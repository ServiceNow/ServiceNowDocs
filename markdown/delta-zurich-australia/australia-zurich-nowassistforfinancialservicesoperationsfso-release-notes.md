---
title: Combined Now Assist for Financial Services Operations \(FSO\) release notes for upgrades from Zurich to Australia
description: Consolidated page of all release notes for Now Assist for Financial Services Operations \(FSO\) from Zurich to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-zurich-australia/australia-zurich-nowassistforfinancialservicesoperationsfso-release-notes.html
release: australia
...
# Combined Now Assist for Financial Services Operations \(FSO\) release notes for upgrades from Zurich to Australia

Consolidated page of all release notes for Now Assist for Financial Services Operations \(FSO\) from Zurich to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Now Assist for Financial Services Operations \(FSO\) release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Zurich to Australia.
...
-   **[Now LLM LTS support for Now Assist for FSO](https://www.servicenow.com/docs/access?context=now-llm-model-updates&family=zurich&ft:locale=en-US)**
...
-   **[Insurance interaction context summary skill](https://www.servicenow.com/docs/access?context=using-now-assist-for-financial-services-operations-fso&family=australia&ft:locale=en-US)**
...
-   **[Insurance Customer Profile Summarization skill](https://www.servicenow.com/docs/access?context=using-now-assist-for-financial-services-operations-fso&family=australia&ft:locale=en-US)**
...
-   **[Customer interaction context summary skill](https://www.servicenow.com/docs/access?context=using-now-assist-for-financial-services-operations-fso&family=australia&ft:locale=en-US)**
...
-   **[Customer profile summarization skill](https://www.servicenow.com/docs/access?context=using-now-assist-for-financial-services-operations-fso&family=australia&ft:locale=en-US)**
...
-   Implement security in Now Assist AI agents and Now Assist for FSO skills with access control lists \(ACLs\).
 ...
 See [Now Assist for FSO](https://www.servicenow.com/docs/access?context=now-assist-for-financial-services-operations&family=zurich&ft:locale=en-US) for more information.
...
-   Research and prepare for customer outreach with a customer profile summary skill and a customer insights AI agent, which answers natural-language queries about a customer by dynamically drawing on data from defined data sources.
 ...
 See [Now Assist for FSO](https://www.servicenow.com/docs/access?context=now-assist-for-financial-services-operations&family=australia&ft:locale=en-US) for more information.
