---
title: Combined Upgrade Console release notes for upgrades from Zurich to Australia
description: Consolidated page of all release notes for Upgrade Console from Zurich to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/delta-zurich-australia/australia-zurich-upgradeconsole-release-notes.html
release: australia
...
# Combined Upgrade Console release notes for upgrades from Zurich to Australia

Consolidated page of all release notes for Upgrade Console from Zurich to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Upgrade Console release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Zurich to Australia.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Upgrade Console to Australia
...
Between your current release family and Australia, new features were introduced for Upgrade Console.
...
-   **[ATF Troubleshooting agent access](https://www.servicenow.com/docs/access?context=um-post-upgrade-activities&family=australia&ft:locale=en-US)**
...
Between your current release family and Australia, some changes were made to existing Upgrade Console features.
...
Between your current release family and Australia, some Upgrade Console features or functionality were removed.
...
Between your current release family and Australia, some Upgrade Console features or functionality were deprecated.
...
Review information on how to activate Upgrade Console.
...
If any additional requirements were introduced or changed for Upgrade Console we have noted them here.
...
If any specific browser requirements were introduced or changed for Upgrade Console we have noted them here.
...
Review details on accessibility information for Upgrade Console, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Upgrade Console we have noted them here.
...
If there are specific highlight considerations for Upgrade Console we have noted them here.
