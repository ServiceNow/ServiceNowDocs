---
title: Exploring Now Assist for Operational Technology Manager \(OTM\)
description: The Now Assist for Operational Technology Manager \(OTM\) plugin uses generative AI to help streamline processes in the Industrial Workspace related to your Operational Technology \(OT\) device data. You can search for OT devices with the OT Configuration Management Database \(CMDB\) search feature and use an agentic workflow to automate the OT device import process.
locale: en-US
release: zurich
topic_type: concept
