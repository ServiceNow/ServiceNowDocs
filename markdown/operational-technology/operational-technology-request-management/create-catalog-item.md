...
6.  On the **Create catalog item** form, fill in the fields.
    ...
    For more information about the Catalog Item form fields, see [Operational Technology Catalog Item form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/operational-technology-request-management/catalog-item-form-ot-request.md).
