...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/operational-technology/results-page-console.html
release: zurich
topic_type: concept
...
\[Omitted image "image.results-page"\] Alt text: Results page
...
\[Omitted image "image.filter-on-result-page"\] Alt text: Filter panel

See [Filter results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/operational-technology/filtering-results.md) for more information.
...
\[Omitted image "image.results-export-raw"\] Alt text: Results page Action button
