...
-   **[Create a change request](../task/create-ot-change-request.md)**  
Create an Operational Technology \(OT\) change request to report a change in your site.
-   **[Create a change task to fulfill a change request](../task/create-ot-change-tasks.md)**  
...
-   **[Create a change request from OT device details](../task/create-ot-change-request-from-ot-asset-details.md)**  
...
-   **[Create a change request from a remediation task](../task/create-change-request-from-remediation-task.md)**  
...
-   **[Create a change request from an incident record](../task/create-change-request-from-incident-record.md)**  
...
-   **[Edit the related devices and equipment model entities in a change record](../task/edit-devices-and-equipment-model-entities-in-ot-change-record.md)**  
...
-   **[Operational Technology change approval](../reference/ot-change-approval.md)**  
...
-   **[Managing change requests across sites](visibility-of-changes-across-sites.md)**  
...
-   **[Visibility of change model records across sites](visibility-of-ot-changes-across-sites.md)**  
...
-   **[Change email notifications](../reference/change-email-notifications.md)**  
