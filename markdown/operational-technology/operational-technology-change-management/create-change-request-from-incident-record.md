...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/operational-technology/operational-technology-change-management/create-change-request-from-incident-record.html
release: yokohama
...
5.  Select the change model that is applicable to your organization.
    ...
    For more information, see [Select a change model to fulfill change requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/operational-technology/operational-technology-change-management/select-change-model.md).
