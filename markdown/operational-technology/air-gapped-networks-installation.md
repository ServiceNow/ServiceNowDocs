...
For these specific steps see the documentation on configuring the individual OT Discovery components. Start with [Configure the Discovery Console for OT](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/configure-ot-discovery-console.md).
...
For more information, see [Install containerized OT Discovery packages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/install-containerized-ot-discovery-packages.md).

-   **[Install containerized OT Discovery packages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/install-containerized-ot-discovery-packages.md)**  
Install the OT Discovery containerized packages on your network.
-   **[Install containerized OT Discovery components on Rocky 10](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/install-containerized-ot-discovery-rocky-10.md)**  
