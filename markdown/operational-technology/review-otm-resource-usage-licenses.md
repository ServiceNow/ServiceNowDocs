---
title: Review OTM resource usage against allocated subscription units
description: Review and analyze resource statistics that OTM products can manage and compare this information to the average allocation of subscription units.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/operational-technology/review-otm-resource-usage-licenses.html
release: xanadu
topic_type: task
...
2.  Select the relevant tab to display the dashboard for the OTM product.
    ...
    \[Omitted image "otm-dashboard-foundation.png"\] Alt text: OTM Licensing Dashboard

3.  Point to a bar to view the number of CIs in each category.

4.  Select the bar to view a list of the counted CIs.

5.  Review the dashboard described in [OTM Licensing dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/operational-technology/otm-licensing-dashboard.md).
