...
breadcrumb: [Import your device spreadsheet into OT CMDB, Use agentic AI in the OTM application, Now Assist for OTM, Operational Technology]
---
...
The Now Assist panel must be activated. For more information, see [Activate the Now Assist panel standard chat](https://www.servicenow.com/docs/access?context=activate-now-assist-panel&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
