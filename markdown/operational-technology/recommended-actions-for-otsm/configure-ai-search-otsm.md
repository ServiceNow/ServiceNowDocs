...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/operational-technology/recommended-actions-for-otsm/configure-ai-search-otsm.html
release: yokohama
...
**Note:** Knowledge \[kb\_knowledge\] is also used as an indexed source for Recommended Actions for OSTM, but Knowledge is already indexed.
