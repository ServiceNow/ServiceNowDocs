...
**Note:** To create a context, see [Create a context in Recommended Actions](https://www.servicenow.com/docs/access?context=ra-csm-contexts-create&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
