...
**Note:** For more information, see [Renew a certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/renew-a-certificate.md). The steps are similar but the Certificate tab only pertains to the Console Certificate.
