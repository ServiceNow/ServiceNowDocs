...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/operational-technology/console-create-backup.html
release: australia
topic_type: task
...
2.  Use the **Database** section to create a backup of the Console MongoDB.
    ...
    \[Omitted image "database-backup.png"\] Alt text: Database backup
