...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/operational-technology/network-zones-page.html
release: zurich
topic_type: concept
...
Additionally, each of the Network Zones can be deleted when they are no longer in use. You can select the name of the Network Zones to view them in more detail.

The following image shows an example of the Network Zones page.

\[Omitted image "image.network-zone-page"\] Alt text: Network Zones page
