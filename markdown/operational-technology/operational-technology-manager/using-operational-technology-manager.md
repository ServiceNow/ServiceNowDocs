...
-   **[Create CMDB Data Certification Policy for Operational Technology](../task/ot-cmdb-data-certification.md)**  
...
-   **[View SIR tasks related to an OT CI](../../mftg-manufacturing-ot-service-mgt/task/view-sir-tasks-related-to-ot.md)**  
