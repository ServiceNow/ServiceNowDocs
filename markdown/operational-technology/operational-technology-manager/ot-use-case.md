...
1.  OT devices:
    1.  Configuration Item classes were created for Operational Technology hardware classes \(cmdb\_ci\_ot\) by extending hardware. See Operational Technology \(OT\) extension classes for details.
