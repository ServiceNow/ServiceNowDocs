...
Also, review the **Security Reader** permission. This permission must be enabled on Microsoft Defender for IoT Azure, which provides the following user actions:
