...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/operational-technology/operational-technology-manager/industrial-core-plugin.html
release: zurich
...
For more information about the OT Device Network Connection data model, see [Operational Technology \(OT\) extension classes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/cmdb-ci-class-models-operation-technology.md).
...
</table>-   **[Create and use an OT device naming strategy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/operational-technology/operational-technology-manager/create-use-ot-device-naming-strategy.md)**  
