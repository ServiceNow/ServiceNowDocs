...
Upload your Operational Technology data to the Configuration Management Database \(CMDB\).For more information, see [Import the Excel template](../task/import-excel-template.md).
...
Discover Operational Technology \(OT\) devices in the designated Purdue levels in your Industrial Control System \(ICS\) networks.For more information about Discovery for Operational Technology, see [Discovery for Operational Technology](discovery-for-operational-technology.md).
...
</table>-   **[Applying CSDM guidelines to Operational Technology](../../operational-technology-management/csdm-implementation/concept/ot-use-case-product-view.md)**  
