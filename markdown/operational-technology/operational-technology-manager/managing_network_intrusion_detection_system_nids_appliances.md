...
For more information about the NIDS class records, see [Network Intrusion Detection System \(NIDS\) CI extension class](https://www.servicenow.com/docs/access?context=cmdb-network-ids-nids-ci-extension-class&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
