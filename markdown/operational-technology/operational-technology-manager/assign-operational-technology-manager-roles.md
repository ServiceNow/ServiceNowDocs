...
Can run the Discovery for Operational Technology process. Can't access the Configuration Management Database \(CMDB\) to view CIs and related Operational Technology \(OT\) entities created from discovered items. See [Create and run the OT Discovery schedule and the Discovery process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/run-discovery-for-operational-technology.md).
