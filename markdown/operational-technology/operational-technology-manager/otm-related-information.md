...
-   **[Network Intrusion Detection System \(NIDS\) CI extension class](https://www.servicenow.com/docs/access?context=cmdb-network-ids-nids-ci-extension-class&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)**
...
-   **[Operational Technology \(OT\) extension classes](https://www.servicenow.com/docs/access?context=cmdb-ci-class-models-operation-technology&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)**
