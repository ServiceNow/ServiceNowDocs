...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/operational-technology/operational-technology-manager/preparing-your-pre-import-ot-worksheet-entry-review-tool-for-sgc-import.html
release: xanadu
...
1.  Fill the following columns in the Microsoft Excel spreadsheet:
    ...
    **Note:** Column names cannot be changed. Extra columns can be added to the staging table. For more information about adding a new custom field mapping in the staging table, see [Add a custom field mapping in the staging table for Service Graph](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/operational-technology/operational-technology-manager/add-new-column-mappings-excel-service-graph.md).
...
Users must not fill this column.
 ...
 For system properties, see [System properties that impact SG-OT Device Excel Import processing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/operational-technology/operational-technology-manager/system-properties-sg-ot-asset-excel-import.md).
...
-   For a listing and explanation of valid CI types, see [Operation Technology \(OT\) extension classes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/configuration-management-database-cmdb/cmdb-ci-class-models-operation-technology.md).
