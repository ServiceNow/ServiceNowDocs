...
-   Use the Microsoft Excel spreadsheet template with the Integration Hub Extract Transform Load \(ETL\), an Operational Technology certified Service Graph Connector. For more information, see [Import your Microsoft Excel spreadsheet using the staging table](import-excel-spreadsheet-service-graph-connector.md).
-   Run Discovery for Operational Technology. For more information, see [Discovery for Operational Technology](../concept/discovery-for-operational-technology.md).
