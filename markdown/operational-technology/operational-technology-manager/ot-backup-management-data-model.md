...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/operational-technology/operational-technology-manager/ot-backup-management-data-model.html
release: yokohama
...
Use the OT Backup Job Execution History \[ot\_backup\_history\_and\_comparison\_log\] class to compare the history of records for all backup executions. The Backup Log table includes the following attributes:
...
**Parent Topic:**[Operational Technology Manager reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/operational-technology/operational-technology-manager/operational-technology-manager-reference.md)
