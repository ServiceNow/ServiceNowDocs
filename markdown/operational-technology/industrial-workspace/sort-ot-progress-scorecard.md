...
2.  Select the **OT Progress Scorecard** \(![image.scorecard-icon-button]\) icon.

3.  Select the Ascending \(![image.ascending-icon]\) or Descending \(![image.descending-icon]\) icon.
