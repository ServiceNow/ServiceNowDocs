...
2.  To the **Home** \(![Home icon in the Industrial Workspace to access the OT Action-Oriented Landing Page](../../mftg-manufacturing-process-mgr/image/home-icon.png)\) icon.
