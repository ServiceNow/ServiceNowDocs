...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/operational-technology/industrial-workspace/oper-tech-task-oriented-landing-page.html
release: xanadu
...
**Note:** The number of records shown on the OT CMDB Health cards remain unchanged until the scheduled job runs. But when you select the **All records** button, the list view shows the updated number. For example, if the scheduled job is set to run at 9am daily but a new unclassed device is added before then, the **Unclassed OT Devices** card doesn't show the updated number. But the list view shows the new device before the scheduled job runs.
...
</table>**Parent Topic:**[Exploring the Industrial Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/operational-technology/industrial-workspace/exploring-industrial-workspace.md)
