...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/operational-technology/operational-technology-incident-management/resolve-and-close-ot-incident.html
release: zurich
...
For more information about OT change requests, see [Create a change request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/operational-technology/operational-technology-change-management/create-ot-change-request.md).
...
For more information about OT requests, see [Create an Operational Technology request on the Industrial Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/operational-technology/operational-technology-request-management/create-ot-service-request-industrial-workspace.md).
