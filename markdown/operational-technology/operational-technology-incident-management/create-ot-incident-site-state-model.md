...
For more information about state management and state models, see [State Management](https://www.servicenow.com/docs/access?context=state-model&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
