...
For more information about state management and state models, see [State Management](https://www.servicenow.com/docs/access?context=state-model&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
