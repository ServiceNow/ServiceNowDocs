...
-   **[Create tasks to fulfill an OT incident](../task/create-ot-incident-task.md)**  
...
-   **[Create a child incident](../task/create-a-child-ot-incident.md)**  
...
-   **[Visibility of incidents across sites](visibility-across-ot-incident-sites.md)**  
...
-   **[Synchronization between an incident and its incident tasks](../reference/synchronization-between-ot-incident-and-ot-incident-tasks.md)**  
...
-   **[Incident email notifications](../reference/ot-incident-notifications.md)**  
Use Operational Technology \(OT\) incident email notifications to alert users when changes are made to an incident.
-   **[Compose an email from an OT incident record](../task/compose-an-email-from-ot-incident-record.md)**  
...
-   **[Resolve and close an incident](../task/resolve-and-close-ot-incident.md)**  
...
-   **[Edit the related devices and equipment model entities in an incident record](../task/edit-devices-and-equipment-model-entities-in-ot-incident-record.md)**  
