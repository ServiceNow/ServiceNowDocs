...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/operational-technology/run-discovery-for-operational-technology.html
release: zurich
topic_type: task
...
-   Install and configure the standard Discovery application. To learn more, see [Discovery setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/discovery-setup.md).
...
-   Install the Mid Server. To learn more, see [Installing the MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server-installation.md).
...
<table id="choicetable_dcf_hl5_vpb"><thead><tr><th align="left" id="d26645e149">

Task

</th><th align="left" id="d26645e152">

Description

</th></tr></thead><tbody><tr><td id="d26645e158">
...
<table id="choicetable_fxf_qpx_nsb"><thead><tr><th align="left" id="d26645e233">

Field

</th><th align="left" id="d26645e236">

Description

</th></tr></thead><tbody><tr><td id="d26645e242">
