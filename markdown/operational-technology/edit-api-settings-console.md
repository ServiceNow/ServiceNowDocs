...
The Service Graph Connector \(SGC\) has been enhanced to enable functions of the Discovery Console for OT API.

## Procedure

1.  In the Console, navigate to the **Settings** page.
...
**Parent Topic:**[Discovery Console for OT API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/api-discovery-console.md)
