...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/operational-technology/create-asset-console.html
release: zurich
topic_type: task
...
2.  Select the add \[Omitted image "add-icon-msi.jpg"\] Alt text: icon.
