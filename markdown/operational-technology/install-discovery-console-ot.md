...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/operational-technology/install-discovery-console-ot.html
release: zurich
topic_type: task
...
4.  Select **Configure** and the **Downloads** page opens.
    ...
    **Note:** For information on downloading and installing the containerized Console and Collector packages, see [Air-gapped networks and OT Discovery installation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/operational-technology/air-gapped-networks-installation.md).
