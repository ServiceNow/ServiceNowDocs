...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/operational-technology/industrial-process-manager/create-entity-new-equipment-model.html
release: xanadu
...
7.  In the Details form, enter the remaining details for the new equipment model entity.
    ...
    To learn more, see [Review and update the equipment model details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/operational-technology/industrial-process-manager/equipment-model-workspace.md).
