...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/operational-technology/industrial-process-manager/create-entity-new-equipment-model.html
release: yokohama
...
7.  In the Details form, enter the remaining details for the new equipment model entity.
    ...
    To learn more, see [Review and update the equipment model details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/operational-technology/industrial-process-manager/equipment-model-workspace.md).
