...
4.  Modify the Configuration Types, CI Filters, and Relationship Types related lists as needed.
    ...
    For more information about how to modify these related lists, see [Create a predefined filter](https://www.servicenow.com/docs/access?context=create-predefined-filter&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
