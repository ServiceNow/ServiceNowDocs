...
-   **[Create an equipment model template](../task/create-equipment-model-template.md)**  
...
-   **[Create hierarchical sorting levels for an equipment model template](../task/create-equipment-model-template-levels.md)**  
...
-   **[Create equipment model level types](../task/create-equipment-model-template-type.md)**  
