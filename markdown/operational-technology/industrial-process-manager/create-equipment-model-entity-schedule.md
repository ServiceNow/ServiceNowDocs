...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/operational-technology/industrial-process-manager/create-equipment-model-entity-schedule.html
release: australia
...
Now, you can create the entries for an equipment model entity schedule. For more information, see [Create a schedule entry](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/operational-technology/industrial-process-manager/create-new-schedule-entry.md).
