...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/operational-technology/industrial-process-manager/view-ot-assets-equipment-model-entity.html
release: xanadu
...
**Note:** To learn more about assigning user roles, see [Assign Industrial Process Manager user roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/operational-technology/industrial-process-manager/assign-manufacturing-process-manager-roles.md).
...
<table id="choicetable_nnq_bxc_3qb"><thead><tr><th align="left" id="d32671e149">

Task

</th><th align="left" id="d32671e152">

Description

</th></tr></thead><tbody><tr><td id="d32671e158">
