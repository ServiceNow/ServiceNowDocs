...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/operational-technology/create-variable-set.html
release: zurich
topic_type: task
...
7.  **Confirmation**: Confirm to create the Variable.


## Result

The new variable appears in the Variable list.
