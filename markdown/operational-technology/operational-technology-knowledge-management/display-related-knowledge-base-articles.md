...
4.  In the incident record, select the **Agent assist** button ![Agent assist button.](../image/agent-assist-button.png) to open the Agent Assist window if it's not already opened.

5.  To view the full knowledge article, select the **More actions** button ![More actions button.](../image/more-actions-vertical.png).
