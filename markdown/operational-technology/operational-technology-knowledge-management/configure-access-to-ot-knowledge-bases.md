...
3.  To restrict unauthenticated users for a knowledge base by using the user criteria, select the knowledge base record and update its user criteria.
    ...
    For more information about creating the user criteria, see [Create the user criteria for an OT knowledge base](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/operational-technology-knowledge-management/create-user-criteria-otkm.md). For more information about assigning the user criteria, see [Assign the user criteria to an OT knowledge base](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/operational-technology-knowledge-management/assign-ot-user-criteria-otkm.md).
