---
title: Combined Collaborative Work Management release notes for upgrades from Washington DC to Australia
description: Consolidated page of all release notes for Collaborative Work Management from Washington DC to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-washingtondc-australia/australia-washingtondc-collaborativeworkmanagement-release-notes.html
release: australia
...
# Combined Collaborative Work Management release notes for upgrades from Washington DC to Australia

Consolidated page of all release notes for Collaborative Work Management from Washington DC to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Collaborative Work Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Australia.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Collaborative Work Management to Australia
...
Between your current release family and Australia, new features were introduced for Collaborative Work Management.
...
-   **[Shared Spaces for collaboration](https://www.servicenow.com/docs/access?context=cwm-spaces&family=washingtondc&ft:locale=en-US)**
...
-   **[Flexible Boards for task management](https://www.servicenow.com/docs/access?context=cwm-boards&family=washingtondc&ft:locale=en-US)**
...
-   **[Automations for tasks in Boards](https://www.servicenow.com/docs/access?context=implementing-automations-in-collaborative-work-management&family=washingtondc&ft:locale=en-US)**
...
-   **[Collaborative documentation](https://www.servicenow.com/docs/access?context=cwm-docs&family=washingtondc&ft:locale=en-US)**
...
-   **[Connecting to Planning portfolios](https://www.servicenow.com/docs/access?context=connect-cwm-spw&family=washingtondc&ft:locale=en-US)**
...
-   **[Use templates for Boards and Docs](https://www.servicenow.com/docs/access?context=templates-in-cwm-for-spaces-boards-and-docs&family=xanadu&ft:locale=en-US)**
...
-   **[Board views in CWM](https://www.servicenow.com/docs/access?context=board-views-in-cwm&family=xanadu&ft:locale=en-US)**
...
-   **[Export a CWM Board to CSV or Microsoft Excel](https://www.servicenow.com/docs/access?context=export-a-board-in-cwm-to-csv-or-excel&family=xanadu&ft:locale=en-US)**
...
-   **[Export a Doc in CWM to a PDF file](https://www.servicenow.com/docs/access?context=export-a-doc-in-cwm-to-a-pdf-file&family=xanadu&ft:locale=en-US)**
...
-   **[My Work in CWM](https://www.servicenow.com/docs/access?context=my-work-in-cwm&family=xanadu&ft:locale=en-US)**
...
-   **[Duplicate a Board in CWM](https://www.servicenow.com/docs/access?context=duplicate-board-in-cwm&family=xanadu&ft:locale=en-US)**
...
-   **[Duplicate a Doc in CWM](https://www.servicenow.com/docs/access?context=duplicate-doc-in-cwm&family=xanadu&ft:locale=en-US)**
...
-   **[Add People column users in Board automations](https://www.servicenow.com/docs/access?context=implementing-automations-in-collaborative-work-management&family=xanadu&ft:locale=en-US)**
...
-   **[Keyboard shortcuts for workspace actions](https://www.servicenow.com/docs/access?context=cwm-spaces&family=yokohama&ft:locale=en-US)**
...
-   **[Kanban board filters](https://www.servicenow.com/docs/access?context=cwm-board-views&family=australia&ft:locale=en-US)**
...
-   **[Image download from docs](https://www.servicenow.com/docs/access?context=cwm-docs&family=australia&ft:locale=en-US)**
...
Between your current release family and Australia, some changes were made to existing Collaborative Work Management features.
...
-   **[Share a Space in CWM and manage sharing permissions](https://www.servicenow.com/docs/access?context=share-space-in-cwm&family=xanadu&ft:locale=en-US)**
...
Between your current release family and Australia, some Collaborative Work Management features or functionality were removed.
...
Between your current release family and Australia, some Collaborative Work Management features or functionality were deprecated.
...
Live user presence in Docs is not supported in the Safari browser.
...
See [Reflow for Configurable Workspace](https://www.servicenow.com/docs/access?context=auto-reflow&family=yokohama&ft:locale=en-US) for details.
...
-   Connect work to any ServiceNow AI Platform record such as Cases, Incidents, or Risks.
 ...
 See [Collaborative Work Management](https://www.servicenow.com/docs/access?context=cwm-landing&family=washingtondc&ft:locale=en-US) for more information.
...
-   Save time and avoid manual copying of information with the ability to duplicate CWM Boards and Docs.
 ...
 See [Collaborative Work Management](https://www.servicenow.com/docs/access?context=cwm-landing&family=xanadu&ft:locale=en-US) for more information.
...
-   Benefit from accessibility improvements to create a configurable workspace that supports Web Content Accessibility Guidelines \(WCAG\) 2.1 Level AA conformance.
 ...
 See [Collaborative Work Management](https://www.servicenow.com/docs/access?context=cwm-landing&family=yokohama&ft:locale=en-US) for more information.
...
-   Filter and group work by vertical and horizontal swimlanes in the Kanban view for a specific work item type.
 ...
 See [Collaborative Work Management](https://www.servicenow.com/docs/access?context=cwm-landing&family=zurich&ft:locale=en-US) for more information.
