---
title: Combined Now Assist for Software Asset Management \(SAM\) release notes for upgrades from Washington DC to Australia
description: Consolidated page of all release notes for Now Assist for Software Asset Management \(SAM\) from Washington DC to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-washingtondc-australia/australia-washingtondc-nowassistforsoftwareassetmanagementsam-release-notes.html
release: australia
...
# Combined Now Assist for Software Asset Management \(SAM\) release notes for upgrades from Washington DC to Australia
...
To help you prepare for your upgrade, we have combined the cross-family Now Assist for Software Asset Management \(SAM\) release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Australia.
