---
title: Combined Privacy Management release notes for upgrades from Washington DC to Australia
description: Consolidated page of all release notes for Privacy Management from Washington DC to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-washingtondc-australia/australia-washingtondc-privacymanagement-release-notes.html
release: australia
...
# Combined Privacy Management release notes for upgrades from Washington DC to Australia

Consolidated page of all release notes for Privacy Management from Washington DC to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Privacy Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Australia.
...
-   **[Privacy Case Management](https://www.servicenow.com/docs/access?context=privacy-case-management-overview&family=washingtondc&ft:locale=en-US)**
...
-   **[Privacy Case Management integration for RadarFirst](https://www.servicenow.com/docs/access?context=integrating-with-radarfirst&family=washingtondc&ft:locale=en-US)**
...
-   **[Functional domain](https://www.servicenow.com/docs/access?context=set-up-steps-it-compliance-ws&family=washingtondc&ft:locale=en-US)**
...
-   Refer to the **Functional domain** field that is automatically set to **Privacy** when the users with privacy roles work on forms such as processing activities, controls, and so on.
 ...
 See [Exploring Privacy Management](https://www.servicenow.com/docs/access?context=explore-privacy-management&family=washingtondc&ft:locale=en-US) for more information.
