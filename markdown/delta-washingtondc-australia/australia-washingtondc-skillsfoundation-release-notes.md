---
title: Combined Skills Foundation release notes for upgrades from Washington DC to Australia
description: Consolidated page of all release notes for Skills Foundation from Washington DC to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-washingtondc-australia/australia-washingtondc-skillsfoundation-release-notes.html
release: australia
...
# Combined Skills Foundation release notes for upgrades from Washington DC to Australia

Consolidated page of all release notes for Skills Foundation from Washington DC to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Skills Foundation release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Australia.
...
Set up Skills Foundation and the Company Job Architecture efficiently through guided setup. For more information, see [\[Placeholder link text to key bundle-emplsm.skills-intelligence-guided-setup\]](https://www.servicenow.com/docs/access?context=skills-intelligence-guided-setup&family=washingtondc&ft:locale=en-US).

-   **Skills Foundation landing page**

Note which parts of the Skills and Company Job Architecture need attention with the actionable insights on the Skills Foundation landing page. For more information, see [Skills Intelligence Workspace](https://www.servicenow.com/docs/access?context=skills-intelligence-workspace&family=washingtondc&ft:locale=en-US).
...
-   The Skills Workspace plugin \(sn\_skills\_int\_ws\) must be installed for the workspace experience.
...
-   Update and maintain skills and role architecture data from a single place using the Skills Workspace.
