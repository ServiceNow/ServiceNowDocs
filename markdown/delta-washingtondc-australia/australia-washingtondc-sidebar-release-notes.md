---
title: Combined Sidebar release notes for upgrades from Washington DC to Australia
description: Consolidated page of all release notes for Sidebar from Washington DC to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-washingtondc-australia/australia-washingtondc-sidebar-release-notes.html
release: australia
...
# Combined Sidebar release notes for upgrades from Washington DC to Australia

Consolidated page of all release notes for Sidebar from Washington DC to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Sidebar release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Australia.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Sidebar to Australia
...
Between your current release family and Australia, new features were introduced for Sidebar.
...
-   **[Sidebar](https://www.servicenow.com/docs/access?context=sidebar-landing&family=australia&ft:locale=en-US)**
...
Between your current release family and Australia, some changes were made to existing Sidebar features.
...
Between your current release family and Australia, some Sidebar features or functionality were removed.
...
Between your current release family and Australia, some Sidebar features or functionality were deprecated.
...
Review information on how to activate Sidebar.
...
If any additional requirements were introduced or changed for Sidebar we have noted them here.
...
If any specific browser requirements were introduced or changed for Sidebar we have noted them here.
...
Review details on accessibility information for Sidebar, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Sidebar we have noted them here.
...
If there are specific highlight considerations for Sidebar we have noted them here.
...
When you select participants to join an existing conversation, Sidebar displays a list of participants who may be helpful in solving a customer's issue.
 ...
 See [Sidebar](https://www.servicenow.com/docs/access?context=sidebar-landing&family=washingtondc&ft:locale=en-US) for more information.
