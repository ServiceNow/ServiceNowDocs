---
title: Combined Security Center release notes for upgrades from Washington DC to Australia
description: Consolidated page of all release notes for Security Center from Washington DC to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-washingtondc-australia/australia-washingtondc-securitycenter-release-notes.html
release: australia
...
# Combined Security Center release notes for upgrades from Washington DC to Australia

Consolidated page of all release notes for Security Center from Washington DC to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Security Center release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Australia.
...
-   **[Security Best Practices](https://www.servicenow.com/docs/access?context=security-best-practices-manager&family=washingtondc&ft:locale=en-US) \(new in v1.5\)**
...
-   **[Customer Actions](https://www.servicenow.com/docs/access?context=critical-updates&family=washingtondc&ft:locale=en-US)**
...
-   **[Hardening settings baseline](https://www.servicenow.com/docs/access?context=hardening-settings-baseline&family=washingtondc&ft:locale=en-US)**
...
-   Use the enhanced Security Hardening tool, which implements the new Instance Security Hardening Setting Baseline version 2.0 \(Security Center 1.3\)and version 4.0 \(Security Center 1.5\).
 ...
 See [Security Best Practices](https://www.servicenow.com/docs/access?context=security-best-practices-manager&family=washingtondc&ft:locale=en-US), [Customer Actions](https://www.servicenow.com/docs/access?context=critical-updates&family=washingtondc&ft:locale=en-US), and [Hardening settings baseline](https://www.servicenow.com/docs/access?context=hardening-settings-baseline&family=washingtondc&ft:locale=en-US) for more information.
