---
title: Combined Operational Resilience release notes for upgrades from Washington DC to Australia
description: Consolidated page of all release notes for Operational Resilience from Washington DC to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-washingtondc-australia/australia-washingtondc-operationalresilience-release-notes.html
release: australia
...
# Combined Operational Resilience release notes for upgrades from Washington DC to Australia

Consolidated page of all release notes for Operational Resilience from Washington DC to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Operational Resilience release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Australia.
...
-   **[Roles installed with Operational Resilience](https://www.servicenow.com/docs/access?context=roles-installed-with-op-res&family=washingtondc&ft:locale=en-US)**
...
-   **[\[Placeholder link text to key bundle-grc.grc-operational-resilience-dashboard\]](https://www.servicenow.com/docs/access?context=grc-operational-resilience-dashboard&family=washingtondc&ft:locale=en-US)**
...
-   **[Fetching dependencies from the CMDB and BIA](https://www.servicenow.com/docs/access?context=add-dependencies-automatically&family=washingtondc&ft:locale=en-US)**
...
-   **[Export action task reports in Microsoft Word, Microsoft Excel, and JSON formats](https://www.servicenow.com/docs/access?context=work-on-action-tasks&family=australia&ft:locale=en-US)**
...
-   Auto-populate the dependency mappings for the business services based on the source-data relationships in the business impact assessment \(BIA\).
 ...
 See [Operational Resilience](https://www.servicenow.com/docs/access?context=grc-opres-landing-page&family=washingtondc&ft:locale=en-US) for more information.
