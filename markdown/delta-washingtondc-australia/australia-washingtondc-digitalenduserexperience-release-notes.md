---
title: Combined Digital End-User Experience release notes for upgrades from Washington DC to Australia
description: Consolidated page of all release notes for Digital End-User Experience from Washington DC to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-washingtondc-australia/australia-washingtondc-digitalenduserexperience-release-notes.html
release: australia
...
# Combined Digital End-User Experience release notes for upgrades from Washington DC to Australia

Consolidated page of all release notes for Digital End-User Experience from Washington DC to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Digital End-User Experience release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Australia.
...
-   **[DEX Application and Device Health](https://www.servicenow.com/docs/access?context=dex-console&family=washingtondc&ft:locale=en-US)**
...
-   **[DEX Content Playbook](https://www.servicenow.com/docs/access?context=dex-content-playbook&family=washingtondc&ft:locale=en-US)**
...
-   **[DEX Desktop Assistant](https://www.servicenow.com/docs/access?context=dex-desktop-experience&family=washingtondc&ft:locale=en-US)**
...
-   **[DEX Insights](https://www.servicenow.com/docs/access?context=dex-workspace-insights-tab&family=xanadu&ft:locale=en-US)**
...
-   **[Integration with ServiceNow Proactive Engagement](https://www.servicenow.com/docs/access?context=add-alert-action&family=xanadu&ft:locale=en-US)**
...
-   **[Desktop Assistant with Now Assist](https://www.servicenow.com/docs/access?context=chat-using-now-assist&family=xanadu&ft:locale=en-US)**
...
-   **[Actions and Actions Library](https://www.servicenow.com/docs/access?context=view-actions-in-actions-library&family=xanadu&ft:locale=en-US)**
...
-   **[Monitoring non-persistent VDIs](https://www.servicenow.com/docs/access?context=monitoring-np-vdis&family=zurich&ft:locale=en-US)**
...
-   **[\[Placeholder link text to key create-insights-report\]](https://www.servicenow.com/docs/access?context=create-insights-report&family=australia&ft:locale=en-US)**
...
Install DEX by requesting it from the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/application/0db59e3eade11d50f8777e45b2f98b72). Visit the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website to view all the available apps and for information about submitting requests to the store. For cumulative release notes information for all released apps, see the [ServiceNow Store version history release notes](https://www.servicenow.com/docs/access?context=sn-store-release-notes&family=washingtondc&ft:locale=en-US).
...
Install Digital End-User Experience by requesting it from the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home). 
...
For the web/SaaS application, enable the DEX browser extension for monitoring web/SaaS applications to collect various operational or performance-based metrics on your system. For more information, see [Enable DEX browser extension for monitoring web/SaaS applications](https://www.servicenow.com/docs/access?context=enable-dex-browser-extension&family=washingtondc&ft:locale=en-US).
...
For the web/SaaS application, enable the DEX browser extension for monitoring web/SaaS applications to collect various operational or performance-based metrics on your system. For more information, see [Enable browser extension](https://www.servicenow.com/docs/access?context=enable-dex-browser-extension&family=xanadu&ft:locale=en-US).
...
Enable the DEX browser extension to monitor web applications for various operational or performance-based metrics on your system. For more information, see [Enable browser extension](https://www.servicenow.com/docs/access?context=enable-dex-browser-extension&family=australia&ft:locale=en-US).
...
Localization is applicable to DEX in all the languages that are supported by the ServiceNow AI Platform.
...
-   Set thresholds for alerts to address issues before they affect employee productivity by optimizing the digital experience to ensure efficient operation of applications on various channels such as desktop and web/SaaS.
 ...
 See [DEX Application and Device Health](https://www.servicenow.com/docs/access?context=dex-console&family=washingtondc&ft:locale=en-US) for more information.
...
-   Resolve the issues that your users face with actions available in list of predefined issue resolutions called Action library.
 ...
 See [Digital End-User Experience](https://www.servicenow.com/docs/access?context=dex-landing&family=xanadu&ft:locale=en-US) for more information.
...
-   Save custom insight reports and access them from the left navigation panel for faster, repeatable analysis.
 ...
 See [Digital End-User Experience](https://www.servicenow.com/docs/access?context=dex-landing&family=australia&ft:locale=en-US) for more information.
