---
title: Combined Case management for CSM release notes for upgrades from Washington DC to Australia
description: Consolidated page of all release notes for Case management for CSM from Washington DC to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-washingtondc-australia/australia-washingtondc-casemanagementforcsm-release-notes.html
release: australia
...
# Combined Case management for CSM release notes for upgrades from Washington DC to Australia

Consolidated page of all release notes for Case management for CSM from Washington DC to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Case management for CSM release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Australia.
...
-   **[Service definition categories](https://www.servicenow.com/docs/access?context=csm-service-definitions&family=washingtondc&ft:locale=en-US)**
...
-   **[Customer activity view](https://www.servicenow.com/docs/access?context=customer-central&family=washingtondc&ft:locale=en-US)**
...
-   **[Technology Product Support Case application](https://www.servicenow.com/docs/access?context=tech-product-support-case-app&family=washingtondc&ft:locale=en-US)**
...
-   **[Technology Product Support case type](https://www.servicenow.com/docs/access?context=tech-product-support-case-type&family=washingtondc&ft:locale=en-US)**
...
-   **[Technology product support record page](https://www.servicenow.com/docs/access?context=tech-product-support-record-page&family=washingtondc&ft:locale=en-US)**
...
-   **[Modeless dialogs for Activity Compose and Email Compose](https://www.servicenow.com/docs/access?context=tech-product-support-record-page&family=washingtondc&ft:locale=en-US)**
...
-   **[Technology Product Support Case playbook](https://www.servicenow.com/docs/access?context=tech-product-support-playbook&family=washingtondc&ft:locale=en-US)**

Provides agents with step-by-step guidance for resolving technology cases.

-   **[Quick start tests for Customer Service Management](https://www.servicenow.com/docs/access?context=quick-start-tests-csm&family=washingtondc&ft:locale=en-US)**
...
-   **[Dynamic Related Records for Configurable Workspace](https://www.servicenow.com/docs/access?context=csm-contextual-related-records&family=washingtondc&ft:locale=en-US)**
...
-   **[Case service selector enhancements](https://www.servicenow.com/docs/access?context=csm-service-definitions&family=washingtondc&ft:locale=en-US)**
...
-   **[Customer Contracts and Entitlements application](https://www.servicenow.com/docs/access?context=exploring-post-sales-support&family=washingtondc&ft:locale=en-US)**
...
-   **[Roles included with the Customer Service manager role](https://www.servicenow.com/docs/access?context=r_RolesInstalledWithCustomerService&family=washingtondc&ft:locale=en-US)**
...
-   Increase agent efficiency with an improved and flexible activity stream layout that optimizes screen real estate through collapsible panels and minimized scrolling.
 ...
 See [Exploring Customer Service Management](https://www.servicenow.com/docs/access?context=exploring-csm&family=washingtondc&ft:locale=en-US) for more information.
