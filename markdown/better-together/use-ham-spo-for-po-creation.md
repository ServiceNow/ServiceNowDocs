...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/better-together/use-ham-spo-for-po-creation.html
release: zurich
topic_type: concept
...
3.  Receive the requested assets in a stockroom. For more information, see [Receiving assets in the IT Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/source-to-pay-operations/itam-spo-receiving-assets.md) application.
4.  Acknowledge the receipt of the assets in the stockroom for asset creation. For more information, see [Asset creation in the IT Asset Management application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/source-to-pay-operations/itam-spo-asset-creation.md).
