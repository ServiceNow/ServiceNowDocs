...
3.  Receive the requested assets in a stockroom. For more information, see [Receiving assets in the IT Asset Management](https://www.servicenow.com/docs/access?context=itam-spo-receiving-assets&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US) application.
4.  Acknowledge the receipt of the assets in the stockroom for asset creation. For more information, see [Asset creation in the IT Asset Management application](https://www.servicenow.com/docs/access?context=itam-spo-asset-creation&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US).
