...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/better-together/better-tprm-slo.html
release: yokohama
topic_type: concept
...
1.  Install the Supplier Lifecycle Operations \(com.snc.sn\_supplier\_mgmt\) application from the ServiceNow® Store. For more information, see [Install Supplier Lifecycle Operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/source-to-pay-operations/install-supp-mgmt.md).
...
3.  Install the Third-party Risk Management \(com.sn\_vdr\_risk\_asmt\) application from the ServiceNow® Store. For more information, see [Configuring Third-party Risk Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/governance-risk-compliance/tprm-configuring.md).
...
1.  Create a supplier. For more information, see [Create a supplier from the Source-to-Pay Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/source-to-pay-operations/new-supplier.md).
2.  Onboard a new supplier using playbooks. For more information, see [Use the supplier onboarding playbook to onboard suppliers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/source-to-pay-operations/use-playbooks-onboard-supp.md).
3.  The playbook creates a due diligence request. For more information about the fields in this activity, see [Request due diligence for a third-party engagement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/governance-risk-compliance/tprm-ws-request-dd-for-engagement.md).
...
**Parent Topic:**[Solutions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/better-together/solutions-gallery.md)
