...
1.  Create a supplier. For more information, see [Create a supplier from the Source-to-Pay Workspace](https://www.servicenow.com/docs/access?context=new-supplier&version=yokohama&pubname=yokohama-source-to-pay-operations&ft:locale=en-US).
2.  Onboard a new supplier using playbooks. For more information, see [Use the supplier onboarding playbook to onboard suppliers](https://www.servicenow.com/docs/access?context=use-playbooks-onboard-supp&version=yokohama&pubname=yokohama-source-to-pay-operations&ft:locale=en-US).
3.  The playbook creates a due diligence request. For more information about the fields in this activity, see [Request due diligence for a third-party engagement](https://www.servicenow.com/docs/access?context=tprm-ws-request-dd-for-engagement&version=yokohama&pubname=yokohama-governance-risk-compliance&ft:locale=en-US).
