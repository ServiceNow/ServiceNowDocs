...
2.  The supplier manager uses the onboarding playbook, which provides a streamlined and guided process to onboard suppliers. For more information, see [Use the supplier onboarding playbook to onboard suppliers](https://www.servicenow.com/docs/access?context=use-playbooks-onboard-supp&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US).
...
1.  Install the Supplier Lifecycle Operations \(com.snc.sn\_supplier\_mgmt\) application from the ServiceNow® Store. For more information, see [Install Supplier Case Management](https://www.servicenow.com/docs/access?context=install-supp-mgmt&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US).
...
1.  Create a supplier. For more information, see [Create a supplier from the Source-to-Pay Workspace](https://www.servicenow.com/docs/access?context=new-supplier&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US).
2.  Onboard a new supplier using playbooks. For more information, see [Use the supplier onboarding playbook to onboard suppliers](https://www.servicenow.com/docs/access?context=use-playbooks-onboard-supp&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US).
3.  The playbook creates a due diligence request. For more information about the fields in this activity, see [Request due diligence for a third-party engagement](https://www.servicenow.com/docs/access?context=tprm-ws-request-dd-for-engagement&version=zurich&pubname=zurich-governance-risk-compliance&ft:locale=en-US).
