---
title: Financial Services Business Lifecycle release notes
description: Version history for the Financial Services Business Lifecycle application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-fso-financial-services-business-lifecycle.html
release: store
...
# Financial Services Business Lifecycle release notes
...
-   **Version 1.0.3 - August 2021**
    ...
    Financial Services Business Lifecycle enables financial institutions to shorten their time-to-revenue for new accounts and respond to events that affect account contacts and KYC over time. With an intelligent workflow that includes rulesets, playbooks, and agent workspaces, each team member can deliver an efficient, consistent, and compliant experience.
