...
Version history for the ServiceNow® Operational Sustainability Management Advanced application on the ServiceNow Store.
-   **[Operational Sustainability Management Content Accelerator release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-esg-content-accelerator.md)**  
Version history for the Operational Sustainability Management Content Accelerator on the ServiceNow Store.
-   **[Operational Sustainability Management integration with DEX release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-esg-int-dex.md)**  
Version history for the Operational Sustainability Management integration with DEX application on the ServiceNow Store.
-   **[Operational Sustainability Management integration with Microsoft 365 release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-esg-integration-ms365.md)**  
Version history for the Operational Sustainability Management integration with Microsoft 365 application on the ServiceNow Store.
-   **[Operational Sustainability Risk Management release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-esg-risk-mgmt.md)**  
Version history for the Operational Sustainability Risk Management application on the ServiceNow Store.
-   **[Operational Sustainability Management with Concur integration release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-esg-concur-esg-integration.md)**  
...
-   **[Watershed integration for Operational Sustainability Management release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-esg-watershed-integration.md)**  
