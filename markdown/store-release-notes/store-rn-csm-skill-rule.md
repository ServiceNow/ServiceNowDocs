---
title: Skill Rule release notes
description: Version history for the ServiceNow Skill Rule application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-csm-skill-rule.html
release: store
...
-   **Version 1.1.1 - September 2026**
    ...
    Changed: Skill matching is now instant and fluent. Work routes the moment it arrives, with no delay between assignment and agent pickup.
