...
-   **Version 16.0.1 - September 2026**
    ...
    -   Changed:
        -   Workflow dependency removal in HAM and ITAM test projects: Test projects now create their own data and run independently of demo data workflows, improving test stability and execution time.
