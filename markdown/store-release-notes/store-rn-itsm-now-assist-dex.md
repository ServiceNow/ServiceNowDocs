---
title: Now Assist for Digital End-user Experience Self-service \(DEX\) release notes
description: Version history for the ServiceNow Now Assist for Digital End-user Experience Self-service \(DEX\) application on the ServiceNow Store.
locale: en-US
...
-   **Version 4.3.0 - June 2026**
    ...
    Changed: Engagement tool for DEX agents to obtain employee approval before auto-triggering device actions. This change integrates with ZTS so will not be published until ZTS is GA.
