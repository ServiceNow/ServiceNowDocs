---
title: Hiring tab release notes
description: Version history for the Hiring tab on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-hr-hiring-tab.html
release: store
...
Version history for the Hiring tab on the ServiceNow Store.

**Important:** For details on system requirements and family compatibility, view the application listing on the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website.

## Version history

-   **Version 8.0.1 - July 2026**
...
-   **Version 7.1.0 - March 2026**
    ...
    Hiring Managers can now search a job requisition by the Job Requisition ID.

-   **Version 7.0.0 - December 2025**
    -   Addressed few minor defects.
    -   Updates to support the interview management agentic workflow.
