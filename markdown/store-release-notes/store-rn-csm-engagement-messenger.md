---
title: Engagement Messenger release notes
description: Version history for the Customer Service Management Engagement Messenger on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-csm-engagement-messenger.html
release: store
...
-   **Version 5.21.0 - September 2026**

    Fixed: Notification popup position on the browser window.

-   **Version 5.16.0 - August 2026**

    Fixed translation and functional bugs
...
-   **Version 5.6.0 - February 2024**
    -   Extend the self-service capabilities to your native mobile apps \(Android and iOS\) by embedding Engagement Messenger using mobile software development kit \(SDK\).
    -   Bug fixes.
...
-   **Version 5.4.0 - August 2023**
    -   Added ability to send email notification for unread messages.
