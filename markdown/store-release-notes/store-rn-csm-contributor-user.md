---
title: CSM Contributor User release notes
description: Version history for the ServiceNow CSM Contributor User application on the ServiceNow Store.
locale: en-US
...
-   **Version 2.4.0 - June 2026**
    -   New:
        -   Create a Case record producer changes for supporting Business Org Self Contributor persona
        -   Changes to support Broad Access Responsibility for Contributor persona
-   **Version 2.2.0 - April 2026**

    Changed: Renamed Service Model Foundation entities to improve clarity and maintain consistency across the platform. Please refer to ServiceNow Documentation for the label changes. Eg: "Business Location" is renamed to "Business Organization".
