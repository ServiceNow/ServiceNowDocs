...
-   **Version 2.6.0 - July 2026**
    ...
    Fixed: Localization fix: corrected hardcoded strings for "Request help and report issues for your unit," "Create a request," and "Track requests," and resolved a layout/truncation issue on the "Create a request" button in German.
