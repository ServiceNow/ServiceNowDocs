---
title: Microsoft Azure RBAC Spoke release notes
description: Version history for the Microsoft Azure RBAC Spoke application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-ms-azure-rbac-spoke.html
release: store
...
-   **Version 1.0.2 - September 2025**
    ...
    Fixed - Added category for Look up Users by Role Stream
