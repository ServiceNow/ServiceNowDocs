...
description: Version history for the ServiceNow Financial Services Operations Integration with Verifi application on the ServiceNow Store.
locale: en-US
...
-   **Version 1.0.1 - May 2026**
    ...
    Fixed: Resolved minor issues related to the read-only fields in the Create Alert merchant task when Verifi integration is enabled.
