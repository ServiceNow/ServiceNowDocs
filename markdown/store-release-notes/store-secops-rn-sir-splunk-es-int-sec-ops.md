...
-   **Version 12.5.3 - September 2026**

    Fixed: SIR Mapping page loading failure when an SIR field has an empty column label, and prevented retired CIs from being attached to SIRs through SIEM ingestions.
