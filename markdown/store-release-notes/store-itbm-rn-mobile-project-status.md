---
title: Project Status Report release notes
description: Version history for the Project Status Report on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-itbm-rn-mobile-project-status.html
release: store
...
-   **Version 1.1.1 - August 2023**
    ...
    Fixed: Fixed issues related to dark theme support
...
-   **Version 1.0.3 - November 2020**
    ...
    Fixed: Fixes for inclusive language.
