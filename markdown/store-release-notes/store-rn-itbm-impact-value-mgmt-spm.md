---
title: Impact Value Management - SPM release notes
description: Version history for the Impact Value Management - SPM application on the ServiceNow Store.
locale: en-US
...
# Impact Value Management - SPM release notes
...
-   **Version 2.0.0 - December 2024**
    -   The Impact Value Management Data Collection Dashboard for Strategic Portfolio Management \(SPM\) gives Impact customers an automated solution for gathering standard ServiceNow value metrics, enhancing their value journey.
