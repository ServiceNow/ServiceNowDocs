---
title: May 29 2026 Now Assist Suite release notes
description: Now Assist Suite version and compatibility information for the May 29 2026 release on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/na-suite-rn-2026-05-29.html
release: store
...
# May 29 2026 Now Assist Suite release notes

Now Assist Suite version and compatibility information for the May 29 2026 release on the ServiceNow Store.
...
## Suite version 29.2.20260529 - Australia Patch 2

|App name|Version number|Release notes|
|--------|--------------|-------------|
|Now Assist in AI Search|16.1.4|Fixed: Fixed an issue where malformed JSON caused Virtual Agent \(VA\) to fail when Multi-Content Response Genius Results included catalog items.|
...
## Suite version 28.9.20260529 - Zurich Patch 9
