---
title: Field Service Capacity and Reservations Management release notes
description: Version history for the ServiceNow Field Service Capacity and Reservations Management application on the ServiceNow Store.
locale: en-US
...
-   **Version 30.0.3 - March 2026**
    -   Field Service Capacity and Reservations Management gives field service organizations a rules-based way to plan, reserve, and distribute work across internal technicians and contractor teams based on defined capacity — not manual judgment or whoever has an open slot.
