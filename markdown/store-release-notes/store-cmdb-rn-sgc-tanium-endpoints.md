---
title: Service Graph Connector for Tanium Endpoints release notes
description: Version history for the ServiceNow Service Graph Connector for Tanium Endpoints application on the ServiceNow Store.
locale: en-US
