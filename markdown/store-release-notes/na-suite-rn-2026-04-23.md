---
title: April 23 2026 Now Assist Suite release notes
description: Now Assist Suite version and compatibility information for the April 23 2026 release on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/na-suite-rn-2026-04-23.html
release: store
...
# April 23 2026 Now Assist Suite release notes

Now Assist Suite version and compatibility information for the April 23 2026 release on the ServiceNow Store.
...
## Suite version 28.8.20260423 - Zurich Patch 8
...
This hotfix release contains targeted defect fixes only. No new features or enhancements are included.
...
New:
 ...
 -   Availability of 3 new Now Assist Guardian filters -
    -   Active Data Loss or security breach
    -   Threatening legal action
    -   Reputational incident/issue
-   Support for product tiers
...
Hot fix for enabling UI Builder Agent
...
Following issues were addressed
 ...
 -   Due to a failure in the Critique Utility tool, the evidence extraction and scoring process incorrectly classifies the task as non-RCA
-   Incorrect Routing to Human Support via Mandatory Override \(access related tickets\)
-   Resolution notes contain helpful resources that the caller of the incident doesn't have access to
-   Fetch Template Notes tool uses worker\_id lookup instead of config-based response\_templates\_mapping
-   ITSM changes for April Hotfix
-   ZTSDCaseUtil.removeHTMLTags should also convert HTML entities like '&gt;' and '&lt;' into '&gt;' and '&lt;'
-   processTaskType function method is called but is not defined anywhere in the script.
-   Routing Issue - not honouring the decision criteria
-   Agent Interactive Counter Increment is skipped if extension point preResolutionValidation is stopping the default comment update route
-   ResumeZTSD to support customer reply as argument to support customization and also prefix "customer reply" to actual reply to reinforce customer reply sentiment

</td></tr></tbody>
</table>|App name|Version number|Last updated|
|--------|--------------|------------|
|@servicenow/sn-ai-engagement-experience|3.1.2|2026-04-17|
...
|Build Agent \(Trial\)|2.1.7|2026-04-17|
|Build Agent Premium|1.1.7|2026-04-17|
...
|Microsoft Azure OpenAI Generative AI Spoke|3.10.0|2026-04-09|
...
|Now Assist context menu|3.3.7|2026-04-17|
...
|Now Assist for Contract Analysis|1.0.6|2026-04-09|
...
## Suite version 28.8.20260423 - Australia Patch 1

<table id="table_ihh_v5w_bjc"><thead><tr><th>
...
|Insights Clustering Utils|2.0.2|2026-03-12|
|Integrated Risk Management Advanced|22.1.6|2026-04-09|
|Integrated Risk Management Foundation|22.1.2|2026-04-09|
|Integrated Risk Management Prime|22.1.3|2026-04-09|
|IRM Compliance GenAI|22.0.1|2026-03-12|
|IRM Risk GenAI|22.0.1|2026-03-12|
|IT Service Management AI voice agent collection|1.2.0|2026-04-09|
...
|Now Assist for Sales and Order Management for Telecommunications|2.0.7|2026-04-09|
|Now Assist for Sales Force Automation \(SFA\)|1.1.1|2026-04-09|
|Now Assist for Security Incident Response \(SIR\)|6.0.0|2026-04-09|
|Now Assist for Security Incident Response \(SIR\) Advanced|1.0.1|2026-04-09|
|Now Assist for Security Incident Response \(SIR\) Foundation|1.0.2|2026-04-09|
|Now Assist for Security Incident Response \(SIR\) Prime|1.0.1|2026-04-09|
|Now Assist for Security Incident Response integrations|1.1.1|2026-01-20|
|Now Assist for Service Exchange|1.0.12|2026-04-09|
|Now Assist for Setup|2.0.7|2026-04-09|
|Now Assist for Setup Core|1.0.6|2026-04-09|
...
|Privacy Management Advanced|22.1.4|2026-04-09|
|prompt-management|1.0.11|2026-03-12|
