---
title: May 28 2026 Now Assist Suite release notes
description: Now Assist Suite version and compatibility information for the May 28 2026 release on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/na-suite-rn-2026-05-28.html
release: store
...
# May 28 2026 Now Assist Suite release notes

Now Assist Suite version and compatibility information for the May 28 2026 release on the ServiceNow Store.
...
## Suite version 29.1.20260528 - Australia Patch 1

|App name|Version number|Release notes|
|--------|--------------|-------------|
|@servicenow/sn-ai-engagement-experience|3.1.3|Includes part of a fix to reduce Multiple angular.do?sysparm\_type=message API calls from AI Engagement Experience plugin|
|Build Agent Premium|1.1.9|Fixed: Improved reliability of opening Build Agent from developer portal links that include a prompt. The ServiceNow IDE now opens more consistently, and the prompt is more reliably carried into the Build Agent chat.|
...
## Suite version 28.8.20260528 - Zurich Patch 8
