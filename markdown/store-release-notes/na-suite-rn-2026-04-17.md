---
title: April 17 2026 Now Assist Suite release notes
description: Now Assist Suite version and compatibility information for the April 17 2026 release on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/na-suite-rn-2026-04-17.html
release: store
...
# April 17 2026 Now Assist Suite release notes

Now Assist Suite version and compatibility information for the April 17 2026 release on the ServiceNow Store.
...
## Suite version 28.7.20260416 - Zurich Patch 7
...
Bug fixes: -   Fix enlarged UI size in UI16 when Polaris is switched off
-   Change summarization is missing when Explain risk is also activated on the record
...
## Suite version 28.8.20260417 - Zurich Patch 8

<table id="table_fgm_msw_bjc"><thead><tr><th>
...
Fixed defect to Confirm button is present in autonomous mode and Incident going back to In progress from resolved state after confirming
...
Key benefits:
 ...
 -   Enhanced Efficiency: Quickly access tailored action plans to reduce resolution times, boost productivity, and improve customer satisfaction.
-   Intelligent Guidance: Leverage historical data and AI-driven insights to receive reliable recommendations for the next best action.
-   Consistent Outcomes: Ensure quality and adherence to best practices by following structured, data-backed recommendations.
-   Seamless Experience: Easily configure AI agents with the right tools and agentic workflows for a smooth deployment.
...
|Assist Order Management AI Agent|1.0.1|2026-03-12|
|ATF troubleshooting agent|1.0.6|2026-03-12|
|Build Agent Premium|1.1.4|2026-04-09|
...
|IRM Compliance GenAI|22.0.1|2026-03-12|
|IRM Risk GenAI|22.0.1|2026-03-12|
|IT Service Management AI agent collection|7.0.5|2026-04-09|
...
|Now Assist for Customer Service Management \(CSM\)|12.1.0|2026-04-09|
|Now Assist for Digital End-user Experience \(DEX\)|4.1.2|2026-04-09|
|Now Assist for Employee Center Pro|1.1.9|2025-12-11|
...
|Now Assist for IT Service Management \(ITSM\)|13.0.10|2026-04-09|
