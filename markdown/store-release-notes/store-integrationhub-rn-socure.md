---
title: Socure spoke release notes
description: Version history for the Socure spoke integration on the ServiceNow Store.
locale: en-US
...
-   **Version 1.1.1 - November 2022**
    ...
    Fixed: Fixed the "Lookup watchlist" action.

-   **Version 1.1.0 - August 2022**
    -   New:
        -   Added new tables for storing responses from Socure for the Fraud score
        -   Added new action to consume the fraud score from Socure
-   **Version 1.0.0 - May 2022**
    -   The Socure spoke provides a list of actions to help companies perform required due diligent activities for onboarding new customers.
