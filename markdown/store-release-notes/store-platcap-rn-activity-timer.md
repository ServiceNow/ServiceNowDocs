---
title: Activity Timer release notes
description: Version history for the ServiceNow Activity Timer application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-platcap-rn-activity-timer.html
release: store
...
Version history for the ServiceNow® Activity Timer application on the ServiceNow Store.

**Important:** For details on system requirements and family compatibility, view the application listing on the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website.

-   **Version 2.0.3 - June 2026**

    Fixed: PRB2017916 reduce DB queries
