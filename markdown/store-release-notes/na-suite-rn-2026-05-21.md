---
title: May 21 2026 Now Assist Suite release notes
description: Now Assist Suite version and compatibility information for the May 21 2026 release on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/na-suite-rn-2026-05-21.html
release: store
...
# May 21 2026 Now Assist Suite release notes

Now Assist Suite version and compatibility information for the May 21 2026 release on the ServiceNow Store.
...
## Suite version 28.8.20260521 - Zurich Patch 8
...
-   Changed:
    -   Licensing profile for External Content Connector AI Agent
    -   Version dependency on External Content Connector apps from 7.0.5 to 7.0.6
-   Fixed: Subscription profiles issue which resulted in an incorrect plugin ID
...
Fixed: Fixed an issue where Azure OpenAI LLM calls were failing with an "Unexpected token: o" error.
...
## Suite version 28.9.20260521 - Zurich Patch 9
...
## Suite version 29.1.20260521 - Australia Patch 1

<table id="table_vnk_z1b_bkc"><thead><tr><th>
...
## Suite version 29.2.20260521 - Australia Patch 2

<table id="table_a4k_z1b_bkc"><thead><tr><th>
