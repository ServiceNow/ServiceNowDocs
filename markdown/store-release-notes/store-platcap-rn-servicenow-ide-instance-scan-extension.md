---
title: ServiceNow IDE Instance Scan extension release notes
description: Version history for the ServiceNow ServiceNow IDE Instance Scan extension application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-platcap-rn-servicenow-ide-instance-scan-extension.html
release: store
...
Version history for the ServiceNow® ServiceNow IDE Instance Scan extension application on the ServiceNow Store.
