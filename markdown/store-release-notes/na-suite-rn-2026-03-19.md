---
title: March 19 2026 Now Assist Suite release notes
description: Now Assist Suite version and compatibility information for the March 19 2026 release on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/na-suite-rn-2026-03-19.html
release: store
...
# March 19 2026 Now Assist Suite release notes

Now Assist Suite version and compatibility information for the March 19 2026 release on the ServiceNow Store.
...
## Suite version 27.11.8 - Yokohama Patch 11

|App name|Version number|Release notes|
|--------|--------------|-------------|
|Now Assist AI Agents|6.0.25|Defect fixes|
...
|Now Assist in Document Intelligence|5.0.8|2026-03-10|
...
## Suite version 27.12.2 - Yokohama Patch 12
...
## Suite version 28.5.7 - Zurich Patch 5

|App name|Version number|Release notes|
|--------|--------------|-------------|
|Now Assist AI Agents|6.1.12|Defect fixes|
|Now Assist for Software Asset Management \(SAM\)|5.2.5|We made few defect fixes in SAM workspace|
...
## Suite version 28.6.4 - Zurich Patch 6

|App name|Version number|Release notes|
|--------|--------------|-------------|
|Now Assist AI Agents|6.2.12|Defect fixes|
|Now Assist for Software Asset Management \(SAM\)|5.2.5|We made few defect fixes in SAM workspace|
...
## Suite version 28.7.1 - Zurich Patch 7

|App name|Version number|Release notes|
|--------|--------------|-------------|
|Now Assist AI Agents|7.0.8|Defect fixes|
...
|Form data collector|2.0.0|2025-12-11|
|Generative AI Controller|13.0.3|2026-03-12|
...
## Suite version 29.0.1 - Australia Early Availability \(Patch 0\)
...
|Model Context Protocol Server|1.1.3|2026-01-22|
|Notifications Email Agents|1.0.7|2025-12-11|
|Now Assist Admin Console|7.0.12|2025-12-11|
|Now Assist Agents for requestor|3.0.9|2026-01-20|
|Now Assist AI Helper - Galileo Inside|2.1.2|2025-10-16|
|Now Assist AI web agent|29.0.7|2025-12-11|
