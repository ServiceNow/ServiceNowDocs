---
title: Order Case Playbook release notes
description: Version history for the Order Case Playbook application on the ServiceNow Store.
locale: en-US
...
-   **Version 1.5.2 - April 2026 \(Yokohama\)**

    Fixed: Improved user experience in the create order case workflow.

-   **Version 1.5.1 - April 2026**

    Fixed: Improved user experience in the create order case workflow.

-   **Version 1.4.3 - January 2026 \(Zurich\)**

    No feature changes.

-   **Version 1.4.2 - January 2026 \(Yokohama\)**

    No feature changes.

-   **Version 1.4.1 - December 2025 \(Zurich\)**
