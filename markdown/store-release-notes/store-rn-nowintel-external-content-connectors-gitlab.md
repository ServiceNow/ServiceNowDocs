---
title: External Content Connectors GitLab release notes
description: Version history for the External Content Connectors GitLab application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-nowintel-external-content-connectors-gitlab.html
release: store
