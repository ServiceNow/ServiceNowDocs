---
title: ITAM Procurement Integration release notes
description: Version history for the ITAM Content Library Portal application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-itam-procurement-integration.html
release: store
...
-   **Version 1.0.1 - November 2024**
    -   Fixed:
        -   Minor bug fixes.
        -   The Purchase Order number on the entitlement import error and the Purchase Order Line Item is auto-populated.
