---
title: June 04 2026 Now Assist Suite release notes
description: Now Assist Suite version and compatibility information for the June 04 2026 release on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/na-suite-rn-2026-06-04.html
release: store
...
# June 04 2026 Now Assist Suite release notes

Now Assist Suite version and compatibility information for the June 04 2026 release on the ServiceNow Store.
...
## Suite version 29.1.20260604 - Australia Patch 1

|App name|Version number|Release notes|
|--------|--------------|-------------|
|AI Agent Advisor|1.0.2|Changed: The schedule at which AI Agent Advisor analyses data now dynamically aligns with the installation date of the app, replacing the previous fixed-date framework. This adjustment alleviates load spikes on ServiceNow infrastructure components, ensuring smoother operations and reduced latency for end-users.|
...
## Suite version 29.2.20260604 - Australia Patch 2

|App name|Version number|Release notes|
|--------|--------------|-------------|
|AI Agent Advisor|1.0.2|Changed: The schedule at which AI Agent Advisor analyses data now dynamically aligns with the installation date of the app, replacing the previous fixed-date framework. This adjustment alleviates load spikes on ServiceNow infrastructure components, ensuring smoother operations and reduced latency for end-users.|
|Now Assist in Virtual Agent|18.0.13|Delete Now Assist panel duplicate channels for a single assistant and prevent future duplicate channels from being created.|
...
## Suite version 28.8.20260604 - Zurich Patch 8
...
## Suite version 28.9.20260604 - Zurich Patch 9
