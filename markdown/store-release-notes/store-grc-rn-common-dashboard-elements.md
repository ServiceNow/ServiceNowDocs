---
title: GRC: Common Dashboard Elements release notes
description: Version history for the GRC: Common Dashboard Elements application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-grc-rn-common-dashboard-elements.html
release: store
...
# GRC: Common Dashboard Elements release notes

Version history for the GRC: Common Dashboard Elements application on the ServiceNow Store.
...
-   **Version 22.0.0 - March 2026**
    -   Fixed:
        -   Risk posture drill downs on CISO dashboard
        -   Control objective workflow changes impact
-   **Version 18.1.4 - June 2024**

    Common elements that enable reporting for all ServiceNow Risk products including: Integrated Risk Management, Business Continuity Management, Third-party Risk Management, and Privacy Management.
