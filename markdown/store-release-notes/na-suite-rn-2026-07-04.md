---
title: July 04 2026 Now Assist Suite release notes
description: Now Assist Suite version and compatibility information for the July 04 2026 release on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/na-suite-rn-2026-07-04.html
release: store
...
# July 04 2026 Now Assist Suite release notes

Now Assist Suite version and compatibility information for the July 04 2026 release on the ServiceNow Store.
...
## Suite version 28.10.20260704 - Zurich Patch 10

|App name|Version number|Release notes|
|--------|--------------|-------------|
|Now Assist AI Agents|8.0.12|This release contains minor fixes to address runtime issues with AI specialists.|
...
## Suite version 29.3.20260704 - Australia Patch 3
