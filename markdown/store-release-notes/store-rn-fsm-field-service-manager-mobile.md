---
title: Field Service Manager Mobile release notes
description: Version history for the ServiceNow Field Service Manager Mobile application on the ServiceNow Store.
locale: en-US
...
-   **Version 1.0.5 - March 2026**
    -   Field Service Manager Mobile is built for enterprise field service managers who run large technician workforces across telecom, utilities, healthcare, facilities, retail, and food service. Right now, most managers spend 5–10% of their time in the field because dispatching, reassignments, approvals, and performance tracking all require a desktop. That keeps managers office-bound, which slows coaching, delays operational decisions, and limits their visibility into what's actually happening on the ground.
