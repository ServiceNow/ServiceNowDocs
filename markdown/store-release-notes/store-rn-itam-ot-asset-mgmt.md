...
-   **Version 2.2.1 - September 2026**
    ...
    Changed: Updated application dependency versions to align with the latest supported version of Enterprise Asset Management, Hardware Asset Management, Operational Technology Core, and ISA Equipment Model releases.
