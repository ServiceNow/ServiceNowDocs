...
description: Version history for the HR Service Delivery Listening Posts on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-hr-listening-posts.html
release: store
...
-   **Version 5.4.5 - May 2025**
    -   Fixed:
        -   Fixed listening\_posts\_survey\_list widget behavior when widget is placed in a column with a width of 6 or less
...
-   **Version 5.1.0 - February 2023**
    -   -   Fixed:
    -   Now Mobile MESP hrm\_todos\_page for listening post feedback page to polaris look
    -   Listening post recordwatcher watching the entire sn\_hr\_core\_task causing performance issues on ticket pag
...
-   **Version 5.0.2 - January 2023**
    -   Fixed:
        -   Now Mobile Employee Service Portal hrm\_todos\_page for listening post feedback.
        -   Listening post recordwatcher watching the entire sn\_hr\_core\_task causes performance issues on ticket page.
...
-   **Version 1.0.4 - January 2021**
    -   ServiceNow Listening Posts helps you capture employee feedback across various touch points, gain insights, and take action quickly to improve the employee service experience.
