---
title: May 15 2026 Now Assist Suite release notes
description: Now Assist Suite version and compatibility information for the May 15 2026 release on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/na-suite-rn-2026-05-15.html
release: store
...
# May 15 2026 Now Assist Suite release notes

Now Assist Suite version and compatibility information for the May 15 2026 release on the ServiceNow Store.
...
## Suite version 29.1.20260515 - Australia Patch 1

**Note:** Zero Touch Service Desk was removed in this version.
...
|AI Agent Advisor|1.0.1|2026-05-05|
...
|Care Team Operations AI agent collection|1.0.3|2026-04-09|
...
|HCLS - Foundation|1.0.1|2026-04-09|
...
|IT Service Management AI agent collection|7.1.2|2026-05-08|
...
|ITSM - Advanced|1.0.7|2026-05-08|
|ITSM - Foundation|1.0.7|2026-05-08|
|ITSM - Prime|1.0.8|2026-05-08|
...
|Microsoft Azure OpenAI Generative AI Spoke|3.11.0|2026-05-05|
...
|Now Assist for Digital End-user Experience \(DEX\)|4.2.2|2026-05-08|
...
|Now Assist for IT Service Management \(ITSM\)|13.1.2|2026-05-08|
...
## Suite version 29.2.20260515 - Australia Patch 2

**Note:** Zero Touch Service Desk and ITSM MCP Server were removed in this version.

<table id="table_fjw_nzp_gjc"><thead><tr><th>
...
Fixed: LEAP installs and upgrades no longer slow down on large instances; role configuration now runs silently in the background eliminating the performance impact.
...
-   Changed
    -   Change Request Risk Explanation - Skill configuration moved to NASK
    -   Change Request Summarization - Skill configuration moved to NASK
    -   SDS Avatar Update - Updated to align with design standards for a more cohesive visual presence across configuration pages and incident records.
...
The ITSM MCP Server is now available as a standalone application, decoupled from the Now Assist for ITSM bundle to provide greater deployment flexibility.
...
|AI Agents for Health and Safety|1.3.2|2026-05-05|
|AI Agents for ITAM|4.1.0|2026-04-09|
|AI agents for Observability|5.0.4|2026-03-12|
|AI Agents for Service Exchange Provider|1.0.12|2026-04-09|
...
|DocIntel Vision AI Agent|1.0.2|2026-04-09|
|Document Intelligence for Contract Management Content Pack|1.4.1|2026-03-12|
|Dynamic Guidance|28.3.1|2026-05-05|
|Enterprise Architecture - Advanced|1.0.0|2026-04-09|
|Enterprise Architecture - Prime|1.0.0|2026-04-09|
|Enterprise Asset Management Advanced|1.0.0|2026-04-09|
|Enterprise Asset Management for DCNAM Advanced|1.0.0|2026-04-09|
...
|HR Talent AI Agent Collection|4.1.0|2026-04-09|
|HR Voice AI Agents|2.3.4|2026-05-05|
|HRSD - Advanced|1.0.5|2026-04-17|
|HRSD - Prime|1.0.5|2026-04-17|
|IBM watsonx Spoke|1.0.4|2025-01-30|
...
|ITOM Configuration Console|28.0.3|2026-05-05|
|ITSM Admin Experience|2.1.0|2026-05-05|
...
|Now Assist for Hardware Asset Management|4.1.0|2026-04-09|
|Now Assist for Health and Safety|1.3.2|2026-05-05|
|Now Assist for HLA|1.0.1|2026-03-12|
...
|Now Assist in Virtual Agent|18.0.11|2026-05-08|
|Now Assist in Virtual Agent Configurations|12.0.2|2026-04-09|
|Now Assist Platform Skills|2.4.3|2026-03-12|
...
## Suite version 28.8.20260515 - Zurich Patch 8
...
## Suite version 28.9.20260515 - Zurich Patch 9

**Note:** Zero Touch Service Desk and ITSM MCP Server were removed in this version.

|App name|Version number|Release notes|
|--------|--------------|-------------|
|AIOps LEAP|3.3.1|Fixed: LEAP installs and upgrades no longer slow down on large instances; role configuration now runs silently in the background eliminating the performance impact.|
|Now Assist for IT Service Management \(ITSM\)|14.0.6|The ITSM MCP Server is now available as a standalone application, decoupled from the Now Assist for ITSM bundle to provide greater deployment flexibility.|
