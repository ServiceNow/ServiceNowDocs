...
-   **Version 4.0.1 - June 2026**
    -   New:
        -   Fallout creation AI Agent - This will be automatically generate fallouts in the correct category depending on the Notes/Comments on the Task.
...
-   **Version 2.0.4 - March 2026**

    New: Voice AI Agent for Move Order will help in capturing a move order request via a Voice AI Agent

-   **Version 1.0.2 - January 2026**

    Minor defect fix for the fulfillment AI agent where GAF role was missing.

-   **Version 1.0.1 - December 2025**
    -   Now Assist for Sales and Order management for telecommunications will help our telecom customers to accelerate product launch by reducing the complexity of defining order fulfillment plan during design time.
