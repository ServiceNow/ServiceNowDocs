...
-   **Version 3.6.4 - August 2026**
    ...
    Fixed an issue where the GitHub Spoke webhook callback used deprecated HMAC-SHA1 signature validation instead of HMAC-SHA256, which could allow signature forgery and execution of sub-flows with attacker-controlled inputs.
