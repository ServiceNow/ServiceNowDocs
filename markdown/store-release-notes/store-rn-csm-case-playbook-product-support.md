---
title: Case Playbook for Product Support release notes
description: Version history for the Customer Service Management Case Playbook for Product Support on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-csm-case-playbook-product-support.html
release: store
