---
title: Performance Analytics - Content Engagement Analytics release notes
description: Version history for the Performance Analytics - Content Engagement Analytics application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-hr-pa-content-engagement-analytics.html
release: store
...
-   **Version 30.1.1 - June 2026 \(Zurich\)**

    Updated to support the latest version of the dependent apps.

-   **Version 30.1.0 - June 2026 \(Australia\)**

    Updated to support the latest version of the dependent apps.

-   **Version 30.0.4 - February 2025**
