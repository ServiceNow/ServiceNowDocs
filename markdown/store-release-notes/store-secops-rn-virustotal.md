...
-   **Version 10.4.3 - September 2026**

    Fixed: VirusTotal integration configuration no longer logs a spurious "cap impl exec Id" error when the configuration is saved successfully with no errors displayed in the UI.
