---
title: Atlassian Administration Spoke release notes
description: Version history for the Atlassian Administration Spoke application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-itam-atlassian-admin-spoke.html
release: store
