...
-   **Version 15.0.4 - September 2026**

    New: Recommended actions now support new guidances, 'Attach Knowledge' and 'Relevant Case' for AI Search results that surface on the CRM workspace.
