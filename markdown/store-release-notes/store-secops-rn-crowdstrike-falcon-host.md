---
title: CrowdStrike Falcon Host for Security Operations release notes
description: Version history for the CrowdStrike Falcon Host for Security Operations on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-secops-rn-crowdstrike-falcon-host.html
release: store
...
# CrowdStrike Falcon Host for Security Operations release notes
