---
title: Live CI View release notes
description: Version history for the Live CI View application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-itom-live-ci-view.html
release: store
...
-   **Version 19.1.2 - May 2023**

    No significant changes.

-   **Version 19.0.1 - February 2022**
