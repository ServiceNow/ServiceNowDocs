---
title: PSDS - Prime release notes
description: Version history for the ServiceNow PSDS - Prime application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-public-sector-psds-prime.html
release: store
...
-   **Version 1.0.1 - April 2026**
    -   PSDS Prime enables the broadest set of AI capabilities to be available within Public Sector Digital Services in alignment with ServiceNow’s product tier packaging approach.
