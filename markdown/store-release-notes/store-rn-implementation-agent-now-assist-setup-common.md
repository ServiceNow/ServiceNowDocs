---
title: ServiceNow Otto for Setup Common release notes
description: Version history for the ServiceNow ServiceNow Otto for Setup Common application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-implementation-agent-now-assist-setup-common.html
release: store
...
# ServiceNow Otto for Setup Common release notes

Version history for the ServiceNow® ServiceNow Otto for Setup Common application on the ServiceNow Store.
