---
title: Roadmap UI Builder Component release notes
description: Version history for the Roadmap UI Builder Component on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-itbm-rn-roadmap-ui-builder.html
release: store
...
Version history for the Roadmap UI Builder Component on the ServiceNow Store.

**Important:** For details on system requirements and family compatibility, view the application listing on the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website.

## Version history

-   **Version 19.0.2 - February 2021**
