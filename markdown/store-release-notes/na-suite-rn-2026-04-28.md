---
title: April 28 2026 Now Assist Suite release notes
description: Now Assist Suite version and compatibility information for the April 28 2026 release on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/na-suite-rn-2026-04-28.html
release: store
...
# April 28 2026 Now Assist Suite release notes

Now Assist Suite version and compatibility information for the April 28 2026 release on the ServiceNow Store.
...
## Suite version 28.8.20260430 - Zurich Patch 8
...
Includes part of a fix to reduce Multiple angular.do?sysparm\_type=message API calls from AI Engagement Experience plugin
...
Fixed: Improved reliability of opening Build Agent from developer portal links that include a prompt. The ServiceNow IDE now opens more consistently, and the prompt is more reliably carried into the Build Agent chat.
...
|IT Service Management AI agent collection|7.0.6|2026-04-23|
...
|Now Assist AI Agents|7.1.36|2026-04-23|
...
|Now Assist for IT Service Management \(ITSM\)|13.0.11|2026-04-23|
...
|Zero Touch Service Desk|2.0.14|2026-04-23|
