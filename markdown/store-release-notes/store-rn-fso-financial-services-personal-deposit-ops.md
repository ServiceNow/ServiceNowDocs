---
title: Financial Services Personal Deposit Operations release notes
description: Version history for the Financial Services Personal Deposit Operations application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-fso-financial-services-personal-deposit-ops.html
release: store
...
-   **Version 2.4.1 - August 2023**
    ...
    Fixed: The landing page's case report filter condition for the assignment group field has been revised to be dynamic.
...
-   **Version 2.2.0 - November 2022**
    -   New: Add the business location functionality
