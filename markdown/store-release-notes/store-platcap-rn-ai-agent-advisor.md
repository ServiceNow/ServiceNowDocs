...
description: Version history for the ServiceNow AI Agent Advisor application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-platcap-rn-ai-agent-advisor.html
release: store
...
Version history for the ServiceNow® AI Agent Advisor application on the ServiceNow Store.
...
-   **Version 1.0.1 - May 2026**
    -   AI Agent Advisor is a generative AI feature that helps you unlock the full potential of AI agents across your organization. It works in three steps:Mine your Incident and Case data to discover your highest-impact automation opportunities;Match those opportunities against ServiceNow's library of AI agents or your custom agents and tools; andMake custom agents tailored to your unique workflows — all powered by AI analysis of your actual operational data.
    -   Important: AI Agent Advisor is the backend engine and must be paired with Now Assist Center for the full experience. If you're looking for AI Agent Advisor, install Now Assist Center; AI Agent Advisor will install automatically as part of it.
