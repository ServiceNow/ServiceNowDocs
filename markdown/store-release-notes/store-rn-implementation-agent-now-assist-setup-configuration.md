---
title: ServiceNow Otto for Setup Configuration release notes
description: Version history for the ServiceNow ServiceNow Otto for Setup Configuration application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-implementation-agent-now-assist-setup-configuration.html
release: store
...
# ServiceNow Otto for Setup Configuration release notes

Version history for the ServiceNow® ServiceNow Otto for Setup Configuration application on the ServiceNow Store.
