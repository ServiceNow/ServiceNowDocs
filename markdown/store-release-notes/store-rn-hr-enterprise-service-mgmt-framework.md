...
-   **Version 3.10.0 - July 2026**
    ...
    Changed: A delta\_tokens name-value pairs column has been added to the sn\_hr\_integr\_fw\_service\_job\_tracker table to support OData Change Tracking delta-token storage for incremental data retrieval.
