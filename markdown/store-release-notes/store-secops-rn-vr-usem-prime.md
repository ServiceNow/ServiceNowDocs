---
title: USEM - Prime release notes
description: Version history for the ServiceNow USEM - Prime application on the ServiceNow Store.
locale: en-US
...
Version history for the ServiceNow® USEM - Prime application on the ServiceNow Store.
