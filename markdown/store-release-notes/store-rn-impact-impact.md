...
description: Version history for the Impact application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-impact-impact.html
release: store
...
Version history for the Impact application on the ServiceNow Store.

**Important:** For details on system requirements and family compatibility, view the application listing on the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website.

## Version history

-   **Version 9.0.6 - July 2026**
...
-   **Version 8.0.10 - June 2026**
    -   What's New Starting June 11th:
        ...
        -   Analytics Dashboard You can now select any segment of the donut chart to drill into the findings behind it. The heatmap has been updated to meet accessibility standards, making results easier to read for everyone. Dashboard data now refreshes in near real-time, with status updates so you always know where things stand.
        -   Scan Engine Backend Each flagged finding in an update set now requires its own exception reason, so nothing gets ignored. A new tooltip on the Level of Finding field explains Act, Recommend, Suggest, and Review in context, without needing to look it up.
        -   7 New Technical Accelerators Seven new Accelerators are available across all Impact packages: AI Data Explorer, AI Control Tower \(AI Lifecycle\), Now Assist in Virtual Agent, ServiceNow Vault, Enterprise Architecture Workspace, Software Asset Management, and ITSM Foundation.
-   **Version 7.1.3 - April 2026**
    1.  Stability fixes
...
-   **Version 5.2.0 - October 2025**

    Minor bug fixes.

-   **Version 5.1.7 - September 2025 \(Zurich\)**
    1.  Updated accelerator definitions
    2.  Success architect role renamed to customer success executive.
-   **Version 5.1.6 - September 2025 \(Xanadu and Yokohama\)**
    1.  Updated accelerator definitions
    2.  Success architect role renamed to customer success executive.
-   **Version 5.0.5 - August 2025 \(Zurich\)**
    -   New:
...
-   **Version 5.0.4 - August 2025 \(Xanadu and Yokohama\)**
    -   New:
        -   Automated registration to seamlessly onboard customers
        -   Introduced Value Reports
        -   Refactoring recommendations to reduce noise
...
-   **Version 3.1.2 - March 2025**
    ...
    ServiceNow Impact is a customer success product powered by AI and human expertise that helps customers maximize the power of the AI Platform for business transformation. Impact provides customers with the support and expertise they need to get to value fast. Add the app to your instance today.
