---
title: Threat Intelligence Support Common UI Components release notes
description: Version history for the Threat Intelligence Support Common UI Components application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-secops-rn-threat-intel-common-ui-components.html
release: store
...
-   **Version 1.1.6 - September 2026**
    ...
    Fixed:Added labels to buttons in heatmap
