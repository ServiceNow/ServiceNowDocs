---
title: Lenovo spoke release notes
description: Version history for the Lenovo Spoke application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-lenovo-spoke.html
release: store
...
-   **Version 1.0.0 - February 2024**
    ...
    Lenovo Spoke will connect your Service Now instance to Lenovo's API.
