---
title: Employee Readiness Surveys release notes
description: Version history for the Safe Workplace Employee Readiness Surveys application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-hr-employee-readiness-surveys.html
release: store
...
# Employee Readiness Surveys release notes

Version history for the Safe Workplace Employee Readiness Surveys application on the ServiceNow Store.
...
-   **Version 1.5.3 - August 2025**

    Changed: Minor ACL updates

-   **Version 1.5.2 - November 2022**

    Fixed: Minor changes to align to quality standards
