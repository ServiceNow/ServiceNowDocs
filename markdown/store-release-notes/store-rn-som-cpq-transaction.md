---
title: CPQ Transaction release notes
description: Version history for the ServiceNow CPQ Transaction application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-som-cpq-transaction.html
release: store
...
-   **Version 1.0.0 - July 2026**
    ...
    The CPQ Transaction application provides components necessary for Quote Experience.
