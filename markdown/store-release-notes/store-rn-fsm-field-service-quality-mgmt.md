---
title: Field Service Quality Management release notes
description: Version history for the ServiceNow Field Service Quality Management application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-fsm-field-service-quality-mgmt.html
release: store
...
-   **Version 29.1.1 - March 2026**
    -   Field Service Quality Management adds a review gate between task completion and final close — so quality issues, missing data, and incomplete work get caught and corrected before a work order is officially closed, not discovered after the fact through callbacks or customer complaints.
