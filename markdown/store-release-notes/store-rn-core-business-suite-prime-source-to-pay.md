---
title: Core Business Suite Prime for Source to Pay release notes
description: Version history for the ServiceNow Core Business Suite Prime for Source to Pay application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-core-business-suite-prime-source-to-pay.html
release: store
...
-   **Version 3.0.0 - April 2026**
    ...
    Core Business Suite Prime includes the highest tier of AI-native capabilities for the Source to Pay department.
