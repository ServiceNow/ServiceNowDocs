---
title: DevOps Pipeline release notes
description: Version history for the ITSM DevOps Pipeline application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-devops-pipeline.html
release: store
...
Version history for the ITSM DevOps Pipeline application on the ServiceNow Store.

**Important:** For details on system requirements and family compatibility, view the application listing on the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website.

## Version history

-   **Version 21.0.5 - August 2022**
    -   When the new DevOps Change Velocity app is installed, both DevOps Data Workspace and DevOps Insights are installed as dependencies. Starting with release 1.31, whether you are upgrading an existing ServiceNow DevOps version or installing it new, please install the DevOps Change Velocity app. DevOps Change Velocity simplifies and streamlines your DevOps install experience.
