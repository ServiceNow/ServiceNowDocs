---
title: External Content Connectors Box release notes
description: Version history for the External Content Connectors Box application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-nowintel-external-content-connectors-box.html
release: store
...
# External Content Connectors Box release notes
