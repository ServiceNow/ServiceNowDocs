...
-   **[Browser Extension for Employee Center release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-esm-browser-extension-employee-center.md)**  
Version history for the Browser Extension for Employee Center application on the ServiceNow Store.
-   **[Employee Center release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-hr-employee-center.md)**  
Version history for the Employee Center application on the ServiceNow Store.
-   **[Employee Center for Microsoft Viva Connections release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-esm-employee-center-msft-viva.md)**  
Version history for the on the ServiceNow Store.
-   **[Employee Center Pro release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-hr-employee-center-pro.md)**  
Version history for the Employee Center Pro application on the ServiceNow Store.
-   **[Employee Center Pro Kiosk release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-hr-employee-center-pro-kiosk.md)**  
Version history for the Employee Center Pro Kiosk application on the ServiceNow Store.
-   **[Employee Slate Advanced release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-esm-employee-slate-advanced.md)**  
