---
title: Impact Value Management - App Engine release notes
description: Version history for the Impact Value Management - App Engine application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-plat-app-engine-impact-value-mgmt.html
release: store
...
# Impact Value Management - App Engine release notes
...
-   **Version 2.0.0 - December 2024**
    -   The Impact Value Management Data Collection Dashboard for App Engine gives Impact customers an automated solution for gathering standard ServiceNow value metrics, enhancing their value journey.
