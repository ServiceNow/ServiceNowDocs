...
-   **[Security Operations Setup Assistant release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-secops-rn-setup-assistant.md)**  
Version history for the Security Operations Setup Assistant on the ServiceNow Store.
-   **[System Events and Jobs Dashboard release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-plat-sys-events-jobs-dashboard.md)**  
Version history for the System Events and Jobs Dashboard on the ServiceNow Store.
-   **[Unified Security Exposure Management release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-secops-rn-unified-security-exposure-mgmt.md)**  
Version history for the ServiceNow® Unified Security Exposure Management application on the ServiceNow Store.
