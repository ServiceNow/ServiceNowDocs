...
-   **Version 1.4.0 - May 2024**
    -   New: Request changes functionality for reviewing and finalizing the contract documents.
    -   Changed: When the request is in Draft state, then the action button will display Resubmit. Previously, it was displayed Submit.
    -   Fixed: Start date &amp; End date fields were not displayed in the Contract Requests form in Legal Counsel Center. This is now fixed.
-   **Version 1.2.3 - March 2024**
    -   ServiceNow Legal Contracts enables enterprises to streamline the request, authoring, review, and approval of contracts for predefined contract templates such as NDAs as well as third-party review request. Legal teams can manage and process the contracts from a centralized location or cloud storage and quickly execute them by using popular eSignature integrations with a complete audit trail.
    -   Contracts Core installed with ServiceNow Legal Contracts enables you to effectively manage a library of clauses, clause variations, and word document templates. You can conveniently store and author reusable contracts templates using Word to deliver prompt services. Ensure contract consistency and compliance by using pre-approved clauses from a library. Lastly, automated email reminders keep the business well-informed and ensures that no contract expiration goes unnoticed.
