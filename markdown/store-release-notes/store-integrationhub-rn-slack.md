...
-   **Version 1.9.3 - August 2026**

    Fixed: Security vulnerability where an attacker bypassing the Slack signing secret could supply an arbitrary response\_url, causing the ServiceNow instance to make unauthorized outbound HTTP requests to internal or external URLs.

-   **Version 1.9.2 - July 2026**

    Fixed — Corrected typo \('succesful' → 'successful'\) and removed extra whitespace in SlackButtonController OOB script line 43.
