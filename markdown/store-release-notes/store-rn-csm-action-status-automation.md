---
title: Action Status Automation release notes
description: Version history for the ServiceNow Action Status Automation application on the ServiceNow Store.
locale: en-US
...
-   **Version 2.1.0 - June 2026**
    ...
    -   Security enhancements to query access controls for Action Status Automation.
