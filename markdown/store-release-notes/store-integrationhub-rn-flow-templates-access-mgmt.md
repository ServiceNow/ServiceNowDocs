---
title: Flow Templates for Access Management release notes
description: Version history for the Flow Templates for Access Management application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-flow-templates-access-mgmt.html
release: store
