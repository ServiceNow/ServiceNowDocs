...
-   **Version 27.2.6 - July 2026**
    ...
    -   Fixed:
        ...
        -   The Express List columns now display correctly in Japanese and CJK languages, resolving translation and layout issues.• The Express List live list functionality now properly triggers and updates in real time.
        ...
        -   Operators with more than five assignment groups can now see their created Enrich automations in the Enrich module.• Alerts manually removed from a group are no longer automatically re-added.
