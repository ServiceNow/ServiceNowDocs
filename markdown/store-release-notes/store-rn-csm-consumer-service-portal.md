---
title: Consumer Service Portal release notes
description: Version history for the Consumer Service Portal application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-csm-consumer-service-portal.html
release: store
...
-   **Version 23.1.3 - February 2023**
    -   The Consumer Service Portal enables business-to-consumer \(B2C\) organizations to support their customers. The portal provides out of the box self-service capabilities that customers can use to search for information or request assistance from a customer service agent.
