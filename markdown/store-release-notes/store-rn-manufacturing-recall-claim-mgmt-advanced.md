---
title: Manufacturing Recall Claim Management Advanced release notes
description: Version history for the ServiceNow Manufacturing Recall Claim Management Advanced application on the ServiceNow Store.
locale: en-US
...
-   **Version 2.1.0 - March 2026**
    -   The Manufacturing Recall Claim Management Advanced store app includes all the user experience elements required to render the recall campaign and it’s various phases and sub-phases on the CSM/FSM workspace.
