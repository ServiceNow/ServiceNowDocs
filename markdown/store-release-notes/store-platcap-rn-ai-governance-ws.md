---
title: AI Control Tower Workspace release notes
description: Version history for the AI Control Tower Workspace application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-platcap-rn-ai-governance-ws.html
release: store
...
Version history for the AI Control Tower Workspace application on the ServiceNow Store.
...
-   **Version 2.0.3 - March 2025**
    ...
    Fixes to the Unified Data model.
