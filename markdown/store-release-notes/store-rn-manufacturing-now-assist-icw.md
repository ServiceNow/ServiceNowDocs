---
title: Now Assist for ICW release notes
description: Version history for the ServiceNow Now Assist for ICW application on the ServiceNow Store.
locale: en-US
...
-   **Version 1.0.0 - May 2026**
    ...
    -   The Now Assist for ICW application allows industrial workers and leaders to:
        -   Surface the procedures and reference documents most relevant to a deviation as it is being recorded
