---
title: Complaint Case AI Agents collection release notes
description: Version history for the ServiceNow Complaint Case AI Agents collection application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-csm-complaint-case-ai-agents-collection.html
release: store
