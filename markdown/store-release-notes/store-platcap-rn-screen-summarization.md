---
title: Screen Summarization release notes
description: Version history for the ServiceNow Screen Summarization application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-platcap-rn-screen-summarization.html
release: store
...
Version history for the ServiceNow® Screen Summarization application on the ServiceNow Store.
