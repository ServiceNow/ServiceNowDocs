---
title: Quote Management for Channel Partners release notes
description: Version history for the ServiceNow Quote Management for Channel Partners application on the ServiceNow Store.
locale: en-US
...
-   **Version 3.1.1 - June 2026**
    -   Features added:
        -   Quote Lists - All quotes page
        -   Quote Analytics dashboard
-   **Version 2.1.0 - June 2026 \(Zurich\)**
    -   Features added:
        -   Quote Lists - All quotes page
        -   Quote Analytics dashboard
-   **Version 3.0.0 - March 2026 \(Australia\)**
    -   New:
        -   Introduced a new 'Quote Partner UI' experience role to enable partner staff to have a consistent experience across all interfaces.
        -   View quote summaries, quote lists, track quotes and more on workspace.
-   **Version 2.0.0 - March 2026 \(Zurich\)**

    No net new features. Added translations.
