---
title: Setup Hub Core release notes
description: Version history for the ServiceNow Setup Hub Core application on the ServiceNow Store.
locale: en-US
...
# Setup Hub Core release notes

Version history for the ServiceNow® Setup Hub Core application on the ServiceNow Store.
