---
title: ServiceNow Otto for Setup Core release notes
description: Version history for the ServiceNow ServiceNow Otto for Setup Core application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-implementation-agent-now-assist-setup-core.html
release: store
...
# ServiceNow Otto for Setup Core release notes

Version history for the ServiceNow® ServiceNow Otto for Setup Core application on the ServiceNow Store.
