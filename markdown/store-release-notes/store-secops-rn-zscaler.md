...
-   **Version 11.2.6 - September 2026**

    Fixed: Tags were being applied to observables and Security Incidents even when theDisplay Tag option was disabled. Tags are now applied only when the setting is enabled.

-   **Version 11.2.5 - July 2026**
