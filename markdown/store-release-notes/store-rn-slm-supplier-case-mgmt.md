---
title: Supplier Case Management release notes
description: Version history for the Supplier Case Management application on the ServiceNow Store.
locale: en-US
...
Version history for the Supplier Case Management application on the ServiceNow Store.
