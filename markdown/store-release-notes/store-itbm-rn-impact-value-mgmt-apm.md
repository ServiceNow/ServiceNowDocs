---
title: Impact Value Management - APM release notes
description: Version history for the Impact Value Management - APM application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-itbm-rn-impact-value-mgmt-apm.html
release: store
...
# Impact Value Management - APM release notes
...
-   **Version 2.0.0 - December 2024**
    -   The Impact Value Management Data Collection Dashboard for Application Portfolio Management \(APM\) gives Impact customers an automated solution for gathering standard ServiceNow value metrics, enhancing their value journey.
