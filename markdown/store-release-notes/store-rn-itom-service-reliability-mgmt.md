...
description: Version history for the Service Reliability Management application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-itom-service-reliability-mgmt.html
release: store
...
-   **Version 6.4.1 - September 2025**

    Fixed: Service Reliability Dashboard with bug fixes, interactive \(clickable\) events, and fix for for slo table rendering improvements.
