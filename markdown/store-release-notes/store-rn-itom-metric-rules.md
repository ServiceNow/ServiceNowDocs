---
title: Metric Rules release notes
description: Version history for the ITOM Metric Rules application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-itom-metric-rules.html
release: store
...
Version history for the ITOM Metric Rules application on the ServiceNow Store.

**Important:** For details on system requirements and family compatibility, view the application listing on the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website.

## Version history

-   **Version 1.1.4 - June 2024**
    -   Fixed:
        -   Fixing ACLs on Metric Rules page
        -   Adding menu item for Metric Rules
-   **Version 1.1.1 - April 2024**
    -   Changed:
        -   Removed support for DEX metric rules
        -   Metric rules are now included in Metric Intelligence app
