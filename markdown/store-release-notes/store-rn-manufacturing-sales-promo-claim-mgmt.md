---
title: Manufacturing Sales Promotion Claim Management release notes
description: Version history for the Manufacturing Sales Promotion Claim Management application on the ServiceNow Store.
locale: en-US
...
-   **Version 3.4.0 - June 2026 \(Zurich\)**
...
-   **Version 3.2.0 - April 2026 \(Zurich\)**
...
-   **Version 1.0.1 - May 2025**
    -   The ServiceNow Manufacturing Commercial Operations \(MCO\) application enables you to manage the end-to-end life cycle of your products, subscriptions, and services. Manufacturing Commercial Operations was improved and updated in the Yokohama release. One of the key features that is included in this release is the following:
