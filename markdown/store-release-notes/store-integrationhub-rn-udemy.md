---
title: Udemy spoke release notes
description: Version history for the Integration Hub Udemy spoke on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-udemy.html
release: store
...
-   **Version 1.0.1 - May 2021**
    ...
    Provides actions to integrate Udemy courses and user activity with ServiceNow.
