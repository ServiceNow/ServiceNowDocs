...
description: Version history for the ServiceNow Operational Technology \(OT\) Manager Foundation application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-manufacturing-now-assist-ot-manager.html
release: store
