...
-   **[Asset Audit Response release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-asset-audit-response.md)**  
Version history for the Asset Audit Response application on the ServiceNow Store.
-   **[Asset Audit Response AI Advanced release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-asset-audit-response-ai-advanced.md)**  
Version history for the ServiceNow® Asset Audit Response AI Advanced application on the ServiceNow Store.
-   **[Asset Audits release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-asset-audits.md)**  
Version history for the ServiceNow® Asset Audits application on the ServiceNow Store.
-   **[Atlassian Administration Spoke release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-atlassian-admin-spoke.md)**  
...
Version history for the Cloud Insights Billing application on the ServiceNow Store.
-   **[Cloud Spend dashboard release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-cloud-spend-dashboard.md)**  
Version history for the IT Operations Management Cloud Spend dashboard on the ServiceNow Store.
-   **[Content Library Portal release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-content-library-portal.md)**  
Version history for the ITAM Content Library Portal application on the ServiceNow Store.
-   **[EAM Demo Data release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-eam-demo-data.md)**  
Version history for the ServiceNow® EAM Demo Data application on the ServiceNow Store.
-   **[Enterprise Asset Management release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-enterprise-asset-mgmt.md)**  
Version history for the ITAM Enterprise Asset Management application on the ServiceNow Store.
-   **[Enterprise Asset Management Advanced release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-enterprise-asset-mgmt-advanced.md)**  
Version history for the ServiceNow® Enterprise Asset Management Advanced application on the ServiceNow Store.
-   **[Enterprise Asset Management for DCNAM release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-enterprise-asset-management-dcnam.md)**  
Version history for the ServiceNow® Enterprise Asset Management for DCNAM application on the ServiceNow Store.
-   **[Enterprise Asset Management for DCNAM Advanced release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-enterprise-asset-mgmt-dcnam-advanced.md)**  
Version history for the ServiceNow® Enterprise Asset Management for DCNAM Advanced application on the ServiceNow Store.
-   **[Enterprise Asset Management for Facilities release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-enterprise-asset-mgmt-facilities.md)**  
Version history for the Enterprise Asset Management for Facilities on the ServiceNow Store.
-   **[Enterprise Asset Management for Healthcare release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-enterprise-asset-mgmt-healthcare.md)**  
Version history for the Enterprise Asset Management for Healthcare application on the ServiceNow Store.
-   **[Enterprise Asset Management for Healthcare Advanced release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-enterprise-asset-mgmt-healthcare-advanced.md)**  
Version history for the ServiceNow® Enterprise Asset Management for Healthcare Advanced application on the ServiceNow Store.
-   **[Enterprise Asset Management for Providers release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-enterprise-asset-mgmt-providers.md)**  
Version history for the ServiceNow® Enterprise Asset Management for Providers application on the ServiceNow Store.
-   **[Enterprise Model and Asset Classes release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-enterprise-model-asset-classes.md)**  
Version history for the ITAM Enterprise and Asset Classes application on the ServiceNow Store.
-   **[Expanded Model and Asset Classes release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-expanded-model-asset-classes.md)**  
Version history for the Expanded Model and Asset Classes application on the ServiceNow Store.
-   **[Hardware Asset Management release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-hardware-mgnt.md)**  
...
-   **[Impact Value Management - HAM release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-impact-value-mgmt-ham.md)**  
...
-   **[Software Asset Management - SaaS License Management Foundation release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-sam-saas-license-mgmt.md)**  
...
-   **[Software Asset Management - Salesforce CRM Integration release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-integrationhub-rn-sam-salesforce-crm.md)**  
Version history for the Software Asset Management - Salesforce CRM Integration on the ServiceNow Store.
-   **[Software Asset Management - Salesforce Marketing Cloud Integration release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-salesforce-marketing-cloud.md)**  
Version history for the Software Asset Management - Salesforce Marketing Cloud Integration on the ServiceNow Store.
-   **[Software Asset Management AI Advanced release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-sam-ai-advanced.md)**  
Version history for the ServiceNow® Software Asset Management AI Advanced application on the ServiceNow Store.
-   **[Software Asset Management AI Prime release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-sam-ai-prime.md)**  
...
-   **[Software Asset Management integration with Tableau release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-software-asset-mgmt-int-tableau.md)**  
Version history for the Software Asset Management integration with Tableau application on the ServiceNow Store.
-   **[Software Asset Management integration with Workday release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-sam-integration-with-workday.md)**  
Version history for the ITAM Software Asset Management integration with Workday application on the ServiceNow Store.
-   **[Software Asset Management Playbooks and Guided Setups release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-sam-playbooks.md)**  
Version history for the IT Asset Management Software Asset Management Playbooks and Guided Setups application on the ServiceNow Store.
-   **[Software Asset Management Professional for Engineering Applications release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-sam-professional-engineering-apps.md)**  
Version history for the ServiceNow® Software Asset Management Professional for Engineering Applications application on the ServiceNow Store.
-   **[Software Asset Management Workspace release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-software-asset-mgmt-ws.md)**  
Version history for the Software Asset Management Workspace application on the ServiceNow Store.
-   **[Software Asset Workspace release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/store/markdown/store-release-notes/store-rn-itam-software-asset-ws.md)**  
