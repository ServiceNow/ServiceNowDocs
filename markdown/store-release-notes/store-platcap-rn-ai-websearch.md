---
title: AI Websearch release notes
description: Version history for the AI Websearch application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-platcap-rn-ai-websearch.html
release: store
...
Version history for the AI Websearch application on the ServiceNow Store.
