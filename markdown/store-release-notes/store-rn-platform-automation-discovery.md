---
title: Automation Discovery release notes
description: Version history for the Automation Discovery on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-platform-automation-discovery.html
release: store
...
-   **Version 2.3.2 - May 2023**
    ...
    -   Fixed: Fixed the issue where a large number of users were shown when sharing a report. The report now only shows users with the nlu\_user or nlu\_admin role.
