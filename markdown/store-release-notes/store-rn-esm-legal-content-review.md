---
title: Legal Content Review release notes
description: Version history for the Legal Content Review application on the ServiceNow Store.
locale: en-US
...
-   **Version 1.2.0 - May 2025**
    ...
    Changed: Improved Legal Content Review icon for improved space utilization in the intake form.

-   **Version 1.0.4 - June 2023**

    Fixed: New Record Producers are not automatically displayed in the ESC portal when new customers install Legal Content Review.
