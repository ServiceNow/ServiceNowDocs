---
title: API Service Graph Connector for Boomi API Management release notes
description: Version history for the ServiceNow API Service Graph Connector for Boomi API Management application on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-cmdb-api-sgc-boomi-cloud-api-mgmt.html
release: store
