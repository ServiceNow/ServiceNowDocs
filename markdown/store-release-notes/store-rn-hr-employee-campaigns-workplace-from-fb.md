---
title: Employee Campaigns for Workplace from Facebook release notes
description: Version history for the HR Service Delivery Employee Campaigns for Workplace from Facebook on the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/store-release-notes/store-rn-hr-employee-campaigns-workplace-from-fb.html
release: store
...
Version history for the HR Service Delivery Employee Campaigns for Workplace from Facebook on the ServiceNow Store.

**Important:** For details on system requirements and family compatibility, view the application listing on the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website.

## Version history

-   **Version 1.0.11 - January 2024**
