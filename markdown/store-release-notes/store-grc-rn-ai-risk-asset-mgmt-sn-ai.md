---
title: AI Risk and Asset Management for ServiceNow AI release notes
description: Version history for the ServiceNow AI Risk and Asset Management for ServiceNow AI application on the ServiceNow Store.
locale: en-US
...
-   **Version 1.1.0 - May 2026 \(Australia\)**

    Fixed: Resolved an issue in the existing workflow automation for lifecycle tasks.
