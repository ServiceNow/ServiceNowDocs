...
description: Create a sales promotions campaign. OEM agent can view all the sales promotion campaign created by them.
locale: en-US
release: zurich
topic_type: task
...
Create a sales promotions campaign. OEM agent can view all the sales promotion campaign created by them.
...
To reuse the sales promotion details, select **Copy**.
...
In the workspace, you can use the My Promotions related list to track information that is related to the applicable product, visibility criteria, and sales promotion.
