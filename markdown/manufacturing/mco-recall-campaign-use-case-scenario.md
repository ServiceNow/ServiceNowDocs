...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/manufacturing/mco-recall-campaign-use-case-scenario.html
release: zurich
topic_type: concept
...
The [Recall management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/manufacturing/mco-recall-management.md) provides real-time visibility into all campaigns, claims, and affected assets throughout the recall life-cycle.
