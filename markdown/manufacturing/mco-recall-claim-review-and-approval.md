---
title: Recall claim review and approval use case
description: Use case scenarios demonstrate when and how to use the recall campaign application to review and approve the claims. It provides practical examples of common recall management situations.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/manufacturing/mco-recall-claim-review-and-approval.html
release: australia
topic_type: concept
...
6.  Receives updated claim after James adds new labor charges and supporting documents, then approves all line items
