...
**Note:** For Dealer visibility setup information, see [Create the criteria for a service organization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/create-service-organization-criteria.md).
