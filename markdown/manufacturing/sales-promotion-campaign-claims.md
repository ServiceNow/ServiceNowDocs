...
![Sales Promotion Campaign Claims entities](../image/Data_model_sales_promotion.svg "Sales Promotion Campaign Claims data model")
...
To learn more about the Business Location Service Portal, see [Using the Business Location Service Portal](https://www.servicenow.com/docs/access?context=using-blsp-portal&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
