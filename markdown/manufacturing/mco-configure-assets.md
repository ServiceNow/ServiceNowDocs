...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/manufacturing/mco-configure-assets.html
release: zurich
topic_type: task
...
5.  Select **Submit**.
    ...
    For more information on importing assets, see [Import assets with guided setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/import-csm-assets.md).
