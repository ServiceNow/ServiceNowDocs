...
Display user profile information. To learn more about user profile, see [User Profile widget](https://www.servicenow.com/docs/access?context=user-profile-widget&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
