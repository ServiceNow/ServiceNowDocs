...
|--------|-----------|
|[Sales promotion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/manufacturing/mco-sls-prom-clms.md)|The sales promotion framework provides OEMs with the tools to efficiently publish and manage promotional campaigns.|
...
|[Repair claim](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/manufacturing/mco-warranty-clms.md)|In Repair claims, customers report product issues to the dealer, who diagnoses, repairs, and requests reimbursement for the work done.|
|[Pre-authorization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/manufacturing/mco-pre-auth-request.md)|A pre-authorization request is a process to confirm the approval before initiating the activities.|
