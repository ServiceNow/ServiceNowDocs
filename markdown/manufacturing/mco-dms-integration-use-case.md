...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/manufacturing/mco-dms-integration-use-case.html
release: zurich
topic_type: concept
...
The [Set up inbound DMS integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/manufacturing/mco-configure-dms.md) describes how to set up the STAR API configuration and map STAR XML payloads to MCO records.
