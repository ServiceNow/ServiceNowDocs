...
The [Set up inbound DMS integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/manufacturing/mco-configure-dms.md) describes how to set up the STAR API configuration and map STAR XML payloads to MCO records.
