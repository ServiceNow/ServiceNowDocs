...
3.  On the Phase task form, fill in the fields.
    ...
    For a description of the field values, see [Phase task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/manufacturing/mco-phase-task-form.md).
