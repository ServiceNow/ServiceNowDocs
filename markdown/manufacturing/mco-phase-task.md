...
1.  Navigate to **Workspaces** &gt; **CRM Workspace** &gt; **Lists** &gt; **Recall Management** &gt; **My Campaign** &gt; **Recall Campaign Phases** &gt; **Phase tasks**.

2.  Select **New**.

3.  On the Phase task form, fill in the fields.

    For a description of the field values, see [Phase task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/manufacturing/mco-phase-task-form.md).
