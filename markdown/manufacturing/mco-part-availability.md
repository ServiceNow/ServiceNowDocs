...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/manufacturing/mco-part-availability.html
release: zurich
topic_type: task
...
2.  Select the corresponding campaign record in which you want to generate the part requirements.
    ...
    To generate the part requirement, see [Generate a part requirement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/manufacturing/mco-part-requirements.md).
