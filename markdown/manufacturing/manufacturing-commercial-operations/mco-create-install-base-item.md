...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/manufacturing/manufacturing-commercial-operations/mco-create-install-base-item.html
release: yokohama
...
breadcrumb: [Create a warranty contract, Set up Manufacturing Commercial Operations, Configuring Manufacturing Commercial Operations, Manufacturing Commercial Operations]
---
...
3.  On the Install based item form, fill in the fields.
    ...
    For a description of the field values, see [Install based item form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/manufacturing/manufacturing-commercial-operations/install-based-item-form.md).
...
</table>    For more information on the related lists, see [Related list for an install base item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/install-base-related-list.md).
...
[Install base items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/install-base-item.md)
