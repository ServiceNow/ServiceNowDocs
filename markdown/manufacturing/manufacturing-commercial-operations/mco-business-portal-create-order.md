---
title: Create an order using the Business Portal in Manufacturing Commercial Operations
description: The Business Portal uses the product catalog to let customers browse and configure products. Customers can also build orders and submit them for fulfillment.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/manufacturing/manufacturing-commercial-operations/mco-business-portal-create-order.html
release: yokohama
...
breadcrumb: [Using the Business Portal in Manufacturing Commercial Operations, Sales Customer Relationship Management for Manufacturing Commercial Operations, Additional workflows, Using Manufacturing Commercial Operations, Manufacturing Commercial Operations]
---
...
1.  Navigate to the **Business Portal**, and select the **Product Catalog**.
    ...
    \[Omitted image "business-portal-mco-pointer.png"\] Alt text: Business portal and product catalog
...
When the order is submitted, **Order Details** opens and shows the order number and order details.\[Omitted image "creating-order-mco-bp.png"\] Alt text: Order created in MCO BP.
