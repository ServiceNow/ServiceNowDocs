...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/manufacturing/manufacturing-commercial-operations/recall-claims-table.html
release: yokohama
...
breadcrumb: [Recall campaign data model, Data model of Manufacturing Commercial Operations, Manufacturing Commercial Operations reference, Manufacturing Commercial Operations]
---
...
It is the parent table and stores the Recall campaign initiative information.
...
Stores the task information that must be fulfilled in order to complete the Recall Campaign process.
