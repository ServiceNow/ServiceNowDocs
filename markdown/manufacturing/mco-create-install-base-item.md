...
</table>    For more information on the related lists, see [Related list for an install base item](https://www.servicenow.com/docs/access?context=install-base-related-list&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
...
[Install base items](https://www.servicenow.com/docs/access?context=install-base-item&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US)
