...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/manufacturing/mco-create-install-base-item.html
release: zurich
topic_type: task
...
5.  On the Install base item form, fill in the fields.
    ...
    For a description of the field values, see [Install based item form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/manufacturing/install-based-item-form.md).
...
8.  Select **Update**.
    ...
    For more information on importing install base items, see [Import Install base items with guided setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/import-csm-install-base-items.md).
