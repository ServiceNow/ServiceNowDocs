...
description: The Agent workspace enables the OEMs to create, manage, and approve the promotion campaign for a specific set of customers.
locale: en-US
release: zurich
topic_type: concept
...
The Agent workspace enables the OEMs to create, manage, and approve the promotion campaign for a specific set of customers.
