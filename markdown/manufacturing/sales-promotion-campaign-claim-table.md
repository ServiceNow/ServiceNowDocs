...
</table>To learn more about the Case and Case Line, see [Case Lines and Workflows](https://www.servicenow.com/docs/access?context=csm-case-mgmt-case-lines&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
