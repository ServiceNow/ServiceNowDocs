...
1.  Navigate to **Workspaces** &gt; **CSM/FSM Configurable Workspace** &gt; **List** &gt; **Product Quality Investigation** &gt; **Product Quality Investigation Task**.

2.  Select **New**.

3.  On the Product Quality Investigation Task form, fill in the fields.

    For a description of the field values, see [Product quality investigation task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/manufacturing/mco-product-quality-investigation-task-form.md).
