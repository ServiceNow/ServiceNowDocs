...
Configuration record details. You can’t edit the application.**Note:** To learn more about the Application file, see [Application files](https://www.servicenow.com/docs/access?context=c_ApplicationFiles&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
