...
</table>To learn more about the Service Model Foundation, see [Configuring Customer Service Management](https://www.servicenow.com/docs/access?context=configure-customer-service&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
