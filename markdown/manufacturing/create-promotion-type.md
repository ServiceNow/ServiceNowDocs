...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/manufacturing/create-promotion-type.html
release: zurich
topic_type: task
...
MCO input set. This field contains a set of questionnaires. To create an input set, see [Create promotion questionnaire](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/manufacturing/mco-create-input-set.md).
