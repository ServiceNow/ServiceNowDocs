...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/manufacturing/mco-summarize-fraudulent-claim-detection.html
release: zurich
topic_type: task
...
To submit the report in the Dealer portal, see [Submit a repair claim for warranty](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/manufacturing/mco-submit-repair-claim.md).
...
3.  Select **Review &amp; approve**, to view the claim analysis generated by ServiceNow Otto \[Omitted image "icon-ai-sparkle.png"\] Alt text:.
