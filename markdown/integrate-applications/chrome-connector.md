...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/chrome-connector.html
release: brazil
topic_type: concept
...
-   Enable the latest versions of the ServiceNow RPA Edge Extension and the ServiceNow RPA Chrome Extension. To enable, see [Add the ServiceNow RPA Chrome extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/add-google-chrome-extension-rpa.md) and [Add the ServiceNow RPA Edge extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/add-servicenow-edge-extension.md).
-   Ensure you have installed the Chromium plugin on the RPA Desktop Design Studio. To install, see [Manage plugins in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/install-plugins-rpa-studio.md).
-   To use the Chromium connector, see [Use a connector in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/use-connector.md).
-   To configure the Google Chrome connector, see [Configure the Chromium connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/configure-chrome-connector.md).
...
-   **[Use the Capture element dialog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/use-context-dialog.md)**  
Identify and capture the elements on a web-based, Java, or Windows application screen by using the Capture element dialog.
-   **[Chromium connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/connectors-chrome-methods.md)**  
...
-   **[Add the ServiceNow RPA Edge extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/add-servicenow-edge-extension.md)**  
