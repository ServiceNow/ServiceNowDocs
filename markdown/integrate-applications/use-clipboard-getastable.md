...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-clipboard-getastable.html
release: brazil
topic_type: task
...
You can configure the properties for the GetAsTable component. For more information about these properties, see [Properties of the Clipboard components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/util-clipboard-prop.md).
