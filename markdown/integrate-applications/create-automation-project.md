...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/create-automation-project.html
release: brazil
topic_type: task
...
To create an automation project using Now Assist, see [Create an automation with AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/create-automation-now-assist.md).
