...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/create-bigquery-metadata-collector.html
release: australia
topic_type: task
...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the BigQuery collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-bigquery-collector.md).
...
Enable the **Use MID server** toggle to connect to the source system through a MID Server. The system automatically selects an available MID Server.
    ...
    |Field|Description|
    |-----|-----------|
    |BigQuery Credential File Path|Upload the credentials file [you generated](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-bigquery-metadata-collector.md) for authentication.|
...
**Parent Topic:**[BigQuery metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/bigquery-metadata-collector.md)
