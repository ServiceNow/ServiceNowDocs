---
title: Create an Exasol connection
description: Establish a zero copy connection to an Exasol database in Workflow Data Fabric Hub.
locale: en-US
release: zurich
...
breadcrumb: [Exasol, Community connectors, Manage zero copy connections, Workflow Data Fabric Hub, Workflow Data Fabric]
---

# Create an Exasol connection

Establish a zero copy connection to an Exasol database in Workflow Data Fabric Hub.
...
Work with your data source admin to create a connection to Exasol. For additional information about connecting, refer to the [Exasol connector documentation](https://trino.io/docs/current/connector/exasol.html).
...
2.  Find the Exasol connector and select **Connect**.
...
JDBC URL to establish the connection. For example:`jdbc:exa://<host>:<port>;encryption=1;fingerprint=<FINGERPRINT>`
