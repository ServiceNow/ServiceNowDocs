...
description: Establish a zero copy connection to an external PostgreSQL instance in Workflow Data Fabric Hub.
locale: en-US
release: zurich
...
breadcrumb: [PostgreSQL, Community connectors, Manage zero copy connections, Workflow Data Fabric Hub, Workflow Data Fabric]
---

# Create a PostgreSQL connection

Establish a zero copy connection to an external PostgreSQL instance in Workflow Data Fabric Hub.
...
Work with your data source admin to create a connection to PostgreSQL. For additional information about connecting, refer to the [PostgreSQL connector documentation](https://trino.io/docs/current/connector/postgresql.html).
...
2.  Find the PostgreSQL connector and select **Connect**.
...
JDBC URL to establish the connection. For example:`jdbc://postgresql://<host>:<port>/database-name?ssl=true&sslmode=require`
