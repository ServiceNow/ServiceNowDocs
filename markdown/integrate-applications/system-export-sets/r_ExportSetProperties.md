...
For Excel files, option to format currency values to match the localization of the instance.
 ...
 For more information on localization, see [Localization Framework](https://www.servicenow.com/docs/access?context=localization-framework-landing&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
