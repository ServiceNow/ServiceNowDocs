...
For Excel files, option to format currency values to match the localization of the instance.
 ...
 -   Type: true \| false
-   Default: false
-   Location: [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/t_AddAPropertyUsingSysPropsList.md)
