...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/system-export-sets/t\_CreateAnExportTarget.html
release: zurich
...
You must use a MID Server as the export destination. For more information on MID Server configuration, see [MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server-landing.md).
