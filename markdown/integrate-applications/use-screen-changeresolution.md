...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-screen-changeresolution.html
release: brazil
topic_type: task
...
You can configure the properties for the ChangeResolution component. For more information about these properties, see [Properties of the Screen components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/util-screen-prop.md).
