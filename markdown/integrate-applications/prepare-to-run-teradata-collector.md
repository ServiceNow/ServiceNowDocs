...
Use these credentials when configuring the collector parameters. See [Create a Teradata metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/create-teradata-metadata-collector.md).
