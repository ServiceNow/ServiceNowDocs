...
4.  Record the values of integrator key and secret key to register the app as a third-party OAuth provider on your ServiceNow instance.
    ...
    You need these values when you [Configure the connection for Docusign eSignature spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-docusign-authorization-code.md).
