...
breadcrumb: [ServiceNow University Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Data and Automation]
---
...
-   Integrate Coaching with Learning with ServiceNow University. For more information, see [External Content Integration Sources](https://www.servicenow.com/docs/access?context=integration-source-coaching-with-learning-coaching-wfo-itsm&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US).
-   Role required: admin.
...
[Building actions](https://www.servicenow.com/docs/access?context=actions&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
