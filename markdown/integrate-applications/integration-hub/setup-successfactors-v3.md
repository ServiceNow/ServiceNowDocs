...
-   If you are installing the SuccessFactors spoke for the first time, install SuccessFactors spoke v4.9.1. For more information about setting up SuccessFactors spoke v4.9.1, [Set up the SuccessFactors spoke v4.x.x](setup-successfactors.md#).
-   If you are using an earlier version of the SuccessFactors spoke, migrate to SuccessFactors spoke v4.9.1. For more information, see [Migrate to SuccessFactors spoke v4.9.1](migrate-successfactors.md).
