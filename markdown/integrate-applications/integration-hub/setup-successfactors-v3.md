...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/setup-successfactors-v3.html
release: xanadu
...
**Note:** SuccessFactors will be deprecating basic authentication by Nov 2026 and hence, everyone must use OAuth SAML, which SuccessFactors spoke v4.9.1 supports.

-   If you are installing the SuccessFactors spoke for the first time, install SuccessFactors spoke v4.9.1. For more information about setting up SuccessFactors spoke v4.9.1, [Set up the SuccessFactors spoke v4.x.x](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-successfactors.md).
-   If you are using an earlier version of the SuccessFactors spoke, migrate to SuccessFactors spoke v4.9.1. For more information, see [Migrate to SuccessFactors spoke v4.9.1](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/migrate-successfactors.md).
