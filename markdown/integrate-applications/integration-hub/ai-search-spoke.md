...
```
 ...
 For more details on security principal access permissions, see [External content access permissions](https://www.servicenow.com/docs/access?context=defining-access-perms-ext-docs-ais&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
