...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/create-kafka-ssl-credentials.html
release: xanadu
...
4.  On the Kafka SSL credentials form, fill in the fields.
    ...
    For a description of the fields, see [Kafka SSL credentials fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/health-log-analytics/hla-data-input-kafka-credentials.md).
