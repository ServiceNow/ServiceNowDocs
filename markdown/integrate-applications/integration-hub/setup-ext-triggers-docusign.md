...
For more information about client credentials grant type, see [Client Credentials](https://www.servicenow.com/docs/access?context=client-credentials&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
...
Create flows in Workflow Studio using these triggers as per your requirement. For more information, see [Create a flow with an external trigger](https://www.servicenow.com/docs/access?context=create-a-flow-with-an-external-trigger-definition&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
