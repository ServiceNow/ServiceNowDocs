...
For more information about client credentials grant type, see [Client Credentials](https://www.servicenow.com/docs/access?context=client-credentials&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
