...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/setup-aha-webhook.html
release: australia
...
3.  Fill the form.
    ...
    |Token|Option to specify the token you had created. See [Create a Token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-aha-webhook.md).|
