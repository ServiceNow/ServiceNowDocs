...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/setup-aha-webhook.html
release: yokohama
...
1.  Generate the webhook callback URL from your ServiceNow instance.
    ...
    4.  Click **Callback URL**.
        ...
        \[Omitted image "aha-webhoook-registry.png"\] Alt text: Webhook callback URL.
...
3.  Fill the form.
    ...
    |Token|Option to specify the token you had created. See [Create a Token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/setup-aha-webhook.md).|
