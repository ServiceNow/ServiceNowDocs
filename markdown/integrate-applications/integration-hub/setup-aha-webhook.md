...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/setup-aha-webhook.html
release: xanadu
...
3.  Fill the form.
    ...
    |Token|Option to specify the token you had created. See [Create a Token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-aha-webhook.md).|
