...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/gcloudstorage-spoke.html
release: australia
...
Google Cloud Storage spoke v1.1.1 is the latest version. For version history of the spoke, see [Google Cloud Storage spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-google-cloud-storage.html).
...
For information about setting up the spoke, see [Set up the Google Cloud Storage spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-gstorage.md).
