...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/amzn-elastic-container.html
release: australia
...
Amazon Elastic Container Service spoke v1.0.2 is the latest version. For version history of the spoke, see [Amazon Elastic Container Service spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-amazon-elastic-container-service.html).
...
For information about setting up the spoke, see [Set up the Amazon Elastic Container Service spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-amzn-elastic-contnr.md).
