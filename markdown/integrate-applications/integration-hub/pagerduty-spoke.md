...
PagerDuty spoke v1.6.0 is the latest version. For version history of the spoke, see [PagerDuty spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-pagerduty.html).
...
Downloads user subscriptions from the PagerDuty portal.To use this subflow, perform the steps outlined in [Integrating with PagerDuty](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/integrate-with-pagerduty.md).
...
Deactivates user accounts in PagerDuty.To use this subflow, perform the steps outlined in [Integrating with PagerDuty](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/integrate-with-pagerduty.md).
...
Retrieves the activity of users who are on an on-call schedule.To use this subflow, perform the steps outlined in [Integrating with PagerDuty](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/integrate-with-pagerduty.md).
