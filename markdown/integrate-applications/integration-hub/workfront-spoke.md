...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/workfront-spoke.html
release: xanadu
...
Workfront v 1.3.0 is the latest version.

## Supported versions

This spoke was built for Workfront v 1.1.1, but may be compatible with later versions.
...
For information about setting up the spoke, see [Set up the Workfront spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-workfront.md).
