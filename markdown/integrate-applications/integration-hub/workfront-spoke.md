...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/workfront-spoke.html
release: australia
...
Workfront v1.4.3 is the latest version. For version history of the spoke, see [Workfront spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-workfront.html).
...
For information about setting up the spoke, see [Set up the Workfront spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-workfront.md).
