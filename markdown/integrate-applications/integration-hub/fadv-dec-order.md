...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/fadv-dec-order.html
release: yokohama
...
-   [Create a case in First Advantage from ServiceNow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/create-fadv-case.md)
...
**Note:** You must set up the webhooks to receive the guest event updates. See [Set up First Advantage webhooks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/setup-first-adv.md) for information on setting up the webhooks.
