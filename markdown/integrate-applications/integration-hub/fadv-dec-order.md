...
description: Initiate background verification of the required candidate by sending an email requesting for the essential information on behalf of the required user.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/fadv-dec-order.html
release: australia
...
Initiate background verification of the required candidate by sending an email requesting for the essential information on behalf of the required user.

## Before you begin

-   [Create a case in First Advantage from ServiceNow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/create-fadv-case.md)

    **Note:** Ensure that the **Send Invite link** option isn't selected and the **Use "Order As"** option is selected.
...
3.  Ensure the **Send Invite link** option isn't selected and the **Use "Order As"** option is selected.
...
**Note:** You must set up the webhooks to receive the guest event updates. See [Set up First Advantage webhooks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-first-adv.md) for information on setting up the webhooks.
