...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/ms-exch-online-spoke.html
release: xanadu
...
Automates workflows related to the calendar within Microsoft Exchange Online such as calendar event management, attachment handling, and time zone look ups.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Automates workflows related to the room management within Microsoft Exchange Online such as 'Look up Rooms Stream'.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Automates workflows related to the room metadata management within Microsoft Exchange Online such as looking up room metadata and time zone metadata.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Automates calendar management tasks within Microsoft Exchange Online. It enables users to find the available meeting time slots and create the meetings accordingly.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Automates mail management tasks within Microsoft Exchange Online such as look up mail folders and messages, delete messages, and set mailbox auto-replies.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
For information about setting up the spoke, see [Set up Microsoft Exchange Online spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-ms-exch-ol.md).
...
To set up the MID Server for this spoke, see [Set up MID Server for a spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/config-adv-mid-settings-for-oauth-on-mid.md).
