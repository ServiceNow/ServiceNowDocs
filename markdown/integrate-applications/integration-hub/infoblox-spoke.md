...
Infoblox spoke v2.1.0 is the latest version. For version history of the spoke, see [Infoblox spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-infoblox.html).
