...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/roadmunk-spoke.html
release: australia
...
Roadmunk spoke v1.7.1 is the latest version. For version history of the spoke, see [Roadmunk spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-sn-roadmunk.html).
...
For information about setting up the spoke, see [Set up the Roadmunk spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-roadmunk.md).
