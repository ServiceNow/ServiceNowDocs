...
-   You must configure webhooks to use the spoke subflow. See [Set up a webhook for the Plivo spoke](../task/setup-plivo-webhook.md#) for information regarding setting up and configuring the webhook.
...
Create routing policy in the Plivo WebHook Routing Policies module and specify conditions as per your requirement. See [Set up a webhook for the Plivo spoke](../task/setup-plivo-webhook.md#) for information regarding setting up and configuring the webhooks.
