...
SAP Ariba spoke v1.15.0 is the latest version. For version history of the spoke, see [SAP Ariba spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-sap-ariba.html).
...
</table>For information about setting up the spoke, see [Set up the SAP Ariba spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-sap-ariba.md).
