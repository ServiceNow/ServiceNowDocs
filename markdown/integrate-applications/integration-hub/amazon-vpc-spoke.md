...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/amazon-vpc-spoke.html
release: australia
...
Amazon VPC spoke v1.0.3 is the latest version. For version history of the spoke, see [Amazon VPC spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-amazon-vpc.html).
...
For information about setting up the spoke, see [Set up the Amazon VPC spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-vpc.md).
