...
[Outbound REST web service](https://www.servicenow.com/docs/access?context=c_OutboundRESTWebService&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) is a platform feature that enables you to retrieve, create, update, or delete data on a web services server that supports the REST architecture.
