...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/set-up-microsoft-sharepoint-online-and-connection-record.html
release: yokohama
...
-   Activate [Microsoft SharePoint Online Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/sharepoint-online-spoke.md)
...
1.  Upload the certificate to Microsoft Azure portal.
    ...
    4.  In the search field, enter the name of the OAuth application you had created.
        ...
        To learn how to configure an OAuth application, see [Configure OAuth application in Microsoft Azure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/configure-oauth-application-in-microsoft-azure.md).
...
5.  Click the attachments icon \(\[Omitted image "attachments-icon.png"\] Alt text: Attachments icon\) and attach the JKS certificate you had generated.
    ...
    For more information, see [Configure OAuth application in Microsoft Azure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/configure-oauth-application-in-microsoft-azure.md).
