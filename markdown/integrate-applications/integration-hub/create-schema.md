...
. For more information, see [Create a data gathering action for a dynamic template](https://www.servicenow.com/docs/access?context=create-data-gathering-action-dynamic-template&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).**Note:** Ensure that you surround the key and value with quotation marks.
