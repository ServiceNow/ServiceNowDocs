...
Udemy spoke v1.0.2 is the latest version. For version history of the spoke, see [Udemy spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-udemy.html).
...
For information about setting up the spoke, see [Set up the Udemy spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-udemy-spk.md).
