...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/setup-gdisk.html
release: yokohama
...
-   Activate and set up the [Google Compute Engine Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/gcomengine-spoke.md).
-   Role required: admin.
