...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/set-up-microsoft-azure-devops-pipelines-spoke.html
release: xanadu
...
breadcrumb: [Microsoft Azure DevOps Pipelines Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
-   Activate Microsoft Azure DevOps Pipelines spoke plugin.
-   Role required: admin
