...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/visa-spoke.html
release: australia
...
Visa spoke v2.5.2 is the latest version. For version history of the spoke, see [Visa Spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-visa-spoke.html).
...
For more information about setting up the spoke, see [Set up Visa Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/set-up-visa-spoke.md).
