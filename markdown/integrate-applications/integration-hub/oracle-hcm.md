...
For information about setting up the spoke, see [Configure the Oracle HCM Cloud spoke connection record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-oracle-hcm.md).
