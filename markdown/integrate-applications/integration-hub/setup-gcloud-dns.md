...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/setup-gcloud-dns.html
release: yokohama
...
breadcrumb: [Google Cloud DNS Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Data and Automation]
---
...
8.  Copy these two values to a text file so that you can use them when you [Register Google Cloud DNS as an OAuth provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/setup-gcloud-dns.md).
...
5.  On the form, fill these values.
    ...
    \[Omitted image "gcloud-dns-cred.png"\] Alt text: Credential record for the Google Cloud DNS spoke.
