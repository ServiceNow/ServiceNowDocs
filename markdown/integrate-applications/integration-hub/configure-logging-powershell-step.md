...
breadcrumb: [PowerShell step, Integration steps, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
2.  Set **mid.property.powershell.log\_info** to **true**.
    ...
    This property enables or disables logging. For more information, see [PowerShell log property](https://www.servicenow.com/docs/access?context=powershell-log-property&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
The new logs are available in the MID agent log and can be downloaded from the MID Server. For more information, see [Download the MID Server files](https://www.servicenow.com/docs/access?context=t_DownloadMIDServerFiles&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).

If you set the system property to view the logs in the instance, you can see them in the **Flow engine log entries** tab of the Flow engine context record. For more information, see [Flow execution details](https://www.servicenow.com/docs/access?context=flow-execution-details&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
