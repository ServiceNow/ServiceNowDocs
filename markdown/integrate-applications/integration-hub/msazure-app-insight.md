...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/msazure-app-insight.html
release: australia
...
Microsoft Azure Application Insights spoke v2.0.0 is the latest version. For version history of the spoke, see [Microsoft Azure Application Insights spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-ms-azure-application-insights.html).
...
For information about setting up the spoke, see [Set up the Azure Application Insights spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-msazure-app-insight.md).
