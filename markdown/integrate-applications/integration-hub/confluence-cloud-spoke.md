...
For information about setting up the spoke, see [Set up the Confluence Cloud spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-confluence-cloud.md).
