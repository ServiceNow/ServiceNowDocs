...
For information about setting up the spoke, see [Set up the Google Directory spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-gdirectory.md).
