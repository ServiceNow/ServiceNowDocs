...
breadcrumb: [Workday Financials Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
-   Activate Workday Financials spoke.
-   Role required: admin
