...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/setup-workday-fin-spoke.html
release: yokohama
...
3.  For **WS-Security Username Profile**, select the security username profile you had created for the Workday Financials spoke.
    ...
    See [Create a WS-Security Username Profile for the Workday Financials spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/setup-workday-fin-spoke.md) for more information.
...
-   [Generate client ID and client secret for Workday Financials spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/setup-workday-fin-spoke.md)
-   [Generate token URL for Workday Financials spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/setup-workday-fin-spoke.md)
-   Role required: admin
...
8.  In **Filter** section, select the value as shown and ensure that you add parenthesis.
    ...
    \[Omitted image "image.wd-fin-led-acct-3"\] Alt text: Select the required values in the Filter section.

9.  In prompt section, clear the **Populate Undefined Prompt Defaults** check box.

    \[Omitted image "image.wd-fin-led-acct-4"\] Alt text: Clear the Populate Undefined Prompt Defaults check box.

10. Select the value of prompts in the Prompt default section.

    Ensure that the **Label For Prompt XML Alias** of all prompt fields must be same as shown.

    \[Omitted image "image.wd-fin-led-acct-5"\] Alt text: Verify the Label For Prompt XML Alias values.
