...
Twilio spoke v1.2.0 is the latest version. For version history of the spoke, see [Twilio spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-twilio.html).
