...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/oracle-iam.html
release: australia
...
Oracle Cloud IAM spoke v1.1.4 is the latest version. For version history of the spoke, see [Oracle Cloud IAM spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-oracle-cloud-iam.html).
...
For information about setting up the spoke, see [Set up the Oracle Cloud IAM spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-oracle-iam.md).
