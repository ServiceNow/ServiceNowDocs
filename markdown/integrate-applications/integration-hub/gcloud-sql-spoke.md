...
Google Cloud SQL spoke v1.0.1 is the latest version. For version history of the spoke, see [Google Cloud SQL spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-google-cloud-sql.html).
...
For information about setting up the spoke, see [Set up the Google Cloud SQL spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-gcloud-sql.md).
