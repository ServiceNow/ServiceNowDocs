...
For information about configuring the conversational settings, see [Conversational actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/conversational-actions.md). For information about the Integration Hub Spoke actions that are currently conversational ready, see [Available conversational actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/available-conversational-actions.md).
