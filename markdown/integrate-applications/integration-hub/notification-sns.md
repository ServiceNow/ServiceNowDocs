...
1.  In Workflow Studio, create a flow and include the Create Topic spoke action.
    ...
    For information about creating flows in Workflow Studio, see [Building flows](https://www.servicenow.com/docs/access?context=flows&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
...
1.  In Workflow Studio, create a copy of the default Amazon SNS Subscription subflow.
    ...
    For information about using subflows in Workflow Studio, see [Building subflows](https://www.servicenow.com/docs/access?context=subflows&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
