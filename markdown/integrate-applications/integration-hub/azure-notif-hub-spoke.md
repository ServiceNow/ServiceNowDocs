...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/azure-notif-hub-spoke.html
release: australia
...
Microsoft Azure Notification Hub spoke v2.0.0 is the latest version. For version history of the spoke, see [Microsoft Azure Notification Hub spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-microsoft-azure-notification-hub.html).
...
For information about setting up the spoke, see [Set up the Microsoft Azure Notification Hub spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-azure-notif-hub.md).
