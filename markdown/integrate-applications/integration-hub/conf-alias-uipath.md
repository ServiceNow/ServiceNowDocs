...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/integration-hub/conf-alias-uipath.html
release: brazil
...
-   See [Option 1: Using OAuth authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/conf-alias-uipath.md) to set up the UiPath spoke using OAuth authentication.
...
-   See [Option 2: Using API key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/conf-alias-uipath.md) to set up the UiPath spoke using API key.
