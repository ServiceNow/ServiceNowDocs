...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/set-up-azure.html
release: xanadu
...
breadcrumb: [Microsoft Entra ID Spoke \(formerly Microsoft Azure Active Directory spoke\), Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
