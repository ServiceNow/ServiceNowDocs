...
Ethoca spoke v3.0.0 is the latest version. For version history of the spoke, see [Ethoca Spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-ethoca-spoke.html).
...
For information about setting up the spoke, see [Set up Ethoca spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/set-up-ethoca-spoke.md)
