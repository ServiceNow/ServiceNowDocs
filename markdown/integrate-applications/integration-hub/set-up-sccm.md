...
-   Role required: admin.
-   [Configure the MID Server for SCCM activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/t_ConfigMIDServerForSCCMActivities.md).
...
4.  Enter these values, then click **Submit**.
    ...
    |Active|Enable|
    |User name|Enter a user name with access to the target Windows host. For more information about Windows permissions, see [Windows credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/r_WindowsCredentialsForm.md).|
...
[Configure MID Server as WinRM trusted host](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/enable-winRM-MID-servers.md)
