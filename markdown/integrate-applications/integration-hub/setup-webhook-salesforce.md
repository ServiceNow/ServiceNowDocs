...
7.  Configure the default subflows or create customsubflows.
    ...
    These subflows are triggered when the required events occur in Salesforce instance. For more information, see [Building subflows](https://www.servicenow.com/docs/access?context=subflows&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
