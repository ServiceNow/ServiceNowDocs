...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/aws-elasticbean-spoke.html
release: xanadu
...
For information about setting up the spoke, see [Create a credential record for the AWS Elastic Beanstalk spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-elasticbean-spk.md).
