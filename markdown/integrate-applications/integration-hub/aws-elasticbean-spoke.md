...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/aws-elasticbean-spoke.html
release: australia
...
AWS Elastic Beanstalk spoke v1.0.3 is the latest version. For version history of the spoke, see [AWS Elastic Beanstalk spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-aws-elastic-beanstalk.html).
...
For information about setting up the spoke, see [Create a credential record for the AWS Elastic Beanstalk spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-elasticbean-spk.md).
