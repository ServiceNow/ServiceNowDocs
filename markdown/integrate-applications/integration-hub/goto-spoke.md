...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/goto-spoke.html
release: australia
...
GoTo spoke v2.0.1 is the latest version. For version history of the spoke, see [GoTo Spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-goto-spoke.html).
...
For information about setting up the spoke, see [Set up the GoTo spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-goto.md).
