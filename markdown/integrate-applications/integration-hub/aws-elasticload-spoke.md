...
For information about setting up the spoke, see [Set up the AWS Elastic Load Balancing spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-load-balancing.md).
