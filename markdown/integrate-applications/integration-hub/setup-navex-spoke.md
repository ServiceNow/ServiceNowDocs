...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/setup-navex-spoke.html
release: xanadu
...
2.  Open the following records and create connections for each of the record.
    ...
    For each connection, you must also [Create basic auth credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-navex-spoke.md).
