...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/setup-navex-spoke.html
release: australia
...
2.  Open the following records and create connections for each of the record.
    ...
    For each connection, you must also [Create basic auth credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-navex-spoke.md).
