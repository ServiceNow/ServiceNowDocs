...
2.  Open the following records and create connections for each of the record.
    ...
    For each connection, you must also [Create basic auth credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-navex-spoke.md).
