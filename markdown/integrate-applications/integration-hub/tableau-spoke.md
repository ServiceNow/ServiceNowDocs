...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/tableau-spoke.html
release: yokohama
...
For more information about setting up the spoke, see [Set up the Tableau spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/set-up-tableau-spoke.md).
