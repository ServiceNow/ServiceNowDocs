...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/configure-slack-workspace.html
release: xanadu
...
5.  From the App Credentials page on the Basic Information page, copy and record the values of Client ID, Client Secret, and Signing Secret of your Slack app.
    ...
    For more information, see the [Obtain Client ID and Client Secret](https://api.slack.com/authentication/postman#get_client_secret) step.
