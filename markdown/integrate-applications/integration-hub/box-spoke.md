...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/box-spoke.html
release: xanadu
...
The Box spoke requires creating a custom app on your Box account to generate OAuth 2.0 tokens. See [Create an OAuth application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-box-spoke.md).
