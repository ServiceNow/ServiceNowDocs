...
Craft spoke v1.1.0 is the latest version. For version history of the spoke, see [Craft Spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-craft-spoke.html).
