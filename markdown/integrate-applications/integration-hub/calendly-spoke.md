...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/calendly-spoke.html
release: xanadu
...
Calendly spoke v1.3.0 is the latest version.
...
For information about setting up the spoke, see [Set up the Calendly spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-calendly.md).
