---
title: Set up Continuous Integration and Continuous Delivery \(CICD\) spoke
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/set-up-cicd.html
release: xanadu
...
breadcrumb: [Continuous Integration and Continuous Delivery \(CICD\) Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
