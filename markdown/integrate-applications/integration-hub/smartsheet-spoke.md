...
Downloads user subscriptions from the Smartsheet portal. To use this subflow, perform the steps outlined in [Integrating with Smartsheet](https://www.servicenow.com/docs/access?context=integrate-with-smartsheet&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).
...
Retrieves Smartsheet user activity.To use this subflow, perform the steps outlined in [Integrating with Smartsheet](https://www.servicenow.com/docs/access?context=integrate-with-smartsheet&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).
...
Deactivates user accounts in Smartsheet.To use this subflow, perform the steps outlined in [Integrating with Smartsheet](https://www.servicenow.com/docs/access?context=integrate-with-smartsheet&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).
...
<table id="table_gtm_w1y_n2c"><thead><tr><th>
...
Enables Process Analysts to automate user management workflows within Smartsheet using Integration Hub. It can automate tasks such as create, update, remove users, and retrieve user information. **Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Enables Process Analysts to automate sheet management workflows within Smartsheet using Integration Hub. It can automate looking up sheets by their ID. **Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Assists the Process Analyst in managing and automating column-related tasks in Smartsheet which enables better design and execution of flows in Integration Hub. The agent performs tasks such as fetch list of available columns in a sheet, and a specific column in a sheet.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Enables the Process Analyst to improve Smartsheet workflows by automating attachment-related tasks such as attaching files or URLs, looking up attachment streams, and looking up attachments by ID.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Enables the Process Analyst to improve group management workflows by automating certain tasks. The Process Analyst can automate tasks such as getting the list of available groups, and update group name.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Enables the Process Analyst to improve workflows related to sharing in Smartsheet by automating certain actions such as looking up sheet share streams, and creating share sheets.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Improves workflows related to cross-referencing of sheets by automating certain tasks such as looking up cross-sheet references stream and by ID, and creating a cross-sheet.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Automates row management by performing certain tasks such as creating new rows, helping users manage data effectively and optimize their processes.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Automates various tasks related to comments such as adding a comment, adding a comment with attachment, updating a comment, and look up for a comment.**Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Automates various tasks related to the history of the data in the cells such as looking up cell history stream to retrieve and analyze historical data from Smartsheet cells. **Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Automates folder-related tasks such as fetch list of available folders, create a new folder, and update a folder. **Important:** This AI agent is supported on Xanadu Patch 9 and later releases.
