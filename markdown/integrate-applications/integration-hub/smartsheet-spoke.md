...
Downloads user subscriptions from the Smartsheet portal. To use this subflow, perform the steps outlined in [Integrating with Smartsheet](https://www.servicenow.com/docs/access?context=integrate-with-smartsheet&version=yokohama&pubname=yokohama-it-asset-management&ft:locale=en-US).
...
Retrieves Smartsheet user activity.To use this subflow, perform the steps outlined in [Integrating with Smartsheet](https://www.servicenow.com/docs/access?context=integrate-with-smartsheet&version=yokohama&pubname=yokohama-it-asset-management&ft:locale=en-US).
...
Deactivates user accounts in Smartsheet.To use this subflow, perform the steps outlined in [Integrating with Smartsheet](https://www.servicenow.com/docs/access?context=integrate-with-smartsheet&version=yokohama&pubname=yokohama-it-asset-management&ft:locale=en-US).
