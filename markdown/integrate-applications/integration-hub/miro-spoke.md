...
Miro spoke v3.4.0 is the latest version. For version history of the spoke, see [Miro Spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-miro.html).
...
For information about setting up the spoke, see [Set up the Miro spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-miro.md).
