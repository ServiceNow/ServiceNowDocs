...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/qualtrics-spoke.html
release: australia
...
Qualtrics spoke v1.4.2 is the latest version. For version history of the spoke, see [Qualtrics spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-qualtrics.html).
...
For information about setting up the spoke, see [Set up the Qualtrics spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-qualtrics.md).
