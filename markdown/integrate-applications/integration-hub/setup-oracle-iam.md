...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/setup-oracle-iam.html
release: xanadu
...
breadcrumb: [Oracle Cloud IAM Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
-   Activate Oracle Cloud IAM spoke.
-   Role required: admin
