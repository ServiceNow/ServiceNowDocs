...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/integration-hub/csd2-conf-sccm.html
release: brazil
...
2.  To use the two advanced actions, Look up Device Collections Stream \(Database\) and Look up User Collections Stream \(Database\), configure the JDBC credential.
    ...
    **Note:** If you are using the Microsoft Endpoint Configuration Manager spoke with [Client Software Distribution 2.0 application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/csd-app-2.md), you must configure the JDBC credential.
