...
breadcrumb: [Oracle Autonomous DB Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
-   Activate Oracle Autonomous DB spoke.
-   Install the Oracle Cloud IAM spoke before installing the Oracle Autonomous DB spoke.
-   Role required: admin.
