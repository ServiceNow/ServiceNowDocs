...
Jenkins spoke v2.3.1 is the latest version. For version history of the spoke, see [Jenkins spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-jenkins.html).
...
For information about setting up the spoke, see [Set up Jenkins spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/set-up-jenkins-v1.md).
