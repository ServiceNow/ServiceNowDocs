...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/jenkins-v1-spoke.html
release: xanadu
...
For information about setting up the spoke, see [Set up Jenkins spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/set-up-jenkins-v1.md).
