...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/perform-backgrnd-check-fadv.html
release: australia
...
-   You must set up the webhooks to receive the guest event updates. See [Set up First Advantage webhooks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-first-adv.md) for information on setting up the webhooks.
