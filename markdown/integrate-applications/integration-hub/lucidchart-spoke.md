...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/lucidchart-spoke.html
release: australia
...
The Lucidchart Diagramming Spoke requires creating a workspace and custom app on your Lucid account to generate OAuth 2.0 tokens for the Lucidchart Diagramming spoke. See [Create OAuth 2.0 Client in Lucidchart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/set-up-lucidchart.md) and [Create a connection and credential alias for the Lucidchart Diagramming spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/create-conn-cred-lucidchart.md).
...
For information about setting up the spoke, see [Create a connection and credential alias for the Lucidchart Diagramming spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/create-conn-cred-lucidchart.md).
