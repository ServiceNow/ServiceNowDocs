...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/lucidchart-spoke.html
release: xanadu
...
For information about setting up the spoke, see [Create a connection and credential alias for the Lucidchart Diagramming spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/create-conn-cred-lucidchart.md).
