...
**Note:** The Retry Handler Framework app is available only as a part of [Microsoft Exchange Online Spoke](ms-exch-online-spoke.md) or [Journey Accelerator](https://www.servicenow.com/docs/access?context=journey-accelerator&version=yokohama&pubname=yokohama-employee-service-management&ft:locale=en-US) app.
