...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/secureworks-ctp.html
release: australia
...
Secureworks CTP spoke v1.0.3 is the latest version. For version history of the spoke, see [Secureworks CTP spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-secureworks-ctp.html).
...
For information about setting up the spoke, see [Set up the Secureworks CTP spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-secureworks-ctp.md).
