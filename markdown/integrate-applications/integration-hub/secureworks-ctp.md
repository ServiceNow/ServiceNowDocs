...
For information about setting up the spoke, see [Set up the Secureworks CTP spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-secureworks-ctp.md).
