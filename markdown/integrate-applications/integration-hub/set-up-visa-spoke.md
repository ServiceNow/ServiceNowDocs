...
-   Role required: admin
-   [Upload client certificate to your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/set-up-visa-spoke.md) to authenticate the client certificate of the instance.
-   [Upload a trusted server certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/set-up-visa-spoke.md) to authenticate the server certificate of the web service provider.
