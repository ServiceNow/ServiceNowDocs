...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/msrc-spoke-dec.html
release: xanadu
...
For information about setting up the spoke, see [Set up the Microsoft Security Response Center spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-msrc-spk-dec.md).
