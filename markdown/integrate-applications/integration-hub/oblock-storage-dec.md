...
Oracle Block Storage spoke v1.0.4 is the latest version. For version history of the spoke, see [Oracle Block Storage Spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-oracle-block-storage.html).
...
For information about setting up the spoke, see [Set up the Oracle Block Storage spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/oblk-strg-vol-decsetup.md).
