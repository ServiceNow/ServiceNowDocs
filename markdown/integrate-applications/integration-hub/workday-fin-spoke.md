...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/workday-fin-spoke.html
release: xanadu
...
|Subflow|Description|
|-------|-----------|
|Create PO|Creates a purchase order record in the Purchase Order table. To use the subflow, [Set up webhook for your Workday Financials spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-webhk-wd.md).|
