...
3.  Record the values of integrator key and secret key to register the app as a third-party OAuth provider on your ServiceNow instance.
    ...
    You need these values when you [Register Docusign as OAuth Provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-docusign-jwt.md)
...
3.  Paste the Private Key you had earlier generated from your Docusign integrator app.
    ...
    For more information, see [Configure Docusign account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-docusign-jwt.md).
...
Synchronize ServiceNow with Docusign to access Docusign accounts, templates, and envelopes from the Docusign spoke. See [Synchronize Docusign with ServiceNow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/sync-docusign-servicenow.md).
