...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/setup-azure-cosmos-db.html
release: xanadu
...
breadcrumb: [Microsoft Azure Cosmos DB Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
-   Activate Microsoft Azure Cosmos DB Spoke.
-   Role required: admin
...
4.  In the Search all connections field, enter `Microsoft Azure Cosmos DB SAS`.

    The **Outbound** tab is active by default. If the tab isn’t active, toggle it to activate.

5.  On the Microsoft Azure Cosmos DB SAS tile, select **View Details**.
