...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/gtask-spoke.html
release: australia
...
Google Tasks spoke v1.4.0 is the latest version. For version history of the spoke, see [Google Tasks spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-google-tasks.html).
...
For information about setting up the spoke, see [Set up the Google Tasks spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-gtask.md).
