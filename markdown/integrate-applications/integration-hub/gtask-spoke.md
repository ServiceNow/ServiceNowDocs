...
For information about setting up the spoke, see [Set up the Google Tasks spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/setup-gtask.md).
