...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/guidewire-spoke.html
release: australia
...
Guidewire Spoke v1.3.0 is the latest version. For version history of the spoke, see [Guidewire Spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-guidewire-spoke.html).
...
For information about setting up the spoke, see [Set up the Guidewire spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/set-up-guidewire-spoke.md).
