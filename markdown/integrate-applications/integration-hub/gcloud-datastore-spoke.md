...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/gcloud-datastore-spoke.html
release: australia
...
Google Cloud Datastore spoke v1.0.2 is the latest version. For version history of the spoke, see [Google Cloud Datastore spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-google-cloud-datastore.html).
...
For information about setting up the spoke, see [Set up the Google Cloud Datastore spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-gcloud-datastore.md).
