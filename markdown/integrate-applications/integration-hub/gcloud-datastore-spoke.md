...
For information about setting up the spoke, see [Set up the Google Cloud Datastore spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/setup-gcloud-datastore.md).
