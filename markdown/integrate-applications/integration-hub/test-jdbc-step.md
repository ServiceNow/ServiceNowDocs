...
2.  [Create an action](https://www.servicenow.com/docs/access?context=create-action&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US) with a [JDBC step](../reference/jdbc-step.md).
