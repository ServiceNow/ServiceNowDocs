...
For information about setting up the spoke, see [Set up the AWS OpsWorks spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-aws-opsworks.md).
