...
Displays the default credential record to set up the Workplace from Facebook spoke. For more information, see [Set up Workplace from Facebook spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/set-up-fb-wp.md).
...
</table>For information about setting up the spoke, see [Set up Workplace from Facebook spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/set-up-fb-wp.md).
