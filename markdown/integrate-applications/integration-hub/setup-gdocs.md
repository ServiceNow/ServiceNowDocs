...
-   [Configure Google Docs application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-gdocs.md)
-   Role required: admin
