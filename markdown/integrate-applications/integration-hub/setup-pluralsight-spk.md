...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/setup-pluralsight-spk.html
release: xanadu
...
breadcrumb: [Pluralsight Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
This task enables you to integrate your ServiceNow instance with the Pluralsight host. See the flow, as given in the image below.\[Omitted image "conn-cred-record-pluralsight.png"\] Alt text: Flow to set connection and credential record for Pluralsight spoke.
