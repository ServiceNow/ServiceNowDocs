...
**Note:** This procedure is applicable if you are setting up the SuccessFactors spoke v4.10.0 for the first time. If you are using an earlier version of the SuccessFactors spoke, see [Migrate to SuccessFactors spoke v4.10.0](migrate-successfactors.md) for the migration procedure.
...
2.  Upload the JKS certificate to your ServiceNow instance.
    ...
    For instructions to upload the JKS certificate, see [Upload a certificate to an instance](https://www.servicenow.com/docs/access?context=t_UploadACertificateToAnInstance&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US) .
