...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/gov-notify.html
release: australia
...
GovNotify spoke v1.3.0 is the latest version. For version history of the spoke, see [GovNotify spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-govnotify.html).
...
For information about setting up the spoke, see [Set up the GovNotify spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/govnotify-setup.md).
