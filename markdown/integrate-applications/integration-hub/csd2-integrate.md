...
See [UI actions](https://www.servicenow.com/docs/access?context=c_UIActions&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) for more information about creating a UI action.
