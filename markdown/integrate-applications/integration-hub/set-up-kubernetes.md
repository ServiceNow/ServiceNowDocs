...
3.  Complete the form and enter the certificate in the **PEM Certificate** field.
    ...
    For more information about uploading certificates, see [Upload a certificate to an instance](https://www.servicenow.com/docs/access?context=t_UploadACertificateToAnInstance&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
