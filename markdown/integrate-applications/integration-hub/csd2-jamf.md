...
-   Activate the Jamf spoke and set up the spoke. For more information about the spoke setup, see [Set up the Jamf spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-jamf-spk.md).
