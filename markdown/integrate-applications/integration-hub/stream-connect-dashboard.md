...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/integration-hub/stream-connect-dashboard.html
release: zurich
...
\[Omitted image "stream-connect-dashboard.png"\] Alt text: User interface for the Stream activity tab of the Stream Connect dashboard overview page.
...
\[Omitted image "sc-dashboard-data.png"\] Alt text: User interface for the Data usage tab of the Stream Connect dashboard overview page.
...
\[Omitted image "stream-connect-dash-topics.png"\] Alt text: User interface for the Stream Connect dashboard Topics page.
...
-   **6. Action buttons**
    ...
    -   To edit a topic, select the topic from the list, select the **Edit** button, then fill in the fields on the Edit [Kafka Topic form.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/create-topic-instance-hermes.md)
    -   To create a new topic, select **New**, then fill in the fields on the Create New [Kafka Topic form.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/create-topic-instance-hermes.md)

You can select a topic from the list to view detailed information for that topic.

\[Omitted image "sc-dash-topic-page.png"\] Alt text: User interface for an individual topic page on the Stream Connect dashboard.
...
\[Omitted image "stream-connect-dash-consumers.png"\] Alt text: User interface for the Stream Connect dashboard Consumers page.
...
\[Omitted image "stream-connect-dash-producers.png"\] Alt text: User interface for the Stream Connect dashboard Producers page.
...
\[Omitted image "sc-dash-producer-page.png"\] Alt text: User interface for an individual producer page on the Stream Connect dashboard.
...
For a detailed description of Producer data and statistics, see [Viewing producer statistics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/producer-statistics.md).

## Message Replications

View message replications, and add, edit, or export a message replication.

\[Omitted image "stream-connect-dash-mes-rep.png"\] Alt text: User interface for the Stream Connect dashboard Message Replications page.
...
-   **24. Action buttons**
    ...
    -   To edit a message replication, select the replication from the list, select the **Edit** button, then fill in the fields on the Edit [Message Replication form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/configure-message-topic-reps-sc.md).
    -   To create a new message replication, select **New**, then fill in the fields on the Create New [Message Replication form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/configure-message-topic-reps-sc.md).
...
\[Omitted image "stream-connect-dash-topic-rep.png"\] Alt text: User interface for the Stream Connect dashboard Topic Replications page.
...
-   **26. Action buttons**
    ...
    -   To edit a topic replication, select the replication from the list, select the **Edit** button, then fill in the fields on the Edit [Topic Replication form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/configure-message-topic-reps-sc.md).
    -   To create a new topic replication, select **New**, then fill in the fields on the Create New [Topic Replication form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/configure-message-topic-reps-sc.md).

You can select a topic replication to view its name, direction, replication, topic name, ServiceNow topic, status, error message \(if any\), if it's active, and if it's being tracked in the current update set. You can also see any associated [Message Replication statistics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/stream-connect-message-rep-stats.md).

## Alerts

View active alerts and each alert's severity level, state, type, and affected entity.

\[Omitted image "sc-dashboard-alerts.png"\] Alt text: User interface for the Stream Connect dashboard Alerts page.
...
-   **28. Alert settings**
    ...
    Opens the [Alerting Properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/sc-alert-properties.md) page where you can specify alert properties and how alerts are managed.
...
\[Omitted image "sc-dash-alert.png"\] Alt text: User interface for an individual alert page on the Stream Connect dashboard.
