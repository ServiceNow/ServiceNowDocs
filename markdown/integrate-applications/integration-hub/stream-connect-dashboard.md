...
-   **4. Action buttons**
    ...
    -   To edit a topic, select the topic from the list, select the **Edit** button, then fill in the fields on the Edit [Kafka Topic form.](https://www.servicenow.com/docs/access?context=create-topic-instance-hermes&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
    -   To create a new topic, select **New**, then fill in the fields on the Create New [Kafka Topic form.](https://www.servicenow.com/docs/access?context=create-topic-instance-hermes&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
