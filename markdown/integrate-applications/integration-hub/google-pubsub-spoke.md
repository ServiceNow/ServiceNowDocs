...
For information about setting up the spoke, see [Set up the Google Cloud Pub Sub Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-google-pubsub.md).
