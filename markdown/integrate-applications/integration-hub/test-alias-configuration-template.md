...
If you don't have a connection alias or an associated configuration template, you can create them. For step-by-step instructions on setting up a configuration template, see [Create a configuration template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/create-template.md). After you create a configuration template, you can [Create a Connection &amp; Credential alias](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/connection-alias.md) and associate it with the template by adding the template name to the **Configuration Template** field.
