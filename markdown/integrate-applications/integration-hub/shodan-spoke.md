...
Shodan spoke v1.1.0 is the latest version. For version history of the spoke, see [Shodan Spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-shodan-spoke.html).
...
For information about setting up the spoke, see [Set up the Shodan spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-shodan-spoke.md).
