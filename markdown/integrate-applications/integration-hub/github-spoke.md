...
For information about setting up the triggers for the GitHub spoke, see [Activate the trigger definition on ServiceNow instance for the GitHub spoke](../task/set-up-triggers-github-spoke.md#). For more information about inbound integration, see [Conditional and event-driven inbound integration](../../integrationhub/concept/conditional-and-event-driven-inbound-integration.md).
