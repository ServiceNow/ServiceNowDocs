...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/github-spoke.html
release: xanadu
...
<table id="table_ecg_qct_bfc"><thead><tr><th>
...
Manages and maintains the GitHub branches. Also, retrieves information about the GitHub branches.**Note:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Manages and automates GitHub-related tasks in Integration Hub.**Note:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Manages the GitHub repositories by handling the repository operations, pull requests, comments on pull request and milestones.**Note:** This AI agent is supported on Xanadu Patch 9 and later releases.
...
Manages source code and handles the repository files, commits, and comments.
...
Manages code changes and GitHub operations from your ServiceNow instance. This agent interprets your requests, asks clarifying questions, and analyzes context to deliver well-integrated code updates. It also performs GitHub tasks such as creating branches, committing changes, and opening pull requests.
...
For information about setting up the spoke, see [Set up the GitHub spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/set-up-github-spoke.md).
