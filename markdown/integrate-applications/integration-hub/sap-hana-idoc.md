...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/sap-hana-idoc.html
release: australia
...
SAP S4 HANA IDoc spoke v1.2.0 is the latest version. For version history of the spoke, see [SAP S4 HANA IDoc spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-sap-s4-hana-idoc.html).
...
-   To retrieve information for authorization purposes, use the Execute RFC spoke action in the [SAP S4 HANA RFC Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/sap-s4hanarfc-spoke.md).
...
For information about setting up the spoke, see [Set up the SAP S4 HANA IDoc spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-sap-s4-hana-idoc.md).
