...
2.  Open the action with the PowerShell step that has the credential you want to test.
    ...
    If you don't have a PowerShell step you're already working with, you can [Create an action](https://www.servicenow.com/docs/access?context=create-action&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US) with a new [PowerShell step](../../flow-designer/reference/powershell-step-action-designer.md).
