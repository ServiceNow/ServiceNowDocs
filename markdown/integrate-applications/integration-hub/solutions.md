...
-   **[Access Management Automation](https://www.servicenow.com/docs/access?context=access-management&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)**
...
-   **[Cloud Deployment Automation](https://www.servicenow.com/docs/access?context=cloud-dep-auto&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)**

    Automates the deployment and provisioning of the AWS CloudFormation services using Service Catalog or Service Portal.

-   **[Microsoft AD Spoke for Password Reset](https://www.servicenow.com/docs/access?context=setup-guide-ad&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)**
...
-   **[Microsoft Azure AD Spoke for Password Reset](https://www.servicenow.com/docs/access?context=setup-guide-azure&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)**
...
-   **[Password Reset integration with Google Directory](https://www.servicenow.com/docs/access?context=google-doc-pwd-reset&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)**

    Enables end users to reset their Google passwords using Password Reset and Google Directory spoke.

-   **[Password Reset integration with Okta](https://www.servicenow.com/docs/access?context=okta-pwdreset-spoke&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)**
