...
For information about setting up the spoke, see [Set up the Blue Prism spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-blueprism.md).
