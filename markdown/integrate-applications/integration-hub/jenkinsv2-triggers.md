...
-   In GitHub, generate a classic personal access token and copy the value.
    ...
    For the list of supported events, see the [Spoke triggers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/jenkins-spoke.md) section.
