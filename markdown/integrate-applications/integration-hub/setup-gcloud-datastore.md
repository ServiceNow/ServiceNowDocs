...
8.  Copy these two values to a text file so that you can use them when you [Register Google Cloud Datastore as an OAuth provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-gcloud-datastore.md).
