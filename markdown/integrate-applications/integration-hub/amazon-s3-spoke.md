...
For information about setting up the spoke, see [Set up the Amazon S3 spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-amazon-s3.md).
