...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/azure-artifacts-spoke.html
release: australia
...
Microsoft Azure Artifacts spoke v1.0.3 is the latest version. For version history of the spoke, see [Microsoft Azure Artifacts spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-microsoft-azure-artifacts.html).
...
For information about setting up the spoke, see [Set up the Microsoft Azure Artifacts spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-azure-artifacts.md).
