...
For information about setting up the spoke, see [Set up the Microsoft Azure Artifacts spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/setup-azure-artifacts.md).
