...
To see inputs and outputs for these activities, see [SCCM activity pack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_SCCMActivityPack.md).
