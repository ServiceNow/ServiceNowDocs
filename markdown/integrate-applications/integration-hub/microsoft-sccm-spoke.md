...
To see inputs and outputs for these activities, see [SCCM activity pack](https://www.servicenow.com/docs/access?context=c_SCCMActivityPack&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
