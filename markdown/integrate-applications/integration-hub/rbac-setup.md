...
8.  Provide the required API permissions.
    ...
    2.  Click **Add a permission** to add the required permissions to access the APIs.
        ...
        For information about permissions needed to perform the required actions, see the Spoke actions section here: [Microsoft Azure RBAC Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/azure-rbac-spoke.md).
