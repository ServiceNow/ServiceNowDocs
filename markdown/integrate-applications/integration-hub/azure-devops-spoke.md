...
Azure DevOps Boards spoke v3.1.3 is the latest version. For version history of the spoke, see [Microsoft Azure DevOps Boards spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-azure-devops.html).
...
-   If you want to set up the Microsoft Azure DevOps Boards spoke using OAuth, see [Set up the Microsoft Azure DevOps Boards spoke using OAuth](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-azdevops-boards-oauth.md).
-   If you want to set up the Microsoft Azure DevOps Boards spoke using personal access token, see [Set up the Microsoft Azure DevOps Boards spoke using personal access token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-azdevops-boards.md).
