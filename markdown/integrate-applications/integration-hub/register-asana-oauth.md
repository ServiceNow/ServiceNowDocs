...
-   The Asana Integration Hub spoke must be active. For more information, see [Asana Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/asana-spoke.md).
