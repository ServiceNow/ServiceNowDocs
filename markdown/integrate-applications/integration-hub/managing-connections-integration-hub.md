...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/managing-connections-integration-hub.html
release: yokohama
...
Integration Hub [supports multiple connections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/support-multiple-connections.md) to a single integration provider. For example, you can have connections to several different Jira environments.
