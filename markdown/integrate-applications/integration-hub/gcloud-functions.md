...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/gcloud-functions.html
release: australia
...
Google Cloud Functions v1.0.3 is the latest version. For version history of the spoke, see [Google Cloud Functions spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-google-cloud-functions.html).
...
For information about setting up the spoke, see [Set up the Google Cloud Functions spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/gcloud-func-setup.md).
