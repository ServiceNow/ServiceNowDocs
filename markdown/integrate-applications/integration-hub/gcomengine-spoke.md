...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/gcomengine-spoke.html
release: australia
...
Google Compute Engine spoke v1.0.5 is the latest version. For version history of the spoke, see [Google Compute Engine spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-gce.html).
...
-   [Google Persistent Disk Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/gpersistentdisk-spoke.md) \(sn\_gpdisk\_spoke\)
-   [Google Cloud Virtual Network Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/gcloudvirntwrk-spoke.md) \(sn\_gcp\_vpc\_spoke\)
...
For information about setting up the spoke, see [Set up the Google Compute Engine spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-gcompute.md).
