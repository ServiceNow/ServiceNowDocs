...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/gitlab-spoke.html
release: xanadu
...
GitLab spoke v2.4.0 is the latest version.
...
For information about setting up the spoke, see [Set up GitLab spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-gitlab-spoke.md).
