...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/sumtotal-spoke.html
release: australia
...
SumTotal spoke v1.0.2 is the latest version. For version history of the spoke, see [SumTotal spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-sumtotal.html).
...
For information about setting up the spoke, see [Set up the SumTotal spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-sumtotal.md).
