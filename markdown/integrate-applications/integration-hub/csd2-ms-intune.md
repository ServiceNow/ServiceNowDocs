...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/csd2-ms-intune.html
release: xanadu
...
</table>-   **[Configure group assignments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd2-intune-app.md)**  
Configure group assignments for all the applications you want to deploy.
-   **[Verify the Microsoft Intune spoke records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd2-intune.md)**  
...
-   **[Store details of the Microsoft Intune server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd2-intune-discapps.md)**  
Create a server instance record to discover applications and store details of the Microsoft Intune server.
-   **[Set up a software model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd2-intune-sw.md)**  
Using the applications discovered on the Microsoft Intune server, set up a software model to manage licenses.
-   **[Define the Microsoft Intune configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd2-intune-coll.md)**  
...
-   **[Create a catalog item for the Microsoft Intune applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd2-intune-create-cat.md)**  
...
-   **[Deployment process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd2-intune-deploy.md)**  
Order an application from a CSD 2.0 catalog item in the service catalog triggers the Order Client Software flow.

**Parent Topic:**[Client Software Distribution 2.0 application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd-app-2.md)
