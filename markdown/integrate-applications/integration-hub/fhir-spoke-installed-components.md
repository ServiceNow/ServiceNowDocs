...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/fhir-spoke-installed-components.html
release: australia
...
The spoke installs eight read-only actions, grouped into four Integration Hub categories. For each action's inputs and outputs, see [HL7 FHIR Spoke actions reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/fhir-spoke-actions.md).
