...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/integration-hub/payload-build-step-action-designer.html
release: brazil
...
**Note:** For JSON, this step is deprecated and replaced by the [JSON Builder step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/json-build-step-action-designer.md).
