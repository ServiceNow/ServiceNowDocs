...
For information about setting up the spoke, see [Set up the Salesforce Marketing Cloud spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-salesforce-marketing-cloud.md).
