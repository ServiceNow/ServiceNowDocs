...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/ucf-spoke.html
release: australia
...
UCF spoke v1.1.0 is the latest version. For version history of the spoke, see [UCF spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-ucf.html).
...
For information about setting up the spoke, see [Set up the UCF spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-ucf-spoke.md).
