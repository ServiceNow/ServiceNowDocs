...
For information about setting up the spoke, see [Set up the UCF spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/setup-ucf-spoke.md).
