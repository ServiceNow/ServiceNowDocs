...
3.  Create flow to generate buyer token.
    ...
    2.  Create a flow and include the Get Buyer Token spoke action.
        ...
        For more information about creating flows, see [Building flows](https://www.servicenow.com/docs/access?context=flows&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
