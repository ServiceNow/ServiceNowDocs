...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/set-up-sap-s4-hana-odata-spoke.html
release: xanadu
...
breadcrumb: [SAP S4 HANA OData spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
-   Activate SAP S4 HANA OData spoke.
-   Role required: admin
