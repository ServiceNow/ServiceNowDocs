...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/gremlin-spoke.html
release: australia
...
Gremlin spoke v1.0.3 is the latest version. For version history of the spoke, see [Gremlin spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-gremlin.html).
...
For information about setting up the spoke, see [Create Connection and Credential record for the Gremlin spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/create-conn-cred-gremlin.md).
