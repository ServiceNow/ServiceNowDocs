...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/integration-hub/gremlin-spoke.html
release: zurich
...
For information about setting up the spoke, see [Create Connection and Credential record for the Gremlin spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/create-conn-cred-gremlin.md).
