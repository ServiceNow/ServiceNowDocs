...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/gremlin-spoke.html
release: xanadu
...
For information about setting up the spoke, see [Create Connection and Credential record for the Gremlin spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/create-conn-cred-gremlin.md).
