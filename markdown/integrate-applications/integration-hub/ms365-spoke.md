...
For information about setting up the spoke, see [Set up Microsoft Dynamics 365](https://www.servicenow.com/docs/access?context=integrating-with-microsoft365&version=zurich&pubname=zurich-it-asset-management&section=setup-ms-dynamics-365&ft:locale=en-US) and [Set up Microsoft Azure Active Directory](https://www.servicenow.com/docs/access?context=integrating-with-microsoft365&version=zurich&pubname=zurich-it-asset-management&section=setup-ms-azure-ad&ft:locale=en-US).
...
For information about setting up the spoke, see [Set up Microsoft Dynamics 365](https://www.servicenow.com/docs/access?context=integrating-with-microsoft365&version=zurich&pubname=zurich-it-asset-management&section=setup-ms-dynamics-365&ft:locale=en-US).
