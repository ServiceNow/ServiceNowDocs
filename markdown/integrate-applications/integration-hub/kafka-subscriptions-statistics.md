...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/kafka-subscriptions-statistics.html
release: xanadu
...
The Consumer Logs tab displays the log entries for the associated consumer. It shows when each entry was created, its log level, the message, and the source. Consumer logs are stored in the Consumer Logs \[sys\_consumer\_log\] table.
...
</table>**Parent Topic:**[Using Stream Connect for Apache Kafka](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/stream-connect-apache-kafka.md)
