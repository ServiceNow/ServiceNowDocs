...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/set-up-ad.html
release: xanadu
...
-   Request Integration Hub subscription
-   [Create Credential record for the Microsoft AD spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/set-up-ad.md)
-   Role required: admin
