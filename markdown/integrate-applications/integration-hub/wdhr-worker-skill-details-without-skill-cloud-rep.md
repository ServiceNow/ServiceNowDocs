---
title: Workday configuration for worker's skill details report without Skill Cloud
description: Extract worker's skill details without skill cloud based on employee ID or time duration by creating the worker's skill details report.
locale: en-US
release: zurich
...
# Workday configuration for worker's skill details report without Skill Cloud

Extract worker's skill details without skill cloud based on employee ID or time duration by creating the worker's skill details report.
...
-   Calculated field 1:
    -   Create True/False condition type calculated field named **CF\_updated**. ![CF_updated True or False Condition calculated field](../image/wdhr-worker-skill-details-without-skill-cloud-rep-1.png)
    -   Create Extract Multi-instance type calculated field named **CF\_last functionally updated skill for worker**. ![CF_last functionally updated skill for worker Extract Multi-Instance field](../image/wdhr-worker-skill-details-without-skill-cloud-rep-2.png)
...
6.  Do not select the **Temporary report** option and click **OK**.
    ...
    ![Report setup with All Active and Terminated Workers](../image/wdhr-worker-skill-details-without-skill-cloud-rep-3.png)

7.  Select the report business object and report fields.

    ![Columns tab with Worker and Skill for Worker basic fields](../image/wdhr-worker-skill-details-without-skill-cloud-rep-4.png)

8.  In **Group Column Heading** section, select all business object as below.

    **Group Column Heading** for each business object will be blank. ![Group Column Headings configuration](../image/wdhr-worker-skill-details-without-skill-cloud-rep-5.png)

9.  In **Filter** section, select the value as given below.

    Ensure to add parenthesis. ![Filter on Instances with multiple conditions](../image/wdhr-worker-skill-details-without-skill-cloud-rep-6.png)

10. In **Subfilter** section, select the value as given below.

    ![Sub Level Filter for Skill for Worker](../image/wdhr-worker-skill-details-without-skill-cloud-rep-7.png)

11. In **Prompts** section, select the **Populate Undefined Prompt Defaults** option.

    ![Prompts tab with runtime date prompts](../image/wdhr-worker-skill-details-without-skill-cloud-rep-8.png)
...
12. Select the value of prompts as given below under Prompt default section.
    ...
    ![Prompt Defaults with Worker and date fields](../image/wdhr-worker-skill-details-without-skill-cloud-rep-9.png)
...
14. Click on three dots icon and navigate to **Web Services** &gt; **View URLs** option once report configuration is done.
    ...
    ![Web Service menu with View URLs](../image/wdhr-worker-skill-details-without-skill-cloud-rep-10.png)

15. Select the worker whose details you want to see or select the time duration for which you want to see the data.

    ![View URLs dialog with Worker and date parameters](../image/wdhr-worker-skill-details-without-skill-cloud-rep-11.png)

16. In View URLs Web Service page, click the marked icon under the **CSV** section.

    A new browser tab is opened.

    ![View URLs page with CSV download](../image/wdhr-worker-skill-details-without-skill-cloud-rep-12.png)
...
17. View the RaaS URL of the report in the new browser tab.
    ...
    ![RaaS URL in browser](../image/wdhr-worker-skill-details-without-skill-cloud-rep-13.png)
