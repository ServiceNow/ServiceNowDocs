...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/onelogin-spoke.html
release: australia
...
OneLogin v1.0.2 is the latest version. For version history of the spoke, see [OneLogin spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-onelogin.html).
...
For information about setting up the spoke, see [Set up the OneLogin spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-oneloginspk.md).
