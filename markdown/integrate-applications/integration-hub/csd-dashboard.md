...
Displays all open tasks grouped by the requested item's stage value.-   Type: [Create a basic list report](https://www.servicenow.com/docs/access?context=t_CreateAListReport&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US)
...
Displays the top 10 applications installed by request count.-   **Type**: [Create a bar report](https://www.servicenow.com/docs/access?context=c_CreateBarCharts&version=zurich&pubname=zurich-now-intelligence&section=t_CreateABarChartReport&ft:locale=en-US)
...
Displays the total software items requested each month. -   **Type**: [Line reports](https://www.servicenow.com/docs/access?context=c_CreateLineCharts&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US)
-   **Table**: Requested Software \[sn\_client\_sf\_dist\_req\_software\]
...
Displays the total of software requests completed each month.-   **Type**: [Line reports](https://www.servicenow.com/docs/access?context=c_CreateLineCharts&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US)
-   **Table**: Requested Software \[sn\_client\_sf\_dist\_req\_software\]
...
Displays the count of requested software, grouped by installation status, for each month.-   **Type**: [Line reports](https://www.servicenow.com/docs/access?context=c_CreateLineCharts&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US)
-   **Table**: Requested Software \[sn\_client\_sf\_dist\_req\_software\]
...
Displays the sum of all requested items, grouped by the requested item’s stage, for each month.-   **Type**: [Line reports](https://www.servicenow.com/docs/access?context=c_CreateLineCharts&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US)
-   **Table**: Requested Software \[sn\_client\_sf\_dist\_req\_software\]
...
Displays the license counts for all available applications.-   **Type**: [Create a basic list report](https://www.servicenow.com/docs/access?context=t_CreateAListReport&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US)
