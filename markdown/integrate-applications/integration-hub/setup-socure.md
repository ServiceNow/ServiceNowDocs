...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/setup-socure.html
release: xanadu
...
breadcrumb: [Socure Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
1.  Obtain the IP addresses of your ServiceNow instance.
    ...
    2.  Search for the **My IP Information** service catalog item.
        ...
        \[Omitted image "socure-ip-instance.png"\] Alt text: Search for the service catalog item.
