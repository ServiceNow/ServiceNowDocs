...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/integration-hub/setup-acc.html
release: zurich
...
1.  Install the Agent Client Collector Framework v2.2.0 \(sn\_agent\) plugin and the other dependant plugins. For more information, see [Agent Client Collector installation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/acc-installation.md).
...
2.  [Installing the MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server-installation.md).
3.  [Configure the websocket server on the MID server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/acc-configure-web-server.md).
