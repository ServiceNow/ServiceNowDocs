...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/setup-workfront.html
release: xanadu
...
The API key that you generated from the Workfront instance. To learn how to generate an API key, see [Generate a Workfront API key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-workfront.md).
