...
Vonage spoke v2.1.0 is the latest version. For version history of the spoke, see [Vonage spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-vonage.html).
...
For information about setting up the spoke, see [Set up the Vonage spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-vonage-spoke.md).
