...
5.  On the form, fill these values.
    ...
    |Access Key ID|Access key ID you created in AWS Management Console. For more information, see [Create an access key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-elasticbean-spk.md).|
    |Secret Access Key|Secret access key you created in AWS Management Console. For more information, see [Create an access key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-elasticbean-spk.md).|
