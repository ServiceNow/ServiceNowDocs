...
-   This document covers how to test a connection to Hermes. To create the connection, see [Set up a secure connection to the Hermes Messaging Service](set-up-connection-hermes.md).
