...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/test-connection-hermes.html
release: yokohama
...
-   This document covers how to test a connection to Hermes. To create the connection, see [Set up a secure connection to the Hermes Messaging Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/set-up-connection-hermes.md).
...
[Use the Kafka Message trigger and Script consumer to consume messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/use-kafka-trigger-script-consumer.md).
