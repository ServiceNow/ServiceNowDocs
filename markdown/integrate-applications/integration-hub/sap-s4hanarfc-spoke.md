...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/sap-s4hanarfc-spoke.html
release: xanadu
...
-   If the MID Server is installed on a Linux machine, perform the configurations as outlined in [Set up the SAP S4 HANA RFC spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-saphana-rfc.md).
