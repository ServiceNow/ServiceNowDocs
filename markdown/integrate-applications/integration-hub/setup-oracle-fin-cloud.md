...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/setup-oracle-fin-cloud.html
release: xanadu
...
breadcrumb: [Oracle Financial Cloud Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
-   Activate Oracle Financial Cloud spoke.
-   Role required: admin
...
To manage more than one spoke connection records. For more information, see [Supporting multiple connections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/support-multiple-connections.md)
