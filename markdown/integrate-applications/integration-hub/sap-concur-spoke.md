...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/sap-concur-spoke.html
release: xanadu
...
<table id="table_hrm_yhx_c3c"><thead><tr><th>

Aample agentic workflow
...
For information about setting up the spoke, see [Set up the SAP Concur spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/setup-sapconcur-spk.md).
