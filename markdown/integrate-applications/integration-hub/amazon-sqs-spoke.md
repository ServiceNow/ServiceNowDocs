...
To learn to set up the spoke, see [Set up Amazon SQS spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/set-up-amazon-sqs-spoke.md).
