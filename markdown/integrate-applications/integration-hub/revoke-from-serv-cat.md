...
-   Create an [Define an SCCM configuration](https://www.servicenow.com/docs/access?context=t_ConfigureSCCMCollections&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) for the application that names an appropriate uninstall collection.
