...
For information about setting up the spoke, see [Set up the Amazon RDS spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-amazon-rds.md).
