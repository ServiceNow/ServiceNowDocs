...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/configure-sccm-ihub.html
release: xanadu
...
-   **[Configure the Application Administrator role on the SCCM server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd-conf-sccm.md)**  
...
-   **[Update the SCCM cmdlet libraries](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd-cmdlet-lib.md)**  
Ensure that the System Center Configuration Manager SCCM Cmdlet Library is up-to-date.
-   **[Configure the MID Server for SCCM activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd-mid-sccm.md)**  
...
-   **[Create Connection and Credential alias for SCCM deployments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/create-win-credentials-ihub.md)**  
...
-   **[Retrieve SCCM data for client software distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/retrieve-sccm-data-ihub.md)**  
Retrieve the collections and the list of applications available for deployment from your SCCM servers.
-   **[Set up a software model for an SCCM application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd-sw-model.md)**  
...
-   **[Define an SCCM configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd-sccm-collections.md)**  
...
-   **[Create a catalog item for an SCCM application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/create-cat-item-ihub.md)**  
...
**Parent Topic:**[Client software distribution from SCCM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/integration-hub/csd-from-sccm-ihub.md)
