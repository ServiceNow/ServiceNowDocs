...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/setup-aws-cert-manager.html
release: xanadu
...
breadcrumb: [AWS Certificate Manager Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
-   Activate AWS Certificate Manager spoke.
-   Role required: admin
