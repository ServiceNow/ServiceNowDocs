...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub/gcloud-func-setup.html
release: xanadu
...
breadcrumb: [Google Cloud Functions Spoke, Integration Hub available spokes, Building integrations in Integration Hub, Integration Hub, Creating integrations with applications]
---
...
-   Activate Google Cloud Functions spoke.
-   Role required: admin
