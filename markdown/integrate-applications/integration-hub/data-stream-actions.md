...
-   **From a script**
    ...
    You can start a Data Stream using the executeDataStreamAction\(\) method in the FlowAPI class. For more information, see [FlowAPI](https://www.servicenow.com/docs/access?context=ScriptableFlowAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
...
For more information about complex data, see [Complex data](https://www.servicenow.com/docs/access?context=complex-data&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US). Parsing components provide these configuration options.
