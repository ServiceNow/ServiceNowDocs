...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/integration-hub/aha-spoke.html
release: brazil
...
Aha! spoke v1.9.1 is the latest version. For version history of the spoke, see [Aha! spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-aha.html).
...
For information about setting up the spoke, see [Create an Aha! OAuth2 application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/create-aha-oauth2-authentication.md) and [Set up ServiceNow instance for Aha!](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-servicenow-instance-to-authorize-aha.md).
