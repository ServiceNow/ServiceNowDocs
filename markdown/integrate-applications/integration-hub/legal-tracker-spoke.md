...
For information about setting up the spoke, see [Set up the Legal Tracker spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/integration-hub/setup-legal-tracker-spoke.md).
