...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/use-etl-transform-map-consumers.html
release: yokohama
...
2.  Create an ETL Consumer to consume data from the topic.
    ...
    8.  [Create a Kafka stream](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/create-kafka-stream.md) for the consumer.
...
4.  Create a Transform Map Consumer to consume data.
    ...
    6.  [Create a Kafka stream](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/create-kafka-stream.md) for the consumer.
...
[Use the Kafka Producer step and the ProducerV2 API to publish messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/publish-messages-instance-hermes.md).
