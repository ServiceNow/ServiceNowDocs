...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/integration-hub/kubernetes-spoke.html
release: brazil
...
Kubernetes spoke v1.4.0 is the latest version. For version history of the spoke, see [Kubernetes spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-kubernetes.html).
