...
On a domain-separated instance, the properties that govern alerts can be overridden on a per-domain basis. See [Domain separation application properties](https://www.servicenow.com/docs/access?context=ds-application-properties&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US) for details.
