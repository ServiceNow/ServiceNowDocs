...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/stream-connect-quick-start.html
release: australia
...
<table id="choicetable_ebz_1jn_zyb"><thead><tr><th align="left" id="d481758e377">

Option

</th><th align="left" id="d481758e380">

Description

</th></tr></thead><tbody><tr><td id="d481758e386">
...
2.  Create an ETL Consumer to consume data from the topic.
    ...
    8.  [Create a Kafka stream](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/create-kafka-stream.md) for the consumer.
...
4.  Create a Transform Map Consumer to consume data.
    ...
    6.  [Create a Kafka stream](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/create-kafka-stream.md) for the consumer.
