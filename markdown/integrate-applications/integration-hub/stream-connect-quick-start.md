...
For more information, see [Using Stream Connect for Apache Kafka](stream-connect-apache-kafka.md) and the [Hermes Messaging Service](https://www.servicenow.com/docs/access?context=hermes-messaging-service&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
...
<table id="choicetable_ebz_1jn_zyb"><thead><tr><th align="left" id="d456647e377">

Option

</th><th align="left" id="d456647e380">

Description

</th></tr></thead><tbody><tr><td id="d456647e386">
