...
To learn more about complex objects, see [Complex data](https://www.servicenow.com/docs/access?context=complex-data&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
