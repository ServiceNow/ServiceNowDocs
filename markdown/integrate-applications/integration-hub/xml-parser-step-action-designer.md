...
To learn more about complex objects, see [Complex data](https://www.servicenow.com/docs/access?context=complex-data&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
