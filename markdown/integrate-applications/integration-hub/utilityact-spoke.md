...
To modify the data retention policy, change the value of **Age in seconds** in the Auto Flush form of the required table. For more information, see [Autoflush form](https://www.servicenow.com/docs/access?context=atf-auto-flush&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
...
These actions use REST calls that can run either on an instance or, optionally, through a MID Server. For more information, see [MID server](https://www.servicenow.com/docs/access?context=mid-server-landing&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
...
-   [Create a MID Server property](https://www.servicenow.com/docs/access?context=r_MIDServerProperties&version=zurich&pubname=zurich-servicenow-platform&section=t_SetMIDServerProperties&ft:locale=en-US) with **Value** as `*.service-now.com`.
