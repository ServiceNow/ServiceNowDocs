...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/integration-hub/gcloud-load-bal-spoke.html
release: zurich
...
For information about setting up the spoke, see [Set up the Google Cloud Load Balancer Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/integration-hub/setup-gcloud-load-bal.md).
