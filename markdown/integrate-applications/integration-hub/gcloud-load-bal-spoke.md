...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/gcloud-load-bal-spoke.html
release: australia
...
Google Cloud Load Balancer spoke v1.0.1 is the latest version. For version history of the spoke, see [Google Cloud Load Balancer spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-google-cloud-load-balancer.html).
...
For information about setting up the spoke, see [Set up the Google Cloud Load Balancer Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-gcloud-load-bal.md).
