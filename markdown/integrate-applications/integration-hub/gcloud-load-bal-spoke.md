...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/integration-hub/gcloud-load-bal-spoke.html
release: yokohama
...
For information about setting up the spoke, see [Set up the Google Cloud Load Balancer Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/integration-hub/setup-gcloud-load-bal.md).
