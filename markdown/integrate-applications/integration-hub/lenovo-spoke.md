...
**Note:** For more information on getting asset warranty details from Lenovo, see [Integration with Lenovo for asset warranty details](https://www.servicenow.com/docs/access?context=integration-with-lenovo-asset-warranty&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US).
