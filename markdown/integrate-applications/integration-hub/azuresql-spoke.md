...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/azuresql-spoke.html
release: australia
...
Microsoft Azure SQL Database spoke v2.0.0 is the latest version. For version history of the spoke, see [Microsoft Azure SQL Database spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-azure-sql.html).
