...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/integration-hub/smartrecruiters-spoke.html
release: australia
...
SmartRecruiters Spoke v1.0.0 is the latest version. For version history of the spoke, see [SmartRecruiters spoke release notes](https://www.servicenow.com/docs/r/store-release-notes/store-integrationhub-rn-smartrecruiters.html).
...
For information about setting up the spoke, see [Set up the SmartRecruiters spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/integration-hub/setup-smartrecruiters.md).
