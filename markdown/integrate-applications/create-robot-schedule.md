...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/create-robot-schedule.html
release: brazil
topic_type: task
...
-   Ensure you are familiar with robot calendar concepts. For more information, see [Using the robot calendar for RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/robot-calendar-rpa.md) and [View current robot events in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/view-robot-calendar.md).
...
To create a schedule within an unattended bot process, see [Create a schedule within a bot process in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/create-schedule-botprocess.md).
...
<table id="choicetable_kgc_jxm_frb"><thead><tr><th align="left" id="d336494e186">

Option

</th><th align="left" id="d336494e189">

Action

</th></tr></thead><tbody><tr><td id="d336494e195">
...
8.  On the schedule form, update the fields as appropriate.
    ...
    For more information, see [Schedule form in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/create-robot-schedule.md).
