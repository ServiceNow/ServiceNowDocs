...
-   For information about how to use the For Each method, see [Use the For Each component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/use-loops-foreach.md).
-   For information about how to use the For Loop method, see [Use the For Loop component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/use-loops-forloop.md).
...
For information about how to set the parameters, see [Configure port properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/configure-input-port-properties.md).
...
</table>**Parent Topic:**[Email connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/email-connectors.md)
