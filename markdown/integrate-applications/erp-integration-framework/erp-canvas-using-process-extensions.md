...
**Note:** You must have a cloned model created within its own application scope. For more information, see [Using Zero Copy Connector for ERP data products](erp-canvas-using-content-packs.md).

Before completing the procedure, it may be helpful to review the following pages:

-   [Zero Copy Connector for ERP data product process extensions](../concept/erp-canvas-content-pack-process-extensions.md)
-   [Available Zero Copy Connector for ERP data products](../concept/erp-canvas-available-content-packs.md)
-   [Explore a Zero Copy Connector for ERP data product](erp-canvas-explore-a-content-pack.md)
