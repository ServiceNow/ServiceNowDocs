...
# Standard Zero Copy Connector for ERP fields in remote tables
...
For details about the standard tables, see [Standard remote tables for Zero Copy Connector for ERP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/erpi-standard-remote-tables.md). The standard remote tables contain the following additional fields:
