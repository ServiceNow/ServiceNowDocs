---
title: View a list of Zero Copy Connector for ERP systems
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/erp-integration-framework/view-and-monitor-erp-systems-health.html
release: australia
...
keywords: [erp, canvas, erp canvas, integration, data hub, zero, copy, connector, sap, system, health, monitor, connection, heartbeat, retrieve, test connection]
...
-   To create and modify ERP systems: sn\_erp\_integration.erp\_admin
-   To view the ERP systems list: sn\_erp\_integration.erp\_user
...
4.  Check the retrieval and heartbeat information to confirm that the system has no connectivity issues.
    ...
    For a description of the field values, see [Zero Copy Connector for ERP system list field descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/erp-integration-framework/erp-canvas-system-list-descriptions.md).
