...
description: Specify the BAPI entity that a Zero Copy Connector for ERP model uses for a read, update, or create operation.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/erp-integration-framework/add-a-bapi-entity-to-a-model-operation.html
release: zurich
...
Specify the BAPI entity that a Zero Copy Connector for ERP model uses for a read, update, or create operation.
