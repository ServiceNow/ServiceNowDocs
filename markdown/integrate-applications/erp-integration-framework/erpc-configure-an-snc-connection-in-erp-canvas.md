...
5.  Restart the MID Server to apply the changes.
    ...
    For more information, see [Manually start, stop, and restart a MID Server](https://www.servicenow.com/docs/access?context=t_InstallMIDServerAsWinService&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
...
-   Confirm that the SAP clients are properly configured to use SNC. For more information, see [Configuring MID Server](https://www.servicenow.com/docs/access?context=configure-mid-server&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
