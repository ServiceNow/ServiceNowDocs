...
Before completing the procedure, it may be helpful to review the list of [Available Zero Copy Connector for ERP data products](../concept/erp-canvas-available-content-packs.md) and to [Explore a Zero Copy Connector for ERP data product](erp-canvas-explore-a-content-pack.md) to review its contents.
...
1.  Create an application.
    ...
    -   [Create the foundation of an app in Creator Studio](https://www.servicenow.com/docs/access?context=create-app-creator-studio&version=zurich&pubname=zurich-application-development&ft:locale=en-US)
...
2.  Confirm that an update set was created for the new application.
    ...
    2.  Find the default update set created for the new application and select the name to open the record.
        ...
        If a default update set wasn't created for the new application, follow the instructions in [Create and select an update set as the current set](https://www.servicenow.com/docs/access?context=create-select-update-set&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
...
**Parent Topic:**[Zero Copy Connector for ERP data products](../concept/erp-canvas-content-packs.md)
