...
description: Access data from the ERP \(Enterprise Resource Planning\) system through the Glide API.
locale: en-US
...
Access data from the ERP \(Enterprise Resource Planning\) system through the Glide API.
