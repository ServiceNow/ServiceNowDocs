...
## ServiceNow Otto for Zero Copy Connector overview
...
The ServiceNow Otto for Zero Copy Connector application includes the generative AI skills and features that enable you to find information about ERP software, models, data products, and more.
