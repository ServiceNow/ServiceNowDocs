...
Zero Copy Connector for ERP \(Enterprise Resource Planning\) is a ServiceNow scoped application that enables you to retrieve and update data from an ERP system, such as SAP, SuccessFactors, and Workday.
...
[Explore \[Omitted image "bus-learn.svg"\] Alt text: Learn about Zero Copy Connector for ERP concepts and features.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/exploring-erp-integration.md)

</td><td>

[Configure \[Omitted image "bus-optimize-manage.svg"\] Alt text: Install and configure Zero Copy Connector for ERP remote tables and connections.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/erp-integration-configuration-overview.md)

</td></tr><tr><td>

[Use Zero Copy Connector for ERP\[Omitted image "bus-application-development.svg"\] Alt text: Use Zero Copy Connector for ERP to build models and work with ERP data.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/work-with-erp-systems-connections-and-remote-tables.md)
...
[Reference \[Omitted image "bus-rocketship.svg"\] Alt text: Get details about Zero Copy Connector for ERP components, such as tables, and terminology.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/erp-integration-reference.md)
...
Zero Copy Connector for ERP has several training and learning resources for you to get started. \(Some of these resources require logging in to the ServiceNow University site.\)

</td><td>

\[Omitted image "bus-webinar.svg"\] Alt text: [Zero Copy Connector for ERP Fundamentals](https://learning.servicenow.com/lxp/en/app-engine/enterprise-resource-planning-clean-core-with-app-engine-overview?id=learning_course_prev&course_id=602abb67c39dbe10e5533b877d0131a4&s=1&ssa=3)

</td></tr><tr><td>

\[Omitted image "bus-3-person.svg"\] Alt text: [Introduction to Zero Copy Connector for ERP Data Products and Process Extensions](https://learning.servicenow.com/lxp/en/app-engine/introduction-to-zero-copy-connector-for-erp-data-products-and?id=learning_course_prev&course_id=872f7c394767ba5050593369126d4391&s=1&ssa=3)
...
Before you can use Zero Copy Connector for ERP, you must first download the application from the ServiceNow Store. If you don't see Zero Copy Connector for ERP on your instance after you have completed the download, clear your local cache.
