...
**Note:** Starting with the Zurich Patch 4 release, you must have permissions to access the model operations to clone a model. For more information, see [Set operation-level security on a model](../concept/erp-canvas-set-operation-level-security-on-a-model.md).
