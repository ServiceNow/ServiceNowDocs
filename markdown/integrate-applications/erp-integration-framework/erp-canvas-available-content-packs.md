...
The ERP Content Pack for Enterprise Data Foundation contains the following:
...
-   SAP Foundation models are foundational models that may not be tied to a specific module or specific area in SAP. Some might be more related to finance or sales distribution, but foundational models commonly go across modules or areas.
...
## ERP Content Pack for Hire to Retire

The ERP Content Pack for Hire to Retire contains models including Candidate, Job Application, and Position.
...
The ERP Content Pack for Quote to Cash contains the following:
...
## ERP Content Pack for Source to Settle

The ERP Content Pack for Source to Settle contains models including Purchase Orders, Purchase Requisition, and Purchasing Info Record.

|Content pack contents|Target systems|Methods|
|---------------------|--------------|-------|
|Models|ECC and S/4|RFC/BAPI/OData V2|

-   **[Zero Copy Connector for ERP Enterprise Data Foundation content pack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/erp-canvas-enterprise-data-foundation-content-pack.md)**  
The Zero Copy Connector for ERP Enterprise Data Foundation content pack contains models and process extensions for SAP master data.
-   **[Zero Copy Connector for ERP Quote to Cash content pack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/erp-canvas-sales-order-content-pack.md)**  
The Zero Copy Connector for ERP Quote to Cash content pack contains models and process extensions for sales order processing.
-   **[Zero Copy Connector for ERP Hire to Retire content pack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/erp-canvas-recruit-to-retire-content-pack.md)**  
...
-   **[Zero Copy Connector for ERP Source to Settle content pack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/erp-source-to-settle-data-product.md)**  
