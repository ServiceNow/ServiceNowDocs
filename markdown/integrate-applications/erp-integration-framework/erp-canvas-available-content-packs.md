...
description: The following content packs are available for use in Zero Copy Connector for ERP to implement and deploy applications with less manual work.
locale: en-US
release: australia
