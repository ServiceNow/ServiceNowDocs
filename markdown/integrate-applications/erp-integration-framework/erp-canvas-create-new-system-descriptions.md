...
|Connection|Alias of the connection credential that you configured to connect to the ERP system. You can select only from connections in the Zero Copy Connector for ERP scope.|
