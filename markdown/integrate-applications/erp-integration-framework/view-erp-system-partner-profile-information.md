...
5.  Select the **Partner profile** tab to view available profiles.
    ...
    For column descriptions, see [Zero Copy Connector for ERP partner profile tab column descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/erp-partner-profile-tab-fields.md).
...
6.  Select a **Partner number** to view information about a specific profile.
    ...
    For field descriptions, see [Zero Copy Connector for ERP partner profile field descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-integration-framework/erp-partner-profile-fields.md).
