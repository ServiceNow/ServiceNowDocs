...
4.  Check the **IDoc retrieval status** on the record.
    ...
    \[Omitted image "image.erp-system-partner-profile-tab2"\] Alt text: Zero Copy Connector for ERP system record with IDOC retrieval status area highlighted.

5.  Select the **Partner profile** tab to view available profiles.

    \[Omitted image "image.erp-system-partner-profile-tab"\] Alt text: Zero Copy Connector for ERP system record with partner profile tab displayed.
...
6.  Select a **Partner number** to view information about a specific profile.
    ...
    \[Omitted image "image.erp-system-partner-profile-tab3"\] Alt text: Zero Copy Connector for ERP profile record for one individual profile.
