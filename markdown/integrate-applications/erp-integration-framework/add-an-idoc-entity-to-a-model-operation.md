...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/erp-integration-framework/add-an-idoc-entity-to-a-model-operation.html
release: zurich
...
3.  Select the model that you want to add an IDoc operation entity to.
    ...
    If you need to create a model, see [Create a new ERP model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/erp-integration-framework/erpc-add-new-data-model.md).
