...
description: Use the Now Assist ERP data discovery skill in ServiceNow Otto for Zero Copy Connector to query SAP standard database tables for data and records.
locale: en-US
...
Use the Now Assist ERP data discovery skill in ServiceNow Otto for Zero Copy Connector to query SAP standard database tables for data and records.
...
\[Omitted image "image.erp-data-discovery-skill2"\] Alt text: Now Assist panel with information about the table and a confirmation option.

Now Assist provides the information you requested.

\[Omitted image "image.erp-data-discovery-skill3"\] Alt text: Now assist panel with information retrieved listed.
