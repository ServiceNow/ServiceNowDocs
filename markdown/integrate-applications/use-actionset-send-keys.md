...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-actionset-send-keys.html
release: australia
topic_type: task
...
Configure the properties for the ActionSet SendKeys action. For more information about these properties, see [ActionSet Send Keys properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/actionset-actions-properties.md).
