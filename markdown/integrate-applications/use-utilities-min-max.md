...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-utilities-min-max.html
release: brazil
topic_type: task
...
You can configure the properties for the Min component. For more information about these properties, see [Properties of the Math components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/properties-math-component.md).
