...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-wait-waitfortime.html
release: australia
topic_type: task
...
To configure the properties for the Wait For Time component, see [Properties of the Wait components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/wait-properties.md).
...
3.  To set the wait time, see [Configure port properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/configure-input-port-properties.md).
