...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/connectors-queues-methods.html
release: australia
...
-   **Input**
    ...
    [Name](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)

    [Priority](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)

-   **Output**

    [WorkItemId](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)

    [IsNameExists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)
...
4.  To pass the value to these fields, see [Configure port properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/configure-input-port-properties.md).
...
-   **Input**
    ...
    [RequestContent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)
...
Stores sensitive content in encrypted format in the new work item. To configure the input field, see [Configure port properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/configure-input-port-properties.md).
...
-   **Input**
    ...
    [Limit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)

-   **Output**

    [TotalCount](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)
...
-   **Output**
    ...
    [Return](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)
...
-   **Inputs**
    ...
    [ReleaseMode](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)

    [Priority](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)

    [Status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)

    [Exception Type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)
