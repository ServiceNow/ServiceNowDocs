...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/create-mysql-metadata-collector.html
release: brazil
topic_type: task
...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the MySQL collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/prepare-to-run-mysql-collector.md).
