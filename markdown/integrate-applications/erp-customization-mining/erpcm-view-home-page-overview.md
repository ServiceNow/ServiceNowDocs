...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/erp-customization-mining/erpcm-view-home-page-overview.html
release: brazil
...
3.  View the list of potential candidates.
    ...
    For a description of the field values, see [ERP Semantic Mining candidate list field descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-customization-mining/erpcm-candidate-list-details.md).

4.  View and edit the details for a candidate by selecting the candidate.

    For more information, see [Save potential candidates to replatform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-customization-mining/erpcm-find-candidates.md).
