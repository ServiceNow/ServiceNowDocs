...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/erp-customization-mining/erpcm-check-data-connection.html
release: australia
...
<table id="choicetable_s1g_n5l_zwb"><thead><tr><th align="left" id="d225285e209">

Tab

</th><th align="left" id="d225285e212">

Description

</th></tr></thead><tbody><tr><td id="d225285e218">
...
6.  View the information for each task and note actions that you must take by scrolling to the task list.
    ...
    For a description of the field values, see [ERP Semantic Mining task list field descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/erp-customization-mining/erpcm-task-list-details.md).
