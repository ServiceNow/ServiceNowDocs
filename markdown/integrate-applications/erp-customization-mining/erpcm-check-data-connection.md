...
2.  In the side panel, select the connection status icon ![](../image/configuration-alias-icon.png).
...
<table id="choicetable_s1g_n5l_zwb"><thead><tr><th align="left" id="d216397e215">

Tab

</th><th align="left" id="d216397e218">

Description

</th></tr></thead><tbody><tr><td id="d216397e224">
