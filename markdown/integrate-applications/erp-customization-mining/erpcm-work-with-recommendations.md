...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/erp-customization-mining/erpcm-work-with-recommendations.html
release: brazil
...
4.  Select the **Recommendations** tab, which summarizes each suggested action.
    ...
    For a description of the field values, see [ERP Semantic Mining candidate recommendations field descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/erp-customization-mining/erpcm-candidate-recommendations-field-descriptions.md).
