...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/license-rpa-hub.html
release: brazil
topic_type: concept
...
For more information about creating a robot license distribution record, see [Create a robot license distribution record in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/create-lua-record.md).

For more information about executing RPA scripts, see [Re-evaluate license distribution by executing RPA scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/execute-rpa-script.md).
...
To unassign a user, you must retire the associated attended robot. For more information, see [Unassign an attended user or group from an attended bot process in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/unassign-rda-users.md). To remove a user from a group, contact your organization.

To retire a robot if the robot machine is not working appropriately, retire the associated unattended robot. For more information, see [Retire a robot in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/retire-robot.md).

You can update a robot license distribution record. For more information, see [Update a robot license distribution record in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/update-license-record-rpa.md).
