...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/set-up-rda-runtime.html
release: xanadu
product: RPA Hub
...
breadcrumb: [Configuring Attended Robot, Attended Robot, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
...
Install the Attended Robot. For more information, see [Install Attended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/install-rda-runtime.md).
...
5.  To add the settings for an internet connection as per your company policies, do the following steps:
    ...
    1.  In the Connection Manager dialog box, under the Proxy Settings section, fill in the fields.
...
Run an Attended Robot to execute the attended bot process. For more information, see [Run an automation using Attended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/run-rda-robot.md).
