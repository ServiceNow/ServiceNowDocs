...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/use-utiilities-systemprocess-wholockedfile.html
release: xanadu
product: RPA Hub
...
You can configure the properties for the WhoLockedFile component. For more information about these properties, see [Properties of the System Process components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/util-sysprocess-prop.md).
