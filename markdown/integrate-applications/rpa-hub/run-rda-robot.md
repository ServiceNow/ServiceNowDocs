...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/run-rda-robot.html
release: xanadu
product: RPA Hub
...
breadcrumb: [Using Attended Robot, Attended Robot, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
...
Ensure that the licenses are available. For more information, see [License distribution in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/license-rpa-hub.md).
...
Assign an attended user or a group to an attended bot process. For more information, see [Assign an attended user or group to an attended bot process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/assign-rda-users-botprocess.md).

Establish a connection between the Attended Robot and ServiceNow RPA Hub instance. For more information, see [Set up Attended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/set-up-rda-runtime.md).
...
You can run an automation using an attended robot in two ways. Do these tasks after you establish a connection between the Attended Robot and ServiceNow RPA Hub instance. For more information, see [Set up Attended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/set-up-rda-runtime.md).

## Procedure

1.  In the Attended Robot dialog box, select the attended bot process that you want to run.

    Bot processes with Embedded Task Automation enabled are not displayed in this list. For more information, see [Embedded Task Automation in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/embedded-task-auto-rpa.md).

2.  To run an attended robot, do any one of the following actions.

<table id="choicetable_ag1_lyx_jrb"><thead><tr><th align="left" id="d126299e318">

Option

</th><th align="left" id="d126299e321">

Action

</th></tr></thead><tbody><tr><td id="d126299e327">
...
**Parent Topic:**[Using Attended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/using-rda-runtime.md)
