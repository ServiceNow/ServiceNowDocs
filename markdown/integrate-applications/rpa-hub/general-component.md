...
-   **[Use the Confirm component](../task/use-general-messagebox-confirm.md)**  
...
-   **[Use the Input component](../task/use-general-messagebox-input.md)**  
Set up a user input dialog with by using the Input component in RPA Desktop Design Studio.
-   **[Use the Input Password component](../task/use-general-messagebox-input-password.md)**  
Set up a password input form by using the Input Password component in RPA Desktop Design Studio.
-   **[Use the Show component](../task/use-general-messagebox-show.md)**  
...
-   **[Use the Variable component](../task/use-general-variable.md)**  
Create a variable in RPA Desktop Design Studio.
-   **[Use the Try Catch component](../task/use-general-try-catch.md)**  
Catch an error or exception that occurs in a component in an automation.
-   **[Use the Expression component](../task/use-general-expression.md)**  
...
-   **[Use the Find Window component](../task/use-general-findwindow.md)**  
...
-   **[Use the Parallel component](../task/use-general-parallel.md)**  
...
-   **[Use the Terminate component](../task/use-general-terminate.md)**  
Abort an automation by using the Terminate component in RPA Desktop Design Studio.
-   **[Use the Throw Error component](../task/use-general-throw-error.md)**  
...
-   **[Use the Wait For Time component](../task/use-wait-waitfortime.md)**  
Set a wait time by using the Wait For Time component in RPA Desktop Design Studio.
-   **[Supported functions for the Expression components](../reference/supported-expression-functions.md)**  
Learn about the various functions for the Expression components in RPA Desktop Design Studio.
-   **[Properties of the General components](../reference/Properties-general-components.md)**  
