...
You can configure the properties for the HasExtension component. For more information about these properties, see [Properties of the File components](../reference/util-file-prop.md).
