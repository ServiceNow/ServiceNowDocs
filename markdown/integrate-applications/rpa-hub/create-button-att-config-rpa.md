...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/create-button-att-config-rpa.html
release: zurich
product: RPA Hub
...
To create a UI action or edit an existing one, see [Create a UI action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_EditingAUIAction.md).
