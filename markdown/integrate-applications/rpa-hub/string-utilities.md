...
-   **[Use the Base64Decode component](../task/use-utilities-stringutilities-base64decode.md)**  
Convert a base64 string to text by using the Base64Decode component in RPA Desktop Design Studio.
-   **[Use the Base64Encode component](../task/use-utilities-stringutilities-base64encode.md)**  
Encode a string with the base64 algorithm by using the Base64Encode component in RPA Desktop Design Studio.
-   **[Use the Compare component](../task/use-stringutil-compare.md)**  
...
-   **[Use the GetHashCode component](../task/use-utilities-stringutilities-gethashcode.md)**  
Generate a HashCode from a string by using the GetHashCode component in RPA Desktop Design Studio.
-   **[Use the GetTextAfter component](../task/use-stringutil-gettextafter.md)**  
...
-   **[Use the GetTextBefore component](../task/use-stringutil-gettxtbfr.md)**  
...
-   **[Use the GetTextBetween component](../task/use-stringutil-gettxtbtwn.md)**  
...
-   **[Use the GetValueByRegex component](../task/use-utilities-stringutilities-getvaluebyregex.md)**  
...
-   **[Use the Join component](../task/use-stringutil-join.md)**  
Concatenate the elements of an array into a string by using the Join component in RPA Desktop Design Studio.
-   **[Use the Occurrence component](../task/use-utilities-stringutilities-occurrence.md)**  
...
-   **[Use the RemoveWhiteSpace component](../task/use-stringutil-rmvwhtspc.md)**  
Remove any white spaces from a string by using the RemoveWhiteSpace component in RPA Desktop Design Studio.
-   **[Use the Replace component](../task/use-stringutil-replace.md)**  
...
-   **[Use the Split component](../task/use-stringutil-split.md)**  
...
-   **[Use the SubString component](../task/use-stringutil-substring.md)**  
...
-   **[Use the TrimEnd component](../task/use-stringutil-trimend.md)**  
...
-   **[Use the TrimStart component](../task/use-stringutil-trimstart.md)**  
...
-   **[Properties of the String Utilities components](../reference/util-stringutil-prop.md)**  
