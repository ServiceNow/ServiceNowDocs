...
5.  [Configure a bot process record.](create-botprocess.md)
    ...
    2.  [Assign a business application with a bot process](../task/associate-business-apps.md).
    ...
    3.  [Associate a credential group to a bot process](../task/map-credential-groups-to-bot-process.md).
    ...
    5.  [Assign a process robot credential within a bot process](../task/assign-process-robot-cred-botprocess.md).
    ...
    1.  [Assign a business application with a bot process](../task/associate-business-apps.md).
...
8.  [Publish an RPA Hub bot process](../task/publish-bot-process.md).
