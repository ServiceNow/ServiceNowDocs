...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/use-actionset-ocr-read-table.html
release: xanadu
product: RPA Hub
...
Capture an image of the target application window and create an anchor. For information about how to do this, see [Use the ActionSet component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/use-actionsui-actionset.md).
...
You can configure the properties for the OCR Read Table action. For more information about these properties, see [ActionSet OCR Read Table properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/actionset-actions-properties.md).

## Procedure

1.  Right-click the anchor.

    To know about the anchor, see how to use the [Anchor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/anchor.md).
...
6.  Configure the properties of the OCR Read Table action in the Properties pane of the ACTIONSET SETTINGS window.
    ...
    For more information about these properties, see [ActionSet OCR Read Table properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/actionset-actions-properties.md).
...
**Parent Topic:**[Use the ActionSet component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/use-actionsui-actionset.md)
