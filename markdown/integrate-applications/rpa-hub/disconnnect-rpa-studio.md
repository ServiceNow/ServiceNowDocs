...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/disconnnect-rpa-studio.html
release: zurich
product: RPA Hub
...
Connect to an RPA Hub instance. For more information, see [Connect to an RPA Hub instance from RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/connect-studio-instance-rpa.md).
...
Log in with new credentials. For more information about connecting to an instance, see [Connect to an RPA Hub instance from RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/connect-studio-instance-rpa.md).

**Related topics**  


[Assign bot process to an automation project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/assign-bot-process.md)
