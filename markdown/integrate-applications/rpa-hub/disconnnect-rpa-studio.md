...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/rpa-hub/disconnnect-rpa-studio.html
release: yokohama
product: RPA Hub
...
Connect to an RPA Hub instance. For more information, see [Connect to an RPA Hub instance from RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/connect-studio-instance-rpa.md).
...
Log in with new credentials. For more information about connecting to an instance, see [Connect to an RPA Hub instance from RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/connect-studio-instance-rpa.md).
