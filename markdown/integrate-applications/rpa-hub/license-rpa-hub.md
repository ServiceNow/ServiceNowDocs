...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/rpa-hub/license-rpa-hub.html
release: yokohama
product: RPA Hub
...
For more information about creating a robot license distribution record, see [Create a robot license distribution record in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/create-lua-record.md).

For more information about executing RPA scripts, see [Execute RPA scripts to re-evaluate license distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/execute-rpa-script.md).
...
To unassign a user, you must retire the associated attended robot. For more information, see [Unassign an attended user or group from an attended bot process in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/unassign-rda-users.md). To remove a user from a group, contact your organization.

To retire a robot if the robot machine is not working appropriately, retire the associated unattended robot. For more information, see [Retire an RPA Hub robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/retire-robot.md).

You can update a robot license distribution record. For more information, see [Update a robot license distribution record in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/update-license-record-rpa.md).
