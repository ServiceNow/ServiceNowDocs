...
<table id="choicetable_xwg_ksg_q2c"><thead><tr><th align="left" id="d569495e362">

Certificate type

</th><th align="left" id="d569495e365">

Steps

</th></tr></thead><tbody><tr><td id="d569495e371">
...
Register user-generated client authentication certificate to make it available for authentication. For more information, see [Register the CA certificate](https://www.servicenow.com/docs/access?context=set-up-mutual-auth&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).

Map the user-generated client authentication certificate to the user. For more information, see [Map the PEM certificate to user](https://www.servicenow.com/docs/access?context=set-up-mutual-auth&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
