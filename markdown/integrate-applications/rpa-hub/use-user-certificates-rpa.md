...
Register user-generated client authentication certificate to make it available for authentication. For more information, see [Register the CA certificate](https://www.servicenow.com/docs/access?context=set-up-mutual-auth&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).

Map the user-generated client authentication certificate to the user. For more information, see [Map the PEM certificate to user](https://www.servicenow.com/docs/access?context=set-up-mutual-auth&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
...
Generate a client authentication and a code signing certificate. For more information, see [Generate a user certificate](use-user-certificates-rpa.md#).
