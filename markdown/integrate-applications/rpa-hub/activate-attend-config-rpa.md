...
<table id="choicetable_uqv_q52_vzb"><thead><tr><th align="left" id="d587636e128">

Option

</th><th align="left" id="d587636e131">

Action

</th></tr></thead><tbody><tr><td id="d587636e137">
...
The corresponding UI action is created on the ServiceNow form. On selecting this UI action, if there are any unsaved changes, the save confirmation dialog box is displayed. Otherwise, corresponding bot process \(automation\) is triggered. If the UI action isn’t visible, refer to the visibility conditions. For more information, see [Visibility conditions of the UI action \(button\)](../reference/visibility-cond-button-rpa.md).
