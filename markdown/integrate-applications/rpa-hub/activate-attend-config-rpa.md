...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/activate-attend-config-rpa.html
release: zurich
product: RPA Hub
...
Create an attended configuration record. For more information, see [Create an attended configuration record in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/create-attended-config-rpa.md).
...
<table id="choicetable_uqv_q52_vzb"><thead><tr><th align="left" id="d664320e139">

Option

</th><th align="left" id="d664320e142">

Action

</th></tr></thead><tbody><tr><td id="d664320e148">
...
[Invoke Embedded Task Automation via API in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/create-button-att-config-rpa.md)
