...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/view-process-jobs-botprocess.html
release: zurich
product: RPA Hub
...
5.  On the **Process Jobs** tab, select the process job that you want to view.
    ...
    For more information, see [Process job states in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/process-job-states-rpa.md).
