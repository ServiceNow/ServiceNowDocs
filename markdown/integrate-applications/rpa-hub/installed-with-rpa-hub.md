...
Schedule runs on demand to validate the distribution of license records.For more information, see [Execute RPA scripts to re-evaluate license distribution](../task/execute-rpa-script.md).
