...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/totp-authentication-rpa.html
release: zurich
product: RPA Hub
...
-   Create a multi-factor authentication \(MFA\) authenticator record in the classic environment. For more information, see [Create an MFA authenticator in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/create-mfa-authenticator-rpa.md).
