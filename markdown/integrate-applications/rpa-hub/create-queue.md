...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/create-queue.html
release: zurich
product: RPA Hub
...
For more information on queues implementation in RPA Hub, see [Queue implementation in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queues-implement-rpa.md).

You can use the guided tour to get instructions on how to create a queue in the classic environment. For more information, see [Use Guided Tours in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/use-guided-tour-rpa-hub.md).
