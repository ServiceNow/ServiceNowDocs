...
Let's consider an employee badge creation use case. The following steps provide guidance of how to use the GetProcessFieldParameters component in this use case. For more information about the use case, see [Embedded Task Automation in RPA Hub](../../rpa-hub/concept/embedded-task-auto-rpa.md).
