...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/queue-form.html
release: zurich
product: RPA Hub
...
Successful work items that are considered for the Average Handling Time \(AHT\) calculation.For more information about robot pool, see [Robot pool in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/robot-pool-rpa.md).
