...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/use-utilities-min-max.html
release: xanadu
product: RPA Hub
...
You can configure the properties for the Min component. For more information about these properties, see [Properties of the Math components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/properties-math-component.md).
