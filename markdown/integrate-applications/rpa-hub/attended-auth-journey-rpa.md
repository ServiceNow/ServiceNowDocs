...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/attended-auth-journey-rpa.html
release: xanadu
product: RPA Hub
...
breadcrumb: [Exploring Attended Robot, Attended Robot, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
...
With the embedded task automation feature, you can trigger attended bot processes \(attended automations\) from the ServiceNow forms, apart from initiating them from the Attended Robot application. For more information, see [Embedded Task Automation in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/embedded-task-auto-rpa.md).

## Attended Robot authentication journey in Embedded Task Automation

After you install the Attended Robot application in a Windows machine, it registers a URL schema 'snrdaforms' with Attended Robot, starting from the Washington DC release. This URL schema is used whenever a redirect occurs from OAuth. For more information about OAuth, see .
...
Attended Robot executes attended automation when triggered from ServiceNow forms. For more information, see [Runtime Phase of the Embedded Task Automation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/runtime-trigger-automation-forms.md). For more information about invoking an attended automation across other types of forms, see [Invoke Embedded Task Automation via API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/create-button-att-config-rpa.md).

If your organization is configured with proxy settings, the prerequisite for this task is to configure the proxy. In the Proxy Settings section of the Connection Manager, configure the proxy, when you launch Attended Robot from ServiceNow forms, for the first time. For more information about connection manager, see [Connect to an RPA Hub instance from Attended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/connect-rda-instance-rpa.md). For more information about setting a proxy, see [Set up Attended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/set-up-rda-runtime.md).
...
Use the **Terminate** component in attended automations to complete the automation execution. For more information about the component, [Use the Terminate component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/use-general-terminate.md).
