...
Attended Robot executes attended automation when triggered from ServiceNow forms. For more information, see [Runtime Phase of the Embedded Task Automation](../../rpa-hub/concept/runtime-trigger-automation-forms.md). For more information about invoking an attended automation across other types of forms, see [Invoke Embedded Task Automation via API](../../rpa-hub/concept/create-button-att-config-rpa.md).
