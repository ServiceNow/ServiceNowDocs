...
For more detail on these applications, see [Authenticator Applications](https://www.servicenow.com/docs/access?context=mfa-auth-app&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
