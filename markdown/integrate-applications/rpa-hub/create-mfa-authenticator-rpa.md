...
For more detail on these applications, see [Authenticator Applications](https://www.servicenow.com/docs/access?context=mfa-auth-app&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
