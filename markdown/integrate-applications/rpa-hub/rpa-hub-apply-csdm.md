...
For more information about the CSDM, see [Common Service Data Model](https://www.servicenow.com/docs/access?context=csdm-landing-page&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).

For more information about implementing the CSDM framework in stages, see [Implementing the CSDM framework in stages](https://www.servicenow.com/docs/access?context=csdm-implementation-stages&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
