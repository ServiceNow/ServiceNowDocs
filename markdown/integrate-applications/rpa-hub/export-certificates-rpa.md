...
breadcrumb: [Obtaining client authentication and code signing certificates, Configuring RPA Hub, RPA Hub, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
...
Register the root certificate to make it available for authentication. For more information, see [Register the CA certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/certificate-based-authentication/set-up-mutual-auth.md).
...
Register the intermediate certificate to make it available for authentication. For more information, see [Register the CA certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/certificate-based-authentication/set-up-mutual-auth.md).
...
Map the PEM certificate to the user. For more information, see [Map the PEM certificate to user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/certificate-based-authentication/set-up-mutual-auth.md).
