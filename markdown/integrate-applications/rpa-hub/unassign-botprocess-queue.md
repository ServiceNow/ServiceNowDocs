---
title: Unassign a bot process from a queue
...
Assign a bot process to a queue. For more information, see [Assign a bot process to a queue from Queues menu](assign-botprocess-queue.md).
...
4.  Open the queue that you want to unassign a bot process from.
