...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/set-up-rpa-runtime.html
release: zurich
product: RPA Hub
...
Install the Unattended Robot. For more information, see [Install Unattended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/install-rpa-runtime.md).

Install the Unattended Robot Login Agent. For more information, see [Install Unattended Robot Login Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/install-rpa-runtime-login-agent.md).
...
-   Set up the environment for high density robots on a Windows Server machine. For more information, see [Set up Windows Server machine for high density robots](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/setup-windows-server-hdr.md).
-   Familiarize yourself with high density robots concepts. For more information, see [High density robots in Unattended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/high-density-robots-uat.md) and [High density robots in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/high-density-robots-rpa-hub.md).
...
1.  From your desktop, to open the Unattended Robot, do either of the following tasks:
    ...
    -   Double-click the Unattended Robot icon \(\[Omitted image "rpa-robot-runtime-desktop-icon.png"\] Alt text: Unattended Robot icon.\).
    -   In the notification area \(system tray\) in the taskbar, select and hold \(or right-click\) the Unattended Robot icon \(\[Omitted image "rpa-robot-runtime-desktop-icon.png"\] Alt text: Unattended Robot icon in the notification area.\) and select **Settings**.
...
You must set up Windows server for high density robots. For more information, see [Set up Windows Server machine for high density robots](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/setup-windows-server-hdr.md).
...
Perform the following actions to select a certificate:1.  Select the three-dot menu \(\[Omitted image "rpa-runtime-run-three-dot-menu.png"\] Alt text: Three-dot menu.\) next to the **Certificate** field.
...
Run an unattended robot to execute the unattended bot process. For more information, see [Run an automation using Unattended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/run-rpa-robot.md).

**Related topics**  


[Install the user-generated certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/use-user-certificates-rpa.md)
