...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/use-cqc-rpa-stduio.html
release: xanadu
product: RPA Hub
...
breadcrumb: [Code quality check in RPA Desktop Design Studio, Using automations, RPA Desktop Design Studio, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
...
**Parent Topic:**[Code quality check in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/code-quality-check-studio.md)
