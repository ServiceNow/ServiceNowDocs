...
The bot process must be marked ready for migration. For more information, see [Mark the bot process as ready for migration](mark-bot-process-ready-for-migration.md).
...
-   [Configuring credentials in RPA Hub](../concept/configuring-credentials-rpahub.md)
-   [Adding details for your bot process in RPA Hub](../concept/post-req-bot-process-rpa.md)
