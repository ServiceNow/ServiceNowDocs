...
Ensure that the Scripting plugin on the RPA Desktop Design Studio is installed. For more information, see [Manage plugins in RPA Desktop Design Studio](../task/install-plugins-rpa-studio.md).
...
-   To configure the Python connector in RPA Desktop Design Studio, see [Configure the Python connector](../task/configure-python-connector.md). Add the Python connector in the Global Objects.
...
-   To understand the various methods in the Python connector, see [Python connector methods](../reference/python-connector-methods-rpa.md).
-   To learn about the limitations of the Python script, see [Limitations of Python script in Python connector](../reference/python-script-limitations-rpa.md).

-   **[Configure the Python connector](../task/configure-python-connector.md)**  
...
-   **[Python connector methods](../reference/python-connector-methods-rpa.md)**  
...
-   **[Limitations of Python script in Python connector](../reference/python-script-limitations-rpa.md)**  
