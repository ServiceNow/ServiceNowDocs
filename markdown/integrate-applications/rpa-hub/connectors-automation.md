...
breadcrumb: [Use a connector in RPA Desktop Design Studio, Building automations, RPA Desktop Design Studio, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
...
|Python|[Python connector methods](python-connector-methods-rpa.md)|
|StringBuilder|[StringBuilder connector methods](connector-stringbuilder-methods.md)|
|SystemEvents|[SystemEvents connector methods](connectors-systemevents-methods.md)|
...
|Universal App Connector|[Use the Universal App Connector](../task/configure-uac.md)|
