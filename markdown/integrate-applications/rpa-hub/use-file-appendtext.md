...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/use-file-appendtext.html
release: xanadu
product: RPA Hub
...
You can configure the properties for the AppendText component. For more information about these properties, see [Properties of the File components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/util-file-prop.md).
...
Takes the path to the file to which the method appends text from a previously executed component.
...
Takes the text that the method appends text from a previously executed component.
...
Returns **True** if the specified text is successfully added to the file. Otherwise, it returns **False**.
