...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/assign-robots.html
release: xanadu
product: RPA Hub
...
To assign robots via robot pool, enable the robot pool option on the bot process form. For more information, see [Enable robot pool for a bot process in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/enable-robot-pool.md).
