...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/rpa-hub/create-recorded-automation.html
release: yokohama
product: RPA Hub
...
breadcrumb: [Recording automations, Using automations, RPA Desktop Design Studio, Robotic Process Automation \(RPA\) Hub, Data and Automation]
---
...
4.  Select the drop-down button against the default action to view the list of related actions for the element.
    ...
    For more information on the different types of actions and elements, see [Types of elements and actions for the recorder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/element-actions-recorder.md).
...
<table id="choicetable_vmv_2f1_5rb"><thead><tr><th align="left" id="d195857e261">

Option

</th><th align="left" id="d195857e264">

Action

</th></tr></thead><tbody><tr><td id="d195857e270">
...
2.  Configure the screens and the elements of the recording from the Screens and elements pane.
    ...
    For more information on how to configure the screen and element match rules, see [Use the Universal App Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/configure-uac.md).
