...
Create a change request from the **Change** module. For more information, see [Create a change request](https://www.servicenow.com/docs/access?context=t_CreateAChange&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US). Ensure to do the following tasks while creating a change request:
