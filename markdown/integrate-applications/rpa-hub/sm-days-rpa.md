...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/sm-days-rpa.html
release: zurich
product: RPA Hub
...
You can view the maintenance request for tracking the state of the scheduled maintenance. For more information, see [View maintenance requests in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/view-mr-rpa.md) and [Maintenance request form in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/mr-form-rpa.md).

For more information about managing scheduled maintenance days, see [Manage scheduled maintenance days in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/manage-sm-request-rpa.md).
