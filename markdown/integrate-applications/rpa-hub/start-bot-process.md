...
Another way to start an unattended bot process is via triggering the **Start Process** Action in Workflow Studio. For more information, see [RPA Hub actions and subflow](../reference/rpa-hub-actions.md).
