...
breadcrumb: [Terminal \(Mainframe\) connector, Connectors, Automation components, RPA Desktop Design Studio, Robotic Process Automation \(RPA\) Hub, Workflow Data Fabric]
---
...
Ensure you have installed the Terminal \(Mainframe\) plugin on the RPA Desktop Design Studio. To install, see [Manage plugins in RPA Desktop Design Studio](../task/install-plugins-rpa-studio.md).
