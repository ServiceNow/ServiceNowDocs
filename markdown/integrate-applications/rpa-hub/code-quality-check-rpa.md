...
View a code quality rule form along with the type and description. For more information, see [Code quality rule form in RPA Hub](../reference/cqr-form-rpa.md).
...
View the result of the code quality check, in the **Code Quality Result** field of an associated package version in RPA Hub. For more information, see [Package Version form in RPA Hub](../reference/package-version-form-rpa.md).
