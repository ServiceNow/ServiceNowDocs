...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/code-quality-check-rpa.html
release: xanadu
product: RPA Hub
...
View a list of the pre-defined code quality rules in the RPA Hub instance. For more information, see [Code quality rules list in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/cqr-list-rpa.md).

View a code quality rule form along with the type and description. For more information, see [Code quality rule form in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/cqr-form-rpa.md).
