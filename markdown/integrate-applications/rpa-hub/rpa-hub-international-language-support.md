...
To view the full list of languages that are offered as ServiceNow AI Platform plugins and are supported in RPA Hub, see [Activate a language](https://www.servicenow.com/docs/access?context=t_ActivateALanguage&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
