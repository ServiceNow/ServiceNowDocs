...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/rpa-hub/rpa-arch-workflow.html
release: yokohama
product: RPA Hub
...
breadcrumb: [Exploring Robotic Process Automation \(RPA\) Hub, Robotic Process Automation \(RPA\) Hub, Data and Automation]
---
