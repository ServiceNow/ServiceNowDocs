...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/rpa-arch-workflow.html
release: xanadu
product: RPA Hub
...
breadcrumb: [Exploring Robotic Process Automation \(RPA\) Hub, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
