---
title: Installed RPA plugins form
description: Use the installed RPA plugins form to view a list of available RPA Hub plugins, the plugin versions, and dependency packs to verify the availability of a specific version that you want to install and use on the RPA Desktop Design Studio.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/rpa-hub/installed-rpa-plugin-form.html
release: yokohama
product: RPA Hub
