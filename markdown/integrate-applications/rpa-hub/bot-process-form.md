...
For more information about Embedded Task Automation, see [Embedded Task Automation in RPA Hub](../concept/embedded-task-auto-rpa.md).
...
Track automation logs that are generated by the robot. The robot logs the automation execution in automation logs. The logs help the RPA users to track the automation progress.For more information about viewing the automation logs, see [View automation logs in RPA Hub](../task/view-automation-logs-rpa.md).
