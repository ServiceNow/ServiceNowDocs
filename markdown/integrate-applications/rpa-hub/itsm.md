...
-   To use the ITSM connectors, see [Use a connector in RPA Desktop Design Studio](../task/use-connector.md).
...
-   **[PowerShell connector methods](../reference/connector-powershell-methods.md)**  
...
-   **[Parameters of the PowerShell connector methods](../reference/parameters-powershell-connectors.md)**  
Learn about the various parameters of the Microsoft PowerShell connector methods in RPA Desktop Design Studio.
-   **[WMI connector methods](../reference/connector-wmi-methods.md)**  
...
-   **[Parameters for WMI connector methods](../reference/connector-wmi-method-parameters.md)**  
