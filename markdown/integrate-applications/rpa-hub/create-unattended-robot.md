...
breadcrumb: [Creating a robot in RPA Hub, Using RPA Hub, RPA Hub, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
...
You can map an unattended robot to only one virtual machine.
...
<table id="choicetable_kgc_jxm_frb"><thead><tr><th align="left" id="d539999e115">

Option

</th><th align="left" id="d539999e118">

Action

</th></tr></thead><tbody><tr><td id="d539999e124">
...
[Retire an RPA Hub robot](retire-robot.md)
