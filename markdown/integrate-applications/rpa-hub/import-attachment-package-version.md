...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/import-attachment-package-version.html
release: xanadu
product: RPA Hub
...
The maximum package size is determined by the **com.glide.attachment.max\_size** system property. For more information about this system property, [Maximum allowed attachment size \[Updated in Security Center 1.3\]](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/instance-security-hardening-settings/sc-max-allowed-attachment-size.md).
...
Another way to import package version attachments automatically is via triggering the **Import Package Version Attachment** Subflow in Workflow Studio. For more information, see [RPA Hub actions and subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/rpa-hub-actions.md).
