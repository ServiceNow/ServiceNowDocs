...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/edit-robot.html
release: xanadu
product: RPA Hub
...
Create an unattended robot. Ensure to select the **Robot Type** field as **Unattended**. For more information, see [Creating a robot in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/create-robot.md).
