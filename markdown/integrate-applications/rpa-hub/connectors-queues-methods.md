...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/connectors-queues-methods.html
release: zurich
product: RPA Hub
...
-   **Input**
    ...
    [Name](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)

    [Priority](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)

-   **Output**

    [WorkItemId](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)

    [IsNameExists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)


To create the key-value pairs in a JSON object, do the following actions:

1.  On the CreateJSONWorkItem method bar, click the method settings icon \(\[Omitted image "component-settings-icon.png"\] Alt text: Method settings icon.\).
...
To configure the input field, see [Configure port properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/configure-input-port-properties.md).
...
1.  Click the add key icon \(\[Omitted image "add-image-icon.png"\] Alt text: Add key icon.\).
2.  Enter the key name in the field.
3.  To add more keys, repeat the previous steps.
4.  To pass the value to these fields, see [Configure port properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/configure-input-port-properties.md).
...
-   **Input**
    ...
    [RequestContent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)
...
1.  On the CreateStringWorkItem method bar, click the method settings icon \(\[Omitted image "component-settings-icon.png"\] Alt text: Method settings icon.\).
2.  Enter the criteria as given in the table.
...
Stores sensitive content in encrypted format in the new work item. To configure the input field, see [Configure port properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/configure-input-port-properties.md).
...
-   **Input**
    ...
    [Limit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)

-   **Output**

    [TotalCount](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)
...
Data out port that returns the JSON path notation of a work item.Click the add key icon \(\[Omitted image "add-image-icon.png"\] Alt text: Add key icon.\) to add a key name.
...
-   **Output**
    ...
    [Return](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)
...
-   **Inputs**
    ...
    [ReleaseMode](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)

    [Priority](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)

    [Status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)

    [Exception Type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector-method-parameters.md)
...
**Parent Topic:**[Queue](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/queue-connector.md)
