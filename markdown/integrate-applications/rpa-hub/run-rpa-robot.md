...
Create a robot. For more information, see [Creating an attended or an unattended robot in RPA Hub](../../rpa-hub/concept/create-robot.md).
...
<table id="choicetable_ag1_lyx_jrb"><thead><tr><th align="left" id="d216907e264">

Option

</th><th align="left" id="d216907e267">

Action

</th></tr></thead><tbody><tr><td id="d216907e273">
