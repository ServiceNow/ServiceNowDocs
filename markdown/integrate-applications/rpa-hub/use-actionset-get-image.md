...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/use-actionset-get-image.html
release: xanadu
product: RPA Hub
...
You can configure the properties for the GetImage component. For more information about these properties, see [ActionSet- Get Image properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/actionset-actions-properties.md).
