...
-   **[Retire a robot in RPA Hub](../task/retire-robot.md)**  
...
-   **[Enable the client callable option on a flow or subflow in RPA Hub](../../rpa-studio/task/enable-client-flow-rpa.md)**  
...
-   **[Convert existing unattended robots to high density robots in RPA Hub](../task/convert-robot-hdr.md)**  
