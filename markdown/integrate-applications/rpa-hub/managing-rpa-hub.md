...
-   **[Unassign a bot process from a queue](../task/unassign-botprocess-queue.md)**  
...
-   **[Assign a bot process to a shared parameter](../task/assign-botprocess-shared-parameter.md)**  
...
-   **[Unassign a bot process from a shared parameter](../task/unassign-botprocess-shared-parameter.md)**  
Unassign a bot process from a shared parameter in RPA Hub to stop an interaction with this shared parameter.
-   **[View robot events in RPA Hub](../task/view-robot-calendar.md)**  
...
-   **[Create a schedule on the robot calendar](../task/create-robot-schedule.md)**  
...
-   **[Edit an unattended robot in RPA Hub](../task/edit-robot.md)**  
...
-   **[Invoke Embedded Task Automation via API](create-button-att-config-rpa.md)**  
...
-   **[Retire an RPA Hub bot process](../task/retire-bot-process.md)**  
...
-   **[Retire an RPA Hub package](../task/retire-package.md)**  
...
-   **[Retire an RPA Hub robot](../task/retire-robot.md)**  
...
-   **[Enable the client callable option on an RPA Hub flow or subflow](../../rpa-studio/task/enable-client-flow-rpa.md)**  
Enable a client script to trigger an RPA Hub flow or subflow.
-   **[Configure the system properties for an activity stream in RPA Hub](../task/configure-sys-properties-activity.md)**  
...
-   **[Display an activity stream for bot processes and robots in RPA Hub](../task/display-activity-stream-sys-property-rpahub.md)**  
...
-   **[Convert existing unattended robots to high density robots](../task/convert-robot-hdr.md)**  
