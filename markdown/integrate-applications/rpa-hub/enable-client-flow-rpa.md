...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/enable-client-flow-rpa.html
release: xanadu
product: RPA Hub
...
Make sure that you're familiar with the RPA Hub actions and subflow. For more information, see [RPA Hub actions and subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/rpa-hub-actions.md).
