...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/invoke-action-component.html
release: xanadu
product: RPA Hub
...
4.  Enter a minimum of three characters to search and select the action from the **Action name** field.
