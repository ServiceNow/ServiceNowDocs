...
-   **[Use the Capture component](../task/use-screen-capture.md)**  
...
-   **[Use the CaptureWindow component](../task/use-screen-capturewindow.md)**  
...
-   **[Use the ChangeResolution component](../task/use-screen-changeresolution.md)**  
...
-   **[Use the GetResolution component](../task/use-utilities-screen-getresolution.md)**  
Get the resolution of the current screen by using the GetResolution component in RPA Desktop Design Studio.
-   **[Properties of the Screen components](../reference/util-screen-prop.md)**  
