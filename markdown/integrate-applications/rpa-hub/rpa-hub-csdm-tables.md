...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/rpa-hub-csdm-tables.html
release: xanadu
product: RPA Hub
...
breadcrumb: [Applying the CSDM guidelines to RPA Hub, Configuring RPA Hub, RPA Hub, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
...
1.  Business Application \[cmdb\_ci\_business\_app\] - For associating business applications to bot processes and later, defining the application credentials for the same.
    ...
    For more information about assigning a business application to a bot process, see [Assign a business application with a bot process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/associate-business-apps.md).

2.  Hardware \[cmdb\_ci\_hardware\] - For the machine name lookup feature on a robot record.

    For more information about machine name field, see [Create an unattended robot in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/create-unattended-robot.md).
