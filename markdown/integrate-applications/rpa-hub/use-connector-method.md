...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/use-connector-method.html
release: zurich
product: RPA Hub
...
You must install the connector plugin. To install, see [Manage plugins in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/install-plugins-rpa-studio.md).
...
<table id="choicetable_vy3_55j_tsb"><thead><tr><th align="left" id="d454036e89">

Number of levels

</th><th align="left" id="d454036e92">

Step

</th></tr></thead><tbody><tr><td id="d454036e98">
