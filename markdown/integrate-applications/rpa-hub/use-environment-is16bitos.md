...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/use-environment-is16bitos.html
release: xanadu
product: RPA Hub
...
You can configure the properties for the Is64BitOperatingSystem component. For more information about these properties, see [Properties of the Environment components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/util-environment-prop.md).
