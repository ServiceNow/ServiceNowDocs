...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/rpa-hub/configure-activity-rpa-studio.html
release: yokohama
product: RPA Hub
...
To create an activity using Now Assist, see [Create an activity with Now Assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/create-activity-now-assist.md).
...
<table id="choicetable_zm4_lwz_vrb"><thead><tr><th align="left" id="d272554e140">

Option

</th><th align="left" id="d272554e143">

Action

</th></tr></thead><tbody><tr><td id="d272554e149">
...
</td></tr><tr><td id="d272554e352">

**To reuse an activity in a different automation project**

</td><td>

Perform the steps in the [Import project in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/import-project-activities.md).

</td></tr><tr><td id="d272554e371">
...
Right-click the desired activity in the Project Explorer pane and select **Source Control**. The COMPARE PROCESSES dialog box appears and the changes are highlighted as shown in the following example.
 ...
 For more information, see [Resolve conflicts when merging changes from multiple sources of the same activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/rpa-hub/source-control-rpa-studio.md).

</td></tr><tr><td id="d272554e500">
