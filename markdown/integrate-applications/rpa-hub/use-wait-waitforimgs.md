...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/use-wait-waitforimgs.html
release: xanadu
product: RPA Hub
...
breadcrumb: [Wait, Automation components, RPA Desktop Design Studio, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
...
You can configure the properties for the Wait For Images component. For more information about these properties, see [Properties of the Wait components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/wait-properties.md).
...
**Parent Topic:**[Wait](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/wait.md)
