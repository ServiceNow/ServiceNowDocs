...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/rpa-hub/use-utilities-keyboard-sendkeys.html
release: xanadu
product: RPA Hub
...
breadcrumb: [Keyboard, Utilities, Automation components, RPA Desktop Design Studio, Robotic Process Automation \(RPA\) Hub, Creating integrations with applications]
---
...
To see the various supported keys, see [Supported keys and functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/supported-keys-and-functions.md).

You can configure the properties for the SendKeys component. For more information about these properties, see [Properties of keyboard components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/properties-of-keyboard-components.md).
...
**Parent Topic:**[Keyboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/rpa-hub/keyboard-utilities.md)
