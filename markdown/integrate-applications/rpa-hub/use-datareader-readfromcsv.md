...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/rpa-hub/use-datareader-readfromcsv.html
release: zurich
product: RPA Hub
...
You can configure the properties for the ReadFromCSV component. For more information about these properties, see [Properties of the Data Reader components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/util-datareader-prop.md).
...
3.  To configure the input fields, see [Use the ReadFromCSV component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/rpa-hub/use-datareader-readfromcsv.md).
