...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-utilities-stringutilities-gethashcode.html
release: australia
topic_type: task
...
You can configure the properties for the GetHashCode component. For more information about these properties, see [Properties of the String Utilities components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/util-stringutil-prop.md).
