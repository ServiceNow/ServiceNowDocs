...
|Manage and monitor private relay registrations and connection health from your ServiceNow instance.|[Monitoring relay connectivity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/using-reverse-tunnel.md)|

## What to explore next

To learn more about configuring and using Reverse Tunnel, see:

-   [Configuring Reverse Tunnel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/configuring-reverse-tunnel.md)
-   [Monitoring relay connectivity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/using-reverse-tunnel.md)
