...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/fivetran-metadata-collector.html
release: australia
topic_type: concept
...
-   **[Prepare to run the Fivetran collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-fivetran-collector.md)**  
Create a Fivetran API key before running the collector.
-   **[Create a Fivetran metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-fivetran-metadata-collector.md)**  
