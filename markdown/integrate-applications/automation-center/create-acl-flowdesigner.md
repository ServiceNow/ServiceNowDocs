...
1.  Navigate to **All** &gt; **Process Automation** &gt; **Workflow Studio**.
    ...
    For detailed information, see [Create a flow in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/build-workflows/create-flow.md).
