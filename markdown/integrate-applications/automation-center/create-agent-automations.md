...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/automation-center/create-agent-automations.html
release: zurich
...
breadcrumb: [Automating tasks from Task Mining, Integration with Task Mining, Integration with Task Mining, Use, Automation Center, Workflow Data Fabric]
---
...
-   You must have completed the steps in [Integration with Automation Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/integration-with-automation-center.md) and reviewed the decomposed automations of the automation request.
-   User task step summarization skill must be activated. For more information, see [Activate skills](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/automation-center/activate-skill.md).
...
1.  On the **Automations** tab of the automation request, confirm that you have reviewed and are satisfied with the decomposed automations.
    ...
    For detailed navigation, see step 1 in [Generate automations from a Task Mining request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/automation-center/generate-automations-tm.md).
...
**Parent Topic:**[Automating tasks from Task Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/automation-center/automate-tasks-from-task-mining.md)
