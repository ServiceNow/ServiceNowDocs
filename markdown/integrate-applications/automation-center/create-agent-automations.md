...
-   You must have completed the steps in [Integration with Automation Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/integration-with-automation-center.md) and reviewed the automations created from the automation request.
