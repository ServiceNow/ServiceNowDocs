...
**Note:** The number of days the error records will be stored in the table is defined in the Automation Center purge system property \(`sn_ac.purge_automation_data_in_days`\).
