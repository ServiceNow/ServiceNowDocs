...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/automation-center/verify-test.html
release: australia
...
Proceed from the **Configure batch import for data** section. For information on configuring batch import for data, see [Configure batch import for data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/automation-center/config-batch-import.md).
