...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/automation-center/auto-explorer.html
release: australia
...
Run the fix script to be able to view the results of the Automation explorer. For information, see [Run fix script to view results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/automation-center/run-script.md).
...
<table id="choicetable_rrb_zjf_q3c"><tbody><tr><td id="d94462e123">
...
**Parent Topic:**[Using ServiceNow Otto for Automation Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/automation-center/use-now-assist.md)
