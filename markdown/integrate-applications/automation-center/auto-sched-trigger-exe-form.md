...
To learn more about creating and using business calendars and defining business calendar entries, see [Creating business calendars](https://www.servicenow.com/docs/access?context=business-calendars&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) and[Define business calendar entries](https://www.servicenow.com/docs/access?context=define-business-calendar-entries&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
