...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/automation-center/spotlight-ac.html
release: xanadu
...
-   **[Configuration Settings for ServiceNow Spotlight](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/automation-center/spotlight-config.md)**  
To use the ServiceNow Spotlight feature, set the configuration settings.
-   **[Default ServiceNow Spotlight Criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/automation-center/default-spotlight-criteria.md)**  
ServiceNow Spotlight is available with default criteria. Each field provides a score based on the default criteria.
-   **[Working with ServiceNow Spotlight](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/automation-center/use-spotlight.md)**  
Use the spotlight feature to auto-calculate the score of an automation request.
-   **[Set up ServiceNow Spotlight](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/automation-center/setup-spotlight.md)**  
