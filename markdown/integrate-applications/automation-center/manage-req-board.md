...
3.  You can do multiple actions on the Request Board.
    ...
    -   Create a task from the automation request card.
        ...
        2.  Select the **Add Task** icon.
            ...
            The **Create New Automation Task** form is displayed. For more information, see [Automation task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/automation-center/automation-task-form.md).
...
-   **[Run fix script to view demo data on Kanban board](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/automation-center/run-fix-scripts.md)**  
