...
4.  You can do multiple actions on the Task Board.
    ...
    -   Create a task from the automation task card.
        ...
        The **Create New Automation Task** form is displayed. Provide the details. For more information, see [Automation task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/automation-center/automation-task-form.md).

        Verify that the associated automation request is either in the **Planned** or **In Progress** state.


**Parent Topic:**[Automation Center Kanban board](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/automation-center/kanban.md)
