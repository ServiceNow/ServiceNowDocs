...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/automation-center/migrate-automations.html
release: australia
...
6.  Select an instance where you want to migrate the automations.
    ...
    For information on how to configure an instance, see [Configure an instance for migration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/automation-center/config-instance.md).
...
-   **[Configure an instance for migration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/automation-center/config-instance.md)**  
