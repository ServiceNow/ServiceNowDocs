...
After the automation request is moved to the following states, the option to clear a checklist isn’t available:
...
4.  Open the automation request for which you want to delete a checklist.
