...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/automation-center/publish-automation-request.html
release: zurich
...
For details about mapping an automation request with automation CI record, see [Map automations with automation request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/integrate-applications/automation-center/map-automation-to-req.md).
