...
For details about mapping an automation request with automation CI record, see [Map automations with automation request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/automation-center/map-automation-to-req.md).
