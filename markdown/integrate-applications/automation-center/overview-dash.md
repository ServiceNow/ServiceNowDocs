...
-   **Deployed automations by business criticality**
    ...
    This chart displays data about all active automations. It also provides details about the business criticality of each of the automation. This helps you in understanding how many automations are highly critical and how many aren’t.
...
-   **Robotic Process Automation \(RPA\) by source**
    ...
    This chart displays the automations for all RPAs grouped by sources. The graph gives details of the time lines when the RPA data was sent to Automation Center.

-   **Automations by ServiceNow Flow**

    This chart provides details of the ServiceNow flow automations with the time lines.

-   **Automations by Document Intelligence**

    This chart provides details of the Document Intelligence automations with the time lines.
...
-   **New requests**
    ...
    Displays all automation requests that are in the New state.

-   **Requests by intake source**

    Displays all automation requests grouped by intake source, such as Web, Process Mining, or Service Request.

-   **Requests to be deployed**

    Displays the automation requests ready to be deployed.
