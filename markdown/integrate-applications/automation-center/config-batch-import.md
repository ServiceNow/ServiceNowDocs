...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/automation-center/config-batch-import.html
release: brazil
...
Proceed from the **Select an action** section. For information on selecting a spoke, see [Select an action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/automation-center/select-action.md).
...
2.  Select **Continue to edit flow**.
    ...
    **Note:** Edit the flow as per your requirement. For information on editing a flow, see [Edit flow in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/automation-center/cm-edit-flow-ac.md).
...
-   **[Edit flow in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/automation-center/cm-edit-flow-ac.md)**  
