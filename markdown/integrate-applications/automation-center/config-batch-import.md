...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/integrate-applications/automation-center/config-batch-import.html
release: yokohama
...
Proceed from the **Select an action** section. For information on selecting a spoke, see [Select an action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/automation-center/select-action.md).
...
2.  Select **Continue to edit flow**.
    ...
    **Note:** Edit the flow as per your requirement. For information on editing a flow, see [Edit flow in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/automation-center/cm-edit-flow-ac.md).
...
-   **[Edit flow in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/automation-center/cm-edit-flow-ac.md)**  
Edit the flow to confirm that the pagination is implemented correctly. This confirms that the data is imported correctly.

**Parent Topic:**[Configuring data import](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/integrate-applications/automation-center/configure-data-import.md)
