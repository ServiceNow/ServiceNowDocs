...
The Automation Center API enables you to create and update processes, robots, and execution jobs. For more information, see [Automation Center API](https://www.servicenow.com/docs/access?context=auto-api&version=australia&pubname=australia-api-reference&ft:locale=en-US).

## Integration with Task Mining

Automation Center integrates with Task Mining enabling you to create automations from Task Mining workspace. For more information, see [Task Mining](https://www.servicenow.com/docs/access?context=task-mining&version=australia&pubname=australia-now-intelligence&ft:locale=en-US).
