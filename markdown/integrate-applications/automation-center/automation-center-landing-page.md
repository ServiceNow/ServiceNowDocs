...
The Automation Center API enables you to create and update processes, robots, and execution jobs. For more information, see [Automation Center API](https://www.servicenow.com/docs/access?context=auto-api&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
