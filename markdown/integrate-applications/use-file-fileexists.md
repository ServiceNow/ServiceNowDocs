...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-file-fileexists.html
release: brazil
topic_type: task
...
You can configure the properties for the FileExists component. For more information about these properties, see [Properties of the File components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/util-file-prop.md).
