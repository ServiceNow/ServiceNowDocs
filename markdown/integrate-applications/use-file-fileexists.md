...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-file-fileexists.html
release: australia
topic_type: task
...
You can configure the properties for the FileExists component. For more information about these properties, see [Properties of the File components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/util-file-prop.md).
