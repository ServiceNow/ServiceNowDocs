...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/create-microsoft-sql-server-metadata-collector.html
release: australia
topic_type: task
...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the Microsoft SQL Server collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-microsoft-sql-server-collector.md).
...
**Parent Topic:**[Microsoft SQL Server metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/microsoft-sql-server-metadata-collector.md)
