...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-user-certificates-rpa.html
release: australia
topic_type: concept
...
If user certificates are generated by your organization, then you can skip this procedure. You can proceed with [installing the user certificate.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/use-user-certificates-rpa.md)
...
<table id="choicetable_xwg_ksg_q2c"><thead><tr><th align="left" id="d159422e362">

Certificate type

</th><th align="left" id="d159422e365">

Steps

</th></tr></thead><tbody><tr><td id="d159422e371">
...
Install the generated client authentication and code signing certificate. For more information, see [Install the user-generated certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/use-user-certificates-rpa.md).
...
Generate a client authentication and a code signing certificate. For more information, see [Generate a user certificate from KeyStore Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/use-user-certificates-rpa.md).
...
Add the user to manage private keys. For more information, see [Add user to manage private keys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/use-user-certificates-rpa.md).
...
-   To set up the Unattended Robot. For more information, see [Set up Unattended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/set-up-rpa-runtime.md).
-   To publish an automation project in RPA Desktop Design Studio. For more information, see [Publish an automation project in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/publish-automation-project.md).
