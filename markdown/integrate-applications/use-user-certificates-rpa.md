...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-user-certificates-rpa.html
release: australia
topic_type: concept
...
If you don't have the active directory certificates, do the tasks in the following topics to generate and install user certificates. For more information, see [Exporting Microsoft Active Directory certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/export-certificates-rpa.md).
...
If user certificates are generated by your organization, then you can skip this procedure. You can proceed with [installing the user certificate.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-user-certificates-rpa.md)
...
<table id="choicetable_xwg_ksg_q2c"><thead><tr><th align="left" id="d603520e362">

Certificate type

</th><th align="left" id="d603520e365">

Steps

</th></tr></thead><tbody><tr><td id="d603520e371">
...
2.  Select the \[Omitted image "icon-plus-user-cert-rpa.png"\] Alt text: Plus icon. icon.
...
5.  In the Custom Extended Key Usage dialog box, select the \[Omitted image "icon-plus-user-cert-rpa.png"\] Alt text: Plus icon. icon.

6.  In the Add Custom Extended Key Usage dialog box, in the Object Identifier field, enter `1.3.6.1.5.5.7.3.2 clientAuth`.

\[Omitted image "add-custome-key-usage-rpa.png"\] Alt text: Add Custom Extended Key Usage dialog box with Client Auth value selected.

7.  Select **OK**.


</td></tr><tr><td id="d603520e450">
...
Register user-generated client authentication certificate to make it available for authentication. For more information, see [Register the CA certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/set-up-mutual-auth.md).

Map the user-generated client authentication certificate to the user. For more information, see [Map the PEM certificate to user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/set-up-mutual-auth.md).

Install the generated client authentication and code signing certificate. For more information, see [Install the user-generated certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-user-certificates-rpa.md).
...
Generate a client authentication and a code signing certificate. For more information, see [Generate a user certificate from KeyStore Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-user-certificates-rpa.md).
...
Add the user to manage private keys. For more information, see [Add user to manage private keys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-user-certificates-rpa.md).
...
Install the user-generated \(client authentication and code signing\) certificates in your Windows machine, if you have the admin role. For more information, see [Install the user-generated certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-user-certificates-rpa.md).
...
-   To set up the Unattended Robot. For more information, see [Set up Unattended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/set-up-rpa-runtime.md).
-   To publish an automation project in RPA Desktop Design Studio. For more information, see [Publish an automation project in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/publish-automation-project.md).
