...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/bigquery-metadata-collector.html
release: australia
topic_type: concept
...
</table>-   **[Prepare to run the BigQuery collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-bigquery-collector.md)**  
Create a service account and configure authentication before running the collector.
-   **[Create a BigQuery metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-bigquery-metadata-collector.md)**  
