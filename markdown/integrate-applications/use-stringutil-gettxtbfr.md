...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-stringutil-gettxtbfr.html
release: brazil
topic_type: task
...
You can configure the properties for the GetTextBefore component. For more information about these properties, see [Properties of the String Utilities components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/util-stringutil-prop.md).
