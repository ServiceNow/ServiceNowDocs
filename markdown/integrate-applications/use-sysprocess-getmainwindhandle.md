...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-sysprocess-getmainwindhandle.html
release: brazil
topic_type: task
...
You can configure the properties for the GetMainWindowHandle component. For more information about these properties, see [Properties of the System Process components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/util-sysprocess-prop.md).
