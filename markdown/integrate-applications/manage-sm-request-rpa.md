...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/manage-sm-request-rpa.html
release: australia
topic_type: task
last_updated: "2026-03-12"
reading_time_minutes: 4
breadcrumb: [Scheduled maintenance days, Use, RPA Hub, Robotic Process Automation \(RPA\) Hub, Workflow Data Fabric]
---
...
Ensure you’re familiar with scheduled maintenance days concepts. For more information, see [Scheduled maintenance days in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/sm-days-rpa.md).

Create a change request from the **Change** module. For more information, see [Create a change request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-service-management/t_CreateAChange.md). Ensure to do the following tasks while creating a change request:
...
**Parent Topic:**[Scheduled maintenance days in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/sm-days-rpa.md)
...
[Maintenance request form in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/view-mr-rpa.md)
