...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-utilities-json-serializeobject.html
release: brazil
topic_type: task
...
To configure the properties for the SerializeObject component, see [Properties of the JSON utilities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/properties-utilities-json.md).
