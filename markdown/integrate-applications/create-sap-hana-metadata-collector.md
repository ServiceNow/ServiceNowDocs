...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the SAP HANA collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/prepare-to-run-sap-hana-collector.md).
...
**Parent Topic:**[SAP HANA metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/sap-hana-metadata-collector.md)
