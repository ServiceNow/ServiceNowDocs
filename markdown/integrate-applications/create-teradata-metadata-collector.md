...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/create-teradata-metadata-collector.html
release: australia
topic_type: task
...
-   All prerequisite tasks are complete. For more information, see [Prepare to run the Teradata Collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-teradata-collector.md).
