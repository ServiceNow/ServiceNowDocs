...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/assign-botprocess-queue.html
release: australia
topic_type: task
...
To associate a queue to a bot process from the bot process related list, see [c to the bot process from the related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/associate-queue-botprocess.md).
