...
<table id="choicetable_kgc_jxm_frb"><thead><tr><th align="left" id="d591605e162">

Option

</th><th align="left" id="d591605e165">

Action

</th></tr></thead><tbody><tr><td id="d591605e171">
...
2.  Select **New Bot Process Configuration**.
    ...
    For a description of the field values, see [Bot process configuration form in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/create-botprocess-config.md).
...
<table id="choicetable_twb_ds5_tvb"><thead><tr><th align="left" id="d591605e262">

Option

</th><th align="left" id="d591605e265">

Action

</th></tr></thead><tbody><tr><td id="d591605e271">
