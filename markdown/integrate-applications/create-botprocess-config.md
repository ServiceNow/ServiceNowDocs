...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/create-botprocess-config.html
release: brazil
topic_type: task
...
<table id="choicetable_kgc_jxm_frb"><thead><tr><th align="left" id="d588882e162">

Option

</th><th align="left" id="d588882e165">

Action

</th></tr></thead><tbody><tr><td id="d588882e171">
...
2.  Select **New Bot Process Configuration**.
    ...
    For a description of the field values, see [Bot process configuration form in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/create-botprocess-config.md).
...
<table id="choicetable_twb_ds5_tvb"><thead><tr><th align="left" id="d588882e262">

Option

</th><th align="left" id="d588882e265">

Action

</th></tr></thead><tbody><tr><td id="d588882e271">
...
This configuration record is not associated to a bot process. It remains orphaned.
 ...
 If you want to associate it with a bot process record later, follow the steps in [Associate a bot process to a bot process configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/select-botprocess.md).

</td></tr><tr><td id="d588882e301">
