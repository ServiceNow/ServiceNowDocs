---
title: Create an LDAP type data source
description: Create an LDAP type data source record to define what data an import set should import.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/system-import-sets/create-ldap-type-data-source.html
release: xanadu
...
breadcrumb: [Create a data source, Data sources, Import sets, Imports, Creating integrations with applications]
---
...
For additional information, see [LDAP type data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/system-import-sets/r_LDAPTypeDataSource.md).
...
<table id="table_n3v_by3_z3b"><thead><tr><th>
...
Target selected from the list of your LDAP OU definitions.
...
**Parent Topic:**[Create a data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/system-import-sets/c_CreateNewDataSource.md)
