...
For more information, see [Complex data](https://www.servicenow.com/docs/access?context=complex-data&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
