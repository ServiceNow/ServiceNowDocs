...
8.  If desired, you can add a Script step to validate or modify action inputs, set default values, or build request payloads before executing the REST step.
    ...
    4.  Configure the Script step as described in [Script step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/javascript-step-action-designer.md).

9.  Select **REST step** from the Action Outline.

10. Configure the REST step as described in [REST step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/rest-request-action-designer.md).
