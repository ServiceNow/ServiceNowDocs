...
6.  Complete the form.
    ...
    |Conditional Script|Condition specified as a string. For an example of a conditional script, see [Temporary entity model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/system-import-sets/temp-entity-model.md).|
