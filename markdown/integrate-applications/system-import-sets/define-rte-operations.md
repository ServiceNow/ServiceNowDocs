...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/system-import-sets/define-rte-operations.html
release: australia
...
6.  Complete the form.
    ...
    |Conditional Script|Condition specified as a string. For an example of a conditional script, see [Temporary entity model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/system-import-sets/temp-entity-model.md).|
