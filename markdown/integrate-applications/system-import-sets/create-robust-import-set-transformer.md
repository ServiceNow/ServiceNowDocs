...
-   [Create an ETL definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/system-import-sets/create-etl-definitions.md).
-   [Create a robust transform definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/system-import-sets/create-robust-transform-definitions.md).
...
Enables you to select an ETL definition or CMDB definition. For procedures to define an RTE, see [Create robust transform definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/system-import-sets/create-robust-transform-definitions.md).
