...
-   **glide.ds.file.http.variable\_replacement**
    ...
    -   Default value: true
    -   Location: [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_AddAPropertyUsingSysPropsList.md)
    -   More information: [Data source fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/system-import-sets/r_DataSourceFileTypeFields.md)
...
-   **glide.import.debug**
    ...
    -   Type: true \| false
    -   Default value: false
    -   Location: [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_AddAPropertyUsingSysPropsList.md)Add to the System Property \[sys\_properties\] table
