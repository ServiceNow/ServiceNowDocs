...
**Explore**
 ...
 -   [Upgrade to Washington DC](https://www.servicenow.com/docs/access?context=upgrade&version=yokohama&pubname=yokohama-release-notes&ft:locale=en-US)
...
-   [Use the Import Set API](https://www.servicenow.com/docs/access?context=c_ImportSetAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US)
...
-   [Apply CI Identification and Reconciliation to Import Sets](https://www.servicenow.com/docs/access?context=identification-import-sets&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
