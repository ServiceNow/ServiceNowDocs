...
**Explore**
 ...
 -   [Upgrade to Washington DC](https://www.servicenow.com/docs/access?context=upgrade&version=xanadu&pubname=xanadu-release-notes&ft:locale=en-US)
...
-   [Use the Import Set API](https://www.servicenow.com/docs/access?context=c_ImportSetAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
...
-   [Apply CI Identification and Reconciliation to Import Sets](https://www.servicenow.com/docs/access?context=identification-import-sets&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
