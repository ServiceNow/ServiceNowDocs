...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/system-import-sets/c\_ImportingFromAnotherSNInstance.html
release: australia
...
-   **[XML records from lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/system-import-sets/c_XMLRecordsFromLists.md)**  
You can directly export records as XML from any list or form.
-   **[Using XML import sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/system-import-sets/c_XMLImportSets.md)**  
Use an XML import set to import data from another instance.
-   **[Retrieving data from a CSV formatted file](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/system-import-sets/t_RetrieveDataFromACSVFormatFile.md)**  
