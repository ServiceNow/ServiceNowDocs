...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/system-import-sets/r\_FileTypeDataSource.html
release: zurich
...
[Add and manage attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/t_AddingAnAttachment.md) a file to the record and import that file in an import set.
