...
[Add and manage attachments](https://www.servicenow.com/docs/access?context=t_AddingAnAttachment&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US) a file to the record and import that file in an import set.
