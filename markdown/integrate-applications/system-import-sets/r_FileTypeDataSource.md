...
[Add and manage attachments](https://www.servicenow.com/docs/access?context=t_AddingAnAttachment&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US) a file to the record and import that file in an import set.
