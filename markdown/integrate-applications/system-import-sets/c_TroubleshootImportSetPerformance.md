...
-   Activate the Secondary Database Pools \[com.glide.secondary\_db\_pools\] plugin. For more information, see [Request a plugin](https://www.servicenow.com/docs/access?context=t_RequestAPlugin&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
