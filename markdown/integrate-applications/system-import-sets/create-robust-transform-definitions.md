...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/system-import-sets/create-robust-transform-definitions.html
release: australia
...
2.  Select an existing robust import set transformer, or click **New** to create a new robust import set transformer.
    ...
    For procedures, see [Create a robust import set transformer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/system-import-sets/create-robust-import-set-transformer.md).
