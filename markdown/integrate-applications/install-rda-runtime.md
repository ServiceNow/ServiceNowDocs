...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/install-rda-runtime.html
release: australia
topic_type: task
...
Download and unzip the installation file for the Attended Robot application. For more information, see [Download the RPA applications from RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/download-installer-rpa.md).
