...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/enable-client-flow-rpa.html
release: brazil
topic_type: task
...
Make sure that you're familiar with the RPA Hub actions and subflow. For more information, see [Workflow Studio actions and subflow in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/rpa-hub-actions.md).

Invoke a flow or a subflow from Workflow Studio by using the InvokeFlow component or InvokeSubFlow component. For more information, see [Use the InvokeFlow component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/use-rpahub-flowdesigner-invokeflow.md) and [Use the InvokeSubFlow component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/use-rpahub-flowdesigner-invokesubflow.md).
...
**Parent Topic:**[Workflow Studio actions and subflow in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/rpa-hub-actions.md)
