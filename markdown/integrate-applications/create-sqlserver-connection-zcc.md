...
description: Establish a zero copy connection to a Microsoft SQL Server database in Zero Copy Connector Hub.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/create-sqlserver-connection-zcc.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 1
breadcrumb: [Microsoft SQL Server, Community connectors, Manage zero copy connections, Zero Copy Connectors, Workflow Data Fabric]
---

# Create a Microsoft SQL Server connection

Establish a zero copy connection to a Microsoft SQL Server database in Zero Copy Connector Hub.
...
Work with your data source admin to create a connection to SQL Server. For additional information about connecting, refer to the [SQL Server connector documentation](https://trino.io/docs/current/connector/sqlserver.html).
...
JDBC URL to establish the connection. For example:`jdbc:sqlserver://<host>:<port>;databaseName=<databaseName>;encrypt=true;trustServerCertificate=true`
