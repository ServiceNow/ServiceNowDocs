...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/publish-automation-project.html
release: brazil
topic_type: task
...
Ensure that the automation project file is open in RPA Desktop Design Studio. For more information, see [Open a local automation project in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/open-project-rpa-studio.md).
...
Verify the connection manager setup in the RPA Desktop Design Studio. For more information, see [Set up RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/set-up-rpa-studio.md).
...
<table><thead><tr><th align="left" id="d205419e251">

Option

</th><th align="left" id="d205419e254">

Action

</th></tr></thead><tbody><tr><td id="d205419e260">
