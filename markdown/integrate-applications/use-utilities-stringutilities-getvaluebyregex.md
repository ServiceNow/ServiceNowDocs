...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-utilities-stringutilities-getvaluebyregex.html
release: brazil
topic_type: task
...
You can configure the properties for the GetValueByRegex component. For more information about these properties, see [Properties of the String Utilities components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/util-stringutil-prop.md).
