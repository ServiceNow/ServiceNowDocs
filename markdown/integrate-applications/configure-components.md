...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/configure-components.html
release: australia
topic_type: task
...
Each component has ports that are used while creating an automation workflow. For more information, see [RPA Desktop Design Studio ports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/overview-ports-rpa-studio.md).
...
<table id="choicetable_vmv_2f1_5rb"><thead><tr><th align="left" id="d259278e213">

Option

</th><th align="left" id="d259278e216">

Action

</th></tr></thead><tbody><tr><td id="d259278e222">
...
</td></tr><tr><td id="d259278e323">

**Handle the errors at a component level**

</td><td>

Right-click the component title bar and select **Error Handler** To learn more about handling errors, see [Handle errors in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/error-handling-rpa-studio.md).

</td></tr><tr><td id="d259278e348">
