...
-   Create an OAuth endpoint on the remote instance. For more information, see [Create an endpoint for clients to access the instance](https://www.servicenow.com/docs/access?context=t_CreateEndpointforExternalClients&version=australia&pubname=australia-platform-security&ft:locale=en-US).
