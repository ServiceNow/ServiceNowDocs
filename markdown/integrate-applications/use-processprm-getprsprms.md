...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-processprm-getprsprms.html
release: brazil
topic_type: task
...
Set at least two process parameters as part of a bot process on the RPA Hub. See [Create a process parameter within a bot process in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/create-process-parameter-botprocess.md).
...
You can configure the properties for the GetProcessParameters component. For more information about these properties, see [Properties of the Process Parameters components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/processprm-properties.md).
