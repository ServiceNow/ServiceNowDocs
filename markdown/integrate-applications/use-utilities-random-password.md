...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-utilities-random-password.html
release: australia
topic_type: task
...
To configure the properties for the Password component, see [Properties of the Random components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/properties-random-component.md).
...
3.  To provide the inputs to the fields, see [Configure port properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/configure-input-port-properties.md).
...
**Parent Topic:**[Random](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/random.md)
