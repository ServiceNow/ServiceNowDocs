...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-security-encryption-decryptstring.html
release: brazil
topic_type: task
...
You can configure the properties for the Decrypt String component. For more information about these properties, see [Properties of the Encryption components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/properties-security-encryption-components.md).
...
**Parent Topic:**[Encryption components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/encryption-components.md)
