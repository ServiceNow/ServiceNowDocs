...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/oracle-hcm-discovery-zcc.html
release: australia
topic_type: concept
...
Oracle HCM \(Discovery\) is a **REST** connector. Before you set up this connection, review [REST connectors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/rest-connectors.md) for prerequisites, authentication requirements, and API consumption considerations.
...
[Create an Oracle HCM \(Discovery\) connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-oracle-hcm-discovery-connection-zcc.md)
