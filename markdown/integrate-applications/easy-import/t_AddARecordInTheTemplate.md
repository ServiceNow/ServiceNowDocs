...
1.  Add a row for each record you want to add to the table.
    ...
    Each column corresponds to a field in the target table. Use the UI [Field administration](https://www.servicenow.com/docs/access?context=c_IntroductionToFields&version=australia&pubname=australia-platform-administration&ft:locale=en-US) to learn about the purpose and content of the field.
