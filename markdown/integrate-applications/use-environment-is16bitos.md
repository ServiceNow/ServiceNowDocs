...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-environment-is16bitos.html
release: brazil
topic_type: task
...
You can configure the properties for the Is64BitOperatingSystem component. For more information about these properties, see [Properties of the Environment components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/util-environment-prop.md).
...
**Parent Topic:**[Environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/environment-utility.md)
