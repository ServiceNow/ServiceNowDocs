...
breadcrumb: [Queue implementation, Use, RPA Hub, Robotic Process Automation \(RPA\) Hub, Workflow Data Fabric]
---
...
For more information on queues implementation in RPA Hub, see [Queue implementation in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/queues-implement-rpa.md).

You can use the guided tour to get instructions on how to create a queue in the classic environment. For more information, see [Use Guided Tours in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/use-guided-tour-rpa-hub.md).
...
**Parent Topic:**[Queue implementation in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/queues-implement-rpa.md)
