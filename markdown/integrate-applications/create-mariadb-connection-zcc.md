---
title: Create a MariaDB connection
description: Establish a zero copy connection to an external MariaDB database in Zero Copy Connector Hub.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/create-mariadb-connection-zcc.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 1
breadcrumb: [MariaDB, Community connectors, Manage zero copy connections, Zero Copy Connectors, Workflow Data Fabric]
---

# Create a MariaDB connection

Establish a zero copy connection to an external MariaDB database in Zero Copy Connector Hub.
...
JDBC URL to establish the connection. For example:`jdbc:mariadb://<host>:<port>?ssl=true`
