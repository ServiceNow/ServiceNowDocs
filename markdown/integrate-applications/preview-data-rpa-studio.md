...
Ensure that the component for which you want to view the data for is executed. For more information, see [Run an automation in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/run-automation-rpa-studio.md).
