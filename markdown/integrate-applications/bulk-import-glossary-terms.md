...
Before importing, [export glossary terms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/bulk-export-glossary-terms.md) to obtain the XLSX template, then [edit the spreadsheet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/edit-glossary-spreadsheet.md) to add or update glossary terms.
