...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/prepare-to-run-oracle-collector.html
release: australia
topic_type: task
...
1.  Create Oracle user and grant permissions.
    ...
    See [Set up user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-oracle-collector.md).

2.  Prepare to harvest cross-server lineage.

    See [Set up AWR permissions for lineage extraction](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-oracle-collector.md).

3.  Prepare to harvest from autonomous databases.

    See [Prepare to harvest cross-server lineage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-oracle-collector.md).


**Parent Topic:**[Oracle metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/oracle-metadata-collector.md)
