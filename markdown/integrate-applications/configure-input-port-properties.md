...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/configure-input-port-properties.html
release: australia
topic_type: task
