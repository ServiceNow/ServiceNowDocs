...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/servicenow-metadata-collector.html
release: australia
topic_type: concept
...
-   **[Prepare to run the ServiceNow collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-servicenow-collector.md)**  
Create a ServiceNow user and configure permissions before running the collector.
-   **[Create a ServiceNow metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-servicenow-metadata-collector.md)**  
