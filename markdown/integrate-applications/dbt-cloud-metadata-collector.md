...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/dbt-cloud-metadata-collector.html
release: australia
topic_type: concept
...
-   **[Prepare to run the dbt Cloud collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-dbt-cloud-collector.md)**  
Configure dbt Cloud and create authentication tokens before running the collector.
-   **[Create a dbt Cloud metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-dbt-cloud-metadata-collector.md)**  
