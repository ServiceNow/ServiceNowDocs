...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-mouse-scroll.html
release: brazil
topic_type: task
...
You can configure the properties for the Scroll component. For more information about these properties, see [Properties of the Mouse components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/util-mouse-prop.md).
...
**Parent Topic:**[Mouse](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/mouse-utility.md)
