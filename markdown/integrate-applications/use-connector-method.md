...
You must install the connector plugin. To install, see [Manage plugins in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/install-plugins-rpa-studio.md).
...
<table id="choicetable_vy3_55j_tsb"><thead><tr><th align="left" id="d581612e89">

Number of levels

</th><th align="left" id="d581612e92">

Step

</th></tr></thead><tbody><tr><td id="d581612e98">
