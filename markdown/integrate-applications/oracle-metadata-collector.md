...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/oracle-metadata-collector.html
release: australia
topic_type: concept
...
-   **[Prepare to run the Oracle collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-oracle-collector.md)**  
Set up database user permissions and configure advanced features before running the collector.
-   **[Create an Oracle metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-oracle-metadata-collector.md)**  
