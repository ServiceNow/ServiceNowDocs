...
description: Crop and retrieve part of an image as part of an automation Workflow by using the GetPart component in RPA Desktop Design Studio.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-imageutil-getpart.html
release: australia
topic_type: task
...
You can configure the properties for the GetPart component. For more information about these properties, see [Properties of the Image Utilities components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/util-imageutil-prop.md).
