...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-utilities-random-string.html
release: australia
topic_type: task
...
You can configure the properties for the String component. For more information about these properties, see [Properties of the Random components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/properties-random-component.md).
