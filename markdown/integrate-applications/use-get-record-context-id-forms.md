...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-get-record-context-id-forms.html
release: brazil
topic_type: task
...
You can configure the properties for the GetRecordContextID component. For more information about these properties, see [Properties of the Forms components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/sn-forms-properties.md).
