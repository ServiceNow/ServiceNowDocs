...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/databricks-metadata-collector.html
release: australia
topic_type: concept
...
-   **[Prepare to run the Databricks collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-the-databricks-collector.md)**  
Complete authentication and permission configuration tasks before running the Databricks metadata collector.
-   **[Create a Databricks metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-databricks-metadata-collector.md)**  
