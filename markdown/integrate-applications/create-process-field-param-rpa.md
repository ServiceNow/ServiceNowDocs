...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/create-process-field-param-rpa.html
release: australia
topic_type: task
...
Otherwise, create it while mapping the field parameters by selecting the **Create parameter** button from the **Field Parameter Mappings** tab. For more information, see [Map a table field to a bot process field parameter in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-field-param-mapping-rpa.md).
...
[Create an attended configuration record in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-attended-config-rpa.md)
