...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-security-dpapi-protectdata.html
release: australia
topic_type: task
...
You can configure the properties for the ProtectData component. For more information about these properties, see [Properties of the DPAPI components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/properties-of-dpapi-components.md).
