...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/connect-to-external-systems.html
release: australia
topic_type: concept
...
-   **Discover external systems and integration opportunities**
    ...
    Explore available [external systems](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/connecthub-create-external-systems.md) and identify connection methods for over 200 third-party systems like MS Teams, Jira, and Snowflake.
