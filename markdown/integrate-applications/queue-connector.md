---
title: Queue
description: The Queue connector enables you to create and manage work items on a queue created in the RPA Hub.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/queue-connector.html
release: australia
topic_type: concept
...
After you create a queue in the RPA Hub and assign a bot process to it, you must associate the Queue connector with the queue name. Then, assign the bot process to the automation project by using the **Assign bot process** option from the **Design** tab of RPA Desktop Design Studio to access the work items. For more information, see [Assign bot process to an automation project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/assign-bot-process.md).

To create a queue, see [Create a queue in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-queue.md).

To assign a bot process to a queue, see [Assign a bot process to a queue from Queues menu in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/assign-botprocess-queue.md).

You must first use, configure, and then expose the methods in the Queue connector to use its methods.

-   To use the Queue connector, see [Use a connector in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-connector.md).
...
-   **[Queue connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/connectors-queues-methods.md)**  
The Queue connector methods enable you to create and manage work items for queues in the RPA Hub.
-   **[Parameters for the Queue connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queue-connector-method-parameters.md)**  
Learn about the various parameters for the Queue connector methods in RPA Desktop Design Studio.

**Parent Topic:**[RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/rpa-hub.md)
