...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/queue-connector.html
release: brazil
topic_type: concept
...
To create a queue, see [Create a queue in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/create-queue.md).

To assign a bot process to a queue, see [Assign a bot process to a queue from Queues menu in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/assign-botprocess-queue.md).

You must first use, configure, and then expose the methods in the Queue connector to use its methods.

-   To use the Queue connector, see [Use a connector in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/use-connector.md).
...
-   **[Queue connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/connectors-queues-methods.md)**  
The Queue connector methods enable you to create and manage work items for queues in the RPA Hub.
-   **[Parameters for the Queue connector methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/queue-connector-method-parameters.md)**  
Learn about the various parameters for the Queue connector methods in RPA Desktop Design Studio.

**Parent Topic:**[RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/rpa-hub.md)
