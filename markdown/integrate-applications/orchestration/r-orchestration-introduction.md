...
-   **[Configuring Password Reset](https://www.servicenow.com/docs/access?context=password-reset-admin-guide&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)**
...
Orchestration can automate tasks such as employee onboarding, user access rights, server management, managed file transfers, and [Security Operations Orchestration](https://www.servicenow.com/docs/access?context=security-operations-orchestration&version=xanadu&pubname=xanadu-security-management&ft:locale=en-US). For example, you might use the Active Directory and Exchange activities provided in the base Orchestration system to set up network accounts and mailboxes for new employees.
...
-   Any system exposing web services \([SOAP,](https://www.servicenow.com/docs/access?context=t_CreateASOAPWebServiceActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) [REST](../../../administer/orchestration-activity-designer/task/t_CreateARESTWebServiceActivity.md#)\)
...
-   Numerous proprietary services: Windows [Active Directory](https://www.servicenow.com/docs/access?context=c_OrchActiveDirectoryActivities&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US), Microsoft [Exchange](../../../administer/orchestration-activities/concept/c_OrchestrationExchangeActivities.md) mail servers, [InfoBlox](../../../administer/orchestration-activities/concept/c_InfobloxDDIActivityPack.md), and [F5 Networks](../../../administer/orchestration-activities/concept/c_OrchF5LoadBalancerActivities.md).
