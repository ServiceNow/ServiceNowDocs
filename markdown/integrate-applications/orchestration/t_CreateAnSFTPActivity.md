...
<table id="choicetable_zmw_zbr_vz"><tbody><tr><td id="d407818e120">
...
</td></tr><tr><td id="d407818e425">

**Required MID Server capabilities**

</td><td>

MID Server with the appropriate [MID Server capabilities](https://www.servicenow.com/docs/access?context=t_ConfigureCapabilities&version=xanadu&pubname=xanadu-servicenow-platform&section=r_MIDServerCapabilities&ft:locale=en-US) for connecting to the source and target servers.
