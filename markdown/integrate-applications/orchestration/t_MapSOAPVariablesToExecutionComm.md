...
[SOAP message](https://www.servicenow.com/docs/access?context=c_SOAPMessage&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) to use for this activity. Users must have the web\_service\_admin role to configure this field.
...
SOAP message [SOAP message functions](https://www.servicenow.com/docs/access?context=c_SOAPMessageFunctions&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) to use for this activity. Users must have the web\_service\_admin role to configure this field.
