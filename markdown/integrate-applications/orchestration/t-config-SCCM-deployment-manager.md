...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/orchestration/t-config-SCCM-deployment-manager.html
release: xanadu
...
8.  Open the menu from the upper left corner of the console and select **Connect via Windows PowerShell**.
    ...
    \[Omitted image "ConnectSCCMviaPowerShell.png"\] Alt text:
