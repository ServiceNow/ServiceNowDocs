...
6.  Click **Continue** to open the Execution Command form, then fill out the **Execution Command** step based on the corresponding execution templates:
    ...
    -   [Create a SOAP web service activity](https://www.servicenow.com/docs/access?context=t_CreateASOAPWebServiceActivity&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
...
<table id="choicetable_lh4_h3j_4y"><tbody><tr><td id="d485160e339">
