...
5.  Fill in the other fields on the form, as appropriate.
    ...
    For details, see [Windows credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/r_WindowsCredentialsForm.md).
