...
|[Change AD User Password](https://www.servicenow.com/docs/access?context=r_ChangeADUserPassword&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|Changes the password of a user account in Windows Active Directory.|
...
|Activity|Description|
|--------|-----------|
|[Add User to Group](https://www.servicenow.com/docs/access?context=r_AddUserToGroupAzureADActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|Adds a user to an existing security group in Azure Active Directory.|
|[Assign User License](https://www.servicenow.com/docs/access?context=r_AssignUserLicenseAzureADActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|Assigns an extra Office 365 software license to the named user.|
|[Create User](https://www.servicenow.com/docs/access?context=r_CreateUserAzureADActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|Creates a user for the Azure Active Directory tenant.|
...
|Activity|Description|
|--------|-----------|
|[Add F5 Pool](https://www.servicenow.com/docs/access?context=r_AddF5PoolActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|Creates the load balancer pool.|
...
|Activity|Description|
|--------|-----------|
|[DHCP Reserve IP v4 Address Range](https://www.servicenow.com/docs/access?context=c_InfobloxDHCPActivities&version=xanadu&pubname=xanadu-servicenow-platform&section=r_DHCPReserveIPv4AddrRangeActivity&ft:locale=en-US)|Reserves an IP address range for DHCP use.|
...
|[List DNS C-records](https://www.servicenow.com/docs/access?context=c_InfobloxDNSActivities&version=xanadu&pubname=xanadu-servicenow-platform&section=r_ListDNSCRecordsActivity&ft:locale=en-US)|Retrieves all canonical \(CNAME\) records from a specified Infoblox server.|
...
|[IPAM Register IP Address](https://www.servicenow.com/docs/access?context=c_InfobloxIPAMActivities&version=xanadu&pubname=xanadu-servicenow-platform&section=r_IPAMRegisterIPAddressActivity&ft:locale=en-US)|Registers an IP address in a network using Infoblox IPAM.|
...
|[Create Network](https://www.servicenow.com/docs/access?context=c_InfobloxNetworkActivities&version=xanadu&pubname=xanadu-servicenow-platform&section=r_CreateNetworkActivity&ft:locale=en-US)|Creates networks on a specified Infoblox server.|
...
|Activity|Description|
|--------|-----------|
|[Create Address List](https://www.servicenow.com/docs/access?context=r_CreateAddressListActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|Creates an address list that acts as an alias for emailing all users in the group. This alias cannot be used to manage user permissions.|
...
|[Create Mailbox](https://www.servicenow.com/docs/access?context=r_CreateMailboxActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|If a user does not exist, creates a new Active Directory user and associated Exchange mailbox.|
...
|Activity|Description|
|--------|-----------|
|[Install Windows App](https://www.servicenow.com/docs/access?context=r_InstallWindowsAppActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|Installs an application on a Windows target machine.|
...
|Activity|Description|
|--------|-----------|
|[Resolve DNS Name](https://www.servicenow.com/docs/access?context=probe_activity-pack&version=xanadu&pubname=xanadu-servicenow-platform&section=resolve-dns-name-activity&ft:locale=en-US)|Resolves an IP address or a fully qualified domain name \(FQDN\) into one or more IP addresses.|
...
|[File Replace String](https://www.servicenow.com/docs/access?context=r_FileReplaceStringActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|Finds and replaces a string in a file on a Linux or UNIX computer.|
| | |
|[Files Compare](https://www.servicenow.com/docs/access?context=r_FilesCompareActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|Compares two files on a Linux or Unix computer, via SSH.|
|[Reset Linux User Password](r_ResetLinuxUserPasswordActivity.md)|Resets the password for a given user on a Linux computer.|
|[Secure Copy](https://www.servicenow.com/docs/access?context=r_SecureCopyActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|Copies a file from one host to another, without storing the copied file on the MID Server.|
