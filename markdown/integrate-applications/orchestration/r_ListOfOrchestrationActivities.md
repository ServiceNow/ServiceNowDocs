...
|--------|-----------|
|[Test Server Alive](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/global-activity-pack.md)|Runs a command \(including shell scripts\) on a Linux or UNIX computer via SSH to validate whether the target system is alive.|
...
|Activity|Description|
|--------|-----------|
|[Create AD Object](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_CreateADObject.md)|Creates a user account in Windows Active Directory when a user account is created in a ServiceNow instance.|
|[Disable AD User Account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_DisableADUserAccount.md)|Marks a Windows Active Directory user account disabled, making it inactive.|
|[Enable AD User Account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_EnableADUserAccount.md)|Enables a Windows Active Directory user account, making it active.|
...
|[Remove User License](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_RemoveUserLicenseAzureADActivity.md)|Revokes the specified Office 365 software license for the named user.|
|[Reset User Password](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_ResetUserPasswordAzureADActivity.md)|Changes the named user's Azure Active Directory password.|
...
|[Get F5 Pool Member](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_GetF5PoolMemberActivity.md)|Returns the pool members and verifies the pool status.|
|[Delete F5 Pool Member](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_DeleteF5PoolMemberActivity.md)|Deletes an F5 pool member.|
|[Add F5 Virtual Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_AddF5VirtualServerActivity.md)|Adds a virtual server.|
|[Modify F5 Virtual Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_ModifyF5VirtualServerActivity.md)|Configures a virtual server assigned to an F5 pool with irules and a vlan.|
|[Delete F5 Virtual Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_DeleteF5VirtualServerActivity.md)|Deletes a virtual server from an F5 pool.|
|[Add F5 Profile to Virtual Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_AddF5ProfileToVirtualServerActivity.md)|Adds a profile to a virtual server assigned to an F5 pool.|
...
|[Get Mailbox](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_GetMailboxActivity.md)|Gets the mailbox for the specified user or all mailboxes on an Exchange server.|
|[Set Mailbox](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_SetMailboxActivity.md)|Modifies the settings of an existing Exchange mailbox.|
...
|[Change Service State](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_ChangeServiceState.md)|Starts or stops a Windows service on a remote system.|
...
|Activity|Description|
|--------|-----------|
|[Add to Device Collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_AddToDeviceCollectionActivity.md)|Adds a device to a Microsoft System Center Configuration Manager \(SCCM\) device collection.|
|[Add to User Collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_AddToUserCollectionActivity.md)|Adds a user to a Microsoft System Center Configuration Manager \(SCCM\) user collection.|
|[Get Applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_GetApplicationsActivity.md)|Returns a list of all the applications available on a Microsoft System Center Configuration Manager \(SCCM\) server.|
|[Get Deployments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_GetDeploymentsActivity.md)|Returns the list of deployments performed by Orchestration using a Microsoft System Center Configuration Manager \(SCCM\) server.|
|[Get Device Collections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_GetDeviceCollectionsActivity.md)|Returns the list of available device collections on a Microsoft System Center Configuration Manager \(SCCM\) host.|
|[Get User Collections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_GetUserCollectionsActivity.md)|Returns the list of available user collections on a Microsoft System Center Configuration Manager \(SCCM\) host.|
|[Remove from Device Collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_RemoveFmDevicCollectionActivity.md)|Removes a device from a Microsoft System Center Configuration Manager \(SCCM\) device collection.|
|[Remove from User Collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_RemoveFromUserCollectionActivity.md)|Removes a user from a Microsoft System Center Configuration Manager \(SCCM\) user collection.|
...
|Activity|Description|
|--------|-----------|
|[Copy File](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_CopyFileActivity.md)|Copies a file from an SFTP server \(source host\) to another SFTP server \(target host\).|
|[Create Directory](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_CreateDirectoryActivity.md)|Creates a directory on an SFTP server.|
|[Get File List](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_GetFileListActivity.md)|Returns a list of files from a given directory and its subdirectories on an SFTP server \(source host\).|
|[Remove File or Directory](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_RemoveFileOrDirectoryActivity.md)|Removes a file or a directory on an SFTP server, including subdirectories, when configured.|
|[Rename File or Directory](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_RenameFileOrDirectoryActivity.md)|Renames a file or directory to a new name on an SFTP server.|
|[Set File Attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/r_SetFileAttributesActivity.md)|Sets common file attributes, such as timestamps, size, permissions, and UID/GID, for a file or directory on an SFTP server.|

## Deprecated activities

These activities have been removed from the Workflow Editor and are not available for new workflows, but continue to work normally in existing workflows. You can [reactivate the deprecated activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/t_ReactivateDeprecatedActivity.md) or duplicate the functionality of a deprecated activity as a scoped activity by recreating it using the [activity designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/c_WorkflowActivityDesigner.md).
