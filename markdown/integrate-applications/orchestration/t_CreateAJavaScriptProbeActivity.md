...
For descriptions of the JavaScript Probe command fields, see the table in [Configure the JavaScript Probe execution command](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/orchestration/t_CreateAJavaScriptProbeActivity.md).
