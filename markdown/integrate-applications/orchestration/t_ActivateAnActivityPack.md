...
-   [Orchestration - Active Directory](https://www.servicenow.com/docs/access?context=c_OrchActiveDirectoryActivities&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) \(com.snc.orchestration.ad\)
