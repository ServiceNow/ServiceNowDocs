...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/orchestration/t-update-sccm-cmdlet-libraries.html
release: xanadu
...
Download the latest version of the cmdlet library from Microsoft. For installation instructions, see [https://technet.microsoft.com/en-us/library/dn958404\(v=sc.20\).aspx](https://technet.microsoft.com/en-us/library/dn958404(v=sc.20).aspx).
