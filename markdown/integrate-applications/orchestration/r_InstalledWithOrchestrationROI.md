...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/orchestration/r\_InstalledWithOrchestrationROI.html
release: zurich
...
Provides the labor rate cards Orchestration ROI uses to determine the savings for each automated task. See [Cost Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-business-management/r_CostManagement.md) for more information.
