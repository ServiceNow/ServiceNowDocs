...
**Important:** You must activate the Performance Analytics [scheduled collection job](https://www.servicenow.com/docs/access?context=r_OrchestrationROIPremiumDashboard&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) before Orchestration ROI premium can display data.
