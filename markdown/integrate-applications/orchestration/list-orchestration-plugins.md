...
Installs the [Active Directory](https://www.servicenow.com/docs/access?context=c_OrchActiveDirectoryActivities&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) activity pack. These activities create, delete, and manage objects in Windows Active Directory.
