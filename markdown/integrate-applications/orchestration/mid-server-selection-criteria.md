...
-   The **Default MID Server** field on the Orchestration application record. See [Configure a default MID Server for each application](https://www.servicenow.com/docs/access?context=t_SpecifyMIDServerApplications&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) for instructions.
