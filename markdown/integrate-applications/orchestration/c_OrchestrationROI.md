...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/orchestration/c\_OrchestrationROI.html
release: australia
...
Orchestration ROI reports offer a number of views of the comparative data and allow you to access the associated records directly from the reports. The [standard reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/orchestration/r_OrchestrationROIStandardDashboard.md) included with the Orchestration - ROI plugin provide summaries, estimated costs, and calculated costs for automated processes. The [ROI premium dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/orchestration/r_OrchestrationROIPremiumDashboard.md) uses Performance Analytics to provide detailed reports on calculated savings over time. Performance Analytics requires a different plugin and subscription.
...
-   **[Create Orchestration ROI labor rate cards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/orchestration/t_CreateOrchROILaborRateCard.md)**  
...
-   **[Create an Orchestration ROI automation entry record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/orchestration/t_CreateOrchROIAutoEntryRecord.md)**  
...
-   **[Create an Orchestration ROI correlated task rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/orchestration/t_CreateOrchROICorrTaskRule.md)**  
...
-   **[Configure the time range for Orchestration ROI calculations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/orchestration/t_ConfigTimeOrchROICalc.md)**  
Select a date range to calculate the average number of tasks and the duration per month for the correlated tasks.
-   **[Installed with Orchestration ROI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/orchestration/r_InstalledWithOrchestrationROI.md)**  
Several types of components are installed with the Orchestration - ROI plugin \(com.snc.runbook\_automation.roi\).
-   **[Orchestration ROI reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/orchestration/c_OrchestrationROIDashboards.md)**  
