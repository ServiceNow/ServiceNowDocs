...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/orchestration/probe\_activity-pack.html
release: brazil
...
These custom activities were built with the [Create a probe activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/orchestration/t_CreateAProbeActivity.md), which gives workflow administrators the ability to store input and output variables in the [databus](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/orchestration/c_OrchestrationDatabus.md).

To use the custom probe activities, you must [request activation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/orchestration/t_ActivateAnActivityPack.md) of the Orchestration - Probe plugin.
