...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/orchestration/t\_CreateAPowershellActivity.html
release: xanadu
...
<table id="choicetable_asj_mzp_vz"><tbody><tr><td id="d86083e116">
...
For descriptions of the Powershell command fields, see the table in [Configure the PowerShell execution command](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/orchestration/CreateInputVariables.md).
