...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/orchestration/t\_RetrieveSCCMDataClientSWDist.html
release: xanadu
...
-   [Configure a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/orchestration/t-config-SCCM-deployment-manager.md) with the Application Deployment Manager role on the SCCM server.
...
Users run the **Discover SCCM** workflow from an [SCCM Server Instance record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/orchestration/t_RetrieveSCCMDataClientSWDist.md) to populate the following ServiceNow tables:
...
</table>**Note:** For details about the custom activities used in this workflow to extract data from an SCCM server, see [Orchestration SCCM activity pack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/integrate-applications/orchestration/c_SCCMActivityPack.md).
