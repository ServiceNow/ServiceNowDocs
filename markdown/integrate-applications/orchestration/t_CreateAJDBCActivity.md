...
<table id="choicetable_py3_zmj_4y"><tbody><tr><td id="d596051e163">
...
JDBC credentials JDBC credentials are retrieved separately by the activity designer template and support external credential storage, such as [CyberArk](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/c_CyberArkCredStorageIntegrate.md).
