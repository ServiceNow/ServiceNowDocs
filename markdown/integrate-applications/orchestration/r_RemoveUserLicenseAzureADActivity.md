...
**Important:** The REST message used for this activity must be configured to use [OAuth 2.0](https://www.servicenow.com/docs/access?context=c_OAuthApplications&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
