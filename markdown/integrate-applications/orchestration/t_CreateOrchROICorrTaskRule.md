...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/orchestration/t\_CreateOrchROICorrTaskRule.html
release: brazil
...
Before starting this procedure, make sure you have created [labor rate cards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/orchestration/t_CreateOrchROILaborRateCard.md) and the appropriate [automation entry records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/orchestration/t_CreateOrchROIAutoEntryRecord.md) for the automated tasks you want to evaluate.
