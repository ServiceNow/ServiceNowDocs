...
An account may be locked automatically if a user enters an incorrect password more times than allowed by the Active Directory security policy. You can unlock an account using the [Unlock AD User Account](https://www.servicenow.com/docs/access?context=c_OrchActiveDirectoryActivities&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) activity.
