...
|sourceCredentialTag|Specific [Credential aliases for Orchestration activities](https://www.servicenow.com/docs/access?context=c_AssignCredsOrchActivities&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) this activity must use to run SSH commands on the source host.|
