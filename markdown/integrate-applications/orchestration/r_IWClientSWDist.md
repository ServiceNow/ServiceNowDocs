...
-   **Revoked**: Software was [revoked](https://www.servicenow.com/docs/access?context=c_SCCMSoftwareRevocation&version=xanadu&pubname=xanadu-servicenow-platform&section=t_RevokeSoftwareInstalledFromSCCM&ft:locale=en-US) by the administrator.
