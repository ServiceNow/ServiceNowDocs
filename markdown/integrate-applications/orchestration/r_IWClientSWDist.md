...
-   **Revoked**: Software was [revoked](https://www.servicenow.com/docs/access?context=c_SCCMSoftwareRevocation&version=zurich&pubname=zurich-servicenow-platform&section=t_RevokeSoftwareInstalledFromSCCM&ft:locale=en-US) by the administrator.
