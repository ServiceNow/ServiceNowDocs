...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/form-control-datetime.html
release: australia
...
The DateTime element in RPA Desktop Design Studio enables you to provide a date and time picker on the form so that your user can select a specific date and time on the form.

The methods and events of the DateTime element are displayed in the Object Explorer pane.
