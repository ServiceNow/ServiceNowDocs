...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the Snowflake collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/prepare-to-run-the-snowflake-collector.md).
