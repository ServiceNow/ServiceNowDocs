...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/start-bot-process.html
release: australia
topic_type: task
...
You can also run an unattended automation using the Unattended Robot. For more information, see [Run an automation using Unattended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/run-rpa-robot.md).
