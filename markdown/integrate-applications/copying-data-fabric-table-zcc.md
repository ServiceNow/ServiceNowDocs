...
For details on using update sets, see [General guidelines for planning the update process](https://www.servicenow.com/docs/access?context=get-started-update-sets&version=australia&pubname=australia-application-development&ft:locale=en-US).
