...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-credentials-getappcredential.html
release: brazil
topic_type: task
...
You can configure the properties for the GetApplicationCredential component. For more information about these properties, see [Properties of the Credentials components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/credentials-properties.md).
...
**Parent Topic:**[Credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/credentials.md)
