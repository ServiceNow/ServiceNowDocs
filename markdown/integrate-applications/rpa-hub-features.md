...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/rpa-hub-features.html
release: australia
topic_type: concept
...
For more information, see [Bot process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-botprocess.md).
...
For more information, see [Robots](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/robots-rpa-hub.md).
...
For more information, see [Package and package version](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/package-version-rpa-hub.md).
...
For more information, see [Credential management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/credential-management-rpa-hub.md).
...
For more information, see [Smart card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/smart-card-il.md).
...
For more information, see [Embedded Task Automation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/embedded-task-auto-rpa.md).
...
For more information, see [Robot pool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/robot-pool-rpa.md).
...
For more information, see [Robot calendar](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/robot-calendar-rpa.md).
...
For more information, see [Scheduled maintenance days](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/sm-days-rpa.md).
...
For more information, see [Graceful stop functionality](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/graceful-stop-rpa.md).
...
For more information, see [Queues implementation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/queues-implement-rpa.md).
...
For more information, see [Work items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/work-items-rpa-hub.md).
...
For more information, see [Shared parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/shared-paramaters-rpa-hub.md).
...
For more information, see [Process parameters within a bot process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-process-parameter-botprocess.md).
...
For more information, see [Code quality checks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/code-quality-check-rpa.md).
...
For more information, see [Alert rule and variable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/alert-rule-rpa-hub.md).

## Process jobs

A process job represents the execution of a bot process on a robot.

For more information, see [View process jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/view-process-jobs-botprocess.md).
...
For more information, see [View automation logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/view-automation-logs-rpa.md).
