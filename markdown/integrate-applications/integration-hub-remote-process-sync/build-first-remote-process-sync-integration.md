...
3.  While still on the User form, select **Set Password** to set a password.
    ...
    For details, see steps four and five in [Configuring password for a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/reset-your-password.md).

4.  [Reset the password](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_EnrollInPasswordReset.md) for RPS API User for Instance A.
...
8.  [Reset the password](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_EnrollInPasswordReset.md) for RPS Run as User A.
...
13. [Reset the password](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_EnrollInPasswordReset.md) for RPS API User for Instance B.
...
17. [Reset the password](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_EnrollInPasswordReset.md) for RPS Run as User B from Instance B.
