...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/integrate-applications/integration-hub-remote-process-sync/build-first-remote-process-sync-integration.html
release: xanadu
...
breadcrumb: [Getting started with Remote Process Sync, Integration Hub Remote Process Sync, Creating integrations with applications]
---
...
3.  While still on the User form, select **Set Password** to set a password.
    ...
    For details, see steps four and five in [Configuring password for a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/authentication/reset-your-password.md).

4.  [Reset the password](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/password-reset/c_EnrollInPasswordReset.md) for RPS API User for Instance A.
...
8.  [Reset the password](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/password-reset/c_EnrollInPasswordReset.md) for RPS Run as User A.
...
13. [Reset the password](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/password-reset/c_EnrollInPasswordReset.md) for RPS API User for Instance B.
...
17. [Reset the password](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/password-reset/c_EnrollInPasswordReset.md) for RPS Run as User B from Instance B.
