...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-utilities-http-downloadfile.html
release: brazil
topic_type: task
...
You can configure the properties for the DownloadFile component. For more information about these properties, see [Properties of the HTTP components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/properties-http-components.md).
...
**Parent Topic:**[HTTP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/http.md)
