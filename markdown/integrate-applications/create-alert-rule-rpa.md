...
Alert message.For example, `{0}% of process jobs failed in a day.`
 ...
 To configure the variables, such as \{0\}, see [Create an alert variable for an alert rule in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/create-alert-variable.md).
