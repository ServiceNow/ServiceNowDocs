...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/create-alert-variable.html
release: australia
topic_type: task
...
Create an alert rule. For more information, see [Create an alert rule to generate custom notifications in RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/create-alert-rule-rpa.md).
