...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/open-project-remote-rpa-studio.html
release: brazil
topic_type: task
...
2.  Select **Open cloud project**.
    ...
    If the selected ServiceNow instance session has expired, add the ServiceNow instance details. For more information, see [Set up RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/set-up-rpa-studio.md).
