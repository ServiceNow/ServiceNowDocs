...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/create-activity-now-assist.html
release: australia
...
To create an activity manually, see [Create and use an activity in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/configure-activity-rpa-studio.md).
...
<table id="choicetable_tkm_2nn_4dc"><thead><tr><th align="left" id="d128060e358">

Option

</th><th align="left" id="d128060e361">

Procedure

</th></tr></thead><tbody><tr><td id="d128060e367">
...
For more actions on the activity, see [Create and use an activity in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/configure-activity-rpa-studio.md).
