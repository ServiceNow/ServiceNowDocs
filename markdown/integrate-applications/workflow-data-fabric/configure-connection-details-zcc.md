...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/configure-connection-details-zcc.html
release: australia
...
If the connection fails, [View the connection log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/configure-connection-details-zcc.md). Review the connection details with the data source admin and try again.
...
<table id="choicetable_wv5_lmf_w2c"><tbody><tr><td id="d275287e780">
