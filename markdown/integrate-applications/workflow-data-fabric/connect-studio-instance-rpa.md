...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/connect-studio-instance-rpa.html
release: australia
...
Set up the RPA Desktop Design Studio application to add ServiceNow instance details. For more information, see [Set up RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/set-up-rpa-studio.md).

Open an automation project. For more information, see [Open a local automation project in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/open-project-rpa-studio.md) and [Open a cloud automation project in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/open-project-remote-rpa-studio.md).
...
<table id="choicetable_ag1_lyx_jrb"><thead><tr><th align="left" id="d168620e153">

Option

</th><th align="left" id="d168620e156">

Action

</th></tr></thead><tbody><tr><td id="d168620e162">
