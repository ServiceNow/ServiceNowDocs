...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/workflow-data-fabric/use-user-certificates-rpa.html
release: australia
...
If you don't have the active directory certificates, do the tasks in the following topics to generate and install user certificates. For more information, see [Exporting Microsoft Active Directory certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/export-certificates-rpa.md).

**Parent Topic:**[Obtaining client authentication and code signing certificates for RPA Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/code-signing-certificate-rpa.md)
...
If user certificates are generated by your organization, then you can skip this procedure. You can proceed with [installing the user certificate.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/use-user-certificates-rpa.md)
...
<table id="choicetable_xwg_ksg_q2c"><thead><tr><th align="left" id="d164596e362">

Certificate type

</th><th align="left" id="d164596e365">

Steps

</th></tr></thead><tbody><tr><td id="d164596e371">
...
Add the user to manage private keys. For more information, see [Add user to manage private keys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/use-user-certificates-rpa.md).
...
-   To set up the Unattended Robot. For more information, see [Set up Unattended Robot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/set-up-rpa-runtime.md).
-   To publish an automation project in RPA Desktop Design Studio. For more information, see [Publish an automation project in RPA Desktop Design Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/workflow-data-fabric/publish-automation-project.md).
