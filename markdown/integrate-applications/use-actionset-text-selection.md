...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-actionset-text-selection.html
release: brazil
topic_type: task
...
You can configure the properties for the Text Selection component. For more information about these properties, see [ActionSet Text Selection- Properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/actionset-actions-properties.md).
