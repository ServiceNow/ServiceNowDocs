...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/integrate-applications/use-imageutil-threshold.html
release: brazil
topic_type: task
...
You can configure the properties for the Threshold component. For more information about these properties, see [Properties of the Image Utilities components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/util-imageutil-prop.md).
