...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/create-postgresql-metadata-collector.html
release: australia
topic_type: task
...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the PostgreSQL collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/prepare-to-run-postgresql-collector.md).
...
**Parent Topic:**[PostgreSQL metadata collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/postgresql-metadata-collector.md)
