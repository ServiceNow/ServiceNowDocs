...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-debug-isrunnngfromstudio.html
release: australia
topic_type: task
...
You can configure the properties for the IsRunningFromStudio component. For more information about these properties, see [Properties of the Debug components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/util-debug-prop.md).
