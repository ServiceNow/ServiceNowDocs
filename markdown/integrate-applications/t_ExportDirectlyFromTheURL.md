...
breadcrumb: [Exports, Data and Automation]
---
...
-   For details on using query parameters, see [Query parameters for display value and header](https://www.servicenow.com/docs/access?context=query-parameters-display-value&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
-   For details on using system properties, see [System properties for display value and header](https://www.servicenow.com/docs/access?context=system-properties-display-value-header&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
...
4.  Query for specific records by adding the **sysparm\_query** parameter.
    ...
    **Note:** All queries use a column name, an operator, and a value. See [Condition Builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US) for a list of available operators.
