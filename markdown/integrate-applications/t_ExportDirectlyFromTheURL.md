...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/integrate-applications/t\_ExportDirectlyFromTheURL.html
release: zurich
topic_type: task
...
You must be familiar with the ServiceNow table and column names to export data directly from the URL. See [Navigate to a record or a module using a URL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/navigate-using-url.md).
...
4.  Query for specific records by adding the **sysparm\_query** parameter.
    ...
    **Note:** All queries use a column name, an operator, and a value. See [Condition Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-user-experiences/c_ConditionBuilder.md) for a list of available operators.
