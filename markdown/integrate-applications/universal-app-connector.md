...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/universal-app-connector.html
release: australia
topic_type: concept
...
For more information on using a UAC, see [Use the Universal App Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/configure-uac.md).
...
For more information about capturing an element in the Windows application, see [Use the Universal App Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/configure-uac.md).
...
For more information about the methods for UI Automation mode and Active Accessibility mode, see [Methods of UI Automation mode and Active Accessibility mode](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/uac-windows-uia-aa-methods.md).

-   **[Use the Universal App Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/configure-uac.md)**  
...
-   **[Use the Click method for Universal App Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-click-method-uac.md)**  
Use the Click method to perform a click action on an element.
-   **[Use the GetValue method for Universal App Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-getvalue-method-uac.md)**  
Use the GetValue method to retrieve a value from an element.
-   **[Use the SetValue method for Universal App Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-setvalue-uac.md)**  
Use the SetValue method to assign a specified value into an element.
-   **[Use the Start method for Universal App Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-start-method.md)**  
...
-   **[Use the WaitForAnyScreen method for Universal App Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/use-the-wait-for-any-screen-method.md)**  
...
-   **[Find the elements on the application screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/find-elements-screen-uac.md)**  
...
-   **[Additional options for application screens and elements in Universal App Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/contextmenu-application-screens.md)**  
...
-   **[Methods of UI Automation mode and Active Accessibility mode](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/uac-windows-uia-aa-methods.md)**  
