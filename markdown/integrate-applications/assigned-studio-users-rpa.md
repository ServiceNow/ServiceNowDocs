...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/assigned-studio-users-rpa.html
release: australia
topic_type: task
...
Familiarise yourself with the Assigned Bot Process feature in RPA Desktop Design Studio. For more information, see [Assign bot process to an automation project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/assign-bot-process.md).
