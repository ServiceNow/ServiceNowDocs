...
keywords: [MySQL, SSL, connection security configurations, zero copy connector]
breadcrumb: [Reference, Zero Copy Connectors, Workflow Data Fabric]
---

# MySQL connection security configuration fields
...
|Server Certificate Source: Custom CA|Truststore|File containing the certificate\(s\) used to verify the MySQL server's identity. Required for all Store type values.|
...
|Store type: PEM|Client Certificate|File containing the client certificate presented to the MySQL server. Required.|
