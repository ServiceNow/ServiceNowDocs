...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/integrate-applications/use-utilities-http-post.html
release: australia
topic_type: task
...
You can configure the properties for the Post component. For more information about these properties, see [Properties of the HTTP components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/integrate-applications/properties-http-components.md).
