...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-nav-functions.html
release: zurich
topic_type: concept
...
-   **Global Context**
    ...
    -   [Configure a navigation to a screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-config-navigation-function.md)
    -   [Configure navigation to a launcher screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-launcher-nav-example.md)
-   **Record Context**
