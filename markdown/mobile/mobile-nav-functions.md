...
-   **Global Context**
    ...
    -   [Configure a navigation to a screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/sg-config-navigation-function.md)
    -   [Configure navigation to a launcher screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/sg-launcher-nav-example.md)
-   **Record Context**
