...
The available score report in mobile is [single score](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/c_SingleScoreCharts.md).

The available bar report in mobile is [vertical bar](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/c_CreateBarCharts.md).

The available donut report in mobile is [donut](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/c_CreateDonutCharts.md).

The available pie report in mobile is [Pie charts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/c_CreatePieCharts.md).
