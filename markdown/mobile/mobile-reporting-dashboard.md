...
The available score report in mobile is [single score](https://www.servicenow.com/docs/access?context=c_SingleScoreCharts&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).

The available bar report in mobile is [vertical bar](https://www.servicenow.com/docs/access?context=c_CreateBarCharts&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).

The available donut report in mobile is [donut](https://www.servicenow.com/docs/access?context=c_CreateDonutCharts&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).

The available pie report in mobile is [Pie charts](https://www.servicenow.com/docs/access?context=c_CreatePieCharts&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).

The available time series trend-by charts in mobile are:

-   [Line](https://www.servicenow.com/docs/access?context=c_CreateLineCharts&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)
-   [Spline](https://www.servicenow.com/docs/access?context=c_CreateAreaAndSplineCharts&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)
-   [Step line](https://www.servicenow.com/docs/access?context=step-reports&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)
