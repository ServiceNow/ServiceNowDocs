...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/color-var-input-description.html
release: yokohama
...
Use color variables in the **Description** field of your inputs to control text color.
 ...
 For details on inputs, see [Configure an input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/parameter-screen-config.md).
