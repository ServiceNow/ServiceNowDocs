...
3.  Check the following items on your app if they've changed from your original request:
    ...
    -   App has the correct name, icon, splash screen, branding, and theming. For more information, see [Create a theme with Theme Builder](https://www.servicenow.com/docs/access?context=tb-create-theme&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
