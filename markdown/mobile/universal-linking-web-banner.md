...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/universal-linking-web-banner.html
release: australia
topic_type: task
...
**Note:** The selection here overrides the selection made in the **Mobile app** field listed in the topic [Mapping specific mobile screens for universal linking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/universal-linking-screen-mapping.md).
