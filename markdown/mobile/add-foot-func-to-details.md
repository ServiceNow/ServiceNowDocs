...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/add-foot-func-to-details.html
release: xanadu
topic_type: task
...
Color emphasis used for the footer function. The appearance of the color depends on your mobile theme. For details on mobile themes, see [Mobile theme color guidelines](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-theme-colors.md).
