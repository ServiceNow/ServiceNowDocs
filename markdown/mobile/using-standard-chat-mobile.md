...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/using-standard-chat-mobile.html
release: zurich
topic_type: concept
...
For more information, see [ServiceNow AI Lens for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/servicenow-lens-mobile.md).
...
For more detailed information on all of standard chat’s specific skills, see [Standard chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/nava-standard-chat.md).
