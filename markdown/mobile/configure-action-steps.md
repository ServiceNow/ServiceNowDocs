...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/configure-action-steps.html
release: xanadu
topic_type: task
...
The script executed by the action. This field only appears if you select **Script** in the **Type** field.
 ...
 To view an example of an execution script, see [Configure an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-studio-create-action-item.md).
