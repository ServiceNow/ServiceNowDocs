...
4.  Add additional fields to the notification content, such as a text slot.
    ...
    2.  Use the notification layout script and include the global application scope to generate layout fields.
        ...
        To learn more about script includes, see [Script Includes](https://www.servicenow.com/docs/access?context=c_ScriptIncludes&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
