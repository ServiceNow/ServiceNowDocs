...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/parameter-screen-sections-create.html
release: yokohama
topic_type: task
