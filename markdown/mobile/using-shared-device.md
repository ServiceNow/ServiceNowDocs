...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/using-shared-device.html
release: australia
...
-   For the admin configuration topics of this feature, see [Enable multiple users to work on a shared device](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/multi-user-single-instance.md).
