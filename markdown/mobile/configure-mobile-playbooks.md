...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/configure-mobile-playbooks.html
release: xanadu
topic_type: task
...
1.  Create the Now Experience Framework page in UI Builder.
    ...
    For instructions about how to create the page, see [Create a Now Experience Framework page in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mob-playbk-create-playbk-pg.md).

2.  Create the mobile web screen in MAB.

    For information about configuring a mobile web screen, see [Configure a mobile web screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-configure-url-screen.md).
...
-   **[Create a Now Experience Framework page in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mob-playbk-create-playbk-pg.md)**  
...
**Parent Topic:**[Mobile App Bridge](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-playbooks.md)
