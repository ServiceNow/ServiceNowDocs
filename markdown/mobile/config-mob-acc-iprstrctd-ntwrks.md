...
To configure mobile access for IP-restricted networks, adaptive authentication must be activated on your ServiceNow instance. For more information, see [Activate adaptive authentication](https://www.servicenow.com/docs/access?context=adaptive-authentication-plugin&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).

Role required: admin

## About this task

For more information about adaptive authentication, see [Adaptive authentication](https://www.servicenow.com/docs/access?context=adaptive-authentication&version=zurich&pubname=zurich-platform-security&ft:locale=en-US), which describes this policy framework that is used to enforce authentication controls.
