...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/multi-user-optional.html
release: australia
topic_type: task
...
-   Set the maximum idle time before users are prompted to re-enter their PIN. The default is 300 seconds. This feature is described in the topic [PIN timeout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/pin-timeout.md).
