...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/configure-signature-inputs.html
release: xanadu
topic_type: task
...
Signature inputs support both declarative and scripted writeback actions in action items. For information about action items, see [Configure an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-studio-create-action-item.md).
...
Signature inputs are available [offline](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-offline-mode.md). [Mobile UI rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-ui-rules.md) apply to signature inputs.
