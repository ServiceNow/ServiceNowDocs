...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/form-screen-alerts.html
release: xanadu
topic_type: task
...
When configuring an alert for a record screen, you must have a record screen to display the alert. See, [Record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/form-screen.md).
...
1.  Configure a navigation function button for use within a mobile alert.
    ...
    4.  Select the **Condition** tab and define the conditions that apply for the display and the hiding of the mobile alert. For more information, see [Configure a navigation to a screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-config-navigation-function.md).
