...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/form-screen-alerts.html
release: australia
topic_type: task
...
When configuring an alert for a record screen, you must have a record screen to display the alert. See, [Record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/form-screen.md).
