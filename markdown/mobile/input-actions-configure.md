...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/input-actions-configure.html
release: australia
topic_type: task
...
**Note:** An *ElementIdentifier* attribute is also required. For more information, see [Data sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/data-sources.md).
...
**Note:** A *DataSourceID* attribute is also required. For more information, see [Data sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/data-sources.md).
...
<table id="choicetable_p4n_gxy_42c"><thead><tr><th align="left" id="d70906e487">

Input action type

</th><th align="left" id="d70906e490">

Procedure

</th></tr></thead><tbody><tr><td id="d70906e496">
...
6.  Select a preconfigured navigation type in the **Value** field. For more information on creating navigation buttons, see [Navigation functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/mobile-nav-functions.md).
