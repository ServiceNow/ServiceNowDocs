...
-   **[Create a navigation function](../task/sg-launcher-nav-example-1.md)**  
Create a navigation function that directs to a screen or launcher screen.
-   **[Use your navigation function as a quick action](../task/sg-launcher-navigation-example-2.md)**  
Use your navigation function as a quick action if users need to frequently access the launcher.
-   **[Use your navigation function as a top menu selection](../task/sg-launcher-navigation-example-3.md)**  
...
-   **[Use your navigation function as a footer function](../task/sg-launcher-navigation-example-4.md)**  
