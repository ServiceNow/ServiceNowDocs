...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/decorative-slider.html
release: australia
topic_type: task
...
You can add translated text to each of the text values displays on your slider. For more information, see [Configure translated values for decorative slider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/decorative-slider-translation.md).
