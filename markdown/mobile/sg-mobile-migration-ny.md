...
-   **Use the Debug Upgrade feature**
    ...
    The debug upgrade feature can help you to quickly diagnose upgrade issues. For information on this feature, see [Debug Upgrade](https://www.servicenow.com/docs/access?context=debug-upgrade&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
-   **Review skipped records**
    ...
    To prevent overriding your customizations, the upgrade process does not update records that you have modified. Instead, the upgrade process notes this skipped record in the upgrade logs. For more detail on handling skipped records, see [Process the skipped records list](https://www.servicenow.com/docs/access?context=upgrademon-process-skip-list&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
