...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/sg-fedramp.html
release: yokohama
topic_type: concept
...
-   **Disabling offline mode**
    ...
    For more information on offline mode, see [Offline mode](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-offline-mode.md).
