...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/sg-assign-param-data-item-record-screen.html
release: xanadu
topic_type: task
...
Make sure that you have configured a data item that has parameters. For more information, see [Configure a parametrized data item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-config-parametrized-data-item.md).
...
13. Complete any additional screen fields as needed. For more information, see [Create a screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-studio-configure-applet-screens.md).
