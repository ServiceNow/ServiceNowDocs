...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/color-var-ui-rule.html
release: yokohama
...
-   `FontColorVariable` outside or within the `TextDecorator`
 ...
 For details on creating these UI rule actions, see [Create a mobile UI rule action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/create-mobile-ui-rule-action.md).
