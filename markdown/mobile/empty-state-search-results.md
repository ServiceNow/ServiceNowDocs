...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/empty-state-search-results.html
release: yokohama
topic_type: task
...
For more information, see [Configure an empty state](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/empty-state-default.md).
