...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/empty-state-search-results.html
release: xanadu
topic_type: task
...
For more information, see [Configure an empty state](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/empty-state-default.md).
