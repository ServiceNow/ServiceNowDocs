...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/sg-ui-section-config-item-function.html
release: xanadu
topic_type: task
...
To configure record section functions within a sections screen, at least one pre-configured record section must be created. For more information, see [Configure a record UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-ui-section-config-item.md).
