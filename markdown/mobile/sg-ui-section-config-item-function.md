...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/sg-ui-section-config-item-function.html
release: australia
topic_type: task
...
To configure record section functions within a sections screen, at least one pre-configured record section must be created. For more information, see [Configure a record UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/sg-ui-section-config-item.md).
