...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/sg-ui-section-config-item-function.html
release: yokohama
topic_type: task
...
To configure record section functions within a sections screen, at least one pre-configured record section must be created. For more information, see [Configure a record UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/sg-ui-section-config-item.md).
