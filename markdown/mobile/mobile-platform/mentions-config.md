...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/mentions-config.html
release: yokohama
...
3.  Create the push notification and define when to send it, who receives it, and what it contains.
    ...
    9.  Select the push notification message you created. The push notification is listed as one of the available messages in the **What to send** tab.
