...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/nav-chart-to-list-3.html
release: yokohama
...
3.  Select the **Screens** category, and then select the screen where you want to add the navigation function.

4.  In the **Chart header function instances** section of the screen record, select the navigation function you wish to add.

5.  Select **Save**.


**Parent Topic:**[Configure a navigation from a chart to a list screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/nav-chart-to-list.md)
