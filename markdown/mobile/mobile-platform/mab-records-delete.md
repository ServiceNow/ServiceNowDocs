...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/mab-records-delete.html
release: yokohama
...
3.  Find the record that you want to delete in any of the following ways:
