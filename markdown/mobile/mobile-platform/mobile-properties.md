...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/mobile-properties.html
release: xanadu
...
-   **[Turn on or turn off automatic app refresh](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/enable-disable-auto-app-refresh.md)**  
...
-   **[Enable external users to access attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/enable-ext-users-attach-access.md)**  
...
-   **[Switch the date/time fields between device time zone and UTC](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/switch-date-time-timezone-utc.md)**  
...
-   **[Configure mobile apps to use the date/time format of mobile devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/config-apps2use-devicedatetimeform.md)**  
...
-   **[Hide seconds in date/time fields on mobile cards, record screen details pages, or activity streams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/hide-secs-mobcds-recscreen-actstrem.md)**  
...
-   **[Extend embedded web sessions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/extend-embedded-web-sessions.md)**  
Extend embedded web sessions to keep mobile users logged in until the mobile OAuth token expires.
-   **[Enable enhanced barcode scanning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/enable-enhanced-barcode-scan.md)**  
...
-   **[Configure different mobile attachment capabilities on Android devices based on user roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/mob-attachments-android.md)**  
...
-   **[Keep native apps active during authentication on Android devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/active-authentication-android.md)**  
...
**Parent Topic:**[Considerations before implementation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/imp-considerations.md)
