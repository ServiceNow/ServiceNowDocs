...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/input-form-screen-input-actions.html
release: yokohama
...
For input actions script examples, refer to the following [Script code for storing user-selected attachments in the database](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/input-actions-script-attachments.md) and [Script code for comment type and updates for input actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/input-actions-script-comments.md).

\[Omitted image "icon-ifs-input-action-more.png"\] Alt text: Image showing a pop-up that displays after a user taps the more menu button.
