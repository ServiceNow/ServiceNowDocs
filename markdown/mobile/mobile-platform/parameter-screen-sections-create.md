...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/parameter-screen-sections-create.html
release: yokohama
