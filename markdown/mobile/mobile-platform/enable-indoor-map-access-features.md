...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/enable-indoor-map-access-features.html
release: yokohama
...
Maps can use patterns or colors to identify locations. The accessibility toggle in the mobile device settings page controls how the map identifies locations.
...
When reserving space, the map accessibility toggle gives you the option to identify map locations with colors or with black and white patterns. Using black and white patterns assists users with accessibility requirements.
