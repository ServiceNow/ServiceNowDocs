...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/location-tracking-add-user.html
release: yokohama
...
1.  Navigate to **All** &gt; **Users**.
    ...
    A list of all your users on your current instance displays.

2.  Select the user who requires location tracking.

3.  In the User form, select the **Geolocation** tracked field.
...
**Parent Topic:**[Location tracking for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/mobile-location-tracking.md)
