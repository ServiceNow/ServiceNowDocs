---
title: Mobile pop-ups
description: Display configurable mobile pop-ups based on real-time conditions. Mobile pop-ups are a way to transmit information to users and to encourage them to perform actions. You can display a mobile pop-up at the login page or when a user taps a button.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/mobile\_popups.html
release: yokohama
...
|-------------------------------------------------------------------|---------------------------------------------------------------------|
|\[Omitted image "mobile-popup-login.png"\] Alt text: Mobile pop-up triggered at the log in page with blurred background.|\[Omitted image "mobile-popup-button.png"\] Alt text: Mobile pop-up triggered on button tap with clear background.|
...
-   **[Create a mobile pop-up](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/mobile-popups-create.md)**  
