---
title: Mobile icon reference
description: Use Mobile App Builder to insert these icons in your mobile apps.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/mobile-icon-reference.html
release: yokohama
...
-   **Screen font icons**
    ...
    Screen font icons are used for lists or section destinations. They can be used to represent a work flow or a screen that you want users to navigate to. These icons are in the **now-mobile-icons** font family.

-   **Mobile card font icons**

    Mobile card font icons are used in the body of mobile cards. These icons are in the **now-mobile-icons-cards** font family.
...
-   **Image icons**
    ...
    Image icons are used on navigation bars and tab bars. These icons are not font-type icons.
...
-   **[Actions font icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/actions-font-icons.md)**  
...
-   **[Screen font icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/screen-font-icons.md)**  
...
-   **[Mobile card font icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/mobile-card-font-icons.md)**  
...
-   **[Launcher screen font icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/launcher-screen-font-icons.md)**  
...
-   **[Image icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/image-icons.md)**  
