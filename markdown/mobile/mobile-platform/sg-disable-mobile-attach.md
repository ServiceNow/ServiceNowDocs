...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/sg-disable-mobile-attach.html
release: yokohama
...
-   You need to elevate to the **security\_admin** role to perform these steps. For details on this role, see [security\_admin role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/servicenow-ai-platform-security/security-admin-role.md).
