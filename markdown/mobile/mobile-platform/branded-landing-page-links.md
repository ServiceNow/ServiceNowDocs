...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/branded-landing-page-links.html
release: xanadu
...
-   Accept: Informs the user that they're loading content from outside the mobile app and it may contain security risks.
