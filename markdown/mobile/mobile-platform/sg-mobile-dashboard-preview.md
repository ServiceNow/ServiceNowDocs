...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/sg-mobile-dashboard-preview.html
release: xanadu
...
After creating a mobile analytics dashboard preview, you need to create a data visualization chart screen. For more information, see [Create a chart screen for a data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/config-single-score-applet.md).
