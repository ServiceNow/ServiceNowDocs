...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/c\_MobileWebUI.html
release: yokohama
...
breadcrumb: [Accessing an instance on a mobile device web browser, Using the mobile apps, Mobile Platform]
---
...
The mobile web UI is similar to the ServiceNow Classic mobile app. Some features are optimized more for the ServiceNow Classic app and may not perform as well on a mobile browser.
...
**Parent Topic:**[Accessing an instance on a mobile device web browser](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/mobile-access-options.md)
