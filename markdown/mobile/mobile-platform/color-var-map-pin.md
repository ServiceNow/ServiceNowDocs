...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/color-var-map-pin.html
release: xanadu
...
Map screens have a **Pin Color** section with a **Pin color variable** field to control the color map pins using a color variable. A map pin is used on the map template screen, to indicate points of interest on the map.
 ...
 For details on creating icon UI sections, see [Configure an icon UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/sg-ui-section-config-navig.md).
