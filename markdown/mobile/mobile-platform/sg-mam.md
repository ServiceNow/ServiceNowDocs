...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/sg-mam.html
release: xanadu
...
Microsoft requires iOS Intune apps to be registered with Microsoft Entra ID \(formerly Microsoft Azure AD\) in the second half of the calendar year 2024. Apps that are not registered will fail the Microsoft Intune login flow.
