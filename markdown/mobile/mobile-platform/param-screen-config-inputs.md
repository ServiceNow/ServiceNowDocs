...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/param-screen-config-inputs.html
release: xanadu
...
The autofill variable used for this input. For details on variables, [Configure input form screen variables and attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/param-screen-config-variables.md).
