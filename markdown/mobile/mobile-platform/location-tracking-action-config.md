...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/location-tracking-action-config.html
release: xanadu
...
You must have a preconfigured action item before you can configure the action-based tracking option. For more information, see [Configure an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/sg-studio-create-action-item.md).

You need preconfigured action functions for users to tap within their mobile device. For more information, see [Configure an action function](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/sg-studio-config-action-function.md).
...
<table id="choicetable_tqp_sb1_fwb"><thead><tr><th align="left" id="d43421e148">

Location tracking action

</th><th align="left" id="d43421e151">

Description

</th></tr></thead><tbody><tr><td id="d43421e157">
