...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/mcb-elements.html
release: xanadu
...
breadcrumb: [Mobile Card Builder user interface, Mobile Card Builder, Mobile app building tools, Building mobile apps, Mobile Platform]
---
...
The field containing the text to be used. The text component will display either the label of the field or the value of the field, depending on what you select in the **Field type** property.**Note:** When creating a card template, you will not be able to select a field. This selection is done when your card is associated with a specific screen.
...
The font size for your text. Enter a numerical value.
...
</table>**Parent Topic:**[Mobile Card Builder user interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/mcb-stage-ui.md)
