...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/sg-mobile-virtual-agent.html
release: yokohama
...
To include virtual agent functionality in your mobile applications, you first must activate and configure Virtual Agent. For details on this process see Planning and configuring Virtual Agent.
...
**Parent Topic:**[Configure a contextual link to Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/sg-av-context-action.md)
