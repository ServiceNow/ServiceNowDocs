...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/config-ne-theming.html
release: yokohama
...
breadcrumb: [Next Experience theming for mobile, Configuring the Mobile Platform, Mobile Platform]
---
...
Themes are defined by records in the UX Themes \[sys\_ux\_theme\] table. Your instance includes two base system themes for use in the mobile UI.
...
Under the Polaris theme is a UX Style \[sys\_ux\_style\] record named **Mobile Colors Default**. This record defines the color variable names and the colors associated with them.
...
Learn more about Next Experience theme configuration at [Configuring Next Experience themes and preferences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/configure-user-experiences/config-next-experience-themes-prefs.md).
...
<table id="table_txx_53d_dwb"><tbody><tr><td>
...
Your instance checks the state of whether Next Experience is enabled and determines which UX Theme \[sys\_ux\_theme\] record to use for the mobile app.
...
\[Omitted image "set-mobile-theme-1.png"\] Alt text:

</td></tr></tbody>
</table>## Use color variables on your custom mobile components
