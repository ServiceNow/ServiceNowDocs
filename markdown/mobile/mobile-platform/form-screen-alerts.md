...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/form-screen-alerts.html
release: yokohama
...
When configuring an alert for a record screen, you must have a record screen to display the alert. See, [Record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/form-screen.md).
