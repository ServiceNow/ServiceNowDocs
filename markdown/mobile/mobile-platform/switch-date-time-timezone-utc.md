...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/switch-date-time-timezone-utc.html
release: xanadu
...
Both [Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/mobile-card-builder.md) and the following mobile screens support the **ShowDateTimeInUTC** property:

-   [Input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/parameter-input-screen.md)
-   [Record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/form-screen.md)
