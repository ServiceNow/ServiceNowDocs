...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/config-push-setup-android-httpv1.html
release: xanadu
...
**Note:** These steps are only necessary if you're using a custom branded mobile app. For more detail on custom branding, see [Request, test, and publish a branded mobile app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/request-test-pub-branded-mob-app.md).
...
**Parent Topic:**[Mobile push notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/sg-mobile-push-notifications.md)
