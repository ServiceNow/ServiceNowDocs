...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/nav-chart-to-list-2.html
release: yokohama
...
Assign your navigation function to your chart screen. For more information, see [Assign the navigation function to the chart screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/nav-chart-to-list-3.md).
