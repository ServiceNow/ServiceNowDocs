...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/now-assist-context-menu-mobile.html
release: yokohama
...
|-----------|-----------|
|Shorten|Shorten the word count of the selected text to make it more concise.|
...
Write with Now Assist is supported on mobile input form screens for Now Assist skills such as task summarization. For more, see [Now Assist on Input Form Screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/ai-case-summarization.md).
