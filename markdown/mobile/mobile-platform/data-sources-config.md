...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/data-sources-config.html
release: yokohama
...
7.  Edit the script in the **Data source script** field as required.
    ...
    For examples of data source script, see [Data source script examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/data-source-script-examples.md).
