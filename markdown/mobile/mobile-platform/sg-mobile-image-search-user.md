...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/sg-mobile-image-search-user.html
release: yokohama
...
**Note:** For details on how an administrator can configure photo search, see [Mobile photo search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/sg-mobile-image-search.md).
