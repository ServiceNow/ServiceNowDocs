...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/mobile-reporting-pa-widgets.html
release: yokohama
...
\[Omitted image "dashboard-pa-example.png"\] Alt text: KPI Details example.
...
-   **Available KPI Details features**

    Mobile dashboards support the following KPI Details features from the web-based UI:
