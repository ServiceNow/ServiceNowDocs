...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/mobile-analytics.html
release: yokohama
...
\[Omitted image "dashboard-overview-page.png"\] Alt text: User Experience Analytics for Mobile overview page
