...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/mobile-platform/config-sg-application-menu.html
release: australia
...
<table id="choicetable_opn_3z2_ccc"><thead><tr><th align="left" id="d73941e156">

Method to add navigation tabs

</th><th align="left" id="d73941e159">

Procedure

</th></tr></thead><tbody><tr><td id="d73941e165">
...
3.  In the new tab screen for the option you selected, do the following.
    ...
    3.  In the Icon field, select whether to choose an existing icon or to create an icon for your navigation tab. Either do one of the following.
        ...
        2.  Select **New** to display the New icon form and then do the following:
            ...
            4.  In the Set appearance section, in the **Value** field, enter the name of an image icon. For a list of image icon names, see [Image icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/mobile/mobile-platform/image-icons.md).
4.  Select **Save**.


</td></tr><tr><td id="d73941e301">
