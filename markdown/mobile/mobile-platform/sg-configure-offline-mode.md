...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-platform/sg-configure-offline-mode.html
release: yokohama
...
4.  Complete the System Property form using the property names listed in this table.
    ...
    **Note:** For more detail on creating system properties, see Add a system property
...
For a view of the offline mode end-user experience, see: [Working offline in mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-platform/offline-end-user.md).
