...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-platform/sg-ui-section-config-reports.html
release: xanadu
...
For an analytics UI section to display data visualizations you need both a mobile analytics preview and a chart screen with navigation functions. For more information, see [Create a mobile analytics preview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/sg-mobile-dashboard-preview.md) and [Chart screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-platform/chart-screen.md). A maximum of six analytics previews can be displayed in an analytics UI section.
