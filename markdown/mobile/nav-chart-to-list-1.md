...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/nav-chart-to-list-1.html
release: xanadu
topic_type: task
...
Configure the List item config for your list screen to choose the cards and fields that will appear on this list. For more information, see [List screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/list-screen.md).

If you're adding an analytics preview to the launcher screen UI section. See, [Configure an analytics UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-ui-section-config-reports.md).
