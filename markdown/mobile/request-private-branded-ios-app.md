...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/request-private-branded-ios-app.html
release: yokohama
topic_type: task
...
After the build successfully completes and your app is ready for testing, see [Test and publish a new branded iOS app for private distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/testpubnu-iosapp-privdist.md).
