...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/request-private-branded-ios-app.html
release: xanadu
topic_type: task
...
After the build successfully completes and your app is ready for testing, see [Test and publish a new branded iOS app for private distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/testpubnu-iosapp-privdist.md).
