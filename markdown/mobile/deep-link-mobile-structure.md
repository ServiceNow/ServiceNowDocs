...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/deep-link-mobile-structure.html
release: yokohama
topic_type: reference
last_updated: "2025-01-30"
reading_time_minutes: 3
breadcrumb: [Deep linking for mobile, Mobile URLs, Configuring the Mobile Platform, Mobile Platform]
---
...
getUniversalLink generates a link into either a list, form, or browser. A screen is generated based on the content of this URL. See [Universal linking for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/universal-links-mobile.md).
...
**Parent Topic:**[Deep linking for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/deep-link-mobile.md)
