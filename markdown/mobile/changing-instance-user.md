...
-   Tapping on the accounts icon \(\[Omitted image "instance-icon.png"\] Alt text: Accounts icon.\) in the header area of your mobile device.
...
\[Omitted image "instance-multi.png"\] Alt text: accounts screen with four accounts listed.
