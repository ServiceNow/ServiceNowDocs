...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/configure-lens-launcher-button.html
release: yokohama
topic_type: task
...
3.  Select the input form screen on which you want to configure the launcher button, or select **New** to create an input form screen.
    ...
    See [Configure an input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/parameter-screen-config.md) for instructions on how to create an input form screen.
...
<table><thead><tr><th align="left" id="d103886e144">

Option

</th><th align="left" id="d103886e147">

Steps

</th></tr></thead><tbody><tr><td id="d103886e153">
...
-   **[Add optional prompts to the ServiceNow AI Lens Launcher](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/add-optional-prompts.md)**  
Add optional prompts to the ServiceNow AI Lens launcher button.
-   **[Enable attachment IDs for write-back actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/making-attachment-ids-available-for-write-back-actions.md)**  
