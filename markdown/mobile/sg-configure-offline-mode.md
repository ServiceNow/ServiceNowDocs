...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-configure-offline-mode.html
release: zurich
topic_type: task
...
4.  Complete the System Property form using the property names listed in this table.
    ...
    **Note:** For more detail on creating system properties, see [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_AddAPropertyUsingSysPropsList.md)
...
For a view of the offline mode end-user experience, see: [Working offline in mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/offline-end-user.md).
