...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/sg-configure-offline-mode.html
release: xanadu
topic_type: task
...
For a view of the offline mode end-user experience, see: [Working offline in mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/offline-end-user.md).
