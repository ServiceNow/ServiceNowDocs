...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/sg-configure-offline-mode.html
release: yokohama
topic_type: task
...
For a view of the offline mode end-user experience, see: [Working offline in mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/offline-end-user.md).
