...
description: This document applies to current ServiceNow apps for iOS and Android for Zurich. This document may be subject to change for future mobile releases.
locale: en-US
release: zurich
topic_type: concept
...
This document applies to current ServiceNow apps for iOS and Android for Zurich. This document may be subject to change for future mobile releases.
