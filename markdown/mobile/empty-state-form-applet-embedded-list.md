...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/empty-state-form-applet-embedded-list.html
release: yokohama
topic_type: task
...
You should already have an empty state configured for record screens that do not contain any data. For more information, see [Configure an empty state](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/empty-state-default.md).
