...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/actionable-push-notification-3.html
release: australia
topic_type: task
...
3.  Create a new function for one of your push actions.
    ...
    -   URL
    -   Chat launcher
    For information on function types, and detailed steps for creating functions, see [Mobile functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/sg-studio-mobile-button-types.md).
