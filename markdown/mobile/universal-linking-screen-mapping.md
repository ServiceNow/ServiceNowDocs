...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/universal-linking-screen-mapping.html
release: xanadu
topic_type: task
...
When creating universal links, you define the screen type and the data the user sees after they tap the mobile banner. See, [Create path segment records and supported URL records for universal linking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/universal-linking-web-banner.md). Also there is an option to create a screen mapping for universal links. Users click these links to see a preconfigured screen based on a defined table.
