...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/location-tracking-enable.html
release: zurich
topic_type: task
last_updated: "2025-07-31"
reading_time_minutes: 2
breadcrumb: [Location tracking, Considerations before implementation, Configuration detail, Configuring the Mobile Platform, Mobile Platform]
---
...
-   **[Configuring manual location tracking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/location-tracking-manual-config.md)**  
...
-   **[Configuring action-based location tracking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/location-tracking-action-config.md)**  
...
**Parent Topic:**[Location tracking for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-location-tracking.md)
