...
When working with user roles in the Mobile App Builder, you assign existing user roles permissions and map them to a mobile component. To create additional user roles, you must access the Roles \[sys\_user\_role\] table. For more information, see Managing roles.
