...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/location-tracking-action-config.html
release: yokohama
topic_type: task
...
You must have a preconfigured action item before you can configure the action-based tracking option. For more information, see [Configure an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/sg-studio-create-action-item.md).

You need preconfigured action functions for users to tap within their mobile device. For more information, see [Configure an action function](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/sg-studio-config-action-function.md).
...
<table id="choicetable_tqp_sb1_fwb"><thead><tr><th align="left" id="d120146e148">

Location tracking action

</th><th align="left" id="d120146e151">

Description

</th></tr></thead><tbody><tr><td id="d120146e157">
...
**Parent Topic:**[Enabling and selecting location tracking options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/location-tracking-enable.md)
