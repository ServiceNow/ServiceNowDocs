...
For the full range of Now Mobile app documentation, see [Now Mobile app](https://www.servicenow.com/docs/access?context=mobile-employee-experience&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US) in the Employee Service Management business unit.
...
-   **Access the demo**
    ...
    Try the Now Mobile app demo. The demo is a curated experience designed to show how your employees can work from anywhere. For more information on the app, see [Now Mobile app demo](https://www.servicenow.com/docs/access?context=sg-mobile-demo&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US).
