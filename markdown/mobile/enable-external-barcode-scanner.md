...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/enable-external-barcode-scanner.html
release: australia
topic_type: task
...
For more information, see [Mobile barcode scanning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/sg-mobile-scanning.md).
