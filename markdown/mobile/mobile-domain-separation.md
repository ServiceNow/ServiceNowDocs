...
**Note:** ITSM Mobile Agent contains an automatically configured domain separation feature. For more information, refer to the [ITSM Mobile Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/itsm-mobile-agent.md) documentation.
