...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/list-filter-sorting.html
release: xanadu
topic_type: task
...
3.  Repeat step 2 to display additional sorting options.
    ...
    **Note:** To change the sorting display attributes, see [Configure sorting display options for mobile filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/list-filter-sorting-attributes.md).
