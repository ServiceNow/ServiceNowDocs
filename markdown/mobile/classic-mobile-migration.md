...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/classic-mobile-migration.html
release: yokohama
topic_type: concept
...
For more detail on ServiceNow® mobile, see [Mobile Configuration and Navigation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-config-navigation.md).
