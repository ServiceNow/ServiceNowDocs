...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/classic-mobile-migration.html
release: brazil
topic_type: concept
...
For more detail on ServiceNow® mobile, see [Mobile Configuration and Navigation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/mobile-config-navigation.md).
...
-   **Mobile experience for Employee Experience Suite**
    ...
    Approve catalog requests, requested items, or change requests from anywhere using the ITSM Mobile Agent app. For more detail, see [ITSM Mobile agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/itsm-mobile-agent.md).
