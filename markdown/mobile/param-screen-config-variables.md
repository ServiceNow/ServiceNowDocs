...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/param-screen-config-variables.html
release: australia
topic_type: task
...
You must create an input form screen before you create variables and attributes. For information about creating an input form screen, see [Configure an input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/parameter-screen-config.md).
