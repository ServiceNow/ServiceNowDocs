...
Install a plugin by searching for the plugin name in you plugins list. For information on the plugin activation process, see [Activate a plugin](https://www.servicenow.com/docs/access?context=t_ActivateAPlugin&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US)
