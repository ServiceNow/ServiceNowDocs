...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/config-advanced-app-allow.html
release: xanadu
topic_type: task
...
3.  In the **Example** field, configure the two following properties:
    ...
    For an example of a completed script, see [Advanced app allowance example script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/adv-app-allow-sample-script.md).
