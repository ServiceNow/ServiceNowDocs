...
3.  In the **Example** field, configure the two following properties:
    ...
    For an example of a completed script, see [Advanced app allowance example script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/adv-app-allow-sample-script.md).
