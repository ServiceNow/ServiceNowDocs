...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/sg-config-parametrized-data-item.html
release: xanadu
topic_type: task
...
5.  Complete the Properties and Data sections as needed.
    ...
    For more information about creating a data item, see [Configure a standard data item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-studio-create-data-item.md). For example, create a data item for open incidents.
