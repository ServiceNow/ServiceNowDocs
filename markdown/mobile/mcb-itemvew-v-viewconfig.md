...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mcb-itemvew-v-viewconfig.html
release: yokohama
...
Legacy cards can be edited as described in [Mobile Card Builder user interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mcb-stage-ui.md), with the following exceptions:
