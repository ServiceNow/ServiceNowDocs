...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mcb-itemvew-v-viewconfig.html
release: zurich
...
Legacy cards can be edited as described in [Mobile Card Builder user interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mcb-stage-ui.md), with the following exceptions:
