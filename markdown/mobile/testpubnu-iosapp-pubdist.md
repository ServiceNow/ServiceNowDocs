...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/testpubnu-iosapp-pubdist.html
release: xanadu
topic_type: concept
...
1.  Set up push notifications by downloading the Apple push certificate \(`p12` file\) and uploading it to your app's push application record:
    ...
    3.  Configure your push applications. For instructions, see [Configure push applications for iOS branded apps using certificate based authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-push-setup-ios.md).
...
Use Mobile App Builder to customize your app. See [Mobile App Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mab-concept.md) for detailed information about how you can customize your branded app.
