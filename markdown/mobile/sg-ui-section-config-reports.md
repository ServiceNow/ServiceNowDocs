...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/sg-ui-section-config-reports.html
release: australia
topic_type: task
