...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/push-notif-sounds.html
release: yokohama
...
The following JSON is an example of how the sound parameter is defined for critical alerts. For more information about critical alerts, see [Create mobile critical alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-critical-alerts-create.md).
