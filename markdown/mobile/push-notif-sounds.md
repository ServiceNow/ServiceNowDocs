...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/push-notif-sounds.html
release: xanadu
...
The following JSON is an example of how the sound parameter is defined for critical alerts. For more information about critical alerts, see [Mobile critical alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-critical-alerts-create.md).
