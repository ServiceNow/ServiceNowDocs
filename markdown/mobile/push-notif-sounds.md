...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/push-notif-sounds.html
release: australia
...
The following JSON is an example of how the sound parameter is defined for critical alerts. For more information about critical alerts, see [Create mobile critical alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/mobile-critical-alerts-create.md).
