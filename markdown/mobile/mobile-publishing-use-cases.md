---
title: Mobile Publishing use cases
description: Here are several reasons to use Mobile Publishing to brand the mobile apps of your company.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-publishing-use-cases.html
release: xanadu
topic_type: concept
...
Use Mobile Publishing if your company needs a branded app for any reason or to satisfy any of the following requirements.
...
**Note:** You must have an account and log in to the [ServiceNow University website](https://learning.servicenow.com/lxp) to access this white paper.
