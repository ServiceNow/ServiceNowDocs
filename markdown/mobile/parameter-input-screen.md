...
Input form screens display inputs to enable your users to enter information into mobile apps. Use input form screens to create or edit records, complete surveys, or any other situation where your users must enter information. Input form screens work in offline mode, so users don't need an internet connection to input information into the app.
 ...
 You can control how users input data, as well as the appearance of input types. You can further customize your input form screens using [Mobile UI Rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/mobile-ui-rules.md).
...
-   **Input section**
    ...
    -   String
    -   Screen
    For more detail on these parameter input types, see [Input form screen attributes for inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/parameter-screen-var-attr.md)
