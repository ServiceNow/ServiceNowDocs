...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/single-multi-barcode-input-config.html
release: zurich
topic_type: task
...
Barcode inputs are available [offline](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-offline-mode.md). [Mobile UI rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-ui-rules.md) apply to barcode inputs.
...
<table id="choicetable_dwz_qrl_zvb"><thead><tr><th align="left" id="d48976e249">

Option

</th><th align="left" id="d48976e252">

Description

</th></tr></thead><tbody><tr><td id="d48976e258">
