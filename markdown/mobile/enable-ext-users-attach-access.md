...
-   [Legacy parameter screen \(UI parameters\), Quebec and earlier](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/parameter-input-screen.md)
-   [Input form screen \(sys\_sg\_parameter\_screen table\), Rome and later](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/parameter-input-screen.md)
-   [Details screen using the Attachment list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/sg-mobile-attachments.md)
