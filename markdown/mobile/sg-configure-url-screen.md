...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/sg-configure-url-screen.html
release: australia
topic_type: task
 ...
 **Note:** To add the URL for a Now Experience Framework page, which leverages the Mobile App Bridge for playbooks, see [Configure mobile web screens with Mobile App Bridge](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/configure-mobile-playbooks.md).
...
If you want to further customize your mobile web screen, see [Add a button to your mobile web screen that launches Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/mobwebscreen-add-button-virtagent.md).
