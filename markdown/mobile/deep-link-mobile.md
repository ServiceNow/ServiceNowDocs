...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/deep-link-mobile.html
release: zurich
topic_type: concept
...
-   **[Mobile deep link structure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/deep-link-mobile-structure.md)**  
Familiarize yourself with how to construct and use mobile deep links in any screen type within a mobile app.

**Parent Topic:**[Mobile URLs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mobile-urls.md)
