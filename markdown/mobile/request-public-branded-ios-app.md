...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/request-public-branded-ios-app.html
release: xanadu
topic_type: task
...
To learn more about mobile deep links and universal links, see [Mobile URLs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-urls.md).
...
-   Do not select this option if you are using AppConfig to pre-configure a default instance URL through an EMM suite or an embedded MAM SDK app. For more information, see [AppConfig for Mobile Apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/appconfig.md).
...
After the build successfully completes and your app is ready for testing, see [Test and publish a new branded iOS app for public distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/testpubnu-iosapp-pubdist.md).
