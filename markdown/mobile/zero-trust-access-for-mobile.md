...
For more information, see [Zero Trust Access \(ZTA\)](https://www.servicenow.com/docs/access?context=session-access&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
