...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/descriptive-elements-script.html
release: yokohama
topic_type: task
...
-   A data source that contains at least one element identifier. Data sources facilitate the mapping of the descriptive element to the input form screen. For more information, see [Data sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/data-sources.md).
