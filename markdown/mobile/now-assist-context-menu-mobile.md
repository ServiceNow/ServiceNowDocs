...
Write with Now Assist is supported on mobile input form screens for Now Assist skills such as task summarization. For more, see [Now Assist on Input Form Screen](ai-case-summarization.md).
