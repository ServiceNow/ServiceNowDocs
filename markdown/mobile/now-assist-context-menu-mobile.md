...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/now-assist-context-menu-mobile.html
release: yokohama
topic_type: concept
...
Write with Now Assist is supported on mobile input form screens for Now Assist skills such as task summarization. For more, see [Now Assist on Input Form Screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/ai-case-summarization.md).
