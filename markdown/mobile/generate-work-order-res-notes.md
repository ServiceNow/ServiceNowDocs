...
For more information on how to generate work resolution notes, see [Generate work order task closure summaries in ServiceNow Agent](https://www.servicenow.com/docs/access?context=generate-close-now-assist-fsm&version=zurich&pubname=zurich-field-service-management&ft:locale=en-US).
