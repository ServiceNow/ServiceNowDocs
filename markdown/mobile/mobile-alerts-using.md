...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-alerts-using.html
release: yokohama
topic_type: task
...
For information about configuring mobile alerts for a record screen, see [Configure a mobile alert for a record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/form-screen-alerts.md). You must be a member of the admin role to perform this configuration.
