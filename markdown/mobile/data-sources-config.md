...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/data-sources-config.html
release: yokohama
topic_type: task
...
7.  Edit the script in the **Data source script** field as required.
    ...
    For examples of data source script, see [Data source script examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/data-source-script-examples.md).
