...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/sg-data-item-relationship.html
release: australia
topic_type: task
...
After creating a relationship data item, create a list screen using this newly created data item. For more information, see [List screen configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/sg-configure-list-screen.md).
