...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-data-item-relationship.html
release: zurich
topic_type: task
...
After creating a relationship data item, create a list screen using this newly created data item. For more information, see [List screen configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-configure-list-screen.md).
