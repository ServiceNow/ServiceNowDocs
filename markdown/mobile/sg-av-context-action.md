...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/sg-av-context-action.html
release: xanadu
topic_type: task
...
-   Delete
-   Script
-   MultiStep. For more information, see [Configure action steps within an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/configure-action-steps.md).
...
Select an input form screen to use for this action item. See [Configure an input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/parameter-screen-config.md).
...
Allows an action item to perform multiple processes.
 ...
 For more information, see [Configure action steps within an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/configure-action-steps.md).

</td></tr></tbody>
</table>6.  Select **Save**.


-   **[Create UI parameters for your Virtual Agent link](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-av-context-2.md)**  
...
-   **[Enable Virtual Agent for mobile applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-mobile-virtual-agent.md)**  
