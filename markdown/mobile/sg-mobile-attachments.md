...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/sg-mobile-attachments.html
release: xanadu
topic_type: concept
...
For details on the record screen configuration, see [Configure a record screen for use with a list screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-configure-form-applet.md).
