...
Configure the enhanced chat experience in Now Assist for Virtual Agent so you can access it from your home page search bar. You can ask questions and receive responses synthesized from multiple sources, as well as get standard search results, all in one place. The summarized answer includes any applicable actions you can take. For more information, see [Enhanced chat](https://www.servicenow.com/docs/access?context=nava-enhanced-chat&version=australia&pubname=australia-conversational-interfaces&ft:locale=en-US).
...
For information on how to configure your Now Assist display experience, see [Configuring assistants overview](https://www.servicenow.com/docs/access?context=configure-now-assist-va&version=australia&pubname=australia-conversational-interfaces&ft:locale=en-US).
