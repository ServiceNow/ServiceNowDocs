...
For more information on configuring authentication for mobile devices, see [Set up OAuth](https://www.servicenow.com/docs/access?context=t_SettingUpOAuth&version=australia&pubname=australia-platform-security&ft:locale=en-US).
