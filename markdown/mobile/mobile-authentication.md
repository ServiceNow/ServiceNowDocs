...
For more information on configuring authentication for mobile devices, see [Set up OAuth](https://www.servicenow.com/docs/access?context=t_SettingUpOAuth&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
