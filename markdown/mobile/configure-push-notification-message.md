...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/configure-push-notification-message.html
release: xanadu
topic_type: task
...
To complete the notification, an event is required to determine when the push notification is sent and who receives it. For more information, see [Configure a push notification event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/configure-push-notification-event.md).

**Parent Topic:**[Mobile push notification components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/configure-mobile-push-notifications.md)
