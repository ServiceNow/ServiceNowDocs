...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/configure-push-notification-message.html
release: australia
topic_type: task
