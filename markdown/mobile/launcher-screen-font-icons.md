...
![Example screen](../image/mab-icon-launcher-examp.png "Launcher screen icon example")
...
|Address Book Solid|f2b9|New York|![Address Book Solid example](../image/mab-icon-launch-addbk-sol.png)| |
|Cart Solid|e935|New York|![Cart Solid example](../image/mab-icon-launch-cart-sol.png)|![Reversed Cart Solid example](../image/mab-icon-launch-cart-sol-rtl.png)|
|Comment Solid|f075|New York|![Comment Solid example](../image/mab-icon-launch-cmmt-sol.png)| |
|File Solid|f15c|New York|![File Solid example](../image/mab-icon-launch-file-sol.png)| |
|Headphones-Mic Solid|e936|New York|![Headphones-Mic Solid example](../image/mab-icon-launch-hdfn-mic-sol.png)| |
|Information Solid|e943|New York|![Information Solid example](../image/mab-icon-launch-inf-sol.png)| |
|Knowledge Solid|e947|New York|![Knowledge Solid example](../image/mab-icon-launch-knowl-sol.png)| |
|Link Solid|e93b|New York|![LInk Solid example](../image/mab-icon-launch-link-sol.png)| |
