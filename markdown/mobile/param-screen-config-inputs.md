...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/param-screen-config-inputs.html
release: xanadu
topic_type: task
...
The autofill variable used for this input. For details on variables, [Configure input form screen variables and attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/param-screen-config-variables.md).
