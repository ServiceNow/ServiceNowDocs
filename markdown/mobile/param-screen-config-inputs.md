...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/param-screen-config-inputs.html
release: australia
topic_type: task
...
The autofill variable used for this input. For details on variables, [Configure attributes for input form screen variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/param-screen-config-variables.md).
