...
The autofill variable used for this input. For details on variables, [Configure input form screen variables and attributes](param-screen-config-variables.md).
