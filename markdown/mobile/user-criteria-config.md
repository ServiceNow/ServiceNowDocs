...
4.  Complete the form as required and select **Submit**.
    ...
    **Note:** Use the following resources when creating a user criteria.
    ...
    -   [Create a user criteria record for Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/create-user-criteria-record.md): Describes the various fields in the User Criteria record form.
