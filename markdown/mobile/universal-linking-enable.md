...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/universal-linking-enable.html
release: xanadu
topic_type: task
...
Define specific ServiceNow platform website pages to display the web banner, where the user does not have a specific mobile app installed. See, [Mobile universal linking for supported URLs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/universal-linking-support-urls.md).

**Parent Topic:**[Universal linking for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/universal-links-mobile.md)
