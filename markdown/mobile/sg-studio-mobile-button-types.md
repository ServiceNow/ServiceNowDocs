...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/sg-studio-mobile-button-types.html
release: yokohama
topic_type: concept
