...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/sg-studio-mobile-button-types.html
release: australia
topic_type: concept
