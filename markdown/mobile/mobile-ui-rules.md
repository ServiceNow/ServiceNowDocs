...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mobile-ui-rules.html
release: yokohama
topic_type: concept
...
For more detail on the kinds of changes you can make with mobile UI rules, see the next section. For detailed steps on creating mobile UI rules and actions, see [Create a mobile UI rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/create-mobile-ui-rule.md).
