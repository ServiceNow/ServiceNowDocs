...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/user-criteria-permissions.html
release: australia
topic_type: concept
...
-   **Navigation tabs**
    ...
    Limit a user’s ability to access certain tabs displayed in the navigation bar. For more information, [Navigation bar](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/sg-mobile-tab-bar.md).
...
-   **Icon section destination**
    ...
    -   For icons, use the reference lookup icon to select an existing icon to display in the icon section. For more information, see [Configure an icon UI section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/sg-ui-section-config-navig.md).
    -   For images, use the reference lookup icon to select the image to display in the icon section. For more information, see [Adding images to an icon section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/add-image-icon-section.md).
...
-   **[Assign mobile user criteria permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/user-criteria-config.md)**  
Apply user criteria permissions to segment your users into different groups, such as location, department, or company.
-   **[Define user criteria status as active or inactive](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/user-criteria-active-inactive.md)**  
