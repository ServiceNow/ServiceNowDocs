...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/sg-studio-create-action-item.html
release: xanadu
topic_type: task
...
Associate the action item with an action function, see [action function](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-studio-config-action-function.md).

Associate action steps to an action item, see [Configure action steps within an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/configure-action-steps.md).
