...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/parameter-screen-var-attr.html
release: zurich
...
Define this attribute whenever you create a data source mechanism to load input values. For more information, see [Data sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/data-sources.md).**Note:**
...
\[Omitted image "param-input-attachment-1.png"\] Alt text: Attachment input example.
...
\[Omitted image "barcode-input.png"\] Alt text: Examples of scanning a barcode with a mobile app.
...
</table>For information about creating an input form screen with barcode inputs, see [Configure input form screens with single and multi-scan barcode inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/single-multi-barcode-input-config.md) and [Configure input form screens with grouped scan barcode inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/config-grouped-scan-barcode-inputs.md).
...
\[Omitted image "param-input-boolean-1.png"\] Alt text: Examples of boolean inputs configured as a check box or toggle switch.
...
\[Omitted image "inline-choice.png"\] Alt text: Single and multiple choice input options on input form screen.
...
\[Omitted image "param-input-choice-1.png"\] Alt text: Inline choice option showing the need for a secondary selection screen.
...
\[Omitted image "input-form-custom-map-input.png"\] Alt text: Shows how the custom map input is displayed in a mobile app where you select 'Next' to view the map.
...
\[Omitted image "param-input-datetime-1.png"\] Alt text: Examples of date and date time configurations.
 ...
 **Note:** The Device Time Zone is different from the User Profile Time Zone that is configured on the platform.
 ...
 For information about setting up the IncludeTimezone attribute of date/time inputs for different action types, see [Date/time input setup for different action item types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/datetime-input-setup-4-action-items.md).

 For information about action item types, see [Configure an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-studio-create-action-item.md).
...
\[Omitted image "ifs-number-box.png"\] Alt text: Examples of number inputs configured as a numerical or percentage values.
...
\[Omitted image "ifs-number-box2.png"\] Alt text: The render type called integer showing a input called Number of outlets with a value of 60.

-   **line**

Displays the input as a line field.

\[Omitted image "ifs-number-line.png"\] Alt text: The render type called line showing a input called Subscription duration in months with a value of 73.

-   **percentage**

Displays a percent symbol\(%\) after the number in the input.

\[Omitted image "ifs-number-percent.png"\] Alt text: The render type called percentage showing a input called Interest rate in percentage with a value of 8%.

-   **slider**

Displays the input as slider value and a box input. For more information about sliders and how to configure them, see [Configure a slider option for a number input](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/configure-slider.md).

\[Omitted image "ifs-slider-float-step-size.png"\] Alt text: The render type called slider showing a input called Weight of package in kilograms with a value of 44.25.


**Note:** For a table showing which attributes can be used with which render type, see [Number render types and compatible input attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/number-compatible-input-attributes.md).
...
</table>The following input attributes listed in this table apply only to the slider render type. For more information, see [Slider types and their input attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/slider-input-attributes.md).
 ...
 **Note:** This defined value is the the starting point, unless a loading mechanism, which takes priority, is configured. See, [Loading mechanisms for input form screens](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/loading-mechanisms.md).
...
\[Omitted image "param-input-ranking-1.png"\] Alt text: Ranking input example.
...
Use reference inputs for inputs that reference a field on a table. These inputs work like [reference fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/c_ReferenceField.md) in the forms on your instance. You can configure your reference input with conditions, reference qualifiers, and a search option to help your users find what they need quickly.
...
|**Conditions**|Enter an encoded query to apply conditions to your reference list. For details on creating these queries, see [Encoded query strings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_EncodedQueryStrings.md).|
...
\[Omitted image "reference-input-example.png"\] Alt text: Input form screen input for the assigned\_to field configured in Mobile App Builder.

\[Omitted image "reference-input-attribute-example.png"\] Alt text: Input form screen input attributes for the assigned\_to field configured in Mobile App Builder.
...
\[Omitted image "signature-inputs.png"\] Alt text: Signature inputs in an input form screen on a mobile device.
...
</table>For information about creating an input form screen with signature inputs, see [Configure input form screens with signature inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/configure-signature-inputs.md).
...
\[Omitted image "param-input-string-1.png"\] Alt text: String input example.
