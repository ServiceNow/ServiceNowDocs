...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/parameter-screen-var-attr.html
release: xanadu
...
</table>For information about creating an input form screen with barcode inputs, see [Configure input form screens with single and multi-scan barcode inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/single-multi-barcode-input-config.md) and [Configure input form screens with grouped scan barcode inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/config-grouped-scan-barcode-inputs.md).
...
\[Omitted image "param-input-choice-1.png"\] Alt text: Examples of single and multiple choice input configurations.
 ...
 **Note:** The Device Time Zone is different from the User Profile Time Zone that is configured on the platform.
 ...
 For information about setting up the IncludeTimezone attribute of date/time inputs for different action types, see [Date/time input setup for different action item types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/datetime-input-setup-4-action-items.md).

 For information about action item types, see [Configure an action item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-studio-create-action-item.md).
...
</table>For information about creating an input form screen with signature inputs, see [Configure input form screens with signature inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/configure-signature-inputs.md).
