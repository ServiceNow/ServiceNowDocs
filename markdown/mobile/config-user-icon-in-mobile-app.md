...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/config-user-icon-in-mobile-app.html
release: xanadu
topic_type: task
 ...
 **Note:** Use a navigation function to navigate to a user profile record screen when you use a user type icon. For more information, see [Navigation functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-nav-functions.md).
