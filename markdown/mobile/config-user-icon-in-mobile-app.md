...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/config-user-icon-in-mobile-app.html
release: yokohama
topic_type: task
 ...
 **Note:** Use a navigation function to navigate to a user profile record screen when you use a user type icon. For more information, see [Navigation functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-nav-functions.md).
