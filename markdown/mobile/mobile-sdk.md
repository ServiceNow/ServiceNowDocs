...
For more details regarding the Mobile SDK, see the [Mobile SDK API reference](https://www.servicenow.com/docs/access?context=api-mobile_sdk&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
