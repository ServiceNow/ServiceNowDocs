...
For more details regarding the Mobile SDK, see the [Mobile SDK API reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/cllent-mobile-api-reference/api-mobile_sdk.md).
