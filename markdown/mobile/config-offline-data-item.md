...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/config-offline-data-item.html
release: yokohama
topic_type: task
...
5.  In the Offline Properties area, define offline mode query conditions for the data item to conform to.
    ...
    Create conditions using the [Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/c_ConditionBuilder.md).
