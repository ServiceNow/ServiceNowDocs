...
![a list of three recommended components](../image/now-assist-component-recc.png "Component recommendations with Now Assist")

Now Assist in Mobile App Builder recommends record components using the record's context. For more information, see [Component recommendations with Now Assist](../task/component-recommend-now-assist.md).
