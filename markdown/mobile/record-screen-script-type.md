...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile/record-screen-script-type.html
release: brazil
...
For full configuration instructions, see [Configure the script field for records screens](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/record-screen-script-type-config.md).
