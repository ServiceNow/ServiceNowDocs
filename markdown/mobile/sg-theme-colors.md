...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/sg-theme-colors.html
release: yokohama
...
**Important:** Currently, ServiceNow® mobile Android apps do not support using \#RGB notation to specify theme colors for the apps. However, \#RRGGBB notation is supported by both iOS and Android apps.

## Theme color locations in mobile apps

<table id="table_zvg_ps1_ljb"><tbody><tr><td>
