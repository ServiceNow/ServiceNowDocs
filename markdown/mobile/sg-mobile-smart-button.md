...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/sg-mobile-smart-button.html
release: xanadu
topic_type: concept
...
For examples of configuring smart buttons, see [Configure a smart button](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-studio-config-smart-button.md).
