...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/mobile/sg-mobile-smart-button.html
release: australia
topic_type: concept
...
For examples of configuring smart buttons, see [Configure a smart button](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/mobile/sg-studio-config-smart-button.md).
