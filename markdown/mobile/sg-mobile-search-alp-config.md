---
title: Add your search configuration to a launcher screen
description: Update your launcher screen to use your custom search configuration.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/sg-mobile-search-alp-config.html
release: yokohama
topic_type: task
...
5.  Select **Choose**, select the search configuration you want to use, and then select **Apply**.

6.  Select **Save**.


**Parent Topic:**[Configure search criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/sg-create-custom-search.md)
