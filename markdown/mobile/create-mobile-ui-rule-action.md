...
Enables record summarization using Now Assist.**Note:** This operation requires Now Assist to be configured. For more information, see Overview tab in Now Assist Admin.
