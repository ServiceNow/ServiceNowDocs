...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/create-mobile-ui-rule-action.html
release: zurich
topic_type: task
...
```
 ...
 You can also use color variables to change theming in your mobile UI rules. For details see [Color variable support for UI rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/color-var-ui-rule.md).

 **Note:**

-   `IconCode` must be replaced with a valid icon code. For a list of icon codes, see [Mobile icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-icon.md)
...
Enables record summarization using Now Assist.**Note:** This operation requires Now Assist to be configured. For more information, see [Overview tab in Now Assist Admin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/configuring-now-assist.md).
