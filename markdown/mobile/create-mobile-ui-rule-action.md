...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/create-mobile-ui-rule-action.html
release: xanadu
topic_type: task
...
```
 ...
 You can also use color variables to change theming in your mobile UI rules. For details see [Color variable support for UI rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/color-var-ui-rule.md).

 **Note:**

-   `IconCode` must be replaced with a valid icon code. For a list of icon codes, see [Mobile icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-mobile-icon.md)
