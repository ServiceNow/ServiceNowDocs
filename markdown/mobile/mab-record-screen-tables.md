...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/mab-record-screen-tables.html
release: yokohama
...
For more information about working with these options, see [Create reference record entries in record screen tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mab-record-screen-table-add-edit.md) and [Edit record reference entries in record screen tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mab-record-screen-table-edit.md).
...
[Create reference record entries in record screen tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mab-record-screen-table-add-edit.md)

[Edit record reference entries in record screen tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mab-record-screen-table-edit.md)
