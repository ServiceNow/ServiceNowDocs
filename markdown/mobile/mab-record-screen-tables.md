...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mab-record-screen-tables.html
release: zurich
...
For more information about working with these options, see [Create reference record entries in record screen tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mab-record-screen-table-add-edit.md) and [Edit record reference entries in record screen tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mab-record-screen-table-edit.md).
...
|\[Omitted image "mab-field-inline-editing.png"\] Alt text:|You can perform inline editing in certain fields, such as the **Order** field. When performing inline editing, you change content within the table and you do not need to open the record.|
...
[Create reference record entries in record screen tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mab-record-screen-table-add-edit.md)

[Edit record reference entries in record screen tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/mab-record-screen-table-edit.md)
