...
For details on configuring Multi-factor Authentication, see [Multifactor authentication system properties](https://www.servicenow.com/docs/access?context=mfa-properties&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US)
