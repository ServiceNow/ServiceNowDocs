...
For more information on this plugin, see [External single sign-on \(SSO\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/c_MultipleProviderSingleSignOn.md).

For more information on configuring multi provider SSO, see [Multi-Provider single sign-on \(SSO\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/c_MultipleProviderSingleSignOn.md).
