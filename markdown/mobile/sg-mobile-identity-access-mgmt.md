...
For more information on this plugin, see [External single sign-on \(SSO\)](https://www.servicenow.com/docs/access?context=c_MultipleProviderSingleSignOn&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).

For more information on configuring multi provider SSO, see [Multi-Provider single sign-on \(SSO\)](https://www.servicenow.com/docs/access?context=c_MultipleProviderSingleSignOn&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
...
For details on configuring Multi-factor Authentication, see [Multifactor authentication system properties](https://www.servicenow.com/docs/access?context=mfa-properties&version=zurich&pubname=zurich-platform-security&ft:locale=en-US)
