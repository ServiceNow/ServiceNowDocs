...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/mobile-hierarchy.html
release: zurich
topic_type: concept
...
-   **Navigation bar tabs**
    ...
    For information on how to create navigation bar tabs, see [Configure the navigation bar and navigation tabs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/config-sg-application-menu.md).
...
-   **Launcher screens**
    ...
    For more detail on launcher screens, see [Launcher screens](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-applet-launcher.md).
...
-   **Icons**
    ...
    For more information on icons, see [Mobile icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-mobile-icon.md).
...
-   **Data items**
    ...
    For more detail on data items, see [Data items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-data-item.md).
...
-   **Screens**
    ...
    -   [Calendar](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/calendar-screen.md)
    -   [Chart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/chart-screen.md)
    -   [Form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/form-screen.md)
    -   [Grouped list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/grouped-list-screen.md)
    -   [List](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/list-screen.md)
    -   [Map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/map-screen.md)
    -   [URL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/url-screen.md)
...
-   **Functions**
    ...
    For more information on functions, see [Mobile functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-studio-mobile-button-types.md).
