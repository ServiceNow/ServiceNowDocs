...
-   Onselect \(defined in root-view attribute JSON\): TextColorVariable and BackgroundColorVariable
 ...
 For details creating card templates, see [Create a card template with Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/mobile/mcb-create-template.md).
