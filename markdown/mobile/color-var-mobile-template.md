...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/color-var-mobile-template.html
release: xanadu
...
-   Onselect \(defined in root-view attribute JSON\): TextColorVariable and BackgroundColorVariable
 ...
 For details creating card templates, see [Create a card template with Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mcb-create-template.md).
