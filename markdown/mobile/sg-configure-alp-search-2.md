...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/sg-configure-alp-search-2.html
release: xanadu
topic_type: task
...
Enable voice search so that your users can search using native speech recognition. For more details, see [Turn on voice search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/turn-on-voice-search.md)
