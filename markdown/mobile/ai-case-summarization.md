...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/ai-case-summarization.html
release: zurich
topic_type: concept
...
This feature is only available with select BU plugins and is currently available with [ServiceNow Otto for Field Service Management \(FSM\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/field-service-management/now-assist-fsm.md).

This example shows a work order where Otto generated the closure notes about a printer replacement. Agents can edit or delete generated notes before submitting the resolution notes. For more information, see [AI Admin Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/platform-now-assist-landing.md).
