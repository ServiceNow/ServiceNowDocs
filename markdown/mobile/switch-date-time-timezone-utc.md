...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/switch-date-time-timezone-utc.html
release: yokohama
topic_type: task
...
Both [Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/mobile-card-builder.md) and the following mobile screens support the **ShowDateTimeInUTC** property:

-   [Input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/parameter-input-screen.md)
-   [Record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/form-screen.md)
