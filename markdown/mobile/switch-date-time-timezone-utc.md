...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/switch-date-time-timezone-utc.html
release: xanadu
topic_type: task
...
Both [Mobile Card Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-card-builder.md) and the following mobile screens support the **ShowDateTimeInUTC** property:

-   [Input form screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/parameter-input-screen.md)
-   [Record screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/form-screen.md)
