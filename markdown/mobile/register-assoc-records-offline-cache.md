...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/register-assoc-records-offline-cache.html
release: xanadu
topic_type: task
