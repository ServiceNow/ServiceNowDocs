...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/register-assoc-records-offline-cache.html
release: yokohama
topic_type: task
