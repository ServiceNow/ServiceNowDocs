...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/config-mobile-list-filter.html
release: yokohama
topic_type: task
...
For information about configuring map screens, see [Configure a map screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/sg-configure-map-screen.md).
