...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/parameter-screen-config.html
release: xanadu
topic_type: task
...
Option to make the input form screen is available in offline mode. For details on offline mode, see [Offline mode](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-offline-mode.md).
...
Variables that are to be used in your input form screen. Variables define what information is collected from the user automatically or the default information for an input. Select **New** to add a new variable. For more information about configuring variables, see [Configure input form screen variables and attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/param-screen-config-variables.md).
