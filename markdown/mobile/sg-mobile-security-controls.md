...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/sg-mobile-security-controls.html
release: yokohama
topic_type: concept
...
For more information, see [Configure the blur app option](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/additional-mobile-configuration.md)
...
For more information, see [Configure the status for rooted and jailbroken devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/configure-rooted-jailbroken-devices.md).
