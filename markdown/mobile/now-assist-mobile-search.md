...
description: Use Now Assist in AI Search on Mobile to provide actionable AI-generated or AI-selected answers to user searches. You can see citations for the sources that were used by Now Assist and navigate to them from the generated answer.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/now-assist-mobile-search.html
release: xanadu
topic_type: concept
...
Use Now Assist in AI Search on Mobile to provide actionable AI-generated or AI-selected answers to user searches. You can see citations for the sources that were used by Now Assist and navigate to them from the generated answer.
...
For more information on Now Assist in AI Search on mobile, including installation, see  for more information. For information on guided setup to configure AI Search on your instance, see 
