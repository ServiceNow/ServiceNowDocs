...
Use Now Assist Search on Mobile to provide actionable AI-generated or AI-selected answers to user searches. You can see citations for the sources that were used by Now Assist and navigate to them from the generated answer.
