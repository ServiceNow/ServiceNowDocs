...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/mobile-properties.html
release: xanadu
topic_type: concept
...
-   **[Turn on or turn off automatic app refresh](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/enable-disable-auto-app-refresh.md)**  
...
-   **[Enable external users to access attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/enable-ext-users-attach-access.md)**  
...
-   **[Switch the date/time fields between device time zone and UTC](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/switch-date-time-timezone-utc.md)**  
...
-   **[Configure mobile apps to use the date/time format of mobile devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/config-apps2use-devicedatetimeform.md)**  
...
-   **[Hide seconds in date/time fields on mobile cards, record screen details pages, or activity streams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/hide-secs-mobcds-recscreen-actstrem.md)**  
...
-   **[Extend embedded web sessions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/extend-embedded-web-sessions.md)**  
Extend embedded web sessions to keep mobile users logged in until the mobile OAuth token expires.
-   **[Enable enhanced barcode scanning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/enable-enhanced-barcode-scan.md)**  
...
-   **[Configure different mobile attachment capabilities on Android devices based on user roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mob-attachments-android.md)**  
...
-   **[Keep native apps active during authentication on Android devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/active-authentication-android.md)**  
