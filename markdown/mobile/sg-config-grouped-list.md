...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/sg-config-grouped-list.html
release: yokohama
topic_type: task
...
The function used within this function instance.
    ...
    For more information on mobile functions, see [Mobile functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/sg-studio-mobile-button-types.md).
