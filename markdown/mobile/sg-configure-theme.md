...
1.  Navigate to [Create a theme with Theme Builder](https://www.servicenow.com/docs/access?context=tb-create-theme&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).

    Follow the instructions to create your theme.

2.  Navigate to [Publish your themes with Theme Builder](https://www.servicenow.com/docs/access?context=tb-apply-theme&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
