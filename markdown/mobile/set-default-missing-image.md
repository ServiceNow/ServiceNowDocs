...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/set-default-missing-image.html
release: zurich
topic_type: task
...
1.  Upload an image to your instance to use as a placeholder. For details on uploading images, see [Storing images in the database](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_StoringImagesInTheDatabase.md)
...
</table>**Parent Topic:**[Mobile system property configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/additional-mobile-configuration.md)
