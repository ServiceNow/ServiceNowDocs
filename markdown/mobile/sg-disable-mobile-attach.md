...
-   You need to elevate to the **security\_admin** role to perform these steps. For details on this role, see [security\_admin role](https://www.servicenow.com/docs/access?context=security-admin-role&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
