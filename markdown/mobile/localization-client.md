...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/localization-client.html
release: zurich
topic_type: concept
...
The ServiceNow AI Platform provides translations for multiple languages on your mobile device. These supported languages are listed in the topic [Native localization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/localization-native.md). You can add and customize additional client-side languages using the Mobile Custom Localization ServiceNow Store app.
...
-   [System Localization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/system-localization-landing.md)
-   [Localization Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/localization-workspace.md)
-   [Translated Name / Field table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/r_TranslatedNameFieldTable.md)
-   [Artifact configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/framework-configuration.md)
-   [Create and configure a custom artifact](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/create-configure-custom-artifact.md)
