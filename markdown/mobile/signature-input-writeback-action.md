...
You can also write custom code to handle saving your signature inputs. For information about server-side scripting, see [Server-side scripting](https://www.servicenow.com/docs/access?context=c_ServerScripting&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
