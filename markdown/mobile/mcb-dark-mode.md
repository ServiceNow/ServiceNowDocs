...
Light and dark modes are user interface themes that adjust color schemes to optimize screen visibility and comfort.
...
\[Omitted image "builder-light-mode.png"\] Alt text: the mobile app builder screens category page in light mode
...
\[Omitted image "builder-dark-mode.png"\] Alt text: the mobile app builder screens category page in dark mode
...
To toggle between light and dark modes, select the theme changer button \(\[Omitted image "builder-dark-mode-button.png"\] Alt text:\) in the builder tool header to open the appearance picker. Select your desired display mode and your builder tool will refresh in real-time with the new appearance.
