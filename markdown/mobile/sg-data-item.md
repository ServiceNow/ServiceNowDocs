...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/mobile/sg-data-item.html
release: yokohama
topic_type: concept
...
-   **Standard data items**
    ...
    For information on standard data items, see [Configure a standard data item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/mobile/sg-studio-create-data-item.md).
