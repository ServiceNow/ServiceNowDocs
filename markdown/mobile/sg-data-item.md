...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/mobile/sg-data-item.html
release: zurich
topic_type: concept
...
-   **Standard data items**
    ...
    For information on standard data items, see [Configure a standard data item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/sg-studio-create-data-item.md).
...
-   **Append encoded query**
    ...
    To navigate from a single score analytics preview or from a chart screen header function to a list of records, you need to configure a special data item using an instance relative URL. This is a standard data item that uses a different type of condition. Find more information about how to configure an append encoded query in [Chart screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/chart-screen.md).

-   **Grouped list data item**

    A grouped data item is used exclusively for a grouped list screen. Any data item, standard and relationship, parametrized or not, can be grouped by a field. Find more info about how to configure grouped list data items at [Grouped list screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/mobile/grouped-list-screen.md).
