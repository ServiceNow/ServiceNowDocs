...
Set of conditions for the data item to conform to. You can create conditions using the condition builder.**Note:** This field is only available when you select `Declarative` in the **Condition type** field.
