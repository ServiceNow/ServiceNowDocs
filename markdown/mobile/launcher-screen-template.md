...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/mobile/launcher-screen-template.html
release: xanadu
topic_type: task
...
Determine if this launcher section contains a header section. For more information, see [Configure a launcher screen header](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/create-alp-header.md).
...
Determine if this launcher section contains a search area. For more information, see [Global search for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/mobile-search-config.md).
...
Determine what UI sections are contained in this launcher screen. For more information, see [Launcher screen UI sections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/alp-ui-sections.md).
...
Determine if this launcher section contains any quick action functions. For more information, see [Quick actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/mobile/sg-config-quick-actions.md).
