...
1.  Export the ETL configuration.
    ...
    3.  Complete the update sets and export it.
        ...
        For more information on update sets, see [Get started with update sets](https://www.servicenow.com/docs/access?context=get-started-update-sets&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
...
2.  Import the ETL configuration to another instance.
    ...
    2.  After a subscription is created for your FDS request, and the request is in awaiting validation state, import the configuration that you have exported in Step 1.
        ...
        If you have any errors in the update sets, you can skip those files and commit the remaining files. Your configuration won't be affected. For more information on update sets, see [Get started with update sets](https://www.servicenow.com/docs/access?context=get-started-update-sets&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
    ...
    5.  Verify all the steps in ETL configuration to make sure everything is mapped correctly, and run the integration and perform rollback.
        ...
        For details, see [IntegrationHub ETL](https://www.servicenow.com/docs/access?context=integrationhub-etl&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
