...
[Configure![](../../../reuse/icons/brand-icons/bus-sdlc.svg)Install and configure Service Exchange applications.](../../tmt-service-bridge-2/concept/service-bridge-v2-configure-provider.md)

</td></tr><tr><td>

[Use![](../../../reuse/icons/brand-icons/bus-management-console.svg)Learn how admin and agents can use Service Exchange to connect multiple ServiceNow instances.](../../tmt-service-bridge-2/concept/service-bridge-v2-administer.md)

</td><td>

[Reference![](../../../reuse/icons/brand-icons/bus-learn.svg)Get additional details about Service Exchange, including data model, error log, and cloning instances.](../../tmt-service-bridge-2/reference/service-bridge-v2-reference.md)

</td></tr></tbody>
</table>## Additional resources

-   Learn more about what's new and changed, see the [Service Exchange release notes](https://www.servicenow.com/docs/access?context=service-bridge-rn&version=zurich&pubname=zurich-release-notes&ft:locale=en-US).
