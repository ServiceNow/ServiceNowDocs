...
<table id="choicetable_msz_gll_sfc"><thead><tr><th align="left" id="d22134e111">

Option

</th><th align="left" id="d22134e114">

Description

</th></tr></thead><tbody><tr><td id="d22134e120">
...
3.  Use the guided setup to complete the mapping to integrate third-party data into CMDB. For details, see [IntegrationHub ETL](https://www.servicenow.com/docs/access?context=integrationhub-etl&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
...
2.  Confirm your choice by selecting **OK**.
3.  Complete the configuration. For details, see [Create a transform map](https://www.servicenow.com/docs/access?context=t_CreateATransformMap&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
4.  Close the browser tab to return to the Subscription Item page.
