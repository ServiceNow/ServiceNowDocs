...
If you’re a consumer, see [Installing and configuring Service Exchange for Consumers](service-bridge-v2-install.md).

**Related topics**  


[Installing and configuring Service Exchange for Consumers](service-bridge-v2-install.md)
