...
-   [Service Exchange Remote Catalog items](service-bridge-v2-proactive-customer-care-csp.md)
-   [Proactive Service Exchange case notification in Service Exchange](service-bridge-v2-proactive-notify.md)
