...
A transform record is created on your ServiceNow® instance. Any Remote Task's inbound or outbound fields that match a transform will automatically use them. To learn more, see [Create remote task definitions in Service Exchange for Providers](service-bridge-v2-create-remote-tasks-defs.md).
