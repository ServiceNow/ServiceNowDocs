...
For more details on variable sets and how they are used, see [Service catalog variable sets](https://www.servicenow.com/docs/access?context=c_ServiceCatalogVariableSets&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
