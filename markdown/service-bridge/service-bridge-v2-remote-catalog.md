...
1.  Create a remote record producer in a remote catalog. See [Create remote record producers in a remote catalog in Service Exchange for Providers](../task/service-bridge-v2-create-remote-rec-prod.md).
