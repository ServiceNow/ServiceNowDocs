...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/set-filter-to-follow-filter.html
release: xanadu
topic_type: task
last_updated: "2024-08-01"
reading_time_minutes: 2
breadcrumb: [Configure a Single/Multiple select or cascading filter, Filters, Platform Analytics]
---
...
**Parent Topic:**[Configure a Single/Multiple select or cascading filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-select-filter-workspace.md)
