...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/set-filter-to-follow-filter.html
release: yokohama
topic_type: task
