...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/filter-dv-condition-builder.html
release: australia
topic_type: task
...
-   **[Add a dynamic JavaScript filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/create-dynamic-js-filter-pae.md)**  
Add a dynamic JavaScript statement for evaluation as part of a report visualization's filter criteria.
-   **[Related list conditions example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/filter-dv-condition-builder-rel-list.md)**  
