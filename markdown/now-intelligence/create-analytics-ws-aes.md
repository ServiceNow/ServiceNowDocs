...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/create-analytics-ws-aes.html
release: zurich
topic_type: concept
...
For more information about using App Engine Studio to create a workspace with an Analytics Center, see Add an application experience.
