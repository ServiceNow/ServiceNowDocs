...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/enable-semantics-generation.html
release: australia
topic_type: task
...
3.  Locate the table or column of interest.
    ...
    **Tip:**
    ...
    -   If you're in the Semantic Table Configurations table and the table is not listed, consider adding it as described in [Add a table to the semantic data layer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/add-table-semantic-layer.md).
