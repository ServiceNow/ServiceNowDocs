...
Distribute and consume Platform Analytics through data visualizations and [dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/dashboards-glossary.md) with optional filters. Explore KPIs and receive insights into significant events in the data.
...
**Platform Analytics** experience is enabled by default on upgrade to Brazil. Core UI dashboards and reports are still visible from the Core UI tools. Users with the report\_admin role can create and edit Core UI reports. Users with the dashboard\_admin role can create and edit Core UI dashboards.
...
[Reference\[Omitted image "bus-learn.svg"\] Alt text:Data caching, roles, and tables across the Platform Analytics experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/platform-analytics-exp-reference.md)
