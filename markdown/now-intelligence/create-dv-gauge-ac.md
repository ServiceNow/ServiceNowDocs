...
6.  Select the options for your data source.
    ...
    -   If your visualization represents table data, go to [Table data options for gauge visualizations](../reference/config-dv-gauge-table-data.md).
    -   If your visualization represents indicator data, go to [Indicator data options for gauge visualizations](../reference/config-dv-gauge-ind-data.md).
