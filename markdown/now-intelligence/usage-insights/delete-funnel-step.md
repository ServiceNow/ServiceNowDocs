---
title: Delete a funnel
description: Easily delete a funnel.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/usage-insights/delete-funnel-step.html
release: xanadu
...
1.  From the **Funnels** module, select to highlight from the funnel list the existing funnel you want to delete.

2.  Select the delete icon \[Omitted image "delete-cohort-funnel-icon.png"\] Alt text: Delete icon to delete the funnel.

3.  Confirm that you want to delete the funnel by selecting **OK**.
