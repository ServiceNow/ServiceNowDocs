...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/usage-insights/viewing-sessions.html
release: zurich
...
\[Omitted image "uxa-session-analytics2-.png"\] Alt text: session analytics
