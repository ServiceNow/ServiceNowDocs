...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/usage-insights/create-funnel.html
release: zurich
...
breadcrumb: [Conversion funnels, Use, Usage Insights, Platform Analytics]
---
...
2.  From the Applications list, select the application to create a conversion funnel for.
...
<table id="choicetable_fsr_qbg_wjb"><tbody><tr><td id="d91468e115">
...
**Parent Topic:**[Funnel reports in Usage Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/usage-insights/funnel-reports-uxa.md)
