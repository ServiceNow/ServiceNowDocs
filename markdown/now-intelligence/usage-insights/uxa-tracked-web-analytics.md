...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/usage-insights/uxa-tracked-web-analytics.html
release: australia
...
For more information about using the data, see [Viewing user analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/usage-insights/viewing-user-data.md).
