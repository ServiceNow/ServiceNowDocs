...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/usage-insights/uxa-tracked-web-analytics.html
release: xanadu
...
For more information about using the data, see [Viewing user analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/usage-insights/viewing-user-data.md).
...
**Parent Topic:**[Tracked analytics fields and cookies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/usage-insights/uxa-tracked-fields-and-cookies.md)
