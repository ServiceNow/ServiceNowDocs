...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/usage-insights/uxa-config-link-privacy-policy.html
release: australia
...
Users can choose to enable or turn off tracking in their settings. To learn more about enabling tracking, see [How users consent to tracking in Usage Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/usage-insights/user-exp-analytics-user-set.md).
