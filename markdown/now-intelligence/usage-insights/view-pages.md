...
The analogous module for mobile applications is Screens. For more information, see [Usage Insights for mobile applications](https://www.servicenow.com/docs/access?context=mobile-analytics&version=australia&pubname=australia-mobile&ft:locale=en-US).
