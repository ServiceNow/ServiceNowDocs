...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/usage-insights/view-pages.html
release: xanadu
...
\[Omitted image "pages-module.png"\] Alt text: Pages module.
...
Name of the selected page. To change the name of a page, click the edit icon \[Omitted image "edit-icon.png"\] Alt text:.
...
-   Client Page Load - Time needed to render the page by only downloading the net new content. For example, client-side routing.
 ...
 \[Omitted image "performance-graph.png"\] Alt text: Performance graph.
