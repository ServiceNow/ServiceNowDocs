...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/usage-insights/view-pages.html
release: zurich
...
The analogous module for mobile applications is Screens. For more information, see [Usage Insights for mobile applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/mobile/mobile-analytics.md).
...
Shows the average time that it takes to load the page, based on the number of times the page is viewed.
