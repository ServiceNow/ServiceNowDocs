...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/usage-insights/data-export-submit-request.html
release: zurich
...
Set up a secure connection to Hermes, to start consuming data export results. See [Setting up a secure connection to Hermes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/usage-insights/data-export-setup-hermes.md).
