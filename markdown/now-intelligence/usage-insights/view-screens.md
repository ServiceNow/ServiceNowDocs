...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/usage-insights/view-screens.html
release: xanadu
...
Name of the selected screen. To change the name of a screen, click the edit icon \[Omitted image "edit-icon.png"\] Alt text:.
...
Merge actions \[Omitted image "merge-actions-button.png"\] Alt text: Merge actions button
...
</table>Where available, you can view sessions that contained a specific screen. Click the Sessions list icon \[Omitted image "session-icon.png"\] Alt text: to view these sessions from the Sessions list.
...
3.  Click the merge icon \(\[Omitted image "merge-actions-button.png"\] Alt text:\) next to the first action that you want to merge.
