...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/usage-insights/view-navigation-paths.html
release: xanadu
...
\[Omitted image "navigation-path.png"\] Alt text: Navigation path visualization
...
Hide or show pop-ups in the visualization.

</td><td>

Check or uncheck the **Hide Popups &amp; Menus** box to hide or show them.

</td></tr><tr><td>

Change the root screen to see navigation paths from that screen onward, regardless of previous navigations to the screen.

</td><td>

Change the root screen several ways:-   Point to an applicable screen and click the **Show Navigation Paths** \[Omitted image "show-nav-path-icon.png"\] Alt text: icon to view paths from the selected screen as the root.
-   Enter a screen name in the search field and select it from the list.

</td></tr><tr><td>

Navigating to a screen to see UI analytics.

</td><td>

Point to a screen and click its screen title.
