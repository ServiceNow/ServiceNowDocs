...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/usage-insights/viewing-user-data.html
release: xanadu
...
\[Omitted image "users-list.png"\] Alt text: Users list
...
-   **[View a users list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/usage-insights/view-users-list.md)**  
View pre-filtered user lists, and search for users by more user or session properties.
-   **[View a session event timeline](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/usage-insights/view-session-event-timeline.md)**  
