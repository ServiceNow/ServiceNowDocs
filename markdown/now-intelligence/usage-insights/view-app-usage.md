---
title: App usage
description: The Usage module provides a view of user adoption, analytics such as total number of users of your site or app, average number of sessions opened daily, and how long sessions last on average.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/usage-insights/view-app-usage.html
release: xanadu
...
The Usage module provides a view of user adoption, analytics such as total number of users of your site or app, average number of sessions opened daily, and how long sessions last on average.

Navigate to **Analytics** &gt; **Usage** to see an overview of usage KPIs. You can point to most visualizations to see brief, relevant details such as date of sessions, number and percentage of users, and app version number.

\[Omitted image "analytics-module-usage-screen.png"\] Alt text: Analytics module - Usage screen
...
**Parent Topic:**[Using the Analytics module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/usage-insights/viewing-analytics.md)
