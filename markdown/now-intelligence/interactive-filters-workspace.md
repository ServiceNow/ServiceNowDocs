...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/interactive-filters-workspace.html
release: australia
topic_type: concept
...
You can filter visualizations by domain on domain-separated instances. Domain filtering uses a different component. For more information, see [Create a domain filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/create-domain-filter.md).
