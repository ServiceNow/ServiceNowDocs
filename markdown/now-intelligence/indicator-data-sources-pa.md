...
-   ServiceNow Community posts
-   Product documentation

If you have upgraded your instance but not yet fully migrated to Platform Analytics, you continue to have Performance Analytics on your instance. Also, administrators who maintain Service Portal pages with Performance Analytics content continue to have access to the Core UI Performance Analytics front end objects on those pages.

**Parent Topic:**[Data sources for data visualizations](../reference/data-sources-visualizations.md)
...
[Multiple data sources](../reference/multiple-data-sources.md)
