...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/platform-analytics/exploring-now-assist-explorer.html
release: yokohama
...
|User|Description|
|----|-----------|
|Exploration creator|Creates new explorations. Sets the goal of the exploration. Generates the first graphics. Can use the exploration just for themselves, or can invite participants and viewers, who must have access to the data in generated data visualizations. Must have the now\_assist\_explorer\_user role or higher.|
|Exploration participant|Anyone with whom the exploration is shared with editing rights. Must also have the now\_assist\_explorer\_user role or higher. Can generate more data visualizations or write commentary. May be able to share the exploration further.|
|Exploration viewer|Anyone with whom the exploration is shared either without editing rights or without the now\_assist\_explorer\_user role or higher. A viewer cannot ask questions of the AI or add text to the exploration, but they can read it.|

## AI Data Explorer benefits
...
-   [Activate AI Data Explorer skills](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/platform-analytics/activate-now-ass-explorer.md)
-   [Using AI Data Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/platform-analytics/use-now-assist-explorer.md)
-   [AI Data Explorer reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/platform-analytics/now-assist-explorer-reference.md)
