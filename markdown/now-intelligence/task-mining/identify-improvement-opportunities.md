...
4.  Select the Image icon \[Omitted image "image.tm-io-image-icon"\] next to the step to preview any collected image.
...
8.  Select the task improvement action that you want to take, and select **Continue**.
    ...
    \[Omitted image "image.tm-io-generate-ai"\] Alt text: Screenshot showing the UI option to generate details with AI.
