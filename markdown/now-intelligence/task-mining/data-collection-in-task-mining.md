...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/task-mining/data-collection-in-task-mining.html
release: zurich
product: Task Mining
...
For a complete list of tables installed with Task Mining, see [Components installed with Task Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/task-mining/installed-with-task-mining.md).
