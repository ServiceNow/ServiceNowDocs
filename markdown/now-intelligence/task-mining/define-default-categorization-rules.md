...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/task-mining/define-default-categorization-rules.html
release: australia
product: Task Mining
...
8.  In the **Categories** section, set the rule properties.
    ...
    For a description of the field values, see [Categorization rule form in Task Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/categorization-rules.md).
...
[Categorization concepts in Task Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/configuration-concepts.md)
