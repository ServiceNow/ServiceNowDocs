...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/task-mining/define-default-categorization-rules.html
release: yokohama
product: Task Mining
...
For more information, see [Categorization concepts in Task Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/task-mining/configuration-concepts.md).
...
6.  On the **Categorization Rule** form, fill in the fields.
    ...
    For a description of the field values, see [Categorization rule form in Task Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/task-mining/categorization-rules.md).
