...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/task-mining/create-task-mining-projects.html
release: zurich
product: Task Mining
...
Group actions as a task for a Task activity or Task timeline analysis. For more information, see [Define user actions for task logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/task-mining/mine-data.md).
