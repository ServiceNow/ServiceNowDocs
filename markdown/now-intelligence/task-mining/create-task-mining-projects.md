...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/task-mining/create-task-mining-projects.html
release: australia
product: Task Mining
...
Group actions as a task for a Task activity or Task timeline analysis. For more information, see [Define user actions for task logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/mine-data.md).
