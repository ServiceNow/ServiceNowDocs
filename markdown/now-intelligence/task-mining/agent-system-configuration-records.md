...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/task-mining/agent-system-configuration-records.html
release: australia
product: Task Mining
...
For information about configuration, see [Adjust Task Mining agent parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/set-system-parameters.md).
