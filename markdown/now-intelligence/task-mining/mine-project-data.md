...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/task-mining/mine-project-data.html
release: zurich
product: Task Mining
...
Review your analysis to see whether it needs further refinement. For more information, see [Refine the presentation of your data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/task-mining/preview-data-based-on-categorization-rules.md).
