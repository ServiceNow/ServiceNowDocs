...
# Generate a project data analysis
...
3.  Select **Mine project**.

    If this option isn’t available, be sure the project timeline has started and all data requests have been approved.

4.  Select the **Mining Jobs** tab to monitor the progress of your mining jobs.
