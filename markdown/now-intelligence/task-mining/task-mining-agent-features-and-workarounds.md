...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/task-mining/task-mining-agent-features-and-workarounds.html
release: zurich
product: Task Mining
...
[Install the Task Mining agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/task-mining/install-agent.md)

[Define user actions for task logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/task-mining/mine-data.md)
