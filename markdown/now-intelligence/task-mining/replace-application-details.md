...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/task-mining/replace-application-details.html
release: australia
product: Task Mining
...
The Event Field Replacement Value anonymization value affects the output of this filter. For more information, see [Define Task Mining anonymization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/define-anonymization.md).
