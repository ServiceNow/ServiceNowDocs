...
-   **[Components installed with Task Mining](../reference/installed-with-task-mining.md)**  
...
-   **[Task Mining key terms](../reference/task-mining-key-terms.md)**  
...
-   **[System configuration form in Task Mining](../reference/system-configuration-form.md)**  
Modify configuration records to set up Task Mining. Configuration records can be modified but cannot be added.

**Parent Topic:**[Task Mining](task-mining.md)
