...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/task-mining/reference-task-mining.html
release: zurich
product: Task Mining
...
-   **[Components installed with Task Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/task-mining/installed-with-task-mining.md)**  
...
-   **[Task Mining key terms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/task-mining/task-mining-key-terms.md)**  
...
-   **[System configuration form in Task Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/task-mining/system-configuration-form.md)**  
Modify configuration records to set up Task Mining. Configuration records can be modified but cannot be added.

**Parent Topic:**[Task Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/task-mining/task-mining.md)
