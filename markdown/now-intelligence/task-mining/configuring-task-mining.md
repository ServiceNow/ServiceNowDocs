...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/task-mining/configuring-task-mining.html
release: australia
product: Task Mining
...
-   **[Install Task Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/install-task-mining.md)**

    Install the Task Mining application \(sn\_tm\_core\) if you have the admin role.

-   **[Adjust Task Mining agent parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/set-system-parameters.md)**

    Modify system-level Task Mining agent and system records.

-   **[Define Task Mining anonymization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/define-anonymization.md)**

    Replace personally identifiable information with alias data to protect sensitive user information.

-   **[Customize Task Mining notifications for workstation users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/define-workstation-user-notifications.md)**
...
-   **[Modify the Task Mining data retention period](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/define-data-retention.md)**

    Modify the default retention configuration rules to delete data automatically.

-   **[Avoid capturing and displaying application details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/replace-application-details.md)**
...
-   **[Assign roles for Task Mining users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/task-mining/assign-users.md)**
