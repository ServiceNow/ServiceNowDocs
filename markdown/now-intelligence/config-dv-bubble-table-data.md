...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/config-dv-bubble-table-data.html
release: xanadu
topic_type: reference
last_updated: "2024-08-01"
reading_time_minutes: 3
breadcrumb: [Create a bubble visualization, Data visualizations in Platform Analytics, Platform Analytics]
---
...
You’ve selected a Table data source in [Create a bubble visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-bubble-ac.md).
