...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/proactive-analytics/proactive-analytics.html
release: yokohama
...
-   **Indicator target or threshold event**
    ...
    -   The [threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/performance-analytics-glossary.md) of an indicator is breached. If the breach is an all-time high or low, this fact is mentioned.
    ...
    \[Omitted image "insight-target-suggestion.png"\] Alt text: Suggestion insight to set a target.
...
\[Omitted image "proactive-analytics-view.png"\] Alt text: The dashboard view insights button.
...
\[Omitted image "proactive-analytics-insights-pane.png"\] Alt text: The Dashboard Insights panel showing insights cards. These cards show indicators that have missed their targets.
...
\[Omitted image "db-insight-on-dv.png"\] Alt text: Data visualization showing an insight notification and an action under More Actions to open the Insights and suggestions panel.
...
The Yokohama version of Proactive analytics applies only to Performance Analytics indicators.

Target and threshold events are shown only when a target or threshold has been set on the indicator. For more information, see [Performance Analytics targets and thresholds](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/pa-targets-thresholds.md).

KPI Signals events are shown only for indicators with KPI Signals activated. For more information, see [Activate KPI Signals monitoring for an indicator \(KPI\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/activate-signals-monitor.md).
...
[Create a flow with a Proactive Analytics trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/create-flow-proactive-analytics.md)

[Indicator targets and thresholds in KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/kpi-details-targets.md)
