...
The Xanadu version of Proactive analytics applies only to Performance Analytics indicators.
...
[Create a flow with a Proactive Analytics trigger](https://www.servicenow.com/docs/access?context=create-flow-proactive-analytics&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US)
