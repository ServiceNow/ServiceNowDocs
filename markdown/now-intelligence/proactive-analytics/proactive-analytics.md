...
[Create a flow with a Proactive Analytics trigger](https://www.servicenow.com/docs/access?context=create-flow-proactive-analytics&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US)
