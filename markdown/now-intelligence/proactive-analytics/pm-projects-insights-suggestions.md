...
-   The facts tables for the relevant indicators must be set up to generate audit logs. For more information, see [Configuring auditing for a table](https://www.servicenow.com/docs/access?context=t_EnableAuditingForATable&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
-   A process configuration must exist for the facts tables of the relevant indicators. For more information, see [Create process configuration record for the table](../../../administer/process-mining/task/create-process-config.md).
...
[Dashboards in Platform Analytics](../../performance-analytics/concept/analytics-center-dashboards.md)
