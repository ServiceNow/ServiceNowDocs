...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/proactive-analytics/pm-projects-insights-suggestions.html
release: zurich
...
-   The facts tables for the relevant indicators must be set up to generate audit logs. For more information, see [Configuring auditing for a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/t_EnableAuditingForATable.md).
-   A process configuration must exist for the facts tables of the relevant indicators. For more information, see [Create process configuration using Classic view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/process-mining/create-process-config.md).
...
[Dashboards in Platform Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/analytics-center-dashboards.md)
