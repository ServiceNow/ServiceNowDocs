...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/proactive-analytics/pm-projects-insights-suggestions.html
release: yokohama
...
-   The facts tables for the relevant indicators must be set up to generate audit logs. For more information, see [Configuring auditing for a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/t_EnableAuditingForATable.md).
-   A process configuration must exist for the facts tables of the relevant indicators. For more information, see [Create process configuration using Classic view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/process-mining/create-process-config.md).
...
[Dashboards in Platform Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/analytics-center-dashboards.md)
...
4.  Open the Suggestions tab and review the suggestions.
    ...
    \[Omitted image "insights-suggestions.png"\] Alt text: Suggestions tab in the Insights panel, showing a suggestion.

5.  In each suggestion, select all the indicators for which you want to create Process Mining projects.

    \[Omitted image "insights-selected-suggestions.png"\] Alt text: Suggestion card with an indicator selected.
...
\[Omitted image "insights-promin-project-complete.png"\] Alt text: Suggestion card showing that the suggested project has been run.
