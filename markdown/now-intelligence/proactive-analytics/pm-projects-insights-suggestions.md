...
-   The facts tables for the relevant indicators must be set up to generate audit logs. For more information, see [Configuring auditing for a table](https://www.servicenow.com/docs/access?context=t_EnableAuditingForATable&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
