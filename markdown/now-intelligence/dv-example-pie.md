...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/dv-example-pie.html
release: xanadu
topic_type: task
...
1.  Follow the first steps to [Create a pie or donut visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-donut-ac.md):
