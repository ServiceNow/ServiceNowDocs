...
1.  First you search for **Data Visualizations** in the Unified Navigation and select **New.**
    ...
    ![Opening Data Visualizations in the Platform Analytics library and selecting New.](../image/ts-dv-nav-new-dv.png)
...
12. You find this difficult to read and aren't sure that this is the best visualization to use. After reading [Time series visualization type use cases](../../reporting/reference/time-series-visualization-types.md), you decide to change the visualization to a column display.
