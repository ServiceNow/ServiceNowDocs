...
5.  Select the options for your data source.
    ...
    -   If your visualization represents User Experience Analytics data, go to [User Experience Analytics data options for time series data visualizations](../reference/config-dv-time-series-uxa-data.md).
...
-   **[User Experience Analytics data options for time series data visualizations](../reference/config-dv-time-series-uxa-data.md)**  
