...
-   If there are no "is one of" filter conditions, the first multiple select filter with a selection overrides all others. This includes all other single/multiple select filters and all filter conditions.
