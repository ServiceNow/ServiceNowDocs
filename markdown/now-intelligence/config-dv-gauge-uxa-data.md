...
You have selected a User Experience Analytics data source in [Create a gauge data visualization in the Visualization Designer](../task/create-dv-gauge-ac.md).
