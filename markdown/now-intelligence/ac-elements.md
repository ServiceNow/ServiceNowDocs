---
title: Exploring Platform Analytics dashboards
description: Use Platform Analytics dashboards to access, organize, and share data in a visual format.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/ac-elements.html
release: australia
topic_type: concept
...
For information on role-based access for the filter navigation pane and Platform Analytics overview page, see [Roles applicable for Platform Analytics overview page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/analytics-center.md).

For more information on Dashboards library, see [Dashboards in the library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/find-dashboard-library.md).
...
\[Omitted image "inline-db-components3.png"\] Alt text: Section of a dashboard. Refer to the following list for the descriptions of the components.

<table id="table_exj_dht_k3c"><thead><tr><th>
...
Displays the dashboard title. Select the arrow to choose a different dashboard.
...
Whether the dashboard is company-approved and recommended for use.
...
Terms or phrases that describe one or more dashboard categories. This information is provided by the dashboard creator or the analytics\_categories\_admin.
...
Button for refreshing all the visualizations on the dashboard.
...
Button for viewing the insights cards. For more information, see [Proactive analytics insights on dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/proactive-analytics/proactive-analytics.md).
...
Button for editing the dashboard. Only users with admin roles, edit permissions, and ownership of the dashboard can edit the contents of the dashboard.
...
Elements that are visible no matter which tab has the focus. Filters in this section apply to visualizations on all of the tabs.
...
</table>-   **[Dashboards in the library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/find-dashboard-library.md)**  
...
-   **[Dashboards for analytics admins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/dashboards-for-admin-users.md)**  
Use Platform Analytics dashboards to access, organize, and share data in a visual format. Dashboards contain data visualizations, filters, and other visual elements.
-   **[Dashboard elements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/dashboard-elements.md)**  
...
-   **[Different approaches to dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/approaches-dashboards.md)**  
Depending on your needs, you have four different ways to present a collection of data visualizations and filters.

**Parent Topic:**[Dashboards in Platform Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/analytics-center-dashboards.md)
