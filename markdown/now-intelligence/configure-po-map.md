...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/configure-po-map.html
release: zurich
topic_type: task
...
You should be familiar with Process Mining and Process projects. For more information, see [Process Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/process-mining/process-mining.md).
...
1.  Create a dashboard, or navigate to a dashboard that you are allowed to edit.
    ...
    For more information, see [Create a dashboard with the in-line editor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/create-db-in-ac.md).
...
6.  For the map to follow filters on the dashboard, select **Follow filters**.
    ...
    For more information, see [Applying filters to Process Mining maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/applying-filters-to-process-optimization-maps.md).
