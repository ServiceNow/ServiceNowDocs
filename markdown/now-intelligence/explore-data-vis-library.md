...
description: Find any data visualization in the Platform Analytics Data Visualizations library. Share information about your data with stakeholders and other users to evaluate trends with real-time data. With the appropriate role, you can also create a visualization.
locale: en-US
...
Find any data visualization in the Platform Analytics Data Visualizations library. Share information about your data with stakeholders and other users to evaluate trends with real-time data. With the appropriate role, you can also create a visualization.

## Data Visualizations Library overview

On Brazil instances, you can find both Core UI reports and Platform Analytics experience data visualizations in the Data Visualizations library.
...
-   **Certified**: Visualizations that an administrator has certified. To certify a data visualization, see [Certify a data visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/certify-dv-ac.md).
-   **Owned by me**: Visualizations that you own or you created.
-   **Shared with me**: Visualizations that have been shared with you as a user, member of a group, or role. To share a data visualization, see [Share a data visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/share-dv-ac.md).
