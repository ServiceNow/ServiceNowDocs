...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/cio-db-roles.html
release: australia
...
# Chief Information Officer Dashboard roles

Two roles are associated with this dashboard

## Platform Analytics administrator

The dashboard administrator \(sn\_ciodashboard.ciodashboard\_admin\) is responsible for installing, configuring, and maintaining the CIO Dashboard and its underlying content.
...
The user \(sn\_ciodashboard.ciodashboard\_user\) role is required to access the dashboard.
