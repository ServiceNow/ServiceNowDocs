...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/now-intelligence/add-analytics-center-to-experience.html
release: brazil
topic_type: task
...
Dashboards \(see [Add a dashboard to a Dashboards page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/add-dashboard-to-workspace.md)\)
