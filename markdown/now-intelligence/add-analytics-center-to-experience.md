...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/add-analytics-center-to-experience.html
release: yokohama
topic_type: task
...
3.  Hold your cursor over the Analytics Center template and select **Use template**.
    ...
    \[Omitted image "analytics-center-template.png"\] Alt text: The Analytics Center template selected.
...
8.  Change from the Editor to the Settings view.
    ...
    \[Omitted image "workspace-settings.png"\] Alt text: The Settings button on a UI Builder page.

9.  Select the **General** variant.

    \[Omitted image "general-variant.png"\] Alt text: The General choice in the variants.
...
Dashboards \(see [Add a dashboard to a Dashboards page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/add-dashboard-to-workspace.md)\)
...
**Parent Topic:**[Creating Platform Analytics pages in your own workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/adding-analytics-center-to-ws.md)
