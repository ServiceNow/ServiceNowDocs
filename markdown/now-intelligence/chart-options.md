...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/chart-options.html
release: zurich
...
**Note:** Targets, thresholds, trends, and comments are not supported in KPI Details when indicator scores are aggregated on multiple elements.

-   **Targets**

    Targets are the desired scores for the indicator. Select to show [indicator targets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/kpi-details-targets.md) on the visualization. If no targets are configured on the indicator, this option is not available.
