...
-   **Thresholds**
    ...
    Thresholds define a normal range of scores for an indicator. Select to show [indicator thresholds](../concept/kpi-details-thresholds.md#) on the visualization. If no thresholds are configured on the indicator, this option is not available.
