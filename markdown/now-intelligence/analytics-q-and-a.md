...
You can ask your ServiceNow AI Platform administrator to add synonyms and semantic shortcuts for keywords. For more information, see [Create an NLQ synonym](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/create-nlq-synonym.md) and [Create an NLQ shortcut](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/create-nlq-shortcut.md).
