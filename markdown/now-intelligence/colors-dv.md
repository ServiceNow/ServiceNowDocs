...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/colors-dv.html
release: zurich
topic_type: concept
...
You can create a theme and select it either for a specific user or set it as the default theme for an instance. For more information, see [Working with themes in Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/next-experience-theming.md).
