...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/config-dv-time-series-uxa-data.html
release: xanadu
...
You have selected a User Experience Analytics data source in [Create time series visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-time-series-ac.md).
...
The period by which to aggregate values to calculate the trend.
