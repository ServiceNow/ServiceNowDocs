---
title: User Experience Analytics data options for time series data visualizations
...
# User Experience Analytics data options for time series data visualizations
...
You have selected a User Experience Analytics data source in [Create time series data visualizations](../task/create-dv-time-series-ac.md).
