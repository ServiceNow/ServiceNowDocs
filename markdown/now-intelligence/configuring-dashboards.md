...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/configuring-dashboards.html
release: yokohama
topic_type: concept
...
-   [Change dashboard name or description](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/config-db-in-ac.md)

    Provide an informative description of your dashboard for other users.

-   [Specify dashboard requester](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/config-db-in-ac.md)
...
-   [Transfer ownership of the dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/config-db-in-ac.md)
...
-   [Set the background colors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/configure-ac-db-settings.md)

    Select the background colors for one or more tabs on the dashboard.

-   [See who created the dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/config-db-in-ac.md)
-   [See with whom the dashboard is shared](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/config-db-in-ac.md)

## Admin configuration tasks

The following tasks require at least the dashboard\_admin if not the admin role.

-   [Set data refresh options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/configure-ac-db-settings.md)
...
-   [Certify a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/certify-db-ac.md)

    Certify that a dashboard has been officially approved for use by your organization. Requires the admin role.

-   [Configure Platform Analytics dashboard tab cache timeout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/configure-ac-db-timeout.md)
...
-   [Manage which workspaces are allowed to contain the dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/config-db-in-ac.md)
...
-   [Move a Platform Analytics dashboard with an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/move-pae-db-with-update-set.md)
...
-   [Configure a Process Mining map on a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/configure-po-map.md)
...
-   [Creating Process Mining projects from Proactive Analytics suggestions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/proactive-analytics/pm-projects-insights-suggestions.md)
