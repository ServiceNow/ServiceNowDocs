...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/set-one-pae-db-as-home-for-specified-users.html
release: xanadu
topic_type: task
last_updated: "2025-07-07"
reading_time_minutes: 1
breadcrumb: [Set dashboards as home for all users, Dashboards in Platform Analytics, Platform Analytics experience, Platform Analytics]
---
