...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/set-one-pae-db-as-home-for-specified-users.html
release: australia
topic_type: task
...
6.  In the **Value** field, enter the following: `/now/platform-analytics-workspace/dashboards/params/edit/false/sys-id/dashboard_sys_id`, but replace `dashboard_sys_id` with the sys\_id you copied before you began.
