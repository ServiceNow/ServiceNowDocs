...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/multiple-data-sources.html
release: zurich
...
3.  For the purposes of this example, create a Vertical bar visualization.
    ...
    For more information, see [Create a horizontal or vertical bar data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/create-dv-bar-ac.md).
