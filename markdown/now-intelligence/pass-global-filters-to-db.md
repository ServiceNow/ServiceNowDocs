...
Global filters are sent to the dashboard serve as filters for the visualizations within the dashboard. These filters are merged with existing filters in the dashboard.
...
1.  Navigate to the UI Builder you want to add a global filter to.
