...
Platform Analytics Solutions provide all the configuration records required to analyze default applications. Customize these records for use in your production environment. For more information, see [Configure Platform Analytics Solutions](../../performance-analytics/concept/configure-nowintel-solutions.md).
...
[Activating your Performance Analytics subscription](../../performance-analytics/concept/c_PremiumPerformanceAnalytics.md#)
