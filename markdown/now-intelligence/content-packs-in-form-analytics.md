...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/content-packs-in-form-analytics.html
release: yokohama
topic_type: concept
...
Platform Analytics Solutions provide all the configuration records required to analyze default applications. Customize these records for use in your production environment. For more information, see [Configure Platform Analytics Solutions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/configure-nowintel-solutions.md).

## Required Performance Analytics entitlement

To enable a Platform Analytics solution, an entitlement to use Platform Analytics with the relevant ServiceNow product may be required. Without proper entitlement, it may not be possible to activate the package, or the package will have data range limitations. For example, to enable the Customer Service Management - Advanced Platform Analytics Solution, you must be entitled to use Performance Analytics for Customer Service Management.
...
-   **[Available Platform Analytics Solutions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/r_AvailableContentPacks.md)**  
...
-   **[ServiceNow Store applications with Performance Analytics content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/store-apps-pa-content.md)**  
...
-   **[Install a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/install-content.md)**  
...
-   **[Configure Platform Analytics Solutions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/configure-nowintel-solutions.md)**  
...
-   **[Collect data for Platform Analytics Solutions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/collect-data-nowintel-solutions.md)**  
...
[Activating your Performance Analytics subscription](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/c_PremiumPerformanceAnalytics.md)
