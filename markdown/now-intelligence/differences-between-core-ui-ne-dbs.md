...
Platform Analytics dashboards are created using either UI Builder or the inline dashboard editor. These dashboards support all objects in the element library, such as data visualizations, filters, and rich text. In a tabbed dashboard, these contents can be placed in a tab or above the tabs. [Filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/dashboards-glossary.md) placed above the tabs apply to content on all the tabs.
