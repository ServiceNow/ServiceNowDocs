...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/now-intelligence/install-dashboard-cfo.html
release: brazil
topic_type: task
...
-   Navigate to **CFO Dashboard** &gt; **Dashboard** to view the installed dashboard.
