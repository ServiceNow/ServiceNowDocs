...
In the UI Builder, you can also enable data caching for a local data instance of the table or indicator type. For more information, see [Enable data caching for a local data instance](../../dashboards/task/dv-local-data-instance.md#).
