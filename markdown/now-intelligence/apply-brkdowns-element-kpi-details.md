...
You can select as many breakdowns as the indicator supports. With [breakdown matrix collection](../../performance-analytics/task/create-breakdown-mapping.md#) enabled on the indicator, you can select up to two levels of breakdown. You can select multiple elements on the first breakdown. If the indicator is a formula indicator, breakdown matrix collection must be enabled on the contributing automated indicators.
...
[Performance Analytics breakdowns](../../performance-analytics/concept/c_CreatingBreakdowns.md)
