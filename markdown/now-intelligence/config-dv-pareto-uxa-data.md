...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/config-dv-pareto-uxa-data.html
release: australia
...
You have selected a Usage Insights data source in [Create a horizontal or vertical bar data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/create-dv-bar-ac.md).
