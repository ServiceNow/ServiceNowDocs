...
2.  If you launch AI Data Explorer from a data visualization or list, choose from the following options:
    ...
    -   Select whether to return an extended or a standard analysis. For more information, see [Extended analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/hidden-insights.md).
    ...
    **Important:**
    ...
    -   The table or database view must be included in the Query Generation semantic layer. For more information, see [Add a table to the semantic data layer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/add-table-semantic-layer.md).
