...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/using-kpi-signals.html
release: zurich
topic_type: concept
...
-   **[Reset baseline or dismiss signal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/reset-baseline-dismiss-signal.md)**  
When you get a signal that abnormal variation has occurred, either dismiss the signal or recalculate the parameters.
-   **[Revert baseline reset or signal dismissal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/revert-reset-dismissal.md)**  
