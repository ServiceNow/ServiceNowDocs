...
6.  Configure the data settings as described in [Table data options for boxplot visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/config-dv-box-table-data.md).
...
-   **[Table data options for boxplot visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/config-dv-box-table-data.md)**  
