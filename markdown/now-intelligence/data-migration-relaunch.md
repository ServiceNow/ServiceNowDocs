...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/data-migration-relaunch.html
release: yokohama
topic_type: task
...
Evaluate the newly migrated content. For more information, see [Evaluate full data migration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/data-migration-evaluate.md).
