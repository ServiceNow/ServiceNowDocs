...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/now-intelligence/dv-example-v-bar.html
release: brazil
topic_type: task
...
1.  Follow the first steps to [Create a horizontal or vertical bar data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/create-dv-bar-ac.md):
...
**Parent Topic:**[Bar visualization examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/dv-example-bar.md)
