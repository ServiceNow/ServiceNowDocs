...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/exploring-aide.html
release: australia
topic_type: concept
...
# Understanding AI Data Explorer

AI Data Explorer is your AI companion for instant insights and deep data explorations. Ask quick questions, receive tailored recommendations, and collaborate with AI and your colleagues to build long-term analysis.
...
\[Omitted image "explore-explorer.png"\] Alt text: An exploration in AI Data Explorer.
...
-   \[Omitted image "callout-2.png"\] Alt text: 2 Title and action bar. This section includes the following:
...
-   \[Omitted image "callout-4.png"\] Alt text: 4 Field for adding your own text. See [Write or edit text in an exploration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/write-text-exploration.md).
-   \[Omitted image "callout-5.png"\] Alt text: 5 Follow-on section. Here you can perform a number of actions to follow up on your original question and response:
    ...
    -   Switch between Extended and Standard analysis. Extended analysis provides more detail but is more resource-intensive. For more information, see [Extended analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/hidden-insights.md).
    -   Ask a suggested follow-up question.
    -   Receive AI recommendations of actions to take based on your current exploration. For more information, see [View recommended actions in AI Data Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/expl-view-recommended-actions.md).

## AI Data Explorer users

<table id="table_lzn_bns_w2c"><thead><tr><th>
...
Creates new explorations. Sets the goal of the exploration. Generates the first graphics. Can use the exploration just for themselves, or can invite participants and viewers, who must have access to the data in generated data visualizations.Role required: now\_assist\_explorer\_user or higher.
...
Anyone with whom the exploration is shared with editing rights. Can generate more data visualizations or comment on the exploration. May be able to share the exploration further.Role required: now\_assist\_explorer\_user or higher.
...
Anyone with whom the exploration is shared either without editing rights or without the now\_assist\_explorer\_user role or higher. A viewer cannot ask questions of the AI or add text to the exploration, but they can read it.
...
-   Seamless integration with all applications: Trigger AI Data Explorer from any list or data visualization to ask questions about the data in your experiences.

## What to explore next

To learn more about configuring and using AI Data Explorer, see:

-   [Activate AI Data Explorer skills](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/activate-aide-explorer.md)
-   [Using AI Data Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/use-aide.md)
-   [AI Data Explorer reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/aide-reference.md)
