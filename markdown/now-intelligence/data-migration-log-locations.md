...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/data-migration-log-locations.html
release: xanadu
...
You can view the logs from within the Migration Center or navigate to the associated list to review them.
