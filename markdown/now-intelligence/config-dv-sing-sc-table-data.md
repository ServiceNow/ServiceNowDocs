...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/now-intelligence/config-dv-sing-sc-table-data.html
release: brazil
...
You have selected a Table data source in [Create a single score data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/create-dv-sing-sc-ac.md).
