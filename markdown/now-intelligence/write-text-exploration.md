...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/write-text-exploration.html
release: yokohama
topic_type: task
...
# Write or edit text in an exploration

Edit text that the AI generated, or share your thoughts in AI Data Explorer by adding text to an exploration.

## Before you begin

To access AI writing tools, the refine text in exploration skill must be activated. For more information, see [Activate AI Data Explorer skills](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/activate-now-ass-explorer.md).

Role required: now\_assist\_explorer\_user, and you must own the exploration or have editing rights to it.

To edit the summary of insights that the AI has generated, place the cursor anywhere in the answer and start typing. You can also select all or part of that text and type over it. You have style options for your edits. You can also select the entire summary and have AI shorten it, lengthen it, or change the tone. The AI shows you its modified text, which you can copy and paste or insert below the original.
