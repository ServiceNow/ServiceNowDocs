...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/performance-analytics/t\_GroupDashboards.html
release: xanadu
...
4.  Open the form of the dashboard group to modify its permissions.
    ...
    Dashboard groups use standard platform permissions. For more information, see [Access control list rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/access-control/access-control-rules.md).
