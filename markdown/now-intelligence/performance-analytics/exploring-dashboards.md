...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/performance-analytics/exploring-dashboards.html
release: australia
...
**Important:** Responsive dashboards cannot show Platform Analytics components such as data visualizations. For more information, see [Platform Analytics experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/par-workspace.md).
...
|Create a dashboard to tell a story with current instance data that you can share.|[Create or configure a responsive dashboard in Core UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/performance-analytics/t_CreateADashboard.md)| |
