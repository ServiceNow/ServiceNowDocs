...
Live Group Profile \[live\_group\_profile\] record for a Live Feed group. Specify a group profile to cause that group to get notifications about this indicator.
 ...
 For more information about this social application on the ServiceNow AI Platform, see [Live Feed](https://www.servicenow.com/docs/access?context=c_GetStartedWithLiveFeed&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
