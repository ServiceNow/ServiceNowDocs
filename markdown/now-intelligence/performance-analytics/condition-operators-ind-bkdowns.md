...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/performance-analytics/condition-operators-ind-bkdowns.html
release: zurich
...
**Warning:** To avoid a [data collection job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/performance-analytics-glossary.md) completing with errors, follow these limitations:
