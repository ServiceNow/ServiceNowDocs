...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/performance-analytics/t\_optimizeWidgetRenderingTime.html
release: xanadu
...
<table id="choicetable_txm_hjc_wy"><thead><tr><th align="left" id="d57793e57">

Name

</th><th align="left" id="d57793e60">

Description

</th></tr></thead><tbody><tr><td id="d57793e66">
...
2.  You can also [configure a transaction quota rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/platform-performance/t_ConfigureATransactionQuotaRule.md).
