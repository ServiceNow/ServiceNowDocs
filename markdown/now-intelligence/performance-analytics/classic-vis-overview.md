...
**Note:** For net new instances, reporting, dashboards, and Performance Analytics in the Core UI are replaced in the Zurich release with Platform Analytics experience functionality:
