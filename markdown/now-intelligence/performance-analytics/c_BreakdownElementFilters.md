...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/performance-analytics/c\_BreakdownElementFilters.html
release: australia
...
**Tip:** Use an elements filter with dynamic conditions to create personalized visuals on a widget. For more information, see [Personalized visuals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/performance-analytics/personalized-visuals.md).
...
Use an element filter with dynamic conditions to create personalized visuals on a widget. For more information, see [Personalized visuals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/performance-analytics/personalized-visuals.md).
