...
3.  If you are creating or editing the historic data collection job, follow the procedure in [Create or schedule a data collection job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/performance-analytics/t_CreatASchedDataCollJob.md).
