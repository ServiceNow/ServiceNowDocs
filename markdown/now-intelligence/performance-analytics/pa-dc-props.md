 ...
 **Important:** This property applies only to jobs that use optimized data collection. See [Optimizing data collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/performance-analytics/optimized-data-collection.md).
