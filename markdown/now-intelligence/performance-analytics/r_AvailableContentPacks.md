...
-   Configuration Management \(CMDB\) \(com.snc.pa.cmdb\)
-   Guided Tours dashboard
-   Knowledge Management \(com.snc.pa.knowledge\_v2\)
-   Service Desk Chat \(com.snc.pa.chat\)
...
-   [Self-Service Analytics for Customer Service \(com.snc.pa.self\_service\_analytics\_csm\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/customer-service-management/ssa-cs-content-pack.md)
    ...
    **Note:** To use Performance Analytics with Self-Service Analytics for applications other than Customer Service Management, see .
