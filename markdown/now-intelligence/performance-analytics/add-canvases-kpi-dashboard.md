...
Select from an existing content block. For more information, see [Content blocks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_ContentBlocks.md).
