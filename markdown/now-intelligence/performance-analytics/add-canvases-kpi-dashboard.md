...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/performance-analytics/add-canvases-kpi-dashboard.html
release: yokohama
...
:   [Add tabs and rows to a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/add-tabs-kpi-dashboard.md)
...
Select an existing Performance Analytics widget that matches this mock-up widget. For more information, see [Performance Analytics widgets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/c_Widgets.md).
...
Select from an existing content block. For more information, see [Content blocks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/content-management-system/c_ContentBlocks.md).
...
Select an existing interactive filter. For more information, see [Interactive Filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/core-ui-interactive-filters/c_HomepagePublishers.md)
...
Select an existing Report. For more information, see [Creating reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/reporting/report-types-creation-details-rd.md)
...
Select an existing Spotlight group. For more information, see [Ranking records with Spotlight](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/spotlight/spotlight.md).
...
**Previous topic:**[Add tabs and rows to a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/add-tabs-kpi-dashboard.md)

**Next topic:**[Create a dashboard tab template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/kpi-comp-create-dashboard-template.md)
