...
[Create or update a treemap category \(Security Incident Analytics\)](https://www.servicenow.com/docs/access?context=t_DfnSvcImpctTmapDmn&version=zurich&pubname=zurich-security-management&ft:locale=en-US)
