...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/performance-analytics/enable-real-time-update-single-score-widget.html
release: xanadu
...
**Note:** Real-time updating doesn’t work for single score report widgets on responsive dashboards under the following circumstances:
