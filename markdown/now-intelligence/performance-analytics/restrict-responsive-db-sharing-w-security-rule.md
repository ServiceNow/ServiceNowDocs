...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/performance-analytics/restrict-responsive-db-sharing-w-security-rule.html
release: yokohama
...
Role required: admin. To modify the Access Control List, the admin must elevate to the security\_admin role. For information, see [Elevate to a privileged role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/t_ElevateToAPrivilegedRole.md).
