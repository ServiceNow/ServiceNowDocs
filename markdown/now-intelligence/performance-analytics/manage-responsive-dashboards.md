...
3.  Click the context menu \(![Context menu icon](../image/icon-context-p.png)\) and choose **Delete Dashboard**.
...
To copy a dashboard related to an Platform Analytics Solution, see [Duplicate an Analytics and Reporting Solution dashboard](duplicate-dashboard.md).
...
3.  Select the context menu \(![Context menu icon](../image/icon-context-p.png)\) and select **Duplicate Dashboard**.

    A copy of the dashboard is created with you as the owner. The name of the copy is Copy of \[Original Dashboard Name\].

4.  To rename the dashboard, click the context menu \(![Context menu icon](../image/icon-context-p.png)\), select **Dashboard Properties**, and edit the **Name** field.
...
3.  From the context menu \(![](../image/icon-context-p.png)\), select **Dashboard Properties**.
