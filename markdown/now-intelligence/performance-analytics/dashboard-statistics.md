...
-   The **Dashboard Stats** list enables you to view how often each of your dashboards is run and how long it takes to run them.
-   The [Dashboard executions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/performance-analytics/dashboard-execs.md) list shows how long it takes for your dashboards to load and the ID of the user who launched it.
