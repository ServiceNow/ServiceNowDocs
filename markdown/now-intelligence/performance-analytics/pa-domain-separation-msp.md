...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/performance-analytics/pa-domain-separation-msp.html
release: xanadu
...
**Note:** Performance Analytics domain configurations are enabled with the Performance Analytics – Domain Separation Support plugin. For more information about plugins, see [Activate a Plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/t_ActivateAPlugin.md).
...
-   **[Create a domain configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/create-domain-configuration.md)**  
...
-   **[Associate a domain configuration with a data collection job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/associate-domain-config-dc-job.md)**  
...
-   **[Associate a domain configuration with a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/associate-domain-config-dashboard.md)**  
Display a domain picker on a dashboard to enable users of that dashboard to view scores from specific domains.
-   **[Transfer domain configuration with score aggregation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/transfer-aggregation-domains.md)**  
