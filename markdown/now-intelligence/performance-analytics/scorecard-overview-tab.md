...
**Note:** You can show real-time scores to dashboard users in some widgets. For more information, see [Real-time scores](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/performance-analytics/real-time-scores.md).
...
If the breakdown has an elements filter defined for its breakdown source, you can choose one of those elements filters. For more information, see [Element filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/performance-analytics/c_BreakdownElementFilters.md).
