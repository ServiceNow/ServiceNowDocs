...
-   The indicator is an [automated indicator](https://www.servicenow.com/docs/access?context=now-platform-glossary&version=zurich&pubname=zurich-glossary&section=gloss-automated-indicator&ft:locale=en-US).
-   It is configured to show real-time scores.
-   The aggregate function for the indicator does not use a script.
-   The indicator source does not use a [database view](https://www.servicenow.com/docs/access?context=now-platform-glossary&version=zurich&pubname=zurich-glossary&section=gloss-database-view&ft:locale=en-US).
