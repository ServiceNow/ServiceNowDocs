...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/performance-analytics/c\_ClctData.html
release: xanadu
...
-   **[Collect historical data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/t_RunHistoricalDataCollection.md)**  
...
-   **[Create or schedule a data collection job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/t_CreatASchedDataCollJob.md)**  
Schedule a data collection job to regularly collect Performance Analytics indicator scores and snapshots.
-   **[Configure a job indicator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/configure-job-indicator.md)**  
Increase the efficiency of data collection by configuring job indicators to collect only necessary and sensible data.
-   **[Cancel a data collection job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/cancel-pa-dc-job.md)**  
Cancel an active data collection job to stop the job from collecting scores.
-   **[Add or edit indicator scores manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/t_ManuallyAddingScoresForIndicators.md)**  
