...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/performance-analytics/dependency-assessment-show-used-by.html
release: xanadu
...
1.  [Launch Dependency Assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/launch-dependency-assessment.md) on the Performance Analytics entity you want to investigate.
...
3.  Click the context menu \(\[Omitted image "ContextMenu.png"\] Alt text:\) of the entity and select **Show Used By**.\[Omitted image "launch-bottom-up.png"\] Alt text: context menu option Show Used By to launch bottom-up tree view
...
**Parent Topic:**[Dependency Assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/impact-analysis.md)
