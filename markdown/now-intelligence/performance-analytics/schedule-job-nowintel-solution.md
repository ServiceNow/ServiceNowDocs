...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/performance-analytics/schedule-job-nowintel-solution.html
release: zurich
...
Prerequisites
:   [Run historical data collection for a Platform Analytics Solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/historical-data-nowintel-solution.md)
...
Every Platform Analytics Solution includes a periodic [data collection job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/performance-analytics-glossary.md).
...
3.  Open the periodic data collection job for your Platform Analytics Solution.
    ...
    \[Omitted image "nowintel-solution-active-job.png"\] Alt text: Active checkbox on scheduled job record
...
**Parent Topic:**[Collect data for Platform Analytics Solutions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/collect-data-nowintel-solutions.md)

**Previous topic:**[Run historical data collection for a Platform Analytics Solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/historical-data-nowintel-solution.md)

**Next topic:**[Automation Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/automation-discovery.md)

**Related topics**  


[Create or schedule a data collection job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/t_CreatASchedDataCollJob.md)
