...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/performance-analytics/breakdown-widgets.html
release: xanadu
...
|\[Omitted image "scorecard-icon.png"\] Alt text:|[Scorecard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/create-scorecard-widget.md)|Shows the trends for one breakdown for a single indicator.|
...
|\[Omitted image "relative-compare-icon.png"\] Alt text:|[Relative Compare](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/create-relative-compare-bkdn.md)|Shows how multiple breakdowns diverge over time.|
