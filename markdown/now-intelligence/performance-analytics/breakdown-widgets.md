...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/performance-analytics/breakdown-widgets.html
release: yokohama
...
|\[Omitted image "scorecard-icon.png"\] Alt text:|[Scorecard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/create-scorecard-widget.md)|Shows the trends for one breakdown for a single indicator.|
