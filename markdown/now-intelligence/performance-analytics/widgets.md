...
-   **Content Blocks**
    ...
    Content blocks are pieces of information that you can reuse across your instance. For more information, see [Configure a content block](https://www.servicenow.com/docs/access?context=t_CreateAContentBlock&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
