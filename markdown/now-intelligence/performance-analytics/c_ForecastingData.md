...
<table id="choicetable_jhq_bkr_5xb"><tbody><tr><td id="d235565e308">
...
To show the forecast for an indicator on KPI Details, turn forecasting on in the [Chart options in KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/chart-options.md).
