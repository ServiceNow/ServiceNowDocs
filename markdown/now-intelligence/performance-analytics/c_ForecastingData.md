...
Also in time series data visualizations, you are not limited to forecasts on Performance Analytics indicators. If you have a subscription version of Performance Analytics, you can generate forecasts for any data source except tables. For more information, see [Create time series visualizations](../../reporting/task/create-dv-time-series-ac.md).
...
<table id="choicetable_jhq_bkr_5xb"><tbody><tr><td id="d182048e307">
