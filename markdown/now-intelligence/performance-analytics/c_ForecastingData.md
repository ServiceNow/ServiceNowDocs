...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/performance-analytics/c\_ForecastingData.html
release: zurich
...
1.  Navigate to **Platform Analytics Administration** &gt; **Indicators** &gt; **Automated indicators**.
...
<table id="choicetable_jhq_bkr_5xb"><tbody><tr><td id="d225080e300">
...
To show the forecast for an indicator on KPI Details, turn forecasting on in the [Chart options in KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/chart-options.md).
