...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/performance-analytics/troubleshoot-dashboard-permissions.html
release: yokohama
...
[How dashboard and dashboard group permissions interact on responsive dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/t_GroupDashboards.md)
...
-   RTR = Restrict to Roles
    ...
    For more information, see [Restrict responsive dashboard access to specific roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/restrict-dashboard-access-to-certain-roles.md).
