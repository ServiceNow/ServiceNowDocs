...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/performance-analytics/create-relative-compare-ts.html
release: yokohama
...
\[Omitted image "relative-compare-ts.png"\] Alt text: Visualization comparing the number of open incidents indicator to the Number of open incidents not updated in 5 days indicator
...
<table id="choicetable_pm3_bj1_kt"><thead><tr><th align="left" id="d66618e125">

Option

</th><th align="left" id="d66618e128">

Note

</th></tr></thead><tbody><tr><td id="d66618e134">
...
[Additional settings for time series widgets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/optional-settings-ts-widgets.md)

[Considerations when creating a time series widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/considerations-creating-time-series.md)

[Add widget indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/add-indicators-to-widget.md)
