...
[Zing removes stop words from queries](https://www.servicenow.com/docs/access?context=stop-words-removed-from-queries&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
