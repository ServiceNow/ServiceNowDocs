...
breadcrumb: [Create a breakdown mapping on a breakdown record, Automated breakdowns, Performance Analytics breakdowns, Configuring fundamentals, Performance Analytics \(Indicator data sources\), Platform Analytics]
---
