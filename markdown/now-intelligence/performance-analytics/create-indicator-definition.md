...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/performance-analytics/create-indicator-definition.html
release: zurich
...
<table id="choicetable_tkh_r5y_4jb"><thead><tr><th align="left" id="d164519e272">

Indicator Type

</th><th align="left" id="d164519e275">

Description

</th></tr></thead><tbody><tr><td id="d164519e281">
...
2.  In the Supporting Indicator Definitions related list, click one of the following buttons:
    ...
    -   Click **New** to create a new indicator definition. Follow the same procedure as in [Create an indicator definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/create-indicator-definition.md).
