...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/performance-analytics/set-widget-on-click.html
release: australia
...
**Note:** For equivalent functionality in Platform Analytics data visualizations, see [Chart interactions in a data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/dv-chart-interactions.md).
