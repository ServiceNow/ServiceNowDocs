...
<table id="choicetable_bwt_24j_dbb"><thead><tr><th align="left" id="d113005e276">

Field

</th><th align="left" id="d113005e279">

Description

</th></tr></thead><tbody><tr><td id="d113005e285">

**Facts table**

</td><td>

Specify the facts table and any conditions for filtering the records of that table. You can specify a [database view](performance-analytics-glossary.md#) as the facts table. Remote tables are not supported.

</td></tr><tr><td id="d113005e298">
...
7.  If you select a facts table directly, add **Conditions** that must be fulfilled before the data is included in the subset.
    ...
    **Tip:**
    ...
    For general information about building conditions, see [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
...
13. If you have configured this indicator source to use a business calendar, set the number of periods for retaining scores and snapshots and for finding seasonal patterns.
    ...
    2.  In the **Number of entries to establish seasonality** field, enter the number of time periods, as defined in business calendar or schedule entries, that are necessary to find seasonal patterns.
        ...
        For more information about business calendar entries, see [Creating business calendars](https://www.servicenow.com/docs/access?context=business-calendars&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
[Creating business calendars](https://www.servicenow.com/docs/access?context=business-calendars&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
...
![](../image/ind-source-db-view-where-clause.png)
...
![](../image/ind-source-db-view-table.png)
