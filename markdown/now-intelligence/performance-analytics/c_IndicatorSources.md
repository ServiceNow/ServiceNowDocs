...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/performance-analytics/c\_IndicatorSources.html
release: zurich
...
<table id="choicetable_bwt_24j_dbb"><thead><tr><th align="left" id="d143440e268">

Field

</th><th align="left" id="d143440e271">

Description

</th></tr></thead><tbody><tr><td id="d143440e277">
...
7.  If you select a facts table directly, add **Conditions** that must be fulfilled before the data is included in the subset.
    ...
    **Tip:**
    ...
    For general information about building conditions, see [Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_ConditionBuilder.md).

8.  Define **RELATED LIST CONDITIONS** to include a relationship with another table in the filter.

    For more information, see [Add related list conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/create-related-list-query.md).
...
[Database views](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/c_DatabaseViews.md)
