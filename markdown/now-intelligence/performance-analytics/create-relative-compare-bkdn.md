...
![The number of open incidents for three incident types as a related column visualization](../image/RelativeCompareExample.png "Example of a relative compare visualization")
