...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/performance-analytics/c\_PADataArchitecture.html
release: yokohama
...
-   **[Performance Analytics Admin Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/pa-admin-console.md)**  
...
-   **[Ranking records with Spotlight](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/spotlight/spotlight.md)**  
Use Spotlight to identify and rank records of interest based on multiple weighted criteria.
-   **[Data collection process and logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/data-collection-process-logging.md)**  
...
-   **[Performance Analytics diagnostics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/self-diagnostics.md)**  
...
-   **[Dependency Assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/impact-analysis.md)**  
...
-   **[Cleaning collected Performance Analytics data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/c_CollectionCleanup.md)**  
...
-   **[Migrating indicator scores](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/pa-scores-migration.md)**  
...
-   **[\(Legacy\) Quickly configure Performance Analytics for a task table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/c_ConfigurationGenerator.md)**  
The configuration generator enables you to quickly configure Performance Analytics to display data from any task table.

**Parent Topic:**[Performance Analytics \(Indicator data sources\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown)
