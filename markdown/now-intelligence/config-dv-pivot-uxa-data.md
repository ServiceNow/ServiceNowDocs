---
title: User Experience Analytics data options for pivot table data visualizations
...
# User Experience Analytics data options for pivot table data visualizations
...
You have selected a User Experience Analytics data source in [Create a pivot table data visualization in the Visualization Designer](../task/create-dv-pivot-ac.md).
...
Properties of the User Experience Analytics data source.
