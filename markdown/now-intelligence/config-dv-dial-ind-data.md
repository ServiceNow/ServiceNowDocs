...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/config-dv-dial-ind-data.html
release: xanadu
...
You have selected an indicator data source in [Create a dial visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-dial-ac.md).
