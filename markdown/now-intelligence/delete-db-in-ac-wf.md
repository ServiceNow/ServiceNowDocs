...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/delete-db-in-ac-wf.html
release: xanadu
topic_type: task
last_updated: "2024-08-01"
reading_time_minutes: 1
breadcrumb: [Delete a dashboard, Dashboards in Platform Analytics, Platform Analytics experience, Platform Analytics]
---
...
4.  Select **Add an Action, Flow Logic, or Subflow**.
    ...
    For more information about the available possibilities, see [Flow Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/building-applications/flow-designer.md).
...
6.  Test the flow with the actions that you added.
    ...
    For more information, see [Test a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flow-test.md).
...
For more information, see [Action error evaluation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/action-error-evaluation.md).
