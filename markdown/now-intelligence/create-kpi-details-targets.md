...
3.  To limit the target to a subset of the scores, open the Filter and select a breakdown and a breakdown element. ![Filter icon highlighted on sidebar.](../image/kpi-details-filter-icon.png)
