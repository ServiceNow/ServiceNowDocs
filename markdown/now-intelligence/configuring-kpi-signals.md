...
-   **[Activate KPI Signals monitoring for an indicator \(KPI\)](../task/activate-signals-monitor.md)**  
...
-   **[Configure signal detection](../task/configure-signal-detection.md)**  
...
-   **[Configure signals for breakdown elements](../task/configure-signals-multi-breakdowns.md)**  
