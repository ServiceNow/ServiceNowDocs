...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/activate-now-ass-explorer.html
release: yokohama
topic_type: task
...
4.  In Now Assist skills for Analytics, search for the analytics exploration skill.
    ...
    \[Omitted image "nowass-expl-skills.png"\] Alt text: Now Assist Skills tab of Now Assist Admin console, showing the skills for AI Data Explorer under Platform.
...
6.  Configure the analytics exploration skill.
    ...
    1.  In the **Record level analysis** page, you can activate record-level analysis and set which tables it applies to.
        ...
        For more information, see [Configure record level analysis in AI Data Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/record-level-analysis.md).
...
7.  To enable users to generate recommendations based on the findings in their exploration, turn on the exploration action recommendation skill.
    ...
    \[Omitted image "ai-data-ex-other-skills.png"\] Alt text: Refine text in exploration and Exploration summarization skills.
...
**Parent Topic:**[Configure AI Data Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/configure-now-ass-explorer.md)
