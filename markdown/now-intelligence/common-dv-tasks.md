...
-   **[Edit a data visualization in an inline dashboard](../../dashboards/task/editing-dv-in-line-db.md)**  
...
-   **[Edit a data visualization in the Visualization Designer](../../dashboards/task/edit-dv-ac-center.md)**  
...
-   **[Add a visualization to a dashboard from the Visualization Designer](../task/add-dv-new-db.md)**  
Add a visualization from the Visualization Designer to a new dashboard or to an existing dashboard.
-   **[Duplicate a visualization in the Visualization Designer](../task/duplicate-dv-ac.md)**  
Duplicate a visualization so that you can use aspects of the source in a copy of the visualization.
-   **[Share a data visualization in the Visualization Designer](../task/share-dv-ac.md#)**  
...
-   **[Export a data visualization from the Visualization Designer](../../par-for-workspace/task/export-visualization-vd.md)**  
Export individual data visualizations to various formats and sizes. Download the exports or share them over email.
-   **[Schedule the export of data visualizations or dashboards](../../par-for-workspace/task/schedule-visn-export-vd.md)**  
...
-   **[Delete a visualization in the Visualization Designer](../../dashboards/task/delete-visualization-vd.md)**  
