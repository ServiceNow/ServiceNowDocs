...
6.  Select the options for your data source.
    ...
    -   If your visualization represents User Experience Analytics data, go to [User Experience Analytics data options for pivot table data visualizations](../reference/config-dv-pivot-uxa-data.md).
...
-   **[User Experience Analytics data options for pivot table data visualizations](../reference/config-dv-pivot-uxa-data.md)**  
