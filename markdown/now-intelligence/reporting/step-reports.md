...
For a step line report use case, [Time series visualization example](../../par-for-workspace/task/dv-example-line.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d169243e239">
