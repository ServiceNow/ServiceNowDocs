...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/step-reports.html
release: xanadu
product: Reporting
...
For a step line report use case, [Time series visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/dv-example-line.md).

### About this task

This task refers to the Xanadu release using Core UI.
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d42835e239">
