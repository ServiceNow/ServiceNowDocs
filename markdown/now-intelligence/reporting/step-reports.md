...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/step-reports.html
release: zurich
product: Reporting
...
For a step line report use case, [Time series data visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/dv-example-line.md).

### About this task

This task refers to the Zurich release using Core UI.
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d211376e285">
