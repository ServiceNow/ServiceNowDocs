...
For a step line report use case, [Time series data visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/dv-example-line.md).

### About this task

This task refers to the Brazil release using Core UI.
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d220894e280">
