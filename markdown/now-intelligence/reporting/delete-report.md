...
This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Delete a visualization in the Visualization Designer](../../dashboards/task/delete-visualization-vd.md).
...
3.  When the report opens, click the **Delete** icon \(![Delete icon](../../../common/image/Form_DeleteIcon.png)\).
