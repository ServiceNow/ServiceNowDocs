...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/c\_CreateParetoCharts.html
release: xanadu
product: Reporting
...
**Note:** This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Create a Pareto bar data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-pareto-vd.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d42701e213">
