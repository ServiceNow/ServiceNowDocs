...
**Note:** This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Create a Pareto bar data visualization](../task/create-dv-pareto-vd.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d107000e213">
