...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/c\_CreateParetoCharts.html
release: zurich
product: Reporting
...
**Note:** This topic refers to Reporting in the Core UI. For instances migrated to Platform Analytics experience and new Zurich instances, see [Create a Pareto bar data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/create-dv-pareto-vd.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d135815e261">
