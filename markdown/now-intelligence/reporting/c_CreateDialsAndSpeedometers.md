...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/reporting/c\_CreateDialsAndSpeedometers.html
release: australia
product: Reporting
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d201488e244">
...
Mathematical calculation to perform on the data. The default is **Count**, which shows the number of records selected.To show only unique records, select **Count Distinct**. For example, if you want a report on the distinct number of users who have one or more of the roles in a given list of roles. Users with more than one role would be counted twice unless you use **Count Distinct**.
 ...
 If you choose **Average**,**Sum**, or **Count Distinct**, you may further be able to aggregate on fields from extended tables. See [How to report on extended tables.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/reporting/t_AccessFieldExtendedTable.md)
