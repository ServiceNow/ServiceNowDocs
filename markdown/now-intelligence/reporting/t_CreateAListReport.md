...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d129723e121">
...
</td></tr><tr><td id="d129723e159">

**External import**

</td><td>

Choose an existing imported report source, or select the Upload icon \(![Upload icon](../image/upload-icon.png)\) to import a new file. See [Create a report from an imported Microsoft Excel document](create-report-with-imported-data-source.md).

</td></tr><tr><td id="d129723e184">
...
-   [Configure and use list functions](https://www.servicenow.com/docs/access?context=configure-use-list-functions&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)
