...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d154623e167">
...
-   [Configure and use list functions](https://www.servicenow.com/docs/access?context=configure-use-list-functions&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
