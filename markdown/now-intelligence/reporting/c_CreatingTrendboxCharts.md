...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/now-intelligence/reporting/c\_CreatingTrendboxCharts.html
release: brazil
product: Reporting
...
\[Omitted image "trendbox-report.png"\] Alt text: Trendbox report

## About trendbox reports

Each box in a trendbox report displays the following information for each group of data:

\[Omitted image "BoxChartScale.png"\] Alt text: Trendbox report components with numbers 1-6 explained in the associated table.
...
**Note:** When accessibility is enabled, this visualization includes a report that screen readers can interpret. For more information, see [Enabling accessibility features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_SetUpSect508ComplianceFeature.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d33384e356">
