...
For more information, see [Lists in the classic environment](https://www.servicenow.com/docs/access?context=c_UseLists&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
