...
To correct this issue, the owner of the report \(or an administrator\) can share that report with the individuals who should have visibility and access to that report. You can share a report directly from the report's sharing icon. For more information, see [Share a report](../task/t_ShareASetting.md).
