...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d162722e238">
...
Select a field to report against. The values from this field appear on the X axis of the histogram and determine the width of the bars. Select the info icon \(![Info icon](../../par-for-workspace/image/icon-info.png)\) for a description of the selected field.
