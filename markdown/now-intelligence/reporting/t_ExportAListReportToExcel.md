...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/t\_ExportAListReportToExcel.html
release: xanadu
product: Reporting
...
This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Export a visualization from the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/export-visualization-vd.md).
