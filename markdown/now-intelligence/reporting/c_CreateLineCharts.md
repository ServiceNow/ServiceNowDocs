...
![Line report](../image/LineChart.png "Line report")
...
For a line report use case, [Time series visualization example](../../par-for-workspace/task/dv-example-line.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d137255e227">
...
Calendar that is the basis for the time series in the report. Select either the standard calendar or a [customized business calendar](https://www.servicenow.com/docs/access?context=business-calendars&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
