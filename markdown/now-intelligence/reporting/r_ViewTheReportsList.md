...
Navigate to **All** &gt; **Reports** &gt; **View / Run** to open the Reports list. Select the gear icon \(![Gear icon](../../performance-analytics/image/Cogwheel.png)\) next to the **Create a report** button to configure the columns displayed in the Reports list.
...
To turn off the automatic marking of reports as favorites, disable the user preference glide.ui.nav.auto\_favorite. For more information, see [User preferences](https://www.servicenow.com/docs/access?context=c_UserPreferences&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US) .
...
3.  Select the gear icon ![Gear icon](../../performance-analytics/image/Cogwheel.png) to show the List Configuration menu.

4.  Turn on the **Created by** option.

    ![Animation showing how to add the Created by column to a list of report visualizations](../image/show-reported-created-by.gif)
...
Enables you to filter on any condition in platform condition builder format. For example, `https://yourbusiness.service-now.com/report_home.do?sysparm_query=titleSTARTSWITHPRB&table!=incident`. For more information, see [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
