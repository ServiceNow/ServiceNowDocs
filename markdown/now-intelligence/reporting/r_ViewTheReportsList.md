...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/reporting/r\_ViewTheReportsList.html
release: yokohama
product: Reporting
...
To turn off the automatic marking of reports as favorites, disable the user preference glide.ui.nav.auto\_favorite. For more information, see [User preferences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/c_UserPreferences.md) .
...
3.  Select the gear icon \[Omitted image "Cogwheel.png"\] Alt text: Gear icon to show the List Configuration menu.

4.  Turn on the **Created by** option.

    \[Omitted image "show-reported-created-by.gif"\] Alt text: Animation showing how to add the Created by column to a list of report visualizations
