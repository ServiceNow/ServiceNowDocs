...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/t\_AccessFieldExtendedTable.html
release: xanadu
product: Reporting
...
5.  Click the filter icon \(\[Omitted image "icon-filter.png"\] Alt text:\) to open the Condition Builder.
...
[Dot-walking examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/dot-walking-examples.md)
