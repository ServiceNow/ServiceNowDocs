...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/create-list-rep-with-question-col.html
release: xanadu
product: Reporting
...
7.  Click the structure icon \(\[Omitted image "Form\_ShowReportStructureIcon.png"\] Alt text:\) to choose an item.
