...
This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Data visualizations in Platform Analytics](../../performance-analytics/concept/analytics-center-data-visualizations.md).

## Procedure

1.  Follow one of these paths.

<table id="choicetable_urt_hlc_5w"><tbody><tr><td id="d158405e81">
...
Info \(![](../../../common/image/Form_ReferenceLookupIcon.png)\)
...
Sharing \(![](../../../common/image/Form_ShareIcon.png)\)
...
Enables you to set the visibility of the report. Options are **Me**, **Everyone**, and **Groups and Users**. See [Share a report](t_ShareASetting.md) for more information on sharing.This option is available from the Sharing icon \(![](../../../common/image/Form_ShareIcon.png)\).
...
Delete \(![](../../../common/image/Form_DeleteIcon.png)\)
