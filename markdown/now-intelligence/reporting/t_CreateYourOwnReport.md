...
**Note:** On net new Zurich instances, only users with the report\_admin role can create reports. To visualization your information in these instances, or if your instance is migrated to Platform Analytics experience, see [Creating data visualizations](../concept/creating-data-visualizations.md).

## Procedure

1.  Follow one of these paths.

<table id="choicetable_urt_hlc_5w"><tbody><tr><td id="d189242e82">
