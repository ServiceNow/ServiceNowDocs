...
This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Create a heatmap visualization in the Visualization Designer](../task/create-dv-heatmap-ac.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d178090e208">
...
Field used as the source of the data for the rows in the heatmap. To select a source field on an extended table, see [How to report on extended tables.](../task/t_AccessFieldExtendedTable.md#) Select the info icon \(![](../image/icon-info.png)\) for a description of the selected field.
...
Field used as the source of the data for the columns in the heatmap. To select a source field on an extended table, see [How to report on extended tables.](../task/t_AccessFieldExtendedTable.md#) Select the info icon \(![](../image/icon-info.png)\) for a description of the selected field.
