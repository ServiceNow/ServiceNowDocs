...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/t\_ShareASetting.html
release: zurich
product: Reporting
...
This topic refers to Reporting in the Core UI. If your instance is a Zurich release or migrated to Platform Analytics experience, see [Share a data visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/share-dv-ac.md).
...
5.  Share the dashboard or share the URL of the published report.
    ...
    **Danger**
    ...
    This functionality is deactivated by default because of the risk of exposing data to unauthorized persons. For more information, see [\(Legacy\) Publish a report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/reporting/t_PublishAReport.md).
