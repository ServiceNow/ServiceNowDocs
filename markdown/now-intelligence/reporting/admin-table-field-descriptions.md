...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/admin-table-field-descriptions.html
release: xanadu
product: Reporting
