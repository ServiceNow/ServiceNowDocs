---
title: Create a report from an imported Microsoft Excel document
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/create-report-with-imported-data-source.html
release: xanadu
product: Reporting
...
**Note:** Report\_view access control lists \(ACLs\) have to be defined for users to view these reports. For more information, see [Report\_view access control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/report-view-access-control.md).
...
4.  Choose an existing imported report source, or select the **Upload** icon \(\[Omitted image "upload-icon.png"\] Alt text:\) icon to import a file.
...
9.  Create report\_view ACLs for the table you created when you uploaded the external data in Step 4.
    ...
    5.  Create report\_view ACLs for roles that you want to be able to read the report, as described in [Report\_view access control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/report-view-access-control.md).
...
Share the report, as described in [Distribute reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/c_DistributeReports.md).

-   **[Edit an imported data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/edit-config-external-data-source.md)**  
