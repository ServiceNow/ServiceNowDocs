...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/reporting/fx-currency-values-reporting.html
release: yokohama
product: Reporting
...
-   **Use FX currency configuration**
    ...
    Calculates the values based on the FX Currency Configuration table. For more information, see [Setting up and operating FX Currency fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/fx-currency.md).
...
2.  On the **Data** tab, name the report, choose the source table with FX currency fields, and then click **Next**.
    ...
    The source must have FX Currency fields. See [Setting up and operating FX Currency fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/fx-currency.md).
