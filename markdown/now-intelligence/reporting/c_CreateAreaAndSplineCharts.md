...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/c\_CreateAreaAndSplineCharts.html
release: zurich
product: Reporting
...
For an area report use case, [Time series data visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/dv-example-line.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d110356e297">
...
6.  On the **Type** tab, enter **Area** or **Spline** in the filter, select the report type, and click **Next**.
