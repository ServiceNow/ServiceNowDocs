...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/c\_CreateAreaAndSplineCharts.html
release: xanadu
product: Reporting
...
For an area report use case, [Time series visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/dv-example-line.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d42848e249">
