...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/reporting/c\_CreateAreaAndSplineCharts.html
release: australia
product: Reporting
...
For an area report use case, [Time series data visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/dv-example-line.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d113322e280">
