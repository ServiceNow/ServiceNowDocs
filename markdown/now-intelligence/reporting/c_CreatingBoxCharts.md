...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/c\_CreatingBoxCharts.html
release: xanadu
product: Reporting
...
**Note:** This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Create a box plot data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-box-plot.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d43021e243">
...
Field to use as a measurement for the data. Date and time fields are not supported for box charts. Select the info icon \(\[Omitted image "icon-info.png"\] Alt text:\) for a description of the selected field.
