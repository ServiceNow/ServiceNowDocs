...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/create-report-with-metricbase-data.html
release: xanadu
product: Reporting
...
6.  On the **Type** tab, select the type of report to create and click **Next**.
    ...
    Only time series reports are available. For information on specific reports types, see [Report types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/report-types-creation-details-rd.md). To view the updated report, click **Run**.
...
For more information, see [MetricBase transforms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/metricbase-transforms.md).
...
</table>8.  To limit the information displayed in the report, select the filter icon \(\[Omitted image "List\_FilterIcon.png"\] Alt text:\) and specify conditions to filter the report data.
...
9.  On the **Style** tab, fill in the fields as appropriate to configure the appearance of the report.
    ...
    -   [Area and spline report style options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/c_CreateAreaAndSplineCharts.md)
    -   [Line report style options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/c_CreateLineCharts.md)
    -   [Step line report style options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/step-reports.md)
...
-   **[MetricBase transforms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/metricbase-transforms.md)**  
