...
-   **[Drilling down within reports](c_DrillingDownWithinReports.md#)**  
...
-   **[Set the on-click behavior of a report](../task/set-report-on-click.md)**  
...
-   **[Using multiple datasets in a report](c_MultipleDataSets.md#)**  
You can create reports that use datasets from up to five tables in a single report.
-   **[Create a report from an imported Microsoft Excel document](../task/create-report-with-imported-data-source.md)**  
...
-   **[Create reports from MetricBase time-series data](../task/create-report-with-metricbase-data.md)**  
...
-   **[Report on service catalog variables](rep-service-catalog-variables.md)**  
Create reports grouped by a variable on a selected service catalog item. You can also create filters on the same variable.
-   **[Report on function fields](function-fields-reporting.md)**  
...
-   **[Report on questions](report-on-questions.md#)**  
Report on selected questions by grouping or filtering on them.
-   **[Predefined colors in reports](colors-reports.md)**  
