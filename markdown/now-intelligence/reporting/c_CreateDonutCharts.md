...
This data visualization is supported on the mobile platform. For more information, see Donut reports for mobile and Mobile dashboard preview.
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d214834e246">
