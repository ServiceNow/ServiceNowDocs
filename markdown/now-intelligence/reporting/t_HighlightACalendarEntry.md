...
[Define field styles](https://www.servicenow.com/docs/access?context=t_DefineFieldStyles&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) for the appropriate table.
...
2.  Filter the list to show the tables you want to address and then group the result by field name.
    ...
    ![](../image/filter-field-styles-table.gif)
