...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/c\_CreateTrendCharts.html
release: zurich
product: Reporting
...
Users with the report\_admin role can define the ranges that are used in a trend chart report. See [Report ranges](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/reporting/c_ReportRanges.md) for information on creating report ranges.
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d106876e221">
...
6.  On the **Type** tab, enter **Trend** in the filter, select the Trend report type from the **Other** section, and click **Next**.
