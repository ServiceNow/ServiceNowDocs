...
To create a report\_view ACL, follow the [general procedure for creating an ACL rule](https://www.servicenow.com/docs/access?context=t_CreateAnACLRule&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US), but bearing the following points in mind:
