...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/report-view-access-control.html
release: xanadu
product: Reporting
...
To create a report\_view ACL, follow the [general procedure for creating an ACL rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/access-control/t_CreateAnACLRule.md), but bearing the following points in mind:
...
-   **[Report execution security](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/read-access-control.md)**  
