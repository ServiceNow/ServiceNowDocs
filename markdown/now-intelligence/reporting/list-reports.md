...
-   This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Create a simple list visualization in the Visualization Designer](../task/create-dv-simple-list-ac.md).
