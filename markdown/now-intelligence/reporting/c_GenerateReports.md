...
**Note:** When Next Experience is enabled, you can create reports in Report Designer and [create data visualizations in the Analytics Center](../../performance-analytics/concept/analytics-center-data-visualizations.md). For more information on Report Designer, see [Create a report](../task/t_CreateYourOwnReport.md#).

On net new Xanadu instances and instances migrated to Platform Analytics experience, Reporting functionality is replaced with Data Visualizations. For more information, see [Data visualizations in Platform Analytics](../../performance-analytics/concept/analytics-center-data-visualizations.md).
...
-   **[Run a report](../task/t_RunAReport.md#)**  
