...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/reporting/single-score-report-coloring-rules.html
release: yokohama
product: Reporting
...
See [Single score visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/dv-example-single-score.md) for example steps to implement a coloring rule.
