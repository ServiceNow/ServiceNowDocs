...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/single-score-report-coloring-rules.html
release: xanadu
product: Reporting
...
See [Single score visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/dv-example-single-score.md) for example steps to implement a coloring rule.
