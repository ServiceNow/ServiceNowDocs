...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/create-function-field.html
release: zurich
product: Reporting
...
9.  Select the fields that the function operates on.
    ...
    Some functions require only one field; some require two or three fields. See [Report on function fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/reporting/function-fields-reporting.md). Make sure that you separate the fields with commas.
