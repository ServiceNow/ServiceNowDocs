...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/c\_CreateBarCharts.html
release: xanadu
product: Reporting
...
**Note:** Vertical bar reports are supported on the mobile platform. For more information, see [Bar reports for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/mobile/mobile-platform/mobile-reporting-bar.md) and [Mobile dashboard preview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/mobile/mobile-platform/mobile-dashboard-preview.md).

This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Create a horizontal or vertical bar data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-bar-ac.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d42703e241">
