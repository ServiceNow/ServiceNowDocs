...
|-------|-------|-----|
|Run a report to view current data in an existing report.|[Run a report](../../reporting/task/t_RunAReport.md#)|itil, report\_user, report\_group, report\_global, report\_admin, or admin|
