...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/reporting/service-portal-reporting-widget.html
release: yokohama
product: Reporting
...
With the report widget, you can show all report types on your portal except for list reports. Use the [Simple List Widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/simple-list-widget.md) instead.
