...
With the report widget, you can show all report types on your portal except for list reports. Use the [Simple List Widget](https://www.servicenow.com/docs/access?context=simple-list-widget&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US) instead.
