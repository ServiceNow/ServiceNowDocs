...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/c\_BubbleCharts.html
release: xanadu
product: Reporting
...
This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Create a bubble visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-bubble-ac.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d42899e215">
...
Field to group data by. Each value is represented by a unique bubble color on the chart. Select the info icon \(\[Omitted image "icon-info.png"\] Alt text:\) for a description of the selected field.
...
Numeric field to use as the Y axis. Select the info icon \(\[Omitted image "icon-info.png"\] Alt text:\) for a description of the selected field.
...
Numeric field to use as the X axis. Select the info icon \(\[Omitted image "icon-info.png"\] Alt text:\) for a description of the selected field.
...
9.  On the **Style** tab, fill in the fields as appropriate to configure the appearance of the report.
    ...
    See [Bubble report style options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/c_BubbleCharts.md).
