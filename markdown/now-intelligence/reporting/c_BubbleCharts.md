...
This topic refers to Reporting in the Core UI. For instances migrated to Platform Analytics experience and new Zurich instances, see [Create a bubble data visualization in the Visualization Designer](../task/create-dv-bubble-ac.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d161487e263">
...
Field to group data by. Each value is represented by a unique bubble color on the chart. Select the info icon \(![Info icon](../../par-for-workspace/image/icon-info.png)\) for a description of the selected field.
...
Numeric field to use as the Y axis. Select the info icon \(![Info icon](../../par-for-workspace/image/icon-info.png)\) for a description of the selected field.
...
Numeric field to use as the X axis. Select the info icon \(![Info icon](../../par-for-workspace/image/icon-info.png)\) for a description of the selected field.
