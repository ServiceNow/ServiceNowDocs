...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/c\_BubbleCharts.html
release: zurich
product: Reporting
...
This topic refers to Reporting in the Core UI. For instances migrated to Platform Analytics experience and new Zurich instances, see [Create a bubble data visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/create-dv-bubble-ac.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d165528e263">
...
6.  On the **Type** tab, enter **Bubble** in the filter, select the report type, and click **Next**.
...
10. On the **Style** tab, fill in the fields as appropriate to configure the appearance of the report.
    ...
    See [Bubble report style options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/reporting/c_BubbleCharts.md).
