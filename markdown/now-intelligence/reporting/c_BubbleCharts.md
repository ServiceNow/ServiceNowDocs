...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/reporting/c\_BubbleCharts.html
release: australia
product: Reporting
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d175020e223">
...
8.  On the **Style** tab, fill in the fields as appropriate to configure the appearance of the report.
    ...
    See [Bubble report style options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/reporting/c_BubbleCharts.md).
