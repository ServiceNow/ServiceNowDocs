...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/perform-report-view-acl-assessment-scan.html
release: xanadu
product: Reporting
...
1.  Elevate your role to security\_admin.
    ...
    For more information, see [Elevate to a privileged role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/servicenow-ai-platform-security/t_ElevateToAPrivilegedRole.md).
...
5.  Navigate to **All** &gt; **Reports** &gt; **ACL Assessment for Reports** &gt; **Affected Reports List** to [view the list of impacted reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/view-impacted-reports.md).
