...
**Note:** Importing report data in this way is useful when you have information that is maintained outside of your instance. To import an external data set into your instance permanently, see [Easy import](https://www.servicenow.com/docs/access?context=c_EasyImport&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
