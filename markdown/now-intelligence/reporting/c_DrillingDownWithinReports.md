...
**Note:** This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Chart interactions in a data visualization](../../par-for-workspace/concept/dv-chart-interactions.md).
...
4.  Click the Add drilldown icon \(![Plus sign button](../../dashboards/image/AddWidgetButton.png)\).
