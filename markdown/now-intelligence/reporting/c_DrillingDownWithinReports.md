---
title: Drilling down within reports
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/reporting/c\_DrillingDownWithinReports.html
release: yokohama
product: Reporting
...
**Note:** This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Chart interactions in a data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/dv-chart-interactions.md).
...
6.  Select the report **Type** to display the data and click **Next**.
    ...
    See [Report types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/reporting/report-types-creation-details-rd.md). The drilldown report type can be different than the parent report.
