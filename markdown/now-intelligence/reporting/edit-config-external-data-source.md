...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/edit-config-external-data-source.html
release: xanadu
product: Reporting
...
**Parent Topic:**[Create a report from an imported Microsoft Excel document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/create-report-with-imported-data-source.md)
