...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/reporting/c\_PivotTables.html
release: zurich
product: Reporting
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d173693e245">
...
10. On the **Style** tab, fill in the fields as appropriate to configure the appearance of the report.
    ...
    See [Pivot report style options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/reporting/c_PivotTables.md).
