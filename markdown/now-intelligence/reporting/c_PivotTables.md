...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d140025e203">
...
Select one field for the chart rows. The chart displays data broken down by a combination of row and column values. To select a source field on extended table, see [How to report on extended tables.](../task/t_AccessFieldExtendedTable.md#) Select the info icon \(![](../image/icon-info.png)\) for a description of the selected field.
...
Select one field for the chart columns. The chart displays data broken down by a combination of row and column values. To select a source field on an extended table, see [How to report on extended tables.](../task/t_AccessFieldExtendedTable.md#) Select the info icon \(![](../image/icon-info.png)\) for a description of the selected field.
