...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/c\_PivotTables.html
release: xanadu
product: Reporting
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d43118e203">
...
9.  On the **Style** tab, fill in the fields as appropriate to configure the appearance of the report.
    ...
    See [Pivot report style options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/c_PivotTables.md).
