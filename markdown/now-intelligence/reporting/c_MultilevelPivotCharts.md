...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/reporting/c\_MultilevelPivotCharts.html
release: xanadu
product: Reporting
...
You can also create multilevel pivot tables with columns and rows containing variables. See [Use service catalog variables in a report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/use-service-catalog-variables-in-report.md).
...
-   This topic refers to Reporting in the Core UI. If your instance is migrated to Platform Analytics experience, see [Create a pivot table visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-pivot-ac.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d42873e224">
...
One or more fields to use as chart columns. The chart displays data broken down by a combination of row and column values. You can select up to three columns. Click the info icon \(\[Omitted image "icon-info.png"\] Alt text:\) for descriptions of the selected fields
...
One or more fields to use as chart rows. The chart displays data broken down by a combination of row and column values. You can select up to five rows. Click the info icon \(\[Omitted image "icon-info.png"\] Alt text:\) for descriptions of the selected fields
...
7.  Select **Default expanded** to display the report with the rows expanded.
...
8.  Check **Display row lines** and **Display column lines** to show the lines that separate the cells in the report.

    \[Omitted image "multilevel-pivot-with-row-column-lines.png"\] Alt text: Multilevel pivot report with row and column lines

9.  Configure the sort order of the applicable fields in the report \(column, row, Group by, Stack by or Trend by depending on the report type\).
...
10. To limit the information displayed in the report, select the filter icon \(\[Omitted image "List\_FilterIcon.png"\] Alt text:\) and specify conditions to filter the report data.
...
12. Select **Save** to continue editing the visualization, or **Save and close** to return to the Analytics Center main screen.
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d42873e916">
...
7.  Select variables to use as columns:
    ...
    4.  Move the selected variables to the **Selected** column and click **OK**. Click the info icon \(\[Omitted image "icon-info.png"\] Alt text:\) for descriptions of the selected fields

8.  Click **Select rows** to select one or more fields to use as report rows.

    You select rows similarly to how you select columns. Click the info icon \(\[Omitted image "icon-info.png"\] Alt text:\) for descriptions of the selected fields.
...
12. To limit the information displayed in the report, select the filter icon \(\[Omitted image "List\_FilterIcon.png"\] Alt text:\) and specify conditions to filter the report data.
...
13. On the **Style** tab, fill in the fields as appropriate to configure the appearance of the report.
    ...
    See [Multilevel pivot report style options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/reporting/c_MultilevelPivotCharts.md).
