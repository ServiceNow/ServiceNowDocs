...
-   This topic refers to Reporting in the Core UI. For instances migrated to Platform Analytics experience and new Australia instances, see [Create a pivot table data visualization in the Visualization Designer](../task/create-dv-pivot-ac.md).
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d198642e249">
...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d198642e916">
