...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/now-intelligence/reporting/rep-service-catalog-variables.html
release: brazil
product: Reporting
...
-   To group by variables, see [Group a report by service catalog variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/reporting/group-rep-service-catalog-variables.md).
-   To group a report on a field and also group by a variable, see [Add additional group by variables to a service catalog report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/reporting/add-addl-group-svc-cat-var-report.md).
-   To add a variable field to a list report, see [Create a list report with variable columns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/reporting/create-list-rep-with-var-col.md).

For reporting on variable questions, see: [Report on questions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/reporting/report-on-questions.md)

-   **[Use service catalog variables in a report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/reporting/use-service-catalog-variables-in-report.md)**  
...
-   **[Group a report by service catalog variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/reporting/group-rep-service-catalog-variables.md)**  
...
-   **[Add additional group by variables to a service catalog report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/reporting/add-addl-group-svc-cat-var-report.md)**  
