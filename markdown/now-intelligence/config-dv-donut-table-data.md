...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/config-dv-donut-table-data.html
release: australia
...
You have selected a Table data source in [Create a pie or donut data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/create-dv-donut-ac.md).
