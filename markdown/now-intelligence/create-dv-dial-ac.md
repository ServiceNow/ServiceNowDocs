...
6.  Select the options for your data source.
    ...
    -   If your visualization represents Usage Insights data, go to [Usage Insights data options for dial data visualizations](../reference/config-dv-dial-uxa-data.md).
...
-   **[Usage Insights data options for dial data visualizations](../reference/config-dv-dial-uxa-data.md)**  
