...
You have selected an Indicator or User Experience Analytics data source in [Create a horizontal or vertical bar data visualization](../task/create-dv-bar-ac.md).
