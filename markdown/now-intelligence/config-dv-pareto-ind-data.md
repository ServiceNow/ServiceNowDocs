...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/config-dv-pareto-ind-data.html
release: xanadu
topic_type: reference
last_updated: "2024-08-01"
reading_time_minutes: 4
breadcrumb: [Pareto bar visualizations, Data visualizations in Platform Analytics, Platform Analytics]
---
...
You have selected an Indicator or User Experience Analytics data source in [Create a horizontal or vertical bar data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-bar-ac.md).
