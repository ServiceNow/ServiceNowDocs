...
Zero Copy Connector Hub provides a view where you can browse data sources, establish connections, and create data fabric tables that provide access to data from external sources. Workflow Data Fabric tables are found in the same list as other tables when you create a visualization. For more information, see [Workflow Data Fabric Home](https://www.servicenow.com/docs/access?context=wdf&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
