...
**Note:** If you have the latest Data Visualizations application installed from the ServiceNow Store, you have the option to hide both X and Y axes in any bar visualization.
