---
title: Table data options for gauge data visualizations
description: When you select a table data source for a gauge visualization, the following Data configuration options are available.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/config-dv-gauge-table-data.html
release: australia
...
You have selected a Table data source in [Create a gauge data visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/create-dv-gauge-ac.md).
...
</table>**Parent Topic:**[Create a gauge data visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/create-dv-gauge-ac.md)
