...
You have several options for filtering what appears in the library. The numbered callouts in [Default indicator library view with basic functionality](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/your-kpis.md) match the numbers in the following list:
...
Press **Check instance eligibility** to see if your instance is eligible for Data snapshots and, if not, why. For more information, see [Activate Data snapshots](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/performance-analytics/activate-unlimited-breakdowns.md).
