...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/customize-entity-descriptions.html
release: zurich
topic_type: task
...
2.  Open the record for your table, or create a record if one does not exist.
    ...
    If creating a new record, set **Table Name** to your table name and **Enable Semantic Generation** to selected. For more information, see [Add a table to the semantic data layer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/add-table-semantic-layer.md).
...
**Parent Topic:**[Customizing semantic metadata](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/customize-semantic-metadata.md)
