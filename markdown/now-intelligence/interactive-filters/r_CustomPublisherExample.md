...
[Configure a content block](https://www.servicenow.com/docs/access?context=t_CreateAContentBlock&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)

[UI scripts](https://www.servicenow.com/docs/access?context=c_UIScripts&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US)
...
2.  Click the add content icon \(![](../image/icon-add-user-db.png)\).
...
<table id="choicetable_qnn_gnq_bvb"><tbody><tr><td id="d35669e465">
