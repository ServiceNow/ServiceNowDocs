...
2.  Open a new Improvement Initiative form one of the following ways:
    ...
    1.  Select the Initiatives icon \(![](../image/improve-initiative-icon.png)\).
...
3.  Fill in the form fields.
    ...
    For more information the fields, see: [Create an improvement initiative](https://www.servicenow.com/docs/access?context=create-cim-request&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
