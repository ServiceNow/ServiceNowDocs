...
5.  Add notes to the project by selecting the notes icon \(![](../image/notes-icon.png)\) and submit an analysis.
...
[Process Mining for Field Service Management](https://www.servicenow.com/docs/access?context=process-opt-fsm&version=xanadu&pubname=xanadu-field-service-management&ft:locale=en-US)
