...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/process-mining/create-project.html
release: xanadu
...
5.  Add activity definitions to the project.
    ...
    For information, see [Scoping your analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/scope-analysis.md)
...
9.  Create improvement opportunities if required.
    ...
    For information, see [Set improvement opportunities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/improve-opportunities.md).

10. Review and mine the project.

    For information, see [Review and mine your project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/review-mine.md).
