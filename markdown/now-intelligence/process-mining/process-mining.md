...
-   View activity transitions to see the top contributing activity transitions across specific metrics. For more information see, [Apply a transition filter on an activity](../task/node-to-node-conditions.md)
