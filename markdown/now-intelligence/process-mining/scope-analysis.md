...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/now-intelligence/process-mining/scope-analysis.html
release: brazil
...
You’ve selected the table from where you want to view data. You probably want to focus on one aspect of the data. The filters that display only the data you want to view in the graph sets the scope of your project.

The following sections have the details.

-   **[Set filter conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/filter-conditions.md)**  
Set filter conditions to limit the scope of your analysis.
-   **[Set activity definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/set-activity-def.md)**  
...
-   **[Set metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/metrics.md)**  
