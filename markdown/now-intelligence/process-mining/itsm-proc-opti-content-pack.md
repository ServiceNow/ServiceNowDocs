...
To enable this content pack, go to the ServiceNow Store. For more detail, see [Activate Process Mining content packs](po-content-pack.md).
...
-   **[Configure insights for ITSM work items in the Process Mining dashboard](../task/configure-insights-itsm-po.md)**  
