...
-   **[Configure ping-pong finding definition](../task/automated-builder.md)**  
...
-   **[Configure extra step finding definition](../task/extra-step.md)**  
Configure an extra-step finding definition to view a pattern where routes differ by one additional step.
-   **[Configure slow transitions](../task/slow-transitions.md)**  
...
-   **[Configure extreme duration finding definition](../task/extreme-duration.md)**  
...
-   **[Configure extreme repetitions finding definition](../task/extreme-repetitions.md)**  
...
-   **[Configure repeating pattern finding definition](../task/repeating-pattern.md)**  
Configure a repeating pattern finding definition to view a pattern with a series of repeating sequence of steps.
-   **[Configure rework finding definition](../task/rework.md)**  
Configure a rework finding definition to view a pattern where a step in the process is repeated.

**Parent Topic:**[Setting improvement opportunity from Project Builder](setting-impr-opp-proj-build.md)
