...
You must install and configure the Automation Center plugin before configuring. See [Install Automation Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/install-automation-center.md) for more information.
...
5.  Fill out the required fields for your request, and select **Submit**. \[Omitted image "new-automation-request.png"\] Alt text: new automation idea form
    ...
    For more information, see [Automation request form from Automation Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/automation-request-autocenter-form.md).
