...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/process-mining/configure-auto-findings.html
release: yokohama
...
# Set automated improvement opportunities using Classic view
...
3.  Select **New** under the **Automated Finding Definitions** tab.

4.  On the form, fill in the fields.

    For more information, see [Automation finding definition form from Classic view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/process-mining/auto-find-form-classic.md).
