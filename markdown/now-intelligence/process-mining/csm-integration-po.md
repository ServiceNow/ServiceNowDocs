...
The Process Mining Content Pack for CSM \(sn\_csm\_po\) adds a pre-built project that includes a predefined **SLA Breach Analysis** project definition for customer service cases. For more information, see [SLA Breach Analysis project](csm-po-sla-breach-analysis.md).
...
-   **[SLA Breach Analysis project](csm-po-sla-breach-analysis.md)**  
