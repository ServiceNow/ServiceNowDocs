...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/process-mining/add-project-note.html
release: xanadu
...
2.  From the project view, select the Notes \(\[Omitted image "notes-icon.png"\] Alt text:\) icon to open the Notes panel.
