...
Specify the field or column from the table whose data you want to view in the process graph.**Note:** Only the following field types are supported:
...
-   journal
-   journal\_input
-   glide\_date\_time \(if type = Date time\)
...
For more information on Process perspectives, see [Configure process details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/process-details.md).
...
9.  Select improvement opportunities to set improvement opportunities.
    ...
    For more information, see [Set improvement opportunities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/improve-opportunities.md)


**Parent Topic:**[Scoping your analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/scope-analysis.md)

**Related topics**  


[Set breakdown definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/breakdown.md)

[Set use cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/adv-settings.md)

[Add a child entity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/child-entity.md)
