...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/process-mining/compare-statistics-two-models.html
release: xanadu
...
1.  Expand the Bottleneck Analysis table in either project and select the combine/split icon \(\[Omitted image "combine-split-icon.png"\] Alt text:\) to show statistics or transitions for both projects in a combined table.
...
2.  To reposition each project's statistics table back into their corresponding maps, select the split icon \(\[Omitted image "combine-split-icon.png"\] Alt text:\).
...
**Parent Topic:**[Comparing projects](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/comparing-models.md)
