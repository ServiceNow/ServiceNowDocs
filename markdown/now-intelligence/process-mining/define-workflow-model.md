...
To mine a project, ensure that you have enabled [Audit Log](https://www.servicenow.com/docs/access?context=t_EnableAuditingForATable&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) for the parent table of the project.
