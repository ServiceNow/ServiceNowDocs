...
-   Data filters: Data filters are always applied before map filters. They can be applied in any order and the result will not change. They are unordered. All advanced data filters, breakdown filters, variant filters, and findings are listed as data filters.
