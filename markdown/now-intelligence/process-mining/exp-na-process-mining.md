...
This feature is accessible to customers with both Process Mining and GenAI. Once activated and configured, Now Assist for Process Mining uses an LLM to analyze all work notes related to inefficient transitions and provide the most important reasons for the transition. This feature is visible in the Process Mining workspace and Platform Analytics PM components.
