...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/process-mining/finding-rule-form.html
release: xanadu
...
Event that triggers a finding rule. You may select an existing rule, or create one using the plus \(+\) button to the right of the field.**Note:** For details on creating a condition, see [Configure advanced conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/po-advanced-conditions.md).
...
Event that concludes a finding rule. You may select an existing rule, or create one using the plus \(+\) button to the right of the field. **Note:** For details on creating a condition, see [Configure advanced conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/po-advanced-conditions.md).
