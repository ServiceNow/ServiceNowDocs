...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/process-mining/verify-data.html
release: xanadu
...
-   [Create an audit table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/create-table.md).

-   [Import data into the audit table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/import-data.md).

Role required: sn\_process\_optimization\_admin

## Procedure

1.  Navigate to the step where you selected **Import using Integration Hub** in the [Import data into the audit table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/import-data.md) section.
...
**Parent Topic:**[Working with external datasets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/external-dataset.md)
