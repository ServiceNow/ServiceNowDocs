...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/process-mining/aba-example.html
release: yokohama
...
3.  Fill in the details in the **Finding Definition** record.
    ...
    For information, see [Set rule-based finding definitions using Classic view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/process-mining/configure-finding-definition.md). \[Omitted image "aba-example-1.png"\] Alt text: Finding definition record
