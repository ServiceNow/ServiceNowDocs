...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/now-intelligence/process-mining/extreme-touchpoints.html
release: brazil
...
**Note:** Extreme touchpoints \(Node\) can be configured for a project only if it has been configured for the process table on which the project is based. For information on configuring touchpoints for a table, see [Configure impact metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/impact-metrics.md).

\[Omitted image "extreme-touchpoints-node.png"\] Alt text: Extreme touchpoints \(Node\)

## Procedure

1.  Navigate to Improvement opportunity definition page.

    For information about the Improvement opportunity definition page, see [Set improvement opportunities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/improve-opportunities.md).
...
5.  Fill the details on the form.
    ...
    \[Omitted image "extreme-touchpoints-node-config.png"\] Alt text: Extreme touchpoints \(Node\)
...
**Parent Topic:**[Setting Automated improvement opportunities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/process-mining/automated-findings.md)
