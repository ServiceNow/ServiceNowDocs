...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/process-mining/content-pack-config.html
release: yokohama
...
# Creating process configurations using content pack templates
...
\[Omitted image "process-config-2.png"\] Alt text: Content pack templates for process configuration
...
-   **[Install Process Mining content pack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/process-mining/install-content-pack.md)**  
Install the content pack to copy the process configurations set for the content pack to your process configuration.
-   **[Create process configurations using content packs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/process-mining/process-config-content-pack.md)**  
