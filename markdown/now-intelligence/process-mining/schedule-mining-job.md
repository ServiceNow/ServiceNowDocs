...
2.  On the Scheduled Process Mining Job form, populate the applicable fields for the job you want to create, then select **Submit**.
    ...
    See [descriptions of fields on a scheduled job record](https://www.servicenow.com/docs/access?context=t_ScheduleTheGenerationOfAnEntity&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
