...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/process-mining/new-project-def.html
release: australia
...
The PAR dashboard \[par\_dashboard\] associated with this project. Select an existing dashboard or use the Plus \(+\) icon to create a dashboard.
 ...
 For details on creating these dashboards, see [Create and use dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/performance-analytics/create-and-edit-dashboards.md)
