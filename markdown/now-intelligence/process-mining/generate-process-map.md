...
-   You can attempt a data refresh from the Analyst Workbench on a project that has been successfully mined from its workflow record. An error icon ![](../image/extract-error-icon.png) displays when project data does not refresh successfully. To investigate for details, view the **Extract Data Log** tab from the Project Definition form.
