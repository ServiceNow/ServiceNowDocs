...
You must install and configure the Automation Center plugin before configuring. See Install Automation Center for more information.
...
5.  Fill out the fields for your request, and select **Submit**.
    ...
    For more information, see Automation request form from Automation Center.
