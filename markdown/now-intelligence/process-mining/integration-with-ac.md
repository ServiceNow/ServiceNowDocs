...
You must install and configure the Automation Center plugin before configuring. See [Install Automation Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/install-automation-center.md) for more information.
...
5.  Fill out the fields for your request, and select **Submit**.
    ...
    For more information, see [Automation request form from Automation Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/automation-request-autocenter-form.md).
