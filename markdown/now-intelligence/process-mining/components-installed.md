...
The Process Mining Analyst \[sn\_process\_optimization\_analyst\] role contains the sn\_process\_optimization\_viewer role.
...
### Process mining viewer \[sn\_process\_optimization\_viewer\]

View projects, and create notes and improvement initiatives in projects created by other users and shared with them.
...
Users with this role cannot create, edit, or delete projects or project settings.
...
Primary metric used in the Analyst Workbench.-   Type: Choice List
...
Secondary metric used in the Analyst Workbench.-   Type: Choice List
