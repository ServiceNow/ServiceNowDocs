...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/process-mining/impr-opp-table.html
release: xanadu
...
3.  On the form, fill in the fields.
    ...
    For information on the fields, see [Create process configuration record for the table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/create-process-config.md).
...
4.  To set improvement opportunities for the table from the Classic view, select **New** under **Finding Definitions** tab or **Automated Finding Definitions** tab.
    ...
    Under the **Finding Definitions** tab, create rule-based improvement opportunities. For more information, see [Rule-based finding definition form from Classic view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/process-mining/finding-def-form.md).
