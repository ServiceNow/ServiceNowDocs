...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/now-intelligence/spotlight/spotlight-interactive-analysis.html
release: brazil
product: Spotlight
...
-   The database view that joins the Spotlight table with the facts table of the main indicator. Each row of this view shows the columns from a Spotlight record and the corresponding facts table record.
    ...
    **Note:**
    ...
    For more information, see [Spotlight database views](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/spotlight/spotlight-analyzing-data.md).
