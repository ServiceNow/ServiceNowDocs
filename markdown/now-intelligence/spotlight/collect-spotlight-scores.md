...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/spotlight/collect-spotlight-scores.html
release: yokohama
product: Spotlight
...
1.  [Create a Spotlight group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/spotlight/create-spotlight-group.md)
2.  [Create Spotlight criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/spotlight/create-spotlight-criteria.md)
...
6.  If you are using domain separation, specify a user in the **Run as** field.
    ...
    For more information, see [Domain separation with Spotlight](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/spotlight/domain-separation-spotlight.md).
