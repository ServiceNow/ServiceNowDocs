...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/spotlight/collect-spotlight-scores.html
release: xanadu
product: Spotlight
...
1.  [Create a Spotlight group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/spotlight/create-spotlight-group.md)
2.  [Create Spotlight criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/spotlight/create-spotlight-criteria.md)
...
6.  If you are using domain separation, specify a user in the **Run as** field.
    ...
    For more information, see [Domain separation with Spotlight](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/spotlight/domain-separation-spotlight.md).
