...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/spotlight/setting-up-spotlight.html
release: zurich
product: Spotlight
...
-   **[Create Spotlight criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/spotlight/create-spotlight-criteria.md)**  
Create Spotlight criteria to define when to weight a record, and the weight to assign.
-   **[Collect Spotlight scores](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/spotlight/collect-spotlight-scores.md)**  
