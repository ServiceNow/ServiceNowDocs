...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/spotlight/setting-up-spotlight.html
release: australia
product: Spotlight
...
-   **[Create Spotlight criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/spotlight/create-spotlight-criteria.md)**  
Create Spotlight criteria to define when to weight a record, and the weight to assign.
-   **[Collect Spotlight scores](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/spotlight/collect-spotlight-scores.md)**  
