...
This topic assumes that your instance is not a net new Xanadu, Yokohama, or Zurich instance. The Migration Center is only available on upgrading instances.
