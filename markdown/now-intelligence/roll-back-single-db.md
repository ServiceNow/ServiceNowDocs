...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/roll-back-single-db.html
release: xanadu
topic_type: task
...
**Note:** It is not possible to roll back technical dashboards.
...
2.  Check one or more boxes next to the names of the dashboard on the list.

    Technical dashboards are identified with the phrase Advanced Dashboards in the Experience column.
...
The version of the rolled back dashboard that is shown from the dashboard library is the Core UI version, not the Next Experience version.
