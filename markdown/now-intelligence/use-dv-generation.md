...
7.  To add the visualization to a collaborative workspace in AI Data Explorer, select **Add to exploration**.
    ...
    For more information, see [Use AI to explore data with AI Data Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/ai-data-explorer.md).

8.  To edit the visualization, select **Edit visualization**.

    If you have the viz\_creator role, you can save the visualization to the Data Visualizations library. For more information, see [Edit a data visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/edit-dv-ac-center.md).
...
-   **[Guidelines and example questions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/example-questions-generating-dv.md)**  
...
-   **[Limitations to generating data visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/limitations-generating-dv.md)**  
