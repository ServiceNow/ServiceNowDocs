...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/expl-view-recommended-actions.html
release: zurich
topic_type: task
...
1.  Launch AI Data Explorer.
    ...
    For more information, see [Launch AI Data Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/launch-ai-data-explorer.md).

2.  Open an exploration that already has generated insights.

3.  For best results, set an exploration goal.

    For more information, see [Setting exploration goals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/goals-questions.md).
