...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/editing-dv-in-line-db.html
release: yokohama
topic_type: concept
...
-   If the visualization is in the library and you don't have the necessary roles to edit it, you can "unlink" the visualization by creating a local copy, which you can edit. For more information, see [Unlink a dashboard copy of a data visualization from the library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/editing-local-copy-saved-dv.md).
...
-   **[Add a dashboard data visualization to the library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/add-db-data-viz-to-library.md)**  
...
-   **[Open a visualization in the Visualization Designer from a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/open-dv-on-db-in-vd.md)**  
From the dashboard editor, open a data visualization in the Visualization Designer. You have a different set of options.
-   **[Unlink a dashboard copy of a data visualization from the library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/editing-local-copy-saved-dv.md)**  
