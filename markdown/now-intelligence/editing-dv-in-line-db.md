...
-   If the visualization is in the library and you own it, you need the itil, report\_user, or viz\_creator role to edit it. When you save your edit, you can save the visualization in the library, which affects all dashboards that show the visualization. Alternatively, you can save a local copy only for the dashboard.
-   If you don't have edit rights to a visualization on a dashboard that has been shared with you, you can still edit the visualization to explore the data. You cannot, however, save those changes to the visualization or to the dashboard.
-   If the visualization is in the library and you don't own it, you need the viz\_admin or admin role to save edits to it, or the owner needs to share it with you with edit rights. When you save your edit, you can save the visualization in the library, which affects all dashboards that show the visualization. Alternatively, you can save a local copy.

    You cannot save changes to data visualizations in the library if you don't have edit rights or you don't have the viz\_admin or admin role.

-   If the visualization is in the library and you don't have the necessary roles to edit it, you can "unlink" the visualization by creating a local copy. You can then edit the local copy. For more information, see [Edit a copy of a shared dashboard element](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/editing-local-copy-saved-dv.md).
...
**Note:** If you save a Platform Analytics dashboard with Usage Insights data, a single click on that dashboard automatically redirects you to the corresponding UXA dashboard. This provides a quick and efficient way to drill down and explore specific user behavior from your Usage Insights data.

## Other topics

-   **[Add a dashboard data visualization to the library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/add-db-data-viz-to-library.md)**  
...
-   **[Open a visualization in the Visualization Designer from a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/open-dv-on-db-in-vd.md)**  
