...
5.  Choose the filter source.
    ...
    -   **User Experience Analytics**
        ...
        Select the User Experience Analytics property to filter on. For more information, see [Filter data in User Experience Analytics](../../../administer/user-exp-analytics/task/filter-user-list.md).
