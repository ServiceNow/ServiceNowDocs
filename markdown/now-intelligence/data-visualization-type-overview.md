...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/data-visualization-type-overview.html
release: xanadu
topic_type: concept
...
[Single score visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-sing-sc-ac.md) \[Omitted image "inline-data-vis-single-score.png"\] Alt text:

</td><td>

Single-score visualizations display a single aggregate value that is important to your business.[Single score visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/dv-example-single-score.md)

</td></tr><tr><td>

[Dial visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-dial-ac.md) \[Omitted image "inline-data-vis-dial.png"\] Alt text:
...
[Gauge visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-gauge-ac.md) \[Omitted image "inline-data-vis-gauge.png"\] Alt text:
...
[Horizontal bar visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-bar-ac.md) \[Omitted image "inline-data-vis-bar-horizontal.png"\] Alt text:
...
-   [Vertical bar visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/dv-example-v-bar.md)
...
[Vertical bar visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-bar-ac.md) \[Omitted image "inline-data-vis-bar-vertical.png"\] Alt text: Data visualization vertical bar type- med

</td></tr><tr><td>

[Pareto bar visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-pareto-vd.md)\[Omitted image "inline-data-vis-pareto.png"\] Alt text: Data visualization pareto bar type
...
[Pie visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-donut-ac.md) \[Omitted image "inline-data-vis-pie.png"\] Alt text:
...
Pie charts are best when comparing 5–7 segments that total 100%, when no two segments have a value within 10% of each other.
 ...
 -   [Pie visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/dv-example-pie.md)
-   [Donut visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/dv-example-donut.md)

</td></tr><tr><td>

[Donut visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-donut-ac.md) \[Omitted image "inline-data-vis-donut.png"\] Alt text:

</td></tr><tr><td>

[Semi-donut visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-donut-ac.md) \[Omitted image "inline-data-vis-semi-donut.png"\] Alt text:
...
[Pivot table visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-pivot-ac.md) \[Omitted image "inline-data-vis-pivot-table.png"\] Alt text: Data visualization pivot table type - med
...
[Heatmap visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-heatmap-ac.md) \[Omitted image "inline-data-vis-heatmap.png"\] Alt text: Data visualization heatmap type - med
...
[Bubble chart visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-bubble-ac.md) \[Omitted image "inline-data-vis-bubble.png"\] Alt text: Data visualization bubble chart - med
...
[Calendar report visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-calendar-ac.md) \[Omitted image "inline-data-vis-calendar-days.png"\] Alt text: Data visualization calendar type - med
...
[Indicator scorecard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-indicator-scorecard.md) \[Omitted image "inline-data-vis-scorecard.png"\] Alt text: Analytics center scorecard report-med

</td><td>

The Indicator scorecard component enables you to visualize and compare data between multiple Performance Analytics indicators.[Create an Indicator Scorecard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-indicator-scorecard.md)

</td></tr><tr><td>

[Simple list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-simple-list-ac.md) \[Omitted image "inline-data-vis-list.png"\] Alt text: Data visualization list type - med

</td><td>

Shows a list of table records. Has a reduced set of features compared to a List component, allowing the simple list to fit in small spaces.[Simple list visualization example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/dv-example-s-list.md)

</td></tr><tr><td>

[Box plot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-box-plot.md)\[Omitted image "inline-data-vis-box.png"\] Alt text:
...
Use a box plot to show the median and lower and upper quartiles of numeric data along with outliers. You can also compare the distribution of different groups of this data.
 ...
 Available in the latest Data visualizations application from the ServiceNow® Store.

</td></tr><tr><td>

[Geomap](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-geomap-ac.md)\[Omitted image "inline-data-vis-geomap.png"\] Alt text: Geomap data visualization
