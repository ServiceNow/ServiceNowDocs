...
Single-score visualizations display a single aggregate value that is important to your business.[Single score visualization example](../task/dv-example-single-score.md)
...
Pie and donut visualizations show the relationship between parts and the whole of a data set. The segments of these charts should total to 100%. For more information, see [Create a pie or donut visualization in the Visualization Designer](../../reporting/task/create-dv-donut-ac.md).
...
[Simple list](../../reporting/task/create-dv-simple-list-ac.md) ![Data visualization list type - med](../../reporting/image/inline-data-vis-list.png)

</td><td>

Shows a list of table records. Has a reduced set of features compared to a List component, allowing the simple list to fit in small spaces.[Simple list visualization example](../task/dv-example-s-list.md)
