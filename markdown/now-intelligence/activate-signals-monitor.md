...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/activate-signals-monitor.html
release: xanadu
topic_type: task
...
1.  Open KPI Signals for an indicator, as described in [View KPI Signals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/view-kpi-signals.md).
...
For more information, see [Configure signal detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/configure-signal-detection.md).
