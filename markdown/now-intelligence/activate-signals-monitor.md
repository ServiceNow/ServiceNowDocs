...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/activate-signals-monitor.html
release: yokohama
topic_type: task
...
1.  Open KPI Signals for an indicator, as described in [View KPI Signals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/view-kpi-signals.md).
...
For more information, see [Configure signal detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/configure-signal-detection.md).
