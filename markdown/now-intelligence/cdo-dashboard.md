...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/cdo-dashboard.html
release: australia
topic_type: concept
...
This dashboard visualizes key indicators such as Monthly Active Users \(MAU\), CSAT responses, platform consumption by application, automation rates, SLA attainment, cost savings, and spend distribution. These insights enable CDOs and digital leaders to identify adoption trends, track digital enablement outcomes, highlight where engagement gaps exist, and drive measurable productivity and efficiency gains.
