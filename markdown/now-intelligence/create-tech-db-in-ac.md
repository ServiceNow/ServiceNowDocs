...
3.  Choose **Technical editor**.
    ...
    ![Create new inline dashboard modal](../image/tech-editor-create-modal.png)
...
8.  Add a component to the container.
    ...
    The **Config** panel on the right enables you to configure the component you’ve chosen.
...
10. If you have added a data visualization component and you want viewers to drill down to a more detailed data view from that component, follow the instructions in [Add a drilldown event to a data visualization in a technical dashboard](add-custom-drilldown-event.md).
