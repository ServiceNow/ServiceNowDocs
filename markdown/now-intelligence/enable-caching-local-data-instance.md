...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/enable-caching-local-data-instance.html
release: yokohama
topic_type: task
...
**Parent Topic:**[Use a local data instance with a data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/dv-local-data-instance.md)
