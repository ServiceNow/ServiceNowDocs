...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/enable-caching-local-data-instance.html
release: australia
topic_type: task
...
**Parent Topic:**[Use a local data instance with a data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/dv-local-data-instance.md)
