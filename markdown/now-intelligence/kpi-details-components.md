...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/kpi-details-components.html
release: zurich
...
-   The **Chart options** menu. For more information, see [Chart options in KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/chart-options.md).
...
-   A time series aggregation selector. For more information, see [Select time aggregation in KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/select-time-series-aggregation.md).
...
-   Set an indicator target or threshold\(\[Omitted image "target-icon.png"\] Alt text: Target icon\). See [Indicator targets and thresholds in KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/kpi-details-targets.md).

## Process analysis

Besides these three sections, a **Run process analysis** button lets you launch a Process Mining analysis on the indicator. For more information, see [Process Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/process-mining/process-mining.md).
...
-   **[View contributing indicators to a formula in KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/view-formula-components.md)**  
...
-   **[Show, compare, create, and edit records in KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/show-compare-edit-records.md)**  
...
-   **[Chart options in KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/chart-options.md)**  
...
-   **[Select time aggregation in KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/select-time-series-aggregation.md)**  
...
-   **[Filter KPI Details by breakdown elements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/apply-brkdowns-element-kpi-details.md)**  
In KPI Details, you apply breakdowns and elements to the indicator in the Filters sidebar.
-   **[Access indicator record or scoresheet from KPI Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/access-indicator-record-scoresheet.md)**  
...
[Performance Analytics \(Indicator data sources\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown)
