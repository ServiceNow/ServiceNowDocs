...
Option to create dashboards. As a user with the admin role, you can create Core UI dashboards on the instances with Platform Analytics experience enabled.
...
Option to delete the selected dashboards.
...
Option to deactivate the selected dashboards.
...
Option to activate the selected dashboards.
