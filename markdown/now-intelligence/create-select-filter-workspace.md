...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/create-select-filter-workspace.html
release: zurich
topic_type: task
...
6.  Select the data to filter.
    ...
    **Note:** Your selection of filter source can impact which data you can filter. For more information, see Step [3](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/create-select-filter-workspace.md).
...
[Applying filters to Process Mining maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/applying-filters-to-process-optimization-maps.md)

[Edit a Platform Analytics filter on a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/edit-filters-configurable-workspaces.md)

[Configure a data visualization to follow filters or not](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/configure-dv-follow-filters-or-not.md)
