...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/create-select-filter-workspace.html
release: australia
topic_type: task
...
7.  Select the data to filter.
    ...
    **Note:** Your selection of filter source can impact which data you can filter. For more information, see Step [3](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/create-select-filter-workspace.md).
...
8.  Under **Other filters to follow**, if the conditions are met, you can select another filter for the current filter to follow in a hierarchy, creating a cascade.
    ...
    **Note:**
    ...
    -   Two filters can follow each other, but there are additional requirements. For more information, see [Conditions for two filters to follow each other](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/filters-follow-each-other.md).
...
[Applying filters to Process Mining maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/applying-filters-to-process-optimization-maps.md)
