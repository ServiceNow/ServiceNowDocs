...
breadcrumb: [Edit Platform Analytics dashboards, Dashboards in Platform Analytics, Platform Analytics experience, Platform Analytics]
---
...
<table id="choicetable_gv3_q3r_g5"><thead><tr><th align="left" id="d72772e134">

Action

</th><th align="left" id="d72772e137">

Steps

</th></tr></thead><tbody><tr><td id="d72772e143">
...
2.  Select the More actions menu icon \(![More actions icon](../image/context-menu-db-element-ac.png)\) next to the element's name and choose **Move to a different tab** or **Move above the tabs**.
3.  When you choose **Move to a different tab**, choose the tab and select **Move**.


</td></tr><tr><td id="d72772e478">
