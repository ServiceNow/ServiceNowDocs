...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/edit-db-elements-in-ac.html
release: yokohama
topic_type: task
...
<table id="choicetable_gv3_q3r_g5"><thead><tr><th align="left" id="d82467e134">

Action

</th><th align="left" id="d82467e137">

Steps

</th></tr></thead><tbody><tr><td id="d82467e143">
...
\[Omitted image "add-new-element-handles.png"\] Alt text: Filter element with four Add new element icons highlighted

3.  Select the element. The element is added to the dashboard where you can edit it.
4.  Drag to move the widget or resize it.


</td></tr><tr><td id="d82467e203">

**Save a data visualization to the Visualization Library**

</td><td>

Role required: admin or viz\_creator1.  Select the **Edit** button \(\[Omitted image "edit-button.png"\] Alt text: Edit button\) to put the dashboard into edit mode.

**Note:** If you don’t see the **Edit** button, you don’t have rights to edit the dashboard.

2.  Select **Add new element**. From the list, select **Data visualization**.
3.  Create the visualization as described in [Data visualizations in Platform Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/analytics-center-data-visualizations.md).
4.  Select the More actions menu icon \(\[Omitted image "context-menu-db-element-ac.png"\] Alt text: More actions icon\) in the header and choose **Add to library**.
...
3.  In the header, select the More actions menu icon \(\[Omitted image "context-menu-db-element-ac.png"\] Alt text: More actions icon\) and choose **Delete**.
...
3.  In the element's header, select the Settings icon \(\[Omitted image "icon-config-ac.png"\] Alt text: Settings icon\) to open the Configuration panel.
4.  Configure the element and choose **Save**. For more information about configuring an element, see one of the following:
    -   [Edit a data visualization in an inline dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/editing-dv-in-line-db.md)
    -   [Edit a Platform Analytics filter on a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/edit-filters-configurable-workspaces.md)
...
</td></tr><tr><td id="d82467e429">

**Move an element between tabs**

</td><td>

When you have multiple tabs, you can move elements from tab to another or to the pane above the tabs.1.  Select the **Edit** button \(\[Omitted image "edit-button.png"\] Alt text: Edit button\) to put the dashboard into edit mode.

**Note:** If you don’t see the **Edit** button, you don’t have rights to edit the dashboard.

2.  Select the More actions menu icon \(\[Omitted image "context-menu-db-element-ac.png"\] Alt text: More actions menu icon\) next to the element's name and choose **Move to a different tab** or **Move above the tabs**.
3.  When you choose **Move to a different tab**, choose the tab and select **Move**.


</td></tr><tr><td id="d82467e481">
...
</td></tr><tr><td id="d82467e502">

**Configure a data visualization to follow or not follow filters**

</td><td>

Data visualizations follow filters by default. A data visualization follows filters in the same tab as itself or above the tabs. Data visualizations either follow all such tabs that target their data sources, or none.1.  Select the **Edit** button \(\[Omitted image "edit-button.png"\] Alt text: Edit button\) to put the dashboard into edit mode.

**Note:** If you don’t see the **Edit** button, you don’t have rights to edit the dashboard.

2.  Select the dashboard element that you want to follow or not follow filters.
3.  In the header, select the Settings icon \(\[Omitted image "icon-config-ac.png"\] Alt text: Settings icon\) to open the Configuration panel.
...
</td></tr><tr><td id="d82467e565">

**Enable chart interaction**

</td><td>

Choose what happens when a user selects a visualization or one of its segments. 1.  Select the **Edit** button \(\[Omitted image "edit-button.png"\] Alt text: Edit button\) to put the dashboard into edit mode.
...
-   For a technical dashboard, see [Add a drilldown event to a data visualization on a technical dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/add-custom-drilldown-event.md).


</td></tr></tbody>
</table>
**Parent Topic:**[Edit Platform Analytics dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/edit-db-in-ac.md)

**Related topics**  


[Share a Platform Analytics dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/share-db-in-ac.md)
