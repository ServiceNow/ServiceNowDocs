...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/dv-example-dial.html
release: xanadu
topic_type: task
last_updated: "2024-08-01"
reading_time_minutes: 5
breadcrumb: [Create a dial visualization, Data visualizations in Platform Analytics, Platform Analytics]
---
...
1.  Follow the first steps to [Create a dial visualization in the Visualization Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/create-dv-dial-ac.md):
