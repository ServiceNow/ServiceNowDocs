...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/now-intelligence/core-ui-interactive-filters/t\_CreateAChoiceListPublisher.html
release: xanadu
...
7.  Select **Apply filter to database views and tables** to apply the filter to widgets based on both [database views](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/performance-analytics/performance-analytics-glossary.md) and tables.
...
**Parent Topic:**[Creating Interactive Filters of different types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/now-intelligence/core-ui-interactive-filters/r_AvailableHomepagePublisherTypes.md)
