...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/core-ui-interactive-filters/apply-filter-to-all-tables-in-hierarchy.html
release: zurich
...
-   **Select __Apply filter to both [database views](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/performance-analytics/performance-analytics-glossary.md) and tables__.**
