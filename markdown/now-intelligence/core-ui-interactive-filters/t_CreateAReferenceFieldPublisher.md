...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/core-ui-interactive-filters/t\_CreateAReferenceFieldPublisher.html
release: yokohama
...
\[Omitted image "if-ex-rf.png"\] Alt text: Reference list filter example with the All option selected
...
4.  In the **Filter based on** list, select **Reference**.
    ...
    \[Omitted image "if-filter-based-on-reference.png"\] Alt text: Filter based on list with Reference selected
...
Select how the available filtering options for this filter appear on the dashboard widget. See [Available interactive filter UI control types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/core-ui-interactive-filters/r_HomepagePublisherUIControlTypes.md).
...
</table>8.  Select **Apply filter to database views and tables** to apply the filter to widgets based on both [database views](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/performance-analytics/performance-analytics-glossary.md) and tables.
...
14. Add a related list condition.
    ...
    1.  Click the link labeled **Greater than or Equal to 1**.
        ...
        -   None
        -   Between
        \[Omitted image "ref-interactive-filter-rel-list-condition-1.png"\] Alt text: Related list condition value list
...
**Parent Topic:**[Creating Interactive Filters of different types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/core-ui-interactive-filters/r_AvailableHomepagePublisherTypes.md)
...
[Add related list conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/create-related-list-query.md)
