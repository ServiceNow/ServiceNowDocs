...
# Chief Procurement Officer \(CPRO\) Dashboard

The Chief Procurement Officer Dashboard provides a consolidated view of the enterprise procurement performance across spending, requisitions, sourcing operations, negotiations, and contract life cycle management.

Navigate to **CPRO Dashboard** &gt; **Dashboard**.

The CPRO dashboard serves as a centralized workspace for tracking end-to-end procurement health. It enables leaders to optimize spend, manage requisition flow, ensure timely sourcing execution, and maintain contract discipline. It brings together critical indicators such as year-to-date spend, savings achieved, open requisitions, sourcing backlog, negotiation outcomes, and contract renewals or expiration.
