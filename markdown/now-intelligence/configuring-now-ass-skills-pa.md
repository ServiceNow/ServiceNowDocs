...
-   **[Activate the data visualization generation skill](configure-analytics-assist.md)**  
...
-   **[The dashboard and visualization export skill](../task/activate-db-dv-export-skill.md)**  
