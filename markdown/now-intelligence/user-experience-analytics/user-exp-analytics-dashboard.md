...
breadcrumb: [Explore, User Experience Analytics, Platform Analytics]
---
...
Different users have different rights and privileges in the User Experience Analytics application. For more information, see [Roles installed with User Experience Analytics](../reference/components-installed-user-exp-analytics.md).
...
You can view basic application usage and event details for all applications within an instance. Select **All Applications** from the applications list to see these metrics simultaneously.

![See basic metrics for all applications within an instance](../../../use/par-for-workspace/image/uxa-overview-all-apps.png)
...
Default filters you can use to limit the data, including Date Range, User type, and location. Use the **Add Filter** option to add more filters to the page. For more information, see [Filter data in User Experience Analytics](../task/filter-user-list.md).
...
**Parent Topic:**[Exploring User Experience Analytics](../content-framework/concept/exploring-user-exp-analytics.md)
