...
2.  In the page header, right-click to display a menu and select **View** &gt; **User Experience Analytics**
    ...
    ![How to view User Experience Analytics polices according to country.](../image/uxa-countries-view.png)
...
**Parent Topic:**[Define how to detect your user's location](uxa-define-detect-location.md)
