...
1.  Navigate to the application or the portal you want to work on.

2.  Select the utility icon present on the bottom left section of the portal/application page.
...
3.  Review the following usage insights information shown in the panel.
    ...
    -   Page views: Shows number of views of the selected page.
    -   Users: Number of unique users \(both active and new\) who visited the selected page.
