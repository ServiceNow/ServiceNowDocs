---
title: Delete a cohort
description: Easily delete a cohort report.
locale: en-US
release: zurich
...
breadcrumb: [Cohort analysis, Use, User Experience Analytics, Platform Analytics]
---
...
2.  From the Applications list, select the application with the cohort you want to delete.
...
**Parent Topic:**[Cohort analysis in User Experience Analytics](../concept/uxa-cohorts.md)
