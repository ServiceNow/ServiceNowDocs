...
The analogous module for mobile applications is Screens. For more information, see [User Experience Analytics for mobile applications](https://www.servicenow.com/docs/access?context=mobile-analytics&version=zurich&pubname=zurich-mobile&ft:locale=en-US).
