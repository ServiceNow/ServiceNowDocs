---
title: Tracked analytics fields and cookies
description: User Experience Analytics tracks data from several sources, including web and mobile analytics fields and client-side cookies.
locale: en-US
release: zurich
...
# Tracked analytics fields and cookies
...
-   **[Tracked web analytics fields for User Experience Analytics](../reference/uxa-tracked-web-analytics.md)**  
...
-   **[Tracked mobile analytics fields for User Experience Analytics](../reference/uxa-tracked-mobile-analytics.md)**  
...
-   **[User Experience Analytics client-side storage cookies](../reference/uxa-tracked-client-cookies.md)**  
...
**Parent Topic:**[User privacy, tracking, and user consent management in User Experience Analytics](user-exp-analytics-track-options.md)
