---
title: Using Usage Insights
description: Monitor how users interact in your ServiceNow  web and mobile applications.
locale: en-US
release: australia
...
-   **[Filter data in Usage Insights](../../task/filter-user-list.md)**  
Drill down into usage data with standard and custom filters.
-   **[User retention](../../concept/view-retention-analytics.md#)**  
...
-   **[Cohort analysis in Usage Insights](../../concept/uxa-cohorts.md)**  
...
-   **[Funnel reports in Usage Insights](../../concept/funnel-reports-uxa.md)**  
...
-   **[Navigation paths](../../concept/view-navigation-paths.md)**  
...
-   **[Viewing dashboards](../../task/uxa-dashboards.md)**  
...
-   **[Creating custom events](../../task/tagged-events.md)**  
...
-   **[Viewing user analytics](../../concept/viewing-user-data.md)**  
...
-   **[Viewing session analytics](../../concept/viewing-sessions.md#)**  
...
-   **[Viewing events analytics](../../task/view-events.md#)**  
View user analytics event occurrences to help you analyze core steps within your business processes.
-   **[Usage Insights for pages and screens](../../reference/view-pages.md#)**  
...
-   **[Exporting data](../../concept/export-data.md)**  
...
-   **[Access analytics overlay](../../task/uxa-access-analytics-overlay.md)**  
