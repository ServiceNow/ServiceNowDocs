...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/now-intelligence/ask-expl-questions.html
release: yokohama
topic_type: concept
...
-   The question you ask has to be about data in one of the tables listed in the Query Generation Semantic Table Configuration table. These tables can include database views and Workflow Data Fabric tables. For more information, see [Add a table to the semantic data layer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/add-table-semantic-layer.md).
...
-   \[Omitted image "callout-1.png"\] Alt text: Area 1 Your original question. You can edit this question to generate new output.
-   \[Omitted image "callout-2.png"\] Alt text: Area 2 The title of the response and a summarization of the AI findings.
-   \[Omitted image "callout-3.png"\] Alt text: Area 3 A list or data visualization. This response can be an existing visualization instead of a generated one. For more information, see [Launch AI Data Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/launch-now-assist-explorer.md).You can change the height of the list or visualization by interacting with the double arrow icon in its corner. You can also drag a visualization to other places in the exploration.
-   \[Omitted image "callout-4.png"\] Alt text: Area 4 Suggestions for follow-up questions.
...
\[Omitted image "nowass-expl-response-source.png"\] Alt text: Source details for a response in an exploration.

## Deleting a response

If you expand the rectangle of dots before the beginning of the response, you have a button to delete the response.

\[Omitted image "nowass-delete-response.png"\] Alt text: Button to delete response.
...
-   **[Extended analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/hidden-insights.md)**  
Generate a deeper level of analysis that can reveal new insights, enabling you to make more informed decisions.
-   **[Add a data visualization from an exploration to a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/add-data-viz-from-expl-to-dboard.md)**  
...
-   **[Refresh a response with new data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/refresh-response.md)**  
...
-   **[Change the question or filter conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/now-intelligence/manually-edit-source-conditions.md)**  
