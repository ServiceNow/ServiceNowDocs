...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/now-intelligence/config-dv-sing-sc-ind-data.html
release: australia
...
You have selected an Indicator data source in [Create a single score data visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/now-intelligence/create-dv-sing-sc-ac.md).
