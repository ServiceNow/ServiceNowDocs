...
6.  Select the options for your data source.
    ...
    -   If your visualization represents User Experience Analytics data, go to [User Experience Analytics data options for pie and donut visualizations](../reference/config-dv-donut-uxa-data.md)
