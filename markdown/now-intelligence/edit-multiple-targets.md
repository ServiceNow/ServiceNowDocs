...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/now-intelligence/edit-multiple-targets.html
release: zurich
topic_type: task
...
A responsible user can edit a global target they are responsible for, regardless of role. For more information, see [Responsibility for global indicator targets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/now-intelligence/responsibiity-targets-kpi-details.md).
