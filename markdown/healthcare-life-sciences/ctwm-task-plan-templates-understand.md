...
For information about how task plan templates work, see [Task Plan Templates](https://www.servicenow.com/docs/access?context=task-plan-templates&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
...
For more information, see [Create a task plan template configuration](https://www.servicenow.com/docs/access?context=task_plan_template_configurations&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).

You can create one or more template items, such as a task or record, for a task plan template. When the task plan template is applied, these records are automatically created. For more information, see [Create a template item](https://www.servicenow.com/docs/access?context=create-task-plan-template-item&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
