...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/healthcare-life-sciences/hco-now-assist-voice-agent.html
release: zurich
topic_type: task
...
For more information on setting up Voice AI Agents, see [Deploy AI voice agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/deploy-ai-agents-for-voice.md).
