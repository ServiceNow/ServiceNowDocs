...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/healthcare-life-sciences/pss-data-model.html
release: xanadu
topic_type: concept
...
\[Omitted image "pss-data-model.png"\] Alt text: Data model displaying how the tables within Patient Support Services and Healthcare and Life Sciences Service Management interact. For information on these tables, see the Patient Support Services application tables section that follows.
...
</table>For more information, see [Healthcare and Life Sciences data model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown).
