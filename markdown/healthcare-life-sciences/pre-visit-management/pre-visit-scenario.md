...
![Infographic displaying the Pre-Visit Management workflow. For more information, refer to the text that follows.](../image/pre-visit-workflow.png "Using the Pre-Visit Management application for managing a procedure request")
