...
breadcrumb: [Managing procedure requests in Workspace, Pre-Visit Management, Healthcare and Life Sciences Service Management, Healthcare and Life Sciences]
---
...
![Workspace view of the patient information tab displaying various attributes. For the text description, refer to the Patient information displayed for a procedure request case section.](../image/pre-visit-patient-info.png "Patient information")
...
Donut chart displaying procedure request cases associated with the patient by status.
