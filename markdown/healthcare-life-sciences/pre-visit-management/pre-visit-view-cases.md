...
For more information on tabs available for a customer service case, see [Customer service case form](https://www.servicenow.com/docs/access?context=r_CustomerServiceCaseForm&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
