...
The following items are installed with Pre-Visit Management:
...
2.  Find the Pre-Visit Management application \(sn\_previsit\) using the filter criteria and search bar.
