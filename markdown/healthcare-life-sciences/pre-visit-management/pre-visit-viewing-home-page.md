...
The Workspace landing page for procedure request cases is same as the landing page of Workspace for any healthcare-related cases including cases created for addressing procedure requests. For more information, see [Viewing the landing page for healthcare-related cases in Workspace](hcls-viewing-home-page.md).
