...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/healthcare-life-sciences/cmms-cd-issue-life-cycle.html
release: yokohama
topic_type: concept
...
\[Omitted image "cmms-issue-cd-case-lc.png"\] Alt text: Life cycle of a Medical device issue case. For more information on the cases states, refer to the Medical device issue case states section.
