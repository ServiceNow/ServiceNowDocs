...
A user with the sn\_hcls\_cmms.clinical\_engineering\_technician role can then complete the work order task. For more information, see [Manage work orders](https://www.servicenow.com/docs/access?context=c_ManageWorkOrders&version=zurich&pubname=zurich-field-service-management&ft:locale=en-US).
