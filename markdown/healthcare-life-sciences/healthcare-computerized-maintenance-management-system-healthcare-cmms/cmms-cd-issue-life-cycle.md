...
![Life cycle of a Medical device issue case. For more information on the cases states, refer to the Medical device issue case states section.](../image/cmms-issue-cd-case-lc.png "Medical device issue case life cycle")
