...
-   To associate an eligibility criteria checklist with the program, create a checklist. For more information, see [Create a checklist](https://www.servicenow.com/docs/access?context=t_CreateAChecklist&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
...
8.  Associate medication products with the program.
    ...
    **Note:** When you add a medication product for a program, you must also configure the dosage specifications for the medication product. For more information, see [Configuring dosage specifications for a medication product](../concept/hcls-config-dosage-spec.md).
