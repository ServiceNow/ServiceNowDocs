...
To associate an eligibility criteria checklist with the program, create a checklist. For more information, see [Create a checklist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_CreateAChecklist.md).
...
8.  Associate medication products with the program.
    ...
    **Note:** When you add a medication product for a program, you must also configure the dosage specifications for the medication product. For more information, see [Configure dosage specifications for a medication product](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-config-dosage-spec.md).

9.  In the **Description** field, enter a summary of the program.

10. Click **Submit**.

11. [Configure a specification characteristic for the program](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-create-program.md).

12. [Associate the program with a program service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-create-program.md).

13. [Publish the program](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-create-program.md).
