...
-   Includes the **Patient** field as a reference to the Patient \[sn\_hcls\_patient\] table. For more information, see [Patient table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-patient-table.md).
