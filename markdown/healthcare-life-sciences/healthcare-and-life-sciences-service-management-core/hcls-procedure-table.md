...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-procedure-table.html
release: xanadu
...
**Note:** To customize the number, define the auto-numbering format for the Procedure \[sn\_hcls\_procedure\] table. For more information, see [Add auto-numbering records in a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/t_AutoNumberingRecordsInATable.md).
