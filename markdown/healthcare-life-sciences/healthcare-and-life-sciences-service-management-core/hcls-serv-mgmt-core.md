...
</table>**Note:** To learn about ServiceNow AI Platform, CSM, and Product Catalog Management Core tables, see [Industry data model tables](https://www.servicenow.com/docs/access?context=csm-data-model-tables&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US), [Tables installed with Customer Service Management](https://www.servicenow.com/docs/access?context=r_TIWCustomerService&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US), and Tables installed with Model Management.
