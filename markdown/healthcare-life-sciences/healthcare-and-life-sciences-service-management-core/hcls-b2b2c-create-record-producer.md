...
3.  On the form, fill in the fields.
    ...
    **Note:** For details on the fields, refer to [Create a record producer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/t_DefRecProdInSCat.md).
...
5.  In the related links, do the following:
    ...
    1.  Navigate to **Variables** and click **New**.
        ...
        **Note:** For details on variables, refer to [Variables to collect data for record producer fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/r_CreatingVariablesForFieldTypes.md).
