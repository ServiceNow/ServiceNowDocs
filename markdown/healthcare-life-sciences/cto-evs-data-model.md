---
title: Care Team Operations for Environmental Services tables
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/healthcare-life-sciences/cto-evs-data-model.html
release: australia
topic_type: concept
...
# Care Team Operations for Environmental Services tables
...
|Field|Description|
|-----|-----------|
|Number|The case number for this Healthcare EVS case. Generated automatically when created.|
...
|State|The current state of the Healthcare EVS case. Synchronizes with the associated work order automatically when the Field Service Management plugin is installed.|
...
|Requesting organization|The service organization of the requestor.|
