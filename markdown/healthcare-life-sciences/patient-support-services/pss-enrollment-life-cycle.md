...
![Enrollment case life cycle within Patient Support Services. For the text description, refer to the Enrollment case states section.](../image/pss-enrollment-case-lc.png "Enrollment case life cycle")
