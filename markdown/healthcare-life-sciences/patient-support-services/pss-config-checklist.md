...
Alternatively, you can create a checklist using the Checklist formatter. For more information, see [Create a checklist](https://www.servicenow.com/docs/access?context=t_CreateAChecklist&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
