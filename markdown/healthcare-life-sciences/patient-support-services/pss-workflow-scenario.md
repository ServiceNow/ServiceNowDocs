...
![Infographic outlining the Patient Support Services workflow. For the image description, refer to the text that follows.](../image/pss-workflow.png "Using the Patient Support Services application for managing a patient support service request")
