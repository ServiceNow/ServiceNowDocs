...
A user with the sn\_hcls\_cmms.clinical\_engineering\_technician role can then complete the work order task. For more information, see [Manage work orders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/field-service-management/c_ManageWorkOrders.md).
