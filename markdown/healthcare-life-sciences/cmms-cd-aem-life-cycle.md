...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/healthcare-life-sciences/cmms-cd-aem-life-cycle.html
release: yokohama
topic_type: concept
...
\[Omitted image "cmms-aem-cd-case-lc.png"\] Alt text: Life cycle of Medical device AEM case. For more information on each state, refer to the Medical device AEM case states section.
