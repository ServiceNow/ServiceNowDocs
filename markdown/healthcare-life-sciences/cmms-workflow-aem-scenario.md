...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/healthcare-life-sciences/cmms-workflow-aem-scenario.html
release: yokohama
topic_type: concept
...
\[Omitted image "cmms-cd-aem-scenario.png"\] Alt text: Workflow for AEM request for medical device models using the Healthcare CMMS application. For the text description, refer to the workflow steps.
