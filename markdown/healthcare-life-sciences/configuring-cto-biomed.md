...
1.  [Activate Care Team Operations for Biomed](cto-biomed-activate.md)

    Install the Care Team Operations for Biomed application \(sn\_cto\_biomed\) if you have the admin role.

2.  [Setting up plugins for Care Team Operations for Biomed](cto-biomed-plugin-info.md)
...
3.  [Set up roles for Care Team Operations for Biomed](../task/cto-biomed-set-up-roles.md)
