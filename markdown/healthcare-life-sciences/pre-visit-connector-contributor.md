...
Creates procedure request cases for only those patients with whom a relationship is established. For more information, see [Create relationships](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/configure-data-model-relationships.md).
