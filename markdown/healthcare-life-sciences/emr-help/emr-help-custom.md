...
3.  On the Extension Point form, either modify a script include to use the sn\_ind\_rmt\_help.RemoteHelpParamTransformer extension point or create and register a custom script include.
    ...
    -   Create and register a custom script include.
        ...
        For more information, see [Registering custom script includes against the scripted extension points](https://www.servicenow.com/docs/access?context=impl-scripted-ext-pts-custom-code&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
