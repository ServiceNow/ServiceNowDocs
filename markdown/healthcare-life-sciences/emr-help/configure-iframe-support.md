...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/healthcare-life-sciences/emr-help/configure-iframe-support.html
release: yokohama
product: EMR Help
...
\[Omitted image "image.configureiframe"\] Alt text: Proper domain indication on iFrame configuration for Epic.
