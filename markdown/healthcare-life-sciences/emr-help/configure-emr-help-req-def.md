...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/healthcare-life-sciences/emr-help/configure-emr-help-req-def.html
release: zurich
product: EMR Help
...
-   Set the application scope to EMR Help using the application picker. For more information, see [Application picker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/c_ApplicationPicker.md).
...
Parameters of scripted REST APIs. You can use scripted REST APIs with system support modules. For more information, see [Remote help request API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/remote_help_request-api.md).
