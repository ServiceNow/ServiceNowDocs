...
The playbooks in the Healthcare CMMS application use the CRM Workspace playbook experience. By default, the Healthcare CMMS application includes the playbook for medical devices in-service to assist clinical engineers to resolve medical device in-service cases.
