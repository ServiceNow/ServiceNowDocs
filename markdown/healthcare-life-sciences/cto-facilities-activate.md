...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/healthcare-life-sciences/cto-facilities-activate.html
release: zurich
topic_type: task
...
2.  Find the Care Team Operations for Facilities application \[sn\_cto\_facilities\] using the filter criteria and search bar.
