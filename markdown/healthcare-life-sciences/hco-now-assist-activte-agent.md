...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/healthcare-life-sciences/hco-now-assist-activte-agent.html
release: australia
topic_type: task
...
2.  In **Agentic Workflows**, select **Request care team assistance**.

3.  In **Select channels and status**, navigate to **Virtual Agent**.
