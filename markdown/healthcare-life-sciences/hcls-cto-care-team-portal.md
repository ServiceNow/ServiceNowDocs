...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/healthcare-life-sciences/hcls-cto-care-team-portal.html
release: zurich
topic_type: concept
...
For information on the features available with the Care Team Portal, see [Navigate the Care Team Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/healthcare-life-sciences/hcls-cto-using-portal.md).
...
For more information on Virtual Agent, see [Virtual Agent as an application design element](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/virtual-agent.md).
