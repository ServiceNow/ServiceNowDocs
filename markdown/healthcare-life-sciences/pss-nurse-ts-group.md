...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/healthcare-life-sciences/pss-nurse-ts-group.html
release: yokohama
topic_type: task
...
-   Add the user who is conducting the training task to the Nurse Training Support assignment group.
    ...
    For more information, see [Assign a role to a group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/user-administration/t_AssignRoleToGroup.md).
