...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/healthcare-life-sciences/vaccine-administration-management/create-appt-for-consumer-user.html
release: xanadu
...
**Note:** A clinician or a vaccine agent cannot create an appointment on behalf of internal users.
...
5.  From the consumer user record, select **Book Vaccine Appointment**.
    ...
    The **Book Vaccine Appointment** button is not visible for the internal user.
