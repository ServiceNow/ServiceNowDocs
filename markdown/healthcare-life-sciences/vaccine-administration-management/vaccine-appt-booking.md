...
3.  Update the information in each section of the form to modify the configuration as needed.
    ...
    For detailed instructions on how to fill in each section, see [Configure appointment booking](https://www.servicenow.com/docs/access?context=csm-walkup-appointment&version=australia&pubname=australia-customer-service-management&ft:locale=en-US).
