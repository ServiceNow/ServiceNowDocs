...
Store the details of vaccine dosages for a vaccination method.
...
Stores the stages of a release that a vaccine program is in and when it is available to administer. Includes the start date, end date, and additional eligibility criteria.
...
</table>To learn about Healthcare and Life Sciences Service Management Core, ServiceNow AI Platform, and CSM tables, see [Healthcare and Life Sciences data model](../../healthcare-life-sciences/concept/hcls-serv-mgmt-core-1.md), [Industry data model tables](https://www.servicenow.com/docs/access?context=csm-data-model-tables&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US), [Tables installed with Model Management](https://www.servicenow.com/docs/access?context=c_InstalledWithModelManagement&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US), and [Tables installed with Customer Service Management](https://www.servicenow.com/docs/access?context=r_TIWCustomerService&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
