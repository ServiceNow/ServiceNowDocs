...
</table>    For details on how to configure a variable, see [Service Catalog variables](https://www.servicenow.com/docs/access?context=c_ServiceCatalogVariables&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
