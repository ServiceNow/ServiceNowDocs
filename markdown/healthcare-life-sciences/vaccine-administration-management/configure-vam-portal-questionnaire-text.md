...
</table>    For details on how to configure a variable, see [Service Catalog variables](https://www.servicenow.com/docs/access?context=c_ServiceCatalogVariables&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
