...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/healthcare-life-sciences/vaccine-administration-management/va-vaccine-admin-mgmt.html
release: xanadu
...
Vaccine Administration Management provides Virtual Agent conversation topics if the Virtual Agent plugin \(com.glide.cs.chatbot\) is installed. A conversation topic defines the dialog between the Virtual Agent \(chatbot\) and the user to accomplish a goal.
