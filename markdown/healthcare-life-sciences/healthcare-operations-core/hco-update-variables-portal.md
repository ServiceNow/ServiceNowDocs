...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/healthcare-life-sciences/healthcare-operations-core/hco-update-variables-portal.html
release: yokohama
...
\[Omitted image "hco-variable-example.png"\] Alt text: Example of variable naming for capturing tokenized data from an EMR system.
