---
title: Create a group for all team members in Healthcare Operations Core
description: Create a group for team members with the sn\_hco.care\_team\_member role assigned so that users added to this group will inherit the collection of roles for Healthcare Operations Core.
locale: en-US
release: yokohama
...
# Create a group for all team members in Healthcare Operations Core
