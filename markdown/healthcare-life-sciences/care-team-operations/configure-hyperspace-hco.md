...
7.  In the launch context, add any tokens you want to capture:
    ...
    -   %WORKSTATIONID%
    For more information on capturing token data in record producer variables, see [Update variables in record producers to capture tokenized data from Epic](hco-update-variables-portal.md).
