...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/healthcare-life-sciences/cmms-retire-device-life-cycle.html
release: yokohama
topic_type: concept
...
\[Omitted image "cmms-lifecycle-retiring-device.png"\] Alt text: Life cycle of a medical device out-of-service case. For more information on the case states, see the text that follows.
