...
3.  In the manage long-term memory section, select categories that you want to map to your AI agent.![Select your LTM categories to map to the AI agent.](../image/map-ltm-category.png)
