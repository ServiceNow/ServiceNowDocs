...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/setup-ai-search-gaf.html
release: xanadu
topic_type: task
...
Once your tables have been indexed, you can continue to [Configure Group Action Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/configure-gaf.md) to set up GAF for each application.
