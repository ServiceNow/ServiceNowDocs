...
2.  Install Now Assist for AI Search by installing a Now Assist application.
    ...
    For more information, see [Install Now Assist in AI Search](https://www.servicenow.com/docs/access?context=install-now-assist-ais&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
