...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/setup-ai-search-gaf.html
release: zurich
topic_type: task
...
ServiceNow Otto for AI Search is the foundation for GAF's optimized prediction feature. AI Search is the backup search for certain workflows, and if it is not enabled and ready, GAF will not return any results.

You must index every table for each workflow or application you'd like to configure GAF for. For example, if you're configuring GAF for ITSM, you must index the Incident and related tables.
...
2.  Install ServiceNow Otto for AI Search by installing an AI application.

    For more information, see [Install ServiceNow Otto for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/install-now-assist-ais.md).
...
The tables for ServiceNow Otto for AI Search for your AI application is indexed based on the appropriate field.
...
Once your tables have been indexed, you can continue to [Configure Group Action Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/configure-gaf.md) to set up GAF for each application.
