...
For more information, see [Edit an article using the Now Assist context menu](https://www.servicenow.com/docs/access?context=Now-Assist-generate-article-using-context-menu&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
