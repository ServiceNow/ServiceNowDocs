...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/document-intelligence/single-field-form.html
release: australia
...
breadcrumb: [DocIntel forms, Reference, Document Intelligence \(Legacy\), Enable AI experiences]
---
...
<table id="table_vy1_bb2_vsb"><thead><tr><th>
...
The type of the field. For example, a text or date field.
 ...
 Some field types convert the extracted value into a standard format. For more information, see [Data normalization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/data-normalization.md).
...
**Note:** The use case must have a target table selected.
 ...
 This field is used for integration with other applications. For more information, see [Integrate with a custom application or workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/document-intelligence/configure-integration-setup.md).
...
</table>**Parent Topic:**[Document Intelligence forms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/document-intelligence/document-intelligence-forms.md)
