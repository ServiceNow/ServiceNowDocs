...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/document-intelligence/languages-supported-by-document-intelligence.html
release: australia
...
Select the language model when creating a document extraction use case. For more information, see [Create a document extraction use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/document-intelligence/create-tasks.md).
