 ...
 **Note:** Ensure that the existing cross-scope records for the old tables are not removed.
 ...
 For more detail on cross-scope records, see [Cross-scope privilege record](https://www.servicenow.com/docs/access?context=c_CrossScopePrivilegeRecord&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
