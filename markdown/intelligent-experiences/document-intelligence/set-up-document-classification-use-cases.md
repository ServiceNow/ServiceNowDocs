...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/document-intelligence/set-up-document-classification-use-cases.html
release: australia
...
1.  [Create a use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/document-intelligence/create-a-document-classification-use-case.md).

    Define the name and properties for the use case.

2.  [Create document classes using fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/document-intelligence/create-document-classes.md).

    Define the classes or categories that the AI will learn to detect and apply to documents.

3.  [Train the use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/document-intelligence/train-a-use-case.md).
