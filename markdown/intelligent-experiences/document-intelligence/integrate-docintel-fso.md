...
For more information, see [Document Intelligence for FSO](https://www.servicenow.com/docs/access?context=integration-with-document-intelligence&version=yokohama&pubname=yokohama-financial-services-operations&ft:locale=en-US).
...
See [Enable Document Intelligence for FSO](https://www.servicenow.com/docs/access?context=enable-docintel-fso&version=yokohama&pubname=yokohama-financial-services-operations&ft:locale=en-US).
