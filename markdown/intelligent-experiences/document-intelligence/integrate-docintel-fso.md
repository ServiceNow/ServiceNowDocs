...
For more information, see [Document Intelligence for FSO](https://www.servicenow.com/docs/access?context=integration-with-document-intelligence&version=xanadu&pubname=xanadu-financial-services-operations&ft:locale=en-US).
...
See [Enable Document Intelligence for FSO](https://www.servicenow.com/docs/access?context=enable-docintel-fso&version=xanadu&pubname=xanadu-financial-services-operations&ft:locale=en-US).
