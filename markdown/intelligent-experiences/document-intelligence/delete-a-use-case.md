---
title: Delete a document extraction use case
description: Delete a use case when it’s no longer needed for your documents.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/document-intelligence/delete-a-use-case.html
release: australia
...
3.  On the use case screen, select the options icon \(\[Omitted image "icon-docintel-field-options-menu.png"\] Alt text: Options icon\) and select **Delete**.
