...
![Confidence score for a recommendation.](../image/docintel-confidence-score.png "Confidence score")
...
To configure confidence score thresholds, see [Configure data extraction modes](../task/configure-data-extraction-modes.md).
