...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/document-intelligence/import-a-use-case.html
release: yokohama
...
-   Update sets for a document extraction use case are downloaded according to the steps provided in [Export a document extraction use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/document-intelligence/export-a-use-case.md).
...
For more information, see [System update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/system-update-sets.md).
...
**Parent Topic:**[Manage document extraction use cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/document-intelligence/manage-use-cases.md)
