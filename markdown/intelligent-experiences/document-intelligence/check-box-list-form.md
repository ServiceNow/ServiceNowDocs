---
title: Check box list form
description: The Check box list form enables you to define a check box list for extraction.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/document-intelligence/check-box-list-form.html
release: australia
...
<table id="table_f3n_lpt_bzb"><thead><tr><th>
...
Field on the target table that you want to align this field with.
 ...
 This field is used for integration with other applications. See [Integrate with a custom application or workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/document-intelligence/configure-integration-setup.md).
...
Option to add a check box to the list.
 ...
 Use the reorder icon \(\[Omitted image "icon-docintel-drag.png"\] Alt text: Reorder icon.\) to reorder a check box in the list.
