...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/activate-offensiveness-protection-for-generative-ai.html
release: xanadu
topic_type: task
...
Logs can be exported for review. For instructions on how to do so, see [Export Now Assist Guardian logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/export-now-assist-guardian-logs.md).
