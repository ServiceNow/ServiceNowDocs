...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/aict-configure-automation-rules.html
release: australia
topic_type: task
...
4.  Change the records the rule evaluates by selecting a different **Table** in the **Define condition** section.
    ...
    For the available tables and the fields you can build conditions against, see [Create an automation rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/aict-create-automation-rule.md).
