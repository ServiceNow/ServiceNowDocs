...
4.  Select **Create an agent from scratch** and select **Next**.
    ...
    For more information about creating an external AI agent, see [Create an external AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/create-a2a-agent-new.md).
