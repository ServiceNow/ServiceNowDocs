...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/enable-ai-experiences/integrate-voice-service-with-twilio.html
release: yokohama
...
The provider application acts as a bridge between Twilio voice service and ServiceNow AI voice assistant.Select **AI Voice Agent Provider Application**, which is preconfigured in the base system. If you want to use an existing provider application or create a new provider application, be sure to update the existing configuration according to the values mentioned in [Configuration for custom AI voice agent provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/enable-ai-experiences/voice-agent-reference.md) before proceeding further.
...
The phone number to connect the caller to a live agent when required. This option is displayed only when you select **Connect to live agent** in the Fallback options.
...
**Parent Topic:**[Integrating voice assistant with CCaaS provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/enable-ai-experiences/integrating-voice-service-with-ccaas-providers.md)
