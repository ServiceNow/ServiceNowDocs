...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/enable-ai-experiences/add-script-ai-agent.html
release: yokohama
...
JavaScript code that includes an object class or a function for your script.
