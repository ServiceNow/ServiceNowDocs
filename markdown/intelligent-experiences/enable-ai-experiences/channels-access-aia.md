...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/enable-ai-experiences/channels-access-aia.html
release: yokohama
...
2.  Set the processing and completion messages for your AI agent.
    ...
    \[Omitted image "channels-access-aia.png"\] Alt text: Select channels and access page
...
3.  Activate the AI agent.
    ...
    \[Omitted image "channels-access-aia-activate.png"\] Alt text: Select channels and access page with activate section highlighted
...
Move to the **Testing** playground to [test an AI agent execution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/enable-ai-experiences/test-ai-agent.md) using example utterances or to [test user access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/enable-ai-experiences/test-aia-access.md).
