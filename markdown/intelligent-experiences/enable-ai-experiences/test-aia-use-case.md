...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/enable-ai-experiences/test-aia-use-case.html
release: xanadu
...
5.  Select **Start test**.
    ...
    \[Omitted image "ais-testing-new.png"\] Alt text: Select the agentic workflow radio button and provide details for testing.
...
\[Omitted image "agentic-workflow-output.png"\] Alt text: Output from a tested agentic workflow with the task given to it.
