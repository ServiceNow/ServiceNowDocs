...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/enable-ai-experiences/create-now-assist-configuration-with-guided-setup.html
release: yokohama
