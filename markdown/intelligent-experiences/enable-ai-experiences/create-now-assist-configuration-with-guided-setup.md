...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/enable-ai-experiences/create-now-assist-configuration-with-guided-setup.html
release: xanadu
