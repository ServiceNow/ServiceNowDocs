...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/enable-ai-experiences/test-ai-agent.html
release: xanadu
...
5.  Select **Start test**.
    ...
    \[Omitted image "select-ai-agent-test-new.png"\] Alt text: Selecting an AI agent for testing in AI Agent Studio.
...
\[Omitted image "ai-agent-test-output.png"\] Alt text: Output from a tested AI agent with the task given to it.
