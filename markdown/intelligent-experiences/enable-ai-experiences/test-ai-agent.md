...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/enable-ai-experiences/test-ai-agent.html
release: zurich
...
2.  Select **Start manual test**.
    ...
    If you want to start an automated test, see [Evaluate an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/execute-aia-eval.md) for more details on that process.

3.  In the **Choose a test type** drop-down menu, select **AI agent or workflow**.

    If you want to test user access security controls, see [Test AI agent user access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/enable-ai-experiences/test-aia-access.md).
