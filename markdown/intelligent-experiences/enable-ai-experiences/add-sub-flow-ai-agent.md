...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/enable-ai-experiences/add-sub-flow-ai-agent.html
release: xanadu
...
Existing process automation capability you want to add.
