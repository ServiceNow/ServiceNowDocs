...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/intelligent-experiences/enable-ai-experiences/example-use-shipping-ai-agent-ad.html
release: australia
...
Familiarize yourself with the AI Desktop Actions Execution workspace. For more information, see [AI Desktop Actions Execution workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/enable-ai-experiences/agentic-desktop-excution-workspace.md).
...
The AI agent performs the tasks in the Execution workspace that shows the execution status. For more information, see [Execution statuses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/enable-ai-experiences/agentic-desktop-excution-workspace.md).
...
<table id="choicetable_tbg_qwv_23c"><thead><tr><th align="left" id="d109429e432">

Option

</th><th align="left" id="d109429e435">

Description

</th></tr></thead><tbody><tr><td id="d109429e441">
...
**Parent Topic:**[Examples of executing desktop actions using AI agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/enable-ai-experiences/use-agentic-desktop.md)
