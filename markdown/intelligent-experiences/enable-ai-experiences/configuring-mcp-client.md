---
title: Configuring Model Context Protocol Client
description: Configure the MCP Client to execute agentic workflows with AI agents and mapped tools.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/enable-ai-experiences/configuring-mcp-client.html
release: yokohama
