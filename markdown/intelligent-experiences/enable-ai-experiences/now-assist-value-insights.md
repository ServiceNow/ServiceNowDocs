...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/enable-ai-experiences/now-assist-value-insights.html
release: yokohama
...
-   **Total generated content**
    ...
    \[Omitted image "naa-value-insights-wts-total-generated-content.png"\] Alt text: Total generated content indicator.
...
-   **Average unique records to generate content per day**
    ...
    \[Omitted image "naa-value-insights-wts-avg-unique-records.png"\] Alt text: Average unique records to generate content per day.
...
-   **Total writing time saved**
    ...
    \[Omitted image "naa-value-insights-wts-totalwts.png"\] Alt text: Total writing time saved indicator.
...
-   **Average writing time saved per day**
    ...
    \[Omitted image "naa-value-insights-wts-avgwts.png"\] Alt text: Average writing time saved per day indicator.
...
-   **Average writing time saved trend per record**
    ...
    \[Omitted image "naa-avg-writing-time-saved-trend-per-record.png"\] Alt text: Average writing time saved trend per record indicator.
...
-   **Average writing time saved trend per user**
    ...
    \[Omitted image "naa-avg-writing-time-saved-trend-per-user.png"\] Alt text: Average writing time saved trend per user indicator.
...
\[Omitted image "naa-value-insights-estimated-rts.png"\] Alt text: Estimated reading time saved indicators.
...
-   **Total generated summaries**
    ...
    \[Omitted image "naa-value-insights-rts-total-generated-summaries.png"\] Alt text: Total generated summaries indicator.
...
-   **Average unique records summarized per day**
    ...
    \[Omitted image "naa-value-insights-rts-avg-unique-records.png"\] Alt text: Average unique records summarized per day indicator.
...
-   **Total reading time saved**
    ...
    \[Omitted image "naa-value-insights-rts-totalrts.png"\] Alt text: Total reading time saved indicator
...
-   **Average reading time saved per day**
    ...
    \[Omitted image "naa-value-insights-rts-avgrts.png"\] Alt text: Average reading time saved per day indicator.
...
-   **Average reading time saved trend per record**
    ...
    \[Omitted image "naa-avg-reading-time-saved-trend-per-record.png.png"\] Alt text: Average reading time saved trend per record indicator.
