...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/enable-ai-experiences/add-skill-ai-agent.html
release: xanadu
...
Existing skill to be selected from the list.
...
**Parent Topic:**[Add a tool to an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/enable-ai-experiences/add-tool-aia.md)
