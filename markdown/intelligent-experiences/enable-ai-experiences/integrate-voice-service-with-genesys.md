...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/enable-ai-experiences/integrate-voice-service-with-genesys.html
release: yokohama
...
5.  Create Audio Connector integration.
    ...
    4.  In the **Configuration** tab, select **Properties** and add the autogenerated URL obtained from creating ServiceNow voice assistant integration for Genesys Cloud in the Base Connection URI field.
        ...
        Enter only the first part of the autogenerated URL. The following is an example URL to enter in the Base Connection URI and should not be used as is: `wss://aivoiceservice-prod-main-prod.sncapps.service-now.com/genesys/stream/connect`.\[Omitted image "voice-agents-genesys-integrations-config.png"\] Alt text: Audio Connector integration setup in Genesys Cloud service.
