---
title: Configuring Now Assist AI agents
description: Configure the Now Assist AI agents to execute agentic workflows with AI agents and mapped tools.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/enable-ai-experiences/configuring-ai-agents.html
release: yokohama
