...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/enable-ai-experiences/ai-agent-studio.html
release: xanadu
...
From the AI Agent Studio testing page, you can test your agentic workflows and AI agents by asking them to complete short tasks that would be part of their more advanced workflows. For example, you could task the Resolve an incident agentic workflow to resolve a specific incident. After the task begins, you can see the AI agent conversation, the AI Agent Orchestrator, and the chain of logic that is used to achieve the task.

The following example shows the inputs for a resolve requests agentic workflow on the testing page of AI Agent Studio.

\[Omitted image "ais-testing-new.png"\] Alt text: AI Agent Studio testing page.
...
-   [Offensiveness detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/enable-ai-experiences/enable-aia-na-guardian.md)
-   [Prompt injection attempt decision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/enable-ai-experiences/enable-aia-na-guardian.md)
-   [Long-term memory for AI agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/enable-ai-experiences/long-term-memory-aia.md)
-   [Manage LLMs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/enable-ai-experiences/select-aia-llm.md)
