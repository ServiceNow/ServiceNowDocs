...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/enable-ai-experiences/add-grp-sow.html
release: yokohama
...
4.  In the Content panel, find **Ribbon Container**, select the Configure icon \[Omitted image "three-dots-icon.png"\], then select **Add before**.
...
5.  Add the **AI Agent Status Card** component.
    ...
    \[Omitted image "add-grp-sow-content-pane.png"\] Alt text: The content pane with an AI Agent Status Card component before the Ribbon Container

6.  Bind data to the **AI Agent Status Card** component.

    1.  In the Edit modal Configure tab next to the **Table** field, select the bind data icon \[Omitted image "bind-data-icon.png"\].

    2.  Select **props** &gt; **table**, then select **Apply**.

    3.  Next to the **sys\_id** field, select the bind data icon \[Omitted image "bind-data-icon.png"\].

    4.  Select **props** &gt; **sys\_id**, then select **Apply**.

    \[Omitted image "add-grp-sow-bind.png"\] Alt text: The Edit component modal with the Table and sys\_id fields with bound data
...
7.  Assign events to the **AI Agent Status Card** component.
    ...
    \[Omitted image "add-grp-sow-events.png"\] Alt text: The data drawer with the events and handlers shown
...
9.  Add an icon component.
    ...
    1.  In the Content panel, find **Top Right** &gt; **Form record presence**, select the Configure icon \[Omitted image "three-dots-icon.png"\], then select **Add before**.
    ...
    \[Omitted image "add-grp-sow-icon.png"\] Alt text: The data drawer for the icon component
...
10. Add the declarative action to the form.
    ...
    \[Omitted image "add-grp-sow-form-action.png"\] Alt text: The Action Assignment record for the Generate resolution plan declarative action with active set to true
...
\[Omitted image "add-grp-sow-result-button.png"\] Alt text: SOW with Incident open and GRP button at the top

\[Omitted image "add-grp-sow-result-card.png"\] Alt text: SOW with Incident open and agentic workflow execution steps at the top

\[Omitted image "add-grp-sow-complete.png"\] Alt text: Complete agentic workflow with review button highlighted and modal displayed
