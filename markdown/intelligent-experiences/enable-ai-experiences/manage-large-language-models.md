...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/enable-ai-experiences/manage-large-language-models.html
release: xanadu
...
3.  Find the available skills in the workflow and select **Turn on** to change the region scope and hence, enable skill.
    ...
    \[Omitted image "na-admin-manage-llm-turnon-region.png"\] Alt text: Now Assist admin - Change region scope for skill

4.  Review the terms and conditions to accept or revert to the LLM provider change.

5.  Navigate to **Settings** &gt; **Manage LLMs**.

    \[Omitted image "na-admin-settings-manage-llm.png"\] Alt text: Now Assist admin settings - Manage LLMs
...
8.  Select **Save** to update the LLM.
    ...
    **Note:** The agreement acceptance message is displayed only for the first time user.
    ...
    \[Omitted image "na-admin-change-region-agreement.png"\] Alt text: Change region scope to global location
