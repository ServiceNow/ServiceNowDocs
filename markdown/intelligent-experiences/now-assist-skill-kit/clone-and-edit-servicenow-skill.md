...
description: Eligible skills provided in ServiceNow Otto applications can be cloned in AI Skill Kit so that you can edit the prompt or change the AI service provider. Editing the prompt enables you to arrange the formatting and content of the LLM response.
locale: en-US
