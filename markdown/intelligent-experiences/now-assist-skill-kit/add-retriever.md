...
10. Select an embedding model.
    ...
    To learn about embedding models, see [Configuring an external or custom embedding model](https://www.servicenow.com/docs/access?context=setting-up-3p-embedding-models&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
