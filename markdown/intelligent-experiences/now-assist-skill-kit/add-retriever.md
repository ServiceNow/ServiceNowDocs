...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/now-assist-skill-kit/add-retriever.html
release: yokohama
...
10. Select an embedding model.
    ...
    To learn about embedding models, see [Configuring an external or custom embedding model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-search/setting-up-3p-embedding-models.md).
...
13. Select **Next**.
    ...
    **Note:** If you selected **Hybrid** or **Semantic** search criteria, see [Retriever chunking and reranking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/now-assist-skill-kit/retriever-chunking.md) to complete setting up your retriever.
...
-   **[Retriever chunking and reranking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/now-assist-skill-kit/retriever-chunking.md)**  
