...
4.  Create a dataset from a table or data collection.
...
</table>5.  Select the add icon ![add icon](../image/icon-nask-add.png) for **Evaluation Runs**.

6.  Give the evaluation run a name and description.

7.  Select one or more prompts that you want to evaluate.
...
11. Expand the **Quality** tab.

12. Select the metrics that you want to evaluate.
...
14. Review the evaluation choices that you made.

15. Select **Save &amp; Evaluate**.

16. Give a human evaluation.
