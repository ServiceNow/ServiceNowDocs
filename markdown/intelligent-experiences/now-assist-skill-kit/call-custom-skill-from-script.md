...
2.  Create a UI action.
    ...
    For more information on creating UI actions, see [Create a UI action](https://www.servicenow.com/docs/access?context=t_EditingAUIAction&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
