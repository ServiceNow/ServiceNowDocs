...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/knowledge-graph/workflow-data-fabric-in-knowledge-graph.html
release: zurich
...
-   Admins: Can create a Knowledge Graph schema with WDF tables and link it to the Now Assist panel, AI Agents, or ServiceNow® Otto for Virtual Agent.
