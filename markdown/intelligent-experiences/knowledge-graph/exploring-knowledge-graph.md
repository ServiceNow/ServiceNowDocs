...
ServiceNow Knowledge Graph application enhances the ServiceNow AI Platform® by creating a semantic layer that connects data, relationships, and context across the enterprise. It structures information as a graph of entities and connections, bringing context and meaning to the available raw data. By leveraging AI, it powers personalized and intelligent experiences across the ServiceNow® ecosystem including ServiceNow® Otto for Virtual Agent, AI Agents, and AI Search to deliver more relevant insights and automation.
...
2.  User context: Provide ServiceNow® Otto for Virtual Agent and AI Agents with contextual information such as role, department, or location to deliver personalized and relevant responses.
...
To create, edit and manage Knowledge Graph schema for your specific use cases, ServiceNow Knowledge Graph has introduced, Knowledge Graph designer.

Users can use these schema to customize and extend Knowledge Graph integrations with ServiceNow® Otto for Virtual Agent and AI agents, and ServiceNow Otto panel. ServiceNow also provides some Prebuilt integrations, that connects Knowledge Graph with ServiceNow® Otto for Virtual Agent and AI agents, and other ServiceNow applications, enabling seamless AI-powered workflows and personalized experiences.
...
-   Design and manage Knowledge Graph schema, and configure the related nodes \(tables\), properties \(columns\), and their relationships.
...
For more details, see [Graph Query Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/knowledge-graph/using-graph-query-builder.md)

## Prebuilt Integrations

Knowledge Graph unifies knowledge across platforms and integrates it with ServiceNow Otto, AI Search, AI agents, and skill kit, the prebuilt integrations of Knowledge Graph. This helps the customer drive productivity, enhance decision-making, and unlock the full potential of enterprise data, while maintaining robust data governance and permission controls.

In this release, the available prebuilt integrations are:

1.  Integration with ServiceNow® Otto for Virtual Agent, ServiceNow Otto panel and AI agents for User Context: Helps users with personalized responses.
2.  Integration with ServiceNow® Otto for Virtual Agent and ServiceNow Otto panel for Slot filling: Helps pre-fill the slots for Virtual Agent topics using the Natural Language Querying feature of Knowledge Graph.
3.  Integration with ServiceNow® Otto for Virtual Agent and ServiceNow Otto panel for Employee schema: Helps requester and fulfillers with personalized responses on people queries and Natural Language queries. Also supports people citation card. By default the user NLQ graph is connected which is used for people queries but you also have sample graph schema for other employee queries. To see more sample graphs for employee queries refer, [KB article](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB2069778).
...
|Requester|Prebuilt integration with Virtual Agent and AI Agent|Helps requesters with personalized answers, natural language queries, and fewer conversation turns with pre-filled slots for LLM topics and skills.|
|Fulfiller|Prebuilt integration with ServiceNow Otto panel and AI Agent|Helps fulfillers with personalized answers, natural language queries, and fewer conversation turns with pre-filled slots for LLM topics and skills.|

## Knowledge Graph benefits

|Benefit|Feature|Users|
|-------|-------|-----|
|Enhance user experience \(with prebuilt integration for downstream products like Virtual Agent and AI Agent\)|Provides accurate data with minimal user effort.|Requester|
...
|Create a Knowledge Graph schema with Workflow Data Fabric tables.|To create and manage Workflow Data Fabric tables, see[Workflow Data Fabric Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/workflow-data-fabric.md)|kg\_admin|
