...
-   Add assets manually when a connector or trace can't reach them. See [Creating AI assets manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/creating-ai-assets-newexperience.md).

For the ways AI Control Tower adds assets to your inventory automatically, see [Discovering AI assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/disc-discovering-ai-assets.md).
