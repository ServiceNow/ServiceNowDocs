...
-   [Project summary emails](https://www.servicenow.com/docs/access?context=email-project-summary-skill-pw&version=zurich&pubname=zurich-it-business-management&ft:locale=en-US)
...
[Record summarization](https://www.servicenow.com/docs/access?context=now-assist-summarize-apo&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US)
...
[Record summarization](https://www.servicenow.com/docs/access?context=now-assist-spo-summarize-record&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US)
...
**Parent Topic:**[Now Assist Admin Settings](../../now-assist-admin/task/configure-now-assist-admin-settings.md)
