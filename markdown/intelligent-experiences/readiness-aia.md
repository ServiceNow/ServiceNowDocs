...
To access this AI agent, you must have ServiceNow Otto® Agent for Platform installed on your instance, which is installed with any other ServiceNow Otto application, such as ServiceNow Otto for IT Service Management \(ITSM\).
