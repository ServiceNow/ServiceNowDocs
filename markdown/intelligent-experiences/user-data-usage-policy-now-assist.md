...
Sensitive data can be masked before sending it to LLMs. You need to enable and configure the Sensitive Data Handling plugin. To configure the plugin, see [Configure sensitive data handling for generative AI](../../generative-ai-controller/task/configure-sensitive-data-handling-for-generative-ai.md).
