---
title: Notifications AI agents
description: The following AI agents are available for Notifications.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/platform-notifications-ai-agents-overview.html
release: australia
topic_type: concept
...
-   **[Email generator AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/plat-not-email-generator-agent-ai-agent.md)**  
This AI agent composes and sends emails \(including new messages or replies\) based on the provided context.
-   **[Intent executor AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/plat-not-intent-executor-agent-ai-agent.md)**  
This AI agent executes admin-defined actions, such as workflows or creating reply responses based on matched intent.
-   **[Intent identification AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/plat-not-intent-identification-agent-ai-agent.md)**  
...
-   **[Notification AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/plat-not-notification-agent-ai-agent.md)**  
This AI agent creates or edits notification records through natural‑language interaction.
-   **[Notification content AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/plat-not-notification-content-agent-ai-agent.md)**  
