...
-   **Data security and privacy**
    ...
    Admins can configure Data Privacy for Now Assist to mask sensitive fields and control what is shared with third-party models. For details, see [Data Privacy for Now Assist](https://www.servicenow.com/docs/access?context=now-assist-for-data-privacy-landing&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
...
-   **Now Assist Admin console**
    ...
    For more information, see [Now Assist Admin console](../../now-assist-platform/concept/configuring-now-assist.md).
