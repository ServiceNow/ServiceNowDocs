...
For more information about how to search for tables in the navigation filter, see [Navigate directly to a table](https://www.servicenow.com/docs/access?context=t_NavigateDirectlyToATable&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
