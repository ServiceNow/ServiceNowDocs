...
The Skills performance dashboard page contains indicators that help you analyze the usage and performance of active skills. Use the **Date range**, **Product**, and **Skills** filters to break down by date range, Now Assist product, and skill, respectively. The filter selection applies to all visualizations on the page. See [Now Assist Analytics dashboard indicator details](now-assist-analytics-dashboard-indicators.md) for information on the data and calculations behind each indicator.

![Now Assist skills usage and performance indicators.](../image/naa-skills-performance.png "Skill Performance dashboard page")

The indicators on the Skills performance dashboard page provide the following insights. See [Now Assist Analytics dashboard indicator details](now-assist-analytics-dashboard-indicators.md) for information on the data and calculations behind each indicator.
...
-   **Skills engagement trend**
    ...
    ![Skill usage trend indicator.](../image/naa-skills-usage-trend.png "Skills usage trend indicator")
...
-   **Number of actions**
    ...
    ![Number of Now Assist actions indicator.](../image/naa-skill-performance-noa.png "Number of actions indicator")
...
-   **Total daily active users**
    ...
    ![Total daily active users indicator.](../image/naa-total-daily-active-users.png "Total daily active users indicator")
...
-   **Total daily active users by skill**
    ...
    ![Total daily active users by skill indicator.](../image/naa-total-daily-active-users-by-skill.png "Total daily active users by skill indicator")
