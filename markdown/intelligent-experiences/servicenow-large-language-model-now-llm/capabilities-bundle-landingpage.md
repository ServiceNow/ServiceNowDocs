...
|Skill|Reference|
|-----|---------|
|App generation|[General guidelines for using app generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/sns-app-gen-guidelines.md)|
