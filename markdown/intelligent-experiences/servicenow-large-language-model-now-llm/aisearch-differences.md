...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/servicenow-large-language-model-now-llm/aisearch-differences.html
release: yokohama
...
For more information on differences in ServiceNow AI results, see [Search result disparities between AI Search and Now Assist search features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/search-disparities-ai-search-now-assist.md).
