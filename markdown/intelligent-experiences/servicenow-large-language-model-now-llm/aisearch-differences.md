...
For more information on differences in ServiceNow AI results, see [Search result disparities between AI Search and Now Assist search features](https://www.servicenow.com/docs/access?context=search-disparities-ai-search-now-assist&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
