---
title: Project summarization AI agent
description: This Strategic Portfolio Management agent assists project managers to get a summary of the project. The agent helps in keeping their projects on track, by providing actionable and proactive updates on critical changes to projects. It also generates the project summaries.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/spm-project-summarization-ai-agent.html
release: australia
...
# Project summarization AI agent
...
1.  Produce project insights and update the status to the project manager.
2.  Close without further interaction.
