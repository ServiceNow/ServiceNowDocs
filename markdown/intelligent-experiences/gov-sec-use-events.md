...
6.  In the malicious activity banner, select **View details** to address the AI agent issue.
    ...
    For more information, see [Manage AI agents using kill switch protocol](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/gov-sec-manage-ai-agents-using-kill-switch-protocol.md).
