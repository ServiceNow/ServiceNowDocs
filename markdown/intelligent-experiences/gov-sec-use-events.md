...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/gov-sec-use-events.html
release: zurich
topic_type: task
...
4.  On any AI recommendation, select **Open** to view all associated AI asset security events.
    ...
    For more information, see [Activity Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/aict-activity-center.md).
