...
-   Mobile app voice launcher function must be configured using Now Assist for Mobile before you can assign it to an assistant. See Configure Mobile AI Voice Agent for more information.
...
6.  In Prominent action button override, select from the **Add tab override** drop-down to allow a prominent action button to launch the assistant.
    ...
    The prominent action button overrides what’s been defined in the chat launcher and voice launcher functions. See Configuring a prominent action button for more information on configuring the prominent action button.
