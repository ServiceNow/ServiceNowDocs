...
-   The Agent Client Collector \(ACC\) agent is deployed to the devices you want covered. For details, see [Agent Client Collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/acc-landing-page.md).
...
ACC is configured as a control enforcement point for explicit block policies. For details, see [Create an Explicit Block policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/gov-pol-create-explicit-block-policy.md).
