...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/servicenow-lens/create-record-in-the-service-portal.html
release: yokohama
...
9.  To extract data from a single screenshot of the artifact, do the steps.
    ...
    1.  Select the capture instructions icon \(\[Omitted image "lens-instructions-icon.png"\] Alt text: Capture instructions icon.\) and enter instructions to analyze.
        ...
        **Note:** This is an optional step.
        ...
        \[Omitted image "lens-vendor-form-capture.png"\] Alt text: Capture instructions field.

    2.  Select **Analyze**.

    ServiceNow AI Lens confirms that the catalog item form is filled.

    \[Omitted image "lens-sp-single-scrn.png"\] Alt text: Single screen of artifact captured.
...
10. Extract the data from multiple screenshots.
    ...
    1.  Select the **Multi-capture** button \[Omitted image "multi-capture-icon.png"\].

    2.  Continue to take the required screenshots by selecting the **Capture** button \[Omitted image "capture-icon.png"\].
    ...
    3.  When you're finished taking screenshots, select **Done** \[Omitted image "done-icon.png"\].

        The window shows the thumbnails of the images that ServiceNow Lens captured.

        \[Omitted image "lens-catalog-multi-capture.png"\] Alt text: Multiple images captured.
...
<table id="choicetable_g1q_l32_2hc"><thead><tr><th align="left" id="d75045e380">

Option

</th><th align="left" id="d75045e383">

Action

</th></tr></thead><tbody><tr><td id="d75045e389">
