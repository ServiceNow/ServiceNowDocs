...
Activate the ServiceNow AI Lens skill to use generative AI to scan and analyze visual data such as images, screens, websites, and applications or use preview options to optimize your workflows.
