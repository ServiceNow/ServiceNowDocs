...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/servicenow-lens/install-sn-lens.html
release: yokohama
...
ServiceNow AI Lens isn’t a standalone application that you can install directly. To enable ServiceNow AI Lens on your instance, you must install other Now Assist applications, such as ServiceNow Otto for IT Service Management \(ITSM\) or ServiceNow Otto for Customer Service Management \(CSM\).
...
For more information, see [Components installed with ServiceNow AI Lens](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/servicenow-lens/components-installed-sn-lens.md).
