...
\[Omitted image "lens-form-autofilled.png"\] Alt text: Incident form auto-filled.**Upload files**

1.  In your instance, navigate to the list view of any table, for example, Incidents.
2.  Open the record that you want to update.
3.  Select **Update with Lens**.

\[Omitted image "lens-upload-files-upload-rec.png"\] Alt text:
...
<table id="choicetable_jjf_zx2_s2c"><thead><tr><th align="left" id="d91293e1250">

Option

</th><th align="left" id="d91293e1253">

Action

</th></tr></thead><tbody><tr><td id="d91293e1259">
