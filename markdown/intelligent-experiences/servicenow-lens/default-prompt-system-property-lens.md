...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/servicenow-lens/default-prompt-system-property-lens.html
release: yokohama
...
1.  In the filter navigator, enter **sys\_properties.list** to display the list of system properties for your instance.
