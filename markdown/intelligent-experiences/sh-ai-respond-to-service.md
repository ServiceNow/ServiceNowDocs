...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/sh-ai-respond-to-service.html
release: zurich
topic_type: task
...
For worked examples of choosing between options, see [Shadow AI triage examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/sh-ai-triage-scenarios.md).
