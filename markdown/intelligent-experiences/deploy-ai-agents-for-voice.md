...
2.  [Configure user identification and authentication](https://www.servicenow.com/docs/access?context=configuring-authentication-factors-for-ai-voice-agents&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US)
...
[Using the IT Service Management Now Assist Voice AI agents](https://www.servicenow.com/docs/access?context=now-assist-itsm-aiagents-voice&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US)
