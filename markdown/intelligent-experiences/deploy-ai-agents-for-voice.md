...
2.  [Configure user identification and authentication](https://www.servicenow.com/docs/access?context=configuring-authentication-factors-for-ai-voice-agents&version=zurich&pubname=zurich-platform-security&ft:locale=en-US)
...
[Agentic AI in the Voice application](https://www.servicenow.com/docs/access?context=now-assist-itsm-aiagents-voice&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US)
