...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/aict-configuring-security-connections.html
release: zurich
topic_type: concept
...
**Important:** AI agent containment for Gemini Enterprise Agent Platform agents is supported only for agents that have a unique agent identity configured. See [Add a Gemini Enterprise Agent Platform connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/aict-configure-gcp-vertex-ai-security-connection.md).

-   **[Add an AWS Bedrock or AWS Bedrock Agent Core connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/aict-configure-aws-bedrock-security-connection.md)**  
...
-   **[Add an Azure AI Foundry connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/aict-configure-azure-foundry-security-connection.md)**  
...
-   **[Add a Gemini Enterprise Agent Platform connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/aict-configure-gcp-vertex-ai-security-connection.md)**  
...
-   **[Add an Okta connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/aict-configure-okta-security-connection.md)**  
...
-   **[Add an Agent Client Collector \(ACC\) connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/aict-configure-acc-cep.md)**  
