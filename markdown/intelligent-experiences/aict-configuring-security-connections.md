...
breadcrumb: [Configuring integrations, Configure, AI Control Tower, Establishing AI governance, Enable AI Experiences]
---
...
-   Deactivate an AI agent through Deny Resource policies applied directly on the AI agent runtime platform, without requiring a separate identity provider connection.
...
-   On a supported AI agent runtime platform \(AWS, Gemini Enterprise Agent Platform, and ServiceNow\), deactivating an AI agent using kill switch protocol applies a Deny Resource policy directly on that platform. This prevents the agent from acting on that platform.
...
-   **[Add an AWS Bedrock or AWS Bedrock Agent Core connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/aict-configure-aws-bedrock-security-connection.md)**  
...
-   **[Add an Okta connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/aict-configure-okta-security-connection.md)**  
...
-   **[Add an Agent Client Collector \(ACC\) connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/aict-configure-acc-cep.md)**  
Block and unblock AI usage on managed devices by configuring Agent Client Collector \(ACC\) as a control enforcement point.

**Parent Topic:**[Configuring integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/aict-configuring-integrations.md)
