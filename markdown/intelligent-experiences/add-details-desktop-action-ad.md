---
title: Add details to desktop actions in Agentic Desktop
...
1.  In the Design workspace, select the Details tab.
    ...
    ![Agentic Desktop details tab displaying name, description, application, and many other fields, along with inputs and outputs.](../image/details-tab-ad.png)
