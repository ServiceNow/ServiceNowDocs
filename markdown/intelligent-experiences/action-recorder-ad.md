...
description: With Action recorder, you can auto-capture steps to automate repetitive tasks in AI Desktop Actions. You can save the steps that you perform on the application elements as a reusable desktop action of type UI block.
locale: en-US
release: zurich
topic_type: concept
...
With Action recorder, you can auto-capture steps to automate repetitive tasks in AI Desktop Actions. You can save the steps that you perform on the application elements as a reusable desktop action of type UI block.
