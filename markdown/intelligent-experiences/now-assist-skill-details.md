...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/now-assist-skill-details.html
release: zurich
topic_type: concept
...
-   Overview: General description of the skill
    ...
    \[Omitted image "na-skill-details.png"\] Alt text: Skill details- overview tab

-   Usage: Details about the skill usage, adoption and AI assist consumption. The report on total execution, active users and executions across channels can be exported in .csv or excel format.

    \[Omitted image "na-skill-details-usage.png"\] Alt text: Skill details- usage tab
    ...
    -   Assist consumption: The total number of AI assists utilized throughout the executions of this skill in a given date range
-   Security and governance- Manage various security and governance aspects of skill details like model provider, ACLs, guardrails and other data privacy policies, as illustrated in the example.
