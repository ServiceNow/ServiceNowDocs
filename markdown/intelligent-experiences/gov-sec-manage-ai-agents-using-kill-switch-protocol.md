...
7.  Select **View kill switch protocol log** to track the progress of the deactivation.
    ...
    For more information, see [Review the kill switch protocol log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/gov-sec-review-kill-switch-protocol-log.md).
...
-   **[Review the kill switch protocol log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/gov-sec-review-kill-switch-protocol-log.md)**  
