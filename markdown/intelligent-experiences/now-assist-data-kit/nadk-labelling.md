...
-   Data Kit Admin \(sn\_data\_kit.admin\): Full access to create projects, manage teams, configure layouts, and review all labeling work
-   Analyst \(sn\_data\_kit.analyst\): Limited access to assigned projects only; can view and label tasks but cannot modify project configurations
