...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/now-assist-data-kit/na-data-kit-generate-data.html
release: yokohama
...
<table id="table_vhp_d33_xfc"><thead><tr><th>
...
The Default Data Generator creates flat records based on a fixed schema with files like name, description, and short description. By providing a few examples, the model learns the structure and generates consistent, realistic data, making it suitable for typical use cases. These configurations can also be saved as templates for easy reuse.
...
The Custom Data Generator enables you to define your won fields or add new ones to an existing dataset. By describing what each column represents and giving a few examples, the model can generate rich, domain-specific data tailored to your needs, covering a wide range of use cases.**Note:** To use a custom generator, see .

</td></tr></tbody>
</table>5.  On the Add job info page, fill in the fields.
...
7.  Select a template.
    ...
    |--------|-----------|
    |Case data|Human Resources is involved in managing the employee life cycle and administering employee benefits|
...
9.  On the form, fill in the rest of the fields.
    ...
    **Note:** If you have sample data available, you can navigate to [Select the sample data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/now-assist-data-kit/select-sample-data.md) to enhance the accuracy of the generated data. If you don't have sample data, refer to the in-product help for guidance.

10. Select **Continue**.

11. Add your sample data by navigating to [Define columns to generate data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/now-assist-data-kit/na-data-kit-define-columns.md).
