...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/aia-eval-metrics.html
release: xanadu
topic_type: concept
...
For more information on AI agent usage and other analytics, you can review the [AI Agent Analytics dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/ai-agent-dashboard.md) in the AI Agent Studio.
