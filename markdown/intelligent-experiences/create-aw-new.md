...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/create-aw-new.html
release: australia
topic_type: task
...
6.  [Review or draft the content in the **Expected behavior** section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/define-aw-new.md).
...
7.  [Add AI agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/add-aia-aw-new.md) that will work together within the agentic workflow.
...
8.  [Define the agentic workflow access rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/define-sec-aw-new.md).
...
10. [Add a trigger to automatically invoke your agentic workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/add-trigger-aw-new.md) if a specified event occurs.

    If you want your agentic workflow to be used only in chats, you don't need to add a trigger.

11. [Determine how and where users can engage with your agentic workflow and set the processing messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/channels-access-aw-new.md).
