---
title: Premium chat
description: Now Assist panel premium chat provides a full-featured conversational AI experience that combines generative AI chat skills with advanced capabilities to speed up issue resolution. Premium chat is the default experience for new installations and upgrades.
locale: en-US
release: australia
topic_type: concept
...
![Search the web fallback option screen.](../images/nap-search-web-fallback.png "Example of Search the web fallback option")
