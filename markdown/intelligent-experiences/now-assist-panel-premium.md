...
-   Now Assist panel premium chat must be activated before you can use it. See Display your assistant on Platform or ServiceNow Studio for more information.
-   If you want to use assistants, you must activate them. See Configuring assistants overview for information on activating assistants.
