...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/config-aia-notifications-new.html
release: australia
topic_type: task
...
There are different email notifications that can be configured: one for Assist usage spikes, one for failed AI agent executions, and two for latency errors.
