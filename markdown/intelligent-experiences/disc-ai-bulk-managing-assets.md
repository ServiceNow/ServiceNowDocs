...
To set up a new rule, see [Create an automation rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/aict-create-automation-rule.md). To change which assets an existing rule matches, see [Edit an automation rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/aict-configure-automation-rules.md).
