...
-   **3. Activate skills.**
    ...
    ![In the Technology workflow, select the workflow area to see all of the available skills. In this example, the skills for Now Assist for IT Service Management (ITSM) are displayed.](../../now-assist-admin/image/explore-now-assist-4.png "Available Now Assist skills in the Technology workflow")
