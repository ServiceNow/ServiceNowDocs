...
5.  In the **Write with Now Assist** step, choose whether you want the Now Assist context menu to be active and then select the actions you want to be available.
    ...
    After each step, select **Save and continue**. For more information about these choices, see [Skill inputs and triggers for Now Assist for CSM](https://www.servicenow.com/docs/access?context=now-assist-csm-skill-inputs&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US) and [Skill inputs and triggers for Now Assist for HRSD](https://www.servicenow.com/docs/access?context=now-assist-hrsd-skill-inputs&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US).
