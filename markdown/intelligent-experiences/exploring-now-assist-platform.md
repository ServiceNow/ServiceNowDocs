...
-   Use [Now Assist in AI Search](https://www.servicenow.com/docs/access?context=now-assist-ais&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) to generate answers for AI Search.
-   Use [Now Assist for Mobile](https://www.servicenow.com/docs/access?context=now-assist-mobile-landing&version=zurich&pubname=zurich-mobile&ft:locale=en-US) to run generative AI skills in a mobile environment.
-   Use [Now Assist in Virtual Agent](https://www.servicenow.com/docs/access?context=now-assist-in-va-landing&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US) to create conversational catalog experiences and author topics that use LLM topic discovery.
...
|Use Now Assist skills on mobile devices.|[Now Assist for Mobile](https://www.servicenow.com/docs/access?context=now-assist-mobile-landing&version=zurich&pubname=zurich-mobile&ft:locale=en-US)|Everyone|
...
|Monitor Now Assist consumption on your instance.|[Monitoring Now Assist usage in Subscription Management](https://www.servicenow.com/docs/access?context=monitoring-now-assist-usage&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)|Administrators|
