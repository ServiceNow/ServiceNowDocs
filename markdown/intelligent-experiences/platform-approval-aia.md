...
description: The Approval assistance AI agent is an AI agent that enables you to see your list of pending approvals, and the details about your pending approvals. You can then approve or reject requests and tickets from ServiceNow Otto in Virtual Agent.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/platform-approval-aia.html
release: zurich
topic_type: concept
...
\[Omitted image "aia-approve-reject.png"\] Alt text: ServiceNow Otto Approve or Reject options for an Approval.
