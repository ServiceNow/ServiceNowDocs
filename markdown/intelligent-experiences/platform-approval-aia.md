...
description: The Approval assistance AI agent enables you to see your list of pending approvals and the details about your pending approvals. You can then approve or reject requests and tickets from ServiceNow Otto in Virtual Agent.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/intelligent-experiences/platform-approval-aia.html
release: australia
topic_type: concept
