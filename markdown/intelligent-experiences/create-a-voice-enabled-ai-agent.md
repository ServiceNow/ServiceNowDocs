...
5.  Select channels and activation status for your AI voice agent.
    ...
    2.  In the **Choose voice assistants** field, select the default assistant or a custom assistant.
        ...
        Voice assistants are created in Assistant Designer. See [Create a voice assistant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/configure-voice-assistants.md) for more information.
