...
3.  Review these on the **Manage model providers** page:
    ...
    -   Policy Summary set by your organization about skills using non-compliant model providers.
        ...
        **Note:** Note the routing and fallback exception details. These details are also derived from the AI Control Tower configurations. See [Explore AI model providers](../../ai-governance-workspace/concept/ai-model-providers.md) to learn more about Fallback exception and other controls set by the AI steward.
...
-   **[Edit model providers](edit-model-providers.md)**  
