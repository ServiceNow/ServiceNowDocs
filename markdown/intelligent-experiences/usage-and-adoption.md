...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/usage-and-adoption.html
release: yokohama
topic_type: concept
...
-   **Daily Now Assist actions**
    ...
    \[Omitted image "naa-daily-now-assist-actions.png"\] Alt text: Daily Now Assist actions indicator.
...
-   **Average daily unique users engaging with Now Assist**
    ...
    \[Omitted image "naa-average-daily-unique-users.png"\] Alt text: Average daily unique users engaging with Now Assist.
...
-   **Daily unique users engaging with Now Assist**
    ...
    \[Omitted image "naa-daily-unique-users.png"\] Alt text: Daily unique users engaging with Now Assist.
...
-   **Departments with highest usage**
    ...
    \[Omitted image "naa-departments-with-highest-usage.png"\] Alt text: Departments with the highest usage number of Now Assist actions indicator.
...
-   **Now Assist actions comparison by user department**
    ...
    \[Omitted image "naa-now-assist-actions-by-department.png"\] Alt text: Now Assist actions comparison by user department indicator.
