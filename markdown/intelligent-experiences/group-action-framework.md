...
See [Install Now Assist in AI Search](https://www.servicenow.com/docs/access?context=install-now-assist-ais&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) and [Set up AI Search for Group Action Framework](../task/setup-ai-search-gaf.md) for more information on configuring AI Search for GAF.
