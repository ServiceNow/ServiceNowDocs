...
See Install Now Assist in AI Search and [Set up AI Search for Group Action Framework](../task/setup-ai-search-gaf.md) for more information on configuring AI Search for GAF.
