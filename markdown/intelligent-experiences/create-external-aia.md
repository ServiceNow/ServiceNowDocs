...
-   **[Integrating external AI agents](external-agent-protocols.md)**  
...
-   **[ServiceNow AI agents as secondary agents](secondary-agent.md)**  
Integrate ServiceNow AI agents into other agentic AI systems, such as Google Cloud or Azure OpenAI.
-   **[Create an external AI agent with manual integration](../task/create-manual-external-agent.md)**  
Create an external AI agent by manually integrating a third-party agent in AI Agent Studio to use in agentic workflows.
-   **[Create an external AI agent with the Agent2Agent protocol](../task/create-a2a-agent.md)**  
