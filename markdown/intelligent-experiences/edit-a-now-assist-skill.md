...
1.  Navigate to **All** &gt; **Now Assist Admin** &gt; **Features**.
    ...
    If you’re already in the AI Admin Hub console, select the **Now Assist Admin Features** tab.
