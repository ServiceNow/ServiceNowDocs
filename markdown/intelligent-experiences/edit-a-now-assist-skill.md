...
4.  Under **Active skills**, select the more options icon ![More options icon.](../../now-assist-platform/images/now-assist-reset-icon.png) next to the skill that you want to configure, then select **Edit**.
