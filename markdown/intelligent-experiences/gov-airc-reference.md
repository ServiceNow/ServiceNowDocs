...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/gov-airc-reference.html
release: zurich
topic_type: concept
...
These views support awareness, prioritization, and review. They do not replace the underlying governance processes that generate assessments, risks, controls, issues, policy exceptions, or related records.
