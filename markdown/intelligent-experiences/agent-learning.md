...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/agent-learning.html
release: yokohama
topic_type: concept
last_updated: "2025-11-10"
reading_time_minutes: 1
keywords: [AI agent learning, Episodic memory]
...
To configure agent learning at the AI agent level, see [Define the specialty of an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/define-specialty.md).

To configure agent learning at the AI Agent Studio level, see [Set up long-term memory](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/long-term-memory-aia.md).
