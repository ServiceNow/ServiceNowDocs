...
4.  On the form, fill in the fields.
    ...
    For a description of the field values on the Create New AI case form, see [Create new AI case form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/ai-control-tower/create-new-ai-case-form.md).
