...
5.  Enter the **Name**.
    ...
    **Note:** A redirect URL will be available after an agent is created and configured. The redirect URL is a callback point endpoint used during OAuth.
    ...
    -   Copilot studio: Unique to the tool or connection that you can create inside their Copilot agent.
...
To connect with Copilot Studio via AI Gateway, see [Connecting with Microsoft Copilot Studio Via AI Gateway](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/ai-control-tower/create-an-agent-in-copilot-studio-for-mcp-client-integration.md)
