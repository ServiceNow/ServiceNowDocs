...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/ai-control-tower/aict-value-tab.html
release: yokohama
...
The indicators on the dashboard are based on the value templates associated with each AI system. See [Using value templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/ai-control-tower/using-value-templates.md) for more information.
