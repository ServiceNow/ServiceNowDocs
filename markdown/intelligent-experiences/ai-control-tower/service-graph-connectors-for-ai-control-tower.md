...
When you access third-party APIs, they return data. This data must be stored in ServiceNow tables. Before saving it, you should transform the data from its JSON format into your preferred format and then store it in ServiceNow tables.
