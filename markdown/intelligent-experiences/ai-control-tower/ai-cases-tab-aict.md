...
For more information, see [Create an AI case in the AI Risk and Compliance workspace](https://www.servicenow.com/docs/access?context=create-ai-case-in-the-ai-risk-and-compliance-workspace&version=australia&pubname=australia-governance-risk-compliance&ft:locale=en-US) and [Create an AI issue in the AI Risk and Compliance workspace](https://www.servicenow.com/docs/access?context=create-ai-issue-in-the-ai-risk-and-compliance-workspace&version=australia&pubname=australia-governance-risk-compliance&ft:locale=en-US).
...
Use the [**Create inquiry**](https://www.servicenow.com/docs/access?context=raise-ai-inquiry&version=australia&pubname=australia-governance-risk-compliance&ft:locale=en-US) button to initiate a new inquiry. You can make timely reports of AI-related concerns or clarification requests.
