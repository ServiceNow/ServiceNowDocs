...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/ai-control-tower/ai-datasets.html
release: australia
...
-   A set of labeled images \(dogs, cats\) for training a model
-   Articles and books for training a language model
