...
Select **Add metrics** to use a custom metric for calculations. See [Create an automated indicator with a wizard](https://www.servicenow.com/docs/access?context=t_CrtIndctrIndctrWzrd&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US) for more information.

 ![image.aict-create-new-value-template-formula]
...
Select the type of AI asset and AI assets that you want to map to the value template.
 ...
 ![image.aict-create-new-value-template-map]
...
Select the instance and AI assets for which you want to estimate the real-time value in productivity and click **Validate and calculate**.
 ...
 ![image.aict-create-new-value-template-test]
