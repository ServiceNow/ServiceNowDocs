...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/ai-control-tower/create-new-value-template.html
release: yokohama
...
5.  On the Add value template form, fill in the fields.
    ...
    For a description of the field values, see [Add value template form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/ai-control-tower/add-value-template-form.md).
...
Select **Add metrics** to use a custom metric for calculations. See [Create an automated indicator with a wizard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/t_CrtIndctrIndctrWzrd.md) for more information.

 \[Omitted image "image.aict-create-new-value-template-formula"\] Alt text: Formula section in the Add value template form in AI Control Tower.
...
Select the type of AI asset and AI assets that you want to map to the value template.
 ...
 \[Omitted image "image.aict-create-new-value-template-map"\] Alt text: Map section in the Add value template form in AI Control Tower.
...
Select the instance and AI assets for which you want to estimate the real-time value in productivity and click **Validate and calculate**.
 ...
 \[Omitted image "image.aict-create-new-value-template-test"\] Alt text: Test section in the Add value template form in AI Control Tower.
