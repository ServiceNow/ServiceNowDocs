...
This setup can be accessed through the [AI connections](ai-discovery-setup.md) page in AI Control Tower using ServiceNow Graph Connectors to discover AI assets, and usage.
