...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/sh-ai-how-detection-works.html
release: zurich
topic_type: concept
...
For details, see [Agent Client Collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/acc-landing-page.md).
...
-   Connect Armis to catch a service running on devices that don't have an agent installed. See [Connect Armis to detect AI use](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/sh-ai-connect-armis.md).
-   Deploy the ACC agent to the devices using a service to see its content: the prompts, attachments, and model called. See [Connect Agent Client Collector to detect AI use](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/sh-ai-connect-acc.md).
