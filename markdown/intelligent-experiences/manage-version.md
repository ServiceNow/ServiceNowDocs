...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/manage-version.html
release: zurich
topic_type: task
...
See [Default and target model version](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/default-and-target-model-model-version.md) to know more about default and target model versions.
