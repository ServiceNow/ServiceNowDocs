...
The Information Extraction skill processes unstructured documents and returns structured field values that AI agents can use in downstream workflows. You configure the skill by activating it and defining use cases that map document content to output fields.
