...
<table id="choicetable_add_remove_metrics_sn"><thead><tr><th align="left" id="d51875e222">

Option

</th><th align="left" id="d51875e225">

Description

</th></tr></thead><tbody><tr><td id="d51875e231">
...
To start evaluating a managed ServiceNow AI system, you must turn on evaluation at the asset level. See [Enable evaluation for an AI system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/disc-enable-evaluation.md).
