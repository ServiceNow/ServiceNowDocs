...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/mon-ai-evaluated-sessions-overview.html
release: zurich
topic_type: concept
...
-   **Name**
    ...
    Session identifier. Select the name to open the session detail page and begin investigating traces and spans. See [Investigate a low-scoring session](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/mon-ai-investigate-session-task.md).
