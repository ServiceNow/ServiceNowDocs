...
-   **Name**
    ...
    Session identifier. Select the name to open the session detail page and begin investigating traces and spans. See [Investigate a low-scoring session](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/mon-ai-investigate-session-task.md).
