...
6.  In the **Version** dropdown, select the version you want to test.
    ...
    See [Version control for AI agents and agentic workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/version-control.md) for more information about creating and managing versions.
