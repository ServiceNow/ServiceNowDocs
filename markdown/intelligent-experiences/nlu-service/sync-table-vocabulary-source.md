...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/nlu-service/sync-table-vocabulary-source.html
release: zurich
product: NLU Service
...
Proceed to train your model. For more information on model training, see [Train and try your NLU model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/nlu-service/test-train-nlu-model.md).
