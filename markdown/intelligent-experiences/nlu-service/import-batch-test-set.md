...
**Note:** For test sets in languages other than English, you must add the glide.import.csv.charset system property with the value UTF-8. See [Import sets properties](https://www.servicenow.com/docs/access?context=r_ImportSetsProperties&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
