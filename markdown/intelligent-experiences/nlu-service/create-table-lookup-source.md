...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/nlu-service/create-table-lookup-source.html
release: xanadu
product: NLU Service
