...
-   **[NLU Workbench roles](../reference/natural-language-understanding-roles.md#)**  
NLU Workbench is installed with these roles.
-   **[NLU Workbench properties](../reference/nlu-instance-properties.md)**  
Refer to these system properties for the Natural Language Understanding \(NLU\) application.
-   **[NLU language support](nlu-language-support.md)**  
