...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/nlu-service/virtual-agent-nlu-model-builder-integration.html
release: yokohama
product: NLU Service
...
For more information, see [Natural Language Understanding \(NLU\) topic discovery in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/conversational-interfaces/virtual-agent/va-NLU.md).
