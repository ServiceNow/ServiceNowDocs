...
For more information, see [Natural Language Understanding \(NLU\) topic discovery in Virtual Agent](https://www.servicenow.com/docs/access?context=va-NLU&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
