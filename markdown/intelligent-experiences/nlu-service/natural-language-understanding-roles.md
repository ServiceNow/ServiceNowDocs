---
title: \(Legacy\) NLU Workbench roles
...
This role is installed with NLU Workbench - Advanced Features. For more information, see [\(Legacy\) NLU Workbench - Advanced Features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/nlu-workbench-advanced-features.md).

This role is used in Expert Feedback Loop modules. For more information, see [\(Legacy\) NLU Expert Feedback Loop](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/nlu-expert-feedback-loop.md) or [\(Legacy\) Issue Auto Resolution Tuning in NLU](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/issue-auto-resolution-tuning-nlu.md).
