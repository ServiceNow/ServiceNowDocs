...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/nlu-service/test-your-model.html
release: xanadu
product: NLU Service
...
-   Have a trained model for Virtual Agent or AI Search. For more information, see [Build and train your model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/nlu-service/managing-model-content.md).
-   Have a test set for testing models. For more information, see [Test set creation and management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/nlu-service/nlu-test-set-creation-management.md).
