...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/nlu-service/create-static-list-source.html
release: xanadu
product: NLU Service
...
You must retrain the model after updating a list vocabulary source. For more information, see [Train and try your NLU model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/nlu-service/test-train-nlu-model.md).
...
**Parent Topic:**[NLU vocabulary](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/nlu-service/using-nlu-vocabulary.md)
