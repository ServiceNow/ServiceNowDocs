...
-   [\(Legacy\) Activate the NLU Workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/activate-nlu-workbench.md)
-   [\(Legacy\) Install NLU Workbench - Advanced Features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/install-nlu-workbench-adv-features.md)
-   [\(Legacy\) Install Intent Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/install-intent-discovery.md)
...
To get started, see [\(Legacy\) Creating models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/creating-models.md).
...
To learn more, see [\(Legacy\) Build and train your model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/managing-model-content.md).

Train your model using utterances that the model is likely to encounter from your users. To learn more, see [\(Legacy\) Train and try your NLU model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/test-train-nlu-model.md).

## Test and publish your model

Test your model to gauge the performance and identify areas for improvement.

**Note:** Model testing requires the NLU Workbench - Advanced Features store application. For more information, see [\(Legacy\) NLU Workbench - Advanced Features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/nlu-workbench-advanced-features.md).

For more information on testing and thresholds, see [\(Legacy\) Test and publish your model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/testing-your-model.md).

When you're satisfied with the results of testing, publish your model to make it available for use by other applications. For more information, see [\(Legacy\) Publish your NLU model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/publish-nlu-model.md).
...
For more information, see [\(Legacy\) Tune your model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/nlu-tune-your-model.md).

If your model is created for Issue Auto Resolution, you will be taken to IAR Tuning by selecting the name of your model in the IAR tab of the NLU Workbench homepage. For more information, see [\(Legacy\) Issue Auto Resolution Tuning in NLU](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/issue-auto-resolution-tuning-nlu.md).
...
For more information, see [\(Legacy\) NLU model settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/nlu-model-settings.md).
