...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/nlu-service/using-regular-expressions-nlu.html
release: yokohama
product: NLU Service
...
For a full example of regex code used in a pattern entity, see [Create a pattern entity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/nlu-service/create-pattern-entity.md).
