---
title: \(Legacy\) Resolve intent issues
...
|intents need review|Have an nlu\_admin or nlu\_editor review the intent. For more information, see [\(Legacy\) Enable or disable a secondary model intent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/nlu-service/enable-disable-secondary-model-intent.md).|
