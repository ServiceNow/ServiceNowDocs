...
For more information on Virtual Agent, see [Virtual Agent](https://www.servicenow.com/docs/access?context=virtual-agent-landing-page&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
...
For more information on setting up IAR, see [Using Issue Auto Resolution](https://www.servicenow.com/docs/access?context=auto-resolution-va&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
...
For more information, see the [AI Search](https://www.servicenow.com/docs/access?context=overview-ais&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) landing page.
