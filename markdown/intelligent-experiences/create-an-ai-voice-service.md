...
5.  Select a voice personality.
    ...
    1.  Select the language your assistant will use as the default speaking language for interacting with the callers.
        ...
        -   British English
        -   Mexican Spanish
        See [Multilingual support for voice assistants](https://www.servicenow.com/docs/access?context=multi-lingual-support-for-voice-assistants&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US) for more information.
