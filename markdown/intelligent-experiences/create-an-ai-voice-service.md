...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/create-an-ai-voice-service.html
release: yokohama
topic_type: task
...
Set up your preferred user identification and authentication methods to allow access to AI voice agents. See [Authentication factors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/authentication-factors.md) for more information.
...
8.  Integrate a telephony provider to power the voice assistant.
    ...
    For more information, see [Integrating voice assistant with CCaaS provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/integrating-voice-service-with-ccaas-providers.md).
