...
5.  Select language and voice persona.
    ...
    1.  Select the primary language your assistant will use for interacting with callers.
        ...
        -   Slovakian
        -   Ukrainian
        See [Multilingual support for voice assistants](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/multi-lingual-support-for-voice-assistants.md) for more information.
