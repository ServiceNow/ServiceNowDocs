...
Once the clone is confirmed working as expected, you can deactivate the original if it's no longer needed. For details, see [Deactivate a policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/gov-pol-deactivate-policy.md).
