...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/manage-lifecycle-newexperience.html
release: australia
topic_type: concept
...
-   **[Create change requests for AI assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/create-ai-asset-change-request-newexperience.md)**  
Create a change request to modify the relationships between a deployed AI asset and its related assets.
-   **[Create offboarding requests for AI assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/create-ai-asset-offboarding-request-newexperience.md)**  
