...
Scroll down to the next section of the guided setup, **Triggers**, to [define specific conditions where the AI agent should run](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/add-trigger-aia-new.md). Adding triggers is optional.
