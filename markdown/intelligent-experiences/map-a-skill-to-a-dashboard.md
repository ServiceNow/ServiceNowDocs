...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/map-a-skill-to-a-dashboard.html
release: yokohama
topic_type: task
...
breadcrumb: [Configuring AI Analytics, Analyzing Now Assist performance, Now Assist, Enable AI experiences]
---
...
If you're mapping a skill to a custom dashboard, be sure to share appropriate access to the dashboard. See [Share a Platform Analytics dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/share-db-in-ac.md) for more information.
