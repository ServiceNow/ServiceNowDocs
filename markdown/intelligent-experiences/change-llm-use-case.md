...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/change-llm-use-case.html
release: australia
topic_type: task
...
-   Set up a use case for the Information Extraction skill. For more information, see [Set up a use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/set-up-use-case.md).
...
Third-party LLM providers are available for skills and AI agents in addition to Now LLM Service. For more information on LLMs, see [Manage AI models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/manage-large-language-models.md).
