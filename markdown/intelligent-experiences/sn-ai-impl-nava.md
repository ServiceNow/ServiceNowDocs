...
-   **1. Install Now Assist in Virtual Agent**
    ...
    See: [Configuring assistants overview](https://www.servicenow.com/docs/access?context=configure-now-assist-va&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US)
...
-   **2. Review your Virtual Agent topic inventory**
    ...
    -   [Create an Automation Discovery report](https://www.servicenow.com/docs/access?context=create-auto-discovry-report&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US)
...
-   **4. Migrate NLU topics to LLM**
    ...
    See: [Migrating NLU/keyword Virtual Agent topics to LLM topics](https://www.servicenow.com/docs/access?context=llm-topic-migration&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US)
...
-   **Review LLM Virtual Agent topics that come with Now Assist**
    ...
    See: [ITSM Virtual Agent pre-built LLM topics](https://www.servicenow.com/docs/access?context=itsm-va-prebuilt-topics&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US)
...
-   You can customize the look of your assistant and the chat experience during guided setup.
    ...
    For details, see [Brand an assistant](https://www.servicenow.com/docs/access?context=brand-assistant&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).

-   You can choose the chat experience you want for each assistant:
    -   [Standard chat](https://www.servicenow.com/docs/access?context=nava-standard-chat&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US)
...
-   You can integrate Now Assist in Virtual Agent with Microsoft Teams.
    ...
    For details, see [Integrating Now Assist in Virtual Agent with Microsoft Teams](https://www.servicenow.com/docs/access?context=integrating-now-assist-va-msteams&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
