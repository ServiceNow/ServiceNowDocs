...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/sn-ai-impl-nava.html
release: yokohama
topic_type: concept
...
-   Conversational catalog ordering
    ...
    **Note:** Service Catalog items must be marked as conversational to work with Virtual Agent. For details, see [Catalog item conversational details page overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/catalog-item-conv-details-page-overview.md).
...
-   **2. Review your Virtual Agent topic inventory**
    ...
    -   [Create an Automation Discovery report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/create-auto-discovry-report.md)
-   **Review your knowledge base**
    ...
    See: [Knowledge Base readiness for Now Assist on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/sn-ai-impl-kb-readiness.md)
...
-   **5. Review Service Catalog items**
    ...
    See: [Service Catalog readiness for Now Assist on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/sn-ai-impl-srvc-catalog.md)
