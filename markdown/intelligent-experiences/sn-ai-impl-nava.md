...
-   **Review your knowledge base**
    ...
    See: [Knowledge Base readiness for Now Assist on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/sn-ai-impl-kb-readiness.md)
...
-   **5. Review Service Catalog items**
    ...
    See: [Service Catalog readiness for Now Assist on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/sn-ai-impl-srvc-catalog.md)
...
-   You can integrate Now Assist in Virtual Agent with Microsoft Teams.
    ...
    For details, see [Integrating Now Assist in Virtual Agent with Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/integrating-now-assist-va-msteams.md).
