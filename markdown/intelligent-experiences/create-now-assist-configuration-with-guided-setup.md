...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/create-now-assist-configuration-with-guided-setup.html
release: xanadu
topic_type: task
...
11. Select options for the following fields on the Configure experience tab:
    ...
    If you proceed without providing the required values for each form field, system will promt you to provide configuration.
