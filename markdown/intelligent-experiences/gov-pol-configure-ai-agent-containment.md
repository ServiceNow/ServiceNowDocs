...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/gov-pol-configure-ai-agent-containment.html
release: zurich
topic_type: task
