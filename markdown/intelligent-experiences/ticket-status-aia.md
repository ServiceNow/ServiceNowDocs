...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/intelligent-experiences/ticket-status-aia.html
release: australia
topic_type: concept
...
The Request status AI agent enables you to view your open tickets. It also enables you to check the status of tickets and view a summary of the previous comments from the AI agent or others working on the ticket. You can also add comments through ServiceNow Otto in Virtual Agent, the ServiceNow Otto panel, or Microsoft Teams.
