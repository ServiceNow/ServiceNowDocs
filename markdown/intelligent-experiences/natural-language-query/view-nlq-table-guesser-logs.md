...
For more information on CMDB queries, see [Exploring CMDB Query Builder](https://www.servicenow.com/docs/access?context=querying-cmdb&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
