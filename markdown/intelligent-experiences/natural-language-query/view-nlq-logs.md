...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/natural-language-query/view-nlq-logs.html
release: zurich
...
-   Source: the location from which the query was initiated. The value **AC** indicates Analytics Center. The value **CMDB\_WS** indicates CMDB Workspace.
...
Based on your users' attempted queries, consider adding more [synonyms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/natural-language-query/create-nlq-synonym.md) or [shortcuts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/natural-language-query/create-nlq-shortcut.md).
