...
-   Synonyms can point to reference fields, using dot-walking. For more information, see [Dot-walking examples](https://www.servicenow.com/docs/access?context=dot-walking-examples&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
...
-   **Record**: Synonym for a value on the CMDB tables \[cmdb\_rel\_type\_table\]. For more information, see [Querying the CMDB](https://www.servicenow.com/docs/access?context=querying-cmdb&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
