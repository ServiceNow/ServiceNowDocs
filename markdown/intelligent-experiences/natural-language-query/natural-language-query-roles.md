...
-   NLQ Cmdb Implicit Relationships. For more information see [Intelligent Search for CMDB](https://www.servicenow.com/docs/access?context=intelligent-search-cmdb&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
