...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/now-assist-readiness-evaluation/reviewing-agentic-ai-assesment.html
release: xanadu
...
\[Omitted image "nare-agentic-ai-assessment-itsm.png"\] Alt text: The Agentic AI - ITSM Categorize Incidents use case assessment is shown, along with the user case's relevant questions and records.
