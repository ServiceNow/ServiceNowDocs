...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/now-assist-readiness-evaluation/reviewing-now-assist-assessment.html
release: yokohama
...
For more information about how to search for tables in the navigation filter, see [Navigate directly to a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/configure-user-experiences/t_NavigateDirectlyToATable.md).
