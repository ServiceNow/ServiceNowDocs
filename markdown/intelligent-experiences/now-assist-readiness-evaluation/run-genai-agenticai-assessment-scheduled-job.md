...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/now-assist-readiness-evaluation/run-genai-agenticai-assessment-scheduled-job.html
release: zurich
...
Before you can view the agentic AI or generative AI assessment results, you must first run the GenAI/AgenticAI Assessment scheduled job.
...
2.  Set the Scheduled Jobs filter to `Application is AI Readiness Evaluation`, and then select **Run**.
...
4.  Select **Execute Now**.
    ...
    This action begins the scheduled job for the agentic and generative AI assessments found in **Workspaces** &gt; **AI Readiness Evaluation**.
