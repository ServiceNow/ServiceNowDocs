...
Install the Now Assist for Spokes application from the ServiceNow Store. For details, see [ServiceNow Otto for Integration Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/integrate-applications/now-assist-spokes.md).
