...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/disc-asset-update-use-purpose.html
release: zurich
topic_type: task
...
4.  In the **Use and purpose** section, update the relevant fields.
    ...
    For a description of the fields and their values, see [Use and purpose fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/disc-asset-use-purpose-fields.md).
