...
For more information on how to use Flow Designer in Workflow Studio, see [Exploring flows](https://www.servicenow.com/docs/access?context=exploring-flows&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US). For information about the Actions included in Predictive Intelligence for Workflow Studio, see the Spoke actions table in [Machine Learning solutions for Flow Designer](https://www.servicenow.com/docs/access?context=predictive-intelligence-spoke&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
...
[Machine Learning solutions for Flow Designer](https://www.servicenow.com/docs/access?context=predictive-intelligence-spoke&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US)
