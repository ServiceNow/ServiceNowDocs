...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/predictive-intelligence/install-predictive-intelligence.html
release: australia
...
4.  On the non-production instance, review the default solution definition records to determine if the filter, input fields, and output field are sufficient to predict your incident or task records.
    ...
    If necessary, [create a solution definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/predictive-intelligence/create-solution-definition.md) for each record set you want to predict.
