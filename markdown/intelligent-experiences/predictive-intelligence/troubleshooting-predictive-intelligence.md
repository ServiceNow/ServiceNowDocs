...
4.  Adjust the class precision and coverage values to increase coverage or precision. See [Tune a trained classification solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/predictive-intelligence/configure-class-precision-coverage.md).
