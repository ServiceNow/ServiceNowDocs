...
-   Similarity solutions:
    ...
    Identifies similarities between new and existing records to recommend resolutions. See [Create and train a similarity solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/predictive-intelligence/create-similarity-solution.md).

-   Clustering solutions:

    Groups similar records into clusters to identify patterns and major incidents. See [Create and train a clustering solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/predictive-intelligence/create-clustering-solution.md).
