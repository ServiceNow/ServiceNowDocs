...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/predictive-intelligence/training-ml-solutions.html
release: yokohama
...
-   Similarity solutions:
    ...
    Identifies similarities between new and existing records to recommend resolutions. See [Create and train a similarity solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/predictive-intelligence/create-similarity-solution.md).

-   Clustering solutions:

    Groups similar records into clusters to identify patterns and major incidents. See [Create and train a clustering solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/predictive-intelligence/create-clustering-solution.md).

-   Regression solutions:

    **Important:** With the Yokohama release, support for creating new regression solutions was removed. You can still edit and train existing regression solutions, but you won't be able to create new ones.

    Uses historic data to predict numeric outputs, such as estimating the time it takes to resolve an incident or case. See [Create and train a regression solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/predictive-intelligence/create-regression-solution.md).
