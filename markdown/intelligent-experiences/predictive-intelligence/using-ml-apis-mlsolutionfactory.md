...
1.  Developers customize a MLSolutionUtil scripted extension point implementation using the MLSolutionFactory scriptable object.
    ...
    -   See [Register a custom script include](https://www.servicenow.com/docs/access?context=impl-client-ext-pts-base-code&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
...
![The basic process the applications can use to invoke prediction APIs using a scripted extension point implementation using MLSolutionFactory scriptable objects.](../images/ml-api-request-flow.png)

For more information, see

-   [Predictive Intelligence REST API](https://www.servicenow.com/docs/access?context=agent-intelligence-api&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
-   [MLSolutionFactory - Global](https://www.servicenow.com/docs/access?context=MLSolutionFactoryAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
