...
1.  Developers customize a MLSolutionUtil scripted extension point implementation using the MLSolutionFactory scriptable object.
    ...
    -   See [Register a custom script include](https://www.servicenow.com/docs/access?context=impl-client-ext-pts-base-code&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US)
...
-   [Predictive Intelligence REST API](https://www.servicenow.com/docs/access?context=agent-intelligence-api&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US)
-   [MLSolutionFactory - Global](https://www.servicenow.com/docs/access?context=MLSolutionFactoryAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US)
