...
1.  Developers customize a MLSolutionUtil scripted extension point implementation using the MLSolutionFactory scriptable object.
    ...
    -   See [Register a custom script include](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/web-services/impl-client-ext-pts-base-code.md)
...
-   [Predictive Intelligence REST API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/agent-intelligence-api.md)
-   [MLSolutionFactory - Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/server-api-reference/MLSolutionFactoryAPI.md)
