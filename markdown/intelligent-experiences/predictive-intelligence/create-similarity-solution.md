...
Review the trained similarity solution examples on the Related Links section of your Solution Definition form. See [Review solution similarity examples](review-similarity-examples.md).
