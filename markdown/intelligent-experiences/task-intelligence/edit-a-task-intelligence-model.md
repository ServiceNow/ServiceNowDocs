...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/task-intelligence/edit-a-task-intelligence-model.html
release: xanadu
...
-   **[Edit a model to predict incident fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/task-intelligence-for-itsm/edit-your-model.md)**
...
-   **[Create and edit a case field prediction model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/csm-task-intel-create-cat-solution.md)**

    Create, train, and edit a model to predict fields for customer service cases.

-   **[Create a model to predict case sentiment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/csm-task-intel-create-sentiment-solution.md)**

    Edit and test the pre-trained sentiment model to predict sentiment for customer service cases.

-   **[Create a model to detect case language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/csm-task-intel-create-language-solution.md)**
