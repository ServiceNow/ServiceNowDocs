...
-   **[Edit a model to predict incident fields](https://www.servicenow.com/docs/access?context=edit-your-model&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US)**
...
-   **[Create and edit a case field prediction model](https://www.servicenow.com/docs/access?context=csm-task-intel-create-cat-solution&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)**

    Create, train, and edit a model to predict fields for customer service cases.

-   **[Create a model to predict case sentiment](https://www.servicenow.com/docs/access?context=csm-task-intel-create-sentiment-solution&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)**

    Edit and test the pre-trained sentiment model to predict sentiment for customer service cases.

-   **[Create a model to detect case language](https://www.servicenow.com/docs/access?context=csm-task-intel-create-language-solution&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)**
