...
-   **[Reference for Task Intelligence for ITSM](https://www.servicenow.com/docs/access?context=task-intelligence-itsm-reference&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US)**

    Reference topics provide additional information about components installed with Task Intelligence for ITSM.

-   **[View Task Intelligence Analytics](https://www.servicenow.com/docs/access?context=csm-task-intel-case-monitoring&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US)**
