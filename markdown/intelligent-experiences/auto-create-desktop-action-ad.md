---
title: Automate repetitive tasks by auto-capturing steps in Agentic Desktop
description: Create desktop actions by auto-capturing steps to automate repetitive tasks in Agentic Desktop. You can save the steps that you perform on the application elements as a reusable desktop action of type UI block.
locale: en-US
release: australia
topic_type: task
...
[Action recorder in Agentic Desktop](../concept/action-recorder-ad.md)

[Screen, anchor, and step properties in Agentic Desktop](../reference/screen-anchor-and-action-properties-ad.md)

[Automate repetitive tasks by manually capturing steps in Agentic Desktop](manual-create-desktop-action-ad.md)
