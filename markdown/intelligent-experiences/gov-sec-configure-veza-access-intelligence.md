...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/gov-sec-configure-veza-access-intelligence.html
release: zurich
topic_type: task
...
3.  In AI Control Tower, navigate to **Settings** &gt; **Integrations** &gt; **Connectors** to configure integrations for all of the hyperscalers that you want to connect to.
    ...
    For more information, see [Configuring integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/aict-configuring-integrations.md).
