...
-   **1. Review existing KB articles and knowledge bases**
    ...
    See: [Knowledge Management Overview dashboard](https://www.servicenow.com/docs/access?context=km-overview-dash&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
...
-   **2. Review the structural formatting of KB articles**
    ...
    -   [Activate the Knowledge Management Advanced plugin](https://www.servicenow.com/docs/access?context=activate-knowledge-advanced-plugin&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
...
-   **4. Perform maintenance audits**
    ...
    -   [Knowledge Management Overview dashboard](https://www.servicenow.com/docs/access?context=km-overview-dash&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
    -   [Retire a knowledge article](https://www.servicenow.com/docs/access?context=c_RetiredKnowledgeArticles&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
    -   [Identify and review duplicate Knowledge articles](https://www.servicenow.com/docs/access?context=Now-Assist-identify-and-review-duplicate-articles&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) \(requires Now Assist in Knowledge Management\)
-   **5. Review top searched queries**
    ...
    See: [Knowledge Management dashboard](https://www.servicenow.com/docs/access?context=knowledge-management-dashboard&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
