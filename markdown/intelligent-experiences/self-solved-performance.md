...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/self-solved-performance.html
release: xanadu
topic_type: concept
...
\[Omitted image "naa-self-service-performance.png"\] Alt text: Self-Service performance indicators
...
-   **Total number of queries**
    ...
    \[Omitted image "naa-total-number-of-queries.png"\] Alt text: Total number of queries indicator
...
-   **Total number of query responses**
    ...
    \[Omitted image "naa-total-number-of-query-responses.png"\] Alt text: Total number of query responses indicator
...
-   **Query resolution status**
    ...
    \[Omitted image "naa-query-resolution-status.png"\] Alt text: Query resolution status indicator
...
-   **Deflection rate**
    ...
    \[Omitted image "naa-deflection-rate.png"\] Alt text: Deflection rate indicator
...
-   **Requestor initiated events**
    ...
    \[Omitted image "naa-req-events.png"\] Alt text: Requestor initiated events indicator
...
-   **Successful conversations by capability**
    ...
    \[Omitted image "naa-successful-conversation-by-capability.png"\] Alt text: Successful conversations handled by Now Assist capability indicator
