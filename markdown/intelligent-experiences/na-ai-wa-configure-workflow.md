...
15. Select **Save and test**.
    ...
    You're directed to the **Testing** tab of AI Agent Studio. For more information, see [Test AI agent or agentic workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/na-ai-wa-test.md).
