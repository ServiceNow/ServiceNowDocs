...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/gov-sec-configure-overview.html
release: zurich
topic_type: task
...
1.  Configure a trace connection for your external AI system.
    ...
    For more information, see [Configuring trace connections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/aict-configuring-trace-connections.md).
...
2.  Generate an API key to authenticate trace data requests from your external AI system.
    ...
    For more information, see [API key credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/API-key-credential-form.md).
...
5.  Make sure that the AiSP AWS IAM Privileged Policy Checker AI skill is enabled.
    ...
    For more information, see [Activate an AI skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/configure-a-now-assist-skill.md).
