---
title: Review the performance of an AI specialist in the legacy AI Agent Studio
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/view-aiw-performance.html
release: zurich
topic_type: task
...
2.  In the **AI specialists** tab, select the AI specialist you want to view the performance of.

3.  Navigate to the **Performance** tab in the AI specialist guided setup.

4.  Review the performance analytics of the AI specialist.
...
If you want to make changes to your AI specialist based on the performance analytics, see [Edit the profile of an AI specialist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/modify-aiw-profile.md) or [Edit the tasks of an AI specialist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/modify-aiw-tasks.md).
