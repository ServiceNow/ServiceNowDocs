...
**Note:** The **Opt out** button appears only if you’ve installed at least one Now Assist application or plugin. For a list of all Now Assist applications, see [Exploring Now Assist](../../now-assist-platform/concept/exploring-now-assist-platform.md).
...
3.  In the Settings panel, select the **Data sharing and processing** &gt; **Data sharing** tab.
    ...
    ![Data sharing in Now Assist Admin Settings that shows the data sharing preference. It also provides a data sharing opt-out button.](../image/naa-data-sharing.png)
