...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/configure-a-now-assist-skill.html
release: yokohama
topic_type: task
...
14. Select the X icon in the role bubble to remove an existing roles.
    ...
    If you don't see this option, you must activate the Now Assist panel. For more information, see [Activate Now Assist panel standard chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/activate-now-assist-panel.md).
