...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/measure-ai-assign-default-template.html
release: zurich
topic_type: task
...
Confirm that a published value template exists. See [Create a value template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/measure-ai-create-value-template.md) for more information.
