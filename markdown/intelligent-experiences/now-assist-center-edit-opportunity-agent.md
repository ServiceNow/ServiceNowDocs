...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/now-assist-center-edit-opportunity-agent.html
release: australia
topic_type: task
...
3.  Select the **AI Agents** tab to view AI agents created from the automation opportunity.
    ...
    \[Omitted image "ai-agent-advisor-opportunity-edit-agent-3.png"\] Alt text: AI Agents tab on the resolution steps page showing the agents created for the automation opportunity.
...
5.  Edit the AI agent in the Agent guided setup tab using AI Agent Studio capabilities.
    ...
    For more details on the guided setup forms, see [Create an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/configure-next-best-action-agent.md).
