...
To view the dashboard, navigate to **All** &gt; **Assistant Designer** &gt; **Analytics** and select the **Voice** tab. See Voice page in assistant analytics for more information.
