...
1.  Ensure entitlement for at least one Now Assist application. For a list of available applications, see [Exploring Now Assist](../../now-assist-platform/concept/exploring-now-assist-platform.md).
...
2.  In the ServiceNow Store, check version compatibilities and dependencies for Now Assist apps.
    ...
    For more information, see [Evaluating version requirements and dependencies](https://www.servicenow.com/docs/access?context=versions-dependencies&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
