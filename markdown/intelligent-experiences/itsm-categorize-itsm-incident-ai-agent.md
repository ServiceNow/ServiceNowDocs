---
title: Categorize ITSM incident AI agent
description: This AI agent assigns the appropriate category and subcategory to an incident.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/itsm-categorize-itsm-incident-ai-agent.html
release: australia
...
1.  Use the Fetch all data - Categorize ITSM incident AI agent tool to fetch incident details, available categories, and available subcategories.
2.  Assign a category and subcategory.
...
Fetch all data - Categorize ITSM incident AI agent
