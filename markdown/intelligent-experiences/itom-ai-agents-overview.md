...
breadcrumb: [IT Operations Management, AI agents library, AI agents and agentic workflows, Enable AI Experiences]
---
...
-   **[Alert impact summary AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-alert-impact-summary-ai-agent.md)**  
This AI agent responds to alerts with an impact summary.
-   **[Alert information retrieval AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-alert-information-retrieval-ai-agent.md)**  
This AI agent looks up and returns information on an em\_alert record.
-   **[Analyze potential impact AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-analyze-potential-impact-ai-agent.md)**  
...
-   **[AWS CloudWatch API AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-aws-cloudwatch-api-agent-ai-agent.md)**  
...
-   **[AWS CloudWatch MCP server AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-aws-cloudwatch-mcp-server-agent-ai-agent.md)**  
...
-   **[Azure Monitor MCP AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-azure-monitor-mcp-agent-ai-agent.md)**  
...
-   **[CSDM business application to infrastructure AI specialist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-csdm-business-application-to-infrastructure-ai-specialist-ai-agent.md)**  
...
-   **[Datadog APM MCP server AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-datadog-apm-mcp-server-agent-ai-agent.md)**  
...
-   **[Dynatrace analysis AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-dynatrace-analysis-ai-agent.md)**  
This AI agent provides the details for a given alert by querying the Dynatrace API.
-   **[Dynatrace MCP server AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-dynatrace-mcp-server-agent-ai-agent.md)**  
This AI agent provides the details for a given alert by querying the Dynatrace API.
-   **[Gemini Cloud Assist A2A investigation AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-gemini-cloud-assist-a2a-investigation-agent-ai-agent.md)**  
...
-   **[Kentik analysis AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-kentik-analysis-ai-agent.md)**  
This AI agent fetches the incident insights report for a Kentik alert.
-   **[LogicMonitor API AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-logicmonitor-api-agent-ai-agent.md)**  
...
-   **[Network SME AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-network-sme-agent-ai-agent.md)**  
...
-   **[New Relic analysis AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-new-relic-analysis-ai-agent.md)**  
This AI agent fetches the incident insights report for a New Relic incident.
-   **[New Relic MCP server AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-new-relic-mcp-server-agent-ai-agent.md)**  
...
-   **[Prometheus API AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-prometheus-api-agent-ai-agent.md)**  
...
-   **[Service map creation AI specialist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-service-map-creation-ai-specialist-ai-agent.md)**  
...
-   **[SolarWinds analysis AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-solarwinds-analysis-ai-agent.md)**  
...
-   **[Splunk MCP server AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-splunk-mcp-server-agent-ai-agent.md)**  
...
-   **[SRE investigate AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-sre-investigate-ai-agent.md)**  
...
-   **[ThousandEyes MCP server AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/itom-obs-thousandeyes-mcp-server-agent-ai-agent.md)**  
