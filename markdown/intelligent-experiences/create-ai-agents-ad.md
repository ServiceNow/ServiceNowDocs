---
title: Creating AI agents for Agentic Desktop
...
## Overview of AI agents for Agentic Desktop
...
3.  [Define security controls for an AI agent](../../../administer/now-assist-ai-agents/task/define-sec-controls-aia.md)
    ...
    Trigger conditions are not supported for AI agents that execute desktop actions. You must manually trigger these agents from the system where the Agentic Desktop application is installed.
