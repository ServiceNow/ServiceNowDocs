...
**Important:** The Extract Information from documents skill can't be cloned. To use the skill, create a new use case or copy an existing one. For more information, see [Set up a use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/set-up-use-case.md) or [Copy a use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/make-copy-use-case.md).
