...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/example-shipping-magmt-concept-ad.html
release: zurich
topic_type: concept
...
For more information, see [Example: Use AI agents to automatically enter data into the shipping management app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/example-use-shipping-ai-agent-ad.md).
