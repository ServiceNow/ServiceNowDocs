...
1.  Configure the Content Insights AI agent.
    ...
    For more information, see [Configure the Content Insights AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/configure-content-insights-ai-agent.md).
