...
description: App generation enables developers to kick start application building through conversation.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/now-assist-app-generation-skill.html
release: xanadu
topic_type: concept
last_updated: "2024-08-15"
reading_time_minutes: 3
keywords: [Now Assist, Gen AI, Generative AI, App generation, Creator, App Engine Studio]
...
\[Omitted image "app-generation-workflow-infographic-asset-0020323.png"\] Alt text: Infographic that shows the three phases to using app generation, with a fourth on verifying the app in App Engine Studio. For the text description, refer to the text that follows.
