...
2.  Select **Start manual test**.
    ...
    If you want to start an automated test, see [Evaluate an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/execute-aia-eval.md) for more details on that process.
...
7.  In the **Task** field, provide a concise summary of the task to be achieved.
    ...
    **Note:** In the task summary, include a reference number or specific record for better results during your testing.
    ...
    \[Omitted image "image.test-aia-manually-new"\] Alt text: Complete the testing form
