...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/test-ai-agent.html
release: yokohama
topic_type: task
...
2.  Select **Start manual test**.
    ...
    If you want to start an automated test, see [Evaluate an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/execute-aia-eval.md) for more details on that process.

3.  In the **Test type** drop-down meny, select **AI agent or workflow**.

    If you want to test user access security controls, see [Test AI agent user access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/test-aia-access.md).
