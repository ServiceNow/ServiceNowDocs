...
To get started with Now Assist, you must install at least one Now Assist application on your instance. The Now Assist Admin console can guide your implementation, starting with installation. Check out the [Now Assist Journey Checklist for more information.](../../now-assist-platform/concept/configuring-now-assist.md)
...
[Turn on the Now Assist panel](activate-now-assist-panel.md) or [Activate a Now Assist skill](configure-a-now-assist-skill.md)
