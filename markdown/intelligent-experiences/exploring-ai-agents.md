...
-   **Agentic system**: An [agentic system](../../now-assist-platform/concept/now-assist-glossary.md#) is a type of software or AI that perceives its environment, decides based on that perception, and takes actions to achieve specific goals, often with minimal human intervention. An agentic system can learn, adapt, and operate independently to solve problems or perform tasks.
