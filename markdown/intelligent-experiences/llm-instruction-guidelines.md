...
|Skill|Reference|
|-----|---------|
|App generation|[General guidelines for using app generation in ServiceNow Studio](https://www.servicenow.com/docs/access?context=sns-app-gen-guidelines&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US)|
|Analytics generation|[Guidelines and example questions](https://www.servicenow.com/docs/access?context=example-questions-generating-dv&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)|
|Catalog item generation|[How to describe a catalog item](https://www.servicenow.com/docs/access?context=how-to-describe-catalog-item&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)|
|Code generation|[General guidelines for code generation](https://www.servicenow.com/docs/access?context=general-guidelines-code-generation&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US)|
|Flow generation|[Flow generation](https://www.servicenow.com/docs/access?context=flow-generation&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US)|
|LLM topic skill for Virtual Agent|[LLM description and instruction guidelines for Virtual Agent topics](https://www.servicenow.com/docs/access?context=va-llm-instruction-guidelines&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US)|
...
|RPA bot generation|[General guidelines for RPA bot generation](https://www.servicenow.com/docs/access?context=rpa-bot-generation&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US)|
|UI generation|[General guidelines experience generation](https://www.servicenow.com/docs/access?context=general-guidelines-ui-generation&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US)|
