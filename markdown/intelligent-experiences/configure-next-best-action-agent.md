...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/configure-next-best-action-agent.html
release: xanadu
topic_type: task
...
Assign one or more specific roles from the drop-down.**Note:** Selecting the role is possible only when you chose the **Users with specific roles** user access.
        ...
        -   For more information about understanding the user identities that will execute the AI agent, see [User identity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/aia-security-implementation.md).
...
Select a specific AI user from the drop-down menu.
    ...
    6.  Specify categories for long-term memory.
        ...
        For more information about setting up categories for AI agent memories, see [Set up long-term memory](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/long-term-memory-aia.md).
...
Additional tools and data sources that you can provide your AI agent to accomplish its role. The available tools are:-   [Catalog item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-catalog-ai-agent.md): Conversational catalog items that you can add to your AI agent.
-   [Conversational topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-va-topic-ai-agent.md): Use conversations to get additional information from users by adding a Virtual Agent topic to an AI agent.
-   [File upload](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-file-retrieval.md): Upload files to let AI agents analyze specialized knowledge.
-   [Flow action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-flow-action-ai-agent.md):

Custom automated processes in your system that you can add to your AI agent.

-   [Knowledge graph](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-knowledge-graph.md): Add a knowledge graph to an AI agent in AI Agent Studio to enhance the performance of AI agents.
-   : Add a model context protocol client
-   [Now Assist Skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-skill-ai-agent.md): Generative AI skills in your system that you can add to your AI agent.

Example for Next Best Action AI agent: Incident summarization.

-   [Record operation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-database-op-ai-agent.md): To create, update, look up, or delete records from an AI agent, add a record operation.
-   [Script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-script-ai-agent.md): Editable scripts and APIs that you can add to your AI agent.

Example for the Next Best Action AI agent: Get similar incident.

-   [Search retrieval](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-retriever-ai-agent.md): Information retrieval processes in your system that you can add to your AI agent.

Example for the Next Best Action AI agent: Get relevant knowledge articles.

-   [Sub flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-sub-flow-ai-agent.md): Automated flows in your system that you can add to your AI agent.
-   [Add a web search to an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/add-web-search-ai-agent.md): Add a web search tool to an AI agent using third-party search API such as Microsoft Bing or Google.
...
7.  Define AI agent availability.
    ...
    1.  Turn on the AI agent by toggling the **Status**, then select if the AI agent should be displayed in the Now Assist panel or Virtual Agent.
        ...
        **Note:** If the Now Assist panel display option isn’t available, you must enable the panel first. For more information, see [Turn on the Now Assist panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/activate-now-assist-panel.md).
...
8.  Select **Save and test** to complete the configuration steps or review a previous step by selecting **Back**.
    ...
    Selecting Save and test leads you to the AI agent testing page, where you can test the AI agent that you created. For more information, see [Test an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/test-ai-agent.md).
