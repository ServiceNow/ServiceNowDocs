...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/generate-kb-article-with.html
release: yokohama
topic_type: task
...
3.  Select a KB article from the list.
    ...
    \[Omitted image "image.nacm-kb-inline-variant"\] Alt text: KB inline variant
...
6.  Press enter to start the KB article generation.
    ...
    \[Omitted image "image.nacm-kb-disclaimer"\] Alt text: KB article preview and disclaimer
...
7.  Select the text to further refine the content with Now Assist Context Menu pop-over variant.
    ...
    \[Omitted image "image.nacm-kb-popover-variant"\]
