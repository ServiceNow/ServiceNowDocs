...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/cu-limitations.html
release: australia
...
-   20 pages per file if a table is defined for the use case.
 ...
 Image mode is selected during use case setup. For more information, see [Set up a use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/set-up-use-case.md).
