...
![Now Assist Admin Overview page with plugins, skills installed, and the Now Assist journey checklist.](../image/now-assist-home.png "Usage analytics on the Now Assist Admin Overview page")
...
For more detailed information about performance, see [Now Assist Analytics](../../now-assist-analytics/concept/now-assist-analytics.md) and [Performance Analytics indicators for generative AI](../reference/performance-analytics-indicators-for-generative-ai.md)
...
See [Now Assist value insights](../../now-assist-analytics/concept/now-assist-value-insights.md) for information on performance metrics.

**Parent Topic:**[Configuring Now Assist settings and features](configuring-na-landing.md)
