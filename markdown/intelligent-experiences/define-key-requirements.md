...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/define-key-requirements.html
release: yokohama
topic_type: task
...
Select **Save and continue** to move to the next step, [Define security controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/define-sec-controls-aw.md).
