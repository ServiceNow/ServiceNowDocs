...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/config-aia-notifications.html
release: yokohama
topic_type: task
