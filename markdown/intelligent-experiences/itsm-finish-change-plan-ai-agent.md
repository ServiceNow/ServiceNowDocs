---
title: Finish change plan AI agent
description: This AI agent flushes the cache and informs the user that execution finished successfully.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/itsm-finish-change-plan-ai-agent.html
release: australia
...
1.  Flush the cache.
2.  Inform the user that execution has finished successfully.
