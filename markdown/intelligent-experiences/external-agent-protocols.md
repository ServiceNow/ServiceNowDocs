...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/intelligent-experiences/external-agent-protocols.html
release: yokohama
topic_type: concept
...
See [Create an external AI agent with manual integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/create-manual-external-agent.md) for instructions for manually integrating an external AI agent.
...
See [Create an external AI agent with the Agent2Agent protocol](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/create-a2a-agent.md) for instructions for using this protocol to create an AI agent.
...
</table>**Parent Topic:**[Create an external AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/intelligent-experiences/create-external-aia.md)
