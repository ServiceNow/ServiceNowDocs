---
title: Create a tool from AI skill
description: Create a tool from generative AI skills to expose it to Model Context Protocol \(MCP\) clients from an MCP Server.
locale: en-US
...
Select a AI skill type from the list.
