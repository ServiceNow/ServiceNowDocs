...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/incident-trends.html
release: xanadu
topic_type: concept
...
You must also configure Group Action Framework \(GAF\). See [Group Action Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/group-action-framework.md) for more information on what GAF is and how to set it up.
