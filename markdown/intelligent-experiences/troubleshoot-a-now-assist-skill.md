...
Certain skills have diagnostic scripts that you can run from the Now Assist Admin console. These diagnostic scripts check for successful skill execution and setup of the underlying [capability definitions](../../generative-ai-controller/reference/reference-for-generative-ai-controller.md). If you have made a copy of a skill, you won’t be able to run diagnostics on the skill copy.
