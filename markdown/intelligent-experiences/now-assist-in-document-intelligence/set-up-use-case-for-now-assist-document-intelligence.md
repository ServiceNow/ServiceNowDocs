...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/now-assist-in-document-intelligence/set-up-use-case-for-now-assist-document-intelligence.html
release: zurich
...
For more information on use cases, see [Use cases in Now Assist in Document Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/now-assist-in-document-intelligence/use-cases-now-assist-document-intelligence.md).
...
5.  Define the use case.
    ...
    3.  Select the language of the files processed for the use case.
        ...
        For more information, see [Languages supported by Now Assist in Document Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/now-assist-in-document-intelligence/languages-supported-now-assist-document-intelligence.md).

    4.  Select the large language model \(LLM\) that will make predictions for the documents processed with this use case.

        For more information, see [Large language models used by Now Assist in Document Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/now-assist-in-document-intelligence/llms-now-assist-document-intelligence.md).
...
6.  Defineinformationor questions.
    ...
    3.  On the form, fill in the fields.
        ...
        -   [Question form for use case setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/now-assist-in-document-intelligence/document-qna-single-field-form.md)
        -   [Field form for use case setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/now-assist-in-document-intelligence/document-extraction-single-field-form.md)
        -   [Table form for use case setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/now-assist-in-document-intelligence/document-extraction-table-form.md)
    ...
    5.  To edit or delete a field, table, or question, select the appropriate option in the options menu \( \[Omitted image "icon-docintel-field-options-menu.png"\] Alt text: Field options menu icon\) of the row.
...
4.  Select **Upload**.
        ...
        **Tip:** Select the **Open in a new tab** button \(\[Omitted image "icon-docintel-na-test-tab.png"\] Alt text: Open in a new tab icon.\) to view the document in a larger workspace on a separate browser tab.
...
8.  Add integrations.
    ...
    For more information on Document Intelligence integrations, see [Integrate with a custom application or workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/document-intelligence/configure-integration-setup.md).
...
**Parent Topic:**[Configuring Now Assist in Document Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/now-assist-in-document-intelligence/docintel-configuring-now-assist.md)
