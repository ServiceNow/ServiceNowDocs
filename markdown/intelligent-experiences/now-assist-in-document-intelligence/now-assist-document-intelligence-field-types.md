...
A reference field stores a reference to a field on another table. For example, the Caller field on the Incident table is a reference to the User \[sys\_user\] table.
 ...
 For more information, see [Reference field type](https://www.servicenow.com/docs/access?context=c_ReferenceField&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
