...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/supporting-information-ai-agent-advisor.html
release: zurich
topic_type: concept
...
Get a quick overview of the important information that is related to the AI Agent Advisor application.
...
For more information, see [AI Admin Center workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/now-assist-center-workspace.md).

## Application information

AI Agent Advisor \(sn\_agent\_miner\) is available as a plugin from the ServiceNow Store.

This store app has the following dependencies.

|Plugin name|Plugin ID|Version|Type|
|-----------|---------|-------|----|
|AI Agent Advisor|sn\_agent\_miner|0.2.1|App|
...
For more information, see [Configuring AI Agent Advisor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/configuring-ai-agent-advisor.md).
