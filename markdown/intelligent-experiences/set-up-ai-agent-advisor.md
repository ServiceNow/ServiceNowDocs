...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/set-up-ai-agent-advisor.html
release: australia
topic_type: task
...
All required plugins must be installed before attempting to run AI Agent Advisor. For a list of dependencies, see [Supporting information for AI Agent Advisor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/supporting-information-ai-agent-advisor.md).
...
**Parent Topic:**[Configuring AI Agent Advisor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/configuring-ai-agent-advisor.md)
