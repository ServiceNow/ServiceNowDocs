...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/gov-sec-configure-design-time.html
release: zurich
topic_type: task
...
1.  Install the AI Service Graph Connector for each third-party AI security tool for which you want data reflected in design-time metrics.
    ...
    For more information, see [Getting started with Service Graph Connectors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/cmdb-sgc-intro.md).
