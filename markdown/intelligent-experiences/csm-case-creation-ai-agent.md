---
title: Case creation AI agent
description: The Case creation AI agent is designed to automate and manage the end-to-end process of case creation. This agent should be invoked when a case needs to be created.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/csm-case-creation-ai-agent.html
release: australia
...
The agent helps users complete tasks related to case creation.

1.  Get the source record details.
2.  Identify if the source record is a duplicated.
3.  Determine case type.
4.  Validate documents.
5.  Retrieve if the source record associated record is present.
6.  Initiate case creation process.
