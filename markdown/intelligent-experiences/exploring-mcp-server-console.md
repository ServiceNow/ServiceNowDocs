...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/exploring-mcp-server-console.html
release: zurich
topic_type: concept
...
3.  If needed, you can create additional tools from generative AI skills and configure which fields are exposed to clients and then add the tools to servers.
...
|Control which tools and fields are exposed to MCP clients.|[Creating tools for a Model Context Protocol server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/creating-tools-mcp-server.md)|AI administrator|
...
[Model Context Protocol Client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/mcp-client.md)
