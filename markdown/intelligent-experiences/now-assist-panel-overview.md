...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/now-assist-panel-overview.html
release: xanadu
topic_type: concept
...
-   You must activate the Now Assist panel. For more information, see [Turn on the Now Assist panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/activate-now-assist-panel.md).
...
\[Omitted image "now-assist-panel-screenshot-example.png"\] Alt text: Now Assist panel
...
1 - \[Omitted image "icon-ai-sparkle.png"\] Alt text: Now Assist icon
...
Now Assist icon
 ...
 If a number in a square appears, it indicates the number of messages you have missed when the Now Assist panel was closed. \[Omitted image "now-assist-sparkle-icon-number.png"\] Alt text: Now Assist icon with messages

</td></tr><tr><td>

2 - \[Omitted image "now-assist-reset-icon.png"\] Alt text: Reset icon
...
3 - \[Omitted image "now-assist-pin-icon.png"\] Alt text: Pushpin icon
...
For more information about the chat summarization, see [Chat summarization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/now-assist-chat-summary.md).
...
For more information about the case or incident summarization, see [Record summarization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/now-assist-case-summary.md).
...
For more information about generating resolution notes, see [Resolution notes generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/now-assist-rn-summarization.md).
