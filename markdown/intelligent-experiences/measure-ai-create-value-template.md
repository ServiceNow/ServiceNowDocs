...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/measure-ai-create-value-template.html
release: zurich
topic_type: task
...
3.  For each of the three steps, fill in the fields on the forms.
    ...
    For descriptions of the field values, see [Value template form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/measure-ai-reference-value-template-form.md).
