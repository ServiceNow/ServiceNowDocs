...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/intelligent-experiences/upload-download-file.html
release: australia
topic_type: concept
...
-   Automated downloads require Chrome configuration. For more information, see [Configure Chrome to download files automatically](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/intelligent-experiences/config-chrome-download.md).
