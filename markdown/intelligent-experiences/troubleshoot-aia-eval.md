...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/intelligent-experiences/troubleshoot-aia-eval.html
release: zurich
topic_type: concept
...
If the re-evaluation scores did not improve after [applying optimizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/intelligent-experiences/aia-eval-apply-optimization.md), try the following:
...
-   If the optimization was applied to the list of steps of an agentic AI asset, verify that the updated list of steps was applied to the version you're evaluating.
