...
4.  Select **Edit in Data Privacy**.
    ...
    See [Configuring Data Privacy for Now Assist](https://www.servicenow.com/docs/access?context=configure-now-assist-data-privacy&version=australia&pubname=australia-platform-security&ft:locale=en-US) for more information on configuring Now Assist policies.
