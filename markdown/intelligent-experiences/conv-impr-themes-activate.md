...
Conversation evaluations have to be enabled in AI Control Tower. For more information, see [Enabling evaluations](../../ai-governance-workspace/concept/ai-eval-enable.md).
