...
See [Approaches to Performance Analytics with domain separation](https://www.servicenow.com/docs/access?context=pa-domain-configurations&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US) for more information on applying domain separation configuration.
