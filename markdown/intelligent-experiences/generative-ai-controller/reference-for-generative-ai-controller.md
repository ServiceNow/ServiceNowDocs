...
Maintains mappings between AI models, their providers, and configuration details. It helps to show how source models map to target models along with metadata like skill type, model type, resource associations, and provider information.
