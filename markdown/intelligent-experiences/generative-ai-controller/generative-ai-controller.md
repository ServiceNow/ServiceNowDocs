...
Use Generative AI Controller to integrate your ServiceNow applications with third-party large language models \(LLMs\) and manage how generative AI requests are governed, protected, and logged.
