...
For more details on domain separation and Virtual Agent, [check out the documentation](https://www.servicenow.com/docs/access?context=domain-separation-virtual-agent&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US).
...
For more information on setting up OneExtend Definition Configs to use in Virtual Agent Designer, see [enabling Generative AI Controller for Virtual Agent](../task/enable-generative-ai-controller-for-virtual-agent.md).
