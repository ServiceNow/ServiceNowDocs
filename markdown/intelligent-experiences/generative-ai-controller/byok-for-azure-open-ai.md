...
2.  Configure your Azure OpenAI model and deployment name in Generative AI Controller so your ServiceNow instance can recognize and use it.
    ...
    For more information, see [Create a custom embedding model](https://www.servicenow.com/docs/access?context=create-byom&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
