...
2.  Configure your Azure OpenAI model and deployment name in Generative AI Controller so your ServiceNow instance can recognize and use it.
    ...
    For more information, see [Create a custom embedding model](https://www.servicenow.com/docs/access?context=create-byom&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
...
[../task/configure-custom-resource-path-byok.md](../task/configure-custom-resource-path-byok.md)
