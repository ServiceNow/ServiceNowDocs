...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/intelligent-experiences/generative-ai-controller/configure-api-credentials-for-a-generic-large-language-model-llm.html
release: xanadu
...
13. In the **Credential** field, select the Credential record you created with the model's API key.
    ...
    You can search the list of Credentials by typing the name of the Credential in the field. You can also select the lookup icon \(\[Omitted image "na-list-lookup-icon.png"\] Alt text: This image shows the list lookup icon used in the Now Assist Admin console.\) to open a modal with the full list.
...
For more information on configuring a generic LLM, see [configure a generic LLM connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/intelligent-experiences/generative-ai-controller/configure-a-generic-llm-connector.md).
