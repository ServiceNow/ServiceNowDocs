...
13. In the **Credential** field, select the Credential record you created with the model's API key.
    ...
    You can search the list of Credentials by typing the name of the Credential in the field. You can also select the lookup icon \(![Lookup icon.](../image/icon-magnifying-glass-blue.png)\) to open a modal with the full list.
