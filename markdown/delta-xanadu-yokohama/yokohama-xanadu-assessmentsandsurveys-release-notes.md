---
title: Combined Assessments and Surveys release notes for upgrades from Xanadu to Yokohama
description: Consolidated page of all release notes for Assessments and Surveys from Xanadu to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-xanadu-yokohama/yokohama-xanadu-assessmentsandsurveys-release-notes.html
release: yokohama
...
# Combined Assessments and Surveys release notes for upgrades from Xanadu to Yokohama

Consolidated page of all release notes for Assessments and Surveys from Xanadu to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Assessments and Surveys release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Assessments and Surveys to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Assessments and Surveys.
...
Between your current release family and Yokohama, some changes were made to existing Assessments and Surveys features.
...
Between your current release family and Yokohama, some Assessments and Surveys features or functionality were removed.
...
Between your current release family and Yokohama, some Assessments and Surveys features or functionality were deprecated.
