---
title: Combined ERP Data Hub release notes for upgrades from Xanadu to Yokohama
description: Consolidated page of all release notes for ERP Data Hub from Xanadu to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-xanadu-yokohama/yokohama-xanadu-erpdatahub-release-notes.html
release: yokohama
...
# Combined ERP Data Hub release notes for upgrades from Xanadu to Yokohama

Consolidated page of all release notes for ERP Data Hub from Xanadu to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family ERP Data Hub release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading ERP Data Hub to Yokohama
...
Between your current release family and Yokohama, new features were introduced for ERP Data Hub.
...
Between your current release family and Yokohama, some changes were made to existing ERP Data Hub features.
...
Between your current release family and Yokohama, some ERP Data Hub features or functionality were removed.
...
Between your current release family and Yokohama, some ERP Data Hub features or functionality were deprecated.
...
Review information on how to activate ERP Data Hub.
...
If any additional requirements were introduced or changed for ERP Data Hub we have noted them here.
...
If any specific browser requirements were introduced or changed for ERP Data Hub we have noted them here.
...
Review details on accessibility information for ERP Data Hub, such as specific requirements or compliance levels.
...
If there are specific localization considerations for ERP Data Hub we have noted them here.
...
If there are specific highlight considerations for ERP Data Hub we have noted them here.
