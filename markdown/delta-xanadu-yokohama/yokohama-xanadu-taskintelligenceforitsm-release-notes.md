---
title: Combined Task Intelligence for ITSM release notes for upgrades from Xanadu to Yokohama
description: Consolidated page of all release notes for Task Intelligence for ITSM from Xanadu to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-xanadu-yokohama/yokohama-xanadu-taskintelligenceforitsm-release-notes.html
release: yokohama
...
# Combined Task Intelligence for ITSM release notes for upgrades from Xanadu to Yokohama

Consolidated page of all release notes for Task Intelligence for ITSM from Xanadu to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Task Intelligence for ITSM release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Task Intelligence for ITSM to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Task Intelligence for ITSM.
...
Between your current release family and Yokohama, some changes were made to existing Task Intelligence for ITSM features.
...
Between your current release family and Yokohama, some Task Intelligence for ITSM features or functionality were removed.
...
Between your current release family and Yokohama, some Task Intelligence for ITSM features or functionality were deprecated.
