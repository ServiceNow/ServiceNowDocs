---
title: Combined Agent Client Collector release notes for upgrades from Xanadu to Yokohama
description: Consolidated page of all release notes for Agent Client Collector from Xanadu to Yokohama.
locale: en-US
...
# Combined Agent Client Collector release notes for upgrades from Xanadu to Yokohama
