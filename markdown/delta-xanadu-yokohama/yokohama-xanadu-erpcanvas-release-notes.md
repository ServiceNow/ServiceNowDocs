---
title: Combined ERP Canvas release notes for upgrades from Xanadu to Yokohama
description: Consolidated page of all release notes for ERP Canvas from Xanadu to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-xanadu-yokohama/yokohama-xanadu-erpcanvas-release-notes.html
release: yokohama
...
# Combined ERP Canvas release notes for upgrades from Xanadu to Yokohama

Consolidated page of all release notes for ERP Canvas from Xanadu to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family ERP Canvas release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Yokohama.
