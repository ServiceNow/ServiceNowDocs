---
title: Combined Subscription Management release notes for upgrades from Xanadu to Yokohama
description: Consolidated page of all release notes for Subscription Management from Xanadu to Yokohama.
locale: en-US
...
# Combined Subscription Management release notes for upgrades from Xanadu to Yokohama

Consolidated page of all release notes for Subscription Management from Xanadu to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Subscription Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Yokohama.
...
Between your current release family and Yokohama, new features were introduced for Subscription Management.
...
Between your current release family and Yokohama, some changes were made to existing Subscription Management features.
...
Between your current release family and Yokohama, some Subscription Management features or functionality were removed.
...
Between your current release family and Yokohama, some Subscription Management features or functionality were deprecated.
