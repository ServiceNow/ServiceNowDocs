...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/field-service-management/configure-filter-options.html
release: australia
topic_type: task
...
2.  Select one of the tables.
    ...
    For a list of tables, see [Advanced resource filter tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/advanced-filter-tables.md).
