...
Field service users with the wm\_basic role have access to the team calendar, where they can view a list of agents along with the work order tasks and events assigned to each agent.

Users can also customize the settings to set default groups and a default starting view. In the right side panel, users can also:
