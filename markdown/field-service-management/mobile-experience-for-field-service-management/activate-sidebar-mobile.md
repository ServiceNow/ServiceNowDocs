...
**Note:** Sidebar is a ServiceNow AI Platform® capability. For more information on configuring Sidebar, see [Configuring Sidebar](https://www.servicenow.com/docs/access?context=configure-sidebar&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).

For more information on how Sidebar works, see [Exploring Sidebar](https://www.servicenow.com/docs/access?context=exploring-sidebar&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
