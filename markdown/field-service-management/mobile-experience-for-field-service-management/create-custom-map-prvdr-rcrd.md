...
Ensure Indoor Maps are set up. For more information, see [Indoor Mapping](https://www.servicenow.com/docs/access?context=Indoor-mapping&version=yokohama&pubname=yokohama-employee-service-management&ft:locale=en-US).
