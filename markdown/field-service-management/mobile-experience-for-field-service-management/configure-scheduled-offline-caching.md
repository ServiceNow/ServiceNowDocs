...
</table>        **Note:** To set additional properties for scheduling offline cache download, see [Configure offline mode behavior](https://www.servicenow.com/docs/access?context=sg-configure-offline-mode&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US).
...
[Scheduled offline caching](https://www.servicenow.com/docs/access?context=scheduled-offline-caching&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US)
