...
<table><tbody><tr><td id="d97806e417">
...
Assign one or more agents from the list of available agents to the user group.
 ...
 For more information on assigning group members, see [Add a user to a group](https://www.servicenow.com/docs/access?context=t_AddAUserToAGroup&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).

</td></tr><tr><td id="d97806e465">
...
<table id="choicetable_d42_kbh_3xb"><tbody><tr><td id="d97806e648">
...
<table id="choicetable_qrz_byd_hxb"><tbody><tr><td id="d97806e846">
