...
To understand the difference between the manager types and their access rights, see [Using Field Service Territory Planning Console](../concept/using-territory-planning-console.md) and [Field Service Territory Planning components](../reference/territory-planning-components-fsm.md#).
