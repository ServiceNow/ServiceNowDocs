...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/field-service-management/workforce-optimization-for-field-service/configure-listmenu-to-wfo-fsm.html
release: xanadu
...
Set the map application scope to **Coaching With Learning**. For more information, see [Set map application scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/set-map-application-scope.md).
