...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/workforce-optimization-for-field-service/assign-work-based-on-the-defined-capacity-.html
release: yokohama
...
-   If work capacity is based on the number of tasks or hours, tasks can be assigned to agents in both internal and external work groups.
...
Name of the capacity definition based on which the capacity will be assigned. For more information, see [.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/workforce-optimization-for-field-service/create-capacity-definitions.md)
