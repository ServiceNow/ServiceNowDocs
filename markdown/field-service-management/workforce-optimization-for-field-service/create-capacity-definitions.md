...
Name of the capacity reservation.This field appears only when the Set capacity by buckets option is cleared. For more information, see [Capacity Reservations reservation rules](../concept/capacity-reservations.md#).
