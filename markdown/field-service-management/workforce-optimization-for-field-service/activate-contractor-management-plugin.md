...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/field-service-management/workforce-optimization-for-field-service/activate-contractor-management-plugin.html
release: australia
...
Activate the Field Service Contractor Management plugin \(com.snc.fsm\_contractor\_management\) to use the Contractor Management application. This plugin includes demo data and activates related plugins if they are not already active.
...
For more information, see [Contractor Management components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/contractor-management-components.md).
