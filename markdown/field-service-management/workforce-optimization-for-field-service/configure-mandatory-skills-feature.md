...
-   If you are using the [assignment workbench](https://www.servicenow.com/docs/access?context=case-assignment-workbench&version=australia&pubname=australia-customer-service-management&ft:locale=en-US), replace the **Matching Skills** matching criteria with the **Matching Skills - Mandatory Skills Support** matching criteria. For more information, see [Matching rules for case assignment](https://www.servicenow.com/docs/access?context=case-assignment-matching-criteria&version=australia&pubname=australia-customer-service-management&ft:locale=en-US).
