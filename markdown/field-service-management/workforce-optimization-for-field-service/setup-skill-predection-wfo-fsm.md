...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/workforce-optimization-for-field-service/setup-skill-predection-wfo-fsm.html
release: yokohama
...
1.  Configure the properties for the Skill recommendation application.
    ...
    For more information, see [properties for the Skill Recommendation application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/components-wfo-fsm.md).
