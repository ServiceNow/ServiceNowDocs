...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/workforce-optimization-for-field-service/add-skill-leader-role.html
release: yokohama
...
For more information on adding resource requirements to a task, see [Add resource requirements for a work order task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/field-service-manager-workforce/add-resource-requirement-wot.md).
