...
![Field Service Management IT workflow from opening an incident to analyzing the audit reports. For more text description, refer to the following table.](../image/FSM-it-workflow-asset0012979final.png)
