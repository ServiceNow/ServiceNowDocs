...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/field-service-management/coordinated-field-service-and-it-service-management-use-case.html
release: xanadu
...
\[Omitted image "FSM-it-workflow-asset0012979final.png"\] Alt text: Field Service Management IT workflow from opening an incident to analyzing the audit reports. For more text description, refer to the folloiwng table.
