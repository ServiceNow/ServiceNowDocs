...
-   **[View an Emergency Exposure Management diagnostic report for an affected agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/field-service-manager-workforce/view-diagnostic-report.md)**  
View the diagnostic report to identify affected agents and potentially affected customers and agents.
-   **[Block the calendar of a field agent based on an Emergency Exposure Management diagnostic report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/field-service-manager-workforce/block-agent-calendar.md)**  
