...
**Note:** Your administrator can disable schedule adherence or change the configuration for adherence and conformance. For more information, see Configure properties for schedule adherence and conformance.
