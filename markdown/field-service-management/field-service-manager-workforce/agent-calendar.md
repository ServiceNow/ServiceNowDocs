...
-   **Schedule**: create or modify schedules. For more information, see [Schedules](https://www.servicenow.com/docs/access?context=c_UseSchedules&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
...
</table>**Parent Topic:**[Managing agent skills, schedules and tasks in Field Service Agent Management](../../field-service-management/concept/field-service-agent-management.md)

**Related topics**  


[Creating and using schedules](https://www.servicenow.com/docs/access?context=c_UseSchedules&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US)
