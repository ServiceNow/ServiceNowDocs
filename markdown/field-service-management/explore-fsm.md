...
|Optimizes contractor management, improve communication, and streamline task allocation processes.|[Field Service Marketplace](fsm-marketplace.md)|Dispatcher|
...
|Track and manage the inventory between stockrooms.|[Managing inventory in Field Service Management](sourcing-parts.md)|Field Service Agent|
