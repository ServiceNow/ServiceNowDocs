...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/field-service-management/field-service-scheduling/set-agent-status-mobile-ui.html
release: australia
...
1.  In the mobile UI, navigate to **Field Service** &gt; **Schedule Status**.
