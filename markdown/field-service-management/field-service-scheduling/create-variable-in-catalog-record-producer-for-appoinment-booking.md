...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/field-service-scheduling/create-variable-in-catalog-record-producer-for-appoinment-booking.html
release: yokohama
...
Example or hint text guiding users. You can use a hint for the following variables:-   Email
-   URL
-   Single Line Text
-   Multi-line Text
