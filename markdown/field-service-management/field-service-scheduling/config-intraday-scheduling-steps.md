...
5.  \(Optional\) [Delete a flow](https://www.servicenow.com/docs/access?context=flow-delete&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)

    If you do not need a flow installed with intra-day schedule automation, you can delete it.

6.  [Activate a flow](https://www.servicenow.com/docs/access?context=flow-activate&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
