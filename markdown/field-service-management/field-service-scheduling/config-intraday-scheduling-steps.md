...
5.  \(Optional\) [Delete a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flow-delete.md)

    If you do not need a flow installed with intra-day schedule automation, you can delete it.

6.  [Activate a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flow-activate.md)
