...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/field-service-management/field-service-scheduling/bulk-actions-dw.html
release: australia
...
2.  All selected. All tasks are selected. This option is the initial state on toggling **Select All**.
