...
<table id="choicetable_jfw_j4r_21c"><tbody><tr><td id="d117190e123">
...
Wait for the request window to close. If you want to withdraw from the request, see [Withdraw from a request on Field Service Marketplace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/field-service-scheduling/withdraw-fsm-marketplace.md).
