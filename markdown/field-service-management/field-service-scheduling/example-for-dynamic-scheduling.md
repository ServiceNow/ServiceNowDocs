...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/field-service-scheduling/example-for-dynamic-scheduling.html
release: yokohama
...
The following infographic helps you to understand how dynamic scheduling use weighting to determine the best agent to assign to a task.\[Omitted image "dynamic\_scheduling.png"\] Alt text: An infographic that demonstrates the process and formulas of calculating an agent rank based on the matching criteria.
