...
-   **Territory Planning**
    ...
    Task bundling considers the agent's start and end locations from the **Agent Schedule Attribute Plans** table for the given day if the Territory Planning plugin is activated. For more information, see [Activate Field Service Territory Planning](../task/Activate-fsm-territory-planning.md).
