...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/field-service-management/field-service-scheduling/assign-equipment-to-wot.html
release: australia
...
For information about configuring Field Service Resource Scheduling plugin, see [Configuring Resource Scheduling](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/asset-management-for-field-service/configure-equipment-scheduling.md).
...
Crew leaders can use the Now Mobile agent app to modify their crews or manage their tasks. For more information, see [Crew on ServiceNow Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/work-order-management/manage-crew-mobile-agent-app.md).
