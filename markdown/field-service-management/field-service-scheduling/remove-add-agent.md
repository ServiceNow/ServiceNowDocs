...
<table id="table_lhg_vtr_jfc"><tbody><tr><td>

To remove a single agent from the top of the calendar

</td><td>

Select the more actions \[Omitted image "more\_actions.png"\] Alt text: more actions icon next to the agent that you want to remove, then select **Remove**.

</td></tr><tr><td>

To remove all agents that were added to the top of the calendar
