...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/field-service-scheduling/dispatcher-wrkspc-settings.html
release: yokohama
...
**Important:** You must enable **Notify me of new tasks before adding them to the list** in order for this setting to work.
...
**Important:** You must enable this setting before you can Select where you want new tasks to be loaded.
...
Entry to choose what time zones are available from the time zone drop-down on the Schedule and Hybrid views of dispatcher workspace. You can choose one or more.
