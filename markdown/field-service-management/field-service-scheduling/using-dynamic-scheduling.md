...
-   **[Select and assign multiple tasks](../task/select-tasks-for-bulk-assignment.md)**  
Dispatchers can select multiple tasks on which to run dynamic scheduling.
-   **[Add a default agent work schedule](../task/add-agent-schedule.md)**  
...
-   **[Display the task assignment debug log](../task/enable-assignment-debug-log.md)**  
Display information from the task assignment debug log in the Confirm Assignment pop-up window.
-   **[Set agent status from the mobile UI](../task/set-agent-status-mobile-ui.md)**  
...
-   **[Set agent status from the desktop](../task/set-agent-status-desktop-ui.md)**  
...
-   **[Work order task start and end dates](../reference/dynamic-sched-task-window-dates.md)**  
