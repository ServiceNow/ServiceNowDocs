...
breadcrumb: [Viewing tasks or events on the calendar, Using Dispatcher Workspace, Assigning tasks from Dispatcher Workspace, Scheduling and dispatching, Use, Field Service Management]
---

# View a task or event on the calendar

Dispatchers can save time and quickly view tasks or events on the calendar from the task panel or contextual side panel.
...
You can view events assigned to a single person only. **View on calendar** is unavailable for multi-person events.
