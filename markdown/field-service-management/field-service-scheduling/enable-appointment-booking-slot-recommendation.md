...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/field-service-scheduling/enable-appointment-booking-slot-recommendation.html
release: yokohama
...
2.  In the properties list, search for the property `sn_adv_apptmnt.show_recommended_slots`.
