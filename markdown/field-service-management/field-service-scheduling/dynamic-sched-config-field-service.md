...
3.  In the **Assignment method for tasks** field, select **using dynamic scheduling**.
...
Tasks are assigned automatically based on the dynamic scheduling configuration.

## What to do next

Review system properties and components installed with Dynamic Scheduling. For more information, see [Dynamic scheduling system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/field-service-scheduling/dynamic-sched-system-properties.md).
