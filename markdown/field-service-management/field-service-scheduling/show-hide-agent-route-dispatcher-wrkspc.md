...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/field-service-management/field-service-scheduling/show-hide-agent-route-dispatcher-wrkspc.html
release: australia
...
3.  Search for a field service agent whose route you want to view.
    ...
    For more information, see [Search for appropriate Field Service agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/field-service-scheduling/search-agents-tasks.md).
