...
3.  Search for a field service agent whose route you want to view.
    ...
    For more information, see [Search for appropriate Field Service agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/field-service-scheduling/search-agents-tasks.md).
