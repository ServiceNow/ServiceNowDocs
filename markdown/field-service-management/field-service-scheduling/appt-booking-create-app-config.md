...
For more information on appointment availability methods, see [Learn about appointment availability settings for an application configuration](../reference/appt-booking-task-assignment.md).
...
Display appointments in categorized time slots \(Morning, Afternoon, Evening\) in the [Select Appointment window](../reference/appt-booking-select-appt-window.md) on the portal.
...
Create service configurations for each of the services available to the customers. For more information, see [Configure an appointment booking record producer](appt-booking-config-record-producer.md).
