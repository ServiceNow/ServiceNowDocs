...
2.  [Enable or disable appointment booking](../task/appointment-booking-enable.md)
...
8.  [Configure daily and advanced schedules](configure-daily-and-advanced-schedules.md)
...
11. [Enable and configure appointment slot recommendation](enable-and-configure-appointment-slot-recommendation.md)
