---
title: Assigning equipment to a work order task
...
Crew leaders can use the Now Mobile agent app to modify their crews or manage their tasks. For more information, see [Manage your crew using the Now Mobile Agent application](manage-crew-mobile-agent-app.md).
