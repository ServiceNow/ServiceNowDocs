...
**Note:** An appointment can’t be rescheduled when the current time is within the reschedule/cancel window specified in the service configuration.
...
6.  Select a different day and appointment time slot and then click **Select**.
    ...
    Information about the rescheduled appointment is noted in the **Activities** field on the work order or the work order task form. This information includes the original appointment window, the rescheduled appointment window, and the user who made the change.
