---
title: Field Service multi-day task scheduling
...
The multi-day task scheduling feature enables dispatchers to assign work order tasks, spanning across multiple schedule entries to agents or crews within their defined working hours, if they are available throughout the task duration. Task schedulers can split work slots evenly throughout the day after considering the task duration, resource working and non-working hours, and resource availability throughout the task duration. Tasks can be assigned to the same agent or crew throughout by skipping the break and other non-working hours from their schedule, and can span multiple days or weeks.
...
Task duration: 4 hours, Agent schedule: 8 a.m. - 5 p.m., Excluded lunch break: 12 p.m. -1 p.m.

The scheduler excludes break hours from the agent's work schedule while scheduling the task. Therefore, the task is scheduled to start at 10 a.m. and end at 3 p.m. the same day, including multiple work schedules of two hours each and pre- and post-break hours of the agent's schedule.

## Schedule a task across multiple days

Task duration: 20 hours, Agent schedule: 8 a.m. - 5 p.m., Excluded lunch break: 12 p.m. -1 p.m.

The scheduler excludes break hours from the agent's work schedule while scheduling the task. Therefore, the task is scheduled to start on Monday at 10 a.m. and end on Wednesday at 12 p.m., including multiple work schedules spanning three days. Each work schedule is estimated for four hours, including pre- and post-break hours of the agent's schedule.
