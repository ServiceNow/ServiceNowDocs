...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/field-service-management/work-order-management/configure-work-orders.html
release: australia
...
-   [Configure the qualification state for work orders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/work-order-management/configure-qualify-fsm.md)

    Allow for a quality check to make sure that the work order meets a certain standard before it moves to the next step.

-   [Customizing state flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/work-order-management/work-order-state-custom.md)
...
-   [Configuring Template Management for Field Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/work-order-management/enabling-advanced-configurations-for-wo-template.md)
...
-   [Signed PDF summaries for closed work orders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/work-order-management/work-order-sign-and-confirm-pdf.md)
