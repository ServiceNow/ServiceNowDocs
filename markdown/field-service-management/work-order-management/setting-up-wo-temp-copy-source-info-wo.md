...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/field-service-management/work-order-management/setting-up-wo-temp-copy-source-info-wo.html
release: brazil
...
1.  [Create field mapping from a source table to a work order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/work-order-management/map-source-table-to-wo.md)
...
2.  [Enable work order template to fetch data from the source table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/work-order-management/associate-table-mappings-with-wotemplate.md)
