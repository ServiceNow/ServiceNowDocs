...
1.  [Create a work order template](../task/t_CreateAWorkOrderTemplate.md)
    ...
    Use work order templates to populate work orders with repeatable information. For example, templates can populate an Assignment group, during the template creation process. This ensures consistent information is included across all related records.

2.  \(Optional\) [Create a knowledge article for a work order template](../task/t_CreateAKnowledgeArticle.md)

    Help Field Service technicians stay consistent when completing the same types of work orders with knowledge articles. For example, a knowledge article can be installation guides, maintenance procedures, or checklists.

3.  \(Optional\) [Configuring SLAs for Field Service Management](../../field-service-management/concept/sla-for-field-service.md)
...
[Managing work orders and work order tasks](../../field-service-management/concept/managing-work-orders.md)

[Managing work order tasks](../../planning-and-policy/concept/c_WorkOrderTasks.md)

[Apply a work order template](../task/t_UseTheWorkOrderTemplate.md)

[Add a knowledge article to a work order or work order task](../../field-service-management/task/add-knowledge-workorder.md)
