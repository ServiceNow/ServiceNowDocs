...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/work-order-management/t\_UseTheFilter.html
release: yokohama
...
breadcrumb: [Manage tasks on the map, Execute a task from the agent map, Execute work order tasks, Updating task status in web interface, Complete work orders on the web interface, Using Field Service Management, Field Service Management]
---
...
1.  Navigate to **All** &gt; **Field Service** &gt; **Agent** &gt; **My Map**

2.  Click **Edit**.

3.  Change the filter settings as needed.

<table id="choicetable_jh3_jhn_kfb"><thead><tr><th align="left" id="d128691e96">

Option

</th><th align="left" id="d128691e99">

Description

</th></tr></thead><tbody><tr><td id="d128691e105">
...
</td></tr><tr><td id="d128691e145">

**Unassigned**

</td><td>

Displays all unassigned tasks for the selected date. Clear the checkbox to hide unassigned tasks.

</td></tr></tbody>
</table>4.  Do one of the following:

    -   To apply the changes to the configuration, click **Apply**.
