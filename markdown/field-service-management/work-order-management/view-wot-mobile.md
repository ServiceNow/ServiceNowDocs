...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/work-order-management/view-wot-mobile.html
release: yokohama
...
3.  Perform one of the following actions.
    ...
    **Note:** You can also [view all work orders for an asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/work-order-management/identify-defect-asset-mobile-app.md).
...
[Working on tasks when your mobile device is offline](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/work-order-management/work-offline-fieldservice-mobile.md)
