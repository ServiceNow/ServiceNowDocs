...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/work-order-management/activate-linear-assets.html
release: yokohama
...
-   **Field Service Management \(com.snc.work\_management\)**
    ...
    Enables you to manage work requests that are performed on location by field service agents. For more information, see [Activate Field Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/t_ActivateFieldServiceManagement.md).
...
For more information, see [Linear Assets Support properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/linear-asset-support-properties.md).
