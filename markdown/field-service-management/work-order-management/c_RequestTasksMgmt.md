...
[Change the location of a request](https://www.servicenow.com/docs/access?context=t_ChangeTheLocationOfARequest&version=zurich&pubname=zurich-service-management-for-the-enterprise&ft:locale=en-US)

[Request approvals](https://www.servicenow.com/docs/access?context=c_RequestApprovals&version=zurich&pubname=zurich-service-management-for-the-enterprise&ft:locale=en-US)

[Collaborate on a request](https://www.servicenow.com/docs/access?context=t_CollaborateOnARequest&version=zurich&pubname=zurich-service-management-for-the-enterprise&ft:locale=en-US)

[Close a request](https://www.servicenow.com/docs/access?context=t_CloseARequest&version=zurich&pubname=zurich-service-management-for-the-enterprise&ft:locale=en-US)
