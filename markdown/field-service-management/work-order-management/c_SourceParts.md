...
-   When one stockroom has all required items, a single transfer order line can fulfill the order when moving consumable assets. One or more transfer order lines may need to be created when moving non-consumable assets. \(For more information about consumable and non-consumable assets, see Asset and CI management.\)
