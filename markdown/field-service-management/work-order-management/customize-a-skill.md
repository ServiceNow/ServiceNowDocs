...
With an admin role, you can customize the **Work Order Task Summarization** and **KB generation** skills, enabling technicians to use them in the Configurable Workspace and in Core UI.
