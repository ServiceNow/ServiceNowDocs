...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/field-service-management/work-order-management/t\_ExecuteATaskFromTheQueue.html
release: brazil
...
5.  When work is complete, [record any asset usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/work-order-management/t_RecordAssetUsage.md).

6.  Add a description of the work you did to the **Work notes** field.

    This is required to close the task.

7.  [Close the task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/work-order-management/t_CloneAWorkOrderTask.md).
...
[Customer notifications for work order tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/work-order-management/Customer-notification-work-order-tasks.md)
