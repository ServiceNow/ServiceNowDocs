...
6.  To create the questions or checklist items that appear on the questionnaire, use the [Survey designer](https://www.servicenow.com/docs/access?context=c_SurveyDesigner&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) tool.
