...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/work-order-management/create-questionnaire-for-work-order.html
release: yokohama
...
breadcrumb: [Configuring survey-based work order questionnaires, Configuring work order questionnaires, Configuring work order tasks, Setting up work orders and tasks, Configuring Field Service Management, Field Service Management]
---
...
6.  To create the questions or checklist items that appear on the questionnaire, use the [Survey designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_SurveyDesigner.md) tool.
