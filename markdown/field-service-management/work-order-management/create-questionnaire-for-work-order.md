...
6.  To create the questions or checklist items that appear on the questionnaire, use the [Survey designer](https://www.servicenow.com/docs/access?context=c_SurveyDesigner&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) tool.
