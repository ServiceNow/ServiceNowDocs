...
description: Create a questionnaire record and then associate it with a table such as the Work Order or Work Order Task tables.
locale: en-US
release: xanadu
...
6.  To create the questions or checklist items that appear on the questionnaire, use the [Survey designer](https://www.servicenow.com/docs/access?context=c_SurveyDesigner&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) tool.
