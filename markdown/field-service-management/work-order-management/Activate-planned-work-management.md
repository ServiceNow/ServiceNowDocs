...
-   Activation of Planned Work Management activates the following plugins if not already active.
    -   **Required ServiceNow plugins**
        ...
        -   **Planned Maintenance \(com.snc.planned\_maintenance\)**
            ...
            Enables you to manage the regular preventive maintenance of assets. For more information, see [Activate Planned Maintenance](https://www.servicenow.com/docs/access?context=t_ActivatePlanMaint&version=zurich&pubname=zurich-service-management-for-the-enterprise&ft:locale=en-US).
