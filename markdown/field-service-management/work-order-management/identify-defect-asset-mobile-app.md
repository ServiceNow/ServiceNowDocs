...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/field-service-management/work-order-management/identify-defect-asset-mobile-app.html
release: zurich
...
2.  In the **My Work** tab, tap **Asset Lookup** at the top.

3.  Tap the barcode icon and scan the asset.

4.  Tap the asset record.

5.  Do one of the following.

<table id="choicetable_xjd_bdv_khb"><thead><tr><th align="left" id="d111433e99">

To

</th><th align="left" id="d111433e102">

Do this

</th></tr></thead><tbody><tr><td id="d111433e108">
