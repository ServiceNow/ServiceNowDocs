...
-   Enforce access control at record and field levels. For more information, see [Configure an ACL rule](https://www.servicenow.com/docs/access?context=t_CreateAnACLRule&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
-   Apply pre-query filtering. For more information, see [CSM Query Rules](https://www.servicenow.com/docs/access?context=csm-query-rules&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
-   Apply dynamic filtering. For more information, see [Before Query business rules](https://www.servicenow.com/docs/access?context=bp-before-query-business-rules&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
-   Apply restrictions at the UI level. For more information, see [Using UI policies](https://www.servicenow.com/docs/access?context=t_CreateAUIPolicy&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
