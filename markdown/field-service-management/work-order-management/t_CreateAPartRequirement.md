...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/work-order-management/t\_CreateAPartRequirement.html
release: yokohama
...
Role required: wm\_admin, wm\_agent, wm\_dispatcher, wm\_qualifier, or [qualifier combination role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/r_UserRoleInstallWFieldSrvMgmnt.md)
...
<table><tbody><tr><td id="d46057e180">
...
This method is useful if you are sourcing a single part for a work order task.
    ...
    |Model|Description of the part [model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/product-catalog/c_Models.md) needed to complete the work order task.|
    ...
    |Reserved quantity|Total quantity that has been [sourced](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/work-order-management/t_SourceAPartAndAssignAnAgent.md) already.|
...
-   **[Copy a part requirement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/work-order-management/t_CopyAPartRequirement.md)**  
Copy a part requirement to quickly create another, similar part requirement.
-   **[Delete a part requirement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/work-order-management/t_DeleteAPartRequirement.md)**  
Delete a part requirement from a work order task.
