...
-   Enable location tracking from your mobile device to record your location in the geo history table. For more information, see [Using location tracking for mobile](https://www.servicenow.com/docs/access?context=mobile-location&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US).
...
**Parent Topic:**[Linear assets on Mobile Agent](../concept/working-on-linear-asset-wot.md)
