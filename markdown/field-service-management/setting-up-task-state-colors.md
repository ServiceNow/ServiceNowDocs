...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/field-service-management/setting-up-task-state-colors.html
release: xanadu
topic_type: task
...
You must have the property `work.management.task_state_color.use_hex` enabled in order to change work order task state colors.
