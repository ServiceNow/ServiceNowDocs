...
Move your excess consumable parts from your stockroom to the drop-off list by using the Now Mobile Agent application on your mobile device. You can generate transfer orders to move these items to the stockroom where it must be dropped off.
...
<table id="choicetable_ijp_w1y_2jb"><thead><tr><th align="left" id="d68648e100">

Option

</th><th align="left" id="d68648e103">

Description

</th></tr></thead><tbody><tr><td id="d68648e109">
...
For more information on asset transfers, see [Move an asset through the transfer process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/create-transfer-order-line-task.md).
