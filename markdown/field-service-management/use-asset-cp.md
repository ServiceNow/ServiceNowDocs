...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/field-service-management/use-asset-cp.html
release: xanadu
topic_type: task
last_updated: "2024-08-01"
reading_time_minutes: 1
breadcrumb: [Record the usage of assets on the Contractor Portal, Work order tasks on the Field Service Contractor Portal, Field Service Contractor Portal, Using Field Service Management, Field Service Management]
---
...
3.  Click **New** in the Asset Usages related list.

4.  Record the used asset.

    1.  In the Asset Usage form, select **Used** from the **Status** list.

    2.  Select the asset from the Asset list.
