...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/mobile-experience-for-field-service-management-glide-family/create-custom-map-prvdr-rcrd.html
release: yokohama
...
breadcrumb: [Configuring Site Mapping for Field Service Management, Setting up Field Service Mobile Agent, Configuring Field Service Management, Field Service Management]
---
...
Ensure Indoor Maps are set up. For more information, see [Indoor Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/employee-service-management/indoor-mapping/Indoor-mapping.md).
