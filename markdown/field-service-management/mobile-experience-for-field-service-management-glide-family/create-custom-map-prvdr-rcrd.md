...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/field-service-management/mobile-experience-for-field-service-management-glide-family/create-custom-map-prvdr-rcrd.html
release: xanadu
...
breadcrumb: [Configuring Site Mapping for Field Service Management, Setting up Field Service Now Mobile Agent application, Configuring Field Service Management, Field Service Management]
---
...
Ensure Indoor Maps are set up. For more information, see [Indoor Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/indoor-mapping/Indoor-mapping.md).
