...
description: You can activate the Smart Assessment for Field Service Questionnaire plugin \(sn\_fsm\_smart\_asmt\) if you have the admin role. If the application does NOT include demo data or it does NOT install related applications and plugins, delete or revise the following sentence:The application includes demo data and installs related ServiceNow Store applications and plugins if they are not already installed.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/mobile-experience-for-field-service-management-glide-family/activate-smart-assessment.html
release: yokohama
...
You can activate the Smart Assessment for Field Service Questionnaire plugin \(sn\_fsm\_smart\_asmt\) if you have the admin role. The application includes demo data and installs related ServiceNow® Store applications and plugins if they are not already installed.
...
For more information, see [Smart Assessment components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/field-service-management/smart-assessment-components.md).
