...
Messaging from the Sidebar in Dispatcher Workspace is a ServiceNow AI Platform® capability. For more information on configuring the Sidebar for messaging, see [Configuring Sidebar](https://www.servicenow.com/docs/access?context=configure-sidebar&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).

For more information on how the Sidebar works, see: [Exploring Sidebar](https://www.servicenow.com/docs/access?context=exploring-sidebar&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).

For more information on using the Sidebar to communicate, see [Using Sidebar](https://www.servicenow.com/docs/access?context=using-sidebar&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
