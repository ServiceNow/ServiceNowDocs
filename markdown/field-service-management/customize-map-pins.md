...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/field-service-management/customize-map-pins.html
release: australia
topic_type: task
...
For a list of map pins that show on the dispatch map, see [Map iconography in Dispatcher Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/r_DispatcherView.md).
