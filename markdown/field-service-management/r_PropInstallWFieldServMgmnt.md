...
Show Collapsed territories or assignment group view.**Warning:** Setting this value to false will load all the territories or assignment groups which may cause performance issues.
