...
For more information, see [Working with database views for reporting](https://www.servicenow.com/docs/access?context=c_DatabaseViews&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
