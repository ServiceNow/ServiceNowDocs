...
The managers of these contractor companies use the [Field Service Contractor Portal](field-service-contractor-portal.md) to review the assigned work order task details and can choose to reject work on the tasks. If they accept the task, they can then reassign the tasks to their contractor team members.
