...
Video showing example for Field Service in CSM Agent Workspace.
...
-   **Case**
    ...
    Use Field Service in CSM Agent Workspace to create work orders from cases while on a live call or chat with the customer.
