...
<table><tbody><tr><td id="d42675e180">
...
This method is useful if you are sourcing a single part for a work order task.
    ...
    |Model|Description of the part [model](https://www.servicenow.com/docs/access?context=c_Models&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US) needed to complete the work order task.|
