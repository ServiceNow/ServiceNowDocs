...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/field-service-management/change-hide-off-shift.html
release: zurich
topic_type: task
...
For more information on hiding off shift agents, see [Show or hide off shift agents from the calendar in Dispatcher Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/field-service-scheduling/hide-off-shift-agents.md).
...
[Run the Populate Agents Daily Schedule Table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/field-service-manager-workforce/run-agent-schedule.md)
