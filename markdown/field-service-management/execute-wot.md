...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/field-service-management/execute-wot.html
release: xanadu
topic_type: task
...
2.  Click **Start Travel** when you begin your travel to work on the task.
    ...
    -   The **Check-In** option appears when `Enable/Disable Onsite Arrival Check-in for Agents` property is enabled. For more information, see [Global domain configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_ConfigureFieldService.md).
...
7.  If you want to close the task when the work is pending, open the task record, and click**Close Incomplete**.
    ...
    For more information about closing incomplete work order tasks, see [Close an external work order task as incomplete](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/close-ext-wot-incomplete.md).
