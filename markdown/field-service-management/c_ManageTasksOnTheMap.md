...
-   **[View work order task information](../../field-service-management/concept/c_ViewWOTaskInformation.md)**  
Click the task icon on the agent map to view task details.
-   **[Customize the display of task information on the agent map](../task/t_UseTheFilter.md)**  
...
-   **[Start work](../task/t_StartWork.md)**  
What to do when you are ready to begin traveling to the first task.
-   **[View task information on the classic mobile UI map](../../field-service-management/task/view-tasks-on-mobile-ui-map.md)**  
