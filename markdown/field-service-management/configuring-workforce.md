...
-   [Configure event types to appear on the Team calendar in Workforce](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/configure-event-types-to-appear-on-the-team-calendar.md)

    Select which event types appear on the team calendar.

-   [Set your Workforce system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/workforce-system-properties.md)

    Enable system properties for group and territory views.

-   [Configure team calendar visibility for group members](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/configure-team-cal-visibility-grp-members.md)

    Make team schedules accessible across groups.

-   [Configure territory view to allow users to see other members' schedules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/enable-territory-view.md)
