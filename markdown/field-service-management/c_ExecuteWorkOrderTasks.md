...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/field-service-management/c\_ExecuteWorkOrderTasks.html
release: xanadu
topic_type: concept
...
The examples in this page illustrate the use of tasks with work orders; however, tasks can be used with any [Service Management application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/service-management-for-the-enterprise/service-management-legacy/c_ServiceManagement.md). The ServiceNow system provides an agent with these methods for managing work order tasks:

-   [Agent task map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_ExecuteATaskFromTheAgentMap.md): The agent task map displays an agent's location and the location of that agent's tasks for the day in a familiar Google Map. The agent map is available when the Service Management Geolocation plugin \(com.snc.service\_management.geolocation\) is active. This map allows for the general scheduling of tasks and provides estimates of an agent's location. Precise agent locations and some automatic features are available when your organization purchases a [Google Maps API for Business](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/ai-platform-capabilities/c_Geolocation.md) key and enters it into the system.
-   [Task queue](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_ExecuteATaskFromTheQueue.md): It the task map is not available, an agent can manage assigned tasks and their schedule directly from a queue accessed from the application navigator.

-   **[Accept or reject a work order task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_AcceptOrRejectAWorkOrderTask.md)**  
...
-   **[Execute a task from the agent map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_ExecuteATaskFromTheAgentMap.md)**  
...
-   **[Execute a task from the queue](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_ExecuteATaskFromTheQueue.md)**  
If the agent task map is not used in your organization, you can manage assigned tasks from the task queue.
-   **[Onsite arrival and check-in](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/onsite-arrival-and-check-in.md)**  
The Onsite Arrival and Check-in process ensures accurate task location confirmation and effective time tracking.
-   **[Record an incidental expense](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_RecordAnIncidentalExpense.md)**  
...
-   **[Complete a questionnaire for a work order or task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/complete-wo-or-task-questionnaire.md)**  
...
-   **[Close a work order task as complete](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_CloseAWorkOrderTaskAsComplete.md)**  
Only agents can close work order tasks assigned to them.
-   **[Close a work order task as incomplete](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_CloseAWorkOrderTaskAsIncomplete.md)**  
Close a work order task as incomplete if there is work pending on the task.
-   **[Cancel a work order task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_CancelAWorkOrderTask.md)**  
...
-   **[View asset usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/t_RecordAssetUsage.md)**  
