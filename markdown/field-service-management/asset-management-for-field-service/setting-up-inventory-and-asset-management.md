...
Assets and model categories are created as needed, using Enterprise Asset Management. For more information, see [Create enterprise assets](https://www.servicenow.com/docs/access?context=create-asset-eam&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).
