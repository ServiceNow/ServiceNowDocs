---
title: Get help needed to complete jobs
...
Ensure the Sidebar for Field Service Management plugin \(com.sn\_fsm\_sidebar\) is activated. For more information, see [Activate Sidebar for the Now Mobile Agent application](../task/activate-sidebar-mobile.md).
