...
2.  Right-click the form title bar and select **Create Work Order**.
    ...
    If you created the work order from another record, the short description of the original record is copied as the short description of the work order. Some of the work order fields are auto-filled with information from the original record. For details, see [Managing work orders and work order tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/managing-work-orders.md).
...
The asset tag number or the serial number of the asset involved in this case.You can select linear asset only if Enterprise Asset Management is installed.
...
The Internal or External \(vendor\) business location**Note:** The Service Organization field appears only when the Industry Data Models or Service Organization \(com.snc.service\_organization\) plugin is installed.
...
</table>**Parent Topic:**[Managing work orders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/c_ManageWorkOrders.md)
