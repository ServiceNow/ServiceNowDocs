...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/field-service-management/field-service-integrations/view-wo-details-from-change-req.html
release: zurich
...
# View work order details from a change request using the CRM Workspace

View or track the progress of a work order in the associated change request from CRM Workspace.

## Before you begin

Enable the activity function using the ChangeWorkOrderIntegration extension point. For more information, see [Using an extension point to synchronize work orders with change requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/field-service-management/field-service-integrations/using-extention-point-for-chnge-mngmnt.md).
