...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/field-service-management/field-service-integrations/setting-up-change-fsm.html
release: australia
...
-   Ability to create a work order from a change request either on the ServiceNow AI Platform or the CRM Workspace.
    -   For information on creating a work order from a change request in ServiceNow AI Platform, see [Create a work order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/work-order-management/t_CreateAWorkOrder.md).
    -   For information about creating a work order from a change request in CRM Workspace, see [Create a work order from a change request in the CRM Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/field-service-management/field-service-integrations/create-wo-from-chng-config-wrkspc.md).
