...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/field-service-management/field-service-integrations/Install-incident-for-fsm.html
release: zurich
...
-   Incident Management for Field Service requires the following plugins. Ensure that these plugins are activated before you install Incident Management for Field Service.
    -   **Required ServiceNow plugins**
        -   **CSM Configurable Workspace \(com.snc.uib.csm\_agent\_workspace\)**
            ...
            Enable your agents so they can engage with customers, answer questions, create cases, and resolve issues. For more information, see [Set up CSM Configurable Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/csm-config-workspace-set-up.md).
