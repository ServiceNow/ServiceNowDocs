...
-   [Customizing the contextual side panel in Dispatcher Workspace with UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/side-panel-ui-builder.md)
-   [Customizing the agent card in Dispatcher Workspace with UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/agent-card-ui-builder.md)
-   [Customizing the calendar grid in Dispatcher Workspace with UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/field-service-management/calendar-color-ui-builder.md)
