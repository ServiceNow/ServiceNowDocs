---
title: Using dynamic scheduling
description: Dynamic scheduling increases the efficiency of Field Service Management by automatically assigning tasks to the agents.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/field-service-management/using-dynamic-scheduling.html
release: xanadu
...
-   **[Select and assign multiple tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/select-tasks-for-bulk-assignment.md)**  
Dispatchers can select multiple tasks on which to run dynamic scheduling.
-   **[Add a default agent work schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/add-agent-schedule.md)**  
Add a default agent schedule so that agents have a schedule assigned to them if their work schedule expires.
-   **[Assigning preferred agents to work on tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/preferred-agents-for-tasks.md)**  
...
-   **[Display the task assignment debug log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/enable-assignment-debug-log.md)**  
Display information from the task assignment debug log in the Confirm Assignment pop-up window.
-   **[Set agent status from the mobile UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/set-agent-status-mobile-ui.md)**  
...
-   **[Set agent status from the desktop](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/set-agent-status-desktop-ui.md)**  
...
-   **[Work order task start and end dates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/dynamic-sched-task-window-dates.md)**  
Dynamic scheduling uses work order task **Window start** and **Window end** dates to schedule tasks.
-   **[Ignoring travel time of field service agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/ignoring-travel-time.md)**  
You can choose to assign work order tasks to the highest ranked agents without taking into account travel time.
-   **[Field Service Management Access Hours Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/access-hour-mngmnt-fsm.md)**  
