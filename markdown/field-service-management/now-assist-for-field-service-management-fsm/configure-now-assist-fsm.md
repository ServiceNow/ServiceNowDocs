...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/field-service-management/now-assist-for-field-service-management-fsm/configure-now-assist-fsm.html
release: xanadu
...
7.  Select the inputs or triggers for the selected skill.
    ...
    For information about the inputs and triggers for each skill, see [Skill inputs for Now Assist for Field Service Management \(FSM\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/now-assist-for-field-service-management-fsm/now-assist-fsm-skill-inputs.md).
