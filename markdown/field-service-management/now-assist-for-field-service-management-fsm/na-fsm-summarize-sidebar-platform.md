...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/field-service-management/now-assist-for-field-service-management-fsm/na-fsm-summarize-sidebar-platform.html
release: xanadu
...
<table id="choicetable_vzl_myv_bcc"><thead><tr><th align="left" id="d76107e284">

Option

</th><th align="left" id="d76107e287">

Procedure

</th></tr></thead><tbody><tr><td id="d76107e293">
...
Ensure the Sidebar for Field Service Management plugin \(com.sn\_fsm\_sidebar\) is activated. For more information, see [Activate Sidebar for the Now Mobile Agent application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/field-service-management/mobile-experience-for-field-service-management-glide-family/activate-sidebar-mobile.md).
