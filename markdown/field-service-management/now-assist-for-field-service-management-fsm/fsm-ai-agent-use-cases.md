---
title: Using agentic AI in ServiceNow Otto for Field Service Management \(FSM\)
...
# Using agentic AI in ServiceNow Otto for Field Service Management \(FSM\)
...
|FSM Scheduling|Creates and manages shifts for Field Service technicians. Workforce managers use conversational AI to assign technicians to shifts, create recurring morning and evening shifts, and send reminders to technicians who haven't responded to the shift. The AI agent can be accessed on the platform or on the ServiceNow Agent mobile application.|
