...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/field-service-management/now-assist-for-field-service-management-fsm/cust-now-assist-fsm-wot-summarization-skill.html
release: yokohama
...
6.  Choose input data.
    ...
    Configure the base input table fields and related lists for the different input templates \(New, WIP, and Closed states\) for the skill.
