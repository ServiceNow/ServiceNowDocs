...
Display the event on the schedule as one of the following:-   Busy
-   Free
-   Tentative
-   On call
...
Start date and time for this event.
...
End date and time for this event.
...
Frequency of the repeated event.Available options:
