...
Use the **Change Approval Policy** workflow activity instead of the **User** and **Group Approval** workflow activities to manage the approvals at a particular stage of the workflow. For more information, see 
