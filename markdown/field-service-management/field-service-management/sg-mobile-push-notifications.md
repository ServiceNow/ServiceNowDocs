...
\[Omitted image "image.SNMobileAppPushNotificationStructureOverview"\] Alt text: Diagram showing how push notifications are created in an instance and sent directly to users to interact with on the device of their choice.
...
\[Omitted image "image.push-notif-in-mab"\] Alt text: Mobile app builder menu showing available push notifications
