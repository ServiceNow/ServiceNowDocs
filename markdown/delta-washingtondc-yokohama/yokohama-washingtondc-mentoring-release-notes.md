---
title: Combined Mentoring release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Mentoring from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-mentoring-release-notes.html
release: yokohama
...
# Combined Mentoring release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Mentoring from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Mentoring release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Mentoring to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Mentoring.
...
Between your current release family and Yokohama, some changes were made to existing Mentoring features.
...
Between your current release family and Yokohama, some Mentoring features or functionality were removed.
...
Between your current release family and Yokohama, some Mentoring features or functionality were deprecated.
...
Review information on how to activate Mentoring.
...
Mentoring can be installed with the activation of the Employee Connections plugin, which is part of ServiceNow® Talent Development Core. For more information, see [Talent Development](https://www.servicenow.com/docs/access?context=egd-employee-growth-developemnt-suite&family=washingtondc&ft:locale=en-US).
...
If any additional requirements were introduced or changed for Mentoring we have noted them here.
...
If any specific browser requirements were introduced or changed for Mentoring we have noted them here.
...
Review details on accessibility information for Mentoring, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Mentoring we have noted them here.
...
If there are specific highlight considerations for Mentoring we have noted them here.
...
-   Drive Mentoring engagement by utilizing discussions \(conversations\).
 ...
 See [Mentoring](https://www.servicenow.com/docs/access?context=mentoring-egd-overview&family=washingtondc&ft:locale=en-US) for more information.
