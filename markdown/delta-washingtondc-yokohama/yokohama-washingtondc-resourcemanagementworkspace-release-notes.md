---
title: Combined Resource Management Workspace release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Resource Management Workspace from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-resourcemanagementworkspace-release-notes.html
release: yokohama
...
# Combined Resource Management Workspace release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Resource Management Workspace from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Resource Management Workspace release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Resource Management Workspace to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Resource Management Workspace.
...
-   **[Create resource card](https://www.servicenow.com/docs/access?context=rmw-create-rsrc-card&family=washingtondc&ft:locale=en-US)**

Create, navigate, and work on resource assignments among your custom persistent portfolios by creating resource cards.

-   **[Filter unassigned tasks](https://www.servicenow.com/docs/access?context=allocate-resources-rmw&family=washingtondc&ft:locale=en-US)**

Efficiently work on resource assignments for priority items by filtering unassigned tasks.

-   **[New iconography to view resource allocations and heatmap modals](https://www.servicenow.com/docs/access?context=using-rmw&family=washingtondc&ft:locale=en-US)**
...
-   **[Reassign or unassign the assigned work](https://www.servicenow.com/docs/access?context=rmw-reassign-unassign-work&family=washingtondc&ft:locale=en-US)**
...
-   **[Export the resource portfolio view](https://www.servicenow.com/docs/access?context=export-rmw-card-view&family=washingtondc&ft:locale=en-US)**
...
-   **[Edit resource assignments using the inline editing feature](https://www.servicenow.com/docs/access?context=explore-rmw&family=washingtondc&ft:locale=en-US)**
...
Between your current release family and Yokohama, some changes were made to existing Resource Management Workspace features.
...
Between your current release family and Yokohama, some Resource Management Workspace features or functionality were removed.
...
Between your current release family and Yokohama, some Resource Management Workspace features or functionality were deprecated.
...
-   Export the resource card view as CSV or Microsoft Excel.
 ...
 See [Resource Management Workspace](https://www.servicenow.com/docs/access?context=rsrc-mgmt-wrkspc&family=washingtondc&ft:locale=en-US) for more information.
