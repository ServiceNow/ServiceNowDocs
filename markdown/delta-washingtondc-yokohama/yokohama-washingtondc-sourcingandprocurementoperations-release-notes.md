---
title: Combined Sourcing and Procurement Operations release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Sourcing and Procurement Operations from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-sourcingandprocurementoperations-release-notes.html
release: yokohama
...
# Combined Sourcing and Procurement Operations release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Sourcing and Procurement Operations from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Sourcing and Procurement Operations release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Sourcing and Procurement Operations to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Sourcing and Procurement Operations.
...
Introduced in-product assistance, also known as Help Center, for the landing, list, and analytics pages of Source-to-Pay Workspace.​ Select the Help Center icon \[Omitted image "image.help-icon"\] on these pages to view the content. This feature enables you to access the information directly from within your workspace.

-   **[\[Placeholder link text to key integration-spo-cmpro\]](https://www.servicenow.com/docs/access?context=integration-spo-cmpro&family=washingtondc&ft:locale=en-US)**
...
Between your current release family and Yokohama, some changes were made to existing Sourcing and Procurement Operations features.
...
-   **[Procurement Service Management integration with Project Management](https://www.servicenow.com/docs/access?context=integration-psm-ppm&family=washingtondc&ft:locale=en-US)**
...
**Note:** These project questions are only available on the intake form if the employee or requester has access to SPM. There’s no impact on existing customers.

-   **[Complete sourcing checkout](https://www.servicenow.com/docs/access?context=complete-sourcing-checkout&family=washingtondc&ft:locale=en-US)**
...
-   **[Requesting for products or services that you don't see on ShoppingHub](https://www.servicenow.com/docs/access?context=request-prod-serv-dont-see-sh&family=washingtondc&ft:locale=en-US)**
...
-   **[Procurement Service Management integration with third-party sourcing solutions](https://www.servicenow.com/docs/access?context=psm-integration-third-party-sourcing&family=washingtondc&ft:locale=en-US)**
...
**Note:** Currently, only a single supplier response can be returned to ServiceNow.
...
-   **[\[Placeholder link text to key source-to-pay-ws-overview\]](https://www.servicenow.com/docs/access?context=source-to-pay-ws-overview&family=washingtondc&ft:locale=en-US)**
...
-   **[\[Placeholder link text to key procurement-specialist-list-page\]](https://www.servicenow.com/docs/access?context=procurement-specialist-list-page&family=washingtondc&ft:locale=en-US)**
...
-   **[\[Placeholder link text to key create-quick-case\]](https://www.servicenow.com/docs/access?context=create-quick-case&family=washingtondc&ft:locale=en-US)**

Enhanced the usability such that a fulfiller can now create a case with just one click from the Source-to-Pay Workspace.

-   **[\[Placeholder link text to key create-procurement-case\]](https://www.servicenow.com/docs/access?context=create-procurement-case&family=washingtondc&ft:locale=en-US)**
...
-   **[Create a procurement task](https://www.servicenow.com/docs/access?context=create-procurement-task&family=washingtondc&ft:locale=en-US)**
...
-   **[Shopper to-dos](https://www.servicenow.com/docs/access?context=shopper-todos&family=washingtondc&ft:locale=en-US)**
...
-   **[Procurement Service Management integration with Employee Center](https://www.servicenow.com/docs/access?context=employee-center-integration-psm&family=washingtondc&ft:locale=en-US)**
...
-   **[Order a product with quick checkout](https://www.servicenow.com/docs/access?context=order-a-product&family=washingtondc&ft:locale=en-US)**
...
-   **[\[Placeholder link text to key purch-punchout-third-party-supp\]](https://www.servicenow.com/docs/access?context=purch-punchout-third-party-supp&family=washingtondc&ft:locale=en-US)**
...
-   **[\[Placeholder link text to key configure-supplier-punchout\]](https://www.servicenow.com/docs/access?context=configure-supplier-punchout&family=washingtondc&ft:locale=en-US)**
...
-   **[\[Placeholder link text to key add-supplier-product-bundle\]](https://www.servicenow.com/docs/access?context=add-supplier-product-bundle&family=washingtondc&ft:locale=en-US)**
...
-   **[Using ShoppingHub](https://www.servicenow.com/docs/access?context=use-shoppinghub-portal&family=washingtondc&ft:locale=en-US)**
...
-   **[Purchase and Receipt Automation](https://www.servicenow.com/docs/access?context=purchase-experience-workflow&family=washingtondc&ft:locale=en-US)**
...
-   **[Spendint API](https://www.servicenow.com/docs/access?context=spendint-api&family=washingtondc&ft:locale=en-US)**
...
**Note:** There’s no impact on existing customers and these changes come in effect only with this upgrade.
...
-   **[Components installed with Procurement Service Management](https://www.servicenow.com/docs/access?context=installed-with-FSC&family=washingtondc&ft:locale=en-US)**

Provide alignment between all Source-to-Pay \(S2P\) products and expose more commonly used data points to the end user by rescoping the **Supplier** field to the Service Task \(sn\_spend\_sdc\_service\_task\) table. With this, all tables extending the Service Task table can pull in the **Supplier** field for a better task experience. If you're an existing customer, you can see the **Supplier** field deprecated from the Supplier Task table and made available in the Service Task table through a fixed script.
...
Between your current release family and Yokohama, some Sourcing and Procurement Operations features or functionality were removed.
...
Between your current release family and Yokohama, some Sourcing and Procurement Operations features or functionality were deprecated.
...
-   **[\[Placeholder link text to key application-plugin-list\]](https://www.servicenow.com/docs/access?context=application-plugin-list&family=washingtondc&ft:locale=en-US)**

Starting with the Washington DC release, classic ShoppingHub \[com.snc.sn\_shop\] is being prepared for future deprecation. If you’re an existing customer who has upgraded, you may choose to continue with the existing ShoppingHub plugin and skip Shopping Hub \[com.snc.sn\_spend\_uib\]. However, for the UI Builder \(UIB\) experience, you must install the Shopping Hub plugin. Remember that you can't go back to the existing ShoppingHub plugin after you’ve installed this Shopping Hub plugin.

-   **[\[Placeholder link text to key simplify-risk-assessment-wf\]](https://www.servicenow.com/docs/access?context=simplify-risk-assessment-wf&family=washingtondc&ft:locale=en-US)**
...
-   Enable Procurement Specialists to source, negotiate, procure goods and services for an organization, and work on procurement tasks.
 ...
 See [Procurement Service Management](https://www.servicenow.com/docs/access?context=psm-overview&family=washingtondc&ft:locale=en-US) for more information.
