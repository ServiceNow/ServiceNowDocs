---
title: Combined Order Management release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Order Management from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-ordermanagement-release-notes.html
release: yokohama
...
-   **[Update product specification versions](https://www.servicenow.com/docs/access?context=order-mgt-exploring&family=washingtondc&ft:locale=en-US)**
...
-   **[Unified consumer option](https://www.servicenow.com/docs/access?context=order-mgt-configuring&family=washingtondc&ft:locale=en-US)**

Added support for unified consumer option in Order Management Data Model. Starting with the Washington DC release, the Data Model for Order Management includes capabilities for a unified consumer role \(sn\_customerservice.unified\_consumer\). This role is assigned to internal users who are employees and can also act as consumers.
...
-   **[Enhanced order capture experience with order enrichment steps](https://www.servicenow.com/docs/access?context=order-capture-overview&family=washingtondc&ft:locale=en-US)**
...
-   **[Monthly Recurring Charges and Non-Recurring Charges](https://www.servicenow.com/docs/access?context=pricing-management&family=washingtondc&ft:locale=en-US)**
...
-   **[Enhancements to the  ServiceNow TMF APIs](https://www.servicenow.com/docs/access?context=order-capture-overview-service-orders&family=washingtondc&ft:locale=en-US)**
...
-   **[Updates to the order to contract workflow](https://www.servicenow.com/docs/access?context=order-mgt-order-data-model&family=washingtondc&ft:locale=en-US)**
