---
title: Combined Journey designer release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Journey designer from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-journeydesigner-release-notes.html
release: yokohama
...
# Combined Journey designer release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Journey designer from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Journey designer release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Journey designer to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Journey designer.
...
-   **[Manage Journey designer task updates in bulk](https://www.servicenow.com/docs/access?context=jny-dsgnr-bulk-task-update&family=washingtondc&ft:locale=en-US)**
...
-   **[Support a change of manager](https://www.servicenow.com/docs/access?context=jny-dsgnr-jrny-config-fields&family=xanadu&ft:locale=en-US)**

Enable journeys to support a change of manager.

-   **[Base instance demo data of Journey designer to support multiple journeys](https://www.servicenow.com/docs/access?context=parental-loa&family=xanadu&ft:locale=en-US)**

Leverage the parental leave guide shipped as part of Parental Leave demo data to enhance the employee experience.

-   **[Return to the Journey details page after a task is completed](https://www.servicenow.com/docs/access?context=jny-dsgnr-employee-journey-tasks&family=xanadu&ft:locale=en-US)**

Navigate back to the Journey details page after task completion, avoiding the need to go through the breadcrumbs.

-   **[Delete subsequent tasks when a journey is deleted](https://www.servicenow.com/docs/access?context=jny-dsgnr-mngr-mntr-quick-links&family=xanadu&ft:locale=en-US)**
...
Between your current release family and Yokohama, some changes were made to existing Journey designer features.
...
Between your current release family and Yokohama, some Journey designer features or functionality were removed.
...
Between your current release family and Yokohama, some Journey designer features or functionality were deprecated.
...
Review information on how to activate Journey designer.
...
If any additional requirements were introduced or changed for Journey designer we have noted them here.
...
If any specific browser requirements were introduced or changed for Journey designer we have noted them here.
...
Review details on accessibility information for Journey designer, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Journey designer we have noted them here.
...
If there are specific highlight considerations for Journey designer we have noted them here.
...
Bulk updates for supported task types were added to Journey designer. Similar journey types with similar task types are identified and can be updated with a single action.
 ...
 See [Journey designer](https://www.servicenow.com/docs/access?context=jny-dsgnr-landing-page&family=washingtondc&ft:locale=en-US) for more information.
...
-   Enhanced employee experience through the parental leave guide shipped as part of Parental Leave demo data.
 ...
 See [Journey designer](https://www.servicenow.com/docs/access?context=jny-dsgnr-landing-page&family=xanadu&ft:locale=en-US) for more information.
