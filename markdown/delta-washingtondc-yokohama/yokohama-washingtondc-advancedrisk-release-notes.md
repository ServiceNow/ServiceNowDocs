---
title: Combined Advanced Risk release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Advanced Risk from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-advancedrisk-release-notes.html
release: yokohama
...
# Combined Advanced Risk release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Advanced Risk from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Advanced Risk release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.
...
-   **[Parallel Review and Feedback in Advanced Risk](https://www.servicenow.com/docs/access?context=integrate-advanced-risk-with-parallel-review-feedback&family=washingtondc&ft:locale=en-US)**
...
-   **[Generating a report in Microsoft Word](https://www.servicenow.com/docs/access?context=integrating-o365-with-management-reporting-of-risk&family=washingtondc&ft:locale=en-US)**
...
-   **[Exporting risk heatmap information](https://www.servicenow.com/docs/access?context=risk-heatmap-workbench&family=washingtondc&ft:locale=en-US)**
...
-   **[Auto save feature in the risk and control assessment form](https://www.servicenow.com/docs/access?context=perform-ara-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Migration of content from GRC Workspace to the ARA Workspace](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB1585068)**
...
-   **[Domain separation in Risk Management](https://www.servicenow.com/docs/access?context=domain-separation-risk-management&family=washingtondc&ft:locale=en-US)**
...
-   The **Save** button on the risk assessment form has been removed. The risk assessment form is automatically saved.
-   The stepper component was removed from the **Approvals** tab in the risk assessment form when there’s no approval configured within the assessment scope. This removal simplifies the user experience and declutters the interface, making it more intuitive.
...
-   Starting with version 18.1.0 of the Advanced Risk and Risk Management applications, the following dashboards are deprecated:
...
If you're on a legacy release or already using these dashboards, you can continue to use them.
...
-   Approve and reassign multiple risk assessments in bulk.
 ...
 See [Advanced Risk Assessment](https://www.servicenow.com/docs/access?context=advanced-risk-assessment&family=washingtondc&ft:locale=en-US) for more information.
