---
title: Combined Digital Portfolio Management release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Digital Portfolio Management from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-digitalportfoliomanagement-release-notes.html
release: yokohama
...
# Combined Digital Portfolio Management release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Digital Portfolio Management from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Digital Portfolio Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.
...
-   **[Digital Portfolio Management Workspace homepage](https://www.servicenow.com/docs/access?context=dpm-explore-landing&family=washingtondc&ft:locale=en-US)**
...
-   **[Personalize the Digital Portfolio Management Workspace homepage](https://www.servicenow.com/docs/access?context=dpm-personalize-homepage&family=washingtondc&ft:locale=en-US)**
...
-   **[Digital Portfolio Management homepage default solution cards](https://www.servicenow.com/docs/access?context=dpm-oob-solution-card-fields&family=washingtondc&ft:locale=en-US)**
...
-   **[Configure the Digital Portfolio Management experience](https://www.servicenow.com/docs/access?context=dpm-configure-experience&family=washingtondc&ft:locale=en-US)**
...
**Note:** When a solution type is hidden, that solution is omitted from the following areas of DPM:
        ...
        -   The page filters.
-   **[View business application details](https://www.servicenow.com/docs/access?context=dpm-business-apps-details&family=washingtondc&ft:locale=en-US)**
...
-   **[Copy a KPI group to create a new KPI group in Digital Portfolio Management](https://www.servicenow.com/docs/access?context=dpm-copy-kpi-group&family=washingtondc&ft:locale=en-US)**
...
-   **[Configure Digital Portfolio Management to integrate with Process Optimization](https://www.servicenow.com/docs/access?context=dpm-setup-po&family=washingtondc&ft:locale=en-US)**
...
-   Added Process Mining for DPM to see KPI details and analyze anomalies.
 ...
 See [Digital Portfolio Management](https://www.servicenow.com/docs/access?context=dpm-landing&family=washingtondc&ft:locale=en-US) for more information.
