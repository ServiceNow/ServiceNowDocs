---
title: Combined Next Experience Developer \(NED\) Tools release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Next Experience Developer \(NED\) Tools from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-nextexperiencedevelopernedtools-release-notes.html
release: yokohama
...
# Combined Next Experience Developer \(NED\) Tools release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Next Experience Developer \(NED\) Tools from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Next Experience Developer \(NED\) Tools release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Next Experience Developer \(NED\) Tools to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Next Experience Developer \(NED\) Tools.
...
Between your current release family and Yokohama, some changes were made to existing Next Experience Developer \(NED\) Tools features.
...
Between your current release family and Yokohama, some Next Experience Developer \(NED\) Tools features or functionality were removed.
...
Between your current release family and Yokohama, some Next Experience Developer \(NED\) Tools features or functionality were deprecated.
...
Review information on how to activate Next Experience Developer \(NED\) Tools.
...
If any additional requirements were introduced or changed for Next Experience Developer \(NED\) Tools we have noted them here.
...
If any specific browser requirements were introduced or changed for Next Experience Developer \(NED\) Tools we have noted them here.
...
Review details on accessibility information for Next Experience Developer \(NED\) Tools, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Next Experience Developer \(NED\) Tools we have noted them here.
...
If there are specific highlight considerations for Next Experience Developer \(NED\) Tools we have noted them here.
...
-   Get information on network calls made to your pages including the type of calls, timing, frequency, and network URLs.
 ...
 See [Next Experience Developer Tools](https://developer.servicenow.com/dev.do#!/reference/next-experience/xanadu/developer-tools/using-next-experience-developer-tools) for more information.
