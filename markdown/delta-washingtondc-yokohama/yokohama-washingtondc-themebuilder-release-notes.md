---
title: Combined Theme Builder release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Theme Builder from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-themebuilder-release-notes.html
release: yokohama
...
# Combined Theme Builder release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Theme Builder from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Theme Builder release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Theme Builder to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Theme Builder.
...
-   **[Component editing](https://www.servicenow.com/docs/access?context=tb-edit-components&family=washingtondc&ft:locale=en-US)**
...
-   **[New feature messaging](https://www.servicenow.com/docs/access?context=configuring-next-experience-with-theme-builder&family=washingtondc&ft:locale=en-US)**

Learn about new features via a what's new modal when you first launch the updated version of Theme Builder.

-   **[Open in Theme Builder button](https://www.servicenow.com/docs/access?context=config-next-experience-themes-prefs&family=washingtondc&ft:locale=en-US)**
...
-   **[Validation of JSON code for the theme records you create](https://www.servicenow.com/docs/access?context=config-next-experience-themes-prefs&family=washingtondc&ft:locale=en-US)**
...
-   **[Customize shape and topography values](https://www.servicenow.com/docs/access?context=tb-create-theme&family=washingtondc&ft:locale=en-US)**
...
Between your current release family and Yokohama, some changes were made to existing Theme Builder features.
...
Between your current release family and Yokohama, some Theme Builder features or functionality were removed.
...
Between your current release family and Yokohama, some Theme Builder features or functionality were deprecated.
...
-   **[Adjust components to meet accessibility standards](https://www.servicenow.com/docs/access?context=tb-adjust-component-wcag&family=washingtondc&ft:locale=en-US)**

Use new Accessibility checker capabilities to ensure you're meeting conformant color contrast levels as you apply your own brand and colors to your web or mobile instance. See [Adjust components to meet accessibility standards](https://www.servicenow.com/docs/access?context=tb-adjust-component-wcag&family=washingtondc&ft:locale=en-US) for details.
...
-   Work with component-specific theme hooks to create a theme tailored to your needs.
 ...
 See [Working with themes in Next Experience](https://www.servicenow.com/docs/access?context=next-experience-theming&family=washingtondc&ft:locale=en-US) for more information.
