---
title: Combined Cloud Cost Management 8.0.0 release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Cloud Cost Management 8.0.0 from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-cloudcostmanagement800-release-notes.html
release: yokohama
...
# Combined Cloud Cost Management 8.0.0 release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Cloud Cost Management 8.0.0 from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Cloud Cost Management 8.0.0 release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Cloud Cost Management 8.0.0 to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Cloud Cost Management 8.0.0.
...
Between your current release family and Yokohama, some changes were made to existing Cloud Cost Management 8.0.0 features.
...
Between your current release family and Yokohama, some Cloud Cost Management 8.0.0 features or functionality were removed.
...
Between your current release family and Yokohama, some Cloud Cost Management 8.0.0 features or functionality were deprecated.
...
Review information on how to activate Cloud Cost Management 8.0.0.
...
If any additional requirements were introduced or changed for Cloud Cost Management 8.0.0 we have noted them here.
...
If any specific browser requirements were introduced or changed for Cloud Cost Management 8.0.0 we have noted them here.
...
Review details on accessibility information for Cloud Cost Management 8.0.0, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Cloud Cost Management 8.0.0 we have noted them here.
...
If there are specific highlight considerations for Cloud Cost Management 8.0.0 we have noted them here.
