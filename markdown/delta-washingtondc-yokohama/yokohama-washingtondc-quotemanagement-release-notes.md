---
title: Combined Quote Management release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Quote Management from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-quotemanagement-release-notes.html
release: yokohama
...
# Combined Quote Management release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Quote Management from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Quote Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.
...
-   **[Quote creation](https://www.servicenow.com/docs/access?context=create-new-quote&family=washingtondc&ft:locale=en-US)**
...
-   **[Quote revisions](https://www.servicenow.com/docs/access?context=quote-management-revisions-tab&family=washingtondc&ft:locale=en-US)**
...
-   **[Generating orders from quotes](https://www.servicenow.com/docs/access?context=quote-management-customer-orders-tab&family=washingtondc&ft:locale=en-US)**

Convert active quotes to product orders after customer approval.

-   **[Using Quote Management](https://www.servicenow.com/docs/access?context=quote-mgmt-using&family=washingtondc&ft:locale=en-US)**

Add Quote and Opportunity related lists to a customer account table. For details, see the [Add Quote and Opportunity related lists to a customer account table \[KB1635146\]](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB1635146).

-   **[Cost book integration with Quote](https://www.servicenow.com/docs/access?context=quote-management&family=washingtondc&ft:locale=en-US)**
...
-   Easily create quotes for Change orders using the reference to sold product.
 ...
 See [Quote Management](https://www.servicenow.com/docs/access?context=quote-management&family=washingtondc&ft:locale=en-US) and [Sales and Order Management](https://www.servicenow.com/docs/access?context=order-mgt-overview&family=washingtondc&ft:locale=en-US) for more information.
