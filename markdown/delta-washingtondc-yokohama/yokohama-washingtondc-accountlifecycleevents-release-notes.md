---
title: Combined Account Lifecycle Events release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Account Lifecycle Events from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-accountlifecycleevents-release-notes.html
release: yokohama
...
# Combined Account Lifecycle Events release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Account Lifecycle Events from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Account Lifecycle Events release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Account Lifecycle Events to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Account Lifecycle Events.
...
Between your current release family and Yokohama, some changes were made to existing Account Lifecycle Events features.
...
Between your current release family and Yokohama, some Account Lifecycle Events features or functionality were removed.
...
Between your current release family and Yokohama, some Account Lifecycle Events features or functionality were deprecated.
...
Review information on how to activate Account Lifecycle Events.
...
If any additional requirements were introduced or changed for Account Lifecycle Events we have noted them here.
...
If any specific browser requirements were introduced or changed for Account Lifecycle Events we have noted them here.
...
Review details on accessibility information for Account Lifecycle Events, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Account Lifecycle Events we have noted them here.
...
If there are specific highlight considerations for Account Lifecycle Events we have noted them here.
