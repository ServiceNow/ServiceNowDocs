---
title: Combined Mobile Platform release notes for upgrades from Washington DC to Yokohama
description: Consolidated page of all release notes for Mobile Platform from Washington DC to Yokohama.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/delta-washingtondc-yokohama/yokohama-washingtondc-mobileplatform-release-notes.html
release: yokohama
...
# Combined Mobile Platform release notes for upgrades from Washington DC to Yokohama

Consolidated page of all release notes for Mobile Platform from Washington DC to Yokohama.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Mobile Platform release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Yokohama.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Mobile Platform to Yokohama
...
Between your current release family and Yokohama, new features were introduced for Mobile Platform.
...
-   **[Overriding critical alerts](https://www.servicenow.com/docs/access?context=mobile-critical-alerts-create&family=washingtondc&ft:locale=en-US)**

Send your users critical alerts, even if they configure their mobile device to a Do Not Disturb or Silent mode setting.

-   **[Dynamic pop-ups](https://www.servicenow.com/docs/access?context=mobile_popups&family=washingtondc&ft:locale=en-US)**
...
-   **[Securing your ServiceNow mobile instance with Zero Trust Access](https://www.servicenow.com/docs/access?context=zero-trust-access-for-mobile&family=washingtondc&ft:locale=en-US)**
...
-   **[Custom map screen support for additional entry points to launch Indoor Wayfinding](https://www.servicenow.com/docs/access?context=indoor-wayfinding-config&family=washingtondc&ft:locale=en-US)**

Launch custom map screens from a mobile embedded web page or from a push notification.

-   **[Mobile Resolution Notes Generation](https://www.servicenow.com/docs/access?context=ai-case-summarization&family=washingtondc&ft:locale=en-US)**
...
-   **[Mobile SDK available in the ServiceNow Store](https://www.servicenow.com/docs/access?context=mobile-sdk&family=washingtondc&ft:locale=en-US)**
...
-   **[Mobile App Builder](https://www.servicenow.com/docs/access?context=mab-concept&family=washingtondc&ft:locale=en-US)**
...
-   **[Data visualization user experience](https://www.servicenow.com/docs/access?context=chart-screen&family=washingtondc&ft:locale=en-US)**
...
-   **[Arabic added to the support of right-to-left languages](https://www.servicenow.com/docs/access?context=language-selection-mobile-device&family=washingtondc&ft:locale=en-US)**
...
-   **[Offline support in Now Mobile apps and custom apps](https://www.servicenow.com/docs/access?context=mobile-offline-mode&family=washingtondc&ft:locale=en-US)**
...
-   **[Now Assist in Virtual Agent for mobile](https://www.servicenow.com/docs/access?context=configure-va-mobile-web-client&family=washingtondc&ft:locale=en-US)**
...
Between your current release family and Yokohama, some changes were made to existing Mobile Platform features.
...
-   **[Mobile Playbooks enhancements](https://www.servicenow.com/docs/access?context=mobile-playbooks&family=washingtondc&ft:locale=en-US)**
...
-   **[Mobile Publishing enhancements](https://www.servicenow.com/docs/access?context=mobile-publishing&family=washingtondc&ft:locale=en-US)**
...
Between your current release family and Yokohama, some Mobile Platform features or functionality were removed.
...
Mobile Studio used for mobile app configuration has been removed from the Washington DC release. Mobile configuration is performed using the following tools: a web-based UI, Mobile App Builder, and Mobile Card Builder.
...
Between your current release family and Yokohama, some Mobile Platform features or functionality were deprecated.
...
Accessibility improvements for the data visualization feature include the following updates:

    -   Enhanced support for screen readers, with a specific focus on the VoiceOver functionality. This improvement ensures that users relying on screen readers can seamlessly navigate and comprehend the content within data visualization charts.
    -   Text within data visualization charts can now be resized, accommodating users who may need larger text for better readability. This support enables text to be increased significantly without any loss of content or functionality.
    -   Enable a dark theme or mode in Mobile Platform. This option is commonly used to alleviate eye strain and improve readability.
...
-   Mobile App Builder is now integrated with Mobile Publishing so that admins can manage custom branded app requests and configure mobile apps in one tool.
 ...
 See [Mobile Platform](https://www.servicenow.com/docs/access?context=mobile-config-navigation&family=washingtondc&ft:locale=en-US) for more information.
