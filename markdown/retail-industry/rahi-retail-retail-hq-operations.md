...
![List of Retail HQ operations cases](../image/z-retail-hq-opertaion.png)

For information on the components installed with HQ communications case, see [Components installed with Retail HQ Operations](rahi-retail-components-retail-hq-operations.md).
