...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/retail-industry/retail-operations/rahi-retail-portal-view-knowledge-articles.html
release: yokohama
...
breadcrumb: [Track cases and tasks from Retail portal, Retail]
---
...
2.  Find and select the knowledge article that you want to review.
    ...
    -   In the **Search Knowledge** field, enter the keywords to search for an article and select the Search icon \(\[Omitted image "search\_icon.png"\] Alt text: search icon.\).
