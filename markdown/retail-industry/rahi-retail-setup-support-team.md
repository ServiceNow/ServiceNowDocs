...
Before assigning the sn\_retail.support\_agent role to a group of users, you must [Create a user group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/user-administration/t_CreateAGroup.md) and then [Add users to a group](https://add%20a%20user%20to%20a%20group/).
