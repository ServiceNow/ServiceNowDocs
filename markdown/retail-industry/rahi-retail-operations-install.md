...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/retail-industry/rahi-retail-operations-install.html
release: zurich
topic_type: task
...
For information about the components installed with each plugin, see respective associated links in [Components installed with plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/retail-industry/rahi-retail-components-installed-with-plugins.md).
