...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/retail-industry/legacy-retail-task-management/rahi-retail-create-service-definition.html
release: yokohama
...
2.  Fill in the **Name** and **ID** fields.

3.  In the **Table** field, select **Retail Case \[sn\_retail\_case\]**.
