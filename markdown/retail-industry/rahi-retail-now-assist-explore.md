...
-   Retrieve relevant knowledge base \(KB\) articles: Locate and provide KB articles that are relevant to a case or query, offering AI agent, valuable context and information.
