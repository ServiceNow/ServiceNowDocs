...
1.  The administrator configures the Retail Core application.
2.  The store manager raises a case at a retail location.
3.  A retail case is created.
4.  The store associate investigates the issue and provides a report, documented within the case.
5.  The store manager reviews the investigation report details and then closes the case.
