...
8.  Select **Save** to save the details.
    ...
    1.  Select \[Omitted image "Form\_DeleteIcon.png"\] Alt text: to delete the new store task.

    2.  Select \[Omitted image "icon-pencil-ac.png"\] Alt text: to edit the store task details.
