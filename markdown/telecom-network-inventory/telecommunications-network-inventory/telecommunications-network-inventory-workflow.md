...
1.  Create network inventory records manually by using inventory forms. With these forms, you can create and review the network inventory records and then define the relationships between them. You can access the inventory form in the Inventory node in the Network Inventory Workspace List view. To learn more, see [Manually create and review your network asset instances](creating-telecommunications-network-inventory.md).
...
-   To learn more about the inventory model relationship, see [Modeling network inventory relationships](inventory-modeling-process.md).
