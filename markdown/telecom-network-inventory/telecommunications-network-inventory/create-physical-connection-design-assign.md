...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/telecom-network-inventory/telecommunications-network-inventory/create-physical-connection-design-assign.html
release: australia
...
9.  On the **Task Attributes** tab, fill in the fields.
    ...
    To learn more, see [Task attributes in Create physical connection form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/telecom-network-inventory/telecommunications-network-inventory/task-attributes-create-physical-connection-form.md).
