...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/telecom-network-inventory/telecommunications-network-inventory/create-physical-connection-design-assign.html
release: brazil
...
9.  On the **Task Attributes** tab, fill in the fields.
    ...
    To learn more, see [Task attributes in Create physical connection form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/task-attributes-create-physical-connection-form.md).
