...
description: With the Order Management for Telecommunications and Media application, you can manage all your product and service orders from one place. These product orders are divided into service orders that are further divided into resource orders.
locale: en-US
release: xanadu
...
1.  Create a record producer. To learn more, see [Create a record producer](https://www.servicenow.com/docs/access?context=t_DefRecProdInSCat&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
2.  Create a change model. To learn more, see [Create a change model](https://www.servicenow.com/docs/access?context=create-a-change-model&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
