...
1.  Create a record producer. To learn more, see [Create a record producer](https://www.servicenow.com/docs/access?context=t_DefRecProdInSCat&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
2.  Create a change model. To learn more, see [Create a change model](https://www.servicenow.com/docs/access?context=create-a-change-model&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
