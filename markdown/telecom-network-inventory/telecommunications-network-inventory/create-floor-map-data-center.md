...
1.  Create a campus with buildings and floors.
    ...
    To learn more, see [Create a campus with buildings and floors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/create-a-campus-building-and-floor.md).
...
7.  Export the updated CAD changes to your CAD file.
    ...
    Exporting the updated changes creates a copy of the modified CAD file in Indoor Mapping. To learn more about, see [Export CAD configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/export-cad-config.md).
