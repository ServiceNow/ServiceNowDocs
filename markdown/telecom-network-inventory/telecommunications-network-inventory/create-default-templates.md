...
4.  On the form, fill in the general information to create a default template.
    ...
    To learn more about the fields, see [Default Template form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/tni-default-template-form.md).
...
6.  To schedule the form, click **Schedule** and fill in the Scheduled Entity Generation form.
    ...
    **Note:** Scheduling is only available in the classic environment.
    ...
    To learn more about the fields, see [Scheduled Entity Generation form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/scheduled-entity-generation-form.md).
