...
Create a network instance instantiation. For information, see [Instantiating inventory using design and assign](../concept/instantiate-asset-using-template-relationship-model.md).
