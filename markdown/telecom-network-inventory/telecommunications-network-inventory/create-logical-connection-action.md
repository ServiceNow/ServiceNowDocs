...
</table>To learn more about the variable data types, see [Flow Designer input and output data variables](https://www.servicenow.com/docs/access?context=action-inputs-outputs&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
