...
List of all discovery sources at the CI attribute level. To learn more, see [CMDB 360/Multisource CMDB](https://www.servicenow.com/docs/access?context=multisource-cmdb&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
