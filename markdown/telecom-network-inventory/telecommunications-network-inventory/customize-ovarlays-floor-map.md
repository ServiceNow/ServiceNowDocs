...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/customize-ovarlays-floor-map.html
release: zurich
...
<table id="choicetable_tyg_2bt_nfc"><thead><tr><th align="left" id="d43630e116">

Action

</th><th align="left" id="d43630e119">

Details

</th></tr></thead><tbody><tr><td id="d43630e125">
...
Set up time duration for the operational data. To learn more, see [Customize overlay time series on the floor map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/customize-overlay-time-series-floor-map.md).
