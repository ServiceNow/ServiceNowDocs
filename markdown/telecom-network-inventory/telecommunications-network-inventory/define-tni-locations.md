...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/telecom-network-inventory/telecommunications-network-inventory/define-tni-locations.html
release: xanadu
...
1.  Navigate to **User Administration** &gt; **Locations**.

2.  Select **New**.

3.  On the Location form, fill in the fields, with address and contact information for the location record.

    **Note:** To learn more about the fields on the Locations form, see [Location form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/telecom-network-inventory/telecommunications-network-inventory/tni-location-forms.md).
