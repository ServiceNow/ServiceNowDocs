...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/telecom-network-inventory/telecommunications-network-inventory/define-tni-locations.html
release: yokohama
...
3.  On the Location form, fill in the fields, with address and contact information for the location record.
    ...
    **Note:** To learn more about the fields on the Locations form, see [Location form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/telecom-network-inventory/telecommunications-network-inventory/tni-location-forms.md).
