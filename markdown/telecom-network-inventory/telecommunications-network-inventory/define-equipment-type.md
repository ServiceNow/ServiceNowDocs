...
<table id="choicetable_mds_dxq_qxb"><thead><tr><th align="left" id="d53049e109">

Option

</th><th align="left" id="d53049e112">

Description

</th></tr></thead><tbody><tr><td id="d53049e118">
...
</td></tr><tr><td id="d53049e140">

**Kubernetes Clusters**

</td><td>

Creates a Kubernetes cluster instance. To learn more about the fields in the form, see [Kubernetes discovery using patterns](https://www.servicenow.com/docs/access?context=kubernetes-discovery&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).

</td></tr><tr><td id="d53049e159">

**Kubernetes Pods**

</td><td>

Creates a Kubernetes pod machine instance. To learn more about the fields in the form, see [Kubernetes discovery using patterns](https://www.servicenow.com/docs/access?context=kubernetes-discovery&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
...
4.  In the Equipment form, fill in the fields.
    ...
    To learn more about the fields in the Equipment form, see [2012740c405ba205cf61fa3af56b937a2f09cf49.dita](define-tni-equipment.md).
