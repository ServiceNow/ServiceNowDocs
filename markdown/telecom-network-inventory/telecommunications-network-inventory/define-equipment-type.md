...
<table id="choicetable_mds_dxq_qxb"><thead><tr><th align="left" id="d66629e109">

Option

</th><th align="left" id="d66629e112">

Description

</th></tr></thead><tbody><tr><td id="d66629e118">
...
</td></tr><tr><td id="d66629e140">

**Kubernetes Clusters**

</td><td>

Creates a Kubernetes cluster instance. To learn more about the fields in the form, see [Kubernetes discovery using patterns](https://www.servicenow.com/docs/access?context=kubernetes-discovery&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).

</td></tr><tr><td id="d66629e159">

**Kubernetes Pods**

</td><td>

Creates a Kubernetes pod machine instance. To learn more about the fields in the form, see [Kubernetes discovery using patterns](https://www.servicenow.com/docs/access?context=kubernetes-discovery&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).
...
4.  In the Equipment form, fill in the fields.
    ...
    To learn more about the fields in the Equipment form, see [ba2dcf9259766c1056a6c37a7888bb630a54016d.dita](define-tni-equipment.md).
