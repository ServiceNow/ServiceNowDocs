...
4.  On the **Details** tab, fill in the form.
    ...
    To learn about the fields in the Network Topology form, see [Network topology form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/network-topology-form.md).
