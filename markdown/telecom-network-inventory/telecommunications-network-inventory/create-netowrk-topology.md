...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/create-netowrk-topology.html
release: zurich
...
4.  On the **Details** tab, fill in the form.
    ...
    To learn about the fields in the Network Topology form, see [Network topology form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/network-topology-form.md).
