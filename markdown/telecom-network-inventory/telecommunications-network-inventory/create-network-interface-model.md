...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/create-network-interface-model.html
release: zurich
...
2.  Select the list icon \(\[Omitted image "ni-workspace-list-icon.png"\] Alt text: List icon..\), and then go to **Inventory Models** &gt; **Interface Models**.
...
6.  Under the **Details** tab, on the form, fill in the fields.
    ...
    **Note:** To learn more about the fields, see [Network Interface Model form - Information tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/network-interface-model-form-information-tab.md).
