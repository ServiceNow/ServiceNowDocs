...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/telecom-network-inventory/telecommunications-network-inventory/create-network-interface-model.html
release: australia
...
6.  Under the **Details** tab, on the form, fill in the fields.
    ...
    **Note:** To learn more about the fields, see [Network Interface Model form - Information tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/telecom-network-inventory/telecommunications-network-inventory/network-interface-model-form-information-tab.md).
