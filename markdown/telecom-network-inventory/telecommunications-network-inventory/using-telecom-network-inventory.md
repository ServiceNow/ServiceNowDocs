...
-   **[Creating inventory template relationship](creating-inventory-templates-telco-equipment.md)**  
...
-   **[Viewing your network inventory configuration items with CMDB Workspace](viewing-network-inventory-using-cmdb-workspace.md)**  
...
-   **[Using the network diagram](using-network-diagram.md)**  
...
-   **[Using an attribute pack for a CI record](using-pack-table-ci-record.md)**  
...
-   **[Using Design and Assign function](using-playbooks-design-assign-inventory-record.md)**  
...
-   **[Using Network visualization view](using-network-visualization.md)**  
