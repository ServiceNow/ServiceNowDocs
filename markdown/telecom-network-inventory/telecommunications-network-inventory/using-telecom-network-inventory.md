...
-   **[Viewing your network inventory configuration items with CMDB Workspace or Service Graph Workspace](viewing-network-inventory-using-cmdb-workspace.md)**  
...
-   **[Network diagram](using-network-diagram.md)**  
...
-   **[Attribute pack for CI records](using-pack-table-ci-record.md)**  
...
-   **[Design and Assign function](using-playbooks-design-assign-inventory-record.md)**  
...
-   **[Network visualization view](using-network-visualization.md)**  
