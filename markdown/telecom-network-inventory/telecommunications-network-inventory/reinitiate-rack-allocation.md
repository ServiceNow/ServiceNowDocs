...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/reinitiate-rack-allocation.html
release: zurich
...
4.  From the **State** list, select **New**.
    ...
    \[Omitted image "image.select-new"\] Alt text: State list on the change request form set to New
