...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/telecom-network-inventory/telecommunications-network-inventory/define-data-center-details.html
release: brazil
...
4.  On the **Details** tab, fill in the fields.
    ...
    To learn more about the fields that are unique to the Data Center form, see [Network site form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/tni-network-site-form.md).
