...
2.  Create the model relationship. The model relationship captures the relationships between the inventory models. To learn more, see [Model relationships](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/inventory-modeling-process.md).
...
1.  Create the change request with the change model. To learn more, see [Create a change request from Network Inventory Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/create_a_change_request_in_tni.md).
...
You can create a set of network inventory records to fulfill an order request for Gigabyte Passive Optical Networks \(GPON\) broadband by using the design and assign function. To learn more, see [Design and assign GPON broadband service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/gpon-broadband-service.md).

**Parent Topic:**[Model your workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/telecommunications-network-inventory-workflow.md)
...
[Model relationships](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/inventory-modeling-process.md)
