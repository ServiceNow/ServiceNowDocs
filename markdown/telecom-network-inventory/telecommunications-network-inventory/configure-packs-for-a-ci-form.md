...
-   Create a pack table with a set of attributes. To learn more, see [Create an attribute pack table](create-pack-table.md).
...
[Create an attribute pack table](create-pack-table.md)
