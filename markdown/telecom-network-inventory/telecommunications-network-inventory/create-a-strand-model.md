...
2.  Select the list icon \(![List icon.](../image/ni-workspace-list-icon.png)\), and then go to **Inventory Models** &gt; **Strand Models**.

3.  Select **New**.

4.  On the **Details** tab, fill in the fields.

    **Note:** To learn more about the fields, see [Strand model form](../reference/strand-model-form.md).
