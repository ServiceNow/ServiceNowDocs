...
Network site or data center in which the network inventory asset is installed. Click the search icon \(![Search icon.](../image/search.png)\) and select a network site. To learn more, see [6ae017e0af7d4246ad6f9813addb0b7ccaa73376.dita](../task/define-tni-sites.md).
