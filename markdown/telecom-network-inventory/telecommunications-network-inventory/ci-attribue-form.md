...
Network site in which the network inventory asset is installed. Click the search icon \(![Search icon.](../image/search.png)\) and select a network site. To learn more, see [ca1a77be2c4d9d7714f11ba6f1f20b14e07bb48f.dita](../task/define-tni-sites.md).
