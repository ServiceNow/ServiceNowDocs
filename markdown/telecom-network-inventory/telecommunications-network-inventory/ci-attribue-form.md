...
Network site or data center in which the network inventory asset is installed. Click the search icon \(![Search icon.](../image/search.png)\) and select a network site. To learn more, see [e471915e2f00861d61d7007e717c2e637214e470.dita](../task/define-tni-sites.md).
