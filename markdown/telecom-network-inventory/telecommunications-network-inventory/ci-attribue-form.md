...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/telecom-network-inventory/telecommunications-network-inventory/ci-attribue-form.html
release: yokohama
...
Configuration item \(CI\) of the network inventory asset.
...
Option that designates if this network asset is a spare.
