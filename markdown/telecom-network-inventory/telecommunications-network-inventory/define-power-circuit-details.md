...
When you create a power circuit connection record, it creates a corresponding configuration item \(CI\) record in the circuit \[cmdb\_ci\_circuit\] table. To learn more, see [Data model for Telecommunications Network Inventory](../concept/uses-for-network-inventory-data.md).
