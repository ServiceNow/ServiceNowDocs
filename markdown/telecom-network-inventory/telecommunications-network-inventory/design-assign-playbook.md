...
Uses the [Workflow Studio](https://www.servicenow.com/docs/access?context=workflow-studio&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US) application to author, configure, and monitor the Design and Assign function.
