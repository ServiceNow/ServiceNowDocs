...
You can customize the capacity calculation for each type of Configuration Item \(CI\). This feature enables you to create and configure the function, definition, and metric to calculate the capacity. To learn more about configuring the capacity function and creating the metric, see [Capacity management](configuring-capacity-management.md).
...
To learn more about capacity function, definition, and metric, see [Capacity management](configuring-capacity-management.md).
