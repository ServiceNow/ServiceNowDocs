...
4.  On the **Details** tab, fill in the fields.
    ...
    To learn more about the fields, see [Strand form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/strand-form.md).
