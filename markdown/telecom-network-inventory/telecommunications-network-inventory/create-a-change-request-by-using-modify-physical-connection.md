...
9.  On the Physical connection modification request form, update the physical connection endpoints and details, as required.
    ...
    To learn more about the fields, see [Physical connection modification request form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/physical-connection-modification-request-form.md).
