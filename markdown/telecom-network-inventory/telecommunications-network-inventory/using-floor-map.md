...
-   **[Map Indoor Mapping campus to a datacenter](../task/map-campus-data-center.md)**  
...
-   **[Map a Configuration Item to a floor map](../task/map-ci-floor-map-location.md)**  
...
-   **[View details of floor map](../task/view-details-floor-map.md)**  
...
-   **[Print a floor map](../task/print-floor-map.md)**  
...
-   **[Open floor map from an incident or alert](../task/open-floor-map-incident-alert.md)**  
...
**Parent Topic:**[Using Network visualization view](using-network-visualization.md)
