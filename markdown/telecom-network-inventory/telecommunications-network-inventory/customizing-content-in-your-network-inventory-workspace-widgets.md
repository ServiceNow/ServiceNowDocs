...
**Note:** To learn more about creating, updating, or naming CMDB groups, see [CMDB groups](https://www.servicenow.com/docs/access?context=cmdb-groups&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
