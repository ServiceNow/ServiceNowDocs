...
**Note:** To learn more about creating, updating, or naming CMDB groups, see [CMDB groups](https://www.servicenow.com/docs/access?context=cmdb-groups&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
