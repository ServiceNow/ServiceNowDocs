...
![CMDB groups view for the Network Inventory Workspace with the list of standard CMDB groups.](../image/cmdb-group.png "Standard CMDB groups for the Network Inventory Workspace")
...
**Note:** To learn more about creating, updating, or naming CMDB groups, see [CMDB groups](https://www.servicenow.com/docs/access?context=cmdb-groups&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
