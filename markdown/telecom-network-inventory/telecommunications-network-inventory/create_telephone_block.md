...
-   Ensure that the Telecommunications Network Inventory application includes all the required components of your telephone number. To learn more, see [Creating telephone number components](../concept/create_components_of_a_telephone_number.md).
