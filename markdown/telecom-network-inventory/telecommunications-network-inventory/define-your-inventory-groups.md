...
When you create an inventory group, it creates a group in the inventory group\[cmdb\_group\] table. To learn more, see [Data model for Telecommunications Network Inventory](../concept/uses-for-network-inventory-data.md).
