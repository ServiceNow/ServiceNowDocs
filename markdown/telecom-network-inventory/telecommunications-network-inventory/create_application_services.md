...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/telecom-network-inventory/telecommunications-network-inventory/create\_application\_services.html
release: brazil
...
4.  On the Service Instance form, fill in the fields.
    ...
    To learn more about fields, see [Service Instance form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/application-service-instance-form.md).
