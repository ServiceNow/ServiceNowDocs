...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/integration-with-hardware-asset-management.html
release: zurich
...
When you instantiate equipment at a network site with an inventory template, the system picks assets that match the interface card models in the same network site location. Otherwise, the application creates a CI for the interface card. The system makes a relationship with the other assets that are available in a stockroom. These relationships are made only if the related assets are available in a stockroom.

## Hardware Asset Management integration workflow

This integration enables you to do the following tasks:

1.  Create a service request for the bill of materials. To learn more, see [Create a service request to procure assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/create-service-request-procure-assets.md).
...
-   **[Create a service request to procure assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/create-service-request-procure-assets.md)**  
...
**Parent Topic:**[Integrating Telecommunications Network Inventory with other applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/integrating-telecommunications-network-inventory--applications.md)
