...
With this integration, you can enable the Telecommunications Network Inventory application to create the bill of materials for your assets by using a record producer. Then, you can create a service request to get those assets. To learn more about record producers, see Record Producer.
...
The Hardware Asset Management fulfills the service request and executes the workflow to procure the assets in the Hardware Asset Management Workspace. To learn more about the Hardware Asset Management workflow, see Procurement.
