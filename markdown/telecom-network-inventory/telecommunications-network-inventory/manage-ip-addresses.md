...
description: Manage IP address allocation in the application by creating IP Address Blocks, IP Subnetworks, allocated IP addresses, and IP Address records. These addresses are expressed in Classless Inter-Domain Routing \(CIDR\) notation. Both IPv4 and IPv6 are supported.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/telecom-network-inventory/telecommunications-network-inventory/manage-ip-addresses.html
release: australia
...
Manage IP address allocation in the application by creating IP Address Blocks, IP Subnetworks, allocated IP addresses, and IP Address records. These addresses are expressed in Classless Inter-Domain Routing \(CIDR\) notation. Both IPv4 and IPv6 are supported.
...
-   **[Allocate IP address slots in a subnetwork](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/telecom-network-inventory/telecommunications-network-inventory/allocate-ip-address-slots-in-a-subnetwork.md)**  
...
**Parent Topic:**[Inventory number allocation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/telecom-network-inventory/telecommunications-network-inventory/vlan_or_lag_number_management.md)
...
[Exploring IP addresses allocation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/telecom-network-inventory/telecommunications-network-inventory/exploring-ip-addresses-allocation.md)
