...
-   **Equipment holder models**
    ...
    An equipment holder model represents the metadata for the representation of containers, including the bays, cabinets, cages, line ups, relay racks, and slots. To learn more, see [Create an equipment holder model](../task/create-equipment-holder-models.md).
...
To learn more about how to model your network inventory relationships, see [Modeling your network inventory relationships](inventory-modeling-process.md).
