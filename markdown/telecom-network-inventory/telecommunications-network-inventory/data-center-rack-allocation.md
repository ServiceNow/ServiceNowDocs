...
When a data center infrastructure allocation change request is submitted, the target data center and rack unit requirements are taken as input. Power, weight, temperature constraints, and any equipment specifications in the **Short description**, **Description**, and **Work notes** fields are also included in the rack allocation analysis.
...
When you re-initiate the **Find Allocation** action on a change request with the same or slightly modified short description that already contains Affected CIs, a dialog appears. It asks whether to continue or finish without changes.
...
[Data center infrastructure allocation placement policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/data-center-infra-allocation-placement-policies.md)

[Data center infrastructure allocation failure cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/data-center-infra-allocation-failure-cases.md)
