...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/network-inventory-facility-classes.html
release: zurich
...
|Rack Rail|cmdb\_ci\_rack\_rail|Hardware|A **rack rail** is a **mounting structure** inside a telecom or server rack that lets you **securely install and slide** equipment such as servers, switches, power supplies, and other hardware into place.|
|Wire Manager|cmdb\_ci\_wire\_manager|Hardware|A wire manager \(also called a cable manager or cable management system\) organizes, guides, protects, and secures network and power cables within telecom racks and data center infrastructure.|
|Cage|cmdb\_ci\_cage|Facility Hardware|A cage in a telecom data center is a secure, enclosed space within a data hall or colocation facility, built using metal mesh panels and lockable doors. It isolates and protects a customer’s or department’s servers, telecom gear, and networking equipment from unauthorized access.|
