...
An inventory template includes the rules on the proper way to configure the equipment. These rules are based on the operating requirements from the manufacturer. A template also includes such information as the number of available slots. It also indicates whether the hardware in a piece of equipment is compatible with the equipment that is related to it.
...
-   **[Define or update a naming pattern for a related template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/define-update-naming-pattern.md)**  
