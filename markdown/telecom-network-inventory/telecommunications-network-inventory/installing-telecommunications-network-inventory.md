...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/telecom-network-inventory/telecommunications-network-inventory/installing-telecommunications-network-inventory.html
release: xanadu
...
2.  Find the Network Inventory Advanced application \(sn\_ni\_adv\) using the filter criteria and search bar.
