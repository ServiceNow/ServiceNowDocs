...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/define-tni-physical-connections.html
release: zurich
...
4.  On the **Details** tab, in the Physical connection section, fill in the general information for the physical connection.
    ...
    To learn more about the fields that are unique to the Physical Connection form, see [Physical Connection form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/physical-connection-form.md).
