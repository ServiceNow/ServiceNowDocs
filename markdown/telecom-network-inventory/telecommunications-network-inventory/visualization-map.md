...
To learn more about how to use the geo map, see [View details of the geo map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/view-details-network-site-map.md).

**Related topics**  


[Geo map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/using-network-site-map.md)
