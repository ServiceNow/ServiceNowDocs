...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/create-equipment-record-design-and-assign.html
release: zurich
...
2.  Create a change request to instantiate an equipment record.
    ...
    4.  On the **Add equipment details** section, fill in the fields.
        ...
        For a description of the field valuesTo learn more about the fields, see [Equipment form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/equipment-form.md).
...
10. On the **Task Attribute** tab, fill in the fields.
    ...
    For a description of the field values, see [Equipment task attribute form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/equipment-task-attribute-form.md).
...
[Create an inventory template for a logical composite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/creating-inventory-template-logical-composite.md)
