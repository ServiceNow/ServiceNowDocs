...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/update\_and\_delete\_ip\_address\_space.html
release: zurich
...
4.  Select a record that you want to update from the displayed list of the respective item.
    ...
    1.  Select options \(\[Omitted image "options-icon.png"\] Alt text: more icon\) icon.
    2.  Select **Delete**.
