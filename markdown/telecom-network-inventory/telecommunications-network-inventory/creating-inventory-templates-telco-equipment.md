...
**Note:** To learn more about equipment instantiation, see [Telecommunications design and assign](telecommunications-circuit-design-resource-assignment.md).

When you create an equipment or card template, the associated slots and interface templates are automatically created by using the data from the model relationship. If the model relationships aren’t made, it doesn't create the associated templates. In this case, you must create the templates manually. To learn more about the model relationship, see [Creating inventory template for network asset instantiation](preparing-inv-templates-network-asset-generation.md). For example, when you create a template for an equipment model, the associated templates, such as the Telco equipment holder \(slot\) and interface, are automatically created.
...
After establishing a default template, begin the sequence by creating an inventory template for the equipment model. To learn more, see [Creating an inventory template for the equipment model](creating-an-inventory-template-for-the-equipment-model.md).

1.  [Creating an inventory template for the equipment model](creating-an-inventory-template-for-the-equipment-model.md)  
...
2.  [Creating inventory templates for related interface card models](creating-inventory-templates-for-related-interface-card-models.md)  
...
3.  [Creating inventory templates for related network interface models](creating-inventory-templates-related-network-interface-models.md)  
...
4.  [Adding slots to the equipment inventory template](adding-slot-equipment-model.md)  
...
5.  [Adding a network interface to the equipment template](adding-interface-cards-associated-equipment-model.md)  
...
6.  [Adding interface card templates to the slot templates](adding-interface-card-slots.md)  
...
7.  [Adding subslot templates to the interface card template](adding-subslots-network-interface-template.md)  
...
8.  [Adding a network interface template to an interface card template](adding-interfaces-interface-card-template.md)  
...
9.  [Adding an interface card template to the subslot templates](adding-interface-card-sub-slots.md)  
...
10. [Adding a network interface template to a child or daughter card template](adding-network-interface-template-child-daughter-card.md)  
...
11. [Creating an inventory template for cable models](create-inventory-tenplate-cable-models.md)  
...
12. [Creating an inventory template for a logical composite](creating-inventory-template-logical-composite.md)  
