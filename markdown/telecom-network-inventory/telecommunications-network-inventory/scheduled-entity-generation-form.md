...
Time interval to use for running the scheduled job. To learn more, see [Automatically generate something from a template](https://www.servicenow.com/docs/access?context=t_ScheduleTheGenerationOfAnEntity&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
