...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/telecom-network-inventory/telecommunications-network-inventory/confgure-telecommunications-network-inventory-attributes.html
release: xanadu
...
3.  In the **Value** field, enter the equipment generic classes using a comma as separator.
    ...
    -   App Service \(cmdb\_ci\_service\_auto\)
