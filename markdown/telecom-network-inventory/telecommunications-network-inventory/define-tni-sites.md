...
4.  On the **Details** tab, in the Network Site section, fill in the fields.
    ...
    To learn more about the fields that are unique to the Network Site form, see [Network site form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/tni-network-site-form.md).
