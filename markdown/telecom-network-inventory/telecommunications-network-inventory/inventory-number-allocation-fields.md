...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/inventory-number-allocation-fields.html
release: zurich
...
Telephone number that conforms with the e164 naming convention. For more information, see [E.164 phone number field configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/r_ConfigureE.164PhoneNumberFields.md).
