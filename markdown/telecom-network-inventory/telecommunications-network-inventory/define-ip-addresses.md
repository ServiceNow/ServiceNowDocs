...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/telecom-network-inventory/telecommunications-network-inventory/define-ip-addresses.html
release: yokohama
...
6.  Select **Add Packs** to add packs to this service.
    ...
    To learn more about packs, see [Attribute packs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/telecom-network-inventory/telecommunications-network-inventory/telecommunication-network-inventory-pack.md).
