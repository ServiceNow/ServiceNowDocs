...
-   **[Add or Remove member to Link Aggregation form](../reference/add-remove-member-link-aggregation-form.md)**  
...
-   **[Assign connection element form](../reference/assign-connection-element.md)**  
...
-   **[Attribute form](../reference/attribute-form.md)**  
...
-   **[Capacity Function form](../reference/capacity-function-form.md)**  
The Capacity Function form enables you to describe the details for a capacity function record.
-   **[Card form](../reference/tni-interface-card-form.md)**  
The Card form enables you create, review, and modify the network card details.
-   **[Change request and change task forms](change_request_forms.md)**  
The change request forms enable you to request a change.
-   **[Change request related tabs](../reference/tni-change-request-related-tabs.md)**  
...
-   **[Commonly used network asset instance identification fields](../reference/commonly-used-tni-identification-fields.md)**  
...
-   **[Commonly used network asset instance configuration fields](../reference/commonly-used-tni-configuration-fields.md)**  
...
-   **[Company form](../reference/tni-company-form.md)**  
The Company form enables you to review, create, and modify the company details for a company code.
-   **[Connection Element form](../reference/connection-element-form.md)**  
...
-   **[Create equipment from rack view](../reference/create-equipment-from-rack-view.md)**  
...
-   **[Create Logical Connection form](../reference/create-logical-connection-form.md)**  
...
-   **[Create Physical Connection form](../reference/create-physical-connection-form.md)**  
...
-   **[Data center place types](../reference/place-types-floor-map.md)**  
...
-   **[Default Template forms](../reference/default-template-forms.md)**  
...
-   **[Equipment task attribute form](../reference/equipment-task-attribute-form.md)**  
The equipment task attribute form enables you to describe the details for an equipment record.
-   **[GPON Broadband Form](../reference/gpon-broadband-record-producer-form.md)**  
...
-   **[GPON Broadband Change model forms](../reference/gpon-broadband-change-model-forms.md)**  
...
-   **[Inventory Model forms](../reference/tni-model-forms.md)**  
...
-   **[Inventory models additional tabs](../reference/additional-tabs-of-inventory-models.md)**  
...
-   **[Inventory number allocation fields](../reference/inventory-number-allocation-fields.md)**  
...
-   **[Inventory Numbers form](../reference/inventory-numbers-form.md)**  
...
-   **[Logical connection modification request form](../reference/logical-connection-modification-request-form.md)**  
...
-   **[Managed Network form](../reference/managed_network_form.md)**  
The Managed network form enables you to manage a network in the Telecommunications Network Inventory application.
-   **[Naming convention for associated templates](../reference/name-convention-templates.md)**  
...
-   **[Network inventory change request form](../reference/tni-change-request-field.md)**  
...
-   **[Network inventory facility classes](../reference/network-inventory-facility-classes.md)**  
...
-   **[Physical connection modification request form](../reference/physical-connection-modification-request-form.md)**  
...
-   **[Power circuit form](../reference/power-circuit-form.md)**  
The Power Circuit form enables you to describe the details for an power circuit record.
-   **[Provision LAG form](../reference/provision-lag-form.md)**  
...
-   **[Related tabs in the network inventory forms](../reference/inventory-related-tab.md)**  
...
-   **[Related templates form](../reference/related-templates-form.md)**  
...
-   **[Router, Switch, Firewall, Virtual Machine, Load Balancer, and Server forms](../reference/router-form.md)**  
...
-   **[Task attributes in Add Equipment to Rack or Cabinet form](../reference/task-attributes-add-equipment-rack-cabinet-form.md)**  
...
-   **[Task attributes in Create logical connection form](../reference/task-attributes-create-logical-connection-form.md)**  
...
-   **[Task attributes in Create physical connection form](../reference/task-attributes-create-physical-connection-form.md)**  
...
-   **[Task attributes in Topology form](../reference/task-attributes-topology-form.md)**  
...
-   **[Telco Equipment form](../reference/tni-equipment-form-configuration.md)**  
...
-   **[Telephone number inventory management data model](../reference/data_model_of_telephone_number_inventory_management.md)**  
...
-   **[TNI CI Attributes form](../reference/ci-attribue-form.md)**  
