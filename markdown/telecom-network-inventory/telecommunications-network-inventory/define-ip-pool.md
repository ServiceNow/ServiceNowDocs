...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/telecom-network-inventory/telecommunications-network-inventory/define-ip-pool.html
release: xanadu
...
4.  On the **Details** tab, in the IP address section, fill in the fields.
    ...
    To learn about the other fields, see [Inventory number allocation fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/telecom-network-inventory/telecommunications-network-inventory/inventory-number-allocation-fields.md).
...
8.  Select **Save**.
    ...
    The related tabs appear on the form. To learn more, see [Related tabs in the Network inventory forms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/telecom-network-inventory/telecommunications-network-inventory/inventory-related-tab.md).
...
**Parent Topic:**[Create IP address allocation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/telecom-network-inventory/telecommunications-network-inventory/ip_pool_ip_network_subnet_allocated_ip_address_and_ip_address.md)
