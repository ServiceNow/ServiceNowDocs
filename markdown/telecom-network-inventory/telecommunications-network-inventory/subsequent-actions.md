...
4.  From the rack or cabinet view, perform one of the following actions.
    ...
    |Add packs|Select the more options icon \(![More Options icon.](../image/options-icon.png)\) and then select **Add Packs** to capture the attributes for a configuration item \(CI\) record. To learn more, see [Using an attribute pack for a CI record](../concept/using-pack-table-ci-record.md).|
