...
For example, if you select **Equipment to Slot** in the **Relationship Type** field, you can define the relationship between a specific equipment inventory model and a specific slot inventory model. In this case, you would see that the number of slots in the specified slot model are compatible with the specified equipment model. To learn more, see [Modeling network inventory relationships](../concept/inventory-modeling-process.md).
...
[Modeling network inventory relationships](../concept/inventory-modeling-process.md)
