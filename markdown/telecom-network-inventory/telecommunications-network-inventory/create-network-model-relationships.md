...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/create-network-model-relationships.html
release: zurich
...
4.  Fill in the general information to create a network model relationship.
    ...
    **Note:** To learn more about the fields, see [Network Model Relationship fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/tni-network-model-relationship-form.md).
...
[Modeling network inventory relationships](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-network-inventory/telecommunications-network-inventory/inventory-modeling-process.md)
