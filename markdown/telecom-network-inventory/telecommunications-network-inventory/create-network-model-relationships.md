...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/telecom-network-inventory/telecommunications-network-inventory/create-network-model-relationships.html
release: australia
...
4.  Fill in the general information to create a network model relationship.
    ...
    **Note:** To learn more about the fields, see [Network Model Relationship fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/telecom-network-inventory/telecommunications-network-inventory/tni-network-model-relationship-form.md).
