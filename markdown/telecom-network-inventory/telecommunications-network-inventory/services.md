...
-   Create a network function record. To learn more, see [Define network function details](../task/create_business_applications.md).
-   Create network service instances. To learn more, see [Define network service instance details](../task/create_application_services.md).
...
-   **[Define network service instance details](../task/create_application_services.md)**  
...
-   **[Define network function details](../task/create_business_applications.md)**  
...
-   **[Update or delete service record](update_or_delete_a_service_record.md)**  
