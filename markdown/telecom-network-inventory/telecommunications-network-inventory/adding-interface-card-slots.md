...
Next, add subslots to the network interface template. To learn more, see [Adding subslot templates to the interface card template](adding-subslots-network-interface-template.md).

**Parent Topic:**[Creating inventory template relationship](creating-inventory-templates-telco-equipment.md)

**Previous topic:**[Adding a network interface to the equipment template](adding-interface-cards-associated-equipment-model.md)

**Next topic:**[Adding subslot templates to the interface card template](adding-subslots-network-interface-template.md)
