...
-   Create a pack table with the attributes that you define. To learn more, see [Create an attribute pack table](../task/create-pack-table.md).
...
After you create and configure a pack table, you can use it in a CI record. To learn more, see [Using an attribute pack for a CI record](using-pack-table-ci-record.md).
