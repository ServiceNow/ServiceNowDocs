...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/telecom-network-inventory/telecommunications-network-inventory/add-equipment-rack.html
release: australia
...
9.  On the **Task Attributes** tab, fill in the fields.
    ...
    To learn more, see [Task attributes in Add Equipment to Rack or Cabinet form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/telecom-network-inventory/telecommunications-network-inventory/task-attributes-add-equipment-rack-cabinet-form.md).
