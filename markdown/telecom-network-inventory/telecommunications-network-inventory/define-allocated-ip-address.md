...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/telecom-network-inventory/telecommunications-network-inventory/define-allocated-ip-address.html
release: xanadu
...
To understand how the IP pools, IP subnetworks, and allocated IP addresses are related to each other, see [IP address inventory management data model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/telecom-network-inventory/telecommunications-network-inventory/data_model_of_ip_address_inventory_management.md).
