...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/telecom-network-inventory/telecommunications-network-inventory/viewing-network-inventory-using-cmdb-workspace.html
release: australia
...
However, an Admin can always customize the deletion action. To learn more, see [Customizing deletion action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/telecom-network-inventory/telecommunications-network-inventory/customizing-deletion-action.md).

</td></tr></tbody>
</table>-   **[Customizing deletion action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/telecom-network-inventory/telecommunications-network-inventory/customizing-deletion-action.md)**  
