...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-network-inventory/telecommunications-network-inventory/tni-change-request-related-tabs.html
release: zurich
...
This tab displays the change request details, service design inputs, provisioning parameters, and implementation planning details that are required to design, provision, and track the GPON broadband service through its lifecycle.
