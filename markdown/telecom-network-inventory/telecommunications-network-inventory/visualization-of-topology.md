...
2.  Select the network viewer icon \(![Network Viewer Icon](../image/icon-network-viewer.png)\).

To learn more about how to create and view a topology in the Telecommunications Network Inventory application, see [Using the network topology](using-network-topology.md).
