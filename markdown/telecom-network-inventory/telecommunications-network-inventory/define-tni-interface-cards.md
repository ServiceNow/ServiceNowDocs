...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/telecom-network-inventory/telecommunications-network-inventory/define-tni-interface-cards.html
release: yokohama
...
4.  On the **Details** tab, in the Card section, fill in the general information for the card.
    ...
    [Card form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/telecom-network-inventory/telecommunications-network-inventory/tni-interface-card-form.md) describes fields that are unique to the Card form.
