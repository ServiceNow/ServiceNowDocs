...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/telecom-network-inventory/telecommunications-network-inventory/define-tni-interface-cards.html
release: brazil
...
4.  On the **Details** tab, in the Card section, fill in the general information for the card.
    ...
    [Card form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-network-inventory/telecommunications-network-inventory/tni-interface-card-form.md) describes fields that are unique to the Card form.
