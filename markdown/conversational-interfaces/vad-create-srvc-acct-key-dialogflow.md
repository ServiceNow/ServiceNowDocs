---
title: \(Legacy\) Create a service account and private key in Google Dialogflow ES
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/vad-create-srvc-acct-key-dialogflow.html
release: brazil
topic_type: task
...
# \(Legacy\) Create a service account and private key in Google Dialogflow ES
...
15. Make note of the private key password \(`notasecret`\).
    ...
    You will need this password in a [later step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/vad-configure-dialogflow-security.md).
