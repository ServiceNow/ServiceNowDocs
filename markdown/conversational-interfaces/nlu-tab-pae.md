...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/nlu-tab-pae.html
release: brazil
topic_type: concept
...
See [Activate the NLU Workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/activate-nlu-workbench.md) for information on how to use NLU Workbench to improve NLU predictions.

-   **[\(Legacy\) Modify models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/modify-model-pae.md)**  
