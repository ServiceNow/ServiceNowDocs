---
title: \(Legacy\) Create a new user for an NLU branded bot
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/ci-create-new-branded-bot-nlu.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 1
keywords: [Virtual Agent, branded, bot, avatar, Live Profile, live\_profile]
breadcrumb: [Branding your NLU chat client, General chat settings, Conversational Interfaces Home for NLU, Configure NLU, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Create a new user for an NLU branded bot
...
You can associate the bot profile with a new branding configuration. For details, see [\(Legacy\) Set up your Virtual Agent NLU bot's branding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/ac-configure-chat-branding-nlu.md).
