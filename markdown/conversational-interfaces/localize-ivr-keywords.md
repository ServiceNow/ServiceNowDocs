---
title: \(Legacy\) Customize keywords in Conversational IVR
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/localize-ivr-keywords.html
release: brazil
topic_type: task
...
# \(Legacy\) Customize keywords in Conversational IVR
...
2.  If you want to customize the default keywords, you can edit the **amz\_ivr\_keywords** slot type and give preferred values, and here's how you can do that.
    ...
    2.  On the Slot types page, select **AMZ\_IVR\_KEYWORDS** slot type.
        ...
        **Important:** Ensure that you are editing the values only on the right column. Do not edit the values on the left column as they should not be changed regardless of the language.
        ...
        If you have edited the slot type values on the right column, you must also ensure that you edit their respective bot messages on your instance to reflect these changes. For more information, see [\(Legacy\) Manage bot messages for Conversational IVR](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/edit-va-ivr-messages.md).
