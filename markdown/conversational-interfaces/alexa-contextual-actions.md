---
title: \(Legacy\) Contextual actions for Alexa
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/alexa-contextual-actions.html
release: brazil
topic_type: reference
last_updated: "2026-09-10"
reading_time_minutes: 1
breadcrumb: [Fine-tune settings and topics, Configure Conversational Integration with Alexa, Conversational Integration with Alexa, Integrate VA for NLU with voice channels, Virtual Agent channel integrations, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Contextual actions for Alexa
...
**Parent Topic:**[\(Legacy\) Fine-tune Virtual Agent settings and topics for the best Alexa voice chat experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/va-settings-for-alexa.md)
