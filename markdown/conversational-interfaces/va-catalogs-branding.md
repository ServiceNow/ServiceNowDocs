---
title: \(Legacy\) Set up catalog branding for NLU Virtual Agent
description: Customize the appearance of catalogs in Virtual Agent to match your business' branding.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-catalogs-branding.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 2
keywords: [Virtual, Theme, Builder, Agent, catalogs, branding, web, client]
breadcrumb: [Using catalogs and autopilot, Configure NLU, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Set up catalog branding for NLU Virtual Agent
...
Download Theme Builder from the ServiceNow Store and activate the plugin \(sn\_theme\_builder\). For more information, see [Activate a plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_ActivateAPlugin.md).
