---
title: \(Legacy\) Topic Recommendations settings
description: Use the Topic Recommendations settings page to configure analysis reports based on your ServiceNow data.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/tr-settings-page.html
release: brazil
...
# \(Legacy\) Topic Recommendations settings
...
[Configure analysis reports for Topic Recommendations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/define-tr-settings.md)
