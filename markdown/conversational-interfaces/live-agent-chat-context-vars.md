...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/conversational-interfaces/live-agent-chat-context-vars.html
release: australia
...
Sys\_id of the interaction record associated with the chat session.For more information, see [Virtual Agent interaction records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/va-interactions.md).
...
Name of a post-chat survey that is used to gather feedback from the requester.For information about creating surveys, see [Create chat surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/create-chat-surveys.md).
...
**Parent Topic:**[Configure context variables for storing chat-related information](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/ac-configure-context-variables.md)
