...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/manage-llm-va.html
release: yokohama
...
Date and time the virtual agent was most recently updated.
    ...
    Follow the screens to create a new virtual agent. For more information, see [Configuring assistants overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/now-assist-in-virtual-agent/configure-now-assist-va.md).
