---
title: \(Legacy\) Integrating Virtual Agent with IBM Watson Assistant for Assistant V2 API
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/configure-watson-assistant-topicV2.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 6
keywords: [IBM Watson Assistant, Virtual Agent, API]
breadcrumb: [Integrating IBM Watson Assistant conversations, Integrate VA for NLU with messaging apps, Virtual Agent channel integrations, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Integrating Virtual Agent with IBM Watson Assistant for Assistant V2 API
...
5.  In Virtual Agent Designer, publish the IBM Watson Assistant V2 topic:
    ...
    4.  In the Virtual Agent Designer home page, select the IBM Watson Assistant V2 topic to open the Topic Properties page.
...
**Parent Topic:**[\(Legacy\) Integrating IBM Watson Assistant conversations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/va-ibm-watson-assistant-config.md)
