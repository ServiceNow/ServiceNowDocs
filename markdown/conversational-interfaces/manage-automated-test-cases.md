---
title: \(Legacy\) Manage and run automated test cases in Virtual Agent Designer
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/manage-automated-test-cases.html
release: brazil
topic_type: task
...
# \(Legacy\) Manage and run automated test cases in Virtual Agent Designer
