...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/agent-chat/agent-init-messg-validate-recipient.html
release: yokohama
product: Agent Chat
