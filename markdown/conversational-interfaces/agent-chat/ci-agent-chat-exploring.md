...
|Read a summarization of the chat \(this is available only if you have Now Assist installed\).|[Chat summarization](https://www.servicenow.com/docs/access?context=now-assist-chat-summary&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US)|Agent|
