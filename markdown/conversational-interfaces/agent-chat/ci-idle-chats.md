...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/conversational-interfaces/agent-chat/ci-idle-chats.html
release: australia
product: Agent Chat
