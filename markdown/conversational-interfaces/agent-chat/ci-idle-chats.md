...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/agent-chat/ci-idle-chats.html
release: yokohama
product: Agent Chat
