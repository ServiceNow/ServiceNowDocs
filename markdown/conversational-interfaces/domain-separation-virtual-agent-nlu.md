---
title: \(Legacy\) Domain separation and Virtual Agent for NLU
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/domain-separation-virtual-agent-nlu.html
release: brazil
topic_type: concept
...
# \(Legacy\) Domain separation and Virtual Agent for NLU
...
When domain separation is used, guest users are restricted to the domain used in the session. For custom chat channels, the domain of the [provider application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/create-channel-id-va-cccif.md) is used. For the chat widget, you can associate a domain ID with the chat portal. For details, see [Associate a domain ID with a chat portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/associate-domain-id-chat-portal.md).

For more information, see [Domain scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/c_DomainScope.md).
...
-   **Branding**
    ...
    Service providers can create a [chat branding configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/ac-configure-chat-branding.md) per domain.

-   **[Chat experiences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/va-conversation-settings.md)**
...
-   **NLU settings**
    ...
    Only one NLU service provider can be set per domain-separated instance for all Virtual Agent clients. The managed service provider \(MSP\) logs in as a global user for the domain to configure NLU. For details, see [\(Legacy\) Configure Natural Language Understanding in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/configure-nlu-settings.md).
...
To configure the portal, see [Associate a domain ID with a chat portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/associate-domain-id-chat-portal.md).

For information about URL parameters, see [Virtual Agent URL parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/va-sysparm.md).
