...
You define, configure, and publish conversational questionnaires \(surveys\) using [Survey Designer](https://www.servicenow.com/docs/access?context=c_SurveyDesigner&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US). You can use various survey controls to define the content of your questionnaires. For details on the survey controls available, see [Survey designer elements](https://www.servicenow.com/docs/access?context=c_SurveyDesignerElements&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US) to see how the controls are rendered in the survey. For example, the Choice control provides a multiple choice selection to your users.
...
2.  Select the **Configuration** tab and configure the survey.
    ...
    -   Select **Save**.
    For details, see [Configure a survey in the survey designer](https://www.servicenow.com/docs/access?context=t_ConfigSurveyInSurveyDesgnr&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
...
3.  Select the **Design** tab and give your survey a **Name**.
    ...
    -   Select **Save**.
    For details, see [Create a question in the survey](https://www.servicenow.com/docs/access?context=t_CreateQuestSurveyDesigr&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
