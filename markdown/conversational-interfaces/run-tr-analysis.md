---
title: \(Legacy\) Run a Topic Recommendation analysis
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/run-tr-analysis.html
release: brazil
topic_type: task
...
# \(Legacy\) Run a Topic Recommendation analysis
...
Make sure you [configure analysis reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/define-tr-settings.md) first.

Role required: virtual\_agent\_admin or admin

## About this task

The analysis process takes about 15 minutes or less to return recommendation results. In the Brazil release, Topic Recommendations requires a minimum of 10,000 records in the data source and will only process a maximum of 300,000 records. Use filters in the settings page to reduce the number of records in the data source, if needed.
...
2.  In the Topic Recommendations page, go to the data source to be analyzed and trigger the analysis.
    ...
    **Note:** Changing the settings here affects only this analysis. The default settings for the recommendation are preserved. To change the default settings, see [\(Legacy\) Configure analysis reports for Topic Recommendations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/define-tr-settings.md).
...
3.  When the report completes, review the analysis results for the data set.
    ...
    **Tip:** To view details about a pre-built topic or user intent, select the card, and then select the Info icon \[Omitted image "icon-info-blue.png"\] Alt text: Info icon. to open an overlay card. For more information, see [\(Legacy\) Topic Recommendations cards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/topic-recommendations-cards.md).


## What to do next

You can [add a Topic Recommendation as a new topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/add-tr-results-va.md) or [link it to an existing topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/link-tr-existing-va-topic.md). You can also [hide a recommendation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/hide-tr-recommendation.md) from the list in aggregate view.
