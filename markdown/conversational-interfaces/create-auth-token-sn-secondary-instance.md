...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/create-auth-token-sn-secondary-instance.html
release: brazil
topic_type: task
...
[Create a connection and credential in Virtual Agent Bot Interconnect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/create-connection-credential-two-sn-instances.md).
