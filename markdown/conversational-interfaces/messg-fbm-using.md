...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/messg-fbm-using.html
release: brazil
topic_type: concept
last_updated: "2026-09-10"
reading_time_minutes: 1
breadcrumb: [Facebook Messenger, Integrate VA with messaging apps, Conversational Integration apps for Virtual Agent, Conversational Interfaces]
---
...
An administrator can configure the Conversational Integration with Facebook Messenger application for integrating the Facebook Messenger app with a ServiceNow application. For more information, see [Integrating the LINE messaging app with other applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/messg-line-integrating-apps.md).

A requester can initiate Facebook Messenger chat conversations with a virtual agent or live agent.

A live agent can accept Facebook Messenger chat conversations as work items from their Agent Workspace Inbox to converse with a requester.

## Accepting Facebook Messenger chat conversations

As a live agent interacting with a requester over the Facebook Messenger service channel, you can:
...
-   **[Capturing information from a user in a Facebook Messenger chat conversation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/messg-fbm-capture-info.md)**  
Use the collection of input controls provided by Assistant Designer to prompt and capture information from the user in a Facebook Messenger chat conversation.

**Parent Topic:**[Conversational Integration with Facebook Messenger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/messg-fbm.md)
