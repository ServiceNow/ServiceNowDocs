---
title: \(Legacy\) Create a provider channel identity record for Alexa
description: Create a provider channel identity record to connect to your Alexa account.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/create-provider-channel-id-record-alexa.html
release: brazil
topic_type: task
...
# \(Legacy\) Create a provider channel identity record for Alexa
