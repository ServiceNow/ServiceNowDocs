---
title: \(Legacy\) Dialog Acts for Virtual Agent
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/c\_dialog-acts.html
release: brazil
topic_type: concept
...
# \(Legacy\) Dialog Acts for Virtual Agent
