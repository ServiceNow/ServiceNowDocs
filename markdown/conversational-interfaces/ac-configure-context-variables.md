...
For details about using context variables in topic scripts, see [Virtual Agent scripts](../../virtual-agent/concept/virtual-agent-scripts.md). For information about learning to use context variables, see [Tutorial: Route interactions by context](https://www.servicenow.com/docs/access?context=context-routing-tutorial&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US). For descriptions of Live Agent context variables, see [Live agent chat context variables](../../virtual-agent/reference/live-agent-chat-context-vars.md).
