---
title: \(Legacy\) Configure enhanced natural language user input handling
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/set-up-natural-lang-handling-other-nlu.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 1
breadcrumb: [Enhanced handling of user inputs, Configure NLU in Virtual Agent, Configure NLU, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Configure enhanced natural language user input handling
