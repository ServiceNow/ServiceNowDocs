---
title: \(Legacy\) Train and test your NLU model in Virtual Agent Designer
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/train-test-publish-nlu-model-vad.html
release: brazil
topic_type: task
...
# \(Legacy\) Train and test your NLU model in Virtual Agent Designer
...
For more information on providing feedback using thumbs icons in the results, see [\(Legacy\) Test panel feedback](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/test-model-panel-feedback.md).
