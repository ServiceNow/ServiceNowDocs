...
Base number for the table. For more information, see [Record numbering](https://www.servicenow.com/docs/access?context=c_ManagingRecordNumbering&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
