---
title: \(Legacy\) Create an Alexa skill
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/create-alexa-skill.html
release: brazil
topic_type: task
