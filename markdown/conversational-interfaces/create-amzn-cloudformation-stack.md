---
title: \(Legacy\) Create an Amazon CloudFormation stack
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/create-amzn-cloudformation-stack.html
release: brazil
topic_type: task
...
# \(Legacy\) Create an Amazon CloudFormation stack
...
Provide the name of the Prompt file that you have uploaded in [\(Legacy\) Create an Amazon S3 bucket](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/create-amazon-s3-bucket.md).The Prompt file is an audio file containing the ringtone when customer connects to an agent.
