...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/set-up-custom-definitions-pae.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 4
breadcrumb: [Setup, Conversational Analytics dashboard, Analyze Virtual Agent performance, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---
...
-   End state—Defined by default in 12 ways. For more information, see [Formula override examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/formula-override-examples-pae.md).
