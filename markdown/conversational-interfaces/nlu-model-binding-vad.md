---
title: \(Legacy\) NLU model mapping in Virtual Agent Designer
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/nlu-model-binding-vad.html
release: brazil
topic_type: concept
...
# \(Legacy\) NLU model mapping in Virtual Agent Designer
...
-   Map the topic to an existing model and create an intent.
    ...
    Mappings are created for all languages that have been activated in NLU Settings as well. For more information, see [\(Legacy\) Configure Natural Language Understanding in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/configure-nlu-settings.md).

-   Create and map the topic to a new model and intent.

    If more than one language has been activated in NLU Settings, mappings are automatically created for secondary languages in the new model group. For more information, see [\(Legacy\) Topic mapping to a multilingual NLU model group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/multilingual-nlu-model-group-topic-mapping.md).
