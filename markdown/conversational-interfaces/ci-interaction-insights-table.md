...
Both synchronous and asynchronous channels support sentiment analysis. Use [Task Intelligence](https://www.servicenow.com/docs/access?context=task-intelligence&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US) to set up sentiment analysis.
