---
title: \(Legacy\) Testing NLU/Keyword topics
description: Use the chat test window to preview, test, and debug Natural Language Understanding \(NLU\)/keyword topics.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-designer-testing.html
release: brazil
...
# \(Legacy\) Testing NLU/Keyword topics
...
If an utterance doesn't match a current intent, you can add or change utterances in Virtual Agent Designer. For more information, see [\(Legacy\) Modify NLU utterances and entities for a Virtual Agent topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/modify-nlu-utterances-va-topic.md).
...
For more information about defining context variables, see [Configure context variables for storing chat-related information](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/ac-configure-context-variables.md). For more information about live agent variables that are included with Virtual Agent, see [Live agent chat context variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/live-agent-chat-context-vars.md).
...
-   **[\(Legacy\) Train and test your NLU model in Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/train-test-publish-nlu-model-vad.md)**  
...
-   **[\(Legacy\) Automated testing for Virtual Agent topics that use NLU topic discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/automated-testing-va-topics.md)**  
...
-   **[\(Legacy\) Debug a Virtual Agent NLU topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent-troubleshooting-guide-nlu.md)**  
