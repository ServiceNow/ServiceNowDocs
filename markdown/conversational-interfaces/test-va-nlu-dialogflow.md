---
title: \(Legacy\) Test Virtual Agent with Google Dialogflow ES NLU in Virtual Agent Designer
description: Test topic discovery with Google Dialogflow and Virtual Agent in the Virtual Agent Designer interface.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/test-va-nlu-dialogflow.html
release: brazil
topic_type: task
...
# \(Legacy\) Test Virtual Agent with Google Dialogflow ES NLU in Virtual Agent Designer
