...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-api-test.html
release: brazil
topic_type: task
...
3.  Click **Send**.
    ...
    -   If your instance is on asynchronous mode, you have to check enabling Virtual Agent API logging. See [Common errors in Virtual Agent API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent-common-errors.md) for more information.
