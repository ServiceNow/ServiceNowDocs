---
title: \(Legacy\) Generate a Java Keystore \(JKS\) file and configure security on your ServiceNow instance
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/vad-configure-dialogflow-security.html
release: brazil
topic_type: task
...
# \(Legacy\) Generate a Java Keystore \(JKS\) file and configure security on your ServiceNow instance
...
5.  In your ServiceNow instance, update the Google Dialogflow JWT provider record.
    ...
    4.  In the Standard Claims related list, enter the email address for your Google Dialogflow agent service account as the **Claim Value** for the **iss** entry.
        ...
        For more information, refer to [\(Legacy\) Create a service account and private key in Google Dialogflow ES](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/vad-create-srvc-acct-key-dialogflow.md).
...
8.  Specify Google Dialogflow ES as your NLU provider in Virtual Agent.
    ...
    For more information, see [\(Legacy\) Configure Natural Language Understanding in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/configure-nlu-settings.md).
