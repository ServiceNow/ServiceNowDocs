...
-   **Here's what you can do next**
    ...
    ![The Here's what you can do next section of the page contains cards that you can select to customize or install additional features.](../image/ci-home-whats-next.png)
...
-   **Install Sidebar**
    ...
    ![Select the Boost agent productivity tile to install Sidebar and help agents resolve user issues more quickly.](../image/ci-home-sidebar.png)
...
-   **Bot Accelerator progress panel**
    ...
    ![Expand the Bot Accelerator progress panel to review settings that have not been configured.](../image/ci-home-bot-accelerator.png)
