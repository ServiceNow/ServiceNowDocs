---
title: \(Legacy\) Unlink a topic recommendation from a Virtual Agent topic
description: You can unlink a topic recommendation from a topic. This lets you link it to a new or alternate topic.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/unlink-tr-va-topic.html
release: brazil
topic_type: task
...
# \(Legacy\) Unlink a topic recommendation from a Virtual Agent topic
