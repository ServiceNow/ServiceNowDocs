---
title: \(Legacy\) Quick start for Topic Recommendations
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/getting-started-topic-recommendations.html
release: brazil
topic_type: concept
...
# \(Legacy\) Quick start for Topic Recommendations
...
Configure analysis reports for Topic Recommendations in Virtual Agent settings. For details, see [\(Legacy\) Configure analysis reports for Topic Recommendations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/define-tr-settings.md).
...
For more information, see [\(Legacy\) Run a Topic Recommendation analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/run-tr-analysis.md).
...
For more information about adding a recommendation to Virtual Agent, see [\(Legacy\) Add recommended topics and intents to Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/add-tr-results-va.md). You can also [link a recommendation to an existing topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/link-tr-existing-va-topic.md).
