...
Enables features for conversational messaging, such as messaging actions in Workspace.
 ...
 For details, see [Activate Conversational Messaging](https://www.servicenow.com/docs/access?context=activate-messaging-actions&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
