---
title: \(Legacy\) Plugins installed with Virtual Agent for NLU
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/installed-wth-virtual-agent.html
release: brazil
topic_type: reference
last_updated: "2026-09-10"
reading_time_minutes: 8
breadcrumb: [Installing NLU components, Configure NLU, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Plugins installed with Virtual Agent for NLU
...
-   For more information on the roles contained in virtual\_agent\_admin, see [Components installed with Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/va-components.md).
