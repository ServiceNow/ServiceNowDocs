...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/using-sms-integ-twilio.html
release: brazil
topic_type: concept
...
A live agent can do the following:
...
As a live agent interacting with a requester over the SMS service channel, you can do the following:
