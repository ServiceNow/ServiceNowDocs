---
title: \(Legacy\) Map a topic to a secondary NLU model
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/map-nlu-language-model.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 3
breadcrumb: [Localize NLU topics, Localizing NLU conversations, Localization options for NLU conversations, Build and deploy NLU conversations, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Map a topic to a secondary NLU model
...
If you're using ServiceNow NLU, review [\(Legacy\) NLU model mapping in Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/nlu-model-binding-vad.md) for an understanding of NLU model groups.
...
**Parent Topic:**[\(Legacy\) Localize Virtual Agent topics that use NLU topic discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/use-lf-translate-va-nlu.md)
