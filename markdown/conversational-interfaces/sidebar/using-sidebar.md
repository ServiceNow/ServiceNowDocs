...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/sidebar/using-sidebar.html
release: xanadu
product: Sidebar
...
2.  Select the list icon \[Omitted image "sidebar-list-icon.png"\] Alt text: List icon.
...
4.  On the Details screen, select **Discuss**.
    ...
    -   If a Sidebar discussion doesn't exist, the Start a Sidebar discussion dialog appears. Fill out the fields and then select **Start discussion**:
        ...
        \[Omitted image "start-sidebar-discussion.png"\] Alt text: Start a Sidebar discussion dialog window.
...
For more information, see [Configuring Sidebar member query](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/sidebar/configure-sidebar-member-query.md).
...
</table>5.  To return to a previous Sidebar discussion, you can select the Discussion icon \[Omitted image "sidebar-chat-icon.png"\] Alt text: Discussion icon or select one of the tabs in the overflow menu.
...
Select the More options icon \[Omitted image "ci\_more\_options\_icon.png"\] Alt text: Discussion icon next to the message and **Edit message**. The message appears in an Editing window where you can change the text.-   You can only edit messages that you sent.
...
Select the More options icon \[Omitted image "ci\_more\_options\_icon.png"\] Alt text: Discussion icon next to the message and **Delete Message**. A dialog displays asking if you’re sure you want to delete your message. Select **Delete** to delete the message or select **Cancel** to leave the message.-   You can only delete messages that you sent.
...
8.  When you’re finished, close or exit the discussion.
    ...
    -   To close the discussion dialog \(but not exit the discussion\), select \[Omitted image "sidebar-x-icon.png"\] Alt text: Close icon..
