...
4.  [Configure the Sidebar member query](../task/configure-sidebar-member-query.md).
...
5.  Enable Sidebar and Microsoft Teams users to communicate with each other by integrating the applications:
    1.  [Sidebar and Teams integration overview](sidebar-teams-overview.md).
    2.  [Integrate Sidebar and Microsoft Teams](integrating-sidebar-teams.md).
    3.  [Enable or configure the Microsoft Teams integration](../task/enable-teams-integration.md).
