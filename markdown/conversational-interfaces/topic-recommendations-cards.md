---
title: \(Legacy\) Topic Recommendations cards
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/topic-recommendations-cards.html
release: brazil
topic_type: reference
last_updated: "2026-09-10"
reading_time_minutes: 2
keywords: [Virtual Agent, Topic Recommendations, cards, intent, status, track]
breadcrumb: [Interface reference, Using Virtual Agent Topic Recommendations, Build and deploy NLU conversations, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Topic Recommendations cards
...
Topic or intent was added to Virtual Agent or [linked to an existing topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/link-tr-existing-va-topic.md) and published.Cards with **Active** status have a green border.
...
-   [Link the recommendation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/link-tr-existing-va-topic.md) to an existing topic.
