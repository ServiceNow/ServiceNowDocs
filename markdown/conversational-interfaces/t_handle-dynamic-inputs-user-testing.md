---
title: \(Legacy\) Handle failures caused by dynamic inputs in user testing of Virtual Agent topics
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/t\_handle-dynamic-inputs-user-testing.html
release: brazil
topic_type: task
...
# \(Legacy\) Handle failures caused by dynamic inputs in user testing of Virtual Agent topics
...
Set up a test case for a topic that includes dynamic inputs. See [\(Legacy\) Create an automated test in Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/create-automated-test-vad.md) for more information.
