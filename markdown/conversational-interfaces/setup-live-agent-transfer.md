---
title: \(Legacy\) Sync agents to set up live agent transfer
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/setup-live-agent-transfer.html
release: brazil
topic_type: task
...
# \(Legacy\) Sync agents to set up live agent transfer
