...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/user-search-metrics-tab-pae.html
release: brazil
topic_type: concept
