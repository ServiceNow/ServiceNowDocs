---
title: \(Legacy\) Boolean user input control
description: Use the Boolean user input control in a Virtual Agent topic to present a Yes/No prompt to the user.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-boolean-user-input-nlu.html
release: brazil
...
# \(Legacy\) Boolean user input control
