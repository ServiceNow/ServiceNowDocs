...
|Rule doesn't run for some end users, and the **action** type selected is **virtual agent topic**.|End users may not have access to the Virtual Agent topic defined on the action. Check the access to the topic in Assistant Designer.|
