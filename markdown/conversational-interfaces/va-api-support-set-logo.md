...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-api-support-set-logo.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 1
breadcrumb: [Configure to support chat history, Use, Virtual Agent API, Conversational Interfaces]
---
