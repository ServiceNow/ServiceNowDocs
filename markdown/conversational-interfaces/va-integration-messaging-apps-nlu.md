---
title: \(Legacy\) Integrating Virtual Agent for NLU with messaging apps
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-integration-messaging-apps-nlu.html
release: brazil
topic_type: concept
last_updated: "2026-09-10"
reading_time_minutes: 4
breadcrumb: [Virtual Agent channel integrations, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Integrating Virtual Agent for NLU with messaging apps
...
-   **[\(Legacy\) Integrating IBM Watson Assistant conversations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/va-ibm-watson-assistant-config.md)**  
...
**Parent Topic:**[\(Legacy\) Integrating Virtual Agent with other channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/integrate-virtual-agent-nlu.md)
