---
title: \(Legacy\) Implementing AI Search in NLU
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-ai-search.html
release: brazil
topic_type: concept
last_updated: "2026-09-10"
reading_time_minutes: 8
keywords: [AI Search, Virtual Agent, ServiceNow AI Platform, User experience]
breadcrumb: [Exploring other Virtual Agent NLU features, Build and deploy NLU conversations, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Implementing AI Search in NLU
...
In order to use AI Search in Virtual Agent, you must request it for your instance. For more information, see [\(Legacy\) Activate AI Search for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/activate-ai-search-va.md).
...
-   **Genius Result cards**
    ...
    \[Omitted image "genius-card-examples2.png"\] Alt text: Question and Answer genius card, Catalog item genius card, and People genius card
...
-   **List output**
    ...
    Admins can edit the prefix of these search result titles by navigating to EVAM and searching for Virtual Agent templates. Select the template for the applicable search result type and update the value for the **key** attribute. \[Omitted image "ai-search-prefix.png"\] Alt text: Virtual Agent Catalog Search Template view, with prefix codeblock highlighted.
...
-   **[\(Legacy\) Create a custom AI Search experience for Virtual Agent conversations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/create-va-aisearch-application.md)**  
...
**Parent Topic:**[\(Legacy\) Exploring other Virtual Agent for NLU features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/exploring-other-vad-features-nlu.md)
