...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/installing-ci-google-chat.html
release: brazil
topic_type: task
...
23. On the Create service account form, fill in the fields.
...
26. On the Service Accounts page, navigate to the Manage Keys page and select your new outbound service account.
...
[Integrating Virtual Agent with Google Chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/integrating-va-google-chat.md)
