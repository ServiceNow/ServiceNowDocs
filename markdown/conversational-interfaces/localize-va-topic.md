---
title: \(Legacy\) Localizing Virtual Agent NLU conversations
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/localize-va-topic.html
release: brazil
topic_type: concept
...
# \(Legacy\) Localizing Virtual Agent NLU conversations
...
To learn more, see [Localization Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/localization-framework-landing.md). To learn more about localization roles, see [\(Legacy\) Localization roles for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/localization-roles-va.md).
...
-   Activate the ServiceNow plugin for each language you want to support.
    ...
    The Localization Framework is also installed by default. For more information, see [Activate a language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_ActivateALanguage.md).

-   Configure the translation mode that you want to use in the Localization Framework.

    You can configure machine translation, a translation management system \(TMS\), or send via email. For more information, see [Translation modes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/translation-modes.md).

-   If you are using Natural Language Understanding \(NLU\), enable languages in Virtual Agent settings.

    For more information, see [\(Legacy\) Enable NLU languages in Virtual Agent settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/enable-langs-va-gen-settings.md).

-   If necessary, add secondary languages to your NLU model group. For more information, see [Multilingual model management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/multilingual-model-managent.md).
-   Assign localization roles to team member groups.

    Users are assigned different roles based on their responsibilities for the translation process. For more information, see [\(Legacy\) Localization roles for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/localization-roles-va.md).
...
For more information, see [\(Legacy\) Localize Virtual Agent topics that use NLU topic discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/use-lf-translate-va-nlu.md).

-   **[\(Legacy\) Enable NLU languages in Virtual Agent settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/enable-langs-va-gen-settings.md)**  
...
-   **[\(Legacy\) Localize Virtual Agent topics that use keyword topic discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/use-lf-translate-va.md)**  
Use the ServiceNow Localization Framework to manage the process of localizing Virtual Agent conversations and keywords.
-   **[\(Legacy\) Localize Virtual Agent topics that use NLU topic discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/use-lf-translate-va-nlu.md)**  
...
-   **[\(Legacy\) Edit translations for Virtual Agent topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/edit-translations-va-topics.md)**  
A Virtual Agent admin user can edit and publish translations directly in Virtual Agent Designer.
-   **[\(Legacy\) Request bulk translations for multiple topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/request-bulk-translations-va.md)**  
...
-   **[\(Legacy\) Authoring Virtual Agent conversations for localization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/authoring-va-l18n.md)**  
...
-   **[\(Legacy\) Language support for NLU services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/language-support-nlu-services.md)**  
...
-   **[\(Legacy\) Localization roles for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/localization-roles-va.md)**  
...
-   **[\(Legacy\) Virtual Agent translation tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/va-translation-tables.md)**  
