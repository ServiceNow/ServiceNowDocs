---
title: \(Legacy\) Test topic and NLU model translations
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/test-nlu-language-model.html
release: brazil
topic_type: task
...
# \(Legacy\) Test topic and NLU model translations
...
8.  On the test window, run the conversation and review the results in the test tabs.
    ...
    For more information about using the chat test window, see [\(Legacy\) Testing NLU/Keyword topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/va-designer-testing.md).
