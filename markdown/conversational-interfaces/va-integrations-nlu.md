---
title: \(Legacy\) Deploying Virtual Agent NLU topics in other channels
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-integrations-nlu.html
release: brazil
topic_type: concept
...
# \(Legacy\) Deploying Virtual Agent NLU topics in other channels
...
\[Omitted image "va-prop-channelsup.png"\] Alt text: The Topic Properties page displaying the Channels support field under Advanced properties, along with the Channels pop-up.
...
-   **Flow** tab \(Virtual Agent Designer canvas\)
    ...
    \[Omitted image "channel-support-canvas-example2.png"\] Alt text: conversation builder interface, with unsupported controls for messaging channels flagged on the flow tab and detailed in a pop-up message.


## Finding the channels available in your instance

To see a list of the available channels in your instance, use the filter icon \(\[Omitted image "filter-icon.png"\] Alt text:\) in Virtual Agent Designer \(**Conversational Interfaces** &gt; **Virtual Agent** &gt; **Designer**\). The Messaging Channels \[sys\_cs\_channel\] table also shows the available channels.

\[Omitted image "va-custom-channels.png"\] Alt text: Use the filter icon to find topics based on channel support on the Virtual Agent Designer topics home page.
