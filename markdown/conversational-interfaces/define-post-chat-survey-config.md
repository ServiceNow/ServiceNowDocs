...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/define-post-chat-survey-config.html
release: xanadu
...
-   Determine the post-chat survey to be displayed to your requesters.
    ...
    -   If you need different post-chat surveys, create them using Survey Designer. For details, see [Create chat surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/create-chat-surveys.md).
