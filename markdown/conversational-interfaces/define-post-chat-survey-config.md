...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/conversational-interfaces/define-post-chat-survey-config.html
release: australia
...
-   Determine the post-chat survey to be displayed to your requesters.
    ...
    -   If you need different post-chat surveys, create them using Survey Designer. For details, see [Create chat surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/create-chat-surveys.md).
