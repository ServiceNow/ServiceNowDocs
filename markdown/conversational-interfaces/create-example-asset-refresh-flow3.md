...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/create-example-asset-refresh-flow3.html
release: brazil
topic_type: task
...
-   [Create the Asset Refresh topic in Assistant Designer Asset library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/create-example-conv-asset-refresh.md)
...
For more information about testing topics, see [\(Legacy\) Testing NLU/Keyword topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/va-designer-testing.md). If you're using NLU discovery, [add utterances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/modify-nlu-utterances-va-topic.md) to the intent and [train and test your NLU model.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/train-test-publish-nlu-model-vad.md)

When you're finished, [publish the topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/publish-virtual-agent-topic.md).

## What to do next

[Create the notification for the Asset Refresh topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/create-example-asset-refresh-notification.md)
