...
description: Use the collection of input controls provided by the Assistant Designer to prompt and capture information from a requester in a WhatsApp chat conversation.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/messg-whatsapp-capture-info.html
release: brazil
topic_type: concept
...
Use the collection of input controls provided by the Assistant Designer to prompt and capture information from a requester in a WhatsApp chat conversation.

The Assistant Designer Asset library contains a diagram tool for creating and managing topics, which are blueprints for conversations between a virtual agent and user. For more information, see [Build conversations in the Asset library in Assistant Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/conversation-designer-virtual-agent.md).
...
The Conversational Integration with WhatsApp \(powered by Twilio\) application supports the following user input controls in Assistant Designer.
...
The Conversational Integration with WhatsApp \(powered by Twilio\) application supports the following bot responses in Assistant Designer.
...
For more information about configuring bot responses, see [Assistant Designer bot responses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/va-bot-responses.md).

**Parent Topic:**[Using Conversational Integration with WhatsApp \(powered by Twilio\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/messg-whatsapp-using.md)
