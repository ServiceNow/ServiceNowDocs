---
title: \(Legacy\) Configure Conversational IVR with Amazon Connect
description: Configure Amazon Connect service provider to integrate with Virtual Agent and use interactive voice response.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/configure-va-ivr.html
release: brazil
topic_type: task
...
# \(Legacy\) Configure Conversational IVR with Amazon Connect
...
-   [\(Legacy\) Sync agents to set up live agent transfer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/setup-live-agent-transfer.md)
-   [\(Legacy\) Configure user authentication for Conversational IVR](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/setup-user-authentication-ivr.md)
-   [\(Legacy\) Manage bot messages for Conversational IVR](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/edit-va-ivr-messages.md)

-   **[\(Legacy\) Enroll user Soft PIN and Device in ServiceNow instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/enrol-user-softpin-device.md)**  
Enroll the user Soft PIN and Device in your ServiceNow instance to setup callback authentication.
-   **[\(Legacy\) Set up the Amazon Connect spoke for Conversational IVR](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/setup-amzn-connect-spoke.md)**  
...
-   **[\(Legacy\) Provider properties for Amazon Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/provider-properties-ivr.md)**  
