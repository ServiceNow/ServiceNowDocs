---
title: \(Legacy\) Duplicate and publish Virtual Agent Lite topics
description: Copy and publish a pre-built ITSM Virtual Agent Lite topic to deploy it to your users.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/duplicate-publish-valite-topic.html
release: brazil
topic_type: task
...
# \(Legacy\) Duplicate and publish Virtual Agent Lite topics

Copy and publish a pre-built ITSM Virtual Agent Lite topic to deploy it to your users.

## Before you begin

[Preview \(test\) the pre-built ITSM Virtual Agent Lite topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/test-valite-topic.md).
