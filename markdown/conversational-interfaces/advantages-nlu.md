---
title: \(Legacy\) Advantages of natural language models over keywords
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/advantages-nlu.html
release: brazil
topic_type: concept
last_updated: "2026-09-10"
reading_time_minutes: 1
breadcrumb: [NLU topic discovery, Explore NLU, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Advantages of natural language models over keywords
...
-   **[LLM topic discovery in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/va-llm.md)**

    Use LLMs to discover topics and access generative AI capabilities without building complex models, intents, or entities.

-   **[\(Legacy\) Natural Language Understanding \(NLU\) topic discovery in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/va-NLU.md)**
