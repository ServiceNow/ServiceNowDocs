---
title: \(Legacy\) Natural Language Understanding topic discovery logic in Virtual Agent
description: Understand how Virtual Agent returns intents and how it selects which intents to show to the user.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/how-topic-discovery-works.html
release: brazil
topic_type: concept
...
# \(Legacy\) Natural Language Understanding topic discovery logic in Virtual Agent
