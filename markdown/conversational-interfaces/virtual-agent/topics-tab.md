...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/topics-tab.html
release: xanadu
...
For more information about the spokes used, see [Legacy - Spokes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/topic-spokes-subtab.md).
...
-   **[Legacy - Topic categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/category-page.md)**  
...
-   **[Legacy - Topics details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/topic-details-subtab.md)**  
Use the Topic Details page in the Conversational Analytics dashboard to see the details of the Virtual Agent \(VA\) topics.
-   **[Legacy - Spokes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/topic-spokes-subtab.md)**  
