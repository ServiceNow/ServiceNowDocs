...
breadcrumb: [Setup Transcript for Amazon Connect, Conversational Integration with Microsoft Teams, Integrating Virtual Agent with enterprise messaging apps, Virtual Agent integration with messaging apps, Integrating Virtual Agent with other channels, Virtual Agent, Conversational Interfaces]
---
...
3.  In the Configure pre-built adapter section, select **Configure IVR**.
