...
The Conversational Integration with WhatsApp \(powered by Twilio\) application supports the following user input controls in Assistant Designer Asset library.
...
The Conversational Integration with WhatsApp \(powered by Twilio\) application supports the following bot responses in Assistant Designer Asset library.
