...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/va-video-bot-response.html
release: xanadu
...
**Note:** Topic authors can also use the [Card bot response control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/va-card-output.md) to include a video in conversations. However, the Card bot response control doesn't include the navigation button, which gives users time to watch the video.
...
Type of card. Select **YouTube Video Card**.**Note:** In the Xanadu release, only YouTube video cards are supported.
...
\[Omitted image "va-video-with-nav-button.png"\] Alt text: Video card with the header, "Returning to work using Safe Workplace Suite" link, description, and a "Continue" navigation button.
...
</table>**Parent Topic:**[Virtual Agent Designer bot responses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/va-bot-responses.md)
