...
![Video card with the header, "Returning to work using Safe Workplace Suite" link, description, and a "Continue" navigation button.](../images/va-video-with-nav-button.png "Video bot response output on the chat widget with the navigation button")
