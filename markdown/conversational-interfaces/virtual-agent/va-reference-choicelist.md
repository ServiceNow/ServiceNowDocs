...
For more information about the preceding scripting details, review information about [GlideRecords](https://www.servicenow.com/docs/access?context=c_GlideRecordAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US) and the additional information:
...
![A Dynamic Choice list returns a list of incidents created by the user and two options are selected.](../../now-assist-in-va/image/nass-dynamic-choice-user-prompt.png "Dynamic Choice list prompt example")
...
![Basic properties include the node name, prompt, NLU entity, and Populate choices by list.](../images/va-refchoice-properties.png "Dynamic Choice user input control basic properties")

</td><td>

![A Dynamic Choice list returns a list of incidents created by the user.](../images/va-ref-choicelist-web-search.png "Web UI Dynamic Choice list prompt")
...
![The prompt asks, "What would you like to check?" followed by a photo and heading of a hotel. Choices include, Dining, Suites, and Facilities.](../images/choice-list-header.png "Web UI Dynamic Choice list prompt with header card")
