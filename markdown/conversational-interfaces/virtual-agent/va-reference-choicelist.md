...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/va-reference-choicelist.html
release: xanadu
...
For more information about the preceding scripting details, review information about [GlideRecords](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/server-api-reference/c_GlideRecordAPI.md) and the additional information:
...
\[Omitted image "nass-dynamic-choice-user-prompt.png"\] Alt text: A Dynamic Choice list returns a list of incidents created by the user and two options are selected.
...
\[Omitted image "va-refchoice-properties.png"\] Alt text: Basic properties include the node name, prompt, NLU entity, and Populate choices by list.

</td><td>

\[Omitted image "va-ref-choicelist-web-search.png"\] Alt text: A Dynamic Choice list returns a list of incidents created by the user.
...
\[Omitted image "choice-list-header.png"\] Alt text: The prompt asks, "What would you like to check?" followed by a photo and heading of a hotel. Choices include, Dining, Suites, and Facilities.
...
</table>## Dynamic Choice script examples
