...
keywords: [Assistant, Designer, Asset, Library, LLM, Now Assist, GenAI, Generative AI, Dynamic Choice, User input control]
...
## Dynamic Choice user input control properties
...
</table>## Example Dynamic Choice user input control
...
|Slack|Not supported|Header cards aren’t supported.|
|SMS Twilio|Not supported|Header cards aren’t supported.|
