...
-   [ITSM Virtual Agent Conversations](https://www.servicenow.com/docs/access?context=setup-itsm-virtual-agent&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US) \(available in the ServiceNow® Store\)
...
10. Request the upgraded item.
    ...
    This topic block returns output variables as well. The user will be able to select variables for their new device, as well. You can configure these variables in [Service Catalog](https://www.servicenow.com/docs/access?context=service-catalog&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
