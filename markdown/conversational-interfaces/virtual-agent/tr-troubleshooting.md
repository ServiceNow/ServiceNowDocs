...
3.  If the Status column is empty, the analysis failed. Try running it again.
 ...
 You can also navigate to **NLU Workbench** &gt; **Intent Discovery** to see if something went wrong in the intent discovery process. For more information, see [Intent Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/intent-discovery.md).
