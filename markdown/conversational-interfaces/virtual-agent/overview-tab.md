...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/overview-tab.html
release: xanadu
...
For directions about using the widgets on the **Overview** tab, see [Explore the Virtual Agent Analytics Dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/dashboard-explore-dashboard.md).
...
-   Selecting the arrowhead icon \[Omitted image "dashboard-carat.png"\] Alt text: Carat in any of the widgets to open other dashboard tabs that display more detailed information.
...
**Note:** Your **Overview** tab might look different because [it can be configured](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/edit-overview-tab.md).

-   **[Edit the Overview page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/edit-overview-tab.md)**  
