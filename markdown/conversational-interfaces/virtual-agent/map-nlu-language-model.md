...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/virtual-agent/map-nlu-language-model.html
release: zurich
...
If you're using ServiceNow NLU, review [NLU model mapping in Assistant Designer Asset library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/nlu-model-binding-vad.md) for an understanding of NLU model groups.
...
3.  Set the discovery type toggle switch to **NLU/keyword** toggle, and open a topic.
...
[Test topic and NLU model translations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/test-nlu-language-model.md)
