...
3.  On the Channels and integrations page, on the Microsoft Teams tile, select **Manage**

4.  In the Manage Microsoft Teams channel page, find the integration \(Now Virtual Agent bot or the Self-configured bot\) that you would like to remove, select the manage bot icon ![Manage bot icon.](../images/manage-bot-icon.png), and select **Remove integration**.
...
5.  In the Remove integration confirmation message, select **Remove** to continue removing the integration.![Banner message confirming removed integration with Microsoft Teams.](../images/remove-integration-success.png)
