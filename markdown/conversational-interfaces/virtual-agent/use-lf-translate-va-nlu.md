...
4.  In the **View language** list, select a language.
    ...
    ![The Manage languages page displaying the topic and their associated NLU models with topic translation status, translations, test, and NLU intent.](../images/va-loc-manage-languages-page-new.png "Manage languages page")
...
6.  Click **Manage NLU translations**.
    ...
    The model opens in NLU Workbench. Request translations for your model group. For more information, see [Translate a multilingual model](https://www.servicenow.com/docs/access?context=translate-multilingual-model&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).
