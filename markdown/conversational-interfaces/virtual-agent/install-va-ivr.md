...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/conversational-interfaces/virtual-agent/install-va-ivr.html
release: australia
...
3.  Click **Install**.
    ...
    You are directed to the ServiceNow Store where you can search and get the Conversational IVR with Amazon Connect application to use IVR.


## What to do next

To learn how to configure your AWS account for enabling Conversational IVR, see [Configuring your AWS account for use with Conversational IVR](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/configure-aws-account.md).

-   **[Components installed with Conversational IVR with Amazon Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/components-installed-with-va-ivr.md)**  
...
**Parent Topic:**[Conversational IVR with Amazon Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/va-ivr-voice.md)
