...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/va-text-response.html
release: yokohama
...
\[Omitted image "bot-text-response-2.png"\] Alt text: Bot text response properties.
