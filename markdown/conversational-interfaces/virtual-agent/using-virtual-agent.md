---
title: Building and deploying Virtual Agent
description: Convert the time your agents and technicians spend handling low-impact user requests into an intelligently managed interaction. Enable Virtual Agent with NLU to understand the intent of what people are looking for and provide them with more relevant answers.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/using-virtual-agent.html
release: xanadu
...
-   **[Using Issue Auto Resolution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/auto-resolution-va.md)**  
...
-   **[Getting started with Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/conversation-designer-virtual-agent.md)**  
...
-   **[Exploring other Virtual Agent features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/exploring-other-vad-features.md)**  
...
-   **[Using Virtual Agent with a live agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/using-va-agent-chat.md)**  
...
-   **[Tracking deflections in Virtual Agent using the deflection topic block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/deflections-virtual-agent.md)**  
...
-   **[Using Virtual Agent API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/virtual-agent-api.md)**  
...
-   **[Using Virtual Agent Bot Interconnect in your configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/using-sn-va-primary-bot-api.md)**  
...
-   **[Localization options for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/multi-language-options-va.md)**  
...
**Parent Topic:**[Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/virtual-agent-landing-page.md)
