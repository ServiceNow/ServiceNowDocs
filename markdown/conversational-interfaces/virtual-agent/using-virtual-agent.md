...
-   **[Using Issue Auto Resolution](auto-resolution-va.md)**  
...
-   **[Exploring other Virtual Agent features](exploring-other-vad-features.md)**  
...
-   **[Tracking deflections in Virtual Agent using the deflection topic block](deflections-virtual-agent.md)**  
