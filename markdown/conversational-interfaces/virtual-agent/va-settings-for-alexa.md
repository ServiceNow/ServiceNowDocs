...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/va-settings-for-alexa.html
release: xanadu
...
-   You can also change the system-generated messages by entering `sys_properties.list` in the navigation filter, and filter them by the criteria `com.glide.cs` to confirm that these messages work for voice channels. You can review the following key messages:
    ...
    **Note:** Most of the messages unique to the voice channels are listed in the Bot Messages section of the Provider Channel Identity record.
    ...
    For more information, see [Change the Virtual Agent greeting messages in the Greeting setup topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/va-welcome-topic-selection-msgs.md).
