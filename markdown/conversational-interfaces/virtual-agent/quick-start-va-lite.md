...
2.  Configure Virtual Agent Lite for additional portals.
    ...
    Virtual Agent Lite appears in the Service portal by default. For more information about configuring the Service portal, see [Service Portal events](https://www.servicenow.com/docs/access?context=sp-analytics-events&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
