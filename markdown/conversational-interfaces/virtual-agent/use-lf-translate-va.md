...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/use-lf-translate-va.html
release: xanadu
...
2.  Open the topic that you want to translate.

3.  Select the **Languages** tab.

    Only languages that are installed and activated are displayed. To learn how to activate localization plugins, see [Activate a language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/system-localization/t_ActivateALanguage.md).
...
4.  Do one of the following:
    ...
    -   Request translation:
        1.  Select the applicable check boxes, and then select **Request translations**.
    ...
    -   [Edit translations directly in Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/edit-translations-va-topics.md).
