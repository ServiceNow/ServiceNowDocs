...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/use-lf-translate-va.html
release: yokohama
...
3.  Select the **Languages** tab.
    ...
    Only languages that are installed and activated are displayed. To learn how to activate localization plugins, see [Activate a language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/system-localization/t_ActivateALanguage.md).
...
4.  Do one of the following:
    ...
    -   [Edit translations directly in Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/edit-translations-va-topics.md).
