...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/user-page.html
release: xanadu
...
-   View detailed information about each chat, and mark chats as favorite. For more information, see [Get information about each chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/user-page.md).
-   View details about each user. For more information, see [Get information about each user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/user-page.md).
...
**Parent Topic:**[Legacy - Users tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/users-tab.md)
