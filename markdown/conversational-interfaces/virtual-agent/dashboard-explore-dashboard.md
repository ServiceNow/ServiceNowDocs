...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/dashboard-explore-dashboard.html
release: yokohama
...
\[Omitted image "vaa-next-exp-overview.png"\] Alt text: Virtual agent analytics overview tab
...
-   **Worst performing topics**
    ...
    \[Omitted image "vaa-next-least-performing-topic.png"\] Alt text: Virtual Agent worst performing topics dialog box, with Least Used tab active.
...
-   **Conversation details**
    ...
    \[Omitted image "vaa-next-conversation-details.png"\] Alt text: Virtual Agent Analytics Dashboard conversation details tab.

-   **User insights**

    Get a history of a user's chats.

    \[Omitted image "vaa-next-user-details.png"\] Alt text: Virtual Agent chat User details with multiple chat events shown.
...
-   **Date range of data displayed**
    ...
    For information about setting the date range, see [Set the date range of the data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/use-the-dashboad.md).
...
-   **Getting detailed data**
    ...
    -   Select the arrowhead in one of the cards.
        ...
        \[Omitted image "vaa-next-active-va-users.png"\] Alt text: Virtual Agent active users widget.

    -   Select a visualization.

        \[Omitted image "vaa-next-click-a-visualization.png"\] Alt text: Open graph in Virtual Agent expanded from Active users widget, with arrow indicator pointing to New Issue category.
...
-   **Trends and scores**
    ...
    \[Omitted image "vaa-next-virtual-agent-activity.png"\] Alt text: Virtual Agent analytics Dashboard scorecard.
...
-   **Visualizing data**
    ...
    \[Omitted image "vaa-next-virtual-agent-performance.png"\] Alt text: Three Virtual Agent data visualization tabs displaying Category, Topics, and User Feedback data.

    The cards have a common setup.

    \[Omitted image "vaa-next-categories-summary.png"\] Alt text: Virtual Agent chat dashboard general widget UI. Summarized Data, Data sets tabs, more information arrow, and data visualization areas of the card are highlighted.

    In each visualization, you can select:

    -   Subtabs to visualize different datasets in the visualization.
    -   Arrowhead icon \[Omitted image "dashboard-arrowhead.png"\] Alt text: Arrowhead icon., which takes you to the corresponding tab that provides more detailed information.
...
Now that you are familiar with the user interface, you can [try the tutorial](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/dashboard-scenario-1.md). It shows how the parts of the dashboard work together to provide insights for improving VA.

-   **[Trying out the dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/dashboard-scenario-1.md)**  
Use this tutorial to get familiar with the Conversational Analytics Dashboard.

**Parent Topic:**[Legacy - Conversational Analytics Dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/VA-dashboard-landing-page.md)
