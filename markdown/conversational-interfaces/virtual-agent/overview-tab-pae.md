...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/overview-tab-pae.html
release: yokohama
...
**Note:** Now Assist in Virtual Agent Analytics appears in the left navigation only when you have [Now Assist in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/now-assist-in-virtual-agent/now-assist-in-va-landing.md) enabled.
