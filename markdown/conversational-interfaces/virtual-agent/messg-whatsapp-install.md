...
-   **Twilio Spoke \(sn\_twilio\_spoke\)**
    ...
    For more information on activating this application, see [Twilio spoke](https://www.servicenow.com/docs/access?context=twilio-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
