...
To learn more, see Localization Framework. To learn more about localization roles, see [Localization roles for Virtual Agent](../reference/localization-roles-va.md#).
