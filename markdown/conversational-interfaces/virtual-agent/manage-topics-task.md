...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/manage-topics-task.html
release: xanadu
...
-   Include the topic in topic discovery.
    ...
    **Note:** If these methods don't generate search results, or Virtual Agent can't determine the appropriate conversation to display, use [AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/va-ai-search.md) as a fall-back method.
...
-   Include the topic in the list of topics available for use.
    ...
    \[Omitted image "show-me-everything.png"\] Alt text: Virtual Agent chat window with Show me everything option.

    You should then see the **All Topics** menu.


\[Omitted image "all-topics-menu.png"\] Alt text: All Topics menu in the chat window.
...
**Note:** If the fields are not visible, you can [configure the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/configure-form-layout.md) to show them.

## Procedure

1.  [Create a Virtual Agent topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/create-virtual-agent-topic.md).
