...
Enable the notifications for the WhatsApp channel. For more information, see [Enable WhatsApp channel notifications](../../virtual-agent/task/enable-direct-whatsapp-channel-notifications.md).
...
**Parent Topic:**[Using Conversational Integration with WhatsApp \(WhatsApp Cloud API\)](../../virtual-agent/concept/messg-direct-whatsapp-using.md)

**Related topics**  


[Provider notifications](https://www.servicenow.com/docs/access?context=provider-notifications-landing&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)

[Create default content in a provider](https://www.servicenow.com/docs/access?context=create-default-content&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
