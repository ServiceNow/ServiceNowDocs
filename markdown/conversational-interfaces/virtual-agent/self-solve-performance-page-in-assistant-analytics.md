...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/virtual-agent/self-solve-performance-page-in-assistant-analytics.html
release: brazil
...
\[Omitted image "NAinVA-assistant-designer-analytics-self-solve-performance.png"\] Alt text: A dashboard with score cards for key self-solve metrics, line charts tracking deflection rate and effort scores over time, and pie charts showing outcome and deflection type distributions
...
-   **Total Deflection Events**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-self-solve-performance-total-events.png"\] Alt text: A single score card displaying the count of events with potential for deflection. Includes a sparkline showing the trend and comparison to the previous period.
...
-   **Total Deflections**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-self-solve-performance-total-self-solved-events.png"\] Alt text: A single score card displaying the count of successfully resolved self-solve events. Includes a sparkline showing the trend and comparison to the previous period.
...
-   **Total Live Agent Transfers**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-self-solve-performance-total-live-agent-transfers.png"\] Alt text: A single score card displaying the count of conversations transferred to live agents. Includes a sparkline showing the trend and percentage change from the previous period.
...
-   **Deflection Rate**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-self-solve-performance-deflection-rate.png"\] Alt text: A single score card displaying the average deflection rate as a percentage. Includes a sparkline showing the trend across the selected date range.
...
-   **Deflection Rate Over Time**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-self-solve-performance-deflection-rate-over-time.png"\] Alt text: A line chart with the x-axis showing dates and the y-axis showing deflection rate percentage from 0% to 100%. A single trend line tracks deflection rate changes over time.
