...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/virtual-agent/nava-sys-props.html
release: brazil
...
breadcrumb: [ServiceNow Otto for Virtual Agent reference, Reference, Virtual Agent, Conversational Interfaces]
---
...
Displays the **View all topics** link on the chat's greeting screen. The default value is `false`.
...
</table>**Parent Topic:**[ServiceNow Otto for Virtual Agent reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/now-assist-in-va-reference.md)
