...
-   Set up notifications to be sent to the requester when a business event occurs or when a record is updated. See [Create a provider notification](../../notification/task/direct-whatsapp-create-a-provider-notification.md).
...
-   **[Create a provider notification](../../notification/task/direct-whatsapp-create-a-provider-notification.md)**  
