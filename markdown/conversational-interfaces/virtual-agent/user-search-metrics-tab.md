...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/user-search-metrics-tab.html
release: yokohama
...
**Note:** You can also use Financial Services Remote Tables to view user-search data in Dashboards. For more information, see [Remote tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/remote-tables/remote-tables.md).
