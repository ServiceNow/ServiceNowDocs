...
The domain-separated instance has one setup record for Slack or Microsoft Teams.

Customers on the subdomain license run either Slack or Microsoft Teams independently of the ServiceNow instance.
