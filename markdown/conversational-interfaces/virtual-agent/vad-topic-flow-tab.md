...
Tabs to navigate between your design and the home page. You can open and nevigate between multiple topics and the home page by selecting **Virtual Agent Designer** or an open topic's tab. Select the close icon ![Close icon.](../images/delete-icon.png) on a tab to close that topic.
...
![Table view of Virtual Agent Designer Flow tab with variables, search table, and Table toggle highlighted. For the text description, see the table that follows.](../images/DesignerTableviewCallouts.png "Example Flow tab in Table View")
