...
For information about the types of entities that you can define, see [NLU entities](https://www.servicenow.com/docs/access?context=entities&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US). For information about system entities, see [NLU system entities](nlu-system-entities.md). When you add an entity, it is also displayed in the **Associated Entities** tab.


</td></tr></tbody>
</table>![The Check IT Ticket Status topic displays 24 utterances. There are two associated entities. You can add more utterances, or train and test your model.](../images/NLU-intent-tab-utterances-2a.png "Example utterances on the NLU Intent tab")

![Select a word or phrase in an utterance, then use the Create New Entity picker to add an entity related to it.](../images/NLU-intent-create-entities-2a.png "Adding entities on the Utterances tab")
...
![The Conflicts tab shows problems that may interfere with topic discovery. In this example, two separate intents contain the same utterance.](../images/nlu-intent-tab-conflicts-2a.png "Utterance conflict between two intents")
