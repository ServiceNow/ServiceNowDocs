...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/vad-topic-nlu-intent-tab.html
release: xanadu
...
Select the Edit icon \[Omitted image "edit-icon.png"\] Alt text: Edit icon. next to the utterance.
...
Select the Copy icon \[Omitted image "copy-utterance-icon.png"\] Alt text: Copy icon. next to the utterance.
...
Select the Menu icon \[Omitted image "manage-bot-icon.png"\] Alt text: Menu icon., and then select **Move this utterance to another intent**.
...
Select the Menu icon \[Omitted image "manage-bot-icon.png"\] Alt text: Menu icon., and then select **Delete this utterance**.
...
For information about the types of entities that you can define, see [NLU entities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/intelligent-experiences/nlu-service/entities.md). For information about system entities, see [NLU system entities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/nlu-system-entities.md). When you add an entity, it is also displayed in the **Associated Entities** tab.
...
You can also associate system entities, such as date and time, with an intent. For more information about supported system entities, see [NLU system entities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/nlu-system-entities.md).
