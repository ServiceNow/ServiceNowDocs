...
Select the Edit icon ![Edit icon.](../images/edit-icon.png) next to the utterance.
...
Select the Copy icon ![Copy icon.](../images/copy-utterance-icon.png) next to the utterance.
...
Select the Menu icon ![Menu icon.](../images/manage-bot-icon.png), and then select **Move this utterance to another intent**.
...
Select the Menu icon ![Menu icon.](../images/manage-bot-icon.png), and then select **Delete this utterance**.
