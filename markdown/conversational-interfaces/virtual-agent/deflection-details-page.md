...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/virtual-agent/deflection-details-page.html
release: brazil
...
breadcrumb: [Self-Solve Performance page, Analyze and optimize, Virtual Agent, Conversational Interfaces]
---
...
This area of the dashboard displays a list of individual conversations based on the drill downs you select in either of the charts.

\[Omitted image "NAinVA-assistant-designer-analytics-self-solve-performance-deflection-details-conversation-details.png"\] Alt text: Conversation details section in Deflection details page
