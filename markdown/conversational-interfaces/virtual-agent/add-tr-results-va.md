...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/add-tr-results-va.html
release: xanadu
...
4.  If you're using ServiceNow NLU, select one of the following options in the **Model** list:
    ...
    -   **Create new model**
        ...
        For more information about model groups, see [Multilingual model management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/intelligent-experiences/nlu-service/multilingual-model-managent.md).
