...
4.  If you're using ServiceNow NLU, select one of the following options in the **Model** list:
    ...
    -   **Create new model**
        ...
        For more information about model groups, see [Multilingual model management](https://www.servicenow.com/docs/access?context=multilingual-model-managent&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).
