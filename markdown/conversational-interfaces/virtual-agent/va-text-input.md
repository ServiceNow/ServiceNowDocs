...
For more information about the WS-security standards, see [WS-Security properties](https://www.servicenow.com/docs/access?context=ws-security-properties&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
