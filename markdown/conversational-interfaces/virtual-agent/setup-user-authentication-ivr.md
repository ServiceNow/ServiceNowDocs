...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/setup-user-authentication-ivr.html
release: xanadu
...
5.  On the Amazon Connect information form, in the Configure user authentication tile, select **Configure authentication**.
...
7.  Select the **Authentication style**.
    ...
    To set up your end users with Soft PIN or MFA, see [Configure your Password Reset process to auto-enroll users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/password-reset/configure-auto-enroll-for-pwd-reset.md).
