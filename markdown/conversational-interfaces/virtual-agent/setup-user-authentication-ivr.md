...
7.  Select the **Authentication style**.
    ...
    To set up your end users with Soft PIN or MFA, see [Configure your Password Reset process to auto-enroll users](https://www.servicenow.com/docs/access?context=configure-auto-enroll-for-pwd-reset&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
