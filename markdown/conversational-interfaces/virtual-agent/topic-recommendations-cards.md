...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/topic-recommendations-cards.html
release: xanadu
...
Topic or intent was added to Virtual Agent or [linked to an existing topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/link-tr-existing-va-topic.md) and published.Cards with **Active** status have a green border.
...
-   [Link the recommendation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/link-tr-existing-va-topic.md) to an existing topic.
