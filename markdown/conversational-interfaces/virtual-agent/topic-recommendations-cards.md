...
Displays the name of the topic that was added for the recommendation, as well as the date when it was added.Click the open link icon ![Open link icon.](../images/icon-open-link.png) to view the topic in Virtual Agent Designer.
...
Displays the name of the topic that was linked, as well as the date when the recommendation was linked. Click the open link icon ![Open link icon.](../images/icon-open-link.png) to view the associated topic in Virtual Agent Designer. You can also [unlink the topic](../task/unlink-tr-va-topic.md) from the recommendation.
