...
For general information about how geolocation is used on the ServiceNow platform, see [Geolocation](https://www.servicenow.com/docs/access?context=c_Geolocation&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
