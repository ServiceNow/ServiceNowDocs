...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/va-teams-other-features.html
release: yokohama
...
Using the Custom Control utility will cause failure in Microsoft Teams conversations with the message `channel is not supported`. See [Custom control utility](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/va-custom-control-util.md) for more information on the utility.

-   **[Virtual Agent Designer user input and bot response controls in Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/va-designer-bot-controls.md)**  
...
-   **[Virtual Agent notifications supported in Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/va-notif-msteams.md)**  
Microsoft Teams app supports Virtual Agent notifications during conversations.
-   **[Unsupported Virtual Agent features in Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/limited-features-msteams.md)**  
