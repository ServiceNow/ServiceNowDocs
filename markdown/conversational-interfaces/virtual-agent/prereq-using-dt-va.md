...
2.  [Activate language plugins](https://www.servicenow.com/docs/access?context=t_ActivateALanguage&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) for each language that you want to deploy with dynamic translation.
...
5.  \(Optional\) Create exclusion rules for specific terms and content patterns within the [Exclusion Framework](https://www.servicenow.com/docs/access?context=dyn-translation-exclusion-framework&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
1.  [Integrate with a translation service provider](https://www.servicenow.com/docs/access?context=integrate-translation-service-provider&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).

2.  [Create a translator configuration in Dynamic Translation](https://www.servicenow.com/docs/access?context=create-custom-translator&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).

3.  [Create a language code mapping](https://www.servicenow.com/docs/access?context=create-language-code-mapping&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) to map translator language codes to the ServiceNow® language codes.
