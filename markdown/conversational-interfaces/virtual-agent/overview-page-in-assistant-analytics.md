...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/virtual-agent/overview-page-in-assistant-analytics.html
release: brazil
...
View high-level summary of assistant activity, assist usage, user engagement and overall customer satisfaction \(CSAT\) score.
...
-   Overall CSAT score, which is an indicator of user sentiment, enables you to monitor assistant quality and make targeted improvements.
-   Assist usage volume reveals assist consumption patterns across assistants.
-   Average distinct users reveals user adoption across assistants.
