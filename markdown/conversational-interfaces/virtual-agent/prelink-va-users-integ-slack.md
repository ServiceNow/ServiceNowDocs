...
-   [Set up Slack Spoke](https://www.servicenow.com/docs/access?context=set-up-slack&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
...
4.  For a description of the other fields that you can change in this form, including **Time zone**, see [Automatically run a script of your choosing](https://www.servicenow.com/docs/access?context=t_ScheduleAScriptExecution&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
