...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/va-llm-instruction-guidelines.html
release: xanadu
...
keywords: [Now Assist, Generative AI, Gen AI, Virtual Agent, LLM, large language model, NLU, natural language understanding]
...
## Overview of LLM description and instruction guidelines for Virtual Agent topics
...
For more information, see [General guidelines for writing instructions for generative AI large language models \(LLMs\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/intelligent-experiences/enable-ai-experiences/llm-instruction-guidelines.md).
