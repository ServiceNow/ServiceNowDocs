...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/create-user-assign-roles.html
release: xanadu
...
breadcrumb: [Configuring your AWS account for use with Conversational IVR, Conversational IVR with Amazon Connect, Virtual Agent integration with Voice channels, Integrating Virtual Agent with other channels, Virtual Agent, Conversational Interfaces]
---
