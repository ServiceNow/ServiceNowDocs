...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/va-lite.html
release: yokohama
...
For Yokohama, the Virtual Agent Designer features available in Virtual Agent Lite include the following:
...
-   Control topic discovery and visibility.
    ...
    For more information about using these options, see [Control topic discovery and visibility](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/manage-topics-task.md).
...
Set up and configure Virtual Agent Lite. For details, see [Quick start for Virtual Agent Lite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/quick-start-va-lite.md).
