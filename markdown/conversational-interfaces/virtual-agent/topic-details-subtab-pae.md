...
description: Use the Topic Details page in the Conversational Analytics dashboard to view key performance indicators of Natural Language Understanding \(NLU\) Virtual Agent \(VA\) topics.
locale: en-US
release: zurich
...
breadcrumb: [Topics tab, Using the Conversational Analytics Dashboard, Conversational Analytics dashboard, Analyze VA performance, Virtual Agent, Conversational Interfaces]
---
