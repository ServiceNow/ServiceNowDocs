...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/conversational-interfaces/virtual-agent/create-va-topic-sn-primary-secondary-config.html
release: australia
...
3.  [Create a topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/create-virtual-agent-topic.md) in your primary instance of Virtual Agent.
...
**Previous topic:**[Create an auth token in the ServiceNow secondary instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/create-auth-token-sn-secondary-instance.md)

**Next topic:**[Enable live agent connection on the primary instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/enable-live-agent-connection-on-the-secondary-instance.md)
