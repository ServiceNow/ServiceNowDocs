...
-   Core ServiceNow® mobile plugins
    ...
    For more information, see [Mobile plugins](https://www.servicenow.com/docs/access?context=sg-mobile-plugins&version=zurich&pubname=zurich-mobile&ft:locale=en-US).
