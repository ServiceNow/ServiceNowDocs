...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/conversational-interfaces/virtual-agent/alexa-intents.html
release: australia
...
|Intent|Utterance|Language understanding|
|------|---------|----------------------|
|AMAZON.YesIntent|yes, yeah|Sends the message “yes”|
|AMAZON.NoIntent|no, nope|Sends the message “no”|
|AMAZON.HelpIntent|help, help me, and can you help me|Help message is displayed|
|AMAZON.PauseIntent|pause|End conversation; End Alexa Session|
...
**Parent Topic:**[Set up Conversational Integration with Alexa](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/setup-alexa.md)
