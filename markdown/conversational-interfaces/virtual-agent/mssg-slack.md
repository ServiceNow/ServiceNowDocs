...
[Integrate![](../../../reuse/icons/brand-icons/bus-integration-and-apis.svg)Integrate Conversational Integration with Slack with Virtual Agent.](../concept/va-integ-slack.md)

</td><td>

[Configure![](../../../reuse/icons/brand-icons/bus-sdlc.svg) Configure your Conversational Integration with Slack implementation.](configure-va-slack-settings.md)

</td></tr><tr><td>

[Now Assist![](../../../reuse/icons/brand-icons/bus-ai-sparkle.svg)Use Now Assist in Virtual Agent in your Slack integration.](../concept/na-va-llm-slack.md)

</td><td>

[Design![](../../../reuse/icons/brand-icons/bus-manage.svg) Use supported Virtual Agent features in Slack conversations.](../concept/va-slack-other-features.md)
...
-   **[Integrating ServiceNow Virtual Agent with Slack](../concept/va-integ-slack.md)**  
...
-   **[Configure Virtual Agent settings for Slack](configure-va-slack-settings.md)**  
...
-   **[Using Now Assist in Virtual Agent conversations with Slack](../concept/na-va-llm-slack.md)**  
...
-   **[Virtual Agent features supported in Slack conversations](../concept/va-slack-other-features.md)**  
