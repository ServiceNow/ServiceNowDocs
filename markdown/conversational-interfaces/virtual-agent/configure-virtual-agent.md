...
|Configure my bot to run in third-party messaging apps|[Virtual Agent integration with messaging apps](va-integration-messaging-apps.md).|
...
[Configure Natural Language Understanding in Virtual Agent](../task/configure-nlu-settings.md)
 ...
 [Creating models](https://www.servicenow.com/docs/access?context=creating-models&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US) \(using NLU Workbench\)
...
Platform hardening for your instance is leveraged by Virtual Agent, so you should follow the overall platform hardening recommendations. For details, see [Secure your instance](https://www.servicenow.com/docs/access?context=platsec-landing&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
...
-   **[Catalogs for Virtual Agent](va-catalogs.md)**  
