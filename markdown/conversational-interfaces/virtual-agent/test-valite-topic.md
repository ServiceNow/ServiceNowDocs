...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/test-valite-topic.html
release: yokohama
...
Activate the plugin. For more information, see [ITSM Virtual Agent Conversation Topics Lite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/itsm-virtual-agent/setup-itsm-virtual-agent-lite.md) \(com.snc.itsm.virtualagent.lite\).
...
If you'd like to deploy a topic, [duplicate and publish the topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/duplicate-publish-valite-topic.md) so that it's available to your users.
