...
Activate the plugin. For more information, see [ITSM Virtual Agent Conversation Topics Lite](https://www.servicenow.com/docs/access?context=setup-itsm-virtual-agent-lite&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US) \(com.snc.itsm.virtualagent.lite\).
...
3.  Select the topic that you want to preview.
    ...
    ![Flow tab of the predefined Check IT Ticket Status topic showing the desinger canvas in a read-only mode.](../images/va-lite-check-status-flow.png)
