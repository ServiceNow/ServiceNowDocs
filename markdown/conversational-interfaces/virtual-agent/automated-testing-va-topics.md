...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/automated-testing-va-topics.html
release: xanadu
...
Create topic test cases through a topic's **Test** &gt; **Create test case** preview and view the topic's test cases through the Topics List page's **Manage NLU/keyword test cases** button. Only run automated tests on a development, test, or other non-production instance to avoid data corruption and outage. For more information, see the [Automated Test Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/automated-test-framework-atf/automated-test-framework.md).
...
-   **[Create an automated test in Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/create-automated-test-vad.md)**  
...
-   **[Manage and run automated test cases in Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/manage-automated-test-cases.md)**  
...
-   **[Handle failures caused by dynamic inputs in user testing of Virtual Agent topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/t_handle-dynamic-inputs-user-testing.md)**  
...
**Parent Topic:**[Testing NLU/Keyword topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/va-designer-testing.md)
