...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/virtual-agent-scripts.html
release: yokohama
...
Evaluates whether `myvar` matches an expected value. **Note:** Values for user input variables are assigned using user input controls. These values can’t be changed in your scripts.
 ...
 -   The Yokohama release supports additional data types. For more information, see [Input data types in Virtual Agent topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/va-data-types.md).
 ...
 **Note:** NLU must be enabled on the topic. In the Virtual Agent Designer, select the **Properties** tab to set up NLU. For information about defining NLU entities, see [Entities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/entities.md).
...
\[Omitted image "ScriptVariablesExample.png"\] Alt text: Sidebar in theVirtual Agent Designer canvas for manually adding script variables that are used in topic scripts.
...
For information about defining a script variable in a topic, see [Define script variables for a topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/define-script-variables-topic.md).
...
For information about live agent context variables that are included with Virtual Agent, see [Live agent chat context variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/live-agent-chat-context-vars.md).
...
Connects the customer to a live agent. For more information on this method, see [Transferring Virtual Agent conversations to a live agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/transfer-to-live-agent.md).
