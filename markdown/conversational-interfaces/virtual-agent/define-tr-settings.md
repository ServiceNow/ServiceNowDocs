...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/define-tr-settings.html
release: yokohama
...
-   In the Yokohama release, Topic Recommendations requires a minimum of 10,000 records in your analysis scope \(data source\). This minimum provides a reasonably sized data set to achieve a certain level of quality in the analyses.
-   Keep your analysis scope \(data source\) under 300,000 records. In the Yokohama release, this is the maximum number allowed. This limit maximizes the performance of the analysis report.
...
5.  On the form, fill in the fields.
    ...
    For details, see [Topic Recommendations settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/tr-settings-page.md).
