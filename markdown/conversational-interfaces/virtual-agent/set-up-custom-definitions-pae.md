...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/conversational-interfaces/virtual-agent/set-up-custom-definitions-pae.html
release: australia
...
-   End state—Defined by default in 12 ways. For more information, see [Formula override examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/formula-override-examples-pae.md).
