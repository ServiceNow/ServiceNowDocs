...
The Virtual Agent search configurations are part of the default chat experience set in Virtual Agent Designer, through the Custom Greetings and Setup feature. Use this feature to specify the context for running Virtual Agent. The chat experience defines the setup topics used in Virtual Agent conversations and the search configuration that controls the AI Search experience. The AI Search Fallback setup topic controls the AI Search experience. For details, see [Setting up chat experiences for Virtual Agent users](va-conversation-settings.md).
