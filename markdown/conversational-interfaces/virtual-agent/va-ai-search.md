...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/virtual-agent/va-ai-search.html
release: zurich
...
The AI Search application, which is included with the ServiceNow AI Platform, provides relevant search results for queries and uses Machine Learning to continuously improve search results based on end-user selections. To learn more about AI Search, see .
...
In order to use AI Search in Virtual Agent, you must request it for your instance. For more information, see [Activate AI Search for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/activate-ai-search-va.md).

## When Virtual Agent uses AI Search fallback

Virtual Agent uses AI Search fallback in the following instances:

-   Topic discovery can't find any matchinag topics for the user query.
...
-   The EVAM configuration for Virtual Agent controls the Genius card content presented in search results \(Q&amp;A, Catalog, and People\). For information on how EVAM works, see .
...
-   **[Activate AI Search for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/activate-ai-search-va.md)**  
...
-   **[Create a custom AI Search experience for Virtual Agent conversations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/create-va-aisearch-application.md)**  
