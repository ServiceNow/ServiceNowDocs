...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/set-up-apple-messages.html
release: yokohama
...
breadcrumb: [Configure Conversational Integration with Apple Messages for Business, Integrating Virtual Agent with Apple Messages for Business, Integrating Virtual Agent with messaging apps, Integrating Virtual Agent with other channels, Virtual Agent, Conversational Interfaces]
---
...
If you want to integrate your Identity Provider \(IdP\), go to: [OAuth setup for Apple Messages for Business](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/oauth-setup-apple.md).
