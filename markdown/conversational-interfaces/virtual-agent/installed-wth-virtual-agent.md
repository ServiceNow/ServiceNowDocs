...
-   For multilanguage support, the localization\_requestor role is included by default. For more information, see [Localization Framework roles](https://www.servicenow.com/docs/access?context=roles-localization-framework&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) .
