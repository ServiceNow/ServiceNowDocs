...
1.  [Create a new domain](https://www.servicenow.com/docs/access?context=t_CreateADomain&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) and assign roles to the domain as needed.
...
4.  Select the name of the portal that you want to restrict to a domain, or [create a new one](https://www.servicenow.com/docs/access?context=create-a-portal&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
