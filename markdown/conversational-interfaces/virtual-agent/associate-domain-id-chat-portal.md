...
1.  [Create a new domain](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/t_CreateADomain.md) and assign roles to the domain as needed.
...
4.  Select the name of the portal that you want to restrict to a domain, or [create a new one](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/create-a-portal.md).
