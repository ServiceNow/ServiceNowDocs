...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/associate-domain-id-chat-portal.html
release: xanadu
...
4.  Select the name of the portal that you want to restrict to a domain, or [create a new one](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/create-a-portal.md).
...
**Parent Topic:**[Domain separation and Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/domain-separation-virtual-agent.md)
