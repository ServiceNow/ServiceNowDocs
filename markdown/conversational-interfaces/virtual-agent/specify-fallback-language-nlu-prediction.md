...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/virtual-agent/specify-fallback-language-nlu-prediction.html
release: zurich
...
**Note:** The fallback language plugin must be installed on the instance. Once installed, the language is available in the Languages \[sys\_language\] table. If ServiceNow Otto for Virtual Agent is on and you work with LLM-enabled conversations, you can only establish a fallback language in the Languages \[sys\_language\] table rather than use the following steps.
