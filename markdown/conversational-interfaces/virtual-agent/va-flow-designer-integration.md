...
In Virtual Agent conversations, you can use actions to trigger workflows. These workflows are custom built in an application \(such as Workflow Studio\) or workflows of third-party applications and products available in the Integration Hub. Integrations built using Workflow Studio and Integration Hub help to ensure a high level of resiliency and performance.
