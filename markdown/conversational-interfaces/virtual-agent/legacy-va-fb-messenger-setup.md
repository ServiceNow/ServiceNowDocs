---
title: Legacy setup and configuration
description: Set up and configure Conversational Integration with Facebook Messenger \(Legacy\).
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/conversational-interfaces/virtual-agent/legacy-va-fb-messenger-setup.html
release: australia
...
# Legacy setup and configuration

Set up and configure Conversational Integration with Facebook Messenger \(Legacy\).

-   **[Set up the Virtual Agent integration with Facebook Messenger \(Legacy\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/setup-virtual-agent-fbmessenger.md)**  
Configure the Virtual Agent integration for Facebook Messenger and associate the app with your instance.
-   **[Configure the help link for the Virtual Agent Facebook Messenger integration \(Legacy\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/create-fb-help-prop.md)**  
