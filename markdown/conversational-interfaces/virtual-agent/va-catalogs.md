---
title: Catalogs for Virtual Agent
description: Use Catalogs to search for and request services and products in chat widget conversations.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/va-catalogs.html
release: xanadu
...
keywords: [virtual, agent, catalogs, web, client]
...
If you choose to order the item, you select any available options. When you complete the order, the Virtual Agent shows you a Requested Item record with a link. Selecting the link takes you to the record.
...
-   **[Set up Catalog branding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/va-catalogs-branding.md)**  
