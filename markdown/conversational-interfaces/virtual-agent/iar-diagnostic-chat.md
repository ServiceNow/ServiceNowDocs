...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/iar-diagnostic-chat.html
release: yokohama
...
\[Omitted image "iar-diagnostic-1a.png"\] Alt text: When the admin types "IAR," the bot offers these two solutions. Select the one that applies.
...
1.  Confirm your selection, return to search, or search KB articles.
    ...
    \[Omitted image "iar-diagnostic-2a.png"\] Alt text: Bot responses for this flow include Yes, Back to Searched result, Search KB, and Search again.
...
2.  Select the type of case or Incident with which you need help, or choose to search all Issue Auto Resolution configurations.
    ...
    \[Omitted image "iar-diagnostic-3a.png"\] Alt text: You are prompted to select the related table you want to run the health check on. For instance, HR Cases, Incidents, or all configured tables.
...
3.  The diagnostic tool performs an analysis on Issue Auto Resolution configuration and settings and displays the results. The diagnostic confirms the following conditions:
    ...
    \[Omitted image "iar-diagnostic-4a.png"\] Alt text: Bot response showing PASSED test results for the conversation.

4.  Enter the Incident or case number and confirm it’s correct.

    \[Omitted image "iar-diagnostic-6.png"\] Alt text: When you've chose to proceed with the test, enter the Incident or case number in the chat.\[Omitted image "iar-diagnostic-6a.png"\] Alt text: When you've chose to proceed with the test, enter the Incident or case number in the chat.
...
1.  Confirm your choice to proceed diagnosing a functionality issue with Issue Auto Resolution.
    ...
    \[Omitted image "iar-diagnostic-9a.png"\] Alt text: Confirm your choice to diagnose an Issue Auto Resolution problem in the chat window.
...
2.  The diagnostic tool checks the following conditions:
    ...
    \[Omitted image "iar-diagnostic-11a.png"\] Alt text: Select Yes if you found a solution, or select No to continue with further diagnosis.


**Parent Topic:**[Using Issue Auto Resolution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/auto-resolution-va.md)

**Related topics**  


[Conversational Interfaces Diagnostic Tool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/conversational-interfaces-diagnostics-tool/ci-diagnostics-tool-landing.md)
