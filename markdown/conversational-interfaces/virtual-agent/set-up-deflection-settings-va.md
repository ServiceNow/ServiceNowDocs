...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/set-up-deflection-settings-va.html
release: yokohama
...
breadcrumb: [Tracking deflections in Virtual Agent using the deflection topic block, Building and deploying Virtual Agent, Virtual Agent, Conversational Interfaces]
---
...
Review [Tracking deflections in Virtual Agent using the deflection topic block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/deflections-virtual-agent.md).
...
**Note:** For information about configuring components of the Virtual Agent Analytics dashboard \(such as Performance Analytics widgets\), see [Add and configure components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/ui-builder/add-components.md).
...
**Parent Topic:**[Tracking deflections in Virtual Agent using the deflection topic block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/deflections-virtual-agent.md)
