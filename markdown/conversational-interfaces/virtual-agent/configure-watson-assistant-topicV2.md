...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/configure-watson-assistant-topicV2.html
release: xanadu
...
1.  Configure IBM Watson Assistant.
    ...
    3.  Select the three vertical dots icon \[Omitted image "kebab-menu.png"\] Alt text: More info icon. and select **Settings**.
