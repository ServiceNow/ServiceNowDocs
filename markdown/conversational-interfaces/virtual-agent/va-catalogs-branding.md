...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/va-catalogs-branding.html
release: yokohama
...
breadcrumb: [Catalogs and Autopilot for Virtual Agent, Configuring Virtual Agent, Virtual Agent, Conversational Interfaces]
---
...
Download Theme Builder from the ServiceNow Store and activate the plugin \(sn\_theme\_builder\). For more information, see [Activate a plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_ActivateAPlugin.md).
...
8.  Run the catalog topic in the portal chat to load its configuration and reveal any elements that need branding.
    ...
    \[Omitted image "catalog-branding-01.png"\] Alt text: Virtual Agent chat window, with highlighted links and buttons to be updated.
...
14. Repeat Steps 12 and 13 until you update all elements.
    ...
    \[Omitted image "catalog-branding-03.png"\] Alt text: Virtual Agent chat window, with highlighted links and buttons updated after changing hex color codes in Theme Builder.
...
**Parent Topic:**[Catalogs and Autopilot for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/va-catalogs.md)
