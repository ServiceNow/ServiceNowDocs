...
[ITSM Virtual Agent pre-built actionable notifications](https://www.servicenow.com/docs/access?context=itsm-actionable-notifications&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US)
