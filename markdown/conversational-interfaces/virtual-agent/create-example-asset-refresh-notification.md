...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/create-example-asset-refresh-notification.html
release: yokohama
...
Publish the Asset Refresh topic. [Change the application scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/change-application-scope-vad.md) in your instance to the same application you used to create your Asset Refresh topic. Ideally, the notification should be in the same application scope as your Virtual Agent topic.

Role required: virtual\_agent\_admin or admin

## About this task

The ServiceNow AI Platform and ITSM Virtual Agent Conversations come with pre-built actionable notifications, and you can also create your own. For more information, see [Notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/notifications.md).
...
[Associate content with the Asset Refresh notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/associate-content-example-notification.md)

**Related topics**  


[ITSM Virtual Agent pre-built actionable notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/itsm-actionable-notifications.md)
