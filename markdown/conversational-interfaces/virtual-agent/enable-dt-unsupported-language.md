...
6.  When the languages have been added, enable Dynamic Translation.
    ...
    For more information on enabling Dynamic Translation, see [Enable Dynamic Translation for languages in Virtual Agent](enable-dynamic-lang-detection.md) and [Enable translation for Now Assist applications](../../now-assist-admin/task/enable-dynamic-translation-for-now-assist-applications.md).
