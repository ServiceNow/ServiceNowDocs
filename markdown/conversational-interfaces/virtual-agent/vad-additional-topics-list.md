...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/vad-additional-topics-list.html
release: xanadu
...
For more information about ITSM pre-built topics, see [ITSM Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/itsm-virtual-agent/itsm-virtual-agent.md).
...
Name of the topic. If its Status is Available to use, select the topic to open it in the conversation builder.
