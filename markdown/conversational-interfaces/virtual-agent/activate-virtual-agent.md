...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/activate-virtual-agent.html
release: yokohama
...
Activate [additional Virtual Agent plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/additional-va-plugins.md) for related features, such as the plugins for predefined Virtual Agent topics.

-   **[Installed with Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/installed-wth-virtual-agent.md)**  
...
-   **[Additional plugins for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/additional-va-plugins.md)**  
After activating Virtual Agent, you can activate additional plugins to enable other features for conversation design.
-   **[Prebuilt Virtual Agent topics, topic blocks, and ServiceNow NLU models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/prebuilt-topics-ITSM.md)**  
