...
All input and output mappings are based on the custom skill you select. For more information on custom skills, see Now Assist Skill Kit, [Managing custom skills in Assistant Designer Asset library](../concept/managing-custom-skills.md), and [Using AI agents in Virtual Agent topics](../../now-assist-skill-kit/reference/ai-agent-custom-skill.md).
