...
2.  Select the info icon ![Blue info icon](../images/icon-info-blue.png) to open the overlay card for a topic that has a New status.
...
To return a recommendation's status to New, select the info icon ![Blue info icon](../images/icon-info-blue.png) to open the overlay card for the topic, and then select **Don't hide**.
