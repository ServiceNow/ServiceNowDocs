...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/enrol-user-softpin-device.html
release: xanadu
...
4.  In the SoftPin Verification for Amazon Connect tab, provide the soft Pin in the **Enter the SoftPIN** field and select **Submit**.
