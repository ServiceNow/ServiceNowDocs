...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/duplicate-publish-valite-topic.html
release: yokohama
...
[Preview \(test\) the pre-built ITSM Virtual Agent Lite topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/test-valite-topic.md).
