...
-   **Manual transfer to a live agent using the Contact support option**
    ...
    **Note:** Users running a Virtual Agent messaging integration must enter the command `Hi` or `agent` to access the live agent transfer option. If your environment isn't configured for live agents, the `agent` command doesn't work. For more information, see [Virtual Agent integration with messaging apps](va-integration-messaging-apps.md).
...
-   **Transfer to a live agent in Agent Workspace**
    ...
    ![Live Agent transfer displayed in the Virtual Agent web client is also displayed in Agent Workspace.](../images/workspace-agent-chat-example.png)
...
-   **Transfer to a live agent in Connect Support**
    ...
    ![Transfer to a live agent is shown in the Virtual Agent web client and in Connect Support.](../images/LiveAgentTransferExample.png)
