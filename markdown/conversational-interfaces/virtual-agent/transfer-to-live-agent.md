...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/transfer-to-live-agent.html
release: yokohama
...
-   **Automatic transfer to a live agent when an error occurs**
    ...
    **Note:** If you don't plan to use Agent Chat, be sure to deactivate it in the Agent Chat settings. For more information, see [Setting up Agent Chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/agent-chat/ac-configure-agent-chat.md).
...
-   **Transfer to a live agent in Agent Workspace**
    ...
    \[Omitted image "workspace-agent-chat-example.png"\] Alt text: Live Agent transfer displayed in the Virtual Agent web client is also displayed in Agent Workspace.
