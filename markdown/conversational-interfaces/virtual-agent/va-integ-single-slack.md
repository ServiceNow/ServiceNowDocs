...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/conversational-interfaces/virtual-agent/va-integ-single-slack.html
release: australia
...
-   **[Create a bot in Slack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/create-self-config-bot-slack.md)**  
You must create a self-configured bot in the targeted workspace in Slack to be able to integrate with the Virtual Agent.
-   **[Retrieve self-configured bot details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/setup-slack-bot-snow.md)**  
Retrieve the details of the bot that you created in the Slack workspace to integrate with the ServiceNow instance.
-   **[Integrate your ServiceNow instance with a self-configured bot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/integ-slack-self-config-bot.md)**  
Add the self-configured bot to your ServiceNow instance to complete the integration with Slack.
-   **[Manage the self-configured bot integration with Slack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/manage-slack-self-bot.md)**  
...
-   **[Remove the self-configured bot integration with Slack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/remove-slack-self-config-integ.md)**  
