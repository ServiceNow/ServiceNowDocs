---
title: Assistant Designer Asset library interface reference
description: The Assistant Designer Asset library interface lets you create, modify, test, publish, and localize topics, topic blocks, and custom controls.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/virtual-agent/vad-reference.html
release: zurich
...
# Assistant Designer Asset library interface reference
...
Assistant Designer Asset library provides the following views. Some tabs may not be available, depending on how you configured your instance or the type of topic you are working with.

-   **[Assistant Designer Asset library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/vad-topics-page.md)**  
...
-   **[Virtual Agent Designer legacy Topics page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/vad-prev-topics-page.md)**  
The Virtual Agent Designer legacy home page lists cards for available topics in your instance.
-   **[Assistant Designer Asset library All pre-built topics page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/vad-additional-topics-list.md)**  
...
-   **[Create a topic form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/vad-topic-creation-form.md)**  
...
-   **[Topic Flow tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/vad-topic-flow-tab.md)**  
...
-   **[Topic NLU Intent tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/vad-topic-nlu-intent-tab.md)**  
...
-   **[Topic Languages tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/vad-topic-languages-tab.md)**  
