...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/conversational-interfaces/virtual-agent/create-amzn-cloudformation-stack.html
release: australia
...
Provide the name of the Prompt file that you have uploaded in [Create an Amazon S3 bucket](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/create-amazon-s3-bucket.md).The Prompt file is an audio file containing the ringtone when customer connects to an agent.
...
[Claim a phone number](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/conversational-interfaces/virtual-agent/claim-phone-nmbr-ivr.md).
