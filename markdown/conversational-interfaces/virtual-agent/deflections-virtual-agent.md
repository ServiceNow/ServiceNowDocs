...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/deflections-virtual-agent.html
release: xanadu
...
**Note:** The Self-Service Analytics framework requires the Self-Service Analytics Core plugin \(com.snc.self\_service\_analytics\_core\). For more information, see .

\[Omitted image "def-metrics.png"\] Alt text: Deflection metrics for Virtual Agent deflections.

You can also view the visualization for deflection metrics in the **Overview** tab of the Conversational Analytics Dashboard. For more information, see [Legacy - Conversational Analytics Dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/VA-dashboard-landing-page.md).

-   **[Create deflection configurations and patterns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/set-up-deflection-settings-va.md)**  
