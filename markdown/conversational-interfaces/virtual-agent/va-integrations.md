...
![The Topic Properties page displaying the Additional channel support field along with the Additional channel support pop-up.](../images/va-prop-channelsup-new.png "Additional channel support field in the Topic Properties page")
...
-   **Properties** tab \(Topic Properties page\)
    ...
    ![Virtual Agent Designer topic properties page with banner message and defined channels.](../images/channel-support-prop-example1.png "Topic Properties tab with defined channels")
...
-   **Flow** tab \(Virtual Agent Designer canvas\)
    ...
    ![Virtual Agent Designer conversation builder interface, with unsupported controls for messaging channels flagged on the flow tab and detailed in a pop-up message.](../images/channel-support-canvas-example2-new.png "Topic Flow tab with channel warnings")
...
![Virtual Agent Designer Supported Channels filter in the Topics page.](../images/va-custom-channels.png "Supported Channels filter in the Topics page")
