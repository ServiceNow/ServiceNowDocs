...
1.  [Install the Virtual Agent API](../task/install-virtual-agent-api.md).
2.  [Review the inbound REST endpoint and configure inbound authentication](../task/configure-send-request.md).
3.  [Configure output response REST endpoint and outbound authentication for the Virtual Agent API \(v4.1 or following\)](../task/configure-response-endpoint-auth-va-api.md).
4.  [Test your Virtual Agent API configuration](../task/va-api-test.md).
...
-   **[Configure output response REST endpoint and outbound authentication for the Virtual Agent API \(v4.1 or following\)](../task/configure-response-endpoint-auth-va-api.md)**  
Specify the outbound endpoint URL to which the Virtual Agent responses are posted. Configure outbound authentication.
-   **[Test your Virtual Agent API configuration](../task/va-api-test.md)**  
