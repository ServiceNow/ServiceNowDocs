...
-   **[Legacy - Set the date range of the data](../task/use-the-dashboad.md)**  
...
-   **[Legacy - Using user search metrics with Virtual Agent](user-search-metrics-tab.md)**  
...
-   **[Legacy - Issue auto-resolution tab](dashboard-auto-resolution.md)**  
