---
title: Legacy - Using the Conversational Analytics Dashboard
description: Use the Conversational Analytics Dashboard to get insights into Virtual Agent \(VA\) conversations.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/use-the-dashboard-overview.html
release: yokohama
...
-   **[Legacy - Set the date range of the data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/use-the-dashboad.md)**  
...
-   **[Legacy - Overview tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/overview-tab.md)**  
Use the Overview tab to get a snapshot of some of the information collected in the Conversational Analytics dashboard.
-   **[Legacy - Usage tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/usage-tab.md)**  
The **Usage** tab provides summary information about conversations.
-   **[Legacy - Conversations tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/conversation-tab.md)**  
...
-   **[Legacy - Users tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/users-tab.md)**  
Get detailed information on Virtual Agent users such as the time of the last chat, length of the chat, and other metrics.
-   **[Topics tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/topics-tab.md)**  
Use the **Topics** tab in the Conversational Analytics dashboard to identify the least and best performing topics.
-   **[Legacy - Natural Language Understanding of Virtual Agent responses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/nlu-tab.md)**  
...
-   **[Legacy - Using user search metrics with Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/user-search-metrics-tab.md)**  
...
-   **[Legacy - Custom Events tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/custom-events-tab.md)**  
Use the Custom Events tab to see the list of custom events created for Virtual Agent.
-   **[Funnels tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/funnels-tab.md)**  
...
-   **[Legacy - Issue auto-resolution tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/dashboard-auto-resolution.md)**  
