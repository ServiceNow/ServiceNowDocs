...
-   **Why did Virtual Agent discover my topic in Spanish but not in French?**
    ...
    -   Not all topics are bound to a language-specific NLU model and intent.
        ...
        In this scenario, create a French model and intent for the topic. For more information, see [Multilingual model management](https://www.servicenow.com/docs/access?context=multilingual-model-managent&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US).
