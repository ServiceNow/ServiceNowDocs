...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/virtual-agent/va-topic-discovery-issues.html
release: zurich
...
-   **Is NLU enabled for the session language?**
    ...
    Enable the language in Natural Language Understanding \(NLU\) settings for Virtual Agent. For details, see [Enable NLU languages in Virtual Agent settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/enable-langs-va-gen-settings.md).
...
-   **Why did Virtual Agent discover my topic in Spanish but not in French?**
    ...
    -   Not all languages are supported by all NLU providers. For details, see [Language support for NLU services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/language-support-nlu-services.md).
...
-   The user is prompted for confirmation for an intent switch in mid-topic \(**Ask user if switched topic is correct** toggle switch is enabled in [NLU Settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/conversational-interfaces/virtual-agent/configure-nlu-settings.md)\).
