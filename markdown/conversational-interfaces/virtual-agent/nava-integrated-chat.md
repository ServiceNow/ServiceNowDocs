...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/virtual-agent/nava-integrated-chat.html
release: brazil
...
breadcrumb: [Chat experiences, Explore, Virtual Agent, Conversational Interfaces]
---
...
To access the ServiceNow Otto for Virtual Agent premium chat screen, select the ServiceNow Otto icon or enter text in the omnibar. \[Omitted image "image.nava-portal-screen"\] Alt text:
...
-   **Plus sign icon**
    ...
    Select the plus sign \(+\) icon to access additional options including web search and file upload.\[Omitted image "image.nava-premium-chat-add-files"\] Alt text:
...
\[Omitted image "image.nava-premium-window-controls"\] Alt text:
...
**Note:** This icon only appears in the sub-header whenever the interactive view is available.
 ...
 Open or close the interactive view. The interactive view appears to the right of the conversational chat area. The drop-down selector displays the names of all interactive views opened in the current conversation, including Knowledge Base articles, catalog forms, and org charts.Interactive view is only available in the following scenarios:
...
\[Omitted image "image.nava-premium-feedback-panel"\] Alt text:
...
**Note:** For more information about where and how to enable fallback options, see [Manage an assistant chat experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/manage-assistant-chat-experience.md).
...
\[Omitted image "image.nava-chat-widget-button-portal"\] Alt text:
