...
-   **[NLU Workbench - Advanced Features](https://www.servicenow.com/docs/access?context=nlu-workbench-advanced-features&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US)**
...
-   **[Use Virtual Agent REST API in a standalone or multi-bot environment](virtual-agent-api.md)**
