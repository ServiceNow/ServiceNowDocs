...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/design-va-topic.html
release: yokohama
...
-   **[Pre-built Virtual Agent topics, topic blocks, and ServiceNow NLU models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/prebuilt-topics-ITSM.md)**
...
-   **[Virtual Agent Topic Recommendations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/va-topic-recommendations.md)**
...
-   **Understand the design process in Virtual Agent Designer.**
    ...
    \[Omitted image "va-design-process-steps.png"\] Alt text: Choose the topic type and set topic properties, build the conversation flow, test and fine-tune the flow, and then publish your topic.
