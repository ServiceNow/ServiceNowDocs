...
## Conversational Integration with Google chat users
...
1.  [Plugins for Conversational Integration with Google chat](../reference/additional-plugins-google-chat.md)
2.  [Installing Conversational Integration with Google chat](../task/installing-ci-google-chat.md)
3.  [Integrating Virtual Agent with Google chat](../task/integrating-va-google-chat.md)
...
-   **[Plugins for Conversational Integration with Google chat](../reference/additional-plugins-google-chat.md)**  
