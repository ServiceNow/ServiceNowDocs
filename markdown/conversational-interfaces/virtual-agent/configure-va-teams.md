...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/configure-va-teams.html
release: xanadu
...
5.  Select the Manage Bot icon \[Omitted image "manage-bot-icon.png"\] Alt text: Manage Bot icon. and select **Manage Virtual Agent**.
...
6.  Select the **Branding** tab to brand your Now Virtual Agent bot.
    ...
    For more information about branding your bot, see [Configure branding for your ServiceNow Virtual Agent bot in Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/configure-msteams-branding.md).

7.  Select the **Bot Messages** tab to create and edit a bot message.

    For more information, see [Create bot messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/create-bot-messages.md).
