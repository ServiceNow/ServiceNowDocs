...
![Static Choice list of radio buttons with options to submit.](../../now-assist-in-va/image/nass-static-choice-user-prompt.png "Static Choice list prompt example")
