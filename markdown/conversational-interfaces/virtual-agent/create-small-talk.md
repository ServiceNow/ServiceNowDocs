...
**Note:** If you have activated Now Assist in Virtual Agent, you can also create small talk filters to redirect the conversation if needed. For more information, see Configure small talk filters.
