...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/va-carousel-input.html
release: yokohama
...
\[Omitted image "va-carousel-native-2.png"\] Alt text: Chat in which the prompt asks, "Select an image." The current selection shows a Virtual Agent Designer canvas.
