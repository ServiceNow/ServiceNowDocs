...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/virtual-agent/va-carousel-input.html
release: zurich
...
**Note:** The Carousel user input control is not supported in ServiceNow Otto for Virtual Agent.
...
The prompt has a maximum limit of 4,096 characters.The title and text for the image together have a character limit of 1024 characters.
