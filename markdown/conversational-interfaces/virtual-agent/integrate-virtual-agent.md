...
-   **[Creating conversational custom chat integrations in Virtual Agent](va-custom-adapter-framework.md)**  
...
-   **[Integrating Virtual Agent with Voice channels](va-integ-voice-apps.md)**  
