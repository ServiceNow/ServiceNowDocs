...
For more information about NLU entities, see [Entities](https://www.servicenow.com/docs/access?context=entities&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US). For more information about system entities, see [NLU system entities](../reference/nlu-system-entities.md).
...
3.  In the sidebar, select the Variables tab, and select the **Input** icon ![Plus icon](../images/icon-plus-clear.png).
