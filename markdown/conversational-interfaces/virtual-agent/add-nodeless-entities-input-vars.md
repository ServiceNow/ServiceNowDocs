...
For more information about NLU entities, see [Entities](https://www.servicenow.com/docs/access?context=entities&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US). For more information about system entities, see [NLU system entities](../reference/nlu-system-entities.md).
