...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/va-designer-testing.html
release: yokohama
...
\[Omitted image "va-test-ui-options-nlu-2a.png"\] Alt text: NLU/Keyword testing options are available on both the Virtual Agent Designer canvas and the Assistant Designer Asset library.
...
\[Omitted image "va-test-tabs-2.png"\] Alt text: Conversation test tabs shown in the chat test window, with Analyze test phrases, Variables, Context, and Logs options highlighted.
...
\[Omitted image "va-test-phrases-multiple-results-2.png"\] Alt text: Analyze test phrases tab, showing test phrase results for multiple intent matches.

If an utterance doesn't match a current intent, you can add or change utterances in Virtual Agent Designer. For more information, see [Modify NLU utterances and entities for a Virtual Agent topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/modify-nlu-utterances-va-topic.md).
...
\[Omitted image "va-test-variables-tab-2.png"\] Alt text: Variables tab that shows the input variables and values, next to a screen capture of the conversation flow.
...
\[Omitted image "vad-grouped-choice-variables-2.png"\] Alt text: Variables tab separated by group, with the node and Group name highlighted.
...
For more information about defining context variables, see [Configure context variables for storing chat-related information](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/ac-configure-context-variables.md). For more information about live agent variables that are included with Virtual Agent, see [Live agent chat context variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/live-agent-chat-context-vars.md).

\[Omitted image "va-cce-it-express-2.png"\] Alt text: Context tab with the context portal value of IT Express.
...
\[Omitted image "va-conv-preview-logs2a.png"\] Alt text: Logs tab that contains processing information about the topic.
...
-   **[Train and test your NLU model in Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/train-test-publish-nlu-model-vad.md)**  
...
-   **[Automated testing for Virtual Agent topics that use NLU topic discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/automated-testing-va-topics.md)**  
