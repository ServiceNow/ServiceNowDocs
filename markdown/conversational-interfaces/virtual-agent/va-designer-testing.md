...
![NLU/Keyword testing options are available on both the Virtual Agent Designer canvas and the home page.](../images/va-test-ui-options-nlu-2.png "Example NLU/Keyword test options")
