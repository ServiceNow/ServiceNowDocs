...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/test-nlu-language-model.html
release: yokohama
...
7.  On the test window, run the conversation and review the results in the test tabs.
    ...
    For more information about using the chat test window, see [Testing NLU/Keyword topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/va-designer-testing.md).
