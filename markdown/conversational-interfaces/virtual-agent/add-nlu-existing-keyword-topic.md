...
7.  Select the **NLU Intent** tab, and then add utterances and associate entities with them.
    ...
    For more information about adding utterances, see [Create an NLU intent](https://www.servicenow.com/docs/access?context=create-nlu-intent&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US). For more information about defining entities, see [Entities](https://www.servicenow.com/docs/access?context=entities&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).
