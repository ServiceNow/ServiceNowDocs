...
For more information, see [Create a Virtual Agent topic](../task/create-virtual-agent-topic.md).

## Topic Properties tab with LLM topic discovery

![The topic Properties tab is simplified when LLM is the model type.](../images/topic-properties-llm.png)

## Topic Properties tab with NLU topic discovery

![The Natural Language Understanding section appears on the topic Properties tab when NLU is the model type.](../images/topic-properties-nlu.png)
