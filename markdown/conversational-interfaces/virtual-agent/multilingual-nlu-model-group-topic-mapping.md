...
Model groups make it easier to maintain your topics. For more information about NLU model groups, see [Multilingual model management](https://www.servicenow.com/docs/access?context=multilingual-model-managent&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).
...
To allow topic discovery for the language, enable the intent in NLU Workbench. For more information, see [Enable or disable a secondary model intent](https://www.servicenow.com/docs/access?context=enable-disable-secondary-model-intent&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).
