...
-   **[Transferring Virtual Agent conversations to a live agent](transfer-to-live-agent.md)**  
...
-   **[Closing Virtual Agent and Agent Chat conversations](va-open-conversations.md)**  
