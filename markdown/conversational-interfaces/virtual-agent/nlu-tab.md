...
See [Activate the NLU Workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/activate-nlu-workbench.md) to see how to use the NLU Workbench to improve NLU predictions.
