...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/virtual-agent/va-boolean-user-input.html
release: zurich
...
|WhatsApp|Not Supported|Supported|The prompt or body text has a maximum limit of 1,024 characters.|
