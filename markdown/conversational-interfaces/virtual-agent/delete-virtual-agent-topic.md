...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/delete-virtual-agent-topic.html
release: yokohama
...
1.  If you're not working on the topic, navigate to **All** &gt; **Conversational Interfaces** &gt; **Virtual Agent** &gt; **Designer**.

2.  Use one of the following methods based on either a record on the home page or the header inside a topic.

<table id="choicetable_brb_vgj_jcc"><thead><tr><th align="left" id="d118366e154">

Method

</th><th align="left" id="d118366e157">

Description

</th></tr></thead><tbody><tr><td id="d118366e163">
