...
Use the system property **sn\_vad\_genai.utterances.count.for.topic.description** to set the maximum number of NLU utterances given to the LLM to generate the description for a migrated NLU/Keyword topic.
