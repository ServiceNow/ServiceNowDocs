...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/virtual-agent/llm-assistants.html
release: brazil
...
A primary assistant uses search sources from secondary assistants. To set up your primary and secondary assistants, see [Assistants overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/configure-now-assist-va.md).
...
-   Generative AI skills: The primary assistant uses its own activation flags regardless of the secondary assistant's configuration.
