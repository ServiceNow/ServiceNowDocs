...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/users-tab-filtering.html
release: xanadu
...
Selecting a **User Index** takes you to the [User Details page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/user-page.md) that provides detailed information about all of a user's conversations.
