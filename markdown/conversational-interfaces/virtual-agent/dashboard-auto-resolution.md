...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/dashboard-auto-resolution.html
release: yokohama
...
\[Omitted image "issue-auto-resolution-tab.png"\] Alt text: Data visualizations for this tab include intent and topic-matching results, matching and conversational trends, acceptance rate, and top topics.
