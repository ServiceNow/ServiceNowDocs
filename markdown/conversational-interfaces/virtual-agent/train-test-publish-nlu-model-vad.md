...
5.  Select **Try model**.
    ...
    ![The Try model panel showing results of testing an utterance manually.](../images/nlu-publish-model-new.png "Example of testing an utterance in the NLU Try model panel")
...
For more information on providing feedback using thumbs icons in the results, see [Test panel feedback](https://www.servicenow.com/docs/access?context=test-model-panel-feedback&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).
