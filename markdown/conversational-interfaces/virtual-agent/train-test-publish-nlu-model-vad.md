...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/train-test-publish-nlu-model-vad.html
release: xanadu
...
2.  Slide the discovery type toggle switch to **NLU/Keyword**.
...
5.  Select **Try model**.
    ...
    \[Omitted image "nlu-publish-model-new.png"\] Alt text: The Try model panel showing results of testing an utterance manually.
...
For more information on providing feedback using thumbs icons in the results, see [Test panel feedback](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/intelligent-experiences/nlu-service/test-model-panel-feedback.md).
