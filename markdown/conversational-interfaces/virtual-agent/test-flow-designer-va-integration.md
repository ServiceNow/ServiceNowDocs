...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/test-flow-designer-va-integration.html
release: yokohama
...
2.  In the Asset library, open the topic with the Action utility that you want to test.

3.  Select **Test**.

    If an action or subflow in the test window is slow to respond or appears to be waiting, you see a relevant error message.

    By default, a scheduled job checks the conversation flow every 120 seconds. For more information about scheduled jobs, see [Scheduled jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/c_ScheduledJobs.md).

    You can change this interval, as needed. To change the interval, see [Specify the action workflow timeout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/va-fdih-action-timeout.md).
