...
If the topic is not currently mapped to a model and intent, the **NLU Intent** tab is not available. Specify a model and intent on the **Properties** tab in Assistant Designer Asset library.
...
4.  Open a topic and select the **NLU Intent** tab.
