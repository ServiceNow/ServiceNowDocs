...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/modify-nlu-utterances-va-topic.html
release: yokohama
...
If the topic is not currently mapped to a model and intent, the **NLU Intent** tab is not available. Specify a model and intent on the **Properties** tab in Virtual Agent Designer.
...
3.  Open a topic and select the **NLU Intent** tab.
...
After making changes, you can [train, test, and publish the model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/train-test-publish-nlu-model-vad.md) from this tab.
