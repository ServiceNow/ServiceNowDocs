...
1.  Configure your ServiceNow instance to link it with your Alexa account.
    ...
    For more information, see [Create an OAuth API endpoint for external clients](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/authentication/t_CreateEndpointforExternalClients.md).
