...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/create-inbound-outbound-amzn-connect-flows.html
release: yokohama
...
1.  Log in to your AWS account and select **Contact Flows**.
    ...
    1.  Select the region where the Lambda function/LexBot was created.
        ...
        For more information see, [Create an Amazon S3 bucket](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/create-amazon-s3-bucket.md).
