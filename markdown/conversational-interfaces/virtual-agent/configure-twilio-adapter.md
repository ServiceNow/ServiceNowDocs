...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/configure-twilio-adapter.html
release: yokohama
...
2.  Install the following applications on your instance:
    ...
    -   Conversational SMS Service Channel
    -   Conversational SMS Integration with Twilio
3.  [Set up Twilio spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/setup-twilio.md)
...
4.  In the Twilio Console, for the phone number that you specified in Step [3](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/configure-twilio-adapter.md), update the SMS incoming web-hook.
