...
description: Enable a combination of language detection and machine translation for Virtual Agent to improve the chat experience for diverse users. You can designate fallback languages for locales or dynamically translate languages that aren't professionally localized or aren't supported in topic discovery.
locale: en-US
