...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/embed-custom-control.html
release: xanadu
...
-   [Create and publish the custom input or response control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/create-custom-control.md).
...
2.  In the Topics page, select the topic or topic block where you will add the custom control.
