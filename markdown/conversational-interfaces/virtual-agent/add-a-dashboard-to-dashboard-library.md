...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/virtual-agent/add-a-dashboard-to-dashboard-library.html
release: brazil
...
breadcrumb: [Related dashboards page, Analyze and optimize, Virtual Agent, Conversational Interfaces]
---
...
2.  Configure the dashboard visibility in Platform Analytics to include Assistant Designer. See [Configure Platform Analytics dashboard details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/config-db-in-ac.md) for more information.
3.  Share the dashboard with virtual\_agent-admin role. See [Share a Platform Analytics dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/now-intelligence/share-db-in-ac.md) for more information.
