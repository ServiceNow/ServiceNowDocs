...
For information about topic discovery, see [LLM topic discovery in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/va-llm.md).
...
As you create or update a topic in the Asset library, use the **Test** button in the topic header bar to preview the conversation. The chat test window shows the conversation as it appears within Service Portal. Elements in your conversation might appear differently in third-party messaging applications. Test your conversations in any third-party applications where you intend to deploy Virtual Agent.

The test chat window displays six tabs that provide detailed information for debugging and refining your topic: **Analysis**, **Modify instructions**, **Variables**, **Edit variables**, **Context**, and **Logs**. For details about these tabs, see [Test details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/test-llm-details.md). The following example shows the processing messages and errors logged during testing.
...
Can't see module designer under conversational interfaces
...
-   Verify that your browser is configured to permit pop-ups from your instance.
