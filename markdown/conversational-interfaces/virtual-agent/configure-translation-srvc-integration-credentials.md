...
1.  Create a credential for the translator service alias.
    ...
    -   [Create a credential for the MicrosoftTranslation alias](https://www.servicenow.com/docs/access?context=create-credential-ms-translation&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
    -   [Configure the credential for the GoogleTranslation alias](https://www.servicenow.com/docs/access?context=configure-credential-google&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
2.  Create a connection for the translator service alias.

    For detailed information, see the following topics:

    -   [Create a connection for the MicrosoftTranslation alias](https://www.servicenow.com/docs/access?context=create-connection-ms-translation&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
    -   [Configure the connection attributes for the GoogleTranslation alias](https://www.servicenow.com/docs/access?context=configure-connection-google&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
