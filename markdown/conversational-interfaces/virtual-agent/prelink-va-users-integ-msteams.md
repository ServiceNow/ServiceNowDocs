...
-   [Set up Microsoft Teams Graph spoke](https://www.servicenow.com/docs/access?context=set-up-msteams&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
-   [Set up Microsoft Active Directory spoke](https://www.servicenow.com/docs/access?context=set-up-ad&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
