...
Dynamic filter conditions for the defined recipients.The dynamic condition is applicable for both messaging and chat channels.
 ...
 Click the refresh icon \[Omitted image "refresh-icon.png"\] Alt text: next to the **records match condition** link to update the exact number of records matching the latest filter condition. By default, it shows the total number of records in the current table.
