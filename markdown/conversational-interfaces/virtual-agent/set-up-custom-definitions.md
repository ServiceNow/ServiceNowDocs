...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/set-up-custom-definitions.html
release: yokohama
...
-   End state—Defined by default in 12 ways. For more information, see [Formula override examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/formula-override-examples.md).
