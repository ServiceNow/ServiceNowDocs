...
3.  If none of the models contain intents and utterances you'd like in your setup, select **Create Model** and follow the instructions in [Create an NLU model](https://www.servicenow.com/docs/access?context=create-nlu-modelx&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US).
