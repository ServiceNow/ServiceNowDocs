...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/virtual-agent/user-search-metrics-tab-pae.html
release: xanadu
...
|Trending content|Search results that users clicked on the most. Total % refers to the number of trending search results users clicked on expressed as a percentage of total number of trending search results.|
