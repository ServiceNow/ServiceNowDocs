...
The [Key Management Framework](https://www.servicenow.com/docs/access?context=understanding-kmf&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) \(KMF\) must be installed and configured for your instance. The scoped application that uses the secure fields must also have the following:
...
-   A [Script step](https://www.servicenow.com/docs/access?context=javascript-step-action-designer&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US) in the Workflow Studio action that unwraps the password2/KMF passwords as follows:
...
For more information about password2 encryption with KMF, see [Password2 encryption with KMF](https://www.servicenow.com/docs/access?context=password-2way-encrypted-fields&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
