...
![Basic properties include node name, detail description, and input format. Advanced options include Enforce user prompt, Additional instructions to LLM, and Hide or skip this node.](../images/va-date-time-llm-2.png)
