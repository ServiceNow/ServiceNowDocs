...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/users-tab-filtering-pae.html
release: yokohama
...
|Tags|Filters users based on the tags associated with the users.|
|Updated|Filters users based on when the user record was last updated.|
|Updated by|Filters users based on who last updated the user record.|
|Updates|Filters users based on updates to a user record.|
|User|Filters users based on user name.|
|Keywords|Filters users based on keywords related to the user record.|

**Parent Topic:**[Users tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/users-tab-pae.md)
