...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/vad-prev-topics-page.html
release: yokohama
...
Filter that displays a list of topics belonging to a category that you specify. A category is a label that identifies a group of assets, such as setup topics or prebuilt topics for a particular business application.
 ...
 You can also define your own custom categories. For details, see [Create or modify custom categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/create-topic-category.md).
...
Filter that is displayed only if you're using multi-language NLU models. Lists NLU -enabled topics by the language that you select.
 ...
 Enable the languages for the NLU service in [NLU settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/conversational-interfaces/virtual-agent/configure-nlu-settings.md).
