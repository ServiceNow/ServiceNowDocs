...
5.  Select the **Synchronous** check box.
    ...
    **Note:** If the **Synchronous** field is not visible, you can [configure the form layout](https://www.servicenow.com/docs/access?context=configure-form-layout&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) to show it.
