---
title: Integrating Virtual Agent with Workplace from Facebook
description: Enable requesters to chat with Virtual Agent or live agents using the Workplace from Facebook application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/virtual-agent/mssg-workplace.html
release: yokohama
