...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/users-tab-pae.html
release: brazil
topic_type: concept
...
-   Filter the list of users based on specific conditions using the filter editor. For more information, see [\(Legacy\) Use filters in the Users tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/users-tab-filtering-pae.md)
...
-   **[\(Legacy\) Use filters in the Users tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/users-tab-filtering-pae.md)**  
