---
title: \(Legacy\) File Picker user input control
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-file-picker-nlu.html
release: brazil
...
# \(Legacy\) File Picker user input control
