---
title: \(Legacy\) Change the Virtual Agent greeting messages in the Greeting setup topic for NLU
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-welcome-topic-selection-msgs-nlu.html
release: brazil
topic_type: task
...
# \(Legacy\) Change the Virtual Agent greeting messages in the Greeting setup topic for NLU
