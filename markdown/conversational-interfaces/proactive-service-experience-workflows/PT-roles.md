...
For details on the administration of users, groups, and roles, see [User Administration](https://www.servicenow.com/docs/access?context=c_UserAdministration&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
