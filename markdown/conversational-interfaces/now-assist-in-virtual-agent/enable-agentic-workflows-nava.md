...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/now-assist-in-virtual-agent/enable-agentic-workflows-nava.html
release: zurich
...
-   Change system property:
    ...
    **Note:** Ensure your application scope is set to Otto AI Agents when making this change.
