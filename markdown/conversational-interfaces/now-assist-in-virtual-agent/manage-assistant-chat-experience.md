...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/now-assist-in-virtual-agent/manage-assistant-chat-experience.html
release: xanadu
...
1.  Manage your assistant's greeting, closing, fallback messages, streaming responses, and document uploads.
    ...
    **Note:** For Now Assist panel assistant \(Platform\), closing message, fallback options, and document uploads aren't supported. For Now Assist panel assistant \(Developer\), closing message, fallback options, document uploads, and response streaming aren't supported.
    ...
    \[Omitted image "NAinVA-chat-exp1-052025.png"\] Alt text: Greeting, closing,fallback options, streaming responses, and document uploads for your Virtual Agent in the Define your chat experience page.
    ...
    In the **Document uploads** section, **Allow document uploads** is turned off by default. If you select the check box, users can upload documents in the chat and ask questions about the content or get a summary. For more information on file formats for uploading files to an assistant, see [Upload documents in Now Assist in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/now-assist-in-virtual-agent/upload-documents-na-va.md).
    ...
    **Note:** For Now Assist panel assistants \(Platform and Developer\), the available setup topic types are Greeting, Fallback, Error, and Explore help.
    ...
    \[Omitted image "NAinVA-chat-exp-adv-052025.png"\] Alt text: Advanced chat settings in the Define your chat experience page.
    ...
    In the **Promoted assets** tab, navigate to Virtual Agent Designer to define promoted assets for this assistant. Promoted assets appear as suggested assets for users to launch after they receive the assistant's greeting. For more information on promoting assets in Virtual Agent Designer, see [Promote or demote LLM topics in Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/virtual-agent/promote-demote-va-topics.md)

    \[Omitted image "NAinVA-promoted-assets-052025.png"\] Alt text: Link to Virtual Agent Designer to define promoted assets.
    ...
    \[Omitted image "NAinVA-chat-promo-reorder2-052025.png"\] Alt text: List of promoted topics that can be reordered.
    ...
    \[Omitted image "NAinVA-closed-chats-052025.png"\] Alt text: Check box to allow users to view past chat history.
...
[Review assistant settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/now-assist-in-virtual-agent/review-assistant-settings.md).
