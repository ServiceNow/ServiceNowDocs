...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/now-assist-in-virtual-agent/suggested-actions.html
release: xanadu
...
\[Omitted image "NASS-dynamic-window-suggested-actions.png"\] Alt text: Suggested actions of block calendar and notify teammates appear under the Here's what you can do next header.
