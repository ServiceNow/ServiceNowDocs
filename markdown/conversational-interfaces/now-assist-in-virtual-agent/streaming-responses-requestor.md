...
To enable streaming, configure your AI assistants to stream responses during the Now Assist in Virtual Agent guided setup. For more information, see [Configuring Now Assist in Virtual Agent](../../now-assist-in-va/task/configure-now-assist-va.md).
