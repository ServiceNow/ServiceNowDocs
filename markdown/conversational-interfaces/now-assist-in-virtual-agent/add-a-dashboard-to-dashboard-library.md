...
2.  Configure the dashboard visibility in Platform Analytics to include Assistant Designer. See Configure Platform Analytics dashboard details for more information.
3.  Share the dashboard with virtual\_agent-admin role. See Share a Platform Analytics dashboard for more information.
