...
2.  Configure the dashboard visibility in Platform Analytics to include Assistant Designer. See [Configure Platform Analytics dashboard details](https://www.servicenow.com/docs/access?context=config-db-in-ac&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US) for more information.
3.  Share the dashboard with virtual\_agent-admin role. See [Share a Platform Analytics dashboard](https://www.servicenow.com/docs/access?context=share-db-in-ac&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US) for more information.
