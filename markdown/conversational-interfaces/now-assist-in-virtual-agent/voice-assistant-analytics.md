...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/now-assist-in-virtual-agent/voice-assistant-analytics.html
release: yokohama
...
\[Omitted image "NAinVA-assistant-designer-analytics-voice.png"\] Alt text: Voice dashboard page in Assistant analytics.
...
-   **Total voice conversations**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-voice-total-conv.png"\] Alt text: Total voice conversations.
...
-   **Total voice conversations deflected**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-voice-total-deflect.png"\] Alt text: Total voice conversations deflected.
...
-   **Conversations transferred to a live agent**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-voice-conv-live-agent.png"\] Alt text: Conversations transferred to a live agent
...
-   **Number of tickets created**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-voice-tickets-created.png"\] Alt text: Number of tickets created.
...
-   **Conversations disconnected**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-voice-conv-disconnect.png"\] Alt text: Conversations disconnected.
...
-   **Inferred customer satisfaction \(CSAT\) score**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-voice-inferred-csat.png"\] Alt text: Inferred customer satisfaction \(CSAT\) score.
...
-   **Average voice conversation duration**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-voice-average-duration.png"\] Alt text: Average voice conversation duration.
...
-   **Deflection by AI agent**
    ...
    \[Omitted image "NAinVA-assistant-designer-analytics-voice-number-deflect.png"\] Alt text: Deflection by AI agent.
