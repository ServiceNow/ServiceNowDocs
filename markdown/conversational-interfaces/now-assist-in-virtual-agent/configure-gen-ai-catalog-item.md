...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/conversational-interfaces/now-assist-in-virtual-agent/configure-gen-ai-catalog-item.html
release: yokohama
...
2.  Enable the generative AI experience for a catalog item request submission in Virtual Agent.
    ...
    2.  Select a catalog item that must be requested in the conversation mode.
        ...
        For information about catalog items that are supported in the conversation mode, see [Service Catalog topic blocks in Virtual Agent powered by Now LLM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/service-catalog/request-topic-blocks-va-llm.md).
...
<table id="choicetable_omj_3fl_lzb"><thead><tr><th align="left" id="d71498e313">

Option

</th><th align="left" id="d71498e316">

Description

</th></tr></thead><tbody><tr><td id="d71498e322">
...
</td></tr><tr><td id="d71498e361">

**Build additional logic in a new subflow. For example, to refer to a new record producer for each business.**

</td><td>

1.  Create a subflow to return the sys\_id of a record producer. For information about Flow Designer subflows, see [Building subflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/workflow-studio/subflows.md).
...
[Service Catalog topic blocks in Virtual Agent powered by NLU](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/service-catalog/request-topic-blocks-va.md)

[Service Catalog topic blocks in Virtual Agent powered by Now LLM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/service-catalog/request-topic-blocks-va-llm.md)
