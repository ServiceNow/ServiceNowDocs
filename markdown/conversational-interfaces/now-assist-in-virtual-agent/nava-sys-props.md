...
Hide the popover for inactive catalog items for ServiceNow Otto for Virtual Agent and ServiceNow Otto panel's enhanced chat. The default value is `false`.
