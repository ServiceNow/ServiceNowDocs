...
**Note:** For more information about how Now Assist in Virtual Agent and Now Assist in AI Search intertwine to include these suggestion type-ahead searches, see .
...
-   Predefined web sources external content connector
    ...
    **Note:** For the list of predefined web sources you can crawl using this external connector, see .
