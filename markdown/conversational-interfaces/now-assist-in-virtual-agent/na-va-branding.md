...
For more information about Now Assist in Virtual Agent, see [Now Assist in Virtual Agent](../concept/now-assist-in-va-landing.md) and [Configuring Now Assist in Virtual Agent](configure-now-assist-va.md).
