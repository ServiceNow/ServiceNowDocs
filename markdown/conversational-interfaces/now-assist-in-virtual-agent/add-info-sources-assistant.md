...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/conversational-interfaces/now-assist-in-virtual-agent/add-info-sources-assistant.html
release: zurich
...
1.  Assign search sources to your chat assistant.
    ...
    **Note:** By default, portals and mobile apps that use enhanced chat with a dynamic, movable, and resizable chat window inherit the search sources assigned to the assistant, as listed in the following table. This configuration helps ensure that answers returned in portals and mobile apps are consistent with those returned by the assistant.
    ...
    To edit the setting, select **Manage Search Profile**. The AI Search Admin console launches. For more information, see [Configure multi-content synthesized sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/configure-multi-content-synthesis-sources.md).
