...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/now-assist-in-virtual-agent/llm-assistants.html
release: xanadu
...
Alternatively, you can make a topic discoverable on the home page once you create an LLM topic and associate it with an assistant. Select the More actions on this row icon \[Omitted image "kebab-menu.png"\] Alt text: More actions icon. next to your topic, and then select **Discoverable**. A checkmark appears by the text to indicate the topic is now discoverable.

\[Omitted image "llm-setup-topic-included-discovery.png"\] Alt text: Included in topic discovery must be turned on if you want LLM setup topics to be discoverable when working with LLM assistants.
...
A primary assistant uses search sources from secondary assistants. To set up your primary and secondary assistants, see [Configuring Now Assist in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/now-assist-in-virtual-agent/configure-now-assist-va.md).
