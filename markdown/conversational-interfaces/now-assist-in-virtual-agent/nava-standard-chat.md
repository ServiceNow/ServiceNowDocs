...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/now-assist-in-virtual-agent/nava-standard-chat.html
release: xanadu
...
For information about configuring a Now Assist skill, see [Activate a Now Assist skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/intelligent-experiences/enable-ai-experiences/configure-a-now-assist-skill.md).
...
\[Omitted image "carousel-nds-cards-na-va.png"\] Alt text: Summary of the laptop options along with catalog options to either Go to request or Start request in the Virtual Agent.
...
\[Omitted image "NAinVA-autolaunch.png"\] Alt text: An LLM-generated message appears before auto-executing the first step in the action.
