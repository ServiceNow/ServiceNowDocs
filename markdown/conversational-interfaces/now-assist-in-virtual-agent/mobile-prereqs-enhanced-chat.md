...
For information on choosing how you want Now Assist in Virtual Agent to display on your mobile app, see . To understand the differences between Now Assist in Virtual Agent standard and enhanced chat experiences, see [Using Now Assist in Virtual Agent](using-now-assist-in-va.md).
...
Admins must select the mobile search conﬁguration to be used. For more information, see [Display your assistant on a portal or channel](../task/display-assistant-portal-channel.md).
