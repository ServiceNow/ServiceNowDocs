...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/now-assist-in-virtual-agent/create-assistant.html
release: xanadu
...
1.  Select the ellipsis to turn on, off, edit, or delete an assistant.
    ...
    **Note:** The default Now Assist in Virtual Agent assistant can't be deleted. You can delete any other assistant that you create. The default Now Assist panel assistants \(Platform and Developer\) can't be deleted. New Now Assist panel assistants can't be created.
    ...
    \[Omitted image "NAinVA-assistants-052025.png"\] Alt text: Table with list of assistants.

    The Relationship type column shows whether an assistant is a primary or secondary assistant, or neither. For more information about primary and secondary assistants, see [LLM assistants](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/now-assist-in-virtual-agent/llm-assistants.md).

    To view the linkage between primary and secondary assistants, you can toggle between the list view and the map view.

    \[Omitted image "NAinVA-view-mapNOV.png"\] Alt text: View primary and secondary assistants as a list or map view.
    ...
    \[Omitted image "NAinVA-mapping.png"\] Alt text: Map view of primary assistants and their associated secondary assistants.
...
2.  Create a Virtual Agent assistant by selecting **Create new**.
    ...
    **Note:** The **Name** and **Description** fields, and the ability to link to other assistants are read-only for Now Assist panel assistants.
    ...
    \[Omitted image "NAinVA-get-started2-NOV.png"\] Alt text: Virtual Agent Name and Description fields in the Get started page.
    ...
    \[Omitted image "NAinVA-link-assistantNOV.png"\] Alt text: Drop-down list showing all available secondary assistants.
