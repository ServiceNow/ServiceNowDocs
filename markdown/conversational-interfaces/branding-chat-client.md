...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/conversational-interfaces/branding-chat-client.html
release: xanadu
...
-   **Colors and fonts**
    ...
    \[Omitted image "ChatWindowLabels.png"\] Alt text: Elements of the Virtual Agent interface including category, links, button background, menu buttons, and input background.
...
-   **Chat menu items**
    ...
    \[Omitted image "SupportMenuCallouts.png"\] Alt text: Contact support information displayed in the default Contact support menu in the web chat window.


-   **[Create a new user for a branded bot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/ci-create-new-branded-bot.md)**  
...
-   **[Set up your Virtual Agent bot's branding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/conversational-interfaces/ac-configure-chat-branding.md)**  
