...
-   **Colors and fonts**
    ...
    ![Elements of the Virtual Agent interface including category, links, button background, menu buttons, and input background.](../image/ChatWindowLabels.png "UI items in the chat window")
...
-   **Chat menu items**
    ...
    ![Contact support information displayed in the default Contact support menu in the web chat window.](../image/SupportMenuCallouts.png "Chat menu")
