---
title: \(Legacy\) Create an automated test in Virtual Agent Designer
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/create-automated-test-vad.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 2
keywords: [Automated, Test, Virtual Agent, designer, om.glide.cs.atf]
breadcrumb: [Automated testing for NLU topics, Testing NLU and keyword topics, Build and deploy NLU conversations, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Create an automated test in Virtual Agent Designer
...
**Note:** You can find a list of NLU/Keyword test cases by selecting the **Manage NLU/Keyword test cases** toggle switch on the Assistant Designer Asset library page. Automated tests are also listed on the Automated Test Framework \(ATF\) Tests \[sys\_atf\_test\] table. For more information on managing NLU/Keyword test cases, see [\(Legacy\) Manage and run automated test cases in Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/manage-automated-test-cases.md)
...
**Parent Topic:**[\(Legacy\) Automated testing for Virtual Agent topics that use NLU topic discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/automated-testing-va-topics.md)
