---
title: \(Legacy\) Grouped Choice user input control
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-grouped-choice-user-input-nlu.html
release: brazil
...
# \(Legacy\) Grouped Choice user input control
