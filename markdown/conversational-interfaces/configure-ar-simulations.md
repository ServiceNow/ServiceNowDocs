---
title: \(Legacy\) Configure and run an Issue Auto Resolution simulation
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/configure-ar-simulations.html
release: brazil
topic_type: task
...
# \(Legacy\) Configure and run an Issue Auto Resolution simulation
