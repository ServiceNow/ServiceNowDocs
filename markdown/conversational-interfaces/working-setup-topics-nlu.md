---
title: \(Legacy\) Working with NLU setup topics
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/working-setup-topics-nlu.html
release: brazil
topic_type: concept
last_updated: "2026-09-10"
reading_time_minutes: 6
breadcrumb: [Customizing an NLU chat experience, Configure NLU, \(Legacy\) Virtual Agent for NLU, Conversational Interfaces]
---

# \(Legacy\) Working with NLU setup topics
