...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/enable-async-mode-secondary-sn-bot.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 1
breadcrumb: [Synchronous or asynchronous mode, Using ServiceNow Virtual Agent as a secondary bot, Virtual Agent Bot Interconnect, Conversational Interfaces]
---
