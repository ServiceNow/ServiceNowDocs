---
title: \(Legacy\) Set up message authentication for Alexa
description: Define a token in your ServiceNow instance to set up a message authentication with your Alexa account.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/setup-message-auth-alexa.html
release: brazil
topic_type: task
...
# \(Legacy\) Set up message authentication for Alexa
