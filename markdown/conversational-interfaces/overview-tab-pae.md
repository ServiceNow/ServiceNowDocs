...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/overview-tab-pae.html
release: brazil
topic_type: concept
...
**Note:** ServiceNow Otto for Virtual Agent Analytics appears in the left navigation only when you have ServiceNow Otto for Virtual Agent enabled.
