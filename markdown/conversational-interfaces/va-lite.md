---
title: \(Legacy\) Virtual Agent Lite
description: Virtual Agent Lite is a limited version of Virtual Agent that is available to ITSM standard customers.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/va-lite.html
release: brazil
topic_type: concept
...
For Brazil, the Virtual Agent Designer features available in Virtual Agent Lite include the following:
...
-   Control topic discovery and visibility.
    ...
    For more information about using these options, see [Control topic discovery and visibility](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/manage-topics-task.md).
...
Set up and configure Virtual Agent Lite. For details, see [\(Legacy\) Quick start for Virtual Agent Lite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/quick-start-va-lite.md).
