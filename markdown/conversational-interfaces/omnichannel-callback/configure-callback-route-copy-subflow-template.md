...
4.  Select the \[Omitted image "icon-ellipses.png"\] Alt text: More actions menu more actions icon, and select **Copy subflow**.
    ...
    To learn more, see [Copy a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/copy-subflow.md).
...
7.  Create a Workflow Studio Subflow action to make third-party API calls and publish the subflow.
    ...
    To learn more, see [Building actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/actions.md).
