---
title: \(Legacy\) Create Virtual Agent NLU notifications
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/create-va-notifications-nlu.html
release: brazil
topic_type: task
...
# \(Legacy\) Create Virtual Agent NLU notifications
...
-   [\(Legacy\) Create additional recipients for Virtual Agent NLU notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/create-additional-recipients-nlu.md).
-   [\(Legacy\) Define Virtual Agent NLU notification contents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/define-va-notif-contents-nlu.md).
