---
title: \(Legacy\) Configuring sensitive data handler
description: Detect and mask sensitive information that is shared in Agent Chat or Virtual Agent conversations.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/ac-configure-sensitive-data-handling.html
release: brazil
topic_type: task
...
# \(Legacy\) Configuring sensitive data handler
