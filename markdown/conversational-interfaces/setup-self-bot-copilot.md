...
description: Using your Self-configured bot with Microsoft Copilot for ServiceNow Otto conversations requires you to complete a few additional setup actions.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/conversational-interfaces/setup-self-bot-copilot.html
release: brazil
topic_type: concept
last_updated: "2026-09-10"
reading_time_minutes: 3
keywords: [Integrating, ServiceNow Otto, Virtual Agent, Microsoft, Copilot, Conversational Integration, Teams, MSTeams, sn\_va\_teams]
...
For more information on Microsoft Teams and ServiceNow Otto in Virtual Agent installation and settings, see [.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/ms-copilot-na-va.md)
...
-   Activate your assistant in the Conversational Interfaces configuration page. For more information, see [Assistants overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/configure-now-assist-va.md).
-   Migrate any relevant topics to the Now LLM Service for ServiceNow Otto large language model \(LLM\) conversations with Copilot. To migrate your topics to LLM, you must enable LLM. For more information, see [Migrate NLU topics to LLM topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/virtual-agent/migrate-nlu-llm.md).
-   Update the following fields within the manifest file that is downloaded from Admin experience to configure the Self-configured bot. You can update your agent's description and update its prompts if it has any unique capabilities.
    ...
    For example, you may LLM skills for scenarios unique to your environment, such as reserving a hotel desk or ordering food for a meeting. Add those skills to your description to help Copilot recognize the skill and process it.
...
**Parent Topic:**[Integrating ServiceNow Otto for Virtual Agent with Microsoft Copilot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/ms-copilot-na-va.md)
