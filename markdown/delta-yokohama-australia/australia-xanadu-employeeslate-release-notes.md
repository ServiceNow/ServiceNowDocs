---
title: Combined Employee Slate release notes for upgrades from Xanadu to Australia
description: Consolidated page of all release notes for Employee Slate from Xanadu to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-yokohama-australia/australia-xanadu-employeeslate-release-notes.html
release: australia
...
# Combined Employee Slate release notes for upgrades from Xanadu to Australia

Consolidated page of all release notes for Employee Slate from Xanadu to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Employee Slate release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Australia.
...
-   **[Conversation-first experience](https://www.servicenow.com/docs/access?context=eslate-conversation-first&family=zurich&ft:locale=en-US)**
...
-   **[Tasks and requests](https://www.servicenow.com/docs/access?context=emp-slate-inbox&family=zurich&ft:locale=en-US)**
...
-   **[Notifications](https://www.servicenow.com/docs/access?context=emp-slate-notifications&family=zurich&ft:locale=en-US)**
...
-   **[Configure admin console](https://www.servicenow.com/docs/access?context=eslate-config-admin-console&family=zurich&ft:locale=en-US)**
...
-   **[Employee Slate for Moveworks](https://www.servicenow.com/docs/access?context=employee-slate-moveworks&family=australia&ft:locale=en-US)**
