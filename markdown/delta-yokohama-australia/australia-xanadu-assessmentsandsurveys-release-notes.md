---
title: Combined Assessments and Surveys release notes for upgrades from Xanadu to Australia
description: Consolidated page of all release notes for Assessments and Surveys from Xanadu to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-yokohama-australia/australia-xanadu-assessmentsandsurveys-release-notes.html
release: australia
...
# Combined Assessments and Surveys release notes for upgrades from Xanadu to Australia

Consolidated page of all release notes for Assessments and Surveys from Xanadu to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Assessments and Surveys release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Australia.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Assessments and Surveys to Australia
...
Between your current release family and Australia, new features were introduced for Assessments and Surveys.
...
Between your current release family and Australia, some changes were made to existing Assessments and Surveys features.
...
Between your current release family and Australia, some Assessments and Surveys features or functionality were removed.
...
Between your current release family and Australia, some Assessments and Surveys features or functionality were deprecated.
...
Review information on how to activate Assessments and Surveys.
...
If any additional requirements were introduced or changed for Assessments and Surveys we have noted them here.
...
If any specific browser requirements were introduced or changed for Assessments and Surveys we have noted them here.
...
Review details on accessibility information for Assessments and Surveys, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Assessments and Surveys we have noted them here.
...
If there are specific highlight considerations for Assessments and Surveys we have noted them here.
