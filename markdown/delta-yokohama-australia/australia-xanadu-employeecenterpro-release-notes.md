...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-yokohama-australia/australia-xanadu-employeecenterpro-release-notes.html
release: australia
...
# Combined Employee Center Pro release notes for upgrades from Xanadu to Australia

Consolidated page of all release notes for Employee Center Pro from Xanadu to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Employee Center Pro release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Australia.
