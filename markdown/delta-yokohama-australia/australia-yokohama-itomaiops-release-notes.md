---
title: Combined ITOM AIOps release notes for upgrades from Yokohama to Australia
description: Consolidated page of all release notes for ITOM AIOps from Yokohama to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/delta-yokohama-australia/australia-yokohama-itomaiops-release-notes.html
release: australia
...
# Combined ITOM AIOps release notes for upgrades from Yokohama to Australia

Consolidated page of all release notes for ITOM AIOps from Yokohama to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family ITOM AIOps release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Australia.
...
**Important:** [Agent Client Collector](https://www.servicenow.com/docs/access?context=agent-client-collector-rn&family=yokohama&ft:locale=en-US), [Health Log Analytics](https://www.servicenow.com/docs/access?context=health-log-analytics-rn&family=yokohama&ft:locale=en-US), and [Install ServiceNow Operations Workspace \(ITOM\)](https://www.servicenow.com/docs/access?context=install-sow-itom-apps&family=yokohama&ft:locale=en-US) are available in the ServiceNow Store. For details, see the "Activation information" section of these release notes.
