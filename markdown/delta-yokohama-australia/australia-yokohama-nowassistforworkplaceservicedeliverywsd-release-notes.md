---
title: Combined Now Assist for Workplace Service Delivery \(WSD\) release notes for upgrades from Yokohama to Australia
description: Consolidated page of all release notes for Now Assist for Workplace Service Delivery \(WSD\) from Yokohama to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-yokohama-australia/australia-yokohama-nowassistforworkplaceservicedeliverywsd-release-notes.html
release: australia
...
# Combined Now Assist for Workplace Service Delivery \(WSD\) release notes for upgrades from Yokohama to Australia

Consolidated page of all release notes for Now Assist for Workplace Service Delivery \(WSD\) from Yokohama to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Now Assist for Workplace Service Delivery \(WSD\) release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Australia.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Now Assist for Workplace Service Delivery \(WSD\) to Australia
...
Between your current release family and Australia, new features were introduced for Now Assist for Workplace Service Delivery \(WSD\).
...
Between your current release family and Australia, some changes were made to existing Now Assist for Workplace Service Delivery \(WSD\) features.
...
Between your current release family and Australia, some Now Assist for Workplace Service Delivery \(WSD\) features or functionality were removed.
...
Between your current release family and Australia, some Now Assist for Workplace Service Delivery \(WSD\) features or functionality were deprecated.
...
Review information on how to activate Now Assist for Workplace Service Delivery \(WSD\).
...
Install Now Assist for Workplace Service Delivery \(WSD\) by requesting it from ServiceNow Store. 
...
If any additional requirements were introduced or changed for Now Assist for Workplace Service Delivery \(WSD\) we have noted them here.
...
If any specific browser requirements were introduced or changed for Now Assist for Workplace Service Delivery \(WSD\) we have noted them here.
...
Review details on accessibility information for Now Assist for Workplace Service Delivery \(WSD\), such as specific requirements or compliance levels.
...
If there are specific localization considerations for Now Assist for Workplace Service Delivery \(WSD\) we have noted them here.
...
If there are specific highlight considerations for Now Assist for Workplace Service Delivery \(WSD\) we have noted them here.
...
-   Help manage workplace reservations for updating existing event planning reservations. This team of AI agents retrieve the reservation from workplace case details, analyze the reservation, and update the workplace case notes.
 ...
 See [Now Assist for Workplace Service Delivery \(WSD\)](https://www.servicenow.com/docs/access?context=now-assist-wsd-landing&family=yokohama&ft:locale=en-US) for more information.
...
[Zurich Patch 7](https://www.servicenow.com/docs/access?context=zurich-patch-7&family=zurich&ft:locale=en-US): Summarize workplace cases by using Now Assist for WSD.
...
-   Optimize a maintenance case based on the space utilization rate of the location where a maintenance case is created using the optimize cleaning activities agentic workflow.
 ...
 See [Now Assist for Workplace Service Delivery \(WSD\)](https://www.servicenow.com/docs/access?context=now-assist-wsd-landing&family=zurich&ft:locale=en-US) for more information.
