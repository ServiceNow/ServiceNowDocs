---
title: Combined Advanced Work Assignment \(AWA\) release notes for upgrades from Yokohama to Australia
description: Consolidated page of all release notes for Advanced Work Assignment \(AWA\) from Yokohama to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/delta-yokohama-australia/australia-yokohama-advancedworkassignmentawa-release-notes.html
release: australia
...
# Combined Advanced Work Assignment \(AWA\) release notes for upgrades from Yokohama to Australia

Consolidated page of all release notes for Advanced Work Assignment \(AWA\) from Yokohama to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Advanced Work Assignment \(AWA\) release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Australia.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Advanced Work Assignment \(AWA\) to Australia
...
Between your current release family and Australia, new features were introduced for Advanced Work Assignment \(AWA\).
...
-   **[Advanced Work Assignment](https://www.servicenow.com/docs/access?context=awa-application-landing-page&family=australia&ft:locale=en-US)**
...
Between your current release family and Australia, some changes were made to existing Advanced Work Assignment \(AWA\) features.
...
Between your current release family and Australia, some Advanced Work Assignment \(AWA\) features or functionality were removed.
...
Between your current release family and Australia, some Advanced Work Assignment \(AWA\) features or functionality were deprecated.
...
Review information on how to activate Advanced Work Assignment \(AWA\).
...
**Important:** AWA is available in the ServiceNow Store. For details, see the "Activation information" section of these release notes.
...
If any additional requirements were introduced or changed for Advanced Work Assignment \(AWA\) we have noted them here.
...
If any specific browser requirements were introduced or changed for Advanced Work Assignment \(AWA\) we have noted them here.
...
Review details on accessibility information for Advanced Work Assignment \(AWA\), such as specific requirements or compliance levels.
...
If there are specific localization considerations for Advanced Work Assignment \(AWA\) we have noted them here.
...
If there are specific highlight considerations for Advanced Work Assignment \(AWA\) we have noted them here.
