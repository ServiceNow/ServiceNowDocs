---
title: Combined Now Assist for Customer Service Management \(CSM\) release notes for upgrades from Xanadu to Australia
description: Consolidated page of all release notes for Now Assist for Customer Service Management \(CSM\) from Xanadu to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-yokohama-australia/australia-xanadu-nowassistforcustomerservicemanagementcsm-release-notes.html
release: australia
...
-   **[Suggested steps in Recommended Actions](https://www.servicenow.com/docs/access?context=suggested-steps-generation-in-now-assist-for-customer-service-management-csm&family=xanadu&ft:locale=en-US)**
...
-   **[Triage cases agentic workflows enhancements](https://www.servicenow.com/docs/access?context=case-resolving-use-case&family=xanadu&ft:locale=en-US)**
...
-   **[Triage cases AI agents use case](https://www.servicenow.com/docs/access?context=csm-ai-agents-use-cases&family=xanadu&ft:locale=en-US)**
...
-   **[Summarizing sidebar conversations](https://www.servicenow.com/docs/access?context=summarize-sidebar-conversations&family=xanadu&ft:locale=en-US)**

Use Now Assist for CSM to summarize sidebar discussions between agents, requesters, and subject matter experts.

-   **[Real-time chat reply recommendations](https://www.servicenow.com/docs/access?context=generate-chat-reply-recommendations&family=xanadu&ft:locale=en-US)**
...
-   **[Generative AI-powered email reply recommendations](https://www.servicenow.com/docs/access?context=generate-email-reply-recommendations&family=xanadu&ft:locale=en-US)**
...
-   **[Multilingual support for Now Assist for CSM skills](https://www.servicenow.com/docs/access?context=now-assist-csm-supporting-info&family=xanadu&ft:locale=en-US)**
...
-   **[Now Assist for CSM Gen AI security directives](https://www.servicenow.com/docs/access?context=configure-chat-summarization-in-now-assist_0&family=yokohama&ft:locale=en-US)**
...
-   **[Now Assist for CSM genAI security directives](https://www.servicenow.com/docs/access?context=configure-chat-summarization-in-now-assist_0&family=zurich&ft:locale=en-US)**
...
-   **[Enhancement in post-call summarization](https://www.servicenow.com/docs/access?context=summarize-a-call-by-using-now-assist-for-customer-service-management-csm&family=xanadu&ft:locale=en-US)**
...
-   **[Knowledge generation from multiple cases](https://www.servicenow.com/docs/access?context=Now-Assist-generate-article-csm-workspace&family=xanadu&ft:locale=en-US)**
...
-   **[Enhancements in chat summarization](https://www.servicenow.com/docs/access?context=now-assist-csm-summarize-chat&family=xanadu&ft:locale=en-US)**
...
-   **[Enhancements in Email recommendation](https://www.servicenow.com/docs/access?context=generate-email-reply-recommendations&family=xanadu&ft:locale=en-US)**
...
-   **[Enhancement in Resolution notes generation](https://www.servicenow.com/docs/access?context=now-assist-csm-generate-resolution&family=xanadu&ft:locale=en-US)**
...
-   **[Enhancements in Knowledge generation](https://www.servicenow.com/docs/access?context=Now-Assist-generate-article-csm-workspace&family=xanadu&ft:locale=en-US)**

Revise the content in existing knowledge articles by using the Now Assist icon \[Omitted image "icon-ai-sparkle.png"\] Alt text:, which is accessible as an inline capability, and create and refine knowledge articles. You can also generate knowledge articles in multiple languages.

-   **Xanadu Patch 7 [Case summarization enhancement](https://www.servicenow.com/docs/access?context=customize-a-now-assist-for-csm-skill&family=xanadu&ft:locale=en-US)**
...
Now Assist features are available with activation of the Now Assist for CSM plugin. For more information, see [Install Now Assist plugins](https://www.servicenow.com/docs/access?context=install-now-assist-feature-plugins&family=xanadu&ft:locale=en-US).
...
Now Assist features are available with activation of the Now Assist for CSM plugin. For more information, see [Install Now Assist plugins](https://www.servicenow.com/docs/access?context=install-now-assist-feature-plugins&family=yokohama&ft:locale=en-US).
...
Now Assist features are available with activation of the Now Assist for CSM plugin. For more information, see [Install Now Assist plugins](https://www.servicenow.com/docs/access?context=install-now-assist-feature-plugins&family=zurich&ft:locale=en-US).
...
-   Summarize records to make it easier to hand off calls between agents and help improve customer satisfaction.
 ...
 See [Now Assist for Customer Service Management \(CSM\)](https://www.servicenow.com/docs/access?context=now-assist-csm&family=xanadu&ft:locale=en-US) for more information.
...
-   Use the Now Assist panel global skill search to ask questions and fetch answers from knowledge articles.
 ...
 See [Now Assist for Customer Service Management \(CSM\)](https://www.servicenow.com/docs/access?context=now-assist-csm&family=yokohama&ft:locale=en-US) for more information.
...
-   Additional role configuration is required for agentic workflows and AI agents included with Now Assist applications.
 ...
 [Zurich Patch 1](https://www.servicenow.com/docs/access?context=zurich-patch-1&family=zurich&ft:locale=en-US) Enable security in Now Assist for CSM and AI agents and agentic workflows by enforcing access control lists \(ACLs\) and user identity-based permissions.
...
-   Use Google Gemini and Anthropic Claude on AWS as AI model providers for Now Assist skills and AI agents in addition to Now LLM Service and Azure OpenAI.
 ...
 See [Now Assist for CSM](https://www.servicenow.com/docs/access?context=now-assist-csm&family=zurich&ft:locale=en-US) for more information.
