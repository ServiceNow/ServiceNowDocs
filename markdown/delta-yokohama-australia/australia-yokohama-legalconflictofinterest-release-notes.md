---
title: Combined Legal Conflict of Interest release notes for upgrades from Yokohama to Australia
description: Consolidated page of all release notes for Legal Conflict of Interest from Yokohama to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/delta-yokohama-australia/australia-yokohama-legalconflictofinterest-release-notes.html
release: australia
...
# Combined Legal Conflict of Interest release notes for upgrades from Yokohama to Australia

Consolidated page of all release notes for Legal Conflict of Interest from Yokohama to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Legal Conflict of Interest release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Australia.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Legal Conflict of Interest to Australia
...
Between your current release family and Australia, new features were introduced for Legal Conflict of Interest.
...
-   **[Configure risk assessment](https://www.servicenow.com/docs/access?context=lsd-coi-config-risk-fac&family=zurich&ft:locale=en-US)**
...
-   **[Configure risk assessment](https://www.servicenow.com/docs/access?context=lsd-coi-config-risk-fac&family=australia&ft:locale=en-US)**
...
Between your current release family and Australia, some changes were made to existing Legal Conflict of Interest features.
...
Between your current release family and Australia, some Legal Conflict of Interest features or functionality were removed.
...
Between your current release family and Australia, some Legal Conflict of Interest features or functionality were deprecated.
...
Review information on how to activate Legal Conflict of Interest.
...
If any additional requirements were introduced or changed for Legal Conflict of Interest we have noted them here.
...
If any specific browser requirements were introduced or changed for Legal Conflict of Interest we have noted them here.
...
Review details on accessibility information for Legal Conflict of Interest, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Legal Conflict of Interest we have noted them here.
...
If there are specific highlight considerations for Legal Conflict of Interest we have noted them here.
...
Disclose conflicts of interest using natural language from Now Assist in Virtual Agent rather than having to fill out intake forms. The risk assessment utility then automatically evaluates each submission and routes it to the appropriate approval workflow, enabling faster resolution.
 ...
 See [Legal Conflict of Interest](https://www.servicenow.com/docs/access?context=legal-conflict-of-interest-landing-page&family=zurich&ft:locale=en-US) for more information.
