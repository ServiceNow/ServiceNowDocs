...
-   Enjoy flexibility to add business outcomes, re-prioritize objectives, and adapt to the needs of your organization​.
    ...
    Impact phases and deliverables are accessible using the Impact Digital Experience \(IDE\), the interactive portal where you access your Impact tools and benefits. See [Impact Digital Experience](impact-digital-experience.md) for more information.

    For information about Guided, Advanced, and Total packages, see [Impact packages](../reference/impact-packages.md).
