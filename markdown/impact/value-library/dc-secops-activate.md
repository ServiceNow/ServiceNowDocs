...
breadcrumb: [Impact Value Management Data Collection Content Pack for SecOps, Data Collection Toolkit, Value Management, Impact Delivery Instance \(formerly Impact Digital Experience\), Impact]
---

# Activate Data Collection for SecOps
...
1.  Navigate to **Performance/PlatformAnalytics** &gt; **Data Collector** &gt; **Jobs**, and then open **Impact VM – SecOps - Monthly Data Collection**.
...
4.  Navigate to **Performance/Platform Analytics** &gt; **Dashboard**, and then open **Impact VM – SecOps**.

    There are two tabs: Monthly – SecOps and Quarterly – SecOps.

5.  To validate the scores on the dashboard, compare them with the numbers you get from applying the same filter conditions on the fact table.

6.  To run historical jobs, do the following:

    1.  Navigate to **Performance/Platform Analytics** &gt; **Data Collector** &gt; **Jobs**, and then open **Impact VM – SecOps – Historical Data Collection**.
    ...
    3.  Navigate to **Platform Analytics** &gt; **Dashboard**, and then open **Impact VM – SecOps**.
