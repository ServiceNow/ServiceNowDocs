...
|--------------|-----------|
|**Report header**|Displays the total value realized figure, product, date range, and comparison period.|
|**Executive summary**|Space for your Impact squad to add commentary and context.|
|**Value realized per objective**|Breaks down the total value by objective, showing each objective's contribution.|
|**Outcome contributions**|Shows the observation data, operational value calculation, business value, and the inputs and assumptions used to derive the monetized figure for each outcome.|
|**About this outcome and metric**|Describes what the outcome measures, its business context, and the metric used to track it.|
