...
The HAM Success Metric Definitions in this application rely on another application. Ensure that the required plugins are installed if they are not already installed. For more information, see [Install Data Collection Content Pack dependent plugins](dc-install-plugins.md).
...
2.  Navigate to **All** &gt; **Impact Workspace** &gt; **Business Value** &gt; **PA Data Collection Jobs**.
    ...
    ![Menu in product with All > Impact Workspace > Business Value > PA Data Collection Jobs selected.](../image/dct_install_all.png)
