...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/value-library/dc-spm-config.html
release: yokohama
...
1.  Navigate to **Performance/PlatformAnalytics** &gt; **Scoresheet**, and then select **Impact VM - Legacy SPM Systems Annual Run-Rate**.
