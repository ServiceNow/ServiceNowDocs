...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/value-library/dc-itom-config.html
release: yokohama
...
breadcrumb: [Impact Value Management Data Collection Content Pack for ITOM, Data Collection Toolkit, Value Management, Impact Delivery Instance \(formerly Impact Digital Experience\), Impact]
---
...
8.  For the Manual Indicators, add a new data point every month.
    ...
    As an example, given the fixed nature of the Impact VM - Legacy ITOM Systems Annual Run-Rate indicator, you only need to enter this data point once.
