...
breadcrumb: [Impact Value Management Data Collection Content Pack for IRM, Data Collection Toolkit, Value Management, Impact Delivery Instance \(formerly Impact Digital Experience\), Impact]
---
...
1.  Navigate to **Performance/Platform Analytics** &gt; **Data Collector** &gt; **Jobs**, and then open **Impact VM – IRM - Monthly Data Collection**.
...
4.  Navigate to **Platform Analytics** &gt; **Dashboard**, and then open **Impact VM – IRM**.

    There are two tabs: Monthly – IRM and Quarterly – IRM.
...
6.  To run historical jobs, do the following:
    ...
    1.  Navigate to **Performance/Platform Analytics** &gt; **Data Collector** &gt; **Jobs**, and then open **Impact VM – IRM – Historical Data Collection**.
    ...
    3.  Navigate to **Platform Analytics** &gt; **Dashboard**, and then open **Impact VM – IRM**.
