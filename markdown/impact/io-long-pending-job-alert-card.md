...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/io-long-pending-job-alert-card.html
release: yokohama
topic_type: task
...
You can also set alert card for pending jobs. For more information, see [Configure long pending jobs alert by job priority](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/impact/io-long-pending-jobs.md).
