...
7.  [Run the Service Bridge pre-configuration scan](https://www.servicenow.com/docs/bundle/zurich-impact/page/product/impact/task/perform_pre_configuration_health_checks_impact_store_app.html)
...
-   **[Initiate the connection to the Impact Delivery Instance with manual registration](initiate-the-connection-impact-delivery-instance.md)**  
