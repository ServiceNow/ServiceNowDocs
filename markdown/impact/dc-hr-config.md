...
9.  For the Manual Indicators, add a new data point every month.
    ...
    As an example, given the fixed nature of the Impact VM - Legacy HR Systems Monthly Run-Rate indicator, you only need to enter this data point once.
    ...
    **Important:** If you do not have full access to Performance/Platform Analytics through a Pro or Enterprise subscription, you are required to enter this data point every month.
    ...
    1.  Navigate to **Performance/Platform Analytics** &gt; **Scoresheet**, and then select **Impact VM - Legacy HR Systems Monthly Run-Rate**.
