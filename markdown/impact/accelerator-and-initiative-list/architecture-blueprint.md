...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/accelerator-and-initiative-list/architecture-blueprint.html
release: yokohama
...
breadcrumb: [Architecture Accelerators, Accelerator catalog, Initiatives &amp; Accelerators, Impact]
---
...
-   **Alignment Customer Meeting \(up to 90 minutes\)**
    ...
    -   Request the completion of an intake questionnaire, and any other necessary inputs. See the [Requested information/access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/impact/accelerator-and-initiative-list/architecture-blueprint.md) section for examples.
...
<table id="table_ip2_4pq_dsb"><thead><tr><th>
...
ServiceNow Platform Architect \(Required\)

</td><td>

Responsible for overall ServiceNow platform architecture, strategy, and governance.

</td></tr><tr><td>

ServiceNow Platform Administrator \(Required\)
...
Maintains the accuracy and integrity of the CMDB configuration data; works with teams to certify data.
...
Responsible for overall management and maintenance of ServiceNow data.

</td></tr><tr><td>

Foundational Data Manager \(Recommended\)

</td><td>

Responsible for the subset of foundational data \(e.g. Users, Groups, Locations, Companies, Departments, etc.\).

</td></tr><tr><td>

Integration Data Owner \(Recommended\)

</td><td>

Responsible for one or more integrations \(e.g. applications being integrated, data being passed, data flow, process flow, etc.\).
...
Responsible for one or more projects \(applications being integrated, data being passed, data flow, process flow, etc.\). Define and communicate project where data can be impacted for quality, security and risk.

</td></tr><tr><td>

ServiceNow Development Lead \(Recommended\)

</td><td>

Leads development on the ServiceNow platform.

</td></tr><tr><td>

IT Risk and Compliance Lead \(Recommended\)

</td><td>

Ensures the organization's security protocols and best practices are followed within the ServiceNow platform.
...
Responsible for designing, building, testing, and implementing security systems within an organization's IT network.

</td></tr><tr><td>

Application Owner / Manager \(Recommended\)

</td><td>

Owns and defines data and process flows for a particular process / product \(aka application\).

</td></tr><tr><td>

Master Services Provider / Delivery Vendor Lead \(Recommended\)

</td><td>

Leads 3rd party development and / or delivery services.
