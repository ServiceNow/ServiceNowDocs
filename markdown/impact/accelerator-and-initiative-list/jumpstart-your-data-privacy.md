...
-   **Session Preparation**
    ...
    -   Activate and configure necessary plugins
-   **Customer Coaching Session \#1 \(up to 1.5 hours\)**

    Includes the following:

    -   Overview of Data Privacy in the ServiceNow Vault
    -   Applied demonstration of Data Privacy features:
        -   Data Discovery
        -   Data Classification
        -   Data Anonymization
...
-   **Customer Coaching Session \#2 \(Optional upon Customer request up to 1 hour\)**
    ...
    Opportunity for Q&amp;A related to Data Privacy.
...
|Security Administrators|Establish and enforce governance policies so all IT projects adhere to architecture standards, promoting consistency and alignment with organizational objectives.|✓| |
