...
Example Expert Connect Activities

</th></tr></thead><tbody><tr><td>

Questions regarding the configuration of a specific ServiceNow Application

</td><td>

Answer a specific technical how-to question presented by the customer.

 Provide guidance on how an application may be able to help address a Customer pain point.
...
Provide guidance on ways to approach building Customer-specific reports.
...
-   **Question submission \(Customer\)**
    ...
    The question must be a specific technical how-to question with sufficient detail to enable the Impact Accelerator Consultant to prepare for the session.
