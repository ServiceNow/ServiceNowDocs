...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/impact/accelerator-and-initiative-list/access-expertise.html
release: xanadu
...
breadcrumb: [Access to Expertise, Initiatives catalog, Initiatives &amp; Accelerators, Impact Digital Experience, Impact]
---
...
2.  On the form, Set up initiative, fill in the fields.

    |Field|Description|
    |-----|-----------|
    |Initiative title|Topic title|
    |Start date|Requested start date|
    |When do you need this by?|Preferred resolution date|
    |Related business objective|Impact objective selected from the drop-down|
    |Stakeholder group|Available for selection if stakeholder groups are enabled and configured|
    |Instance type|Select if multiple instance types are available, such as production or sub-production|
...
3.  Select a **Primary category** on the form, What do you need help with?.
...
6.  Select the technical lead and other important contacts to include for the request on the next form, Who else should be involved?.
...
8.  Monitor the status and the related tasks in **Impact** &gt; **Initiatives &amp; Accelerators** &gt; **Your initiatives**.
