...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/accelerator-and-initiative-list/multi-instance-topologies.html
release: yokohama
...
Service Owner\(s\) \(Recommended\)

</td><td>

Responsible for data and process flows related to a specific service, process, or an integration.
