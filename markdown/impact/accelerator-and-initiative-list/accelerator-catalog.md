...
-   Refer to [Impact releases](impact-releases.md) to access the release notes to identify the most recently added or updated Accelerators.
...
|[On-Demand Value Report](../reference/on-demand-value-report.md)|✓|![Green check mark icon](../image/dark-green-checks.png)| | | |
...
|[Value Potential](../reference/value-potential-undeployed-apps.md)| |✓|✓|✓|![Green check mark icon](../image/dark-green-checks.png)|
