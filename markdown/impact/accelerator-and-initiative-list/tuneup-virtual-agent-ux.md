---
title: TuneUp Your Virtual Agent – UX \(User Experience\)
description: The TuneUp Your Virtual Agent – UX \(User Experience\) Accelerator provides guidance on fine-tuning Virtual Agent conversations to optimize value.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/impact/accelerator-and-initiative-list/tuneup-virtual-agent-ux.html
release: xanadu
...
breadcrumb: [TuneUp Your Virtual Agent, Technical Accelerators, Accelerator catalog, Initiatives &amp; Accelerators, Impact Digital Experience, Impact]
---

# TuneUp Your Virtual Agent – UX \(User Experience\)

The TuneUp Your Virtual Agent – UX \(User Experience\) Accelerator provides guidance on fine-tuning Virtual Agent conversations to optimize value.
...
See [Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/conversational-interfaces/virtual-agent/virtual-agent-landing-page.md) for additional information on Virtual Agent.
...
-   **Virtual Agent User Experience Assessment**
    -   Provisioning of a temporary instance
    -   Activating or upgrading and configuring necessary plugins
    -   Assessing the Virtual Agent user experience
-   **Customer Coaching Session \#1 \(up to 90 minutes\)**
    ...
    -   Conversational Design leading practices
    -   Designing effective conversations
    -   Demonstration of conversational design leading practices
    -   Prescriptive guidance on how to enhance experience
-   **Customer Coaching Session \#2 \(Optional upon Customer request, up to 60 minutes\)**

    Opportunity for Questions and Answers related to Virtual Agent user experience


## Requested Customer Resources

<table id="table_wqw_dyd_fsb"><thead><tr><th>
