...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/impact/accelerator-and-initiative-list/preventive-care.html
release: australia
...
**Note:** Preventive Care is an add-on package available for all Impact customers with activation. Large or complex ServiceNow implementations may benefit from quarterly \(instead of bi-annual\) reviews. For further details contact your Impact Customer Success Manager for additional information.
...
System Administrator\(s\) \(Recommended\)
...
Subject Matter Expert\(s\) \(Recommended\)

</td><td>

Non-developers with strong knowledge of processes who are a candidate for Citizen Development.

</td></tr></tbody>
</table>## Exclusions and Limitations

Preventive Care is limited to the following:

-   Preventive Care activities are performed bi-annually \(however this can be increased to quarterly, if required, at an additional cost\).
