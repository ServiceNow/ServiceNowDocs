...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/accelerator-and-initiative-list/access-experts-acc.html
release: yokohama
...
The Access to Experts Accelerator applies to a selected set of requestable topics:
...
For examples of requests or additional information on the request process, see [Request Access to Expertise](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/impact/accelerator-and-initiative-list/access-expertise.md).
...
**Important:** Impact customers must provide sufficient detail and context related to the requested topic at least one week in advance of the session to allow the  ServiceNow   Request Owner to prepare.
...
This Accelerator doesn’t include:

-   Resolving active support cases.
