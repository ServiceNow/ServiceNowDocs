...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/accelerator-and-initiative-list/csdm-assessment-foundation-data-advanced.html
release: yokohama
...
-   **Introductory Customer Session \(up to 120 minutes\)**
    ...
    -   Communicate expectation for Customer participation
        ...
        **Note:** The CSDM - Foundation Data Assessment initiative requires active customer participation, and may require inclusion of a variety of customer roles to address the breadth of the CSDM Foundation Data’s application across the organization.
...
Application Service Owner\(s\) \(Optional\)
