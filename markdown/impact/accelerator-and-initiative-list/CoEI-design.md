...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/impact/accelerator-and-initiative-list/CoEI-design.html
release: xanadu
...
Refer to the [Customer Success Center](https://www.servicenow.com/success/playbook/center-excellence-innovation-coei.html) for additional information about the CoEI.
...
-   **Customer discovery sessions workshops \(up to 12 hours\)**
...
-   **Implementation plan workshop \(up to 2 hours\)**
    -   Co-develop a plan to implement the recommended CoEI structure
    -   Outline of resources and risks
    -   Assistance with measuring the progress and effectiveness of the plan
