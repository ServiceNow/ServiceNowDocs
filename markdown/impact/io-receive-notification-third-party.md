...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/io-receive-notification-third-party.html
release: yokohama
topic_type: task
...
For Third-party integrations, webhook URLs may expire if a subscription is not renewed, or API keys may be invalid over time. Your integration credentials must be up to date to avoid missed alert deliveries.
...
Webhook URL as configured on your third-party \(external\) application.For more information, see [Create a scripted REST API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/rest-api-explorer/t_CreateAScriptedRESTService.md)
