...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/io-receive-notification-customer-conf-webhook.html
release: yokohama
product: Impact
...
For more information, see [Create a scripted REST API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/rest-api-explorer/t_CreateAScriptedRESTService.md)
