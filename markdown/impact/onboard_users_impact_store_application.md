...
8.  After assigning users to groups, select **Mark as complete**.

    This will complete user setup for the Impact Store App and unlock the next step in Guided Setup. If you select **Close**, you will return to Guided Setup and other steps are locked until the Impact User assignment is marked as complete.
