...
8.  Exit the Edit Dashboard mode to view the dashboard.
    ...
    For more information, see [Performance insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-performance-insights.md).
