...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/impact/configuring-sn-integration-options.html
release: australia
topic_type: task
