...
4.  [Assign users to Scan Engine groups](../task/assign-users-scan-engine-groups.md)  
...
7.  [Run the Service Exchange pre-configuration scan](../task/perform_pre_configuration_health_checks_impact_store_app.md)  
...
8.  [Use automated registration to connect to the Impact Delivery Instance](../task/start-automated-registration-IDI.md)  
...
9.  [Verify Impact data connection](../task/verify-impact-data-connection.md)  
...
10. [Initiate data migration from IDI](../task/initiate-migration-idi.md)  
...
11. [Grant temporary instance access to your Impact Squad](../task/hop-access-impact-squad.md)  
