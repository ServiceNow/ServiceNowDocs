...
2.  Assign users to groups.
    ...
    Refer to [Use Guided Setup to onboard users to the Impact Store Application](onboard_users_impact_store_application.md) for information about role assignment.
