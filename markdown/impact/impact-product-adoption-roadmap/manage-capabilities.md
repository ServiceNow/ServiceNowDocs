...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/impact-product-adoption-roadmap/manage-capabilities.html
release: yokohama
...
breadcrumb: [Capabilities maps, Product Adoption, Impact Delivery Instance \(formerly Impact Digital Experience\), Impact]
---
...
You can view and update the statuses of capabilities that can be used in your instance, as well as hide and unhide capabilities. No specific role is required to view capabilities maps.
