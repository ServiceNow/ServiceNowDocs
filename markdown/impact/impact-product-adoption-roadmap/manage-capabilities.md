...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/impact/impact-product-adoption-roadmap/manage-capabilities.html
release: xanadu
...
breadcrumb: [Capabilities maps, Product Adoption, Impact Digital Experience, Impact]
---
...
4.  Update the status for one or more capabilities.
    ...
    2.  Bulk update: Select the check box for multiple capabilities, then select a status from the **Change Status** button.
        ...
        \[Omitted image "bulk-update-caps.png"\]
