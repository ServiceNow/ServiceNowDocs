...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/impact/impact-product-adoption-roadmap/create-product-adoption-roadmap.html
release: zurich
...
-   Evaluate the capabilities currently in **Planning**, **Implementing**, **In Use**, **Not in Use**, **No Intent to Use**, and **Needs Validation**.  
-   Add or remove capabilities as needed to align with business outcomes specific to your organization.
...
<table id="choicetable_ncv_thk_s2c"><thead><tr><th align="left" id="d87162e177">

How do you want to start?

</th><th align="left" id="d87162e180">

Actions

</th></tr></thead><tbody><tr><td id="d87162e186">

**Create from a Template**

</td><td>

1.  Select **Create from a template**.
2.  Select a template in the **Choose a template** section.
...
7.  Select a capability to view its details page, and to view or edit phase level notes.
    ...
    Select the **About** tab to view capability notes and phase specific notes for that capability. See [Capability Details Page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/impact/impact-product-adoption-roadmap/capability-details.md).
...
12. Select **Edit** to edit a published roadmap to manage the adoption phases and capabilities.
