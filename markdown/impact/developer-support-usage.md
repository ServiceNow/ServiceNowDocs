...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/impact/developer-support-usage.html
release: zurich
topic_type: concept
...
-   **Users:**
    ...
    **Note:** See [Manage Developer Support user access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/impact/manage-developer-support-user-access.md) to designate users.
