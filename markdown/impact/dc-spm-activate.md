...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/impact/dc-spm-activate.html
release: australia
topic_type: task
...
1.  Navigate to **Performance/PlatformAnalytics** &gt; **Data Collector** &gt; **Jobs**, and then open **Impact VM – SPM - Monthly Data Collection**.
...
4.  Navigate to **Performance/Platform Analytics** &gt; **Dashboard**, and then open **Impact VM – SPM**.

    There are two tabs: Monthly – SPM and Quarterly – SPM.
...
6.  To run historical jobs, do the following:
    ...
    1.  Navigate to **Performance/Platform Analytics** &gt; **Data Collector** &gt; **Jobs**, and then open **Impact VM – SPM – Historical Data Collection**.
    ...
    3.  Navigate to **Platform Analytics** &gt; **Dashboard**, and then open **Impact VM – SPM**.
