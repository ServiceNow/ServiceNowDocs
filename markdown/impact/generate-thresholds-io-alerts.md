...
11. While editing an Alert Configuration, select **Change Alert Count**.![](../image/change-alert-count.png)

12. Select a maximum alert value of up to five and select **Submit**.![](../image/change-alert-count-config.png)
