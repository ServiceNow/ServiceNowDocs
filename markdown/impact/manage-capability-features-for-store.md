...
breadcrumb: [Manage Capabilities Map, Impact Store Application product adoption, Using Impact Store Application, Impact Store Application, Impact]
---
...
Explore resources related to each capability that guide you through every step of adopting the capability, from planning to implementation.
...
Restore one or more hidden capabilities to the **Capabilities** map by selecting the**Unhide** button.
