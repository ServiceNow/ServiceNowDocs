...
- [Impact]()
  ...
  - [Configuring Impact](configuring-impact.md)
    ...
    - [Configure the Impact Store Application](configuring-impact-platform.md)
      ...
      - [Perform pre-configuration scans](perform_pre_configuration_health_checks_impact_store_app.md)
    ...
    - [Manage Impact users](ide-user-management.md)
  ...
  - [Using Impact]()
        ...
        - [Scan Engine integrations](instance-integration-scan-engine.md)
          - [Register your instance](register-your-instance.md)
            ...
            - [Configure the OAuth authentication method](configure-oauth-auth-method.md)
              - [Finalize OAuth configuration](finalize-oauth-config.md)
        ...
        - [Accelerator catalog](accelerator-and-initiative-list/accelerator-catalog.md)
          - [Architecture Accelerators](accelerator-and-initiative-list/architecture-accelerators.md)
            ...
            - [Common Service Data Model (CSDM) Assessment Accelerators](accelerator-and-initiative-list/CSDM-assessment.md)
              - [Foundation Data - Advanced](accelerator-and-initiative-list/csdm-assessment-foundation-data-advanced.md)
              - [Application Services (Crawl) - Advanced](accelerator-and-initiative-list/csdm-assessment-application-services-crawl-adv.md)
              - [Technical Services (Walk) - Advanced](accelerator-and-initiative-list/csdm_assessment_technical_services.md)
              - [Business Services (Run) - Advanced](accelerator-and-initiative-list/csdm_assessment_business_services.md)
              - [CSDM Assessment - Total](accelerator-and-initiative-list/CSDM-assessment-total.md)
          ...
          - [Technical Accelerators](accelerator-and-initiative-list/technical-accelerators.md)
            ...
            - [TuneUp Your Virtual Agent](accelerator-and-initiative-list/tuneup-your-virtual-agent.md)
              ...
              - [UX (User Experience)](accelerator-and-initiative-list/tuneup-virtual-agent-ux.md)
    ...
    - [Consumption Report](ide-consumption-report.md)
      - [Gen AI based consumption report summarization](ide-consumption-report.md)
  ...
  - [Impact reference]()
    ...
    - [Use manual registration to IDI](use_manual_registration_configure_impact_store_application.md)
      ...
      - [Finalize the connection to IDI](connect-instance-impact-store-app.md)
