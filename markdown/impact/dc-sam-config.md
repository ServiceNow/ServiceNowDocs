...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/impact/dc-sam-config.html
release: australia
topic_type: task
...
1.  Navigate to **Performance/Platform Analytics** &gt; **Scoresheet**, and then select **Impact VM - \# of material security breaches due to vulnerable SW**.
