...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/impact/impact-scan-engine-overview.html
release: zurich
topic_type: concept
...
For more information, see [Scan Engine definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/impact/scan-engine-definitions.md).
...
See [Run your first scan with the Scan Engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/impact/run-scan-engine.md) for first time setup.
...
**Note:** See [Configure update set scanning properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/impact/update-set-scanning-properties.md) for details.
...
Scan applications to identify definition findings before publishing to the application repository. **Note:** See [Initiate application scans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/impact/initiating-on-demand-scans-scan-engine.md)for details.

</td></tr></tbody>
</table>## Configuration overview

For more information on configuring and running the Scan Engine, see [Running on-demand scans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/impact/using-impact-scan-engine.md), and [Analytics Dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/impact/scan-engine-diagnostic-dashboards.md).
