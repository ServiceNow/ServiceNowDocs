...
If the account has been locked out, see [Recover from account lockout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/recover-from-account-lockout.md).
