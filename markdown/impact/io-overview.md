...
<table id="table_ct2_mhj_rhc"><thead><tr><th>
...
Performance: Lookback date range
...
Starter alert types and conditions

</td><td>

All alert types and conditions
...
✓ \(Email, SMS, ServiceNow, third-party integrations\). Unlimited notifications
...
✓ \(10 per day per user per instance\)
...
✓ \(Daily Performance Metrics Report, Custom Performance Report, Database Growth Report, Encryption Report\)
...
✓ \(also get Performance Trends Report\)
