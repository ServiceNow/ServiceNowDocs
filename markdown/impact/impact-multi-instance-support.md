...
For additional information about multi-instance support, see [Cross-instance application trust configuration](https://www.servicenow.com/docs/access?context=grant-access-v2&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
