...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/impact/io-long-pending-jobs.html
release: yokohama
topic_type: task
...
2.  Log in to Instance Observer and navigate to **Alerts** &gt; **Configure Alerts**.
    ...
    For more information on how to configure alerts, see [Configure Key Alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/impact/configuring-io-alerts.md).
