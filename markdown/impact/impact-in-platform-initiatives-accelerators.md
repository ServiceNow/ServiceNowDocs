...
You must update the content app by selecting **Update** on the information displayed on-screen, to use all the available accelerators and initiatives. It might take up to an hour for the update to reflect.

Use the Quick links to access the complete catalog directly from in the store app. The Overview page provides a summary of available Accelerators and Initiatives, usage status, and an option to request additional Accelerators and Initiatives.

## Consumption

Analyze the current consumption of Accelerators and Initiatives available to you. View their current state and filter by categories. This section is defaulted to display Accelerators and Initiatives by all categories, but can be updated to show specific categories. Examine the number currently in use in relation to the limit that can be used simultaneously.

## Your list

View the full list of the Accelerators and Initiatives available to you as shown in the overall consumption chart.
