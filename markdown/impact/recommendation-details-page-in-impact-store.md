...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/impact/recommendation-details-page-in-impact-store.html
release: australia
topic_type: concept
...
-   **Delete** for deleting a selected work item.
-   **Open Link** to view the selected work item on the SPM or the CWM workspace.
