...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/impact/dc-ham-config.html
release: australia
topic_type: task
...
1.  Navigate to **Performance/Platform Analytics** &gt; **Scoresheet**, and then select **Legacy HAM Systems Annual Run-Rate**.
...
**Parent Topic:**[Impact Value Management Data Collection Content Pack for HAM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/impact/data-collection-ham.md)
