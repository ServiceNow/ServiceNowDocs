...
-   **[Anomaly insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/addl-inf-io-anomaly.md)**  
The reference topic gives additional information for anomaly charts.
-   **[Feature availability based on package](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-feature-availability.md)**  
...
-   **[Auriga Intelligent Alert report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/auriga-intelligent-report.md)**  
...
-   **[Transaction or response metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-core-performance-metrics.md)**  
The metrics provide a performance snapshot of classic UI transactions within the ServiceNow AI Platform®.
-   **[Database performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-database-performance-metrics.md)**  
The metrics provide the database performance snapshot within the ServiceNow AI Platform®.
-   **[Semaphores performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-semaphores-performance-metrics.md)**  
The metrics provide the key performance indicators calculated at the instance level for the selected duration.
-   **[Event queues performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-events-performance-metrics.md)**  
The metrics provide the event performance snapshot within the ServiceNow AI Platform®.
-   **[ECC Queue performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-ecc-queue-perf-metrics.md)**  
The metrics provide the ECC Queue performance snapshot within the ServiceNow AI Platform®.
-   **[Email performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-emails-performance-metrics.md)**  
The metrics provide the Email performance snapshot within the ServiceNow AI Platform®.
-   **[Scheduler performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-schedulers-perf-metrics.md)**  
The metrics provide the Schedulers performance snapshot within the ServiceNow AI Platform®.
-   **[Job details performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-job-details-perf-metrics.md)**  
The metrics provide the job details performance snapshot within the ServiceNow AI Platform®.
-   **[Node health performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-node-health-perf-metrics.md)**  
The metrics provide the node health performance snapshot within the ServiceNow AI Platform®.
-   **[Host health performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-host-health-perf-metrics.md)**  
The metrics provide the host health performance snapshot within the ServiceNow AI Platform®.
-   **[Standby replication Lag](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-standby-replica-lag.md)**  
...
-   **[Pool Replication Lag](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-pool-replica-lag.md)**  
...
-   **[Chat details performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-chat-details.md)**  
...
-   **[Cluster details performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-cluster-details.md)**  
The metrics provide the cluster details and Encryption status snapshot within the ServiceNow AI Platform®.
-   **[Load balancer performance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-load-balancer.md)**  
The metrics provide the load balancer performance snapshot within the ServiceNow AI Platform®.
-   **[User information metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/io-user-info-metrics.md)**  
The metrics provide the user information performance snapshot within the ServiceNow AI Platform®.
-   **[Instance Data Replication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/impact/instance-observer-metrics.md)**  
