---
title: Combined Service Portal release notes for upgrades from Zurich to Brazil
description: Consolidated page of all release notes for Service Portal from Zurich to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-zurich-brazil/brazil-zurich-serviceportal-release-notes.html
release: brazil
...
# Combined Service Portal release notes for upgrades from Zurich to Brazil

Consolidated page of all release notes for Service Portal from Zurich to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Service Portal release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Zurich to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Service Portal to Brazil
...
Between your current release family and Brazil, new features were introduced for Service Portal.
...
-   **[Enable identifier-first login in Service Portal](https://www.servicenow.com/docs/access?context=identifier-first-login-service-portal&family=brazil&ft:locale=en-US)**

Use an identifier-first login \(IFL\) authentication method in Service Portal where the authentication path is determined by the username or email entered, and evaluated against configured IFL policies.


</td></tr></tbody>
</table>## Changes

Between your current release family and Brazil, some changes were made to existing Service Portal features.
...
Between your current release family and Brazil, some Service Portal features or functionality were removed.
...
Between your current release family and Brazil, some Service Portal features or functionality were deprecated.
