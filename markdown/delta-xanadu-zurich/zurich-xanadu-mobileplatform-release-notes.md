---
title: Combined Mobile Platform release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for Mobile Platform from Xanadu to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-xanadu-zurich/zurich-xanadu-mobileplatform-release-notes.html
release: zurich
...
# Combined Mobile Platform release notes for upgrades from Xanadu to Zurich

Consolidated page of all release notes for Mobile Platform from Xanadu to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Mobile Platform release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Mobile Platform to Zurich
...
Between your current release family and Zurich, new features were introduced for Mobile Platform.
...
-   **[Now Assist for Mobile Agent app](https://servicenow-staging.fluidtopics.net/access?context=now-assist-agents-mobile&family=xanadu&ft:locale=en-US)**
...
-   **[User criteria permissions](https://servicenow-staging.fluidtopics.net/access?context=roles-user-criteria&family=xanadu&ft:locale=en-US)**
...
-   **[Mobile App Builder](https://servicenow-staging.fluidtopics.net/access?context=mab-concept&family=xanadu&ft:locale=en-US)**
...
Between your current release family and Zurich, some changes were made to existing Mobile Platform features.
...
-   **[Now Assist for Virtual Agent enhancements](https://servicenow-staging.fluidtopics.net/access?context=now-assist-mobile-va&family=xanadu&ft:locale=en-US)**
...
-   **[Now Assist in AI Search on Mobile](https://servicenow-staging.fluidtopics.net/access?context=now-assist-mobile-search&family=xanadu&ft:locale=en-US)**
...
-   **[Two new button instances](https://servicenow-staging.fluidtopics.net/access?context=sg-studio-button-instances&family=xanadu&ft:locale=en-US)**
...
-   **[Mobile client scripting enhancements](https://servicenow-staging.fluidtopics.net/access?context=config-autofil-inputs-nptfrmscrn&family=xanadu&ft:locale=en-US)**

Streamline input form screen completion with auto-filled inputs based on one or many user inputs.

-   **[Navigation bar enhancement](https://servicenow-staging.fluidtopics.net/access?context=config-badge-counts-nav-bars&family=xanadu&ft:locale=en-US)**

Add badging capability to navigation bar tabs, which enables badging on any navigation tab icons.

-   **[Configure mobile apps to use device date/time formats](https://servicenow-staging.fluidtopics.net/access?context=config-apps2use-devicedatetimeform&family=xanadu&ft:locale=en-US)**
...
-   **[Hide the seconds display in date/time fields](https://servicenow-staging.fluidtopics.net/access?context=hide-secs-mobcds-recscreen-actstrem&family=xanadu&ft:locale=en-US)**
...
-   **[Configure an external authentication browser for iOS apps](https://servicenow-staging.fluidtopics.net/access?context=config-ext-auth-browser-ios&family=xanadu&ft:locale=en-US)**
...
-   **[Search in a ServiceNow instance with Siri shortcuts](https://servicenow-staging.fluidtopics.net/access?context=siri-shortcuts&family=xanadu&ft:locale=en-US)**
...
-   **[Notification tab enhancements](https://servicenow-staging.fluidtopics.net/access?context=sg-mobile-tab-bar&family=xanadu&ft:locale=en-US)**
...
-   **[Mobile Publishing enhancements and changes](https://servicenow-staging.fluidtopics.net/access?context=mobile-publishing&family=xanadu&ft:locale=en-US)**
...
Between your current release family and Zurich, some Mobile Platform features or functionality were removed.
...
Between your current release family and Zurich, some Mobile Platform features or functionality were deprecated.
...
-   Dynamically auto-fill inputs based on user selections on input form screens.
 ...
 See [Mobile Platform](https://servicenow-staging.fluidtopics.net/access?context=mobile-config-navigation&family=xanadu&ft:locale=en-US) for more information.
