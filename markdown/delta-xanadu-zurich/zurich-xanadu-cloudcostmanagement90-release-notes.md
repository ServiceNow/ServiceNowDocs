---
title: Combined Cloud Cost Management 9.0 release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for Cloud Cost Management 9.0 from Xanadu to Zurich.
locale: en-US
...
# Combined Cloud Cost Management 9.0 release notes for upgrades from Xanadu to Zurich

Consolidated page of all release notes for Cloud Cost Management 9.0 from Xanadu to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Cloud Cost Management 9.0 release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Zurich.
