---
title: Combined Agent experience for CSM release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for Agent experience for CSM from Xanadu to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-xanadu-zurich/zurich-xanadu-agentexperienceforcsm-release-notes.html
release: zurich
...
# Combined Agent experience for CSM release notes for upgrades from Xanadu to Zurich
...
-   **[Email enhancements](https://servicenow-staging.fluidtopics.net/access?context=csm-front-line-case-page-modeless-dialogs&family=xanadu&ft:locale=en-US)**
...
-   Open the Compose Email modeless dialog with the last saved email draft.
 ...
 See [CSM Configurable Workspace](https://servicenow-staging.fluidtopics.net/access?context=csm-workspaces-configure&family=xanadu&ft:locale=en-US) for more information.
