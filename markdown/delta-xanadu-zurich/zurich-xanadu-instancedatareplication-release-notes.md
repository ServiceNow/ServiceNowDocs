---
title: Combined Instance Data Replication release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for Instance Data Replication from Xanadu to Zurich.
locale: en-US
...
# Combined Instance Data Replication release notes for upgrades from Xanadu to Zurich

Consolidated page of all release notes for Instance Data Replication from Xanadu to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Instance Data Replication release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Zurich.
