---
title: Combined Project Workspace release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for Project Workspace from Xanadu to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-xanadu-zurich/zurich-xanadu-projectworkspace-release-notes.html
release: zurich
...
# Combined Project Workspace release notes for upgrades from Xanadu to Zurich

Consolidated page of all release notes for Project Workspace from Xanadu to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Project Workspace release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Zurich.
...
-   **[Now Assist in Project Workspace](https://servicenow-staging.fluidtopics.net/access?context=summarize-docs-genai-skill-pw&family=xanadu&ft:locale=en-US)**
...
-   **[Manage Projects](https://servicenow-staging.fluidtopics.net/access?context=use-projects-pw&family=xanadu&ft:locale=en-US)**
...
-   **[Resource planning with Project Workspace](https://servicenow-staging.fluidtopics.net/access?context=use-resource-mgmt-prj-wksp&family=xanadu&ft:locale=en-US)**
...
-   **[Project details page enhancements](https://servicenow-staging.fluidtopics.net/access?context=update-project-details-from-project-workspace&family=xanadu&ft:locale=en-US)**
...
-   **[Financials in Project Workspace](https://servicenow-staging.fluidtopics.net/access?context=using-financials-prj-wrkspc&family=xanadu&ft:locale=en-US)**
...
-   **[Status reporting in Project Workspace](https://servicenow-staging.fluidtopics.net/access?context=status-reporting-in-pw&family=xanadu&ft:locale=en-US)**
...
-   View and track the actuals of each resource assignment with the actuals toggle.
 ...
 See [Project Workspace](https://servicenow-staging.fluidtopics.net/access?context=project-workspace-landing-page&family=xanadu&ft:locale=en-US) for more information.
