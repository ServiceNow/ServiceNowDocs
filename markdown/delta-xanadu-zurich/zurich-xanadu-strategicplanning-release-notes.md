---
title: Combined Strategic Planning release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for Strategic Planning from Xanadu to Zurich.
locale: en-US
...
# Combined Strategic Planning release notes for upgrades from Xanadu to Zurich

Consolidated page of all release notes for Strategic Planning from Xanadu to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Strategic Planning release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Zurich.
...
Between your current release family and Zurich, new features were introduced for Strategic Planning.
...
Between your current release family and Zurich, some changes were made to existing Strategic Planning features.
...
Between your current release family and Zurich, some Strategic Planning features or functionality were removed.
...
Between your current release family and Zurich, some Strategic Planning features or functionality were deprecated.
