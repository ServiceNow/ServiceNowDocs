---
title: Combined ServiceNow Studio release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for ServiceNow Studio from Xanadu to Zurich.
locale: en-US
...
# Combined ServiceNow Studio release notes for upgrades from Xanadu to Zurich

Consolidated page of all release notes for ServiceNow Studio from Xanadu to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family ServiceNow Studio release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading ServiceNow Studio to Zurich
...
Between your current release family and Zurich, new features were introduced for ServiceNow Studio.
...
-   **[Consolidated access to all integrated ServiceNow® builders and tools](https://servicenow-staging.fluidtopics.net/access?context=integrated-development-tools&family=xanadu&ft:locale=en-US)**
...
-   **[Work with all supported file types and metadata](https://servicenow-staging.fluidtopics.net/access?context=sn-studio-working-with-metadata&family=xanadu&ft:locale=en-US)**

Use the Navigator panel to quickly find, bookmark, and edit any type of supported ServiceNow metadata.

-   **[Deploy updates within ServiceNow Studio](https://servicenow-staging.fluidtopics.net/access?context=working-with-update-sets-in-servicenow-studio&family=xanadu&ft:locale=en-US)**
...
-   **[Generate apps using Now Assist](https://servicenow-staging.fluidtopics.net/access?context=sns-now-assist-app-gen-landing&family=xanadu&ft:locale=en-US)**
...
Between your current release family and Zurich, some changes were made to existing ServiceNow Studio features.
...
Between your current release family and Zurich, some ServiceNow Studio features or functionality were removed.
...
Between your current release family and Zurich, some ServiceNow Studio features or functionality were deprecated.
...
-   Bookmark applications and application files for easy, fast access.
 ...
 See [Building applications with ServiceNow Studio](https://servicenow-staging.fluidtopics.net/access?context=servicenow-studio-landing&family=xanadu&ft:locale=en-US) for more information.
