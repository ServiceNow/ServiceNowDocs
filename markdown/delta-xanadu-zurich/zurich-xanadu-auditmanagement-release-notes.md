---
title: Combined Audit Management release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for Audit Management from Xanadu to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-xanadu-zurich/zurich-xanadu-auditmanagement-release-notes.html
release: zurich
...
# Combined Audit Management release notes for upgrades from Xanadu to Zurich

Consolidated page of all release notes for Audit Management from Xanadu to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Audit Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Audit Management to Zurich
...
Between your current release family and Zurich, new features were introduced for Audit Management.
...
-   **[Generate an audit report for an engagement using Microsoft Word template](https://servicenow-staging.fluidtopics.net/access?context=generate-audit-report&family=xanadu&ft:locale=en-US)**
...
-   **[Cloud document management](https://servicenow-staging.fluidtopics.net/access?context=manage-cloud-docs-using-onedrive-int&family=xanadu&ft:locale=en-US)**
...
-   **[User role enhancements in Audit Management](https://servicenow-staging.fluidtopics.net/access?context=r_RolesInstallWAudit&family=xanadu&ft:locale=en-US)**
...
-   **[Matrix report in the Audit Workspace](https://servicenow-staging.fluidtopics.net/access?context=matrix-report-audit-ws&family=yokohama&ft:locale=en-US)**
...
-   **[Entity Based Access for Audit Management](https://servicenow-staging.fluidtopics.net/access?context=c_Engagements&family=yokohama&ft:locale=en-US)**
...
-   **Audit Period Start and End Dates [\[Placeholder link text to key t\_CreateEngagement\]](https://servicenow-staging.fluidtopics.net/access?context=t_CreateEngagement&family=zurich&ft:locale=en-US)**
...
-   **[\[Placeholder link text to key unified-content-management\_0\]](https://servicenow-staging.fluidtopics.net/access?context=unified-content-management_0&family=zurich&ft:locale=en-US)**
...
-   **[Enhancement to evidence request](https://servicenow-staging.fluidtopics.net/access?context=evidence-request&family=zurich&ft:locale=en-US)**
...
-   **[Integration with ITAM](https://servicenow-staging.fluidtopics.net/access?context=solutions-gallery&family=zurich&ft:locale=en-US)**
...
Between your current release family and Zurich, some changes were made to existing Audit Management features.
...
-   **[Domain separation and Audit Management](https://servicenow-staging.fluidtopics.net/access?context=audit-management-domain-separation&family=xanadu&ft:locale=en-US)**
...
-   **[Role change for users approving workflows](https://servicenow-staging.fluidtopics.net/access?context=r_RolesInstallWAudit&family=xanadu&ft:locale=en-US)**
...
Between your current release family and Zurich, some Audit Management features or functionality were removed.
...
Between your current release family and Zurich, some Audit Management features or functionality were deprecated.
...
-   Use the lite roles introduced in Audit Management for lighter business operations.
 ...
 See [Audit Management](https://servicenow-staging.fluidtopics.net/access?context=c_GRCAudits&family=xanadu&ft:locale=en-US) for more information.
...
-   Benefit from accessibility improvements to create a configurable workspace that supports Web Content Accessibility Guidelines \(WCAG\) 2.1 Level AA conformance.
 ...
 See [Audit Management](https://servicenow-staging.fluidtopics.net/access?context=c_GRCAudits&family=yokohama&ft:locale=en-US) for more information.
...
-   Access engagements, add existing entities to an engagement, and create activities in the Lite Audit workspace, which is a simplified version of the Audit Management workspace. If the advance core store app is installed, evidences can also be associated with the engagement.
 ...
 See [Audit Management](https://servicenow-staging.fluidtopics.net/access?context=c_GRCAudits&family=zurich&ft:locale=en-US) for more information.
