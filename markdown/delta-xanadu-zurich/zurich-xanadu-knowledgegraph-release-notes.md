---
title: Combined Knowledge Graph release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for Knowledge Graph from Xanadu to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-xanadu-zurich/zurich-xanadu-knowledgegraph-release-notes.html
release: zurich
...
# Combined Knowledge Graph release notes for upgrades from Xanadu to Zurich

Consolidated page of all release notes for Knowledge Graph from Xanadu to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Knowledge Graph release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Knowledge Graph to Zurich
...
Between your current release family and Zurich, new features were introduced for Knowledge Graph.
...
-   **[Test a Knowledge Graph schema](https://servicenow-staging.fluidtopics.net/access?context=test-a-knowledge-graph-schema&family=yokohama&ft:locale=en-US)**
...
-   **[Access Knowledge Graph Schema](https://servicenow-staging.fluidtopics.net/access?context=access-knowledge-graph-designer&family=yokohama&ft:locale=en-US)**
...
-   **[Leverage Knowledge Graph prebuilt integration with Virtual Agent](https://servicenow-staging.fluidtopics.net/access?context=example-use-case-for-knowledge-graph&family=yokohama&ft:locale=en-US)**
...
-   **[Leverage Knowledge Graph prebuild integration with AI agents](https://servicenow-staging.fluidtopics.net/access?context=leverage-knowledge-graph-prebuild-integration-with-agentic-ai&family=yokohama&ft:locale=en-US)**
...
-   **[Exploring Knowledge Graph](https://servicenow-staging.fluidtopics.net/access?context=exploring-knowledge-graph&family=yokohama&ft:locale=en-US)**
...
-   **[Using Knowledge Graph Designer](https://servicenow-staging.fluidtopics.net/access?context=using-knowledge-graph-designer&family=yokohama&ft:locale=en-US)**
...
-   **[Using Enterprise graph schema](https://servicenow-staging.fluidtopics.net/access?context=global-graph-schema&family=zurich&ft:locale=en-US)**
...
-   **[Tagging in Knowledge Graph Designer](https://servicenow-staging.fluidtopics.net/access?context=tagging-in-knowledge-graph&family=zurich&ft:locale=en-US)**
...
-   **[Test a Knowledge Graph schema](https://servicenow-staging.fluidtopics.net/access?context=test-a-knowledge-graph-schema&family=zurich&ft:locale=en-US)**

Enter a query and test the Knowledge Graph schema using different LLM options. You can also add previous conversations before you run the query.


-   **[Configure LLM for Knowledge Graph](https://servicenow-staging.fluidtopics.net/access?context=configure-gpt-4-0-for-knowledge-graph&family=zurich&ft:locale=en-US)**
...
Between your current release family and Zurich, some changes were made to existing Knowledge Graph features.
...
Between your current release family and Zurich, some Knowledge Graph features or functionality were removed.
...
Between your current release family and Zurich, some Knowledge Graph features or functionality were deprecated.
...
Review information on how to activate Knowledge Graph.
...
If any additional requirements were introduced or changed for Knowledge Graph we have noted them here.
...
If any specific browser requirements were introduced or changed for Knowledge Graph we have noted them here.
...
Review details on accessibility information for Knowledge Graph, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Knowledge Graph we have noted them here.
...
If there are specific highlight considerations for Knowledge Graph we have noted them here.
...
-   Knowledge Graph admins can use Knowledge Graph to create and manage the Knowledge Graph schemas. These Knowledge Graph schemas are the customized Knowledge Graph that consist of nodes, node properties, and edges.
 ...
 See [Knowledge Graph](https://servicenow-staging.fluidtopics.net/access?context=knowledge-graph-landing&family=yokohama&ft:locale=en-US) for more information.
...
-   Select your preferred large language model \(LLM\) provider for Now Assist platform. Apart from Now LLM Service, the platform supports Azure OpenAI GPT-4.1 and GPT-4.1 mini, Google Gemini 2.0 Flash and 2.5 Pro, and AWS Anthropic Claude 3.7 Sonnet LLM providers with ServiceNow® third-party model strategy.
 ...
 See [Knowledge Graph](https://servicenow-staging.fluidtopics.net/access?context=knowledge-graph-landing&family=zurich&ft:locale=en-US) for more information.
