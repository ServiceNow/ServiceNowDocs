---
title: Combined Automated Test Framework release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for Automated Test Framework from Xanadu to Zurich.
locale: en-US
