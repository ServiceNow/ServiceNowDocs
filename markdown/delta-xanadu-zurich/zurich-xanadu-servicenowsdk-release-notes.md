---
title: Combined ServiceNow SDK release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for ServiceNow SDK from Xanadu to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-xanadu-zurich/zurich-xanadu-servicenowsdk-release-notes.html
release: zurich
...
Upgrade to the latest version of the ServiceNow SDK with the `now-sdk upgrade` command. For more information, see [Upgrade the ServiceNow SDK](https://servicenow-staging.fluidtopics.net/access?context=upgrade-servicenow-sdk&family=xanadu&ft:locale=en-US).
...
-   **[Turn off synchronizing changes to ServiceNow Fluent code](https://servicenow-staging.fluidtopics.net/access?context=servicenow-fluent&family=xanadu&ft:locale=en-US)**
...
-   **[Authenticate to an instance using OAuth 2.0](https://servicenow-staging.fluidtopics.net/access?context=authenticate-instance-now-sdk&family=xanadu&ft:locale=en-US)**

Authenticate to a ServiceNow instance using OAuth 2.0 by setting the `type` parameter on the `now-sdk auth` command to `oauth`.

-   **[Ignore ServiceNow Fluent diagnostics](https://servicenow-staging.fluidtopics.net/access?context=servicenow-fluent&family=xanadu&ft:locale=en-US)**
...
-   **[ServiceNow Fluent Language server in Visual Studio Code](https://servicenow-staging.fluidtopics.net/access?context=install-fluent-language-extension-vs-code&family=xanadu&ft:locale=en-US)**
...
-   **[Convert command uses module project type by default](https://servicenow-staging.fluidtopics.net/access?context=servicenow-sdk-cli-commands&family=xanadu&ft:locale=en-US)**
...
-   **[transpiledSourceDir parameter replaced with modulePaths parameter in now.config.json file](https://servicenow-staging.fluidtopics.net/access?context=building-applications-source-code&family=xanadu&ft:locale=en-US)**
...
-   **[Table API includes label object](https://servicenow-staging.fluidtopics.net/access?context=table-api-now-ts&family=xanadu&ft:locale=en-US)**

Configure field labels \[sys\_documentation\] for tables and columns with the label object in the Table API.


-   **[Create and convert commands include template parameter](https://servicenow-staging.fluidtopics.net/access?context=servicenow-sdk-cli-commands&family=xanadu&ft:locale=en-US)**
...
-   **[Default application structure](https://servicenow-staging.fluidtopics.net/access?context=building-applications-source-code&family=xanadu&ft:locale=en-US)**
...
-   **[Create and convert commands include project-type parameter](https://servicenow-staging.fluidtopics.net/access?context=servicenow-sdk-cli-commands&family=xanadu&ft:locale=en-US)**
...
-   **[Fetch command includes debug parameter](https://servicenow-staging.fluidtopics.net/access?context=now-sdk-fetch-command&family=xanadu&ft:locale=en-US)**
...
-   **[Deploy command includes reinstall parameter](https://servicenow-staging.fluidtopics.net/access?context=now-sdk-deploy-command&family=xanadu&ft:locale=en-US)**
...
You must have Node.js and npm installed to install the ServiceNow SDK. For more information, see [Install the ServiceNow SDK](https://servicenow-staging.fluidtopics.net/access?context=install-servicenow-sdk&family=xanadu&ft:locale=en-US).
...
Write source code to define the metadata that makes up applications with ServiceNow Fluent.
 ...
 See [ServiceNow SDK](https://servicenow-staging.fluidtopics.net/access?context=servicenow-sdk-landing&family=xanadu&ft:locale=en-US) for more information.
