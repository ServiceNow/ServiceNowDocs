---
title: Combined HR Service Delivery for Healthcare release notes for upgrades from Xanadu to Zurich
description: Consolidated page of all release notes for HR Service Delivery for Healthcare from Xanadu to Zurich.
locale: en-US
...
# Combined HR Service Delivery for Healthcare release notes for upgrades from Xanadu to Zurich

Consolidated page of all release notes for HR Service Delivery for Healthcare from Xanadu to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family HR Service Delivery for Healthcare release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Zurich.
