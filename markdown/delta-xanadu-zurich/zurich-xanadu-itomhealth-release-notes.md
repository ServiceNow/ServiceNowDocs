...
-   **[Load the allow list only from the configuration file](https://www.servicenow.com/docs/access?context=acc-yml-options&family=xanadu)**

Enhance your security by loading the allow list from the configuration file and ignoring the allow-list parameters.

-   **[Configure the agent log level from the instance](https://www.servicenow.com/docs/access?context=set-agent-log-level&family=xanadu)**
...
-   **[Ensure secure agent connections](https://www.servicenow.com/docs/access?context=add-certificate-trust-store&family=xanadu)**
...
-   **[Use the new application Service Reliability Management](https://www.servicenow.com/docs/access?context=sr-landing-page&family=xanadu)**
...
-   **[Configure the Dynatrace connector instance](https://www.servicenow.com/docs/access?context=configure-dynatrace-connector&family=xanadu)**
...
-   **[Enable expanded processing for the MID server on Network Interface Controllers \(NICs\) during keepalive operation](https://www.servicenow.com/docs/access?context=acc-yml-options&family=xanadu)**
...
-   **[Stream log data from the System Log table in Glide to the Health Log Analytics AI engine](https://www.servicenow.com/docs/access?context=hla-data-input-glide-syslog&family=xanadu)**
...
-   **[Enrich automation](https://www.servicenow.com/docs/access?context=enrich-alert-sow-itom&family=xanadu)**
...
-   **[Group automation](https://www.servicenow.com/docs/access?context=group-alert-sow-itom&family=xanadu)**
...
-   **[View data on configuration items on the preview panel in Express List](https://www.servicenow.com/docs/access?context=el-ci-data&family=xanadu)**

View additional details about configuration items \(CIs\) that are bound to alerts on the Express List preview panel.

-   **[Speed up alert resolution with a Now Assist analysis of past related incidents](https://www.servicenow.com/docs/access?context=nai-past-incidents&family=xanadu)**
...
-   **[Generate an alert group description in Express List using Now Assist](https://www.servicenow.com/docs/access?context=alert-group-descr-generate-el&family=xanadu)**
...
-   **[Launch an alert analysis from the Now Assist panel](https://www.servicenow.com/docs/access?context=alert-analysis-now-assist-panel&family=xanadu)**
...
-   **[Alert automation enhancements](https://www.servicenow.com/docs/access?context=sow-itom-alert-automation&family=xanadu)**
...
-   **[Associate services to use in Service Reliability Management](https://www.servicenow.com/docs/access?context=sr-add-service&family=xanadu)**
...
[Agent Client Collector](https://www.servicenow.com/docs/access?context=agent-client-collector-rn&family=xanadu) highlights:
...
-   Gather expanded information on your Linux and Windows servers by using expanded Linux and Windows checks.
 ...
 [Health Log Analytics](https://www.servicenow.com/docs/access?context=health-log-analytics-rn&family=xanadu) highlights:
...
-   Stream system logs from Glide to Health Log Analytics using the Glide Syslog data input.
 ...
 [Event Management release notes](https://www.servicenow.com/docs/access?context=event-management-rn&family=xanadu) highlights:
