...
-   **[Resolve HR cases agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=employee-issue-resolver-na&family=yokohama&ft:locale=en-US)**
...
-   **[Growth Conversations agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=agentic-wf-conversations-na-td&family=yokohama&ft:locale=en-US)**
...
-   **[Generate a knowledge article](https://servicenow-staging.fluidtopics.net/access?context=gen-kb-now-assisthr&family=yokohama&ft:locale=en-US)**
...
-   **[Generate an email reply recommendation by using Now Assist for HR Service Delivery \(HRSD\)](https://servicenow-staging.fluidtopics.net/access?context=email-recommendation-nahr&family=yokohama&ft:locale=en-US)**

View the list of KB articles, related records, and current records that are used to generate email reply recommendations.

-   **[Generate onboarding ramp-up plan agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=onboarding-ramp-up-plan-agentic-wf&family=yokohama&ft:locale=en-US)**
...
-   **[Access knowledge from internal and external content sources](https://servicenow-staging.fluidtopics.net/access?context=explore-now-assist-hr&family=yokohama&ft:locale=en-US)**
...
-   **[Override sensitivity detection false positives](https://servicenow-staging.fluidtopics.net/access?context=explore-now-assist-hr&family=yokohama&ft:locale=en-US)**

Proceed with the interaction when the virtual agent incorrectly identifies a phrase as containing sensitive information.

-   **[Create a growth conversation with the help of an agent in Now Assist](https://servicenow-staging.fluidtopics.net/access?context=agentic-wf-conversations-na-td&family=yokohama&ft:locale=en-US)**
...
-   **[Help resolve tuition requests agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=now-assist-hrsd-ai-agents-policy-resolving-tr-usecase&family=yokohama&ft:locale=en-US)**
...
-   **[Now Assist for HRSD Virtual Agent topics](https://servicenow-staging.fluidtopics.net/access?context=now-assist-ohcm&family=yokohama&ft:locale=en-US)**

Use the [Now Assist for HR Service Delivery \(HRSD\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-hrsd&family=yokohama&ft:locale=en-US) Virtual Agent topics to place employee requests in the HCM system. Examples of requests are when an employee requests time off or updates their personal details.

-   **[Use Knowledge Graph](https://servicenow-staging.fluidtopics.net/access?context=na-kb-graph&family=yokohama&ft:locale=en-US)**
...
-   **[Create a journey using Now Assist](https://servicenow-staging.fluidtopics.net/access?context=create-journey-na&family=yokohama&ft:locale=en-US)**
...
-   **[Some Now Assist skills are now turned on by default](https://servicenow-staging.fluidtopics.net/access?context=now-assist-skills-on-by-default&family=zurich&ft:locale=en-US)**
...
-   **[Streamline feedback collection and review using the Employee feedback collection AI agent](https://servicenow-staging.fluidtopics.net/access?context=employee-feedback-agent&family=zurich&ft:locale=en-US)**
...
-   **[Predict service and transfer HR cases agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=predict-transfer-hrcase&family=zurich&ft:locale=en-US)**
...
-   **[Resolve noncritical HR cases agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=employee-issue-resolver-na&family=zurich&ft:locale=en-US)**
...
-   **[Resolve critical HR case agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=employee-issue-resolve-critical&family=zurich&ft:locale=en-US)**
...
-   **[Summarize an ER case](https://servicenow-staging.fluidtopics.net/access?context=now-assist-hrsd-summarize-er-case&family=zurich&ft:locale=en-US)**
...
-   **[Help resolve tuition reimbursement requests agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=resolve-tuition-reimbursement-requests&family=zurich&ft:locale=en-US)**
...
-   **[HR Voice AI agents](https://servicenow-staging.fluidtopics.net/access?context=now-assist-hrsd-voice-ai-agents&family=zurich&ft:locale=en-US)**
...
-   **[Collect employee feedback with the help of an agent in Now Assist](https://servicenow-staging.fluidtopics.net/access?context=employee-feedback-agent&family=zurich&ft:locale=en-US)**
...
-   **[Security for AI agents](https://servicenow-staging.fluidtopics.net/access?context=aia-security-implementation&family=zurich&ft:locale=en-US)**
...
-   **[HCM AI agents](https://servicenow-staging.fluidtopics.net/access?context=conversational-agents&family=zurich&ft:locale=en-US)**

Use AI agents to enable employees to place requests to the HCM system, such as apply for time off or update details.

-   **[Resolve HR cases agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=employee-issue-resolver-na&family=zurich&ft:locale=en-US)**
...
-   **[HR case sentiment analysis](https://servicenow-staging.fluidtopics.net/access?context=analyze-sentiments-now-assist&family=zurich&ft:locale=en-US)**
...
-   **[Schedule interviews agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=use-ai-agents-to-schedule-interviews&family=zurich&ft:locale=en-US)**
...
-   **[Create job requisition using AI](https://servicenow-staging.fluidtopics.net/access?context=use-ai-agents-to-create-job-req&family=zurich&ft:locale=en-US)**
...
-   **[Functional change](https://servicenow-staging.fluidtopics.net/access?context=employee-issue-resolver-na&family=zurich&ft:locale=en-US)**
...
-   **[Flow name](https://servicenow-staging.fluidtopics.net/access?context=employee-issue-resolver-na&family=zurich&ft:locale=en-US)**
...
-   Create Journey Accelerator plans by using Now Assist for HRSD in Journey designer.
 ...
 See [Now Assist for HR Service Delivery \(HRSD\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-hrsd&family=yokohama&ft:locale=en-US) for more information.
...
-   Use Google Gemini and Anthropic Claude on AWS as AI model providers for Now Assist skills and AI agents in addition to Now LLM Service and Azure OpenAI.
 ...
 See [Now Assist for HR Service Delivery \(HRSD\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-hrsd&family=zurich&ft:locale=en-US) for more information.
