---
title: Combined Care Team Operations for Biomed release notes for upgrades from Xanadu to Brazil
description: Consolidated page of all release notes for Care Team Operations for Biomed from Xanadu to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-xanadu-brazil/brazil-xanadu-careteamoperationsforbiomed-release-notes.html
release: brazil
...
# Combined Care Team Operations for Biomed release notes for upgrades from Xanadu to Brazil

Consolidated page of all release notes for Care Team Operations for Biomed from Xanadu to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Care Team Operations for Biomed release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Care Team Operations for Biomed to Brazil
...
Between your current release family and Brazil, new features were introduced for Care Team Operations for Biomed.
...
Between your current release family and Brazil, some changes were made to existing Care Team Operations for Biomed features.
...
Between your current release family and Brazil, some Care Team Operations for Biomed features or functionality were removed.
...
Between your current release family and Brazil, some Care Team Operations for Biomed features or functionality were deprecated.
...
Review information on how to activate Care Team Operations for Biomed.
...
If any additional requirements were introduced or changed for Care Team Operations for Biomed we have noted them here.
...
If any specific browser requirements were introduced or changed for Care Team Operations for Biomed we have noted them here.
...
Review details on accessibility information for Care Team Operations for Biomed, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Care Team Operations for Biomed we have noted them here.
...
If there are specific highlight considerations for Care Team Operations for Biomed we have noted them here.
...
-   Care Team Operations for Biomed has received security enhancements in the Australia release.
 ...
 See [Care Team Operations for Biomed](https://www.servicenow.com/docs/access?context=care-team-operations-for-biomed&family=australia&ft:locale=en-US) for more information.
