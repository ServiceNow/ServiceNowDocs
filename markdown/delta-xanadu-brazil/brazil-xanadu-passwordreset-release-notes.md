---
title: Combined Password Reset release notes for upgrades from Xanadu to Brazil
description: Consolidated page of all release notes for Password Reset from Xanadu to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-xanadu-brazil/brazil-xanadu-passwordreset-release-notes.html
release: brazil
...
# Combined Password Reset release notes for upgrades from Xanadu to Brazil

Consolidated page of all release notes for Password Reset from Xanadu to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Password Reset release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Password Reset to Brazil
...
Between your current release family and Brazil, new features were introduced for Password Reset.
...
Between your current release family and Brazil, some changes were made to existing Password Reset features.
...
Between your current release family and Brazil, some Password Reset features or functionality were removed.
...
Between your current release family and Brazil, some Password Reset features or functionality were deprecated.
...
**Note:** Password Reset is a ServiceNow AI Platform feature that is active by default.
...
-   Password Reset application enforces strong and secure passwords by enabling end users to reset or change their passwords either by using the self-service process or by requesting the assistance of a service desk agent.
...
-   ServiceNow® has implemented an automated workflow to streamline the default instance admin password reset process.

 See [Password Reset](https://www.servicenow.com/docs/access?context=password-reset-landing-page&family=brazil&ft:locale=en-US) for more information.
