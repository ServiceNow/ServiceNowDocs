---
title: Combined App Engine Studio release notes for upgrades from Xanadu to Brazil
description: Consolidated page of all release notes for App Engine Studio from Xanadu to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-xanadu-brazil/brazil-xanadu-appenginestudio-release-notes.html
release: brazil
...
# Combined App Engine Studio release notes for upgrades from Xanadu to Brazil

Consolidated page of all release notes for App Engine Studio from Xanadu to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family App Engine Studio release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading App Engine Studio to Brazil
...
Between your current release family and Brazil, new features were introduced for App Engine Studio.
...
-   **[Add users to one or more user groups](https://www.servicenow.com/docs/access?context=manage-intake-application-requests&family=xanadu&ft:locale=en-US)**

When viewing an intake request in AEMC, add a user to one or more AES and Creator Studio user groups.

-   **[Manage user groups for Application Intake](https://www.servicenow.com/docs/access?context=manage-app-intake-user-groups&family=xanadu&ft:locale=en-US)**
...
-   **[Test AEMC on a non-production instance](https://www.servicenow.com/docs/access?context=test-aemc-non-production-instance&family=xanadu&ft:locale=en-US)**

Test AEMC on a non-production instance to ensure everything works as expected before moving to your production instance.

-   **[Open applications in ServiceNow Studio](https://www.servicenow.com/docs/access?context=create-app-scratch&family=xanadu&ft:locale=en-US)**
...
Between your current release family and Brazil, some changes were made to existing App Engine Studio features.
...
Between your current release family and Brazil, some App Engine Studio features or functionality were removed.
...
Between your current release family and Brazil, some App Engine Studio features or functionality were deprecated.
...
-   As of Xanadu Store Release 2, open an application in ServiceNow Studio directly from App Engine Studio.
 ...
 See [Build apps using App Engine Studio](https://www.servicenow.com/docs/access?context=aes-overview&family=xanadu&ft:locale=en-US) for more information.
...
Several Integration Hub flow templates are being deprecated.
 ...
 See [App Engine Studio](https://www.servicenow.com/docs/access?context=aes-overview&family=australia&ft:locale=en-US) for more information.
...
-   Build applications to store information, automate business processes, and solve business problems using a low-code, wizard interface.
-   Leverage a suite of powerful development tools, including guided workflows and templates.
...
-   Publish apps using the App Engine Management Center.
 ...
 See [App Engine Studio](https://www.servicenow.com/docs/access?context=aes-overview&family=brazil&ft:locale=en-US) for more information.
