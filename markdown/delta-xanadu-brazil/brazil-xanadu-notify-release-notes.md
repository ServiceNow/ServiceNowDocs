---
title: Combined Notify release notes for upgrades from Xanadu to Brazil
description: Consolidated page of all release notes for Notify from Xanadu to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-xanadu-brazil/brazil-xanadu-notify-release-notes.html
release: brazil
...
# Combined Notify release notes for upgrades from Xanadu to Brazil

Consolidated page of all release notes for Notify from Xanadu to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Notify release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Notify to Brazil
...
Between your current release family and Brazil, new features were introduced for Notify.
...
Between your current release family and Brazil, some changes were made to existing Notify features.
...
Between your current release family and Brazil, some Notify features or functionality were removed.
...
Between your current release family and Brazil, some Notify features or functionality were deprecated.
...
-   Notify provides support for SMS and voice channels on the ServiceNow AI Platform for communicating internally with team members and externally with customers and contractors.
-   Use and integrate Notify with the third-party service providers as a communication channel to meet with the stakeholders to resolve the incidents.
 ...
 See [Notify](https://www.servicenow.com/docs/access?context=notify-landing-page&family=brazil&ft:locale=en-US) for more information.
