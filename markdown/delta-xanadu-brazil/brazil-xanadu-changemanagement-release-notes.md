---
title: Combined Change Management release notes for upgrades from Xanadu to Brazil
description: Consolidated page of all release notes for Change Management from Xanadu to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-xanadu-brazil/brazil-xanadu-changemanagement-release-notes.html
release: brazil
...
# Combined Change Management release notes for upgrades from Xanadu to Brazil

Consolidated page of all release notes for Change Management from Xanadu to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Change Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Change Management to Brazil
...
Between your current release family and Brazil, new features were introduced for Change Management.
...
-   **[Compliance dynamic schema](https://www.servicenow.com/docs/access?context=compliance-dynamic-schema&family=brazil&ft:locale=en-US)**
...
-   **[Change lockdown](https://www.servicenow.com/docs/access?context=change-lockdown&family=brazil&ft:locale=en-US)**
...
-   **[Change lockdown conflict detection](https://www.servicenow.com/docs/access?context=lockdown-conflict-detection&family=brazil&ft:locale=en-US)**
...
-   **[Scaled change](https://www.servicenow.com/docs/access?context=scaled-change-overview&family=brazil&ft:locale=en-US)**
...
Between your current release family and Brazil, some changes were made to existing Change Management features.
...
Between your current release family and Brazil, some Change Management features or functionality were removed.
...
Between your current release family and Brazil, some Change Management features or functionality were deprecated.
...
-   Track team performance with the Change Success Score, which uses historical data to predict successful change completion. This feature requires an ITSM Professional subscription.
 ...
 See [Change Management](https://www.servicenow.com/docs/access?context=c_ITILChangeManagement&family=brazil&ft:locale=en-US) for more information.
