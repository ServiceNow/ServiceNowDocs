---
title: Combined Vendor Management Workspace release notes for upgrades from Xanadu to Brazil
description: Consolidated page of all release notes for Vendor Management Workspace from Xanadu to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-xanadu-brazil/brazil-xanadu-vendormanagementworkspace-release-notes.html
release: brazil
...
# Combined Vendor Management Workspace release notes for upgrades from Xanadu to Brazil

Consolidated page of all release notes for Vendor Management Workspace from Xanadu to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Vendor Management Workspace release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Vendor Management Workspace to Brazil
...
Between your current release family and Brazil, new features were introduced for Vendor Management Workspace.
...
Between your current release family and Brazil, some changes were made to existing Vendor Management Workspace features.
...
Between your current release family and Brazil, some Vendor Management Workspace features or functionality were removed.
...
Between your current release family and Brazil, some Vendor Management Workspace features or functionality were deprecated.
...
Review information on how to activate Vendor Management Workspace.
...
If any additional requirements were introduced or changed for Vendor Management Workspace we have noted them here.
...
If any specific browser requirements were introduced or changed for Vendor Management Workspace we have noted them here.
...
Review details on accessibility information for Vendor Management Workspace, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Vendor Management Workspace we have noted them here.
...
If there are specific highlight considerations for Vendor Management Workspace we have noted them here.
