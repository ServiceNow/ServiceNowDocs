---
title: Combined Request Management release notes for upgrades from Xanadu to Brazil
description: Consolidated page of all release notes for Request Management from Xanadu to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-xanadu-brazil/brazil-xanadu-requestmanagement-release-notes.html
release: brazil
...
# Combined Request Management release notes for upgrades from Xanadu to Brazil

Consolidated page of all release notes for Request Management from Xanadu to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Request Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Request Management to Brazil
...
Between your current release family and Brazil, new features were introduced for Request Management.
...
Between your current release family and Brazil, some changes were made to existing Request Management features.
...
Between your current release family and Brazil, some Request Management features or functionality were removed.
...
Between your current release family and Brazil, some Request Management features or functionality were deprecated.
...
Review information on how to activate Request Management.
...
If any additional requirements were introduced or changed for Request Management we have noted them here.
...
If any specific browser requirements were introduced or changed for Request Management we have noted them here.
...
Review details on accessibility information for Request Management, such as specific requirements or compliance levels.
...
If there are specific highlight considerations for Request Management we have noted them here.
...
-   Request Management streamlines fulfillment workflows, reduces manual effort, and improves visibility into request status for both users and agents.
-   Request Management allows employees to submit requests for services, products, or information through a self-service portal.

 See [Request Management](https://www.servicenow.com/docs/access?context=c_RequestManagement&family=brazil&ft:locale=en-US) for more information.
