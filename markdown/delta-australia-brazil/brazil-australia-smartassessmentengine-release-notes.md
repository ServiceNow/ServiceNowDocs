---
title: Combined Smart Assessment Engine release notes for upgrades from Australia to Brazil
description: Consolidated page of all release notes for Smart Assessment Engine from Australia to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-australia-brazil/brazil-australia-smartassessmentengine-release-notes.html
release: brazil
...
# Combined Smart Assessment Engine release notes for upgrades from Australia to Brazil

Consolidated page of all release notes for Smart Assessment Engine from Australia to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Smart Assessment Engine release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Australia to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Smart Assessment Engine to Brazil
...
Between your current release family and Brazil, new features were introduced for Smart Assessment Engine.
...
Between your current release family and Brazil, some changes were made to existing Smart Assessment Engine features.
...
Between your current release family and Brazil, some Smart Assessment Engine features or functionality were removed.
...
Between your current release family and Brazil, some Smart Assessment Engine features or functionality were deprecated.
...
-   Score and report on assessment results to gain actionable insights.
 ...
 See [Smart Assessment Engine](https://www.servicenow.com/docs/access?context=smart-asmnt-engine-landing-page&family=brazil&ft:locale=en-US) for more information.
