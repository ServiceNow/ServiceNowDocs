---
title: Combined Predictive AI for CSM release notes for upgrades from Australia to Brazil
description: Consolidated page of all release notes for Predictive AI for CSM from Australia to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-australia-brazil/brazil-australia-predictiveaiforcsm-release-notes.html
release: brazil
...
# Combined Predictive AI for CSM release notes for upgrades from Australia to Brazil

Consolidated page of all release notes for Predictive AI for CSM from Australia to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Predictive AI for CSM release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Australia to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Predictive AI for CSM to Brazil
...
Between your current release family and Brazil, new features were introduced for Predictive AI for CSM.
...
Between your current release family and Brazil, some changes were made to existing Predictive AI for CSM features.
...
Between your current release family and Brazil, some Predictive AI for CSM features or functionality were removed.
...
Between your current release family and Brazil, some Predictive AI for CSM features or functionality were deprecated.
