---
title: Combined Build Agent and Autonomous Engineer release notes for upgrades from Australia to Brazil
description: Consolidated page of all release notes for Build Agent and Autonomous Engineer from Australia to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-australia-brazil/brazil-australia-buildagentandautonomousengineer-release-notes.html
release: brazil
...
# Combined Build Agent and Autonomous Engineer release notes for upgrades from Australia to Brazil

Consolidated page of all release notes for Build Agent and Autonomous Engineer from Australia to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Build Agent and Autonomous Engineer release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Australia to Brazil.
...
Several changes have been made to how you access Build Agent in ServiceNow Studio:
 ...
 -   **[Organized settings with tabs](https://www.servicenow.com/docs/access?context=ba-configure-settings&family=australia&ft:locale=en-US)**
...
An updated semantic metadata search tool improves performance replaces the previous semantic search tool.
 ...
 -   **[New button prompt to add AI to an app](https://www.servicenow.com/docs/access?context=create-a-new-application-using-build-agent&family=australia&ft:locale=en-US)**
...
-   **[Open Build Agent from ServiceNow Studio banner](https://www.servicenow.com/docs/access?context=access-build-agent&family=australia&ft:locale=en-US)**
...
Build Agent handles checkpoints and update sets differently in the following ways:
 ...
 -   **[Generated artifact preview](https://www.servicenow.com/docs/access?context=edit-an-existing-application-using-build-agent&family=australia&ft:locale=en-US)**
