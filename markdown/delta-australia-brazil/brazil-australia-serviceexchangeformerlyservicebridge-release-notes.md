---
title: Combined Service Exchange \(formerly Service Bridge\) release notes for upgrades from Australia to Brazil
description: Consolidated page of all release notes for Service Exchange \(formerly Service Bridge\) from Australia to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-australia-brazil/brazil-australia-serviceexchangeformerlyservicebridge-release-notes.html
release: brazil
...
# Combined Service Exchange \(formerly Service Bridge\) release notes for upgrades from Australia to Brazil

Consolidated page of all release notes for Service Exchange \(formerly Service Bridge\) from Australia to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Service Exchange \(formerly Service Bridge\) release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Australia to Brazil.
