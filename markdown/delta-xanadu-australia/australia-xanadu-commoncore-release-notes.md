---
title: Combined Common Core release notes for upgrades from Xanadu to Australia
description: Consolidated page of all release notes for Common Core from Xanadu to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-xanadu-australia/australia-xanadu-commoncore-release-notes.html
release: australia
...
# Combined Common Core release notes for upgrades from Xanadu to Australia

Consolidated page of all release notes for Common Core from Xanadu to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Common Core release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Australia.
...
-   **[Entity Based Access](https://www.servicenow.com/docs/access?context=entity-based-access&family=yokohama&ft:locale=en-US)**
...
-   **[Gen AI issue summarization](https://www.servicenow.com/docs/access?context=generate-grc-issue-resolution&family=yokohama&ft:locale=en-US)**
...
-   Review changes to Now Assist usage measurements.
 ...
 For detailed documentation, see [Common GRC features](https://www.servicenow.com/docs/access?context=common-grc-features&family=yokohama&ft:locale=en-US).
...
-   Enable entity-based access on custom GRC tables.
 ...
 For detailed documentation, see [Common GRC features](https://www.servicenow.com/docs/access?context=common-grc-features&family=zurich&ft:locale=en-US).
