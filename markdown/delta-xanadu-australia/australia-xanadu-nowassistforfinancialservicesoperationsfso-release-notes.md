---
title: Combined Now Assist for Financial Services Operations \(FSO\) release notes for upgrades from Xanadu to Australia
description: Consolidated page of all release notes for Now Assist for Financial Services Operations \(FSO\) from Xanadu to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-xanadu-australia/australia-xanadu-nowassistforfinancialservicesoperationsfso-release-notes.html
release: australia
...
# Combined Now Assist for Financial Services Operations \(FSO\) release notes for upgrades from Xanadu to Australia
