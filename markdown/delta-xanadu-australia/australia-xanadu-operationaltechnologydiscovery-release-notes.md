---
title: Combined Operational Technology Discovery release notes for upgrades from Xanadu to Australia
description: Consolidated page of all release notes for Operational Technology Discovery from Xanadu to Australia.
locale: en-US
...
# Combined Operational Technology Discovery release notes for upgrades from Xanadu to Australia

Consolidated page of all release notes for Operational Technology Discovery from Xanadu to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Operational Technology Discovery release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Australia.
