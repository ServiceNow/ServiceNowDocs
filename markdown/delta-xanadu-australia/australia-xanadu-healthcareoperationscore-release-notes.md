---
title: Combined Healthcare Operations Core release notes for upgrades from Xanadu to Australia
description: Consolidated page of all release notes for Healthcare Operations Core from Xanadu to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/delta-xanadu-australia/australia-xanadu-healthcareoperationscore-release-notes.html
release: australia
...
# Combined Healthcare Operations Core release notes for upgrades from Xanadu to Australia

Consolidated page of all release notes for Healthcare Operations Core from Xanadu to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Healthcare Operations Core release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Australia.
...
Between your current release family and Australia, new features were introduced for Healthcare Operations Core.
...
Between your current release family and Australia, some changes were made to existing Healthcare Operations Core features.
...
Between your current release family and Australia, some Healthcare Operations Core features or functionality were removed.
...
Between your current release family and Australia, some Healthcare Operations Core features or functionality were deprecated.
...
Review information on how to activate Healthcare Operations Core.
...
If any additional requirements were introduced or changed for Healthcare Operations Core we have noted them here.
...
If any specific browser requirements were introduced or changed for Healthcare Operations Core we have noted them here.
...
Review details on accessibility information for Healthcare Operations Core, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Healthcare Operations Core we have noted them here.
...
If there are specific highlight considerations for Healthcare Operations Core we have noted them here.
...
has received security enhancements in the Australia release.
 ...
 See [Healthcare Operations Core](https://www.servicenow.com/docs/access?context=hcls-cto-app&family=australia&ft:locale=en-US) for more information.
