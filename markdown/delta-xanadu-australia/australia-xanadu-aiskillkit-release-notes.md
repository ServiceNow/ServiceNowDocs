---
title: Combined AI Skill Kit release notes for upgrades from Xanadu to Australia
description: Consolidated page of all release notes for AI Skill Kit from Xanadu to Australia.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/delta-xanadu-australia/australia-xanadu-aiskillkit-release-notes.html
release: australia
...
# Combined AI Skill Kit release notes for upgrades from Xanadu to Australia

Consolidated page of all release notes for AI Skill Kit from Xanadu to Australia.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family AI Skill Kit release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Xanadu to Australia.
