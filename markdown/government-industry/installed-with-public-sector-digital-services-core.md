...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/installed-with-public-sector-digital-services-core.html
release: xanadu
...
</table>**Parent Topic:**[Install and configure the Public Sector Digital Services Core application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/configure-psds-core.md)
...
-   sn\_gsm\_lic\_prmt.government\_agency\_contributor
...
License &amp; Permits Contributor Creator\[sn\_gsm\_lic\_perm.contributor\_creator\]

</td><td>

Enables users to create government service cases and is included in the top-level contributor roles. It only allows record creation but does not allow visibilty to a record on its own.
