...
Selecting the response templates icon ![Response template icon.](../image/response-template-icon.png) shows the reusable messages that you can copy and paste into cases and case tasks. For information on how to create response templates, see Create or modify a response template.
