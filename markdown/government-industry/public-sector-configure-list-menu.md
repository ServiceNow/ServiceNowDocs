...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/public-sector-configure-list-menu.html
release: yokohama
topic_type: task
...
To configure the List Menu, you can follow this procedure or use [guided setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/psds-use-gs.md) for the Public Sector Digital Services Core application.
...
[Configure the Public Sector landing page using UI Builder.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/public-sector-configure-landing-page.md)
