...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/psds-servicebridge-config-connect-prov-consu.html
release: yokohama
topic_type: task
