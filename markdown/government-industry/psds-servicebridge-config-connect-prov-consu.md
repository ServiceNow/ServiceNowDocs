...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/government-industry/psds-servicebridge-config-connect-prov-consu.html
release: zurich
topic_type: task
