...
A provider record must have been created. See [Set up a Service Exchange provider record](https://www.servicenow.com/docs/access?context=service-bridge-v2-new-provider&version=zurich&pubname=zurich-service-bridge&ft:locale=en-US).
