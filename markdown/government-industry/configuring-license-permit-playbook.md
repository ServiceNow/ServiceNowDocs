...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/configuring-license-permit-playbook.html
release: xanadu
topic_type: concept
...
|[Automatically route license and permit requests using Advanced Work Assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/psds-configuring-awa-lpr.md)|Use the ServiceNow Advanced Work Assignment \(AWA\) application to route and assign license and permit requests to designated agents.|
|[Configure E-sign in License and Permit Playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/configure-esign-lpr.md)|Configure E-sign to allow constituents the option of drawing their signature when they submit cases through the Government Service Portal.|
|[Configure Eligibility Checklist UI in License and Permit Playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/psds-configure-eligibility-checklist-ui-lpr.md)|Configure the eligibility checklist UI to allow agents to confirm whether an applicant is eligible for the specific license or permit requested.|
|[Configure decision tables for License and Permit Playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/psds-configure-decision-tables.md)|Use decisions tables to simplify the pricing configuration of a license or permit request that depends on multiple factors. Decision tables provide a single point where you can create, view, and modify pricing and dependent attributes.|
|[Append price to Pricing Attribute label​](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/psds-append-price-to-pricing-attribute-label.md)|Prices are appended to all Boolean Price Attributes by default. Client scripts must added for any price choice attributes​ or price control attributes.|
|[Create Document Templates for License and Permit Playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/psds-lpr-configure-doc-template.md)|Use the Document Templates application to generate templates for various types of Licenses and Permits issued through the License and Permit Playbook.|
