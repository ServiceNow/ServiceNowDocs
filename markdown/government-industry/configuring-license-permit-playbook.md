...
|[Configure Eligibility in License and Permit Playbook](psds-configure-eligibility-lpr.md)|Configure the pre-eligibility criteria to allow agents to confirm whether an applicant is eligible for the specific license or permit requested.|
