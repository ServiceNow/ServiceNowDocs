...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/psds-using-sb-playbooks.html
release: xanadu
topic_type: concept
...
-   Includes the tabs that you can use to display the following types of information:
    ...
    -   Dynamic related records. For more information, see [Dynamic related records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/psds-playbook-viewing-rel-records.md).
