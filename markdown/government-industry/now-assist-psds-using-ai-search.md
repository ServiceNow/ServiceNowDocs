...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/now-assist-psds-using-ai-search.html
release: xanadu
topic_type: concept
