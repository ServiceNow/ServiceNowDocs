...
For more information on search application configurations, see Search application configurations. For more information on how to set up and customize AI Search for use with Now Assist for Public Sector Digital Services \(PSDS\), see [Configure AI search for Now Assist for Public Sector Digital Services \(PSDS\)](now-assist-psds-configuring-ai-search-toggle.md).
