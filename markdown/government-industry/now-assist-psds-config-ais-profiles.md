...
For more information on AI search profiles, see [Search profiles in AI Search](https://www.servicenow.com/docs/access?context=defining-search-profiles-ais&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
3.  On the Search Profile form, fill in the fields.
    ...
    For a description of the field values, see [Search Profile form](https://www.servicenow.com/docs/access?context=search-profile-form-ais&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
Your new search profile includes sample synonym and stop word dictionaries and a default typo handling dictionary. For more details on configuring and populating these dictionaries, see [Synonyms](https://www.servicenow.com/docs/access?context=synonyms-ais&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US), [Stop words](https://www.servicenow.com/docs/access?context=stop-words-ais&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US), and [Typo handling](https://www.servicenow.com/docs/access?context=typo-handling-ais&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
4.  On the Search Profile-Search Source Mapping form, fill in the fields.
    ...
    For a description of the field values, see [Search Profile - Search Source Mapping form](https://www.servicenow.com/docs/access?context=search-prof-src-mapping-form-ais&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
