...
**Previous topic:**[Configure PaCE Eligibility Framework Engine for use with Grants Management](psds-config-gmp-pace.md)

**Next topic:**[Configure Eligibility Rules Engine Policies in Grants Management](../task/psds-config-gmp-eligibility.md)
