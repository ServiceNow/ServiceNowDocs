...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/government-industry/psds-config-reviewer-service-portal.html
release: australia
topic_type: task
...
1.  Navigate to **All** &gt; **Service Portal** &gt; **Service Portal Configuration**.
    ...
    -   Branding: [Configure the portal branding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/c_BrandingEditor.md) to give the reviewer service portal its own look and feel. The Coral Theme is available for the reviewer service portal.
