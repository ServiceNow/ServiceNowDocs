...
description: If you have an agent role, you can use various skills with the Now Assist for Public Sector Digital Services \(PSDS\) application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/government-industry/now-assist-psds-using.html
release: zurich
topic_type: concept
...
If you have an agent role, you can use various skills with the Now Assist for Public Sector Digital Services \(PSDS\) application.
