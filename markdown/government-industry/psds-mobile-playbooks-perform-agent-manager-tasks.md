...
4.  Determine if you need to make any changes or take other actions. If so, perform any of the tasks in this table.
 ...
 For details on viewing a case in the Mobile Agent, see [Track government service requests with the ServiceNow Mobile Agent app](../task/psds-mobile-playbook-view-service-requests-agent.md).
