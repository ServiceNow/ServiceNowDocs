...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/psds-eligibility-decision-table-lp.html
release: xanadu
topic_type: task
...
26. Select the \[Omitted image "psdsplusiconlp.png"\] Alt text: Plus icon. icon to add a new decision row.
