...
2.  Select **Character counter for text area \(journal and multi line text fields\)**.
    ...
    ![Show character count prompt.](../image/psds-config-gmp-character-counter-field.png)
...
3.  Navigate to a playbook form activity and verify that the character counter is visible.
    ...
    ![Program information activity.](../image/psds-gmp-character-count.png)
...
**Previous topic:**[Configure read/write access roles for the Grants Management internal program team](psds-config-gmp-internal-team-default-roles.md)

**Next topic:**[Configure a retention policy for grant cases in Grants Management](psds-config-gmp-setup-retention-policy.md)
