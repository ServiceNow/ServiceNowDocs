...
**Previous topic:**[Configure a retention policy for grant cases in Grants Management](psds-config-gmp-setup-retention-policy.md)

**Next topic:**[Configure application export functionality in Grants Management](psds-config-gmp-export-pdf.md)
