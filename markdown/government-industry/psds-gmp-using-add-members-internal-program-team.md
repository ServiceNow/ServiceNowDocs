...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/government-industry/psds-gmp-using-add-members-internal-program-team.html
release: zurich
topic_type: task
...
To add public-facing points of contact that potential applicants can reach out to, see [Add points of contact to a Grant Program](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/government-industry/psds-using-gmp-pgr-announcement.md).
