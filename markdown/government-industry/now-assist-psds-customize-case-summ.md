...
12. Review your choices and select **Activate** to complete the skill customization.
    ...
    Review the settings on this page. Click **Back** to make changes for the input or display settings, or select **Activate** to turn the skill on.![Review and activate step for Now Assist case summarization.](../image/case-summarization-activate-now-assist-psds.png)
