...
7.  In the General details step, fill in the fields.
    ...
    For information about the inputs and triggers for each skill, see [Skill inputs and triggers for Now Assist for Public Sector Digital Services \(PSDS\)](now-assist-psds-skill-inputs.md).
