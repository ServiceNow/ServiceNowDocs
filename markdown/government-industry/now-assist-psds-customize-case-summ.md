...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/now-assist-psds-customize-case-summ.html
release: xanadu
topic_type: task
...
7.  In the General details step, fill in the fields.
    ...
    For information about the inputs and triggers for each skill, see [Skill inputs and triggers for Now Assist for Public Sector Digital Services \(PSDS\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/now-assist-psds-skill-inputs.md).
