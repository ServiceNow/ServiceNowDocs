...
To view the Documents related list, you must first install the [Document Management plugin](https://www.servicenow.com/docs/access?context=doc-mgt-plugin&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
