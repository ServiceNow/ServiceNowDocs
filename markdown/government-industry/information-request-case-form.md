...
To view the Documents related list, you must first install the [Document Management plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/doc-mgt-plugin.md).
