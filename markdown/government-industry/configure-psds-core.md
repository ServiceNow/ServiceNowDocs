...
Assign public sector roles to users or groups that have been configured in the ServiceNow AI Platform®. For additional role information, see [Roles installed with Public Sector Digital Services Core](../reference/installed-with-public-sector-digital-services-core.md#).

</td></tr><tr><td>

[Configure Public Sector Digital Services Core using guided setup](../task/psds-use-gs.md)
