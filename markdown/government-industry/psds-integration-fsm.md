...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/psds-integration-fsm.html
release: xanadu
topic_type: concept
last_updated: "2024-08-01"
reading_time_minutes: 1
breadcrumb: [Integrating Public Sector Digital Services with other applications, Public Sector Digital Services \(PSDS\)]
---
...
If you’ve purchased a subscription for both the Public Sector Digital Services \(PSDS\) application and the Field Service Management \(FSM\) application, PSDS agents can create and view all work orders and appointments related to their cases.

FSM field agents can view relevant PSDS data from work orders with the right roles.

External users with the snc\_external and other relevant PSDS and Customer Service Management \(CSM\) roles can view all case-related work orders and appointments related to their accounts.
