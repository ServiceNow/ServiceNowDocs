...
List view icon \(![List view icon.](../../customer-service-management/image/dynamic-related-records-list-view-icon.png)\) to display the related records in a list view in a subtab under the parent record.
