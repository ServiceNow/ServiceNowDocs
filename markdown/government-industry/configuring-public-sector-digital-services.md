...
[Set up your environment![](../../../reuse/icons/brand-icons/bus-optimize-manage.svg)Plan and set up your PSDS environment, import your foundation data, configure access and case management](psds-config-set-up-your-environment.md)

</td><td>

[Configure agent workspaces![](../../../reuse/icons/brand-icons/bus-customer-service-agent.svg)Configure your agent workspaces, including the CSM Configurable Workspace, Playbooks, Service Bridge, case routing, and advanced case management features.](psds-config-organize-agent-workspaces.md)

</td><td>

[Enable communication channels![](../../../reuse/icons/brand-icons/bus-customer-service.svg)Set up communication channels, including voice, email, web, and messaging.](psds-config-enable-comm-channels.md)

</td></tr><tr><td>

[Implement intelligence![](../../../reuse/icons/brand-icons/bus-actionable-analytics.svg)Set up Intelligence features to automate routine tasks and provide recommended content to agents, such as Now Assist.](psds-config-imp-intel.md)

</td><td>

[Set up self-service![](../../../reuse/icons/brand-icons/bus-personalized-self-service-portal.svg)Create self-service portals for constituents that are integrated with knowledge, communities, service catalogs, and chatbots.](psds-config-set-up-self-service.md)

</td><td>

[Extend capabilities![](../../../reuse/icons/brand-icons/bus-extend-visability.svg)Set up additional PSDS features to extend the capabilities of your environment.](psds-config-advanced-cap.md)
...
-   **Relabel menu items in CSM Configurable Workspace after upgrade**
    ...
    For details, see [Relabel CSM Configurable Workspace items for public sector use after upgrade](../task/psds-relabel-after-upgrading.md).
