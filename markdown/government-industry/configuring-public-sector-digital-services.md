...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/configuring-public-sector-digital-services.html
release: yokohama
topic_type: concept
...
-   **ServiceNow® Virtual Agent**
    ...
    For details on configuring Virtual Agent for public sector use, see [Configure Virtual Agent for Public Sector Digital Services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/psds-configuring-va.md).
...
-   **Service definitions**
    ...
    For more information, see [Service definitions for Public Sector Digital Services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/psds-service-definitions.md).
...
-   **Relabel menu items in CSM Configurable Workspace after upgrade**
    ...
    For details, see [Relabel CSM Configurable Workspace items for public sector use after upgrade](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/psds-relabel-after-upgrading.md).
