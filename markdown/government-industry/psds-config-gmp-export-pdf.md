...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/government-industry/psds-config-gmp-export-pdf.html
release: australia
topic_type: task
...
**Previous topic:**[Configure a currency in Grants Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/government-industry/psds-config-gmp-single-currency-setup.md)

**Next topic:**[Configure PaCE Eligibility Framework Engine for use with Grants Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/government-industry/psds-config-gmp-pace.md)
