...
3.  On the form, fill in the fields.
    ...
    For more information on the fields on the Household form, see [Household form](https://www.servicenow.com/docs/access?context=data-model-household-form&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
