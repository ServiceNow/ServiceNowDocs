...
For more information on record producers in Service Exchange, see [Remote record producers in Service Exchange](https://www.servicenow.com/docs/access?context=service-bridge-v2-remote-record&version=australia&pubname=australia-service-bridge&ft:locale=en-US)
