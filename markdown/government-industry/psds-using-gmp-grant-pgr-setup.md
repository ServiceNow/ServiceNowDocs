...
breadcrumb: [Grants Management, Playbooks and solutions, Use, Public Sector Digital Services \(PSDS\)]
---

# Using the Grant Program Setup Playbook in Grants Management

Design and configure a grant program before accepting applications from applicants or their liaisons. With Grants Management Program Setup, grants program managers can set up and manage grant programs with guided steps.

![grants program setup view](../image/psds_gm_programsetup.png)
...
Make it effortless for Grant Program Managers to create, publish and manage grant programs. Minimize errors with a guided process including built-in business logic. Protect sensitive information with role-based access management.
...
<table id="table_fzp_qf2_q3c"><thead><tr><th>
...
Define key details regarding the grant program. Agencieslink the grant program to a funding program, establish milestones, internal program team members, eligibility criteria, budgets, and key performance metrics.Grants program managers define merit review due dates, review framework, scoring rubric, and the internal review team.
