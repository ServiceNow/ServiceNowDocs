...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/government-industry/psds-config-icm-info-completeness-rules.html
release: australia
topic_type: task
...
For more information on the default completeness rules for ICM entities, see [Completeness Rules by Investigative Case Management Entity Type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/government-industry/psds-icm-ref-entity-man-completeness-rules.md).
