...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/using-psds-government-service-portal-overview.html
release: xanadu
topic_type: concept
...
**Note:** Administrators can customize Government Service Portal homepages in Service Portal, so homepages may differ visually across government agencies. For more information on customization, see [Customize the Government Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/customize-government-service-portal.md).
...
Tab where constituents can access the Knowledge homepage and search or view a list of the top-rated or most viewed knowledge base articles.
...
Tab where constituents can find all the available services in the catalog. They can search through the service catalog or view a list of the recently used or most popular catalog items.
...
Tab where constituents can find all their cases.
...
Tab where constituents can access quick links to their personal information:-   Businesses \(agent experience only\)
...
Tab where constituents can see their notifications for resolved cases, cases awaiting information, publications, and approvals.
...
Link where constituents can view a tour for additional guidance on how the Public Sector Digital Services application works. An administrator determines whether tours appear on pages.
...
Link where constituents can use Engagement Messenger to submit service requests from a third-party web application that is outside of the ServiceNow environment. For more information, see [Configure Engagement Messenger for Playbooks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/psds-configure-engagement-messenger.md).
...
Link where constituents can access a profile photo to either view a profile or log out.
...
Link where constituents can search the portal by either entering a keyword to use the type-ahead search or enter one or more words to view all search results.
...
Link where constituents can view a list of the most viewed articles.
...
Link where constituents can view featured community content.
...
Link where constituents can view the most useful knowledge articles by the usage count of the articles.
...
For more information on the services that are offered in the Government Service Portal service catalog, see [Government Service Portal service catalog list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/psds-service-catalog-list.md).
...
To customize this portal, navigate to **Service Portal** &gt; **Portals** and select Government Service. See [Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/c_ServicePortal.md)for more information about creating a custom interface.
