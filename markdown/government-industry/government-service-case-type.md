...
-   For more details on how to configure case types using Guided Setup, see [Configuring customer service case types](https://www.servicenow.com/docs/access?context=configure-csm-case-types&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
