...
**Note:** Points of contact can only be added from the internal team list record. To add members to the internal team list record, see [Create a grant program using Grants Management Program Set Up for Public Sector Digital Services](psds-gmp-using-set-up-grants-management-program.md).
