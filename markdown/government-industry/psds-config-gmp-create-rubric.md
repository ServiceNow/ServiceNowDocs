---
title: Configure a merit review scoring rubric for a grants proposal
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/government-industry/psds-config-gmp-create-rubric.html
release: zurich
topic_type: task
...
3.  On the Knowledge form, fill in the fields.
    ...
    For more information on the Knowledge form fields, see [Create a knowledge article](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/create-knowledge-article.md).
...
**Parent Topic:**[Configure the Merit Review Scoring Framework for a Grant Program in the Reviewer Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/government-industry/psds-config-gmp-scoring-framework.md)
