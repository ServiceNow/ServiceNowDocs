...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/psds-gsp-resolving-case-tasks-agent.html
release: yokohama
topic_type: concept
last_updated: "2025-07-31"
reading_time_minutes: 2
breadcrumb: [Using CSM Configurable Workspace, Using Public Sector Digital Services, Public Sector Digital Services \(PSDS\)]
---
...
3.  On the form, fill in the fields.
    ...
    For more information on the fields, see [Service Request Case Task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/service-request-case-form-new.md).
