...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/psds-lpr-configure-doc-template.html
release: xanadu
topic_type: task
...
6.  In the **PDF Template Mappings** related list, define additional PDF field mappings.
    ...
    See [Define a PDF field mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/hr-service-delivery/edit-pdf-mappings.md) for more information.
...
In the **Participants** related list, add additional participants. See [Create participants for a PDF document template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/hr-service-delivery/create-participant.md) for more information.
