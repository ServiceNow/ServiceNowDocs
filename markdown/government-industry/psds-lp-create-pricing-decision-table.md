...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/government-industry/psds-lp-create-pricing-decision-table.html
release: brazil
topic_type: task
