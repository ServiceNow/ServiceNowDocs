...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/psds-using-mobile-agent.html
release: yokohama
topic_type: concept
...
For more information on the agent tasks in the Mobile Agent app, see [Using the Mobile Agent to perform agent tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/psds-mobile-playbooks-perform-agent-manager-tasks.md).
...
For more information on the agent tasks in the Mobile Agent, see [Using the Mobile Agent to perform agent tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/psds-mobile-playbooks-perform-agent-manager-tasks.md).
