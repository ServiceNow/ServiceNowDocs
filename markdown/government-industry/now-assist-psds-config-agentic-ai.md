...
1.  Ensure that the Now Assist Panel and AI Search module are both enabled.
    ...
    For instructions on how to enable the Now Assist panel and on how to set up AI Search, see [Configure Now Assist for Public Sector Digital Services \(PSDS\)](now-assist-psds-configuring.md) and [Enabling and configuring AI Search with Now Assist for PSDS](now-assist-psds-enabling-configuring-ai-search.md).
