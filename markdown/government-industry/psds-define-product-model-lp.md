...
For more information on product models, case types, and service definitions, see [Using the extendable data model in Public Sector Digital Services](../concept/psds-using-flexible-data-model.md#).
