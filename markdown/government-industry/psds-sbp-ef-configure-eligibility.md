...
breadcrumb: [Configure Eligibility Rules Engine in Social Benefits Playbook, Social Benefits Playbook, Playbooks, Configure Agent Workspaces, Configuring Public Sector Digital Services, Public Sector Digital Services \(PSDS\)]
---
...
For more details, see [Manage PaCE policy versions](https://www.servicenow.com/docs/access?context=pace-policy-versions&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).**Note:** You must publish a policy version to make it current before it can be used.
...
An eligibility policy is now created, and is ready to be mapped to one of more benefits models of the Social Benefits Playbook. See [Map an eligibility policy to a benefit model](psds-sbp-ef-configure-eligibility.md#) for information on how to map the published policy to a specific benefit.
...
<table id="choicetable_swn_gw1_3bc"><thead><tr><th align="left" id="d49185e768">

Select...

</th><th align="left" id="d49185e771">

To...

</th></tr></thead><tbody><tr><td id="d49185e777">
...
6.  Select the **Template Builder** tab and fill in the conditions in the Policy logic section, then select **Save**.
    ...
    For more information about the parameters and condition fields, see [Passing parameters to PaCE policies](https://www.servicenow.com/docs/access?context=pace-passing-parameters&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) and [Policy logic condition fields](https://www.servicenow.com/docs/access?context=pace-policy-logic-fields&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
