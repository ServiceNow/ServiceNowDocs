...
description: Use the Social Benefits Playbook Eligibility Rules Engine, powered by Policy as Code Engine \(PaCE\), to manage the life cycle of a policy and create, update, review, and execute policies.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/government-industry/psds-sbp-ef-configure-eligibility.html
release: zurich
topic_type: concept
...
Use the Social Benefits Playbook Eligibility Rules Engine, powered by Policy as Code Engine \(PaCE\), to manage the life cycle of a policy and create, update, review, and execute policies.
