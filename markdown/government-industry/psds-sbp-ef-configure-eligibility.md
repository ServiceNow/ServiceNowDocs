...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/psds-sbp-ef-configure-eligibility.html
release: xanadu
topic_type: concept
last_updated: "2024-08-01"
reading_time_minutes: 8
breadcrumb: [Configure Eligibility Rules Engine in Social Benefits Playbook, Social Benefits Playbook, Playbooks, Configuring Public Sector Digital Services, Public Sector Digital Services \(PSDS\)]
---
...
For more details, see [Manage PaCE policy versions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/policy-as-code-engine-pace/pace-policy-versions.md).**Note:** You must publish a policy version to make it current before it can be used.
...
An eligibility policy is now created, and is ready to be mapped to one of more benefits models of the Social Benefits Playbook. See [Map an eligibility policy to a benefit model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/psds-sbp-ef-configure-eligibility.md) for information on how to map the published policy to a specific benefit.

## Map an eligibility policy to a benefit model
...
<table id="choicetable_swn_gw1_3bc"><thead><tr><th align="left" id="d46197e768">

Select...

</th><th align="left" id="d46197e771">

To...

</th></tr></thead><tbody><tr><td id="d46197e777">
