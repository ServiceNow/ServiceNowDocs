...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/psds-configure-engagement-messenger.html
release: xanadu
topic_type: concept
...
-   [Activate the Agent Chat plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/conversational-interfaces/agent-chat/ac-configure-agent-chat.md) \(com.glide.interaction.awa\).
-   [Activate the Virtual Agent plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/conversational-interfaces/virtual-agent/activate-virtual-agent.md) \(com.glide.cs.chatbot\), which requires a subscription.
