...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/psds-use-gs.html
release: yokohama
topic_type: task
last_updated: "2025-07-31"
reading_time_minutes: 1
breadcrumb: [Install and configure the Public Sector Digital Services Core application, Set up your environment, Configuring Public Sector Digital Services, Public Sector Digital Services \(PSDS\)]
---
...
[Install the Public Sector Digital Services Core application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/install-public-sector-digital-services-core.md).
...
After you have completed the setup tasks, you can install other public sector applications, such as the [Service Request Playbook application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/install-psds-service-request-playbook.md) and the [Performance Analytics Content Pack for Public Sector Digital Services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/psds-install.md).
