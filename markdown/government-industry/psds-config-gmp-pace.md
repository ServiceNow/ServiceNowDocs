...
1.  [Configure pre-eligibility questions in Grants Management](psds-config-gmp-config-pre-eligibility.md)  
...
2.  [Configure Eligibility Rules Engine Policies in Grants Management](../task/psds-config-gmp-eligibility.md)  
...
3.  [Configure PaCE Restricted Caller Access Privileges \(RCA\)](psds-config-gmp-rca.md)  
...
4.  [Configure the Smart Assessment Engine for Grants Management](psds-config-gmp-smart-assessment-engine.md)  
