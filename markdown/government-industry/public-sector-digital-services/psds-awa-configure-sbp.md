---
title: Configure Social Benefit Requests service channel
description: Change the default Social Benefit Requests service channel attributes in Advanced Work Assignment to control how public sector social benefit requests are routed and assigned to government agents.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/public-sector-digital-services/psds-awa-configure-sbp.html
release: xanadu
...
breadcrumb: [Automatically route social benefit requests using Advanced Work Assignment, Social Benefits Playbook, Playbooks, Configuring Public Sector Digital Services, Public Sector Digital Services \(PSDS\)]
---
