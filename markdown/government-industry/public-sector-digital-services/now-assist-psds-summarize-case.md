---
title: Summarize a case using Now Assist for Public Sector Digital Services \(PSDS\)
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/public-sector-digital-services/now-assist-psds-summarize-case.html
release: xanadu
...
# Summarize a case using Now Assist for Public Sector Digital Services \(PSDS\)
...
**Note:** You can also generate a case summary on demand from the Now Assist panel. For more information, see [Record summarization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/intelligent-experiences/enable-ai-experiences/now-assist-case-summary.md).
...
<table id="choicetable_md1_nyf_xyb"><thead><tr><th align="left" id="d41029e173">

Option

</th><th align="left" id="d41029e176">

Procedure

</th></tr></thead><tbody><tr><td id="d41029e182">
