...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/public-sector-digital-services/psds-playbook-customizing-rel-records-view.html
release: yokohama
...
1.  Select the filter icon \(\[Omitted image "dynamic-related-records-filter-icon.png"\] Alt text: Filter icon.\).
