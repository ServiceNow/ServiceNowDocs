---
title: Track government service requests with the ServiceNow Mobile Agent app
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/public-sector-digital-services/psds-mobile-playbook-view-service-requests-agent.html
release: yokohama
...
# Track government service requests with the ServiceNow Mobile Agent app
...
3.  Select the service request case that you want to see more details for.
    ...
    For a detailed description of the service request case fields, see [Service Request case form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/public-sector-digital-services/service-request-case-form-new.md).
