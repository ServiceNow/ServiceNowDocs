...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/public-sector-digital-services/psds-configure-eligibility-lpr.html
release: yokohama
...
The License and Permit Playbook uses eligibility criteria, a series of questions posed to an applicant, to determine whether they are eligible to apply for a license or permit. Using a set eligibility criteria for applications routed through the License and Permit Playbook may aid in deflecting applications in which the applicant is not eligible to obtain a license or permit.

Pre-Eligibility criteria is established by performing the following activities:

1.  Creating a Pre-Eligibility Decision Table. For more information, see [Create a Pre-Eligibility Decision Table in License and Permit Playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/public-sector-digital-services/psds-eligibility-decision-table-lp.md).
