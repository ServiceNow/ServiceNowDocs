...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/public-sector-digital-services/psds-create-new-service-definition.html
release: xanadu
...
3.  Enter the details for the Service Definition.
    ...
    |View|View to load for the selected service.|
    |Template|Field values that should be defaulted on the form when a case or task is created.|
    |Category|Service definition category for a public service.|
