...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/public-sector-digital-services/psds-define-product-model-lp.html
release: yokohama
...
For more information on product models, case types, and service definitions, see [Using the extendable data model in Public Sector Digital Services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/public-sector-digital-services/psds-using-flexible-data-model.md).
