...
|Task|Description|
|----|-----------|
|[Install Grants Management for Public Sector Digital Services](psds-install-grants-management-playbook.md)|Install Grants Management from the ServiceNow® Store.|
|[Configure pre-eligibility questions in Grants Management](psds-config-gmp-config-pre-eligibility.md)|Configure the eligibility framework engine to allow agents to confirm whether an applicant is eligible for the specific grant being requested.|
...
-   [Policy as Code Engine \(PaCE\)](https://www.servicenow.com/docs/access?context=pace-managing-policies&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US): Streamline the creation, maintenance, and use of screening criteria with a low-code rules engine.
