---
title: Mark for Decline
description: Select scored proposals, mark them for decline to the Grant Program Director for approval.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/government-industry/psds-rolling-grants-mark-decline-task.html
release: australia
topic_type: task
...
5.  In the **Scored Proposals** list, select one or more proposals with **Undecided** funding status.

6.  Select **Mark for Decline** in the toolbar.

7.  In the Mark for Decline confirmation dialog, provide a recommendation reason.
...
8.  Select **Mark for Decline** to confirm.
