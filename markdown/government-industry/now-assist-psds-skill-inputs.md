...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/government-industry/now-assist-psds-skill-inputs.html
release: zurich
topic_type: concept
...
# Skill inputs for ServiceNow Otto for Public Sector Digital Services \(PSDS\)
