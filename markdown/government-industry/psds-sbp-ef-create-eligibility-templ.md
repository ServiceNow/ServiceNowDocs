...
description: Create eligibility policy templates for the Social Benefits Playbook policy forms that you use frequently.short desc.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/government-industry/psds-sbp-ef-create-eligibility-templ.html
release: zurich
topic_type: task
