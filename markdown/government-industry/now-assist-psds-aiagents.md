...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/government-industry/now-assist-psds-aiagents.html
release: zurich
topic_type: concept
last_updated: "2025-11-06"
reading_time_minutes: 2
breadcrumb: [Use agentic AI, ServiceNow Otto for PSDS, Public Sector Digital Services \(PSDS\)]
---
...
-   Azure OpenAI is recommended for ITSM agentic workflows. For information on Large Language Models \(LLMs\) for AI agents and agentic workflows, see [Select the LLM for AI agents and agentic workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/select-aia-llm.md).

For more information on configuring AI Agents, see [Configure AI Agents for Public Sector Digital Services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/government-industry/now-assist-psds-config-agentic-ai.md).
