---
title: Create a service request record by using playbooks in Public Sector Digital Services
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/government-industry/psds-playbook-create-record.html
release: yokohama
topic_type: task
...
# Create a service request record by using playbooks in Public Sector Digital Services
...
**Note:** Before starting this procedure, verify that the Service Request Playbook application, which is separate from Public Sector Digital Services Core, has been installed and enabled in the CRM Workspace. For instructions, see [Install Service Request Playbook for Public Sector Digital Services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/government-industry/install-psds-service-request-playbook.md).
...
1.  In the CRM Workspace, navigate to **Lists** &gt; **Service Requests** &gt; **All**.
