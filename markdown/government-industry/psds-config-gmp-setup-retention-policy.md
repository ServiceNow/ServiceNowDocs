...
**Previous topic:**[Toggle character count display for form fields in Grants Management](psds-gmp-config-show-character-count.md)

**Next topic:**[Configure a currency in Grants Management](psds-config-gmp-single-currency-setup.md)
