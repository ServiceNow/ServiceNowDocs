...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/government-industry/psds-config-icm-create-case-team.html
release: australia
topic_type: task
