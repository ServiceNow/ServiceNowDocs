...
\(Optional\) [Activate Field Service Management](https://www.servicenow.com/docs/access?context=t_ActivateFieldServiceManagement&version=xanadu&pubname=xanadu-field-service-management&ft:locale=en-US) plugin \(com.snc.work\_management\)
