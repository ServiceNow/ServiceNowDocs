...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/government-industry/estimate-fees-ai-agents-using.html
release: xanadu
topic_type: concept
...
For more information, see [Install and configure Now Assist for Public Sector Digital Services \(PSDS\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/government-industry/now-assist-psds-configuring.md).
