...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/it-executive-dashboard.html
release: xanadu
topic_type: concept
...
**Important:** Starting with the Xanadu release, the IT Executive dashboard is deprecated. Users can access the [ITSM Success Dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/itsm-success-dashboard-indicators/explore-success-dashboard-indicators.md) to view the metrics for ITSM.
