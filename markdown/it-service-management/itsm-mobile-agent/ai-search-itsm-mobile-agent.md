...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/itsm-mobile-agent/ai-search-itsm-mobile-agent.html
release: xanadu
...
For information about AI search, see [AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/ai-search/overview-ais.md).

For information about AI search in mobile, see [AI Search in mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/now-mobile-employee-experience/text-search-advanced-now.md).
...
-   A search profile, ITSM Mobile Agent Search Profile. For information about search profiles, see [Search profiles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/ai-search/defining-search-profiles-ais.md).
