...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/itsm-mobile-agent/add-participants-inc-task-itsm-mobile.html
release: yokohama
...
breadcrumb: [Collaboration with incident tasks, My incidents, My Work applet, ITSM Mobile Agent, IT Service Management]
---

# Add participants to a conference call from an incident task

Add participants to an active conference call with the caller from an incident task to discuss about the resolution of a task.
