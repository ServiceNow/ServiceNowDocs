...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/itsm-mobile-agent/breached-incidents.html
release: yokohama
...
-   **[Process a breached incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/itsm-mobile-agent/process-breached-incident.md)**  
View and manage the breached incident from the mobile.

**Parent Topic:**[Managing incidents and tasks using My Work applet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/itsm-mobile-agent/my-work-application.md)
