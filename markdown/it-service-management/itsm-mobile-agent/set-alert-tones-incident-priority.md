...
3.  Update the **Push Message Generation** field with the following script.
    ...
    **Note:** Replace the ringtone with the desired alert tone name. For more information on the list of ringtones and alert tones available to update the script, see Configure sounds for push notifications.
