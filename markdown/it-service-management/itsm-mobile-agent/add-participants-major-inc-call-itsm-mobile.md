...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/itsm-mobile-agent/add-participants-major-inc-call-itsm-mobile.html
release: yokohama
...
breadcrumb: [Collaboration with major incidents, Major incident applet, ITSM Mobile Agent, IT Service Management]
---

# Add participants to a conference call from a major incident

Add participants to an active conference call from a major incident record to discuss about the resolution of the major incident.

## Before you begin

Role required: major\_incident\_manager, itil, itil\_admin, or admin
...
4.  Tap on the active conference call.

    \[Omitted image "maj-inc-related-details.png"\] Alt text: Active called highlighted in Colaborate tab.

5.  Tap **Add participants**

    \[Omitted image "maj-inc-active-conf-call-2.png"\] Alt text: Add participants highlighted in the conference call screen.
