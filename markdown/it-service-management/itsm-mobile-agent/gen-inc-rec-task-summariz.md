...
For more information on Now Assist for mobile, see [Now Assist for Mobile](https://www.servicenow.com/docs/access?context=now-assist-mobile-landing&version=australia&pubname=australia-mobile&ft:locale=en-US).
