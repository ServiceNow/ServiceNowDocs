...
For information about Zing search in mobile, see [Global search for mobile](https://www.servicenow.com/docs/access?context=mobile-search-config&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US).
