...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/itsm-mobile-agent/enable-notifications-categories.html
release: yokohama
...
4.  Select **Update**.
    ...
    \[Omitted image "notification-category-selection.png"\] Alt text: Notifications by category
