...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/itsm-mobile-agent/migrate-itsm-mobile-agent-5.0.3.html
release: yokohama
