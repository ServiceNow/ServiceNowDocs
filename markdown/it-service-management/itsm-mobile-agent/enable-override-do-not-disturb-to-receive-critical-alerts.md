...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/itsm-mobile-agent/enable-override-do-not-disturb-to-receive-critical-alerts.html
release: xanadu
