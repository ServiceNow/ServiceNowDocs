...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/itsm-mobile-agent/actionable-notify-itsm-mobile.html
release: xanadu
...
3.  Create a function for one of your push actions.
    ...
    -   URL
    -   Chat launcher
    For information on function types, and detailed steps for creating functions, see [Mobile functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/mobile/mobile-platform/sg-studio-mobile-button-types.md).
...
[Map functions with push actions for actionable push notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/itsm-mobile-agent/actionable-notify-itsm-mobile.md)
