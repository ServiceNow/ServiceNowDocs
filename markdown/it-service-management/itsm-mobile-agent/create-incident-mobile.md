...
For more information on configuring the auto-populated values, see [Configure auto-fill inputs on input form screens](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/mobile/config-autofil-inputs-nptfrmscrn.md).
