...
On your mobile, install the ServiceNow Agent app \(from Apple App Store or Google Play Store\). For more information about this app, see [Mobile Agent](https://www.servicenow.com/docs/access?context=mobile-experience&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US).
