...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/problem-management/complete-a-problem-task.html
release: yokohama
...
Role required: admin, problem\_admin, problem\_coordinator, problem\_manager, or problem\_task\_analyst

## Procedure

1.  Select **Complete**.

    \[Omitted image "pm-task-complete.png"\] Alt text: work in progress state
