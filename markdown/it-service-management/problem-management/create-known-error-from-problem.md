...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/problem-management/create-known-error-from-problem.html
release: xanadu
...
5.  On the form, fill in the fields.
    ...
    **Note:** Click **Search for Duplicates** to search for existing known error articles. The search is based on short description, category, and topic.
    ...
    For a description of the field values, see [Known error article form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/known-error-article-form.md).
