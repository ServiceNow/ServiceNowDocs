...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/problem-management/create-problem.html
release: yokohama
...
<table id="choicetable_agp_ckc_3t"><tbody><tr><td id="d143701e54">
...
2.  On the context menu, click **Create Problem**.
    ...
    For a description of the field values, see [Legacy Problem form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/problem-management/legacy-problem-form.md).
...
**Parent Topic:**[Create a problem](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/problem-management/create-a-problem-v2.md)
