...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/problem-management/problem-overview-dashboard.html
release: yokohama
...
Starting in Xanadu release, the Problem overview dashboard is deprecated. Users can use [Problem dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/problem.md) to view, and track the open problems.
