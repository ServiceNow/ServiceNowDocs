...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/problem-management/open-problem-age-monitor-dashboard.html
release: yokohama
...
Starting in Xanadu release, the Problem age dashboard is deprecated. Users can use [Problem dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/problem.md) to view, and track the open problems.
