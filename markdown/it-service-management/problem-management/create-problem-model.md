...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/problem-management/create-problem-model.html
release: xanadu
...
See considerations for enabling Problem Management models at [Problem Management models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/problem-mgmt-models.md).

Enable the system property **com.snc.problem\_management.models.enabled**. For more information, see [Enable Problem Management models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/enable-problem-mgmt-models.md).
...
1.  Open the Problem Models table in one of the following ways.
    ...
    -   Navigate to **All** &gt; **Problem** &gt; **Administration** &gt; **Problem Models**.
        ...
        **Note:** For more information about enabling menu items for Problem Management models, see [Enable or disable an application menu or module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/t_EnDisableAppMenuOrMod.md).

    1.  Select **New**.

    2.  On the Problem Model form, fill in the fields.

        For more information, see [Problem model form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/problem-model-form.md).
...
4.  Apply transition conditions by selecting any of your model state transitions.
    ...
    2.  On the Model State Transition Condition form, fill in the fields.
        ...
        For more information, see [Problem Management model state transition condition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/problem-model-state-transition-condition.md).
...
**Parent Topic:**[Configuring Problem Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/configuring-problem-mgmt.md)

**Previous topic:**[Enable Problem Management models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/enable-problem-mgmt-models.md)

**Next topic:**[Create a problem task model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/create-problem-task-model.md)
