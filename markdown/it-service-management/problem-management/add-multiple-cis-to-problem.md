...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/problem-management/add-multiple-cis-to-problem.html
release: yokohama
...
3.  Click **Add Selected**.
 **Note:** If the Impacted Services/CIs is not visible on the form, [configure the form layout.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/configure-form-layout.md)
