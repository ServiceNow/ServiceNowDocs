...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/problem-management/extension-point-for-problem.html
release: xanadu
...
Navigate to **All** &gt; **Scripted Extension Points** to add global.MRABulkAddRecordsFilter to the Extension Point \[sys\_extension\_point\] table.
...
**Parent Topic:**[Add multiple incidents to a problem](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/add-multiple-incidents-to-problem.md)
