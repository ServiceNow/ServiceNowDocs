...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/problem-management/activate-plugin-problem-management.html
release: xanadu
...
Before you activate the plugin, be sure to resolve blocking modifications. For more information, see [Resolve blocking modifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/resolve-blocking-modifications.md).
...
<table id="choicetable_zxl_xhm_plb"><tbody><tr><td id="d199888e95">
...
[Prepare base plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/prepare-base-plugins.md).
