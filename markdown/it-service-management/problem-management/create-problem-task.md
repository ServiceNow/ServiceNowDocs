...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/problem-management/create-problem-task.html
release: xanadu
...
5.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Problem Task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/problem-task-form.md).
