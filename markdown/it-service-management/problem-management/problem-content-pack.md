...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/problem-management/problem-content-pack.html
release: zurich
...
-   **[Legacy: Problem Overview dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/problem-management/problem-overview-dashboard.md)**  
This dashboard shows the current state of open problems.
-   **[Legacy: Problem Management dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/problem-management/problem-management-dashboard.md)**  
Use this dashboard to gain a high-level view across the problem management process, from opening to closing.
-   **[Legacy: Problem Premium dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/problem-management/problem-premium-dashboard.md)**  
...
-   **[Legacy: Problem daily 7d - 28d dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/problem-management/problem-daily-7d-28d-dashboard.md)**  
Track the progress made by different assignment groups in resolving problems in the daily, weekly, and monthly time frames.
-   **[Legacy: Open Problem Age Monitor dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/problem-management/open-problem-age-monitor-dashboard.md)**  
