...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/problem-management/c\_ProblemManagementProcess.html
release: xanadu
...
A problem can be created in several ways. For detailed information, refer [Create a problem](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/create-a-problem-v2.md).
...
As a problem is updated, [email notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/c_EmailNotifications.md) are sent to concerned parties. If inbound email actions are specified, the problem can be updated via email.
...
-   **[Life cycle of a problem](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/understanding-state-mgmt-transitions.md)**  
...
-   **[Life cycle of a problem task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/understanding-state-trans-prob-task.md)**  
...
**Parent Topic:**[Exploring Problem Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/exploring-problem-management.md)
