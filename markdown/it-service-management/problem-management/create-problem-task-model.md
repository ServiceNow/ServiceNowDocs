...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/problem-management/create-problem-task-model.html
release: yokohama
...
See considerations for enabling Problem Management models at [Problem Management models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/problem-management/problem-mgmt-models.md).
...
1.  Open the Problem Task Models table in one of the following ways.
    ...
    -   Navigate to **All** &gt; **Problem** &gt; **Administration** &gt; **Problem Task Models**.
        ...
        **Note:** For more information about enabling menu items for Problem Management models, see [Enable or disable an application menu or module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/configure-user-experiences/t_EnDisableAppMenuOrMod.md).
    ...
    3.  On the Problem Task Model form, fill in the fields.
        ...
        For more information, see [Problem task model form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/problem-management/problem-task-model-form.md).
...
4.  Apply transition conditions by selecting any of your model state transitions.
    ...
    2.  On the Model State Transition Condition form, fill in the fields.
        ...
        For more information, see [Problem Management model state transition condition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/problem-management/problem-model-state-transition-condition.md).
...
**Previous topic:**[Create a problem model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/problem-management/create-problem-model.md)

**Next topic:**[Applying CSDM guidelines to Problem Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/problem-management/pm-use-case-product-view.md)
