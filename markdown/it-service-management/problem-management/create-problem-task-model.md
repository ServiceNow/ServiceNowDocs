...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/problem-management/create-problem-task-model.html
release: xanadu
...
1.  Open the Problem Task Models table in one of the following ways.
    ...
    3.  On the Problem Task Model form, fill in the fields.
        ...
        For more information, see [Problem task model form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/problem-task-model-form.md).
...
**Previous topic:**[Create a problem model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/create-problem-model.md)

**Next topic:**[Managing Problems](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/problem-management/problem-mgmt-lifecycle.md)
