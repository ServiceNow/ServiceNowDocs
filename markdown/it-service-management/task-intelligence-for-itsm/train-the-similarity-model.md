...
description: Train your similar records models with training data to predict the similar records by recognizing similarities between fields of Incident table and training tables.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/task-intelligence-for-itsm/train-the-similarity-model.html
release: xanadu
...
10. Review the resulting **Number of records** in the training data based on the selected conditions. 
    ...
    \[Omitted image "TI\_review\_results.png"\] Alt text: UI of the "Review the resulting number of records" section
