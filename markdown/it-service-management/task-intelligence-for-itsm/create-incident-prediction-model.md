...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/task-intelligence-for-itsm/create-incident-prediction-model.html
release: xanadu
...
-   Output fields, or the fields that the model predicts
-   Input fields, or the fields used to predict the output fields
...
Task Intelligence for ITSM comes with a base system **Incident Categorization** model for predicting the Incident fields.
...
To edit and redeploy the base system model, you can navigate to the Setup page. From the model list, select **Incident Categorization** and edit the model. For more information on how to edit the model, see [Edit an incident prediction model in Task Intelligence for ITSM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/task-intelligence-for-itsm/edit-your-model.md).
...
To set up a new model using a template, see [Set up your incident prediction model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/task-intelligence-for-itsm/set-up-model.md).

-   **[Set up your incident prediction model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/task-intelligence-for-itsm/set-up-model.md)**  
