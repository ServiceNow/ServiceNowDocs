...
2.  Create an entitlement if you don't have any entitlements carried over to the draft contract.
    ...
    2.  On the Software Entitlement form, fill in the required fields.
        ...
        For more information, see [Software entitlement fields](https://www.servicenow.com/docs/access?context=software-entitlement-fields&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).
...
<table id="choicetable_ohx_k1c_qtb"><thead><tr><th align="left" id="d212965e134">

Interface

</th><th align="left" id="d212965e137">

Action

</th></tr></thead><tbody><tr><td id="d212965e143">
