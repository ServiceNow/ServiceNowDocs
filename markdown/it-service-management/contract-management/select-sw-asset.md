...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/contract-management/select-sw-asset.html
release: australia
...
2.  Create an entitlement if you don't have any entitlements carried over to the draft contract.
    ...
    2.  On the Software Entitlement form, fill in the required fields.
        ...
        For more information, see [Software entitlement fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/software-entitlement-fields.md).
...
<table id="choicetable_ohx_k1c_qtb"><thead><tr><th align="left" id="d133512e134">

Interface

</th><th align="left" id="d133512e137">

Action

</th></tr></thead><tbody><tr><td id="d133512e143">
...
[Update terms and conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/contract-management/update-terms-conditions.md)
