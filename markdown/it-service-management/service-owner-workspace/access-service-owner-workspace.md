...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-owner-workspace/access-service-owner-workspace.html
release: xanadu
...
3.  Click **My Services** to view portfolios that you own and manage.
    ...
    \[Omitted image "AllServices.png"\] Alt text: All Services view
...
4.  Click a service name to view pertinent information about the service.
    ...
    \[Omitted image "HighLevelService.png"\] Alt text: Parent service view
...
7.  Click in the **Service** card to drill deeper into the details and view health and performance metrics, as well as any associated service offerings.
    ...
    \[Omitted image "ServiceOfferingView.png"\] Alt text: Service offering view
...
8.  Click additional tabs besides the **Overview** tab to display data relevant to the offering, including:
    ...
    -   **Info** — View the service offering description, performance breakdown, general information, commitments, team, and more. You can also view your service offering to catalog item relationships via this tab. Click to open a catalog item to drill down into more details.
        ...
        Monitor fulfilled requests for all associated catalog items in the **Offering Activity** metric. For complete details about service offerings and associated catalog items, refer to [Service offering to catalog item relationships](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-owner-workspace/SPM2-offering-to-catalog.md).
...
9.  Click icons in the impact stream panel, on the right side of the workspace, to display related information about **Outages**, **Critical Incidents**, **Change Requests**, or **Attachments**.
    ...
    \[Omitted image "ActivityStream.png"\] Alt text: Contextual side panel
...
10. Click an outage, critical incident, or change request to drill deeper into the details.
    ...
    Recent, current, and upcoming outage data is available. Click a type of outage for the information you want. Refer to [Outages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-owner-workspace/use-service-owner-workspace.md) for information about a unique **Outage Number** identifier and activating the Outage Numbering plugin \(com.snc.outage\_numbering\).

11. If the service you are viewing has associated child offerings, click an offering to drill down and view details.

    \[Omitted image "ServiceOfferingChild.png"\] Alt text: Service Offering Children view
