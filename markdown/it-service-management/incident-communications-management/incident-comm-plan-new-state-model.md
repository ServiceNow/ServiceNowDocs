...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/incident-communications-management/incident-comm-plan-new-state-model.html
release: xanadu
...
For more information on the old Incident Communications Plan state model, see [Incident communication plan state model \(old\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/incident-communications-management/r_IncidentAlertLifeCycle.md).
