...
For the Software Asset Management product \(requires a separate subscription\), see [Software Asset Management](https://www.servicenow.com/docs/access?context=c_SAMOverview&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).
