...
For the Software Asset Management product \(requires a separate subscription\), see [Software Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-asset-management/c_SAMOverview.md).
