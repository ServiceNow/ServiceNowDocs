...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-self-service/configuring-dex-self-service-issues.html
release: yokohama
...
Device, application, and network issues and metric details displayed in DEX Self-service are based on evaluation criteria configured in issue configuration records. If metrics in the evaluation criteria of an issue resolution are defined as **Poor**, the corresponding DEX Self-service subcategory is also marked as **Poor**. DEX Self-service displays resolutions for **Poor** subcategories as configured in issue configuration records.

For information about how device health is calculated, see [Device heath check calculation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/digital-end-user-experience-self-service/Device-health-check-calculation.md).
