...
Each subcategory’s performance is marked as Good, Average, or Poor by calculating the weighted average of the performance indicators of associated device metrics.
...
-   **Formula used to calculate the subcategory performance indicators**
    ...
    -   Evaluation metric performance indicator: Performance indicator \(Good, Average, Poor\) of the evaluation metrics' value as defined in the metric definition table.
