...
1.  Select the Virtual Agent or chat icon \(\[Omitted image "icon-virtual-agent.png"\] Alt text: Virtual agent or chat icon\) that appears on any portal or Desktop Assistant header.
...
3.  If you have more than one device, select the required device to check its health.
    ...
    \[Omitted image "Check\_device\_health\_first\_image.png"\] Alt text: Check device's health using Now Assist for ITSM

4.  Select the required resolution to improve the device performance.

    **Note:** The resolution can either be a remedial action, a self-help instruction, or an URL. For more information, see [Resolution for Proactive Engagement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/proactive-engagement/resolutions.md)
...
The Virtual Agent ask for your consent to continue with the selected remedial action if it is configured to do so.\[Omitted image "Check\_device\_check\_in\_now\_assist\_remedial\_action.png"\] Alt text: Remedial action in Now Assist for ITSM
...
Virtual Agent displays the steps to resolve the issue.\[Omitted image "Check\_device\_health\_check\_self\_help\_instructions.png"\] Alt text: Self help instructions in Now Assist for ITSM
...
5.  Confirm to the Virtual Agent if this conversation was helpful.
    ...
    **Note:**
    ...
    The resolutions and fallback options are defined by the admin in ServiceNow Proactive Engagement. To know more, see [Engagement Settings for Proactive Engagement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/proactive-engagement/engagement-settings.md)
