...
1.  [Configuring Digital End-User Experience](config-dex-console.md)
    ...
    **Important:** DEX Self-service is inactive in the base system. To activate DEX Self-service, enable the base system issue configurations. For more information, see [Enable DEX Self-service for issue configurations](../task/enable-dex-self-service-issues.md).
...
3.  [Enable DEX Self-service for issue configurations](../task/enable-dex-self-service-issues.md).
