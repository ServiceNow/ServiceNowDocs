...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-self-service/check-your-device-s-using-employee-center.html
release: yokohama
...
<table id="choicetable_lhy_ttn_z2c"><thead><tr><th align="left" id="d143852e65">

Option

</th><th align="left" id="d143852e68">

Steps to open Device heath check

</th></tr></thead><tbody><tr><td id="d143852e74">
...
**Note:** If the Employee Center Pro is enabled, then it will be available under Help center. Navigate to **Help center** &gt; **Technology Service** &gt; **Hardware/Software**.
...
</td></tr><tr><td id="d143852e123">

**Access Device health check from Quick links.**

</td><td>

Navigate to **Technology Services** &gt; **Quick links** &gt; **Device health check**. **Note:** If the Employee center pro is enabled, then it will be available under Help center. Navigate to **Help center** &gt; **Technology Services** &gt; **Quick links** &gt; **Device health check**.
...
4.  View and use the resolution to improve the category.
    ...
    **Note:**
    ...
    -   The resolution can be remedial action button, a Self-help instruction, or an URL. For more information, see [Resolution for Proactive Engagement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/proactive-engagement/resolutions.md).
