...
View the selected metric here.**Note:** You can select multiple metrics. DEX Self-service checks both the metrics and decides if the category is Good, Average, or Poor.
