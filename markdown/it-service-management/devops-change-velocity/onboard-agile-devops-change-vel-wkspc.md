...
Activate the Agile Development 2.0 plugin. For more information, see [Activate Agile Development 2.0](https://www.servicenow.com/docs/access?context=activate-agile-development&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US).
...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d380606e107">

Option

</th><th align="left" id="d380606e110">

Steps

</th></tr></thead><tbody><tr><td id="d380606e116">
