...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/devops-change-velocity/configure-veracode-scans-on-your-pipeline.html
release: xanadu
...
Run the generic Docker Container Image to use the following script. For more information, see [Implement custom actions for pipelines using generic Docker container image](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/servicenow-custom-actions-for-gitlab.md).```
- stage:
