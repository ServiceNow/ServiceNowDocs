...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/devops-change-velocity/rally-connect-workspace.html
release: australia
...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d444814e95">

Option

</th><th align="left" id="d444814e98">

Steps

</th></tr></thead><tbody><tr><td id="d444814e104">
...
3.  On the Enter Rally instance details playbook activity, enter the following details:
    ...
    2.  Select the credential type as **Basic Auth** or **OAuth 2.0**.
        ...
        -   OAuth 2.0: Enter your OAuth credential.
            ...
            For information on setting up your OAuth 2.0 credentials for Rally, see [Setting up Rally OAuth 2.0 credentials for DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/setting-up-rally-oauth-2-0-credentials-for-devops.md).
