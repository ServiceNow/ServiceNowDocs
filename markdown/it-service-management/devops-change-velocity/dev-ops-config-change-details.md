...
-   Use the [DevOps - POST /devops/orchestration/changeControl](https://www.servicenow.com/docs/access?context=devops-api&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US) endpoint of the DevOps API.
