...
-   Use the [DevOps - POST /devops/orchestration/changeControl](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/devops-api.md) endpoint of the DevOps API.
