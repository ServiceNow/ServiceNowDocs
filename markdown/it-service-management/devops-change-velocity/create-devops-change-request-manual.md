...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/devops-change-velocity/create-devops-change-request-manual.html
release: xanadu
...
1.  Navigate to **All** &gt; **Change** &gt; **Create New** &gt; **Create Normal Change**.
    ...
    **Note:** For more information on using the Change module, see [Create a Change](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/change-management/t_CreateAChange.md).
...
10. Configure the change window for the change request from the Schedule tab.
    ...
    **Note:** For more information on configuring the schedule, see [Create a Change](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/change-management/t_CreateAChange.md).
