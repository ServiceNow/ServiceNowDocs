...
To learn about the tools that the DevOps Change Velocity application supports, see [DevOps Change Velocity integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/dev-ops-overview.md).

To understand how you can incrementally progress to get value faster using DevOps Change Velocity, see [User journey for DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/user-journey-in-devops-change-velocity.md).
...
-   **[User journey for DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/user-journey-in-devops-change-velocity.md)**  
...
-   **[DevOps Change Velocity integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/dev-ops-overview.md)**  
...
-   **[DevOps dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/insights-dashboard-dev-ops.md)**  
