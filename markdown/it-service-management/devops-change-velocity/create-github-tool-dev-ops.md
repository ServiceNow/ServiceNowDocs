...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/devops-change-velocity/create-github-tool-dev-ops.html
release: australia
...
Complete the steps specified in the [Getting started](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/setting-up-devops-change-velocity.md) section before connecting to a tool.
...
GitHub Tool Credential. See [Setting up GitHub OAuth 2.0 credentials for DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/setting-up-github-oauth-dev-ops.md).
