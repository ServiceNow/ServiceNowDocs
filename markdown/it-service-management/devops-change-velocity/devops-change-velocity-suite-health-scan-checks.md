...
Before working with update sets, create a standard process for moving customizations. For more information, see the General guidelines for planning the update process topic in product documentation.
