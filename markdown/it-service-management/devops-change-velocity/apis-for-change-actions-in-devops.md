...
-   [DevOps - PUT /devops/orchestration/changeInfo/\{changeInfo\}](https://www.servicenow.com/docs/access?context=devops-api&version=zurich&pubname=zurich-api-reference&section=devops-PUT-orch-changeInfo&ft:locale=en-US) to update fields within a specified change request.
