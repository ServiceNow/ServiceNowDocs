...
-   [DevOps - PUT /devops/orchestration/changeInfo/\{changeInfo\}](https://www.servicenow.com/docs/access?context=devops-api&version=xanadu&pubname=xanadu-api-reference&section=devops-PUT-orch-changeInfo&ft:locale=en-US) to update fields within a specified change request.
...
-   Passing the change attributes through the Update function in the orchestration pipeline function. For more information, see the following:
    ...
    -   [Implement custom actions for pipelines using generic Docker container image](servicenow-custom-actions-for-gitlab.md)
