...
Run the generic Docker Container Image to use the following script. For more information, see [Implement custom actions for pipelines using generic Docker container image](servicenow-custom-actions-for-gitlab.md).```
- stage:
