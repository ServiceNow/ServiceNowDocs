...
-   **Notification** \(webhook\) action:
    ...
    See the [Notification capability subflow](creating-dev-ops-subflows.md#section_ep4_txg_w3b) and the DevOps - POST /devops/tool/\{capability\} endpoint of the DevOps API for more details.
