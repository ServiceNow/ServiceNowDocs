...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/devops-change-velocity/update-third-party-tool-credentials-in-devops-change-velocity.html
release: xanadu
...
<table id="choicetable_bvm_p5l_f5b"><thead><tr><th align="left" id="d46314e66">

Option

</th><th align="left" id="d46314e69">

Steps

</th></tr></thead><tbody><tr><td id="d46314e75">
...
-   **[Notifications on tool credential expiration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/notifications-for-tool-credential-expiry.md)**  
