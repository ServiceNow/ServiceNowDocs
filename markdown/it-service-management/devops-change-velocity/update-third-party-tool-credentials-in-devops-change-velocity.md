...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-change-velocity/update-third-party-tool-credentials-in-devops-change-velocity.html
release: yokohama
...
<table id="choicetable_bvm_p5l_f5b"><thead><tr><th align="left" id="d44373e66">

Option

</th><th align="left" id="d44373e69">

Steps

</th></tr></thead><tbody><tr><td id="d44373e75">
...
3.  In the tool record, select **More Actions\(\[Omitted image "more-actions-icon.png"\] Alt text: More Actions icon \) &gt; Update credentials**.
...
-   **[Notifications on tool credential expiration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/notifications-for-tool-credential-expiry.md)**  
