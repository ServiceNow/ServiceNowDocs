...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/devops-change-velocity/dev-ops-change-acceleration.html
release: australia
...
**Note:** ServiceNow [Change Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/change-management/c_ITILChangeManagement.md) must be installed for change acceleration.

Enable and set up change control when you model your pipeline in DevOps:

-   [Model an Azure pipeline in DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/model-azure-pipeline-dev-ops.md)
-   [Model a GitLab basic CI pipeline in DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/model-gitlab-pipeline-dev-ops.md)
-   [Model a Jenkins pipeline in DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/model-jenkins-pipeline-dev-ops.md)
...
For more information on change approval policies, see [Change approval policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/change-management/change-approval-policy.md).
...
If desired, you can write a custom subflow in place of this flow by modifying the **\[sn\_devops.change\_request\_handler\_subflow\]** [DevOps property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/dev-ops-administration.md).
...
-   **Test Summaries \(replaces Test Results related list\)**
    ...
    See [Test Results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/dev-ops-change-acceleration.md) for more details.
...
These [DevOps change properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/dev-ops-administration.md) are available to customize your change request flow.
...
Once you have created the choice list and added it to the script include, you can update [DevOps change properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/dev-ops-administration.md) with the new choice list values. For example, **DevOps change request implement state** `-10`.
...
-   **[Customizing DevOps flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/using-dev-ops-model-change-flow.md)**  
...
-   **[Automate DevOps change request creation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/automate-devops-change-request.md)**  
Modify your pipeline to automatically create a DevOps change request.
-   **[Create a DevOps Change request and associate existing DevOps data — Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/devops-wkspc-chg-create-manual.md)**  
Create a DevOps change request and associate existing DevOps data through the Workspace UI.
-   **[Create a DevOps change request and associate existing DevOps data — Classic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/create-devops-change-request-manual.md)**  
Create a DevOps change request and associate existing DevOps data through the Classic UI.
-   **[DevOps change request without mandating category as DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/create-devops-change-any-category.md)**  
...
-   **[Change request creation with DevOps data retrieval errors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/change-request-creation-with-devops-data-retrieval-errors.md)**  
Create change requests even with errors in DevOps data retrieval.
-   **[Artifacts and packages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/using-dev-ops-release-change.md)**  
...
-   **[DevOps Pipeline UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/dev-ops-pipeline-ui.md)**  
...
-   **[Configuring DevOps change request details within the pipeline](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/dev-ops-config-change-details.md)**  
...
-   **[DevOps change models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/devops-change-multimodel.md)**  
...
-   **[Retrieve change request data using DevOpsChangeRelationshipHelper script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/retrieve-change-request-data-using-devopschangerelationshiphelper-script.md)**  
...
-   **[Manage Pull Requests \(PR\) or Merge Requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/manage-pull-request-pipelines.md)**  
...
-   **[DevOps change request attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/apis-for-change-actions-in-devops.md)**  
...
-   **[Import based evidence collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/import-based-evidence-collection-for-orchestration-capability.md)**  
