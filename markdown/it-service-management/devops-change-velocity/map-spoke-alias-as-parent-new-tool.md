...
-   Ensure that you have set up the connection and credential alias using spoke for Jira, Jenkins and GitHub . For more information, see:
    -   [Jira spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/jira-spoke-v3-0-2.md)
    -   [Jenkins spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/jenkins-spoke.md)
    -   [GitHub spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/github-spoke.md)
