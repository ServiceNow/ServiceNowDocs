...
For more information about the API, see [DevOps - POST /devops/tool/\{capability\}](https://www.servicenow.com/docs/access?context=devops-api&version=australia&pubname=australia-api-reference&section=devops-POST-tool&ft:locale=en-US). To use the API in Azure DevOps, GitHub, and Jenkins, you must use the format mentioned in the respective sections below.
