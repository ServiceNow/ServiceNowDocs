...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/devops-change-velocity/azure-devops-integration-dev-ops.html
release: xanadu
...
The [**ServiceNow DevOps** extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/config-dev-ops-extensions-azure.md) includes:
...
-   For MID Server settings, view the [MID Server support for Data Stream actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/dsa-on-mid.md) section.
...
-   **[Onboard Azure DevOps to DevOps Change Velocity — Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/devops-wkspc-azuredevops-tool-conn.md)**  
...
-   **[Onboard Azure DevOps to DevOps Change Velocity — Service Catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/onboard-azure-devops-service-catalog.md)**  
Create, connect, discover, and configure your Azure DevOps instance using the ServiceNow Service Catalog.
-   **[Onboard Azure DevOps to DevOps Change Velocity — Classic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/create-azure-tool-dev-ops.md)**  
