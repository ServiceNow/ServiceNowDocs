...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/devops-change-velocity/azure-devops-integration-dev-ops.html
release: brazil
...
The [**ServiceNow DevOps** extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/config-dev-ops-extensions-azure.md) includes:
...
-   For MID Server settings, view the [MID Server support for Data Stream actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/dsa-on-mid.md) section.
