...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/devops-change-velocity/onboard-argo-cd-to-devops-change-velocity-workspace.html
release: xanadu
...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d147951e80">

Option

</th><th align="left" id="d147951e83">

Steps

</th></tr></thead><tbody><tr><td id="d147951e89">
...
3.  On the Argo CD instance details playbook activity:
    ...
    3.  Select the MID Server option and enter its details if your Argo CD instance is attached to a MID Server.
        ...
        A MID server is required if your tool instance is hosted on-prem. For more information about MID server, see [MID Server selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/mid-server/c_MIDServerSelector.md).
...
**Parent Topic:**[Argo CD integration with DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/argo-cd-integration-with-devops-change-velocity.md)
