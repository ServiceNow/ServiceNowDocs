...
For more information, see [Create a DevOps tool integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/set-up-dev-ops-integrations.md).
...
-   **Action**
    ...
    -   If the error persists, update the [Tool permission check timeout per record \(in milliseconds\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/devops-reference-error-messages.md) property and try again.
...
For more information, see [Retry errored inbound events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/config-retry-schedule-job-inbound.md)
...
For all SonarQube steps in code quality scans, the user must create SonarQube tool in the ServiceNow DevOps instance.
 ...
 For more information, see [SonarQube integration with DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/sonarqube-devops-integration-devops.md)
