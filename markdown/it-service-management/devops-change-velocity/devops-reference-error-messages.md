...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-change-velocity/devops-reference-error-messages.html
release: yokohama
...
4.  From the Actions section, open the **DevOps Demo Validate Action** record by selecting the Open action in Action Designer \(\[Omitted image "openactionfdicon.png"\] Alt text: Open action in Action Designer icon\) icon.
5.  Select **More Actions menu &gt; Copy Action**.\[Omitted image "validate-action-copy-dialog.png"\] Alt text: Copy action dialog box
...
8.  In the Request Details section, enter resource path of your custom tool in the **Resource Path** field.\[Omitted image "validate-action-copy.png"\] Alt text: Validate action screen
...
15. In the copied subflow, delete the **DevOps Demo Validate Action** action and add the action you created in step 11.\[Omitted image "validate-add-action.png"\] Alt text: Add new action record
...
For more information, see [Create a DevOps tool integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/set-up-dev-ops-integrations.md).
...
-   **Action**
    ...
    -   If the error persists, update the [Tool permission check timeout per record \(in milliseconds\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/devops-reference-error-messages.md) property and try again.
...
For more information, see [Retry errored inbound events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/config-retry-schedule-job-inbound.md)
...
For all SonarQube steps in code quality scans, the user must create SonarQube tool in the ServiceNow DevOps instance.
 ...
 For more information, see [SonarQube integration with DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/sonarqube-devops-integration-devops.md)
