...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/devops-change-velocity/change-request-state-in-jenkins-pipeline-logs.html
release: australia
