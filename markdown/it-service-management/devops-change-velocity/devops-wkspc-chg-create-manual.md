...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-change-velocity/devops-wkspc-chg-create-manual.html
release: yokohama
...
For more information on using Change features, see [Create a Change](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/t_CreateAChange.md).
...
7.  Configure other settings as needed.
    ...
    **Note:** For more information on configuring settings, see [Create a Change](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/t_CreateAChange.md).
