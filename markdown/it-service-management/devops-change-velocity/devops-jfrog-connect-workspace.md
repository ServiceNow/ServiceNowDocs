...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-change-velocity/devops-jfrog-connect-workspace.html
release: yokohama
...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d124314e121">

Option

</th><th align="left" id="d124314e124">

Steps

</th></tr></thead><tbody><tr><td id="d124314e130">
...
3.  On the JFrog instance details playbook activity:
    ...
    4.  Select the MID Server option and enter its details if your JFrog instance is attached to a MID Server.
        ...
        A MID server is required if your tool instance is hosted on-prem. For more information about MID server, see [MID Server selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/mid-server/c_MIDServerSelector.md).
...
**Parent Topic:**[JFrog integration with DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/devops-jfrog-integration.md)
