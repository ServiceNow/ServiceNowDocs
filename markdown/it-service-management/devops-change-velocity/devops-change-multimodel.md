...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/devops-change-velocity/devops-change-multimodel.html
release: zurich
...
For information on resolving this error, see [Common errors in DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-change-velocity/devops-reference-error-messages.md).
...
-   **Configuration of DevOps models**
    ...
    If you want to create your own model instead of using the base system DevOps models, see the instructions in the [Create a Change model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/change-management/create-a-change-model.md) section.
...
See the [Note](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-change-velocity/devops-change-multimodel.md) in the Callback section.
...
</table>-   **[Update change model in pipeline](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-change-velocity/update-change-model-in-pipeline.md)**  
