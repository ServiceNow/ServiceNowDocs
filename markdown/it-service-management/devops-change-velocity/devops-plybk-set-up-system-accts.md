...
<table id="choicetable_g4v_f5r_gwb"><thead><tr><th align="left" id="d234815e88">

Option

</th><th align="left" id="d234815e91">

Steps

</th></tr></thead><tbody><tr><td id="d234815e97">
...
</td></tr><tr><td id="d234815e177">

**Using Classic UI**

</td><td>

Set a password for the DevOps integration user by navigating to **All** &gt; **User Administration** &gt; **Users**. For more information, see [Set password for a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/reset-your-password.md).
