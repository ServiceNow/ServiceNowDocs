...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/devops-change-velocity/onboard-harness-to-devops-change-velocity.html
release: xanadu
...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d220839e86">

Option

</th><th align="left" id="d220839e89">

Steps

</th></tr></thead><tbody><tr><td id="d220839e95">
...
2.  Select an existing application, or create one. To create an application, see [Create an application - Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/app-create-workspace.md).
...
**Parent Topic:**[Harness integration with DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/harness-integration-with-devops-change-velocity.md)
