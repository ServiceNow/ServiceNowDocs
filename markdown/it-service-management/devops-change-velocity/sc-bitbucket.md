...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/devops-change-velocity/sc-bitbucket.html
release: brazil
...
-   Oauth 2.0 - Client Credentials
 For more information, see [Bitbucket integration with DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-change-velocity/bitbucket-integration-dev-ops.md).
