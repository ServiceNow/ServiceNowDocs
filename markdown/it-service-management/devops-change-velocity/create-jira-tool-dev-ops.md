...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/devops-change-velocity/create-jira-tool-dev-ops.html
release: zurich
...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d365248e100">

Option

</th><th align="left" id="d365248e103">

Steps

</th></tr></thead><tbody><tr><td id="d365248e109">
...
For information on obtaining the value of Cloud ID, see [Obtain the value of Cloud ID](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/setup-jira-serv-mgmt.md).
...
6.  To send data in real time between DevOps and your Jira instance, select **Configure**.
    ...
    To configure manually, select **Configure manually**. See [Configure webhooks in Jira manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-change-velocity/config-webhooks-jira-manually.md) for more information.
...
-   **[Connect a Jira tool using OAuth 2.0 with 3LO](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-change-velocity/connect-a-jira-tool-using-oauth-2-0-with-3lo.md)**  
