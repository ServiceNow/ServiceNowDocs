...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d243858e100">

Option

</th><th align="left" id="d243858e103">

Steps

</th></tr></thead><tbody><tr><td id="d243858e109">
...
For information on obtaining the value of Cloud ID, see [Obtain the value of Cloud ID](https://www.servicenow.com/docs/access?context=setup-jira-spk-opt2&version=xanadu&pubname=xanadu-integrate-applications&section=jira-cloud-id&ft:locale=en-US).
