...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d357565e100">

Option

</th><th align="left" id="d357565e103">

Steps

</th></tr></thead><tbody><tr><td id="d357565e109">
...
For information on obtaining the value of Cloud ID, see [Obtain the value of Cloud ID](https://www.servicenow.com/docs/access?context=setup-jira-serv-mgmt&version=zurich&pubname=zurich-integrate-applications&section=jira-cloud-id&ft:locale=en-US).
