...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-change-velocity/create-jira-tool-dev-ops.html
release: yokohama
...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d361586e100">

Option

</th><th align="left" id="d361586e103">

Steps

</th></tr></thead><tbody><tr><td id="d361586e109">
...
For information on obtaining the value of Cloud ID, see [Obtain the value of Cloud ID](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/setup-jira-serv-mgmt.md).
...
\[Omitted image "jira-plybk-10.png"\] Alt text: Enter Jira Cloud instance details for OAuth 2.0 authentication
...
6.  To send data in real time between DevOps and your Jira instance, select **Configure**.
    ...
    To configure manually, select **Configure manually**. See [Configure webhooks in Jira manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/config-webhooks-jira-manually.md) for more information.
