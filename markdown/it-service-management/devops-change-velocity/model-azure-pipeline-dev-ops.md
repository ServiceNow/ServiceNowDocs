...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-change-velocity/model-azure-pipeline-dev-ops.html
release: yokohama
...
</table>        You can set up change control in your Azure DevOps YAML or Classic Azure pipeline using the [Azure Invoke REST API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/dev-ops-azure-change-control-api.md) or the [ServiceNow DevOps extension for Azure DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/config-dev-ops-extensions-azure.md).


## What to do next

[Configure the Azure pipeline for DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/config-azure-pipeline-dev-ops.md)
