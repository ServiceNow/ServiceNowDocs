...
GitLab pipeline parallel stages is supported with GitLab Docker Image. For more details, see [GitLab pipelines with parallel jobs](gitlab-parallel-stages.md) and [Implement custom actions for pipelines using generic Docker container image](servicenow-custom-actions-for-gitlab.md).
