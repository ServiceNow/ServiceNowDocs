...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-change-velocity/run-health-scan-check.html
release: yokohama
...
4.  Select **Execute suite scan**.
    ...
    For information on the scans available for the DevOps suite, see [DevOps Change Velocity suite health scan checks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/devops-change-velocity-suite-health-scan-checks.md).
