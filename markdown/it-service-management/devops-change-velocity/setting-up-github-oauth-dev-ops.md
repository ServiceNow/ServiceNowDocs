...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/devops-change-velocity/setting-up-github-oauth-dev-ops.html
release: xanadu
...
-   **[OAuth 2.0 credentials for GitHub Apps - JWT](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/dev-ops-github-apps-oath-jwt.md)**  
Perform the following steps to integrate your GitHub Apps using the JWT bearer token.
-   **[OAuth 2.0 credentials for GitHub Apps - Authorization Code](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-change-velocity/dev-ops-github-apps-oauth-auth.md)**  
