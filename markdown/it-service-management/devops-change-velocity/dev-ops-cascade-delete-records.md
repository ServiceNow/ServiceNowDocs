...
![DevOps delete record](../image/dev-ops-delete-record.png)

![DevOps delete record warning](../image/dev-ops-delete-record-warning.png)

![DevOps delete record cascade](../image/dev-ops-delete-record-cascade.png)
