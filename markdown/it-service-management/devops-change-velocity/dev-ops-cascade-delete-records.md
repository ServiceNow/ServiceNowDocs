...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/devops-change-velocity/dev-ops-cascade-delete-records.html
release: zurich
...
A pipeline record can be deleted only if no pipeline executions from other pipelines are dependent on the artifact versions generated by the pipeline executions of the deleted pipeline.
