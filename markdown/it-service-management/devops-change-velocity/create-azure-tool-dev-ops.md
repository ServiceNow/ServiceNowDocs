...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/devops-change-velocity/create-azure-tool-dev-ops.html
release: australia
...
To [customize Azure Boards import](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/dev-ops-azure-work-item-import.md) of work item states or types, use the **DevOpsAzureDevOpsWorkItemHelper** script include.
...
For Azure pipelines, [Model an Azure pipeline in DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/model-azure-pipeline-dev-ops.md) to complete the configuration in DevOps Change Velocity.
