...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d407989e96">

Option

</th><th align="left" id="d407989e99">

Steps

</th></tr></thead><tbody><tr><td id="d407989e105">
...
<table id="choicetable_krv_ykg_42c"><thead><tr><th align="left" id="d407989e272">

Tool

</th><th align="left" id="d407989e275">

Steps

</th></tr></thead><tbody><tr><td id="d407989e281">
...
3.  If your Bitbucket instance is attached to a MID Server, select the MID Server option and enter its details. A MID server is required if your tool instance is hosted on-prem. For more information about MID server, see MID Server selection.
![Enter Bitbucket instance details page for Bitbucket Server](../image/bitbucket-connect-server.png)

</td></tr><tr><td id="d407989e318">
