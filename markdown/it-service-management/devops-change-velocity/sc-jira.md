...
Pre-requisites:
    ...
    -   
    -   [Obtain the value of Cloud ID](https://www.servicenow.com/docs/access?context=setup-jira-spk-opt2&version=xanadu&pubname=xanadu-integrate-applications&section=jira-cloud-id&ft:locale=en-US)
    -   
