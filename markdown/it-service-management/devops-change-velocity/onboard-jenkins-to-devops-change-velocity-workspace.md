...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/devops-change-velocity/onboard-jenkins-to-devops-change-velocity-workspace.html
release: australia
...
<table id="choicetable_m3t_ky1_fwb"><thead><tr><th align="left" id="d45090e127">

Option

</th><th align="left" id="d45090e130">

Steps

</th></tr></thead><tbody><tr><td id="d45090e136">
...
3.  On the **Jenkins instance details** playbook activity:
    ...
    2.  Enter the login credentials \(password or access token or API token\) of the Jenkins instance.
        ...
        To generate API token, see [Connect to Jenkins using API token authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/authenticate-jenkins-using-api-token.md).
...
8.  Install the ServiceNow DevOps plugin for Jenkins.
    ...
    For more information on the extension, see [Configure Jenkins plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/configure-jenkins-plugin.md).
...
9.  Select **Configure** to automatically set up **ServiceNow DevOps Configuration** in your Jenkins instance.
    ...
    **Important:**
    ...
    To configure webhooks manually in Jenkins, see [Configure webhooks manually for Jenkins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-change-velocity/configure-jenkins-plugin.md).
