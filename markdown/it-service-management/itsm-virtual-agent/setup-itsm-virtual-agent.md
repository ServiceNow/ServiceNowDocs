...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/itsm-virtual-agent/setup-itsm-virtual-agent.html
release: zurich
...
4.  [Configure Natural Language Understanding \(NLU\) in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/configure-nlu-settings.md).
