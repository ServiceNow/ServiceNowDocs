...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/itsm-virtual-agent/setup-itsm-virtual-agent.html
release: yokohama
...
4.  [Configure Natural Language Understanding \(NLU\) in Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/conversational-interfaces/virtual-agent/configure-nlu-settings.md).
