...
To view, train, or retrain the NLU model, see [Train and test your model in Virtual Agent Designer](https://www.servicenow.com/docs/access?context=train-test-publish-nlu-model-vad&version=australia&pubname=australia-conversational-interfaces&ft:locale=en-US).
...
[Using Virtual Agent for Issue Auto Resolution](https://www.servicenow.com/docs/access?context=auto-resolution-va&version=australia&pubname=australia-conversational-interfaces&ft:locale=en-US)
