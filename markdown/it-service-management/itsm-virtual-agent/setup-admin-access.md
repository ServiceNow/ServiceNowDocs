...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/itsm-virtual-agent/setup-admin-access.html
release: zurich
...
1.  Install the Agent Client Collector Spoke plugin on the instance according to the [Agent Client Collector installation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/acc-installation.md) instructions.
...
5.  Duplicate and activate the Local Admin Access topic in the ITSM scope.
    ...
    To view, duplicate, preview, or publish IT Service Management topics in the Virtual Agent Designer, see [Getting started with Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/conversation-designer-virtual-agent.md).
