...
**Note:** End users must be using [Client Software Distribution](https://www.servicenow.com/docs/access?context=c_ClientSoftwareDistribution&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
