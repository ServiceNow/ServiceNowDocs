...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/itsm-virtual-agent/itsm-va-it-issues-generic.html
release: zurich
...
-   [Agent Client Collector spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/acc-spoke.md) \(com.sn.acc.spoke\)
...
To set up and use the Local Admin Access topic, refer to [Set up the Local Admin Access topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/itsm-virtual-agent/setup-admin-access.md).
