...
-   [Agent Client Collector spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/acc-spoke.md) \(com.sn.acc.spoke\)
...
To set up and use the Local Admin Access topic, refer to [Set up the Local Admin Access topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/itsm-virtual-agent/setup-admin-access.md).
