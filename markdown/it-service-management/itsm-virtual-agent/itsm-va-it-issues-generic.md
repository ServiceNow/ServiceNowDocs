...
-   [Agent Client Collector spoke](https://www.servicenow.com/docs/access?context=acc-spoke&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US) \(com.sn.acc.spoke\)
