...
Requirement: [Microsoft Teams Communication spoke](https://www.servicenow.com/docs/access?context=msteams-comm&version=australia&pubname=australia-integrate-applications&ft:locale=en-US) \(sn\_msteams\_com\_spk\) plugin
...
For more information, see [Password Reset for Virtual Agent](https://www.servicenow.com/docs/access?context=password-reset-for-virtual-agent&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
...
For information about this topic block, see [Service Catalog topic blocks in Virtual Agent](https://www.servicenow.com/docs/access?context=request-topic-blocks-va&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
