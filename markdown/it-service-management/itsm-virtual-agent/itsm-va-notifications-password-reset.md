...
For more information about configuring password expiration, see [Configure password expiration reminder](https://www.servicenow.com/docs/access?context=password-reset-expiration-setup&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
