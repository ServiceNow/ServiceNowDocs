...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/itsm-virtual-agent/manage-citrix-convo-flow.html
release: xanadu
...
This topic uses the Request Catalog Item [Service Catalog topic block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/service-catalog/request-topic-blocks-va.md).
