...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/itsm-virtual-agent/manage-citrix-convo-flow.html
release: yokohama
...
This topic uses the Request Catalog Item [Service Catalog topic block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/service-catalog/request-topic-blocks-va.md).
