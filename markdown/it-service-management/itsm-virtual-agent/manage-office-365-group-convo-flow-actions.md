...
Requirement: [Microsoft Azure AD spoke](https://www.servicenow.com/docs/access?context=set-up-azure&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) \(com.sn.azure\_ad.spoke\) plugin
