...
Requirement: [Microsoft AD spoke](https://www.servicenow.com/docs/access?context=microsoft-ad-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) for Integration Hub \(com.sn.ad.spoke\) plugin
