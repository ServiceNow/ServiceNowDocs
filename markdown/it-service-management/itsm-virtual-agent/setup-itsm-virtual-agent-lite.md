...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/itsm-virtual-agent/setup-itsm-virtual-agent-lite.html
release: yokohama
...
5.  Select **Publish** to publish the topic.
    ...
    **Note:** For details about activating and publishing conversation topics, see [Getting started with Virtual Agent Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/conversational-interfaces/virtual-agent/conversation-designer-virtual-agent.md).
...
-   **[ITSM Virtual Agent Lite pre-built topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/itsm-virtual-agent/itsm-virtual-agent-lite-topics.md)**  
...
**Parent Topic:**[ITSM Virtual Agent Lite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/itsm-virtual-agent/itsm-virtual-agent-lite.md)
