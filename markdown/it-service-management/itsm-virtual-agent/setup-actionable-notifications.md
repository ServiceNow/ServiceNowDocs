...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/itsm-virtual-agent/setup-actionable-notifications.html
release: yokohama
...
2.  Activate Workflow Studio flows for specific actionable notifications ITSM Virtual Agent conversations.
    ...
    These topics are inactive by default. For complete details about activating flows, refer to [Activate a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/workflow-studio/flow-activate.md).
...
3.  [Enable notifications in Virtual Agent.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/conversational-interfaces/virtual-agent/enable-va-notifications.md)
