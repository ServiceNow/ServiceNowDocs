...
2.  Activate Workflow Studio flows for specific actionable notifications ITSM Virtual Agent conversations.
    ...
    These topics are inactive by default. For complete details about activating flows, refer to [Activate a flow](https://www.servicenow.com/docs/access?context=flow-activate&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
...
3.  [Enable notifications in Virtual Agent.](https://www.servicenow.com/docs/access?context=enable-va-notifications&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US)
