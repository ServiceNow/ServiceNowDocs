...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/itsm-virtual-agent/itsm-va-self-service-topics.html
release: zurich
...
Requirement: [Microsoft Exchange Online spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/ms-exch-online-spoke.md) \(sn\_ex\_online\_spke\)
...
Requirement: [Microsoft Exchange Server spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/msexchangeserver-spoke.md) \(sn\_exchange\_spoke\)
...
This topic is deprecated. Use [Reset Password](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/itsm-virtual-agent/itsm-password-management.md) instead.
...
-   [Microsoft Exchange Online spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/ms-exch-online-spoke.md) \(com.sn.msexchange.spoke\)
-   [Zoom spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/zoom-spoke.md) \(com.sn.zoom.spoke\)
...
This topic uses the following [topic blocks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/itsm-virtual-agent/itsm-va-topic-blocks.md):
...
Requirement: [Predictive Intelligence for Incident plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/request-predictive-intelligence-for-im.md) \(com.snc.incident.ml\)
...
**Note:** While you can use the Submit a request topic to search for and request catalog items, the recommended method is to use the [Fallback setup topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/working-setup-topics.md).
...
This topic uses the following [Service Catalog topic blocks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/request-topic-blocks-va.md):
...
Requirement: [Walk-up Experience plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/walk-up-experience/activate-walkup-experience.md) \(com.snc.walkup\)
...
-   [Microsoft Azure Active Directory spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/microsoft-azure-ad-spoke.md) \(com.sn.azure\_ad.spoke\)
