...
For more information on pattern customization, see [Discovery patterns used by ITOM Visibility](https://www.servicenow.com/docs/access?context=c_MappingPatternsCustomization&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
...
If the software product has an edition that is not being discovered, [Manually override SAM Foundation edition value in classic](t_ManOverrideEditionSAMF.md) so the software can be successfully reconciled.
