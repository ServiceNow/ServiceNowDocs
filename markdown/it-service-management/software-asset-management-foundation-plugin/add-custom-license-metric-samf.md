...
Custom metrics can be disabled using the custom license metric [property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/software-asset-management-foundation-plugin/sam-properties-samf.md). This feature is enabled by default.
