...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/software-asset-management-foundation-plugin/add-custom-license-metric-samf.html
release: xanadu
...
Custom metrics can be disabled using the custom license metric [property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/software-asset-management-foundation-plugin/sam-properties-samf.md). This feature is enabled by default.
