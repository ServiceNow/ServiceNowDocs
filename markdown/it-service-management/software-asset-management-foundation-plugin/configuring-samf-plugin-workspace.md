...
If software models haven't automatically been created, you need to manually create software models. For information on creating software models, see [Create a Software Asset Management Foundation software model in workspace](../task/Create-samf-software-model-workspace.md)

-   **[Create a Software Asset Management Foundation entitlement in workspace](../task/create-samf-entitlement-workspace.md)**  
...
-   **[Create a Software Asset Management Foundation software model in workspace](../task/Create-samf-software-model-workspace.md)**  
