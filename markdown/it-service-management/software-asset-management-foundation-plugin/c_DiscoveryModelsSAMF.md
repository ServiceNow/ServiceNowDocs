...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/software-asset-management-foundation-plugin/c\_DiscoveryModelsSAMF.html
release: xanadu
...
There is a difference between [software models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/software-asset-management-foundation-plugin/t_AddASoftwareModelSAMF.md) and software discovery models.
...
[Status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/software-asset-management-foundation-plugin/c_SAMDiscoverySAMF.md) of the normalization process:-   Manually Normalized
-   New
...
Override of the software edition setting.If the edition for the software was not discovered, you can edit this field to set the edition, if known, so reconciliation can be performed successfully.
 ...
 For more information, see [Manually override SAM Foundation edition value in classic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/software-asset-management-foundation-plugin/t_ManOverrideEditionSAMF.md).
...
</table>**Parent Topic:**[Exploring Software Asset Management Foundation plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/software-asset-management-foundation-plugin/exploring-sam-foundation.md)
