...
For more information, see [Collect software data with either SCCM or Discovery](https://www.servicenow.com/docs/access?context=c_DiscoveryAndSCCMTogether&version=xanadu&pubname=xanadu-it-operations-management&section=collect-software-data-sccm-disco&ft:locale=en-US) and [Discovery with Software Asset Management](https://www.servicenow.com/docs/access?context=c_DiscoSWAssetMgmtTableSchema&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).

**Note:** To use Discovery, the [Request Discovery](https://www.servicenow.com/docs/access?context=t_ActivateTheDiscoveryPlugin&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US) must be activated.
