...
4.  In the Create New Software Entitlement page, fill in the fields.
    ...
    For a detailed description of the fields, see [Create a Software Asset Management Foundation plugin entitlement in classic](t_AddASoftwareEntitlementSAMF.md).
