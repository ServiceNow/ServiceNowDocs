...
You can also track a software model lifecycle phase for use with the [Technology Portfolio Management - Legacy](https://www.servicenow.com/docs/access?context=technology-portfolio-management&version=zurich&pubname=zurich-application-portfolio-management&ft:locale=en-US).
