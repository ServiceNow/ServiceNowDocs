...
-   **[Create a Software Asset Management Foundation plugin entitlement in classic](../task/t_AddASoftwareEntitlementSAMF.md)**  
Software entitlements enable you to define license details that are matched to software models.
-   **[Create a Software Asset Management Foundation plugin software model in classic](../task/t_AddASoftwareModelSAMF.md)**  
...
-   **[Manually normalize a SAM Foundation software discovery model in classic](../task/t_EditASoftwareDiscModelSAMF.md)**  
...
-   **[Manually override SAM Foundation edition value in classic](../task/t_ManOverrideEditionSAMF.md)**  
