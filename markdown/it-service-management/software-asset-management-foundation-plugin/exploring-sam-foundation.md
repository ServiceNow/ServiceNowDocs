...
For detailed information on configuring and using the classic Software Asset Management Foundation plugin application, refer to [Configuring Software Asset Management Foundation plugin classic](samf-plugin-configuration.md) and [Using Software Asset Management classic](https://www.servicenow.com/docs/access?context=using-sam-classic&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).
