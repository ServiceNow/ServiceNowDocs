...
-   [Add a custom license metric](https://www.servicenow.com/docs/access?context=add-custom-license-metric&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US)
