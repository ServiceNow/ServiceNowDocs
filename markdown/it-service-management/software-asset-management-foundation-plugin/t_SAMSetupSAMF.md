...
2.  Determine whether Discovery is activated \(see [Request Discovery](https://www.servicenow.com/docs/access?context=t_ActivateTheDiscoveryPlugin&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US)\).
    ...
    -   If not, activate and configure Discovery.
        ...
        For more information, see [Discovery](https://www.servicenow.com/docs/access?context=r-discovery&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
