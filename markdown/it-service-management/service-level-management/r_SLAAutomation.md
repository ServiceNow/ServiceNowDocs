...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-level-management/r\_SLAAutomation.html
release: xanadu
...
-   **[Run the 2011 SLA engine asynchronously](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-level-management/t_RunSLABusinessRule.md)**  
...
-   **[Recalculate SLA times automatically](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-level-management/t_SLACalculationOnTaskDisplay.md)**  
By default when a user opens a task, the SLA timing information for that task is not automatically recalculated.
-   **[Use exact times in SLA calculations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-level-management/t_SLABreachCalculation.md)**  
When business percentages are used for SLA calculations, they are rounded up to two decimal places.

**Parent Topic:**[Using Service Level Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-level-management/using-service-level-management.md)
