...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-level-management/r\_ManageSLARepair.html
release: xanadu
...
**Note:** Repair actions will not be available for instances that are not running the 2011 engine. To enable or disable SLA repair, use the **com.snc.sla.repair.enabled** repair property. You can also configure SLA workflow usage.
