...
breadcrumb: [Create and manage definition, Define and manage configuration, Configure, Service Level Management, IT Service Management]
---
...
This field appears only when the relative duration is selected in the **Duration type** field. For more information, see [SLA duration types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-level-management/c_SLADuration.md).
...
For more information, see [Time zones in SLAs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-level-management/c_TimeZonesInSLAs.md).
