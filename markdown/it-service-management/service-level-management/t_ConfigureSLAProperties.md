...
Logging level for SLARepair \([SLA repair](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/service-level-management/c_RepairSLAs.md) must be enabled to use this\)
...
Navigate to **Service Level Management** &gt; **Properties** &gt; **SLA Repair** to view [SLA repair](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/service-level-management/c_RepairSLAs.md) properties.
