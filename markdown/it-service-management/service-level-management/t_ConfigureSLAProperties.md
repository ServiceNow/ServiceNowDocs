...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-level-management/t\_ConfigureSLAProperties.html
release: xanadu
...
Logging level for SLARepair \([SLA repair](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-level-management/c_RepairSLAs.md) must be enabled to use this\)
...
Navigate to **Service Level Management** &gt; **Properties** &gt; **SLA Repair** to view [SLA repair](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-level-management/c_RepairSLAs.md) properties.
...
-   Learn more: [Configure SLA repair](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-level-management/r_ManageSLARepair.md)
