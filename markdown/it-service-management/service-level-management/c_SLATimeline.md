...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/service-level-management/c\_SLATimeline.html
release: yokohama
...
\[Omitted image "SLATimeline.png"\] Alt text: SLA Timeline
...
\[Omitted image "SLAFilter.png"\] Alt text: SLA filter icon
...
\[Omitted image "SLATaskRecordPicker.png"\] Alt text: Task Record Picker
...
\[Omitted image "SLAZoom.png"\] Alt text: Zoom In/Out
...
\[Omitted image "SLALegendList.png"\] Alt text: SLA Legend List
...
\[Omitted image "SLAConfigurationToggle.png"\] Alt text: SLA Configuration Toggle Button
...
\[Omitted image "SLARefresh.png"\] Alt text: Refresh
 ...
 **Note:** Click \[Omitted image "SLALeftCarousel.png"\] Alt text: Left Carousel in SLA Timeline and \[Omitted image "SLARightCarousel.png"\] Alt text: Right Carousel in SLA Timeline to navigate to the left and right task update in the details section.
...
-   **[Understand why an SLA did not trigger as expected](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-level-management/why-sla-did-not-trigger.md)**  
Describes the conditions when an SLA might not trigger as expected.
-   **[Use SLA timeline to determine business schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-level-management/sla-timeline-determines-bus-schedule.md)**  
...
-   **[Use SLA timeline to understand SLA stage change](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-level-management/understand-sla-stage-change.md)**  
Describes how you can understand SLA stage changes using SLA timeline.
-   **[Use SLA Timeline to validate a new SLA definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-level-management/validate-new-sla-definition.md)**  
...
**Parent Topic:**[Service Level Management reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-level-management/service-level-management-reference.md)
