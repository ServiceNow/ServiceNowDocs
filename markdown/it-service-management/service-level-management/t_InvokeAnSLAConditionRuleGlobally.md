...
2.  Change the value of the **com.snc.sla.default\_conditionclass** [SLA property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/service-level-management/t_ConfigureSLAProperties.md) to the new condition rule name:
