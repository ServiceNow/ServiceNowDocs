...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/coaching/cf-coaching-reference.html
release: brazil
product: Coaching
...
The business rule **Evaluate coaching opportunity on tasks** initiates coaching for tables that extend Task. You can copy this business rule and modify it for tables that don't extend the Task table.
...
</table>-   **[Coaching roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/coaching/cf-coaching-roles.md)**  
Assign Coaching roles to specify what different users can see and do.
-   **[Coaching properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/coaching/cf-coaching-properties.md)**  
...
-   **[Integrating Coaching with other applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/coaching/cf-coaching-integration.md)**  
Bring in data from other ServiceNow applications to enhance the training of your agents.
-   **[Resolve Coaching issues](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/coaching/cf-coaching-troubleshooting.md)**  
Resolve common issues when setting up or running Coaching.
-   **[Domain separation and Coaching](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/coaching/cf-domain-separation-coaching.md)**  
...
-   **[Quick start tests for Coaching](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/coaching/cf-quick-start-tests-coaching.md)**  
