...
<table id="choicetable_wfs_345_4lb"><thead><tr><th align="left" id="d399714e68">

To create using

</th><th align="left" id="d399714e71">

Do this

</th></tr></thead><tbody><tr><td id="d399714e77">
...
4.  Fill in the fields in the **Snapshot Settings** tab.
    ...
    2.  To use an advanced script, select the **Advanced** check box and add your script.
        ...
        See [Scripts](https://www.servicenow.com/docs/access?context=c_Script&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) for more information on scripting.
