...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/coaching/cf-create-coaching-opportunity.html
release: zurich
product: Coaching
...
<table id="choicetable_wfs_345_4lb"><thead><tr><th align="left" id="d410109e68">

To create using

</th><th align="left" id="d410109e71">

Do this

</th></tr></thead><tbody><tr><td id="d410109e77">
...
3.  Fill in the fields on the Coaching Opportunity form.
    ...
    5.  Add the condition for the critical moment in the **Trigger** fields.
        ...
        See [Common ITSM assessment triggers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/coaching/cf-coaching-overview.md) for examples.
...
4.  Fill in the fields in the **Snapshot Settings** tab.
    ...
    2.  To use an advanced script, select the **Advanced** check box and add your script.
        ...
        See [Scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/scripts/c_Script.md) for more information on scripting.
...
7.  Fill in the fields in the **Related KPIs** tab.
    ...
    2.  Select the **Strategic objective** affected by the coaching opportunity in the **Strategic objective** field.
        ...
        **Note:** You can set strategic objectives by navigating to **Continual Improvement** &gt; **Strategy Objectives**.
        ...
        You can add [assigned trainings and virtual coach](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/coaching/cf-identify-learning-content.md) items to the related lists, if applicable, to complete the coaching opportunity.
