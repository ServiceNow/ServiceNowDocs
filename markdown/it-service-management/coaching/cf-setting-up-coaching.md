...
Access the [Survey designer](https://www.servicenow.com/docs/access?context=c_SurveyDesigner&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) for Coaching by navigating to **Survey** &gt; **Survey Designer**.

Access the Coaching [Survey definitions](https://www.servicenow.com/docs/access?context=c_SurveyDefinitions&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) by navigating to **Coaching** &gt; **Coaching Surveys**.
