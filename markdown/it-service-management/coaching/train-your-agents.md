...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/coaching/train-your-agents.html
release: xanadu
product: Coaching
...
-   You must have the [Workforce Optimization for ITSM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/workforce-optimization-for-it-service-management/activate-configurable-workforce-optimization-itsm.md) application installed.
-   You must integrate Coaching With Learning with third-party learning management systems. For information on how to perform this integration, see [Integrating Learning Core with third-party learning management systems](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/learning-core/setup-learning-third-party-1.md).
