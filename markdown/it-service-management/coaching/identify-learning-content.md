...
Enable to set advanced conditions. See [Scripts](https://www.servicenow.com/docs/access?context=c_Script&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US) for more information on scripting.
