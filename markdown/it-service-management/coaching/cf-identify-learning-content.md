...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/coaching/cf-identify-learning-content.html
release: zurich
product: Coaching
...
Enable to set advanced conditions. See [Scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/scripts/c_Script.md) for more information on scripting.
