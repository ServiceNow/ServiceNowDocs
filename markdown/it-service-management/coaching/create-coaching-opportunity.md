...
<table id="choicetable_wfs_345_4lb"><thead><tr><th align="left" id="d200992e68">

To create using

</th><th align="left" id="d200992e71">

Do this

</th></tr></thead><tbody><tr><td id="d200992e77">
...
3.  Fill in the fields on the Coaching Opportunity form.
    ...
    5.  Add the condition for the critical moment in the **Trigger** fields.
        ...
        See [Common ITSM assessment triggers](../concept/coaching-overview.md#section_b5h_3cd_gfb) for examples.
...
4.  Fill in the fields in the **Snapshot Settings** tab.
    ...
    2.  To use an advanced script, select the **Advanced** check box and add your script.
        ...
        See [Scripts](https://www.servicenow.com/docs/access?context=c_Script&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US) for more information on scripting.
...
7.  Fill in the fields in the **Related KPIs** tab.
    ...
    2.  Select the **Strategic objective** affected by the coaching opportunity in the **Strategic objective** field.
        ...
        **Note:** You can set strategic objectives by navigating to **Continual Improvement** &gt; **Strategy Objectives**.
        ...
        You can add [assigned trainings and virtual coach](identify-learning-content.md) items to the related lists, if applicable, to complete the coaching opportunity.
...
[Coaching field descriptions](../reference/coaching-field-descriptions.md)
