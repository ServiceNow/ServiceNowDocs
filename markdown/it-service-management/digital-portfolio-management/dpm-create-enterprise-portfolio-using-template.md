...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-portfolio-management/dpm-create-enterprise-portfolio-using-template.html
release: yokohama
...
2.  Select the enterprise portfolios icon \(\[Omitted image "enterprise-portfolio-icon-purple.png"\] Alt text: Enterprise portfolios icon.\).

3.  Select **Create enterprise portfolio**.

4.  Select the type of enterprise portfolio: service portfolio, business application portfolio, or application service portfolio.
...
<table id="choicetable_k4w_m1j_q2c"><thead><tr><th align="left" id="d62705e114">

Option

</th><th align="left" id="d62705e117">

Steps

</th></tr></thead><tbody><tr><td id="d62705e123">

**Build your own portfolio**

</td><td>

1.  Select **Create portfolio**.
2.  In the form, fill in the fields.


</td></tr><tr><td id="d62705e144">
...
2.  Select a way to use the template: Either apply everything from the template or exclude services.
3.  Select **Use template**.


</td></tr></tbody>
</table><table id="table_ijw_gfx_msb"><thead><tr><th>
...
7.  Add KPI groups.
    ...
    For more information on KPI groups, see [Create KPI groups and mappings in Digital Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/digital-portfolio-management/dpm-create-kpi-groups.md).
