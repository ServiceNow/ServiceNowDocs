...
A list of the offerings that depend on this service instance. The number of offerings is in a gray box. Select an offering for its details.
 ...
 For information on offering details, see [View service and service offering details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-portfolio-management/dpm-service-details.md).
