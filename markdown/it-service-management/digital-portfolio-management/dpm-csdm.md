...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-portfolio-management/dpm-csdm.html
release: yokohama
...
Service portfolios viewed in DPM display the phase \(or stage\) field and the status field in the header of each business and technical service and service offering. The field values come from the service table \[cmdb\_ci\_service\].
...
How you establish relationships between your solutions and configuration items \(CIs\) varies depending on your situation. For more information, see [CI relationships in the CSDM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/ci-relationships.md).

-   **[CSDM terms for Digital Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/digital-portfolio-management/dpm-common-terms.md)**  
