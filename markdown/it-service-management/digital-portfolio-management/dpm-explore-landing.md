...
-   Fields to enable you to search, filter, and personalize what you see on your DPM Workspace homepage. For more information, see [Personalize the Digital Portfolio Management Workspace homepage](../task/dpm-personalize-homepage.md).
...
1.  Solution name and type \(service, service offering, business application, or application service\).
2.  Actions menu ![Actions menu icon](../../../administer/on-call-scheduling/image/icon-actions.png) to view the solution's details, its relationship map, or remove the item from your homepage. For more information, see [Personalize the Digital Portfolio Management Workspace homepage](../task/dpm-personalize-homepage.md).
...
DPM comes with default thresholds for Needs attention attributes. You’re encouraged to personalize the thresholds to define your metrics for good, moderate, and severe. See [Personalize the Digital Portfolio Management Workspace homepage](../task/dpm-personalize-homepage.md).
...
[Personalize the Digital Portfolio Management Workspace homepage](../task/dpm-personalize-homepage.md)
