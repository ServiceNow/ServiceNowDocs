...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-portfolio-management/dpm-business-apps-details.html
release: yokohama
...
Performance details about the business application. You can select a card indicator in each section to view its details. Each indicator has an information icon \(\[Omitted image "information-icon.jpg"\] Alt text: Information icon.\) that when selected, provides a tooltip description for that indicator.
