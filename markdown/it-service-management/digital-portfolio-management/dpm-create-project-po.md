...
If you want different templates, then your administrator must create them on the tables that correspond to what you want to see insights for. For information on creating templates, see [Create Process Mining templates](../../configurable-workforce-optimization-itsm/task/create-template-po-wfo-itsm.md).
...
4.  See the Process Mining insights and variations for selected KPI records.
    ...
    2.  Select the enterprise portfolios icon \(![Enterprise portfolios icon.](../image/enterprise-portfolio-gray.png), and then open an enterprise portfolio.
