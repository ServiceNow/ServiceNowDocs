...
For details on the Unified Map panels and navigation, see [Unified Map](https://www.servicenow.com/docs/access?context=cmdb-workspace-unified-map&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
-   Select ![Application services icon.](../../../common/image/icon-pipelines.png) to see the application services associated with the selected solution.
