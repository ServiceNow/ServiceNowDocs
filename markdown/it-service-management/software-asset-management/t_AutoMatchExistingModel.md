...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/software-asset-management/t\_AutoMatchExistingModel.html
release: yokohama
...
5.  If no match is found, create a new model.
    ...
    For more information on software installation and usage records, see [Determine where software is installed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/software-asset-management/c_DeterminWhereSWInstalled.md).
