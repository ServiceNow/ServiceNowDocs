...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/software-asset-management/t\_AutoMatchExistingModel.html
release: xanadu
...
5.  If no match is found, create a new model.
    ...
    For more information on software installation and usage records, see [Determine where software is installed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/software-asset-management/c_DeterminWhereSWInstalled.md).
