...
-   **[Calculate software licenses using the legacy Software Asset Management plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/software-asset-management/r_CalculateSoftwareLicenses.md)**  
Software calculations use license calculation types to determine how software licenses are counted in your organization.
-   **[License calculation types supported by the legacy Software Asset Management plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/software-asset-management/r_LicenseCalculationTypes.md)**  
...
-   **[Create a custom license type for the legacy Software Asset Management plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/software-asset-management/t_CreateACustomLicenseType.md)**  
...
-   **[Create a custom script for a legacy Software Asset Management plugin license type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/software-asset-management/r_CreateTheScript.md)**  
