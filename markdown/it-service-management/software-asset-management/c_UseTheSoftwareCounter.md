...
**Note:** For information about the scheduled job that runs all counters each day or the steps to run all counters manually, see [Scheduling Software Counts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/software-asset-management/t_ScheduleASoftwareCount.md).
