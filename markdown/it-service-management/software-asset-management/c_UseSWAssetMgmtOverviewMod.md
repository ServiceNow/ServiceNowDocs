...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/software-asset-management/c\_UseSWAssetMgmtOverviewMod.html
release: yokohama
...
-   Immediate Compliance: number of licenses that should be purchased in order to be compliant immediately. Compliance is based on grouping. When tracking software licenses at a high level without any grouping, you are more likely to be compliant. With grouping, you are more likely to be out of compliance. For example, if grouping regionally by location, your organization can be globally compliant, but regionally non-compliant.
-   Planned Compliance: based on the number of licenses you plan to allocate and the number installed.
...
**Parent Topic:**[Legacy Software Asset Management plugin Overview module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/software-asset-management/c_SWAssetMgmtOverviewMod.md)
