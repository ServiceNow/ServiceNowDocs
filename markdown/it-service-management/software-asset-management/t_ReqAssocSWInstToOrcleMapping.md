...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/software-asset-management/t\_ReqAssocSWInstToOrcleMapping.html
release: yokohama
...
2.  [Activate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/software-asset-management/t_ActivateSWAssetMgmtOraclProcPac.md) the legacy Software Asset Management - Oracle Process Pack \(com.snc.sam.oracle.pp\) plugin.
...
4.  Ensure that the software models that you want to manage with Oracle licensing are set up accurately.
    ...
    See [Creating a software model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/software-asset-management/t_ManagingSoftwareModels.md).

5.  [Create a software license](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/software-asset-management/t_CreateAnOracleSoftwareLicense.md) for your Oracle software.
...
6.  [Create a software counter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/software-asset-management/c_CreatingAnOracleSoftwareCounter.md) to calculate Oracle licenses with the matching license type.

7.  Count licenses to determine compliance with Oracle guidelines.


**Parent Topic:**[Legacy Oracle process pack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/software-asset-management/c_OracleProcessPack.md)
