...
2.  View the Software Counter Result form \(see table\).
    ...
    |Related List|
    |Summary|Breakdown of software counter results by[type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/software-asset-management/c_UseTheSoftwareCounter.md). Click a type to view a detailed [summary](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/software-asset-management/t_ViewASoftwareCounterSummary.md).|
