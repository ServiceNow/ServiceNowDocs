...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/software-asset-management/t\_ViewASoftwareCounterResult.html
release: xanadu
...
2.  View the Software Counter Result form \(see table\).
    ...
    |Related List|
    |Summary|Breakdown of software counter results by[type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/software-asset-management/c_UseTheSoftwareCounter.md). Click a type to view a detailed [summary](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/software-asset-management/t_ViewASoftwareCounterSummary.md).|
