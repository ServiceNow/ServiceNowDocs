...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/service-builder/install-service-builder.html
release: australia
...
3.  Select **Install** and follow the onscreen instructions.
    ...
    -   Visit the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website.
