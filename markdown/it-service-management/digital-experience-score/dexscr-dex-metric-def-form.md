...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-experience-score/dexscr-dex-metric-def-form.html
release: yokohama
...
For more information, see [Customize metric definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/digital-experience-score/dexscr-customize-dex-score-metric-defs.md).
...
Option to determine who can see the metric. To edit this field, select the lock icon \[Omitted image "icon-visible-fields.png"\] Alt text: lock icon and select the visibility type from the drop-down list.
...
To delete a value, select the value and then select the remove icon \[Omitted image "image.icon-remove"\] Alt text: remove icon.

Select the unlock icon \[Omitted image "icon-lock-visible-fields.png"\] Alt text: unlock icon to set the visibility option.
...
Device health category that the metric is associated with.To select or change a device health category, select the search icon \[Omitted image "icon-magnifying-glass-blue.png"\] Alt text: search icon and then select a category from the DEX Self-service categories page.
...
Minimum value for a good metric.For example, let's say the good lower bound for a customer satisfaction metric score is set to 80%. This value means that any score above 80% is considered good.
