...
-   **[Components installed with Digital Experience Score​](../reference/dexscr-installed-with-dex-score.md)**  
...
-   **[Components installed with Digital Experience Feedback Survey](../reference/dexscr-installed-with-survey-feedback.md)**  
...
-   **[Digital Experience Score​ properties](../reference/dexscr-dex-score-properties.md)**  
...
-   **[DEX Score metric definitions](../reference/dexscr-metric-defs.md)**  
List of the base system DEX Score metric definitions.
-   **[Metric definition form](../reference/dexscr-dex-metric-def-form.md)**  
...
-   **[DEX Score survey configuration form](../reference/dexscr-score-survey-config-form.md)**  
...
-   **[Data collection frequency for DEX Score metrics](../reference/dexscr-metric-data-load.md)**  
