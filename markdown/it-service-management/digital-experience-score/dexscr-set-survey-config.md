...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-experience-score/dexscr-set-survey-config.html
release: yokohama
...
3.  On the form, update the fields.
    ...
    For more information on survey configuration field descriptions, see [DEX Score survey configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/digital-experience-score/dexscr-score-survey-config-form.md).
