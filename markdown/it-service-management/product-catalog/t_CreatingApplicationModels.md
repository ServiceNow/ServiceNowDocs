...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/product-catalog/t\_CreatingApplicationModels.html
release: zurich
...
3.  Complete the form.
    ...
    For general field descriptions, see [Model form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/product-catalog/r_ModelFormFields.md). There are no fields specific to application models.
