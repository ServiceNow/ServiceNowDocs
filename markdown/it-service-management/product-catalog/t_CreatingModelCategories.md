...
Add and track items in this category as[Create pre-allocated assets](https://www.servicenow.com/docs/access?context=t_CreatingPreAllocatedAssets&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US).
