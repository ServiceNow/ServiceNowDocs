...
The [Use depreciation with fixed assets](https://www.servicenow.com/docs/access?context=c_CreatingFixedAssets&version=zurich&pubname=zurich-it-asset-management&section=t_UsingDepreciationWithFixedAssets&ft:locale=en-US) for the model.
