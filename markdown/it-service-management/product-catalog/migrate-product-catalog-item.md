...
<table id="choicetable_c1z_jby_3gc"><thead><tr><th align="left" id="d123679e110">

Option

</th><th align="left" id="d123679e113">

Description

</th></tr></thead><tbody><tr><td id="d123679e119">
...
3.  On the hardware model form, select the Additional actions ![Additional actions](../../enterprise-dev-ops/image/additional-actions.png) icon and then select **Export XML \(This record\)**.
4.  Save the exported hardware model XML file on your local system.


</td></tr><tr><td id="d123679e167">
...
3.  On the software model form, select the Additional actions ![Additional actions](../../enterprise-dev-ops/image/additional-actions.png) icon and then select **Export XML \(This record\)**.
...
<table id="choicetable_z4t_ldy_3gc"><thead><tr><th align="left" id="d123679e281">

Option

</th><th align="left" id="d123679e284">

Description

</th></tr></thead><tbody><tr><td id="d123679e290">
...
3.  Select Column options ![image.column-options] and then select **Import XML**.
4.  Select **Choose File** and select the hardware model record XML file saved previously in Step 1.
5.  Select **Upload**.


</td></tr><tr><td id="d123679e353">
