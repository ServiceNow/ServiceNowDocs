...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/product-catalog/migrate-product-catalog-item.html
release: zurich
...
<table id="choicetable_c1z_jby_3gc"><thead><tr><th align="left" id="d87896e110">

Option

</th><th align="left" id="d87896e113">

Description

</th></tr></thead><tbody><tr><td id="d87896e119">
...
<table id="choicetable_z4t_ldy_3gc"><thead><tr><th align="left" id="d87896e281">

Option

</th><th align="left" id="d87896e284">

Description

</th></tr></thead><tbody><tr><td id="d87896e290">
...
3.  Select Column options s \[Omitted image "image.column-options"\] Alt text: Column options icon and then select **Import XML**.
...
**Parent Topic:**[Product catalog items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/product-catalog/c_ManagingProductCatalogItems.md)
