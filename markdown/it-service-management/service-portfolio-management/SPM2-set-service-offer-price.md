...
You can review service offering information regularly as a part of [Data Certification](https://www.servicenow.com/docs/access?context=c_DataCertification&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) and workflow. For example, you can set up a certification to validate pricing for your service offerings.

Forecast service usage and cost for a fiscal period to plan your future business using the [Showback](https://www.servicenow.com/docs/access?context=showback-statements&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US) functionality of Financial Management.
