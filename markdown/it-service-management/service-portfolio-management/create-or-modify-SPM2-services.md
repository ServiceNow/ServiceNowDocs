...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/service-portfolio-management/create-or-modify-SPM2-services.html
release: australia
...
**Important:** The following two fields only appear if you're using the deprecated Service Owner Workspace plugin.
