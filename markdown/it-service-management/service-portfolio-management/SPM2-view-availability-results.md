...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-portfolio-management/SPM2-view-availability-results.html
release: xanadu
...
For information on adding availability commitments, see [Add a commitment to a service offering](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-portfolio-management/define-SPM2-service-commitments.md).

## Availability calculator

Starting with the Xanadu release, you can use an availability calculator **\[com.snc.availability.v2\]** for improved performance, calculations, and maintenance.
