...
description: Service Portfolio Management Core is active by default for users with ITSM licences. Service Portfolio Management Foundation is administrator activated and enables you to document portfolios, taxonomies, services, and service offerings using a standardized, structured format.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-portfolio-management/r\_InstalledWSPM2.html
release: xanadu
...
</table>**Parent Topic:**[Service Portfolio Management reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-portfolio-management/SPM2-reference.md)
