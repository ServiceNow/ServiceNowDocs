---
title: Assign multiple teams to support a service offering in Service Portfolio Management
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-portfolio-management/spm2-assign-teams.html
release: xanadu
...
4.  In the Related Links **Teams** tab, add more support groups to the **User group** list.
