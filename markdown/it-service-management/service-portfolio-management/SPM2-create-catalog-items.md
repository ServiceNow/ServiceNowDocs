...
Comma-separated list of tags used to search for the catalog item. Use commas between keywords for better results when searching.
 ...
 For more information, see [Configure keyword search for catalog items](https://www.servicenow.com/docs/access?context=search-catalog-item&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
