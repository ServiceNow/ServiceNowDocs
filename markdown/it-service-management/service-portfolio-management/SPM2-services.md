...
description: Configure IT services within your portfolios to add the most value to your organization. The IT services defined in your portfolios may, or may not be, specifically aligned to an application. IT services defined in your portfolios may, or may not be, represented in a request catalog.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-portfolio-management/SPM2-services.html
release: xanadu
...
To create or modify services, see [Create or modify Service Portfolio Management services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-portfolio-management/create-or-modify-SPM2-services.md).

To learn about service offerings, see [Service Portfolio Management service offerings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-portfolio-management/SPM2-service-offerings.md).

To subscribe users to a service offering, see [Subscribe users to a service offering in Service Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-portfolio-management/SPM2-subscribe-to-service-offering.md).
