...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/walk-up-experience/add-walkup-checkin-icon-to-servport.html
release: xanadu
...
10. To add the Walk-up Check-in icon link to a new container, refer to [Create and edit a page using the Service Portal Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/t_ConfigureAPage.md).
