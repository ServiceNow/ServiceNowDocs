...
[Agent Workspace UI](https://www.servicenow.com/docs/access?context=workspace-landing-page&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)
...
[Create a request through a catalog](https://www.servicenow.com/docs/access?context=t_CreateARequestThroughTheCatalog&version=xanadu&pubname=xanadu-service-management-for-the-enterprise&ft:locale=en-US)
