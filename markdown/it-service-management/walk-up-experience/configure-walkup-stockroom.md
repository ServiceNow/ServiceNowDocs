...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/walk-up-experience/configure-walkup-stockroom.html
release: yokohama
...
Role required: sn\_walkup.walkup\_admin, asset\_user, inventory\_user, or admin
...
3.  Complete the Stockroom New record \[Walk-up view\] form or modify fields on an existing form.
    ...
    |Fields|Description|
    |------|-----------|
    |Name|Display name and unique identifier of the stockroom.|
    ...
    |Location|Physical location \(address\) of the stockroom.|
    ...
    For more information on creating or modifying a stockroom, and adding and managing stockroom assets, refer to [Stockrooms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-asset-management/c_Stockrooms.md).
