...
If there are no people in the approval group, the flow will skip past the approval group requirement, and activate the badge reader. For detailed information about approvals, groups, and adding users to groups, refer to [Approvals](https://www.servicenow.com/docs/access?context=r_Approvals&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US) [Creating groups](https://www.servicenow.com/docs/access?context=ua-creating-groups&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) and [Add a user to a group](https://www.servicenow.com/docs/access?context=t_AddAUserToAGroup&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
