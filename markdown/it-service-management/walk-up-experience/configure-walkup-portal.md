...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/walk-up-experience/configure-walkup-portal.html
release: xanadu
...
<table id="choicetable_egv_2gp_ldb"><tbody><tr><td id="d106016e171">
...
</table>    You can modify the form content to meet your portal requirements. For more details, refer to [Form configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/basic-form-administration.md) .
