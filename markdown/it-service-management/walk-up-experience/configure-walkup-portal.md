...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/walk-up-experience/configure-walkup-portal.html
release: yokohama
...
<table id="choicetable_egv_2gp_ldb"><tbody><tr><td id="d187017e171">
...
</table>    You can modify the form content to meet your portal requirements. For more details, refer to [Form configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/basic-form-administration.md) .
