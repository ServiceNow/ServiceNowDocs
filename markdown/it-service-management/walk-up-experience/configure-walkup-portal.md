...
<table id="choicetable_egv_2gp_ldb"><tbody><tr><td id="d280341e171">
...
</table>    You can modify the form content to meet your portal requirements. For more details, refer to [Form configuration](https://www.servicenow.com/docs/access?context=basic-form-administration&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) .
