...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/walk-up-experience/walkup-routing-tasks-to-skilled-agents.html
release: yokohama
...
Set up metadata in **All Skills**, **Group Skills**, and **User Skills**tables before configuring walk-up locations for skill-based routing. For more information, .
...
**Parent Topic:**[Configure skill-based routing in Walk-up Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/walk-up-experience/walkup-skill-based-routing.md)
