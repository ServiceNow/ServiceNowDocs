...
4.  To create a new walk-up email or push notification, click **New** and refer to [Create an email notification](https://www.servicenow.com/docs/access?context=t_CreateANotification&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) or [Create a push message](https://www.servicenow.com/docs/access?context=t_CreateAPushMessage&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) .
