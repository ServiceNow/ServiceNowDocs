...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/walk-up-experience/assisted-config-badge-read-settings.html
release: australia
...
-   Manually, through the ServiceNow AI Platform®. Refer to [Define and register a badge reader device manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/walk-up-experience/config-badge-reader-settings.md) for details on this procedure.
