...
For detailed information about the **Appointment Booking** application, refer to [Managing appointments in Field Service Management](https://www.servicenow.com/docs/access?context=managing-appointments-fsm&version=xanadu&pubname=xanadu-field-service-management&ft:locale=en-US).
