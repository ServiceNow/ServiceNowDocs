...
3.  Refer to [Configure a service channel](https://www.servicenow.com/docs/access?context=awa-create-service-channel&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) for detailed information regarding the Service Channel Walk-up form values and conditions.
