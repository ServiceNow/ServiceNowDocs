...
-   **Requesters**
    ...
    -   Onsite at the Walk-up Experience location:
        -   Check into a queue at the physical walk-up location by manually entering either your name or email or by scanning an employee badge.
            ...
            **Note:** The badge scanning feature requires activation and configuration. Refer to [Badge Reader Integration for Walk-up Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/walk-up-experience/badge-scan-walkup-onsite.md).
