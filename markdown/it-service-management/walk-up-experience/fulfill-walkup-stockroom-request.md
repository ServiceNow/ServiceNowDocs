...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/walk-up-experience/fulfill-walkup-stockroom-request.html
release: yokohama
...
9.  Return to the interaction in your **My Assigned Walk-ups** module to change the **State** to **Closed Complete** and click **Update** to update the interaction.
    ...
    If you cannot fulfill the request from the associated stockroom, click the **Create Request** related link from the interaction form to access the Service Catalog. Refer to  to order an item for the requester.


**Parent Topic:**[View Walk-up Experience location stockroom and assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/walk-up-experience/view-walkup-location-stockroom.md)
