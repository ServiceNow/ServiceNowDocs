...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/itsm-success-dashboard-indicators/instrument-virtual-agent-sdb.html
release: xanadu
...
breadcrumb: [Configure Virtual Agent topics for ITSM Success Dashboard, ITSM Success Dashboard Admin console, Configuring ITSM Success Dashboard indicators, ITSM Success Dashboard indicators, IT Service Management]
---
...
**Parent Topic:**[Configure Virtual Agent topics for ITSM Success Dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/itsm-success-dashboard-indicators/configure-va.md)
