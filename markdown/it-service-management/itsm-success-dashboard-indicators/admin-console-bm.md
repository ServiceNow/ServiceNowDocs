...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/itsm-success-dashboard-indicators/admin-console-bm.html
release: xanadu
...
For more information, see [Getting started with the ITSM Success Dashboard admin console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/benchmarks/c_gettingstartedadminconsole.md).
