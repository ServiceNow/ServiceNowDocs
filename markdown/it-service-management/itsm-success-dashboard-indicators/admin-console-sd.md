...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/itsm-success-dashboard-indicators/admin-console-sd.html
release: xanadu
...
-   **[Set the refresh interval for Success Dashboard indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/itsm-success-dashboard-indicators/configure-knowledge-deflection.md)**  
...
-   **[Configure Virtual Agent topics for ITSM Success Dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/itsm-success-dashboard-indicators/configure-va.md)**  
...
-   **[Update the live agent script include](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/itsm-success-dashboard-indicators/update-live-agent-script-include.md)**  
...
-   **[Set fulfillment automation level of catalog item for the Success Dashboard indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/itsm-success-dashboard-indicators/set-fulfillment-automation-level-sdb.md)**  
...
-   **[Activate Performance Analytics jobs for ITSM Success Dashboard indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/itsm-success-dashboard-indicators/activae-pa-indicator-jobs-sdb.md)**  
...
-   **[Configure Success Dashboard indicators KPIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/itsm-success-dashboard-indicators/config-kpis-sdb.md)**  
