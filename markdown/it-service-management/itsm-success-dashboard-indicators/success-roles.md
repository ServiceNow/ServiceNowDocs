...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/itsm-success-dashboard-indicators/success-roles.html
release: yokohama
...
breadcrumb: [ITSM Success Dashboard indicators reference, ITSM Success Dashboard indicators, IT Service Management]
---
...
The Success Dashboard indicators roles and the tasks are uniform across Service groups; ITSM or HR. The following are the user roles and responsibilities:
...
sn\_sd.success\_dashboard\_admin

</td></tr><tr><td>

As an IT leader or process owner, you can-   View the dashboard and KPIs
...
As a process owner, you can-   View the dashboard and KPIs
...
</table>**Parent Topic:**[ITSM Success Dashboard indicators reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/itsm-success-dashboard-indicators/itsm-success-dashboard-reference.md)
