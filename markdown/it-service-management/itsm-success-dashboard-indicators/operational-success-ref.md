...
To create a new operational dashboard, refer [Create an operational success dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/itsm-success-dashboard-indicators/create-operational-success-dashboard.md).

This framework uses the PA Dashboard created as part of the Platform Analytics for ITSM. For more information see, [Platform Analytics KPIs and dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/operational-success-kpi.md).

**Parent Topic:**[ITSM Success Dashboard indicators KPI definitions and formulas](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/itsm-success-dashboard-indicators/sd-kpi-formulae.md)
