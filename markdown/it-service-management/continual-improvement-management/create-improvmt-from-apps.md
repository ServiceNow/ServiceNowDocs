...
4.  Enter the field values in the Improvement Initiative form.
    ...
    For more information, see [Improvement field descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/continual-improvement-management/cim-field-descriptions.md).
