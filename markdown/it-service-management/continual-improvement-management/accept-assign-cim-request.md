...
2.  Align the improvement request with company strategic objectives, and assign an Improvement Coordinator.
    ...
    2.  Select the [enterprise strategy](https://www.servicenow.com/docs/access?context=overview-business-planning&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US) aligned with the improvement request.
