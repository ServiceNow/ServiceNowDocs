...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/continual-improvement-management/quick-tests-cim.html
release: xanadu
...
-   The **sn\_cim.create\_default\_phase** system property must be enabled. For more information, see [Properties installed with Continual Improvement Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/continual-improvement-management/cim-components.md).
