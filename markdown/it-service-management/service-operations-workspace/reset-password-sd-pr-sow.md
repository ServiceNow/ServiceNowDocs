...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/service-operations-workspace/reset-password-sd-pr-sow.html
release: australia
...
10. Select **Exit** in the confirmation modal displays to indicate that the password has been shared with the user.
    ...
    To know about errors that you encounter while you reset the password, refer [Password Reset in Service Operations Workspace reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/service-operations-workspace/pr-sow-reference.md).
