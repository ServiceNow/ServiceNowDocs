...
5.  Enter the following tag information in the **Value** field to define and customize your tags.
    ...
    For more information on how to use the correct values to customize the tags, see [Configure tags for the Activity stream](https://www.servicenow.com/docs/access?context=tags-activity-stream-admin&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
