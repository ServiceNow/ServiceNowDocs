...
<table id="choicetable_hvj_ccg_vsb"><thead><tr><th align="left" id="d248528e58">

Option

</th><th align="left" id="d248528e61">

Description

</th></tr></thead><tbody><tr><td id="d248528e67">
 ...
 **Note:** The agent assist icon is available only for users with the following roles: itil or interaction\_agent.
 ...
 For information on configuring additional search resources, see [Configure search resources for an interaction](configure-resources-for-an-interaction.md).

</td></tr><tr><td id="d248528e327">
