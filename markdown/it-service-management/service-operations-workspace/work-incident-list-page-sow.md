...
<table id="choicetable_l1y_yhz_ydc"><thead><tr><th align="left" id="d183619e128">

Option

</th><th align="left" id="d183619e131">

Description

</th></tr></thead><tbody><tr><td id="d183619e137">
...
</td></tr><tr><td id="d183619e189">

**Copy sys\_id**

</td><td>

Select the **More actions** icon \(![](../../digital-product-release/image/dpr-icon-more-actions-v.png)\) icon corresponding to the incident record, and then select **Copy sys\_id** to copy the sys\_id of the incident record. You can then share the sys\_id with other agents.**Note:** This option is available to sn\_sow\_admin role.

</td></tr><tr><td id="d183619e209">
