...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-operations-workspace/assign-playbook-mim-sow.html
release: xanadu
...
<table id="choicetable_ttg_gsk_gbc"><tbody><tr><td id="d178933e188">
...
For more information, see [Designing a major incident playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-operations-workspace/design-playbooks-mim-sow.md). Playbooks enables you to make the Advanced MI Playbook more flexible to use. This playbook is suggested for and can be used by new or zBoot customers. For more information, see [Managing major incidents using playbooks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-operations-workspace/managing-mi-playbook-sow.md).
