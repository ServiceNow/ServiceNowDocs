...
2.  Select the Chat - Most Capacity assignment rule.
    ...
    For information about AWA assignment rules, see [Configure agent assignment rules](https://www.servicenow.com/docs/access?context=awa-create-assignment-rule&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
