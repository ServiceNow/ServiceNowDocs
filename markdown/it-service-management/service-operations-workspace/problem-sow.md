...
-   **Create defect** \(for more information and requirements, see [Agile Development 2.0](https://www.servicenow.com/docs/access?context=agile-landing-page&version=zurich&pubname=zurich-it-business-management&ft:locale=en-US)\)
-   **Create enhancement** \(for more information and requirements, see [Agile Development 2.0](https://www.servicenow.com/docs/access?context=agile-landing-page&version=zurich&pubname=zurich-it-business-management&ft:locale=en-US)\)
