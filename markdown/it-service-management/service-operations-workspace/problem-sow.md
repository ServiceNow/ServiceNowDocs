...
-   **Create defect** \(for more information and requirements, see [Agile Development 2.0](https://www.servicenow.com/docs/access?context=agile-landing-page&version=australia&pubname=australia-it-business-management&ft:locale=en-US)\)
-   **Create enhancement** \(for more information and requirements, see [Agile Development 2.0](https://www.servicenow.com/docs/access?context=agile-landing-page&version=australia&pubname=australia-it-business-management&ft:locale=en-US)\)
