...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/service-operations-workspace/srp-service-operations-workspace.html
release: australia
...
-   **[Add declarative actions on the standard record page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/service-operations-workspace/customize-srp-sow.md)**  
...
-   **[Custom Modal Migration in Standard Record Page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/service-operations-workspace/custom-modal-migration-srp.md)**  
Modify the modal containers inside a record page in the Service Operations Workspace.
-   **[Modify the Record Page in the Service Operations Workspace using the Standard Record Page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/service-operations-workspace/configure-record-page-order-sow.md)**  
...
-   **[Configure the Agent Assist tab in Service Operations Workspace using the Standard Record Page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/service-operations-workspace/configure-agent-assist-tab-sow-srp.md)**  
