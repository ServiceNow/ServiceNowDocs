...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/service-operations-workspace/customize-the-incident-record-page.html
release: zurich
...
**Parent Topic:**[Customizing Service Operations Workspace for ITSM to align with your requirements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/customize-sow-landing-page.md)
...
16. Select the **Editor** tab to start editing the page components for customizing the **Overview** tab.
    ...
    For more information on working with pages, see [Work with pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/work-pages.md).
...
Role required: workspace\_admin, sn\_sow\_inc.sn\_incident\_sow\_admin, ui\_builder\_admin, or admin
...
Role required: workspace\_admin, ui\_builder\_admin, sn\_sow\_inc.sn\_incident\_sow\_admin or admin
...
16. Select the **Editor** tab to start editing the page components for customizing the remedial action playbook .
    ...
    For information on working with pages, see [Work with pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/work-pages.md).
...
3.  In the **Script** field, modify the display information for SLAs.
    ...
    For information about how the SLA information is displayed for an incident, see [View service level agreement information for an incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/slm-sow.md).
