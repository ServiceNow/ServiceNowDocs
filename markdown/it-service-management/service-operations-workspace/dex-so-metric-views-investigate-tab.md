...
-   Service Observability \(SO\) view: The CI metrics are displayed in SO dashboard view on the tab. For more information, see [View overall service health](https://www.servicenow.com/docs/access?context=view-overall-service-health&version=australia&pubname=australia-it-operations-management&ft:locale=en-US).
...
-   CI is configured with SO data mapping. For more information, see [Create and manage data mappings](https://www.servicenow.com/docs/access?context=create-and-manage-observability-data-mappings&version=australia&pubname=australia-it-operations-management&ft:locale=en-US).
...
For more information on SO, see [Service Observability](https://www.servicenow.com/docs/access?context=service-observability&version=australia&pubname=australia-it-operations-management&ft:locale=en-US).
