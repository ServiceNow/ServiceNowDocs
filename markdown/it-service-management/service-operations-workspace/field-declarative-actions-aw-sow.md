...
breadcrumb: [Configurations and customizations that can be migrated from ITSM Agent workspace to SOW for ITSM, Migrate from ITSM Agent Workspace to Service Operations Workspace for ITSM, Migration, Service Operations Workspace for ITSM, IT Service Management]
---
...
-   **[Migrate the client script from ITSM Agent Workspace to Service Operations Workspace for field decorators actions](../task/migrate-field-declarative-client-script-aw-sow.md)**  
...
-   **[Migrate the server script from ITSM Agent Workspace to Service Operations Workspace for field decorators actions](../task/migrate-field-declarative-server-script-aw-sow.md)**  
...
-   **[Migrate the client action from ITSM Agent Workspace to Service Operations Workspace for field decorators actions](../task/migrate-field-declarative-client-action-aw-sow.md)**  
...
-   **[Migrate the UI component from ITSM Agent Workspace to Service Operations Workspace for field decorators actions](../task/migrate-field-declarative-ui-component-aw-sow.md)**  
Configure the UI component to migrate field decorators actions from ITSM Agent Workspace to Service Operations Workspace.
-   **[Perform post-migration tasks for field decorators form actions](../task/verify-migration-status-field-declarative-actions-aw-sow.md)**  
