...
4.  Create an update set to record any changes that are made to Service Operations Workspace for ITSM during the migration. See Create and select an update set as the current set.
