...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/service-operations-workspace/on-call-scheduling-in-service-operations-workspace.html
release: zurich
...
See [On-Call Scheduling in Service Operations Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/on-call-scheduling-in-sow.md) for more details.

## On-Call Scheduling in Service Operations Workspace workflow

The various members of an organisation use On-Call Scheduling to work together. See a sample end-to-end workflow:\[Omitted image "Oncall\_workflow.png"\] Alt text: On-call scheduling workflow

1.  Shift admin creates shift and group templates.
2.  Shift admin assigns role and configures escalation trigger rules. See [Roles in Service Operations Workspace for ITSM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/roles-in-sow.md) and [Assigning On-Call Scheduling roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/on-call-scheduling/roles-assigning-oncall.md)
...
[Create and edit shift in Service Operations Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/create-a-schedule-in-sow.md)
...
[Manage shifts in service operation workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/manage-shifts-in-service-operation-workspace.md)
...
[Escalation triggers and policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/work-on-escalation-trigger-rules-and-policies-in-sow.md)
...
[Edit On-call team preference using Teams menu](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/oncall-team-preference-tab-in-teams.md)
...
[Manage delivery channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/work-on-a-notification-preference-rule-in-sow.md)To configure delivery channels, see:

-   For Slack: [Setting up Slack as a contact method](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/on-call-scheduling/slack-setup-oncall.md)
-   For SMS and voice message: [Setting up SMS and voice messaging as contact methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/on-call-scheduling/c_UseNotifyWithOnCallScheduling.md)
-   For teams: Microsoft Teams
-   For mobile push notifications: [Set up mobile push as a contact method for an on-call escalation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/on-call-scheduling/set-up-mobile-push-oncall.md)
...
</table>**Note:** For more details on user roles, see [Assigning On-Call Scheduling roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/on-call-scheduling/roles-assigning-oncall.md).

**Parent Topic:**[Exploring Service Operations Workspace for ITSM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/service-operations-workspace/explore-sow.md)
