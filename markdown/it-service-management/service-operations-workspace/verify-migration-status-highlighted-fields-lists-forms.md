...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-operations-workspace/verify-migration-status-highlighted-fields-lists-forms.html
release: xanadu
...
breadcrumb: [Migration of highlighted fields in lists and forms from ITSM Agent Workspace to Service Operations Workspace for ITSM, Configurations and customizations that can be migrated from ITSM Agent workspace to SOW for ITSM, Migrate from ITSM Agent Workspace to Service Operations Workspace for ITSM, Migration, Service Operations Workspace for ITSM, IT Service Management]
---
