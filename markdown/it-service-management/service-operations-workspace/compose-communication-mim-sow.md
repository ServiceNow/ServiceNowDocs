...
description: Compose the communication messages for incidents and major incidents using communication channels such as email and SMS.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/service-operations-workspace/compose-communication-mim-sow.html
release: yokohama
...
-   For major incidents, you must configure communication plans and tasks for Major Incident Management in Admin Center. For more information, see [Configure a communication plan in Major Incident Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-operations-workspace/configure-comm-plan-mim-sow.md).
-   For incidents, you must activate and then configure communication plans and tasks in Task Communications Management. For more information, see [Task Communications Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/tcm-landing-page.md).

Role required: major\_incident\_manager, ia\_admin, itil, or admin

## Procedure

1.  Navigate to **Service Oeprations Workspace** &gt; **List** &gt; **Major Incident or Incident**

2.  Select the required category under **Major incident** or **Incident** such as **All** or **Open**.

3.  On the incident record, select the **Communicate** tab.
...
4.  Select the communication task where you want to compose the communication message.

    **Note:** Select the communication task based on the due dates to ensure that no communication deadline is breached. For example, communication tasks from the **Overdue** section.

5.  On the communication task, select **Compose**.
    ...
    **Note:**
    ...
    -   For major incident SMS communications, you can select or change the SMS templates with any of the following user roles:
        ...
        -   An itil user to whom the major incident is assigned
...
</table>    For more information on DEX Desktop Assistant, see [Use DEX Desktop Assistant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/digital-end-user-experience-dex/use-dex-desktop-exp.md).
