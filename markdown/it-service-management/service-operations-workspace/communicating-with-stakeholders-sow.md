...
-   **View Record**
    ...
    On the ICT record, you can also initiate a call or chat from the collaborate tab on the side panel using the **Collaborate** \(![Collaborate icon](../image/mim-collaborate-icon.png)\) icon on the contextual side panel. For more information, see [Collaborate with stakeholders during a major incident](../task/collaborate-stakeholders-mim-sow.md).
