---
title: Communicating with stakeholders about incidents and major incidents
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/service-operations-workspace/communicating-with-stakeholders-sow.html
release: yokohama
...
-   **View Record**
    ...
    View detailed information about the incident communication task \(ICT\) record. Select the **More actions** \(\[Omitted image "mim-more-action-icon.png"\] Alt text: More action icon\) icon on the communication task and then select **View record**.
...
-   **Close**
    ...
    Close the communication task. Select the **More actions** \(\[Omitted image "mim-more-action-icon.png"\] Alt text: More action icon\) icon on the communication task and then select **Close**. The communication task is then moved to either the Completed or Skipped section of the **Communicate** tab based on the following scenarios:
...
-   **Start**
    ...
    Start the communication task with the **Pending** status. Select the **More actions** \(\[Omitted image "mim-more-action-icon.png"\] Alt text: More action icon\) icon on the communication task and then select **Start**.
...
-   **[Compose communications for incidents and major incidents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-operations-workspace/compose-communication-mim-sow.md)**  
Compose the communication messages for incidents and major incidents using communication channels such as email and SMS.
-   **[Manage recipients in a communication task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-operations-workspace/manage-recipients-mim-sow.md)**  
...
-   **[Create an adhoc communication task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-operations-workspace/create-adhoc-comm-task-mim-sow.md)**  
Create an adhoc communication task as required during the various phases of an incident in Major Incident Management.
-   **[Manage an announcement for communicating about major incidents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-operations-workspace/create-announcements-major-inc.md)**  
...
**Parent Topic:**[Managing a major incident record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-operations-workspace/managing-major-incident-sow.md)
