...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-operations-workspace/review-update-pir-mim-sow.html
release: xanadu
...
The major incident must be in the **Resolved** state. For more information, see [Resolve and close a major incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-operations-workspace/resolve-close-mim-sow.md).
...
**Note:** When an event is flagged on the activity stream of the **Overview** tab of a major incident record, the event is added to the events timeline of the PIR.
