...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-operations-workspace/promote-major-incident-sow.html
release: xanadu
...
breadcrumb: [Managing a major incident record, Major Incident Management in Service Operations Workspace, Incident Management in Service Operations Workspace, Use, Service Operations Workspace for ITSM, IT Service Management]
---
...
You must propose the incident as a major incident candidate. For more information, see [Propose a major incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-operations-workspace/propose-major-incident-sow.md).
...
6.  Select **Promote** to promote the major incident candidate to a major incident.
    ...
    If you want to reject the major incident proposal, you can select **Reject**. This action would convert the major incident candidate back into an incident.

7.  On the Promote to Major Incident pop-up window, fill in the details.

    |Field|Description|
    |-----|-----------|
    |Reason|Reason for promoting the incident as major incident candidate.|
    |Business Impact|Impact the incident creates on the business. By default, the business impact stated by the agent to propose major incident is displayed. You can modify the value.|
...
**Parent Topic:**[Managing a major incident record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-operations-workspace/managing-major-incident-sow.md)
