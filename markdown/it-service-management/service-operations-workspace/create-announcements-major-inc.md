...
Announcements can be displayed in an announcement banner or an announcement widget instance. For more information, see [Posting announcements to portal users](https://www.servicenow.com/docs/access?context=announcements&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
...
6.  On the **Related records** tab, you use the following related links.
    ...
    You can select an existing user criteria or select **New** to create a user criteria. For more information, see [User criteria for Service Portal](https://www.servicenow.com/docs/access?context=user-criteria&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
