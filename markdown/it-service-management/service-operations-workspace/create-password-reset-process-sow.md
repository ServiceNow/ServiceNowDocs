...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/service-operations-workspace/create-password-reset-process-sow.html
release: yokohama
...
14. Right-click on the form header, and select **Save**.
    ...
    For more information on password reset process, see [Configure your Password Reset process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/password-reset/t_CreateAPasswordResetProcess.md).
