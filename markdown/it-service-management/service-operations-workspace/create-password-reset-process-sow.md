...
14. Right-click on the form header, and select **Save**.
    ...
    For more information on password reset process, see [Configure your Password Reset process](https://www.servicenow.com/docs/access?context=t_CreateAPasswordResetProcess&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
