...
For information about creating a view rule, see [Create a view rule](https://www.servicenow.com/docs/access?context=t_CreateAViewRule&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
