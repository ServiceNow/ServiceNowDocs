...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/service-operations-workspace/view-rules-migration-itsm-aw-sow.html
release: zurich
...
For information about creating a view rule, see [Create a view rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/t_CreateAViewRule.md).
