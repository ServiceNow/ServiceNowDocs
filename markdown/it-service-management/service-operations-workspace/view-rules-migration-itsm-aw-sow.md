...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/service-operations-workspace/view-rules-migration-itsm-aw-sow.html
release: yokohama
...
For information about creating a view rule, see [Create a view rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/t_CreateAViewRule.md).
