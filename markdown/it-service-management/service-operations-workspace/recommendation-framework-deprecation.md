---
title: Recommendation Framework Deprecation
description: Recommendation Framework is now deprecated and no longer supported or available for new activation. Recommended Actions for ITSM feature provides the latest experience for this functionality. To get the advanced version, you must install the Advanced Recommended actions for ITSM \(com.snc.uib.sow\_itsm\_ra\_advanced\) plugin and you must procure ITSM Pro package subscription.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-operations-workspace/recommendation-framework-deprecation.html
release: xanadu
...
breadcrumb: [Configuring Recommended Actions for ITSM in Service Operations Workspace, Contextual side panel configurations in SOW for ITSM, Getting started, Service Operations Workspace for ITSM, IT Service Management]
---
