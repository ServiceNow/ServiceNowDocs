...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/service-operations-workspace/install-mim-sow.html
release: yokohama
...
breadcrumb: [Setting up Major Incident Management in Service Operations Workspace, Getting started with Service Operations Workspace for ITSM, Configure, Service Operations Workspace for ITSM, IT Service Management]
---
...
2.  On the Admin Center **Overview** tab, in the Configure ITSM Core section, select the **Install** button under Major Incident Management.
