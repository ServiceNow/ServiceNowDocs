...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/service-operations-workspace/custom-modal-migration-srp.html
release: zurich
...
7.  Select the \[Omitted image "add-icon.png"\] Alt text: Create new page icon to create a page or to add a new variant to a page.
    ...
    For more information about creating a page and variant, see [Learn UI Builder by example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/learning-uib-by-example.md)
