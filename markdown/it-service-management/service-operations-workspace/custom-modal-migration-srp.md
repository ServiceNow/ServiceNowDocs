...
7.  Select the ![Create new page](../image/add-icon.png) icon to create a page or to add a new variant to a page.
    ...
    For more information about creating a page and variant, see [Learn UI Builder by example](https://www.servicenow.com/docs/access?context=learning-uib-by-example&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US)
