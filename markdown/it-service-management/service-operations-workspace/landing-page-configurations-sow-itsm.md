...
-   **[Configure record creation from the new tab menu in Service Operations Workspace](../task/configure-new-tab-records.md)**  
Customize the records that can be created from the new tab menu in all pages of Service Operations Workspace.
-   **[Restore the greeting banner on the landing page](../task/restore-greeting-banner.md)**  
If the greeting banner is closed, restore it to view the agent's shift information.
-   **[Configure the header message on the landing page](../task/modify-greeting-text.md)**  
...
-   **[Configure the space man on the landing page](../task/modify-space-man-landing-page.md)**  
Change the image of the space man to an image your choice.
-   **[Configure the donut color in the Overview section](../task/customize-donut-color.md)**  
Create a visual experience that works the best for donuts in the **Overview** section.
-   **[Configure the donuts in the tier 1 landing page](../task/customize-first-level-cards.md)**  
Configure the data displayed in donuts in the **Overview** section of the tier 1 landing page.
-   **[Configure the donuts in the tier 2 landing page](../task/configure-donut-tier2-landing-page.md)**  
Configure the data displayed in donuts in the **Overview** section of the tier 2 landing page.
-   **[Configure the visibility of landing page sections](../task/configure-visibility-landing-page-sections.md)**  
Configure if few sections of the landing page should be visible or hidden. For example, **Quick links** and **Upcoming** sections.
-   **[Configure the Announcements section on the landing page](../task/modify-announcements-section.md)**  
Customize an existing announcement or add an announcement for additional tables.
-   **[Configure the Upcoming section on the landing page](../task/modify-upcoming-section.md)**  
