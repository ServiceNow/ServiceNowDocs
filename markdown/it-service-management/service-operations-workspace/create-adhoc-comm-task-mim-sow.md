...
Channel that must be used to compose and sent communication messages. Possible options are:-   Email – Compose and send the communication message as an email.
