...
breadcrumb: [Major Incident Management in Service Operations Workspace, Incident Management in Service Operations Workspace, Use, Service Operations Workspace for ITSM, IT Service Management]
---
...
-   **Overview tab**
    ...
    For more information on the **Overview** tab, see [View and update incident information on the Overview tab](../task/view-update-inc-overview-tab.md).
...
-   **[Communicating with stakeholders about incidents and major incidents](communicating-with-stakeholders-sow.md)**  
