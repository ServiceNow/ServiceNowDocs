...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-operations-workspace/config-system-dsregcmd-metrics.html
release: xanadu
...
2.  Create a MECM script with the name `dsregcmd`.
    ...
    For more information, see [Create a script in Microsoft Endpoint Configuration Manager](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-operations-workspace/create-mecm-script.md).
