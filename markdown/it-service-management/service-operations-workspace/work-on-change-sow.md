...
1.  To open a change request, select the List icon \(![list icon](../image/sow-list.png)\) and then navigate to **Changes**.
...
<table id="choicetable_hvj_ccg_vsb"><thead><tr><th align="left" id="d305902e105">

Option

</th><th align="left" id="d305902e108">

Description

</th></tr></thead><tbody><tr><td id="d305902e114">
