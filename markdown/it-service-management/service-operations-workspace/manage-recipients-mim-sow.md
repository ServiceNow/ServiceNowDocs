...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/service-operations-workspace/manage-recipients-mim-sow.html
release: yokohama
...
breadcrumb: [Communicating with stakeholders about incidents and major incidents, Managing a major incident record, Major Incident Management in Service Operations Workspace, Manage, Service Operations Workspace for ITSM, IT Service Management]
---
...
<table id="table_sch_g4g_z1c"><thead><tr><th>
...
User, user group, or list of recipients to whom the communication is sent.
...
Button to add the recipients and the user role to the **Recipients** field.
...
User, user group, or list of recipients with the user role. You must use the **Add** button to add the recipients and the user role to this field.

</td></tr></tbody>
</table>4.  Select **Save**.


**Parent Topic:**[Communicating with stakeholders about incidents and major incidents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-operations-workspace/communicating-with-stakeholders-sow.md)
