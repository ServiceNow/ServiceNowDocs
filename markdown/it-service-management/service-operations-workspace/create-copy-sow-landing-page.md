...
5.  To edit the page or any of its subpages, customize its components.
    ...
    For information about components, see [Work with components](https://www.servicenow.com/docs/access?context=work-components&version=australia&pubname=australia-application-development&ft:locale=en-US).
