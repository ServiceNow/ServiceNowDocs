...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/service-operations-workspace/resetting-password-pr-sow.html
release: brazil
...
-   **[Reset password using service-desk assistance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/service-operations-workspace/reset-password-sd-pr-sow.md)**  
Resetting the password enables the user to log in to their system and resume their work.
-   **[Unlock the user account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/service-operations-workspace/unlock-user-account-pr-sow.md)**  
You can unlock a blocked user to enable them to log in to their system.
-   **[Password Reset in Service Operations Workspace reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/service-operations-workspace/pr-sow-reference.md)**  
