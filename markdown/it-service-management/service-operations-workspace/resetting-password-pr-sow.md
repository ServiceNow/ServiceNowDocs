---
title: Resetting password using Service-desk assisted Password Reset in Service Operations Workspace
description: The Password Reset for Service Operations Workspace application enforces strong and secure passwords by enabling end users to reset or change their passwords by requesting the service desk agent.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/service-operations-workspace/resetting-password-pr-sow.html
release: yokohama
...
-   **[Reset password using service-desk assistance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-operations-workspace/reset-password-sd-pr-sow.md)**  
Resetting the password enables the user to log in to their system and resume their work.
-   **[Unlock the user account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-operations-workspace/unlock-user-account-pr-sow.md)**  
You can unlock a blocked user to enable them to log in to their system.
-   **[Password Reset in Service Operations Workspace reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/service-operations-workspace/pr-sow-reference.md)**  
