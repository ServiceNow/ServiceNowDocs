...
<table id="choicetable_vrd_rrt_tsb"><thead><tr><th align="left" id="d169126e57">

Source

</th><th align="left" id="d169126e61">

Description

</th></tr></thead><tbody><tr><td id="d169126e67">
...
Date when the conflict detection process was last run.
    ...
    4.  Reschedule your current change request if there is any conflict.
        ...
        2.  Select the edit icon ![Edit icon.](../../configuration-data-management/image/icon-edit-pencil.png) in the **Current** card.
