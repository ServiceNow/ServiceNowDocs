...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/service-operations-workspace/verify-migration-status-ui-actions-layouts.html
release: xanadu
...
breadcrumb: [Migration of UI actions and layouts from ITSM Agent Workspace to Service Operations Workspace for ITSM, Configurations and customizations that can be migrated from ITSM Agent workspace to SOW for ITSM, Migrate from ITSM Agent Workspace to Service Operations Workspace for ITSM, Migration, Service Operations Workspace for ITSM, IT Service Management]
---
...
2.  If the migration fails, perform the following steps.
    ...
    4.  For each failed item, identify which step has failed and perform the steps mentioned in the [How the migration works](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-operations-workspace/ui-actions-layouts-migration-itsm-aw-sow.md) section.


**Parent Topic:**[Migration of UI actions and layouts from ITSM Agent Workspace to Service Operations Workspace for ITSM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/service-operations-workspace/ui-actions-layouts-migration-itsm-aw-sow.md)
