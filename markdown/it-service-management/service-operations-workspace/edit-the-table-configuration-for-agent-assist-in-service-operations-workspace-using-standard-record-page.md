...
To create a table configuration, see [Configure table for a contextual search](https://www.servicenow.com/docs/access?context=t_DefineContextualSearchForForm&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
