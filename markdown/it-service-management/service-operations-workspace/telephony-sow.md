...
Ensure that Twilio is configured to make conference calls from Service Operations Workspace. To configure Twilio, refer [Configure Notify with Twilio](https://www.servicenow.com/docs/access?context=t_ConfigureNotifyWithTwilio&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
