...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/vendor-management-workspace/analyze-performance-trends-vendors-configurable-workspace.html
release: yokohama
...
3.  Select the Success Indicators icon \( \[Omitted image "success-indicators-icon.png"\] Alt text: Success Indicators icon\).

4.  Analyze the metrics for your vendors and compare them against top performers.\[Omitted image "vendor-success-indicators.png"\] Alt text: Vendor Success Indicators
...
5.  Select **See more** to drill down into the data.
    ...
    \[Omitted image "top-performance-indicator.png"\] Alt text: Average Availability Success Indicator
...
**Parent Topic:**[Managing vendors using Vendor Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/vendor-management-workspace/using-vendor-management-workspace.md)

**Related topics**  


[Explore Vendor Success Indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/vendor-management-workspace/exploring-vendor-management-workspace.md)

[Set up Vendor Success Indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/vendor-management-workspace/configuring-vendor-management-workspace.md)
