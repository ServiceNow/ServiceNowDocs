...
5.  Fill in the fields on the form.
    ...
    For information on the field descriptions, see [Create a contract](https://www.servicenow.com/docs/access?context=t_CreateAContract&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).
