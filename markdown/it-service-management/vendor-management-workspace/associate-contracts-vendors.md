...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/vendor-management-workspace/associate-contracts-vendors.html
release: xanadu
...
5.  Fill in the fields on the form.
    ...
    For information on the field descriptions, see [Create a contract](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-asset-management/contract-management/t_CreateAContract.md).
