...
1.  Configure a domain to collect vendor score performance analytics data for that domain.
    ...
    5.  Click **Update**.
    For more information on creating or scheduling a data collection job, refer to [Create or schedule a data collection job](https://www.servicenow.com/docs/access?context=t_CreatASchedDataCollJob&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)
    ...
    **Note:** The Performance Analytics application:
    ...
    -   Automatically adds database queries that limit results from the domain to the [indicator source queries](https://www.servicenow.com/docs/access?context=c_IndicatorSources&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US) when the application runs a job for a domain configuration.
...
<table id="choicetable_uxc_zhx_5jb"><thead><tr><th align="left" id="d216553e200">

To

</th><th align="left" id="d216553e203">

Do this

</th></tr></thead><tbody><tr><td id="d216553e209">
