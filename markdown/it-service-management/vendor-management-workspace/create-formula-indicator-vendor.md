...
For detailed information on creating a formula indicator, see [Create a formula indicator](https://www.servicenow.com/docs/access?context=t_CreateAFormulaIndicator&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
