...
-   A project from the Planning tool is linked with the product or service. For more information, see [View and manage data from external tools](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-product-release/dpr-manage-product-ext-tool.md).
