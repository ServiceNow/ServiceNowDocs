...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/digital-product-release/dpr-view-rls-readiness-target.html
release: xanadu
...
2.  Select the release calendar icon \(\[Omitted image "dpr-icon-rls-target.png"\] Alt text: Release calendar icon.\).
    ...
    \[Omitted image "dpr-release-readiness-target2.png"\] Alt text: Release calendar view showing release readiness targets.
...
<table id="choicetable_n1l_1nq_d1c"><thead><tr><th align="left" id="d174463e101">

Option

</th><th align="left" id="d174463e104">

Steps

</th></tr></thead><tbody><tr><td id="d174463e110">
