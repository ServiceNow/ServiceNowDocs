...
2.  Select the release calendar icon \(![Release calendar icon.](../image/dpr-icon-rls-target.png)\).
    ...
    ![Release calendar view showing release readiness targets.](../image/dpr-release-readiness-target2.png)
...
<table id="choicetable_n1l_1nq_d1c"><thead><tr><th align="left" id="d176327e101">

Option

</th><th align="left" id="d176327e104">

Steps

</th></tr></thead><tbody><tr><td id="d176327e110">
