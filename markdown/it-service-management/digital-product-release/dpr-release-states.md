...
The release is closed. All release work is finished and the phases mapped to it are compliant with their policies.For more information, see [Close a release](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-product-release/dpr-complete-release.md).
...
</table>**Parent Topic:**[Release for a product or service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-product-release/dpr-product-release.md)
