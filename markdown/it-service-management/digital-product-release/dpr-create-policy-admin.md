...
The policies are defined using ServiceNow® Policy as Code Engine \(PaCE\), so make sure you’re familiar with the basics. For more information, see [Understanding PaCE](https://www.servicenow.com/docs/access?context=pace-understanding&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
...
3.  Create a policy or update an existing one.
    ...
    -   To create a policy, select **New**.
        ...
        For more information on creating a policy, see [Create a PaCE policy](https://www.servicenow.com/docs/access?context=pace-create-policy&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
...
5.  On the Version record form, select the **Policy Builder** tab to [write the policy](https://www.servicenow.com/docs/access?context=pace-write-test-policies&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
...
6.  Test your policy in the **Test Playground** tab.
    ...
    For more information, see [Use the Test Playground for PaCE policies](https://www.servicenow.com/docs/access?context=pace-use-test-playground&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
...
For more information, see [Manage PaCE policy versions](https://www.servicenow.com/docs/access?context=pace-policy-versions&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
