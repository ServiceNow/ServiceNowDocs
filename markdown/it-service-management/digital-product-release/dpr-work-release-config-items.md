...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-product-release/dpr-work-release-config-items.html
release: yokohama
...
<table id="choicetable_l2q_vl2_52c"><thead><tr><th align="left" id="d77517e104">

Option

</th><th align="left" id="d77517e107">

Steps

</th></tr></thead><tbody><tr><td id="d77517e113">
...
</td></tr><tr><td id="d77517e143">

**Remove associated CIs from a phase**

</td><td>

1.  Select configuration items form the list that you want to remove from the phase.
2.  Select **Remove**.
