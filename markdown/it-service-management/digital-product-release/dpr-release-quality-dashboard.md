...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-product-release/dpr-release-quality-dashboard.html
release: yokohama
...
For more information, see [Integrate external tools from Digital Product Release Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/digital-product-release/dpr-integrate-external-tool.md).
...
\[Omitted image "dpr-quality-dashboard.gif"\] Alt text: Animated gif showing Build, Artifact, and Package tabs on the Release Quality dashboard.
...
**Parent Topic:**[Digital Product Release dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/digital-product-release/dpr-dashboard-release.md)
...
[Quality metrics dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-change-velocity/devops-insights-dboard-ws.md)
