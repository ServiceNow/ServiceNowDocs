...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/digital-product-release/dpr-create-release-template.html
release: zurich
...
11. In the Phases activity, add phases to the release template.
    ...
    5.  Change the order of phases by selecting the move phase up \(\[Omitted image "dpr-icon-up.png"\] Alt text: Move phase up icon.\) or move phase down \(\[Omitted image "dpr-icon-down.png"\] Alt text: Move phase down icon.\) icons to define the sequence in which they’re processed in a release.
...
12. In the Tasks activity, manage tasks to define the work that must be completed during each phase of a release.
    ...
    4.  If approval is required for the task, select an approval definition from the **Approval definition** list.
        ...
        For more information, see [Create an approval definition in Digital Product Release](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/digital-product-release/dpr-create-approval-definition.md).
    ...
    4.  Change the order of tasks within a phase to define the sequence in which tasks are executed during a release.
        ...
        2.  Select the move task up \(\[Omitted image "dpr-icon-up.png"\] Alt text: Move task up icon.\) or move task down \(\[Omitted image "dpr-icon-down.png"\] Alt text: Move task down icon.\) icons to change the order in which they’re processed in a release.
...
-   A published release template can be used for [creating releases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/digital-product-release/dpr-create-release.md).
...
Select the more actions button \(\[Omitted image "dpr-icon-more-actions.png"\] Alt text: More actions button icon.\) and select **Delete**.
...
[Create a release with a wizard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/digital-product-release/dpr-create-release-guided.md)

[Create a release for a product or service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/digital-product-release/dpr-create-release.md)

[Work on a timeline-oriented release for a single product or service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/digital-product-release/dpr-work-release.md)
...
3.  Configure the form layout to add the custom fields on the form.
    ...
    For more information on configuring form layout, see [ServiceNow AI Platform® form administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/form-administration-landing-page.md).
