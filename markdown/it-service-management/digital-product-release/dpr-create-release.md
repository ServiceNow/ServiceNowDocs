...
For creating a release for multiple products using the wizard, see [Create a release with a wizard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-product-release/dpr-create-release-guided.md).
...
<table id="choicetable_mxj_fsr_lyb"><thead><tr><th align="left" id="d106734e166">

Option

</th><th align="left" id="d106734e169">

Steps

</th></tr></thead><tbody><tr><td id="d106734e175">
...
2.  Select the more actions icon next to the **Create release** button and then select **Quick create**.
    ...
    For more information on release field descriptions, see [Release form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-product-release/create-release-form.md).
