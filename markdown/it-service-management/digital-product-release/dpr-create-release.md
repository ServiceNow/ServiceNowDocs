...
<table id="choicetable_mxj_fsr_lyb"><thead><tr><th align="left" id="d156796e151">

Option

</th><th align="left" id="d156796e154">

Steps

</th></tr></thead><tbody><tr><td id="d156796e160">
...
4.  Select the sub menu icon \(![Sub menu icon.](../image/dpr-icon-lane-action.png)\) on a version lane and select the **Create release** menu option.


</td></tr><tr><td id="d156796e211">
