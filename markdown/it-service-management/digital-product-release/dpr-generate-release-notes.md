...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/digital-product-release/dpr-generate-release-notes.html
release: brazil
...
-   **Required applications and plugins:**
    ...
    -   ServiceNow Otto for ITSM plugin \(sn\_itsm\_gen\_ai\) version 12.0.0 or later.
        ...
        For more information, see [ServiceNow Otto for IT Service Management \(ITSM\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/now-assist-for-it-service-management-itsm/now-assist-itsm.md).
