...
For more information, see [Manage control objectives and policies using the Compliance Workspace](https://www.servicenow.com/docs/access?context=manage-control-obj-policies-ws&version=australia&pubname=australia-governance-risk-compliance&ft:locale=en-US).
...
3.b. One or more Controls are created for a combination of release entity and control objective \(CO\).For more information, see [Multiple controls for compliance management](https://www.servicenow.com/docs/access?context=support-multiple-controls-same-entity-control-objective&version=australia&pubname=australia-governance-risk-compliance&ft:locale=en-US).
