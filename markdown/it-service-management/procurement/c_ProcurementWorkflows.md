...
-   In the Source Request workflow, catalog tasks are created so that a procurement manager can source the item by creating a transfer order or purchase order.
    ...
    ![Source request workflow](../image/SourceRequestWorkflow.png "Source request workflow")
...
[Workflows](https://www.servicenow.com/docs/access?context=c_WorkflowOverview&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US)
