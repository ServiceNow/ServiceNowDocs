...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/procurement/create-coupa-int-profile.html
release: yokohama
product: Procurement
...
If you want to delete the Coupa integration profile, see [Deleting an external procurement application integration profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/procurement/delete-ext-profile.md).
