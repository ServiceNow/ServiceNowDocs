...
For more details on creating consumable assets, see [Create consumable assets](https://www.servicenow.com/docs/access?context=t_CreatingConsumableAssets&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US).
