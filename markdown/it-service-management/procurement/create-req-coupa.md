...
-   When a sam\_user creates a Purchase Order directly from the Remediation Options form. For more information, see [View software model results](https://www.servicenow.com/docs/access?context=t_ViewSWModelResults&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US).
