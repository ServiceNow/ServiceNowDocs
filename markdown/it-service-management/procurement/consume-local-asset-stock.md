...
**Note:** Use decision tables to customize the Asset Local Stock subflow. For more details, see [Hardware Asset Management flow customization](https://www.servicenow.com/docs/access?context=readily-available-dec-tables-ham&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US).
