...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/procurement/consume-local-asset-stock.html
release: zurich
product: Procurement
...
**Note:** Use decision tables to customize the Asset Local Stock subflow. For more details, see [Hardware Asset Management flow customization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-asset-management/readily-available-dec-tables-ham.md).
...
**Parent Topic:**[Sourcing items in a service catalog request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/procurement/c_SourcingRequestItems.md)
