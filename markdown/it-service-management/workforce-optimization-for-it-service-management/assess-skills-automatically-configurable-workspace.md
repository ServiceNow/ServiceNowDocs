...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/workforce-optimization-for-it-service-management/assess-skills-automatically-configurable-workspace.html
release: yokohama
...
If the [coaching opportunity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/coaching/create-coaching-opportunity.md) includes a survey, you can opt to take the survey and the assessment. When you use a survey to [assess a trainee](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/coaching/assess-trainee.md), the score for the survey is automatically calculated when you complete the survey. The assessment rating is then updated based on that score.
...
<table id="choicetable_k5z_rpq_pnb"><thead><tr><th align="left" id="d156137e109">

To

</th><th align="left" id="d156137e112">

Do this

</th></tr></thead><tbody><tr><td id="d156137e118">
