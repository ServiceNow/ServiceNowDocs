...
-   **[Configure the due date logic for shift approval flows](../task/configure-time-off-shift-swap-approval-flows.md)**  
As an administrator, you can configure the due date logic for the time-off request and shift-swap request approval flows.
-   **[Configure event categories for the ITSM Manager Workspace](../task/categorize-events-configurable-wfo-itsm.md)**  
...
-   **[Create or enable access to event types to add them to the team calendar](../task/configure-events-team-calendar-configurable-wfo-itsm.md)**  
...
-   **[Event type extension points in Workforce Optimization for ITSM](../reference/extension-points-configurable-workforce-optimization-itsm.md)**  
Use extension points to call scripts for event categories such as a meeting, time off, or work time.
-   **[Synchronize agent calendar in Workforce Optimization for ITSM with the Microsoft Outlook calendar](synchronize-microsoft-outlook-wfo-itsm.md)**  
