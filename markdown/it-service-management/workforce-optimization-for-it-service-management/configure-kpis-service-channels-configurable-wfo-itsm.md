...
7.  To create a KPI report that explicitly apply to your teams, do the following:
    ...
    2.  Fill in the details on the form. For more information, see [Single score report](https://www.servicenow.com/docs/access?context=c_SingleScoreCharts&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
    3.  Select **Save**.
    ...
    7.  Select the KPI report's table name and field name. For more information, see [Create a reference field interactive filter](https://www.servicenow.com/docs/access?context=t_CreateAReferenceFieldPublisher&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
    8.  Select **Submit**.
