...
[Create and bind a client state parameter to a component](https://www.servicenow.com/docs/access?context=state-parameters&version=zurich&pubname=zurich-application-development&ft:locale=en-US)
