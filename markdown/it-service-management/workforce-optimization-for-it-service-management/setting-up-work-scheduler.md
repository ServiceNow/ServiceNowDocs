...
-   **[Customize a Work Scheduler card using the Next Experience UI Builder](../task/customize-workscheduler-card-wfo-itsm.md)**  
...
-   **[Set up a work configuration](../task/setup-work-scheduler.md)**  
...
-   **[Create a Work scheduler card using the Next Experience UI Builder](../task/create-workscheduler-card-wfo-itsm.md)**  
...
-   **[Create extension points for Work scheduler](../task/create-work-sched-ext-points-wfo-itsm.md)**  
