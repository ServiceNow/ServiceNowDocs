...
4.  Fill in the fields on the form.
    ...
    For information on creating a new matching criteria, see [Create assignment workbench matching criteria](https://www.servicenow.com/docs/access?context=create-assignment-wkbench-criteria&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
