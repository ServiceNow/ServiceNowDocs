...
<table id="choicetable_bzs_wvn_rpb"><thead><tr><th align="left" id="d170403e312">

To integrate with this third-party learning source

</th><th align="left" id="d170403e315">

Do this

</th></tr></thead><tbody><tr><td id="d170403e321">
...
</td></tr><tr><td id="d170403e365">

**ServiceNow University application**

</td><td>

Register an OAuth application and authenticate requests from ServiceNow. Follow the steps in [Set up the ServiceNow University spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/create-now-learning-spoke.md) to perform the integration.
