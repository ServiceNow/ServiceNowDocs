...
<table id="choicetable_bzs_wvn_rpb"><thead><tr><th align="left" id="d169926e336">

To integrate with this third-party learning source

</th><th align="left" id="d169926e339">

Do this

</th></tr></thead><tbody><tr><td id="d169926e345">
...
</td></tr><tr><td id="d169926e389">

**ServiceNow University application**

</td><td>

Register an OAuth application and authenticate requests from ServiceNow. Follow the steps in [Set up the ServiceNow University spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/create-now-learning-spoke.md) to perform the integration.
