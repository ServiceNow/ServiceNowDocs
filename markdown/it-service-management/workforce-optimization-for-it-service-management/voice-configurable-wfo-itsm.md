...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/workforce-optimization-for-it-service-management/voice-configurable-wfo-itsm.html
release: yokohama
...
**Note:** You can integrate any third-party telephony service with the ServiceNow Voice Center application. By default, the Voice provides you with the ability to integrate with the Amazon Connect application.

You can visualize the metrics from the Amazon Connect phone queues that are routed through Voice using the Channels application in Workforce Optimization for ITSM.The Voice application uses Advanced Work Assignment to report data from the Amazon Connect queues.
...
-   View synchronized agent presence states within the Channels application in Workforce Optimization for ITSM.
...
-   **[Associate Amazon Connect queues for ITSM to a ServiceNow instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/workforce-optimization-for-it-service-management/setup-cloudcallcenter-itsm-configurable-workspace.md)**  
Set up phone queues for Amazon Connect to gain visibility into the queues using Workforce Optimization for ITSM.
-   **[Listen in to an agent call](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/workforce-optimization-for-it-service-management/listen-in-to-agent-call-configurable-workspace.md)**  
Monitor agent calls when they are resolving issues for external callers by using Workforce Optimization for ITSM.
-   **[Analyze transcripts and sentiments for the Amazon Connect phone channel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/workforce-optimization-for-it-service-management/analyze-transcripts-sentiments-wfo-itsm-confgurable-workspace.md)**  
