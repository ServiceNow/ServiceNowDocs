...
**Note:** You can integrate any third-party telephony service with the [ServiceNow Voice Center application](https://www.servicenow.com/docs/access?context=cloud-call-center-overview&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US). By default, the Voice provides you with the ability to integrate with the Amazon Connect application.
...
-   View synchronized [agent presence states](https://www.servicenow.com/docs/access?context=agent-experience&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US) within the Channels application in Workforce Optimization for ITSM.
