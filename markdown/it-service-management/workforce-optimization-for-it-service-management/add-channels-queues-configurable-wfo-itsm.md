...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/workforce-optimization-for-it-service-management/add-channels-queues-configurable-wfo-itsm.html
release: zurich
...
1.  To create a service channel, do the following:
    ...
    2.  Click **New** and refer to the information in the [Create a service channel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-create-service-channel.md) to create the service channel.
    3.  Click **Submit**.
...
2.  To create a queue, do the following:
    ...
    2.  Click **New** and refer to the information in [Create a work item queue](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-create-queue.md) to create the queue.
