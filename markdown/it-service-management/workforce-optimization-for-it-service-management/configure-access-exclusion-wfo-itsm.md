...
4.  Set the filter conditions to exclude the groups.
    ...
    For information on configuring condition builders, see [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
