...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/workforce-optimization-for-it-service-management/create-schedule-plan-wfo-itsm.html
release: xanadu
...
you must manually run the **Shift Planning - Delete All Agent Schedules Cache** [schedule job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/workforce-optimization-for-it-service-management/configurable-wfo-itsm-scheduling-reference.md) to clear the cache.
