...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/workforce-optimization-for-it-service-management/create-schedule-plan-wfo-itsm.html
release: australia
...
you must manually run the **Shift Planning - Delete All Agent Schedules Cache** [schedule job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/workforce-optimization-for-it-service-management/configurable-wfo-itsm-scheduling-reference.md) to clear the cache.
