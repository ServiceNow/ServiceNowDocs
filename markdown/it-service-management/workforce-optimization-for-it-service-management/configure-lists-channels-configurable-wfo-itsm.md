...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/workforce-optimization-for-it-service-management/configure-lists-channels-configurable-wfo-itsm.html
release: xanadu
...
3.  Click the **Supervisor Lists** tab.
    ...
    **Note:** If you do not see the **Supervisor Lists** tab, you must [configure the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/configure-form-layout.md) and the Reports related list.
