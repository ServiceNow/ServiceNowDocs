...
3.  Click the **Supervisor Lists** tab.
    ...
    **Note:** If you do not see the **Supervisor Lists** tab, you must [configure the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/configure-form-layout.md) and the Reports related list.
