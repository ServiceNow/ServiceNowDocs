...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/workforce-optimization-for-it-service-management/configuring-groups-wfo-itsm.html
release: zurich
...
-   **[Assign a primary assignment group for each agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/workforce-optimization-for-it-service-management/setup-primary-group-wfo-itsm.md)**  
...
[Exclude access for specific groups in Workforce Optimization for ITSM manager workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/workforce-optimization-for-it-service-management/configure-access-exclusion-wfo-itsm.md)

[Using extension points to include access for specific groups in Workforce Optimization for ITSM manager workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/workforce-optimization-for-it-service-management/ext-points-exclude-access-wfo-itsm.md)
