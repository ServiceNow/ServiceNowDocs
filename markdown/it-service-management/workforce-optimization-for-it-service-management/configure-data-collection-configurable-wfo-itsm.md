...
-   You must be in the [Global scope](https://www.servicenow.com/docs/access?context=c_GlobalScope&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
