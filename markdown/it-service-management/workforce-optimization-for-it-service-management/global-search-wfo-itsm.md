...
**Note:** To search shifts and schedules, you must [generate the text index](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/index-multiple-tables.md) for the following tables before you start performing the search for shifts and schedules:
