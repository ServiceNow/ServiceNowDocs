...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/workforce-optimization-for-it-service-management/configurable-wfo-itsm-channel-management-reference.html
release: yokohama
...
**Note:** To use channel management properties, they must be added to the System Property \[sys\_properties\] table. For information on how to add a system property, refer to .
