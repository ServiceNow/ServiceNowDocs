...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/workforce-optimization-for-it-service-management/publish-schedule-wfo-itsm.html
release: xanadu
...
4.  Publish a schedule.
    ...
    All the schedules that are in **Draft** state move to **Published** state. You can view the published schedule in the team calendar and also edit the name of the schedule.
