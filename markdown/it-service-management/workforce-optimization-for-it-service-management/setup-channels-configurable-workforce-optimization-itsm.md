...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/workforce-optimization-for-it-service-management/setup-channels-configurable-workforce-optimization-itsm.html
release: brazil
...
**Note:** As an administrator, you can configure filters to refine the search and view targeted results. Filters are persisted across all channel management pages in the session. To view a list of the default interactive filters and the KPI reports for channels, queues, agents, and groups that you can map to the interactive filters, see [the filter configuration tables for Channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/workforce-optimization-for-it-service-management/configure-filter-configurable-manager-workspace.md). By default, the assignment group filter is applied to all lists and groups that you manage. You can disable interactive filters by using the **sn\_channel\_mgmt.filter\_config.enable** property.

-   **[Add service channels and queues](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/workforce-optimization-for-it-service-management/add-channels-queues-configurable-wfo-itsm.md)**  
Add service channels and queues to automatically route incoming work items to agents.
-   **[Create assignment rules and groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/workforce-optimization-for-it-service-management/create-assignment-rules-configurable-wfo-itsm.md)**  
...
-   **[Configure KPIs for service channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/workforce-optimization-for-it-service-management/configure-kpis-service-channels-configurable-wfo-itsm.md)**  
...
-   **[Configure KPIs for agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/workforce-optimization-for-it-service-management/configure-kpis-agents-configurable-wfo-itsm.md)**  
...
-   **[Configure KPIs for queues](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/workforce-optimization-for-it-service-management/configure-kpis-queues-configurable-wfo-itsm.md)**  
...
-   **[Configure supervisor lists for service channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/workforce-optimization-for-it-service-management/configure-lists-channels-configurable-wfo-itsm.md)**  
Configure supervisor lists in a service channel to view the list of active work items across service channels and queues.
-   **[Schedule the generation of a daily report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/workforce-optimization-for-it-service-management/schedule-report-configurable-wfo-itsm.md)**  
Generate and distribute a daily scheduled report that summarizes the agent's work performance via email.
-   **[Channel Management extension point in Workforce Optimization for ITSM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/workforce-optimization-for-it-service-management/extension-points-channels-sort-order-wfo-itsm.md)**  
