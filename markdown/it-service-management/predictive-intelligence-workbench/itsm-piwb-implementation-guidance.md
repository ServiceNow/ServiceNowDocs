...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/predictive-intelligence-workbench/itsm-piwb-implementation-guidance.html
release: yokohama
...
\[Omitted image "ITSMPIWBUseCaseTemplateGuidedSetup.png"\] Alt text: ITSM Predictive Intelligence Workbench guided use case template

\[Omitted image "ITSMPIWBUseCaseTemplateClassicSetup.png"\] Alt text: ITSM Predictive Intelligence Workbench classic setup use case template
...
\[Omitted image "ITSMPIWBLinksProductDoc.png"\] Alt text: ITSM Predictive Intelligence Workbench links to product documentation and Predictive Intelligence product documentation
