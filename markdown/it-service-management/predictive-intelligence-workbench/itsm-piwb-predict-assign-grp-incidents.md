---
title: Predict Assignment Group for incoming incidents
description: Use this guided template to auto-assign incoming incidents to the correct assignment group to reduce your incident resolution times.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/predictive-intelligence-workbench/itsm-piwb-predict-assign-grp-incidents.html
release: yokohama
...
2.  Select the **Predict Assignment Group for incoming incidents** guided template.
    ...
    \[Omitted image "piwb-predict-assign-grp-template.png"\] Alt text: Predict Assignment Group for incoming incidents template
