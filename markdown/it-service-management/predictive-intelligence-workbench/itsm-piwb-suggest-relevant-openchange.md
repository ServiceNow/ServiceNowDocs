...
9.  Communicate the value of Predictive Intelligence to your stakeholders by linking business key performance indicators \(KPIs\) to machine learning metrics.
    ...
    For information regarding the Predictive Intelligence workbench dashboard, see [ITSM Predictive Intelligence Workbench dashboard](../../../use/dashboards/application-content-packs/itsm-piwb-incidents-dashboard.md).
