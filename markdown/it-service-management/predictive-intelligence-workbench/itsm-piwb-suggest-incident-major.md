---
title: Suggest relevant Incidents for a Major Incident
description: Use this template to recommend similar resolved incidents to help expedite your major incident investigation and resolution processes.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/predictive-intelligence-workbench/itsm-piwb-suggest-incident-major.html
release: yokohama
...
Use this template to recommend similar resolved incidents to help expedite your major incident investigation and resolution processes.
...
2.  Select the **Suggest relevant Incidents for an Major Incident** template.

    The **Suggest relevant Incidents for an Major Incident** pop-up opens featuring a link to this procedure and a link to the platform Predictive Intelligence product and associated documentation.
