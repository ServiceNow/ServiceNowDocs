...
3.  Create and train a machine learning predictive model.
    ...
    1.  [Create a word corpus](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/create-word-corpus.md).
    ...
    2.  [Create and train a similarity solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/create-similarity-solution.md).
...
4.  [Evaluation and tune your model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/review-similarity-examples.md).
    ...
    If you want to adjust the score for your similarity solution, refer to [Update your similarity score threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/update-similarity-threshold.md).

5.  Once you have a satisfactory model, [test the similarity solution prediction](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/test-similarity-solution-prediction.md).

    You can manually provide inputs and select the top similar results outcome values.

6.  Once you have tested the behavior, [configure the user experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/configuring-advanced-settings-ml-solutions.md) layout to show attributed results and actions performed on the results.
...
7.  [Integrate trained models by exporting them to production](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/implement-iterative-solution-updates.md).
