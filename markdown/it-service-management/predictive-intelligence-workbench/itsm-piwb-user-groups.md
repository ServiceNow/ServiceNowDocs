...
1.  To create an ITSM Predictive Intelligence Workbench user group and add users, refer to [Create a user group](https://www.servicenow.com/docs/access?context=t_CreateAGroup&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
