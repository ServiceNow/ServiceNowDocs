...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/predictive-intelligence-workbench/itsm-piwb-migration-utility.html
release: yokohama
...
\[Omitted image "itsm-piwb-migration-related-link.png"\] Alt text: Migration Utility Related Link on Classification Definition form
...
\[Omitted image "itsm-piwb-migration-utility-page.png"\] Alt text: Migration Utility detail page
...
\[Omitted image "itsm-piwb-migration-solution-popup.png"\] Alt text: Migration Utility alert pop-up

Clicking **Migrate** from this pop-up alert finalizes the migration.

\[Omitted image "itsm-piwb-migration-utility-migration-done.png"\] Alt text: Migration is complete pop-up
