...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/predictive-intelligence-workbench/itsm-piwb-similar-demands.html
release: yokohama
...
Use this template to include the demand name and description as inputs to list similar demands.
...
This use case template helps you improve your ITSM business ability to include the demand name and description as inputs to list similar demands. The template also provides a link to the Predictive Intelligence platform application and associated documentation.
