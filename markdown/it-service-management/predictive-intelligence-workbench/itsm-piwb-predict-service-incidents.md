...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/predictive-intelligence-workbench/itsm-piwb-predict-service-incidents.html
release: yokohama
...
2.  Select the **Predict Service for incoming incidents** guided template.
    ...
    \[Omitted image "piwb-use-case-predict-service-int.png"\] Alt text: Predict Service for incoming incidents template.
