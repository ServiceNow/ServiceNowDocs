...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/request-management/request-fulfillment.html
release: brazil
...
-   **[Service catalog workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/c_ServiceCatalogWorkflowDefinition.md)**  
...
-   **[Execution Plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/c_ExecutionPlans.md)**  
An execution plan describes how a catalog item is procured, configured, and installed.
-   **[Service Catalog checkout models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/c_EnableATwoStepCheckout.md)**  
...
-   **[Create a catalog request from another flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/create-request-from-other-flow.md)**  
...
-   **[Configure a parent mapping for a request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/configure-mapping-for-request.md)**  
You can configure a mapping that specifies the association between the parent record and the request record.
-   **[State closure in the request fulfillment execution plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/state-closure-request.md)**  
...
-   **[View request notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/view-request-notification.md)**  
