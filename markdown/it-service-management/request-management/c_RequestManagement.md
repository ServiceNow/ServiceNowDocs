...
-   **[Exploring Request Management](../../request-management/concept/exploring-request-management.md)**  
Request Management allows catalog items to be requested and fulfilled based on defined flows.
...
-   **[Agent Workspace for Request Management](../../service-catalog-management/concept/agent-workspace-request-mgmnt.md)**  
...
[Exploring Service Catalog](https://www.servicenow.com/docs/access?context=exploring-service-catalog&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
