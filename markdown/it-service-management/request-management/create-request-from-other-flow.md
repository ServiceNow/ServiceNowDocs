...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/request-management/create-request-from-other-flow.html
release: brazil
...
2.  Click the additional actions menu icon \[Omitted image "image.AdditinalActions"\] Alt text: Additional actions menu icon. and select **Create Request**.
...
4.  Check out the required catalog item, order guide, or record producer.
    ...
    For information on checkout models, see [.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/c_EnableATwoStepCheckout.md)
