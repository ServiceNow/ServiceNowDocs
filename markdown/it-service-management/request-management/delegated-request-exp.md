...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/request-management/delegated-request-exp.html
release: brazil
...
-   Requested For variable for a catalog item. For information about this variable, see .
...
For information about cloning requests, see .
...
-   **[Configure the default behavior to request items for other users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/config-default-behavior-request-other-user.md)**  
