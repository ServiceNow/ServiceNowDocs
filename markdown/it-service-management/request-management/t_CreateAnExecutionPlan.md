...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/request-management/t\_CreateAnExecutionPlan.html
release: brazil
...
2.  Click **New**.
    ...
    \[Omitted image "image.CreateAnExecutionPlan"\] Alt text:

3.  Enter a Name and Short description for the execution plan.

4.  Specify [delivery information](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/c_ExecutionPlanTasks.md) in the Total delivery time and On Calendar fields.
