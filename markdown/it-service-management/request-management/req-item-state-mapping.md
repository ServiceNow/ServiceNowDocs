...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/request-management/req-item-state-mapping.html
release: xanadu
...
3.  On the form, fill in the fields.
    ...
    For more information, see [State mapping form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/universal-request-for-hr-service-delivery/ur-state-mapping-form.md).


**Parent Topic:**[Request Management integration with Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/request-management/request-mgmt-integration-ur.md)
