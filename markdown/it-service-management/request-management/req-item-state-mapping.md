...
3.  On the form, fill in the fields.
    ...
    For more information, see [State mapping form](https://www.servicenow.com/docs/access?context=ur-state-mapping-form&version=australia&pubname=australia-employee-service-management&ft:locale=en-US).
