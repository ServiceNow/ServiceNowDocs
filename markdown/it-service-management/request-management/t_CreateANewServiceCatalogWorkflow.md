...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/request-management/t\_CreateANewServiceCatalogWorkflow.html
release: brazil
...
breadcrumb: [Service catalog workflows, Service Catalog request fulfillment, Configure, Request Management, IT Service Management]
---
...
2.  Click **New Workflow**.
    ...
    \[Omitted image "image.ServiceCatalogWorkflowForm"\] Alt text: Service catalog workflow form
...
`A workflow for the fulfillment of laptop requests.`
    ...
    \[Omitted image "image.ServiceCatalogWorkflowFormActivities"\] Alt text: Service catalog workflow form activities
...
**Parent Topic:**[Service catalog workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/c_ServiceCatalogWorkflowDefinition.md)
