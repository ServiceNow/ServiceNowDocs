...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/request-management/config-default-behavior-request-other-user.html
release: brazil
...
breadcrumb: [Delegated request experience, Configure, Request Management, IT Service Management]
---
...
The **glide.sc.req\_for.roles** property specifies the list of roles who can request items for other users. When no roles are specified, then the default behavior is defined by the **glide.sc.req\_for.roles.default** property. For information about the **glide.sc.req\_for.roles** property, see .
...
**Parent Topic:**[Delegated request experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/request-management/delegated-request-exp.md)
