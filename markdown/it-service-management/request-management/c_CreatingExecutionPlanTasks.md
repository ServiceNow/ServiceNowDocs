...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/request-management/c\_CreatingExecutionPlanTasks.html
release: brazil
...
\[Omitted image "image.ApplyConditionToTasks"\] Alt text:
...
\[Omitted image "image.UseConditionScriptsToRunTasks"\] Alt text: Use Condition Scripts
