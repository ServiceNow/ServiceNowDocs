...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/request-management/request-mgmt-integration-ur.html
release: xanadu
...
-   **[Create a request from Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/request-management/create-request-from-ur.md)**  
...
-   **[Requested item state mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/request-management/req-item-state-mapping.md)**  
...
-   **[Transfer a request to another department](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/request-management/req-transfer-ur.md)**  
Transfer a request to another department with or without resolution to fulfill the request.

**Parent Topic:**[Configuring Request Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/request-management/configuring-request-management.md)
