...
1.  Navigate to the homepage.\[Omitted image "employeeworks-landing-page.png"\] Alt text: landing page
...
2.  Select **View details**.\[Omitted image "employeeworks-all-services.png"\] Alt text: All services for that has the Service health and Scheduled maintenance tabs
...
3.  Select a service to drill down into the details for .

    \[Omitted image "employeeworks-service-details.png"\] Alt text: Drilldown into a service in

4.  From the Servicehealth banner in the homepage, select **Ask Otto** to open a chat that automatically summarizes active outages for services you can access.

    **Note:** Make sure the Outage lookup plugin is installed to view the Ask Otto conversations.

    \[Omitted image "employeeworks-ask-otto.png"\] Alt text: Ask Otto chat in

5.  Add the **Tech lounge** quick link to the homepage.

    For more information, see [Configure EmployeeWorks Web App](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/employee-service-management/empworks-configure-employee-slate-moveworks.md).
