...
2.  Select **Resolve**.
    ...
    -   When you select **Resolve**, the large loader icon![](../image/itsm-res-notes-large-loader-icon.png) displays when the notes are being generated by Now Assist. The small loader icon ![](../image/itsm-res-notes-small-loader-icon.png)displays when resolution notes are pre-filled on the incident.
...
<table id="choicetable_uh4_l1f_xyb"><thead><tr><th align="left" id="d183915e390">

Interface

</th><th align="left" id="d183915e393">

Procedure

</th></tr></thead><tbody><tr><td id="d183915e399">
