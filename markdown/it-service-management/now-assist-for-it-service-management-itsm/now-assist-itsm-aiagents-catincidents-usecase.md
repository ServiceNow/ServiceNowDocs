...
To modify the Triage and categorize ITSM incidents agentic workflow, [duplicate it](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/clone-aia-usecase.md), and adjust the settings according to your requirements.

**Note:** You must enable the semantic indexing for the Problem table when you duplicate the agentic workflow. For more information, see [Semantic Index Field form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/semantic-index-field-form.md).
...
2.  The first AI agent, which is the Categorize ITSM incident AI agent does the following:
    ...
    2.  Updates any changes in the **Work notes** field.
        ...
        \[Omitted image "now-assist-itsm-inc-cat-nap.png"\] Alt text: Orchestrator then moves to the next available agent
