...
Using the Now Assist panel saves time for an agent; for example, the agent can quickly learn the details of an incident by reading the incident summarization. The summarization gives enough details about the associated interaction so that the requester doesn't have to repeat the same information to the agent. For information about the Now Assist panel, see [Now Assist panel](https://www.servicenow.com/docs/access?context=now-assist-panel-overview&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).

For information about how to activate the Now Assist panel, see [Activate the Now Assist panel standard chat](https://www.servicenow.com/docs/access?context=activate-now-assist-panel&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
...
<table id="choicetable_tvj_cqn_xyb"><thead><tr><th align="left" id="d278778e207">

Option

</th><th align="left" id="d278778e210">

Description

</th></tr></thead><tbody><tr><td id="d278778e216">
...
For more information, see [Conversational actions](https://www.servicenow.com/docs/access?context=conversational-actions&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
