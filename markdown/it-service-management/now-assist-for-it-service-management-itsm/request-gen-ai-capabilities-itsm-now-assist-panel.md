...
For information about how to activate the Now Assist panel, see [Turn on the Now Assist panel](https://www.servicenow.com/docs/access?context=activate-now-assist-panel&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).
...
<table id="choicetable_tvj_cqn_xyb"><thead><tr><th align="left" id="d103077e200">

Option

</th><th align="left" id="d103077e203">

Description

</th></tr></thead><tbody><tr><td id="d103077e209">
...
2.  Follow the on-screen instructions to complete the task.
For more information, see [Conversational actions](https://www.servicenow.com/docs/access?context=conversational-actions&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
