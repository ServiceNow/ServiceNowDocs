...
To modify the Wrap-up and resolve incident agentic workflow, [duplicate it](https://www.servicenow.com/docs/access?context=clone-aia-usecase&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US), and adjust the settings according to your requirements.
...
**Parent Topic:**[Agentic AI Now Assist for Incident Management](using-agentic-ai-workflow-im.md)
