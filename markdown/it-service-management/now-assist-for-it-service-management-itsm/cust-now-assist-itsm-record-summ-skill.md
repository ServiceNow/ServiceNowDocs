...
-   You can also extract the summarized content from the attachment in any of these languages:
    ...
    -   Portuguese
    -   Spanish
When you use [translate with Dynamic Translation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/using-dynamic-translation.md), you can also translate user-generated content live on your instance in additional languages. For more information, see [Dynamic Translation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/using-dynamic-translation.md).**Note:**
...
<table id="choicetable_ipx_pkr_2hc"><thead><tr><th align="left" id="d446714e568">

To

</th><th align="left" id="d446714e571">

Do this

</th></tr></thead><tbody><tr><td id="d446714e577">
