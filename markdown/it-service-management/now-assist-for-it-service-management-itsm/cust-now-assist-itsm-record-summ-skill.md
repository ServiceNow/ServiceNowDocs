...
-   You can also extract the summarized content from the attachment in any of these languages:
    ...
    -   Portuguese
    -   Spanish
When you use translate with Dynamic Translation, you can also translate user-generated content live on your instance in additional languages. For more information, see Dynamic Translation.**Note:** Attachment summaries aren't available in child incident records and are only supported in the English language.
...
<table id="choicetable_ipx_pkr_2hc"><thead><tr><th align="left" id="d393594e557">

To

</th><th align="left" id="d393594e560">

Do this

</th></tr></thead><tbody><tr><td id="d393594e566">
