...
-   Next Experience must be enabled to summarize Sidebar discussions in Core UI. For more information, see [Considerations for activating Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/next-experience-adoption-paths.md).
-   The Sidebar Chat Summarization skill must be enabled. For more information, see [Activate an AI skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/configure-a-now-assist-skill.md).
...
Summarizing Sidebar chats integrated with Microsoft Teams is supported. For more information, see [Sidebar and Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/sidebar-teams-overview.md).
...
3.  Generate a summary of the Sidebar discussion during the conversation either by either entering `/Summarize` in the Active Sidebar discussion window, or by selecting the quick action icon \[Omitted image "now-assist-sidebar-lightning-bolt-icon.png"\] Alt text: Quick action icon. and selecting **Summarize**.
    ...
    The Sidebar discussion summary appears in the Discussion that is summarized by the ServiceNow Otto modal.

4.  Add the summary to the incident work notes, and provide feedback about it.

<table id="choicetable_oz1_rtx_1cc"><thead><tr><th align="left" id="d445091e253">

Option

</th><th align="left" id="d445091e256">

Procedure

</th></tr></thead><tbody><tr><td id="d445091e262">
