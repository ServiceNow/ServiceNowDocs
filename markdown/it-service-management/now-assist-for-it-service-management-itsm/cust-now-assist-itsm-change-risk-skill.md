...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/now-assist-for-it-service-management-itsm/cust-now-assist-itsm-change-risk-skill.html
release: xanadu
...
6.  Choose the change request input data.
    ...
    1.  Add base input table fields.
        ...
        **Important:** If you add a new field with the same name as an existing field, the name and description of the new field will override the description of the existing field.
        ...
        \[Omitted image "itsm-now-assist-change-choose-input.png"\] Alt text: Choose input data screen for change request risk explanation
