...
Relationship between the input table and the table field.
    ...
    4.  Select input data from past similar changes.
        ...
        **Note:**
        ...
        -   You must have AI Search implemented to retrieve similar changes. For more information on AI Search, see AI Search.
        -   The search criteria to retrieve similar changes is based on the conditions set in the Change Requests search source. For information on search source, see Search Source form.
