...
1.  [Add the **sn\_itsm\_aia.office\_365\_group\_member\_approval.required** system property](https://www.servicenow.com/docs/access?context=r_AvailableSystemProperties&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).

**Note:** This property is set to **true** by default.

2.  [Add the **sn\_itsm\_aia.office\_365\_group\_member\_approval.group\_id** system property](https://www.servicenow.com/docs/access?context=r_AvailableSystemProperties&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
To modify the Manage Microsoft 365 group members agentic workflow, [duplicate it](https://www.servicenow.com/docs/access?context=clone-aia-usecase&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US), and adjust the settings according to your requirements.
