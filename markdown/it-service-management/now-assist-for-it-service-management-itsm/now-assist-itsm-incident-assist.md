...
2.  From the header menu, select the ServiceNow Otto icon \[Omitted image "now-assist-sn-otto-dark-icon.png"\] Alt text: ServiceNow Otto icon to open the ServiceNow Otto panel.
