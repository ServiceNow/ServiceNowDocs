---
title: Summarize a change request by using ServiceNow Otto for IT Service Management \(ITSM\)
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/now-assist-for-it-service-management-itsm/summarize-change-now-assist.html
release: australia
...
# Summarize a change request by using ServiceNow Otto for IT Service Management \(ITSM\)

Quickly capture the important details of a change request, including the current status, by using the change request summarization skill in the ServiceNow Otto for IT Service Management \(ITSM\) application.
...
For information about the change request states, see [State progression for normal, standard, and emergency changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/change-management/normal-standard-emergency-states.md).
...
<table id="choicetable_c2n_fsz_xbc"><thead><tr><th align="left" id="d356976e231">

Option

</th><th align="left" id="d356976e234">

Procedure

</th></tr></thead><tbody><tr><td id="d356976e240">
