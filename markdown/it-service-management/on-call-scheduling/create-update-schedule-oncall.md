...
Option to send [on-call reminders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/escalation-remind-settings-oncall.md) to members of the roster.
...
Interval for updates of coverage details. Specifies whether you want to update the [subscribed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/view-my-schedule-on-my-app-oncall.md) calendar with weekly or daily coverage details.
...
Use the edit icon to edit the name of the [roster](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/config-roster-oncall.md) that you are adding members to.
...
**Note:** This option is available only for the 2024 schedule engine. For information about this schedule engine, see [On-Call Scheduling new schedule engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/oncall-schedule-engine.md).
...
If your choice is not in the list, select the closest value. [Edit the roster](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/update-shift-from-calendar-oncall.md) to update the number of reminders after the schedule is generated.
...
-   **[Updating an On-Call schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/update-schedule-oncall.md)**  
...
-   **[Update a schedule entry](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/schedule-entry-update-oncall.md)**  
You can deactivate a schedule entry or update setting like schedule entry type, date, or time.
-   **[Specify the sources of contact information for schedule notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/config-contact-sources-oncall.md)**  
...
-   **[Manage shifts from the Calendar view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/customize-calendar-view-oncall.md)**  
...
-   **[Manage shifts from the Timeline view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/customize-timeline-view-oncall.md)**  
