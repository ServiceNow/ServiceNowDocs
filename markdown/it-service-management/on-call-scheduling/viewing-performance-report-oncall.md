...
**Important:** Starting in Xanadu release, the On-Call dashboard is deprecated. Users can use [On-call dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/oncall-scheduling.md) to view, maintain, and track the performance reports.
...
-   **Records tab**
    ...
    **Note:** Each record also appears in the appropriate escalation log. See [View details in an escalation log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/view-escalation-logs-oncall.md).
