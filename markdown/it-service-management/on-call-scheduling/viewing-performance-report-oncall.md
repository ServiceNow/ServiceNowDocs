...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/on-call-scheduling/viewing-performance-report-oncall.html
release: yokohama
...
**Important:** Starting in Xanadu release, the On-Call dashboard is deprecated. Users can use [On-call dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/oncall-scheduling.md) to view, maintain, and track the performance reports.
...
-   **Records tab**
    ...
    **Note:** Each record also appears in the appropriate escalation log. See [View details in an escalation log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/on-call-scheduling/view-escalation-logs-oncall.md).
...
\[Omitted image "perform-all-esc-reports-tab.png"\] Alt text: All Escalations tab

## Acknowledged Escalations tab

\[Omitted image "perform-ack-esc-reports-tab.png"\] Alt text: Performance &gt; Acknowledged Escalations reports
