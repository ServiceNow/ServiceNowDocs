...
For information about escalation policy, see [Create an escalation policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/create-custom-esc-policy-oncall.md).

For information about escalation trigger rule, see [Create an escalation trigger rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/create-trigger-rule-oncall.md).
...
-   **[Delivery status tracking for On-Call Scheduling notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/delivery-status-tracking-oncall.md)**  
...
[Legacy: Viewing Escalation Overview reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/viewing-esc-oview-report-oncall.md)
