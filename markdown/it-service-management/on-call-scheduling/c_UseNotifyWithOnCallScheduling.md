...
To set up SMS and voice message as contact methods, see [Set up Notify with On-Call Scheduling](https://www.servicenow.com/docs/access?context=t_SetUpNotifyWithOnCall&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)
...
[On-Call Assign by Acknowledgement workflow](https://www.servicenow.com/docs/access?context=c_OnCallAssignByAckWorkflow&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)

[Controlling the on-call communication channel with Notify](https://www.servicenow.com/docs/access?context=c_OnCallNotifyForceCommChannel&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)
