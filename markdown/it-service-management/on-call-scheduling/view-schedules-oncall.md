...
On-Call schedules enable you to view the presence of on-call members. For more information on presence, see [User presence](https://www.servicenow.com/docs/access?context=c_UserPresence&version=australia&pubname=australia-platform-user-interface&ft:locale=en-US).
...
5.  To view roster and escalation details, click **Roster and escalation details** on the shift card.
    ...
    **Note:** By default, the details of the on-call member of the primary roster are displayed. Click **Send a direct message** to send a direct message to the on-call member. Alternatively, call the member if the Notify WebRTC is configured. For more information on real-time messaging, see [Connect](https://www.servicenow.com/docs/access?context=c_Connect&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US). For information on Notify WebRTC, see [Forward call workflow activity](https://www.servicenow.com/docs/access?context=r_WorkflowActivityForwardCall&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US). For information on the **Specify a valid Notify Number with voice capability** property that enables the Notify WebRTC for on-call, see [System properties for On-Call Scheduling](../reference/on-call-properties.md).
