...
On-Call schedules enable you to view the presence of on-call members. For more information on presence, see [User presence](https://www.servicenow.com/docs/access?context=c_UserPresence&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
