...
-   **Forced communication channel**: You can specify a mandatory communication channel: SMS, voice, Slack, email, Microsoft Teams, or mobile push.
    ...
    For information on setting up MS Teams as a notification channel, see [Set up Microsoft Teams as a contact method for an on-call escalation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/set-up-msteams-oncall.md).

    For information on setting up mobile push as a notification channel, see [Set up mobile push as a contact method for an on-call escalation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/set-up-mobile-push-oncall.md).
...
For detailed instructions, see [Configure a roster](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/config-roster-oncall.md).
