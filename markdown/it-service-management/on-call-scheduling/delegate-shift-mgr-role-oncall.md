...
2.  Follow the instructions to [Delegating roles](https://www.servicenow.com/docs/access?context=c_DelegateRoles&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) the shift manager role to a member of your shift.
