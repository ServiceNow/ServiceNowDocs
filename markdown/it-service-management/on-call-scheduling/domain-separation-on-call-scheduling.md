...
To learn more, see [Domain support for schedules](https://www.servicenow.com/docs/access?context=domain-support-for-schedules&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
