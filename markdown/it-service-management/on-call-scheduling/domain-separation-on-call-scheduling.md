...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/on-call-scheduling/domain-separation-on-call-scheduling.html
release: xanadu
...
## On-Call Scheduling tables that use the domain\_master attribute
...
To learn more, see [Domain support for schedules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/time-configuration/domain-support-for-schedules.md)
