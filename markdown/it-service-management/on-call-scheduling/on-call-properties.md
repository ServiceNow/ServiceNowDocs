...
Determines whether the escalations can be logged.If true, the escalations are logged.

Default value: true

For more information, see [View details in an escalation log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/view-escalation-logs-oncall.md).Location: System Property \[sys\_properties\] table
...
-   The property is enabled only when the [Notify](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/t_ActivateNotify.md) plugin \(com.snc.notify\) is active.
...
</table>**Parent Topic:**[Reference for on-call scheduling](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/on-call-scheduling/reference-for-on-call-scheduling.md)
