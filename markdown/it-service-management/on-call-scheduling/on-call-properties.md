...
-   The property is enabled only when the [Notify](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/notify/t_ActivateNotify.md) plugin \(com.snc.notify\) is active.
