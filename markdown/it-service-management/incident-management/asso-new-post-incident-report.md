...
2.  Create a UI page.
    ...
    For information on how to create a UI page, refer [UI pages](https://www.servicenow.com/docs/access?context=r_UIPages&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
