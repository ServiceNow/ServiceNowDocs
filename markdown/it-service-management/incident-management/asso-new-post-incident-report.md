...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/incident-management/asso-new-post-incident-report.html
release: xanadu
...
2.  Create a UI page.
    ...
    For information on how to create a UI page, refer [UI pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/scripts/r_UIPages.md).
