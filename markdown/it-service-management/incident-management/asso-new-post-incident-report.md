...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/incident-management/asso-new-post-incident-report.html
release: yokohama
...
2.  Create a UI page.
    ...
    For information on how to create a UI page, refer [UI pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/scripts/r_UIPages.md).
