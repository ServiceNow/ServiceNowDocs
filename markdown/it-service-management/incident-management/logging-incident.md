...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/incident-management/logging-incident.html
release: xanadu
...
-   Incidents can be generated from outside the platform with SOAP messaging. For more information, refer to [SOAP messaging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/web-services/c_DirectWebServices.md) .
