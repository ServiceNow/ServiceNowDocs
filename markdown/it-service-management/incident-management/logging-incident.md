...
-   Incidents can be generated from outside the platform with SOAP messaging. For more information, refer to [SOAP messaging](https://www.servicenow.com/docs/access?context=c_DirectWebServices&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US) .
