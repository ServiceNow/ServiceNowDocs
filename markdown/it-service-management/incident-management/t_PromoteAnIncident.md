...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/incident-management/t\_PromoteAnIncident.html
release: yokohama
...
<table id="choicetable_s5g_lgw_xy"><thead><tr><th align="left" id="d79716e80">

Task record

</th><th align="left" id="d79716e83">

Option

</th></tr></thead><tbody><tr><td id="d79716e89">
...
</td></tr><tr><td id="d79716e130">

**Change**

</td><td>

Create Normal, Standard, or Emergency Change. For more information, refer to [Create a change request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/t_CreateAChange.md).**Note:**
