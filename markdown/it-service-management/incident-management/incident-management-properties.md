...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/incident-management/incident-management-properties.html
release: yokohama
 ...
 **Note:** Starting with the Yokohama release, this property is automatically set to **true** for new customers. Existing customers have to set the property to **true** manually.
...
</table>**Parent Topic:**[Configuring Incident Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/incident-management/incident-configuration.md)
