 ...
 **Note:** Starting with the Zurich release, this property is automatically set to **true** for new customers. Existing customers have to set the property to **true** manually.
