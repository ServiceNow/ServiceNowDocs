...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/incident-management/major-incident-overview.html
release: zurich
...
Starting in Xanadu release, the Major incident overview dashboard is deprecated. Users can use [Major incident dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/major-incident.md) to view the process and communication related metrics for Open and Closed major incidents.
