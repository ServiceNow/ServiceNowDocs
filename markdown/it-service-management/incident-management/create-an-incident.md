...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/incident-management/create-an-incident.html
release: yokohama
...
2.  [Use a template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/incident-management/t_UseATemplateFromAForm.md), if one exists for the type of incident that you are logging.
...
[Create a record from incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/incident-management/t_PromoteAnIncident.md)
