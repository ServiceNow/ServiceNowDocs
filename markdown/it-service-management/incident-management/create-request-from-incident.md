...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/incident-management/create-request-from-incident.html
release: xanadu
...
5.  Check out the required catalog item, order guide, or record producer.
    ...
    For information on checkout models, see [Service Catalog checkout models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/service-catalog/c_EnableATwoStepCheckout.md).
