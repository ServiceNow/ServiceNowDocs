...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/incident-management/itsm-incident-use-case.html
release: xanadu
...
3.  Business Service \[cmdb\_ci\_service\_business\] table and Technical service \[cmdb\_ci\_service\_technical\] table: Use the service classification attribute to identify business services, technical services, and application services as types of services.
...
\[Omitted image "incident-elements-4.png"\] Alt text: CSDM tables used by Incident Management.
