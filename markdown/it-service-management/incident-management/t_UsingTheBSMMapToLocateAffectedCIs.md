...
<table id="choicetable_crl_z1k_yy"><thead><tr><th align="left" id="d78542e74">

From where

</th><th align="left" id="d78542e77">

Action

</th></tr></thead><tbody><tr><td id="d78542e83">
...
</table>2.  Click the dependency views icon \(![Dependency views icon](../image/BusinessServiceMapIcon.png)\) beside the **Configuration item** field.
...
[Dependency Views map](https://www.servicenow.com/docs/access?context=c_NextGenBSMMaps&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
