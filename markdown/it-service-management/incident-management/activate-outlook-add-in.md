...
For more information, see [Install the ServiceNow Add-in for Microsoft 365](https://www.servicenow.com/docs/access?context=install-sn-addin-for-ms365&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US) and [Components installed with ServiceNow Add-in for Microsoft 365](https://www.servicenow.com/docs/access?context=installed-with-sn-addin-ms365&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US).
