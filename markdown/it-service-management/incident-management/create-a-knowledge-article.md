...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/incident-management/create-a-knowledge-article.html
release: yokohama
...
Activate the [KCS Integration for Incident Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/incident-management/activate-kcs-integration-for-im.md) plugin \(com.snc.incident.knowledge\).
...
3.  Access the Incident-KCS article - HTML form using one of the following methods:
    ...
    The base system **Incident-KCS article - HTML** template appears by default. To use a custom template instead, refer to [Create an article template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/knowledge-management/create-a-new-article-templates.md).
...
4.  On the form, fill in the fields.
    ...
    |Workflow|\[Auto-generated\] Workflow that is followed for creating the knowledge article. For more information, refer [Knowledge workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/knowledge-management/r_KnowledgeWorkflows.md) .|
