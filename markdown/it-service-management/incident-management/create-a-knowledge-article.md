...
3.  Access the Incident-KCS article - HTML form using one of the following methods:
    ...
    The base system **Incident-KCS article - HTML** template appears by default. To use a custom template instead, refer to [Create an article template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/create-a-new-article-templates.md).
...
4.  On the form, fill in the fields.
    ...
    |Workflow|\[Auto-generated\] Workflow that is followed for creating the knowledge article. For more information, refer [Knowledge workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/r_KnowledgeWorkflows.md) .|
