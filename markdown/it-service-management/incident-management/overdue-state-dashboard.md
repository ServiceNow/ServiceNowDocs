...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/incident-management/overdue-state-dashboard.html
release: australia
...
Starting in Xanadu release, the Overdue by State dashboard is deprecated. Users can use [Incident management dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/incident.md) to view the incidents that are overdue according to an SLA, divided by the New, In Progress, and On Hold states.
