...
2.  Click **New** and complete the steps in [Create a record producer](https://www.servicenow.com/docs/access?context=t_DefRecProdInSCat&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
