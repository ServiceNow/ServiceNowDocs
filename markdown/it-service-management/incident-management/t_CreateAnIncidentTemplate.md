...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/incident-management/t\_CreateAnIncidentTemplate.html
release: yokohama
...
1.  Navigate to **All** &gt; **System Definition** &gt; **Templates**.
    ...
    You can also [Create a template from the incident form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/incident-management/create-template-inci-form.md).

2.  Complete the steps in [Create a template using the Template form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_CreateATemplateUsingTheTmplForm.md) using the following information:
