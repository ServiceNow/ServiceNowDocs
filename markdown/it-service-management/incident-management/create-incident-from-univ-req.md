...
4.  Fill in the fields on the [incident form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/incident-management/create-an-incident.md) and click **Submit**.
