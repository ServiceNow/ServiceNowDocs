...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/digital-end-user-experience-dex/user-health-card.html
release: zurich
...
**Note:** The data appears on this page only after the System compliance functionality has been configured. For more information, see [Manage your system compliance report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/digital-end-user-experience-dex/manage-compliance-report.md).
...
**Note:** The data appears on this page only after File management has been set up. For more information, see [Set up file management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/digital-end-user-experience-dex/set-up-file-mgmt.md).
