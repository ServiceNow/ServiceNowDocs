...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/digital-end-user-experience-dex/user-health-card.html
release: australia
...
The icon for a service management event displays a pop-up window that provides information about the event record link, state, priority, and the time the event was created. Select the record link to open the event record and view more details.
...
**Note:** The data appears on this page only after File management has been set up. For more information, see [Set up file management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/digital-end-user-experience-dex/set-up-file-mgmt.md).
