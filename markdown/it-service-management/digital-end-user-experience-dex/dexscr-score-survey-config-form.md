...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/digital-end-user-experience-dex/dexscr-score-survey-config-form.html
release: brazil
...
For more information, see [Update DEX Score survey configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/dexscr-set-survey-config.md).
