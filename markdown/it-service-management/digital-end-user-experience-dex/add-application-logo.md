...
2.  Select the **Manage Applications** card.
    ...
    The list of monitored application appears.

3.  Select the name of the application for which you'd like to add a logo.

    The Edit Application form appears.

4.  Select the **Add/Edit image** link.

    The Application form opens in a new window.

5.  On the **Logo** field, select **Click to add**.

6.  Select **Choose file**, select **Open**, and then select **OK**.
