...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-dex/add-application-logo.html
release: yokohama
...
3.  Select the **Manage Applications** card.
