...
2.  From the primary navigation pane, select the DEX Administration icon \(![Administration icon](../image/icon-administration.png)\).
...
5.  To monitor an application from the pre-existing list, turn on the application monitoring.
    ...
    For more information on how to turn on an application, see [Enable application monitoring](enable-app-monitor.md).
