...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/digital-end-user-experience-dex/view-dex-metrics.html
release: xanadu
...
5.  In the Metrics analyzer window, search for or select up to five metrics to display as a graph.
    ...
    To learn more, see [Metrics analyzer form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/digital-end-user-experience-dex/metrics-analyzer.md).
