...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/digital-end-user-experience-dex/using-dex-or-sam-for-app-monitoring.html
release: zurich
...
</table>For more information for application monitoring with DEX, see [Add an application for monitoring](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/digital-end-user-experience-dex/add-new-application.md).

For more information on application monitoring with SAM, see the following:

-   [Using push-based Discovery and SAM together](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/using-enhanced-discovery-and-sam-together.md)
-   [SaaS detection report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-asset-management/shadow-saas-analytics.md)
