...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/digital-end-user-experience-dex/device-actions-issues.html
release: brazil
...
Confirm that the sudoers file grants the required permissions to `_servicenow`.For more information, see [Configure ServiceNow sudoers file](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/config-sudoers-file.md).
