...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/digital-end-user-experience-dex/dexscr-dex-score-normalization.html
release: brazil
...
In Digital Experience Score​, key metrics monitored from applications and devices are normalized on a scale of 100. The normalization maps the Good, Average, or Poor range of the actual metric value to the corresponding range definition.
...
You can customize the lower bound values for Good, Average, and Poor ranges. For more information, see [Customize metric definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/dexscr-customize-dex-score-metric-defs.md)
...
**Parent Topic:**[Digital Experience Score​ reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/dexscr-dex-score-reference.md)
