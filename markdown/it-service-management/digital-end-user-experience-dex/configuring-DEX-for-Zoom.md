...
1.  Integrate your Zoom account with your ServiceNow instance so that you can use the DEX for Zoom to perform various actions on your Zoom account. You can also create a custom OAuth application in the Zoom account to authenticate requests from your instance.
    ...
    -   [Create a connected Zoom application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/create-a-connected-zoom-app.md).
    -   [Add Zoom connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/add-zoom-connection.md).
2.  [Enable application monitoring](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/enable-app-monitor.md) to gain insights into call quality metrics and diagnose issues to enhance performance.
