...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-service-management/digital-end-user-experience-dex/dexscr-customize-dex-score-metric-defs.html
release: brazil
...
5.  On the form, customize the remaining fields.
    ...
    For a description of the field values, see [Metric definition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/dexscr-dex-metric-def-form.md).
...
[Define qualitative mapping for a DEX Score metric](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/dexscr-define-qlty-metric-score-mapping.md)
