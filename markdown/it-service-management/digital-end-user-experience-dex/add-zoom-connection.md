...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-dex/add-zoom-connection.html
release: yokohama
...
3.  In the **Search all connections** field, enter `DEX for Zoom`.
    ...
    \[Omitted image "image.zoom\_search\_for\_Dex"\] Alt text: Searching DEX for Zoom
...
5.  On the form, fill the following values.
    ...
    \[Omitted image "image.zoom\_edit\_connection\_details"\] Alt text: Generate OAuth Token.

6.  Select **Configure and Get OAuth Token**.

    A confirmation message is displayed that the token is available.\[Omitted image "image.zoom\_dex\_confirmation\_message"\] Alt text: Confirmation that refresh token is available.
