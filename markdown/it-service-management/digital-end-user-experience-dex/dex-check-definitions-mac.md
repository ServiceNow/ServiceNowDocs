...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-dex/dex-check-definitions-mac.html
release: yokohama
...
To promote proper sudo configuration, remove the following file:
