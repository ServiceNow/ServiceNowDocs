...
description: Diagnose and resolve issues on DEX monitored devices directly from the Investigation tab of an incident record or by using the DEX diagnosis and resolution agentic workflow from the Now Assist panel.
locale: en-US
release: zurich
