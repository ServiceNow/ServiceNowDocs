...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-dex/add-home-page-section.html
release: yokohama
...
3.  Select the application scope.
    ...
    1.  Select the globe icon \[Omitted image "image.icon-globe"\] on the top navigation bar.
