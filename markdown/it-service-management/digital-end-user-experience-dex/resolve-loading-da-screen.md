...
description: 
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/digital-end-user-experience-dex/resolve-loading-da-screen.html
release: xanadu
...
# Resolve the loading failure of your DEX Desktop Assistant screen

## Symptom

My DEX Desktop Assistant screen is empty or in a continuously loading state. 
...
3.  Clear the Electron settings file at the following location:
    ...
    -   Windows OS: `~\AppData\Roaming\desktop_assistant_app\settings.json`
