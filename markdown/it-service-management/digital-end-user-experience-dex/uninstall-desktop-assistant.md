...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-dex/uninstall-desktop-assistant.html
release: yokohama
...
Remove Desktop Assistant effortlessly using single-line uninstaller commands for a clean system.

## Before you begin

Ensure you have administrator privileges for the operating system to run the one-liner script.
...
The Desktop Assistant app is uninstalled.
