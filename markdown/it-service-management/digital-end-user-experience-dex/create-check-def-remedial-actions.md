...
-   Upload the signed ACC plugin `tar.gz` file to the ServiceNow instance. For more information, see [Create and edit Agent Client Collector plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/create-edit-assets.md).
...
5.  In the **Command** field, enter the name of the `.rb` script included in the ACC plugin package.
    ...
    **Note:** For information about creating a check definition with input parameters, see [Create a check definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/acc-api-check-def.md).
...
8.  On the form, fill in the remaining fields.
    ...
    For a description of the field values, see [Agent Client Collector check definition page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/check-definition-form.md).
