...
5.  In the **Command** field, enter the name of the `.rb` script included in the ACC plugin package.
    ...
    **Note:** For information about creating a check definition with input parameters, see [Create a check definition](https://www.servicenow.com/docs/access?context=acc-api-check-def&version=australia&pubname=australia-it-operations-management&ft:locale=en-US).
