...
Enjoy a comprehensive visibility into application performance, user engagement, and trends, promoting a positive digital experience.
...
Monitor your active and impacted users to gain an accurate measure of how many users are engaged with the application. Active users are an important metric to identify trends in user behaviors.

-   On the All users page, two filters are available to refine your search: **Users** and **Status**. The **Status** provides an overview of user statuses, indicating whether they're active, impacted, or you can opt to view all users.

    **Note:** The All users list displays all system users with Agent Client Collector \(ACC\) installed on their devices. If a user hasn't used the application in the last three days, the value of the **App last accessed** field is denoted as **-**. By default, sorting is applied on the **App last accessed** field and data is sorted for the latest 1000 records.
