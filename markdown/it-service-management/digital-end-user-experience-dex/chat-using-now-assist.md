...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/digital-end-user-experience-dex/chat-using-now-assist.html
release: zurich
...
1.  On the Desktop Assistant home page, select the Virtual Agent or chat icon \(\[Omitted image "icon-virtual-agent.png"\] Alt text:\) that appears on the Desktop Assistant header.
...
3.  Use the prompts from ServiceNow Otto to create a ticket, check the status of an existing ticket, or resolve other issues you might have.
    ...
    **Note:**
    ...
    -   To customize the topics that must be displayed and available on the **Show me everything** window, see [Getting started with Assistant Designer Asset library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/conversation-designer-virtual-agent.md)
