...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-dex/monitor-user-apps-network.html
release: yokohama
...
3.  In the **Network experience** section, select one of the following options:
    ...
    For more details, see [Network experience pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/digital-end-user-experience-dex/network-experience-pages.md).
