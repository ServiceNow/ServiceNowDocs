...
5.  On the form, edit the required fields.
    ...
    For more information on each field, see [Edit web or installed application form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/admin-edit-app-form.md).
