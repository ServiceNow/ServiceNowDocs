...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/digital-end-user-experience-dex/edit-new-application-details.html
release: xanadu
...
5.  On the form, edit the required fields.
    ...
    For more information on each field, see [Edit web or installed application form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/digital-end-user-experience-dex/admin-edit-app-form.md).
