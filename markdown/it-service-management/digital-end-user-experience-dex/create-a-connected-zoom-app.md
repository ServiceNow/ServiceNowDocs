...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-dex/create-a-connected-zoom-app.html
release: yokohama
...
5.  Double-click the default name of the app and update the name.
    ...
    \[Omitted image "image.zoom-spk-app-name"\] Alt text: Update general app name.
...
8.  Under the **App Credentials** section, copy the Client ID and Client secret and store them at a secure place.
    ...
    \[Omitted image "image.zoom-spk-client-id-secret"\] Alt text: Client ID and client secret.
...
9.  Under the **OAuth Information** section, complete the following steps.
    ...
    3.  To add another URL to the allow list, select **Add New List**.
        ...
        \[Omitted image "image.zoom-app-conf"\] Alt text: OAuth credentials configuration for Zoom spokes.
...
14. In the **Search** scope field, enter the granular scope.
    ...
    \[Omitted image "image.zoom-spk-find-scope"\] Alt text: Scope search and find.

15. Select the scope and then select **Done**.

    The granular scope is added.

    \[Omitted image "image.Zoom\_scope\_added"\] Alt text: Granular scope added
