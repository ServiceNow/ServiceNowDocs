...
4.  Log in to Desktop Assistant.
    ...
    -   When Single Sign-On \(SSO\) is not enabled:
        ...
        **Note:** To enable SSO login, set up the SSO provider and configure SSO in the instance. For more information, see [Configure Open Authorization details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/configure-oauth-details.md).
