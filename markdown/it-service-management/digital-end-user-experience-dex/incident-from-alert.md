...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/digital-end-user-experience-dex/incident-from-alert.html
release: xanadu
...
breadcrumb: [DEX Alerts, Configuring Digital End-User Experience, Digital End-User Experience, IT Service Management]
---

# Incidents from alerts

As an agent or IT operator, you can create an incident from the Digital End-User Experience \(DEX\) alerts which is addressed by the L1 agent.
