...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-dex/update-da-instance-url.html
release: yokohama
...
Desktop Assistant users can update the instance URL when logging in to the application. For more information, see [Open Desktop Assistant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/digital-end-user-experience-dex/open-desktop-exp.md).
