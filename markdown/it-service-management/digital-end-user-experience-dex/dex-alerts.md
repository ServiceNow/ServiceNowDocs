...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/digital-end-user-experience-dex/dex-alerts.html
release: xanadu
...
**Note:** For details on the active alerts listed see, [Monitor incoming alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/service-operations-workspace-for-itom-apps/t_EMUseAlertConsole.md).
