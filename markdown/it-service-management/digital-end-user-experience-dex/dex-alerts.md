...
**Note:** For details on the active alerts listed see, [Monitor incoming alerts](https://www.servicenow.com/docs/access?context=t_EMUseAlertConsole&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
