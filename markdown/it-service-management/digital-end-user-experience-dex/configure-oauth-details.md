...
3.  On the Application Registries form, edit the required fields.
    ...
    For a description of the field values, see [Application Registries form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/digital-end-user-experience-dex/application-registries-form.md).
