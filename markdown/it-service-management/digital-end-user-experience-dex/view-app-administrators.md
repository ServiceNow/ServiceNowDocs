...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/digital-end-user-experience-dex/view-app-administrators.html
release: yokohama
...
4.  Select **Role: sn\_dex.admin** to see the list of DEX admins.
