...
description: It allows you to configure and define how an end user should be engaged to self-solve the issue. Virtual agent is the only notification channel used to engage with the user. As a fallback, an incident can be created or route to a live agent.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/proactive-engagement/engagement-settings.html
release: xanadu
...
**Parent Topic:**[Proactive Engagement reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/proactive-engagement/proactive-engagement-reference.md)
