...
1.  Navigate to **All** &gt; **SOW** &gt; **DEX Administration** &gt; **Metric rules** &gt; **Create metric rule**.
    ...
    ![New metric rule](../digital-end-user-experience/image/metric-rules-select-app.png)
...
4.  Select the metric and criteria to create an alert.
    ...
    ![Add criteria window to create an alert.](../digital-end-user-experience/image/metric-rules-add-criteria.png)
...
8.  Select the type of resolution and update the resolution details.
    ...
    ![Proactive resolution content window to add the Resolution details.](images/resolutions.png)
...
11. Update the **Engagement settings**.
    ...
    ![Define the engagement settings](images/engagement-settings.png)
    ...
    **Note:**
    ...
    -   Choose Desktop Assistant as the notification channel to notify the users with any self-help instructions or URL. For more information, see [Desktop Assistant notifications](../digital-end-user-experience/concept/da-push-notifications.md).
    -   Choose Email notification channel to notify the users with any self-help instructions or URL. For more information, see [Configuring Email as a notification channel for Proactive Engagement](concept/email-notif.md).
    .
