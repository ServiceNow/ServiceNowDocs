...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/proactive-engagement/exploring-proactive-engagement.html
release: xanadu
...
ServiceNow Proactive Engagement integrates with ServiceNow Digital End-User Experience to define issue detection rules, resolution content, and engagement settings that help employees to self-solve digital experience issues by leveraging proactive identification of issues.

For information on the ServiceNow Digital End-User Experience, see [Digital End-User Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/digital-end-user-experience-dex/dex-landing.md).
