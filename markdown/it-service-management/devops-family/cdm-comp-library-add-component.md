...
You can also add a component to the library as a shared component from a request. For more information, see [Accept or reject a component request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/cdm-comp-library-request-approval.md).
...
7.  Add a file node to the component.
    ...
    For more information on adding files, see [Manage files using file nodes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/cdm-manage-file-config-data-file-node.md).
