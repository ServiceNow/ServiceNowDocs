...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/devops-family/cdm-comp-library-add-component.html
release: xanadu
...
7.  Add a file node to the component.
    ...
    For more information on adding files, see [Manage files in the config data model using file nodes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-family/cdm-manage-file-config-data-file-node.md).
