...
**Note:** Pipeline integration requires plugin installation. See [Configure your pipeline in DevOps Config](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-family/devops-config-set-up-pipeline.md) for installation requirements.
