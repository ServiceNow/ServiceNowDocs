...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-family/devops-config-integrations.html
release: yokohama
...
**Note:** Pipeline integration requires plugin installation. See [Configure your pipeline in DevOps Config](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-family/devops-config-set-up-pipeline.md) for installation requirements.
