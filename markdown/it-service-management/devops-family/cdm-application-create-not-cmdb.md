...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/devops-family/cdm-application-create-not-cmdb.html
release: zurich
 ...
 **Note:** To continue, you must connect each deployable to a service.
    ...
    \[Omitted image "cdm-edit-deployables-tab.png"\] Alt text: Choose how to create the new CDM application


## What to do next

The application is not yet structured to accept config data, so the next step is to add the data structure. See [Add nodes with config data to CDM application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/cdm-data-structure-add-for-upload.md).

**Related topics**  


[CDM data model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/cdm-data-model.md)
