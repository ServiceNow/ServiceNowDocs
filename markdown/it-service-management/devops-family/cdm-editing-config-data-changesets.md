...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/devops-family/cdm-editing-config-data-changesets.html
release: zurich
...
-   **E: Actions**
    ...
    -   **Commit Changeset**:  The system generates a snapshot of each deployable that is affected by the changes.
        ...
        **Note:** Because changes in two changesets that are open at the same time can conflict, the system blocks such commits. See [Conflicts between changeset commits](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/cdm-changeset-conflicts.md).
...
-   Blocked: Other commits conflict with this commit. The changeset cannot be committed. See [Conflicts between changeset commits](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/cdm-changeset-conflicts.md).
