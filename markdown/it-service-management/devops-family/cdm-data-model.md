...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-family/cdm-data-model.html
release: yokohama
...
\[Omitted image "cdm-data-structure.png"\] Alt text: Folder structure for a new CDM application
...
\[Omitted image "cdm-app-dynamics.png"\] Alt text: How components and collections supply content that you can build into deployables for a variety of environments
...
-   **[Contextual variables for config data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-family/cdm-context-var.md)**  
...
[Preparing an application for config data upload](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-family/cdm-prep-app-for-upload.md)
