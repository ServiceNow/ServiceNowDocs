...
For more information on defining a condition, see [Map PaCE policies using Dynamic Mapping](https://www.servicenow.com/docs/access?context=pace-validate-dynamic&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
...
[Map PaCE policies using Static Mapping](https://www.servicenow.com/docs/access?context=pace-validate-static&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)

[Map PaCE policies using Dynamic Mapping](https://www.servicenow.com/docs/access?context=pace-validate-dynamic&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)
