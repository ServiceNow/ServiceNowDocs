...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/devops-family/cdm-cda-snapshots-compare.html
release: zurich
...
To see the changes between two snapshots from the same deployables, see [Compare two snapshots of a deployable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/cdm-cda-snapshots-compare-changes.md).
