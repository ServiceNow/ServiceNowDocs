...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-family/devops-config-install-policy-pack.html
release: yokohama
...
The DevOps Config Policy content pack contains a set of [default DevOps Config policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-family/devops-config-default-policies.md) to validate your configuration data.
