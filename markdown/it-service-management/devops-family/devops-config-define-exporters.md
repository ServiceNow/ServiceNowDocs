...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-family/devops-config-define-exporters.html
release: yokohama
...
2.  Select a default exporter or select **New** to create a custom exporter.
    ...
    See [Create a custom exporter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-family/cdm-exporter-create-custom.md) for details.
