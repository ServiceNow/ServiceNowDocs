...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/devops-family/devops-config-define-exporters.html
release: zurich
...
2.  Select a default exporter or select **New** to create a custom exporter.
    ...
    See [Create a custom exporter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/cdm-exporter-create-custom.md) for details.
...
[Default DevOps Config exporters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/devops-family/devops-config-default-exporters.md)
