...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-family/cdm-cda-snapshots-compare-changes.html
release: yokohama
...
To compare snapshots from different deployables or applications, see [Compare snapshots from the same or different applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-family/cdm-cda-snapshots-compare.md).
