...
1.  Prepare an exporter for execution as described in [Test an exporter and export a snapshot](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/devops-family/cdm-exporter-update-n-test.md).
