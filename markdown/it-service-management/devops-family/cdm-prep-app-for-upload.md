...
4.  Now that the structure is in place, you use the REST APIs or the CDM code editing panel to upload your existing configuration data into the changeset. The process is described in [Uploading your config data](cdm-upload-process.md). For more information, see [CdmApplicationsAPI](https://www.servicenow.com/docs/access?context=applications-api&version=zurich&pubname=zurich-api-reference&ft:locale=en-US), [CdmChangesetsAPI](https://www.servicenow.com/docs/access?context=changesets-api&version=zurich&pubname=zurich-api-reference&ft:locale=en-US), and [CdmSnapshoAPI](https://www.servicenow.com/docs/access?context=snapshot-api&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
