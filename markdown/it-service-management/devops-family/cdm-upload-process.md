...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-family/cdm-upload-process.html
release: yokohama
...
5.  Back to CDM: Review and update the config data as described in [Preparing an application for config data upload](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-family/cdm-prep-app-for-upload.md).
