...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/devops-family/cdm-upload-process.html
release: australia
...
5.  Back to CDM: Review and update the config data as described in [Preparing an application for config data upload](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/devops-family/cdm-prep-app-for-upload.md).
