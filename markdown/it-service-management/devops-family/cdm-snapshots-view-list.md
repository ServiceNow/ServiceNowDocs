...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/devops-family/cdm-snapshots-view-list.html
release: xanadu
...
-   Execution error: A policy failed to run to completiondue to an unexpected error, mostly when the [CdmPolicyUtil script include](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/devops-family/cdm-about-cdmpolicyutil.md) is not used to provide warning and failure messages..
