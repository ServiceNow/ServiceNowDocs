...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/devops-family/cdm-snapshot-validate-manually.html
release: yokohama
...
If the snapshot failed validation, you can view the issues to fix them. See [View the results of snapshot validation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/devops-family/cdm-validation-results-view.md).
