...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/collaboration-services/add-field-slack-icon.html
release: yokohama
...
2.  Import the update set file.
    ...
    For more information, refer [Import an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/t_SaveAnUpdateSetAsAnXMLFile.md).
...
6.  Click **Run Fix Script**.
    ...
    The slack icon \(\[Omitted image "slack-icon.png"\] Alt text: Slack icon\) appears next to the following fields mentioned in the script.
...
[Open slack from an incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/collaboration-services/open-slack-from-inci.md)
