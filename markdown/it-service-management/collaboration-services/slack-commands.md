...
You need to [configure slash commands](https://www.servicenow.com/docs/access?context=set-up-slack&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US) to execute the commands. Only a user with the sn\_incident\_write, itil or admin role can execute the commands.
