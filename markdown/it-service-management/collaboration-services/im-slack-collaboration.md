...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/collaboration-services/im-slack-collaboration.html
release: xanadu
...
-   [Slack Spoke for ServiceNow IntegrationHub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/slack-spoke.md) plugin \(com.sn.slack.ahv2\) version 1.3.x and the necessary Integration Hub license to use Slack as a collaboration channel.

    **Note:** The Slack spoke requires creating a custom app on your Slack account to generate OAuth 2.0 tokens for the Slack spoke. For more information, refer [Set up Slack spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/set-up-slack.md).
