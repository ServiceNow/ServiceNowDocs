...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/collaboration-services/create-slack-inci.html
release: yokohama
...
-   Ensure you have set up interactivity and shortcuts for slack. For more information, refer [configure slack app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/integration-hub/set-up-slack.md).
...
3.  Click the **Create Slack Channel** related link.
    ...
    \[Omitted image "create-slack-channel.png"\] Alt text: Create a slack channel to collaborate with team members.
