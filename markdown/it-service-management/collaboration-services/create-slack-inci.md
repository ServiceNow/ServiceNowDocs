...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/collaboration-services/create-slack-inci.html
release: xanadu
...
-   Ensure you have set up interactivity and shortcuts for slack. For more information, refer [configure slack app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/set-up-slack.md).
