...
-   Ensure you have set up interactivity and shortcuts for slack. For more information, refer [configure slack app](https://www.servicenow.com/docs/access?context=set-up-slack&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
...
3.  Click the **Create Slack Channel** related link.
    ...
    ![Create a slack channel to collaborate with team members.](../image/create-slack-channel.png "Create slack channel")
