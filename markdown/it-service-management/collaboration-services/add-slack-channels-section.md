...
3.  Click the Additional actions icon \[Omitted image "additional-actions.png"\] Alt text: Additional actions icon and select **Configure** &gt; **Form Layout**.
    ...
    For more information, refer [Configuring form layouts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/configure-form-layout.md).
