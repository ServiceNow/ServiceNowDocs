...
3.  Click the Additional actions icon and select **Configure** &gt; **Form Layout**.
    ...
    For more information, refer [Configuring form layouts](https://www.servicenow.com/docs/access?context=configure-form-layout&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
**Parent Topic:**[View or join slack channel from an incident](view-slack-channel.md)
