...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/configure-standard-change-model-scm.html
release: australia
topic_type: task
...
3.  To add a template, select **New template**.
    ...
    For steps to configure a template, see [Create and propose a change template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/change-management/create-change-template.md).
