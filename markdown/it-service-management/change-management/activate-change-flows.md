---
title: Activate Change Management - Change Flows
description: You can activate the Change Management - Change Model Foundation Data \(com.snc.change\_management.change\_model.foundation\) plugin if you have the admin role. This plugin includes demo data and activates related plugins if they are not already active.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/change-management/activate-change-flows.html
release: yokohama
