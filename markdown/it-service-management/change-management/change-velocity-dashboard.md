...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/change-management/change-velocity-dashboard.html
release: zurich
...
Starting in Xanadu release, the Core UI Change Velocity dashboard is deprecated. You can use Platform Analytics [Change Management dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/change.md) to view, and track the open changes.
