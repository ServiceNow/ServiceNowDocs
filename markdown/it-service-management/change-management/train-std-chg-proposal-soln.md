...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/change-management/train-std-chg-proposal-soln.html
release: yokohama
...
2.  Customize the default solution definition to train the solution.
    ...
    For more information on creating and training the solutions, see [Create and train a clustering solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/predictive-intelligence/create-clustering-solution.md).

3.  Click **Update**.


**Parent Topic:**[Predictive Intelligence for Change Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/change-mgmt-intelligent-solutions.md)
