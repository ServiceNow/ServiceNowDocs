...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/change-management/configure-copy-change-request.html
release: yokohama
...
<table id="choicetable_q1v_qzc_nw"><tbody><tr><td id="d75316e92">
...
|Impacted Services/CIs|**com.snc.change\_request.copy.rl.task\_cmdb\_ci\_service.attributes**|
    ...
    2.  Create a custom script include that extends ChangeUtils.
