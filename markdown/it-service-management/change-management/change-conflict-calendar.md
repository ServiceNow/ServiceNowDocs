...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/change-management/change-conflict-calendar.html
release: yokohama
...
\[Omitted image "change-conflict-calendar-1.png"\] Alt text: Sections of the change conflict calendar
...
|5|Scheduling Assistant|Enables you to choose from the list of available time slots to resolve conflicts. For more information on resolving conflicts, see [Manage your change schedules and resolve conflicts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/use-conflict-calendar.md)|
...
-   **[Manage your change schedules and resolve conflicts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/use-conflict-calendar.md)**  
...
**Parent Topic:**[Conflict detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/c_ConflictDetection.md)
