...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/change-management/change-conflict-calendar.html
release: zurich
...
\[Omitted image "change-req-conflict-calendar.png"\] Alt text: Conflict Calendar page with highlighted callouts. For the text descriptions, refer to the table that follows.
...
Enables you to choose a date. When you select a date, you can view the schedule details of that day.
...
Enables you to view the schedule of the current day or month when you click **Today**.
...
Enables you to navigate to the previous day, the next day, or month, depending on the view type when you click the arrow buttons.
...
Enables you to change the calendar view to a day view or month view.
...
</table>-   **[Manage your change schedules and resolve conflicts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/change-management/use-conflict-calendar.md)**  
