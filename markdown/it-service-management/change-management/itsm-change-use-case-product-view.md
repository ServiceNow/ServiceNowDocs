...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/change-management/itsm-change-use-case-product-view.html
release: yokohama
...
For details on implementing the CSDM framework, see [Implementing the CSDM framework in stages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/common-service-data-model-csdm/csdm-implementation-stages.md).
...
</table>\[Omitted image "itsm-change-form.png"\] Alt text: Change Request form with numbered fields.

## For more information

For additional details on Change Management, see [Change Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/c_ITILChangeManagement.md).
...
-   **[Change Management and CSDM tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/itsm-change-use-case.md)**  
...
-   **[Change Management use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/itsm-change-use-case-example.md)**  
...
-   **[Change Management considerations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/itsm-change-use-case-trouble.md)**  
