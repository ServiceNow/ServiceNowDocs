...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/change-management/change-premium-dashboard.html
release: zurich
...
Starting in Xanadu release, the Core UI Change Premium dashboard is deprecated. You can use [Change Management dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/change.md) to view the information about the Change process in one place.
