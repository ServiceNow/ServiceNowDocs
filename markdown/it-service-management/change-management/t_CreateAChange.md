...
<table id="choicetable_agp_ckc_3t"><tbody><tr><td id="d189946e96">
...
2.  Select **Normal**, **Emergency**, or **Standard** changes.
 If you are an upgrade customer and willing to use change models, you must enable the change model properties. For information on change models and its properties, see [Change models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/change-models.md).
...
Change model being used for the change request.For information about Change models, see [Change models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/change-models.md).
