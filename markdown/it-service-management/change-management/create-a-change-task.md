...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/change-management/create-a-change-task.html
release: australia
...
4.  To associate an existing change task with the change request, open the change task record and update the **Change** field to the target change request and save the record.
    ...
    **Note:** The **New** button creates a change task and doesn't attach an existing change task. To carry tasks to the new change request, [Copy a change request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/change-management/copy-a-change-request.md)
