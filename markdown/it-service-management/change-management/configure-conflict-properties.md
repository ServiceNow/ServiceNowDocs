...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/change-management/configure-conflict-properties.html
release: zurich
...
3.  Configure the remaining customization properties.
    ...
    For more information on conflict detection properties, see [Conflict detection properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-service-management/change-management/configure-conflict-properties.md).
