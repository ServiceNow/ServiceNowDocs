...
[View the change history of application services in Agent Workspace](https://www.servicenow.com/docs/access?context=workspace-view-history-app-service&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US)
