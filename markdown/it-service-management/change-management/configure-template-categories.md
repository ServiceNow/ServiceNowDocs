...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-service-management/change-management/configure-template-categories.html
release: australia
...
The change template for which you want to create categories should already exist. For more information, see [Create and propose a change template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-service-management/change-management/create-change-template.md).
