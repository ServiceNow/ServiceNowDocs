...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/change-management/itsm-change-use-case.html
release: xanadu
...
\[Omitted image "change-mgmt-elements-1.png"\] Alt text: CSDM elements in Change Management.
...
3.  Business Service \[cmdb\_ci\_service\_business\] table and Technical service \[cmdb\_ci\_service\_technical\] table: Uses the service classification attribute to identify business services, technical services, and application services as types of services.
...
\[Omitted image "change-mgmt-elements-2.png"\] Alt text: CSDM elements used by Change Management.
...
**Parent Topic:**[Applying CSDM guidelines to Change Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/change-management/itsm-change-use-case-product-view.md)
