...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/change-management/approval-e-signature-changes.html
release: zurich
...
For more information, see [Approval with e-signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/approval-with-e-signature.md).

## Requirements

Before you can use e-signatures with change approvals, verify the following requirements:

-   The e-signature platform plugin is activated on your instance. For activation instructions, see [Activate Approval with e-Signature plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/activate-approval-esignature.md).
