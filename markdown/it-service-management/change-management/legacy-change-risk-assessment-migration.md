...
1.  Create an update set and set it as the current set.
    ...
    For more information, see [Create and select an update set as the current set](https://www.servicenow.com/docs/access?context=create-select-update-set&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
...
Capture the results in the update set created and later mark the update set as closed complete. For more information, see [Mark an update set complete](https://www.servicenow.com/docs/access?context=t_CompleteUpdateSets&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
