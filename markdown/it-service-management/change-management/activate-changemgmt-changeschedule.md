---
title: Activate Change Management - Change Schedule
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/change-management/activate-changemgmt-changeschedule.html
release: yokohama
...
You can activate the Change Management - Change Schedule plugin \(com.snc.change\_management.soc\) if you have the admin role. This plugin includes demo data and activates related plugins if they are not already active.
...
The Change Management - Change Schedule plugin \(com.snc.change\_management.soc\) activates these related plugins if they are not already active.

<table id="table_z5b_1qc_3db"><thead><tr><th>
...
This plugin contains six change schedules to help users. Enabling this plugin automatically enables Change Management – Change Schedules Version 1.0.0.
...
-   **[Installed with Change Management - Change Schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/installed-cm-changeschedule.md)**  
Several types of components are installed with the Change Management - Change Schedule.

**Parent Topic:**[Change Management plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/change-management/change-plugins.md)
