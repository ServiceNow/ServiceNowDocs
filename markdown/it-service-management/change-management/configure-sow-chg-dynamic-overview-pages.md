...
**Note:** To create a custom section, add new change overview cards. For information on modify the layout and formatting of the sections, see [UI Builder tutorial.](https://www.servicenow.com/docs/access?context=uib-tutorial&version=australia&pubname=australia-application-development&ft:locale=en-US)
