...
2.  From the list of servers, select the server that you want to add the maintenance schedule to.
    ...
    **Note:** If you don't see the **Maintenance schedule** field on the record, click the personalize list icon \( ![personalize list](../image/gearicon.png)\) and modify the Personalize List settings to add this field.
...
**Parent Topic:**[Create blackout and maintenance schedules in Change Management](t_CreateBlkoutMaintSched.md)
