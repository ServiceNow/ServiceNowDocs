...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/change-management/create-a-change-request-template.html
release: xanadu
...
3.  Complete the form as described in [Create a template using the Template form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/t_CreateATemplateUsingTheTmplForm.md).
