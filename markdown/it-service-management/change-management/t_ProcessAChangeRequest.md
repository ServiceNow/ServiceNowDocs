...
As part of processing a change request, ensure that you have [detected any change conflicts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/change-management/t_RunManualConflictDetection.md) and [performed risk assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/change-management/t_AssessRisk.md)
...
<table id="choicetable_yhp_ddv_tt"><tbody><tr><td id="d159215e126">
...
From the context menu, Select **Cancel Change**. Provide a reason for canceling the change and select **Save**.The change request is canceled and the reason for canceling the change is added to the **Work Notes** field.
    ...
    -   Backout plan
    You can add approval history to the change request activity log. Select the activity filter icon and select **Approval history** from the list. When there is a change in the approval process, such as an approval, rejection, or comments, the activity log is updated.


-   **[Associated CIs on a change request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/change-management/c_AffectedCIsAndImpactedServices.md)**  
...
-   **[Use Mass Update CI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/change-management/use-bulk-mass-ci-changes.md)**  
...
-   **[Refresh impacted services and CIs for Change](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/change-management/refresh-impacted-services-cis.md)**  
