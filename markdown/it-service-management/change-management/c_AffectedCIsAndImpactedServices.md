...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/change-management/c\_AffectedCIsAndImpactedServices.html
release: yokohama
...
3.  Select the appropriate CIs from the list of CIs displayed in the pop-up window.
    ...
    \[Omitted image "Create-Change-select-CIs-1.png"\] Alt text: Affected items pop-up window displays the same CI class
