...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/change-management/itsm-change-use-case-example.html
release: yokohama
...
\[Omitted image "change-mgmt-elements-use-case.png"\] Alt text: Data elements available for use by Change Management.
