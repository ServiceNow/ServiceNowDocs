...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-service-management/change-management/add-new-agenda-items.html
release: zurich
...
Lookup list to select the change request or standard change proposal.**Note:** The standard change proposal is available for selection only from Zurich .
