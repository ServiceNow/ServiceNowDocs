...
3.  In the **Policy inputs** tab, create a policy input or update an existing record.
    ...
    For more information, see [Create a decision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/change-management/create-policy-input.md).
