...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/benchmarks/c\_BenchKPIConfig.html
release: yokohama
product: Benchmarks
...
**Note:** In some environments, KPIs involving resolved incidents may require further [configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/benchmarks/t_ConfigResIncBenchKPIs.md) to retrieve resolved incident data.
...
If you're using a different survey to collect user feedback, you can [customize the KPI definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/benchmarks/t_CustomBenchKPIConditions.md).
...
-   Self-solved using DEX Self-service.
...
-   Self-solved using Knowledge articles
-   Call deflection using DEX Self-service
-   Call deflection using Proactive Engagement for DEX.
...
-   **[Use Benchmarks data for value management analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/benchmarks/analyze-business-value-historical-data-benchmarks.md)**  
