...
\[The number of incidents and requests created using Virtual Agent \] / \[Total numbers of incidents and requests created\]
 ...
 The number of times, in percentage, the incident, or request was submitted using Virtual Agent. This is determined by the [deflection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/deflections-virtual-agent.md) pattern added in the Virtual Agent topic.
...
\[The number of incidents auto-resolved by Virtual Agent \] / \[Total number of incidents resolved\]
 ...
 The number of times, in percentage, incidents were automatically resolved using automated workflows or by [Issue Auto Resolution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/auto-resolution-va.md).
