...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/benchmarks/analyze-business-value-historical-data-benchmarks-cf.html
release: yokohama
product: Benchmarks
...
breadcrumb: [Using Benchmarks, Benchmarks, IT Service Management]
---
...
1.  Set up Benchmarks historical data collection.
    ...
    5.  Click **Execute**.
        ...
        For detailed information on scheduling a data collection job, refer to [Create or schedule a data collection job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/performance-analytics/t_CreatASchedDataCollJob.md).
