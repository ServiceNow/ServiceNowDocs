...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-service-management/benchmarks/exploring-benchmarks.html
release: yokohama
product: Benchmarks
...
-   Available KPIs from other ServiceNow applications such as ITSM, ITOM, Security Operations. For more information, see [Benchmark KPIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-service-management/benchmarks/c_BenchKPIConfig.md).
...
<table id="table_hgn_5wx_szb"><thead><tr><th>
