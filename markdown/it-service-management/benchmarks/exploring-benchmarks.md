...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/benchmarks/exploring-benchmarks.html
release: xanadu
product: Benchmarks
...
-   Available KPIs from other ServiceNow applications such as ITSM, ITOM, Security Operations. For more information, see [Benchmark KPIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/benchmarks/c_BenchKPIConfig.md).
