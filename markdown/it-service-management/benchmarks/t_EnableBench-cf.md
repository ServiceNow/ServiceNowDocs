...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/benchmarks/t\_EnableBench-cf.html
release: xanadu
product: Benchmarks
...
</table>2.  Click **Opt-In Agreement** and read the agreement.

3.  After reading the agreement, click **Done**.

4.  Select the **Yes, I have read and accept the Opt-In Agreement** check box, and then click **Opt-In**.
...
[Enable and configure your KPIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/benchmarks/c_BenchKPIConfig.md).
