...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-service-management/benchmarks/t\_ViewBenchKPIData.html
release: xanadu
product: Benchmarks
...
2.  Select one of the **KPI categories** from the [KPI list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/benchmarks/c_BenchKPIConfig.md).
...
Click a KPI to view [Benchmarks KPI performance trend and recommendations \(deprecated\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-service-management/benchmarks/bench-kpi-trend-recommend.md).
