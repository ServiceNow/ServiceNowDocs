...
-   **[Configure the data visualization group variables](../task/c360-configure-data-card.md)**  
Configure the variables in the data visualization card.
-   **[Configure the contact card variables](../task/c360-configure-contact-card.md)**  
Configure the variables in the contact card.
-   **[Configure the billing card variables](../task/c360-configure-billing-card.md)**  
...
**Parent Topic:**[Setup Telecommunications Customer 360](../task/telecom-cust-360-landing.md)
