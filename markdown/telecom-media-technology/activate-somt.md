...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/telecom-media-technology/activate-somt.html
release: australia
topic_type: task
...
# Activate Sales CRM for Telecommunications

Activate the Sales CRM for Telecommunications plugin for Sales CRM for Telecommunications if you have the admin role. The application includes demo data and activate related ServiceNow® Store applications and plugins if they aren't already installed.
...
2.  Find the Sales CRM for Telecommunications application and child applications using the filter criteria and search bar.
