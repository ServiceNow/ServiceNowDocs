...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/telecom-media-technology/quote-to-order-flows.html
release: australia
topic_type: concept
...
Quote to order \(Q2O\) automates the transition from sales to order fulfillment in the Unified \(USAM\) platform. It covers the full customer lifecycle: lead capture, quote configuration, contract acceptance, and order decomposition.
