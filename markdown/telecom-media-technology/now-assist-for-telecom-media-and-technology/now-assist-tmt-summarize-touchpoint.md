...
# Summarize a touchpoint using ServiceNow Otto for Telecommunications, Media, and Technology \(TMT\)
...
3.  In the Touchpoint summary by ServiceNow Otto component, select **Summarize**.

    The Touchpoint summary by ServiceNow Otto component appears above the Account details card. The component is collapsed by default and expands to display the summary. For longer summaries that don't fit in the window, select **View more** and use the scroll bar to view the rest of the content.
...
<table id="choicetable_md1_nyf_xyb"><thead><tr><th align="left" id="d42483e171">

Option

</th><th align="left" id="d42483e174">

Procedure

</th></tr></thead><tbody><tr><td id="d42483e180">
