...
For more details on configuring the data sources, see [Setup the data context engine](https://www.servicenow.com/docs/access?context=account-lifecycle-setup-metric-data&version=yokohama&pubname=yokohama-acct-lifecycle-events&ft:locale=en-US).
...
2.  Follow the instructions in the [Manually test the execution of an agentic workflow](https://www.servicenow.com/docs/access?context=test-aia-use-case&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US) section to test the agentic workflow.
