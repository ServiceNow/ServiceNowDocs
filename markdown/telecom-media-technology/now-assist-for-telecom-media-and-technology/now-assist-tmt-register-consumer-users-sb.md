...
To modify the Service Exchange onboarding agentic workflow, you must duplicate the workflow and adjust the settings according to your requirements. For more information, see Duplicate an agentic workflow.

You can initiate the onboarding workflow from the Now Assist panel by entering the prompt `start onboarding`. For more information on the Now Assist panel, see Now Assist panel.
