...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/telecom-media-technology/now-assist-for-telecom-media-and-technology/now-assist-tmt-summarize-engagement.html
release: australia
...
3.  In the Engagement summary by ServiceNow Otto component, select **Summarize**.

    The Engagement summary by ServiceNow Otto component appears above the Account details card. The component is collapsed by default and expands to display the summary. For longer summaries that don't fit in the window, select **View more** and use the scroll bar to view the rest of the content.
...
<table id="choicetable_md1_nyf_xyb"><thead><tr><th align="left" id="d50115e165">

Option

</th><th align="left" id="d50115e168">

Procedure

</th></tr></thead><tbody><tr><td id="d50115e174">
