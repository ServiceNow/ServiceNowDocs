...
**Important:** In the Now Assist skills page, make sure to Activate the product release content generator skill to trigger the agentic workflow. See Activate a skill for more details.
...
To modify the Product release email communication agentic workflow, Duplicate an agentic workflow, and adjust the settings according to your requirements.
...
</table>To create an AI agent, see Create an AI agent.
