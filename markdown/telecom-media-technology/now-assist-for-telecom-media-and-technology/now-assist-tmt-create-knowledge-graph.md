...
7.  In the Node details section, you can edit the following fields.
    ...
    To manage the nodes in the Knowledge Graph schema, see [Manage nodes in a Knowledge Graph schema](https://www.servicenow.com/docs/access?context=add-or-delete-nodes-from-a-knowledge-graph-schema&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
...
9.  Add, delete, or edit edges in the Related nodes section and select **Save**.
    ...
    To edit the Knowledge Graph schema, see [Edit a Knowledge Graph schema](https://www.servicenow.com/docs/access?context=editing-a-knowledge-graph-schema&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
