...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-media-technology/now-assist-for-telecom-media-and-technology/now-assist-tmt-create-knowledge-graph.html
release: zurich
...
7.  In the Node details section, you can edit the following fields.
    ...
    To manage the nodes in the Knowledge Graph schema, see [Manage nodes in a Knowledge Graph schema](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/add-or-delete-nodes-from-a-knowledge-graph-schema.md).
...
9.  Add, delete, or edit edges in the Related nodes section and select **Save**.
    ...
    To edit the Knowledge Graph schema, see [Edit a Knowledge Graph schema](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/editing-a-knowledge-graph-schema.md).
