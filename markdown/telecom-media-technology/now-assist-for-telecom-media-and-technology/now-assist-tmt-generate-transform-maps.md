...
2.  Click **New** and create a simple transform.
    ...
    See [Create a transform in Service Exchange](https://www.servicenow.com/docs/access?context=service-bridge-v2-create-transform&version=yokohama&pubname=yokohama-service-bridge&ft:locale=en-US) for instructions. The Now Assist for TMT Transform Assist Mapping can be used only with simple transforms.
