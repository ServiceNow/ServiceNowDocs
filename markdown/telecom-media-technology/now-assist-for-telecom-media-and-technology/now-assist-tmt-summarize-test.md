...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/telecom-media-technology/now-assist-for-telecom-media-and-technology/now-assist-tmt-summarize-test.html
release: australia
...
<table id="choicetable_md1_nyf_xyb"><thead><tr><th align="left" id="d47968e165">

Option

</th><th align="left" id="d47968e168">

Procedure

</th></tr></thead><tbody><tr><td id="d47968e174">
...
Fetch the latest test run summary by selecting the refresh icon \(\[Omitted image "refresh-sync-new.png"\] Alt text: Refresh test summary\).
    ...
    To create test groups, see [Create a test group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/telecom-media-technology/create-test-group.md).
