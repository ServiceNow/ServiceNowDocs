...
From the AI Admin Hub console, you can select the input table, related records, and fields for each input template of the account onboarding and service problem management, and then configure the prompt headers to include them in the general summary.
...
10. Configure where to display the case summarization.
...
11. Review and activate the skill.
