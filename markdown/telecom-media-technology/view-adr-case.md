...
description: View the details of an Customer Dispute Management \(CDM\) case record in the CRM Workspace so that you can review the customer dispute information.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/telecom-media-technology/view-adr-case.html
release: brazil
topic_type: task
...
View the details of an Customer Dispute Management \(CDM\) case record in the CRM Workspace so that you can review the customer dispute information.
