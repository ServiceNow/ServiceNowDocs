...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-media-technology/somt-flow-action-catalog-task.html
release: zurich
...
[Create a task plan template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/create-task-plan-template.md).
...
[Configure task plan template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-media-technology/configure-task-plan-template.md)
...
[Create one or more template items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/create-task-plan-template-item.md).
...
[Create conditions for template items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/create-task-plan-template-item-condition.md).
