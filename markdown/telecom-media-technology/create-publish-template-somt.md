...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/telecom-media-technology/create-publish-template-somt.html
release: zurich
topic_type: task
...
<table id="choicetable_q3p_bpt_txb"><thead><tr><th align="left" id="d21963e380">

Action

</th><th align="left" id="d21963e383">

Description

</th></tr></thead><tbody><tr><td id="d21963e389">
...
Create and publish the service specifications and associate them with the templates. For more information, see [Create and publish service specifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/telecom-media-technology/create-service-specification.md).
