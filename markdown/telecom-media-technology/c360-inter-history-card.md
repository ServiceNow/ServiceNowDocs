...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/telecom-media-technology/c360-inter-history-card.html
release: brazil
topic_type: concept
...
**Note:** You can customize the interaction details that are displayed. See [Configuring the Customer History component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/customer-central-configuration.md) for details.
