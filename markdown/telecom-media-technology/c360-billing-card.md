...
-   Select the ![](../../../reuse/icons/product-icons/open-link-right-outline-24.svg) to drill down to the invoice record page.
-   Select **Create invoice case** to create an invoice case for the billing account. See [Create an invoice case](https://www.servicenow.com/docs/access?context=invoice-ops-create-invoice-case&version=australia&pubname=australia-customer-service-management&ft:locale=en-US) for details.
