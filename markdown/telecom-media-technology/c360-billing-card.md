...
-   Select the \[Omitted image "open-link-right-outline-24.svg"\] Alt text: to drill down to the invoice record page.
-   Select **Create invoice case** to create an invoice case for the billing account. See [Create an invoice case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/invoice-ops-create-invoice-case.md) for details.
...
You can configure variables such as tables, display fields, and query conditions. See [Configure the billing card variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-media-technology/c360-configure-billing-card.md) for details.
