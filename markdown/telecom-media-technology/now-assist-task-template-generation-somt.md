...
\[Omitted image "image.task-plan-template-1"\] Alt text: example image for task plan template.
...
-   Connecting lines of tasks and node must not overlap.
    ...
    \[Omitted image "image.task-plan-template-2"\] Alt text: Connecting lines of tasks and node must not overlap.
