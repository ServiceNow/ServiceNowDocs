---
title: Combined Agent Workspace for HR Case Management release notes for upgrades from Yokohama to Zurich
description: Consolidated page of all release notes for Agent Workspace for HR Case Management from Yokohama to Zurich.
locale: en-US
