---
title: Combined Now Assist for Sales Force Automation \(SFA\) release notes for upgrades from Yokohama to Zurich
description: Consolidated page of all release notes for Now Assist for Sales Force Automation \(SFA\) from Yokohama to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-yokohama-zurich/zurich-yokohama-nowassistforsalesforceautomationsfa-release-notes.html
release: zurich
...
# Combined Now Assist for Sales Force Automation \(SFA\) release notes for upgrades from Yokohama to Zurich

Consolidated page of all release notes for Now Assist for Sales Force Automation \(SFA\) from Yokohama to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Now Assist for Sales Force Automation \(SFA\) release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Now Assist for Sales Force Automation \(SFA\) to Zurich
...
Between your current release family and Zurich, new features were introduced for Now Assist for Sales Force Automation \(SFA\).
...
Between your current release family and Zurich, some changes were made to existing Now Assist for Sales Force Automation \(SFA\) features.
...
Between your current release family and Zurich, some Now Assist for Sales Force Automation \(SFA\) features or functionality were removed.
...
Between your current release family and Zurich, some Now Assist for Sales Force Automation \(SFA\) features or functionality were deprecated.
