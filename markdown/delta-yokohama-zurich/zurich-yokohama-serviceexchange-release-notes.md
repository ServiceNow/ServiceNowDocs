---
title: Combined Service Exchange release notes for upgrades from Yokohama to Zurich
description: Consolidated page of all release notes for Service Exchange from Yokohama to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-yokohama-zurich/zurich-yokohama-serviceexchange-release-notes.html
release: zurich
...
# Combined Service Exchange release notes for upgrades from Yokohama to Zurich
...
-   If you are upgrading from Service Exchange version 1.x.x, follow the steps in [Upgrade Guide - Service Bridge for Providers and Consumers application \(v2.x.x release\) \[KB1700387\]](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB1700387) to migrate your Service Exchange applications.
...
-   **[Remote Catalog Item Client Scripts](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-add-scripts-to-rrp&family=yokohama&ft:locale=en-US)**
...
-   **[Copy From Service Catalog Item to Remote Catalog Item](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-copy-catalog-as-rrp&family=yokohama&ft:locale=en-US)**
...
-   **[Transform Mapping Assist](https://servicenow-staging.fluidtopics.net/access?context=now-assist-tmt-exploring&family=yokohama&ft:locale=en-US)**
...
-   **[Consumer Variable Sets](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-consumer-variables&family=yokohama&ft:locale=en-US)**
...
-   **[Foundation data sync](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-explore-foundation-data-sync&family=zurich&ft:locale=en-US)**
...
-   **[Journal field framework](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-expolre-journal-field-framework&family=zurich&ft:locale=en-US)**
...
-   **[Flow action](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-flow-action&family=zurich&ft:locale=en-US)**
...
-   **[Magic links](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-explore-magic-link&family=zurich&ft:locale=en-US)**
...
-   Consumers can now add variables to remote record producers for use in consumer pre-flows.
 ...
 See [Service Exchange](https://servicenow-staging.fluidtopics.net/access?context=tmt-service-bridge-both-landing-page&family=yokohama&ft:locale=en-US) for more information.
...
-   Enable consumer users to access linked resources in the provider instance using magic links.
 ...
 See [Service Exchange](https://servicenow-staging.fluidtopics.net/access?context=tmt-service-bridge-both-landing-page&family=zurich&ft:locale=en-US) for more information.
