---
title: Combined Service Graph Connector for Microsoft Defender for IoT \(Azure\) release notes for upgrades from Yokohama to Zurich
description: Consolidated page of all release notes for Service Graph Connector for Microsoft Defender for IoT \(Azure\) from Yokohama to Zurich.
locale: en-US
...
# Combined Service Graph Connector for Microsoft Defender for IoT \(Azure\) release notes for upgrades from Yokohama to Zurich
...
To help you prepare for your upgrade, we have combined the cross-family Service Graph Connector for Microsoft Defender for IoT \(Azure\) release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Zurich.
