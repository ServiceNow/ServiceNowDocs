---
title: Combined Customer Engagement Sequences release notes for upgrades from Yokohama to Zurich
description: Consolidated page of all release notes for Customer Engagement Sequences from Yokohama to Zurich.
locale: en-US
...
# Combined Customer Engagement Sequences release notes for upgrades from Yokohama to Zurich

Consolidated page of all release notes for Customer Engagement Sequences from Yokohama to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Customer Engagement Sequences release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Customer Engagement Sequences to Zurich
...
Between your current release family and Zurich, new features were introduced for Customer Engagement Sequences.
...
Between your current release family and Zurich, some changes were made to existing Customer Engagement Sequences features.
...
Between your current release family and Zurich, some Customer Engagement Sequences features or functionality were removed.
...
Between your current release family and Zurich, some Customer Engagement Sequences features or functionality were deprecated.
