---
title: Combined Authentication release notes for upgrades from Yokohama to Zurich
description: Consolidated page of all release notes for Authentication from Yokohama to Zurich.
locale: en-US
