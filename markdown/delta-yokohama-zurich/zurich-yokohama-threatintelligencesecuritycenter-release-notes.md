---
title: Combined Threat Intelligence Security Center release notes for upgrades from Yokohama to Zurich
description: Consolidated page of all release notes for Threat Intelligence Security Center from Yokohama to Zurich.
locale: en-US
