---
title: Combined Service Portfolio Management release notes for upgrades from Yokohama to Zurich
description: Consolidated page of all release notes for Service Portfolio Management from Yokohama to Zurich.
locale: en-US
...
# Combined Service Portfolio Management release notes for upgrades from Yokohama to Zurich

Consolidated page of all release notes for Service Portfolio Management from Yokohama to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Service Portfolio Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Zurich.
