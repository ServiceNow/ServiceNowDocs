...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/config-trm-data-to-publish.html
release: zurich
topic_type: task
...
6.  On the form, fill in the fields.
    ...
    For field information, see [Create publishing configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/create-pub-config-form.md).
