...
6.  On the form, fill in the fields.
    ...
    For field information, see [Create publishing configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-portfolio-management/create-pub-config-form.md).
