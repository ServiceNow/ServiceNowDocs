...
You can leverage the same features by using the Enterprise Architecture Workspace. To learn more, see [Manage TRM categories](../concept/eaw-concept/eaw-configure-trm-categories.md).
