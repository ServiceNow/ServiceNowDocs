---
title: Monitor performance, costs, and workloads in Application 360
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/applications-360-dashboard.html
release: xanadu
topic_type: task
...
# Monitor performance, costs, and workloads in Application 360
...
Starting with the Xanadu release, the legacy Application 360 dashboard is moved to the Enterprise Architecture Workspace. To learn more, see [Working with the Application 360 dashboard in Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/eaw-working-with-application-360-dashboard-in-enterprise-architecture-workspace.md).
...
1.  Navigate to **All** &gt; **Enterprise Architecture** &gt; **Application Portfolio Analysis** &gt; **Application 360**.

    \[Omitted image "App360BusAppViewScore.png"\] Alt text: The application indicator scores
