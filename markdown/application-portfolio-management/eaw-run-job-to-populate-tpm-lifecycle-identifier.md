...
3.  Select  ** Execute Now**.
    ...
    **Note:** You must verify that your application scope is set to Technology Lifecycle Management. For information on how to change the application scope, see [Application picker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/c_ApplicationPicker.md)
