...
3.  Select  ** Execute Now**.
    ...
    **Note:** You must verify that your application scope is set to Technology Portfolio Management. For information on how to change the application scope, see [Select an application from the application picker](https://www.servicenow.com/docs/access?context=t_SelectAnAppFromTheAppPicker&version=australia&pubname=australia-platform-administration&ft:locale=en-US)
