...
Starting with the Xanadu release, the legacy scoring profiles module is moved to the Enterprise Architecture Workspace. To learn more, see [Manage scoring profiles](../concept/eaw-concept/eaw-configure-scoring-profiles.md).
