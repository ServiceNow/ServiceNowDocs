...
Starting with the Xanadu release, the legacy digital interfaces module is moved to the Enterprise Architecture Workspace. To learn more, see [Exploring digital interfaces in Enterprise Architecture Workspace](eaw-concept/eaw-digital-interface.md).
