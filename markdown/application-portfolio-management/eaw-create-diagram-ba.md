...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-portfolio-management/eaw-create-diagram-ba.html
release: australia
topic_type: task
...
6.  On the Create Diagram form, fill in the fields.
    ...
    For field information, see [Create diagram form for a business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-portfolio-management/eaw-create-diagram-ba-form.md).
