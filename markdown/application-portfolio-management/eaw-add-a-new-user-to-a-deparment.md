...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/eaw-add-a-new-user-to-a-deparment.html
release: xanadu
topic_type: task
...
7.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Create new user form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/eaw-create-new-user-form.md).
