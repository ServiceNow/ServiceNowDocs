...
4.  Click the production icon \(![Production instance icon](../image/ProductionInstanceIcon.png)\) to view the production instances that are liable to risks in the current quarter or month.

5.  The lifecycle data sources of software models can be displayed in either of the following two ways:

    -   To display the lifecycle data sources of a particular software model, click the expand icon \(![Software Model expand icon](../image/ExpandIcon.png)\) of the software model.
    -   To display the lifecycle data sources of all software models related to a business application, click show all lifecycle data sources icon \(![Show all lifecycle data sources icon](../image/LifecycleDataSourcesIcon.png)\). Use the icon to toggle between show and hide the data sources.
...
6.  Click the legend icon \(![legend icon](../image/LegendIcon.png)\) to understand the indications of the markings on the timeline, and the color-coded lines.
...
10. Click the risk bubble of a software model to view the scores at the risk parameter level.
    ...
    ![TPM risk profile of software model](../image/TPMRiskProfileBubble_v2.png "TPM risk profile of software model")
...
11. Click the risk bubble of a hardware model to view the breakdown of its risks.
    ...
    ![TPM risk profile of hardware model](../image/TPMRiskProfileBubbleHw.png "TPM risk profile of hardware model")
...
13. Click the life-cycle phase icon \(![Life-cycle phase icon](../image/LifecyclePhaseIcon.png)\) on the hardware or software timeline to view the life-cycle information of the hardware or software model in a pop-up.
...
-   **[Multiple views in TPM](../concept/tpm-timeline-views.md)**  
