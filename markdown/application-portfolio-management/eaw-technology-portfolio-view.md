...
For more information on Technology Reference Model, see [Managing the Technology Reference Model in Enterprise Architecture Workspace](eaw-managing-the-technology-portfolio.md).
