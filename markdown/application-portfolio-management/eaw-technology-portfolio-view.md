...
description: Use the Technology Portfolio list view in the Enterprise Architecture Workspace to manage TLM lifecycles and risk, and your TRM catalog.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/eaw-technology-portfolio-view.html
release: zurich
topic_type: concept
...
For more information on Technology Lifecycle Management, see [Manage the Technology Lifecycle Management \(TLM\) in Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-tpm.md).
...
For more information on Technology Reference Model, see [Manage the Technology Reference Model in Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-managing-the-technology-portfolio.md).
