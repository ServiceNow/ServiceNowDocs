...
1.  Navigate to **All** &gt; **Enterprise Architecture** &gt; **Capability Ratings** &gt; **Capability Map**.
    ...
    ![Capability based planning view](../image/CapabilityBasedPlanningGenView.png "Capability-based planning view")
...
2.  By default the overall summary of capabilities is displayed.
    ...
    -   **Legend \(![Legend information icon](../image/LegendIcon.png)\)**
