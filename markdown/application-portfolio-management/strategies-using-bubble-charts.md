...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/strategies-using-bubble-charts.html
release: zurich
topic_type: task
...
4.  To change the configurations of the bubble chart, click the configuration icon \(\) icon and then fill in the fields on the Select Chart Dimensions form.
    ...
    For field information, see [Select Chart Dimensions form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/select-chart-dimensions-form.md).
