...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-portfolio-management/eaw-add-edit-my-trm-prod.html
release: brazil
topic_type: task
...
6.  On the TRM Product form, fill in the fields.
    ...
    For field information, see [Create TRM product form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-portfolio-management/eaw-new-trm-prod-form.md).
