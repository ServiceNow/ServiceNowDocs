...
\(Optional\) Select type of diagrams for which you want to hide this shape element.![Hide shape library element in different diagrams](../../image/eaw-image/eaw-modeling-hide-show-shape-element.png)
