...
Starting with the Xanadu release, the legacy application category groups module is moved to the Enterprise Architecture Workspace. To learn more, see [Configure application category groups](../concept/eaw-concept/eaw-configure-application-category-groups.md).
