...
<table id="choicetable_dsh_sns_dfc"><thead><tr><th align="left" id="d90447e142">

Options

</th><th align="left" id="d90447e145">

Steps

</th></tr></thead><tbody><tr><td id="d90447e151">
...
You can again select the open item icon \(![Expand Row icon](../../image/ExpandIcon.png)\) next to a sub capability to view more sub capabilities that are lower in the business capability hierarchy.![Selected sub capabilities that are to be added to the business application.](../../image/eaw-image/business-sub-capability-added-to-ba.png)
