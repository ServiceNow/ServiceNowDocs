...
-   **[Job schedule to compute application scores - Legacy](job-run-compute-application-scores.md)**  
...
**Parent Topic:**[Exploring Enterprise Architecture \(formerly Application Portfolio Management\) - Legacy](explore-apm.md)

**Related topics**  


[View all application scores - Legacy](../task/view-application-scores.md)

[View application indicator scores - Legacy](../task/view-application-indicator-scores.md)
