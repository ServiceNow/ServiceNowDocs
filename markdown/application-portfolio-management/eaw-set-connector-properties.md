...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/eaw-set-connector-properties.html
release: zurich
topic_type: task
...
7.  To add a text label to the connector, select **T+**.
    ...
    For details, see [Add labels to connector lines between shapes in a diagram](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-modeling-add-labels-to-connector-lines.md).
