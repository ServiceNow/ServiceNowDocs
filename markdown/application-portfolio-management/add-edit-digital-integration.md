...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/add-edit-digital-integration.html
release: yokohama
topic_type: task
...
3.  On the Create Digital Integration form, fill in the fields.
    ...
    For a description of the field values, see [Create digital integration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/create-digital-integration-form.md).
