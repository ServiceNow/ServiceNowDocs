...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/create-my-list.html
release: yokohama
topic_type: task
...
Add conditions to narrow which records appear in the list. The selected list’s existing conditions are shown by default. For details, see [Filter conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-filter-conditions-reference.md).
        ...
        |Add filters|Add conditions to narrow which records appear in the list. For details, see [Filter conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-filter-conditions-reference.md).|
