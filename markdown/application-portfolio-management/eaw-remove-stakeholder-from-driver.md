---
title: Remove a stakeholder from a driver
description: Remove stakeholders associated with a driver in the Enterprise Architecture Workspace.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-portfolio-management/eaw-remove-stakeholder-from-driver.html
release: australia
topic_type: task
last_updated: "2026-08-02"
reading_time_minutes: 1
keywords: [stakeholder, driver, business architecture, enterprise architecture]
...
5.  Select the driver that you want to remove a stakeholder from.

6.  Select the **Stakeholders** tab.

7.  Select the checkbox next to the stakeholder that you want to remove, and select **Remove**.
