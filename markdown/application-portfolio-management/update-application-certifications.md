---
title: View and update the application certifications - Legacy
...
# View and update the application certifications - Legacy
...
Starting with the Xanadu release, the legacy application certifications module is moved to the Enterprise Architecture Workspace. To learn more, see [Managing requests, certifications, and assessments](../concept/manage-requests-certs-assessments.md).
