---
title: Integrate with Governance, Risk, and Compliance to identify risks - Legacy
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/apm-grc-integration-identify-risks.html
release: zurich
topic_type: task
...
# Integrate with Governance, Risk, and Compliance to identify risks - Legacy
...
4.  Install GRC: Policy and Compliance Management Dependencies \(com.snc.grc\_policy\_dep\) plugin.
    ...
    **Note:** The integration also requires certain applications that should be installed from the ServiceNow app store. See [Request apps on the Store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/governance-risk-compliance/grc-and-store.md) for instructions to download and activate them.


## What to do next

[Create an entity referencing the business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/apm-grc-integration-identify-risks.md). Attach the entity to an audit.
...
## Create audit entity for business application - Legacy
...
3.  On the form, fill in the fields.
    ...
    For field information, see [Entity Form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/entity-form-fields.md).
...
2.  Create a risk in the Risk form.
    ...
    See: [Create a risk manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/governance-risk-compliance/t_CreateRisk.md).
...
2.  To add the business application entity to the engagement, click **Add** button in the **Entities** related list.
    ...
    **Note:** The engagement must be in **Scope** or **Validate** state.
    ...
    See: [Add profiles to an engagement scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/governance-risk-compliance/add-profiles-to-engagement-scope.md).
...
1.  To create a control and add an entity to the control, see [Create a control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/governance-risk-compliance/t_CreateAControl.md).
