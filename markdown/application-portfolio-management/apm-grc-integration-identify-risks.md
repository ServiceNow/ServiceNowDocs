...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/apm-grc-integration-identify-risks.html
release: xanadu
topic_type: task
...
[Create an entity referencing the business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/apm-grc-integration-identify-risks.md). Attach the entity to an audit.
...
3.  On the form, fill in the fields.
    ...
    For field information, see [Entity Form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/entity-form-fields.md).
