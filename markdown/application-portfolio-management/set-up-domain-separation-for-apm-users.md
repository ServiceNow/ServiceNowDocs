...
![Illustration of a sample domain map](../image/DomainMap.png "Illustration of a sample domain map")
...
6.  Execute jobs for domain separated data.
    ...
    ![Scheduled jobs](../image/DomainSeparationRunas.png "Scheduled jobs")
