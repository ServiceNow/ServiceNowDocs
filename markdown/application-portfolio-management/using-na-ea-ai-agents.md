...
To change any configuration of an AI agent, you must first duplicate the use case. For information, see [duplicate the use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/clone-aia-usecase.md). Then proceed with the following steps:
...
To view more information on AI agents and how to install them, see [AI Agent Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/ai-agent-studio.md).
