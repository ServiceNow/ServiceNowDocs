...
To change any configuration of an AI agent, you must first duplicate the use case. For information, see duplicate the use case. Then proceed with the following steps:
