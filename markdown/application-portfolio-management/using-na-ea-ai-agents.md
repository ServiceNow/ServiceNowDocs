...
To change any configuration of an AI agent, you must first duplicate the use case. For information, see [duplicate the use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/enable-ai-experiences/clone-aia-usecase.md). Then proceed with the following steps:
