...
To change any configuration of an AI agent, you must first duplicate the use case. For information, see [duplicate the use case](https://www.servicenow.com/docs/access?context=clone-aia-usecase&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US). Then proceed with the following steps:

-   Activate the use case.
-   Activate all agents in a use case.To invoke the Generate enterprise architecture diagram use case, you can ask for a business hierarchy diagram for a specific entity through the Now Assist panel.
