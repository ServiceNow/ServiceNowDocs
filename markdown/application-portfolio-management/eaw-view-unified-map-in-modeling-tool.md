...
7.  Select the **Model with Enterprise Modeling and Visualization** icon \(![Unified map with the Model with Enterprise Modeling and Visualization icon highlighted.](../../image/eaw-image/open-with-modeling-tool.png)\).
...
9.  Select **OK**.
    ...
    To learn more on how to use Enterprise Modeling and Visualization, see [Enterprise Modeling and Visualization in the EA Workspace](../../concept/eaw-concept/eaw-modeling.md).
