...
7.  Select the **Model with Enterprise Modeling and Visualization** icon \(![Model with Enterprise Modeling and Visualization icon.](../../image/eaw-image/open-with-modeling-tool.png)\).
