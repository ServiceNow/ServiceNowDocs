...
5.  Open the catalog that you want to publish or create a configuration to publish.
    ...
    For instructions to create a configuration,see [Create a configuration to publish TRM data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-portfolio-management/config-trm-data-to-publish.md).
