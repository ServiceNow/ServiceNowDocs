...
Starting with the Xanadu release, the legacy Technology Reference Model module is moved to the Enterprise Architecture Workspace. To learn more, see [TRM technical debt](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-manage-trm-technical-debt.md).

Role required: sn\_apm.apm\_analyst

## About this task

A scheduled job **Populate TRM technical debts in the EA Workspace** runs and creates an entry in the TRM Technical Debt \[sn\_apm\_trm\_standards\_technical\_debt\] table for EA Workspace. The table shows a reference to the software in any business application that is not aligned with the TRM software phases. The table shows software references that either aren't defined in TRM or have TRM product lifecycles that restrict software usage. To know how the technical debts are calculated, see [Manage Technology Reference Model \(TRM\) technical debt - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/trm-technical-debt-calc.md).
