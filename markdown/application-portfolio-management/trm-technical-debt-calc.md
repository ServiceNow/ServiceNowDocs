...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/trm-technical-debt-calc.html
release: yokohama
topic_type: task
