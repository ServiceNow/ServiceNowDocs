...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/manage-relationships-in-capability-map.html
release: xanadu
topic_type: task
...
4.  On the form, fill in the fields.
    ...
    For field information, see [Business capability new record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/business-capability-new-record-form.md).
