...
Starting with the Xanadu release, the legacy business applications module is moved to the Enterprise Architecture Workspace. To learn more, see [Exploring the application portfolio](eaw-concept/eaw-app-portfolio.md).

You can record the details of a business application manually or import the list of applications from a spreadsheet or a third-party tool. To [import data](https://www.servicenow.com/docs/access?context=c_ImportDataUsingImportSets&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US), define a data source and transform map, and run or schedule an import.
...
[Business application relationship with CIs for application information - Legacy](application-relations.md)

[View business application roadmap - Legacy](../task/view-business-application-roadmap.md)

[Suggestions to relate technology models to an application service - Legacy](software-models-suggestions-application-service.md)
