...
Starting with the Xanadu release, the legacy business capability module is moved to the Enterprise Architecture Workspace. To learn more, see [Manage business capabilities](../concept/eaw-concept/eaw-business-capabilities.md).
...
12. In the Relationships section, select the CI relationship icon ![CI relationship icon](../image/RelationshipEditorIcon.png) to create a new relationship with selected configuration items.

    The Provided by::Provides relationship is added in the Relationships section.

13. Select **Save and Exit**.![Relation editor page highlighting the relevant suggested relationship type and the relationship.](../image/relate-cap-to-ba.png)
