...
![Enterprise Architecture Workspace.](../../../common/image/icon-manage.png)

</td><td>

[Enterprise Modeling and Visualization](application-portfolio-management-landing-page.md#section_rts_qj4_dwb)

 Create diagrams and model the future state of your IT and its relationship to the business landscape.

</td></tr><tr><td>

![Enterprise Architecture Workspace.](../image/icon-project-manager.png)

</td><td>

[Rationalization of business applications](application-portfolio-management-landing-page.md#section_vsr_3l4_dwb)
...
![Enterprise Architecture Workspace.](../image/icon-supervised-learning.png)

</td><td>

[Gantt view of TPM and TRM lifecycle timelines](application-portfolio-management-landing-page.md#section_nrb_5l4_dwb)
...
![TPM Gantt chart view](../image/eaw-image/TPM-gantt-chart.png)![TRM Gantt chart view](../image/eaw-image/TRM-gantt-chart.png)
...
-   [Managing a business portfolio](manage-business-portfolio.md)
-   [Working with the Enterprise Architecture Workspace dashboard](../../../use/dashboards/concept/eaw-workspace-dashboard.md)
-   [Managing the Technology Portfolio Management \(TPM\) in Enterprise Architecture Workspace](eaw-concept/eaw-tpm.md)
...
-   [Configure application total cost of ownership \(TCO\) in Enterprise Architecture Workspace](eaw-concept/eaw-app-tco.md)

-   **[Enterprise Architecture \(formerly Application Portfolio Management\)](application-portfolio-management.md)**  
