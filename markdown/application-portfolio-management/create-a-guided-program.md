...
-   **Step 1: Set Goal Contribution Target**
    ...
    2.  On the form, fill in the fields.
        ...
        For field information, see [Goal Contribution Target form](../reference/goal-contribution-target-form.md).
...
-   **Step 2: Identify Opportunities**
    ...
    6.  Right-click a bubble in the [bubble chart](strategies-using-bubble-charts.md) and click the **Create Demand** prompt to [create a demand](create-an-idea.md).
...
-   **Step 3: Track Project**
    ...
    1.  Click the projects link to track the status of the project anytime.
        ...
        The [Program Workbench](https://www.servicenow.com/docs/access?context=c_ProgramWorkbench&version=zurich&pubname=zurich-it-business-management&ft:locale=en-US) opens up, which is a central location for creating and managing projects. As the demand manager approves the demands and the projects are executed, you can navigate to the program workbench to track the status of the projects.
