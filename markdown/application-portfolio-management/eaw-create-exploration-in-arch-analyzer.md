...
-   To clear all entities from the canvas, select the **Clear** button \(![Clear button icon](../../image/eaw-image/arch-anlyzer-clear-canvas.png)\)
...
**Parent Topic:**[Exploring the architecture analyzer](../../concept/eaw-concept/eaw-explore-arch-analyzer.md)
