...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/configure-apm.html
release: zurich
topic_type: concept
...
-   **[Activate Enterprise Architecture - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/activate-apm.md)**  
An administrator can activate the Enterprise Architecture plugin \(com.snc.apm\).
-   **[Enterprise Architecture administration - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/application-portfolio-management-admin.md)**  
...
-   **[Enterprise Architecture \(EA\) \(formerly Application Portfolio Management\) and the CSDM framework - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/apm-use-case-product-view.md)**  
...
-   **[Add a data classification - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/add-data-classification.md)**  
...
-   **[Apply classification tags to an information object - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/apply-classif-tag-info-obj.md)**  
...
-   **[Set up domain separation for Enterprise Architecture users - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/set-up-domain-separation-for-apm-users.md)**  
