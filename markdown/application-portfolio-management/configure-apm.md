...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/configure-apm.html
release: xanadu
topic_type: concept
...
-   **[Exploring Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/explore-eaw.md)**  
...
-   **[Activate Enterprise Architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/activate-apm.md)**  
An administrator can activate the Enterprise Architecture plugin \(com.snc.apm\).
-   **[Enterprise Architecture administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/application-portfolio-management-admin.md)**  
...
-   **[Enterprise Architecture \(EA\) \(formerlyApplication Portfolio Management\) and the CSDM framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/apm-use-case-product-view.md)**  
...
-   **[Application classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/setup-appln-class-attrib.md)**  
...
-   **[Manage the life cycle of a business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/create-app-model-lifecycle.md)**  
Create or edit the life cycle of a business application to better manage the business application.
-   **[Run a scheduled job to generate an application model for business applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/run-job-gen-model-id-ba.md)**  
...
-   **[Add a data classification group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/add-data-class-group.md)**  
Create a data classification group to categorize data classifications.
-   **[Add a data classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/add-data-classification.md)**  
...
-   **[Apply classification tags to an information object](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/apply-classif-tag-info-obj.md)**  
...
-   **[Schedule a data certification task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/schedule-data-in-business-applications.md)**  
...
-   **[Run audits to determine invalid and missing configuration data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/run-desired-and-scripted-audits.md)**  
...
-   **[Train the similarity solution for Enterprise Architecture to categorize applications while registering](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/similarity-solution-apm.md)**  
...
-   **[Suggest an application category based on similar business applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/apm-piwb-usecase-ba.md)**  
...
-   **[Configure script to customize risk calculation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/configure-risk-bubble.md)**  
...
-   **[Run scheduled job to generate risk values](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/run-scheduled-job-to-calculate-risks.md)**  
...
-   **[Install Application Portfolio Management \(APM\) Cloud Assessment Application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/install-cloud-readiness-sore-prof.md)**  
Install the APM Cloud Assessment application \(app-apm-cloud-readiness\) from  the  ServiceNow Store.
-   **[Schedule a job to compute application scores](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/schedule-job-for-indicator-sourcing-score-cal.md)**  
...
-   **[Set up domain separation for Enterprise Architecture users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/set-up-domain-separation-for-apm-users.md)**  
...
-   **[Run scheduled jobs for CMDB Query Builder reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/scheduled-job-cmdb-query-builder.md)**  
...
-   **[Schedule a job to generate TPM lifecycle data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/schedule-job-generate-tpm-data.md)**  
...
-   **[Run a scheduled job to generate TPM lifecycle data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/run-scheduled-job-update-tpm-data.md)**  
Run a scheduled job to fetch the technology lifecycle data for your technology portfolio.
-   **[Schedule a job to generate TPM technology risk](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/schedule-job-generate-tpm-risk.md)**  
