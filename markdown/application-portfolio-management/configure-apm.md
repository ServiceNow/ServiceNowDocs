---
title: Configuring Enterprise Architecture \(formerly Application Portfolio Management\) - Legacy
...
# Configuring Enterprise Architecture \(formerly Application Portfolio Management\) - Legacy
...
-   **[Activate Enterprise Architecture - Legacy](../task/activate-apm.md)**  
An administrator can activate the Enterprise Architecture plugin \(com.snc.apm\).
-   **[Enterprise Architecture administration - Legacy](application-portfolio-management-admin.md)**  
...
-   **[Enterprise Architecture \(EA\) \(formerly Application Portfolio Management\) and the CSDM framework - Legacy](apm-use-case-product-view.md)**  
...
-   **[Application classification - Legacy](setup-appln-class-attrib.md)**  
...
-   **[Manage the life cycle of a business application - Legacy](../task/create-app-model-lifecycle.md)**  
Create or edit the life cycle of a business application to better manage the business application.
-   **[Run a scheduled job to generate an application model for business applications - Legacy](../task/run-job-gen-model-id-ba.md)**  
...
-   **[Add a data classification group - Legacy](../task/add-data-class-group.md)**  
Create a data classification group to categorize data classifications.
-   **[Add a data classification - Legacy](../task/add-data-classification.md)**  
...
-   **[Apply classification tags to an information object - Legacy](../task/apply-classif-tag-info-obj.md)**  
...
-   **[Run audits to determine invalid and missing configuration data - Legacy](../task/run-desired-and-scripted-audits.md)**  
...
-   **[Train the similarity solution for Enterprise Architecture to categorize applications while registering - Legacy](../task/similarity-solution-apm.md)**  
...
-   **[Suggest an application category based on similar business applications - Legacy](../task/apm-piwb-usecase-ba.md)**  
...
-   **[Set up domain separation for Enterprise Architecture users - Legacy](../task/set-up-domain-separation-for-apm-users.md)**  
...
-   **[Run scheduled jobs for CMDB Query Builder reports - Legacy](../task/scheduled-job-cmdb-query-builder.md)**  
...
-   **[Schedule a job to generate TPM lifecycle data - Legacy](../task/schedule-job-generate-tpm-data.md)**  
...
-   **[Run a scheduled job to generate TPM lifecycle data - Legacy](../task/run-scheduled-job-update-tpm-data.md)**  
Run a scheduled job to fetch the technology lifecycle data for your technology portfolio.
-   **[Schedule a job to generate TPM technology risk - Legacy](../task/schedule-job-generate-tpm-risk.md)**  
