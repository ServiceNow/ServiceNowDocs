...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/configure-apm.html
release: yokohama
topic_type: concept
...
-   **[Activate Enterprise Architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/activate-apm.md)**  
An administrator can activate the Enterprise Architecture plugin \(com.snc.apm\).
-   **[Enterprise Architecture administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/application-portfolio-management-admin.md)**  
...
-   **[Enterprise Architecture \(EA\) \(formerlyApplication Portfolio Management\) and the CSDM framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/apm-use-case-product-view.md)**  
...
-   **[Manage the life cycle of a business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/create-app-model-lifecycle.md)**  
Create or edit the life cycle of a business application to better manage the business application.
-   **[Run a scheduled job to generate an application model for business applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/run-job-gen-model-id-ba.md)**  
...
-   **[Add a data classification group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/add-data-class-group.md)**  
Create a data classification group to categorize data classifications.
-   **[Add a data classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/add-data-classification.md)**  
...
-   **[Apply classification tags to an information object](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/apply-classif-tag-info-obj.md)**  
...
-   **[Run audits to determine invalid and missing configuration data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/run-desired-and-scripted-audits.md)**  
...
-   **[Train the similarity solution for Enterprise Architecture to categorize applications while registering](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/similarity-solution-apm.md)**  
...
-   **[Suggest an application category based on similar business applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/apm-piwb-usecase-ba.md)**  
...
-   **[Set up domain separation for Enterprise Architecture users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/set-up-domain-separation-for-apm-users.md)**  
...
-   **[Schedule a job to generate TPM technology risk](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/schedule-job-generate-tpm-risk.md)**  
