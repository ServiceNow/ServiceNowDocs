...
For more details, see [Schedule a job to generate TPM lifecycle data - Legacy](../../task/schedule-job-generate-tpm-data.md) and [Run a scheduled job to generate TPM lifecycle data - Legacy](../../task/run-scheduled-job-update-tpm-data.md).
