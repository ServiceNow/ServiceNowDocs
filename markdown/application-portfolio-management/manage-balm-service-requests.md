---
title: Manage BALM service requests
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/manage-balm-service-requests.html
release: yokohama
topic_type: task
...
7.  Select **Update**.
    ...
    -   **If you approve a Retire a Business Application request**
        ...
        -   If the value in the **sn\_apm.retireBusinessApplocationTaskType** system property is set as demand, then a demand is created.
            ...
            For field information, see [Demand form to retire an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/demand-form-retire-application.md).
