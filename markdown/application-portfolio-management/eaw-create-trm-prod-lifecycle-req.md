...
3.  Select the TRM more actions icon ![TRM more actions icon](../../image/eaw-image/trm-more-actions-icon.png) next to **Request TRM product**.

4.  Select **Create TRM product lifecycle**.

5.  On the form, fill in the fields.

    For field information, see [Create new TRM product lifecycle form](../../reference/eaw-reference/eaw-create-trm-prod-lifecycle-form.md).
