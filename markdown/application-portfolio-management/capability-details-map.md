...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/capability-details-map.html
release: yokohama
topic_type: task
...
3.  Click each capability to view the sub-capabilities and their details.
    ...
    -   **Number of applications linked to the capability**
        ...
        The applications icon \(\[Omitted image "ApplicationsIcon.png"\] Alt text: Applications icon\) displays the total count of applications that are related to that capability.
    ...
    -   **Details**
        ...
        \[Omitted image "CapabilityBasedPlanning.png"\] Alt text: Capability based planning
    ...
    -   **Business Applications**
        ...
        **Business Capability** view: Displays the names of the business applications on the right pane, which are related to the selected business capability on the left pane, and the overall score of each individual application.
        ...
        \[Omitted image "BusAppOverallScore.png"\] Alt text: Business application overall score view

        Click the business application hypertext to navigate to the Business Application form and view the record details.

        Click the information icon \(\[Omitted image "iIcon.png"\] Alt text: Information icon\) of an application to view the following details:

        \[Omitted image "BusiAppIndicatorScore.png"\] Alt text: Business application indicator score
