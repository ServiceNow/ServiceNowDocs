---
title: View business capability details in capability map - Legacy
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/capability-details-map.html
release: zurich
topic_type: task
...
# View business capability details in capability map - Legacy
...
3.  Click each capability to view the sub-capabilities and their details.
    ...
    -   **Number of applications linked to the capability**
        ...
        The applications icon \(\) displays the total count of applications that are related to that capability.
    ...
    -   **Business Applications**
        ...
        **Business Capability** view: Displays the names of the business applications on the right pane, which are related to the selected business capability on the left pane, and the overall score of each individual application.
        ...
        Click the information icon \(\) of an application to view the following details:
...
[View technology risk details in capability map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/technology-risk-map.md)

**Parent Topic:**[Use capability map for planning - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/view-capability-based-planning.md)
