...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/eaw-add-a-related-entity-to-an-architectural-artifact.html
release: xanadu
topic_type: task
...
8.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Create new related entities form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/related-entities-form.md).
