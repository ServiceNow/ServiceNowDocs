...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/eaw-add-a-related-entity-to-an-architectural-artifact.html
release: yokohama
topic_type: task
...
8.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Create new related entities form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-artifact-releated-entity-form.md).
