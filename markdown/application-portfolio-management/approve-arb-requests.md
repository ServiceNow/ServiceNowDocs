...
Starting with the Xanadu release, the legacy business applications module is moved to the Enterprise Architecture Workspace. To learn more, see [Managing requests, certifications, and assessments](../concept/manage-requests-certs-assessments.md).
