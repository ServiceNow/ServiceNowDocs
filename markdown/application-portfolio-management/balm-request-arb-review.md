...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/balm-request-arb-review.html
release: xanadu
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    **Note:**
    ...
    For field information, see [Request Architecture Review form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/request-architecture-review-form.md).
