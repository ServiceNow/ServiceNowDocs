...
3.  On the form, fill in the fields.
    ...
    **Note:**
    ...
    For field information, see [Request Architecture Review form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/request-architecture-review-form.md).
