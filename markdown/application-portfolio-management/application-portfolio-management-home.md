...
-   **Technology Portfolio**
    ...
    Use the Technology Reference Model to define the software products standards and manage unapproved software in your organization. For more information, see [Exploring Technology Reference Model - Legacy](technology-reference-model-in-apm.md).
