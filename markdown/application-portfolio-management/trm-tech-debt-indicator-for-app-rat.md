...
-   Populate TPM Discovered Technologies and Lifecycles
    ...
    **Note:** The data includes end of support date, end of extended support date, and end of life date for your software products and hardware models.
    ...
    For instructions, see [Run a scheduled job to generate TPM lifecycle data - Legacy](../../task/run-scheduled-job-update-tpm-data.md). For updating the TPM data for a selected business application, see [Update TPM data for a business application or application service](../../task/eaw-task/update-tpm-data.md).
