...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/eaw-create-lucid-diagram-ba.html
release: zurich
topic_type: task
...
6.  On the Create Diagram form, fill in the fields.
    ...
    For field information, see [Create a diagram for a business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-create-diagram-ba.md).
