...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/eaw-create-a-demand-using-the-bubble-chart.html
release: zurich
topic_type: task
...
<table id="choicetable_ebc_3mq_fhc"><thead><tr><th align="left" id="d37576e92">

Bubble type

</th><th align="left" id="d37576e95">

Action

</th></tr></thead><tbody><tr><td id="d37576e101">
...
\[Omitted image "bubble-chart-grouped-bubble-demand.png"\] Alt text: Create demand button highlighted for a grouped bubble.
    ...
    For a description of the field values, see [Create demand form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-demand-form.md).
