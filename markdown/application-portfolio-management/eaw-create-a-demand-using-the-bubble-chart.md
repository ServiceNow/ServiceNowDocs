...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-portfolio-management/eaw-create-a-demand-using-the-bubble-chart.html
release: australia
topic_type: task
...
<table id="choicetable_ebc_3mq_fhc"><thead><tr><th align="left" id="d36259e92">

Bubble type

</th><th align="left" id="d36259e95">

Action

</th></tr></thead><tbody><tr><td id="d36259e101">
...
\[Omitted image "bubble-chart-grouped-bubble-demand.png"\] Alt text: Create demand button highlighted for a grouped bubble.
    ...
    For a description of the field values, see [Create demand form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-portfolio-management/eaw-demand-form.md).
...
[Set the planned disposition of a business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-portfolio-management/eaw-set-planned-disposition-of-a-business-application.md)
