...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-portfolio-management/eaw-edit-modeling-menu.html
release: australia
topic_type: task
...
6.  On the Shape Library form, fill in the fields.
    ...
    For field information, see [Modeling configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-portfolio-management/eaw-modeling-config-form.md).
