...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/apm-use-case-product-view.html
release: zurich
topic_type: concept
...
**Note:** If you do not use CSDM 5.0 or later versions, see the Rome documentation for CSDM. For implementing CSDM framework, see [Implementing the CSDM framework in stages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/csdm-implementation-stages.md).
...
-   **Technology Portfolio**
    ...
    For more information about technology portfolio management and how it relates to business applications, see [Technology Lifecycle Management \(TLM\) in Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-tpm.md).


-   **[Enterprise Architecture \(formerly Application Portfolio Management\) and CSDM tables - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/apm-use-case.md)**  
...
-   **[Enterprise Architecture \(formerly Application Portfolio Management\) use case - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/apm-use-case-example.md)**  
...
-   **[Enterprise Architecture \(formerly Application Portfolio Management\) considerations - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/apm-use-case-trouble.md)**  
...
[Exploring the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/csdm-content-frame-exploring.md)
