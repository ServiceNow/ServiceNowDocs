...
**Note:** If you do not use CSDM 4.0 or later versions, see the Rome documentation for CSDM. For implementing CSDM framework, see [Implementing the CSDM framework in stages](https://www.servicenow.com/docs/access?context=csdm-implementation-stages&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
![Enterprise Architecture home page presents business, information, application, and technology portfolios.](../image/csdm-apm/apm-dashboard.png)
...
-   **Technology Portfolio**
    ...
    For more information about technology portfolio management and how it relates to business applications, see [Managing the Technology Portfolio Management \(TPM\) in Enterprise Architecture Workspace](eaw-concept/eaw-tpm.md).


-   **[Enterprise Architecture \(formerly Application Portfolio Management\) and CSDM tables](../reference/apm-use-case.md)**  
