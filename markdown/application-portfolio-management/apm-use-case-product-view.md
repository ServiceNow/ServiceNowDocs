---
title: Enterprise Architecture \(EA\) \(formerlyApplication Portfolio Management\) and the CSDM framework
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/apm-use-case-product-view.html
release: yokohama
topic_type: concept
...
**Note:** If you do not use CSDM 4.0 or later versions, see the Rome documentation for CSDM. For implementing CSDM framework, see [Implementing the CSDM framework in stages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/csdm-implementation-stages.md).
...
-   **[Enterprise Architecture \(formerly Application Portfolio Management\) and CSDM tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/apm-use-case.md)**  
...
-   **[Enterprise Architecture \(formerly Application Portfolio Management\) use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/apm-use-case-example.md)**  
...
-   **[Enterprise Architecture \(formerly Application Portfolio Management\) considerations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/apm-use-case-trouble.md)**  
