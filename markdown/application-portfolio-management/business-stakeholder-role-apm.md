...
2.  Click the add widgets icon \(![Add widget icon](../image/AddWidgetsIcon.png)\).
3.  Click the edit content icon \(![Edit content - pencil icon](../image/EditContentIcon.png)\) of the widget that you want to share.
4.  Click the sharing icon \(![Sharing icon](../image/ShareingIcon.png)\).
