...
-   **Upgrade customer**
    ...
    If you are upgrading to Australia, the business stakeholder role for Enterprise Architecture is available only when you activate Read only roles for Enterprise Architecture \(com.snc.apm\_read\_roles\) plugin.
