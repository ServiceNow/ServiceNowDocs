...
-   **[Components installed with Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/installed-with-eaw.md)**  
...
-   **[Create profile indicator form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-new-profile-indicator-form.md)**  
You can use indicators within many scoring profiles, which generate indicator scores unique to that scoring profile.
-   **[Create a sub-capability form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-a-sub-capability.md)**  
...
-   **[Digital integration form \(easy form\) in EA Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-digital-integ-form.md)**  
The digital integration represents the integration between two business applications.
-   **[Digital integration form in EA Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-update-digital-integration-form.md)**  
...
-   **[Create demand form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-demand-form.md)**  
...
-   **[Architectural artifact form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-new-arct-artfct-form.md)**  
...
-   **[Share architectural artifacts form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-share-architectural-artifacts-form.md)**  
Share architectural artifacts with users and group and assign them relevant access permissions.
-   **[Application model life-cycle details form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-application-model-lifecycle-details-form.md)**  
The application model life cycle helps you to better manage the life cycle of a business application.
-   **[Business application form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-business-application-form.md)**  
...
-   **[Create product capability form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-new-product-capability-form.md)**  
...
-   **[Demand form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-edit-demand-form.md)**  
Use a demand as a step to identify cost-saving opportunities on the business applications and meet your targets.
-   **[Demand Actions Form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-demand-action-form.md)**  
...
-   **[Create demand form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-new-demand-form.md)**  
Create a demand for your application or capability.
-   **[Edit a project form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-edit-project-form.md)**  
Use application rationalization to edit details of an existing project associated with a business application.
-   **[Digital interface form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-digital-interface-form.md)**  
...
-   **[Digital interface to API form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-dig-interface-api-form.md)**  
...
-   **[Application service form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-app-service-form.md)**  
...
-   **[Create value stream to process form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-new-value-stream-to-process-form.md)**  
Add a value stream to a process to create an efficient workflow.
-   **[Create application model form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-new-application-model-from.md)**  
...
-   **[Create application category form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-new-application-category-form.md)**  
Create an application category to categorize applications and rationalize decisions on their usage.
-   **[Create application category group form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-crate-new-application-category-group-form.md)**  
Create an application category group or edit an existing one to align it with your business requirements.
-   **[Create application family form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-new-application-family-form.md)**  
Create an application family to align it with your business requirements.
-   **[Create indicator form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-new-indicator-form.md)**  
Create an application or capability indicator to assess applications or capabilities within the indicator framework.
-   **[Create scoring profile form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/create-new-scoring-profile-form.md)**  
...
-   **[Certification schedule form in Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-certification-schedule-form.md)**  
...
-   **[Shape library form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-shape-library-form.md)**  
...
-   **[Modeling configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-modeling-config-form.md)**  
The modeling configuration form helps you to configure UI options for Enterprise Modeling and Visualization.
-   **[Entity configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-entity-config-form.md)**  
...
-   **[Relationship configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-relationship-form.md)**  
The entity configuration form helps you to configure entities that can be used in the Enterprise Modeling and Visualization.
-   **[Add relationship form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-add-relationship-form.md)**  
...
-   **[Digital interface SDLC component form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-dig-interface-sdlc-comp-form.md)**  
The SDLC components represent the artifacts or configurations that are used to implement an Interface.
-   **[Digital interface information object form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-dig-interface-info-object-form.md)**  
...
-   **[Certification policy form in Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-certification-policy-form.md)**  
A system administrator with Enterprise Architecture \(formerly APM\) admin role can create and assign data certification tasks to the system owners for certifying business application data.
-   **[Shape library element form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-modeling-shape-library-element-form.md)**  
...
-   **[Create a business process map form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-modeling-bp-map-form.md)**  
Create a business process map and associate an artifact for the map using Enterprise Modeling and Visualization.
-   **[Create value stream form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-new-value-stream-form.md)**  
Create a new value stream to visualize the flow of a process from start to finish.
-   **[Create diagram form for a business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-diagram-ba-form.md)**  
...
-   **[General information form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-data-cert-gen-info-form.md)**  
...
-   **[Create a portal knowledge base form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/create-portal-kb.md)**  
...
-   **[Document template form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/document-template-form.md)**  
Use the document template form to create document template that can be used in the Enterprise Architecture Workspace.
-   **[Data Domain form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-data-domain-form.md)**  
...
-   **[Filter conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-filter-conditions-reference.md)**  
Filter and sort options define which records appear in a custom list and the order in which they are displayed.
-   **[Architectural category form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/architectural-category-form.md)**  
Architectural category enables Enterprise architects to categorize and manage artifacts efficiently.
-   **[Data Domain form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/data-domain-form.md)**  
Define and manage a data domain to organize related information objects within a hierarchical structure. Data domains help categorize data discovered in database catalogs by ServiceNow Discovery. A data catalog lists all the catalog objects, or databases, discovered for an instance of a database.
-   **[TRM Category form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-portfolio-management/trm-category-form.md)**  
