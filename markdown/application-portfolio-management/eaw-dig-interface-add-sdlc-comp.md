...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/eaw-dig-interface-add-sdlc-comp.html
release: zurich
topic_type: task
...
3.  Select the expand row icon \(\[Omitted image "new-expand-icon-coral.png"\] Alt text:\) next to **Application Portfolio**.
...
8.  On the Digital Interface SDLC Component form, fill in the fields.
    ...
    For field descriptions, see [Digital interface SDLC component form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-dig-interface-sdlc-comp-form.md).
