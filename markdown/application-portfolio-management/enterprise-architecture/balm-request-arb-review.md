...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/enterprise-architecture/balm-request-arb-review.html
release: xanadu
...
3.  On the form, fill in the fields.
    ...
    **Note:**
    ...
    For field information, see [Request Architecture Review form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/enterprise-architecture/request-architecture-review-form.md).
