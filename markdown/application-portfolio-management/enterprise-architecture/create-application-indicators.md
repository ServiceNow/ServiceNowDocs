---
title: Create or edit an indicator to assess an application
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/enterprise-architecture/create-application-indicators.html
release: yokohama
...
# Create or edit an indicator to assess an application
...
Starting with the Xanadu release, the application indicators module is moved to the Enterprise Architecture Workspace. To learn more, see [Configure indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-configure-indicators.md).
...
3.  On the form, fill in the fields.
    ...
    For field information, see [Indicator form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/indicator-form.md).
...
Use the [preconfigured indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/preconfigured-indicators-and-sources.md) to assess the applications based on cost, quality, and risk.

-   **[Generate survey assessments and view the results within Enterprise Architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/generate-survey-assessments-results-apm.md)**  
