---
title: Create business capability and relate the capability with an application
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/enterprise-architecture/create-a-business-capability.html
release: xanadu
...
# Create business capability and relate the capability with an application
...
Starting with the Xanadu release, the legacy business capability module has been deprecated from Enterprise Architecture \(formerly Application Portfolio Management\). However, if you’re an existing user of Enterprise Architecture \(formerly Application Portfolio Management\), you can still use the legacy business capability module. If you’re a new activation user, the legacy business capability module isn’t available.

You can leverage the same features by using the Enterprise Architecture Workspace. To learn more, see [Manage business capabilities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/enterprise-architecture/eaw-business-capabilities.md).
...
3.  Fill in the form fields.
    ...
    For field information, see [Business capability form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/enterprise-architecture/business-capability-form.md).
...
9.  In the Related Items section of the business capability form, select the Add CI relationship \(\[Omitted image "RelationshipEditorIcon.png"\] Alt text: CI relationship editor icon\) icon to launch the relationship editor and create the CI relationship.
...
12. In the Relationships section, select the CI relationship icon \[Omitted image "RelationshipEditorIcon.png"\] Alt text: CI relationship icon to create a new relationship with selected configuration items.

    The Provided by::Provides relationship is added in the Relationships section.

13. Select **Save and Exit**.\[Omitted image "relate-cap-to-ba.png"\] Alt text: Relation editor page highlighting the relevant suggested relationship type and the relationship.


## What to do next

View [capability based planning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/enterprise-architecture/overview-business-capability-planning.md) to understand the hierarchy of capabilities mapped with its related applications and [plan investments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/enterprise-architecture/view-capability-based-planning.md) in applications if the technology of the applications is at a risk.
