...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/enterprise-architecture/add-edit-digital-integration.html
release: xanadu
...
3.  On the Create Digital Integration form, fill in the fields.
    ...
    For a description of the field values, see [Create digital integration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/enterprise-architecture/create-digital-integration-form.md).
