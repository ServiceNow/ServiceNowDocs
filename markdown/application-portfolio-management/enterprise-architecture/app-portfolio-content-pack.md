---
title: Enterprise Architecture \(formerly Application Portfolio Management\) Platform Analytics Solutions
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/enterprise-architecture/app-portfolio-content-pack.html
release: yokohama
...
# Enterprise Architecture \(formerly Application Portfolio Management\) Platform Analytics Solutions
...
To enable the solution plugin for Application Portfolio Management, an admin can navigate to **System Definitions** &gt; **Plugins** and activate the Performance Analytics - Content Pack - Application Portfolio Management plugin.
