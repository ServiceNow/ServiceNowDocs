...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/enterprise-architecture/set-up-domain-separation-for-apm-users.html
release: yokohama
...
\[Omitted image "DomainMap.png"\] Alt text: Illustration of a sample domain map
...
6.  Execute jobs for domain separated data.
    ...
    \[Omitted image "DomainSeparationRunas.png"\] Alt text: Scheduled jobs
