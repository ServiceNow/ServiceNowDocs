...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/enterprise-architecture/use-tpm-encoded-query.html
release: xanadu
...
1.  Generate an encoded query string through a filter on the **Software Installations** page.
    ...
    2.  Apply a filter according to your requirement.
