...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/enterprise-architecture/eaw-business-processes.html
release: yokohama
...
-   **[View all business processes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-view-all-business-processes.md)**  
You can view the list of all available business processes in the Enterprise Architecture Workspace.
-   **[Add or edit a business process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-create-business-process.md)**  
...
-   **[Manage architectural artifacts of a business process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-assoicate-artifact-bp.md)**  
You can create new, add, or remove the artifacts that are associated with a business process.
-   **[View value stream stages associated with a business process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-view-vs-stages-assoc-with-bp.md)**  
