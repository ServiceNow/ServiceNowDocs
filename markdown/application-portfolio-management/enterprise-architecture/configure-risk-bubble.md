...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/enterprise-architecture/configure-risk-bubble.html
release: yokohama
...
5.  Click the preview this record icon \(\[Omitted image "LegendInfoIcon.png"\] Alt text: Information icon\) next to the **Class** field.
...
6.  In the Script Include pop-up, click **Open Record** button.
    ...
    \[Omitted image "ConfigureRiskCustomScript.png"\] Alt text: Configure custom script to calculate risks at three levels of risk calculation
