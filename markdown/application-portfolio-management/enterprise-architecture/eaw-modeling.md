...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling.html
release: yokohama
...
-   **[Shapes to create a modeling diagram](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-shapes.md)**  
...
-   **[Search shapes in a diagram](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-filter-shapes.md)**  
Search for a shape in the Shapes palette of a diagram.
-   **[Add related records in the modeling diagram](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-add-related-records.md)**  
Fetch and add a related record to the selected shape in a diagram.
-   **[Create a blank diagram using modeling in the EA Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-create-diagram.md)**  
Create a diagram and synchronize it to the ServiceNow database.
-   **[Create a diagram for a business capability map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-bc-map.md)**  
Create and model your business capability map using the Enterprise Modeling and Visualization.
-   **[Update a business capability map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-update-bc-map.md)**  
...
-   **[Add a business capability or business application to the capability map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-bcmap-add-bc-ba.md)**  
...
-   **[Create diagram for a business hierarchy map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-ba-map.md)**  
Create and model your business application hierarchy map using the Enterprise Modeling and Visualization.
-   **[Update a business application hierarchy map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-update-ba-map.md)**  
Modify an existing business application hierarchy map by adding or removing shapes and relationships.
-   **[Business process modeling](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/business-process-modeling.md)**  
...
-   **[Add labels to connector lines between shapes in a diagram](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-add-labels-to-connector-lines.md)**  
...
-   **[ArchiMate shapes support in the Enterprise Modeling and Visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-archimate.md)**  
...
-   **[Custom shapes support in the Enterprise Modeling and Visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-custom-shapes.md)**  
...
-   **[Share a modeling diagram](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-share-diagram.md)**  
Share your draft diagrams with individuals and groups and define access levels for them to view and modify the diagram.
-   **[Commit diagram changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-sync-diagram-servicenow.md)**  
Synchronize an approved diagram and all its elements to the database.
-   **[Save as a new version](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-save-as-new.md)**  
...
-   **[Add or edit diagram version details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-add-or-edit-diagram-version-details.md)**  
...
-   **[Duplicate a modeling diagram](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-duplicate.md)**  
...
-   **[Submit a modeling diagram for approval](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-submit-for-approval.md)**  
...
-   **[Synchronize a shape to the database](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-sync-shape.md)**  
Add a shape to a diagram. Synchronize the shape to the database by mapping the shape to an existing CI or adding a CI.
-   **[Delete a shape](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-delete-shape.md)**  
Delete a shape and all of its relationships from a diagram.
-   **[Delete Enterprise Modeling and Visualization diagrams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/enterprise-architecture/eaw-modeling-delete-diagram.md)**  
