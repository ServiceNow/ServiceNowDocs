...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/enterprise-architecture/business-stakeholder-role-apm.html
release: xanadu
...
-   **Upgrade customer**
    ...
    If you are upgrading to Xanadu, the business stakeholder role for Enterprise Architecture is available only when you activate Read only roles for Enterprise Architecture \(com.snc.apm\_read\_roles\) plugin.
