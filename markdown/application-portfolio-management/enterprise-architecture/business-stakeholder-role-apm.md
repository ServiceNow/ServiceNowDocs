...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/enterprise-architecture/business-stakeholder-role-apm.html
release: yokohama
...
-   **Upgrade customer**
    ...
    If you are upgrading to Yokohama, the business stakeholder role for Enterprise Architecture is available only when you activate Read only roles for Enterprise Architecture \(com.snc.apm\_read\_roles\) plugin.
...
2.  Click the add widgets icon \(\[Omitted image "AddWidgetsIcon.png"\] Alt text: Add widget icon\).
3.  Click the edit content icon \(\[Omitted image "EditContentIcon.png"\] Alt text: Edit content - pencil icon\) of the widget that you want to share.
4.  Click the sharing icon \(\[Omitted image "ShareingIcon.png"\] Alt text: Sharing icon\).
