...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/enterprise-architecture/categorize-similarity-solution-integrate-service-cat.html
release: yokohama
...
3.  Enter the details in the Register a Business Application form.
    ...
    \[Omitted image "MLSuggestedCategory.png"\] Alt text: Register a business application form with category suggested by ML
