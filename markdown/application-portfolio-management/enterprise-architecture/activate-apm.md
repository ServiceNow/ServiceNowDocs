---
title: Activate Enterprise Architecture
description: An administrator can activate the Enterprise Architecture plugin \(com.snc.apm\).
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/enterprise-architecture/activate-apm.html
release: yokohama
...
# Activate Enterprise Architecture
