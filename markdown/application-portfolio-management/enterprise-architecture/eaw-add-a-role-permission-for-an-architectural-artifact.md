...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/enterprise-architecture/eaw-add-a-role-permission-for-an-architectural-artifact.html
release: xanadu
...
8.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Create new role permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/enterprise-architecture/eaw-create-new-role-permissions.md).
