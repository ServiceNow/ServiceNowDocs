...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/schedule-job-generate-tpm-data.html
release: xanadu
topic_type: task
...
**Note:** You can also run the job on-demand. For details, see [Run a scheduled job to generate TPM lifecycle data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/run-scheduled-job-update-tpm-data.md).
