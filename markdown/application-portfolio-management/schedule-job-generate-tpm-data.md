...
**Note:** You can also run the job on-demand. For details, see [Run a scheduled job to generate TPM lifecycle data - Legacy](run-scheduled-job-update-tpm-data.md).
