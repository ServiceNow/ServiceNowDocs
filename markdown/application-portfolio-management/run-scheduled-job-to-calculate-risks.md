...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/run-scheduled-job-to-calculate-risks.html
release: yokohama
topic_type: task
