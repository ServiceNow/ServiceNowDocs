...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/run-scheduled-job-to-calculate-risks.html
release: zurich
topic_type: task
