...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/balm-request-retire-bus-application.html
release: xanadu
topic_type: task
...
For more information on the plugin, see [Activate Application Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/activate-apm.md). See [Predictive Intelligence for Application Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/predictive-intelligence-apm.md) to know more about machine-learning solution for business applications.
