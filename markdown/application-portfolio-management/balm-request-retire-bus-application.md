---
title: Request or retire an application - Legacy
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/balm-request-retire-bus-application.html
release: zurich
topic_type: task
...
# Request or retire an application - Legacy
...
For more information on the plugin, see [Activate Application Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/activate-apm.md). See [Predictive Intelligence for Application Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/predictive-intelligence-apm.md) to know more about machine-learning solution for business applications.
