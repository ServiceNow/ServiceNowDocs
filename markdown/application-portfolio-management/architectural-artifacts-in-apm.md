...
Starting with the Xanadu release, the legacy architectural artifact module is moved to the Enterprise Architecture Workspace. To learn more, see [Manage architectural artifacts](eaw-concept/eaw-managing-architectural-artifacts.md).
...
[Create or edit an architectural artifact](../task/create-edit-artifacts.md)

[Associate an artifact to a business entity](../task/associate-artifact-business-entities.md)

[Managing categories for artifacts](managing-categories.md)

[Create an artifact version](../task/create-artifact-version.md)

[Approve or reject an artifact version request](../task/approve-reject-artifact-request.md)

[Approve architecture review requests](../task/approve-arb-requests.md)
