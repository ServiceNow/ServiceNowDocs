...
3.  Select **TPM risk**.
    ...
    To update the TPM risk scores, you must run the **Populate Technology Lifecycles Risks** job. For more details, see [Schedule a job to generate TPM technology risk - Legacy](../schedule-job-generate-tpm-risk.md).
