---
title: Certification Schedule form
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/certification-schedule-form.html
release: yokohama
...
## Certificate Schedule form fields

<table id="table_nhg_grl_v1b"><thead><tr><th>
...
Select a group from the choice list.
...
-   **Do Not Create Task**: Certification task isn’t created for these records.
...
Defaults to the prior date when the certification was run. The field can’t be edited if the certification schedule is a new record.
...
[Schedule a data certification task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/schedule-data-in-business-applications.md)
