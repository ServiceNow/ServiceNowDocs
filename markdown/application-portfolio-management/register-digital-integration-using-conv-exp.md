...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/register-digital-integration-using-conv-exp.html
release: xanadu
topic_type: task
...
-   Complete configuring the conversational experiences for Enterprise Architecture. For more information, see [Configure Now Assist for Enterprise Architecture \(EA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/configure-now-assist-ea.md).
...
<table id="choicetable_ttr_fll_b2c"><thead><tr><th align="left" id="d32872e152">

Instruction

</th><th align="left" id="d32872e155">

Description

</th></tr></thead><tbody><tr><td id="d32872e161">
...
**Parent Topic:**[Using Now Assist for Enterprise Architecture \(EA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/using-now-assist-for-ea.md)
