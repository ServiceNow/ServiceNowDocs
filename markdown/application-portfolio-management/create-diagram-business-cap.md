...
Starting with the Xanadu release, the Create Diagram feature is moved to the Enterprise Architecture Workspace. To learn more, see [Create a Lucidchart diagram for a business capability in the EA Workspace](eaw-task/eaw-create-lucid-diagram-cap.md).
