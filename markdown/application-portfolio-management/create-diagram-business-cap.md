---
title: Create a Lucid diagram for a business capability - Legacy
...
# Create a Lucid diagram for a business capability - Legacy
...
Starting with the Xanadu release, the Create Diagram feature is moved to the Enterprise Architecture Workspace. To learn more, see [Create a Lucidchart diagram for a business capability in the Enterprise Architecture Workspace](eaw-task/eaw-create-lucid-diagram-cap.md).
...
Ensure a connection is established with Lucid. For details, see [Create OAuth 2.0 Client in Lucidchart](https://www.servicenow.com/docs/access?context=set-up-lucidchart&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) and [Create a connection and credential alias for the Lucidchart diagramming spoke](https://www.servicenow.com/docs/access?context=create-conn-cred-lucidchart&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
...
3.  On the form, fill in the fields.
    ...
    **Note:** Use the authorization link on the Create Diagram window, to generate an authentication token and fetch your Lucid folders to save the diagram.
    ...
    For field information, see [Create diagram for a business capability](../reference/create-diagram-for-business-capability.md).
