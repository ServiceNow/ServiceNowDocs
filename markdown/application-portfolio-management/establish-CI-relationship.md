...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/establish-CI-relationship.html
release: xanadu
topic_type: task
...
[Create a business capability](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/create-a-business-capability.md) and relate the capability to a business application using the CI relationship editor.
