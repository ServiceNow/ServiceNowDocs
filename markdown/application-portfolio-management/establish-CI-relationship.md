...
![Business capability scoring framework](../image/BusinessCapMap.png "Business capability scoring framework")
...
1.  Create CI relationships or edit the existing relationships using [CI relationships in the CMDB](https://www.servicenow.com/docs/access?context=c_CIRelationships&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
