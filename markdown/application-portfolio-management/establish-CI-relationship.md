...
1.  Create CI relationships or edit the existing relationships using [CI relationships in the CMDB](https://www.servicenow.com/docs/access?context=c_CIRelationships&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
