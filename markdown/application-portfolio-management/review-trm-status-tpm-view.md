...
4.  Click the production icon \(\) and view the production instances that are liable to risks in the current quarter or month.

5.  Display the life-cycle data sources of software models.

    -   To display the life-cycle data sources of a particular software model, click the expand icon \(\) of the software model.
    -   To display the life-cycle data sources of all software models related to a business application, click show all life-cycle data sources icon \(\).
