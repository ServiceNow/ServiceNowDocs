---
title: Application Backlog view
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/tpm-by-app-unified-backlog.html
release: yokohama
topic_type: concept
...
\[Omitted image "ByApplicationUnifiedBacklog.png"\] Alt text: By Application Backlog view of the timeline
...
-   **Demands**
    ...
    **Note:** For the timeline to display the epics, stories, and enhancements, each of these records should reference the business application attached to it. See [Associate epic to business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/reference-epic-business-app-unified-backlog-view.md) for more information.
...
-   **[Associate an epic to a business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/reference-epic-business-app-unified-backlog-view.md)**  
