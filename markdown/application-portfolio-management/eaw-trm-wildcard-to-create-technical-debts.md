---
title: Working with TRM lifecycle with wildcard
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/eaw-trm-wildcard-to-create-technical-debts.html
release: yokohama
topic_type: concept
...
# Working with TRM lifecycle with wildcard
...
**Note:** To define a version for a specific TRM product, see [Add a TRM product lifecycle](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-create-trm-prod-lifecycle-req.md).
...
[TRM Technical Debt calculation in Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-trm-technical-debt-calc.md)
