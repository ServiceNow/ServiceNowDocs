...
Starting with the Xanadu release, the legacy Technology Portfolio Management module is moved to the Enterprise Architecture Workspace. To learn more, see [Manage the Technology Portfolio Management \(TPM\) in Enterprise Architecture Workspace](eaw-concept/eaw-tpm.md).
...
[Configure script to customize risk calculation - Legacy](../task/configure-risk-bubble.md)

[Run scheduled job to generate risk values - Legacy](../task/run-scheduled-job-to-calculate-risks.md)
