...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/eaw-publish-a-draft-policy.html
release: xanadu
topic_type: task
...
5.  Select the Draft policies list view on the Data Manager policies page.
    ...
    \[Omitted image "cmdb-draft-policies.png"\] Alt text:
...
6.  Select the policy that you want to publish and then, on the policy form, select **Edit Policy**.
    ...
    \[Omitted image "cmdb-edit-policy.png"\] Alt text:
...
8.  Select Review in the left-side bar and then select **Publish Policy** to activate the policy.
    ...
    \[Omitted image "cmdb-publish-policy.png"\] Alt text:
