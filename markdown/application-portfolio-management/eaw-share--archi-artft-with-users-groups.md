...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-portfolio-management/eaw-share--archi-artft-with-users-groups.html
release: australia
topic_type: task
...
7.  In the **Share architectural artifact** pop-up window, fill in the form fields.
    ...
    For field information, see [Share architectural artifacts form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-portfolio-management/eaw-share-architectural-artifacts-form.md).
