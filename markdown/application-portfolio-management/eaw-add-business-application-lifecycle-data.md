...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/eaw-add-business-application-lifecycle-data.html
release: yokohama
topic_type: task
...
<table id="choicetable_ebc_3mq_fhc"><thead><tr><th align="left" id="d76862e113">

Bubble type

</th><th align="left" id="d76862e116">

Action

</th></tr></thead><tbody><tr><td id="d76862e122">
...
\[Omitted image "bubble-chart-grouped-add-lifecycle.png"\] Alt text: Add lifecycle data button highlighted for a grouped bubble.
    ...
    For a description of the field values, see [Application model life-cycle details form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-application-model-lifecycle-details-form.md).
