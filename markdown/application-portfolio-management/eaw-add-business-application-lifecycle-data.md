...
<table id="choicetable_ebc_3mq_fhc"><thead><tr><th align="left" id="d84971e111">

Bubble type

</th><th align="left" id="d84971e114">

Action

</th></tr></thead><tbody><tr><td id="d84971e120">
...
\[Omitted image "bubble-chart-grouped-add-lifecycle.png"\] Alt text: Add lifecycle data button highlighted for a grouped bubble.
    ...
    For a description of the field values, see [Application model life-cycle details form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-portfolio-management/eaw-application-model-lifecycle-details-form.md).
