...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/summarize-docs-genai-skill-ea.html
release: yokohama
topic_type: task
...
6.  In the **Artifact content** tab, select **Now Assist** drop-down menu and then use either of the following options.
    ...
    \[Omitted image "eaw-adr-doc-summarize.gif"\] Alt text: ADR Doc summarization in Enterprise Architecture Workspace
