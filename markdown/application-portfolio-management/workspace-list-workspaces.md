...
breadcrumb: [Exploring Enterprise Architecture Workspace, Configure, Enterprise Architecture \(formerly Application Portfolio Management\), Enterprise Architecture \(formerly Application Portfolio Management\)]
---
...
-   **[Workspace](https://www.servicenow.com/docs/access?context=workspace-landing-page&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)**
    ...
    Workspace acts as the default workspace available on the ServiceNow Platform and provides the foundation for the targeted workspaces ServiceNow offers.

-   **[Audit Workspace](https://www.servicenow.com/docs/access?context=audit-management-overview-ws&version=xanadu&pubname=xanadu-governance-risk-compliance&ft:locale=en-US)**
...
-   **[Cloud Discovery Workspace](https://www.servicenow.com/docs/access?context=cow-landing-page&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US)**
...
-   **[Compliance Workspace](https://www.servicenow.com/docs/access?context=grc-unified-compliance-workspace&version=xanadu&pubname=xanadu-governance-risk-compliance&ft:locale=en-US)**
...
-   **[Continuous Authorization and Monitoring](https://www.servicenow.com/docs/access?context=grc-cam-landing-page&version=xanadu&pubname=xanadu-governance-risk-compliance&ft:locale=en-US)**
...
-   **[Digital Portfolio Management Workspace](https://www.servicenow.com/docs/access?context=dpm-landing&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US)**
...
-   **[DEX Application &amp; Device Health](https://www.servicenow.com/docs/access?context=accessing-pages&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US)**
...
-   **[Platform Analytics Workspace](https://www.servicenow.com/docs/access?context=par-workspace&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)**
...
-   **[Vendor Management Workspace](https://www.servicenow.com/docs/access?context=vendor-management-workspace-landing-page&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US)**
