...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/indicator-form.html
release: zurich
...
Starting with the Xanadu release, the application indicators module is moved to the Enterprise Architecture Workspace. To learn more, see [Manage indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-configure-indicators.md). To view the updated indicator form fields, see [Create indicator form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-create-new-indicator-form.md).
 ...
 **Example: Monthly cost indicator scored quarterly**
 ...
 An indicator named **Monthly Infrastructure Cost** has a frequency of Monthly, with a **Target maximum** of $50,000 and a **Target minimum** of $10,000.

 -   **Check box selected, scoring period is Monthly \(frequency matches\):** The system applies the absolute values—$50,000 and $10,000—in the normalization formula.
-   **Check box selected, scoring period is Quarterly \(frequency does not match\):** The system ignores the absolute values and derives the target maximum and minimum from the actual application weights in the current scoring run.
-   **Check box cleared \(any scoring period\):** The system applies intelligent logic, comparing the defined target values with actual application weights and using whichever is more appropriate for each boundary.
 ...
 **Note:** If the collection frequency of the application indicator isn't greater than the frequency at which the data of the Performance Analytic indicator is generated, then the system displays an error message: `Frequency of the indicator must always be greater than or equal to the frequency of the datasource configuration indicator`. For more information, see [Collection of PA indicator score data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/pa-indicators-jobs.md).
