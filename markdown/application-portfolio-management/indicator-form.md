...
You can leverage the same feature by using the Enterprise Architecture Workspace. To learn more, see [Manage indicators](../concept/eaw-concept/eaw-configure-indicators.md). To view the updated indicator form fields, see [Create new indicator form](eaw-reference/eaw-create-new-indicator-form.md).
 ...
 **Note:** If the collection frequency of the application indicator isn’t greater than the frequency at which the data of the Performance Analytic indicator is generated, then the system displays an error message: `Frequency of the indicator must always be greater than or equal to the frequency of the datasource configuration indicator`. For more information, see [Collection of PA indicator score data](../concept/application-assessment.md#CollectionPAIndicators).
