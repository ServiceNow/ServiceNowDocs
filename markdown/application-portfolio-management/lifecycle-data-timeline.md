...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/lifecycle-data-timeline.html
release: zurich
topic_type: concept
...
As a SAM user or software model manager, you can [add the software product lifecycle](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-asset-management/record-terms-software-licenses.md) to the software product lifecycle table. This table holds the information of the software product, its lifecycle type \(internal or external\), full version, lifecycle phases, start date of the phase, and the risk.
