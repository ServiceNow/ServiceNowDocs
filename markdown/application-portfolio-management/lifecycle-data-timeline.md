...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/lifecycle-data-timeline.html
release: xanadu
topic_type: concept
...
To know more about the Date conditions and the lifecycle phases of the record, see [Date conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/date-conditions.md).
