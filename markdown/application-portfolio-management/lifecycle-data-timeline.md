...
As a SAM user or software model manager, you can [add the software product lifecycle](https://www.servicenow.com/docs/access?context=record-terms-software-licenses&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US) to the software product lifecycle table. This table holds the information of the software product, its lifecycle type \(internal or external\), full version, lifecycle phases, start date of the phase, and the risk.
