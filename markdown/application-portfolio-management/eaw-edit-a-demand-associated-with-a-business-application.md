...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/eaw-edit-a-demand-associated-with-a-business-application.html
release: xanadu
topic_type: task
...
4.  Select the expand row icon \(\[Omitted image "ExpandIcon.png"\] Alt text: Expand row icon.\) next to the business application that you want to edit the associated demand details for.

    A list of demands associated with that business application is displayed.

5.  Select the demand that you want to edit.
...
6.  On the Edit demand form, fill in the fields.

    For a description of the field values, see [Demand form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/eaw-edit-demand-form.md).

7.  Select **Update**.


**Parent Topic:**[List view of application rationalization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/eaw-list-view.md)
