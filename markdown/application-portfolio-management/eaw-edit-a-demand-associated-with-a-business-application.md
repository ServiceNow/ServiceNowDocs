...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/eaw-edit-a-demand-associated-with-a-business-application.html
release: yokohama
topic_type: task
...
# Edit a demand associated with a business application
...
3.  Select the expand row icon \(\[Omitted image "ExpandIcon.png"\] Alt text: Expand row icon.\) next to the business application that you want to edit the associated demand details for.
...
4.  Select the demand that you want to edit.
    ...
    **Note:** Select **Full details** to view more details regarding the demand.

5.  On the Edit demand form, fill in the fields.

    For a description of the field values, see [Demand form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-edit-demand-form.md).

6.  Select **Update**.


**Parent Topic:**[List view of application rationalization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-list-view.md)
