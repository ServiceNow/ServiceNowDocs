---
title: Exploring Enterprise Architecture \(formerly Application Portfolio Management\)
description: Learn about the features, functionality, and the business value that Enterprise Architecture \(formerly Application Portfolio Management\) provides.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/explore-apm.html
release: yokohama
topic_type: concept
...
-   Application Classification
    ...
    -   Provides additional attributes to classify applications in a new CI class, Business application, which extends the base Configuration Management Database \(CMDB\) configuration item.
        ...
        \[Omitted image "CIRelationships.png"\] Alt text: APM configuration items relationship
...
-   Reports and Dashboards
    ...
    -   Application Risk and Compliance Overview \(role required is sn\_grc.reader\)
