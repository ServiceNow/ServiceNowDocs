...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/add-business-process-or-capabilities.html
release: yokohama
topic_type: task
...
Starting with the Xanadu release, the legacy business processes module is moved to the Enterprise Architecture Workspace. To learn more, see [Manage business processes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-business-processes.md).
...
3.  Fill in the fields.
    ...
    For field information, see [Business Process Form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/business-process-form.md).

4.  Right-click the form header and select **Save**.

5.  If you want to add items to this business process, use the Related Items [CI relations formatter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_CIRelationsFormatterNG.md).

6.  Select **Submit** or **Update**.


**Parent Topic:**[Application classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/setup-appln-class-attrib.md)
...
[Add a strategy for managing applications]()
