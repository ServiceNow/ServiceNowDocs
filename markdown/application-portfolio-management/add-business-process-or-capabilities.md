---
title: Add or edit an application business process - Legacy
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/add-business-process-or-capabilities.html
release: zurich
topic_type: task
last_updated: "2025-07-31"
reading_time_minutes: 3
breadcrumb: [Application classification - Legacy, Configure - Legacy, Enterprise Architecture \(formerly Application Portfolio Management\), Enterprise Architecture \(formerly Application Portfolio Management\)]
---

# Add or edit an application business process - Legacy
...
Starting with the Xanadu release, the legacy business processes module is moved to the Enterprise Architecture Workspace. To learn more, see [Exploring business processes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/eaw-business-processes.md).
...
3.  Fill in the fields.
    ...
    For field information, see [Business Process Form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/business-process-form.md).

4.  Right-click the form header and select **Save**.

5.  If you want to add items to this business process, use the Related Items [CI relations formatter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/c_CIRelationsFormatterNG.md).

6.  Select **Submit** or **Update**.


**Parent Topic:**[Application classification - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/setup-appln-class-attrib.md)

**Related topics**  


[Add or edit an application category group - Legacy]()

[Add or edit an application category - Legacy]()

[Add or edit an application family - Legacy]()

[Create an application portfolio - Legacy]()

[Add a strategy for managing applications - Legacy]()
