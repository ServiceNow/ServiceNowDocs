...
The list view of application rationalization enables you to view all available applications based on your scoring profile, in your enterprise architecture landscape. For details, see [Add or edit a scoring profile](../../task/eaw-task/eaw-create-scoring-profile.md) and [Regenerate scoring profile indicator scores on-demand in Enterprise Architecture Workspace](../../task/eaw-task/eaw-regenerate-scoring-profile-indicator-scores-in-eaw.md).
