---
title: Associate technology models to an application service
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/associate-application-service-software-models.html
release: yokohama
topic_type: task
...
# Associate technology models to an application service
...
Starting with the Xanadu release, the Technology Lifecycle Management module is moved to the Enterprise Architecture Workspace. To learn more, see [Managing the Technology Lifecycle Management \(TLM\) in Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-tpm.md).
...
10. Select the check box adjacent to the software model and click **Associate Software Models** action from the **Action on selected rows** list to associate the software model to the application service.
    ...
    For information about the status of the software models, see [Status of the Software models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/status-software-models.md).
