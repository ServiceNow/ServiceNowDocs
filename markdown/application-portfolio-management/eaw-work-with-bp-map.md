...
-   Add BPMN shapes to the canvas and connect them with relationship lines. Change the line type using the drop-down that appears directly on the connector.
...
**Note:** Canvas controls, including shape context menus and the modify business process details icon, are accessible via keyboard. Use the **Tab** key to navigate to shapes and their controls without a mouse.
...
-   **[Modify BPMN diagram details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-portfolio-management/eaw-modeling-modify-bpmn.md)**  
