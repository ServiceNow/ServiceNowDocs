...
4.  Select the expand row icon \(![Expand row icon.](../../image/ExpandIcon.png)\) next to the business application that you want to edit the associated project details for.
