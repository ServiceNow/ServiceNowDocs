...
![The figure shows the step-by-step plan to implement the program.](../image/ProgramNavig.png "Program navigation page")
...
-   **Step 2: Identify Opportunities**
    ...
    ![The Group Analysis page shows the assessment period, filter applications, and application categories.](../image/ProgramNavigStep2.png "Group Analysis page")
    ...
    -   **Bulb icon \(![The bulb icon](../image/BulbIcon.png)\)**
