---
title: Guided plan to execute a program
description: After you create a program, you can use the guided plan to formulate steps in executing the program that you have created.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/program-guided-plan.html
release: yokohama
topic_type: concept
...
\[Omitted image "ProgramNavig.png"\] Alt text: The figure shows the step-by-step plan to implement the program.
...
-   **Step 2: Identify Opportunities**
    ...
    \[Omitted image "ProgramNavigStep2.png"\] Alt text: The Group Analysis page shows the assessment period, filter applications, and application categories.
    ...
    -   **Bulb icon \(\[Omitted image "BulbIcon.png"\] Alt text: The bulb icon\)**
