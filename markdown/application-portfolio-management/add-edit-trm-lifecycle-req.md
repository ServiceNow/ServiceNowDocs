...
You can leverage the same features by using the Enterprise Architecture Workspace. To learn more, see [Add a TRM product lifecycle](eaw-task/eaw-create-trm-prod-lifecycle-req.md).
