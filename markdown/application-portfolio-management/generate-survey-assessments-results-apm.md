...
breadcrumb: [Create or edit an indicator to assess an application, Using Enterprise Architecture \(formerly Application Portfolio Management\), Enterprise Architecture \(formerly Application Portfolio Management\), Enterprise Architecture \(formerly Application Portfolio Management\)]
---
...
To know more about indicators, see [Manage indicators](../concept/eaw-concept/eaw-configure-indicators.md).
...
10. Select **OK** to confirm in the Send Assessment dialog box.
    ...
    For more information, see [Take a survey](https://www.servicenow.com/docs/access?context=t_TakeASurvey&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
...
12. Select the **Metric Category Results** tab to view the weight, rating, and normalized value of each business application that was assessed by the user or the user group.
    ...
    For more information, see [View an assessment category result](https://www.servicenow.com/docs/access?context=t_ViewACategoryResult&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US) to know how the assessment results are calculated.
