...
10. Click **OK** to confirm in the Send Assessment dialog box.
    ...
    For more information, see [Take a survey](https://www.servicenow.com/docs/access?context=t_TakeASurvey&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
12. Click the **Metric Category Results** tab to view the weight, rating, and normalized value of each business application that was assessed by the user or the user group.
    ...
    For more information, see [View an assessment category result](https://www.servicenow.com/docs/access?context=t_ViewACategoryResult&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) to know how the assessment results are calculated.
