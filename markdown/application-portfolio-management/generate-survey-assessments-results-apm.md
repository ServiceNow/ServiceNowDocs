---
title: Generate survey assessments and view results within Enterprise Architecture
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/generate-survey-assessments-results-apm.html
release: xanadu
topic_type: task
...
# Generate survey assessments and view results within Enterprise Architecture
...
Starting with the Xanadu release, the application indicators module is moved to the Enterprise Architecture Workspace. To learn more, see [Regenerate capability indicator scores on-demand in Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/eaw-regenerate-capability-indicator-scores-in-eaw.md) and [Regenerate application indicator scores on-demand in Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/eaw-regenerate-indicator-score.md).

To know more about indicators, see [Configure indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/eaw-configure-indicators.md).
...
4.  To filter the business applications that should be assessed, set your conditions in the **Field**, **Operator**, and **Value** fields of the condition builder in the Generate Assessment UI that opens up.
    ...
    \[Omitted image "APMAssessmentIntegration.png"\] Alt text: UI to set filter conditions on applications and select users to send the assessment.
...
5.  To add dependent condition, click **AND** or **OR** next to the condition.

6.  To add a top-level condition or multiple filter criteria, click the **New Criteria** button.

7.  To clear existing filter conditions and set a new condition, click the **Clear All** button.
...
9.  Click **Send Assessments**.

10. Click **OK** to confirm in the Send Assessment dialog box.
...
11. Click the **Assessments Instances** tab to view the instances of assessments that have been created, the total number of assessments that have been sent out to users who fit in the filter criteria, and the status of the assessment instances.

    Each occurrence of a questionnaire assigned to one user is an assessments instance.

    **Note:**

    Indicator score and the corresponding application score are calculated only when all the users in the assessment group have completed the assessment.
...
**Parent Topic:**[Create or edit an indicator to assess an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/create-application-indicators.md)
