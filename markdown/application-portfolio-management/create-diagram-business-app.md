...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/create-diagram-business-app.html
release: yokohama
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    For field information, see [Create diagram form for business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/create-lucidchart-diagram-form.md).
