...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/setup-appln-class-attrib.html
release: xanadu
topic_type: concept
...
To check out an application classification example, see [Application Classification Example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/application-classification-example.md).

-   **[Add or edit an application category group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/application-category-groups.md)**  
...
-   **[Add or edit an application category](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/add-application-categories.md)**  
...
-   **[Add or edit an application family](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/add-application-families.md)**  
...
-   **[Add or edit an application business process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/add-business-process-or-capabilities.md)**  
...
-   **[Create an application portfolio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/add-portfolios.md)**  
...
-   **[Add a strategy for managing applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/add-idea-actions.md)**  
