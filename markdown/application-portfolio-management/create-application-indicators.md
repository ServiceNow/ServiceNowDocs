...
You can leverage the same feature by using the Enterprise Architecture Workspace. To learn more, see [Manage indicators](../concept/eaw-concept/eaw-configure-indicators.md).
...
Use the [preconfigured indicators](../concept/application-assessment.md#) to assess the applications based on cost, quality, and risk.
