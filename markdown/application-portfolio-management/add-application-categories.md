...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-portfolio-management/add-application-categories.html
release: yokohama
topic_type: task
...
Starting with the Xanadu release, the legacy application categories module is moved to the Enterprise Architecture Workspace. To learn more, see [Configure application categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-portfolio-management/eaw-configure-application-categories.md).
