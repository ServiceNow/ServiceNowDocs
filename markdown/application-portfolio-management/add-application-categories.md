...
Starting with the Xanadu release, the legacy application categories module is moved to the Enterprise Architecture Workspace. To learn more, see [Configure application categories](../concept/eaw-concept/eaw-configure-application-categories.md).
