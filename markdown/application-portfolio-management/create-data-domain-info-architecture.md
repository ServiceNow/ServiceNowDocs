...
Starting with the Xanadu release, the data domains module is moved to the Enterprise Architecture Workspace. To learn more, see [Exploring data domains](../concept/eaw-concept/eaw-data-domains.md) and [Manage data domains](../concept/eaw-concept/eaw-manage-data-domains.md).
