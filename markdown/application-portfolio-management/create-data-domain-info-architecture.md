...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/create-data-domain-info-architecture.html
release: xanadu
topic_type: task
...
Starting with the Xanadu release, the data domains module is moved to the Enterprise Architecture Workspace. To learn more, see [Manage data domains](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/eaw-data-domains.md).
...
3.  On the form, fill in the fields.
    ...
    For field information, see [Data Domain form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/data-domain-form.md).
