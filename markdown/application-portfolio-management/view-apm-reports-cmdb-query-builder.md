...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/view-apm-reports-cmdb-query-builder.html
release: zurich
topic_type: task
...
[Run scheduled jobs for CMDB Query Builder reports - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/scheduled-job-cmdb-query-builder.md)
