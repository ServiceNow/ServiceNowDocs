...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-portfolio-management/index-archive-pub-trm-cat.html
release: zurich
topic_type: task
last_updated: "2026-04-17"
reading_time_minutes: 1
breadcrumb: [AI Search on the TRM catalog, Working with the publishing center, Manage, Enterprise Architecture Workspace, Enterprise Architecture \(formerly Application Portfolio Management\)]
---
...
-   Install the Now Assist for EA plugin. For instructions, see [Configure ServiceNow Otto for Enterprise Architecture \(EA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/configure-now-assist-ea.md).
...
**Parent Topic:**[AI Search on the TRM catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-portfolio-management/ai-search-trm-cat.md)
