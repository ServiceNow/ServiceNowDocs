...
3.  Select **here** to update the property details.![System property screen with the here hyperlink highlighted.](../../image/eaw-image/sys-prop-incl-cmdb-table.png)
...
[Run a scheduled job to generate TPM lifecycle data - Legacy](../run-scheduled-job-update-tpm-data.md)

[Schedule a job to generate TPM lifecycle data - Legacy](../schedule-job-generate-tpm-data.md)
