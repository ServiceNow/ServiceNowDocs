...
Portfolio TCO**Note:** For information on TCO, see [Manage application total cost of ownership \(TCO\)](../../../product/application-portfolio-management/concept/eaw-concept/eaw-manage-application-tco.md).
