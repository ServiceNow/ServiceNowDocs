...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-portfolio-management/eaw-add-or-edit-a-value-stream.html
release: xanadu
topic_type: task
...
6.  On the form, fill in the fields.
    ...
    For field information, see [Create new value stream form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-portfolio-management/eaw-create-new-value-stream-form.md).
