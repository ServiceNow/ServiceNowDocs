---
title: Request a TRM product lifecycle in Enterprise Architecture Workspace
description: Submit a request to add one or more lifecycle records to an existing TRM product.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-portfolio-management/eaw-request-a-trm-product-lifecycle.html
release: brazil
topic_type: task
...
# Request a TRM product lifecycle in Enterprise Architecture Workspace
...
3.  In the **TRM catalog** tab, select the more actions icon \[Omitted image "trm-more-actions-icon.png"\] Alt text: next to **Request TRM product**, then select **Request TRM product lifecycles**.

4.  In the **TRM product** field, select the existing product to add lifecycles to.

5.  In the **TRM product lifecycles** section, select **Add version and edition** for a software product or **Add model** for a hardware product, then fill in the lifecycle fields.
    ...
    **Note:**
    ...
    For a description of the field values, see [Request TRM product lifecycle form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-portfolio-management/eaw-create-trm-prod-lifecycle-req-form.md).
...
A confirmation message appears with the request number. The request is routed to an Enterprise Architect for approval. After approval, the lifecycle records are created and linked to the selected product.
...
[Request TRM product lifecycle form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-portfolio-management/eaw-create-trm-prod-lifecycle-req-form.md)
