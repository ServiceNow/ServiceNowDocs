...
-   **[Use capability map for planning](../task/view-capability-based-planning.md)**  
...
-   **[Create or edit an artifact category](../task/create-artifact-category.md)**  
...
-   **[Download an artifact version](../task/download-artifact-version.md)**  
Download an approved artifact version to view the architectural diagram in it.
-   **[Request approval for an artifact version](../task/request-approval.md)**  
...
-   **[Create a Lucid diagram for a business capability](../task/create-diagram-business-cap.md)**  
...
-   **[Configure the business application form for risk management](../../grc-application-risk-assessment/task/configure-related-lists-risk.md)**  
...
-   **[Respond to a risk assessment questionnaire](../../grc-application-risk-assessment/task/take-assesment-risk.md)**  
Respond to a risk questionnaire to provide risk-related information for your business application to a risk manager.
-   **[Take the control attestation survey](../../grc-application-risk-assessment/task/take-assessment-controls.md)**  
...
-   **[Visualize Enterprise Architecture reports using CMDB Query Builder](../task/view-apm-reports-cmdb-query-builder.md)**  
...
-   **[Export data to Microsoft PowerPoint](../task/export-apm-data-ppt.md)**  
