...
-   **[Create business capability and relate the capability with an application - Legacy](../task/create-a-business-capability.md)**  
...
-   **[Use capability map for planning - Legacy](../task/view-capability-based-planning.md)**  
...
-   **[View technology risks in timeline - Legacy](../task/view-technology-risks-in-timeline.md)**  
...
-   **[Relate business application to application service using CI relationship editor - Legacy](../task/relate-business-application-to-business-service.md)**  
...
-   **[Associate an application service to a software model - Legacy](../task/associate-business-service-to-software-model.md)**  
...
-   **[Create a risk parameter - Legacy](../task/create-risk-parameters.md)**  
...
-   **[Create or edit an architectural artifact - Legacy](../task/create-edit-artifacts.md)**  
...
-   **[Create or edit an artifact category - Legacy](../task/create-artifact-category.md)**  
...
-   **[Create an artifact version - Legacy](../task/create-artifact-version.md)**  
...
-   **[Download an artifact version - Legacy](../task/download-artifact-version.md)**  
Download an approved artifact version to view the architectural diagram in it.
-   **[Request approval for an artifact version - Legacy](../task/request-approval.md)**  
...
-   **[Approve or reject an artifact version request - Legacy](../task/approve-reject-artifact-request.md)**  
...
-   **[Approve architecture review requests - Legacy](../task/approve-arb-requests.md)**  
You can approve an architecture review request if you are part of the Enterprise Architect Group.
-   **[Create a diagram for a business application - Legacy](../task/create-diagram-business-app.md)**  
...
-   **[Create a Lucid diagram for a business capability - Legacy](../task/create-diagram-business-cap.md)**  
...
-   **[Create or edit an indicator to assess an application - Legacy](../task/create-application-indicators.md)**  
...
-   **[Create an application score profile and attach profile indicators - Legacy](../task/create-an-appln-score-profile.md)**  
...
-   **[Analyze application scores in a bubble chart - Legacy](../task/strategies-using-bubble-charts.md)**  
...
-   **[Monitor performance, costs, and workloads in Application 360 - Legacy](../task/applications-360-dashboard.md)**  
...
-   **[Assess the performance of applications in the dashboard - Legacy](../task/use-appln-assessment-dashboard.md)**  
...
-   **[Create a demand towards achievement of goal - Legacy](../task/create-an-idea.md)**  
...
-   **[Create a program for an application goal - Legacy](../task/create-a-program.md)**  
...
-   **[Create a guided plan to execute a program - Legacy](../task/create-a-guided-program.md)**  
...
-   **[Configure the business application form for risk management - Legacy](../../grc-application-risk-assessment/task/configure-related-lists-risk.md)**  
...
-   **[Respond to a risk assessment questionnaire - Legacy](../../grc-application-risk-assessment/task/take-assesment-risk.md)**  
Respond to a risk questionnaire to provide risk-related information for your business application to a risk manager.
-   **[Take the control attestation survey - Legacy](../../grc-application-risk-assessment/task/take-assessment-controls.md)**  
...
-   **[Visualize Enterprise Architecture reports using CMDB Query Builder - Legacy](../task/view-apm-reports-cmdb-query-builder.md)**  
