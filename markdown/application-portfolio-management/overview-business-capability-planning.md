...
Starting with the Xanadu release, the business capability module has been deprecated from Enterprise Architecture \(formerly Application Portfolio Management\). However, if you’re an existing user of Enterprise Architecture \(formerly Application Portfolio Management\), you can still use the business capability module. If you’re a new activation user, the business capability module isn’t available.
...
Use the [capability map](../task/view-capability-based-planning.md) for planning investments in applications.
