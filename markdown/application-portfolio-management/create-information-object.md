...
Starting with the Xanadu release, the legacy information objects module is moved to the Enterprise Architecture Workspace. To learn more, see [Exploring information objects](../concept/eaw-concept/eaw-information-objects.md).
