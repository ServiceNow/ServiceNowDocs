...
4.  Fill in the fields on the form, as appropriate.
    ...
    **Note:** Some request forms do not contain every field described here. For more information, see [Forms](https://www.servicenow.com/docs/access?context=c_UsingForms&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
