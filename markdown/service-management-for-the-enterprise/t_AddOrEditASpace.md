...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/service-management-for-the-enterprise/t\_AddOrEditASpace.html
release: zurich
topic_type: task
 ...
 **Note:** The **Area unit** assigned to all spaces must be consistent for the rollup calculations to work properly. See [Space roll up calculations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/service-management-for-the-enterprise/c_SpaceRollupCalculations.md).
...
Select this check box if the space can be occupied. See [Space roll up calculations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/service-management-for-the-enterprise/c_SpaceRollupCalculations.md).
