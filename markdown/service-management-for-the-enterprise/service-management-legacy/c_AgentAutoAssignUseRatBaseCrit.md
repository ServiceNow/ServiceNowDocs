...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/service-management-for-the-enterprise/service-management-legacy/c\_AgentAutoAssignUseRatBaseCrit.html
release: xanadu
...
These values help you prioritize which auto-assignment selection criteria is more important to your organization. The priority values should be \[1, 10\] and they are factored between 1 and 0. That is, 10 is a factor of 1, 5 is a factor of 0.5, and so on. For an example of how the weighting properties affect agent ratings, see [Agent auto assignment using multiple selection criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/service-management-for-the-enterprise/service-management-legacy/c_AgAtAssgmtMlt.md).

-   **[Agent auto assignment using location](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/service-management-for-the-enterprise/service-management-legacy/c_AgentAutoAssignmentUsingLocation.md)**  
Agents can be auto assigned based on the location defined in their user record and the location of the tasks.
-   **[Agent auto assignment using skills](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/service-management-for-the-enterprise/service-management-legacy/c_AgentAutoAssignmentUsingSkills.md)**  
...
-   **[Agent auto assignment using time zones](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/service-management-for-the-enterprise/service-management-legacy/c_AgAtAssgnZones.md)**  
Agents can be auto assigned based on the time zone defined in their user records and the time zone of the tasks.

**Parent Topic:**[Agent auto assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/service-management-for-the-enterprise/service-management-legacy/c_AgentAutoAssignment.md)
