...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/service-management-for-the-enterprise/service-management-legacy/t\_CreateFacReqWorkbench.html
release: yokohama
...
1.  Perform one of the following options.
    ...
    |Choice|Action|
    |------|------|
    |**To search for a space location**|[Find a space on the floor plan.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/service-management-for-the-enterprise/service-management-legacy/t_FindASpaceOrUser.md)|
...
2.  On the Spaces tab, under the room information details and **Related Links** section, click **Create Facilities Request**.
    ...
    **Note:** You can also right-click the space link and select **Create Facilities Request**.
    ...
    \[Omitted image "CreateFacReq.png"\] Alt text: Create a facilities request like trash removal.
...
**Parent Topic:**[Facilities Floor Plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/service-management-for-the-enterprise/service-management-legacy/c_FacilitiesFloorPlan.md)
