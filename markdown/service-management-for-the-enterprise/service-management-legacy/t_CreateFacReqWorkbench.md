...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/service-management-for-the-enterprise/service-management-legacy/t\_CreateFacReqWorkbench.html
release: xanadu
...
1.  Perform one of the following options.
    ...
    |Choice|Action|
    |------|------|
    |**To search for a space location**|[Find a space on the floor plan.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/service-management-for-the-enterprise/service-management-legacy/t_FindASpaceOrUser.md)|
...
**Parent Topic:**[Facilities Floor Plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/service-management-for-the-enterprise/service-management-legacy/c_FacilitiesFloorPlan.md)
