...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/it-remediation-workspace/vr-ws-split-task.html
release: xanadu
...
Starting with v19.0 of Vulnerability Response, you can split tasks for test result groups.
...
Starting with version 18.0, you can split tasks for application vulnerability items and container vulnerability items.
