---
title: Use the email digest in the Vulnerability Response Workspaces
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/it-remediation-workspace/vr-ws-email-digest.html
release: xanadu
...
Role required: sn\_vul.remediation\_owner, sn\_vul.app\_security\_champion, sn\_vul\_container.remediation\_owner, or sn\_vulc.remediation\_owner
...
See [Set up email notifications in the Vulnerability Response Workspaces](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/vulnerability-manager-workspace/vr-ws-email-notifications.md) for more information about how to configure this feature.
...
1.  Navigate to your email, locate a notification, and click to open it.

    The notification is displayed with information about your work status.
