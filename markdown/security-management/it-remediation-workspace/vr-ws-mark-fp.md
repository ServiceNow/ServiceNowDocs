...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/it-remediation-workspace/vr-ws-mark-fp.html
release: yokohama
...
For information on how to request a false positive for a set of test results, see [Request a false positive for a set of test results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/it-remediation-workspace/vmws-tr-false-positive.md).

## Procedure

1.  Navigate to **Workspaces** &gt; **IT Remediation Workspace**.

2.  Select List icon \(\[Omitted image "listview-icon.png"\] Alt text: List icon\).
...
[False Positive overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/vr-false-positive.md)
