...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/it-remediation-workspace/itr-ws-list-page.html
release: zurich
...
-   **My Lists** tab: Displays any list that you’ve renamed from the List tab and any list that you create.
    ...
    You can also create your own list of records. For more information, see [Create a list in the IT Remediation Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/it-remediation-workspace/vr-ws-IT-list-view.md).
...
[Use the List view in the Vulnerability Manager Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/vulnerability-manager-workspace/vr-ws-vmws-list-view-duplicate.md)
