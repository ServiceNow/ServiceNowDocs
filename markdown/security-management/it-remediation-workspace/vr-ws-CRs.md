...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/it-remediation-workspace/vr-ws-CRs.html
release: xanadu
...
5.  To create a new change request, in the modal that displays, fill in the fields.
    ...
    For information on the form fields, see [Create change request form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/it-remediation-workspace/itr-ws-create-cr-fields.md).
