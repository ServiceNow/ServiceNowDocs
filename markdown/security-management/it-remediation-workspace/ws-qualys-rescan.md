...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/it-remediation-workspace/ws-qualys-rescan.html
release: yokohama
...
To initiate a rescan for the Qualys product from the classic environment, see [Initiate rescan for the Qualys Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/advanced-modifications.md).
...
<table id="choicetable_itr_bmq_yqb"><thead><tr><th align="left" id="d162627e256">

Option

</th><th align="left" id="d162627e259">

Description

</th></tr></thead><tbody><tr><td id="d162627e265">
