...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/it-remediation-workspace/ws-qualys-rescan.html
release: xanadu
...
To initiate a rescan for the Qualys product from the classic environment, see [Initiate rescan for the Qualys Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/vulnerability-response/advanced-modifications.md).
...
<table id="choicetable_itr_bmq_yqb"><thead><tr><th align="left" id="d157917e260">

Option

</th><th align="left" id="d157917e263">

Description

</th></tr></thead><tbody><tr><td id="d157917e269">
