...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/it-remediation-workspace/ws-qualys-rescan.html
release: australia
...
To initiate a rescan for the Qualys product from the classic environment, see [Initiate rescan for the Qualys Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/vulnerability-response/advanced-modifications.md).
...
<table id="choicetable_itr_bmq_yqb"><thead><tr><th align="left" id="d183789e256">

Option

</th><th align="left" id="d183789e259">

Description

</th></tr></thead><tbody><tr><td id="d183789e265">
