...
4.  From either the Home page or the List view, click a remediation task to open it.
    ...
    The details tab includes information in the form header at the top that relates to the nature of the task, for example, `Vulnerabilities on XYZ Servers (San Diego)`. Under the form header, values for the State, Risk rating, Assignment group, Remediation status, and the percent of active records you've remediated are displayed.

5.  Refer to the following table for the UI actions you can perform from the remediation task record.

<table id="choicetable_rrb_qt4_1qb"><thead><tr><th align="left" id="d39737e159">

Task

</th><th align="left" id="d39737e162">

Description

</th></tr></thead><tbody><tr><td id="d39737e168">
