...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/it-remediation-workspace/vr-ws-remed-task.html
release: yokohama
...
breadcrumb: [Create a remediation task manually in the IT Remediation Workspace, Using the IT Remediation Workspace, IT Remediation Workspace, Vulnerability Response Workspaces, Unified Security Exposure Management, Security Operations]
---
...
3.  Alternatively, you can click the List icon in the upper left on the home page to see all the remediation tasks \(VULs, AVULs, CVULs and CRGs\) and records \(VITs, AVITs, CVITs and TRs\) assigned to you and your groups.
    ...
    For more information about how to use the list view, see [Create a list in the IT Remediation Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/it-remediation-workspace/vr-ws-IT-list-view.md).
...
<table id="choicetable_rrb_qt4_1qb"><thead><tr><th align="left" id="d308178e145">

Task

</th><th align="left" id="d308178e148">

Description

</th></tr></thead><tbody><tr><td id="d308178e154">
