...
![Vulnerable items grouped by business impact and risk score, assigned to support teams](../../vulnerability-response/image/VGR-BusImpactRiskScore-v10.png "Remediation task rule example")
...
![Grouped by high impact vulnerability](../../vulnerability-response/image/HighImpactVI-CI-assign_v10.png)
...
![Group by high risk vulnerabilities and external-facing CIs in a German data center](../../vulnerability-response/image/VGR-GermanDataCenter-v10.png)

**Parent Topic:**[Unified Security Exposure Management reference](../../security-exposure-management-workspace/concept/unified-security-exposure-management-reference.md)
