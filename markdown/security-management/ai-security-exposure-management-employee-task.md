...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/ai-security-exposure-management-employee-task.html
release: zurich
topic_type: task
...
**Parent Topic:**[Using AI remediation workflows with Employee Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/ai-security-exposure-employee-workflow.md)
