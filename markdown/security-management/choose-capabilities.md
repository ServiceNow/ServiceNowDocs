...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/choose-capabilities.html
release: australia
topic_type: task
...
1.  From the **Capabilities** list, select all the capabilities supported by the integration.

    The following is the list of available capabilities:
