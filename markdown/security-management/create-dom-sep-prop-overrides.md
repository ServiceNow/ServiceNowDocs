...
Requires that [Domain Support - Domain Extensions](https://www.servicenow.com/docs/access?context=list-of-plugins&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) be activated. You can also learn about the [Domain Override Viewer](https://www.servicenow.com/docs/access?context=domain-sep-override-viewer&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
