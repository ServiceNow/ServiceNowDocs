...
Requires that [Domain Support - Domain Extensions](https://www.servicenow.com/docs/access?context=list-of-plugins&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) be activated. You can also learn about the [Domain Override Viewer](https://www.servicenow.com/docs/access?context=domain-sep-override-viewer&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
