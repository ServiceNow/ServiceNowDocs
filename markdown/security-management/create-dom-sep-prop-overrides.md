...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/create-dom-sep-prop-overrides.html
release: zurich
topic_type: task
...
Requires that [Domain Support - Domain Extensions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/list-of-plugins.md) be activated. You can also learn about the [Domain Override Viewer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/domain-sep-override-viewer.md).
