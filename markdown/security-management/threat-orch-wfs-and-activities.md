...
-   [Populate lookup with observable activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/threat-orch-wfs-and-activities.md)
-   [Perform IoC Lookup activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/threat-orch-wfs-and-activities.md)
-   Wait for lookup \(core activity\)
-   [Update observable with lookup result activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/threat-orch-wfs-and-activities.md)
