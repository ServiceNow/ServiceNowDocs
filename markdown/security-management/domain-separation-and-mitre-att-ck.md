...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/domain-separation-and-mitre-att-ck.html
release: australia
...
-   Replicate the following for every domain:
    -   [TAXII Collections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/domain-separation-and-mitre-att-ck.md)
