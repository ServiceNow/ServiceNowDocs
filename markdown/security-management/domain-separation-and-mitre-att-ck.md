...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/domain-separation-and-mitre-att-ck.html
release: zurich
...
-   Replicate the following for every domain:
    -   [TAXII Collections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/domain-separation-and-mitre-att-ck.md)
