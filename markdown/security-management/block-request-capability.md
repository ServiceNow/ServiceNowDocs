...
The Block Request capability has a flow, [Security Operations Integration - Block Request Flow](../../security-operations-integrations/task/secops-integration-block-request-workflow.md), that executes the request to block. This flow accepts a list of observables, finds any implementing capabilities, and executes the request based on the configured flow.
