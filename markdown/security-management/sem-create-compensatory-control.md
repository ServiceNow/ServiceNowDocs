...
Starting from v21.0 of Vulnerability Response, you can associate compensating controls with CVEs or TPEs after adding a compensating controls to the library. For more information on how to associate compensating controls, see [Associate compensating controls with CVEs or TPEs for risk change requests](../../vr-vulnerability-manager-workspace/task/associate-controls-cve-risk-reduction.md).
...
[Disable or enable risk change for a CVE or TPE](../../vr-vulnerability-manager-workspace/task/disable-risk-reduction.md)
