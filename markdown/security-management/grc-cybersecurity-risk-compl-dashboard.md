...
You can navigate to the Risk and compliance dashboard from the single unified [Cybersecurity Executive Dashboard](vr-unified-CISO-dashboard.md) to view the risk and compliance metrics of Governance, Risk, and Compliance applications.
...
**Important:** You must have primary access to the [Cybersecurity Executive Dashboard](vr-unified-CISO-dashboard.md) to activate the Cybersecurity and risk functional plugin with which you can access the Risk and compliance dashboard.
...
2.  Select **Risk and compliance** label from the list on the left of the dashboard.
    ...
    ![Unified Cybersecurity Executive Dashboard for risk, and compliance metrics.](../image/cybersecurity-executive-dashboard.png "Unified Cybersecurity Executive Dashboard for risk and compliance metrics")

3.  To visualize your data, and to view the reports and solutions available on the dashboard that is designed for the user, select the [Explore Risk and Compliance Dashboard label](grc-ced-risk-compliance-db-reports.md).
