...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/sem-updating-class-cloud-resource-hybrid-assets.html
release: yokohama
topic_type: concept
...
**Parent Topic:**[Creating CIs using the Identification and Reconciliation engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/sem-ci-creation-using-IRE.md)
