...
-   **[Define an observable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/t_AddObservable.md)**  
Observables are retrieved from the vendor server as STIX data. However, you can create observables, as needed.
-   **[Add a related IoC to an observable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/t_AddIoCToObserv.md)**  
In addition to importing observables as STIX data, you can add related observables to an IoC manually.
-   **[Add associated tasks to an observable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/t_AddAssociatedTasksToObservable.md)**  
...
-   **[Add a related observable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/t_AddRelatedObservable.md)**  
In addition to importing observables as STIX data, you can add related observables manually.
-   **[Load more IoC data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/t_LoadAdditionalIoCData.md)**  
...
-   **[Identify observable sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/t_IdentifyObservbleSources.md)**  
...
-   **[Perform threat enrichment on observables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/perform-enrich-on-observs.md)**  
