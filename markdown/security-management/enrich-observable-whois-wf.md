...
Activities specific to this integration are described here. For more information on other activities, see [Common Security Operations integration flows and orchestration Flow Actions](../../../security-operations-common/concept/common-wf-activities.md).
