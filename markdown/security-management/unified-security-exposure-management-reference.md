...
-   **[Security Exposure Management Workspace remediation task rule examples](../../security-exposure-management-administration/reference/sem-rem-target-rules-examples.md)**  
...
-   **[Re-evaluating the exceptions for selected records in the Security Exposure Management Workspace](../reference/sem-exception-rules-scenarios.md)**  
