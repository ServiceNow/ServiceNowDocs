---
title: Threat Intelligence administration
description: The Threat Intelligence base system is ready to use on activation. You can add records to certain modules in the Administration application menu, but most are already populated with industry-standard information.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/r\_ThreatRespAdmin.html
release: yokohama
...
|-----------|-----------|
|Properties|Threat Intelligence [properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/c_GetStartedWithThreatIntel.md) allow you to control how different aspects of the system function, including the setting of API keys.|
...
|Notifications|This module is used for creating [email notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_CreateANotification.md). This involves specifying when they are sent, who receives them, and what they contain.|
