...
3.  Fill in the fields, as needed.
    ...
    |Condition|The [condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US) fields display only if you did not select the **Use filter group** check box.|
...
[Attach a script file to a file synchronized MID Server](https://www.servicenow.com/docs/access?context=mid-server-script-attach&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)
