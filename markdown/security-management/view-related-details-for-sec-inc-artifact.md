---
title: View related details for a security incident artifact
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/view-related-details-for-sec-inc-artifact.html
release: yokohama
topic_type: task
...
1.  Open a case that contains security incident artifacts.

2.  Click the **Incidents** tab.

3.  Click the Additional Details icon for the security incident you want to view related details for.

    \[Omitted image "related-details-sec-inc.png"\] Alt text: View related details for a security incident
...
**Parent Topic:**[Related details for case artifacts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/related-details-for-case-artifacts.md)
