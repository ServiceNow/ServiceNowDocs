...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/ai-security-exposure-home.html
release: australia
topic_type: concept
...
Access the entire attack surface across various types of findings on the AI Security Exposure Management dashboard with the AI Exposures module. AI Security Exposure Management is a dedicated module of the Security Exposure Management workspace.

## AI Exposures overview

See [Exploring AI Security Exposure Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/exploring-ai-security-exposure.md) for an overview and more information about the application.
...
There are three categories of AI exposures that are displayed on the AI Security Exposure Management dashboard.
...
|-------------|-----------|
|Open findings|Total findings still in an open state across vulnerabilities, validation, and posture combined.|
...
|Overdue findings|Findings already past their due date. A value of 0 means the queue is reflecting good remediation timing.|
...
-   **Findings**
    ...
    -   By top 5 categories - Vulnerability types detected, for example, Unapproved, Knowledge Base Poisoning, Obfuscation vulnerability, Unauthorized, etc. Each bar represents a class of unsafe model file behavior.
    -   By top 5 MITRE ATLAS techniques - \(Adversarial Threat Landscape for Artificial-Intelligence Systems\) is a knowledge base of tactics and techniques attackers use against AI/ML systems — the AI-specific cousin of MITRE ATT&amp;CK. Findings are tagged to ATLAS techniques so an analyst can understand the adversarial behavior behind a finding, not just the symptom.
...
-   **Posture metrics**
    ...
    **Note:**
    ...
    They may read 0, but they show that AISEM watches posture across the whole agent ecosystem, not just standalone models.
