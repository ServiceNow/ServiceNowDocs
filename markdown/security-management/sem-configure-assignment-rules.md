...
The request is approved by using a default, one-level approval workflow. For more information, see [Approve or reject an unassign request](../task/sem-approve-unassign-requests.md).
