...
<table id="choicetable_dkw_4rr_1cc"><thead><tr><th align="left" id="d301445e118">

Option

</th><th align="left" id="d301445e121">

Description

</th></tr></thead><tbody><tr><td id="d301445e127">
...
3.  Select the required option from the ServiceNow Otto context menu. **Elaborate** will help you to elaborate the text and replaces the selected resolution text. In case, if you wish to shorten the resolution text you can select **Shorten** option from the Context menu to make the text more concise.
...
5.  Select the required option from the ServiceNow Otto context menu. **Elaborate** will help you to elaborate the text and replaces the selected resolution text. In case, if you wish to shorten the resolution text you can select **Shorten** option from the context menu to make the text more concise.
...
**Note:** Using the context menu, you can directly add or generate the resolution notes in the **Close notes** section on the incident record itself, when the incident is in the **Review** state. For more information, see the screen shot below.
