...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/now-assist-for-security-incident-response-sir/resolve-sir-incident-aiagent.html
release: xanadu
...
breadcrumb: [Security Incident Response AI agent collection Resolve security incident agentic workflow, Using AI agentic workflows in Now Assist for Security Incident Response, Now Assist for Security Incident Response, Security Operations]
---
...
5.  Select **Resolve security incident**.
    ...
    \[Omitted image "ai-agent-resolution-plan.png"\] Alt text: Resolution plan for a security incident.
...
The AI agent closes the incident. For more information, see [Close a security incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/now-assist-for-security-incident-response-sir/close-sir-incident-aiagent.md).
