...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/now-assist-for-security-incident-response-sir/assess-metrics-sir-aiagent.html
release: xanadu
...
breadcrumb: [Security Incident Response AI agent collection for the Analyze security operations metrics agentic workflow, Using AI agentic workflows in Now Assist for Security Incident Response, Now Assist for Security Incident Response, Security Operations]
---
