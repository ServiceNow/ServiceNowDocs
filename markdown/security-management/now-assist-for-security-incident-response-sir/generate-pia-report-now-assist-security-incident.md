---
title: Generate a post-incident analysis for a security incident with ServiceNow Otto for Security Incident Response \(SIR\)
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/now-assist-for-security-incident-response-sir/generate-pia-report-now-assist-security-incident.html
release: yokohama
...
# Generate a post-incident analysis for a security incident with ServiceNow Otto for Security Incident Response \(SIR\)
...
If the Close notes are already populated manually prior to closing the security incident, this content is not over-written by ServiceNow Otto for Security Incident Response \(SIR\) when analysts set the State field to **Closed**.
...
4.  To generate the post-incident analysis select **Next**.
    ...
    The post-incident analysis is displayed in the modal with three sections. Note the Now Assist icon \(\[Omitted image "icon-ai-sparkle.png"\] Alt text: AI Sparkle icon\) indicates the content is generated by ServiceNow Otto for Security Incident Response \(SIR\).
