...
4.  To generate the post-incident analysis select **Next**.
    ...
    The post-incident analysis is displayed in the modal with three sections. Note the Now Assist icon \(\[Omitted image "icon-ai-sparkle.png"\] Alt text: AI Sparkle icon\) indicates the content is generated by Now Assist for Security Incident Response.
