...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/now-assist-for-security-incident-response-sir/supporting-information-now-assist-security-incident.html
release: xanadu
...
breadcrumb: [Exploring Now Assist for Security Incident Response, Now Assist for Security Incident Response, Security Operations]
---
...
Version 3.2 of Now Assist for Security Incident Response supports:

-   Security Operations UI Components, v1.0.1
-   Recommended Actions for Security Operations, v1.0.1
-   legacy UI \(UI16\): Security Incident Response core application, v13.6.5
-   Security Incident Response Workspace \(SIR Workspace\), v1.7.0
-   Now Assist for ServiceNow AI Platform® v6.3.0
