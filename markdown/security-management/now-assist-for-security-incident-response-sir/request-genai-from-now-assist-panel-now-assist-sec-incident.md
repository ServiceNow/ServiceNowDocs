---
title: Request generative AI skills in the Now Assist panel for ServiceNow Otto for Security Incident Response \(SIR\)
description: Request a security incident summary or closure notes from the Now Assist panel.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/now-assist-for-security-incident-response-sir/request-genai-from-now-assist-panel-now-assist-sec-incident.html
release: yokohama
...
# Request generative AI skills in the Now Assist panel for ServiceNow Otto for Security Incident Response \(SIR\)

Request a security incident summary or closure notes from the Now Assist panel.

## Before you begin

See [Now Assist panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/now-assist-panel-overview.md) for how to activate the Now Assist panel.
...
In the Now Assist panel, select **Generate correlation insights**.
 ...
 See [Generate correlation insights in the Now Assist panel with ServiceNow Otto for Security Incident Response \(SIR\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/now-assist-for-security-incident-response-sir/generate-correlation-insights-now-assist-for-security.md) for more information.
