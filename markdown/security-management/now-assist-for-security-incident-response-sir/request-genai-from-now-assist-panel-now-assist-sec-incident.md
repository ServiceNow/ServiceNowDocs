...
See [Now Assist panel](https://www.servicenow.com/docs/access?context=now-assist-panel-overview&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US) for how to activate the Now Assist panel.
...
4.  Select the Now Assist icon \(![AI Sparkle icon](../../../common/image/icon-ai-sparkle.png)\) in the top banner.

<table id="choicetable_wp5_pvr_1cc"><thead><tr><th align="left" id="d282735e128">

Option

</th><th align="left" id="d282735e131">

Description

</th></tr></thead><tbody><tr><td id="d282735e137">
...
In the Now Assist panel, select **Generate correlation insights**.
 ...
 See [Exploring correlation insights with Now Assist for Security Incident Response](generating-insights-for-now-assist-for-security.md) and [Generate correlation insights with Now Assist for Security Incident Response](generate-correlation-insights-now-assist-for-security.md) for more information.
