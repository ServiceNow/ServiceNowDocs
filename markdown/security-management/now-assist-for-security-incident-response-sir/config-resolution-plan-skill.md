...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/now-assist-for-security-incident-response-sir/config-resolution-plan-skill.html
release: zurich
