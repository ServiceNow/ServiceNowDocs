...
7.  Select **Create response task** on a card.
...
8.  Edit the form as needed and the select **Save** to create the response task.
...
9.  Create a response task from the recommended actions.
