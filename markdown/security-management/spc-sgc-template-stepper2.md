...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/spc-sgc-template-stepper2.html
release: yokohama
topic_type: task
...
4.  Select **Save and continue** to save your edits.
    ...
    After you save your edits, the [Select template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/spc-sgc-template-stepper-3.md) step is displayed and highlighted on the stepper.
