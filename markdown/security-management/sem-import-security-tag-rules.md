...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sem-import-security-tag-rules.html
release: zurich
topic_type: task
...
2.  Choose or [create a security tag](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/create-class-group-and-tags.md).
...
**Parent Topic:**[Set up security tag groups and tags](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-create-class-group-and-tags.md)
