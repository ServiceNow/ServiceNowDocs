...
![Vulnerability rollup calculator example with a maximum risk score of 80, an average risk score of 5, and a count of vulnerable items of 15.](../image/remediation-task-rollup-calculator-example.png "Vulnerability rollup calculator example")
