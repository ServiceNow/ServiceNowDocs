...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/map-technique-coverage.html
release: australia
topic_type: task
...
The technique detection coverage mapping that you define is used in the [coverage visualization in the heatmap](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/mitre-att-ck-heatmap-and-navigator.md).
...
2.  Review each technique and map your overall technique detection coverage based on your [detection coverage definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/define-technique-coverage.md) and your organization's coverage availability.
