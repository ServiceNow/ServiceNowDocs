...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/spc-clone-policy.html
release: xanadu
topic_type: task
...
<table id="choicetable_mvf_ylm_dcc"><thead><tr><th align="left" id="d56816e120">

Option

</th><th align="left" id="d56816e123">

Description

</th></tr></thead><tbody><tr><td id="d56816e129">
...
8.  To activate a policy, follow the steps described in [Create and activate custom policies for Security Posture Control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/spc-create-policy.md).
