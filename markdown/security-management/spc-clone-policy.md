...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/spc-clone-policy.html
release: yokohama
topic_type: task
...
<table id="choicetable_mvf_ylm_dcc"><thead><tr><th align="left" id="d236155e116">

Option

</th><th align="left" id="d236155e119">

Description

</th></tr></thead><tbody><tr><td id="d236155e125">
...
8.  To activate a policy, follow the steps described in [Create and activate custom policies for Security Posture Control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/spc-create-policy.md).
