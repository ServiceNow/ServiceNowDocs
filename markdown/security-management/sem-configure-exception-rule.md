...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/sem-configure-exception-rule.html
release: australia
topic_type: concept
...
-   **[Create an exception rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/sem-create-exception-rule.md)**  
...
-   **[Approve an exception rule request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/sem-approve-ex-rule-request.md)**  
Assess exception rule requests from users so that you can approve or reject these requests.
-   **[Activating an exception rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/sem-activate-ex-rule.md)**  
A rule is activated on its "Valid from" date. After activation, it automates the exception process for findings.
-   **[Reopen an exception rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/sem-reopen-ex-rule.md)**  
Reopen an exception rule that has been rejected, but you want to resubmit. Reopening the rule moves it to the Draft state.
-   **[Update an approved exception rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/sem-update-approved-ex-rule.md)**  
...
-   **[Delete an exception rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/sem-delete-ex-rule.md)**  
