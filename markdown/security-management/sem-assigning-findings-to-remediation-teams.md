...
You can automate the regrouping of findings when assignment groups change due to assignment rule reapplication by activating the system property **sn\_vul.rerun\_task\_rules**.

Steps to enable:

1.  Navigate to **All** &gt; **System Properties** &gt; **All Properties**.
2.  Open **sn\_vul.rerun\_task\_rules** system property.
