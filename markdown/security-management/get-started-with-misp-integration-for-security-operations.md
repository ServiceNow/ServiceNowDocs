...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/get-started-with-misp-integration-for-security-operations.html
release: yokohama
...
-   sn\_sec\_misp.write - The MISP analyst role has read and write permissions for MISP data that includes the event and attribute data.
 ...
 For more information, see [Setup Threat Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/c_GetStartedWithThreatIntel.md).
...
Verify the [domain separation section](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/domain-separation-and-misp.md) if you intend to separate data, processes, and administrative tasks.

</td></tr></tbody>
</table>-   **[MISP user roles and permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/misp-user-roles-and-permissions.md)**  
