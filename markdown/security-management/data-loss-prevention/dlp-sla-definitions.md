...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/data-loss-prevention/dlp-sla-definitions.html
release: zurich
...
2.  Create an SLA definition.
    ...
    For a description of the field values, see [DLP SLA Definition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/data-loss-prevention/dlp-sla-def-properties.md).
