...
**Note:** The conditions in the condition builder are case sensitive.
    ...
    ![The list incident response option rule that the End user can perform.](../image/dlp-incident-response-options1.png "Incident Response Option Rule")
...
</table>    ![Response Option mapping page within Incident Response Option Rules](../image/dlp-response-option-mapping-new-record-rule.png "Response Option Mapping Action")
