...
</table>        ![DLP Analyst Workspace: Details tab](../image/dlp-ops-portal-details.png "DLP Analyst Workspace")

6.  You can see the List view from the homepage by going to the top-left of the page and clicking the **Lists** tab.
    ...
    The following example shows the DLP workspace with the list view categories. The **All** list view option is selected.

    ![DLP Analyst Workspace Lists view](../image/dlp-lists-view-analyst-workspace.png "DLP Analyst Workspace Lists view")
...
![Playbooks for DLP Incident Response](../image/dlp-playbook.png "Sample Playbooks for DLP Incident Response")
...
3.  Add the Playbook.
    ...
    2.  In the UI actions menu, select the More actions icon \(![More actions icon.](../image/dlp-more-actions-icon.png)\) and select **Add Playbooks**.
...
4.  Select each lane to explore the tasks this Playbook performs.
    ...
    ![Add a DLP Playbook.](../image/playbook-in-dlp.png "Sample DLP Playbook")
...
4.  In the header of the Playbook that you want to cancel, select the Playbook actions icon \(![Playbook actions icon.](../image/icon-playbook-actions.png)\) and then select **Cancel Playbook**.
