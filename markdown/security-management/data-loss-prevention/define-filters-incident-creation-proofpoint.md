...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/data-loss-prevention/define-filters-incident-creation-proofpoint.html
release: australia
...
2.  Using the lists and fields of the condition builder, set the filters in the **Filter Conditions** field.
    ...
    \[Omitted image "dlp-proofpoint-filter.gif"\] Alt text: Define filters to apply for the Incident creation.
