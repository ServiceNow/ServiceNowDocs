...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/data-loss-prevention/configure-enduser-lookup-rules.html
release: yokohama
...
You can use the script editor to customize and format the field values during the end user lookup rule creation. For example, you can use the email address field to identify the end user.
    ...
    \[Omitted image "dlp-enduser-lookuprule.png"\] Alt text: Configure end user lookup rules
