...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/data-loss-prevention/setup-response-due-date-rules.html
release: zurich
...
-   **[Add multiple users to access DLP incidents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/data-loss-prevention/add-multiple-users-to-access-dlp-incidents.md)**  
