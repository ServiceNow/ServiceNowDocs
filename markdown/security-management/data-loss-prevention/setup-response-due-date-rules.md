...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/data-loss-prevention/setup-response-due-date-rules.html
release: yokohama
...
**Note:** You can only view and select groups that have been assigned with the sn\_dlir.analyst role.
    ...
    \[Omitted image "dlp-response-due-date.gif"\] Alt text: Response Due Data Rules list view

4.  Click **Submit**.


-   **[Add multiple users to access DLP incidents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/data-loss-prevention/add-multiple-users-to-access-dlp-incidents.md)**  
