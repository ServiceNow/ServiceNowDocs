...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/data-loss-prevention/add-multiple-users-to-access-dlp-incidents.html
release: yokohama
...
**Parent Topic:**[Create response due date rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/data-loss-prevention/setup-response-due-date-rules.md)
