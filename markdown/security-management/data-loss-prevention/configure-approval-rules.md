...
Option to select the approvers. 1.  Users and Groups:
    1.  **Users**: Click the ![Add me icon](../image/dlp-addme-icon.png) icon to add a particular user from the list. You can also add a user by using their email address or search option.
