...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/data-loss-prevention/email-actions.html
release: yokohama
...
\[Omitted image "dlp-proofpoint-release-response-option-rule.png"\] Alt text: Proofpoint Quarantine Release Response Option Rule

\[Omitted image "dlp-proofpoint-release-response-option-mapping.png"\] Alt text: Proofpoint Quarantine Release Response Option Mappings
