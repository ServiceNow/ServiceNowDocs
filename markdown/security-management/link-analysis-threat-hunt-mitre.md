...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/link-analysis-threat-hunt-mitre.html
release: australia
topic_type: task
...
2.  Select **Update Personalized List** to add the MITRE columns.
...
4.  Create a filter condition that is based on the above criteria and select **Run** to perform a link analysis or correlation between security incidents, observables, and MITRE-ATT&amp;CK related information.
