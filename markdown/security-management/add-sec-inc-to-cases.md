...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/add-sec-inc-to-cases.html
release: australia
topic_type: task
...
3.  From the **Actions on selected items** drop-down list, select **Add to Security Case**.
    ...
    \[Omitted image "add-sec-inc-to-existing-case.png"\] Alt text: Add a security incident to an existing case
