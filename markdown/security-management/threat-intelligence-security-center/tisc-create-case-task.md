...
7.  Click **Save**.
    ...
    **Note:** After saving the case task, you can add tags and taxonomies to the task. For more information, see [Creating Taxonomies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/threat-intelligence-security-center/create-taxonomies.md).
