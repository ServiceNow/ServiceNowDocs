...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/threat-intelligence-security-center/tisc-automated-flows.html
release: zurich
...
-   **[Analyze and assess threat IoC’s](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/threat-intelligence-security-center/tisc-analyze-ioc.md)**  
Learn how to analyze an IOC’s which are a threat and notifying the security incident team.
-   **[Vulnerability Management Support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/threat-intelligence-security-center/tisc-vul-mgmt.md)**  
Learn how a new vulnerability is created in TISC with a related vulnerability in VR.
-   **[Zero-day vulnerability tracking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/threat-intelligence-security-center/tisc-zero-vul.md)**  
Learn how to analyze RSS Feeds coming into the system.
-   **[Automatic Threat Actor priority tagging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/threat-intelligence-security-center/tisc-threat-actor-priority-tagging.md)**  
Learn how to enable automatic tagging of Threat Actors based on their origin locations.
-   **[Automated flows tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/threat-intelligence-security-center/tisc-flows-tables.md)**  
