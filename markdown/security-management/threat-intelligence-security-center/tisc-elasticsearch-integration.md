...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/threat-intelligence-security-center/tisc-elasticsearch-integration.html
release: xanadu
...
2.  [Download the integration from the ServiceNow Store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/download-app-first-time.md).
...
**Parent Topic:**[Get started with Elasticsearch integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/threat-intelligence-security-center/get-started-with-elasticsearch-integration.md)
