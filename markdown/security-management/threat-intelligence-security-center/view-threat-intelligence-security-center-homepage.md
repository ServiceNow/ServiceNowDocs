...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/threat-intelligence-security-center/view-threat-intelligence-security-center-homepage.html
release: zurich
...
1.  Navigate to **All** &gt; **Workspaces** &gt; **Threat Intelligence Security Center**.
    ...
    \[Omitted image "tisc-homepage-view.png"\] Alt text: TISC homepage
...
**Parent Topic:**[Explore](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/threat-intelligence-security-center/threat-intelligence-security-center-overview.md)
