...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/threat-intelligence-security-center/tisc-export-threat-intell.html
release: xanadu
...
</table>**Note:** For better understanding of export limit on the other format types, see [Export limits](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/table-administration-and-data-management/c_ExportLimits.md).
