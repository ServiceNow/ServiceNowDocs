...
List the MITRE techniques related to the case\(s\).MITRE techniques also displays all the associated techniques in a case. For more information, see [Show MITRE ATT&amp;CK Framework for a Case\(s\)](tisc-show-mitre-fw.md).
...
[Create case task using Threat Analyst Workbench](tisc-create-case-task.md)
