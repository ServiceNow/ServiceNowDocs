...
description: Delete records from the threat intelligence library.
locale: en-US
release: yokohama
...
Delete records from the threat intelligence library.
...
6.  Delete the library record.
    ...
    **Note:**
    ...
    2.  To permanently delete the data from the threat intelligence library, use archival rules instead of deleting the library records. For more information, see [TISC Data Archival](tisc-data-archival.md).
