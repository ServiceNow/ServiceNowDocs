...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/threat-intelligence-security-center/tisc-download-app-first-time.html
release: zurich
...
1.  Follow the instructions for [installing an application from the ServiceNow Store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/download-app-first-time.md) and install the **Threat Intelligence Security Center Security Operations** application.
