...
-   The sn\_sec\_tisc.analyst role performs the following tasks:
    -   Views the overview of data in the system using Product Homepage. For more information, see [Home page in TISC Workspace](../task/view-threat-intelligence-security-center-homepage.md).
