...
breadcrumb: [Configure TISC add-on in Splunk, TISC add-on for Splunk overview, Configure Sighting Search, Sighting Search, TISC Enrichment integrations, TISC Integrations, Integrate Threat Intelligence Security Center, Threat Intelligence Security Center, Security Operations]
---
...
</table>**Parent Topic:**[Configure TISC add-on in Splunk](../task/tisc-configure-splunk.md)
