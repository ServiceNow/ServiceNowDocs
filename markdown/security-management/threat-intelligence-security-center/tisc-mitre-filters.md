...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/threat-intelligence-security-center/tisc-mitre-filters.html
release: xanadu
...
breadcrumb: [Investigation canvas and MITRE ATT&amp;CK, Working with Investigation Canvases, Threat Analyst Workbench, Use, Threat Intelligence Security Center, Security Operations]
---
...
\[Omitted image "tisc-investigation-mitre-filter-example.png"\] Alt text: Filtering by MITRE Group
...
**Parent Topic:**[Investigation canvas and MITRE ATT&amp;CK](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/threat-intelligence-security-center/investigation-and-mitre.md)
