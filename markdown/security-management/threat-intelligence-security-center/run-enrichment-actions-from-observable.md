...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/threat-intelligence-security-center/run-enrichment-actions-from-observable.html
release: zurich
