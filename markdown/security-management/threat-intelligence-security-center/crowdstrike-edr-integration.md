...
description: Integration with CrowdStrike Falcon EDR enables continuous monitoring and real-time alerting based on intelligence from TISC.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/threat-intelligence-security-center/crowdstrike-edr-integration.html
release: xanadu
...
This integration can help streamline security operations and reduce any potential risk to the organization's business.

-   **[Configure Crowdstrike Falcon EDR integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/threat-intelligence-security-center/config-cs-edr-integration.md)**  
...
-   **[Send observables to EDR](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/threat-intelligence-security-center/send-to-edr.md)**  
