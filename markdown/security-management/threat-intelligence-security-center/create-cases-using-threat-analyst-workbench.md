...
7.  Click **Save**.
    ...
    **Note:** If you are importing and processing data from Case Management, then a unique is associated to the import record.![Import intelligence-Case Management](../image/tisc-import-intelligence-case-management.png)
...
[Working with Investigation Canvases](tisc-investigation-canvases.md)
