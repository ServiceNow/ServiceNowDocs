...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/threat-intelligence-security-center/tisc-splunk-integration.html
release: yokohama
...
breadcrumb: [Get started with Splunk Search integration, Configure Sighting Search, Sighting Search, TISC Enrichment integrations, TISC Integrations, Integrate Threat Intelligence Security Center, Threat Intelligence Security Center, Security Operations]
---
...
**Parent Topic:**[Get started with Splunk Search integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/threat-intelligence-security-center/get-started-with-splunk-search-integration.md)
