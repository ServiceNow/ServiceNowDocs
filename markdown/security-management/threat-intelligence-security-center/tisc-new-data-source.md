...
description: Configure new threat intelligence feed data source.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/threat-intelligence-security-center/tisc-new-data-source.html
release: xanadu
...
Select the REST Message record from the list of REST message records which are already configured in the instance. For more information, see [Outbound REST web service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/web-services/c_OutboundRESTWebService.md) on the ServiceNow AI Platform documentation.**Note:** Select this value when you need to view specific headers, and define the REST related records using the REST message option.
...
**Note:** By default, the frequency is set to On Demand.
 ...
 For more information, see [Scheduled Jobs and how to Automatically run a script of your choosing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/time-configuration/t_ScheduleAScriptExecution.md).
