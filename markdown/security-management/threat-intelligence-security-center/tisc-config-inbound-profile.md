...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/threat-intelligence-security-center/tisc-config-inbound-profile.html
release: yokohama
...
-   STIX 2.1
-   MISP
For more information on the data formats description, see [Configuring Outbound Intel Sharing Profiles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/threat-intelligence-security-center/tisc-outbound-sharing-profiles.md).
