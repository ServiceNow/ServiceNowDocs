...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/threat-intelligence-security-center/tisc-api-references.html
release: zurich
...
|---|-----------|---------------------------------|
|TISC API - POST|This API is designed to access observables data as well as associated threat entity information from TISC.|[TISC API under REST API reference section on API implementation and reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/tisc-api.md)|
