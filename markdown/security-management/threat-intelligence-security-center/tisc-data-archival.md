...
3.  View the TISC related records.
    ...
    **Note:**
    ...
    For information on how the archival rules are created, see [Create an archive rule](https://www.servicenow.com/docs/access?context=t_CreateAnArchiveRule&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
