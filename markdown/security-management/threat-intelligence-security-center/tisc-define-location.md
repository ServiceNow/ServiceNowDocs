...
description: Define a geographic location to provide more context to other Suspicious Domain Objects \(SDO\).
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/threat-intelligence-security-center/tisc-define-location.html
release: xanadu
...
**Parent Topic:**[Location](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/threat-intelligence-security-center/location.md)
