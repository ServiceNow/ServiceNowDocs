...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/threat-intelligence-security-center/tisc-email-notifications.html
release: zurich
...
breadcrumb: [Managing email Notifications in TISC, Administer, Threat Intelligence Security Center, Security Operations]
---
...
For more information, see [Create an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_CreateANotification.md) section on ServiceNow AI Platform administration documentation.
...
**Parent Topic:**[Managing email Notifications in TISC](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/threat-intelligence-security-center/tisc-notifications.md)
