...
breadcrumb: [TISC Security Tools - Firewall, TISC Security Tools integrations, TISC Integrations, Integrating Threat Intelligence Security Center, Threat Intelligence Security Center, Security Operations]
---
...
**Parent Topic:**[TISC Security Tools - Firewall](tisc-security-tools.md)
