...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/ms-graph-install.html
release: yokohama
...
breadcrumb: [Set up your Now platform instance for the Microsoft Graph Security API integration, Microsoft Graph Security API alert ingestion integration, Security Incident Response integrations, Security Incident Response, Enterprise security case management applications, Security Operations]
---
...
<table id="choicetable_rrp_bwk_kdb"><thead><tr><th align="left" id="d64927e125">

Field

</th><th align="left" id="d64927e128">

Description

</th></tr></thead><tbody><tr><td id="d64927e134">
