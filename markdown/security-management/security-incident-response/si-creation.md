...
[Manually created from an alert](https://www.servicenow.com/docs/access?context=t_CreateAnAlertFromAnIncident&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US)
...
|Method|Description|
|------|-----------|
|[Automatically created using alert rules](c_ScIncdUseAlrts.md)|Security incidents can be created based on alert rules defined in the [Event management in your data center](https://www.servicenow.com/docs/access?context=c_EM&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US) application.|
