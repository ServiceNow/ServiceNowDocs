...
</table>-   **[Create a capability profile for the McAfee ePO integration](../task/mcafee-epo-create-profile.md)**  
Create a profile and select the McAfee ePO capabilities that you want the profile to run.
-   **[Defining triggering conditions with a Configuration item \(CI\) field for a McAfee ePO profile](mcafee-epo-alternate-ci.md)**  
...
-   **[Configuring profiles for the McAfee ePO integration](mcafee-epo-configuring-profile.md)**  
...
**Next topic:**[Create a capability profile for the McAfee ePO integration](../task/mcafee-epo-create-profile.md)
