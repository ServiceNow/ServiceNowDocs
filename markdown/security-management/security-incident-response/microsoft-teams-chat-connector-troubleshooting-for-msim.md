...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/microsoft-teams-chat-connector-troubleshooting-for-msim.html
release: yokohama
...
15. Validate MS Teams Connection.
    ...
    \[Omitted image "msteams-flow-designer-subflows.png"\] Alt text: MS Teams flow designer sub flows
