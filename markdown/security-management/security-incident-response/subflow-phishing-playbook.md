...
You can launch the Subflow Designer to view additional details of a subflow. The Subflow Designer page for the Run Threat Lookups for Observables subflow is shown here. Click the ![Subflow designer](../image/cj-sir-flow-actiondesign-icon.png) icon in the image below to view the Subflow Designer.
...
![Automated phishing flow: step 7.1.1-1](../image/cj-sir-flow-phishing-action7-1-1.png)
