---
title: Set up your ServiceNow AI Platform instance for the Microsoft Graph Security API integration
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/ms-graph-setup-sn.html
release: xanadu
...
# Set up your ServiceNow AI Platform instance for the Microsoft Graph Security API integration
...
Before you can ingest alerts, you must configure your application in the Microsoft Azure portal. See [Configure the Microsoft Azure portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/ms-graph-configure-azure.md) for details.
