...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/playbook-legal-request.html
release: xanadu
...
breadcrumb: [Major Security Incident Management Playbooks, Major Security Incident Management, Security Incident Response, Enterprise security case management applications, Security Operations]
---
...
The following are the lanes of the process definition and correspond to the major security incident state:
...
\[Omitted image "msim-playbook-list.png"\] Alt text: Playbook for Legal Request
