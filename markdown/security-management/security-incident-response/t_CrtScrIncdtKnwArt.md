...
3.  Fill in the fields on the form, as appropriate.
    ...
    |Workflow|\[Read-Only\] The publication state of the article, such as Draft or Published. When inserting a new article from an existing article, the state of the new article is reset to **Draft**.|
