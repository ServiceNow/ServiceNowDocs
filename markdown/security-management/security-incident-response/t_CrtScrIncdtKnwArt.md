...
Any additional steps required to publish the article, such as approvals, depend on the [publishing workflow](https://www.servicenow.com/docs/access?context=r_KnowledgeWorkflows&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) for the knowledge base.
