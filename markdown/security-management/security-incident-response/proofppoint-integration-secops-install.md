...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/proofppoint-integration-secops-install.html
release: yokohama
...
1.  Download the  Proofpoint Integration for Security Operations application from the  ServiceNow® Store and install it.
    ...
    For more information, see [Install a ServiceNow Store application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_InstallApplications.md).
