...
As a first step, install:-   [ServiceNow IntegrationHub Installer](https://www.servicenow.com/docs/access?context=request-ih-overview&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US) \(com.glide.hub.integrations\)
