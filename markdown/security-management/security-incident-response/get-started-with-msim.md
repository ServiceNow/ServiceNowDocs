...
As a first step, install:-   [ServiceNow IntegrationHub Installer](https://www.servicenow.com/docs/access?context=request-ih-overview&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) \(com.glide.hub.integrations\)
