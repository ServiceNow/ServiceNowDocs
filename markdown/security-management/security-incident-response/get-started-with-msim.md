...
As a first step, install:-   [ServiceNow IntegrationHub Installer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/request-ih-overview.md) \(com.glide.hub.integrations\)
