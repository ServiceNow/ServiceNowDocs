...
Create a **Manual event forwarding** profile to forward alerts on-demand from your splunk console to create a Security Incident Response \(SIR\) on the ServiceNow instance. For more information, see [Create and name an event profile for the Splunk Enterprise Event Ingestion integration](splunk-event-ingest-create-profile.md) and implement same for Splunk V2.
