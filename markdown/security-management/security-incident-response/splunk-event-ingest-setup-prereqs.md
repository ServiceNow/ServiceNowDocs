...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/splunk-event-ingest-setup-prereqs.html
release: xanadu
...
Create a **Manual event forwarding** profile to forward alerts on-demand from your splunk console to create a Security Incident Response \(SIR\) on the ServiceNow instance. For more information, see [Create and name an event profile for the Splunk Enterprise Event Ingestion integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/splunk-event-ingest-create-profile.md) and implement same for Splunk V2.
