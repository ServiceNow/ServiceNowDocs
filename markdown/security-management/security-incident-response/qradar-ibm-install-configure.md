...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/qradar-ibm-install-configure.html
release: xanadu
...
<table id="choicetable_rrp_bwk_kdb"><thead><tr><th align="left" id="d196442e143">

Field

</th><th align="left" id="d196442e146">

Description

</th></tr></thead><tbody><tr><td id="d196442e152">
...
</table>    \[Omitted image "ibm-qradar-minimum-roles-required.png"\] Alt text: Minimum User Roles
