...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/customize-si-to-msi-flows-for-msim.html
release: zurich
...
1.  In the [ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-platform/now-platform-landing.md), navigate to **Flow Designer**.
