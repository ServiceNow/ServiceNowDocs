...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/configure-profiles-and-security-incidents-for-the-crowdstrike-falcon-insight-integration.html
release: xanadu
...
1.  In the Profile Configuration page, review and configure the following sections:
    ...
    **Additional Configuration**
    ...
    2.  In the **Alternate CI Trigger Field**, select an input field.
        ...
        **Note:** For more information, see [Understand how trigger conditions work with a configuration item for a profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/define-trigger-conditions.md).
