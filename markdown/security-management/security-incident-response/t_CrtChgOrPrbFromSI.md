...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/t\_CrtChgOrPrbFromSI.html
release: xanadu
...
Role required: sn.si\_basic or higher
