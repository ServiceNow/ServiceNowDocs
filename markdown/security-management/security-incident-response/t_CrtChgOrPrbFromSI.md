...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/t\_CrtChgOrPrbFromSI.html
release: yokohama
...
2.  Right-click in the security incident header bar and select one of the following:
    ...
    **Note:**
    ...
    -   The **Create OT Change Request** option is available only when the Operational Technology Change Management plugin \(com.sn\_ot\_chg\_mgmt\) is installed and relevant OT change role is assigned to the user.
