...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/playbook-setup-osquery-external-address.html
release: yokohama
...
3.  Create a copy of the OSquery External Address in /etc/hosts playbook flow and make the necessary modifications.
    ...
    \[Omitted image "playbook-osquery-overview.png"\] Alt text: Overview of the OSquery of External Address in /etc/hosts playbook.
...
5.  Set a **Trigger Condition** for the playbook.
    ...
    \[Omitted image "playbook-osquery-trigger.png"\] Alt text: Trigger condition for OSquery of External Address in /etc/hosts playbook
