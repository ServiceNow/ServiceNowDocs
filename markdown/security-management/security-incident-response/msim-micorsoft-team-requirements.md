...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/msim-micorsoft-team-requirements.html
release: yokohama
...
-   **[Using Certificates for authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/using-certificates-for-authentication.md)**  
Request an access token with a certificate credential.
-   **[Using Client Secret value](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/using-client-secret-value.md)**  
Use client secret value to configure the Graph application registry record.

**Parent Topic:**[Integrating Major Security Incident Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/integrate-with-other-applications.md)
