...
breadcrumb: [Unified Experience example, Unified experience framework for integrations powered by Capability Framework, SIR Workspace Orchestration, Working with Security Incident Records, Using SIR Workspace, Security Incident Response Workspace, Security Incident Response, Enterprise security case management applications, Security Operations]
---
...
**Parent Topic:**[Unified Experience example](../concept/unified-expereince-example.md)
