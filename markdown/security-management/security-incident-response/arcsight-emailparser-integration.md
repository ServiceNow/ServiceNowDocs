...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/arcsight-emailparser-integration.html
release: yokohama
...
1.  Navigate to **All** &gt; **Security Operations** &gt; **Integrations** &gt; **Integration Configurations**.
    ...
    \[Omitted image "arcsight-emailparser-plugin-card.png"\] Alt text: HPE Security Arcsight ESM - Email Parser card
