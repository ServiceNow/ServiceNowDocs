...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/si-web-defacement-template.html
release: zurich
...
1.  Open the security incident for this occurrence of web or BBS defacement, or [create a new security incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/t_ManuallyCreateSecurityIncident.md).
