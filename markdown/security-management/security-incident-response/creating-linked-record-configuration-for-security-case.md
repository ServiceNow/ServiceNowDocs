...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/creating-linked-record-configuration-for-security-case.html
release: xanadu
...
2.  Click **New**.
    ...
    \[Omitted image "linked-record-new.png"\] Alt text: New button
...
</table>    \[Omitted image "can-promote-to-msi-step1.png"\] Alt text: Can promote to MSI

    \[Omitted image "modal-view-step1.png"\] Alt text: Modal view
