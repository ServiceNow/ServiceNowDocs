...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/activate-configure-arcsight-inc-enrich.html
release: yokohama
...
3.  In the HPE ArcSight Logger - Incident Enrichment card, click **New**.
    ...
    \[Omitted image "arcsight-config.png"\] Alt text: HPE ArcSight Logger configuration
...
**Parent Topic:**[HPE ArcSight Logger - Incident Enrichment integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/arcsight-logger-landing-page.md)
