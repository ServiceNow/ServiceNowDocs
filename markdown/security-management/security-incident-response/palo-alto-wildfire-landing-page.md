...
Set up
 ...
 [Activate Security Operations Palo Alto Networks - WildFire](../task/activate-secops-palo-alto-network.md)

</td></tr><tr><td>

Use

 [Get WildFire Data Enrichment Flow](../task/enrich-wildfire-data.md#)
