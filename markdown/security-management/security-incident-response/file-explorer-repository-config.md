...
Select the File Explorer Graph tenant record. For more information on the tenant connection configuration, see [Microsoft SharePoint spoke](https://www.servicenow.com/docs/access?context=sharepoint-online-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
...
Select the File Explorer REST tenant record. For more information on the tenant connection configuration, see [Microsoft SharePoint spoke](https://www.servicenow.com/docs/access?context=sharepoint-online-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
