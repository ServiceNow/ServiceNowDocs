...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/cj-sir-flow-library4.html
release: xanadu
...
To understand how to resolve security threats in a step-by-step manner, see [Resolve security threats with the playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/use-the-playbook.md).
...
\[Omitted image "cj-sir-child-automation-trigger.png"\] Alt text: Child Automation playbook: Trigger
...
1.  When the playbook starts executing, in Step 1, if the security incident is in a Draft state, it’s updated and set to the Analysis state.
    ...
    \[Omitted image "cj-sir-child-automation-step1.png"\] Alt text: Child Automation playbook: step 1
...
3.  In steps 4 and 5, configuration items associated with the child security incident are retrieved and unique CIs are rolled up to the parent security incident.
    ...
    \[Omitted image "cj-sir-child-automation-step4-5.png"\] Alt text: Child automation playbook: step 5
...
4.  In steps 6 and 7, observables associated with the child security incident are retrieved and unique observables are rolled up to the parent security incident.
    ...
    \[Omitted image "cj-sir-child-automation-step6-7.png"\] Alt text: Child automation playbook: step 7
