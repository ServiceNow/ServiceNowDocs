...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/splunk-event-ingest-install-and-configure-security.html
release: yokohama
...
\[Omitted video\] Description: Configure Splunk ES- Event Ingestion integration
...
<table id="choicetable_rrp_bwk_kdb"><thead><tr><th align="left" id="d259981e151">

Field

</th><th align="left" id="d259981e154">

Description

</th></tr></thead><tbody><tr><td id="d259981e160">
...
[Create and name an event profile for the Splunk Enterprise Security event ingestion integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/splunk-event-ingest-create-profile-security.md)
