...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/explore-investigation-in-sir-workspace.html
release: zurich
...
The list of children table under an entry point is also configurable. For more information, see [Configure SI design time investigation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/configure-investigation-canvas-records.md).
...
**Parent Topic:**[SIR Workspace Investigation Canvas](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/security-incident-response-investigation-canvas.md)

**Related topics**  


[Configure SI design time investigation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/configure-investigation-canvas-records.md)
