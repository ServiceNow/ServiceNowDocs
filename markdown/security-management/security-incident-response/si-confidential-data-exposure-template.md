...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/si-confidential-data-exposure-template.html
release: yokohama
...
1.  Open the security incident for which you want to handle the exposure to sensitive data, or [create a new security incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/t_ManuallyCreateSecurityIncident.md).
