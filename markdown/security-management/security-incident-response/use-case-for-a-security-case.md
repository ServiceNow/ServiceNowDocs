...
-   [Step 1. Create linked record configuration for a Security Case](../task/creating-linked-record-configuration-for-security-case.md)
-   [Step 2. Create a view for modal window for a Security Case](../task/creating-a-view-for-modal-window-for-security-case.md)
-   [Step 3. Create UI actions for the Source Table for a Security Case](../task/creating-ui-actions-for-source-table.md)
-   [Step 4. Create a view for a new Linked Record Tab for a Security Case](../task/creating-a-view-for-the-new-linked-record-tab.md)
-   [Step 5. Add Access Control Lists \(ACLs\) for Major Security Incident Management workspace users](../task/adding-access-control-lists-for-msim-workspace-users.md)
-   [Step 6. Create business rules for a Security Case](../task/creating-required-business-rules-for-security-case.md)
-   [Step 7. Create rollup record configurations](../task/create-rollup-record-configurations.md#)
