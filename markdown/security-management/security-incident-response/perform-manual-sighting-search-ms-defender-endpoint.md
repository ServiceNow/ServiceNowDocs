...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/perform-manual-sighting-search-ms-defender-endpoint.html
release: xanadu
...
breadcrumb: [Create and configure a profile for sightings search with the Microsoft Defender for Endpoint integration, Microsoft Defender for Endpoint integration, Security Incident Response integrations, Security Incident Response, Enterprise security case management applications, Security Operations]
---
