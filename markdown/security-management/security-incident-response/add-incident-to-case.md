...
4.  Click **Add to TISC Case** action.
    ...
    ![Security incident - Add to TISC Case.](../../secops-analyst-workspace/image/tisc-add-incident-to-case.png)
...
6.  Click **Add**.
    ...
    ![Security incident case is added successfully.](../../secops-analyst-workspace/image/tisc-add-to-case-activity-msg.png)
