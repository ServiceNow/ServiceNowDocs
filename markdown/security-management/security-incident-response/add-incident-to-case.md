...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/add-incident-to-case.html
release: yokohama
...
4.  Click **Add to TISC Case** action.
    ...
    \[Omitted image "tisc-add-incident-to-case.png"\] Alt text: Security incident - Add to TISC Case.
...
6.  Click **Add**.
    ...
    \[Omitted image "tisc-add-to-case-activity-msg.png"\] Alt text: Security incident case is added successfully.
