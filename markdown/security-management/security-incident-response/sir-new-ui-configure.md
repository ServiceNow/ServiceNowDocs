...
9.  To view the updated incident banner, select **Security Incidents** &gt; **Incidents \(New UI\)** to navigate to the Incident record in the Security Analyst Workspace and refresh the page to view the updated Incident banner.
