...
-   [Creating View for associated info tables](../task/creating-view-for-associated-info-tables.md)
-   [Adding an entry point list](../task/add-an-entry-point-list.md)
-   [Mapping View of the Associate Info to the entry point list](../task/map-view-to-the-entry-point-list.md)
-   [Configure each associated list from the view to handle run time data rendering](../task/configure-associated-list.md)
