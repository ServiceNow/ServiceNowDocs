...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/whois-install-and-config.html
release: yokohama
...
1.  If you have not installed the application, see [Install a Security Operations integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-operations/install-non-core-apps.md) and follow the steps to install it.

2.  After the installation completes, navigate to **Integrations** &gt; **Integrations Configurations** and locate the Whois API tile.

3.  Click **Configure**.

    \[Omitted image "whois-configure.png"\] Alt text: A description of the app and the button used to initiate the configuration.
...
**Previous topic:**[Install and configure Reverse Whois](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/install-and-config-reversewhois.md)

**Next topic:**[Initiate the lookup for Reverse Whois](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/manually-attch-an-obsvrble-reversewhois.md)
