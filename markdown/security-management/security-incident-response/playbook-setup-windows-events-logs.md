...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/playbook-setup-windows-events-logs.html
release: yokohama
...
3.  Create a copy of the T1070 - Windows Events Logs Cleared playbook flow and make the necessary modifications.
    ...
    \[Omitted image "playbook-windows-event-user-identify.png"\] Alt text: Overview of the T1070 - Windows Events Logs Cleared playbook
...
5.  Set a **Trigger Condition** for the playbook.
    ...
    \[Omitted image "playbook-windows-event-trigger.png"\] Alt text: Trigger condition for T1070 - Windows Events Logs Cleared playbook
