...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/logrhythm-map-alarms.html
release: xanadu
...
breadcrumb: [Mapping LogRhythm alarms to the security incident, Creating an alarm profile for LogRhythm, LogRhythm Overview, Security Incident Response integrations, Security Incident Response, Enterprise security case management applications, Security Operations]
---
...
After you complete the field mapping, the next step is to [Filter alarms for LogRhythm](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/filter-alarms-logrhythm.md).

**Parent Topic:**[Mapping LogRhythm alarms to the security incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/mapping-logrhythm.md)
