...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/playbook-setup-credential-dumping-mimikatz-dcsync.html
release: yokohama
...
3.  Create a copy of the T1003 - Credential Dumping - Mimikatz DCsync playbook flow and make the necessary modifications.
    ...
    \[Omitted image "playbook-mimikatz-dcsync-overview.png"\] Alt text: Overview of the T1003 - Credential Dumping - Mimikatz DCSync playbook.
...
5.  Set a **Trigger Condition** for the playbook.
    ...
    \[Omitted image "playbook-mimikatz-dcsync-trigger.png"\] Alt text: Trigger condition for T1003 - Credential Dumping - Mimikatz DCSync playbook.
