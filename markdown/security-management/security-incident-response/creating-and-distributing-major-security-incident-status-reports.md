...
description: As a Major Security Incident manager, you can create and distribute the different status reports to different stakeholders at various intervals based on the configured report template or a previous status report throughout the course of the major security incident resolution.
locale: en-US
release: xanadu
...
<table id="choicetable_lfv_mkq_d1c"><thead><tr><th align="left" id="d293282e249">

Report section

</th><th align="left" id="d293282e252">

Description

</th></tr></thead><tbody><tr><td id="d293282e258">
...
9.  Select **Share** to share the status report with internal and external stakeholders.
    ...
    1.  In the Subject field, enter the subject for the email report.

    2.  In the Add internal recipients field, type and select the recipients for the email report.

    3.  In the Add external recipients field, type the recipients' email or DL for the email report.

        You can add multiple email IDs using a comma or semi-colon.
