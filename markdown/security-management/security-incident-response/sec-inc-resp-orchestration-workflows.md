...
Only users with the sn\_sec\_cmn.admin role can [Workflow editor](https://www.servicenow.com/docs/access?context=workflow-editor&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
