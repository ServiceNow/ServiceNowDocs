...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/si-phishing-template.html
release: yokohama
...
1.  Open the security incident for this potential spear phishing attack, or [create a new security incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/t_ManuallyCreateSecurityIncident.md).
