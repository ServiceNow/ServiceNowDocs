---
title: View, edit, and reassign security incidents using Security Incident Response Mobile app
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/mobile-sir-my-incidents.html
release: zurich
...
# View, edit, and reassign security incidents using Security Incident Response Mobile app
...
1.  If you are not logged in to your ServiceNow AI Platform instance on your mobile device, see [Log in to the Security Incident Response Mobile app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/mobile-sir-get-started.md).
...
<table id="choicetable_er2_4pf_thb"><thead><tr><th align="left" id="d482433e156">

Option

</th><th align="left" id="d482433e159">

Description

</th></tr></thead><tbody><tr><td id="d482433e165">
...
2.  Tap a name from the list that is displayed, or enter text in the search field.
 Tap the **Submit** to save and submit your changes.
...
<table id="choicetable_yfw_cgw_lhb"><thead><tr><th align="left" id="d482433e223">

Option

</th><th align="left" id="d482433e226">

Description

</th></tr></thead><tbody><tr><td id="d482433e232">
