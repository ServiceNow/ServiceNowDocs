...
description: If you are an existing user, then follow the procedure in this section to activate Microsoft Teams chat connector.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/activate-microsoft-teams-chat-connector-for-existing-users.html
release: xanadu
...
breadcrumb: [Using Client Secret value, Establish MS Teams Graph connection on ServiceNow AI Platform, Integrating Major Security Incident Management, Major Security Incident Management, Security Incident Response, Enterprise security case management applications, Security Operations]
---

# Activate MS Teams chat connector for MS Teams Graph Spoke user

If you are an existing user, then follow the procedure in this section to activate Microsoft Teams chat connector.
...
**Parent Topic:**[Using Client Secret value](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/using-client-secret-value.md)
