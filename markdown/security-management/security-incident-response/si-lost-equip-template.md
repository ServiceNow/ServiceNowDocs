...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/si-lost-equip-template.html
release: yokohama
...
\[Omitted image "lost-equip-wf-template.png"\] Alt text: Lost Equipment Template

## Procedure

1.  Open the security incident for the equipment loss, or [create a new security incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/t_ManuallyCreateSecurityIncident.md).
