---
title: Create and configure a profile for sightings search with the FireEye Integration
description: Configure the sightings search profile using the following procedure.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/create-configure-profile-for-sightings-search-with-fireeye-integration.html
release: xanadu
