...
9.  Select **Select improvement opportunities** and configure the improvements for your security incidents.
    ...
    A list of improvement opportunities displays. For information about configuring improvement opportunities, see [Working with improvement opportunities](https://www.servicenow.com/docs/access?context=working-with-imp-opp&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
