...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/install-zscaler-integration-for-security-operations.html
release: yokohama
