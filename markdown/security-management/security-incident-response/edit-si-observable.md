...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/edit-si-observable.html
release: yokohama
...
5.  Add or remove observables from the list.
    ...
    \[Omitted image "EditObservableList.png"\] Alt text: Edit observables list example
...
[Create a security incident observable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/create-si-observable.md)
