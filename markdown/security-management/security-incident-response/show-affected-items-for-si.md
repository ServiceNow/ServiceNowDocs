...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/show-affected-items-for-si.html
release: xanadu
...
4.  Click any of the following related links to further update the security incident:
    ...
    -   [Show Response Tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/show-response-tasks-for-si.md)
