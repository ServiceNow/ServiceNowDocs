...
For more information on Access Control Rules, see [Explore Access Control Lists](https://www.servicenow.com/docs/access?context=exploring-access-control-list&version=zurich&pubname=zurich-platform-security&ft:locale=en-US)
