...
For more information on Access Control Rules, see [Exploring Access Control Lists](https://www.servicenow.com/docs/access?context=exploring-access-control-list&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US)
