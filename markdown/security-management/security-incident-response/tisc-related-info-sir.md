...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/tisc-related-info-sir.html
release: yokohama
...
3.  Once the incident is open, navigate to **TISC Context** tab.
    ...
    **Viewing View Related Information:**
    ...
    2.  Click on **View Related Info** button.
        ...
        |Name|Description|
        |----|-----------|
        |Threat Actors|Shows information from TISC for Threat Actors related to the selected observables.|
        |Attack Patterns|Shows information from TISC for Attack Patterns related to the selected observables.|
