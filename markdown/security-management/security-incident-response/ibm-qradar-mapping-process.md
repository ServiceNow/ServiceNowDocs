...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/ibm-qradar-mapping-process.html
release: xanadu
