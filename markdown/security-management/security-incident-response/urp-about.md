...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/urp-about.html
release: xanadu
...
Define the header information that needs to be captured from user reported phishing emails. For more information, see [Define User Reported Phishing properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/urp-about.md).
...
\[Omitted image "urp-diff-image.png"\] Alt text: User Reported Phishing: Differences
...
4.  Click **Submit** to save the rule.
    ...
    -   **ToRule**: Filter emails that have been sent directly or forwarded to `security@example.com` email id. \[Omitted image "urp-torule-example.png"\] Alt text: Define ToRule
...
-   Finally, the [Transform user-reported phishing emails to security incidents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/urp-about.md) flow is applied to convert the phishing email record to a security incident.
...
\[Omitted image "urp-emailmatch-torule.png"\] Alt text: URP ingestion rule As you can see, in this example, the **Condition** field shows that the ToRule is applied on this email and a security incident is created. See [Set up ingestion rules for User Reported Phishing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/urp-about.md) for more information on defining email matching rules.
...
-   In step 2, the oldest parent security incident is identified.
    ...
    -   Subject or From value match the email matching rule conditions defined \(See [Set up ingestion rules for User Reported Phishing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/urp-about.md)\).
...
-   Step 3 is applicable only if the **Create child incidents for aggregated email submissions?** flag was set to **No** in the [Transform user-reported phishing emails to security incidents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/urp-about.md) page.
    ...
    \[Omitted image "urp-transform-flow-action3.png"\] Alt text: Transform flow: Action 3
...
-   If the **Create child incidents for aggregated email submissions?** is set to **Yes**, the flow continues to run and a new security incident is created based on the user-reported phishing email.
    ...
    \[Omitted image "urp-transform-flow-action4.png"\] Alt text: Transform flow: Action 4
...
\[Omitted image "urp-transform-flow-execute.png"\] Alt text: Transform flow: Execution details

When the flow has been executed, the phishing email record is converted to a security incident. See [Security incident records created from phishing email records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/urp-about.md).
...
\[Omitted image "urp-sec-rec-child.png"\] Alt text: Child security incidents
...
\[Omitted image "urp-sec-new-ui.png"\] Alt text: URP security incident: New UI

Select the binoculars icon. The original phishing email is displayed.

\[Omitted image "urp-sec-new-ui-phish-email.png"\] Alt text: URP security incident: New UI - phishing email

In the **Explore** tab, select **Incidents** &gt; **Child Security Incidents**.

\[Omitted image "urp-sec-new-ui-phish-child.png"\] Alt text: URP security incident: New UI - child security incidents
...
\[Omitted image "urp-sec-rec-phish-assoc-header.png"\] Alt text: URP: New UI - Email headers

Select on the phishing email link to view the phishing email record associated with the security incident.

\[Omitted image "urp-sec-rec-phish-from-email.png"\] Alt text: URP: New UI: phishing email record

Select the **Incident Timeline** tab.

\[Omitted image "urp-sec-newui-worknotes.png"\] Alt text: URP: New UI: worknotes
...
1.  I have installed the new Security Incident Response spoke but I cannot view any user reported phishing incidents.
    ...
    To enable this feature, you must make a copy of the read-only [Transform user-reported phishing emails to security incidents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/urp-about.md) flow and activate it before use.
