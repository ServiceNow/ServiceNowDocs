...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/using-reports-lists-in-your-report-templates.html
release: yokohama
...
2.  Drill down to **Report Template** &gt; **Lists**.

3.  Select **Configure**.

    The MSI Status Reports Lists section describes how each specific related list is affected since the incident is created. The following are the predefined MSI Report Lists as a part of the base system, which you can use to configure and modify your status reports.
...
**Parent Topic:**[Create a Report Template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/create-report-template.md)
