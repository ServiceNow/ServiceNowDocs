...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/creating-a-view-for-the-new-linked-record-tab.html
release: xanadu
...
-   Choose the order of the fields to be displayed in the drop-down list.
    ...
    \[Omitted image "list-layout-security-case-step4.png"\] Alt text: List layout for a security case.
...
1.  Search for **sn\_msi\_m2m\_child.list** using the left navigation.
    ...
    \[Omitted image "linked-records-table-step4.png"\] Alt text: Linked records table.

2.  Right-click the header and select **Configure** &gt; **List Layout**.

    The Configuring Linked Records List page is displayed.

    \[Omitted image "configure-linked-record-step4.png"\] Alt text: Configure options.
