...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/edit-report-sir.html
release: yokohama
...
10. Select the share report in email icon \[Omitted image "share-report-icon-sir.png"\] Alt text: email icon.
...
**Parent Topic:**[Reports in Security Incident Response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/report-templates-sir.md)
