...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/playbook-using-windows-events-logs.html
release: yokohama
...
3.  In Action 3, if the user has not been identified, perform the following steps:
    ...
    2.  In Action 5, check whether the user has been identified from the CMDB or not.
        ...
        \[Omitted image "playbook-windows-event-user-identify.png"\] Alt text: Response task if the user has not been identified in the Windows Events Logs Cleared playbook
...
5.  In Action 17, reach out to the user for validation of their business justification.
    ...
    \[Omitted image "playbook-windows-event-user-not-identified.png"\] Alt text: Response task if the user has been identified in the Windows Events Logs Cleared playbook
...
**Parent Topic:**[Playbook for T1070 - Windows Events Logs Cleared](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/playbook-windows-events-log.md)
