...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/setup-sandbox-submission-configurations.html
release: xanadu
...
After you configure sandbox submissions, the next step is to [manually submit files or ULRs to Sandbox](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/submit-files-or-urls-to-sandbox.md)
