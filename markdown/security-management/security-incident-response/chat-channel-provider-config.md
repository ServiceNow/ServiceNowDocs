...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/chat-channel-provider-config.html
release: zurich
...
-   [Activate MS Teams as a chat provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/chat-provider-configuration.md)
...
-   [View Chat Message Activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/chat-message-activity.md)

-   **[Get started with Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/get-started-with-microsoft-teams.md)**  
...
-   **[Microsoft Teams Chat Connector troubleshooting for MSIM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/microsoft-teams-chat-connector-troubleshooting-for-msim.md)**  
...
**Parent Topic:**[Configuring Major Security Incident Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/configuring-major-security-incident-management.md)
