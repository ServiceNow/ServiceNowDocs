...
7.  From the drop down, select the **Workflow action label** configured while setting up the add-on.
    ...
    For more information on Workflow action label, see [Set up ServiceNow Event Ingestion Integration add-on](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/security-incident-response/splunk-event-ingest-setup-prereqs.md)
