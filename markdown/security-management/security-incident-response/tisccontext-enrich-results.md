...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/tisccontext-enrich-results.html
release: yokohama
...
3.  Once the incident is open, navigate to **TISC Context** tab.
    ...
    **Viewing Enrichment Results:**
    ...
    2.  Click on **View Enrichment Results** button.
        ...
        \[Omitted image "tisc-context-view-enrich-results.png"\] Alt text: TISC Context - View Enrichment Results.
