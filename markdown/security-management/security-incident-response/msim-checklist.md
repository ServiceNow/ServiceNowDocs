...
Microsoft SharePoint manages sites, folders, files, groups, and users in Microsoft SharePoint.
 ...
 For information, see [Microsoft SharePoint spoke v1.1.2](https://www.servicenow.com/docs/access?context=sharepoint-online-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) documentation on how to setup REST and Graph connections Configuration.
