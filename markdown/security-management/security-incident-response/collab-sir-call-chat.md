...
-   **[Start a conference call in Security Incident Response](../task/initiate-conf-call-sir.md)**  
...
-   **[Add participants to active Conference Call](../task/add-members-conf-call-sir.md)**  
You can add participants to an active conference call if you have not added them before starting the conference call.
-   **[Start a Sidebar chat in Security Incident Response](../task/initiate-chat-sidebar-sir.md)**  
