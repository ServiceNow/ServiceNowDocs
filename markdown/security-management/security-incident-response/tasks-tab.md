...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/tasks-tab.html
release: zurich
...
\[Omitted image "msim-tasks-list-view.png"\] Alt text: Tasks List view
...
-   **[Manage tasks using the Visual Task Board](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/manage-tasks-using-vtb.md)**  
Track and manage all the tasks associated with a major security incident using the Visual Task Board \(Kanban view\).
-   **[Manage tasks using the List view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/manage-tasks-using-list-view.md)**  
