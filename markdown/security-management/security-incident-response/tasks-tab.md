...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/tasks-tab.html
release: yokohama
...
The sn\_msi.workspace\_manager can do the following on the Tasks tab:

-   Create a task
-   Modify tasks
-   View and assign tasks to self or others
-   Delete tasks

**Note:** Make sure you have installed the **MSIM VTB Task Card: 1.0.1v** app separately after installing the MSIM app.

The Tasks tab displays the details of all the tasks associated with a major security incident. The Task tab supports two views:
...
-   **Visual Task Board \(Kanban view\)**:
    ...
    \[Omitted image "msim-tasks-kanban-view.png"\] Alt text: Visual Task Board view
...
\[Omitted image "msim-tasks-list-view.png"\] Alt text: Tasks List view \[Omitted image ""\] Alt text:
...
-   **[Manage tasks using the Visual Task Board](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/manage-tasks-using-vtb.md)**  
Track and manage all the tasks associated with a major security incident using the Visual Task Board \(Kanban view\).
-   **[Manage tasks using the List view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/manage-tasks-using-list-view.md)**  
