...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/t\_SubmitThrtReqFromSecInc.html
release: xanadu
...
1.  [Create a new security incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/t_ManuallyCreateSecurityIncident.md) or open an existing one if you intend to attach new files to it.
