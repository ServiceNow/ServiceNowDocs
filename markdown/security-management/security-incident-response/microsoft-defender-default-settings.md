...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/microsoft-defender-default-settings.html
release: yokohama
...
breadcrumb: [Install the application and configure a source for the integration, Microsoft Defender for Endpoint integration, Security Incident Response integrations, Security Incident Response, Enterprise security case management applications, Security Operations]
---
