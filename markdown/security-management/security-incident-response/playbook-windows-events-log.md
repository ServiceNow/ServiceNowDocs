...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/playbook-windows-events-log.html
release: xanadu
...
-   **[Set up the T1070 - Windows Events Logs Cleared playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/playbook-setup-windows-events-logs.md)**  
Use the following steps to set up the T1070 - Windows Events Logs Cleared playbook.
-   **[Use the T1070 - Windows Events Logs Cleared playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/playbook-using-windows-events-logs.md)**  
