...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/security-incident-response/arcsight-esm-create-profile-preview.html
release: australia
...
2.  From the Sample Event IDs list, select an item.
