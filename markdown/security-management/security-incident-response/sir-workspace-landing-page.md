...
[Explore Workspace ![](../../../common/image/icon-explore.png) Learn about SIR Workspace concepts and features](exploring-security-incident-response-workspace.md)

</td><td>

[Admins using Workspace ![](../../../common/image/icon-set-up.png) Configure SIR Workspace and features](configuring-security-incident-response-workspace.md)

</td></tr><tr><td>

[Analysts using Workspace ![](../../../common/image/icon-workspace.png) Learn how Analysts use SIR Workspace](using-sir-workspace.md)

</td><td>

[View SIR Dashboards ![](../image/icon-dashboard.png) View SIR Workspace dashboards](../concept/working-with-analysts-dashboard.md)
