...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/enrich-wildfire-data.html
release: yokohama
...
\[Omitted image "get-wildfire-flow.png"\] Alt text: Wildfire data enrichment flow
