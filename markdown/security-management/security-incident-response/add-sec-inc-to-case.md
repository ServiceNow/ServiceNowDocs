...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/add-sec-inc-to-case.html
release: yokohama
...
2.  Click the **Add to Security Case** related link.
    ...
    \[Omitted image "AddSecIncToCase2.png"\] Alt text: Add this security incident to an existing or new case
...
4.  If you have one or more cases assigned to you, but want to create a new case and assign the security incident to it, click **Create new case** to show additional fields.
    ...
    \[Omitted image "AddSecIncToCase.png"\] Alt text: Add this security incident to a new case
...
[Security Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/case-mgmt.md)
