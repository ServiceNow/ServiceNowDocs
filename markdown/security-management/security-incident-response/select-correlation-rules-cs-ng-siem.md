---
title: Set correlation rules for CrowdStrike Next-Gen SIEM integration
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/select-correlation-rules-cs-ng-siem.html
release: xanadu
...
Map individual CrowdStrike Next-Gen SIEM detection fields to the fields on the ServiceNow AI Platform Security Incident Response security incident. For more information, see [Map the CrowdStrike Next-Gen detection fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/map-crowdstrike-next-gen-inc.md).
