---
title: Send Sighting Search to TISC
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/send-sighting-search-to-tisc.html
release: yokohama
...
3.  Select one or more Sighting Search Results record.
    ...
    \[Omitted image "tisc-sighting-search-sir.png"\] Alt text: Sighting Search

4.  Click **Send Results to TISC**.

    **Note:**

    -   If the selected sighting search observable isn't present in TISC, then in manual mode first the observable is created as observable source and then once source observable creates TISC observable record, the observable record will be automatically associated with the newly created observable. Also, selected sighting search will also be pushed to the newly created threat lookup observable in manual mode.
...
**Parent Topic:**[Send data from SIR Workspace to TISC](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/send-sir-to-tisc.md)
