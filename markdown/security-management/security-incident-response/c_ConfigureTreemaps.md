...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/c\_ConfigureTreemaps.html
release: xanadu
...
-   **[Add treemaps to the Security Incident Response overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/t_AddTreemapsToSIRHomepage.md)**  
...
-   **[Create or update a treemap category](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/t_DfnSvcImpctTmapDmn.md)**  
You can modify the predefined categories for the security incident treemaps or create categories as needed.
-   **[Create or update a treemap indicator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/t_CreateUpdateTreemapIndicator.md)**  
