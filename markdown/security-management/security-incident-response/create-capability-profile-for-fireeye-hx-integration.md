---
title: Create a new capability profile for the FireEye Endpoint integration
description: Create a profile and select the FireEye HX capabilities that you want the profile to run.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/create-capability-profile-for-fireeye-hx-integration.html
release: xanadu
...
</table>    \[Omitted image "fireeye-profile-config.png"\] Alt text:
