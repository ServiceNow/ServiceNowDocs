...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/security-incident-response/t\_ViewRelatedAlerts.html
release: australia
...
1.  Navigate to any security incident list \(for example, **All** &gt; **Security Incident** &gt; **Incidents** &gt; **Unassigned Incidents**\).
