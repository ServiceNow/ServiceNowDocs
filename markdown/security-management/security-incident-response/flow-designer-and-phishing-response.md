...
To create custom templates \(flows\), follow the instructions in [Flows](https://www.servicenow.com/docs/access?context=flows&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
