...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/qradar-ibm-domain-sep.html
release: yokohama
...
\[Omitted image "ibm-qradar-domain-sep2.png"\] Alt text: IBM QRadar Process Profiles and Offense Updates job
