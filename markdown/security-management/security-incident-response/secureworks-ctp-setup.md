...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/secureworks-ctp-setup.html
release: zurich
...
-   A user with the sn\_si.admin role oversees the following tasks in the ServiceNow AI Platform:
 ...
 For more information about roles and assigning roles to users, see [Managing roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/ua-creating-roles.md)
