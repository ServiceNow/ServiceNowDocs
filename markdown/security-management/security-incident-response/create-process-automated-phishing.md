...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/create-process-automated-phishing.html
release: xanadu
...
6.  Choose the conditions to define when your process must run by selecting a table and filling in the conditions.
    ...
    \[Omitted image "automated-phishing.gif"\] Alt text: Automated phishing playbook
...
13. Click **Create a new activity**.
    ...
    \[Omitted image "automated-phishing.gif"\] Alt text: Automated Phishing Activity
...
**Parent Topic:**[Playbook for Automated Phishing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/playbook-automated-phishing.md)
