...
6.  Choose the conditions to define when your process must run by selecting a table and filling in the conditions.
    ...
    ![Automated phishing playbook](../image/automated-phishing.gif "Automated Phishing playbook")
...
13. Click **Create a new activity**.
    ...
    ![Automated Phishing Activity](../image/automated-phishing.gif "Automated Phishing Activity")
