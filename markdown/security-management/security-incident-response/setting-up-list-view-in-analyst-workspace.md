...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/setting-up-list-view-in-analyst-workspace.html
release: zurich
...
To get to the list view, select the list icon \(\[Omitted image "listview-icon.png"\] Alt text: list view icon\). When you select a record in a list view, the record opens in a new tab.
...
-   Report Phishing Email. For more information, see [Report Phish Email](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/report-phish-email.md) on how to report a phishing email.
...
</table>-   **[Personalize a list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/personalize-a-list.md)**  
...
-   **[Apply quick filters on Security Incidents and Response Tasks lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/use-quick-filters-for-security-incidents.md)**  
Apply the predefined quick filters on Security Incidents and Response Tasks lists to get the desired work items.
-   **[Assign Security Incidents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/assign-security-incident.md)**  
Assign security incidents.
-   **[Close multiple security incidents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/close-multiple-incidents-sir.md)**  
...
-   **[Assign Response Tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/assign_response_tasks.md)**  
Assign Response tasks for a security issue.
-   **[Report Phish Email](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/report-phish-email.md)**  
Report phishing emails from the lists view.
-   **[Working with quick filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/configure-quick-filters.md)**  
Quick filters are easily accessible filters that are available on, security incidents and response tasks lists.
-   **[Export Security Incidents or Response Tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/export-security-incidents-or-response-tasks.md)**  
Export the security incidents or response tasks from the list view.
-   **[Manage Shift Handover records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/manage-shift-handover-records.md)**  
...
**Parent Topic:**[Exploring SIR Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/exploring-security-incident-response-workspace.md)
