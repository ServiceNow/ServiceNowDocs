...
breadcrumb: [SIR Workspace Orchestration, Working with Security Incident Records, Using SIR Workspace, Security Incident Response Workspace, Security Incident Response, Enterprise security case management applications, Security Operations]
---
...
-   **[Unified Experience example](unified-expereince-example.md)**  
