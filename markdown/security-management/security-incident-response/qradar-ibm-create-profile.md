---
title: Create a profile for IBM QRadar offense ingestion integration
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/qradar-ibm-create-profile.html
release: xanadu
...
breadcrumb: [Set up your ServiceNow AI Platform instance for the IBM QRadar offense ingestion integration, IBM QRadar Offense Ingestion Integration, Security Incident Response integrations, Security Incident Response, Enterprise security case management applications, Security Operations]
---
