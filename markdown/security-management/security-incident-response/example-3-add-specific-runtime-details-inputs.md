...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/security-incident-response/example-3-add-specific-runtime-details-inputs.html
release: australia
