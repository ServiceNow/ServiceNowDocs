...
To configure the MSIM Conference Call Cisco Webex integration using the Notify communication channel, see [Configure Notify Cisco Webex Connector](https://www.servicenow.com/docs/access?context=setup-cisco-webex-notify&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
