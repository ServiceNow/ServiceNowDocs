...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/assign-security-incident.html
release: yokohama
...
4.  For example, go to **Security Incidents** &gt; **All Open**.
