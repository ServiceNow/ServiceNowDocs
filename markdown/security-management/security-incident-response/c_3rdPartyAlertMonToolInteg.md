...
To integrate alert monitoring tools to Security Incident Response, you must use the [REST API](https://www.servicenow.com/docs/access?context=c_RESTAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) to write to the Security Incident Import \[sn\_si\_incident\_import\] table. Then, using the **Security Incident Transform** [transform maps](https://www.servicenow.com/docs/access?context=c_CreatingNewTransformMaps&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US), the import set source table is mapped to fields in the target Security Incident \[sn\_si.incident\] table.
