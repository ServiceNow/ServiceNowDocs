...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/on-demand-orchestration.html
release: xanadu
...
-   If the property is set to **false** \(default\), all workflows for applications configured in the [SecOps Application Registry](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/register-new-secops-apps.md) are available.
