...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/on-demand-orchestration.html
release: yokohama
...
Each registered Security Operations application includes several on-demand orchestrations in the base system. You can define [custom on-demand orchestrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/define-new-on-demand-orchs.md), as needed.
...
-   If the property is set to **false** \(default\), all workflows for applications configured in the [SecOps Application Registry](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/register-new-secops-apps.md) are available.
