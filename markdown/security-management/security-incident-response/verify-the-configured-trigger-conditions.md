...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/verify-the-configured-trigger-conditions.html
release: xanadu
...
breadcrumb: [Configure profiles and security incidents for the FireEye HX integration, FireEye Endpoint Security integration, Security Incident Response integrations, Security Incident Response, Enterprise security case management applications, Security Operations]
---
...
2.  Select **New** to create a new security incident.
...
6.  View the profile initiated, profile completed, or profile failed tags.

7.  Click **Show all Related lists**.

8.  Click any related list \(tab\).
