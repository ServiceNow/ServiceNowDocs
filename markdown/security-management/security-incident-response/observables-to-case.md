...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/observables-to-case.html
release: yokohama
...
7.  Select **Add to TISC Case**.
    ...
    \[Omitted image "tisc-related-records-add2-case.png"\] Alt text: Adding observables to TISC Case
