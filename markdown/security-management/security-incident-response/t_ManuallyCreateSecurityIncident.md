...
If needed, select a [Security tag](../../security-operations-common/task/create-class-group-and-tags.md) to add metadata to the record or identify who should have access to this security incident record. This field appears only after the security incident has been saved.
...
As you type the short description, links to related articles from the knowledge base appear. Scanning the information could solve your issue.
    ...
    -   [Security Incident Response - Get Running Services Flow](../../security-incident-response-orchestration/task/get-running-services-workflow.md). This workflow retrieves a list of running services from Windows-based CIs.
    -   [Security Operations Integrations - Get Network Statistics workflow](../../security-operations-integrations/task/secops-integration-get-network-stats-workflow.md). This workflow retrieves a list of active network connections from a host or endpoint.
