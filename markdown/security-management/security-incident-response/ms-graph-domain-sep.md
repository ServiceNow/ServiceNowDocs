...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/ms-graph-domain-sep.html
release: yokohama
...
\[Omitted image "ms-graph-domain-sep.png"\] Alt text: Microsoft Graph Security API: Domain Separation I

\[Omitted image "ms-graph-domain-sep1.png"\] Alt text: Microsoft Graph Security API: Domain Separation II
