...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/sir-new-ui-add-playbook.html
release: yokohama
...
\[Omitted image "add-task-button-callout-1.png"\] Alt text: Security Incident New UI: Select playbook
