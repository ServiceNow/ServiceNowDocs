...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/mobile-sir-high-priority-incndts.html
release: xanadu
...
From the list of records, assign an open, critical security incident to yourself or to another analyst in your group. Alternatively, view the details and related lists of the record or add a work note prior to assignment. Time to complete this task: 5-10 minutes.
...
3.  Refer to [Search for security incidents with the Security Incident Response Mobile app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/mobile-sir-search.md) to search for security incidents that match specific criteria.
...
<table id="choicetable_er2_4pf_thb"><thead><tr><th align="left" id="d140628e184">

Option

</th><th align="left" id="d140628e187">

Description

</th></tr></thead><tbody><tr><td id="d140628e193">
...
<table id="choicetable_yfw_cgw_lhb"><thead><tr><th align="left" id="d140628e277">

Option

</th><th align="left" id="d140628e280">

Description

</th></tr></thead><tbody><tr><td id="d140628e286">
