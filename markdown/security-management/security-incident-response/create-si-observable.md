...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/create-si-observable.html
release: zurich
...
-   Default value: Unknown. For more information, see [Threat Lookup Finding Calculators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/threat-lookup-finding-calculators.md).
...
Using the settings in two properties and a script include definition, you can load [Load more IoC data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/t_LoadAdditionalIoCData.md) in this field.
...
[Edit a security incident observable list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/edit-si-observable.md)

[Add multiple security incident observables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/add-multiple-si-observables.md)
