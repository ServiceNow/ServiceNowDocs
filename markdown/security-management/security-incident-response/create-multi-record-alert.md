...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/create-multi-record-alert.html
release: yokohama
...
2.  In the **Search** box, create a search that generates your record data.
    ...
    See the [examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/multi-record-examples.md) for recommended search criteria.
