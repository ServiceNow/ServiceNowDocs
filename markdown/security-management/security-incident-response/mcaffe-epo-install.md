...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/security-incident-response/mcaffe-epo-install.html
release: australia
...
**Previous topic:**[Set up your McAfee ePO console to integrate with Security Incident Response \(SIR\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/security-incident-response/mcafee-epo-setup-mcafee.md)

**Next topic:**[Edit security tags in the ServiceNow AI Platform for the McAfee ePO integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/security-incident-response/mcafee-epo-match-tags.md)
