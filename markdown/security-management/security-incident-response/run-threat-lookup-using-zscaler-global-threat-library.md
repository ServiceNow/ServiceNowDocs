...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/run-threat-lookup-using-zscaler-global-threat-library.html
release: xanadu
