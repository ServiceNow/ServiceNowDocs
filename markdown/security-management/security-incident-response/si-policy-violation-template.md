...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/si-policy-violation-template.html
release: yokohama
...
\[Omitted image "policy-violation-wf-template.png"\] Alt text: Policy Violation Template

## Procedure

1.  Open the security incident for the policy violation, or [create a new security incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/t_ManuallyCreateSecurityIncident.md).
...
**Parent Topic:**[Security Incident Response workflow templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/sir-orch-workflow-templates.md)
