---
title: Playbook for Repeat Detection
description: This playbook helps you determine if the incident response has been provided on an exact or similar phishing report in the past and automatically works on the new report similarly.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/playbook-repeat-detection.html
release: yokohama
...
-   **[Set up the Repeat Detection playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/playbook-setup-repeat-detection.md)**  
Use the following steps to set up the Repeat Detection playbook.
-   **[Use the Repeat Detection playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/playbook-using-repeat-detection-playbook.md)**  
