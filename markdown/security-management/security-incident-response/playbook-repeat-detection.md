...
-   **[Set up the Repeat Detection playbook](../task/playbook-setup-repeat-detection.md)**  
Use the following steps to set up the Repeat Detection playbook.
-   **[Use the Repeat Detection playbook](../task/playbook-using-repeat-detection-playbook.md)**  
