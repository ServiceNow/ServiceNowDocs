...
1.  Verify that you have assigned the required ServiceNow AI Platform® and Security Incident Response \(SIR\) roles.
    ...
    For more information, see [Managing roles](https://www.servicenow.com/docs/access?context=ua-creating-roles&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
...
If you want to export notable events manually and on-demand from your Splunk Enterprise Security console for the integration, see [Setup ServiceNow Security Operations Event Ingestion Addon for Splunk ES](../task/splunk-es-addon.md) for more information.
