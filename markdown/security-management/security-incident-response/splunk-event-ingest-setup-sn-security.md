...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/splunk-event-ingest-setup-sn-security.html
release: yokohama
...
1.  Verify that you have assigned the required ServiceNow AI Platform® and Security Incident Response \(SIR\) roles.
    ...
    For more information, see [Managing roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/user-administration/ua-creating-roles.md).
...
If you want to export notable events manually and on-demand from your Splunk Enterprise Security console for the integration, see [Setup ServiceNow Security Operations Event Ingestion Addon for Splunk ES](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/splunk-es-addon.md) for more information.
