...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/qradar-ibm-intg-settings.html
release: xanadu
...
Option to ingest ADE Rules in IBM QRadar Rules list.ADE Rules will fetch Anomaly Rules created in IBM QRadar.
