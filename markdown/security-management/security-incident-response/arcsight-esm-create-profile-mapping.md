...
7.  Open the script editor and continue editing.
    ...
    For more information about the script editor, see [Use the script editor to format correlation event values for ArcSight ESM integration](arcsight-esm-create-profile-script.md).**Incident generation filtering conditions**
...
<table id="choicetable_ov3_gbq_nkb"><thead><tr><th align="left" id="d171803e483">

Option

</th><th align="left" id="d171803e486">

Description

</th></tr></thead><tbody><tr><td id="d171803e492">
