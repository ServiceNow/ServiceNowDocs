...
4.  On the Create New Quick Filters, fill in the fields.
    ...
    |Conditions|Use the [condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US) to define the criteria to be filtered.|
