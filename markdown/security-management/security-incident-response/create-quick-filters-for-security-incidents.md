...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/security-incident-response/create-quick-filters-for-security-incidents.html
release: zurich
...
4.  On the Create New Quick Filters, fill in the fields.
    ...
    |Conditions|Use the [condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_ConditionBuilder.md) to define the criteria to be filtered.|
