...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/using-conf-call-ms-teams-integration.html
release: xanadu
...
breadcrumb: [Integrate MSIM Conference Calls with Microsoft Teams, Major Security Incident Management Conference Call Integration, Integrating Major Security Incident Management, Major Security Incident Management, Security Incident Response, Enterprise security case management applications, Security Operations]
---
...
10. Select the **Click here** option on top of the major security incident to join the conference call on the Microsoft Teams app.
    ...
    \[Omitted image "msim-conf-teams-email.png"\] Alt text: MSIM email notification for the Microsoft Teams conference call
...
**Parent Topic:**[Integrate MSIM Conference Calls with Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/integrate-msim-conf-call-ms-teams.md)
