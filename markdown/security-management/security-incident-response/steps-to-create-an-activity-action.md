...
2.  Click **New**.
    ...
    Refer to the [ServiceNow AI Platform](https://www.servicenow.com/docs/access?context=now-platform-landing&version=yokohama&pubname=yokohama-now-platform&ft:locale=en-US) documentation to know how to create these actions. In this example, Skip is implemented as a server script.
