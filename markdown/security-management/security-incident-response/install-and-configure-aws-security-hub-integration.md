...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/install-and-configure-aws-security-hub-integration.html
release: yokohama
