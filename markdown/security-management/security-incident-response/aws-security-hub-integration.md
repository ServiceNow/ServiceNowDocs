...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/aws-security-hub-integration.html
release: xanadu
...
\[Omitted image "aws-security-hub-overview.png"\] Alt text: How AWS Security Hub integrates with the ServiceNow Platform.
