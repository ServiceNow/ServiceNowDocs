...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/security-incident-response/tisc-si-case.html
release: australia
...
7.  View the associated case records by logging into Threat Intelligence Security Center workspace for further steps.
    ...
    For more information see, [TISC integration with SIR Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/threat-intelligence-security-center/tisc-integration-with-sir-workspace.md).
...
[Enable security incidents for vulnerabilities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/security-incident-response/tisc-view-security-context.md)
