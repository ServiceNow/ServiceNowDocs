...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/activate-configure-qradar-inc-enrich.html
release: yokohama
...
4.  In the IBM QRadar - Incident Enrichment card, click **New**.
    ...
    \[Omitted image "QRadar-config.png"\] Alt text: IBM QRadar - Incident Enrichment Configuration
...
**Parent Topic:**[IBM QRadar - Incident Enrichment Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-incident-response/qradar-landing-page.md)
