...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-incident-response/map-view-to-the-entry-point-list.html
release: xanadu
...
3.  Enter the view name containing the associated info related lists in the **Associated Info View** field.
    ...
    For information on how to create a view for the associated info related lists, see [Creating View for associated info tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-incident-response/creating-view-for-associated-info-tables.md).
