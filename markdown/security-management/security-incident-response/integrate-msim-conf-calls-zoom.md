...
To configure the MSIM Conference Call Zoom integration using the Notify communication channel, see [Configure Notify Zoom connector in Notify](https://www.servicenow.com/docs/access?context=configure-notify-zoom-connector&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
