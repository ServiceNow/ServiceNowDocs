...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-incident-response/activate-configure-carbonblack-inc-enrich.html
release: yokohama
...
4.  In the Carbon Black - Incident Enrichment card, click **Configure**.
    ...
    \[Omitted image "carbonblack-config.png"\] Alt text: Carbon Black Incident Enrichment
