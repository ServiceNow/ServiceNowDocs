...
6.  To create a profile that supports manual event forwarding, follow these steps.
    ...
    2.  In the Mapping Option field that is displayed, from the choice list, choose one mapping option to continue.
        ...
        ![Mapping Option field highlighted.](../image/splunk-manualevent1.png "Create new field mapping option")
...
Text to help you distinguish this profile from other profiles.
        ...
        ![Search icon highlighted for copy existing mapping option.](../image/copy_mapping.png "Select existing profile for field mapping option")
...
-   **[Preview the security incident for the Splunk Enterprise Event Ingestion integration](splunk-event-ingest-preview.md)**  
