...
2.  Search for **Quick Filters** \(sn\_si\_aw\_quick\_filters\).
    ...
    ![quick filters](../../security-incident-response/image/quick-filters.png)
...
9.  Click **Update**.
    ...
    ![Quick Filters: Tasks opened today](../image/update-existing-filter-record.png "Quick filters")
