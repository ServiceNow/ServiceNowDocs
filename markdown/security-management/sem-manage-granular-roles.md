...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/sem-manage-granular-roles.html
release: australia
topic_type: task
...
For key terms and an overview of persona roles, see [Vulnerability Response personas and granular roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/vulnerability-response/vr-persona-overview.md).
