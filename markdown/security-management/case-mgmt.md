...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/case-mgmt.html
release: xanadu
topic_type: concept
...
-   [Run a sightings search on observables in a case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/run-local-sighted-srch.md)
