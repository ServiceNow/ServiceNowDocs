...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/sem-installing-required-applications.html
release: australia
topic_type: concept
...
3.  See [Download and activate applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/sem-install-required-applications.md) for a list of the required applications and installation steps for the Security Exposure Management Workspace.
4.  See [Security Exposure Management Workspace Components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/sem-components-installed.md) for roles and tables that are installed with the applications.
