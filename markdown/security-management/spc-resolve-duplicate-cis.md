...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/spc-resolve-duplicate-cis.html
release: yokohama
topic_type: task
...
2.  Locate the sn\_sec\_spc-core.is\_ci\_name\_unique system property.
    ...
    See [Resolving duplicate configuration items in Security Posture Control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/spc-using-dedup-template.md) for more information about how to identify duplicate CIs.
