...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/t\_AddAttackModeMethod.html
release: yokohama
topic_type: task
...
Select the threat data source for this attack mode/method. Some data sources are included with the base system. You can [create new data sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/c_GetStartedWithThreatIntel.md) as needed.
...
**Parent Topic:**[Attack modes and methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/c_AttackModeMethod.md)
