...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/set-network-isolation-enabled-activity-cb-wf.html
release: xanadu
...
**Parent Topic:**[Security Operations Carbon Black Integration - Isolate Host Flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/secops-integration-cb-isolate-host-workflow.md)
