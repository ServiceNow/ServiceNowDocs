...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/sem-new-scheduledjobs-installed.html
release: australia
...
|Application|Scheduled job name|Description|
|-----------|------------------|-----------|
|Security Exposure Management|Trigger aggregation creation and running for dashboard|Initiates the creation and execution of dashboard aggregations.|
...
**Parent Topic:**[Security Exposure Management Workspace Components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/sem-components-installed.md)
