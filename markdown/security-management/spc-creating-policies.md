...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/security-management/spc-creating-policies.html
release: brazil
topic_type: concept
...
See [Policies for Security Posture Control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/security-management/spc-policies-overview.md) for more information about the Security Posture Control policy schema.
