...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/integrating-usem.html
release: yokohama
topic_type: concept
...
1.  Vulnerability entries are imported from the National Vulnerability Database \(NVD\) and third-party scanners.
...
-   **No cross-integration deduplication**: If multiple third-party integrations are active, findings aren’t deduplicated across them. For example, Rapid7 and Qualys findings remain separate.
-   **Detection count mismatches**: Variations between scanner counts \(for example, Qualys\) and ServiceNow findings are expected due to deduplication across IPs, ports, and so on
...
[Understanding the Tenable Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/tenableIntegration.md)
...
[Understanding the Rapid7 Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/r7-vuln-integration.md)
...
[Understanding the Qualys Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/c_QualysVulnIntegration.md)
...
[Understanding the Wiz Vulnerability Response Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/vr-wiz-exploring-host-cf.md)
...
[Vulnerability Response Integration with Palo Alto Networks Prisma Cloud Compute integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/container-vulnerability-response/pcc-integration.md)
...
[Exploring the Wiz Container Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/container-vulnerability-response/wiz-exploring-cvr-vuln-intcf.md)
...
[Microsoft Security Response Center Solution Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/mscr-integration.md)
...
[Red Hat Solution Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/redhat-integration.md)
...
[Rapid7 solution management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/rapid-7-solution-management.md)
...
-   [Generic framework to ingest data from any solution vendor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/ingest-data-solution-vendors-generic-framework.md)
-   [Setting up vulnerability solution providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/setup-vulnerability-solution-providers.md)
...
[Understanding the Shodan Exploit Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/shodan-exploit-vuln-integration.md)
...
[CISA Known Exploit Vulnerability \(KEV\) Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/cisa-vuln-integration.md)
...
[Understanding the Exploit Prediction Scoring System \(EPSS\) integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/epss-vr-integration-overview.md)
...
[Understanding the HCL BigFix patch orchestration integration with Vulnerability Response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/vr-bigfix-integration.md)
...
[Understanding the Vulnerability Response Integration with Palo Alto Prisma Cloud](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/configuration-compliance/prisma-cloud-overview.md)
...
[Exploring the Wiz Test Results and Issues Integrations with Configuration Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/configuration-compliance/exploring-wiz-ctest-results-int.md)
...
[Veracode Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/application-vulnerability-response/veracode-vuln-integration.md)
...
[Fortify on Demand Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/application-vulnerability-response/fortify-vuln-integration.md)
...
[GitHub Application Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/application-vulnerability-response/github-vuln-integration.md)
...
[Invicti Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/application-vulnerability-response/invicti-vuln-integration.md)
...
[Vulnerability Response Integration with Black Duck](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown)
...
[Understanding the Atlassian Jira integration with Vulnerability Response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/jira-vuln-integration.md)
...
-   For integrations supporting multiple deployments, refer to [Create domain-separated imports for an integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/create-domain-separated-imports.md).
...
[Review Unified Security Exposure Management integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/review-usem-integrations.md)
