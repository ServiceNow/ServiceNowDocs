...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/review-the-misp-integration-settings.html
release: zurich
topic_type: task
...
Rollup of MITRE-ATT&amp;CK information from the MISP observable enrichment results \(galaxies\) to the security incident.Default value: Yes
    ...
    -   To use the MITRE™ technique extraction features in MISP, you must [enable the MITRE-ATT&amp;CK feature in the Threat Intelligence module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/get-started-with-mitre.md).
...
**Parent Topic:**[MISP administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/misp-administration.md)
