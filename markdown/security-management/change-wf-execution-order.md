---
title: Change the order of workflow execution
description: Integration capability implementations specify the workflow to be executed. In the base system, workflows are executed sequentially, in the order specified in the implementation. You can change the order as needed.
locale: en-US
release: xanadu
topic_type: task
