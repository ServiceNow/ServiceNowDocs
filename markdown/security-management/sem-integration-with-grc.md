...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sem-integration-with-grc.html
release: zurich
topic_type: task
