...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/manage-tools.html
release: yokohama
topic_type: task
...
Use the [techniques module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/view-techniques.md) to add or modify the tools data.
