...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/sbom-core/vr-sbom-config-osv-deps.html
release: xanadu
product: SBOM Core
...
breadcrumb: [Install the supported applications for Software Bill of Materials, Configuring Software Bill of Materials, Software Bill of Materials, Unified Security Exposure Management, Security Operations]
---
