...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/sbom-core/vr-sbom-uploading-devops.html
release: yokohama
product: SBOM Core
...
See [Uploading Software Bill of Materials files using a REST API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/sbom-core/vr-sbom-preparing-upload.md) for more information about \(POST\) and \(GET\) parameters and URLs for the Upload and Status APIs.
