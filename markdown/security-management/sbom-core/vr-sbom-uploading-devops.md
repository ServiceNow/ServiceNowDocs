...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sbom-core/vr-sbom-uploading-devops.html
release: zurich
product: SBOM Core
...
See [Uploading Software Bill of Materials files using a REST API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sbom-core/vr-sbom-preparing-upload.md) for more information about \(POST\) and \(GET\) parameters and URLs for the Upload and Status APIs.
