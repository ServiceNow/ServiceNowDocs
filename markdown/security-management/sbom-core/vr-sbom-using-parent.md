...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/sbom-core/vr-sbom-using-parent.html
release: xanadu
product: SBOM Core
...
-   [Uploading Software Bill of Materials files using a REST API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/sbom-core/vr-sbom-preparing-upload.md).

    The Upload API is used for uploading and ingesting an SBOM file \(CycloneDX/SPDX\) into your instance.

-   [Upload Software Bill of Materials files manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/sbom-core/vr-sbom-ingest.md).
...
-   [Uploading Software Bill of Materials for DevOps SBOM files](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/sbom-core/vr-sbom-uploading-devops.md).
