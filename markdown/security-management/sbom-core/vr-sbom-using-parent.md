...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sbom-core/vr-sbom-using-parent.html
release: zurich
product: SBOM Core
...
-   [Uploading Software Bill of Materials for DevOps SBOM files](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sbom-core/vr-sbom-uploading-devops.md).
