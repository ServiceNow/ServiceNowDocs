...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/sbom-core/vr-sbom-config-sbom-response.html
release: xanadu
product: SBOM Core
...
See [Create an application vulnerable item rule in the Software Bill of Materials Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/sbom-core/vr-sbom-create-avi-rule.md) for information about how to create a rule.
...
-   [Create or edit Vulnerability Response assignment rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/vulnerability-response/create-vul-assign-rules.md)
