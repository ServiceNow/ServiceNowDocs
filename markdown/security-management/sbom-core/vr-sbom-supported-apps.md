...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/sbom-core/vr-sbom-supported-apps.html
release: yokohama
product: SBOM Core
...
See [Veracode Vulnerability Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/application-vulnerability-response/veracode-vuln-integration.md) for more information.
