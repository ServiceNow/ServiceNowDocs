...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/using-now-assist-ai-agents-vr.html
release: zurich
topic_type: concept
...
[Assess your vulnerability exposure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/assess-exposure-vr-aiagent.md)-   Determine if your configuration items \(CIs\) and business services are exposed to known vulnerabilities.
...
-   See [Configure an agentic workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/now-assist-vr-acticvate-agentic-workflow.md) for more information.
