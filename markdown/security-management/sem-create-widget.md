...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/sem-create-widget.html
release: yokohama
topic_type: task
...
3.  On the new Visualization widget form, enter the required details.
    ...
    For a full description of each field, see [Visualization widget fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/sem-vis-widget-fields.md).
