...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/create-an-observable-from-a-case.html
release: australia
topic_type: task
...
2.  Either open an existing case or click **New** to [create a new case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/create-cases-in-case-mgmt.md).
...
7.  Click **Submit**.
    ...
    As needed, you can click the **Case Artifacts** tab and [add artifacts to the case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/add-records-to-cases.md).
