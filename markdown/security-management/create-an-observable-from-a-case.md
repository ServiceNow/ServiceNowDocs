...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/create-an-observable-from-a-case.html
release: zurich
topic_type: task
...
2.  Either open an existing case or click **New** to [create a new case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/create-cases-in-case-mgmt.md).
...
7.  Click **Submit**.
    ...
    As needed, you can click the **Case Artifacts** tab and [add artifacts to the case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/add-records-to-cases.md).


**Parent Topic:**[IoCs and observables in cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/cases-in-threat.md)
