...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/manage-groups-threat-intel.html
release: zurich
topic_type: task
...
Use the [techniques module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/view-techniques.md) to add or modify the groups data.
