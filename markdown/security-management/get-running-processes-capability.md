...
The Get Running Processes capability has two implementation workflows:
...
Activities specific to this workflow are described here. For more information on other activities, see [Common Security Operations integration flows and orchestration Flow Actions](common-wf-activities.md).
