---
title: List page in the Security Exposure Management Workspace
description: The List page in the Security Exposure Management Workspace permits vulnerability and security managers and analysts to view remediation progress on records, drill down into records, and view the status of their approval requests and exceptions.
locale: en-US
release: zurich
topic_type: concept
...
# List page in the Security Exposure Management Workspace

The List page in the Security Exposure Management Workspace permits vulnerability and security managers and analysts to view remediation progress on records, drill down into records, and view the status of their approval requests and exceptions.
