...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/sem-smart-assessment-exp-management.html
release: yokohama
topic_type: concept
...
-   **[Questionnaire Configuration form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/sem-compensating-controls-approval-rule.md)**  
...
-   **[Configure an assessment template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/sem-configure-assessment-template.md)**  
...
-   **[Use case for False positive or Request Exception Questionnaire](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/sem-ques-for-false-positive-or-request-exp.md)**  
Scenario when the questionnaire for False Positive or Request Exception is raised but not filled completely.

**Parent Topic:**[Exception Management Overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/sem-exception-management-overview.md)
