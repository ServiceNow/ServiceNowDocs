...
-   [Common Service Data Model conceptual model](https://www.servicenow.com/docs/access?context=csdm-conceptual-model&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US)
-   [CMDB schema model](https://www.servicenow.com/docs/access?context=c_ConfigurationManagementDatabase&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US)
