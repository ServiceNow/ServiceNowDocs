...
-   [Common Service Data Model conceptual model](https://www.servicenow.com/docs/access?context=csdm-conceptual-model&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
-   [CMDB schema model](https://www.servicenow.com/docs/access?context=c_ConfigurationManagementDatabase&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
