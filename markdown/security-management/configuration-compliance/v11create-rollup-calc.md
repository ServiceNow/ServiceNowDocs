...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/configuration-compliance/v11create-rollup-calc.html
release: xanadu
...
breadcrumb: [Configuration Compliance calculators and calculator rules, Create a Configuration Compliance calculator group, Setting up, installing, and configuring the Configuration Compliance application, Configuration Compliance, Unified Security Exposure Management, Security Operations]
---
