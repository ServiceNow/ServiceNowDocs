...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/configuration-compliance/cc-chng-mngment.html
release: xanadu
...
For more information, see [Create a change request in Configuration Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/cc-CR-v12-create.md).
...
-   **Test Groups**
    ...
    Test groups are related to authoritative documents and test records. A group of configuration tests define a Test group.
...
For more information about test results and remediation tasks, see [Configuration Compliance remediation tasks and remediation task rules overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/cc-groups.md).
