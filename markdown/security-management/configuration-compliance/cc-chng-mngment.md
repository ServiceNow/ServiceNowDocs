...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/configuration-compliance/cc-chng-mngment.html
release: yokohama
...
For more information, see [Create a change request in Configuration Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/configuration-compliance/cc-CR-v12-create.md).
...
For more information about test results and remediation tasks, see [Configuration Compliance remediation tasks and remediation task rules overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/configuration-compliance/cc-groups.md).
