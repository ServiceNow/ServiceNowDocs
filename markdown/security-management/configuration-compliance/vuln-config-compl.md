...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/configuration-compliance/vuln-config-compl.html
release: yokohama
...
See [Setting up, installing, and configuring the Configuration Compliance application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/configuration-compliance/cc-configuring.md) for more information about activating the application.
