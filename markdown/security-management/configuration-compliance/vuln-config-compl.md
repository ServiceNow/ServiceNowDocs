...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/configuration-compliance/vuln-config-compl.html
release: xanadu
...
-   **[CI Lookup Rules for identifying configuration items from Configuration Compliance third-party vulnerability integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/cc-ci-identifier-rules.md)**  
...
-   **[Creating CIs for Configuration Compliance using the Identification and Reconciliation Engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/cc-ci-creation-using-ire.md)**  
...
-   **[Configuration Compliance assignment rules overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/cc-assignment-rules.md)**  
Define the criteria by which test results are automatically assigned to an assignment group for remediation.
-   **[Configuration Compliance remediation tasks and remediation task rules overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/cc-groups.md)**  
...
-   **[Configuring calculator groups and calculators for Configuration Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/vuln-configuring-cc-calcs.md)**  
...
-   **[Configuration Compliance Exception Management overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/cc-ex-mgmt.md)**  
...
-   **[Configuration Compliance change management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/cc-chng-mngment.md)**  
