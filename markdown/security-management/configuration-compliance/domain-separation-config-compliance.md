...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/configuration-compliance/domain-separation-config-compliance.html
release: xanadu
...
**Note:** In all the above cases the overarching principles of visibility in separated domains separation in the ServiceNow AI Platform apply.
