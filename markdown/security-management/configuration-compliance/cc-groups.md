...
description: Automatically create Remediation Tasks \(RTs\) to analyze results in bulk using remediation task rules. The criteria by which groups are formed is configured so that you do not have to manually assign test results into groups.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/configuration-compliance/cc-groups.html
release: xanadu
