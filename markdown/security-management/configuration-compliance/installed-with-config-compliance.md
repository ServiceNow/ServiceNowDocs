...
Read lists and records in Configuration Compliance.
...
Updates test group on tests for Tenable and Microsoft Defender source. This is an one-time job.
...
Updates values into newly added columns \(such as Age, Age closed, Active, etc\) in the test results table, saved filters and modules. This is an one-time job.
...
Populates total records in the Vulnerable CIs table. This is an one-time job.
...
Group Rule\[sn\_vulc\_grouping\_rule\]
...
Version 12.0:Test Result Group Change Requests
