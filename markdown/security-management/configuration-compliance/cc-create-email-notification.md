...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/configuration-compliance/cc-create-email-notification.html
release: zurich
...
3.  Fill in the fields on the form, as appropriate.
    ...
    For more information on the form fields, see [Create an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_CreateANotification.md).
