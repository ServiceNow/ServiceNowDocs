...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/configuration-compliance/view-vuln-config-compl-test-results.html
release: xanadu
...
Time period for which a test result is active since it was last open.This field is empty for the closed test results.
