...
The value of the system property **sn\_vulc.flow\_designer\_activation** is set to true. This means that the flow designer is enabled by default.
...
1.  Navigate to **All** &gt; **Configuration Compliance** &gt; **Administration** &gt; **Approval Rules** &gt; **Exception approval rules for test result group**.
