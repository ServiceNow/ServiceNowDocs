...
Complete the setup checklist described in [Setting up, installing, and configuring the Configuration Compliance application](../concept/cc-configuring.md) prior to installation. These setup tasks are required for a smooth installation and configuration.Role required: admin

## Procedure

1.  To Opt in to ServiceNow products, follow the steps in [Opt in to the ServiceNow Store products](https://www.servicenow.com/docs/access?context=optin-optout-prod&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).

2.  To install an application that you have purchased from the ServiceNow Store, follow the steps in [Install a ServiceNow Store application](https://www.servicenow.com/docs/access?context=t_InstallApplications&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
...
4.  If you have already installed the Configuration Compliance application and you are updating it, see [Install an update to a ServiceNow Store application](https://www.servicenow.com/docs/access?context=t_InstallUpdates&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
