...
Progress status of the group.-   Open
-   Under investigation
...
This score is the rolled-up value of the risk scores for all the active test results in a remediation task. This score changes as test results are remediated in the test result group.
...
Brief description of this test result group.
...
Long description of the test result group that includes the list of software associated with this test result group.
...
The configuration test associated with this test result group.
...
-   **% Test results remediated**: The percent of remediated \(closed\) test results for this test result group.
...
-   **Open test results**: The number \(count\) of active \(any state other than **Closed**\) test results for this test result group.
...
The list of change requests associated with this test result group.
