...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/configuration-compliance/create-cc-group-rules.html
release: xanadu
...
**Note:** New or updated rules are automatically evaluated on the next import or manually using the **Reapply** button on the Group Rule form.
...
Conditions that must be met.By default, \(**Case sensitive** check box disabled\), the search text you enter in the condition builder on group rules records and forms is not case-sensitive. You have the option to enable case-sensitive searches on group records and forms.
