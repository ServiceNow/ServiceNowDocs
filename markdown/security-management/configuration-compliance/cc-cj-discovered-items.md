...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/configuration-compliance/cc-cj-discovered-items.html
release: xanadu
...
If a match was not found, a CI is created in the Unmatched CI class `[sn_sec_cmn_unmatched_ci]`, `[cmdb_ci_unclassed_hardware]`, or `[cmdb_ci_incomplete_ip]` of the CMDB. If the original unmatched CI was reclassified, Discovered item records are updated to reflect that state. For more information, see [Unmatched CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/vulnerability-response/unmatchedCIs.md) and [View and reclassify unmatched configuration items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/vulnerability-response/view-discovered-items.md) for more information.
...
For a description of the fields in Discovered Items, see [Discovered Items form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/vulnerability-response/discovered-items-fields.md).

-   **[CI changes for discovered items for Configuration Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/reapply-discovered-items-ci-changes-cc.md)**  
...
-   **[Reconcile unmatched discovered items for Configuration Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/reapply-reconcile-unmatched-discovered-items-cc.md)**  
...
-   **[Reapply CI lookup rules on selected discovered items for Configuration Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/configuration-compliance/reapply-ci-lookup-rules-di-cc.md)**  
