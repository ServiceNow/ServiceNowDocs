...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/configuration-compliance/cc-ex-request-test-result-group.html
release: yokohama
...
-   Other
To see how to add new reason choices, see [Define policy reason mappings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/configuration-compliance/define-policy-reason-mappings.md).
