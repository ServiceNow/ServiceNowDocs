...
-   **[Working with retired configuration items in Configuration Compliance](cc-working-with-retired-CIs.md)**  
...
-   **[Automatically close test results related to retired CIs](../task/cc-auto-close-vis.md)**  
