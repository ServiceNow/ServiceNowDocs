...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/activate-configure-virustotal.html
release: yokohama
topic_type: task
...
Select this check box to send the URLs as hashes for threat lookup and protect the users' privacy on the integration.**Note:** If disabled, the URL is sent as Base64 encoding to the VirusTotal API.
    ...
    \[Omitted image "virus-total-config.png"\] Alt text: VirusTotal Configuration page
