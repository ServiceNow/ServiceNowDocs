...
-   **[Create a case from IoCs or observables](../task/create-cases-threat.md)**  
...
-   **[Add IoCs and observables to an existing case](../task/add-records-to-cases-threat.md)**  
...
-   **[Create an observable from a case](../task/create-an-observable-from-a-case.md)**  
...
[Security incidents in cases](case-in-sir.md)
