...
For information on the activities used by this flow, see [Common Security Operations integration flows and orchestration Flow Actions](../../../security-operations-common/concept/common-wf-activities.md).
...
3.  Click **New** and [create a new record](https://www.servicenow.com/docs/access?context=t_UploadACertificateToAnInstance&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) for the integration.
