...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/c\_Metadefenderintegration.html
release: zurich
topic_type: concept
...
3.  Click **New** and [create a new record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/t_UploadACertificateToAnInstance.md) for the integration.
