...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/c\_Metadefenderintegration.html
release: yokohama
topic_type: concept
...
For information on the activities used by this flow, see [Common Security Operations integration flows and orchestration activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/common-wf-activities.md).
...
3.  Click **New** and [create a new record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/t_UploadACertificateToAnInstance.md) for the integration.
