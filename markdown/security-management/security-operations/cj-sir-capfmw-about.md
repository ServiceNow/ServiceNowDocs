...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-operations/cj-sir-capfmw-about.html
release: xanadu
...
The new framework has capabilities implemented using [Flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flows.md).
...
For more information on how to migrate from workflows to flows, using the Integration Capabilities Framework 2.0, see the [KB1644337](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB1644337) article in the Now Support Knowledge Base.
...
-   **Capabilities**: All of the following capabilities that exist in the product today as workflows have been redesigned using [Flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flows.md):
...
2.  The capabilities available with the base system are displayed.
    ...
    \[Omitted image "cj-sir-capfmw-oob-cap.png"\] Alt text: Capability flows: out-of-the-box
...
4.  Select the **Active** check box to activate the capability.
    ...
    -   **Capability implementations**: Click the **Capability Implementations** tab. The implementations \(integrations\) that have been configured for the capability are displayed. The example below shows the integrations configured for the Threat Lookup capability:
        ...
        \[Omitted image "cj-sir-capfmw-config3.png"\] Alt text: Capability flows: Threat Lookup: Capability implementations
...
6.  Click the **Active** checkbox to activate the capability.
    ...
    \[Omitted image "cj-sir-capfmw-config4.png"\] Alt text: Capability flows: Threat Lookup: VirusTotal
...
The default sighting search queries that can be executed.
    ...
    \[Omitted image "cj-sir-capfmw-config5.png"\] Alt text: Capability flows: Threat Lookup: VirusTotal: filter condition
...
-   Role required: sn\_si.admin, flow\_designer, action\_designer
-   Install one of the supported integrations \(see [Supported integrations and components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-operations/cj-sir-capfmw-about.md)\)
...
3.  Select a Trigger condition for the flow \(a common trigger is the creation of a security incident record for a certain incident category\).
    ...
    \[Omitted image "cj-sir-capfmw-create-flow-trigger.png"\] Alt text: Capability Framework: Create new flow: trigger
...
5.  In step 2, select a subflow \(for example, Threat Lookup\).
    ...
    \[Omitted image "cj-sir-capfmw-create-flow-subflow.png"\] Alt text: Capability Framework: Create new flow: subflow
