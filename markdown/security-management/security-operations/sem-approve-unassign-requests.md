...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-operations/sem-approve-unassign-requests.html
release: yokohama
...
For more information on approval rules and configurations, see [Approval workflow configurations for unassign request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/vr-unassign-approval-rules.md).
