...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-operations/create-dom-sep-prop-overrides.html
release: xanadu
...
Requires that [Domain Support - Domain Extensions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/list-of-plugins.md) be activated. You can also learn about the [Domain Override Viewer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/servicenow-ai-platform-security/domain-sep-override-viewer.md).
...
2.  Click **New**.
    ...
    \[Omitted image "NewDomainSepProperty.png"\] Alt text: Adding a new domain-separated property override
