...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-operations/sem-create-rev16.html
release: xanadu
...
5.  Alternatively, you can [Create a recurring remediation effort in the Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-operations/sem-create-recurringRE-steal-VI.md).
