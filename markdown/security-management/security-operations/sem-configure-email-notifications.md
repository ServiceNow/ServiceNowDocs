...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-operations/sem-configure-email-notifications.html
release: yokohama
...
4.  Select **New**.
    ...
    For detailed instructions on creating email notifications, see .
