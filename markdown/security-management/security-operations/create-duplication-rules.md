...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-operations/create-duplication-rules.html
release: yokohama
...
</table>    \[Omitted image "DuplicationActionsRelationship.png"\] Alt text: Duplication actions with relationship

7.  Click **Submit**.

    \[Omitted image "DuplicationRule.png"\] Alt text: Duplication rule


**Parent Topic:**[Shared data transformation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-operations/shared-data-transformation.md)
