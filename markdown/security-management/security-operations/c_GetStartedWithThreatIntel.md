...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-operations/c\_GetStartedWithThreatIntel.html
release: xanadu
...
[Set Threat Intelligence properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-operations/c_GetStartedWithThreatIntel.md).
...
6.  Fill in the fields in the **Source Details** section, as appropriate.
    ...
    |REST message|Click the lookup icon, and select the REST message from the list or click **New** to [define a new REST message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/web-services/t_ConfiguringARESTMessage.md).|
...
<table id="choicetable_fn4_l4l_wmb"><thead><tr><th align="left" id="d69552e2698">

Field

</th><th align="left" id="d69552e2701">

Description

</th></tr></thead><tbody><tr><td id="d69552e2707">
