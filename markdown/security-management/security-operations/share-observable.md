...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-operations/share-observable.html
release: yokohama
...
4.  On the **Observable** form click the **Share observable** related link.
    ...
    \[Omitted image "ShareObservableDialogBox.png"\] Alt text: Share Observable dialog box
