...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-operations/sem-components-installed.html
release: yokohama
...
-   [Components installed with Vulnerability Response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/installed-with-vr.md)
-   [Components installed with Application Vulnerability Response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/application-vulnerability-response/installed-with-avm.md)
-   [Components installed with Container Vulnerability Response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/container-vulnerability-response/installed-with-cvr-data.md)
-   [Components installed with Configuration Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/configuration-compliance/installed-with-config-compliance.md)

To view the full list of installed components, use the Application Files table. For instructions, see [Find components installed with an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/find-components.md).
...
-   **[Security Exposure Management Workspace Roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-operations/sem-new-roles-installed.md)**  
...
-   **[Security Exposure Management Workspace Tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-operations/sem-new-tables-installed.md)**  
...
-   **[Security Exposure Management Workspace Scheduled Jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-operations/sem-new-scheduledjobs-installed.md)**  
...
**Parent Topic:**[Unified Security Exposure Management reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/security-operations/unified-security-exposure-management-reference.md)
