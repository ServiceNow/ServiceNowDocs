...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-operations/sem-bulk-edit-update-state.html
release: yokohama
...
For more information, see[Request bulk exception in the Vulnerability Manager Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-manager-workspace/vmws-bulk-edit-request-exception.md).

-   Closed

For more information, see [Bulk edit for false positive in the Vulnerability Manager Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-manager-workspace/vmws-bulk-edit-request-false-positive.md)
