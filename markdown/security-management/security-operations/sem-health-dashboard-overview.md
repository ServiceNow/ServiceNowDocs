...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-operations/sem-health-dashboard-overview.html
release: yokohama
