...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-operations/sem-transfer-VI-to-RE.html
release: yokohama
...
11. To transfer records from other efforts, from the list, select the check boxes for the records you want.
    ...
    \[Omitted image "vr-ws-create-re-step-3-v18.png"\] Alt text: Version 18.0 Create Remediation Effort
