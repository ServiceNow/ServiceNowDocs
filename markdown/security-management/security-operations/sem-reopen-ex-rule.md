...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/security-operations/sem-reopen-ex-rule.html
release: yokohama
...
You can then update and resubmit the rule for approval.
...
4.  Find the rule that you want to reopen and click **Reopen**.
