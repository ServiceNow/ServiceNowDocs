...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/security-operations/create-class-group-and-tags.html
release: xanadu
...
1.  Navigate to **All** &gt; **Security Operations** &gt; **Security Tags** &gt; **Groups**.
    ...
    -   **Enrichment allow list/deny list**: This group defines whether a record is to be treated as a allow list or deny list record. Allow list records are generally of less significance, so they can be ignored. Deny list records are generally of higher interest.
...
6.  Fill in the fields on the form, as appropriate.
    ...
    |Roles \(read access\)|To assign read access to a security tag, click the lock icon, select the appropriate access roles, and click the lock icon again. This field appears only if you selected the **Enforce restricted access** check box.|
    |Roles \(write access\)|To assign write access to a security tag, click the lock icon, select the appropriate access roles, and click the lock icon again. This field appears only if you selected the **Enforce restricted access** check box.|
...
-   **[Create security tag rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-operations/create-security-tag-rules.md)**  
Security tag rules provide filtering for security tag access.
-   **[Import security tag rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-operations/import-security-tag-rules.md)**  
You can import security tag rules from other tables in your deployment.

**Parent Topic:**[Security Operations common functionality](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/security-operations/sec-ops-common-functionality.md)
