...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/fix-intel-for-usem-landing.html
release: australia
...
[Use \[Omitted image "bus-agent-workspace-1.svg"\] Alt text: Review Fix records and prioritize remediation by the fixes that remove the most risk.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/using-fix-intel-security-exposure-management.md)

</td><td>

[Reference \[Omitted image "bus-learn.svg"\] Alt text: Find the roles, tables, and other components installed with Fix Intelligence for SEM.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/fix-intel-reference.md)

</td></tr></tbody>
</table>-   **[Exploring Fix Intelligence for Security Exposure Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/exploring-fix-intel.md)**  
...
-   **[Using Fix Intelligence for Security Exposure Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/using-fix-intel-security-exposure-management.md)**  
...
-   **[Fix Intelligence for SEM reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/fix-intel-reference.md)**  
...
[Unified Security Exposure Management \(USEM\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/unified-security-exposure-management-landing-page.md)
