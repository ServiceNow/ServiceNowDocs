...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/define-object-observable.html
release: australia
topic_type: task
...
3.  Complete the fields in the form as appropriate.
    ...
    |Field|Description|
    |-----|-----------|
    |**Object**|Select and define the source object.|
    |**Type**|Enter a descriptive name to identify the object type.|
