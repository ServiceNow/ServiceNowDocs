...
The **Threat Lookups** capability has a workflow, [Security Operations Integration - Threat Lookup workflow](../../security-operations-integrations/task/sec-ops-integ-threat-lookup.md). When the capability workflow runs, it executes additional workflows for the activated implementations. You can specify an implementation to use to perform a lookup on the selected observables, or you can perform the lookup using all implementations.

**Note:** If no implementations are available, capability actions are not displayed in product menus.

-   **[Security Operations Integration - Threat Lookup workflow](../../security-operations-integrations/task/sec-ops-integ-threat-lookup.md)**  
