...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/using-unified-security-exposure-management.html
release: zurich
topic_type: concept
...
-   **[Create a dashboard in the Findings view page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-create-dashboard.md)**  
...
-   **[Evaluate vulnerability exposure data with Security Exposure 360](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/now-assist-review-vulnerability-exposure-data.md)**  
...
-   **[Exploring AI Security Exposure Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/exploring-ai-security-exposure.md)**  
...
-   **[Generate vulnerability insights with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-insights-skill.md)**  
...
-   **[Retrieve Vulnerability and exposure data with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/retrieve-vr-data.md)**  
...
-   **[Assess your vulnerability exposure with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/assess-exposure-vr-aiagent.md)**  
...
-   **[Identify duplicate vulnerable items with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/dedupe-host-vi-now-assist-vulnerability-response.md)**  
...
-   **[Approval recommendations using generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/now-assist-vr-generating-approvals.md)**  
...
-   **[Suggest vulnerability solutions with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/solutions-now-assist-vulnerability-response.md)**  
...
-   **[Analyze vulnerability remediation status with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sla-targets-vr-aiagent.md)**  
Chat with an AI agent to help you gain insights into your monthly remediation compliance metrics for vulnerable items.
-   **[Creating an API connector with generative AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/using-now-assist-api-connector.md)**  
...
-   **[Reclassify unclassed hardware](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-reclassify-unclassed-hardware.md)**  
Reclassify unclassed hardware by updating the lookup rules.
-   **[Bulk edit in the Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-workspace-bulk-edit-overview.md)**  
...
-   **[Create a remediation task manually in the Security Exposure Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-create-remediation-task.md)**  
...
-   **[Enable or disable the import of test results for a Qualys test group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-enable-disable-imports-qualys.md)**  
...
-   **[Modify the severity for a CVE or TPE](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-modify-reset-severity.md)**  
...
-   **[Use Remediation Effort records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-ws-remed-eff-rcd.md)**  
...
-   **[Exception Management Overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-exception-management-overview.md)**  
...
-   **[Unified Approvals View](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-approval-view.md)**  
...
-   **[Employee service center for Vulnerability Response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/employee-center-vr-overview.md)**  
...
-   **[Unified Approval Rules Overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-approval-rules-overiew.md)**  
...
-   **[Create a change request in the Remediation view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-ws-CRs.md)**  
