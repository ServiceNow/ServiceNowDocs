...
-   **[Create a dashboard in the Findings view page](../../security-exposure-management-findings/task/sem-create-dashboard.md)**  
...
-   **[Bulk edit in the Security Exposure Management Workspace](sem-workspace-bulk-edit-overview.md)**  
...
-   **[Enable or disable the import of test results for a Qualys test group](../task/sem-enable-disable-imports-qualys.md)**  
...
-   **[Modify the severity for a CVE or TPE](../task/sem-modify-reset-severity.md)**  
...
-   **[Use Remediation Effort records](../task/sem-ws-remed-eff-rcd.md)**  
...
-   **[Approve or reject requests in the Security Exposure Management Workspace](../task/sem-approve-requests.md)**  
Approve or reject requests that are submitted by remediation owners.
-   **[Add a compensating control to the library](../task/sem-create-compensatory-control.md)**  
...
-   **[Examples for remediation task creation in the Security Exposure Management Workspace](../reference/sem-create-remediation-task-examples.md)**  
...
-   **[Exception Management Overview](../../security-exposure-management-administration/concept/sem-exception-management-overview.md)**  
...
-   **[Unified Approvals View](../../security-exposure-management-administration/concept/sem-approval-view.md)**  
...
-   **[Employee service center for Vulnerability Response](../../employee-center-vuln-respn/concept/employee-center-vr-overview.md)**  
...
-   **[Unified Approval Rules Overview](../../security-exposure-management-administration/concept/sem-approval-rules-overiew.md)**  
