...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/sem-configure-lookup-rules.html
release: yokohama
topic_type: concept
...
The process function has three parameters: **rule**, **sourceValue**, and **sourcePayload**
    ...
    \[Omitted image "CI-LookupRules-v12.png"\] Alt text: CI lookup rule using a condition builder for version 12.0.

    \[Omitted image "CI-LookupRules.png"\] Alt text: CI lookup rule using a script


**Related topics**  


[Vulnerability Response vulnerable item form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/vulnerable-item-fields.md)
...
For more information, see [CI changes for discovered items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/vulnerability-response/reapply-discovered-items-ci-changes.md).
