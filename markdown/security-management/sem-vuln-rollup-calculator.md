...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/sem-vuln-rollup-calculator.html
release: xanadu
topic_type: concept
...
**Parent Topic:**[Prioritizing vulnerabilities and other findings using roll-up calculators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/sem-prioritizing-vulnerabilities-other-findings.md)
