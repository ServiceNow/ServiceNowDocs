...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sem-vuln-rollup-calculator.html
release: zurich
topic_type: concept
...
**Parent Topic:**[Prioritizing vulnerabilities and other findings using roll-up calculators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-prioritizing-vulnerabilities-other-findings.md)
