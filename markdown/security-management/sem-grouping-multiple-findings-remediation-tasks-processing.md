...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/sem-grouping-multiple-findings-remediation-tasks-processing.html
release: yokohama
topic_type: concept
...
-   Manually in the IT Remediation Workspace. For more information, see [Create a remediation task manually in the IT Remediation Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/it-remediation-workspace/itr-ws-create-remediation-task.md).
...
[Configuring remediation task rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/sem-configure-remediation-task-rules.md)
