...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sem-grouping-multiple-findings-remediation-tasks-processing.html
release: zurich
topic_type: concept
...
-   Manually in the IT Remediation Workspace. For more information, see [Create a remediation task manually in the IT Remediation Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/it-remediation-workspace/itr-ws-create-remediation-task.md).
