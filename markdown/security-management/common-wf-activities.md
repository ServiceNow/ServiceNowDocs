...
-   **[Get Supported Security Capabilities activity](../../security-operations-integrations/reference/get-supported-security-capabilities-activity.md)**  
...
-   **[Capability Execution Tracking- No Impls activity](../../security-operations-integrations/reference/execution-tracking-noimpls-activity.md)**  
...
-   **[Get IP from CI Flow Action](../../security-operations-integrations/reference/get-ip-from-ci-activity.md)**  
