...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/common-wf-activities.html
release: australia
topic_type: concept
...
-   **[Capability - Determine CIs activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/determine-cis-activity.md)**  
...
-   **[Determine Observables activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/determine-observables-activity.md)**  
...
-   **[Create Compliance Search Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/get-email-details-from-exch-server.md)**  
...
-   **[Get running processes via WMI activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/get-running-process-WMI-activity.md)**  
...
-   **[Check Compliance Search Status Action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/search-delete-email-threat-exchange.md)**  
...
-   **[Update Task Worknotes activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/update-task-worknotes-activity.md)**  
...
-   **[Roll up lookup info to security incident activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/r_RollUpScanInfoSI.md)**  
...
-   **[Update security incident with lookup results workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/t_UpdateSecIncScanResults.md)**  
The **Update security incident with lookup results** workflow updates existing security incidents with lookup results.
-   **[Filter Allowlisted Observables activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/filter-whitelisted-observables-activity.md)**  
...
-   **[Write content to record as attachment activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/write-content-record-attachment-activity.md)**  
This activity writes the content passed in from an input and creates a designated attachment to a given record.
-   **[Get IP from CI activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/get-ip-from-ci-activity.md)**  
