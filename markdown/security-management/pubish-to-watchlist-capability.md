---
title: Security Operations Integration- Publish to Watchlist capability
description: The Publish to Watchlist capability adds observables and indicators associated with a security incident to a third-party watchlist that monitors for security events and generates alerts. This capability is used as part of incident response during investigations.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/pubish-to-watchlist-capability.html
release: yokohama
topic_type: concept
...
-   **[Security Operations Integration - Publish to Watchlist Flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/secops-integration-publish-watchlist-workflow.md)**  
