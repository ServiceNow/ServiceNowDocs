...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/secops-integration-block-request-workflow.html
release: xanadu
topic_type: task
...
\[Omitted image "security-operations-integration-block-request-flow-V1.png"\] Alt text: Flow designer for Security Operations Integration- Block Request Flow
