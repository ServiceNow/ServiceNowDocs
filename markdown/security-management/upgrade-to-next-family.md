...
For more information about new features and steps for how to upgrade, see [Using the release notes](https://www.servicenow.com/docs/access?context=rn-getting-started-landing-page&version=yokohama&pubname=yokohama-release-notes&ft:locale=en-US) and [Release notes for upgrading from Xanadu](https://www.servicenow.com/docs/access?context=rn-n-1-landing-page&version=yokohama&pubname=yokohama-release-notes&ft:locale=en-US) to learn how to navigate the redesigned release notes and find the information you're looking for.
