...
For more information see [Using the release notes](https://www.servicenow.com/docs/access?context=rn-getting-started-landing-page&version=zurich&pubname=zurich-release-notes&ft:locale=en-US) to learn how to navigate the redesigned release notes and find the information you're looking for and [Learn about the Zurich release](https://www.servicenow.com/docs/access?context=rn-learn-landing-page&version=zurich&pubname=zurich-release-notes&ft:locale=en-US) for new features.
