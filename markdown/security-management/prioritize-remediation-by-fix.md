...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/prioritize-remediation-by-fix.html
release: zurich
topic_type: task
...
3.  In the Fix list, sort by **Risk score** or filter by **Risk rating** to surface the fixes that remove the most risk.
    ...
    For more information on roll-up calculators, see [Vulnerability Response Rollup Calculators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-vuln-rollup-calculator.md).
...
6.  Plan remediation for the selected fixes, optionally grouping their findings into a remediation task.
    ...
    See [Group findings by fix](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/group-findings-by-fix.md).
