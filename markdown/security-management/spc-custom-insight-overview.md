...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/security-management/spc-custom-insight-overview.html
release: australia
topic_type: concept
...
See [Create and activate a configured insight for Security Posture Control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/security-management/spc-create-custom-insight.md) for more information about the steps for creating a configured insight.
