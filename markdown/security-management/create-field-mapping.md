...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/create-field-mapping.html
release: yokohama
topic_type: task
...
Governs how to handle source records that would generate a duplicate record. For more information, see [Shared data transformation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/shared-data-transformation.md).
...
<table id="choicetable_w4v_gmy_tz"><tbody><tr><td id="d148677e243">
...
For reference fields, an entry is set only when a value matching the display name of the record, or valid`sys_id` is found. For more information, see [Reference fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/c_ReferenceField.md).

</td></tr><tr><td id="d148677e314">
...
**Parent Topic:**[Security Operations field mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/field-mapping.md)
