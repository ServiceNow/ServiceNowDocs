...
<table id="choicetable_w4v_gmy_tz"><tbody><tr><td id="d140539e247">
...
For reference fields, an entry is set only when a value matching the display name of the record, or valid`sys_id` is found. For more information, see [Reference fields](https://www.servicenow.com/docs/access?context=c_ReferenceField&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).

</td></tr><tr><td id="d140539e318">
