...
The new framework has capabilities implemented using [Flows](https://www.servicenow.com/docs/access?context=flows&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
...
-   **Capabilities**: All of the following capabilities that exist in the product today as workflows have been redesigned using [Flows](https://www.servicenow.com/docs/access?context=flows&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US):
