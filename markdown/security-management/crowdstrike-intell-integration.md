...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/crowdstrike-intell-integration.html
release: zurich
topic_type: concept
...
[Submit an IoC Lookup request from the Security Incident Catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/security-incident-response/t_SubmitThrtScnReqFromCat.md)
...
For information on the activities used by this flow designer, see [Common Security Operations integration flows and orchestration activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/common-wf-activities.md).
