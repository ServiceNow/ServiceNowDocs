...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/sem-ws-list-view.html
release: xanadu
topic_type: task
...
3.  Select **My Lists** to create a list.
    ...
    For more information on how to create a list, see [Create a customized list of records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/sem-create-custom-list.md).
