...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/sem-ws-list-view.html
release: yokohama
topic_type: task
...
3.  Select **My Lists** to create a list.
    ...
    For more information on how to create a list, see [Create a customized list of records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/sem-create-custom-list.md).
...
-   **[Create a customized list of records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/sem-create-custom-list.md)**  
