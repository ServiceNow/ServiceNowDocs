...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/about-mitre-attack.html
release: yokohama
topic_type: concept
...
In addition to the MITRE-ATT&amp;CK framework, ServiceNow also supports MITRE ATLAS.

For an overview, see [MITRE ATLAS framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/about-mitre-atlas.md).
...
\[Omitted image "mitre-attack-architecture.png"\] Alt text: How MITRE ATT&amp;CK works with Security Operations' applications.
...
\[Omitted image "mitre-attack-architecture\_benefits.png"\] Alt text: Benefits of using MITRE ATT&amp;CK
...
-   **[MITRE-ATT&amp;CK administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/mitre-att-ck-administration.md)**  
...
-   **[Using MITRE-ATT&amp;CK to detect and analyze threats](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/mitre-att-ck-features.md)**  
