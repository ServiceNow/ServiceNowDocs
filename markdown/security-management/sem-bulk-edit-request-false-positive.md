...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/security-management/sem-bulk-edit-request-false-positive.html
release: xanadu
topic_type: task
...
3.  Perform one of the following:
    ...
    -   Select the check box next to each item if you want to use the Only Selected Items option in the [**Record selection**](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/vulnerability-manager-workspace/vmws-bulk-edit-request-false-positive.md) field.
    -   Apply filters if you want to use the All records that match filter option in the [**Record selection**](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/security-management/vulnerability-manager-workspace/vmws-bulk-edit-request-false-positive.md) field.
