...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/threat-lookup-virustotal-wf.html
release: yokohama
topic_type: task
...
For information on the activities used by this workflow, see [Common Security Operations integration flows and orchestration activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/common-wf-activities.md).
