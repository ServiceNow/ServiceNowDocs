...
For information on the activities used by this workflow, see [Common Security Operations integration flows and orchestration Flow Actions](../../../security-operations-common/concept/common-wf-activities.md).
