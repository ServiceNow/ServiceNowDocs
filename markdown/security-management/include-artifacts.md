...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/include-artifacts.html
release: yokohama
topic_type: task
...
4.  Click the Artifact Filter drop-down list and select **Excluded Artifacts**.
    ...
    \[Omitted image "exclude-filter.png"\] Alt text: Excluded Artifacts list
...
6.  From the **Actions on selected items** drop-down list, select **Include**.
    ...
    \[Omitted image "re-include-artifacts.png"\] Alt text: Select artifacts and return them to the Include list
...
**Parent Topic:**[Security artifact exclusion and inclusion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/artifact-inclusion-exclusion.md)
