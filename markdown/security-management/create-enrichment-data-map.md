...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/create-enrichment-data-map.html
release: yokohama
topic_type: task
...
The table to which the fields to map are going.
    ...
    \[Omitted image "EnrichmentDataMapForm.png"\] Alt text: Enrichment Data Mapping example


**Parent Topic:**[Security Operations enrichment data mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/enrichment-data-mapping.md)
