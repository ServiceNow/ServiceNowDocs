...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/define-technique-coverage.html
release: zurich
topic_type: task
...
Name of the overall technique detection coverage. The [base system technique coverage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/scoring-definition.md) consists of None, Poor, Fair, Good, Very Good, or Excellent.
...
Overall technique detection coverage. See the base system definition in the [Scoring Definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/scoring-definition.md).
...
-   **[MITRE-ATT&amp;CK Scoring definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/scoring-definition.md)**  
