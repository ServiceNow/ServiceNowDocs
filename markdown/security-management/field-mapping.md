---
title: Security Operations field mapping
description: Security Operations tables can be mapped to and from other tables, linking a security incident to a customer service case or a problem to other parts of the Security Operations system.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/field-mapping.html
release: yokohama
topic_type: concept
...
-   **[Map tables to tables with Security Operations field mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/create-field-mapping.md)**  
