...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/ai-security-exposure-use-agent.html
release: zurich
topic_type: task
...
4.  Select a prompt in the panel.
    ...
    The system displays a justification for the deferral for your review. You can approve or reject the justification. If you approve it, a calendar is displayed. Choose an end date for the deferral. After you select **Submit**, the finding state transitions from **Open** to **Deferred**.
