...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/security-management/sem-components-installed.html
release: zurich
topic_type: concept
...
To view the full list of installed components, use the Application Files table. For instructions, see [Find components installed with an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/find-components.md).
...
-   **[Security Exposure Management Workspace Roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-new-roles-installed.md)**  
...
-   **[Security Exposure Management Workspace Tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-new-tables-installed.md)**  
...
-   **[Security Exposure Management Workspace Scheduled Jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/sem-new-scheduledjobs-installed.md)**  
...
**Parent Topic:**[Unified Security Exposure Management reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/security-management/unified-security-exposure-management-reference.md)
