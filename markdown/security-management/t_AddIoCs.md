...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/t\_AddIoCs.html
release: yokohama
topic_type: task
...
1.  After the scheduled job has retrieved IoC data from the [defined data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/c_GetStartedWithThreatIntel.md), navigate to **Threat Intelligence** &gt; **IoC Repository** &gt; **Indicators**.
