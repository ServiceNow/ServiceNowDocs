...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/security-management/view-fixes-in-workspace.html
release: yokohama
topic_type: task
...
5.  Review the fix's fields to understand what it remediates and how much risk it removes.
    ...
    For what each field means, see [Understanding Fix records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/security-management/understanding-fix-records.md).
