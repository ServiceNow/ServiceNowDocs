...
-   **[Create security annotations for CIs](../task/create-security-annotations.md)**  
Annotations on CIs allow you to track activity across incidents. You can add annotations to a single or multiple CIs.
-   **[Create security annotations for observables](../task/create-security-annotations-multiple.md)**  
...
-   **[Create security annotations for users](../task/create-multi-sec-annotations-for-users.md)**  
...
-   **[View security annotations reports](../task/view-security-annotations-report.md)**  
