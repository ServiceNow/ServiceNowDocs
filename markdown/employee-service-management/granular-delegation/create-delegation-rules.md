...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/granular-delegation/create-delegation-rules.html
release: xanadu
...
If you have not done so already, create a delegation rule table. See [Add delegation rule tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/granular-delegation/add-delegation-rules-tables.md).
...
Organize the delegation rules into categories to make delegating large batches of tasks easy and efficient for your employees. See [Create delegation rule categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/granular-delegation/create-delegation-rule-categories.md).

Delegate assigned tasks for a specific period of time. See [Create a delegate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/granular-delegation/create-delegation-admin.md).

Employees can now delegate their assigned tasks to other employees. See [Delegate on-demand tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/granular-delegation/granular-delegation-use.md).
