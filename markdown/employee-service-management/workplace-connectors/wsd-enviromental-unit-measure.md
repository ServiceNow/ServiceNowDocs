...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-connectors/wsd-enviromental-unit-measure.html
release: yokohama
...
The Occupancy and Environment Data table \(sn\_wsd\_wc\_occ\_env\_data\) name.
...
Units for the value selected in the Value field. For example, **Temperature units** in case you have selected Temperature value in the Value field.
...
**Previous topic:**[Provider Connector Configuration for Environmental sensors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-connectors/wsd-env-provider-connectorconfig.md)

**Next topic:**[Configure environmental sensor data for a workplace location](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-connectors/config-connectors-env-sensor.md)
