...
Option to indicate the target or destination table to store the occupancy data.Select Occupancy and Environment Data \(sn\_wsd\_wc\_occ\_env\_data\) table. For more information, see [Retrieving Space Occupancy Data](space-occupancy-data.md).
