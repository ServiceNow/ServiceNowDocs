...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/workplace-connectors/setup-wifi-data-connectors.html
release: xanadu
...
-   **[Set up Connector Configuration for Wi-Fi data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-connectors/wsd-connectorconfig-wifi-data.md)**  
...
-   **[Provider Connector Configuration for Wi-Fi data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-connectors/wsd-provider-connectorconfig-wifi-data.md)**  
Configure the Provider Connector Configurations table for setting up Wi-Fi data in workplace locations.
-   **[Set up a new table to store Wi-Fi data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-connectors/wsd-setup-wifi-data-table.md)**  
...
-   **[Extension point definition for Wi-Fi data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-connectors/wsd-extension-point-definition-for-wifi-data.md)**  
...
**Previous topic:**[Extension point for occupancy and environment data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-connectors/extension-point-for-occupancy-and-environment-data.md)

**Next topic:**[Set up Connector Configuration for Wi-Fi data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-connectors/wsd-connectorconfig-wifi-data.md)
