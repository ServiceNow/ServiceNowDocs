...
1.  [Archive and purge summary data tables](../task/archive-and-purge-summary-data.md)  
...
2.  [Run the DataSummarization on-demand job](../task/run-the-datasummarization-on-demand-job.md)  
...
3.  [Migrate event data to new summary tables](../task/migrate-data-from-old-tables-to-new-summary-tables.md)  
