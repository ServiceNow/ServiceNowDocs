...
-   Provides near-real time occupancy data on floor maps, Employees can reserve spaces based on Occupancy data and reservation data. For more information, see [Manage workplace activities and services with Location directory](../../workplace-service-delivery/concept/location-directory.md).
...
**Previous topic:**[Extension point for badging data](../task/extension-point-for-badging-data.md)
