...
2.  [Configure connectors for badging data](../task/workplace-connector-configuration.md)  
...
4.  [Bading data](../task/bading-data-table.md)  
...
6.  [Extension point for badging data](../task/extension-point-badging-data.md)  
...
**Previous topic:**[Configure badging data choices](../task/configure-badging-data-choices-table.md)
