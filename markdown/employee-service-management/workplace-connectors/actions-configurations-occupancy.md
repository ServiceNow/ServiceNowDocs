...
Invokes sub flows from the Flow designer for Metrikus spoke integration. For more information, see [Metrikus spoke](https://www.servicenow.com/docs/access?context=metrikus-spoke&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US)Select **Subflow**.
