...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-connectors/wsd-env-provider-connectorconfig.html
release: yokohama
...
Option to select the event data for supported metrics.
...
**Previous topic:**[Set up Connector Configuration for Environmental sensor data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-connectors/wsd-connectorconfiguration-environment.md)

**Next topic:**[Set up the Units of measure data table for environmental sensors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-connectors/wsd-enviromental-unit-measure.md)
