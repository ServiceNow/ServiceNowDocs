...
4.  [Configure badging data choices](../task/configure-badging-data-choices.md)  
...
8.  [Set up Workplace Connectors for Wi-Fi data](setup-wifi-data-connectors.md)  
...
9.  [Execute Temperature Beyond Threshold MetricBase trigger](../task/execute-temperature-beyond-threshold-metricbase-trigger.md)  
