...
Day and time frequency to import data from the workplace system. For example: 5 minutes.The process provider data record picks the records from the wifi data table and populates the Employee Attendance table based on the run frequency.
