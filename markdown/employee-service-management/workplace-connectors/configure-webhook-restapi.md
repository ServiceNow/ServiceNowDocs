...
Option to search for and select the lookup list icon \(![Lookup list icon.](../../workplace-lease-administration/images/look-up-icon.png)\) to select **Badging**. For more information, see [Configure connector configuration for badging data](workplace-connector-configuration.md).
...
**Next topic:**[Badging Data](badging-data.md)
