...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/workplace-connectors/configure-webhook-restapi.html
release: xanadu
...
Option to search for and select the lookup list icon \(\[Omitted image "look-up-icon.png"\] Alt text: Lookup list icon.\) to select **Badging**. For more information, see [Configure connector configuration for badging data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-connectors/workplace-connector-configuration.md).
...
**Previous topic:**[Configure badging table data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-connectors/provider-configuration-wsd-connectors.md)

**Next topic:**[Badging Data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-connectors/badging-data.md)
