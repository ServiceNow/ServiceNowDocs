...
[Explore ![Explore icon.](../../../common/image/icon-explore.png) Learn about how employees, paralegal staff, and lawyers use Legal Content Review.](../concept/explore-legal-content-review.md)

</td><td>

[Set up ![Setup icon.](../../../common/image/icon-configure.png) Set up practice areas, intake forms, and other configurations.](../concept/setting-up-legal-content-review.md)

</td></tr><tr><td>

[Request and Manage Legal Content Review request ![Manage icon.](../../../common/image/icon-workspace.png) Submit and track Legal Content Review requests.](../concept/legal-content-review-requests.md)

</td><td>

[Reference ![Reference icon.](../../../common/image/icon-reference.png) Get details about components such as roles, tables, plugins, and store applications that are installed.](legal-cr-reference.md)
...
-   **[Setting up Legal Content Review](../concept/setting-up-legal-content-review.md)**  
