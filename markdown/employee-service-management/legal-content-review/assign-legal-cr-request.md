...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-content-review/assign-legal-cr-request.html
release: xanadu
...
The assigned user can start working on the legal request. For more information, see [Work on a legal request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/work-on-legal-request.md).
