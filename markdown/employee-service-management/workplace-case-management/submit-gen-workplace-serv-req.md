...
You can also submit a general question using the Virtual agent chat support. From Employee Center portal, select the chat option ![Chat icon](../image/chat-icon.png). Type your question or select **Show Me Everything** to choose from the list of options to submit your query.
