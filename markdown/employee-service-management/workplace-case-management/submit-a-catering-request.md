...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-case-management/submit-a-catering-request.html
release: yokohama
...
Use the **Catering** workplace service to request for food service for meetings and events at your workplace.

## Procedure

1.  Navigate to the portal from one of the following locations.

<table id="choicetable_presence_dashboard"><thead><tr><th align="left" id="d433258e70">

Location

</th><th align="left" id="d433258e73">

Navigation

</th></tr></thead><tbody><tr><td id="d433258e79">
...
Choose the **Urgency** for the catering service.
...
**Building**, that has requested for catering service.
...
**Floor**, that has requested for catering service.
...
**Space**, that has requested for the catering service.
...
The catering request is submitted.
