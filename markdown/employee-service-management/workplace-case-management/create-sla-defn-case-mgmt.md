...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-case-management/create-sla-defn-case-mgmt.html
release: yokohama
...
2.  Create an SLA Definition or modify an existing one.
    ...
    For information about the template form fields, see [Create an SLA Defintion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/t_CreateAnSLADefinition.md).
