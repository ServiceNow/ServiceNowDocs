...
2.  Create an SLA Definition or modify an existing one.
    ...
    For information about the template form fields, see [Create an SLA Defintion](https://www.servicenow.com/docs/access?context=t_CreateAnSLADefinition&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US).
