...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-case-management/view-emergency-maint-case.html
release: yokohama
...
3.  Scroll down and select the Comments and Work Notes section.
    ...
    \[Omitted image "wsd-new-emergency-maintenance-case-notes-ai.png"\] Alt text: Emergency Maintenance request showing the agent activity notes in the Activity tab.
...
4.  Navigate to **All** &gt; **Workplace Reservation Management** &gt; **All Reservations** &gt; **Workplace Reservations**.
    ...
    -   From the Related List, select the **Requested Service Items** tab.
        ...
        \[Omitted image "wsd-new-extra-services-added-agenticai.png"\] Alt text: Selected reservation showing the moved workplace services in the Requested Service Items tab.
...
5.  An email notification is triggered and sent to workplace reservation administrators and event planners for the updated reservation location.
    ...
    \[Omitted image "wsd-email-notification.png"\] Alt text: Email notification after the reservation location is updated.
