...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-case-management/config-case-edit-rp.html
release: zurich
...
If you want to integrate the record producer with Workplace Reservation Management, see [Configuring a record producer for reservation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-case-management/config-reservation-rp.md).
...
For more information about the fields of a workplace service, see [Workplace Service form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-case-management/workplace-service-form.md).
