...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/workplace-case-management/create-workplace-service-activity.html
release: xanadu
...
-   A workplace service with fulfillment type selected as **Service activity**. For more information, see [Create a Workplace service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-case-management/create-workplace-service.md).
...
This field appears if you select the **Activity type** **Approval**. Select approvers for the case from the configured performer criteria. Click the unlock icon \(\[Omitted image "unlock-icon.png"\] Alt text: Approvers from case unlock icon \) to select.
...
This field appears if you select the **Activity type** as **Child case**. Click the search \(\[Omitted image "search-icon.png"\] Alt text: Workplace case service search icon\) icon and select the Workplace service you want to set as a child case. To add a Workplace service, see [Create a Workplace service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-case-management/create-workplace-service.md).
...
**Parent Topic:**[Create a Workplace service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-case-management/create-workplace-service.md)
