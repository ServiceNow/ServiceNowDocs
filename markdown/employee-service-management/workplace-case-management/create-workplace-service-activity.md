...
This field appears if you select the **Activity type** **Approval**. Select approvers for the case from the configured performer criteria. Click the unlock icon \( ![Approvers from case unlock icon](../image/unlock-icon.png) \) to select.
