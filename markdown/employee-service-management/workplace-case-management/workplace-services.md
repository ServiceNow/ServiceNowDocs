...
breadcrumb: [Explore Workplace Case Management, Workplace Case Management, Workplace Service Delivery, Employee Service Management]
---
...
The workplace services that you create using the Workplace Case Management application are displayed in the Workplace Service Portal in a Workplace Service Catalog under various categories as follows:

![The workplace services created using the Workplace Case Management application are displayed in the Workplace Service Portal in a Workplace Service Catalog](../image/wscasemgmt-workplace-service-catalog.png)
...
-   **Manual**: The Manual option enables you to configure a workplace service with human response. This works for services like general inquiries or complaints, and similar requests. Following is an example of how a manual workplace service is configured and displayed in the Workplace Service Portal.
    ...
    Manual Workplace Service created as 'General Workplace Enquiry' in the Workplace Case Management application:![Manual Workplace Service created as 'General Workplace Enquiry' in the Workplace Case Management application.](../image/wcasemgmt-manual-workplace-service.png)
...
-   **Flow**: The flow option enables you to select an existing sub-flow from the application. For more information about Flows, see [Flows](https://www.servicenow.com/docs/access?context=flows&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).

**Parent Topic:**[Explore Workplace Case Management](workplace-case-mgmt-ovw.md)
