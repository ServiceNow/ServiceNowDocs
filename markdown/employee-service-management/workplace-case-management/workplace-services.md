...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-case-management/workplace-services.html
release: zurich
...
-   **Flow**: The flow option enables you to select an existing sub-flow from the application. For more information about Flows, see [Flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/flows.md).

**Parent Topic:**[Exploring Workplace Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-case-management/workplace-case-mgmt-ovw.md)
