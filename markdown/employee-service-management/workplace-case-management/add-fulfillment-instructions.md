...
Knowledge article to support the instructions.Select the unlock knowledge articles icon \(![Unlock Knowledge articles icon.](../image/unlock-icon.png)\) to add an article. Select the lookup icon \(![Lookup icon.](../image/search-icon.png)\) to search for an article.
