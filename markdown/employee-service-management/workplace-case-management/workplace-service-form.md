...
-   **Flow**: Select this option to use an existing subflow from the application for fulfillment. For more information about Flows, see [Create a subflow](https://www.servicenow.com/docs/access?context=create-subflow&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
