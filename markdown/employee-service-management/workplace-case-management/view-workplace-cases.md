...
</table>5.  Select the Personalized list icon \(![Gear settings icon.](../../workplace-space-mapping/images/gear-icon.png)\) to add the additional fields that you require.
...
11. To ensure that services are retained, select **Save reservation**.
