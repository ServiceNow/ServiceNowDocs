...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-case-management/submit-emergency-maint-request.html
release: yokohama
...
2.  Select **Submit an emergency maintenance request** record form.
    ...
    \[Omitted image "wsd-submit-emergency-request-form-use.png"\] Alt text: Submit an emergency maintenance request form.
