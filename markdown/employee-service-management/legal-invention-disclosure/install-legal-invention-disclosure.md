...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-invention-disclosure/install-legal-invention-disclosure.html
release: xanadu
...
# Install Legal Invention Disclosure

You can install the Legal Invention Disclosure application by installing the Legal Simple Intellectual Property \(sn\_lg\_ip\) application if you have the admin role.
...
The following items are installed with Legal Invention Disclosure:
...
2.  Find the Legal Simple Intellectual Property application \(sn\_lg\_ip\) using the filter criteria and search bar.
