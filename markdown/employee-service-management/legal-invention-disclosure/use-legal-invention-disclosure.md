...
-   **[Review the Legal Invention Disclosure request](../task/request-for-clarification.md)**  
...
-   **[Respond to a request for clarification for a Legal Invention Disclosure request](../task/submit-request-for-review.md)**  
...
-   **[Create a matter or add a Legal Invention Disclosure request to an existing matter](../task/create-matter.md)**  
...
-   **[Associate an existing Outside Counsel to a legal matter](../task/add-outside-counsel-to-existing-matter.md)**  
...
-   **[Proceed with a Legal Invention Disclosure request](../task/idf-proceed-application.md)**  
...
-   **[Provide Legal Invention Disclosure request information to an outside counsel](../task/idf-provide-info-outside-counsel.md)**  
...
-   **[Facilitate the patent review process](../task/facilitate-patent-review-process.md)**  
