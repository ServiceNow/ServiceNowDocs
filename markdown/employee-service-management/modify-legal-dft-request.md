...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/modify-legal-dft-request.html
release: zurich
topic_type: task
...
<table id="choicetable_pdc_mqj_znb"><thead><tr><th align="left" id="d233872e99">

Action

</th><th align="left" id="d233872e102">

Steps

</th></tr></thead><tbody><tr><td id="d233872e108">
...
2.  In the Variables form, complete any of the following actions:
    ...
    -   To add custodial data, click **Add**. For more information, see [Add a custodian to a digital forensic request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/submit-legal-dft-request.md).
    -   To remove all custodial data, click **Remove All**.
    -   To add non-custodial data, click **Add**. For more information, see [Add a custodian to a digital forensic request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/submit-legal-dft-request.md).
    -   To remove all non-custodial data, click **Remove All**.
    -   To add multiple custodial or non-custodial data from a file in one go, click **Upload**. For more information, see [Add custodial and non-custodial data from a file](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/submit-legal-dft-request.md).
.
...
<table id="choicetable_dtv_1j4_gtb"><thead><tr><th align="left" id="d233872e250">

Option

</th><th align="left" id="d233872e253">

Steps

</th></tr></thead><tbody><tr><td id="d233872e259">
