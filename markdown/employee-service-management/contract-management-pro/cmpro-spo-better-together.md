...
1.  [Install Sourcing and Procurement Operations](https://www.servicenow.com/docs/access?context=activate-finance-spend-central&version=yokohama&pubname=yokohama-source-to-pay-operations&ft:locale=en-US).
2.  [Install Contract Management Pro](../task/cncore-install-cmpro.md).
3.  [Integrate with Contract Management Pro](https://www.servicenow.com/docs/access?context=integrate-spo-with-cmpro&version=yokohama&pubname=yokohama-source-to-pay-operations&ft:locale=en-US).
...
1.  [Configuring Sourcing and Procurement Operations](https://www.servicenow.com/docs/access?context=configuring-spo&version=yokohama&pubname=yokohama-source-to-pay-operations&ft:locale=en-US).
...
3.  [Initiate a contract request](https://www.servicenow.com/docs/access?context=initiate-contract-request&version=yokohama&pubname=yokohama-source-to-pay-operations&ft:locale=en-US).
