...
1.  [Install Sourcing and Procurement Operations](https://www.servicenow.com/docs/access?context=activate-finance-spend-central&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US).
2.  [Install Contract Management Pro](../task/cncore-install-cmpro.md).
3.  [Integrate with Contract Management Pro](https://www.servicenow.com/docs/access?context=integrate-spo-with-cmpro&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US).
...
1.  [Configure Sourcing and Procurement Operations](https://www.servicenow.com/docs/access?context=configuring-spo&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US).
...
3.  [Initiate a contract request](https://www.servicenow.com/docs/access?context=initiate-contract-request&version=zurich&pubname=zurich-source-to-pay-operations&ft:locale=en-US).
