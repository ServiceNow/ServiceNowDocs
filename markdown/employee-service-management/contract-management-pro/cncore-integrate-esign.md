...
-   **[Adobe Sign spoke](https://www.servicenow.com/docs/access?context=adobe-sign-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) v2.5.1 or later version**
...
-   **[DocuSign spoke](https://www.servicenow.com/docs/access?context=docusign-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) v4.1.x or later version**
...
**Parent Topic:**[External applications for Contract Management Pro](../concept/cncore-set-ext-app-config.md)
