...
A contract template that is active and is in the Draft or Editing state must exist. For more information, see [Create a contract template to contain content controls](cncore-create-ct-word-addin.md).
...
<table id="choicetable_j14_bd2_2yb"><thead><tr><th align="left" id="d129144e210">

Methods for content and clause mapping

</th><th align="left" id="d129144e213">

Steps

</th></tr></thead><tbody><tr><td id="d129144e219">
