...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cmpro-send-receive-email-notification-admin.html
release: yokohama
...
5.  Select **Update**.
    ...
    **Note:** You must configure the **ApprovalNotificationWorkspaceURLExt** extension point to enable the notifications for Legal Counsel Center.
    ...
    For more information, see [Configure extension point for notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cmpro-configure-action-extension-point-email-notification-admin.md).
