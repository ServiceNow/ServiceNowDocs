...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cmpro-approve-reject-request-docs.html
release: yokohama
...
breadcrumb: [Initiate an ad hoc approval for a contract document revision, Using Contract Management Pro, Contract Management Pro, Employee Service Management]
---
...
<table id="choicetable_ix4_gbl_trb"><thead><tr><th align="left" id="d194013e54">

Options

</th><th align="left" id="d194013e57">

Steps

</th></tr></thead><tbody><tr><td id="d194013e63">
...
</table>**Parent Topic:**[Initiate an ad hoc approval for a contract document revision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cmpro-initiate-approval-contract-request.md)
