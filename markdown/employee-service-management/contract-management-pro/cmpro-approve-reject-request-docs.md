...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/contract-management-pro/cmpro-approve-reject-request-docs.html
release: xanadu
...
breadcrumb: [Initiate an ad hoc approval for a contract document revision, Use Contract Management Pro, Contract Management Pro, Employee Service Management]
---
...
<table id="choicetable_ix4_gbl_trb"><thead><tr><th align="left" id="d79647e54">

Options

</th><th align="left" id="d79647e57">

Steps

</th></tr></thead><tbody><tr><td id="d79647e63">
...
</table>**Parent Topic:**[Initiate an ad hoc approval for a contract document revision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contract-management-pro/cmpro-initiate-approval-contract-request.md)
