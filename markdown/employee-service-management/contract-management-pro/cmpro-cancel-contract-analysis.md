...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/contract-management-pro/cmpro-cancel-contract-analysis.html
release: xanadu
...
You must have started the contract analysis with Now Assist. For more information, see [Analyze a contract document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contract-management-pro/cmpro-analyze-contract-doc.md).
