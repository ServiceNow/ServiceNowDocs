...
<table id="choicetable_rvj_4rw_bcc"><thead><tr><th align="left" id="d121930e140">

Action

</th><th align="left" id="d121930e143">

Steps

</th></tr></thead><tbody><tr><td id="d121930e149">
...
For more information, see [Map contract document tables using the Microsoft Word add-in for ServiceNow Contracts](cncore-addin-table.md).
