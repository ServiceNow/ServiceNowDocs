...
If you want the variables related to the contract request to be available in condition builder, add the contract request reference to your application table. For more information, see [Provide access to contract request fields in condition builders](cncore-add-cmr-condtion-build.md)
...
<table id="choicetable_grz_dw5_yxb"><thead><tr><th align="left" id="d78413e214">

Mapping type

</th><th align="left" id="d78413e217">

Fields available

</th></tr></thead><tbody><tr><td id="d78413e223">
