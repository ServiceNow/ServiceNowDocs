...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cncore-contract-config.html
release: yokohama
...
If you want the variables related to the contract request to be available in condition builder, add the contract request reference to your application table. For more information, see [Provide access to contract request fields in condition builders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-add-cmr-condtion-build.md)
...
3.  On the Contract Configuration form, fill in the fields.
    ...
    For more information, see [Contract Configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-contract-config-form.md).
...
<table id="choicetable_grz_dw5_yxb"><thead><tr><th align="left" id="d75827e214">

Mapping type

</th><th align="left" id="d75827e217">

Fields available

</th></tr></thead><tbody><tr><td id="d75827e223">
