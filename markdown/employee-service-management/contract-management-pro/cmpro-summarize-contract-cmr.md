...
-   The smart documents skill must be activated. For more information, see [Configure the Smart Documents Skill for Now Assist in Document Management](https://www.servicenow.com/docs/access?context=configure-skill-smart-documents&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
-   The Now Assist panel must be enabled. For more information, see [Activate Now Assist panel standard chat](https://www.servicenow.com/docs/access?context=activate-now-assist-panel&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US).
