...
-   The smart documents skill must be activated. For more information, see Configure the Smart Documents Skill for Now Assist in Document Management.
...
-   The Now Assist panel must be enabled. For more information, see Activate the Now Assist panel standard chat.
...
4.  Select **Ask Now Assist**.
    ...
    For more information on using Now Assist for generating summaries, see Generate a document summary by using Now Assist in Document Management and Generate summary and ask questions using Now Assist in Document Management.
