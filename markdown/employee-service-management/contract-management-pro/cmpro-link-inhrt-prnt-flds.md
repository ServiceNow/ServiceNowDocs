...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cmpro-link-inhrt-prnt-flds.html
release: yokohama
...
Ensure that the parent child mapping is configured. For more information, see [Configure field mapping for parent-child contract linking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncor-conf-parent-child.md).
...
<table id="choicetable_zst_kcr_5bc"><thead><tr><th align="left" id="d68890e86">

Method

</th><th align="left" id="d68890e89">

Steps

</th></tr></thead><tbody><tr><td id="d68890e95">
