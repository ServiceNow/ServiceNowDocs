...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/contract-management-pro/cncore-add-cmr-condtion-build.html
release: zurich
...
3.  Add the contract request as a reference field to the table.
    ...
    7.  On the Dictionary entry form, fill in the fields.
        ...
        For more information, see [Dictionary entry form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/r_DictionaryEntryForm.md).
