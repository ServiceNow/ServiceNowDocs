...
3.  Add the contract request as a reference field to the table.
    ...
    7.  On the Dictionary entry form, fill in the fields.
        ...
        For more information, see [Dictionary entry form](https://www.servicenow.com/docs/access?context=r_DictionaryEntryForm&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
