...
-   **![](../../../reuse/icons/dcx-icons/dcx-icon-docs.svg) Release Notes**
    ...
    Learn more about what's new and changed. See the [Contract Management Pro release notes](https://www.servicenow.com/docs/access?context=cmpro-rn&version=yokohama&pubname=yokohama-release-notes&ft:locale=en-US).
