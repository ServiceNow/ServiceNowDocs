...
1.  Activate the smart documents skill in Now Assist in Document Management. For more information, see [Configure the Smart Documents Skill for Now Assist in Document Management](https://www.servicenow.com/docs/access?context=configure-skill-smart-documents&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
...
4.  Enable the Now Assist panel for your instance. For more information, see [Activate the Now Assist panel standard chat](https://www.servicenow.com/docs/access?context=activate-now-assist-panel&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US).
