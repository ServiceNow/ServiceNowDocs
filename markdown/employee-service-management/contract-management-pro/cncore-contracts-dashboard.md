...
For more information on working with KPI details, see [Examining indicators with KPI Details](https://www.servicenow.com/docs/access?context=kpi-details-components&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
