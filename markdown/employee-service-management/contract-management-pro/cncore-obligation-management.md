...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cncore-obligation-management.html
release: yokohama
...
2.  The contract manager provides the obligation details, including an obligation task schedule, in the obligation record.
    ...
    For more information, see [Create obligation records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-create-obligations.md).
...
-   **[Create obligation records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-create-obligations.md)**  
...
-   **[Submit obligation tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-work-on-ob-tasks.md)**  
...
-   **[Cancel an obligation task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-cancel-ob-task.md)**  
Cancel an open obligation task in Obligation Management that is no longer required.
-   **[Approve or reject obligation tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-manage-ob-tasks.md)**  
