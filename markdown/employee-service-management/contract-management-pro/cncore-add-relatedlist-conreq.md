---
title: Add Contract requests tab to your workspace
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cncore-add-relatedlist-conreq.html
release: yokohama
...
For the **Contract request**Role required: admin
...
The Contract requests tab will appear in your workspace.

For more information on roles required to work on contract requests, see [Components installed with Contract Management Pro](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-comp-ccore.md).
