...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cmpro-initiate-approval-contract-request.html
release: yokohama
...
<table id="choicetable_jhj_kb3_gtb"><thead><tr><th align="left" id="d83975e100">

Option

</th><th align="left" id="d83975e103">

Steps

</th></tr></thead><tbody><tr><td id="d83975e109">
...
Approvers can view and [Approve or reject a contract document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cmpro-approve-reject-request-docs.md).

-   **[Approve or reject a contract document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cmpro-approve-reject-request-docs.md)**  
Review a contract request or attachment and approve or reject it.
-   **[Cancel an ad hoc approval for a contract document revision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cmpro-cancel-approval-request.md)**  
