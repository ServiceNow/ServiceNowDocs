...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/contract-management-pro/cmpro-conf-users-agentic-wf.html
release: australia
...
In ServiceNow Otto for Contract Management Pro, the following roles are configured with the base system to provide data access to the agentic workflows in Contract Management Pro.
