...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cncore-publish-template.html
release: yokohama
...
3.  Review the contract document.
    ...
    1.  Generate and preview the contract document.
        ...
        For more information, see [Generate and preview a contract document from a template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-preview-template.md).
