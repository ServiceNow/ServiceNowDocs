...
Displays the skill name for which you’re creating the use case.
    ...
    2.  Enter details for the new field.
        ...
        For more information on the field form, see [Field form for document extraction setup](https://www.servicenow.com/docs/access?context=document-extraction-single-field-form&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US).
