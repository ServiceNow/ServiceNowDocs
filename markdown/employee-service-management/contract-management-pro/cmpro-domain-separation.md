...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cmpro-domain-separation.html
release: yokohama
...
Domain separation in Contract Management Pro is enabled through the Domain Separation plugin. For more information, see [Request domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/servicenow-ai-platform-security/t_ActivateDomainSeparation.md).
