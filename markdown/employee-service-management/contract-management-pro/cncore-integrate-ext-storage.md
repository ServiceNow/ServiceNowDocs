...
The following video walks you through the process of configuring your external storage for Contract Management Pro.Video explaining how to configure external storage for Contract Management Pro, approximately two minutes long. 
...
-   **[Microsoft OneDrive spoke](https://www.servicenow.com/docs/access?context=onedrive-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) v2.1.0 or later version**
    ...
    For more information on the setup and creating the Google Drive account, see [Set up Microsoft OneDrive spoke](https://www.servicenow.com/docs/access?context=setup-msonedrive&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) .
