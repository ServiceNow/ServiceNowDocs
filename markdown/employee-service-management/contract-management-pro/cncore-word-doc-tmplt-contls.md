...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cncore-word-doc-tmplt-contls.html
release: yokohama
...
8.  Enter a tag value.
    ...
    **Note:**
    ...
    -   When adding content controls for signature or signatories, set the font color of the content control tags to match the document’s background color.
