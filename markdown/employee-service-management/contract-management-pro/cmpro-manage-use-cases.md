...
5.  Select the actions icon ![Actions icon.](../image/cmpro-na-three-dot-icon.png) on the use case that you want to update, delete, deactivate, or copy.
    ...
    -   **Edit**
        ...
        For more information on the **Field** form, see [Field form for use case setup](https://www.servicenow.com/docs/access?context=document-extraction-single-field-form&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US) and [Question form for use case setup](https://www.servicenow.com/docs/access?context=document-qna-single-field-form&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
