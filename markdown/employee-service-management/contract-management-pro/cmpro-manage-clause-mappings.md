...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cmpro-manage-clause-mappings.html
release: yokohama
...
5.  Select the actions icon \[Omitted image "cmpro-na-three-dot-icon.png"\] Alt text: Actions icon on the clause mapping that you want to update, delete, or deactivate.
    ...
    -   **Edit**
        ...
        For more information on clause mapping, see [Map a field group to a clause](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cmpro-na-map-fieldgrp-clause.md).
