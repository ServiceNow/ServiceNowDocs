...
This field should be left empty.
    ...
    4.  Enter details for the field.
        ...
        For more information on the field form, see [Question form for use case setup](https://www.servicenow.com/docs/access?context=document-qna-single-field-form&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
