...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/contract-management-pro/cncore-initiate-self-served-contract.html
release: xanadu
...
Before initiating a self-serve contract request, ensure you have created contract types and templates for them. For more information, see [Create a contract type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contract-management-pro/cncore-create-contract-type.md) and [Configure contract templates for a contract request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contract-management-pro/cncore-document-templates.md).
...
-   If there were validation errors, complete the signatory details and resubmit the contract request. For more information, see [Resolve the failure to submit a self-serve contract](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contract-management-pro/cncore-sync-signatories-fulfiller.md).
-   If there were no validation errors, you can proceed to work on the contract request. For more information see, [Work on a self-served contract request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contract-management-pro/cncore-work-ss-cntr-request-fulfiller.md) and [Work on a self-served contract request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contract-management-pro/cncore-work-ss-cntr-request-fulfiller.md).
