...
4.  On the Contract Analysis Playbook form, fill in the fields.
    ...
    For a description of the fields, see [Contract Analysis Playbook form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/employee-service-management/contract-management-pro/cmpro-negotiation-playbook-form.md).
