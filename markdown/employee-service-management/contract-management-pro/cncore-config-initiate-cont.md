...
1.  Add initiate contract request functionality to your workspace.
    ...
    1.  Navigate to **All** &gt; **Now Experience Framework** &gt; **Declarative Actions** &gt; **Form Actions**
        ...
        For more information, see [Customizing Configurable Workspace with declarative actions](https://www.servicenow.com/docs/access?context=declarative-actions-landing&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
