...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contract-management-pro/cncore-create-obligations.html
release: yokohama
...
<table id="choicetable_zst_kcr_5bc"><thead><tr><th align="left" id="d669276e83">

Method

</th><th align="left" id="d669276e86">

Steps

</th></tr></thead><tbody><tr><td id="d669276e92">
...
4.  On the form, fill in the fields.
    ...
    For more information, see [Obligation form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-obligation-form.md).

5.  Select **Save**.


-   **[Create an ad hoc obligation task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contract-management-pro/cncore-adhoc-ob-task.md)**  
