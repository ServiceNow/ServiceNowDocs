...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/contract-management-pro/cncore-create-obligations.html
release: xanadu
...
breadcrumb: [Obligation Management, Use Contract Management Pro, Contract Management Pro, Employee Service Management]
---
...
<table id="choicetable_zst_kcr_5bc"><thead><tr><th align="left" id="d189642e83">

Method

</th><th align="left" id="d189642e86">

Steps

</th></tr></thead><tbody><tr><td id="d189642e92">
...
4.  On the form, fill in the fields.
    ...
    For more information, see [Obligation form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contract-management-pro/cncore-obligation-form.md).

5.  Select **Save**.


-   **[Create an ad hoc obligation task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contract-management-pro/cncore-adhoc-ob-task.md)**  
