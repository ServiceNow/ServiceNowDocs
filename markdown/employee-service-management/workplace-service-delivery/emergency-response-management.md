...
![Manage user status end-to-end](../image/covid-apps_workflow.png "Emergency response app workflow from self-reporting to assessing exposure to requesting user health status check-in")
