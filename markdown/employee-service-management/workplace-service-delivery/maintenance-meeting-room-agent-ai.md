...
1.  Navigate to **All** &gt; **AI Agent Studio** &gt; **Overview** &gt; **Manage Temporary space closures.**.
    ...
    The Manage temporary space closure Describe and Connect workflow opens. For more information, see [AI agents used in the Manage temporary space closures workflow](maintenance-meeting-room-agent-ai.md#section_ifc_bby_w2c).
