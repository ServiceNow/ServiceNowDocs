...
[Reserve ![Reserve](../../workplace-service-delivery/images/icon-request.png) Make a reservation using the Workplace Reservations for Microsoft Outlook Add-in.](../task/make-reservation-using-outlook-add-in.md)
