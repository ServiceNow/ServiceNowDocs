...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/legal-investigations/integrate-lsd-hrsd.html
release: yokohama
...
4.  Configure the Universal Request property to determine how the primary ticket should be handled while transferring between the departments.
    ...
    For more information, see [Universal Request properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/universal-request-for-hr-service-delivery/ur-properties.md).
