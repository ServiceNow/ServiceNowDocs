...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-investigations/lsd-investigations-hr-emp-relations.html
release: xanadu
...
breadcrumb: [Exploring Legal Investigations, Legal Investigations, Legal Service Delivery Practice Applications, Legal Service Delivery, Employee Service Management]
---
...
-   [Set up Legal Investigations with HR Service Delivery Employee Relations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-investigations/integrate-lsd-hrsd.md)
-   [Configure Universal Request for legal services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-service-delivery/configure-universal-request-legal.md)

## Data mapping

When information related to HR [Employee Relations cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/hr-case-employee-relations.md) and related legal ethics matters is transferred between HR and the Legal departments, a complete data copy with appropriate data mapping is performed. For the Legal to HR transfer, activate the `HRERDepartmentTransferPostProcessor` script to enable copying. For more information, see [Data mapping fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-investigations/deep-data-copy-mapping.md).
