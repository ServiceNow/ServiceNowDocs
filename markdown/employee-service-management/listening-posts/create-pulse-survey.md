...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/listening-posts/create-pulse-survey.html
release: yokohama
...
5.  In the **Questions** related list:
    ...
    -   To add a question to the content, click **New**. For more information, see [Create a pulse question in Listening Posts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/listening-posts/create-pulseq.md).
...
-   In the **Feedback initiators** related list, click **New** to initiate feedback surveys based on trigger conditions. See [Automatically initiate a pulse survey from Listening Posts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/listening-posts/auto-initiate-cnd.md).

-   **[Automatically initiate a pulse survey from Listening Posts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/listening-posts/auto-initiate-cnd.md)**  
