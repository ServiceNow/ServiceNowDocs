...
For more information on setting up the post-authentication policy, see [Configure an authentication policy](https://www.servicenow.com/docs/access?context=configure-allow-access-policy&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
