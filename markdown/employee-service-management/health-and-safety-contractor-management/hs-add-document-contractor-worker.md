...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/health-and-safety-contractor-management/hs-add-document-contractor-worker.html
release: xanadu
...
# Add a document to a contractor worker

Add any documents collected from a contractor worker or related to this contractor worker.

## Before you begin

Role required: sn\_hs\_crm.contractor\_coordinator or sn\_ohs\_im.document\_writer
...
<table id="choicetable_v4f_5dw_bdc"><thead><tr><th align="left" id="d67571e73">

Option

</th><th align="left" id="d67571e76">

Steps

</th></tr></thead><tbody><tr><td id="d67571e82">
...
</table>3.  In the **Documents** tab, select **New**.

4.  On the form, fill in the fields.

    For information on form field descriptions, see [Health and Safety document form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-core/hs-document-form.md).
...
-   The document is also listed in the **Standards and documents** list under **Configuration** and is saved in the Health and Safety user document \[sn\_ohs\_im\_m2m\_hs\_user\_document\] table.
