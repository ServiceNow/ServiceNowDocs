...
Confirm that the snc\_external role is assigned to the contractor worker. For more information on this explicit role, see [Explicit Roles](https://www.servicenow.com/docs/access?context=explicit-roles&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
