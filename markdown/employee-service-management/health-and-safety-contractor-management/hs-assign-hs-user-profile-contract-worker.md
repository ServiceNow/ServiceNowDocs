...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/health-and-safety-contractor-management/hs-assign-hs-user-profile-contract-worker.html
release: xanadu
...
breadcrumb: [Configure settings, Health and Safety Contractor Management, Health and Safety, Employee Service Management]
---
...
Confirm that the snc\_external role is assigned to the contractor worker. For more information on this explicit role, see [Explicit Roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/servicenow-ai-platform-security/explicit-roles.md).
...
5.  On the form, fill in the fields.
    ...
    For information on form field descriptions, see [Health and Safety profile form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-core/hs-health-safety-profile-form.md).
