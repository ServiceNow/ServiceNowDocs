...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/localize-manifest-file-st.html
release: xanadu
topic_type: concept
...
You must activate the localized plugins in your instance. To install the language plugin, see [Activate a language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/system-localization/t_ActivateALanguage.md).
