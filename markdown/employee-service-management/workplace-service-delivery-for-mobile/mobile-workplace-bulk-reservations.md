...
When an employee creates a future date reservation from the Workplace page, the **All day** check box is selected on the reservation page. The **All day** check box is selected, even if the **All day** is set to **Full day** or **Office hours** in the Reservable Module Configuration by your administrator. When an employee creates a reservation and selects today's date or current date after the standard office hours **Start time** and **End time**, the **All day** check box is not selected on the reservation page. The **All day** check box is not selected on the Make a Reservation page as the timings specified are outside of the standard office or working hours. For more information about the office hours start and end property, see [Properties installed with Workplace Reservation Management](../../wsd-reservation-management/reference/properties-installed-with-wsd-reservation-mgmt.md).
