...
1.  [Mobile Wayfinding Administration](mobile-wayfinding.md)  
...
2.  [Enable map view to create reservations](../task/enable-map-view-mobile-reservations.md)  
Enable map view for mobile employee users so that they can reserve spaces using floor maps Now Mobile app.
3.  [Configure the Toggle map view property](../task/configure-toggle-map-view.md)  
Configure the Toggle map view option on the Now Mobile app app while reserving a space.
4.  [Configure AI search for Workplace Service Delivery for Mobile](../task/configure-ai-search-mobile.md)  
...
5.  [Configure map properties for Location directory](../task/wsd-mobile-map-config-properties-loc-directory.md)  
