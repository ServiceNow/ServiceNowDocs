...
3.  [Edit or cancel a reservation on Now Mobile app](../task/edit-rsv-on-mobile.md)  
Modify your upcoming reservation or cancel the reservation at any time using the Now Mobile app.
4.  [Check in or check out a reservation](../task/check-in-out-rsv-on-mobile.md)  
Check in an upcoming reservation or check out an ending reservation using the Now Mobile app.
5.  [Share your reservation details with other users](../task/share-rsv-details.md)  
...
6.  [Scan the QR code to reserve a space](../task/scan-qr-code.md)  
Scan the QR code of a workplace and quickly reserve a space using the Now Mobile app.
7.  [Work with Location Directory for Now Mobile app](../task/view-location-directory-mobile.md)  
...
8.  [Get directions to a workplace](../task/get-directions-to-a-workplace.md)  
