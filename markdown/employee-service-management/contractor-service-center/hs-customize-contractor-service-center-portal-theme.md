...
3.  Configure the theme content to suit your requirement.
    ...
    6.  Edit the **CSS variables** field to customize the text and the background colors of your portal.
        ...
        -   To create a portal theme and for a description of the field values to create a portal theme, see [Create a portal theme](https://www.servicenow.com/docs/access?context=c_CustomCSS&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
        -   To configure a portal header or footer, see [Configure a portal header menu](https://www.servicenow.com/docs/access?context=configure-header-menu&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
