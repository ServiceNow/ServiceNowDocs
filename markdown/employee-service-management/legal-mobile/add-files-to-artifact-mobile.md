...
6.  You can rename the file by tapping the edit icon \(![Edit icon.](../image/edit-icon.png)\) and entering a new name.
    ...
    **Note:** If a file is no longer required for the legal matter, you can remove the file by tapping the delete icon \(![Delete icon.](../../legal-request-management/image/delete-icon.png)\).
