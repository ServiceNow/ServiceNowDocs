...
3.  On the Form Mappings Configurations form, fill in the fields.
    ...
    For a description of the field values, see [Form Mapping Configurations form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/form-mapping-config-form.md).
...
6.  On the Office Mailbox to Form Field Mappings form, fill in the fields.
    ...
    For a description of the field values, see [Office Mailbox to Form Field Mappings form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/mailbox-form-mapping-form.md).
