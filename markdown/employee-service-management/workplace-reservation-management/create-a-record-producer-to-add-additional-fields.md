...
5.  On the Dictionary Entry form, fill in the fields.
    ...
    For more information on columns and fields, refer to [Field administration](https://www.servicenow.com/docs/access?context=c_IntroductionToFields&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
5.  Select **Active** to activate the record producer.
    ...
    For further form field descriptions, refer to [Record Producer form](https://www.servicenow.com/docs/access?context=record-producer-form&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
8.  In the **Variables** related list, add the additional details that you want to configure.
    ...
    -   Select Box
    -   Single Line Text
    To learn more about the different types of variables and how to configure them, see [Types of service catalog variables](https://www.servicenow.com/docs/access?context=r_VariableTypes&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) Types of service catalog variables.
...
10. You can add **Catalog UI Policies**.
    ...
    Refer to [Service catalog UI policy](https://www.servicenow.com/docs/access?context=c_ServiceCatalogUIPolicy&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)

11. You can add **Catalog Client Scripts**.

    Refer to [Create a Service Catalog client script](https://www.servicenow.com/docs/access?context=t_CreateACatalogClientScript&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
