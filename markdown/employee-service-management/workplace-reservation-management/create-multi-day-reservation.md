...
<table id="choicetable_prt_yr3_smb"><thead><tr><th align="left" id="d491754e102">

Location

</th><th align="left" id="d491754e105">

Steps

</th></tr></thead><tbody><tr><td id="d491754e111">
...
-   Another way to make reservation is to use chat icon. On the home page, select the chat icon \(![Chat icon.](../../workplace-case-mgmt/image/chat-icon.png)\). To make a reservation, enter your question or select **Show Me Everything** to select from the list of available options.
