...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-reservation-management/displayname-person-booking-rsv.html
release: yokohama
...
5.  Select the map gear settings icon \(\[Omitted image "wsd-gear-settings-icon.png"\] Alt text: Floor map gear settings icon.\) to view Display options.
