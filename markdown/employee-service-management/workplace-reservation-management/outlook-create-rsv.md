...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-reservation-management/outlook-create-rsv.html
release: yokohama
...
-   Upload the manifest file in Microsoft Outlook Add-in. Depending on your usage, complete the following:
    ...
    For more information, see [Activate the add-in for Microsoft Outlook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-reservation-management/add-outlook-addin.md).
...
2.  Perform any one of the following actions depending on the type of reservation that you want to make:
    ...
    -   Complete the New Event form details in Outlook Calendar:
        ...
        -   All day: Option to enable **All day** reservation. For more information, see [Configure Reservable Module for Microsoft Outlook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-reservation-management/config-rsv-module-outlook.md).
