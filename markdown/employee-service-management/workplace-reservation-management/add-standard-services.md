...
Add the standard service to a workplace room or space. For more information, see [Add a standard service to workplace](add-std-service-to-workplaceitem.md).

-   **[Add a standard service to workplace](add-std-service-to-workplaceitem.md)**  
