...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-reservation-management/add-standard-services.html
release: zurich
...
3.  On the form, fill in the fields.
    ...
    |Field|Description|
    |-----|-----------|
    |Name|Enter the name of the standard service|
    |Active|Select active to make it available in reservations.|
    |**Service Configuration** section|Specify the field details in the Service Configuration section.|
    |Short description|Enter a short description about the service.|
    |Font awesome icon|A font awesome icon in the 'fa-\(name\)' format. Currently, the **Font Awesome** library of version 4.7 is supported.|
...
The standard service is added to the application.

## What to do next

Add the standard service to a workplace room or space. For more information, see [Add a standard service to workplace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-reservation-management/add-std-service-to-workplaceitem.md).

-   **[Add a standard service to workplace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-reservation-management/add-std-service-to-workplaceitem.md)**  
