...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-reservation-management/create-group-reservation.html
release: yokohama
...
<table id="choicetable_ewc_11d_vrb"><thead><tr><th align="left" id="d514431e73">

Location

</th><th align="left" id="d514431e76">

Steps

</th></tr></thead><tbody><tr><td id="d514431e82">
...
7.  On the form, specify the reservation details.
    ...
    3.  Clear the **Reserve these items together for the same person** option.
        ...
        \[Omitted image "wsd-group-reservation-use.png"\] Alt text: Reservation details page showing options to reserve a space for a group.
