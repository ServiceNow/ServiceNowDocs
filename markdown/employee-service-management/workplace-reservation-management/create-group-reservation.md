...
<table id="choicetable_ewc_11d_vrb"><thead><tr><th align="left" id="d501840e73">

Location

</th><th align="left" id="d501840e76">

Steps

</th></tr></thead><tbody><tr><td id="d501840e82">
...
7.  On the form, specify the reservation details.
    ...
    3.  Clear the **Reserve these items together for the same person** option.
        ...
        ![Reservation details page showing options to reserve a space for a group.](../image/wsd-group-reservation-use.png)
