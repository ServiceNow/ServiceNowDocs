...
To configure mobile push notifications, refer to [Mobile push notifications](https://www.servicenow.com/docs/access?context=sg-mobile-push-notifications&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US).
