...
1.  Setup Zoom to enable virtual meeting.
    ...
    Refer to the Create a connected app in Zoom topic in [Set up the](https://www.servicenow.com/docs/access?context=setup-zoom&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US)
