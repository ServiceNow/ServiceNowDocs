...
**Previous topic:**[Create a reservation in Microsoft Outlook add-in](outlook-create-rsv.md)

**Next topic:**[Delegate reservations in Microsoft Outlook add-in](outlook-delegate-rsv.md)
