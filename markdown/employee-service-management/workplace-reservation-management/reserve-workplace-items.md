...
-   **[Create a reservation](../task/create-reservation-request-1.md)**  
...
-   **[Add invitees as collaborators and create a reservation](../task/add-colleagues-rsv-search.md)**  
...
-   **[Auto-resolve recurring reservations](../task/recurring-reservations.md)**  
...
-   **[Reserve a space near your colleague](../task/browse-near-person-rsv.md)**  
Make a workplace reservation and reserve a space near your team member or a colleague.
-   **[Create multi-building reservations](../task/create-multi-building-reservation.md)**  
...
-   **[Create a multi-day reservation](../task/create-multi-day-reservation.md)**  
...
-   **[Create neighborhood reservations](../task/create-neighborhood-reservations.md)**  
Reserve neighborhood spaces using Advanced reservation.
-   **[Create reservation for multiple workplace items](../task/create-reservation-for-multiple-wrkplceitems-1.md)**  
Reserve multiple workplace items for the same date and time in a single reservation.
-   **[Create a group reservation](../task/create-group-reservation.md)**  
Reserve multiple spaces for different users in a single group reservation.
-   **[Enable shift-based reservation](../task/enable-shift-based-reservation.md)**  
...
-   **[Set a location as favorite using the Space details page](../task/set-a-location-as-favorite.md)**  
...
-   **[Create a reservation along with a shared reservation](../task/create-rsv-along-with-shared-rsv.md)**  
Reserve a workplace near to your co-worker using their shared reservation details.
-   **[Create a reservation including a virtual meeting link](../task/Create-reservation-with-virtual-meeting.md)**  
...
-   **[Create a shift reservation](../task/create-a-shift-reservation.md)**  
Reserve a workplace item for a shift. Create a single reservation or a recurring reservation for the same shift.
-   **[Share, modify, or cancel a reservation](../task/modify-cancel-res-request.md)**  
...
-   **[Reserve a workplace using the Quick Reservation widget](../task/reserve-workplace-for-a-time-slot.md)**  
...
-   **[Download an iCalendar for a reservation](../task/generate-ical.md)**  
