...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-reservation-management/add-std-service-to-workplaceitem.html
release: yokohama
...
5.  On the Edit Members form, select the service.
    ...
    1.  Select the standard service from the **Collection** column on the left.
...
**Parent Topic:**[Create a standard service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-reservation-management/add-standard-services.md)
