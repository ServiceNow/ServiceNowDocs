...
1.  [Create a reservation in Microsoft Outlook add-in](../task/outlook-create-rsv.md)  
...
2.  [Edit reservation details in Microsoft Outlook](../task/outlook-edit-rsv.md)  
Edit or update your workplace reservation using Microsoft Outlook Add-in.
3.  [Delegate reservations in Microsoft Outlook add-in](../task/outlook-delegate-rsv.md)  
