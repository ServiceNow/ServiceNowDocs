...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-space-management/configure-a-boma-type.html
release: yokohama
...
1.  Navigate to **All** &gt; **Workplace Core** &gt; **Administration** &gt; **BOMA type configuration**.

2.  Click **New**.

3.  On the BOMA type form, enter a **Name** for the BOMA type.

4.  Select **Active** to activate the BOMA type.
...
The BOMA type is configured. To map the BOMA type with a Space type, refer to [Map a space type with BOMA type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-space-management/map-a-space-type-with-boma-type.md).
