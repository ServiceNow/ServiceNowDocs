...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-space-management/create-view-by-config.html
release: zurich
...
3.  On the View by Configuration form, fill in the fields.
    ...
    For a description of the field values, see [View by Configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-space-management/view-by-configuration-form.md).
