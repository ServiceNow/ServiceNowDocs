...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/config-vaccination-properties.html
release: xanadu
topic_type: task
...
-   Vaccine code, such as a CVX code, to verify the vaccine's manufacturer
 This property is inactive by default. For more information on enabling automated vaccine response reviews, see [Automating vaccine response reviews](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/vaccination-status-vaccine-validation.md).
