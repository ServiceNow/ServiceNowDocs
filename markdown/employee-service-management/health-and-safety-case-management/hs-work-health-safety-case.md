...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety-case-management/hs-work-health-safety-case.html
release: yokohama
...
5.  On the form, fill in the fields.
    ...
    For information about safety case form fields, see [Health and Safety case form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety-case-management/hs-case-form.md).
...
8.  In the **Documents** tab, add any documents related to the case.
    ...
    For more information, see [Add a new Health and Safety related document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety-core/add-hs-related-document.md).
