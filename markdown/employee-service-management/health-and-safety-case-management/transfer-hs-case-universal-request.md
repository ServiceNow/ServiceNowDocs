...
5.  In the **Primary Ticket** field, select the information \(\[Omitted image "circle-info-outline-24.svg"\] Alt text: information icon\) icon to open the health and safety case.
