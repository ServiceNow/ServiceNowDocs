...
-   [External Content Connectors](https://www.servicenow.com/docs/access?context=ext-cont-connectors-landing-page&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
-   [Exploring External Content Connectors](https://www.servicenow.com/docs/access?context=exploring-ext-cont-connectors&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
