...
Install Virtual Agent Lite or Virtual Agent. For more information see [Virtual Agent integration with messaging apps](https://www.servicenow.com/docs/access?context=va-integration-messaging-apps&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US).
