...
3.  In the search field, enter a name, partial name, or case number.
    ...
    **Note:**
    ...
    -   If your company uses **Employee Relations**, you can select the **Skip verification** link to create an ER case without identifying an Opened for person. For more information on Employee Relations, see [Create an HR Service Delivery Employee Relations case using the legacy UI](create-hr-employee-relations.md).
4.  Select **Next**.
