...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/agent-workspace-for-hr-case-management/copy-case-hr.html
release: australia
...
3.  Select the \[Omitted image "more-icon.png"\] Alt text: More Actions icon icon at the top right-hand corner of the **Details** tab.
