...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/agent-workspace-for-hr-case-management/knowledge-task-aws.html
release: zurich
...
breadcrumb: [Report knowledge gap from a case, Using the More icon in Agent Workspace for HR Case Management, Use, Agent Workspace, HR Service Delivery, Employee Service Management]
---
