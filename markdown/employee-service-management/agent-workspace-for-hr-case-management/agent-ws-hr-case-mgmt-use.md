...
For additional information on working within Agent Workspace, see [Using workspace](https://www.servicenow.com/docs/access?context=using-workspace&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
