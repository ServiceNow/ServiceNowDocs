...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/agent-workspace-for-hr-case-management/run-fix-scripts-aw.html
release: australia
...
5.  Select **Run Script** to approve all the requested RCAs.
