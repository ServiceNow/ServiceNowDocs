...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/agent-workspace-for-hr-case-management/hr-agent-ws-using-response-template.html
release: yokohama
...
breadcrumb: [Response templates in Agent Workspace for HR Case Management, Agent Workspace for HR Case Management contextual side panel, Using Agent Workspace for HR Case Management, Agent Workspace for HR Case Management \(Configurable\), HR Service Delivery, Employee Service Management]
---
...
<table id="choicetable_a5l_fjh_1cc"><thead><tr><th align="left" id="d267927e85">

Item

</th><th align="left" id="d267927e88">

Steps

</th></tr></thead><tbody><tr><td id="d267927e94">

**HR case**

</td><td>

1.  Select **All HR cases** &gt; **Assigned to me**.
2.  Select the HR case.


</td></tr><tr><td id="d267927e121">

**HR task**

</td><td>

1.  Select **HR tasks** &gt; **Assigned to me**.
2.  Select the HR task.
...
6.  Select the response template.

7.  Select the **Copy to clipboard** button and paste the text in the **Comments/Worknotes** area.

8.  Select **Post Comments**.

    The reused message is visible under the **Comments/Worknotes** section to the subject person.
