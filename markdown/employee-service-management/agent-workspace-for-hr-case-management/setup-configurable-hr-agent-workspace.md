...
-   Set up these components:
    ...
    -   Workspace setup. See [Configuring Configurable Workspace](https://www.servicenow.com/docs/access?context=c_set-up-configurable-workspace&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
...
Grants access to all HR cases, profiles, and secure information.With this role, you can manage Agent Workspace for HR Case Management lists and categories.
 ...
 This role contains the Workspace List Admin, which is an elevated role. For more information on elevated roles, see [Elevated privilege roles](https://www.servicenow.com/docs/access?context=c_ElevatedPrivilege&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
