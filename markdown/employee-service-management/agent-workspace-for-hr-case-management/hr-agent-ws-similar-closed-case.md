...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/agent-workspace-for-hr-case-management/hr-agent-ws-similar-closed-case.html
release: zurich
...
breadcrumb: [Machine learning solutions, Use, Agent Workspace, HR Service Delivery, Employee Service Management]
---
...
**Parent Topic:**[Machine learning solutions in Agent Workspace for HR Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/agent-workspace-for-hr-case-management/hr-agent-ws-ml-solutions.md)
