...
For more information about guided decision trees, see [Configuring Guided Decisions](https://www.servicenow.com/docs/access?context=setting-up-guided-decisions&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
