...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/create-app-registry-meeting-extensibility.html
release: xanadu
...
4.  On the form, fill in the fields.
    ...
    -   Client ID: Enter the client ID value in the format `api://<instance-name>.service-now.com/<client-id>` from the section [Create an app in Microsoft Teams to enable making calls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/create-app-ms-teams.md).
...
Enter value in the following format:
 ...
 To copy tenant ID, see [Create an app in Microsoft Teams to enable making calls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/create-app-ms-teams.md).
...
After completing Meeting Extensions integration with Microsoft Teams, see the section [Meeting Extensions for Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/meeting-extensibility-ms-teams.md).
