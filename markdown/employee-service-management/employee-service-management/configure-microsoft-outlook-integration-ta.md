...
1.  Set up the Microsoft Exchange Online spoke.
    ...
    For more information, see [Microsoft Exchange Online Spoke](https://www.servicenow.com/docs/access?context=ms-exch-online-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
