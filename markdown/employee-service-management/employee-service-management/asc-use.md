...
-   **[Register on the Alumni Center website](../task/alumni-self-registration.md)**  
As an external user, sign up using a personal email address and other details to self-register as alumni.
-   **[Alumni job preferences](../task/alumni-job-preferences.md)**  
...
-   **[Add other employment details](../task/add-other-emp-details.md)**  
...
-   **[Edit personal details](../task/edit-personal-details.md)**  
Review your personal details and edit them if necessary.

**Parent Topic:**[Alumni Center](alumni-service-center.md#)
