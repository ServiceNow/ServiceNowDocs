...
8.  To add an indoor map building, select the Additional Actions icon \(\[Omitted image "additionalactions-icon.png"\] Alt text: Additional Actions to switch to the Workplace view.\) to select **View** &gt; **Workplace Indoor Mapping Building**.
