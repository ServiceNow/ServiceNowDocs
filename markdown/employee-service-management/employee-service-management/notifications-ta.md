...
Follow up with your applicants with the Virtual Agent Microsoft Teams chat. For more information, see [Configure Virtual Agent notifications in Microsoft Teams](../task/config-va-ta.md).

-   **[Virtual Agent notifications](va-notification-ta.md)**  
