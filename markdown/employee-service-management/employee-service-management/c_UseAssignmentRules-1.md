...
Refer to [Create rules to route and assign customer service cases](https://www.servicenow.com/docs/access?context=c_CaseRouting&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US) for more information on matching and assignment rules.
