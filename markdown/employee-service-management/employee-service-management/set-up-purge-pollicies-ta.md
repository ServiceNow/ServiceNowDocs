...
2.  Select one or more of the following tables to modify the default auto flush settings one at a time.
    ...
    For a description of the auto flush form field values, see [Autoflush form](https://www.servicenow.com/docs/access?context=atf-auto-flush&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
