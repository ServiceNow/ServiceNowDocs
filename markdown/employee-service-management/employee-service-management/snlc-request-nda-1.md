---
title: Non-disclosure agreement legal requests
...
# Non-disclosure agreement legal requests
...
-   **[Synchronize a non-disclosure agreement document after modifying a self-served contract request \(Contract Management Pro 1.2.1\)](../task/snlc-sync-doc.md)**  
...
-   **[Regenerate contract document after modifying request](../task/snlcregen-contract-doc.md)**  
...
-   **[Updating and synchronizing signatories](../task/snlc-update-sync-signatories.md)**  
...
-   **[Reviewing and finalizing a self-serve contract document](../task/snlc-review-finalize-contract.md)**  
...
-   **[Initiate an ad hoc approval for a contract document revision](../task/snlc-initiate-approval-cr.md)**  
Initiate an ad hoc approval for a contract document revision from a user or a user group.
-   **[Send a non-disclosure agreement document for signature](../task/snlc-send-doc-sign-nda.md)**  
...
[Signature workflow for a legal request](snlc-lsd-signature-workflow.md)
