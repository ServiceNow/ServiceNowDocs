...
3.  Select **Submit**.
    ...
    You can download the import set template too. For more information, see [Download an import template](https://www.servicenow.com/docs/access?context=t_DownloadAnImportTemplate&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
