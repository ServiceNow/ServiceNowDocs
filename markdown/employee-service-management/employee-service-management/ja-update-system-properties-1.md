...
Complete all the steps required for setting up [Microsoft Exchange Online Spoke v2.0.2](https://www.servicenow.com/docs/access?context=ms-exch-online-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) Microsoft Exchange Online before updating the system properties for the Journey Accelerator app.
...
**Parent Topic:**[Microsoft Exchange Online setup for Journey Accelerator](../concept/ja-ms-exchange-online-setup-1.md)
