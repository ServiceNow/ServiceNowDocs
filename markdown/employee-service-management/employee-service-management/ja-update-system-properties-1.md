...
Complete all the steps required for setting up [Microsoft Exchange Online Spoke v2.0.2](https://www.servicenow.com/docs/access?context=ms-exch-online-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) Microsoft Exchange Online before updating the system properties for the Journey Accelerator app.
