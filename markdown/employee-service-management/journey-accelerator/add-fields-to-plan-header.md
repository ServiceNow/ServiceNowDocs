...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/journey-accelerator/add-fields-to-plan-header.html
release: xanadu
...
breadcrumb: [Customize and manage Journey Accelerator plan headers, Creating and managing audience-specific Journey Accelerator templates, Install and configure Journey Accelerator, Journey Accelerator, HR Service Delivery, Employee Service Management]
---
...
8.  Click **Update** again.
    ...
    Configure unique plan headers for different plan types. For more information, see [Create and manage Journey Accelerator plan types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/journey-accelerator/create-manage-ja-plans.md).
