...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/journey-accelerator/add-fields-to-plan-header.html
release: yokohama
...
breadcrumb: [Customize and manage Journey Accelerator plan headers, Creating and managing audience-specific Journey Accelerator templates, Install and configure Journey Accelerator, Journey Accelerator, Employee Journey Management, HR Service Delivery, Employee Service Management]
---
...
8.  Click **Update** again.
    ...
    Configure unique plan headers for different plan types. For more information, see [Create and manage Journey Accelerator plan types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/journey-accelerator/create-manage-ja-plans.md).
