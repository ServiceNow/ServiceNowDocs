...
For more information on table administration and how to manage data, see [Table administration](https://www.servicenow.com/docs/access?context=c_TableAdministration&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
