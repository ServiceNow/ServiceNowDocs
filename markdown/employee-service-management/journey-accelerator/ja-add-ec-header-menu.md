...
3.  -   [Add a Journey Accelerator action plan to My active items](../task/add-ja-action-plan-myitems-list.md)
-   [Add a Journey Accelerator action plan to the menu in the Employee Center](../task/add-ja-action-plan-menu-ec-header.md)
