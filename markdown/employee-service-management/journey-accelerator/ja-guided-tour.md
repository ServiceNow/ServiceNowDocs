...
-   [Guided tours](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/guided-tours.md): This overview covers many of the features administrators use to create and modify tours.
-   [Guided Tour Designer interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/guided-tour-designer-interface.md): Learn about the Guided Tour Designer features and interface.
-   [Edit a guided tour](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/edit-guided-tour.md): This task provides details about how to modify guided tours.
