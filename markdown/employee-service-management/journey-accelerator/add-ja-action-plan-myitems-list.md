...
# Add a Journey Accelerator action plan to My active items

Add a menu item for Journey Accelerator action plans to My active items in the Employee Center.
