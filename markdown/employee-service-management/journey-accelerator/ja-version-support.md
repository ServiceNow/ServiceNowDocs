...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/journey-accelerator/ja-version-support.html
release: xanadu
...
breadcrumb: [Exploring Journey Accelerator, Journey Accelerator, HR Service Delivery, Employee Service Management]
---
...
**Note:** Journey Accelerator Version 4.0.2 is the last family release that a standalone version of the app can be installed. The latest Journey Accelerator functionality is included with the [Journey designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown) application.
