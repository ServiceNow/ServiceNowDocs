...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/issue-auto-resolution-for-hr/using-iar-for-hr.html
release: australia
...
5.  A new structured case is created. The original case is closed automatically.
    ...
    **Note:** If the employee isn’t satisfied with the resolution, the employee can choose to connect with an agent for further assistance.
