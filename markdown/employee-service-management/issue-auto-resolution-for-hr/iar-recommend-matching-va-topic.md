...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/issue-auto-resolution-for-hr/iar-recommend-matching-va-topic.html
release: yokohama
...
\[Omitted image "iar-new-va-flow.png"\] Alt text: New Virtual Agent topic introduced in IAR flow.
...
\[Omitted image "iar-new-email-preview.png"\] Alt text:
