...
To learn more about time-limited authentication, see [Time limited authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/time-based-authentication-with-mfa.md).
