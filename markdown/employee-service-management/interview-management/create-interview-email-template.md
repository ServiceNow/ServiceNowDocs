...
1.  Navigate to **All** &gt; **sys\_template.LIST** to create the template.
    ...
    For more information on creating a template, see [Create a template using the Template form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/ai-platform-administration/t_CreateATemplateUsingTheTmplForm.md).
