...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/external-legal-portal/lsd-ext-portal-config-intake-form.html
release: yokohama
...
7.  Configure ACLs for tables referenced from the record producers to make is available in the catalog.
    ...
    For more information, see [Configure an ACL rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/access-control/t_CreateAnACLRule.md).
