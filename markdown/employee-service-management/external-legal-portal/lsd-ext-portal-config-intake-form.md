...
7.  Configure ACLs for tables referenced from the record producers to make is available in the catalog.
    ...
    For more information, see [Configure an ACL rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/t_CreateAnACLRule.md).
