...
External users can reset their password on forgetting it. For more information on the password reset process configuration, see [Configuring Password Reset](https://www.servicenow.com/docs/access?context=password-reset-admin-guide&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
