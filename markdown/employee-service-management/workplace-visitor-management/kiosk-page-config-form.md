...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-visitor-management/kiosk-page-config-form.html
release: zurich
...
Type of page that you want to create for the kiosk flow. For more information, see [Kiosk Check-in Flow Configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-visitor-management/kiosk-check-in-config-form.md).
