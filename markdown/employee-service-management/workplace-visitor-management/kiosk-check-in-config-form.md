...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-visitor-management/kiosk-check-in-config-form.html
release: yokohama
...
|Acknowledgment page configuration|Page configuration that contains the check-in policies for the visitor to acknowledge. For more information about policies, see [Create a visitor policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-visitor-management/create-visitor-policy.md).|
