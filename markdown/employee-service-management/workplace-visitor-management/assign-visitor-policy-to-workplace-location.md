...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-visitor-management/assign-visitor-policy-to-workplace-location.html
release: yokohama
...
breadcrumb: [Create a visitor policy, Configure, Workplace Visitor Management, Workplace Service Delivery, Employee Service Management]
---
...
6.  In the Locations related list, apply the policy to internal or external visitors and configure whether the policies require signatures.

    1.  Select the preview icon \(\[Omitted image "preview-icon.png"\] Alt text: Preview icon.\) for the record that you want to edit.

    2.  On the preview window for the location policy, select **Open Record**.

    3.  On the Location Policy form, fill in the fields.

        For a description of the field values, see [Location Policy form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-visitor-management/location-policy-form.md).
...
**Parent Topic:**[Create a visitor policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-visitor-management/create-visitor-policy.md)
