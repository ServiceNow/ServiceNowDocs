...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/alumni-center/asc-staged-users.html
release: zurich
...
12. Select **Import All**.
    ...
    For more information about the default state for staged alumni, see [Properties for Alumni Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/alumni-center/asc-properties.md).
