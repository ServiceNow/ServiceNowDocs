...
4.  Configure the media section.
    ...
    -   Function instance
        ...
        **Note:** You can personalize the label and configure the associated function. To learn more about how to configure functions, see [Functions in ServiceNow mobile](https://www.servicenow.com/docs/access?context=sg-studio-mobile-button-types&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US).
