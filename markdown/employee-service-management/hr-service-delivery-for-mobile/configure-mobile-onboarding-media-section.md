...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery-for-mobile/configure-mobile-onboarding-media-section.html
release: xanadu
...
4.  Configure the media section.
    ...
    -   Function instance
        ...
        **Note:** You can personalize the label and configure the associated function. To learn more about how to configure functions, see [Functions in ServiceNow mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/mobile/mobile-platform/sg-studio-mobile-button-types.md).
