...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery-for-mobile/configure-journeys-now-mobile.html
release: xanadu
...
Assign the Journey to the employee and publish the Journey. See [Create a journey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/journey-designer/jny-dsgnr-create-journey.md)

For more information on Journeys, see [Journey designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown).
...
3.  Upload an image to appear at the top of the Journey when viewed on Now Mobile.
    ...
    For an example of how a Journey looks on Now Mobile, see [Journeys on Now Mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery-for-mobile/journeys-mobile-now.md).
