---
title: Enable Agent Chat in Now Mobile
description: Activate the Chat quick action so that your new hires can chat with a live or virtual agent.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery-for-mobile/enable-agent-chat-in-mobile-onboarding-app.html
release: yokohama
...
# Enable Agent Chat in Now Mobile
...
-   [Employee live chat overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/employee-center-chat-configuration.md)
...
3.  In the Body related list, under the Quick Actions Menu Maps section, open the **Chat** record.
    ...
    \[Omitted image "mobile-onboarding-chat-record.png"\] Alt text: Open the Chat record.
