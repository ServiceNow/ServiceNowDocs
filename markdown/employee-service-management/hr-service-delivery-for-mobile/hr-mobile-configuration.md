...
-   Search
    -   People search
        -   Note: Customers that do not use the Employee Center \(EC\), the base system people search configuration is used. For more information, see [Mobile search](https://www.servicenow.com/docs/access?context=sg-mobile-search&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US).
