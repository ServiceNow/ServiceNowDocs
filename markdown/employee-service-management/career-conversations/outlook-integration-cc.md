...
-   **[Create a connection with Microsoft Exchange Online](../task/set-up-ms-exhchange-cc.md)**  
...
-   **[Configure Microsoft Azure](../task/ms-outlook-azure-cc.md)**  
Set up a authentication with Microsoft Azure to connect Microsoft Exchange Online.
-   **[Configure the webhook registry of Microsoft Exchange Online spoke in Career Conversations](../task/webhook-registry-cc.md)**  
