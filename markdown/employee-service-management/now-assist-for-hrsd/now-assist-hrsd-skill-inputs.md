...
</table>## Email reply recommendation
...
The following table lists the triggers that determine when an email reply recommendation is generated.
...
[RCA approvals for Now Assist for HR Service Delivery \(HRSD\)](../task/run-rca-now-assist-hrsd.md)

[Restrict Now Assist capabilities for employee relations cases](../task/restrict-now-assist-skills-er-cases.md)

[Configure Gen AI Virtual Agent for HRSD](../task/use-genai-ec.md)

[Configure the Now Assist for HRSD Virtual Agent topics](../task/config-va-topics.md)

[Configure HCM AI agents from the HR Service Delivery AI Agent Collection](../task/configure-hcm-agents.md)

[Configure sensitivity detection in Now Assist for HR Service Delivery \(HRSD\)](../task/config-na-sd-filters.md)
