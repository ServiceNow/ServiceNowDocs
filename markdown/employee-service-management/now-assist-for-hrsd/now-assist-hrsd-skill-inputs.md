...
[Configure resolution notes generation for Now Assist for HRSD](../task/resolution-notes-nacm-config.md)

[Configure sensitivity detection](../task/config-na-sd-filters.md)
...
[Configure HCM agents for HR Service Delivery AI Agent Collection](../task/configure-hcm-agents.md)

[Configure Now Assist AI Helper – Galileo Inside](../task/configuring-galileo-inside.md)
