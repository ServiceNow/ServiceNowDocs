...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/now-assist-for-hrsd/now-assist-panel-hr.html
release: zurich
...
Generate chat and case summaries and resolution notes by using the ServiceNow Otto panel in Agent Workspace for HR Case Management or Core UI.
...
2.  Select the ServiceNow Otto icon \[Omitted image "icon-ai-sparkle.png"\] Alt text: ServiceNow Otto icon..
