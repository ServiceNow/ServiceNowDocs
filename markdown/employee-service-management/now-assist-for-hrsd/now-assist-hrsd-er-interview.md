...
You can use the ER interview summarization skill in either Core UI or Agent Workspace for HR Case Management.
...
3.  Open the **Interview** related list.

4.  Select **Summarize**.

5.  **Note:** Generating and displaying the summary may take several seconds.

6.  Review the summary details.

    A summary of the interview record is displayed with a quick recap, key assertions, and responses.

    \[Omitted image "int-summarize-aws.png"\] Alt text: ER interview summary in HR Agent Workspace \[Omitted image "int-summarize-aws-output.png"\] Alt text: ER interview summary in HR Agent Workspace

    \[Omitted image "int-summarize-coreui.png"\] Alt text: ER interview summary in Core UI \[Omitted image "int-summarize-coreui-output.png"\] Alt text: ER interview summary in Core UI
...
<table id="choicetable_md1_nyf_xyb"><thead><tr><th align="left" id="d640807e223">

Option

</th><th align="left" id="d640807e226">

Procedure

</th></tr></thead><tbody><tr><td id="d640807e232">
...
1.  Select **Share**.
2.  In the Share to AI Interview summary dialog box, edit the summary.
3.  Select **Save to AI Interview Summary**.


</td></tr><tr><td id="d640807e259">
