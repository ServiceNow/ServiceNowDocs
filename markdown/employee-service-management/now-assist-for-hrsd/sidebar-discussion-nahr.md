...
**Note:** The Sidebar discussion summarization skill can be found in the **HRSD** tab under the **Employee** group in Now Assist Admin. For more information, see [Sidebar discussion summarization](https://www.servicenow.com/docs/access?context=now-assist-sidebar-discussion-summarization&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).
...
3.  Generate a summary of the Sidebar discussion during the conversation either by using the Summarize quick action \(enter `/Summarize` in the Active sidebar discussion window\), or by selecting the quick action icon ![image.now-assist-sidebar-lightning-bolt-icon].

4.  After summarizing the Sidebar discussion, you can add it to the case work notes, and provide feedback about it.

<table id="choicetable_vzl_myv_bcc"><thead><tr><th align="left" id="d512118e191">

Option

</th><th align="left" id="d512118e194">

Procedure

</th></tr></thead><tbody><tr><td id="d512118e200">
