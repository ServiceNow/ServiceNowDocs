...
Use the Now LLM Service or any of the following supported third-party small or large language model with any Now Assist for HR Service Delivery \(HRSD\) skill or AI agent:
