...
3.  In the Sentiment field, select the information icon ![icon for seeing information about sentiment when you click](../image/icon-more-info.png) to see the reasons for the sentiment.
...
2.  Go to **Cases** &gt; **Open**
3.  Select a case.
4.  Select the information icon ![The information icon provides an explanation for why a particular sentiment has been assigned](../image/icon-more-info.png) to see the reasons for the sentiment.
...
4.  Manually refresh a sentiment.
    ...
    2.  In the Agent Workspace for HR Case Management interface, a red dot appears on the information icon ![The information icon provides an explanation for why a particular sentiment has been assigned](../image/icon-more-info.png) next to the sentiment.

    3.  Select the information icon ![The information icon provides an explanation for why a particular sentiment has been assigned](../image/icon-more-info.png) and then select the refresh icon to see the updated sentiment and sentiment trend.
