...
6.  Duplicate available HCM AI agents to run them autonomously.
    ...
    For more information, see Duplicate an AI agent For list of available agents, see [Using agentic workflows in Now Assist for HRSD](../concept/now-assist-hrsd-ai-agents-use-cases.md).
