...
6.  Duplicate available HCM AI agents to run them autonomously.
    ...
    For more information, see [Duplicate an AI agent](https://www.servicenow.com/docs/access?context=clone-ai-agent&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US) For list of available agents, see [Using agentic workflows in Now Assist for HRSD](../concept/now-assist-hrsd-ai-agents-use-cases.md).
