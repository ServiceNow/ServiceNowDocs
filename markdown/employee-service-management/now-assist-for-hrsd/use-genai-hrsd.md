...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/now-assist-for-hrsd/use-genai-hrsd.html
release: yokohama
...
3.  Enter your query and select the required catalog item.
    ...
    \[Omitted image "catalog-item-request.png"\] Alt text: Dental request Gen AI assistance \[Omitted image ""\] Alt text:
