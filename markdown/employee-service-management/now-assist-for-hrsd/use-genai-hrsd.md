...
3.  Enter your query and select the required catalog item.
    ...
    ![Dental request Gen AI assistance](../image/catalog-item-request.png "Example: Gen AI Virtual Agent assistance in placing a Dental inquiry request") ![]( "Example: Gen AI Virtual Agent assistance in placing a Dental inquiry request")
