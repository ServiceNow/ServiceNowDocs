...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/now-assist-for-hrsd/use-ai-agents-to-create-job-req.html
release: australia
...
-   The job requisition creation using AI agent is only supported from the Virtual Agent chat window and not from the ServiceNow Otto panel.
