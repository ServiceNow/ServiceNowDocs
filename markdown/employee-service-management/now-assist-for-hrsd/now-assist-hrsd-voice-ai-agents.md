...
To enable employee access and use of Voice AI agents, an admin must install the HR Voice AI Agents \[sn\_hr\_voice\_aia\] plugin and [Configure HR Voice AI agents](../task/configure-voice-agents.md).
...
[Deploy AI voice agents](https://www.servicenow.com/docs/access?context=deploy-ai-agents-for-voice&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)
