...
![CAD Configuration page showing the Map configuration and CAD Editor tabs.](../images/wsd-cad-config-home-page.png)
...
-   **[Map Configuration tab](map-configuration-v2.md)**  
