...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/indoor-mapping/configure-map-data.html
release: australia
...
2.  Select any of the following map objects to configure and customize the default parameters:
    ...
    -   Indoor Mapping properties: For more information about how to set the configuration properties, see [Indoor Mapping properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/indoor-mapping/indoor-mapping-properties.md).
...
**Previous topic:**[Install Indoor Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/indoor-mapping/install-indoor-mapping.md)

**Next topic:**[Configure role-based access in Indoor Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/indoor-mapping/map-limited-editor.md)
