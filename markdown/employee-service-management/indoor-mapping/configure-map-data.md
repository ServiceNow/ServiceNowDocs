...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/indoor-mapping/configure-map-data.html
release: xanadu
...
2.  Select any of the following map objects to configure and customize the default parameters:
    ...
    -   Indoor Mapping properties: For more information about how to set the configuration properties, see [Indoor Mapping properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/indoor-mapping/indoor-mapping-properties.md).
...
**Previous topic:**[Install Indoor Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/indoor-mapping/install-indoor-mapping.md)

**Next topic:**[Configure role-based access in Indoor Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/indoor-mapping/map-limited-editor.md)
