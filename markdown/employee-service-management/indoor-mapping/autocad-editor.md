...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/indoor-mapping/autocad-editor.html
release: yokohama
...
Configure and manage layers, places, text, and block attributes. For more information, see [Configure CAD objects using the Map Configuration tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/indoor-mapping/manage-cad-map-config.md).
