...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/indoor-mapping/CAD-file-import.html
release: yokohama
...
2.  Create a Campus, add few buildings and floors to a campus or select an existing campus.
    ...
    For more information, see [Create a campus with buildings and floors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/indoor-mapping/create-a-campus-building-and-floor.md)
...
**Parent Topic:**[Autocad tool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/indoor-mapping/autocad-processor-v1.md)

**Previous topic:**[Autocad tool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/indoor-mapping/autocad-processor-v1.md)

**Next topic:**[Indoor Mapping references](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/indoor-mapping/indoor-mapping-references.md)
