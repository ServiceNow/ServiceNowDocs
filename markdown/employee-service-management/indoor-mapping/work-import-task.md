...
-   Configuration: This step is required to select the layers and place types for floor plan.
...
3.  If the import task is at the `Source retrieval` step, select a source for the import task.
    ...
    If the file name is the same as the source, the system automatically selects the source and moves to the next step.
