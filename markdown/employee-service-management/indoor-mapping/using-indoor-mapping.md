...
1.  [Create a campus with buildings and floors](../task/create-a-campus-building-and-floor.md)  
...
2.  [Working with boundary editor](../task/working-with-boundary-editor.md)  
...
3.  [Import outdoor elements](../task/import-outdoor-elements.md)  
...
6.  [Edit with view editor](../task/edit-with-view-editor.md)  
...
7.  [Map preview](../task/map-preview-indoor-mapping.md)  
...
8.  [Print a map](../task/print-map.md)  
Print a map by configuring relevant options and applying filters.
9.  [Create Snapshots to migrate Indoor Mapping data](../task/snapshot-ind-mapping.md)  
...
10. [Keyboard shortcuts](../task/keyboard-shortcuts.md)  
...
11. [Synchronize Indoor Mapping with Workplace Service Delivery](../task/synchronize-ind-mapping-wsd.md)  
...
12. [Synchronize Indoor Mapping with CMN Locations](sync-cmn-location.md)  
Create a new CMN Location or synchronize an existing CMN Location with a corresponding Indoor Mapping Place type.
13. [Using enhanced synchronization](using-enhanced-sync.md)  
