...
5.  Select to open a place.
    ...
    The Places panel opens in the edit mode. Notice that the **Autocad properties** field is available. For more information, see [Manage places](manage-buildings.md).
