...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/indoor-mapping/manage-sync-operations.html
release: xanadu
...
2.  Filter the list to include the records that you want to process.
    ...
    Only the records that are included in the filter are processed. For more information about filtering lists, see [Create a filter in List](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/t_CreatingFilters.md).
...
**Parent Topic:**[Using enhanced synchronization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/indoor-mapping/using-enhanced-sync.md)
