...
2.  Filter the list to include the records that you want to process.
    ...
    Only the records that are included in the filter are processed. For more information about filtering lists, see [Create a filter in List](https://www.servicenow.com/docs/access?context=t_CreatingFilters&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
