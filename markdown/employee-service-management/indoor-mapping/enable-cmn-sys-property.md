...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/indoor-mapping/enable-cmn-sys-property.html
release: yokohama
...
**Previous topic:**[Synchronize Indoor Mapping with CMN Locations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/indoor-mapping/sync-cmn-location.md)

**Next topic:**[Add CMN locations and map it to Indoor Mapping Place types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/indoor-mapping/enable-cmn-location-types.md)
