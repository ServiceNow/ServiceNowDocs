...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/enable-link-unfurling.html
release: xanadu
...
-   **[Enable link unfurling](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/unfurl-links.md)**  
Enable link unfurling in the manifest file to preview the content of the link shared in the chat conversations.
-   **[Configure the system property to open the unfurled links](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/configure-links-chat-conversations.md)**  
