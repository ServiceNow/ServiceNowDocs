...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety-risk-management/hs-define-action-schedule-affected-people.html
release: yokohama
...
# Define an action schedule for affected people
...
The scheduler only runs when there are active exposures so that the actions are assigned to the actively exposed people.
...
4.  In the **Action schedule** tab, select **New**.

5.  On the form, fill in the fields.

    For information on field descriptions, see [Action schedule form for an exposure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety-risk-management/hs-action-schedule-form.md).
...
**Parent Topic:**[Perform an exposure assessment for a location](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety-risk-management/hs-perform-exposure-assessment.md)
