...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety-risk-management/hs-define-controls.html
release: yokohama
...
-   Risk assessment manager can also create a control measure during the hazard assessment for a risk assessment. If a control is not available in the **Available Control Measures** field, they can select **Create new control** to define and use a new control.
    ...
    For more information, see [Assess safety hazards and risk levels for a risk analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety-risk-management/add-a-risk-and-its-controls-for-a-safety-risk-assessment.md).
