...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/health-and-safety-risk-management/hs-safety-inspections.html
release: xanadu
...
-   Maintain standards and documents list enabling standards or regulatory documents to be used as a reference for audit findings.

-   **[Set up a safety inspection schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-risk-management/hs-schedule-recurring-safety-inspection.md)**  
...
-   **[Create and manage a safety inspection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-risk-management/hs-create-manage-safety-inspection.md)**  
Create a safety inspection to manage your workplace inspection of a particular activity, process, or an area. Review the survey results and add findings, root cause analyses \(RCA\), and actions for the inspection.
-   **[Set up a safety audit schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-risk-management/hs-setup-safety-audit-schedule.md)**  
Create an audit schedule and define the top-level audit details and the recurrence, for example, monthly or bi-monthly.
-   **[Create and manage a safety audit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-risk-management/hs-create-manage-safety-audit-workspace.md)**  
...
-   **[Complete a safety inspection or audit survey through Employee Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-risk-management/hs-complete-safety-insp-survey.md)**  
Complete a safety inspection or audit survey assigned to you through the Employee Center.
-   **[Add a finding and root cause analysis for a safety inspection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-risk-management/hs-add-finding-rca-safety-inspection.md)**  
Record a finding based on the survey results for a safety inspection and perform a root cause analysis \(RCA\) for it.
-   **[Add a finding and root cause analysis for a safety audit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-risk-management/hs-add-finding-rca-safety-audit.md)**  
Record a finding based on the audit results and perform a root cause analysis \(RCA\) for it.
-   **[Add an action for a safety inspection or audit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-risk-management/hs-add-action-safety-inspection.md)**  
...
-   **[Add an action from survey response in safety inspection through Employee center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-risk-management/add-action-from-survey-response-in-safety-inspection.md)**  
...
-   **[Assign safety inspection to agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-risk-management/hs-assign-safety-inspection-to-agents.md)**  
