...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety-risk-management/hs-define-job-register.html
release: yokohama
...
<table id="choicetable_l1q_grs_dcc"><thead><tr><th align="left" id="d717552e115">

Option

</th><th align="left" id="d717552e118">

Steps

</th></tr></thead><tbody><tr><td id="d717552e124">
...
<table id="choicetable_k4d_sw3_dcc"><thead><tr><th align="left" id="d717552e330">

Job type

</th><th align="left" id="d717552e333">

Steps

</th></tr></thead><tbody><tr><td id="d717552e339">
...
-   The job is available for selection on these forms:
    -   JSA form when submitting a JSA. For more information, see [Submit JSA form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety-risk-management/hs-submit-jsa-form.md).
