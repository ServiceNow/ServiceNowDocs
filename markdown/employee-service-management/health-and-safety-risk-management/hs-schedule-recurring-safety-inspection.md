...
6.  Select **Save**.
    ...
    The **Scheduled inspection** related item and the **Create inspections** button appear for this record.

7.  In **Scheduled inspection** related item of the record, open a scheduled inspection and add **Findings and RCA** and **Inspection actions** as required.

8.  Use the **Create inspection** button to create an inspection record.

    In the modal,

    -   Select **Create next scheduled inspection** to create the first upcoming inspection.
    -   Select **Create all scheduled inspection at once** to create all scheduled inspections immediately.

## Result

-   Based on the duration and the selected frequency of the inspection schedule, inspection records are created one by one on the start date.
