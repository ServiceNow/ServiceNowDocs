...
11. Create a flow for the checklist type.
    ...
    3.  Select **Duplicate action** for the existing **Create permit checklist record** action.
        ...
        The flows are built using ServiceNow Workflow Studio, so make sure you’re familiar with the [Flow Designer](https://www.servicenow.com/docs/access?context=flow-designer-home-landing-page&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US) basics.
