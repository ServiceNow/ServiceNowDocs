...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety-risk-management/hs-create-manage-safety-audit-workspace.html
release: yokohama
...
You can also set up an audit schedule to generate safety audits. For more information, see [Set up a safety audit schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety-risk-management/hs-setup-safety-audit-schedule.md).
...
5.  On the form, fill in the fields.
    ...
    For information on audit field descriptions, see [Audit schedule form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety-risk-management/hs-audit-schedule-form.md).
...
10. Review the survey responses and gather evidence as part of the audit, for example, document assessments, interviews, and observations.
    ...
    3.  In the **Risk assessments** tab, select **New** to conduct a risk assessment as part of this audit.
        ...
        -   For more information, see [Conduct a safety risk assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety-risk-management/hs-conduct-risk-assessment.md).
    ...
    5.  In the **Audit actions** tab, select **New** to create and assign any actions based on findings and recommendations.
        ...
        For more information, see [Add an action for a safety inspection or audit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety-risk-management/hs-add-action-safety-inspection.md).
