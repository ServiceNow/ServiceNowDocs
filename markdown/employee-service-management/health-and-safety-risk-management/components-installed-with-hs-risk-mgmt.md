...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety-risk-management/components-installed-with-hs-risk-mgmt.html
release: yokohama
...
Enables creating smart assessments for safety inspection or audits. For more information, see [Smart Assessment Engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/governance-risk-compliance/smart-assessment-engine/smart-asmnt-engine-landing-page.md).
...
Stores all audit surveys for safety audits. This table extends the Health and Safety task \[sn\_ohs\_im\_task\] table.
