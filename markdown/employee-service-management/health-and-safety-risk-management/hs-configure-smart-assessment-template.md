...
-   Verify that the application scope is selected as Health and Safety Risk Management. For more information, see [Application picker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/c_ApplicationPicker.md).
...
3.  In the **Purpose** field on the **Smart assessment template** form, select **Health and Safety**.
    ...
    You can also configure a category role for a specific purpose. For more information, see [Create an assessment template category](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/governance-risk-compliance/sae-asmnt-template-category-create.md).
