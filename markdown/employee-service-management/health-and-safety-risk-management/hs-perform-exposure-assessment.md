...
8.  In the **Documents** tab, select **Add** to add any documents related to this assessment.
    ...
    For information on storing documents in the Health and Safety Workspace, see [Add a Health and Safety related document](../../ohs-incident-management/task/add-hs-related-document.md).
