...
# Import hazards and controls from a job
...
4.  Open the risk assessment to import the hazards and controls.

5.  Select **Import hazards and controls**.

6.  In the **Select jobs to import hazards and controls from** field, select the job.

7.  Select **Import**.

    All hazards and controls from the selected job are imported.
