...
For information on adding an audit questionnaire to an audit or audit schedule, see [Set up a safety audit schedule](../task/hs-setup-safety-audit-schedule.md).
