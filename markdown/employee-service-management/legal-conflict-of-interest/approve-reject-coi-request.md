...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-conflict-of-interest/approve-reject-coi-request.html
release: xanadu
...
For more information on approval flow, see [Conflict of Interest – Approval flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-conflict-of-interest/conflict-of-interest-overview.md).
...
6.  In the **Approvers** tab, click **Requested** in the **State** column to open the approval form.
...
</table>**Parent Topic:**[Managing conflict of interest disclosure requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-conflict-of-interest/managing-legal-coi-request.md)
