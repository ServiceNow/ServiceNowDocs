...
-   [Okta spoke v1.1.1](https://www.servicenow.com/docs/access?context=okta-v2-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
...
1.  Set up the Okta spoke v1.1.1.
    ...
    For instructions on how to set up the spoke, see [Set up Okta spoke v1.1.1](https://www.servicenow.com/docs/access?context=set-up-okta-v1.1.1&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).

2.  Fetch the Okta groups into your instance.

    For instructions on how to fetch the groups, see [Fetch Okta groups](https://www.servicenow.com/docs/access?context=fetch-okta-groups&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
