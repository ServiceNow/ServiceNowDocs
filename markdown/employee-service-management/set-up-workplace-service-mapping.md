...
breadcrumb: [Configure Workplace Space Mapping, Workplace Space Mapping, Workplace Service Delivery, Employee Service Management]
---
...
**Parent Topic:**[Configure Workplace Space Mapping](wsm-config_space_mapping.md)
