...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/configure-forensics-search-sources.html
release: xanadu
topic_type: task
...
[Add fulfillment instructions and checklist for a data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/add-fulfillments-steps-dft.md). When a matter owner creates a task for the source in a legal matter, these instructions are pre-populated in the task. The users to whom the legal matter task is assigned can follow these instructions to resolve the task.
