...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/emergency-outreach/response-scripts.html
release: xanadu
...
**Note:** The [Employee Readiness Surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/safe-workplace/employee-readiness-surveys.md) app must be installed to use response scripts.
