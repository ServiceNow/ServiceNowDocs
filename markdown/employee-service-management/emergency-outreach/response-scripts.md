...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/emergency-outreach/response-scripts.html
release: yokohama
...
**Note:** The [Employee Readiness Surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/safe-workplace/employee-readiness-surveys.md) app must be installed to use response scripts.
