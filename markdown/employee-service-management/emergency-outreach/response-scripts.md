...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/emergency-outreach/response-scripts.html
release: australia
...
**Note:** The [Employee Readiness Surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/safe-workplace/employee-readiness-surveys.md) app must be installed to use response scripts.
