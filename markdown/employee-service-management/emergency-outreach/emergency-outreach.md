...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/emergency-outreach/emergency-outreach.html
release: xanadu
...
-   [Employee Readiness Surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/safe-workplace/employee-readiness-surveys.md) provides an outreach notification with a link to a survey to assess user readiness to return to the workplace. Customize the notification and the survey to address your company’s concerns.
-   [Employee Health Screening](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/safe-workplace/employee-health-screening.md) uses outreach notifications to request that users submit their health status verification each day before they can return to the workplace.
-   [Contact Tracing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contact-tracing/contact-tracing.md) uses the following outreach notifications:
...
\[Omitted image "eo-home-page-graphic.png"\] Alt text: Emergency Outreach mobile application for a health check in.
...
-   **[Install Emergency Outreach](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/install-emergency-outreach.md)**  
You can install Emergency Outreach if you have the admin role.
-   **[Configure Emergency Outreach notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/configure-emergency-outreach.md)**  
...
-   **[Modify or add Employee Readiness Surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/modify-emp-readiness-survey.md)**  
...
-   **[Send notifications for an emergency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/send-eo-notification-outreach.md)**  
...
-   **[Review Emergency Outreach acknowledgements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/eo-review-outreach-acks.md)**  
...
-   **[Send notifications for daily health verification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/send-daily-health-verif-notif-outreach.md)**  
Use Emergency Outreach to notify users to report their daily health status.
-   **[Review daily health verification acknowledgements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/daily-health-verif-review-outreach-acks.md)**  
...
-   **[Send a readiness survey and view responses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/send-eo-outreach-survey.md)**  
...
-   **[Report your health status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/emp-check-in-emergency-outreach.md)**  
...
-   **[Response scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/response-scripts.md)**  
...
-   **[Domain separation for Emergency Outreach](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/emergency-outreach-domain-separation.md)**  
...
**Parent Topic:**[Emergency Response Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-service-delivery/emergency-response-management.md)
