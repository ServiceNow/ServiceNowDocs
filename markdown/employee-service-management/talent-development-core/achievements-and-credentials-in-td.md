...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/talent-development-core/achievements-and-credentials-in-td.html
release: xanadu
...
-   If the skill is new, it’s added to the queue pipeline for harmonization. For more information, see [Dynamic skill import for harmonization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/talent-development-core/dynamic-skill-import.md).
...
-   **[View credentials in Achievements and Credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/talent-development-core/view-achievement-credentials.md)**  
View all type of user credentials in Achievements and Credentials.
-   **[View achievement credential templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/talent-development-core/view-ach-credential-templates.md)**  
