...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/talent-development-core/dynamic-skill-import.html
release: xanadu
...
8.  Select **Next**.
    ...
    Follow the next steps to complete the import. For more information, see [Bring in skills through Skills import](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/talent-development-core/import-and-validate-custom-skills-onboarding.md).


## Result

The harmonized new skills are added to the skills library \(cmn\_skills table\) and updated in the credentials badge skills metadata. For more information, see [Achievements and Credentials in Talent Development Core](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/talent-development-core/achievements-and-credentials-in-td.md).
