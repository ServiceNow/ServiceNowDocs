...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/talent-development-core/skills-intelligence-workspace.html
release: yokohama
...
You can update and maintain skills and job architecture data from a single place using the Skills Workspace.

## Workspace users

Access to the Skills Workspace requires the sn\_skills\_int\_ws.workspace\_user role or any role that contains it. For more information on roles in Skills Foundation, see [Components installed with Skills Foundation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown).

## Home page

Access the following information on the Skills Foundation Home page to manage skills-related tasks:

-   Skills data overview.
-   Critical information gaps that require your immediate attention such as role groups without a role level, skills without a skill level type, or role groups without skills.
