...
Access to the Skills Workspace requires the sn\_skills\_int\_ws.workspace\_user role or any role that contains it. For more information on roles in Skills Foundation, see [Components installed with Skills Foundation](../reference/skills-intelligence-users-and-roles.md).

## Home page

Access the following information on the Skills Foundation Home page to manage skills-related tasks:

-   Skills Intelligence data overview.
