...
-   **[Create a course catalog in Workforce Optimization for HR](../task/create-course-catalog-wfo-hr.md)**  
...
-   **[Create a learning library in Workforce Optimization for HR](../task/create-learning-library-wfo-hr.md)**  
Create a learning library to organize related content into categories.
-   **[Create internal learning in Workforce Optimization for HR](../task/create-internal-learning-content-wfo-hr.md)**  
Add internal courses so that agents can learn new content and enhance their skill set.
-   **[Access external courses on Workforce Optimization for HR](../task/external-coruses-integration-wfo-hr.md)**  
...
-   **[Create a learning path in Workforce Optimization for HR](../task/create-learning-path-wfo-hr.md)**  
...
-   **[Assign a learning path to agents](../task/assign-learning-path-wfo-hr.md)**  
Assign a learning path to one or more agents and add a due date for them to complete the path.
-   **[Create a learning task](../task/create-learning-task-wfo-hr.md)**  
