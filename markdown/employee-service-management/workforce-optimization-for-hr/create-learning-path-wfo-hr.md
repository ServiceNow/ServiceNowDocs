...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workforce-optimization-for-hr/create-learning-path-wfo-hr.html
release: yokohama
...
breadcrumb: [Learning in Workforce Optimization for HR, Coaching in Workforce Optimization for HR, Using Workforce Optimization for HR, Workforce Optimization for HR Overview, HR Service Delivery, Employee Service Management]
---
...
6.  On the form, fill in the fields:
    ...
    |Field|Description|
    |-----|-----------|
    |Path name|Unique name for the learning path.|
    |Course catalog|Catalog to which you want to associate the learning path|
    |Objective|Objective of the learning path.|
    |Short description|Brief description of the learning path.|
    |Description|In-depth description of the learning path.|

7.  Click **Next**

    The learning path that is created is in **Draft** state. You can choose to complete it later.

8.  Add or remove course items.
...
10. Click **Submit** to publish the learning path.

    The learning path is published based on the Publish flow.


**Parent Topic:**[Learning in Workforce Optimization for HR](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workforce-optimization-for-hr/learning-wfo-hr.md)
