...
-   **[Configure an indicator to display in the Coaching Overview tab in Workforce Optimization for HR](../task/add-property-indicator-wfo-hr.md)**  
Add a system property to display the desired indicator in the Coaching Overview tab in the Coaching application.
-   **[Setting up skill prediction in Workforce Optimization for HR](../task/setup-skill-prediction-wfo-hr.md)**  
...
-   **[Configure a list menu to display in the Learning tab in Workforce Optimization for HR](../task/configure-list-menu-wfo-hr.md)**  
