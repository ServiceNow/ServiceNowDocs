...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/emergency-exposure-management/list-of-tracing-system-sys-properties.html
release: xanadu
...
For more information on setting up or modifying a tracing system, see [Set up a tracing system for an exposure data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-exposure-management/set-up-tracing-system.md).
