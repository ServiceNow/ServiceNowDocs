...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/sharepoint-reference.html
release: xanadu
...
For more information on crawl types, see [Microsoft SharePoint crawl types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/sp-crawl-types.md).
...
The default-scheduled job frequency is set to maximize the performance. For more information, see [SharePoint Online Search Connector scheduled jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/sharepoint-scheduled-jobs-full-crawl.md).
