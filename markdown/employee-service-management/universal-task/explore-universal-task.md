...
For more information on the types of task available, see [Universal Task types](universal-task-types.md).

-   **[Universal Task types](universal-task-types.md)**  
...
-   **[Universal Task data model](universal-task-data-model.md)**  
...
-   **[Universal Task in Now Mobile](ut-now-mobile.md)**  
...
**Parent Topic:**[Universal Task](universal-task-landing.md)
