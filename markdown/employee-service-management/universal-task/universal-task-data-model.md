...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/universal-task/universal-task-data-model.html
release: xanadu
...
For information on the tables and components that are installed with the Universal Task application, see [Components installed with Universal Task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/universal-task/installed-with-uni-task.md).
...
-   The task types that are available to the agents to task the requester with. For more details, see [Universal Task types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/universal-task/universal-task-types.md).
