...
6.  To build the questions for your employee form, use the survey designer.
    ...
    For more information on the question types, see [Survey designer elements](https://www.servicenow.com/docs/access?context=c_SurveyDesignerElements&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
