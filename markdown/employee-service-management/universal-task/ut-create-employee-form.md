...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/universal-task/ut-create-employee-form.html
release: yokohama
...
3.  On the form, fill in the fields.
    ...
    For more information on form fields and descriptions, see [Employee form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/universal-task/ut-emp-form.md).
...
6.  To build the questions for your employee form, use the survey designer.
    ...
    For more information on the question types, see [Survey designer elements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/ai-platform-capabilities/c_SurveyDesignerElements.md).
...
**Note:** You must have specific roles to view the employee responses. For more information, see [Configure the roles to view employee forms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/universal-task/ut-config-empform-view-roles.md)
