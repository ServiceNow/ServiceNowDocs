...
3.  To create an extension point script that defines the agent criteria for your service, click **Create Implementations** in the related link.
    ...
    To know more about extension points, see [Using extension points to extend application functionality](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/extension-points.md).
