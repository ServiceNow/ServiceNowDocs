...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/universal-task/config-stdtktpage-for-ut.html
release: yokohama
...
**Previous topic:**[Add a Universal Task related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/universal-task/create-relatedlist-ur.md)

**Next topic:**[Define the agent criteria for Universal Task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/universal-task/ut-config-extn-point-agent.md)
