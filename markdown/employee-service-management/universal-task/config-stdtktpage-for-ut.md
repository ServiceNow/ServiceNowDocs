...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/universal-task/config-stdtktpage-for-ut.html
release: xanadu
...
**Previous topic:**[Add a Universal Task related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/universal-task/create-relatedlist-ur.md)

**Next topic:**[Define the agent criteria for Universal Task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/universal-task/ut-config-extn-point-agent.md)
