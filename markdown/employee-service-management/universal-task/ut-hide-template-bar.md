...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/universal-task/ut-hide-template-bar.html
release: xanadu
...
**Previous topic:**[Display the universal tasks for a request in Now Mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/universal-task/ut-mobile-config-tasktab.md)

**Next topic:**[Remove the Universal Task admin role from the admin role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/universal-task/ut-remove-admin-role.md)
