...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/universal-task/ut-for-external-users.html
release: australia
...
-   The Explicit Role \(com.glide.explicit\_roles\) plugin must be installed to assign external and internal roles to the users.
