...
Configure the variables of practice areas that you want to be considered as inputs for legal request or matter summarization. To add variables, see [Configure variables for Now Assist summarization](../task/configure-variables-for-now-assist-summarization.md).
