...
-   **[Use the Now Assist for Legal Service Delivery \(LSD\) capabilities from the Now Assist panel](../task/now-assist-request-gen-ai-cap.md)**  
...
-   **[Generate search results using Q&amp;A Genius Results in Now Assist for Legal Service Delivery \(LSD\)](../task/now-assist-lsd-use-genius-result.md)**  
