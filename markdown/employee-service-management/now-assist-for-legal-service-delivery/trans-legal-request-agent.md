...
breadcrumb: [Agentic workflow, ServiceNow Otto for Legal Service Delivery \(LSD\), Legal Service Delivery, Legal and Contract Operations, Employee Service Management]
---
...
1.  Open the ServiceNow Otto panel by selecting the ServiceNow Otto icon \[Omitted image "image.cmpro-otto-icon"\] Alt text: ServiceNow Otto icon
...
**Parent Topic:**[Using agentic workflow in ServiceNow Otto for Legal Service Delivery \(LSD\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/now-assist-for-legal-service-delivery/agentic-ai-now-assist-lsd.md)
