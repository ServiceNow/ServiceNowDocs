...
2.  Confirm the Now Assist panel is turned on. For more information, see Activate the Now Assist panel standard chat.
3.  Confirm the **Now Assist Panel - Platform \(default\)** assistant in the CI Admin Experience is turned on. For more information, see Manage LLM virtual agents on the Assistants screen.
4.  Configure AI Search. For more information, see Configuring AI Search.
