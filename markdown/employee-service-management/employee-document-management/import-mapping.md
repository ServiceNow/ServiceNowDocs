...
You can also use scripts to map source elements to the required map elements for Employee Document Management. See [Scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/scripts/c_Script.md).
