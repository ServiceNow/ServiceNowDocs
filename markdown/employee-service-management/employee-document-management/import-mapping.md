...
You can also use scripts to map source elements to the required map elements for Employee Document Management. See [Scripts](https://www.servicenow.com/docs/access?context=c_Script&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
