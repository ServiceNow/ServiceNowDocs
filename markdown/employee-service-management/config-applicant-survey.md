...
1.  Create the applicant survey for the applicants.
    ...
    For more information, see [Survey designer](https://www.servicenow.com/docs/access?context=c_SurveyDesigner&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
