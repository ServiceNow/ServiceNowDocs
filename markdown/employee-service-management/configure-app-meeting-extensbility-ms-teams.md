...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/configure-app-meeting-extensbility-ms-teams.html
release: xanadu
topic_type: task
...
3.  Open the app created for Notify connector in Microsoft Teams in the section [Create an app in Microsoft Teams to enable making calls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/create-app-ms-teams.md).
