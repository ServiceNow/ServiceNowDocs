...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-agent-for-mobile/edit-or-view-a-child-task-agentmobile.html
release: yokohama
...
Refer to [Workplace Agent for mobile - Key features, actions, and case details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-agent-for-mobile/workplace-agent-mob-key-features-workstats-casedetailspage.md) for detailed information of all the actions available.
...
2.  On the **Work view** page, go to any one of the following sections to view the cases and tasks.

    -   My work overview
    -   My work
    -   Group work
    -   Unassigned work
3.  If you know the parent case of the task, select the case.

    The case details page opens separately.
...
6.  To edit the task details, do the following:

    1.  Select **Edit**.

    2.  On the Edit task form, change the fields that you want to edit.
...
8.  To perform other actions, select the \[Omitted image "wsdagentmob-actions.png"\] Alt text: More options icon. icon on the top-right of the header and do the following:

    1.  To update the checklist of the task, select **Update checklist**.

        On the Checklist page, select the checklist items that you want to add.

    2.  To update the current state of the task, select **Update state**.

        1.  On the Update state form, select the state to which you want to update the task.
        2.  Select **Submit**.
        The state is updated.

    3.  To add a comment, select **Add comment**.

        You can also add a comment directly from the details page using the **Comment** option.

        1.  Enter your work notes in the **Work notes** field.
        2.  To add additional comments, enter the comments in the **Additional comments \(Customer visible\)**.
        3.  Select **Post**.
