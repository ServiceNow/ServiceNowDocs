...
breadcrumb: [Explore Workplace Agent for mobile, Workplace Agent for mobile, Workplace Service Delivery, Employee Service Management]
---
...
There are different screens with case details depending on the type of workplace case that you open such as:
...
For example, if you open a regular workplace case, the details of the case are displayed in a separate **Workplace case details** screen.
