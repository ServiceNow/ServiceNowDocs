...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/now-mobile-employee-experience/advanced-text-search-config-now.html
release: yokohama
