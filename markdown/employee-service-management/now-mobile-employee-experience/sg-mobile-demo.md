...
-   **New Hire Contacts**
    ...
    For information on configuring functions like those used to make calls and send emails, see [Mobile functions](https://www.servicenow.com/docs/access?context=sg-studio-mobile-button-types&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US).
...
-   Now Mobile app
-   [Configuring the Mobile Platform](https://www.servicenow.com/docs/access?context=config-mobile-platform-landing&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US)
