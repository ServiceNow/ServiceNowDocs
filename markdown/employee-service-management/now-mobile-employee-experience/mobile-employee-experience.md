...
**Note:** For more information, see [Base system functionality for ServiceNow mobile](https://www.servicenow.com/docs/access?context=base-system-functionality&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US).
...
</table>-   **[Now Mobile app demo](../../tablet-mobile-ui/concept/sg-mobile-demo.md)**  
Access the demo in your Now Mobile app to learn how the app can help you work from anywhere using your mobile device.

**Parent Topic:**[Employee Service Management](../../../product/employee-service-management/concept/employee-service-management-overview.md)
