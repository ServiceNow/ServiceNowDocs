...
-   For more information on AI Search configuration, see [AI Search](https://www.servicenow.com/docs/access?context=overview-ais&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
-   For more information about Zing configuration, see [Global search for mobile](https://www.servicenow.com/docs/access?context=mobile-search-config&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US).
