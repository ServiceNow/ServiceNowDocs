...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/now-mobile-employee-experience/add-quick-action.html
release: xanadu
...
For more information about function types, see [Configure a smart button](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/mobile/mobile-platform/sg-studio-config-smart-button.md).
