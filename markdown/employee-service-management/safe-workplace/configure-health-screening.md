 ...
 **Note:** [Inbound mail configuration](https://www.servicenow.com/docs/access?context=r_InboundMailConfiguration&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US). If you need to perform filtering on inbound emails, see [Email filters](https://www.servicenow.com/docs/access?context=c_EmailFilters&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
