 ...
 **Note:** [Inbound mail configuration](https://www.servicenow.com/docs/access?context=r_InboundMailConfiguration&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US). If you need to perform filtering on inbound emails, see [Email filters](https://www.servicenow.com/docs/access?context=c_EmailFilters&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
