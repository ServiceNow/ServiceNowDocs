...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/safe-workplace/send-health-logs.html
release: xanadu
...
Generate reports on the data you imported to the Log \[sn\_imt\_core\_log\] table using [Reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/reporting/reporting-landing-page.md).
