...
1.  Send a POST request to the Table API on your instance.
    ...
    For more information, see [Table API](https://www.servicenow.com/docs/access?context=c_TableAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
...
Generate reports on the data you imported to the Log \[sn\_imt\_core\_log\] table using [Reporting](https://www.servicenow.com/docs/access?context=reporting-landing-page&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
