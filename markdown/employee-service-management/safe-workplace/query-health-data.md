...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/safe-workplace/query-health-data.html
release: xanadu
...
1.  Send a GET request to the Table API on your instance.
    ...
    For more information, see [Table API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/rest-apis/c_TableAPI.md).
