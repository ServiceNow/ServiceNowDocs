...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/safe-workplace/screen-returning-employee.html
release: yokohama
...
<table id="choicetable_bgv_ws5_r2c"><thead><tr><th align="left" id="d75176e92">

Platform

</th><th align="left" id="d75176e95">

Action

</th></tr></thead><tbody><tr><td id="d75176e101">
...
Navigate to **Employee Health and Safety Status** &gt; **View Employee and Visitor Status** and select the person.
    ...
    **Note:** Requirements are created in the Employee Readiness Core application. For more information, see [Employee Health and Safety Status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-readiness-core/employee-health-safety-status.md).
...
<table id="choicetable_pjf_l3s_zlb"><thead><tr><th align="left" id="d75176e202">

Platform

</th><th align="left" id="d75176e205">

Action

</th></tr></thead><tbody><tr><td id="d75176e211">
