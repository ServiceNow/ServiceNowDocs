...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/safe-workplace/screen-returning-employee.html
release: xanadu
...
<table id="choicetable_bgv_ws5_r2c"><thead><tr><th align="left" id="d71740e92">

Platform

</th><th align="left" id="d71740e95">

Action

</th></tr></thead><tbody><tr><td id="d71740e101">
...
Navigate to **Employee Health and Safety Status** &gt; **View Employee and Visitor Status** and select the person.
    ...
    **Note:** Requirements are created in the Employee Readiness Core application. For more information, see [Employee Health and Safety Status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-readiness-core/employee-health-safety-status.md).
    ...
    \[Omitted image "erc-status-screening-links-rnd32.png"\] Alt text: Health and safety status screen.

3.  Perform the health screen.

<table id="choicetable_pjf_l3s_zlb"><thead><tr><th align="left" id="d71740e202">

Platform

</th><th align="left" id="d71740e205">

Action

</th></tr></thead><tbody><tr><td id="d71740e211">
...
</table>    \[Omitted image "health-screen-person-entry.png"\] Alt text: Health screening form
