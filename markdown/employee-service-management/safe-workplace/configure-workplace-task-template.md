...
2.  Create a new template or modify an existing template.
    ...
    For information about the template form fields, see [Create a template](https://www.servicenow.com/docs/access?context=t_CreateATemplateUsingTheTmplForm&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
