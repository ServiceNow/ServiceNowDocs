...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/modify-download-manifest-file.html
release: xanadu
...
breadcrumb: [Integrating Employee Center and Virtual Agent with Microsoft Teams for GCC-H or DoD, Microsoft Teams for GCC-H or DoD, Integrate, ServiceNow for Microsoft Teams and Microsoft 365, Employee Service Management]
---
...
6.  In the **Configure Virtual Agent** section, you can do one of the following.
    ...
    To configure the Virtual Agent in your instance, click **Configure Virtual Agent**. For more information, see [Conversational Integration with Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/conversational-interfaces/virtual-agent/teams-conv-integration.md).
...
You must upload the manifest file in Microsoft Teams. For more information, refer [Upload manifest file in Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/upload-manifest-ms-teams.md).

**Parent Topic:**[Integrating Employee Center and Virtual Agent with Microsoft Teams for GCC-H or DoD](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/ec-teams-va-integration-gcch.md)
