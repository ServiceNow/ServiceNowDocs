...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/legal-simple-contracts/work-tpc-review-request.html
release: yokohama
...
<table id="choicetable_jhj_kb3_gtb"><thead><tr><th align="left" id="d254329e114">

Option

</th><th align="left" id="d254329e117">

Steps

</th></tr></thead><tbody><tr><td id="d254329e123">
...
<table id="choicetable_v1f_bjj_bwb"><thead><tr><th align="left" id="d254329e206">

Option

</th><th align="left" id="d254329e209">

Steps

</th></tr></thead><tbody><tr><td id="d254329e215">
...
2.  In the **Create revision from** list, select the location of the document.
    ...
    -   **Online**: Select a file stored in the [configured external storage system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-request-management/integrate-legal-ext-storage.md).
...
6.  [Send the document for ad-hoc approval](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-request-management/initiate-approval-legal-request.md) when an approval is required from other stakeholders.
...
1.  Signatories can review and [sign or decline to sign the contract document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-simple-contracts/sign-a-legal-contract-document.md).
...
3.  If the contract is signed by all parties, you can [close the request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-request-management/close-legal-request.md) by clicking **Close Complete.**
