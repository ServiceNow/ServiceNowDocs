...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/legal-simple-contracts/lsc-create-copy-template-word.html
release: yokohama
...
breadcrumb: [Manage Legal Simple Contracts, Legal Simple Contracts, Legal Service Delivery Practice Applications, Legal Service Delivery, Employee Service Management]
---
...
4.  Import template field mappings from a Microsoft Word document with content controls.
    ...
    For more information, see [Add content controls in a Microsoft Word document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-simple-contracts/lsc-cont-contr-word-tmplt.md).
...
Map any new meta data found during parsing. For more information, see [Update contract template mappings for legal contract template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-simple-contracts/lsc-template-map-msword.md).
