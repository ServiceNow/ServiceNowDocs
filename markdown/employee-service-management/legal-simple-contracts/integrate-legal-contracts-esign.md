...
-   **[Adobe Sign spoke](https://www.servicenow.com/docs/access?context=adobe-sign-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) spoke v2.5.1 or later version**

    For more information on the setup and synchronizing the Adobe Acrobat Sign group, see [Synchronize Adobe Acrobat Sign group with ServiceNow](https://www.servicenow.com/docs/access?context=setup-adobe-sign&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).

-   **[DocuSign spoke](https://www.servicenow.com/docs/access?context=docusign-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) spoke v2.2.0 or later version**

    For more information on the setup and creating the Docusign account, see [Set up Docusign eSignature spoke using authorization code grant](https://www.servicenow.com/docs/access?context=setup-docusign-authorization-code&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
