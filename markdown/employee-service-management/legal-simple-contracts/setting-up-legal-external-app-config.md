...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/legal-simple-contracts/setting-up-legal-external-app-config.html
release: zurich
...
-   **Configure external storage provider spokes**
    ...
    -   [Box spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/box-spoke.md)
