...
-   **Configure external storage provider spokes**
    ...
    -   [Box spoke](https://www.servicenow.com/docs/access?context=box-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
    -   [Google Drive spoke](https://www.servicenow.com/docs/access?context=googledrive-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
    -   [Microsoft OneDrive spoke](https://www.servicenow.com/docs/access?context=onedrive-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
...
-   **Configure electronic signature provider spokes**
    ...
    -   [Adobe Acrobat Sign spoke](https://www.servicenow.com/docs/access?context=adobe-sign-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
    -   [Docusign spoke](https://www.servicenow.com/docs/access?context=docusign-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
