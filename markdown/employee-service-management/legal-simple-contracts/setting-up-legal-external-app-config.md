...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/legal-simple-contracts/setting-up-legal-external-app-config.html
release: yokohama
...
-   **Configure external storage provider spokes**
    ...
    -   [Box spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/box-spoke.md)
