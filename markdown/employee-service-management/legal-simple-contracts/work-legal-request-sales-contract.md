...
2.  Click the list icon \(![List icon](../../human-resources/reference/images/checklist-icon.png)\).

3.  In the **Lists** tab, open a legal request by selecting an option under **Legal Requests**.

<table id="choicetable_jhj_kb3_gtb"><thead><tr><th align="left" id="d540643e109">

Option

</th><th align="left" id="d540643e112">

Steps

</th></tr></thead><tbody><tr><td id="d540643e118">
