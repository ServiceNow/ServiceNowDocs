...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/legal-simple-contracts/lsc-create-ct-msword.html
release: zurich
...
4.  On the Word Template New Record form, fill in the fields.
    ...
    For a description of the field values, see [Word Template New Record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/legal-simple-contracts/lsc-word-tmple-rec-form.md).
...
5.  Extract the content marked by the supported content controls from the imported document by selecting **Parse Document**.
    ...
    For more information on the supported content controls and tagging guidelines, see [Add content controls in a Microsoft Word document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/legal-simple-contracts/lsc-cont-contr-word-tmplt.md).
...
**Parent Topic:**[Configure legal contract templates of type Microsoft Word](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/legal-simple-contracts/lsc-configure-ct-msword.md)
