...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/legal-simple-contracts/lsc-create-ct-msword.html
release: yokohama
...
breadcrumb: [Configure legal contract templates of type Microsoft Word, Legal contract templates, Configure Legal Simple Contracts, Setting up Legal Simple Contracts, Legal Simple Contracts, Legal Service Delivery Practice Applications, Legal Service Delivery, Employee Service Management]
---
...
4.  On the Word Template New Record form, fill in the fields.
    ...
    For a description of the field values, see [Word Template New Record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-simple-contracts/lsc-word-tmple-rec-form.md).
...
5.  Extract the content marked by the supported content controls from the imported document by selecting **Parse Document**.
    ...
    For more information on the supported content controls and tagging guidelines, see [Add content controls in a Microsoft Word document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-simple-contracts/lsc-cont-contr-word-tmplt.md).
...
**Parent Topic:**[Configure legal contract templates of type Microsoft Word](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-simple-contracts/lsc-configure-ct-msword.md)
