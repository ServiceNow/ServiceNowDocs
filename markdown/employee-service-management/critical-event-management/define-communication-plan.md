...
4.  Select **Submit**.
    ...
    **Note:**
    ...
    -   To learn more about a communication plan and its process, see [Task Communications Management process](https://www.servicenow.com/docs/access?context=task-communications-management&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
