...
To use SMS in addition to email as a communication channel, configure Twilio for SMS. For more information on configuring Twilio, see Configure Notify with Twilio.
