...
[Critical Event Management reference](critical-event-management-reference.md)![](../../../common/image/icon-reference.png)Get detailed description of the forms used in critical event management.
