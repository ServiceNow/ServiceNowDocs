...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/critical-event-management/using-playbook.html
release: yokohama
...
5.  Complete the generic playbook section.
    ...
    4.  Select **Compose** on an initial-communication template or select **Go to Notification center** to compose an ad-hoc communication for the impacted people.
        ...
        For more details on sending ad-hoc communication, see [Create a communication task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/critical-event-management/create-new-communication.md)
