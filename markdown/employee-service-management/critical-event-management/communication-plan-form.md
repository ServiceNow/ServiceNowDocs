...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/critical-event-management/communication-plan-form.html
release: yokohama
...
|Order|Order in which the communication plans must be associated with the table.|
...
**Parent Topic:**[Critical Event Management reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/critical-event-management/critical-event-management-reference.md)
