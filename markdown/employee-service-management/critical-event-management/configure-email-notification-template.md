...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/critical-event-management/configure-email-notification-template.html
release: yokohama
...
3.  Fill the form and draft the content for the template. For more information on email templates, see [Email templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/c_EmailTemplates.md).
