...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/critical-event-management/configure-email-notification-template.html
release: xanadu
...
3.  Fill the form and draft the content for the template. For more information on email templates, see [Email templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/c_EmailTemplates.md).
