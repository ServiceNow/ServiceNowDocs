...
7.  Update the status of multiple individuals by selecting multiple check boxes and then selecting the **Accounted** button or selecting the Accounted - More Actions icon ![Accounted - More Actions icon](../../legal-request-management/image/arrow.png) and choosing a different status.
