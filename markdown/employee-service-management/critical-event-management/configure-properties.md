...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/critical-event-management/configure-properties.html
release: yokohama
...
5.  Use the **Flag to disable the playbook for Critical Event** option to enable or disable the **Playbook** related item on the critical event record page.

6.  In the Google Map Component Properties section, select the **Enable Geo Map feature** check box.

    **Note:** This configuration is available only when the Geo map application is installed.

7.  Add either a client id or an API key:
    ...
    For more information, see [Set up Google Maps API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/set-up-google-maps-api.md).
