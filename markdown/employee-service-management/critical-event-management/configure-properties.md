...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/critical-event-management/configure-properties.html
release: xanadu
...
6.  Add either a client id or an API key:
    ...
    For more information, see [Set up Google Maps API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/set-up-google-maps-api.md).
