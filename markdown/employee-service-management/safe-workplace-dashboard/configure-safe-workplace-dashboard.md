...
2.  Follow the steps in [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/configure-form-layout.md) to add the **Parent**, **Latitude**, and **Longitude** fields to the Campus form.
