...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/safe-workplace-dashboard/configure-safe-workplace-dashboard.html
release: yokohama
...
2.  Follow the steps in [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/configure-form-layout.md) to add the **Parent**, **Latitude**, and **Longitude** fields to the Campus form.
