...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/safe-workplace-dashboard/safe-wkplc-dashboard-alert-types.html
release: yokohama
...
A user with the pa\_admin role can define additional alert types. For information about using Performance Analytics, see [Performance Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/performance-analytics/pa-overview.md).

**Parent Topic:**[Safe Workplace Dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/safe-workplace-dashboard/safe-workplace-dashboard.md)
