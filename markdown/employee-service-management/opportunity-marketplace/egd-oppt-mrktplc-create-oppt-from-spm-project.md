...
You must have Project Workspace installed and configured to create opportunities from project files. See, [Project Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/project-workspace-landing-page.md).
...
Attachments can include related information such department details of the team an applicant would be working with or more extensive details about gigs, projects, or volunteer opportunities. Attachments are attached to the corresponding opportunity record.
    ...
    2.  From the **Who can view this opportunity?** list, select one or more groups to enable members of the group to view the opportunity.
        ...
        For information about creating user groups, see [Create a user group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_CreateAGroup.md).
...
10. Fill in the form with the role details.
    ...
    To read more details about the role form and fields, see [Form fields for creating opportunities in Opportunity Marketplace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/employee-service-management/opportunity-marketplace/egd-oppt-mrktplc-oppty-form-fields.md).
...
**Parent Topic:**[Use Opportunity Marketplace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/employee-service-management/opportunity-marketplace/egd-oppt-mrktplc-using.md)
