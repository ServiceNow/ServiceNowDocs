...
You must have Project Workspace installed and configured to create opportunities from project files. See, [Project Workspace](https://www.servicenow.com/docs/access?context=project-workspace-landing-page&version=zurich&pubname=zurich-it-business-management&ft:locale=en-US).
