...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/opportunity-marketplace/egd-create-other-opportunities.html
release: yokohama
...
2.  Select **Create an opportunity**.
    ...
    **Note:**
    ...
    -   Gig: For details on gigs, see [Gig opportunities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/opportunity-marketplace/egd-oppt-mrktplc-gig.md).
    -   Project: For details about what a project is, see [Project opportunity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/opportunity-marketplace/egd-oppt-mrktplc-project.md)
    -   Volunteer: For details about what a volunteer opportunity is, see [Volunteer opportunities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/opportunity-marketplace/egd-oppt-mrktplc-volunteer.md)
    **Tip:** If you need a different opportunity type, you can create custom opportunity types. For more details, read [Creating custom opportunity types in Opportunity Marketplace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/opportunity-marketplace/egd-oppt-mrktplc-custom-oppt-type.md).
...
4.  Fill in the form with the details for the opportunity that you selected.
    ...
    2.  From the **Who can view this opportunity?** list, select one or more groups to enable members of the group to view the opportunity.
        ...
        For information about creating user groups, see [Create a user group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/user-administration/t_CreateAGroup.md).

    To read details about the opportunity forms and fields, see [Form fields for creating opportunities in Opportunity Marketplace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/opportunity-marketplace/egd-oppt-mrktplc-oppty-form-fields.md).
...
7.  Fill in the form with the role details.
    ...
    To read more details about the role form and fields, see [Form fields for creating opportunities in Opportunity Marketplace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/opportunity-marketplace/egd-oppt-mrktplc-oppty-form-fields.md).
...
9.  When you’re satisfied with your opportunity, select **Publish**.
    ...
    You may be prompted to **Submit for approval** instead. This occurs when the opportunity meets specific conditions, requiring approval prior to publishing. For more information, see [Opportunity publishing approval](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/opportunity-marketplace/egd-oppt-pubs-approval.md).


**Parent Topic:**[Use Opportunity Marketplace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/opportunity-marketplace/egd-oppt-mrktplc-using.md)
