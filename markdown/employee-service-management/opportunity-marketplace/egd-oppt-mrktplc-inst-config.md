...
1.  [Install Opportunity Marketplace](../task/egd-oppt-mrktplc-store-install.md)
2.  Assign the `sn_opp_market.admin` role to users so they can configure and manage Opportunity Marketplace
3.  Provide employees with licenses to access OPM features: [License Talent Development Core users](../../employee-service-management/task/egd-employee-profile-licensing.md)
4.  \(Optional\) Users with the `sn_opp_market.admin` role can [create Custom Opportunity Types](egd-oppt-mrktplc-custom-oppt-type.md)
