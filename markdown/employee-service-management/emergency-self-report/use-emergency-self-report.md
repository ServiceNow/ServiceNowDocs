...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/emergency-self-report/use-emergency-self-report.html
release: yokohama
...
-   To report your health status:
    ...
    2.  Choose an option from the **Health status** list.
        ...
        \[Omitted image "employee-self-report-employee-view.png"\] Alt text: Users report their own health status.
...
-   To evaluate the health status of your direct reports if you're a manager:
    ...
    1.  Navigate to **Emergency Self Report** &gt; **Emergency Self Report Dashboard**.
        ...
        \[Omitted image "employee-self-report-dashboard-manager-view-fullscreen.png"\] Alt text: Emergency Self Report manager view.
...
[View a dashboard of all user reports if you are a response team member](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/emergency-self-report/view-hr-tasks-response-team.md)
