...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/emergency-self-report/set-up-emergency-self-report.html
release: zurich
...
1.  Add the default application user roles to appropriate groups.
    ...
    For information about how to assign roles to groups, see [Roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_AssignRoleToGroup.md).
