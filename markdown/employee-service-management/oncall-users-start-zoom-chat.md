...
breadcrumb: [Chat-specific configuration for Collaboration services for Zoom, Enhance employee experience by integrating ServiceNow with Zoom, Integrate, ServiceNow for Zoom, Employee Service Management]
---
...
The users who are associated with On-call Scheduling will be displayed in the **Selected** column of **Start Zoom chat** dialog box.
...
-   **[Extend On-call users for Start Zoom Team Chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/extend-oncall-users-start-zoom-chat.md)**  
