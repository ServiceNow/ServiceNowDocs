...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/submit-legal-dft-request.html
release: xanadu
topic_type: task
...
-   If you [uploaded custodial and non-custodial data from an Excel or CSV file](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/submit-legal-dft-request.md), the file is attached as a reference document to the request.
