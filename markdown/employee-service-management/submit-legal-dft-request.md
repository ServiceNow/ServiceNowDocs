...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/submit-legal-dft-request.html
release: australia
topic_type: task
...
-   If you [uploaded custodial and non-custodial data from an Excel or CSV file](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/submit-legal-dft-request.md), the file is attached as a reference document to the request.
