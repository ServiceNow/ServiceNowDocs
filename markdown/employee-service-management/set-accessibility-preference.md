...
Users can tab through the platform UI without enabling accessibility. However, without accessibility enabled, tabbing goes from field to field and skips other items on a form, such as reference icons. For details, see [Using accessibility features](https://www.servicenow.com/docs/access?context=keyboard-accessibility&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
