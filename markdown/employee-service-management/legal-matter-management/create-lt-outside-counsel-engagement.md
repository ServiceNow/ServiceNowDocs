...
<table id="choicetable_vvd_bng_hxb"><thead><tr><th align="left" id="d182758e61">

Method

</th><th align="left" id="d182758e64">

Action

</th></tr></thead><tbody><tr><td id="d182758e70">
...
</table>2.  Select **Add outside counsel for Legal Tracker** from the down arrow ![Down Arrow icon](../../legal-invention-disclosure/image/arrow.png) on **Add outside counsel**.
...
4.  If do not have the complete the Legal Tracker details and want it to be filled later, select the **Create a task for entering Legal Tracker field details** check box.
    ...
    A task will be created to fill in the Legal Tracker details once the outside counsel request is approved. You need to fill in the details and submit the outside counsel engagement request for integration with Legal Tracker. For more information, see [Assign task created for filling Legal Tracker details](lmm-lt-assign-task-ocer.md) and [Enter Legal Tracker details and submit for integration](lmm-enter-lt-details.md).
