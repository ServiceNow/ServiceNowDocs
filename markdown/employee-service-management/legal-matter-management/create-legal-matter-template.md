...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-matter-management/create-legal-matter-template.html
release: xanadu
...
breadcrumb: [Legal matter templates, Setting up Legal Matter Management, Legal Matter Management, Legal Service Delivery, Employee Service Management]
---
...
5.  In the Phases related list, [create phase templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-matter-management/create-phase-template-for-matter-template.md).

6.  In the Tasks related list, [create task templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-matter-management/create-task-template-for-matter-phase-template.md).
...
-   **[Create a phase template for a matter template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-matter-management/create-phase-template-for-matter-template.md)**  
...
-   **[Create a task template within a phase template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-matter-management/create-task-template-for-matter-phase-template.md)**  
...
**Parent Topic:**[Legal matter templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-matter-management/legal-matter-administration.md)
