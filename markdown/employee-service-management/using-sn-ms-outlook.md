...
breadcrumb: [ServiceNow for Microsoft Outlook, Employee Service Management]
---

# Using ServiceNow for Microsoft Outlook

Use the ServiceNow integration with Microsoft Outlook to view reports, approve requests, and provide feedback from within email messages.

## Concur expense reports

View Concur expense reports from approval notifications in email messages. Approve or reject expense reports without leaving the Microsoft Outlook application.
