...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/workplace-maintenance-management/cal-view-overview.html
release: xanadu
...
8.  To view the schedule plan for a maintenance record, click the **Schedules** tab.
    ...
    You also have the option to create or copy a schedule. For more information, see [Create or copy a maintenance schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/create-maint-schedule.md).
...
**Previous topic:**[Create and publish maintenance plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/create-publish-maintenance-plans.md)

**Next topic:**[Create or copy a maintenance schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/create-maint-schedule.md)
