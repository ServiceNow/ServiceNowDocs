...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/workplace-maintenance-management/sch-job-planned-nightly.html
release: xanadu
...
-   For each plan record, the **Next run value** depends on the **Field** name value. The **Field** value is available when you’re creating a meter-based schedule.
    ...
    For more information, see in [Create or copy a maintenance schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/create-maint-schedule.md).
...
**Previous topic:**[Create or copy a maintenance schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/create-maint-schedule.md)

**Next topic:**[Workplace maintenance cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/create-maint-cases.md)
