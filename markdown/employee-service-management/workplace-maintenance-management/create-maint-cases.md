...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/workplace-maintenance-management/create-maint-cases.html
release: xanadu
...
3.  Select a maintenance case to view the **Workplace Service** associated with a maintenance case and the scheduled job value for a case.
    ...
    For more information, see [Create plan service configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/create-maint-service-config.md).
...
5.  Navigate to **All** &gt; **System Definitions** &gt; **Scheduled jobs**.
    ...
    3.  To execute the schedule job before the scheduled time, select **Execute Now**.
        ...
        For more information about how to create a scheduled job and how the scheduled job picks up plan records based on conditions and workplace services, see [Create or copy a maintenance schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/create-maint-schedule.md) and [Workplace planned maintenance scheduled job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/sch-job-planned-nightly.md).
...
6.  To optimize cleaning activities for a selected location using Agentic AI workflow, the Optimize cleaning activity scheduled job is executed.
    ...
    For more information, see [Components installed with Workplace Maintenance Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/components-installed-with-maintenance-mgmt.md) and [Optimize cleaning activities agent overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-service-delivery/optimise-cleaning-agent-overview.md).
...
**Previous topic:**[Workplace planned maintenance scheduled job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/sch-job-planned-nightly.md)

**Next topic:**[Create workplace services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-maintenance-management/create-workplace-services.md)
