...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-calendar-synchronization/workplace-calendar-synchronization-overview.html
release: yokohama
...
-   Microsoft Exchange Online, receive calendar updates through subscriptions and callback events. A callback event triggers the application to retrieve the calendar information.
...
**Parent Topic:**[Workplace Calendar Synchronization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-calendar-synchronization/workplace-calendar-sync-feat.md)
