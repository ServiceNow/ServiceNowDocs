...
1.  [Authenticate Google for calendar synchronization](../task/authenticate-google-for-calendar-sync.md)  
...
2.  [Create a Connection and credential record for Google](../task/create-connection-configuration-with-google.md)  
Connect Google with the ServiceNow using the flow designer to synchronize reservations.
3.  [Configure your own Google connection and credential alias](../concept/configure-your-own-google-connection-and-credential-alias.md)  
...
4.  [Configure Google as calendar provider](../task/configure-google-as-calendar-provider.md)  
