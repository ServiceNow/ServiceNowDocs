...
1.  Install Microsoft Exchange Online spoke from the ServiceNow Store. For more information, refer to [Microsoft Exchange Online spoke](https://www.servicenow.com/docs/access?context=ms-exch-online-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
...
2.  [Set up Microsoft Exchange Online spoke](https://www.servicenow.com/docs/access?context=setup-ms-exch-ol&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
