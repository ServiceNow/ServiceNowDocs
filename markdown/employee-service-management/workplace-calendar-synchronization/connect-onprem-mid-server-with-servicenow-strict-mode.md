...
**Previous topic:**[Create a strict mode connection for Microsoft Exchange On-Premises](../concept/create-a-strict-mode-connection-for-onprem.md)

**Next topic:**[Create a strict mode Connection and credential alias for Microsoft Exchange On-Premises](create-connection-credential-alias-for-exchange-on-prem-in-strict-mode.md)
