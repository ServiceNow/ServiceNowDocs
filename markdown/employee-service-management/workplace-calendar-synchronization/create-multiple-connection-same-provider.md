...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/workplace-calendar-synchronization/create-multiple-connection-same-provider.html
release: australia
