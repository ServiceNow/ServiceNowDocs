...
**Previous topic:**[Create your own connection and credential alias for Google](create-own-connection-credential-alias-for-google.md)

**Next topic:**[Microsoft Exchange On-Premises - Calendar synchronization](../reference/ms-exchange-on-prem-calendar-synchronization.md)
