...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-calendar-synchronization/wsd-calendar-provider-form-fields.html
release: yokohama
...
Option to enable the selection of your own connection and credential alias. If the option isn’t enabled, then the default connection and credential alias are used.
