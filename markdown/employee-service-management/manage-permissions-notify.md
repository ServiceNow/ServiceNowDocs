...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/manage-permissions-notify.html
release: xanadu
topic_type: task
...
3.  Search and open the Notify connector bot created in step 3 in the section [Create an app in Microsoft Teams to enable making calls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/create-app-ms-teams.md) by name or by Application \(client\) ID.
