...
9.  Navigate to Microsoft SharePoint Online Spoke and register the certificate and secret for your application.
...
6.  Navigate to the OAuth Entity Profiles \[oauth\_entity\_profile\] table to find the following entries:
    ...
    Two system-generated OAuth entity profiles \(REST and Graph\) are created in the OAuth Entity Profiles \[oauth\_entity\_profile\] table. For more information, see Specify an OAuth profile
...
</table>    For more information, see Specify an OAuth scope.
...
\(For Graph\) Graph entity profile identified.\(For REST\) REST entity profile identified.
        ...
        **Note:** For more information on Entities, Connection &amp; Credential Aliases, see Configure the SharePoint Graph Root Site Subscription connection and credential alias record.
