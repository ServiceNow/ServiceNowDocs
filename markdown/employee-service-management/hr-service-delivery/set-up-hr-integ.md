...
3.  Create a flow in Flow Designer.
    ...
    For more information, refer to [Create a flow](https://www.servicenow.com/docs/access?context=create-flow&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
