...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/train-model-articles-hr.html
release: xanadu
...
You can also [manually train the predictive model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/hr-predictive-intelligence-train.md) if it is not auto trained by default.
