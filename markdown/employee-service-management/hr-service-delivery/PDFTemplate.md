...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/PDFTemplate.html
release: xanadu
...
**Note:** See . [Managed Document features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/document-management-services/r_ManagedDocumentFeatures.md)
...
3.  Select **PDF Document Template**.
    ...
    **Note:** To know the differences between the types of document template, see [HR document templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/c_HRDocumentTemplates.md).
...
Select the document type the template applies to. Click **New** from **HR Document Type** to create a document type.
 ...
 See [Using document types with HR document templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/DocumentTypes.md).
