...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/hr-integrations-with-first-advantage.html
release: xanadu
...
1.  [Provide source credentials for the First Advantage service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/hr-integrations-sources-first-advantage.md)  
Provide the source and SOAP credentials for the First Advantage service so that it can be accessed for integration.
2.  [Verify integration for the First Advantage service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/verify-base-inbound-integration-for-first-advantage.md)  
...
3.  [Add background check packages for the First Advantage service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/background-check-package-for-first-advantage.md)  
