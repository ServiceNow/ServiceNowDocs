---
title: Default configurations for to-dos
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/hr-service-delivery/manager-hub-todos.html
release: zurich
...
To dos filters is a module within Employee Center. For more details on how to configure the filters, see [Create or modify a to-dos filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/configure-to-dos-page-filters.md)

|Name|Description|
|----|-----------|
|Approvals|Filters to display requests that require approval of a manager in Manager Hub.|
|My team tasks|Filter to display team tasks to a manager in Manager Hub.|

The following filter conditions are also available: HR approvals, HR tasks, HR tasks for UR, Journey accelerator to-dos, Journey accelerator to-dos- Adhoc, Request approvals, Universal task, and UR approvals.

For more information on the filters, navigate to **Employee Center** &gt; **Administration** &gt; **To-dos configuration** &gt; **To-dos filters**.
