...
3.  Review the information from [Configure Knowledge Demand Insights](https://www.servicenow.com/docs/access?context=configure-demand-insights&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
