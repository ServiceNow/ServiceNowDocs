...
3.  Configure the [Oracle HCM Cloud Spoke](https://www.servicenow.com/docs/access?context=oracle-hcm&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) to pull data from Oracle system.
