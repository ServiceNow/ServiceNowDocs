...
For more information, see [HR Service Delivery Employee Relations assignment rules](hr-er-assign-rules.md).

## ER matching rules

Use ER matching rules to assign an agent that has the least number of cases, the required skills, and matches the location.

For more information, see [HR Service Delivery Employee Relations matching rules](hr-er-matching-rules.md).
