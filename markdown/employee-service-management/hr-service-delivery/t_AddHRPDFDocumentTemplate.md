...
7.  Review the look of the generated document by impersonating an employee and submitting the associated catalog item.
    ...
    **Note:** The following HTML elements are NOT supported:
    ...
    -   Inline styling.
    -   Background images.
    See [Editing functions in the TinyMCE editor](https://www.servicenow.com/docs/access?context=r_EditingFunctions&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
