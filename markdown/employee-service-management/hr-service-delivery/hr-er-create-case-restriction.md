...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/hr-er-create-case-restriction.html
release: xanadu
...
Center of Excellence \(COE\) that you want to restrict access to.**Note:** For more information on COE, see [HR Centers of Excellence data model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/hr-centers-of-excellence-coes.md).
