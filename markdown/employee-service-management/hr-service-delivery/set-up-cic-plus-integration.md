...
2.  Your CIC Plus partner must then:
    ...
    1.  Configure your account to get employee profiles for US-based employees through the get\_usa\_employee\_profile REST endpoint.
        ...
        For information and examples on the get\_usa\_employee\_profile REST endpoint, see [get\_usa\_employee\_profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/hr-core-api.md).
