...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/set-up-cic-plus-integration.html
release: xanadu
...
2.  Your CIC Plus partner must then:
    ...
    1.  Configure your account to get employee profiles for US-based employees through the get\_usa\_employee\_profile REST endpoint.
        ...
        For information and examples on the get\_usa\_employee\_profile REST endpoint, see [get\_usa\_employee\_profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/rest-apis/hr-core-api.md).
