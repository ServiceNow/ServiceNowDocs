...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/set-up-ukg.html
release: xanadu
...
1.  Integrate your Ultimate Kronos Group application with your ServiceNow instance.
    ...
    Register an OAuth application in the Ultimate Kronos Group application and authenticate requests from ServiceNow. For more information, see [Set up the UKG spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/setup-kronos.md).

2.  Complete the one time set up of loading accrual codes from the Ultimate Kronos Group application into ServiceNow.

    For more information, see [Set up accrual codes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/accrual-type-ukg.md).
