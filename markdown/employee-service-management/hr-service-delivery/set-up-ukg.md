...
1.  Integrate your Ultimate Kronos Group application with your ServiceNow instance.
    ...
    Register an OAuth application in the Ultimate Kronos Group application and authenticate requests from ServiceNow. For more information, see [Set up the UKG spoke](https://www.servicenow.com/docs/access?context=setup-kronos&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
