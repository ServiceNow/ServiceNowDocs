...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/t\_ViewHRCaseInformation.html
release: yokohama
...
Role required: sn\_hr\_core.case\_reader
...
3.  Select a button.
    ...
    -   **Follow**: Track activity on the case or follow a record in Connect Chat to track activity as it happens. For more information, see [Follow a record in Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/connect/t_StartARecordConversation.md).
