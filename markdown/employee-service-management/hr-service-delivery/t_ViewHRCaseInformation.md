...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/hr-service-delivery/t\_ViewHRCaseInformation.html
release: zurich
...
3.  Select a button.
    ...
    -   **Follow**: Track activity on the case or follow a record in Connect Chat to track activity as it happens. For more information, see [Follow a record in Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/t_StartARecordConversation.md).
