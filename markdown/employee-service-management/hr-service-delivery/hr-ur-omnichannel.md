...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/hr-ur-omnichannel.html
release: xanadu
...
To auto-create a universal request from an HR case and copy the primary details from an HR case to a universal request, [Configure field mappings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/create-mappings-hrur.md).
