...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/config-business-csdm.html
release: xanadu
...
2.  [Create a service table configuration in Service Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/config-service-table.md).

3.  Map your BU service to CSDM Service or Service Offering.

    For more information, see [Configure CSDM service mappings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/config-csdm-ser-map.md).
...
5.  Create a service portfolio and add the required taxonomy nodes.
    ...
    For more information, see [Service Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/service-portfolio-management/SPM2-landing-page.md).
...
7.  Configure KPI group and indicators for your business unit in the Digital Portfolio Management dashboard.
    ...
    For more information, see [Digital Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/digital-portfolio-management/dpm-landing.md).
