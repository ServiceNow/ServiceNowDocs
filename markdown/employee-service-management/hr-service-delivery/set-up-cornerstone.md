...
1.  Set up the Cornerstone spoke in IntegrationHub.
    ...
    For more information, refer to the [Cornerstone spoke](https://www.servicenow.com/docs/access?context=cornerstone-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) documentation.
