...
<table id="choicetable_iql_hwq_yqb"><thead><tr><th align="left" id="d462572e101">

Status of the person related to the case

</th><th align="left" id="d462572e104">

Action

</th></tr></thead><tbody><tr><td id="d462572e110">
 ...
 **Note:** You can translate the text in your preferred language using the **Translate** option. For configuring the dynamic translation framework, see [Dynamic translation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/dynamic-translation-overview.md).
