...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/configure-case-creation-form-for-hr-service.html
release: xanadu
...
breadcrumb: [Configure an HR service, HR service configuration, HR services, HR Administration, Case and Knowledge Management, HR Service Delivery, Employee Service Management]
---
...
**Parent Topic:**[Configure an HR service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/configure-hr-service.md)
