...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/hr-service-delivery/employee-center-hr.html
release: zurich
...
-   The base system provides the HR topics and subtopics and are included when you activate the HR taxonomy \(com.sn\_hr\_emp\_taxonomy\) plugin.
    ...
    **Note:** For more information, see:
    ...
    -   [Associate a knowledge article with a taxonomy category](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/associate-knowledge-article-with-taxonomy-topic.md)
