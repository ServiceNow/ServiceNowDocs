...
-   Matching rules are used to determine case assignment by matching criteria. Refer to [Matching rules for case assignment](https://www.servicenow.com/docs/access?context=case-assignment-matching-rules&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US) .
