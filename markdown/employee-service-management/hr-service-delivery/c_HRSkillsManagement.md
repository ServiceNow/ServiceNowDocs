...
-   Matching rules are used to determine case assignment by matching criteria. Refer to [Matching rules for case assignment](https://www.servicenow.com/docs/access?context=case-assignment-matching-rules&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US) .
