...
-   [Service Bridge](https://www.servicenow.com/docs/access?context=tmt-service-bridge-both-landing-page&version=zurich&pubname=zurich-service-bridge&ft:locale=en-US)
...
-   Can [Enable magic links](https://www.servicenow.com/docs/access?context=service-bridge-v2-magic-links&version=zurich&pubname=zurich-service-bridge&ft:locale=en-US) to let consumer users complete assigned tasks from provider instance.
