...
3.  Configure the [Workday HR Spoke](https://www.servicenow.com/docs/access?context=workday-hr-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) to pull data from Workday system.
