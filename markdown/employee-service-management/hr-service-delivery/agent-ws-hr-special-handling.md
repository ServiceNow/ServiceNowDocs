...
1.  Edit the special handling notes properties.
    ...
    For more information, see [Configure special handling notes properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/t_EnableOnScreenAlertProperties.md).

2.  Create special handling notes for an HR table.

    For more information, see [Configure special handling notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/configure-special-handling-notes.md).
...
For more information, see Highlighted values in the form header and [Special handling notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/c_OnScreenAlerts.md).
