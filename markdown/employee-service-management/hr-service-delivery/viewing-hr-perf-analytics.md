...
-   **Scheduled Data Collection**
    ...
    See [Create or schedule a data collection job](https://www.servicenow.com/docs/access?context=t_CreatASchedDataCollJob&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).

-   **Indicators**

    Each job has indicators to make data collection efficient and defines what data to collect.

    See [Configure a job indicator](https://www.servicenow.com/docs/access?context=configure-job-indicator&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).

-   **View dashboards**

    After the PA jobs run, you can view the collected data from the **Dashboard**.

    See [Dashboards overview](https://www.servicenow.com/docs/access?context=dashboards-overview&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
...
For more information about performance analytics and how to develop and modify widgets for your organization, see [Performance Analytics concepts](https://www.servicenow.com/docs/access?context=c_PerformanceAnalytics&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US) .
