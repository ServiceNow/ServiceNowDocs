...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/t\_CreateBulkCases.html
release: xanadu
...
4.  Select **New** in the **User segment groups** tab.
    ...
    For more information, see [Create a user segment group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/bulk-case-segment.md).
