...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/hr-centers-of-excellence-coes.html
release: xanadu
...
\[Omitted image "hr-coe-data-model.png"\] Alt text: HR COE data model
...
\[Omitted image "hr-coe-data-model-components.png"\] Alt text: HR COE data model
...
**Note:** For a list of base system COEs and how to enable or disable them, see [Enable or disable an HR Center of Excellence \(COE\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/hr-service-categorization.md).
