...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/playbook-hr-card-configuration-classic.html
release: yokohama
...
breadcrumb: [Setting up HR Service Delivery Playbook, HR Service Delivery Playbook, HR Service Delivery Agent Workspace \(Classic\), HR Service Delivery, Employee Service Management]
---
