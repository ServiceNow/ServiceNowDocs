...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/er-hr-pa-eo.html
release: xanadu
...
The number of ER cases that are classified as restricted. For more information, see [HR Service Delivery Employee Relations case restrictions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/hr-er-case-restriction.md).
