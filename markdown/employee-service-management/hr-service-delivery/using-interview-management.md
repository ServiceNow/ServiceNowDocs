...
-   Use Microsoft Outlook Calendar to schedule an interview.
    ...
    **Note:** You can use the manual method of scheduling in HR Service Delivery Agent Workspace. For more information, see  or [Schedule an interview in Employee Relations using Agent Workspace for HR Case Management](../task/hr-er-interview-ws.md).
