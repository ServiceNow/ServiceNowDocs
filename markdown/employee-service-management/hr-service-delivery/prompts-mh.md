...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/prompts-mh.html
release: yokohama
...
To learn how to use Proactive Prompts, refer to the [Proactive Prompts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/proactive-prompts/proactive-prompts-for-hrsd.md) documentation.

## Signal configurations

For detailed information on how to configure signals in Proactive Prompts, see [Configuring Proactive Prompts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/proactive-prompts/proactive-prompts-config.md).
...
For more information on signal actions, see [Configure signal actions for Proactive Prompts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/proactive-prompts/proactive-prompts-signal-actions.md).
