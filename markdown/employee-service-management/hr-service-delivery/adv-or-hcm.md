...
Next, you must set up [Oracle HCM Cloud spoke](https://www.servicenow.com/docs/access?context=setup-oracle-hcm&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
