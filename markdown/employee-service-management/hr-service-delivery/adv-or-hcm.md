...
Next, you must set up [Oracle HCM Cloud spoke](https://www.servicenow.com/docs/access?context=setup-oracle-hcm&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
