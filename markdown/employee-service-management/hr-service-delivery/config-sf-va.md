...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/config-sf-va.html
release: xanadu
...
2.  Configure the [SuccessFactors Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/successfactors-spoke.md) to pull data from SuccessFactors system.
