...
To make a copy of your landing page, use the UI Builder. For more information, see [UI Builder](https://www.servicenow.com/docs/access?context=ui-builder-overview&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).
...
The configuration of the SLA timer that determines which task SLA displays as part of the timer component.**Note:** For more information, see [SLA timer configurations](https://www.servicenow.com/docs/access?context=sla-timer-configurations&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US).
