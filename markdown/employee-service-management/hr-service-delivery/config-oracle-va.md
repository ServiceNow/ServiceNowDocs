...
2.  Configure the [Oracle HCM Cloud Spoke](https://www.servicenow.com/docs/access?context=oracle-hcm&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) to pull data from Oracle system.
