...
<table id="choicetable_vvj_tvs_mgb"><thead><tr><th align="left" id="d98912e51">

Option

</th><th align="left" id="d98912e54">

Description

</th></tr></thead><tbody><tr><td id="d98912e60">
...
-   This option is only available for existing customers that have not yet migrated to e-signature. See [Migrate existing HR task templates and open HR tasks to e-signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/employee-service-management/hr-service-delivery/migrate-existing-tasks-to-scoped-e-signature.md) for more information.
-   Starting with the Brazil release, the HR task type: Credential will be hidden, but will continue to be supported. E-signature provides the latest experience for this functionality.
...
-   This option is only available for existing customers that have not yet migrated to e-signature. See [Migrate existing HR task templates and open HR tasks to e-signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/employee-service-management/hr-service-delivery/migrate-existing-tasks-to-scoped-e-signature.md) for more information.
-   Starting with the Brazil release, the HR task type: E-signature \(e\_signature\) will be hidden, but will continue to be supported. E-signature provides the latest experience for this functionality.
...
**Note:** The document must be included in the HR case template in the **PDF Template** field. See [Configure an HR case template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/employee-service-management/hr-service-delivery/configure-hr-case-template.md).
...
Starting with the Brazil release, HR task type: Sign Document will be hidden, but will continue to be supported. E-signature provides the latest experience for this functionality.
