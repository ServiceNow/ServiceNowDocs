...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/configure-hr-task-template.html
release: xanadu
...
breadcrumb: [HR templates, HR services, HR Administration, Case and Knowledge Management, HR Service Delivery, Employee Service Management]
---
...
<table id="choicetable_vvj_tvs_mgb"><thead><tr><th align="left" id="d103519e51">

Option

</th><th align="left" id="d103519e54">

Description

</th></tr></thead><tbody><tr><td id="d103519e60">
...
-   Starting with the Xanadu release, the HR task type: Credential will be hidden, but will continue to be supported. E-signature provides the latest experience for this functionality.
...
-   This option is only available for existing customers that have not yet migrated to e-signature. See [Migrate existing HR task templates and open HR tasks to e-signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/migrate-existing-tasks-to-scoped-e-signature.md) for more information.
-   Starting with the Xanadu release, the HR task type: E-signature \(e\_signature\) will be hidden, but will continue to be supported. E-signature provides the latest experience for this functionality.
...
**Note:** The document must be included in the HR case template in the **PDF Template** field. See [Configure an HR case template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/configure-hr-case-template.md).
...
Acknowledgment text entered on the HR document template overrides text written here. See [Configure an HR document template \(HTML\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/t_AddHRPDFDocumentTemplate.md) or [Configure an HR PDF document template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/PDFTemplate.md).

**Note:**

Starting with the Xanadu release, HR task type: Sign Document will be hidden, but will continue to be supported. E-signature provides the latest experience for this functionality.
