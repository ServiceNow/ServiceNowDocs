...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/agent-ws-response-template-email.html
release: xanadu
...
4.  Enter the name of the person you are sending the email to in the **To** field.
