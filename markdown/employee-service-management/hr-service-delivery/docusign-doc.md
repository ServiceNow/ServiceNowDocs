...
Next, set up the Docusign spoke. For more information, see [Docusign eSignature Spoke](https://www.servicenow.com/docs/access?context=docusign-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
