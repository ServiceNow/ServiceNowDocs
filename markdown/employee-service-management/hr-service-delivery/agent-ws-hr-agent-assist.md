...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/agent-ws-hr-agent-assist.html
release: xanadu
...
The contextual side panel provides your agents with tools to research and resolve HR cases.

For information on setting up Contextual Sidebar, see Set up Agent Assist.
...
-   **Response Templates**
    ...
    **Note:** The base system provides table configurations for each HR case table. If you use a different Center for Excellence \(COE\), you must create a new table configuration record.
...
-   **Employee Documents**
    ...
    For more information, see [Filter configuration for contextual search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/contextual-search/filter-configuration-for-cxs.md).
