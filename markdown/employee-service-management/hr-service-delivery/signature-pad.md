...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/signature-pad.html
release: yokohama
...
Ensure **Yes** is checked in the **com.snc.signaturepad.retrieveSignature** field on HR properties. See [HR properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/t_HRProperties.md).

**Note:** [E-signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/e-signature.md)
...
-   **Use**
    ...
    **Note:** Typing a signature provides acknowledgement, but does not capture an image that is stored.
    ...
    For **HR document templates**, use the **Insert Signature** button to insert a variable that prompts a user to sign the document. For **HR PDF document templates**, use the **Employee Signature** field name and **PDF Template Mappings** to prompt a user to sign the document. Refer to [HR document templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/c_HRDocumentTemplates.md).

    **Note:** Check the generate document UI action condition to ensure this feature works correctly.

    -   **Examples**

        The HR Delivery System uses PDF documents for various scenarios. An example of the code used to call a UI page or dialog box for the signature pad:\[Omitted image "PDF\_code\_snippet.png"\] Alt text: PDF code snippet example that calls UI page.

        An example of the code used in a document after a signature has been accepted and a final PDF document is created:\[Omitted image "signature\_pad\_snippet.png"\] Alt text: Code when signature is accepted.
