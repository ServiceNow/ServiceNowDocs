...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/hr-service-delivery/arc-setup.html
release: zurich
...
1.  Install and activate the Anonymous Report Center \(com.sn\_anonymous\_report\_center\) plugin: [Activate the Anonymous Report Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/arc-activate.md).
...
You must also set up an enterprise Google captcha account. For more information, see [Configure Google reCAPTCHA for the password reset process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/t_ConfigureGoogleRecaptcha.md).
...
</table>3.  Give employees access to the Anonymous Report Center by adding the catalog items to the Employee Center: [Add ARC catalog items to the Employee Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/hr-service-delivery/add-arc-menu.md)
