...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/hr-profile-create-employee-union.html
release: xanadu
...
2.  Select **New** or an existing HR profile.
    ...
    **Note:** For information on the fields to complete an HR profile, see [Add or modify an HR profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/t_CreateOrModifyAUserProfile.md).
