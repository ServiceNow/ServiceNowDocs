---
title: Using chat in HR Service Delivery Agent Workspace
description: Agent chat for HR Service Delivery Agent Workspace enables you to ask questions and receive information through live or virtual agent chat.Use the agent inbox to manage your incoming work, such as chats, HR cases, and interactions.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/agent-ws-hr-chat.html
release: yokohama
...
-   **HR groups**
    ...
    For more information about HR groups, see [Manage HR Groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/t_ManageHRGroups.md).
...
-   **Virtual agent**
    ...
    For more information on virtual agent, see [Virtual Agent for HR Service Delivery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-virtual-agent-conversations.md).
...
6.  Select the \[Omitted image "quick-action-icon.png"\] Alt text: HR Agent Workspace - Quick action icon quick action icon.

    Or enter a back slash \(/\) in the chat area.
