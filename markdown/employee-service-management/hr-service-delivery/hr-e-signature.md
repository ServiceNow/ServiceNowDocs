...
</table>You can use the assignments as-is or change them. To change the default assignments, see Components installed with e-signature for information on how to assign a role to another role, group, or user.
