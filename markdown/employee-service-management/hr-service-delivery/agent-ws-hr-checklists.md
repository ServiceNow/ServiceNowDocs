...
-   **Creating a checklist directly into an HR case**
    ...
    -   Scroll down and select the down arrow and select **Create New**.![Checklist](../reference/images/checklist-create-new.png)
    -   Enter instructions.
-   **Creating a checklist directly into an HR Task**

    Create an HR task with **Checklist** for the **HR Task Type**. See [Create a task for a case using HR Service Delivery Agent Workspace](../task/agent-ws-hr-task.md).
