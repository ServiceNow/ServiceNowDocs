...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/configure-hr-case-template.html
release: xanadu
...
breadcrumb: [HR service configuration, HR services, HR Administration, Case and Knowledge Management, HR Service Delivery, Employee Service Management]
---
...
**Parent Topic:**[HR service configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/hr-service-configuration.md)

**Previous topic:**[Add a custom column \(field\) to an HR table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/configure-custom-column-hr-table.md)

**Next topic:**[Configure a record producer for an HR service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/configure-hr-record-producer.md)
