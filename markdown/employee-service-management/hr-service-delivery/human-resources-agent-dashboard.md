...
breadcrumb: [Scoped solutions, Performance Analytics for HR Service Delivery, Integrate with ServiceNow applications, HR Service Delivery, Employee Service Management]
---
...
HR Agent: Agents need to monitor their cases and measure their performance to stay on top of the backlog.

</td><td>

sn\_hr\_core.basic, sn\_hr\_core.case\_writer

</td><td>

The HR Agent can provide a streamlined experience for the organization workforce.

</td></tr></tbody>
</table>## Use case

Organizations need to understand and meet or exceed the expectations of the modern workforce and provide a delightful employee experience. Using this dashboard, the HR Agent can track the progress of the cases they own, sorted by priority.

## Data visualizations

The Human Resources Agent dashboard contains the following visualizations:
