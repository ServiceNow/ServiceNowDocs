...
-   **[Integrations for Leader Hub](td-lh-integrate.md)**  
...
-   **[View north-star and drill-down metrics](../task/td-lh-view-metrics.md)**  
...
-   **[View team details](../task/td-lh-view-team-details.md)**  
...
-   **[Use the View menu icon in Leader Hub](../../human-resources/task/view-menu-lh.md)**  
Use the View menu icon \(![View menu icon](../../human-resources/image/viewmenu.png)\) to view the career profile of an employee, schedule or create a conversation, or send emails.
-   **[View skill details](../task/td-lh-view-skill-details.md)**  
...
-   **[View organizations you support](../task/td-lh-view-org-support.md)**  
...
-   **[Use the Employee Summary Virtual Agent topic in Leader Hub](../task/employee-summary-va-lh.md)**  
