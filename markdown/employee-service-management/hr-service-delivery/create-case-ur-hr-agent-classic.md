...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/create-case-ur-hr-agent-classic.html
release: yokohama
...
breadcrumb: [HR Service Delivery Agent Workspace integration with Universal Request, HR Service Delivery Agent Workspace \(Classic\), HR Service Delivery, Employee Service Management]
---
