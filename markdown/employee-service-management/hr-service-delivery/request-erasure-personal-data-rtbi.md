...
HR admin can choose to anonymize instead of deleting the employee data. For more information, see [Data anonymization](https://www.servicenow.com/docs/access?context=dps-data-anonymization&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
