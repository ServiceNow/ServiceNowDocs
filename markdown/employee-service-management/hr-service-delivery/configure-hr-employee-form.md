...
6.  Use the survey designer to build questions for your employee form.
    ...
    **Note:** If you plan to map the question to a table field, make sure that the data types match. Mapping is supported for the following question types:
    ...
    -   String
    -   Reference
    For further details on the different question types, see [Survey designer elements](https://www.servicenow.com/docs/access?context=c_SurveyDesignerElements&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
