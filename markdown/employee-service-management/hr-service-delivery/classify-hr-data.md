...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/hr-service-delivery/classify-hr-data.html
release: zurich
...
breadcrumb: [ServiceNow Vault for HR Service Delivery, Integrate with ServiceNow applications, HR Service Delivery, Employee Service Management]
---
...
5.  In the Assign to data class dialog, select the data classifications you want to assign to your selected dictionary elements, then click **Classify**.
    ...
    **Warning:** This will overwrite any existing classifications for the selected dictionary items.
    ...
    See [Data dictionary tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/c_DataDictionaryTables.md) for additional information.
