...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/use-agent-ws-hr.html
release: yokohama
...
</table>For additional information, see [Working from the agent inbox](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/live-agent-overview.md).
