...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/DocumentTypes.html
release: xanadu
...
-   **Setting up document types**
    ...
    -   Add HR criteria to the HR service.
        ...
        -   When defining conditions like case sensitivity or null values, see API[GlideFilter - Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/server-api-reference/c_GlideFilterScopedAPI.md).
-   **How it works**
