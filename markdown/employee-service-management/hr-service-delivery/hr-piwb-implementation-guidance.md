...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/hr-piwb-implementation-guidance.html
release: yokohama
...
-   **[HR PIWB template: Auto-categorize email cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-piwb-email-categorization.md)**  
...
-   **[HR PIWB template: Predict the HR service for incoming cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-piwb-predict-hrservice.md)**  
...
-   **[HR PIWB template: Predict the assignment group for incoming cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-piwb-predict-ag.md)**  
...
-   **[HR PIWB template: Predict knowledge case clusters and demand insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-piwb-kb-case-clusters.md)**  
...
-   **[HR PIWB template: Predict knowledge gaps and insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-piwb-kb-gaps-insights.md)**  
...
-   **[HR PIWB template: Predict knowledge for HR case resolution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-piwb-similar-hrcases-agent.md)**  
...
-   **[HR PIWB template: Recommend similar cases by employee profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-piwb-similar-profile.md)**  
...
-   **[HR PIWB template: Predict knowledge for HR task completion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-piwb-similar-hrtasks-employee.md)**  
...
-   **[HR PIWB template: Recommend similar cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-piwb-similar-cases.md)**  
...
-   **[HR PIWB template: Recommend estimated time to resolve](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-piwb-ettr.md)**  
...
**Parent Topic:**[HR Predictive Intelligence Workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-predictive-intelligence-wb.md)

**Related topics**  


[Predictive Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/predictive-intelligence/predictive-intelligence.md)

[Get started with Predictive Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/predictive-intelligence/install-predictive-intelligence.md)
