...
-   **Automate signing requests using templates**
    ...
    For more information on using DocuSign templates and automating signing requests using templates, see [How to automate signing requests using templates](https://www.servicenow.com/docs/access?context=automate-docusign-templates&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
