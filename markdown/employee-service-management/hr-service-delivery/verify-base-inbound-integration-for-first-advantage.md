...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/verify-base-inbound-integration-for-first-advantage.html
release: yokohama
...
**Previous topic:**[Provide source credentials for the First Advantage service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/hr-integrations-sources-first-advantage.md)

**Next topic:**[Add background check packages for the First Advantage service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/background-check-package-for-first-advantage.md)
