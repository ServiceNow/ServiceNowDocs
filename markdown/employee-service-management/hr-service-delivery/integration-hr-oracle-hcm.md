...
[Configure ![Plan and configure your implementation](../../../common/image/icon-set-up.png) Plan and configure your integration.](configure-oracle-hcm.md)

</td><td>

[Use ![Work on integrating ServiceNow with Oracle HCM Cloud](../../../common/image/icon-workspace.png) Work on integrating ServiceNow with Oracle HCM Cloud.](../task/using-hrsd-int-oracle-clud-hcm.md)

</td><td>

[Reference ![Get details about components like fields, tables, and properties](../../../common/image/icon-reference.png) Get details about components like fields, tables, and properties.](../reference/reference-hrsd-int-oracle-cloud-hcm.md)
