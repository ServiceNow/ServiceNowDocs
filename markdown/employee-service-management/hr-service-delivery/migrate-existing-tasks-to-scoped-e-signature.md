...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/migrate-existing-tasks-to-scoped-e-signature.html
release: xanadu
...
breadcrumb: [HR e-signature, E-signature applications of HR Service Delivery, HR Service Delivery, Employee Service Management]
---
...
Starting with the Xanadu release, HR task types: Credential, E-signature \(e\_signature\), and Sign Document will be hidden and no longer activated on new instances, but will continue to be supported. E-signature provides the latest experience for this functionality.
