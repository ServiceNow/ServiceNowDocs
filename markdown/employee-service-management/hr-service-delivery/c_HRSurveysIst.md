...
For more detailed information about working with surveys, trigger conditions, and survey questions, see [Get started with Survey Management](https://www.servicenow.com/docs/access?context=r_SurveyManagementLandingPage&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
