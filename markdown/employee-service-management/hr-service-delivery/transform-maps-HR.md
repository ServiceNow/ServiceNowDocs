...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/transform-maps-HR.html
release: yokohama
...
3.  To create a transform map, click **New**.
    ...
    For details of how to create a transform map, refer to the table in [Transformation scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/system-import-sets/t_CreateATransformMap.md).
