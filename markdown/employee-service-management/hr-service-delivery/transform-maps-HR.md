...
3.  To create a transform map, click **New**.
    ...
    For details of how to create a transform map, refer to the table in [Transformation scripts](https://www.servicenow.com/docs/access?context=t_CreateATransformMap&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
