...
breadcrumb: [Setting up ESM framework, Enterprise Service Management Integrations Framework, Integration of HR Service Delivery with third-party systems, HR Service Delivery, Employee Service Management]
---
...
3.  On the form, fill in the fields:
    ...
    |Field|Description|
    |-----|-----------|
    |Name|Display name of the third-party application.|
    |Properties|Properties configured according to the requirements of the integration.|
    |Domain|Name of the application for which the record is created.|
