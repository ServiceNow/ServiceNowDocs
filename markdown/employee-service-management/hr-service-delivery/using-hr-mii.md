...
3.  [Using HR Multi Instance Integration for Provider](using-hr-mii-provider.md)
...
3.  [Using HR Multi Instance Integration for Consumer](using-hr-mii-consumer.md)
