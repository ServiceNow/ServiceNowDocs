...
**Parent Topic:**[Using Document Templates: HR Service Delivery use case](../concept/using-doc-templates.md)

**Related topics**  


[Document template categories](../concept/document-types-document-templates.md)

[Document Templates of type HTML](../concept/document-templates-flow-html.md)

[Document Templates of type PDF \(Advanced forms\)](../concept/document-templates-PDF-flow.md)

[Document Templates configurations](../concept/doc-template-configs.md#)

[Document generation methods](../concept/generate-pdf-doctemp.md)
