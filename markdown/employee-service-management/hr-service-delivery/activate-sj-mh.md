...
[Configure important dates in Manager Hub](../task/configure-imp-dates.md)

[Configure team requests in Manager Hub](../task/configure-team-requests.md)

[Configure team data in Manager Hub](../task/configure-team-data.md)

[Configure team column data in Manager Hub](../task/configure-team-columndata.md)

[Configure team filters in Manager Hub](../task/configure-team-filter.md)

[Set up View as Direct Reports](../../employee-center/task/view-direct-reportee.md)

[Configure daily stats in Manager Hub](../task/configure-daily-stats.md)

[Configure to do mappings in Manager Hub](../task/use-to-do-map.md)

[Configure widgets in Manager Hub](../task/configure-team-insights.md)
