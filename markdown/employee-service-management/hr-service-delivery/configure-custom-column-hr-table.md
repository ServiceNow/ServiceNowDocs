...
4.  Fill in the fields for the **Dictionary Entry**.
    ...
    **Note:** For more information on columns and fields, see [Field administration](https://www.servicenow.com/docs/access?context=c_IntroductionToFields&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
