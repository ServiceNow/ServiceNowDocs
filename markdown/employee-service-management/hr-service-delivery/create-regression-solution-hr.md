...
-   Employee portal view
    ...
    ![Displays the estimated time to resolve the case for employee](../image/ettr-employee-view.png "ETTR for employee")

-   Now Mobile view

    ![Displays the estimated time to resolve the case for employee on mobile app](../image/ettr-mobile-employee.png "ETTR on Now Mobile")
...
-   Agent workspace
    ...
    ![Displays the estimated time to resolve the case on agent workspace](../image/ettr-agent-view.png "ETTR on agent workspace")
