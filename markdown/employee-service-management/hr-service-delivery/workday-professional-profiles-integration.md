...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/workday-professional-profiles-integration.html
release: xanadu
...
-   Pulling data into the staging tables, and transform maps move data into target tables. For more information, see [Use transform maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/transform-maps-w.md).
