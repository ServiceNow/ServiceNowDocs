...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/workday-professional-profiles-integration.html
release: yokohama
...
-   Pulling data into the staging tables, and transform maps move data into target tables. For more information, see [Use transform maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/transform-maps-w.md).
