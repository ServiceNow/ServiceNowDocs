---
title: Set up the Microsoft Azure AD integration for new hire onboarding
description: To set up the Microsoft Azure AD integration for new hire onboarding, you must first set up the Microsoft Azure AD spoke, next configure the remote directory sync to fetch the groups into your instance, and last configure the required business roles.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/set-up-microsoft-azure-ad-integration-for-new-hire-onboarding.html
release: xanadu
...
breadcrumb: [Microsoft Azure AD integration for new hire onboarding, Lifecyle events for enterprise integrations, Lifecyle events for enterprise, HR Service Delivery, Employee Service Management]
---
...
-   [Microsoft Azure AD spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/microsoft-azure-ad-spoke.md)
...
1.  Set up the Microsoft Azure AD spoke.
    ...
    For instructions on how to set up the spoke, see [Set up Microsoft Azure AD spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/set-up-azure.md).
...
3.  Configure the required business roles.
    ...
    **Note:** The Business Roles \[com.snc.businessroles\] plugin is automatically activated with the Human Resources Scoped App: Lifecycle Events for Enterprise \[com.sn\_hr\_lifecycle\_ent\] plugin.
    ...
    For instructions on how to configure the business roles and map them to the relevant groups, see [Configure a business role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/configure-business-role.md).


**Parent Topic:**[Microsoft Azure AD integration for new hire onboarding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/azure-active-directory-integration-for-new-hire-onboarding.md)
