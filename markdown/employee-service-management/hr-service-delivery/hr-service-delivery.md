...
By meeting employees where they are, you empower them to find answers, get help, and get things done with a simple swipe, click, or chat. Employees can self-serve through the Now Mobile app . Digital workflows drive action across any organizational function and can enable every department to service employees more efficiently and effectively. New hires are guided through the onboarding process with the Now Mobile app, ensuring they're ready to succeed from day one.

[View and download the full info card](https://downloads.docs.servicenow.com/resource/enus/infocard/hr-service-delivery-statcard.pdf) for a highlight of HR Service Delivery features.
...
-   **Make it easy for employees to get HR services**

Give employees anytime, anywhere access to HR services to increase satisfaction.
...
Manage employee interactions in a structured and efficient manner, driving down the cost of service delivery.
...
-   **Use HR Service Delivery to build great experiences**

Replace manual and siloed processes with cross-functional digital workflows for increased efficiency.
...
The intelligent, intuitive, and mobile-first tech that transformed real life will radically transform work life.
...
-   **Enable leaders to support and manage their teams better**

Align business goals with employee needs, including onboarding, career growth, and other transitions.
...
Manage employee interactions in a structured and efficient manner, driving down the cost of service delivery. A purpose-built Centers of Excellence data model organizes HR data, services, and processes by functional discipline, enabling you to support all types of employee requests. You can deliver intelligence behind every interaction with virtual agents. And a standardized case and knowledge management system means that live agents have answers at their fingertips to provide help that is accurate, timely, and consistent.
...
## Enable leaders to support and manage team journeys

Align business goals with employee needs, including onboarding, career growth, and other transitions using Journey designer or Journey Accelerator.

-   **Journey designer \(JD\)**
    -   Combines the employee experience of Lifecycle Events and Journey Accelerator, so that managers and employees have a single interface to manage all their journeys.
    -   Enable managers and mentors to develop and curate custom journeys.
    -   Provide managers with high-level insights for their team's journeys.
    -   Integrate ServiceNow apps and third-party applications to extend JD features and capabilities.
-   **Journey Accelerator \(JA\)**
    -   Define and manage plan types, configurations, and stages for transitions such as promotions, onboarding, offboarding, and more.
    -   Create and manage task-based, to-do templates for specific employee audiences.
    -   Track plan progress and template usage from the Journey Accelerator dashboard.
    -   Trigger automatic department-based onboarding plans from Lifecycle Events

Integrate applications with Journey designer or Journey Accelerator.
...
-   **Learning Posts**
    ...
    Create and access an omni-channel learning experience empowering employees with the right learning at the right time, making learning accessible.

-   **Listening Posts**

    Trigger pulse surveys during the action plans to gather feedback on the Journey.

-   **Manager Hub**

    Increase managers self-service and proactive engagement with their team by providing insights and recommended actions for what's most urgent and important to drive team success. Enable managers to grow as leaders through curated and personalised resources.

-   **Microsoft Exchange Online**

    Schedule plans and to-do tasks with the Microsoft Office 365 calendar function.

    **Note:** If you intend to use the Microsoft Office 365 scheduling capabilities with Journey Accelerator or Journey designer, an administrator must install and configure the related Microsoft plugins and integrations before installing Journey Accelerator or Journey designer.


## Learn

-   [What is employee onboarding?](https://www.servicenow.com/products/hr-service-delivery/what-is-employee-onboarding.html)
-   [What is HR analytics?](https://www.servicenow.com/products/hr-service-delivery/what-is-hr-analytics.html)
-   [What is human resource management \(HRM\)?](https://www.servicenow.com/products/hr-service-delivery/what-is-hr-management.html)
-   [What is human capital management \(HCM\)?](https://www.servicenow.com/products/hr-service-delivery/what-is-human-capital-management.html)
-   [What is knowledge management \(KM\)?](https://www.servicenow.com/products/hr-service-delivery/what-is-knowledge-management.html)
