...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/emp-relations-legal.html
release: xanadu
...
Complete the necessary configurations to start using the integration. See [Set up Legal Investigations with HR Service Delivery Employee Relations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-investigations/integrate-lsd-hrsd.md).
