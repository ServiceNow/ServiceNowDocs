---
title: Create a task for a case using HR Service Delivery Agent Workspace
description: You can add a checklist for an HR task. Use the checklist as a step-by-step guide to ensure a consistent and efficient process.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/agent-ws-hr-task.html
release: xanadu
...
# Create a task for a case using HR Service Delivery Agent Workspace

You can add a checklist for an HR task. Use the checklist as a step-by-step guide to ensure a consistent and efficient process.
...
When assigning a task to an employee, you can request how the employee acknowledges completion of the task. The tasks appear on the Employee Center for the employee.

## Procedure

1.  Navigate to **All** &gt; **HR Case Management** &gt; **HR Agent Workspace** and select a case you want to add a task to.

2.  From the Child tabs above the Case details section, select the **HR Tasks** tab.

    \[Omitted image "agent-ws-hr-task.png"\] Alt text: HR Agent Workspace - HR Tasks tab

3.  Select **New**.

    \[Omitted image "agent-ws-hr-task-new.png"\] Alt text: HR Agent Workspace - Task tab New button

4.  Select an **HR task type**.

    \[Omitted image "agent-ws-hr-task-type.png"\] Alt text: HR Agent Workspace - Task type
...
</table>    **Note:** For information on all the fields, see [Adding an HR task to an HR case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/t_ViewAnHRTask.md).
