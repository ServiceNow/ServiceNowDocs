...
2.  From the Child tabs above the Case details section, select the **HR Tasks** tab.
    ...
    ![HR Agent Workspace - HR Tasks tab](../image/agent-ws-hr-task.png)

3.  Select **New**.

    ![HR Agent Workspace - Task tab New button](../image/agent-ws-hr-task-new.png)

4.  Select an **HR task type**.

    ![HR Agent Workspace - Task type](../image/agent-ws-hr-task-type.png)
