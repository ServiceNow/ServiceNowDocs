...
-   [set up the Adobe Sign spoke](https://www.servicenow.com/docs/access?context=adobe-sign-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
...
1.  Create a managed document that you want to make available for signing. See [Managed Documents](https://www.servicenow.com/docs/access?context=c_ManagedDocuments&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) for more information.
2.  Configure an HR service for the adhoc document.
3.  [Configure an HR PDF document template for an ad hoc document](../task/configure-hr-pdf-document-adobesign.md).
...
-   **[Configure an HR PDF document template for an ad hoc document](../task/configure-hr-pdf-document-adobesign.md)**  
