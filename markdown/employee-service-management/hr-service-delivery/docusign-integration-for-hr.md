...
-   Set up DocuSign spoke. See [Docusign eSignature Spoke](https://www.servicenow.com/docs/access?context=docusign-spoke&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
-   [Sychronize DocuSign with ServiceNow](https://www.servicenow.com/docs/access?context=sync-docusign-servicenow&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US)
...
1.  Create a managed document that you want to make available for signing. See [Managed Documents](https://www.servicenow.com/docs/access?context=c_ManagedDocuments&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) for more information.
