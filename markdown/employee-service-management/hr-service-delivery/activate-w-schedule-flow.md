...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/activate-w-schedule-flow.html
release: xanadu
...
5.  Select the data that you want to pull.
    ...
    **Note:**
    ...
    -   The **Retrieve All Data** check box is not supported for **Pull To-Dos**. The first pull will always be a full pull based on the configuration parameter **Initial Load Date time**
...
Once data is pulled into staging tables, transform maps move data into target tables. For more details, refer to [Use transform maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/transform-maps-w.md).
