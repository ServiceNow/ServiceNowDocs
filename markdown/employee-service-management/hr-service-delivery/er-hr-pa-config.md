...
11. Set up and run the historical job for this Analytics and Reporting Solution, **ERCases.HistoricalDataCollection**.
    ...
    Follow the procedure in [Run historical data collection for a Platform Analytics Solution](https://www.servicenow.com/docs/access?context=historical-data-nowintel-solution&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).

12. Edit and activate the scheduled data collection job for this Analytics and Reporting Solution, **ERCases.DailyCollection**.

    Follow the procedure in [Schedule data collection for a Platform Analytics Solution](https://www.servicenow.com/docs/access?context=schedule-job-nowintel-solution&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
