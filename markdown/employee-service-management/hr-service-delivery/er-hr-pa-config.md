...
11. Set up and run the historical job for this Analytics and Reporting Solution, **ERCases.HistoricalDataCollection**.
    ...
    Follow the procedure in [Run historical data collection for a Platform Analytics Solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/platform-analytics/historical-data-nowintel-solution.md).

12. Edit and activate the scheduled data collection job for this Analytics and Reporting Solution, **ERCases.DailyCollection**.

    Follow the procedure in [Schedule data collection for a Platform Analytics Solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/platform-analytics/schedule-job-nowintel-solution.md).
