...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/hr-profile-encrypted-fields.html
release: xanadu
...
**Note:** For more information on how to add the tax identification number for an employee, see [Add or modify an HR profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/t_CreateOrModifyAUserProfile.md).
