...
For more information, see [Integrating ServiceNow Voice for HR](https://www.servicenow.com/docs/access?context=integrate-voice-hr-agent&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
