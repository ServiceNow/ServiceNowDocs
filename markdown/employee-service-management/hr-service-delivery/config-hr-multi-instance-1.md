...
2.  Configure HR Multi Instance Integration for Provider by performing the following steps:
    ...
    2.  Create a remote record producer and publish it. For more information, see [Remote catalogs](https://www.servicenow.com/docs/access?context=service-bridge-v2-create-apps&version=australia&pubname=australia-service-exchange&ft:locale=en-US).
