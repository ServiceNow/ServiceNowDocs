...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/hr-piwb-kb-gaps-insights.html
release: yokohama
...
2.  From the templates list, go to **Similar HR cases with knowledge gap** template and click **Start**.
...
When the configuration is complete, machine learning algorithm provides various Knowledge Management capabilities, such as similar articles and knowledge demand insights.
