...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/t\_HRProperties.html
release: xanadu
...
**Note:** This property only affects possible duplicate HR cases for the same HR service and subject person in HR Agent Workspace. For more information, see [Receiving a duplicate case warning with HR Service Delivery Agent Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/agent-ws-hr-dup-case.md).
...
**Note:** For more information, see [Transfer an HR case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/reclassify-hr-case.md).
