...
**Note:** If you are using the table with Strategic Portfolio Management, see [Update the resource capacity](https://www.servicenow.com/docs/access?context=update-resource-capacity&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US) for more information.
