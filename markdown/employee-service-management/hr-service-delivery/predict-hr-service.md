...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/predict-hr-service.html
release: xanadu
...
You can [manually train the predictive model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/hr-predictive-intelligence-train.md) if it is not auto trained by default. Later, navigate to the **HR AI configuration** module, open the HR Case Classification record, and map the configured solution definition.
