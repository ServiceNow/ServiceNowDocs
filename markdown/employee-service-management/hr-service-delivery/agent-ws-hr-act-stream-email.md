...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/agent-ws-hr-act-stream-email.html
release: yokohama
...
breadcrumb: [Using the activity stream in HR Service Delivery Agent Workspace, Using the HR Service Delivery Agent Workspace, HR Service Delivery Agent Workspace \(Classic\), HR Service Delivery, Employee Service Management]
---

# Create a work note or comment in HR Agent Workspace

You can add a work note \(private\) or comment to an activity.
