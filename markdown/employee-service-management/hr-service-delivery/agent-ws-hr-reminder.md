...
# Create a reminder in HR Service Delivery Agent Workspace

You can create reminders tied to HR cases or tasks to provide timely communication and actions are taken. Use reminders to make certain you follow up by a specific date.
...
5.  Fill in the fields.
    ...
    |Date time|The date and time you want to receive the reminder.|
