...
-   Set up [Workday Learning Spoke](https://www.servicenow.com/docs/access?context=wd-learning-setup&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
