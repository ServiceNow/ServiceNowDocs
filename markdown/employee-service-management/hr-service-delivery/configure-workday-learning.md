...
-   Set up [Workday Learning Spoke](https://www.servicenow.com/docs/access?context=wd-learning-setup&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
