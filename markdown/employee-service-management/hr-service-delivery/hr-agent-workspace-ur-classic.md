...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/hr-agent-workspace-ur-classic.html
release: xanadu
...
## HR Service Delivery Agent Workspace integration with Universal Request overview
...
At any point in time, the HR agent can [route the HR case back](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/agent-workspace-for-hr-case-management/route-hrcase-ur-workspace.md) to the universal request queue with or without resolution.
