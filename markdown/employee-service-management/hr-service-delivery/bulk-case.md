...
-   **HR admin \(sn\_hr\_core.admin\) and bulk case creation**
    ...
    For more information on ACLs, see [Access control list rules](https://www.servicenow.com/docs/access?context=access-control-rules&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
