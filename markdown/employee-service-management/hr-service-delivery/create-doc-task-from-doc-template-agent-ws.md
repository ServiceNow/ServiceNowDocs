...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/create-doc-task-from-doc-template-agent-ws.html
release: yokohama
...
breadcrumb: [Creating reusable templates in HR Service Delivery Agent Workspace, Using the HR Service Delivery Agent Workspace, HR Service Delivery Agent Workspace \(Classic\), HR Service Delivery, Employee Service Management]
---
...
7.  In the document task record, sign off on the document.
    ...
    2.  In the dialog box that appears, sign the document.
        ...
        **Note:** If the **Signing type** in the template is Adobe Acrobat Sign or Docusign, after clicking **Sign Document**, the document opens in a new tab to enable you to use the associated signing type.
