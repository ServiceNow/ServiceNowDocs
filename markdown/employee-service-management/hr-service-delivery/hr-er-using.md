...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/hr-er-using.html
release: yokohama
...
-   Create an ER case using the Core UI Case Creation form or the HR Service Delivery Agent Workspace Create a new case form.
