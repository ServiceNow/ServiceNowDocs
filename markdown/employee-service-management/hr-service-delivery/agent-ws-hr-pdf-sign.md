...
**Note:** For more information, see [Configure an e-signature template](https://www.servicenow.com/docs/access?context=configure-e-signature-configuration&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
