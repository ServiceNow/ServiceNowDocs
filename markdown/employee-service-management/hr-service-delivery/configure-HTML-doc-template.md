...
The sanitization happens using the default HTML sanitizer. See [Exploring HTML sanitizer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/exploring.md-sanitizer.md) for more details.
