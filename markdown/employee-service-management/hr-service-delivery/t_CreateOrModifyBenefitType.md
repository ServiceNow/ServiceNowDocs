...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/hr-service-delivery/t\_CreateOrModifyBenefitType.html
release: yokohama
...
breadcrumb: [Managed lists, HR Administration, Case and Knowledge Management, HR Service Delivery, Employee Service Management]
---
...
Issue value name, such as benefit\_401k, or basic\_life.
...
Click and select the benefit type. Benefit types are:-   HR Disability Benefit
-   HR Health Benefit
...
Check to make this benefit type active and available to use.
...
Check to indicate that this benefit type requires beneficiaries to be entered when selected.
...
**Parent Topic:**[Managed lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/c_ManagedLists.md)
