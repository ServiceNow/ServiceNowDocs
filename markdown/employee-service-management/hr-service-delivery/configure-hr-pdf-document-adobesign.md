...
Create the managed document that you want to make available for signing through the Adobe Sign system. See [Managed Documents](https://www.servicenow.com/docs/access?context=c_ManagedDocuments&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) for more information.
