...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/hr-service-delivery/labor-unions-setting-up.html
release: xanadu
...
-   **[Create a labor union](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/labor-unions-create.md)**  
Create a union with details that identify it.
-   **[Create a local chapter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/labor-unions-local-chapter.md)**  
Use Local Chapters to set up and track the chapters of your union. Local chapters are children to labor unions.
-   **[Create union contacts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/labor-union-contacts.md)**  
