...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/now-assist-for-wsd/create-rsv-agent.html
release: yokohama
...
breadcrumb: [Making reservations using the Create a reservation agent, Using Now Assist in Virtual Agent, Workplace Service Delivery, Employee Service Management]
---
