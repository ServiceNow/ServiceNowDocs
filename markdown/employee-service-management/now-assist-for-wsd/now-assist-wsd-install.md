...
The System Admin \(admin\) role is required to install the application. Make sure that you have installed and configured the following dependent applications:
