...
-   **Breakdown**
-   **Aggregator**
For more information about the fields, see [Performance Analytics indicators](https://www.servicenow.com/docs/access?context=c_Indicators&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
