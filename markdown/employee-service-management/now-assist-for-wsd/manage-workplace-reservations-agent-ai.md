...
-   Send notification to Workplace Event planners using the ServiceNow Otto panel conversational interface.
    ...
    For more information, see [Review notifications in the ServiceNow Otto panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/now-assist-for-wsd/agentic-workflow-notifications-nowassist.md).
