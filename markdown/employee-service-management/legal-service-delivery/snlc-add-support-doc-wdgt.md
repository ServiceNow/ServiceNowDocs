...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/legal-service-delivery/snlc-add-support-doc-wdgt.html
release: yokohama
...
4.  Configure variables for **Upload documents optional interaction** variable set.\[Omitted image "snlc-add-suppdoc-wdg-variableset.png"\] Alt text:
