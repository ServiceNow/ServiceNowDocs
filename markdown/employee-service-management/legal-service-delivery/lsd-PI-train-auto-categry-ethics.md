...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-service-delivery/lsd-PI-train-auto-categry-ethics.html
release: xanadu
...
Role required: sn\_lg\_pi.admin
...
3.  On the form, verify the default field values and customize the solution as required.
    ...
    For more information about the Classification Definition form fields, see [Create and train classification solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/intelligent-experiences/predictive-intelligence/create-solution-definition.md).
