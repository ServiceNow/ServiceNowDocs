...
6.  Use Skill Determination Rules as an alternative way to map skills to an legal request case.
    ...
    If you are going to use skill determination rules to map a skill to an legal request, activate Skills Management. For more information, see [Skills Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/skills-management/skills-management.md).
