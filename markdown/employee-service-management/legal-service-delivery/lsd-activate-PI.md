...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/legal-service-delivery/lsd-activate-PI.html
release: yokohama
...
Predictive Intelligence for Legal Service Delivery requires a separate subscription from the rest of the ServiceNow AI Platform.
...
2.  Find the Predictive Intelligence for Legal Service Delivery plugin \(sn\_lg\_pi\) using the filter criteria and search bar.
...
**Parent Topic:**[Configure Predictive Intelligence for Legal Service Delivery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-service-delivery/lsd-PI-configure-landing.md)
