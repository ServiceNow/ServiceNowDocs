...
<table id="choicetable_tly_21d_xbc"><thead><tr><th align="left" id="d602436e150">

Method

</th><th align="left" id="d602436e153">

Steps

</th></tr></thead><tbody><tr><td id="d602436e159">
...
2.  Drag and drop the file into the add attachment pop-up.
    ...
    3.  Select Delete icon![Delete icon](../image/delete-icon.png).

        For legal matter, select the artifact from the Artifact section and then select Delete icon \(![Delete icon](../image/delete-icon.png)\).
