...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-service-delivery/snlc-submit-nda-request.html
release: xanadu
...
<table id="choicetable_vvd_bng_hxb"><thead><tr><th align="left" id="d330112e85">

Method

</th><th align="left" id="d330112e88">

Actions

</th></tr></thead><tbody><tr><td id="d330112e94">
...
For more information on how to view and track a legal request, see [View and track non-disclosure agreement requests as a legal user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-service-delivery/snlc-view-legal-req-details.md).
