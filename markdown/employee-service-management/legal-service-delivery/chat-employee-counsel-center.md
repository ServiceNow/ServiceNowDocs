...
[Getting work from chats](https://www.servicenow.com/docs/access?context=live-agent-overview&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)

[Interaction records in Workspace](https://www.servicenow.com/docs/access?context=interaction-message-agent-workspace&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
