...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-service-delivery/snlc-upload-doc-wet-sign.html
release: xanadu
...
4.  If you have opened contract request from the **Legal requests** listing, select the **Contract request** tab.
