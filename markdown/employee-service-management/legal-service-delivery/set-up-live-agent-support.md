...
2.  Configure the assignment rule to provide the criteria for routing the chat conversations to live agents in the Legal department.
    ...
    3.  Update fields as required.
        ...
        For more information on the fields, see [Configure agent assignment rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-create-assignment-rule.md).
...
3.  Configure the work item queue and the associated assignment eligibility.
    ...
    3.  Update fields as required.
        ...
        For more information on the fields, see [Create a work item queue](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-create-queue.md).
    ...
    6.  Update fields as required.
        ...
        For more information on the fields, see [Define Assignment Eligibility](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-specify-assignment-eligibility.md).
