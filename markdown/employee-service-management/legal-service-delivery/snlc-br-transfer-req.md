...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-service-delivery/snlc-br-transfer-req.html
release: xanadu
...
The business rule should be configured only if you have custom record producer that will be used to generate a contract request. For information on how to create a custom record producer, see [Create or modify a record producer for legal services through Classic environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/create-record-producer-legal-request.md) and [Create or modify a record producer for legal services through Catalog Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/create-record-producer-catalog-builder-legal.md).
