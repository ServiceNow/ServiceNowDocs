...
2.  Go to **Create and Manage** tab.

3.  Select **Generate onboarding ramp-up plan** from the list.

4.  Select **Add a preferred trigger**.

5.  Select **Onboarding ramp-up trigger** in the **Define trigger** window and duplicate it.
