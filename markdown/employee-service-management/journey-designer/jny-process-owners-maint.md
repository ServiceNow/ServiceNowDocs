...
**Note:** An administrator must assign owners and approvers to Journey designer plan configurations. For more details, read [Setup the Journey designer version 2 plan configuration review and approval process](jny-dsgnr-plan-config-admin.md)
...
-   **[Journey designer plan configuration approvers](jny-dsgnr-config-plan-approvers.md)**  
