...
You can also associate other actions with the notifications. For more information, see [Add actions to the notification content](https://www.servicenow.com/docs/access?context=noti-select-provider-actions-order&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
