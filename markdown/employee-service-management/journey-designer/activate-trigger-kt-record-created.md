...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/journey-designer/activate-trigger-kt-record-created.html
release: zurich
...
15. Set the **Assistants where AI agents are discoverable** field to **ServiceNow Otto \(default\)**.
