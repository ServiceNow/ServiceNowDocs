---
title: Install Journey designer version 3
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/journey-designer/jny-install-version-3.html
release: xanadu
...
# Install Journey designer version 3
...
**Note:** You must upgrade to Vancouver before you can install Journey designer version 3.
...
**Note:** Journey designer version 3 is compatible with Tokyo Patch 5 and later.

Role required: admin.

## About this task

Journey designer version 3 \(JD\) must be installed as a store application on the Vancouver family release.

**Important:** The Journey designer app also installs the Journey Accelerator v6.2.2 \[sn\_ja\] \(JA\) application.
