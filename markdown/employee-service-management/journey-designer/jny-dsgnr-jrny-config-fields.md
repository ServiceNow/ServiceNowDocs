...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/journey-designer/jny-dsgnr-jrny-config-fields.html
release: xanadu
...
**Note:** For this functionality to work, ensure that you copy the flow **Manager Change - Journeys** and activate it. To activate a flow, see . Also note that email notifications \(in the event of a change in manager\) are sent to the old manager, new manager, assigned agent, and the user updating the manager in `sys_user`.
...
The image that appears at the top of the Journey when viewed in the mobile app. See, [Journeys on Now Mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery-for-mobile/journeys-mobile-now.md).
...
Enables journey owners to see the pulse survey results tied to this journey.**Note:** This feature requires integration with Listening Posts. See, [Integrating Listening Posts with Journey designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/journey-designer/integrating-li-with-jny.md).
...
Enables journey owners to add courses that are related to training or learning. This permission depends on your organization’s implantation of Journey designer app and features.**Note:** This feature requires integration with Learning Posts. See, [Integrating Learning Posts with Journey designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/journey-designer/jny-dsgnr-intgrt-lrnng-pst.md).
...
**Parent Topic:**[Journey designer reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/journey-designer/jny-dsnr-reference.md)
