...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-readiness-core/create-readiness-user.html
release: xanadu
