...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-readiness-core/sync-employee-readiness-core-visitors.html
release: xanadu
...
-   The Workplace Visitor Management application must be installed. For more information, see [Install Workplace Visitor Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-visitor-management/install-workplace-visitor-mgmt.md).
