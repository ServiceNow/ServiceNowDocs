...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/config-azure-form-recognizer-integration.html
release: yokohama
topic_type: task
...
<table id="choicetable_gy1_qhr_4sb"><thead><tr><th align="left" id="d653365e219">

Trained model

</th><th align="left" id="d653365e222">

Steps

</th></tr></thead><tbody><tr><td id="d653365e228">
...
**Parent Topic:**[Automating vaccine response reviews with the Azure Form Recognizer service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/automate-vaccine-validation-with-azure-form-recognizer.md)
