...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-request-management/add-catalog-categories.html
release: xanadu
...
-   Associate a record producer with the category using the [Catalog Item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/create-record-producer-legal-request.md) related list.
-   Associate the catalog category with a practice area to map the practice area, record producer, and catalog category together. This mapping helps employees to use the relevant categories to submit legal requests. In turn, these requests are assigned to the correct groups or users through the associated practice area.
    ...
    For more information, see [Create or modify a practice area](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/manage-practice-areas.md).
