...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-request-management/manage-attachments-legal-request.html
release: xanadu
...
If the [external storage option](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/associate-categories-practice-area.md) is enabled, you can manage document access for users to see these attachments. For more information, see [Document access in a legal request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/document-access-legal-request.md).
...
<table id="choicetable_jhj_kb3_gtb"><thead><tr><th align="left" id="d72490e110">

Option

</th><th align="left" id="d72490e113">

Steps

</th></tr></thead><tbody><tr><td id="d72490e119">
...
<table id="choicetable_rpv_3f2_f5b"><thead><tr><th align="left" id="d72490e178">

Option

</th><th align="left" id="d72490e181">

Steps

</th></tr></thead><tbody><tr><td id="d72490e187">
...
-   **[Document access in a legal request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/document-access-legal-request.md)**  
