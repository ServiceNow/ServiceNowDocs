...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/legal-request-management/configure-pa-tables-for-reporting.html
release: yokohama
...
1.  Add new columns in a practice area table that you want to use to create reports for legal requests or legal matters submitted for the practice area.
    ...
    For more information, see [Add and customize a field in a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_CreatingNewFields.md).

2.  Create or modify a record producer for a legal request or legal matter for the associated practice area.

    For more information, see [Create or modify a record producer for legal services through Classic environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-request-management/create-record-producer-legal-request.md).
...
3.  Update the business rule to synchronize variables with the mapped table columns when users modify the intake form data after they've submitted a legal request or matter.
    ...
    For more information, see [Create a business rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/business-rules-classic/c_BusinessRules.md).
