...
-   From the SLA Definitions related list, [create a service level agreements \(SLA\) definition](https://www.servicenow.com/docs/access?context=t_CreateAnSLADefinition&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US), if required.
