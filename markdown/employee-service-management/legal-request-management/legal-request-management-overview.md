...
-   Submitting legal request across a service portal, mobile device, and Virtual Agent
-   Managing legal requests by resolving the issue or answering queries
-   Promoting legal request to legal matters that needs cross-departmental tasking and workflow
