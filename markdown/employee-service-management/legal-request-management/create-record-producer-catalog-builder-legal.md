...
For more information about catalog item templates and catalog items, see [Catalog Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/catalog-builder.md).

## Procedure

1.  Open Catalog Builder from the application navigator or from an intake form.

<table id="choicetable_umx_jtg_cvb"><thead><tr><th align="left" id="d598882e97">

Option

</th><th align="left" id="d598882e100">

Steps

</th></tr></thead><tbody><tr><td id="d598882e106">
...
4.  Select a template from the list, review the template preview, and click **Use this item template**.
    ...
    For more information, see [Create a catalog item using a template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/create-item-cat-builder.md).
 ...
 **Note:** If you don’t specify a user criteria in any option, access is granted to everyone.
 ...
 For more information on creating a user criteria, see [Set up the user criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/t_CreateAUserCriteriaRecord.md).
