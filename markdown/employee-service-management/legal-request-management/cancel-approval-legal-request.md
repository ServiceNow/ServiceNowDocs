...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/legal-request-management/cancel-approval-legal-request.html
release: yokohama
...
breadcrumb: [Initiate an ad hoc approval, Work on a legal request, Managing legal requests, Legal Request Management, Legal Service Delivery, Employee Service Management]
---
...
<table id="choicetable_jhj_kb3_gtb"><thead><tr><th align="left" id="d479074e102">

Option

</th><th align="left" id="d479074e105">

Steps

</th></tr></thead><tbody><tr><td id="d479074e111">
...
**Parent Topic:**[Initiate an ad hoc approval for a legal request or its attachment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-request-management/initiate-approval-legal-request.md)
