...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-request-management/initiate-approval-legal-request.html
release: xanadu
...
**Note:** The Document option in the list appears only when the [external storage option is enabled](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/associate-categories-practice-area.md) on the intake form of the request type.
...
Approvers can review and [approve or reject the requested item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/approve-reject-legal-request-attach.md).

-   **[Cancel an ad hoc approval for a legal request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/legal-request-management/cancel-approval-legal-request.md)**  
