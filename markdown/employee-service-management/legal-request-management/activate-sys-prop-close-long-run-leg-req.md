...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/legal-request-management/activate-sys-prop-close-long-run-leg-req.html
release: xanadu
