...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/legal-request-management/activate-sys-prop-close-long-run-leg-req.html
release: australia
