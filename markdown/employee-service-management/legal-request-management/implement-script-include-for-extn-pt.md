...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/legal-request-management/implement-script-include-for-extn-pt.html
release: yokohama
...
breadcrumb: [Create implementation in Scripted Extension Point, Configure legal storage system, Configure, Legal Request Management, Legal Service Delivery, Employee Service Management]
---
...
-   On the script include form, the script field is auto populated with the structure of expected function definitions. For more information on script include form, see [Script includes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/scripts/c_ScriptIncludes.md).
...
**Parent Topic:**[Create implementation in Scripted Extension Point](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/legal-request-management/create-scripted-extension-point.md)
