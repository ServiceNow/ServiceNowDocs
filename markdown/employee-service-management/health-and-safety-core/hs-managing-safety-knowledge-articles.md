...
The Health and Safety Knowledge is the same as the ServiceNow AI Platform Knowledge Management. For more information, see [Knowledge Management](https://www.servicenow.com/docs/access?context=knowledge-management&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
To learn about authoring and managing knowledge articles in a workspace, see [Authoring a knowledge article in Agent Workspace](https://www.servicenow.com/docs/access?context=managing-knowledge-workspace&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
-   Additionally, to remove this default filter setting from the Knowledge list in the Health and Safety Workspace, remove it in the UIB related list configuration. For more information, see [Lists](https://www.servicenow.com/docs/access?context=lists-configurable-workspace&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
