...
Provides access to enable the map component in the Health and Safety Workspace from the application properties.
 ...
 To install, see [Activate a plugin](https://www.servicenow.com/docs/access?context=t_ActivateAPlugin&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
...
Enables geolocation feature on the Now Mobile app and gives access to manual tracking options.
 ...
 For more information, see [Enabling and selecting location tracking options](https://www.servicenow.com/docs/access?context=location-tracking-enable&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US)
