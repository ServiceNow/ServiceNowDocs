...
8.  In the **Documents** tab, select **Add** to add any documents that cover topics to be discussed or shared in this meeting.

    For information on storing documents in the Health and Safety Workspace, see [Add a Health and Safety related document](add-hs-related-document.md).
...
-   The documents associated with this meeting are saved in the Health and Safety m2m meeting document \[sn\_ohs\_im\_m2m\_meeting\_document\] table.
