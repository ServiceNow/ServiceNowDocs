...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety-core/hs-action-form.html
release: yokohama
...
Parent Health and Safety record this action is related to.If the action belongs to an existing safety record such as an injury or risk assessment, select that record.
...
System-generated unique number for the action.
...
User group responsible for this action.
...
Location this action item applies to.
...
Date by when this action should be complete.
...
**Note:** This field lists the learning content created in Learning Core. For more information, see [Managing course and catalog content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/learning-core/manage-ln-content.md).
