...
For detailed information on authoring and managing knowledge articles in a workspace, see [Authoring a knowledge article in Agent Workspace](https://www.servicenow.com/docs/access?context=managing-knowledge-workspace&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
6.  On the form, fill in the fields.
    ...
    For information on the knowledge field descriptions, see [Create a knowledge article in Agent Workspace](https://www.servicenow.com/docs/access?context=create-article-workspace&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
