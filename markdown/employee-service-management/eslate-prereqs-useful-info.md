...
description: Verify the prerequisites, plugins, roles, licenses, and assets that Employee Slate needs before you deploy it.
locale: en-US
release: australia
topic_type: concept
...
Verify the prerequisites, plugins, roles, licenses, and assets that Employee Slate needs before you deploy it.
...
If your team publishes content or announcements in Employee Slate, verify the following prerequisites:
