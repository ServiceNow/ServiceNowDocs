...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/proactive-prompts/proactive-prompts-config-channels.html
release: yokohama
