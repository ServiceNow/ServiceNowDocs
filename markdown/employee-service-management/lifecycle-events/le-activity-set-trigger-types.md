...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/lifecycle-events/le-activity-set-trigger-types.html
release: yokohama
...
If there is no date in the trigger field, the activity set doesn't trigger.
...
**Parent Topic:**[Configure a Lifecycle Events trigger for activity sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/lifecycle-events/le-config-event-trigger.md)
