...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/lifecycle-events/lifecycle-event-properties-page.html
release: yokohama
 ...
 **Note:** To trigger an activity set proactively rather than wait for the value entered in this property, see [Lifecycle Events evaluation interval](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/lifecycle-events/le-evaluation-interval1.md).

</td></tr></tbody>
</table>3.  Click **Save**.


**Parent Topic:**[Lifecycle Events reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/lifecycle-events/lifecycle-events-reference.md)
