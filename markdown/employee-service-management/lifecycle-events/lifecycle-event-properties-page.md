...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/lifecycle-events/lifecycle-event-properties-page.html
release: australia
 ...
 **Note:** To trigger an activity set proactively rather than wait for the value entered in this property, see [Lifecycle Events evaluation interval](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/lifecycle-events/le-evaluation-interval1.md).
