...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/lifecycle-events/lifecycle-event-properties-page.html
release: xanadu
 ...
 **Note:** To trigger an activity set proactively rather than wait for the value entered in this property, see [Lifecycle Events evaluation interval](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/lifecycle-events/le-evaluation-interval1.md).
