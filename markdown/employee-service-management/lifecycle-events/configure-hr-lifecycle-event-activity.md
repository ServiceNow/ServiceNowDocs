...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/lifecycle-events/configure-hr-lifecycle-event-activity.html
release: australia
...
3.  Create a new or modify an existing activity.
    ...
    \[Omitted image "le-builder-config-activities-brand2.png"\] Alt text: Use the lifecycle event builder to create new or modify existing activities.
...
**Parent Topic:**[Configure a lifecycle event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/lifecycle-events/configure-hr-lifecycle-event-type.md)
...
-   Owning groups control who owns a lifecycle event activity. To learn more, see [Configure an owning group for a lifecycle event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/lifecycle-events/configure-lifecycle-event-owning-group.md).
...
For more information, see [Flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/build-workflows/flows.md).
...
</table>For more information, see [Subflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/build-workflows/subflows.md).
...
-   Only the **Switch primary job** subflow that is used to [support multiple jobs in a lifecycle event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/lifecycle-events/adopt-jobs-table.md) is available to use out-of-box.
...
2.  Select an activity that has **Flow** as the **Activity type**.
    ...
    For more information, see [For a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/lifecycle-events/configure-hr-lifecycle-event-activity.md).
...
Indicates if the input is required and reflects the settings from the subflow you selected.For more information, see [Subflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/build-workflows/subflows.md).
...
6.  A reorder pop-up appears.
    ...
    \[Omitted image "le-reorder-activity-brand2.png"\] Alt text: Lifecycle event activity - Reorder
