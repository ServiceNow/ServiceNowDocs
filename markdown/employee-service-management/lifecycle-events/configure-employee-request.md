...
-   For the Catalog Item category type, see [Service catalog items](https://www.servicenow.com/docs/access?context=c_IntroductionToCatalogItems&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
