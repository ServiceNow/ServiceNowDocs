...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/lifecycle-events/configure-lifecycle-event-owning-group.html
release: xanadu
...
breadcrumb: [Configure the supporting components for a lifecycle event, Building a lifecycle event, Lifecycle Events, HR Service Delivery, Employee Service Management]
---
...
**Parent Topic:**[Configure the supporting components for a lifecycle event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/lifecycle-events/configure-supporting-components-for-lifecycle-event.md)
