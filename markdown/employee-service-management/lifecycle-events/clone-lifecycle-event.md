...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/lifecycle-events/clone-lifecycle-event.html
release: yokohama
...
2.  Click **Clone Lifecycle Event** to clone the lifecycle event and all of its associated activity sets and activities.
    ...
    \[Omitted image "lifecycle-event-clone.png"\] Alt text: Click Clone Lifecycle Event to begin the cloning process.
...
After cloning a lifecycle event, you can filter lifecyle event activities. See, [Filter lifecycle event activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/lifecycle-events/filter-lifecycle-event-activities.md)
