...
Activity set triggers per the specified conditions.**Note:** When defining conditions like case sensitivity or null values, see APIGlideFilter - Scoped, Global.
