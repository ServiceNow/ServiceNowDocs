...
3.  Create a new or modify an existing activity set.
    ...
    ![Use the lifecycle event builder to create new or modify existing activity sets.](../image/le-builder-configure-activity-sets.png)
...
Activity set triggers per the specified conditions.**Note:** When defining conditions like case sensitivity or null values, see API [GlideFilter - Scoped, Global](https://www.servicenow.com/docs/access?context=c_GlideFilterScopedAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
