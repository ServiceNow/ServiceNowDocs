...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/lifecycle-events/le-config-event-trigger.html
release: yokohama
...
5.  Select a **Trigger type**.
    ...
    For information about the trigger types, see [Lifecycle Events activity set trigger types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/lifecycle-events/le-activity-set-trigger-types.md).

6.  Select **Update**.


-   **[Lifecycle Events activity set trigger types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/lifecycle-events/le-activity-set-trigger-types.md)**  
Administrators can configure activity set triggers to make activities in an activity set available.
-   **[Lifecycle Events activity set progress optimization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/lifecycle-events/le-stagnant-activity-set.md)**  
