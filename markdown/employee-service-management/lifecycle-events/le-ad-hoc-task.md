...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/lifecycle-events/le-ad-hoc-task.html
release: yokohama
...
4.  Select **Add a child case** or **Add task**.
    ...
    For more information, see [Create an HR case for a lifecycle event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/lifecycle-events/create-hr-lifecycle-event-case.md) and [Adding an HR task to an HR case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/hr-service-delivery/t_ViewAnHRTask.md).
...
5.  After filling in the required fields, ensure you select a value from the **Stage** field.
    ...
    **Note:** Stage is also known as an activity set or bundle. For more information, see [Configure a lifecycle event activity set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/lifecycle-events/configure-hr-lifecycle-event-activity-set.md).
