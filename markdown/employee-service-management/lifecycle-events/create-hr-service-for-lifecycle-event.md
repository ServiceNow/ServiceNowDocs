...
</table>    ![On the HR service form, set the Fulfillment type to Lifecycle Event.](../image/create-hr-service-for-lifecycle-event-1.png)
...
**Previous topic:**[Configure the rescind process for a Lifecycle Events activity](configure-rescind-for-a-lifecycle-event.md)
