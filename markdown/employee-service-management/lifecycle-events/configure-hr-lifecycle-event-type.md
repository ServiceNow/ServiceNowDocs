...
 
    ...
    ![Click the Activity Sets tab to configure the activity sets and activities for the lifecycle event.](../image/lifecycle-event-builder-ui.gif)
...
-   **[Configure the rescind process for a Lifecycle Events activity](configure-rescind-for-a-lifecycle-event.md)**  
