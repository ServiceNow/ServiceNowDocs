...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/lifecycle-events/configure-hr-lifecycle-event-type.html
release: xanadu
...
 
    ...
    -   [Configure a lifecycle event activity set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/lifecycle-events/configure-hr-lifecycle-event-activity-set.md)
    -   [Configure a lifecycle event activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/lifecycle-events/configure-hr-lifecycle-event-activity.md)
    \[Omitted image "lifecycle-event-builder-ui.gif"\] Alt text: Click the Activity Sets tab to configure the activity sets and activities for the lifecycle event.
...
-   **[Lifecycle Events evaluation interval](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/lifecycle-events/le-evaluation-interval1.md)**  
...
-   **[Configure the rescind process for a Lifecycle Events activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/lifecycle-events/configure-rescind-for-a-lifecycle-event.md)**  
...
**Previous topic:**[Configure a schedule content template for a lifecycle event activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/lifecycle-events/configure-schedule-content-template-for-lifecycle-event.md)

**Next topic:**[Configure a lifecycle event activity set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/lifecycle-events/configure-hr-lifecycle-event-activity-set.md)
