...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-services-kiosk/install-workplace-kiosk.html
release: yokohama
...
-   Name of the application: Workplace Services Kiosk
-   ID of the application: sn\_wsd\_kiosk
...
2.  Find the application by using the filter criteria and search bar.
    ...
    Search for the application by its name \(Workplace Services Kiosk or ID \(sn\_wsd\_kiosk\). If you can’t find the application, you may have to request it from the ServiceNow Store.

3.  Select **Install**.

4.  In the Application installation dialog box, review the application dependencies.

    A list of dependent plugins and applications are displayed if they’ll be installed, are currently installed, or must be installed. If there are any plugins or applications that must be installed, you must install them before you can install Workplace Services Kiosk.
