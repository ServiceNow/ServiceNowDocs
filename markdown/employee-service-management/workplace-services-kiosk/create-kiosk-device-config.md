...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/workplace-services-kiosk/create-kiosk-device-config.html
release: xanadu
...
3.  On the Kiosk configuration form, fill in the fields.
    ...
    For a description of the field values, see [Kiosk configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-services-kiosk/kiosk-configuration-form.md).
...
**Parent Topic:**[Configure Workplace Services Kiosk](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-services-kiosk/configure-workplace-services-kiosk.md)
