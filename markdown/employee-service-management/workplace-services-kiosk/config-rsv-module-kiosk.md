...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-services-kiosk/config-rsv-module-kiosk.html
release: yokohama
...
1.  Navigate to **All** &gt; **Workplace Reservation Management** &gt; **Reservable Module**.
    ...
    For more information, see [Configure a reservable module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-reservation-management/config-reservable-module.md). On the Reservable Module Configuration page, select the Kiosk module and configure it. This configuration enables employees and guests to select a kiosk on their physical device and make reservations.
...
8.  After configuring the kiosk map, kiosk operators can bind or assign the kiosk to a device for employees and guests to make workplace reservations.
    ...
    For more information, see [Setup a kiosk on a physical device for reservations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-services-kiosk/kiosk-setup-rsv-space.md).

    For more information, see [Make workplace reservations on the kiosk](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-services-kiosk/rsv-space-kiosk-map.md).
