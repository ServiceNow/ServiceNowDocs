...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-services-kiosk/using-kiosk-indoor-map.html
release: yokohama
...
-   Pan, rotate, or zoom the map based on your requirement.You can select the reset camera button \[Omitted image "wsd-kiosk-reset-camera.png"\] Alt text: Reset camera icon. to reset the map to its default position.
-   Select a different building or floor to browse the relevant map.
