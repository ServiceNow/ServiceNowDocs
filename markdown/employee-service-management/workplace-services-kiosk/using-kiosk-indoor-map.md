...
-   Pan, rotate, or zoom the map based on your requirement.You can select the reset camera button ![Reset camera icon.](../images/wsd-kiosk-reset-camera.png) to reset the map to its default position.
