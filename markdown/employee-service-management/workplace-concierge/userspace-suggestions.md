...
**Note:** Administrators don't have to configure or make updates to this table record. The data in this table is prefilled automatically based on employee presence and workplace preferences data.
...
System ID of the default Reservable module that is used. For example, Desks Reservable module.
