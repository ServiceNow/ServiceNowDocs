...
6.  Create a custom header for the embedded portal after you configure your custom portal.
    ...
    For more information on adding header configuration, see [Configure HTTP response headers](https://www.servicenow.com/docs/access?context=configure-http-response-header&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
