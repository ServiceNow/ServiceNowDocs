...
For more information, see [Modify dictionary entries](https://www.servicenow.com/docs/access?context=t_ModifyADictionaryEntryFromAForm&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
...
-   [Configuring navigation tabs in AI Search](https://www.servicenow.com/docs/access?context=config-nav-tabs-ais&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US)
-   [Search sources](https://www.servicenow.com/docs/access?context=search-sources-ais&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US)
