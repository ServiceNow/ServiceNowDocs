...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/localize-manifest-file.html
release: yokohama
...
# Translate the Microsoft Teams manifest file

ServiceNow for Microsoft Teams supports localization to multiple languages, using UTF-8 for international characters.

You must activate the localized plugins in your instance. To install the language plugin, see [Activate a language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/system-localization/t_ActivateALanguage.md).
