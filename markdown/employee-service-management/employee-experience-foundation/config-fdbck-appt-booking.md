...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/config-fdbck-appt-booking.html
release: yokohama
 ...
 **Note:** You can select one or both portals based on your requirement.
    ...
    You can fill in the remaining fields based on your preference. For a description of the field values, see [Feedback definition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/fdbck-dfnition-record.md).
