...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/web-configure-favorites-admin-mobile.html
release: yokohama
...
2.  Edit the mobile UI rules to suit your needs.
    ...
    See [Mobile UI Rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/mobile/create-mobile-ui-rule.md) and configure the following field values.
...
3.  Create a function and function instance to suit your needs.
    ...
    See [Create a function and function instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/now-mobile-employee-experience/add-quick-action.md) and configure the following field values.
...
[Mobile plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/mobile/sg-mobile-plugins.md)
