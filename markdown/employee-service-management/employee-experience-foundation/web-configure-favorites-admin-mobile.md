...
2.  Edit the mobile UI rules to suit your needs.
    ...
    See [Mobile UI Rules](https://www.servicenow.com/docs/access?context=create-mobile-ui-rule&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US) and configure the following field values.
...
[Mobile plugins](https://www.servicenow.com/docs/access?context=sg-mobile-plugins&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US)
