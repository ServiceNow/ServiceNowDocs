...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/config-defer-load-widget-instance-options.html
release: zurich
...
3.  Configure the instance options.
    ...
    \[Omitted image "defer-homepage-instance.png"\] Alt text: Instance option fields and description
...
-   **Popular topics**: During high-traffic, the widget displays the message.
    ...
    For more information, see [Popular topics widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/config-popular-topics.md).
...
[Defer load in Employee Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/ec-load-expe-defer-load.md)
