...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/config-defer-load-widget-instance-options.html
release: yokohama
...
breadcrumb: [High-traffic experience, Portal performance optimization, Setup Employee Center browse experience features, Configure, Employee Center, Unified Employee Experience, Employee Service Management]
---
...
-   **Popular topics**: During high-traffic, the widget displays the message.
    ...
    For more information, see [Popular topics widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/config-popular-topics.md).
...
[Defer load in Employee Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/ec-load-expe-defer-load.md)
