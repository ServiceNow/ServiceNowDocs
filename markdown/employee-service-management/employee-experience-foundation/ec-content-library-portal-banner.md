...
![](../images/ec-rich-text-content.png)
...
8.  Or, select **Save and continue** to save the record and move to the **Publish** tab.
    ...
    To request your content to be translated into a different language, select the **Translate content** button at the top. This button only appears when the sn\_cd.enable\_localization\_framework\_integration system property is activated. For more information, see [Properties installed with Content Publishing](../reference/properties-with-content-delivery.md) and [Integration with Localization Framework](../concept/ec-int-localization-framework.md).
