...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/mnge-content-topics.html
release: yokohama
...
-   [Run the scheduled job for content association](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/schduld-job-link-cntnt.md) and [Check for updated content in categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/may-associate-updated-content-categories-topics.md) for manual checking and updation of each record.
-   [Enable connected content autosync system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/may-system-properties-taxonomy-autosync.md) for autosync.
...
4.  You can perform the following content actions:
    ...
    2.  Go to **Category** and the related list **Catalog Item** &gt; **Actions on selected rows** &gt; **Delete** to remove the record.
        ...
        \[Omitted image "image.category-delete-content"\] Alt text: catalog item removal

5.  [Run the scheduled job for content association](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/schduld-job-link-cntnt.md) to surface the unconnected content of categories.
...
-   **[Run the scheduled job for content association](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/schduld-job-link-cntnt.md)**  
...
-   **[Check for updated content in categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/may-associate-updated-content-categories-topics.md)**  
Track and manage the updated content in categories for better visibility, content maintenance, and performance.

**Parent Topic:**[Taxonomy and connected content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/track-new-content.md)
