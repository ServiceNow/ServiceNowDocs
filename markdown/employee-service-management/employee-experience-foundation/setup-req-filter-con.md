...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/setup-req-filter-con.html
release: xanadu
...
5.  On the Request filter conditions form, fill in the fields, and select **Submit**.
    ...
    For a description of the field values, see [Request filter condition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/filter-cond-form-req.md).
