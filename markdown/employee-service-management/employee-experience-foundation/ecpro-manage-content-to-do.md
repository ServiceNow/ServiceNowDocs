...
description: You can assign tasks to your employees that prompts your employees to take action. You can also have the to-do as part of a campagin or trigger additional content once a task is completed. To-dos can also be sent via email.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/ecpro-manage-content-to-do.html
release: yokohama
...
breadcrumb: [To-do content, Creating employee communications, Managing employee communications, Configure, Employee Center Pro, Unified Employee Experience, Employee Service Management]
---
...
5.  Fill in the form.
    ...
    For more information on each field, see [To-do content form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/to-do-content-form.md).

6.  Select **Submit** or **Save**.

    The Schedule Content related list appears. For more information on scheduling your content, see [Scheduling the delivery of content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/ecpro-schedule-content.md).
