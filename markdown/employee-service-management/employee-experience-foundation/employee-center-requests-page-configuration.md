...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/employee-center-requests-page-configuration.html
release: xanadu
...
To learn more, including how to configure the view for the subject person of an HR case, see [HR Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/hr-service-delivery/c_HRCaseManagement.md).
