...
breadcrumb: [Employee Center Pro Kiosk overview, Unified Employee Experience, Employee Service Management]
---

# Use Employee Center Pro Kiosk
...
-   View the shift and time off information.
-   Raise requests about health, profile updates, and other services.
-   Send the required information to self as an SMS or email.

## How Send to self works
