...
[Configure eligible users for org chart](../task/config-eligible-users-orgchart.md)

[Configure card settings for org chart](../task/ecpro-new-org-chart-card-config.md)
