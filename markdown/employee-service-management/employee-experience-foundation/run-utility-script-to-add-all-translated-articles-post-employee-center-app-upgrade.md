...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/run-utility-script-to-add-all-translated-articles-post-employee-center-app-upgrade.html
release: xanadu
...
breadcrumb: [Translated Knowledge Base article attachment behaviour, Dynamic topic pages, Setup browse experience features, Configure, Employee Center, Employee Service Management]
---
...
Link all unassociated translations of Knowledge Base articles to their respective topics after upgrading the Employee Center app to the latest version of San Diego or Rome.
