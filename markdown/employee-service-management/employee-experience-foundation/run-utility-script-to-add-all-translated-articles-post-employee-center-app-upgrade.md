...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/employee-experience-foundation/run-utility-script-to-add-all-translated-articles-post-employee-center-app-upgrade.html
release: australia
