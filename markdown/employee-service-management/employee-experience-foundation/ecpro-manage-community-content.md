...
-   A forum to post community content. For information on creating forums, see [Configure community forums](https://www.servicenow.com/docs/access?context=configure-forums-topics&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
 ...
 **Note:** For more information on community content types, see [Community content types](https://www.servicenow.com/docs/access?context=c_communities-content-types&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
