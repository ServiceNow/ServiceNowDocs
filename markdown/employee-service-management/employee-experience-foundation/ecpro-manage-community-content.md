...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/ecpro-manage-community-content.html
release: yokohama
...
breadcrumb: [Employee Forums, Creating employee communications, Managing employee communications, Configure, Employee Center Pro, Unified Employee Experience, Employee Service Management]
---
...
-   A forum to post community content. For information on creating forums, see [Configure community forums](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/communities/configure-forums-topics.md).
 ...
 **Note:** For more information on community content types, see [Community content types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/communities/c_communities-content-types.md).
...
-   vimeo.com
-   youtube.com
 For more information on video content, see [Add or modify links to other content sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/ecpro-manage-link-content.md).
...
-   Go to Schedule Content to define the audience, date, and time your content is available. For more information, see [Scheduling the delivery of content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/ecpro-schedule-content.md).

    **Note:** If you edit published forum content, you must create a new Schedule content record to publish the updates.

-   Or, go to Campaign Content to add your content to a campaign bundle. For more information, see [Create campaign bundles/stages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/ecpro-manage-campaign-bundles.md).
