...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/ecpro-audience.html
release: xanadu
...
|For|Use case|
|---|--------|
|Portal content|Defines the conditions or criteria that a user must meet to see content in the portal. See [Scheduling the delivery of content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/ecpro-schedule-content.md) for more information.|
