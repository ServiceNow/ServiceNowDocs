...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/ex-fdback-ovrvw.html
release: xanadu
...
-   Configure the experience feedback drawer widget to provide feedback in various formats like, experience, numeric value feedback, or star rating feedback. For more information on configuring feedback definition, see [Set up the feedback definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/config-feedback-dfnition.md).
-   Avail the star rating and the numeric value rating in Experience feedback predefined with Employee Center version 35.0.
-   For a description of the field values in the feedback definition form, see [Feedback definition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/fdbck-dfnition-record.md).
...
-   [Resolve a feedback task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/resolve-feedback-task.md)
-   [Feedback task notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/fdbck-task-notification.md)
