...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/gss-guided-help-config.html
release: yokohama
...
Option to make the GSS unavailable for.
    ...
    **Note:** By default, only sn\_hr\_sp.esc\_admin user role can add GSS to the topics and topic persona users \(such as Topic Managers and Contributors\) can't add GSS to the assigned topics.
    ...
    \[Omitted image "gss-guided-helpconfig.png"\] Alt text: gss-guided-self-service-process-topic-selection
...
[Associate Guided Self-Service Process to a topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/associate-gss-guided-process-to-topic.md)
