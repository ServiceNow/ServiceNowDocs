...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/ecpro-content-analytics-tracking-setup.html
release: xanadu
...
5.  Then replace PROFILE\_NAME with the profile you want to use for tracking.
    ...
    For more information, see [Configure a portal header menu](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/configure-header-menu.md).
...
6.  If you are using a different header, add the following to the Body HTML and replace PROFILE\_NAME:
    ...
    To track Employee Center events, add cdaAnalytics service to your custom widgets. See [Widget developer guide](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/widget-dev-guide.md).
