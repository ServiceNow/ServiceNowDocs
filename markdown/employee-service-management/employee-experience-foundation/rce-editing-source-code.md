...
-   **Ensure portal security**
    ...
    When you click **Apply** in the Edit code window, the code editor removes HTML tags that could be used to compromise your instance. For more information, see [HTML sanitizer](https://www.servicenow.com/docs/access?context=c_HTMLSanitizer&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
