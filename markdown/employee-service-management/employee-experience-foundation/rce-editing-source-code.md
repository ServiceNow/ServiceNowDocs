...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/rce-editing-source-code.html
release: xanadu
...
-   **Ensure portal security**
    ...
    When you click **Apply** in the Edit code window, the code editor removes HTML tags that could be used to compromise your instance. For more information, see [HTML sanitizer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/servicenow-ai-platform-security/c_HTMLSanitizer.md).
