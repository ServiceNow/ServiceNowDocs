...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/enable-user-criteria-topics.html
release: yokohama
...
3.  Configure the topic form, see [Topic form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/topic-form.md).
...
Create child topics for the parent topic. For more information, see [Create a child topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/create-child-topics-for-parent.md). Go to the tabs to associate the topic appropriately. Child topics inherit the user criteria of the parent topic however admin can update the child-topic criteria separately as per business needs.
