...
For more information, see [Understanding Employee Center plugins](install-plugins.md).
...
The Content request appears on the Content request item due date. For more information, see [Managing content requests with Content Governance](ec-content-governance.md).
