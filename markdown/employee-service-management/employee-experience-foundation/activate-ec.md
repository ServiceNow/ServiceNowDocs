...
4.  Check the **Load demo data** check-box to include the demo data along with your install or repair your install with demo data checked.
    ...
    **Note:** Dependent plugin demo data is not automatically installed. To use demo data, repair the plugins with demo data checked. See [Repair a ServiceNow application](https://www.servicenow.com/docs/access?context=repair-app&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
