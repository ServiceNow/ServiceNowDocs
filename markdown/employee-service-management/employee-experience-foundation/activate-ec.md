...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/activate-ec.html
release: yokohama
...
breadcrumb: [Migrate to Employee Center from Service Portal, Admin configurations, Configure, Employee Center, Unified Employee Experience, Employee Service Management]
---
...
4.  Check the **Load demo data** check-box to include the demo data along with your install or repair your install with demo data checked.
    ...
    **Note:** Dependent plugin demo data is not automatically installed. To use demo data, repair the plugins with demo data checked. See [Repair a ServiceNow application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/repair-app.md).
