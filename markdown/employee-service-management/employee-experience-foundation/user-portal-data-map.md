...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/user-portal-data-map.html
release: yokohama
...
\[Omitted image "image.mm-user-portal-data-map"\] Alt text: Illustrative image for the user portal data map session data
