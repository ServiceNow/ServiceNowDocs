...
See [Next Experience keyboard shortcuts](https://www.servicenow.com/docs/access?context=next-experience-keyboard-shortcuts&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US) for additional information.
