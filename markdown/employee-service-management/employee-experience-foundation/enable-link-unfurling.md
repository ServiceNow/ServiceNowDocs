...
![Adaptive card](../images/adaptive-card-generic-sn-link.png)
...
-   **[Enable link unfurling](../task/unfurl-links.md)**  
Enable link unfurling in the manifest file to preview the content of the link shared in the chat conversations.
-   **[Configure the system property to open the unfurled links](../task/configure-links-chat-conversations.md)**  
