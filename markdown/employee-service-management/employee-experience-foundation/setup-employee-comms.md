...
3.  Customize the out-of-the-box widgets \(optional\):
    ...
    For information on translating custom widgets, see [Translate a client script message](https://www.servicenow.com/docs/access?context=t_TranslateAClientScriptMessage&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US)
