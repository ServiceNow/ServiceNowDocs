...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/ec-rich-content-editor-table.html
release: yokohama
...
Use the up and down arrows to adjust the radius of the border. Just like the width and height, you can choose the unit of measure you prefer by selecting the single down arrow key to the left of the up and down arrows.
    ...
    \[Omitted image "rce-table-settings.png"\] Alt text: Select options to use and create tables
