...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/download-manifest-file-mt.html
release: yokohama
...
7.  Configure the Virtual Agent in your instance.
    ...
    For more information, see [Conversational Integration with Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/conversational-interfaces/virtual-agent/teams-conv-integration.md).
...
You must upload the manifest file in Microsoft Teams. For more information, see [Upload manifest file in Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/upload-manifest-ms-teams.md).
