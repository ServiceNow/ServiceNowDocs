...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/config-topic-search-relevance.html
release: zurich
...
1.  Understand the basics of search events and suggestions from [Analyze search relevancy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/improve-search-results.md).
