...
6.  On the theme page, Edit **CSS variables** information to customize other settings such as primary and background colors.
    ...
    For more information on the theme fields and description, see [Create a portal theme](https://www.servicenow.com/docs/access?context=c_CustomCSS&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
