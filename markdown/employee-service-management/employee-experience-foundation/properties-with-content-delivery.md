...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/properties-with-content-delivery.html
release: zurich
...
Indicates you want to be able to enable audience ownership within Content Publishing.For more information, see [Content Ownership](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/ecpro-content-restriction.md).
...
Indicates you want to be able to enable content item ownership within Content Publishing.For more information, see [Content Ownership](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/ecpro-content-restriction.md).
...
**Note:** Other users that have access to the content can view the content scheduled to the restricted topic, but cannot remove the topic from the schedule.
 ...
 For more information, see [Content Ownership](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/ecpro-content-restriction.md).
...
|----------|-----------|-------------|
|sn-cd.activate\_content\_snapshots|Select the checkbox to enable Content Versioning for the Content Library. See [Content versioning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/ec-content-versioning.md)|Yes|
...
The amount of time between events when a scheduled job runs. Staggering provides time for the events to be processed during the staggered time.
...
|----------|-----------|-------------|
|sn\_cd.todo.max\_run\_time|The maximum run time in seconds for the Content Publishing: Create To-dos scheduled job. When the job finishes running, any current items are still processed after the elapsed time.|Max run time in seconds is 600|
|sn\_cd.todo.event\_stagger|The number of seconds between events.|Number of seconds to stagger events is 60|
|sn\_cd.todo.max\_events|The maximum number of events that are queued per scheduled job run.|Max number of events to queue is 50|
|sn\_cd.todo.max\_users\_per\_event|The maximum number of users that can be added per event.|Max number of users to add per event is 1000|
|sn\_cd.todo.max\_assignees|The maximum number of people you can assign to a task.|Man number of assignees allowed per task is 50,000|
...
Allows you to change your system setting language in the Content Library.When you turn this system property on, the **Switch language** button appears after creating content from the Content Library.
 ...
 For more information, see [Portal content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/ec-streamline-content.md).
...
|Properties|Description|Default Value|
|----------|-----------|-------------|
|The number of seconds to wait before timing out a video content provider subflow \(sn\_cd.provider\_timeout\)|Sets the period of time that the Employee Center attempts to connect to the video content provider. See [Video hosting integrations framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/content-providers.md)|20 seconds|

|Properties|Description|Default Value|
|----------|-----------|-------------|
|Allow comments \(sn\_cd.allow\_comments\)|Displays a checkbox in the new content and content template forms for content managers to allow employees to comment on news articles|Yes|
|Allow replies to comments \(sn\_cd.allow\_replies\_to\_comments\)|Displays a checkbox in the new content and content template forms for content managers to allow employees to reply to comments on news articles|Yes, but currently unused|
|Allow reactions \(sn\_cd.allow\_reactions\)|Displays a checkbox in the new content and content template forms for content managers to allow employees to select a reaction icon|Yes|
|Show view count \(sn\_cd.show\_views\)|Displays the number of unique views for a news article at the top of the article|Yes|
