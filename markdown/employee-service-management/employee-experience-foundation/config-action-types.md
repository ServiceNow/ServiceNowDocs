...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/config-action-types.html
release: yokohama
...
4.  On the form, fill in the fields.
    ...
    |Server script|Server scripts run on the server.|
