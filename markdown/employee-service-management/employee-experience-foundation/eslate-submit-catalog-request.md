...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/eslate-submit-catalog-request.html
release: zurich
...
1.  In the chat, describe the item you need in plain language.

    For example, enter `Need access to Adobe application`.

    The assistant identifies the catalog item that matches the request and returns it with source links and citations.

2.  Review the catalog item and citations in the chat response.
...
5.  Review the order details and submit the request by selecting **Checkout**.
