...
1.  Set up the UKG spoke.
    ...
    -   The schedule and time off data on the Employee Center Pro kiosk is enabled with the existing UKG spoke actions.
        ...
        -   **Get Employee Accruals by Person Number**: To get the time off balance data.
            ...
            For more information on creating requests, see [Create request as manager using the catalog item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/kronos-serv-cat.md).
