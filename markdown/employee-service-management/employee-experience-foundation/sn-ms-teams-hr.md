...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/sn-ms-teams-hr.html
release: yokohama
...
The HR Service Delivery integration with Microsoft Teams application extends the [Now Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/conversational-interfaces/virtual-agent-landing-page.md) integration and includes the following additional capabilities:
...
1.  [Install HR Service Delivery integration with Microsoft Teams application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/install-hr-ms-teams-plugin.md)
