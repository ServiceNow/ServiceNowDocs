...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/check-company-news-using-nowassist-va.html
release: zurich
...
Check your local or company news at any time. Search for the upcoming events or know details of a specific event. The AI Agent provides you with the latest news and announcements. It responds to both general and vague questions.

The agent displays news based on your location and your interests. It displays your nearby events, local news stories, news about relevant people and also any topic of your interest.
...
**Note:** You can check the company news and events using the Virtual agent only if your company has enabled the configuration.
