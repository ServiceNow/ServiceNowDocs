...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/topic-facets.html
release: yokohama
...
breadcrumb: [AI Search for Curated Experiences, Setup search experience, Configure, Employee Center, Unified Employee Experience, Employee Service Management]
---
...
-   The base system facet levels available are two. You can add up to 10 levels.
    ...
    For more information on adding facet levels, see [Configure search by the topic facets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/config-facets.md).
