...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/start-request-based-chat-with-guest.html
release: yokohama
...
The guest user must be authenticated with chat access. For more information, see [Enable chat access for guest users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/enable-guest-chat-access-st.md) for self-configured app and [Enable chat access for a guest user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/enable-guest-chat-access-mt.md) for pre-published app instances.
