...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/ecpro-new-org-chart-card-config.html
release: yokohama
...
For more information on widget instance options, see [Modify the org chart widget display](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/config-orgchart-instanceoptions.md).
