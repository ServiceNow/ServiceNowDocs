...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/ecpro-new-org-chart-card-config.html
release: xanadu
...
For more information on widget instance options, see [Modify the org chart widget display](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/config-orgchart-instanceoptions.md).
