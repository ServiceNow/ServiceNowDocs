...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/config-rfy.html
release: yokohama
...
2.  Edit the portal to suit your needs.
    ...
    For more information on the portal form fields and description, see [Create a portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/service-portal/create-a-portal.md).

3.  Map the **Taxonomy** that you created or use the default **Employee** taxonomy at the portal level.

    For more information on taxonomy, see [Unified Taxonomy for Employee Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/config-taxonomy.md).
