...
breadcrumb: [Recommended for you, Customize the Employee Center with widgets, Configure your Employee Center portal, Configure, Employee Center, Employee Service Management]
---
...
2.  Edit the portal to suit your needs.
    ...
    For more information on the portal form fields and description, see [Create a portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/create-a-portal.md).
