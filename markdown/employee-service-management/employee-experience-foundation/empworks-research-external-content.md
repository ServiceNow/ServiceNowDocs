...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/empworks-research-external-content.html
release: zurich
...
Use the AI assistant to research a prospect, pull internal case studies, and generate a ready-to-send document. Complete these tasks in one conversation with opt-in access to an external large language model.
