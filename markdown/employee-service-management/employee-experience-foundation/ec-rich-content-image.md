...
3.  Click in the file picker pop-up to select an image.
    ...
    Or, if you have previously selected images, select the image from the available images on the right side of the **Select Image** pop-up.![Rich Content Editor - Image pop-up](../images/ec-rich-content-image.png)
