...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/config-mega-menu-async-load.html
release: yokohama
...
2.  Search for the following properties and click open.
    ...
    \[Omitted image "mm-sys-properties-megamenu.png"\] Alt text: Async load system properties with timeout and skeleton load
...
[Portal performance optimization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/ec-load-experience-optimization.md)

[User portal data map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/user-portal-data-map.md)
