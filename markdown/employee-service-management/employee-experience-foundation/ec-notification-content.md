...
</table>-   Configure notifications to work with an SMS service provider or configure a Twilio account. See [Configure Notify with Twilio](https://www.servicenow.com/docs/access?context=t_ConfigureNotifyWithTwilio&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
