...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/config-my-activity-instance-options.html
release: zurich
...
4.  Select **Save**.
    ...
    **Note:** The My Active Items widget does not support column sizes less than 3. If you use a column size lower than 3, the widget is not guaranteed to display correctly for all screen widths. Currently, there are no plans to improve support for smaller column sizes. We suggest you use a column size of 3 or higher moving forward.


**Related topics**  


[My active items widget configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/my-activity-config.md)
