...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/ec-rich-content-video.html
release: xanadu
...
-   Video streaming service
    ...
    **Note:** You must configure a content provider to use videos from a video streaming service. See [Video hosting integrations framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/content-providers.md).
