...
Filters what topics you can schedule your content to. Taxonomy is a collection of hierarchical topics that brings together different content types, like requests, articles, quick links, and employee communications. For example, you can set up separate taxonomies for HR and IT so you can group specific topics under each.
 ...
 For child topics to appear on your Employee Center, you must add it to the Portal form under Service Portal. For more information, see [Create a portal](https://www.servicenow.com/docs/access?context=create-a-portal&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
...
The following fields appear when **Community Content** is the content type for content selected. For more information, see [Community content types](https://www.servicenow.com/docs/access?context=c_communities-content-types&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
...
The forum you want to post the community content.For more information on forums, see [Create a forum](https://www.servicenow.com/docs/access?context=create-forum&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
...
The area of interest that users can discuss.Click to select a topic that is within the forum.
 ...
 For more information on topics, see [Create a topic](https://www.servicenow.com/docs/access?context=create-topic&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
