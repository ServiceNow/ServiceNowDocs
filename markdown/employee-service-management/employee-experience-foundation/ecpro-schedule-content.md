...
-   [Content Library](../concept/ec-streamline-content.md)
-   [Create email, SMS, or push notification content](ecpro-manage-notification-content.md)
-   [Create to-do content](../concept/ec-to-do-content.md#)
-   [Add or modify forum content](../concept/ecpro-employee-forum.md#)
...
**Note:** Ensure you schedule the portal content when you are adding a link content to a banner or styled content. The to-do content is automatically scheduled separately when the link content is scheduled. For more information, see [Creating to-do content](../concept/ec-to-do-content.md#).
...
The following fields appear when **Service Portal** is selected from the **Content location** field. For more information, see [Content Library](../concept/ec-streamline-content.md).
...
Filters what topics you can schedule your content to. Taxonomy is a collection of hierarchical topics that brings together different content types, like requests, articles, quick links, and employee communications. For example, you can set up separate taxonomies for HR and IT so you can group specific topics under each.
 ...
 For child topics to appear on your Employee Center, you must add it to the Portal form under Service Portal. For more information, see [Create a portal](https://www.servicenow.com/docs/access?context=create-a-portal&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
...
The topics you want your content to appear in under a taxonomy. For more information, see [Create and associate topics](create-topics-for-taxonomy.md).
 ...
 To display your topics in the Employee Center, see [Portal configuration](portal-config.md).
...
The following fields appear when **Community Content** is the content type for content selected. For more information, see [Community content types](https://www.servicenow.com/docs/access?context=c_communities-content-types&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
...
The forum you want to post the community content.For more information on forums, see [Create a forum](https://www.servicenow.com/docs/access?context=create-forum&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
...
The area of interest that users can discuss.Click to select a topic that is within the forum.
 ...
 For more information on topics, see [Create a topic](https://www.servicenow.com/docs/access?context=create-topic&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
