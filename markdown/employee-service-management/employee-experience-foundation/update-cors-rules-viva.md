...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/update-cors-rules-viva.html
release: xanadu
...
The REST API this CORS rule applies to.
...
The domain that this CORS rule applies to. This CORS rule is evaluated against requests from the specified domain. You can specify a domain pattern or an IP address.
