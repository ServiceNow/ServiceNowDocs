...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/x-concur-sa-integration.html
release: xanadu
...
-   Integrate [Approvals hub integration with SAP Concur](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/x-concur-sa-integration.md) with ServiceNow, create credential records, and create connection records as explained in [SAP Concur Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/sap-concur-spoke.md).
...
-   **[Manage approvals from SAP Concur](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/x-concur-approvals.md)**  
...
-   **[Populate SAP Concur report and metadata](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/x-concur-approvals-scheduled-job.md)**  
...
-   **[Use task configuration for SAP Concur approvals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/approval-hub-to-dos-page-concur.md)**  
