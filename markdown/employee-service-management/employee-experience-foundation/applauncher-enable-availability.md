...
-   [Configuring navigation tabs in AI Search](https://www.servicenow.com/docs/access?context=config-nav-tabs-ais&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) and tag **ESC Portal Default Search Application**
...
![app application and ai search results](../images/app-launcher-search-results.png "App Launcher app visibility and AI search results")
