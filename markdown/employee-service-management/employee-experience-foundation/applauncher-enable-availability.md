...
-   [Configuring navigation tabs in AI Search](https://www.servicenow.com/docs/access?context=config-nav-tabs-ais&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) and tag **ESC Portal Default Search Application**
