...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/create-notification-content-exp-builder-mt.html
release: yokohama
...
3.  On the Campaign form, fill in the fields.
    ...
    For a description of the field values, see [Campaign form in the Content Experience Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/create-notification-content-exp-builder-mt.md).
