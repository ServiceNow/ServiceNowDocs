...
-   **[Activate Company News and Events AI Agent](../task/enable-company-news-and-events-ai-agent.md)**  
Activate the Company News and Events AI Agent to enable users to check news and events in Now Assist in Virtual Agent.

**Parent Topic:**[Using AI Agents with Now Assist for Employee Experience](using-ai-agent-in-now-assist-for-empexp.md)
