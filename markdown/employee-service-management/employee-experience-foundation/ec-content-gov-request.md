...
<table id="choicetable_b4s_qgk_5tb"><thead><tr><th align="left" id="d163334e253">

Field

</th><th align="left" id="d163334e256">

Description

</th></tr></thead><tbody><tr><td id="d163334e262">
...
<table id="choicetable_tsj_lv5_x5b"><thead><tr><th align="left" id="d163334e590">

Field

</th><th align="left" id="d163334e593">

Description

</th></tr></thead><tbody><tr><td id="d163334e599">
...
**Note:** Requires integration with Notify. For more information, see [Notify](https://www.servicenow.com/docs/access?context=notify-landing-page&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).

-   Other

**Note:** The Content Manager should define what it means to select Other/Other. For example, it could be used for another type of personal communication like company chat.

</td></tr><tr><td id="d163334e714">
...
<table id="choicetable_b4s_qgk_5tb"><thead><tr><th align="left" id="d163334e974">

Field

</th><th align="left" id="d163334e977">

Description

</th></tr></thead><tbody><tr><td id="d163334e983">
 ...
 **Note:** For more information, see [Manage ownership groups](https://www.servicenow.com/docs/access?context=create-edit-ownership-group&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
<table id="choicetable_apf_2vq_5tb"><thead><tr><th align="left" id="d163334e1382">

Fields

</th><th align="left" id="d163334e1385">

Description

</th></tr></thead><tbody><tr><td id="d163334e1391">
...
6.  To schedule content, select **New** from the **Schedule Content** related list.
    ...
    -   **Create Content**
        ...
        Selecting the **Create Content** button takes you to the **Content Library** form where you can select the type of content you want to create. For more information, see [Content Library](ec-streamline-content.md).
    ...
    -   **Edit Content**
        ...
        This takes you to the content form. For more information on editing content, see [Content Library](ec-streamline-content.md).
    ...
    -   **Clone Content**
        ...
        Selecting the **Clone Content** button takes you to the content list where you can select content to clone. For more information on editing content, see [Content Library](ec-streamline-content.md).
