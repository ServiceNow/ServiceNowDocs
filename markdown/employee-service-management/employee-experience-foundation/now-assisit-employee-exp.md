...
-   Learn more about what's new and changed, see the [HR Service Delivery release notes](https://www.servicenow.com/docs/access?context=hr-service-delivery-landing&version=yokohama&pubname=yokohama-release-notes&ft:locale=en-US).
