...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/activate-notification-template.html
release: yokohama
...
-   **With layout**
    ...
    \[Omitted image "request-with-layout.jpg"\] Alt text: Notification with Email notification layout and template applied

-   **Without the layout**

    \[Omitted image "request-without-layout.jpg"\] Alt text: Notification without the Email notification layout and template
...
4.  On the **What it will contain** tab, select search and apply the `Email notification template` for **Email template**.
    ...
    \[Omitted image "apply-template-notification.jpg"\] Alt text: Apply template to notification.
...
[Configure the mail and SMS send to self](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/deskless-kiosk-sendtoself-sms-email.md)
