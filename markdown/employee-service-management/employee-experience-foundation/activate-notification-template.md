---
title: Use email notification layout
description: Use the email notification layout and template shipped with the Employee Experience Foundation \(com.snc.sn\_ex\_emp\_fd\) plugin to deliver notifications.
locale: en-US
release: xanadu
...
# Use email notification layout

Use the email notification layout and template shipped with the Employee Experience Foundation \(com.snc.sn\_ex\_emp\_fd\) plugin to deliver notifications.
...
-   **With layout**
    ...
    ![Notification with Email notification layout and template applied](../images/request-with-layout.jpg)

-   **Without the layout**

    ![Notification without the Email notification layout and template](../images/request-without-layout.jpg)
...
4.  On the **What it will contain** tab, select search and apply the `Email notification template` for **Email template**.
    ...
    ![Apply template to notificaiton](../images/apply-template-notification.jpg)

5.  Modify the email body or use it as given.

6.  Preview the notification and click **Update**.
