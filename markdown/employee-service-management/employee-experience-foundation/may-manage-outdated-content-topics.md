...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/may-manage-outdated-content-topics.html
release: yokohama
...
\[Omitted image "image.outdated-connected-content-ui"\] Alt text: See how the outdated connected content tab and interface looks
...
4.  Go to the **Outdated Connected Content** tab to use the default conditions.
    ...
    \[Omitted image "image.outdated-connected-content"\] Alt text: Outdated connected content count and default filters
...
For more information, see [Run the scheduled job for outdated content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/may-scheduled-job-content-outdated.md).

-   **[Run the scheduled job for outdated content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/may-scheduled-job-content-outdated.md)**  
