...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/create-implementation-kiosk.html
release: yokohama
...
breadcrumb: [Schedule in Employee Center Pro Kiosk, Configure, Employee Center Pro Kiosk overview, Unified Employee Experience, Employee Service Management]
---
...
4.  In the Script Include page, add the unique location sys\_id in the `this.LOCATIONS` array in **Script**.
    ...
    -   For more information on location tracking, see [Enabling and selecting location tracking options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/mobile/mobile-platform/location-tracking-enable.md).
    -   For more information on script include customizations, see [Script includes and customization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/customize-script-includes-itsm.md).
