...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/employee-experience-foundation/rfy-ec.html
release: australia
...
For more information, see [Configure the Recommended for you](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/employee-experience-foundation/config-rfy.md)

## How Recommended for you works

Administrators, developers, and advanced users can configure the widget options​. **Recommended for you** highlights the most viewed knowledge article and most requested catalog items across all employees for a time period defined in the [Modify the Recommended for you widget display](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/employee-service-management/employee-experience-foundation/config-recommended-for-you.md) by the portal administrator.
