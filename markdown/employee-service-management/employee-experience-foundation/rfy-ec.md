...
-   **[Configure the Recommended for you](../task/config-rfy.md)**  
...
-   **[Modify the Recommended for you widget display](../task/config-recommended-for-you.md)**  
...
**Parent Topic:**[Customize the Employee Center with widgets](emp-center-topic-inst-options.md)
