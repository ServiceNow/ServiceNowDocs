...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/ec-rich-content-button.html
release: xanadu
...
-   Secondary
-   Link only
 Selecting a button type pulls from your portal theme settings in order to sync with it. For more information, see [Portal configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/portal-config.md).
...
Defines the size of your button.Selecting a button size pulls from your portal theme settings in order to sync with it. For more information, see [Portal configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/portal-config.md).

 Your choices are:-   X-Small
-   Small
-   Medium \(default\)
-   Large
