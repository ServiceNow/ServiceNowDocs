...
-   Secondary
-   Link only
 Selecting a button type pulls from your portal theme settings in order to sync with it. For more information, see [Portal configuration](portal-config.md).
...
Defines the size of your button.Selecting a button size pulls from your portal theme settings in order to sync with it. For more information, see [Portal configuration](portal-config.md).
