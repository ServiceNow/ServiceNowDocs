...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/modify-news-feed-widget-display.html
release: xanadu
...
Learn more about the news widgets: [News articles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/ec-news-articles.md)
...
2.  Press and hold the control key, right-click the News feed widget, and then select **Instance Options**.
...
Option to display the news article subheadline
...
Enables employees to open other news articles from the Article detail page without refreshing the web page
