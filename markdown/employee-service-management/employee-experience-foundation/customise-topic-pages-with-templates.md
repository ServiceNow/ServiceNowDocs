...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/customise-topic-pages-with-templates.html
release: yokohama
...
Assign various topic templates based on the content after you create or clone a new topic page. For more information, see [Create and edit a page using the Service Portal Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/t_ConfigureAPage.md).
