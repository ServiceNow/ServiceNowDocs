...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/ec-direction-right-to-left-languages.html
release: yokohama
...
Understand how the UI works for a right-to-left language, see [CSS for right-to-left languages in portals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/service-portal/css-directives-right-to-left-languages.md).
...
For more information, see [Modify the Quick links widget display](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/config-quick-links-widget.md).
