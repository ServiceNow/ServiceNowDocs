...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/config-portal-search-filters.html
release: xanadu
...
3.  On the form, fill in the fields.
    ...
    |Widget instance|The Employee Center widget instance, for example, `ESC Topic Page`. In the lookup, add filter condition \( widget=Topic content\) to filter the topic content widget instances.|
