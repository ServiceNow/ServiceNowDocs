...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/user-criteria-output.html
release: zurich
...
breadcrumb: [Configure the Employee Profile overview widget, Employee profile, Setup task management, Configure, Employee Center, Unified Employee Experience, Employee Service Management]
---
...
|-------------|-----------------|------|
|Not defined|Not defined|Accessible to all users. For more information, see [Configure the Employee Profile overview widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/config-employee-profile-widget.md)|
