---
title: Sync your applications from Microsoft Azure AD
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/web-applications-azure.html
release: xanadu
...
# Sync your applications from Microsoft Azure AD
...
-   The App Launcher synchronization of applications from Azure is compatible only with the latest Microsoft Azure AD spoke version. Ensure that you upgrade the existing Azure AD spoke to sync the apps with your web applications.
-   Azure AD integration enables your employees to access and manage pre-integrated apps.
-   Integrate Azure AD spoke with ServiceNow, create credential records, and create connection records as explained in [Azure AD spoke setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/set-up-azure.md)
...
4.  To assign the topics to the applications, see [Assign topics to web applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/web-applications-topic-assignment.md).
