...
3.  Customize the theme content to suit your requirement.
    ...
    3.  Edit the **CSS variables** field to customize the text and the background colors of your portal.
        ...
        For a description of the field values to create a portal theme, see [Create a portal theme](https://www.servicenow.com/docs/access?context=c_CustomCSS&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
...
[Configure portal branding](https://www.servicenow.com/docs/access?context=c_BrandingEditor&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
