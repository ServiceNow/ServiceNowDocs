...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/customize-theme.html
release: zurich
...
3.  Customize the theme content to suit your requirement.
    ...
    3.  Edit the **CSS variables** field to customize the text and the background colors of your portal.
        ...
        For a description of the field values to create a portal theme, see [Create a portal theme](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_CustomCSS.md).
...
[Enhanced chat in Employee Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/nass-now-assissist-self-service.md)

[Configure portal branding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_BrandingEditor.md)
