...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/add-menu-items.html
release: xanadu
...
breadcrumb: [Configure Mega menu, Setup browse experience features, Configure, Employee Center, Employee Service Management]
---
...
5.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Menu Item form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/menu-item-form.md).
