...
**Note:** For more information about **Connect**, see [Connect](https://www.servicenow.com/docs/access?context=c_Connect&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).

For HR cases, define configuration under **Conversational Interfaces**.

**Note:** For more information about **Conversational Interfaces**, see [Conversational Interfaces](https://www.servicenow.com/docs/access?context=convint-landing-page&version=australia&pubname=australia-conversational-interfaces&ft:locale=en-US) and [Setting up Agent Chat](https://www.servicenow.com/docs/access?context=ac-configure-agent-chat&version=australia&pubname=australia-conversational-interfaces&ft:locale=en-US).
