...
-   **Dotted carousel** is only supported for widgets with a width less than 900 pixels.If a head widget is less than 900 pixels, other widget styles will not be supported.
