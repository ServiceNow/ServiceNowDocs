...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/approval-hub-to-dos-page-concur.html
release: xanadu
...
breadcrumb: [Approvals hub integration with SAP Concur, Approval hub integrations, Integrate, Employee Center, Employee Service Management]
---
...
3.  Understand the configuration as explained in [Enable task configuration for approvals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/approval-hub-to-dos-page-filters.md)
...
Based on this configuration, the approvers see the in-context information about the Concur approval and process the approval. For more reference info, see [Approvals experience reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/approval-hub-ootb.md).

## What to do next

Approver users can see information and process the approvals. For more information, see [Use approval experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/ec-to-dos-use-approval-hub.md)

**Parent Topic:**[Approvals hub integration with SAP Concur](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/x-concur-sa-integration.md)
