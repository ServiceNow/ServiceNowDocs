...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/web-applications-custom.html
release: yokohama
...
</table>    For more information, see [Configure application visibility and access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/applauncher-enable-availability.md).

4.  Click **Submit**.

    The application is registered. You can proceed to associate topics suitable for the application.

5.  Follow the steps from [Assign topics to web applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/web-applications-topic-assignment.md) to assign the topics to applications.
