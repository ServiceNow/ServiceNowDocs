...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/update-ms-teams-app-id.html
release: xanadu
...
1.  Copy the App ID.
    ...
    4.  Copy the App ID.\[Omitted image "app-id.png"\] Alt text: App ID of the ServiceNow for Teams app
