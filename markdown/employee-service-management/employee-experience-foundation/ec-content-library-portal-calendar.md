...
Calender dates are configured in the ServiceNow AI Platform. For more information, see [Holidays](https://www.servicenow.com/docs/access?context=c_Holidays&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
