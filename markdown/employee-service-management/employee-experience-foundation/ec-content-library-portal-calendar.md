...
description: Using the Content Library, you can create calendar content that provide your employees with a quick way of viewing scheduled events.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/ec-content-library-portal-calendar.html
release: xanadu
...
Using the Content Library, you can create calendar content that provide your employees with a quick way of viewing scheduled events.
...
The calendar you want to appear on the Employee Center.Select the Lookup using list icon \(\[Omitted image "magnify-glass-outline-icon.png"\] Alt text: Lookup using list icon\) to view a list of link content.
    ...
    The **Schedule Content** related list displays. For information on publishing your content, see [Scheduling the delivery of content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-experience-foundation/ecpro-schedule-content.md).
