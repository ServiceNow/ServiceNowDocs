...
Calender dates are configured in the ServiceNow AI Platform. For more information, see [Holidays](https://www.servicenow.com/docs/access?context=c_Holidays&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
