...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/link-user-teams-va.html
release: zurich
...
breadcrumb: [Employee actions, Use ITSM and HRSD integrations with Microsoft Teams, Use Microsoft Teams integration for Employee Experience, Use, ServiceNow for Microsoft Teams and Microsoft 365, Unified Employee Experience, Employee Service Management]
---

# Link ServiceNow user account to Microsoft Teams application for Virtual Agent
...
4.  Select **Link to ServiceNow** to authenticate.
    ...
    **Note:**
    ...
    The administrator can auto-link the ServiceNow user accounts to Microsoft Teams. For more information, see [Account linking in pre-built messaging integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/va-adapter-autolinking.md).

5.  On the confirmation dialog, select Confirm to link your account.


**Parent Topic:**[Employee actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/employee-experience-foundation/employee-sn-ms-teams.md)
