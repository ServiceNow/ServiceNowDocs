...
1.  Activate the IT Service Management integration with Microsoft Teams plugin \(sn\_now\_teams\_it\) and Glide Virtual Agent plugin \(com.glide.cs.chatbot\).
    ...
    **Note:** For more information on activating plugins, see Activate a plugin.
...
3.  Create a bot in Microsoft Teams for GCC-H or DoD.
4.  Integrate your self-configured bot with Microsoft Teams for GCC-H or DoD.
