...
1.  Activate the IT Service Management integration with Microsoft Teams plugin \(sn\_now\_teams\_it\) and Glide Virtual Agent plugin \(com.glide.cs.chatbot\).
    ...
    **Note:** For more information on activating plugins, see [Activate a plugin](https://www.servicenow.com/docs/access?context=t_ActivateAPlugin&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
...
3.  [Create a bot in Microsoft Teams for GCC-H or DoD](https://www.servicenow.com/docs/access?context=create-msteams-bot-gcch&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
4.  [Integrate your Self-configured bot with Microsoft Teams for GCC-H or DoD](https://www.servicenow.com/docs/access?context=link-msteams-bot-snow&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
