...
The e-signature template used with the e-signature content type. **Note:** For more information, see [Configure an e-signature template](https://www.servicenow.com/docs/access?context=configure-e-signature-configuration&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
