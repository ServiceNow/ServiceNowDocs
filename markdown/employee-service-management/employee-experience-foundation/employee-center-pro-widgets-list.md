...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/employee-experience-foundation/employee-center-pro-widgets-list.html
release: yokohama
...
Delivers targeted, actionable communications to employees. For more information, see [Creating campaigns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/ecpro-campaigns.md).
...
|Widget|ID|Description|
|------|---|-----------|
|Kiosk Header|eck-header|Appears across the kiosk portal and provides quick access to My requests, My favories, Employee profile, and so on.|
|Employee Center Pro Kiosk Portal login|ec-pro-kiosk-portal-login|Enables the login and access to the kiosk portal.|
|Employee Upcoming Shift|employee-upcoming-shift|Shows upcoming events.|
|Timeoff Accrual Balance|timeoff-accrual-balance|Shows the time off and leave balances.|
...
For more information, see [Employee Center Pro Kiosk overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/deskless-kiosk-overview.md).

For more information on configuring widgets, see [Customize Employee Center Pro Kiosk widgets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/emp-center-topic-inst-options.md).

**Parent Topic:**[Employee Center Pro reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-experience-foundation/emp-center-pro-reference.md)
