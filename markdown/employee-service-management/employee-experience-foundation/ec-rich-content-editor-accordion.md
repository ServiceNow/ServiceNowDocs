...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/ec-rich-content-editor-accordion.html
release: xanadu
...
12. View the canvas components and property panel for style and setting options.

    \[Omitted image "rce-accordion-title.png"\] Alt text: Basic Accordion and components view

    \[Omitted image "rce-accordion-property-panel.jpeg"\] Alt text: Basic view of the Accordion property panel with style and setting options

    Use the components, properties, styling and settings to customize Accordion.
