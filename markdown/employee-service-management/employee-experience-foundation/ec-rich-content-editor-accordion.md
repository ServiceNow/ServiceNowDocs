...
12. View the canvas components and property panel for style and setting options.
    ...
    ![Basic Accordion and components view](../images/rce-accordion-title.png "Accordion view")

    ![Basic view of the Accordion property panel with style and setting options](../images/rce-accordion-property-panel.jpeg "Accordion property panel")
