...
[Activate Communities plugins](https://www.servicenow.com/docs/access?context=activate-communities&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US)
...
</table>For more information, see the [List of plugins \(Yokohama\)](https://www.servicenow.com/docs/access?context=list-of-plugins&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
