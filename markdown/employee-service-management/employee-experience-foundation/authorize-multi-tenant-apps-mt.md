...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/employee-experience-foundation/authorize-multi-tenant-apps-mt.html
release: zurich
...
Install Virtual Agent Lite or Virtual Agent. For more information see [Virtual Agent integration with messaging apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/va-integration-messaging-apps.md).
