...
-   Integrate Okta spoke with ServiceNow, Inc., create credential records, and create connection records as explained in [Okta spoke setup](https://www.servicenow.com/docs/access?context=okta-v2-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
