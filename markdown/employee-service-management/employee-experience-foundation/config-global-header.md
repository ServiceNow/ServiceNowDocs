...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/employee-experience-foundation/config-global-header.html
release: xanadu
...
Shows the additional menu items that you want to add.**Note:** Add any new menu items to the EC Header under the **More** option. Currently, Filtered or Scripted menu items are not supported as Filtered or Scripted List must be top-level Menu Items.
