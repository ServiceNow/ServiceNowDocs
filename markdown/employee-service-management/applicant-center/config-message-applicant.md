...
4.  Add conditions to enable the messaging functionality for the applicants.
    ...
    For a description of the field values, see [Configure the standard ticket page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/configure-st-page.md).
