...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/applicant-center/config-message-applicant.html
release: zurich
...
4.  Add conditions to enable the messaging functionality for the applicants.
    ...
    For a description of the field values, see [Configure the standard ticket page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/configure-st-page.md).
