...
Before getting started, see the reference information available at [SharePoint Online Search Connector reference](../reference/sharepoint-reference.md), SharePoint Online Search Connector KB articles, and known issues.
