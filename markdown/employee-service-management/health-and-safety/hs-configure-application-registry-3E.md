...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/health-and-safety/hs-configure-application-registry-3E.html
release: australia
...
2.  Search and select **3E SDS provider**.

3.  From the application scope notification, select **here** to edit the registry record.

4.  In the **Client ID** and **Client secret field**, enter the credentials provided by 3E service provider.
