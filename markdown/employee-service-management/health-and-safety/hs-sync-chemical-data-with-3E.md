...
description: You can sync details of chemicals, such as hazard identification, chemical ingredients, and others, with the 3E database to verify that current information is accessible.
locale: en-US
release: australia
...
4.  On any of the related lists, select the **More actions** \(![more actions icon](../../human-resources/image/agent-workspace-more-ui-actions-icon.jpg)\) icon.
