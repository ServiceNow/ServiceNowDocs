...
<table id="choicetable_znq_p3r_dcc"><thead><tr><th align="left" id="d340770e62">

Option

</th><th align="left" id="d340770e65">

Steps

</th></tr></thead><tbody><tr><td id="d340770e71">
...
-   The JSA is also listed in the JSAs list on Health and Safety Workspace. A risk manager \[sn\_hs\_rm.jsa\_manager\] can view all the filed JSAs by navigating to the Health and Safety Workspace and selecting the JSAs icon \(![JSAs icon](../../hs-risk-management/image/icon-jsa.png)\).
