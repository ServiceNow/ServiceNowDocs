...
5.  Tap the **Related lists** tab and then tap **Root cause analysis**.
    ...
    1.  To modify an existing root cause analysis record,
        ...
        -   Open the root cause analysis record and tap **More options** icon ![more options](../../wsd-for-mobile/images/wsd-more-options-icon-loc-directory.png) then tap edit or delete.
