...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety/hs-configure-approver-by-location.html
release: yokohama
...
breadcrumb: [Configure the chemical request approval flow, Configure settings, Health and Safety Environmental Management, Health and Safety, Employee Service Management]
---
...
**Parent Topic:**[Configure the chemical request approval flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety/hs-modify-approval-flow-environmental-mgmt.md)
