---
title: Generate an annual OSHA 300 or 300A form
description: Generate an annual 300 or 300A OSHA form for all OSHA recordable injuries and illnesses that happened in an establishment between January 1 and December 31 of a calendar year.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/health-and-safety/generate-osha-annual-form.html
release: xanadu
...
# Generate an annual OSHA 300 or 300A form
...
The OSHA 300 and 300A forms are generated per establishment per year.

The system uses the saved PDF templates for OSHA 300 and 300A forms and fills them with the values from the recordable injury and illness reports.
...
Type of OSHA form.-   **300**: Log of all work-related injuries and illnesses.
-   **300a**: Summary of all work-related injuries and illnesses.
...
-   The OSHA form is generated based on the selected form type and the saved PDF template for 300 and 300A OSHA forms.
-   The PDF template is automatically filled with the values from the recordable injury and illness reports.
...
You can view the saved OSHA form by navigating to the **Establishments** list. For more information, see [View a saved OSHA 300 and 300A form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety/view-osha-annual-forms.md).
