...
5.  Tap the **Related lists** tab and then tap **Injury and illness**.
    ...
    1.  To modify an existing injury and illness record,
        ...
        -   Open the injury and illness record and tap **More options** icon ![more options](../../wsd-for-mobile/images/wsd-more-options-icon-loc-directory.png), then tap edit or delete.
