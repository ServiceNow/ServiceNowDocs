...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety/hs-modify-approval-flow-environmental-mgmt.html
release: yokohama
...
The approval flows are built on [Flow Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/building-applications/flow-designer.md). Before modifying, make sure that you're familiar with the basics of ServiceNow® Workflow Studio.
...
-   **[Configure the chemical request approver based on location](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety/hs-configure-approver-by-location.md)**  
...
**Parent Topic:**[Setting up Health and Safety Environmental Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/health-and-safety/hs-setting-up-environmental-management.md)
