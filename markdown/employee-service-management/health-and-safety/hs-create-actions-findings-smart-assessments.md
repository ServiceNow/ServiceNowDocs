...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety/hs-create-actions-findings-smart-assessments.html
release: yokohama
...
# Create actions or findings for the smart assessment questionnaire
...
The actions or finding that are created for the inspections and audits through the Mobile Agent app gets synced with the workspace.
...
8.  Complete the **Action input** form.
