...
5.  Tap the **Related lists** tab and then tap **People involved**.
    ...
    1.  To modify an existing people involved record,
        ...
        -   Open the people involved record and tap **More options** icon ![more options](../../wsd-for-mobile/images/wsd-more-options-icon-loc-directory.png), then tap edit or delete.
