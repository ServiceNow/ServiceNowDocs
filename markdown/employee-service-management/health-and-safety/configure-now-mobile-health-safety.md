...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/health-and-safety/configure-now-mobile-health-safety.html
release: xanadu
...
1.  Download the following mobile apps for the iOS platform from the Apple App Store or for the Android platform from the Google Play Store.
    ...
    -   ServiceNow Agent mobile app for conducting inspection and audit surveys offline.
        ...
        For more information on using this mobile app, see [Mobile Agent app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/mobile/mobile-platform/mobile-experience.md) app.
