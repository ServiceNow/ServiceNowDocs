...
For information on how the offline mode works in the mobile app, see [Offline mode for mobile](https://www.servicenow.com/docs/access?context=offline-end-user&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US).
