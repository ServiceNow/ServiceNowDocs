...
You can also generate a report for an injury and illness by directly uploading your regional or industry-specific reporting PDF templates into the application. For more information, see [Create a safety report field mapping](../task/create-safety-report-field-mapping.md) and [Generate a report for a safety incident, observation, or injury](../task/generate-report-safety-incident-obsv-injury.md).
