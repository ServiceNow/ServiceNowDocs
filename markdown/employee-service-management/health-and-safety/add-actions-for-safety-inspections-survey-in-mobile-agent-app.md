...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/health-and-safety/add-actions-for-safety-inspections-survey-in-mobile-agent-app.html
release: xanadu
...
-   The offline mode for the Mobile Agent app on your mobile device is turned on. For more information, see [Offline mode for Mobile Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety/hs-health-safety-mobile.md).
...
For more information on how offline mode works in the mobile app, see [Offline mode for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/mobile/mobile-platform/offline-end-user.md).
...
<table id="choicetable_adf_tqn_lfc"><thead><tr><th align="left" id="d335849e147">

Section

</th><th align="left" id="d335849e150">

Steps

</th></tr></thead><tbody><tr><td id="d335849e156">
