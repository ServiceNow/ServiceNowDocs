...
-   You can use the **Push down** option if you want to push down the workplace entity to child locations at any time. For more information about how an allocation works, refer to [Allocation - types, setting, and impact](../../workplace-space-management/reference/setting-an-allocation-and-its-impact.md).
