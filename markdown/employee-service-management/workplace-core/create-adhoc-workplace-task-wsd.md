...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-core/create-adhoc-workplace-task-wsd.html
release: yokohama
...
<table id="table_m1b_33c_qlb"><thead><tr><th>
...
Type of the workplace task. Select **Ad-hoc Task**.
...
Workplace location where the task should be performed.
...
Task signature template to use for signing off on this task when it is completed.For more information, see [Sign a completed workplace task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-core/sign-completed-task-wsd.md).
...
User group assigned to the task.
...
Vendor whose employees should perform the task.
...
Brief description of the ad hoc task.
