...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-core/create-adhoc-workplace-task-wsd.html
release: zurich
...
Task signature template to use for signing off on this task when it is completed.For more information, see [Sign a completed workplace task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-core/sign-completed-task-wsd.md).
