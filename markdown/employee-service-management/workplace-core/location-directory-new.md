...
1.  [Configure map properties for Location Directory](../task/configure-map-properties-location-directory.md)  
...
2.  [Work with the Map view on the Location Directory](../task/wsd-map-view-loc-directiory.md)  
...
3.  [Work with the Card view on the Location directory](../task/wsd-card-view-loc-directory.md)  
