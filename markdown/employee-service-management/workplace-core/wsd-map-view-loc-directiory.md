...
3.  From the **Support resources** section, select **Location directory**.
    ...
    Your location is displayed with a location pin \(![Location pin that shows the selected location on the map.](../images/wsd-location-pin-icon.png)\).
