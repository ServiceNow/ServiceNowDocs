...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-core/wsd-map-view-loc-directiory.html
release: yokohama
...
For more information, see [Configure map properties for Location Directory](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-core/configure-map-properties-location-directory.md).
...
13. Select a space on the map to view the Space card details.
    ...
    3.  Select **Get Directions** for wayfinding and navigating to a meeting room or to where your co-worker is seated.
        ...
        \[Omitted video\] Description: Wayfinding using Location Directory.
