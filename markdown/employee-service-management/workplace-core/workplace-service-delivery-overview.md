...
-   **Workplace Case Management**
    ...
    As a case manager, you can manage the requests raised by the employees in the form of workplace cases. You can create task, sub-tasks a s per requirement and perform various other actions. For more information, refer to [Workplace Case Management](../../workplace-case-mgmt/concept/workplace-case-mgmt-feat.md).
