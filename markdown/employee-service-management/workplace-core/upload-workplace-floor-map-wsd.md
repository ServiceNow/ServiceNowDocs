...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-core/upload-workplace-floor-map-wsd.html
release: zurich
...
-   Set the **com.glide.attachment.max\_get\_size** property to a size that is greater or equal to the dxf.json file size. For more information, see [Administering attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/r_AdministeringAttachments.md).
