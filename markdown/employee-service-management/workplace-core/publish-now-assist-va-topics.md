...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/workplace-core/publish-now-assist-va-topics.html
release: xanadu
...
-   Now Assist for HR Service Delivery \(HRSD\)
    ...
    For more information about the application, see [Now Assist for HR Service Delivery \(HRSD\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/now-assist-for-hrsd/now-assist-hrsd.md).

-   Workplace Reservation Management

    For more information about the application, see [Workplace Reservation Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-reservation-management/workplace-rsv-mgmt-feat.md).

-   Workplace Visitor Management

    For more information about the application, see [Workplace Visitor Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-visitor-management/workplace-visitor-mgmt-feat.md)

-   Workplace Case Management

    For more information about the application, see [Workplace Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-case-management/workplace-case-mgmt-feat.md).
...
-   Use Virtual Agent to reserve a workplace item, add services, add coworkers, or invite visitors. For more information, see  [Using Now Assist in Virtual Agent topics for Workplace Service Delivery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-core/use-now-assist-in-virtual-agent-wsd.md).
