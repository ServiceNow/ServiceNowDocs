...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/set-up-vaccine-privacy.html
release: xanadu
topic_type: task
...
3.  Add all usersfrom the User \[sys\_user\] table who will be reporting their vaccination status to a Safe Workplace audience.
    ...
    2.  Add users to the audience.
        ...
        For detailed instructions about adding users to an audience, see [Add a Safe Workplace audience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-readiness-core/add-safe-workplace-audience.md).
...
4.  Configure an outreach to send the privacy consent to users.
    ...
    2.  Make any modifications to the outreach if needed, such as scheduling a time to send.
        ...
        For detailed instructions about configuring an outreach, see [Send notifications for an emergency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/send-eo-notification-outreach.md).
