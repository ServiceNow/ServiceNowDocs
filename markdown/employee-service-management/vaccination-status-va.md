...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/vaccination-status-va.html
release: xanadu
topic_type: concept
...
For more information on creating caller access records, see [Set application scope, application resource, and event access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/building-applications/scope-resource-access.md).
