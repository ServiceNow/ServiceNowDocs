...
-   To learn more about configuring the Now Assist AI agents, see [Configure Now Assist AI agents](https://www.servicenow.com/docs/access?context=configuring-ai-agents&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
-   To learn about reducing the exposure of harmful content on your agentic workflow, see [Enable Now Assist Guardian for AI agents](https://www.servicenow.com/docs/access?context=enable-aia-na-guardian&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
