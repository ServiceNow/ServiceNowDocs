...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/universal-request-for-hr-service-delivery/ur-state-mapping.html
release: xanadu
...
3.  On the form, fill in the fields.
    ...
    For more information on the field description, see [State mapping form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/universal-request-for-hr-service-delivery/ur-state-mapping-form.md).
