...
3.  On the form, verify the default field values and customize the solution as required.
    ...
    For more information about the Classification Definition form fields, see [Create and train classification solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/create-solution-definition.md).
