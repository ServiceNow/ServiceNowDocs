...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/universal-request-for-hr-service-delivery/train-classification-identify-restrict-ur.html
release: yokohama
...
3.  On the form, verify the default field values and customize the solution as required.
    ...
    For more information about the Classification Definition form fields, see [Create and train classification solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/predictive-intelligence/create-solution-definition.md).
