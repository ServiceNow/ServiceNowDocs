...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/universal-request-for-hr-service-delivery/ur-create-brule-omnichannel.html
release: yokohama
...
10. Click **Submit**.
    ...
    For more information on other fields of this form, see [Create a business rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/business-rules-classic/c_BusinessRules.md).
