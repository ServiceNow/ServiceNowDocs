...
-   You can create new users and groups using the ServiceNow AI Platform user administration feature.
    ...
    -   [Create a user](https://www.servicenow.com/docs/access?context=t_CreateAUser&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US)
    ...
    -   [Add a user to a group](https://www.servicenow.com/docs/access?context=t_CreateAGroup&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US)
