...
3.  Create your department-specific extension point by selecting **Create implementation**.
    ...
    For more information about using extension points, see [Using extension points to extend application functionality](https://www.servicenow.com/docs/access?context=extension-points&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
