...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/universal-request-for-hr-service-delivery/create-extension-points-ur-transfers.html
release: xanadu
...
3.  Create your department-specific extension point by selecting **Create implementation**.
    ...
    For more information about using extension points, see [Using extension points to extend application functionality](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/web-services/extension-points.md).
