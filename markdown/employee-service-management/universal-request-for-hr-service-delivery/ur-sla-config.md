...
3.  On the form, fill the fields.
    ...
    For field descriptions and detailed instructions, see [Create an SLA definition](https://www.servicenow.com/docs/access?context=t_CreateAnSLADefinition&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US).
