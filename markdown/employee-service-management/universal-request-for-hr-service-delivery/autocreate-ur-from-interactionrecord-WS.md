...
You can achieve this by using a business rule and the Universal Request API. For more information, see [UniversalRequestUtilsSNC API](https://www.servicenow.com/docs/access?context=UniversalRequestUtilsSNCScopedAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
...
3.  Create an onSubmit\(\) client script to fetch the URL parameter.
    ...
    For more information, see [Client scripts](https://www.servicenow.com/docs/access?context=client-scripts&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
