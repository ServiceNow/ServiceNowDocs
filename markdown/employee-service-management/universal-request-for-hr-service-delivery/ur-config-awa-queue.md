...
2.  Perform any of the following task.
    ...
    For more information, see [Advanced Work Assignment](https://www.servicenow.com/docs/access?context=implement-awa&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
