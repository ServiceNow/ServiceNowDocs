...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/universal-request-for-hr-service-delivery/ur-use-dynamic-translation.html
release: yokohama
...
1.  Navigate to **All** &gt; **Settings** &gt; **General** &gt; **Language**.

2.  Select the language.

    **Note:** Only the languages that have been configured will be displayed. To activate a language, see [Activate a Language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/system-localization/t_ActivateALanguage.md)
