...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/change-tenant.html
release: xanadu
topic_type: task
...
You must upload the manifest file in Microsoft Teams. For more information, refer [Create and download the manifest file for pre-published apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/download-manifest-file-mt.md).
