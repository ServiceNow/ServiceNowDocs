...
3.  On the Stack plan, select the Stack plan settings icon \(![stack plan settings](../images/gear-icon.png)\) from the right pane to display different view options.
...
9.  To change the view, on the right pane, select the Map Settings icon \(![map settings](../images/gear-icon.png)\).
...
11. To edit the space attributes or its allocation details, do the following:
    ...
    1.  Select either a single space or bulk spaces.
        ...
        For more information about conditions, see [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
