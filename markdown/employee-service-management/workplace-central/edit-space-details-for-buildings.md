...
11. To edit the space attributes or its allocation details, do the following:
    ...
    1.  Select either a single space or bulk spaces.
        ...
        For more information about conditions, see [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
