...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-central/edit-space-details-for-buildings.html
release: zurich
...
11. To edit the space attributes or its allocation details, do the following:
    ...
    1.  Select either a single space or bulk spaces.
        ...
        For more information about conditions, see [Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_ConditionBuilder.md).
...
3.  Select **Apply**.
    ...
    13. Select **New** to add a workplace location and update the required fields.
        ...
        For more information, see [Managing workplace locations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-space-management/Creating-workplace-location-records-using-spce-mgmt.md).
...
**Parent Topic:**[Map based space administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-central/map-based-space-administration.md)
