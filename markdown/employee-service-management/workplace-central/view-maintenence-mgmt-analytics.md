...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-central/view-maintenence-mgmt-analytics.html
release: yokohama
...
</table>You can also add new indicators. For more information on how to work with indicators, see [Configure Performance Analytics fundamentals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/c_PAWidgetsAndDashboards.md).

-   **[Run the scheduled job for the Maintenance Management dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-central/run-job-for-wmm-dashboard.md)**  
