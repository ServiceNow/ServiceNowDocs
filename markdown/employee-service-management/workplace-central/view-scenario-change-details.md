...
Ensure that the scenario is created.
...
<table id="choicetable_vtv_5nj_3vb"><thead><tr><th align="left" id="d679237e135">

Path

</th><th align="left" id="d679237e138">

Action

</th></tr></thead><tbody><tr><td id="d679237e144">
...
4.  Select the **Space Deployment plan** tab of the scenario.
    ...
    If the scenario is grouped by neighbourhood, to view user related changes, select the **User Deployment plan**.
