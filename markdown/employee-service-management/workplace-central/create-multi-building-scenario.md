...
<table id="choicetable_fwz_mgg_3vb"><thead><tr><th align="left" id="d501975e157">

Path

</th><th align="left" id="d501975e160">

Action

</th></tr></thead><tbody><tr><td id="d501975e166">
...
-   **Edit Scenario**: You can only edit a scenario using this option. This option is available only when you select a scenario from the Space Optimization page. It is not available when you select a building from the Space Optimization page.
