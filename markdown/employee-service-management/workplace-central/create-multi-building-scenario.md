...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-central/create-multi-building-scenario.html
release: zurich
...
<table id="choicetable_fwz_mgg_3vb"><thead><tr><th align="left" id="d571422e157">

Path

</th><th align="left" id="d571422e160">

Action

</th></tr></thead><tbody><tr><td id="d571422e166">
...
2.  On the building details tab, select **Create scenario**.
    ...
    For a description of the field values, see [Scenario details form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-central/scenario-details-form.md).
...
For more information about scenario states, refer to [Scenario and Building - Views, states, settings, and key features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-central/scenario-planning-views-actions-keyfeatures-.md).
...
To create a copy of an existing scenario, see [Create a copy of an existing scenario](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-central/create-copy-of-scenario.md).

View or edit the scenario by using the stack plan or the floor map. For more information, see [Viewing or editing a scenario](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-central/viewing-editing-scenario.md).
