...
<table id="choicetable_y3x_khj_3vb"><thead><tr><th align="left" id="d493364e252">

Action

</th><th align="left" id="d493364e255">

Steps

</th></tr></thead><tbody><tr><td id="d493364e261">
...
For example, `Department is Finance`. For more information about conditions, see [Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_ConditionBuilder.md) and [Filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_Filters.md).
...
For example, `Workplace profile is Active`. For more information about conditions, see [Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_ConditionBuilder.md).
