...
-   Create child cases and child tasks if needed. For more information, see [Create a child case and a child task](create-a-child-case-and-a-child-task-casemgmtworkspace.md).

For more information about the features and actions that you can perform in the workspace, see [Case Management - Key features, Actions &amp; Case details](../reference/case-management-key-features-actions-case-details.md).
...
2.  On the pane, select the **Case Management** icon ![](../images/casemgmt-icon.png).
...
4.  Select the case that you want to open.
    ...
    The case details are displayed in a new tab. For more information about the view, the actions that you can perform and additional features, see the Case details page section in the [Case Management - Key features, Actions &amp; Case details](../reference/case-management-key-features-actions-case-details.md) topic.
...
<table id="choicetable_g2k_xbt_v1c"><thead><tr><th align="left" id="d346326e343">

Action

</th><th align="left" id="d346326e346">

Procedure

</th></tr></thead><tbody><tr><td id="d346326e354">
...
</td></tr><tr><td id="d346326e540">

**View the __Requested for__ employee details or send an email to the employee**

</td><td>

Select the At a glance icon ![](../images/casemgmt-ataglanceicon.png) on the side panel.**Note:** The employee details are displayed by default when you open the case. However, the employee details are subject to availability in the system database. If the details aren’t available, the details of the admin or the case manager are displayed.
...
</td></tr><tr><td id="d346326e623">

**View knowledge base articles related to the case**

</td><td>

Select the Knowledge Articles icon ![](../images/casemgmt-knowledgeicon.png) on the side panel.-   In the **Knowledge Articles** panel, search for an article.
...
</td></tr><tr><td id="d346326e676">

**View or upload attachments to the case**

</td><td>

Select the Attachment icon ![](../images/casemgmt-attachementicon.png).-   In the **Attachments** panel, view the attachments.
-   To upload a file, select **Select**.


</td></tr><tr><td id="d346326e711">

**View the template of the case or add a template**

</td><td>

Select the Template icon ![](../images/casemgmt-templateicon.png).-   In the **Templates** panel, view the templates in the **All** tab.
-   To add a template, select the Create template icon ![](../images/casemgmt-createtempicon.png).
...
Select the Location icon ![](../images/casemgmt-locationicon.png).-   In the **Locations** panel, view the location details such as the location name, floor, building, campus, and region details.
...
</td></tr><tr><td id="d346326e902">

**View the fulfillment instructions**

</td><td>

Select the fulfillment Instructions icon ![](../images/casemgmt-fulfimenticon.png).To add fulfillment instructions, see [Add Fulfillment instructions](../../workplace-case-mgmt/task/add-fulfillment-instructions.md).

</td></tr><tr><td id="d346326e937">

**View or add checklist items**

</td><td>

Select the Checklist icon ![](../images/casemgmt-checklisticon.png).-   Mark a checklist if it’s completed.
-   Edit a checklist if necessary.
-   Add a checklist item if necessary. If there are no checklist items, you can add them.


</td></tr><tr><td id="d346326e968">
...
2.  To create a child case, select **New**. For more information, see [Create a child case and a child task](create-a-child-case-and-a-child-task-casemgmtworkspace.md).


</td></tr><tr><td id="d346326e1015">
...
-   To create a child case, select **New**, see [Create a child case and a child task](create-a-child-case-and-a-child-task-casemgmtworkspace.md).


</td></tr><tr><td id="d346326e1059">
...
To create the SLA definition, see [Create an SLA Definition](../../workplace-case-mgmt/task/create-sla-defn-case-mgmt.md).

</td></tr><tr><td id="d346326e1112">
...
</td></tr><tr><td id="d346326e1137">

**View the related cases**

</td><td>

Go to the **Related cases** tab. View the cases or add a case if necessary. For more information, see [Create a child case and a child task](create-a-child-case-and-a-child-task-casemgmtworkspace.md).

</td></tr><tr><td id="d346326e1161">

**For a maintenance case, view the associated workplace cases**

</td><td>

Go to the **Workplace Cases** tab. View the cases or add a case if necessary. For more information, see [Create a child case and a child task](create-a-child-case-and-a-child-task-casemgmtworkspace.md).

</td></tr><tr><td id="d346326e1185">
...
The workplace case is updated or modified based on your changes. To cancel or delete the case, see [Cancel or delete a case](cancel-or-delete-a-case-casemgmtworkspace.md).
