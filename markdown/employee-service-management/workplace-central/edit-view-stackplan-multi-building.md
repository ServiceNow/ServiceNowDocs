...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-central/edit-view-stackplan-multi-building.html
release: zurich
...
Ensure that you have created a scenario, and it is in the Draft state. For more information, see [Create a scenario](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown).
...
<table id="choicetable_ej5_fmc_kfc"><thead><tr><th align="left" id="d166248e190">

Action

</th><th align="left" id="d166248e193">

Steps

</th></tr></thead><tbody><tr><td id="d166248e199">
