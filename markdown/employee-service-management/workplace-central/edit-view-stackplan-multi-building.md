...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-central/edit-view-stackplan-multi-building.html
release: yokohama
...
Ensure that you have created a scenario, and it is in the Draft state. For more information, see [Create a scenario](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown).
...
<table id="choicetable_ej5_fmc_kfc"><thead><tr><th align="left" id="d159500e195">

Action

</th><th align="left" id="d159500e198">

Steps

</th></tr></thead><tbody><tr><td id="d159500e204">
