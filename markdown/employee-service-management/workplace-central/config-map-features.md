...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/workplace-central/config-map-features.html
release: xanadu
...
Browse and select the Kiosk Reservable module. For more information, see [Configure Reservable Module for kiosk reservation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-services-kiosk/config-rsv-module-kiosk.md).
...
**Previous topic:**[Working with Kiosk Indoor Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-central/working-kiosk-ind-map.md)

**Next topic:**[Configure the kiosk position and map settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/workplace-central/config-kiosk-map.md)
