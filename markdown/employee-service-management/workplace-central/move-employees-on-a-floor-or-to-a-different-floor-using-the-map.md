...
6.  On the side panel, select **Users** icon \(![Users icon.](../images/movefloormap-usedetailsoption.png)\).
    ...
    ![Map legend for Assigned spaces, spaces with move cases, and selected employees.](../images/movefloormap-usericonlegend.png)

7.  To view the details of the employees assigned to a space, select the User icon \(![User icon.](../images/movefloormap-usericon.png)\) or the Move icon \(![Move icon.](../images/movefloormap-movecase.png)\) on the space.
    ...
    **Important:**
    ...
    4.  In the **Select neighborhood** field, select the neighborhood where you want to move the employee.
        ...
        **Note:** If an employee is selected more than once, all actions related to the employee are set to invalid.
        ...
        ![Building overview screen with a confirm move request pop-up, which displays invalid actions for Abel Tuter.](../images/building-overview-invalid-action.png)
