...
Create and publish a maintenance plan record. For more information, see [Create and publish maintenance plans](../../workplace-maintenance-management/task/create-publish-maintenance-plans.md).

The scheduled job should be run before viewing the dashboard for the first time. It collects all the data required for the reports for the past year. For more information, [View Maintenance Management metrics](view-maintenence-mgmt-analytics.md)
...
[Components installed with Workplace Maintenance Management](../../workplace-maintenance-management/reference/components-installed-with-maintenance-mgmt.md)
