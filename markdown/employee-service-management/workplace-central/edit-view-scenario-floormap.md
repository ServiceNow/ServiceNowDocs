...
<table id="choicetable_y3x_khj_3vb"><thead><tr><th align="left" id="d689107e212">

Action

</th><th align="left" id="d689107e215">

Description

</th></tr></thead><tbody><tr><td id="d689107e221">
...
For example, `Space type is Room`. For more information about conditions, see [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
