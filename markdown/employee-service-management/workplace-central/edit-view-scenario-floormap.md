...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-central/edit-view-scenario-floormap.html
release: zurich
...
Make sure that you have created a scenario, and it is in the Draft state. For more information, see [Create a scenario](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown).

Make sure that you have selected Indoor Mapping as your map provider to view maps.

-   For more information about selecting a map provider, see [Customize the map properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/wsm-configure-map-properties.md).
-   For more information about indoor mapping, see [Indoor Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/indoor-mapping/Indoor-mapping.md).
...
<table id="choicetable_y3x_khj_3vb"><thead><tr><th align="left" id="d718871e212">

Action

</th><th align="left" id="d718871e215">

Description

</th></tr></thead><tbody><tr><td id="d718871e221">
...
For example, `Space type is Room`. For more information about conditions, see [Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_ConditionBuilder.md).
