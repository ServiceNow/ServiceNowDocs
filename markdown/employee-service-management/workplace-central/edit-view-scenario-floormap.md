...
<table id="choicetable_y3x_khj_3vb"><thead><tr><th align="left" id="d661059e217">

Action

</th><th align="left" id="d661059e220">

Description

</th></tr></thead><tbody><tr><td id="d661059e226">
...
For example, `Space type is Room`. For more information about conditions, see [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
