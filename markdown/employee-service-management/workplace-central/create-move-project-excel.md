...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-central/create-move-project-excel.html
release: zurich
...
For more information about working on a move project, see [Work on a move project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-central/work-on-a-move-project.md).
