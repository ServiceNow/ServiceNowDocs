...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-central/view-space-opt-analytics.html
release: yokohama
...
-   Ensure that the Workplace Central application is installed. For more information, see [Install Workplace Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-central/install-workplace-central.md)
-   Ensure that the Workplace Space Management \(sn\_wsd\_spcmgmt\) application is installed. For more information, see [Install Workplace Space Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-space-management/install-workplace-space-mgmt.md).
...
For more information, see [Allocation - types, setting, and impact](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-space-management/setting-an-allocation-and-its-impact.md).
...
For more information, see [Map designated workspaces to user profiles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-core/map-employees-to-existing-workplace-locations-wsd.md).
...
-   **Capacity vs utilization**
    ...
    -   Select the more options icon \(\[Omitted image "dashboard-report-refresh-icon.png"\] Alt text: More options icon to refresh the report.\) to refresh the report.
...
-   **Space utilization by workplace entity**
    ...
    \[Omitted image "wsd-space-ulitization-by-workplace-entity.png"\] Alt text: Space utilization by workplace entity metrics.
...
You can customize the widgets to display relevant metrics by using the UI Builder. For more information, see [UI Builder tutorial](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/uib-tutorial.md).

-   **[Run the scheduled job for the Space Optimization dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-central/run-job-space-opt-dashboard.md)**  
...
**Parent Topic:**[Working with Workplace Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-central/working-with-workplace-analytics.md)
