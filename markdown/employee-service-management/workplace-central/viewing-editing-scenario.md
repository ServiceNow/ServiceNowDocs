...
-   Neighborhood assignments are applicable if Neighborhood is selected as the group by or view by option in a scenario or building overview. Location assignments are applicable for all other options.
