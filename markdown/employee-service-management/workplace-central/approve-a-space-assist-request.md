...
3.  To view the request details before approving, in the **Approving** field, select the Preview this record icon \(![Preview this record icon](../images/preview-icon.png)\).
