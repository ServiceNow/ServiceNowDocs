...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-central/approve-a-space-assist-request.html
release: zurich
...
-   You're the manager to the user that raised the space assist request.
...
7.  On the form, do any one of the following:
    ...
    -   To reject the request, do the following:
        ...
        2.  Select **Post** after entering your comments.
        3.  Select **Reject**.

            The request is rejected.


**Parent Topic:**[Manage Workplace Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-central/manage-workplace-central.md)
