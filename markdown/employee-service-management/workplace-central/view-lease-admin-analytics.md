...
-   Navigate to the **Lease Administration** tab.![Workplace Analytics Lease Administration dashboard. For more information on the scorecards and key metrics displayed, refer to the following sections.](../images/wpa-lease-admin-dashboard.png)
