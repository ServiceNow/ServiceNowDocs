...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/workplace-central/work-on-space-assist-request.html
release: yokohama
...
For a detailed information about the functionality, views, and states, refer to [Space request approvals, states, actions, and key features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/workplace-central/space-request-states-and-view.md).
