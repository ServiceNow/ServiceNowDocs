...
-   **Select a space**
    ...
    Select a space on the map directly and view the details of that space on the right panel. You can select a single or multiple spaces by drawing a circle around them or by using the Shift key on the keyboard. The details on the right panel are displayed based on your selection.
