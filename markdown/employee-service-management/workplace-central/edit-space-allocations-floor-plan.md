...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-central/edit-space-allocations-floor-plan.html
release: zurich
...
5.  Select the spaces that you want to edit.
    ...
    2.  Add conditions to filter the spaces.
        ...
        For example, `Department is Finance`. For more information about conditions, see [Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_ConditionBuilder.md).

    3.  Select the spaces from the list, then select **Select**.

6.  Edit the space allocations based on your requirement.

<table id="choicetable_vyl_2qc_f3c"><thead><tr><th align="left" id="d205183e169">

Action

</th><th align="left" id="d205183e172">

Steps

</th></tr></thead><tbody><tr><td id="d205183e178">
