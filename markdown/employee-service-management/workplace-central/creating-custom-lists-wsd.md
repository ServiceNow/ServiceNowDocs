...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/workplace-central/creating-custom-lists-wsd.html
release: zurich
...
-   **[Create a custom list based on an existing list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-central/create-list-from-existing.md)**  
Create a custom list based on an existing list on Workplace Central.
-   **[Create a custom list based on a system table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/workplace-central/create-custom-list.md)**  
