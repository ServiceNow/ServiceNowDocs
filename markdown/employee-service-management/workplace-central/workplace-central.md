...
-   Plan scenarios using the Scenario planning feature available with the Space optimization module. This module provides the collective information for all the scenarios created, published, deployed, and archived in the system.
    ...
    For more information about scenario planning and the Space optimization module, refer to [Scenario Planning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/employee-service-management/workplace-space-management/scenario-planning.md).
