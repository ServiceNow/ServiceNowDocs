...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/contact-tracing/contact-tracing-domain-separation.html
release: zurich
...
Admins must install the [Domain separation plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/t_ActivateDomainSeparation.md) before working with the Contact Tracing tables.
