...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contact-tracing/identify-exposed-contacts.html
release: yokohama
...
5.  On the Diagnostic Request form, run the diagnostic request on the affected employee to identify other potentially exposed employees, and add them to the case.
    ...
    For more information on running a diagnostic request, see [Run a diagnostic request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/emergency-exposure-management/use-emergency-exposure-mgnt.md).
...
If you have the [Employee Readiness Core](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-readiness-core/employee-readiness-core.md) application installed and a health and safety requirement for the potentially exposed contacts activated, a record is created with the requirement status as Not Cleared for these potentially exposed employees.
...
If the automatic case task creation is disabled, [create a case task for each exposed contact](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/create-task-exposed-contact.md).
