...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contact-tracing/create-task-exposed-contact.html
release: yokohama
...
The contact tracers can start working on the tasks by [following up with the exposed contacts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/contact-exposed-contacts.md) about their health status.
