...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contact-tracing/contact-tracing.html
release: yokohama
...
\[Omitted image "contact-tracing-overview.png"\] Alt text: Identify potential exposures from affected users to minimize transmission of infectious diseases at the workplace
...
-   **[Install Contact Tracing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/install-contact-tracing.md)**  
You can install Contact Tracing if you have the admin role.
-   **[Setting up Contact Tracing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/set-up-contact-tracing.md)**  
...
-   **[Maintaining user data privacy in Contact Tracing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/contact-tracing-user-privacy-options.md)**  
...
-   **[Collecting user badge data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/badge-management.md)**  
...
-   **[Collecting risk scores in Contact Tracing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/contact-tracing-collect-risk-scores.md)**  
...
-   **[Retrieving Wi-Fi access log data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/wifi-access-management.md)**  

-   **[Tracking employee contacts using daily logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/employee-daily-log.md)**  
...
-   **[Managing cases to follow up with potentially exposed contacts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/exposure-case-management.md)**  
