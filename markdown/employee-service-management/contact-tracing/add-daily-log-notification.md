...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/contact-tracing/add-daily-log-notification.html
release: xanadu
...
To use this email notification for as your daily contact log, see [Configure an Emergency Outreach notification for the daily contact log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contact-tracing/configure-outreach-notif-daily-log.md).
