...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/contact-tracing/configure-outreach-notify-exp-contact.html
release: xanadu
...
<table id="choicetable_frh_152_jmb"><thead><tr><th align="left" id="d186085e165">

Option

</th><th align="left" id="d186085e168">

Steps

</th></tr></thead><tbody><tr><td id="d186085e174">
...
A case manager can [send the outreach notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/contact-tracing/send-notification-to-exposed-contact.md) to the potentially exposed contacts in a case.
