...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contact-tracing/configure-outreach-notify-exp-contact.html
release: yokohama
...
<table id="choicetable_frh_152_jmb"><thead><tr><th align="left" id="d199161e165">

Option

</th><th align="left" id="d199161e168">

Steps

</th></tr></thead><tbody><tr><td id="d199161e174">
...
A case manager can [send the outreach notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/send-notification-to-exposed-contact.md) to the potentially exposed contacts in a case.
