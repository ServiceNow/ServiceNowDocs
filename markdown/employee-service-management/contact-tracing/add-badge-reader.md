...
You can also import your badge reader data from an Excel spreadsheet. For more information, see [Easy import data from a list](https://www.servicenow.com/docs/access?context=c_EasyImport&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
