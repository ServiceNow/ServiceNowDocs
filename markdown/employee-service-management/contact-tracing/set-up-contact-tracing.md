...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/contact-tracing/set-up-contact-tracing.html
release: yokohama
...
For more information, see [Set up a tracing system for an exposure data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/emergency-exposure-management/set-up-tracing-system.md).

-   **[Set up Contact Tracing properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/configure-contact-tracing-properties.md)**  
Configure system properties to adjust how contact tracing data is used.
-   **[Domain separation and Contact Tracing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/contact-tracing-domain-separation.md)**  
...
-   **[Modify the scheduled data import job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/configure-badge-sched-import-job.md)**  
...
-   **[Configure the time zone setting for badge and daily log data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/add-script-include-contact-tracing.md)**  
...
-   **[Configure an email notification for the daily contact log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/add-daily-log-notification.md)**  
...
-   **[Configure an Emergency Outreach notification for the daily contact log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/configure-outreach-notif-daily-log.md)**  
...
-   **[Configure Contact Tracing data retention settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/configure-contact-tracing-data-retention.md)**  
...
-   **[Create a requirement for potentially exposed contacts to return to work](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/create-exposed-contacts-requirement.md)**  
Create a requirement for potentially exposed employees to meet to verify that they are eligible to return to work.
-   **[Create a requirement for employees to acknowledge the privacy consent request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/create-privacy-consent-requirement.md)**  
...
-   **[Configure an email notification for an exposure notice](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/configure-notify-exp-contact-email.md)**  
...
-   **[Configure contact tracing visualization to show vaccination status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/add-vaccination-status-to-case-visualization.md)**  
...
-   **[Setting up data privacy consent settings for Contact Tracing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/set-up-privacy-consent-settings.md)**  
...
-   **[Map handheld computing devices assigned to employees](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/add-user-handheld-devices.md)**  
...
-   **[Configure KINEXON integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/configure-kinexon-integration.md)**  
...
-   **[Virtual Agent conversations for Contact Tracing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/contact-tracing/contact-tracing-va-sms.md)**  
