...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/user-presence-indicator-mt.html
release: xanadu
topic_type: concept
...
-   **[Configure cache duration for the user presence status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/configure-cache-duration-mt.md)**  
