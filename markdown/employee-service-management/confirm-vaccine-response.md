...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/confirm-vaccine-response.html
release: xanadu
topic_type: task
...
For more information, see [Set up Vaccination Status properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/config-vaccination-properties.md).
...
For more information on configuring Vaccination Status, see [Set up Vaccination Status properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/config-vaccination-properties.md).
