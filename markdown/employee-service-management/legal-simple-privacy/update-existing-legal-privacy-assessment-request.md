...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/legal-simple-privacy/update-existing-legal-privacy-assessment-request.html
release: zurich
...
4.  On the standard ticket page, review and edit the request details.

5.  From the Actions menu, select **Edit Request**.

6.  In the Variables form, modify the request details.

7.  Select **Save**.

8.  Select **Back** to return to the standard ticket page.
...
<table id="choicetable_dtv_1j4_gtb"><thead><tr><th align="left" id="d228653e151">

Option

</th><th align="left" id="d228653e154">

Steps

</th></tr></thead><tbody><tr><td id="d228653e160">
...
</table>11. In the **Approvals** tab, view the approval details associated with the request.

    **Note:** The **Approvals** tab appears only when the privacy assessment request or an attachment has approval records.


**Parent Topic:**[Privacy assessment requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/employee-service-management/legal-simple-privacy/privacy-assessment-requests.md)
