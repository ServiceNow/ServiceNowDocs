...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/health-and-safety-testing/configure-health-safety-testing.html
release: xanadu
...
3.  Generate the [location-based privacy configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/employee-readiness-core/generate-location-common-privacy-configuration.md) for the locations in your instance.
...
4.  Configure an outreach to send the privacy consent to users.
    ...
    2.  Make any modifications to the outreach if needed, such as scheduling a time to send.
        ...
        For more information, see [Send notifications for an emergency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/emergency-outreach/send-eo-notification-outreach.md).
