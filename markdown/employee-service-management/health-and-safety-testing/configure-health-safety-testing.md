...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/employee-service-management/health-and-safety-testing/configure-health-safety-testing.html
release: yokohama
...
5.  In the **Message HTML** field, click **Insert/edit image** and select your banner image.
    ...
    **Tip:** The image must be added before the mail script so that it appears at the top of the email.
    ...
    If you don't already have an email banner image in your ServiceNow instance, you can upload an image to use. For instructions, see [Upload one or more images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/upload-multiple-images.md).
...
3.  Generate the [location-based privacy configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/employee-readiness-core/generate-location-common-privacy-configuration.md) for the locations in your instance.
...
4.  Configure an outreach to send the privacy consent to users.
    ...
    2.  Make any modifications to the outreach if needed, such as scheduling a time to send.
        ...
        For more information, see [Send notifications for an emergency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/employee-service-management/emergency-outreach/send-eo-notification-outreach.md).
