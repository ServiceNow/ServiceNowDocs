...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/health-and-safety-testing/review-your-health-test-results.html
release: xanadu
...
3.  Modify the record by adding an attachment or review the record.
    ...
    -   If you are adding an attachment, such as test results, add the attachment and then click **Update**.
        ...
        **Note:** For information on managing attachments, see [Manage attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/t_ManagingAttachments.md).
