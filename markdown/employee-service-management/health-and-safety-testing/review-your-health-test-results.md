...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/health-and-safety-testing/review-your-health-test-results.html
release: zurich
...
3.  Modify the record by adding an attachment or review the record.
    ...
    -   If you are adding an attachment, such as test results, add the attachment and then click **Update**.
        ...
        **Note:** For information on managing attachments, see [Manage attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/t_ManagingAttachments.md).
