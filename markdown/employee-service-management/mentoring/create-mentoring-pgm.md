...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/employee-service-management/mentoring/create-mentoring-pgm.html
release: zurich
product: Mentoring
...
3.  On the form, fill in the fields.
    ...
    |User criteria|Records that contain lists of users that can participate in a mentoring program. See, [Create User Criteria Records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/create-user-criteria-record-in-knowledge-management.md).|
