...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/mentoring/configuring-mentoring-egd.html
release: xanadu
product: Mentoring
...
Before installing Mentoring 2.0.1, first upgrade to an **MSI trued-up patch** of the Store Apps family version. This ensures all MSI fixes are applied correctly.
...
-   **[Create a Mentoring program](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/mentoring/create-mentoring-pgm.md)**  
Create a customized mentoring program that can be adopted by a mentee.
-   **[Add a new Mentoring participant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/mentoring/add-mentoring-participant.md)**  
As a manager, add members from your team either as mentors or mentees to participate in mentorship program.
-   **[Create a Mentoring relationship](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/mentoring/create-mentoring-relationship.md)**  
