...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/employee-service-management/mentoring/search-add-skills-mentoring.html
release: australia
product: Mentoring
...
3.  On the **Search for more skills** wizard, specify the proficiency level from one of the following using the slide bar.
