...
For more information on setting up assignment groups, see [Configure assignment group types](https://www.servicenow.com/docs/access?context=c_ConfigGroupTypesForAssignGroups&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
