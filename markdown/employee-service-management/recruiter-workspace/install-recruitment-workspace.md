...
-   Review the [Recruitment workspace](https://store.servicenow.com/store/app/74eaa3e61b246a50a85b16db234bcbea) application listing in the ServiceNow Store for information on dependencies, licensing or subscription requirements, and release compatibility.
...
2.  Find the Recruiter Workspace application \(sn\_ta\_recruiter\) using the filter criteria and search bar.
