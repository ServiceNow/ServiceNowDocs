...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/employee-service-management/health-and-safety-incident-management/log-injury-illness.html
release: xanadu
...
5.  In the **Add injury and illness** activity, add the injury and illness.
    ...
    2.  On the form, fill in the fields in the **Person**, **Healthcare**, and **Injury and illness details** sections.
        ...
        For field descriptions, see [Injury and illness fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-incident-management/hs-injury-illness-form.md).
...
7.  In the **What was the injury?** section, add the injury.
    ...
    3.  If there's more than one injury, select the other injured body parts and add their details like the earlier step.
...
10. Create a return to work case for the person involved in this injury or illness using the **Create RTW Case** button, if needed.
    ...
    **Note:** This button appears only when the following conditions are met:
    ...
    For more information, see [Create a return to work case from an injury or illness](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/employee-service-management/health-and-safety-incident-management/create-rtw-case-injury-illness.md).
