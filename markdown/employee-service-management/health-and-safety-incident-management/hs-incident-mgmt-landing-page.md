...
[Explore ![](../../../common/image/icon-explore.png) Learn about how employees, safety managers, and agents use Health and Safety Incident Management.](explore-hs-incident-mgmt.md)

</td><td>

[Set up ![](../../../common/image/icon-set-up.png) Set up Health and Safety Incident Management.](setting-up-hs-incident-mgmt.md)

</td><td>

[Submit incidents ![](../../../common/image/icon-workspace.png) Submit and track safety incidents and observations.](submitting-safety-incidents-obvs.md)

</td></tr><tr><td>

[Manage incidents ![](../../human-resources/image/icon-report.png) Manage safety incidents and observations to investigate and resolve them.](managing-hs-incidents-obs.md)

</td><td>

[Reporting ![](../../../common/image/icon-reference.png) Fill and export reporting forms for injuries and illnesses in your organization.](injury-illness-reports.md)

</td><td>

[Reference ![](../../../common/image/icon-reference.png) Get details about components such as roles, tables, plugins, and store applications that are installed.](hs-incident-mgmt-reference.md)
