...
The Geo map component \[sn\_geo\_map\] must be installed to use this feature. For more information, see [Activate a plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_ActivateAPlugin.md).
