...
For more information on how to interact with a playbook, see [Playbooks](https://www.servicenow.com/docs/access?context=playbook-ui&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
...
10. [Close the safety incident](close-hs-incident-observation.md) after all activities are complete.
