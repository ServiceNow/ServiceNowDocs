...
9.  To view the case-related list in the playbook contextual side panel, select the **Related items**.
    ...
    For more information about the related items components, see [Playbook related items component](https://www.servicenow.com/docs/access?context=csm-playbook-related-items-component&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
