...
6.  Diagnose the service problem case to identify the root-cause of the problem.
    ...
    The decision table can be configured to control the visibility of the Run Diagnostics contextual panel tab. For more information about decision tables, see [Decision Tables](https://www.servicenow.com/docs/access?context=decision-table&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
...
9.  To view the case-related list in the playbook contextual side panel, select the **Related items**.
    ...
    For more information about the related items components, see [Playbook related items component](https://www.servicenow.com/docs/access?context=csm-playbook-related-items-component&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
...
**Parent Topic:**[Using Customer Service Problem Management](../concept/using-spm.md)
