...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/proactive-service-exp-workflows/publish-test-groups.html
release: yokohama
topic_type: task
...
You must ensure that the characteristic and its options are added to the test group for successful publishing and operation of the tests.

Role required: sn\_st\_mgmt.test\_def\_manager
...
**Parent Topic:**[Setting up a test group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/proactive-service-exp-workflows/setting-test-group.md)
