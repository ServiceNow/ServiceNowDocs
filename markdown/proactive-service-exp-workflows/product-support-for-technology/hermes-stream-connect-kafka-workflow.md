...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/proactive-service-exp-workflows/product-support-for-technology/hermes-stream-connect-kafka-workflow.html
release: xanadu
...
-   To learn more about Apache Kafka Stream Connect, see [Using Stream Connect for Apache Kafka](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/stream-connect-apache-kafka.md).
...
1.  On the trigger of the trouble ticket event, the system invokes the appropriate business rule, and stamps the event type.
    ...
    To learn more about business rule that you must add to your ServiceNow instance, see [Add a business rule for a new trouble ticket event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/developer-guides/prd_evt_not-dev_gd-add_bus_rule.md).
