...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/proactive-service-exp-workflows/product-support-for-technology/diagnose-resolve-cmdb-ci.html
release: xanadu
...
5.  Diagnose the service to identify the root-cause of the problem.
    ...
    2.  In the run diagnostics panel, select **CI/Service** from the drop-down list.
        ...
        To set up test definitions, see [Setting up test definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/settingup-test-specifications.md).

    3.  Expand the cards in **Available test suite**.

        To set up test group, see [Setting up a test group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/setting-test-group.md).
