...
# Create escalation from Technology Account 360 view
...
5.  Select **Create**, and then select **Escalation** from the drop-down list.

6.  On the Escalation form, fill in the fields.

    For more information about the fields, see [Escalate a case or an account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/escalate-csm-case.md).
