...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/proactive-service-exp-workflows/setting-test-group.html
release: xanadu
topic_type: concept
...
-   **[Create a test group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/create-test-group.md)**  
...
-   **[Associate a test group with a specifications or product model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/define-relationship-test-group-specifications.md)**  
...
-   **[Publish a test groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/publish-test-groups.md)**  
