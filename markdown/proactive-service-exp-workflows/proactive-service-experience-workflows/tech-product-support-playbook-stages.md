...
The decision table is provided with the Product Support for Technology application. You can modify the conditions that have been defined, and the results to suit your requirements.
 ...
 The status can be changed to False by the agent. For more details on updating decision tables, see [Decision Tables](https://www.servicenow.com/docs/access?context=decision-table&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
...
For more information, see [Recommended Actions](https://www.servicenow.com/docs/access?context=configure-nba&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
