---
title: Configuring Product Support for Technology
...
breadcrumb: [Configure, Product Support for Technology]
---
...
The Product Support for Technology application \(sn\_tech\_support\) is available from the ServiceNow Store.
