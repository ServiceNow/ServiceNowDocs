...
4.  Select **Create a Technology Product Case**.
    ...
    Case form as been created using a record producer. For more information about how to create record producer, see [Record Producer](https://www.servicenow.com/docs/access?context=c_RecordProducer&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
