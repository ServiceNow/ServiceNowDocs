...
![The Product Support for Technology record page enables agents to focus on case details, the activity stream, and information in the contextual side panel.](../image/tech-product-support-record-page.png "Product Support for Technology record page")
...
**Note:** The case summarization component requires the [Now Assist for Customer Service Management \(CSM\)](https://www.servicenow.com/docs/access?context=now-assist-csm&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US) application to be activated and configured.
...
|Action|Description|
|------|-----------|
|In-progress Actions|Provides a list of minimized [modeless dialogs](https://www.servicenow.com/docs/access?context=csm-front-line-case-page-modeless-dialogs&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US) and includes a badge that displays the number of items in the list. From this list, an agent can select an item to open the minimized comment, work note, or email.|
...
|Compose|Compose comments, work notes, and emails in [modeless dialogs](https://www.servicenow.com/docs/access?context=csm-front-line-case-page-modeless-dialogs&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).|
...
For more information, see [Modeless dialogs](https://www.servicenow.com/docs/access?context=csm-front-line-case-page-modeless-dialogs&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
...
-   [Activate Now Assist for Customer Service Management \(CSM\)](https://www.servicenow.com/docs/access?context=now-assist-csm-supporting-info&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US)
-   [Configure the case summarization skill in the Now Assist Admin console](https://www.servicenow.com/docs/access?context=now-assist-csm-configuring&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
...
-   [Activate Now Assist for Customer Service Management \(CSM\)](https://www.servicenow.com/docs/access?context=now-assist-csm-supporting-info&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
-   [Configure the resolution notes generation skill in the Now Assist Admin console](https://www.servicenow.com/docs/access?context=now-assist-csm-configuring&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
-   [Configure the Propose Solution UI action and declarative action](https://www.servicenow.com/docs/access?context=now-assist-csm-config-propose-solution&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
