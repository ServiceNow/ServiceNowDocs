...
-   **[Run diagnostics tests for a CI or a service](../../tmt-spmc/task/diagnose-resolve-cmdb-ci.md)**  
...
-   **[Handling API notifications](handling-trouble-ticket-notifications.md)**  
