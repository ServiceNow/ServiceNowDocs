...
-   Trigger outbound requests for one or more service test runs by using the TeleManagement Forum \(TMF\) 653 Open POST order API. To learn more, see [Service Test Management Open API](https://www.servicenow.com/docs/access?context=service-test-management-api&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
