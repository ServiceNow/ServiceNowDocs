...
![The Product Support for Technology playbook enables agents to focus on the contact and account information, the playbook stages and activities, and information in the contextual side panel.](../image/tech-product-support-playbook-page.png "Product Support for Technology playbook")
...
-   Refresh the summary.
 ...
 The case summarization component requires that the [Now Assist for Customer Service Management \(CSM\)](https://www.servicenow.com/docs/access?context=now-assist-csm&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US) application is installed and the case summarization skill has been configured.
...
For more information about the playbook, see [Product Support for Technology playbook stages and activities](tech-product-support-playbook-stages.md).
...
-   **Discuss**: starts a Sidebar discussion. For more information about using the Sidebar feature, see [Exploring Sidebar](https://www.servicenow.com/docs/access?context=exploring-sidebar&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
...
![The Product support for technology playbook activity stream component lists record activities in a collapsed or expanded format and uses tiles to represent the activity types.](../image/front-line-case-page-activity-stream.png "Product support for technology playbook activity stream component")
...
![The Product support for technology playbook related lists component in the contextual side panel uses an accordion format to expand and display related list items](../image/front-line-case-page-related-lists.png "Technology product support playbook related lists component")
...
1.  [Activate Now Assist for Customer Service Management \(CSM\)](https://www.servicenow.com/docs/access?context=now-assist-csm-supporting-info&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
2.  [Configure the resolution notes generation skill in the Now Assist Admin console](https://www.servicenow.com/docs/access?context=now-assist-csm-configuring&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
