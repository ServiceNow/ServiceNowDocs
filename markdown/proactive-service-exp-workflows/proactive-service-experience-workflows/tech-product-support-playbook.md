...
-   Refresh the summary.
 ...
 The case summarization component requires that the [Now Assist for Customer Service Management \(CSM\)](https://www.servicenow.com/docs/access?context=now-assist-csm&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US) application is installed and the case summarization skill has been configured.
...
-   **Discuss**: starts a Sidebar discussion. For more information about using the Sidebar feature, see [Exploring Sidebar](https://www.servicenow.com/docs/access?context=exploring-sidebar&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US).
...
1.  [Activate Now Assist for Customer Service Management \(CSM\)](https://www.servicenow.com/docs/access?context=now-assist-csm-supporting-info&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
2.  [Configure the resolution notes generation skill in the Now Assist Admin console](https://www.servicenow.com/docs/access?context=now-assist-csm-configuring&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
