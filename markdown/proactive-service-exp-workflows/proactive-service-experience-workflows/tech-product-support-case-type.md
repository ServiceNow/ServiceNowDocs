---
title: Product Support for Technology type
description: The Product Support for Technology type enables technology companies to provide support for digital products and services.
locale: en-US
release: zurich
...
A [case types](https://www.servicenow.com/docs/access?context=customer-service-case-types&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US) represents the processes and the data that are needed to resolve a specific type of customer issue. The Technology Product Support case type includes the table, roles, SLAs, email notifications, and other items needed to resolve technology issues.

The Product Support for Technology application \(sn\_tech\_product\_support\) includes the Product Support for Technology type. To view a list of available case types, navigate to **Customer Service** &gt; **Case Types** &gt; **Manage Case Types**.
...
The Product Support for Technology application includes the Tech Product Support Case \[sn\_tech\_product\_support\_case\] table. This table extends the Case table and can be extended.For a detailed description of the Product Support for Technology table, including field descriptions, see [Tech Product Support Case table](../reference/tech-product-support-case-table.md).
...
Roles control access to features and capabilities in the Product Support for Technology application, menu, and modules.
...
Product Support for Technology cases follow a specific life cycle and move through a series of states from creation to closure.
...
The Product Support for Technology application includes list views for CSM/FSM Configurable Workspace and for Core UI that appear in the application navigator.
...
Provider notifications for agents are sent following updates to Product Support for Technology cases.
...
A record producer is a specific type of catalog item that allows end users to create task-based records from a service catalog. The Product Support for Technology application includes the following record producer: **Create a Technology Product Case**.
...
The Product Support for Technology type uses field indicators and field highlights to indicate information about cases.
...
Users with this role:-   Can view product support for technology cases in the Customer Service Portal.
...
Provides write access to product support for technology cases.
...
For more information, see [Major issue management overview](https://www.servicenow.com/docs/access?context=major-issue-management&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
...
The Product Support for Technology application includes a configuration for special handling notes. Navigate to **Special Handling Notes** &gt; **Configuration** to view the configuration for the Tech Product Support Case table \[sn\_tech\_product\_support\_case\]. This configuration includes the following related fields:
...
-   [Special handling notes](https://www.servicenow.com/docs/access?context=c_OnScreenAlerts&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US)
-   [Configure special handling notes](https://www.servicenow.com/docs/access?context=configure-special-handling-notes&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US)
-   [Create a special handling note](https://www.servicenow.com/docs/access?context=t_CreateAnOnScreenAlert&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US)
...
For more information, see [Service definitions](https://www.servicenow.com/docs/access?context=csm-service-definitions&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US) and Service definition categories.
...
-   [Administering case action status](https://www.servicenow.com/docs/access?context=customer-service-case-action-status&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US)
-   [Case action status](https://www.servicenow.com/docs/access?context=case-action-status-csm-workspace&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US) \(CSM Configurable Workspace\)
...
-   Orange: Medium severity
 ...
 For more information, see [Administering case and account escalation](https://www.servicenow.com/docs/access?context=administer-case-account-escalation&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
...
For more information, see [Automatically close customer service cases](https://www.servicenow.com/docs/access?context=auto-close-customer-service-case&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
