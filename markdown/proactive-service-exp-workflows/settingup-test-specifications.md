...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/proactive-service-exp-workflows/settingup-test-specifications.html
release: xanadu
topic_type: concept
...
-   **[Create a test definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/create-test-specification.md)**  
...
-   **[Define a characteristic for the test definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/add-characterisitc-for-test-specification.md)**  
Add a characteristic for a test to determine the properties that are required to run and evaluate the test.
-   **[Define the relationship between the test definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/define-test-spec-relationship.md)**  
...
-   **[Define the relationship between test definition and specifications or product model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/specification-to-test-definition.md)**  
...
-   **[Define test measure definitions for a service test](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/define-test-measure-spm.md)**  
...
-   **[Define threshold rules for a test measure definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/define-threshold-rules.md)**  
...
-   **[Define measure consequences for the threshold rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/define-threshold-consequences-spm.md)**  
Set actions or responses to trigger when the test measure results fall outside the predefined acceptable limits.
-   **[Publish test definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/publish-test-specification-spm.md)**  
...
**Parent Topic:**[Configuring Customer Service Problem Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/proactive-service-exp-workflows/configuring-spm.md)
