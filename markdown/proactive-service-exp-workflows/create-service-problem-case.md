...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/proactive-service-exp-workflows/create-service-problem-case.html
release: xanadu
topic_type: task
...
Role required: an\_sprb\_mgmt.agent
