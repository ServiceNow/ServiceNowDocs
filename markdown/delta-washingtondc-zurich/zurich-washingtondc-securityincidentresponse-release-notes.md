---
title: Combined Security Incident Response release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Security Incident Response from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-securityincidentresponse-release-notes.html
release: zurich
...
# Combined Security Incident Response release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Security Incident Response from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Security Incident Response release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Major Security Incident Management Conference Call Integration](https://servicenow-staging.fluidtopics.net/access?context=integrate-msim-conference-calls&family=washingtondc&ft:locale=en-US)**
...
-   **[Flow-based Playbooks](https://servicenow-staging.fluidtopics.net/access?context=playbook-flow-based&family=washingtondc&ft:locale=en-US)**
...
More easily transition from manual or undocumented playbooks to automated and repeatable playbooks using . Security Incident Response now supports the following new playbooks:
    ...
    -   [Playbook for Office 365 - Malicious File Detected](https://servicenow-staging.fluidtopics.net/access?context=playbook-office-malicious-file-detected-&family=washingtondc&ft:locale=en-US)
    -   [Playbook for Repeat Detection](https://servicenow-staging.fluidtopics.net/access?context=playbook-repeat-detection&family=washingtondc&ft:locale=en-US)
    -   [Playbook for Spoofed Emails \(using the same Display name\)](https://servicenow-staging.fluidtopics.net/access?context=playbook-spoofed-emails-display-name&family=washingtondc&ft:locale=en-US)
    -   [Playbook for Endpoint Detection](https://servicenow-staging.fluidtopics.net/access?context=playbook-endpoint-detection&family=washingtondc&ft:locale=en-US)
    -   [Playbook for Possible Password Spray](https://servicenow-staging.fluidtopics.net/access?context=playbook-possible-password-spray&family=washingtondc&ft:locale=en-US)
    -   [Playbook for T1003 - Detect Credential Dumping Tools](https://servicenow-staging.fluidtopics.net/access?context=playbook-detect-credential-dumping-tools&family=washingtondc&ft:locale=en-US)
    -   [Playbook for Email Domain Spoofing Detection](https://servicenow-staging.fluidtopics.net/access?context=playbook-email-spoof-detection&family=washingtondc&ft:locale=en-US)
    -   [Playbook for Typo Squatted Domain](https://servicenow-staging.fluidtopics.net/access?context=playbook-typo-squatted-domain&family=washingtondc&ft:locale=en-US)
    -   [Playbook for Credential Sniffing](https://servicenow-staging.fluidtopics.net/access?context=playbook-credential-sniffing&family=washingtondc&ft:locale=en-US)
    -   [Playbook for T1070 - Windows Events Logs Cleared](https://servicenow-staging.fluidtopics.net/access?context=playbook-windows-events-log&family=washingtondc&ft:locale=en-US)
    -   [Playbook for OSquery of External Address in /etc/hosts file](https://servicenow-staging.fluidtopics.net/access?context=playbook-osquery-external-address&family=washingtondc&ft:locale=en-US)
    -   [Playbook for User Deleting Bash History - Cloud](https://servicenow-staging.fluidtopics.net/access?context=playbook-deleting-bash-history&family=washingtondc&ft:locale=en-US)
    -   [Playbook for Successful VPN Attempts from the Service Accounts - Corp/Cloud](https://servicenow-staging.fluidtopics.net/access?context=playbook-successful-vpn-attempts&family=washingtondc&ft:locale=en-US)
    -   [Playbook for Attempted Access to Deactivated Accounts](https://servicenow-staging.fluidtopics.net/access?context=playbook-attempted-access-deactivated-accounts&family=washingtondc&ft:locale=en-US)
    -   [Playbook for T1003 - Defense Evasion - Mimikatz DCShadow](https://servicenow-staging.fluidtopics.net/access?context=playbook-defense-evasion-mimikatz-dcshadow&family=washingtondc&ft:locale=en-US)
    -   [Playbook for T1003 - Credential Dumping - Mimikatz DCSync](https://servicenow-staging.fluidtopics.net/access?context=playbook-credential-dumping-mimikatz-dcsync&family=washingtondc&ft:locale=en-US)
    -   [Playbook for Okta User Login Failures from Multiple IPs](https://servicenow-staging.fluidtopics.net/access?context=playbook-okta-user-login-failures-ips&family=washingtondc&ft:locale=en-US)
    -   [Playbook for ModSec Brute force by IP Burst](https://servicenow-staging.fluidtopics.net/access?context=playbook-modsec-bruteforce-ip&family=washingtondc&ft:locale=en-US)
-   **[Manage post incident activities](https://servicenow-staging.fluidtopics.net/access?context=c_PostIncidentReview&family=washingtondc&ft:locale=en-US)**
...
-   **[Security Incident Response Workspace](https://servicenow-staging.fluidtopics.net/access?context=sir-workspace-landing-page&family=washingtondc&ft:locale=en-US)**
...
-   **[Activate and configure the VirusTotal integration](https://servicenow-staging.fluidtopics.net/access?context=activate-configure-virustotal&family=washingtondc&ft:locale=en-US)**
...
-   **[Security Incident Response integration with AWS Security Hub](https://servicenow-staging.fluidtopics.net/access?context=aws-security-hub-integration&family=xanadu&ft:locale=en-US)**
...
-   **[Internet Content Adaption Protocol \(ICAP\) integration for DLP IR](https://servicenow-staging.fluidtopics.net/access?context=icap-dlp-integration&family=xanadu&ft:locale=en-US)**
...
-   **[Playbook for zero-day vulnerability](https://servicenow-staging.fluidtopics.net/access?context=playbook-for-zero-day&family=xanadu&ft:locale=en-US)**
...
-   **[Configure Shift Handover Templates](https://servicenow-staging.fluidtopics.net/access?context=configure-shift-handover-templates&family=xanadu&ft:locale=en-US)**
...
-   **[Configure Slack chat connector for major security incidents](https://servicenow-staging.fluidtopics.net/access?context=configure-slack-chat-connector-msi&family=xanadu&ft:locale=en-US)**
...
-   **[Playbook for Legal Request](https://servicenow-staging.fluidtopics.net/access?context=playbook-legal-request&family=xanadu&ft:locale=en-US)**
...
-   **[Add Zscaler Internet Access URL category lists](https://servicenow-staging.fluidtopics.net/access?context=create-zscaler-internet-access-url-category-manually&family=xanadu&ft:locale=en-US)**
...
-   **[Configure how an automatic event is created](https://servicenow-staging.fluidtopics.net/access?context=configure-automatic-event-creation-profile&family=xanadu&ft:locale=en-US) and [MISP event data](https://servicenow-staging.fluidtopics.net/access?context=misp-event-data&family=xanadu&ft:locale=en-US)**

Add security tags during automatic MISP profile configuration.

-   **[Mapping DLP incident status with Netskope](https://servicenow-staging.fluidtopics.net/access?context=map-incident-status&family=xanadu&ft:locale=en-US)**

Provide the mappings between the DLP Incident status in your ServiceNow instance and the Netskope Object status.

-   **[Define the new Risk Score Calculator Rules](https://servicenow-staging.fluidtopics.net/access?context=define-risk-score-calculator-rules-sir&family=xanadu&ft:locale=en-US)**
...
-   **[Managing MSIM status reports](https://servicenow-staging.fluidtopics.net/access?context=reports-and-metrics&family=xanadu&ft:locale=en-US)**
...
-   **[Microsoft Azure Sentinel integration](https://servicenow-staging.fluidtopics.net/access?context=microsoft-azure-sentinel-integration&family=washingtondc&ft:locale=en-US)Microsoft Azure Sentinel integration**
    -   Any new or updated changes made in Microsoft Azure Sentinel will automatically update the respective SIR incident data while mapping the Microsoft Azure Sentinel fields. For more information, see[Map the Microsoft Azure Sentinel incident fields](https://servicenow-staging.fluidtopics.net/access?context=map-azure-sentinel-incident-fields&family=washingtondc&ft:locale=en-US).
    -   Pull all open and closed Azure Sentinel incidents for the period up to 6 months. For more information, see [Schedule the Microsoft Azure Sentinel incident retrieval](https://servicenow-staging.fluidtopics.net/access?context=schedule-retrieve-and-ingest-incident-data&family=washingtondc&ft:locale=en-US).
...
-   **[Security Incident Response Orchestration](https://servicenow-staging.fluidtopics.net/access?context=c_SecIncRespOrchestration&family=xanadu&ft:locale=en-US)**
...
[Security Incident Response Orchestration flows and actions](https://servicenow-staging.fluidtopics.net/access?context=sec-inc-resp-orchestration-workflows&family=xanadu&ft:locale=en-US)

</td><td>

Workflow is migrated to the Flow Designer in following sections:-   [Create Lookup Request for IoC Changes Flow](https://servicenow-staging.fluidtopics.net/access?context=t_CreateScanRequestforIoCChanges&family=xanadu&ft:locale=en-US)
-   [Security Incident Response- Get Network Statistics Flow](https://servicenow-staging.fluidtopics.net/access?context=obtain-network-statistics-workflow&family=xanadu&ft:locale=en-US)
-   [Security Incident Response - Get Running Services Flow](https://servicenow-staging.fluidtopics.net/access?context=get-running-services-workflow&family=xanadu&ft:locale=en-US)


</td></tr></tbody>
</table>-   **[Security Operations common functionality](https://servicenow-staging.fluidtopics.net/access?context=sec-ops-common-functionality&family=xanadu&ft:locale=en-US)**
...
[Security Operations Integration- Block Request capability](https://servicenow-staging.fluidtopics.net/access?context=block-request-capability&family=xanadu&ft:locale=en-US)

</td><td>

Workflow is migrated to the Flow Designer flows in the following integrations:-   [Run Block Request](https://servicenow-staging.fluidtopics.net/access?context=run-block-request&family=xanadu&ft:locale=en-US)
-   [Security Operations Integration - Block Request Flow](https://servicenow-staging.fluidtopics.net/access?context=secops-integration-block-request-workflow&family=xanadu&ft:locale=en-US)


</td></tr><tr><td>

[Security Operations Integration- Get Network Statistics capability](https://servicenow-staging.fluidtopics.net/access?context=get-network-statistics-capability&family=xanadu&ft:locale=en-US)

</td><td>

Workflow is migrated to the Flow Designer in following sections:-   [Execution Tracking - Begin \(CIs\) Flow Action](https://servicenow-staging.fluidtopics.net/access?context=execution-tracking-begins-cis-activity&family=xanadu&ft:locale=en-US)
-   [Security Incident Response- Get Network Statistics Flow](https://servicenow-staging.fluidtopics.net/access?context=obtain-network-statistics-workflow&family=xanadu&ft:locale=en-US)


</td></tr><tr><td>

[Security Operations Integration- Get Running Processes capability](https://servicenow-staging.fluidtopics.net/access?context=get-running-processes-capability&family=xanadu&ft:locale=en-US)

</td><td>

Workflow is migrated to the Flow Designer in following sections:-   [Security Operations - Get Running Processes Flow](https://servicenow-staging.fluidtopics.net/access?context=secops-integration-get-running-processes-workflow&family=xanadu&ft:locale=en-US)
-   [Security Operations Carbon Black Integration - Get Running Processes Flow](https://servicenow-staging.fluidtopics.net/access?context=secops-integration-cb-get-running-processes-workflow&family=xanadu&ft:locale=en-US)


</td></tr><tr><td>

[Security Operations Integration- Isolate Host capability](https://servicenow-staging.fluidtopics.net/access?context=isolate-host-capability&family=xanadu&ft:locale=en-US)

</td><td>

Workflow is migrated to the Flow Designer in following sections:-   [Security Operations - Isolate Host Flow](https://servicenow-staging.fluidtopics.net/access?context=secops-integration-isolate-host-workflow&family=xanadu&ft:locale=en-US)
-   [Run Isolate Host](https://servicenow-staging.fluidtopics.net/access?context=run-isolate-host&family=xanadu&ft:locale=en-US)
-   [Security Operations Carbon Black Integration - Isolate Host Flow](https://servicenow-staging.fluidtopics.net/access?context=secops-integration-cb-isolate-host-workflow&family=xanadu&ft:locale=en-US)


</td></tr><tr><td>

[Security Operations Integration- Publish to Watchlist capability](https://servicenow-staging.fluidtopics.net/access?context=pubish-to-watchlist-capability&family=xanadu&ft:locale=en-US)

</td><td>

Workflow is migrated to the Flow Designer in following section:-   [Security Operations Integration - Publish to Watchlist Flow](https://servicenow-staging.fluidtopics.net/access?context=secops-integration-publish-watchlist-workflow&family=xanadu&ft:locale=en-US)


</td></tr><tr><td>

[Security Operations Integration- Sightings Search capability](https://servicenow-staging.fluidtopics.net/access?context=sightings-search-capability&family=xanadu&ft:locale=en-US)

</td><td>

Workflow is migrated to the Flow Designer in following section:-   [Security Operations Integration - Sightings Search Flow](https://servicenow-staging.fluidtopics.net/access?context=secops-integration-sightings-search-workflow&family=xanadu&ft:locale=en-US)


</td></tr></tbody>
</table>-   **[Security Incident Response integrations](https://servicenow-staging.fluidtopics.net/access?context=sir_integrations&family=xanadu&ft:locale=en-US)**
...
[CrowdStrike Falcon Host integration](https://servicenow-staging.fluidtopics.net/access?context=crowdstrike-falcon-host-landing-page&family=xanadu&ft:locale=en-US)

</td><td>

Workflow is migrated to the Flow Designer in following sections:-   [Get started with the CrowdStrike Falcon Host integration](https://servicenow-staging.fluidtopics.net/access?context=activate-configure-crowdstrike-host&family=xanadu&ft:locale=en-US)
-   [Security Operations CrowdStrike Falcon Host - Publish to Watchlist Flow](https://servicenow-staging.fluidtopics.net/access?context=secops-integration-crowdstrike-publish&family=xanadu&ft:locale=en-US)


</td></tr></tbody>
</table>-   **[Review and assign your DLP incidents](https://servicenow-staging.fluidtopics.net/access?context=review-and-assign-dlp-incidents&family=xanadu&ft:locale=en-US)**

Providing a closure code when closing a DLP incident from the DLP IR analyst workspace is now mandatory.

-   **[Administer](https://servicenow-staging.fluidtopics.net/access?context=data-loss-prevention-administration&family=xanadu&ft:locale=en-US)**
...
-   **[Install and configure the Netskope DLP integration for Data Loss Prevention](https://servicenow-staging.fluidtopics.net/access?context=install-configure-netskope-dlp-integration&family=xanadu&ft:locale=en-US)**

The Netskope integration now supports DLP incident ingestion.

-   **[Manage incidents](https://servicenow-staging.fluidtopics.net/access?context=data-loss-prevention-incident-management&family=xanadu&ft:locale=en-US)**

View the forensic details of DLP Incidents in both the DLP IR Analyst workspace and DLP End user workspace.

-   **[Download evidence files](https://servicenow-staging.fluidtopics.net/access?context=download-files-netskope&family=xanadu&ft:locale=en-US)**
