---
title: Combined Skills Foundation release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Skills Foundation from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-skillsfoundation-release-notes.html
release: zurich
...
# Combined Skills Foundation release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Skills Foundation from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Skills Foundation release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
Between your current release family and Zurich, new features were introduced for Skills Foundation.
...
Between your current release family and Zurich, some changes were made to existing Skills Foundation features.
...
Between your current release family and Zurich, some Skills Foundation features or functionality were removed.
...
Between your current release family and Zurich, some Skills Foundation features or functionality were deprecated.
