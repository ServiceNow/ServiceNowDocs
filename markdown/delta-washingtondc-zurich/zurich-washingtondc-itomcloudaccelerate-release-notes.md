---
title: Combined ITOM Cloud Accelerate release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for ITOM Cloud Accelerate from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-itomcloudaccelerate-release-notes.html
release: zurich
...
# Combined ITOM Cloud Accelerate release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for ITOM Cloud Accelerate from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family ITOM Cloud Accelerate release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading ITOM Cloud Accelerate to Zurich
...
Between your current release family and Zurich, new features were introduced for ITOM Cloud Accelerate.
...
-   **[Cloud Services Catalog](https://servicenow-staging.fluidtopics.net/access?context=csc-home&family=washingtondc&ft:locale=en-US)Cloud Services Catalog \(CSC\) Guided Setup**
...
-   **[Cloud Services Catalog](https://servicenow-staging.fluidtopics.net/access?context=csc-home&family=washingtondc&ft:locale=en-US)Cloud Services Catalog app features**
...
For more information, see [Set up Amazon Web Services on Cloud Services Catalog](https://servicenow-staging.fluidtopics.net/access?context=setting-up-aws-on-cloud-services-catalog&family=washingtondc&ft:locale=en-US), [Set up Microsoft Azure Cloud on Cloud Services Catalog](https://servicenow-staging.fluidtopics.net/access?context=setting-up-azure-cloud-on-cloud-services-catalog&family=washingtondc&ft:locale=en-US) and [Setting up Google Cloud Platform on Cloud Services Catalog](https://servicenow-staging.fluidtopics.net/access?context=setting-up-google-cloud-platform-on-cloud-services-catalog&family=washingtondc&ft:locale=en-US).
...
-   **[Cloud Account Management](https://servicenow-staging.fluidtopics.net/access?context=cam-landing&family=yokohama&ft:locale=en-US)**
...
-   **[Configure a custom catalog ID in Cloud Account Management account request](https://servicenow-staging.fluidtopics.net/access?context=configuring-catalog-ids-in-cam-account-request&family=zurich&ft:locale=en-US)**
...
-   **[Viewing Cloud Account Management dashboards](https://servicenow-staging.fluidtopics.net/access?context=about-cam-dashboard&family=zurich&ft:locale=en-US)**
...
-   **[Viewing the home page](https://servicenow-staging.fluidtopics.net/access?context=view-home-page&family=zurich&ft:locale=en-US) in Cloud Account Management**
...
-   **[Cloud Provisioning and Governance](https://servicenow-staging.fluidtopics.net/access?context=cloud-management-v2-landing-page&family=zurich&ft:locale=en-US)**
...
Between your current release family and Zurich, some changes were made to existing ITOM Cloud Accelerate features.
...
-   **Enhanced [Cloud Service Catalog](https://servicenow-staging.fluidtopics.net/access?context=csc-home&family=washingtondc&ft:locale=en-US)**
...
-   **Enhanced [Cloud Services Catalog](https://servicenow-staging.fluidtopics.net/access?context=csc-home&family=xanadu&ft:locale=en-US) Cloud Services Catalog experience**
...
-   **[Cloud Provisioning and Governance: Terraform Connector](https://servicenow-staging.fluidtopics.net/access?context=cpg-terraform-connector-landing-page&family=yokohama&ft:locale=en-US)**
...
Between your current release family and Zurich, some ITOM Cloud Accelerate features or functionality were removed.
...
Between your current release family and Zurich, some ITOM Cloud Accelerate features or functionality were deprecated.
...
The ITOM Cloud Accelerate features are available as an application at [Cloud Accelerate](https://store.servicenow.com/sn_appstore_store.do#!/store/search?listingtype=allintegrations%253Bancillary_app%253Bcertified_apps%253Bcontent%253Bindustry_solution%253Boem%253Butility%253Btemplate%253Bgenerative_ai%253Bsnow_solution&q=cloud%20governance), on the ServiceNow Store. Contact your ServiceNow sales representative to procure the ITOM Cloud Accelerate entitlement.

 The [Cloud Service Catalog](https://servicenow-staging.fluidtopics.net/access?context=csc-home&family=washingtondc&ft:locale=en-US) application is available with the [ITOM Cloud Accelerate](https://servicenow-staging.fluidtopics.net/access?context=cloud-governance&family=washingtondc&ft:locale=en-US) entitlements. Alternatively, you can install it by requesting them from [https://store.servicenow.com/sn\_appstore\_store.do\#!/store/application/bc3429fc24e02910f877b722d6bbdcaf](https://store.servicenow.com/sn_appstore_store.do#!/store/application/bc3429fc24e02910f877b722d6bbdcaf). You must have ServiceNow Employee Center as a prerequisite to launch and use the [Cloud Service Catalog](https://servicenow-staging.fluidtopics.net/access?context=csc-home&family=washingtondc&ft:locale=en-US) application.

 **Note:** Cloud Provisioning and Governance is already included as a part of ITOM entitlements so you don't need to procure it separately. For details, see [Request the Cloud Provisioning and Governance application](https://servicenow-staging.fluidtopics.net/access?context=request-plugin-cloud-mgt&family=washingtondc&ft:locale=en-US).

 **Note:** License migration: If you have exchangeable Cloud Optimization licenses, contact your ServiceNow account representative to migrate your licenses to ITOM Cloud Accelerate without charge.
...
-   Control the life cycle and usage of your resources through the improved Request console.
 ...
 See [Cloud Governance](https://servicenow-staging.fluidtopics.net/access?context=cloud-governance&family=washingtondc&ft:locale=en-US) for more information.
...
-   Access and manage your cloud resources and publish your cloud offerings to a catalog by using the added features in the ServiceNow Cloud Services Catalog user interface.
 ...
 See [ITOM Cloud Accelerate](https://servicenow-staging.fluidtopics.net/access?context=itom-governance-landing-page&family=xanadu&ft:locale=en-US) for more information.
...
See [Cloud Governance](https://servicenow-staging.fluidtopics.net/access?context=cloud-governance&family=yokohama&ft:locale=en-US) for more information.
...
-   Migrated legacy workflows to subflows in Cloud Provisioning and Governance.
 ...
 See [Cloud Governance](https://servicenow-staging.fluidtopics.net/access?context=cloud-governance&family=zurich&ft:locale=en-US) for more information.
