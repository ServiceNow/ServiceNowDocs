---
title: Combined Health Log Analytics release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Health Log Analytics from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-healthloganalytics-release-notes.html
release: zurich
...
# Combined Health Log Analytics release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Health Log Analytics from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Health Log Analytics release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Scale Health Log Analytics to support increased log ingestion](https://servicenow-staging.fluidtopics.net/access?context=hla-scale-request&family=washingtondc&ft:locale=en-US)**
...
-   **[Enjoy a significantly faster log streaming rate with the Lighting gRPC client for MID Server communication with the ServiceNow instance](https://servicenow-staging.fluidtopics.net/access?context=hla-configuration-preferences&family=xanadu&ft:locale=en-US)**
...
-   **[Stream system logs from Glide to Health Log Analytics](https://servicenow-staging.fluidtopics.net/access?context=hla-data-input-glide-syslog&family=xanadu&ft:locale=en-US)**
...
-   Stream logs in a scalable, more stable way with Health Log Analytics by using the new ServiceNow infrastructure.
 ...
 See [Health Log Analytics](https://servicenow-staging.fluidtopics.net/access?context=hla-landing-page&family=washingtondc&ft:locale=en-US) for more information.
...
-   Stream system logs from Glide to Health Log Analytics.
 ...
 See [Health Log Analytics](https://servicenow-staging.fluidtopics.net/access?context=hla-landing-page&family=xanadu&ft:locale=en-US) for more information.
