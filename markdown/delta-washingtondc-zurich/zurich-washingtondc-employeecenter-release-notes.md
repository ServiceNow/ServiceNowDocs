---
title: Combined Employee Center release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Employee Center from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-employeecenter-release-notes.html
release: zurich
...
# Combined Employee Center release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Employee Center from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Employee Center release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Employee Center to Zurich
...
Between your current release family and Zurich, new features were introduced for Employee Center.
...
-   **[News articles](https://servicenow-staging.fluidtopics.net/access?context=ec-news-articles&family=washingtondc&ft:locale=en-US)**
...
-   **[Add content destination](https://servicenow-staging.fluidtopics.net/access?context=ec-add-content-destination&family=washingtondc&ft:locale=en-US)**
...
-   **[Rich Content Editor](https://servicenow-staging.fluidtopics.net/access?context=ec-rich-content&family=washingtondc&ft:locale=en-US)**
...
-   **[Video hosting integrations framework](https://servicenow-staging.fluidtopics.net/access?context=content-providers&family=washingtondc&ft:locale=en-US)**
...
-   **[Create campaign stages \(bundles\) using Content Experience Builder](https://servicenow-staging.fluidtopics.net/access?context=ecpro-campaign-builder&family=washingtondc&ft:locale=en-US)**
...
-   **[Approvals in Now Mobile](https://servicenow-staging.fluidtopics.net/access?context=approvals-mesp-ec&family=washingtondc&ft:locale=en-US)**
...
-   **[Workday approvals in Now Mobile](https://servicenow-staging.fluidtopics.net/access?context=ec-workday-mobile&family=washingtondc&ft:locale=en-US)**

Access all your Workday approval tasks on the Now Mobile app. Approve or reject a task or navigate to the Workday portal.

-   **[Integrated experience and service feedback](https://servicenow-staging.fluidtopics.net/access?context=ex-fdback-ovrvw&family=washingtondc&ft:locale=en-US)**
...
-   **[Employee Center Pro Kiosk](https://servicenow-staging.fluidtopics.net/access?context=deskless-kiosk-overview&family=washingtondc&ft:locale=en-US)**
...
-   **[Quick start tests for Employee Center](https://servicenow-staging.fluidtopics.net/access?context=quick-start-tests-employee-center&family=washingtondc&ft:locale=en-US)**
...
-   **[Accelerate news article creation with reusable articles](https://servicenow-staging.fluidtopics.net/access?context=ec-content-templates&family=xanadu&ft:locale=en-US)**
...
-   **[Content engagement](https://servicenow-staging.fluidtopics.net/access?context=ec-content-engagement&family=xanadu&ft:locale=en-US)**
...
-   **[Employee Center Pro Kiosk](https://servicenow-staging.fluidtopics.net/access?context=deskless-kiosk-overview&family=xanadu&ft:locale=en-US)**
...
-   **[Guided Self-Service in Employee Center](https://servicenow-staging.fluidtopics.net/access?context=gss-guided-self-service-overview&family=xanadu&ft:locale=en-US)**
...
-   **[Content operations dashboard](https://servicenow-staging.fluidtopics.net/access?context=ec-content-operations&family=xanadu&ft:locale=en-US)**
...
-   **[Content Analytics support for Content Publishing](https://servicenow-staging.fluidtopics.net/access?context=content-library-overview-dashboard&family=xanadu&ft:locale=en-US)**
...
-   **[Enhanced copy-paste options in Rich Content Editor](https://servicenow-staging.fluidtopics.net/access?context=ec-rich-content-text&family=xanadu&ft:locale=en-US)**
...
-   **[Integrated service and experience feedback in Now Mobile](https://servicenow-staging.fluidtopics.net/access?context=ex-service-mobile&family=xanadu&ft:locale=en-US)**

Access feedback functionality more easily through the Experience and Service feedback functionality in Now® Mobile.

-   **[Create rich content from portal widgets](https://servicenow-staging.fluidtopics.net/access?context=ec-create-content-widgets&family=xanadu&ft:locale=en-US)**

Create or edit content directly from the Employee Center portal pages.

-   **[Hide parameters in the Rich Content Editor](https://servicenow-staging.fluidtopics.net/access?context=configure-content-rendering-parameter&family=xanadu&ft:locale=en-US)**
...
-   **[New campaign demo data for Content Experiences](https://servicenow-staging.fluidtopics.net/access?context=ecpro-campaigns&family=xanadu&ft:locale=en-US)**
...
-   **[Quick start tests for Employee Center](https://servicenow-staging.fluidtopics.net/access?context=quick-start-tests-employee-center&family=xanadu&ft:locale=en-US)**
...
-   **[Favoriting topic pages](https://servicenow-staging.fluidtopics.net/access?context=app-launcher-usability&family=yokohama&ft:locale=en-US)**
...
-   **[Single-click taxonomy sync](https://servicenow-staging.fluidtopics.net/access?context=config-adv-portal-nav-as-menu&family=yokohama&ft:locale=en-US)**

Sync taxonomy updates across Advanced Portal Navigation hierarchy levels with one click.

-   **[Guided Self-Service enhancements](https://servicenow-staging.fluidtopics.net/access?context=gss-guided-self-service-overview&family=yokohama&ft:locale=en-US)**
...
-   **[Enhanced apps discovery and visibility preferences \(Employee Center Pro\)](https://servicenow-staging.fluidtopics.net/access?context=applauncher-enable-availability&family=yokohama&ft:locale=en-US)**

Employees can search for authorized work applications using the AI-powered global search bar.

-   **[Appointment booking with HR representative \(Employee Center Pro\)](https://servicenow-staging.fluidtopics.net/access?context=appointment-booking&family=yokohama&ft:locale=en-US)**
...
-   **[Rich Content Editor updates \(Employee Center Pro\)](https://servicenow-staging.fluidtopics.net/access?context=ec-rich-content&family=yokohama&ft:locale=en-US)**
...
-   **[Portal shortcuts for content authoring \(Employee Center Pro\)](https://servicenow-staging.fluidtopics.net/access?context=ec-create-content-widgets&family=yokohama&ft:locale=en-US)**
...
-   **[Integrated experience and service feedback](https://servicenow-staging.fluidtopics.net/access?context=ex-fdback-ovrvw&family=yokohama&ft:locale=en-US) \(Employee Center Pro\)**
...
-   **[Live company events hosting and communications framework \(Employee Center Pro\)](https://servicenow-staging.fluidtopics.net/access?context=ec-company-events&family=yokohama&ft:locale=en-US)**
...
-   **[Improved topic search ranking](https://servicenow-staging.fluidtopics.net/access?context=config-topic-search-relevance&family=yokohama&ft:locale=en-US)**
...
-   **[Quick start tests for Employee Center](https://servicenow-staging.fluidtopics.net/access?context=quick-start-tests-employee-center&family=yokohama&ft:locale=en-US)**
...
-   **[Check latest company news and events](https://servicenow-staging.fluidtopics.net/access?context=check-company-newsevent-ai-agent-for-emp-exp&family=zurich&ft:locale=en-US)**
...
-   **[Now Assist for Employee Experience Summarization skill](https://servicenow-staging.fluidtopics.net/access?context=activate-now-assist-skills-uex&family=zurich&ft:locale=en-US)**
...
-   **[Now Assist for Employee Experience plugin](https://servicenow-staging.fluidtopics.net/access?context=now-assisit-employee-exp&family=zurich&ft:locale=en-US)**
...
-   **[Browser Extension for Employee Center](https://servicenow-staging.fluidtopics.net/access?context=ecbe-intro&family=zurich&ft:locale=en-US)**
...
-   **[Enhanced Requests Experience](https://servicenow-staging.fluidtopics.net/access?context=my-requests-update-intro&family=zurich&ft:locale=en-US)**
...
-   **[High-traffic experience](https://servicenow-staging.fluidtopics.net/access?context=ec-load-high-traffic&family=zurich&ft:locale=en-US)**
...
-   **[Taxonomy and connected content](https://servicenow-staging.fluidtopics.net/access?context=track-new-content&family=zurich&ft:locale=en-US)**
...
-   **[Mega menu load](https://servicenow-staging.fluidtopics.net/access?context=config-mega-menu-async-load&family=zurich&ft:locale=en-US)**
...
-   **[Notifications for Employee Center enhancements](https://servicenow-staging.fluidtopics.net/access?context=notifications-ec&family=zurich&ft:locale=en-US)**

Get Notifications for Employee Center in Content engagement that is available with Employee Center Pro. For more information, see [Employee Center Pro release notes](https://servicenow-staging.fluidtopics.net/access?context=employee-center-pro-rn&family=zurich&ft:locale=en-US).

-   **[Quick start tests for Employee Center](https://servicenow-staging.fluidtopics.net/access?context=quick-start-tests-employee-center&family=zurich&ft:locale=en-US)**
...
Between your current release family and Zurich, some changes were made to existing Employee Center features.
...
-   **[Content Analytics](https://servicenow-staging.fluidtopics.net/access?context=ecpro-content-automation-analytics&family=xanadu&ft:locale=en-US)**
...
-   **[Experience and Service Feedback](https://servicenow-staging.fluidtopics.net/access?context=ex-fdback-ovrvw&family=xanadu&ft:locale=en-US)**
...
-   **[SharePoint Online Search Connector](https://servicenow-staging.fluidtopics.net/access?context=sharepoint-search-overview&family=xanadu&ft:locale=en-US)**
...
Between your current release family and Zurich, some Employee Center features or functionality were removed.
...
Between your current release family and Zurich, some Employee Center features or functionality were deprecated.
...
-   Use the employee experience feedback feature to get relevant feedback from your users.
 ...
 See [Employee Center](https://servicenow-staging.fluidtopics.net/access?context=employee-center-landing-page&family=washingtondc&ft:locale=en-US) for more information.
...
-   Access content management tools from Content Publishing, Content Analytics, and Content Governance plugins in the Content Operations dashboard.
 ...
 See [Employee Center](https://servicenow-staging.fluidtopics.net/access?context=employee-center-landing-page&family=xanadu&ft:locale=en-US) for more information.
...
-   Host live company events seamlessly in the employee portal with streamlined pre-event communications and a drag-and-drop editor for easy content creation.
 ...
 See [Employee Center](https://servicenow-staging.fluidtopics.net/access?context=employee-center-landing-page&family=yokohama&ft:locale=en-US) for more information.
...
-   Enable employees to check their latest company news and upcoming events using Now Assist in Virtual Agent with the **Company News &amp; Events AI Agent** in the Now Assist for Employee Experience. The AI Agent displays a list of all the latest news and planned events in the company. For more information, see [Check latest company news and events](https://servicenow-staging.fluidtopics.net/access?context=check-company-newsevent-ai-agent-for-emp-exp&family=zurich&ft:locale=en-US).
-   Employees can check all their to-do tasks and pending approvals using Now Assist in Virtual Agent for Microsoft Teams.
-   Enable a summary of the request, requested item, or case for approval task using Now Assist for Employee Experience. The skill provides a summary of the selected item from the available list that you want to work on. For more information, see [Now Assist for Employee Experience Summarization skill](https://servicenow-staging.fluidtopics.net/access?context=activate-now-assist-skills-uex&family=zurich&ft:locale=en-US).
...
-   Improve the My Requests experience with adoptive and scalable enhancements.
 ...
 See [Employee Center](https://servicenow-staging.fluidtopics.net/access?context=employee-center-landing-page&family=zurich&ft:locale=en-US) for more information.
