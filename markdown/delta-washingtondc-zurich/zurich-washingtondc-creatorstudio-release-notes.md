---
title: Combined Creator Studio release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Creator Studio from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-creatorstudio-release-notes.html
release: zurich
...
# Combined Creator Studio release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Creator Studio from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Creator Studio release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Use templates to quickly build forms to intake requests](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-work-with-forms&family=washingtondc&ft:locale=en-US)**

An easy-to-use form building environment enables no-code development of forms.

-   **[Create automated playbooks to streamline workflows](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-working-with-automations&family=washingtondc&ft:locale=en-US)**
...
-   **[Intuitive form submission workspace is ready to use out-of-the-box](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-form-submissions-workspace-about&family=washingtondc&ft:locale=en-US)**
...
-   **[Co-create apps with other developers using collaboration](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-collaboration-roles&family=washingtondc&ft:locale=en-US)**
...
-   **[Deploy apps to production instances using Pipelines and Deployments](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-publishing-apps&family=washingtondc&ft:locale=en-US)**
...
-   **[Associate a topic with a form](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-edit-form-settings&family=xanadu&ft:locale=en-US)**

You can now add a topic to the settings for a form, enabling users to browse forms by their related topics.

-   **[Dynamic behavior for forms](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-dynamic-behavior&family=xanadu&ft:locale=en-US)**
...
-   **[Define custom activities for use in automations](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-add-automation&family=xanadu&ft:locale=en-US)**
...
-   **[Interact with sample records within Creator Studio](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-preview-record&family=xanadu&ft:locale=en-US)**
...
-   **[Use questions as process triggers](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-add-trigger-automation&family=xanadu&ft:locale=en-US)**
...
-   **[New send email activity in automations](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-add-activities-automation&family=xanadu&ft:locale=en-US)**
...
-   **[Add curated questions to a form using question sets](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-edit-form&family=xanadu&ft:locale=en-US)**
...
-   **[Better performance for reference-based form questions](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-form-elements-ref&family=xanadu&ft:locale=en-US)**
...
-   Create apps that are natively compliant with the ServiceNow AI Platform without the risks associated with traditional development.
 ...
 See [Creator Studio: Creating applications without writing code](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-landing&family=washingtondc&ft:locale=en-US) for more information.
...
-   Add question sets curated by your admin to a form
 ...
 See [Creator Studio](https://servicenow-staging.fluidtopics.net/access?context=creator-studio-landing&family=xanadu&ft:locale=en-US) for more information.
