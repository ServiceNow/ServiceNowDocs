---
title: Combined Opportunity Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Opportunity Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-opportunitymanagement-release-notes.html
release: zurich
...
# Combined Opportunity Management release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Opportunity Management from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Opportunity Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Opportunity needs analysis](https://servicenow-staging.fluidtopics.net/access?context=configuring-needs-analysis&family=washingtondc&ft:locale=en-US)**
...
-   **[Opportunity creation](https://servicenow-staging.fluidtopics.net/access?context=create-new-opportunity&family=washingtondc&ft:locale=en-US)**

Create opportunity headers and lines for recommended products.

-   **[Kanban boards](https://servicenow-staging.fluidtopics.net/access?context=opportunity-management-kanban-view&family=washingtondc&ft:locale=en-US)**
...
-   **[Generating quotes from opportunities](https://servicenow-staging.fluidtopics.net/access?context=opportunity-management-create-quote&family=washingtondc&ft:locale=en-US)**

Convert opportunities to sales quotes if you’re using the ServiceNow Quote Management application.

-   **[Pricing integration with Opportunity](https://servicenow-staging.fluidtopics.net/access?context=opportunity-management&family=washingtondc&ft:locale=en-US)**
...
-   View prices for a product offering from the catalog based on the selected price list.
 ...
 See [Opportunity Management](https://servicenow-staging.fluidtopics.net/access?context=opportunity-management&family=washingtondc&ft:locale=en-US) for more information.
