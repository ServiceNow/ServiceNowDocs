---
title: Combined Knowledge Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Knowledge Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-knowledgemanagement-release-notes.html
release: zurich
...
# Combined Knowledge Management release notes for upgrades from Washington DC to Zurich
...
-   **[Now Assist in Knowledge Management](https://servicenow-staging.fluidtopics.net/access?context=now-assist-knowledge-management&family=washingtondc&ft:locale=en-US)**
...
-   **[New report on Knowledge Management dashboard](https://servicenow-staging.fluidtopics.net/access?context=km-overview-dash&family=xanadu&ft:locale=en-US)**
...
-   **[Now Assist in Knowledge article generation from multiple cases](https://servicenow-staging.fluidtopics.net/access?context=Now-Assist-generate-article-coreui&family=xanadu&ft:locale=en-US)**
...
-   **[Enable AI Search on the Knowledge Management Service Portal](https://servicenow-staging.fluidtopics.net/access?context=knowledge-service-portal-searching&family=xanadu&ft:locale=en-US)**

Displays AI-powered search results for a selected article through AI Search.

-   **[Default advanced plugin installation](https://servicenow-staging.fluidtopics.net/access?context=activate-knowledge-advanced-plugin&family=xanadu&ft:locale=en-US)**
...
Knowledge Management is a ServiceNow AI Platform feature that is active by default. The Knowledge Management Service Portal is available with its plugin \(com.snc.knowledge\_serviceportal\) that is active by default.
 ...
 Activate the Knowledge Management Advanced plugin \(com.snc.knowledge\_advanced\) to enable advanced features for Knowledge Management. For more information, see [Activate the Knowledge Management Advanced plugin](https://servicenow-staging.fluidtopics.net/access?context=activate-knowledge-advanced-plugin&family=washingtondc&ft:locale=en-US)

 Additional plugins that enable various Knowledge Management features are available. For more information, see [Additional plugins for Knowledge Management](https://servicenow-staging.fluidtopics.net/access?context=additional-plugins-km&family=washingtondc&ft:locale=en-US).

 Activate the Sitemap Generator plugin \(sn\_ux\_seo\_sitemap\) to define and automatically generate XML sitemaps to improve the search engine optimization \(SEO\) of your public portal pages. You must also activate the Sitemap configuration record \(sitemap\_config\_KB\) and the sitemap configuration definition. For more information, see [Configure Sitemap Generator record](https://servicenow-staging.fluidtopics.net/access?context=config-sitemap-generator&family=washingtondc&ft:locale=en-US).
...
-   Now Assist in Knowledge Management Knowledge generation skill now available.
 ...
 See [Knowledge Management](https://servicenow-staging.fluidtopics.net/access?context=knowledge-management&family=washingtondc&ft:locale=en-US) for more information.
...
-   Select content in a knowledge article and shorten or elaborate it using the generative AI capabilities of Now Assist.
 ...
 See [Knowledge Management](https://servicenow-staging.fluidtopics.net/access?context=knowledge-management&family=xanadu&ft:locale=en-US) for more information.
