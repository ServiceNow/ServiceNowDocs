---
title: Combined DevOps Change Velocity release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for DevOps Change Velocity from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-devopschangevelocity-release-notes.html
release: zurich
...
# Combined DevOps Change Velocity release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for DevOps Change Velocity from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family DevOps Change Velocity release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[GitHub Issues integration](https://servicenow-staging.fluidtopics.net/access?context=playbook-enter-github-instance-details&family=washingtondc&ft:locale=en-US)**
...
-   **[Implement custom actions for pipelines using generic Docker container image](https://servicenow-staging.fluidtopics.net/access?context=servicenow-custom-actions-for-gitlab&family=washingtondc&ft:locale=en-US)**
...
-   **[User-created orchestration tool integration support](https://servicenow-staging.fluidtopics.net/access?context=devops-user-created-orchestration-tool-integration&family=washingtondc&ft:locale=en-US)**
...
-   **[GitLab pull request for change approval](https://servicenow-staging.fluidtopics.net/access?context=gitlab-pull-request-config&family=washingtondc&ft:locale=en-US)**
...
-   **[Jira Cloud integration](https://servicenow-staging.fluidtopics.net/access?context=create-jira-tool-dev-ops&family=washingtondc&ft:locale=en-US)**

Integrate DevOps Change Velocity with Jira Cloud and track Jira Issues for the configured projects.

-   **[JFrog Artifactory for GitHub, GitLab, and Azure DevOps](https://servicenow-staging.fluidtopics.net/access?context=associate-artifacts-jfrog&family=washingtondc&ft:locale=en-US)**
...
-   **[OAuth 2.0 authentication for Azure DevOps \(ADO\)](https://servicenow-staging.fluidtopics.net/access?context=set-up-azure-devops-oauth-2-0-credential&family=washingtondc&ft:locale=en-US)**
...
-   **[OAuth 2.0 authentication for Jira Cloud](https://servicenow-staging.fluidtopics.net/access?context=create-jira-tool-dev-ops&family=washingtondc&ft:locale=en-US)**
...
-   **[Change Management in SOW Admin Center](https://servicenow-staging.fluidtopics.net/access?context=manage-admin-console-sow-itsm&family=xanadu&ft:locale=en-US)**
...
-   **[OAuth 2.0 authentication for Azure DevOps \(ADO\)](https://servicenow-staging.fluidtopics.net/access?context=set-up-azure-devops-oauth-2-0-credential&family=xanadu&ft:locale=en-US)**

Use OAuth 2.0 authentication to connect your Azure DevOps tool with DevOps Change Velocity ensuring a more secure authentication method.

-   **[OAuth 2.0 authentication for Jira Cloud](https://servicenow-staging.fluidtopics.net/access?context=create-jira-tool-dev-ops&family=xanadu&ft:locale=en-US)**

Use OAuth 2.0 authentication to connect your Jira Cloud tool with DevOps Change Velocity ensuring a more secure authentication method.

-   **[Bitbucket Cloud tool integration with ServiceNow](https://servicenow-staging.fluidtopics.net/access?context=bitbucket-integration-dev-ops&family=xanadu&ft:locale=en-US)**
...
-   **[DevOps Change Workspace UI for simplified creation of custom tool integration with planning, coding and orchestration capabilities](https://servicenow-staging.fluidtopics.net/access?context=create-a-tool-integration-from-the-devops-change-workspace&family=xanadu&ft:locale=en-US)**
...
-   **[Import based evidence collection](https://servicenow-staging.fluidtopics.net/access?context=import-based-evidence-collection-for-orchestration-capability&family=xanadu&ft:locale=en-US)**
...
-   **[Enhanced automated change creation](https://servicenow-staging.fluidtopics.net/access?context=automate-devops-change-request&family=washingtondc&ft:locale=en-US)**
...
-   **[New state transition flows for DevOps change model](https://servicenow-staging.fluidtopics.net/access?context=devops-change-multimodel&family=washingtondc&ft:locale=en-US)**
...
-   **[Error handling for DevOps flows](https://servicenow-staging.fluidtopics.net/access?context=dev-ops-change-acceleration&family=washingtondc&ft:locale=en-US)**
...
-   **[DevOpsChangeRelationshipHelper script to retrieve change data](https://servicenow-staging.fluidtopics.net/access?context=retrieve-change-request-data-using-devopschangerelationshiphelper-script&family=washingtondc&ft:locale=en-US)**
...
-   **[New property to specify retry limit](https://servicenow-staging.fluidtopics.net/access?context=dev-ops-administration&family=washingtondc&ft:locale=en-US)**
...
-   **[Import request restart](https://servicenow-staging.fluidtopics.net/access?context=app-create-workspace&family=washingtondc&ft:locale=en-US)**

Restart an import request from the Import Request record that couldn’t be completed due to an error.

-   **[Automatically associate repositories](https://servicenow-staging.fluidtopics.net/access?context=apps-associate-objects-wkspc&family=washingtondc&ft:locale=en-US)**
...
-   **[Unit test type support for GitHub](https://servicenow-staging.fluidtopics.net/access?context=dev-ops-test-tool-integration&family=washingtondc&ft:locale=en-US)**
...
-   **[Change request creation with errors in DevOps data retrieval](https://servicenow-staging.fluidtopics.net/access?context=change-request-creation-with-devops-data-retrieval-errors&family=washingtondc&ft:locale=en-US)**

Enable change request creation even if there is an error in retrieving the DevOps data in a pipeline.

-   **[Multiple ServiceNow DevOps configurations in the same Jenkins instance](https://servicenow-staging.fluidtopics.net/access?context=configure-webhooks-manually-for-jenkins&family=washingtondc&ft:locale=en-US)**

Configure multiple ServiceNow DevOps connections in one Jenkins server.

-   **[Custom actions for GitLab using Docker](https://servicenow-staging.fluidtopics.net/access?context=servicenow-custom-actions-for-gitlab&family=washingtondc&ft:locale=en-US)**
...
-   **[Enhancements to DevOps Model change](https://servicenow-staging.fluidtopics.net/access?context=devops-change-multimodel&family=washingtondc&ft:locale=en-US)**
...
-   **[Branch details for artifacts and packages](https://servicenow-staging.fluidtopics.net/access?context=using-dev-ops-release-change&family=washingtondc&ft:locale=en-US)**

Branch details from pipeline executions are now available for artifacts and packages for better tracking.

-   **[Create lists](https://servicenow-staging.fluidtopics.net/access?context=add-new-list-in-list-module&family=washingtondc&ft:locale=en-US)**

Option to create customized lists added to the Changes, Tools, and Administration modules in the DevOps Change Workspace.

-   **[Jira Server connection using API key](https://servicenow-staging.fluidtopics.net/access?context=create-jira-tool-dev-ops&family=washingtondc&ft:locale=en-US)**

Connect to your Jira Server using API key authentication rather than basic authentication.

-   **[GitHub Actions reruns](https://servicenow-staging.fluidtopics.net/access?context=github-actions-integration-with-devops&family=washingtondc&ft:locale=en-US)**
...
-   **[Generalized Docker Container solution to support any orchestration tool](https://servicenow-staging.fluidtopics.net/access?context=servicenow-custom-actions-for-gitlab&family=washingtondc&ft:locale=en-US)**
...
-   **[Simplified onboarding of planning tools that are not supported in the base system](https://servicenow-staging.fluidtopics.net/access?context=onboard-gitlab-to-devops-change-velocity-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Default BitBucket branch property](https://servicenow-staging.fluidtopics.net/access?context=dev-ops-administration&family=washingtondc&ft:locale=en-US)**
...
-   **[Enhancements to DevOps Model change](https://servicenow-staging.fluidtopics.net/access?context=devops-change-multimodel&family=xanadu&ft:locale=en-US)**
    -   In-product guidance enables you to leverage DevOps models and easily create DevOps changes without disruption of your change process.
    -   To make the Change - DevOps – Implement flow of the DevOps model more suitable for DevOps changes, change tasks are no longer automatically created.
    -   The new Change – DevOps – Update execution state flow in the DevOps model means you no longer have to activate the DevOps Change Request Manual Approval flow to send a callback to the third-party orchestration tool.
    -   Fast-track your change process by using a new DevOps Simplified change model, which doesn’t contain the Assess state. Change approval for this model is based on the DevOps Simplified Model Change policy.
-   **[Branch details for artifacts and packages](https://servicenow-staging.fluidtopics.net/access?context=using-dev-ops-release-change&family=xanadu&ft:locale=en-US)**

Branch details from pipeline executions are now available for artifacts and packages for better tracking.

-   **[Create lists](https://servicenow-staging.fluidtopics.net/access?context=add-new-list-in-list-module&family=xanadu&ft:locale=en-US)**

Option to create customized lists added to the Changes, Tools, and Administration modules in the DevOps Change Workspace.

-   **[Jira Server connection using API key](https://servicenow-staging.fluidtopics.net/access?context=create-jira-tool-dev-ops&family=xanadu&ft:locale=en-US)**

Connect to your Jira Server using API key authentication rather than basic authentication.

-   **[GitHub Actions reruns](https://servicenow-staging.fluidtopics.net/access?context=github-actions-integration-with-devops&family=xanadu&ft:locale=en-US)**

Re-running failed GitHub jobs will now use the existing change request created for the failed jobs instead of creating new change requests.

-   **[Generalized Docker Container solution to support any orchestration tool](https://servicenow-staging.fluidtopics.net/access?context=servicenow-custom-actions-for-gitlab&family=xanadu&ft:locale=en-US)**

Use the generalized and extensible Docker Container solution to integrate any orchestration tool with DevOps Change Velocity for invoking pipeline actions like change request creation and collecting relevant DevOps data without having to rely on tool specific plugins or extensions.

-   **[Simplified onboarding of planning tools that are not supported in the base system](https://servicenow-staging.fluidtopics.net/access?context=onboard-gitlab-to-devops-change-velocity-workspace&family=xanadu&ft:locale=en-US)**

Integrate planning tools that are not supported in the base system by leveraging transformer rules. GitLab Issues is now available as one of the planning tools and is built leveraging this new approach so you can discover plans, import work items, and configure webhooks for work items \(issues\) in GitLab.

-   **[Enhanced manual DevOps change creation experience](https://servicenow-staging.fluidtopics.net/access?context=create-change-sow&family=xanadu&ft:locale=en-US)**

Add work items data in a manually created DevOps change request in  Service Operations Workspace  for  ITSM.

-   **[Default BitBucket branch property](https://servicenow-staging.fluidtopics.net/access?context=dev-ops-administration&family=xanadu&ft:locale=en-US)**

Specify the default Bitbucket branch name that must be used to create an import request in the **sn\_devops.bitbucket\_default\_branch** property.

-   **[Additional scans for DevOps Health Scan Content pack](https://servicenow-staging.fluidtopics.net/access?context=run-health-scan-check&family=xanadu&ft:locale=en-US)**
...
-   **[Import pull-request records for Bitbucket Server or Bitbucket Data Center](https://servicenow-staging.fluidtopics.net/access?context=devops-wkspc-bitbucket-tool-conn&family=xanadu&ft:locale=en-US)**

Import pull-request records for Bitbucket Server or Data Center for improved insights and efficiency.

-   **[Change request creation with errors in DevOps data retrieval for Harness pipelines](https://servicenow-staging.fluidtopics.net/access?context=change-request-creation-with-devops-data-retrieval-errors&family=xanadu&ft:locale=en-US)**

Enable change request creation even if there is an error in retrieving the DevOps data for a Harness pipeline.

-   **[Branch name filter](https://servicenow-staging.fluidtopics.net/access?context=create-devops-change-request-manual&family=xanadu&ft:locale=en-US)**
...
-   **[Test summary name in GitHub Actions](https://servicenow-staging.fluidtopics.net/access?context=servicenow-devops-test-report-custom-action&family=xanadu&ft:locale=en-US)**
...
-   **[Token based authentication for Rally](https://servicenow-staging.fluidtopics.net/access?context=configure-webhooks-for-rally-manually&family=xanadu&ft:locale=en-US)**

Configure webhooks for Rally using token based authentication instead of using the integration username and password.

-   **[Renamed variables for Docker](https://servicenow-staging.fluidtopics.net/access?context=servicenow-custom-actions-for-gitlab&family=xanadu&ft:locale=en-US)**
...
-   **[Security scan results](https://servicenow-staging.fluidtopics.net/access?context=dev-ops-change-acceleration&family=xanadu&ft:locale=en-US)**
...
-   **[Source of commits in SOW](https://servicenow-staging.fluidtopics.net/access?context=create-change-sow&family=xanadu&ft:locale=en-US)**
...
-   **[Track file changes](https://servicenow-staging.fluidtopics.net/access?context=sc-github&family=xanadu&ft:locale=en-US)**
...
-   **[Close code value for a change request](https://servicenow-staging.fluidtopics.net/access?context=dev-ops-administration&family=xanadu&ft:locale=en-US)**
...
-   **[Support for MID Server cluster](https://servicenow-staging.fluidtopics.net/access?context=playbook-enter-github-instance-details&family=xanadu&ft:locale=en-US)**
...
-   **[Improved UX for DevOps Change health scans](https://servicenow-staging.fluidtopics.net/access?context=run-health-scan-check&family=xanadu&ft:locale=en-US)**
...
-   **[Pipeline association for GitHub Actions](https://servicenow-staging.fluidtopics.net/access?context=sc-github&family=xanadu&ft:locale=en-US)**
...
-   **[Tool connection check status](https://servicenow-staging.fluidtopics.net/access?context=devops-reference-error-messages&family=xanadu&ft:locale=en-US)**
...
-   **[New roles for vulnerability integration](https://servicenow-staging.fluidtopics.net/access?context=installed-with-dev-ops&family=xanadu&ft:locale=en-US)**
...
-   Retrieve data associated with a change request using the DevOpsChangeRelationshipHelper script.
 ...
 See [DevOps Change Velocity](https://servicenow-staging.fluidtopics.net/access?context=devops-landing-page-new&family=washingtondc&ft:locale=en-US) for more information.
...
-   Benefit from accessibility improvements to create a configurable workspace that supports Web Content Accessibility Guidelines \(WCAG\) 2.1 Level AA conformance.
 ...
 See [DevOps Change Velocity](https://servicenow-staging.fluidtopics.net/access?context=devops-landing-page-new&family=xanadu&ft:locale=en-US) for more information.
