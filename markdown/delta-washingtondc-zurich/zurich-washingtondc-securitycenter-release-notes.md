---
title: Combined Security Center release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Security Center from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-securitycenter-release-notes.html
release: zurich
...
# Combined Security Center release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Security Center from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Security Center release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Security Center to Zurich
...
Between your current release family and Zurich, new features were introduced for Security Center.
...
-   **[Security Best Practices](https://servicenow-staging.fluidtopics.net/access?context=security-best-practices-manager&family=washingtondc&ft:locale=en-US) \(new in v1.5\)**

Manage your security best practices from the security best practices home page. You can also view the history of data related to security best practices and apply filters to the Security Best Practices table.


-   **[Customer Actions](https://servicenow-staging.fluidtopics.net/access?context=critical-updates&family=washingtondc&ft:locale=en-US)**

View timelines for when your Critical Updates are due so that you can plan and prioritize them. Get clear step-by-step guidance on how to implement Critical Updates within your instance. View logs related to your updates, including comments, instructions, and work notes for each step or update.
...
Between your current release family and Zurich, some changes were made to existing Security Center features.
...
-   **[Hardening settings baseline](https://servicenow-staging.fluidtopics.net/access?context=hardening-settings-baseline&family=washingtondc&ft:locale=en-US)**
...
Between your current release family and Zurich, some Security Center features or functionality were removed.
...
Between your current release family and Zurich, some Security Center features or functionality were deprecated.
...
Security Center is a store release and must be installed from the [ServiceNow store](https://store.servicenow.com/sn_appstore_store.do#!/store/home).
...
-   Use the enhanced Security Hardening tool, which implements the new Instance Security Hardening Setting Baseline version 2.0 \(Security Center 1.3\)and version 4.0 \(Security Center 1.5\).
 ...
 See [Security Best Practices](https://servicenow-staging.fluidtopics.net/access?context=security-best-practices-manager&family=washingtondc&ft:locale=en-US), [Customer Actions](https://servicenow-staging.fluidtopics.net/access?context=critical-updates&family=washingtondc&ft:locale=en-US), and [Hardening settings baseline](https://servicenow-staging.fluidtopics.net/access?context=hardening-settings-baseline&family=washingtondc&ft:locale=en-US) for more information.
