---
title: Combined Collaborative Work Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Collaborative Work Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-collaborativeworkmanagement-release-notes.html
release: zurich
...
# Combined Collaborative Work Management release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Collaborative Work Management from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Collaborative Work Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Shared Spaces for collaboration](https://servicenow-staging.fluidtopics.net/access?context=cwm-spaces&family=washingtondc&ft:locale=en-US)**
...
-   **[Flexible Boards for task management](https://servicenow-staging.fluidtopics.net/access?context=cwm-boards&family=washingtondc&ft:locale=en-US)**
...
-   **[Automations for tasks in Boards](https://servicenow-staging.fluidtopics.net/access?context=implementing-automations-in-collaborative-work-management&family=washingtondc&ft:locale=en-US)**
...
-   **[Collaborative documentation](https://servicenow-staging.fluidtopics.net/access?context=cwm-docs&family=washingtondc&ft:locale=en-US)**
...
-   **[Connecting to Planning portfolios](https://servicenow-staging.fluidtopics.net/access?context=connect-cwm-spw&family=washingtondc&ft:locale=en-US)**
...
-   **[Use templates for Boards and Docs](https://servicenow-staging.fluidtopics.net/access?context=templates-in-cwm-for-spaces-boards-and-docs&family=xanadu&ft:locale=en-US)**
...
-   **[Board views in CWM](https://servicenow-staging.fluidtopics.net/access?context=board-views-in-cwm&family=xanadu&ft:locale=en-US)**
...
-   **[Export a CWM Board to CSV or Microsoft Excel](https://servicenow-staging.fluidtopics.net/access?context=export-a-board-in-cwm-to-csv-or-excel&family=xanadu&ft:locale=en-US)**
...
-   **[Export a Doc in CWM to a PDF file](https://servicenow-staging.fluidtopics.net/access?context=export-a-doc-in-cwm-to-a-pdf-file&family=xanadu&ft:locale=en-US)**
...
-   **[My Work in CWM](https://servicenow-staging.fluidtopics.net/access?context=my-work-in-cwm&family=xanadu&ft:locale=en-US)**
...
-   **[Duplicate a Board in CWM](https://servicenow-staging.fluidtopics.net/access?context=duplicate-board-in-cwm&family=xanadu&ft:locale=en-US)**
...
-   **[Duplicate a Doc in CWM](https://servicenow-staging.fluidtopics.net/access?context=duplicate-doc-in-cwm&family=xanadu&ft:locale=en-US)**
...
-   **[Add People column users in Board automations](https://servicenow-staging.fluidtopics.net/access?context=implementing-automations-in-collaborative-work-management&family=xanadu&ft:locale=en-US)**
...
-   **[Share a Space in CWM and manage sharing permissions](https://servicenow-staging.fluidtopics.net/access?context=share-space-in-cwm&family=xanadu&ft:locale=en-US)**
...
-   Connect work to any ServiceNow AI Platform record such as Cases, Incidents, or Risks.
 ...
 See [Collaborative Work Management](https://servicenow-staging.fluidtopics.net/access?context=cwm-landing&family=washingtondc&ft:locale=en-US) for more information.
...
-   Save time and avoid manual copying of information with the ability to duplicate CWM Boards and Docs.
 ...
 See [Collaborative Work Management](https://servicenow-staging.fluidtopics.net/access?context=cwm-landing&family=xanadu&ft:locale=en-US) for more information.
