---
title: Combined Now Assist release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Now Assist from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-nowassist-release-notes.html
release: zurich
...
# Combined Now Assist release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Now Assist from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Now Assist release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[New Now Assist skills](https://servicenow-staging.fluidtopics.net/access?context=now-assist-skills&family=washingtondc&ft:locale=en-US)**
    -   [App generation](https://servicenow-staging.fluidtopics.net/access?context=now-assist-app-generation-skill&family=washingtondc&ft:locale=en-US)
    -   [Catalog item generation](https://servicenow-staging.fluidtopics.net/access?context=now-assist-catalog-item-generation&family=washingtondc&ft:locale=en-US)
    -   [Feedback summarization](https://servicenow-staging.fluidtopics.net/access?context=now-assist-feedback-summary&family=washingtondc&ft:locale=en-US)
    -   [KB generation](https://servicenow-staging.fluidtopics.net/access?context=now-assist-kb-generation&family=washingtondc&ft:locale=en-US)
    -   [Playbook generation](https://servicenow-staging.fluidtopics.net/access?context=now-assist-playbook-generation-skill&family=washingtondc&ft:locale=en-US)
...
-   **[Restrict Now Assist skills by user role in-product](https://servicenow-staging.fluidtopics.net/access?context=configure-a-now-assist-skill&family=washingtondc&ft:locale=en-US)**
...
-   **[Add conditions to skill availability](https://servicenow-staging.fluidtopics.net/access?context=configure-a-now-assist-skill&family=washingtondc&ft:locale=en-US)**
...
-   **[Assign the data steward role](https://servicenow-staging.fluidtopics.net/access?context=assign-data-steward-role&family=washingtondc&ft:locale=en-US)**

Select a dedicated user to determine data sharing preferences for your instance.

-   **[Using ITSM Virtual Agent pre-built LLM topics](https://servicenow-staging.fluidtopics.net/access?context=using-itsm-llm-topics&family=washingtondc&ft:locale=en-US)**
...
-   **[Create copies of Now Assist skills](https://servicenow-staging.fluidtopics.net/access?context=make-a-copy-of-a-now-assist-skill&family=washingtondc&ft:locale=en-US)**
...
-   **[Enable Dynamic Translation for Now Assist applications](https://servicenow-staging.fluidtopics.net/access?context=enable-dynamic-translation-for-now-assist-applications&family=washingtondc&ft:locale=en-US)**
...
-   **[Generate code from text using the Code with Now Assist dialog box](https://servicenow-staging.fluidtopics.net/access?context=generate-code&family=washingtondc&ft:locale=en-US)**
...
-   **[Now Assist panel icon displays asynchronous notifications](https://servicenow-staging.fluidtopics.net/access?context=now-assist-panel-overview&family=washingtondc&ft:locale=en-US)**
...
-   **[Now Assist journey checklist on the Overview page](https://servicenow-staging.fluidtopics.net/access?context=configuring-now-assist&family=washingtondc&ft:locale=en-US)**
...
-   **[New process for opting out of data sharing preferences](https://servicenow-staging.fluidtopics.net/access?context=opt-out-of-data-sharing-for-now-assist&family=washingtondc&ft:locale=en-US)**
...
-   **[New input and prompt output configuration for record summarization](https://servicenow-staging.fluidtopics.net/access?context=configure-a-now-assist-skill&family=washingtondc&ft:locale=en-US)**
...
-   **[Code completion off by default](https://servicenow-staging.fluidtopics.net/access?context=turn-on-code-completion&family=washingtondc&ft:locale=en-US)**
...
-   [Now Assist for Creator](https://servicenow-staging.fluidtopics.net/access?context=now-assist-for-creator-landing&family=washingtondc&ft:locale=en-US)
-   [Now Assist for Customer Service Management \(CSM\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm&family=washingtondc&ft:locale=en-US)
...
-   [Now Assist for HR Service Delivery \(HRSD\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-hrsd&family=washingtondc&ft:locale=en-US)
-   [Now Assist for IT Operations Management \(ITOM\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-itom&family=washingtondc&ft:locale=en-US)
-   [Now Assist for IT Service Management \(ITSM\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-itsm&family=washingtondc&ft:locale=en-US)
-   [Now Assist for Strategic Portfolio Management \(SPM\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-spm&family=washingtondc&ft:locale=en-US)

**Note:** The generative AI features that are available with Now Assist plugins may vary.

For more information, see [Install Now Assist plugins](https://servicenow-staging.fluidtopics.net/access?context=install-now-assist-feature-plugins&family=washingtondc&ft:locale=en-US).
...
-   Enable Dynamic Translation for Now Assist applications and customize language support
 ...
 See [Now Assist](https://servicenow-staging.fluidtopics.net/access?context=platform-now-assist-landing&family=washingtondc&ft:locale=en-US) for more information.
