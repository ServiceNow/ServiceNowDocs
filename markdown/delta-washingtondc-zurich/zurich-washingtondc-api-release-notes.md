---
title: Combined API release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for API from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-api-release-notes.html
release: zurich
...
[GlideAggregate - Scoped](https://servicenow-staging.fluidtopics.net/access?context=c_GlideAggregateScopedAPI&family=washingtondc&ft:locale=en-US)

</td><td>

[setIntervalYearIncluded\(\)](https://servicenow-staging.fluidtopics.net/access?context=ScopedGlAgg-setIntervalYearInclu_B&family=washingtondc&ft:locale=en-US)

</td></tr><tr><td>

[GlideRecord - Scoped](https://servicenow-staging.fluidtopics.net/access?context=c_GlideRecordScopedAPI&family=washingtondc&ft:locale=en-US)

</td><td>

[Scoped GlideRecord - updateWithReferences\(Object reason\)](https://servicenow-staging.fluidtopics.net/access?context=SGR-updateWithReferences_O.dita&family=washingtondc&ft:locale=en-US)

</td></tr><tr><td>

[ProcessMiningForExternalData - Scoped, Global](https://servicenow-staging.fluidtopics.net/access?context=ProcessMiningExtDataBothAPI&family=washingtondc&ft:locale=en-US)

</td><td>

[ProcessMiningForExternalData - scheduleCaseGeneration\(String externalDataSysId\)](https://servicenow-staging.fluidtopics.net/access?context=ProMiningExtData-schedCaseGen_S&family=washingtondc&ft:locale=en-US)

</td></tr><tr><td>

[ProductInstance API - Scoped, Global](https://servicenow-staging.fluidtopics.net/access?context=ProductInstanceBothAPI&family=washingtondc&ft:locale=en-US)

</td><td>

-   [generatePID\(\)](https://servicenow-staging.fluidtopics.net/access?context=ProductInstance-generatePID_S_S_O&family=washingtondc&ft:locale=en-US)
-   [getPIDConfig\(\)](https://servicenow-staging.fluidtopics.net/access?context=ProductInstance-getPIDConfig_S_S&family=washingtondc&ft:locale=en-US)
-   [isProductInstance\(\)](https://servicenow-staging.fluidtopics.net/access?context=ProductInstance-isProductInstance_S&family=washingtondc&ft:locale=en-US)

</td></tr><tr><td>

[XMLDocument2 - Scoped, Global](https://servicenow-staging.fluidtopics.net/access?context=c_XMLDocument2ScopedAPI&family=washingtondc&ft:locale=en-US)

</td><td>

[setEnableCDATAReporting\(\)](https://servicenow-staging.fluidtopics.net/access?context=SXMLD_setEnableCDATAReporting_B&family=washingtondc&ft:locale=en-US)

</td></tr><tr><td>

[XMLNode - Scoped, Global](https://servicenow-staging.fluidtopics.net/access?context=c_XMLNodeScopedAPI&family=washingtondc&ft:locale=en-US)

</td><td>

[isCDATANode\(\)](https://servicenow-staging.fluidtopics.net/access?context=SXMLN_isCDATANode&family=washingtondc&ft:locale=en-US)
...
[GlideAggregate - Global](https://servicenow-staging.fluidtopics.net/access?context=c_GlideAggregateAPI&family=washingtondc&ft:locale=en-US)

</td><td>

[setIntervalYearIncluded\(\)](https://servicenow-staging.fluidtopics.net/access?context=GlideAgg-setIntervalYearIncluded_B&family=washingtondc&ft:locale=en-US)

</td></tr><tr><td>

[GlideRecord - Global](https://servicenow-staging.fluidtopics.net/access?context=c_GlideRecordAPI&family=washingtondc&ft:locale=en-US)

</td><td>

[GlideRecord - addExtraField\(String dotWalkedField\)](https://servicenow-staging.fluidtopics.net/access?context=GlideRecord-addExtraField_S&family=washingtondc&ft:locale=en-US)

</td></tr><tr><td>

[OnCallContactPrefTemplate - Global](https://servicenow-staging.fluidtopics.net/access?context=OnCallContactPrefTemplateAPI&family=washingtondc&ft:locale=en-US)

</td><td>

-   [OnCallContactPrefTemplate\(\)](https://servicenow-staging.fluidtopics.net/access?context=OnCallCtPrefTemp-OnCallCtPrefTemp&family=washingtondc&ft:locale=en-US)
-   [copyContactPreferences\(\)](https://servicenow-staging.fluidtopics.net/access?context=OnCallCtPrefTemp-copyCtPrefs_S_S&family=washingtondc&ft:locale=en-US)
-   [deleteContactPreferenceAttempts\(\)](https://servicenow-staging.fluidtopics.net/access?context=OnCallCtPrefTemp-deleteCtPrefAtt_S&family=washingtondc&ft:locale=en-US)

</td></tr><tr><td>

[OnCallEscalationTemplateSNC - Global](https://servicenow-staging.fluidtopics.net/access?context=OnCallEscalationTemplateSNCAPI&family=washingtondc&ft:locale=en-US)

</td><td>

-   [OnCallEscalationTemplateSNC\(\)](https://servicenow-staging.fluidtopics.net/access?context=OnCallEscTemp-OnCallEscTemp&family=washingtondc&ft:locale=en-US)
-   [copyEscalationTemplatetoEscalationSet\(\)](https://servicenow-staging.fluidtopics.net/access?context=OnCallEscTemp-copyEsTempEsSet_S_S&family=washingtondc&ft:locale=en-US)
-   [deleteEscalationSetSteps\(\)](https://servicenow-staging.fluidtopics.net/access?context=OnCallEscTemp-deleteEsSetSteps_S&family=washingtondc&ft:locale=en-US)
...
[SPWidgetAccessControl - Global](https://servicenow-staging.fluidtopics.net/access?context=SPWidgetAccessControlGlobalAPI&family=washingtondc&ft:locale=en-US)

</td><td>

[hasPublicAccess\(\)](https://servicenow-staging.fluidtopics.net/access?context=SPWAcsCtrl-hasPublicAccess_S_O_S_O&family=washingtondc&ft:locale=en-US)
...
|-----------|-------|---|---------|
|Threat Intelligence Security Center for Security Operations|3.0.2|[TISC API](https://servicenow-staging.fluidtopics.net/access?context=tisc-api&family=washingtondc&ft:locale=en-US)|[POST /sn\_sec\_tisc/threat\_intel\_data/observables](https://servicenow-staging.fluidtopics.net/access?context=tisc-POST-observables&family=washingtondc&ft:locale=en-US)|
...
[DecisionTableAPI - Scoped, Global](https://servicenow-staging.fluidtopics.net/access?context=DecisionTableAPI&family=washingtondc&ft:locale=en-US)

</td><td>

The [createAnswerElements\(\)](https://servicenow-staging.fluidtopics.net/access?context=DecisionTableAPI-createAnsEls_S_O&family=washingtondc&ft:locale=en-US) method now supports additional answer element types.-   Due\_date
-   Glide\_date
-   Glide\_date\_time
-   Glide\_duration
-   Longint
...
[LeadtoCashCore - Scoped](https://servicenow-staging.fluidtopics.net/access?context=LeadToCashCoreAPI&family=washingtondc&ft:locale=en-US)

</td><td>

-   The [LeadtoCashCore - getPrimitivesEPService\(String sourceToTargetConfigID, Object context\)](https://servicenow-staging.fluidtopics.net/access?context=LTCC-getPrimitivesEPService_S&family=washingtondc&ft:locale=en-US) method provides an new object parameter, **context**, which supports two options for displaying attribute values and for enabling the ability to invoke more than one instance at a time.
-   The [LeadtoCashCore - createInstance\(String headerSysIDs, String lineSysIDs, Boolean isTarget, Object additionalParams\)](https://servicenow-staging.fluidtopics.net/access?context=LTCC-createInstance_S_S_B_O_B&family=washingtondc&ft:locale=en-US) method supports the ability to create one or more entities using multiple header or line IDs in the API script.
-   The [LeadtoCashCore - delta\(Object sourceJSON, Object dirtyJSON, Object additionalParams\)](https://servicenow-staging.fluidtopics.net/access?context=LTCC-delta_O_O_O&family=washingtondc&ft:locale=en-US) method now supports multi-select use cases and retrieves action details in the source JSON.
-   The [LeadtoCashCore - effect\(Object sourceJSON, Object targetJSON, Object additionalParams\)](https://servicenow-staging.fluidtopics.net/access?context=LTCC-effect_O_O_O&family=washingtondc&ft:locale=en-US) method now supports the ability to invoke effect\(\) with empty arrays of various related items to mark them as 'no change' between source and target JSONs.
...
-   Use inbound REST APIs to interact with various ServiceNow functionalities within your application.
 ...
 See [API implementation and reference](https://servicenow-staging.fluidtopics.net/access?context=api-implementation-reference&family=washingtondc&ft:locale=en-US) for more information.
