---
title: Combined Threat Intelligence Security Center release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Threat Intelligence Security Center from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-threatintelligencesecuritycenter-release-notes.html
release: zurich
...
# Combined Threat Intelligence Security Center release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Threat Intelligence Security Center from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Threat Intelligence Security Center release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[View Threat Intelligence Security Center Homepage](https://servicenow-staging.fluidtopics.net/access?context=view-threat-intelligence-security-center-homepage&family=washingtondc&ft:locale=en-US)**

Threat Intelligence Security Center homepage provides the data visualization to the threat intelligence.

-   **[Threat Intelligence Security Center Catalog](https://servicenow-staging.fluidtopics.net/access?context=threat-intelligence-security-center-catalogue&family=washingtondc&ft:locale=en-US)**
...
-   **[Threat Intelligence Feeds](https://servicenow-staging.fluidtopics.net/access?context=threat-intelligence-feeds&family=washingtondc&ft:locale=en-US)**

Ability that provides the integration of premium feeds to enhance threat intelligence.

-   **[TISC Enrichment Integrations](https://servicenow-staging.fluidtopics.net/access?context=tisc-enrichment-integrations&family=washingtondc&ft:locale=en-US)**
...
-   **[Administration](https://servicenow-staging.fluidtopics.net/access?context=tisc-data-administration&family=washingtondc&ft:locale=en-US)**
...
-   **[TISC integration with SIR Workspace](https://servicenow-staging.fluidtopics.net/access?context=tisc-integration-with-sir-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Threat Intelligence Security Center Library](https://servicenow-staging.fluidtopics.net/access?context=threat-intelligence-security-center-library&family=washingtondc&ft:locale=en-US)**

Threat Analyst library is a dedicated Threat Intel Analyst Workspace for streamlined operations.

-   **[Threat Analyst Workbench](https://servicenow-staging.fluidtopics.net/access?context=threat-analyst-workbench&family=washingtondc&ft:locale=en-US)**
...
-   Threat investigation helps the teams to create and track threat investigations using the Case Management feature.​
 ...
 See [Threat Intelligence Security Center](https://servicenow-staging.fluidtopics.net/access?context=tisc-landing-page&family=washingtondc&ft:locale=en-US) for more information.
