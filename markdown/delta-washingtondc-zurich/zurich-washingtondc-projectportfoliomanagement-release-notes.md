---
title: Combined Project Portfolio Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Project Portfolio Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-projectportfoliomanagement-release-notes.html
release: zurich
...
# Combined Project Portfolio Management release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Project Portfolio Management from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Project Portfolio Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Enhanced project planning and management](https://servicenow-staging.fluidtopics.net/access?context=exploring-project-workspace&family=washingtondc&ft:locale=en-US)**

Create and manage cost plans by using the new Project Workspace. For more information, see the [Project Workspace release notes](https://servicenow-staging.fluidtopics.net/access?context=project-workspace-rn&family=washingtondc&ft:locale=en-US).

-   **[New experience to view and manage resource allocations](https://servicenow-staging.fluidtopics.net/access?context=rsrc-mgmt-wrkspc&family=washingtondc&ft:locale=en-US)**
...
-   **[Migrate resource plans and operational resource plans to attribute-based resource assignments](https://servicenow-staging.fluidtopics.net/access?context=rsrc-plans-rsrc-asgmnts&family=washingtondc&ft:locale=en-US)**

[Migrate the resource plans](https://servicenow-staging.fluidtopics.net/access?context=rsrc-plans-rsrc-asgmnts&family=washingtondc&ft:locale=en-US) of your projects and demands to attribute-based resource assignments and work on resource allocations using [Project Workspace](https://servicenow-staging.fluidtopics.net/access?context=exploring-project-workspace&family=washingtondc&ft:locale=en-US).

-   **[Migrate cost plans to attribute-based costs plans](https://servicenow-staging.fluidtopics.net/access?context=rsrc-plans-rsrc-asgmnts&family=washingtondc&ft:locale=en-US)**
...
-   **[Generate labor costs for epics](https://servicenow-staging.fluidtopics.net/access?context=gen-labor-costs-epics&family=washingtondc&ft:locale=en-US)**

Generate labor costs based on the resource assignments for epics.

-   **[Migrate financial baselines to Next Experience](https://servicenow-staging.fluidtopics.net/access?context=migrate-fin-baselines-projects&family=washingtondc&ft:locale=en-US)**
...
-   **[Next Experience support for Strategic Spend Tracking for PPM dashboard](https://servicenow-staging.fluidtopics.net/access?context=ppm-strategic-spend-tracking-dashboard&family=washingtondc&ft:locale=en-US)**
...
-   **[Migrate Idea Manager dashboard to Next Experience](https://servicenow-staging.fluidtopics.net/access?context=idea-manager-dashboard&family=washingtondc&ft:locale=en-US)**
...
-   **[Migrate PMO dashboard to Next Experience](https://servicenow-staging.fluidtopics.net/access?context=pmo-dashboard&family=washingtondc&ft:locale=en-US)**
...
-   Migrate the Strategic Spend Tracking for PPM dashboard to Next Experience.
 ...
 See [Explore Project Portfolio Management](https://servicenow-staging.fluidtopics.net/access?context=explore-project-portfolio-management&family=washingtondc&ft:locale=en-US) for more information.
