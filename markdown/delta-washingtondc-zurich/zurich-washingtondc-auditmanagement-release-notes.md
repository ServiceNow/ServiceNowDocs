---
title: Combined Audit Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Audit Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-auditmanagement-release-notes.html
release: zurich
...
# Combined Audit Management release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Audit Management from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Audit Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Manage your documents and work papers with Audit Management as cloud files](https://servicenow-staging.fluidtopics.net/access?context=manage-cloud-docs-using-onedrive-int&family=washingtondc&ft:locale=en-US)**
...
-   **[Create a Cloud file configuration on engagements and audit tasks](https://servicenow-staging.fluidtopics.net/access?context=document-access-configuration&family=washingtondc&ft:locale=en-US)**
...
-   **[Analytics and Reporting Solutions for Audit Management in Next Experience UI Framework](https://servicenow-staging.fluidtopics.net/access?context=grc-audit-mgmt-content-pack&family=washingtondc&ft:locale=en-US)**
...
-   Manage access permissions on the cloud files.
 ...
 See [Audit Management](https://servicenow-staging.fluidtopics.net/access?context=c_GRCAudits&family=washingtondc&ft:locale=en-US) for more information.
