---
title: Combined Event Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Event Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-eventmanagement-release-notes.html
release: zurich
...
# Combined Event Management release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Event Management from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Event Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Team-based integrations in Event Management](https://servicenow-staging.fluidtopics.net/access?context=team-based-integrations&family=washingtondc&ft:locale=en-US)**
...
-   **[Event forwarding](https://servicenow-staging.fluidtopics.net/access?context=event-forwarding-em&family=washingtondc&ft:locale=en-US)**
...
-   **[Free-text search for alerts in Express List](https://servicenow-staging.fluidtopics.net/access?context=el-free-text-search&family=washingtondc&ft:locale=en-US)**

Starting in version 23.2.1, find alerts in the Express List by using free-text search.

-   **[Keyboard shortcuts in Express List](https://servicenow-staging.fluidtopics.net/access?context=el-keyboard-shortcuts&family=washingtondc&ft:locale=en-US)**

Starting in version 23.2.1, speed up your work in Express List with keyboard shortcuts.

-   **[Timeline View of alerts in an alert group in Express List](https://servicenow-staging.fluidtopics.net/access?context=el-timeline-view-concept&family=washingtondc&ft:locale=en-US)**
...
-   **[Link View in Express List](https://servicenow-staging.fluidtopics.net/access?context=el-link-view&family=washingtondc&ft:locale=en-US)**
...
-   **[Alert analysis of alert groups in Express List created by Now Assist using generative AI](https://servicenow-staging.fluidtopics.net/access?context=el-alert-group-analysis&family=washingtondc&ft:locale=en-US)**
...
Event Management is available with activation of the Event Management plugin \(com.glideapp.itom.snac\). For details, see [Request Event Management](https://servicenow-staging.fluidtopics.net/access?context=t_EMActivatePlugin&family=washingtondc&ft:locale=en-US).
...
-   View an alert group analysis created by Now Assist using generative AI.
 ...
 See [Event Management](https://servicenow-staging.fluidtopics.net/access?context=c_EM&family=washingtondc&ft:locale=en-US) for more information.
