---
title: Combined AI Risk and Compliance release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for AI Risk and Compliance from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-airiskandcompliance-release-notes.html
release: zurich
...
# Combined AI Risk and Compliance release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for AI Risk and Compliance from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family AI Risk and Compliance release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[AI asset lifecycle management](https://servicenow-staging.fluidtopics.net/access?context=ai-asset-lifecycle&family=yokohama&ft:locale=en-US)**
...
-   **[Perform impact assessment on an AI use case](https://servicenow-staging.fluidtopics.net/access?context=perform-impact-assessment-of-ai-use-case&family=yokohama&ft:locale=en-US)**
...
-   **[AI asset inventory risk management](https://servicenow-staging.fluidtopics.net/access?context=request-risk-assessments-for-ai-systems&family=yokohama&ft:locale=en-US)**
...
-   **[AI case management](https://servicenow-staging.fluidtopics.net/access?context=ai-case-management-landing-page&family=yokohama&ft:locale=en-US)**
...
-   **[AI framework content pack](https://servicenow-staging.fluidtopics.net/access?context=install-ai-risk-content-pack&family=yokohama&ft:locale=en-US)**
...
-   **[AI Risk and Compliance workspace](https://servicenow-staging.fluidtopics.net/access?context=ai-risk-and-compliance-workspace&family=yokohama&ft:locale=en-US)**
...
-   **[Collaborate with internal users](https://servicenow-staging.fluidtopics.net/access?context=perform-impact-assessment-of-ai-use-case&family=yokohama&ft:locale=en-US)**
...
-   **[Roles installed](https://servicenow-staging.fluidtopics.net/access?context=roles-installed-with-ai-risk-and-compliance&family=yokohama&ft:locale=en-US)**
...
-   **[Assess multiple risks and controls for AI assets simultaneously](https://servicenow-staging.fluidtopics.net/access?context=risk-assessment-project-airc&family=zurich&ft:locale=en-US)**
...
-   **[AI asset data segregation with entity based access](https://servicenow-staging.fluidtopics.net/access?context=entity-based-access-for-ai-assets&family=zurich&ft:locale=en-US)**
...
-   **[AI Risk and Compliance content accelerator](https://servicenow-staging.fluidtopics.net/access?context=unified-content-management-in-airc&family=zurich&ft:locale=en-US)**
...
-   **[Automatic AI case and inquiry creation from emails](https://servicenow-staging.fluidtopics.net/access?context=automatic-creation-cases-inquiries-from-email&family=zurich&ft:locale=en-US)**
...
-   **[360° AI asset view](https://servicenow-staging.fluidtopics.net/access?context=visualization-of-ai-assest&family=zurich&ft:locale=en-US)**
...
-   **[Deliver system-level AI risk score aggregation and visualization](https://servicenow-staging.fluidtopics.net/access?context=ai-assets-airc&family=zurich&ft:locale=en-US)**
...
-   **[Enable AI risk and compliance views with updated content packs](https://servicenow-staging.fluidtopics.net/access?context=ai-assets-airc&family=zurich&ft:locale=en-US)**
...
-   **[Implement robust access control and AI asset management capabilities](https://servicenow-staging.fluidtopics.net/access?context=roles-installed-with-ai-risk-and-compliance&family=zurich&ft:locale=en-US)**
...
-   **[Use the AI cases tab to monitor and manage AI case activity](https://servicenow-staging.fluidtopics.net/access?context=ai-cases-tab-airc&family=zurich&ft:locale=en-US)**
...
-   **[Filter the risk heatmap by Risk Assessment Methodology for targeted risk analysis](https://servicenow-staging.fluidtopics.net/access?context=risk-and-compliance-tab-airc&family=zurich&ft:locale=en-US)**
...
-   **[Group control attestations](https://servicenow-staging.fluidtopics.net/access?context=attest-controls-for-ai-systems&family=zurich&ft:locale=en-US)**
...
-   **[Scan and analyze updates from global regulators](https://servicenow-staging.fluidtopics.net/access?context=ai-risk-and-compliance-workspace&family=zurich&ft:locale=en-US)**
...
-   **[Manage reporting compliance posture insights on key regulations or policies](https://servicenow-staging.fluidtopics.net/access?context=risk-and-compliance-tab-airc&family=zurich&ft:locale=en-US)**
...
-   **[AI risk and compliance home page](https://servicenow-staging.fluidtopics.net/access?context=ai-risk-and-compliance-workspace&family=zurich&ft:locale=en-US)**
...
-   **[Worknotes and comments in AI system records](https://servicenow-staging.fluidtopics.net/access?context=ai-system-airc&family=zurich&ft:locale=en-US)**
...
-   Build a compliance-ready AI asset inventory aligned with regulatory requirements using the AI framework content pack.
 ...
 See [AI Risk and Compliance](https://servicenow-staging.fluidtopics.net/access?context=ai-risk-and-compliance&family=yokohama&ft:locale=en-US) for more information.
...
-   Monitor and track the risk and compliance posture of your AI assets to ensure that your organization aligns with organizational and regulatory standards. You can also gain real-time insights into the emerging risks and compliance gaps across your AI portfolio.
 ...
 See [AI Risk and Compliance](https://servicenow-staging.fluidtopics.net/access?context=ai-risk-and-compliance&family=zurich&ft:locale=en-US) for more information.
