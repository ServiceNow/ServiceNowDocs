---
title: Combined Now Assist for Creator release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Now Assist for Creator from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-nowassistforcreator-release-notes.html
release: zurich
...
# Combined Now Assist for Creator release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Now Assist for Creator from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Now Assist for Creator release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
To receive Workflow Studio performance improvements, install one of these versions of the Workflow Studio application from the ServiceNow Store. For more information about upgrading Workflow Studio, see [Update to the latest version of Workflow Studio](https://servicenow-staging.fluidtopics.net/access?context=update-to-the-latest-version-of-workflow-studio&family=washingtondc&ft:locale=en-US).
...
-   **[Create a playbook outline with Now Assist](https://servicenow-staging.fluidtopics.net/access?context=playbook-assist-landing&family=washingtondc&ft:locale=en-US)**
...
-   **[Create a catalog item using Now Assist](https://servicenow-staging.fluidtopics.net/access?context=create-catalog-item-using-now-assist&family=washingtondc&ft:locale=en-US)**
...
-   **[Add visualization to any dashboard](https://servicenow-staging.fluidtopics.net/access?context=use-dv-generation&family=xanadu&ft:locale=en-US)**
...
-   **[Generate a playbook from an image](https://servicenow-staging.fluidtopics.net/access?context=generate-a-playbook-outline&family=xanadu&ft:locale=en-US)**

Generate a playbook with out-of-the-box activities from text, an image, or both.

-   **[Generate a UI experience](https://servicenow-staging.fluidtopics.net/access?context=ui-generation-landing&family=xanadu&ft:locale=en-US)**

Generate a UI experience using natural language description.

-   **[Edit code with Now Assist](https://servicenow-staging.fluidtopics.net/access?context=edit-code-now-assist&family=xanadu&ft:locale=en-US)**
...
-   **[Use Now Assist to create spokes and actions](https://servicenow-staging.fluidtopics.net/access?context=now-assist-in-spk-gen&family=xanadu&ft:locale=en-US)**
...
-   **[Modify generated data visualizations](https://servicenow-staging.fluidtopics.net/access?context=use-dv-generation&family=xanadu&ft:locale=en-US)**
...
-   **[Support more chart types for generating data visualizations](https://servicenow-staging.fluidtopics.net/access?context=limitations-generating-dv&family=xanadu&ft:locale=en-US)**
...
-   **[Edit in ServiceNow Studio after generating an application](https://servicenow-staging.fluidtopics.net/access?context=sns-app-gen-review-apps&family=xanadu&ft:locale=en-US)**

Use Now Assist for App Generation in ServiceNow Studio, which offers an advanced application development environment.

-   **[Preview an application before generating](https://servicenow-staging.fluidtopics.net/access?context=generate-apps-from-prompts&family=xanadu&ft:locale=en-US)**
...
-   **[Update applications that have already been generated](https://servicenow-staging.fluidtopics.net/access?context=sns-app-gen-edit-apps&family=xanadu&ft:locale=en-US)**

Augment existing applications with new application objects, such as tables, roles, ACLs, and record producers.

-   **[Create new tables by extending existing tables](https://servicenow-staging.fluidtopics.net/access?context=sns-app-gen-edit-apps&family=xanadu&ft:locale=en-US)**

Create new tables for an application created with app generation by extending existing tables, such as the task table.

-   **[Edit existing applications without having the admin role](https://servicenow-staging.fluidtopics.net/access?context=app-generation-roles&family=xanadu&ft:locale=en-US)**
...
-   **[Get Playbook recommendations](https://servicenow-staging.fluidtopics.net/access?context=playbook-recommendations&family=xanadu&ft:locale=en-US)**

Get suggestions on which activities to replace placeholder activities with.

-   **[Re-prompt and preview while generating a playbook](https://servicenow-staging.fluidtopics.net/access?context=generate-a-playbook-outline&family=xanadu&ft:locale=en-US)**
...
-   **[Data visualization generation](https://servicenow-staging.fluidtopics.net/access?context=now-assist-data-visualization-generation&family=xanadu&ft:locale=en-US)**
...
-   Generate a catalog item by describing the catalog item you want.
 ...
 See [Now Assist for Creator](https://servicenow-staging.fluidtopics.net/access?context=now-assist-for-creator-landing&family=washingtondc&ft:locale=en-US) for more information.
...
-   Show annotations of what text directions were used to generate actions, flow logic, and subflows during flow generation.
 ...
 See [Now Assist for Creator](https://servicenow-staging.fluidtopics.net/access?context=now-assist-for-creator-landing&family=xanadu&ft:locale=en-US) for more information.
