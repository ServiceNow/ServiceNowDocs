---
title: Combined Mobile Platform release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Mobile Platform from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-mobileplatform-release-notes.html
release: zurich
...
# Combined Mobile Platform release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Mobile Platform from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Mobile Platform release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Overriding critical alerts](https://servicenow-staging.fluidtopics.net/access?context=mobile-critical-alerts-create&family=washingtondc&ft:locale=en-US)**

Send your users critical alerts, even if they configure their mobile device to a Do Not Disturb or Silent mode setting.

-   **[Dynamic pop-ups](https://servicenow-staging.fluidtopics.net/access?context=mobile_popups&family=washingtondc&ft:locale=en-US)**
...
-   **[Securing your ServiceNow mobile instance with Zero Trust Access](https://servicenow-staging.fluidtopics.net/access?context=zero-trust-access-for-mobile&family=washingtondc&ft:locale=en-US)**
...
-   **[Custom map screen support for additional entry points to launch Indoor Wayfinding](https://servicenow-staging.fluidtopics.net/access?context=indoor-wayfinding-config&family=washingtondc&ft:locale=en-US)**

Launch custom map screens from a mobile embedded web page or from a push notification.

-   **[Mobile Resolution Notes Generation](https://servicenow-staging.fluidtopics.net/access?context=ai-case-summarization&family=washingtondc&ft:locale=en-US)**
...
-   **[Mobile SDK available in the ServiceNow Store](https://servicenow-staging.fluidtopics.net/access?context=mobile-sdk&family=washingtondc&ft:locale=en-US)**
...
-   **[Mobile App Builder](https://servicenow-staging.fluidtopics.net/access?context=mab-concept&family=washingtondc&ft:locale=en-US)**
...
-   **[Data visualization user experience](https://servicenow-staging.fluidtopics.net/access?context=chart-screen&family=washingtondc&ft:locale=en-US)**
...
-   **[Arabic added to the support of right-to-left languages](https://servicenow-staging.fluidtopics.net/access?context=language-selection-mobile-device&family=washingtondc&ft:locale=en-US)**
...
-   **[Offline support in Now Mobile apps and custom apps](https://servicenow-staging.fluidtopics.net/access?context=mobile-offline-mode&family=washingtondc&ft:locale=en-US)**
...
-   **[Now Assist in Virtual Agent for mobile](https://servicenow-staging.fluidtopics.net/access?context=configure-va-mobile-web-client&family=washingtondc&ft:locale=en-US)**
...
-   **[Mobile Playbooks enhancements](https://servicenow-staging.fluidtopics.net/access?context=mobile-playbooks&family=washingtondc&ft:locale=en-US)**
...
-   **[Mobile Publishing enhancements](https://servicenow-staging.fluidtopics.net/access?context=mobile-publishing&family=washingtondc&ft:locale=en-US)**
...
-   Mobile App Builder is now integrated with Mobile Publishing so that admins can manage custom branded app requests and configure mobile apps in one tool.
 ...
 See [Mobile Platform](https://servicenow-staging.fluidtopics.net/access?context=mobile-config-navigation&family=washingtondc&ft:locale=en-US) for more information.
