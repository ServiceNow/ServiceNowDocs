---
title: Combined Service Exchange release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Service Exchange from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-serviceexchange-release-notes.html
release: zurich
...
# Combined Service Exchange release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Service Exchange from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Service Exchange release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   If you are upgrading from version 1.x.x of Service Exchange, follow the steps listed in [Upgrade Guide - Service Bridge for Providers and Consumers application \(v2.x.x release - KB1700387\)](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB1700387) to migrate your Service Exchange applications.
...
-   **[Error handling through Transport Diagnostics](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-error-log&family=washingtondc&ft:locale=en-US)**

Track errors on recent transactions, provide the connection status, run the health checks, and provide recommendations.

-   **[Support for variable sets for remote record producers](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-variable-sets&family=washingtondc&ft:locale=en-US)**
...
-   **[Service Exchange mismatched version support](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-mismatch-version&family=xanadu&ft:locale=en-US)**
...
-   **[Configuration revisions](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-config-revision&family=xanadu&ft:locale=en-US)**
...
-   **[Consumer pre-flows](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-conf-consumer-flow&family=xanadu&ft:locale=en-US)**
...
-   **[Integration with Sales and Order Management](https://servicenow-staging.fluidtopics.net/access?context=service-bridge-v2-omt-intg&family=xanadu&ft:locale=en-US)**
...
-   Use variable sets and multi-row variable sets with remote record producers.
 ...
 See [Service Exchange](https://servicenow-staging.fluidtopics.net/access?context=tmt-service-bridge-both-landing-page&family=washingtondc&ft:locale=en-US) for more information.
...
-   Support automated synchronization of configuration data between provider and consumer instances.
 ...
 See [Service Exchange](https://servicenow-staging.fluidtopics.net/access?context=tmt-service-bridge-both-landing-page&family=xanadu&ft:locale=en-US) for more information.
