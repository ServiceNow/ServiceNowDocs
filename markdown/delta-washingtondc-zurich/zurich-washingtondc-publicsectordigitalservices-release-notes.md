---
title: Combined Public Sector Digital Services release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Public Sector Digital Services from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-publicsectordigitalservices-release-notes.html
release: zurich
...
# Combined Public Sector Digital Services release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Public Sector Digital Services from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Public Sector Digital Services release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Submit requests for social benefits with the Social Benefits Playbook](https://servicenow-staging.fluidtopics.net/access?context=psds-using-sb-playbooks&family=washingtondc&ft:locale=en-US)**
...
-   **​[Provide auto-calculated eligibility using​ the Social Benefits Eligibility Framework engine](https://servicenow-staging.fluidtopics.net/access?context=psds-configure-eligibility-sbp&family=washingtondc&ft:locale=en-US)**
...
-   **[Manage Eligibility Criteria Policies using the Social Benefits Eligibility Framework engine](https://servicenow-staging.fluidtopics.net/access?context=psds-sbp-ef-configure-eligibility&family=washingtondc&ft:locale=en-US)**
...
-   **[Create relationship records between applicants and beneficiaries](https://servicenow-staging.fluidtopics.net/access?context=psds-sbp-add-beneficiary&family=washingtondc&ft:locale=en-US)**
...
-   **[Upload and verify documents attached to a social benefits application](https://servicenow-staging.fluidtopics.net/access?context=psds-using-sb-playbooks&family=washingtondc&ft:locale=en-US)**
...
-   **[Request interviews with constituents through the Conduct Interview modal in Social Benefits Playbook](https://servicenow-staging.fluidtopics.net/access?context=psds-using-sb-playbooks&family=washingtondc&ft:locale=en-US)**
...
-   **[Apply for additional Social Benefits programs by using data from the primary case](https://servicenow-staging.fluidtopics.net/access?context=psds-using-sb-playbooks&family=washingtondc&ft:locale=en-US)**
...
-   **[View benefits summary card in Government Service Portal and Social Benefits Playbook](https://servicenow-staging.fluidtopics.net/access?context=psds-using-sb-playbooks&family=washingtondc&ft:locale=en-US)**
...
-   **[Submit a license and permit application on behalf of someone else](https://servicenow-staging.fluidtopics.net/access?context=psds-proxy-application-gsp-lpr&family=washingtondc&ft:locale=en-US)**
...
-   **[Create a digital copy of a license and permit in License and Permit Playbook](https://servicenow-staging.fluidtopics.net/access?context=public-sector-resolving-lpr-case-playbooks&family=washingtondc&ft:locale=en-US)**
...
-   **[Submit license and permit requests using Virtual Agent](https://servicenow-staging.fluidtopics.net/access?context=using-va-for-public-sector-digital-services&family=washingtondc&ft:locale=en-US)**
...
-   **[Request additional inspections needed for a license or permit request in License and Permit Playbook](https://servicenow-staging.fluidtopics.net/access?context=public-sector-resolving-lpr-case-playbooks&family=washingtondc&ft:locale=en-US)**
...
-   Request additional inspections directly from the playbook so that applicants can make the required changes to pass an inspection.
 ...
 See [Public Sector Digital Services](https://servicenow-staging.fluidtopics.net/access?context=bun-public-sector-landing-page&family=washingtondc&ft:locale=en-US) for more information.
