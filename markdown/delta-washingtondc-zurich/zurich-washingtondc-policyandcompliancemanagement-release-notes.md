---
title: Combined Policy and Compliance Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Policy and Compliance Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-policyandcompliancemanagement-release-notes.html
release: zurich
...
# Combined Policy and Compliance Management release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Policy and Compliance Management from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Policy and Compliance Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Policy authoring using Google Drive](https://servicenow-staging.fluidtopics.net/access?context=connect-google-drive-doc&family=washingtondc&ft:locale=en-US)**
...
-   **[Set up dynamic approval configuration on a policy record](https://servicenow-staging.fluidtopics.net/access?context=dynamic-approval-config-for-a-policy&family=washingtondc&ft:locale=en-US)**
...
-   **[Performance enhancements in processing indicator jobs](https://servicenow-staging.fluidtopics.net/access?context=create-ctrl-indicator-ws&family=washingtondc&ft:locale=en-US)**
...
-   **[Analytics and Reporting solutions for Policy and Compliance Management in Next Experience UI Framework](https://servicenow-staging.fluidtopics.net/access?context=grc-policy-compliance-content-pack&family=washingtondc&ft:locale=en-US)**
...
-   Set up the dynamic approval configuration on a policy record. Define the approval levels and rules based on different dynamic conditions, such as policy type, source table, state, and filter conditions.
 ...
 See [Policy and Compliance Management](https://servicenow-staging.fluidtopics.net/access?context=r_PolicyComplianceMgmt&family=washingtondc&ft:locale=en-US) for more information.
