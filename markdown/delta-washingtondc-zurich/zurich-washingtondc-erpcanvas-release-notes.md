---
title: Combined ERP Canvas release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for ERP Canvas from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-erpcanvas-release-notes.html
release: zurich
...
# Combined ERP Canvas release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for ERP Canvas from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family ERP Canvas release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading ERP Canvas to Zurich
...
Between your current release family and Zurich, new features were introduced for ERP Canvas.
...
-   **[New UI for managing models](https://servicenow-staging.fluidtopics.net/access?context=work-with-erp-data-models&family=washingtondc&ft:locale=en-US)**

Create and map models using tables and BAPIs, and then use the models to read and update the ERP system.

-   **[Read and update SAP from using BAPI function calls](https://servicenow-staging.fluidtopics.net/access?context=erpc-managing-models-read&family=washingtondc&ft:locale=en-US)**
...
-   **[Support for earlier versions of ECC](https://servicenow-staging.fluidtopics.net/access?context=erpc-prereqs-for-installation&family=washingtondc&ft:locale=en-US)**

Use with earlier versions of ECC, beginning with version SAP ECC 6.0 EHP 8.

-   **[Use actions to build flows that specify where ERP data goes on the ServiceNow AI Platform](https://servicenow-staging.fluidtopics.net/access?context=erp-canvas-build-flow-operation&family=washingtondc&ft:locale=en-US)**
...
Between your current release family and Zurich, some changes were made to existing ERP Canvas features.
...
-   **[no longer required for](https://servicenow-staging.fluidtopics.net/access?context=erpc-prereqs-for-installation&family=washingtondc&ft:locale=en-US)**

You can now install without also installing ERP-CM.

-   **[Use ERP Model Management to create table joins](https://servicenow-staging.fluidtopics.net/access?context=erp-canvas-add-join-data-model&family=washingtondc&ft:locale=en-US)**
...
Between your current release family and Zurich, some ERP Canvas features or functionality were removed.
...
Between your current release family and Zurich, some ERP Canvas features or functionality were deprecated.
...
-   Removed the requirement to have \(ERP-CM\) in order to run .
 ...
 See [ERP Integration](https://servicenow-staging.fluidtopics.net/access?context=erp-integration-overview&family=washingtondc&ft:locale=en-US) for more information.
