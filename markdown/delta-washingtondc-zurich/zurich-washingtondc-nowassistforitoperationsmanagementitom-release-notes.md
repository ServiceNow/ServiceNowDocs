---
title: Combined Now Assist for IT Operations Management \(ITOM\) release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Now Assist for IT Operations Management \(ITOM\) from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-nowassistforitoperationsmanagementitom-release-notes.html
release: zurich
...
# Combined Now Assist for IT Operations Management \(ITOM\) release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Now Assist for IT Operations Management \(ITOM\) from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Now Assist for IT Operations Management \(ITOM\) release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Investigate and resolve alerts more effectively by using alert analysis in Service Operations Workspace](https://servicenow-staging.fluidtopics.net/access?context=alert-summarization-now-assist&family=washingtondc&ft:locale=en-US)**
...
-   **[Use alert analysis in the Express List](https://servicenow-staging.fluidtopics.net/access?context=alert-summary-now-assist-express-list&family=washingtondc&ft:locale=en-US)**
...
Now Assist for ITOM is available with activation of the ITOM plugin in the [Now Assist Admin console](https://servicenow-staging.fluidtopics.net/access?context=configuring-now-assist&family=washingtondc&ft:locale=en-US). For more information, see [Install the Now Assist for IT Operations Management \(ITOM\) plugin](https://servicenow-staging.fluidtopics.net/access?context=install-now-assist-itom&family=washingtondc&ft:locale=en-US).
...
-   Enable quick alert triage and effective analysis, which can lead to reduced resolution time.
 ...
 See [Now Assist for IT Operations Management \(ITOM\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-itom&family=washingtondc&ft:locale=en-US) for more information.
...
-   Launch an alert analysis from the Now Assist panel.
 ...
 See [Now Assist for IT Operations Management \(ITOM\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-itom&family=xanadu&ft:locale=en-US) for more information.
