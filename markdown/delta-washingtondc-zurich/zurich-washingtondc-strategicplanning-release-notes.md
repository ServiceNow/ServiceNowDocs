---
title: Combined Strategic Planning release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Strategic Planning from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-strategicplanning-release-notes.html
release: zurich
...
# Combined Strategic Planning release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Strategic Planning from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Strategic Planning release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Enterprise Agile Planning in Strategic Planning](https://servicenow-staging.fluidtopics.net/access?context=eap-landing&family=washingtondc&ft:locale=en-US)**
...
-   **[Feedback or Product idea list view enhancements](https://servicenow-staging.fluidtopics.net/access?context=update-feedback-or-idea&family=washingtondc&ft:locale=en-US)**
...
-   **[Product feedback enhancements](https://servicenow-staging.fluidtopics.net/access?context=product-feedback-landing&family=washingtondc&ft:locale=en-US)**
...
-   **[Create feedback filters in Strategic Planning](https://servicenow-staging.fluidtopics.net/access?context=create-feedback-filters&family=washingtondc&ft:locale=en-US)**
...
-   **[Plan efficiently with additional pre-defined lenses](https://servicenow-staging.fluidtopics.net/access?context=lens-alignment-planner-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Tagging planning items](https://servicenow-staging.fluidtopics.net/access?context=categorize-and-find-work-items-using-tags-spw&family=washingtondc&ft:locale=en-US)**
...
-   **[Prioritization enhancements](https://servicenow-staging.fluidtopics.net/access?context=managing-backlog-alignment-planner-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Goal management enhancements](https://servicenow-staging.fluidtopics.net/access?context=managing-backlog-alignment-planner-workspace&family=washingtondc&ft:locale=en-US)**
    ...
    -   When creating a target, the **Contributors** field on the [Target form](https://servicenow-staging.fluidtopics.net/access?context=target-form-egm&family=washingtondc&ft:locale=en-US) is automatically populated with the contributors of its goal.
...
-   **[Financial planning for planning items](https://servicenow-staging.fluidtopics.net/access?context=financials-strategic-planning&family=washingtondc&ft:locale=en-US)**
    ...
    -   Create expense lines to capture any unplanned costs to meet your work requirements without associating them to any forecasted planned costs. For more information, see [Add or edit expense lines](https://servicenow-staging.fluidtopics.net/access?context=create-expense-line&family=washingtondc&ft:locale=en-US).
...
-   **[Scoring enhancements](https://servicenow-staging.fluidtopics.net/access?context=managing-backlog-alignment-planner-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Export data of portfolio plan items from Scoring or Prioritization](https://servicenow-staging.fluidtopics.net/access?context=export-data-from-list-view-of-prioritization-spw&family=washingtondc&ft:locale=en-US)**
...
For more information, see [Export planning items data from Scoring to Excel or CSV](https://servicenow-staging.fluidtopics.net/access?context=export-planning-items-data-from-scoring&family=washingtondc&ft:locale=en-US) and [Export data of portfolio plan items from Prioritization to Excel or CSV](https://servicenow-staging.fluidtopics.net/access?context=export-data-from-list-view-of-prioritization-spw&family=washingtondc&ft:locale=en-US).

-   **[Strategic Planning with PPM, Agile 2.0, and SAFe](https://servicenow-staging.fluidtopics.net/access?context=managing-backlog-alignment-planner-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Operation work in Capacity Planning](https://servicenow-staging.fluidtopics.net/access?context=using-cap-plan-spw&family=washingtondc&ft:locale=en-US)**
...
-   **[Enable or disable scoring frameworks](https://servicenow-staging.fluidtopics.net/access?context=custom-scoring-frameworks-in-strategic-planning&family=washingtondc&ft:locale=en-US)**
...
-   **[Product idea deprecations](https://servicenow-staging.fluidtopics.net/access?context=managing-product-feedback-in-strategic-planning&family=washingtondc&ft:locale=en-US)**
...
-   View operational resource assignments on the Capacity Planning screen.
 ...
 See [Strategic Planning](https://servicenow-staging.fluidtopics.net/access?context=alignment-planner-workspace-landing-page&family=washingtondc&ft:locale=en-US) for more information.
