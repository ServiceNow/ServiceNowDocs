---
title: Combined Customer Contracts and Entitlements release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Customer Contracts and Entitlements from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-customercontractsandentitlements-release-notes.html
release: zurich
...
# Combined Customer Contracts and Entitlements release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Customer Contracts and Entitlements from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Customer Contracts and Entitlements release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Create and manage contracts](https://servicenow-staging.fluidtopics.net/access?context=create-service-contract&family=washingtondc&ft:locale=en-US)**

Create contracts manually and import and synchronize existing contracts to retain updated data.

-   **[Work in agent workspace](https://servicenow-staging.fluidtopics.net/access?context=using-post-sales-support&family=washingtondc&ft:locale=en-US)**

View, utilize, and manage contracts and entitlements in the ServiceNow® CSM Agent Workspace.

-   **[Generating new customer contracts and entitlements](https://servicenow-staging.fluidtopics.net/access?context=cont-ent-workflows-csm&family=washingtondc&ft:locale=en-US)**

Manage the life cycle of customer service contracts and entitlements from offer creation to contract generation.

-   **[Integrating offer to contract services](https://servicenow-staging.fluidtopics.net/access?context=create-cont-ent-workflows-csm&family=washingtondc&ft:locale=en-US)**
...
-   **[Managing contracts and entitlements](https://servicenow-staging.fluidtopics.net/access?context=cont-ent-workflows-csm&family=washingtondc&ft:locale=en-US)**
...
-   **[Renew service contract](https://servicenow-staging.fluidtopics.net/access?context=cce-renew-service-contract&family=washingtondc&ft:locale=en-US)**

Renew a service contract before the contract expires.

-   **[Service contract lines for subscription plans](https://servicenow-staging.fluidtopics.net/access?context=create-cont-ent-workflows-csm&family=washingtondc&ft:locale=en-US)**

Create contract lines for subscription products and services.

-   **[Resuming, cancelling, and suspending service contracts](https://servicenow-staging.fluidtopics.net/access?context=using-post-sales-support&family=washingtondc&ft:locale=en-US)**
...
-   Manage and modify contracts, contract lines, and entitlements.
 ...
 See [Post-Sales Support](https://servicenow-staging.fluidtopics.net/access?context=exploring-post-sales-support&family=washingtondc&ft:locale=en-US) for more information.
