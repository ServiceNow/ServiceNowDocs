---
title: Combined Automated Test Framework release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Automated Test Framework from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-automatedtestframework-release-notes.html
release: zurich
...
# Combined Automated Test Framework release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Automated Test Framework from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Automated Test Framework release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Performance profiling](https://servicenow-staging.fluidtopics.net/access?context=atf-perf-prof&family=washingtondc&ft:locale=en-US)**
...
-   **[Configurable workspace support](https://servicenow-staging.fluidtopics.net/access?context=test-steps-form-category&family=washingtondc&ft:locale=en-US)**
...
-   **[Declarative Action Visibility test step](https://servicenow-staging.fluidtopics.net/access?context=atf-declarative-visible&family=washingtondc&ft:locale=en-US)**
...
-   **[Click a Declarative Action test step](https://servicenow-staging.fluidtopics.net/access?context=atf-click-declarative-action&family=washingtondc&ft:locale=en-US)**
...
-   Reduce test design time by copying quick start tests and test suites. You can also create custom test steps to expand test coverage.
 ...
 See [Test your apps with the ATF](https://servicenow-staging.fluidtopics.net/access?context=automated-test-framework&family=washingtondc&ft:locale=en-US) for more information.
