---
title: Combined Subscription Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Subscription Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-subscriptionmanagement-release-notes.html
release: zurich
...
# Combined Subscription Management release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Subscription Management from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Subscription Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Proactively manage your subscriptions](https://servicenow-staging.fluidtopics.net/access?context=subscriptions-overview-v2&family=washingtondc&ft:locale=en-US)**

View a summary of your product subscriptions in a new user interface that prioritizes actionable data.

-   **[View insights about your subscription allocations](https://servicenow-staging.fluidtopics.net/access?context=discovering-insights-subscription-management-v2&family=washingtondc&ft:locale=en-US)**
...
-   **[Allocate subscriptions using recommended groups](https://servicenow-staging.fluidtopics.net/access?context=allocate-subscriptions-v2&family=washingtondc&ft:locale=en-US)**

Grant entitlement to the right users by allocating subscriptions using recommended groups.

-   **[Address issues with your product subscriptions](https://servicenow-staging.fluidtopics.net/access?context=addressing-issues-subscription-management-v2&family=washingtondc&ft:locale=en-US)**

Stay in compliance by mapping custom tables and custom applications to your product subscriptions.

-   **[View application installation status](https://servicenow-staging.fluidtopics.net/access?context=subscription-details-v2&family=washingtondc&ft:locale=en-US)**

Determine whether an application is available for install from the current product subscription.

-   **[Monitor Now Assist usage](https://servicenow-staging.fluidtopics.net/access?context=monitoring-now-assist-usage&family=washingtondc&ft:locale=en-US)**

View an account-level summary of your Now Assist entitlements and track Now Assist usage across all your instances.

-   **[Monitor Now Assist creators](https://servicenow-staging.fluidtopics.net/access?context=monitoring-now-assist-creator&family=washingtondc&ft:locale=en-US)**
...
-   Avoid unexpected costs by tracking subscription usage and allocations over time.
 ...
 See [Subscription Management](https://servicenow-staging.fluidtopics.net/access?context=subscription-management-landing-page-v2&family=washingtondc&ft:locale=en-US) for more information.
