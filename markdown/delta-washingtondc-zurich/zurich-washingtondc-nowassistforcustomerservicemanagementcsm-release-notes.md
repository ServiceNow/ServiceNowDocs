---
title: Combined Now Assist for Customer Service Management \(CSM\) release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Now Assist for Customer Service Management \(CSM\) from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-nowassistforcustomerservicemanagementcsm-release-notes.html
release: zurich
...
# Combined Now Assist for Customer Service Management \(CSM\) release notes for upgrades from Washington DC to Zurich
...
To help you prepare for your upgrade, we have combined the cross-family Now Assist for Customer Service Management \(CSM\) release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Add conditions to skill availability](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm-configuring&family=washingtondc&ft:locale=en-US)**
...
-   **[Restrict skill availability by user role](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm-configuring&family=washingtondc&ft:locale=en-US)**

Specify the roles that can access the skills for case summarization and resolution notes summarization.

-   **[Post-call summarization](https://servicenow-staging.fluidtopics.net/access?context=summarize-a-call-by-using-now-assist-for-customer-service-management-csm&family=washingtondc&ft:locale=en-US)**

Analyze a call after it's done and then provide a summary of the main points that were discussed during the call.

-   **[Generate a knowledge article from the CSM Configurable Workspace and classic environment with Now Assist](https://servicenow-staging.fluidtopics.net/access?context=Now-Assist-generate-article-csm-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Dynamic translation for Now Assist Q&amp;A in self-service](https://servicenow-staging.fluidtopics.net/access?context=enable-dynamic-lang-detection&family=washingtondc&ft:locale=en-US)**
...
-   **[Prompt Configurability support in the Now Assist Admin](https://servicenow-staging.fluidtopics.net/access?context=customize-a-now-assist-for-csm-skill&family=washingtondc&ft:locale=en-US)**
...
-   **[Suggested steps in Recommended Actions](https://servicenow-staging.fluidtopics.net/access?context=suggested-steps-generation-in-now-assist-for-customer-service-management-csm&family=xanadu&ft:locale=en-US)**
...
-   **[Triage cases agentic workflows enhancements](https://servicenow-staging.fluidtopics.net/access?context=case-resolving-use-case&family=xanadu&ft:locale=en-US)**
...
-   **[Triage cases AI agents use case](https://servicenow-staging.fluidtopics.net/access?context=csm-ai-agents-use-cases&family=xanadu&ft:locale=en-US)**
...
-   **[Summarizing sidebar conversations](https://servicenow-staging.fluidtopics.net/access?context=summarize-sidebar-conversations&family=xanadu&ft:locale=en-US)**

Use Now Assist for CSM to summarize sidebar discussions between agents, requesters, and subject matter experts.

-   **[Real-time chat reply recommendations](https://servicenow-staging.fluidtopics.net/access?context=generate-chat-reply-recommendations&family=xanadu&ft:locale=en-US)**
...
-   **[Generative AI-powered email reply recommendations](https://servicenow-staging.fluidtopics.net/access?context=generate-email-reply-recommendations&family=xanadu&ft:locale=en-US)**
...
-   **[Multilingual support for Now Assist for CSM skills](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm-supporting-info&family=xanadu&ft:locale=en-US)**
...
-   **[Minimum text requirement for case summarization](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm-summarize-case&family=washingtondc&ft:locale=en-US)**
...
-   **[Case summarization enhancements](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm-skill-inputs&family=washingtondc&ft:locale=en-US)**
...
-   **[Resolution notes enhancements](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm-skill-inputs&family=washingtondc&ft:locale=en-US)**

Use email as input to generate resolution notes for a case and propose a solution to the customer.

-   **[Chat summarization enhancements](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm-skill-inputs&family=washingtondc&ft:locale=en-US)**
...
-   **[Enhancement in post-call summarization](https://servicenow-staging.fluidtopics.net/access?context=summarize-a-call-by-using-now-assist-for-customer-service-management-csm&family=xanadu&ft:locale=en-US)**
...
-   **[Knowledge generation from multiple cases](https://servicenow-staging.fluidtopics.net/access?context=Now-Assist-generate-article-csm-workspace&family=xanadu&ft:locale=en-US)**
...
-   **[Enhancements in chat summarization](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm-summarize-chat&family=xanadu&ft:locale=en-US)**
...
-   **[Enhancements in Email recommendation](https://servicenow-staging.fluidtopics.net/access?context=generate-email-reply-recommendations&family=xanadu&ft:locale=en-US)**
...
-   **[Enhancement in Resolution notes generation](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm-generate-resolution&family=xanadu&ft:locale=en-US)**
...
-   **[Enhancements in Knowledge generation](https://servicenow-staging.fluidtopics.net/access?context=Now-Assist-generate-article-csm-workspace&family=xanadu&ft:locale=en-US)**
...
-   **Xanadu Patch 7 [Case summarization enhancement](https://servicenow-staging.fluidtopics.net/access?context=customize-a-now-assist-for-csm-skill&family=xanadu&ft:locale=en-US)**
...
Now Assist features are available with activation of the Now Assist for CSM plugin. For more information, see [Install Now Assist plugins](https://servicenow-staging.fluidtopics.net/access?context=install-now-assist-feature-plugins&family=washingtondc&ft:locale=en-US).
...
Now Assist features are available with activation of the Now Assist for CSM plugin. For more information, see [Install Now Assist plugins](https://servicenow-staging.fluidtopics.net/access?context=install-now-assist-feature-plugins&family=xanadu&ft:locale=en-US).
...
-   Attribute roles to the activities in the case summarization and resolution notes generation to reduce hallucinations and improve the summary quality.
 ...
 See [Now Assist for Customer Service Management \(CSM\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm&family=washingtondc&ft:locale=en-US) for more information.
...
-   Summarize records to make it easier to hand off calls between agents and help improve customer satisfaction.
 ...
 See [Now Assist for Customer Service Management \(CSM\)](https://servicenow-staging.fluidtopics.net/access?context=now-assist-csm&family=xanadu&ft:locale=en-US) for more information.
