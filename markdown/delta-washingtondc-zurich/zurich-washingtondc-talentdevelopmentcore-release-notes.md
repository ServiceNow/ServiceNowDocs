---
title: Combined Talent Development Core release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Talent Development Core from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-talentdevelopmentcore-release-notes.html
release: zurich
...
# Combined Talent Development Core release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Talent Development Core from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Talent Development Core release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Talent Development Core to Zurich
...
Between your current release family and Zurich, new features were introduced for Talent Development Core.
...
-   **[Opportunity Marketplace](https://servicenow-staging.fluidtopics.net/access?context=egd-opportunity-marketplace-ovrvw&family=washingtondc&ft:locale=en-US)**

Help employees discover new opportunities that support their career and organizational growth.

-   **[Conversations](https://servicenow-staging.fluidtopics.net/access?context=egd-conversations-ovrvw&family=washingtondc&ft:locale=en-US)**

Use Microsoft Outlook with Talent Development activities to schedule and manage conversations.

-   **[Mentoring](https://servicenow-staging.fluidtopics.net/access?context=mentoring-egd-overview&family=washingtondc&ft:locale=en-US)**

Build meaningful mentor relationships that drives employee development and promotes continuous career conversations and engagement.

-   **[Growth Plans](https://servicenow-staging.fluidtopics.net/access?context=egd-growth-plans-ovrvw&family=washingtondc&ft:locale=en-US)**

Help employees manage career activities, educational learning, team building, and work-life balance.

-   **[Aspirations](https://servicenow-staging.fluidtopics.net/access?context=egd-aspirations-overview&family=washingtondc&ft:locale=en-US)**

Use new application widgets to help promote aspirations that link with your skills and career development.
...
Between your current release family and Zurich, some changes were made to existing Talent Development Core features.
...
Between your current release family and Zurich, some Talent Development Core features or functionality were removed.
...
Between your current release family and Zurich, some Talent Development Core features or functionality were deprecated.
...
Review information on how to activate Talent Development Core.
...
Install Talent Development by requesting it from the ServiceNow Store. Visit the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website to view all the available apps and for information about submitting requests to the ServiceNow Store. For cumulative release notes information for all released apps, see the [ServiceNow Store version history release notes](https://servicenow-staging.fluidtopics.net/access?context=sn-store-release-notes&family=washingtondc&ft:locale=en-US).
...
If any additional requirements were introduced or changed for Talent Development Core we have noted them here.
...
If any specific browser requirements were introduced or changed for Talent Development Core we have noted them here.
...
Review details on accessibility information for Talent Development Core, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Talent Development Core we have noted them here.
...
If there are specific highlight considerations for Talent Development Core we have noted them here.
...
-   Use Mentoring to create meaningful relationships within the organization and also foster a culture of knowledge, sharing, and collaboration.
 ...
 See [Talent Development Core](https://servicenow-staging.fluidtopics.net/access?context=egd-landing-page&family=washingtondc&ft:locale=en-US) for more information.
