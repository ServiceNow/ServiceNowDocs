---
title: Combined Business Continuity Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Business Continuity Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-businesscontinuitymanagement-release-notes.html
release: zurich
...
# Combined Business Continuity Management release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Business Continuity Management from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Business Continuity Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Configuring the Dictionary, UI policy, element variables, and UI view](https://servicenow-staging.fluidtopics.net/access?context=bcm-enhanced-bia-logic&family=washingtondc&ft:locale=en-US)**
...
-   **[Automate the recovery task in the plan](https://servicenow-staging.fluidtopics.net/access?context=automate-the-recovery-tasks&family=washingtondc&ft:locale=en-US)**
...
-   **[Add a task to the crisis event](https://servicenow-staging.fluidtopics.net/access?context=add-event-task-to-crisis-event&family=washingtondc&ft:locale=en-US)**
...
-   **[Schedule an auto-update of the dependencies](https://servicenow-staging.fluidtopics.net/access?context=update-impactanalysis-dep-based-on-cmdb-changes&family=washingtondc&ft:locale=en-US)**
...
-   **[Schedule an auto-update of the related assets](https://servicenow-staging.fluidtopics.net/access?context=import-cmdb-updates-in-plans&family=washingtondc&ft:locale=en-US)**
...
-   **[Adding the dependencies of the impacted assets](https://servicenow-staging.fluidtopics.net/access?context=import-event-dep-updates&family=washingtondc&ft:locale=en-US)**
...
-   Add the dependencies of the impacted assets manually in the events and exercises from the CMDB, BIA, and plans.
 ...
 See [Business Continuity Management](https://servicenow-staging.fluidtopics.net/access?context=business-continuity-mangmt-overview&family=washingtondc&ft:locale=en-US) for more information.
