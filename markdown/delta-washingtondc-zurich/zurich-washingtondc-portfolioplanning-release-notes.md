---
title: Combined Portfolio Planning release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Portfolio Planning from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-portfolioplanning-release-notes.html
release: zurich
...
# Combined Portfolio Planning release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Portfolio Planning from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Portfolio Planning release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Financial planning for Projects and Demands](https://servicenow-staging.fluidtopics.net/access?context=financials-portfolio-planning&family=washingtondc&ft:locale=en-US)**
    ...
    -   Delete descoped cost plans using the row context menu icon \(\[Omitted image "image.row-context-menu-icon"\] Alt text: Row context menu icon.\) to manage your financials efficiently.
...
-   **[Export data of portfolio plan items from the List view of the Prioritization tab](https://servicenow-staging.fluidtopics.net/access?context=export-data-from-list-view-of-prioritization&family=washingtondc&ft:locale=en-US)**
...
-   **[Prioritization enhancements](https://servicenow-staging.fluidtopics.net/access?context=prioritizing-work-in-portfolio-planning-workspace&family=washingtondc&ft:locale=en-US)**
    -   Assign the highest and lowest ranks to the planning items using the **Move to top** and **Move to bottom** options respectively from the row context menu icon \(\[Omitted image "image.row-context-menu-icon"\] Alt text: Row context menu icon.\).
    ...
    -   View and manage the item details quickly from the side panel using the Preview record icon \(\[Omitted image "image.icon-view-item-details"\] Alt text: View item details icon.\) in the List view of the **Prioritization** tab.
-   **[Plan efficiently with additional pre-defined lens](https://servicenow-staging.fluidtopics.net/access?context=lens-and-portfolio-plans&family=washingtondc&ft:locale=en-US)**

Using the Project Program lens, program managers and portfolio managers can plan, prioritize, and roadmap work in programs.

-   **[Tagging planning items](https://servicenow-staging.fluidtopics.net/access?context=categorize-and-find-work-items-using-tags-ppw&family=washingtondc&ft:locale=en-US)**
...
-   **[Planning enhancements](https://servicenow-staging.fluidtopics.net/access?context=managing-backlog-alignment-planner-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Portfolio Planning with PPM](https://servicenow-staging.fluidtopics.net/access?context=managing-backlog-alignment-planner-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Operation work in Capacity Planning](https://servicenow-staging.fluidtopics.net/access?context=using-cap-plan-pp&family=washingtondc&ft:locale=en-US)**
...
-   **[Support for truncation](https://servicenow-staging.fluidtopics.net/access?context=next-experience-accessibility-preferences&family=washingtondc&ft:locale=en-US)**

The following views of the Portfolio Planning Workspace were updated to show the truncated text for non-interactive elements when the “Enable keyboard focus on truncated text” accessibility user preference is turned on:

    -   List view of the **Prioritization** tab
    -   Hierarchy view of the **Prioritization** tab
    -   Timeline view of portfolio plan and free-form roadmaps
    -   Capacity Planning
This enhancement supports sighted users who rely solely on a keyboard to use the ServiceNow platform. For more information, see [Configure Next Experience accessibility preferences](https://servicenow-staging.fluidtopics.net/access?context=next-experience-accessibility-preferences&family=washingtondc&ft:locale=en-US).

-   **[Invisible Controls](https://servicenow-staging.fluidtopics.net/access?context=next-experience-accessibility-preferences&family=washingtondc&ft:locale=en-US)**

The following views of the Portfolio Planning Workspace were updated to automatically display controls that aren’t normally visible when the **Show all buttons without the need to hover** accessibility user preference is turned on:
...
-   View operational resource assignments on the Capacity Planning screen.
 ...
 See [Portfolio Planning](https://servicenow-staging.fluidtopics.net/access?context=portfolio-planning-app-landing-page&family=washingtondc&ft:locale=en-US) for more information.
...
-   Prioritize and roadmap the program \[pm\_program\] items for your organization at a high level by building portfolio plans using the Project Program lens.
