---
title: Combined Operational Resilience release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Operational Resilience from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-operationalresilience-release-notes.html
release: zurich
...
# Combined Operational Resilience release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Operational Resilience from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Operational Resilience release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Roles installed with Operational Resilience](https://servicenow-staging.fluidtopics.net/access?context=roles-installed-with-op-res&family=washingtondc&ft:locale=en-US)**
...
-   **[\[Placeholder link text to key bundle-grc.grc-operational-resilience-dashboard\]](https://servicenow-staging.fluidtopics.net/access?context=grc-operational-resilience-dashboard&family=washingtondc&ft:locale=en-US)**
...
-   **[Fetching dependencies from the CMDB and BIA](https://servicenow-staging.fluidtopics.net/access?context=add-dependencies-automatically&family=washingtondc&ft:locale=en-US)**
...
-   Auto-populate the dependency mappings for the business services based on the source-data relationships in the business impact assessment \(BIA\).
 ...
 See [Operational Resilience](https://servicenow-staging.fluidtopics.net/access?context=grc-opres-landing-page&family=washingtondc&ft:locale=en-US) for more information.
