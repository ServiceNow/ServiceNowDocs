---
title: Combined AI Control Tower release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for AI Control Tower from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-aicontroltower-release-notes.html
release: zurich
...
# Combined AI Control Tower release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for AI Control Tower from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family AI Control Tower release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Health tab in AI Control Tower](https://servicenow-staging.fluidtopics.net/access?context=aict-health-tab&family=yokohama&ft:locale=en-US)**

Monitor and evaluate the effectiveness of offensive content and prompt injection guardrails active on your AI assets.

-   **[Evaluation tab](https://servicenow-staging.fluidtopics.net/access?context=ai-evaluation&family=yokohama&ft:locale=en-US)**

Measure and improve the quality of interactions with virtual agents using the Evaluation tab.


 -   **[Explore AI model providers](https://servicenow-staging.fluidtopics.net/access?context=ai-model-providers&family=yokohama&ft:locale=en-US)**

Enable choice for third party model providers powering ServiceNow® skills and agents.


-   **[AI Governance](https://servicenow-staging.fluidtopics.net/access?context=ai-control-tower-landing&family=yokohama&ft:locale=en-US)**
...
-   **[Security and privacy tab](https://servicenow-staging.fluidtopics.net/access?context=security-privacy-tab&family=zurich&ft:locale=en-US)**
...
-   **[AI Gateway tab](https://servicenow-staging.fluidtopics.net/access?context=ai-gateway-tab&family=zurich&ft:locale=en-US)**
...
-   **[Data section on Configurations page](https://servicenow-staging.fluidtopics.net/access?context=data&family=zurich&ft:locale=en-US)**
...
-   **[AI Task section on AI assets page](https://servicenow-staging.fluidtopics.net/access?context=ai-assets&family=zurich&ft:locale=en-US)**
...
-   **[Enhance control of AI asset life cycle through change and offboarding requests](https://servicenow-staging.fluidtopics.net/access?context=creating-ai-asset-requests&family=zurich&ft:locale=en-US)**
...
-   **[Health tab in AI Control Tower](https://servicenow-staging.fluidtopics.net/access?context=aict-health-tab&family=zurich&ft:locale=en-US)**

Monitor and evaluate the effectiveness of offensive content and prompt injection guardrails active on your AI assets.


-   **[AI strategy with Strategic Planning](https://servicenow-staging.fluidtopics.net/access?context=ai-strategy-aict&family=zurich&ft:locale=en-US)\(Requires SPM\)**
...
-   **[AI strategy with Goal Framework](https://servicenow-staging.fluidtopics.net/access?context=ai-strategy-aict&family=zurich&ft:locale=en-US) \(Requires SPM\)**

Monitor and track your AI strategies and associated goals and targets.

-   **[Enterprise AI discovery: Unlock Visibility, Governance &amp; Value](https://servicenow-staging.fluidtopics.net/access?context=enterprise-ai-discovery&family=zurich&ft:locale=en-US)**
...
-   **[Value tab](https://servicenow-staging.fluidtopics.net/access?context=aict-value-tab&family=zurich&ft:locale=en-US)**
...
-   **[Value templates](https://servicenow-staging.fluidtopics.net/access?context=using-value-templates&family=zurich&ft:locale=en-US)**
...
-   **[Risk and compliance tab](https://servicenow-staging.fluidtopics.net/access?context=risk-and-complaince-tab&family=zurich&ft:locale=en-US)**
...
-   **[AI cases tab](https://servicenow-staging.fluidtopics.net/access?context=ai-cases-tab-aict&family=zurich&ft:locale=en-US)**
...
-   **[Specify additional details during AI asset creation](https://servicenow-staging.fluidtopics.net/access?context=creating-ai-assets&family=zurich&ft:locale=en-US)**
...
-   **[Changes in Zurich Patch 4](https://servicenow-staging.fluidtopics.net/access?context=zurich-patch-4&family=zurich&ft:locale=en-US)**
...
-   AI connections are introduced in AI Control Tower using Service Graph Connectors. AI connections are combination of hyperscalars, AI apps, and agentic AI frameworks. The AI Service Graph Connectors available from March 2026:
    -   [AWS](https://servicenow-staging.fluidtopics.net/access?context=aws_0&family=yokohama&ft:locale=en-US)
    -   [Microsoft](https://servicenow-staging.fluidtopics.net/access?context=microsoft&family=yokohama&ft:locale=en-US)- Azure Foundry and Copilot
    -   [n8n](https://servicenow-staging.fluidtopics.net/access?context=n8n&family=yokohama&ft:locale=en-US)
    -   [GCP Vertex AI](https://servicenow-staging.fluidtopics.net/access?context=gcp-vertex-ai&family=yokohama&ft:locale=en-US)
    -   [LangGraph](https://servicenow-staging.fluidtopics.net/access?context=langgraph&family=yokohama&ft:locale=en-US)
    -   [Salesforce](https://servicenow-staging.fluidtopics.net/access?context=salesforce&family=yokohama&ft:locale=en-US)
...
-   Track costs of your AI projects, epics, demands, and track key project risks, issues, decisions, actions, and changes from the **AI strategy** tab.
 ...
 See [AI Governance](https://servicenow-staging.fluidtopics.net/access?context=ai-control-tower-landing&family=zurich&ft:locale=en-US) for more information.
