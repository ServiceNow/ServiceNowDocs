---
title: Combined Workspace release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Workspace from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-workspace-release-notes.html
release: zurich
...
# Combined Workspace release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Workspace from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Workspace release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Save email drafts](https://servicenow-staging.fluidtopics.net/access?context=review-draft-emails&family=washingtondc&ft:locale=en-US)**
...
-   **[Add email addresses into recipient fields](https://servicenow-staging.fluidtopics.net/access?context=drag-and-drop-recipients-in-to-cc-and-bcc-email-fields&family=washingtondc&ft:locale=en-US)**

Copy and paste email addresses into the recipient fields in the email client.

-   **[Insert link to knowledge article in email](https://servicenow-staging.fluidtopics.net/access?context=add-article-agent-assist&family=washingtondc&ft:locale=en-US)**
...
-   **[Declarative actions configuration improvements](https://servicenow-staging.fluidtopics.net/access?context=declarative-actions-landing&family=washingtondc&ft:locale=en-US)**
...
-   **[Translations via payload for UXF Client Actions](https://servicenow-staging.fluidtopics.net/access?context=create-a-new-uxf-client-action-for-forms&family=washingtondc&ft:locale=en-US)**
...
-   Get more versatility while working in your workspace with more supported field types, unified actions, and auto-save functionality for emails.
 ...
 See [Configurable Workspace UI](https://servicenow-staging.fluidtopics.net/access?context=workspace-landing-page&family=washingtondc&ft:locale=en-US) for more information.
