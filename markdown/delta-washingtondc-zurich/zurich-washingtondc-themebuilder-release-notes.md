---
title: Combined Theme Builder release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Theme Builder from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-themebuilder-release-notes.html
release: zurich
...
# Combined Theme Builder release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Theme Builder from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Theme Builder release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Component editing](https://servicenow-staging.fluidtopics.net/access?context=tb-edit-components&family=washingtondc&ft:locale=en-US)**
...
-   **[New feature messaging](https://servicenow-staging.fluidtopics.net/access?context=configuring-next-experience-with-theme-builder&family=washingtondc&ft:locale=en-US)**

Learn about new features via a what's new modal when you first launch the updated version of Theme Builder.

-   **[Open in Theme Builder button](https://servicenow-staging.fluidtopics.net/access?context=config-next-experience-themes-prefs&family=washingtondc&ft:locale=en-US)**
...
-   **[Validation of JSON code for the theme records you create](https://servicenow-staging.fluidtopics.net/access?context=config-next-experience-themes-prefs&family=washingtondc&ft:locale=en-US)**
...
-   **[Customize shape and topography values](https://servicenow-staging.fluidtopics.net/access?context=tb-create-theme&family=washingtondc&ft:locale=en-US)**
...
-   Work with component-specific theme hooks to create a theme tailored to your needs.
 ...
 See [Working with themes in Next Experience](https://servicenow-staging.fluidtopics.net/access?context=next-experience-theming&family=washingtondc&ft:locale=en-US) for more information.
