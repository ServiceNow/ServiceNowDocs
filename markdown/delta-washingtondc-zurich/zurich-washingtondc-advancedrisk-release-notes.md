---
title: Combined Advanced Risk release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Advanced Risk from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-advancedrisk-release-notes.html
release: zurich
...
# Combined Advanced Risk release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Advanced Risk from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Advanced Risk release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Parallel Review and Feedback in Advanced Risk](https://servicenow-staging.fluidtopics.net/access?context=integrate-advanced-risk-with-parallel-review-feedback&family=washingtondc&ft:locale=en-US)**
...
-   **[Generating a report in Microsoft Word](https://servicenow-staging.fluidtopics.net/access?context=integrating-o365-with-management-reporting-of-risk&family=washingtondc&ft:locale=en-US)**
...
-   **[Exporting risk heatmap information](https://servicenow-staging.fluidtopics.net/access?context=risk-heatmap-workbench&family=washingtondc&ft:locale=en-US)**
...
-   **[Auto save feature in the risk and control assessment form](https://servicenow-staging.fluidtopics.net/access?context=perform-ara-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Domain separation in Risk Management](https://servicenow-staging.fluidtopics.net/access?context=domain-separation-risk-management&family=washingtondc&ft:locale=en-US)**
...
-   Approve and reassign multiple risk assessments in bulk.
 ...
 See [Advanced Risk Assessment](https://servicenow-staging.fluidtopics.net/access?context=advanced-risk-assessment&family=washingtondc&ft:locale=en-US) for more information.
