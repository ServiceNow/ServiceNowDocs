---
title: Combined Next Experience release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Next Experience from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-nextexperience-release-notes.html
release: zurich
...
# Combined Next Experience release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Next Experience from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Next Experience release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Keyboard shortcuts](https://servicenow-staging.fluidtopics.net/access?context=r_KeyboardShortcuts&family=washingtondc&ft:locale=en-US)**
...
-   **["No records to display" graphic can be suppressed](https://servicenow-staging.fluidtopics.net/access?context=pol-sys-properties&family=washingtondc&ft:locale=en-US)**
...
-   **[What's New content added to Help Center](https://servicenow-staging.fluidtopics.net/access?context=next-experience-in-product-help&family=washingtondc&ft:locale=en-US)**
...
-   **[Next Experience keyboard shortcuts](https://servicenow-staging.fluidtopics.net/access?context=next-experience-keyboard-shortcuts&family=xanadu&ft:locale=en-US)**

Use a new keyboard shortcut to reduce the time required to open the OpenFrame window.

-   **[User experience user preference group added](https://servicenow-staging.fluidtopics.net/access?context=set-up-preferences-next-experience&family=xanadu&ft:locale=en-US)**
...
-   **[Pin your notifications menu](https://servicenow-staging.fluidtopics.net/access?context=using-the-next-experience-global-header&family=xanadu&ft:locale=en-US)**

Pin your notifications menu for quick access to important updates.

-   **[View Next Experience performance metrics](https://servicenow-staging.fluidtopics.net/access?context=measuring-performance-next-experience&family=xanadu&ft:locale=en-US)**

View performance metrics for any Next Experience page.

-   **[Preserve your custom Next Experience theme during a clone](https://servicenow-staging.fluidtopics.net/access?context=preserve-next-experience-theme-during-clone&family=xanadu&ft:locale=en-US)**
...
-   **[Impersonate user feature improved](https://servicenow-staging.fluidtopics.net/access?context=c_ImpersonateAUser&family=washingtondc&ft:locale=en-US)**
...
-   **[Select a theme in Next Experience](https://servicenow-staging.fluidtopics.net/access?context=select-a-theme-in-next-experience&family=xanadu&ft:locale=en-US)**
...
-   **[Next Experience keyboard shortcuts](https://servicenow-staging.fluidtopics.net/access?context=next-experience-keyboard-shortcuts&family=washingtondc&ft:locale=en-US)**
...
-   **[Reflow](https://servicenow-staging.fluidtopics.net/access?context=auto-reflow&family=washingtondc&ft:locale=en-US)**
...
-   Enhancements to the Impersonate user UI.
 ...
 See [Next Experience UI](https://servicenow-staging.fluidtopics.net/access?context=next-experience-landing-page&family=washingtondc&ft:locale=en-US) for more information.
...
-   A new client interaction table displays UI load times for identifying and investigating performance anomalies.
 ...
 See [Next Experience UI](https://servicenow-staging.fluidtopics.net/access?context=next-experience-landing-page&family=xanadu&ft:locale=en-US) for more information.
