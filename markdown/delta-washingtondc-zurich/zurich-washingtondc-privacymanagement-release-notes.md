---
title: Combined Privacy Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Privacy Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-privacymanagement-release-notes.html
release: zurich
...
# Combined Privacy Management release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Privacy Management from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Privacy Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Privacy Case Management](https://servicenow-staging.fluidtopics.net/access?context=privacy-case-management-overview&family=washingtondc&ft:locale=en-US)**
...
-   **[Privacy Case Management integration for RadarFirst](https://servicenow-staging.fluidtopics.net/access?context=integrating-with-radarfirst&family=washingtondc&ft:locale=en-US)**
...
-   **[Functional domain](https://servicenow-staging.fluidtopics.net/access?context=set-up-steps-it-compliance-ws&family=washingtondc&ft:locale=en-US)**
...
-   Refer to the **Functional domain** field that is automatically set to **Privacy** when the users with privacy roles work on forms such as processing activities, controls, and so on.
 ...
 See [Exploring Privacy Management](https://servicenow-staging.fluidtopics.net/access?context=explore-privacy-management&family=washingtondc&ft:locale=en-US) for more information.
