---
title: Combined Dispute Rules Content Pack for Visa release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Dispute Rules Content Pack for Visa from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-disputerulescontentpackforvisa-release-notes.html
release: zurich
...
# Combined Dispute Rules Content Pack for Visa release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Dispute Rules Content Pack for Visa from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Dispute Rules Content Pack for Visa release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Data model updates](https://servicenow-staging.fluidtopics.net/access?context=components-installed-with-dispute-rules-content-pack-for-visa&family=washingtondc&ft:locale=en-US)**

Dispute questionnaire tables are available to support responses to the VROL questionnaire.

-   **[Decision tables](https://servicenow-staging.fluidtopics.net/access?context=installed-with-card-operations&family=washingtondc&ft:locale=en-US)**
...
-   **[Dispute case playbook](https://servicenow-staging.fluidtopics.net/access?context=using-the-dispute-rules-content-pack-for-visa&family=washingtondc&ft:locale=en-US)**
...
-   Refine chargeback eligibility rules to apply to all regions in addition to the US.
 ...
 See [Dispute Rules Content Pack for Visa](https://servicenow-staging.fluidtopics.net/access?context=dispute-rules-content-pack-for-visa-landing-page-1&family=washingtondc&ft:locale=en-US) for more information.
