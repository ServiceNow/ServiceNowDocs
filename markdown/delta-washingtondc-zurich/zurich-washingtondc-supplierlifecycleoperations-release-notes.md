---
title: Combined Supplier Lifecycle Operations release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Supplier Lifecycle Operations from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-supplierlifecycleoperations-release-notes.html
release: zurich
...
# Combined Supplier Lifecycle Operations release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Supplier Lifecycle Operations from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Supplier Lifecycle Operations release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Supplier Lifecycle Operations to Zurich
...
After upgrading from the Vancouver release to the Washington DC release, you will see only the Source-to-Pay Workspace on the **All** navigation tab. You don't have to do anything if you choose to continue to use the Source-to-Pay Workspace.
 ...
 If you want to revert to using the Source-to-Pay Workspace, run the `fixscript_migrate_workspace_to_s2p.xml` fix script. You can download the `fixscript_migrate_workspace_to_smw.xml` file from the ServiceNow Store. For more information about how to run a fix script, see [Run fix scripts](https://servicenow-staging.fluidtopics.net/access?context=t_RunFixScripts&family=washingtondc&ft:locale=en-US).

 After you upgrade to Washington DC, you must review all the post-upgrade tasks and complete them as needed. For more information, see [Post-upgrade tasks for Supplier Lifecycle Management](https://servicenow-staging.fluidtopics.net/access?context=post-upgrade-tasks-slo&family=washingtondc&ft:locale=en-US).
...
Between your current release family and Zurich, new features were introduced for Supplier Lifecycle Operations.
...
-   **[Help Center](https://servicenow-staging.fluidtopics.net/access?context=help-center&family=washingtondc&ft:locale=en-US)**
...
-   **[Offboard a supplier from the Procurement Workspace](https://servicenow-staging.fluidtopics.net/access?context=offboard-supplier&family=washingtondc&ft:locale=en-US)**
...
-   **[Supplier Lifecycle Management integration framework](https://servicenow-staging.fluidtopics.net/access?context=slo-int-framework&family=washingtondc&ft:locale=en-US)**
...
-   **[Configure due dates for tasks](https://servicenow-staging.fluidtopics.net/access?context=configure-task-due-date&family=washingtondc&ft:locale=en-US)**

Configure due dates for different task types so that the **Due date** field is auto-populated when you create tasks.

-   **[Complete a risk assessment from the Supplier Collaboration Portal](https://servicenow-staging.fluidtopics.net/access?context=complete-risk-assessments&family=washingtondc&ft:locale=en-US)**
...
-   **[View risk assessment details in Source-to-Pay Workspace](https://servicenow-staging.fluidtopics.net/access?context=supp-ws-details-page&family=washingtondc&ft:locale=en-US)**
...
-   **[Assign tasks to internal users](https://servicenow-staging.fluidtopics.net/access?context=create-new-task-for-supp-case&family=washingtondc&ft:locale=en-US)**
...
-   **[Organization Tax Details table](https://servicenow-staging.fluidtopics.net/access?context=installed-with-supp-mgmt&family=washingtondc&ft:locale=en-US)**
...
-   **[Restructured Supplier Task table](https://servicenow-staging.fluidtopics.net/access?context=supplier-task-table-restructure&family=washingtondc&ft:locale=en-US)**
...
-   **[Risk Assessments for Supplier Lifecycle Operations plugin introduced](https://servicenow-staging.fluidtopics.net/access?context=use-playbooks-onboard-supp&family=washingtondc&ft:locale=en-US)**
...
-   **[Using the supplier onboarding playbook to onboard suppliers](https://servicenow-staging.fluidtopics.net/access?context=use-playbooks-onboard-supp&family=washingtondc&ft:locale=en-US)**
...
-   **[Create a case on behalf of a supplier from the Procurement Workspace](https://servicenow-staging.fluidtopics.net/access?context=create-new-supplier-case&family=washingtondc&ft:locale=en-US)**
...
-   **[Supplier Relationship and Performance Management](https://servicenow-staging.fluidtopics.net/access?context=supplier-performance-management-overview&family=xanadu&ft:locale=en-US)**
...
-   **[Supplier Lifecycle Management integration framework](https://servicenow-staging.fluidtopics.net/access?context=slo-int-framework&family=xanadu&ft:locale=en-US)**
...
-   **[View supplier details in the Source-to-Pay Workspace](https://servicenow-staging.fluidtopics.net/access?context=supp-ws-details-page&family=xanadu&ft:locale=en-US)**
...
-   **[View supplier details in the Supplier Collaboration Portal](https://servicenow-staging.fluidtopics.net/access?context=supplier-central&family=xanadu&ft:locale=en-US)**
...
-   **[Supplier Operations](https://servicenow-staging.fluidtopics.net/access?context=supplier-operations&family=yokohama&ft:locale=en-US)**
...
-   **[Supplier Payment Optimization](https://servicenow-staging.fluidtopics.net/access?context=supplier-pmnt-opt&family=yokohama&ft:locale=en-US)**
...
-   **[Relish Integration for Supplier Lifecycle Operations](https://servicenow-staging.fluidtopics.net/access?context=relish-slo-connector&family=yokohama&ft:locale=en-US)**
...
-   **[Mapping multiple internal stakeholders to a supplier](https://servicenow-staging.fluidtopics.net/access?context=manage-internal-stakeholders&family=yokohama&ft:locale=en-US)**
...
-   **[Universal Request](https://servicenow-staging.fluidtopics.net/access?context=universal-request&family=yokohama&ft:locale=en-US)**
...
-   **[Overall supplier dashboard](https://servicenow-staging.fluidtopics.net/access?context=overall-supplier-db&family=yokohama&ft:locale=en-US)**
...
-   **[Supplier Relationship and Performance Management](https://servicenow-staging.fluidtopics.net/access?context=supplier-performance-management-overview&family=yokohama&ft:locale=en-US)**
...
-   **[Many-to-many \(M2M\) mapping between supplier contact and suppliers](https://servicenow-staging.fluidtopics.net/access?context=enable-m2m-supplier-contacts&family=yokohama&ft:locale=en-US)**
    ...
    -   M2M mapping between supplier contact and suppliers is available from the Xanadu December 2024 release onwards. To enable this feature, see [Enable M2M mapping between supplier contact and suppliers](https://servicenow-staging.fluidtopics.net/access?context=enable-m2m-supplier-contacts&family=yokohama&ft:locale=en-US).
...
-   **[\[Placeholder link text to key bundle-stpop.agentic-workflows-na-slo\]](https://servicenow-staging.fluidtopics.net/access?context=agentic-workflows-na-slo&family=yokohama&ft:locale=en-US)**
...
-   **[Supplier Operations](https://servicenow-staging.fluidtopics.net/access?context=supplier-operations&family=zurich&ft:locale=en-US)**

Supplier Operations ​ provides support for advanced case management capabilities to handle key supplier lifecycle events such as onboarding, offboarding, and ongoing operations. It includes the ability to resolve cases via Playbooks for a structured and consistent approach.

-   **[Supplier Payment Optimization](https://servicenow-staging.fluidtopics.net/access?context=supplier-pmnt-opt&family=zurich&ft:locale=en-US)**
...
Supplier managers can identify, prioritize, and track suppliers with high potential for accepting credit card payments.
    ...
    -   They can initiate credit card enablement journey for new or existing suppliers after checking their propensity scores \(currently requires manual updates\).
    -   They can view the saving estimates associated with the card for a given supplier using the **Savings calculator** tool. They can also view the calculation details of the savings estimator formulas.
-   **[Relish Integration](https://servicenow-staging.fluidtopics.net/access?context=relish-slo-connector&family=zurich&ft:locale=en-US)**

Supplier managers can conduct sanction screening, validate banking details change requests, and supplier location change requests via Relish integration.

-   **[Automated KPI data collection](https://servicenow-staging.fluidtopics.net/access?context=create-auto-kpi-template&family=zurich&ft:locale=en-US)**
...
-   **[Mapping multiple internal stakeholders to a supplier](https://servicenow-staging.fluidtopics.net/access?context=manage-internal-stakeholders&family=zurich&ft:locale=en-US)**

This feature enhances supplier governance in SLO by enabling the mapping of multiple internal stakeholders such as legal, business, technical, and risk teams to suppliers, improving visibility and management of supplier relationships.

-   **[Universal Request](https://servicenow-staging.fluidtopics.net/access?context=universal-request&family=zurich&ft:locale=en-US)**

Supplier contacts can create generic cases by selecting **Request Help** in the Supplier Collaboration Portal, if they can't find the relevant search results or are unsure of which department to contact for help. These cases are triaged and routed internally to appropriate case types. Universal requests remove ambiguity and improve efficiency for both suppliers and internal operations.

-   **[Overall supplier dashboard](https://servicenow-staging.fluidtopics.net/access?context=overall-supplier-db&family=zurich&ft:locale=en-US)**
...
Between your current release family and Zurich, some changes were made to existing Supplier Lifecycle Operations features.
...
-   **[Case playbook for specific supplier case types](https://servicenow-staging.fluidtopics.net/access?context=gen-playbook-cases&family=washingtondc&ft:locale=en-US)**
...
The Case playbook has been updated to no longer include approval activities for completing the following supplier case types:
    ...
    -   General inquiry
-   **[Playbook for updating the supplier primary data](https://servicenow-staging.fluidtopics.net/access?context=primary-playbook-cases&family=washingtondc&ft:locale=en-US)**
...
Between your current release family and Zurich, some Supplier Lifecycle Operations features or functionality were removed.
...
Between your current release family and Zurich, some Supplier Lifecycle Operations features or functionality were deprecated.
...
-   **[Procurement Workspace](https://servicenow-staging.fluidtopics.net/access?context=supplier-manager-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Enable deprecated case types after upgrade](https://servicenow-staging.fluidtopics.net/access?context=enable-deprecated-case-types&family=washingtondc&ft:locale=en-US)**
...
-   **[Procurement Workspace](https://servicenow-staging.fluidtopics.net/access?context=supplier-manager-workspace&family=xanadu&ft:locale=en-US)**
...
-   **[Procurement Workspace](https://servicenow-staging.fluidtopics.net/access?context=supplier-manager-workspace&family=yokohama&ft:locale=en-US)**
...
-   Onboard suppliers using the enhanced Supplier onboarding playbook that provides integration with Third-party Risk Management \(TPRM\) to conduct risk assessments when onboarding new suppliers.
 ...
 See [Supplier Lifecycle Management](https://servicenow-staging.fluidtopics.net/access?context=supp-mgmt-landing-page&family=washingtondc&ft:locale=en-US) for more information.
...
-   Support for many-to-many \(M2M\) mapping between supplier contact and suppliers: A single supplier contact can be the contact for multiple suppliers, if the suppliers share a parent-subsidiary relationship. M2M mapping between supplier contact and suppliers is available from the Xanadu December 2024 release onwards.
 ...
 See [Supplier Lifecycle Management](https://servicenow-staging.fluidtopics.net/access?context=supp-mgmt-landing-page&family=xanadu&ft:locale=en-US) for more information.
...
-   Support for self-registration for supplier contacts. They can register with a supplier company name, enabling multiple domains under a single supplier.
 ...
 See [Supplier Lifecycle Management](https://servicenow-staging.fluidtopics.net/access?context=supp-mgmt-landing-page&family=yokohama&ft:locale=en-US) for more information.
...
-   The plugin Supplier Operations \(com.snc.sn\_so\) **must** be installed after upgrading to Supplier Lifecycle Operations Zurich release. For more information, see [Install Supplier Operations](https://servicenow-staging.fluidtopics.net/access?context=install-supplier-ops&family=zurich&ft:locale=en-US).
-   The Supplier Lifecycle Operations plugin \(com.snc.sn\_supplier\_mgmt\) is renamed to Supplier Case Management. For more information, see [Supplier Case Management](https://servicenow-staging.fluidtopics.net/access?context=supplier-case-management&family=zurich&ft:locale=en-US).

 See [Supplier Lifecycle Management](https://servicenow-staging.fluidtopics.net/access?context=supp-mgmt-landing-page&family=zurich&ft:locale=en-US) for more information.
