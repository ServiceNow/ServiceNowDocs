---
title: Combined Now Assist for Security Incident Response release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Now Assist for Security Incident Response from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-nowassistforsecurityincidentresponse-release-notes.html
release: zurich
...
# Combined Now Assist for Security Incident Response release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Now Assist for Security Incident Response from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Now Assist for Security Incident Response release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
For more information about required applications for Now Assist for Security Incident Response, see [Supporting information](https://servicenow-staging.fluidtopics.net/access?context=supporting-information-now-assist-security-incident&family=yokohama&ft:locale=en-US).
...
Between your current release family and Zurich, new features were introduced for Now Assist for Security Incident Response.
...
-   **[Generate a quality assessment report](https://servicenow-staging.fluidtopics.net/access?context=na-sir-quality-assessment&family=yokohama&ft:locale=en-US)**
...
-   **[Generate SIR Shift Handover Report](https://servicenow-staging.fluidtopics.net/access?context=add-incidents-shifthandover-ai-agent&family=yokohama&ft:locale=en-US)**
...
-   **[Use agentic workflows](https://servicenow-staging.fluidtopics.net/access?context=using-now-assist-ai-agents-sir&family=yokohama&ft:locale=en-US)**
...
-   **[Enhancements to correlation insights in Now Assist for Security Incident Response](https://servicenow-staging.fluidtopics.net/access?context=generating-insights-for-now-assist-for-security&family=yokohama&ft:locale=en-US)**
...
-   **[Using Security incident resolution agentic workflow](https://servicenow-staging.fluidtopics.net/access?context=now-assist-sir-resolve-incident-ai-workflow&family=yokohama&ft:locale=en-US)**
...
-   **[Using Security Incident Response AI agents](https://servicenow-staging.fluidtopics.net/access?context=using-now-assist-ai-agents-sir&family=yokohama&ft:locale=en-US)**
...
-   **[Yokohama Early Availability](https://servicenow-staging.fluidtopics.net/access?context=now-assist-security-incident-landing&family=yokohama&ft:locale=en-US)**
    -   [Generate correlation insights](https://servicenow-staging.fluidtopics.net/access?context=generate-correlation-insights-now-assist-for-security&family=yokohama&ft:locale=en-US)
...
Generate correlation insights to connect current security incidents to past events. You can identify the affected users, configuration items \(CI\)s, or observables \(IP addresses and file hashes\) from existing incidents and records to help you more quickly triage your new security incidents. Correlation insights are supported in Workspace, the Core UI, and from the Now Assist panel.
    ...
    -   Enhancements to [closure \(resolution\) notes](https://servicenow-staging.fluidtopics.net/access?context=generate-closure-notes-si-now-assist-sec-incident&family=yokohama&ft:locale=en-US) and [post incident analysis](https://servicenow-staging.fluidtopics.net/access?context=generate-pia-report-now-assist-security-incident&family=yokohama&ft:locale=en-US) generation
...
Between your current release family and Zurich, some changes were made to existing Now Assist for Security Incident Response features.
...
-   **[Some Now Assist skills are now turned on by default](https://servicenow-staging.fluidtopics.net/access?context=now-assist-skills-on-by-default&family=yokohama&ft:locale=en-US)**
...
Between your current release family and Zurich, some Now Assist for Security Incident Response features or functionality were removed.
...
Between your current release family and Zurich, some Now Assist for Security Incident Response features or functionality were deprecated.
...
For more information, see [Now Assist for Security Incident Response](https://servicenow-staging.fluidtopics.net/access?context=now-assist-security-incident-landing&family=yokohama&ft:locale=en-US).
