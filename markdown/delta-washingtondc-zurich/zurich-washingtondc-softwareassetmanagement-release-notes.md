---
title: Combined Software Asset Management release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Software Asset Management from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-softwareassetmanagement-release-notes.html
release: zurich
...
# Combined Software Asset Management release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Software Asset Management from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Software Asset Management release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Measure the maturity of your Software Asset Management application through Success Portal](https://servicenow-staging.fluidtopics.net/access?context=success-portal-view&family=washingtondc&ft:locale=en-US)**
...
-   **[Gain complete visibility into the usage of all SaaS applications](https://servicenow-staging.fluidtopics.net/access?context=shadow-saas-analytics&family=washingtondc&ft:locale=en-US)**
...
-   **[Manage licenses for all Okta users](https://servicenow-staging.fluidtopics.net/access?context=integrate-okta&family=washingtondc&ft:locale=en-US)**

Manage Okta user licenses by creating subscriptions for Okta users.

-   **[Integrate Salesforce Marketing Cloud using OAuth 2.0 credentials](https://servicenow-staging.fluidtopics.net/access?context=integrate-with-salesforce-marketing-cloud&family=washingtondc&ft:locale=en-US)**

Integrate Salesforce Marketing Cloud using OAuth 2.0 credentials and view the contact counts for email and SMS.

-   **[Simplify the credential setup for Adobe integration using OAuth Server-to-Server credentials](https://servicenow-staging.fluidtopics.net/access?context=adobe-cloud-integration&family=washingtondc&ft:locale=en-US)**

Simplify your credential setup process by integrating your Adobe Cloud services with a ServiceNow instance using OAuth credentials. Adobe is migrating from a Service Account \(JWT\) credential to an OAuth Server-to-Server credential. For more information, see the [Adobe Migration guide](https://developer.adobe.com/developer-console/docs/guides/authentication/ServerToServerAuthentication/migration/).

-   **[Improve the readability of the License usage view with a phase-wise implementation of Software Asset Management](https://servicenow-staging.fluidtopics.net/access?context=add-published-products&family=washingtondc&ft:locale=en-US)**
...
-   **[Manage Red Hat core-based licensed products and track their consumption with the Software Asset Management publisher pack for Red Hat Enterprise Linux \(RHEL\)](https://servicenow-staging.fluidtopics.net/access?context=rhel-publisher-pack&family=washingtondc&ft:locale=en-US)**
...
-   **[Determine license compliance for Microsoft Windows Server on Azure according to the new licensing rules from Microsoft with BYOL support](https://servicenow-staging.fluidtopics.net/access?context=byol-concepts&family=washingtondc&ft:locale=en-US)**
...
-   **[Discover software and their license types on Google Cloud Platform \(GCP\) using BYOL support](https://servicenow-staging.fluidtopics.net/access?context=byol-concepts&family=washingtondc&ft:locale=en-US)**
...
-   **[Manage product licensability at the edition level by using the enhanced software licensing feature](https://servicenow-staging.fluidtopics.net/access?context=sam-content-updates&family=washingtondc&ft:locale=en-US)**
...
-   **[Optimize Microsoft 365 subscriptions with reduced dependency on discovery solutions to track usage](https://servicenow-staging.fluidtopics.net/access?context=integrate-with-microsoft&family=washingtondc&ft:locale=en-US)**
...
-   **[Improve granularity via the enhanced license usage view](https://servicenow-staging.fluidtopics.net/access?context=sam-workspace-workbench&family=washingtondc&ft:locale=en-US)**
...
-   **[Manage Microsoft Windows Server licensing through Guided Setup](https://servicenow-staging.fluidtopics.net/access?context=playbook-entitlementsetup-workspace&family=washingtondc&ft:locale=en-US)**
...
-   **[Enhanced coverage and visibility into product life cycles](https://servicenow-staging.fluidtopics.net/access?context=calculated-lifecycles&family=washingtondc&ft:locale=en-US)**
...
-   **[Adobe and Microsoft 365 integration functionalities moved to Software Asset Management – SaaS License Management](https://servicenow-staging.fluidtopics.net/access?context=sam-subscription-management&family=washingtondc&ft:locale=en-US)**

For quick turnaround of enhancements and fixes, the Adobe and Microsoft 365 integration functionalities have moved to the Software Asset Management – SaaS License Management store application.
...
-   Cisco Webex Meetings integration is no longer deployed or enhanced. Instead, use the [Cisco Webex integration](https://servicenow-staging.fluidtopics.net/access?context=integrate-with-webex-apps&family=washingtondc&ft:locale=en-US) profile to integrate with Webex Meetings and other Webex applications.
-   Starting with the Washington DC release, the following two quick start tests are deprecated:
    -   SAM - Validate Reconciliation for Custom Product
    -   SAM - Pin and Unpin Publishers on License Workbench
-   The Microsoft 365 user activity according to the subscription report on the Optimization and savings dashboard in the Asset analytics view is deprecated. This report has been replaced by the new Microsoft 365 subscription details report.
...
-   ITAM Health Check
-   Software Asset Management Playbooks and Guided Setup
...
-   Get a detailed analysis of your software installation, uncovering the factors behind their unlicensed status and outlining the necessary steps for action.
 ...
 See [Software Asset Management](https://servicenow-staging.fluidtopics.net/access?context=c_SoftwareAssetMgmt&family=washingtondc&ft:locale=en-US) for more information.
