---
title: Combined Generative AI Controller release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Generative AI Controller from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-generativeaicontroller-release-notes.html
release: zurich
...
# Combined Generative AI Controller release notes for upgrades from Washington DC to Zurich
...
-   **[Recursive summarization for large inputs](https://servicenow-staging.fluidtopics.net/access?context=enable-recursive-summarization&family=washingtondc&ft:locale=en-US)**
...
-   **[Integrate with Aleph Alpha models](https://servicenow-staging.fluidtopics.net/access?context=configure-api-credentials-for-aleph-alpha&family=washingtondc&ft:locale=en-US)**

Bring your own API credentials and connect Aleph Alpha's Luminous LLM with the ServiceNow AI Platform.

-   **[Integrate with IBM watsonx models](https://servicenow-staging.fluidtopics.net/access?context=configure-api-credentials-for-ibm-watsonx&family=washingtondc&ft:locale=en-US)**

Use your own API credentials to connect to IBM watsonx's Granite LLMs with the ServiceNow AI Platform.

-   **[Integrate with external LLMs](https://servicenow-staging.fluidtopics.net/access?context=configure-api-credentials-for-a-generic-large-language-model-llm&family=washingtondc&ft:locale=en-US)**

Connect API credentials with a generic LLM connector and use an external LLM on the ServiceNow AI Platform.

-   **[Semantic filter for sensitive content in generative AI conversations](https://servicenow-staging.fluidtopics.net/access?context=add-semantic-filtering-for-sensitive-information&family=washingtondc&ft:locale=en-US)**
...
-   **[Disable Dynamic Translation for LLM conversations in Virtual Agent](https://servicenow-staging.fluidtopics.net/access?context=disable-dynamic-translation-for-llm-va-conversations&family=washingtondc&ft:locale=en-US)**
...
Generative AI Controller is a ServiceNow AI Platform feature that is available with activation of any Now Assist application. For details, see [Installing Generative AI Controller](https://servicenow-staging.fluidtopics.net/access?context=installing-generative-ai-controller&family=washingtondc&ft:locale=en-US).
...
-   Add semantic filters in Virtual Agent to detect and handle sensitive topics
 ...
 See [Generative AI Controller](https://servicenow-staging.fluidtopics.net/access?context=generative-ai-controller&family=washingtondc&ft:locale=en-US) for more information.
