---
title: Combined Configuration Compliance release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Configuration Compliance from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-configurationcompliance-release-notes.html
release: zurich
...
# Combined Configuration Compliance release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Configuration Compliance from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Configuration Compliance release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Requesting false positive for a set of test results from the Vulnerability Manager Workspace and IT Remediation Workspace](https://servicenow-staging.fluidtopics.net/access?context=vmws-tr-false-positive&family=washingtondc&ft:locale=en-US)**
...
-   **[Requesting false positive for a remediation task \(CRG\#\) from the Vulnerability Manager Workspace and IT Remediation Workspace](https://servicenow-staging.fluidtopics.net/access?context=vr-ws-mark-fp&family=washingtondc&ft:locale=en-US)**
...
-   **[Setting up questionnaire for false positive requests](https://servicenow-staging.fluidtopics.net/access?context=configure-exception-management-configuration-compliance&family=washingtondc&ft:locale=en-US)**
...
-   **[Updating the risk score in the Vulnerability Manager Workspace](https://servicenow-staging.fluidtopics.net/access?context=config-compliance-calculator-rules&family=washingtondc&ft:locale=en-US)**
...
-   **[Analyzing the vulnerability landscape in the Vulnerability Manager Workspace](https://servicenow-staging.fluidtopics.net/access?context=vmws-home-page&family=washingtondc&ft:locale=en-US)**
...
-   **[Acquiring the summary of a set of test results using filters](https://servicenow-staging.fluidtopics.net/access?context=vmws-home-page-create-filter&family=washingtondc&ft:locale=en-US)**
...
-   **[Displaying records in workspaces upon clicking the links in email notifications](https://servicenow-staging.fluidtopics.net/access?context=t_DefineEmailNotifications&family=washingtondc&ft:locale=en-US)**
...
-   **[Notifications on false positive and exception requests](https://servicenow-staging.fluidtopics.net/access?context=cc-ex-mgmt-request-approve&family=washingtondc&ft:locale=en-US)**
...
-   **[Quick start tests](https://servicenow-staging.fluidtopics.net/access?context=quick-start-tests&family=washingtondc&ft:locale=en-US) for Configuration Compliance.**
...
-   Analyze the overall impact of test results with summary visualizations of all or prefiltered active test results on the new Vulnerability Manager Workspace landing page.
 ...
 See [Configuration Compliance](https://servicenow-staging.fluidtopics.net/access?context=vr-config-compliance-landing&family=washingtondc&ft:locale=en-US) for more information.
