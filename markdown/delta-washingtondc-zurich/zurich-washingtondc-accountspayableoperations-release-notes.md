---
title: Combined Accounts Payable Operations release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Accounts Payable Operations from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-accountspayableoperations-release-notes.html
release: zurich
...
# Combined Accounts Payable Operations release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Accounts Payable Operations from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Accounts Payable Operations release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
...
-   **[Using invoice integration](https://servicenow-staging.fluidtopics.net/access?context=using-integration-to-create-invoice&family=washingtondc&ft:locale=en-US)**
...
-   **[Integration errors](https://servicenow-staging.fluidtopics.net/access?context=integration-errors-during-erp-posting&family=washingtondc&ft:locale=en-US)**

Work on system-generated integration error tasks through the ERP integration framework.

-   **[Invoice data transformation logic](https://servicenow-staging.fluidtopics.net/access?context=invoice-data-trans-logic&family=washingtondc&ft:locale=en-US)**
...
-   **[Credit memo](https://servicenow-staging.fluidtopics.net/access?context=invoice-type-credit-memo&family=washingtondc&ft:locale=en-US)**
...
-   **[Playbooks](https://servicenow-staging.fluidtopics.net/access?context=playbooks&family=washingtondc&ft:locale=en-US)**
...
-   **[Invoice data transformation logic](https://servicenow-staging.fluidtopics.net/access?context=invoice-data-trans-logic&family=washingtondc&ft:locale=en-US) experience**
...
-   **[Invoice exceptions](https://servicenow-staging.fluidtopics.net/access?context=work-with-invoice-exceptions&family=washingtondc&ft:locale=en-US)**
...
-   Visualize the workflow of invoice processing cases using Playbooks.
 ...
 See [Landing page for Accounts Payable Operations in Accounts Payable Workspace](https://servicenow-staging.fluidtopics.net/access?context=acc-pay-workspace-landing-page&family=washingtondc&ft:locale=en-US) for more information.
