---
title: Combined Application Manager release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Application Manager from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-applicationmanager-release-notes.html
release: zurich
...
# Combined Application Manager release notes for upgrades from Washington DC to Zurich

Consolidated page of all release notes for Application Manager from Washington DC to Zurich.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Application Manager release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Application Manager to Zurich
...
Between your current release family and Zurich, new features were introduced for Application Manager.
...
-   **[Installing applications in Application Manager](https://servicenow-staging.fluidtopics.net/access?context=installing-applications-in-application-manager&family=washingtondc&ft:locale=en-US) modal pop-up**
...
-   **[One-click experience to update dependent applications](https://servicenow-staging.fluidtopics.net/access?context=installing-applications-in-application-manager&family=washingtondc&ft:locale=en-US)**
...
Between your current release family and Zurich, some changes were made to existing Application Manager features.
...
Between your current release family and Zurich, some Application Manager features or functionality were removed.
...
Between your current release family and Zurich, some Application Manager features or functionality were deprecated.
...
-   Locate an application that may meet the criteria you're searching for with partial search.
 ...
 See [Application Manager](https://servicenow-staging.fluidtopics.net/access?context=application-manager&family=washingtondc&ft:locale=en-US) for more information.
...
-   The search bar displays a message if your result isn't available in the tab you have selected.
 ...
 See [Application Manager](https://servicenow-staging.fluidtopics.net/access?context=application-manager&family=xanadu&ft:locale=en-US) for more information.
