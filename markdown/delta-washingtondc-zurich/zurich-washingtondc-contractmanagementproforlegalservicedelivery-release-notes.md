---
title: Combined Contract Management Pro for Legal Service Delivery release notes for upgrades from Washington DC to Zurich
description: Consolidated page of all release notes for Contract Management Pro for Legal Service Delivery from Washington DC to Zurich.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/delta-washingtondc-zurich/zurich-washingtondc-contractmanagementproforlegalservicedelivery-release-notes.html
release: zurich
...
# Combined Contract Management Pro for Legal Service Delivery release notes for upgrades from Washington DC to Zurich
...
To help you prepare for your upgrade, we have combined the cross-family Contract Management Pro for Legal Service Delivery release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Washington DC to Zurich.
