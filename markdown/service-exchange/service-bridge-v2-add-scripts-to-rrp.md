...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/service-exchange/service-bridge-v2-add-scripts-to-rrp.html
release: zurich
...
-   Adding scripts in UI policies: You can add scripts in a UI policy and apply the UI policy on an RRP. For details, see [Service catalog UI policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/c_ServiceCatalogUIPolicy.md).
