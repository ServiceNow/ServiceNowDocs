...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/service-exchange/service-bridge-v2-remote-catalog.html
release: australia
...
1.  Create a remote record producer in a remote catalog. See [Create remote record producers for Providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/service-exchange/service-bridge-v2-create-remote-rec-prod.md).
2.  Create variables for remote record producers. See [Create variables for remote record producers for Providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/service-exchange/service-bridge-v2-assign-variables-ser-defn.md).
