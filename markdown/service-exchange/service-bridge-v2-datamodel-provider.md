...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/service-exchange/service-bridge-v2-datamodel-provider.html
release: yokohama
...
\[Omitted image "service-bridge-v2-data-model-provider.jpg"\] Alt text: Diagram shows the Service Exchange for Providers data model.
