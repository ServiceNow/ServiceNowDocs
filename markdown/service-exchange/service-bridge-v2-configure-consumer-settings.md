...
description: As a consumer, you can configure an define default settings on your instance.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/service-exchange/service-bridge-v2-configure-consumer-settings.html
release: yokohama
...
As a consumer, you can configure an define default settings on your instance.
