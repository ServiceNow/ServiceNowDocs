...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/service-exchange/service-bridge-v2-remote-task-connect-disconnect.html
release: australia
...
When you create a remote task for an active remote task definition, the Status of the remote task is set to **Connected** on the provider and consumer instances. This occurs if there are no errors. This ensures that the remote task syncs data including field updates, attachments, and comments between the parent tasks.
