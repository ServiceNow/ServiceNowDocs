...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/service-exchange/service-bridge-v2-offboard-consumer.html
release: xanadu
...
-   Tasks \(the following tables are deleted only if you choose to delete all existing tasks\)
