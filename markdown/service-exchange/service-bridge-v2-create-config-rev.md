...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/service-exchange/service-bridge-v2-create-config-rev.html
release: yokohama
...
The following diagram shows how a configuration revision is created, published, and deployed to consumers.

\[Omitted image "service-bridge-v2-config-revision.jpg"\] Alt text: Configuration revision lifecycle
...
-   [Create a configuration revision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/service-exchange/service-bridge-v2-create-config-rev.md)
-   [Archive a configuration revision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/service-exchange/service-bridge-v2-create-config-rev.md)
-   [Retire a configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/service-exchange/service-bridge-v2-create-config-rev.md)
-   [Copy a configuration revision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/service-exchange/service-bridge-v2-create-config-rev.md)
-   [Delete a configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/service-exchange/service-bridge-v2-create-config-rev.md)

You can follow the same process to create revisions for a remote record producer.

## Create a configuration revision

1.  Navigate to the **All** &gt; **Service ExchangeProvider** &gt; **Remote task definitions**.
