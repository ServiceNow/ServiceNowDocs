...
-   **Simple**: Select the simple transform option to use the predefined values of the inbound and outbound fields for your remote tasks. For example, you convert the Open state of an incident in the provider's ServiceNow® instance to the In Progress state in the consumer's ServiceNow® instance.
