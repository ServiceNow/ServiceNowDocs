...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/service-exchange/service-bridge-v2-scan-checks.html
release: australia
...
Each suite contains multiple child suites and each child suite contains multiple scan checks. For more information on suite and scan checks, see [Instance Scan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-administration/hs-landing-page.md).
...
To view the list of Service Exchange supported scan checks, see [List of scan checks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/service-exchange/service-bridge-v2-list-of-scan-checks-in-sb.md).
...
[List of scan checks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/service-exchange/service-bridge-v2-list-of-scan-checks-in-sb.md)
