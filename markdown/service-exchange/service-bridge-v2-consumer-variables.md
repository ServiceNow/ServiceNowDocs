...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/service-exchange/service-bridge-v2-consumer-variables.html
release: australia
...
-   You have added the necessary variables to a variable set. For more details, see [Using variable sets with Remote Record Producers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/service-exchange/service-bridge-v2-variable-sets.md).
