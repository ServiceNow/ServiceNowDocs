...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/service-exchange/service-bridge-v2-onboarding.html
release: xanadu
...
-   Role required: admin
-   A provider record must have been created. See [Set up a Service Exchange provider record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/service-exchange/service-bridge-v2-new-provider.md).
...
\[Omitted image "service-bridge-v2-oauth-flow.jpg"\] Alt text: Service Exchange Key Exchange Onboarding flow
