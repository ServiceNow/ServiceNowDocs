...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/service-exchange/service-bridge-v2-create-consumer-criteria.html
release: zurich
...
<table id="choicetable_yhh_n4d_5fc"><thead><tr><th align="left" id="d21633e75">

Option

</th><th align="left" id="d21633e78">

Action

</th></tr></thead><tbody><tr><td id="d21633e84">
...
For a description of the field values, see [Consumer criteria new record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/service-exchange/service-bridge-v2-consumer-criteria-new-record-form.md).
