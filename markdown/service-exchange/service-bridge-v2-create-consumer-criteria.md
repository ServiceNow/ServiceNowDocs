...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/service-exchange/service-bridge-v2-create-consumer-criteria.html
release: australia
...
<table id="choicetable_yhh_n4d_5fc"><thead><tr><th align="left" id="d22687e75">

Option

</th><th align="left" id="d22687e78">

Action

</th></tr></thead><tbody><tr><td id="d22687e84">
...
For a description of the field values, see [Consumer criteria record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/service-exchange/service-bridge-v2-consumer-criteria-new-record-form.md).
