...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/c\_GlideList2API.html
release: australia
...
Several of these methods are available in Next Experience UI Framework. For details, see [GlideList \(Next Experience UI Framework\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/GlideListClientAPINEx.md).
