...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/c\_Notify2WebRTCClient.html
release: yokohama
...
This method excludes the current client from the list. The equivalent [Notify-getAvailableClients\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_NotifyAPI.md) method does not filter any user.
