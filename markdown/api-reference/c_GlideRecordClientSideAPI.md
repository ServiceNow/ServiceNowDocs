...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/c\_GlideRecordClientSideAPI.html
release: yokohama
...
To create more complex queries, use the [setEncodedQuery\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideRecordClientSideAPI.md) method.
