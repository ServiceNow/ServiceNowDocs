...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/c\_GlideRecordClientSideAPI.html
release: xanadu
...
To create more complex queries, use the [setEncodedQuery\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/c_GlideRecordClientSideAPI.md) method.
