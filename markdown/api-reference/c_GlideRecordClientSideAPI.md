...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/c\_GlideRecordClientSideAPI.html
release: zurich
...
To create more complex queries, use the [setEncodedQuery\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/c_GlideRecordClientSideAPI.md) method.
