...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/c\_GlideRecordClientSideAPI.html
release: australia
...
To create more complex queries, use the [setEncodedQuery\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/c_GlideRecordClientSideAPI.md) method.
