...
## g\_modal - alert\(String title, String message, Function callback, style Object\)
...
## g\_modal - confirm\(String title, String message, Function callback, style Object\)
...
![Screen shot that shows the confirm modal generated by the code](../image/g_modal_confirm-modal_shot.png)

## g\_modal - confirmDestroy\(String title, String message, Function callback, style Object\)
...
</table>This code example shows how to call the confirmDestroy\(\) method to display a confirmation modal with a red **OK** button.
...
![Confirm destroy modal](../image/g_modal_confirmDest-modal_shot.png)

## g\_modal - richText\(String title, String richText, Function callback, String size, String cancelTitle, String confirmTitle, String cancelType, String confirmType\)
...
![Rich text modal](../image/g_modal_richText-modal_shot.png)

## g\_modal - showFields\(String title, Array fields, Function callback, String size, String cancelTitle, String confirmTitle, String cancelType, String confirmType, String instruction\)
...
![Screen shot of modal produced by associated code.](../image/g_modal_showFields-modal_shot2.png)
...
![Screen shot of modal produced by associated code.](../image/g_modal_showFields-modal_shot1.png)
...
![Modal screenshot](../image/g_modal_showFields-modal_glidelist.png)

## g\_modal - showFrame\(String title, String url, Function callback, String size, String height, String modalHeight, String modalWidth, Boolean showClose, String autoCloseOn, Boolean hasLoadingMessage, Boolean closeOnEscape, Boolean hideOverlay\)
...
![Screen shot of the modal generated by the code](../image/g_modal_showFrame-modal_shot.png)
...
![Screen shot of the modal generated by the code](../image/g_modal_showFrame-modal_shot2.png)
