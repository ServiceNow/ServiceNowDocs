...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/api-implementation.html
release: xanadu
topic_type: concept
...
[Scripts \[Omitted image "bus-start-developing.svg"\] Alt text: Extend application server and client functionality.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_Script.md)

</td><td>

[Web services \[Omitted image "bus-rocketship.svg"\] Alt text: Communicate between ServiceNow and third-party applications.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/r_AvailableWebServices.md)
