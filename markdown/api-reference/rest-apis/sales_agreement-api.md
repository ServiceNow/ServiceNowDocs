...
This API works with data in the [Sales Agreement Management](https://www.servicenow.com/docs/access?context=sales-agreement-mgmt&version=zurich&pubname=zurich-order-management&ft:locale=en-US) application, which managers, agents, and administrators use to generate sales agreements from quotes.
