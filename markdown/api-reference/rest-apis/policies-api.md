...
Required. Name of the Configuration Data Management \(CDM\) application for which to remove the mapping to the policy. Located in the CDM Application \[sn\_cdm\_application\] table.Data type: String
...
Required. Name of the CDM deployable for which to remove the mapping to the policy. Located in the CDM Deployable \[sn\_cdm\_deployable\] table.Data type: String
...
Required. Name of the associated policy. Located in the Policy \[sn\_pace\_policy\] table.Data type: String
...
For additional information on policy mappings, see [Map policies to a deployable](https://www.servicenow.com/docs/access?context=cdm-deployable-map-policy-to&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US) and [Validating and correcting configuration data](https://www.servicenow.com/docs/access?context=cdm-validating-cfg-data&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
...
Required. Name of the Configuration Data Management \(CDM\) application associated with the deployable for which to return the resolved policy inputs. Located in the CDM Application \[sn\_cdm\_application\] table.Data type: String
...
Required. Name of the CDM deployable for which to return the resolved policy. Located in the CDM Deployable \[sn\_cdm\_deployable\] table.Data type: String
...
Required. Name of the Configuration Data Management \(CDM\) application for which to map the policy. Located in the CDM Application \[sn\_cdm\_application\] table.Data type: String
...
Required. Name of the CDM deployable for which to map the policy. Located in the CDM Deployable \[sn\_cdm\_deployable\] table.Data type: String
...
Sys\_id of the user record. Located in the User \[sys\_user\] table.Data type: String
...
Sys\_id of the policy record. Located in the Policy \[sn\_pace\_policy\] table.Data type: String
...
Sys\_id of the mapping. Located in the Policy Mapping \[sn\_pace\_policy\_mapping\] table.Data type: String
...
Required. Name of the CDM application to which the deployable is associated. Located in the CDM Application \[sn\_cdm\_application\] table.Data type: String
...
Required. Name of the CDM deployable to add to the additionalDeployablesInput input variable. Located in the CDM Deployable \[sn\_cdm\_deployable\] table.Data type: String
...
Required. Name of the CDM application for which to update the additionalDeployablesInput input variable. Located in the CDM Application \[sn\_cdm\_application\] table.Data type: String
...
Required. Name of the CDM deployable for which to update the additionalDeployablesInput input variable. Located in the CDM Deployable \[sn\_cdm\_deployable\] table.Data type: String
...
Details about the associated PaCE IO definition record.For additional information on PaCE, see [Policy as Code Engine \(PaCE\)](https://www.servicenow.com/docs/access?context=pace-managing-policies&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
Sys\_id of the PaCE IO definition record. Located in the IO Mapping \[sn\_pace\_io\_mapping\] table. Data type: String
...
Details about the PaCE policy-mapping record.For additional information on PaCE, see [Policy as Code Engine \(PaCE\)](https://www.servicenow.com/docs/access?context=pace-managing-policies&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
Sys\_id of the PaCE policy-mapping record. Located in the Policy Mapping \[sn\_pace\_policy\_mapping\] table.Data type: String
...
Sys\_id of the associated mapping record. Located in the IO Mapping \[sn\_pace\_io\_mapping\] table. Data type: String
...
Required. Name of the CDM application for which to update the policy mapping inputs. Located in the CDM Application \[sn\_cdm\_application\] table.Data type: String
...
Required. Name of the CDM deployable for which to update the policy mapping inputs. Located in the CDM Deployable \[sn\_cdm\_deployable\] table.Data type: String
...
Required. Name of the input variable to update. The available input variables are defined in the IO Mapping \[sn\_pace\_io\_mapping\] table.Data type: String
