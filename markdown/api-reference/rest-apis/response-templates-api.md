...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/rest-apis/response-templates-api.html
release: australia
product: REST APIs
