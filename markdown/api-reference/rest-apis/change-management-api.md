...
For information on configuring change models, see [Configure Change Management](https://www.servicenow.com/docs/access?context=configure-change-management&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
...
Use this endpoint to find a change model that best fits the change request that you are trying to create. For additional information, see [Change Models](https://www.servicenow.com/docs/access?context=change-models&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
...
You can then use this change model to create the desired change request. For additional information on change models, see [Change Models](https://www.servicenow.com/docs/access?context=change-models&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
...
For more information, see [Change models](https://www.servicenow.com/docs/access?context=change-models&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
...
For more information, see [Add a new change request type](https://www.servicenow.com/docs/access?context=t_AddNewChangeType&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
