...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/cs-catalog-api.html
release: xanadu
product: REST APIs
...
The active state of the resource operation catalog item. Possible values:
...
Sys\_id of the resource operation catalog item. Located in the Resource Operation Catalog Item \[sn\_cmp\_rsrc\_opr\_cat\_item\] table.Data type: String
...
Brief description of the resource operation catalog item. Located in the Resource Operation Catalog Item \[sn\_cmp\_rsrc\_opr\_cat\_item\] table.Data type: String
...
Required. The name of the resource block to get its related resource operation catalog items from \(for example, Virtual Server\). Available in the Resource Block \[sn\_cmp\_rb\_resourceblock\] table.Default: All catalog items of all operation types are returned.
...
sys\_id of the blueprint. Located in the Blueprint \[sn\_cmp\_bp\_blueprint\] table.Data type: String
...
sys\_id of the blueprint category. Located in the Cloud Service Category \[sn\_capi\_service\_category\] table. Data type: String
...
Name of the blueprint category. Located in the Cloud Service Category \[sn\_capi\_service\_category\] table. Possible values:
...
Name of the catalog. Located in the Cloud Catalog Item \[sn\_cmp\_bp\_cat\_item\] table.Data type: String
...
The type of catalog. Possible values:-   `1`: Catalog is of type provision.
...
sys\_id of the blueprint. Located in the Cloud Catalog Item \[sn\_cmp\_bp\_cat\_item\] table.Data type: String
...
sys\_id of the operation. Available in the OperationSignature \[sn\_cmp\_rb\_op\_signature\] table.
...
Name of the operation. Possible values:-   Start: Starts the resources that are in an off state.
...
An object containing extra details about the list catalog item. The variables returned in this API vary based on the query parameters that are passed in the request.Data type: Object
...
The name of the catalog type. Possible values:-   Provision Operation \(Day 1\): Catalog type is named provision.
...
sys\_id of the life cycle operation. Available in the OperationSignature \[sn\_cmp\_rb\_op\_signature\] table.
...
Type of life cycle operations. Possible values:1.  Deprovision: Deletes resources in a terminated state and updates resource CMDB tables accordingly.
2.  ModifySchedule: Performs business hours scheduling on stacks at the time of provisioning or on existing stacks.
3.  Stop: Stops the resources that are in an on state.
4.  Cleanup: Cleans up resources with a terminated state.
5.  ModifyLease: Modifies the lease operation scheduled on provisioned resources.
6.  Start: Starts the resources that are in an off state.
...
A brief description of the catalog.Data type: String
...
Name of the template. Available in the Cloud Catalog Item \[sn\_cmp\_bp\_cat\_item\] table.Data type: String
...
sys\_id of the template type. Available in the Cloud Catalog Item \[sn\_cmp\_bp\_cat\_item\] table.Data type: String
...
Name of the product. Available in the Cloud Catalog Item \[sn\_cmp\_bp\_cat\_item\] table.Data type: String
...
The group assigned to the request.Data type: String
...
The user email assigned to the request.Data type: String
...
sys\_id of the catalog item request. Located in the Cloud Catalog Item \[sn\_cmp\_bp\_cat\_item\] table.Data type: String
...
A message with details about a returned error. Possible error messages:-   Record Not Found: The request item doesn't exist.
...
The unique Request Item Number \(RITM\) given to the new request item. Located in the Request Item \[sc\_req\_item\] table. Data type: String
...
The current completion state of the request item.Possible values:
...
sys\_id of the request item record. Located in the Request Item \[sc\_req\_item\] table.Data type: String
...
Required. The sys\_id of the resource where Day 2 operations will be performed. Located in the Stack Items \[sn\_cmp\_stack\_item\] table.
...
Required. The name of the resource block to get its related resource operation catalog items from \(for example, Virtual Server\). Available in the Resource Block \[sn\_cmp\_rb\_resourceblock\] table. The resource interface you enter depends on the value passed in the **resourceBlock** and **operation\_name** parameters.Default: All catalog items of all operation types are returned.
