...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/resource-inventory-api.html
release: xanadu
product: REST APIs
...
List of notes about the resource. Data type: Array
...
The type of place. This value is always `GeographicAddress`.Data type: String
...
Sys\_id of the place record in the Network Site \[cmdb\_ci\_ni\_site\] table.
...
The type of related party. Located in the Group \[sys\_user\_group\] table in the **Type** field.Data type: String
...
Sys\_id of the related party record in the Group \[sys\_user\_group\] table.
...
The role of the related party. Located in the Teams \[cmdb\_rel\_team\] table in the **Group type** field. Data type: String
...
Required if the **place** parameter is used.Sys\_id of the place record in the Network Site \[cmdb\_ci\_ni\_site\] table.
...
Required if the **relatedParty** parameter is used.Sys\_id of the related party record in the Group \[sys\_user\_group\] table.
...
Required. Sys\_id of the template. Located in the Inventory Template \[sn\_ni\_core\_inventory\_template\] table. Data type: String
...
List of template overrides.Data type: Array
