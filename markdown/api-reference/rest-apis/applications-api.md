...
For additional information on Configuration Data Management and the DevOps Config Workspace UI, see [Uploading your config data](https://www.servicenow.com/docs/access?context=cdm-upload-process&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).

For additional information on shared components and shared libraries, see [Sharing components among applications — Component libraries](https://www.servicenow.com/docs/access?context=cdm-component-libraries&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
