...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/rest-apis/agent-intelligence-api.html
release: australia
product: REST APIs
...
For customization information, see [MLSolutionFactory scriptable objects](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/using-ml-apis-mlsolutionfactory.md).
