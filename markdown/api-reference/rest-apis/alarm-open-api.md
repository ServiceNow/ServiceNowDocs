...
Alarm ID. Only alarms with an ID matching the value of this parameter are returned in the response. Located in the **Message key** field in the Events \[em\_event\] table.Data type: String
...
Details about the crossed threshold.```
"crossedThresholdInformation":
{
  "direction": "String",
  "granularity": "String",
...
Threshold crossing direction.Possible values:
...
Alarm severity. Possible values:
...
-   false: Alarm does not affect service.
...
If the state is `Ready`, an alert is created in the Alert \[em\_alert\] table and the state then becomes `Processed`. If the state is `Processed`, `Ignored`, or `Error` no alert is created.
...
Unique identifier of the record to retrieve. Located in the **Message key** field in the Events \[em\_event\] table.Data type: String
...
Unique identifier of the record to update. Located in the **Message key** field in the Events \[em\_event\] table.Data type: String
...
Required. Alarm severity. Possible values:
...
Date and time the alarm changed in GMT on the alarm-owning system. This value is in GlideDateTime format and is in the **Time of event** field of a record in the Events \[em\_events\] table. This value updates when changes to the alarm from the alarmed resource occur or a change from a client update triggers the alarm. This value is required in the response.Data type: String
...
An alert record might also be created based on [Alert management rules](https://www.servicenow.com/docs/access?context=alert-management-rule&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
...
Unique identifier of the alarm to clear. Located in the **Message key** field in the Events \[em\_events\] table.Data type: String
...
Date and time at which the alarm clears at the source. This value is in the **Time of event** field of the record in the Events \[em\_events\] table.Data type: String
...
Required. Unique ID of the user who invoked the **alarmCleared** operation. This value is in the **Source** field of the record in the Events \[em\_events\] table. Data type: String
...
Unique ID of the user who invoked the **alarmCleared** operation. This value is in the **Source** field of the record in the Events \[em\_events\] table. Data type: String
...
Unique ID in the **Message key** field of a record in the Events \[em\_events\] table.Data type: String
