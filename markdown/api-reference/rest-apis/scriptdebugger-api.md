...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/scriptdebugger-api.html
release: yokohama
product: REST APIs
...
For more information about the Script Debugger, see [Script Debugger and Session Log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/scripts/script-debugger.md).
