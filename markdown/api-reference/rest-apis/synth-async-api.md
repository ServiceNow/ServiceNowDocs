...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-apis/synth-async-api.html
release: zurich
product: REST APIs
...
Order of the monitor in the **checks** array provided in the request body for [POST /sn\_sow\_synthetics/synthetics\_async\_bulk\_create](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/synth-async-api.md).Data type: Number
...
Endpoint for tracking the current status of the monitor creation job. For more information, see [GET /sn\_sow\_synthetics/v1/synthetics\_async\_bulk\_create/\{job\_id\}](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/synth-async-api.md).Data type: String
