...
For more information on the IRE, see [Identification and Reconciliation engine \(IRE\)](https://www.servicenow.com/docs/access?context=ire&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
For more on Enhanced IRE options, see [Identification and Reconciliation engine \(IRE\)](https://www.servicenow.com/docs/access?context=ire&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
