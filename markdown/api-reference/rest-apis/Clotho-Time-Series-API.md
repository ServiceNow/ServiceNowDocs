...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/Clotho-Time-Series-API.html
release: xanadu
product: REST APIs
...
The label used to identify this metric’s result set. Data type: String
...
Data series results. Data type: Array
...
The name of the metric from which the data series was obtained. Only appears if the **metrics** object is passed in the request.Data type: String
...
The sys\_id of the data series record. Located in the table specified in **seriesRef.table**.Data type: String
...
The name of the table from where the data series was obtained.Data type: String
...
The transformed series values.Data type: Array
...
The ISO 8601 timestamp of the value.Data type: String
...
The metric values.Data type: Number
...
Required. The name of the accumulating metric to update.Data type: String
...
Required. The sys\_id of the record in which to update the data. Located in the table specified in **seriesRef.table**.Data type: String
...
Required. The name of the table in which to save the data.Data type: String
...
Required. The series values to accumulate and store. Values with the same timestamp are summed up with the **default\_value** query parameter.Data type: Array
...
Required. The ISO 8601 timestamp of the value.Data type: String
...
Required. The metric value.Data type: Number
...
Data type: Number, String, Boolean, or JSON object, depending on transform. \(For a list of available transforms, refer to the table [Supported transforms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/Clotho-Time-Series-API.md) below.\)
...
Required if a **transforms** object is specified. Name of the transform.For a list of available transforms, refer to the table [Supported transforms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/Clotho-Time-Series-API.md) below.
...
Sys\_id of the data series record. Located in the table specified in **results.series.seriesRef.table**.Data type: String
...
List of ungrouped series of result objects.Data type: Array
...
Transformed series values.Data type: Array
...
Metric that the data is from. Null values are represented by an encoded empty string.Size: 2+ bytes
...
Label of the data. Null values are represented by an encoded empty string.Size: 2+ bytes
...
Encoded **serializeFlags** variable. If **serializeTags** is true and the data contains tags, the value is 2, otherwise it is 0.Size: 1 byte
...
Period associated with the data.Size: 4 bytes
...
If **serializeTags** is true, then this is the number of tags stored in the data.Size: 4 bytes
...
If **serializeTags** is true, each tag is stored in the data.Size: Depends on number of tags \(2+ bytes\).
...
Epoch UTC time representing the start time of this data series.Size: 8 bytes
...
Number of values stored in this data.Size: 4 bytes
...
If **Type** is `Double Signal`, then the remainder consists of double values.Size: **Number of Values** \* 4 bytes
...
If **Type** is `Float Model` or `Double Model`, the remainder is a Java Modified UTF String representing the model as JSON.Size: 2+ bytes
...
If the length of the model’s JSON is greater than 65,535 bytes, then this field is written instead of the **Model Json**.Size: 5
...
Length of the JSON representation of the big model.Size: 4 bytes
...
JSON representation of the model as a series of UTF characters, The size is dictated by the **Big Model Size** field.Size: 65535-256000 bytes
...
Amount of time between each value. For example, a period of 60 would mean that each value is a minute apart.Unit: Seconds
...
Start and end times of the data in ISO 8601 \(UTC\) format. Data type: Array
...
Tags associated with the data.Data type: Array of String
...
Required. Information to update.Data type: Array
...
Required. The name of the metric to update.Data type: String
...
Required. The series values to store.Data type: Array
