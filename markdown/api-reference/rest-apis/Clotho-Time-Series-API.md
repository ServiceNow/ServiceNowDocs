...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/Clotho-Time-Series-API.html
release: yokohama
product: REST APIs
...
List of metrics objects to use in the transform. For more information on metrics, see [Metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/c_MetricDefinitionSupport.md).Data type: Array
...
Data type: Number, String, Boolean, or JSON object, depending on transform. \(For a list of available transforms, refer to the table [Supported transforms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/rest-apis/Clotho-Time-Series-API.md) below.\)
...
Required if a **transforms** object is specified. Name of the transform.For a list of available transforms, refer to the table [Supported transforms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/rest-apis/Clotho-Time-Series-API.md) below.
