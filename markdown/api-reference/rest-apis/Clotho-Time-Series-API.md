...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/rest-apis/Clotho-Time-Series-API.html
release: australia
product: REST APIs
...
Data type: Number, String, Boolean, or JSON object, depending on transform. \(For a list of available transforms, refer to the table [Supported transforms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/Clotho-Time-Series-API.md) below.\)
...
Required if a **transforms** object is specified. Name of the transform.For a list of available transforms, refer to the table [Supported transforms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/Clotho-Time-Series-API.md) below.
