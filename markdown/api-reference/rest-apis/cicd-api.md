...
-   [Continuous Integration and Continuous Delivery \(CICD\) Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/cicd-spoke.md)
...
Describes the progress link information.Data type: Object
...
URL to use to retrieve the progress details.Data type: String
...
Results information.Data type: Object
...
Numeric execution state. Used with **status\_label**.Values:
...
Execution state description. Used with **status**.Values:
...
Additional information on why the operation failed. Empty if the operation is successful.Data type: String
...
Unique identifier to use to obtain the progress details for the operation. Use this value when calling the endpoint /sn\_cicd/progress/\{progress\_id\}.Data type: String
...
Unique identifier of the results information. Use this value when calling the associated results endpoint.Data type: String
...
Source information.Data type: Object
...
Unique identifier of the source record in the Execution Tracker \[sys\_execution\_tracker\] table. Data type: String
...
Since base plugins can have only one version per family release, the **auto\_upgrade\_base\_app** and **base\_app\_version** parameters do not apply to application customization installs for plugins. To activate a plugin for the first time on an instance, use the /sn\_cicd/plugin/\{plugin\_id\}/activate endpoint instead.
...
Required if **sys\_id** is not specified. Scope name of the application, such as `x_aah_custom_app`. You can locate this value in the **scope** field in the Custom Application \[sys\_app\] table or Store Application \[sys\_store\_app\] table.Data type: String
...
Required if **scope** is not specified. Sys\_id of the application to install. You can locate this value in the **Sys ID** field in the Custom Application \[sys\_app\] table or Store Application \[sys\_store\_app\] table.Data type: String
...
Required if **sys\_id** isn’t specified. The scope of the application. You can locate this value in the **scope** field in the Custom Application \[sys\_app\] table.Data type: String
...
Required if **scope** isn’t specified. The sys\_id of the application to store in the repository. You can locate this value in the **Sys ID** field in the Custom Application \[sys\_app\] table.Data type: String
...
You can run checks that are provided with Instance Scan or you can create your own checks. For more information, see [Instance Scan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/instance-scan/hs-landing-page.md).
...
The sys\_id of the scan to run. The scan must be an existing scan that you want to re-run. Located in the Combo \[scan\_combo\] table.Data type: String
...
The sys\_id of the [suite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/instance-scan/hc-suites-mgmt.md) to run. Located in the Suite \[scan\_check\_suite\] table.Data type: String
...
Required. A list of sys\_ids of the scoped applications to scan. Located in the Application \[sys\_scope\] table. The array can't be an empty array. Data type: Array
...
Required. A list of sys\_ids of the update sets to scan. Located in the Update Set \[sys\_update\_set\] table. The array can't be an empty array. Data type: Array
...
Required if **test\_suite\_name** is not specified. The sys\_id of the test suite to run. This value is located in the Test \[sys\_atf\_test\_suite\] table.Data type: String
...
Required if **test\_suite\_sys\_id** is not specified. The name of the test suite to run. This value is located in the Test \[sys\_atf\_test\_suite\] table.Data type: String
