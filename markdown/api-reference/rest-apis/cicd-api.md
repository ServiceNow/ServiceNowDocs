...
-   [Continuous Integration and Continuous Delivery \(CICD\) Spoke](https://www.servicenow.com/docs/access?context=cicd-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
...
You can run checks that are provided with Instance Scan or you can create your own checks. For more information, see [Instance Scan](https://www.servicenow.com/docs/access?context=hs-landing-page&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
Sys\_id of the [suite](https://www.servicenow.com/docs/access?context=hc-suites-mgmt&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) to run.Data type: String
