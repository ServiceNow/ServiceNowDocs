...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/editor-api.html
release: xanadu
product: REST APIs
...
Unique identifier of the associated changeset, such as "Chset-10". Located in the CDM Changeset \[sn\_cdm\_changeset\] table.
...
Timestamp \(converted to a long integer\) when the node was committed as part of the changeset. If the node hasn't been committed, this value is "null".Data type: Integer
...
Timestamp \(converted to a long integer\) of the node when it was either deleted or superseded by another node, otherwise "null".Data type: Integer
...
Sys\_id of the node. Located in the CDM Node \[sn\_cdm\_node\] table.Data type: String
...
Unique identifier of the changeset record. Located in the CDM Changeset \[sn\_cdm\_changeset\] table.Data type: String
...
Sys\_id of the node record. Located in the CDM Node \[sn\_cdm\_node\] table.Data type: String
...
Sys\_id of the group record. Located in the CDM Group \[sys\_user\_group\] table.Data type: String
...
Required. Unique number of the open changeset to include in the target node. Located in the CDM Changeset \[sn\_cdm\_changeset\] table.Data type: String
