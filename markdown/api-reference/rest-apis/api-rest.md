...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-apis/api-rest.html
release: zurich
product: REST APIs
...
-   **[Agent Mapping API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/agent-mapping-api.md)**  
...
-   **[AI Assets API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/ai-assets-api.md)**  
...
-   **[AWA Agent Consult API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/awa-agent-consult-api.md)**  
...
-   **[AWA Offer Work API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/awa-offer-work-api.md)**  
...
-   **[Continuous Integration and Continuous Delivery \(CICD\) Update Set API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/cicd-update-set-api.md)**  
...
-   **[CSM Pricing API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/csm-pricing-api.md)**  
...
-   **[DCIM Metric Data Feed API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/dcim-metric-data-feed-api.md)**  
...
-   **[Digital Product Release API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/digital-product-release-api.md)**  
...
-   **[Event Management Topic Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/event_management_topic-api.md)**  
...
-   **[External ID Mapping API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/external-id-mapping-api.md)**  
...
-   **[Quote Management API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/quote-management-api.md)**  
...
-   **[SyntheticsAsyncBulkCreate API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/synth-async-api.md)**  
...
-   **[TISC Intel Exchange API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/tisc-intel-ex-api.md)**  
Enables external systems to share threat intelligence data with the Threat Intelligence Security Center \(TISC\) application.
-   **[TISC RPZ API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/tisc-rpz-api.md)**  
The TISC RPZ API provides an endpoint to export domains and IP addresses in Response Policy Zone \(RPZ\) format.
-   **[TISC TAXII Server API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/taxii-server-api.md)**  
...
-   **[Work Order Management API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/work-order-mgmt-api.md)**  
...
-   **[Wrap Up API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/wrap-up-api.md)**  
...
-   **[WSD Reservable V2 API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/wsd_reservable-V2-api.md)**  
...
-   **[WSD Reservable Module API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/wsd_reservable_module-api.md)**  
...
**Parent Topic:**[API reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/api-reference.md)
