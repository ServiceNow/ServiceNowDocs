...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/actsub-api.html
release: yokohama
product: REST APIs
...
For more details on dynamic facets, see [Create facets for activity contexts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/create-facet-customer-central.md).
...
For more details on activity context facets, see [Create facets for activity contexts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/create-facet-customer-central.md).
