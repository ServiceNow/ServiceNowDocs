...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/rest-apis/ci-lifecycle-management-api.html
release: australia
product: REST APIs
