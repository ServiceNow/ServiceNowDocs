...
description: The Appointment Open API is a telecommunication API that allows you to interact with the appointment booking application. Use this API to book appointments and search available time slots.Retrieves a list of appointment records.Retrieves an appointment record associated with a specified ID.Returns time slots that were configured in the appointment booking service configuration along with their availability.Deletes an appointment record with a given ID.Reschedule appointments with a given ID for a  work order.Enables you to book appointments for a work order.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/appointment-open-api.html
release: xanadu
product: REST APIs
