...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/verifyentitlements-api.html
release: xanadu
product: REST APIs
...
To access this API, the Entitlement Verification \(sn\_ent\_verify\) plugin must be activated.
