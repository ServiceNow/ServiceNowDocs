...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/awa\_manual\_assign-api.html
release: yokohama
product: REST APIs
...
-   "Work item &lt;work\_item\_sys\_id&gt; cannot be assigned" – Work item provided cannot be assigned because it is in **Accepted** or **Canceled** state. Refer to [Check work items and AWA events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/awa-work-items-all.md).
...
-   "Agent is not available" – Agent is not in the **Available** state in AWA. Refer to [Agent Inbox controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/agent-experience.md).
