...
To use this endpoint with additional CI types, [create metric definitions](https://www.servicenow.com/docs/access?context=set-up-data-monitoring&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) and implement the scripted extension point TNIDCIMFeedParser.
