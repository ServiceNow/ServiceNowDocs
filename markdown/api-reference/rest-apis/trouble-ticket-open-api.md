...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/trouble-ticket-open-api.html
release: xanadu
product: REST APIs
...
The method of contact that the ticket was created through.Data type: Object
...
List of impacted assets, products, sold products \(product inventory\), configuration items, or services.Data type: Array
...
The type of item or service.Valid values for case tickets:
...
Details about contacts for the ticket.Data type: Array
...
The type of related party.Possible values:

-   `assigned_to`: The user assigned to work on the ticket.
-   `assignment_group`: The group assigned to work on the ticket.
-   `customer`: The company or account for the ticket.
-   `customer_contact`: The caller or contact for the ticket.
...
Sys\_id of the case or incident record to retrieve. Located in the Case \[sn\_customerservice\_case\] or Incident \[incident\] table.Data type: String
...
## Trouble Ticket - GET /sn\_ind\_tsm\_sdwan/troubleticket/\{ticketType\}/\{id\}

Retrieves a specified record from the Case \[sn\_customerservice\_case\] or Incident \[incident\] table.

**Important:** Starting with the Tokyo release, this endpoint is deprecated. The new version of this endpoint is [Trouble Ticket - GET /sn\_ind\_tsm\_sdwan/ticket/troubleTicket/\{id\}](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/trouble-ticket-open-api.md).
...
The type of ticket. This value determines whether a record is retrieved from the Case \[sn\_customerservice\_case\] or Incident \[incident\] table.Valid values:
...
Comma-separated list of fields to return in the response. Invalid fields are ignored. If this value is not passed in, all fields are returned.Valid fields:
...
Details about the companies and contacts associated with the ticket.Data type: Array
...
The type of related party.Valid values:

-   customer: The company or account for the ticket.
-   customer\_contact: The caller or contact for the ticket.
...
Sys\_id of the related party. For cases, the sys\_id is from the Contact \[customer\_contact\] or Account \[customer\_account\] tables. For incidents, the sys\_id is from the User \[sys\_user\] or Company \[core\_company\] tables. If you provide a contact or a user \(caller\), their account or company is automatically populated on the ticket. Data type: String
...
The name of the related party. For cases, maps to the **Contact** or **Account** field. For incidents, maps to the **Caller** or **Company** field.Data type: String
...
The type of ticket \(case or incident\).Data type: String
...
Sys\_id of the case or incident record to update. Located in the Case \[sn\_customerservice\_case\] or Incident \[incident\] table.Data type: String
...
The name of the contact method. Maps to the **Channel** \[contact\_type\] field for cases and the **Contact type** \[contact\_type\] field for incidents.Valid values are the choices for the contact\_type field. You can provide the choice label or value. For example, `Virtual Agent` or `virtual_agent`.
...
A description of the issue. Maps to the **Description** field.Data type: String
...
A list of work notes and comments to add to the ticket.Data type: Array
...
The type of note. This value determines whether the note is recorded in the **Work notes** or **Additional comments** field.Valid values:
...
The note text. Maps to the **Work notes** or **Additional comments** field.Data type: String
...
Details about contacts for the ticket. For cases, this parameter populates the **Contact** or **Account** field. For incidents, this parameter populates the **Caller** or **Company** field.Data type: Array
...
The severity of the issue described by the trouble ticket. Maps to the **Priority** field.Valid values:
...
The current status of the trouble ticket. Maps to the **State** field.Valid values are the choices for the **State** field. You can provide the choice label or value. For example, `New` or `1`.
...
The date the record was created.Data type: String
...
The date the record was last updated.Data type: String
...
The type of ticket. This value determines whether a record is updated in the Case \[sn\_customerservice\_case\] or Incident \[incident\] table.Valid values:
...
The sys\_id of the case or incident record to update.Data type: String
...
The name of the related party.Data type: String
...
The type of ticket. This value determines whether the record is created in the Case \[sn\_customerservice\_case\] or Incident \[incident\] table.Valid values:
...
## Trouble Ticket - POST /sn\_ind\_tsm\_sdwan/troubleticket/\{ticketType\}

Creates a record in the Case \[sn\_customerservice\_case\] or Incident \[incident\] table.

**Important:** Starting with the Tokyo release, this endpoint is deprecated. The new version of this endpoint is [Trouble Ticket - POST /sn\_ind\_tsm\_sdwan/ticket/troubleTicket ](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/trouble-ticket-open-api.md).
...
Required. The type of ticket. This value determines whether the record is created in the Case \[sn\_customerservice\_case\] or Incident \[incident\] table.Valid values:
...
A list of the comments and work notes that were added to the ticket by the POST request.Data type: Array
...
The name of the ServiceNow integration user who made the POST request that created the note.Data type: String
...
The date the note was created in the ServiceNow instance.Data type: String
