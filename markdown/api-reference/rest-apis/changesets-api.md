...
Required. Name of the CDM application whose changesets you want returned. This must be an active application. Located in the CDM Application \[sn\_cdm\_application\] table.Data type: String
...
Changeset number. Located in the CDMChangeset \[sn\_cdm\_changeset\] table.If you pass this value, only the specified changeset is returned. It must be a changeset that is associated with the CDM application specified in the **appName** parameter.
...
-   false: Do not validate the changesets.
...
Sys\_id of the associated CDM application. Located in the CDM Application \[sn\_cdm\_application\] table.Data type: String
...
Date and time when the changeset was created.Format: YYYY-mm-DD hh:mm:ss
...
Sys\_id of the changeset. Located in the CDMChangeset \[sn\_cdm\_changeset\] table.Data type: String
...
Date and time when the changeset was last updated.Format: YYYY-mm-DD hh:mm:ss
...
Sys\_id of the associated changeset. Located in the CDM Changeset \[sn\_cdm\_changeset\] table.Data type: String
...
Current state of the specified commit. Value from state column in the CDM Request Queue \[sn\_cdm\_request\_queue\] table.Possible values:
...
Sys\_id of the shared component node. Located in the CDM Node \[sn\_cdm\_node\] table.Data type: String
...
Sys\_id of the main\_id of the shared component node record. Located in the CDM Node Main \[sn\_cdm\_node\_main\] table.Data type: String
...
Sys\_id of the shared component. Located in the CDM Shared Component \[sn\_cdm\_shared\_component\] table.Data type: String
...
Sys\_id of the changeset record to process. Located in the CDM Changeset \[sn\_cdm\_changeset\] table.Data type: String
...
Flag that indicates whether the associated deployable is in conflict.
...
List of sys\_ids of the users that are allowed to access the associated deployable node. This information comes from the CDM Restricted Groups \[sn\_cdm\_restricted\_groups\] table. This value is `null` if all groups can access the deployable.Data type: String
...
Flag that indicates whether the associated folder is a system folder.
