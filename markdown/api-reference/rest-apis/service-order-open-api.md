...
The date and timestamp of the order.Format: YYYY-MM-DD HH:MM:SS
...
Flag that indicates whether the point of no return for the order has been reached.
...
List of contacts for the order. Each contact is an object in the array.Data type: Array
...
Array of objects that describes the line items in the service order and their associated action. ```
"serviceOrderItem:" [
  {
    "action": "String",
    "actionReason": "String",
...
List of product inventories related to the service.Data type: Array
...
Initial\_version of the service specification. The initial\_version is the sys\_id of the first version of the specification. Located in the Service Specification \[sn\_prd\_pm\_service\_specification\] table.Data type: String
...
Sys\_id of the service order to retrieve. Located in the Order \[sn\_ind\_tmt\_orm\_order\] table.Data type: String
...
Array of objects that describes the line items in the service order and their associated action. Data type: Array
...
Description of the instance details of the service purchased by the customer. ```
"service:" {
  "serviceCharacteristic": [Array],
  "serviceRelationship": [Array],
  "serviceSpecification": {Object},
...
Required. Sys\_id or external\_id of the account, customer contact, or consumer associated with the order. Located in the Account \[customer\_account\] table, Contact \[customer\_contact\] table, or Consumer \[csm\_consumer\] table.Data type: String
...
Required. Array of objects that describes the line items in the service order and their associated action. Data type: Array
...
Required. Array of objects that describe the relationships between order line items.Data type: Array
...
Updates the service\_specification field in the Order Line Item \[sn\_ind\_tmt\_orm\_order\_line\_item\] table.
...
**Note:** This endpoint cannot be used on orders for which the point of no return has been reached. An order line item can't be canceled while fulfillment is in progress.
...
Contains data about the service order.Data type: Object
...
The value for this parameter should be `ServiceOrder`.Data type: String
...
The value for this parameter should be `CancelServiceOrder`.Data type: String
...
The value for this parameter is `ServiceOrder`.Data type: String
...
The value for this parameter is `CancelServiceOrder`.Data type: String
...
Description of the reason for adding the line item. Located in the Order Line Item \[sn\_ind\_tmt\_orm\_order\_line\_item\] table.Data type: String
...
Required. Outbound request identifier of the domain orders record sent for fulfillment. Located in the request\_id field in the Outbound Request \[sn\_tmt\_core\_outbound\_request\] table.Data type: String
...
Required. Sys\_id of a domain order record for which to update the external fulfillment state. Located in the Domain Order \[sn\_ind\_tmt\_orm\_domain\_order\] table.Data type: String
...
Outbound request identifier of the domain orders record sent for fulfillment. Located in the request\_id field in the Outbound Request \[sn\_tmt\_core\_outbound\_request\] table.Data type: String
...
Sys\_id of a domain order record for which to update the external fulfillment state. Located in the Domain Order \[sn\_ind\_tmt\_orm\_domain\_order\] table.Data type: String
