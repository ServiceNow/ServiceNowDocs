...
Sys\_id of the agent. Located in the User \[sys\_user\] table.Data type: String
...
List of objects that define which channels are available for the agent.Data type: Array
