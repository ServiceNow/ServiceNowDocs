...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/rest-apis/agent-api.html
release: australia
product: REST APIs
...
Use the [AWA Agent - PUT /now/awa/agents/\{user\_id\}/capacities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/agent-api.md) method to modify the channel and universal capacities of an agent.
...
Use the [AWA Agent - GET /now/awa/agents/\{user\_id\}/capacities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/agent-api.md) method to retrieve the current channel and universal capacities of an agent.
