...
For additional information on snapshots, see [View snapshots](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/devops-family/cdm-snapshots-view-list.md).
...
Required. Name of the shared component whose configuration data to export. Located in the CDM Shared Component \[sn\_cdm\_shared\_component\] table.Data type: String
...
Required. Name of the shared library that contains the component whose configuration data you want to return. Located in the CDM Application \[sn\_cdm\_application\] table. The specified application must have the type field set to "shared\_library".Data type: String
...
Flag that indicates whether to follow the variables. For information on following the variables, see [Validating and correcting configuration data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/devops-family/cdm-validating-cfg-data.md).Valid values:
...
Required. Name of the version of the shared component to publish. Located in the CDM Shared Component \[sn\_cdm\_shared\_component\] table.Data type: String
...
Required. Name of the shared component to publish. Located in the CDM Shared Component \[sn\_cdm\_shared\_component\] table.Data type: String
...
Required. Name of the shared library in which the specified component resides. Located in the CDM Application \[sn\_cdm\_application\] table. The type field in the associated record must be set to "shared\_library".Data type: String
...
Sys\_id of the deployable record. Located in the CDM Deployable \[sn\_cdm\_deployable\] table.Data type: String
...
Sys\_id of the snapshot. Located in the CDM Snapshot \[sn\_cdm\_snapshot\] table.Data type: String
...
Required. Name of the version of the shared component to unpublish. Located in the CDM Shared Component \[sn\_cdm\_shared\_component\] table.Data type: String
...
Required. Name of the shared component to unpublish. Located in the CDM Shared Component \[sn\_cdm\_shared\_component\] table.Data type: String
