...
For additional information on snapshots, see [View snapshots](https://www.servicenow.com/docs/access?context=cdm-snapshots-view-list&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
...
Flag that indicates whether to follow the variables. For information on following the variables, see [Validating and correcting configuration data](https://www.servicenow.com/docs/access?context=cdm-validating-cfg-data&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).Valid values:
