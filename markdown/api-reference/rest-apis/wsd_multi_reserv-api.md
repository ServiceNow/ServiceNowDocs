...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/wsd\_multi\_reserv-api.html
release: xanadu
product: REST APIs
...
Sys\_id of the multi-reservation to cancel. Located in the Workplace Reservation \[sn\_wsd\_rsv\_reservation\] table.Data type: String
...
-   false: Reservation was not cancelled.
...
Sys\_id of the reservation that was cancelled. Located in the Workplace Reservation \[sn\_wsd\_rsv\_reservation\] table.Data type: String
...
Sys\_id of the reservation that was not cancelled. Located in the Workplace Reservation \[sn\_wsd\_rsv\_reservation\] table.Data type: String
...
Sys\_id of the reservation to update.-   Single reservation to multi-reservation: Sys\_id of the single reservation. Located in the Workplace Reservation \[sn\_wsd\_rsv\_reservation\] table.
-   Update content of multi-reservation: Sys\_id of the parent reservation record. Located in the Workplace Reservation \[sn\_wsd\_rsv\_reservation\] table.
...
Sys\_id of the location at which to make the reservations. Located in the Workplace Location \[sn\_wsd\_core\_workplace\_location\] table.Data type: String
...
List of the reservations that were successfully created.Data type: Array
...
Sys\_id of the workplace for which the reservation was made. Located in the Workplace Location \[sn\_wsd\_core\_workplace\_location\] table.Data type: String
...
List of the reservations that were unsuccessful.Data type: Array
...
Sys\_id of the workplace for which the reservation was trying to be made. Located in the Workplace Location \[sn\_wsd\_core\_workplace\_location\] table.Data type: String
...
List of the reservations that were unsuccessfully.Data type: Array
