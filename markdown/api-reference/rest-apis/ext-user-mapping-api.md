...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/rest-apis/ext-user-mapping-api.html
release: australia
product: REST APIs
