...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/ext-user-mapping-api.html
release: yokohama
product: REST APIs
