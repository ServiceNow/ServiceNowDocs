...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/wsd\_search-api.html
release: xanadu
product: REST APIs
...
Required. Comma-separated list of reservable sys\_ids to evaluate for availability. Located in the Workplace Location \[sn\_wsd\_core\_workplace\_location\] table.Data type: String
...
Comma-separated list of existing reservation sys\_ids. Pass this parameter if you want to edit the associated reservations. Located in the Workplace Reservation \[sn\_wsd\_rsv\_reservation\] table.The time blocked for these sys\_ids for the corresponding reservables are treated as available.
...
Required. Sys\_id of the reservable module to include in the search. A reservable module groups similar types of workplace items. Located in the Reservable Module \[sn\_wsd\_rsv\_reservable\_module\] table.Data type: String
...
Required if the specified reservable modules are based on a shift. Sys\_id of the shift to associate with the reservation. Located in the Shift \[sn\_wsd\_core\_shift\] table. If this parameter is passed in, the **end** parameter isn't required.
...
Sys\_id of the associated record. Located in the Campus \[sn\_wsd\_core\_campus\] table.Data type: String
...
Sys\_id of the associated record in the Floor \[sn\_wsd\_core\_floor\] table.Data type: String
...
Configuration items corresponding to the reservation. Located in the cmdb\_ci table.Data type: String
...
Flag that indicates whether to return the purpose of reserving the workplace location for each reservable in the return results. This information is located in the Reservable Purpose \[sn\_wsd\_rsv\_reservable\_purpose\] table.Valid values:
...
Sys\_id of a time slot record for which we are trying to look for the best matching reservable. Located in the Time Slot \[sn\_wsd\_rsv\_time\_slot\] table.Data Type: String
...
Located in the Campus \[sn\_wsd\_core\_campus\] table.
...
Sys\_id of the associated container record. The table in which this resides can be configured for any container type. By default it is in the Area \[sn\_wsd\_core\_area\] table.Data type: String
...
Details about the reservable units that match the specified search criteria. A reservable unit is a singe reservable item such as a desk or a chair.Data type: Object
...
Details about the area in which the reservable module is located. Located in the Area \[sn\_wsd\_core\_area\] table.Data type: Object
...
Details about the building in which the reservable is located. Located in the Building \[sn\_wsd\_core\_building\] table.Data type: Object
...
Flag that indicates the default privacy setting for the reservable.For additional information on these privacy settings, see Location privacy settings and impact.

 Possible values:

-   true: Privacy setting for the reservable can be overridden.
-   false: Privacy setting for the reservable cannot be overridden.
...
Located in the Floor \[sn\_wsd\_core\_floor\] table.
...
Details about the type of location of the reservable, such as workplace/desk, cafe, or gym.Located in the Workplace Location \[sn\_wsd\_core\_workplace\_location\] table.
...
Sys\_id of the reservable purpose record. Located in the Reservable Purpose \[sn\_wsd\_rsv\_reservable\_purpose\] table.Data type: String
...
Flag that indicates whether an employee can override the privacy settings for the associated reservable.For additional information on these privacy settings, see Location privacy settings and impact.

 Valid values:

-   true: Privacy settings can be overridden.
-   false: Privacy setting cannot be overridden.
...
Sys\_id of the reservable record. Located in the Workplace Location \[sn\_wsd\_core\_workplace\_location\] table.Data type: String
...
Sys\_id of the reservable module to check for overlapping reservations. Located in the Reservable Module \[sn\_wsd\_rsv\_reservable\_module\] table.Data type: String
...
Sys\_id of the reservation to check for overlap. This value is needed in the edit flow of multi/group parents. Located in the Workplace Reservation \[sn\_wsd\_rsv\_reservation\] table.Data type: String
...
Details of the shift to check for overlap. For additional information on shift-based reservations, see Enable shift-based reservation.
...
Sys\_id of the shift to associate with the reservation. Located in the Shift \[sn\_wsd\_core\_shift\] table. If this parameter is passed in, the **end** parameter isn't required.Data type: String
...
Required. Sys\_id of the user to check for overlapping reservations. Located in the User \[sys\_user\] table.Data type: String
...
List of one or more sys\_ids of reservables to exclude from the search results. The table in which these sys\_ids are located is specified in the reservable\_table field in the Reservable Module \[sn\_wsd\_rsv\_reservable\_module\] table. It can be either the Space \[sn\_wsd\_core\_space\] or Room \[sn\_wsd\_core\_room\] table.Data type: String or Array
...
Required if the **rsv\_path** parameter is set to `browse_near_a_person`. Sys\_id of the location to use in the encoded query. Located in the Workplace Location \[sn\_wsd\_core\_workplace\_location\] table. Data type: String
...
Sys\_id of the building to include in the search query. Located in the Building \[sn\_wsd\_core\_building\] table.Data type: String
...
Sys\_id of the reservable module to include in the search query. Located in the Reservable Module \[sn\_wsd\_core\_reservable\_module\] table. A reservable module groups similar types of workplace items, such a chairs or desks.Data type: String
...
-   false: Reservable module does not has shifts enabled. No encoded query returned.
...
Required. List of sys\_ids of the reservables to include in the availability score. Located in the Workplace Location \[sn\_wsd\_core\_workplace\_location\] table.Data type: Array
