...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/wsd\_search-api.html
release: yokohama
product: REST APIs
...
Required. Sys\_id of the reservable module to include in the search. A reservable module groups similar types of workplace items.Data type: String
