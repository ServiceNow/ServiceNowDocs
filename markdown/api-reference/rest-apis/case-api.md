...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/case-api.html
release: xanadu
product: REST APIs
...
Sys\_id or case number of the case to retrieve. Located in the Case \[sn\_customerservice\_case\] table. Results will be unpredictable if a specified case number is shared by two or more cases.Data type: String
...
Array of objects in which each object represents an activity stream entry from the CSM case.Data type: Array
...
State of the attachment record in the Attachment \[sys\_attachment\] table.Possible values:
...
Sys\_id for the attachment. Located in the Attachment \[sys\_attachment\] table.Data type: String
...
-   false: The activity stream entry does not contain code.
...
Name for the journal field associated with the activity stream entry. Located in Dictionary Entries \[sys\_dictionary\] table.Data type: String
...
Sys\_id for user who created the activity stream entry. Located in User \[sys\_user\] table.Data type: String
...
Array of objects in which each object represents a journal field present in the Case table from which activity entries are drawn.Data type: Array
...
Name for the journal field. Located in Dictionary Entries \[sys\_dictionary\] table.Data type: String
...
Sys\_id for the CSM case. Located in the Case \[sn\_customerservice\_case\] table.Data type: String
...
Sys\_id for logged-in user. Located in User \[sys\_user\] table.Data type: String
...
Name of a choice or reference field in the Case \[sn\_customerservice\_case\] table.Data type: String
...
Array of objects in which each object describes a single value for the requested field.Data type: Array
...
Name of a choice or reference field. Located in the Case \[sn\_customerservice\_case\] table.Data type: String
...
Sys\_id of a record. Located in the Case \[sn\_customerservice\_case\] table to use when evaluating reference qualifiers.Data type: String
...
Sys\_id or case number for the case to retrieve. Located in the Case \[sn\_customerservice\_case\] table. Results will be unpredictable if a specified case number is shared by two or more cases.Data type: String
...
Sys\_id of the active escalation associated with the account. Located in the Escalation \[sn\_customerservice\_escalation\] table.Data type: String
...
Sys\_id of a contact record associated with this account. Located in the User \[sys\_user\] table.Data type: String
...
Sys\_id of the parent account of this account. Located in the Company \[core\_company\] table.Data type: String
...
Sys\_id of the primary contact for the account. Located in the Contact \[customer\_contact\] table.Data type: String
...
Sys\_id of the customer portal theme used by this account. Located in the Theme \[sys\_ui\_theme\] table.Data type: String
...
List of sys\_ids of the vendor managers for the account. Located in the User \[sys\_user\] table.Data type: String
...
List of sys\_ids of the type of vendor such as, applications, hardware, services, or software. Located in the Vendor Type \[vendor\_type\] table.Data type: String
...
Sys\_id of the account record to which the contact is associated; Account \[customer\_account\] table.Data type: String
...
Sys\_id of the record that describes the building in which the contact resides; Building \[cmn\_building\] table.Data type: String
...
Sys\_id of the company record to which the contact is associated; Company \[core\_company\] table.Data type: String
...
Sys\_id of the cost center associated with the contact; Cost Center \[cmn\_cost\_center\] table.Data type: String
...
Sys\_id of the default perspective for the contact. Located in the Menu List \[sys\_perspective\] table.Data type: String
...
Sys\_id of the department associated with the contact. Located in the Department \[cmn\_department\] table.Data type: String
...
Sys\_id of the LDAP server used by the contact to last log in to the system; LDAP Server \[ldap\_server\_config\] table. Data type: String
...
Sys\_id of the record that describes the location of the contact; Location \[cmn\_location\] table.Data type: String
...
Sys\_id of the record that describes the direct supervisor of the contact; User \[sys\_user\] table.Data type: String
...
Photo image of the contact. Data type: Image
...
Sys\_id of the record that describes the work schedule for the associated contact; Schedule \[cmn\_schedule\] table.Data type: String
...
Sys\_id of the record that contains the time sheet policy for the associated contact; Time Sheet Policy \[time\_sheet\_policy\] table.Data type: String
...
Array of objects that contain details for a specific social media profile, such as Facebook, Twitter, or YouTube.Data type: Array
...
Sys\_id of the account associated with the case; located in the Account \[customer\_account\] table. Data type: String
...
Sys\_id of the case to update. Located in the Case \[sn\_customerservice\_case\] table.
