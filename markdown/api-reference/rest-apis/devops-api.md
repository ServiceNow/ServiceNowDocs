...
For additional information, see [DevOps Config](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/devops-family/devops-config-landing-page.md).
...
Description of the commits.Data type: Array
...
Sys\_id of the application that was generated when the application was onboarded. Located in the Apps \[sn\_devops\_app\] table.Data type: String
...
List of pipelines associated with the onboarding event and their corresponding details.Data type: Array
...
Array of objects that describe any change steps that are associated with the onboarding.Data type: Array
...
List of plans associated with the onboarding event and their corresponding details.Data type: Array
...
List of repositories associated with the onboarding event and their corresponding details.Data type: Array
...
Array of objects that define the tools to onboard within the associated ServiceNow instance.Data type: Array
...
Describes the configuration status of the tool. In case of success, it returns the **status** and **message**. In case of error, it returns the **status** and **error**.Data type: Object
...
Describes the connection status of the tool. In case of success, it returns the **status** and **message**. In case of error, it returns the **status** and **error**.Data type: Object
...
Describes the creation status of the tool. In case of success, it returns the **status** and **message**. In case of error, it returns the **status** and **error**.Data type: Object
...
Describes the discovery status of the tool. In case of success, it returns the **status** and **message**. In case of error, it returns the **status** and **error**.Data type: Object
...
Array of objects that describe each entity that was discovered.Data type: Array
...
Sys\_id of the import request. Located in the sn\_devops\_m2m\_inbound\_event\_import\_request table.Data type: String
...
-   false: Change request was not found.
...
For additional information on artifacts, see [Using DevOps change acceleration for releases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/devops-change-velocity/using-dev-ops-release-change.md).
...
Required. Sys\_id of the orchestration tool associated with the artifact. Located in the Orchestration Tool \[sn\_devops\_orchestration\_tool\] table. The endpoint uses this information to locate task execution information.Data type: String
...
Sys\_id of the artifact tool associated with the artifact. Located in the Artifact Tool \[sn\_devops\_artifact\_tool\] table.Data type: String
...
At least one entry required. Array of objects in which each object uniquely identifies an artifact version to register.Data type: Array
...
If the request created artifact records, the list of sys\_ids of the created records in the Artifacts \[sn\_devops\_artifact\] table.Data type: Array
...
If the request created artifact staging records, the list of sys\_ids of the created records.Data type: Array
...
If artifact repositories were created by the request, the list of sys\_ids of the created records.Data type: Array
...
If the endpoint updates the track flag on a repository to true \(from false\), the list of sys\_ids of the repository records that were modified.Data type: Array
...
Results for any artifact version records that were created during the processing of the request.Data type: Array
...
If artifact version records used in the register request already exist, the list of sys\_ids of the existing records.Data type: Array
...
Required. ServiceNow user ID of the user making the endpoint request. Located in the User \[sys\_user\] table. This user must have the devops.integration.user role. Starting with version 1.34.1, this user must have the sn\_devops.admin role.Data type: String
...
Array of objects that define pipelines to associate with applications. Data type: Array
...
Array of objects that define the change steps to create for the pipeline specified in the **pipelines.name** field. Data type: Array
...
Required if a **changeSteps** object is specified. Name of the change approval group to associate with the pipeline. Located in the Group \[sys\_user\_group\] table. This group must already exist on the ServiceNow instance. Data type: String
...
Required if a **changeSteps** object is specified. Type of change request to create. The available types are defined in the Type field of the Change Request \[change\_request\] table. Data type: String
...
Required if a **changeSteps** object is specified. Type of step to create. The available step types are defined in the Type field of the Steps \[sn\_devops\_step\] table.Data type: String
...
Array of objects that define a plan to associate with an application. Data type: Array
...
Array of objects that define the repositories associated with an application. If the repositories object contains an app parameter, then it maps the repository to the application. Data type: Array
...
Required. ServiceNow identifier of the user making the endpoint request. Located in the User \[sys\_user\] table. This user must have the devops.integration.user role. Starting with version 1.34.1, this user must have the sn\_devops.admin role.Data type: String
...
Required. Array of objects that define the tools to create within the associated ServiceNow instance. You can create one or more tools in a single request.Data type: Array
...
Required. Sys\_id of the DevOps tool for which to place the specified task under change control. Located in the Orchestration Tool sn\_devops\_orchestration\_tool table.Data type: String
...
For additional information on artifact packages, see [Using DevOps change acceleration for releases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/devops-change-velocity/using-dev-ops-release-change.md).
...
Required. Sys\_id of the orchestration tool associated with the artifact package. Located in the Orchestration Tool \[sn\_devops\_orchestration\_tool\] table. The endpoint uses this information to locate task execution information.Data type: String
...
Sys\_id of the artifact tool associated with the artifact package. Located in the Artifact Tool \[sn\_devops\_artifact\_tool\] table.Data type: String
...
At least one entry required. Array of objects in which each object uniquely identifies an artifact version to include in the package.Data type: Array
...
If the request created package staging records, the list of sys\_ids of the created staging records.Data type: Array
...
If the request created records linking artifact versions to packages, the list of sys\_ids of the created records in the Artifact Version to Package \[sn\_devops\_m2m\_artifact\_version\_package\] table.Data type: Array
...
If package records were created by the request, the list of sys\_ids of the created records.Data type: Array
...
Optional. The sys\_id of the orchestration tool to which the related pipeline belongs. **orchestrationToolId** is required if the **capability** request parameter is set to `test` or `softwarequality`.**toolId** is the default orchestration tool if orchestrationToolId is not present.
...
Required if **capability** is set to `test`. The type of test being run. The valid values for this parameter are those in the Test type column of the Test Types \[sn\_devops\_test\_type\] table.
...
Required. Sys\_id of the tool for which the endpoint is being called.
...
Description of a single error. Data type: Array
...
-   [GitHub integration with DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/devops-change-velocity/github-integration-dev-ops.md)
-   [Jira integration with DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/devops-change-velocity/jira-integration-dev-ops.md)
-   [Bitbucket integration with DevOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/devops-change-velocity/bitbucket-integration-dev-ops.md)
...
Required. Sys\_id of the DevOps tool associated with the change control task. Located in the Orchestration Tool \[sn\_devops\_orchestration\_tool\] table.Data type: String
...
Required. Change request number associated with the orchestration task to update. Located in the Change Request \[change\_request\] table.Data type: String
