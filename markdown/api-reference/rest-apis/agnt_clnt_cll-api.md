...
List of [Agent Client Collector plugins](https://www.servicenow.com/docs/access?context=acc-assets&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US) associated with this check. Data type: Array
...
An [encoded query string](https://www.servicenow.com/docs/access?context=c_EncodedQueryStrings&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US) to filter the check definition result list. Use null for an unfiltered list of check definitions in the system. Data type: String
...
Encoded query on the Agent Client Collectors \[sn\_agent\_cmdb\_ci\_agent\] table in standard Glide format. See [Encoded query strings](https://www.servicenow.com/docs/access?context=c_EncodedQueryStrings&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
...
Optional. Encoded query string in standard Glide format. See [Encoded query strings](https://www.servicenow.com/docs/access?context=c_EncodedQueryStrings&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
...
Name of the [CMDB groups](https://www.servicenow.com/docs/access?context=cmdb-groups&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) associated with the policy.This field is only applied if the value of the **monitored\_ci\_type\_group** property is true.
...
Extended details of the sandbox copy associated with the policy. For information on policies, see [default checks and policies](https://www.servicenow.com/docs/access?context=agent-policies-checks&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).```
{
  "active": Boolean"
  "agent_ids": "String",
  "checks": [Array],
