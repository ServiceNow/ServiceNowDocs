...
For the command line solution, see [CMDB Application CLI and API available commands](https://www.servicenow.com/docs/access?context=cmdb-cli-commands&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
