...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-apis/sg\_services-api.html
release: zurich
product: REST APIs
...
For the command line solution, see [CMDB Application CLI and API available commands](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/cmdb-cli-commands.md).
