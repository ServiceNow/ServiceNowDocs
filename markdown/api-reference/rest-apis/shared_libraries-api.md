...
For additional information on shared libraries and shared components, see [Sharing components among applications — Component libraries](https://www.servicenow.com/docs/access?context=cdm-component-libraries&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
...
Value of the publish option passed in the associated upload call. For additional information on publishing snapshots, see [Publish or unpublish a snapshot](https://www.servicenow.com/docs/access?context=cdm-snapshot-publish&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
...
String that uniquely identifies the [changeset](https://www.servicenow.com/docs/access?context=cdm-changesets-version-control&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US) associated with the application, such as Chset-102. This changeset must be in the "Open" state.Data type: String
