...
Sys\_id of the mapped application service. Located in the Mapped Application Service \[cmdb\_ci\_service\_discovered\] table.Data type: String
...
List of services related to the identified service.Data type: Array
...
Hierarchy data for the CIs within the application service. All CIs form pairs with a parent and child CI. The top-level CI, referred to as the entry point of an application service, does not have a parent CI.Data type: Array
...
Required, if **number** is not passed in. Name of the service for which to return information. Located in the Application Service \[cmdb\_ci\_service\_auto\] table.Data type: String
...
Required, if **name** is not passed in. Unique number that identifies the application service for which to return information. Located in the Application Service \[cmdb\_ci\_service\_auto\] table.Data type: String
...
List of sys\_ids of the technical service offerings related to the application service.Data type: Array
...
Creates an application service record stub in the Application Service \[cmdb\_ci\_service\_auto\] table and populates it with the passed in information.
...
Upstream \(parent\) service types to associate with the application service. These relationships are stored in the CI Relationships \[cmdb\_rel\_ci\] table.Data type: Object
...
Unique number that identifies the application service. This number is generated by the endpoint.
...
Sys\_id of the registered application service.
...
Sys\_id of the application service to populate with the specified CIs. Located in the Application Service \[cmdb\_ci\_service\_auto\] table. Data type: String
...
CIs to associate with the specified application service. The elements in the **populate\_method** object depend on the type of information being populated; defined by the **type** parameter.Data type: Object
...
List of attributes to associate with the CI, such as host, port, name, and URL.For additional information on entry points, see [Entry point attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/service-mapping/r_EntryPointsforBizSvcDef.md).
...
Required if **population\_method.type** = discovery. Entry point into the application service. For additional information on entry points, see [Entry point attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/service-mapping/r_EntryPointsforBizSvcDef.md) and [Create entry point types for Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/discovery-and-service-mapping-patterns/t_CreateEntryPoint.md).Data type: String
...
Required if **population\_method.type** = cmdb\_group\_based. Sys\_id of the group to associate with the CI. Located in the CMDB Group \[cmdb\_group\] table. Data type: String
...
List of tags to associate with the CI. This information is located in the Key Values \[cmdb\_key\_value\} table. Data type: Array
...
Sys\_id of the application service to updated. Located in the Application Service \[cmdb\_ci\_service\_auto\] table. Data type: String
