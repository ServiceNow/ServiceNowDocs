...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/devops-config-api.html
release: xanadu
product: REST APIs
