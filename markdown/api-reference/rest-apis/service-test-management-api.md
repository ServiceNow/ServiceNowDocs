...
Sys\_id or external\_id of characteristics. Located in the Characteristics \[sn\_prd\_pm\_characteristic\] table. If external\_id is present for that record, the response returns the external\_id otherwise it returns the sys\_id.Data type: String
...
Type of characteristic value.-   yes/no
-   choice
-   date
-   date/time
-   duration
...
End date and time of the service test. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Sys\_id or external\_id of the service test definition. Located in the Service Test \[sn\_st\_mgmt\_test\] table.Data type: String
...
The mode that the service test is running in.Valid values:
...
Required. The test definition associated with the service test.Data type: Object
...
Sys\_id or external\_id of the product inventory. Located in the sys\_id or external\_id field of the product Inventory \[sn\_prd\_invt\_product\_inventory\] table.Data type: String
...
Start date and time of the service test. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
The date and time that the metric was captured. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Sys\_id or external\_id of the Test Measures. Located in the sys\_id or external\_id fields of the Test Measures table \[sn\_st\_mgmt\_test\_measure\] table.Data type: String
...
The number of periods before applying the consequence.Data type: Number
...
Sys\_id or external\_id of the threshold rule violation. Located in the Threshold Rule Violation table \[sn\_st\_mgmt\_threshold\_rule\_violation\] table.Data type: String
...
Specifies the unit of measurement for the conformance target values of the test measure.Data type: String
...
The value of the test measure.Data type: Object
...
The ID of the test measure value.Data type: String
...
The name of the test measure value.Data type: String
...
The value of the test measure.Data type: String
...
The type of test measure value such as numeric, text, and so forth.Data type: String
...
Required. The test definition associated with this test. Data type: Object
...
The sys\_id or external\_id of the service test definition. Located in the sys\_id or external\_id field of the Service Test Definition \[sn\_st\_mgmt\_test\_definition\] table.Data type: String
...
Validity end date of the service test. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Validity start date of the service test. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Required. Sys\_id or external\_id of the service test to retrieve. Located in the Service Test \[sn\_st\_mgmt\_test\] table.Data type: String
...
The sys\_id or external\_id of the product inventory. Located in the sys\_id or external\_id field of the Product Inventory \[sn\_prd\_invt\_product\_inventory\] table.Data type: String
...
The state of the service test.Valid values:
...
Sys\_id or external\_id of the test measure. Located in the Test Measures table \[sn\_st\_mgmt\_test\_measure\] table.Data type: String
...
Sys\_id or external\_id of the service test definition. Located in the sys\_id or external\_id field of the Service Test Definition \[sn\_st\_mgmt\_test\_definition\] table.Data type: String
...
End date and timestamp of the service test. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Start date and timestamp of the service test. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Sys\_id or external\_id of the service test definition. Located in the Service Test Definition \[sn\_st\_mgmt\_test\_definition\] table.Data type: String
...
Sys\_id or external\_id of the service specification. Located in the sys\_id or external\_id field of the Specification \[sn\_prd\_pm\_specification\] table.Data type: String
...
Sys\_id or external\_id of the related service test definition. Located in the sys\_id or external\_id field of the Test Definition \[sn\_st\_mgmt\_test\_definition\] table.Data type: String
...
Sys\_id or external\_id of the test measure definitions. Located in the Test Measure definition table \[sn\_st\_mgmt\_test\_measure\_definition\] table.Data type: String
...
Validity end date of the consequence. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Validity start date of the consequence. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Sys\_id or external\_id of the threshold rules. Located in the Located in the sys\_id or external\_id field of the Threshold Rules \[sn\_st\_mgmt\_threshold\_rule\] table.Data type: String
...
Maximum crossings allowed within the tolerance period before consequences are applied.Maximum value: 40
...
Validity end date of the test measure definition. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Validity start date of the test measure definition. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Date and time of the test definition on which the state of it is retired. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Date and time of the test definition on which the state of it is published. Format: YYYY-MM-DD 00:00:00. For example, `2025-01-31 09:35:43`.
...
Required. Sys\_id or external\_id of the service test definition to retrieve. Located in the Service Test Definition \[sn\_st\_mgmt\_test\_definition\] table.Data type: String
...
The sys\_id or external\_id of the service test definition. Located in the Service Test \[sn\_st\_mgmt\_test\] table.Data type: String
...
The sys\_id or external\_id of the service specification. Located in the sys\_id or external\_id field of the Specification \[sn\_prd\_pm\_specification\] table.Data type: String
...
The frequency in which to capture the metric. Valid values:
...
A duration or period of the capture.Data type: Object
...
Sys\_id or external\_id of the threshold rules. Located in the Threshold Rules \[sn\_st\_mgmt\_threshold\_rule\] table.Data type: String
...
Sys\_id or external\_id of the service test. Located in the Service Test \[sn\_st\_mgmt\_test\] table. This ID creates a service test and is used as the external\_id.Data type: String
...
The related service test definition.Data type: Array of objects
