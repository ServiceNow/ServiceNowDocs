...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/order\_csm-api.html
release: yokohama
product: REST APIs
...
For information on B2B and B2C orders, see [Customer Data Models for B2B2C](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/customer-data-model-b2b2c.md).
