...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-apis/appointment-api.html
release: zurich
product: REST APIs
...
For additional information on lead time and maximum future bookable dates configuration, see [Create or modify an application configuration for Appointment Booking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/field-service-management/appt-booking-create-app-config.md).
...
For additional information on Field Service Management tasks, see [Configuring Appointment Booking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/field-service-management/appointment-booking-administer.md).
