...
Name of the import set table from which to import the data. Refer to [Import sets key concepts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/c_ImportSetsKeyConcepts.md).Data type: String
...
The [Data dictionary tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/c_DataDictionaryTables.md) provides details on table fields in the system.
