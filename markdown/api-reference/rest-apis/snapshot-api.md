...
Sys\_id of the snapshot record to process. Located in the CDM Snapshot \[sn\_cdm\_snapshot\] table.Data type: String
...
Required. Name of the Configuration Data Management \(CDM\) application for which to create the snapshot. Located in the CDM Application \[sn\_cdm\_application\] table.Data type: String
...
Required. Name of the CDM deployable for which to create the snapshot. Located in the CDM Deployable \[sn\_cdm\_deployable\] table.Data type: String
...
Required. Name of the snapshot. Located in the CDM Snapshot \[sn\_cdm\_snapshot\] table.Data type: String
