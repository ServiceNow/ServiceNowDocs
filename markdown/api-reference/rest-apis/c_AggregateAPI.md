...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/c\_AggregateAPI.html
release: yokohama
product: REST APIs
...
This API uses [GlideAggregate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_GlideAggregateScopedAPI.md) calls and only honors read-only queries if read access is defined for the table being called on based on role ownership.
