...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/integrations-api.html
release: yokohama
product: REST APIs
...
For additional information on install base items, see [Create an install base item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/create-install-base-item.md).
...
For additional information, see [Configure related parties for items received](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/government-industry/public-sector-digital-services/psds-add-related-parties-to-record.md).
