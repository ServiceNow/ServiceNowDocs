...
```
 ...
 For more information on Install Base Items [Configure install base](https://www.servicenow.com/docs/access?context=configure-install-base&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
