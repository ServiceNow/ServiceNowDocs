...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/entitlement-api.html
release: xanadu
product: REST APIs
...
Versioned URL: `/api/sn_pss_core/v1/entitlement/{id}`
...
Sys\_id of the entitlement record to retrieve. Located in the Entitlement \[service\_entitlement\] table.Data type: String
...
List of characteristics associated with the entitlement. The data in this array is inserted in the Characteristic \[sn\_pss\_core\_entitlement\_characteristic\] table.Data type: Array of Objects
...
List of install base items covered under the  entitlement. Located in the Sold Product Covered  \[sn\_install\_base\_m2m\_contract\_sold\_product\] table. Data type: Array of Objects
...
Versioned URL: `/api/sn_pss_core/v1/entitlement`
...
```
 ...
 For more information on Install Base Items [Configure install base](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/configure-install-base.md).
...
List of products covered under the entitlement. The data in this parameter is inserted in the Sold Product Covered \[sn\_install\_base\_m2m\_contract\_sold\_product\] table. Data type: Array of Objects
...
Sys\_id of a entitlement characteristics record associated with the entitlement. Located in the Characteristic \[sn\_pss\_core\_entitlement\_characteristic\] table.Data type: String
