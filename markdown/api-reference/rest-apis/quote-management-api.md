...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-apis/quote-management-api.html
release: zurich
product: REST APIs
...
The Quote Management API requires the Quote Management \(com.sn\_quote\_mgmt\) plugin and the quote\_integrator role. This API belongs to the sn\_tmf\_api namespace. See [Quote Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/order-management/quote-management.md).
...
See [Create product characteristics and characteristic options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/order-management/som-product-config-add-characteristics.md).
