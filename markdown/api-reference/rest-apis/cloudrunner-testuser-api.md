...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/cloudrunner-testuser-api.html
release: xanadu
product: REST APIs
...
To view the Server API reference documentation of this API, see [Cloud Runner TestUserApi – Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/cloudrnr-TestUserAPI-scoped.md).
...
Required. The BOQ record sys\_id of the test user job to get the progress of. Located in the BOQ \[sn\_atf\_tg\_sn\_boq\] table.Data Type: String
...
The current status of the BOQ record.Possible values:
...
Sys\_id of the BOQ record that is inserted when test user job starts successfully. Located in the BOQ \[sn\_atf\_tg\_sn\_boq\] table.Data type: String
...
Required. Sys\_id of the BOQ record to cancel associated with the test user job. Located in the SNBOQ \[sn\_atf\_tg\_sn\_boq\] table.Data Type: String
