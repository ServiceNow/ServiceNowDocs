...
For additional information on installing and configuring the Virtual Agent Bot Integration API, see [Using Virtual Agent with a live agent](https://www.servicenow.com/docs/access?context=using-va-agent-chat&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
