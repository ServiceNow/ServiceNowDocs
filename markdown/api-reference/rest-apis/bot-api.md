...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/bot-api.html
release: xanadu
product: REST APIs
...
For additional information on installing and configuring the Virtual Agent Bot Integration API, see [Virtual Agent API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/conversational-interfaces/virtual-agent/virtual-agent-api.md).
