...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/openframe-api.html
release: yokohama
product: REST APIs
...
Use this API to create interaction records to track agent phone calls. Once an interaction record is created, the interaction can automatically display in the CRM Workspace when an agent receives a phone call.
...
For additional information on CSM voice interaction records, see [CSM voice interaction record page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/csm-native-voice-record-page.md).
...
Sys\_id of the interaction record to update. This value is returned by the [Create Voice Interaction/POST](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/rest-apis/openframe-api.md) endpoint.Data type: String
...
See also the **callerPhoneNumber** property description for [Create Voice Interaction/POST](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/rest-apis/openframe-api.md).
