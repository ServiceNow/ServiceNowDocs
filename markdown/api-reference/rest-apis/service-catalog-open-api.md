...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/service-catalog-open-api.html
release: xanadu
product: REST APIs
...
External\_id of the service specification. Located in the Service Specification \[sn\_prd\_pm\_service\_specification\] table.Data type: String
...
Initial\_version or external\_id of the service specification. Located in the Service Specification \[sn\_prd\_pm\_service\_specification\] table.Data type: String
...
Resource specifications for this service specification.Data type: Array
...
Initial\_version or external\_id of the resource specification.Data type: String
...
Initial\_version of the resource specification.Data type: String
...
External\_version of the resource specification.Data type: String
...
This specification's relationships to other service specifications.Data type: Array
...
Initial\_version or external\_id of the related specification.Data type: String
...
Initial\_version of the related specification.
...
External\_version of the related specification.Data type: String
...
Sys\_id of the service specification to retrieve. Located in the Service Specification \[sn\_prd\_pm\_service\_specification\] table.Data type: String
...
External\_id of the service specification. Located in the Service Specification \[sn\_prd\_pm\_service\_specification\] table. If both **externalId** and **id** are provided, they must refer to the same specification.
...
Initial\_version or external\_id of the service specification. If **id** is not provided, this endpoint creates a new specification with version=1. If **id** is provided, this endpoint creates a new version of the given specification. If both **externalId** and **id** are provided, they must refer to the same specification.
...
Required. Resource specifications for this service specification.Data type: Array
...
Required. Initial\_version or external\_id of the resource specification.Data type: String
...
Required. The value type of the characteristic, such as choice or email.Data type: String
...
External\_version of the service specification. Located in the Service Specification \[sn\_prd\_pm\_service\_specification\] table. Version must be unique for the given version chain.
