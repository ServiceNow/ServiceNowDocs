...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/c\_ServiceCatalogAPI.html
release: xanadu
product: REST APIs
...
Sys\_id of the user whose shipping address is to be retrieved. Located in the User \[sys\_user\] table.Data type: String
...
Sys\_id of the service catalog item to verify whether the specified user has acquisition rights. Located in the Service Catalog \[sc\_catalog\] table.Data type: String
...
Sys\_id of the user to check whether they have acquisition rights to the specified service catalog item. Located in the Users \[sys\_users\] table.Data type: String
...
Comma-separated string of user sys\_ids of other users for which to order the specified item. User sys\_ids are located in the User \[sys\_user\] table.-   You cannot specify more than 50 additional users to receive the item.
...
Sys\_id of the user for whom to order the specified item. Located in the User \[sys\_user\] table.Data type: String
...
You can call this endpoint prior to calling an endpoint such as [Service Catalog API - POST /sn\_sc/servicecatalog/items/\{sys\_id\}/add\_to\_cart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/c_ServiceCatalogAPI.md) or [Service Catalog API - POST /sn\_sc/servicecatalog/items/\{sys\_id\}/order\_now](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/c_ServiceCatalogAPI.md) that allow the requisition of a service catalog item on behalf of another person. These calls fail if you pass in a user that is not authorized for the associated item. This endpoint allows you to verify your list of users prior to calling an endpoint that orders the item or tries to add the item to a cart.
...
Comma separated string of valid user sys\_ids. The endpoint verifies that these users have acquisition rights to the specified service catalog item. Located in the Users \[sys\_user\] table.Data type: String
...
Sys\_id of the service catalog item. Located in the Catalog Item \[sc\_cat\_item\] table.Data type: String
...
Sys\_id of the user for whom to order the specified item. Located in the User \[sys\_user\] table.The settings of the **glide.sc.req\_for.roles** and **glide.sc.req\_for.roles.default** properties determine the level at which a user can request items.
...
Number of the generated request.
...
Sys\_id of the order guide whose items are to be retrieved. Located in the Order guide \[sc\_cat\_item\_guide\] table.Data type: String
...
List of of objects the catalogs to which the item belongs and each catalog title and sys\_id of the catalog.Data type: Array
...
Indicates whether to show the price details. If true, returns the following details. -   local\_currency
-   localized\_price
-   localized\_recurring\_price
-   price
-   price\_currency
