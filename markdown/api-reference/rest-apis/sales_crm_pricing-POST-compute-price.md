...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/rest-apis/sales\_crm\_pricing-POST-compute-price.html
release: australia
product: REST APIs
...
**Parent Topic:**[Sales CRM Pricing API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/sales-crm-pricing-api.md)
