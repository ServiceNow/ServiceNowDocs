...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-apis/awa-inbox-actions-api.html
release: zurich
product: REST APIs
...
This API requires the Advanced Work Assignment \(com.glide.awa\) plugin and awa\_integration\_user role. For more information, refer to [Advanced Work Assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-overview.md).
