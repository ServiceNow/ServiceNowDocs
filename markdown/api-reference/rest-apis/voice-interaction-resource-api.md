...
Sys\_id of the interaction record whose voice interaction to terminate. Located in the Interaction \[interaction\] table and passed back by the [Voice Interaction Resource - POST /cs/voice-interactions](voice-interaction-resource-api.md#) endpoint.Data type: String
