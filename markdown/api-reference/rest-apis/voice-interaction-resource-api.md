...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/voice-interaction-resource-api.html
release: xanadu
product: REST APIs
...
Sys\_id of the interaction record whose voice interaction to terminate. Located in the Interaction \[interaction\] table and passed back by the [Voice Interaction Resource - POST /cs/voice-interactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/voice-interaction-resource-api.md) endpoint.Data type: String
...
Unique identifier of the agent to assign the voice interaction to. Located in the User ID field in the User \[sys\_user\] table. Data type: String
...
Unique identifier of the application provider for the voice service. Located in the Inbound ID field in the Provider Channel Application \[sys\_cs\_provider\_application\] table. Data type: String
...
Sys\_id of the newly created voice interaction record. Located in the Interaction \[interaction\] table. Use this sys\_id when:

-   Calling the [Voice Interaction Resource - POST /cs/voice-interactions/\{interactionId\}/messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/voice-interaction-resource-api.md) endpoint to add a message to the voice interaction.
-   Calling the [Voice Interaction Resource - PATCH /cs/voice-interactions/\{interactionId\}/state](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/voice-interaction-resource-api.md) endpoint to end the voice interaction.
...
|Name|Description|
|----|-----------|
|conversationId|Sys\_id of the newly created conversation record. Located in the Conversation \[sys\_cs\_conversation\] table.|
...
Sys\_id of the voice interaction message record that was created. Located in the Voice Transcript Conversation Message \[sys\_cs\_message\_voice\_transcript\] table.Data type: String
...
Start time of the conversation. Located in the Interaction \[interaction\] table.Data type: String
...
Sys\_id of the voice conversation table where the messages were attached. Located in the Conversation \[sys\_cs\_message\_conversation\] table.Data type: String
