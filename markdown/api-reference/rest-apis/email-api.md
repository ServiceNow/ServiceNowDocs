...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-apis/email-api.html
release: xanadu
product: REST APIs
...
Sys\_id of the email for which to return details. Located in the Email \[sys\_email\] table.
...
Processing state of the email message. Indicates whether the system scheduled jobs have processed the email message. Values include:
...
Current state of the email message as incoming or outgoing mail. Values include:
