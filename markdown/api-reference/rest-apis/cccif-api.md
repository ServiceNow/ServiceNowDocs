...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-apis/cccif-api.html
release: zurich
product: REST APIs
...
If the attachment is public, you can just send the attachment URL in the request body of your [Virtual Agent Bot Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-apis/bot-api.md) call.
...
For additional information on the capabilities of the Virtual Agent API, see [Virtual Agent API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/virtual-agent-api-landing-page.md).
