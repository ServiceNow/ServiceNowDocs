...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-apis/cccif-api.html
release: yokohama
product: REST APIs
...
If the attachment is public, you can just send the attachment URL in the request body of your [Virtual Agent Bot Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/rest-apis/bot-api.md) call.
...
For additional information on the capabilities of the Virtual Agent API, see [Virtual Agent API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/conversational-interfaces/virtual-agent/virtual-agent-api.md).
