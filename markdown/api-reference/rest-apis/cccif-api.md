...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/rest-apis/cccif-api.html
release: australia
product: REST APIs
...
If the attachment is public, you can just send the attachment URL in the request body of your [Virtual Agent Bot Integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/bot-api.md) call.
