...
For additional information on the capabilities of the Virtual Agent API, see [Virtual Agent API](https://www.servicenow.com/docs/access?context=virtual-agent-api-landing-page&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
