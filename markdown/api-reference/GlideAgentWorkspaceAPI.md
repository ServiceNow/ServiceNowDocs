...
The domainScopeProvider\(\) method accesses four functions to return information about the domain scope. For information, see [Domain scope](https://www.servicenow.com/docs/access?context=c_DomainScope&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
