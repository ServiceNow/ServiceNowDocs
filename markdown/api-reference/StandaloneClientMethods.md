...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/StandaloneClientMethods.html
release: xanadu
...
Configured dependent field for the specified **target** element. For additional information, see [Make a field dependent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/t_MakingAFieldDependent.md).
