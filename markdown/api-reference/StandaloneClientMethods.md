...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/StandaloneClientMethods.html
release: yokohama
...
Configured dependent field for the specified **target** element. For additional information, see [Make a field dependent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_MakingAFieldDependent.md).
