...
Configured dependent field for the specified **target** element. For additional information, see [Make a field dependent](https://www.servicenow.com/docs/access?context=t_MakingAFieldDependent&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
