...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/StandaloneClientMethods.html
release: zurich
...
Configured dependent field for the specified **target** element. For additional information, see [Make a field dependent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_MakingAFieldDependent.md).
