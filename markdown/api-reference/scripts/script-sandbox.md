...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/scripts/script-sandbox.html
release: zurich
product: Scripts
...
For more information about guarded-script exemptions and enforcement phases, see [Guarded script evaluator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/guarded-script.md).
...
</table>**Parent Topic:**[Script sandbox environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/script-sandbox-environment.md)
