...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/scripts/exploring-now-assist-code.html
release: australia
product: Scripts
...
For more information, see [Generate code with autocomplete](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/generate-code-with-autocomplete.md).
...
For more information, see [https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/edit-code-now-assist.md](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/edit-code-now-assist.md).
...
For more information, see [Explain and summarize code](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/explain-and-summarize-code-with-quick-actions.md).

## ServiceNow Otto for Code benefits

|Benefit|Feature|Users|
|-------|-------|-----|
|Generate code based on your prompts to improve quality and reduce repetitive tasks.|[Generate code with AI-powered code generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/generate-scripts-from-text.md)|Developers|
|Quickly edit and refactor large code segments.|[https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/edit-code-now-assist.md](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/edit-code-now-assist.md)|Developers|
|Add comments to code segments.|[Add comments to code](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/add-comments-to-code-with-quick-actions.md)|Developers|
|Understand code.|[Explain and summarize code](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/explain-and-summarize-code-with-quick-actions.md)|Developers|
|Identify code generated by AI.|[Tracking AI-generated code](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/tracking-ai-generated-code.md)|Developers, administrators|
