...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/scripts/monaco-editor.html
release: zurich
product: Scripts
...
The code editor has these features for the supported language services and [Inline scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/inline-scripts.md).
