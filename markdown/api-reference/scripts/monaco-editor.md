...
The code editor has these features for the supported language services and [Inline scripts](https://www.servicenow.com/docs/access?context=inline-scripts&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
