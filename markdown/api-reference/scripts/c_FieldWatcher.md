...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/c\_FieldWatcher.html
release: xanadu
product: Scripts
...
3.  View the field watcher log by clicking the debug icon.
    ...
    A new pane opens at the bottom of the screen, showing a field watcher tab. It may also show tabs for [JavaScript Logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_WritingToTheDebugLog.md) and JavaScript Debugger.
