...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/scripts/c\_ServerScripting.html
release: zurich
product: Scripts
...
-   **[Glide Server APIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/p_GlideServerAPIs.md)**  
ServiceNow provides APIs for the Glide Server.
-   **[Classic Business rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/business-rules-classic/c_BusinessRules.md)**  
...
-   **[Processors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_Processors.md)**  
...
-   **[Scripts - Background module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_ScriptsBackground.md)**  
Administrators can use the Scripts - Background module to run arbitrary JavaScript code from the server.
-   **[Script sandbox environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/script-sandbox-environment.md)**  
...
-   **[Installation settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_InstallationSettings.md)**  
...
-   **[Using DurationCalculator to calculate a due date](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_DrtnClDueDate.md)**  
...
-   **[Querying tables in script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_UsingGlideRecordToQueryTables.md)**  
...
-   **[Running order guides automatically](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_RunningOrderGuidesAutomatically.md)**  
...
-   **[Scriptable assignment of execution plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_ScptblAsmtExctnPlns.md)**  
...
-   **[Using regular expressions in server-side scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_RegularExpressionsInScripts.md)**  
...
-   **[Scriptable service catalog variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_ScriptableServiceCatalogVariables.md)**  
You can use scripting to reference any request item variable from a table in scoped and non-scoped environment.
-   **[Setting a GlideRecord variable to 'NULL'](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/r_SettingAGlideRecordVariableToNull.md)**  
...
-   **[Schedule Pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_SchedulePages.md)**  
...
-   **[XMLDocument script object](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_XMLDocumentScriptObject.md)**  
A JavaScript object wrapper for parsing and extracting XML data from an XML document \(String\).
-   **[JavaScript engine on the platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_JS_engine_upgrade.md)**  
The JavaScript engine that evaluates server-side scripts supports the ECMAScript 2021 \(ES12\) standard.
-   **[JavaScript API Context-sensitive help](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/scripts/c_ScriptingAssistance.md)**  
