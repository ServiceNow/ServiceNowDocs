...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/considerations-switching-javascript-mode.html
release: xanadu
product: Scripts
...
For more information about each JavaScript mode, see [JavaScript modes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_JS_modes.md) and [JavaScript engine feature support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/javascript-engine-feature-support.md).
...
</table>**Parent Topic:**[JavaScript modes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_JS_modes.md)
