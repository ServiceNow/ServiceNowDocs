...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/scripts/considerations-switching-javascript-mode.html
release: australia
product: Scripts
...
</table>**Parent Topic:**[JavaScript modes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/c_JS_modes.md)
