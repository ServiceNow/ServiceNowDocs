...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/create-custom-ui-pages.html
release: xanadu
product: Scripts
...
-   **[UI pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/r_UIPages.md)**  
UI pages can be used to create and display forms, dialogs, lists, and other UI components.
-   **[UI macros](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_UIMacros.md)**  
UI macros are discrete scripted components administrators can add to the user interface.
-   **[Jelly tags](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/r_JellyTags.md)**  
