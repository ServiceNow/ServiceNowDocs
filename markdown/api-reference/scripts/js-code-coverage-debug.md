...
![Sample code coverage highlighting](../image/js-code-coverage-highlighting.png "Sample code coverage highlighting")
...
5.  Navigate to **JS Code Coverage Debug** &gt; **Coverage Data**.
    ...
    ![Sample JavaScript Code Coverage records](../image/sample-js-code-coverage-list.png)
