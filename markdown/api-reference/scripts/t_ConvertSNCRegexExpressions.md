...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/scripts/t\_ConvertSNCRegexExpressions.html
release: yokohama
product: Scripts
...
**Parent Topic:**[Using regular expressions in server-side scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/scripts/c_RegularExpressionsInScripts.md)
