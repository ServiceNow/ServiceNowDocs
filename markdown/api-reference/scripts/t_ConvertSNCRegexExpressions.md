...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/t\_ConvertSNCRegexExpressions.html
release: xanadu
product: Scripts
...
**Parent Topic:**[Using regular expressions in server-side scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_RegularExpressionsInScripts.md)
