...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/scripts/p\_AJAX.html
release: yokohama
product: Scripts
...
For additional information, refer to the [GlideAjax](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideAjaxAPI.md) API.
