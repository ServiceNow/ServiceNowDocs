...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/r\_DebuggingBusinessRules.html
release: xanadu
product: Scripts
...
|GlideRecord Information|This is the basic syntax used to query the database for information. See [Querying tables in script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_UsingGlideRecordToQueryTables.md). GlideRecord also includes aggregation support.|
