...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/scripts/script-debugger.html
release: australia
product: Scripts
...
To view debug logs, see [Display debugging logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/c_SessionDebug.md).
...
-   **[Access the Script Debugger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/launch-script-debugger.md)**  
Developers can access the Script Debugger from the application navigator, Studio, or from the syntax editor.
-   **[Script Debugger user interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/parts-script-debugger-interface.md)**  
...
-   **[Evaluate expressions in runtime using Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/evaluate-expressions.md)**  
...
-   **[Set or remove logpoints](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/set-remove-logpts.md)**  
...
-   **[Script Debugger multiple developer support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/multiple-developer-support.md)**  
...
-   **[Script Debugger Scripts - Background support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/scripts-background-support.md)**  
...
-   **[Domain separation and Script Debugger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/domain-separation-script-debugging.md)**  
