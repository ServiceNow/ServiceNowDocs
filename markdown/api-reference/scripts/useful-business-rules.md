...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/useful-business-rules.html
release: xanadu
product: Scripts
...
-   **[Abort a database action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_AbortDatabaseActionBusRule.md)**  
...
-   **[Restricting record access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_ExScptDftBfrQryBsnRu.md)**  
