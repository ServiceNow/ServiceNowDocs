...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/scripts/useful-business-rules.html
release: yokohama
product: Scripts
...
-   **[Abort a database action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/scripts/c_AbortDatabaseActionBusRule.md)**  
...
-   **[Restricting record access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/scripts/c_ExScptDftBfrQryBsnRu.md)**  
