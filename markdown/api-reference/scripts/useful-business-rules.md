...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/scripts/useful-business-rules.html
release: australia
product: Scripts
...
-   **[Abort a database action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/c_AbortDatabaseActionBusRule.md)**  
...
-   **[Restricting record access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/c_ExScptDftBfrQryBsnRu.md)**  
