...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/c\_ScriptsBackground.html
release: xanadu
product: Scripts
...
For examples of scripts you could run, see [Useful scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/usefulScripts.md).
