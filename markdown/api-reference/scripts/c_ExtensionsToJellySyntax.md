...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/scripts/c\_ExtensionsToJellySyntax.html
release: yokohama
product: Scripts
...
breadcrumb: [Jelly tags, Creating custom UI Pages and UI macros, Scripting, API implementation, API implementation and reference]
---
...
**Parent Topic:**[Jelly tags](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/scripts/r_JellyTags.md)
...
For more information, see [UI macros](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/scripts/c_UIMacros.md).
