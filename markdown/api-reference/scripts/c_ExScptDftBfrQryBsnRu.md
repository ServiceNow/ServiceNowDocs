...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/c\_ExScptDftBfrQryBsnRu.html
release: xanadu
product: Scripts
...
For more information, see [Validation script use case - Date and time](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_ValidateDateAndTime.md).
