...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/r\_ScriptingAlertInfoAndErrorMsgs.html
release: xanadu
product: Scripts
