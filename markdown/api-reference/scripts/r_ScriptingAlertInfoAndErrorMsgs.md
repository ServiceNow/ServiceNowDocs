...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/scripts/r\_ScriptingAlertInfoAndErrorMsgs.html
release: yokohama
product: Scripts
