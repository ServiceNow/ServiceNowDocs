---
title: ServiceNow Otto for Code reference
description: Reference topics provide additional information about configuration properties, roles, and more.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/scripts/now-assist-code-reference.html
release: australia
product: Scripts
...
# ServiceNow Otto for Code reference

Reference topics provide additional information about configuration properties, roles, and more.

-   **[ServiceNow Otto for Code properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/now-assist-code-properties.md)**  
You can adjust how code generation functions on an instance using several advanced properties.
-   **[ServiceNow Otto for Code roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/now-assist-code-roles.md)**  
...
-   **[Keyboard shortcuts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/scripts/keyboard-shortcuts.md)**  
