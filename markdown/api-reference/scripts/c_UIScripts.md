...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/c\_UIScripts.html
release: xanadu
product: Scripts
...
**Parent Topic:**[Client-side scripting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/client-side-scripting-overview.md)
...
Access UI scripts from within client-side code using the g\_ui\_scripts global object. For more information, see [GlideUIScripts - Client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/GUIScriptsAPI.md).
