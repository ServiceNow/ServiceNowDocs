...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/scripts/c\_UIScripts.html
release: yokohama
product: Scripts
...
**Parent Topic:**[Client-side scripting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/scripts/client-side-scripting-overview.md)
...
Access UI scripts from within client-side code using the g\_ui\_scripts global object. For more information, see [GlideUIScripts - Client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/GUIScriptsAPI.md).
