...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/scripts/general-guidelines-code-generation.html
release: yokohama
product: Scripts
...
breadcrumb: [Exploring code generation, Now Assist for code generation, Scripting, API implementation, API implementation and reference]
---
