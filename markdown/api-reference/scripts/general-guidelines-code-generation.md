...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/scripts/general-guidelines-code-generation.html
release: australia
product: Scripts
...
breadcrumb: [Explore, ServiceNow Otto for Code, Scripting, API implementation, API implementation and reference]
---
