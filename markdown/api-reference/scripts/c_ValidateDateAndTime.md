...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/c\_ValidateDateAndTime.html
release: xanadu
product: Scripts
...
For a comprehensive use case, see [Restricting record access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_ExScptDftBfrQryBsnRu.md).
