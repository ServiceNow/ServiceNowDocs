...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/scripts/r\_SyntxEdtrKybrdSrtctsActn.html
release: xanadu
product: Scripts
...
</table>**Parent Topic:**[Syntax editor plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/scripts/c_SyntaxEditorPlugin.md)
