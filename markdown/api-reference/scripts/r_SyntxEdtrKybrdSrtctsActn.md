...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/scripts/r\_SyntxEdtrKybrdSrtctsActn.html
release: yokohama
product: Scripts
...
breadcrumb: [Syntax editor plugin, JavaScript syntax editor, Scripting, API implementation, API implementation and reference]
---
...
</table>**Parent Topic:**[Syntax editor plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/scripts/c_SyntaxEditorPlugin.md)
