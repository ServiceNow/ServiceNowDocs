...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/scripts/useful-client-side-scripts.html
release: yokohama
product: Scripts
...
\[Omitted image "RequestedFor.png"\] Alt text: Requested for dialog box with "System Administrator" in the field.
...
\[Omitted image "AddedFieldServiceCatalogCheckout.png"\] Alt text: Added field on service catalog checkout
...
[GlideForm - getFormElement\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md)

[Scoped GlideSystem - eventQueue\(String name, Object instance, String parm1, String parm2, String queue\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_GlideSystemScopedAPI.md)
