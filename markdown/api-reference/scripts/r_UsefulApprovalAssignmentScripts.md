...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/scripts/r\_UsefulApprovalAssignmentScripts.html
release: yokohama
product: Scripts
...
For see [Viewing my approvals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/security-management/viewing-my-approvals.md).
...
-   **Custom approval UI macro**
    ...
    For information on creating a custom approval UI macro, see [UI macros](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/scripts/c_UIMacros.md).


**Parent Topic:**[Field script use cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/scripts/r_UsefulFieldScripts.md)
