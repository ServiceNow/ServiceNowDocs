...
For see [Viewing my approvals](https://www.servicenow.com/docs/access?context=viewing-my-approvals&version=zurich&pubname=zurich-security-management&ft:locale=en-US).
