...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/c\_GlideFormAPI.html
release: yokohama
...
-   [clearAllFormMessages\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md)
-   [clearFormMessages\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md)
...
-   [addFormMessage\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md)
-   [clearFormMessages\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md)
...
**Note:** To get a display value from a form in Service Portal, use the [getDisplayValue\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md) method.

See also:

-   [getValue\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md)
...
**Note:** To get a display value from a form in the core UI, use the [getDisplayBox\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md) method.
...
Use the [GlideForm - showFieldMsg\(String field, String message, String type\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md) or [GlideForm - showFieldMsg\(String field, String message, String type, Boolean scrollForm\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md) methods to display messages on a form.
...
For additional information on display values, see [Display value](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/c_DisplayValues.md).
...
Once you set a field to read-only, you cannot use the [setValue\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideFormAPI.md) method to update the value of that field. If you need to set the value in this way, you must set the readOnly value to false.
