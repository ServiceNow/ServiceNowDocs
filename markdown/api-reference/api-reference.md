...
Use UI Builder APIs when developing client scripts in the [UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/ui-builder/ui-builder-overview.md). Client scripts are executed in response to something happening on a page, such as:
