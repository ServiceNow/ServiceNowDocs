...
Use UI Builder APIs when developing client scripts in the [UI Builder](https://www.servicenow.com/docs/access?context=ui-builder-overview&version=australia&pubname=australia-application-development&ft:locale=en-US). Client scripts are executed in response to something happening on a page, such as:
