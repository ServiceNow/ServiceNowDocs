...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/spUtilAPI.html
release: yokohama
...
-   Display a notification error message. [spUtil - addErrorMessage\(String message\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Display a notification info message. [spUtil - addInfoMessage\(String message\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Display a trivial notification message. [spUtil - addTrivialMessage\(String message\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Create a unique identifier. [spUtil - createUid\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Format a string with variables. [spUtil - format\(String template, Object data\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Embed a widget model in a widget client script. [spUtil - get\(String widgetId Object data\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Retrieve all headers to use for API calls. [spUtil - getHeaders\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Return the complete host domain. [spUtil - getHost\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Execute the callback with User Preference response by passing the preference name. [spUtil - getPreference\(String preference, Function callback\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Return the current service portal URL information. [spUtil - getURL\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Check if the current client is a mobile device. [spUtil - isMobile\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Parse the comma-separated attributes within a specified string. [spUtil - parseAttributes\(String attributes\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Watch for updates to a table or filter and returns the value from the callback function. [spUtil - recordWatch\(Object $scope, String table, String filter, Function callback\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Call the server and replaces the current **options** and **data** with the server response. [spUtil - refresh\(Object $scope\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Scroll to the element with the specified selector, over a specified period of time. [spUtil - scrollTo\(String selector, Number time\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Update the header breadcrumbs. [spUtil - setBreadCrumb\(Object $scope, Array breadcrumbs\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Set a user preference. [spUtil - setPreference\(String pref, String value\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Update the search page. [spUtil - setSearchPage\(String searchPage\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)
-   Update the data object on the server within a given scope. [spUtil - update\(Object $scope\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/spUtilAPI.md)

For additional information on widgets, see [Service Portal widgets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/service-portal/service-portal-widgets.md).
...
The callback function returns the full widget model. For additional information on widgets, see [Service Portal widgets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/service-portal/service-portal-widgets.md).
