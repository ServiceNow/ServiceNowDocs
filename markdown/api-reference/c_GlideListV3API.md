...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/c\_GlideListV3API.html
release: yokohama
...
This API is no longer supported. Consider using the [GlideList2\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideList2API.md) API instead.
