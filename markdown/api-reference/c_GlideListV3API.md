...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/c\_GlideListV3API.html
release: xanadu
...
This API is no longer supported. Consider using the [GlideList2\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/c_GlideList2API.md) API instead.
