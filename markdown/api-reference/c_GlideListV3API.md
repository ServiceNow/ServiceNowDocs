...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/c\_GlideListV3API.html
release: australia
...
This API is no longer supported. Consider using the [GlideList2\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/c_GlideList2API.md) API instead.
