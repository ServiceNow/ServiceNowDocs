...
|Name|Type|Description|
|----|----|-----------|
|sysId|String|Sys\_id of the attribute group to clear from the cache. Located in the Dynamic Attribute Group \[dynamic\_attribute\_group\] table|
...
|Name|Type|Description|
|----|----|-----------|
|sysId|String|Sys\_id of the category to clear from the cache. Located in the Dynamic Category \[dynamic\_category\] table.|
...
|Name|Type|Description|
|----|----|-----------|
|sysId|String|Sys\_id of the choice set to clear from the cache. Located in the Dynamic Choice Set \[dynamic\_choice\_set\] table.|
