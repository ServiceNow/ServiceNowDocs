...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/c\_ScriptableServiceResponseBuilder.html
release: yokohama
...
Error object. For more information about the types of error objects that can be used, see [Scripted REST API example - script samples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/rest-api-explorer/r_ScriptedRESTServiceScriptExamples.md).
