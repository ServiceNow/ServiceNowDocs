...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/GeniusResultAnswerScopedAPI.html
release: xanadu
...
You can populate the answer object with query details retrieved from the context of the Genius Result configuration using the [GeniusResultContext](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/GeniusResultContextScopedAPI.md) API.
