...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/tmftopiceventapiutiloobScopedAPI.html
release: xanadu
...
For additional information on how to override these functions, see the [Event Notification Management Open API Developer Guide](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/developer-guides/event-mgmt-notif_dev-guide.md).

For additional information on the Event Notification Management Open API, see [Event Notification Management Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/event_open-api.md).
...
Message key. This key is generated when an event is created. Located in the Message key field in the Events \[em\_event\] table.
...
This function is called by the [processAlarmCreateEvent\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/tmftopiceventapiutiloobScopedAPI.md) function as part of the flow action. You can change the functionality of this function by overriding the default functionality in the `TMFTopicEventAPIUtil` script include.
