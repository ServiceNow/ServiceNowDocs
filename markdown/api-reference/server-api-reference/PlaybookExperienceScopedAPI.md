...
description: The PlaybookExperience API provides methods for handling playbook executions.Cancels playbook executions for a given parent record.Gets a list of playbook executions for a given parent record.Checks whether a parent record has playbook executions.Restarts an execution from the beginning \(the entire playbook\) or from a specific stage or activity of a playbook.Initiates a playbook for a parent record.Cancel an individual playbook.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/PlaybookExperienceScopedAPI.html
release: yokohama
...
## PlaybookExperience - restartPlaybook\(GlideRecord playbookContextRecord, String laneContextId, String activityContextId, String playbookExperienceId\)
