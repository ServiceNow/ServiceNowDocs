...
|Type|Description|
|----|-----------|
|String|Current date and time in the user-defined format. For more information on setting the system date and time format, see [Date and Date/Time fields](https://www.servicenow.com/docs/access?context=r_UseDateAndTimeFields&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).|
