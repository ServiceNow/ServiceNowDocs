...
|Type|Description|
|----|-----------|
|String|Current date and time in the user-defined format. For more information on setting the system date and time format, see [Date and Date/Time fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/r_UseDateAndTimeFields.md).|
