...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/c\_XMLDocument2ScopedAPI.html
release: australia
...
This method must be called with [Scoped XMLDocument2 - parseXML\(String xmlDoc\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/c_XMLDocument2ScopedAPI.md).

See also: [Scoped XMLNode - isCDATANode\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/c_XMLNodeScopedAPI.md).
