...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/c\_XMLDocument2ScopedAPI.html
release: yokohama
...
This method must be called with [Scoped XMLDocument2 - parseXML\(String xmlDoc\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_XMLDocument2ScopedAPI.md).

See also: [Scoped XMLNode - isCDATANode\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_XMLNodeScopedAPI.md).
