...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/UniversalTaskUtilsBothAPI.html
release: xanadu
...
For additional information on the Universal Task application, see [Universal Task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/universal-task/universal-task-landing.md).
...
Before you can use this method, there must be universal task templates configured in your instance. For details, see [Universal Task templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/universal-task/ut-task-template-landing.md).

|Name|Type|Description|
|----|----|-----------|
|templateSysId|String|Sys\_id of universal task template to apply to the specified universal task record. Located in the Universal Task Template \[sn\_uni\_task\_template\] table.|
...
You can then use the GlideRecord API, [scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideRecordScopedAPI.md) or [global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideRecordAPI.md) depending on the calling application's scope, to access the returned data, such as using the getRowCount\(\) method to count active tasks.
