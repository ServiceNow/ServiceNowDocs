...
Before you can use this method, there must be universal task templates configured in your instance. For details, see [Universal Task templates](https://www.servicenow.com/docs/access?context=ut-task-template-landing&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US).
