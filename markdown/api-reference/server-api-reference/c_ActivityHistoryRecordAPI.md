...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/c\_ActivityHistoryRecordAPI.html
release: yokohama
...
Flag that indicates whether the activity is a [turnstile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/workflow-activities/r_TurnstileActivity.md).
