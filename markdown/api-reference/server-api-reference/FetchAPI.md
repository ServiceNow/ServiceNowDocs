...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/FetchAPI.html
release: australia
...
-   A [Fetch Request - Request\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/Fetch.RequestAPI.md) object.
...
-   response.json\(\): Parses the JSON response body into a JavaScript object. \(See [Fetch Response - json\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/Fetch.ResponseAPI.md) for more information.\)
-   console.log\(\): Outputs the incidents \(data.result\) using the Console API \(See [Console - log\(Object val1...val2, String msg, String subst1...subst2\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/ConsoleAPI.md)\).
