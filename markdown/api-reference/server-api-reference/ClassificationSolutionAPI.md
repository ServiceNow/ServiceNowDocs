...
See also: [Model Explainability](https://www.servicenow.com/docs/access?context=predictive-intel-explainability&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)
...
Optional. Field name by which the system groups records to build classification solutions. For usage information, see [Using group by for classification](https://www.servicenow.com/docs/access?context=using-group-by-for-classification&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
