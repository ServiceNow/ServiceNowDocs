...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/DocumentVersionServiceBothAPI.html
release: xanadu
...
|Name|Type|Description|
|----|----|-----------|
|docVersion|[SystemDocumentVersion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/SystemDocumentVersionBothAPI.md)|One or more properties representing fields of a document version.|
...
</table>The following example shows how to populate SystemDocumentVersion object properties and create a new document version. See also [SystemDocumentVersion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/SystemDocumentVersionBothAPI.md).
