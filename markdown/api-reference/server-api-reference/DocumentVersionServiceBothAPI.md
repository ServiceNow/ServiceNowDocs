...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/DocumentVersionServiceBothAPI.html
release: yokohama
...
|Name|Type|Description|
|----|----|-----------|
|docVersion|[SystemDocumentVersion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/SystemDocumentVersionBothAPI.md)|One or more properties representing fields of a document version.|
