...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/server-api-reference/DocumentVersionServiceBothAPI.html
release: zurich
...
|Name|Type|Description|
|----|----|-----------|
|docVersion|[SystemDocumentVersion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/server-api-reference/SystemDocumentVersionBothAPI.md)|One or more properties representing fields of a document version.|
