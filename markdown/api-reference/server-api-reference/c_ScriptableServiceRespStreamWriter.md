...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/c\_ScriptableServiceRespStreamWriter.html
release: australia
...
Use RESTAPIResponseStream methods to build web service APIs in the [Scripted REST API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-api-explorer/c_CustomWebServices.md) feature.
