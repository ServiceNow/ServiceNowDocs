...
Selects a metric to retrieve within a span of dates. For more information, see [Configuring target metrics](https://www.servicenow.com/docs/access?context=configuring-target-metrics-trained-classification-solution&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US).```
{
  "fromDate": "String",
  "metricName": "String",
  "toDate": "String"
...
Training statistics data from the Class Confidence \[ml\_class\] table. For more information, see [Configuring target metrics](https://www.servicenow.com/docs/access?context=configuring-target-metrics-trained-classification-solution&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US).Data type: Object
...
List of objects providing training statistics data. For more information, see [Configuring target metrics](https://www.servicenow.com/docs/access?context=configuring-target-metrics-trained-classification-solution&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US).Data type: Array of Objects
...
Metric configuration values. For information about these features, see [Configuring target metrics](https://www.servicenow.com/docs/access?context=configuring-target-metrics-trained-classification-solution&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US).```
{  	 
   "metricName" : "String",
   "metricValue" : "String",
   "className" : "String"
