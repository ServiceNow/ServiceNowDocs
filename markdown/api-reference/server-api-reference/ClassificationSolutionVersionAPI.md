...
Selects a metric to retrieve within a span of dates. For more information, see [Configuring target metrics](https://www.servicenow.com/docs/access?context=configuring-target-metrics-trained-classification-solution&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).```
{
  "fromDate": "String",
  "metricName": "String",
  "toDate": "String"
...
Metric configuration values. For information about these features, see [Configuring target metrics](https://www.servicenow.com/docs/access?context=configuring-target-metrics-trained-classification-solution&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).```
{  	 
   "metricName" : "String",
   "metricValue" : "String",
   "className" : "String"
