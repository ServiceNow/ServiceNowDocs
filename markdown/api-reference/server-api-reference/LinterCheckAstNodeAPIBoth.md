...
The following example uses the Findings API [incrementWithNode\(\)](../../Findings/concept/FindingsAPI.md#) method in a linter check. Use this method in the Script field of the Linter Check form.
