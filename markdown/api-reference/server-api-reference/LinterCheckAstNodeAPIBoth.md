...
The following example uses the Findings API [incrementWithNode\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/FindingsAPI.md) method in a linter check. Use this method in the Script field of the Linter Check form.
