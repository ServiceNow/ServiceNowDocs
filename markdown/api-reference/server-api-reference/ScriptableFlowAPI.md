...
|Type|Description|
|----|-----------|
|[ScriptableFlowRunner](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/ScriptableFlowRunnerScopedAPI.md)|Builder object used to run a Workflow Studio action, flow, or subflow.|
...
JSON formatted string containing the current state of the flow, subflow, or action as name-value pairs. ```
{
...
JSON formatted string containing state details about the queried flow, subflow, or action.```
{
    "hasLookupError": false,
    "errorMessage": "",
    "contextStatus": {
...
&lt;String&gt;.contextStatus.errorState
...
&lt;String&gt;.contextStatus.canceledReason
...
&lt;String&gt;.contextStatus.isRunOnMid
...
&lt;String&gt;.contextStatus.waitingOn
...
&lt;String&gt;.contextStatus.waitingOn.stepType
...
List of reasons why a flow, subflow, or action is waiting. The API only generates this parameter when the flow, subflow, or action is in the WAITING state.-   WAIT\_FOR\_CONDITION
...
&lt;String&gt;.contextStatus.waitingOn.table
...
&lt;String&gt;.contextStatus.waitingOn.condition
...
Query condition of the record that the flow, subflow, or action is waiting on. The API only generates this parameter when the flow, subflow, or action is in the WAITING state and the stepType is WAIT\_FOR\_CONDITION, WAIT\_FOR\_CONDITION\_WITH\_TIMEOUT, ASK\_FOR\_APPROVAL, or CREATE\_TASK\_WITH\_WAIT.```
{
    "hasLookupError": false,
    "errorMessage": "",
    "contextStatus": {
...
&lt;String&gt;.contextStatus.waitingOn.endTime
...
&lt;String&gt;.contextStatus.waitingOn.approvalRule
...
&lt;String&gt;.contextStatus.waitingOn.contextId
