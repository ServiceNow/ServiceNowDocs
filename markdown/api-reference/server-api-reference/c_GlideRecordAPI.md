...
An [encoded query string](https://www.servicenow.com/docs/access?context=c_EncodedQueryStrings&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
...
[Display values](https://www.servicenow.com/docs/access?context=c_DisplayValues&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) are manipulated based on the actual value in the database and user or system settings and preferences.
...
Name of the field in the current table that contains the [dynamic schema](https://www.servicenow.com/docs/access?context=dynamic-schema&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
