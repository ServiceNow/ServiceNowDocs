...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/NotifyJsTelephonyDriverAPI.html
release: xanadu
...
For additional information on scripted extension points, see [Using extension points to extend application functionality point](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/extension-points.md).
...
[NotifyPhoneNumber - Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_NotifyPhoneNumberAPI.md)
...
|Name|Type|Description|
|----|----|-----------|
|participantRecord|[GlideRecord - Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideRecordAPI.md)|GlideRecord object containing the Notify Participant \[notify\_participant\] record of the caller to remove from the conference call.|
...
|Name|Type|Description|
|----|----|-----------|
|participantRecord|[GlideRecord - Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideRecordAPI.md)|GlideRecord object containing the Notify Participant \[notify\_participant\] record of the caller to mute in the conference call.|
...
[GlideRecord - Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideRecordAPI.md)
