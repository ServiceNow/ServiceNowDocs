...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/c\_GlideEvaluatorScopedAPI.html
release: xanadu
...
|Name|Type|Description|
|----|----|-----------|
|grObj|[GlideRecord](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideRecordScopedAPI.md)|GlideRecord containing a script expression.|
