...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/c\_GlideEvaluatorScopedAPI.html
release: yokohama
...
|Name|Type|Description|
|----|----|-----------|
|grObj|[GlideRecord](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_GlideRecordScopedAPI.md)|GlideRecord containing a script expression.|
