...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/GlideGeopointGlobalAPI.html
release: xanadu
...
The name of the geo point field. Located in the Dictionary Entry `[sys_dictionary]` table.**Note:** You can also locate field names under dictionary elements defined on a table to see associated fields of geo point type.
