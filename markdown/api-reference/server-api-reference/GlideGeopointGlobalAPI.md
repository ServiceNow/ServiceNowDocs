...
The examples on this page assume that a custom table is pre-populated with fields containing the geopoint field type. For more information about this data type, see [Geo point field type](https://www.servicenow.com/docs/access?context=geo-point-field-type&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) and [Function field](https://www.servicenow.com/docs/access?context=platform-support-functions&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
