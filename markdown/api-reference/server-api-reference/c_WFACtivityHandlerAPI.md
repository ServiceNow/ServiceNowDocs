...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/c\_WFACtivityHandlerAPI.html
release: xanadu
...
Enables generating objects at the start of a workflow in a **pending** state. For related information, see [Generate workflow activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-activities/r_Generate.md).
...
Sys\_id of this running activity. Located in the Workflow Activities \[wf\_activity\] table.
...
The order number associated with the task or approval.
...
The starting time for the task or approval in [GlideDateTime](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideDateTimeAPI.md) format.
...
Flag that indicates whether to skip creating an approval record.
...
-   The activity must create the approvals using the onExecute function.
