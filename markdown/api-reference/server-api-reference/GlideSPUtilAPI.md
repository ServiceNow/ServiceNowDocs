...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/GlideSPUtilAPI.html
release: xanadu
...
GlideRecord object of theService Portal template page for which to resolve the dynamic URL variables. Located in the Page \[sp\_page\] table.
