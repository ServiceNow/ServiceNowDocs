...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/GlideSPUtilAPI.html
release: yokohama
...
For additional information, see [Service Portal pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/add-human-readable-keywords-page-urls.md).
