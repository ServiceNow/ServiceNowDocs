...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/SystemDocumentListEntryBothAPI.html
release: yokohama
...
The following example shows how to add a document template as a document list entry. See also [DocumentListEntryService API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/DocumentListEntryServiceBothAPI.md).
...
The following example shows how to set the document list in which to add a document. See also [DocumentListEntryService API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/DocumentListEntryServiceBothAPI.md).
