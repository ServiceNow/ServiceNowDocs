...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/TransformerDefinitionAPI.html
release: xanadu
...
|----|----|-----------|
|transformerDefinitionSysId|String|Sys\_id of a transformer definition. Located in the Record Transformer \[sys\_record\_transformer\] table.|

This example instantiates a TransformerDefinition object based on the provided sys\_id.
