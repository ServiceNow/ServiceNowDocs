...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/TopicSubscriptionUtilAPIScoped.html
release: australia
...
For additional information on topic subscriptions, see [External event management via Telecommunications API notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/telecom-service-ops/telecommunications-api-notification.md).
...
Typically you will call this function within the [updateRegistrationResponse\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/TopicSubscriptionUtilAPIScoped.md) function.
...
For more information, see [executeRegistrationSubflow\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/TopicSubscriptionUtilAPIScoped.md).
