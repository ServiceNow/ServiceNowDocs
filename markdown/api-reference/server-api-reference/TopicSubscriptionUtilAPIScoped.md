...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/TopicSubscriptionUtilAPIScoped.html
release: xanadu
...
For additional information on topic subscriptions, see [Handling the external events using Telecommunications API notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/telecom-service-ops/telecommunications-service-operations-management/telecommunications-api-notification.md).
...
|Name|Type|Description|
|----|----|-----------|
|topicSubRefID|String|Sys\_id of the topic subscription record whose topic name to return. Located in the Topic Subscription \[sn\_api\_notif\_mgmt\_topic\_subscription\] table.|
...
Typically you will call this function within the [updateRegistrationResponse\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/TopicSubscriptionUtilAPIScoped.md) function.
...
For more information, see [executeRegistrationSubflow\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/TopicSubscriptionUtilAPIScoped.md).
