...
For additional information on topic subscriptions, see [Handling the external events using Telecommunications API notification](https://www.servicenow.com/docs/access?context=telecommunications-api-notification&version=xanadu&pubname=xanadu-telecom-service-ops&ft:locale=en-US).
