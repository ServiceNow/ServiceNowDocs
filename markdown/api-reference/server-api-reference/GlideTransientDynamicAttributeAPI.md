...
Value of the transient dynamic attribute's group name property.See also [Create a dynamic attribute group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/create-dynamic-attribute-group.md).
