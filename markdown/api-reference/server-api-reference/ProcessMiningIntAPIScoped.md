...
This script include requires the Process Mining plugin \(sn\_po\). For more information, see [Process Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/process-mining.md).
...
Mining state for the project.For descriptions of mining states, see [Mine states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/generate-process-map.md).
...
For more information, see [Automated improvement opportunities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/automated-findings.md).
