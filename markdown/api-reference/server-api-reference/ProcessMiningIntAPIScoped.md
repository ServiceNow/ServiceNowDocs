...
This script include requires the Process Mining plugin \(sn\_po\). For more information, see [Process Mining](https://www.servicenow.com/docs/access?context=process-mining&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
...
For more information about finding definitions and KPIs, see [Working with finding definitions](https://www.servicenow.com/docs/access?context=po-finding-definition&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US) and [Viewing business insights](https://www.servicenow.com/docs/access?context=view-business-findings&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
...
Mining state for the project.For descriptions of mining states, see [Mine states](https://www.servicenow.com/docs/access?context=generate-process-map&version=zurich&pubname=zurich-now-intelligence&section=extraction-states&ft:locale=en-US).
...
For more information, see [Automated improvement opportunities](https://www.servicenow.com/docs/access?context=automated-findings&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
