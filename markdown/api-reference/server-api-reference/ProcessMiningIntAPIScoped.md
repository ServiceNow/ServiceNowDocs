...
This script include requires the Process Mining plugin \(sn\_po\). For more information, see Process Mining.
...
Mining state for the project.For descriptions of mining states, see Mining states.
