...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/server-api-reference/SNEventSenderProviderAPI.html
release: zurich
...
Use the [IEventSender](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/server-api-reference/IEventSenderAPI.md) API to send the event to the ServiceNow instance. Use the [Event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/server-api-reference/EventAPI.md) API to add/update fields within an event.
