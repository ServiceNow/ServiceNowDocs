...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/ScopedCacheManagerAPI.html
release: yokohama
