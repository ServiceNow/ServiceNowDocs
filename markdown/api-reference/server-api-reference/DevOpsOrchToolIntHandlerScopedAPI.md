...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/DevOpsOrchToolIntHandlerScopedAPI.html
release: xanadu
...
A custom DevOps tool is any tool that doesn't have an integration with DevOps. For a list of tools that have DevOps integrations, see [DevOps Change Velocity integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/devops-change-velocity/dev-ops-overview.md).

This API enables the processing of payloads that are used by the REST endpoint [DevOps - POST /devops/tool/\{capability\}](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/devops-api.md). You must implement the methods of this API in a script include before calling the POST /devops/tool/\{capability\} endpoint.

This API executes in the `sn_devops` namespace. For more information about DevOps, see [DevOps Config](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/devops-family/devops-config-landing-page.md).
...
You must implement this method in a script include before calling the REST endpoint [DevOps - POST /devops/tool/\{capability\}](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/devops-api.md).
...
You must implement this method in a script include before calling [DevOps - POST /devops/tool/\{capability\}](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/devops-api.md).

|Name|Type|Description|
|----|----|-----------|
|toolName|String|Name of the tool. Located in the **Tool Name** field in the DevOps Tool Integration \[sn\_devops\_tool\_integration\] table.|

<table id="table_htf_1vm_ctb" class="returns"><thead><tr><th>
...
Flag that indicates whether this handler is valid for the specified tool.
