...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/HermesEventPublishOOBScopedAPI.html
release: xanadu
...
For additional information on how to implement this method, see [Configure the Producer Event Notification Framework to use the Hermes Messaging Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/developer-guides/prod_evt_not-dev_gd-cfg_herm_bus.md).
...
List of sys\_ids of the Kafka topics to which the message should be sent. Located in the Kafka Topic \[cmdb\_ci\_appl\_kafka\_topic\] table.For example:
