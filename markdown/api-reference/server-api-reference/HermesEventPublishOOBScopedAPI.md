...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/HermesEventPublishOOBScopedAPI.html
release: australia
...
For additional information on how to implement this method, see [Configure the Producer Event Notification Framework to use the Hermes Messaging Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/developer-guides/prod_evt_not-dev_gd-cfg_herm_bus.md).
