...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/GlideEvaluatorAPI.html
release: xanadu
...
To use the GlideScopedEvaluator\(\) method in a scoped application, use the corresponding scoped method: [GlideScopedEvaluator\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideEvaluatorScopedAPI.md).
...
To use the evaluateScript\(\) method in a scoped application, use the corresponding scoped method: [evaluateScript\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideEvaluatorScopedAPI.md).
...
To use the getVariable\(\) method in a scoped application, use the corresponding scoped method: [getVariable\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideEvaluatorScopedAPI.md).
...
To use the putVariable\(\) method in a scoped application, use the corresponding scoped method: [putVariable\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideEvaluatorScopedAPI.md).
