...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/c\_DurationCalculatorAPI.html
release: xanadu
...
Sys\_id of the schedule to set. Located in the Schedule \[cmn\_schedule\] table.
