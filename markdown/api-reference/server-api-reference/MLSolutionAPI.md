...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/MLSolutionAPI.html
release: yokohama
...
The methods in this object are instantiated using [MLSolutionFactory](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/MLSolutionFactoryAPI.md).
