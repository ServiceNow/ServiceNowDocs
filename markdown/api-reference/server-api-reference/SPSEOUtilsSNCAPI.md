...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/SPSEOUtilsSNCAPI.html
release: xanadu
...
ID of the Pages \[sp\_page\] record to return. Located in the **id** field of the Pages \[sp\_page\] table.
