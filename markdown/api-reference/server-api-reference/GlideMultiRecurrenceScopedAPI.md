...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/GlideMultiRecurrenceScopedAPI.html
release: yokohama
...
|----|----|-----------|
|grSchedule|[GlideRecord](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_GlideRecordScopedAPI.md)|GlideRecord object pointing to the record containing the job for which you want to get the schedule occurrences.|

|Type|Description|
|----|-----------|
|Array of [GlideDateTime](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_GlideDateTimeAPI.md) objects|GlideDateTime object for each time that the schedule job should run.|
