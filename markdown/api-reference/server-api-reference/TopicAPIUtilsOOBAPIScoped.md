...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/TopicAPIUtilsOOBAPIScoped.html
release: australia
...
Topic payload object passed into the [Event Management Topic Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/event_management_topic-api.md) endpoint.For example:
...
Warning messages to return in the [Event Management Topic Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/event_management_topic-api.md) endpoint response if the method encounters an issue at the level of "warning".This parameter allows you to add custom warning messages to your implementation of this endpoint.
...
For details on these parameters, see the return results for [Event Management Topic Open - POST /sn\_api\_notif\_mgmt/topic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/event_management_topic-api.md).
...
Schema to use to validate the topic payload. Use the [TopicAPIUtilsOOB - getCreateTopicSchema\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/TopicAPIUtilsOOBAPIScoped.md) method to obtain this schema.
...
Error/detail messages to return in the [Event Management Topic Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/event_management_topic-api.md) endpoint response if the method encounters an issue at the level of "error".This parameter allows you to add custom error messages to your implementation of this endpoint.
