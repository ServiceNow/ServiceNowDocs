...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/GlideSystemRunLevelAPIGlobal.html
release: xanadu
