...
Setting the system run level allows applications to change or limit their features based on operational toggles. For more information about using operational toggles, see [Operational toggles](https://www.servicenow.com/docs/access?context=operational-toggles&version=australia&pubname=australia-platform-administration&ft:locale=en-US).
