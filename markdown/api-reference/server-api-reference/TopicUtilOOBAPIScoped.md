...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/TopicUtilOOBAPIScoped.html
release: xanadu
...
Typically you will call this function within the [validateAndInsertTopic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/TopicUtilOOBAPIScoped.md) function that also performs various validations on the content.
