...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/TopicUtilOOBAPIScoped.html
release: australia
...
For additional information on topics, see [External event management via Telecommunications API notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/telecom-service-ops/telecommunications-api-notification.md).
...
Typically you will call this function within the [validateAndInsertTopic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/TopicUtilOOBAPIScoped.md) function that also performs various validations on the content.
