...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/SubflowScopedAPI.html
release: yokohama
...
This API is deprecated and replaced by the [FlowAPI - Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/ScriptableFlowAPI.md).
