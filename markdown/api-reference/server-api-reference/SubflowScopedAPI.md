...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/SubflowScopedAPI.html
release: xanadu
...
This API is deprecated and replaced by the [FlowAPI - Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/ScriptableFlowAPI.md).
