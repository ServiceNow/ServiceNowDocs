...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/GlideExcelParserScopedAPI.html
release: australia
...
[GlideScriptableInputStream](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/c_GlideScriptableInpStrmScopedAPI.md)

</td><td>

Excel document provided as an input stream. **Note:** Do not set this value if using the [setSource\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/GlideExcelParserScopedAPI.md) method to parse the same source multiple times.
...
|Name|Type|Description|
|----|----|-----------|
|inputStream|[GlideScriptableInputStream](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/c_GlideScriptableInpStrmScopedAPI.md)|Excel document provided as an input stream.|
