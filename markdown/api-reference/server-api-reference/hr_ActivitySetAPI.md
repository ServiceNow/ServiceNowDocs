...
For additional information, see [Understanding Enterprise Onboarding and Transitions](https://www.servicenow.com/docs/access?context=understanding-enterprise-onboarding-and-transitions&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).
