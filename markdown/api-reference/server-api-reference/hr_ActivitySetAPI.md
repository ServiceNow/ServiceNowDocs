...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/hr\_ActivitySetAPI.html
release: xanadu
...
For additional information, see [Understanding Enterprise Onboarding and Transitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/hr-service-delivery/understanding-enterprise-onboarding-and-transitions.md).
