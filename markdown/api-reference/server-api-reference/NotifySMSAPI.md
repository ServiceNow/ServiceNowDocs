...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/NotifySMSAPI.html
release: xanadu
...
|----|-----------|
|ScriptableFlowRunnerResult|[ScriptableFlowRunnerResult - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/ScriptableFlowRunnerResultScopedAPI.md) object.|
