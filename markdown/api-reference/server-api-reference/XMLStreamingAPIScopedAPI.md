...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/XMLStreamingAPIScopedAPI.html
release: xanadu
...
There is no constructor for this class. Instead, you must call the build\(\) method in the [XMLStreamingBuilder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/XMLStreamingBuilderScopedAPI.md) class to return an XMLStreamingAPI object.
...
You must associate an XML element's prefix with a namespace using [writeNamespace\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/XMLStreamingAPIScopedAPI.md).
