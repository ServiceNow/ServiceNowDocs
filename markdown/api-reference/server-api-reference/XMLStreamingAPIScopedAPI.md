...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/XMLStreamingAPIScopedAPI.html
release: australia
...
There is no constructor for this class. Instead, you must call the build\(\) method in the [XMLStreamingBuilder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/XMLStreamingBuilderScopedAPI.md) class to return an XMLStreamingAPI object.
...
You must associate an XML element's prefix with a namespace using [writeNamespace\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/XMLStreamingAPIScopedAPI.md).
