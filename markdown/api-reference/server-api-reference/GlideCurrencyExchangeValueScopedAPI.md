...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/GlideCurrencyExchangeValueScopedAPI.html
release: australia
...
There is no constructor for this class. Use the convert\(\) method from the [GlideCurrencyConverter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/GlideCurrencyConverterScopedAPI.md) API to return a GlideCurrencyExchangeValue object.
