...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/SimilaritySolutionStoreAPI.html
release: yokohama
...
|Name|Type|Description|
|----|----|-----------|
|name|String|Name of the [SimilaritySolution\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/SimilaritySolutionAPI.md) object to be deleted.|
...
|Type|Description|
|----|-----------|
|Object|[SimilaritySolution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/SimilaritySolutionAPI.md) object. Returns an error if the object does not exist.|

The following example shows how to get a solution object from the store using the get\(\) method and view its training status using the [SimilaritySolution - getActiveVersion\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/SimilaritySolutionAPI.md) and [SimilaritySolutionVersion - getStatus\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/SimilaritySolutionVersionAPI.md) methods.
