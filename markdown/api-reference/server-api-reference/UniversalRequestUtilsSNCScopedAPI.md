...
```
 ...
 Other fields not listed might be eligible for your use case. For a list of table fields and related fields in the system, view the [Data dictionary tables](https://www.servicenow.com/docs/access?context=c_DataDictionaryTables&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
Optional. Flag that indicates if the universal request has restricted access. Refer to [Universal Request roles and groups](https://www.servicenow.com/docs/access?context=ur-roles&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US).
