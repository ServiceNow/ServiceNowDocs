...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/UniversalRequestUtilsSNCScopedAPI.html
release: xanadu
...
For information, refer to [Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/universal-request-for-hr-service-delivery/ur-landing-limitedaccess.md).
...
Optional. Sys\_id of the group assigned to the resource. Located in the Group \[sys\_user\_group\] table.Default: Default assignment group is set per assignment rules.
...
Optional. Flag that indicates if the universal request has restricted access. Refer to [Universal Request roles and groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/universal-request-for-hr-service-delivery/ur-roles.md).
