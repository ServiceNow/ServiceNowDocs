...
For a list of the available OOB events, refer to [Workflow events in the base system](https://www.servicenow.com/docs/access?context=r_WorkflowEventsInTheBaseSystem&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
