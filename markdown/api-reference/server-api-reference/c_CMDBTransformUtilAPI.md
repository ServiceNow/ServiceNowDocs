...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/c\_CMDBTransformUtilAPI.html
release: xanadu
...
Use this method in onBefore transform map scripts to obtain errors. Use the [hasError\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_CMDBTransformUtilAPI.md) method to first detect any errors from the identifyAndReconcile\(\) or identifyAndReconcileEnhanced\(\) method.
