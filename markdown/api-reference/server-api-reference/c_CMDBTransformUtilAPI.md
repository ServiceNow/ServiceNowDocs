...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/c\_CMDBTransformUtilAPI.html
release: yokohama
...
Use this method in onBefore transform map scripts to obtain errors. Use the [hasError\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_CMDBTransformUtilAPI.md) method to first detect any errors from the identifyAndReconcile\(\) or identifyAndReconcileEnhanced\(\) method.
...
For additional information on Identification and Reconciliation and more detailed explanations of the data used by this method, see [Identification and Reconciliation \(IRE\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/ire.md).
