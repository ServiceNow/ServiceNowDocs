...
For additional information on Identification and Reconciliation and more detailed explanations of the data used by this method, see [Identification and Reconciliation \(IRE\)](https://www.servicenow.com/docs/access?context=ire&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
