...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/UriMatcherScopedAPI.html
release: australia
...
|----|-----------|
|[UriMatcherResponse](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/UriMatcherResponseScopedAPI.md)|UriMatcherResponse object with methods for returning detailed information about the match.|
