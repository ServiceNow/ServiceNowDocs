...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/DCManagerAPIScoped.html
release: xanadu
...
<table id="table_cgq_p5c_snb" class="returns"><thead><tr><th>
