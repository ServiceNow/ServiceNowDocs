...
Use these methods in server scripts to send a probe to the MID Server For more information, see [Create a JavaScript Probe activity](https://www.servicenow.com/docs/access?context=t_CreateAJavaScriptProbeActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
