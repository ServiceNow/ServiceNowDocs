...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/c\_SOAPMessageV2API.html
release: yokohama
...
-   [Direct SOAPMessageV2 example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/r_DirectSOAPMessageV2Example.md)
-   [Recordless SOAPMessageV2 example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/r_RecordlessSOAPMessageV2Example.md)
-   [Asynchronous SOAPMessageV2 example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/r_AsyncronousSOAPMessageV2Example.md)
-   [SOAPMessageV2 MID server example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/r_SOAPMessageV2MIDServerExample.md)
...
|Type|Description|
|----|-----------|
|[SOAPResponseV2](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_SOAPResponseV2API.md)|Response returned by the SOAP provider.|
...
**Note:** Before calling the getRequestBody\(\) method, you must call the [execute\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_SOAPMessageV2API.md) method to obtain the response object.
