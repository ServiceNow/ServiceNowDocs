...
This class is part of the [MetricBase](https://www.servicenow.com/docs/access?context=metricbase&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) application.
...
See also [MetricBase retention policies](https://www.servicenow.com/docs/access?context=metricbase-retention-policies&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
