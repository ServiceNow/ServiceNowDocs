...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/ProducerScopedAPI.html
release: yokohama
...
**Note:** This API is deprecated and replaced by the [ProducerV2 - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/ProducerV2ScopedAPI.md) API.
