...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/ProducerScopedAPI.html
release: australia
...
**Note:** This API is deprecated and replaced by the [ProducerV2 - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/ProducerV2ScopedAPI.md) API.
