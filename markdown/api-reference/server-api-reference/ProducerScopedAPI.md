...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/ProducerScopedAPI.html
release: xanadu
...
**Note:** This API is deprecated and replaced by the [ProducerV2 - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/ProducerV2ScopedAPI.md) API.
