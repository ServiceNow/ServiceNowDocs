...
To learn more about data stream actions, see [Data Stream actions and pagination](https://www.servicenow.com/docs/access?context=data-stream-actions&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
...
To learn more about overriding a Connections and Credentials alias, see [Supporting multiple connections](https://www.servicenow.com/docs/access?context=support-multiple-connections&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
