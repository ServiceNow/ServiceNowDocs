...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/ScriptableFlowRunnerScopedAPI.html
release: yokohama
...
-   [ScriptableFlowRunner - flow\(String scopedFlowName\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/ScriptableFlowRunnerScopedAPI.md)
-   [ScriptableFlowRunner - subflow\(String scopedSubflowName\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/ScriptableFlowRunnerScopedAPI.md)
...
|Type|Description|
|----|-----------|
|[ScriptableFlowRunner](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/ScriptableFlowRunnerScopedAPI.md)|Builder object used to run a Workflow Studio action, flow, or subflow.|
...
|Type|Description|
|----|-----------|
|[ScriptableFlowRunner - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/ScriptableFlowRunnerScopedAPI.md)|Builder object used to run a Workflow Studio action, flow, or subflow.|
...
To learn more about data stream actions, see [Data Stream actions and pagination](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/integration-hub/data-stream-actions.md).
...
-   [ScriptableFlowRunner - action\(String scopedActionName\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/ScriptableFlowRunnerScopedAPI.md)
-   [ScriptableFlowRunner - subflow\(String scopedSubflowName\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/ScriptableFlowRunnerScopedAPI.md)
...
To learn more about overriding a Connections and Credentials alias, see [Supporting multiple connections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/integration-hub/support-multiple-connections.md).
