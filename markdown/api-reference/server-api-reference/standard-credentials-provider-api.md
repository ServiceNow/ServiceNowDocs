...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/standard-credentials-provider-api.html
release: xanadu
...
This method is specifically for use with credential types. For information, see [Credential aliases for Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/connections-and-credentials/discovery-credential-alias.md).
...
|Name|Type|Description|
|----|----|-----------|
|sys\_id|String|Sys\_id of the credential record. Located in the Credentials \[discovery\_credentials\] table.|
