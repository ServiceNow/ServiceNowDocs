...
This method is specifically for use with credential types. For information, see [Credential aliases for Discovery](https://www.servicenow.com/docs/access?context=discovery-credential-alias&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
