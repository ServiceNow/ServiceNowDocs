...
This method is specifically for use with credential types. For information, see [Credential aliases for Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/discovery-credential-alias.md).
