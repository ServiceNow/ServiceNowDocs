...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/PdfMergeSignRequestorBothAPI.html
release: xanadu
...
This API creates a signature object that can be implemented in a PDF using [PDFGenerationAPI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/PDFGenerationAPIBothAPI.md).
