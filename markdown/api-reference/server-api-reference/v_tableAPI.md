...
-   [Create a script definition for a remote table](https://www.servicenow.com/docs/access?context=create-remote-table-script&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
-   [Lookup remote information in the system of record](https://www.servicenow.com/docs/access?context=fso-int_guide-agt_table_lookup&version=xanadu&pubname=xanadu-financial-services-operations&ft:locale=en-US)
