...
-   [Model categories](https://www.servicenow.com/docs/access?context=c_ModelCategories&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US)
-   [Product Instance feature in Hardware Asset Management](https://www.servicenow.com/docs/access?context=product-instance-for-assets&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US)
-   [Create an install base item](https://www.servicenow.com/docs/access?context=create-install-base-item&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)
...
See also [Product Instance feature in Hardware Asset Management](https://www.servicenow.com/docs/access?context=product-instance-for-assets&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).
...
The sys\_id of the model category in the Model Categories \[cmdb\_model\_category\] table. For information, see [Model categories](https://www.servicenow.com/docs/access?context=c_ModelCategories&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).
...
|modelCategorySysId|String|The sys\_id of the model category in the Model Categories \[cmdb\_model\_category\] table. For information, see [Model categories](https://www.servicenow.com/docs/access?context=c_ModelCategories&version=xanadu&pubname=xanadu-it-asset-management&ft:locale=en-US).|
