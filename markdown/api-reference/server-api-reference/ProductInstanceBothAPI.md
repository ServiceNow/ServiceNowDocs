...
-   [Model categories](https://www.servicenow.com/docs/access?context=c_ModelCategories&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US)
-   [Product Instance feature in Hardware Asset Management](https://www.servicenow.com/docs/access?context=product-instance-for-assets&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US)
...
See also [Product Instance feature in Hardware Asset Management](https://www.servicenow.com/docs/access?context=product-instance-for-assets&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US).
...
The sys\_id of the model category in the Model Categories \[cmdb\_model\_category\] table. For information, see [Model categories](https://www.servicenow.com/docs/access?context=c_ModelCategories&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US).
...
|modelCategorySysId|String|The sys\_id of the model category in the Model Categories \[cmdb\_model\_category\] table. For information, see [Model categories](https://www.servicenow.com/docs/access?context=c_ModelCategories&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US).|
