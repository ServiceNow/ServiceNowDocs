...
|Name|Type|Description|
|----|----|-----------|
|encodedQuery|String|An [encoded query string](https://www.servicenow.com/docs/access?context=c_EncodedQueryStrings&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).|
...
-   [Building and managing models to work with ERP data](https://www.servicenow.com/docs/access?context=work-with-erp-data-models&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
...
-   [Outbound message configuration fields](https://www.servicenow.com/docs/access?context=erp-canvas-add-new-outbound-message-configuration-fields&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
-   [Outbound message IDoc status for IDoc log tab fields](https://www.servicenow.com/docs/access?context=erp-canvas-outbound-message-idoc-status-for-idoc-log-tab-columns&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
