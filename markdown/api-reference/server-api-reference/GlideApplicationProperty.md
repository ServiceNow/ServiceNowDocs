...
For additional information on domain-specific application properties, see [Domain-separated application properties](https://www.servicenow.com/docs/access?context=ds-application-properties&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
