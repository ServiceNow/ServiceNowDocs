...
For additional information, see [Define Robust Transform Engine operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/system-import-sets/define-rte-operations.md).
...
Flag that indicates whether to enable verbose logging and the creation of import set rows for debugging.

 Valid values:

-   true: Enable logging and import set row creation.
-   false: Do not enable logging and import set row creation.
