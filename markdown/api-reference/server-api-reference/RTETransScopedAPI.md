...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/RTETransScopedAPI.html
release: yokohama
...
For additional information, see [Define Robust Transform Engine operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/define-rte-operations.md).
...
Sys\_id of the extract, transform, and load \(ETL\) definition to use for the transform.For information on creating an ETL, see [Create Extract Transform Load \(ETL\) definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/create-etl-definitions.md).
