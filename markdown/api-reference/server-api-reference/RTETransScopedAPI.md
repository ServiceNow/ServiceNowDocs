...
For additional information, see [Define Robust Transform Engine operations](https://www.servicenow.com/docs/access?context=define-rte-operations&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
