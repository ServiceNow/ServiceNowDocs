...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/GlideScriptedExtPtScopedAPI.html
release: xanadu
...
For more information on extension points, see [Using extension points to extend application functionality](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/extension-points.md).
...
|----|----|-----------|
|name|String|Name of the extension point for which to return the extension instances. Located in the Extension Instance \[sys\_extension\_instance\] table.|
