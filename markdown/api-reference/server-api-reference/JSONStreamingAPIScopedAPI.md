...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/JSONStreamingAPIScopedAPI.html
release: yokohama
...
To return the JSON object as a string, do not call the withAttachment\(\) method in the JSONStreamingBuilder class. See [JSONStreamingBuilder - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/JSONStreamingBuilderScopedAPI.md).
