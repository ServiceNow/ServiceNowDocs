...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/c\_CartJSScoped.html
release: xanadu
...
|Type|Description|
|----|-----------|
|String|Sys\_id of the user record for whom the cart is requested; located in the User \[sys\_user\] table.|

Returns the user sys\_id associated with the cart.
...
|Type|Description|
|----|-----------|
|String|Name of the user for whom the current cart is requested; located in the User \[sys\_user\] table.|
...
A JSON object that contains details of the cart to be submitted. ```
{
...
Sys\_id of the user who the order is requested for. Located in the User \[sys\_user\] table.Default: The current user.
