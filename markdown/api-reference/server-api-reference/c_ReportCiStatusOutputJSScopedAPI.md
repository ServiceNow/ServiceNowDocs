...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/c\_ReportCiStatusOutputJSScopedAPI.html
release: yokohama
...
The values returned by this method are used to calculate the value returned by the [getCiOperationStatus\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_ReportCiStatusOutputJSScopedAPI.md) method
