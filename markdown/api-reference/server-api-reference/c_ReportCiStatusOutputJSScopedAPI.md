...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/c\_ReportCiStatusOutputJSScopedAPI.html
release: xanadu
...
The values returned by this method are used to calculate the value returned by the [getCiOperationStatus\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_ReportCiStatusOutputJSScopedAPI.md) method
