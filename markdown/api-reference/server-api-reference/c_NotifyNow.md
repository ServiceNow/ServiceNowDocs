...
See also: [Advanced configuration for SMS](https://www.servicenow.com/docs/access?context=t_ConfigureNotifyforVoiceandSMS&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
