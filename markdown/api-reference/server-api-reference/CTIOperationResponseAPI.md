...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/CTIOperationResponseAPI.html
release: yokohama
...
The [CTIOperationResponse - setInteractionSysId\(String Id\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/CTIOperationResponseAPI.md) method must have been called prior to calling this method.
