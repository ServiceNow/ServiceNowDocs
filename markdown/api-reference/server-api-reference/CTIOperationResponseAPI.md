...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/CTIOperationResponseAPI.html
release: australia
...
The [CTIOperationResponse - setInteractionSysId\(String Id\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/CTIOperationResponseAPI.md) method must have been called prior to calling this method.
