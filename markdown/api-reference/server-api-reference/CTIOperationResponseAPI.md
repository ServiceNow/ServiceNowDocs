...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/CTIOperationResponseAPI.html
release: xanadu
...
The [CTIOperationResponse - setInteractionSysId\(String Id\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/CTIOperationResponseAPI.md) method must have been called prior to calling this method.
...
The sys\_id of the interaction record set on the CTIOperationResponse object. Interaction records are located in the Interaction \[interaction\] table.If the interaction record sys\_id is not set, the method returns null.
