...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/LeadAPIProcessUtilOOBAPI.html
release: australia
...
Request body of the lead and its related lead line items to create.For details on the contents of this object, see [lead - POST /sn\_lead\_mgmt\_core/lead](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/lead-api.md).
...
Object containing the query parameters to apply when retrieving the lead records. These are the query parameters passed in the [lead - GET /sn\_lead\_mgmt\_core/lead](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/lead-api.md) endpoint.For example:
...
Request body of the lead and its related lead line item fields to update.For details on the contents of this object, see [lead - PATCH /sn\_lead\_mgmt\_core/lead/\{sys\_id\}](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/lead-api.md).
