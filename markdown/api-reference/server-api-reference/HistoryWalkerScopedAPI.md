...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/HistoryWalkerScopedAPI.html
release: australia
...
**Note:** This method is not supported by the checkpoint walker implementation. Call the [HistoryWalker - walkTo\(String checkpoint\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/HistoryWalkerScopedAPI.md) method when using the checkpoint walker.
