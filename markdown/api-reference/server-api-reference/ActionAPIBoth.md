...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/ActionAPIBoth.html
release: xanadu
...
Use this API to configure UI actions with which users can interact. Use these scripts in the UI Action \[sys\_ui\_action\] table. For information, see [UI actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/t_EditingAUIAction.md).
...
GlideURI object representing the URI parameter of the user view.-   [GlideURI - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideURIScopedAPI.md)
...
|Name|Type|Description|
|----|----|-----------|
|gr|[GlideRecord](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideRecordScopedAPI.md)|GlideRecord of the page to be opened in the user view.|

|Type|Description|
|----|-----------|
|void| |

The following example shows how to include the caller name and incident description created from an interaction record. For more details, see [Customizing Configurable Workspace with declarative actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/declarative-actions-landing.md).
...
-   [Create a UI routing action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/scripts/useful-client-side-scripts.md)
-   [Create knowledge articles from HR cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/knowledge-management/ui-action-hrcase-article.md)
-   [Task relationships with UI actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/table-administration-and-data-management/r_UIActions.md)

|Name|Type|Description|
|----|----|-----------|
|URL|Object|URL to set as the redirect. You can provide the URL as a string or a [GlideRecord](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideRecordScopedAPI.md). If you pass the URL as a GlideRecord, this value takes the focus to that record's form.|

|Type|Description|
|----|-----------|
|void| |

The following example shows how to redirect a user to a URL from a UI action using the [current](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/scripts/c_ScriptableServiceCatalogVariables.md) variable.
...
|Name|Type|Description|
|----|----|-----------|
|URL|Object|URI to set as the return location after a UI action is complete. You can provide the URL as a string or a [GlideRecord](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_GlideRecordScopedAPI.md).|

|Type|Description|
|----|-----------|
|void| |

The following example enables the user to select the UI action to create a change record using information from the problem record and the change template. After the change, the user returns to [current](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/scripts/c_ScriptableServiceCatalogVariables.md) view. For more information, see [Scripted templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/r_ScriptedTemplates.md). For more use cases, see [Task relationships with UI actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/table-administration-and-data-management/r_UIActions.md).
