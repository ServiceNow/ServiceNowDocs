...
The passed in event schedule information is stored in the Events \[sysevent\] table. For additional information on events, see [Events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/events.md).
...
For additional information about the Message table, see [Message table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/r_MessageTable.md).
