...
The passed in event schedule information is stored in the Events \[sysevent\] table. For additional information on events, see [Events](https://www.servicenow.com/docs/access?context=events&version=australia&pubname=australia-build-workflows&ft:locale=en-US).
