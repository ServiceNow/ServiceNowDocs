...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/c\_GlideOAuthToken.html
release: australia
...
This example code shows how to retrieve access and refresh tokens from the instance database. See also [GlideOAuthClient](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/c_GlideOAuthClient.md).
...
</table>This example code shows how to retrieve access and refresh tokens from the instance database. See also [GlideOAuthClient](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/c_GlideOAuthClient.md).
