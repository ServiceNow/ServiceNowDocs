...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/c\_RESTResponseV2API.html
release: australia
...
**Note:** To retrieve the contents of the actual error message, use the [getBody\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/c_RESTResponseV2API.md) method.
