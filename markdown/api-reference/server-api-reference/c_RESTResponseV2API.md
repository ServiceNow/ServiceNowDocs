...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/c\_RESTResponseV2API.html
release: xanadu
...
**Note:** To retrieve the contents of the actual error message, use the [getBody\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_RESTResponseV2API.md) method.
