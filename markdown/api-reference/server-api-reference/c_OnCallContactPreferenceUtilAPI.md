...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/c\_OnCallContactPreferenceUtilAPI.html
release: yokohama
...
For contact preference configuration, see [Configure contact preferences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/on-call-scheduling/config-my-contact-prefs-oncall.md).

This script include supports the [OnCallRotation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_OnCallRotationAPI.md) script include.
...
Mandatory. Escalatee object returned by the [getEscalationPlan\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/c_OnCallRotationAPI.md) method.
