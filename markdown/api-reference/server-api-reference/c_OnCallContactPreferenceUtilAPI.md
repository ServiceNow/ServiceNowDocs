...
For contact preference configuration, see [Configure contact preferences](https://www.servicenow.com/docs/access?context=config-my-contact-prefs-oncall&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
