...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/SystemDocumentListBothAPI.html
release: xanadu
...
To create or manage a document list, use the [DocumentListService API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/DocumentListServiceBothAPI.md).
...
The following example shows how to add a description to the document list. See also [DocumentListService API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/DocumentListServiceBothAPI.md).
...
The following example shows how to rename an existing document list. See also [DocumentListService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/DocumentListServiceBothAPI.md).
