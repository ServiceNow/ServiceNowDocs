...
This API requires the Remote Tables plugin \(com.glide.script.vtable\) to be activated. For more information, see Create script definitions for a remote table.
