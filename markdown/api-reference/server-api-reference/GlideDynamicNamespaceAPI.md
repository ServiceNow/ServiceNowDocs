...
This API provides methods that enable you to get dynamic schema values defined in the Dynamic Namespace \[dynamic\_namespace\] table. For more details on dynamic namespaces, see Dynamic Schema.
