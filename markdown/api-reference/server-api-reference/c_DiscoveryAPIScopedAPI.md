...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/c\_DiscoveryAPIScopedAPI.html
release: xanadu
...
|Type|Description|
|----|-----------|
|array|JavaScript array of immutable [ReportCiStatusOutputJS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/c_ReportCiStatusOutputJSScopedAPI.md) objects.|
