...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/server-api-reference/QueueScopedAPI.html
release: xanadu
...
Before calling this method, you must call the [Scoped Queue - get\(String sysID\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/QueueScopedAPI.md) method to retrieve the chat queue to which to attach the current user.
