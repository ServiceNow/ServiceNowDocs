...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/server-api-reference/QueueScopedAPI.html
release: australia
...
Before calling this method, you must call the [Scoped Queue - get\(String sysID\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/QueueScopedAPI.md) method to retrieve the chat queue to which to attach the current user.
