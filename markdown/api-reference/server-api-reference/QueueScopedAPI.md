...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/server-api-reference/QueueScopedAPI.html
release: yokohama
...
Before calling this method, you must call the [Scoped Queue - get\(String sysID\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/QueueScopedAPI.md) method to retrieve the chat queue to which to attach the current user.
