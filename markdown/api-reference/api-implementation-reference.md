...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/api-implementation-reference.html
release: yokohama
topic_type: concept
...
[API implementation \[Omitted image "bus-integration-and-apis.svg"\] Alt text: Set up Web Services to access ServiceNow APIs.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/api-implementation.md)

</td><td>

[API reference \[Omitted image "bus-learn.svg"\] Alt text: Find reference documentation for Client, Server, and REST APIs.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/api-reference.md)

</td><td>

[Developer guides \[Omitted image "bus-application-developer.svg"\] Alt text: Explore program resources for learning, building, and developing.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/developer-guides/developer-guides.md)
