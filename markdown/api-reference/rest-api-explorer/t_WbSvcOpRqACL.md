...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/rest-api-explorer/t\_WbSvcOpRqACL.html
release: zurich
...
breadcrumb: [Configure a scripted REST API to require an ACL, Create, Scripted REST APIs, REST APIs, Web services, API implementation, API implementation and reference]
---
...
**Parent Topic:**[Configure a scripted REST API to require an ACL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/rest-api-explorer/t_WbSvcRqACL.md)
