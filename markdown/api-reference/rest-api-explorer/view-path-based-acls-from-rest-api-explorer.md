...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/rest-api-explorer/view-path-based-acls-from-rest-api-explorer.html
release: australia
...
3.  Select the menu icon \(\[Omitted image "menu-icon.png"\] Alt text:\).
...
**Parent Topic:**[View path-based ACLs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-api-explorer/view-path-based-acls.md)
