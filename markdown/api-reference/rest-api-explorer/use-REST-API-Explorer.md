...
-   **[Access the REST API Explorer](../task/t_GetStartedAccessExplorer.md)**  
View available REST API resources using the REST API Explorer.
-   **[Create an incident record](../task/t_GetStartedCreateInt.md)**  
Use a POST request to create a new record.
-   **[Read the inserted incident](../task/t_GetStartedReadInt.md)**  
Use a GET request to view a record.
-   **[Retrieve existing incidents](../task/t_GetStartedRetrieveExisting.md)**  
Use a GET request to view existing incident records.
-   **[Update the incident](../task/get-started-update-incident.md)**  
Update the incident record using either a PUT or PATCH function.
-   **[Delete the incident](../task/t_GetStartedDeleteInt.md)**  
Delete the incident using a DELETE request.
-   **[Explore the REST API for a table](../task/explore-rest-api-for-table.md)**  
...
-   **[Export to OpenAPI specification](../task/export-openapi-specification.md)**  
