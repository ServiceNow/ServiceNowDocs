...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/rest-api-explorer/t\_GetStartedRetrieveExisting.html
release: yokohama
...
2.  Click **Retrieve records from a table \(GET\)**.
    ...
    For more information about this API endpoint, see [Table - GET /now/table/\{tableName\}](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/rest-apis/c_TableAPI.md).
