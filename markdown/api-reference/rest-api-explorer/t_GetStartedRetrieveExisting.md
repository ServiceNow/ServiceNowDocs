...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/rest-api-explorer/t\_GetStartedRetrieveExisting.html
release: xanadu
...
2.  Click **Retrieve records from a table \(GET\)**.
    ...
    For more information about this API endpoint, see [Table - GET /now/table/\{tableName\}](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/c_TableAPI.md).
