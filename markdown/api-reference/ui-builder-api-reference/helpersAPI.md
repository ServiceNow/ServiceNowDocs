...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/ui-builder-api-reference/helpersAPI.html
release: xanadu
...
**Parent Topic:**[UIB API reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/ui-builder-api-reference/api-uib.md)
...
You can use this method with the [api - setState\(String stateParam, Any value\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/ui-builder-api-reference/apiAPI.md) to bind the translated value to other fields on the page.
