...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/ui-builder-api-reference/helpersAPI.html
release: zurich
...
You can use this method with the [api - setState\(String stateParam, Any value\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/ui-builder-api-reference/apiAPI.md) to bind the translated value to other fields on the page.
