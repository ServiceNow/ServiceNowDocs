...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/business-rules-classic/c\_BusinessRules.html
release: australia
...
-   onBefore
-   onDisplay
 For more information and examples, see [Example business rule scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/business-rules-classic/c_BusinessRules.md).
...
|*gs*|References to [GlideSystem](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/c_GlideSystemScopedAPI.md) functions.|
