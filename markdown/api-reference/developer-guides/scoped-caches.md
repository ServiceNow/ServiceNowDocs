...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/developer-guides/scoped-caches.html
release: xanadu
...
This guide includes instructions for creating a scoped cache and table pair to use with the [ScopedCacheManager API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/ScopedCacheManagerAPI.md).
