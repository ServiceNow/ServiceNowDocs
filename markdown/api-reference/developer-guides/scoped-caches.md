...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/scoped-caches.html
release: yokohama
...
This guide includes instructions for creating a scoped cache and table pair to use with the [ScopedCacheManager API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/server-api-reference/ScopedCacheManagerAPI.md).
