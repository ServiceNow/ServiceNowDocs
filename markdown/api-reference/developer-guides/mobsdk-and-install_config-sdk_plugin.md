...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/mobsdk-and-install\_config-sdk\_plugin.html
release: yokohama
...
1.  Navigate to the Mobile SDK page on the ServiceNow Store web site.
    ...
    For details, see [Install a ServiceNow Store application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_InstallApplications.md).
