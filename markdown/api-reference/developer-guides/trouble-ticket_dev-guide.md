...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/trouble-ticket\_dev-guide.html
release: yokohama
...
This developer guide provides information on how to extend the [Trouble Ticket Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/rest-apis/trouble-ticket-open-api.md) to make various customizations.
