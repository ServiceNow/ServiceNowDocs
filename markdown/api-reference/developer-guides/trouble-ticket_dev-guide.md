...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/developer-guides/trouble-ticket\_dev-guide.html
release: australia
...
This developer guide provides information on how to extend the [Trouble Ticket Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/rest-apis/trouble-ticket-open-api.md) to make various customizations.
