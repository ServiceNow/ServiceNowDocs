...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/service-order\_dev-guide.html
release: yokohama
...
This developer guide provides information on how to extend the [Service Order Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/rest-apis/service-order-open-api.md) to make various customizations.
