...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/mobsdk-ios-write\_options.html
release: yokohama
...
You configure field write options using the [FieldWriteOptions class - iOS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/FieldWriteOptionsiOSStruct.md) structure. This structure enables you to configure:

-   Whether to suppress automatic generation of system fields.
-   Whether to set field values using their [display value](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/c_DisplayValues.md)[display value](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/c_DisplayValues.md) rather than their actual value.
