...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/developer-guides/mobsdk-ios-write\_options.html
release: australia
...
You configure field write options using the [FieldWriteOptions class - iOS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/cllent-mobile-api-reference/FieldWriteOptionsiOSStruct.md) structure. This structure enables you to configure:
