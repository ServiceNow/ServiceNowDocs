...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/developer-guides/event-mgmt-notif\_dev-guide.html
release: xanadu
...
-   [`TMFTopicEventAPIUtilOOB`](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/server-api-reference/tmftopiceventapiutiloobScopedAPI.md): Contains functions to handle API requests that are triggered by [external trigger definition flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/set-up-flow-ihub.md) that have the actions `AlarmCreateNotification`, `AlarmChangeNotification`, `AlarmDeleteNotification` which create, update, and delete events.
