...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/developer-guides/prod\_evt\_not-dev\_gd-cfg\_open\_bus.html
release: australia
...
2.  Customize the [OpenMessageBusEventPublisherOOB - publishMessageToComptibleRestProxy\(Object tmfEventPayload, Array compatibleTopicArr\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/server-api-reference/OpenMsgBusEvtPubScopedAPI.md) method to send messages directly to a preconfigured REST action.
