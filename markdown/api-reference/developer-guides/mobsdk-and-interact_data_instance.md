...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/developer-guides/mobsdk-and-interact\_data\_instance.html
release: xanadu
...
For additional code examples using the available NowTableService methods, refer to the [NowTableService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/NowTableServiceAndroidInterface.md) API documentation.
