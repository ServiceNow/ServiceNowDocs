...
1.  Download the Mobile SDK Android library, called NowSDK, from the ServiceNow Store.
    ...
    For details on installing applications on your instance, see [Administering applications](https://www.servicenow.com/docs/access?context=administering-applications&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
