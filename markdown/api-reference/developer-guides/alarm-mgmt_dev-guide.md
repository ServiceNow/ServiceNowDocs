...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/developer-guides/alarm-mgmt\_dev-guide.html
release: xanadu
...
This developer guide provides information on how to extend the [Alarm Management Open API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/alarm-open-api.md) to make various customizations.
