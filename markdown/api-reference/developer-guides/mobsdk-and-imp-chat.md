...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/mobsdk-and-imp-chat.html
release: yokohama
...
You use the [NowChatSDK](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowChatSDKAndroidAPI.md) API to create the chat service. Once the service is created, you must then start the chat user interface.
