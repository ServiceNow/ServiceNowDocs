...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/developer-guides/prd\_evt\_not-dev\_gd-add\_bus\_rule.html
release: xanadu
...
For details on creating a business rule, see [Create a business rule for your service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/universal-request-for-hr-service-delivery/ur-create-busrule-service.md).
