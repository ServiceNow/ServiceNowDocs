...
-   NowAnalytics
    ...
    -   Primary APIs:
        -   [NowAnalyticsService](../../../../../app-store/dev_portal/API_reference/MobileSDKiOS/NowAnalyticsService/concept/NowAnalyticsServiceiOSProtocol.md#): This API provides functionality to gather user analytics data and store it within the ServiceNow platform for later analysis and tracking.
-   NowChat

    Enables you to embed a native [Virtual Agent](https://www.servicenow.com/docs/access?context=virtual-agent-landing-page&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US) chat window in your applications. This service includes UI/UX features.

    -   Primary APIs:
        -   [NowChatService](../../../../../app-store/dev_portal/API_reference/MobileSDKiOS/NowChatService/concept/NowChatServiceiOSAPI.md#): This API provides Virtual Agent and Live Agent chat capabilities to your iOS applications. Leverage the full-service chat capabilities provided by the ServiceNow platform by simply implementing NowChatService within your application.
-   NowPush
...
-   NowWeb
    ...
    -   Primary APIs:
        -   [NowWebService](../../../../../app-store/dev_portal/API_reference/MobileSDKiOS/NowWebService/concept/NowWebServiceiOSAPI.md#): This API provides functionality that enables the browsing of web pages on your ServiceNow instance.
