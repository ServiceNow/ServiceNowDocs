...
For additional information, see [NowChatConfiguration - Android](../../../../../app-store/dev_portal/API_reference/MobileSDKAndroid/NowChatOptions/concept/NowChatOptionsAndroid.md#) and [NowChatService - start\(activity: Activity, themeColors: NowChatTheme = object: NowChatTheme\{\}, contextData: Map&lt;String, Any&gt; = mapOf\(\), chatConfiguration: NowChatConfiguration? = null\)](../../../../../app-store/dev_portal/API_reference/MobileSDKAndroid/NowChatService/concept/NowChatServiceAndroidAPI.md#).
