...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/mobsdk-ios-setup-push-app.html
release: yokohama
...
For additional information on the NowPush.makePushService\(\) method, refer to [NowPush API - iOS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowPushiOSAPI.md).
