...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/developer-guides/mobsdk-ios-setup-push-app.html
release: australia
...
For additional information on the NowPush.makePushService\(\) method, refer to [NowPush API - iOS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/cllent-mobile-api-reference/NowPushiOSAPI.md).
