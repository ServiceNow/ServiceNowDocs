...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/developer-guides/mobsdk-ios-init-nowsdk-in-app.html
release: xanadu
...
\[Omitted image "mobsdk-init-diagram.png"\] Alt text: MobileSDK integration flow diagram
