...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/mobsdk-and-write\_options.html
release: yokohama
...
You configure field write options using the [FieldWriteOptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/FieldWriteOptionsAndroidAPI.md) API. This interface enables you to configure:
