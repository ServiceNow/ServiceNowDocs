...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/mobsdk-ios-down-install-sdk-libs.html
release: yokohama
...
2.  Download the Mobile SDK iOS library, called NowKit from the ServiceNow Store.
    ...
    For details on installing applications on your instance, see [Administering applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/administering-applications.md).
