...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/developer-guides/mobsdk-ios-display-web-pages.html
release: australia
...
The following example shows how to create a [NowWebViewController](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/cllent-mobile-api-reference/NWebViewControlleriOSAPI.md) view:
