...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/mobsdk-ios-display-web-pages.html
release: yokohama
...
The following example shows how to create a [NowWebViewController](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NWebViewControlleriOSAPI.md) view:
