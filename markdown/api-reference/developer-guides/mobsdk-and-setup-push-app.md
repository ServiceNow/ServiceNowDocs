...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/developer-guides/mobsdk-and-setup-push-app.html
release: xanadu
...
For additional information on the NowPushSDK.makePushService\(\) method, refer to [NowPushSDK - makePushService\(instanceURL: URL\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/NowPushSDKAndroidAPI.md).
