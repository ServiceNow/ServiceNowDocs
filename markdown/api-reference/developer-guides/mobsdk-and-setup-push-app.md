...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/mobsdk-and-setup-push-app.html
release: yokohama
...
For additional information on the NowPushSDK.makePushService\(\) method, refer to [NowPushSDK - makePushService\(instanceURL: URL\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowPushSDKAndroidAPI.md).
