...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/developer-guides/mobsdk-and-paginate\_return\_records.html
release: yokohama
...
[NowTableService - paginator\(tableName: String, configuration: FetchConfiguration\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowTableServiceAndroidInterface.md)
