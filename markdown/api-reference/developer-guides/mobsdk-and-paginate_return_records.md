...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/developer-guides/mobsdk-and-paginate\_return\_records.html
release: xanadu
...
[NowTableService - paginator\(tableName: String, configuration: FetchConfiguration\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/NowTableServiceAndroidInterface.md)
