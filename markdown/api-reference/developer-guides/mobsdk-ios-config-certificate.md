...
1.  If not already configured, configure your ServiceNow instance as an OAuth JWT provider.
    ...
    For details, see [Create an OAuth JWT API endpoint for external clients \(machine to machine integration\)](https://www.servicenow.com/docs/access?context=create-jwt-endpoint&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
...
3.  Select **New** and then create a new public certificate as shown in the following image.
    ...
    For details on creating this certificate, see [Update your X.509 certificate](https://www.servicenow.com/docs/access?context=update-cert-whois&version=xanadu&pubname=xanadu-security-management&ft:locale=en-US).
