...
4.  Select a type associated with the field value \(for example, `Integer`\) from the **Type** menu.
    ...
    **Note:** For a list of valid types, see [Field types](https://www.servicenow.com/docs/access?context=r_FieldTypes&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
7.  Add a column of the same name and type to the Invoice \[sn\_shop\_invoice\] table.
    ...
    **Note:** For more information on columns and fields, see [Field administration](https://www.servicenow.com/docs/access?context=c_IntroductionToFields&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
