...
7.  [Map custom fields to a payload source format](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/developer-guides/apInvoice-dev-guide.md).
...
5.  Provide a name \(JSON property\) or path \(cXML attribute or element\) for the payload entry in the **Source field** field.
    ...
    You can view the Invoice integration field mapping \[sn\_spend\_intg\_invoice\_intg\_field\_mapping\] table for examples of cXML path settings.
...
See also [AP Invoice – POST sn\_spend\_intg/ap\_invoice/cxml](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/ap-invoice-api.md).
