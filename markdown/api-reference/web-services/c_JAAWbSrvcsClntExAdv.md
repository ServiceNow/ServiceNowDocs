...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/c\_JAAWbSrvcsClntExAdv.html
release: yokohama
...
-   Verify that the correct JRE is specified.
    ...
    -   If using the Axis2 Codegen plugin use default JRE.
        ...
        \[Omitted image "JavaProject.png"\] Alt text:
...
**Parent Topic:**[Java Apache Axis2 web services client examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/c_JAAWbSrvcsClntEx.md)
