...
-   Location: [Add glide.processor.json.row\_limit to the system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_AddAPropertyUsingSysPropsList.md) `[sys_properties]` table
