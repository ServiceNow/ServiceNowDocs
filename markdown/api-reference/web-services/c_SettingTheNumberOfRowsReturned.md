...
-   Location: [Add glide.processor.json.row\_limit to the system properties](https://www.servicenow.com/docs/access?context=r_AvailableSystemProperties&version=australia&pubname=australia-platform-administration&section=t_AddAPropertyUsingSysPropsList&ft:locale=en-US) `[sys_properties]` table
