...
locale: en-us
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/connect-dbvisualizer-jdbc.html
release: zurich
...
5.  Select the **+** icon to create a connection.
    ...
    \[Omitted image "sql-api-dbvisualizer-4.png"\] Alt text:
