...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/web-services/t\_CreateAnODBCUser.html
release: xanadu
...
**Previous topic:**[Getting started with ODBC](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/c_GettingStartedWithODBC.md)

**Next topic:**[Define an ACL rule for the odbc role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_DefineAnACLRuleForTheODBCRole.md)
