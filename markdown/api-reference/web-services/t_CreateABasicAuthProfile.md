...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/web-services/t\_CreateABasicAuthProfile.html
release: australia
...
breadcrumb: [Configure a message with basic auth, Outbound REST authentication, REST, Outbound, Web services, API implementation, API implementation and reference]
---
...
**Parent Topic:**[Configure a REST message with basic auth](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/web-services/t_ConfigureRESTMsgBasicAuth.md)
