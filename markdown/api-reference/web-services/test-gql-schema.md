...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/test-gql-schema.html
release: yokohama
...
Create a schema for your GraphQL API. For more information, see [Create a GraphQL schema](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/build-graphql-scripted-schema.md).
...
3.  In the editor, enter a query to the schema.
    ...
    Include both the application and schema namespaces in the query. For information about directives you can apply, see [Directives and global functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/scripted-graph-ql.md).
