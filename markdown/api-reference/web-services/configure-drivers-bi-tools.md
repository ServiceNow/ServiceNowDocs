...
Before connecting third-party tools to the Live Connect drivers, confirm that you have completed the following:

-   The Live Connect plugin is installed on your ServiceNow instance.
-   The Live Connect is configured on your instance, including Service Account creation, ACL configuration, and IP filter setup.
...
-   All connections are read-only. Third-party tools cannot modify ServiceNow data through the Live Connect.
...
While Power BI Desktop and DB Visualizer are specifically documented examples in this guide, the Live Connect drivers support any ODBC or JDBC-compatible application. Other commonly used tools include:
