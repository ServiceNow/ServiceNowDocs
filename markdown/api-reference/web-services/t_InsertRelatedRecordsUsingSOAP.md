...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/t\_InsertRelatedRecordsUsingSOAP.html
release: yokohama
...
\[Omitted image "HierarchicalIncident.png"\] Alt text:

And `u_comment_items` is created as a related list for `u_custom_comments`:

\[Omitted image "HierarchicalCustomComments.png"\] Alt text:

-   **[WSDL Schema with related records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/r_WSDLSchemaWithRelatedRecords.md)**  
...
-   **[Hierarchical SOAP Message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/r_HierarchicalSOAPMessage.md)**  
