...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/t\_InsertRelatedRecordsUsingSOAP.html
release: zurich
...
For example, when a related list is created for the incident table called `u_custom_comments`, `u_comment_items` is created as a related list for `u_custom_comments`:

-   **[WSDL Schema with related records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/r_WSDLSchemaWithRelatedRecords.md)**  
...
-   **[Hierarchical SOAP Message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/r_HierarchicalSOAPMessage.md)**  
