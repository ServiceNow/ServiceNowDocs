...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/additional-integration-resources.html
release: zurich
...
-   **[Manage connection pooling](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/r_HTTPClientConnectionManagement.md)**  
...
-   **[Create data sources from other apps using ODBC driver](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_ODBCDriver.md)**  
...
-   **[Understanding domain separation and web services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/domain-separation-web-services.md)**  
...
-   **[Analyze REST and SOAP API usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_APIAnalytics.md)**  
REST and SOAP API analytics allow you to track and analyze web service API usage.
-   **[Monitor inbound API integration usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/inbound-api-integration-usage-dashboard.md)**  
