...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/t\_CreateANewWS-SecurityProfile.html
release: yokohama
...
3.  Fill in the WS-Security Profile form \(see table\).
    ...
    \[Omitted image "WS-SecurityProfile.png"\] Alt text: WS-Security Profile
...
[WS-Security](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/c_SOAPWebService.md)

[WS-Security profiles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/c_SOAPWebService.md)
