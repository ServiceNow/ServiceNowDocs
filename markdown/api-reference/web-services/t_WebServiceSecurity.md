...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/t\_WebServiceSecurity.html
release: zurich
...
breadcrumb: [Security, SOAP, Outbound, Web services, API implementation, API implementation and reference]
---
