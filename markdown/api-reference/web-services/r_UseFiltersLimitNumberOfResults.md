...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/r\_UseFiltersLimitNumberOfResults.html
release: yokohama
...
breadcrumb: [SOAP strategies, Retrieve a large number of records using SOAP, Inbound web service examples, Inbound web services, Web services, API implementation, API implementation and reference]
---
...
**Parent Topic:**[SOAP strategies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/c_SOAPStrategies.md)
