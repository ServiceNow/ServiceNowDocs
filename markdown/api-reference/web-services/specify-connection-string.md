...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/web-services/specify-connection-string.html
release: xanadu
...
This is an alternative method of connecting with different instance URLs. See also [Create a new DSN](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_CreatingANewDSN.md).
