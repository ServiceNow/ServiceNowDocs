...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/c\_OutboundRESTMutualAuthentication.html
release: yokohama
...
**Note:** For information about mutual authentication for inbound web services, see [Certificate-based authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/certificate-based-authentication/certificate-based-authentication.md).

For information about using a custom HTTPS protocol profile to enable mutual authentication, see [Create a protocol profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/t_CreateAProtocolProfile.md).

**Parent Topic:**[Outbound REST authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/c_OutboundRESTAuth.md)
