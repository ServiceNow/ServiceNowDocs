...
-   [REST APIs](../../inbound-rest/concept/c_RESTAPI.md)
-   [Scripted REST APIs](../../custom-web-services/concept/c_CustomWebServices.md)
-   [Query record data using the GraphQL API framework](../../graphql/concept/scripted-graph-ql.md)
-   [SOAP web service](../../inbound-soap/concept/c_SOAPWebService.md)
-   [JSONv2 web service](../../inbound-other-web-services/concept/c_JSONv2WebService.md)
-   [RSS web service](../../rss/topic/p_RSS.md)
-   [Scripted SOAP web services](../../inbound-soap/concept/c_ScriptedWebServices.md)
