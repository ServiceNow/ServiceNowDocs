---
title: Configure Live Connect plugin on your ServiceNow instance
description: Overview of the three-step configuration process required to enable Live Connect access including prerequisites and expected outcomes.
locale: en-us
...
# Configure Live Connect plugin on your ServiceNow instance
...
Configuring the Live Connect on your instance enables you to integrate your ServiceNow data with external BI tools and analytics platforms such as Power BI, DB Visualizer, or custom ODBC/JDBC clients, enhancing your reporting and data analysis capabilities.
...
-   Turn off MFA: Non-interactive \(Machine\) users cannot complete MFA challenges. Confirm that MFA is turned off for all Live Connect Service Accounts.
