...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/c\_OutboundSOAPSecurity.html
release: yokohama
...
-   **[Enable basic authentication for outbound SOAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/t_BasicAuthentication.md)**  
If the endpoint requires a user name and password, you can provide credentials using basic authentication.
-   **[Enable WS-Security for outbound SOAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/t_WebServiceSecurity.md)**  
