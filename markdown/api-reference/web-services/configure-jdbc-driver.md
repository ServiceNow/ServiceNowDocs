...
-   You have downloaded the ServiceNow SQL API JDYou have valid client machine. See [Download the SQL API drivers on client machine](download-sql-api-drivers.md) for more information.
