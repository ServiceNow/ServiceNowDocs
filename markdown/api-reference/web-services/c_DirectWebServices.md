...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/web-services/c\_DirectWebServices.html
release: zurich
...
-   **[Use forms to limit or extend the query response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/using-forms-limit-extend-query-resp.md)**  
On occasion, there is a need to limit the number of field values that a SOAP query returns.
-   **[Return the display value for reference variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/return-display-reference-variables.md)**  
...
-   **[Clear values from a target instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/clearing-values-target.md)**  
You can pass an empty value through a SOAP parameter to clear the respective value in the target instance.
-   **[Retrieve journal entries using direct web services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/retrieving-journal-entries.md)**  
...
-   **[Retrieve choice fields using direct web services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/retrieving-choice-fields-direct-ws.md)**  
To retrieve or set choice fields, use the choice **Value**, not the **Label**.
-   **[Persist an HTTP session across all SOAP calls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/persist-session-all-soap-calls.md)**  
...
-   **[SOAP direct web service API functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/r_DirectWebServiceAPIFunctions.md)**  
...
[SOAP web service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/web-services/c_SOAPWebService.md)
