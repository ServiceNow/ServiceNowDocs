...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/t\_CreateStaticWSDLScriptWebService.html
release: yokohama
...
-   **[Scripted web service example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/r_StaticWSDLScriptedWebService.md)**  
This example demonstrates the processing script for the FakeStockValue web service.

**Parent Topic:**[Create a scripted SOAP web service using a static WSDL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/createSOAPwebserviceStaticWSDL.md)
