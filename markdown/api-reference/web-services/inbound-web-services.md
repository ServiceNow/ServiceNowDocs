...
-   **[Exporting and converting records into complex data types](../../inbound-soap/reference/store-retrieve-records-complex-data-type.md)**  
Use URL parameters to export table records and convert them into complex data types, such as JSON, XML, PDF, CSV, and XLS.
-   **[Inbound web service examples](../../examples/concept/c_InboundWebServiceExamples.md)**  
Inbound web service examples demonstrate how to access ServiceNow web services.

**Parent Topic:**[Web services](../reference/r_AvailableWebServices.md)
