...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/web-services/r\_AttachmentCreatorSOAPWebService.html
release: xanadu
...
**Important:** The AttachmentCreator SOAP web service is not recommended. Instead, use the REST [Attachment API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/rest-apis/c_AttachmentAPI.md) to manage attachments with web services.
