...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/t\_TestingTheODBCDriver.html
release: yokohama
...
3.  Click **Configure**.
    ...
    \[Omitted image "ServiceNowDataSource.png"\] Alt text: ServiceNow system data source

4.  Click **Test Connect** in the ODBC driver Setup dialog box.

    \[Omitted image "TestConnect.png"\] Alt text: Test data source connection

5.  Enter the login credentials.

    These are the usual ServiceNow base system login credentials for the ODBC user you created.

    \[Omitted image "DataSourceLogOn.png"\] Alt text: Log on to data source
...
-   **[Generate logs for debugging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/t_GenerateDebugLogs.md)**  
...
-   **[Test a query](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/t_TestingAQuery.md)**  
...
-   **[ODBC troubleshooting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/odbc-troubleshooting.md)**  
...
[Configure the ODBC driver](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/t_ConfigureTheODBCDriver.md)
