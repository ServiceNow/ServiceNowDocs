...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/t\_ViewingASOAPSessionReport.html
release: yokohama
...
1.  Navigate to **All** &gt; **User Administration** &gt; **Logged in users**.
    ...
    \[Omitted image "LoggedInUsers.png"\] Alt text: Logged In Users
