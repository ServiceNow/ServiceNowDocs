...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/t\_GenerateMessageVariables.html
release: yokohama
...
breadcrumb: [Variable substitution in outbound REST messages, Outbound REST web service, Outbound web services, Web services, API implementation, API implementation and reference]
---
...
**Parent Topic:**[Variable substitution in outbound REST messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/c_VariableSubstitutionREST.md)
