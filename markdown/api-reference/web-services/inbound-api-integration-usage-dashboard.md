...
|API Usage by Application|Shows the number of calls made by an [OAuth inbound](https://www.servicenow.com/docs/access?context=oauth-inbound&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) authentication application.|
