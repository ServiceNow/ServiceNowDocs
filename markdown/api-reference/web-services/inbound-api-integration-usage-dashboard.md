...
|API Usage by Application|Shows the number of calls made by an [OAuth Inbound](https://www.servicenow.com/docs/access?context=oauth-inbound&version=australia&pubname=australia-platform-security&ft:locale=en-US) authentication application.|
