...
|API Usage by Application|Shows the number of calls made by an [OAuth Inbound](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/oauth-inbound.md) authentication application.|
