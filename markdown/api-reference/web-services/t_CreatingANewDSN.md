...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/web-services/t\_CreatingANewDSN.html
release: xanadu
...
Instead of creating a new DSN, you can [Specify a connection string](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/specify-connection-string.md) to connect with different instance URLs.
