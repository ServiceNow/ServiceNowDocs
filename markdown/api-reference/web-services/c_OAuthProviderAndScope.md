...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/web-services/c\_OAuthProviderAndScope.html
release: xanadu
...
breadcrumb: [Use a third-party OAuth provider, Configure a REST message with OAuth, Outbound REST authentication, Outbound REST web service, Outbound web services, Web services, API implementation, API implementation and reference]
---
...
|`oauth_provider_profile`|The sys\_id of the OAuth profile record that is the default \(see [Specify an OAuth profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_SpecifyAnOAuthProfile.md)\).|
...
-   **[Specify an OAuth profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_SpecifyAnOAuthProfile.md)**  
...
-   **[Specify an OAuth scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_SpecifyAnOAuthScope.md)**  
...
**Parent Topic:**[Use a third-party OAuth provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_UseAThirdPartyOAuthProvider.md)
