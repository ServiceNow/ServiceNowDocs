...
The file headers must match the field columns in the targeted table. For more information, see [Post CSV or Excel files directly to an import set](https://www.servicenow.com/docs/access?context=t_PostCSVOrExcelFilesToImportSet&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
