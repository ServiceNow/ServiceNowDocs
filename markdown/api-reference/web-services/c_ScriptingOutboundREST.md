...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/web-services/c\_ScriptingOutboundREST.html
release: xanadu
...
-   **[Generate a REST message script preview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_ScriptingWithREST.md)**  
...
-   **[Direct RESTMessageV2 example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/r_DirectRESTMessageV2Example.md)**  
You can send an outbound REST message directly to the endpoint.
-   **[RESTMessageV2 MID server example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/r_RESTMessageV2MIDServerExample.md)**  
You can send an outbound REST message through a MID Server.
-   **[Recordless RESTMessageV2 example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/r_RecordlessRESTMessageV2Example.md)**  
