...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/web-services/c\_SOAPWebService.html
release: xanadu
...
-   [Direct web services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/c_DirectWebServices.md): Use a URL query to request a table's WSDL.
-   [SOAP web service import sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/soap-web-service-import-sets.md): Use import tables and transform maps to automate web service requests for tables.
-   [Scripted SOAP web services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/c_ScriptedWebServices.md): Use custom JavaScript to execute SOAP web services requests.
...
To know more about SOAP access policy, see [SOAP API access policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/authentication/soap-api-access-policies.md).
...
|Location|[Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/r_AvailableSystemProperties.md) to the System Properties \[sys\_properties\] table|
...
Specify the authentication mechanism you want to use when you [create a new WS-security profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_CreateANewWS-SecurityProfile.md).
...
-   [Access control \(instance security hardening\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/instance-security-hardening-settings/sc-access-control.md)
-   [Basic auth: SOAP requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/instance-security-hardening-settings/sc-soap-request-authorization.md)

-   **[Scripted SOAP web services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/c_ScriptedWebServices.md)**  
Scripted SOAP web services allow a ServiceNow administrator to create custom SOAP web services.
-   **[Direct web services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/c_DirectWebServices.md)**  
A direct web service is available for any table in the system if the correct access control list is configured.
-   **[SOAP web service import sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/soap-web-service-import-sets.md)**  
...
-   **[AttachmentCreator SOAP web service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/r_AttachmentCreatorSOAPWebService.md)**  
Attach documents to records in ServiceNow by sending a SOAP message targeting the ecc\_queue table.
-   **[Override a SOAP endpoint](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/c_OverridingTheSOAPEndpoint.md)**  
The SOAP endpoint address where the SOAP message is posted is consistent with the endpoint of the WSDL.
-   **[Enable HTTP compression](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/c_EnablingHTTPCompression.md)**  
By default, the SOAP request is accepted un-compressed and the result of the request is returned un-compressed.
-   **[Prevent empty elements in SOAP messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/c_PreventEmptyElementSOAPMsgs.md)**  
By default, an instance does not omit empty elements, elements with NULL or NIL values, from SOAP messages.
-   **[Insert related records using SOAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_InsertRelatedRecordsUsingSOAP.md)**  
...
-   **[Specify requirement for signed SOAP requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_SpecifyReqForSignedSOAPRequests.md)**  
Use a SOAP security policy to specify whether the instance requires signed SOAP requests for all inbound SOAP traffic.
-   **[Activate the Enhanced Web Service Provider - Common plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_ActivateEnhancedWSPPlugin.md)**  
...
-   **[Configure SOAP security](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_ConfigureSOAPSecurity.md)**  
Administrators can configure web service security for inbound SOAP requests made to the ServiceNow instance.
-   **[Set the SOAP default security policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_SetTheSOAPDefaultSecurityPolicy.md)**  
Set the SOAP default security policy.
-   **[Create a new security policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_CreateANewSecurityPolicy.md)**  
...
-   **[Create a new WS-Security profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_CreateANewWS-SecurityProfile.md)**  
Create a new WS Security profile to define how to authenticate a web services message when WS-Security is enabled.
-   **[Enforce strict security for inbound SOAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_EnforceStrictSecurityWebSvcConns.md)**  
Strict security for web services requires that users meet Contextual Security requirements to access instance resources.
-   **[Enable WS-Security verification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_EnableWS-SecurityVerification.md)**  
Administrators can enable Web Services Security \(WSS\) verification from the Web Services system properties.
-   **[Debug incoming SOAP envelope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/c_DebuggingIncomingSOAPEnvelope.md)**  
...
-   **[View a SOAP session log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/t_ViewingASOAPSessionReport.md)**  
You can view a user's log from a SOAP session.
-   **[Basic authentication code samples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/r_BasicAuthenticationExamples.md)**  
Samples of basic authentication code for several programming languages and versions.
-   **[Example WS-Security SOAP envelope header](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/r_SmplWSSecSOAPEnvHeader.md)**  
An example of a valid WS-Security SOAP envelope header.
-   **[WS-Security properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/ws-security-properties.md)**  
These properties control the behavior of WS-Security X.509 tokens.
-   **[WS-Security error messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/r_WS-SecurityErrorMessages.md)**  
An instances produces one of the following error messages when it encounters an issue with a WS-security SOAP message.
-   **[WS-Security reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/ws-security-reference.md)**  
...
-   **[LongRunningSOAPRequestProps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/LongRunningSOAPRequestProps.md)**  
The following properties are available for long-running SOAP requests.

**Parent Topic:**[Inbound web services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/inbound-web-services.md)
