...
![Access Controls list is filtered by the type processor and a date range.](../image/WebServiceProcessorACLs.png "Web service processor ACLs")
...
To know more about SOAP access policy, see [SOAP API access policies](https://www.servicenow.com/docs/access?context=soap-api-access-policies&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).

![SOAP Security Policies module is highlighted in the All menu.](../image/SOAPSecurityPolicies.png "SOAP security policies")
...
|Location|[Add a system property](https://www.servicenow.com/docs/access?context=r_AvailableSystemProperties&version=zurich&pubname=zurich-platform-administration&section=t_AddAPropertyUsingSysPropsList&ft:locale=en-US) to the System Properties \[sys\_properties\] table|
...
![WS Security Profiles list is populated with X509 and Username profile records.](../image/WS-SecurityProfilesModule.png "WS-Security Profiles module")
...
![WS Security Profile form is populated with the X509 profile type and a certificate.](../image/WSSX509SecurityProfile.png "WSS X.509 Security Profile")
...
1.  Authenticate with existing user credentials.
    ...
    ![WS Security Profile form is populated with the Username profile type and preferred actions.](../image/AuthenticateWithExistingServiceNowUserCredentials.png "Authenticate with existing user credentials")
...
2.  Authenticate with specified user credentials.
    ...
    ![WS Security Profile form is populated with the Username profile type and action.](../image/AuthenticateWithSpecifiedUserCredentials.png "Authenticate with specified user credentials")
...
-   [Access control \(instance security hardening\)](https://www.servicenow.com/docs/access?context=sc-access-control&version=zurich&pubname=zurich-platform-security&ft:locale=en-US)
-   [Basic auth: SOAP requests](https://www.servicenow.com/docs/access?context=sc-soap-request-authorization&version=zurich&pubname=zurich-platform-security&ft:locale=en-US)
