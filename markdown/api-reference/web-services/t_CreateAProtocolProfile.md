...
-   Role required: admin
-   [Uploading a certificate to an instance](https://www.servicenow.com/docs/access?context=t_UploadACertificateToAnInstance&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) to authenticate the client certificate of the instance.
-   [Uploading a trusted server certificate](https://www.servicenow.com/docs/access?context=t_UploadATrustedServerCertificate&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) to authenticate the server certificate of the web service provider.
