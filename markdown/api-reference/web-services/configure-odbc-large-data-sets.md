...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/configure-odbc-large-data-sets.html
release: yokohama
...
These properties are set using the ODBC Management Console available on Windows operating systems. For more information, see [ODBC management console properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/r_SettingODBCProperties.md).
