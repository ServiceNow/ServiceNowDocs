...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/web-services/configure-odbc-large-data-sets.html
release: xanadu
...
These properties are set using the ODBC Management Console available on Windows operating systems. For more information, see [ODBC management console properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/r_SettingODBCProperties.md).
...
**Parent Topic:**[Configuring the ODBC driver](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/configuring-odbc.md)
