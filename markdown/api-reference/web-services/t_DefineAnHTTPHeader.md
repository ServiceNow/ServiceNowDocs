...
6.  Enter the name of the header, such as Content-Type or Accept.
    ...
    **Note:**
    ...
    -   Multipart Content-Type is not supported in RestMessage. You can use [REST step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/rest-request-action-designer.md) instead.
