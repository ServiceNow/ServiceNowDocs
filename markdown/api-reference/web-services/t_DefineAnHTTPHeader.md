...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/t\_DefineAnHTTPHeader.html
release: yokohama
...
6.  Enter the name of the header, such as Content-Type or Accept.
    ...
    **Note:**
    ...
    -   Multipart Content-Type is not supported in RestMessage. You can use [REST step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/rest-request-action-designer.md) instead.
...
**Parent Topic:**[Create a REST message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/t_ConfiguringARESTMessage.md)
