...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/web-services/t\_CreateANewSecurityPolicy.html
release: yokohama
...
3.  Fill out the SOAP Security Policy form \(see table\).
    ...
    |Security Profiles|Select the [security profiles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/web-services/ws-security-reference.md) you want to apply to this SOAP security policy. You must select at least one security profile.|
