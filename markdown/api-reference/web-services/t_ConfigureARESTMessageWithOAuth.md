...
-   There is an OAuth provider set up in the OAuth application registry with the OAuth client information to use. For more information, see [OAuth 2.0](https://www.servicenow.com/docs/access?context=c_OAuthApplications&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
