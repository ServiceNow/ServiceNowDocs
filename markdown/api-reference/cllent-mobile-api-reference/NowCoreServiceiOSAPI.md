...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/cllent-mobile-api-reference/NowCoreServiceiOSAPI.html
release: yokohama
...
|----|----|-----------|
|for service|[NowService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowServiceiOSProtocol.md)|Feature service requesting the access token.|
...
|Name|Type|Description|
|----|----|-----------|
|for service|[NowService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowServiceiOSProtocol.md)|Feature service requesting the network service.|
...
|Name|Type|Description|
|----|----|-----------|
|for service|[NowService protocol - iOS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowServiceiOSProtocol.md)|Feature service requesting the publisher subscription.|
