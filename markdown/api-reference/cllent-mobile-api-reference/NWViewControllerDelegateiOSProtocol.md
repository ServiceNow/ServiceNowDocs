...
description: The NowWebViewControllerDelegate protocol provides callbacks for notification of issues within the NowWebViewController processing such as when a flow ends or a navigation fails.Callback that notifies the host application that the web view attempted to load an unsupported URL.Callback that notifies the host application that the specified Cabrillo \(mobile web\) flow has ended.Callback that notifies the host application that the web view navigation has failed.Callback that notifies the host application that the system web UI theme changed.Callback that notifies the host application that during a back navigation attempt, the stack was exhausted. The host application can then decide whether to dismiss the NowWebViewController instance.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/cllent-mobile-api-reference/NWViewControllerDelegateiOSProtocol.html
release: yokohama
...
|----|----|-----------|
|nowWebViewController|[NowWebViewController](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NWebViewControlleriOSAPI.md)|Instance of NowWebViewController used when attempting to load the unsupported URL.|
...
|Name|Type|Description|
|----|----|-----------|
|nowWebViewController|[NowWebViewController](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NWebViewControlleriOSAPI.md)|Instance of NowWebViewController where the flow ended.|
...
|Name|Type|Description|
|----|----|-----------|
|nowWebViewController|[NowWebViewController](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NWebViewControlleriOSAPI.md)|Instance of NowWebViewController in which the navigation failed.|
...
|Name|Type|Description|
|----|----|-----------|
|nowWebViewController|[NowWebViewController](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NWebViewControlleriOSAPI.md)|Instance of NowWebViewController in which the web UI theme changed.|
...
|Name|Type|Description|
|----|----|-----------|
|nowWebViewController|[NowWebViewController](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NWebViewControlleriOSAPI.md)|Instance of NowWebViewController in which the back navigation was attempted.|
