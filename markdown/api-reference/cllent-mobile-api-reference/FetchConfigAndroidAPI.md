...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/FetchConfigAndroidAPI.html
release: xanadu
...
This class only contains a single function \(constructor\), [FetchConfiguration\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/FetchConfigAndroidAPI.md).

|Name|Type|Description|
|----|----|-----------|
|filter|[Filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/FilterAndroidAPI.md)|Query to use to filter the return results.|
...
|readConfiguration|[FieldReadConfiguration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/FieldReadConfigAndroidAPI.md)|Configuration for the fields to return in the response.|
