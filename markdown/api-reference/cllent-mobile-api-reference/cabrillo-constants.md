...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/cabrillo-constants.html
release: xanadu
...
The appearance of each message style can be customized using theme colors. For more information, see [Next Experience theming for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/mobile/mobile-platform/explore-ne-theming.md).
