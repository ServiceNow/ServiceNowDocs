...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/cllent-mobile-api-reference/NVoiceThemeableiOSProtocol.html
release: zurich
...
|----|----|-----------|
|color|[NowUIColoring](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/developer-guides/mobsdk-ios-use_nowUIcoloring.md)|Colors to apply to NowVoice UI elements.|
