...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/cllent-mobile-api-reference/NVoiceThemeableiOSProtocol.html
release: australia
...
|----|----|-----------|
|color|[NowUIColoring](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/developer-guides/mobsdk-ios-use_nowUIcoloring.md)|Colors to apply to NowVoice UI elements.|
