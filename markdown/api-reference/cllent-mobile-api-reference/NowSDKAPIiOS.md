...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/NowSDKAPIiOS.html
release: xanadu
...
|----|----|-----------|
|with configuration|[NowSDKConfiguration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/NowSDKConfigurationiOSAPI.md)|NowSDKConfiguration that contains the information necessary to initialize the service.|
