...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/cllent-mobile-api-reference/NowWebiOSAPI.html
release: yokohama
...
[NowWebService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowWebServiceiOSAPI.md)
...
|Type|Description|
|----|-----------|
|AnyPublisher&lt;[NowWebService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowWebServiceiOSAPI.md), NowServiceError&gt;|If successful, returns an initialized NowWebService object. If it fails, returns a NowServiceError object.|
