...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/cabrillo-modal-namespace.html
release: xanadu
...
**Parent Topic:**[Client mobile API reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/api-client-mobile.md)
...
For more information, see [Cabrillo JS constants - close button styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/cabrillo-constants.md).
...
For more information, see [Cabrillo JS constants - modal presentation styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/cabrillo-constants.md).
