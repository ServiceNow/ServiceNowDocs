...
**Note:** Only Action functions are supported for the Vancouver release. For more information, see [Action functions](https://www.servicenow.com/docs/access?context=mobile-actions&version=zurich&pubname=zurich-mobile&ft:locale=en-US).
...
The record table. Optional for Global Action items. For more information about mobile function, see [Action functions](https://www.servicenow.com/docs/access?context=mobile-actions&version=zurich&pubname=zurich-mobile&ft:locale=en-US).**Note:** Differences between Global and Record actions:
...
The record sys\_id. Optional for Global Action Items. For more information about mobile function, see [Action functions](https://www.servicenow.com/docs/access?context=mobile-actions&version=zurich&pubname=zurich-mobile&ft:locale=en-US).
