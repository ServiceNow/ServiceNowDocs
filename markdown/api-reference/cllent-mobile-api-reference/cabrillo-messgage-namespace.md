...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/cabrillo-messgage-namespace.html
release: xanadu
...
For more information, see [Cabrillo JS constants - message styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/cabrillo-constants.md).
