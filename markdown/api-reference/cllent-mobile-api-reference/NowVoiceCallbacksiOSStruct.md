...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/api-reference/cllent-mobile-api-reference/NowVoiceCallbacksiOSStruct.html
release: zurich
...
\(\([NowVoiceTranscriptMessage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/api-reference/cllent-mobile-api-reference/NVoiceTrnstMsgiOSta.md)\) -&gt; Void\)?
