...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/NowAnalyticsAndroidInterface.html
release: xanadu
...
To set the current user, call the [NowAnalyticsSDK - setUserId\(userId: String\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/NowAnalyticsAndroidInterface.md) function.
