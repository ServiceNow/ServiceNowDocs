...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/cllent-mobile-api-reference/NowAnalyticsAndroidInterface.html
release: yokohama
...
To set the current user, call the [NowAnalyticsSDK - setUserId\(userId: String\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowAnalyticsAndroidInterface.md) function.
