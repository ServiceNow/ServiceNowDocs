...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/NowGQLServiceAndroidInterface.html
release: xanadu
...
For more details on the ServiceNow GraphQL API, see [Query record data using the GraphQL API framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/web-services/scripted-graph-ql.md).
...
|Type|Description|
|----|-----------|
|[Call](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/CallAndroidInterface.md)&lt;[Byte Array](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-byte-array/)&gt;|Query response.|
