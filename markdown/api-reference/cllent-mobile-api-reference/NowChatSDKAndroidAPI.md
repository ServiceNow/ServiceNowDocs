...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/NowChatSDKAndroidAPI.html
release: xanadu
...
For additional information on Live Agent and Virtual Agent, see [Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/conversational-interfaces/virtual-agent/virtual-agent-landing-page.md).
...
|nowChatSdkCallbacks|[NowChatSdkCallbacks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/NowChatSdkCallbacksAndroidInt.md)|Callbacks for the host application to use to configure the NowChatService.|
