...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/NowDataAPIiOS.html
release: xanadu
...
@escaping \(\(Result​&lt;[NowApiService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/NowAPIServiceiOSAPI.md), Now​Service​Error&gt;\) -&gt; Void\)
