...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/cllent-mobile-api-reference/NowDataAPIiOS.html
release: australia
...
@escaping \(\(Result​&lt;[NowApiService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/cllent-mobile-api-reference/NowAPIServiceiOSAPI.md), Now​Service​Error&gt;\) -&gt; Void\)
