...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/cllent-mobile-api-reference/NowDataAPIiOS.html
release: yokohama
...
@escaping \(\(Result​&lt;[NowApiService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowAPIServiceiOSAPI.md), Now​Service​Error&gt;\) -&gt; Void\)
