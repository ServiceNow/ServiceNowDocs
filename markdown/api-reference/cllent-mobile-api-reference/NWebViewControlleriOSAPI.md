...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/NWebViewControlleriOSAPI.html
release: xanadu
...
|Name|Type|Description|
|----|----|-----------|
|themeColors|[NowWebThemeable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/cllent-mobile-api-reference/NowWebThemeableiOSProtocol.md)|Theme to update the web UI with.|
