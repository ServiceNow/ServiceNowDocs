...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/cllent-mobile-api-reference/NWebViewControlleriOSAPI.html
release: yokohama
...
|Name|Type|Description|
|----|----|-----------|
|themeColors|[NowWebThemeable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowWebThemeableiOSProtocol.md)|Theme to update the web UI with.|
