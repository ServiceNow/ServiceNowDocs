...
-   Failure: Void - Failure may occur if the User Experience Analytics servers cannot be reached, as when there is no connectivity. If failure occurs, retry the method.
