...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/cllent-mobile-api-reference/NowAnalyticsServiceiOSProtocol.html
release: yokohama
...
To set the current user, use the [setUserId\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowAnalyticsServiceiOSProtocol.md) method.
...
This method returns an [SNMobileAnalytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/SNMobileAnalytics.md) object that is available in JavaScript, which exposes the native methods.
...
|Type|Description|
|----|-----------|
|Object|[SNMobileAnalytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/SNMobileAnalytics.md)|
...
[NowAnalyticsServiceDelegate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowAnalyticsServiceDeliOSProtocol.md)
...
You must call the [setUserId\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowAnalyticsServiceiOSProtocol.md) function before calling this function.
