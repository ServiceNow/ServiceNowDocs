...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/cllent-mobile-api-reference/NowChatServiceDelegateiOSProtocol.html
release: yokohama
...
|----|----|-----------|
|chatService|[NowChatService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowChatServiceiOSAPI.md)|NowChatService object making the request.|
...
|Name|Type|Description|
|----|----|-----------|
|chatService|[NowChatService](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/NowChatServiceiOSAPI.md)|NowChatService object whose view controller was dismissed.|
...
**Note:** You must define the desired functionality for this callback by overriding the function as the default implementation simply prints the message "Chat Session ended with ID: \\\(sessionId\)".
