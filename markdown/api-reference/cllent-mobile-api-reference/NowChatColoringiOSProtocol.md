...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/cllent-mobile-api-reference/NowChatColoringiOSProtocol.html
release: xanadu
...
Color applied to the alert pop-up icon and bar.Default dark color: \#E46876
