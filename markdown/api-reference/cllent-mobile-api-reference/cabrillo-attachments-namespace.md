...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/cllent-mobile-api-reference/cabrillo-attachments-namespace.html
release: yokohama
...
**Important:** This method is deprecated. Use the [addFiles\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/cllent-mobile-api-reference/cabrillo-attachments-namespace.md) method instead.
