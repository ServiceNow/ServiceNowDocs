...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/DynamicTranslationClientAPI.html
release: xanadu
...
Translation service to use to detect the language of a string. Translation services are configured under the **Translator Configuration** menu and located in the Translator Configuration \[sn\_dt\_translator\_configuration\] table.Possible values - not case-sensitive:
...
Array of objects that describe the language translations.Data type: Array
...
Array of objects. Description of the language used to translate the text string.```
"textTranslation": {
  "targetLanguage": "String",
  "translatedText": "String"
}
