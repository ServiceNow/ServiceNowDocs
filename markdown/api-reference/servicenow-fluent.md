...
To get started using the ServiceNow IDE or ServiceNow SDK, see the [ServiceNow IDE](https://www.servicenow.com/docs/access?context=servicenow-ide-landing&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US) or [ServiceNow SDK](https://www.servicenow.com/docs/access?context=servicenow-sdk-landing&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US) documentation.
...
For details about the APIs and examples, see [ServiceNow Fluent API reference](https://www.servicenow.com/docs/access?context=servicenow-fluent-api-reference&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US) and the [ServiceNow SDK examples](https://github.com/ServiceNow/sdk-examples) GitHub repository.
...
[ServiceNow Fluent API reference](https://www.servicenow.com/docs/access?context=servicenow-fluent-api-reference&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US)
