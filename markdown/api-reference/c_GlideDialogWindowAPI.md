...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/api-reference/c\_GlideDialogWindowAPI.html
release: yokohama
...
**Note:** This API has been deprecated, use the [GlideModal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/api-reference/c_GlideModalV3API.md) API instead.
