...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/api-reference/c\_GlideDialogWindowAPI.html
release: australia
...
**Note:** This API has been deprecated, use the [GlideModal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/api-reference/c_GlideModalV3API.md) API instead.
