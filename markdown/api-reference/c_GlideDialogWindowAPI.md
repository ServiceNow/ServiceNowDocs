...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/api-reference/c\_GlideDialogWindowAPI.html
release: xanadu
...
**Note:** This API has been deprecated, use the [GlideModal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/api-reference/c_GlideModalV3API.md) API instead.
