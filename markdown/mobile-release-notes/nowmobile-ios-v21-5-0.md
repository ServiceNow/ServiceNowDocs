---
title: Now Mobile for iOS v21.5.0
description: The iOS v21.5.0 release provides fixes for the application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile-release-notes/nowmobile-ios-v21-5-0.html
release: mobile
