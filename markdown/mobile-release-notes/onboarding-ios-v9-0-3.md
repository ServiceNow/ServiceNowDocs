...
# Mobile Onboarding for iOS v9.0.3

The iOS v9.0.3 release provides fixes for the application.
...
Empty mandatory text fields in parameters screen can be submitted
