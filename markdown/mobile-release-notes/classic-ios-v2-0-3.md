...
# Mobile Classic iOS v2.0.3

The Mobile Classic iOS v2.0.3 release provides problem fixes.
...
Native iOS application should handle repairing web session for SSO users

</td><td>

1.  Log into an SSO instance.
2.  Go directly to Service Catalog.
