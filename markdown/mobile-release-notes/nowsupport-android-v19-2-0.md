---
title: Now Support for Android v19.2.0
description: The Android v19.2.0 release provides fixes for the application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile-release-notes/nowsupport-android-v19-2-0.html
release: mobile
...
# Now Support for Android v19.2.0
...
Images in the Choice List are displayed with a rounded white box
...
1.  Log in to Now Mobile. In Home select **My task**.
2.  Open any task.
3.  In the 'To-Do' section, select **Complete new hire pulse check**.

 Notice the rounded white box on the image in the Choice List.
