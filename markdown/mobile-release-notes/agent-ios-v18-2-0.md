---
title: Mobile Agent for iOS v18.2.0
description: The iOS v18.2.0 release provides fixes for the application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile-release-notes/agent-ios-v18-2-0.html
release: mobile
