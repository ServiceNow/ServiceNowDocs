...
# ServiceNow Onboarding - Intune for iOS v13.1.1

The iOS v13.1.1 release provides fixes for the application.
...
Intune SDK experiences a UI loop when asking for the PIN

</td><td>

This loop causes severe performance degradation and prevents users from using the app.
