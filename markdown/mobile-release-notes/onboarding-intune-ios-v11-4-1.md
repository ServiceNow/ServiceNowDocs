---
title: ServiceNow Onboarding - Intune for iOS v11.4.1
description: The iOS v11.4.1 release provides fixes for the application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile-release-notes/onboarding-intune-ios-v11-4-1.html
release: mobile
...
# ServiceNow Onboarding - Intune for iOS v11.4.1

The iOS v11.4.1 release provides fixes for the application.
...
Performance instability with Intune iOS apps

</td><td>

Intune iOS apps may fail to launch after upgrading.
