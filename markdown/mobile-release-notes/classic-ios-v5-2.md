---
title: Mobile Classic iOS v5.2
description: The Mobile Classic iOS v5.2 release provides problem fixes.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile-release-notes/classic-ios-v5-2.html
release: mobile
...
# Mobile Classic iOS v5.2

The Mobile Classic iOS v5.2 release provides problem fixes.
...
Support for iOS internal distribution binary
