---
title: Mobile Agent - Intune for Android v21.2.0
description: The Android v21.2.0 release provides fixes for the application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile-release-notes/agent-intune-android-v21-2-0.html
release: mobile
...
# Mobile Agent - Intune for Android v21.2.0

The Android v21.2.0 release provides fixes for the application.
...
The **Back** button on the NowMobile App on Android on the 'Requests' tab is not consistently visible, despite the button color being set to black on a white background. However, sometimes the button renders to white, making invisible on the white background.
