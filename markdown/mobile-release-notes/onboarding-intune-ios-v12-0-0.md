---
title: ServiceNow Onboarding - Intune for iOS v12.0.0
description: The iOS v12.0.0 release provides fixes for the application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile-release-notes/onboarding-intune-ios-v12-0-0.html
release: mobile
...
<table id="table_tks_m5r_2pb" class="custom-rows"><thead><tr><th class="filter">
