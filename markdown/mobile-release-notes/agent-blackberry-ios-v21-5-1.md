---
title: Mobile Agent - BlackBerry for iOS v21.5.1
description: The iOS v21.5.1 release provides fixes for the application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile-release-notes/agent-blackberry-ios-v21-5-1.html
release: mobile
...
# Mobile Agent - BlackBerry for iOS v21.5.1

The iOS v21.5.1 release provides fixes for the application.
...
Images fail to upload in the Agent app with an error reading 'File Compression Failed'

</td><td>

Images fail to upload across multiple features including widget-based uploads \(Chat, Forum, etc.\), survey uploads, and questionnaire/form uploads.
