---
title: ServiceNow Onboarding - Intune for iOS v9.1.0
description: The iOS v9.1.0 release provides fixes for the application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/mobile-release-notes/onboarding-intune-ios-v9-1-0.html
release: mobile
...
# ServiceNow Onboarding - Intune for iOS v9.1.0

The iOS v9.1.0 release provides fixes for the application.
...
Mobile iOS \(non-classic\)PRB1384254
