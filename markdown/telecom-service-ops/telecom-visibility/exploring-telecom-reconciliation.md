...
\[Omitted image "telecom-discrepancy-identification-reconciliation.png"\] Alt text: telecom discrepancy identification and reconciliation framework.
...
For more information, see [CMDB Identification and Reconciliation \(IRE\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_CMDBIdentifyandReconcile.md).
...
For more information on the general Certifications Audits feature, see [Certification audits](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_CertificationAudits.md).
...
For more information on how to build a subflow, see [Building subflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/subflows.md).
...
3.  Select the **Run Audits** to run the audit.
    ...
    \[Omitted image "telecom-run-audits.png"\] Alt text: run audit.

4.  Select **TASK0020215**.\[Omitted image "telecom-follow-on-task.png"\] Alt text: follow-on task.
...
\[Omitted image "telecom-subflow.png"\] Alt text: example subflow.
