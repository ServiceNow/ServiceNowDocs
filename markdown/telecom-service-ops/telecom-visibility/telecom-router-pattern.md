...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/telecom-service-ops/telecom-visibility/telecom-router-pattern.html
release: yokohama
...
3.  Open the tab **SNMP OID Classifications** and see the list of OIDs.\[Omitted image "telecom-router-pattern-classification.png"\] Alt text: snmp-classification.
