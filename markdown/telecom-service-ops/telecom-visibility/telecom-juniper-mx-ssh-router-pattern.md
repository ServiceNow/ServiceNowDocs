...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/telecom-service-ops/telecom-visibility/telecom-juniper-mx-ssh-router-pattern.html
release: yokohama
...
-   On the ServiceNow instance, configure SNMP credentials. For more information, see [SNMP support for Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/c_SNMPSupportForDiscovery.md).
...
3.  Open the tab **SNMP OID Classifications** and see the list of OIDs.\[Omitted image "telecom-juniper-classification.png"\] Alt text: snmp oid classifications.
