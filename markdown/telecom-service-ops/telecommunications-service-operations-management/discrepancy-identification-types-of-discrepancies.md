...
-   **Mismatched configuration items \(CIs\) - entities that exist in inventory and network but differ in attribute values and hierarchical relationships**
    ...
    -   Attribute Value Mismatches - Involve discrepancies in CI field-level properties. The common issues are:
        ...
        **Note:** For more information, see [Configure attribute value discrepancy in CMDB 360](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/telecom-service-ops/telecommunications-service-operations-management/configure-attribute-value-discrepancy-in-cmdb-360.md).
