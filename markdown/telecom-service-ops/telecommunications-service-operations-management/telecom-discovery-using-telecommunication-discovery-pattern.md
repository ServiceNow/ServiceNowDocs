...
For more information, see [Horizontal discovery process flow with patterns](https://www.servicenow.com/docs/access?context=disco-process-flow-patterns&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).
