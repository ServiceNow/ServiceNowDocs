...
3.  On the Guided setup home page, create and configure the MID Server or skip based on your environment.
    ...
    **Note:** For more information on how to activate and configure a MID Server, see [Configuring MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/configure-mid-server.md).
