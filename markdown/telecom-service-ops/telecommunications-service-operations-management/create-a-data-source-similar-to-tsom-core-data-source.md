...
5.  On the form, fill in the fields
    ...
    For more information, see [Create a Custom \(Load by Script\) type data source](https://www.servicenow.com/docs/access?context=create-custom-type-data-source&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
