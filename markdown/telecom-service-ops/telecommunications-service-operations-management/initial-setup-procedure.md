...
3.  Create and configure MID Server or skip based on your environment.
    ...
    3.  Select **Mark as Complete** when done.
        ...
        **Note:** For more information on how to install and configure MID Server, see [Configuring MID Server](https://www.servicenow.com/docs/access?context=configure-mid-server&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
