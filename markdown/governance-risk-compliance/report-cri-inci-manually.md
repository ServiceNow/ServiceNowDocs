...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/report-cri-inci-manually.html
release: yokohama
topic_type: task
...
4.  On the New record form, fill in the fields.
    ...
    To view more information on the fields, see the [Create New Digital Resilience Incident form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/create-new-dig-res-inci.md).
