---
title: Create a third-party engagement and enhance data
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/create-drtp-reg-tp-engagement.html
release: australia
topic_type: task
...
# Create a third-party engagement and enhance data
...
3.  On the form, fill in the fields.
    ...
    For more information, see [Create a third party engagement form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/create-new-tp-engmt-form.md).

    When the Identification code type field is set to LEI and a valid LEI is entered, the system validates the code in real time against the GLEIF database. It auto-populates the associated name and country fields. If you edit auto-populated field so that the value no longer matches GLEIF data, a warning message is displayed on edited field. You can still save the record \(warn-and-save\).

4.  Select **Save**

5.  Add digital resilience information.

    For more information, see [Add Digital resilience info to third-party engagements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/tp-eng-add-digi-resi-info.md).
...
-   **[Add Digital resilience info to third-party engagements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/tp-eng-add-digi-resi-info.md)**  
Add Digital resilience information to third-party engagements.
-   **[Create a third party engagement form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/create-new-tp-engmt-form.md)**  
