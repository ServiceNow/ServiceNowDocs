...
If the entity does not belong to an entity type such as Facilities, People, Suppliers, or Technology, Operational Resilience users must add it to the corresponding entity type manually. Operational Resilience administrators and managers can also update the dependencies manually instead of using the scheduled job.

## Support for main node configuration in Data Relationships Framework

For information on the Data Relationships Framework and main node configuration, see [Data Relationships Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/data-relationship-framework.md) and [Create a main node configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/create-a-main-node-config-record.md).
