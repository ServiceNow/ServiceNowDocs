...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/add-dependencies-automatically.html
release: xanadu
topic_type: concept
...
For information on the Data Relationships Framework and main node configuration, see [Data Relationships Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/data-relationship-framework.md) and [Create a main node configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/create-a-main-node-config-record.md).
