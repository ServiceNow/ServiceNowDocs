...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/create-bcp-plan-template-workspace.html
release: yokohama
topic_type: task
