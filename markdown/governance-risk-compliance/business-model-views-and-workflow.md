...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/business-model-views-and-workflow.html
release: xanadu
topic_type: concept
...
For information on gathering Operational Resilience data aligned with the CSDM model, see [Gathering data aligned with the CSDM setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/using-csdm-v5.md) and [Landing page and dashboard views](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/setup-homepage.md).
