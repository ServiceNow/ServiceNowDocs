...
3.  On the form, fill in the fields.
    ...
    For more information on the fields in the form, see [Grid category record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/grid-category-record-form.md).

4.  Select **Submit**.


-   **[Grid category record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/grid-category-record-form.md)**  
