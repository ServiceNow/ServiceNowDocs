...
Before proceeding, ensure that entity types and pillars are properly configured; refer to the [Set up pillars, entity types, and generate entities](../../grc-operational-res/task/manage-entity-types-pillars-from-ws.md) for setup instructions.
...
**Note:** Instead of adding services directly to Operational Resilience reporting, set up the entity filters for the desired services. For instructions on setting up the entity filters, see [Configure entity types and entity filters](../../grc-operational-res/task/set-up-entity-types.md).
