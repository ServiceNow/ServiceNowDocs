...
breadcrumb: [Adding a scenario event to the analysis, Conducting a scenario analysis, Managing Operational Resilience, Operational Resilience, Governance, Risk, and Compliance]
---
