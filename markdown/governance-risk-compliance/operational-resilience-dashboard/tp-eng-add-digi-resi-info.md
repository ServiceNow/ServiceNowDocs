...
breadcrumb: [Create a third-party engagement and enhance digital resilience data, Using Digital resilience third-party registers, Maintaining Digital resilience third-party registers, Managing Operational Resilience, Operational Resilience, Governance, Risk, and Compliance]
---
...
5.  Select **Save**.
    ...
    The ICT third-party service provider record is created and its details are displayed in the **Details** tab.
