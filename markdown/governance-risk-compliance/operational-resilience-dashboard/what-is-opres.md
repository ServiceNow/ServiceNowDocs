...
The Operational Resilience application helps your organization to achieve a uniform vision and build resilience across different business functions. By using the Operational Resilience application on one platform, various teams can monitor the health of their services in one place as shown in the following example.

![Uniform vision.](../image/cfo-and-ro.png "Uniform vision with Operational Resilience")
...
![Four stages of Operational Resilience.](../image/op-res-breaking-it-down.png "Four stages of Operational Resilience workflow")
