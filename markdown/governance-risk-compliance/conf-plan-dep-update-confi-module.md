...
3.  On the form, fill in the fields.
    ...
    For more information on the fields in the form, see [Planning dependency update configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/pla-dep-update-confi-form.md).

4.  Select **Submit**.

    Based on the sources and preferences configured in the Planning dependency update configuration record, the planning dependency updates are automatically updated for the plan record.

    The BCP owner and approver review the updated dependencies and complete the BCP workflow.


-   **[Planning dependency update configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/pla-dep-update-confi-form.md)**  
...
**Parent Topic:**[Configuring planning dependency updates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/confi-planning-dep-updates.md)
