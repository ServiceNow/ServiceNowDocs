...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/roles-installed-with-op-res.html
release: yokohama
...
For BCM Professional, the following mandatory applications are installed with Operational Resilience.\[Omitted image "bcm-required-plugins.png"\] Alt text: BCM plugins.
...
For IRM Professional, the following mandatory applications are installed with Operational Resilience.\[Omitted image "irm-required-plugins.png"\] Alt text: IRM plugins.
