...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/set-up-important-choices.html
release: xanadu
topic_type: task
...
3.  On the form, fill in the fields and select **Submit**.
    ...
    For a description of the field values on the GRC Choices form, see [GRC Choices form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/important-choices-reference.md).
