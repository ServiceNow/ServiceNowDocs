...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/add-rela-for-created-records-in-csdm-header.html
release: xanadu
topic_type: task
...
To fetch the dependencies, execute the scheduled job. For more information, see [Execute the scheduled jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/execute-sch-jobs.md).
