...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/add-rela-for-created-records-in-csdm-header.html
release: yokohama
topic_type: task
...
To fetch the dependencies, execute the scheduled job. For more information, see [Execute the scheduled jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/execute-sch-jobs.md).
