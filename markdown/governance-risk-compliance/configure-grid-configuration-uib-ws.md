...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/configure-grid-configuration-uib-ws.html
release: xanadu
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    For more information, see [Grid configuration record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grid-configuration-record-form.md).

4.  Select **Submit**.


-   **[Grid configuration record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grid-configuration-record-form.md)**  
