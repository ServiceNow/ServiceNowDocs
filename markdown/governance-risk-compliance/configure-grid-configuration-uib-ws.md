...
3.  On the form, fill in the fields.
    ...
    For more information, see [Grid configuration record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/grid-configuration-record-form.md).

4.  Select **Submit**.


-   **[Grid configuration record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/grid-configuration-record-form.md)**  
