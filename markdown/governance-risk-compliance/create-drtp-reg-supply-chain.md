...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/create-drtp-reg-supply-chain.html
release: yokohama
topic_type: task
...
7.  To export supply chain records, complete the following.
    ...
    4.  Select the **Delivery Type**.
        ...
        -   **Download**
        -   **Email**
8.  To delete the supply chain record, select it from the list and select **Delete**.
