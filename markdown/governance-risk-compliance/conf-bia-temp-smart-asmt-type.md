...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/conf-bia-temp-smart-asmt-type.html
release: xanadu
topic_type: task
...
For the initial setup checklist for Smart Assessment Engine, see [Configuring Smart Assessment Engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/smart-assessment-engine/smart-assessment-engine-cf-config.md).
...
4.  Select **Smart Assessment** as the assessment type.
    ...
    The Impact assessment template is the Smart Assessment template you configured following the steps outlined in [Create Smart Assessment templates for BIA](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/conf-impact-asmt-template.md).
...
-   **[BIA template record form for the Smart assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/bia-smart-temp-ref-form.md)**  
