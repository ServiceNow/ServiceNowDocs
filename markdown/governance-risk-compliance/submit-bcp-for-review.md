...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/submit-bcp-for-review.html
release: xanadu
topic_type: task
...
5.  Select **Approve**.
    ...
    **Note:** If an approval record is created for the BCP, the **Approve** or **Reject** actions are not displayed on the BCP form. For a user to view the **Approve** or **Reject** actions, these conditions must be fulfilled:
    ...
    To configure multiple approval levels for the plan, see [Set up approval levels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/setup-bcm-approval-levels.md).
