...
description: Build the word template using the add-in. The Word Templates module provides the DRIR Word templates used to generate Microsoft Word reports.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/build-word-template-using-add-in.html
release: yokohama
topic_type: task
...
Build the word template using the add-in. The Word Templates module provides the DRIR Word templates used to generate Microsoft Word reports.
