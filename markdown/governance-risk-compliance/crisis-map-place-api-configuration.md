...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/crisis-map-place-api-configuration.html
release: xanadu
topic_type: task
...
-   **[Configure scheduled data imports for crisis map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/crisis-map-scheduled-data-imports.md)**  
Manage your subscriptions to threat feeds from internal or external sources by configuring scheduled data imports.
-   **[Configure a resource for crisis map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/crisis-map-configure-resource.md)**  
...
-   **[Configure alert rules to display alerts in crisis map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/crisis-map-alert-configuration.md)**  
...
-   **[Configure an alert action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/crisis-map-alert-actions.md)**  
The alert actions are the follow-up actions that you can perform from the crisis map dashboard.

**Parent Topic:**[Setting up the crisis map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/Setting-up-crisis-map.md)
