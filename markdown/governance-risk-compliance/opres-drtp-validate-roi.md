...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/opres-drtp-validate-roi.html
release: yokohama
topic_type: task
...
Generate a Plain-CSV Reporting Package and an Excel Master Template. For more information, see [Generate a Register of Information package](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/opres-drtp-gen-roi-pkg.md).
