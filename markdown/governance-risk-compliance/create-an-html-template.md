...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/create-an-html-template.html
release: yokohama
topic_type: task
...
4.  On the form, fill in the fields and click **Submit**.
    ...
    The new template is displayed in the Document Templates list.​ For descriptions of the field values, see [HTML Template form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/html-template-reference-form.md).
