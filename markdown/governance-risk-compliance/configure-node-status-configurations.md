...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/configure-node-status-configurations.html
release: yokohama
topic_type: task
...
4.  In the Node status configurations related list, select **New**.
    ...
    For more information on the fields, see [Node status configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/node-status-configuration-form.md).
