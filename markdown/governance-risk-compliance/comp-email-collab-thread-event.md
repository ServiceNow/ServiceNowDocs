...
5.  On the **Emails** tab of the collaboration thread, select **Compose email**.
    ...
    **Note:** For setting up email properties in the instance, see [Configure email for collaboration threads](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/configure-email-for-collaboration-threads.md).
