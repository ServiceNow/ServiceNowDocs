...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/configure-op-res-assessment.html
release: yokohama
topic_type: task
last_updated: "2025-07-31"
reading_time_minutes: 1
breadcrumb: [Create a Smart Assessment template, Completing general administrative tasks, Configure, Operational Resilience, Governance, Risk, and Compliance]
---
...
Create your own questionnaire \(assessment\) template and request the responses from the assessor. This task is optional.
...
3.  On the Assessment Metric Type form, fill in the fields and click **Submit**.
    ...
    For a description of the field values on the Assessment Templates form, see [Assessment Metric Type form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/new-assessment-reference.md).
