...
3.  On the Assessment Metric Type form, fill in the fields and click **Submit**.
    ...
    For a description of the field values on the Assessment Templates form, see [Assessment Metric Type form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/new-assessment-reference.md).
