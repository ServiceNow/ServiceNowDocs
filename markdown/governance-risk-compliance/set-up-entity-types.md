...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/set-up-entity-types.html
release: xanadu
topic_type: task
...
7.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Entity Type New record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/entity-type-reference.md).
