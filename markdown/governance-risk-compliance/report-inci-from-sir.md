...
2.  Open the Digital resilience incident case from the list view.
    ...
    The analyst assesses the incident's impact on factors such as critical services, clients \(including financial counterparts and third parties\), data losses, reputation, service downtime, geography, and economy. These sections in the template help you determine the impact of the incident. Respond to the questions in the questionnaire to determine whether the incident should be reported to the regulators. For information on the assessment template, see [Create an assessment template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/smart-assessment-engine/sae-asmnt-template-create.md).
