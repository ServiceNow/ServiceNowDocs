...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/configure-csdm-modules.html
release: yokohama
topic_type: task
...
2.  To add a service to Operational Resilience, select **New** in the Services list view and fill in the details regarding the service on the Create New service form.
    ...
    **Note:** You must have the itil user role to create a service. If you do not have the itil user role, the **New** button for creating a service is not displayed.
    ...
    For a description of the field values on the Service form, see [Create New Service form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/service-form-lists-ws-reference.md).
