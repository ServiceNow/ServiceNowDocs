...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/configure-bia-template-uib-ws.html
release: xanadu
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    For more information on the fields in the form, see [BIA template form for the legacy assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/bia-template-new-record-form.md).
...
-   **[BIA template form for the legacy assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/bia-template-new-record-form.md)**  
...
**Parent Topic:**[Setup for a business impact analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/bcm-admin-tasks.md)
