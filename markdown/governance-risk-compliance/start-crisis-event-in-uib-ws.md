...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/start-crisis-event-in-uib-ws.html
release: yokohama
topic_type: task
...
3.  In the **Details** tab of the **Create New Event** form, fill in the required fields.
    ...
    **Note:** For a crisis event, the event type is **Actual**.
    ...
    For more information on the fields, see [Create Crisis Event form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/create-crisis-event-ref-form.md).
...
-   **[Create Crisis Event form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/create-crisis-event-ref-form.md)**  
