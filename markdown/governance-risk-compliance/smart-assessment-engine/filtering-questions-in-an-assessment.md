...
For the step-by-step procedure, see [Filter questions in an assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/smart-assessment-engine/filter-questions-in-an-assessment.md).
