...
description: Create an assessment template category in the Smart Assessment Engine application to organize and grant access to assessment templates that are related.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/smart-assessment-engine/sae-asmnt-template-category-create.html
release: yokohama
...
Create an assessment template category in the Smart Assessment Engine application to organize and grant access to assessment templates that are related.
