...
For the configuration steps on the SAE side, see [Embed an assessment in a record page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/smart-assessment-engine/embed-assessment-in-record-page.md).
