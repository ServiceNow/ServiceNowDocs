...
-   A subflow must be available and mapped to the assessment template category for which you want to configure post-assessment actions. For more information about how to create and build subflows, refer to [Create a subflow in Workflow Studio](https://www.servicenow.com/docs/access?context=create-subflow&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US) and [Building subflows](https://www.servicenow.com/docs/access?context=subflows&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
...
<table id="choicetable_v2z_xht_42c"><thead><tr><th align="left" id="d266414e139">

Option

</th><th align="left" id="d266414e142">

Description

</th></tr></thead><tbody><tr><td id="d266414e148">
...
3.  Create the conditional action set using the condition builder. For more information, refer to [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
4.  Select **Save**.
 **Note:** You can select **+New condition set** to add multiple conditions.

</td></tr><tr><td id="d266414e194">
...
[Flow Designer](https://www.servicenow.com/docs/access?context=flow-designer&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)
