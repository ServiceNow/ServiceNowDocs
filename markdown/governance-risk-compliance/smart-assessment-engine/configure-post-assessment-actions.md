...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/smart-assessment-engine/configure-post-assessment-actions.html
release: xanadu
...
<table id="choicetable_v2z_xht_42c"><thead><tr><th align="left" id="d87851e129">

Option

</th><th align="left" id="d87851e132">

Description

</th></tr></thead><tbody><tr><td id="d87851e138">
...
3.  Create the conditional action set using the condition builder. For more information, refer to [Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/c_ConditionBuilder.md).
4.  Select **Save**.
 **Note:** You can select **+New condition set** to add multiple conditions.

</td></tr><tr><td id="d87851e184">
