...
<table id="choicetable_v2z_xht_42c"><thead><tr><th align="left" id="d271202e139">

Option

</th><th align="left" id="d271202e142">

Description

</th></tr></thead><tbody><tr><td id="d271202e148">
...
3.  Create the conditional action set using the condition builder. For more information, refer to [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
4.  Select **Save**.
 **Note:** You can select **+New condition set** to add multiple conditions.

</td></tr><tr><td id="d271202e194">
