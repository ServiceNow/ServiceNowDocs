...
3.  In the More actions icon \(![More actions icon.](../../grc-workspace-risk/image/icon-more-actions-risk.png)\), select **Create code snippet**, and then copy and paste the snippet into your script.
