...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/smart-assessment-engine/sae-asmnt-trigger-from-script.html
release: yokohama
...
3.  In the More actions icon \(\[Omitted image "icon-more-actions-risk.png"\] Alt text: More actions icon.\), select **Create code snippet**, and then copy and paste the snippet into your script.
