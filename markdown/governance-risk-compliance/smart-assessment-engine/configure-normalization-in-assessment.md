...
6.  If the **Assessment score** option is selected, to use aggregate score at the assessment level, you can select **Use normalized score for aggregation**.
    ...
    1.  To edit the normalization values for the assessment score, select edit ![](../../../reuse/icons/product-icons/pencil-outline-24.svg) icon and update normalization values.

    2.  To delete the normalization values for the assessment score, select delete ![](../../../common/image/Form_DeleteIcon.png) icon and select **Remove normalization**.
