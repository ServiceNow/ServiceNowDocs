...
If you have the assessment reassign \[sn\_smart\_asmt.reassign\] role, you can reassign in-progress assessments to another user. If your template manager or administrator has added reference information, such as scope-related information, you can view it in the Details section of your assessment. If relevant to the state of the assessment, the scope, requestor, assignee, the requested and due dates are listed in the Details section by default.

While responding to an assessment, you can collaborate at the level of individual questions through four features on each question card. **Comments** supports question-specific conversation. **Work notes** provides private threads for users with a configured role. Question **Flags** marks questions that need attention. Question-level **Change history** tracks how the response, justification, and flag state changed. For an overview of these features, including how their visibility and permissions are controlled, see [Collaboration in assessments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/smart-assessment-engine/collaboration-in-assessments.md). For details on the change history panel, see [Question change history](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/smart-assessment-engine/sae-question-change-history.md).
