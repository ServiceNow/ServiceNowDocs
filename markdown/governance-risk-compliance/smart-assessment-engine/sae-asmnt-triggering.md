...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/smart-assessment-engine/sae-asmnt-triggering.html
release: yokohama
...
-   **Trigger an assessment from Workflow Studio**
    ...
    For more information, see [Configure the Trigger Smart Assessment Flow action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/smart-assessment-engine/sae-asmnt-trigger-from-flow.md).
...
-   **Trigger an assessment from a script**
    ...
    For more information, see [Trigger assessments from a script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/smart-assessment-engine/sae-asmnt-trigger-from-script.md).
