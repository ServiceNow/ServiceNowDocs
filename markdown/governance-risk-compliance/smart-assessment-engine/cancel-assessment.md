...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/smart-assessment-engine/cancel-assessment.html
release: yokohama
...
3.  To cancel the assessment, on the top pane select more action icon \[Omitted image "ellipsis-vertical-outline-24.svg"\] and select **Cancel**.
