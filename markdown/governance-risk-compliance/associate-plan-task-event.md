...
2.  From the Home page of the Business continuity workspace, click the event record link in the **Event** column of the **My exercises** section.
...
7.  Click the **Impacts** tab to view the list of impacted items.
    ...
    For information on the logic behind the calculation of recovery task entities, see [Calculation of actual duration and total effort to recover an event asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/view-exercise-crisis-event-details.md).
    ...
    For more information on the planning and execution of a recovery event, see [Data flow, planning, execution, and recovery of related plan assets in event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/planning-execution-event-bcm.md).
