...
2.  To update an active exercise or crisis event from the Home page of the Business continuity workspace, select the link to the event record in the **Event** column of **My exercises**.
...
6.  Select the **Impacts** tab to view the list of impacted items.

    You can add assets, activated plans for the recovery of the assets, and an ad hoc plan for an event asset.

7.  Select the **Impacts** tab to view the list of impacted items.
...
9.  Select **Add plans** button.
    ...
    Add ad hoc plan button is shown after an ad hoc plan is created for an event. The same is mapped to the selected assets in the ad hoc plan modal.
    ...
    -   To select a plan that the impacted asset is part of, select **Show plan for impacted assets**.
        ...
        3.  Select the plans for the impacted asset in the Select Plans to Add pop-up.
            ...
            This action creates the activated plan if it does not already exist. It then maps the impacted asset with the activated plan in the Impacted Asset to Activated Plan \[sn\_recovery\_impacted\_asset\_to\_activated\_plan\] table.
    ...
    -   To display all plans and select assets from the plans, select **Show all plans**.
        ...
        5.  Select **Confirm** to proceed with the activation of the selected plans. This message pops up for the events that are **In Progress** state.
    **Note:** The impacted items or event assets, the activated plans, and their status are displayed in the grid.

10. Select the **Add ad hoc plan** button.

    After you add assets to the event, you can select the **Add ad hoc plan** button to add an ad hoc plan for the selected assets of the event.

    **Note:** This action adds an ad hoc plan if it does not already exist for the event. After an ad hoc plan is added to the event, subsequently whenever you select the add ad hoc plan button, all the impacted assets that you select are added to this existing ad hoc plan.
...
11. To update the impact details, select \[Omitted image "InformationIcon.png"\] Alt text: Information icon of the respective record to launch the event asset and activated plan in the form view.

    1.  To view the plan details of an activated plan, select \[Omitted image "InformationIcon.png"\] Alt text: Information icon for the respective plan record in the impact grid.
    ...
    2.  Select the **Open Record** link next to the plan name.
