...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/generate-pdf-for-events.html
release: xanadu
topic_type: task
...
6.  To format the Events PDF template, follow the instructions in [Format PDF templates for BIAs, BCPs, and events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/update-pdf-format-for-bia-bcp-event.md).
