...
Report a Governance, Risk, and Compliance \(GRC\) issue from ServiceNow Otto® panel, Employee Center, or a plan or event record in Business Continuity Workspace.
...
2.  To report an issue from a plan or event record in Business Continuity Workspace, follow these steps.
    ...
    1.  Select an issue from the plan or event record.
        ...
        \[Omitted image "existing-issue-from-crisis-event-bcm-ws.png"\] Alt text: Issue from record.

    2.  Select **Summarize**.

        \[Omitted image "summarize-bcm-issue-from-record.png"\] Alt text: Issue summary.

    3.  Open the ServiceNow Otto for IRM AI agent and provide the details.

    4.  In the ServiceNow Otto for IRM panel, select **Edit details**, **Cancel**, or **Submit**.

        After submission, the ServiceNow Otto for IRM panel confirms the receipt and displays your issue request number.

3.  To activate a Report a GRC issue AI agent from the ServiceNow Otto for IRM panel, follow the instructions in [Activate the Report a GRC issue AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/grc-common-functions/activate-the-issue-submission-ai-agent.md).

4.  To report a GRC issue from the Employee Center, follow the steps outlined in [Report a GRC issue](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/grc-common-functions/report-a-grc-issue.md).

5.  Track your issue requests from the Employee Center.

    Your GRC issue is created in a **New** state and assigned a request number \(for example, IPT0020004\). The compliance team receives a notification and begins an initial review. You can track the issue status anytime under **My Requests** in your user portal.

    \[Omitted image "open-submitted-issues-from-emp-center.png"\] Alt text: Open issues.\[Omitted image "submitted-issue-details.png"\] Alt text: Submitted issues.
...
[Exploring AI capabilities in BCM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/bcm-exploring-ai-skills.md)
