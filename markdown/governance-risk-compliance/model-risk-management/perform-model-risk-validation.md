...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/model-risk-management/perform-model-risk-validation.html
release: yokohama
...
3.  In the Pre-deployment state, select **Open task**.
    ...
    \[Omitted image "validation-task-workflow.png"\] Alt text: Model risk validation task workflow.

    The model risk validation task workflow opens.

4.  To send an evidence collection request, select **Create Request**.

    For more information, see [Request evidence for model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/model-risk-management/request-evidence-for-model.md).
...
-   **[Request evidence for model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/model-risk-management/request-evidence-for-model.md)**  
