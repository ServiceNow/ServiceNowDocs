...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/create-sm-asmt-temp-as-ws.html
release: xanadu
topic_type: task
...
4.  Navigate to the **General** tab.
    ...
    For information on creating an assessment template, see [Create an assessment template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/smart-assessment-engine/sae-asmnt-template-create.md).
...
Configure the vulnerability type after adding the Smart Assessment template. For more information, see [Set up the Operational vulnerability type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/set-up-op-vul-type.md).
