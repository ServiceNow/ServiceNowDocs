...
While upgrading from Release 15.x.x to Release 16.x.x, a response task is not created automatically if a participant is already added to a scenario analysis in the **Analyze** state. This is a known issue.
