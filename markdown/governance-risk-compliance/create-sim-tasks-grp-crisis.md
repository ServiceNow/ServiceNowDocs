...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/create-sim-tasks-grp-crisis.html
release: xanadu
topic_type: task
...
For information on identifying and grouping duplicate event tasks, see [Grouping similar event tasks in events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/identifying-running-dup-tasks-once.md).

For information on the state changes for event tasks in similar tasks groups, see [State changes for event tasks in groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/transition-states-of-event-task.md).
