...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/policy-and-compliance-management/enable-other-apps-to-request-policy-exceptions.html
release: australia
