...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/policy-and-compliance-management/approve-lib-import-task.html
release: yokohama
...
7.  Click **Import**.
    ...
    **Note:**
    ...
    \[Omitted image "import-transformer-role-summary.png"\] Alt text: Task completed and import\_transformer role view summary.
