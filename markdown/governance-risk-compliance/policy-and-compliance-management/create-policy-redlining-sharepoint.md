...
3.  Navigate to **Compliance library** &gt; **My policies**.
    ...
    You can [create a new policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/grc-compliance-management-workspace/create-policy-ws.md) or open a policy record to associate a document.
