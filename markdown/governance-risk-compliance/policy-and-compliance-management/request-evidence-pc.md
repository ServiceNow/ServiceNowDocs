...
9.  Click **Request Evidence**.
    ...
    When a new evidence collection detail is added to an evidence request in the Work in Progress state, the task is sent to the assignee immediately.
