...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/policy-and-compliance-management/mobile-remed-tasks-p-and-c.html
release: xanadu
...
2.  With the Policy and Compliance landing screen displayed, under the section titled, `Team's Unassigned Work`, tap **Remediation Tasks**.
    ...
    \[Omitted image "mobile\_Policy\_and\_Compliance\_overview-app\_rd.png"\] Alt text: Remediation Tasks applet highlighted.
...
3.  See [Filter records with the GRC Mobile application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/policy-and-compliance-management/mobile-pc-set-filters.md) to search for records that match specific search criteria.
...
4.  To edit or assign a task directly from the list of records displayed on the Remediation Tasks screen, swipe left on a record to open the menu.
    ...
    \[Omitted image "mobile-remedtask-swipe.jpg"\] Alt text: Remediation Tasks swipe menu.

5.  In the menu that is displayed, choose one to continue.

<table id="choicetable_x5p_j3z_xhb"><thead><tr><th align="left" id="d99172e178">

Option

</th><th align="left" id="d99172e181">

Description

</th></tr></thead><tbody><tr><td id="d99172e187">

**Edit**

</td><td>

In the Extend by days field on the Edit Remediation Task screen that is displayed, enter a value. This value is added to the Duration field in your ServiceNow AI Platform instance. To assign the remediation task, tap the Assigned to field and tap a name. Alternatively, enter a user name in the search field.
...
</td></tr><tr><td id="d99172e211">

**Assign**

</td><td>

On the Issue Assignment screen that is displayed, tap the **Assignment Group** and **Assigned to** fields to assign the issue.

</td></tr></tbody>
</table>6.  Alternatively, with the Remediation Tasks screen displayed, tap a record on the list to open it and review more details.
...
<table id="choicetable_sjk_w3z_xhb"><thead><tr><th align="left" id="d99172e254">

Option

</th><th align="left" id="d99172e257">

Description

</th></tr></thead><tbody><tr><td id="d99172e263">
...
Tap the Issue field to expand it. On the Issue screen, a list of records is displayed. Tap an item to display more details about the Control Objective and Control/Risk.
...
**Parent Topic:**[Managing mobile experience for GRC Policy and Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/policy-and-compliance-management/mobile-policy_compliance-ovrvw.md)
