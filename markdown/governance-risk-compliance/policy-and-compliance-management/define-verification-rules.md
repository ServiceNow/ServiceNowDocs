...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/policy-and-compliance-management/define-verification-rules.html
release: yokohama
...
2.  Click **New**.
    ...
    \[Omitted image "verification-rule-new.png"\] Alt text: Verification rule
