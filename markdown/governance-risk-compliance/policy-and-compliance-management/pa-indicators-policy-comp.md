...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/policy-and-compliance-management/pa-indicators-policy-comp.html
release: zurich
...
**Note:** Note: Content can be a policy statement or a risk statement and item can be a control or a risk.
...
[List of plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown)
