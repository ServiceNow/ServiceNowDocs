...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/policy-and-compliance-management/mobile-pc-set-filters.html
release: yokohama
...
6.  Tap the intersection union after you set all criteria to create AND conditions.\[Omitted image "mobile-filter-1.jpg"\] Alt text: Intersection icon AND.\).
