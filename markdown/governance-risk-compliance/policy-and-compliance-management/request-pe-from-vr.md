...
3.  In Vulnerability Response, the remediation owner [Request an exception using GRC: Policy and Compliance Management](https://www.servicenow.com/docs/access?context=integration-with-grc&version=zurich&pubname=zurich-security-management&ft:locale=en-US) .
