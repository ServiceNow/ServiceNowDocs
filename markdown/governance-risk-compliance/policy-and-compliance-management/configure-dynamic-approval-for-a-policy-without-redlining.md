...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/policy-and-compliance-management/configure-dynamic-approval-for-a-policy-without-redlining.html
release: australia
...
6.  Select the approval method in the **Approval method** field.
    ...
    For more information on creating a policy in the Compliance Workspace, see [create a new policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/grc-compliance-management-workspace/create-policy-ws.md).
