...
6.  Select the approval method in the **Approval method** field.
    ...
    For more information on creating a policy in the Compliance Workspace, see [create a new policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/grc-compliance-management-workspace/create-policy-ws.md).
