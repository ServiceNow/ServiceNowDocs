---
title: Configure dynamic approval configuration on a policy
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/policy-and-compliance-management/configure-dynamic-approval-for-a-policy-without-redlining.html
release: yokohama
...
6.  Select the approval method in the **Approval method** field.
    ...
    For more information on creating a policy in the Compliance Workspace, see [create a new policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-compliance-management-workspace/create-policy-ws.md).
