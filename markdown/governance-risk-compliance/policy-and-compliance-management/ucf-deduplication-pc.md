...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/policy-and-compliance-management/ucf-deduplication-pc.html
release: yokohama
...
-   Import data from the UCF Shared list. To download a UCF shared list, see [Download a UCF shared list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/policy-and-compliance-management/download-a-shared-list.md).
