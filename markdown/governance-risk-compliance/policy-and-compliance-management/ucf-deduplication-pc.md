...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/policy-and-compliance-management/ucf-deduplication-pc.html
release: xanadu
...
breadcrumb: [Integrate with UCF Common Controls Hub to manage compliance frameworks, Configure the UCF integration using the UCF Common Controls Hub, Manage the UCF integration, Using the Classic user interface for Policy and Compliance tasks, Policy and Compliance Management, Governance, Risk, and Compliance]
---
...
-   Import data from the UCF Shared list. To download a UCF shared list, see [Download a UCF shared list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/policy-and-compliance-management/download-a-shared-list.md).
...
**Parent Topic:**[Integrate with UCF Common Controls Hub to manage compliance frameworks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/policy-and-compliance-management/c_UCF.md)
