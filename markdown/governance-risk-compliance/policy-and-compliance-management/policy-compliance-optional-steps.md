...
-   **[Set up GRC Virtual Agent for requesting an exception to a policy or a control objective](../../grc-policy-and-compliance/task/grc-virtual-agent-for-policy-exception.md)**  
...
-   **[Define policy exceptions and extensions with the GRC Approval Configurator](../../grc-policy-and-compliance/concept/define-policy-exceptions-and-extensions-with-the-grc-approval-configurator.md)**  
