---
title: Configure dynamic approval configuration on a policy with redlining enabled
description: Set up dynamic approval configuration on a policy for which redlining is enabled.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/policy-and-compliance-management/configure-dynamic-approval-for-policy-redlining.html
release: xanadu
...
3.  Navigate to **Compliance library** &gt; **My policies** and open a policy record.
    ...
    You can [create a new policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-compliance-management-workspace/create-policy-ws.md) or open a policy record to enable the redlining feature.
