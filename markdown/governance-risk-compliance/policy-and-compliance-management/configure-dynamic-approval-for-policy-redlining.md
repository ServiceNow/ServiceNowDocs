...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/policy-and-compliance-management/configure-dynamic-approval-for-policy-redlining.html
release: australia
...
3.  Navigate to **Compliance library** &gt; **My policies** and open a policy record.
    ...
    You can [create a new policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/grc-compliance-management-workspace/create-policy-ws.md) or open a policy record to enable the redlining feature.
