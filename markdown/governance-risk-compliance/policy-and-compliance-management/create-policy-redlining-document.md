...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/policy-and-compliance-management/create-policy-redlining-document.html
release: australia
...
2.  In the Compliance Workspace, select\[Omitted image "ws-list-icon.png"\] Alt text: Lists icon. from the sidebar.
