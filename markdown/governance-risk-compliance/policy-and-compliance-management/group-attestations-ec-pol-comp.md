...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/policy-and-compliance-management/group-attestations-ec-pol-comp.html
release: xanadu
...
3.  Select the Tasks \[Omitted image "TasksIcon.jpg"\] Alt text: Tasks icon. icon on the left pane.
...
6.  Select a **Response type** in the Group assessments pop-up.
    ...
    For more information on the response types, see [Consolidate control attestations using the Same Response feature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/policy-and-compliance-management/c_Attestations.md).
