...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/policy-and-compliance-management/upload-word-doc-googledrive.html
release: yokohama
...
4.  Select a policy and click the Policy text related list.
...
11. After the file is attached, select **Upload**.
    ...
    The selected file is uploaded to the Google Drive folder link that you'd specified.
