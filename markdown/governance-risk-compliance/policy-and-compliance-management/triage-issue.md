...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/policy-and-compliance-management/triage-issue.html
release: xanadu
...
breadcrumb: [Report self-identified issues via the Service Portal, Manage issues in Policy and Compliance Management, Using the Classic user interface for Policy and Compliance tasks, Policy and Compliance Management, Governance, Risk, and Compliance]
---
...
**Parent Topic:**[Report self-identified issues via the Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/policy-and-compliance-management/create-self-identified-issues.md)
