...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/policy-and-compliance-management/complete-publishing-checklist-redlining.html
release: zurich
...
2.  In the Compliance Workspace, select \[Omitted image "ws-list-icon.png"\] Alt text: Lists icon..
...
6.  To view your attachments, select the attachment icon in the right panel.
