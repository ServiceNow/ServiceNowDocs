...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/policy-and-compliance-management/api-batch.html
release: xanadu
...
To learn how you can use the user roles to access the APIs and batch records, see [User roles for the integration process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-common-functions/int-integrator-user-roles.md).
