...
4.  Choose one or more jurisdictions from the list \(for example, North America, EU, APAC\).
    ...
    For more information on creating jurisdictions, see [Map the taxonomy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/regulatory-change-management-service-portal/manage-taxonomy.md).
