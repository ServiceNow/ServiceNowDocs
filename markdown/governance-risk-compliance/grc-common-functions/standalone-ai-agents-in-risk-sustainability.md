...
-   Control Objective Change Agent
    ...
    For more information, see [Use the control objective change agent to update control objectives](../../grc-policy-and-compliance/task/update-impacted-control-objectives-AI.md).
