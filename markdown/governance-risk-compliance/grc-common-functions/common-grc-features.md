...
-   **[Using the item generation process to generate controls and risks](item-generation-process.md)**  
...
-   **[Using Approver Configurator for setting up approvals](approval-configuration.md)**  
...
-   **[Confidential records](confidential-records.md)**  
...
-   **[User group-based access on the GRC tables](user-groups.md)**  
...
-   **[Content references in GRC](content-references.md#)**  
...
-   **[Entity Based Access](entity-based-access.md)**  
...
-   **[Manage issues](manage-issues-common-core.md)**  
...
-   **[Domain separation in GRC](grc-domain-separation.md)**  
...
-   **[Breadcrumb navigation](breadcrumb-navigation.md)**  
...
-   **[Advanced Governance, Risk, and Compliance Application Risk dashboard](advanced-grc-dashboard.md)**  
...
-   **[GRC licensing summary dashboard](grc-licensing-summary-dashboard.md)**  
...
-   **[Microsoft Word based audit report templates using Document designer](document-designer-template.md)**  
...
-   **[Workspace page configuration](workspace-page-configuration.md)**  
A common record page can be used and configured within all the GRC applications.
-   **[Governance, Risk, and Compliance reference](grc-reference.md)**  
