...
-   **[Create a new Issue Page Configuration record](../task/create-new-issue-page-configuration.md)**  
...
-   **[Link a new Issue Page Configuration record to a workspace](../../grc-common-workspace/task/link-new-issue-config-record-to-the-ws.md)**  
...
-   **[Update an Issue Page Configurations record](../task/update-issue-page-configuration.md)**  
