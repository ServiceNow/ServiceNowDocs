...
2.  Select Now Assist Virtual Agent.
    ...
    \[Omitted image "now-assist-va.png"\] Alt text: Now Assist Virtual Agent icon in Employee Center.

3.  Select **Report a GRC issue**.

    \[Omitted image "report-grc-issue.png"\] Alt text: Report a GRC issue option in the Virtual Agent panel.
...
<table id="choicetable_r54_x4l_3hc"><thead><tr><th align="left" id="d297363e300">

Option

</th><th align="left" id="d297363e303">

Action

</th></tr></thead><tbody><tr><td id="d297363e309">
