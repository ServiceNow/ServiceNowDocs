...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-common-functions/report-a-grc-issue.html
release: yokohama
...
2.  Select Now Assist Virtual Agent.
    ...
    \[Omitted image "now-assist-va.png"\] Alt text:

3.  Select **Report a GRC issue**.

    \[Omitted image "report-grc-issue.png"\] Alt text:
...
<table id="choicetable_r54_x4l_3hc"><thead><tr><th align="left" id="d134404e295">

Option

</th><th align="left" id="d134404e298">

Action

</th></tr></thead><tbody><tr><td id="d134404e304">
