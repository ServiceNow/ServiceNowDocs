...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-common-functions/configure-confidential-record.html
release: yokohama
...
2.  Select **Yes** for **Enable record level confidentiality** property and click **Save**.
