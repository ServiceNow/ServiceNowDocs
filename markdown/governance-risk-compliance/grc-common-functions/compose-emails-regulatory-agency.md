...
2.  Select the list icon ![](../../grc-workspace-vrm/image/ws-list-icon.png) and then Navigate to **Regulatory information** &gt; **Agencies** and select the agency you want to compose an email for.
