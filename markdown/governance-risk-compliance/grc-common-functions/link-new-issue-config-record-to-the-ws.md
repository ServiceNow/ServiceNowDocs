...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-common-functions/link-new-issue-config-record-to-the-ws.html
release: yokohama
...
1.  Create a new issue configuration in the Issue page configurations record.
    ...
    For instructions, see [Create a new Issue Page Configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/create-new-issue-page-configuration.md).
