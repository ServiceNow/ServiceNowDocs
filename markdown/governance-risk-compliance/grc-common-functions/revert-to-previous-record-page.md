...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-common-functions/revert-to-previous-record-page.html
release: yokohama
...
2.  Click the workspace in which you want to make changes, from the **My Experiences** list.

3.  Click **Record** page that belongs to your workspace from the .

4.  In the record page, click **Developer** listed under **Menu** tab and click **Open variant collection**.
...
5.  Click the variant for which you want to change the order.
...
**Parent Topic:**[Configure workspace page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/configure-workspace-page.md)
