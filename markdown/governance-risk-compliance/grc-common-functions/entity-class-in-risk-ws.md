...
Entity classes are listed under Lists in the workspace view. Select an entity class in the List view to display its details.
...
</table>To save the newly created entity class configuration, select **Save**.
