...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-common-functions/exploring-document-designer-template.html
release: yokohama
...
This feature enables customers to build audit report templates using a Word template. They can configure the template, apply it to one or more audit engagements, and generate the audit report in Word format. The generated report can then be collaboratively edited using Document designer, streamlining the review and approval process.
...
**Parent Topic:**[Microsoft Word based audit report templates using Document designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/document-designer-template.md)
