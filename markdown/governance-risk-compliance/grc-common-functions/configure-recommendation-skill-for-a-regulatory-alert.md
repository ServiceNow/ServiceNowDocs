...
4.  Select the General details section to review the following fields and confirm that the recommendation skill meets your requirements.
    ...
    **Note:**
    ...
    -   [Make a copy of a Now Assist skill](https://www.servicenow.com/docs/access?context=make-a-copy-of-a-now-assist-skill&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US)
...
<table id="choicetable_mvq_4wl_tgc"><thead><tr><th align="left" id="d31874e344">

Option

</th><th align="left" id="d31874e347">

Description

</th></tr></thead><tbody><tr><td id="d31874e353">
