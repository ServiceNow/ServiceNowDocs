...
-   **[Entities in GRC](what-is-an-entity.md)**  
...
-   **[Composite entity in Governance, Risk, and Compliance](../../grc-common-workspace/concept/composite-entity-in-grc.md)**  
...
-   **[An entity in the workspace view](../../grc-common-workspace/concept/entities-in-risk-ws.md)**  
...
-   **[Functionality enhancements for the entities](enhancements-for-entities.md)**  
You can configure some functionality enhancements for the entities as part of the GRC updates.
-   **[Entity scoping in GRC](c_Scoping.md)**  
...
-   **[Entity classes](../../grc-common-workspace/concept/entity-class-in-risk-ws.md)**  
...
-   **[Entity class rules](../../grc-common-workspace/concept/entity-class-rules-in-risk-ws.md)**  
...
-   **[Entity types](../../grc-common-workspace/concept/entity-type-in-risk-ws.md)**  
...
-   **[Entity tiers](../../grc-common-workspace/concept/entity-tier-in-risk-ws.md)**  
