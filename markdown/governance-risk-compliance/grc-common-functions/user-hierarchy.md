...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-common-functions/user-hierarchy.html
release: xanadu
...
-   **[Create a user hierarchy configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-common-functions/configure-a-new-user-hierarchy-configuration-record.md)**  
