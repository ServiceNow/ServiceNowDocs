...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-common-functions/relate-profiles-to-each-other.html
release: xanadu
...
<table id="choicetable_cyx_ljg_lw"><tbody><tr><td id="d258687e131">
