...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-common-functions/confidentiality-inheritance-configuration-record.html
release: xanadu
