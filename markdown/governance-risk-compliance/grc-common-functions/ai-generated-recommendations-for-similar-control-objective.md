...
To generate recommendations for a control objective you must configure Now Assist for integrated risk management and activate the rationalization skill, refer to [Configure Now Assist for Integrated Risk Management \(IRM\)](../../grc-common/concept/configure-now-assist-for-irm.md) and [Activate the rationalization skill for control objective](activate-the-rationalization-skill-for-control-objective.md) for more information.
...
[Activate the rationalization skill for control objective](activate-the-rationalization-skill-for-control-objective.md)
