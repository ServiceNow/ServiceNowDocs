...
To verify that these applications are activated, navigate to **Subscription Management** &gt; **Subscriptions** in your instance. The list displays the subscriptions your organization has purchased.
 ...
 For more information about the setup and activation of the Risk Management plugin, see [Install Risk Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/grc-risk-management-workspace/install-risk-store-app.md)
