...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-common-functions/create-a-recommendation-template.html
release: yokohama
...
Create a recommendation context before you create a recommendation template. For more information, see [Recommendation contexts and templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/recommendation-contexts.md).
...
4.  On the **Relationship section** tab, enter **Heading** and **Sub heading**.
    ...
    For example, you can [fetch recommendations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/create-recommendation-reg-alert.md) for remediation tasks for an issue by using the ServiceNow Otto for IRM application.
