...
You must have notification routing rules configured before modifying notifications. For more information, see [Modify email notifications to use notification redirection](modify-email-notifications-to-use-notification-redirection.md).
...
**Parent Topic:**[Configure GRC notification redirection](configure-email-notification-redirection.md)
