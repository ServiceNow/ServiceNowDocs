...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/grc-common-functions/configure-continuous-eba-monitoring-on-record-types.html
release: zurich
