...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-common-functions/taxonomy-management.html
release: xanadu
...
**Note:** If you have downloaded the Regulatory Change Management application previously and you are upgrading to the Xanadu GA release, copy the data from the old taxonomy tables to the new taxonomy tables.
