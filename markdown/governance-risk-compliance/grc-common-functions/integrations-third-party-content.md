...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-common-functions/integrations-third-party-content.html
release: xanadu
...
In Xanadu, you can use the GRC: integrations with third-party content application with the GRC: Policy and Compliance integrator application. The GRC: Policy and Compliance integrator application provides the options that enable you to review, approve, and import the data into the Policy and Compliance Management tables.
...
\[Omitted image "integrator-application-download.png"\] Alt text: GRC: Policy and Compliance integrator application download structure.
...
For more information on the user roles, see [User roles for the integration process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-common-functions/int-integrator-user-roles.md) and [Create a user with the sn\_grc\_cim.admin role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-common-functions/create-user-with-cim-manager-role.md).

-   **[User roles for the integration process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-common-functions/int-integrator-user-roles.md)**  
...
-   **[Create a user with the sn\_grc\_cim.admin role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-common-functions/create-user-with-cim-manager-role.md)**  
...
**Parent Topic:**[Governance, Risk, and Compliance integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-common-functions/grc-integrations.md)
