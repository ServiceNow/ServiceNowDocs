...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-common-functions/create-composite-entity-ws.html
release: yokohama
...
4.  On the form, fill in the fields.
    ...
    For a description of the field values on the Create New Entity form, see [Create new composite entity form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/create-new-composite-entity-form-ws.md).
...
5.  Select **Save**.
    ...
    **Note:** When you create an entity, only the **Details** tab is displayed. After the entity is created, the **Overview** tab, **Details** tab, and other related lists are displayed.
    ...
    For information on the fields in these related lists, see [An entity in the workspace view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/entities-in-risk-ws.md).


-   **[Create new composite entity form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/create-new-composite-entity-form-ws.md)**  
...
**Parent Topic:**[Composite entity in Governance, Risk, and Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/composite-entity-in-grc.md)

**Related topics**  


[Create an entity class](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/create-new-entity-class-ws.md)
