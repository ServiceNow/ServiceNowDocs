...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-common-functions/components-item-gen-process.html
release: xanadu
...
</table>**Note:** For more information on the item generation process for common controls, see [the new action types in generation of items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-common-functions/item-gen-action-types.md).
...
</table>**Parent Topic:**[Using the item generation process to generate controls and risks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-common-functions/item-generation-process.md)
