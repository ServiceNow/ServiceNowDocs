...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/grc-common-functions/review-and-accept-entity-changes.html
release: zurich
...
-   Entity approvals must be configured for the applicable change type. See [Configure entity approvals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/grc-common-functions/configure-entity-approvals.md).
