...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/privacy-workspace/configure-request-types-and-map-jurisdictions.html
release: yokohama
...
3.  Select **Submit** to create the new request type.
...
6.  Select **Submit** to create the new jurisdiction mapping.
