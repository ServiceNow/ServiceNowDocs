...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/privacy-workspace/pcm-state-model-transition-condition-form.html
release: yokohama
...
</table>**Parent Topic:**[Define the model state transitions for a privacy case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/privacy-workspace/create-a-model-state-transition-for-privacy-case.md)
