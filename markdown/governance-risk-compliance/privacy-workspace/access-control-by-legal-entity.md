...
For information about configuring access control, see [Configuring access control](configure-access-control-by-legal-entity.md).
...
-   **[Configuring access control](configure-access-control-by-legal-entity.md)**  
