...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/privacy-workspace/tag-io-with-pi.html
release: yokohama
...
2.  In the Privacy Workspace, click the List icon \(\[Omitted image "ws-list-icon.png"\] Alt text: List icon.\).
...
**Parent Topic:**[Manage the Privacy Management library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/privacy-workspace/privacy-library-setup.md)
