...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/privacy-workspace/entity-scoping-in-privacy-mgmt.html
release: yokohama
...
-   **Discover processing activities by their usage of personal information**
    ...
    \[Omitted image "business-process-with-io.jpg"\] Alt text: Business process with information objects associated with it.
...
-   **Identify potential entities and sending initial privacy assessments**
    ...
    \[Omitted image "send-privacy-asmt-entities.jpg"\] Alt text: Send privacy assessments to entities to determine personal data.


After the entities are scoped, then, in the applications, only those entities appear that contain personal information.

-   **[Scope entities to discover processing activities with personal information](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/privacy-workspace/scope-entities-with-pi.md)**  
