...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/privacy-workspace/prm-create-state-model-transition.html
release: yokohama
...
-   **[Define the workflow states for a privacy case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/privacy-workspace/define-pcm-workflow-states.md)**  
Define the workflow states for a privacy case that govern the lifecycle of the case.

**Parent Topic:**[Configuring Privacy Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/privacy-workspace/configuring-privacy-case-management.md)
