...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/privacy-workspace/smart-assessments-in-privacy-management.html
release: yokohama
...
To perform these assessments, you can use the Smart Assessment Engine application. This application provides several benefits such as configuration of templates, workflows, guidance for questions, and reviewing of assessment results with actionable insights. For more information about the Smart Assessment Engine application, refer to [Exploring Smart Assessment Engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/smart-assessment-engine/smart-assessment-engine-cf-explore.md).
...
-   **Privacy screening assessment**
    ...
    For detailed information on how to configure a screening assessment template, see [Configure smart assessment templates for screening assessments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/privacy-workspace/configure-a-smart-assessment-template.md).

    \[Omitted image "privacy-screening-asmt.png"\] Alt text: Privacy screening assessment page.
...
**Parent Topic:**[Exploring Privacy Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/privacy-workspace/explore-privacy-management.md)
