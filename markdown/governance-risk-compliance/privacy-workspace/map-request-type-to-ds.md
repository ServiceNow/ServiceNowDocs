...
Verify that the data subject types are mapped to their relevant jurisdictions. For steps, see [Configure the data subject types for a jurisdiction](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/privacy-workspace/config-pdr-ds-types.md).
...
<table><thead><tr><th align="left" id="d106543e124">

Choice

</th><th align="left" id="d106543e127">

Steps

</th></tr></thead><tbody><tr><td id="d106543e133">
