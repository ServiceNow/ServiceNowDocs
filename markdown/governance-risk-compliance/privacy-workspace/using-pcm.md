...
-   **[Reporting a privacy case](reporting-a-privacy-case.md)**  
Any user can report a privacy case or an event that needs the attention of the privacy team.
-   **[Report a privacy case through email](../task/add-issues-email.md)**  
...
-   **[Initiate a breach assessment from a case](../task/initiate-a-breach-assessment-from-a-case.md)**  
...
-   **[Work on a privacy breach assessment](../task/work-on-a-privacy-breach-asmt.md)**  
Accept the work of assessing a privacy breach assessment and work on the assessment.
-   **[Case task workflow](case-task-workflow.md)**  
...
-   **[Add causes and consequences to a privacy case](../task/add-causes-consequences.md)**  
...
-   **[Add a privacy regulation related to a case](../task/add-regulations.md)**  
...
-   **[Add or create an issue for a privacy case](../task/add-issues.md)**  
Identify and manage issues related to the impacted areas for the reported privacy case. You can also create issues from the Privacy Case Management landing page.
-   **[Export a privacy case as a PDF](../task/export-a-privacy-case-as-a-pdf.md)**  
Export a privacy case as a PDF to easily share it with various stakeholders.
-   **[Send an email from a privacy case](../task/send-email-from-a-privacy-case.md)**  
...
-   **[Perform smart assessment on privacy action task](../task/perform-smart-assessment-on-privacy-action-task.md)**  
