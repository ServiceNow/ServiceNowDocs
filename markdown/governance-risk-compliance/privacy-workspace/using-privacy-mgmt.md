...
-   **[Entity scoping to plan a privacy program](entity-scoping-in-privacy-mgmt.md)**  
...
-   **[Types of privacy assessments](privacy-assessments.md)**  
...
-   **[Respond to a privacy smart assessment](../task/respond-to-a-privacy-smart-assessment.md)**  
...
-   **[Respond to a privacy screening assessment](../task/respond-to-privacy-assmnt.md)**  
...
-   **[Review a privacy assessment](../task/review-a-privacy-assessment.md)**  
...
-   **[Create or update a processing activity](../task/create-processing-activity.md)**  
...
-   **[Create or manage an information object within a processing activity](../task/create-manage-io-on-pa.md)**  
...
-   **[Add data subject type to a processing activity](../task/add-a-new-data-subject-type.md)**  
Add data subject types to a processing activity in the Privacy Workspace.
-   **[Add data subject type to privacy impact assessment](../task/add-data-subject-type-to-pia.md)**  
Add data subject types to privacy impact assessment from the Employee Center.
-   **[Classify data subject type as vulnerable](classify-data-subject-type-as-vulnerable.md)**  
...
-   **[Add key stakeholders and send privacy assessments](../task/add-stakeholders-to-a-pa.md)**  
...
-   **[Add a regulatory agency](../task/add-a-regulatory-agency.md)**  
...
-   **[Create or manage a control on a processing activity](../task/create-controls.md)**  
...
-   **[Delete a control from a processing activity](../task/delete-controls.md)**  
Delete the controls that are no longer required in the processing activity.
-   **[Create or manage risks on a processing activity](../task/create-or-manage-risks-on-a-pa.md)**  
...
-   **[Manage chat collaborations of a processing activity](../task/manage-discussions-of-a-pa.md)**  
...
-   **[Create or add issues on a processing activity](../task/create-or-manage-issues-on-a-pa.md)**  
...
-   **[Assign a processing activity to a key stakeholder](../task/assign-pa-to-keystakeholders.md)**  
...
-   **[Accessing control through organizational structure](../access-control-by-legal-entity.md)**  
