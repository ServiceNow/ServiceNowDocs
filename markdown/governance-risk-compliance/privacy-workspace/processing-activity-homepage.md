...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/privacy-workspace/processing-activity-homepage.html
release: xanadu
...
\[Omitted image "processing-activity-overview.png"\] Alt text: Reports on the processing activity overview page.
...
|-----|----|-----------|
|Compliance posture by month|Trend chart \[Omitted image "line-icon.png"\] Alt text: Line chart.|Compliance posture by month is plotted by referring to the processing activity compliance score.|
|Compliance status|Donut \[Omitted image "icon-donut-report.png"\] Alt text: Donut chart.|This report provides the compliance status of all the controls for the processing activity.|
|Controls \(by authority documents or by policies\)|Bar chart \[Omitted image "BarChart.png"\] Alt text: Bar chart.|This report provides the compliance status of the controls that are associated with the authority documents or policies.|
|Privacy assessments status|Single score \[Omitted image "icon-single-score-report.png"\] Alt text: Single score.|Shows the number of assessments that are open, overdue, and approaching due date.|
|Recently completed privacy assessments|List report \[Omitted image "icon-list-report.png"\] Alt text: List report.|Shows the list of recently completed privacy assessments.|
|Issues|Single score \[Omitted image "icon-single-score-report.png"\] Alt text: Single score.|Shows the number of issues that are open, overdue, and approaching due date.|
|Issues by priority|Donut\[Omitted image "icon-donut-report.png"\] Alt text: Donut chart.|Shows the issues by their priority.|
|Policy exceptions|Single score \[Omitted image "icon-single-score-report.png"\] Alt text: Single score.|Shows the number of policy exceptions that are active, expiring, and requested.|
|By risk rating|Donut\[Omitted image "icon-donut-report.png"\] Alt text: Donut chart.|Shows the policy exceptions by their risk ratings.|

**Parent Topic:**[Reporting for Privacy Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/privacy-workspace/reporting-prm.md)
