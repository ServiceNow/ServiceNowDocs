...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/privacy-workspace/pcm-workflow.html
release: yokohama
...
\[Omitted image "privacy-case-mgmt-workflow.jpg"\] Alt text: Life cycle of a privacy case after it is created.
...
3.  The case analyst triages and investigates the case and creates [Case task workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/privacy-workspace/case-task-workflow.md) tasks. Each task is assigned to a case task owner.
...
5.  The case analyst then does the following tasks:
    ...
    2.  Records \[PI\] information objects, key stakeholders, impacted areas, and related areas.
