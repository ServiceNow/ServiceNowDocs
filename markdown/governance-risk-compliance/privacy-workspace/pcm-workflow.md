...
3.  The case analyst triages and investigates the case and creates [Case task workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/privacy-workspace/case-task-workflow.md) tasks. Each task is assigned to a case task owner.
