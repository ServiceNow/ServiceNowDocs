...
6.  Edit the **General**, **Questions**, and **Automations** sections.
    ...
    For details about each section, see [Types of assessment templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/privacy-workspace/smart-assessments-in-privacy-management.md).
