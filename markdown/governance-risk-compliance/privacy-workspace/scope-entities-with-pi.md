...
Ensure that you created the CMDB queries. For more information on the CMDB queries, see [Querying the CMDB](https://www.servicenow.com/docs/access?context=querying-cmdb&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
-   Building your own query. For more information on building the CMDB queries, see [Querying the CMDB](https://www.servicenow.com/docs/access?context=querying-cmdb&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
...
![Predefined queries with associated information objects.](../image/entity-filters-io.jpg "Usage of predefined queries")
