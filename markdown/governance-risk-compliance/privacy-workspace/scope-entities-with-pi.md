...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/privacy-workspace/scope-entities-with-pi.html
release: yokohama
...
Ensure that you created the CMDB queries. For more information on the CMDB queries, see [Querying the CMDB](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/configuration-management-database-cmdb/querying-cmdb.md).
...
-   Building your own query. For more information on building the CMDB queries, see [Querying the CMDB](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/configuration-management-database-cmdb/querying-cmdb.md)
...
\[Omitted image "entity-filters-io.jpg"\] Alt text: Predefined queries with associated information objects.

**Parent Topic:**[Entity scoping to plan a privacy program](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/privacy-workspace/entity-scoping-in-privacy-mgmt.md)
