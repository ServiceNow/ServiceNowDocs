...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/add-event-task-to-crisis-event.html
release: xanadu
topic_type: task
...
For more information, see [Structured workflows for crisis events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/perform-tasks-to-manage-crisis-events.md).
