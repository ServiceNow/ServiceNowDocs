...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/configuring-event-dep-updates.html
release: xanadu
topic_type: concept
...
For more information on configuring the Event dependency source configuration record, see [Configure Event dependency source configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/conf-event-dep-source-confi-module.md).

-   **[Configure Event dependency source configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/conf-event-dep-source-confi-module.md)**  
Configure the sources for adding the event dependencies in the Event dependency source configuration record.

**Parent Topic:**[Dependency Configuration records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/dependency-config-modules.md)
