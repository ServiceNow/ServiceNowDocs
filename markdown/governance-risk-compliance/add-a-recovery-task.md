...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/add-a-recovery-task.html
release: xanadu
topic_type: task
...
4.  On the form, fill in the fields.
    ...
    For more information on the fields in the form, see [Create New Recovery task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/create-new-recovery-task-form.md).
...
-   **[Create New Recovery task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/create-new-recovery-task-form.md)**  
