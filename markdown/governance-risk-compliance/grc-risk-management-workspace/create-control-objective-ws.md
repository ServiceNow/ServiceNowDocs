...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-risk-management-workspace/create-control-objective-ws.html
release: yokohama
...
When a control objective and risk statement are associated and the control entity matches the risk entity, the risk-control association is created. This association helps in mitigating the risks and threats.

## Procedure

1.  Navigate to **All** &gt; **Risk** &gt; **Risk Workspace**.

2.  In the Risk Workspace, select the list \[Omitted image "ws-list-icon.png"\] Alt text: List. icon.
