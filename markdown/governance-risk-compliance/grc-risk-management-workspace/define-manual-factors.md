...
Option to transform the overall group qualitative score based on an interval scale.For example, assume the **User response** field is set to **Percentage**. As the admin, you can transform the percentage value into a qualitative score. In this example, 0% to 30% is low, 30% to 60% is medium, and 60% and higher is high. The ratings 1, 2, and 3 can be assigned to low, medium, and high.
...
Option to make comments mandatory when an assessor responds to this factor.
...
5.  Select the Qualitative Transformation Criteria related list.
