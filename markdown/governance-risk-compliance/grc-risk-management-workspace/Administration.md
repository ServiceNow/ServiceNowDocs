...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-risk-management-workspace/Administration.html
release: xanadu
...
Risk managers can create a new set of questions for each risk assessment. See [Create an assessment type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-risk-management-workspace/create-assessment-type.md).
