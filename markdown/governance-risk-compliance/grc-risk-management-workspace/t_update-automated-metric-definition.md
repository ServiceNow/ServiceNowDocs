...
</table>4.  To save the metric definition, select **Save**.

5.  To calculate the composite metric data for the composite metric definition, select **Aggregate**.
...
6.  To delete the metric definition, select **Delete**.
