...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-risk-management-workspace/perform-ara-workspace.html
release: yokohama
...
11. To select an appropriate strategy and to define the plan of action for the risks assessed, select **Next**, and do the following.
    ...
    2.  To create a risk response task, select the **Create task** button, and select the appropriate values.
        ...
        For more information, see [Create a risk response task in the Risk Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-risk-management-workspace/create-risk-response-task-risk-workspace.md).
...
16. To view the activities taking place for the assessment, select the Activity log icon \[Omitted image "activity-log.jpg"\] Alt text: Activity log icon..
...
[Generate a risk assessment summary](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-common-functions/generate-risk-assessment-summary-genai.md)
