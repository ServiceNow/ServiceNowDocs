...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-risk-management-workspace/configure-matrix-report-registry-risk-ws.html
release: yokohama
...
After the matrix relationship is complete, you can [Configure target table fields as columns for matrix report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/audit-management/matrix-report-relationship-audit-ws.md).
