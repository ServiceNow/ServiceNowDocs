...
-   Scan a QR code.
 For more information about the mobile app, see [Log in to an instance with a mobile app](https://www.servicenow.com/docs/access?context=login-end-user&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US)
