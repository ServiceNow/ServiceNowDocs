...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-risk-management-workspace/mobile-login-risk-mobileapp.html
release: yokohama
...
Verify that you have completed the setup steps described in [Set up checklist for the GRC Mobile application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-risk-management-workspace/mobile-setup-risk-app.md).

\[Omitted image "mobile\_Risk\_overview-app-redo.png"\] Alt text: Risk mobile app menu map.
...
-   Scan a QR code.
 For more information about the mobile app, see [Log in to an instance with a mobile app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/mobile/mobile-platform/login-end-user.md)
