...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-risk-management-workspace/schedule-risk-assessment-workspace.html
release: yokohama
...
2.  Select the list \[Omitted image "ListsIcon.jpg"\] Alt text: List icon..
