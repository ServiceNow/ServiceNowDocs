...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-risk-management-workspace/setup-checklist-advanced-risk.html
release: xanadu
...
2.  To generate a PDF, select the **Save As PDF** \[Omitted image "save-as-pdf.png"\] Alt text: Save as PDF icon icon and at the top of the topic and select **Selected topic**.
