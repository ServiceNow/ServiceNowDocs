...
2.  Select the project for risk assessment.
    ...
    Ensure that risks for this project are present. See [Add risks for a project](https://www.servicenow.com/docs/access?context=add-risks-for-project&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US).
