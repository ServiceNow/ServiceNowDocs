...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-risk-management-workspace/define-risk-appetite-on-entity.html
release: yokohama
...
4.  On the entity form, select the **Risk Appetite** section and fill in the fields.
    ...
    For a description of the field values, see [Risk appetite fields on the Entity form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-risk-management-workspace/risk-appetite-fields-on-entity.md).
...
-   **[Risk appetite fields on the Entity form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-risk-management-workspace/risk-appetite-fields-on-entity.md)**  
