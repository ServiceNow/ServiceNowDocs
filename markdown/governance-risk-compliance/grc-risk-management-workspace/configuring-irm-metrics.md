...
-   [Create a threshold for a metric](../task/t_create-threshold-for-metrics.md)

-   **[Create a manual metric definition](../task/t_create-manual-metric-definition.md)**  
Create a manual metric definition to collect the data manually for a metric.
-   **[Create an assignment configuration](../task/create-assign-config-mmd-irm.md)**  
...
-   **[Formula building in a calculated metric definition](formula-building-at-metric-definition-and-entity-level-irm.md)**  
In a calculated metric definition, you can create formulas to perform calculations for any data that you may require.
-   **[Update a metric definition](../task/t_update-automated-metric-definition.md)**  
...
-   **[Convert metric data to a different unit](../task/convert-md-irm.md)**  
...
-   **[Update a manually created metric](../task/t_update-manual-metric.md)**  
