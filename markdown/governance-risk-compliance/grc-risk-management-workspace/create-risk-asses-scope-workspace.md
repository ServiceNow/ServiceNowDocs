...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-risk-management-workspace/create-risk-asses-scope-workspace.html
release: yokohama
...
16. To go back in the workflow and change the scope, assignment, or frequency, select the menu \[Omitted image "icon-menu.png"\] Alt text: Menu icon. icon, and then select **Redefine scope**.
