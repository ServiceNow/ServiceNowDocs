...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/grc-risk-management-workspace/create-new-event-impact.html
release: zurich
...
-   **Link new control to risks**
    ...
    **Note:** Only those risks and controls that are tagged to the impacted entity can be related to this risk event.
    ...
    For more information, see [Create a control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/policy-and-compliance-management/t_CreateAControl.md).
