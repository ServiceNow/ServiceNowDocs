...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-risk-management-workspace/create-new-event-impact.html
release: yokohama
...
-   **Link new control to risks**
    ...
    **Note:** Only those risks and controls that are tagged to the impacted entity can be related to this risk event.
    ...
    For more information, see [Create a control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/policy-and-compliance-management/t_CreateAControl.md).
