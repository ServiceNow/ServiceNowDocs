...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-risk-management-workspace/enhancements-ws.html
release: yokohama
...
-   **List view**
    ...
    The list view shows a simplified list of all the modules. You can access the list view by clicking the List icon \(\[Omitted image "list-view.jpg"\] Alt text: List view icon.\).
