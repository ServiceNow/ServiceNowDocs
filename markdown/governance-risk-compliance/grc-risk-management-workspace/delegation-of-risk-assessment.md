...
As a risk assessor, to understand how you can assign a delegate, refer to [Configure a delegate for your tasks](https://www.servicenow.com/docs/access?context=t_DelegateApprovalsTasks&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).

To delegate tasks to another user, configure your user profile form to display the Delegates related list. For details, refer to [Add the Delegates related list](https://www.servicenow.com/docs/access?context=add-delegates-related-list&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
