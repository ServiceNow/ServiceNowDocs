...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-risk-management-workspace/risk-assessment-as-lite-user.html
release: yokohama
...
-   The lite users of other business units can only have two published [risk assessment methodologies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-risk-management-workspace/configure-ram.md).
-   [Automated factors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-risk-management-workspace/factors.md) are available for use.
-   Managing risk events and using the risk identification workflow are not available in limited risk assessments.

-   **[Risk score rollup in Privacy Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-risk-management-workspace/risk-rollup-in-bcm-privacy.md)**  
