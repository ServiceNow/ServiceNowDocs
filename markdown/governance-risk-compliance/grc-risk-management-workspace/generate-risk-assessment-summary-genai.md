...
Install the Now Assist for IRM application to generate a risk assessment summary.

Activate the Risk Assessment Summarization skill from the Now Assist Admin console to enable assessors and approvers to generate risk assessment summary.
