...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/continuous-risk-monitoring/define-auth-boundaries.html
release: xanadu
...
2.  Select **New** and then fill in the form.
    ...
    The settings are described in [Fields on the Authorization Boundary form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/continuous-risk-monitoring/cam-form-authorization-boundary.md).
