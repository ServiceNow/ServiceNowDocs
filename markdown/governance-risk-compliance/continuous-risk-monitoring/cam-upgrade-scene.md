...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/continuous-risk-monitoring/cam-upgrade-scene.html
release: xanadu
...
The following actions happen when you upgrade to the Xanadu release:
