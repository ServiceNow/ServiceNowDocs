...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/governance-risk-compliance/continuous-risk-monitoring/cam-upgrade-scene.html
release: brazil
...
The following actions happen when you upgrade to the Brazil release:
