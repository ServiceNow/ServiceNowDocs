...
1.  [Risk Management Framework \(RMF\) step 0 - Prepare the authorization package](prepare-auth-pkg.md)
...
2.  [Risk Management Framework \(RMF\) step 1 - Categorize the authorization package](../task/categorize.md)
...
3.  [Risk Management Framework \(RMF\) step 2 - Select controls for an authorization package](../task/select-controls.md)

    When the impact levels for the package have been approved, it is time to select baseline controls.

4.  [Risk Management Framework \(RMF\) step 3 - Implement controls](../task/implement-controls.md)
...
5.  [Risk Management Framework \(RMF\) step 4 - Assess implemented controls and document findings](../task/assess-control-effectiveness.md)
