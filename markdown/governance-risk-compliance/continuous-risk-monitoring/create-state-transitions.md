...
[Create GRC model state transition conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/continuous-risk-monitoring/add-state-transition-conditions.md)
