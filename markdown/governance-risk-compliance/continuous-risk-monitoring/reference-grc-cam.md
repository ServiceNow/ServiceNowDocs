...
-   **[Control requirement details in the CAM view of Control objective and Control forms](../reference/cam-cr-control-form.md)**  
The CAM view of the Control form has fields that have been added to capture the control requirement details.
-   **[Impact of associated compliance objects on control requirements](cam-cor-changes-impact.md)**  
...
-   **[Fields on the Roles and Responsibilities tab](../reference/cam-form-roles-responsibility-tab.md)**  
...
-   **[Configuring ATO artifacts report templates using the Document Designer with Word add-in](../reference/cam-configure-word-based-template.md)**  
