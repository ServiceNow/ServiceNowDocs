...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/continuous-risk-monitoring/cam-hybrid-controls.html
release: xanadu
...
breadcrumb: [RMF step 2 - Select controls for an authorization package, Continuous Authorization and Monitoring, Governance, Risk, and Compliance]
---
...
3.  To assign baseline controls from a common control provider as common controls, select the control objectives in the Baseline Controls tab that you want to assign as common controls.
    ...
    1.  Select **Mark as Common** and then select **OK** in the Confirmation popup.
