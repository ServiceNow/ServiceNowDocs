...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/continuous-risk-monitoring/add-impact-to-version.html
release: yokohama
...
3.  To view the impact list, select the expand icon \(\[Omitted image "WF-version-and-impact-icon.png"\] Alt text: impact expand icon\) in the **Versions** tab.
