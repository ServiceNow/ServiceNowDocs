...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/verify-response-to-the-assessment-in-ws.html
release: xanadu
topic_type: task
...
Having an approved Importance and impact tolerance assessment completes the workflow. To close an inactive assessment, see [Close the assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/approve-the-assessment-in-ws.md). Note that closed assessments are considered inactive.
