...
Having an approved Importance and impact tolerance assessment completes the workflow. To close an inactive assessment, see [Close the assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/approve-the-assessment-in-ws.md). Note that closed assessments are considered inactive.
