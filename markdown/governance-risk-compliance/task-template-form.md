...
Recovery phase that the task belongs to. The Phase set here takes precedence over a Phase filter on the parent list. See [Add recovery tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/add-a-recovery-task.md).
...
**Parent Topic:**[Configure Task templates and Task template groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/create-task-temp-temp-groups.md)
