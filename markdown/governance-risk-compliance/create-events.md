...
5.  In the **Event group** field, select an event group.
    ...
    For a description of the field values in the form, see [Event record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/event-reference.md).
