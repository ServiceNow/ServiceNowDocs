...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/compliance-case-management/workflow-state-form.html
release: yokohama
...
breadcrumb: [Create a workflow state for a compliance case or request, Configuring Compliance Case Management, Compliance Case Management, Governance, Risk, and Compliance]
---
...
</table>**Parent Topic:**[Create a workflow state for a compliance case or request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/compliance-case-management/create-workflow-state.md)
