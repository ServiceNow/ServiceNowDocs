...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/compliance-case-management/ccm-workspace.html
release: yokohama
...
You can launch the compliance case management landing page by using the launcher \(\[Omitted image "compliance-case-launcher.png"\] Alt text: Compliance case launcher.\) icon.
...
Overview of the events or cases that need immediate attention: -   **Overdue cases**
...
Graphical representation of all the active cases by their state, breach status, and priority:-   **By state**
...
Trends about your cases:-   Reported cases by the affected business units and geographical locations.
-   Cases by Syb-type.
...
Items to track:-   Number of open issues for a compliance case
...
<table id="table_wks_m2s_wxb"><thead><tr><th>
...
Overview of the requests that need immediate attention: -   **Active requests**
...
Graphical representation of all the active requests by their state, priority, and business units:-   **By state**
...
Number of compliance requests that are open, approved, rejected, and canceled in the last 12 months, and requests by sub-types.There are drill-down capabilities. When you click the individual sector you are navigated to a list view to get more rich and contextual information.

</td></tr></tbody>
</table>## My tasks section
