...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/compliance-case-management/case-task-form.html
release: yokohama
...
breadcrumb: [Create an action task, Compliance case task workflow, Using Compliance Case Management, Compliance Case Management, Governance, Risk, and Compliance]
---
...
</table>**Parent Topic:**[Create an action task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/compliance-case-management/create-a-case-task.md)
