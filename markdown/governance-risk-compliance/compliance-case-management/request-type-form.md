...
|State Model|
|State Model|Workflow states for the request type. For more information, see [Create a state model to define the workflow states and transitions](../task/create-state-model.md).|
