...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/compliance-case-management/add-impacted-areas-to-compliance-case.html
release: xanadu
...
You can specify the impacted areas or objects, such as the entities, controls, companies, and users that are affected by the compliance case.
