...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/bia-impact-categories.html
release: xanadu
topic_type: concept
...
For more information on how to configure an impact category with the sn\_bcm.admin role, see [Configure impact category for BIA](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/configure-impact-category-uib-ws.md).
...
For more information on how to configure an impact rating with the sn\_bcm.admin role, see [Configure impact ratings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/configure-impact-rating-uib-ws.md).
