...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/home-page-uib-ws.html
release: yokohama
topic_type: concept
...
The Home page in Business Continuity Workspace provides an overview of the BCM functional components in an interactive dashboard. The visualizations help the Workspace users to know the status of their tasks and act on them in an organized manner. The Home page consists of the following tabs:
...
The **Crisis events** tab in the Home page displays various cards that offer information on the crisis events. You can review the crisis events in various states, details of the selected crisis events, and monitoring and tracking of the crisis events. The following example shows the cards in the **Crisis events** tab.

\[Omitted image "bcm-manager-homepage-view.png"\] Alt text: Crisis events tab in the Home page.

See the following table for the description of the cards in the **Crisis events** tab:
...
Overview of the crisis events in different states. You can view the details of the crisis events in the following states:-   **In progress**
...
Details of the crisis events for the selected state of the card. For example, if you selected **In progress** in **Crisis events overview**, then details of the crisis events that are in the **In progress** state are displayed in this panel. You can view the following details on the crisis events:-   **Active**
...
Name of the assignee responsible to respond to the crisis event. When you select the assignee name in the column, it opens the record form where the following tabs are displayed:
...
Shows the number of the assets by their recovery status for ongoing events. The following details are displayed on the asset in a pie chart:
...
Shows the plans by the following status of the ongoing events:
...
Shows the tasks by the following status of the ongoing events:
...
The **Business impact analysis** tab in the Home page displays various cards that offer information on the business impact analyses. You can review the business impact analyses in various states, details of the selected analyses, and monitoring and tracking of the analyses. The following example shows the cards in the **Business impact analysis** tab.

\[Omitted image "bia-home-page.png"\] Alt text: Business impact analysis tab in the Home page.

See the following table for the description of the cards in the **Business impact analysis** tab:
...
Overview of the business impact analysis in different states. You can view the details of the business impact analysis in the following states:-   **All**
...
Details of the business impact analyses for the selected state of the card. For example, if you selected **In progress** in **Crisis events overview**, then details of the business impact analyses that are in the **In progress** state are displayed in this panel. You can view the following details on the business impact analyses in a tabular format:-   **Name**
...
Overview of the business continuity plans in different states. You can view the business continuity plans in the following states:-   **All**
...
Details of the business continuity plans for the selected state of the card. For example, if you selected **In progress** in **Business continuity plan overview**, then details of the business continuity plans that are in the **In progress** state are displayed in this panel. You can view the following details on the business impact analyses in a tabular format:-   **Name**
...
Overview of the exercise events in different states. You can view the details of the exercise events in the following states:-   **In progress**
...
Name of the assignee responsible for the crisis event. When you select the assignee name in the column, it opens the record form where the following tabs are displayed:
...
Shows the number of the assets by the recovery status for ongoing events. The following details are displayed on the asset in a pie chart:
...
A typical Home page view for a BCM manager is shown in the following example.

\[Omitted image "exercises-homepage.png"\] Alt text: Exercises tab in the Home page.

A typical Home page view for a BCM planner is shown in the following example.

\[Omitted image "bcm-planner-homepage-view.png"\] Alt text: Home page view for the BCM planner.

For information on the tabs and their associated actions in the Home page, see [Home page view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/home-page-uib-ws.md).

**Parent Topic:**[BCM Configurable Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/bcm-workspace.md)
