...
-   Map view with the locations of the alerts
    ...
    **Note:**
    ...
    To enable Crisis map functionality in the GRC: Crisis map application, you must set up Google maps. For more information, see [Set up Google Maps API](https://www.servicenow.com/docs/access?context=set-up-google-maps-api&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
...
</table>**Parent Topic:**[BCM Configurable Workspace](bcm-workspace.md)
