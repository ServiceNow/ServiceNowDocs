...
The Tasks page displays the assigned tasks for the logged-in user in different tabs as shown in the following example.

![My tasks page in BCM UIB Workspace.](../image/my-tasks-page-all-tabs.png)

The Tasks page in BCM UIB Workspace displays the following tabs:
...
**Parent Topic:**[BCM Configurable Workspace](bcm-workspace.md)
