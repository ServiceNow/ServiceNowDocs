...
breadcrumb: [Create contacts for emergency notifications, Setup steps for emergency notification, Integrating Crisis Management with Everbridge, Using BCM Classic Workspace, Business Continuity Management, Governance, Risk, and Compliance]
---
...
**Parent Topic:**[Create contacts for emergency notifications](create-contact-rules-emergency-notifications.md)
