...
-   **[Workflow status of the emergency notification](../reference/workflow-activities-emergency-notifications.md)**  
...
**Parent Topic:**[Integrating Crisis Management with Everbridge](../concept/BCM-integration-everbridge.md)
