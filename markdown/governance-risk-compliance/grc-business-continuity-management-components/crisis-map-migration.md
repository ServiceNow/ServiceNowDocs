...
For information on the form headers, see [Set up a form header in Configurable Workspace](https://www.servicenow.com/docs/access?context=config-ws-form-header&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
