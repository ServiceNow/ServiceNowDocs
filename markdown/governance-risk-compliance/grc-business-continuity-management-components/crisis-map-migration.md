...
For information on the form headers, see [Configure a form header for a workspace](https://www.servicenow.com/docs/access?context=config-ws-form-header&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
