...
For more information on the fix scripts, see [Fix scripts](https://www.servicenow.com/docs/access?context=c_FixScripts&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
