...
Typically, the BIA administrator with the sn\_bia.bia\_admin role configures the BIA templates. For more information, see [Configure BIA templates with legacy assessment](../task/configure-bia-template-uib-ws.md).
