...
breadcrumb: [Manage Microsoft Word document templates, Generating reports using Document designer, Manage, Business Continuity Management, Governance, Risk, and Compliance]
---
...
</table>**Parent Topic:**[Manage Microsoft Word document templates](../task/edit-report-temp.md)
