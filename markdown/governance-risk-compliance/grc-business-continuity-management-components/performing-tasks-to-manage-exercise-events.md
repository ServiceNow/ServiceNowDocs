...
-   Create an exercise. For more information, see [Create an exercise](../task/start-exercise-event-in-uib-ws.md).
-   Add an asset and plan to the exercise. For more information, see [Track impacted assets and add associated plans](../task/add-asset-and-plan-to-exercise-event-uib-ws.md).
-   Add an event task to the exercise. For more information, see [Monitor event tasks and create ad-hoc tasks](../task/add-an-event-task-to-exercise-event.md).
-   Submit the event task for the exercise event. For more information, see [Request an approval and approve the event](../task/submit-an-event-task-uib-ws.md).

## Additional information on Exercises

-   For information on the **Exercises** tab in the Home page, see [Home page view](home-page-uib-ws.md).
-   For information on the exercises, see [Exercises](exercise-management-uib.md).
...
-   **[Grouping similar event tasks in events](identifying-running-dup-tasks-once.md)**  
