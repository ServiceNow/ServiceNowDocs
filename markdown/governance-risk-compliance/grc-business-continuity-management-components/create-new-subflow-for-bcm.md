...
Annotation for the subflow. The help text under the subflow title in Workflow Studio helps the flow designers to understand the function of the subflow does when it is used in a flow.
...
</table>For more information on creating a subflow, see [Create a subflow in Workflow Studio](https://www.servicenow.com/docs/access?context=create-subflow&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
