...
A sample **Business Continuity Plan template** with the **SN-Overview** and **SN-Checklist** document sections is shown in the following example. ![Demo data template.](../image/business-continuity-plan-template.png)
