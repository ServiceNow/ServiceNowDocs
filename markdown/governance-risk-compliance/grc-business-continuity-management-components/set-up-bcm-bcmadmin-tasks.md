...
The administrative tasks that are associated with the BCM application are listed in the **General Administration** module in the application UI as shown in the following example.![General Administration module.](../image/gen-admin-module.png)
...
-   Configure the impact categories. For more information, see [Configure impact category for BIA](../task/configure-impact-category-uib-ws.md).
-   Configure the documentation sections. For more information, see [Configure documentation section](../task/configure-doc-section-for-bcp.md).
-   Configure the element definitions. For more information, see [Configure element definition](../task/configure-element-definition-bia-uib-ws.md).
-   Configure the loss scenarios. For more information, see [Configure loss scenarios in the plan](../task/configure-plan-loss-scenario-uib-ws.md).
-   Configure the impact ratings. For more information, see [Configure impact ratings](../task/configure-impact-rating-uib-ws.md).
-   Configure the recovery tiers. For more information, see [Configure recovery tiers for BIA](../task/configure-recovery-tier-bia-uib-ws.md).
-   Configure the recovery timeframes. For more information, see [Set up recovery timeframes](../task/configure-recovery-timeframe-bia-uib-ws.md).
-   Configure the element variables. For more information, see [Configure element variables for element definitions](../task/configure-element-variable-uib-ws.md).
-   View the My tasks page configurations module. For more information, see [My tasks page configurations](my-tasks-page-config-module.md).
-   Configure the approval configurations. For more information, see [Approval configuration](bcm-approval-configuration.md).
-   Configure the properties. For more information, see [BCM properties](bcm-properties-module.md).
...
The **BIA templates** menu option in the BIA Configuration module is shown in the following example.![BIA Configuration module.](../image/bia-config-module.png)
...
Typically, the Business Continuity Management administrator uses the **Plan Templates** module to configure a business continuity plan template. The **Plan Templates** module is shown in the following example.![Plan Templates module.](../image/plan-templates-module.png)
