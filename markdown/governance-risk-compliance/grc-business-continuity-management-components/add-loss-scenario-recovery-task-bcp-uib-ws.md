...
3.  Select the **Loss scenarios** tab and select **Add**.
    ...
    ![Add a loss scenario.](../image/loss-scenarios-list.png)

    The loss of scenario record is displayed as shown in the example.

    ![Loss of scenario record with the tabs.](../image/loss-scenarios-details-tab.png)
...
4.  Navigate to **Related asset dependencies** tab and select **Add**.
    ...
    ![Add the related asset dependencies to the loss of scenario.](../image/loss-scenarios-add-rel-asset-dep.png)
...
5.  Select the dependencies from the list and select **Add**.
    ...
    ![Add the dependencies that are related to the assets.](../image/loss-scenarios-add-dep.png)
