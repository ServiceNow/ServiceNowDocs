...
Typically, the business continuity plan owner performs the following tasks:

-   Create a business continuity plan as per the plan template. For more information, see [Create a business continuity plan](../task/create-bcp-plan-in-uib-ws.md).
-   Add an asset and scope to the plan. For more information, see [Add asset and scope to the BCP](../task/add-asset-plan-scope-for-bcp-uib-ws.md).
-   Create a documentation section. For more information, see [Create documentation sections](../task/create-documentation-section-bcp.md).
-   Add the related plan and recovery team. For more information, see [Add associated plans and recovery teams](../task/add-related-plans-recovery-teams-bcp-uib-ws.md).
-   Add a loss scenario, recovery strategy, and recovery task. For more information, see [Add loss scenarios](../task/add-loss-scenario-recovery-task-bcp-uib-ws.md), [Add recovery strategies for dependencies](../task/create-new-recovery-strategy-for-loss-scenario-uib-ws.md), and [Add recovery tasks](../task/add-a-recovery-task.md).
-   Generate and save the PDF of the analysis for reference. For more information, see [Generate BCP reports in PDF or Microsoft Word format](../task/generate-pdf-for-bcp.md).

## BCP updates in the Xanadu release
