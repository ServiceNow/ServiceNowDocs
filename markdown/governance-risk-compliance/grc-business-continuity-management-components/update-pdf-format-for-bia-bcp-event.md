...
<table id="choicetable_ib1_wzc_tcc"><tbody><tr><td id="d342894e247">
...
Select **Create New Block**.
    ...
    For more information on Document Templates, see [Configure a PDF document template](https://www.servicenow.com/docs/access?context=configure-editable-pdf&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US).
