...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/planning-execution-event-bcm.html
release: zurich
topic_type: concept
...
-   **Plan**
    ...
    In the **Recovery Tasks** tab of a plan, you can also [refer to a different plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/bcp-recovery-tasks-grid.md) and select the plan from the list of related plans.
