...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/currency-conversion-aggregation.html
release: australia
topic_type: concept
...
For information on creating a Microsoft Excel download and upload request and generating the reports, see [Create Microsoft Excel download and upload request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/create-excel-upload-download-request.md).

For steps on converting and aggregating contractual expenses to regulator-required currencies, see [Convert and aggregate contractual expenses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/create-excel-report-aggregate-expenses.md).

-   **[Convert and aggregate contractual expenses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/create-excel-report-aggregate-expenses.md)**  
