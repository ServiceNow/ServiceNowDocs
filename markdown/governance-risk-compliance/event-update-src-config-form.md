...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/event-update-src-config-form.html
release: australia
...
</table>**Parent Topic:**[Configure Event dependency source configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/conf-event-dep-source-confi-module.md)
