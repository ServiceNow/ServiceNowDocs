...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/event-update-src-config-form.html
release: xanadu
...
</table>**Parent Topic:**[Configure Event dependency source configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/conf-event-dep-source-confi-module.md)
