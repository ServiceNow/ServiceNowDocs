...
For more information on the fix scripts, see [Fix scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/c_FixScripts.md).
