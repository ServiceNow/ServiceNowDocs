---
title: Generating Word reports using Document designer
description: Operational Resilience administrators can now set up Microsoft Word templates and Operational Resilience managers can download action task reports in MS word format​.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/gen-word-reports.html
release: xanadu
topic_type: concept
...
# Generating Word reports using Document designer

Operational Resilience administrators can now set up Microsoft Word templates and Operational Resilience managers can download action task reports in MS word format​.
...
1.  Install Document designer.
2.  Create template configuration
3.  Create Data relationships
4.  Create Content configurations
5.  Download the manifest file and side-load it in the ServiceNow Document designer with Word.
6.  Build the word template using the add-in.
