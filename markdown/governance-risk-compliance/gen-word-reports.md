...
description: Operational Resilience administrators can now set up Microsoft Word templates and Operational Resilience managers can download action task reports in Microsoft Word format​.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/gen-word-reports.html
release: yokohama
topic_type: concept
...
Operational Resilience administrators can now set up Microsoft Word templates and Operational Resilience managers can download action task reports in Microsoft Word format​.
...
5.  Download manifest file and side-load it in the ServiceNow Document designer with Word
6.  Build Microsoft Word template using the add-in
7.  Generate report in Microsoft Word format
