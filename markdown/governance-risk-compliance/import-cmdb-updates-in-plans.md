...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/import-cmdb-updates-in-plans.html
release: yokohama
topic_type: concept
...
The Planning dependency update configuration module is shown in the following example.\[Omitted image "plan-dep-update-config.png"\] Alt text: Updating the BCP dependencies.
...
For more information on setting up the Planning dependency update configuration module, see [Configuring planning dependency updates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/confi-planning-dep-updates.md).
...
For more information on the source BIA records option in the Dependency configuration modules, see [Set up Planning dependency update configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/conf-plan-dep-update-confi-module.md).
...
For more information on updating the planning dependencies manually, see [Update the planning dependencies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/import-cmdb-updates-in-bcp.md).
...
When you create a business continuity plan, you must update the related assets in the plans. Beginning with the Yokohama release, the Data Relationships Framework \(com.sn\_app\_grc\_relationship\_config\) application supports the BCM application with the underlying framework to fetch the related assets in the plans. The Data Relationships Framework application is installed with the BCM application by default.

For more information on the Data Relationships Framework, see [Data Relationships Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/data-relationship-framework.md).

-   **[Update the planning dependencies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/import-cmdb-updates-in-bcp.md)**  
...
**Parent Topic:**[Structured workflows for BCPs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/bcp-tasks-performed-by-bcp-owner.md)
