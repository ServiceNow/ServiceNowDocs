...
Create a scripted variable for the report. For more information, see [Define the scripted variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/create-scripted-vari-for-temp-config.md).
