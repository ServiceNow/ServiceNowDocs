...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/set-up-op-vul-type.html
release: yokohama
topic_type: task
...
2.  On the Vulnerability Type record form, fill in the fields.
    ...
    For more information on the fields, see [Vulnerability Type form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/vul-type-form.md).
