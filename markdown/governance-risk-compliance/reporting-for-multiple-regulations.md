...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/reporting-for-multiple-regulations.html
release: yokohama
topic_type: concept
...
For information on setting up the entities, see [Set up entities for the targets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/set-up-entities-for-targets.md).
...
For information on mapping regulations and setting up action task templates, see [Map regulations to the entities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/configure-case-types-map-regu.md) and [Set up action task templates in Regulatory agency profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/set-up-action-task-templates.md).

For information on completing action tasks, refer to [Complete action tasks and report incidents associated with regulations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/work-on-action-tasks.md).
