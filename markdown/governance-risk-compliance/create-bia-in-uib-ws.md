...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/create-bia-in-uib-ws.html
release: yokohama
topic_type: task
...
3.  On the **Details** tab of the **Create New Impact analysis** form, fill in the required fields.
    ...
    For more information on the fields, see [Create New Impact analysis form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/create-new-impact-analysis-reference-form-bcm-uib-ws.md).
...
-   **[Create New Impact analysis form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/create-new-impact-analysis-reference-form-bcm-uib-ws.md)**  
