...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/mapping-recovery-tasks-to-phases.html
release: australia
topic_type: concept
...
For information and steps on mapping recovery tasks to phases, see [Add recovery tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/add-a-recovery-task.md).
