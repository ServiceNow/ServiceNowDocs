...
3.  In the Node configurations related list, select **New**.
    ...
    For more information on the fields, see [Node configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/node-configuration-form.md).
