...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/configure-node-configurations.html
release: xanadu
topic_type: task
...
3.  In the Node configurations related list, select **New**.
    ...
    For more information on the fields, see [Node configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/node-configuration-form.md).
