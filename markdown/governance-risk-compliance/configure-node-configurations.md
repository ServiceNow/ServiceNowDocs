...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/configure-node-configurations.html
release: yokohama
topic_type: task
...
3.  In the Node configurations related list, select **New**.
    ...
    For more information on the fields, see [Node configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/node-configuration-form.md).
