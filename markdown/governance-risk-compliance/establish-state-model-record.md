...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/establish-state-model-record.html
release: yokohama
topic_type: task
...
3.  On the State model form, fill in the other fields.
    ...
    For more information on the fields, see [GRC state model form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-state-model-form-for-op-vul.md).
