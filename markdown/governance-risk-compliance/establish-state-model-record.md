...
3.  On the State model form, fill in the other fields.
    ...
    For more information on the fields, see [GRC state model form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/grc-state-model-form-for-op-vul.md).
