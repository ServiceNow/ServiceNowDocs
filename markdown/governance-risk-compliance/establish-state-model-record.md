...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/establish-state-model-record.html
release: xanadu
topic_type: task
...
3.  On the State model form, fill in the other fields.
    ...
    For more information on the fields, see [GRC state model form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-state-model-form-for-op-vul.md).
