...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/configure-edge-status-configurations.html
release: xanadu
topic_type: task
...
4.  In the Edge status configurations related list, select **New**.
    ...
    For more information on the fields, see [Edge status configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/edge-status-configuration-form.md).
