...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/configure-edge-status-configurations.html
release: yokohama
topic_type: task
last_updated: "2025-11-06"
reading_time_minutes: 1
breadcrumb: [Configure the Edge configurations, Configure the Node configurations, Configure the Node relationship configurations, Configure the Main node configurations, Configure, Operational Resilience, Governance, Risk, and Compliance]
---
...
4.  In the Edge status configurations related list, select **New**.
    ...
    For more information on the fields, see [Edge status configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/edge-status-configuration-form.md).
