...
3.  On the form, fill in the fields.
    ...
    For description of the fields on the form, see [Create Contract form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/create-new-contract-form.md).
...
8.  On the form, fill in the fields.
    ...
    For more information, see [Create Contractual arrangement form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/create-new-cont-arrange-form.md).

    **Note:** Third party, Third-party engagement, and Contractual arrangement Digital resilience information records include a reference field back to their parent record.
...
-   **[Create Contract form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/create-new-contract-form.md)**  
On the Create New Contract form, fill in the fields.
-   **[Create Contractual arrangement form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/create-new-cont-arrange-form.md)**  
