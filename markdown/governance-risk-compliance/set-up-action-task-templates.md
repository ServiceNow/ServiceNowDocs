...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/set-up-action-task-templates.html
release: yokohama
topic_type: task
