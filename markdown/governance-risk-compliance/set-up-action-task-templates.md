...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/set-up-action-task-templates.html
release: xanadu
topic_type: task
