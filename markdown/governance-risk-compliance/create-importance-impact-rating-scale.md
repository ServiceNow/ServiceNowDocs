...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/create-importance-impact-rating-scale.html
release: yokohama
topic_type: task
...
3.  On the form, fill in the fields and click **Submit**.
    ...
    For a description of the field values on the Rating Scale New Record form, see [Rating Scale New Record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/importance-and-impact-rating-scale-reference.md).
