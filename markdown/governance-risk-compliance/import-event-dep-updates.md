...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/import-event-dep-updates.html
release: xanadu
topic_type: concept
...
For more information on setting up the Event dependency source configuration module, see [Configure Event dependency source configuration record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/conf-event-dep-source-confi-module.md).
...
For more information on updating the event dependencies manually, see [Update the event dependencies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/update-event-dep-manually.md).
