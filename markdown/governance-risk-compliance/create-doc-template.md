...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/create-doc-template.html
release: yokohama
topic_type: task
...
3.  On the HTML Template record form, fill in the fields.
    ...
    For more information on the fields, see [HTML Template form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/html-template-form-op-vul.md).
...
<table id="choicetable_ib1_wzc_tcc"><tbody><tr><td id="d356897e149">
