---
title: Using Digital resilience incident reporting
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/governance-risk-compliance/drir-module.html
release: brazil
topic_type: concept
...
The Digital Resilience Incident Reporting \(DRIR\) streamlines the case reporting process by creating assessments for regulatory reporting, assigning action tasks, and determining reportability. It generates initial, intermediate, and final reports in the format specified by regulators. Using DRIR ensures that critical incidents are properly documented, tracked, and reported to authorities within the required timelines for regulatory compliance.
...
[Explore \[Omitted image "bus-explore.svg"\] Alt text:Learn about Digital resilience incident reporting \(DRIR\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/dri-module-in-ws.md)

</td><td>

[Configure \[Omitted image "bus-sdlc.svg"\] Alt text:Configure the conditions for incident reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/workflow-confi-auto-trigger-inci-repo-cases.md)

</td></tr><tr><td>

[Use \[Omitted image "bus-agent-workspace-1.svg"\] Alt text:Report incidents from other applications or manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/using-drir.md)

</td><td>

[Reference\[Omitted image "bus-learn.svg"\] Alt text: Components installed with DRIR](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/drir-ref.md)
