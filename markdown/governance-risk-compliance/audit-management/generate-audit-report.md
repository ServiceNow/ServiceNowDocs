...
For more information, see [Create content configurations](../../grc-common/task/create-content-configurations.md) and [Create Word template record for an audit engagement](../../grc-audit/task/configure-audit-word-template.md).
