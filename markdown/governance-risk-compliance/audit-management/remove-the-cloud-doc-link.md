...
6.  Select **Remove linked file** in the pop-up.
    ...
    When a cloud file is linked to a record, the file access permissions are refreshed according to the set permissions on the table. For information on File access permissions, see [Create a Cloud file configuration on engagements and audit tasks](../concept/document-access-configuration.md).
