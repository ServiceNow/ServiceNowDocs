...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/audit-management/matrix-report-create-audit-ws.html
release: xanadu
...
Create the matrix report configuration giving a name to the report, determining its display type either as a landing page or as a record page, and setting filter conditions on the base table.
...
3.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Matrix report configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/audit-management/mat-report-config-form-audit-ws.md).
