...
When an audit user logs time using time cards, the time cards are sent for approval based on the approvers defined in the time sheets policy. To learn more about time sheets policy, see [Time sheet policy](https://www.servicenow.com/docs/access?context=time-sheet-policies&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US)

**Note:** If there's no approver identified or **None** is selected in the **Non-project time approver** field on the time sheet policy assigned to the user, then the users in the **Time card approver** field are able to approve the time cards associated to that engagement. If **User Manager** or **Auto** is selected in the **Non-project time approver** field, then the approvers are not overridden and remain as is. For details on the roles required to approve time cards, see [Roles required for Advanced planning capability and Project Portfolio Management integration](../reference/roles-for-audit-and-ppm.md)

To create a time card, see [Create a time card](https://www.servicenow.com/docs/access?context=t_CreateATimeCard&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US).

A user can submit the time cards through the time sheet portal directly without coming to the engagement. To submit a time card, see [Submit a time card](https://www.servicenow.com/docs/access?context=submit-time-card&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US). To submit a time card from the time sheet portal, see [Submit time card from the time sheet portal](https://www.servicenow.com/docs/access?context=create-timecards-through-worker-portal&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US)
...
[Roles required for Advanced planning capability and Project Portfolio Management integration](../reference/roles-for-audit-and-ppm.md)
