...
To create a time card, see [Create a time card](https://www.servicenow.com/docs/access?context=t_CreateATimeCard&version=australia&pubname=australia-it-business-management&ft:locale=en-US).

A user can submit the time cards through the time sheet portal directly without coming to the engagement. To submit a time card, see [Submit a time card](https://www.servicenow.com/docs/access?context=submit-time-card&version=australia&pubname=australia-it-business-management&ft:locale=en-US). To submit a time card from the time sheet portal, see [Submit time card from the time sheet portal](https://www.servicenow.com/docs/access?context=create-timecards-through-worker-portal&version=australia&pubname=australia-it-business-management&ft:locale=en-US)
