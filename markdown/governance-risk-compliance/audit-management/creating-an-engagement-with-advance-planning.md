...
[Create a resource plan](https://www.servicenow.com/docs/access?context=t_CreateResourcePlanProjectTask&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US) and [Create a cost plan](https://www.servicenow.com/docs/access?context=t_CreateAProjectCostPlan&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US).
