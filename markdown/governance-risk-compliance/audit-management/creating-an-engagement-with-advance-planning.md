...
[Create a resource plan](https://www.servicenow.com/docs/access?context=t_CreateResourcePlanProjectTask&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US) and [Create a cost plan](https://www.servicenow.com/docs/access?context=t_CreateAProjectCostPlan&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US).
