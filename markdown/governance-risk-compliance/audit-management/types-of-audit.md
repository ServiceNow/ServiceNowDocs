...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/audit-management/types-of-audit.html
release: australia
...
|SOX Audit|A Sarbanes Oxley \(SOX\) compliance audit is a measure of how well your company manages its internal controls. SOX doesn't specifically mention information security. However, an internal control is understood to be any type of protocol dealing with the infrastructure that handles your financial data.|
...
|Compliance Audit|A compliance audit is an independent evaluation to ensure that an organization follows external laws, rules, and regulations or internal guidelines, such as corporate bylaws, controls, and policies.|
...
|Vendor Audit|A vendor audit assesses whether contractors or vendors comply with the terms, conditions, and intent of their contracts or agreements.|
