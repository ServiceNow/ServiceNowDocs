...
|External Audit|An external audit is an independent examination of the financial statements prepared by the organization.|
|SOX Audit|A Sarbanes Oxley \(SOX\) compliance audit is a measure of how well your company manages its internal controls. SOX doesn't specifically mention information security. However, an internal control is understood to be any protocol dealing with the infrastructure that handles your financial data.|
...
|Compliance Audit|A compliance audit is an independent evaluation to verify that an organization follows external laws, rules, and regulations. It also verifies adherence to internal guidelines, such as corporate bylaws, controls, policies, and procedures.|
...
|Operational Audit|An operational audit examines how an organization conducts business to identify improvements that increase efficiency and effectiveness.|
...
|Vendor Audit|A vendor audit assesses whether contractors or vendors comply with contract terms and conditions. It provides an objective evaluation of vendor adherence to contractual agreements.|
|Customer Audit|A customer audit reviews how your company is perceived by its customers and evaluates each customer's needs. It assesses the role your company plays in each customer's business.|
