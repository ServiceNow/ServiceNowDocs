...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/audit-management/audit-task-mangmt-ws.html
release: xanadu
...
These audit tasks are assigned to the engagements that are in **Validate** or **Fieldwork** state.
