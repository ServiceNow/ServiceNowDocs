...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/audit-management/create-audit-report-temp.html
release: yokohama
...
Name of the audit report template.
...
Type of the audit report template. Available options are:-   **Script**
-   **HTML**
-   **XML**
...
Option that indicates that this template is used as the default template for all KB articles.
