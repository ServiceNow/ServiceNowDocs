...
**Note:** The Audit period start and end is available from Yokohama patch 10 and Zurich patch 4 release. To enable this feature, see [Schedule job for audit date enhancement](../../grc-audit/task/schedule-job-for-audit-date.md).

To enable Audit period start and end for older version, see [Create exclusion table for audit date](../../grc-audit/task/create-exclusion-table-for-audit-date.md).
