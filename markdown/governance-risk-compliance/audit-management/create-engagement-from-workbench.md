...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/audit-management/create-engagement-from-workbench.html
release: xanadu
...
breadcrumb: [Use the Audit Engagement Workbench to visually manage engagements, Manage engagements, Using Audit Management, Audit Management, Governance, Risk, and Compliance]
---
...
3.  On the form, fill in the fields.
    ...
    |Audit period end|Date that work on the engagement is expected to end.|
...
**Parent Topic:**[Use the Audit Engagement Workbench to visually manage engagements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/audit-management/c_AuditEngagementWorkbench.md)
