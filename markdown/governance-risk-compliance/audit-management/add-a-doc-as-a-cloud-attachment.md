...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/audit-management/add-a-doc-as-a-cloud-attachment.html
release: xanadu
...
Ensure that the cloud file UI actions on the Cloud files related list are visible on the forms based on the configured conditions. Ensure that file access permissions of read and write are added for the auditor and engagement leads. For more information, see [Create a Cloud file configuration on engagements and audit tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/audit-management/document-access-configuration.md).
...
7.  Select the **Mark as non-sharable** option.
    ...
    When this option is selected, the cloud file that is linked to the record is marked as non-sharable. It cannot be linked with other records in ServiceNow. If you attempt to link a non-sharable file to another ServiceNow record, an error message is displayed.
...
8.  Select **Link** in the pop-up.
    ...
    For more information on file access permissions, see [Create a Cloud file configuration on engagements and audit tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/audit-management/document-access-configuration.md).
