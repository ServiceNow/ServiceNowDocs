...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/audit-management/add-a-doc-as-a-cloud-attachment.html
release: zurich
...
8.  Select **Link** in the pop-up.
    ...
    For more information on file access permissions, see [Create Cloud File Access on engagements and audit tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/audit-management/document-access-configuration.md).
