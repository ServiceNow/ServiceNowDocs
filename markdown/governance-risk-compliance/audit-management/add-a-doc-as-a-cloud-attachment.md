...
Ensure that the cloud file UI actions on the Cloud files related list are visible on the forms based on the configured conditions. Ensure that file access permissions of read and write are added for the auditor and engagement leads. For more information, see [Create a Cloud file configuration on engagements and audit tasks](../concept/document-access-configuration.md).
...
8.  Select **Link** in the pop-up.
    ...
    For more information on file access permissions, see [Create a Cloud file configuration on engagements and audit tasks](../concept/document-access-configuration.md).
