...
1.  Set up the Microsoft OneDrive Integration Hub Spoke.
    ...
    For more information, see [Document Services Framework for Microsoft OneDrive](https://www.servicenow.com/docs/access?context=onedrive-spoke-document-services-framework&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
