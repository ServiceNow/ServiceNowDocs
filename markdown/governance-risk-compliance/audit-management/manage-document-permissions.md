...
The **Manage permissions** action on a document lets you grant read or write access in two ways:
...
-   User-based permission: Grant read or write access to a specific user, a group, or an existing condition that you select.
