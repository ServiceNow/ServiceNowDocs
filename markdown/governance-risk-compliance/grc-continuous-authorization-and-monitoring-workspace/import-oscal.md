---
title: Importing in OSCAL format
description: CAM supports importing Catalog and System Security Plan \(SSP\) models in OSCAL \(Open Security Controls Assessment Language\) format. This feature streamlines data integration, enhances collaboration, and helps reduce manual effort so your security control information is consistent and up to date.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-continuous-authorization-and-monitoring-workspace/import-oscal.html
release: yokohama
...
-   **[Import OSCAL catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-continuous-authorization-and-monitoring-workspace/import-oscal-cam-ws.md)**  
From the OSCAL Import landing page, import catalog OSCAL data into the CAM Workspace.
-   **[Import OSCAL SSP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-continuous-authorization-and-monitoring-workspace/import-oscal-ssp-cam-ws.md)**  
