...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/grc-continuous-authorization-and-monitoring-workspace/add-child-boundary.html
release: australia
...
1.  Navigate to **All** &gt; **CAM Workspace** and then select the \[Omitted image "ws-list-icon.png"\] Alt text: List icon icon.
