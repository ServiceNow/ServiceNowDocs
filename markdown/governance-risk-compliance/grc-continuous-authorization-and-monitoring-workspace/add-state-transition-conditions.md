...
breadcrumb: [Configure transition between state models, Create GRC workflow states, GRC state model configuration, CAM workflow configuration, Continuous authorization and monitoring tasks in the CAM Workspace, Use, Continuous Authorization and Monitoring, Governance, Risk, and Compliance]
---
