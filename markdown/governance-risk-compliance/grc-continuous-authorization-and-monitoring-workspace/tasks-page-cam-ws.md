...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-continuous-authorization-and-monitoring-workspace/tasks-page-cam-ws.html
release: xanadu
...
2.  Navigate to the appropriate tab.
    ...
    **Note:** When a user or user group doesn’t have pending or associated tasks, the `All your tasks are done` message appears for the tab.
    ...
    -   **Confidential records**
        ...
        Mark sensitive records as confidential and ensure that the appropriate people have access to these records. The **Confidential records** tab configuration displays the confidential records for the selected table.
