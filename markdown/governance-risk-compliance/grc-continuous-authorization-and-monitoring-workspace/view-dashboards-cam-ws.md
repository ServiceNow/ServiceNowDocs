...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/grc-continuous-authorization-and-monitoring-workspace/view-dashboards-cam-ws.html
release: zurich
...
3.  Select the dashboard you want to view.
    ...
    -   **CAM Overview dashboard**
        ...
        See [CAM Overview dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/continuous-risk-monitoring/cam-overvw-pa-db.md).
    ...
    -   **AO Overview dashboard**
        ...
        See [AO Overview dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/continuous-risk-monitoring/reports-ao-overview.md).
    ...
    -   **SCA Overview dashboard**
        ...
        See [SCA Overview dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/continuous-risk-monitoring/reports-sca-ov.md).
