---
title: View the dashboards to monitor and manage your NIST security posture
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/grc-continuous-authorization-and-monitoring-workspace/view-dashboards-cam-ws.html
release: yokohama
...
Role required: sn\_irm\_cont\_auth.admin, sn\_irm\_cont\_auth.authorization\_official, sn\_irm\_cont\_auth.info\_system\_sec\_manager, sn\_irm\_cont\_auth.info\_system\_sec\_officer, sn\_irm\_cont\_auth.sec\_control\_assessor, sn\_irm\_cont\_auth.system\_owner
...
2.  Select the change dashboard list icon \(\[Omitted image "change-dashboard-icon.png"\] Alt text: Change dashboard list icon.\) to select the dashboard to view.
    ...
    -   **CAM Overview dashboard**
        ...
        See [CAM Overview dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/continuous-risk-monitoring/cam-overvw-pa-db.md).
    ...
    -   **AO Overview dashboard**
        ...
        See [AO Overview dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/continuous-risk-monitoring/reports-ao-overview.md).
    ...
    -   **SCA Overview dashboard**
        ...
        See [SCA Overview dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/continuous-risk-monitoring/reports-sca-ov.md).


**Parent Topic:**[Continuous authorization and monitoring tasks in the CAM Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/grc-continuous-authorization-and-monitoring-workspace/cam-ws-continuous-auth-monitor.md)
