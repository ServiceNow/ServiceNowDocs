...
6.  Select **Generate SSP** to generate a System Security Plan \(SSP\).
    ...
    For more information on CAM ATO artifacts, see [Generating ATO artifacts from an authorization package](../concept/generate-ato-artifacts-cam-ws.md).
...
7.  To generate OSCAL SSP, select the **Export OSCAL SSP** option from the more actions icon \(![More actions icon](../../grc-workspace-risk/image/icon-more-actions-risk.png)\).
    ...
    For more information, see [Exporting in OSCAL format](../concept/oscal-support-cam.md) and [Export OSCAL SSP](generate-oscal-models.md).
