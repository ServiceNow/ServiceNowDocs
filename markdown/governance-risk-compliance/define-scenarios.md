...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/define-scenarios.html
release: xanadu
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    For the description of the field values, see [Scenario New record form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/scenario-reference.md).
