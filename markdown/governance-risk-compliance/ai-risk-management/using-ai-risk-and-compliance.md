...
-   **[Report an AI case from the Employee Center](../task/report-ai-case.md)**  
...
-   **[Remediate an issue in AI Risk and Compliance](../task/remediate-an-issue-in-airc.md)**  
After an issue has been created, reported, identified, triaged, and investigated, you can remediate it.
-   **[Initiate AI assessment on an AI asset](../task/initiate-assessment-on-an-ai-asset.md)**  
...
-   **[Initiate risk assessment on AI asset](../task/initiate-risk-assessment-on-ai-systems.md)**  
...
-   **[Perform risk assessments on AI systems](../task/perform-risk-assessments-on-ai-systems.md)**  
...
-   **[Manage controls using AI Risk and Compliance](manage-controls-in-airc.md)**  
You can add, remove, and delete controls for an AI asset using the AI Risk and Compliance.
-   **[Initiate risk assessment on AI asset's risks](../task/request-risk-assessments-for-ai-systems.md)**  
...
-   **[Create bulk risk assessment](../task/create-bulk-risk-assessment-airc.md)**  
...
-   **[Perform bulk assessment in stacked view](../task/perform-bulk-assessment-in-stacked-view-airc.md)**  
...
-   **[Perform bulk assessment in grid view](../task/perform-bulk-assessment-in-grid-view-airc.md)**  
...
-   **[Activate or update NIST Risk Management Framework using the ESG content accelerator](../task/activate-or-update-nist-using-the-content-accelerator.md)**  
...
-   **[Activate or update EU Artificial Intelligence Act using the ESG content accelerator](../task/activate-or-update-eu-artificial-intelligence-act.md)**  
