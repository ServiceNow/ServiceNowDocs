...
<table id="choicetable_afh_4hk_23c"><thead><tr><th align="left" id="d117039e190">

Option

</th><th align="left" id="d117039e193">

Description

</th></tr></thead><tbody><tr><td id="d117039e199">
...
**Note:** An AI Asset owner can complete this option.
    ...
    For full descriptions of the fields, see [Request an AI use case form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/governance-risk-compliance/ai-risk-management/request-ai-system-form.md). For more information about adding an AI system using AI Control Tower, see [Create AI system assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/create-ai-system-assets.md).
