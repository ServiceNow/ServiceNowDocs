...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/ai-risk-management/perform-impact-assessment-of-ai-use-case.html
release: yokohama
...
3.  In the Assess stage of the AI Asset Lifecycle, select the task for the impact assessment.
...
6.  To initiate a sidebar discussion, select the more \[Omitted image "more-options.png"\] Alt text: More icon. icon, and select **Discuss**.
...
Proceed to [Initiate risk assessment on AI asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/ai-risk-management/initiate-risk-assessment-on-ai-systems.md).
