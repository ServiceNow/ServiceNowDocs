...
<table><thead><tr><th align="left" id="d150242e71">

Option

</th><th align="left" id="d150242e74">

Description

</th></tr></thead><tbody><tr><td id="d150242e80">
 ...
 **Note:** An AI Asset owner can complete this option.
    ...
    For descriptions of the fields, see [Request an AI model form](../reference/request-ai-model-form.md). For more information, on adding an AI model using the AI Control Tower, see [Create AI model assets](https://www.servicenow.com/docs/access?context=create-ai-model-assets&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
