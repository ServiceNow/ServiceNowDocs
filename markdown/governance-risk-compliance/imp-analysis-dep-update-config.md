...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/imp-analysis-dep-update-config.html
release: xanadu
topic_type: task
...
**Parent Topic:**[Scheduling auto-update of dependencies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/update-impactanalysis-dep-based-on-cmdb-changes.md)
