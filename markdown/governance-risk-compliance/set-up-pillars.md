...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/set-up-pillars.html
release: yokohama
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    For a description of the field values, see [GRC Choices form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/pillars-reference.md).
