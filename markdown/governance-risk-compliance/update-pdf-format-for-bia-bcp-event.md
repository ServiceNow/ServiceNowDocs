...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/update-pdf-format-for-bia-bcp-event.html
release: yokohama
topic_type: task
...
<table id="choicetable_ib1_wzc_tcc"><tbody><tr><td id="d153448e247">
...
Select **Create New Block**.
    ...
    For more information on Document Templates, see [Configure a PDF document template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/employee-service-management/hr-service-delivery/configure-editable-pdf.md).
