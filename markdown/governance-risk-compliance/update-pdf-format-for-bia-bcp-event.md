...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/update-pdf-format-for-bia-bcp-event.html
release: zurich
topic_type: task
...
<table id="choicetable_ib1_wzc_tcc"><tbody><tr><td id="d389873e247">
...
Select **Create New Block**.
    ...
    For more information on Document Templates, see [Configure a PDF document template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/configure-editable-pdf.md).
