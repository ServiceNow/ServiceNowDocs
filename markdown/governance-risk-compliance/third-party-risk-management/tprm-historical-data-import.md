...
The overall process of importing data into your instance is discussed at [Import sets](https://www.servicenow.com/docs/access?context=import-sets-landing-page&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
...
1.  Create a transform map.
    ...
    See [Create a transform map](https://www.servicenow.com/docs/access?context=t_CreateATransformMap&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) for instructions.
