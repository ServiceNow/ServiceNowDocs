...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/third-party-risk-management/tprm-migrate-asmnt-template-result.html
release: yokohama
...
\[Omitted image "tprm-q-to-sae-workflow.png"\] Alt text: Questionnaire to SAE template migration workflow. For a text description, see the text that preceded and follows this diagram.
