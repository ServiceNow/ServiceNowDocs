...
Person with the IRQ assessor role who should respond to the IRQ. For more information, see [Respond to an internal assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/third-party-risk-management/tprm-irq-respond-to.md).**Note:** While reviewing this request for due diligence, the TPR manager or owner can specify a different user.
...
</table>**Parent Topic:**[Due diligence request process management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/third-party-risk-management/tprm-ws-dd-mgt-pg-details-tab.md)
