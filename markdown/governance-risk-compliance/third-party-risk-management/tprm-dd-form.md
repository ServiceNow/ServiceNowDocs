...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/third-party-risk-management/tprm-dd-form.html
release: zurich
...
Person with the IRQ assessor role who should respond to the IRQ. For more information, see [Respond to an internal assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/third-party-risk-management/tprm-irq-respond-to.md).**Note:** While reviewing this request for due diligence, the TPR manager or owner can specify a different user.
