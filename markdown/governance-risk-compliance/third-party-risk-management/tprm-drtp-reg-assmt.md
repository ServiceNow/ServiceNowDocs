...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/third-party-risk-management/tprm-drtp-reg-assmt.html
release: xanadu
...
6.  To edit the assessment record, complete the following.
    ...
    1.  Navigate to **Assessments** and select the check box of the record you want from the list.
...
-   Download the information using the Microsoft Excel download feature. For more information, see [Create a Microsoft Excel download request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/third-party-risk-management/tprm-excel-upload-download-request.md).
-   Upload updated records as needed. For more information, see [Update existing records in bulk](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/third-party-risk-management/tprm-bulk-update.md).
