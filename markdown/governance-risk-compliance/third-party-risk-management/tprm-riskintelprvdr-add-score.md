...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/third-party-risk-management/tprm-riskintelprvdr-add-score.html
release: xanadu
...
1.  Navigate to **All** &gt; **Third-party Risk Management** &gt; **Risk Intelligence Provider Setup** &gt; **Scores**.
    ...
    \[Omitted image "security-scores.png"\] Alt text: Scores provided by risk intelligence providers.
...
The data that you have associated with the third party now appears in reports. See [Viewing risk intelligence scores](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/third-party-risk-management/tprm-ws-tab-risk-intel-scores.md) for details. The data appears in the following locations:
