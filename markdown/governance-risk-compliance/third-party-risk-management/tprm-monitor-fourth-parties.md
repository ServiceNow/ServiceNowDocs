...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/governance-risk-compliance/third-party-risk-management/tprm-monitor-fourth-parties.html
release: brazil
...
-   **Register the fourth-nth parties**
    ...
    If you're a third-party risk \(TPR\) assessor or manager, you can register fourth-nth parties after collecting responses from a third party by using the fourth-party registration questionnaire. You can send the fourth-party registration questionnaire only to the third parties and not engagements. For more information, see [Register a fourth-nth party](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/third-party-risk-management/tprm-fourth-party-register.md).
...
-   **View the fourth-nth parties that are associated with a third party**
    ...
    For more information on how to view all the related fourth-nth parties, see [Viewing information on fourth parties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/third-party-risk-management/tprm-ws-tab-tp-downstream-suppliers.md).
...
-   **View the fourth-parties overview section**
    ...
    **Note:** The known fourth parties are organizations that have already been used as third parties in your risk management program. The unknown fourth parties are only categorized as fourth parties that haven’t been used or identified as third parties.
    ...
    For more information on viewing the known fourth parties, the sub-parties that are associated with the third parties, and the unknown fourth parties, see [TPRM Home page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/third-party-risk-management/tprm-ws-home-page.md).
...
-   **Manually create a fourth-nth party record**
    ...
    For more information on how to create a fourth-nth party record, see [Create a fourth-nth party record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/third-party-risk-management/tprm-fourth-party-create.md).
...
-   **Promote a fourth-nth party to a third party**
    ...
    For more information on how to promote a fourth-nth party record to a third-party record, see [Promote a fourth-nth party to a third party](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/third-party-risk-management/tprm-fourth-party-promote.md).


**Related topics**  


[Viewing information on fourth parties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/third-party-risk-management/tprm-ws-tab-tp-downstream-suppliers.md)
