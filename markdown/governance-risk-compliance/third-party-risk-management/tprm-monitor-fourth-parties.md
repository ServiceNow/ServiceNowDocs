...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/third-party-risk-management/tprm-monitor-fourth-parties.html
release: zurich
...
-   **View the fourth-nth parties that are associated with a third party**
    ...
    For more information on how to view all the related fourth-nth parties, see [Viewing information on fourth parties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/third-party-risk-management/tprm-ws-tab-tp-downstream-suppliers.md).
...
-   **Manually create a fourth-nth party record**
    ...
    For more information on how to create a fourth-nth party record, see [Create a fourth-nth party record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/third-party-risk-management/tprm-fourth-party-create.md).
...
-   **Promote a fourth-nth party to a third party**
    ...
    For more information on how to promote a fourth-nth party record to a third-party record, see [Promote a fourth-nth party to a third party](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/third-party-risk-management/tprm-fourth-party-promote.md).


**Related topics**  


[Viewing information on fourth parties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/third-party-risk-management/tprm-ws-tab-tp-downstream-suppliers.md)
