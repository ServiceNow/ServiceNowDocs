...
-   ServiceNow Otto for Smart Assessment Engine \(SAE\) is installed and the Smart Assessment Response Assist skill is active.
    ...
    For more information, see [Activate smart assessment response assist skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/smart-assessment-engine/activate-smart-assessment-response-assist-skill.md).
...
To use AI-assisted drafting in an active assessment, see [Generate AI-assisted draft responses in a TPRM assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/third-party-risk-management/tprm-dms-sae-assess-doc.md).
