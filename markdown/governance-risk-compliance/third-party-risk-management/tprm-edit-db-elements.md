...
<table id="choicetable_gv3_q3r_g5"><thead><tr><th align="left" id="d175198e109">

Action

</th><th align="left" id="d175198e112">

Steps

</th></tr></thead><tbody><tr><td id="d175198e118">
...
3.  Create the visualization as described in [Data visualizations in Platform Analytics](https://www.servicenow.com/docs/access?context=analytics-center-data-visualizations&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
...
4.  Configure the element and choose **Save**. For more information about configuring an element, see one of the following:
    -   [Edit a data visualization in an inline dashboard](https://www.servicenow.com/docs/access?context=editing-dv-in-line-db&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US)
    -   [Edit a Platform Analytics filter on a dashboard](https://www.servicenow.com/docs/access?context=edit-filters-configurable-workspaces&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US)
...
Filters let users filter data for all report widgets on a dashboard that follow them. You can add filters to both the entire dashboard and to individual dashboard tabs.
 ...
 For more information, see [Filters in Platform Analytics](https://www.servicenow.com/docs/access?context=interactive-filters-workspace&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).

</td></tr><tr><td id="d175198e376">
