...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/third-party-risk-management/using-legacy-ui.html
release: yokohama
...
-   **[Configure a risk assessment to recur on a schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/define-repeating-vend-assess.md)**
...
-   **[Create a VRM third party record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-ws-third-party-create-new.md)**

    Configure a third-party risk assessment to recur on a schedule to regularly update risk results for a third party or an engagement.

    Role required: admin or sn\_vdr\_risk\_asmt.vendor\_risk\_manager.

-   **[Setting up VRM third-party hierarchies and engagements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/vendor-hierarchy-engagements.md)**
...
-   **[Define a VRM engagement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-ws-engagement-request.md)**
...
-   **[Managing external risk assessments — Legacy process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/c_Issues.md)**
...
-   **[Create an external assessment — Legacy process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/create-vendor-risk-assess.md)**
