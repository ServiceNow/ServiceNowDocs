...
1.  Use either of the following methods to start the process:
    ...
    -   In the Vendor Management Workspace, select the list icon ![](../../grc-workspace-vrm/image/ws-list-icon.png) and then navigate to **Tiering risk assessments** &gt; **Open assigned to me**.
