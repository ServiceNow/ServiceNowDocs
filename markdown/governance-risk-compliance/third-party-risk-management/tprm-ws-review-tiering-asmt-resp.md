---
title: Review VRM tiering assessment responses
description: Starting with GRC: TPRM version 15.0.0, risk tiering is a legacy process that you do not need to perform. Instead, use the IRQ process in the Vendor Management Workspace.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/third-party-risk-management/tprm-ws-review-tiering-asmt-resp.html
release: yokohama
...
1.  Use either of the following methods to start the process:
    ...
    -   In the Vendor Management Workspace, select the list icon \[Omitted image "ws-list-icon.png"\] Alt text: and then navigate to **Tiering risk assessments** &gt; **Open assigned to me**.
