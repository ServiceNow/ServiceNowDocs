...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/third-party-risk-management/tprm-drtp-roi-packages.html
release: xanadu
...
3.  On the form, select and fill in the remaining fields.
...
4.  Select **Export info register** to initiate the download process.
    ...
    For more information on validation, see [Validate Register of Information packages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/third-party-risk-management/tprm-valid-dora.md).
