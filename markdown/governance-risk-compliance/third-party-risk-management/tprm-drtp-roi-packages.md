...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/third-party-risk-management/tprm-drtp-roi-packages.html
release: yokohama
...
4.  Select **Export info register** to initiate the download process.
    ...
    For more information on validation, see [Validate Register of Information packages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-valid-dora.md).
