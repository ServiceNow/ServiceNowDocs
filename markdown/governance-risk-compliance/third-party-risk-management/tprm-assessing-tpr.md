...
-   **Third-party \(TP\) element collection process: Collect TP element information**
    ...
    ![Infographic that shows the TP element collection process in the due diligence workflow. For the text description, refer to the process steps that follows.](../../grc-workspace-vrm/image/mmasset0020761-TP-element-process-vertical.png)
