---
title: Create a fourth-nth party record
description: Create a fourth-nth party record by using the Third-party Risk Management application. You can create fourth-nth party records manually as an alternative to using a fourth-party registration questionnaire.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/third-party-risk-management/tprm-fourth-party-create.html
release: xanadu
...
If you only need to create one fourth-nth party record or don't have time to send a questionnaire to a third party, you can create a fourth-nth party record manually. To create and register multiple fourth-nth party records, see [Register a fourth-nth party](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/third-party-risk-management/tprm-fourth-party-register.md).
...
-   Terminated
-   Onboarding rejected
 **Note:** After a fourth-nth party record is active, it’s available for use in your risk management program.
...
Additional information about the fourth-nth party.
...
6.  Associate the active fourth-nth party record with a third party by navigating to the **Downstream Suppliers** tab of the desired third party and selecting **Add**.
    ...
    For more information on fourth-nth parties, see [Monitoring your fourth-nth parties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/third-party-risk-management/tprm-monitor-fourth-parties.md).
