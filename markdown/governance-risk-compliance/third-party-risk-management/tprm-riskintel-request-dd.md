...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/third-party-risk-management/tprm-riskintel-request-dd.html
release: yokohama
...
4.  On the **Risk Intelligence report request** tab, select **New** and specify the **Provider** and **Request type**.
    ...
    For descriptions of all these fields, see [Risk intelligence report request form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-rir-form.md).

5.  In the Sanction section of the form, enter any sanction-related information.

    For information on how to track sanctions screening information, see [Track sanctions-related information](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-riskintel-track-sanctions.md).
