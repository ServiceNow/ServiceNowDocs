...
4.  If the message indicates issues, download `Consolidated_Reports.zip` from the attachments area of the request record and open `Level4_LEI_Validation_Report.csv`.
    ...
    For descriptions of all columns in the report, see [Level 4 LEI Validation Report columns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/third-party-risk-management/tprm-lei-validation-report.md).
