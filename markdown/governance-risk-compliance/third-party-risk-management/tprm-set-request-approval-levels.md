...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/third-party-risk-management/tprm-set-request-approval-levels.html
release: yokohama
...
5.  Select **Submit**.
    ...
    For information on setting up rules to assign to levels, see [Set up the approval rules for due diligence requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-set-request-approval-rules.md).

    For more information on approval levels and rules, see [Approving or rejecting requests for due diligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-approving.md).
