...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/third-party-risk-management/tprm-ws-tab-risk-intel-scores.html
release: yokohama
...
Risk intelligence scores are described in [Integrating scores from risk intelligence providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-riskintelprvdr-overview.md), [Set up a risk intelligence provider service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-riskintelprvdr-set-up.md), and [Add a risk intelligence score to risk data for a third party](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-riskintelprvdr-add-score.md).
...
\[Omitted image "tprm-ws-riskintel-scores-for-dd-tab.png"\] Alt text: All risk intelligence scores for a DD request.
...
\[Omitted image "tprm-ws-riskintel-scores-for-tp-tab.png"\] Alt text: All risk intelligence scores for a third party.

Each card displays the following information:

\[Omitted image "tprm-ws-riskintel-card-for-tp.png"\] Alt text: All risk intelligence scores for a third party.
