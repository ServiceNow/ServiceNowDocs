...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/third-party-risk-management/tprm-ws-third-party-create-new.html
release: yokohama
...
See [Integrating scores from risk intelligence providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-riskintelprvdr-overview.md).
...
If you selected **Override risk rating**, you must enter a reason for the override.
    ...
    For more information, see [Setting up VRM third-party hierarchies and engagements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/vendor-hierarchy-engagements.md).
