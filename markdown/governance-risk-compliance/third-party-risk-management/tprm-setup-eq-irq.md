...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/third-party-risk-management/tprm-setup-eq-irq.html
release: australia
...
3.  Select the Metric Categories related list, the category name, and then select the question from the Assessments Metrics related list that you want to configure.
    ...
    For more information on the different types of questions and how to define them, see [Define a question](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/governance-risk-compliance/third-party-risk-management/tprm-questions-create.md).
