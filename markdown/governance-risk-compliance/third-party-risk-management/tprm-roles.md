...
A user with the TPRM SAE admin \[sn\_smart\_asmt.assessment\_admin\] role can create SAE templates in the [Configure domain separation for Vendor Management Workspace](https://www.servicenow.com/docs/access?context=config-domain-sep-vendor-management-configurable-workspace&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US) and Assessment Workspace.
...
For more information on SAE related roles, see [Roles in Smart Assessment Engine](../../assessment-engine/reference/sae-roles-defined.md).
...
[Roles in Smart Assessment Engine](../../assessment-engine/reference/sae-roles-defined.md)
