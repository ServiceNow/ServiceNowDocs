...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/third-party-risk-management/tprm-ws-request-dd-for-engagement.html
release: yokohama
...
3.  On the request form, specify the purpose of your request.
    ...
    -   **Offboard an engagement with no due diligence**
        ...
        For more information, see [Offboarding an engagement without conducting due diligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-dd-request-offboard-no-dd.md).

    For descriptions of each type of due diligence request, see [Requesting third-party risk due diligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/third-party-risk-management/tprm-requesting-tpr-due-diligence.md).
