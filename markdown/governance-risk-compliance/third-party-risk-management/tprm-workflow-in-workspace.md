...
-   **TP element collection process: Collect third-party element information \(Optional\)**
    ...
    11. In the Vendor Management Workspace, the TPR manager or owner opens the engagement and manually adds elements to the Engagement elements tab of the engagement.
