...
1.  Follow the instructions in [Set up Google Maps API](https://www.servicenow.com/docs/access?context=set-up-google-maps-api&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
