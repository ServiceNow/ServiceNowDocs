...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/third-party-risk-management/tprm-question-bank-create.html
release: xanadu
...
<table id="choicetable_rkc_13z_hcc"><thead><tr><th align="left" id="d69949e102">

Option

</th><th align="left" id="d69949e105">

Description

</th></tr></thead><tbody><tr><td id="d69949e111">

**Create a question**

</td><td>

Select **New** and fill out the form. For more information, see [Define a question](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/third-party-risk-management/tprm-questions-create.md).

</td></tr><tr><td id="d69949e134">
