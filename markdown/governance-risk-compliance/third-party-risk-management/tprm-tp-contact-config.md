...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/third-party-risk-management/tprm-tp-contact-config.html
release: xanadu
...
2.  On the third-party contacts page, select a third party to view the list of associated contacts.
    ...
    -   To manage existing contacts:
        ...
        **Note:** For more information on managing third-party contacts, see [Manage the access for your third-party contacts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/third-party-risk-management/tprm-manage-tp-contact.md).
