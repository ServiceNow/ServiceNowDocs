---
title: Now Assist for Third-party Risk Management \(TPRM\) \(TPRM\)
description: Use the ServiceNow Now Assist for Third-party Risk Management \(TPRM\) \(TPRM\) application to empower your risk management teams with generative AI-powered capabilities to automate and streamline data collection enabling teams to efficiently gather, validate, and report on third-party risk information.
locale: en-US
release: yokohama
...
# Now Assist for Third-party Risk Management \(TPRM\) \(TPRM\)

Use the ServiceNow® Now Assist for Third-party Risk Management \(TPRM\) \(TPRM\) application to empower your risk management teams with generative AI-powered capabilities to automate and streamline data collection enabling teams to efficiently gather, validate, and report on third-party risk information.
