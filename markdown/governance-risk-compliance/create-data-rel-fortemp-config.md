...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/create-data-rel-fortemp-config.html
release: yokohama
topic_type: task
