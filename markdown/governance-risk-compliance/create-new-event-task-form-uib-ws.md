...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/create-new-event-task-form-uib-ws.html
release: yokohama
...
Beginning with the Yokohama release, you can now manually add a dependency for the event task or select an event task from the list in the **Dependencies** field. Only applicable event tasks are shown in this field.
...
-   **Recovered**
 ...
 For more information on enhanced event asset management, see [Event assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/event-assets.md).
...
</table>**Parent Topic:**[Monitor event tasks and create ad-hoc tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/add-an-event-task-to-exercise-event.md)
