...
4.  Click **New**.
    ...
    For field descriptions of the Create New Issue form, see [Compliance workspace issue form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/grc-compliance-management-workspace/new-issue-form-compliance-ws.md).
