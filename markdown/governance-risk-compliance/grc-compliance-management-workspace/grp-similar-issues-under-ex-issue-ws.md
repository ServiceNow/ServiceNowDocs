...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/grc-compliance-management-workspace/grp-similar-issues-under-ex-issue-ws.html
release: zurich
...
3.  Click the bulb icon and select **Issues with existing parent** from the **Group with** drop-down list.

4.  Select **Similar issue** to group the similar issue with the current issue.
