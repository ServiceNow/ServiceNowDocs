...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-compliance-management-workspace/create-ctrl-objective-ws.html
release: xanadu
...
Option to generate control requirements automatically for every control generated under an entity. **Note:**

-   If no control objective requirements exist, then control requirements are not generated.
...
Description of the control objective.
    ...
    To view and manage the details of the control objective that you created, see [Manage a control objective from the overview page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/grc-compliance-management-workspace/co-overview-pc-ws.md).
