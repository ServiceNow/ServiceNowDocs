...
5.  Select a **Response type** in the Group assessments pop-up.
    ...
    For more information on the response types, see [Consolidate control attestations using the Same Response feature](../../grc-policy-and-compliance/concept/c_Attestations.md#).
