...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/grc-compliance-management-workspace/create-control-ws.html
release: xanadu
...
Option to generate attestation tasks for each control requirement.

 This provides the ability to attest compliance at the control requirement level, not just at the control level.
