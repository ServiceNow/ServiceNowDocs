...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/create-contact-rules-emergency-notifications.html
release: xanadu
topic_type: task
...
6.  To import contacts using a sync rule, you must first [create a contact import rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/contact-import-sync-rule.md).
...
-   **[Create contact import rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/contact-import-sync-rule.md)**  
