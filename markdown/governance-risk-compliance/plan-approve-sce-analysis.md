...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/plan-approve-sce-analysis.html
release: yokohama
topic_type: task
last_updated: "2025-07-31"
reading_time_minutes: 1
breadcrumb: [Request the plan approval, Conducting a scenario analysis, Manage, Operational Resilience, Governance, Risk, and Compliance]
---
...
1.  Navigate to **All** &gt; **Operational Resilience Workspace** &gt; **All scenario analysis** and select the scenario analysis that you’re working on.
...
3.  Check your emails for notifications.
    ...
    1.  Log in as an administrator and navigate to **All** **&gt; Emails** in the application UI.
    ...
    3.  In the email record, select **Preview Email**.
    ...
    4.  In the email, select **Approve**.
        ...
        You can approve or reject the scenario analysis from the **Comments** section or you can view the **Approval Request** links as shown in the example. The approved analysis is updated to the **Analyze** state. The rejected scenario analysis is reset to the **Draft** state.

4.  To approve, reject, or cancel the scenario analysis, double-click the state column on the **Approval** tab.
