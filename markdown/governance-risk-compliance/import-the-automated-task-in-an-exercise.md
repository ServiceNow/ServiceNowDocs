...
3.  Fill in the required fields in the **Details** tab.
    ...
    For more information on the fields, see [Create Event Task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/governance-risk-compliance/create-new-event-task-form-uib-ws.md).
