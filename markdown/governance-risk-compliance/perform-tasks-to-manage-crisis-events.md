...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/perform-tasks-to-manage-crisis-events.html
release: yokohama
topic_type: concept
...
-   Create a crisis event. For more information, see [Start a crisis event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/start-crisis-event-in-uib-ws.md).
-   Add an asset and plan to the crisis event. For more information, see [Track impacted assets and add related plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/add-asset-plan-to-crisis-event-uib-ws.md).
-   Add an event task to the crisis event. For more information, see [Add a task to the crisis event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/add-event-task-to-crisis-event.md).
-   Submit the event task for the exercise event. For more information, see [Request an approval and approve the crisis event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/submit-event-task-for-crisis-event-uib-ws.md).

## Additional information on Crisis events

-   For information on the **Crisis events** tab in the Home page, see [Home page view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/home-page-uib-ws.md).
-   For information on the threats, feeds, and alerts in the Crisis map interface, see [Crisis map interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/threats-feeds-alerts-crisis-map.md).
-   For information on the administrative tasks in the Crisis map interface, see [Setup for Crisis map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/crisis-map-admin-tasks.md).
-   For information on the crisis events, see [Crisis events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/crisis-management-uib.md).
...
For information on importing the automated task in an event, see [Import automated tasks and start an event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/import-the-automated-task-in-an-event.md).

-   **[Start a crisis event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/start-crisis-event-in-uib-ws.md)**  
...
-   **[Track impacted assets and add related plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/add-asset-plan-to-crisis-event-uib-ws.md)**  
...
-   **[Add a task to the crisis event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/add-event-task-to-crisis-event.md)**  
...
-   **[Import automated tasks and start an event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/import-the-automated-task-in-an-event.md)**  
...
-   **[Creating action items in crisis events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/creating-action-items-in-crisis.md)**  
...
-   **[Create a similar tasks group in a crisis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/create-sim-tasks-grp-crisis.md)**  
...
-   **[Request an approval and approve the crisis event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/submit-event-task-for-crisis-event-uib-ws.md)**  
