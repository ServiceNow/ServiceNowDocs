...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/bcp-related-assets-plans-cmdb.html
release: yokohama
topic_type: task
...
You can [refer one of the related plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/bcp-recovery-tasks-grid.md) in a recovery task of the main plan and sequence the order of execution in the event.
