...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/governance-risk-compliance/bcp-related-assets-plans-cmdb.html
release: xanadu
topic_type: task
...
You can [refer one of the related plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/governance-risk-compliance/bcp-recovery-tasks-grid.md) in a recovery task of the main plan and sequence the order of execution in the event.
