...
1.  [Establishing the connection and credential aliases with the RSS feed sources](https://www.servicenow.com/docs/access?context=credentials-connections-alias&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
...
![Image displaying the configurations steps of RSS feeds.](../image/rss-feed-setup.jpg "Workflow of setting up and pulling RSS feeds")
...
-   **[Regulatory taxonomy overview](regulatory-taxonomy-overview.md)**  
