---
title: Activate Regulatory alert recommendation skill
description: Configure the recommendation skill from ServiceNow Otto to generate the recommendations of the impacted areas for a regulatory alert.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/regulatory-change-management-service-portal/configure-recommendation-skill-for-a-regulatory-alert.html
release: zurich
...
# Activate Regulatory alert recommendation skill

Configure the recommendation skill from ServiceNow Otto to generate the recommendations of the impacted areas for a regulatory alert.
...
4.  Select the General details section to review the following fields and confirm that the recommendation skill meets your requirements.
    ...
    **Note:**
    ...
    -   [Make a copy of AI skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/make-a-copy-of-a-now-assist-skill.md)
    -   [Troubleshoot an AI skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/troubleshoot-a-now-assist-skill.md)
...
10. Select **Activate**.
    ...
    The ServiceNow Otto recommendation skills for a regulatory alert are activated.
