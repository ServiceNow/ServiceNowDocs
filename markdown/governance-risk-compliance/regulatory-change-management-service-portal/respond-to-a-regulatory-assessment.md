...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/governance-risk-compliance/regulatory-change-management-service-portal/respond-to-a-regulatory-assessment.html
release: australia
...
4.  To reassign the assessment to a different assessor, do the following.

    1.  Select More options on the top right.

    2.  Select **Reassign**.

5.  To cancel the assessment while responding, select **Cancel**.
