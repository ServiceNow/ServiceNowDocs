...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/regulatory-change-management-service-portal/rcm-workspace-for-managers.html
release: yokohama
...
Use the regulatory change icon \[Omitted image "reg-change-icon.png"\] Alt text: to access the landing page.
...
\[Omitted image "rcm-homepage-ws.png"\] Alt text: Landing page.
