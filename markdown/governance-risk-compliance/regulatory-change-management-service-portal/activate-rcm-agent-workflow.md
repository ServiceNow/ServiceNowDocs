...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/regulatory-change-management-service-portal/activate-rcm-agent-workflow.html
release: zurich
...
If you have the RCM user \[sn\_grc\_reg\_change.user\] role and the sn\_grc\_comp\_genai.reg\_change\_ai\_agent\_user role, you can get regulatory analysis using the get regulatory analysis agentic workflow in the ServiceNow Otto panel.
...
4.  Select **Get Regulatory Analysis**.
...
</table>6.  Review how user and data access is defined to confirm that the default settings meet your requirements by selecting **Define security controls**.
