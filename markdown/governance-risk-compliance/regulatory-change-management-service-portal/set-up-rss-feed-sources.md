...
3.  On the form, fill in the fields.
    ...
    |Connection|Connection that has the details from which the feed would be obtained. For more information, refer to [Create an HTTP\(s\) connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/create-https-connection.md).|
    |Active|Option to denote if the source is active. Only active sources are able to fetch the feeds.|
    |Provider|Service or platform that generates and distributes RSS feeds for websites or content creators. For more information, refer to, [Create a connection Alias for third-party provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/create-cnctn-alias.md).|
