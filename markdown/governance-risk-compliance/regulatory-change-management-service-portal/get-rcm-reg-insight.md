...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/governance-risk-compliance/regulatory-change-management-service-portal/get-rcm-reg-insight.html
release: zurich
...
3.  To initiate the get regulatory analysis agentic workflow, select one of the following:
    ...
    -   Open the ServiceNow Otto panel by selecting the ServiceNow Otto icon\[Omitted image "icon-ai-admin-center-otto-panel.png"\] and then select **Get Regulatory Analysis**.
    -   Select **Ask ServiceNow Otto** and then **Get analysis**.
    The ServiceNow Otto panel icon is available to select anywhere in the Compliance Workspace and the **Ask ServiceNow Otto** action menu is available when you're on a regulatory alert page.

    Here is an example of how this workflow appears when you initiate it.

    \[Omitted image "get-regulatory-analysis.png"\] Alt text: Details of initiating the get regulatory alerts workflow in the Ask ServiceNow Otto panel.

4.  Analyze and enrich regulatory alerts by adding enriched insights or generating recommended impacted areas.

<table id="choicetable_hf2_xq3_zgc"><thead><tr><th align="left" id="d369683e248">

Option

</th><th align="left" id="d369683e251">

Description

</th></tr></thead><tbody><tr><td id="d369683e257">

**Add enriched insights**

</td><td>

In the ServiceNow Otto panel, ask the agent to enrich a regulatory alert with web sources to get a comprehensive overview by entering `1`.\[Omitted image "get-regulatory-analysis-2.png"\] Alt text: Details of agent enriching a regulatory alert in the Now Assist panel.
...
</td></tr><tr><td id="d369683e296">

**Recommend impacted areas**

</td><td>

In the ServiceNow Otto panel, ask the agent to check for recommended impacted areas for a regulatory alert by entering `2`.\[Omitted image "get-regulatory-analysis-3.png"\] Alt text: Details of agent recommending impacted areas in the Now Assist panel.
...
</table>    In the ServiceNow Otto panel, the agent receives a notification when the interaction is generated, enabling your users to follow the on-screen instructions and complete the task.
...
[Activate the get regulatory analysis agentic workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/regulatory-change-management-service-portal/activate-rcm-agent-workflow.md)

[Accept or dismiss recommendations for regulatory alert impacted citations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/regulatory-change-management-service-portal/manage-recommendation-reg-alert.md)

[Accept or dismiss recommendations for regulatory alert impacted control objectives](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/regulatory-change-management-service-portal/manage-recommend-co-reg-alert.md)

[Accept or dismiss recommendations for regulatory alert impacted controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/regulatory-change-management-service-portal/manage-recos-for-controls.md)

[Add impacted areas manually to a regulatory alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/governance-risk-compliance/regulatory-change-management-service-portal/add-impacted-area-reg-alert.md)
