...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/governance-risk-compliance/regulatory-change-management-service-portal/perform-actions-on-reg-alerts-using-ws.html
release: yokohama
...
5.  In the Details tab, fill in the form.
    ...
    **Note:** Beginning with the ServiceNow® Yokohama release, the taxonomy section in the form is not available to the new installations.
...
[Assess the impact of a regulatory event alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/governance-risk-compliance/regulatory-change-management-service-portal/assess-impact-of-reg-change-using-ws.md)
