...
For more information on the available templates, see [Available templates](https://www.servicenow.com/docs/access?context=template-library&version=australia&pubname=australia-application-development&ft:locale=en-US).
