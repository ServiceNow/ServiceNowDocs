...
description: The Operational Technology Discovery application give the user visibility into their Operational Technology environment and discovers the enviroments assets. Operational Technology Discovery is a new application in the Zurich release.The Operational Technology Discovery application give the user visibility into their Operational Technology environment and discovers the enviroments assets. Operational Technology Discovery is a new application in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/operational-technology-discovery-rn.html
release: zurich
topic_type: topic
