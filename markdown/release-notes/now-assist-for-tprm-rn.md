...
description: The ServiceNow Now Assist for TPRM application brings generative AI to Third-party Risk Management. ServiceNow Otto for Third-party Risk Management \(TPRM\) is a new application in the Zurich release.The ServiceNow Now Assist for TPRM application brings generative AI to Third-party Risk Management. ServiceNow Otto for Third-party Risk Management \(TPRM\) is a new application in the Zurich release.The ServiceNow Now Assist for TPRM application brings generative AI to Third-party Risk Management. ServiceNow Otto for Third-party Risk Management \(TPRM\) is a new application in the Zurich release.The ServiceNow Now Assist for TPRM application brings generative AI to Third-party Risk Management. ServiceNow Otto for Third-party Risk Management \(TPRM\) is a new application in the Zurich release.The ServiceNow Now Assist for TPRM application brings generative AI to Third-party Risk Management. ServiceNow Otto for Third-party Risk Management \(TPRM\) is a new application in the Zurich release.The ServiceNow Now Assist for TPRM application brings generative AI to Third-party Risk Management. ServiceNow Otto for Third-party Risk Management \(TPRM\) is a new application in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/now-assist-for-tprm-rn.html
release: zurich
topic_type: topic
last_updated: "2025-11-07"
reading_time_minutes: 4
breadcrumb: [Governance, Risk, and Compliance release notes, Features and changes by product, Release notes for upgrading from Yokohama, Learn about the Zurich release, Zurich release notes]
---
...
## About ServiceNow Otto for Third-party Risk Management \(TPRM\)
