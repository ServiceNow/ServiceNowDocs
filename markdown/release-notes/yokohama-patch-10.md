...
\[Omitted image "prb-chart-yp10.png"\] Alt text: Fixed issues grouped by problem categories bar chart
...
-   **[TRM Category form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/trm-category-form.md)**
-   **[Data certification in the Enterprise Architecture Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-explore-data-cert.md)**
...
-   **[Working with data certification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-work-with-data-cert.md)**
-   **[Create a certification policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-create-policy.md)**
-   **[Edit a certification policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-cert-edit-policy.md)**
-   **[View certification policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-cert-view-policy.md)**
-   **[Publish a certification policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-cert-publish-policy.md)**
-   **[Run certification for a policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-cert-run-certification.md)**
-   **[Track progress of a certification policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-cert-track-progress.md)**
-   **[Activate a certification policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-cert-activate.md)**
-   **[Deactivate a certification policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-cert-deactivate.md)**
-   **[Delete a certification policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-delete-data-cert.md)**
-   **[Export business portfolio data to Excel or CSV](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-export-business-portfolio-data.md)**
-   **[Rationalization of business applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-rationalize-business-applications.md)**

    \[Target &lt;fig&gt; was unhandled by content reference generator.\]

    \[Target &lt;fig&gt; was unhandled by content reference generator.\]

-   **[Bubble chart view of application rationalization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-bubble-chart-view.md)**
-   **[Analyze applications using the bubble chart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-analyze-applications-by-capability.md)**

    \[Omitted image "image.bubble-chart-group"\] Alt text: Bubble chart page with a grouped bubble and the info section displaying the individual business applications within the grouped bubble, highlighted.

-   **[Create a demand using the bubble chart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-create-a-demand-using-the-bubble-chart.md)**

    Select **Bubble chart**.

    Select the bubble for the relevant application that you want to create a demand for perform the following.

-   **[Set the planned disposition of a business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-set-planned-disposition-of-a-business-application.md)**
-   **[Add business application lifecycle data using bubble chart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-add-business-application-lifecycle-data.md)**
...
-   **[Edit business application details in bubble chart view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-edit-ba-details-in-bubble-chart.md)**

    You can make updates to the business application record directly from the list, without leaving the bubble chart view.

-   **[List view of application rationalization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-list-view.md)**
-   **[Create a demand using the list view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-create-a-demand-using-the-list-view.md)**
-   **[Add business application lifecycle data using the list view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-add-business-application-lifecycle-data-listview.md)**
-   **[Edit business application details in list view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-edit-business-application-details.md)**
-   **[Edit a demand associated with a business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-edit-a-demand-associated-with-a-business-application.md)**
-   **[Edit a project associated with a business application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-edit-a-project-associated-with-a-business-application.md)**
-   **[Export application rationalization data to Excel or CSV](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-export-app-rat-list-data.md)**
...
-   **[Apply filters on the Application Rationalization page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-apply-filters-app-rat.md)**
...
-   **[View all AI System Product Models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-view-all-ai-system-product-models.md)**
-   **[View all AI Model Product Models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-view-all-ai-model-product-models.md)**
-   **[View all AI Dataset Product Models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-view-all-ai-dataset-product-models.md)**
-   **[View all AI Prompt Product Models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-view-all-ai-prompt-product-models.md)**
-   **[Add or edit a TRM category](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-create-new-trm-category.md)**

    \[Target &lt;context&gt; was unhandled by content reference generator.\]

-   **[General information form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-cert-gen-info-form.md)**

    Learn about the fields of the General information form. Use this form to provide details for the new policy.

-   **[Options form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-cert-options-form.md)**
...
-   **[Schedule form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-cert-schedule-form.md)**
...
-   **[Data filter form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/eaw-data-filter-form.md)**
