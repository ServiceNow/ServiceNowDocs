...
description: ServiceNow Impact is built on the Impact AI Platform and combines customized service with a digital interface to provide tailored recommendations and guidance. Impact was enhanced and updated in the Zurich release.ServiceNow Impact is built on the Impact AI Platform and combines customized service with a digital interface to provide tailored recommendations and guidance. Impact was enhanced and updated in the Zurich release.ServiceNow Impact is built on the Impact AI Platform and combines customized service with a digital interface to provide tailored recommendations and guidance. Impact was enhanced and updated in the Zurich release.ServiceNow Impact is built on the Impact AI Platform and combines customized service with a digital interface to provide tailored recommendations and guidance. Impact was enhanced and updated in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/impact-rn.html
release: zurich
topic_type: topic
...
-   **Activation information**
    -   **[Impact](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/impact/impact-landing-page.md)**
        ...
        See [Impact packages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/impact/impact-packages.md) for information on package entitlement and features activation.

        See [Configuring Impact](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/impact/configuring-impact.md) for details on configuring Impact and its features.

-   **Upgrade information**

    The Impact Store Application configuration requires a sequence of tasks in a unified registration process. See [Configure the Impact Store Application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/impact/configuring-impact-platform.md).
