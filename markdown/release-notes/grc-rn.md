...
description: The ServiceNow Integrated Risk Management \(IRM\) application enables your organization to continue to provide its business services during adverse operational events, such as a pandemic, extreme weather, or hacking. Integrated Risk Management was enhanced and updated in the Zurich release.The ServiceNow Integrated Risk Management \(IRM\) application enables your organization to continue to provide its business services during adverse operational events, such as a pandemic, extreme weather, or hacking. Integrated Risk Management was enhanced and updated in the Zurich release.The ServiceNow Integrated Risk Management \(IRM\) application enables your organization to continue to provide its business services during adverse operational events, such as a pandemic, extreme weather, or hacking. Integrated Risk Management was enhanced and updated in the Zurich release.The ServiceNow Integrated Risk Management \(IRM\) application enables your organization to continue to provide its business services during adverse operational events, such as a pandemic, extreme weather, or hacking. Integrated Risk Management was enhanced and updated in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/grc-rn.html
release: zurich
topic_type: topic
last_updated: "2025-07-31"
reading_time_minutes: 7
keywords: [Common Core, GRC Common Core, GRC Common, Common Core, GRC Common Core, GRC Common, Common Core, GRC Common Core, GRC Common, Common Core, GRC Common Core, GRC Common]
