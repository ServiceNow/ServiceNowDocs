---
title: Changes to plugins from Utah to Xanadu
description: Before you upgrade from Utah to Xanadu, read the release notes for information about new plugins and existing plugins that were deprecated, renamed, or changed in some way.This table lists the existing plugins that were deprecated in Utah, Vancouver, Washington DC, or Xanadu.This table lists the existing plugins that were planned for deprecation in a future release.This table lists the existing plugins that were renamed or changed in Utah, Vancouver, Washington DC, or Xanadu.This table lists the existing plugins that are in maintenance mode.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/release-notes/plugin-changes-u-to-x.html
release: xanadu
topic_type: reference
last_updated: "2024-08-01"
reading_time_minutes: 26
breadcrumb: [Release notes for upgrading from Utah, Learn about the Xanadu release, Xanadu release notes]
---

# Changes to plugins from Utah to Xanadu

Before you upgrade from Utah to Xanadu, read the release notes for information about new plugins and existing plugins that were deprecated, renamed, or changed in some way.

## Utah, Vancouver, and Washington DC plugin changes

See [Utah plugin changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/release-notes/plugin-changes.md) for more information.

See [Vancouver plugin changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/release-notes/plugin-changes.md) for more information.

See [Washington DC plugin changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/release-notes/plugin-changes.md) for more information.

## Deprecated plugins

This table lists the existing plugins that were deprecated in Utah, Vancouver, Washington DC, or Xanadu.
...
Cloud Provisioning and Governance - Terraform Connector for IBM Cloud
...
CMDB: IT Fundamentals\[com.sn\_apphealth\]
...
Transition to CMDB Data Workspace/Insights and Data Foundation Dashboard.
...
Migrate to Advanced Work Assignment and Agent Chat on the Agent Workspace.
...
Select and activate alternative capability, Integrations Hub or Integrations with Anisble.
...
Legal Service Management\[com.snc.legal\_service\_automation, com.snc.marketing\_service\_automation, com.snc.finance\_service\_automation\]
...
Lets you launch Legal Service Automation and other service management applications. Activation of this plugin on production instances may require a separate license. Contact ServiceNow for details.

</td><td>

Customer should find a replacement technology.
...
OpenID Single Sign-On\[com.snc.integrations.sso.openid\]
...
Transition to “Integration - Multiple Provider Single Sign-On Installer “ plugin \(com.snc.integration.sso.multi.installer\) and configure IDP to use the SSO feature.
...
SAML 1.1 Single Sign-on - Update 1\[com.snc.sso.saml11.update1\]
...
Legacy version of single sign-on used with an external OpenID Provider \(OP\). OpenID Connect is provided in London but is limited to web services.

</td><td>

Transition to the “Integration - Multiple Provider Single Sign-On Installer” plugin \(com.snc.integration.sso.multi.installer\) and configure IDP to use OIDC-based SSO feature.
...
Software Asset Management Classic UI
...
Classic user interface for Software Asset Management \(com.snc.software\_asset\_management\).

</td><td>

Migrate to Software Asset Workspace \(com.sn\_sam\_workspace\) to use the new user interface.
...
Vendor Manager Workspace \(Legacy\)\[com.snc.vlm.vmw\]
...
Migrate to the new workspace, Vendor Management Workspace on the ServiceNow Store.
...
</table>## Renamed and changed plugins from Utah to Xanadu

This table lists the existing plugins that were renamed or changed in Utah, Vancouver, Washington DC, or Xanadu.
...
Advanced Goal Framework\[sn\_gfa\]
...
Renamed to Goal Framework for SPM.

</td></tr><tr><td>

Alignment Planner Workspace\[sn\_align\_ws\]
...
Prioritize, roadmap, and track work for traditional waterfall approaches and enhance your project and demand management.

</td><td>

Renamed to Portfolio Planning.
...
Enables to analyze the full range of costs associated with your cloud assets so you can identify and take action on opportunities to optimize operations and save money.

</td><td>

Renamed to Cloud Cost Management.

</td></tr><tr><td>

Lenses for Alignment Planner Workspace\[sn\_apw\_advanced\]
...
Prioritize all work, align goals, visually roadmap, and track progress when using Agile, waterfall, or hybrid approaches.

</td><td>

Renamed to Strategic Planning.
