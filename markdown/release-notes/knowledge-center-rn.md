...
description: The ServiceNow Knowledge Center helps you manage your knowledge articles from a single interface. It consists of dashboards that provide metrics of articles and facilitate swift actions. Knowledge Center is introduced in the Zurich release.The ServiceNow Knowledge Center helps you manage your knowledge articles from a single interface. It consists of dashboards that provide metrics of articles and facilitate swift actions. Knowledge Center is introduced in the Zurich release.The ServiceNow Knowledge Center helps you manage your knowledge articles from a single interface. It consists of dashboards that provide metrics of articles and facilitate swift actions. Knowledge Center is introduced in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/knowledge-center-rn.html
release: zurich
topic_type: topic
...
-   **New plugins**
    ...
    Knowledge Center \(com.snc.knowledge\_center\): Knowledge Center helps you manage your knowledge articles from a single interface.
