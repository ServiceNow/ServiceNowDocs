---
title: Xanadu Patch 3 Hotfix 2
description: The Xanadu Patch 3 Hotfix 2 release contains fixes to these problems.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/release-notes/xanadu-patch-3-hf-2.html
release: xanadu
...
# Xanadu Patch 3 Hotfix 2

The Xanadu Patch 3 Hotfix 2 release contains fixes to these problems.

-   **Build information:**

    Build date: 12-05-2024\_2307

    Build tag: glide-xanadu-07-02-2024\_\_patch3-hotfix2-12-04-2024
...
UI Actions
 ...
 [KB1709928](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB1709928)
...
UI Actions
 ...
 [KB1710085](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB1710085)

</td><td>

MFA Configured with SSO users are wrongly redirected to a page that can't be found
