...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/release-notes/upgrades-phase-6.html
release: xanadu
topic_type: task
...
-   Negotiate a suitable upgrade time for all users of the ServiceNow system.
    ...
    For example, schedule the upgrade after hours, to minimize impact to your users. Remember to schedule the upgrade to occur 15–20 minutes before the [**Upgrade** scheduled job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/release-notes/upgrades-phase-3.md) interval.
