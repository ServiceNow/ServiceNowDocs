...
description: The ServiceNow App Engine Management Center \(AEMC\) application enables admins to manage app development from intake through production. AEMC was enhanced and updated in the Zurich release.The ServiceNow App Engine Management Center \(AEMC\) application enables admins to manage app development from intake through production. AEMC was enhanced and updated in the Zurich release.The ServiceNow App Engine Management Center \(AEMC\) application enables admins to manage app development from intake through production. AEMC was enhanced and updated in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/aemc-rn.html
release: zurich
topic_type: topic
...
The ServiceNow® App Engine Management Center \(AEMC\) application enables admins to manage app development from intake through production. AEMC was enhanced and updated in the Zurich release.

## About App Engine Management Center
