...
description: The ServiceNow App Engine Management Center \(AEMC\) application enables admins to manage app development from intake to deployment to production monitoring. AEMC was enhanced and updated in the Australia release.The ServiceNow App Engine Management Center \(AEMC\) application enables admins to manage app development from intake to deployment to production monitoring. AEMC was enhanced and updated in the Australia release.The ServiceNow App Engine Management Center \(AEMC\) application enables admins to manage app development from intake to deployment to production monitoring. AEMC was enhanced and updated in the Australia release.The ServiceNow App Engine Management Center \(AEMC\) application enables admins to manage app development from intake to deployment to production monitoring. AEMC was enhanced and updated in the Australia release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/release-notes/aemc-rn.html
release: australia
topic_type: topic
