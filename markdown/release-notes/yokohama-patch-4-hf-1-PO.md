---
title: Yokohama Patch 4 Hotfix 1
description: The Yokohama Patch 4 Hotfix 1 release contains fixes to these problems.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/release-notes/yokohama-patch-4-hf-1-PO.html
release: yokohama
...
# Yokohama Patch 4 Hotfix 1

The Yokohama Patch 4 Hotfix 1 release contains fixes to these problems.

-   **Build information:**

    Build date: 06-28-2025\_2229

    Build tag: glide-yokohama-12-18-2024\_\_patch4-hotfix1-06-24-2025
...
Process Mining
 ...
 [KB2229304](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB2229304)
...
Agent Chat
 ...
 [KB2226265](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB2226265)
...
4.  Notice that the Record field in the other browser window isn't updated.
