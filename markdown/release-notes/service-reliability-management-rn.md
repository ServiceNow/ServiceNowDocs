...
description: The ServiceNow Service Reliability Management \(SRM\) application helps your organization respond, collaborate, track, and self-remediate when working on alerts and incidents. SRM was enhanced and updated in the Zurich release.The ServiceNow Service Reliability Management \(SRM\) application helps your organization respond, collaborate, track, and self-remediate when working on alerts and incidents. SRM was enhanced and updated in the Zurich release.The ServiceNow Service Reliability Management \(SRM\) application helps your organization respond, collaborate, track, and self-remediate when working on alerts and incidents. SRM was enhanced and updated in the Zurich release.The ServiceNow Service Reliability Management \(SRM\) application helps your organization respond, collaborate, track, and self-remediate when working on alerts and incidents. SRM was enhanced and updated in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/service-reliability-management-rn.html
release: zurich
topic_type: topic
...
## About Service Reliability Management
