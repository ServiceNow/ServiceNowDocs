---
title: Model Risk Management release notes
description: The ServiceNow Model Risk Management application helps to identify, assess, validate, and address model risks throughout their life cycle. Model Risk Management is a new application in the Zurich release.The ServiceNow Model Risk Management application helps to identify, assess, validate, and address model risks throughout their life cycle. Model Risk Management is a new application in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/grc-model-risk-management-rn.html
release: zurich
topic_type: topic
...
See [Model Risk Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/governance-risk-compliance/model-risk-management.md) for more information.
