...
Review the [Xanadu release notes](../family-release-notes.md) for the target ServiceNow feature release and patch, in addition to product and release documentation.
...
Based on the [Xanadu release notes](../family-release-notes.md) and other release materials, determine new functionality or notable changes that need to be validated after the upgrade.
...
After the upgrade for your development instance is complete, [process the skipped records list](https://www.servicenow.com/docs/access?context=uc-process-skipped-records&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) in the Upgrade Monitor.
...
[Monitor the upgrade to your instance](https://www.servicenow.com/docs/access?context=monitor-upgrade-apply-upgrade&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) and validate that the upgrade to your production instance is complete.
