...
3.  [Monitor the upgrade to your instance](https://www.servicenow.com/docs/access?context=monitor-upgrade-apply-upgrade&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) and validate that the upgrade to your production instance is complete.
