---
title: Australia Patch 4m Hotfix 1
description: The Australia Patch 4m Hotfix 1 release contains fixes to these problems.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/release-notes/australia-patch-4m-hf-1.html
release: australia
...
# Australia Patch 4m Hotfix 1

The Australia Patch 4m Hotfix 1 release contains fixes to these problems.

-   **Build information:**

    Build date: 08-19-2026\_1112

    Build tag: glide-australia-02-11-2026\_\_patch4m-hotfix1-07-24-2026
...
Vulnerability Response \(Family\)

 PRB2075246

</td><td>

Revert USEM versions from Australia Patch 4m
...
1.  On a Zurich platform instance, install a Vulnerability Response version below 30.0.
2.  Upgrade to Australia Patch 4m.

 Observe that the Vulnerability Response version is upgraded to 30.2.5.
