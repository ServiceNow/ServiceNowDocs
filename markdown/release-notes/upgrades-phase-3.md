...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/release-notes/upgrades-phase-3.html
release: xanadu
topic_type: task
...
|Action|Result|
|------|------|
|You schedule an upgrade to Xanadu Patch 8 to take place on June 10 at 3:00pm.|Now Support changes its records to reflect that you should be on Xanadu Patch 8 on June 10 at 3:00pm.|
...
|After the scheduled time on June 10, Now Support receives a ping from your instance.|Now Support tells your instance that it should be on Xanadu Patch 8.|
