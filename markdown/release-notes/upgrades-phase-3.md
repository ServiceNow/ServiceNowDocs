...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/release-notes/upgrades-phase-3.html
release: yokohama
topic_type: task
...
|Action|Result|
|------|------|
|You schedule an upgrade to Yokohama Patch 8 to take place on June 10 at 3:00pm.|Now Support changes its records to reflect that you should be on Yokohama Patch 8 on June 10 at 3:00pm.|
...
|After the scheduled time on June 10, Now Support receives a ping from your instance.|Now Support tells your instance that it should be on Yokohama Patch 8.|
