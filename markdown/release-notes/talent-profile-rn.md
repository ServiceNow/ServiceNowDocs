---
title: Talent profile release notes
description: The ServiceNow Talent profile application helps you get an aggregated view of different talent types at different touch points in the hiring workflow. Talent profile is a new application in the Zurich release.The ServiceNow Talent profile application helps you get an aggregated view of different talent types at different touch points in the hiring workflow. Talent profile is a new application in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/talent-profile-rn.html
release: zurich
topic_type: topic
last_updated: "2025-07-31"
reading_time_minutes: 2
breadcrumb: [Hiring Experiences release notes, HR Service Delivery release notes, Employee Service Management release notes, Features and changes by product, Release notes for upgrading from Yokohama, Learn about the Zurich release, Zurich release notes]
---
...
See [Talent Profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/talent-profile-ovrvw.md) for more information.
