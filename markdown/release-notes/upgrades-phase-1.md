...
1.  Read the release notes for your target version.
    ...
    -   ServiceNow provides release notes for every release. The release notes offer valuable information about new functionality, notable changes, and fixes available in a particular version. Read the [Xanadu release notes](../../family-release-notes.md) to determine whether the upgrade contains functionality you need and fixes that resolve any issues affecting your instance. The release notes can also help you determine whether items you previously customized are being upgraded.
    -   For Xanadu -specific upgrade considerations, see [Pre- and post-upgrade tasks for various products](../reference/upgrade-and-migration-tasks.md).
    -   If you are thinking about upgrading to the Xanadu family, problem \(PRB\) fixes can be an important factor in your upgrade plans. You can generate a list of . Compare the lists of fixed problems across various Xanadu upgrade scenarios to help you decide which release version to upgrade to.
