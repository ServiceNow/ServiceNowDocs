...
description: The ServiceNow Advanced Work Assignment \(AWA\) application automatically assigns work items to your agents based on their availability, capacity, and optionally, skills. AWA was enhanced and updated in the Zurich release.The ServiceNow Advanced Work Assignment \(AWA\) application automatically assigns work items to your agents based on their availability, capacity, and optionally, skills. AWA was enhanced and updated in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/advanced-work-assignment-rn.html
release: zurich
topic_type: topic
...
## About Advanced Work Assignment \(AWA\)
