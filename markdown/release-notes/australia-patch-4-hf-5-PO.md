---
title: Australia Patch 4 Hotfix 5
description: The Australia Patch 4 Hotfix 5 release contains fixes to these problems.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/release-notes/australia-patch-4-hf-5-PO.html
release: australia
...
# Australia Patch 4 Hotfix 5

The Australia Patch 4 Hotfix 5 release contains fixes to these problems.

-   **Build information:**

    Build date: 08-31-2026\_1215

    Build tag: glide-australia-02-11-2026\_\_patch4-hotfix5-08-26-2026
...
AI Native Platform Experience Snowsk8s Service

 PRB2073095

</td><td>

On the Employeeworks canvas page, the reset functionality doesn't work as expected
...
1.  Navigate to https://\[instance-name\].servicenow.com/aiux/employeeworks/canvas.
2.  Add widgets to the canvas.
3.  Select **Reset**.

 Observe that the widgets don't get reset.
