...
description: The ServiceNow Customer Engagement Sequences application enables customer-focused teams to execute structured, personalized outreach and follow-up activities to engage customers throughout the time they’re associated with your business. Customer Engagement Sequences is a new application in the Zurich release.The ServiceNow Customer Engagement Sequences application enables customer-focused teams to execute structured, personalized outreach and follow-up activities to engage customers throughout the time they’re associated with your business. Customer Engagement Sequences is a new application in the Zurich release.The ServiceNow Customer Engagement Sequences application enables customer-focused teams to execute structured, personalized outreach and follow-up activities to engage customers throughout the time they’re associated with your business. Customer Engagement Sequences is a new application in the Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/customer-engagement-sequences-rn.html
release: zurich
topic_type: topic
...
See [Customer Engagement Sequences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/order-management/explore-customer-engagement-sequences.md) for more information.
