...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/release-notes/it-service-management-rn-landing.html
release: australia
topic_type: concept
...
-   **[Change Management release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/change-management-rn.md)**  
...
-   **[DevOps Change Velocity release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/devops-change-velocity-rn.md)**  
...
-   **[Digital End-User Experience release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/digital-end-user-experience-rn.md)**  
...
-   **[Incident Management release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/incident-management-rn.md)**  
...
-   **[ITSM MCP Server release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/itsm-mcp-server-rn.md)**  
...
-   **[ITSM Employee Slate for Moveworks release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/itsm-employeeslate-moveworks-rn.md)**  
...
-   **[Simplified IT Service Management release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/ai-native-it-service-desk-rn.md)**  
The ServiceNow® IT Service Management application provides simplified and automated implementation for administrators and a unified user experience for employees and fulfillers \(service desk agents\).
-   **[L1 IT Service Desk AI Specialist release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/l1-service-desk-ai-specialist-rn.md)**  
...
The ServiceNow® L1 IT Service Desk AI Specialist application is an autonomous worker that investigates and resolves incidents end-to-end without human intervention. It's designed to support high-volume, repeatable L1 incidents enabling a live human agent to handle more complex issues. For incidents that come in as requests, the appropriate request item, such as a software access, is proposed. The L1 IT Service Desk AI Specialist is a new application in the Australia release. See the following sections for release notes by version.
-   **[ServiceNow Otto for IT Service Management \(ITSM\) release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/now-assist-for-itsm-rn.md)**  
...
-   **[On-Call Scheduling release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/on-call-scheduling-rn.md)**  
...
-   **[Service Operations Workspace for ITSM release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/service-operations-workspace-itsm-rn.md)**  
...
-   **[Workforce Optimization for ITSM release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/release-notes/workforce-optimization-for-itsm-rn.md)**  
