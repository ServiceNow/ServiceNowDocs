...
-   Use the improved anonymization dashboard to get more details about anonymization. For example, what data was anonymized and how \(real-time or through anonymization jobs\).
-   Use the new real-time protection module to configure real-time alerting and your blocking policies. You can also view real-time sensitive data logs.
...
Data Privacy is available with activation of the Data Privacy plugin \(`sn_dp_store_app`\). For details, see Activate data privacy.
