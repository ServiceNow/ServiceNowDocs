...
description: The ServiceNow Model Risk Management application helps to identify, assess, validate, and address model risks throughout their life cycle. Model Risk Management is a new application in the Zurich release.
locale: en-US
release: zurich
...
## Model Risk Management highlights for the Zurich release
...
-   **[Document Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/doc-management-landing.md)**

    The ServiceNow® Document Management application helps you to organize and maintain large volumes of documents in one place with version control.
