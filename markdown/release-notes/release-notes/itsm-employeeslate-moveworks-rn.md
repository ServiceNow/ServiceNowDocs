...
description: The ServiceNow ITSM Employee Slate for Moveworks application surfaces active outages, scheduled maintenance, and trending incidents directly on the employee home page. ITSM Employee Slate for Moveworks is a new application in the Australia release.
locale: en-US
release: australia
...
## ITSM Employee Slate for Moveworks highlights for the Australia release
...
## ITSM Employee Slate for Moveworks features
