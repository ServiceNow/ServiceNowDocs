...
description: ServiceNow Impact is built on the Impact AI Platform and combines customized service with a digital interface to provide tailored recommendations and guidance. Impact was enhanced and updated in the Zurich release.
locale: en-US
release: zurich
...
-   **[Admin Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/admin-center-intro.md)[Hardware Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-asset-management/ham-landing-page.md)**
