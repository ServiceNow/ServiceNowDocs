...
-   **Impact**
    ...
    For information on package entitlement and features activation, see Impact packages.

    For details on configuring Impact and its features, see Configuring Impact.
...
-   **Admin Center Hardware Asset Management**
