...
description: The ServiceNow Operational Technology \(OT\) Manager Foundation application helps streamline processes in the Industrial Workspace related to your Operational Technology \(OT\) device data. Operational Technology \(OT\) Manager Foundation is a new application in the Yokohama release.
locale: en-US
release: yokohama
...
## Operational Technology \(OT\) Manager Foundation highlights for the Yokohama release
...
## Operational Technology \(OT\) Manager Foundation features
