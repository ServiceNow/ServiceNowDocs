...
See [CPQ Configurator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/order-management/explore-servicenowcpq.md) for more information.
...
-   **Additional requirements**
    ...
    Before implementing CPQ Configurator, you must prepare your environment to use it. For more information, see [Configuring CPQ Configurator without guided setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/order-management/configuring-servicenow-cpq.md).
