...
description: The ServiceNow Upgrade Console application guides you for a comprehensive and efficient upgrade experience. Upgrade Console was enhanced and updated in the Zurich release.
locale: en-US
release: zurich
...
The ServiceNow® Upgrade Console application guides you for a comprehensive and efficient upgrade experience. Upgrade Console was enhanced and updated in the Zurich release.

## Upgrade Console highlights for the Zurich release
...
See [Upgrade Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/um-landing-page.md) for more information.
