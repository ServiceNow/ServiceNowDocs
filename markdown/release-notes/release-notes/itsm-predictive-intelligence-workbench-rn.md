---
title: ITSM Predictive Intelligence Workbench release notes
description: The ServiceNow ITSM Predictive Intelligence Workbench application provides prebuilt use case templates and guides you through your machine learning implementation to create intelligent IT Service Management \(ITSM\) business processes. ITSM Predictive Intelligence Workbench is deprecated starting with the Yokohama release.The ServiceNow ITSM Predictive Intelligence Workbench application provides prebuilt use case templates and guides you through your machine learning implementation to create intelligent IT Service Management \(ITSM\) business processes. ITSM Predictive Intelligence Workbench is deprecated starting with the Yokohama release.
locale: en-US
release: yokohama
topic_type: topic
...
## About ITSM Predictive Intelligence Workbench
