...
description: ServiceNow AI Platform capabilities were enhancements and updates in the Yokohama release.
locale: en-US
release: yokohama
topic_type: concept
...
ServiceNow AI Platform® capabilities were enhancements and updates in the Yokohama release.
...
-   **[Advanced Work Assignment release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/release-notes/awa-rn.md)**  
The ServiceNow® Advanced Work Assignment \(AWA\) application automatically assigns work items to your agents based on their availability, capacity, and optionally, skills. Advanced Work Assignment was enhanced and updated in the Yokohama release.
-   **[Automated Test Framework release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/release-notes/automated-test-framework-rn.md)**  
...
-   **[Configuration Management Database \(CMDB\) release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/release-notes/cmdb-rn.md)**  
...
-   **[Document Services release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/release-notes/document-services-rn.md)**  
...
-   **[MID Server release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/release-notes/mid-server-rn.md)**  
...
-   **[Notify release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/release-notes/notify-rn.md)**  
The ServiceNow® Notify application provides support for SMS and voice channels on the ServiceNow AI Platform® to communicate with customers. Notify was enhanced and updated in the Yokohama release.
-   **[Password Reset release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/release-notes/password-reset-rn.md)**  
...
-   **[Hermes Messaging Service release notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/release-notes/hermes-messaging-service-rn.md)**  
