...
description: Enterprise Architecture \(formerly Application Portfolio Management\) has new and updated features in the Yokohama release.
locale: en-US
release: yokohama
topic_type: concept
...
Enterprise Architecture \(formerly Application Portfolio Management\) has new and updated features in the Yokohama release.
