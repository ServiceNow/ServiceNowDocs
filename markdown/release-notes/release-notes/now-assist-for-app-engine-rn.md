...
description: The ServiceNow ServiceNow Otto for App Engine application enables creators to enhance custom applications with AI agents and skills that application users can leverage at runtime. ServiceNow Otto for App Engine was enhanced and updated in the Zurich release.
locale: en-US
release: zurich
...
## ServiceNow Otto for App Engine highlights for the Zurich release
