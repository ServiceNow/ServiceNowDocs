...
description: The ServiceNow User Experience Analytics application enables you to monitor usage analytics of Next Experience web applications as well as Virtual Agent, ServiceNow mobile, and Service Portal applications. User Experience Analytics was enhanced and updated in the Yokohama release.The ServiceNow User Experience Analytics application enables you to monitor usage analytics of Next Experience web applications as well as Virtual Agent, ServiceNow mobile, and Service Portal applications. User Experience Analytics was enhanced and updated in the Yokohama release.
locale: en-US
release: yokohama
topic_type: topic
last_updated: "2025-01-30"
reading_time_minutes: 3
keywords: [uxa, navigation, funnel, cohort, uxa, navigation, funnel, cohort]
---
...
## About User Experience Analytics
