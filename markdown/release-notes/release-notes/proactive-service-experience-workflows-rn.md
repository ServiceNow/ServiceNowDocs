...
See [Proactive Service Experience Workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/proactive-service-exp-workflows/assurance-workflows.md) and [Now Assist for Telecommunications, Media and Technology \(TMT\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/telecom-media-technology/now-assist-spmc.md) for more information.

## New in the Yokohama release

-   **[Redirection to the right case type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/proactive-service-exp-workflows/generate-proactive-cases.md)**

    Create a proactive case from an incident in the Proactive Service Experience Workflows.

-   **[Technology Product Support Case playbook stages and activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/proactive-service-exp-workflows/tech-product-support-playbook-stages.md)**
...
-   **[Integrating Technology Product Support Case with southbound external systems](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/proactive-service-exp-workflows/tech-product-outbound-flow.md)**
...
-   **[Create a service problem case from the workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/proactive-service-exp-workflows/create-service-problem-case.md)**
...
-   **[Create a service problem case from the Customer Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/proactive-service-exp-workflows/create-a-product-case-from-the-customer-service-portal.md)**

    Create a service problem case to report an issue about the service from the Customer Service Portal.

-   **[Summarize a service problem case using Now Assist for Telecommunications, Media and Technology \(TMT\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/telecom-media-technology/now-assist-tmt-summarize-case.md)**
...
-   **[Generate the resolution notes for a service problem case using Now Assist for Telecommunications, Media and Technology \(TMT\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/telecom-media-technology/now-assist-tmt-generate-resolution.md)**
...
-   **[Generate a knowledge article for a service problem case using Now Assist for Telecommunications, Media and Technology \(TMT\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/telecom-media-technology/now-assist-tmt-generate-knowledge-article.md)**
...
-   **[Summarize test for a technology product support case using Now Assist for Telecommunications, Media and Technology \(TMT\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/telecom-media-technology/now-assist-tmt-summarize-tech-support-case.md)**
...
-   **[Components installed with Customer Service Problem Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/proactive-service-exp-workflows/spm-components.md)**
...
-   **[Incident Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/c_IncidentManagement.md)**
    ...
    ServiceNow® Incident Management restores normal service operation while minimizing impact to business operations and maintaining quality. You can record an incident and track it through the entire incident life cycle until service is restored and the issue is resolved.
