...
-   **Changes to Goal and Target forms**

    The **Cancelled** option has been added to the **State** field in both the Goal and Target forms, enabling you to set their status to **Cancelled** when needed.

-   **Changes to Strategic Priority form**
