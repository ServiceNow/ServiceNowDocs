...
-   **[Knowledge Center Article Optimization](https://www.servicenow.com/docs/access?context=knowledge-center-article-optimization&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US)**
...
-   **[Knowledge Center article editor](https://www.servicenow.com/docs/access?context=kc-article-editor&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US)**

    Use the editing tools in the Knowledge Center to format knowledge article content such as text, images, and media.


-   **[Potential knowledge gaps](https://www.servicenow.com/docs/access?context=understanding-knowledge-gaps&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US)**
...
-   **[Add a knowledge block to a knowledge article](https://www.servicenow.com/docs/access?context=kc-add-knowledge-blocks-to-a-knowledge-article&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US)**
...
-   **[Article optimization with article length scan](https://www.servicenow.com/docs/access?context=article-optimization-with-article-length-scan&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US)**
...
-   **[Knowledge Center Home Page](https://www.servicenow.com/docs/access?context=kc-home-page&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US)**
...
-   **[Field Service Management](https://www.servicenow.com/docs/access?context=fsm-application-landing-page&version=australia&pubname=australia-field-service-management&ft:locale=en-US)**
    ...
    Enable field service agents to read Knowledge articles that are attached to their work order tasks while they’re offline through the Now Mobile Agent app. For more information, see [Knowledge articles on ServiceNow Agent](https://www.servicenow.com/docs/access?context=access-information-you-need-mobile&version=australia&pubname=australia-field-service-management&ft:locale=en-US).

-   **[Communities](https://www.servicenow.com/docs/access?context=create-knowledge-from-communities&version=australia&pubname=australia-customer-service-management&ft:locale=en-US)**
...
-   **[Problem Management](https://www.servicenow.com/docs/access?context=c_CreateKnowledge&version=australia&pubname=australia-it-service-management&ft:locale=en-US)**
...
-   **[Incident Management](https://www.servicenow.com/docs/access?context=create-a-knowledge-article&version=australia&pubname=australia-it-service-management&ft:locale=en-US)**
