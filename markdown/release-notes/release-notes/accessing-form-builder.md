...
2.  Select **Open**. \[Omitted image "image.tb-accessfrmnavigator"\] Alt text: Access table from the App navigator
...
2.  From the application home, select the menu icon \(\[Omitted image "image.menu-icon"\] Alt text: Menu icon.\) next to a table, and then select **Edit**.
    ...
    **Note:** To edit form views for the selected data table, navigate to the **Forms** tab.
    ...
    \[Omitted image "image.tables-tab"\] Alt text: Data tab.
...
2.  Select **Edit form view** at the bottom of the Configuration pane.
    ...
    \[Omitted image "image.fb-home"\] Alt text: Forms tab.
