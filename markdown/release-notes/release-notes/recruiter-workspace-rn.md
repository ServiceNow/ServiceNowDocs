...
description: The ServiceNow Recruitment workspace application provides a flexible workspace for you as a recruiter to manage, prioritize, and perform your work. Recruitment workspace is a new application in the Zurich release.
locale: en-US
release: zurich
...
## Recruitment workspace highlights for the Zurich release
...
## Recruitment workspace features
...
The Recruitment workspace application is delivered as a Store application. For plugin details, see the Store listing.
