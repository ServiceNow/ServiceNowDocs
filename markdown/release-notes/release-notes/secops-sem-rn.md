...
See [Unified Security Exposure Management \(USEM\)](https://www.servicenow.com/docs/access?context=unified-security-exposure-management-landing-page&version=australia&pubname=australia-security-management&ft:locale=en-US) for more information.
...
-   **[Deferred migration option for Unified Security Exposure Management \(USEM\)](https://www.servicenow.com/docs/access?context=migrate-to-usem&version=australia&pubname=australia-security-management&ft:locale=en-US)**
...
-   **[Configure users and groups in Security Exposure Management Workspace](https://www.servicenow.com/docs/access?context=sem-configure-users-groups-overview&version=australia&pubname=australia-security-management&ft:locale=en-US)**
...
-   **[Security tag groups and tags for organized security content](https://www.servicenow.com/docs/access?context=sem-create-class-group-and-tags&version=australia&pubname=australia-security-management&ft:locale=en-US)**
...
-   **[Watchdog configuration](https://www.servicenow.com/docs/access?context=sem-watchdog-configure&version=australia&pubname=australia-security-management&ft:locale=en-US)**
...
-   **[Severity mapping for third-party integrations](https://www.servicenow.com/docs/access?context=sem-configure-severity-map&version=australia&pubname=australia-security-management&ft:locale=en-US)**
...
-   **[Background job configuration](https://www.servicenow.com/docs/access?context=vr-background-framework&version=australia&pubname=australia-security-management&ft:locale=en-US)**
...
-   **[Advanced settings](https://www.servicenow.com/docs/access?context=sem-advanced-settings&version=australia&pubname=australia-security-management&ft:locale=en-US)**
...
-   **[Bulk approval and rejection](https://www.servicenow.com/docs/access?context=sem-approve-ex-rule-request&version=australia&pubname=australia-security-management&ft:locale=en-US)**
...
-   **[New KPI tiles for exception management](https://www.servicenow.com/docs/access?context=sem-unified-approval-rules-explore&version=australia&pubname=australia-security-management&ft:locale=en-US)**
...
-   **[GitHub Application Vulnerability Integration – Generic secrets support](https://www.servicenow.com/docs/access?context=github-vuln-integration&version=australia&pubname=australia-security-management&ft:locale=en-US)**
