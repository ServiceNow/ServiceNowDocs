...
description: The ServiceNow Care Team Operations for Environmental Services application contains case types to report and fulfill facilities issues as part of Healthcare Operations. Care Team Operations for Environmental Services is a new application in the Zurich release.
locale: en-US
release: zurich
...
# Care Team Operations for Environmental Services release notes
...
## Care Team Operations for Environmental Services highlights for the Zurich release
...
See [Care Team Operations for Environmental Services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/healthcare-life-sciences/cto-evs-landing.md) for more information.
...
## Care Team Operations for Environmental Services features
...
-   **[Healthcare Operations Core](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/healthcare-life-sciences/hcls-cto-app.md)**
    ...
    ServiceNow® Healthcare Operations Core provides the foundation to enable hospitals to streamline and automate their operations by integrating with supporting service departments. It provides the Care Team Portal functionality for use with Care Team Operations for Environmental Services.
...
-   **[Care Team Operations for Biomed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/healthcare-life-sciences/care-team-operations-for-biomed.md)**
    ...
    ServiceNow® Care Team Operations for Biomed contains the case types to report and fulfill healthcare biomed issues and utilizes the Healthcare Operations Core data model from the Healthcare Operations Core application.
