...
-   **[Additional fields in the OT Subnet Mapping table](https://www.servicenow.com/docs/access?context=create-a-new-ot-subnet-mapping-record&version=australia&pubname=australia-operational-technology&ft:locale=en-US)**
    ...
    -   Managed Network
    -   VLAN ID
-   **[OT Discovered Subnets table](https://www.servicenow.com/docs/access?context=automate-mappings-between-ot-assets-and-equipment-model-entity&version=australia&pubname=australia-operational-technology&ft:locale=en-US)**
...
-   **[Discovered Subnet value added to the OT Subnet Mapping table](https://www.servicenow.com/docs/access?context=create-a-new-ot-subnet-mapping-record&version=australia&pubname=australia-operational-technology&ft:locale=en-US)**
...
-   **[Updated OT device mapping to equipment model entities in the Industrial Workspace](https://www.servicenow.com/docs/access?context=map-ot-devices-in-iw&version=australia&pubname=australia-operational-technology&ft:locale=en-US)**
...
-   **[Location Validation Map tab](https://www.servicenow.com/docs/access?context=create-location-hierarchy-isa&version=australia&pubname=australia-operational-technology&ft:locale=en-US)**
...
-   **[Operational Technology Manager](https://www.servicenow.com/docs/access?context=operational-technology-manager&version=australia&pubname=australia-operational-technology&ft:locale=en-US)**
