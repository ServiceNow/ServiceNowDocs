...
-   **[Now Assist for Enterprise Architecture \(EA\) release notes](../enterprise-architecture/now-assist-for-ea-rn.md)**  
...
-   **[Now Assist for Sales and Order Management for Telecommunications \(SOMT\) release notes](../tmt/now-assist-sales-order-management-telecommunications-rn.md)**  
