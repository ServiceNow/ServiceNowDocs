...
description: The ServiceNow ServiceNow Otto for Manufacturing Commercial Operations \(MCO\) application brings platform AI capabilities to Manufacturing Commercial Operations. ServiceNow Otto for MCO is a new application in the Zurich release.
locale: en-US
release: zurich
...
## ServiceNow Otto for MCO highlights for the Zurich release
...
See [Now Assist for Manufacturing Commercial Operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/manufacturing/now-assist-for-MCO.md) for more information.
