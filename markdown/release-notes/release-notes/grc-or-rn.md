...
-   **Export action updated to include Microsoft Excel and JSON formats**
...
-   **Fields added to the Create new Excel download/upload request form**
...
For more information, see Install Operational Resilience application.
