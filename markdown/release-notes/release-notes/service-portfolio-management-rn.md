...
-   ****
    ...
    Add ServiceNow® Digital Portfolio Management \(DPM\) from the ServiceNow Store to view all your Service Portfolio Management data in one centralized place. If you transition to the standard service portfolio structure as described in , then you can use key performance indicator \(KPI\) groups in DPM to report on services, nodes, and portfolio performance.
