...
description: ServiceNow Third-party Risk Management application upgrade information for the Zurich release.
locale: en-US
release: zurich
...
**Note:** For more information on these plugins, see [Configuring Smart Assessment Engine](https://www.servicenow.com/docs/access?context=smart-assessment-engine-cf-config&version=zurich&pubname=zurich-governance-risk-compliance&ft:locale=en-US) and [Smart assessment configuration](https://www.servicenow.com/docs/access?context=tprm-sae-assessment-config&version=zurich&pubname=zurich-governance-risk-compliance&ft:locale=en-US).
...
For more information, see [Migrate a template to an SAE template](https://www.servicenow.com/docs/access?context=tprm-asmnt-tmplt-migrate-metrics-to&version=zurich&pubname=zurich-governance-risk-compliance&ft:locale=en-US), [Create a TPRM SAE questionnaire or document request template](https://www.servicenow.com/docs/access?context=create-sae-q-template&version=zurich&pubname=zurich-governance-risk-compliance&ft:locale=en-US), [Create an external assessment template](https://www.servicenow.com/docs/access?context=create-vendor-risk-assess-temp&version=zurich&pubname=zurich-governance-risk-compliance&ft:locale=en-US), and [Create an issue generation rule](https://www.servicenow.com/docs/access?context=tprm-generate-issue-rule&version=zurich&pubname=zurich-governance-risk-compliance&ft:locale=en-US).
