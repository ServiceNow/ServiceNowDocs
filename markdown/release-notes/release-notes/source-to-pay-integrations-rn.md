...
description: The ServiceNow Source-to-Pay Operations extends its capabilities by integrating with third-party applications. The Source-to-Pay Operations integration with SAP, Oracle EBS, Coupa, and SAP Ariba are new applications in the Zurich release.
locale: en-US
release: zurich
...
## Source-to-Pay Operations Integrations highlights for the Zurich release
...
## Important upgrade information for Source-to-Pay Operations Integrations
...
## Source-to-Pay Operations Integration features
...
-   **[Integrate Sourcing and Procurement Operations with other applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/source-to-pay-operations/integrating-spo.md)**
...
-   **[Integrate Supplier Lifecycle Operations with other applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/source-to-pay-operations/integrate-slo.md)**

    Extend the capabilities of Supplier Lifecycle Operations by integrating with other applications.

-   **[Integrate APO with other applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/source-to-pay-operations/integrate-apo.md)**
