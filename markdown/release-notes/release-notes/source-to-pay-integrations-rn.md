...
-   **[Integrate Sourcing and Procurement Operations with other applications](https://www.servicenow.com/docs/access?context=integrating-spo&version=australia&pubname=australia-source-to-pay-operations&ft:locale=en-US)**
...
-   **[Integrate Supplier Lifecycle Operations with other applications](https://www.servicenow.com/docs/access?context=integrate-slo&version=australia&pubname=australia-source-to-pay-operations&ft:locale=en-US)**

    Extend the capabilities of Supplier Lifecycle Operations by integrating with other applications.

-   **[Integrate APO with other applications](https://www.servicenow.com/docs/access?context=integrate-apo&version=australia&pubname=australia-source-to-pay-operations&ft:locale=en-US)**
