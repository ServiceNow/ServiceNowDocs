...
To use playbook generation features in Workflow Studio, download the Now Assist for Creator application. To use Agentic Playbooks, enable it through Now Assist.
