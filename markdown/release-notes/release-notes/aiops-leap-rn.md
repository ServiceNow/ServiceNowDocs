...
description: The ServiceNow AIOps LEAP application uses AI driven insights to create standard and dynamic playbooks for quick incident resolution management. AIOps LEAP is a new application in the Yokohama release.
locale: en-US
release: yokohama
...
## AIOps LEAP highlights for the Yokohama release
...
-   **[Pin automation opportunities](https://www.servicenow.com/docs/access?context=aiops-leap-features&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US)**

    You can pin the automation opportunities required for ease of access and research.

-   **[Automation feedback and tracking](https://www.servicenow.com/docs/access?context=aiops-leap-features&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US)**
...
-   **[Filters for automation opportunities and playbooks](https://www.servicenow.com/docs/access?context=aiops-leap-features&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US)**
