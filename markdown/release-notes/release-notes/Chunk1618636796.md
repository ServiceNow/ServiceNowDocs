...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/now-assist-ai-agents-rn.html
release: zurich
topic_type: topic
...
-   Support the latest MCP version from [Zurich Patch 3]().
...
-   The support for manually integrating external agents has been deprecated from [Zurich Patch 8]() release.
