...
The ServiceNow® Manufacturing Commercial Operations application enables manufacturers, agents, and Dealers \(internal and channel partners\) to connect and track services and manage recall and sales promotion campaigns. Manufacturing Commercial Operations is a new application in the Zurich release.

## Manufacturing Commercial Operations highlights for the Zurich release
...
See [Explore Manufacturing Commercial Operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/manufacturing/manufacturing-explore.md) for more information.
...
-   **[Order management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/order-management/explore-order-management.md).**
    ...
    -   [Product Catalog Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/order-management/product-catalog-managment.md) enables you to create and manage product catalogs for commercial and technical product offerings.
    -   [Order management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/order-management/explore-order-management.md) enables you to capture and fulfill product and service orders to create a seamless ordering experience for your customers.
    -   [Pricing Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/order-management/pricing-management.md) enables you to set the pricing for your products.
