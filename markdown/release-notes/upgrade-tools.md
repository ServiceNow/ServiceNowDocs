...
-   **[Automated Test Framework](https://www.servicenow.com/docs/access?context=automated-test-framework&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)**
    ...
    **Note:** By default, the system property to run automated tests is disabled to prevent you from accidentally running them on a production system. Run tests only on development, test, and other non-production instances to avoid data corruption and outage.
    ...
    ![Automated Test Framework test steps](../image/atf-executionorder.png)

-   **[Upgrade Center](https://www.servicenow.com/docs/access?context=uc-landing-page&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US)**
