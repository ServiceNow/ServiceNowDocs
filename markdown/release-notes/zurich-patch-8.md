...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/release-notes/zurich-patch-8.html
release: zurich
...
Zurich Patch 8 includes 325 problem fixes in various categories. The chart below shows the top 10 problem categories included in this patch.

\[Omitted image "prb-chart-zp8.png"\] Alt text: Fixed issues grouped by problem categories bar chart
...
-   **[SQL API Release Notes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/release-notes/sql-api-rn.md)**
...
-   **[Getting started with ServiceNow SQL API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/getting-started-with-servicenow-sql-api.md)**
...
-   **[SQL API architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/sql-api-architecture.md)**
...
-   **[Configuring SQL API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/configuring-sql-api.md)**
...
-   **[Create a Service Account and assign Roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/create-service-account.md)**
...
-   **[Create Access Control Lists \(ACLs\) for SQL API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/create-acls-sql-api.md)**
...
-   **[Download the SQL API drivers on client machine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/download-sql-api-drivers.md)**

    Download the ODBC and JDBC drivers from the ServiceNow store to your client machine to enable SQL API connectivity.

-   **[Install ServiceNow SQL API ODBC driver on client machine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/install-odbc-driver.md)**
...
-   **[Configure ServiceNow SQL API ODBC driver on client machine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/configure-odbc-driver.md)**
...
-   **[Test SQL API ODBC driver connection using Interactive SQL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/test-sql-api-odbc-driver-connection-using-interactive-sql.md)**
...
-   **[Configure ServiceNow SQL API JDBC driver on client machine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/configure-jdbc-driver.md)**
...
-   **[Route SQL API calls to Read Replica](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/routing-sql-api-calls-to-read-replica.md)**

    You can route SQL API calls to Read Replica to optimize the performance of your ServiceNow instance.

-   **[Common use cases for SQL API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/common-use-cases-for-sql-api.md)**

    The SQL API supports business intelligence reporting, ad-hoc data analysis, and custom report development.

-   **[Integrate SQL API Drivers with third-party BI tools](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/configure-drivers-bi-tools.md)**
...
-   **[SQL API reference information](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/troubleshooting.md)**
...
-   **[Minimum requirements and supported software for SQL API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/minimum-requirements-and-supported-softwares.md)**
...
-   **[Usage Limitations for SQL API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/web-services/usage-limitations.md)**
...
MariaDB Glide instant alter statements are stuck in 'wait for metadata lock' that can cause database lock and semaphore exhaustion
...
1.  Have a 2-hour long query running on the task table.
2.  Try to create an index on the task table via the UI.
3.  Try to do any query on the task table 4. Notice that query is stuck and state is "Waiting for table metadata lock".
4.  Repeat step \#3 until database connections are exhausted or some other systemic bottleneck occurs.

 The lock will release after 2 minutes but will wait for a little while and then try again, creating another potential 2-minute impact.
...
Record conversation states with trace all over the place

</td><td>

Cleanup info, debug, and trace levels.
...
Refreshing the page is creating a new conversation

</td><td>

Earlier, on a Now Assit Portal chat, most of the Virtual Agent topics and agent tools that accept file uploads are designed to use the standard pattern: extract media\_id from vaInputs.file\_picker \(media URL\) → query sys\_cs\_media by media\_id → get sys\_attachment\_id → read file. Without sys\_cs\_media, this lookup fails and the file is inaccessible.
...
Add CSV and TXT formats for DocQNA off-Glide
...
Associate a trace ID to sys\_cs\_message for easier debuggability
...
1.  Perform a search on the Next Wave UI.
2.  Navigate to sys\_cs\_message.
3.  Fetch the inbound record for the query performed in step 1.

 Expected behavior: There should be a **payload** field that contains the trace\_id.

 Actual behavior: There is no field to get the trace\_id from.
...
-   [Zurich Patch 4 Hotfix 4b](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/release-notes/zurich-patch-4-hf-4b-PO.md)
