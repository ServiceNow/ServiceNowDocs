...
-   **Improved user experience for adding hyperlinks in Docs**
...
-   **Redirection to the specific doc pages from notification emails**
...
The new Impact Store Application provides a more efficient, streamlined way for you to work. For information about how to upgrade, see . Note that  is still supported in this release.
...
The following Accelerators are renamed:
    ...
    -   Jumpstart Your Now Assist for ITSM is now 
    -   Jumpstart Your Now Assist for CSM is now 
-   ****
...
-   **Turn off Zero Trust Access banners in mobile app screens**
...
-   **OT Excel SGC - Import Task list module in the Industrial Workspace**
...
-   **OT Excel SGC - Remediation Task list module in the Industrial Workspace**
...
-   **Is Virtual field for OT devices**
...
-   **OT Subnet Mappings related list**
...
-   **__Manufacturer__ and __Model Number__ fields**
...
Simplified the setup of Microsoft Teams Chat integration with Major Security Incident Management Workspace. For more information, see .
...
Simplified the setup of Microsoft SharePoint integration with Major Security Incident Management Workspace. For more information, see .
...
Workflow was migrated to Workflow Studio. For more information, see the following:-   
-   
-   
-   
-   
...
Workflow was migrated to Workflow Studio in the section .
