...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/review-draft-emails.html
release: xanadu
topic_type: task
...
3.  **Note:** Instead of a button to save email drafts manually, drafts save automatically.
    ...
    View your drafts by selecting the more options icon \(\[Omitted image "x-more-actions-icon.png"\] Alt text: More actions icon\).
...
5.  Delete multiple drafts within the Manage drafts modal.
