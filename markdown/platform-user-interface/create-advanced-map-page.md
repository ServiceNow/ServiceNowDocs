...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/create-advanced-map-page.html
release: zurich
topic_type: task
...
-   **[Configure map data items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-map-data-items.md)**  
Add map data items to render data on your Map Page using the Classic Environment.
-   **[Create a map marker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-map-markers.md)**  
...
-   **[Add a map filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/set-up-map-filters.md)**  
