...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/tb-edit-components.html
release: australia
topic_type: task
