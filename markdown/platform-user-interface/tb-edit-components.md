...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/tb-edit-components.html
release: xanadu
topic_type: task
