...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/next-experience-start-option.html
release: yokohama
topic_type: concept
