...
1.  Activate the Dynamic Translation \(com.glide.dynamic\_translation\) plugin. For more information see [Activate Dynamic Translation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/activate-dynamic-translation.md).
2.  Configure Dynamic Translation for the translation service provider. For more information, see [Integration with other translation services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/integration-with-other-translation-services.md).
