...
1.  Activate the Dynamic Translation \(com.glide.dynamic\_translation\) plugin. For more information see [Activate Dynamic Translation](https://www.servicenow.com/docs/access?context=activate-dynamic-translation&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
2.  Configure Dynamic Translation for the translation service provider. For more information, see [Integration with other translation services](https://www.servicenow.com/docs/access?context=integration-with-other-translation-services&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
