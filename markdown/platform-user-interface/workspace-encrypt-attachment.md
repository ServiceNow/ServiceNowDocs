...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/workspace-encrypt-attachment.html
release: zurich
topic_type: task
...
For more information on encryption, see [Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/encryption.md).
