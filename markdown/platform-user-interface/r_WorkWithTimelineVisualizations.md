...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/r\_WorkWithTimelineVisualizations.html
release: brazil
...
|Option|Description|
|------|-----------|
|Dragging|Hold down the left mouse button and drag the [slider track](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_UseTheSliderAndSliderTrack.md) right or left to view other months.|
...
|Option|Description|
|------|-----------|
|Dragging|Hold down the left mouse button and drag the slider along the [slider track](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_UseTheSliderAndSliderTrack.md) to move the timeline forward or backward.|
|Mouse wheel button|Scroll the wheel to move the timeline forward or backward.|
...
**Parent Topic:**[Use Timeline Visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_UseTimelineVisualizations.md)
