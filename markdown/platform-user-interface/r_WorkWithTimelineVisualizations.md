---
title: Work with timeline visualizations
description: There are various tools that allow you to move visualizations backward and forward in time depending on whether you are in 2D or 3D view.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/r\_WorkWithTimelineVisualizations.html
release: yokohama
...
|Option|Description|
|------|-----------|
|Dragging|Hold down the left mouse button and drag the [slider track](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/c_UseTheSliderAndSliderTrack.md) right or left to view other months.|
...
|Option|Description|
|------|-----------|
|Dragging|Hold down the left mouse button and drag the slider along the [slider track](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/c_UseTheSliderAndSliderTrack.md) to move the timeline forward or backward.|
|Mouse wheel button|Scroll the wheel to move the timeline forward or backward.|
|Up and down arrow keys|Press the arrow keys to move the timeline forward or backward.|
|Shift key|Press the shift key and click the panel for a single record to open the complete record that contains additional information.|

**Parent Topic:**[Use Timeline Visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/c_UseTimelineVisualizations.md)
