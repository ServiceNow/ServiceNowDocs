...
**Important:** Configurable Workspace pages must use the latest layout system for reflow to be available. For more information, see [Upgrading layouts in UI Builder](https://www.servicenow.com/docs/access?context=upgrade-layout-uib&version=australia&pubname=australia-application-development&ft:locale=en-US)
