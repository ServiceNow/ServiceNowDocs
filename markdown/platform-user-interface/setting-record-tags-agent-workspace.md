...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/setting-record-tags-agent-workspace.html
release: zurich
topic_type: task
...
After tagging records, you can use the tags to search for records in the [global search field](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/search-workspace.md) or using the filter icon \(\[Omitted image "filter-outline.png"\] Alt text: Filter icon\) in List view.
...
<table id="choicetable_n2j_xn4_c3b"><tbody><tr><td id="d55840e182">
...
7.  Search for your tag using the [global search field](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/search-workspace.md).
