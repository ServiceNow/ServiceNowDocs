...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/use-script-field-types-in-your-configurable-workspace.html
release: zurich
topic_type: task
...
2.  Show script fields in forms with a code editor component.
    ...
    1.  Add a system property named **glide.ui.workspace.script.code\_editor.enable**.
        ...
        For more information on adding system property, see [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_AddAPropertyUsingSysPropsList.md).
