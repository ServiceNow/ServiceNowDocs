...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/t\_SavingFilters.html
release: xanadu
topic_type: task
...
1.  Navigate to a list and create or modify a filter as described in [Create a filter in List](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/t_CreatingFilters.md).
...
<table id="choicetable_v1q_3x2_pv"><tbody><tr><td id="d50713e109">
