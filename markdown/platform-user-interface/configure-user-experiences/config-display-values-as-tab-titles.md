...
description: Display field values, such as contact or consumer names, as titles on interaction record tabs in Configurable Workspace.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/config-display-values-as-tab-titles.html
release: yokohama
...
Display field values, such as contact or consumer names, as titles on interaction record tabs in Configurable Workspace.
...
**Note:** This task applies to Configurable Workspace.
...
1.  Navigate to **All** &gt; **Now Experience Framework** &gt; **Experiences** &gt; **Base agent workspace**.
