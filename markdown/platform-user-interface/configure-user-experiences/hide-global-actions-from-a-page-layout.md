...
description: Configure global form actions to be hidden from a page or experience by using action layouts.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/hide-global-actions-from-a-page-layout.html
release: xanadu
...
Configure global form actions to be hidden from a page or experience by using action layouts.
