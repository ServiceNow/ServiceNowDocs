...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/c\_UserPresence.html
release: yokohama
...
\[Omitted image "UserPresenceChatActivity.png"\] Alt text: Connect window highlighting the fact that you can see when another user is typing.

An administrator can disable user presence globally.

-   **[Disable user presence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/t_DisableUserPresence.md)**  
You can disable user presence globally by enabling a system property.
-   **[Disable live form features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/configure-live-form-feat.md)**  
...
-   **[Configure time intervals for user presence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/configure-time-interval-user-presence.md)**  
