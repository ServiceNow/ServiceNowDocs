---
title: Responding to issues in an open record in Workspace
description: Use the following sections to discover answers to the issues you're dealing with in an open record.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/finding-answers.html
release: yokohama
...
\[Omitted image "agent-workflow-whole-2.png"\] Alt text: Agent workflow
...
\[Omitted image "record-view-4.jpg"\] Alt text: Record view
...
Now that you understand how to look through the parts of workspace to get contextual information about an issue, let's see how to [find a solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/agent-assist.md).
