...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/use-email-templates-in-the-compose-email-page.html
release: yokohama
...
3.  Apply an email template from the Agent Assist panel.
    ...
    3.  Select the More actions icon \(\[Omitted image "menu-icon.png"\] Alt text: Menu icon\), and select **Apply Template**.
