...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/working-on-callback-records-in-your-workspace.html
release: yokohama
