...
description: Get familiar with your ServiceNow workspace.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/working-in-your-workspace.html
release: yokohama
...
-   **Single-pane view**
    ...
    \[Omitted image "Record-view-complete.png"\] Alt text: Workspace single pane.

-   **Integrated communication channels**

    Agents can communicate in real time with customers by Agent Chat or phone in the same interface.

    \[Omitted image "live-agent-chat.png"\] Alt text: Workspace chat and phone.

-   **Integrated email client**

    Agents can read and respond to emails side by side.

    \[Omitted image "activity-stream-email-client.png"\] Alt text: Workspace Activity Stream email client.

-   **Agent assistance**

    Agents can close cases and incidents faster with artificial-intelligence-assisted recommendations.

    \[Omitted image "AA-knowledge-article.png"\] Alt text: Workspace Agent assist.

-   **Playbook**

    Agents can accomplish business process workflows in a simple, task-oriented view.

    \[Omitted image "playbook-service-management.png"\] Alt text: Workspace Playbook workflow.
