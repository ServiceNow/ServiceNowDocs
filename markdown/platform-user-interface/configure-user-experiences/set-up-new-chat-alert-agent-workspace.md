...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/set-up-new-chat-alert-agent-workspace.html
release: xanadu
...
6.  To receive browser notifications, you must have this set-up:
    ...
    For additional information, see [Setting up Agent Chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/conversational-interfaces/agent-chat/ac-configure-agent-chat.md).
