...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/create-a-new-uxf-client-action-for-forms.html
release: xanadu
...
4.  Select an existing payload definition.
    ...
    For instructions on setting up a new payload definition, see [Configure action button to open a custom modal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-user-experiences/configuring-an-action-button-to-open-a-custom-modal.md).
