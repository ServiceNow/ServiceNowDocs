...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/configure-activity-stream-general.html
release: yokohama
...
\[Omitted image "activity-stream-washington.png"\] Alt text: Activity stream
