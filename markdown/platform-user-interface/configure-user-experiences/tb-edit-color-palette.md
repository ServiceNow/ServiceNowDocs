...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/tb-edit-color-palette.html
release: yokohama
...
2.  From the Home page view, select the Manager page view to see [the themes you have previously defined](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/tb-create-theme.md).
...
6.  On this screen, you can perform the following actions if needed:
    ...
    -   Select any of the three brand colors defined in this palette and change them from the color picker.
        ...
        **Note:** For dark palettes, only the primary color can be edited. If you want to customize further, see [Edit components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/tb-edit-components.md).


## Result

The alternate color palette has been added to your core theme. The theme name now appears as a theme group with the palette recorded under the Color palette drop-down list within the Manager page.\[Omitted image "tb-color-palette-list.png"\] Alt text: Color palette drop-down list.
...
**Parent Topic:**[Manage or edit a theme with Theme Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/tb-edit-theme.md)
