...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/live-agent-overview.html
release: xanadu
...
Display buttons for available actions: -   [Quick actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/conversational-interfaces/agent-chat/ci-agent-chat-using.md) \[Omitted image "quick-action-icon.png"\] Alt text: Quick action icon - select to display the quick action menu.
