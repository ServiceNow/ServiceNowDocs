...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/t\_SavingFilters.html
release: xanadu
...
1.  Navigate to a list and create or modify a filter as described in [Create a filter in List](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-user-experiences/t_CreatingFilters.md).
...
<table id="choicetable_v1q_3x2_pv"><tbody><tr><td id="d51242e109">
