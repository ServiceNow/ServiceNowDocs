...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/activity-stream-compose-configurable-workspace.html
release: xanadu
