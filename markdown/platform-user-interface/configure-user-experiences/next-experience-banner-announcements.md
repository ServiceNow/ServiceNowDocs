...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/next-experience-banner-announcements.html
release: yokohama
...
6.  In the Announcement Config field, select the Lookup using list icon \[Omitted image "QueryIcon.png"\] Alt text: The Lookup using list icon..
