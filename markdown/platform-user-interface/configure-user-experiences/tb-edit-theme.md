...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/tb-edit-theme.html
release: xanadu
...
2.  From the Home page view, select Manager page view to see all available themes.
    ...
    **Note:** In both the Grid and List views, your published and unpublished themes are grouped separately. The published themes are themes that appear in the user's theme preference. View your web and mobile themes by selecting either the **Web** or **Mobile** button.
    ...
    The More actions \(\[Omitted image "tb-more-actions.png"\] Alt text: More actions icon.\) icons for the unpublished themes contains the following options:
...
4.  Review and update the Global styles, as needed.
    ...
    **Note:** The following style records are generated with your theme:
    ...
    1.  To change the auto-generated UI colors for more in-depth editing, select the Color palette \(\[Omitted image "tb-color-palette-icon.png"\] Alt text: Color palette icon.\) icon from the Global styles color panel. Use the drop-down list next to each UI element to access the color options.
...
5.  To preview your theme before publishing it to your instance, select the **Experience preview** tab.
    ...
    **Note:** Select the Open in new tab \(\[Omitted image "tb-icon-open-new-tab.png"\] Alt text: Open in new tab.\) icon to open the experience in a new tab. You can see how your unpublished theme interacts with your selected experience.
...
6.  Publish your theme.
    ...
    For more information, see [Publish your themes with Theme Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-user-experiences/tb-apply-theme.md).


-   **[Core styles, colors, variants, and alternate color palettes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-user-experiences/difference-themes-variants.md)**  
...
-   **[Add an alternate color palette](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-user-experiences/tb-edit-color-palette.md)**  
Customize a Theme Builder theme by creating an alternate color palette for the theme and publishing it to your instance.
-   **[Preview components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-user-experiences/tb-preview-components.md)**  
As you’re creating or managing your theme, you can preview the components available for inclusion on your instance.
-   **[Edit components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-user-experiences/tb-edit-components.md)**  
...
**Parent Topic:**[Configuring Next Experience with Theme Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-user-experiences/configuring-next-experience-with-theme-builder.md)
