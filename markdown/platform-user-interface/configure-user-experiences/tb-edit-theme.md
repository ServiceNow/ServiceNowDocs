...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/configure-user-experiences/tb-edit-theme.html
release: australia
...
<table id="choicetable_v1x_lnb_qfc"><thead><tr><th align="left" id="d40524e240">

Page

</th><th align="left" id="d40524e243">

Option

</th></tr></thead><tbody><tr><td id="d40524e249">
...
4.  Review and update the Global styles, as needed.
    ...
    **Note:** The following style records are generated with your theme:
    ...
    -   **Your brand palette**: Update the interface colors for your brand. For more information, see [Edit your theme colors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/edit-theme-colors.md).
    -   **Logo**: Update the logo. You can upload the logo during the theme application from the Overview page. For more information, see [Upload a new logo to your Theme Builder theme](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/tb-upload-logo.md).
    ...
    -   **Shape**: Update the corner shapes of on-screen components. For more information, see [Edit corner shapes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/edit-corner-shapes.md).
...
6.  Publish your theme.
    ...
    For more information, see [Publish your themes with Theme Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/tb-apply-theme.md).


-   **[Core styles, colors, variants, and alternate color palettes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/difference-themes-variants.md)**  
...
-   **[Add an alternate color palette](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/tb-edit-color-palette.md)**  
Customize a Theme Builder theme by creating an alternate color palette for the theme and publishing it to your instance.
-   **[Working with Global styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/working-with-global-styles.md)**  
...
-   **[Working with Component styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/working-with-component-styles.md)**  
...
-   **[Working with Image styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/working-with-image-styles.md)**  
...
**Parent Topic:**[Configuring Next Experience with Theme Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/configuring-next-experience-with-theme-builder.md)
