...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/ui16-navigator-tasks.html
release: xanadu
...
**Parent Topic:**[Core UI application navigator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-user-experiences/c_UI16ApplicationNavigator.md)
...
<table id="choicetable_ah3_rs3_ks"><tbody><tr><td id="d87115e149">
...
<table id="choicetable_wqh_2yx_pt"><tbody><tr><td id="d87115e295">
...
<table id="choicetable_zxc_mcg_qs"><tbody><tr><td id="d87115e497">
