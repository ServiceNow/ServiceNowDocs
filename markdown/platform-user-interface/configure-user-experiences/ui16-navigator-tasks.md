...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/ui16-navigator-tasks.html
release: yokohama
...
**Parent Topic:**[Core UI application navigator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/c_UI16ApplicationNavigator.md)
...
<table id="choicetable_ah3_rs3_ks"><tbody><tr><td id="d111815e149">
...
<table id="choicetable_wqh_2yx_pt"><tbody><tr><td id="d111815e295">
...
<table id="choicetable_zxc_mcg_qs"><tbody><tr><td id="d111815e497">
