...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/workspace-tutorial-for-agents.html
release: xanadu
...
\[Omitted image "aw-agent-overview.gif"\] Alt text: Agent overview.

## Procedure

1.  Open your workspace by selecting your Workspace from the Workspace menu.

    \[Omitted image "open-workspace.png"\] Alt text: Open workspace.
...
3.  Log in to your workspace.
    ...
    \[Omitted image "landing-page.png"\] Alt text: Open workspace.
...
4.  View P1 incidents that haven't been solved by clicking **Open P1 Incidents** on the landing page.
    ...
    \[Omitted image "open-incidents-22.png"\] Alt text: Open P1 incidents.
