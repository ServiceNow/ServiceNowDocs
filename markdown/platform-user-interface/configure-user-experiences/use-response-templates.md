...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/use-response-templates.html
release: xanadu
...
2.  Open the Compose Email page by selecting the menu icon \(\[Omitted image "x-more-actions-icon.png"\] Alt text: More actions icon\) and **Compose Email**.
...
3.  Apply a response template from the Agent Assist panel.
    ...
    4.  Paste the response template into your email.
...
4.  Apply a response template from the email footer.
    ...
    3.  Select a response template from the list.
