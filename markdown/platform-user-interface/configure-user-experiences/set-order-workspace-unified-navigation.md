...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/set-order-workspace-unified-navigation.html
release: yokohama
...
2.  Select the Preview record icon \[Omitted image "next-exp-preview-record.png"\] Alt text: Preview record. for the workspace that you want to order.
