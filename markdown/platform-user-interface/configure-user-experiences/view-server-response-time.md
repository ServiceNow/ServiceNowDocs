...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/view-server-response-time.html
release: yokohama
...
breadcrumb: [Measuring the performance of your instance in Next Experience, Configuring the Next Experience UI, Next Experience UI, Configure UIs and portals, Configure user experiences]
---
...
7.  From the transaction table, select the personalize list icon \( \[Omitted image "PersonalizeListIcon.png"\] Alt text: Personalize list icon.\), within the banner frame.
...
**Parent Topic:**[Measuring the performance of your instance in Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/measuring-performance-next-experience.md)
