...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/domain-selection.html
release: yokohama
...
For more information on Cross-Tenant Intelligence in Domain Separation, see [What is Domain Separation?](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/servicenow-ai-platform-security/bp-what-is-domain-separation.md).
