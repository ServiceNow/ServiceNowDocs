...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/domain-selection.html
release: xanadu
...
For more information on Cross-Tenant Intelligence in Domain Separation, see [What is Domain Separation?](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/servicenow-ai-platform-security/bp-what-is-domain-separation.md).
