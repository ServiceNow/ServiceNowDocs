...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/configurable-workspace-glossary.html
release: yokohama
...
keywords: [dashboard]
breadcrumb: [Configurable Workspace reference, Configurable Workspace UI, Configure UIs and portals, Configure user experiences]
---
...
A user with the admin \(administrator\) role in ServiceNow has permission to perform almost all functions. The term "admin" usually includes both the global admin and the admin for a given application. For example, both the admin and catalog\_admin roles have rights to administer the service catalog.
...
A group of records from a single table at the bottom of a form that are related to the record on the form.
