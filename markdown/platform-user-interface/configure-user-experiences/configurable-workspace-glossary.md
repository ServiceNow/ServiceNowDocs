...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-user-experiences/configurable-workspace-glossary.html
release: zurich
...
To learn more about the workspace, see .
