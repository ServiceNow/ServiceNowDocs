...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/compose-emails-with-email-templates.html
release: yokohama
...
5.  Select an email template from the list.
