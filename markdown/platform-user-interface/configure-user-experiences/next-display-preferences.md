...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/next-display-preferences.html
release: xanadu
...
1.  Navigate to\[Omitted image "pol-user-menu.png"\] Alt text: User menu. **User Menu** &gt; **Preferences** &gt; **Display**.
