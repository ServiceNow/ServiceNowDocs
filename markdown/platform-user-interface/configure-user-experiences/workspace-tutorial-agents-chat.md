...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/workspace-tutorial-agents-chat.html
release: yokohama
...
4.  Click the inbox icon \(\[Omitted image "inbox-outline.png"\] Alt text: Inbox icon\) and set your status to **Available**.
    ...
    \[Omitted image "available.png"\] Alt text: Status is available
