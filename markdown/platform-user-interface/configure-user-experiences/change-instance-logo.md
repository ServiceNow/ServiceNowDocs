...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/change-instance-logo.html
release: yokohama
...
3.  Click **Choose file** and select the file, and then click **OK**.
