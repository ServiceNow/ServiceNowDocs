---
title: Configure automatic resizing for fields
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-user-experiences/expand-text-shown-in-fields-before-scrolling.html
release: xanadu
...
2.  Select **Name** for the search value, and enter `autoresize` into the search bar.
    ...
    \[Omitted image "autoresize-search.png"\] Alt text: Search for autoresize
...
|--------------------|--------|-------------|
|glide.ui.textarea.autoresize\_line\_limit|Determines the line number after which the scroll bar should appear for the textarea component in all textarea fields.|Enter a maximum value for textarea fields to automatically resize.|
|glide.ui.journal.use\_html|Converts all journal fields with a textarea subtype to HTML editor fields.|Set the Value field to **true**.|
...
|glide.activity.compose.textarea.autoresize\_line\_limit|Determines the line number after which the scroll bar should appear for the textarea component in all Activity stream textarea fields.|Enter a maximum value for textarea fields to automatically resize.|
