...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/add-email-templates-sidebar-icon-to-record-page.html
release: yokohama
