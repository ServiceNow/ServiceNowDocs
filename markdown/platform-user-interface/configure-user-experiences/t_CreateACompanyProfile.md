...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/t\_CreateACompanyProfile.html
release: yokohama
...
3.  Select the **Primary** check box to indicate if this company is the primary company.
    ...
    If needed, [configure the form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/configure-form-layout.md) to add the **Primary** check box. Designate only one company in your system as the primary company.
...
-   **[Banner logo link](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/c_CustomizeTheBannerLogoLink.md)**  
Properties are available to control the URL and target frame used when clicking the banner logo.
-   **[Customize the banner logo in Core UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/t_CustomizeTheLogoInSysProps.md)**  
...
-   **[Customize the favicon](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/customize-favicon.md)**  
Use the **glide.product.icon** property to change the icon that appears in bookmarks and the browser address bar.
-   **[Examples of how to modify the banner](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/c_ExamplesOfHowToModifyTheBanner.md)**  
There are various ways that you can modify the banner on your instances.
-   **[Modify the banner](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/c_ModifyTheBanner.md)**  
