...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/tb-apply-theme.html
release: yokohama
...
<table id="choicetable_ahh_ch2_fdc"><thead><tr><th align="left" id="d31531e116">

Option

</th><th align="left" id="d31531e119">

Description

</th></tr></thead><tbody><tr><td id="d31531e125">

**Publish using the List or Grid view More Actions menu**

</td><td>

From the Unpublished section, select the More actions \(\[Omitted image "tb-more-actions.png"\] Alt text: More actions.\) icon from the theme that you want published, and select **Publish**.

**Note:** A confirmation dialog box appears.\[Omitted image "tb-test-theme-dialog-box.png"\] Alt text: Publish the theme dialog box.

</td></tr><tr><td id="d31531e153">
...
6.  Select one theme as the default if you have published multiple themes to your web instance.
    ...
    For more information, see [Set the default theme](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/set-the-default-theme.md).
...
7.  Set the presentation order of your themes if you have published multiple themes to your web instance.
    ...
    **Note:** The presentation order determines how the themes appear in the user's Theme preference.
    ...
    For more information on setting order using the List view drag-and-drop feature, see [Set the presentation order of your Theme Builder themes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/set-presentation-order-themes.md).

    For information on setting order using the Next Experience, see [Publish multiple themes in Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/configure-presentation-order-of-themes.md).
...
-   **[Set the default theme](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/set-the-default-theme.md)**  
Set a preferred Theme Builder theme as the default for your web experiences when multiple themes are published.
-   **[Set the presentation order of your Theme Builder themes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/set-presentation-order-themes.md)**  
Set the order of your Theme Builder themes to configure how they’re displayed in the user's Theme preferences.
-   **[Upload a logo while publishing a theme with Theme Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-user-experiences/tb-upload-logo.md)**  
