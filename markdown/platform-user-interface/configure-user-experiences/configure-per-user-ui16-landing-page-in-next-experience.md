...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-user-experiences/configure-per-user-ui16-landing-page-in-next-experience.html
release: yokohama
...
4.  In the **User** field, select the Lookup using the list icon \(\[Omitted image "query-icon.png"\] Alt text: Lookup using list icon.\) and assign a user.
