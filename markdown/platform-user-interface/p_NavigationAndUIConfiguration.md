...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/p\_NavigationAndUIConfiguration.html
release: australia
topic_type: topic
...
-   **[Response time indicator icon](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_ResponseTimeIndicator.md)**  
A response time indicator icon may appear at the bottom right of forms and in the list view in the classic environment.
-   **[Navigation stack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_NavigationStack.md)**  
...
-   **[Navigation action cancellation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_CancelingNavigationActions.md)**  
...
-   **[Overview help pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/overview-help-pages.md)**  
...
-   **[System user guide](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_SystemUserGuide.md)**  
...
-   **[Manage audio files](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/t_UploadAnAudioFile.md)**  
You can upload and store `.mp3` or `.ogg` audio files. Once uploaded, you can reference audio files using HTML.
-   **[Storing images in the database](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_StoringImagesInTheDatabase.md)**  
...
-   **[Welcome pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_WelcomePageContent.md)**  
...
-   **[Enabling accessibility features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_SetUpSect508ComplianceFeature.md)**  
...
-   **[Using accessibility features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/keyboard-accessibility.md)**  
Accessibility features include keyboard navigation, color and style settings, using a screen reader, and search methods.
-   **[Map pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_MapPages.md)**  
Map pages display ServiceNow data graphically on a Google map page based on location data that you provide.
-   **[Customizing instance appearance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/customizing-instance-appearance.md)**  
...
-   **[Create a company profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/t_CreateACompanyProfile.md)**  
...
-   **[Add help to a field label on a form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/t_FieldLabelForm.md)**  
...
**Parent Topic:**[Working in Core UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/working-in-ui16-and-ui15.md)
