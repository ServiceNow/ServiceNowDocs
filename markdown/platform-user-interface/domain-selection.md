...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/domain-selection.html
release: yokohama
topic_type: concept
...
For more information on Cross-Tenant Intelligence in Domain Separation, see [What is Domain Separation?](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/bp-what-is-domain-separation.md).
