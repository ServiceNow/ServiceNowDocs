...
Opens a JavaScript debugger with a script tracer and a session log. For more information, see [Debugging scripts](https://www.servicenow.com/docs/access?context=script-debug-overview&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
...
Enables you to identify and inspect pages created in classic custom UI pages using the page inspector. For more information, see [Page Inspector](https://www.servicenow.com/docs/access?context=atf-page-inspector&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
