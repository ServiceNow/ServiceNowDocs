...
Indicates what action opens the list editor in List v2. This record updates automatically when the user personalizes any v2 list and changes the **Double click to edit** setting. For more information, see [List editor administration](https://www.servicenow.com/docs/access?context=r_AdministeringTheListEditor&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) . This preference does not apply to v3 lists. Single-click list editing is not supported in List v3.**True** = open the list editor when the user double-clicks a field in a v2 list.
...
**DO NOT MODIFY.** Shows who the administrator most recently impersonated. For more information, see [Impersonate a user](https://www.servicenow.com/docs/access?context=c_ImpersonateAUser&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).**Type**: **String**
...
Indicates whether forms that contain more than two sections use a tabbed interface or a scrolling list of sections. This setting applies to all forms. It's not set on a form-by-form basis. This record updates automatically when a user clicks the Toggle Tabs icon in the banner bar. For more information, see [Configure the form layout](https://www.servicenow.com/docs/access?context=configure-form-layout&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) .**True** = display multi-section forms as tabs.
...
Indicates whether users see a **Logout** button. If this is False, users are automatically logged out when their session times out. For more information, see Remove the logout button. This user preference does not apply to Core UI.**True** = show the **Logout** button, which enables manual logout.
