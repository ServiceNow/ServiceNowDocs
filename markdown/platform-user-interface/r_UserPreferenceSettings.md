...
Indicates what action opens the list editor in List v2. This record updates automatically when the user personalizes any v2 list and changes the **Double click to edit** setting. For more information, see [List editor administration](https://www.servicenow.com/docs/access?context=r_AdministeringTheListEditor&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) . This preference does not apply to v3 lists. Single-click list editing is not supported in List v3.**True** = open the list editor when the user double-clicks a field in a v2 list.
...
**DO NOT MODIFY.** Shows who the administrator most recently impersonated. For more information, see [Impersonate a user](https://www.servicenow.com/docs/access?context=c_ImpersonateAUser&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).**Type**: **String**
