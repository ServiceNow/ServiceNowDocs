...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-keyboard-shortcuts.html
release: yokohama
topic_type: task
