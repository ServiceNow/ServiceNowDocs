...
2.  From the Home page view, select the Manager page view to see [the themes you have created](tb-create-theme.md).
    ...
    **Important:** When you have selected the theme you want to work on, verify that you have selected the correct scope for the theme from the application scope picker.
    ...
    ![Manager page view with available published themes.](../image/tb-available-themes.png "Available published themes")
...
The alternate color palette is added to your primary theme. The theme name now appears as a theme group with the palette recorded under the Color palette drop-down list.![Color palette drop-down list.](../image/tb-color-palette-list.png)
