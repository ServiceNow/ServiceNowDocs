...
2.  From the Home page view, select the Manager page view to see [the themes you have previously defined](tb-create-theme.md).
    ...
    **Important:** When you have selected the theme you want to work on, verify that you have selected the correct scope for the theme from the application scope picker.
    ...
    ![Available themes.](../image/tb-available-themes.png "Available themes")
...
3.  Select the theme that you want to add an alternate color palette to.
    ...
    -   For published or unpublished themes without an alternate color palette defined, select the More actions \(![More actions icon.](../image/tb-more-actions.png)\) icon, and select **Add alternate color palette**.![Add an alternate color palette.](../image/tb-select-alt-color-pal.png)
...
5.  Select **Create color palette**.
    ...
    ![Edit the color palette.](../image/tb-edit-alt-color.png "Edit color palette")
...
After the alternate color palette has been added to your core theme, the theme name appears as a group with the palette recorded under the Color palette drop-down list.![Color palette drop-down list.](../image/tb-color-palette-list.png)
