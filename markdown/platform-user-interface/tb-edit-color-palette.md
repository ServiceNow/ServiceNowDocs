...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/tb-edit-color-palette.html
release: xanadu
topic_type: task
...
2.  From the Home page view, select the Manager page view to see [the themes you have previously defined](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/tb-create-theme.md).
...
6.  On this screen, perform the following actions:
    ...
    -   Select any of the three brand colors defined in this palette and change them from the color picker.
        ...
        **Note:** For dark palettes, only the primary color can be edited. If you want to customize further, see [Edit components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/tb-edit-components.md).
