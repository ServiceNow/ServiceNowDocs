...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/set-up-google-maps-api.html
release: yokohama
topic_type: task
...
<table id="choicetable_okq_vnj_smb"><thead><tr><th align="left" id="d53858e127">

Existing Google Maps API for Business license available?

</th><th align="left" id="d53858e133">

Tasks

</th></tr></thead><tbody><tr><td id="d53858e139">
