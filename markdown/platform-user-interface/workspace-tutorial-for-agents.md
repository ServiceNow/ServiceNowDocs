...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/workspace-tutorial-for-agents.html
release: xanadu
topic_type: task
...
You've walked through finding and solving an incident that was in the database. Next, walk through [solving an issue that comes in through a phone call or a chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/workspace-tutorial-agents-chat.md).
