...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/workspace-tutorial-for-agents.html
release: yokohama
topic_type: task
