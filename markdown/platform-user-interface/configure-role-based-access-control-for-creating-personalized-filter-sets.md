...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/configure-role-based-access-control-for-creating-personalized-filter-sets.html
release: australia
topic_type: task
