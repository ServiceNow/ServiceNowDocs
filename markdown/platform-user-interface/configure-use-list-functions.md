...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/configure-use-list-functions.html
release: xanadu
topic_type: task
...
[Integer values for default choice lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/c_IntValsForDfltChoiceList.md)
...
1.  The process depends on the version.
    ...
    For more information, see [Creating Personal Lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/c_PersonalLists.md).
