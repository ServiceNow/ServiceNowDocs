...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/c\_ConditionBuilder.html
release: yokohama
topic_type: concept
...
\[Omitted image "condition-builder-breadcrumb.png"\] Alt text: An image of the condition builder breadcrumb above a list in Core UI.
...
-   **[Filtering on empty fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/t_FilteringOnEmptyFields.md)**  
...
-   **[Values for date/time fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/c_ValuesForDateTimeFields.md)**  
...
-   **[Comparing field values](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/r_ComparingFieldValues.md)**  
...
**Parent Topic:**[Create a condition statement using the condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/create-cond-state-using-cond-build.md)
