...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/visual-task-boards/t\_ModifyQueryForExistingBoard.html
release: xanadu
...
<table id="choicetable_uxv_q2g_pv"><tbody><tr><td id="d92305e77">

**Edit the board query**

</td><td>

1.  Under **Board Filter**, select**Edit Filter &amp; Sort** to open the condition builder.
2.  Add and remove conditions as needed to edit the query.
3.  Select **Save changes**.


</td></tr><tr><td id="d92305e107">
