...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/visual-task-boards/t\_ModifyQueryForExistingBoard.html
release: yokohama
...
<table id="choicetable_uxv_q2g_pv"><tbody><tr><td id="d121766e77">
...
</td></tr><tr><td id="d121766e107">

**Change the lane field**

</td><td>

1.  Select the **Lane Field** picker and select a field or the **None** option.
