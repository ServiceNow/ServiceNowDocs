...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/visual-task-boards/t\_EditCardDetails.html
release: australia
...
3.  Modify the card details.
    ...
    -   Add a label to the card by selecting one or more of the [available labels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/visual-task-boards/t_ConfigureLabels.md).
