...
2.  Select the Additional actions icon from the header\(![additional actions icon](../../../administer/navigation-and-ui/image/additional-actions.png)\), and then select **Configure** &gt; **Form Layout**.
