...
![Activate swimlanes for a data driven flexible board](../image/flexibleswimlanes.png)
...
![Activate a data driven guided board with swimlanes](../image/swimlanesdatadriven.png)
