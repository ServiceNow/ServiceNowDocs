...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/visual-task-boards/data-driven-tasks.html
release: zurich
...
-   **[Create a data driven Visual Task Board](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/visual-task-boards/t_CreateAFlexibleOrGuidedBoard.md)**  
