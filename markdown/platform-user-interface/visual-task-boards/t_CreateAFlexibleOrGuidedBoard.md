...
6.  [Create a filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/t_CreatingFilters.md) to show only the records you want to work with.
