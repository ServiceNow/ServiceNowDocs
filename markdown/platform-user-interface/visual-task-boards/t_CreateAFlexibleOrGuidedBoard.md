...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/visual-task-boards/t\_CreateAFlexibleOrGuidedBoard.html
release: australia
...
6.  [Create a filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/t_CreatingFilters.md) to show only the records you want to work with.
...
**Parent Topic:**[Data driven Visual Task Boards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/visual-task-boards/data-driven-tasks.md)
