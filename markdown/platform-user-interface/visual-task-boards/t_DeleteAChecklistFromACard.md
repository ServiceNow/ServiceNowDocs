...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/visual-task-boards/t\_DeleteAChecklistFromACard.html
release: xanadu
...
3.  Click the more icon \(\[Omitted image "IconMore.png"\] Alt text: More icon\).
