...
![Sample checklist of an incident task card](../image/CardCheckList.png "Sample checklist")
...
![The task card displays a checklist progress bar](../image/TaskCardChecklistProgress.png "Task card with checklist progress bar")
