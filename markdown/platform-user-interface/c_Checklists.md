...
To enable checklists, navigate to the form and add the **Checklist** formatter. For instructions, see [Add a formatter](https://www.servicenow.com/docs/access?context=c_FormDesign&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
