...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/enable-accessibility-in-classic-pref.html
release: australia
topic_type: concept
...
Extends keyboard navigation and enables more tab stops in the classic environment.
...
Anyone using the legacy Classic UI.
...
**Activated:** Additional tab stops and keyboard navigation are available in Classic UI.

 **Deactivated:** Classic UI has limited keyboard navigation and tab stops.
