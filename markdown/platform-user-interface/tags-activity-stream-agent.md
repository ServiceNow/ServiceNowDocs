...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/tags-activity-stream-agent.html
release: brazil
topic_type: task
...
**Important:** Tags are enabled and created by your administrator. For instructions, see [Configure tags for the Activity stream](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/tags-activity-stream-admin.md).
