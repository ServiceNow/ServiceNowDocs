...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/config-da-action-configuration.html
release: australia
topic_type: task
