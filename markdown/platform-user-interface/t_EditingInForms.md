...
Administrators can enable the **Insert** function for task records. For more information, see [Allow insert options on task records](https://www.servicenow.com/docs/access?context=advanced-form-administration&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
<table id="choicetable_sdh_h2c_br"><tbody><tr><td id="d131143e223">
