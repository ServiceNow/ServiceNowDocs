...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/create-next-experience-landing-page.html
release: xanadu
topic_type: task
...
6.  Customize the components on the page according to the needs of your audience.
    ...
    To enable a footer for the page, see [Configure a Next Experience landing page footer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-next-experience-landing-page-footer.md).
