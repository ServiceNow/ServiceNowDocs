...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/create-a-new-uxf-client-action-for-forms.html
release: yokohama
topic_type: task
...
4.  Select an existing payload definition.
    ...
    For instructions on setting up a new payload definition, see [Configure action button to open a custom modal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configuring-an-action-button-to-open-a-custom-modal.md).
