...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-uis-and-portals.html
release: yokohama
topic_type: concept
...
[Workspace UI \[Omitted image "bus-monitor.svg"\] Alt text: Icon for working with Workspace UI Improve agent efficiency with Workspace UI, to offer better customer experience.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/workspace-landing-page.md)

</td><td>

[Working in Core UI \[Omitted image "bus-agent-workspace-1.svg"\] Alt text: Icon for Working in Core UI Upgrade the user experience with custom homepages and URL navigation, all in Core UI.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/working-in-ui16-and-ui15.md)
