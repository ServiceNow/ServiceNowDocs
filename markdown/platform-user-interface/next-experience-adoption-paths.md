...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/next-experience-adoption-paths.html
release: zurich
topic_type: concept
...
-   [Scriptable PolarisUI API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/server-api-reference/PolarisUIScopedAPI.md)
-   [Next Experience client scripting globals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/next-exp-client-script-globals.md)
...
1.  Enable the Next Experience using the system property described in [Enable Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/next-experience-adoption-paths.md).
