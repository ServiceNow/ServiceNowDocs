...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/next-experience-adoption-paths.html
release: xanadu
topic_type: concept
...
## New customer starting on the Xanadu release
...
-   [Next Experience client scripting globals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/next-exp-client-script-globals.md)
-   Jelly tags
...
-   [Live Feed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/live-feed/c_GetStartedWithLiveFeed.md) is not supported.
...
As an administrator, you can enable Next Experience for all users on your Xanadu instance, or let users enable or disable unified navigation for themselves.

If you're a new customer running the Xanadu release, Next Experience is enabled by default. If you're upgrading, see the information at [Considerations for activating Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/next-experience-adoption-paths.md) before you enable Next Experience.
