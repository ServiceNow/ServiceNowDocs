...
As a category, all card illustrations share color hook mappings. Color hook mappings link theme colors to specific parts of an illustration. As a result, the colors that you apply to one card illustration type are also applied to the entire card illustration category.
...
5.  Select any card illustration type from the main stage.
    ...
    **Note:** Customizing the colors of any card illustration type applies the color change to the entire card category, regardless of which type you select.
    ...
    ![Image styles tab selected with card illustrations listed on main stage and property panel opened.](../image/tb-card-property-panel.png "Image styles tab with Cards expanded and Focus important illustration selected")
