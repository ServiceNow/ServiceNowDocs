...
6.  To receive browser notifications, you must have this set-up:
    ...
    For additional information, see [Setting up Agent Chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/ac-configure-agent-chat.md).
