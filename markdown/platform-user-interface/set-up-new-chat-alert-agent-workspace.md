...
1.  In your Agent Workspace inbox, select the settings \(![Settings](../image/AgentWorkspaceSettingsIcon.png)\) icon.
...
6.  To receive browser notifications, you must have this set-up:
    ...
    For additional information, see [Setting up Agent Chat](https://www.servicenow.com/docs/access?context=ac-configure-agent-chat&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
