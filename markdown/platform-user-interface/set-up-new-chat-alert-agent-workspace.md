...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/set-up-new-chat-alert-agent-workspace.html
release: yokohama
topic_type: task
...
6.  To receive browser notifications, you must have this set-up:
    ...
    For additional information, see [Setting up Agent Chat](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/conversational-interfaces/ac-configure-agent-chat.md).
