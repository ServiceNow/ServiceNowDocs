...
6.  To receive browser notifications, you must have this set-up:
    ...
    For additional information, see [Setting up Agent Chat](https://www.servicenow.com/docs/access?context=ac-configure-agent-chat&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US).
