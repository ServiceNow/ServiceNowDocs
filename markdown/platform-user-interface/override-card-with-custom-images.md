...
5.  Use one of the following options to select the card illustration that you want to override.
    ...
    -   Select the Filter icon ![](../image/tb-filter-icon.png) icon and expand the card category to select the specific card illustration that you want to override.
    ...
    ![Image styles tab selected with card illustrations listed on main stage and property panel opened.](../image/tb-card-property-panel.png "Image styles tab with Cards selected")

6.  From the property panel, select the **Images** tab.

7.  Select the default card illustration file name.

    ![Focus important card illustration with Images tab selected.](../image/tb-card-focus-important-images.png)
...
9.  Preview your image in the modal and select **Save**.
    ...
    ![Focus important card illustration type with custom image displayed on main stage.](../image/tb-card-focus-important.png "Focus important card illustration type with custom image displayed")
...
**Parent Topic:**[Card illustrations in Theme Builder](../concept/card-illustrations-tb.md)
