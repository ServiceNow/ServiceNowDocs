...
7.  From the transaction table, select the personalize list icon \( ![Personalize list icon.](../../../use/using-lists/image/PersonalizeListIcon.png)\), within the banner frame.
