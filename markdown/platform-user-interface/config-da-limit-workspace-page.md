...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/config-da-limit-workspace-page.html
release: australia
topic_type: task
