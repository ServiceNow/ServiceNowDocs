...
You can activate the Sitemap Generator application \(sn\_ux\_seo\_sitemap\) from your instance. For more information, see [Activate Sitemap Generator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/sitemap-generator/activate-sitemap-generator.md).
...
-   **[Activate Sitemap Generator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/sitemap-generator/activate-sitemap-generator.md)**  
You can activate the Sitemap Generator plugin \(sn\_ux\_seo\_sitemap\) for Service Portal if you have the admin role.
-   **[Generate XML sitemaps for SEO indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/sitemap-generator/generate-xml-sitemaps-seo-indexing.md)**  
