...
**Important:** This procedure explains how to add a list or related list action button to your configurable workspace. For instructions on how to configure your action button to open a custom modal, see [Configuring an action button to open a custom modal](configuring-an-action-button-to-open-a-custom-modal.md).
