...
3.  Call the JavaScript function from the condition builder.
    ...
    For more information, see [GlideRecord](https://www.servicenow.com/docs/access?context=p_GlideServerAPIs&version=zurich&pubname=zurich-api-reference&section=c_GlideRecord&ft:locale=en-US) queries and [Script includes](https://www.servicenow.com/docs/access?context=c_ScriptIncludes&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
