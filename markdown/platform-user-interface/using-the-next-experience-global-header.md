...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/using-the-next-experience-global-header.html
release: xanadu
topic_type: concept
...
\[Omitted image "polaris-filter-ui.png"\] Alt text: Filter.pol-nav-all-p
...
Lists all the menu items and modules in the instance.
 ...
 Select the Refresh icon \(\[Omitted image "polaris-refresh-icon.png"\] Alt text: Refresh.\) to quickly obtain the latest menu items without the need to manually clear the cache.
...
Items you've marked as favorites, for example, favorite workspaces, classic environment, and records.
 ...
 Select the Edit icon \(\[Omitted image "polaris-edit-icon.png"\] Alt text: Edit.\) to open the edit modal.

 For information on adding and editing favorites, see [Managing your favorites in Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/managing-your-favorites.md).
...
Select the scope of your instance and the scope of your update sets. You can also select the **Update set** option and click the Plus sign \(\[Omitted image "plus.png"\] Alt text: Plus\) to create a new update set. Any application scope other than Global displays a red circle \(\[Omitted image "icon-scope-changed.png"\] Alt text: Scope selector icon with red circle.\).
