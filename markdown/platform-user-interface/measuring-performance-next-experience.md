...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/measuring-performance-next-experience.html
release: xanadu
topic_type: concept
...
</table>-   **[View the server response time](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/view-server-response-time.md)**  
