---
title: Communicating with requesters and agents using Compose
description: You use Compose to communicate with requesters and to enter comments about the work that you do on issues that only fellow agents can read.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/communicating-with-requesters.html
release: xanadu
topic_type: concept
