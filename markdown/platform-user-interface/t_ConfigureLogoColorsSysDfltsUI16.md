...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/t\_ConfigureLogoColorsSysDfltsUI16.html
release: yokohama
topic_type: task
...
**Note:** This information is applicable to Core UI. For theming information for Next Experience, see [Working with themes in Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/next-experience-theming.md).
