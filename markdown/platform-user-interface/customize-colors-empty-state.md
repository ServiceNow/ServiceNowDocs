...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/customize-colors-empty-state.html
release: yokohama
topic_type: task
