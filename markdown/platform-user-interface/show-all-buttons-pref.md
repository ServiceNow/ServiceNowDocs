...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/show-all-buttons-pref.html
release: zurich
topic_type: concept
...
# Show all buttons without the need to hover preference

Learn more about the Show all buttons without the need to hover accessibility preference.

\[Omitted image "coral-pref-no-hover.png"\] Alt text: Show all buttons without the need to hover accessibility preference.
...
Makes all interactive elements visible and discoverable. Visible controls remove guesswork and help users confidently take action.
...
-   Anyone unfamiliar with hidden UI patterns

</td></tr></tbody>
</table><table id="table_qym_c3h_ngc"><thead><tr><th>
...
\[Omitted image "a11y-pref-hover-on.png"\] Alt text: All menu with each button displayed with Show all buttons without need to hover preference turned on.

</td><td>

Some buttons or elements are hidden until hovered over.

\[Omitted image "a11y-pref-hover-off.png"\] Alt text: All menu with buttons displayed only with hover.
