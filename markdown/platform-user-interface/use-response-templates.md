...
2.  Open the Compose Email page by selecting the menu icon \(![More actions icon](../image/x-more-actions-icon.png)\) and **Compose Email**.
...
5.  Apply a response template with a keyboard shortcut.
    ...
    For instructions on applying a response template with a keyboard shortcut, see [Add response templates with a keyboard shortcut](../reference/add-response-templates-shortcut.md).
