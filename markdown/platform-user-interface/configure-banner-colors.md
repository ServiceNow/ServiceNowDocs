...
As a category, all banner illustrations share color hook mappings. Color hook mappings link theme colors to specific parts of an illustration. As a result, the colors that you apply to one banner illustration type are also applied to the entire banner illustration category.
