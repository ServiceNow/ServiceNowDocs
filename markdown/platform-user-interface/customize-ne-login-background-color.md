...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/customize-ne-login-background-color.html
release: australia
topic_type: task
