...
1.  To access the unique, secure web address for each instance, enter the default format: `https://<instancename>.service-now.com`.
    ...
    **Note:** To display a custom base URL in email notifications, set the **glide.email.override.url** property. For more information, see [Advanced email properties](https://www.servicenow.com/docs/access?context=r_AdditionalProperties&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
