...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/navigate-using-url.html
release: yokohama
topic_type: task
...
1.  To access the unique, secure web address for each instance, enter the default format: `https://<instancename>.service-now.com`.
    ...
    **Note:** To display a custom base URL in email notifications, set the **glide.email.override.url** property. For more information, see [Advanced email properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/r_AdditionalProperties.md).
...
-   **[Enable tiny URL support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/t_EnableTinyURLSupport.md)**  
...
-   **[Examples of navigating by URL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/r_NavigatingByURLExamples.md)**  
...
[Page navigation by URL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/navigate-by-portal-url.md)
