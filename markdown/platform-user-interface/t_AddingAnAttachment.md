...
Administrators can configure attachments and how they work in the system. For more information, see [Administering attachments](https://www.servicenow.com/docs/access?context=r_AdministeringAttachments&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
Limit the users who can view attachments by applying ACL rules. For more information on ACL rules, see [Access control list rules](https://www.servicenow.com/docs/access?context=access-control-rules&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
