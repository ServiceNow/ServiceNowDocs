...
-   **Group similar items**
    ...
    Use AI to group similar records based on their short descriptions.

-   **Summarize group**

    Create an AI-generated summary for a group based on record details.

-   **Post group summary to work notes**

    Post the AI-generated group summary as a work note to selected records.

-   **Ungroup items**

    Remove the groups of similar records.
...
5.  Post the summary as work notes.

    1.  Select **Post as work notes**.
    ...
    4.  Select records from the list to post the work note to.
