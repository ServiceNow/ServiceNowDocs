...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/define-the-payload-for-a-custom-modal.html
release: yokohama
topic_type: task
...
-   [Create a UX add-on event mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/create-a-ux-add-on-event-mapping.md)
