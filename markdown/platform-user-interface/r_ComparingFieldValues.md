...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/r\_ComparingFieldValues.html
release: zurich
...
\[Omitted image "ExampleFilter.png"\] Alt text: Example filter.
...
You can [Evaluate equality between date values](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/t_EvaluatingEqualityBetweenDates.md) and you can evaluate unequal dates within a range.
...
\[Omitted image "UnequalDatesFieldComparison.png"\] Alt text: Unequal dates field comparison.
...
-   **[Evaluate equality between date values](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/t_EvaluatingEqualityBetweenDates.md)**  
Date comparison evaluates a match for one of several date increments.

**Parent Topic:**[Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/c_ConditionBuilder.md)
