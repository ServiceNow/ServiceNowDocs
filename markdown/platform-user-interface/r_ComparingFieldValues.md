...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/r\_ComparingFieldValues.html
release: yokohama
...
You can [Evaluate equality between date values](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/t_EvaluatingEqualityBetweenDates.md) and you can evaluate unequal dates within a range.
...
-   **[Evaluate equality between date values](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/t_EvaluatingEqualityBetweenDates.md)**  
Date comparison evaluates a match for one of several date increments.

**Parent Topic:**[Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/c_ConditionBuilder.md)
