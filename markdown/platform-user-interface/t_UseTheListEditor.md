...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/t\_UseTheListEditor.html
release: zurich
topic_type: task
...
\[Omitted video\] Description: Use the list editor
...
1.  Double-click in an empty area of the field.
    ...
    **Note:** You can enable single-click editing from the [list personalization interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/c_PersonalLists.md). You can also use keyboard navigation to access the list editor.
