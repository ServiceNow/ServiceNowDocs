...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/t\_UseTheListEditor.html
release: yokohama
topic_type: task
...
1.  Double-click in an empty area of the field.
    ...
    **Note:** You can enable single-click editing from the [list personalization interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/c_PersonalLists.md). You can also use keyboard navigation to access the list editor.
