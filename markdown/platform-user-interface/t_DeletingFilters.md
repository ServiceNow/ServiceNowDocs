...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/t\_DeletingFilters.html
release: yokohama
topic_type: task
...
4.  Select the filter to delete.

5.  Click **Delete** and confirm the deletion.


**Parent Topic:**[Filter admin functions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/filter-admin-functions.md)
