...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/c\_Lanes.html
release: yokohama
topic_type: concept
...
**Note:** The number of items displayed in a lane depends on the **Max items per lane** and **Max items per lane 2d** settings on [Timeline Visualization form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/t_CreateATimelineVisualization.md).
...
\[Omitted image "3DPanelAnno.png"\] Alt text: 3D panel

\[Omitted image "2DPanelAnno.png"\] Alt text: 2D panel
