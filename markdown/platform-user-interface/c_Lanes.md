...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/c\_Lanes.html
release: brazil
topic_type: concept
...
**Note:** The number of items displayed in a lane depends on the **Max items per lane** and **Max items per lane 2d** settings on [Timeline Visualization form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_CreateATimelineVisualization.md).
