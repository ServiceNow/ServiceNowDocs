...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/c\_Lanes.html
release: zurich
topic_type: concept
...
**Note:** The number of items displayed in a lane depends on the **Max items per lane** and **Max items per lane 2d** settings on [Timeline Visualization form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/t_CreateATimelineVisualization.md).
...
**Parent Topic:**[Use Timeline Visualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/c_UseTimelineVisualizations.md)
