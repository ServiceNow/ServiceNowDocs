...
-   **[Configure a declarative action with the Now Assist icon](../task/create-da-buttons-now-assist-icon.md)**

    Configure a declarative action button with the Now Assist icon \(![](../../../common/image/icon-ai-sparkle.png)\) and hover animation.

-   **[Trigger a UI interaction as a declarative action](../task/configure-da-ui-interactions.md)**

    Trigger a UI interaction from a declarative action to extend a page without taking ownership.

-   **[Configure a form action layout on a workspace page](../task/configure-da-action-layout.md)**
...
-   **[Configure modal background loading](../../workspace/task/set-up-asychronous-record-addition-declarative-actions.md)**

    Configure a modal to load large selections of records added to a related list in the background.

-   **[Resize a modal](../../workspace/task/set-up-resizing-for-select-modals-in-configurable-workspace.md)**
...
-   **[Configure an action configuration record](../task/config-da-action-configuration.md)**

    Create an action configuration record for a form or list action and copy the action configuration record's sys\_id.

-   **[Configure a watch list](../task/configure-watch-list.md)**
