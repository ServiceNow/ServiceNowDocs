...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/tb-create-a-theme-ai.html
release: zurich
topic_type: task
...
4.  Choose how to define your theme colors.
    ...
    \[Omitted image "tb-nap-wizard-flow-2.png"\] Alt text: Theme Creation wizard showing the option to upload a brand image or handpick colors to generate a color palette.

5.  If you chose to upload a brand image, generate your theme colors using AI.

    1.  Upload your brand image.

        Supported formats are JPEG, JPG, PNG, and SVG with a maximum size of 1 MB.\[Omitted image "tb-nap-wizard-upload-image.png"\] Alt text: Theme Creation wizard showing a brand image uploaded to generate a color palette using AI.
