...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/t\_DynamicFilterOptions.html
release: zurich
topic_type: task
...
1.  [Create a scripted filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/scripts/c_ScriptIncludes.md) as a client-callable script include or business rule.
