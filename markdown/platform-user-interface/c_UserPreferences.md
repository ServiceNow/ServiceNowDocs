...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/c\_UserPreferences.html
release: xanadu
topic_type: concept
...
For more information about the preferences available to users, see [User preference settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/r_UserPreferenceSettings.md) and [Next Experience preferences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/set-up-preferences-next-experience.md).
...
**Note:** A maximum of 10,000 user preferences can be there for each user, exceeding this limit causes system degradation and UI performance issues.
...
User preference records for system-wide values, also called the default or global values, are stored in update sets. Any changes are implemented when you import the update set and affect all users who have not customized the feature. User preference records for specific users aren’t stored in update sets, so user customizations are retained when you import an update set. For more information, see .

-   **[User preference settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/r_UserPreferenceSettings.md)**  
...
-   **[Turn off the Next Experience welcome screen after upgrading your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/remove-welcome-splash-screen.md)**  
...
-   **[Configure available keyboard shortcuts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/configure-keyboard-shortcuts.md)**  
