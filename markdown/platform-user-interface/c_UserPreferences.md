...
For more information about the preferences available to users, see [User preference settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/r_UserPreferenceSettings.md) and [Next Experience preferences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/set-up-preferences-next-experience.md).
...
-   **[Turn off the Next Experience welcome screen after upgrading your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/remove-welcome-splash-screen.md)**  
...
-   **[Configure available keyboard shortcuts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/configure-keyboard-shortcuts.md)**  
