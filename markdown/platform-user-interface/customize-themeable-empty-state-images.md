...
5.  Add your custom image in one of the following ways.
    ...
    -   Add image to UX Style Assets list.
        ...
        2.  Select the Lookup icon\(![Lookup icon.](../image/SearchIcon.png)\) next to the **Asset** item.
        3.  In the UX Theme Assets list, select **New**.
        4.  Select the Manage Attachments icon \(![Manage attachments icon](../image/icon-manage-attachment.png)\) to add an image.
