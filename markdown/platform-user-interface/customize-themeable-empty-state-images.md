...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/customize-themeable-empty-state-images.html
release: xanadu
topic_type: task
...
5.  Add your custom image in one of the following ways.
    ...
    -   Add your custom image to the Images \[db\_images\_list.do\] table.
        ...
        **Note:** Verify that your image is in SVG format.
        ...
        1.  For detailed instructions, see [Upload one or more images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/upload-multiple-images.md).
...
**Parent Topic:**[Working with theme-able empty state images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/themeable-empty-state-images.md)
