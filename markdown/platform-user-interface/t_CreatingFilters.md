...
<table id="choicetable_ll5_44w_tt"><tbody><tr><td id="d139286e135">
...
7.  Click **Save** to keep the filter for future use.
    ...
    For more information, see [Save and use filters in a list view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_SavingFilters.md).
