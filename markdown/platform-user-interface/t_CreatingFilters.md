...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/t\_CreatingFilters.html
release: zurich
topic_type: task
...
<table id="choicetable_ll5_44w_tt"><tbody><tr><td id="d140385e135">
...
7.  Click **Save** to keep the filter for future use.
    ...
    For more information, see [Save and use filters in a list view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/t_SavingFilters.md).

8.  Click **Run** to apply the filter.


**Parent Topic:**[Filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/c_Filters.md)
