...
|Option|Description|
|------|-----------|
|Dragging|Hold down the left mouse button and drag the [slider track](../concept/c_UseTheSliderAndSliderTrack.md) right or left to view other months.|
...
|Option|Description|
|------|-----------|
|Dragging|Hold down the left mouse button and drag the slider along the [slider track](../concept/c_UseTheSliderAndSliderTrack.md) to move the timeline forward or backward.|
|Mouse wheel button|Scroll the wheel to move the timeline forward or backward.|
...
[Personalize Timeline Visualizations](r_PersonalizeTimelineVisualizations.md)
