...
![Agent workflow](../image/agent-workflow-whole-2.png)
...
![Record view](../image/record-view-4.jpg)
...
Now that you understand how to look through the parts of workspace to get contextual information about an issue, let's see how to [find a solution](agent-assist.md).
