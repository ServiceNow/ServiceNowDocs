...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/live-agent-overview.html
release: yokohama
topic_type: concept
...
Display buttons for available actions: -   [Quick actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/conversational-interfaces/ci-agent-chat-using.md) \[Omitted image "quick-action-icon.png"\] Alt text: Quick action icon - select to display the quick action menu.
