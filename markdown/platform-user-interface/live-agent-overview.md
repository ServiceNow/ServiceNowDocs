...
Display buttons for available actions: -   [Quick actions](https://www.servicenow.com/docs/access?context=ci-agent-chat-using&version=zurich&pubname=zurich-conversational-interfaces&section=ci-quick-actions&ft:locale=en-US) ![Quick action icon](../image/quick-action-icon.png) - select to display the quick action menu.
