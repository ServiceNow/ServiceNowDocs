...
Option to impersonate other authenticated users for testing purposes and to view impersonation logs. For more information, see [Impersonate a user](https://www.servicenow.com/docs/access?context=c_ImpersonateAUser&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
Option to elevate to a privileged role to gain access to the features of High Security Settings for the current session. For more information, see [Elevated privilege roles](https://www.servicenow.com/docs/access?context=c_ElevatedPrivilege&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).**Note:** Users granted the admin role can't elevate to a privileged role. Only the base system admin can be elevated.
