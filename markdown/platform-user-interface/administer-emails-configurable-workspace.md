...
-   **[Configure email templates](../../workspace/task/configure-email-templates.md)**

    Configure email templates in Configurable Workspace to quickly create emails for common issues.

-   **[Configure collapsible templates](../../workspace/task/configure-collapsible-email-templates.md)**
