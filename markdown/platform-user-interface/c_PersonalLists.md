...
Personal list customizations don’t affect what other users see in their lists. Administrators can [manage](https://www.servicenow.com/docs/access?context=c_AdministeringPersonalLists&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) the personal lists function.
...
<table id="choicetable_qgk_vbz_3r"><tbody><tr><td id="d50308e177">
...
<table id="choicetable_ofx_lcz_3r"><tbody><tr><td id="d50308e278">
