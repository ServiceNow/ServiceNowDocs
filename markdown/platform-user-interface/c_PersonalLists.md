...
Personal list customizations don’t affect what other users see in their lists. Administrators can [manage](https://www.servicenow.com/docs/access?context=c_AdministeringPersonalLists&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) the personal lists function.
...
<table id="choicetable_qgk_vbz_3r"><tbody><tr><td id="d40692e171">
...
<table id="choicetable_ofx_lcz_3r"><tbody><tr><td id="d40692e272">
