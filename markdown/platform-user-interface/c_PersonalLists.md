...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/c\_PersonalLists.html
release: zurich
topic_type: concept
...
<table id="choicetable_qgk_vbz_3r"><tbody><tr><td id="d45117e181">
...
</td></tr><tr><td id="d45117e236">

**Use updated field status indicators**

</td><td>

Select the **Modern cell coloring** check box.In Core UI, this option is also available in the **Lists** section of the [system settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/r_UI16BannerFrame.md).
...
<table id="choicetable_ofx_lcz_3r"><tbody><tr><td id="d45117e282">
