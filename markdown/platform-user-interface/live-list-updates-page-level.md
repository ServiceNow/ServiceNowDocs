...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/live-list-updates-page-level.html
release: australia
topic_type: task
