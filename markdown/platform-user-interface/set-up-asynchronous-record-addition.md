...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/set-up-asynchronous-record-addition.html
release: zurich
topic_type: task
