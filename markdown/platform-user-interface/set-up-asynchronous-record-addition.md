...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/set-up-asynchronous-record-addition.html
release: yokohama
topic_type: task
