...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/t\_CreateOrCustomizeATheme.html
release: zurich
topic_type: task
...
4.  Add any of the [default CSS styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/r_DefaultCSSStyle.md) in the **CSS** field.
