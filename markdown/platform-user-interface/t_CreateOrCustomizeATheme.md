...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/t\_CreateOrCustomizeATheme.html
release: yokohama
topic_type: task
...
4.  Add any of the [default CSS styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/r_DefaultCSSStyle.md) in the **CSS** field.
...
**Parent Topic:**[CSS theme support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/c_CSSThemeSupport.md)
