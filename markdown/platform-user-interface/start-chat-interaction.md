...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/start-chat-interaction.html
release: yokohama
topic_type: task
...
<table id="choicetable_rrq_1lt_ddb"><tbody><tr><td id="d48807e89">

**Manage your chat**

</td><td>

Do the following actions from the Actions toolbar:-   [Add an attachment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/chat-attachment.md).
-   Transfer a chat to another queue.
-   Transfer a chat to another agent.


</td></tr><tr><td id="d48807e116">
