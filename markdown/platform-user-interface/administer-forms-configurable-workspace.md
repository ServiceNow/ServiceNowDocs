...
-   **[Configure highlighted values](../task/config-ws-highlight-value.md)**
...
-   **[Configure string field guidance and validation](../task/format-regex-pattern-string-fields.md)**
...
-   **[Configure access-based @mention suggestions](../task/set-up-at-mentions.md)**
