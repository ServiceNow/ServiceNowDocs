...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/c\_activity-streams.html
release: australia
topic_type: concept
...
-   In a list, in the [activity stream](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_DisplayActivityStreams.md) for a record.
-   On a Visual Task Board card, in the [card details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/visual-task-boards/t_EditCardDetails.md).
