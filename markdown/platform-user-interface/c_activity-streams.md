...
-   **Record activity stream**
    ...
    Appears in forms that are configured with the [activity formatter](https://www.servicenow.com/docs/access?context=c_ActivityFormatter&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) . You can customize the activities to include in this type of stream.
...
-   On a form, in the [activity formatter](https://www.servicenow.com/docs/access?context=c_ActivityFormatter&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) \(Core UI only\).
...
-   In a Connect [record conversation](https://www.servicenow.com/docs/access?context=t_StartARecordConversation&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
