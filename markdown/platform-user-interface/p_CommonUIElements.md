...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/p\_CommonUIElements.html
release: australia
topic_type: topic
...
-   **[Log in to an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/t_LoggingIn.md)**  
...
-   **[Navigate directly to a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/t_NavigateDirectlyToATable.md)**  
You can use commands in the navigation filter to navigate directly to the list, form, or configuration view of a table.
-   **[Tree picker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_TreePicker.md)**  
...
-   **[Activity streams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_activity-streams.md)**  
...
-   **[Create a condition statement using the condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/create-cond-state-using-cond-build.md)**  
...
-   **[Enable or disable an application menu or module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/t_EnDisableAppMenuOrMod.md)**  
You can enable \(show\) or disable \(hide\) an application menu or module in the application navigator.
-   **[Tags](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_Tags.md)**  
...
-   **[User presence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/c_UserPresence.md)**  
