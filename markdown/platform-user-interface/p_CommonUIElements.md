...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/p\_CommonUIElements.html
release: brazil
topic_type: topic
...
-   **[Log in to an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_LoggingIn.md)**  
...
-   **[Navigate directly to a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_NavigateDirectlyToATable.md)**  
...
-   **[Dot-walking to data in related tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_DotWalking.md)**  
...
-   **[Activity streams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_activity-streams.md)**  
...
-   **[Create a condition statement using the condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/create-cond-state-using-cond-build.md)**  
...
-   **[Enable or disable an application menu or module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_EnDisableAppMenuOrMod.md)**  
You can enable \(show\) or disable \(hide\) an application menu or module in the application navigator.
-   **[Tags](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_Tags.md)**  
