...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/next-experience-list-module.html
release: australia
topic_type: task
...
9.  Enter or select the value you want to filter for in the list.
