...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/t\_UseSlushbuckets.html
release: zurich
topic_type: task
...
-   **[Set the number of list collector items visible in the available column](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/t_SetNumSlushbucketItemsVisible.md)**  
