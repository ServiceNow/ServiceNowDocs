...
![Form pane](../image/use-form-pane.png)

You can vary the width of the form pane by dragging the right side of it.

You can scroll through all the fields or jump to a section in the **Detail** tab. To jump to a section, click the menu icon \(![menu icon](../image/hamburger-icon.png)\) to the left of the record type to display the sections in the form pane. Click the section title you want to jump to. For example, in the following image, if you click **Notes**, the record fields scroll up to the **Notes** section.

![Jump to section in form pane](../image/use-forms-section-jump.png)
...
![Related items menu](../image/related-items-menu-alone.png)

Click these tabs to understand what this record might be affecting. For example, clicking **Impacted Services** displays the services affected by the incident in the open record. For more information, see [Get information related to the open record](../reference/related-lists.md).
...
![Enter information into the form pane](../image/enter-info-into-form-pane.png)

## Additional record functionality

-   Template value field:–-. For more information, see [Configure a template value field](../task/configure-template-value-field.md).
