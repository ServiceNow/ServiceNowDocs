...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/configure-next-experience-theme.html
release: yokohama
topic_type: task
...
4.  Select the Additional actions icon \(\[Omitted image "icon-context-p.png"\] Alt text: Additional actions icon\) and select **Save**.
...
6.  Select the **Style** field and select the \[Omitted image "ux-style-search.png"\] Alt text: UX style search icon..
...
-   Core
-   Variant
 For more information on types, see [Difference between core styles and variants](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/difference-themes-variants.md).
...
To publish your custom theme, see [Publish multiple themes in Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/configure-presentation-order-of-themes.md).

**Parent Topic:**[Configuring Next Experience themes and preferences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/config-next-experience-themes-prefs.md)
