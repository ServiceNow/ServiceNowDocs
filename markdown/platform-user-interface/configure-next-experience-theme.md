...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/configure-next-experience-theme.html
release: zurich
topic_type: task
...
6.  Select the **Style** field and select the search icon \[Omitted image "ux-style-search.png"\] Alt text:.
...
-   Core
-   Variant
 For more information on types, see [Difference between core styles and variants](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/difference-themes-variants.md).
...
To publish your custom theme, see [Publish multiple themes in Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/configure-presentation-order-of-themes.md).
