...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/adoption-services/add-custom-help-copy.html
release: xanadu
...
**Note:** Embedded help records are also used to create content for the Help Center within a configurable workspace. For more information, see [Create Help Center content for configurable workspaces](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/adoption-services/create-help-center-content.md).
...
The UI page this topic corresponds to. Typically, you do not change the page name.**Note:** If you are using the embedded help record to display in the Help Center, as described in [Create Help Center content for configurable workspaces](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/adoption-services/create-help-center-content.md), enter the same value in the Name and Page fields, replacing spaces with underscores in the Page field.
...
Specify the domain this content is used for, if applicable.This field appears in the form if the administrator configured the form to display it.
    ...
    **Note:** Do not add images in an embedded help topic. Images are removed from the content section when the record is saved.
    ...
    To add an embedded video, see [Embed video content in help topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/adoption-services/embed-video-help-content.md).
...
**Parent Topic:**[Configuring Embedded Help](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/adoption-services/configuring-embedded-help.md)
