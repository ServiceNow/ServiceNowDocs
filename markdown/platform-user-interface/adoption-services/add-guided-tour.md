...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/adoption-services/add-guided-tour.html
release: yokohama
 ...
 **Note:** When you add at least one role to a tour, it limits the audience to only those users who have that role.
    ...
    \[Omitted image "create-guided-tour-madrid.png"\] Alt text: Shows Delegate role page with the list of delegates. In this example, no records are displayed in the list as new delegates are not created in the instance.
...
5.  Complete the following steps to add a tour step with a callout and trigger.
    ...
    2.  Once the callout is placed at the right position, Create Step page appears.\[Omitted image "gtd-createstep.png"\] Alt text: Create Step Page
    ...
    5.  [Select the trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/adoption-services/guided-tour-triggers.md) under **Choose action** field. Only triggers that you can use for the selected element appear in the list.
...
8.  Click **Save**.
    ...
    \[Omitted image "gtd-closing-note-london.png"\] Alt text: Closing step in a guided tour — Madrid UI

9.  Click **Preview** at any time to test your steps and make any final revisions to the tour until you are satisfied.

    Note the steps that are not working properly or that need correction. Edit the tour or the steps as described in [Edit a guided tour](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/adoption-services/edit-guided-tour.md).

10. To share your draft or published tour with internal colleagues for review, you can:

    1.  Click the Copy URL icon \[Omitted image "gtd-paperclip-icon.png"\] Alt text: Show the user the Copy URL icon for guided tours. to copy the tour URL.
...
[Exploring Guided Tours](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/adoption-services/exploring-guided-tours.md)
