...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/adoption-services/add-guided-tour.html
release: australia
...
5.  Follow these steps to add a tour step with a callout and trigger:
    ...
    3.  [Select the trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/adoption-services/guided-tour-triggers.md) from the **Choose action** list. Only triggers applicable to the selected element appears in the list.
...
8.  Select **Preview** at any time to test your steps and make any final revisions to the tour.
    ...
    Note the steps that aren’t working properly or that need correction. Edit the tour or the steps as described in [Edit Guided Tours](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/adoption-services/edit-guided-tour.md).
...
[Exploring Guided Tours](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/adoption-services/exploring-guided-tours.md)
