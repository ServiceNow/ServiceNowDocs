...
-   **[Create a guided tour to illustrate vacation delegation](../task/usecase-set-a-vacation-delegate.md)**  
Use Guided Tour Designer to create a guided tour for assigning a vacation delegate.
-   **[Create guided tour to explore Service Portal home page](../task/usecase-create-guide-tour-service-portal.md)**  
Use Guided Tour Designer to create a guided tour to explore the Service Portal home page.
-   **[Create a guided tour to show incident generation in Workspace](../task/usecase-create-guided-tour-in-workspace.md#)**  
