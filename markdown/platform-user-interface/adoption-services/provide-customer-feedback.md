...
1.  Open the Help Center by selecting the Help Center icon \[Omitted image "pol-nav-help.png"\] Alt text:.

2.  Scroll to the bottom of the Help Center menu and select **Provide feedback**.

    \[Omitted image "ads-help-center.png"\] Alt text:
...
4.  When you have completed your feedback, select **Submit**.
    ...
    **Note:** If you do not want the **Provide Feedback** button to appear in the Help Center, you can [disable it](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/adoption-services/disable-feedbak.md).
