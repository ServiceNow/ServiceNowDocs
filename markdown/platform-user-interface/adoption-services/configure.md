...
-   When sn\_dyn\_guidance\_user role is assigned, it includes the genai\_admin role.
...
-   Configure external content connectors to integrate with Dynamic Guidance. See [External content connector in Dynamic Guidance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/adoption-services/external-content-connector-in-dynamic-guidance.md).
-   Link Dynamic Guidance to additional documentation sources. See [Adding custom sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/adoption-services/adding-custom-sources.md).
