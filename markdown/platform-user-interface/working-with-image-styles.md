...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/working-with-image-styles.html
release: yokohama
topic_type: concept
...
-   **[Customize the colors for empty state illustrations and custom images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/customize-colors-empty-state.md)**  
...
-   **[Override empty state illustrations with custom images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/override-empty-state-illustrations.md)**  
