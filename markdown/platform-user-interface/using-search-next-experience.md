...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/using-search-next-experience.html
release: yokohama
topic_type: concept
...
For more details on the contents of the Next Experience search results page, see [Search results page in Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/global-search-polaris-ui.md).
...
For information adding a workspace to the Unified Navigation search menu, see [Add a workspace application to the Unified Navigation search context menu](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/add-app-search-context-polaris-ui.md).
