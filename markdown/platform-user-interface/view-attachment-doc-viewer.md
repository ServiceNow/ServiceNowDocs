...
Make sure that Document Viewer is enabled for the table containing the record. For more information, see [Enable Document Viewer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/enable-document-viewer.md).

Role required: none

## About this task

Document Viewer supports inline viewing of certain [document types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/Documentviewer.md) within the platform.
