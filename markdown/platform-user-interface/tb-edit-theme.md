...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/tb-edit-theme.html
release: zurich
topic_type: task
...
<table id="choicetable_v1x_lnb_qfc"><thead><tr><th align="left" id="d52721e234">

Page

</th><th align="left" id="d52721e237">

Option

</th></tr></thead><tbody><tr><td id="d52721e243">
...
4.  Review and update the Global styles, as needed.
    ...
    **Note:** The following style records are generated with your theme:
    ...
    -   **Your brand palette**: Update the interface colors for your brand. For more information, see [Edit your theme colors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/edit-theme-colors.md).
    -   **Logo**: Update the logo. You can upload the logo during the theme application from the Overview page. For more information, see [Upload a new logo to your Theme Builder theme](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/tb-upload-logo.md).
    -   **Typography**: Update the fonts applied globally to your experience. The fonts are used in headlines, titles, subtitles, body text, and captions. For more information, see [Edit your default font](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/edit-font.md).
    -   **Shape**: Update the corner shapes of on-screen components. For more information, see [Edit corner shapes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/edit-corner-shapes.md).
...
6.  Publish your theme.
    ...
    For more information, see [Publish your themes with Theme Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/tb-apply-theme.md).


-   **[Core styles, colors, variants, and alternate color palettes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/difference-themes-variants.md)**  
...
-   **[Add an alternate color palette](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/tb-edit-color-palette.md)**  
Customize a Theme Builder theme by creating an alternate color palette for the theme and publishing it to your instance.
-   **[Working with Global styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/working-with-global-styles.md)**  
...
-   **[Working with Component styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/working-with-component-styles.md)**  
...
-   **[Working with Image styles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/working-with-image-styles.md)**  
