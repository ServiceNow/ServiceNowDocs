...
The kinds of records you can create is configured by your system administrator. The default is an interaction record. If you place your mouse over the plus sign icon \(![Add record](../image/icon-plus-sign.png)\), the list of records you can create appears.

## Procedure

1.  Click the plus sign icon \(![Add record](../image/icon-plus-sign.png)\).

    ![Record tab](../image/record-tab.png)
