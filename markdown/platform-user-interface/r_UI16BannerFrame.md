...
-   [Add channels](https://www.servicenow.com/docs/access?context=create-channel&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) using the **Create Channel** option.
-   [Modify channel information](https://www.servicenow.com/docs/access?context=modify-notif-channel&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US). Click the channel row or the right arrow \(**&gt;**\) next to the appropriate channel to edit or delete it.
...
List of notification categories that identify and group related notifications. Each category contains the notifications that you can subscribe to. To view the notifications in a given category, click the category row or the right arrow \(**&gt;**\) next to the appropriate category. You can:
 ...
 -   Edit settings for a notification:
    ...
    -   [Apply notification conditions](https://www.servicenow.com/docs/access?context=apply-notification-conditions&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US), such as schedules and filters, that affect the delivery of the notification.
-   [Create personal notifications](https://www.servicenow.com/docs/access?context=create-personal-notifications&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US), which are subscriptions to specific notifications that matter to you.
...
\(Administrators only\) Opens the client-side [JavaScript debug window](https://www.servicenow.com/docs/access?context=c_JavaScriptDebugWindow&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
