...
As a category, all tile icon illustrations share color hook mappings. Color hook mappings link theme colors to specific parts of an illustration. As a result, the colors that you apply to one tile icon illustration type are also applied to the entire tile icon illustration category.
...
5.  Select any tile icon illustration type from the main stage.
    ...
    **Note:** Customizing the colors of any tile icon illustration type applies the color change to the entire tile icon category, regardless of which type you select.
    ...
    ![Image styles tab selected with tile icon illustrations listed on main stage and property panel opened.](../image/tb-tile-icon-property-panel.png "Image styles tab with Tile icons expanded and Accessibility illustration selected")
