...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/add-workspace-unified-navigation.html
release: yokohama
topic_type: task
