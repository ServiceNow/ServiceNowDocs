...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/add-workspace-unified-navigation.html
release: xanadu
topic_type: task
