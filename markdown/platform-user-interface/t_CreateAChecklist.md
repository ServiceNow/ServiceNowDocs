...
The Checklist formatter must be [added to the form](https://www.servicenow.com/docs/access?context=c_FormDesign&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) by a user with the personalize\_form role.
...
<table id="choicetable_zzd_cd3_xbb"><tbody><tr><td id="d97844e88">
