...
The total number of accessibility violations are indicated on the red numbered badge \(![Accessibility inspector badge.](../image/tb-a11y-inspector-badge.png)\) alongside the Accessibility inspector panel.

## Procedure

1.  From the Editor page, access the accessibility violations in one of the two ways listed in the following table.

<table id="choicetable_php_1vv_2dc"><thead><tr><th align="left" id="d108122e91">

Option

</th><th align="left" id="d108122e94">

Description

</th></tr></thead><tbody><tr><td id="d108122e100">
