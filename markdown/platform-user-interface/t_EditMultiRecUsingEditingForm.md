...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/t\_EditMultiRecUsingEditingForm.html
release: zurich
topic_type: task
...
<table id="choicetable_f1q_l2n_pv"><tbody><tr><td id="d86692e66">
...
**Parent Topic:**[Methods for list edits](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/r_MethodsForListEdits.md)
