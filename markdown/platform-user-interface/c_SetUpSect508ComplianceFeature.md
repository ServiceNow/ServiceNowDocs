...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/c\_SetUpSect508ComplianceFeature.html
release: yokohama
topic_type: concept
...
Alternatively, enable accessibility mode using the Enable Accessibility skip link. For more information on skip links, see [Use skip links](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/keyboard-accessibility.md).
...
Individual users can enable the contrast theme for themselves by navigating to the Theme tab of the [system settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/r_UI16BannerFrame.md) menu. From the Theme tab, select the **Contrast UI** theme.
...
1.  Click the gear icon \(\[Omitted image "IconUI16Gear.png"\] Alt text: Gear icon\) in the banner frame to open the System Settings window.
