...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/c\_SetUpSect508ComplianceFeature.html
release: zurich
topic_type: concept
...
Alternatively, enable accessibility mode using the Enable Accessibility skip link. For more information on skip links, see [Use skip links](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/keyboard-accessibility.md).
...
Individual users can enable the contrast theme for themselves by navigating to the Theme tab of the [system settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/r_UI16BannerFrame.md) menu. From the Theme tab, select the **Contrast UI** theme.
