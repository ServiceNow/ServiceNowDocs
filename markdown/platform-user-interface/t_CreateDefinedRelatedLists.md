...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/t\_CreateDefinedRelatedLists.html
release: zurich
topic_type: task
...
-   **[Add incidents by same caller related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/t_ExampleIncidentsBySameCaller.md)**  
This example adds the existing relationship, Incidents by Same Caller, to incident forms.
-   **[Add transactions by user related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/t_ExampleTransactionsByUser.md)**  
This example adds a relationship, Last 20 transactions, to the user form.

**Parent Topic:**[Related lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/c_RelatedLists.md)
