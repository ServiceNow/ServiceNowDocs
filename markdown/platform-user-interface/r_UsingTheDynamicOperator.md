...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/r\_UsingTheDynamicOperator.html
release: zurich
...
**Note:** Administrators can [create new dynamic filter options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/t_DynamicFilterOptions.md).
