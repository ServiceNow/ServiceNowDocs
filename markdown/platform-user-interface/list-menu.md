...
To get to list view, click the list icon \(![List icon](../image/list-icon-black.png)\).

![List panel showing Lists and My Lists](../image/list-view.png "List view")
...
![List view](../image/list-category-list-fields.png)
...
You can use the up arrowhead icon \(![Collapse icon](../image/icon-arrowhead-up.png)\) to display the list filters under each list category. Clicking the down arrowhead icon \(![Collapse icon](../image/icon-arrowhead-down.jpg)\) collapses the list categories to make it easier to scroll through the list categories.
...
Any lists that you create appear in this section. Lists in this section are only visible to you. For more information about creating your own list categories and list filters, see [Create My Lists in workspace](../task/create-filtered-list-agent-workspace.md).

## Next

Learn how to [work with lists in list view](../task/work-with-lists.md#).
