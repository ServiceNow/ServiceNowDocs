...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/list-menu.html
release: yokohama
topic_type: concept
...
Any lists that you create appear in this section. Lists in this section are only visible to you. For more information about creating your own list categories and list filters, see [Create My Lists in workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/create-filtered-list-agent-workspace.md).

## Next

Learn how to [work with lists in list view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/work-with-lists.md).
