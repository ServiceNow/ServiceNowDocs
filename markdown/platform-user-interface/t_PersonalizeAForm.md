...
**Note:** Personalizing a form in this way modifies the form for you only. To make changes to a form that are visible to all users, you must [configure the form](https://www.servicenow.com/docs/access?context=configure-form-layout&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
[Administering form personalization](https://www.servicenow.com/docs/access?context=c_FormPersonalizationAdmin&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
