...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/t\_PersonalizeAForm.html
release: zurich
topic_type: task
...
**Note:** Personalizing a form in this way modifies the form for you only. To make changes to a form that are visible to all users, you must [configure the form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/configure-form-layout.md).
...
[Administering form personalization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/c_FormPersonalizationAdmin.md)
