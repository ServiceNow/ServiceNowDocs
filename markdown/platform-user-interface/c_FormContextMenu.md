...
Access the form context menu by clicking an icon beside the form title or by right-clicking the form header \(![Context menu icon](../image/UI14FormContextMenu.png)\).
...
|Export|Exports data to PDF. Administrators can also export to XML. For more information, see [Export data](https://www.servicenow.com/docs/access?context=c_ExportData&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).|
...
|History|Administrators only. Displays audit history for the record, which must be enabled for the table. For more information, see [Enable auditing for a table](https://www.servicenow.com/docs/access?context=t_EnableAuditingForATable&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).|
...
[UI actions](https://www.servicenow.com/docs/access?context=c_UIActions&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
