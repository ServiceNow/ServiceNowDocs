...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/content-management-system/t\_BuildAMasterTemplateStepByStep.html
release: australia
...
2.  Create a theme.
    ...
    The theme defines the structure of the layouts in CSS and the base styles, such as fonts and colors. For more information, see [Design themes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/content-management-system/c_DesignThemes.md).
