...
**Note:** The global search is similar to the normal frame set user interface and ties to the same roles \([Set global text search properties](https://www.servicenow.com/docs/access?context=set-global-text-search-properties&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)\).
