...
After defining content blocks, use them on any content page by adding them to drop zones. For more information, see [Add content to a page](../task/t_AddContentToAPage.md).
