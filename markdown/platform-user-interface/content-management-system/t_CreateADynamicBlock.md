...
For information about Apache Jelly, see [Jelly tags](https://www.servicenow.com/docs/access?context=r_JellyTags&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).

**Note:** Dynamic Content Blocks in Content Management System are not automatically escaped. These blocks must implement their own content escaping \(e.g., to protect against potential Cross Site Scripting attacks\). For more information, see [Jelly escaping types](https://www.servicenow.com/docs/access?context=r_JellyEscapingTypes&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
...
3.  Complete the Dynamic Content form.
    ...
    |Two phase|Select this check box to allow two phase [Extensions to Jelly syntax](https://www.servicenow.com/docs/access?context=c_ExtensionsToJellySyntax&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).|
