...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/content-management-system/c\_CMSIntegrationPoints.html
release: zurich
...
The templates work together to pass data attributes or Unique record identifier \(sys\_id\) \(sysid\) into a single detail page that manages the data. Any attribute variations use the URL sent to the page.
...
-   **[Static methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/content-management-system/c_StaticMethods.md)**  
Static methods in the CMS application were created for ease of use.
-   **[Dynamic methods](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/content-management-system/c_DynamicMethods.md)**  
...
-   **[Example integration points](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/content-management-system/c_IntegrationPointsExample.md)**  
