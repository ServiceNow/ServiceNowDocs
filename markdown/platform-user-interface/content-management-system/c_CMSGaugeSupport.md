...
1.  [You can put a gauge on a CMS page](../task/t_PutAGaugeOnACMSPage.md)
2.  [You can control what will happen when a user clicks on a cell within that gauge](../reference/r_ControlWhatHappensOnAClick.md)
