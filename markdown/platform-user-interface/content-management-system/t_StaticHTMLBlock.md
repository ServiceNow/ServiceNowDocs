...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/content-management-system/t\_StaticHTMLBlock.html
release: zurich
...
3.  Complete the Static Content form.
    ...
    |Frame|Select a border styling for the static HTML block. For more information, see [Format a frame](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/content-management-system/t_Frame.md).|
    ...
    |Static Content|Enter [HTML code](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/c_UseHTMLFields.md) that determines the behavior of the static HTML block.|
