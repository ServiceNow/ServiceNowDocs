...
-   **[Configure a header block](../task/t_HeaderBlock.md)**  
...
-   **[Create a navigation menu block](../task/t_CreateNavigationMenuBlock.md)**  
Navigation menu blocks enable you to create a menu of links to different content pages.
-   **[Configure dynamic blocks](../task/t_CreateADynamicBlock.md)**  
...
-   **[Customize the list block](../task/t_DefineTheListBlock.md)**  
...
-   **[Configure a static HTML block](../task/t_StaticHTMLBlock.md)**  
...
[Format an image as a static HTML block](../task/t_AddAnImageAsAStaticHTMLBlock.md)

[Catalog cart block](../concept/c_CatalogCartBlock.md)

[Integrate Live Feed with CMS](../task/t_AddLiveFeedToIFrame.md)
