...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/content-management-system/t\_DefineTheListBlock.html
release: yokohama
...
Select a list definition UI macro to format the list of links.For more information, see [Configure list definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/content-management-system/t_ConfigureListDefinitions.md).
...
Select a border style for the list block. For more information, see [Create a frame UI macro](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/content-management-system/t_CreateANewFrameUIMacro.md).
...
-   **[Configure list definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/content-management-system/t_ConfigureListDefinitions.md)**  
