...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/replace-colors-with-patterns.html
release: australia
topic_type: concept
...
<table id="table_rns_lby_hgc"><thead><tr><th>
...
Enhances chart clarity and ensures accessibility for users who have color-blindness by incorporating patterns or labels, making visual data easy for everyone to interpret.
...
-   Black-and-white printing users
-   Anyone needing extra clarity in data visualization
