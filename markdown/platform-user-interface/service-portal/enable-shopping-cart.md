...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/service-portal/enable-shopping-cart.html
release: zurich
...
2.  CTRL+right-click a catalog item widget to open the [widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/c_ConfigureWidgetInstances.md).
...
**Parent Topic:**[SC Shopping Cart widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/sc-shopping-cart.md)
