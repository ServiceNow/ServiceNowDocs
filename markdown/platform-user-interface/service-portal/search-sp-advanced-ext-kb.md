...
5.  Add content to the data fetch script field.
    ...
    1.  Define the search function to be executed by the instance.
        ...
        This example uses a [Recordless RESTMessageV2 example](https://www.servicenow.com/docs/access?context=r_RecordlessRESTMessageV2Example&version=zurich&pubname=zurich-api-reference&ft:locale=en-US), but you can modify this example to use a pre-configured [Outbound REST web service](https://www.servicenow.com/docs/access?context=c_OutboundRESTWebService&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) if needed, or create a more secure authentication profile.
        ...
        **Note:** In the preceding example, `ws.setBasicAuth` requires a username and password for the remote instance. For more detail, see [RESTMessageV2 - Scoped, Global](https://www.servicenow.com/docs/access?context=c_RESTMessageV2API&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) .
