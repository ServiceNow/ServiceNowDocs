 ...
 **Note:** To call a UI script within a Validation script, use the g\_ui\_scripts global object. For more information, see [GlideUIScripts](https://www.servicenow.com/docs/access?context=GUIScriptsAPI&version=australia&pubname=australia-api-reference&ft:locale=en-US). Verify that the UI script has the **Global** field set to false and **UI Type** set to Mobile / Service Portal or All.
...
For detailed class and method information, see the [Client API reference](https://www.servicenow.com/docs/access?context=api-client&version=australia&pubname=australia-api-reference&ft:locale=en-US).
