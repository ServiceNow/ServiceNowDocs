...
3.  Select the **Form** icon\[Omitted image "Form\_icon.png"\] Alt text: Form icon to open a new form.
...
-   **[Deferred loading of AI Search assets in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/service-portal/defer-loading-ais-sp.md)**  
