...
For more information on configuring the available facets, see [Create a facet in an AI Search application configuration](https://www.servicenow.com/docs/access?context=create-facet-ais&version=australia&pubname=australia-platform-administration&ft:locale=en-US).
