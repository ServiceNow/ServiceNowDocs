...
For additional information on GlideAjax, refer to [GlideAjax](https://www.servicenow.com/docs/access?context=c_GlideAjaxAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).

 To understand the impact of updating your CMS to work in a mobile environment, review [Mobile client GlideForm \(g form\) scripting and migration](https://www.servicenow.com/docs/access?context=r_MobilePlatformMigrationImpacts&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
