...
-   **Avoid using large data sets to improve performance**
    ...
    -   [spUtil - recordWatch](https://www.servicenow.com/docs/access?context=spUtilAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
    -   [GlideRecord setLimit Function](https://www.servicenow.com/docs/access?context=c_GlideRecordAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
