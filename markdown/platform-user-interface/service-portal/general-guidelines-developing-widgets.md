...
-   **Avoid using large data sets to improve performance**
    ...
    -   [spUtil - recordWatch](https://www.servicenow.com/docs/access?context=spUtilAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
    -   [GlideRecord setLimit Function](https://www.servicenow.com/docs/access?context=c_GlideRecordAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
