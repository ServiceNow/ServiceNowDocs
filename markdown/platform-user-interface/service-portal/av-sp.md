...
**Note:** Antivirus Scanning is a ServiceNow AI Platform feature. For more information, see [Antivirus Scanning](https://www.servicenow.com/docs/access?context=antivirus-protection&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
