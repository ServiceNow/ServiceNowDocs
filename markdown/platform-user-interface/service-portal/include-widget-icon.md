...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/service-portal/include-widget-icon.html
release: zurich
...
\[Omitted image "IconExample.png"\] Alt text: Example matches the HTML with a check circle stating,"you did it!"

## What to do next

To use custom font-icons across widgets, add the icon to a page or make it a widget dependency.

**Parent Topic:**[Create a widget dependency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/widget-dependencies.md)

**Related topics**  


[Include font icons on a page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/t_ConfigureAPage.md)
