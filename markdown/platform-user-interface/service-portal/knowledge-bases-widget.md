...
For example, if a user selects to browse only the IT knowledge base, then the [KB Categories widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/service-portal/kb-categories-widget.md) shows only the categories within the IT knowledge base.
...
For more information on associating your portal with knowledge bases, see [Associate a portal with a knowledge base](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/service-portal/associate-portal-knowledge.md).
