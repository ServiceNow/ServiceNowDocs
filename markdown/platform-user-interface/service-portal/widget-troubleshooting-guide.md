...
[gs.log\(\)](https://www.servicenow.com/docs/access?context=c_GlideSystemAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[gs.warn\(\)](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[gs.error\(\)](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[gs.addInfoMessage\(\)](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[gs.addErrorMessage\(\)](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[spUtil.addErrorMessage\(\)](https://www.servicenow.com/docs/access?context=spUtilAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[spUtil.addInfoMessage\(\)](https://www.servicenow.com/docs/access?context=spUtilAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[spUtil.addTrivialMessage\(\)](https://www.servicenow.com/docs/access?context=spUtilAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[debugger](https://www.servicenow.com/docs/access?context=script-debugger&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
