...
-   **Determine the cause of performance issues**
    ...
    -   Determine if the issue is related to the portal or platform-wide by comparing the functionality in both interfaces. For more information about platform performance issues, see [Platform performance](https://www.servicenow.com/docs/access?context=platform-performance-landing&version=australia&pubname=australia-platform-administration&ft:locale=en-US).
...
[gs.log\(\)](https://www.servicenow.com/docs/access?context=c_GlideSystemAPI&version=australia&pubname=australia-api-reference&ft:locale=en-US)
...
[gs.warn\(\)](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=australia&pubname=australia-api-reference&ft:locale=en-US)
...
[gs.error\(\)](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=australia&pubname=australia-api-reference&ft:locale=en-US)
...
[gs.addInfoMessage\(\)](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=australia&pubname=australia-api-reference&ft:locale=en-US)
...
[gs.addErrorMessage\(\)](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=australia&pubname=australia-api-reference&ft:locale=en-US)
...
[spUtil.addErrorMessage\(\)](https://www.servicenow.com/docs/access?context=spUtilAPI&version=australia&pubname=australia-api-reference&ft:locale=en-US)
...
[spUtil.addInfoMessage\(\)](https://www.servicenow.com/docs/access?context=spUtilAPI&version=australia&pubname=australia-api-reference&ft:locale=en-US)
...
[spUtil.addTrivialMessage\(\)](https://www.servicenow.com/docs/access?context=spUtilAPI&version=australia&pubname=australia-api-reference&ft:locale=en-US)
...
[debugger](https://www.servicenow.com/docs/access?context=script-debugger&version=australia&pubname=australia-api-reference&ft:locale=en-US)
