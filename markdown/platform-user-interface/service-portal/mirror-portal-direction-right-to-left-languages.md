...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/service-portal/mirror-portal-direction-right-to-left-languages.html
release: australia
...
5.  If you use an external CSS library for your portal theme, provide your own CSS that mirrors the direction of a portal's user interface to override the automatically generated CSS.
    ...
    3.  In the **CSS Includes** related list, select the CSS Include that links to an external CSS library URL.
        ...
        If you need to create a new CSS Include, see [Create a portal theme](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/service-portal/c_CustomCSS.md).
...
**Parent Topic:**[Styling for right-to-left languages in portals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/service-portal/styling-right-to-left-languages.md)
