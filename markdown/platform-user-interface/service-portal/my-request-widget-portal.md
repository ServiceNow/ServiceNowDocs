...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/service-portal/my-request-widget-portal.html
release: yokohama
...
Use the widget instance options to customize the settings for the My Requests widget. To customize the settings for this widget, press the Ctrl key, click on the widget, and select **Instance Options**.
...
-   **[Enable the My Requests menu for an upgrade scenario](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/enable-requests-menu.md)**  
