...
</table>You can create custom events to be triggered. For more information, see [SNAnalytics - Client](https://www.servicenow.com/docs/access?context=SNAnalyticsClientAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
