...
User Experience Analytics automatically detects the gestures and actions of portal users. You can view each occurrence of these events on the Analytics Dashboard.
...
</table>You can create custom events to be triggered. For more information, see [SNAnalytics - Client](https://www.servicenow.com/docs/access?context=SNAnalyticsClientAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
