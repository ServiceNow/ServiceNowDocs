...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/service-portal/data-table-url-widget.html
release: yokohama
...
For more information on using the condition builder, see [Create a filter in List](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/t_CreatingFilters.md).
