...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/service-portal/announcements-widget.html
release: zurich
...
Control who can and cannot view a widget instance with [user criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/user-criteria.md). Only visible if user criteria for the Service Portal is activated.

</td></tr></tbody>
</table>**Parent Topic:**[Example widgets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/service-portal/sp-example-widgets.md)
