...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/service-portal/announcements-widget.html
release: yokohama
...
Control who can and cannot view a widget instance with [user criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/user-criteria.md). Only visible if user criteria for the Service Portal is activated.

</td></tr></tbody>
</table>**Parent Topic:**[Example widgets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/sp-example-widgets.md)
