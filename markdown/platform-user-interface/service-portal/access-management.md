...
description: Automate access management request fulfillment using the Service Catalog or Service Portal. The catalog items and flows support requests in Okta, Microsoft Entra ID \(formerly Microsoft Azure AD\), and Microsoft Active Directory.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/service-portal/access-management.html
release: xanadu
...
|Microsoft Entra ID \(formerly Microsoft Azure AD\)|Delete Microsoft Entra ID User|Deletes the specified user from Microsoft Entra ID.|
