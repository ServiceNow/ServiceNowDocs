...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/service-portal/standard-ticket-page.html
release: xanadu
...
-   Associated Requests. Displays all associated requests \(visible in the **My Requests** widget in Service Portal\) for which the current ticket is the parent. It is applicable in any of the following scenarios:
    ...
    For information on defining filters for the My Requests widget, see [Define filters for My Requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/service-catalog/configure-my-requests.md).
...
-   **[Configure the standard ticket page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/configure-st-page.md)**  
...
-   **[Activate the page route map for the standard ticket page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/config-pageroutemap-stpage.md)**  
...
[Standard ticket page for a requested item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/service-catalog/stpage-req-item.md)

[Incident standard ticket page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/incident-management/incident-stnd-ticket-page.md)
