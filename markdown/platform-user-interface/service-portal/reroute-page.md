...
To redirect all references to a page, create a record in the Page Route Maps table \[sp\_page\_route\_map\]. This table enables you to redirect a reference to a page without cloning base system widgets.
