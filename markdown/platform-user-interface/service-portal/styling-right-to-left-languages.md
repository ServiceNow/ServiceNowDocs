...
![Service Portal user interface direction mirrored with Hebrew as the session language](../image/right-to-left-portal.png "Service Portal direction mirrored for Hebrew")
