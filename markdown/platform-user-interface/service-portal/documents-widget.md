...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/service-portal/documents-widget.html
release: zurich
...
**Note:** The Documents widget is available with the Multi Provider Document Services Framework plugin \(com.snc.multiprovider\_documents\). For more information, see .
...
\[Omitted image "documents-widget.png"\] Alt text: Related Documents widget
