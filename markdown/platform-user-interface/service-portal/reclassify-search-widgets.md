...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/service-portal/reclassify-search-widgets.html
release: xanadu
...
1.  [Enable and configure AI Search in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/enable-ais-sp.md)
2.  Run the Portal Analyzer to identify all cloned or customized search widgets. For more information, see [Portal Analyzer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/portal-analyzer.md).
...
**Parent Topic:**[Enable and configure AI Search in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/enable-ais-sp.md)
