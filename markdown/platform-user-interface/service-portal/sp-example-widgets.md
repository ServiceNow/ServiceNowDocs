...
-   **[Announcements widget](announcements-widget.md)**  
...
-   **[Approvals widget](approvals-widget.md)**  
...
-   **[Approval Info Record widget](approval-info-record-widget.md)**  
...
-   **[Approval Info widget](approval-info-widget.md)**  
...
-   **[Approval Record widget](approval-record-widget.md)**  
...
-   **[Breadcrumbs widget](breadcrumbs-widget.md)**  
...
-   **[Breakout Game widget](breakout-game-widget.md)**  
...
-   **[Calculator widget](calculator-widget.md)**  
...
-   **[Carousel widget](carousel-widget.md)**  
...
-   **[Change Password widget](change-password-widget.md)**  
Users can change their passwords using the Change Password widget.
-   **[Cool Clock widget](cool-clock-widget.md)**  
...
-   **[Data table from instance definition widget](data-table-widget.md)**  
...
-   **[Data Table from URL definition widget](data-table-url-widget.md)**  
...
-   **[Documents widget](documents-widget.md)**  
...
-   **[Header menu widget](header-widget.md)**  
...
-   **[Hello World widgets](hello-world-widget.md)**  
...
-   **[Icon Link widget](icon-link-widget.md)**  
...
-   **[Icon menu list widget](icon-menu-list-widget.md)**  
...
-   **[Language Switch widget](language-switch-widget.md)**  
...
-   **[Link button widget](link-button-widget.md)**  
...
-   **[My Requests widget](my-requests-widget.md)**  
...
-   **[New Organization Chart widget](new-organization-chart-widget.md)**  
...
-   **[Simple List widget](simple-list-widget.md)**  
...
-   **[Sample Footer widget](sample-footer-widget.md)**  
...
-   **[Ticket Attachments widget](ticket-attachment-widget.md)**  
...
-   **[Ticket Conversations widget](ticket-conversations-widget.md)**  
...
-   **[Ticket Fields widget](ticket-fields-widget.md)**  
...
-   **[Ticket Location widget](ticket-location-widget.md)**  
...
-   **[User Profile widget](user-profile-widget.md)**  
...
**Parent Topic:**[Widget library](widget-showcase.md)
