...
If Service Portal \[com.glide.service-portal.esm\] is not active on your instance, you can activate by following the [Activate a plugin](https://www.servicenow.com/docs/access?context=t_ActivateAPlugin&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) instructions.
