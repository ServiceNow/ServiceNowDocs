...
Defines how search results are displayed in the portal. For more information on defining a search results configuration, see [Define a composite dataset](https://www.servicenow.com/docs/access?context=define-composite-dataset&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
