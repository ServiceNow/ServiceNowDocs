...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/service-portal/create-a-portal.html
release: xanadu
...
Turn off access to a portal that you no longer want users to visit and optionally redirect them to another portal. For more information, see [Deactivate a portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/deactivate-portal.md).
...
Option to enable AI Search in your portal. For more information, see [AI Search in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/ai-search.md).
...
4.  In the Knowledge Bases related list, select **Edit** and then select which knowledge bases appear for the knowledge base page.
    ...
    For example, if you select **IT** and **Instance Security Center**, only the article categories defined for these knowledge bases appear in the [KB categories widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/kb-categories-widget.md).
...
-   **[Assign a homepage to a portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/assign-portal-homepage.md)**  
Edit your portal record to specify any page as your homepage.
-   **[Assign a default error page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/create-a-default-404-page.md)**  
Create a default 404 error page for your portal using a system property.
-   **[Configure a portal header menu](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/configure-header-menu.md)**  
...
-   **[Configure a catalog in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/associate-portal-catalog.md)**  
Associate a portal with multiple catalogs. By default, Service Portal is associated with Service Catalog.
-   **[Associate a portal with a knowledge base](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/associate-portal-knowledge.md)**  
You can associate a portal with any knowledge base. Multiple knowledge bases can be associated with a portal.
-   **[Configure Agent Chat in a portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/configure-va-in-sp.md)**  
...
**Parent Topic:**[Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/c_ServicePortal.md)
