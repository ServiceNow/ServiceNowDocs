...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/service-portal/sp-what-to-know.html
release: australia
...
-   [Themes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/service-portal/c_BrandingEditor.md): Themes define the look and feel of the whole portal, but can be overridden by other style configurations.
-   [Pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/service-portal/c_Pages.md): Pages control where and how you store portal content. Pages have no defined relationship to portal records, they simply exist.
...
-   **[Service Portal core concepts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/service-portal/c_CoreConcepts.md)**  
...
-   **[Service Portal configuration page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/service-portal/service-portal-configuration-page.md)**  
Most Service Portal configuration is accessible through the Service Portal configuration page landing page.
-   **[Page navigation in Service Portal by URL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/service-portal/navigate-by-portal-url.md)**  
You can navigate to a portal or a page in Service Portal using a URL.
-   **[Content Management and Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/service-portal/c_CMSAndSP.md)**  
...
**Parent Topic:**[Exploring Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/service-portal/exploring-service-portal.md)
