...
-   Activate and configure the [AWS CloudFormation spoke](https://www.servicenow.com/docs/access?context=aws-cloudformation&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
