...
4.  If the search source is advanced, modify the data fetch script to handle multiple search result pages.
    ...
    |Scope|Method|
    |-----|------|
    |Global|setLocation\(\) in [GlideRecord - Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/server-api-reference/c_GlideRecordAPI.md)|
    |Scoped application|chooseWindow\(\) in [GlideRecord - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/server-api-reference/c_GlideRecordScopedAPI.md)|
