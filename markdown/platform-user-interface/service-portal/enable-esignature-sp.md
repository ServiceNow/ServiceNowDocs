...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/service-portal/enable-esignature-sp.html
release: xanadu
...
1.  Enter the spEsignatureCustom script.
    ...
    5.  Paste the [spEsignatureCustom script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/enable-esignature-sp.md) in the **Script** field.
...
2.  Enter the spAuthCustom script.
    ...
    4.  Paste the [spAuthCustom script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/enable-esignature-sp.md) in the **Script** field.
