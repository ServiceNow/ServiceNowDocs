...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/service-portal/ais-sp-css-vars.html
release: xanadu
...
breadcrumb: [Create a CSS include to override theming for AI Search in Service Portal, AI Search in Service Portal, Configuring search in a portal, Configuring Service Portal, Service Portal, Configure UIs and portals, Configure user experiences]
---
...
-   [Create a CSS include to override theming for AI Search in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/css-override-ais-theming-sp.md)
...
*$now-sp-display-type--secondary--color*
...
Differentiates the radius for button and search bat buttons.
...
</table>**Parent Topic:**[Create a CSS include to override theming for AI Search in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/css-override-ais-theming-sp.md)
