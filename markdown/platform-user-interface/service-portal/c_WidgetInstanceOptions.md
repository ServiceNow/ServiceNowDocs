...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/service-portal/c\_WidgetInstanceOptions.html
release: xanadu
...
7.  Test the option schema by adding the widget to a page in the Service Portal Designer.
    ...
    3.  [Configure the widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-user-interface/service-portal/c_ConfigureWidgetInstances.md).
