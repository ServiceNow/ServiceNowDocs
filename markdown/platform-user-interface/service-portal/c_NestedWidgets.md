...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/service-portal/c\_NestedWidgets.html
release: yokohama
...
Use [spUtil.get\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/spUtilAPI.md) to get a widget model in the client script.
...
Use [$sp.getWidget\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/server-api-reference/c_GlideSPScriptableScopedAPI.md) to get a widget model in the server script.
