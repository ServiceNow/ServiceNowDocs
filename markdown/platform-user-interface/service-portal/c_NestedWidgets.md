...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-user-interface/service-portal/c\_NestedWidgets.html
release: xanadu
...
Use [spUtil.get\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/spUtilAPI.md) to get a widget model in the client script.
...
Use [$sp.getWidget\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/server-api-reference/c_GlideSPScriptableScopedAPI.md) to get a widget model in the server script.
