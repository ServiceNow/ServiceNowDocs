...
-   Multifactor authentication: If an instance is configured to require multifactor authentication, users are automatically directed to set up multifactor authentication upon initial login. For setup instructions, see [Setup multi-factor authentication upon initial login](https://www.servicenow.com/docs/access?context=t_SetUpMultiFactorAuthUponLogin&version=australia&pubname=australia-platform-security&ft:locale=en-US). If multifactor authentication is optional, users can still enable or disable authentication from their user profile. For setup instructions, see [Setup multi-factor authentication on your user profile](https://www.servicenow.com/docs/access?context=mfa-setup-profile&version=australia&pubname=australia-platform-security&ft:locale=en-US).
