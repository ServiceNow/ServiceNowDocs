...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-user-interface/service-portal/announcements.html
release: brazil
...
-   **Sort order**
    ...
    -   The **glide.service\_portal.announcement.default\_sort\_order** system property. See [Service Portal properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/service-portal/properties-service-portal.md).
...
-   **Display location**
    ...
    -   Announcement banner
    -   [Announcements widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/service-portal/announcements-widget.md) instance
...
-   **[Create an announcement display style](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/service-portal/create-announcement-style.md)**  
Define the background color, foreground color, and text alignment of an announcement.
-   **[Create an announcement type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/service-portal/add-announcement-type.md)**  
