...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-user-interface/service-portal/zing-search-service-portal.html
release: yokohama
...
-   **Simple**
    ...
    Define a table within your ServiceNow instance as a source of searchable data. To learn more, see [Define a search source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/add-table-search-source.md).

    When you create a simple search source, Service Portal uses the search engine settings configured on your instance. To learn more, see [Zing text indexing and search engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/c_ZingTextSearch.md).
...
-   **Advanced**
    ...
    |API|Use|
    |---|---|
    |[SPScriptedFacetService - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/server-api-reference/SPScriptedFacetServiceScopedAPI.md)|Creates a single or multi choice facet.|
    |[SPScriptedFacet - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/server-api-reference/SPScriptedFacetScopedAPI.md)|Defines facet items, filters, or mapped queries for the facet.|


-   **[Define a search source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/add-table-search-source.md)**  
...
-   **[Enable search facets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/enable-facets.md)**  
...
-   **[Add facets to a simple search source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/create-search-filter.md)**  
...
-   **[Disable facets for a search source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/disable-search-facets.md)**  
...
-   **[Populate search suggestions in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/populate-search-suggestions-sp.md)**  
...
-   **[Add a text index group to a portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/create-text-index-group.md)**  
...
-   **[Set the default portal search source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/default-search-sources.md)**  
Use the **glide.service\_portal.default\_search\_sources** system property to define default search sources.
-   **[Configure Search Sources available on a page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-user-interface/service-portal/configure-contextual-search.md)**  
