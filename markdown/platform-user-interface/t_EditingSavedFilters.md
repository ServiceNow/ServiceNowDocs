...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/t\_EditingSavedFilters.html
release: zurich
topic_type: task
...
**Note:** The following procedure is intended for administrators. Users with other role types should instead refer to [Save and use filters in a list view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/t_SavingFilters.md).
