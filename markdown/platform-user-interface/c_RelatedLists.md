...
-   **[Select or create records in a related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_SelectRelatedRecords.md)**  
...
-   **[Configure when a related list loads](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_ConfigureWhenARelatedListLoads.md)**  
...
-   **[Create a default filter for a related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_CreateADefaultFilter.md)**  
Create a default filter for the records that load when your related list displays.
-   **[Configure the edit option](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_ConfigureTheEditOption.md)**  
You can configure the edit option that allows users to add records to related lists in forms.
-   **[Create defined related lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_CreateDefinedRelatedLists.md)**  
You can add default related lists to the form for all users to see when viewing records.
-   **[Add fields to selections in a related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_AddingFieldsToARelatedList.md)**  
...
-   **[Create a default filter for list selector records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_CreateDefaultRelatedRecSecFilter.md)**  
...
[Configure form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/configure-form-layout.md)

[Lists in the classic environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_UseLists.md)
