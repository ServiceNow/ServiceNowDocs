...
-   Options specific to features such as [Live Feed](https://www.servicenow.com/docs/access?context=c_GetStartedWithLiveFeed&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) and [Visual Task Boards](../../visual-task-boards/concept/c_VisualTaskBoards.md).
