...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-user-interface/remove-welcome-splash-screen.html
release: zurich
topic_type: task
...
<table id="choicetable_h1c_4hh_jw"><tbody><tr><td id="d151121e120">
...
**Parent Topic:**[User preferences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-user-interface/c_UserPreferences.md)
