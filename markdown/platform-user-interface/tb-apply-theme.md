...
If you want to publish a theme to specific mobile applications, you can use [Mobile App Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/mobile/mab-concept.md). Any themes that are created using Theme Builder are available for publishing in [Mobile App Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/mobile/mab-concept.md).
...
<table id="choicetable_ahh_ch2_fdc"><thead><tr><th align="left" id="d120012e134">

Option

</th><th align="left" id="d120012e137">

Description

</th></tr></thead><tbody><tr><td id="d120012e143">
