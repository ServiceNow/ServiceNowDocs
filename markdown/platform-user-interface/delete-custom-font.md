...
5.  Select **Delete**.
    ...
    ![Custom font family preview modal with Delete button selected.](../image/tb-custom-font-delete-modal.png "Custom font family preview modal with delete option")
