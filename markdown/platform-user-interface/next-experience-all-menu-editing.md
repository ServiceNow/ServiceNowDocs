---
title: Next Experience All Menu Editing
description: Create and edit application menus and modules directly in the Platform All menu.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-user-interface/next-experience-all-menu-editing.html
release: australia
topic_type: concept
...
**Note:** Administrators can disable Next Experience All Menu Editing for their organization by setting a system user preference. When turned off, administrators use the classic UI16 configuration workflow for application menus and modules.
...
\[Omitted image "neame-ui.png"\] Alt text: Next Experience All Menu editor displays the select list module in the preview pane.
...
\[Omitted image "neame-app-menu-ui.png"\] Alt text: Next Experience All Menu editor displays the application menu configuration fields.
...
\[Omitted image "neame-edit-module-ui.png"\] Alt text: Next Experience All Menu editor showing the new record module configuration screen.
...
-   **[Create a Next Experience Menu Application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/next-experience-create-menu-application.md)**  
Create and configure application menus and modules directly within the All menu.
-   **[Create a Dashboard Module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/next-experience-dashboard-module.md)**  
Create custom dashboards for the All menu using the Next Experience All Menu Editor.
-   **[Create a List Module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/next-experience-list-module.md)**  
Create custom lists for the All menu using the Next Experience All Menu Editing.
-   **[Create a New Record module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/next-experience-new-record-module.md)**  
Create custom New Record form for the All menu using the Next Experience All Menu Editing.
-   **[Create a Single Record Module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-user-interface/next-experience-single-record-module.md)**  
