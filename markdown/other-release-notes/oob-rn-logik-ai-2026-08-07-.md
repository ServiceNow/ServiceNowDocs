...
|Sector|Upgrade|
|------|-------|
|Demo|Thursday, Aug 06, 2026, 8 pm CT|
|Test|Thursday, Aug 06, 2026, 8 pm CT|
|Prod|Friday, Aug 14, 2026, 8 pm CT|

Example: an environment with URL https://\[YourLogikURL\].prod.logik.io receives this build Aug 14, 2026.
...
|---|-----------------|
|PRB2037358|Fixed issue where pricing enrichment combined with the pricing matrix caused values ending in zero to display in scientific notation.|
|PRB2039445|Fixed issue where pricing was not appearing in the configurator.|
|PRB2040203|Added pagination and scroll support for the dynamic pick list table selection.|
