...
|[Event Logs](https://www.servicenow.com/docs/access?context=event-logs-2&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)|All system events that occur within the system.|
...
|[Outbound web services logging](https://www.servicenow.com/docs/access?context=outbound-request-logging&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)|All outbound web services requests such as REST and SOAP requests.|
|[Signature Images](https://www.servicenow.com/docs/access?context=signature-pad&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US)|Electronic signatures for the HR signature pad.|
