...
|[System](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/r_SystemLogs.md)|Warnings and errors for instance processes, records, and non-critical events, such as memory usage on the server machine.|

Use the [Log File Browser](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/r_LogUtilities.md) to search and download logs. You can also search archived logs in the [log history](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/r_LogHistory.md).

## Other logs

Your instance offers other logs in addition to those in the System Logs module. For example, the [System Diagnostics module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/c_SystemDiagnosticsApplication.md) provides upgrade history and slow query logs, which you can use to gain insight into how queries are affecting platform performance. The [Customer Updates table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/r_CustomerUpdatesTable.md) records every change that is made in the system.
