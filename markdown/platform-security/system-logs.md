...
|[Event Logs](https://www.servicenow.com/docs/access?context=event-logs-2&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)|All system events that occur within the system.|
...
|[Outbound web services logging](https://www.servicenow.com/docs/access?context=outbound-request-logging&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)|All outbound web services requests such as REST and SOAP requests.|
|[Signature Images](https://www.servicenow.com/docs/access?context=signature-pad&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US)|Electronic signatures for the HR signature pad.|
