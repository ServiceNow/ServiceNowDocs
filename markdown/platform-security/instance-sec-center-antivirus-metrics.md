...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/instance-sec-center-antivirus-metrics.html
release: yokohama
topic_type: concept
...
-   To view the following breakdowns in the Analytics Hub page, click \[Omitted image "Breakdown\_icon.png"\] Alt text: Breakdown icon, then click:
...
**Note:** You can also add **Quarantined Files** and **Virus Types** tiles to the Event ribbon. To learn more, see [Monitor security events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/instance-sec-center-event-ribbon.md) and [Configure the security event ribbon](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/instance-sec-center-configure-event-ribbon.md).

**Parent Topic:**[Monitor instance metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/monitoring-user-email-antivirus-metrics.md)

**Related topics**  


[Antivirus Scanning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/antivirus-protection.md)

[Configuring Antivirus Scanning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/configure-antivirus-protection.md)

[Reviewing quarantined files](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/resolve-infected-file.md)

[Reviewing antivirus activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/generate-log-report-of-quarantined-files.md)
...
[Performance Analytics breakdowns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/c_CreatingBreakdowns.md)

[Analytics, Intelligence, and Reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/c_performanceAnalyticsAndReporting.md)
