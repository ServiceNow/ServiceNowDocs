...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/instance-sec-center-configure-event-ribbon.html
release: zurich
topic_type: task
...
**Note:** To learn about the types of security events that appear in the event ribbon, see [Monitor security events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/instance-sec-center-event-ribbon.md).
