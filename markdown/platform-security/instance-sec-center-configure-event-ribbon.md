...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/instance-sec-center-configure-event-ribbon.html
release: yokohama
topic_type: task
...
**Note:** To learn about the types of security events that appear in the event ribbon, see [Monitor security events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/instance-sec-center-event-ribbon.md).
