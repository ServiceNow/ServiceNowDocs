...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/bp-no-domain-path-in-scripts.html
release: yokohama
topic_type: concept
...
To learn more about domain path, see [Request domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/t_ActivateDomainSeparation.md) and [Domain Separation Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/domain-separation-center.md).
