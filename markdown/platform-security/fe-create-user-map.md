...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/fe-create-user-map.html
release: australia
topic_type: task
