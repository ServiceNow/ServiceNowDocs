...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/multiple-module-access-policies.html
release: yokohama
topic_type: task
...
2.  Navigate to **System Security** &gt; **Column Level Encryption** &gt; **Encrypted Field Configurations**.

    If you need more information on Encrypted Field Configurations, see [Set encrypted field configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/set-encrypted-field-config.md).
...
4.  Select **Multiple Modules** in the **Method** field.
    ...
    \[Omitted image "select-multi-modules.png"\] Alt text: Multiple Modules selected as the method Encrypted Field Configurations.
