...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/instance-sec-center-export-metrics.html
release: xanadu
topic_type: concept
...
-   **[Export metrics settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/isc-export-metrics-settings.md)**  
