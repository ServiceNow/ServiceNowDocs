...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/bp-domain-sep-hierarchies.html
release: zurich
...
To learn more about hierarchy architecture, see [Service provider reference architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-sp-reference-arch-ds.md).
