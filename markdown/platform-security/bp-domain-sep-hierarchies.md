...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/bp-domain-sep-hierarchies.html
release: yokohama
...
To learn more about hierarchy architecture, see [Service provider reference architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/bp-sp-reference-arch-ds.md).
