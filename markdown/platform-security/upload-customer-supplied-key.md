...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/upload-customer-supplied-key.html
release: xanadu
topic_type: task
...
If you’re NOT supplying your own keys, you don’t need to perform this procedure. To create a cryptographic module with ServiceNow® keys, go to [Create a cryptographic module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/platform-encryption/create-cryptographic-module.md) or [Create cryptographic module for Column Level Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/create-PE-cryptographic-module.md).

**Note:** This procedure only applies to Column Level Encryption Enterprise functionality. See [Activate Column Level Encryption Enterprise](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/activate-platform-encryption.md) for more information.
...
3.  Return to **System Security** &gt; **Field Encryption Modules** &gt; **** &gt; **Create New**.
    ...
    \[Omitted image "pe-cryptomodule.png"\] Alt text: Column Level Encryption create crypto module form.
...
10. Run the BYOK command on a terminal to wrap the key.
    ...
    For more information, refer to [Wrap your customer-supplied key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/wrap-customer-supplied-key.md).
...
Now that you have finished configuring your cryptographic module with your customer-supplied key, move on to [Create a module access policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/platform-encryption/create-module-access-policy.md)
