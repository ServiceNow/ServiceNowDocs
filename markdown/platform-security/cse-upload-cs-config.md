...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/cse-upload-cs-config.html
release: australia
topic_type: task
...
You also need the configuration file generated in the steps detailed in [Configure Code Signing Enterprise on your trusted instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/cse-turn-on-cse.md).
