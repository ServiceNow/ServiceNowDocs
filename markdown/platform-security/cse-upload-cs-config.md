...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/cse-upload-cs-config.html
release: yokohama
topic_type: task
...
You also need the configuration file generated in the steps detailed in [Configure Code Signing Enterprise on your trusted instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/cse-turn-on-cse.md).
