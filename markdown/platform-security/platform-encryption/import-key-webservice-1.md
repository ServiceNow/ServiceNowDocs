...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/platform-encryption/import-key-webservice-1.html
release: australia
...
5.  Select an appropriate algorithm that aligns with asymmetric key material for the imported keystore.
    ...
    See [Cryptographic specification overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/platform-encryption/cryptographic-purpose.md) for additional information.
...
<table id="choicetable_wgh_zgb_fqb"><thead><tr><th align="left" id="d97988e407">

Option

</th><th align="left" id="d97988e410">

Value/Format

</th></tr></thead><tbody><tr><td id="d97988e416">
