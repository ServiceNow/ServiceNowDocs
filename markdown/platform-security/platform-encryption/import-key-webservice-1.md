...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/platform-encryption/import-key-webservice-1.html
release: xanadu
...
5.  Select an appropriate algorithm that aligns with asymmetric key material for the imported keystore.
    ...
    See [Cryptographic specification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/platform-encryption/cryptographic-purpose.md) for additional information.
...
<table id="choicetable_wgh_zgb_fqb"><thead><tr><th align="left" id="d55203e407">

Option

</th><th align="left" id="d55203e410">

Value/Format

</th></tr></thead><tbody><tr><td id="d55203e416">
