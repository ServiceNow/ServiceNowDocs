...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/platform-encryption/kmf\_diagnostics.html
release: yokohama
...
For additional information on subcomponents, see [Instance level keys in the Key Management Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/platform-encryption/instance-level-keys.md).
