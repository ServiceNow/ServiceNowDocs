...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/platform-encryption/kmf\_diagnostics.html
release: xanadu
...
For additional information on subcomponents, see [Instance level keys in the Key Management Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/platform-encryption/instance-level-keys.md).
