...
-   Click **Next** to create a cryptographic key. See one of the following tasks for key generation:
    ...
    -   [Configure properties for customer-supplied keys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/customer-supplied-keys.md).
