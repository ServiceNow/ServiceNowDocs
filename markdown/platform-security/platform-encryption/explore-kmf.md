...
-   **Cryptographic modules**
    ...
    Module access policies are found by navigating to **All** &gt; **Key Management** &gt; **Cryptographic Modules** &gt; **All**. For more information on these modules, see [Cryptographic module overview](../../key-management-framework/concept/crypto-module-overview.md).
...
-   **Module keys**
    ...
    You can access the module keys for a cryptographic module in the **Module Keys** related list in cryptographic module records. For more information on module keys, see [Instance level keys in the Key Management Framework](../../key-management-framework/reference/instance-level-keys.md).
...
-   **Cryptographic specifications**
    ...
    You can access the module keys for a cryptographic module in the **Crypto Specifications** related list in cryptographic module records. For more information on module keys, see [Cryptographic specification overview](../../key-management-framework/concept/cryptographic-purpose.md).
...
-   **Module access policies**
    ...
    Find module access policies by selecting the **View access policies** link in cryptographic module records. For more information, see [Module access policy overview](../../key-management-framework/concept/module_access_policy_overview.md).
...
-   **[Cryptographic specification overview](../../key-management-framework/concept/cryptographic-purpose.md)**  
