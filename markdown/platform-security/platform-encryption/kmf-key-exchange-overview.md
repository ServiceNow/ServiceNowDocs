...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/platform-encryption/kmf-key-exchange-overview.html
release: xanadu
...
This functionality is included with the Key Management Framework, which is included in the ServiceNow Platform Encryption subscription bundle. For details on this product, see [Key Management Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/encryption.md).

## Using Key Exchange

Administrators who use KMF for Column Level Encryption can use Key Exchange to clone the keys between production instances when performing data cloning. In data cloning, the administrator/ KMF cryptographic manager can perform the following:
