...
This functionality is included with the Key Management Framework, which is included in the ServiceNow Platform Encryption subscription bundle. For details on this product, see [Key Management Framework](../../encryption/concept/encryption.md).
