...
**Note:** If the **sn\_infra\_sec.syoc.enabled** property isn’t available on your instance, you must create it. For details on this process see Add a system property.
