---
title: Creating subject criteria
description: Create subject criteria records for use in data filtration rules.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/df-create-criteria.html
release: yokohama
topic_type: task
...
**Important:** To create or modify data filtration rules you, must elevate to a privileged role. For details on this process, see [Elevate to a privileged role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/t_ElevateToAPrivilegedRole.md).
