...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/bp-domain-levels.html
release: zurich
...
</table>To view all applications listed by their support level see [Application support for domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/domain-separated-apps.md).
