...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/migrate-sigs-customer-rot.html
release: xanadu
topic_type: task
...
To continue the Root of Trust configuration process, see [Disable ServiceNow Root of Trust](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/disable-sn-rot.md).

**Parent Topic:**[Change your Root of Trust configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/change-rot-overview.md)
