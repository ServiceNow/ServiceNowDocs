...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/migrate-sigs-customer-rot.html
release: yokohama
topic_type: task
...
To continue the Root of Trust configuration process, see [Disable ServiceNow Root of Trust](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/disable-sn-rot.md).

**Parent Topic:**[Change your Root of Trust configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/change-rot-overview.md)
