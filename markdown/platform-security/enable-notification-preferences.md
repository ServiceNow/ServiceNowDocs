...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/enable-notification-preferences.html
release: zurich
topic_type: task
...
Send the selected type of notification whenever another user is impersonating you.To learn more about impersonating users, see [Impersonate a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/user-administration/c_ImpersonateAUser.md).
...
<table id="choicetable_amb_lb4_mnb"><thead><tr><th align="left" id="d32877e212">

Check box

</th><th align="left" id="d32877e215">

Description

</th></tr></thead><tbody><tr><td id="d32877e221">
...
**Parent Topic:**[Monitor security events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/instance-sec-center-event-ribbon.md)
