...
Send the selected type of notification whenever another user is impersonating you.To learn more about impersonating users, see [Impersonate a user](https://www.servicenow.com/docs/access?context=c_ImpersonateAUser&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
<table id="choicetable_amb_lb4_mnb"><thead><tr><th align="left" id="d30279e212">

Check box

</th><th align="left" id="d30279e215">

Description

</th></tr></thead><tbody><tr><td id="d30279e221">
