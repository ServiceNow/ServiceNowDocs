...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/script-map.html
release: yokohama
topic_type: concept
...
-   **[Configure script access to encrypted data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/configure-script-encryption.md)**  
