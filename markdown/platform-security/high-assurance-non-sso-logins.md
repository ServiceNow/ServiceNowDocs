...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/high-assurance-non-sso-logins.html
release: yokohama
topic_type: concept
...
After successful authentication, the protected data is displayed to the users for a certain time frame. You can configure the properties to change the time limit based on your requirement. To know more, see [High Assurance Continuous Authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/high-assurance-ca.md).
