...
Inbound emails are scanned for viruses by the system [email filters](https://www.servicenow.com/docs/access?context=c_EmailFilters&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US), not by Antivirus Scanning.
