...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/bp-db-query-with-ds.html
release: yokohama
topic_type: concept
...
To learn more about contextual security, see [Context and domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/bp-domain-sep-context.md).
