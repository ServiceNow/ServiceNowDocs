...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/edge-encryption/configure-cyberark-prop-protection.html
release: australia
...
**Previous topic:**[Install the Edge Encryption proxy server \(interactive installer\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/install-proxy.md)

**Next topic:**[Configure the signature key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/configure-sig-key.md)
