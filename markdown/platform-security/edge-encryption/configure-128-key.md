...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/edge-encryption/configure-128-key.html
release: australia
...
If you are updating an SSL certificate on an Edge proxy server, see [Update SSL certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/update-ssl-certificate.md).

## Procedure

1.  Select the encryption key location.

<table id="choicetable_hj2_b1p_gfb"><thead><tr><th align="left" id="d146153e93">

Option

</th><th align="left" id="d146153e96">

Description

</th></tr></thead><tbody><tr><td id="d146153e102">

**File Store**

</td><td>

Use a file to store a single encryption key. You can use an existing file in the `/keys` directory, or you can generate a new file. To generate a new file, enter an alias and click **Generate**. A file containing an encryption key is created.**Note:** This choice designates both the storage location and the encryption key. If you select **File Store**, click **Next** and go to [step 5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/configure-128-key.md).

</td></tr><tr><td id="d146153e130">
...
<table id="choicetable_trt_g1p_gfb"><thead><tr><th align="left" id="d146153e166">

Option

</th><th align="left" id="d146153e169">

Description

</th></tr></thead><tbody><tr><td id="d146153e175">
...
**Previous topic:**[Configure the HTTPS certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/configure-cert.md)

**Next topic:**[Configure the AES 256-bit encryption key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/configure-256-key.md)
