...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/edge-encryption/c\_JsonNodeAPI.html
release: brazil
...
You can access a JsonNode object by calling [getAsJsonContent\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/edge-encryption/c_requestAPI.md) on a request object.

You access JSON content from a [POST or URL parameter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/edge-encryption/param-apis.md) by calling `request.postParms.<parameter name>.getAsJsonContent()` or `request.urlParms.<parameter name>.getAsJsonContent()`.

**Parent Topic:**[JSON APIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/edge-encryption/json-overview.md)
...
Calling this function on a JSON node tells the proxy that the value is an [Encoded query strings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_EncodedQueryStrings.md) for the specified table. The proxy parses the encoded query and encrypts the values for fields in the encoded query that must be encrypted.
