...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/edge-encryption/cyberark-integration-edge-proxy.html
release: yokohama
...
\[Omitted image "cyberark-digital-vault-credentials.png"\] Alt text: CyberArk Add SSH Key page
...
\[Omitted image "cyberark-connection.png"\] Alt text: CyberArk Connection page
...
\[Omitted image "cyberark-connection-installer-2.png"\] Alt text: CyberArk Protected Credentials page
