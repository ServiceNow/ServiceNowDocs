...
3.  [Create a record producer](https://www.servicenow.com/docs/access?context=t_DefRecProdInSCat&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) record or open an existing record producer record.
