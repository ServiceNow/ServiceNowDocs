...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/edge-encryption/t\_SetUpNAEKeyStore.html
release: australia
...
2.  Enter the properties for the [SafeNet keystore](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/edge-encryption-proxy-server-properties.md).
