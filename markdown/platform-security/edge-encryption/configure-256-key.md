...
If you’re updating an SSL certificate on an Edge proxy server, see [Update SSL certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/edge-encryption/update-ssl-certificate.md).

## Procedure

1.  Select the encryption key location.

<table id="choicetable_ech_hb2_hfb"><thead><tr><th align="left" id="d159958e93">

Option

</th><th align="left" id="d159958e96">

Description

</th></tr></thead><tbody><tr><td id="d159958e102">
...
<table id="choicetable_x1n_4b2_hfb"><thead><tr><th align="left" id="d159958e166">

Option

</th><th align="left" id="d159958e169">

Description

</th></tr></thead><tbody><tr><td id="d159958e175">
...
5.  If you want to use AES 256-bit encryption, see [Configure the AES 256-bit encryption key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/edge-encryption/configure-256-key.md).
...
**Previous topic:**[Configure the AES 128-bit encryption key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/edge-encryption/configure-128-key.md)
