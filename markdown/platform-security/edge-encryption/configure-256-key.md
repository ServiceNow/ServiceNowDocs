...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/edge-encryption/configure-256-key.html
release: australia
...
If you’re updating an SSL certificate on an Edge proxy server, see [Update SSL certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/update-ssl-certificate.md).

## Procedure

1.  Select the encryption key location.

<table id="choicetable_ech_hb2_hfb"><thead><tr><th align="left" id="d159022e93">

Option

</th><th align="left" id="d159022e96">

Description

</th></tr></thead><tbody><tr><td id="d159022e102">
...
<table id="choicetable_x1n_4b2_hfb"><thead><tr><th align="left" id="d159022e166">

Option

</th><th align="left" id="d159022e169">

Description

</th></tr></thead><tbody><tr><td id="d159022e175">
...
**Previous topic:**[Configure the AES 128-bit encryption key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/configure-128-key.md)

**Next topic:**[Update SSL certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/update-ssl-certificate.md)
