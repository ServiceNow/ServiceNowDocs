...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/edge-encryption/install-edge-linux-windows.html
release: xanadu
...
**Previous topic:**[Install the Edge Encryption proxy server using the command line installer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/manual-proxy-install.md)

**Next topic:**[Create and configure the RSA key pair for the digital signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/t_SetUpAKeyPair.md)
