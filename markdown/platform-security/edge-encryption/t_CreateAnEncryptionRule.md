...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/edge-encryption/t\_CreateAnEncryptionRule.html
release: australia
...
Before creating an encryption rule, you must [Inspect the client request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/edge-encryption/request-type.md) to determine the format.
