...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/edge-encryption/t\_RollBackAProxyUpdate.html
release: yokohama
...
If an upgrade fails when using the scheduled upgrade feature in the Yokohama release, the proxy server will automatically roll back to the old version. The old proxy server is stored unmodified in a backup directory.
...
**Parent Topic:**[Upgrading Edge Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/edge-encryption/c_UpdateEdgeEncryptionProxy.md)
