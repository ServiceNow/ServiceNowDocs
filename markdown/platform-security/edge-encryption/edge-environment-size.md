...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/edge-encryption/edge-environment-size.html
release: yokohama
...
The proxy server must have a minimum of 4 GB of RAM available \(6 GB recommended\). [Set the proxy server initial and upper bound memory limits](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/edge-encryption/increase-memory.md) to the recommended settings.

**Parent Topic:**[Planning for Edge Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/edge-encryption/c_EdgeEncryptionPlanning.md)
