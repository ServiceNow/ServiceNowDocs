...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/edge-encryption/c\_EdgeEncryptionOverview.html
release: xanadu
...
As with Column Level Encryption Enterprise and Column Level Encryption, Edge Encryption imposes some functional limitations within an instance as a result of the additional security. The local Edge proxy does, however, also provide some additional functionality relating to sorting when compared to column-level encryption.
...
-   [Planning for Edge Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/c_EdgeEncryptionPlanning.md)
...
-   [Key management for Edge Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/c_EncryptionKeyManagement.md)

-   **[Edge Encryption components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/c_EdgeEncryptionProxy.md)**  
...
-   **[Edge Encryption clients](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/edge-clients.md)**  
...
-   **[Encryption configurations and patterns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/c_EncryptionTypes.md)**  
With Edge Encryption, you can encrypt fields and tokenize strings.
-   **[Installed with Edge Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/installed-with-edge-encryption.md)**  
