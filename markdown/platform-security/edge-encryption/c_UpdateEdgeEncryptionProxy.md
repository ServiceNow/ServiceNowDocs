...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/edge-encryption/c\_UpdateEdgeEncryptionProxy.html
release: yokohama
...
3.  The administrator can [Schedule an Edge Encryption proxy server upgrade](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/edge-encryption/schedule-proxy-upgrade.md) for each proxy server.
...
Instead of creating an upgrade schedule, you can manually upgrade each proxy server through the command line. See [Manually upgrade an Edge Encryption proxy server running on Linux](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/edge-encryption/t_UpdateEEProxyOnLinux.md) or [Manually upgrade an Edge Encryption proxy server running on Windows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/edge-encryption/t_UpdateEEProxyOnWindows.md).
...
-   **[Schedule an Edge Encryption proxy server upgrade](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/edge-encryption/schedule-proxy-upgrade.md)**  
Create an upgrade schedule to enable the instance to upgrade an out-of-date proxy server.
-   **[Manually upgrade an Edge Encryption proxy server running on Linux](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/edge-encryption/t_UpdateEEProxyOnLinux.md)**  
Update a proxy running on Linux.
-   **[Manually upgrade an Edge Encryption proxy server running on Windows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/edge-encryption/t_UpdateEEProxyOnWindows.md)**  
Update a proxy running on Windows.
-   **[Roll back an Edge Encryption proxy server upgrade](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/edge-encryption/t_RollBackAProxyUpdate.md)**  
