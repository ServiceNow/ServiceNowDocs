...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/edge-encryption/c\_EncryptionRules.html
release: xanadu
...
-   **[Create an encryption rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/t_CreateAnEncryptionRule.md)**  
Encryption rules are used by the proxy to find content in HTTP requests that should be encrypted.
-   **[Encryption rule conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/c_EncryptionRuleConditions.md)**  
Encryption rule conditions determine if the rule should be executed.
-   **[Encryption rule actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/c_EncryptionRuleActions.md)**  
...
-   **[Encryption rule objects and APIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/edge-encryption/api-overview.md)**  
