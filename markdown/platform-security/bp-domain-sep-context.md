...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/bp-domain-sep-context.html
release: zurich
topic_type: concept
...
You can learn about additional ways to add domains to a user’s session context in [Service provider reference architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-sp-reference-arch-ds.md).
