...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/bp-domain-sep-context.html
release: yokohama
topic_type: concept
...
You can learn about additional ways to add domains to a user’s session context in [Service provider reference architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/bp-sp-reference-arch-ds.md).
