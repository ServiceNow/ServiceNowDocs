...
|Role|Description|
|----|-----------|
|`sn_vault_console.vault_console_admin`|This role is necessary to view the Vault console dashboard and use guided setup in your instance. It is a combination of Data Classification admin, Data Privacy admin, and CA admin roles for management of the Vault console. On the Vault console dashboard, this role provides read-only access to all the tool charts and available protection configurations. This role includes `access_analyzer_ai_user`, which AI agents require to call the Access Analyzer API.|
