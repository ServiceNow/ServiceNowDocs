...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/dps-create-anonymization-policies.html
release: yokohama
topic_type: task
...
1.  Elevate to the **data\_privacy\_admin** role.
    ...
    For details on role elevation, see [Elevate to a privileged role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/t_ElevateToAPrivilegedRole.md).
...
4.  Select to either anonymize **Data tables or columns**, **User specific data**, or **Real time data**.
    ...
    |Real time data|Anonymize real time entries for a set of columns. See [Real time anonymization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/data-privacy-classic/real-time-anonymization.md) for more information.|

    Data privacy policies can only apply to classified data, for more information on data classification, see [Data classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/data-privacy-classic/dps-data-classification.md).
...
<table id="choicetable_ywk_ywc_dwb"><thead><tr><th align="left" id="d170825e268">

Option

</th><th align="left" id="d170825e271">

Description

</th></tr></thead><tbody><tr><td id="d170825e277">
...
[Create anonymization job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/dps-create-anonymization-job.md).
