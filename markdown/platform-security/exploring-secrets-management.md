...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/exploring-secrets-management.html
release: yokohama
topic_type: concept
...
**Important:** Admins must have the role to see modules and records related to Secrets Management. For secrets management role information, see [Secrets management roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/roles-sec-man.md).
...
**Note:** For more information on these group types, see [About client-side Secrets Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/understand-sec-man.md).
...
-   **[About client-side Secrets Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/understand-sec-man.md)**  
