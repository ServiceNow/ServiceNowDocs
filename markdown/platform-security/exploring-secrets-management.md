...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/exploring-secrets-management.html
release: xanadu
topic_type: concept
...
**Important:** Admins must have the role to see modules and records related to Secrets Management. For secrets management role information, see [Secrets management roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/roles-sec-man.md).
...
**Note:** For more information on these group types, see [Understanding client side Secrets Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/understand-sec-man.md).
...
-   **[Understanding client side Secrets Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/understand-sec-man.md)**  
