...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/pre-work-ca.html
release: australia
topic_type: concept
...
-   [LDAP or Local login \(Username and Password\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/pre-work-ca.md)
-   [SSO login \(SAML or OIDC\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/pre-work-ca.md).
...
To know more, see [High Assurance session for non-SSO login](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/high-assurance-non-sso-logins.md).
...
To know more, see [High Assurance for SSO login](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/high-assurance-sso-logins.md).
