...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/update-security-hardening-params.html
release: yokohama
topic_type: task
...
2.  Click the **Daily Compliance Score** tile or the **Hardening** link to access the Hardening Compliance Configuration page.
    ...
    \[Omitted image "isc-hardening-1.png"\] Alt text: Instance security center page
...
<table id="choicetable_lvw_mhf_kfb"><tbody><tr><td id="d85035e125">
...
</table>    \[Omitted image "isc-hardening-2.png"\] Alt text: Instance security center page
...
<table id="choicetable_kwb_2q5_mlb"><tbody><tr><td id="d85035e183">
...
**Parent Topic:**[Check the daily compliance score and configure security property settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/instance-sec-center-hardening.md)
