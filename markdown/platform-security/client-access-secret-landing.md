...
These instructions assume you have a MID server configured on your local network. For information on this process see [MID Server](https://www.servicenow.com/docs/access?context=mid-server-landing&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
