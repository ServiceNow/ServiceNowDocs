...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/frequently-asked-questions.html
release: brazil
topic_type: concept
...
At a table level, ACLs are evaluated only for roles and security attributes. Conditions and scripts aren’t evaluated.
 ...
 Roles are evaluated first. If Roles are blocked, conditions and scripts are skipped. For more information, see [Configure an ACL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/access-control/t_CreateAnACLRule.md).
