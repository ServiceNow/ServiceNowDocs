---
title: Granular admin roles required to secure your instance
description: Verify proper access management by assigning roles that define user permissions and responsibilities. By doing so, organizations can maintain security, enforce conformance, and optimize their operations effectively.
locale: en-US
release: zurich
topic_type: concept
