...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/les-log-sources-export.html
release: xanadu
topic_type: concept
...
See [System logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/system-logs.md) to learn more about the schema and purpose for the above log sources.
