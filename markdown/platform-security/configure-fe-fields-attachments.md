...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/configure-fe-fields-attachments.html
release: australia
topic_type: task
