...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/configure-fe-fields-attachments.html
release: brazil
topic_type: task
...
You must have a configured field encryption module with a ServiceNow or customer-supplied key. If you have not yet configured a module, see [Configure Field Encryption modules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/configure-fe-modules.md).
