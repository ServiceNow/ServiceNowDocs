...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/kmf-walkthroughs-tutorials.html
release: xanadu
topic_type: concept
...
**Parent Topic:**[Using Column Level Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/using-column-level-encryption.md)
...
**Note:** This procedure only applies to Column Level Encryption Enterprise functionality. See [Activate Column Level Encryption Enterprise](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/activate-platform-encryption.md) for more information on obtaining Column Level Encryption Enterprise.

Role required: admin or security\_admin

**Note:** security\_admin is a privileged role, for details on using privileged roles, see [Elevate to a privileged role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/t_ElevateToAPrivilegedRole.md)
...
2.  Create a cryptographic module.
    ...
    See [Create cryptographic module for Column Level Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/create-PE-cryptographic-module.md) for more information.
