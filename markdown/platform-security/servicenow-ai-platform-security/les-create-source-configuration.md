...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/les-create-source-configuration.html
release: yokohama
...
-   Table
See [Log sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/les-log-sources-export.md) for more information.
...
See [Create source type and multi topics in the LES source table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/les-multi-topics-v2.md) for more information.
...
7.  Create a filter type and assign it to a topic.
    ...
    4.  Select the lookup icon in the Topic field.
        ...
        **Note:** You can select an existing Kafka topic from the list. You can also create a new Kafka topic by selecting **New** in the Kafka Topics list. See [Create source type and multi topics in the LES source table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/les-multi-topics-v2.md) to create a new Kafka topic.
...
-   **[Create source type and multi topics in the LES source table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/les-multi-topics-v2.md)**  
...
**Parent Topic:**[Administering Log Export Service \(LES\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/les-administer.md)
