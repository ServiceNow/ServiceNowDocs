---
title: Exploring Zero Trust Access
description: Zero Trust Access \(ZTA\) is a security model that assumes that no user or device is trusted by default.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/explore-zero-trust-access.html
release: xanadu
...
-   Reduce access based on IDP response for a user session, if the user is using an untrusted device. For more information, see [Configure IDP attribute for Session Access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/configure-idp-session-access.md).
...
For more information, see [Configure Zero Trust Access for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/mobile/mobile-platform/configure-zero-trust-access-mobile.md).
