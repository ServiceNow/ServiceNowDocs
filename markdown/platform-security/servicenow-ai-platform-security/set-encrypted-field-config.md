...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/set-encrypted-field-config.html
release: yokohama
 ...
 **Note:** Attachment encryption is only available with Field Encryption Enterprise.
 ...
 **Note:** If the field you want to encrypt is not available, it is not a supported type. The supported field types are:
...
**Parent Topic:**[Encrypting fields and attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/field-encryption-key-management.md)
