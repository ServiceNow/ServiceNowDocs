...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/module-lifecycle-policy-exceptions-for-fe.html
release: yokohama
