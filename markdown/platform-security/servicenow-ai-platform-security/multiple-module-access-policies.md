...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/multiple-module-access-policies.html
release: yokohama
...
2.  Navigate to **System Security** &gt; **Column Level Encryption** &gt; **Encrypted Field Configurations**.
    ...
    If you need more information on Encrypted Field Configurations, see [Set encrypted field configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/set-encrypted-field-config.md).
