...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/enable-notification-preferences.html
release: xanadu
...
Send the selected type of notification whenever a high privilege security role \(including oauth\_admin, admin, security\_admin, and impersonator roles\) is granted to another user.To learn more about elevating user security, see [Elevate to a privileged role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/t_ElevateToAPrivilegedRole.md) and [Elevated privilege roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/c_ElevatedPrivilege.md).
...
Send the selected type of notification whenever another user is impersonating you.To learn more about impersonating users, see [Impersonate a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/user-administration/c_ImpersonateAUser.md).
...
<table id="choicetable_amb_lb4_mnb"><thead><tr><th align="left" id="d30534e215">

Check box

</th><th align="left" id="d30534e218">

Description

</th></tr></thead><tbody><tr><td id="d30534e224">
...
**Parent Topic:**[Monitor security events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/instance-sec-center-event-ribbon.md)
