...
description: Sign a specific record, or group of records you define on a trusted non-production instance.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/sign-files-nonprod.html
release: xanadu
...
breadcrumb: [Sign specific records or attachments, Using Code Signing, Code Signing, Platform Security]
---
...
**Parent Topic:**[Sign specific records or attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/sign-specific-records.md)
