...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/t\_ExcludeAFieldFromBeingAudited.html
release: yokohama
...
To exclude a field in a table from being audited, you must have first [enable auditing for that table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/t_EnableAuditingForATable.md).
