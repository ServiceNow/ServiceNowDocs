...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/pci-config-controls-dashboard.html
release: yokohama
...
</table>**Parent Topic:**[Check the daily compliance score and configure security property settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/instance-sec-center-hardening.md)
