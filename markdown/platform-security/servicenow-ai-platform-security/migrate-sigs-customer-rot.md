...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/migrate-sigs-customer-rot.html
release: xanadu
...
16. Select **Export Code Signing job to production**.
    ...
    This action signs the job and places it in a new update set you can import into your production instance.
...
20. Log in to your production instance.
...
To continue the Root of Trust configuration process, see [Disable ServiceNow Root of Trust](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/disable-sn-rot.md).

**Parent Topic:**[Change your Root of Trust configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/change-rot-overview.md)
