...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/configure-script-encryption.html
release: yokohama
...
6.  Navigate to **Key Management** &gt; **Module Access Policies** &gt; **** **All**.
    ...
    **Note:** For additional information, refer to [Create a module access policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/platform-encryption/create-module-access-policy.md).
...
-   **[View declined cryptographic module usage requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/view-declined-crypto-module-usage-requests.md)**  
...
**Parent Topic:**[Script access for cryptographic modules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/script-map.md)
