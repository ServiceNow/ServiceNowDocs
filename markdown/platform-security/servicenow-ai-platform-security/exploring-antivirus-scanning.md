...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/exploring-antivirus-scanning.html
release: xanadu
...
Inbound emails are scanned for viruses by the system [email filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/c_EmailFilters.md), not by Antivirus Scanning.
