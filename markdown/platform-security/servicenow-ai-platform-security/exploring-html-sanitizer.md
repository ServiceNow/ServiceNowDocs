...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/exploring-html-sanitizer.html
release: xanadu
...
**Note:** To learn more about the **glide.html.sanitize\_all\_fields** property that controls use of the HTML sanitizer, see [Enable HTML Sanitizer \[Updated in Security Center 1.3\]](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/instance-security-hardening-settings/sc-html-sanitizer.md) in Instance Security Hardening Settings.

## Configure urlAttributes and the protocols

You can configure urlAttributes and their protocols in the **HTMLSanitizerConfig** script include. For example:
