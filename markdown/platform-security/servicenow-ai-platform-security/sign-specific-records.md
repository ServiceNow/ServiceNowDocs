...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/sign-specific-records.html
release: yokohama
...
-   **[Create a job to sign specific records or attachments on a trusted instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/sign-files-nonprod.md)**  
Sign a specific record, or group of records you define on a trusted instance.

**Parent Topic:**[Using Code Signing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/using-code-signing.md)
