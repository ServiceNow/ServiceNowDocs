...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/dps-configure-data-anonymization-clone.html
release: xanadu
...
4.  Select **Create new policy**.
    ...
    See [Create anonymization policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/dps-create-anonymization-policies.md) for details.
...
13. Schedule the anonymization job.
    ...
    See [Create anonymization job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/dps-create-anonymization-job.md)for details.
