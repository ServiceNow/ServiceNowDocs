---
title: Execute audits immediately
description: Audits typically run as scheduled. You can, however, run all audits on command.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/execute-audits-immediately.html
release: yokohama
