...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/t\_ConSysTablDelAud.html
release: xanadu
...
4.  Click **Save**.
    ...
    **Note:** For more information about auditing, see [Understanding the sys audit Table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/c_UnderstandingTheSysAuditTable.md).
