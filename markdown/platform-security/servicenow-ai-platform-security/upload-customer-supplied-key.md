...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/upload-customer-supplied-key.html
release: yokohama
...
10. Run the BYOK command on a terminal to wrap the key.
    ...
    For more information, refer to [Wrap your customer-supplied key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/wrap-customer-supplied-key.md).
