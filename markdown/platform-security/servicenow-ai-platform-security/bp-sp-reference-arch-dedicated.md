...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/bp-sp-reference-arch-dedicated.html
release: yokohama
...
\[Omitted image "bp-sp-reference-architecture-dedicated.png"\] Alt text: Dedicated instance
...
\[Omitted image "bp-dedicated-ds-hybrid-siam.png"\] Alt text: Reference architecture

**Parent Topic:**[Service provider reference architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/bp-sp-reference-arch-ds.md)
