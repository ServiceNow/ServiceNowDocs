...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/understand-sec-man.html
release: yokohama
...
\[Omitted image "cse-process-1.png"\] Alt text: Symmetric key encryption
...
\[Omitted image "cse-process-2.png"\] Alt text: Credential encrypted with symmetric key encryption
...
\[Omitted image "cse-process-3.png"\] Alt text: Public and private keys
...
\[Omitted image "cse-process-4.png"\] Alt text: Public key used to encrypt the symmetric key.
...
\[Omitted image "cse-process-5.png"\] Alt text: Public key used to encrypt the symmetric key.

</td></tr></tbody>
</table>**Parent Topic:**[Exploring Secrets Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/exploring-secrets-management.md)
