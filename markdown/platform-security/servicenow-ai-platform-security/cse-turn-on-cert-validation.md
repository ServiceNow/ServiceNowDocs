...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/cse-turn-on-cert-validation.html
release: xanadu
...
16. On the **Export Configuration** file page, select **Export** to create and download a configuration file used to turn on Code Signing on your protected production instance.
    ...
    The export process downloads an XML file to your local machine for use in the steps detailed in [Configure Code Signing Enterprise on your protected production instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/cse-ppi-config.md).
