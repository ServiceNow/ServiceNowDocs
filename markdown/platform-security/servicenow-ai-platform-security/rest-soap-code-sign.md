...
description: Sign and validate the existing REST and SOAP messages by enabling the Code Signing in production and trusted non-production instances.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/rest-soap-code-sign.html
release: xanadu
...
breadcrumb: [Sign the REST and SOAP messages in the production instance, Using Code Signing, Code Signing, Platform Security]
---
...
4.  In the production instance, import the update sets.
...
5.  In the production instance, run the encryption job you had earlier created in the trusted instance by selecting **Start**.

    A confirmation message is displayed mentioning that the records are signed.


**Parent Topic:**[Sign the REST and SOAP messages in the production instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/cs-rest-soap.md)
