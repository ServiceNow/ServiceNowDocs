...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/exploring-column-level-encryption.html
release: xanadu
...
Create up to 5 modules and module access policies \(MAP\)s using the standard version of FE. MAPs expand on role-based access to allow considerations for:-   System users
-   Scripts
...
FEE supports more than 5 modules and module access policies to provide more options for access to secured data.
...
</table>-   **[Column Level Encryption Guided Tour](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/cle-tour.md)**  
...
**Parent Topic:**[Column Level Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/column-level-encryption-landing.md)
