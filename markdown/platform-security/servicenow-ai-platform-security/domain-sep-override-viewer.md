...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/domain-sep-override-viewer.html
release: xanadu
...
To learn more, see [Create domain-separated property overrides](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/security-management/security-operations/create-dom-sep-prop-overrides.md).
