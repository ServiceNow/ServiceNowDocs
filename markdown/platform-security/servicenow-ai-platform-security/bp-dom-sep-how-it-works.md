...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/bp-dom-sep-how-it-works.html
release: yokohama
...
breadcrumb: [Segregating and securing data with domain separation, Domain separation recommended practices for service providers, Domain separation for service providers, Access Management]
---
...
**Parent Topic:**[Segregating and securing data with domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/bp-segregate-secure.md)
