...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/instance-sec-center-user-metrics.html
release: xanadu
...
|security\_admin|Elevated privilege role that enables a user to create and change access controls and High Security Settings. To learn more, see [Security\_admin role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/security-admin-role.md)|
