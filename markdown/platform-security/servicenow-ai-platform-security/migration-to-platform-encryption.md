...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/migration-to-platform-encryption.html
release: xanadu
...
-   A deactivated encryption module key \(from the automated key exchange transfer
    ...
    To use a single key to decrypt and encrypt all data, you can run a module rekeying job. For more information about module rekeying jobs, see [Schedule mass encryption, decryption, and rekeying jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/schedule-mass-jobs.md).


-   **[Column Level Encryption migration status page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/cle-migration-status-page.md)**  
Use the migration status page to track the migration of encryption contexts to encryption modules.

**Parent Topic:**[Configuring Column Level Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/configuring-column-level-encryption.md)
