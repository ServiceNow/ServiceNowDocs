...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/les-kafka-consumer.html
release: xanadu
...
\[Omitted image "les-kafka-categories.png"\] Alt text:
