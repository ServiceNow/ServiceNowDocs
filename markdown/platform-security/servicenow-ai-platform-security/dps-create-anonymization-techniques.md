...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/dps-create-anonymization-techniques.html
release: xanadu
...
Transforms String data and selectively replaces sensitive characters with the letter X.**Note:** Default technique for data patterns in [Exploring Data Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/data-discovery/data-discovery.md).
...
See [Create anonymization policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/dps-create-anonymization-policies.md) to configure an anonymization policy to specify which techniques are used when anonymizing your data.
