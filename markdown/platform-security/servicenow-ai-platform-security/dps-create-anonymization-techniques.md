...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/dps-create-anonymization-techniques.html
release: yokohama
...
See [Create anonymization policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/servicenow-ai-platform-security/dps-create-anonymization-policies.md) to configure an anonymization policy to specify which techniques are used when anonymizing your data.
