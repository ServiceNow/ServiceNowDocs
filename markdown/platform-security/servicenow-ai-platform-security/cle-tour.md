...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/servicenow-ai-platform-security/cle-tour.html
release: yokohama
...
4.  Select **Next** to progress through the tour.
    ...
    \[Omitted image "tour\_image.png"\] Alt text: The Column Level Encryption Enterprise tour.
