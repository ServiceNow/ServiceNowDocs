...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/servicenow-ai-platform-security/cle-tour.html
release: xanadu
...
**Note:** The guided tour is not available:

-   When Next Experience is enabled.
-   In Yokohama release and later.
...
2.  Open the **Show Help** icon \(\[Omitted image "toggle-help-sidebar-icon.png"\] Alt text: Shows Toggle Help Sidebar icon in the upper left corner.​ **Note:** This icon may be located in the upper right corner, depending on the version you are running.
...
**Parent Topic:**[Exploring Column Level Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/exploring-column-level-encryption.md)
