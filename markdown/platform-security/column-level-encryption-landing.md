...
For field encryption support see or [Column Level Encryption Enterprise](../../now-platform-encryption/concept/now-platform-encryption.md) for premium field and attachment encryption support.
...
![Role-based encryption](../image/fig-1-role-based-encryption-example.png "Role-based encryption example")
