...
If you want to audit only a few fields in the table [Enabling inclusion list auditing for a table](enable-whitelist-for-table.md). If you want to audit most – but exclude some – fields, see [Excluding a field from being audited \(exclusion listing\)](t_ExcludeAFieldFromBeingAudited.md).
