...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/bp-domain-logs.html
release: zurich
topic_type: concept
...
To learn more about domain-separation errors, see [Troubleshoot domain separation errors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/r_TroubleshootDomainSeparationError.md).
