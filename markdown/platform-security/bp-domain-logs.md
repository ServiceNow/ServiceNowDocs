...
To learn more about domain-separation errors, see [Troubleshoot domain separation errors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/r_TroubleshootDomainSeparationError.md).
