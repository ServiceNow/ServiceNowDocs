...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/bp-domain-logs.html
release: yokohama
topic_type: concept
...
To learn more about domain-separation errors, see [Troubleshoot domain separation errors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/r_TroubleshootDomainSeparationError.md).
