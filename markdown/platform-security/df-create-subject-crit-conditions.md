...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/df-create-subject-crit-conditions.html
release: xanadu
topic_type: task
