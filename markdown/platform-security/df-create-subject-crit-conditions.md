...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/df-create-subject-crit-conditions.html
release: yokohama
topic_type: task
