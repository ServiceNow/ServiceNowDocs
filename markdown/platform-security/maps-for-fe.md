...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/maps-for-fe.html
release: australia
topic_type: task
...
You must have a published field encryption module to use this process. If you have not done so, see [Configure Field Encryption modules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/configure-fe-modules.md).
...
MAPs are separate from access control lists \(ACL\), but can be used in combination with them. See [Exploring Field Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/exploring-fe.md) for more information about the purpose behind MAPs.
