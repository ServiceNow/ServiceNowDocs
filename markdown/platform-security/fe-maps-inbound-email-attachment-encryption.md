...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/fe-maps-inbound-email-attachment-encryption.html
release: australia
topic_type: concept
...
-   **System MAP** — Required when inbound email processing runs as the system user, which is the default behavior. See [Create a system module access policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/fe-create-system-map.md).
-   **User MAP** — Required when the email is matched to a user in your instance and processing runs as that user. Any MAP type can be used as long as the user has access to the cryptographic module. If you use a role-based MAP, you must enable impersonation. See [Create a user module access policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/fe-create-user-map.md).

-   **[Create a system module access policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/fe-create-system-map.md)**  
...
-   **[Create a user module access policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/fe-create-user-map.md)**  
Create a module access policy \(MAP\) for a matched user to encrypt attachments when inbound email processing runs as that user.
