...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/enable-whitelist-for-table.html
release: yokohama
topic_type: task
...
The table must be [enabled for auditing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/t_EnableAuditingForATable.md).
...
[Designate which fields you want to audit in this table.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/security-whitelist-audit-field.md)
