...
**Note:** To learn more about this plugin, see [Enable SNC access control plugin \[Updated in Security Center 1.3\]](../../security-center/reference/sc-snc-access-control-plugin.md) in Instance Security Hardening Settings.
