...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/schedule-mass-jobs.html
release: australia
topic_type: task
...
Mass encryption and decryption is also available from the Encrypted Field Configurations form. See [Run mass encryption or decryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/mass-enc-dec.md) for instructions.
