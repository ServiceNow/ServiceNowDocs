...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/schedule-mass-jobs.html
release: yokohama
topic_type: task
...
Mass encryption and decryption is also available from the Encrypted Field Configurations form. See [Run mass encryption or decryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/mass-enc-dec.md) for instructions.
...
**Parent Topic:**[Encrypting fields and attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/field-encryption-key-management.md)
