...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/cse-turn-on-cse.html
release: xanadu
topic_type: task
...
-   codesigning\_admin
    ...
    **Note:** The codesigning\_admin role can be assigned using the process detailed in [Assign the Code Signing Administrator Role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cse-assign-roles.md).
...
**Warning:** After completing this process, you’ll have downloaded a configuration file that must be installed on your PPI within an hour. Verify that you have time available after this process to upload the configuration file to your production instance. For details on that process, see [Upload your Code Signing configuration file to your protected production instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cse-upload-cs-config.md).
...
15. On the **Export Configuration** file page, select **Export** to create and download a configuration file used to turn on Code Signing on your protected production instance.
    ...
    The export process downloads an XML file to your local machine for use in the steps details in [Configure Code Signing Enterprise on your protected production instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cse-ppi-config.md).


**Parent Topic:**[Configuring Code Signing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/config-code-signing.md)
