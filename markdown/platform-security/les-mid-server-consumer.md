...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/les-mid-server-consumer.html
release: zurich
topic_type: concept
...
-   **[Guided setup for MID Server consumers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/les-guided-setup-mid-server.md)**  
Implement the following steps for a complete guided setup for MID Server consumers.
-   **[Multi-consumer support using unique mid servers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/les-multi-consumer.md)**  
