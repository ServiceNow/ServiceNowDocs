...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/les-mid-server-consumer.html
release: yokohama
topic_type: concept
...
\[Omitted image "les-mid-server-setup.png"\] Alt text: LES Guided setup for MID server consumer
...
\[Omitted image "les-mid-server-categories.png"\] Alt text: Categories page for LES Guided setup
