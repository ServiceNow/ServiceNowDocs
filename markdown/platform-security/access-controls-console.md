...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/access-controls-console.html
release: brazil
topic_type: concept
...
For details on using the Access Analyzer diagnostic tool, see [Access Analyzer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/access-analyzer.md), or review the tutorial video and links in the **Access analyzer** tab.
