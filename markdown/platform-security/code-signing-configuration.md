...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/code-signing-configuration.html
release: zurich
topic_type: concept
...
**Parent Topic:**[Code Signing Health and Status Dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/code-signing-health-and-status-dashboard.md)
