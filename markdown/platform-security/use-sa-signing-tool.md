...
5.  Import the updated application back into your instance by applying remote changes in Studio.
    ...
    For more information, see [Legacy - Apply remote changes](https://www.servicenow.com/docs/access?context=t_ApplyRemoteChanges&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
