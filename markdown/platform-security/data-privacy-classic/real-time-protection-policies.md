...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-privacy-classic/real-time-protection-policies.html
release: australia
...
2.  Select **Create new policy.**
    ...
    **Note:** In order to create real time protection polices, you must first create at least one[alert data pattern](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/alert-data-patterns.md).
...
Select the data pattern that defines what sensitive data to detect. **Note:** You can create [Alert data patterns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/alert-data-patterns.md) if none exist.
