...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-privacy-classic/data-privacy-for-virtual-agent.html
release: australia
...
2.  Under **Sensitive data detection**, select **View all**.
    ...
    If the button reads **Get data privacy**, you will need to install the Data Privacy plugin to continue. See [Activate data privacy \(Classic\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/install-data-privacy.md) for more information
...
7.  Create a new Data Privacy policy for Virtual Agent, see [Create anonymization policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/dps-create-anonymization-policies.md) for more information on Data Privacy policies.
