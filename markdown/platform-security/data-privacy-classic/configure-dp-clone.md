...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-privacy-classic/configure-dp-clone.html
release: australia
...
4.  Create a Privacy Policy configuration.
    ...
    Select **Apply to All in Data Class** and **Apply when Cloning**. See [Create a data privacy policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/config-dp-policy.md) for more information.
