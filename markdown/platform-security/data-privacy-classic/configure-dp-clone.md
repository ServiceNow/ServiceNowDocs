...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/data-privacy-classic/configure-dp-clone.html
release: xanadu
...
4.  Create a Privacy Policy configuration.
    ...
    Select **Apply to All in Data Class** and **Apply when Cloning**. See [Create a data privacy policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/data-privacy-classic/config-dp-policy.md) for more information.
