...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-privacy-classic/dps-configure-data-anonymization-clone.html
release: australia
...
4.  Select **Create new policy**.
    ...
    See [Create anonymization policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/dps-create-anonymization-policies.md) for details.
...
13. Schedule the anonymization job.
    ...
    See [Create anonymization job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/dps-create-anonymization-job.md)for details.
