...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/data-privacy-classic/configure-now-assist-data-privacy.html
release: yokohama
...
4.  In the **Data Channel** field, select the data channel to be used, see [Contextual based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/data-discovery/contextual-based-discovery.md) for more information.
...
8.  To create your own data pattern, see [Configure Data Discovery patterns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/data-discovery/configure-data-discovery-patterns.md).
