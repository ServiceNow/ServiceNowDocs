...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-privacy-classic/config-data-privacy-job.html
release: australia
...
The privacy policy configuration to use for this job. For detail on Privacy policy configurations, see [Create a data privacy policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/config-dp-policy.md).
...
-   **Completed with Errors**: The job completed but has errors. See [Data Privacy Job Logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/dp-job-logs.md) for more information.
-   **Error**: Job did not complete and had an error. See [Data Privacy Job Logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/dp-job-logs.md) for more information
A read-only field.
