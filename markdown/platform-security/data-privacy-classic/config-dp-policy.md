...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-privacy-classic/config-dp-policy.html
release: australia
...
5.  In the **Data Class** field, select the data class to use with this policy.
    ...
    Data privacy policies can only apply to classified data, for more information on data classification, see [Data classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-classification/data-classification.md).
...
7.  Select **Supports Rollback** to enable the ability to de-anonymize the data from a data privacy job.
    ...
    See [Roll back a data privacy job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/rollback-data-privacy-job.md) for more information.
...
[Configure a data privacy job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/config-data-privacy-job.md).
