...
-   You must have two 4096-bit RSA public/private key pairs to load into Code Signing cryptographic modules:
    ...
    For more information on these keys, see [Create Code Signing key pairs and certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/create-key-pairs-and-certs.md).
...
Export the certificate to production. See [Prepare Circle of Trust certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/create-updateset-nonprod.md) for details.
