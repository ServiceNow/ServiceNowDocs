...
This remediation enforces validation on the catalog page such that only relative URLs are permitted. Existing links to external web applications will be broken.
