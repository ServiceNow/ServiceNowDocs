...
**Note:** To enforce a maximum session time for any active user sessions, see [Managing user sessions](https://www.servicenow.com/docs/access?context=c_ManageUserSessions&version=australia&pubname=australia-platform-administration&ft:locale=en-US).
