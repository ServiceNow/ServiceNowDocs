...
-   [Review extraneous explicit role access control conditions \[Removed in Security Center 1.5\]](../reference/sc-review-extraneous-explicit-role-access-control-conditions.md)
...
-   [Restrict flow context read access \[New in Security Center 1.5\]](../reference/sc-restrict-flow-context-read-access.md)
-   [Limit policy based session access mobile refresh token interval \[New in Security Center 1.5\]](../reference/sc-limit-policy-based-session-access-mobile-refresh.md)
-   [Enable policy based session access for mobile \[New in Security Center 1.5\]](../reference/sc-enable-policy-based-session-access-for-mobile.md)
...
**Parent Topic:**[New hardening settings for baseline version 5](new-hardening-settings-for-baseline-five.md)
