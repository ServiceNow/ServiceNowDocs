...
-   **[Log all outbound http request fields \[Removed in Security Center v1.3.2\]](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/instance-security-hardening-settings/sc-log-all-outbound-http-request-fields.md)**  
...
-   **[Log html sanitization \[Removed in Security Center 2.0\]](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/instance-security-hardening-settings/sc-log-html-sanitization.md)**  
...
-   **[Log Impersonation History](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/instance-security-hardening-settings/sc-log-impersonation-history.md)**  
...
-   **[Restrict exposure of validation error details to end users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/instance-security-hardening-settings/sc-restrict-exposure-of-validation-error-details-to-end-users.md)**  
...
-   **[Restrict vault code signing audit exclusion to defaults](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/instance-security-hardening-settings/sc-restrict-vault-code-signing-audit-exclusion-list-to-default-tables.md)**  
...
-   **[Track Impersonation Events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/instance-security-hardening-settings/sc-track-impersonation-events.md)**  
