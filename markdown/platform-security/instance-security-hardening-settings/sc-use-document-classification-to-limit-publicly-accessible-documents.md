...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/instance-security-hardening-settings/sc-use-document-classification-to-limit-publicly-accessible-documents.html
release: brazil
