---
title: Restrict MID Server users from authenticating using UI
description: Reduce risk from a compromised MID Server account by disallowing UI authentication.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/instance-security-hardening-settings/sc-restrict-mid-server-users-from-authenticating-via-the-ui.html
release: brazil
...
# Restrict MID Server users from authenticating using UI
