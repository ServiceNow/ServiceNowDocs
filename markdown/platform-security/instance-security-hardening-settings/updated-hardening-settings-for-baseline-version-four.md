...
</table>-   **[Updated hardening settings](updated-hardening-settings.md)**  
This list contains the hardening settings which have been updated in Security Center baseline version 2.0.

**Parent Topic:**[Updated hardening settings for baseline version 5](updated-hardening-settings-for-baseline-version-five.md)
