...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/instance-security-hardening-settings/sc-reduce-allowed-bypasses-for-multifactor-setup.html
release: zurich
