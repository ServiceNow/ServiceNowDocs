...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/instance-security-hardening-settings/sc-account-recovery.html
release: yokohama
...
|References|See [Account recovery \(ACR\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/sso-acct-recovery.md) for additional information.|
