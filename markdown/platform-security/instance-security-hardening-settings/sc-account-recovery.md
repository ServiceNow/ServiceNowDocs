...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/instance-security-hardening-settings/sc-account-recovery.html
release: xanadu
...
|References|See [Account recovery \(ACR\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/authentication/sso-acct-recovery.md) for additional information.|
