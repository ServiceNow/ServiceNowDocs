...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/instance-security-hardening-settings/validate-query-acls-on-glide-db-functions.html
release: zurich
