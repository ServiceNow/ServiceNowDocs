...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/instance-security-hardening-settings/sc-email-spam-scoring-and-filtering.html
release: yokohama
...
Set the **glide.email.read.active** property to true. To learn more, see [Enable using your own POP3 server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_ConfAltEmailConfPOP3Server.md).
...
[Email filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/c_EmailFilters.md)
