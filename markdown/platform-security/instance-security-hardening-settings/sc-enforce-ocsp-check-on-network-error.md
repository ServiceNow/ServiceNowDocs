...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/instance-security-hardening-settings/sc-enforce-ocsp-check-on-network-error.html
release: xanadu
