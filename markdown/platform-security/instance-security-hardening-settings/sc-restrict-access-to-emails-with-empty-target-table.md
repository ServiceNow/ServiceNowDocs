...
-   Severity score: 6.5
-   CVSS rating: Medium
-   Security risk details: Emails without a target record are visible to all users, allowing unauthorized access to sensitive communication and violating data confidentiality principles.
