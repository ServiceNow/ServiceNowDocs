...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/instance-security-hardening-settings/sc-enabling-ajaxgliderecord-acl-checking.html
release: yokohama
...
[Apply ACLs to AJAXGlideRecord \(client-side Glide record\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/access-control/r_ApplyACLsToAJAXGlideRecord.md) This property belongs to the same family of properties that secure and restrict execution of scripts originating from the client:
