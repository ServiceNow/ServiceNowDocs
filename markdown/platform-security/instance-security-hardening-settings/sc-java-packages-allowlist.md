...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/instance-security-hardening-settings/sc-java-packages-allowlist.html
release: australia
...
Install the Packages call removal tool. See [Packages call removal tool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/instance-security-hardening-settings/sc-packages-call-removal-tool.md) for details.
...
-   **[Packages call removal tool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/instance-security-hardening-settings/sc-packages-call-removal-tool.md)**  
