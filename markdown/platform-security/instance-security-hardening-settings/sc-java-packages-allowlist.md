...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/instance-security-hardening-settings/sc-java-packages-allowlist.html
release: xanadu
...
Install the Packages call removal tool. See [Packages call removal tool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/instance-security-hardening-settings/sc-packages-call-removal-tool.md) for details.
...
-   **[Packages call removal tool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/instance-security-hardening-settings/sc-packages-call-removal-tool.md)**  
