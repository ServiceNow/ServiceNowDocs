...
breadcrumb: [Updated hardening settings for baseline version 4.0, Updated hardening settings for baseline version 5, Baseline versions, Hardening settings, Platform Security]
---

# Updated hardening settings

This list contains the hardening settings which have been updated in Security Center baseline version 2.0.
