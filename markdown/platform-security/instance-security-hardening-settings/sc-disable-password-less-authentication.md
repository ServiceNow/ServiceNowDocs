...
description: Use the glide.login.no\_blank\_password property to prevent users from logging into the ServiceNow AI Platform with blank passwords, or by leaving the Password field empty.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/instance-security-hardening-settings/sc-disable-password-less-authentication.html
release: xanadu
