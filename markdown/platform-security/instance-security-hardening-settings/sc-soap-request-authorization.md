...
-   Create an account for a user who needs access to this content, with the necessary access control permissions.
 ...
 To learn more, see [SOAP web service](https://www.servicenow.com/docs/access?context=c_SOAPWebService&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US) and [MID Server authentication credentials and SOAP requests](https://www.servicenow.com/docs/access?context=mid-authentication-soap-requests&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
