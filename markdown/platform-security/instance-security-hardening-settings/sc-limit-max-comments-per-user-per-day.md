...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/instance-security-hardening-settings/sc-limit-max-comments-per-user-per-day.html
release: yokohama
