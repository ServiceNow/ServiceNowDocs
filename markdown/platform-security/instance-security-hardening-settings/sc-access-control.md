...
-   **[hardening-template-example.md](hardening-template-example.md)**  
...
-   **[Enforce credential alias usage \[New in Security Center 1.3 and updated in 1.5\]](sc-enforce-credential-alias-usage.md)**  
...
-   **[Publicly Exposed Virtual Agent Embedded Web Client sn\_va\_web\_client\_app\_embed \[New in Security Center 2.0\]](sc-publicly-exposed-virtual-agent-embedded-web-client.md)**  
