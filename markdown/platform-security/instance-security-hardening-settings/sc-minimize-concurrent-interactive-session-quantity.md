...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/instance-security-hardening-settings/sc-minimize-concurrent-interactive-session-quantity.html
release: brazil
