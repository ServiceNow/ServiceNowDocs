...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/instance-security-hardening-settings/sc-enable-url-allowlist-for-cross-origin-iframe-communication.html
release: xanadu
...
`Openframe` can only process messages from trusted domains that are specified in the **glide.ui.concourse.onmessage\_enforce\_same\_origin\_whitelist** property. To learn more, see Specify UTL allow list for cross-origin iframe communication.
...
|References|[OpenFrame overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/c_OpenFrameOverview.md)|
