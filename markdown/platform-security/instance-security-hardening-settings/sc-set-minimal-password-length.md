...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/instance-security-hardening-settings/sc-set-minimal-password-length.html
release: yokohama
...
For more information configuring a password policy, see [Enabling password policies on your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/enable-password-policies.md).
