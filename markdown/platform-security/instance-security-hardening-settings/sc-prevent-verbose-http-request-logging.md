...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/instance-security-hardening-settings/sc-prevent-verbose-http-request-logging.html
release: yokohama
...
The **glide.outbound\_http\_log.override** system property enables you to override outbound http request log level. A value of **false** defaults the log level to basic.
 ...
 For additional details, see [Configure outbound logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/web-services/outbound-logging-configure.md).
...
**Parent Topic:**[Error handling and logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/instance-security-hardening-settings/sc-error-handling-logging.md)
