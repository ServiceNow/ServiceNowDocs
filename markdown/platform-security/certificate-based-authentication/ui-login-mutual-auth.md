...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/certificate-based-authentication/ui-login-mutual-auth.html
release: xanadu
...
If you need an admin to register your client certificate, see [Map PEM certificate to user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/certificate-based-authentication/set-up-mutual-auth.md).
...
-   Make sure that a client certificate of your PIV or CAC card is mapped to you. For more information, see [Register CA certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/certificate-based-authentication/set-up-mutual-auth.md).
