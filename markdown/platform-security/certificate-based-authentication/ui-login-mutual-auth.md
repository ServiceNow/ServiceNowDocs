...
[Manage your client certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/certificate-based-authentication/ui-login-mutual-auth.md)

[Register client certificate for your PIV or CAC card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/certificate-based-authentication/ui-login-mutual-auth.md)

[Log in to ServiceNow AI Platform using PIV or CAC card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/certificate-based-authentication/ui-login-mutual-auth.md)
...
If you need an admin to register your client certificate, see [Map PEM certificate to user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/certificate-based-authentication/map-user-pem-certificate.md).
...
-   Make sure that a client certificate of your PIV or CAC card is mapped to you. For more information, see [Register CA certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/certificate-based-authentication/map-ca-cert-chain.md).
