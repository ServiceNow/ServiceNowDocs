...
breadcrumb: [Create data filtration rules, Data filtration\(Legacy\), Access Management]
---
...
2.  Use the condition builder to filter the table records their field values.
    ...
    The data filter uses the same condition builder used in other parts of the platform. For details on using this interface, see [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=australia&pubname=australia-platform-user-interface&ft:locale=en-US).
