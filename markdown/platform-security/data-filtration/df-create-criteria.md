...
**Important:** To create or modify data filtration rules you, must elevate to a privileged role. For details on this process, see [Elevate to a privileged role](t_ElevateToAPrivilegedRole.md).
