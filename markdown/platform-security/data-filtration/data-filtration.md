...
-   **Subject criteria records**
    ...
    Subject criteria \[sys\_df\_subject\_criteria\] records represent specific user attributes you can use to determine whether to grant access with a Data filtration rule. These attributes can be a user's groups, roles, or IP address. To create a subject criteria, you must create the subject criteria record, as well as criteria input and criteria conditions records. For details on this process, see [Create subject criteria](../task/df-create-criteria.md).
