...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/les-kafka-consumer.html
release: yokohama
topic_type: concept
...
\[Omitted image "les-kafka-setup.png"\] Alt text: LES Guided setup for Kafka consumers
...
\[Omitted image "les-kafka-categories.png"\] Alt text: Categories page for LES Guided setup

Complete the tasks under each category by following the setup instructions.

**Parent Topic:**[Configuring Log Export Service \(LES\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/les-configure.md)
...
2.  Generate certificates for a secure connection to Hermes Messaging Service and pull log events from it.
    ...
    Setup secure connection to Hermes Messaging Service. See [Set up a secure connection to the Hermes Messaging Service for LES](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/les-hermes-cert.md) for more information. You will need these certificates for authentication and authorization in the client which will pull the logs from Hermes.
