 ...
 **Note:** Some automated processes use the system or guest user to apply and track changes to records. For more information, see [System and guest users](https://www.servicenow.com/docs/access?context=user&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US#system-guest-users).
