...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/machine-identity-access-controls.html
release: brazil
topic_type: concept
...
See [Create a machine identity access control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/create-a-machine-identity-access-control.md) to learn how to create a machine identity access control
