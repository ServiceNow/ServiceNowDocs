...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/explore-zero-trust-access.html
release: xanadu
topic_type: concept
...
-   Reduce access based on IDP response for a user session, if the user is using an untrusted device. For more information, see [Configure IDP attribute for Session Access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/configure-idp-session-access.md).
