...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/explore-zero-trust-access.html
release: yokohama
topic_type: concept
...
-   Reduce access based on IDP response for a user session, if the user is using an untrusted device. For more information, see [Configure IDP attribute for Session Access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/configure-idp-session-access.md).
...
For more information, see [Configure Zero Trust Access for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/mobile/configure-zero-trust-access-mobile.md).
