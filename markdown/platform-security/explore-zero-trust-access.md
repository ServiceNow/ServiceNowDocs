...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/explore-zero-trust-access.html
release: zurich
topic_type: concept
...
For more information, see [Configure Zero Trust Access for mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/mobile/configure-zero-trust-access-mobile.md).
