...
3.  Configure the property value as a comma-separated list of roles: **admin, itil**.
    ...
    To learn more, see [Configure Next Experience pickers](https://www.servicenow.com/docs/access?context=next-experience-pickers&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
