...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/dictionary-attributes-antivirus-scan.html
release: australia
...
|----|-----|--------------|-----------|
|Exclude\_from\_antivirus\_scan|true/false|any table|If true, file attachments on the table are excluded from the antivirus scan. See [Configuring Antivirus Scanning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/configure-antivirus-protection.md)|
