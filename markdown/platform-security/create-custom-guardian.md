...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/create-custom-guardian.html
release: australia
topic_type: task
...
Configure a connection and credential alias for your preferred provider. For more information, see [Create a Connection &amp; Credential alias](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/connections-and-credentials/connection-alias.md).
