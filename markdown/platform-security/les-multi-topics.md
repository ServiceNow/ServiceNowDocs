...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/les-multi-topics.html
release: xanadu
topic_type: task
...
**Parent Topic:**[Create a log source configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-create-source-configuration.md)
