...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/sign-specific-records.html
release: yokohama
topic_type: concept
...
2.  In the trusted instance, create a signing job to sign the record. This process is detailed in [Create a job to sign specific records or attachments on a trusted instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/sign-files-nonprod.md).
...
-   **[Create a job to sign specific records or attachments on a trusted instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/sign-files-nonprod.md)**  
