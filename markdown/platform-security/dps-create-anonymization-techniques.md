...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/dps-create-anonymization-techniques.html
release: yokohama
topic_type: task
...
Transforms String data and selectively replaces sensitive characters with the letter X.**Note:** Default technique for data patterns in [Exploring Data Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/data-discovery/data-discovery.md).
...
Only anonymizes discovered data patterns within unstructured data fields while keeping underlying context intact. **Note:** Settings for this technique reference data pattern anonymization technique settings in [Exploring Data Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/data-discovery/data-discovery.md).
...
Preserves the format, context, and statistical properties of the original data with a synthetic replacement. Default data patterns support 10 synthetic values by default. See \_\_ to configure synthetic values.**Note:** Only available for the [data channels in real time anonymization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/data-privacy-classic/data-channels-for-rta.md).
...
See [Create anonymization policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/dps-create-anonymization-policies.md) to configure an anonymization policy to specify which techniques are used when anonymizing your data.
