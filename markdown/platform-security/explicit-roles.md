...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/explicit-roles.html
release: yokohama
topic_type: concept
...
-   Role assignment does not apply to a newly created ACL with a role assigned.
