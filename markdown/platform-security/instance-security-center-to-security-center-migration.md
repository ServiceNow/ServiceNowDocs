...
-   Visualize session activities using the [Analytics Hub](https://www.servicenow.com/docs/access?context=c_UsePerformanceAnalyticsScorecards&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
