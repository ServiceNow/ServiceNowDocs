...
-   Visualize session activities using the [Analytics Hub](https://www.servicenow.com/docs/access?context=c_UsePerformanceAnalyticsScorecards&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
