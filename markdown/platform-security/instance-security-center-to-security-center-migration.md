...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/instance-security-center-to-security-center-migration.html
release: zurich
topic_type: concept
...
-   Visualize session activities using the [Analytics Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/c_UsePerformanceAnalyticsScorecards.md).
