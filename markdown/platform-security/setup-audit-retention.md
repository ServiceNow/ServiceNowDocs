...
6.  Select **Generate Estimate** to view the approximate number of audit records that are older than your selected duration.
    ...
    For information about generate estimate, see [Enable an audit deletion estimate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/configure-audit-deletion-estimation.md)
