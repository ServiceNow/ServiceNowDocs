...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/identity/handling-umapped-fields.html
release: yokohama
product: Identity
...
During SCIM customization, the fields that are not part of the sys\_user and sys\_user\_group tables can be mapped by performing the following functions.
