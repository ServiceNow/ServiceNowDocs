...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/identity/create-scim-provider.html
release: yokohama
product: Identity
...
3.  On the form, fill in the fields.
    ...
    |Outbound REST Message|Message that is used to call the API of the SCIM Provider. For more information, see [Create a REST message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/identity/create-a-rest-message.md).|
