...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/identity/explore-scim-provider.html
release: australia
product: Identity
...
-   Activate the **SCIM v2 - ServiceNow Cross-domain Identity Management** plugin. To learn more, see [Activating the SCIM plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/identity/activate-scim-plugin.md).​
-   Activate the other plugins that other plugins that are required for SCIM:
    -   [OAuth 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/authentication/t_SettingUpOAuth.md)
    -   REST API Provider
    -   [REST API Access Policy​](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/authentication/activate-rest-api-access-policy.md)
