...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/identity/create-scim-etl-definitions.html
release: yokohama
product: Identity
...
1.  Follow the instructions in [Create Extract Transform Load \(ETL\) definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/system-import-sets/create-etl-definitions.md).
...
[Create Extract Transform Load \(ETL\) definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/system-import-sets/create-etl-definitions.md)
