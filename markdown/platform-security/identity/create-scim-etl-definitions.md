...
1.  Follow the instructions in [Create Extract Transform Load \(ETL\) definitions](https://www.servicenow.com/docs/access?context=create-etl-definitions&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
...
[Create Extract Transform Load \(ETL\) definitions](https://www.servicenow.com/docs/access?context=create-etl-definitions&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
