...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/identity/use-access-insights.html
release: yokohama
product: Identity
...
**Note:** To view the details of though Access Insights feature, you must use the [Compare user access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/identity/comparing-access-controls.md) feature.
