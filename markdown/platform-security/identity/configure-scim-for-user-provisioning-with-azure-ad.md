...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/identity/configure-scim-for-user-provisioning-with-azure-ad.html
release: xanadu
product: Identity
...
-   [Provisioning user using Basic Authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/identity/provisioning-user-basic-auth.md)
-   [Provisioning user using OAuth](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/identity/provisioning-user-oauth.md)
