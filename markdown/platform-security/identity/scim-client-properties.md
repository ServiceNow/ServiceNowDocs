...
To know more about the scriptable API, see [SCIM2Client API](https://www.servicenow.com/docs/access?context=SCIM2ClientAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
