...
To know more about the scriptable API, see [SCIM2Client API](https://www.servicenow.com/docs/access?context=SCIM2ClientAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
