...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/identity/scim-client-properties.html
release: xanadu
product: Identity
...
To know more about the scriptable API, see [SCIM2Client API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/server-api-reference/SCIM2ClientAPI.md).
