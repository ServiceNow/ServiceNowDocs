...
To know more about the SCIM API, see [System for Cross-domain Identity Management \(SCIM\) API](https://www.servicenow.com/docs/access?context=scim-api&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
