...
[SCIM Provider \[Omitted image "bus-explore.svg"\] Alt text: Explore](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/identity/scim-provider.md)

 [The SCIM provider synchronizes the changes made to identities in the IdP, including creating, updating, or deleting records.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/identity/scim-provider.md)

</td><td>

[SCIM Client \[Omitted image "bus-learn.svg"\] Alt text: Reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/identity/scim-client-app.md)

 [The SCIM Client is used for creating, updating, and deleting identity resources in a system that supports SCIM compliant REST requests.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/identity/scim-client-app.md)
