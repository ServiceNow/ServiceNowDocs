...
-   User name and email are used to generate Federated IDs by default. To update the fields for generating Federated IDs based on your requirement, see [Update ID fields](../task/updating-id-fields.md).
