...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/identity/configure-federated-id-criteria.html
release: yokohama
product: Identity
...
2.  The Federated ID Criterias page, displays the record with the following details:
    ...
    **Note:** Only the ID fields can be updated to generate a new Federated ID for the existing records. To know more, see [Updating ID fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/identity/updating-id-fields.md).
