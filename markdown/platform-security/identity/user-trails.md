...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/identity/user-trails.html
release: yokohama
product: Identity
...
|User Sys id|Details about the User sys\_id for the audited record.|
