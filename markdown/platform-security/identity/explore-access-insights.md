...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/identity/explore-access-insights.html
release: yokohama
product: Identity
...
To enable Access Insights in the Access Analyzer, you must navigate to the Settings. To learn more, see [Configure Access Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/identity/configure-access-insights.md).
