...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/identity/configure-tables-and-fields.html
release: xanadu
product: Identity
...
**Note:** To understand which fields can be configured for the tables, see [Fields supported and not supported for Identity Access and Audit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/identity/allowed-fields-for-audit.md).
