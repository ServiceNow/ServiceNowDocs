...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/migrate-ee-to-fe-1.html
release: yokohama
topic_type: task
...
**Parent Topic:**[Migrate from Edge Encryption to Field Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/migrate-ee-to-fe.md)
