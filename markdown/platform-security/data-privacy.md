...
Use [Data privacy](../../data-privacy-store/concept/dps-data-privacy.md) to classify sensitive data and to remove personally identifiable information \(PII\) from user data in a production instance and anonymize data in non-production instances.

**Note:** You can also use the legacy plugin [Data privacy \(Classic\)](../reference/data-privacy-classic.md).
