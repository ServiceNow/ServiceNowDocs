...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-privacy.html
release: australia
topic_type: concept
...
-   [Data privacy \(Classic\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/data-privacy-classic.md): First use the data classification app to group your data by type, using pre-defined or user-defined data classifications. Then create data privacy techniques and jobs to anonymize PII.
-   [Data privacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-privacy-classic/dps-data-privacy.md) \(Store App\): Classify and anonymize your data all from within the data privacy app.
