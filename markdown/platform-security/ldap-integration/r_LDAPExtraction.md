...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/ldap-integration/r\_LDAPExtraction.html
release: xanadu
...
[LDAP refresh filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/ldap-integration/r_LDAPRefreshFilters.md) use multiple import jobs to divide different types of user records, segregating records for separate processing.
