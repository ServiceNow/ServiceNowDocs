...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/ldap-integration/r\_LDAPExtraction.html
release: yokohama
...
[LDAP refresh filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/ldap-integration/r_LDAPRefreshFilters.md) use multiple import jobs to divide different types of user records, segregating records for separate processing.
