...
Decide whether to retain or [Delete all records from a table](https://www.servicenow.com/docs/access?context=t_DeleteAllRecordsFromATable&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) according to your organization's needs.
