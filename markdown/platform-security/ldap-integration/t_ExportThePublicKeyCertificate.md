...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/ldap-integration/t\_ExportThePublicKeyCertificate.html
release: xanadu
...
See [Install the LDAP X.509 SSL certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/ldap-integration/t_UploadTheX509SSLCertificate.md) to upload the certificate into the application.
