...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/ldap-integration/t\_ExportThePublicKeyCertificate.html
release: yokohama
...
See [Install the LDAP X.509 SSL certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/ldap-integration/t_UploadTheX509SSLCertificate.md) to upload the certificate into the application.
