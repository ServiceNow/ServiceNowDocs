...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/ldap-integration/r\_LDAPIntegrationRequirements.html
release: australia
...
-   The external IP address or fully-qualified domain name of the LDAP server. You can also use a [MID server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/ldap-integration/c_LDAPIntegrationViaMIDServer.md).
