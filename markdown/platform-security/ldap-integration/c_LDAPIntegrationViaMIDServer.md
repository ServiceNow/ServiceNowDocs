...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/ldap-integration/c\_LDAPIntegrationViaMIDServer.html
release: xanadu
...
For a secure communication over SSL, you must [add an SSL certificate for the MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/mid-server/add-ssl-certificates.md). Change the LDAP server URL from LDAP to LDAPS and change to port 636.
...
To set connection properties for a specific LDAP server, see [Define an LDAP server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/ldap-integration/t_DefineAnLDAPServer.md).
