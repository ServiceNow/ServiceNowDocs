...
For a secure communication over SSL, you must [add an SSL certificate for the MID Server](https://www.servicenow.com/docs/access?context=add-ssl-certificates&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US). Change the LDAP server URL from LDAP to LDAPS and change to port 636.
