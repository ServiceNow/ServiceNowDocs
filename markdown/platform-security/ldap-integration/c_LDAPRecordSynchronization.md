...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/ldap-integration/c\_LDAPRecordSynchronization.html
release: yokohama
...
The import process can use [LDAP refresh filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/ldap-integration/r_LDAPRefreshFilters.md)on multiple import jobs to divide different types of user records and segregarte records for separate processing.
