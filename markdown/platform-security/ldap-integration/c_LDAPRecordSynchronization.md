...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/ldap-integration/c\_LDAPRecordSynchronization.html
release: xanadu
...
The import process can use [LDAP refresh filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/ldap-integration/r_LDAPRefreshFilters.md)on multiple import jobs to divide different types of user records and segregarte records for separate processing.
