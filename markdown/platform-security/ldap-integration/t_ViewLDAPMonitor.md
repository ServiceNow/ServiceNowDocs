...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/ldap-integration/t\_ViewLDAPMonitor.html
release: xanadu
...
As you monitor LDAP servers, you can [make changes to the properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/ldap-integration/t_DefineAnLDAPServer.md) by clicking **Edit** in the LDAP Server Monitor screen.
