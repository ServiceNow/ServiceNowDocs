...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/ldap-integration/c\_SetUpADAMSync.html
release: zurich
...
breadcrumb: [Use ADAMSync to populate ADAM, Active Directory Application Mode \(ADAM\), LDAP integration, Access Management]
---
