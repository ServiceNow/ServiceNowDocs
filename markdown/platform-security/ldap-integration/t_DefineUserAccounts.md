...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/ldap-integration/t\_DefineUserAccounts.html
release: xanadu
...
3.  Test the new accounts by using LDP as defined in [Active Directory Application Mode \(ADAM\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/ldap-integration/c_ActiveDirectoryApplicationMode.md) to make sure they can connect.
