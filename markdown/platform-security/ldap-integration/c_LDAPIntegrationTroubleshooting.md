...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/ldap-integration/c\_LDAPIntegrationTroubleshooting.html
release: yokohama
...
See [LDAP transform maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/ldap-integration/c_LDAPTransformMaps.md) to set how the integration processes incoming LDAP records that are missing matching values in reference fields.
