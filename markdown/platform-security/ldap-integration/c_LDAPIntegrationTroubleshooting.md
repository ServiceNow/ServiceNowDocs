...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/ldap-integration/c\_LDAPIntegrationTroubleshooting.html
release: xanadu
...
See [LDAP transform maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/ldap-integration/c_LDAPTransformMaps.md) to set how the integration processes incoming LDAP records that are missing matching values in reference fields.
