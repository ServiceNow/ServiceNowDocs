...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/ldap-integration/c\_InactiveLDAPUserAccounts.html
release: xanadu
...
For more information on locating inactive accounts, see [Find inactive LDAP accounts by using the userAccountControl field](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/ldap-integration/t_FindInactLDAPAcctsWUsrAcctCtrlFld.md).
