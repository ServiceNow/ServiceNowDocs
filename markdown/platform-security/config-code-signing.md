...
-   **[Assign the Code Signing Administrator Role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cse-assign-roles.md)**

    Assign the Code Signing Administrator role to a user to access the Code Signing configuration experience.

-   **[Configure Code Signing Enterprise on your trusted instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cse-turn-on-cse.md)**

    Turn on Code Signing on your trusted instance.

-   **[Upload your Code Signing configuration file to your protected instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cse-upload-cs-config.md)**

    Upload the configuration file generated on your trusted instance.

-   **[Configure Code Signing Enterprise on your protected instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cse-ppi-config.md)**

    Turn on and configure Code Signing on your protected instance.

-   **[Turn on certificate validation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cse-turn-on-cert-validation.md)**

    Turn on certificate validation on your instance.

-   **[Turn off Code Signing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cse-turn-off-cse.md)**
...
-   **[Quorum Controlled Certificate Revocation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/certificate-revocation.md)**  
...
-   **[Turn off Code Signing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cse-turn-off-cse.md)**  
Disable code signing on your protected instance.
-   **[Load required key pairs and certificates for Code Signing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/circle-trust-setup.md)**  
...
-   **[Prepare Circle of Trust certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/create-updateset-nonprod.md)**  
Create an update set in the trusted environment to export the trusted certificate to the production environment.
-   **[Import and install certificates for Circle of Trust](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/retrieve-updateset-prod.md)**  
...
-   **[Turn on Code Signing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/enable-codesiging.md)**  
...
-   **[Create Code Signing key pairs and certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/create-key-pairs-and-certs.md)**  
Create two key pairs to signed certificates to establish trust between your protected and trusted instances.
-   **[Specify custom rules in ECC firewall](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/custom-yaml-conf.md)**  
...
-   **[Change your Root of Trust configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/change-rot-overview.md)**  
...
**Parent Topic:**[Code Signing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/code-signing-landing.md)
