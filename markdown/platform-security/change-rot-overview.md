...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/change-rot-overview.html
release: xanadu
topic_type: concept
...
Learn more about these steps in [Migrate signatures to use a customer certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/migrate-sigs-customer-rot.md) and [Disable ServiceNow Root of Trust](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/disable-sn-rot.md).
...
-   **[Migrate signatures to use a customer certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/migrate-sigs-customer-rot.md)**  
