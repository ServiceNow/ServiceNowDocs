...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/rest-soap-code-sign.html
release: yokohama
topic_type: task
...
**Parent Topic:**[Sign the REST and SOAP messages in the production instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/cs-rest-soap.md)
