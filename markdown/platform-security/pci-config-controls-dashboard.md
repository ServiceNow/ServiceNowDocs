...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/pci-config-controls-dashboard.html
release: xanadu
topic_type: concept
...
</table>**Parent Topic:**[Check the daily compliance score and configure security property settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/instance-sec-center-hardening.md)
