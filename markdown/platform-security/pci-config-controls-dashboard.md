...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/pci-config-controls-dashboard.html
release: yokohama
topic_type: concept
...
\[Omitted image "pci-config-control-score.png"\] Alt text: PCI compliance score dashboard with sample values
...
</table>**Parent Topic:**[Check the daily compliance score and configure security property settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/instance-sec-center-hardening.md)
