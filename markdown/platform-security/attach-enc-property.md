...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/attach-enc-property.html
release: australia
topic_type: task
...
You must elevate to the security\_admin role performing these steps. For instructions, see [Elevate to a privileged role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/t_ElevateToAPrivilegedRole.md)
