...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/attach-enc-property.html
release: yokohama
topic_type: task
...
You must elevate to the security\_admin role performing these steps. For instructions, see [Elevate to a privileged role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/t_ElevateToAPrivilegedRole.md)
