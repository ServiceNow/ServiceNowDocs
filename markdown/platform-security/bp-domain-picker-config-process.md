...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/bp-domain-picker-config-process.html
release: zurich
topic_type: concept
