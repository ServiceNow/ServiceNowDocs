...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/bp-domain-picker-config-process.html
release: yokohama
topic_type: concept
