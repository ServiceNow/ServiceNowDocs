...
[Zero Trust Access![](../../../reuse/icons/brand-icons/bus-agent-workspace-1.svg)](../../../integrate/authentication/concept/session-access.md)
...
[Domain Separation![Icon for working with Admin Center](../../../reuse/icons/brand-icons/bus-gender-neutral-leader-c-suite.svg)](../../company-and-domain-separation/reference/domain-sep-landing-page.md)

 [With the ServiceNow Platform, service providers \(SPs\) can provide their customers with faster onboarding, meet compliance, and protect their data using domain separation.](../../company-and-domain-separation/reference/domain-sep-landing-page.md)
