...
description: Column Level Encryption Enterprise utilizes the Key Management Framework \(KMF\) to enable you to customize and manage how fields and attachments are encrypted and decrypted on your instance. A subscription is required to utilize Column Level Encryption Enterprise.
locale: en-US
release: xanadu
topic_type: concept
...
For field encryption support see or [Column Level Encryption Enterprise](now-platform-encryption.md) for premium field and attachment encryption support.
...
Support for both field encryption and attachment encryptionBoth field encryption and attachment encryption utilize cryptographic modules and access policies through Encrypted Field Configurations. The Encrypted Field Configuration form is used to choose an encryption type of column or attachment encryption. See [Set encrypted field configurations](../../encryption/task/set-encrypted-field-config.md) for more information and supported field types.
