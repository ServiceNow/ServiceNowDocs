...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/security-admin-role.html
release: australia
topic_type: concept
