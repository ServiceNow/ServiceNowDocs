...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/security-admin-role.html
release: yokohama
topic_type: concept
