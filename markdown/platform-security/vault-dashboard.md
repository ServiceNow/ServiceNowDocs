...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/vault-dashboard.html
release: zurich
topic_type: concept
...
Use generative AI to streamline your tasks in ServiceNow Vault. For example, you can ask Now Assist to schedule a data discovery job for you. Prerequisite: Enable skills in AI Admin Hub console. For more information, see [Activate an AI skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/configure-a-now-assist-skill.md) and [Using Now Assist for Vault](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/using-now-assist-vault.md).

</td></tr><tr><td>

[Guided Vault](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/guided-vault.md)

</td><td>

Guided setups cards for applications

</td><td>

Select the **Get Started** button on an applications card to start using ServiceNow Vault with that application. Read more about guided setup here:[Use guided setup for ServiceNow Vault](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/use-vault-guided-setup.md).

</td></tr><tr><td rowspan="2">

[Vault tools and metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/vault-tools.md)
...
-   [Field Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/field-encryption.md)
-   [Zero Trust Access \(ZTA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/session-access.md)
...
Select the dropdown to review various metrics and graphs about a tool. **Note:** Find out more information about the metrics by reviewing the respective tool's homepage.

</td></tr></tbody>
</table>-   **[Guided Vault](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/guided-vault.md)**  
...
**Parent Topic:**[ServiceNow Vault](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/servicenow-vault-landing.md)
