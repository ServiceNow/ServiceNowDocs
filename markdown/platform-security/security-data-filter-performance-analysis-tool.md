...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/security-data-filter-performance-analysis-tool.html
release: yokohama
topic_type: task
...
2.  Set the property `glide.security.data_filter.diagnostic_enabled` to **true**.
    ...
    If the property does not exist in the System Properties table, read [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_AddAPropertyUsingSysPropsList.md) and add the property manually.

3.  Navigate to **All** &gt; **System Security** &gt; **Security Data Filters**.

4.  Select a security data filter to analyze.

5.  Select **Analyze Performance** under **Related Links**.\[Omitted image "secdf-analyzeperflink.svg"\] Alt text: Analyze performance related link

6.  In the form, fill in the fields as needed.\[Omitted image "secdf-analyzeperfconfig.svg"\] Alt text: Data filter example
...
The number of currently active data filters that may impact performance. Select the information icon \(\[Omitted image "info-icon.png"\] Alt text: information icon\) to view the active data filters.
