...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/les-landing-page.html
release: xanadu
topic_type: concept
...
**Note:** You can also create a new source configuration. See [Create a log source configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-create-source-configuration.md) for more information.

-   **[Log Export Service roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-roles.md)**  
Log Export Service is installed with these roles.
-   **[Log sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-log-sources-export.md)**  
Log Export Service \(LES\) can export log sources from some System Log Tables, the Audit Table, and Application Node Log Files.
-   **[Create a log source configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-create-source-configuration.md)**  
Regulate and set filters on the logs to be forwarded by creating a log source configuration.
-   **[Kafka consumer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-kafka-consumer.md)**  
...
-   **[MID server consumer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-mid-server-consumer.md)**  
Use guided setup to step through the initial configuration of LES. Guided setup assists you with planning the roll-out of the product and performing the basic configuration to go live.
-   **[Set up a secure connection to the Hermes Messaging Service for LES](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-hermes-cert.md)**  
Secure your Kafka topics by generating a ServiceNow® instance-signed certificate.
-   **[Review log report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-review-log-exports.md)**  
