...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/security-center/implement-steps-for-critical-updates.html
release: yokohama
...
4.  Implement the update steps.
    ...
    2.  Click **Mark complete** when you are done with a set of instructions.

    3.  Repeat steps a-b until you have completed all of the update steps.
