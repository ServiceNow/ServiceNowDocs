...
breadcrumb: [Create new suite, Scan suites, Security scanner, Security configuration console, Security Center, Platform Security]
---
...
1.  Navigate to access control auditor suite by selecting **Scanner** &gt; **Suites** &gt; **Access Controls Auditor** suite. Then, to review the suite checks, select the **Checks** tab.

    You should see the list of 8 checks available for the suite.

2.  Select the name of a check you want to analyze.

3.  Analyze the fields associated with the check.
