...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/security-center/scan-results.html
release: xanadu
...
-   **Failures**
    ...
    Displays the checks that failed during the execution of the scan and the reason of its failure in the form of an error message.
