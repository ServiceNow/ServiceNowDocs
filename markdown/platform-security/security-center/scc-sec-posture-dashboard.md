...
You may add or remove instances that appear on this dashboard by modifying your trust configuration. Providing data visibility between instances allows them to appear within your dashboard. For details on this process, see [Configure data synchronization for applications](https://www.servicenow.com/docs/access?context=grant-access-other-instances&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
