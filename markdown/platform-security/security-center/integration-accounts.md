...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/security-center/integration-accounts.html
release: xanadu
...
Select the **+Create task** button to create a Security Task related to a metric. For details on Security Tasks, see .
