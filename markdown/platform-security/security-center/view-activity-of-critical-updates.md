...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/security-center/view-activity-of-critical-updates.html
release: yokohama
...
3.  Click a state, and then select a Customer Action from that state.
    ...
    \[Omitted image "critical-updates-complete-state.png"\] Alt text: different states of Customer Actions

4.  View the activity of your Customer Action.

    \[Omitted image "critical-updates-activity.png"\] Alt text: Customer Action activities
...
**Parent Topic:**[Customer Actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/security-center/critical-updates.md)
