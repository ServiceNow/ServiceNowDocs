...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/schedule-audits.html
release: xanadu
topic_type: task
...
You [configured one or more audits](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/configure-domain-separation-audits.md) to run daily, weekly, or monthly. The scheduler specifies what days and times to run those audits. All audits with the same scheduling frequency run sequentially starting at the time you configure.
