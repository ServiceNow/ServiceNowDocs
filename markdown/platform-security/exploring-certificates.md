...
-   [Outbound web service mutual authentication](https://www.servicenow.com/docs/access?context=c_OutboundWebServicesMutualAuth&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
-   [Web service security](../../security/concept/c_WebServiceSecurity.md)
-   [MID Server](https://www.servicenow.com/docs/access?context=add-ssl-certificates&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)
