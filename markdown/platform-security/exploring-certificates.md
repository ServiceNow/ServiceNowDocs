...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/exploring-certificates.html
release: yokohama
topic_type: concept
...
-   [LDAPS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/ldap-integration/r_LDAPIntegrationFAQs.md)
-   [Outbound web service mutual authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/web-services/c_OutboundWebServicesMutualAuth.md)
...
-   [MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/add-ssl-certificates.md)
...
**Note:** To learn more about the properties that affect the use of certificates, see [Communications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/instance-security-hardening-settings/sc-communications.md) in Instance Security Hardening Settings.
