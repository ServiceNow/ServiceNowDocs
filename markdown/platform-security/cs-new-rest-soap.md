...
description: Sign and validate the new REST and SOAP messages from the trusted instance by enabling the Code Signing in production and trusted instances.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/cs-new-rest-soap.html
release: xanadu
topic_type: task
...
2.  In the trusted non-production instance, create the required REST or SOAP messages.
...
6.  In the production instance, import the update set.
...
**Parent Topic:**[Sign the REST and SOAP messages in the production instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cs-rest-soap.md)
