...
The **All Patterns** table lists all current patterns. Note that inactive patterns will show up in this list.See [Create new data pattern](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/data-discovery/dds-create-new-data-pattern.md) to create a new data pattern.
...
The **Active Patterns** table lists all of the current active data patterns. See [Select active data patterns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/data-discovery/dds-active-data-patterns.md) to learn how set a pattern to active and used by discovery jobs.
...
The **Target Tables** table lists all tables currently selected for discovery jobs. See [Select target tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/data-discovery/dds-select-target-tables.md) to select tables for use in discovery jobs.
