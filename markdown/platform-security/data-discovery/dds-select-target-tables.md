...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-discovery/dds-select-target-tables.html
release: australia
...
4.  Check the tables to target, they will show in the right side of the pop-up.
    ...
    **Note:** Target tables will scan all columns, unless specified otherwise [in policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-discovery/dds-new-policy.md).
...
Selected tables will now be targeted by [scheduled discovery jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-discovery/dds-scheduled-discovery.md).
