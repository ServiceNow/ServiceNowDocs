...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/data-discovery/data-discovery-findings.html
release: brazil
...
Users may select the **Track Granular Findings** action to use the [Granular Findings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/data-discovery/granular-findings.md) page to take action on specific discovered records. See [Granular Findings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/data-discovery/granular-findings.md) for more information.

## Available Protections

Select the **Available Protections** button to review an entries control service, status, notes, and last check in. As of Xanadu this feature supports only [Field Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/field-encryption.md).

Protecton services can also be accessed from the Dashboard. For more information on the dashboard see, [Data Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/data-discovery/data-discovery-landing.md).
