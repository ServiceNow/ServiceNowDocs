...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-discovery/dds-scheduled-discovery.html
release: australia
...
The **Discovery Jobs** table lists all discovery jobs. See [Create discovery job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-discovery/dds-create-new-job.md) to create a new discovery job.
...
The **Discovery Findings** table lists all the discovered findings from discovery jobs. See [Review discovery findings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-discovery/dds-review-discovery-findings.md) to review and classify findings from discovery jobs.
...
The **Granular Configuration** table lists all granular discovery jobs. See [Create granular job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-discovery/dds-create-granular-job.md) to learn how to create a granular discovery job.
