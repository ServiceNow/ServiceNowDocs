...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-discovery/data-discovery-supported-data-types.html
release: australia
...
|Field type|Supported by default|
|----------|--------------------|
|audio|No|
|condition|Yes|
|condition\_string|Yes|
|currency|Yes|
|decimal|Yes|
|due\_date|Yes|
|float|Yes|
...
|translated\_html|Yes|
|translated\_text|Yes|
|url|Yes|
|user\_image|No|
|video|No|
|wiki\_text|Yes|
