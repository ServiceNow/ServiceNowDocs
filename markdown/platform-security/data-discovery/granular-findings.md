...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/data-discovery/granular-findings.html
release: xanadu
...
breadcrumb: [Scanning with Granular Configuration, Data Discovery, Platform Privacy]
---
...
**Granular Findings** is used to review up to 500 findings from [Granular Configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/data-discovery/granular-configuration.md). When there are 500 findings, scanning of Granular Configurations is paused until action is taken.
