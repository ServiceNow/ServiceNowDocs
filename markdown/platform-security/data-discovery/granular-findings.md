...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/data-discovery/granular-findings.html
release: yokohama
...
**Granular Findings** is used to review up to 500 findings from [Granular Configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/data-discovery/granular-configuration.md). When there are 500 findings, scanning of Granular Configurations is paused until action is taken.
