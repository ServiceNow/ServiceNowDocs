...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/data-discovery/dds-create-granular-job.html
release: australia
...
A granular scan is scheduled to run on the target table and column, after it executes you can [review the scan findings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/data-discovery/dds-review-granular-findings.md).
