...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/set-encrypted-field-config.html
release: xanadu
topic_type: task
...
In order to encrypt data that existed before the column was encrypted, you must run a separate mass encryption job. Learn more about mass encryption in [Run mass encryption or decryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/mass-enc-dec.md).
