...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/set-encrypted-field-config.html
release: yokohama
topic_type: task
