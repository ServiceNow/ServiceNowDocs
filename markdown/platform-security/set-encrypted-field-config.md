...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/set-encrypted-field-config.html
release: australia
topic_type: task
