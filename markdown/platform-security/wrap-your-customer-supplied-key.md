...
Now that your key is wrapped, you can upload it to your instance using the procedure in [Upload your customer-supplied key](upload-your-customer-supplied-key.md).
