...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/wrap-your-customer-supplied-key.html
release: australia
topic_type: task
...
2.  Select**View module details** from the **Field Encryption modules overview** to open the field encryption module that you’ve previously created.
    ...
    **Note:** If you haven't created a field encryption module yet, you can create one using the steps in [Configure Field Encryption modules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/configure-fe-modules.md).
...
5.  Verify that the **Origin** field has a value of **Upload customer supplied key**.
    ...
    If that value can't be selected, refer to steps 3–5 in [Configure Customer-supplied keys for Field Encryption Enterprise](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/fe-config-customer-supplied-keys.md).
...
**Parent Topic:**[Configure Customer-supplied keys for Field Encryption Enterprise](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/fe-config-customer-supplied-keys.md)
