...
**Note:** To learn more about these administrative role types, see [Special administrative roles](https://www.servicenow.com/docs/access?context=r_SpecialAdministrativeRoles&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
