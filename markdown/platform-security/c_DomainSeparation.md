...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/c\_DomainSeparation.html
release: zurich
topic_type: concept
...
\[Omitted image "bp-alternatives-to-DS.png"\] Alt text: Alternatives to domain separation
...
-   **[Configuration that can be delegated to internal or external customers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/ds-before-you-begin.md)**  
...
-   **[Domain assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/c_DomainAssignment.md)**  
By default, domain separation adds a domain field to tables and their extensions.
-   **[Visibility domains and Contains domains](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/c_DomainVisibility.md)**  
...
-   **[Domain scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/c_DomainScope.md)**  
Domain scope defines what users can and cannot access.
-   **[Concepts for service providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/sp-concepts.md)**  
These concepts work with the existing ServiceNow platform capabilities to help you solve for common use cases.
-   **[Installed with domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/r_InstalledWithDomainSeparation.md)**  
Several platform components are added or modified with domain separation.

**Parent Topic:**[Domain separation for service providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/domain-sep-landing-page.md)

**Related topics**  


[Domain separation recommended practices for service providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/bp-domain-sep-recommended.md)

[Domain separation plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/domain-sep-plugin.md)
