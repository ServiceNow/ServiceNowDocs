...
**Note:** To learn more about this property, see [Enforce URL allowlist check \[Updated in Security Center 1.3, 1.5, and 2.0\]](../../../administer/security-center/reference/sc-enforce-url-allowlist-check.md) in Instance Security Hardening Settings.
