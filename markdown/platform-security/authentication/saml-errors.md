...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/authentication/saml-errors.html
release: australia
...
**Note:** To learn more about this property, see [Enforce URL allowlist check](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/instance-security-hardening-settings/sc-enforce-url-allowlist-check.md) in Instance Security Hardening Settings.
