...
Unique id as part of request. The id can be a user name, employee id, and so on.**Note:** Both redirect and post binding is supported for request. The option to set this field only appears after a successful test connection. For more information, see [Testing IdP connections](../../single-sign-on/task/t_TestIdPConnections.md).
...
Unique id as part of response. The id can be a user name, employee id, and so on. **Note:** Both redirect and post binding is supported for response. The option to set this field only appears after a successful test connection. For more information, see [Testing IdP connections](../../single-sign-on/task/t_TestIdPConnections.md).
