...
description: Register a hardware key to use as part of your multi-factor authentication login.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/mfa-setup-hardware-key-auth.html
release: yokohama
...
Register a hardware key to use as part of your multi-factor authentication login.
