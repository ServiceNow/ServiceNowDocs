...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/unsupported-password-characters.html
release: yokohama
...
For more information about the password policy properties, see [password policy properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/password-policy-properties.md).
