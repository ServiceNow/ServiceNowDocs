...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/authentication/unsupported-password-characters.html
release: xanadu
...
For more information about the password policy properties, see [password policy properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/authentication/password-policy-properties.md).
