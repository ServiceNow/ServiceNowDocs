...
-   Role required: admin
-   [Activating External User Self-Registration](external-user-registration-plugin.md)
...
8.  Configure the **Advanced** tab to map user tables and redirection pages of the registration form.
    ...
    ![Registration Form Preview](../images/preview_registration_form.png "Registration Form Preview")
