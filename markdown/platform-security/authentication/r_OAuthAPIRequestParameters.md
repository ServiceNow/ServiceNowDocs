...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/r\_OAuthAPIRequestParameters.html
release: yokohama
...
breadcrumb: [Create an endpoint for clients to access the instance, OAuth Inbound, OAuth authentication, Authentication, Access Management]
---
