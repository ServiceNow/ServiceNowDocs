...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/authentication/faq-mfa-enforcement.html
release: australia
...
5.  What is the MFA requirement for existing customers?
    ...
    -   If the instance doesn’t already have the **Adaptive Authentication** – [Multi-factor Authentication context](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/authentication/mfa-auth-context.md) turned on, automatically it’s enabled as a default MFA policy.
