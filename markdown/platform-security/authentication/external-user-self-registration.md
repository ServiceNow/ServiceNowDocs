...
[Explore![Explore](../../../common/image/icon-explore.png)](explore-self-register.md)

 [Learn the features and business value of Self-register.](explore-self-register.md)

</td><td>

[Activate![Use](../../../common/image/icon-set-up.png)](../task/external-user-registration-plugin.md)

 [Understand how to Activate External Self-register.](../task/external-user-registration-plugin.md)

</td></tr><tr><td>

[Configure](../task/external-user-configuration.md)![Reviewing](../../../common/image/icon-manage.png)

 [Configure the Self-register.](../task/external-user-configuration.md)

</td><td>

[Enable![Reference](../../../common/image/icon-reference.png)](../task/sp-ext-user-self-reg.md)
