...
2.  Replace `<credential_sys_id>` and `<oauth_profile_sys_id>` with the appropriate record values.
    ...
    **Note:** For more information on the methods for requesting and revoking OAuth refresh and access tokens, see: [Glide OAuth Client API Documentation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/server-api-reference/c_GlideOAuthClient.md).
