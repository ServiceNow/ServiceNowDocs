...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/t\_ModifyPasswordResetNotification.html
release: yokohama
...
This process is relevant only if users are [Subscription-based notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/c_SubscriptionBasedNotifications.md).
...
3.  Modify the text of the email in the **What it will contain** section.
    ...
    For information on configuring other aspects of the notification, see [Create an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_CreateANotification.md).
