...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/create-knowledge-based-questions.html
release: yokohama
...
</table>    \[Omitted image "configure-kba-questions.png"\] Alt text: Knowledge Based Question \[Omitted image ""\] Alt text:
...
\[Omitted image "configure-kba-questions-result.png"\] Alt text: Knowledge Based Question - list
