...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/vonage-provider-config.html
release: yokohama
...
11. Create a custom provider in Multi-Factor Provider table.
    ...
    To know more about provider configuration, see [Configure MFA Provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/configure-mfa-provider.md).
