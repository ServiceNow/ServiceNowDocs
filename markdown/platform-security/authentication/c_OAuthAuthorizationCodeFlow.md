...
You can manage the tokens, including revoking the token, in the instance. See [Manage OAuth tokens](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/authentication/t_ManageTokens.md).
...
**Note:** The system also supports [OAuth implicit grants](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/authentication/c_OAuthImplicitGrants.md), also known as implicit grant code flow.
