...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/authentication/c\_OAuthAuthorizationCodeFlow.html
release: xanadu
...
breadcrumb: [OAuth Inbound, OAuth Inbound and Outbound authentication, Authentication, Access Management]
---
...
You can manage the tokens, including revoking the token, in the instance. See [Manage OAuth tokens](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/authentication/t_ManageTokens.md).
...
**Note:** The system also supports [OAuth implicit grants](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/authentication/c_OAuthImplicitGrants.md), also known as implicit grant code flow.
