...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/t\_UpdateExistingSAML2.0Integration.html
release: yokohama
...
1.  [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_AddAPropertyUsingSysPropsList.md) called glide.authenticate.sso.saml2.debug with a value of true.
...
4.  Identify and fix typical login errors.
    ...
    For more information, see [Multi-SSO \(SAML 2.0\) errors and fixes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/saml-errors.md).
