...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/authentication/t\_UpdateExistingSAML2.0Integration.html
release: xanadu
...
1.  [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/r_AvailableSystemProperties.md) called glide.authenticate.sso.saml2.debug with a value of true.
...
4.  Identify and fix typical login errors.
    ...
    For more information, see [Multi-SSO \(SAML 2.0\) errors and fixes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/authentication/saml-errors.md).
