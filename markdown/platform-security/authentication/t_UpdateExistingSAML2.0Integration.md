...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/authentication/t\_UpdateExistingSAML2.0Integration.html
release: zurich
...
4.  Identify and fix typical login errors.
    ...
    For more information, see [Multi-SSO \(SAML 2.0\) errors and fixes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/authentication/saml-errors.md).
