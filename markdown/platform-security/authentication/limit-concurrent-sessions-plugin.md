...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/limit-concurrent-sessions-plugin.html
release: yokohama
...
<table id="choicetable_dhn_fnq_hz"><tbody><tr><td id="d142878e95">
...
<table id="choicetable_upr_nc5_3z"><tbody><tr><td id="d142878e135">
...
[Setting a concurrent session limit by user or role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/set-session-limit-user-role.md).
