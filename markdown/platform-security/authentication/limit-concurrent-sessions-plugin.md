...
<table id="choicetable_dhn_fnq_hz"><tbody><tr><td id="d279897e101">
...
<table id="choicetable_upr_nc5_3z"><tbody><tr><td id="d279897e141">
...
[Set a concurrent session limit by user or role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/authentication/set-session-limit-user-role.md).
