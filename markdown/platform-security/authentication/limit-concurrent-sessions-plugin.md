...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/authentication/limit-concurrent-sessions-plugin.html
release: australia
...
<table id="choicetable_dhn_fnq_hz"><tbody><tr><td id="d267142e101">
...
<table id="choicetable_upr_nc5_3z"><tbody><tr><td id="d267142e141">
...
[Set a concurrent session limit by user or role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-security/authentication/set-session-limit-user-role.md).
