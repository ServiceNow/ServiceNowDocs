...
Cross-scope access policy. For more information, see [Application access settings](https://www.servicenow.com/docs/access?context=c_ApplicationAccessSettings&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
