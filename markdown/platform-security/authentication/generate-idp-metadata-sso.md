...
<table id="choicetable_eqz_pd4_pdb"><tbody><tr><td id="d40539e84">
...
7.  To use Google reCAPTCHA service, [set up an API key pair.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/t_ConfigureGoogleRecaptcha.md)
