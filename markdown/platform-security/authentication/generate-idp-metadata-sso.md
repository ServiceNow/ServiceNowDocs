...
<table id="choicetable_eqz_pd4_pdb"><tbody><tr><td id="d34432e77">
...
7.  To use Google reCAPTCHA service, [set up an API key pair.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/password-reset/t_ConfigureGoogleRecaptcha.md)
