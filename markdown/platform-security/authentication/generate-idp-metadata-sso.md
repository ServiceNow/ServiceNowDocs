...
<table id="choicetable_eqz_pd4_pdb"><tbody><tr><td id="d36587e77">
...
7.  To use Google reCAPTCHA service, [set up an API key pair.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/t_ConfigureGoogleRecaptcha.md)
