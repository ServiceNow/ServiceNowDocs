...
<table id="choicetable_eqz_pd4_pdb"><tbody><tr><td id="d37909e89">
...
7.  To use Google reCAPTCHA service, [set up an API key pair.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/t_ConfigureGoogleRecaptcha.md)
