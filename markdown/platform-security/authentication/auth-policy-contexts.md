...
Policies assigned to the MFA context define whether to enforce MFA during the login process. Whether your instance enforces MFA is determined by the configuration of policies in this context. For more detail on this context, see [MFA \(Multi-Factor Authentication\) context](mfa-auth-context.md).
