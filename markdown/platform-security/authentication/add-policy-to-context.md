...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/authentication/add-policy-to-context.html
release: xanadu
...
2.  In the **Default Policy** field, select a value.
    ...
    The available options in this field depend on the selected context. For details on these contexts, see [Authentication policy contexts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/authentication/auth-policy-contexts.md).
