...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/add-policy-to-context.html
release: yokohama
...
2.  In the **Default Policy** field, select a value.
    ...
    The available options in this field depend on the selected context. For details on these contexts, see [Authentication policy contexts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/auth-policy-contexts.md).
