...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/authentication/add-policy-to-context.html
release: australia
...
2.  In the **Default Policy** field, select a value.
    ...
    The available options in this field depend on the selected context. For details on these contexts, see [Authentication policy contexts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/authentication/auth-policy-contexts.md).
