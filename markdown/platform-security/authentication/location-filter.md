...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/authentication/location-filter.html
release: australia
...
-   Location filter is available with Zero Trust Access feature. For more information, see [Zero Trust Access \(ZTA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/session-access.md).
