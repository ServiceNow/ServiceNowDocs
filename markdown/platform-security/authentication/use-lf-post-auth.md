...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/use-lf-post-auth.html
release: yokohama
...
2.  Select the information icon to open the **Allow Policy** record.

    **Note:** The example described in this task is **Allow Policy**. You can also use **Deny Policy** and set the conditions accordingly to control the logins.
...
4.  Add the Role Filter criteria and Location Filter criteria.
    ...
    1.  Adding Role Filter criteria:
        ...
        For more information on how to create role filter criteria, see [Create role filter criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/create-role-filter-criteria.md).
    ...
    2.  Adding Location Filter criteria:
        ...
        For more information on how to create role filter criteria, see [Create location filter criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/create-location-filter-criteria.md).
