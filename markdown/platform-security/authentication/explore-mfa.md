...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/explore-mfa.html
release: yokohama
...
-   **Authenticator App**: Apps that generate unique, temporary verification codes. For example: Okta, Google Authenticator, Microsoft Authenticator, etc.
...
-   Local Database Authentication \(native ServiceNow authentication\) or [LDAP integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/ldap-integration/c_LDAPIntegration.md)
-   SSO SAML or SSO OIDC. For more information, see [Multi-Provider Single sign-on \(SSO\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/c_MultipleProviderSingleSignOn.md).
