...
[JSON Web token grant workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/authentication/using-json-web-token-grant.md)

[Configure an OAuth JSON web token bearer grant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/authentication/configure-an-oauth-jwt-bearer-grant.md)
