...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/activate-custom-url-plugin.html
release: yokohama
...
<table id="choicetable_dhn_fnq_hz"><tbody><tr><td id="d50630e115">
