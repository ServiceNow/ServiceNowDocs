...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/authentication/sso-esignature-approval-SAML.html
release: australia
...
1.  Activate or upgrade to SAML 2.0 with the [Activate Multi-Provider SSO plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/authentication/t_ActivateMultipleProviderSSO.md).

2.  Activate the [Approval with E-Signature plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/authentication/activate-approval-esignature.md).
...
<table id="choicetable_b2l_vpw_lz"><tbody><tr><td id="d251524e113">
