...
The [GlideJWT API](https://www.servicenow.com/docs/access?context=GlideJWTScopedAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) is a scoped, scriptable API which generates a JWT. There are three arguments necessary before generating the JWT:
