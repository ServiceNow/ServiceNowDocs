...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/authentication/t\_ConfigureMultiProviderSSOProps.html
release: zurich
...
breadcrumb: [Multi-Provider SSO configurations, Multi-Provider single sign-on \(SSO\), Access Management]
---
...
3.  To [update the user table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/authentication/t_AdministerSAMLUserProvisioning.md) with the users in the IdP, select the **Enable Auto Importing** option.
...
[SAML user provisioning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/authentication/c_SAMLUserProvisioning.md)
