...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/authentication/mfa-role-criteria.html
release: xanadu
...
breadcrumb: [Multi-factor authentication criteria, Configuring MFA, supported methods, and workflow, Multi-factor authentication \(MFA\), Authentication, Access Management]
---
...
<table id="choicetable_w45_gnx_bpb"><tbody><tr><td id="d29877e85">
