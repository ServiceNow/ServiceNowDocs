...
description: 
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/authentication/explore-digest-token.html
release: xanadu
...
**Note:** Use Time Limited Authentication \(TLA\) to configure time based expiry links. To know more, see [Time limited authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/authentication/time-limited-authentication.md).
