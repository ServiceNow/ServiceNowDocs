...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/authentication/explore-digest-token.html
release: australia
...
**Note:** Use Time Limited Authentication \(TLA\) to configure time based expiry links. To know more, see [Time limited authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/authentication/time-limited-authentication.md).
