...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/authentication/rest-api-auth-scope.html
release: zurich
...
To learn more about how to use the API Auth Scope in the new Inbound integration experience, see [Inbound integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/identity/inbound-integrations.md).
