...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/authentication/rest-api-auth-scope.html
release: australia
...
To learn more about how to use the API Auth Scope in the new Inbound integration experience, see [Inbound integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/identity/inbound-integrations.md).
