...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/t\_ConfigureADFSClaimRules.html
release: yokohama
...
13. Set the **Outgoing claim type** to `Name ID` and the **Outgoing name ID format** to `Email`.
    ...
    **Note:** These values must match the [Name ID policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/t_SetUpNameIDPolicy.md) you define during SAML 2.0 configuration.
