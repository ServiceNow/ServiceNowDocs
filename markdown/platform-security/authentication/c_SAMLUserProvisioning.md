...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/authentication/c\_SAMLUserProvisioning.html
release: xanadu
...
-   If none of the above conditions are true, the system uses the [Auto Redirect IdP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/authentication/t_CreateASAML2Upd1SSOConfigMultiSSO.md).
