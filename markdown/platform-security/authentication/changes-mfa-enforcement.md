...
-   Review the MFA Enforcement Properties and adjust based on your requirements. To learn more, see [Multi-factor Authentication enforcement properties](mfa-enforcement-properties.md).
