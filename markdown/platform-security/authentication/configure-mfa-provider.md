...
Choose **Twilio** or **Custom**.**Note:** To configure Twilio, see [Configure Notify with Twilio](https://www.servicenow.com/docs/access?context=t_ConfigureNotifyWithTwilio&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
