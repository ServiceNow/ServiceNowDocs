...
**Note:** For information about using a custom HTTPS protocol profile to enable mutual authentication, see [Create a protocol profile](https://www.servicenow.com/docs/access?context=t_CreateAProtocolProfile&version=australia&pubname=australia-api-reference&ft:locale=en-US).
