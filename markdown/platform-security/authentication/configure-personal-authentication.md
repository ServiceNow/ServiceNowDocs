...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/authentication/configure-personal-authentication.html
release: australia
...
For information on how to check if a personal OAuth token exists for a user, see [Get Personal OAuth Token \(using GlideOAuthClient\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/authentication/personal-oauth-token.md).

For information to generate the initial token for a user, who doesn’t have access to the credentials page, see [Generate Personal Auth Initiator URL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/authentication/generate-initial-token.md).
...
2.  Navigate to **Connection &amp; Credentials Aliases**, and create a connection alias.
    ...
    This alias is used in the REST steps. For more information, see [Create a Connection &amp; Credential alias](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/connections-and-credentials/connection-alias.md).
