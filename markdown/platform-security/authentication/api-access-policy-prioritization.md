...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/authentication/api-access-policy-prioritization.html
release: zurich
...
|Global but not Apply to all methods|8|If the fields **Global** is `true` and **Apply to all methods** is `false` then that policy takes the 8th priority.|
