...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/authentication/user-pub-cred.html
release: zurich
...
breadcrumb: [Web Authentication, MFA verification methods, Configure MFA, Multi-factor authentication, Access Management]
---
