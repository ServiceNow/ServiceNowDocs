...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/authentication/use-idp-filter-criteria.html
release: xanadu
...
1.  Use of IDP attribute in Post Authentication Policy Context.
    ...
    3.  In the Policy Input, create the Policy Input and Policy Condition.
        ...
        For more information on how to create Post Authentication Context with Policy and Condition, see [Post-authentication context](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/authentication/post-auth-context.md).
...
2.  Use of IDP attribute in MFA Policy Context.
    ...
    2.  In the Policy Input, create the Policy Input and Policy Condition.
        ...
        For more information on how to create MFA Context with Policy and Condition, see [MFA \(Multi-Factor Authentication\) context](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/authentication/mfa-auth-context.md).
...
3.  Use of IDP attribute in Zero Trust - Policy based session access.
    ...
    3.  In the Policy Input, create the Policy Input and Policy Condition.
        ...
        For more information on how to create Zero Trust - Policy based session access with Policy and Condition, see [Zero Trust Access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/servicenow-ai-platform-security/session-access.md).
