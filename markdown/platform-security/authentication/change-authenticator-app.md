...
description: Generate a new code to change the Authenticator app on your device.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/authentication/change-authenticator-app.html
release: xanadu
...
breadcrumb: [Authenticator Applications, Using Multi-factor authentication \(MFA\), Multi-factor authentication \(MFA\), Authentication, Access Management]
---

# Change Authenticator app

Generate a new code to change the Authenticator app on your device.
