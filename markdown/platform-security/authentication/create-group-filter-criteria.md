...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/create-group-filter-criteria.html
release: yokohama
...
6.  Click the save icon \[Omitted image "green-checkmark.png"\] Alt text: save icon.
