...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/faq-mfa-exception.html
release: yokohama
...
2.  How can the MFAs mandate be relaxed for certain roles?
    ...
    -   Under the **Policy Input** related list, select **Has MFA exempted role** filter criteria record.\[Omitted image "image.mfa-exempted-relaxed-input"\] Alt text: Policy Input
