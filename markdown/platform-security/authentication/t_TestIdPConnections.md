...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/authentication/t\_TestIdPConnections.html
release: yokohama
...
5.  Verify results using the **SSO Test Results/Summary** or the **Testing SSO Logs** section to see log messages.
    ...
    If there are any errors, refer to the [Multi-SSO \(SAML 2.0\) errors and fixes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/authentication/saml-errors.md)
