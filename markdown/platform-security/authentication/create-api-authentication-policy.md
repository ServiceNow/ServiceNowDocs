...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/authentication/create-api-authentication-policy.html
release: xanadu
...
5.  From the Policy Inputs tab, select **Edit** to add the existing Filter Criteria.
    ...
    You can also create a new Policy Input. For more information, see [Create policy inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/change-management/create-policy-input.md).
