...
-   For KBA, voice input is configured per question. For more information, see [Create KBA questions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/authentication/create-knowledge-based-questions.md)
