...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/authentication/c\_SAML2.0WebBrowserSSOProfile.html
release: zurich
...
**Note:** It is recommended that customers using an existing SAML 2.0 integration upgrade to the [Multi-Provider SSO plugin.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/authentication/t_ActivateMultipleProviderSSO.md)
