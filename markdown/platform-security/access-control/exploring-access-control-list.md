...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/access-control/exploring-access-control-list.html
release: xanadu
...
User can’t create a report on the ACL table. For more information, see [Restrict report creation with an ACL rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/reporting/t_RestrictRepCreationWAnACLRule.md).
...
User can’t view the content of a report on the ACL table or on the ACL field. For more information, see [Reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/reporting/reporting-landing-page.md).
