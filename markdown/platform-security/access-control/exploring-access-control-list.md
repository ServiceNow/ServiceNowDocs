...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/access-control/exploring-access-control-list.html
release: yokohama
...
User can’t create a report on the ACL table. For more information, see [Restrict report creation with an ACL rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/t_RestrictRepCreationWAnACLRule.md).
...
User can’t view the content of a report on the ACL table or on the ACL field. For more information, see [Reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/reporting-landing-page.md).
