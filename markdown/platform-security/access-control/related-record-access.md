...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/access-control/related-record-access.html
release: yokohama
...
Review the related records of an ACL in the **Advanced Condition** &gt; **Controlled by references** field. See [Configure an ACL rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/access-control/t_CreateAnACLRule.md) for more information on configuring ACLs.
