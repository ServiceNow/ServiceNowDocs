...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/access-control/r\_SecurityJumpStartACLRules.html
release: australia
...
**Note:** To learn more about this plugin, see [Enable security jump start plugin \(ACL Rules\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/instance-security-hardening-settings/sc-security-jump-start-plugin-acl-rules.md) in Instance Security Hardening Settings.
