...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/access-control/c\_ACLConfigWatcher.html
release: xanadu
...
The configuration watcher shows the [ACL execution plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/access-control/t_ShowACLExecutionPlan.md). The execution plan is displayed in the security rules pop-up window. You can view this kind of information:
