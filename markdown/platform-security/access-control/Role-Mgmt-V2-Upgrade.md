...
You must have the admin role and [Elevate to a privileged role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/t_ElevateToAPrivilegedRole.md) to obtain the effective security\_admin role.
