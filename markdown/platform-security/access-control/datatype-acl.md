...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/access-control/datatype-acl.html
release: australia
...
**Note:** Scripting Governance uses datatype ACLs by default for scripting restrictions. For more information, see [Scripting Governance Tool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/access-control/scripting-governance.md).
