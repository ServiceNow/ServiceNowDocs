...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/access-control/oob-security-attributes.html
release: yokohama
...
To create your own Security Attribute, or expand an OOB Security Attributes capabilities see [Compound Security Attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/access-control/compound-security-attributes.md)
