...
[Explore![Explore](../../../common/image/icon-explore.png)](explore-database-encryption.md)

 [Learn the key features and business value of Database Encryption.](explore-database-encryption.md)

</td><td>

[Request![](../../../common/image/icon-workspace.png)](../task/request-dbkek-rotation.md)

 [Learn more about how to request database key rotation.](../task/request-dbkek-rotation.md)

</td></tr><tr><td>

[Reference![Reference](../../../common/image/icon-reference.png)](dbe-with-ccs.md)
