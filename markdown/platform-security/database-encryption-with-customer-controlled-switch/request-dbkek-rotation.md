...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/database-encryption-with-customer-controlled-switch/request-dbkek-rotation.html
release: yokohama
...
1.  Contact Customer Service and Support to request any of the following key rotation actions:
...
**Parent Topic:**[Database Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/database-encryption-with-customer-controlled-switch/db-full-disk-encryption.md)
