...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/database-encryption-with-customer-controlled-switch/explore-database-encryption.html
release: xanadu
...
If you are using your own keys for database encryption, see [Database Encryption with Customer-Controlled Switch](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/database-encryption-with-customer-controlled-switch/dbe-with-ccs.md).
