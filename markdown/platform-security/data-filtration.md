...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/data-filtration.html
release: zurich
topic_type: concept
...
-   **Subject criteria records**
    ...
    Subject criteria \[sys\_df\_subject\_criteria\] records represent specific user attributes you can use to determine whether to grant access with a Data filtration rule. These attributes can be a user's groups, roles, or IP address. To create a subject criteria, you must create the subject criteria record, as well as criteria input and criteria conditions records. For details on this process, see [Create subject criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/df-create-criteria.md).
...
-   **Criteria input records examples**
    ...
    \[Omitted image "criteria-condition-example2.png"\] Alt text: Example criteria input for all roles containing admin
...
-   **Subject criteria condition records**
    ...
    \[Omitted image "criteria-condition-example3.png"\] Alt text: Example criteria condition using the Admins Only criteria input
