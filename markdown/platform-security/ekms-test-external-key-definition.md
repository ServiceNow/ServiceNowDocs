...
To test an external key definition, there must be one configured in EKMS. See [Configure an external key definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/ekms-configure-external-key-definition.md).
