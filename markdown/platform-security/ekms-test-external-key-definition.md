...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/ekms-test-external-key-definition.html
release: australia
topic_type: task
...
To test an external key definition, there must be one configured in EKMS. See [Configure an external key definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/ekms-configure-external-key-definition.md).
