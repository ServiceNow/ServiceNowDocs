...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/t\_GenerateAnLDAPClientCertificate.html
release: yokohama
topic_type: task
...
4.  [Upload the certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/t_UploadACertificateToAnInstance.md) in the keystore file \(`test1.jks`\) to the instance.
...
[Uploading a certificate to an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/t_UploadACertificateToAnInstance.md)

-   **[Generating a server certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/t_GenerateAServerCertificate.md)**  
...
**Parent Topic:**[Certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/c_Certificates.md)
