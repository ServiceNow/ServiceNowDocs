...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/t\_GenerateAnLDAPClientCertificate.html
release: australia
topic_type: task
...
4.  [Upload the certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/t_UploadACertificateToAnInstance.md) in the keystore file \(`test1.jks`\) to the instance.
...
[Uploading a certificate to an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/t_UploadACertificateToAnInstance.md)

-   **[Generating a server certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/t_GenerateAServerCertificate.md)**  
