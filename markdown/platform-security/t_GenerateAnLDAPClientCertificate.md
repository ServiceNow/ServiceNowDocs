...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/t\_GenerateAnLDAPClientCertificate.html
release: zurich
topic_type: task
...
4.  [Upload the certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/t_UploadACertificateToAnInstance.md) in the keystore file \(`test1.jks`\) to the instance.
...
[Uploading a certificate to an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/t_UploadACertificateToAnInstance.md)

-   **[Generating a server certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/t_GenerateAServerCertificate.md)**  
...
**Parent Topic:**[Certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/c_Certificates.md)
