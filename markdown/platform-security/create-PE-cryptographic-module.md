...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/create-PE-cryptographic-module.html
release: xanadu
topic_type: task
...
[Create a cryptographic specification for Column Level Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/create-crypto-spec-pe.md).
