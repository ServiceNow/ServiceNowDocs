...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/t\_CrContRelBetDom.html
release: yokohama
topic_type: task
...
3.  [Toggle the domain scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/c_DomainScope.md) to switch between the session scope and record scope, if necessary.
