...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/les-create-source-configuration.html
release: xanadu
topic_type: task
...
-   Table
See [Log sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-log-sources-export.md) for more information.
...
-   **[Create multi topics in the LES source table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/les-multi-topics.md)**  
