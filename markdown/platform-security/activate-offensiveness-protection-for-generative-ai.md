...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/activate-offensiveness-protection-for-generative-ai.html
release: australia
topic_type: task
...
You can export logs for review. For more information, see [Export Now Assist Guardian logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/export-now-assist-guardian-logs.md).
...
To change the detection impact for an active workflow, select more options \(\[Omitted image "image.more-options-menu-item"\] Alt text: More options icon.\) icon in the list of active workflows and then select **Edit**.

To deactivate offensiveness protection for a workflow, select more options \(\[Omitted image "image.more-options-menu-item"\] Alt text: More options icon.\) icon in the list of active workflows and then select **Deactivate**.
