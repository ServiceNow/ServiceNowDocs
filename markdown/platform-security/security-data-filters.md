...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/security-data-filters.html
release: australia
topic_type: concept
...
Security data filters are applied before a query is executed so restricted data never leaves the database. In contrast [conditional ACLs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/access-control/access-control-rules.md) filter data after a query is executed possibly leaking data.

**Note:** Pair security data filters with [Deny-Unless ACL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/access-control/acl-denial-behavior.md) to ensure consistent security
...
-   Security data filters are not checked by `canRead`. See [When to use security data filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/security-data-filters.md) for more details
