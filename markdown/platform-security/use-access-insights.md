...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/use-access-insights.html
release: brazil
topic_type: task
...
**Note:** To view the details of though Access Insights feature, you must use the [Compare user access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/comparing-access-controls.md) feature.
