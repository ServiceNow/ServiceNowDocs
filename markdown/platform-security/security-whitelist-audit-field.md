...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/security-whitelist-audit-field.html
release: yokohama
topic_type: task
