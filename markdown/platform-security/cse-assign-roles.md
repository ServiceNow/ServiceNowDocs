...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/cse-assign-roles.html
release: xanadu
topic_type: task
...
To learn more about Code Signing roles, see [Roles installed with Code Signing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cs-role-landing.md).
