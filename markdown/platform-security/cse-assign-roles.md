...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/cse-assign-roles.html
release: yokohama
topic_type: task
...
To learn more about Code Signing roles, see [Roles installed with Code Signing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/cs-role-landing.md).
