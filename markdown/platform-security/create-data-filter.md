...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/create-data-filter.html
release: yokohama
topic_type: task
...
2.  Use the condition builder to filter the table records their field values.
    ...
    The data filter uses the same condition builder used in other parts of the platform. For details on using this interface, see [Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/configure-user-experiences/c_ConditionBuilder.md).
