...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-security/configure-ca.html
release: brazil
topic_type: task
...
**Note:** To know more about how to create data class, see [Data Classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/data-classification/data-classification.md).
...
-   [Tutorial: Configure Continuous Authentication for a Table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/configure-ca-tutorial-table.md).
-   [Tutorial: Configure Continuous Authentication for a Data Class](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/configure-ca-tutorial.md).
