...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/domain-sep-plugin.html
release: yokohama
topic_type: concept
