...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/domain-sep-plugin.html
release: australia
topic_type: concept
