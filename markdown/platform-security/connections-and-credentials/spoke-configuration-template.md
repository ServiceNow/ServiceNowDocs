...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/connections-and-credentials/spoke-configuration-template.html
release: zurich
...
-   **[Configure a template for OAuth JWT Bearer grant type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/connections-and-credentials/docusign-example.md)**  
...
-   **[Create a configuration template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/connections-and-credentials/create-template.md)**  
