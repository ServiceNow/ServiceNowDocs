...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/connections-and-credentials/create-connection-attributes.html
release: xanadu
...
For more information about building custom Workflow Studio actions, see [Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/actions.md).
...
4.  Define the attribute label and field type.
    ...
    For a list of field types, see [field types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/r_FieldTypes.md).

5.  Click the Advanced view related link to set advanced dictionary preferences for the attribute.

    For example, to create an attribute with a dynamically calculated value. See [Dictionary entry form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/table-administration-and-data-management/r_DictionaryEntryForm.md).
...
**Parent Topic:**[Getting started with connections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/connection-information.md)
