...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/connections-and-credentials/oauth-2-0-support-in-external-credential.html
release: xanadu
...
-   **[Configure a JAR file and credential identifiers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/configure-and-import-jar-file.md)**  
...
-   **[Configure CyberArk](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/configure-cyberark.md)**  
...
-   **[Configure a connection to send OAuth request via the MID Server using external vault](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/configure-oauth-2-0-authentication.md)**  
