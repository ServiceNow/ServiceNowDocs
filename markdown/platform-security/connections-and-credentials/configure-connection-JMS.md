...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/connections-and-credentials/configure-connection-JMS.html
release: xanadu
...
<table id="choicetable_gqc_pd4_5y"><tbody><tr><td id="d58106e104">
...
4.  Click **New**, select **JMS Credentials**, and then provide the user name and password the MID should use to communicate with the JMS provider.
    ...
    For more information, see [JMS credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/r_JMSCredentialsForm.md).
