...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/connections-and-credentials/authentication-algorithms.html
release: yokohama
...
For more information, see [Integration steps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/integration-hub/integration-steps.md)
...
To know more, on how to configure the authentication algorithm, see [Configure an authentication algorithm](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/connections-and-credentials/configure-authentication-algorithm.md).
