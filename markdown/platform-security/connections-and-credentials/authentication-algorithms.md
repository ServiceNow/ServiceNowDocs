...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/connections-and-credentials/authentication-algorithms.html
release: xanadu
...
For more information, see [Integration steps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/integration-steps.md)
...
To know more, on how to configure the authentication algorithm, see [Configure an authentication algorithm](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/configure-authentication-algorithm.md).
