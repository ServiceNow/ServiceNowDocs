...
<table id="choicetable_brl_cpl_1jb"><thead><tr><th align="left" id="d57229e77">

Configuration type

</th><th align="left" id="d57229e80">

Description

</th></tr></thead><tbody><tr><td id="d57229e86">
...
```
 ...
 For more information on how to use dot-walking, see [Dot-walking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/c_DotWalking.md).
