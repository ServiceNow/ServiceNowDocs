...
<table id="choicetable_brl_cpl_1jb"><thead><tr><th align="left" id="d59145e77">

Configuration type

</th><th align="left" id="d59145e80">

Description

</th></tr></thead><tbody><tr><td id="d59145e86">
...
```
 ...
 For more information on how to use dot-walking, see [Dot-walking](https://www.servicenow.com/docs/access?context=c_DotWalking&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
