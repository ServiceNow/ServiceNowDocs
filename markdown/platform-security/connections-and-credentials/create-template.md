...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/connections-and-credentials/create-template.html
release: xanadu
...
breadcrumb: [Connection &amp; Credential configuration templates, Exploring credentials, connections, and aliases, Connections and Credentials, Access Management]
---
...
<table id="choicetable_brl_cpl_1jb"><thead><tr><th align="left" id="d49387e77">

Configuration type

</th><th align="left" id="d49387e80">

Description

</th></tr></thead><tbody><tr><td id="d49387e86">
...
```
 ...
 For more information on how to use dot-walking, see [Dot-walking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/c_DotWalking.md).
...
9.  Add the template to a Connection &amp; Credential alias.
...
**Parent Topic:**[Connection &amp; Credential configuration templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/spoke-configuration-template.md)
