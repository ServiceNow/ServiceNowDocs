...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-security/connections-and-credentials/create-template.html
release: zurich
...
<table id="choicetable_brl_cpl_1jb"><thead><tr><th align="left" id="d71234e77">

Configuration type

</th><th align="left" id="d71234e80">

Description

</th></tr></thead><tbody><tr><td id="d71234e86">
...
```
 ...
 For more information on how to use dot-walking, see [Dot-walking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_DotWalking.md).
...
**Parent Topic:**[Connection &amp; Credential configuration templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/connections-and-credentials/spoke-configuration-template.md)
