...
<table id="choicetable_brl_cpl_1jb"><thead><tr><th align="left" id="d67429e77">

Configuration type

</th><th align="left" id="d67429e80">

Description

</th></tr></thead><tbody><tr><td id="d67429e86">
...
```
 ...
 For more information on how to use dot-walking, see [Dot-walking](https://www.servicenow.com/docs/access?context=c_DotWalking&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
