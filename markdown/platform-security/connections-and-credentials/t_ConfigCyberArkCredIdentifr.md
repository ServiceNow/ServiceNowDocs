...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/connections-and-credentials/t\_ConfigCyberArkCredIdentifr.html
release: yokohama
...
3.  From the list of credential types, select a type that [supports CyberArk](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/connections-and-credentials/c_CyberArkCredStorageIntegrate.md) external storage.

4.  Complete the form using the fields from your [credential type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/connections-and-credentials/t_CreateCredential.md).
