...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/connections-and-credentials/t\_ConfigCyberArkCredIdentifr.html
release: xanadu
...
3.  From the list of credential types, select a type that [supports CyberArk](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/c_CyberArkCredStorageIntegrate.md) external storage.

4.  Complete the form using the fields from your [credential type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/t_CreateCredential.md).
