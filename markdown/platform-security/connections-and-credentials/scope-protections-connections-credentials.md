...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/connections-and-credentials/scope-protections-connections-credentials.html
release: xanadu
...
An **Application** field is available in the Connection \[sys\_connection\] and Discovery Credentials \[discovery\_credentials\] tables for associating these types of records to specific scopes. It is not visible on UI forms in Xanadu, but you can easily add it to them. To learn more about these record types, and adding the field to their UI forms, see:

-   [Getting started with connections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/connection-information.md)
-   [Getting started with credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/credentials-getting-started.md)
...
-   Applies Access Control List rules \(ACLs\) to restricted scopes. To learn more about scoped ACLs, see [Access control list rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/access-control/access-control-rules.md).

    **Note:** Some applications using scope administration and enforced security may require additional setup. To learn more, see [Manage HR roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/hr-service-delivery/c_ManageRoles.md)
...
**Parent Topic:**[Exploring credentials, connections, and aliases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/connections-and-credentials/credentials-connections-alias.md)
