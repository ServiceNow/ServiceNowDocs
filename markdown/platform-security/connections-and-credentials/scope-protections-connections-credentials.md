...
-   Applies Access Control List rules \(ACLs\) to restricted scopes. To learn more about scoped ACLs, see [Access control list rules](../../../administer/contextual-security/concept/access-control-rules.md).
    ...
    **Note:** Some applications using scope administration and enforced security may require additional setup. To learn more, see [Manage HR roles](https://www.servicenow.com/docs/access?context=c_ManageRoles&version=australia&pubname=australia-employee-service-management&ft:locale=en-US)
