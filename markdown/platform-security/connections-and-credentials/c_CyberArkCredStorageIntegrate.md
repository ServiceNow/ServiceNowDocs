...
|----------------|-----------------------------------|---------------------|
|SOAP|SOAP Step|[Create a SOAP web service activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/t_CreateASOAPWebServiceActivity.md) with basic authentication overrides|
|REST|REST Step|[Create a REST web service activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/t_CreateARESTWebServiceActivity.md) with basic authentication overrides|
