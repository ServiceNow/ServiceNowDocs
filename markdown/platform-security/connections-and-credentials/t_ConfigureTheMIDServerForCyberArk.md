...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/connections-and-credentials/t\_ConfigureTheMIDServerForCyberArk.html
release: yokohama
...
1.  Manually configure the MID Server [Add a MID Server parameter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/mid-server/mid-server-parameters.md) file with these parameters.
