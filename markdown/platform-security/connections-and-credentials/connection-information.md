...
-   **[Create a basic connection for PowerShell and SSH](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/connections-and-credentials/configure-ps-connection.md)**  
...
-   **[Create an HTTP\(s\) connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/connections-and-credentials/create-https-connection.md)**  
The HTTP\(s\) connection provides the information custom HTTP\(s\) actions or activities use to connect.
-   **[Create a JDBC connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/connections-and-credentials/create-JDBC-connection.md)**  
...
-   **[Create a JMS connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/connections-and-credentials/configure-connection-JMS.md)**  
Configure your system to use Java Messaging Service \(JMS\) with a custom JMS activity or action.
-   **[Create connection attributes for IntegrationHub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/connections-and-credentials/create-connection-attributes.md)**  
