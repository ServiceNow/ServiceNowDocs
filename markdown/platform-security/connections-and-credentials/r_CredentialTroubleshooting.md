...
-   Credentials fail for [WMIRunner probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/r_WMIRunnerProbe.md), [PowerShell probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/c_PowershellProbe.md), [JMS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-security/connections-and-credentials/r_JMSCredentialsForm.md), or [SSHCommand probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/c_SSHCommandProbe.md).
...
-   If the [mid.powershell.use\_credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/r_PowerShellForDiscovery.md) parameter is set to `true`.
