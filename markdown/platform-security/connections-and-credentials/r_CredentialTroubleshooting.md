...
-   Credentials fail for [WMIRunner probe](https://www.servicenow.com/docs/access?context=r_WMIRunnerProbe&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US), [PowerShell probe](https://www.servicenow.com/docs/access?context=c_PowershellProbe&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US), [JMS](r_JMSCredentialsForm.md), or [SSHCommand probe](https://www.servicenow.com/docs/access?context=c_SSHCommandProbe&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
...
-   If the [mid.powershell.use\_credentials](https://www.servicenow.com/docs/access?context=r_PowerShellForDiscovery&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US) parameter is set to `true`.
