...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/connections-and-credentials/r\_CredentialTroubleshooting.html
release: yokohama
...
-   Credentials fail for [WMIRunner probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/discovery/r_WMIRunnerProbe.md), [PowerShell probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/discovery/c_PowershellProbe.md), [JMS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/connections-and-credentials/r_JMSCredentialsForm.md), or [SSHCommand probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/discovery/c_SSHCommandProbe.md).
...
-   If the [mid.powershell.use\_credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/discovery/r_PowerShellForDiscovery.md) parameter is set to `true`.
