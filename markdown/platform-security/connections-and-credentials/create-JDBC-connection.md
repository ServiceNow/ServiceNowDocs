...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/connections-and-credentials/create-JDBC-connection.html
release: yokohama
...
JDBC credentials are retrieved separately by the activity designer template and support [external credential storage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/connections-and-credentials/c_ExternalCredentialStorage.md), such as CyberArk.
