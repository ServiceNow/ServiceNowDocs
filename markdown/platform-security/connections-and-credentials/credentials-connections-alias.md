...
-   In the Connections dashboard of Integration Hub. See [Add a connection](https://www.servicenow.com/docs/access?context=dashboard-add-connection&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).

    **Note:** Integration Hub requires a separate subscription. For more information, see [Request Integration Hub](https://www.servicenow.com/docs/access?context=request-ih-overview&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
