...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/connections-and-credentials/configure-oauth-2-0-credentials-on-cyberark.html
release: yokohama
...
breadcrumb: [Configure CyberArk, OAuth 2.0 authentication via MID Server using external credential storage, External credential storage, Getting started with credentials, Connections and Credentials, Access Management]
---
...
**Parent Topic:**[Configure CyberArk](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/connections-and-credentials/configure-cyberark.md)
