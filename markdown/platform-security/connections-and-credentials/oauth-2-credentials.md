...
-   Ensure that there is at least one MID Server \(in the MID Servers selected in **Applies to**\) with these configurations:
    ...
    -   The capability of the MID Server is set to **REST** or **ALL**. To learn how to configure the MID server, see [https://www.servicenow.com/docs/access?context=configure-capabilities&amp;version=zurich&amp;pubname=zurich-integrate-applications&amp;ft:locale=en-US](https://www.servicenow.com/docs/access?context=configure-capabilities&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).![MID Server status.](../image/MidServerDashbardGaugeOAuth2.0.png)

To learn more about these statuses, see [MID Server dashboard](https://www.servicenow.com/docs/access?context=c_MIDServerDashboard&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
