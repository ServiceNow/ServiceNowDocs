...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/connections-and-credentials/configure-an-amazon-signature-based-custom-algorithm.html
release: xanadu
