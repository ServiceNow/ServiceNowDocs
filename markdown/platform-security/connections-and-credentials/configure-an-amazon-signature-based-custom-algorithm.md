...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/connections-and-credentials/configure-an-amazon-signature-based-custom-algorithm.html
release: yokohama
...
\[Omitted image "aws-regions-get.png"\] Alt text: GET AWS Region
