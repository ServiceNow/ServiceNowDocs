...
To learn more, see [Create domain-separated property overrides](https://www.servicenow.com/docs/access?context=create-dom-sep-prop-overrides&version=xanadu&pubname=xanadu-security-management&ft:locale=en-US).
