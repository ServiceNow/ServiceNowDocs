...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/wrap-customer-supplied-key.html
release: yokohama
topic_type: task
...
-   Modify optional properties that control the size, padding algorithm, and validity period of the key. See [Configure properties for customer-supplied keys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/customer-supplied-keys.md).
...
Return to [Configure and upload your customer supplied key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/upload-customer-supplied-key.md) to upload your wrapped key.
...
**Parent Topic:**[Configure properties for customer-supplied keys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/customer-supplied-keys.md)
