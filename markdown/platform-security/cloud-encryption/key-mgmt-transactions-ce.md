...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/cloud-encryption/key-mgmt-transactions-ce.html
release: xanadu
...
See [Key Management Framework key lifecycle states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/platform-encryption/key-life-cycle-states.md) for definitions.
...
</table>**Parent Topic:**[Cloud Encryption with Key Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cloud-encryption/dare-overview.md)
