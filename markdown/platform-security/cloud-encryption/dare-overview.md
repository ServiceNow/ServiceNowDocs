...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-security/cloud-encryption/dare-overview.html
release: xanadu
...
-   Customer-Managed keys option.
    ...
    **Note:** Consider this option if your organization requires you to use key material generated by your own cryptographic tools or libraries, an enterprise key management system, or a hardware security module \(HSM\). See [Key management operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cloud-encryption/key-mgmt-operations-ce.md) for details.


The following diagram shows how Cloud Encryption works.

\[Omitted image "cloud-encryption-diagram.png"\] Alt text: Cloud Encryption overview diagram.

The Cloud Encryption Key Management module consists of the following submodules:

-   [Key management operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cloud-encryption/key-mgmt-operations-ce.md):
    -   Access the list of keys.
    -   Perform key rotation operations.
    -   Withdraw customer-managed key.
-   [Key management transactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cloud-encryption/key-mgmt-transactions-ce.md):
...
For information about licensing Cloud Encryption, see [Encryption and Key Management subscription bundle](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/platform-encryption/encryption-sku.md).
...
-   **[Quorum Control Policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cloud-encryption/quorum-ctrl-policy.md)**  
...
-   **[Cloud Encryption logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cloud-encryption/dare-logging.md)**  
Learn about logging options for Cloud Encryption.
-   **[Tamper Detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-security/cloud-encryption/tamper-detect.md)**  
