...
-   [Key management operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/key-mgmt-operations-ce.md):
    -   Access the list of keys.
    -   Perform key rotation operations.
    -   Withdraw customer-managed key.
-   [Key management transactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/key-mgmt-transactions-ce.md):
...
For information about licensing Cloud Encryption, see [Encryption and Key Management subscription bundle](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/platform-encryption/encryption-sku.md).
...
-   **[Quorum Control Policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/quorum-ctrl-policy.md)**  
...
-   **[Cloud Encryption logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/dare-logging.md)**  
Learn about logging options for Cloud Encryption.
-   **[Tamper Detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/tamper-detect.md)**  
