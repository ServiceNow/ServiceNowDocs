...
See [Rotate a ServiceNow managed key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/key-mgmt-operations-ce.md) or [Rotate a customer managed key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/key-mgmt-operations-ce.md) for details.
...
**Important:** If you’re using customer-managed keys, see [Rotate a customer managed key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/key-mgmt-operations-ce.md).
...
6.  Open the entry for the original key to view the Key Management Transactions.
    ...
    For more information, see [Key management transactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/key-mgmt-transactions-ce.md) for more information.
...
4.  In the **Upload Customer Managed key** window perform the listed steps.
    ...
    4.  Select **OK** to upload your key.
        ...
        In the Key Management Transactions table, the certificate download and key upload steps are listed. See [Key management transactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/key-mgmt-transactions-ce.md) for details on the request steps.
...
To switch to a customer managed key, you must have a wrapped customer managed key ready to upload as part of these steps. For details on preparing this key for upload, see [Prepare your customer managed key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/key-mgmt-operations-ce.md). After uploading your key, this process will initiate a key rotation to your new key.
...
5.  Refresh the Key Definition page to view the pending withdrawal request.
    ...
    If the Quorum Control Policy has been activated, the approval workflow must be completed successfully to complete the key withdrawal. See [Manage Quorum Control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/quorum-ctrl-mgmt.md) for details.
...
5.  Prepare your key for upload.
    ...
    For details on this process, see [Prepare your customer managed key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/cloud-encryption/key-mgmt-operations-ce.md).
