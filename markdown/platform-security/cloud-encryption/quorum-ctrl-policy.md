...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-security/cloud-encryption/quorum-ctrl-policy.html
release: yokohama
...
See [Configure Quorum Control Policy Settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/cloud-encryption/configure-quorum.md) for setup details.

-   **[Configure Quorum Control Policy Settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/cloud-encryption/configure-quorum.md)**  
Follow these steps to configure Quorum Control Policy Settings.
-   **[Manage Quorum Control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-security/cloud-encryption/quorum-ctrl-mgmt.md)**  
