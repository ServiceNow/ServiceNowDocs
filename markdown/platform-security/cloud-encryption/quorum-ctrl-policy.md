...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-security/cloud-encryption/quorum-ctrl-policy.html
release: australia
...
See [Configure Quorum Control Policy Settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/cloud-encryption/configure-quorum.md) for setup details.

-   **[Configure Quorum Control Policy Settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/cloud-encryption/configure-quorum.md)**  
Follow these steps to configure Quorum Control Policy Settings.
-   **[Manage Quorum Control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-security/cloud-encryption/quorum-ctrl-mgmt.md)**  
