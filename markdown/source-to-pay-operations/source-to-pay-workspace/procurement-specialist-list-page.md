...
Sidebar enables stakeholders to collaborate with others by getting into discussions when working on task-based records. You can create a Sidebar discussion by selecting **Discuss** from your procurement object details page on the Source-to-Pay Workspace list page. Other stakeholders are notified when you add them to a discussion. They can join the discussion from the Sidebar discussions icon. For more information, see [Sidebar and Microsoft Teams](https://www.servicenow.com/docs/access?context=sidebar-teams-overview&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).

For more information on Sidebar, see [Sidebar](https://www.servicenow.com/docs/access?context=sidebar-landing&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).

To learn more about how to use Sidebar, see [Using Sidebar](https://www.servicenow.com/docs/access?context=using-sidebar&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).

For information on activity stream in Sidebar, see [Activity stream in Sidebar](https://www.servicenow.com/docs/access?context=activity-stream-sidebar&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).

For detailed information on integrating and enabling Sidebar with Microsoft Teams, see [Integrate Sidebar and Microsoft Teams](https://www.servicenow.com/docs/access?context=integrating-sidebar-teams&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US) and [Enable or configure the Microsoft Teams integration](https://www.servicenow.com/docs/access?context=enable-teams-integration&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
