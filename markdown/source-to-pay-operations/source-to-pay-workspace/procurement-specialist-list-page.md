...
For more information on Sidebar, see [Sidebar](https://www.servicenow.com/docs/access?context=sidebar-landing&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).

To learn more about how to use Sidebar, see [Using Sidebar](https://www.servicenow.com/docs/access?context=using-sidebar&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).

For information on activity stream in Sidebar, see [Activity stream in Sidebar](https://www.servicenow.com/docs/access?context=activity-stream-sidebar&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).

For detailed information on integrating and enabling Sidebar with Microsoft Teams, see [Integrate Sidebar and Microsoft Teams](https://www.servicenow.com/docs/access?context=integrating-sidebar-teams&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US) and [Enable or configure the Microsoft Teams integration](https://www.servicenow.com/docs/access?context=enable-teams-integration&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
