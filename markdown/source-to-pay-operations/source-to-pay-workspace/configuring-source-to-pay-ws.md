...
Make record content searchable by configuring an indexed source to add it to the AI Search index. For more information on AI search indexing, see AI Search.
