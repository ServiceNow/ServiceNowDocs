...
# Exploring Source-to-Pay integration with SAP ECC and S4HANA

Learn more about the Source-to-Pay integration with SAP ECC and S4HANA

## Establishing communication between the SAP and ServiceNow instances

The Source-to-Pay integration with SAP ECC and SAP S4 HANA supports the following APIs:
