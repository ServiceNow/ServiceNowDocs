...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/source-to-pay-integration-framework/define-erp-source-sap-ariba.html
release: yokohama
...
3.  To edit the ERP source, select **here** from the label **To edit this record click here**.
    ...
    \[Omitted image "sap-ariba-edit-config.png"\] Alt text: Edit the ERP Source for SAP Ariba
