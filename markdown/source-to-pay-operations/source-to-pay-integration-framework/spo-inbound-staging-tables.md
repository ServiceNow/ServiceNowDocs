...
breadcrumb: [Inbound staging tables for Source-to-Pay Operations, Source-to-Pay integration framework, Source-to-Pay integration with third-party applications, Source-to-Pay Integrations, Source-to-Pay Operations, Finance and Supply Chain]
---
...
The Cost Center Stage inbound \[sn\_fcms\_intg\_imp\_cost\_center\] staging table temporarily stores important data about cost centers before this data is sent to the primary table.
...
-   **[Inbound Cost Allocation staging table](../reference/spo-cost-alloc-inbound-table.md)**  
...
-   **[Inbound Invoice staging table](../reference/spo-inbound-invoice-table.md)**  
...
-   **[Inbound Purchase Order staging table](../reference/spo-inbound-pur-order-table.md)**  
...
-   **[Inbound Purchase Order Line staging table](../reference/spo-inbound-pol-table.md)**  
...
-   **[Inbound Receipt staging table](../reference/spo-inbound-receipt-table.md)**  
