...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/source-to-pay-integration-framework/unit-measure-inbound-staging-table.html
release: zurich
...
|-----|---------|-----------|
|ERP Unit|String|Name of the base ERP unit.|
|ERP Unit Description|String|Description of the base ERP unit.|
