...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/source-to-pay-integration-framework/copy-subflow-sap-ariba.html
release: yokohama
...
4.  Select the More actions icon\[Omitted image "icon-ellipses.png"\] Alt text: More actions menu and select **Copy flow**.
...
**Parent Topic:**[Use flows in SAP Ariba](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/source-to-pay-integration-framework/use-flows-sap-ariba.md)
