...
breadcrumb: [Use flows in SAP Ariba, Using Source-to-Pay integration with SAP Ariba, Source-to-Pay integration with SAP Ariba, Source-to-Pay integration with third-party applications, Source-to-Pay Integrations, Source-to-Pay Operations, Finance and Supply Chain]
---
...
4.  Select the required flow from the list.
    ...
    ![Overview of the Create or Update Sourcing Event in SAP Ariba](../image/sap-ariba-trigger.png "Create or Update Sourcing Event in SAP Ariba")
