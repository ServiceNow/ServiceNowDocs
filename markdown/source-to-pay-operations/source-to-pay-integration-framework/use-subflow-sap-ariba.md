...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/source-to-pay-integration-framework/use-subflow-sap-ariba.html
release: yokohama
...
4.  Select the required flow from the list.
    ...
    \[Omitted image "sap-ariba-trigger.png"\] Alt text: Overview of the Create or Update Sourcing Event in SAP Ariba
