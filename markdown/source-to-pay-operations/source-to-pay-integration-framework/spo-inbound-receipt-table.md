---
title: Inbound Receipt staging table
description: The Inbound Receipt \[sn\_fcms\_intg\_imp\_receipt\] staging table temporarily stores important data about receipts before this data is sent to the primary table.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/source-to-pay-integration-framework/spo-inbound-receipt-table.html
release: yokohama
...
The Inbound Receipt \[sn\_fcms\_intg\_imp\_receipt\] staging table temporarily stores important data about receipts before this data is sent to the primary table.

The following table lists the mandatory fields for the Inbound Receipt \[sn\_fcms\_intg\_imp\_receipt\] staging table.
