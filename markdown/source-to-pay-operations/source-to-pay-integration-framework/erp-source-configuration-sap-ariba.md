...
4.  Define the source configuration for ERP source. The ERP source configuration determines the ERP source to which your ERP system connects. For more information, see [define-erp-source-sap-ariba.md](define-erp-source-sap-ariba.md).
