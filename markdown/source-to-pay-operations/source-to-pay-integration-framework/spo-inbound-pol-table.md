---
title: Inbound Purchase Order Line staging table
description: The Inbound Purchase Order Line \[sn\_fcms\_intg\_imp\_order\_line\] staging table temporarily stores important data about purchase order lines before this data is sent to the primary table.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/source-to-pay-integration-framework/spo-inbound-pol-table.html
release: yokohama
...
The following table lists the mandatory fields for the Inbound Purchase Order Line \[sn\_fcms\_intg\_imp\_order\_line\] staging table.
