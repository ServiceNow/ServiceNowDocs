...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/source-to-pay-integration-framework/run-scheduled-job-to-fetch-primary-data.html
release: yokohama
