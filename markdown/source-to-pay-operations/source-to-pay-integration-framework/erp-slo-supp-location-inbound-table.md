...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/source-to-pay-operations/source-to-pay-integration-framework/erp-slo-supp-location-inbound-table.html
release: australia
...
The following table lists the fields for the Supplier Location inbound \[sn\_fcms\_intg\_supplier\_location\_inbound\] staging table.

<table id="table_erp_slo_supp_location_inbound_table"><thead><tr><th>
