...
breadcrumb: [Use schedule flows in Oracle EBS, Using Source-to-Pay integration with Oracle EBS, Source-to-Pay integration with Oracle EBS, Source-to-Pay integration with third-party applications, Source-to-Pay Integrations, Source-to-Pay Operations, Finance and Supply Chain]
---
...
3.  In the Integration Services list, select the subflows that you want to manually trigger.
    ...
    ![Manually trigger flows or subflows in Oracle EBS (Inbound)](../image/manual-trigger-flow-oracle.png "Manually trigger flows or subflows in Oracle EBS")
...
8.  Look up the **Flow** or **Subflow** name or **Oracle EBS** application name using the filter icon, and select **Apply**.
    ...
    ![View the list of Flows or subflows in Workflow Studio](../image/manual-trigger-ws-oracle.png "Flows or subflows in Workflow Studio")
