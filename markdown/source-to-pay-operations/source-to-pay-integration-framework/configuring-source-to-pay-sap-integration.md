...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/source-to-pay-integration-framework/configuring-source-to-pay-sap-integration.html
release: xanadu
...
Run the Trigger SAP ECC and SAP S4 HANA Integration that pulls tasks into ServiceNow. For more information, see [Use schedule flows in SAP ECC and SAP S4 HANA](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/source-to-pay-integration-framework/using-schedule-flows-sap.md).
...
-   **[ERP Source Configuration for SAP ECC and SAP S4 HANA](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/source-to-pay-integration-framework/erp-source-configuration-sap.md)**  
...
-   **[Define ERP source configuration for SAP ECC and SAP S4 HANA](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/source-to-pay-integration-framework/define-erp-source-sap.md)**  
...
-   **[Configure integration services for SAP ECC and SAP S4 HANA](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/source-to-pay-integration-framework/configure-service-maps-sap.md)**  
...
-   **[Look up primary data in SAP ECC and SAP S4 HANA](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/source-to-pay-integration-framework/look-up-primary-data-sap.md)**  
You can run a job to look up primary data \(for example, Currencies\) from different ERP sources into ServiceNow.
-   **[Manually trigger flows or subflows in SAP ECC and SAP S4 HANA \(Inbound\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown)**  
...
-   **[Scheduled jobs to look up primary data in SAP ECC and SAP S4 HANA](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/source-to-pay-integration-framework/scheduled-jobs-to-primary-data-sap.md)**  
...
**Parent Topic:**[Source-to-Pay integration with SAP ECC and SAP S4 HANA](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/source-to-pay-integration-framework/source-to-pay-sap-integration.md)
