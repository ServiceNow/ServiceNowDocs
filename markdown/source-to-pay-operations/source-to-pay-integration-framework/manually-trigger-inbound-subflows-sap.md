---
title: Manually trigger flows or subflows in SAP ECC and SAP S4 HANA \(Inbound\)
description: You can manually trigger flows or subflows in SAP ECC and SAP S4 HANA on demand. Follow these steps to manually trigger a flow or subflow.
locale: en-US
release: xanadu
...
# Manually trigger flows or subflows in SAP ECC and SAP S4 HANA \(Inbound\)
...
2.  In the ERP Configurations view, select the **SAP ECC and SAP S4 HANA** ERP source to manually trigger the flows or subflows.

3.  In the Integration Services list, select the subflows that you want to manually trigger.

    ![Manually trigger flows or subflows in SAP ECC and SAP S4 HANA (Inbound)](../image/sap-integration-manual-trigger-flow.png "Manually trigger flows or subflows in SAP ECC and SAP S4 HANA")
...
8.  Look up the **Flow** or **Subflow** name or **SAP ECC and SAP S4 HANA** application name using the filter icon, and select **Apply**.
...
[Configure integration services for SAP ECC and SAP S4 HANA](configure-service-maps-sap.md)
