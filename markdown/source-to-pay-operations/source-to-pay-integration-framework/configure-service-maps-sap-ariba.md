---
title: Configure service maps for SAP Ariba
description: For configuring service maps, provide the connection end point and the SAP Ariba credentials that you set up for your authentication profile. Also, create a integration service record for each entity you want to customize.
locale: en-US
release: xanadu
...
# Configure service maps for SAP Ariba
...
2.  Open the ERP source for which you must configure service maps.
...
The order in which the entity should be displayed.
    ...
    The service mapping is configured for the selected entity.
