...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/source-to-pay-integration-framework/source-to-pay-oracle-ebs-integration.html
release: xanadu
...
First, you must activate the Source-to-Pay integration with Oracle EBS application from the ServiceNow Store. This automatically activates the Oracle EBS Spoke. Next you must set up [Oracle EBS Spoke](https://www.servicenow.com/docs/access?context=setup-oebs-spoke&version=yokohama).
