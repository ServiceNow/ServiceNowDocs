...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/source-to-pay-integration-framework/erp-source-configuration-sap.html
release: zurich
...
4.  The integration services are preconfigured with the base system for the following entities:
    ...
    \[Omitted image "sap-integration-source-config.png"\] Alt text: ERP Source Configuration of S4 HANA
