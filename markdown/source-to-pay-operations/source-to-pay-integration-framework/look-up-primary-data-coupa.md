...
|Purchase Orders|Look up purchase orders from Coupa|[Purchase Order inbound staging table](../../sourcing-procurement-operations/reference/spo-inbound-pur-order-table.md)|
...
|Receipts|Look up receipts from Coupa.|[Receipt inbound staging table](../../sourcing-procurement-operations/reference/spo-inbound-receipt-table.md)|
