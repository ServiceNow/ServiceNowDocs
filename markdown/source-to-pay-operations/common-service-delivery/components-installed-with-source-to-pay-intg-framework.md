...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/source-to-pay-operations/common-service-delivery/components-installed-with-source-to-pay-intg-framework.html
release: australia
