...
description: Run this fix script to update the new fields added in the KPI table \(sn\_kpi\_kpi\) after the May 2025 Zurich release.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/supplier-lifecycle-operations/run-fixscript-update-kpi-aggregation-method.html
release: zurich
