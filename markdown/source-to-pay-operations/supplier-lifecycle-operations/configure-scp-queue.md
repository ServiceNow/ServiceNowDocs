...
2.  Select **Supplier Collaboration Queue**.
    ...
    For more information about the fields on the Supplier Collaboration Queue form, see [Create a work item queue](https://www.servicenow.com/docs/access?context=awa-create-queue&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
