...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/manage-documents-from-my-company.html
release: yokohama
...
breadcrumb: [Manage documents, Using Supplier Collaboration Portal, Using Supplier Lifecycle Operations, Supplier Lifecycle Operations, Finance and Supply Chain]
---

# Manage documents from My Company page
...
2.  In the portal header, select **My Company**.

3.  Select the supplier from the list of suppliers, if applicable.
...
To upload a document:
 ...
 1.  Select the document that you want to upload.
2.  Select **Upload**.
3.  Upload your document in the Attachments section.
4.  Click **Submit**
...
The document template specifies the expected format of the document that you must upload. To download the document template:1.  Select the document.
2.  Select **Get template**.
...
**Parent Topic:**[Manage documents from the Supplier Collaboration Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/supplier-lifecycle-operations/upload-doc-portal.md)
