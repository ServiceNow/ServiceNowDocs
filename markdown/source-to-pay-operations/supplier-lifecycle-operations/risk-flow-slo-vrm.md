...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/supplier-lifecycle-operations/risk-flow-slo-vrm.html
release: xanadu
...
\[Omitted image "risk-flow-slo-vrm.png"\] Alt text: Risk assessment flow when only VRM is installed.
...
-   **[Playbook stages and activities when only Vendor Risk Management is installed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/supplier-lifecycle-operations/risk-flow-vrm-stages.md)**  
