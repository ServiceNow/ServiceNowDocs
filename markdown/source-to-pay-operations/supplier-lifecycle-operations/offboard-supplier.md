...
The supplier manager or supplier owner can continue to offboard the supplier using the Playbook tab on the Case Details page. For more information, see [Offboard suppliers using the supplier offboarding playbook](../concept/offboard-suppliers-using-playbook.md).

-   **[Offboard suppliers using the supplier offboarding playbook](../concept/offboard-suppliers-using-playbook.md)**  
