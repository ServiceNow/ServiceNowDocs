...
Advanced Work Assignment for Supplier Lifecycle Operations pushes work to qualified agents using work item queues, routing conditions, and assignment criteria that you define. For more information, see .
