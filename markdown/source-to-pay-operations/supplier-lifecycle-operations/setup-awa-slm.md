...
3.  Define or change a queue so that you can determine which work items are routed automatically to agents through a given service channel.
    ...
    For more information, see [Create a work item queue](https://www.servicenow.com/docs/access?context=awa-create-queue&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
