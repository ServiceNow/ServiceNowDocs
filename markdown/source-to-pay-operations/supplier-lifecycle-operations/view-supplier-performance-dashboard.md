...
4.  Select the **Performance** tab.
    ...
    **Note:** From the March 2026 Zurich release, all scores are calculated up to three decimal places. To implement this change, [Run fix script to update the KPI weighted score field in the KPI score table](run-fixscript-update-kpi-weighted-score.md).
