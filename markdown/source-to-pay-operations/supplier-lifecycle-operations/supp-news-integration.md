...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/supplier-lifecycle-operations/supp-news-integration.html
release: zurich
...
The Microsoft Bing News Search API uses the default Supplier News REST message to fetch supplier news, so ensure that you have configured the Supplier News REST message. For more information, see [Configure the Supplier News REST message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/supplier-lifecycle-operations/config-supp-news-rest.md).

-   **[Configure the Supplier News REST message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/supplier-lifecycle-operations/config-supp-news-rest.md)**  
Configure the Supplier News REST message using the Microsoft Bing News Search API subscription key.
-   **[Configuring a custom API to dynamically fetch supplier news](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/supplier-lifecycle-operations/config-supplier-news-api.md)**  
