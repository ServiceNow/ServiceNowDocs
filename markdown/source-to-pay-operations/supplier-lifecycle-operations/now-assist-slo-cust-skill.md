...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/supplier-lifecycle-operations/now-assist-slo-cust-skill.html
release: xanadu
...
4.  In the General details step, fill in the fields.
    ...
    For information about the inputs for each skill, see [Skill input for Now Assist for Supplier Lifecycle Operations \(SLO\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/supplier-lifecycle-operations/now-assist-slo-skill-input-triggers.md).
