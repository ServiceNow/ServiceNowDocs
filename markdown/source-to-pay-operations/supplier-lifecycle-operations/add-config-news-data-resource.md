...
A data resource is the data that a page fetches to display the content in the components. For more information, see [Data resources in UI Builder](https://www.servicenow.com/docs/access?context=data-resources&version=zurich&pubname=zurich-application-development&ft:locale=en-US) .
