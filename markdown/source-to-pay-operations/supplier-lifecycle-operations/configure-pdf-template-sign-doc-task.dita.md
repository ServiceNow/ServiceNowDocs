...
For a description of the field values, see Configure an HTML document template.

4.  Select **Submit** or **Save**.
5.  Select the Participants related list to create participants for the PDF document template. For more information, see Create participants for an HTML document template.
6.  Insert signatures in an HTML document template by selecting participants from the list. For more information, see Insert signatures.
7.  Select **Publish**.
...
For a description of the field values, see Configure a PDF document template.
...
6.  Select the Participants related list to create participants for the PDF document template. For more information, see Create participants for a PDF document template.
7.  Select the Template Mappings related list to define the PDF field mappings. For more information, see Define a PDF field mapping.
...
For more information, see Mark a signature block.
