...
For a description of the field values, see [Configure an HTML document template](https://www.servicenow.com/docs/access?context=configure-HTML-doc-template&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).

4.  Select **Submit** or **Save**.
5.  Select the Participants related list to create participants for the PDF document template. For more information, see [Create participants for an HTML document template](https://www.servicenow.com/docs/access?context=create-participants-html&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).
6.  Insert signatures in an HTML document template by selecting participants from the list. For more information, see [Insert signatures](https://www.servicenow.com/docs/access?context=create-participants-html&version=zurich&pubname=zurich-employee-service-management&section=insert-signatures&ft:locale=en-US).
7.  Select **Publish**.
...
For a description of the field values, see [Configure a PDF document template](https://www.servicenow.com/docs/access?context=configure-editable-pdf&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).
...
6.  Select the Participants related list to create participants for the PDF document template. For more information, see [Create participants for a PDF document template](https://www.servicenow.com/docs/access?context=create-participant&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).
7.  Select the Template Mappings related list to define the PDF field mappings. For more information, see [Define a PDF field mapping](https://www.servicenow.com/docs/access?context=edit-pdf-mappings&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).
...
For more information, see [Mark a signature block](https://www.servicenow.com/docs/access?context=create-participant&version=zurich&pubname=zurich-employee-service-management&section=mark-signature-doctemp&ft:locale=en-US).
