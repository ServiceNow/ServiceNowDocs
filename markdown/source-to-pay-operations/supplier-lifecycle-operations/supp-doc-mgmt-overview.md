...
Supplier Lifecycle Operations extends the Document Management plugin \(com.snc.platform\_document\_management\), which is installed along with the Supplier Lifecycle Operations application. For more information, see [Document Management](https://www.servicenow.com/docs/access?context=doc-management-landing&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
