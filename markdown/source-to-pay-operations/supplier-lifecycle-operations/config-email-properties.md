...
Supplier Lifecycle Operations automatically creates a supplier case if the incoming email address matches with the email address specified in this property. For more information, see [Configure properties for Supplier Lifecycle Operations](../reference/config-prop-supp-mgmt.md).
...
**Parent Topic:**[Configure properties for Supplier Lifecycle Operations](../reference/config-prop-supp-mgmt.md)
