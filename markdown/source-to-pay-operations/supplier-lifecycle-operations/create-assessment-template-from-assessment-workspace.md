...
Smart assessments are built using the ServiceNow® Smart Assessment Engine \(SAE\) application. Familiarize yourself with the [Smart Assessment Engine](https://www.servicenow.com/docs/access?context=smart-asmnt-engine-landing-page&version=yokohama&pubname=yokohama-governance-risk-compliance&ft:locale=en-US).
...
1.  Select the **Workspaces** tab and then select the **Assessment workspace**.
    ...
    For more information on creating the smart assessment template, see [Create an assessment template](https://www.servicenow.com/docs/access?context=sae-asmnt-template-create&version=yokohama&pubname=yokohama-governance-risk-compliance&ft:locale=en-US).
...
5.  In the template designer, add instructions and questions.
    ...
    For more information, see [Add instructions and questions to an assessment template](https://www.servicenow.com/docs/access?context=sae-asmnt-template-populate&version=yokohama&pubname=yokohama-governance-risk-compliance&ft:locale=en-US).
