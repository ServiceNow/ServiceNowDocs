...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/supplier-lifecycle-operations/remove-unique-constraint.html
release: zurich
...
5.  Select the form context menu icon \(\[Omitted image "context-menu.png"\]\) and select **Configure** &gt; **Form Layout**.
...
[Run the fix script to enable M2M mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/supplier-lifecycle-operations/run-fix-script.md)
