...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/supplier-lifecycle-operations/remove-unique-constraint.html
release: xanadu
...
3.  Select the form context menu icon \(\[Omitted image "context-menu.png"\] Alt text: Context menu icon\) and select **Configure** &gt; **Form Layout**.
...
**Parent Topic:**[Enable M2M mapping between supplier contact and suppliers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/supplier-lifecycle-operations/enable-m2m-supplier-contacts.md)
