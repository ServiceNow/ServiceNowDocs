...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/view-supp-loc-supp-central.html
release: yokohama
...
3.  Navigate to the **Locations** section on the Company Profile page.

    The Locations section displays the details about your locations.
...
4.  Do one of the following:
    ...
    **Note:**
    ...
    You can also see location details from company page through **My Company** widget.
