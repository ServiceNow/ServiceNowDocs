---
title: Request something else using the supplier catalog
description: Request something else if the available catalog items in the supplier catalog do not meet your needs.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/supplier-lifecycle-operations/submit-general-request.html
release: zurich
...
4.  Under the General category, select the **General inquiry** catalog item.\[Omitted image "request-something-else.png"\] Alt text: Selected General inquiry catalog item.
