...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/run-rca-fix-script.html
release: yokohama
...
breadcrumb: [Restricted caller access approvals for Supplier Collaboration Portal, Install Supplier Collaboration Portal, Configuring Supplier Lifecycle Operations, Supplier Lifecycle Operations, Finance and Supply Chain]
---
...
Download the **SCP\_BULK\_RCAs\_Approval.xml** file from the [ServiceNow Store](https://store.servicenow.com/store/frame/app?pp=1a96d3851bab6010593876a61a4bcb01).\[Omitted image "xml-file-store.png"\] Alt text: Location of the XML file fix script for RCA approvals.
...
**Parent Topic:**[Restricted caller access approvals for Supplier Collaboration Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/supplier-lifecycle-operations/rca-approvals.md)
