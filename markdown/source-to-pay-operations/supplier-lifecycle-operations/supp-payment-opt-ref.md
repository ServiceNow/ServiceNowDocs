...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/supplier-lifecycle-operations/supp-payment-opt-ref.html
release: zurich
...
-   **[Supplier Payment Optimization data model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/supplier-lifecycle-operations/supp-opt-data-model.md)**  
The diagram shows the tables and their relationships that comprise the Supplier Payment Optimization data model.
-   **[Spend Savings Estimation table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/supplier-lifecycle-operations/spend-savings-estimation-table.md)**  
