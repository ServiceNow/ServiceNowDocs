...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/configure-user-criteria-for-reassigning-assessments.html
release: yokohama
...
3.  Open the **related lists** for the assessment template by right clicking the assessment name and selecting **Configure** &gt; **Related Lists**.
    ...
    \[Omitted image "related-links.png"\] Alt text: Opening related lists for the assessment template

4.  Add **User criteria** to the selected related list and **Save** the form.

    \[Omitted image "slo-user-criteria.png"\] Alt text: Add User criteria field to the assessment template

5.  In the **User criteria** section of the assessment template, select **Edit** to update the user criteria list.

    \[Omitted image "slo-user-criteria-list.png"\] Alt text: Edit button in User criteria section
...
6.  Add the required roles or configurations to the User criteria based on the Audience type and save the template.
    ...
    \[Omitted image "slo-user-criteria-supplier.png"\] Alt text: Add Supplier: Any Contact to the user criteria list.
...
-   **[Create custom user criteria for primary managers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/supplier-lifecycle-operations/create-new-user-criteria.md)**  
...
-   **[Create custom user criteria for all managers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/supplier-lifecycle-operations/create-user-criteria-all-managers.md)**  
