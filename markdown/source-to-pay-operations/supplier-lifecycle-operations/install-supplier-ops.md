...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/install-supplier-ops.html
release: yokohama
...
-   The new plugin Supplier Operations \(com.snc.sn\_so\) \(v 1.2.0 \) must be installed after upgrading to the Supplier Case Management Yokohama December 2025 \(v 5.2.0\) release.
