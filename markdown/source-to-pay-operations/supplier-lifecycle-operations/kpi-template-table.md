...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/source-to-pay-operations/supplier-lifecycle-operations/kpi-template-table.html
release: australia
...
keywords: [KPI Template table, Threshold set, Supplier count, Recommended weight, Collection source type]
