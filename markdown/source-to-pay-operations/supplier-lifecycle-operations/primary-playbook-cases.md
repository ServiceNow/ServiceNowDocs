...
-   Reject changes: Rejects your changes and opens the Reject changes stage.
 ...
 For more information, see [Non-Interactive activities](https://www.servicenow.com/docs/access?context=non-interactive-activities&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
...
</table>**Parent Topic:**[Source-to-Pay Workspace Supplier page](supp-ws-details-page.md)
