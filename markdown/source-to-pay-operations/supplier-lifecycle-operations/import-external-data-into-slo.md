...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/supplier-lifecycle-operations/import-external-data-into-slo.html
release: xanadu
...
Load the supplier data from the excel template into the supplier inbound​ staging tables. For more information, see [Load supplier data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/supplier-lifecycle-operations/load-supplier-data.md).
