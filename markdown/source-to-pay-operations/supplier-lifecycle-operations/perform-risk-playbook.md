...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/perform-risk-playbook.html
release: yokohama
...
The Perform risk assessment playbook flow create a due diligence request to verify the eligibility of the supplier. For more information, see [Risk assessment flow when Third-party Risk Due Diligence is installed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/supplier-lifecycle-operations/risk-flow-slo-tprm.md).

</td></tr></tbody>
</table>-   **[Risk assessment flow when only Vendor Risk Management is installed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/risk-flow-slo-vrm.md)**  
...
-   **[Risk assessment flow when Third-party Risk Due Diligence is installed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/supplier-lifecycle-operations/risk-flow-slo-tprm.md)**  
