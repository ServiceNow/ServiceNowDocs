...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/source-to-pay-operations/supplier-lifecycle-operations/post-upgrade-tasks-slo.html
release: australia
...
-   **[Run fix script to update the KPI weighted score field in the KPI score table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/supplier-lifecycle-operations/run-fixscript-update-kpi-weighted-score.md)**  
...
-   **[Run fix script to update the Aggregation method field in the KPI table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/supplier-lifecycle-operations/run-fixscript-update-kpi-aggregation-method.md)**  
...
-   **[Run fix scripts to enable Automated KPI collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/supplier-lifecycle-operations/run-fixscript-automated-kpis.md)**  
...
-   **[Run fix script to migrate existing data from the deprecated Action type column after upgrade](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/supplier-lifecycle-operations/fix-script-deprecated-column.md)**  
...
-   **[Enable deprecated case types after upgrade](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/supplier-lifecycle-operations/enable-deprecated-case-types.md)**  
