...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/supplier-lifecycle-operations/risk-flow-tprmdd-stages.html
release: xanadu
...
breadcrumb: [Risk assessment flow with Third-party Risk Due Diligence, Perform risk assessment playbook, Create a supplier from the Source-to-Pay Workspace, Using Source-to-Pay Workspace, Using Supplier Lifecycle Operations, Supplier Lifecycle Operations, Finance and Supply Chain]
---
...
</table>**Parent Topic:**[Risk assessment flow when Third-party Risk Due Diligence is installed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/supplier-lifecycle-operations/risk-flow-slo-tprm.md)
