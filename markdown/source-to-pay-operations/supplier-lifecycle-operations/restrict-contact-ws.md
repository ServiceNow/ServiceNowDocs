...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/restrict-contact-ws.html
release: yokohama
...
7.  Select **Restrict access**.\[Omitted image "restrict-access-primary-contact.png"\] Alt text: Selected Restrict access button.
