...
10. The supplier manager closes the due diligence request \(case\).
    ...
    For more information about the due diligence workflow, see [Due diligence workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/governance-risk-compliance/tprm-workflow-in-workspace.md).
