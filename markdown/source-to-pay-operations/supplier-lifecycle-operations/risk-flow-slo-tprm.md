...
10. The supplier manager closes the due diligence request \(case\).
    ...
    For more information about the due diligence workflow, see [Due diligence workflow](https://www.servicenow.com/docs/access?context=tprm-workflow-in-workspace&version=yokohama&pubname=yokohama-governance-risk-compliance&ft:locale=en-US).
