...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/supplier-lifecycle-operations/risk-flow-slo-tprm.html
release: zurich
...
10. The supplier manager closes the due diligence request \(case\).
    ...
    For more information about the due diligence workflow, see [Due diligence workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/governance-risk-compliance/tprm-workflow-in-workspace.md).


-   **[Playbook stages and activities when Third-party Risk Due Diligence is installed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/supplier-lifecycle-operations/risk-flow-tprmdd-stages.md)**  
...
**Parent Topic:**[Perform risk assessment playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/perform-risk-playbook.md)
