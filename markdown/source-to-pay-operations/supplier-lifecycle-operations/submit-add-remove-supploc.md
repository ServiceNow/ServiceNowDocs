...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/supplier-lifecycle-operations/submit-add-remove-supploc.html
release: zurich
...
9.  On the Supplier Location form, fill in the fields.
    ...
    For a description of the field values, see [Add New Location form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/supplier-lifecycle-operations/supplier-location-form.md).
