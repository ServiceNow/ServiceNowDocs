...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/submit-add-remove-supploc.html
release: yokohama
...
9.  On the Supplier Location form, fill in the fields.
    ...
    For a description of the field values, see [Add New Location form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/supplier-lifecycle-operations/supplier-location-form.md).
