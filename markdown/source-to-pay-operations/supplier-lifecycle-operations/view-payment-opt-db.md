...
description: The Payment optimization dashboard provides an overview of the total spend and potential savings for all suppliers.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/view-payment-opt-db.html
release: yokohama
...
2.  Select the **Payment optimization** icon \[Omitted image "pymt-opt-db-icon.png"\].
    ...
    \[Omitted image "pymt-opt-db.png"\] Alt text: Payment optimization dashboard
