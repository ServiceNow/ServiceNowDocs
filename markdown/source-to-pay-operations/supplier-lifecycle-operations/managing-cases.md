...
Depending on the risk score of the supplier, the following risk ratings are displayed:
        ...
        -   4 - Low
        -   5 - Very Low
For more information about risk ratings and risk scores, see [Set up risk rating scales for scoring](https://www.servicenow.com/docs/access?context=tprm-risk-rating-scales-config&version=zurich&pubname=zurich-governance-risk-compliance&ft:locale=en-US).
