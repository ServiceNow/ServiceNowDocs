...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/approve-sign-task-rca.html
release: yokohama
...
breadcrumb: [Configure document template for the Sign document action type, Configuring Supplier Lifecycle Operations, Supplier Lifecycle Operations, Finance and Supply Chain]
---
...
**Parent Topic:**[Configure the document template for the Sign document action type for supplier task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown)
