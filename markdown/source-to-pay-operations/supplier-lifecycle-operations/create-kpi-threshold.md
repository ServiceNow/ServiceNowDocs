...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/supplier-lifecycle-operations/create-kpi-threshold.html
release: xanadu
...
breadcrumb: [Create a KPI template, Configure Supplier Relationship and Performance Management, Configuring Supplier Lifecycle Operations, Supplier Lifecycle Operations, Finance and Supply Chain]
---
...
Option that indicates the threshold is active for use.
...
**Parent Topic:**[Create a KPI template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/supplier-lifecycle-operations/create-kpi-template-slo.md)
