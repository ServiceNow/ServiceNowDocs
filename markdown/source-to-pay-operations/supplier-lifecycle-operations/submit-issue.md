...
4.  Under the General category, select the **Submit or report an issue** catalog item.![Selected catalogue item for submitting or reporitng an issue.](../image/submit-issue.png)
...
7.  To add attachments, such as documents and image files, to the request, select the add attachments icon \(![Add attachments icon.](../image/attachments-icon.png)\).
