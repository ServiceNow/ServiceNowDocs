---
title: Submit an issue using the supplier catalog
description: Submit an issue that you need help with.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/supplier-lifecycle-operations/submit-issue.html
release: zurich
...
4.  Under the General category, select the **Submit or report an issue** catalog item.\[Omitted image "submit-issue.png"\] Alt text: Selected catalogue item for submitting or reporitng an issue.
...
7.  To add attachments, such as documents and image files, to the request, select the add attachments icon \(\[Omitted image "attachments-icon.png"\] Alt text: Add attachments icon.\).
