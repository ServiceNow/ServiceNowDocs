...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/create-doc-config.html
release: yokohama
...
breadcrumb: [Supplier Document Management, Configuring Supplier Lifecycle Operations, Supplier Lifecycle Operations, Finance and Supply Chain]
---
...
<table id="choicetable_ur2_ykv_dvb"><thead><tr><th align="left" id="d82645e50">

To

</th><th align="left" id="d82645e53">

Do This

</th></tr></thead><tbody><tr><td id="d82645e59">
...
3.  On the form, fill in the fields.
    ...
    |Order|The order that you want the configuration to be displayed. Assign a numeric value in multiples of 100.|
    |Active|Option to decide if this configuration is in use.|
    |Description|A brief description of the configuration.|

4.  Select the **Run condition** tab and fill in the fields.
...
</table>5.  Select the **Upload preferences** tab and fill in the fields.
...
For more information, see [Manage documents from the Supplier Collaboration Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/supplier-lifecycle-operations/upload-doc-portal.md).
...
</table>6.  Select the **Manage access** tab and fill in the fields.
...
7.  Select the **Notification** tab and fill in the fields.
...
The user that you want to notify when the document is uploaded.This field becomes available only if you select **Yes** in the **Notify on upload** field.
...
The user that you want to notify when the document expires.This field becomes available only if you select **Yes** in the **Notify on expiry** field.
...
The order that you want the configuration to be displayed. Assign a numeric value in multiples of 100.
...
**Parent Topic:**[Supplier Document Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/supplier-lifecycle-operations/supp-doc-mgmt-overview.md)
