...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/supplier-lifecycle-operations/view-overall-supp-db.html
release: yokohama
...
breadcrumb: [Overall supplier dashboard, Using Source-to-Pay Workspace, Using Supplier Lifecycle Operations, Supplier Lifecycle Operations, Finance and Supply Chain]
---
...
2.  Select the Overall supplier dashboard \(\[Omitted image "supp-db.png"\] Alt text: dashboard icon\) icon.
...
**Parent Topic:**[Overall supplier dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/supplier-lifecycle-operations/overall-supplier-db.md)
