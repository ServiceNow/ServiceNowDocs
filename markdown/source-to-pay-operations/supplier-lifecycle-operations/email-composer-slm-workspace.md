...
For more information on how to create a quick message, see [Define a quick message](https://www.servicenow.com/docs/access?context=t_QuickMessages&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
For more information on how to work with response templates, see [Create or modify a response template](https://www.servicenow.com/docs/access?context=create-modify-templated-snippet&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
[Managing supplier cases from the Source-to-Pay Workspace](managing-cases.md)

[Managing supplier tasks from the Source-to-Pay Workspace](managing-tasks.md)
...
[Managing supplier contacts from the Source-to-Pay Workspace](managing-contacts-smw.md)
