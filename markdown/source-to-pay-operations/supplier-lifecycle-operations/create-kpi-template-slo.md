...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/source-to-pay-operations/supplier-lifecycle-operations/create-kpi-template-slo.html
release: australia
...
keywords: [manual KPI template, KPI template, frequency schedule, quantitative KPI, qualitative KPI, performance domain, collection frequency]
