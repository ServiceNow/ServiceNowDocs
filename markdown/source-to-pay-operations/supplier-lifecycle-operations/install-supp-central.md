...
Ensure that you complete the post installation mandatory steps. For more information, see [Post installation troubleshooting](https://www.servicenow.com/docs/access?context=post-install-steps&version=yokohama&pubname=yokohama-employee-service-management&ft:locale=en-US).
