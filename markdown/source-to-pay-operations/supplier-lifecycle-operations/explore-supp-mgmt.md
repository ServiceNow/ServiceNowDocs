...
[Risk Assessments Integration for Supplier Lifecycle Operations](https://www.servicenow.com/docs/access?context=better-tprm-slo&version=zurich&pubname=zurich-better-together&ft:locale=en-US)
...
-   **![](../../../reuse/icons/dcx-icons/dcx-icon-docs.svg) Release Notes**
    ...
    Learn more about what's new and changed. See the [Supplier Lifecycle Operations release notes](https://www.servicenow.com/docs/access?context=supplier-lifecycle-operations-rn&version=zurich&pubname=zurich-release-notes&ft:locale=en-US).
