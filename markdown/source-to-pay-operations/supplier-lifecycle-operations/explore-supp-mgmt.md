...
For more information about installing and configuring Supplier Lifecycle Operations, see [Configuring Supplier Lifecycle Operations](config-supp-mgmt.md).
...
[Risk Assessments Integration for Supplier Lifecycle Operations](https://www.servicenow.com/docs/access?context=better-tprm-slo&version=yokohama&pubname=yokohama-better-together&ft:locale=en-US)
...
-   **![](../../../reuse/icons/dcx-icons/dcx-icon-docs.svg) Release Notes**
    ...
    Learn more about what's new and changed. See the [Supplier Lifecycle Operations release notes](https://www.servicenow.com/docs/access?context=supplier-lifecycle-operations-rn&version=yokohama&pubname=yokohama-release-notes&ft:locale=en-US).
