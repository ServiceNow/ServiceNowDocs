...
-   The Supplier Lifecycle Operations application \(com.snc.sn\_supplier\_mgmt\) installs the following dependent plugins.
    ...
    -   Geo Map component \(sn\_geo\_map\)
        ...
        **Note:** For the Geo Map component \(sn\_geo\_map\) plugin, ensure that you configure the Geo map properties. For more information, see [Configure properties for Supplier Lifecycle Operations](../reference/config-prop-supp-mgmt.md).
...
-   **[Application plugin installation sequence in Supplier Lifecycle Operations](../reference/slm-plugin-list.md)**  
