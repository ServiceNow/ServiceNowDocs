...
8.  To request assistance from other departments in resolving the Universal Request simultaneously, select **Create Associated Ticket**.
    ...
    For more information on creating associated tickets, see [Create associated ticket for primary ticket of UR](https://www.servicenow.com/docs/access?context=create-associated-ticket&version=yokohama&pubname=yokohama-employee-service-management&ft:locale=en-US).
