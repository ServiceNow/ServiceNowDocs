...
2.  In the Finance Operations Workspace, select the List icon \(![List icon](../../supplier-lifecycle-operations/image/cases-list-icon.png)\) to open the List page.
...
The details of finance cases are displayed on the **Details** tab of the Finance Operations Workspace. For more information, see [Finance Operations Workspace Case Details page](../concept/case-details-fin-ops-ws.md).![View a finance case](../image/fin-ops-view-case.png)
