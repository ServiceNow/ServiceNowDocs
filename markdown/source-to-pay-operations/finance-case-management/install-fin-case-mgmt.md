...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/finance-case-management/install-fin-case-mgmt.html
release: yokohama
...
breadcrumb: [Configuring Finance Case Management, Finance Case Management, Finance and Supply Chain applications, Finance and Supply Chain]
---
...
1.  Navigate to **All** &gt; **Application Manager**.
    ...
    \[Omitted image "fin-case-mgmt-installation.png"\] Alt text: Menu path to Application Manager
...
-   **[Components installed with Finance Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/finance-case-management/installed-with-fin-ops.md)**  
...
**Parent Topic:**[Configuring Finance Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/finance-case-management/config-fin-case-mgmt.md)

**Related topics**  


[Configuring Finance Operations Workspace]()
