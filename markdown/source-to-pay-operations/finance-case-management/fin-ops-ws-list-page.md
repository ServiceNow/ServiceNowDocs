...
In the Finance Operations Workspace, select the List icon ![List icon.](../../supplier-lifecycle-operations/image/cases-list-icon.png) to open the List page.
...
**Parent Topic:**[Exploring the Finance Operations Workspace](fin-ops-workpace.md)
