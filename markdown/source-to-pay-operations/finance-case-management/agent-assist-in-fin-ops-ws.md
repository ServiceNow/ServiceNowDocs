...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/finance-case-management/agent-assist-in-fin-ops-ws.html
release: yokohama
...
You can also search for knowledge articles. Select the search resource icon \(\[Omitted image "Form\_PersonalizeFormIcon.png"\] Alt text: Select a resource icon.\) and select **Knowledge Articles** to view the articles.
