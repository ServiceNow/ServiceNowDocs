...
breadcrumb: [Finance Operations Workspace Case Details page, Exploring the Finance Operations Workspace, Exploring Finance Case Management, Finance Case Management, Finance and Supply Chain applications, Finance and Supply Chain]
---
...
7.  Enter the email body, if necessary.
    ...
    By default, the email body contains the link to the finance case. You can also use the email templates. For more information on email templates, see [Email templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/c_EmailTemplates.md).
