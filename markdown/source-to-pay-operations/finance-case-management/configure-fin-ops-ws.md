...
For more information on how to configure using UI Builder, see [Create a page in UI Builder](https://www.servicenow.com/docs/access?context=create-page&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
