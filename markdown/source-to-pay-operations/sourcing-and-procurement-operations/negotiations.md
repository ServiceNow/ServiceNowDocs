...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/source-to-pay-operations/sourcing-and-procurement-operations/negotiations.html
release: australia
...
View and track all the sourcing requests associated with the purchase lines in the negotiation​.For details, see [Sourcing request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/sourcing-and-procurement-operations/sourcing-request.md).
...
View and track all the draft contracts for the supplier referenced on the negotiation. For more details, see [Contracts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/sourcing-and-procurement-operations/contracts.md).
