...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/negotiations.html
release: xanadu
...
View and track all the sourcing requests associated with the purchase lines in the negotiation​.For details, see [Sourcing request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/sourcing-request.md).
...
View information on all the purchasing tasks that are related to the negotiation. For details, see [Purchasing tasks and procurement cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/purchasing-tasks.md).
...
View and track all the draft contracts for the supplier referenced on the negotiation. For more details, see [Contracts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/contracts.md).
