...
description: Revisions for the quantity of the product, budget, or delivery location can be made to orders placed from Shopping Hub.
locale: en-US
release: xanadu
...
Revisions for the quantity of the product, budget, or delivery location can be made to orders placed from Shopping Hub.

The shopper can revise an order from Shopping Hub or the procurement specialist can submit revision from the Sourcing and Purchasing Automation module.
...
-   Shopper-initiated purchase order revision:
    -   When the status of a purchase order is not **Closed Complete** or **Closed Canceled**, a shopper can revise the lines from Shopping Hub. A revision request is created and assigned to the procurement specialist, and the state is updated to **Closed Complete**. A procurement specialist does not have to confirm the revision request prior to creation of the revised purchase requisition.
...
-   Shopper-initiated blanket purchase order revision:
    -   When the status of a blanket purchase order is not **Closed Released**, a shopper can initiate a revision from Shopping Hub. Only the quantity and budget can be revised on a blanket purchase order.
...
Revisions are not allowed in Shopping Hub for lines that have been fully received. Revisions can only be triggered for an amount that exceeds the received amount.
