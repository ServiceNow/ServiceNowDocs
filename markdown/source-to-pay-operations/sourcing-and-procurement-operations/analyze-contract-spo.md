...
For more information, see [Contract analysis using Now Assist in Contract Management](https://www.servicenow.com/docs/access?context=cncore-NA-review-land&version=yokohama&pubname=yokohama-employee-service-management&ft:locale=en-US).
...
<table id="choicetable_p3s_2gn_zcc"><thead><tr><th align="left" id="d73682e150">

Method

</th><th align="left" id="d73682e153">

Steps

</th></tr></thead><tbody><tr><td id="d73682e159">
