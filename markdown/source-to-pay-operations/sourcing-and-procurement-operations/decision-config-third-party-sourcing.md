...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/decision-config-third-party-sourcing.html
release: xanadu
...
When a shopper requests pricing for an item that must be sourced in Shopping Hub, the following decision inputs are automatically evaluated in ServiceNow:
...
**Parent Topic:**[Sourcing and Procurement Operations integration with third-party sourcing solutions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/psm-integration-third-party-sourcing.md)
