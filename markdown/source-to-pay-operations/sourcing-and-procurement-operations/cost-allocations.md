...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/cost-allocations.html
release: xanadu
...
-   From the Shopping Hub catalog, the cost allocation is created from the payment method that the employee selects during checkout. The employee can define the cost center to allocate to, and can split the allocation amongst multiple cost centers, as required. Employee credits and paycheck payments also result in the creation of a cost allocation.
...
**Parent Topic:**[Purchase lines](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/purchase-lines.md)
