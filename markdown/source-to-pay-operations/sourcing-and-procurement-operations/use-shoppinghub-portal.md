...
This video shows the shopper journey. Approximately three minutes thirteen seconds long.
...
For detailed information on how to configure your experience with UIB, see [Working in UI Builder](https://www.servicenow.com/docs/access?context=using-ui-builder&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
...
-   **[Browse punchout and native catalog items from the Categories and Suppliers lists in Shopping Hub \(SH\)](../task/sh-browse-products.md)**  
...
-   **[Order a product with quick checkout](../task/order-a-product.md)**  
...
-   **[Shopping cart](../concept/shopping-cart.md)**  
...
-   **[Complete your checkout](../task/complete-your-checkout.md)**  
Proceed to checkout when you’ve completed your shopping and have reviewed your shopping cart.
-   **[Purchasing from punchout or third-party suppliers](../concept/purch-punchout-third-party-supp.md)**  
...
-   **[Unified request tracking in Shopping Hub](../concept/sh-unified-request-tracking.md)**  
...
-   **[Hide supplier pricing from ShoppingHub](hide-supplier-pricing-from-shoppinghub.md)**  
...
-   **[Requesting for products or services that you don't see on ShoppingHub](../concept/request-prod-serv-dont-see-sh.md)**  
...
-   **[Submit a quote](../task/submit-quote.md)**  
...
-   **[Return a product](../task/return-a-product.md)**  
You can request a return for a product that has been fully or partially delivered to you.
-   **[Submit an edit receipt request from Shopping Hub](../task/submit-edit-receipt-request.md)**  
...
-   **[Create an employee credit](../task/create-employee-credit.md)**  
...
-   **[Create a credit allocation rule](../task/create-credit-allocation-rule.md)**  
...
-   **[Create a paycheck period](../task/create-paycheck-period.md)**  
...
-   **[Shopping controls overridden by credits](shopping-controls-overridden.md)**  
...
-   **[Shop with employee credits](../task/shop-employee-credits.md)**  
...
-   **[Alerts and email notifications from ShoppingHub](alerts-messages-email-notifications.md)**  
...
-   **[Prioritize Shopping Hub email notifications](../task/prioritize-email-notifications.md)**  
...
**Parent Topic:**[Use Sourcing and Procurement Operations](../concept/using-spo.md)
...
[Using Procurement Case Management](../concept/using-pcm.md)

[Working with Sourcing and Procurement Operations playbooks in the Source-to-Pay Workspace](../concept/work-playbooks-spo.md)

[Using Spend and Savings Management](../concept/using-spend-mgmt.md)

[Using Sourcing Pipeline Management](../concept/use-pipeline-sourcing-mgmt.md)
...
[Setting up primary data for Shopping Hub](set-up-master-data-shopping-hub.md)
...
[Customize your top suppliers in Shopping Hub](../task/customize-top-suppliers.md)
