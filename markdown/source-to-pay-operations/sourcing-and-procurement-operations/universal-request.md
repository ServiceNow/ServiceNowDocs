...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/sourcing-and-procurement-operations/universal-request.html
release: zurich
...
3.  The routing agent creates a procurement case as the primary ticket for resolution.
    ...
    For more information, see [Create a procurement case from a Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/sourcing-and-procurement-operations/create-procurement-case-from-ur.md).
...
4.  When **Need resolution review** is enabled, the routing agent reviews the resolution and determines the next steps:
    ...
    -   Rejects the resolution: The procurement case is dissociated from the Universal Request and the routing agent creates a new primary ticket for resolution.
