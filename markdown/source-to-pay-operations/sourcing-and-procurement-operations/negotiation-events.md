...
System-generated unique identifier of the negotiation event.
...
User who is responsible for the negotiation event.
...
Current state of the negotiation event.**Note:** This is a read-only field.
...
Brief of the negotiation event.
...
Type of negotiation event or the method used to engage with the supplier. For example, you can initiate a contract renewal or ask for a quote.
...
Anticipated outcome or end results of the negotiation event. For example, you can negotiate contract terms or standard savings on a purchase.
...
Expected start date of the negotiation event.
...
Actual start date of the negotiation event.
...
Actual end date of the negotiation event.
...
Duration of the negotiation event.
...
Objectives or goals for the negotiation event.
...
Notes on closure of the negotiation event, if any.

</td></tr></tbody>
</table>The following are the related lists of a negotiation event:
...
View and track all the signed contracts for the suppliers referenced on the negotiation event.
...
View and track all the other legal documents for the suppliers referenced on the negotiation event.
...
Displays all the associated contract requests against this negotiation event.**Note:** This field is displayed only if you have the Source-to-Pay Operations with Contract Management Pro plugin \(com.snc.sn\_spend\_clm\) installed.
...
View all the purchase SLAs associated to purchasing tasks against the negotiation event, along with tasks associated to the underlying purchase requisition lines.
