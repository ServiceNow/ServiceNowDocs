...
A bundled model is a single model comprised of individual models. For example, a laptop, printer, keyboard, and mouse can be combined into a single bundled model. For this bundled model to appear in the Shopping Hub portal, you have to create a supplier product for the same. Once the supplier product is created and published, it will be available for purchase in Shopping Hub. For more information on how to create bundled models, see [Bundled models](https://servicenow.com/docs/bundle/washingtondc-it-asset-management/page/product/product-catalog/concept/c_CreatingBundledModels.html).
