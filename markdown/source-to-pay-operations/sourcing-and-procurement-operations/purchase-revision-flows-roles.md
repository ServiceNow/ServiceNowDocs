...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/purchase-revision-flows-roles.html
release: xanadu
...
As an admin or process owner, you can facilitate shoppers with a process to raise edit or cancel requests from Service Catalog and Shopping Hub. Define a unified task-view playbook experience for agents to process the approval workflows:

## Shopper

As a shopper, you can raise the edit or cancel requests for the following objects from Shopping Hub or Service Catalog:
...
As an agent or fulfiller or buyer, you can process these requests from the procurement workspace [playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/process-automation-designer-flows-psm.md):
...
\[Omitted image "edit-flow.png"\] Alt text: Raise an edit request from Shopping Hub
...
\[Omitted image "cancel-flow.png"\] Alt text: Raise a cancel request from Shopping Hub
