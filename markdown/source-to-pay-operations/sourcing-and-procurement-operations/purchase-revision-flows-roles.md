...
As an agent or fulfiller or buyer, you can process these requests from the procurement workspace [playbook](process-automation-designer-flows-psm.md):
...
![Raise an edit request from Shopping Hub](../image/edit-flow.png "Edit request overview")
...
![Raise a cancel request from Shopping Hub](../image/cancel-flow.png "Cancel request overview")
