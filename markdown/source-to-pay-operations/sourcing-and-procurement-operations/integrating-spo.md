...
-   **Source-to-Pay Integration Framework**
    ...
    For more information on this, see [Spendint API](../../../integrate/inbound-rest/concept/spendint-api.md).
...
-   **Primary Data Integration with SAP**
    ...
    For more information on this, see [Source-to-Pay integration with SAP ECC and SAP S4 HANA](../../source-to-pay-operations/concept/source-to-pay-sap-integration.md).
