...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/configure-additional-questions-for-checkout.html
release: xanadu
...
3.  In Catalog Builder, configure a record producer titled Shopping Hub Additional Questions using the **ShoppingHub additional questions for a PR** template.
    ...
    **Note:** For information on how to create a record producer, see [Create a catalog item using a template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/service-catalog/create-item-cat-builder.md).
