...
2.  Select a purchase order and a purchase order line in it.
    ...
    **Note:** Remember that the **Edit** option is not available for purchases in the Close state.
...
6.  Add an attachment to support your edit request, if applicable.
    ...
    This file is attached to the procurement case record initially, and then to the purchase order associated to that procurement case when the case is closed.
