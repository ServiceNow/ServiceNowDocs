...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/approval-email-notifications-template.html
release: xanadu
...
breadcrumb: [Approve a request from Employee Center, Sourcing and Procurement Operations integration with Employee Center, Integrating Sourcing and Procurement Operations with other applications, Sourcing and Procurement Operations, Finance and Supply Chain]
---
...
**Parent Topic:**[Approve a request from Employee Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/approve-request-from-employee-center.md)
