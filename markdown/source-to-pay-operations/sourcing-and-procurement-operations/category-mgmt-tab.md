...
description: The Category management tab provides a unified, filter-driven view of category performance across spend, savings, pipeline projects, contracts, purchase orders, and suppliers.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/category-mgmt-tab.html
release: yokohama
...
breadcrumb: [Spend and Savings Management, Exploring Sourcing and Procurement Operations, Sourcing and Procurement Operations, Finance and Supply Chain]
---
...
Displays total spend from all settled invoices for the selected time period, along with a trend line showing spend progression over time.**Note:** The spend data covers only the last 750 days. You can run the fix script and modify the period to retrieve spend data for their preferred date range.
...
</table>**Parent Topic:**[Spend and Savings Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/spo-spend-mgmt.md)
