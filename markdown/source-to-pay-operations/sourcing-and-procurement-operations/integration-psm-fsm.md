...
description: The Procurement for Field Service Management plugin \(snc.fsm\_psm\_mobile\) provides an integration between the Field Service Management and Sourcing and Procurement Operations applications.
locale: en-US
release: xanadu
...
The Procurement for Field Service Management plugin \(snc.fsm\_psm\_mobile\) provides an integration between the Field Service Management and Sourcing and Procurement Operations applications.
