...
For more information, see [Contract metadata extraction using Now Assist in Contract Management](https://www.servicenow.com/docs/access?context=cncore-metadata-extract-land&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).
...
Review the metadata extracted from a contract and add it to the contract repository. For more information, see [Work with extracted metadata](https://www.servicenow.com/docs/access?context=cncore-review-metatdata&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).
