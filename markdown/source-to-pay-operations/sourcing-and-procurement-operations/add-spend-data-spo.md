...
keywords: [spend category data, add spend category data, add spend category data in an Excel file template]
...
3.  Select and hold \(or right-click\) any column heading and select **Export** &gt; **.xlsx**.
