...
4.  Complete the initial configuration steps to set up CM Pro.
    ...
    For more information on setting up Contract Management Pro, see [Add and configure contract request functionality](https://www.servicenow.com/docs/access?context=cncore-uptake-steps&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US).
