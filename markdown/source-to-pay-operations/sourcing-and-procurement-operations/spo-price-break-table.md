...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/sourcing-and-procurement-operations/spo-price-break-table.html
release: zurich
...
|-----|---------|-----------|
|From quantity|Decimal|Lower limit quantity for a price break.|
|To quantity|Decimal|Upper limit quantity for a price break.|
|Price|Currency|Price amount for the price break.|
|Supplier product contract|Reference|Supplier product and contract relationship associated with the price break.|
