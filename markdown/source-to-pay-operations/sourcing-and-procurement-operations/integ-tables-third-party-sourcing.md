...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/integ-tables-third-party-sourcing.html
release: yokohama
...
-   Negotiation Event Outbound Queue, which stores the negotiation type, objectives, third party sourcing event record, sourcing event number, and supplier response close associated with the sourcing requests.
