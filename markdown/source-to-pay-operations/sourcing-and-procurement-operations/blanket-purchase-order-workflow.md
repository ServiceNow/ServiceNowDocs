...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/blanket-purchase-order-workflow.html
release: yokohama
...
For details on the various fields and related lists that are populated for a blanket purchase order, see [Purchase order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/purchase-order.md).
