...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/blanket-purchase-order-workflow.html
release: xanadu
...
For details on the various fields and related lists that are populated for a blanket purchase order, see [Purchase order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/purchase-order.md).
