...
4.  Select **Summarize**.
    ...
    ![Summarize option that appears at the top of the record in ShoppingHub.](../image/sh-po-summarize.png)

    **Note:** Generating and displaying the summary may take several seconds.

5.  Review the summary details.

    A concise summary of a record, including its overview and next steps you need to take. The information that is displayed is based on the type of the record.![Summarized purchase order.](../image/sh-po-summarized.png)
...
<table id="choicetable_md1_nyf_xyb"><thead><tr><th align="left" id="d148106e246">

Option

</th><th align="left" id="d148106e249">

Procedure

</th></tr></thead><tbody><tr><td id="d148106e255">
...
</td></tr><tr><td id="d148106e299">

**Copy the record summary**

</td><td>

Select the copy to clipboard icon \(![Copy to clipboard icon.](../../accounts-payable-operations/image/icon-copy.png)\) to use the record summary information for another purpose, such as pasting into an email.

</td></tr><tr><td id="d148106e314">
...
**Parent Topic:**[Using Now Assist for Sourcing and Procurement Operations \(SPO\)](../concept/now-assist-spo-using.md)
