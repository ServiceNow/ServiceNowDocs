...
-   **[Add a supplier](../task/create-supplier.md)**  
Add suppliers and their products to populate your primary data.
-   **[Add office locations](../task/create-office-locations.md)**  
...
-   **[Add delivery locations](../task/create-delivery-locations.md)**  
Add the address that can be selected by the user to have the product delivered. You can add multiple delivery locations.
-   **[Setting up your product catalog](../task/create-product-catalogue.md)**  
...
-   **[Lead time calculations](lead-time-calculations.md)**  
...
-   **[Ledger assignment rules](../concept/ledger-assignment-rules.md)**  
When a purchase line is created for a purchase requisition on the Shopping Hub portal, the details of capex account, expense account, and pre-paid account are auto-populated based on applicable ledger assignment rules.
-   **[Create shopping controls](../task/create-shopping-controls.md)**  
...
-   **[Configure delegate for a shopper](../task/configure-delegate-for-a-shopper.md)**  
...
-   **[Shopping Hub configuration](../concept/shoppinghub-configurations.md)**  
As an admin, you can create and modify Shopping Hub configurations to offer a standardized experience.
-   **[Sourcing checkout](../concept/sourcing-checkout.md)**  
As a Shopping Hub or Procurement administrator, you can configure checkouts for sourcing requests to collect information that is relevant to the product, product model, or category. Your teams can automate the sourcing processes, share more information, and improve operational efficiency.
-   **[Shopping Hub process visibility configuration](../concept/process-visibility-configuration.md)**  
...
[Service portal configuration for Shopping Hub](../concept/service-portal-configuration-for-shoppinghub.md)
