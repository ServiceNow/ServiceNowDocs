...
**Note:** To know more about EC and how to set it up as an admin, visit the [Employee Center](https://www.servicenow.com/docs/access?context=employee-center-landing-page&version=australia&pubname=australia-employee-service-management&ft:locale=en-US) home page.
...
**Note:** Admins can create new to-do widgets to show up in Employee Center, or configure existing widgets from **Employee Center** &gt; **Activity Configurations**. For more information, see [Employee tasks page](https://www.servicenow.com/docs/access?context=employee-center-to-dos-page-configuration&version=australia&pubname=australia-employee-service-management&ft:locale=en-US).
...
For detailed information on how to work with configurable task filters, see [Configurable task filters](https://www.servicenow.com/docs/access?context=configurable-filters-experience-employee&version=australia&pubname=australia-employee-service-management&ft:locale=en-US).
...
**Note:** Admins can also configure these active items widgets in Employee Center. For more information, see [My active items widget configuration](https://www.servicenow.com/docs/access?context=my-activity-config&version=australia&pubname=australia-employee-service-management&ft:locale=en-US).
