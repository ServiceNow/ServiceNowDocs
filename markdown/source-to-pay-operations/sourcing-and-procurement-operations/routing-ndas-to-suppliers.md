...
2.  Set up DocuSign.
    ...
    For more information, see [Docusign eSignature Spoke](https://www.servicenow.com/docs/access?context=docusign-spoke&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).

3.  Navigate to **All** &gt; **Procurement Case Management** &gt; **Procurement Workspace**.
4.  Select the list icon and select **All work** &gt; **Cases**.
5.  Select **New**.
