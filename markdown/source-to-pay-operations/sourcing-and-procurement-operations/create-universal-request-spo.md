...
2.  In the **How can we help?** search bar, enter a description of your request in natural language.
...
3.  Review the search results to check whether an existing catalog item or knowledge article addresses your need.
