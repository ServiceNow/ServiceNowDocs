...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/configure-awa-spo.html
release: xanadu
...
2.  Create a service channel to automatically route incoming work to agents.
    ...
    -   Procurement Cases: For more information,see [Automatic case creation from emails](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/case-creation-from-emails.md).
    -   Chat. For more information,see [Using Advanced Work Assignment for Source-to-Pay Operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/using-awa-spo.md).
