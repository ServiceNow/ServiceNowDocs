...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/sourcing-and-procurement-operations/purchase-refinement-options.html
release: zurich
...
keywords: [purchase refinement options, purchase refinement, options to refine purchases]
...
\[Omitted image "shoppinghub-filter-open.png"\] Alt text: Filter options in Shopping Hub
...
\[Omitted image "sort-by-date-submitted.png"\] Alt text: Sorting options in Shopping Hub.
...
\[Omitted image "my-purchases-shoppinghub.png"\] Alt text: Tabs to view by purchase or by line.
...
\[Omitted image "shoppinghub-user-actions.png"\] Alt text: User actions in Shopping Hub.
