...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/work-approval-todos.html
release: yokohama
...
4.  On the **Pending approval** tab, view details of the approval requests, such as requester name, total amount or budget requiring approval, and request ID at the header level.
...
5.  Do any of these actions.
    ...
    **Note:** When rejecting a purchase requisition, you must provide your justification for rejection on the **Reason for rejection** window.
