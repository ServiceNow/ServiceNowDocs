...
breadcrumb: [Install ShoppingHub Mobile, Configure, Sourcing and Procurement Operations, Finance and Supply Chain]
---
...
2.  Download the Now mobile application on an iOS platform from the Apple App Store or on an Android platform from the Google Play Store.
    ...
    For more information on using this mobile app, see [Now Mobile app](https://www.servicenow.com/docs/access?context=mobile-employee-experience&version=australia&pubname=australia-employee-service-management&ft:locale=en-US) topic.
...
[Log in to an instance with a mobile app](https://www.servicenow.com/docs/access?context=login-end-user&version=australia&pubname=australia-mobile&ft:locale=en-US)
