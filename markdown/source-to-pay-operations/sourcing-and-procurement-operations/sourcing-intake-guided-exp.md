...
For details on how administrators, agents, and fulfillers can configure playbooks, see [Running playbooks](https://www.servicenow.com/docs/access?context=playbook-agents-and-fulfillers&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US). For more information on Playbooks stages and activities, see [Stages and activities](https://www.servicenow.com/docs/access?context=process-automation-designer-lanes-activities&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
