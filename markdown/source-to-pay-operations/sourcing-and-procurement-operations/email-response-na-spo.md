...
6.  To generate a context-based email response, select the Now Assist icon ![Sparkle icon for Now Assist](../../../common/image/icon-ai-sparkle.png) to generate a context-based email response.
