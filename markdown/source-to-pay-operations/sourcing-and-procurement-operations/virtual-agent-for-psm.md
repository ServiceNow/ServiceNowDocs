...
For more information on Virtual Agent in general, its components, benefits, and basic user interface, see [Virtual Agent](https://www.servicenow.com/docs/access?context=virtual-agent-landing-page&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
