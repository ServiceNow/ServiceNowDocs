...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/invoices.html
release: xanadu
...
When the services acknowledgment is set to **Invoice approval**, invoice approvals act as a form of receipt before issuing the payment to a supplier.In the absence of a receipt and three-way matching, invoice approvals are used to avoid an automatic two-way match.
 ...
 Invoice approvals are sent to the recipient of the line and the shopper can act on them as a to-do in Shopping Hub.

 For details, see [Shopper to-dos](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/sourcing-and-procurement-operations/shopper-todos.md).
