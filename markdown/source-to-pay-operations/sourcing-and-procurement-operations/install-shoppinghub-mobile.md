...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/sourcing-and-procurement-operations/install-shoppinghub-mobile.html
release: zurich
...
4.  In the Application installation dialog box, review the application dependencies.
    ...
    If your application requires other applications, you need to install them first if they are not already installed.

    Installing your application also automatically installs dependent applications or plugins if they are not installed already.
...
-   **[Enable the mobile experience for ShoppingHub Mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/source-to-pay-operations/sourcing-and-procurement-operations/enable-shoppinghub-mobile.md)**  
