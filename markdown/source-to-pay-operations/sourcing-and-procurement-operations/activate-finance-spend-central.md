...
6.  Source-to-Pay Common Architecture \[snc.sn\_shop\]
7.  Sourcing and Purchasing Automation \[snc.sn\_pr\]
...
8.  Shopping Hub \[snc.sn\_spend\_uib\]
...
For more information on these applications and their dependencies, see [Application plugin installation sequence](../reference/application-plugin-list.md).
...
6.  Select **Install**.
    ...
    To uninstall an application, see [Uninstall an application](https://www.servicenow.com/docs/access?context=t_UninstallApplications&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
-   [Components installed with ERP Integration Framework for Sourcing and Procurement Operations](../reference/installed-with-FSC-ERP.md)
