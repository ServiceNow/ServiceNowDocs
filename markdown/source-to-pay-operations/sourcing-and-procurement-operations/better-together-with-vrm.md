...
For information on tiering and risk assessments on a vendor, see [Manage vendor tiering assessments](https://www.servicenow.com/docs/access?context=manage-risk-tiering-assessments&version=yokohama&pubname=yokohama-governance-risk-compliance&ft:locale=en-US) and [Manage vendor risk assessments](https://www.servicenow.com/docs/access?context=c_Issues&version=yokohama&pubname=yokohama-governance-risk-compliance&ft:locale=en-US).
