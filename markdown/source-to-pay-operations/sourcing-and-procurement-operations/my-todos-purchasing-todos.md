---
title: My to-dos and purchase-related tasks
...
keywords: [my to-dos, purchasing to-dos, purchasing tasks, purchasing actions]
breadcrumb: [Shopping Hub, Explore, Sourcing and Procurement Operations, Finance and Supply Chain]
---

# My to-dos and purchase-related tasks

As a shopper, you can review to-dos from the **To-dos** tab.

You can select the individual to-dos from the **My to-dos** tab and work with them as required. For more information on the various types of to-dos and how to work with them, see [Shopper to-dos](shopper-todos.md).![My to-dos.](../image/shoppinghub-my-to-dos.png)
...
In the **Purchase detail view**, you can also view all approval requests, including those that have not been requested. For example, if there is a sequential rule that has three approvers, all three purchase request approvals are displayed. Approvals are not triggered for the subsequent approvers though, and email notifications are sent only when approval is required for purchase request. If the approval is no longer required or complete, it is no longer displayed.![Purchasing to-dos.](../image/shoppinghub-purchasing-to-dos.png)
