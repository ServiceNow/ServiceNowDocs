...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/spend-category-run-trasnform.html
release: yokohama
...
breadcrumb: [Map spend categories to product categories, Using Spend and Savings Management, Using Sourcing and Procurement Operations, Sourcing and Procurement Operations, Finance and Supply Chain]
---
...
3.  In the **Import set table** field, select **Spend Category Stage \(sn\_spend\_mgmt\_category\_stage\)**.
