...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/sourcing-and-procurement-operations/fin-fx-rate-table.html
release: zurich
...
The Finance Exchange Rates \[sn\_fin\_fx\_rate\] table stores currency exchange rates used for Finance Common.

This table contains the following fields.

|Field|Data type|Description|
|-----|---------|-----------|
|ERP Source|Reference|ERP source system associated with the exchange rate.|
|Rate type|String|Type of the exchange rate.|
