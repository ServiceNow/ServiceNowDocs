...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/spo-sourcing-pipeline-mgmt.html
release: yokohama
...
For more information about using Sourcing Pipeline Management, see [Using Sourcing Pipeline Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/use-pipeline-sourcing-mgmt.md).
...
Install the [Sourcing Pipeline Management](https://store.servicenow.com/store/app/6ceb92461b472a942a76a643604bcb01) application from the ServiceNow Store. For more information about installing an application from the ServiceNow Store, [Install a ServiceNow Store application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_InstallApplications.md).
...
-   **[Components installed with Sourcing Pipeline Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/components-pipeline-mgmt.md)**  
...
-   **[Pipeline project creation rule for high-value sourcing requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/pipeline-project-creation-rule.md)**  
...
-   **[Automatic pipeline project creation via Shopping Hub or Employee Center intake requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/automatic-pipeline-creation.md)**  
...
-   **[Email notifications for pipeline projects](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/pipeline-email-notifications.md)**  
...
-   **[Pipeline management tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/sourcing-and-procurement-operations/pipeline-mgmt-tab.md)**  
