...
For more information on asset creation, see [Create assets](https://www.servicenow.com/docs/access?context=t_CreatingAssets&version=australia&pubname=australia-it-asset-management&ft:locale=en-US).
