...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/sourcing-and-procurement-operations/inventory-asset-creation.html
release: zurich
...
keywords: [inventory assets, create inventory assets]
...
For more information on asset creation, see [Create assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-asset-management/t_CreatingAssets.md).
