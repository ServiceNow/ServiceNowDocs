...
For more information on asset creation, see [Create assets](https://www.servicenow.com/docs/access?context=t_CreatingAssets&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US).
