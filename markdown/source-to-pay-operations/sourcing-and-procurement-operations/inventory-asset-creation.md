...
For more information on asset creation, see [Create assets](https://www.servicenow.com/docs/access?context=t_CreatingAssets&version=yokohama&pubname=yokohama-it-asset-management&ft:locale=en-US).
