---
title: Pricing \[sn\_shop\_m2m\_product\_contract\] table
description: The Pricing \[sn\_shop\_m2m\_product\_contract\] table stores contract-specific product pricing information.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/source-to-pay-operations/sourcing-and-procurement-operations/spo-pricing-table.html
release: australia
...
|-----|---------|-----------|
|Contract|Reference|Contract associated with the supplier product.|
|Price|Currency|Single contractual price associated with the supplier product.|
|Maximum price|Currency|Maximum price from price breaks for the supplier product.|
|Minimum price|Currency|Minimum price from price breaks for the supplier product.|
|Original unit cost|Currency|Original unit cost of the supplier product.|
|Price type|Choice|Type of contractual pricing for the supplier product. The options are Single Price or Price Break.|
|Display name|String|Display name for this relation.|
|Price duration|Choice|Whether the contractual price is for a one-time purchase or a term purchase. The options are One Time or Term.|
|ERP source|Reference|ERP source system associated with the supplier product contract.|
