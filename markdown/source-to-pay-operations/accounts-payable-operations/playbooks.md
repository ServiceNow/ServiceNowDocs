...
The generative AI skill is used to map purchase order lines with invoice lines. Mapping performed by a generative AI skill is displayed with an ![genAI](../image/genAI.png) icon.
