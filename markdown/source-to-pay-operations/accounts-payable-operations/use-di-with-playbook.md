...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/source-to-pay-operations/accounts-payable-operations/use-di-with-playbook.html
release: australia
...
-   [Extract data when Document Intelligence fails](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/accounts-payable-operations/extract-data-when-di-fails.md)
-   [Extract data when Document Intelligence is unavailable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/accounts-payable-operations/extract-data-when-di-is-unavailable.md)
...
-   **[Extract data when Document Intelligence fails](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/accounts-payable-operations/extract-data-when-di-fails.md)**  
Manually create an invoice for processing when Document Intelligence fails to process the ingestion task.
-   **[Extract data when Document Intelligence is unavailable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/accounts-payable-operations/extract-data-when-di-is-unavailable.md)**  
