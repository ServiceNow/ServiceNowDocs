...
For more information, see [Create new interaction](../task/create-new-interaction-record-in-apo.md).

.

-   **[Create new interaction](../task/create-new-interaction-record-in-apo.md)**  
