...
The Supplier Collaboration portal application integrated with Accounts Payable Operations provides seamless interaction between Account Payable Specialist and suppliers for creating invoice inquiry case, submitting new invoices, resolving case tasks and exception tasks.
