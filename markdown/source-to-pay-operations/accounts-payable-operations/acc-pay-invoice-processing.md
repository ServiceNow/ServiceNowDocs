...
description: Accounts Payable Invoice Processing automates invoice document ingestion and data extraction using ServiceNow Document Intelligence and supports the complete invoice life cycle from capture through approval.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/source-to-pay-operations/accounts-payable-operations/acc-pay-invoice-processing.html
release: australia
...
keywords: [APO, Accounts Payable Operations, invoice capture, invoice processing, invoice ingestion]
...
For more information about installing Accounts Payable Invoice Processing, see [Install Accounts Payable Invoice Processing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/source-to-pay-operations/accounts-payable-operations/install-acc-pay-mgmt.md).
