...
8.  In the **Toggle display** page, you can enable the **Display** option to display AI agent output in the Now Assist panel.\[Omitted image "apo-toggle.png"\] Alt text: Toggle display

9.  Select **Save and test**.

    Flow designer automatically updates the Inquiry resolution provider flow as Invoice case - AI agent: Inquiry resolution provider - SysID.
