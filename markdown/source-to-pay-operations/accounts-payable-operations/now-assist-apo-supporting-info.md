...
-   Purchase order line mapping enables the AP fulfillers to review the Now Assist driven mapping results.
-   Case summarization for AP fulfillers involves invoice case summarization and inquiry case summarization.
-   Invoice data extraction for DocIntel auto-extracts the invoice details from email and processes the invoice.
...
Record summarization involves invoice case summarization and inquiry case summarization.
