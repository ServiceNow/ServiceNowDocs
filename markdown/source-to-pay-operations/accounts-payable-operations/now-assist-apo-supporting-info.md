...
The Now Assist for APO application is supported starting with Xanadu.
...
|Interface|Skill|
|---------|-----|
|Source-to-Pay Workspace|Case summarization for AP fulfillers involves invoice case summarization and inquiry case summarization.|
|Core UI|Record summarization involves invoice case summarization and inquiry case summarization.|
