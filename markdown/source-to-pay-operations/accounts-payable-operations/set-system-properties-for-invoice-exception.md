...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/accounts-payable-operations/set-system-properties-for-invoice-exception.html
release: zurich
...
2.  Search for `sn_ap_apm.exception.engine.max_parallel_thread_count` and open the system property.\[Omitted image "apo-system-properties.png"\] Alt text: System properties of APO
...
3.  In the **Value** field, you can enter the value as 6, or 8.
...
The system properties are set for invoice exception.
