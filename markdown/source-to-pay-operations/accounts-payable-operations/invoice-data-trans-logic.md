...
For more information on currency conversion, see [Currency administration](https://www.servicenow.com/docs/access?context=currency&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
