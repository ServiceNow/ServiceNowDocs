...
-   **![](../../../reuse/icons/dcx-icons/dcx-icon-docs.svg) Release Notes**
    ...
    Learn more about what's new and changed. See the [Accounts Payable Operations release notes](https://www.servicenow.com/docs/access?context=accounts-payable-operations-rn&version=yokohama&pubname=yokohama-release-notes&ft:locale=en-US).
