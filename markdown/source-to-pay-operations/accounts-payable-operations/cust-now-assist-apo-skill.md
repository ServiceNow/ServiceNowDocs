...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/accounts-payable-operations/cust-now-assist-apo-skill.html
release: xanadu
...
From the Now Assist Admin console, you can select the input table, related records, and fields for each input template of the Case Summarization skill and then configure the prompt headers to be included in the general summary.
