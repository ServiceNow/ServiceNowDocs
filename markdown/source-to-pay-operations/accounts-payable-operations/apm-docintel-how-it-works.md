...
![How Accounts Payable Operations works with Document Intelligence](../image/acct-pay-di-works.png)
...
For more information on Document Intelligence, see [Document Intelligence](https://www.servicenow.com/docs/access?context=document-intelligence-landing&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
