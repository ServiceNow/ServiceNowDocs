...
This exception occurs when one or more lines of an invoice are missing the following information: -   Ledger account
-   Tax code
-   Cost center
...
This exception occurs when the cost allocated on invoice lines is not equal to the sub total of the invoice lines amount.

</td><td>

To resolve this invoice exception, do the following:1.  Log in to the application with Accounts Payable Specialist \(sn\_ap\_apm.accounts\_payable\_specialist\) role.
2.  Make necessary corrections to invoice line amount such that the line amount is equal to the sub total of the invoice line amount.
