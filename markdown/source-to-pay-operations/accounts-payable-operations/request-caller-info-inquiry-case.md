...
5.  Select the down arrow icon \(![Down arrow icon](../image/down-arrow-icon.png)\) and then select **Wait for requester**.

    ![Request additional information](../image/apo-request-add-info.png)The Wait for requester dialog box is displayed.
