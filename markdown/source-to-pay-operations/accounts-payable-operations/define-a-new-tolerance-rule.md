...
1.  Navigate to **All** &gt; **Accounts Payable Operations** &gt; **All** &gt; **Tolerance rules**.
    ...
    ![image.apo-tolerance-rules-nav]

2.  On the **Invoice Tolerance rule** list, select **New**.

3.  On the form, fill in the fields.

<table id="choicetable_zfx_wfs_xyb"><thead><tr><th align="left" id="d195860e119">

Field

</th><th align="left" id="d195860e122">

Description

</th></tr></thead><tbody><tr><td id="d195860e128">
