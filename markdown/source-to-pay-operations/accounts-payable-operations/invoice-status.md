...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/accounts-payable-operations/invoice-status.html
release: xanadu
...
After the invoice is submitted for approval \(pending approval\), Accounts Payable Specialist can recall the approval to edit the invoice if needed.
...
</table>**Parent Topic:**[Create New Invoice case form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/create-new-ap-case-form.md)
