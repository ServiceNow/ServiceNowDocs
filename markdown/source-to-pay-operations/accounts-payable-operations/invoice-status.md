...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/accounts-payable-operations/invoice-status.html
release: yokohama
...
Any invoice lines that is matched using GenAI will be set to new status and will be stopped for Accounts Payable specialist review. After the Accounts Payable specialist reviews the recommendation, the status of the invoice changes accordingly.
...
An invoice consisting of multiple invoice lines and any invoice line is in mapping error status, then the invoice status remains in Mapping error.
...
If instead of approving the GenAI recommendation, Accounts Payable specialist wants to overwrite it \(or if no recommendation was given and Accounts Payable specialist manually adds POLI\), then the invoice is moved to Mapping completed status.
...
</table>**Parent Topic:**[Create New Invoice case form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/source-to-pay-operations/accounts-payable-operations/create-new-ap-case-form.md)
