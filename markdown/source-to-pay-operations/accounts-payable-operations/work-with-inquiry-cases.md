...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/accounts-payable-operations/work-with-inquiry-cases.html
release: xanadu
...
-   **[Work on an invoice inquiry case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/work-inquiry-case.md)**  
Work on an invoice inquiry case to resolve an issue raised by the suppliers or employees.
-   **[Create an invoice inquiry case manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/create-inquiry-case.md)**  
Create invoice inquiry cases to address and respond to questions related to invoices and payment.
-   **[Create an invoice task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/create-apm-task.md)**  
Create an invoice task and assign it to a user or group to resolve an invoice inquiry case.
-   **[Request additional information from the requester for an invoice inquiry case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/request-caller-info-inquiry-case.md)**  
Request additional information from the requester to continue working on the case.
-   **[Submit an invoice inquiry case for an internal review](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/submit-inquiry-case-internal-review.md)**  
Submit an invoice inquiry case for an internal review by creating a review task and assigning it to the reviewers.
-   **[Close an invoice inquiry case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/close-inquiry-case.md)**  
Close an invoice inquiry case when all the activities and tasks for resolving the case are completed.

**Parent Topic:**[Using Invoice Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/use-invoice-case-mgmt.md)
