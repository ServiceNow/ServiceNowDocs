...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/accounts-payable-operations/invoice-processing-case-tabs.html
release: xanadu
...
Exception engine evaluates the invoice and then raises exceptions if necessary.
