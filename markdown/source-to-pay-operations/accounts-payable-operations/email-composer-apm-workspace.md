...
You can use this feature to compose and send emails directly from an invoice case. To open the email client, select **Compose Email** from the more actions icon \(a![more actions](../../supplier-lifecycle-operations/image/more-actions-icon.png)\) from an invoice case. A draft email appears with pre-populated data in the **To** and **Subject** fields.
