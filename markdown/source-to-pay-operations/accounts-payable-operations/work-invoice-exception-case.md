...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/source-to-pay-operations/accounts-payable-operations/work-invoice-exception-case.html
release: xanadu
...
4.  Select the link to the invoice exception under the Number column to open the exception and view its details.
    ...
    For more information, see [Create an exception task for an invoice exception](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/create-exception-task.md).
...
-   **[Create an exception task for an invoice exception](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/create-exception-task.md)**  
Create an exception task to assign it to a user or an assignment group to resolve the invoice exception.
-   **[Mark an exception task as complete from Employee Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/complete-exception-task-ec.md)**  
...
-   **[Edit a purchase for an Insufficient Funds invoice exception](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/edit-purchase-insufficient-funds.md)**  
...
-   **[Confirm receipt of your order from Employee Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/confirm-receipt-task.md)**  
Confirm the receipt of the items that you've ordered so that the payment is made to the supplier.
-   **[Bypass an invoice exception](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/source-to-pay-operations/accounts-payable-operations/bypass-invoice-exception.md)**  
