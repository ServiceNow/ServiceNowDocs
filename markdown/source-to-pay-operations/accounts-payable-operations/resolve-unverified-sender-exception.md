...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/accounts-payable-operations/resolve-unverified-sender-exception.html
release: yokohama
...
4.  Select one of the following actions to resolve the exception:
    ...
    **Note:**
    ...
    To reject the invoice, select **Reject invoice**. A rejection dialog appears. Continue to the next step.\[Omitted image "image.unverified-sender"\] Alt text: Review an unverified sender source exception in APO
