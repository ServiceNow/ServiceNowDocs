...
**Parent Topic:**[Using Now Assist for Accounts Payable Operations \(APO\)](using-now-assist-apo.md)

**Related topics**  


[Summarize a record by using Now Assist for Accounts Payable Operations \(APO\)](../task/now-assist-summarize-apo.md)

[Use Invoice inquiry solution generator skill](../task/use-invoice-inquiry-solution-generator-skill.md)

[Use purchase order line mapping](../task/use-purchase-order-line-mapping.md)

[Analyze sentiments in invoice cases](../task/analyze-sentiments-in-invoice-case.md)

[Generate email response for invoice case](../task/generate-email-invoice-case-apo.md)

[Generate email response for invoice task](../task/generate-email-invoice-task-apo.md)
