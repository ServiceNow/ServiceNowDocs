...
For more information on the AP invoice API, see [AP Invoice API Developer Guide](https://www.servicenow.com/docs/access?context=apInvoice-dev-guide&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
...
[Integrate APO with other applications](integrate-apo.md)
