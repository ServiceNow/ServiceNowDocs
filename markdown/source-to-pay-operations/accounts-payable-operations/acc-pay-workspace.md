...
breadcrumb: [Exploring Accounts Payable Operations, Accounts Payable Operations, Finance and Supply Chain]
---
...
The Source-to-Pay Workspace supports global search, which enables you to search for information using keywords. The search results include all the items that the keyword appears in, for example, cases, tasks, short description, content, or attached files. For more information, see [Global search in Workspace](https://www.servicenow.com/docs/access?context=search-workspace&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
...
**Parent Topic:**[Exploring Accounts Payable Operations](explore-acc-pay-mgmt.md)
