...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/source-to-pay-operations/accounts-payable-operations/copy-invoice-email-di-flow.html
release: zurich
...
When activated, \[Omitted image "more-actions-icon.png"\] Alt text: more actions this flow automatically creates an invoice processing case for an inbound email.
