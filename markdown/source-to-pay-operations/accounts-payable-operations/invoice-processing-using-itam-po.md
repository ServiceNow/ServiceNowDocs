...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/accounts-payable-operations/invoice-processing-using-itam-po.html
release: yokohama
...
breadcrumb: [IT Asset Management purchase order invoice processing, Integrating APO with other applications, Accounts Payable Operations, Finance and Supply Chain]
---
...
2.  Create a purchase order in ITAM.
    ...
    For more information on creating purchase order in ITAM, see [Create a purchase order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-asset-management/procurement/t_CreateAPurchaseOrder.md).
