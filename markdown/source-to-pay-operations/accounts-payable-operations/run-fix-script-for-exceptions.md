...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/source-to-pay-operations/accounts-payable-operations/run-fix-script-for-exceptions.html
release: yokohama
...
2.  Search for script "APM - Recalculate In-Process Invoice Amounts and Quantity".
    ...
    The below image shows the Fix script.\[Omitted image "fix-script-exception.png"\] Alt text: Fix script for exceptions
