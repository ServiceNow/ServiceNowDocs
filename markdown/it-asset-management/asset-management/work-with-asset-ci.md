...
-   **[Create assets](../../asset-management/task/t_CreatingAssets.md)**  
...
-   **[Retire assets](../../asset-management/task/t_RetiringAssets.md)**  
You can retire an asset at any time.
-   **[Delete assets](../../asset-management/task/t_DeletingAssets.md)**  
You can delete an asset at any time.
-   **[Map asset and CI fields](../../asset-management/task/t_CreateAssetandCIFieldsMapping.md)**  
...
-   **[Map asset state and CI install status](../../asset-management/task/t_CreateAssetandCIInstallStatusMapping.md)**  
...
-   **[Map asset state and CI hardware status](../../asset-management/task/t_CreateAssetandCIHardwareStatusMapping.md)**  
