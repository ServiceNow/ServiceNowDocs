...
**Note:** After moving to Asset Management Workspace, you can still use the Asset Management classic. For more information, see [Asset Management](https://www.servicenow.com/docs/access?context=c_AssetManagement&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
