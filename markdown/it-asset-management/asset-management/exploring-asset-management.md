...
**Note:** The Asset Workspace is installed by default only on the zBoot ServiceNow instances and not on the ServiceNow instances upgraded to the latest version. When the Hardware Asset Management application is activated, the Hardware Asset Workspace replaces the Asset Workspace.
...
**Note:** After moving to Asset Management Workspace, you can still use the Asset Management classic. For more information, see [Asset Management](https://www.servicenow.com/docs/access?context=c_AssetManagement&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).

**Related topics**  


[Customize tabs in Asset Workspace](../../hardware-asset-management/reuse/customize-tabs-asset-workspace.md)
