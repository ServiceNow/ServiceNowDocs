...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/integrate-with-slack.html
release: yokohama
...
Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-slack.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d227019e901">

Interface

</th><th align="left" id="d227019e904">

Action

</th></tr></thead><tbody><tr><td id="d227019e910">
...
Type of integration profile. This field is automatically set to `Slack Enterprise Subscription`.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-slack.md) table.
...
8.  Select **Configure and Get OAuth Token**.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-slack.md) table.
...
13. Return to your ServiceNow instance to associate your Slack workspace connections with the instance.
    ...
    3.  On the Slack Workspace Tokens form, fill in the fields.
        ...
        |Field|Description|
        |-----|-----------|
        |Connection Alias|Name of your Slack workspace connection. Enter the same connection name that you entered in [step g](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-slack.md).|
        |Workspace Name|The name of the workspace to which your Slack application belongs.|
        |Slack App|Name of your Slack workspace application. Enter the same application name that you entered in [Create a Slack workspace application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-slack.md).|
