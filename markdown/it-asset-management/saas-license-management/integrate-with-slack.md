...
Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-slack.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d306279e893">

Interface

</th><th align="left" id="d306279e896">

Action

</th></tr></thead><tbody><tr><td id="d306279e902">
...
Type of integration profile. This field is automatically set to `Slack Enterprise Subscription`.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-slack.md) table.
...
8.  Select **Configure and Get OAuth Token**.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-slack.md) table.

9.  On the Authorize App dialog box, verify if the Enterprise Grid workspace \(Enterprise Organization\) is available in the top corner drop-down list.

10. If the Enterprise Grid workspace is available, select the **Enterprise Grid workspace**.

    This action confirms that the token is fetched correctly, allowing the connection to validate successfully. For more information, refer to the knowledge base article [KB2536373](https://support.servicenow.com/kb?sys_kb_id=1f87321d93507290d9743f986cba10c1&id=kb_article_view).

    A dialog box requests access at the Organization Level after you select the **Enterprise Grid workspace** \(Enterprise Organization\).
...
13. Return to your ServiceNow instance to associate your Slack workspace connections with the instance.
    ...
    3.  On the Slack Workspace Tokens form, fill in the fields.
        ...
        |Field|Description|
        |-----|-----------|
        |Connection Alias|Name of your Slack workspace connection. Enter the same connection name that you entered in [step g](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-slack.md).|
        |Workspace Name|The name of the workspace to which your Slack application belongs.|
        |Slack App|Name of your Slack workspace application. Enter the same application name that you entered in [Create a Slack workspace application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-slack.md).|
