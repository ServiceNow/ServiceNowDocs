...
**Previous topic:**[Create an action to remove a user](create-data-stream-remove-user.md)

**Next topic:**[Create a subflow to get license consumption](create-subflow-get-license-consumption.md)
