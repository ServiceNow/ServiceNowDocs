...
1.  On the Add New App page of your PagerDuty account, select **Scoped OAuth** or **Classic User OAuth** in the Authorization section.
    ...
    For more information about the permission scopes, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-pagerduty.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d127795e670">

Interface

</th><th align="left" id="d127795e673">

Action

</th></tr></thead><tbody><tr><td id="d127795e679">
...
Type of integration profile. This field is automatically set to `PagerDuty Subscription`.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-pagerduty.md) table.
...
8.  Select **Create and Get OAuth Token**.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-pagerduty.md) table.
