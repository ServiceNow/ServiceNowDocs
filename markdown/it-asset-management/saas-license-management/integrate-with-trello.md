...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/saas-license-management/integrate-with-trello.html
release: zurich
...
Trello Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/saas-license-management/integrate-with-trello.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d97883e380">

Interface

</th><th align="left" id="d97883e383">

Action

</th></tr></thead><tbody><tr><td id="d97883e389">
...
This field is automatically set to **Trello Enterprise Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/saas-license-management/integrate-with-trello.md) table.
