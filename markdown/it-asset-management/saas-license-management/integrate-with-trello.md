...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/integrate-with-trello.html
release: yokohama
...
Trello Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-trello.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d95321e383">

Interface

</th><th align="left" id="d95321e386">

Action

</th></tr></thead><tbody><tr><td id="d95321e392">
...
This field is automatically set to **Trello Enterprise Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-trello.md) table.
