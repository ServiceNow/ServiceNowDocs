...
Trello Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-trello.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d69969e380">

Interface

</th><th align="left" id="d69969e383">

Action

</th></tr></thead><tbody><tr><td id="d69969e389">
...
This field is automatically set to **Trello Enterprise Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-trello.md) table.
