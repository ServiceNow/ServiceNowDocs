...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/integrate-with-salesforce-crm.html
release: yokohama
...
The **Client Credentials** grant type is supported in Software Asset Management - SaaS License Management \(sn\_sam\_saas\_int\) 15.1.0, Salesforce CRM application 1.1.9, and Salesforce CRM Spoke 2.4.0 version onwards.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d129137e1122">

Interface

</th><th align="left" id="d129137e1125">

Action

</th></tr></thead><tbody><tr><td id="d129137e1131">
...
Type of integration profile. This value is automatically set to **Salesforce CRM Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-salesforce-crm.md) table.
...
5.  Open the connection &amp; credential aliases record by selecting the preview icon \(\[Omitted image "preview-icon.png"\] Alt text: Preview icon.\) next to the **Connection &amp; Credential** field to configure the child alias.
...
URL of the OAuth provider that users are redirected to after authentication. This is generally the URL of the ServiceNow instance that you specified in [Register a Salesforce application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-salesforce-crm.md).

</td></tr></tbody>
</table>9.  Select **Create and Get OAuth Token**.

    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-salesforce-crm.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d129137e2000">

Interface

</th><th align="left" id="d129137e2003">

Action

</th></tr></thead><tbody><tr><td id="d129137e2009">
...
5.  Select the preview icon \(\[Omitted image "preview-icon.png"\] Alt text: Preview icon.\) next to the **Connection &amp; Credential** field to open the connection &amp; credential aliases record.
