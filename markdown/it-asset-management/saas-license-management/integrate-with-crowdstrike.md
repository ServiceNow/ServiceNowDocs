...
The CrowdStrike Integration Hub spoke must be active. For more information, see [CrowdStrike spoke](https://www.servicenow.com/docs/access?context=crowdstrike-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d102207e457">

Interface

</th><th align="left" id="d102207e460">

Action

</th></tr></thead><tbody><tr><td id="d102207e466">
