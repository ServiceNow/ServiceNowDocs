...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/reclaim-surveymonkey-subscription.html
release: yokohama
...
2.  Remove the associated users from your SurveyMonkey team.
    ...
    Based on the list of removal candidates that you identified in [step 1](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/reclaim-surveymonkey-subscription.md), you can reclaim user subscriptions by reassigning or deleting the associated users from your SurveyMonkey team.
