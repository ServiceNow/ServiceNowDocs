...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/saas-license-management/integrate-with-workplace.html
release: xanadu
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d114127e236">

Interface

</th><th align="left" id="d114127e239">

Action

</th></tr></thead><tbody><tr><td id="d114127e245">
...
6.  Select the preview icon \(\[Omitted image "preview-icon.png"\] Alt text: Preview icon.\) next to the **Connection &amp; Credential** field and select **Open Record** in the record preview to open the connection &amp; credential aliases record.
