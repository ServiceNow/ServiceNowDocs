...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/integrate-with-workplace.html
release: yokohama
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d165703e262">

Interface

</th><th align="left" id="d165703e265">

Action

</th></tr></thead><tbody><tr><td id="d165703e271">
...
Type of integration profile. This field is automatically set to Workplace from Facebook Subscription.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-workplace.md) table.
...
5.  Select the preview icon \(\[Omitted image "preview-icon.png"\] Alt text: Preview icon.\) next to the **Connection &amp; Credential** field and select **Open Record** in the record preview to open the connection &amp; credential aliases record.
