...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d110747e259">

Interface

</th><th align="left" id="d110747e262">

Action

</th></tr></thead><tbody><tr><td id="d110747e268">
...
Type of integration profile. This field is automatically set to Workplace from Facebook Subscription.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-workplace.md) table.
