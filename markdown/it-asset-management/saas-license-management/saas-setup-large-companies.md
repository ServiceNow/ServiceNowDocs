...
**Note:** For more information about how to use the **com.snc.pa.dc.max\_row\_count\_indicator\_source** property, see [Data collector properties](https://www.servicenow.com/docs/access?context=pa-properties&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
