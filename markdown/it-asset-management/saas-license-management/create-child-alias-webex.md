...
1.  Create a Cisco Webex integration profile.
    ...
    For more information about creating an integration profile, see [Integrating with Cisco Webex](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-webex-apps.md).
