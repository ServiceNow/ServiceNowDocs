...
SurveyMonkey Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-surveymonkey.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d92764e476">

Interface

</th><th align="left" id="d92764e479">

Action

</th></tr></thead><tbody><tr><td id="d92764e485">
...
Type of integration profile. This field is automatically set to **SurveyMonkey Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-surveymonkey.md) table.
...
URL of the OAuth provider that users are redirected to after authentication. This field populates automatically based on the OAuth redirect URL that you specified in [Create a private SurveyMonkey application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-surveymonkey.md).

</td></tr></tbody>
</table>8.  Select **Create and Get OAuth Token**.

    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-surveymonkey.md) table.
