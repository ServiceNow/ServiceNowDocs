...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/integrate-with-ariba.html
release: yokohama
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d85801e800">

Interface

</th><th align="left" id="d85801e803">

Action

</th></tr></thead><tbody><tr><td id="d85801e809">
...
5.  After the integration profile is saved, upload the attachments by selecting the **Attach** icon \(\[Omitted image "attachments-icon.png"\] Alt text: Attach icon\).
