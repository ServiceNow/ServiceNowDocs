...
<table id="choicetable_mtv_n33_rcc"><thead><tr><th align="left" id="d135592e91">

Interface

</th><th align="left" id="d135592e94">

Action

</th></tr></thead><tbody><tr><td id="d135592e100">
...
4.  Open the Connection &amp; Credential alias record by selecting the preview icon \(![Preview icon](../../../common/image/Form_ReferenceLookupIcon.png)\) and then selecting **Open Record**.
...
**Previous topic:**[Create a custom spoke](create-saas-spoke.md)

**Next topic:**[Create a data stream action to get users](create-data-stream-action-slc.md)
