...
Jira Role required: Refer the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-jira-oauth.md) table.
...
Jira Subscription. This field is automatically populated.
    ...
    **Note:** For more information, see the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-jira-oauth.md) table.
...
Base URL for the Jira API. This field is automatically set to `https://api.atlassian.com/ex/jira/<Cloud-ID>`.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-jira-oauth.md) table.
