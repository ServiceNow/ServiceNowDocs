...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/integrate-with-roadmunk.html
release: yokohama
...
**Important:** You must select the **Roadmunk Spoke** check box for this integration while installing optional features on the  page. For more information about choosing the required SaaS applications, see [Request SaaS License Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/request-saas-license-management.md).
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d44786e377">

Interface

</th><th align="left" id="d44786e380">

Action

</th></tr></thead><tbody><tr><td id="d44786e386">
...
Type of integration profile. This field is automatically set to **Roadmunk Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-roadmunk.md) table.
...
5.  To avoid your integration profile from including inactive users in your list of Roadmunk subscriptions, enable the Roadmunk Download Subscriptions subflow to download only the active users in your Roadmunk account.
    ...
    8.  In the Attachments dialog box, select **Choose file** to locate and select the Roadmunk User Report that you downloaded in [step e](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-roadmunk.md).
