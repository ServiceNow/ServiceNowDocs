...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-asset-management/saas-license-management/integrate-with-roadmunk.html
release: australia
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d44860e377">

Interface

</th><th align="left" id="d44860e380">

Action

</th></tr></thead><tbody><tr><td id="d44860e386">
...
Type of integration profile. This field is automatically set to **Roadmunk Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-roadmunk.md) table.
...
5.  To avoid your integration profile from including inactive users in your list of Roadmunk subscriptions, enable the Roadmunk Download Subscriptions subflow to download only the active users in your Roadmunk account.
    ...
    8.  In the Attachments dialog box, select **Choose file** to locate and select the Roadmunk User Report that you downloaded in [step e](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-roadmunk.md).
