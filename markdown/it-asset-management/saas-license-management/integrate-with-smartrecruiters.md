...
API key for your SmartRecruiters applications. Enter the same API key that you generated in [Generate a SmartRecruiters API key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-smartrecruiters.md).
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d99494e562">

Interface

</th><th align="left" id="d99494e565">

Action

</th></tr></thead><tbody><tr><td id="d99494e571">
...
4.  Select **Continue**.
    ...
    |Connection &amp; Credential|Connection and credential alias for the SmartRecruiters spoke. This field is automatically set to **sn\_smartrec\_spoke.SmartRecruiters**.|
