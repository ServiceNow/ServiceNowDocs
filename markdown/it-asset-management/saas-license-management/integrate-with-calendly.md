...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/saas-license-management/integrate-with-calendly.html
release: xanadu
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d74451e449">

Interface

</th><th align="left" id="d74451e452">

Action

</th></tr></thead><tbody><tr><td id="d74451e458">
...
URL of the OAuth provider that users are redirected to after authentication. This field populates automatically based on your instance name.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-calendly.md) table.
