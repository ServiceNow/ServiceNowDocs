...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d220936e525">

Interface

</th><th align="left" id="d220936e528">

Action

</th></tr></thead><tbody><tr><td id="d220936e534">
...
Type of integration profile.This field is automatically set to **Calendly Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-calendly.md) table.
...
URL of the OAuth provider that users are redirected to after authentication. This field populates automatically based on your instance name.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-calendly.md) table.
