...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/playbook-salesforce-crm.html
release: yokohama
...
**Note:** The **Client Credentials** grant type is supported in Software Asset Management - SaaS License Management \(sn\_sam\_saas\_int\) 15.1.0, Salesforce CRM application 1.1.9, and Salesforce CRM Spoke 2.4.0 version onwards.
...
4.  Register the Salesforce application through the Salesforce admin portal.
    ...
    For more information, see [Register a Salesforce application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-salesforce-crm.md).
...
**Parent Topic:**[Playbook for SaaS integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/playbook-saas-integrations.md)
