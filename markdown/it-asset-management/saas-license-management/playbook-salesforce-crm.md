...
6.  Create a connection and credential in the ServiceNow Classic interface.
    ...
    2.  Open the connection &amp; credential aliases record by selecting the preview icon \(![Preview icon.](../image/preview-icon.png)\) next to the **Connection &amp; Credential** field.
...
8.  Review the required fields before publishing the integration profile.
    ...
    3.  In the Connection &amp; Credential field, select the preview icon \(![Preview icon.](../image/preview-icon.png)\) to locate and select the child alias that you created in [Step 7](playbook-salesforce-crm.md#step-7).
