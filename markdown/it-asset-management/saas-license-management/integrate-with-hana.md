...
The SAP S/4HANA Public Cloud Integration Hub spoke must be active. For more information, see [SAP S4 HANA Public Cloud Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/sap-s4-hana-cloud-spk.md).
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d45248e658">

Interface

</th><th align="left" id="d45248e661">

Action

</th></tr></thead><tbody><tr><td id="d45248e667">
...
Type of integration profile. This field is automatically set to **SAP S4Hana Cloud Subscription**.
    ...
    For more information about the required roles and scopes, see [Minimal user permissions table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-hana.md).
