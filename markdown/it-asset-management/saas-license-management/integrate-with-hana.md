...
The SAP S/4HANA Public Cloud Integration Hub spoke must be active. For more information, see [SAP S4 HANA Public Cloud Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/sap-s4-hana-cloud-spk.md).
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d51448e658">

Interface

</th><th align="left" id="d51448e661">

Action

</th></tr></thead><tbody><tr><td id="d51448e667">
