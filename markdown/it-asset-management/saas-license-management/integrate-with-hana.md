...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/integrate-with-hana.html
release: yokohama
...
The SAP S/4HANA Public Cloud Integration Hub spoke must be active. For more information, see [SAP S4 HANA Public Cloud Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/integration-hub/sap-s4-hana-cloud-spk.md).
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d50419e658">

Interface

</th><th align="left" id="d50419e661">

Action

</th></tr></thead><tbody><tr><td id="d50419e667">
...
Type of integration profile. This field is automatically set to **SAP S4Hana Cloud Subscription**.
    ...
    For more information about the required roles and scopes, see [Minimal user permissions table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-hana.md).
...
6.  Open the connection &amp; credential aliases record by selecting the preview icon \(\[Omitted image "Form\_ReferenceLookupIcon.png"\] Alt text: Preview icon\) beside the **Connection &amp; Credential** field.
