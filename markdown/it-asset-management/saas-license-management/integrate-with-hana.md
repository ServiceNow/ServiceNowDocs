...
The SAP S/4HANA Public Cloud Integration Hub spoke must be active. For more information, see [SAP S4 HANA Public Cloud Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/sap-s4-hana-cloud-spk.md).
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d53308e658">

Interface

</th><th align="left" id="d53308e661">

Action

</th></tr></thead><tbody><tr><td id="d53308e667">
