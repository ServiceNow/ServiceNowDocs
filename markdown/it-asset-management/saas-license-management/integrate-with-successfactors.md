...
2.  Upload the JKS certificate to your ServiceNow instance.
    ...
    For instructions to upload the JKS certificate, see [Upload a certificate to an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/t_UploadACertificateToAnInstance.md).\[Omitted image "saml-oauth-sf.png"\] Alt text: Uploading certificate to an instance
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d59751e2331">

Interface

</th><th align="left" id="d59751e2334">

Action

</th></tr></thead><tbody><tr><td id="d59751e2340">
