...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/integrate-with-aha.html
release: yokohama
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d129024e385">

Interface

</th><th align="left" id="d129024e388">

Action

</th></tr></thead><tbody><tr><td id="d129024e394">
...
Type of integration profile. This field is automatically set to **Aha! Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-aha.md) table.
...
8.  Select **Create and Get OAuth Token** and then select **Authorize**.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-aha.md) table.
