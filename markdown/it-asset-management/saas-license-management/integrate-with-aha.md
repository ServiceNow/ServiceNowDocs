...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/saas-license-management/integrate-with-aha.html
release: xanadu
...
6.  Select **Configure and get OAuth Token** and then select **Authorize**.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-aha.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d113984e583">

Interface

</th><th align="left" id="d113984e586">

Action

</th></tr></thead><tbody><tr><td id="d113984e592">
...
Aha! Download SubscriptionYou can view events performed by individual users up to one year prior to the current date. For more information, see [Review a software reclamation rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/add-reclamation-rule-sub.md).
