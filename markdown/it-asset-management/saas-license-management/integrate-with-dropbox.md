...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/saas-license-management/integrate-with-dropbox.html
release: xanadu
...
Dropbox Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-dropbox.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d114046e472">

Interface

</th><th align="left" id="d114046e475">

Action

</th></tr></thead><tbody><tr><td id="d114046e481">
...
5.  On the integration profile, select **Get OAuth Token**.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-dropbox.md) table.

6.  Select **Allow** if you have already logged in to the Dropbox application.

7.  If you haven't logged in to the Dropbox application, log in with your admin credentials and then continue with the next steps.
