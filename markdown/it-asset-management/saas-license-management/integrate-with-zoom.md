...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/saas-license-management/integrate-with-zoom.html
release: xanadu
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d84100e482">

Interface

</th><th align="left" id="d84100e485">

Action

</th></tr></thead><tbody><tr><td id="d84100e491">
...
4.  Select **Continue**.
    ...
    |Client Id|Client ID for the OAuth application created in the SaaS admin account in [step 5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-zoom.md).|
    |Redirect url|This value is automatically populated.|
    |Client secret|Password related with the client ID created in the SaaS admin account in [step 5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-zoom.md).|
...
4.  On the integration profile, select the **Get OAuth Token** related link and follow the steps to get an OAuth token.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-zoom.md) table.
