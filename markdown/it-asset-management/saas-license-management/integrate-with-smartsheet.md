...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-asset-management/saas-license-management/integrate-with-smartsheet.html
release: australia
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d136650e383">

Interface

</th><th align="left" id="d136650e386">

Action

</th></tr></thead><tbody><tr><td id="d136650e392">
...
Type of integration profile. This field is automatically set to **Smartsheet Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-smartsheet.md) table.
