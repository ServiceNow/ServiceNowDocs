...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/integrate-with-smartsheet.html
release: yokohama
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d129228e387">

Interface

</th><th align="left" id="d129228e390">

Action

</th></tr></thead><tbody><tr><td id="d129228e396">
...
Type of integration profile. This field is automatically set to **Smartsheet Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-smartsheet.md) table.
