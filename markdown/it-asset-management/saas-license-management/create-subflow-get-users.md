...
**Previous topic:**[Create a data stream action to get users](create-data-stream-action-slc.md)

**Next topic:**[Create a data stream action to get user activity](create-data-stream-get-activity.md)
