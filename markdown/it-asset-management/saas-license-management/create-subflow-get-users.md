...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/saas-license-management/create-subflow-get-users.html
release: xanadu
...
This subflow requires a data stream action to get users. For more information, see [Create a data stream action to get users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/create-data-stream-action-slc.md).
...
If an identifier doesn't exist, configure an identifier. For more information, see [Configure an identifier](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/create-subflow-get-users.md).
...
**Previous topic:**[Create a data stream action to get users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/create-data-stream-action-slc.md)

**Next topic:**[Create a data stream action to get user activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/create-data-stream-get-activity.md)
...
Current software product name. Custom product that you created in [step 1](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/create-subflow-get-users.md).
...
Custom discovery map that you created in [step 2](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/create-subflow-get-users.md).
...
Checkbox indicating the identifier is used or not.
