...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/saas-license-management/integrate-with-goto.html
release: xanadu
...
GoTo Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-goto.md) table.
...
6.  Select **Configure and Get OAuth Token**.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-goto.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d91555e967">

Interface

</th><th align="left" id="d91555e970">

Action

</th></tr></thead><tbody><tr><td id="d91555e976">
