...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/saas-license-management/create-child-alias-confluence.html
release: zurich
...
1.  Create a Confluence Cloud integration profile.
    ...
    For more information about creating an integration profile, see [Integrating with Confluence Cloud](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/saas-license-management/integrate-with-confluence-cloud.md).
