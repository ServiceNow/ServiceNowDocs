...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-asset-management/saas-license-management/integrate-with-workfront.html
release: australia
...
3.  On the page header of your Adobe Workfront instance, select the Main Menu icon \[Omitted image "main-menu-icon.png"\] and then select **Setup**.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d148349e377">

Interface

</th><th align="left" id="d148349e380">

Action

</th></tr></thead><tbody><tr><td id="d148349e386">
...
Type of integration profile. This field is automatically set to **Workfront Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/saas-license-management/integrate-with-workfront.md) table.
...
API key for your Workfront applications. Enter the same API key that you generated in [Generate a Workfront API key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/saas-license-management/integrate-with-workfront.md).
