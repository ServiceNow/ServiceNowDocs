...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/saas-license-management/integrate-with-rally.html
release: zurich
...
The Rally Integration Hub spoke must be active. For more information, see [Rally spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/rally-spoke.md).

Rally Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/saas-license-management/integrate-with-rally.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d131896e428">

Interface

</th><th align="left" id="d131896e431">

Action

</th></tr></thead><tbody><tr><td id="d131896e437">
...
Type of integration profile. This field is automatically set to Rally Subscription.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/saas-license-management/integrate-with-rally.md) table.
...
8.  Select **Create and Get OAuth Token**.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/saas-license-management/integrate-with-rally.md) table.
