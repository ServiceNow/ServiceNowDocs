...
Miro Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-miro-enterprise.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d117989e581">

Interface

</th><th align="left" id="d117989e584">

Action

</th></tr></thead><tbody><tr><td id="d117989e590">
...
Type of integration profile. This field is automatically set to **Miro Enterprise Subscription**.
    ...
    **Note:** For more information about the required roles and scopes, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-miro-enterprise.md) table.
