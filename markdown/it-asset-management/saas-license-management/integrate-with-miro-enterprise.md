...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/saas-license-management/integrate-with-miro-enterprise.html
release: zurich
...
Miro Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/saas-license-management/integrate-with-miro-enterprise.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d181466e581">

Interface

</th><th align="left" id="d181466e584">

Action

</th></tr></thead><tbody><tr><td id="d181466e590">
...
Type of integration profile. This field is automatically set to **Miro Enterprise Subscription**.
    ...
    **Note:** For more information about the required roles and scopes, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/saas-license-management/integrate-with-miro-enterprise.md) table.
