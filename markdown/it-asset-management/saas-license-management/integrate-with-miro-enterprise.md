...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/integrate-with-miro-enterprise.html
release: yokohama
...
Miro Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-miro-enterprise.md) table.
...
**Important:** You must select the **Miro Spoke** check box for this integration while installing optional features on the  page. For more information about choosing the required SaaS applications, see [Request SaaS License Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/request-saas-license-management.md).
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d129099e592">

Interface

</th><th align="left" id="d129099e595">

Action

</th></tr></thead><tbody><tr><td id="d129099e601">
...
Type of integration profile. This field is automatically set to **Miro Enterprise Subscription**.
    ...
    **Note:** For more information about the required roles and scopes, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/integrate-with-miro-enterprise.md) table.
