...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d268786e341">

Interface

</th><th align="left" id="d268786e344">

Action

</th></tr></thead><tbody><tr><td id="d268786e350">
...
Type of integration profile. This field is automatically set to Looker Subscription.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-looker.md) table.
