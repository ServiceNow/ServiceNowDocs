...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/saas-license-management/integrate-with-looker.html
release: xanadu
...
5.  Select **Create and Get OAuth Token**.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/saas-license-management/integrate-with-looker.md) table.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d114084e544">

Interface

</th><th align="left" id="d114084e547">

Action

</th></tr></thead><tbody><tr><td id="d114084e553">
