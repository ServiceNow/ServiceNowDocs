...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/saas-license-management/reclaim-roadmunk-subscription-workspace.html
release: yokohama
...
2.  Deactivate the associated users on your Roadmunk account.
    ...
    Based on the list of removal candidates that you identified in [step 1](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/saas-license-management/reclaim-roadmunk-subscription-workspace.md), you can reclaim user subscriptions by deactivating the associated users on your Roadmunk account.
