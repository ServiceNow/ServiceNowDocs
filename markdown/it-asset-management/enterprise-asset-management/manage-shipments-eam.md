...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/manage-shipments-eam.html
release: yokohama
...
\[Omitted image "itam-carrier-integration.png"\] Alt text: Shipping carrier integration overview.
...
-   **[Use Advanced Shipment Notification in Enterprise Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/asn-eam.md)**  
...
-   **[Create a shipment carrier record in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/create-shipment-carrier-record-eam.md)**  
Create a shipping carrier record in the Enterprise Asset workspace to associate the carrier with an integration profile.
-   **[Script include for third-party shipping carrier integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/script-include-shipping-carrier-integrations-eam.md)**  
...
-   **[Integrate with a third-party shipping carrier in the Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/integrate-shipping-carriers-eam.md)**  
...
-   **[View integration profiles for third-party shipping carriers in the Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/view-shipping-carrier-integration-profiles-eam.md)**  
...
-   **[Associate a third-party shipping carrier with an integration profile in the Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/associate-shipping-carrier-integration-profile-eam.md)**  
...
-   **[Remove a third-party shipping carrier from an integration profile in the Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/remove-shipping-carrier-integration-profile-eam.md)**  
Remove a third-party shipping carrier that you no longer want to associate with an integration profile.
-   **[Test the integration profile for a third-party shipping carrier in the Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/test-shipping-carrier-integration-profile-eam.md)**  
...
-   **[View and add enterprise asset shipments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/view-enterprise-asset-shipments.md)**  
