...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/view-knowledge-articles-mobile-agent.html
release: zurich
...
View helpful and relevant knowledge articles attached to work order tasks in the Mobile Agent application.
...
7.  View relevant knowledge articles.
    ...
    -   To view a knowledge article related to the work order task, tap the article link in the **Attached Knowledge** section.
    -   To view knowledge articles related to the parts associated with the work order task, tap the article link in the **Parts Knowledge** section.
