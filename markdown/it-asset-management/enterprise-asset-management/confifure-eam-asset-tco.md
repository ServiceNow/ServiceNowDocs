...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/confifure-eam-asset-tco.html
release: yokohama
...
-   **[Create a TCO report in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/create-eam-tco-report.md)**  
...
-   **[Create a TCO report source in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/create-tco-report-source-eam.md)**  
Create a TCO report source to add report sources to a TCO report.
-   **[Create a task rate card in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/create-eam-task-rate-card.md)**  
Create a task rate card to capture costs per task type in the Enterprise Asset Workspace.
-   **[Create expense lines for closed tasks in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/create-expenselines-closed-tasks-eam.md)**  
...
-   **[Create a labor rate card in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/create-eam-labor-rate-card.md)**  
