...
Provides the capability to manage work orders and related tasks. See [Field Service Management](https://www.servicenow.com/docs/access?context=fsm-application-landing-page&version=xanadu&pubname=xanadu-field-service-management&ft:locale=en-US) for more information on Field Service Management.
...
Provides the capability to manage regular preventative maintenance of assets. See [Planned Maintenance](https://www.servicenow.com/docs/access?context=c_SMPlanMaint&version=xanadu&pubname=xanadu-service-management-for-the-enterprise&ft:locale=en-US) for more information on Planned Maintenance.
