...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/create-eam-work-order-task.html
release: xanadu
...
Type of work that the assigned agent must perform on the associated enterprise asset. The options are **Break Fix**, **Install**, **Planned Maintenance**, and **Calibration**.
