...
5.  In the **Add assets** dialog box, enter the asset details.
    ...
    -   **RFID tag**
    -   **Additional info**
6.  For each asset that you want to onboard, select the Add Row icon \(![Add row icon.](../../hardware-asset-management/image/add-aisle-icon.png)\) and enter the asset details.
