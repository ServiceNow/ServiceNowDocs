...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/submit-enterprise-asset-move-order-service-catalog.html
release: xanadu
...
breadcrumb: [Submitting an enterprise asset move order, Managing enterprise asset move orders, Managing enterprise assets and models, Enterprise Asset Management, IT Asset Management]
---
...
**Parent Topic:**[Submitting an enterprise asset move order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/enterprise-asset-management/submitting-enterprise-asset-move-order.md)
