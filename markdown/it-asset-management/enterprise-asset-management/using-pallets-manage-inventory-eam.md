...
-   **Swap tasks from the IT Service Management Asset Management application**
    ...
    For more information on the Asset Management application, see [Asset Management](https://www.servicenow.com/docs/access?context=c_AssetManagement&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
