---
title: Record time worked on a repair task manually in the Enterprise Asset Workspace
description: Create an entry for the time worked on a repair task manually in the Enterprise Asset Workspace.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/record-time-worked-manually-eam-ws.html
release: zurich
...
10. In the **Record Time** dialog box, enter the details of the time worked.
    ...
    1.  Enter the time duration that you worked on the task in the **Days**, **Hours**, and **Minutes** fields.

    2.  Provide any additional information in the **Comments** field.
