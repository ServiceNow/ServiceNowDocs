...
Workflow**Note:** This field appears only if you select the Add icon \(![Add icon.](../../hardware-asset-management/image/add_content_icon.png)\) next to the **Name** field.
...
5.  Attach related knowledge base articles to the work order template.
    ...
    2.  On the Model Knowledge form, select the Lookup using list icon \(![Lookup using list icon.](../../software-asset-management2/image/search-icon.png)\) in the **Knowledge** field to search for and select the knowledge base article that you want to attach to the work order template.
