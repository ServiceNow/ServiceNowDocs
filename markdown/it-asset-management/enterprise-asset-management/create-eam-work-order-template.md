...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/create-eam-work-order-template.html
release: xanadu
...
Work order templates are added to the Field Service Catalog, which is part of the ServiceNow® Field Service Management application. You can access the Field Service Catalog by navigating to **All** &gt; **Field Service** &gt; **Catalog and Knowledge**. See Field Service Management for more information on the Field Service Management application.

**Note:** The Field Service Management application is automatically activated when you request and install the Enterprise Asset Management application from the ServiceNow Store. See [Install Enterprise Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/enterprise-asset-management/request-enterprise-asset-management.md) for more details.
...
Workflow**Note:** This field appears only if you select the Add icon \(\[Omitted image "add\_content\_icon.png"\] Alt text: Add icon.\) next to the **Name** field.
...
5.  Attach related knowledge base articles to the work order template.
    ...
    2.  On the Model Knowledge form, select the Lookup using list icon \(\[Omitted image "search-icon.png"\] Alt text: Lookup using list icon.\) in the **Knowledge** field to search for and select the knowledge base article that you want to attach to the work order template.
