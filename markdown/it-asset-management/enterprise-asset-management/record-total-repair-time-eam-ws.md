...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/record-total-repair-time-eam-ws.html
release: zurich
...
breadcrumb: [Record time worked on asset repair tasks in the Enterprise Asset Workspace, Manage repair of defective assets in your stockroom in the Enterprise Asset Workspace, Create and manage enterprise asset inventory, Manage enterprise asset inventory and contracts, Enterprise Asset Management, IT Asset Management]
---
...
You can record the time worked for Troubleshoot asset, Repair asset, and Evaluate asset tasks that are in the Open state.
...
10. After you have completed working on the task, on the **Details** form, select the task result.
    ...
    -   If you have completed a Troubleshoot asset task, then select any of the following results in the **Troubleshoot result** field:
        -   **Repairable**
        -   **Unrepairable**
        -   **Redeployable**
    -   If you have completed a Repair asset task, then select any of the following results in the **Repair result** field:
        -   **Repaired**
        -   **Unrepairable**
        -   **Redeployable**
    -   If you have completed an Evaluate asset task, then select any of the following results in the **Evaluation result** field:
        -   **Redeployable**
        -   **To be disposed**
...
**Parent Topic:**[Record time worked on asset repair tasks in the Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/enterprise-asset-management/record-repair-time-eam-ws.md)
