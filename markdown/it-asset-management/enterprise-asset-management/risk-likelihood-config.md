...
3.  From the navigation panel of the Admin center view, navigate to **Risk configuration** &gt; **Risk likelihood**.

4.  Select **New**.

5.  Enter a label in the Enterprise Risk Likelihood Configuration page.
