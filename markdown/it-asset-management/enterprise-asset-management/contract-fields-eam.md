...
Option that indicates if the lease contract has an associated contract rate card, which provides detailed cost information for the contract.See [Create a contract rate card](https://www.servicenow.com/docs/access?context=t_ContractRateCardsAndExpenseLines&version=australia&pubname=australia-it-service-management&ft:locale=en-US) for more information on contract rate cards.
