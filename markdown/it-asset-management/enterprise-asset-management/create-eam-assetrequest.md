...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/create-eam-assetrequest.html
release: xanadu
...
5.  Login with credentials for the role of sys \_admin role and add the **Enterprise Assets** catalog.
    ...
    The **Enterprise Assets** catalog is not on the Service Catalog page by default. To add this catalog, select the Add Content icon \[Omitted image "add\_content\_icon.png"\] Alt text: Add Content icon \) beside the search catalog bar and then select **Enterprise Assets**
...
17. Complete the Asset pick task using the Mobile Agent application.
    ...
    For details on completing this step, see [Manage enterprise asset pick tasks using the Mobile Agent application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/enterprise-asset-management/manage-asset-pick-task-eam-mobile-app.md).
