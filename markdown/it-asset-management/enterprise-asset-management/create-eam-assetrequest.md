...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/create-eam-assetrequest.html
release: yokohama
...
17. Complete the Asset pick task using the Mobile Agent application.
    ...
    For details on completing this step, see [Manage enterprise asset pick tasks using the Mobile Agent application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/manage-asset-pick-task-eam-mobile-app.md).
