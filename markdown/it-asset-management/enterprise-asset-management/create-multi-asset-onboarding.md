...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/create-multi-asset-onboarding.html
release: yokohama
...
8.  Review and then complete or skip the **Deployment** activity.
    ...
    The asset technicians complete the deploy tasks assigned to them. For more information, see [Complete and close the Pick Up task for an enterprise asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/complete-pickup-task-work-order.md) and [Complete and close a work order for an enterprise asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/complete-eam-work-order.md).
