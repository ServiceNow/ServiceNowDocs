...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/create-eam-incident.html
release: xanadu
...
breadcrumb: [Configuring Enterprise Asset Management by incident managers, Configuring Enterprise Asset Management, Enterprise Asset Management, IT Asset Management]
---
...
To create an Enterprise Asset Management incident record, you must install all applicable Incident Management plugins on your ServiceNow instance. See [Incident Management plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/incident-management/incident-mgmt-plugins.md) for the complete list of Incident Management plugins.

## About this task

This procedure describes how an ITIL agent must complete an incident form to document and track an Enterprise Asset Management incident. Refer to [Incident Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/incident-management/c_IncidentManagement.md) for more in-depth information on creating and managing incidents.

## Procedure

1.  [Create an incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/incident-management/create-an-incident.md).
...
4.  After the form reloads in the Enterprise Asset Management incident form view, specify the asset that is affected by this incident.
    ...
    1.  Select the Lookup using list icon \(\[Omitted image "search-icon.png"\] Alt text: Lookup using list icon.\) in the **Asset** field.
    ...
    3.  On the form header, select the Additional actions menu icon \(\[Omitted image "additional-actions-icon.png"\] Alt text: Additional actions menu icon.\) and then select **Save**.
...
5.  If you selected a multi-component asset in the previous step, specify the child assets that are affected by this incident.
    ...
    3.  Select the Add icon \(\[Omitted image "add-icon.png"\] Alt text: Add icon.\) to move the selected child asset to the Affected Assets List.
