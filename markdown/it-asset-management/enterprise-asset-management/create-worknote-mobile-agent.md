---
title: Create work notes about the work order tasks using the Mobile Agent application
description: Add notes with details about work order task to the task record using the Mobile Agent application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/create-worknote-mobile-agent.html
release: zurich
...
Add notes with details about work order task to the task record using the Mobile Agent application.
