...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/perform-put-away-mobile-agent-eam.html
release: xanadu
...
**Parent Topic:**[Manage enterprise asset put away using the ServiceNow Agent application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/enterprise-asset-management/manage-asset-put-away-eam-mobile-agent.md)
