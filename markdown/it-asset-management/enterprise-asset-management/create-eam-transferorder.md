...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/create-eam-transferorder.html
release: xanadu
...
-   **[Create transfer order lines in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/enterprise-asset-management/create-eam-transferorderline.md)**  
Create transfer order lines in Enterprise Asset Management to specify the items that comprise a transfer order.
-   **[Close transfer order line tasks in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/enterprise-asset-management/close-eamtransferorder-task.md)**  
