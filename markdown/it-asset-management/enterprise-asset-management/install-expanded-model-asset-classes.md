---
title: Install Expanded Model and Asset Classes
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-asset-management/enterprise-asset-management/install-expanded-model-asset-classes.html
release: australia
...
-   Review the [Expanded Model and Asset Classes](https://store.servicenow.com/store/app/523c6b6e1b246a50a85b16db234bcbfb) application listing in the ServiceNow Store for information on dependencies, licensing or subscription requirements, and release compatibility.
...
2.  Find the Expanded Model and Asset Classes application \(sn\_ent\) using the filter criteria and search bar.
