...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/create-dropoff-task-eam-mobile.html
release: yokohama
...
breadcrumb: [Manage Drop off tasks for enterprise assets using the Mobile Agent application, Managing enterprise assets and tasks using the Mobile Agent application, Enterprise Asset Management, IT Asset Management]
---
...
<table id="choicetable_p5z_d2w_tfc"><thead><tr><th align="left" id="d182736e157">

UI option

</th><th align="left" id="d182736e160">

Action

</th></tr></thead><tbody><tr><td id="d182736e166">
