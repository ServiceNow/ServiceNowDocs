...
3.  In the My group task section, tap the **Create Drop Off Task** ![](../image/create-drop-off-icon.png) icon.
...
<table id="choicetable_p5z_d2w_tfc"><thead><tr><th align="left" id="d192179e158">

UI option

</th><th align="left" id="d192179e161">

Action

</th></tr></thead><tbody><tr><td id="d192179e167">
