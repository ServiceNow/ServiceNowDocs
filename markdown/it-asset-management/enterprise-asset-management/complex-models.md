...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/complex-models.html
release: yokohama
...
-   User-assembled asset: assemble assets using assets present in the parent asset stockroom.
    -   Assemble the assets yourself by using the **Assemble** button in the asset record. For details, see [Select assets for user-assembled asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/assemble-assets-eam.md).
    ...
    -   Release all child and add-on assets from the parent asset. For details on releasing assets, see [Release assets from the parent asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/release-assets-eam.md).
...
**Note:** For more details on swapping assets, see [Swap assets for parent multi-component asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/swap-assets-eam.md).
