...
3.  In the navigation panel of the Admin center view, select **Normalization opt-in**.

4.  Select **Opt-In Agreement** to read the agreement and then select the check box, **Yes, I have read and accept the Opt-in Agreement**.
...
6.  To disable a KPI, select the toggle button next to the KPI and then select **Save**.

7.  To opt out, select **I would like to opt my company out of the Enterprise Asset Management Content Service Program** and then select **Opt-Out**.
