...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/add-calibration-attributes-enterprise-asset.html
release: xanadu
...
9.  If your enterprise asset also contains calibration attributes at the enterprise model level, enable this enterprise asset level attribute to override an existing enterprise model level attribute.
    ...
    2.  In the Identification section of the **Details** tab, select the Search for Record icon \(\[Omitted image "search-icon.png"\] Alt text: Search for Record icon.\) next to the **Override** field.
