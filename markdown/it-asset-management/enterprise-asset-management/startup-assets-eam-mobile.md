...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/startup-assets-eam-mobile.html
release: zurich
...
5.  Tap the work order task of the **Startup** work type that has the assets that you want to start up.
...
9.  In the **Select assets to start up** screen, select the assets that you want to start up.
