...
-   **[Create segments for linear assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/define-linear-segments.md)**  
...
-   **[Associate a discrete asset to a linear asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/associate-discreet-asset.md)**  
...
-   **[Find linear asset relationships](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/find-linear-asset-relships.md)**  
...
-   **[Update enterprise assets that have unknown enterprise models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/updated-enterprise-assets-unknown-enterprise-model.md)**  
...
-   **[Swap assets for parent multi-component asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/swap-assets-eam.md)**  
Swap child assets that are part of a multi-component asset. You can swap out only one child asset at a time.
-   **[Select assets for user-assembled asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/assemble-assets-eam.md)**  
Create a user-assembled asset by selecting assets from the parent asset's stockroom.
-   **[Release assets from the parent asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/release-assets-eam.md)**  
Release a child asset that is no longer required to be associated with its parent asset.
-   **[Create additional child assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/create-addon-asset.md)**  
Create additional child assets for the model even if the assets are not defined in the model component.
-   **[Create a TCO report in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/create-eam-tco-report.md)**  
...
-   **[Create a TCO report source in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/create-tco-report-source-eam.md)**  
...
-   **[Asset conditions in Enterprise Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/asset-conditions-eam.md)**  
...
-   **[Create an asset group in Enterprise Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/create-asset-groups-eam.md)**  
Create asset groups to create a logical group of entities that includes assets, locations, and users.
-   **[Create consumable assets in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/create-consumables-eam.md)**  
Create consumables in the Enterprise Asset Workspace to track enterprise assets.
-   **[Use consumable assets in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/create-eamconsumable-asset.md)**  
To use consumable assets, ensure that they are in the **In stock** state and **Available** substate.
-   **[Dispose consumable assets in Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/dispose-eamconsumable-assets.md)**  
...
-   **[Use Advanced Shipment Notification in Enterprise Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/asn-eam.md)**  
...
-   **[View and add enterprise asset shipments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/view-enterprise-asset-shipments.md)**  
...
-   **[Zebra MotionWorks RFID integration for Enterprise Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/eam-zebra-rfid-integration.md)**  
...
-   **[View the asset hierarchy in the Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/view-asset-hierarchy-eam.md)**  
View the hierarchy details of a multi-component asset in a tree-like format in the Enterprise Asset Workspace.
-   **[View the total time worked on all tasks related to an enterprise asset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/view-total-time-spent-on-asset-eam.md)**  
...
-   **[Asset performance reports in the Enterprise Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/enterprise-asset-management/asset-performance-reports-eam.md)**  
