...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/track-tasks-using-mobile-agent-app.html
release: yokohama
...
4.  Filter your tasks by field values.
    ...
    1.  Tap the Filter icon \(\[Omitted image "filter-mobile-task-eam.png"\] Alt text: Filter icon\).
