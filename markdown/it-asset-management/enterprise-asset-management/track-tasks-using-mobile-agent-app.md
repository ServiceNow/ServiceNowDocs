...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/track-tasks-using-mobile-agent-app.html
release: zurich
...
View your work order tasks, asset tasks, and asset repair tasks using the Mobile Agent application.

## Before you begin

Role required: sn\_eam.enterprise\_admin, sn\_eam.enterprise\_asset\_manager, or sn\_eam.enterprise\_asset\_technician
