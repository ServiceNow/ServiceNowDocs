---
title: Asset Total Cost of Ownership for Enterprise Asset Management
description: Asset managers like to know the Total Cost of Ownership \(TCO\) for assets to gain insights into the total cost of assets and enable capital planning.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/asset-tco-eam.html
release: zurich
...
Asset managers like to know the Total Cost of Ownership \(TCO\) for assets to gain insights into the total cost of assets and enable capital planning.
...
If you’re upgrading to Zurich, after the scheduled job **TCO Upgrade for Enterprise Assets** runs, the following updates are made:
...
[Configuring Total Cost of Ownership for enterprise assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/enterprise-asset-management/confifure-eam-asset-tco.md)
