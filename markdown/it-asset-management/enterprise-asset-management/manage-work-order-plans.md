...
Create reusable work order plan templates and use them when creating work order plans. For more details, see [Asset work order plans in Enterprise Asset Management](work-order-plans-eam-assets.md).
