...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/create-asset-eam.html
release: yokohama
...
6.  In the Create New asset page, fill in the details.
    ...
    For a detailed description of the fields, see [Asset fields for enterprise assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/asset-fields-eam.md).
