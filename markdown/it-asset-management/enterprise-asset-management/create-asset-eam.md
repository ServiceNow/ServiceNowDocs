...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/create-asset-eam.html
release: zurich
...
6.  In the Create New asset page, fill in the details.
    ...
    For a detailed description of the fields, see [Asset fields for enterprise assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/enterprise-asset-management/asset-fields-eam.md).
