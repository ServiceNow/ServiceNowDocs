...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-asset-management/enterprise-asset-management/create-asset-eam.html
release: australia
...
6.  In the Create New asset page, fill in the details.
    ...
    For a detailed description of the fields, see [Asset fields for enterprise assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/enterprise-asset-management/asset-fields-eam.md).
