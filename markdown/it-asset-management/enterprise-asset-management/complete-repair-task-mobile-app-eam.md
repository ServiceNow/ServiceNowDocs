...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/enterprise-asset-management/complete-repair-task-mobile-app-eam.html
release: zurich
...
breadcrumb: [Manage enterprise asset repair tasks using the Mobile Agent application, Manage enterprise assets and tasks using Mobile Agent application, Enterprise Asset Management, IT Asset Management]
---
...
<table id="choicetable_g14_wv2_yxb"><thead><tr><th align="left" id="d329771e168">

Task

</th><th align="left" id="d329771e171">

Action

</th></tr></thead><tbody><tr><td id="d329771e177">

**Troubleshoot asset**

</td><td>

In the **Troubleshoot result** field, select any of the following:-   **Repairable**
-   **Unrepairable**
-   **Redeployable**


</td></tr><tr><td id="d329771e203">

**Repair asset**

</td><td>

In the **Repair result** field, select any of the following: -   **Repaired**
-   **Unrepairable**
-   **Redeployable**


</td></tr><tr><td id="d329771e229">

**Evaluate asset**

</td><td>

In the **Evaluation result** field, select any of the following:-   **Redeployable**
-   **To be disposed**


</td></tr></tbody>
</table>8.  In the **Work notes** field, enter your closure comments.
...
**Parent Topic:**[Manage enterprise asset repair tasks using the Mobile Agent application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/enterprise-asset-management/repair-orders-mobile-agent-eam.md)
