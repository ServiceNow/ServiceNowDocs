...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/create-calculated-model-lc-template-eam.html
release: yokohama
...
breadcrumb: [Manage the lifecycle of enterprise models with calculated lifecycle templates, Create and manage enterprise models, Managing enterprise models and assets, Enterprise Asset Management, IT Asset Management]
---
...
Associate the Calculated model lifecycle template with an enterprise model. For details, see [Associate an enterprise model with a Calculated model lifecycle template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/associate-eam-model-calc-template.md).

**Parent Topic:**[Manage the lifecycle of enterprise models with calculated lifecycle templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/manage-eam-lifecycle-temp.md)
