...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/create-eam-lease-contract.html
release: xanadu
...
3.  On the Create New Contract form, fill in the fields.
    ...
    See [Contract fields for Enterprise Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/enterprise-asset-management/contract-fields-eam.md) for a detailed description of each field.
...
7.  Create expense lines to track the cost of each enterprise asset that is covered by the lease contract.
    ...
    2.  On the Create New Expense Line form, fill in the fields.
        ...
        See [Expense line fields for Enterprise Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/enterprise-asset-management/expense-line-fields-eam.md) for a detailed description of each field.
