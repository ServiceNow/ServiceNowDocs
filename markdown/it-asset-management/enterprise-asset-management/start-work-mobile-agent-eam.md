...
-   The more actions icon \(![More actions icon](../../hardware-asset-management/image/more-actions-icon.png)\) with the **Pause work** and **Record time** options is displayed in the top-right corner of the screen.
