...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/start-work-mobile-agent-eam.html
release: yokohama
...
-   The more actions icon \(\[Omitted image "more-actions-icon.png"\] Alt text: More actions icon\) with the **Pause work** and **Record time** options is displayed in the top-right corner of the screen.
