...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/view-stockroom-details.html
release: xanadu
...
Create and view audits for your enterprise asset inventory.
    ...
    1.  From the sidebar of the stockroom record, select the Stock rules icon \(\[Omitted image "stock-rules-icon.png"\] Alt text: Stock rules icon.\).
