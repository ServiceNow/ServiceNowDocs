...
4.  On the **Substitutes** tab of the enterprise model record, add substitute models for the given enterprise model.
    ...
    4.  On the **Substitutes** tab, select the Refresh list icon \(![Refresh list icon.](../image/refresh-list-icon.png)\) to populate the list of newly added substitute models.
