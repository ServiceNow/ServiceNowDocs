...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/record-time-worked-manually.html
release: yokohama
...
Record time worked on a work order task or asset task manually and provide any additional comments on the task using the Mobile Agent application.

## Before you begin

Role required: wm\_agent or sn\_eam.enterprise\_asset\_manager
...
6.  Navigate to **Record time** from the more actions icon \(\[Omitted image "more-actions-icon.png"\] Alt text: More actions icon\) or the **Details** tab.

    -   Tap the more actions icon \(\[Omitted image "more-actions-icon.png"\] Alt text: More actions icon\) at the top right corner of the screen and then tap **Record time**.
    -   On the **Details** tab, tap **Record time**.
7.  On the Record time screen, specify the details of the task.

    1.  Specify the date in the **Work Date** field.

        By default, this field is set to the current date.

    2.  Enter the time duration that you worked on the task in the **Time worked \(Hours\)** and **Time worked \(Minutes\)** fields.

    3.  Provide any additional information in the **Comments** field.
...
**Parent Topic:**[Record time worked on a task using the Mobile Agent application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/record-time-mobile-agent-app.md)
