...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/create-work-order-plan-eam.html
release: yokohama
...
breadcrumb: [Manage work order plans, Managing work orders for your enterprise assets, Enterprise Asset Management, IT Asset Management]
---
...
<table id="choicetable_zfb_tsx_j3c"><thead><tr><th align="left" id="d291148e75">

Create from

</th><th align="left" id="d291148e78">

Steps

</th></tr></thead><tbody><tr><td id="d291148e84">
...
5.  In the **Review work order tasks** activity, assign the work order tasks to technicians and schedule the tasks.
...
**Parent Topic:**[Manage asset-centric work tasks using work order plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/enterprise-asset-management/manage-work-order-plans.md)
