...
4.  Filter or sort the task view.
    ...
    -   To filter your tasks, tap the Filter icon \(![Filter icon](../image/filter-mobile-task-eam.png)\), enter the values to use as a filter in the **Due Date**, **Asset**, **Location**, or **Priority** fields.
