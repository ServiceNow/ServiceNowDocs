...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/enterprise-asset-management/view-availability-for-ent-aaset.html
release: xanadu
...
4.  On the contextual sidebar, select the Asset availability and related KPIs icon \[\[Omitted image "asset-kpi-icon.png"\] Alt text: Asset KPI icon\].
    ...
    \[Omitted image "asset-kpis-report-sidebar.png"\] Alt text: Asset KPIs report
