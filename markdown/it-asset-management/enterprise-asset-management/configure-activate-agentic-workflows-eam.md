...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-asset-management/enterprise-asset-management/configure-activate-agentic-workflows-eam.html
release: australia
...
1.  If you want to use a customized agentic workflow, configure it through one of the following options:
    ...
    **Note:** If you want to run an existing agentic workflow as is, skip this step and proceed directly to [step 3](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/enterprise-asset-management/configure-activate-agentic-workflows-eam.md).
