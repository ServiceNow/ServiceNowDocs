...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/pause-task-mobile-agent-app.html
release: yokohama
...
6.  Tap the more actions icon \(\[Omitted image "more-actions-icon.png"\] Alt text: More actions icon\) at the top right corner of the screen and then tap **Pause work**.
