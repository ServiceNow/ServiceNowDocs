...
4.  Tap **Remove**.
The Asset Usages section reloads to display the removed asset or part, which now has the Status of Removed and State of In stock.
...
-   The Swap in asset has a status of Used.
        ...
        1.  Tap **Calibrate** on the work order task.
