...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/complete-notation-task-recall-order.html
release: yokohama
...
4.  On the **Enterprise Recalled Assets** tab of the recall order record, select the enterprise asset that you want to provide additional operating instructions for.
