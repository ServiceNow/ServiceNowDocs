...
5.  Add aisles to the selected stockroom.
    ...
    3.  To add more aisles, select the Add icon \(![Add an Aisle](../../hardware-asset-management/image/add-aisle-icon.png)\) and enter a unique identifier for the aisle in the **Aisle** field.
...
6.  Add a space to an aisle in the stockroom.
    ...
    4.  To add more spaces, select the Add icon \(![Add Space](../../hardware-asset-management/image/add-aisle-icon.png)\) and enter a unique identifier for the space in the **Space** field.
...
**Parent Topic:**[Manage picking enterprise assets within your stockroom for Enterprise Asset Management workflows](../concept/manage-asset-picking-stockroom-eam-ws.md)
