...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/enterprise-asset-management/import-export-content-data-firmware-ot-assets.html
release: yokohama
...
2.  Import firmware content data onto your ServiceNow instance.
    ...
    2.  Select the Attachments icon \(\[Omitted image "attachments-icon.png"\] Alt text: Attachments icon.\) on the sidebar of the Import page.
...
3.  Export firmware content data from your ServiceNow instance.
    ...
    3.  Select the Attachments icon \(\[Omitted image "attachments-icon.png"\] Alt text: Attachments icon.\) on the sidebar of the Export page.

    4.  In the Attachments window, select the Actions icon \(\[Omitted image "icon-menu.png"\] Alt text: Actions icon.\) for the zip file that you want to download.
