...
|Trigger|Description|
|-------|-----------|
|User triggered|Publisher compliance summary is generated when the agent manually triggers the skill by selecting **Summarize** in the Publisher details page.|
