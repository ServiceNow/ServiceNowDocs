---
title: Using generative AI skills in Now Assist for SAM
...
-   **[Generate publisher compliance summaries by using Now Assist for SAM](../task/summarize-publisher-compliance-now-assist-sam.md)**  
...
-   **[Generate product compliance summaries by using Now Assist for SAM](../task/summarize-product-compliance-now-assist-sam.md)**  
...
-   **[Generate recommended actions for products by using Now Assist for SAM](../task/recommended-actions-now-assist-sam.md)**  
...
-   **[Generate troubleshooting guidance for SaaS integrations by using Now Assist for SAM](../task/troubleshooting-saas-now-assist-sam.md)**  
...
-   **[Automate user resolution for SaaS license management using Now Assist for SAM](../task/automate-userresolution-saas-now-assist-sam.md)**  
Automatically generate user resolution rules to ensure accurate mapping of incoming SaaS subscription data to SAM users.
-   **[Extract entitlements from software contracts using Now Assist for SAM](../task/extract-entitlements-from-contracts-now-assist-sam.md)**  
