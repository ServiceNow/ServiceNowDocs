...
-   **Contract entitlement data extraction**
    ...
    **Note:** For more information on DocIntel, see [Document Intelligence documentation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/document-intelligence-landing.md).
