...
5.  Open the user resolution rule to view additional details.
    ...
    The AI indicator next to the **Source** field and the prepopulated value **AI**, signifies that the rule is automatically generated by the SaaS user resolution Now Assist skill.
