...
5.  Open the user resolution rule to view additional details.
    ...
    For details on the rule, refer to the AI Activity log under Activity center that provides a detailed log of the steps involved in creating the rule. For details on all the fields, see [User resolution rule fields](../../software-asset-management2/reference/user-resolution-rule-fields.md).
