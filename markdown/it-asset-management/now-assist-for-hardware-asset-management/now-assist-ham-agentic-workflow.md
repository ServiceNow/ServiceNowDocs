...
By default, all agentic workflows and AI agent records are read-only. To customize them, you must first [duplicate the agentic workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/clone-aia-usecase.md), and then activate the duplicated workflow.
