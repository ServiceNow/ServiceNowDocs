...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/contract-management/create-contract-renew-req.html
release: yokohama
...
If the parent contract doesn't have child contracts, select the [Build renewal task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/contract-management/fill-cont-renew-info.md).

If the parent contract has child contracts, select the [Contract selection task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/contract-management/select-contract.md).
