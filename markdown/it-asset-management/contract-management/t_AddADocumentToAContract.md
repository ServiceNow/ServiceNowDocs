...
3.  Add a document to the contract.
    ...
    -   If you are using the core UI, use the following steps:
        1.  Click the Manage Attachments \(![Manage Attachments icon.](../image/attachments-icon.png)\) icon on the form header.
    ...
    -   If you are using the Hardware Asset Workspaceor Enterprise Asset Workspace, use the following steps:
        1.  Click the Attachment \(![Attachment icon](../image/attachments-icon.png)\) icon on the sidebar of the contract record.
