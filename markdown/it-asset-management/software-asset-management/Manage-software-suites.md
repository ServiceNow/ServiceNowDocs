...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/Manage-software-suites.html
release: yokohama
...
-   If the preceding rule isn’t met, then any suite that meets the Inference percentage or the Inference number on that device can be considered an Inferred suite candidatthe e.
-   The candidate with highest number of installed components is chosen.
...
**Parent Topic:**[Software Asset Management software suites](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/software-suites.md)
