...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/Manage-software-suites.html
release: xanadu
...
-   If one of the software installations belongs to the suite software model, the suite is inferred directly without the need to meet the Inference percentage.
