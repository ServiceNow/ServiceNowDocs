...
description: The Software Asset Management application automatically maps discovered Oracle features to the Oracle Database options and management packs that they are associated with. These mappings can help you determine the usage and license compliance of your database options and management packs.If a discovered feature is associated with more than one Oracle Database option or management pack, you can change the database option or management pack that the feature usage data is applied to by updating the default mapping for that feature.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/oracle-feature-option-mapping.html
release: xanadu
...
Every Oracle Database option and management pack contains a set of features that enhance the capabilities of Oracle Database. For example, the Oracle Active Data Guard option provides real-time data protection and availability for Oracle Database using features such as automatic block repair, global data services, and application continuity. For more information on the features that are supported by each database option and management pack, refer to the [Oracle documentation](https://docs.oracle.com/en/).
