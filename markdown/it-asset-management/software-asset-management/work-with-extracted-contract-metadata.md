...
To receive notifications when AI agents complete metadata extraction, verify that notifications are enabled by the administrator. For more information, see [Enable notifications for AI extracted metadata and obligations](https://www.servicenow.com/docs/access?context=cmpro-na-me-agentic-ntf&version=australia&pubname=australia-employee-service-management&ft:locale=en-US).
