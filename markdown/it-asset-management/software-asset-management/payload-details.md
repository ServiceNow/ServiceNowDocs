...
**Note:** For more information on CI Identifier rules, see [Identifier Rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_IdentificationRules.md).
