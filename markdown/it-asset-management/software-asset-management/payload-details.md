...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/payload-details.html
release: xanadu
...
**Note:** For more information on CI Identifier rules, see [Identifier Rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/configuration-management-database-cmdb/c_IdentificationRules.md).
