...
The SAP publisher pack supports licensing for named users, engine measurement, third-party access, user subscription, and full usage equivalent.
...
-   **User Subscription and Full Usage Equivalent \(FUE\)**

    Full Usage Equivalent \(FUE\) is a licensing framework for SAP S/4HANA Cloud applications. FUE grants access to the number of users that are authorized to access specified solution capabilities. A single FUE can be allocated across four cloud use types and each use type has a specific weighting factor:

    -   Self-Service
    -   Core
    -   Advanced
    -   Development
    The FUE framework applies to both SAP S/4HANA Cloud, Public Edition and SAP S/4HANA Cloud, Private Edition. The license metric name differs by deployment:

    -   For SAP S/4HANA Cloud, Public Edition, the metric is named **User Subscription**. In releases earlier than Brazil, this metric was named Full Usage Equivalent.
    -   For SAP S/4HANA Cloud, Private Edition, the metric is named **Full Usage Equivalent**.
    The predefined cloud use types for SAP S/4HANA Cloud, Public Edition are stored in the SAP Cloud Use Types \[samp\_sap\_cloud\_use\_type\] table that’s installed with the SAP S/4HANA Spoke plugin \(sn\_s4\_hana\_cld\_spk\).

    For SAP S/4HANA Cloud, Private Edition, the use type for each user is determined on the SAP system during use collection. Based on this classification during data collection. For details on uploading the license ruleset for Private Edition, see [Upload the license ruleset for SAP S/4HANA Private Cloud](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/upload-license-ruleset-sap-private-cloud.md). For details on SAP S/4HANA Cloud, Public Edition, see [Integrating with SAP S/4HANA Cloud Public Edition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/integrate-with-hana.md).

    For descriptions of each cloud use type, the weighting factors, and how FUE licenses are calculated, see [License calculation for SAP cloud use types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/license-calculation-sap-cloud.md).

    **Note:** The FUE feature requires the following minimum system requirements:

    -   Environment: ECS
    -   Deployment Type: SAP S/4HANA Cloud Private Edition
    -   SAP S/4HANA Version: 2025
    -   FPS Level: FPS01 \(02/2026\)
    -   SAP\_BASIS: 816

## SAP connection with the ServiceNow AI Platform

To start connecting your SAP systems and your ServiceNow instance, see [Set up SAP integration to establish a connection with SAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/setup-sap-integration.md). After completing the configuration, establish an SAP connection using one of the following authentication methods:

-   [Basic Authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/add-sap-connection.md)
-   [OAuth 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/add-sap-connection-oauth.md)
...
View your SAP license costs, usage, and compliance using the [Software Publisher Analytics dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/dashboard-sap.md) \(Software Asset Management classic application\) or [publisher overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/publisher-overview-sap.md) \(Software Asset Workspace\). The dashboard and overview also show how you can optimize license consumption by reassigning user roles in your SAP system. You can view the license optimization details in the Software asset analytics view. For more details, see [Publisher optimizations for SAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/pub-opt-sap.md).
...
-   **[SAP publisher pack integration architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/sap-integration-architecture.md)**  
...
-   **[Establish an SAP connection using basic authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/add-sap-connection.md)**  
...
-   **[Establish an SAP connection using OAuth 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/add-sap-connection-oauth.md)**  
...
-   **[Create software models for SAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/add-software-model-sap.md)**  
Create software models to record SAP product information.
-   **[Create entitlements for SAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-entitlement-sap.md)**  
...
-   **[Create a custom SAP named user type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-named-user.md)**  
...
-   **[Map a role to a named user type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-named-user-type-role-mapping.md)**  
...
-   **[Create custom SAP price lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-sap-pricelist.md)**  
...
-   **[Import custom SAP named user types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/import-custom-sap-named-user-type.md)**  
...
-   **[Import custom SAP price lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/import-custom-sap-price-list.md)**  
...
-   **[SAP USMM-based optimization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/usmm-optimization.md)**  
...
-   **[User transaction activity for named user types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/sap-named-user-transaction-activity.md)**  
Determine license optimizations for your SAP named user types based on your SAP user transaction activity.
-   **[Self-declaring SAP engine license usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/self-declaring-sap-engine-usage.md)**  
...
-   **[Software Publisher Analytics dashboard for SAP in Software Asset Management classic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/dashboard-sap.md)**  
...
-   **[Publisher overview for SAP in the Software Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/publisher-overview-sap.md)**  
