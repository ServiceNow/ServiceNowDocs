...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/integrating-ilmt-bigfix-v1-apis.html
release: xanadu
...
-   **[IBM License Metric Tool \(ILMT\) and BigFix Inventory transform maps for v1 APIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/ibm-transform-maps.md)**  
