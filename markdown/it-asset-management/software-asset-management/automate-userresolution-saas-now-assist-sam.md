...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-asset-management/software-asset-management/automate-userresolution-saas-now-assist-sam.html
release: brazil
...
3.  Select **SaaS license management** &gt; **User subscription**.
...
4.  Select **SaaS license management** &gt; **User resolution rules** to view the new user resolution rule that got created.

5.  Open the user resolution rule to view additional details.

    \[Omitted image "user-resolution-details.png"\] Alt text: User resolution rule details
