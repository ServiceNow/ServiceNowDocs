...
If you are on the Rome or the San Diego releases, you must execute the full scan to view the results in the base system scan dashboard. For details on executing a full scan, see Execute full scan.
