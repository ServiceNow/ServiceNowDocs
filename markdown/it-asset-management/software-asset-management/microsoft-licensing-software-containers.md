...
For more information on Docker discovery, see [Docker virtualization](https://www.servicenow.com/docs/access?context=c-docker-virtualization&version=australia&pubname=australia-it-operations-management&ft:locale=en-US). For more information on Kubernetes discovery, see [Kubernetes discovery](https://www.servicenow.com/docs/access?context=kubernetes-discovery&version=australia&pubname=australia-it-operations-management&ft:locale=en-US).
