...
For more information on Docker discovery, see [Docker virtualization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/c-docker-virtualization.md). For more information on Kubernetes discovery, see [Kubernetes discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/kubernetes-discovery.md).
