...
For more information on Docker discovery, see [Docker virtualization](https://www.servicenow.com/docs/access?context=c-docker-virtualization&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US). For more information on Kubernetes discovery, see [Kubernetes discovery](https://www.servicenow.com/docs/access?context=kubernetes-discovery&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
