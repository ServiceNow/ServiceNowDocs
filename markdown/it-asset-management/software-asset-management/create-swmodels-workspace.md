...
11. Associate your software model with a vendor by selecting [Vendor Catalog Items](https://www.servicenow.com/docs/access?context=t_CreateAVendorCatalogItem&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US) and complete the form.
