...
-   Activate the Discovery \(com.snc.discovery\) plugin on your ServiceNow instance. See [Request Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/t_ActivateTheDiscoveryPlugin.md) for detailed instructions.
-   Activate the File-based Discovery \(com.snc.discovery.file\_based\_discovery\) plugin on your ServiceNow instance. See [File-based Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/file-based-discovery.md) for more information on file-based Discovery.
...
-   If you want to track and manage IBM licensing in public cloud environments, configure one or more for the following services to automatically scan for and update the CMDB with cloud infrastructure changes every 30 minutes:
    -   For public clouds hosted by AWS, configure the AWS Config service. See [Configure AWS Config event notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/aws-config-service-cloud-mgt.md) for detailed instructions.
    -   For public clouds hosted by Microsoft Azure, configure the Microsoft Azure Alert service. See [Configure the Microsoft Azure Alert service to auto-update the CMDB](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/microsoft-azure-alert-driven-discovery.md) for detailed instructions.
    -   For public clouds hosted by Google Cloud Platform \(GCP\), configure the Google Cloud Logging service. See [Configure the Google Cloud Logging service to auto-update the CMDB](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/gcp-stackdriver-service.md) for detailed instructions.

If you are integrating the IBM publisher pack with Anglepoint, you must also complete these additional prerequisites:

-   Request and install Anglepoint's IBM Licensing for Software Asset Management application from the ServiceNow® Store. See [Request Anglepoint's IBM Licensing for Software Asset Management application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/request-anglepoint-application.md) for detailed instructions.
-   Set up the Anglepoint Elevate platform.

-   **[Virtualization technologies and public cloud platforms supported by IBM Authorized SAM Provider \(ASP\) integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/supported-virtualization-technologies-iasp-integrations.md)**  
...
-   **[Licensing for IBM Cloud Paks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/licensing-ibm-cloud-paks.md)**  
...
-   **[IBM reconciliation for IBM Authorized SAM Provider \(ASP\) integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/ibm-reconciliation-iasp-integrations.md)**  
...
-   **[Setting up an IBM Authorized SAM Provider \(ASP\) integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/setting-up-anglepoint-integration.md)**  
...
-   **[Creating a connection for the Anglepoint integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/creating-connection-anglepoint-elevate-platform.md)**  
...
-   **[View the daily aggregated peak usage of your IBM software products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/view-daily-aggregated-peak-usage-ibm-products.md)**  
...
-   **[View devices with the highest daily usage of your IBM software products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/view-daily-high-water-mark-usage-ibm-products.md)**  
...
-   **[View product classifications for your IBM components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/view-product-classifications-ibm-components.md)**  
...
-   **[Specify VMMs for IBM licenses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/specify-vm-managers-anglepoint-integration.md)**  
...
-   **[Deduplicating IBM software installations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/deduplicating-ibm-software-installations.md)**  
...
-   **[Enable IBM reconciliation for specific domains](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/enable-domain-recon-anglepoint-integration.md)**  
...
-   **[Verify the meta data for your IBM hosts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/verify-ibm-device-meta-data.md)**  
