...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/ibm-asp-integration.html
release: xanadu
...
-   Activate the Discovery \(com.snc.discovery\) plugin on your ServiceNow instance. See [Request Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/discovery/t_ActivateTheDiscoveryPlugin.md) for detailed instructions.
-   Activate the File-based Discovery \(com.snc.discovery.file\_based\_discovery\) plugin on your ServiceNow instance. See [File-based Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/discovery/file-based-discovery.md) for more information on file-based Discovery.
...
-   If you want to track and manage IBM licensing in public cloud environments, configure one or more for the following services to automatically scan for and update the CMDB with cloud infrastructure changes every 30 minutes:
    ...
    -   For public clouds hosted by Google Cloud Platform \(GCP\), configure the Google Cloud Logging service. See [Configure the Google Cloud Logging service to auto-update the CMDB](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/discovery/gcp-stackdriver-service.md) for detailed instructions.

If you are integrating the IBM publisher pack with Anglepoint, you must also complete these additional prerequisites:

-   Request and install Anglepoint's IBM Licensing for Software Asset Management application from the ServiceNow® Store. See [Request Anglepoint's IBM Licensing for Software Asset Management application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/request-anglepoint-application.md) for detailed instructions.
-   Set up the Anglepoint Elevate platform.

-   **[Virtualization technologies and public cloud platforms supported by IBM Authorized SAM Provider \(IASP\) integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/supported-virtualization-technologies-iasp-integrations.md)**  
...
-   **[IBM reconciliation for IBM Authorized SAM Provider \(IASP\) integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/ibm-reconciliation-iasp-integrations.md)**  
...
-   **[Setting up an IBM Authorized SAM Provider \(IASP\) integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/setting-up-anglepoint-integration.md)**  
...
-   **[Creating a connection for the Anglepoint integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/creating-connection-anglepoint-elevate-platform.md)**  
...
-   **[View the daily aggregated peak usage of your IBM software products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/view-daily-aggregated-peak-usage-ibm-products.md)**  
...
-   **[View devices with the highest daily usage of your IBM software products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/view-daily-high-water-mark-usage-ibm-products.md)**  
...
-   **[View product classifications for your IBM components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/view-product-classifications-ibm-components.md)**  
...
-   **[Specify the virtual machine \(VM\) managers for which you are tracking IBM licenses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/specify-vm-managers-anglepoint-integration.md)**  
Specify the virtual machine \(VM\) managers, such as VMware vCenter Servers and IBM Hardware Management Consoles \(HMCs\), for which you want to track IBM licenses. You can track licenses for IBM software that is discovered within these specified VM managers only.
-   **[Deduplicating IBM software installations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/deduplicating-ibm-software-installations.md)**  
...
-   **[Enable IBM reconciliation for specific domains](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/enable-domain-recon-anglepoint-integration.md)**  
If you are using domain separation for the integration between the Software Asset Management publisher pack for IBM and an authorized Software Asset Management provider, enable IBM reconciliation only for specific domains.
-   **[Verify the meta data for your IBM hosts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/verify-ibm-device-meta-data.md)**  
