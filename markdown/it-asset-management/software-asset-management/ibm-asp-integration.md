...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/ibm-asp-integration.html
release: yokohama
...
-   Activate the Discovery \(com.snc.discovery\) plugin on your ServiceNow instance. See [Request Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/t_ActivateTheDiscoveryPlugin.md) for detailed instructions.
-   Activate the File-based Discovery \(com.snc.discovery.file\_based\_discovery\) plugin on your ServiceNow instance. See [File-based Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/file-based-discovery.md) for more information on file-based Discovery.
...
-   **[Licensing for IBM Cloud Paks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/licensing-ibm-cloud-paks.md)**  
...
-   **[IBM reconciliation for IBM Authorized SAM Provider \(IASP\) integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/ibm-reconciliation-iasp-integrations.md)**  
...
-   **[Setting up an IBM Authorized SAM Provider \(IASP\) integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/setting-up-anglepoint-integration.md)**  
...
-   **[Creating a connection for the Anglepoint integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/creating-connection-anglepoint-elevate-platform.md)**  
...
-   **[View the daily aggregated peak usage of your IBM software products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/view-daily-aggregated-peak-usage-ibm-products.md)**  
...
-   **[View devices with the highest daily usage of your IBM software products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/view-daily-high-water-mark-usage-ibm-products.md)**  
...
-   **[View product classifications for your IBM components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/view-product-classifications-ibm-components.md)**  
...
-   **[Specify the virtual machine \(VM\) managers for which you are tracking IBM licenses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/specify-vm-managers-anglepoint-integration.md)**  
...
-   **[Deduplicating IBM software installations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/deduplicating-ibm-software-installations.md)**  
...
-   **[Enable IBM reconciliation for specific domains](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/enable-domain-recon-anglepoint-integration.md)**  
...
-   **[Verify the meta data for your IBM hosts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/verify-ibm-device-meta-data.md)**  
