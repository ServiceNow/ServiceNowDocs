...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/sam-workspace-landing.html
release: zurich
...
Opens the CMDB success advisor for SAM dashboard to review software install data quality metrics and remediation actions.
 ...
 If the scope isn't configured yet, opens the **Edit dashboard scope** dialog box instead. For more information, see [Using CMDB success advisor for SAM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/cmdb-sa-sam-use.md).
