...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/cmdb-sa-sam-optimize-dashboard.html
release: zurich
...
2.  Review your previously selected software products, shown as already selected in the Edit dashboard scope dialog box.
    ...
    Add or remove software products using the same actions described in [Get started with CMDB success advisor setup for SAM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/cmdb-sa-sam-get-started.md).
