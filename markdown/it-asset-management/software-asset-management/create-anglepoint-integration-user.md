...
Option to designate the user as an internal integration user. See [Mark service accounts as internal integration users](https://www.servicenow.com/docs/access?context=t_MarkSvcAcctsAsInternalIntegUsers&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US) for more information on internal integration users.
