...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-asset-management/software-asset-management/adobe-cloud-integration.html
release: brazil
...
You can integrate your ServiceNow® instance with Adobe Cloud services using the [OAuth Server to Server credential](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/integrate-adobe-cloud-oauth.md) authentication method.
...
-   **Prerequisites**
    ...
    1.  [Install Software Asset Management Professional for Adobe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/adobe-publisher-pack.md)
    ...
    2.  [Install Software Asset Management - SaaS License Management plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/request-saas-license-management.md)
    ...
    3.  [Verify content updates for Software Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/c_SAMContentService.md)
    ...
    4.  [Create a success goal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-success-goals.md)
    ...
    5.  [​ Set up OAuth on Adobe Cloud](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-adobe-cloud-oauth.md)
...
-   **Software Asset Management configurations**
    ...
    1.  [​ Set up Adobe Cloud integration profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-adobe-cloud-integration-oauth.md)
    ...
    2.  [Configure user resolution rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/map-user-data.md)
    ...
    3.  [Review and configure reclamation rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/reclamation-rules-adobe.md)

        The Software Asset Management application automatically provides base system reclamation rules when you create an integration profile for Adobe Cloud. You can customize these rules based on your specific activity thresholds, such as 15, 30, 90, or 180 days. For more information, see [Review a software reclamation rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/add-reclamation-rule-sub.md).

    4.  [Pull subscription data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/adobe-scheduled-jobs.md)
    ...
    5.  [Set up software models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/customppn-swap.md)
    ...
    6.  [Set up entitlements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-entitlements-workspace.md)
...
-   **Software Asset Management configurations verification**
    ...
    1.  [Verify the complete pull of all subscriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/verify-adobe-info.md)
    ...
    2.  [Run health check](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/run-healthcheck.md)
    ...
    3.  [Verify the pull of all required software usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/view-sw-usage-workspace.md)
    ...
    5.  [Run reconciliation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/run-recon-workspace.md)
    ...
    6.  [Check license position report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/sam-license-position-report.md)
    ...
    7.  [Act on unlicensed subscriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/publisher-overview-adobe.md)

        Identify and address the unlicensed Adobe Cloud subscriptions.

    8.  [Act on optimization recommendations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/pub-opt-adobe.md)
