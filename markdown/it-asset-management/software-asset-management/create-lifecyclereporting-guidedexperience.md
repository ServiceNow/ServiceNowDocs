...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-asset-management/software-asset-management/create-lifecyclereporting-guidedexperience.html
release: australia
...
10. On the form, fill in the fields.
    ...
    For a description of each field, see [SAM Success Goal Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/software-asset-management/sam-success-goal-details.md).
...
14. On the form, fill in the fields.
    ...
    For a description of each field, see [SAM Success Activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/software-asset-management/sam-success-activity.md).
...
26. On the form, fill in the fields.
    ...
    For details, see [Create averages for product life cycles in workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/software-asset-management/create-lifecycle-averages-workspace.md).
