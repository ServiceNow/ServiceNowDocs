...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-asset-management/software-asset-management/sccm-software-usage.html
release: brazil
...
The SCCM integration plugin installs [several components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/sccm-sam-components.md).

After the SCCM usage plugin is [activated and configured](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/configure-sccm-sam.md), a scheduled import runs monthly to [bring SCCM software usage data into your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/c_MicrosoftSCCMIntegration.md). The usage data is then mapped to Software Usage table. During the scheduled job, a SQL query is executed.
...
You can also import usage information using ServiceNow [import sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/import-sets-landing-page.md) feature.
