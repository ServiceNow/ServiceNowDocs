...
After the SCCM usage plugin is [activated and configured](../task/configure-sccm-sam.md), a scheduled import runs monthly to [bring SCCM software usage data into your instance](https://www.servicenow.com/docs/access?context=c_MicrosoftSCCMIntegration&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US). The usage data is then mapped to Software Usage table. During the scheduled job, a SQL query is executed.
...
You can also import usage information using ServiceNow [import sets](https://www.servicenow.com/docs/access?context=import-sets-landing-page&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US) feature.

-   **[Components installed with the Microsoft SCCM software usage plugin](../reference/sccm-sam-components.md)**  
...
**Parent Topic:**[Software reclamation rules](sw-reclamation-rules.md)
