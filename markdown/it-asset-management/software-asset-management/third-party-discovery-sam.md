...
For more information on IRE, see [Identification and Reconciliation Engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/configuration-management-database-cmdb/ire.md).
