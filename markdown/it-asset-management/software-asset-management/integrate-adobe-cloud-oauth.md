...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d296321e390">

Interface

</th><th align="left" id="d296321e393">

Action

</th></tr></thead><tbody><tr><td id="d296321e399">
...
Connection and credential alias for the Adobe Cloud spoke. This field is automatically set to **Adobe OAuth**.
...
4.  Select the preview icon \(![Preview icon](../image/preview-icon.png)\) beside the Connection &amp; Credential field to open the Connection &amp; Credential Aliases record.
...
7.  Select **Create and Get OAuth Token**.
    ...
    The OAuth token flow is completed successfully.
