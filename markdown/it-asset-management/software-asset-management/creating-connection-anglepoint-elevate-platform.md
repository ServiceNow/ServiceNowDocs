...
-   **[Create an API user for the Anglepoint integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-anglepoint-integration-user.md)**  
...
-   **[Configuring the API authentication method for the Anglepoint integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/configuring-auth-method-anglepoint-integration.md)**  
