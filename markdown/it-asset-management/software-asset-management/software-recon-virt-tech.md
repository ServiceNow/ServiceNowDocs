...
Virtualization is a process of simulating hardware functionality and creating a virtual environment in which you can run more than one virtual machine on a single server in a clustered environment. The virtualization technologies supported by Software Asset Management are:
...
ITOM Discovery discovers virtualization technologies based on their relationship architecture. Software Asset Management depends on the discovered relationships to determine the license compliance of the software installs.
