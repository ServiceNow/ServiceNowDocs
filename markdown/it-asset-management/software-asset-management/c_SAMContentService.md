...
Publisher, product, version, and edition, as well as their corresponding values of the software product in the Software Asset Management \(SAM\) content library.
...
Product, edition condition, edition, and product type, as well as their corresponding values of the software product in the Software Asset Management \(SAM\) content library. The exception rules table provides an option to tag certain product editions as non-licensable​.
