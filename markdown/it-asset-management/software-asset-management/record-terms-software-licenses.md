...
10. To associate your software model with a vendor, select the [Vendor Catalog Item related list](https://www.servicenow.com/docs/access?context=t_CreateAVendorCatalogItem&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US) and complete the form.
