...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/microsoft-sql-server-ha-configurations.html
release: zurich
...
For more information on Microsoft SQL Server licensing, see [Microsoft Per Core licensing rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/microsoft-sw-license-metrics.md). For more information on Always On availability group discovery, see [Microsoft SQL Server and Cluster discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/mssql-data-collected-pattern.md).
