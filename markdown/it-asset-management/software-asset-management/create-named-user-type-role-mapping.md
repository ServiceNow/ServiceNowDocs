...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/create-named-user-type-role-mapping.html
release: yokohama
...
6.  Select the Add icon \(\[Omitted image "add-icon.png"\] Alt text: Add icon.\) to move the selected role to the SAP Roles List.
