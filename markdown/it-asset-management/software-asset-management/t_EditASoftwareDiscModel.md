---
title: Manually normalize a software discovery model
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/t\_EditASoftwareDiscModel.html
release: xanadu
...
breadcrumb: [View normalization suggestions, Using Software Asset Management classic, Software Asset Management, IT Asset Management]
---
...
2.  Fill in the **Publisher**, **Product**, and **Version** fields, as appropriate.
    ...
    You can create a [custom product](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/t_AddACustomProduct.md) from the Product lookup list, if desired.
...
**Parent Topic:**[View normalization suggestions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/view-norm-suggestions-sam.md)
