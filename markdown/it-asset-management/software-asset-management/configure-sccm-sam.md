...
1.  [Activate the SCCM integration plugin](https://www.servicenow.com/docs/access?context=activate-microsoft-sccm-plugin&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) for your version of SCCM.
...
2.  If you want to reclaim unused and underused software, set up SCCM for Client Software Distribution \(CSD\).
    ...
    1.  Request the [Client Software Distribution](https://www.servicenow.com/docs/access?context=t_ActivateClientSWDistribution&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) \(com.snc.orchestration.client\_sf\_distribution\) plugin.

        Client Software Distribution requires a subscription to [Orchestration](https://www.servicenow.com/docs/access?context=r-orchestration&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
3.  [Setup the MID Server](https://www.servicenow.com/docs/access?context=mid-server-installation&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).

4.  [Configure SCCM and the ServiceNow AI Platform](https://www.servicenow.com/docs/access?context=t_RetrieveSCCMDataClientSWDist&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).

5.  To offer an application from the Service Catalog, [create a catalog item](https://www.servicenow.com/docs/access?context=t_CreateCatItemSCCMApp&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).


## What to do next

Once you've configured SCCM and discovered your software applications, you can [create reclamation rules](create-reclamation-rule-sccm.md) to identify unused or underused software, [view software usage](t_ViewSoftwareUsage.md), and [reclaim software](t_AddAReclCandidate.md).
