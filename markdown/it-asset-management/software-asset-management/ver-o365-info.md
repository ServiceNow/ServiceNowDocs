...
3.  If your Microsoft 365 subscription data isn’t getting pulled into Software Asset Management, verify your integration setup:
    ...
    3.  On the Rest Message form, select the **Get OAuth Token** related link.
        ...
        **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/integrate-with-microsoft.md) table.
...
5.  If the **User** field in the Software Subscription \[samp\_sw\_subscription\] table is empty, you can map the field with an associated user.
    ...
    For more information, see [Associate a user with subscription records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/saas-license-management/map-user-data.md).
