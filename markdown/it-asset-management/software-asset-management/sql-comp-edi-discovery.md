...
For more information on Microsoft SQL Server component edition discovery, see [MSSQL server discovery](https://www.servicenow.com/docs/access?context=mssql-data-collected-pattern&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).
