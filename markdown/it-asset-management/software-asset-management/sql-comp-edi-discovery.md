...
For more information on Microsoft SQL Server component edition discovery, see [MSSQL server discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/mssql-data-collected-pattern.md).
