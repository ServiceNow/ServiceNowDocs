...
You can use a discovery tool, such as the ServiceNow® Discovery application, to automatically locate and identify the Hyper-V hypervisors and VMs in your environment, as well as the Microsoft Server products that are running on those VMs. For more information on this discovery process and the associated data models, see [Hyper-V discovery](https://www.servicenow.com/docs/access?context=r_DiscoveryForHyperV&version=australia&pubname=australia-it-operations-management&ft:locale=en-US).
