...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/playbook-entitlementsetup-workspace.html
release: yokohama
...
-   activity log on the right-hand side.

\[Omitted image "guided-playbook.png"\] Alt text: playbook \[Omitted image ""\] Alt text: Playbook layout.
...
Guided Setups provide a sequence of tasks that help you configure the following products or applications on your ServiceNow instance:
...
Navigate to the [Microsoft 365 Guided Setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/integrate-with-microsoft.md) by either of the following ways:
