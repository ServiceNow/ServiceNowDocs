...
7.  To track the cost of your software over its lifecycle, configure [expense lines](https://www.servicenow.com/docs/access?context=c_ExpenseLine&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
