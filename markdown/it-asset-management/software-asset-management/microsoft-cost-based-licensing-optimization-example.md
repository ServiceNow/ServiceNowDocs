...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/microsoft-cost-based-licensing-optimization-example.html
release: yokohama
...
\[Omitted image "microsoft-sql-server-cluster-example.png"\] Alt text: Microsoft SQL Server cluster infrastructure.
