...
You can review plugin activation changes in the [Upgrade History module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/uc-history-module.md) to determine what changes have automatically been skipped so you can [Resolve a skipped update and set a resolution status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/uc-resolve-skipped-update.md), if needed.
...
[plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-service-management/c_SoftwareAssetManagement.md)
