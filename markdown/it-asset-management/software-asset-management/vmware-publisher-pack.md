...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/vmware-publisher-pack.html
release: zurich
...
To use the VMware publisher pack, activate the Software Asset Management Professional for VMware \(com.sn\_samp\_vmware\) [plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/t_RequSoftwareAssetMgmt.md).
...
View compliance analysis results for VMware in either the Software Publisher Analytics dashboard for VMware \(Software Asset Management classic application\) or the publisher overview for VMware, Inc. \(Software Asset Workspace\). For more information on the Software Publisher Analytics dashboard for VMware, see [Software Publisher Analytics dashboard for VMware in Software Asset Management classic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/dashboard-vmware.md). For more information on the publisher overview for VMware, Inc., see [Publisher overview for VMware, Inc. in the Software Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/publisher-overview-vmware.md).
...
-   **[Software Publisher Analytics dashboard for VMware in Software Asset Management classic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/dashboard-vmware.md)**  
...
-   **[Publisher overview for VMware, Inc. in the Software Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/publisher-overview-vmware.md)**  
