...
You can view descriptions of your license metrics by selecting the reference \(![Reference icon](../image/reference-icon.png)\) icon next to the **License metric** field in your software entitlements.
