...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/create-lifecycle-averages-workspace.html
release: yokohama
...
Ensure that **com.snc.samp.generate.calculated.lifecycles** system property is enabled. For additional details, see [Product life cycles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/calculated-lifecycles.md).
