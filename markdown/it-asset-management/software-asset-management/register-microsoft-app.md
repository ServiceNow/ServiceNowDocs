...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/register-microsoft-app.html
release: zurich
...
Microsoft Entra ID Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/integrate-with-microsoft.md) table.
...
10. Specify the level of access that the application has to your protected resources.
    ...
    6.  Under Select permissions, select the check boxes for the following permissions:
        ...
        **Important:** Add Tenant.Read.All for Power BI delegated permissions. Use this permission only for standard delegated admin access tokens. You must not include this permission when authenticating via a service principal.
...
After you successfully register and set up your application, remain in the Microsoft Azure portal if you have selected application permission. You must enable your application to access Power BI service content and APIs.
