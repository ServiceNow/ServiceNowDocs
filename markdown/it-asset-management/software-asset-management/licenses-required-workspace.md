...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/licenses-required-workspace.html
release: xanadu
...
breadcrumb: [License usage view, Using Software Asset Workspace, Software Asset Management, IT Asset Management]
---
...
Name of the configuration item such as server, cluster, which consumes the licenses.
...
Indicates whether the configuration item is a virtual or physical host.
    ...
    This related lists only appears if the specified license is used by a downgrade version of the software. If a downgrade is not using any rights, that downgrade doesn't appear in this related list.
...
6.  In the Licenses Required By related list, view the details of required licenses by selecting the value for a device under the **License required** column.
    ...
    \[Omitted image "license-required-calculation.png"\] Alt text: License calculation details of a device.
