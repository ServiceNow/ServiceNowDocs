...
2.  Add the application that you created in [Register a Microsoft Entra ID application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/register-microsoft-app.md) as a member of your security group.
    ...
    4.  In the dialog box, search for and select the application that you created in [Register a Microsoft Entra ID application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/register-microsoft-app.md).
