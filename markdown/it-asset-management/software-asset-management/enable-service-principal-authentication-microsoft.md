...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/enable-service-principal-authentication-microsoft.html
release: yokohama
...
2.  Add the application that you created in [Register a Microsoft Entra ID application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/register-microsoft-app.md) as a member of your security group.
    ...
    4.  In the dialog box, search for and select the application that you created in [Register a Microsoft Entra ID application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/register-microsoft-app.md).
...
3.  Enable your security group to access read-only Power BI admin APIs.
    ...
    3.  On the page header of the Power BI portal, select the Settings icon \(\[Omitted image "gear-icon.png"\] Alt text: Settings icon.\) and then select **Admin portal**.
