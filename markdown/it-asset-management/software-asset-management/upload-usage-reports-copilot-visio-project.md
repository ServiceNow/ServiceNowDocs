...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/upload-usage-reports-copilot-visio-project.html
release: yokohama
...
<table id="choicetable_yzk_rml_bcc"><thead><tr><th align="left" id="d123335e202">

Interface

</th><th align="left" id="d123335e205">

Action

</th></tr></thead><tbody><tr><td id="d123335e211">
...
<table id="choicetable_np5_wnl_bcc"><thead><tr><th align="left" id="d123335e269">

Interface

</th><th align="left" id="d123335e272">

Action

</th></tr></thead><tbody><tr><td id="d123335e278">
...
<table id="choicetable_my4_mcm_bcc"><thead><tr><th align="left" id="d123335e358">

Interface

</th><th align="left" id="d123335e361">

Action

</th></tr></thead><tbody><tr><td id="d123335e367">
...
2.  Select the Manage Attachments \(\[Omitted image "attachments-icon.png"\] Alt text:\) icon on the form header.
...
1.  Select an integration profile.
2.  Select the Attachment \(\[Omitted image "attachments-icon.png"\] Alt text:\) icon from the sidebar of the integration profile.
