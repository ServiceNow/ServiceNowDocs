...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/usmm-optimization.html
release: zurich
...
If you opt in for the USMM rules by selecting the **Use USMM Role Optimization** check box in the SAP Connection record, the Software Asset Management application prefers the optimized USMM Named User Type during reconciliation. For more information about creating a connection profile to establish a connection between your SAP system and your ServiceNow instance, see [Establish an SAP connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/add-sap-connection.md).
