...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/install-sam-playbook.html
release: yokohama
...
-   Store applications: Playbook Experience \(sn\_playbook\_exp\) and Playbook Experience Components \(now\_playbook\_exp\)
-   Tables
