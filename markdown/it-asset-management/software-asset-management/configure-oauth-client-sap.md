...
2.  In the **Client ID** field, select the system user created for OAuth authentication.
    ...
    For example, `OAUTH_USER`. For information on creating a system user, see [Create a system user for OAuth authentication in SAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-system-user-oauth-sap.md).
...
Configure roles and authorizations for the OAuth user. For details, see [Configure roles and authorizations for the OAuth user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/configure-roles-auth-oauth-user.md).
