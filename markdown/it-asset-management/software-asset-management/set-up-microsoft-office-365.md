...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/set-up-microsoft-office-365.html
release: zurich
...
-   Software Asset Management - SaaS License Management \(sn\_sam\_saas\_int\) plugin from the [ServiceNow Store](https://store.servicenow.com/)
    ...
    For more information, see [Request SaaS License Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/saas-license-management/request-saas-license-management.md).
...
<table id="choicetable_w41_4c4_2cc"><thead><tr><th align="left" id="d336126e127">

Interface

</th><th align="left" id="d336126e130">

Action

</th></tr></thead><tbody><tr><td id="d336126e136">
...
-   **Delegated**: Permissions that enable the application to act in place of a signed-in user.
    ...
    **Note:** For more information about the required roles and scopes, see [Minimal user permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/integrate-with-microsoft.md) table.
