...
For more information about the allocation fields, see [Software model results license metric results fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/license-metric-results-fields.md).
...
5.  Add the Device Allocations details. For more information, see [Create device allocation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/create-device-allocation.md). When allocating license to the Host or VM, based on the value provided in the **Quantity** field, the Software Asset Management application determines the core count based on the following criteria:
