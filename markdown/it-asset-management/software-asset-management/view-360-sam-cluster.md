...
8.  Select **Open Dependency View** to view the relationship between the nodes of the cluster.
    ...
    For details on Dependency Views, see [Dependency Views map menus and controls](https://www.servicenow.com/docs/access?context=r_NGBSMMenus&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
