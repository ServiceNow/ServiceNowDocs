...
# Create an unrecognized publisher integration mapping
...
4.  Select the appropriate subscription integration for the publisher using the lookup \(\[Omitted image "search-icon.png"\] Alt text: Lookup icon\) icon.
