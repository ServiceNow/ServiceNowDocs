...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/soft-asset-demand.html
release: zurich
...
When this field is clear, and you reset the demand to **Draft**, the value for the **Assessment Required** field is retained as clear.
    ...
    You can also create a demand requirement. For more information, see [Create a demand requirement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/create-demand-req.md).
