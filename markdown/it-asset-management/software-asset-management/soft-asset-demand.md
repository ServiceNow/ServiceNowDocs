...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/soft-asset-demand.html
release: xanadu
...
When this field is clear, and you reset the demand to **Draft**, the value for the **Assessment Required** field is retained as clear.
    ...
    You can also create a demand requirement. For more information, see [Create a demand requirement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/create-demand-req.md).
...
Use the ServiceNow® Demand Management application to approve and complete the demand. For more information, see .

You can create a project for the demand by selecting the **Create Project** related link. A project enables you to track the status, percent complete, and duration of the work required to accomplish the demand. You can also create project tasks to define the work items that are required to complete the project. For more information, see .
