...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-asset-management/software-asset-management/supported-microsoft-license-types.html
release: brazil
...
**Note:** For details on the license metrics that are supported by each Microsoft product, see [License metrics for Microsoft products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/mapping-ms-license-metrics.md).
...
For more information on Microsoft per core licenses, see [Microsoft Per Core licensing rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/microsoft-sw-license-metrics.md).
...
For more information on Microsoft per core \(with CAL\) licenses, see [Microsoft Per Core \(with CAL\) licensing rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/software-asset-management/microsoft-percore-withcal.md).
