...
![Oracle Multitenant option not in use.](../image/multitenant-not-in-use.png "Oracle Multitenant option not in use example")
...
![Oracle Multitenant option in use.](../image/multitenant-in-use.png "Oracle Multitenant option in use example")
...
![Oracle Multitenant option in use but exceeds maximum PDB amount.](../image/multitenant-in-use-exceeds-max-allowed.png "Oracle Multitenant option in use but exceedx maximum PDB amount example")
