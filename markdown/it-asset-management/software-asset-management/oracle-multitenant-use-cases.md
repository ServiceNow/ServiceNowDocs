...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/oracle-multitenant-use-cases.html
release: yokohama
...
breadcrumb: [Oracle Database licensing in multitenant architectures, Software Asset Management publisher pack for Oracle, Supported software publisher licenses, Software Asset Management, IT Asset Management]
---
...
\[Omitted image "multitenant-not-in-use.png"\] Alt text: Oracle Multitenant option not in use.
...
\[Omitted image "multitenant-in-use.png"\] Alt text: Oracle Multitenant option in use.
...
\[Omitted image "multitenant-in-use-exceeds-max-allowed.png"\] Alt text: Oracle Multitenant option in use but exceeds maximum PDB amount.
...
**Parent Topic:**[Oracle Database licensing in multitenant architectures](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/oracle-licensing-multitenant-architectures.md)
