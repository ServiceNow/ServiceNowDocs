...
**Note:** After you upgrade to the Xanadu release and a content update is performed, if the content update changes the license type of a specific PPN from Step-up to Subscription Step-up, all entitlements associated with that PPN will be updated to Subscription Step-up entitlements.
...
Billing frequency for your software subscription. The options are **Monthly**, **Quarterly**, **Annually**, and **Entire Subscription Period**. The **Entire Subscription period** option indicates that you’re required to pay only after throughout the entire duration of your subscription.If you select **Monthly**, **Quarterly**, or **Annually**, you must specify the time period during which the subscription is valid in the **Start date** and **End date** fields. If you select **Entire Subscription Period**, only the **Start date** field is required.
 ...
 This field appears only if you select **Subscription** or **Subscription Step-up** from the License type list.
...
Start date of your subscription, maintenance entitlement, or SA service.This field appears only if you select **Subscription**, **Perpetual + Maintenance**, **Maintenance**, **Perpetual + Software Assurance**,**Software Assurance**, **Step-up**, or **Subscription Step-up** from the License type list.
...
End date of your subscription, maintenance entitlement, or SA service.After the end date is reached, the maintenance flag is cleared and the state is retired if **Software Assurance** was specified as the **License type**.

 This field appears only if you select **Subscription**, **Perpetual + Maintenance**, **Maintenance**, **Perpetual + Software Assurance**,**Software Assurance**, **Step-up**, or **Subscription Step-up** from the License type list.
