...
-   **Prerequisites**
    ...
    4.  [Install Microsoft Entra ID Spoke](https://www.servicenow.com/docs/access?context=microsoft-azure-ad-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
