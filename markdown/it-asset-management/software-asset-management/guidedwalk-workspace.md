...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/guidedwalk-workspace.html
release: xanadu
...
breadcrumb: [Software Asset Management Guided Experiences, Exploring Software Asset Management, Software Asset Management, IT Asset Management]
---
...
The process of creating an entitlement is organized into lanes. The lanes appear in the left pane of the page. Each lane has a few tasks that you are asked to complete. After you complete a task, click **Mark Complete** to move to the next task. You can click **Save** at any time in the process to save your changes and return to the playbook later. You can also click **Cancel** to abort the entitlement setup at any point of time. While you are performing a particular task, a status of in progress appears for that task. As you mark a task complete, the status of that task changes to complete. Once you complete all the tasks in a lane, you move to the next lane.
...
4.  Select whether you are creating an entitlement for an on-premises product or for a SaaS product.
    ...
    **Note:** You are asked to select on-premise or SaaS only if the Software Asset Management - SaaS License Management Integrations \(sn\_sam\_saas\_int\)SaaS plugin is activated. If this plugin is not activated, then the product type is automatically selected as on-premise.
    ...
    |Publisher Part number|Enter the PPN if you have one; else create a custom PPN by clicking the link in the informational message to take you to the Custom Part Numbers page.|
...
If you have an integration profile already set-up, select it; else, click the appropriate link to create a direct or a SSO integration profile. **Note:** Integration profile is needed to view software usage information and optimize stale licenses.
...
Select the type of profile, direct or SSO, that you are using for this SaaS product.
...
9.  Enter the number of rights purchased in **Purchased rights**.
    ...
    If you've specified a Microsoft Per Core or Microsoft Per Core with CAL license type, this field is automatically populated. This value is based on the values entered in the Rights per license pack field multiplied by the value in the Number of packs field.
...
17. Enter contract details in **Lease Contract**, **Warranty expiration**, **Support Group** and **Supported by** fields.
    ...
    Once you complete all the tasks in the Additional Details lane, you can move to the Review lane.
