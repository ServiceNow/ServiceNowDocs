...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/reconcile-licenses-global-entities.html
release: xanadu
...
If you're upgrading from a Pre Xanadu release and based on what you have selected in the **com.snc.samp.recon.group** and **com.snc.samp.recon.subgroup** properties \(in the Software Asset Management Properties page\), the following upgrade actions take place:
