...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/import-abap-program-sap.html
release: zurich
...
To access the ABAP program, download the SAP ABAP for Software Asset Management application from the [ServiceNow Store](https://store.servicenow.com/). Make sure you download the application version that is compatible with the Zurich release.
