...
To access the ABAP program, download the SAP ABAP for Software Asset Management application from the [ServiceNow Store](https://store.servicenow.com/). Make sure you download the application version that is compatible with the Xanadu release.
