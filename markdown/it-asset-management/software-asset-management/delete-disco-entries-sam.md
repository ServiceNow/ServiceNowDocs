...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/delete-disco-entries-sam.html
release: yokohama
...
1.  Use the REST Table API api/now/table/cmdb\_sam\_sw\_install?sysparm\_query=installed\_on%3D28c9c3b8c0a8000b009b2d941d7e3ee9 to query and identify the list of software installs on a specific CI.
    ...
    For more information on the REST endpoint API, see [Table API-GET](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/rest-apis/c_TableAPI.md).
...
2.  Based on the response, identify the sys\_ids of the software installations that are deleted on a CI.
    ...
    Only the sys\_ids of those software installations need to be passed through the Delete API.
