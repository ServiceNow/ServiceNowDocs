...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/sw-reclamation-rules.html
release: xanadu
...
For more information about the reclamation rules for each application, see [Reclamation rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/reclamation-rules.md).
...
-   **[Add a software reclamation rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/t_AddAReclamationRule.md)**  
Add a reclamation rule to aggregate usage records and to identify unused software.
-   **[Microsoft SCCM software usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/sccm-software-usage.md)**  
