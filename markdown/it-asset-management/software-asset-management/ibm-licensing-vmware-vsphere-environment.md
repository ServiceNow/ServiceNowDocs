...
Sub-capacity**Note:** You can use sub-capacity licensing only if you configure and specify a VM manager for your VMs. For more information on VM managers, see [Specify the virtual machine \(VM\) managers for which you are tracking IBM licenses](../task/specify-vm-managers-anglepoint-integration.md).
...
</table>**Parent Topic:**[Virtualization technologies and public cloud platforms supported by IBM Authorized SAM Provider \(IASP\) integrations](supported-virtualization-technologies-iasp-integrations.md)
