...
For a Nutanix AHV environment, data is stored in the following tables. For more information on the Nutanix discovery pattern, see [Nutanix Acropolis discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/nutanix-pattern.md).
