...
-   **[Create entitlements in Software Asset Management classic](../task/track-software-rights.md)**  
...
-   **[Import bulk entitlements in Software Asset Management classic](../task/view-entitlement-import-errors.md)**  
You can import multiple entitlements together using a Microsoft Excel spreadsheet in Software Asset Management classic.
-   **[Create software models in Software Asset Management classic](../task/record-terms-software-licenses.md)**  
...
-   **[View normalization suggestions](../task/view-norm-suggestions-sam.md)**  
View normalization suggestion records that are created for discovery models. You can accept or reject these suggestions.
-   **[Software license usage](sam-license-workbench.md)**  
Review reconciliation results in a simplified workbench view.
-   **[View or create software usage in Software Asset Management classic](../task/t_ViewSoftwareUsage.md)**  
...
-   **[Create averages for product life cycles in Software Asset Management classic](../task/create-lifecycle-averages-classic.md)**  
...
-   **[Add a software client access record in Software Asset Management classic](../task/t_AddAClientAccessRec.md)**  
...
-   **[Add a custom software product in Software Asset Management classic](../task/t_AddACustomProduct.md)**  
...
-   **[View publisher part number \(PPN\) suggestions in Software Asset Management classic](../task/View-customppn-classic.md)**  
