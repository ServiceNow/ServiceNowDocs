...
3.  Integrate with an inventory tool for installation usage data.
    ...
    -   For integrating with Microsoft SCCM, complete the steps in the Service Graph Connector for Microsoft SCCM topic and all subtopics.
    -   For integrating with ServiceNow Agent Client Collector \(ACC\), complete the steps in the Agent Client Collector installation topic and all subtopics.
    ...
    -   For integrating with Jamf for MAC OS devices, complete the steps in the Service Graph Connector for Jamf topic and all subtopics.
