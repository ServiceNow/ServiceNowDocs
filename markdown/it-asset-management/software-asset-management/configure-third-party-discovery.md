...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/configure-third-party-discovery.html
release: yokohama
...
4.  Send the payload to the ServiceNow instance using the IRE REST API.
    ...
    For information on a sample payload, see [Sample payload for generic software install records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/payload-details.md).
