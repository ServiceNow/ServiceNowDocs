...
Only Microsoft 365 software products that are recognized as subscription software are shown. [Microsoft Office 365 integration](../concept/integrate-with-microsoft.md#) must be set up to view compliance information.
