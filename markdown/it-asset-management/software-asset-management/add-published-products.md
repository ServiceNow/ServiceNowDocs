...
breadcrumb: [Manage phase-wise Software Asset Management implementation, License operations view, Using Software Asset Workspace, Software Asset Management, IT Asset Management]
---
...
**Note:** To view accurate data on the reports, you must run software reconciliation whenever the following occur:
