...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/view-entitlement-import-errors.html
release: yokohama
...
9.  Select an import error record to view its errors.
    ...
    The Entitlement Import Errors page appears. For a detailed description of the entitlement import error fields, see [Entitlement import error fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/entitlement-import-error-fields.md).

10. Correct the errors and then select **Import**.

    The entitlement is successfully created. For more information on resolving errors, see [Entitlement import error actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/software-asset-management/import-software-rights-form.md).
