...
2.  [Import a certificate for the MID Server](https://www.servicenow.com/docs/access?context=add-ssl-certificates&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
2.  From your ServiceNow instance, navigate to **System Definition** &gt; **Certificates** and create a [certificate](https://www.servicenow.com/docs/access?context=t_UploadACertificateToAnInstance&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) \(Trust Store Cert, PEM format\).
