...
**Parent Topic:**[Request the IBM License Compliance for Software Asset Management application for authorized Software Asset Management provider integrations](../task/request-ibm-license-compliance-sam-application.md)
