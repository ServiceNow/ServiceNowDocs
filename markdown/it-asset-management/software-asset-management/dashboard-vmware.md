...
-   [vCenter probe](https://www.servicenow.com/docs/access?context=vcenter-probes&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US) VMware — vCenter ESX Hosts License
...
For more information, see [vCenter discovery with Software Asset Management](https://www.servicenow.com/docs/access?context=r_VCenterDataCollected&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
