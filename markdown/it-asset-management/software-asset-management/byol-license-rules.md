...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/byol-license-rules.html
release: xanadu
...
-   Enough eligible core licenses must be allocated to cover all cores on the virtual machines that are running.
