...
The User Device License Consumption \[samp\_user\_device\_license\_consumption\] table is populated with the CAL usage logging data for the Windows Server. This data comes from ServiceNow Discovery.
