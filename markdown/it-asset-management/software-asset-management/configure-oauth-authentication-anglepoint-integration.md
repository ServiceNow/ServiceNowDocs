...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/configure-oauth-authentication-anglepoint-integration.html
release: zurich
...
breadcrumb: [Configuring the API authentication method, Creating a connection for the Anglepoint integration, CVA integrations, Software Asset Management publisher pack for IBM, Supported software publisher licenses, Software Asset Management, IT Asset Management]
---
...
1.  From your ServiceNow instance, create an OAuth API endpoint.
    ...
    Refer to [Create an endpoint for clients to access the instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/t_CreateEndpointforExternalClients.md) for instructions on how to create an OAuth API endpoint.
...
**Parent Topic:**[Configuring the API authentication method for the Anglepoint integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/configuring-auth-method-anglepoint-integration.md)
