...
1.  From your ServiceNow instance, create an OAuth API endpoint.
    ...
    Refer to [Create an endpoint for clients to access the instance](https://www.servicenow.com/docs/access?context=t_CreateEndpointforExternalClients&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) for instructions on how to create an OAuth API endpoint.
