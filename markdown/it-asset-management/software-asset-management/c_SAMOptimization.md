...
Software reclamation is integrated with Workflow and [Client Software Distribution](https://www.servicenow.com/docs/access?context=c_ClientSoftwareDistribution&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) \(CSD\) to automate the process of uninstalling software from devices and reclaiming those software rights. During the workflow, the state of the removal candidate changes based on the progression within the workflow.
