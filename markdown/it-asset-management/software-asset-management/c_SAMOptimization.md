...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/software-asset-management/c\_SAMOptimization.html
release: zurich
...
Software reclamation is integrated with Workflow and [Client Software Distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/c_ClientSoftwareDistribution.md) \(CSD\) to automate the process of uninstalling software from devices and reclaiming those software rights. During the workflow, the state of the removal candidate changes based on the progression within the workflow.
...
[View or create software usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/view-sw-usage-workspace.md)

[Reclaim software](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/software-asset-management/reclaiming-software-sam.md)
