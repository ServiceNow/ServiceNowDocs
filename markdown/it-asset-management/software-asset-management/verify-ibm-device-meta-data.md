...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/software-asset-management/verify-ibm-device-meta-data.html
release: yokohama
...
5.  If any of the following meta data is incorrect, update it.
    ...
    **Note:** You cannot update the Device, PVU Comment, and IBM PVU mapping meta data.
    ...
    2.  When prompted, enter or select the correct value and then select the Save icon \(\[Omitted image "save-icon.png"\] Alt text: Save icon.\).
