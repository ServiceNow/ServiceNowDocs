...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/software-asset-management/complete-eol-workflow-request.html
release: xanadu
...
6.  Complete the first task, which is the Assess IT architecture impact task.
    ...
    2.  On the **Details** tab of the Assess IT architecture impact task, fill in the fields.
        ...
        For details on the form fields and their description, see [Software EOL tasks tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/software-asset-management/software-eol-request.md).
...
12. Select the change request and review the values that are automatically populated in the Change Request form.
    ...
    For details on completing a change request, see [Process a change request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/change-management/t_ProcessAChangeRequest.md).
