...
1.  Create a project in the Adobe Developer Console to access the Adobe APIs.
...
One of the following roles in combination can create Adobe Cloud integration profile using JWT credentials:
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d48377e375">

Interface

</th><th align="left" id="d48377e378">

Action

</th></tr></thead><tbody><tr><td id="d48377e384">
...
4.  Right-click the Integration Profile form header and then select **Save**.

5.  After the form reloads, select the **Validate Adobe Credential** related link to complete the connection.
