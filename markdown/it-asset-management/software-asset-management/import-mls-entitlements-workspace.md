...
7.  If your entitlement import contains any errors, identify and resolve those errors.
    ...
    2.  Use one or both of the following options to resolve your import errors:
        ...
        -   Resolve errors in which imported Microsoft SA or Step-up entitlements are not assigned to any base entitlements.
            ...
            2.  From the list of available Microsoft SA or Step-up entitlements, select the entitlement that you want to assign to a base entitlement.
                ...
                The corresponding software entitlement record opens in a new tab.

            3.  Select **Publish**.
            4.  After the form reloads, select the Related Entitlements related list and then select **New**.
...
Number of rights that you want to grant to the base entitlement.
...
Microsoft SA or Step-up entitlement that you are assigning to the base entitlement. This field populates automatically.
...
Base entitlement that you want to assign your Microsoft SA or Step-up entitlement to.**Note:** If an appropriate base entitlement is not available for the specified Microsoft SA or Step-up entitlement, you can create one.
