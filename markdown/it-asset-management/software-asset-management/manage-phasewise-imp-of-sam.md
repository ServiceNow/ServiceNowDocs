...
-   **[Set the domain-specific property to publish your software products](../task/set-domain-specific-publish.md)**  
...
-   **[Publish a specific set of your software products](../task/add-published-products.md)**  
...
-   **[Remove published software products](../task/remove-published-products.md)**  
