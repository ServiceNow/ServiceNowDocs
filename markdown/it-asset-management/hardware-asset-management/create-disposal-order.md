...
To add the consumables to a disposal order, select **Mark for disposal**. This will set the Planned for disposal field to **true**. For more details, see [Plan disposal of consumable assets](dispose-consumables.md).
...
<table id="choicetable_l5h_scg_kyb"><thead><tr><th align="left" id="d278271e116">

Interface

</th><th align="left" id="d278271e119">

Action

</th></tr></thead><tbody><tr><td id="d278271e125">
