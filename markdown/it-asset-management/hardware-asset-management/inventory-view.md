...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/hardware-asset-management/inventory-view.html
release: xanadu
...
To create an asset audit for your inventory, select **New asset audit**. For more details, see [Audit your inventory](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/hardware-asset-management/audit-your-inventory.md).
