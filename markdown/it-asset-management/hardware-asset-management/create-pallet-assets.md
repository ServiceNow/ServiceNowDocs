...
You must create a model for a pallet asset. For more information, see [Models](https://www.servicenow.com/docs/access?context=c_Models&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
