...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/locate-and-pick-hardware-asset-using-mobile-app.html
release: yokohama
