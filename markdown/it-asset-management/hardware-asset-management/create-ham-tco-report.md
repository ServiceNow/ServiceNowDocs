...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/hardware-asset-management/create-ham-tco-report.html
release: xanadu
...
-   **[Create a TCO report source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/hardware-asset-management/create-tco-report-source-ham.md)**  
Create a Total Cost of Ownership \(TCO\) report source for TCO reports.

**Parent Topic:**[Configure the Total Cost of Ownership of assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/hardware-asset-management/configure-ham-tco.md)
