...
breadcrumb: [Manage Service Catalog items for the Zero Touch request flow, Configure Zero Touch request flow, Integrations and advanced configuration, Configure, Hardware Asset Management, IT Asset Management, Asset Management]
---
...
5.  On the form, fill in the fields.
    ...
    For details on the form fields, see [Service Catalog variable form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/hardware-asset-management/service-catalog-var-form-fields.md).
...
[Associate a catalog item with a remote record producer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/hardware-asset-management/associate-catalog-item-with-record-producer.md).
