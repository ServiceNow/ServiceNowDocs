...
**Note:** Every Sunday, the license count for the managed IT resource types is calculated. Any changes to the license consumption reflect on the ITAM license report only after the monthly license count calculation.
