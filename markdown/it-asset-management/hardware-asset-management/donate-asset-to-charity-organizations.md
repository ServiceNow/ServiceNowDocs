...
-   **[Create an Asset Donation Order](../task/create-asset-donation-order.md)**  
...
-   **[Approve or reject an Asset Donation Order](../task/approve-reject-asset-donation-order.md)**  
As an asset manager, review and then approve or reject an Asset Donation Order.
-   **[Process an Asset Donation Order](../task/process-asset-donation-order.md)**  
Process an Asset Donation Order to prepare and send assets to a charity organization.
-   **[Add a charity organization for donating assets](../task/add-charity-org.md)**  
...
[Exclude assets](../task/exclude-assets.md)
...
[Audit your inventory](../task/audit-your-inventory.md)
