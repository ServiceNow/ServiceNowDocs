...
breadcrumb: [Playbook for asset attestation, Audit your hardware assets by using Asset Attestation, Attestation and conformance, Use, Hardware Asset Management, IT Asset Management, Asset Management]
---
...
3.  From the list of schedules, select the one where you have incomplete activities in the playbook.
...
Complete all the pending activities in the playbook. For details, see [Create an asset attestation or a schedule using the playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/hardware-asset-management/create-attestation-using-playbook.md).

**Parent Topic:**[Playbook for asset attestation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/hardware-asset-management/playbook-asset-attestation-ham.md)
