...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/hardware-asset-management/process-asset-donation-order.html
release: zurich
...
9.  Attach the donation documentation from the charity organization to the Asset Donation Order record.
    ...
    2.  In the Details related list, select the Attachment icon \[Omitted image "paper-clip-icon.png"\] Alt text: Attachment icon.
