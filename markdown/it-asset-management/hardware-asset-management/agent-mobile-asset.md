...
On the app, you can use the same functionalities when you are offline. For more information, see [Offline mode](https://www.servicenow.com/docs/access?context=mobile-offline-mode&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US).
