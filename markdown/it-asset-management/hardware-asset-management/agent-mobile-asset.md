...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/agent-mobile-asset.html
release: yokohama
...
breadcrumb: [Mobile app for Hardware Asset Management, Exploring Hardware Asset Management, Hardware Asset Management, IT Asset Management]
---
...
**Parent Topic:**[Mobile app for Hardware Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/mobile-my-asset.md)
...
1.  Navigate to **Asset** and tap **Create Asset**.
    ...
    \[Omitted image "AgentAssetHome.png"\] Alt text: Agent Mobile Asset home screen
...
4.  Tap the **PO Line Items** asset that you ordered and swipe **Receive** to receive the asset.
    ...
    \[Omitted image "receive-asset.png"\] Alt text: Swipe Receive on the Purchase Order Line Items page
...
On the app, you can use the same functionalities when you are offline. For more information, see [Offline mode](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/mobile/mobile-offline-mode.md).
...
5.  Enter the vendor details and the scheduled date by using your Hardware Asset Management instance.
    ...
    See [Create a disposal order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/create-disposal-order.md).
