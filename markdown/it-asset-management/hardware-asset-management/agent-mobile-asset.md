...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-asset-management/hardware-asset-management/agent-mobile-asset.html
release: australia
...
5.  Enter the vendor details and the scheduled date by using your Hardware Asset Management instance.
    ...
    See [Create a disposal order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/hardware-asset-management/create-disposal-order.md).
