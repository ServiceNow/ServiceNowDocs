...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/hardware-asset-management/agent-mobile-asset.html
release: zurich
...
On the app, you can use the same functionalities when you are offline. For more information, see [Offline mode](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/mobile/mobile-offline-mode.md).
...
5.  Enter the vendor details and the scheduled date by using your Hardware Asset Management instance.
    ...
    See [Create a disposal order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/hardware-asset-management/create-disposal-order.md).
