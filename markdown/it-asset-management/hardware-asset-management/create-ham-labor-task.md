...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/hardware-asset-management/create-ham-labor-task.html
release: zurich
...
Filter to determine whether the **Use time worked** option applies to this rate card. For more information, see [Create a task rate card in Hardware Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/hardware-asset-management/create-ham-task-rate-card.md).This field uses the Condition Count widget to preview what records would be returned by the conditions.
