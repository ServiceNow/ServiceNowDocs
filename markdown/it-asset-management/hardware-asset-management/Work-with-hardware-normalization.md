...
**Note:** This documentation is for Hardware Model Normalization. For additional information on Asset Management, see the [Asset Management documentation](https://www.servicenow.com/docs/access?context=c_AssetManagement&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
