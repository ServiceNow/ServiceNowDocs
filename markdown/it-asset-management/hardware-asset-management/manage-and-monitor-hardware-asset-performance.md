...
-   **[Configure settings to monitor asset key performance indicators \(KPIs\) in the Hardware Asset Workspace](configure-kpi-settings-ham.md)**  
...
-   **[Monitor hardware asset performance with Asset KPIs report](../task/view-availability-for-hardware-aaset.md)**  
Track the asset availability and related KPI values in the report to see how well a hardware asset is performing.
-   **[View the total time worked on all tasks related to a hardware asset](../task/view-total-time-spent-on-asset-ham.md)**  
