...
The Service Exchange application must be installed on your instance. For more information, see [Install Service Bridge for customers](https://www.servicenow.com/docs/access?context=install-service-bridge-v2-customer&version=xanadu&pubname=xanadu-service-bridge&ft:locale=en-US).
