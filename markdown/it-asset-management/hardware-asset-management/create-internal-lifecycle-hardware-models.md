...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/hardware-asset-management/create-internal-lifecycle-hardware-models.html
release: zurich
...
<table id="choicetable_z1b_lpx_jjc"><thead><tr><th align="left" id="d295141e95">

Option

</th><th align="left" id="d295141e98">

Description

</th></tr></thead><tbody><tr><td id="d295141e104">
...
The Create New Consumable Model Lifecycle form is displayed.
    ...
    For field descriptions, see [Model lifecycle form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/hardware-asset-management/model-lifecycle-fields.md).
