...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/process-zero-touch-asset-request.html
release: yokohama
...
9.  Evaluate the old asset and select the appropriate status.
    ...
    2.  In the **Evaluation status**, mark the asset for reuse, repair, or ready for disposal.
        ...
        -   To mark the asset for repair, select **Needs repair**.
            ...
            This option initiates the [Return Merchandise Authorization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/return-merchandise-authorization.md) \(RMA\) flow.
...
**Parent Topic:**[Manage refresh of assets using Zero Touch Refresh](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/refresh-hardware-uisng-ztr.md)
