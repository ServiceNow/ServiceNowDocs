...
For more details on creating and fulfilling hardware asset requests through the Zero Touch request flow, see [Use Zero Touch request flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/hardware-asset-management/managing-standard-hw-req-ztr.md).
