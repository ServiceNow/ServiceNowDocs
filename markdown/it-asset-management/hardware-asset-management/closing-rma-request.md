...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/closing-rma-request.html
release: yokohama
...
**Parent Topic:**[Manage RMA requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/manage-rma-req.md)
...
4.  If the faulty asset could not be repaired on-site and you want to send it for an off-site repair, then do the following:
    ...
    3.  Click **Close task**.
        ...
        The Asset RMA Off-site flow is triggered and Shipment task is generated. See [Close an RMA request with off-site repair or replacement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/closing-rma-request.md) for details.
