...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/create-audit-using-mobile-app.html
release: yokohama
...
<table id="choicetable_bpk_mvc_whc"><thead><tr><th align="left" id="d145217e102">

Audit type

</th><th align="left" id="d145217e105">

Action

</th></tr></thead><tbody><tr><td id="d145217e111">
...
-   The audit result fields are displayed on the audit **Details** tab.
    ...
    For a detailed description of the audit result field values, see [Audit results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/audit-results.md).
