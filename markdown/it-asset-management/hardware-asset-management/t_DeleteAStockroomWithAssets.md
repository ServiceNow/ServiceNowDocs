...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/hardware-asset-management/t\_DeleteAStockroomWithAssets.html
release: xanadu
...
5.  After removing assets from the stockroom you want to delete, continue with the instructions for [deleting a stockroom with no assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/hardware-asset-management/t_DeleteAStockroomWithNoAssets.md).
