...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/hardware-asset-refresh.html
release: yokohama
...
5.  Select **Order Now**.
    ...
    You can't view an excluded asset. For more information, see [Hardware Asset Management license exclusion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/ham-license-exclusion.md).
...
<table id="choicetable_upl_qst_ywb"><thead><tr><th align="left" id="d266235e752">

Interface

</th><th align="left" id="d266235e755">

Action

</th></tr></thead><tbody><tr><td id="d266235e761">
