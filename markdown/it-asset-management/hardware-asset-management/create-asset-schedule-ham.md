...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/create-asset-schedule-ham.html
release: yokohama
...
Source table for the assets. You can select any of the following tables:-   Hardware \[alm\_hardware\]
-   Enterprise asset \[sn\_ent\_asset\]
