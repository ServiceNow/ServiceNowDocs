...
-   The Lenovo Spoke \(sn\_lenovo\_spoke\) installed on your ServiceNow instance from the ServiceNow Store. For detailed information, see [Lenovo Spoke](https://www.servicenow.com/docs/access?context=lenovo-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
