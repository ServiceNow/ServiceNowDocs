...
-   Stockroom receiving- Receive assets: View the list of all import records that were performed in any stockroom. For more details, see [Import and receive assets in bulk at your stockroom in the Hardware Asset Workspace](../task/import-assets-for-receive-ham.md).
...
[Request items source](https://www.servicenow.com/docs/access?context=c_SourcingRequestItems&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US)
