...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/hardware-asset-management/create-rtd-for-providers.html
release: xanadu
...
As a provider, you must have created a provider record. For more details, see [Set up a Service Exchange provider record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/service-exchange/service-bridge-v2-new-provider.md).
...
3.  On the form, fill in the fields.
    ...
    For the description of field values, see [Remote task definition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/service-exchange/service-bridge-v2-create-remote-tasks-defs.md).
...
7.  Create the inbound fields, which enable you to receive data from the customer's instance when a remote task is created or updated.
    ...
    2.  For each field you create, fill in the fields and then select **Submit**.
        ...
        For the required details of the inbound fields that you must create, see [Remote task definition inbound and outbound fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/hardware-asset-management/inbound-outbound-fields-for-rtd.md).
...
8.  Create the outbound fields, which enable you to send data to the customer's instance when a remote task is created or updated.
    ...
    2.  For each field you create, fill in the fields and then select **Submit**.
        ...
        For the required details of the outbound fields that you must create, see [Remote task definition inbound and outbound fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/hardware-asset-management/inbound-outbound-fields-for-rtd.md).
