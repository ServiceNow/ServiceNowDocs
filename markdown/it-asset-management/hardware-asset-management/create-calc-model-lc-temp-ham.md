...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/hardware-asset-management/create-calc-model-lc-temp-ham.html
release: xanadu
...
[Associate a hardware model with a Calculated lifecycle template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/hardware-asset-management/associate-hardware-model-cal-temp.md).

**Parent Topic:**[Manage the lifecycle of hardware models with calculated lifecycle templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/hardware-asset-management/manage-ham-lifecycle-temp.md)
