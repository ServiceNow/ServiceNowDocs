...
5.  Add base, hardware, and bundle assets to the pallet.
    ...
    **Note:** Only the substate of pre-allocated assets isn't synced with the pallet. For more information, see [Create pre-allocated assets](https://www.servicenow.com/docs/access?context=t_CreatingPreAllocatedAssets&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
