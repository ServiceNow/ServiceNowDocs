...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/hardware-asset-management/add-assets-to-pallet.html
release: zurich
...
5.  Add base, hardware, and bundle assets to the pallet.
    ...
    **Note:** Only the substate of pre-allocated assets isn't synced with the pallet. For more information, see [Create pre-allocated assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/asset-management/t_CreatingPreAllocatedAssets.md).
