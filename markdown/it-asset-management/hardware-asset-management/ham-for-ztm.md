...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/ham-for-ztm.html
release: yokohama
...
-   The following Hardware Asset Management features aren't available:
    ...
    **Note:** HAM Guided Setup is available. However, it isn't required to run the setup.
    ...
    For more information on the Hardware Asset Management workflows and features, see [Hardware Asset Management subscription](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/ham-subscription.md).
...
-   [Stock order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/create-inventory-stock-order.md)
-   [Advanced Shipment Notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/advanced-shipment-notification.md)
-   [Standard Asset Request flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/hardware-request-flow.md)
-   [Shipment carrier integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/integrating-with-third-party-carrier-apps.md)
-   [Advanced inventory and distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/associate-stockroom-with-distribution-channels.md)
-   [Asset reclamation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/reclaim-asset.md)
...
-   [Lease expiration flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/manage-your-leased-hw-asts-expiring-contract.md): Non-mobile devices are excluded from this flow.
-   [Hardware Asset Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/using-ham-workspace.md): Reports and dashboards related to normalization of assets aren't available.

**Related topics**  


[Exploring Hardware Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/exploring-ham.md)
