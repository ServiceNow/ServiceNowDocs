...
4.  Return to CMDB success advisor and proceed with selecting model categories.
    ...
    For more information, see [Getting started with HAM advisor dashboard setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/hardware-asset-management/cmdb-sa-ham-get-started.md).
