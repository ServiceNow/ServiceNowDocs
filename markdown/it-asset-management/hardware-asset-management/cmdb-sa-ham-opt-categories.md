...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/hardware-asset-management/cmdb-sa-ham-opt-categories.html
release: zurich
...
4.  Return to CMDB success advisor and proceed with selecting model categories.
    ...
    For more information, see [Getting started with HAM advisor dashboard setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/hardware-asset-management/cmdb-sa-ham-get-started.md).
