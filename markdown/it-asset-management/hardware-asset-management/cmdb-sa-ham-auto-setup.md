...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/hardware-asset-management/cmdb-sa-ham-auto-setup.html
release: zurich
...
-   The instance has a HAM Pro entitlement. See [Hardware Asset Management licensing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/hardware-asset-management/ham-licensing.md).
...
For instructions on updating model categories, see [Optimize the HAM advisor dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/hardware-asset-management/cmdb-sa-ham-optimize-dashboard.md).
