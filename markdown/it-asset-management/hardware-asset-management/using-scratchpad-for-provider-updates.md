...
You must include the code specific to your tasks in the **PSBScratchpadUtil** API. For more information, see [Using the Scratchpad for Service Exchange tasks](https://www.servicenow.com/docs/access?context=service-bridge-v2-scratchpad&version=australia&pubname=australia-service-bridge&ft:locale=en-US). Confirm that the Scratchpad codes associated with the tasks of your request fulfillment flow are in the following format.
