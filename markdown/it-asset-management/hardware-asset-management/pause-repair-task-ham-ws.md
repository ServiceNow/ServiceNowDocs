...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/pause-repair-task-ham-ws.html
release: yokohama
...
You can pause an asset repair task that is in the Work in Progress state. The option to pause the task is available only after you perform the following actions for the asset repair task:
