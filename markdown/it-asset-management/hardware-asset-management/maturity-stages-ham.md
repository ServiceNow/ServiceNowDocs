...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/maturity-stages-ham.html
release: yokohama
...
|Stage|Description|
|-----|-----------|
|Crawl|Begin your HAM journey, such as implementing or developing a new HAM program. At this stage, you can define models, create stockrooms, identify tools to discover data, and establish processes and roles. You can set up a normalization process to normalize models and get the date or time of asset lifecycles.|
