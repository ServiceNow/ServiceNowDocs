...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-asset-management/hardware-asset-management/daas-workspace.html
release: australia
...
For more information about the DaaS feature, see [Device as a Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/hardware-asset-management/exploring-daas.md).
...
-   Create and manage [inbound asset orders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/hardware-asset-management/manage-inbound-orders.md), [RMA response orders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/hardware-asset-management/manage-rma-orders.md), and [repair order lines](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/hardware-asset-management/requesting-hardware-asset-repair.md) for the DaaS assets of your customers.
...
For more information, see [Managing inbound asset orders for DaaS assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/hardware-asset-management/manage-inbound-orders.md).
...
For more information, see [Managing RMA response orders for DaaS assets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/hardware-asset-management/manage-rma-orders.md).
