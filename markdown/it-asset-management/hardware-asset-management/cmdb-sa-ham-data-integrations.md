...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/hardware-asset-management/cmdb-sa-ham-data-integrations.html
release: yokohama
...
For a quick reference to improve HAM data coverage, see [Data integration checklist for HAM in CMDB success advisor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/hardware-asset-management/cmdb-sa-ham-integ-checklist.md).

## Access data integrations

Navigate to the CMDB success advisor, and on the HAM card, select **View insights**. Select the **Data integrations** tab. To access the dashboard, see .
