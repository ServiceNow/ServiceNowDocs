...
<table id="choicetable_c1z_jby_3gc"><thead><tr><th align="left" id="d171733e110">

Option

</th><th align="left" id="d171733e113">

Description

</th></tr></thead><tbody><tr><td id="d171733e119">
...
3.  On the hardware model form, select the Additional actions ![Additional actions](../image/additional-actions.png) icon and then select **Export XML \(This record\)**.
4.  Save the exported hardware model XML file on your local system.


</td></tr><tr><td id="d171733e167">
...
3.  On the software model form, select the Additional actions ![Additional actions](../image/additional-actions.png) icon and then select **Export XML \(This record\)**.
...
<table id="choicetable_z4t_ldy_3gc"><thead><tr><th align="left" id="d171733e281">

Option

</th><th align="left" id="d171733e284">

Description

</th></tr></thead><tbody><tr><td id="d171733e290">
...
3.  Select Column options s ![Column options](../image/column-options.png) icon and then select **Import XML**.
