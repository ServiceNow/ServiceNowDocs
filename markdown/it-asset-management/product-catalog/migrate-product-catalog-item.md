...
<table id="choicetable_c1z_jby_3gc"><thead><tr><th align="left" id="d148619e110">

Option

</th><th align="left" id="d148619e113">

Description

</th></tr></thead><tbody><tr><td id="d148619e119">
...
<table id="choicetable_z4t_ldy_3gc"><thead><tr><th align="left" id="d148619e281">

Option

</th><th align="left" id="d148619e284">

Description

</th></tr></thead><tbody><tr><td id="d148619e290">
...
3.  Select Column options ![Column options](../image/column-options.png) and then select **Import XML**.
4.  Select **Choose File** and select the hardware model record XML file saved previously in Step 1.
5.  Select **Upload**.


</td></tr><tr><td id="d148619e353">
