...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/product-catalog/migrate-product-catalog-item.html
release: zurich
...
<table id="choicetable_c1z_jby_3gc"><thead><tr><th align="left" id="d179151e110">

Option

</th><th align="left" id="d179151e113">

Description

</th></tr></thead><tbody><tr><td id="d179151e119">
...
3.  On the hardware model form, select the Additional actions \[Omitted image "additional-actions.png"\] Alt text: Additional actions icon and then select **Export XML \(This record\)**.
4.  Save the exported hardware model XML file on your local system.


</td></tr><tr><td id="d179151e167">
...
3.  On the software model form, select the Additional actions \[Omitted image "additional-actions.png"\] Alt text: Additional actions icon and then select **Export XML \(This record\)**.
...
<table id="choicetable_z4t_ldy_3gc"><thead><tr><th align="left" id="d179151e281">

Option

</th><th align="left" id="d179151e284">

Description

</th></tr></thead><tbody><tr><td id="d179151e290">
...
3.  Select Column options s \[Omitted image "column-options.png"\] Alt text: Column options icon and then select **Import XML**.
...
**Parent Topic:**[Product catalog items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/product-catalog/c_ManagingProductCatalogItems.md)
