...
-   **[Tables installed with Product Catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/product-catalog/r_TablesProductCatalog.md)**  
Product Catalog plugin adds the following tables.
-   **[Roles installed with Product Catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/product-catalog/r_RolesProductCatalog.md)**  
Product Catalog plugin adds the following roles.
-   **[Script includes installed with Product Catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/product-catalog/r_ScriptIncludesProductCatalog.md)**  
Product Catalog plugin adds the following script include.
-   **[Client scripts installed with Product Catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/product-catalog/r_ClientScriptsProductCatalog.md)**  
Product Catalog plugin adds the following client script.
-   **[Business rules installed with Product Catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/product-catalog/r_BusinessRulesProductCatalog.md)**  
