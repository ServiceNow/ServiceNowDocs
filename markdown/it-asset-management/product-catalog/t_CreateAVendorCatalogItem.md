...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/product-catalog/t\_CreateAVendorCatalogItem.html
release: zurich
...
-   **[Link an item to the hardware catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/product-catalog/t_LinkAnItemToTheHardwareCatalog.md)**  
After you create a vendor catalog item, link the item to the hardware catalog for viewing.
-   **[Link an item to the software catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/product-catalog/t_LinkAnItemToTheSoftwareCatalog.md)**  
After you create a vendor catalog item, link the item to the software catalog for viewing.
-   **[Publish an item to the hardware catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/product-catalog/t_PublishAnItemToTheHardwareCatalog.md)**  
...
-   **[Publish an item to the software catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/product-catalog/t_PublishAnItemToTheSoftwareCatalog.md)**  
...
**Parent Topic:**[Vendor catalog items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/product-catalog/c_ManageVendorCatalogItems.md)
