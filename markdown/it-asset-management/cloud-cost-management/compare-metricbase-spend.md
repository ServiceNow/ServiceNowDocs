...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/cloud-cost-management/compare-metricbase-spend.html
release: xanadu
...
Request the MetricBase \[com.snc.clotho\] plugin. For more information, see [Requesting the MetricBase product](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/metricbase/request-metricbase.md).
