...
1.  Follow the instructions in [Add an Azure service account](https://www.servicenow.com/docs/access?context=azure-service-account-cloud-mgt&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
