...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/cloud-cost-management/create-azure-exports.html
release: zurich
...
8.  Select the edit icon \[Omitted image "workspace-icon-edit.png"\] Alt text: Edit credentials icon. next to the export name that you want to edit.
