...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/cloud-cost-management/reserve-plan-using.html
release: zurich
...
You can also [configure Reservation/Saving plans operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/cloud-cost-management/reserve-plan-using.md) by selecting **Settings**.
