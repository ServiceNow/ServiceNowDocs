...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/cloud-cost-management/reserve-plan-using.html
release: yokohama
...
Resources that would benefit most in reservation plans. Review the list and decide the conversion to reservation plans by moving a resource to one of the other tabs by selecting the appropriate action.
...
You can also [configure Reservation/Saving plans operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/cloud-cost-management/reserve-plan-using.md) by selecting **Settings**.
