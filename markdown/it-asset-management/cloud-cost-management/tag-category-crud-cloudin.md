...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/cloud-cost-management/tag-category-crud-cloudin.html
release: zurich
...
2.  On the Tag Categories list, select **New**.
    ...
    For the list of default tag categories, see [List of default tag categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/cloud-cost-management/default-tag-categories.md).
...
The list of tag names that you can add to the category.1.  Select the Lookup icon \[Omitted image "search-icon.png"\] Alt text: Search icon. to open the list of tag names that came with the latest Billing Download Job. All tag names appear on the Tag Names list.
