...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-asset-management/cloud-cost-management/tag-category-crud-cloudin.html
release: australia
...
2.  On the Tag Categories list, select **New**.
    ...
    For the list of default tag categories, see [List of default tag categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/cloud-cost-management/default-tag-categories.md).
...
-   **[Select a tag category source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-asset-management/cloud-cost-management/select-tag-category-source.md)**  
