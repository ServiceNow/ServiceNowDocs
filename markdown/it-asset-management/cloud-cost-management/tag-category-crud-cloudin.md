...
The list of tag names that you can add to the category.1.  Select the Lookup icon ![Lookup icon](../image/icon-lookup.png) to open the list of tag names that came with the latest Billing Download Job. All tag names appear on the Tag Names list.
...
6.  On the **Tag names** list, select the Lookup icon ![Lookup icon](../image/icon-lookup.png) to add multiple tag names.
