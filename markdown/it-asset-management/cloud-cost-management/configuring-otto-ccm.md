...
# Configuring ServiceNow Otto for Cloud Cost Management \(CCM\)

Configure the ServiceNow Otto for Cloud Cost Management application to use the generative AI skills for spend summarization.
