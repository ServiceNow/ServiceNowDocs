...
3.  On the Budget policy creation form, fill in the fields.
    ...
    For a description of the field values, see [List of Budget policy creation fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/cloud-cost-management/budget-policy-fields.md).
