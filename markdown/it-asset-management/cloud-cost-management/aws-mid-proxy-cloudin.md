...
[Proxy server configuration for MID Servers used for Cloud Discovery and Cloud Provisioning and Governance](https://www.servicenow.com/docs/access?context=mid-server-proxy&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US)
