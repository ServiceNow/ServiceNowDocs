...
-   [Configure the MID Server for AWS IAM role](https://www.servicenow.com/docs/access?context=config-mid-iam-roles&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).
