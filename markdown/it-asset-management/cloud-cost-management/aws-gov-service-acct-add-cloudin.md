...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/cloud-cost-management/aws-gov-service-acct-add-cloudin.html
release: zurich
...
Name of the credentials that you created in the [Create an AWS IAM user policy for Cloud Cost Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/cloud-cost-management/aws-user-policy-create-cloudin.md) procedure.
