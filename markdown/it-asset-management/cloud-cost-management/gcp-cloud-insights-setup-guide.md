...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/cloud-cost-management/gcp-cloud-insights-setup-guide.html
release: yokohama
...
\[Omitted image "icon-certificate.png"\] Alt text: Little badge image Set up access to Google Cloud.
