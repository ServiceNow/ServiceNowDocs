...
To securely access data on your provider account, the Discovery process must present appropriate credentials. To make the credentials available to Discovery, you first create Google Cloud credentials in the Google Cloud portal. You then securely store the credentials in a serviceaccount in your instance.
