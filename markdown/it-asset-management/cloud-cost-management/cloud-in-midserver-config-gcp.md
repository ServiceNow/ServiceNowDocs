...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/cloud-cost-management/cloud-in-midserver-config-gcp.html
release: xanadu
...
You can use a proxy server for the Cloud Cost Management MID Server. See [Proxy server configuration for Cloud Cost Management MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/cloud-cost-management/gcp-mid-proxy-cloudin.md).
