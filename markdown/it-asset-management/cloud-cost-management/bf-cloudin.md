...
1.  Apply each budget plan to billing data. For more information about plans, see are described in [Create or update a budget policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-asset-management/cloud-cost-management/manage-cloud-budgets.md).
