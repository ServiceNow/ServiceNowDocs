...
The **Short description**, **Description**, **Assignment group**, and **Affected CIs** fields are auto populated. For more information, see [Create a change request](https://www.servicenow.com/docs/access?context=t_CreateAChange&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
...
[Standard change catalog](https://www.servicenow.com/docs/access?context=c_StandardChangeCatalogPlugin&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US)

[Create a change request template](https://www.servicenow.com/docs/access?context=create-a-change-request-template&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US)
