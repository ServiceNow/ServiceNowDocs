...
The **Short description**, **Description**, **Assignment group**, and **Affected CIs** fields are auto populated. For more information, see [Create a change request](https://www.servicenow.com/docs/access?context=t_CreateAChange&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
...
This field appears only when the **Approval type** is selected as **Auto approval**.
 ...
 Change request template \(Standard Change type\) to be used. If no template appears in the list, you must create one. See [Create a change request template](https://www.servicenow.com/docs/access?context=create-a-change-request-template&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
...
[Standard change catalog](https://www.servicenow.com/docs/access?context=c_StandardChangeCatalogPlugin&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US)

[Create a change request template](https://www.servicenow.com/docs/access?context=create-a-change-request-template&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US)
