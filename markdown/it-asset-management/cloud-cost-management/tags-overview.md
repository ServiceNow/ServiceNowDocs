...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/cloud-cost-management/tags-overview.html
release: yokohama
...
-   To apply the latest tag category definitions to cost data without waiting for the next Billing Download job, you can manually reapply the categories. To reapply tag categories, navigate to **Cloud Cost Management Workspace** &gt; **Operations** &gt; **Cost usage tags** &gt; **Tag categories** &gt; **Reapply tag categories**.
