...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/cloud-cost-management/enable-cost-allocation-kc-gcp.html
release: xanadu
...
2.  Select the hamburger icon \(\[Omitted image "Form\_MenuIcon.png"\] Alt text: Hamburger\).
