...
Users or groups to notify by email when the spend for unused resources exceeds the specified percentage of overall cloud spend.
 ...
 For information on configuring the email, see [Create an email template](https://www.servicenow.com/docs/access?context=t_CreateAnEmailTemplate&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
