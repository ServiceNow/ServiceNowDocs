...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/cloud-cost-management/rs-change-job-cloudin.html
release: yokohama
...
Change request template \(Standard Change type\) to be used. If no template appears in the list, you must create one. See [Create a change request template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/change-management/create-a-change-request-template.md).
