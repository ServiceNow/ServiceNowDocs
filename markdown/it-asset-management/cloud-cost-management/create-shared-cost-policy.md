...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/cloud-cost-management/create-shared-cost-policy.html
release: yokohama
...
4.  On the Shared Cost Allocation Policy Creation form, fill in the fields.
    ...
    For a description of the field values, see [List of Shared cost allocation policy fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/cloud-cost-management/shared-cost-allocation-policy-fields.md).
