...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/cloud-cost-management/manage-unused-mac.html
release: xanadu
...
You can [configure Unused resources operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/cloud-cost-management/um-settings-config-cloudin.md) by selecting **Settings**.
...
</table>-   **[Configure Unused resources operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/cloud-cost-management/um-settings-config-cloudin.md)**  
...
-   **[Schedule unused resources to be powered off or terminated](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/cloud-cost-management/um-schedule-job-cloudin.md)**  
...
-   **[Move a resource to a different Unused resources job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/cloud-cost-management/um-change-job-cloudin.md)**  
You can add resources to a currently scheduled job, move resources from one job to another, or remove resources from a job.
-   **[Exclude a resource from Unused resources analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/cloud-cost-management/um-exclude-resource-cloudin.md)**  
...
-   **[View or edit scheduled and completed Unused resources jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/cloud-cost-management/view-um-scheduled-jobs.md)**  
