...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-asset-management/cloud-cost-management/rs-settings-config-cloudin.html
release: yokohama
...
Users or groups to notify by email when the spend for incorrectly sized resources exceeds the specified percentage of overall cloud spend. For information on configuring the email, see Create an email template.
...
-   **[Specify rate discounts to enable accurate pricing for Rightsizing recommendations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/cloud-cost-management/discounts-specify-cloudin.md)**  
...
-   **[Define a metric threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-asset-management/cloud-cost-management/define-metric-threshold.md)**  
