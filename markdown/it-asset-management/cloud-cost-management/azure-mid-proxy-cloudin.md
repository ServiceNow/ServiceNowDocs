...
breadcrumb: [Configuring access to CI data on your Microsoft Azure account, Configure Cloud Cost Management for Microsoft Azure, Configure, Cloud Cost Management, IT Asset Management]
---
