...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-asset-management/cloud-cost-management/azure-midserver-config-cloudin.html
release: xanadu
...
See [Azure Cloud Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/discovery/azure-cloud-discovery.md).
...
You can use a proxy server for the Cloud Cost Management MID Server. See [Proxy server configuration for your Cloud Cost Management MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-asset-management/cloud-cost-management/azure-mid-proxy-cloudin.md).
