...
-   When a user requests software through Service Catalog. For more information, see [Request a catalog item from Service Portal](https://www.servicenow.com/docs/access?context=request-cat-item-portal&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
