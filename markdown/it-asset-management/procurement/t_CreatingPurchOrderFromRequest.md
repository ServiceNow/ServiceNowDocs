...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/procurement/t\_CreatingPurchOrderFromRequest.html
release: zurich
product: Procurement
...
If you don't have the Sourcing and Procurement Operations \(SPO\) application, you can create a purchase order to obtain items and fulfill requests from the Service Catalog.
...
**Parent Topic:**[Sourcing items in a service catalog request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/procurement/c_SourcingRequestItems.md)
