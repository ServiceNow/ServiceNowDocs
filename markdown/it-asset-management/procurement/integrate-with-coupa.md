...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-asset-management/procurement/integrate-with-coupa.html
release: brazil
product: Procurement
...
-   Activate the Coupa spoke. For more information, see [Coupa Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/coupa-spoke.md).
-   Activate the Procurement plugin \(com.snc.procurement\). For more information, see [Activate Procurement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-asset-management/procurement/t_ActivateProcurement.md).
