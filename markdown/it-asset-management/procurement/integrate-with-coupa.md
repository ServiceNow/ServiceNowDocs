...
-   Activate the Coupa spoke. For more information, see [Coupa Spoke](https://www.servicenow.com/docs/access?context=coupa-spoke&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
