...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-asset-management/procurement/integrate-with-coupa.html
release: zurich
product: Procurement
...
-   Activate the Coupa spoke. For more information, see [Coupa Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/coupa-spoke.md).
-   Activate the Procurement plugin \(com.snc.procurement\). For more information, see [Activate Procurement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-asset-management/procurement/t_ActivateProcurement.md).
