...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/now-assist-for-creator/install-now-assist-for-creator.html
release: xanadu
...
-   Upgrade to Washington DC Patch 1 or later. For more information about this release, see [Available patches and hotfixes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/release-notes/available-versions.md).
-   Enable Next Experience. For information about activating Next Experience, see [Considerations for activating Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/next-experience-adoption-paths.md).
