...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/now-assist-for-creator/exploring-flow-recommendations.html
release: yokohama
...
\[Omitted image "image.flow-recommendations-diagramming-view"\] Alt text:
