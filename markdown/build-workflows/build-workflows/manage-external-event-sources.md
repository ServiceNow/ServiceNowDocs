...
Option to specify the script that generates or validates the hash.To know more about HMAC, see [Configure HMAC - Token-based authentication](https://www.servicenow.com/docs/access?context=configure-hmac&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
