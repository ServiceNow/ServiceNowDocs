...
Agentic Playbooks are powered by the **Playbook Activity Assist** agentic workflow \(See: Now Assist agentic workflows\). The workflow contains a range of AI agents designed to enhance user experience and productivity. These agents are categorized based on their functionality and the tasks they perform.
...
Gathers data by using ServiceNow Knowledge Graph.You can also use a custom knowledge graph schema for the agent. To know more about knowledge graphs, see Exploring Knowledge Graph
...
For more information about Now Assist AI agents and their capabilities, refer to Now Assist AI agents.
