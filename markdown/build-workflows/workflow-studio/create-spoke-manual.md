...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/create-spoke-manual.html
release: yokohama
...
**Note:** User with the action\_designer role cannot add actions by importing the Open API Specification.
