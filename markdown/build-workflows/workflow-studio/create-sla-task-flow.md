...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/create-sla-task-flow.html
release: xanadu
...
6.  Add actions, subflows, and flow logic to the flow.
    ...
    Add [SLA Percentage Timer actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/sla-percentage-timer-action.md) to specify what to do when a task record attached to an SLA reaches specific percentages of completion.
...
8.  [Create an SLA definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/service-level-management/t_CreateAnSLADefinition.md)
