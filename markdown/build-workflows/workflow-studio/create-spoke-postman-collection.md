...
4.  Click **Continue**.
    ...
    2.  Install the spoke from the Store.
        ...
        For more details, see [Install a ServiceNow Store application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_InstallApplications.md).
...
19. Click **Done: Go to spoke** to go the Spokes page and view the publish status.
    ...
    -   Actions with the OpenAPI step are created. For information about the OpenAPI step, see [OpenAPI support in the REST step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/open-api-integration.md).
