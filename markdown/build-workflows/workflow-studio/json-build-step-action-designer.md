...
-   **Output**
    ...
    JSON payload as a string. If you want to use the payload as an object, you can use the [JSON parser step](https://www.servicenow.com/docs/access?context=json-parser-step-action-designer&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) to parse the string.
