...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/add-dynamic-inputs-to-activity.html
release: zurich
...
Familiarize yourself with the other Workflow Studio components. [Dynamic inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/getting-started-dynamic-input.md) are created with actions and subflows:
...
2.  [Create an action to add an input.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/create-data-gathering-action-dynamic-inputs.md)
...
4.  [Create a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/create-subflow.md) with the new input.

5.  Navigate to **All** &gt; **Process Automation Administration** &gt; **Activity Definitions**.

6.  Open or [create the activity definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/create-activity-definition.md) to add the new input to.
