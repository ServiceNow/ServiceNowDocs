...
<table id="choicetable_e2d_3mv_21c"><thead><tr><th align="left" id="d158222e73">

View

</th><th align="left" id="d158222e76">

Steps

</th></tr></thead><tbody><tr><td id="d158222e82">
...
<table id="choicetable_n4l_ydt_vlb"><tbody><tr><td id="d158222e269">
...
For more information, see [Enable and Configure Restart for Playbooks](enable-define-restart.md).
...
4.  Under the Inputs section, define the values of the activity's inputs.
    ...
    Configure inputs with a hardcoded value, or by [dot-walking to a data pill](https://www.servicenow.com/docs/access?context=c_DotWalking&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US) \(![Data pill picker icon](../images/data-pill-picker-icon.png)\) to use data from previous activities or the playbook trigger.
...
<table id="choicetable_cf4_jqb_g5b"><tbody><tr><td id="d158222e538">
