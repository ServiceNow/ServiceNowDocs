...
|Create Standard Change Request|Creates a Change Request record of type Standard. For more information, see [IT Service Management](https://www.servicenow.com/docs/access?context=r_ITServiceManagement&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).|
