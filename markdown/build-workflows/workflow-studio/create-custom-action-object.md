...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/create-custom-action-object.html
release: yokohama
...
1.  Create an application to store your work.
    ...
    Use the [Guided Application Creator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/guided-application-creator/guided-app-creator.md).
