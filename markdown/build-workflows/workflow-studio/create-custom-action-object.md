...
1.  Create an application to store your work.
    ...
    Use the [Guided Application Creator](https://www.servicenow.com/docs/access?context=guided-app-creator&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
