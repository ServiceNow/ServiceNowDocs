...
2.  In the Workflow Studio landing page's main header, select the question mark icon \(![Help panel question mark icon](../images/fd-help-panel-icon.png)\) to open the help panel.
...
3.  To close the help panel, select the question mark icon \(![Help panel question mark icon](../images/fd-help-panel-icon.png)\) again.

4.  Open any flow from the list of flows to go to the Workflow Studio design environment.

5.  Next to the name for any action in the flow, select the Open help panel icon \(![Open help panel icon](../images/action-open-help-panel-icon.png)\).
...
6.  You can also access guided tours from the help panel by selecting the question mark icon \(![Help panel question mark icon](../images/fd-help-panel-icon.png)\) while in the Workflow Studio design environment.
...
![The Flow Designer help panel shows you information about building flows and actions, working with data and spokes, as well as guided tours of the Flow Designer interface.](../images/fd-help-panel-example.png)
