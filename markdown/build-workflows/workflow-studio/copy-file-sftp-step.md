---
title: Copy File
description: Copies a file from the source SFTP server to target SFTP server.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/copy-file-sftp-step.html
release: zurich
