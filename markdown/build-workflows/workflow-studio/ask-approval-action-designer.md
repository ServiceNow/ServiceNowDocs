...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/ask-approval-action-designer.html
release: yokohama
...
[Classic approvals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/approvals/r_Approvals.md) is a platform feature that enables users or groups to approve or reject a task.
...
-   **Rules**
    ...
    **Note:** By default, Ask for Approval generates approval records for inactive users and groups. This behavior allows a flow or action to continue working even when a specific user or group is later made inactive. If you want to change the behavior of generating approvals for inactive entities, set the com.glide.hub.flow.approval.allow\_inactive\_entity system property. See [Workflow Studio flow system properties]().
...
\[Omitted image "ask-for-approval-example.png"\] Alt text: Example Ask for Approval step in an action.
