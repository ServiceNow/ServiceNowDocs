...
-   Activate your Platform Analytics subscription. See [Activating your Performance Analytics subscription](https://www.servicenow.com/docs/access?context=c_PremiumPerformanceAnalytics&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
...
5.  For **Proactive analytics trigger**, select a trigger type.
    ...
    **Note:** For more information about Proactive Analytics options, see [Proactive analytics insights on dashboards](https://www.servicenow.com/docs/access?context=proactive-analytics&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
...
[Performance Analytics indicators](https://www.servicenow.com/docs/access?context=c_Indicators&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)

[KPI Signals](https://www.servicenow.com/docs/access?context=process-behavior-charts-for-kpis&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)
