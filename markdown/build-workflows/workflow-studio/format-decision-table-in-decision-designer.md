...
Role required: admin, decision\_table\_admin, or delegated developer permissions. For more information, see [Delegate developers using App Engine Studio](https://www.servicenow.com/docs/access?context=aes-app-dev-workflow&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
...
<table id="choicetable_mgh_hb1_cyb"><thead><tr><th align="left" id="d58684e271">

Action

</th><th align="left" id="d58684e274">

Description

</th></tr></thead><tbody><tr><td id="d58684e280">
...
Role required: admin, decision\_table\_admin, delegated developer permissions. For more information, see [Delegate developers using App Engine Studio](https://www.servicenow.com/docs/access?context=aes-app-dev-workflow&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
