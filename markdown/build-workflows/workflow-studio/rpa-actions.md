...
For more information about stopping a bot process, see Stop an unattended bot process in RPA Hub.

For more information about Graceful stop, see Using Graceful Stop functionality in RPA Hub.
...
Verifies the HashCode of a package version in RPA Hub to validate the HashCode of the manually uploaded automation zip file with the associated package version record.For more information about verifying the HashCode of a package version, see Verify the HashCode of a package version in RPA Hub.
...
Imports the package version attachments automatically for a package version. To automatically migrate the package attachment \(automation zip file\) from a lower \(non-production\) to a higher \(production\) environment.For more information about importing a package version attachment in RPA Hub, see Import a package version attachment in RPA Hub.
