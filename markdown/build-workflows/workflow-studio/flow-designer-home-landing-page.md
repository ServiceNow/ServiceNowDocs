...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/flow-designer-home-landing-page.html
release: xanadu
...
-   **Executions**
    ...
    Lists the execution details of the actions, flows, and subflows run. By default, this list displays the created date, name of the action, flow, or subflow run, run state, runtime duration, created by, and sys\_id information. You can use the standard list controls to filter or personalize this list.
