...
breadcrumb: [Create an external trigger, Build triggers, Flows, subflows, and actions, Workflow Studio, Build workflows]
---
...
**Parent Topic:**[Create a saved external trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/create-saved-external-trigger.md)
...
Option to specify the script that generates or validates the hash.To know more about HMAC, see [Configure HMAC - Token-based authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/configure-hmac.md).
...
[Create a saved external trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/create-saved-external-trigger.md) and associate it with the external event source that you created.
