...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/build-workflows/workflow-studio/activity-executions.html
release: australia
...
|State|Execution status for the activity. See [Activity execution states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/activity-executions.md).|
|Activity Type|Experience type for the activity. See [Experience types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/experience-types.md).|
