...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/call-now-assist-skill-step.html
release: zurich
...
-   **Now Assist Skill Kit requirements**
    ...
    This step requires the Now Assist Skill Kit. For more information, see [Exploring Now Assist Skill Kit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/exploring-now-assist-skill-kit.md).

-   **Role requirements**

    This step requires roles granted by delegated development or assigned to the user. For more information, see [User access to Workflow Studio flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/user-access-flow-designer.md).
...
-   **Skill Config**
    ...
    Reference to a Now Assist Skill Config \[sn\_nowassist\_skill\_config\] record. The payload is generated based on the Skill Config you select.
