...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/build-workflows/workflow-studio/flow-error-handler.html
release: brazil
...
-   **[Add an error handler to a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/add-error-handler-flow.md)**  
Run a sequence of Workflow Studio actions and subflows to identify and correct issues that are caused by flow errors.
-   **[Create a custom action to throw an error](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/create-custom-action-throw-error.md)**  
