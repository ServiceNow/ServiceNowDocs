...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/action-inputs-outputs.html
release: xanadu
...
-   **[Approval rules data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/approval-rules-data.md)**  
Store the conditions for approving or rejecting an approval requests.
-   **[Array.Boolean data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/array-boolean-data.md)**  
Store a sequence of true or false values in an array.
-   **[Array.Choice data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/array-choice-data.md)**  
Store a sequence of choice list values in an array.
-   **[Array.Datetime data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/array-datetime-data.md)**  
Store a sequence of date-time values in an array.
-   **[Array.Integer data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/array-integer-data.md)**  
Store a sequence of numeric integer data in an array.
-   **[Array.Object data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/array-object-data.md)**  
Store a sequence of JavaScript objects in an array.
-   **[Array.String data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/array-string-data.md)**  
Store a sequence of alphanumeric text values in an array.
-   **[Choice data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/choice-data.md)**  
Store choice list values for a specific choice field.
-   **[Conditions data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/conditions-data.md)**  
Store a set of conditions for a specific type of record. You must select a source table to define the conditions.
-   **[Datetime data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/datetime-data.md)**  
Store date-time values.
-   **[File attachment data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/file-attachment-data-type.md)**  
...
-   **[Integer data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/integer-data.md)**  
Store numeric integer data. Integers are whole numbers only. Fractions and decimals values are not supported.
-   **[JSON data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/json-data-type.md)**  
Store JSON formatted text values. JSON values can be generated by integration steps or by scripts.
-   **[List.\[Table\] data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/list-table-data.md)**  
...
-   **[Object data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/object-data.md)**  
Store a JavaScript object.
-   **[Password \(2 Way Encrypted\) design considerations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/password-2-data.md)**  
Store encrypted password data that can be decrypted.
-   **[Records.\[Table\] data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/records-data.md)**  
...
-   **[Reference.\[Table\] data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/reference-data.md)**  
Store a single Sys ID reference to a record in a specific table.
-   **[String data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/string-data.md)**  
Store alphanumeric text values using JavaScript data conventions.
-   **[Table name data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/table-name-data.md)**  
Store a table name value as specified in the database dictionary. Table names are always alphanumeric strings.
-   **[True/false data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/true-false-data.md)**  
Store true or false values using JavaScript data conventions.
-   **[Variables.\[Table\] data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/variables-data-type.md)**  
