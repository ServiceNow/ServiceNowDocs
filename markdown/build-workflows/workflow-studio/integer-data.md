...
description: Store numeric integer data. Integers are whole numbers only. Fractions and decimals values are not supported.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/integer-data.html
release: yokohama
