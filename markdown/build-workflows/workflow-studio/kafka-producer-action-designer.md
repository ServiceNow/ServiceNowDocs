...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/kafka-producer-action-designer.html
release: xanadu
...
Reference to a schema table. Select a schema from the list. For information on schemas, see [Schema management in Stream Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/schema-management.md).**Note:** The message you're sending in the **Message** field must adhere to the structure of the selected schema.
