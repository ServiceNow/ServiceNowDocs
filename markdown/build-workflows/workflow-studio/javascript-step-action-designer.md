...
**Note:** Integration Hub See [Request Integration Hub](https://www.servicenow.com/docs/access?context=request-ih-overview&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) for information about Integration Hub usage and subscriptions.
...
-   **Vanilla \(Core JavaScript\)**: The action step runs the script from either the instance or MID Server. Select this option when the script only needs the core JavaScript APIs and not the ServiceNow API or instance data.
 ...
 The runtime you select determines the JavaScript objects and methods displayed in the [Context-sensitive help](https://www.servicenow.com/docs/access?context=c_ScriptingAssistance&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
...
```
 ...
 For available classes and methods, see the [JavaScript API context-sensitive help](https://www.servicenow.com/docs/access?context=c_ScriptingAssistance&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) or the [API reference](https://www.servicenow.com/docs/access?context=api-reference&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
