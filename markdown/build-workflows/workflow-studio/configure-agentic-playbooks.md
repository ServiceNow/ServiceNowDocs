...
6.  In the **AI Agent Instructions** field, enter instructions for the task that you want the AI Agent to perform.
    ...
    For guidelines about how to write instructions for AI Agents, see [Guidelines for writing AI agent instructions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/guidelines-agent-instruction.md).
...
After the playbook is complete, test the playbook. For information, see [Test a playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/test-process.md).
