...
Specify the choices available to select. Use the add button \(![Add button](../images/green-add-button.png)\) to create a choice. Each choice must have a **Name**, **Value**, and **Order**. See Choice list field type for more information about choice lists.
