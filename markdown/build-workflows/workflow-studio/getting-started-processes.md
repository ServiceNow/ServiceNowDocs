...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/build-workflows/workflow-studio/getting-started-processes.html
release: australia
...
-   **[Process executions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/process-executions.md)**
...
\[Omitted image "getting-started-process-definition.png"\] Alt text: Create a digitized representation of your business process, known as a playbook.
...
\[Omitted image "getting-started-process-execution.png"\] Alt text: When your activated playbook is triggered, the system creates a process execution, a playbook can render for agents, and automated record operations on the ServiceNow AI Platform occur.
...
-   [Create a sample playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/design-automated-process.md)
