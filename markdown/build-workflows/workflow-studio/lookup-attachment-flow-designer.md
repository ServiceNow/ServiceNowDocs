...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/lookup-attachment-flow-designer.html
release: yokohama
...
-   **Source Record**
    ...
    Record containing one or more attachments to look up. You can use the [Look Up Record action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/lookup-record-flow-designer.md) to find an appropriate source record.
...
-   **Attachment Sys ID**
    ...
    Sys ID of the first matching attachment. You can use the [Look Up Record action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/lookup-record-flow-designer.md) to convert this string value into a record output.
