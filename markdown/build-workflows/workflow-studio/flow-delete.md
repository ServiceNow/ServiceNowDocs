...
1.  If needed, change application scope to that of the flow you want to delete.
    ...
    For more information about changing application scope, see [Exploring Next Experience pickers](https://www.servicenow.com/docs/access?context=next-experience-pickers&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
