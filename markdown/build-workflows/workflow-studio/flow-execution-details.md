...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/flow-execution-details.html
release: zurich
...
Update flow runtime data as needed. Set a flow preference to refresh flow data automatically when you run a test. See [User preferences for flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/flow-preferences.md).
...
|Metric Trigger|The flow started when the MetricBase trigger conditions of a [MetricBase](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/metricbase.md) were met.|
...
\[Omitted image "flow-runtime-statistics.png"\] Alt text: Sample flow statistics
