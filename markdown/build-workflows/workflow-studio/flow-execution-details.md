...
|Metric Trigger|The flow started when the MetricBase trigger conditions of a [MetricBase](https://www.servicenow.com/docs/access?context=metricbase&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) were met.|
...
![Sample flow statistics](../images/flow-runtime-statistics.png "Sample flow statistics for each item in the flow logic")
