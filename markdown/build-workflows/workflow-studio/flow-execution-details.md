...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/flow-execution-details.html
release: yokohama
...
You can configure the default reporting level the system uses to generate execution details each time a flow is run. For more information, see [Activate flow reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/enable-flow-reporting.md).

## Refresh flow data

Update flow runtime data as needed. Set a flow preference to refresh flow data automatically when you run a test. See [User preferences for flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/flow-preferences.md).
...
|Metric Trigger|The flow started when the MetricBase trigger conditions of a [MetricBase](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/metricbase.md) were met.|
...
\[Omitted image "execution-details-embedded-editors.png"\] Alt text: Sample script
...
\[Omitted image "example-flow-logic-for-each.png"\] Alt text: For Each flow logic
