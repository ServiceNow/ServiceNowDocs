...
5.  Complete the trigger fields.
    ...
    |Field|Description|
    |-----|-----------|
    |MetricBase Trigger|Select or create a MetricBase trigger record to start the flow. For types of MetricBase triggers, see [MetricBase triggers](https://www.servicenow.com/docs/access?context=metricbase-triggers&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).|
