...
breadcrumb: [Reference, Workflow Studio, Build workflows]
---
...
-   **[Playbooks system properties](process-automation-designer-system-properties.md)**  
...
-   **[Playbooks roles](process-automation-designer-roles.md)**  
Grant users one or more Playbooks roles to enable them to create triggers, playbooks, and activity definitions.
-   **[Keyboard navigation in playbook diagram view](keyboard-navigation-in-playbook-diagram-view.md)**  
Use keyboard commands to navigate and configure playbooks in diagram view.
-   **[Playbook statuses and activation states](process-status-activation-state.md)**  
...
-   **[Process executions](../concept/process-executions.md)**  
...
-   **[Activity executions](../concept/activity-executions.md)**  
...
-   **[Create Task activity](create-task-activity.md)**  
Create a task record from previously gathered or generated data.
-   **[Instruction activity](instruction-activity.md)**  
Display a simple message to guide end users through your playbook.
-   **[User Form activity](user-form-activity.md)**  
...
-   **[Placeholder activity](placeholder-activity.md)**  
Display an activity card in Playbooks to indicate what a future activity does.
-   **[Interactive activities](../concept/interactive-activities.md)**  
An interactive activity prompts a user for input in your playbook as it runs.
-   **[Non-Interactive activities](../concept/non-interactive-activities.md)**  
...
**Parent Topic:**[Workflow Studio reference](../../workflow-studio/reference/workflow-studio-reference.md)
