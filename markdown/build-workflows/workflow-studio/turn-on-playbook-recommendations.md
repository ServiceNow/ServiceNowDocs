...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/turn-on-playbook-recommendations.html
release: yokohama
...
4.  Turn on the **Playbook recommendation** skill.
    ...
    \[Omitted image "image.now-assist-creator-playbook"\] Alt text: Now Assist for creator page with Playbook skills.


## Result

The Playbook recommendation skill is active on your instance.
