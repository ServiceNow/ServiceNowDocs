...
**Note:** For JSON, this step is deprecated and replaced by the [JSON Builder step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/json-build-step-action-designer.md).
