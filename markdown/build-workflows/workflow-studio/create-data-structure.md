...
1.  Create a data variable.
    ...
    |**XML parser step**|See [XML parser step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/xml-parser-step-action-designer.md)|
