...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/trigger-notification-action-designer.html
release: yokohama
...
[Notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/notifications.md) is a platform feature. Before triggering a notification as an action step in Workflow Studio, ensure that the notification is set up for use in the platform.

-   When you [Create an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_CreateANotification.md), set the **Send when** field in the **When to send** tab of the Notification form to Triggered.
