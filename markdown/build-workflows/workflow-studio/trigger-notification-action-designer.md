...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/trigger-notification-action-designer.html
release: zurich
...
[Notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/notifications.md) is a platform feature. Before triggering a notification as an action step in Workflow Studio, ensure that the notification is set up for use in the platform.

-   When you [Create an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_CreateANotification.md), set the **Send when** field in the **When to send** tab of the Notification form to Triggered.
