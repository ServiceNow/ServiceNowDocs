...
By default, Workflow Studio stores 100 flow history records. When the total number of flow history entries exceeds this limit, Workflow Studio overwrites the oldest history entry that is not marked as a favorite. You can set the maximum number of flow history records to store using the sn\_flow\_designer.maximum\_flow\_history\_records\_per\_flow system property. For more information about using this property, see [Workflow Studio flow system properties](../reference/flow-designer-system-properties.md).

-   **[Add an annotation to a flow history entry](../task/add-annotation-to-flow-history-entry.md)**  
Add a text description to a flow history entry. Summarize the purpose or contents of a particular flow history entry.
-   **[Delete a flow history entry](../task/delete-flow-history-entry.md)**  
Delete a flow history entry from the flow history list.
-   **[Restore a flow to a previous flow history entry](../task/restore-flow-to-previous-flow-history-entry.md)**  
Restore a flow to a previous configuration. Create a new flow history entry for the restore operation.
-   **[Save a copy of a flow history entry](../task/save-copy-flow-history-entry.md)**  
