...
Option to set a duration value manually or to select a Duration data pill from the data pill picker \(![Data pill picker](../images/data-pill-picker-icon-01.png)\).-   **Explicit Duration**: Wait duration in hours, minutes, and seconds.
