...
-   **7. Advanced Options section**
    ...
    -   **When to run the flow**
        ...
        |Option|Description|
        |------|-----------|
        |Only Run for Non-Interactive Session|Flow that is triggered only in non-interactive sessions. See [Non-interactive sessions](https://www.servicenow.com/docs/access?context=c_NonInteractiveSessions&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).|
