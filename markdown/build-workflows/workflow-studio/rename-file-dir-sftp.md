...
description: Renames a file or directory on an SFTP server.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/rename-file-dir-sftp.html
release: zurich
...
Name or IP address of the SFTP server that contains the file or directory you wish to rename.
...
Full path with the renamed file or directory.
