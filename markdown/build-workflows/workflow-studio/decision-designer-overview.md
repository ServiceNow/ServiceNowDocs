...
-   For more information about this update, see the [Washington DC Decision Builder release notes](https://www.servicenow.com/docs/access?context=decision-builder-rn&version=zurich&pubname=zurich-release-notes&ft:locale=en-US).
...
See [Add a decision](https://www.servicenow.com/docs/access?context=add-automation&version=zurich&pubname=zurich-application-development&ft:locale=en-US) in App Engine Studio.
...
-   **[Filter decision tables](filtering-overview.md)**  
