...
description: Creates a new directory on an SFTP server.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/create-dir-sftp.html
release: zurich
...
breadcrumb: [SFTP step, Steps, Flows, subflows, and actions reference, Reference, Workflow Studio, Build workflows]
---
...
<table id="table_szc_wsk_kjb"><thead><tr><th>
...
Name or IP address of the SFTP server where you wish to create directory.
...
Path of the directory you wish to create.
...
Option to enable the retry policy. For more information, see [Retry policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/retry-policy.md).
...
**Parent Topic:**[SFTP step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/sftp-step.md)
