...
-   You don't need to run any reports on the collected data. If you need any metrics or reports on the collected data, create a table and use the [User Form activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/user-form-activity.md) instead.
...
<table id="choicetable_qcs_vmh_j1c"><tbody><tr><td id="d66613e229">
...
Configure a [**Collect user data** activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/collect-user-data-activity.md) in Workflow Studio Playbooks to use your new data definition.
