...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/create-decision-table-flow.html
release: yokohama
...
7.  In the **Decision Table** field, select the Create new record icon \(\[Omitted image "create-new-record-icon.png"\] Alt text: Create new record icon\).
