...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/create-decision-table-flow.html
release: xanadu
...
7.  In the **Decision Table** field, select the Create new record \(\[Omitted image "create-new-record-icon.png"\] Alt text:\) icon.
