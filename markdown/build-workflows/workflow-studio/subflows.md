...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/build-workflows/workflow-studio/subflows.html
release: australia
...
-   **Manage natural language title**
    ...
    Create or edit a subflow title with styled or dynamic text. For more information, see [Manage natural language titles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/manage-natural-language-title.md).
...
General guidelines that apply to [flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/flows.md) also apply to subflows.
...
-   **[Create a subflow in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/create-subflow.md)**  
...
-   **[Create a subflow with Now Assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/create-subflow-now-asist.md)**  
Use generative AI to create a subflow from text directionsand images.
-   **[Create conversational subflow skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/create-conversational-subflow-skill.md)**  
...
-   **[Configure LLM to generate descriptions for conversational subflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/configure-llm-for-conversational-subflow.md)**  
...
-   **[Copy a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/copy-subflow.md)**  
Copy a subflow to give it a new name and move it to another application scope.
-   **[Create a decision table in a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/create-decision-table-subflow.md)**  
...
-   **[Convert items to subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/convert-items-subflow.md)**  
...
-   **[Create a template value input](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/template-value.md)**  
...
-   **[Get started with Dynamic Flow and Get Flow Outputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/getting-started-dynamic-flow-get-flow-outputs.md)**  
Create a sample flow that dynamically calls subflows for provisioning cloud services.
-   **[Publish a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/publish-subflow.md)**  
Publish a subflow to make it available to other users and to add it to activated flows.
-   **[Summarize a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/summarize-a-subflow.md)**  
Generate a summary of a subflow with ServiceNow Otto for Creator.
-   **[Subflow history](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/subflow-history.md)**  
View and manage the history of a subflow. See past configurations of a subflow to copy, restore, or remove them.
-   **[Test a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/test-subflow.md)**  
...
-   **[Test conversational subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/test-conversational-subflow.md)**  
