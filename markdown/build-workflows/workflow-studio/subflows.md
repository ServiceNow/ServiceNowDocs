...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/subflows.html
release: yokohama
...
-   **Manage natural language title**
    ...
    Create or edit a subflow title with styled or dynamic text. For more information, see [Manage natural language titles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/manage-natural-language-title.md).
...
General guidelines that apply to [flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/flows.md) also apply to subflows.
...
-   **[Create a subflow in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/create-subflow.md)**  
...
-   **[Create a subflow with Now Assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/create-subflow-now-asist.md)**  
...
-   **[Copy a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/copy-subflow.md)**  
Copy a subflow to give it a new name and move it to another application scope.
-   **[Create a decision table in a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/create-decision-table-subflow.md)**  
...
-   **[Convert items to subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/convert-items-subflow.md)**  
...
-   **[Create a template value input](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/template-value.md)**  
...
-   **[Get started with Dynamic Flow and Get Flow Outputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/getting-started-dynamic-flow-get-flow-outputs.md)**  
Create a sample flow that dynamically calls subflows for provisioning cloud services.
-   **[Test a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/test-subflow.md)**  
