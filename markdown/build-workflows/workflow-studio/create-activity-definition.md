...
-   Make sure to set your current application to the application that you want your activity to run in. For more information, see [Application picker](https://www.servicenow.com/docs/access?context=c_ApplicationPicker&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
...
<table id="choicetable_ndc_pgy_5lb"><thead><tr><th align="left" id="d172814e170">

Field

</th><th align="left" id="d172814e173">

Action

</th></tr></thead><tbody><tr><td id="d172814e179">
