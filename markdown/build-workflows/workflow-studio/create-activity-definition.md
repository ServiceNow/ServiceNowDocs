...
-   Make sure to set your current application to the application that you want your activity to run in. For more information, see [Application picker](https://www.servicenow.com/docs/access?context=c_ApplicationPicker&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
...
<table id="choicetable_ndc_pgy_5lb"><thead><tr><th align="left" id="d155215e173">

Field

</th><th align="left" id="d155215e176">

Action

</th></tr></thead><tbody><tr><td id="d155215e182">
