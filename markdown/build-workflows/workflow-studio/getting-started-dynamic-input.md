...
-   A REST step to gather table names from the REST [Table API](https://www.servicenow.com/docs/access?context=c_TableAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
...
-   A REST step to gather fields from the REST [Table API](https://www.servicenow.com/docs/access?context=c_TableAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
-   A script step to construct a JSON payload from the REST step's Response Body
...
-   A script step to create a record from the [GlideRecord - Global](https://www.servicenow.com/docs/access?context=c_GlideRecordAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
