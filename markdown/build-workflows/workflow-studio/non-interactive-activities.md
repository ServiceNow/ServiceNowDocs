...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/non-interactive-activities.html
release: xanadu
...
To learn how to design a playbook with non-interactive activities, see [design an automated process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/design-automated-process.md).

-   **[Automated Create Record activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/automated-create-record-activity.md)**  
...
-   **[Automated Send Email activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/automated-send-email-activity.md)**  
...
-   **[Automated Update Record activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/automated-update-record-activity.md)**  
...
-   **[Autocompleting User Form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/autocompleting-user-form.md)**  
Display a form during runtime to collect input values for your playbook.
-   **[Look Up Records activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/look-up-records-activity.md)**  
Find system records that match a set of conditions.
-   **[Make a Decision-First Match activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/make-decision-first-match-activity.md)**  
