...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/design-considerations-consolidated.html
release: zurich
...
-   **Include sys\_complex\_object records generated by the flow in update sets**
    ...
    Missing [complex data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/complex-data.md) schemas can cause execution issues. Make sure you include sys\_complex\_object records generated by the flow in update sets. Rather than manually build update sets, consider transferring flows from one instance to another by using the application repository.
...
-   **View final transformed values in the flow execution details**
    ...
    Only the final transformed value, and not the value for each applied transform, appears in the [flow execution details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/flow-execution-details.md).
...
-   **View final transformed values in the flow execution details**
    ...
    Only the final transformed value appears in the [flow execution details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/flow-execution-details.md), and not the value for each applied transform.
