...
2.  Create a flow or open an existing flow.
    ...
    For more information about creating a flow, see [Create a flow in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/create-flow.md).
...
4.  Add actions, flow logic options, or subflows to the Error Handler section.
    ...
    |-----------------|-----------|
    |If|Selectively apply one or more actions only when a list of conditions is met. For more information, see [If](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/flow-logic-if.md).|
    ...
    |End Flow|Use this flow logic option to stop a flow within Workflow Studio. For more information, see [End Flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/flow-logic-end-action.md).|
    ...
    |Set Flow Variables|Assign a value to one or more flow variables. Change or update a variable's value during a flow. For more information, see [Set Flow Variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/flow-logic-set-flow-variables.md).|
...
5.  Add stages in the Error Handler.
    ...
    For more information on how to add stages, see [Configure stages and add them to a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/add-stages.md).

6.  Add a custom action to the main body of the flow that throws an error.

    To learn how to create a custom action, see [Create a custom action to throw an error](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/create-custom-action-throw-error.md).

7.  Test your flow to ensure that the error handler works as expected.

    For more information about testing a flow, see [Test your flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/flow-test.md).
...
**Parent Topic:**[Flow error handler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/flow-error-handler.md)
