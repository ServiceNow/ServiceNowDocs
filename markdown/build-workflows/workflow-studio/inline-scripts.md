...
Script writers should be familiar with ServiceNow AI Platform table structures and [field types](https://www.servicenow.com/docs/access?context=r_FieldTypes&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US). In addition, they should know how to work with record and system data using the ServiceNow API.
