...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/collect-user-data-activity.html
release: yokohama
...
The key input for this activity is the **User form for data collection** field, under the [Inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/collect-user-data-activity.md) section. To provide this input, you must [create a data definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/create-data-definition.md) first.
