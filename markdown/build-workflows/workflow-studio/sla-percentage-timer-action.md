...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/sla-percentage-timer-action.html
release: yokohama
...
Workflow Studio sets the action status when the SLA state matches an [SLA condition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/c_SLAConditions.md) or when certain UI actions are selected.
