...
-   **Trigger**
    ...
    A trigger specifies when to run the flow. When the trigger conditions are met, the system runs the flow using the data provided by the trigger. Workflow Studio supports a variety of trigger types such as record, Service Catalog requests, and scheduled triggers. For a description of available trigger types, see [Workflow Studio flow trigger types](../../flow-designer/reference/flow-triggers.md).
...
The following illustration describes the basic tasks involved in creating a flow using Workflow Studio. For detailed instructions for creating a flow, see [Create a flow in Workflow Studio](../../flow-designer/task/create-flow.md).
...
-   **[Flow Assist](../../flow-designer/reference/flow-assist-landing.md)**  
