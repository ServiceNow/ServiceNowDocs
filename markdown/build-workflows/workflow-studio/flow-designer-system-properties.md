...
-   Location: System Properties \[sys\_properties\] table
-   More information: [Restricted caller access privilege settings](https://www.servicenow.com/docs/access?context=restricted-caller-access-privilege&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US)
...
-   Default value: 120
-   Location: System Properties \[sys\_properties\] table
-   More information: [Specify the action workflow timeout](https://www.servicenow.com/docs/access?context=va-fdih-action-timeout&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US).
