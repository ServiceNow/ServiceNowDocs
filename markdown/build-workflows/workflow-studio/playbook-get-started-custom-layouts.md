...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/playbook-get-started-custom-layouts.html
release: xanadu
...
-   If you don't have a playbook to apply custom layouts to, build a playbook. To learn more, see [Building playbooks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/building-a-process.md).
