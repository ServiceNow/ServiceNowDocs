...
3.  In your **UI Builder** experience, you can:
    ...
    -   [create a page from a **Standard record** template](https://www.servicenow.com/docs/access?context=reuse-page-definitions&version=australia&pubname=australia-application-development&ft:locale=en-US),
