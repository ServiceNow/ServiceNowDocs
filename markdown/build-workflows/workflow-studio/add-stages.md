...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/add-stages.html
release: xanadu
...
This task assumes that you are familiar with flow and subflow stages, stage fields, and stage sets. For more information about stages, see [Flow and subflow stages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/flow-designer-stages.md).
...
1.  If not already present, create a stage field on the table that triggers the flow.
    ...
    To add a field to a table, see [Add and customize a field in a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/t_CreatingNewFields.md).
...
4.  Create and configure stages.
    ...
    1.  Click \[Omitted image "more-actions-menu-icon.png"\] Alt text: The More Actions icon and select **Flow stages**.
    ...
    2.  From **Add stages from a template**, select a stage set to import existing stages from the Stage Sets table, and select **Add stages**.
        ...
        To learn more about stage sets, see [Workflow stage sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/legacy-workflow/c_WorkflowStageSets.md). Any changes made to the copy do not affect the original stage set record.
...
**Parent Topic:**[Flow and subflow stages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/flow-designer-stages.md)
