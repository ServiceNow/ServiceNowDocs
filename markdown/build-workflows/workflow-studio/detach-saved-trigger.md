...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/detach-saved-trigger.html
release: zurich
...
7.  Select the **Detach saved trigger** icon\[Omitted image "detach-flow-trigger.png"\] Alt text: Detach saved trigger from a flow..
