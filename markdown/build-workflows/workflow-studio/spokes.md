...
|-----|-----------|------|-------------|
|[Benchmarks Spoke](../reference/benchmarks-actions.md)|Provides read-only actions for the read-only Benchmark Recommendation Evaluator flow.|\[com.sn\_bm\_client.spoke\]|Benchmarks application.|
...
|[Customer Service Spoke](../reference/customer-service-actions.md)|Provides actions for flow designers to use when creating Customer Service Management business processes.|\[com.snc.customer\_service.spoke\]|Customer Service Management application|
...
|[Field Service Spoke](../reference/field-service-actions.md)|Provides actions for flow designers to use when creating Field Service Management business processes.|\[com.snc.field\_service.spoke\]|Field Service Management application|
|[ITSM spoke](../reference/itsm-spoke.md)|Provides flow and actions associated with ITSM. Requires the ITSM application suite.|\[com.snc.itsm.spoke\]|IT Service Management application|
|[Machine Learning solutions for Flow Designer](../reference/predictive-intelligence-spoke.md)|Provides actions to make predictions from trained Predictive Intelligence solutions.|\[com.snc.ml\_flowdesigner\]|Predictive Intelligence|
...
|[Security Operations spoke](../../integrationhub/reference/secops-spoke.md)|Provides Security Operations actions for flow designers to manage Security Incident Response flow templates.|\[com.snc.secops.spoke\]|Security Operations application|
