...
|-----|-----------|------|-------------|
|[Benchmarks Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/benchmarks-actions.md)|Provides read-only actions for the read-only Benchmark Recommendation Evaluator flow.|\[com.sn\_bm\_client.spoke\]|[Benchmarks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-service-management/benchmarks-landing.md) application.|
