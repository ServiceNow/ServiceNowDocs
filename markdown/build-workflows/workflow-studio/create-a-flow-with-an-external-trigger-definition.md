...
5.  Add a trigger to your flow.
    ...
    3.  Select the predefined external trigger definition.![External trigger definition.](../images/select-external-trigger-definition.png)
        ...
        To learn more about external trigger definitions, see [Conditional and event-driven inbound integration](https://www.servicenow.com/docs/access?context=conditional-and-event-driven-inbound-integration&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
