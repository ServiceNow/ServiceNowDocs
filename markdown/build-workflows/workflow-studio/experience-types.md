...
![UI Layout fields in an activity definition that uses the Create Record UI Layout](../images/create-rec-activity-def-ui-layout.gif "In an activity definition")

In Workflow Studio, the fields are configured on the UI Layouts tab of the side panel:

![UI Layout fields in the side panel of an activity that uses an activity definition that uses the Create Record UI Layout, in Workflow Studio](../images/create-rec-wf-studio-ui-layout.gif "In Workflow Studio")

**Note:** To learn more about configuring out-of-the-box activities in Workflow Studio, find activity reference documentation in [Playbooks reference](../reference/process-automation-designer-reference.md).

In a running playbook, your configurations are reflected:

![An activity for creating a record in a running playbook, also called the Playbook Experience, as configured in the UI Layout fields in Workflow Studio](../images/create-rec-activity-running-playbook.png "In a running playbook, also called a Playbook Experience")
