...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/turn-off-automated-archiving.html
release: xanadu
...
If you want to change the number of days to before a playbook is archived instead, see [Configure archive settings for process contexts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/config-archive-settings-process-contexts.md).
...
\[Omitted image "turn-off-archiving.gif"\] Alt text:

**Parent Topic:**[Archive process contexts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/archive-process-executions.md)
