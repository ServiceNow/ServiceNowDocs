...
-   Turn on the flow recommendations skill. See Turn on the flow recommendations skill.
...
8.  If the generated flow preview does not meet your needs, you can update the Now Assist directions, and select **Rebuild flow**.
    ...
    Each time you build or rebuild a flow, the operation counts as an assist tracked by your Now Assist subscription. To track your Now Assist usage, see Monitoring Now Assist usage in Subscription Management.
