...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/lookup-record-action-designer.html
release: zurich
...
\[Omitted image "look-up-record-example.png"\] Alt text: Example Look Up Record step in an action.
