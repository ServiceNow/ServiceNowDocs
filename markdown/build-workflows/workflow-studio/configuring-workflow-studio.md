...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/build-workflows/workflow-studio/configuring-workflow-studio.html
release: brazil
...
-   **Data stream actions**
    ...
    Data stream actions require a separate subscription to Integration Hub. For activation information, see [Request Integration Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/request-ih-overview.md).

-   **Decision Builder**

    Decision Builder is a ServiceNow AI Platform feature that is available for installation and update from the ServiceNow Store. For installation and update information, see [Configuring decision tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/configuring-decision-builder.md).


-   **[Update to the latest version of Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/update-to-the-latest-version-of-workflow-studio.md)**  
