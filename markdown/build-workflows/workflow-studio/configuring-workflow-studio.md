...
-   **Playbooks**
    ...
    Playbooks requires a separate subscription. For activation information, see [Activate playbooks](../../process-automation-designer/concept/activate-process-automation-designer.md#).
...
-   **Data stream actions**
    ...
    Data stream actions require a separate subscription to Integration Hub. For activation information, see [Request Integration Hub](https://www.servicenow.com/docs/access?context=request-ih-overview&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
...
-   **[Configuring playbooks](../../process-automation-designer/concept/setting-up-process-automation-designer.md)**  
Set up and monitor playbooks and Playbook Experience.
-   **[Configuring flows](../../flow-designer/concept/configuring-flow-designer.md)**  
Configure user access, API access, and properties for Workflow Studio flows.
-   **[Configuring decision tables](../../decision-table/concept/configuring-decision-builder.md#)**  
