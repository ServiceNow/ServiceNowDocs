...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/create-trigger-definition.html
release: zurich
...
3.  On the Trigger Definition form, in the **Label** field, enter any label for your trigger definition.
    ...
    This label appears as a trigger option when you [Create a playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/create-process-definition.md).
...
8.  Under Condition, use the [condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_ConditionBuilder.md) to add field conditions for when you want to trigger your playbook.
