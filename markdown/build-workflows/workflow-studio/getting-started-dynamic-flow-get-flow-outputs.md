...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/getting-started-dynamic-flow-get-flow-outputs.html
release: xanadu
...
3.  Under the **Log** action, add a [Create Record action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/create-record-flow-designer.md).
...
8.  In the Flow header, select **Activate** to make your flow accessible within the Cloud Instance Provisioning [Application scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/building-applications/c_ApplicationScope.md).
