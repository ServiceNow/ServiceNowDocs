...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/flow-logic-dynamic-flow.html
release: yokohama
...
After you build a template, consider copying it to create similarly named and similarly performing flows or subflows. Make sure that you name each flow or subflow with a standard naming convention that can be generated by Dynamic Flow. For more information on creating a template for Dynamic Flow, see [Getting started with Dynamic Flow and Get Flow Outputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/getting-started-dynamic-flow-get-flow-outputs.md).
...
3.  Specifies the value for the **Context** input by clicking the data pill picker \(\[Omitted image "data\_pill\_picker.png"\] Alt text: Data pill picker\) and selecting **Dynamic Flow** &gt; **Context**.

For more information on using Get Flow Outputs, see [Getting started with Dynamic Flow and Get Flow Outputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/build-workflows/workflow-studio/getting-started-dynamic-flow-get-flow-outputs.md).
