...
After you build a template, consider copying it to create similarly named and similarly performing flows or subflows. Make sure that you name each flow or subflow with a standard naming convention that can be generated by Dynamic Flow. For more information on creating a template for Dynamic Flow, see [Getting started with Dynamic Flow and Get Flow Outputs](../task/getting-started-dynamic-flow-get-flow-outputs.md#).
...
For more information on using Get Flow Outputs, see [Getting started with Dynamic Flow and Get Flow Outputs](../task/getting-started-dynamic-flow-get-flow-outputs.md#).
