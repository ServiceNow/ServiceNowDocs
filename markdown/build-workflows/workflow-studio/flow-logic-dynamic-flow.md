...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/build-workflows/workflow-studio/flow-logic-dynamic-flow.html
release: australia
...
For more information on using Get Flow Outputs, see [Getting started with Dynamic Flow and Get Flow Outputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/workflow-studio/getting-started-dynamic-flow-get-flow-outputs.md).
