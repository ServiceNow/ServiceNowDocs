...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/exploring-process-automation-designer.html
release: zurich
...
-   **Design space**
    ...
    **Note:** Decision activities are not available in Board view, and Optional activities are not available in Diagram view.
    ...
    For more information, see [Stages and activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/process-automation-designer-lanes-activities.md).
...
For more information on creating a playbook, see [Getting started with Playbooks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/getting-started-processes.md).
