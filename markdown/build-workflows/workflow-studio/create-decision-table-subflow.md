...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/create-decision-table-subflow.html
release: zurich
...
4.  Set **Subflow Inputs &amp; Outputs** for your subflows.\[Omitted image "image.subflow-input-output"\] Alt text: setting inputs and outputs
