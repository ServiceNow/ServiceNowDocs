...
Parser scripts have access to the data stream input and output objects as well as a targetObject property. See [Data Stream actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/create-data-stream-action.md) for more information about parsing a response stream to create complex data.
