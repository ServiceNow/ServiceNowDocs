...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/portal-playbook-widget.html
release: xanadu
...
breadcrumb: [Embed the playbook in Service Portal, Playbooks in Service Portal, Designing playbooks, Using Workflow Studio, Workflow Studio, Build workflows]
---
...
**Note:** To learn more about how to clone or create your own widget instead, see [Developing custom widgets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/widget-dev-guide.md).
...
The iFrame URL is the URL of the UI Builder page. To learn more about the HTML template field, see [.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/widget-dev-guide.md#section_gpd_lkw_h1b) and .**Warning:** Make sure the iFrame URL of your cloned widget is different from the iFrame URL for the out-of-the-box widget.
...
Configure the widget CSS. Configuring CSS in an actual widget affects all instances of that widget. To learn more about the CSS field, see [.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/widget-dev-guide.md#section_gpd_lkw_h1b) and .
...
To learn more about the Server script field, see [.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/widget-dev-guide.md#section_gpd_lkw_h1b) and .
...
The link function requires knowledge of AngularJS.
 ...
 To learn more about the Link field, see [.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/widget-dev-guide.md#section_gpd_lkw_h1b) and .
...
Select the checkbox to enable a preview of the widget in the Widget Editor.
...
**Parent Topic:**[Embed the playbook in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/workflow-studio/embed-playbook-service-portal.md)
