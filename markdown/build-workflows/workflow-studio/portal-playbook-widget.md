...
The iFrame URL is the URL of the UI Builder page. To learn more about the HTML template field, see . and .**Warning:** Make sure the iFrame URL of your cloned widget is different from the iFrame URL for the out-of-the-box widget.
...
Configure the widget CSS. Configuring CSS in an actual widget affects all instances of that widget. To learn more about the CSS field, see . and .
...
To learn more about the Server script field, see . and .
...
The link function requires knowledge of AngularJS.
 ...
 To learn more about the Link field, see . and .
...
Allows a Service Portal admin to configure a widget. To learn more about the Option schema field, see . and .
