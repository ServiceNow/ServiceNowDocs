...
-   [Create a checklist](https://www.servicenow.com/docs/access?context=t_CreateAChecklist&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US), and
-   [Create a checklist template for the target task table.](https://www.servicenow.com/docs/access?context=create-checklist-template&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)
...
Template for the checklist to create for each run. Before you can provide this input, you must:-   [Create a checklist](https://www.servicenow.com/docs/access?context=t_CreateAChecklist&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US), and
-   [Create a checklist template for Visual Task Board tasks](https://www.servicenow.com/docs/access?context=create-checklist-template&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)
