...
The key inputs for this activity are the **Checklist Owner**, **Checklist Items**, and **Checklist Name** fields under the [Inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/checklist-task-activity.md) section.
