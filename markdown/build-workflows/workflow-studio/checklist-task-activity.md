...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/checklist-task-activity.html
release: zurich
...
The key inputs for this activity are the **Checklist Owner**, **Checklist Items**, and **Checklist Name** fields under the [Inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/checklist-task-activity.md) section.
