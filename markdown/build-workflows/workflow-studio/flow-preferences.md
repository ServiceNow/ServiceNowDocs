...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/build-workflows/workflow-studio/flow-preferences.html
release: yokohama
...
|User preferences|Open a flow in draft state and select **More actions** to access these preferences.|
