...
For more information, see [Restart a playbook](restart-a-playbook.md).
    ...
    2.  Select the **Add Condition** button.
        ...
        The [condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US) displays.
