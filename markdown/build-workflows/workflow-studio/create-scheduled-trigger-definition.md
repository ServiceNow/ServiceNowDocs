...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/create-scheduled-trigger-definition.html
release: zurich
...
3.  On the sidebar, select **Triggers** \(\[Omitted image "triggers-icon.png"\] Alt text: Icon to open the triggers.\)\).
...
**Parent Topic:**[Triggers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/process-automation-designer-triggers.md)
