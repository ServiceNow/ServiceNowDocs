...
Parse an inbound REST API request into a complex data object and use the values in a flow. See [REST API trigger](https://www.servicenow.com/docs/access?context=rest-trigger&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
