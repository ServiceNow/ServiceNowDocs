...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/workflow-studio/flow-edit.html
release: xanadu
...
<table id="choicetable_opd_n4h_x1b"><tbody><tr><td id="d104099e116">
...
</td></tr><tr><td id="d104099e182">

**To undo the last edit**

</td><td>

Select **Undo last action** to revert your last change. \[Omitted image "icon-undo.png"\] Alt text:
...
</td></tr><tr><td id="d104099e215">

**To redo the last undo**

</td><td>

Select **Redo last action** to reapply the last reverted change. \[Omitted image "icon-redo.png"\] Alt text:
