...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/update-record-flow-designer.html
release: zurich
...
-   **Field Values**
    ...
    If adding the action to a subflow, you can [Create a template value input](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/workflow-studio/template-value.md).
