...
-   **Record**
    ...
    Record where you want to add a link to the flow execution details. You can use the [Look Up Record action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/lookup-record-flow-designer.md) to find an appropriate record.
