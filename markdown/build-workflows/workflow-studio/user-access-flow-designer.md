...
Enables someone with the flow\_designer or action\_designer role to set and modify input values by writing inline scripts. For information, see [Inline scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/inline-scripts.md).
...
Enables you to view reports for Workflow Studio flow tables. For a list of relevant flow reporting tables, see [Flow execution details retention](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/workflow-studio/flow-reporting.md).
