...
<table id="choicetable_jwq_jdh_x1c"><tbody><tr><td id="d105797e87">
...
</table>10. Setup your default [page variant](https://www.servicenow.com/docs/access?context=create-variant&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
...
![image.troubleshooting-custom-layout-bundle-1]

Alternatively, you can set the **flex-direction** of your new bundle tab to **column**.

![image.troubleshooting-custom-layout-bundle-2]
