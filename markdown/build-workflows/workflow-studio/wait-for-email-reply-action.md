...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/workflow-studio/wait-for-email-reply-action.html
release: zurich
...
\[Omitted image "example-wait-for-email-reply.png"\] Alt text: Example flow that waits for a reply to an incident resolved message
