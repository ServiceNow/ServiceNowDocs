...
If selected, the [**Generate** activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/r_Generate.md) does not follow this transition to generate approvals or tasks.
