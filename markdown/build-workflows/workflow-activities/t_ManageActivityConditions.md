...
If selected, the [**Generate** activity](https://www.servicenow.com/docs/access?context=r_Generate&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) does not follow this transition to generate approvals or tasks.
