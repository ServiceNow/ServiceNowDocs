...
4.  On the Form Design page for the Activity Properties form, add and remove activity variables.
    ...
    For more details on using the form design interface, see [Using the form designer](https://www.servicenow.com/docs/access?context=c_FormDesign&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
