...
[Approval and rollback workflow activities](https://www.servicenow.com/docs/access?context=c_ApprovalAndRollbackActivities&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
...
-   The activity is a [Dot-walking to data in related tables](https://www.servicenow.com/docs/access?context=c_DotWalking&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US) field, such as `current.opened_by.department.manager`, and it has a missing or invalid approval user or group.
