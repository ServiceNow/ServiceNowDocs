...
A unique mutex key. The [Unlock activity](https://www.servicenow.com/docs/access?context=r_UnlockActivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) activity uses this key to release the lock.
