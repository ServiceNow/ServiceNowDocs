...
A unique mutex key. The [Unlock activity](https://www.servicenow.com/docs/access?context=r_UnlockActivity&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) activity uses this key to release the lock.
