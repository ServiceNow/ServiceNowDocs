...
-   If it is a [task activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/r_TaskActivities.md), creates the task and sets:
