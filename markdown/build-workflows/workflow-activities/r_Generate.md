...
-   If it is a [task activity](https://www.servicenow.com/docs/access?context=r_TaskActivities&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US), creates the task and sets:
