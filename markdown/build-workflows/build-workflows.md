...
description: Transform manual tasks and mundane work into digital workflows. Modernize legacy processes with hyperautomation. Enable citizen automation from one platform.
locale: en-US
release: xanadu
topic_type: concept
...
-   **[Classic Business Rules](../../../script/business-rules/concept/c_BusinessRules.md#)**
...
-   **[ERP Customization Mining](https://www.servicenow.com/docs/access?context=erp-customization-mining-overview&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US)**
...
-   **[Virtual Agent Designer](https://www.servicenow.com/docs/access?context=conversation-designer-virtual-agent&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US)**
