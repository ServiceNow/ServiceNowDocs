...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/approvals/sso-esignature-approval-SAML.html
release: xanadu
product: Approvals
...
2.  Activate the [Approval with E-Signature plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/approvals/activate-approval-esignature.md).
...
<table id="choicetable_b2l_vpw_lz"><tbody><tr><td id="d131345e104">
