...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/approvals/t\_SetupAnApprovalEngine.html
release: xanadu
product: Approvals
...
2.  Select the [approval engine option](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/approvals/c_ApprovalEngines.md) for each Task table from the choice list.
