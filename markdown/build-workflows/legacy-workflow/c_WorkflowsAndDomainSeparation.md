...
-   **Workflow \[wf\_workflow\]** and **Workflow Version \[wf\_workflow\_version\]**: used for [Process administration](https://www.servicenow.com/docs/access?context=c_DelegatedAdministration&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) or process separation.
-   **Workflow Context \[wf\_context\]**: used for [Understanding domain separation](https://www.servicenow.com/docs/access?context=c_DomainSeparation&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
