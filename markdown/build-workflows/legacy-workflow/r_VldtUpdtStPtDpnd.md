...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/legacy-workflow/r\_VldtUpdtStPtDpnd.html
release: zurich
...
-   Publishable: Yes
-   Runnable: Yes
-   Related Information: [Workflow movement with update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/c_WorkflowMovementWithUpdateSets.md)
...
4.  Follow standard procedures for migrating update sets to local instances. For information about update sets, see [System update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/system-update-sets.md).
