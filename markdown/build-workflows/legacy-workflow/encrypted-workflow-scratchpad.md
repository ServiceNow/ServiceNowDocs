...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/build-workflows/legacy-workflow/encrypted-workflow-scratchpad.html
release: australia
...
After plugin activation, resume all paused workflows. Refer to [Pause and resume all or multiple workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/build-workflows/legacy-workflow/pause-resume-all-multiple-workflows.md).
