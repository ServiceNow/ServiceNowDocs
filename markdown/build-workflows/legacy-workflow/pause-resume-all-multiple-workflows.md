...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/build-workflows/legacy-workflow/pause-resume-all-multiple-workflows.html
release: xanadu
...
3.  To pause all active workflows, select **Pause All**, then click **Update**. To pause a filtered group of active workflow contexts, skip this step.
    ...
    All currently active workflow contexts in the instance are paused until you resume them. Use [Workflow pause request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/build-workflows/legacy-workflow/monitor-workflow-pause-requests.md) to monitor their status.
