...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/build-workflows/legacy-workflow/t\_SelectAStageField.html
release: brazil
...
Ensure that the workflow field you want to use as the stage field is configured to properly display stages. For detailed steps, see [Create a workflow stage field](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/legacy-workflow/t_CreateAWorkflowStageField.md).
