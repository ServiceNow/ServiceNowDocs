...
-   Publishable: Yes
-   Runnable: Yes
-   Related Information: [Workflow movement with update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/legacy-workflow/c_WorkflowMovementWithUpdateSets.md)
...
Follow the instructions for [Input variable removal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/legacy-workflow/c_InputVariableRemoval.md) when the validator issues this warning.
