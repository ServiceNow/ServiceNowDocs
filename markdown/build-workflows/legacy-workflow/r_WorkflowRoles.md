...
Accesses and uses REST and SOAP messages in the [Orchestration activity designer](https://www.servicenow.com/docs/access?context=c_WorkflowActivityDesigner&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US). Creates and edits custom activities that use the REST web service and SOAP web service templates.
