...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/legacy-workflow/t\_CreateAWorkflow.html
release: zurich
...
-   **[Workflow properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/r_WorkflowProperties.md)**  
...
-   **[Create a workflow from a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/t_CreateAWorkflowFromATable.md)**  
Automate a multi-step process by creating a workflow from the list view of any table that supports workflows.
-   **[Create a workflow for a new service catalog item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/t_CrtWkflwNewSvcCtlgItm.md)**  
When you create a new service catalog item, you can create a new corresponding workflow at the same time.
-   **[Create a workflow for an SLA Definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/t_CreateAWorkflowFromSLADefinition.md)**  
Automate a multi-step process by creating a workflow from an SLA definition.
-   **[Ending workflows with multiple branches](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/c_EndingWorkflowsMultipleBranches.md)**  
