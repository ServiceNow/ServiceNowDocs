...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/build-workflows/legacy-workflow/r\_EventSpecificWorkflowActivities.html
release: zurich
...
2.  Create an event.
3.  Navigate to **System Policy** &gt; **Templates** and create an [Email templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/c_EmailTemplates.md).
4.  Navigate to **System Policy** &gt; **Email** &gt; **Notifications**.
5.  [Create an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_CreateANotification.md) that is triggered by the event you created and sends the template you created.
...
[Wait for WF Event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/r_WaitForWFEvent.md)

</td><td>

Listens for workflow events, as described in the [Workflow Events in the Base System](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/r_WorkflowEventsInTheBaseSystem.md) table, and only within the current context. This activity is located in the **Conditions** category of the workflow tree.
...
</table>**Parent Topic:**[Workflow events in the base system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/build-workflows/legacy-workflow/r_WorkflowEventsInTheBaseSystem.md)
