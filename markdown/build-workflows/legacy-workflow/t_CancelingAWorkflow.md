...
3.  Configure form layout to add **On-cancel script** field to form.
    ...
    For detailed information about configuring form layout, see [Configuring the form layout](https://www.servicenow.com/docs/access?context=configure-form-layout&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
For more information, see the [Workflow - cancelContext\(GlideRecord context\)](https://www.servicenow.com/docs/access?context=c_Workflow_api&version=xanadu&pubname=xanadu-api-reference&section=r_WF-cancelContext_GR&ft:locale=en-US).
