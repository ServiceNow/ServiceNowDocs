...
These features improve the user experience when accessing platform functions with [Using accessibility features](https://www.servicenow.com/docs/access?context=keyboard-accessibility&version=australia&pubname=australia-platform-user-interface&ft:locale=en-US). In general, you use the following set of standard keyboard navigation functions:
