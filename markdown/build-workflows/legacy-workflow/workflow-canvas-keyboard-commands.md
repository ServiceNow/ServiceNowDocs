...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/build-workflows/legacy-workflow/workflow-canvas-keyboard-commands.html
release: brazil
...
2.  Press **Enter** to open [Workflow Properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/legacy-workflow/r_WorkflowProperties.md).
