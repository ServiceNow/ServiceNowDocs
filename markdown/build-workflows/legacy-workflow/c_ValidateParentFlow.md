...
-   **Publishable:** Yes
-   **Runnable:**Yes
-   **Related Information:** [Workflows used as subflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/legacy-workflow/workflows-as-subflows.md)
...
-   Changing the data types of [input variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/legacy-workflow/c_UsingVariablesInAWorkflow.md). Verify that all parent workflows cited in this validation report can pass the correct value type.
