...
-   Activated Now Assist panel. For more information, see [Activate the Now Assist panel standard chat](https://www.servicenow.com/docs/access?context=activate-now-assist-panel&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)
...
-   Activated Now LLM Service as a provider. For more information, see [Manage AI models](https://www.servicenow.com/docs/access?context=manage-large-language-models&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)
-   Set Up AI Search. For more information, see [AI Search readiness for Now Assist on the ServiceNow AI Platform](https://www.servicenow.com/docs/access?context=sn-ai-impl-ai-search&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)
