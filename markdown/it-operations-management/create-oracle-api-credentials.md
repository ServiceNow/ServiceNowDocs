...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/create-oracle-api-credentials.html
release: yokohama
topic_type: task
...
Create OCI service accounts. For more information, see [Create OCI service accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/create-oci-service-accounts.md).
