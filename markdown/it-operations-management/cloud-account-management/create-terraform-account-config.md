...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-account-management/create-terraform-account-config.html
release: yokohama
...
3.  Enter the details in the **New Configuration** form.
    ...
    To fill the form fields, see [Terraform account configuration fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-account-management/terraform-details.md).
