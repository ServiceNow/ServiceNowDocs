...
\[Omitted image "bus-person.svg"\] Alt text:[Set up an IAM account for a ServiceNow user in AWS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-account-management/set-up-iam-account-in-aws.md)
