...
7.  Assign owners \(if they’re empty\) by select and hold \(or right-click\) on the **Owned By** entry and selecting the name from the lookup.
    ...
    **Note:**
    ...
    For more information on certifying a task, see [Review certification tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/data-certific-review-tasks.md).
