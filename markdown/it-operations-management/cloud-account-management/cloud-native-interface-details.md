...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-account-management/cloud-native-interface-details.html
release: yokohama
...
</table>To return to the procedure, see [Create a cloud native interface account configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-account-management/create-cloud-native-interface-config.md).
