...
**Note:** For more information on each section, see [Manage CI details in CI Form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/ci-form-cmdb-workspace.md).
