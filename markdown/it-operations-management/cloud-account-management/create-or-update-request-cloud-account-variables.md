...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-account-management/create-or-update-request-cloud-account-variables.html
release: yokohama
...
6.  Click **Update** once you have made all the changes to the variable.
