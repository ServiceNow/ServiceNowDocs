...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/cloud-account-management/create-or-update-request-cloud-account-variables.html
release: zurich
...
If the expression isn't valid, an error appears.
    ...
    | | |
    |---|---|
    |Visible|If selected, the variable is visible in the item form before ordering the item. It is also visible in the Variable editor after ordering and in the cart view.|
