...
6.  To remove a condition, select the delete icon ![Delete](../../event-management/image/delete-input-icon.png).
    ...
    **Note:** For more information on managing policies, see [Manage PaCE policies](https://www.servicenow.com/docs/access?context=pace-admin-manage-policies&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
