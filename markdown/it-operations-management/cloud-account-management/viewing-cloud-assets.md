...
![View cloud asset details](../image/cloud-asset-details.png "View cloud asset details")
...
For more information about the various sections, see [Managing the Cloud Workspace asset details](manage-cam-ci-details.md).
