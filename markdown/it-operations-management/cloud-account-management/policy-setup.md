...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-account-management/policy-setup.html
release: yokohama
...
3.  For creating or customizing a policy, see [Create a CMDB Data Manager policy \(in Core UI\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/create-data-manager-policy.md).
    ...
    **Note:**
    ...
    -   For certifying an account, see [Certify an account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-account-management/certify-account.md).
