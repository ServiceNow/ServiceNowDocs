...
You can configure the Service Operations Workspace to remain logged in for up to 24 hours. For more information, see [Manage user sessions](https://www.servicenow.com/docs/access?context=c_ManageUserSessions&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
