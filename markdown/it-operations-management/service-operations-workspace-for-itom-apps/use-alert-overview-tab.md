...
-   **Application services:** The application services affected by the alert. For details on application services, see [Application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/application-services.md).
