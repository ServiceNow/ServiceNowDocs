...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-operations-workspace-for-itom-apps/launch-a-web-application-for-an-alert-in-service-operation-workspace.html
release: yokohama
...
Launch a web application that was configured in an alert management rule to quickly access necessary tools, improving response times and efficiency.
