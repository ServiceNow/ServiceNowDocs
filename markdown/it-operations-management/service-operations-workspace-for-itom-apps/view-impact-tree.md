...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-operations-workspace-for-itom-apps/view-impact-tree.html
release: yokohama
...
4.  Select **Service Map**.
    ...
    **Impact Path** shows alerts on the selected CI and all CIs within its impact subtree.
    ...
    To view active alerts directly associated with the selected CI, select the Related items icon \(\[Omitted image "image.icon-service-map-related-items"\] Alt text: Related items icon\) in the right pane, then select **Active Alerts**.

    \[Omitted image "image.sow-service-map-related-items"\] Alt text: View active alerts directly associated with the selected CI.
