...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-operations-workspace-for-itom-apps/extract-compose-fields.html
release: yokohama
...
\[Omitted image "sow-extract-multiple-alert-fields.png"\] Alt text: Extract field for multiple alert outputs
