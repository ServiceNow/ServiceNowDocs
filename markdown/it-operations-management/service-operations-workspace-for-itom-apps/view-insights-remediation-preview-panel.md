...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-operations-workspace-for-itom-apps/view-insights-remediation-preview-panel.html
release: zurich
...
Verify you have the ServiceNow Otto for IT Operations Management \(ITOM\) plugin installed on your instance. For more information about installing Now Assist plugins, see [Install plugins for ServiceNow Otto](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/install-now-assist-feature-plugins.md).
...
3.  Select the alert for which you want to view alert insights.
    ...
    For supported alerts, the Preview panel opens with the **Insights** tab selected by default. Some alert group types aren't supported and don't open with the **Insights** tab first.

4.  If the **Insights** tab shows a waiting for approval message, select **Approve** to trigger the AI Specialist workflow.
