...
-   **[Mark an alert as significant in Health Log Analytics](../../health-log-analytics-operator/task/hla-op-alert-make-significant-sow.md)**  
...
-   **[Mute an unimportant alert in Health Log Analytics](../../health-log-analytics-operator/task/hla-op-alert-mute-sow.md)**  
Eliminate distracting new alerts for insignificant issues by muting them.
-   **[Decrease sensitivity to similar anomalies in Health Log Analytics](../../health-log-analytics-operator/task/hla-op-alert-raise-feedback-sow.md)**  
Make anomaly detection less sensitive to anomalies like the one that triggered the current Log Analytics alert.
-   **[Restore normal importance to an alert metric in Health Log Analytics](../../health-log-analytics-operator/task/hla-op-alert-restore-user-defined-sow.md)**  
