...
-   **[Mark an alert as significant](../../health-log-analytics-operator/task/hla-op-alert-make-significant-sow.md)**  
...
-   **[Mute an unimportant alert](../../health-log-analytics-operator/task/hla-op-alert-mute-sow.md)**  
Eliminate distracting new alerts for insignificant issues by muting them.
-   **[Decrease sensitivity to similar anomalies](../../health-log-analytics-operator/task/hla-op-alert-raise-feedback-sow.md)**  
...
-   **[Restore normal importance to an alert metric](../../health-log-analytics-operator/task/hla-op-alert-restore-user-defined-sow.md)**  
