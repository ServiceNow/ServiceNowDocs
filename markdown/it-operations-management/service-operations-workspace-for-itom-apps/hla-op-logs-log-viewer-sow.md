...
-   If you discover important relationships in the log data, select **Define alert** to define the kind of alert that should be triggered by the data. See [Add a Log Analytics alert rule in Health Log Analytics](hla-op-alert-rule-add-sow.md) for instructions.
