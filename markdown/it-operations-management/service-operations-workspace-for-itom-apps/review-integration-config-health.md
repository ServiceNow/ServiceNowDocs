...
To learn more about de-duplication, see [Event Management configuration preferences](../../event-management/reference/r_EMBestPractice.md). To set the message key in your custom connector integration, see [Configure a custom connector](custom-connector.md).
