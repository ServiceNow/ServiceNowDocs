...
breadcrumb: [Viewing an alert group analysis by Now Assist in Express List, Using agentic and generative AI in Express List, Express List in SOW for ITOM, Using SOW for ITOM, Service Operations Workspace for ITOM, ITOM AIOps, IT Operations Management]
---
...
**Parent Topic:**[Viewing an alert group analysis by Now Assist in Express List](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-operations-workspace-for-itom-apps/el-alert-group-analysis.md)
