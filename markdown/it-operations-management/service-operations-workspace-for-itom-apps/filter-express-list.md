...
-   Add or remove alert tags. Tags enable you to identify and group alerts easily without the need for discovery or accessing the Configuration Management Database \(CMDB\). For more information, see [Categorize alerts displayed in Express List](../task/add-remove-tags-filter.md)
