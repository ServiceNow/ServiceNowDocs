---
title: Define, save, and share a search of log data
...
3.  Save the search.
    ...
    The saved search includes any selected filters. For information about filters, see [Filter search results on the Log viewer](hla-op-log-viewer-filter-sow.md).
    ...
    **Note:** If you are using Health Log Analytics application, Version 20.0.11 - July 2021, and the Health Log Analytics Viewer application, Version 20.0.4 - July 2021, available from the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home), you can define an alert rule without saving the search. For more information, see [Add a Log Analytics alert rule](hla-op-alert-rule-add.md).
...
[Use or modify a saved search](hla-op-search-queries-saved-sow.md)

[Add a Log Analytics alert rule](hla-op-alert-rule-add-sow.md)
