...
-   **[View data on configuration items on the preview panel in Express List](../task/el-ci-data.md)**  
View additional details about configuration items \(CIs\) that are bound to alerts on the Express List preview panel.
-   **[View the Dependency View map for an alert from Express List](../task/el-dependency-map-close-menu.md)**  
View the **Dependency View** map for an alert from the **Alert actions** list in Express List.
-   **[View the Dependency View map from the alert record page](../task/el-dependency-map-alert-details.md)**  
View the **Dependency View** map for an alert from the alert record page.
-   **[View Dependency View map from quick response of an alert](../task/view-em-quick-response-dependency-map.md)**  
