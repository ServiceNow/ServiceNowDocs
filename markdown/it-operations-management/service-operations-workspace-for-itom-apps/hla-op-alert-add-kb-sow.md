...
The KB article is added to the selected alert. You can search for and display the article in the [Agent assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/agent-assist.md) side panel. Health Log Analytics also uses your article to enhance similar alerts with the same Event ID property or alert pattern.
