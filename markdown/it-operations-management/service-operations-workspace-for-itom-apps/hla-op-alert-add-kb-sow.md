...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-operations-workspace-for-itom-apps/hla-op-alert-add-kb-sow.html
release: zurich
...
The KB article is added to the selected alert. You can search for and display the article in the [Agent assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/agent-assist.md) side panel. Health Log Analytics also uses your article to enhance similar alerts with the same Event ID property or alert pattern.
