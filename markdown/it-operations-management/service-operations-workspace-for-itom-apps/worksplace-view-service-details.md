...
4.  Select **Service Details**.
    ...
    ![Application service details page](../image/sow-app-service-details.png)

    For information on the fields, see [Application service details page](../reference/app-service-details.md).
