...
description: The table lists the node attributes that are available in Link View with their icon and description.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-operations-workspace-for-itom-apps/link-view-tags-icons-descriptions.html
release: yokohama
