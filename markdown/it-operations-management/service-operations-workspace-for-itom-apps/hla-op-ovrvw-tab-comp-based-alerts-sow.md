---
title: Sections and cards on the Overview tab for a Component-based alert
...
-   **Identified issue**
    ...
    Select **View surrounding logs** to view log messages that are relevant to the alert. See [Analyze log lines that surround an anomaly](../task/hla-op-surrounding-logs-view-sow.md).
...
**Parent Topic:**[Take action on a Health Log Analytics alert from the Overview tab](../task/hla-op-overview-tab-view-sow.md)
