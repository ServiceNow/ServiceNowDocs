...
breadcrumb: [Use alert rules to control when HLA generates alerts, Log Analytics in SOW for ITOM, Using SOW for ITOM, Service Operations Workspace for ITOM, ITOM AIOps, IT Operations Management]
---
...
**Parent Topic:**[Use alert rules to control when Health Log Analytics generates alerts](../../service-operations-workspace-itom/concept/hla-alert-rules-manage-sow-itom.md)
