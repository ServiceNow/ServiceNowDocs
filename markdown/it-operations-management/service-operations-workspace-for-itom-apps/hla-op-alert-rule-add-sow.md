...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-operations-workspace-for-itom-apps/hla-op-alert-rule-add-sow.html
release: yokohama
...
3.  When a search returns log data that should generate an alert, click **Save** or **Save as** to save the search.
    ...
    **Note:** If you are using Health Log Analytics application, Version 20.0.11 - July 2021, and the Health Log Analytics Viewer application, Version 20.0.4 - July 2021, available from the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home), you don't have to perform this step.
