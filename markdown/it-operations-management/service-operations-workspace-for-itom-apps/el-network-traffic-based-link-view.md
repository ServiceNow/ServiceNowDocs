...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-operations-workspace-for-itom-apps/el-network-traffic-based-link-view.html
release: yokohama
...
\[Omitted image "el-link-view-network-traffic.png"\] Alt text: A map with seven nodes with links between the network traffic-based alerts.
