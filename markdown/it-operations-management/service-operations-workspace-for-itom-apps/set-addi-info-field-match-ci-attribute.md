...
1.  In the **Select which CI class you'd like to identify** field, select the CI class.
...
4.  In the Enrich Alerts page, use **Extract fields**, **Copy or Compose fields**, and **Change alert values** to set at least one **Additional info** field in your alert.
    ...
    Ensure the field precisely matches the field and value format of the CI attributes in the CI record.
