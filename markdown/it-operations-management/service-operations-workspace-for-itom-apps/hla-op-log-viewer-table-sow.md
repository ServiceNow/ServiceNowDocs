...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/service-operations-workspace-for-itom-apps/hla-op-log-viewer-table-sow.html
release: xanadu
...
3.  Add or remove columns in the **Log viewer** table.
    ...
    -   To remove a column, select the field of the same name in the Selected fields list and then select the remove icon \(\[Omitted image "icon-remove-sow.png"\] Alt text: Remove icon.\).
        ...
        If you have filtered the data for specific values in a field, that data still displays even when the field is no longer selected. For more information about filtering data, see [Filter search results on the Log viewer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/service-operations-workspace-for-itom-apps/hla-op-log-viewer-filter-sow.md).
...
**Parent Topic:**[Viewing the logs for an alert on the Log viewer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/service-operations-workspace-for-itom-apps/hla-op-logs-log-viewer-concept-sow.md)
