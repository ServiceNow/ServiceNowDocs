...
For information regarding subscriptions for ITOM Service Operations Workspace, check the ITOM Health subscription at [Subscription for ITOM Health](../../it-operations-management/concept/itom-license-module.md).
...
To know about the ITSM features, see [Service Operations Workspace for ITSM](https://www.servicenow.com/docs/access?context=sow-landing-page&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
