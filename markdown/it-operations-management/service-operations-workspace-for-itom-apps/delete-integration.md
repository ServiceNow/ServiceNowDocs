...
5.  For the integration that you want to delete, select the Ellipses icon \(![Ellipsis horizontal icon](../../../reuse/icons/product-icons/ellipsis-horizontal-fill-24.svg)\) and then select **Delete**.
