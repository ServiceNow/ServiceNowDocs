...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/view-a-monitor-s-test-results.html
release: xanadu
topic_type: task
...
4.  View an overview of the monitor's configuration in the **Configuration** card.
    ...
    -   To view the full configuration, use the **Details** tab. See [Create and edit a synthetic monitor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/create-synthetic-monitor.md) for more information.
...
6.  View the status of each test in the **Monitor result history** card.
    ...
    To view the details for a test, select its timestamp. For more information about the test details, see [View test details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/view-test-details.md).
