...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/health-log-analytics/hla-data-input-log-export.html
release: australia
...
5.  On the form, fill in the fields.
    ...
    For a description of the fields, see [ServiceNow Log Export data input configuration fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/health-log-analytics/hla-data-input-log-export-ref.md).
