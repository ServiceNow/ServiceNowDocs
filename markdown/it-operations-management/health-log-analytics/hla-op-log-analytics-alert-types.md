...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/hla-op-log-analytics-alert-types.html
release: yokohama
...
\[Omitted image "log-analytics-alerts-in-list.png"\] Alt text: Look for the value in the Group column.
