...
description: Understand the Health Log Analytics workflow, architecture, and high-level tasks.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/hla-exploring.html
release: yokohama
...
Understand the Health Log Analytics workflow, architecture, and high-level tasks.

-   **[Get started with ServiceNow Health Log Analytics \(HLA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-understanding.md)**  
