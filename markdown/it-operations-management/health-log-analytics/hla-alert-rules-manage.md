...
-   [Add a Log Analytics alert rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-operations-workspace-for-itom-apps/hla-op-alert-rule-add-sow.md)

    Add a Log Analytics alert rule when you come across log data that should generate an alert.

-   [Modify a defined Log Analytics alert rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-operations-workspace-for-itom-apps/hla-op-defined-alert-modify-sow.md)

    Edit a Log Analytics alert rule that you have defined.

-   [Delete a defined Log Analytics alert rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-operations-workspace-for-itom-apps/hla-op-defined-alert-delete-sow.md)
