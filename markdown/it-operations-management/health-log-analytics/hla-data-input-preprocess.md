...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/hla-data-input-preprocess.html
release: yokohama
...
Proceed to the **Data Input Mapping** page by selecting the **Go to Mapping** related link. [Map raw data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-data-input-mapping.md) that streams into your instance to determine how Health Log Analytics processes it.
