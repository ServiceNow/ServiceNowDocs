...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/health-log-analytics/hla-data-input-streaming.html
release: xanadu
...
1.  Navigate to **All** &gt; **Health Log Analytics** &gt; **Streaming Sources**.
    ...
    **Note:**
    ...
    -   When **Look up hostnames** is selected in the [advanced data input configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/health-log-analytics/hla-data-input-adv-configuration.md), the Streaming Sources page shows the hostname of devices that use an Rsyslog or a Filebeat shipper. For Elasticsearch indices, it displays the index name.
    ...
    -   If the HLA engine is down is down and data has stopped streaming, a notification appears at the top of the Streaming Sources page. When this happens, contact ServiceNow support.
...
When the logs are streaming properly, proceed to [map your raw log data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/health-log-analytics/hla-data-input-mapping.md).
