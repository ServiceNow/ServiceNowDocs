...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/health-log-analytics/hla-components.html
release: xanadu
...
-   The ServiceNow® [Event Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/c_EM.md) application
...
This plugin contains essential components for Health Log Analytics, such as the AI Engine and Elasticsearch.Health Log Analytics Core is a ServiceNow Store app. Once installed, the module is available, but you can choose not to interact with it.
 ...
 Dependency: The ServiceNow® [Event Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/c_EM.md) application.
