...
-   Maximum Java heap size for MID Server: 8,192 MB
    ...
    For general information, see: [MID Server system requirements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/r_MIDServerSystemRequirements.md).
