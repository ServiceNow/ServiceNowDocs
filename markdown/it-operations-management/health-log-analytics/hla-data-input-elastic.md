---
title: Configure data inputs \(Elasticsearch\)
description: Configure a data input for streaming log data from Elasticsearch indices to your ServiceNow instance. Data input configuration is an essential step in setting up the Health Log Analytics \(HLA\) application.
locale: en-US
release: xanadu
...
5.  Select **Advanced** to set advanced configuration fields.
    ...
    For a description of the fields, see [Elasticsearch data input configuration fields](../reference/hla-data-input-elastic-ref.md). For information about configuring the advanced settings later, see [Configure advanced settings for Elasticsearch data inputs](hla-data-input-adv-elastic.md).
...
[Configure advanced settings for Elasticsearch data inputs](hla-data-input-adv-elastic.md)
