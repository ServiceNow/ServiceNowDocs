...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/health-log-analytics/hla-data-input-splunk-polling-ref.html
release: zurich
...
The credential alias to be used. Specify a Splunk Poll credential alias by selecting the magnifying glass icon. Select an existing credential alias from the **Connection &amp; Credential Aliases** list, or select **New** to create a new record. The selected credential alias can hold one Basic Auth credential and one Token Auth credential.

For information about creating a credential alias, see [Credential aliases for Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/discovery-credential-alias.md).
