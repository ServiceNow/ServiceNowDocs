...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/health-log-analytics/hla-log-sources-review.html
release: australia
...
4.  If a log source is missing, add it.
    ...
    2.  Use the JavaScript function to manually map a log sample to the correct service instance, component, and source type.
        ...
        For more information, see [Map raw log data manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/health-log-analytics/hla-data-input-mapping.md).
