...
description: Verify that all your log sources are present and active after Health Log Analytics assigns logs to service instances and components.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/hla-log-sources-review.html
release: yokohama
...
4.  If a log source is missing, add it.
    ...
    2.  Use the JavaScript function to manually map a log sample to the correct service instance, component, and source type.
        ...
        For more information, see [Map raw log data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-data-input-mapping.md).
...
[Delete a log source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-log-source-delete.md)
