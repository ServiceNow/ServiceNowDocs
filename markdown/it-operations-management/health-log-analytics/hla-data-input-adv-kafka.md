---
title: Configure advanced settings for Apache Kafka data inputs
description: Configure advanced settings for data inputs used for streaming log data from Apache Kafka to your instance.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/hla-data-input-adv-kafka.html
release: yokohama
