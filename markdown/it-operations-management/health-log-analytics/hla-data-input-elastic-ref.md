...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/health-log-analytics/hla-data-input-elastic-ref.html
release: xanadu
...
breadcrumb: [Configure data inputs \(Elasticsearch\), Configuring data inputs for Health Log Analytics manually, Set up data inputs for Health Log Analytics manually, Health Log Analytics data input setup, Configuring Health Log Analytics, Health Log Analytics, ITOM Health, IT Operations Management]
---
...
Option for reading log data directly from the Elasticsearch indices with the configured prefix.-   When selected, the data input reads the log data directly from the Elasticsearch indices with the configured prefix. To perform this task, it needs only read privileges.
...
</table>**Parent Topic:**[Configure data inputs \(Elasticsearch\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/health-log-analytics/hla-data-input-elastic.md)
