...
For the Apache Kafka integration setup procedure, see [Set up an Apache Kafka integration for Health Log Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/il-connector-hla-kafka.md).
