...
<table id="choicetable_ywx_ypy_qrb"><thead><tr><th align="left" id="d86552e103">

Option

</th><th align="left" id="d86552e106">

Procedure

</th></tr></thead><tbody><tr><td id="d86552e112">
...
For field descriptions, see [Log-based CI candidates fields in Health Log Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/hla-cmdb-enrich-fields.md).
...
**Parent Topic:**[Enhancing the CMDB with host data Health Log Analytics found in logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/hla-cmdb-enrich-concept.md)
