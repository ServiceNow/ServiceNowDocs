...
-   [Create advanced log alert filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/hla-op-adv-alert-filter-crud.md)
...
-   Continue modifying the filter by reopening the filter record from the [filters list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/hla-op-search-queries-manage-sow.md). You can then edit, test, publish, and activate the filter.
