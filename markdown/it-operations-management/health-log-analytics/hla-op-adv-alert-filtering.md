...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/hla-op-adv-alert-filtering.html
release: yokohama
...
-   [Create advanced log alert filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-op-adv-alert-filter-crud.md)
...
-   Continue modifying the filter by reopening the filter record from the [filters list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-op-search-queries-manage.md). You can then edit, test, publish, and activate the filter.
