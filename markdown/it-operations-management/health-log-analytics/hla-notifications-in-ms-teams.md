---
title: Set up alert notifications in a Microsoft Teams channel
description: Set up notifications for new Health Log Analytics anomaly alerts in a Microsoft Teams channel.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/health-log-analytics/hla-notifications-in-ms-teams.html
release: xanadu
...
breadcrumb: [Alert notification in Slack or Microsoft Teams channels, Health Log Analytics administration, Configuring Health Log Analytics, Health Log Analytics, ITOM Health, IT Operations Management]
---
...
Starting with Version 33.0.27 - August 2024, Health Log Analytics uses the Microsoft Teams Graph spoke application to send notifications on new anomaly alerts. For more information, see [Microsoft Teams Graph Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/msteams-spoke.md). If you're using an HLA version earlier than 33.0.27, refer to the setup procedure in [Set up alert notifications in channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/health-log-analytics/hla-notifications-in-channel.md).
...
2.  Set up the Microsoft Teams Graph spoke.
    ...
    For instructions, see: [Set up](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/integration-hub/set-up-msteams.md).
...
**Parent Topic:**[Alert notification in Slack or Microsoft Teams channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/health-log-analytics/hla-alert-notification-in-channel.md)
