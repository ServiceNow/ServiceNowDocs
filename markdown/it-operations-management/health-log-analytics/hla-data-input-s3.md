---
title: Configure data inputs \(Amazon S3\)
description: Configure a data input for streaming log data from Amazon S3 \(Simple Storage Service\) buckets to your ServiceNow instance. Data input configuration is an essential step in setting up the Health Log Analytics \(HLA\) application.
locale: en-US
release: xanadu
...
Configure a data input for streaming log data from Amazon S3 \(Simple Storage Service\) buckets to your ServiceNow instance. Data input configuration is an essential step in setting up the Health Log Analytics \(HLA\) application.
...
5.  Select **Advanced** to set additional configuration fields.
    ...
    For a description of the fields, see [Amazon S3 data input configuration fields](../reference/hla-data-input-s3-ref.md). For information about configuring the advanced settings later, see [Configure advanced settings for Amazon S3 data inputs](hla-data-input-adv-s3.md).
...
[Configure advanced settings for Amazon S3 data inputs](hla-data-input-adv-s3.md)
