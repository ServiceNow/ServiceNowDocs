...
![HLA core components on the Event Management service instance map.](../image/hla-system-health-service-map.png "HLA components on the Event Management service map")
