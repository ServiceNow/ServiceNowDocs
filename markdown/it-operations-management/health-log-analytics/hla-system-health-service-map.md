...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/health-log-analytics/hla-system-health-service-map.html
release: zurich
...
\[Omitted image "hla-system-health-service-map.png"\] Alt text: HLA core components on the Event Management service instance map.
...
If the alert impacts the parent object, the parent object has a bar of the same color. For more information, see [View an alert impact on CIs in a service map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/t_EMViewTopology.md).

You can drill down into an alert to view details about the issue and then address it by performing the action proposed in the notification. For more information, see [Health Log Analytics self-health checks, notifications, and proposed actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/health-log-analytics/hla-self-health-notifications.md).
...
[Identify Health Log Analytics system health issues on the service map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/health-log-analytics/hla-system-health-service-map-view.md)
