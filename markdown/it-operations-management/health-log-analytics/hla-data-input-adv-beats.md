---
title: Configure advanced settings for Beats data inputs
description: Configure advanced settings for data inputs that use Beats agents.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/hla-data-input-adv-beats.html
release: yokohama
