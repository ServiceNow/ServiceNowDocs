---
title: Configure GCP PubSub data inputs
description: Configure a data input for receiving log messages that are published to a Google Cloud Pub/Sub topic and streaming them to your ServiceNow instance.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/hla-data-input-gcp-pubsub.html
release: yokohama
...
4.  On the form, fill in the fields.
    ...
    For a description of the fields, see [GCP PubSub data input configuration fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-data-input-gcp-pubsub-ref.md).
