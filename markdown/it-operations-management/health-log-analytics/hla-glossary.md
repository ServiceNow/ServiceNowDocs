...
For a description of the simplified mapping interface in the new HLA UI, see: [Log context mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/hla-glossary.md).
...
A logical representation of the source of the log data that HLA ingests. Each log source is defined by a [service instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/hla-glossary.md)-[component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/hla-glossary.md) pair. HLA performs anomaly detection and generates alerts on issues within the scope of each individual log source.
