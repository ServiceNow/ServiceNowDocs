---
title: Health Log Analytics system health notifications and proposed actions
description: Health Log Analytics provides self-health checks, notifications, and proposed problem-solving steps.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/health-log-analytics/hla-self-health-notifications.html
release: xanadu
...
breadcrumb: [Viewing Health Log Analytics system health alerts on the service map, Using Health Log Analytics, Health Log Analytics, ITOM Health, IT Operations Management]
---
...
**Parent Topic:**[Viewing Health Log Analytics system health alerts on the service map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/health-log-analytics/hla-system-health-service-map.md)
