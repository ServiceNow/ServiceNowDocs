...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/health-log-analytics/hla-scale-request.html
release: xanadu
...
breadcrumb: [Scaling Health Log Analytics to stream logs at a higher rate, Health Log Analytics administration, Configuring Health Log Analytics, Health Log Analytics, ITOM Health, IT Operations Management]
---
...
**Parent Topic:**[Scaling Health Log Analytics to stream logs at a higher rate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/health-log-analytics/hla-scaling.md)
