...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/health-log-analytics/il-connector-hla-aws-s3-fields.html
release: australia
...
For the Amazon S3 integration setup procedure, see [Set up an Amazon S3 integration for Health Log Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/health-log-analytics/il-connector-hla-aws-s3.md).
