...
5.  On the **Provide details** form, fill in the fields.
    ...
    For a description of the fields, see the **Provide details** table in [TCP integration configuration fields](../reference/il-connector-hla-tcp-fields.md).
...
-   **[TCP integration configuration fields](../reference/il-connector-hla-tcp-fields.md)**  
