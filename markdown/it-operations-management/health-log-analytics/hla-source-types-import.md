...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/health-log-analytics/hla-source-types-import.html
release: xanadu
...
Before performing this procedure, export the source types to an update set. For more information, see [Export source types to an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/health-log-analytics/hla-source-types-migrate.md).
