...
-   **Correlations banner**
    ...
    ![Click More info to open the Correlations list.](../image/correlations-banner.png "Correlations banner")
...
-   **Alerts in group**
    ...
    Click a Log Analytics alert to view its details. To view the full list of Log Analytics alerts, click **View more** or click the **Alerts in group** tab. See [View the list of Log Analytics alerts in a Log Analytics group](../task/hla-op-alerts-in-group.md).

    ![Click a Log Analytics alert to view its details.](../image/alerts-in-group-tabs.png "Viewing alert details")

-   **Configuration Items**

    To view more detailed information on the CIs that are associated with the alerts, click the **Configuration Items** tab or click **View more** in the Configuration Items section. See [Operator phase 1: Analyze and acknowledge an alert](../../event-management-operator/task/operator-phase-acknowledge-analyze.md).
...
-   **[View the list of Log Analytics alerts in a Log Analytics group](../task/hla-op-alerts-in-group.md)**  
