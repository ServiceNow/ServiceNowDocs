...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/hla-op-ovrvw-tab-log-anltcs-alerts.html
release: yokohama
...
For a detailed description of Log Analytics groups, see [Types of Health Log Analytics alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-op-log-analytics-alert-types.md).
...
-   **Correlations banner**
    ...
    \[Omitted image "correlations-banner.png"\] Alt text: Click More info to open the Correlations list.
...
-   **Alerts in group**
    ...
    Click a Log Analytics alert to view its details. To view the full list of Log Analytics alerts, click **View more** or click the **Alerts in group** tab.

    \[Omitted image "alerts-in-group-tabs.png"\] Alt text: Click a Log Analytics alert to view its details.

-   **Configuration Items**

    To view more detailed information on the CIs that are associated with the alerts, click the **Configuration Items** tab or click **View more** in the Configuration Items section. See [Operator phase 1: Analyze and acknowledge an alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/operator-phase-acknowledge-analyze.md).
...
-   **[Log Analytics alerts in the Alerts in group tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-alerts-in-group-ref.md)**  
