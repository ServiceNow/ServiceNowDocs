...
-   **[Configure an Amazon CloudWatch data input in Health Log Analytics manually](../task/hla-data-input-cloudwatch.md)**  
Set up a data input for streaming log data from Amazon CloudWatch to your ServiceNow instance.
-   **[Configure an Amazon S3 data input in Health Log Analytics manually](../task/hla-data-input-s3.md)**  
...
-   **[Configure an Elasticsearch data input in Health Log Analytics manually](../task/hla-data-input-elastic.md)**  
Set up a data input for streaming log data from Elasticsearch indices to your ServiceNow instance.
-   **[Configure a GCP PubSub data input in Health Log Analytics manually](../task/hla-data-input-gcp-pubsub.md)**  
...
-   **[Configure a Microsoft Azure Event Hubs data input in Health Log Analytics manually](../task/hla-data-input-event-hubs.md)**  
Set up a data input for streaming events from Microsoft Azure Event Hubs to your ServiceNow instance.
-   **[Configure a Microsoft Azure Log Analytics data input in Health Log Analytics manually](../task/hla-data-input-azure.md)**  
...
-   **[Configure a MID Server data input in Health Log Analytics manually](../task/hla-data-input-mid-server.md)**  
Set up a data input for collecting and streaming MID Server log messages to your ServiceNow instance.
-   **[Configure a REST API data input in Health Log Analytics manually](../task/hla-data-input-rest-api.md)**  
Set up a REST API data input for streaming log data to your ServiceNow instance.
-   **[Configure a Rsyslog, Filebeat, or Winlogbeat data input in Health Log Analytics manually](../task/hla-data-input-rsyslog-beats.md)**  
Set up a data input for streaming log messages to your ServiceNow instance using an Rsyslog, Filebeat, or Winlogbeat agent.
-   **[Configure a ServiceNow Log Export data input in Health Log Analytics manually](../task/hla-data-input-log-export.md)**  
...
-   **[Configure a ServiceNow System Logs Retriever data input in Health Log Analytics manually](../task/hla-data-input-glide-syslog.md)**  
Set up a data input for streaming log data from the ServiceNow System Log table to the HLA engine \(aka Occultus\).
-   **[Configure a Splunk data input in Health Log Analytics manually](../task/hla-data-input-splunk.md)**  
Set up a data input for streaming log messages to your ServiceNow instance using a Splunk heavy forwarder.
-   **[Configure a Splunk Polling data input in Health Log Analytics manually](../task/hla-data-input-splunk-polling.md)**  
Set up a data input that periodically pulls log data from Splunk by using a query.
-   **[Configure a TCP data input in Health Log Analytics manually](../task/hla-data-input-tcp.md)**  
Set up a data input for sending raw log messages to your ServiceNow instance directly over a TCP/SSL socket.
-   **[Configure a UDP data input in Health Log Analytics manually](../task/hla-data-input-udp.md)**  
Set up a data input for sending raw log messages to your ServiceNow instance directly over a UDP socket.
-   **[Configure a Vector Agent data input in Health Log Analytics manually](../task/hla-data-input-vector-agent.md)**  
