---
title: Configure data inputs \(Amazon CloudWatch\)
description: Configure a data input for streaming log data from Amazon CloudWatch to your ServiceNow instance. Data input configuration is an essential step in setting up the Health Log Analytics \(HLA\) application.
locale: en-US
release: xanadu
...
Configure a data input for streaming log data from Amazon CloudWatch to your ServiceNow instance. Data input configuration is an essential step in setting up the Health Log Analytics \(HLA\) application.
...
5.  Select **Advanced** to set additional configuration fields.
    ...
    For a description of the fields, see [Amazon CloudWatch data input configuration fields](../reference/hla-data-input-cloudwatch-ref.md). For information about configuring the advanced settings later, see [Configure advanced settings for Amazon CloudWatch data inputs](hla-data-input-adv-cloudwatch.md).
...
[Configure advanced settings for Amazon CloudWatch data inputs](hla-data-input-adv-cloudwatch.md)
