...
6.  On the **Provide details** form, fill in the fields.
    ...
    For a description of the fields, see [REST API integration configuration fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/il-connector-hla-restapi-fields.md).
