...
3.  Export the data input to an update set.
    ...
    **Note:** The exported configuration doesn't include the service instance configured for the data input.
    ...
    2.  In the **Export Data Input** dialog, do one of the following:
        ...
        **Note:** You can export source types separately. For more information, see [Export source types to an update set](hla-source-types-migrate.md).
...
Import the update set to the required ServiceNow instance. For more information, see [Import a data input to a target instance](hla-data-input-import.md).
