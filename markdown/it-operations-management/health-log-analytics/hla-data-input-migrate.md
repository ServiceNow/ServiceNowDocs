...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/health-log-analytics/hla-data-input-migrate.html
release: australia
...
For an overview of this feature, see [Migrating a Health Log Analytics data input configuration between instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/health-log-analytics/hla-data-input-migration.md).
...
3.  Export the data input to an update set.
    ...
    **Note:** The exported configuration doesn't include the service instance configured for the data input.
    ...
    2.  In the **Export Data Input** dialog, do one of the following:
        ...
        **Note:** You can export source types separately. For more information, see [Export source types to an update set in Health Log Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/health-log-analytics/hla-source-types-migrate.md).
...
Import the update set to the required ServiceNow instance. For more information, see [Import a Health Log Analytics data input to a target instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/health-log-analytics/hla-data-input-import.md).

**Parent Topic:**[Migrating a Health Log Analytics data input configuration between instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/health-log-analytics/hla-data-input-migration.md)
