---
title: Export a data input configuration
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/hla-data-input-migrate.html
release: yokohama
...
For an overview of this feature, see [Migrating Health Log Analytics data input configurations between instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-data-input-migration.md).
...
3.  Export the data input to an update set.
    ...
    **Note:** The exported configuration doesn't include the service instance configured for the data input.
    ...
    2.  In the **Export Data Input** dialog, do one of the following:
        ...
        **Note:** You can export source types separately. For more information, see [Export source types to an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-source-types-migrate.md).
...
Import the update set to the required ServiceNow instance. For more information, see [Import a data input to a target instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-data-input-import.md).

**Parent Topic:**[Migrating Health Log Analytics data input configurations between instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/hla-data-input-migration.md)
