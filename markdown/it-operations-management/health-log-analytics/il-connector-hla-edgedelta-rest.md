...
6.  On the **Provide details** form, fill in the fields.
    ...
    For a description of the fields, see [Edge Delta REST integration configuration fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/il-connector-hla-edgedelta-rest-fields.md).
