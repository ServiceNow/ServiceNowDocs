...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/il-connector-hla-elastic-fields.html
release: yokohama
...
For the Elasticsearch integration setup procedure, see [Set up an Elasticsearch integration for Health Log Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/il-connector-hla-elasticsearch.md).
