---
title: Configure data inputs \(Splunk\)
description: Configure a data input for streaming log messages to your ServiceNow instance using a Splunk heavy forwarder. Data input configuration is an essential step in setting up the Health Log Analytics \(HLA\) application.
locale: en-US
release: xanadu
...
3.  Choose the Splunk data input.
