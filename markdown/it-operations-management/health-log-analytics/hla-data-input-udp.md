---
title: Configure data inputs \(UDP\)
description: Configure a data input for sending raw log messages to your ServiceNow instance directly over a UDP socket. Data input configuration is an essential step in setting up the Health Log Analytics \(HLA\) application.
locale: en-US
release: xanadu
...
Configure a data input for sending raw log messages to your ServiceNow instance directly over a UDP socket. Data input configuration is an essential step in setting up the Health Log Analytics \(HLA\) application.
