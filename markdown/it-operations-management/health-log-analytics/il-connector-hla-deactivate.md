...
4.  On the **Installed integrations** tab, search for and select the integration tile for the integration you want to deactivate.

5.  On the **Overview** tab, select **Deactivate**.
