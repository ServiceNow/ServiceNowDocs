...
-   **[Amazon CloudWatch data input configuration fields](../reference/hla-data-input-cloudwatch-ref.md)**  
Description of the fields on the Amazon CloudWatch data input configuration form.
-   **[Amazon S3 data input configuration fields](../reference/hla-data-input-s3-ref.md)**  
Description of the fields on the Amazon S3 data input configuration form.
-   **[Apache Kafka data input configuration fields](../reference/hla-data-input-kafka-ref.md)**  
Description of the fields on the Apache Kafka data input configuration form.
-   **[Cribl data input configuration fields](../reference/hla-data-input-cribl-ref.md)**  
Description of the fields on the Cribl data input configuration form.
-   **[Edge Delta data input configuration fields](../reference/hla-data-input-edge-delta-ref.md)**  
Description of the fields on the Edge Delta data input configuration form.
-   **[Elasticsearch data input configuration fields](../reference/hla-data-input-elastic-ref.md)**  
...
-   **[Microsoft Azure Log Analytics data input configuration fields](../reference/hla-data-input-azure-ref.md)**  
...
-   **[ServiceNow Log Export data input configuration fields](../reference/hla-data-input-log-export-ref.md)**  
Description of the fields on the ServiceNow Log Export data input configuration form.
-   **[ServiceNow System Logs Retriever data input configuration fields](../reference/hla-data-input-glide-syslog-ref.md)**  
Description of the fields on the ServiceNow System Logs Retriever data input configuration form.
-   **[Splunk data input configuration fields](../reference/hla-data-input-splunk-ref.md)**  
Description of the fields on the Splunk data input configuration form.
-   **[Splunk Polling data input configuration fields](../reference/hla-data-input-splunk-polling-ref.md)**  
...
-   **[UDP data input configuration fields](../reference/hla-data-input-udp-ref.md)**  
Description of the fields on the UDP data input configuration form.
-   **[Vector Agent data input configuration fields](../reference/hla-data-input-vector-agent-ref.md)**  
