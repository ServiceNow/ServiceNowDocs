...
description: The Overview screen in Health Log Analytics provides a comprehensive view of the components in the log-processing pipeline of active integrations. From this screen, you can troubleshoot any streaming issues and adjust the integration’s settings if needed.
locale: en-US
release: zurich
