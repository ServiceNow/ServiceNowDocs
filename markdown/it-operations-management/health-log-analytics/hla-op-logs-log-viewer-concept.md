...
If you discover an important metric in the log data, you can use it to define a new Log Analytics alert rule. For more information, see [Add a Log Analytics alert rule in Health Log Analytics](../task/hla-op-alert-rule-add-sow.md).
