...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/health-log-analytics/il-connector-hla-firehose.html
release: yokohama
...
6.  On the **Provide details** form, fill in the fields.
    ...
    For a description of the fields, see [Amazon Data Firehose integration configuration fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/health-log-analytics/il-connector-hla-firehose-fields.md).
