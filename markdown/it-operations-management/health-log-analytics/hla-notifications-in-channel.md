---
title: Set up alert notifications in channels
...
**Note:** If you upgrade from an earlier version to Version 33.0.27 - August 2024 or later, redo the setup using the procedure in [Set up alert notifications in a Microsoft Teams channel](hla-notifications-in-ms-teams.md).
