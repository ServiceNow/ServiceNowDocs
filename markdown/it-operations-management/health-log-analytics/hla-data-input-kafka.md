---
title: Configure data inputs \(Apache Kafka\)
description: Configure a data input for streaming log data from Apache Kafka to your ServiceNow instance. Data input configuration is an essential step in setting up the Health Log Analytics \(HLA\) application.
locale: en-US
release: xanadu
...
Configure a data input for streaming log data from Apache Kafka to your ServiceNow instance. Data input configuration is an essential step in setting up the Health Log Analytics \(HLA\) application.
...
5.  Select **Advanced** to set additional configuration fields.
    ...
    For a description of the fields, see [Apache Kafka data input configuration fields](../reference/hla-data-input-kafka-ref.md). For information about configuring the advanced settings later, see [Configure advanced settings for Apache Kafka data inputs](hla-data-input-adv-kafka.md).
...
-   **[Kafka SSL credentials fields](../reference/hla-data-input-kafka-credentials.md)**  
...
[Configure advanced settings for Apache Kafka data inputs](hla-data-input-adv-kafka.md)
