...
-   **[Components installed with Health Log Analytics](../reference/hla-components.md)**  
...
-   **[General guidelines for streaming data to Health Log Analytics](../reference/hla-data-streaming-ref.md)**  
...
-   **[MID Server proxy preconditions for streaming logs to Health Log Analytics](../reference/hla-mid-proxy-configure.md)**  
Requirements for using a MID Server proxy to stream log data to Health Log Analytics.
-   **[Health Log Analytics configuration preferences](../reference/hla-configuration-preferences.md)**  
...
-   **[Health Log Analytics self-health checks, notifications, and proposed actions](../reference/hla-self-health-notifications.md)**  
 Health Log Analytics provides self-health checks, notifications, and proposed problem-solving steps.
-   **[Health Log Analytics language support](../reference/hla-localization.md)**  
Health Log Analytics provides international language support. The default language is US English.
-   **[Domain separation and Health Log Analytics](hla-domain-separation.md)**  
...
-   **[Health Log Analytics severity mapping](../reference/hla-severity-mapping.md)**  
Health Log Analytics \(HLA\) uses common severity values to identify severity labels in the Source Type Structure.
-   **[Integration configuration field descriptions](hla-connector-config-fields.md)**  
This section provides descriptions of the fields on the integration configuration forms for Health Log Analytics.
-   **[Data input configuration field descriptions](hla-data-input-config-fields.md)**  
...
-   **[Information on the Alert Insight Similar Alerts tab](../../health-log-analytics-operator/reference/hla-op-alrt-inst-simlr-alrts-tab.md)**  
...
-   **[Surrounding logs tab fields](../../health-log-analytics-operator/reference/hla-surrounding-logs-tab.md)**  
This section describes the information displayed on the **Surrounding logs** tab.
-   **[Log Viewer table fields](../../health-log-analytics-operator/reference/hla-op-log-viewer-table-ref.md)**  
This section describes the information displayed in the **Log Viewer** table.
-   **[Log correlators form fields](../../health-log-analytics-operator/reference/hla-log-correlators-form-ref.md)**  
This section describes the fields on the Log correlators form.
-   **[Log-based CI candidates fields in Health Log Analytics](../reference/hla-cmdb-enrich-fields.md)**  
