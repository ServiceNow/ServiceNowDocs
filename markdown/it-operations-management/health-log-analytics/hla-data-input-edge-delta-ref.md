...
When choosing the TCP transport option, create a TCP destination in Edge Delta to send log data to the instance from any source. Use the same MID Server host and port you configured for the Edge Delta data input.
...
**Note:** If no relevant service instance exists, [Create an service instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/create-it-services.md) and add CIs to it. Set the status of the new service instance to Operational.
