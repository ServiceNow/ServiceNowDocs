...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/view-test-details.html
release: xanadu
topic_type: task
...
3.  Select a test from the list of tests.
    ...
    The modal displays information about the test including a response body. In this example, it shows that the request was sent to a bad gateway.\[Omitted image "sys-mon-failed\_monitor.png"\] Alt text: A modal displays information about the test including a response body that states that the request was to a bad gateway.
