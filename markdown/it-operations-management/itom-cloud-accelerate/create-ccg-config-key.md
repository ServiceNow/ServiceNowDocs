...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/itom-cloud-accelerate/create-ccg-config-key.html
release: australia
...
3.  On the Configuration Key form, fill in the fields.
    ...
    For the description of the form fields, see [Cloud Configuration Governance Configuration key form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/itom-cloud-accelerate/ccg-config-key-form.md).
