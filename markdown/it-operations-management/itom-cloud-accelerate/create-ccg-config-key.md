...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/itom-cloud-accelerate/create-ccg-config-key.html
release: yokohama
...
3.  On the Configuration Key form, fill in the fields.
    ...
    For the description of the form fields, see [Cloud Configuration Governance Configuration key form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/itom-cloud-accelerate/ccg-config-key-form.md).
