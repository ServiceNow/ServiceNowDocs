...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/itom-cloud-accelerate/create-assume-role-config.html
release: yokohama
...
3.  Fill the values on the Service Account Assume Role Config form.
    ...
    For a description of the form fields, see [Cloud Configuration Governance Service Account Assume Role Config form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/itom-cloud-accelerate/ccg-service-account-assume-role-config-form.md).

4.  Select **Submit**.


**Parent Topic:**[Set up Cloud Configuration Governance for AWS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/itom-cloud-accelerate/set-up-ccg-for-aws.md)
