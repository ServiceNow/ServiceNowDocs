...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/itom-cloud-accelerate/plugin-app-cloud-accelerate.html
release: yokohama
...
|Plugin or application name|Description|
|--------------------------|-----------|
|Cloud Action Library \(sn\_itom\_cal\)|Provides predefined actions and subflows to enable interaction with the cloud resources of your organization. ServiceNow® ITOM Cloud Accelerate features such as Cloud Configuration Governance use these actions to operate.|
