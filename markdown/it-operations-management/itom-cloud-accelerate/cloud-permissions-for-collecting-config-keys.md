...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/itom-cloud-accelerate/cloud-permissions-for-collecting-config-keys.html
release: australia
