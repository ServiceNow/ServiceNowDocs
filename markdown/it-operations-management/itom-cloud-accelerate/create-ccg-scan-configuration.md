...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/itom-cloud-accelerate/create-ccg-scan-configuration.html
release: yokohama
...
3.  Fill the values on the Scan Configuration form.
    ...
    For a description of the form fields, see [Cloud Configuration Governance Scan configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/itom-cloud-accelerate/ccg-scan-configuration-form.md).
