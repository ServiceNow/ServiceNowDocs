...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/itom-cloud-accelerate/create-ccg-scan-configuration.html
release: australia
...
3.  Fill the values on the Scan Configuration form.
    ...
    For a description of the form fields, see [Cloud Configuration Governance Scan configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/itom-cloud-accelerate/ccg-scan-configuration-form.md).
