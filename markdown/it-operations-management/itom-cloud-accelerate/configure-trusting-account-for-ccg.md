...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/itom-cloud-accelerate/configure-trusting-account-for-ccg.html
release: zurich
...
breadcrumb: [Set up Cloud Configuration Governance for AWS, Explore, Cloud Configuration Governance, ITOM Cloud Accelerate, IT Operations Management]
---
...
-   Set up the trusted and the trusting account as described in [Set up Cloud Configuration Governance for AWS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-cloud-accelerate/set-up-ccg-for-aws.md).
