...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/itom-cloud-accelerate/set-up-cloud-action-library-for-aws.html
release: yokohama
...
7.  To use a trusted account to scan the trusting account, configure trusting account for Cloud Action Library.
    ...
    2.  Repeat step [7.a](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/itom-cloud-accelerate/set-up-cloud-action-library-for-aws.md) for each trusting account that needs to be scanned through the trusted account.


**Parent Topic:**[Exploring Cloud Action Library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/itom-cloud-accelerate/exploring-cloud-actions-library.md)
