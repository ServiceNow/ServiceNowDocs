...
description: Create a synthetic monitoring location to run a synthetic monitor. If you plan to run monitors from a ServiceNow Glide instance, you can skip this procedure.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/create-synthetic-monitoring-locations.html
release: xanadu
topic_type: task
...
Create a synthetic monitoring location to run a synthetic monitor. If you plan to run monitors from a ServiceNow Glide instance, you can skip this procedure.
...
[Create and edit a synthetic monitor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/create-synthetic-monitor.md)

**Parent Topic:**[Configuring synthetic monitoring](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/configuring-synthetic-monitoring.md)
