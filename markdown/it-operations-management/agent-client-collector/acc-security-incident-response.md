...
For details on the plugins installed with Security Incident Response, see [Plugins or applications installed with ITOM Health](../../it-operations-management/reference/plugin-app-itom-health.md).
