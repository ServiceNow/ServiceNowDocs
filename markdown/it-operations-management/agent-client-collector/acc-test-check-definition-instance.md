...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/acc-test-check-definition-instance.html
release: yokohama
...
breadcrumb: [Create and edit checks, Collect data from your system devices, Agent Client Collector Framework, Agent Client Collector, IT Operations Management]
---
