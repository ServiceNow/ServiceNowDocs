...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/hla-data-input-acc.html
release: yokohama
...
3.  On the form, fill in the fields.
    ...
    For a description of the fields, see [ACC data input configuration fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/accl-data-input-conf-ref.md).
