...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/agent-client-collector/acc-self-sign-certificate.html
release: zurich
...
breadcrumb: [Create and edit ACC plugins, ACC deployment - servers, Agent Client Collector, IT Operations Management]
---
