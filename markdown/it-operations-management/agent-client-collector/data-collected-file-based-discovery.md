---
title: Data collected by Oracle GLAS using Agent Client Collector for Visibility Content
description: The following tables describe the data collected by Oracle Global License Advisory Services \(GLAS\) using Agent Client Collector for Visibility Content.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/data-collected-file-based-discovery.html
release: yokohama
...
# Data collected by Oracle GLAS using Agent Client Collector for Visibility Content

The following tables describe the data collected by Oracle Global License Advisory Services \(GLAS\) using Agent Client Collector for Visibility Content.
