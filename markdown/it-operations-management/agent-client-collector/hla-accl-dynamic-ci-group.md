...
description: When ACC-L discovers a CI not associated to an application service, it creates a dynamic CI Group and associates the CI to it.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/hla-accl-dynamic-ci-group.html
release: yokohama
...
When ACC-L discovers a CI not associated to an application service, it creates a dynamic CI Group and associates the CI to it.
