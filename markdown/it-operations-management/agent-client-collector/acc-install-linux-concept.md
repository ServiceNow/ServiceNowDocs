...
-   **[Perform a single-line Agent Client Collector installation on Linux using ITOM Cloud Services](../task/acc-install-linux-itom-cloud.md)**  
...
-   **[Uninstall Agent Client Collector from a Linux system](../task/acc-linux-uninstall.md)**  
