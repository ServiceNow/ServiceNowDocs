...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/acc-set-silent-reference.html
release: yokohama
...
To prevent the agent from shutting itself off when CPU reaches a certain threshold, set value to **True**.Default=False
