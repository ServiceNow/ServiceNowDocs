...
To begin discovering packages, you must configure package discovery. See [Configure portable software discovery in Agent Client Collector for Visibility Content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/configure-package-discovery-accvc.md) for step-by-step instructions.

-   **[Configure portable software discovery in Agent Client Collector for Visibility Content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/configure-package-discovery-accvc.md)**  
