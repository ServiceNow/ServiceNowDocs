...
-   Define a new log policy when no policy exists for the CI that you want Agent Client Collector to monitor.
    ...
    For more information, see [Create an Agent Client Collector log policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/hla-acc-log-policies.md). For a general explanation of Agent Client Collector policies, see [Checks and policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/checks-policies.md).
