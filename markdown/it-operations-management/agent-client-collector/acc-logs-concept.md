...
Agent Client Collector logs measure the activity of the Agent Client Collector. Log feedback can be helpful in identifying the areas of the agent with issues if agent performance is less than optimal.
