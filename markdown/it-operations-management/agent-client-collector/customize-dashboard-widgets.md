...
Your customized widgets are saved in the Data Visualizations library, and can be used to configure a customized dashboard \(see [Create a dashboard with the In-line editor](https://www.servicenow.com/docs/access?context=create-db-in-ac&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)\).
