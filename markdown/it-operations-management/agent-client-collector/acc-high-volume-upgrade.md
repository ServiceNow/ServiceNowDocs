...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/acc-high-volume-upgrade.html
release: yokohama
...
2.  Enable the property on the System Properties table \(**All** &gt; **System Properties** &gt; **All Properties**\) to activate the upgrade.
    ...
    1.  Locate the **sn\_agent.auto\_upgrade.enable** property.
