...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/configuring-accv.html
release: yokohama
...
You can then download and install the Agent Client Collector for Visibility - Content \(ACC-VC\) application from the ServiceNow Store or from the instance \[sn\_acc\_visibility\]. See [Agent Client Collector Installation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/acc-installation.md) for details.
