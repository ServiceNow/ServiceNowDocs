...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/check-definition-form.html
release: yokohama
...
</table>-   **[Check definition form parameters tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/check-definition-parameters-tab.md)**  
The Parameters tab definitions for the **Command** field on the check definition form.
-   **[Test check dialog box fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/test-check-dialog-box.md)**  
