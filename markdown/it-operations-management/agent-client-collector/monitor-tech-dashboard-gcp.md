...
-   Create a GCP credential and use it to create a Discovery schedule. For details on creating GCP credentials, see [Google Cloud Platform discovery](../../service-mapping/reference/google-gcp-discovery-pattern.md).
-   Create a Discovery schedule, using the credential created in the previous step. For details on creating a Discovery schedule, see [Google Cloud Platform discovery](../../service-mapping/reference/google-gcp-discovery-pattern.md).
