...
For details on the plugins installed with Agent Client Collector Monitoring, see [Plugins or applications installed with ITOM Health](../../it-operations-management/reference/plugin-app-itom-health.md).
...
|Gather metrics on host data|[Metric Intelligence](../../event-management/concept/operational-metrics.md)|Agent Client Collector administrator|
