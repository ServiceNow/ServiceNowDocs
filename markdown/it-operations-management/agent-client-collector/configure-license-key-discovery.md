...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/configure-license-key-discovery.html
release: yokohama
...
breadcrumb: [License key discovery, Using Agent Client Collector for Visibility - Content, Agent Client Collector for Visibility - Content, Agent Client Collector, IT Operations Management]
---
...
5.  Navigate to the **License Registry Configuration** \[sn\_acc\_vis\_content\_license\_registry\_config\] table and create a record for each registry entry you want to collect.
    ...
    Enter the appropriate values in the fields for each record. For details about the fields, see the [License Registry Configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/license-key-discovery-reference.md) table.
...
**Parent Topic:**[License key discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/license-key-discovery.md)
