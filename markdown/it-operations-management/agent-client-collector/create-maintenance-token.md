...
Uninstall the agent using the maintenance token, as described in [Uninstall an agent using a maintenance token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/uninstall-agent-maintenance-token.md).
