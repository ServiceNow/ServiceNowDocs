...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/accl-log-shipper-alerts.html
release: yokohama
...
2.  Review the information provided in the Alerts list.
    ...
    For details and a description of the columns, see [Monitor incoming alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-operations-workspace-for-itom-apps/t_EMUseAlertConsole.md).


**Related topics**  


[View log shipper events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/accl-log-shipper-events.md)
