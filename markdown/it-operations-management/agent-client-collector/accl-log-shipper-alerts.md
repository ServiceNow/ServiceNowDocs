...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/agent-client-collector/accl-log-shipper-alerts.html
release: zurich
...
\[Omitted image "accl-log-shipper-alerts-list.png"\] Alt text: Log shipper Alerts list.
...
2.  Review the information provided in the Alerts list.
    ...
    For details and a description of the columns, see [Monitor incoming alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-operations-workspace-for-itom-apps/t_EMUseAlertConsole.md).


**Related topics**  


[View log shipper events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/accl-log-shipper-events.md)
