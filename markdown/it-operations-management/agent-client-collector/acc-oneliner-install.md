...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/agent-client-collector/acc-oneliner-install.html
release: xanadu
...
5.  Run the single-line command \(specified in step [2](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/agent-client-collector/acc-oneliner-install.md), above\) on the server where the Agent Client Collector is installed.
