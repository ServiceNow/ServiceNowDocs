...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/acc-oneliner-install.html
release: yokohama
...
5.  Run the single-line command \(specified in step [2](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/acc-oneliner-install.md), above\) on the server where the Agent Client Collector is installed.
...
-   **[Uninstall Agent Client Collector from a Linux system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/acc-linux-uninstall.md)**  
