...
5.  Run the single-line command \(specified in step [2](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/acc-oneliner-install.md), above\) on the server where the Agent Client Collector is installed.
