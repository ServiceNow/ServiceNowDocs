...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/agent-client-collector/monitor-tech-dashboard-aws.html
release: xanadu
...
## Monitoring Technology Dashboard for AWS overview
...
-   Create an AWS credential. For details on creating AWS credentials, see [Set up AWS service accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/setup-aws-service-accounts.md).
