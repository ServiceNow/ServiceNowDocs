...
-   **[Perform a single-line Agent Client Collector installation on macOS](../task/acc-install-macOS-single-line.md)**  
...
-   **[Manually install Agent Client Collector on macOS](../task/acc-install-macOS-manual.md)**  
...
-   **[Upgrade Agent Client Collector manually on a macOS system](../task/acc-macos-upgrade-manual.md)**  
...
-   **[Uninstall Agent Client Collector from macOS using a single-line command](../task/acc-uninstall-mac-single-line.md)**  
...
-   **[Uninstall Agent Client Collector from a macOS machine manually](../task/acc-uninstall-mac-manual.md)**  
...
**Parent Topic:**[Agent Client Collector deployment - endpoints](acc-endpoint-deployment.md)
