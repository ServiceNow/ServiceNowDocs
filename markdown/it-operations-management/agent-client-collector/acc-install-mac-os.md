...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-operations-management/agent-client-collector/acc-install-mac-os.html
release: brazil
...
-   **[Perform a single-line Agent Client Collector installation on macOS when using a MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/acc-install-macOS-single-line.md)**  
...
-   **[Manually install Agent Client Collector on macOS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/acc-install-macOS-manual.md)**  
...
-   **[Upgrade Agent Client Collector manually on a macOS system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/acc-macos-upgrade-manual.md)**  
...
-   **[Uninstall the Agent Client Collector from macOS using a single-line command](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/acc-uninstall-mac-single-line.md)**  
...
-   **[Uninstall the Agent Client Collector from a macOS machine manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/acc-uninstall-mac-manual.md)**  
