...
7.  Determine whether to load-balance the selected multi-proxy agents that monitor the matching CIs in the policy's **Monitored CIs** tab or have each agent monitor the matching CIs.
    ...
    -   To load balance the selected multi-proxy agents that monitor the matching CIs, clear the **Run checks on all proxy agents \(No load balancing\)** option.
        ...
        You can also enable load balancing at a later time, as described in [Enable load balancing between proxy agents in a cluster](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/view-proxy-ci-distribution.md).
...
-   **[Enable load balancing between proxy agents in a cluster](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/view-proxy-ci-distribution.md)**  
