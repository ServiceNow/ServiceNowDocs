...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/accl-streaming-sources-ref.html
release: yokohama
...
breadcrumb: [Identify and resolve log streaming issues, Agent Client Collector Log Analytics, Agent Client Collector, IT Operations Management]
---
