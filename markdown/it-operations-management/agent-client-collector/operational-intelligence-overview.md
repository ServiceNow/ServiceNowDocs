...
Starting with the New York release, Metric Intelligence is part of ITOM Health in the [IT Operations Management](../../it-operations-management/reference/r_ITOMApplications.md) product.
