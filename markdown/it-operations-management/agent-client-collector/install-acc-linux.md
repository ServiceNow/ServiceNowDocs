...
2.  Verify the package signature.
    ...
    2.  Validate the installation file signature by running the indicated commands.
        ...
        -   On a Debian-based system:
            ...
            -   On Debian 12 machines: `dpkg-sig --verify agent-client-collector-<version number>-<distro>_amd64.deb`
            -   On other Debian machines: `sudo gpg --verify agent-client-collector-<version number>-<distro>_amd64.deb`
            For example:
