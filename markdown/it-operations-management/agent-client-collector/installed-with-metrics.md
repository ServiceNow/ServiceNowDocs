...
-   **Default value**: true
-   **Location**: System Property \[sys\_properties\] table
-   **Learn more**: [MID Server distributed cluster for Metric Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/metric-intelligence/ops-intelligence-mid-server.md)
