...
For details on the tables that determine which entries are labeled as irrelevant, see [Software filter tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/sw-filter-tables.md).
...
-   **[Create a custom filter rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/create-custom-filter-rule.md)**  
...
-   **[Review filtered software](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/review-filtered-software.md)**  
