---
title: Create an event rule to map metrics to specific CIs
...
breadcrumb: [Metric binding, Metric Intelligence, Agent Client Collector Monitoring, Agent Client Collector, IT Operations Management]
---
