...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/view-proxy-ci-distribution.html
release: yokohama
...
breadcrumb: [Assign a proxy agent cluster to a policy, Using proxy agents in Agent Client Collector, Agent Client Collector Monitoring, Agent Client Collector, IT Operations Management]
---
