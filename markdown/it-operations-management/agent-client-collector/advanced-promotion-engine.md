...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/agent-client-collector/advanced-promotion-engine.html
release: xanadu
...
Anomaly alerts indicate a deviation from projected metric values for monitored CIs. For details, see [View anomaly alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/agent-client-collector/view-metrics-anomaly-alerts.md).
