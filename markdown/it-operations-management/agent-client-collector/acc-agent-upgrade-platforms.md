...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/acc-agent-upgrade-platforms.html
release: yokohama
...
Agent must run as root or have full sudo access.For information on configuring sudo access, see [Install Agent Client Collector on a Linux system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/install-acc-linux.md).
