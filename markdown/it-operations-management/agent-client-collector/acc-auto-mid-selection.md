...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/agent-client-collector/acc-auto-mid-selection.html
release: zurich
...
Automatic MID Server selection provides several benefits. [MID Server capabilities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/t_ConfigureCapabilities.md) can narrow the list of MID Servers an agent can potential connect to. Automatic MID Server selection keeps the back-end URL configuration list up to date on the agent host without additional work flows.
...
To secure communication between the MID Server and the agent, use the MID Server's unified key store. For details on using the MID Server unified key store, see [MID Server unified key store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-unified-keystore.md).

-   **[Enable automatic MID Server selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/acc-disable-auto-mid-selection.md)**  
...
-   **[Configure the Agent Client Collector capabilities for MID Servers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/configure-acc-capability.md)**  
...
-   **[Configure the automatic MID Server selection based on the Agent Client Collector capabilities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/configure-auto-mid-eligibility-by-capability.md)**  
