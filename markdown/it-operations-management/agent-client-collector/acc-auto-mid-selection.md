...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/acc-auto-mid-selection.html
release: yokohama
...
To secure communication between the MID Server and the agent, use the MID Server's unified key store. For details on using the MID Server unified key store, see [MID Server unified key store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/mid-unified-keystore.md).

-   **[Enable automatic MID Server selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/acc-disable-auto-mid-selection.md)**  
...
-   **[Configure the Agent Client Collector capabilities for MID Servers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/configure-acc-capability.md)**  
...
-   **[Configure the automatic MID Server selection based on the Agent Client Collector capabilities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/configure-auto-mid-eligibility-by-capability.md)**  
...
**Parent Topic:**[Configuring Agent Client Collector with a MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/acc-configuring-with-mid.md)
