---
title: Check definition form parameters tab
description: The Parameters tab definitions for the Command field on the check definition form.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/agent-client-collector/check-definition-parameters-tab.html
release: australia
...
**Parent Topic:**[Agent Client Collector check definition page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/agent-client-collector/check-definition-form.md)
