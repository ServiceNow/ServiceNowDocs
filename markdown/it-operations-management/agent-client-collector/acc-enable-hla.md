...
3.  On the MID Server page for the selected server, select **Setup ACC Log Analytics** in the related links section.
    ...
    **Note:** It is important to configure an ACC data input for every MID Server to which Agent Client Collectors can connect. For more information, see [Set up additional ACC data inputs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/accl-data-input-setup.md).

    The system also prompts you to set up the MID Web Server. For more information, see [MID Web Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/mid-web-server.md).
...
6.  Install the ACC agent on the endpoint machine.
    ...
    **Note:** If you have already installed the ACC agent, proceed to [Agent Client Collector log policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/hla-acc-data-input-log-policies.md).
...
Review the [Agent Client Collector log policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/hla-acc-data-input-log-policies.md).
