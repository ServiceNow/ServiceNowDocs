...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/agent-client-collector/vsphere-metrics.html
release: zurich
...
|disk.used.latest|disk|KiB|Amount of space actually used by the virtual machine or the datastore. This value may be less than the amount provisioned. Factors include whether the virtual machine is powered off and whether snapshots exist.|
