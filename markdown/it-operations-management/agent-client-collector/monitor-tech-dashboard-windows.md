...
On the right side of widgets displaying a single metric, you can select the More options icon \(\[Omitted image "three-vertical-icon.png"\] Alt text: More options icon\) and select **Change group by**. Select the category that you want to view the metric by: Host name, Class, Operating System, or OS Version.

## Windows server dashboard

\[Omitted image "monitor-tech-dash-windows.png"\] Alt text: Windows Server dashboard
