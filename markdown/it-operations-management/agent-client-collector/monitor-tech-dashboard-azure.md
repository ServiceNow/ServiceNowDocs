...
-   Create a Discovery schedule, using the credential created in the previous step. For details on creating a Discovery schedule, see [Discovery for Microsoft Azure Cloud](../../discovery/concept/azure-cloud-discovery.md).
