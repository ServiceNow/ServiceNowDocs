...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-operations-management/agent-client-collector/logs-acc.html
release: brazil
...
-   **[Configure Agent Client Collector log levels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/acc-configure-log-levels.md)**  
...
-   **[View the Agent Client Collector logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/acc-view-log.md)**  
You can view the activity logs for an Agent Client Collector.
-   **[Set the agent log level](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/set-agent-log-level.md)**  
