...
For a list of Agent Client Collector Log Analytics plugin dependencies, see [Plugins or applications installed with ITOM Health](../../it-operations-management/reference/plugin-app-itom-health.md).
