...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/agent-client-collector/create-config-overriding-rule.html
release: australia
...
Configuration setting for which to override its value. Click the \[Omitted image "LookupUsingList.png"\] Alt text: Event Management icon icon to display the list of all configuration settings.

 Click the \[Omitted image "info.png"\] Alt text: Event Management icon icon to display the **Metric Settings** dialog with details such as range of possible values.
...
**anomaly\_detection\_action\_level**
 ...
 For more information, see [Configure the action level for anomaly detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/agent-client-collector/configure-level-anomaly-detection.md).
...
-   **[Synchronize configuration settings rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/agent-client-collector/synch-config-settings-rules.md)**  
...
[Configure multiple MID Servers to work with Agent Client Collector Monitoring](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/agent-client-collector/configure-multiple-mid-acc-monitoring.md)
