...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/agent-client-collector/create-error-task.html
release: yokohama
...
2.  Hover under the search icon to the left an error code.
    ...
    The preview icon \[Omitted image "preview-icon.png"\] Alt text: Preview icon appears.
...
3.  Select the preview icon and select the **Open Record** button on the resulting pop-up window.
    ...
    \[Omitted image "acc-error-message-form.png"\] Alt text: ACC Error Message form
...
4.  Select the **Create ACC Error Task** button to create a task to address the error.
    ...
    \[Omitted image "acc-error-task-page.png"\] Alt text: ACC Error Task page
...
5.  Configure the fields on the page.
    ...
    For details on the available fields, see [ACC Error Task page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/error-task-page.md).
...
[Ignore an Agent Client Collector error](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/ignore-acc-errors.md)
