...
8.  Repeat steps [4](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/acc-enable-log-monitoring-linux.md) and [5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/acc-enable-log-monitoring-linux.md) to monitor logs owned by the root user.
