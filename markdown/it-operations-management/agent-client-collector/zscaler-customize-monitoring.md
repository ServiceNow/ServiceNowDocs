...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/agent-client-collector/zscaler-customize-monitoring.html
release: xanadu
...
For details on customizing the Zscaler monitoring check, see [Perform Zscaler remediation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/agent-client-collector/zscaler-remediation-concept.md).
