...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/create-ccg-config-key.html
release: xanadu
topic_type: task
...
3.  On the Configuration Key form, fill in the fields.
    ...
    For the description of the form fields, see [Cloud Configuration Governance Configuration key form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/ccg-config-key-form.md).
