...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery/r\_CIMProbe.html
release: yokohama
product: Discovery
...
For instructions on configuring probe parameters, see [Set probe parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/t_SetProbeParameters.md).
...
**Parent Topic:**[List of Discovery probes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_ListOfDiscoveryProbes.md)
...
|[Operation Token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md)|The first token of each query must be an , which represents the overall logical operation to be performed.|
|[Component Token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md)|A is a sub-component of an operation token.|
...
[Enumerate Associated Objects](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md) Retrieves objects associated with each result from the preceding query.
...
[Substitution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md) A no-op token that feeds the results of a previous named statement as input into the next query of its own statement.
...
-   The [index token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md) is optional.
-   This token must only be used as the first query in a statement.
-   Returns: class object
-   Example:
...
The following tokens are sub-components of [operation tokens](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md).
...
Retrieves all instances of CIM\_ComputerSystem and their descendants. Retrieves only one [property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md), PrimaryOwnerContact.
...
Retrieves all instances and descendants of CIM\_ComputerSystem that do not have a Name [property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md) of 'runtime'.

 The [filter token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md) \{\{ \}\} filters out instances that do not contain all of the properties/keys specified.
...
1.  [Query](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md) server for all CIM\_ComputerSystem and descendants.
2.  [Filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md) results based on Name property.
3.  [Retrieve the second](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md) instance that passed the filter.
...
Retrieves the Name [property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md) for the first CIM\_OperatingSystem instance of each CIM\_ComputerSystem instance.

 The middle-token, CIM\_RunningOS, is the name of the [Associator class](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/r_CIMProbe.md), not the end-result.
