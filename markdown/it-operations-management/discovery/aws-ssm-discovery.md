...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/aws-ssm-discovery.html
release: australia
product: Discovery
...
Install the MID Server. For more information, see [Install and configure the MID Servers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/mid-server-configuration-cloud.md).
...
-   **Configure MID Server properties**
    ...
    For more information, see [Configure MID Server for AWS S3 access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/configure-mid-server-aws-s3-access.md) and [Configure MID Server for AWS KMS access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/config-mid-server-aws-kms-access.md).
