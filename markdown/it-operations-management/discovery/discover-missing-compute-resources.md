...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/discover-missing-compute-resources.html
release: xanadu
product: Discovery
...
2.  Run a quick discovery for a resource.
    ...
    4.  In the **MID Selection Method** and **MID Server** fields, select the preferred options.
        ...
        For more information, see [MID Server selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/mid-server/c_MIDServerSelector.md).
