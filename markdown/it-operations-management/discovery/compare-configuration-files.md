...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/compare-configuration-files.html
release: zurich
product: Discovery
...
<table id="choicetable_c2k_pxd_bhc"><thead><tr><th align="left" id="d275385e143">

Product

</th><th align="left" id="d275385e146">

Steps

</th></tr></thead><tbody><tr><td id="d275385e152">
...
The Tracked Configuration File Comparison tab opens, displaying the configuration file versions you selected.
    ...
    -   Pink — New line
    -   Gray — Deleted line
3.  Navigate between the changes using the Next difference icon and the Previous difference icon .


**Related topics**  


[Tracked Configuration file form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/tracked-configuration-file-form.md)
