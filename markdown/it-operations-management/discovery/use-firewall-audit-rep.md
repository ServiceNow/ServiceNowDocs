...
-   **[Discover firewall policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/disco-firewall-policies.md)**  
...
-   **[Customize Firewall Audits and Reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/customize-firewall-audit-reporting.md)**  
Configure default policy owner and approval groups for firewall rule change requests to reduce manual data entry.
-   **[Archive firewall rule audit, rule requests, and audit tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/archive-firewall-rule-req-tasks.md)**  
...
**Parent Topic:**[Configuring Firewall Audits and Reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/firewall-audit-report-config.md)
