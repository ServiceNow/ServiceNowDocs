...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/daw-ip-inventory.html
release: zurich
product: Discovery
...
You can also access the IP inventory page from the [Discovery Admin Workspace Settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/discovery-admin-workspace-setup.md) page.
...
-   **New**: Create IP data. For more information, see [Add IP data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/daw-add-ip-data.md).
-   **Add to Range Set**: Map IP data to a range set. For more information, see [Add IP data to a range set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/daw-add-ip-range-set.md).
...
-   **IP Ranges**
    ...
    **Note:** The **Multiple** link is available starting with Discovery Admin Workspace v1.20.0.
    ...
    Select one or more IP ranges from the table to enable the **Add to Range Set** option. For more information, see [Add IP data to a range set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/daw-add-ip-range-set.md).
...
-   **IP Networks**
    ...
    **Note:** The **Multiple** link is available starting with Discovery Admin Workspace v1.20.0.
    ...
    Select one or more IP networks from the table to enable the **Add to Range Set** option. For more information, see [Add IP data to a range set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/daw-add-ip-range-set.md).
