...
3.  Select the cloud provider.
    ...
    1.  Fill the values on the Choose the provider form.
        ...
        For description of the form fields, see [Create a new discovery schedule form reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/create-a-new-discovery-schedule-form.md).
