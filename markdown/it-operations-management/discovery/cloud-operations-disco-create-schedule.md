...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/cloud-operations-disco-create-schedule.html
release: australia
product: Discovery
...
3.  Select the cloud provider.
    ...
    1.  Fill the values on the Choose the provider form.
        ...
        For description of the form fields, see [Create a new discovery schedule form reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/create-a-new-discovery-schedule-form.md).
