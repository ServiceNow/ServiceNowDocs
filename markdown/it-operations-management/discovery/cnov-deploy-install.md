...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/cnov-deploy-install.html
release: zurich
product: Discovery
...
-   **[Display the Kubernetes cluster version in the CMDB](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/cnov-config-see-cluster-version.md)**  
...
-   **[Create a cmdb\_ci\_linux\_server CI for each Kubernetes node](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/cnov-config-linux-server-ci.md)**  
...
-   **[Enable automatic retirement for inactive Kubernetes cluster CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/remove-inactive-cis.md)**  
...
-   **[Define include and exclude lists of Labels and Annotations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/cnov-config-annotations-allowed.md)**  
...
-   **[Add custom Labels and Annotations to Kubernetes resources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/cnov-config-add-custom-labels.md)**  
Add custom Labels and Annotations to all resources deployed by Kubernetes Visibility Agent in the Kubernetes cluster.
-   **[Upgrade Kubernetes Visibility Agent Informers remotely](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/cnov-informer-upgrade-remote.md)**  
...
-   **[Override Informer parameters from the Instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/cnov-params-override.md)**  
