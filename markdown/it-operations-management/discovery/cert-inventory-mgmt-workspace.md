...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/cert-inventory-mgmt-workspace.html
release: zurich
product: Discovery
...
Displays the settings to manage the notifications of this workspace. For more information on setting up these notifications, see [Receive certificate notifications via Microsoft Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/configure-ms-teams-cert-notifications.md) and [Receive certificate notifications via email](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/receive-email-certificate-notifications.md).
