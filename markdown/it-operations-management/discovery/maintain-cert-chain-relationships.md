...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery/maintain-cert-chain-relationships.html
release: yokohama
product: Discovery
...
-   If there is a .txt extension containing two certificates, the first certificate is considered as the server certificate and the second certificate is considered as the root certificate. There are no intermediate certificates.
