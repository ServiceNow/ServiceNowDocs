...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery/create-oci-schedule-DAW.html
release: yokohama
product: Discovery
...
-   Configure an OCI user in the Oracle Cloud console with an API signing key and the required Identity and Access Management \(IAM\) policies. This grants the MID Server access to the cloud resources you plan to discover.
-   You have created a suitable OCI API credentials in the ServiceNow AI Platform to connect with the OCI user you want to use for discovery. For more information, see [Create Oracle API credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/create-oracle-api-credentials.md).
...
<table id="choicetable_bbl_3zw_zgc"><thead><tr><th align="left" id="d479774e317">

Option

</th><th align="left" id="d479774e320">

Description

</th></tr></thead><tbody><tr><td id="d479774e326">
