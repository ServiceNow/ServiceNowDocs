...
Configure CyberArk credentials. For more information, see [Configure CyberArk Certificate Manager SaaS credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/configure-cyberark-venafi-creds.md).
...
3.  On the Certificate Routing Policy form, fill in the fields.
    ...
    For a description of the field values, see [Certificate Routing Policy form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/certificate-routing-policy-form.md).
