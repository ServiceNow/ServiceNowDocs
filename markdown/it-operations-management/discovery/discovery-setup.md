...
Use this method if you want to set up everything you need to use Discovery, including a MID Server. Discovery guided setup provides a sequence of tasks that help you configure Discovery on your ServiceNow instance. To open Discovery guided setup, navigate to **Guided Setup** &gt; **ITOM Guided Setup**.
