...
2.  Filter the command list according to your requirements.
    ...
    For more information about the filtering options, see [Command List form for pattern-based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/commands-list-discovery.md).
