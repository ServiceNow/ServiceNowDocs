...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/view-pattern-command-in-command-list.html
release: zurich
product: Discovery
...
2.  Filter the command list according to your requirements.
    ...
    For more information about the filtering options, see [Command List form for pattern-based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/commands-list-discovery.md).
