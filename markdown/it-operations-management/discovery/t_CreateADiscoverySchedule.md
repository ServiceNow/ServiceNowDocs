...
Make sure to [test your credentials](https://www.servicenow.com/docs/access?context=t_CreateCredential&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) before you run a schedule. Bad credentials are a leading cause of failed discoveries.
...
[MID Server pause](https://www.servicenow.com/docs/access?context=t_PauseTheMIDServer&version=zurich&pubname=zurich-servicenow-platform&section=c_MIDServerPause&ft:locale=en-US)

[MID Server cluster configuration](https://www.servicenow.com/docs/access?context=t_ConfigureAMIDServerCluster&version=zurich&pubname=zurich-servicenow-platform&section=mid-server-clusters&ft:locale=en-US)
