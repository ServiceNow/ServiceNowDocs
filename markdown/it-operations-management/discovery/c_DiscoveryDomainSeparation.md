...
See [MID Server domain separation](https://www.servicenow.com/docs/access?context=c_MIDServerDomainSeparation&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) for instructions on setting up domain separation through the MID Server.
