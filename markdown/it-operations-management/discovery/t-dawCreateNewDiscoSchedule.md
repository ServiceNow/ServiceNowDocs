...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/t-dawCreateNewDiscoSchedule.html
release: zurich
product: Discovery
...
3.  Select **IP-based discovery** and select **Continue**.
    ...
    **Note:** This schedule is only for IP-based Discovery. For Cloud Discovery, see [Create a discovery schedule in Cloud Discovery Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/cloud-operations-disco-create-schedule.md).
