...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/enable-sbom.html
release: xanadu
product: Discovery
...
-   CMDB CI Class Model, is up to date.
-   Visibility Content is up to date.
-   MID Server requirements: 8GB RAM with 4GB JVM and the Scan container images capability. For more information, see [Scan container images](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/container-image-task.md)
...
[Download a software bill of materials \(SBOM\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/generate-sbom-pattern.md)
