...
description: Discovery finds computers, servers, printers, a variety of IP-enabled devices, and the applications that run on them. It can then update the configuration items \(CIs\) in your CMDB with the data it collects.
locale: en-US
release: xanadu
product: Discovery
...
Discovery finds computers, servers, printers, a variety of IP-enabled devices, and the applications that run on them. It can then update the configuration items \(CIs\) in your CMDB with the data it collects.
...
Run this type of discovery to find the internal IP networks within your organization. If you already know the IP address ranges in your network, it is not necessary to run network discovery.For more information, see [Run network Discovery](c_NetworkDiscovery.md#).
...
Run this type of discovery to find the devices, computers, and applications on your network. This is essentially the standard type of discovery that you run most often.For more information, see.
...
Run this type of discovery to find AWS and Azure resources in your organization's cloud.For more information, see.
