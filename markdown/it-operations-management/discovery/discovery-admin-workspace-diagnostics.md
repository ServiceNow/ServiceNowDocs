...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/discovery-admin-workspace-diagnostics.html
release: australia
product: Discovery
...
-   **Refined Codes**
    ...
    Select an error card or the **Occurrences** link within an error card to open the Error Details page. The page displays the root cause, remediation steps, and available actions for that refined code. For more information, see [Discovery Admin Workspace Error Details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/daw-error-details.md).

-   **AI Insights**

    The Errors tab includes an AI Insights panel powered by ServiceNow Otto for Error Framework. The panel analyzes your current Discovery errors and surfaces the following:
    ...
    **Note:** ServiceNow Otto for Error Framework \(com.sn\_ef\_gen\_ai\) is available starting with Australia Patch 3 and requires the ServiceNow Otto for Platform \(sn\_genai\_platform\) plugin. If the plugin is not enabled, the panel displays a prompt to enable it.


For more information about how the Error Framework works, see [Error Framework in Discovery Admin Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/error-framework-daw.md).
