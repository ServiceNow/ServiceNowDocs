...
description: Discovery is available as a separate subscription from the rest of the ServiceNow AI Platform and requires the Discovery \(com.snc.discovery\) plugin.
locale: en-US
release: xanadu
product: Discovery
...
Discovery is available as a separate subscription from the rest of the ServiceNow AI Platform and requires the Discovery \(com.snc.discovery\) plugin.
