...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/aws-config-service-cloud-mgt.html
release: xanadu
product: Discovery
...
5.  Enable **AWS** event recording.
    ...
    5.  Fill the values on the Edit settings form.
        ...
        For a description of the form fields, see [Edit settings form reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/edit-aws-event-recording-settings-form-reference.md).
...
After some events are generated, navigate to the [Cloud User Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/cloudmgt-view-cloud-events.md) to view the events.
