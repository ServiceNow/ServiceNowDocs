...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery/aws-config-service-cloud-mgt.html
release: yokohama
product: Discovery
...
Select **Choose a topic from your account** and select the SNS topic created in [3](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/aws-config-service-cloud-mgt.md).
...
After some events are generated, navigate to the [Cloud User Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/cloudmgt-view-cloud-events.md) to view the events.
