...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/azure-change-processing.html
release: zurich
product: Discovery
...
-   **ACP Resource Type \[sn\_itom\_pattern\_acp\_supported\_resource\_types\]**
    ...
    For more information on adding support for an Azure resource type, see [Add change processing support for an Azure resource type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/add-change-processing-support-azure-resource-type.md).
...
You can [configure Azure change processing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/configure-azure-change-processing.md) to get resource change information from the Microsoft Azure cloud and use it to update the CMDB.

If you’re using the Microsoft Azure alert-driven discovery, then you can [migrate to Azure change processing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/migrate-to-azure-change-processing.md) to improve the change processing performance of the ServiceNow AI Platform and take advantage of the simplified setup.
