...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-operations-management/discovery/azure-change-processing.html
release: brazil
product: Discovery
...
-   **ACP Resource Type \[sn\_itom\_pattern\_acp\_resource\_types\]**

    **Note:** In Discovery and Service Mapping Patterns versions 1.21.0-1.30.2, resource type information was stored in the sn\_itom\_pattern\_acp\_supported\_resource\_types table.
    ...
    For more information on adding support for an Azure resource type, see [Add change processing support for an Azure resource type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/add-change-processing-support-azure-resource-type.md).
...
You can [configure Azure change processing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/configure-azure-change-processing.md) to get resource change information from the Microsoft Azure cloud and use it to update the CMDB.

If you’re using the Microsoft Azure alert-driven discovery, then you can [migrate to Azure change processing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/migrate-to-azure-change-processing.md) to improve the change processing performance of the ServiceNow AI Platform and take advantage of the simplified setup.
