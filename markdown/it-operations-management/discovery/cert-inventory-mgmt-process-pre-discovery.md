...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/cert-inventory-mgmt-process-pre-discovery.html
release: xanadu
product: Discovery
...
Once the pre-discovery phase is completed, move on to the [post-discovery phase](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/cert-inventory-mgmt-process-post-discovery.md).
