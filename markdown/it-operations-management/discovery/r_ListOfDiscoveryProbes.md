...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/r\_ListOfDiscoveryProbes.html
release: xanadu
product: Discovery
...
-   **[CIM probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r_CIMProbe.md)**  
...
-   **[DNS probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/dns-discovery-probe.md)**  
DNS probes determine the DNS names for configuration items \(CI\).
-   **[Horizontal Pattern probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r-HorizontalPatternProbe.md)**  
Discovery uses the Horizontal Pattern probe to launch patterns for horizontal discovery.
-   **[PowerShell probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/c_PowershellProbe.md)**  
The PowerShell Probe executes PowerShell V2 scripts on the MID Server host.
-   **[SCPRelay probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r_SCPRelayProbe.md)**  
...
-   **[SNMP probes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/c_SNMPProbe.md)**  
...
-   **[SSHCommand probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/c_SSHCommandProbe.md)**  
...
-   **[vCenter probes and probe parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/vcenter-probes.md)**  
...
-   **[Windows probes and permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r_DiscoWinProbesAndPermissions.md)**  
Discovery accesses devices and software by executing commands as a specific user on Windows computers.
-   **[WMIRunner probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r_WMIRunnerProbe.md)**  
...
-   **[Port probes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r_PortProbes.md)**  
