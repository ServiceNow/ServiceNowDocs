...
Confirm that AWS SSM Agent discovery is enabled. For more information, see [Enable AWS SSM-based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/enable-aws-ssm-based-discovery.md).
