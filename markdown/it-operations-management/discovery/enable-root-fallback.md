...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/enable-root-fallback.html
release: zurich
product: Discovery
...
Confirm that AWS SSM Agent discovery is enabled. For more information, see [Enable AWS SSM-based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/enable-aws-ssm-based-discovery.md).
