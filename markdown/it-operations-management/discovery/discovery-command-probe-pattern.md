...
For information about MID Server privileged commands, see [MID Server privileged commands](https://www.servicenow.com/docs/access?context=c_PrivilegedCommandsForMIDServer&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
