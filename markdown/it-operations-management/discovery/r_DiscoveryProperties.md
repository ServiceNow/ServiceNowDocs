...
Log Message Length: Limit the maximum message length that is displayed in Discovery Log table. A value of 0 or any negative number disables this limit.
 ...
 **Note:** When this property is enabled, overriding behavior is not applicable on Discovery schedules that use range sets.
