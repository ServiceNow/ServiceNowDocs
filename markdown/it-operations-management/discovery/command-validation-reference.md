...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/command-validation-reference.html
release: australia
product: Discovery
