...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/gcp-stackdriver-service.html
release: xanadu
product: Discovery
...
breadcrumb: [Google Cloud Platform discovery, Discovery for cloud environment, Discovery, ITOM Visibility, IT Operations Management]
---
...
-   Activate Discovery and Service Mapping Patterns. For more information, see [Google Cloud Platform Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/google-gcp-discovery-pattern.md).
-   Verify that Discovery has successfully discovered logical datacenters of the Google Cloud project. For more information, see [Set up a cloud account and service account for Google Cloud Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/gcp-first-cld-and-srvc-accts.md).
