...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/kubernetes-explorer-dash.html
release: australia
product: Discovery
...
-   **Verify that you have the required setup**
    ...
    -   You must have a completed Kubernetes discovery, so that resource data is available to display. For more information, see [Kubernetes discovery using patterns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/kubernetes-discovery.md).
