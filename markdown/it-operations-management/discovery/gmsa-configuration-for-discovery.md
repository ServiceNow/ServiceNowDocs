...
3.  Start the MID Server with the gMSA account following the directions here on using gMSA: [Install a MID Server on Windows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-server-install-prereqs.md)
