...
3.  Start the MID Server with the gMSA account following the directions here on using gMSA: [Install a MID Server on Windows](https://www.servicenow.com/docs/access?context=mid-server-install-prereqs&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
