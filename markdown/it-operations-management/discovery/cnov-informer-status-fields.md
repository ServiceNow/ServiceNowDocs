...
# Agent Client Collector for Kubernetes – Visibility Informer status fields

The fields in the Agent Client Collector for Kubernetes – Visibility Informers table describe the status of the Informer pods deployed in your Kubernetes clusters.
