...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/t\_SetUpLoadBalDiscoBehavr.html
release: zurich
product: Discovery
...
5.  Create a [Discovery schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/t_CreateADiscoverySchedule.md) for each time zone and name the behavior you created.
