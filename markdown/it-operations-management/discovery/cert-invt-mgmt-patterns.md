...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/cert-invt-mgmt-patterns.html
release: xanadu
product: Discovery
...
Allows you to discover certificates by importing certificates from files. [Run Certificate Discovery via certificate file import](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/run-cert-inventory-mgmt-import.md).
...
Discovers certificates as part of AWS Cloud discovery. [AWS Certificate Manager discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/aws-certificate-manager-discovery-pattern.md).
...
Discovers certificates as part of GCP Cloud discovery. [GCP Certificate Manager discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/gcp-certificate-discovery-pattern.md).
...
Discovers certificates as part of Azure Cloud discovery. [Azure Key Vault certificate discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/azure-certificate-discovery-pattern.md).
...
Discovers certificates in the Java KeyStore or Windows Certificate Store. [Java KeyStore and Windows Certificate Store discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/x509-certificates-discovery.md).

</td></tr></tbody>
</table>-   **[AWS Certificate Manager discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/aws-certificate-manager-discovery-pattern.md)**  
...
-   **[GCP Certificate Manager discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/gcp-certificate-discovery-pattern.md)**  
...
-   **[Azure Key Vault certificate discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/azure-certificate-discovery-pattern.md)**  
...
-   **[Java KeyStore and Windows Certificate Store discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/x509-certificates-discovery.md)**  
