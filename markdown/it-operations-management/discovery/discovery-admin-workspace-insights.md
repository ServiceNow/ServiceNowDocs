...
The Discovery Admin Workspace Insights tab provides access to specialized widgets, dashboards, and reports to leverage your organization's IT operations management and infrastructure monitoring, taking advantage of Discovery's capabilities for improved operational visibility and infrastructure health.

## Prerequisites

In order to access the Insights tab, make sure the Discovery plugin is installed and active.
...
You must have the admin or discover\_admin role to access the Discovery Admin Workspace.

## Information accessed through the Insights tab
