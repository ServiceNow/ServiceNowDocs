...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-operations-management/discovery/running-discoveries.html
release: brazil
product: Discovery
...
Ensure that your MID Servers are properly configured before creating a Discovery schedule.
...
2.  Determine what type of discovery to run:
    -   [Run a Configuration item \(CI\) discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/t_CreateADiscoverySchedule.md) to find the devices, computers, and applications on your network. This is the most common type of discovery. Run CI discovery from the Discovery schedule, where you to set up a recurring schedule or run a discovery on demand. The Discovery schedule also provides configuration options for MID Servers and the Shazzam port probe.
    -   [Run a Network Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/c_NetworkDiscovery.md) to find the internal IP networks within your organization. If you already know the IP address ranges in your network, it is not necessary to run Network Discovery. It is intended for organizations that don't have complete knowledge of the IP addresses available for Discovery in their networks.
    -   [Run a Serverless Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/serverless-discovery.md) to find applications on host machines without the need to discover the host first. Serverless Discovery relies on infrastructure patterns to explore CIs on a host. This kind of discovery skips the scanning and classification phases of discovery. You need an advanced knowledge of patterns to use this type of discovery. Refer to [Patterns and horizontal discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/c-UsingPatternsForHorizontalDiscovery.md) to get started with patterns.
3.  After you run a discovery, monitor the results of the discovery and resolve errors if they occurred:
    -   [Use the Discovery status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/c_DiscoveryStatus.md) to see a summary of a discovery and to access the ECC queue. The ECC queue shows probe and sensor activity and the actual XML payload that is sent to or from an instance.
    -   Use the [Discovery Admin Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/discovery-admin-workspace.md) to monitor ongoing Discovery operations.
...
[Discovery resource utilization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/discovery-resource-utilization.md)
