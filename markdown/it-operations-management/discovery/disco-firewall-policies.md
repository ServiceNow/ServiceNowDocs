...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/disco-firewall-policies.html
release: xanadu
product: Discovery
...
2.  Enter the Panorama API key.
    ...
    For more information, see [Credential aliases for Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/connections-and-credentials/discovery-credential-alias.md).
...
3.  To create a Discovery schedule, perform the following steps.
    ...
    For more information on Discovery schedule, see [Schedule a horizontal discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/t_CreateADiscoverySchedule.md).
...
5.  In the Serverless Execution pattern, perform the following steps.
    ...
    1.  Select **PaloAlto - Firewall Manager**.
    2.  Select **Run Child Patterns**.
    3.  Select **Submit**.
6.  Navigate to **Discovery Pattern Launcher Parameters** and set the following three parameters.
    ...
    -   trustInsecureHosts: Set to **true** to bypass handshake.
