...
2.  Create a credential alias for the API key credential created in the previous step.
    ...
    You provide this credential alias in the discovery schedule configuration. For more information, see [Credential aliases for Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/discovery-credential-alias.md).
