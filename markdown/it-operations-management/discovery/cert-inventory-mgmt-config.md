...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/cert-inventory-mgmt-config.html
release: xanadu
product: Discovery
