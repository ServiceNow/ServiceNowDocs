...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/cert-inventory-mgmt-config.html
release: australia
product: Discovery
