...
-   **Enable the data collection**
    ...
    Run a Discovery schedule. For more information, see: [Running discoveries in your network](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/running-discoveries.md).
