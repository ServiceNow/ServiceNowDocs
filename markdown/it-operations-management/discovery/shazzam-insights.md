...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/shazzam-insights.html
release: australia
product: Discovery
...
-   **Enable the data collection**
    ...
    Run a Discovery schedule. For more information, see: [Running discoveries in your network](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/running-discoveries.md).
