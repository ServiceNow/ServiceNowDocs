...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/configure-azure-change-processing.html
release: xanadu
product: Discovery
...
breadcrumb: [Azure change processing, Azure Cloud Discovery, Discovery for cloud environment, Discovery, ITOM Visibility, IT Operations Management]
---
...
For information about the resources which are supported by Azure change processing, see [Azure change processing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/azure-change-processing.md).
