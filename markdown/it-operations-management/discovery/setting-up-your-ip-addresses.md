...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/setting-up-your-ip-addresses.html
release: australia
product: Discovery
...
|Type - IP Network|The Network IP field appears. Enter the IP address of the network. For more information, see [Discovery IP address configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/discovery-ip-address-configuration.md).|
