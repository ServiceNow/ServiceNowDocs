...
Using the Certificate Inventory and Management, you can [Run Certificate Discovery via port scans](../task/run-cert-inventory-mgmt-ports.md), [Run Certificate Discovery via individual URL scans](../task/run-cert-inventory-mgmt-urls.md), and [Run IP-Based Certificate Discovery](../task/run-ip-based-certificate-discovery.md).
