...
description: Performance tests are available for Kubernetes Visibility Agent \(KVA\) \(former CNO for Visibility\) to help you estimate the load, memory, CPU, etc., on the Instance as well as on the Kubernetes cluster.
locale: en-US
release: australia
product: Discovery
