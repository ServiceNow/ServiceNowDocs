...
description: When you perform discovery with a pattern, you can choose what to do with configuration items \(CIs\) that are in the CMDB but Discovery can no longer find.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/deletion-strategy.html
release: xanadu
product: Discovery
...
-   **[Set a deletion strategy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/set-deletion-strategy.md)**  
