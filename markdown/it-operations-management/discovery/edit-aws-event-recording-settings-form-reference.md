...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/edit-aws-event-recording-settings-form-reference.html
release: xanadu
product: Discovery
...
2.  Select the Amazon SNS topic created in step [3](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/aws-config-service-cloud-mgt.md) from the SNS topic name drop-down list.

</td></tr></tbody>
</table>**Parent Topic:**[Cloud Discovery reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/cloud-discovery-reference.md)
