...
|Provision for requesting a new firewall rule using the Service Catalog.|[Firewall rule requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-operations-management/discovery/firewall-requests.md)|Firewall Requester \[sn\_disco\_firewall.firewall\_requester\]|
