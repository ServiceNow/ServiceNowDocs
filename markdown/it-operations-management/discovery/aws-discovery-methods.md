...
-   You must provide ITOM Visibility with access permissions. For more information, see [Set up AWS service accounts](../concept/setup-aws-service-accounts.md)
...
[Service Graph Connector for AWS](https://www.servicenow.com/docs/access?context=cmdb-integration-aws-sg&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)

</td><td>

[Configure Service Graph Connector for AWS using the guided setup](https://www.servicenow.com/docs/access?context=configure-aws-integration&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
