...
[Service Graph Connector for AWS](https://www.servicenow.com/docs/access?context=cmdb-integration-aws-sg&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)

</td><td>

[Configure Service Graph Connector for AWS using the guided setup](https://www.servicenow.com/docs/access?context=configure-aws-integration&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)
