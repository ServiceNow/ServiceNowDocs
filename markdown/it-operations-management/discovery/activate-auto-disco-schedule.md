...
-   You have installed and configured Service Graph Connector Central \(SGC Central\) v2.4.0. For more information, see Configuring SGC Central.
-   You have installed and configured Service Graph Connector for Infoblox v1.5.0. For more information, see Configure Service Graph Connector for Infoblox using SGC Central.
...
5.  Select the **MID Server** drop-down list and choose a MID Server selection method.
    ...
    |**Specific MID Cluster**|Select this option to search for an existing MID Server cluster. Clusters provide failover protection and load balancing between MID Servers. See Configure a MID Server cluster for more information.|
