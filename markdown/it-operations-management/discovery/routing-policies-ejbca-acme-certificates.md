...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/routing-policies-ejbca-acme-certificates.html
release: australia
product: Discovery
...
3.  On the Certificate Routing Policy form, fill in the fields.
    ...
    For a description of the field values, see [Certificate routing policy form for EJBCA ACME](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/certificate-routing-policy-form-table.md).
