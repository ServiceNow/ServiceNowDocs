...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/c\_NetworkDiscovery.html
release: zurich
product: Discovery
...
Network discovery debugging: Enables extensive logging of all Network Discovery activities on the instance.
 ...
 -   Type: true \| false
-   Default value true
-   Learn More: [Discovery monitoring and issue resolution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/c_DiscoveryTroubleshooting.md)
...
Configure [SNMP credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/c_SNMPCredentials.md), and keep port 161 open for SNMP access.
...
5.  In **Related Links**, select **Create Range Sets**.
    ...
    The [Discovery Status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/c_DiscoveryStatus.md) page appears, displaying the progress of the conversion. The system increments the **Started** and **Completed** count of IP networks, until all the networks are converted.


### What to do next

Add discovery range sets to [Discovery schedules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/t_CreateADiscoverySchedule.md).
...
1.  Open a [Discovery schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/t_CreateADiscoverySchedule.md).
...
4.  On the **Discovery Range Set** form, add a [Discovery behavior](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/c_DiscoveryBehaviors.md) if necessary.
