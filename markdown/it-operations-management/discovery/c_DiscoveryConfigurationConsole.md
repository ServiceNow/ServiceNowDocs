...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/c\_DiscoveryConfigurationConsole.html
release: australia
product: Discovery
...
2.  Select the toggle to enable [File-based Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/file-based-discovery.md).
...
File-based Discovery is now enabled, configured, and ready for you to run. See [Run File-based Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/run-file-based-discovery.md) for more information.
