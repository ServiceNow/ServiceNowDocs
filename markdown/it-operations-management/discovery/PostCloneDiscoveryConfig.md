...
After completing the [Request a clone in the Clone Admin Console](https://www.servicenow.com/docs/access?context=clone-ui-request-clone&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) process, post-clone configuration is determined by the MID Server selection method you chose in the Discovery schedule on the source instance.
