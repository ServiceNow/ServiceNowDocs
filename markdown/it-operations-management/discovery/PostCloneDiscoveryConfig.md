...
After completing the [Request a clone](https://www.servicenow.com/docs/access?context=t_StartAClone&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) process, post-clone configuration is determined by the MID Server selection method you chose in the Discovery schedule on the source instance.
...
[Managing Instance Clone](https://www.servicenow.com/docs/access?context=using-instance-clone&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
