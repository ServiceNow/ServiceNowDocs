...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery/PostCloneDiscoveryConfig.html
release: yokohama
product: Discovery
...
After completing the [Request a clone](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_StartAClone.md) process, post-clone configuration is determined by the MID Server selection method you chose in the Discovery schedule on the source instance.
...
[Managing Instance Clone](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/using-instance-clone.md)
