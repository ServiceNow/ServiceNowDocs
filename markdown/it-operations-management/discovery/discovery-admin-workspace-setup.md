...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/discovery-admin-workspace-setup.html
release: zurich
product: Discovery
...
-   **Targeted URL discovery**
    ...
    -   Individual: Complete the required fields in the Add new URL form and select **Save**.
        ...
        **Note:** For a description of the fields in this form, see [URL Discovery insights dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/url-disco-insights.md).
