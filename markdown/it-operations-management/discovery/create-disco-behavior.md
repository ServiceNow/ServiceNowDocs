...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery/create-disco-behavior.html
release: yokohama
product: Discovery
...
Enter the actual name of the MID Server \(`mid_server`\) or domain \(`win_domain`\) to pass to Discovery for this criteria. This field can also have a value of `mid_domain`, which defines the Windows domain of the MID Server that is processing the Shazzam results.
    ...
    The following graphic shows an example of functionality criteria. \[Omitted image "DiscoveryFunctionalityCriteria.png"\] Alt text: Discovery functionality criteria


## What to do next

[Schedule a horizontal discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/t_CreateADiscoverySchedule.md) of type **Configuration Item**, and select **Use Behavior** for the MID Server selection method.
