...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/run-file-based-discovery.html
release: zurich
product: Discovery
...
2.  [Activate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_RequestAPlugin.md) the File-based Discovery plugin.
...
4.  Configure File-based Discovery scans.
    ...
    1.  Using the [Discovery Configuration Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/c_DiscoveryConfigurationConsole.md), expand **Common** and then enter the maximum number of files that you want to discover.
