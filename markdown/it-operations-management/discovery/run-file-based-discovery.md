...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery/run-file-based-discovery.html
release: australia
product: Discovery
...
4.  Configure File-based Discovery scans.
    ...
    1.  Using the [Discovery Configuration Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/c_DiscoveryConfigurationConsole.md), expand **Common** and then enter the maximum number of files that you want to discover.
