...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery/ip-based-cert-discovery-schedule-table.html
release: yokohama
product: Discovery
...
Enter a name for your IP Based Discovery Schedule.
...
Select a MID Server. **Warning:** Warning: Make sure that your IP address is accessible to the MID Server you’re using. If it doesn’t, you have to [Credential aliases for Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/discovery-credential-alias.md).
...
Set the frequency that you want the Discovery to run. Daily, Weekly, Monthly, and so on
