...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/run-process-filters.html
release: xanadu
product: Discovery
...
To add processes to the filter, you need to setup configurations using the Running Process filter record \[running\_process\_filter\]. These records make sure the filtered processes do not populate the Running process \[cmdb\_running\_process\] table.
...
A name for the configuration type. Running process filters can be grouped however you want so that it easier to identify and choose in the table.
...
Any process matching the filter will not be added to the cmdb\_running\_process table.
...
-   parameters does not contain iissvcs
 For information on setting filter conditions see: [Condition builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/c_ConditionBuilder.md)
...
There are Linux and Windows filters to choose from. See [Out-of-the-box process filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/out-of-the-box-process-filters.md) for more details.

</td></tr></tbody>
</table>3.  Enter the details and click **Submit**.


-   **[Out-of-the-box process filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/out-of-the-box-process-filters.md)**  
