...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/file-based-discovery-references.html
release: zurich
product: Discovery
...
-   **Scan UNIX file names**: The number of unique file names used to identify installed software on UNIX is relatively small. The complete list of file names is included in the UNIX probe, which filters discovered files against the signature list on the target. No additional filtering is required until the results are returned to the instance.
...
If you're experiencing any issues when setting up or running File-based Discovery, see [File-based Discovery issue resolution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/file-based-discovery-troubleshooting.md).

**Related topics**  


[File-based Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/file-based-discovery.md)
