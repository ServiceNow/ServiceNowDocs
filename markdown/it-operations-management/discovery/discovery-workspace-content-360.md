...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/discovery-workspace-content-360.html
release: zurich
product: Discovery
...
-   **AI-suggested application fingerprints**
    ...
    For more information about discovery based on application fingerprints, see [Discover applications based on fingerprints](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/discover-application-based-process.md).
...
-   **ITOM Content Service**
    ...
    To learn more about ITOM Content Service, see [ITOM Content Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/discovery-content-services.md).
    ...
    **Sharing data on ITOM Content Service**
    ...
    For more information, see [Share data on ITOM Content Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/share-data-itom-content-service.md).
