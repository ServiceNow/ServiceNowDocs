...
description: Using Discovery Admin Workspace Content 360, you can discover applications and evaluate application suggestions based on machine learning or crowd-sourced resources. Then, create configuration items with a single click.
locale: en-US
release: xanadu
product: Discovery
...
Using Discovery Admin Workspace Content 360, you can discover applications and evaluate application suggestions based on machine learning or crowd-sourced resources. Then, create configuration items with a single click.

The Discovery Admin Workspace Content 360 uses data visualizations to offer extensive visibility of your infrastructure's applications and the resources available to create application configuration items \(CIs\). It also provides access to a list of classifiers to add to discovery. Refresh the page to view the most up-to-date visualizations.
...
The following roles have access to Discovery Admin Workspace Content 360:
