...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/r-HorizontalPatternProbe.html
release: xanadu
product: Discovery
...
Control how the MID Server splits payloads and handles payloads using properties. See [MID Server properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/mid-server/r_MIDServerProperties.md) for more information.
