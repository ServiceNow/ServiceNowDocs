...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery/r-HorizontalPatternProbe.html
release: yokohama
product: Discovery
...
Control how the MID Server splits payloads and handles payloads using properties. See [MID Server properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/mid-server/r_MIDServerProperties.md) for more information.
