...
10. To test the pattern, click **Debug Mode** and fill in values for the input parameters.
    ...
    ![Example debugging of an HTTP Get Call](../image/debug-serverless-example.png "Example debugging of an HTTP Get Call")
...
Ensure you have [basic authentication credentials](https://www.servicenow.com/docs/access?context=r_BasicAuthCredentialsForm&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) for HTTP calls in the pattern.
