...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery/configuring-automated-certificate-renewal.html
release: zurich
product: Discovery
...
To automatically renew your certificates before they expire, use the automated certificate renewal workflow or the certificate renewal AI agent.
...
3.  [Configure automatic certificate renewal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/config-sys-props-for-auto-cert-renewal.md). This step is optional if you use the certificate renewal AI agent.
