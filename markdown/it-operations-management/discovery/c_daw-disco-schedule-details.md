...
description: Discovery Admin Workspace enables you to conveniently view, edit, and run IP-based Discovery schedules conveniently within a single interface.
locale: en-US
...
Discovery Admin Workspace enables you to conveniently view, edit, and run IP-based Discovery schedules conveniently within a single interface.
...
**Important:** Anomaly information displays only when anomaly detection is enabled. For more information, see [Discovery Admin Workspace Settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-operations-management/discovery/discovery-admin-workspace-setup.md).
