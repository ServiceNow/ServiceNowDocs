...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/track-configuration-files.html
release: xanadu
product: Discovery
...
Configure the system to collect information about changes in configuration files belonging to a configuration item \(CI\). Service Mapping uses this information to notify users that CI configuration files changed and to view actual changes to configuration files directly in the application service maps.
...
-   For CI types representing applications, [create a Discovery process classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/t_CreateAProcessClassification.md) for the relevant pattern. Add the [Horizontal Pattern](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r-HorizontalPatternProbe.md) probe in the **Probe** column, and then specify your pattern in the **Pattern** column.
...
3.  Click the **Tracked Files** tab.
    ...
    One or more tracked file definitions appear by default for Discovery [patterns that support configuration file tracking](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/tracked-config-files.md).
    ...
    \[Omitted image "tracked-files-tab.png"\] Alt text: Tracked files on the IIS pattern
...
5.  Fill out or modify the form fields \(see table\):
    ...
    \[Omitted image "tracked-file-definition.png"\] Alt text: An example tracked file definition for IIS Server discovery
...
7.  If necessary, set the tracked files deletion strategy as described in [Set the deletion strategy for tracked configuration files](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/set-config-file-deletion-strategy.md)
...
2.  On the Changes tab, check that the list includes a record of the change you made. For example, that the configuration file was added, modified or deleted.
    ...
    \[Omitted image "MapTrackedFilesAdded.png"\] Alt text: Configuration files added
