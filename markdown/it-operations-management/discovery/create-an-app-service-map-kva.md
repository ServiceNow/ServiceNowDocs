...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/create-an-app-service-map-kva.html
release: xanadu
product: Discovery
