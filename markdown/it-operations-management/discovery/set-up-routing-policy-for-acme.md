...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery/set-up-routing-policy-for-acme.html
release: yokohama
product: Discovery
...
breadcrumb: [Configuring ACME, Automated Certificate Management Environment, ITOM Visibility, IT Operations Management]
---
...
3.  On the **Certificate Routing Policy** form, fill in the fields.
    ...
    For the description of the field values, see [Certificate Routing Policy form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/certificate-routing-policy-field-values.md).
