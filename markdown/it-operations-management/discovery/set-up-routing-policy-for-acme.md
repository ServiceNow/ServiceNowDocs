...
3.  On the **Certificate Routing Policy** form, fill in the fields.
    ...
    For a description of the field values, see [Certificate Routing Policy form for ACME](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/certificate-routing-policy-field-values.md).
