...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery/use-automated-flow-cert-requests.html
release: yokohama
product: Discovery
...
4.  Create the certificate credential and map it to the credential alias.
    ...
    Each credential should map using a unique credential alias. For more information, see [Credential alias for Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/connections-and-credentials/discovery-credential-alias.md).
