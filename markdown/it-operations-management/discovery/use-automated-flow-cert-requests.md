...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/use-automated-flow-cert-requests.html
release: xanadu
product: Discovery
...
4.  Create the certificate credential and map it to the credential alias.
    ...
    Each credential should map using a unique credential alias. For more information, see [Credential alias for Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/connections-and-credentials/discovery-credential-alias.md).
