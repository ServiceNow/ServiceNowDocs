...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/c\_DiscoveryProbesAndSensors.html
release: xanadu
product: Discovery
...
\[Omitted image "ECCQueueOutput.png"\] Alt text: The ECC queue
...
\[Omitted image "ECCQueueInput.png"\] Alt text: ECC queue record
...
\[Omitted image "MultisensorExample.png"\] Alt text: The MultiSensor form
...
</table>-   **[List of Discovery probes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r_ListOfDiscoveryProbes.md)**  
A wide variety of probes exist for the Discovery application to detect elements on your network.
-   **[Discovery sensors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r_Sensors.md)**  
Every probe in Discovery must have a corresponding sensor to process the data returned.
-   **[Discovery probe management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r_Probes.md)**  
...
-   **[Align versions of customized probes and sensors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/t_AlignVerCustProbeSens.md)**  
...
-   **[Discovery multiprobes and multisensors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/r_MultiprobesIncludedWithDiscovery.md)**  
...
-   **[Example custom Discovery probe and sensor: populate a CI with text file values](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/t_CustomProbeTextFile.md)**  
