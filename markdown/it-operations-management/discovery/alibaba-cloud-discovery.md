...
[Create the MID Server user and grant the role](https://www.servicenow.com/docs/access?context=t_SetupMIDServerRole&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
...
[Validate the MID Server](https://www.servicenow.com/docs/access?context=t_ValidateAMIDServer&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
...
[Managing roles](https://www.servicenow.com/docs/access?context=ua-creating-roles&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
