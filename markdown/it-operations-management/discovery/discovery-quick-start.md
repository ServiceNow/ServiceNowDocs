...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery/discovery-quick-start.html
release: xanadu
product: Discovery
...
Before using Discovery Quick Start, install and validate MID Servers. See [MID Server installation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/mid-server/mid-server-installation.md) for details.
...
6.  View subnet discovery results.
    ...
    3.  Click **Advanced View** to see the Automation Status Set form.
...
You should perform this procedure after you complete [Configure and schedule subnet discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/discovery-quick-start.md) in the Discovery Quick Start.
...
1.  In the **Add Credentials** tab in the Discovery Quick Start, create the credentials necessary to discover CIs in your network.
    ...
    1.  Select the credential type you want to manage from the **Type** field.
        ...
        All the credentials currently configured for that CI type appear in rows of tiles.\[Omitted image "credentials-ci-disco-accel.png"\] Alt text: Create credentials for CI Discovery
