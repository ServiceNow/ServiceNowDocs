...
You must have AI Agents for SLO and Service Reliability Management \(SRM\) installed on your instance. For more information, see Install Now Assist plugins and [Install Service Reliability Management from Admin Center or ServiceNow Store](../../service-reliability/task/sr-install-sr-store-app.md).
...
<table id="choicetable_bxh_g3y_23c"><thead><tr><th align="left" id="d473469e166">

Setting

</th><th align="left" id="d473469e169">

Description

</th></tr></thead><tbody><tr><td id="d473469e175">
