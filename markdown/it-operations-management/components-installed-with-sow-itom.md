...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/components-installed-with-sow-itom.html
release: australia
...
</table>To return to the procedure, see [Install Service Operations Workspace for ITOM application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/install-sow-itom-apps.md).
