...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/tag-governance/configuring-tag-governance.html
release: xanadu
...
-   [Install Tag Governance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/tag-governance/install-tag-governance.md)

    Install the Tag Governance app to execute tag audits, view the Tag Data Governance dashboard, and perform tag remediation.

    To view the list of plugins and applications installed with Tag Governance, including any dependencies, see [Plugins or applications installed with ITOM Visibility](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/itom-visibility/plugin-app-itom-visibility.md).
