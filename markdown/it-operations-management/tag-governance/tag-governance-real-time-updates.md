...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/tag-governance/tag-governance-real-time-updates.html
release: australia
...
-   [Configure the Google Cloud's Operations Suite Logging service to auto-update the CMDB](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/gcp-stackdriver-service.md)
