...
Configure tag policies and remediation policies. See [Configure a tag policy for Tag Governance](configure-tag-governance-policy.md) and [Configure auto-remediation tag policies](configure-remediation-tag-governance-.md).
