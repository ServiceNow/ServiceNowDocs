...
2.  Select **New** and then fill in the Tag Policies form.
    ...
    The form fields are described in [Tag Policies form](../../itom-governance/reference/tag-gov-tag-policies-form.md).
...
-   For more information see, [Flows](https://www.servicenow.com/docs/access?context=flows&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US) and [Subflows](https://www.servicenow.com/docs/access?context=subflows&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
