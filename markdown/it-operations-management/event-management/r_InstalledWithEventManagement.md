...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/r\_InstalledWithEventManagement.html
release: yokohama
...
Calculate [alert priority](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/alert-priority.md). Two Alert Priority Queue jobs are active and available and can be run multi-thread. Runs every minute.
...
Calculate [license usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/license-usage.md). Runs once every hour.
