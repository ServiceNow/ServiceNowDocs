...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/dependency-view-map.html
release: xanadu
...
4.  Scroll down and select the **Activities** tab.
    ...
    \[Omitted image "em-open-dependency-map.png"\] Alt text: Select the link to view dependency map.

5.  Select the link to see the dependency view of the CMDB alerts.

    \[Omitted image "em-view-dependency-map.png"\] Alt text: View dependency map for CMDB alerts.
