...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/mid-web-server-api-key-authentication.html
release: xanadu
...
Create a MID Web Server extension to use API Key authentication, as described in [Configure the MID Web Server extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/configure-mid-web-server-extension.md). Ensure that you select **API Key** in the extension's **Authentication Type** field.
...
**Parent Topic:**[Configure the MID Web Server extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/configure-mid-web-server-extension.md)
