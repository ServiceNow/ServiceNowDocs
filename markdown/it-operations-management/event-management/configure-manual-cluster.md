...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/configure-manual-cluster.html
release: yokohama
...
For more information, see [Alert impact calculation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/c_EMImpactCalculation.md).
...
3.  In the **Select a Service containing this manual cluster** section, select an application service to contain the new manual cluster based on a specific CI or general CI class.
    ...
    2.  In the CMDB CI Service \[cmdb\_ci\_service\_discovered\] table, select a manually created service.
        ...
        To define a new application service, see [Manually create an application service in Event Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/create-an-application-service.md).
