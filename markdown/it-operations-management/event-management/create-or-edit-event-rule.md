...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/event-management/create-or-edit-event-rule.html
release: zurich
...
You can refresh an existing event rule with new event data. For more information see, [Refresh event rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/refresh-event-rule.md).
...
Configure event rules to automatically bind alerts to CI information from the CMDB. See [Binding alerts to CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/ci-binding-alert.md).
...
[Pattern matching](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/c_PatternMatching.md)
