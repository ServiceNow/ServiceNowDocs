...
3.  Configure the fields on the [Event Management tag based alert grouping definition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/tag-based-alert-clustering-definition-form.md).
