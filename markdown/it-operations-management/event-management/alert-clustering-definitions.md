...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/alert-clustering-definitions.html
release: yokohama
...
3.  Configure the fields on the [Event Management tag based alert clustering definition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/tag-based-alert-clustering-definition-form.md).
