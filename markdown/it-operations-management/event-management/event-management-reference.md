...
-   **[List of predefined alert clustering tags](alert-clustering-predefined-tag-list.md)**  
A list of the predefined alert clustering tags provided with the Tag Based Alert Clustering Engine  application.
-   **[Event Management tag based alert clustering definition form](tag-based-alert-clustering-definition-form.md)**  
...
-   **[List of predefined tag-based alert clustering definitions](alert-clustering-predefined-definition-list.md)**  
