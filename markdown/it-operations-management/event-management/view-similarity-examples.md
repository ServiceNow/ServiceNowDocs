...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/view-similarity-examples.html
release: yokohama
...
Train a similarity solution in a ServiceNow datacenter. For more information, see [Create an Event Management similarity solution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/create-solution-similarity.md).
