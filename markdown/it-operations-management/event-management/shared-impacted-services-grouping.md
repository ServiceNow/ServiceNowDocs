...
The Shared impacted services alert grouping automatically gathers related alerts under the business service they affect. When your IT environment generates multiple alerts at once, your team gets one focused, organized view instead of a flood of disconnected notifications.

The Shared impacted services alert grouping feature solves this by automatically gathering related alerts into one place. It looks at each alert and figures out which business service is ultimately affected — for example, Online Payments or HR Portal. All alerts that point to the same service are grouped together.
