...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/t\_EMCreateSLADefForCI\_BS.html
release: yokohama
...
3.  Fill out the fields on the SLA Definition form.
    ...
    For a description of each field, see [Create an SLA definition for a CI or application service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/t_EMCreateSLADefForCI_BS.md).
