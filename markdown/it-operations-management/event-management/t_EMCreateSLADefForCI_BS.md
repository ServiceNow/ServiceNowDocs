...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/t\_EMCreateSLADefForCI\_BS.html
release: xanadu
...
3.  Fill out the fields on the SLA Definition form.
    ...
    For a description of each field, see [Create an SLA definition for a CI or application service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/t_EMCreateSLADefForCI_BS.md).
...
**CI** **Note:** Event Management SLAs work only on CI classes from Application Service \[cmdb\_ci\_service\_auto\].
