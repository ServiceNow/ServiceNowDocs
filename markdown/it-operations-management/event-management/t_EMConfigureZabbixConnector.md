...
3.  On the form, fill in the fields.
    ...
    |Credential|Select the credential with basic authentication that you created for this connector. For more information, see [Create Zabbix server credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/create-credentials-zabbix.md).|
...
-   **[Create Zabbix server credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/create-credentials-zabbix.md)**  
