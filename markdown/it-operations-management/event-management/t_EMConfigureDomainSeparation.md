...
For more information on domain separation in the Flow Designer, see [Domain separation and Flow Designer.](https://www.servicenow.com/docs/access?context=flow-designer-domain-separation&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US)
...
**Parent Topic:**[Domain separation and Event Management](../concept/domain-separation-event-management.md)
