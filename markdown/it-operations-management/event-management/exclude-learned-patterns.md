---
title: Exclude a pattern with an incorrect alert from a learned pattern
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/exclude-learned-patterns.html
release: xanadu
