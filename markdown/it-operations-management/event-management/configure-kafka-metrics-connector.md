...
5.  For a SASL\_PLAINTEXT, SSL, or SASL\_SSL authentication credential, in the Credential field, create a Kafka SSL credential.
    ...
    3.  From the list of available credentials, select **Kafka SSL Credentials**.
        ...
        For the Kafka SSL credentials fields descriptions, see [Kafka SSL credentials fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/health-log-analytics/hla-data-input-kafka-credentials.md).
