...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/configure-logic-monitor-connector.html
release: xanadu
...
4.  Select the **Active** check box and select **Save**.

    **Note:** The LogicMonitor pull connector does not retrieve Events or populate the Events \[em\_event\] table.
