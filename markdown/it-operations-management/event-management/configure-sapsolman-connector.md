...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/event-management/configure-sapsolman-connector.html
release: zurich
...
This configuration enables you to update the SAP Solution Manager with the statuses that have been updated by ServiceNow. For general information about the SAP Solution Manager, see [SAP configurations for the SAP Solution Manager connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/sap-manager-connector.md).
...
-   **[SAP configurations for the SAP Solution Manager connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/sap-manager-connector.md)**  
