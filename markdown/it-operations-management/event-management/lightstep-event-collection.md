...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/lightstep-event-collection.html
release: xanadu
...
1.  Create a CI.
    ...
    **Note:** Discovery for ServiceNow Cloud Observability services isn’t supported. Create a CI manually in a ServiceNow instance \(cmdb\_ci\_service\_auto table\) to enable binding.
