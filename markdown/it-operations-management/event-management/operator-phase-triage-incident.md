...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/operator-phase-triage-incident.html
release: yokohama
...
1.  Before you start to work on the alert, check whether other alerts should be correlated with the one you just reviewed:
    ...
    3.  If multiple alerts are present, open one to determine if it is related to the other alert, or if the underlying issue is the same in both alerts.
        ...
        For example, an alert might be associated with a web server and another alert might exist for a database issue. Correlate the web server alert as secondary and the database alert as primary.
...
-   **[Run a remediation workflow on an alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/operator-run-remdiation.md)**  
...
-   **[Launch a web application from an alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/operator-launch-web-app.md)**  
...
-   **[Associate a knowledge base article with an alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/operator-associate-kb.md)**  
...
-   **[Put an alert into maintenance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/operator-put-alert-into-maintenance.md)**  
...
**Parent Topic:**[What Event Management operators do](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/operator-process.md)
