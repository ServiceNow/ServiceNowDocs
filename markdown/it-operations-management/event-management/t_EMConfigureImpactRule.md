...
<table id="choicetable_mbd_wfk_35"><tbody><tr><td id="d588627e131">
...
**Note:** To configure a manual cluster, see [Configure a manual cluster](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/configure-manual-cluster.md)
