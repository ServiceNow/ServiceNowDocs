...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/t\_EMConfigureImpactRule.html
release: xanadu
...
<table id="choicetable_mbd_wfk_35"><tbody><tr><td id="d313237e125">
...
**Note:** To configure a manual cluster, see [Configure a manual cluster](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/configure-manual-cluster.md)
