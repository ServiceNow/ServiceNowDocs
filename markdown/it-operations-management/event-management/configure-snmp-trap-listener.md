...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/configure-snmp-trap-listener.html
release: xanadu
...
3.  Fill in the fields, as described in [Configure event collection for SNMP traps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/t_EMSNMPTrapEvent.md).
...
4.  Click **Submit**.
    ...
    **Note:**
    ...
    Ensure all required SNMP MIB files are uploaded on the instance. For more information, see [Load a MIB module](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/t_LoadAMIBModule.md).
...
**Parent Topic:**[Configure event collection for SNMP traps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/t_EMSNMPTrapEvent.md)
