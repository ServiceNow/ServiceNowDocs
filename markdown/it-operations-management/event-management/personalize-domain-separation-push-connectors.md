...
-   You have read access to the domain information table for the evt\_mgmt\_integration role \(default table: core\_company\). For more information, see Configure an ACL rule.
...
<table id="choicetable_jm5_rmb_d1c"><thead><tr><th align="left" id="d261870e187">

Domain creation location

</th><th align="left" id="d261870e190">

Parameter and values

</th></tr></thead><tbody><tr><td id="d261870e196">
...
**Note:** The table that stores domain information records \(for example, core\_company\) must be domain separated. For more information, see Domain-separate a custom table.
