...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/integrate-scout-apm-events.html
release: xanadu
...
Discovery for Scout APM applications is not supported. To enable binding, you must manually create a CI in a ServiceNow instance in the Application Service \[cmdb\_ci\_service\_auto\] table.
