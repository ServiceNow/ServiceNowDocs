...
breadcrumb: [Manage alerts autonomously agentic workflow, Responding to and working with alerts in Express List, Express List, Event Management, ITOM AIOps, IT Operations Management]
---
...
For this feature, you must have ServiceNow Otto for IT Operations Management \(ITOM\) installed on your instance. For more information about installing ServiceNow Otto plugins, see [Install Now Assist plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/install-now-assist-feature-plugins.md).
...
-   Search for specific information and key words in the Insights column. To add the column, see [Add or modify Express List columns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/edit-list-columns-el.md) for more information.
...
<table id="choicetable_qzt_n1y_thc"><thead><tr><th align="left" id="d137252e216">

Review AI insights

</th><th align="left" id="d137252e219">

Procedure

</th></tr></thead><tbody><tr><td id="d137252e225">
