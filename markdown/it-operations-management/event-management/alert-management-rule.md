...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/alert-management-rule.html
release: xanadu
...
-   **[Event Management subflows in the base system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/subflows-provided.md)**  
The subflows provided with the base system appear in the Remediation Subflows area of alert management rules.
-   **[Create a custom subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/create-custom-create-incident-subflow.md)**  
You can create a subflow according to your requirements. You can then use the custom subflow to resolve alerts.
-   **[Alert executions information](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/alert-rule-execution.md)**  
...
-   **[Migrate an alert action rule to an alert management rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/t_EMCreateAlertRule.md)**  
...
-   **[Synchronizing alert response with automated alert grouping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/coordinating-alert-response-with-automated-alert-grouping.md)**  
...
-   **[Configure alert remediation actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/configure-alert-remediation-subflows.md)**  
