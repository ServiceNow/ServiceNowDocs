...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/configure-contextual-colors-icons.html
release: yokohama
...
Icon that is displayed when the context includes an icon and when accessibility mode is enabled. To add your own icon, or to see a list of available icons, see Upload one or more images.

</td></tr></tbody>
</table>4.  Click **Submit**.


**Parent Topic:**[Configure email notification on application service severity change](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/t_EMCreateEmailNotificationBusinessService.md)
