...
description: Modify an existing manual cluster by changing the service, CI, CI class, or description.
locale: en-US
...
Modify an existing manual cluster by changing the service, CI, CI class, or description.
