...
description: Modify an existing manual cluster by changing the service, the specific CI, the generic CI class, or the description.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/event-management/modify-a-manual-cluster.html
release: zurich
...
Modify an existing manual cluster by changing the service, the specific CI, the generic CI class, or the description.
...
4.  In the **Select a Specific CI or generic CI class** section, use the **Defined As** field to modify the manual cluster.
...
**Parent Topic:**[Configuring CIs in a manual service as a manual cluster](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/manual-cluster-in-a-manual-service.md)

**Related topics**  


[Configuring CIs in a manual service as a manual cluster](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/manual-cluster-in-a-manual-service.md)
