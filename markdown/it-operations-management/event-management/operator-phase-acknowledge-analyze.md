...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/operator-phase-acknowledge-analyze.html
release: yokohama
...
<table id="choicetable_w31_kkr_jkb"><tbody><tr><td id="d179865e548">
...
Go to [Operator phase 2: Triage an alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/operator-phase-triage-incident.md).
