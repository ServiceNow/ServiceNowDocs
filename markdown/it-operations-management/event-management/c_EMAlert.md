...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/c\_EMAlert.html
release: yokohama
...
-   **[Alert management rules for resolving alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/alert-management-rule.md)**  
...
-   **[CI Remediation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/ci-remediation.md)**  
...
-   **[SLAs for application services and CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/c_EMSLAsForBSAndCIs.md)**  
Event Management supports the creation of SLAs for application services and for CIs.
-   **[Alert lifecycle configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/c_EMAlertRule.md)**  
...
-   **[Alert priority](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/alert-priority.md)**  
...
-   **[Alert assignment groups for teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/alert-assignment-group.md)**  
...
-   **[Configuring Express List views for users and user groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/manage-views-express-list.md)**  
Centrally control what users monitor by predefining views in Express List and assigning them to users and user groups.
-   **[Probable Root Cause Analysis \(RCA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/probable-rca.md)**  
Shorten the mean time to repair \(MTTR\) by discovering the root cause of an alert.
-   **[Alert similarity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/alert-similarity.md)**  
...
-   **[Self-health monitors for Event Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/self-monitoring.md)**  
...
-   **[Resolve an incident related to an alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/t_EMResolveCloseIncidentAlert.md)**  
...
-   **[Close an alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/t_EMCloseAlert.md)**  
...
-   **[Reopen an alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/t_EMReopenAlert.md)**  
...
-   **[Alert insight properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/configure-alert-insight-properties.md)**  
