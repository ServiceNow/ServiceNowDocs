...
2.  Select a predefined definition.
    ...
    **Note:** For a complete list of the available predefined definitions, see [List of predefined tag-based alert grouping definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/alert-clustering-predefined-definition-list.md).
