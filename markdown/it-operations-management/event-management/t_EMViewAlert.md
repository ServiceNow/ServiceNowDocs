...
1.  Navigate to **All** &gt; **Event Management** &gt; **All Alerts**.
    ...
    ![Message to use Express List for visualizing and managing alerts.](../image/em-express-list-msg.png)
...
[Security incidents created from events and alerts](https://www.servicenow.com/docs/access?context=c_ScIncdUseAlrts&version=xanadu&pubname=xanadu-security-management&ft:locale=en-US)
