...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/custom-configure-threshold-monitoring.html
release: xanadu
...
-   closeAlert
    ...
    For more information about script includes and APIs, see:Script includes that are [installed with Event Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/r_InstalledWithEventManagement.md)
...
**Parent Topic:**[Self-health monitors for Event Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/self-monitoring.md)
