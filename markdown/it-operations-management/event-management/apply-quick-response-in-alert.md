...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/event-management/apply-quick-response-in-alert.html
release: zurich
...
<table id="choicetable_ehj_lwd_lz"><tbody><tr><td id="d678286e123">
...
7.  Click **Update**.
 For further information, see [Migrate an alert action rule to an alert management rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/t_EMCreateAlertRule.md).

</td></tr><tr><td id="d678286e202">
...
To create a remediation task or web application link, see [Migrate an alert action rule to an alert management rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/t_EMCreateAlertRule.md).
...
[Launch web application from alert](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/t_EMLaunchAnApplication.md)
