...
**Note:** This procedure is only for compatibility with releases prior to Xanadu. For details on the procedure in the Xanadu release for configuring the MID Web Server, see [Configure the MID Web Server extension](configure-mid-web-server-extension.md).
