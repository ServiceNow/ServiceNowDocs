...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/configure-mid-web-server-extension-metric-data.html
release: xanadu
...
**Note:** This procedure is only for compatibility with releases prior to Xanadu. For details on the procedure in the Xanadu release for configuring the MID Web Server, see [Configure the MID Web Server extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/configure-mid-web-server-extension.md).

-   Deploy and start a MID Server.
-   Configure a MID Web Server extension and select Keybased as the authentication type. For details, see [Configure the MID Web Server extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/configure-mid-web-server-extension.md).
