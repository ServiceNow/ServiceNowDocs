...
**Note:** This procedure is only for compatibility with releases prior to Zurich. For details on the procedure in the Zurich release for configuring the MID Web Server, see [Configure the MID Web Server extension](configure-mid-web-server-extension.md).
