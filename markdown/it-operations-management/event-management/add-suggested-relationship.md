...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/add-suggested-relationship.html
release: xanadu
...
1.  Navigate to **All** &gt; **Event Management** &gt; **Administration** &gt; **CMDB Group CI Relations**.
    ...
    1.  Click **New**.
        ...
        \[Omitted image "em-cmdb-ci-relationship.png"\] Alt text: Form to create a new CMDB Group CI Relation.
