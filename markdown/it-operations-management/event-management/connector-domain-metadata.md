...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/connector-domain-metadata.html
release: xanadu
...
**Note:** For information on connector parameters, see [Personalize domains for push connector events to use in event creation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/personalize-domain-separation-push-connectors.md).
