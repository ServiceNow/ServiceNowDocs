...
3.  In the **Authentication Type** field, select an authentication type to be used.
    ...
    -   Keybased – See [Configure key-based MID Web Server authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/configure-mid-web-server-extension-metric-data.md)
...
<table id="choicetable_ezm_tvg_dsb"><thead><tr><th align="left" id="d75555e149">

Option

</th><th align="left" id="d75555e152">

Description

</th></tr></thead><tbody><tr><td id="d75555e158">
...
For more information, see the **Install custom certificates in the MID Server unified key store** section in [MID Server unified key store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/mid-unified-keystore.md).
