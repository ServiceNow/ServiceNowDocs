...
description: Use the domain properties installed with Event Management to provide metadata that points to the appropriate table. This metadata identifies the domain in which to create the event.
locale: en-US
