...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/event-management/monitor-event-processing-metrics.html
release: zurich
