...
-   Send events to the Event \[em\_event\] table using a web service API. See [REST API](https://www.servicenow.com/docs/access?context=c_RESTAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
