...
4.  To ensure that the MID Server is validated, under Related Links, select **Validate**.
    ...
    For more information, see [Validate a MID Server](https://www.servicenow.com/docs/access?context=t_ValidateAMIDServer&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
