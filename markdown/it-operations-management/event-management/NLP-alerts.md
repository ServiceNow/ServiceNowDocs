...
breadcrumb: [Text-based alert grouping, Alert grouping types and creation methods, Alert grouping, Configure, Event Management, ITOM AIOps, IT Operations Management]
---
...
4.  Select **Update &amp; Retrain**.
    ...
    For more information on ML solutions, see [Reviewing your ML solution training jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/reviewing-ml-solution-training-jobs.md).
