...
View an AI summary of past incidents related to the current alert, including strategies used to resolve them.
...
5.  Select the ServiceNow Otto panel icon \(\[Omitted image "icon-ai-sparkle.png"\] Alt text: ServiceNow Otto panel icon.\).

    The panel displays.

6.  Request a past incidents investigation by selecting **Analyze related incidents**.
