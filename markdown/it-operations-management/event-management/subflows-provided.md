...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/subflows-provided.html
release: xanadu
...
2.  To customize a subflow, see [Create a custom subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/create-custom-create-incident-subflow.md). This topic also describes the input parameters in a subflow.
