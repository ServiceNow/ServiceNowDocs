...
2.  To customize a subflow, see [Create a custom subflow](../task/create-custom-create-incident-subflow.md). This topic also describes the input parameters in a subflow.
