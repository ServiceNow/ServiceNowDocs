...
-   Scenario 1: CMDB class is added to em\_impact\_inclusion\_class.list but you want only specific services to be considered for impact calculation. You can either:
    ...
    For information on how to remove the application service from the list, see [Remove application services from impact calculation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/remove-impact-cal-services.md).
...
5.  Select **Submit**.
    ...
    **Note:** Only the application services added to the Impact Filter Services list appear in the [Service Dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/worksplace-view-service-details.md).
