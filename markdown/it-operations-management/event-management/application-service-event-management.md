...
For general information on application services, see [Application services](https://www.servicenow.com/docs/access?context=application-services&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
-   **[Create a service group](../task/create-service-group.md)**  
