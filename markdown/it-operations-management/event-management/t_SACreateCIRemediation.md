...
After you finish configuring the workflow, make sure that you publish it. For more details, see [Create a workflow](https://www.servicenow.com/docs/access?context=t_CreateAWorkflow&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
