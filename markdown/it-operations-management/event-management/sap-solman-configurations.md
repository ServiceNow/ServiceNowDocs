...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/event-management/sap-solman-configurations.html
release: zurich
...
-   **[Configure RFC in SAP Solution Manager](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/configure-sap-solution-mgr.md)**  
...
-   **[Configure SAP to forward alerts to your BADI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/configure-sap-fwd-alerts-badi.md)**  
...
-   **[Configure the alert inbox in SAP Solution Manager](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/configure-sap-solman-alert-inbox.md)**  
Configure SAP solution manager to retrieve alerts in the system by enabling the alert inbox with the SOA manager.
-   **[View alerts in the SAP Solution Manager inbox](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/sap-view-alerts.md)**  
...
-   **[View and update your SAP Solution Manager certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/sap-sol-certificate-view-update.md)**  
