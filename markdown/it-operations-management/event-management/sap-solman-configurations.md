...
-   **[Configure RFC in SAP Solution Manager](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/configure-sap-solution-mgr.md)**  
...
-   **[Configure SAP to forward alerts to your BADI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/configure-sap-fwd-alerts-badi.md)**  
Configure SAP to forward alerts to the BADI \(Business Add-in\) you create for the integration.
-   **[Configure the alert inbox in SAP Solution Manager](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/configure-sap-solman-alert-inbox.md)**  
Configure SAP solution manager to retrieve alerts in the system by enabling the alert inbox with the SOA manager.
-   **[View alerts in the SAP Solution Manager inbox](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/sap-view-alerts.md)**  
...
-   **[View and update your SAP Solution Manager certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/sap-sol-certificate-view-update.md)**  
View your SAP Solution Manager certificate, and update the certificate if necessary.
-   **[View the SAP interface log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/sapsolman-view-interface-debugging-table.md)**  
