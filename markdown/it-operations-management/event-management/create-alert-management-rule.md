...
For more information about creating related lists, see [Add related list conditions](https://www.servicenow.com/docs/access?context=create-related-list-query&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
