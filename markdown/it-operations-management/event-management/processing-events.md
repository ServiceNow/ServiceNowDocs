...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/processing-events.html
release: xanadu
...
For more information, see [Exploring Event Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/exploring-event-management.md).

-   **[View events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/t_EMManageEvent.md)**  
...
-   **[Team-based integrations in Event Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/team-based-integrations.md)**  
...
-   **[Event rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/create-event-rules.md)**  
...
-   **[Event field mapping configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/c_EMEventFieldMapping.md)**  
Use Event field mappings rules to map values from specific fields to values in other fields.
-   **[Event identifiers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/c_EMEventIdentifier.md)**  
...
-   **[Alert tags](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/alert-tags.md)**  
...
-   **[Event field format for event collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/c_EMIntegrateRequirementEvent.md)**  
Event Management requires all events to use a standard form, regardless of how they arrive at the instance.
-   **[Custom alert fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/populate-custom-alert-fields.md)**  
You can populate custom alert fields with data contained in **Additional information** field of the event.
-   **[Testing and sending events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/t_EMCreateEventManually.md)**  
You can manually test and send events to confirm that Event Management properly manages events and generates alerts.
-   **[View event processing statistics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/monitor-event-processing-metrics.md)**  
