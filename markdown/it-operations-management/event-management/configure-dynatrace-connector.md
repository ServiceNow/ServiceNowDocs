---
title: Configure the Dynatrace connector instance
description: Configure the Dynatrace connector instance to receive Metric Intelligence raw data from the Dynatrace server.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/configure-dynatrace-connector.html
release: xanadu
...
2.  Select **New** and create a connector instance.
    ...
    For details on the connector instance fields displayed on the page, see [Dynatrace connector instance form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/dynatrace-connector-instance-form.md).
...
4.  In the Connector Instance Values section, you can edit the values of the mandatory Dynatrace parameters.
    ...
    For details on the connector instance value parameters, see [Dynatrace connector instance value parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/dynatrace-connector-instance-value-parameters.md).
...
Select for the metrics to collect.
    ...
    -   Create an event rule to perform CI binding, as needed. For details, see [Create or edit an event rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/create-or-edit-event-rule.md).
...
**Parent Topic:**[Configure a pull connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/event-management/t_EMConfigureConnectorInstance.md)
