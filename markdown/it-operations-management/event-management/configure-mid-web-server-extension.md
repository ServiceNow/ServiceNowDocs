...
-   **Keybased**: For backwards \(pre-Xanadu release\) compatibility only. See [Configure key-based MID Web Server authentication](configure-mid-web-server-extension-metric-data.md).
