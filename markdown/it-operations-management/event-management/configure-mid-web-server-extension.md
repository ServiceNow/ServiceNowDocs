...
-   **Keybased**: For backwards \(pre-Brazil release\) compatibility only. See [Configure key-based MID Web Server authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/configure-mid-web-server-extension-metric-data.md).
...
3.  Fill in the values on the [Event Management MID Web Server extension form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/event-management/configure-midwebserver-extension-form.md).
