...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/event-collection-GCP.html
release: yokohama
...
1.  Verify that the MID Server IP and MID rest point are accessible from the GCP console.
