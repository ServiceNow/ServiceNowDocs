...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/event-management/t\_EMCreateAlertGroup.html
release: zurich
...
3.  On the **Alert Query** form, fill in the fields.
    ...
    For a description of the field values, see [Alert Query form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/alert-query-form.md)
    ...
    **Note:** In the **Filter** field:
    ...
    -   Some filters may slow down impact calculation. To solve this problem, adjust your alert query by adding an appropriate index, as described in [Index suggestions for slow queries](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/index-suggestions.md).
4.  Select **Update**.
...
[Create alert group manually](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/t_SAAddAlertCorrelatedAlertGrp.md)
