...
description: Use event field mapping to dynamically bind alerts to the appropriate CIs based on event attributes, eliminating the need for separate event rules for each CI. This approach simplifies configuration, improves accuracy, and enhances alert binding.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/bind-ci-event-mapping.html
release: yokohama
