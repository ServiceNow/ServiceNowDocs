...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/event-management/create-solution-similarity.html
release: xanadu
...
-   If the field you are using for training is encrypted using Column Level Encryption, ensure that the shared service worker user has the correct encryption module role that has been used for encryption.
