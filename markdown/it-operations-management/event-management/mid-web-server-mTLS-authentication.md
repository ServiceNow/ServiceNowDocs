...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/event-management/mid-web-server-mTLS-authentication.html
release: yokohama
...
When mTLS is configured, the client presents a certificate or certificate chain to the server. The server then authenticates the client in the same way that the client authenticates the server.
...
-   **[Create keys and certificates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/create-keys-and-certificates.md)**  
...
-   **[Connect the agent to the MID Web Server using TLS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/agent-mid-connect.md)**  
Connect the agent to the MID Web Server to enable configuring mTLS on your MID Web Server and agent.
-   **[Configure mTLS authentication for a MID Web Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/configure-mid-web-server-extension-mTLS.md)**  
Enhance security in your MID Web Server extension by enabling mTLS authentication.
-   **[Connect the agent to the MID Server using mTLS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/enable-tls-agent.md)**  
...
**Parent Topic:**[Configure the MID Web Server extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/configure-mid-web-server-extension.md)

**Related topics**  


[Configure the MID Web Server extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/event-management/configure-mid-web-server-extension.md)
