...
-   OAuth authentication: Provides enterprise-grade authentication to keep your enterprise environment safe. Authentication is performed using Dynatrace Monitor V1 or V2 access tokens. For more information, see [Integrate Dynatrace with OAuth authentication](../task/dynatrace-oauth-authentication.md).
