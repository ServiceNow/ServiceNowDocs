...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/event-management/configure-em-context-extension.html
release: zurich
...
To ensure high availability for external API integrations, deploy an external load balancer that distributes traffic across multiple MID servers.

**Note:** The MID cluster web server configuration handles internal processing only \(through ecc\_queue\) and can't manage inbound external API traffic.
...
[Configure the MID Web Server extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/configure-mid-web-server-extension.md)

[Event collection from BMC TrueSight](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/event-collection-BMCTrueSight.md)

[Event collection from Microsoft Azure Monitor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/event-collection-MicrosoftAzure.md)

[Event collection from Google Cloud Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/event-management/event-collection-GCP.md)
