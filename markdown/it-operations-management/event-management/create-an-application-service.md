...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/event-management/create-an-application-service.html
release: australia
...
For details on grouping application services, see [Group application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/service-mapping/organizing_services-into-groups.md).

For details on controlling user access to application services, see [Control user access to application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/service-mapping/control-user-access-to-business-services.md).
