---
title: Express List Configuring Express List views for users and user groups
...
[Use an assigned Express List view](../task/manage-views-express-list-operator.md)
