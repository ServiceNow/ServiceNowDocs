...
Set up a team. Teams are responsible for the issues that occur in the associated services.
...
Create an on-call schedule for your team to ensure to ensure that dedicated support team members are available to resolve issues as they arise. You can set up an escalation policy for your team so that at least one team member is engaged in incident response.
...
For more information, see Service Level Objective Management.
