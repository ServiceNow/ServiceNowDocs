...
# Edit and publish a team request form for SRM

Edit a team request form to customize team requests to your organization's preference.
...
3.  Select the **Catalog item request form** link.
