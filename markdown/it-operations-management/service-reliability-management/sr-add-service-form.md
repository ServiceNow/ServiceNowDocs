...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/service-reliability-management/sr-add-service-form.html
release: xanadu
...
For more information, see [Add a service to SRM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/service-reliability-management/sr-add-service.md).
...
Unique and meaningful name for the service.
...
How important it is to the business. Choices are:
...
Status of the service. Choices are:
...
Description of the overall service that will help others to understand the purpose of the service and other relevant information.
