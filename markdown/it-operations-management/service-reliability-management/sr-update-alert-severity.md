...
<table id="choicetable_llb_1fq_vyb"><thead><tr><th align="left" id="d371915e101">

Option

</th><th align="left" id="d371915e104">

Description

</th></tr></thead><tbody><tr><td id="d371915e110">

**In the alert list view**

</td><td>

-   To update the severity of one alert at a time:
    1.  Double-click the **Severity** field \(or use the keyboard shortcut\) for the alert and reclassify it from the list menu.
    2.  Select **OK**.
-   To change the severity of one or more alerts:

    1.  Select one or more alerts using the check box to the left of the alert.
    2.  Select **Edit** in the list view header.
    3.  Scroll down to the value that you want to edit.
    4.  Select from a menu, enter the appropriate text, or check a box.
    5.  Select **Update**.
...
</td></tr><tr><td id="d371915e167">

**In the alert form**

</td><td>

1.  Select the alert to open the alert record in a new tab.
2.  Select the **Details** tab.
3.  In the alert form, update the **Severity** field by selecting a value from the list menu.
4.  Select **Save**.
