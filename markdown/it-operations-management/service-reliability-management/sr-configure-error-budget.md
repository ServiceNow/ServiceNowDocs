...
Configure the actions the team can select when the error budget of a service level objective \(SLO\) is breached.
...
2.  Under **Governance and autonomy**, select **Error budgets**.
