...
breadcrumb: [Get started with Service Reliability Management, Exploring Service Reliability Management, Service Reliability Management, ITOM Health, IT Operations Management]
---
...
**Note:** If you have other SOW applications, and depending on your assigned roles, that homepage may not be the SRM homepage, as described. It is the SOW homepage instead, with SRM alerts and incidents included in your metrics. If you have other roles, like itil, you may see additional icons in the left navigation pane.
...
A home for your organization logo and system-level utilities that are present everywhere in the interface.-   All
-   Favorites
-   History
-   Workspaces
-   Current workspace
...
If you want to minimize the far right side panel on forms, by default, navigate to **Preferences** &gt; **Workspace** and disable the **Show sidebar** option.
