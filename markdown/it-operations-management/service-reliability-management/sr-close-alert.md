...
1.  Select one or more alerts using the check box next to the alert.

Select the **Close** button from the header menu.

2.  Select one or more alerts using the check box to the left of the alert, and select **Edit** in the list view header.

Scroll down to the **State** field and select from a menu.
...
Open an alert and set the **State** field to **Closed**.
