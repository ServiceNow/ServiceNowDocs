...
You can manually create incidents within SRM or create an error budget action to do so. See [Manually create an SRM incident](../task/sr-create-incident.md) or [Create SLO, SLI, and Error budget policies](../../slo-management/task/sr-create-slo-sli.md) for more information.

-   [Manual creation from an alert](../task/sr-promote-incident-alert.md)
...
For more information on the areas and fields available in an incident, see [SRM incident workspace](../reference/sr-incidents-workspace.md).
