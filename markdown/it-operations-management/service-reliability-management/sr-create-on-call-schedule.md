...
5.  Fill in the fields.
    ...
    For more information on the field descriptions, see [Create a shift form in Service Reliability Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-reliability-management/sr-create-shift-form.md).

6.  Select **Create shift**.


-   **[Set on-call team preferences in SRM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-reliability-management/sr-set-on-call-prefs.md)**  
