...
Only open change requests are available in this view.

Role required: admin or SRM approval team
...
4.  Open a change request.

5.  If you are the intended owner of the service or team, select **Assign to me**, otherwise, assign it to the intended owner within the list view or the record.

6.  Select to open the record.

7.  On the **State** field, select the list and select **Approved**.

8.  Select **Save**.

    The state of the change request changes from the **Assess** state to the **Approved** state.
