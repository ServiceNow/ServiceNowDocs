...
Select one or more alerts using the check box to the left of the alert, and select **Edit** in the list view header.Scroll down to the **Task** field and select from a menu.
