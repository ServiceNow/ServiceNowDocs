...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/create-chef-or-ansible-cfg-provider.html
release: yokohama
...
-   Ensure to have an Ansible server and [Ansible credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/configure-ansible-creds.md).
...
Credentials to access the Ansible server. For more information on creating credential for Ansible server, see [Ansible credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/configure-ansible-creds.md).
