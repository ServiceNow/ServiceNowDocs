---
title: Day 1 setup guide for Cloud Provisioning and Governance: Google Cloud Connector
...
-   [Download the Connector app](https://www.servicenow.com/docs/access?context=download-app-first-time&version=xanadu&pubname=xanadu-security-management&ft:locale=en-US) and supporting store apps on the ServiceNow Store and [activate](https://www.servicenow.com/docs/access?context=activate-entitled-store-app&version=xanadu&pubname=xanadu-security-management&ft:locale=en-US) the store applications.
...
-   **1. Get the Cloud Provisioning and Governance: Google Cloud Connector app on the ServiceNow Store**

    The Google Cloud Connector app requires Cloud Provisioning and Governance. After you have set up Cloud Provisioning and Governance, visit the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home) website to get the Google Cloud Connector app and supporting plugins and apps.
