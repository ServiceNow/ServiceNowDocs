...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/cloud-configuration-governance/resource-blocks.html
release: xanadu
...
-   **[Create a custom resource block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/create-resource-block.md)**  
...
-   **[Configure resource block input parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/manage-resource-block-operations.md)**  
...
-   **[Add operation steps to a resource block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/add-operation-steps.md)**  
...
-   **[Extend Cloud Provisioning and Governance resource blocks with an override operation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/extend-cloud-management-entities.md)**  
...
-   **[Add a resource script to a resource block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/add-resource-script-resource-block.md)**  
A resource script operates on a resource during deployment or returns data to the CMDB after a resource is deployed.
-   **[Configure a response processor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/configure-response-processor.md)**  
Configure a response processor to handle responses from datacenters.
-   **[Add Terraform Orchestration interface on a resource block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/add-terraform-orchestration-interface.md)**  
...
-   **[Create a resource block for Microsoft Azure Cloud](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/create-resource-block-azure-terraform.md)**  
