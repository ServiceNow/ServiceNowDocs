...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/create-pre-provisioning.html
release: yokohama
...
6.  Either create expression mappings for an attribute \(in the **Mapping** field\) or generate variables for an attribute.
    ...
    See [Manage operation attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/manage-attributes.md) for more information.
