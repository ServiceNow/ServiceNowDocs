...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/use-cloud-root-call-analysis.html
release: yokohama
...
1.  In the Cloud Admin Portal, navigate to **Operate** &gt; **Root Cause Analysis Dashboard**.
    ...
    See [The Cloud Orchestration Trail](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/cloud-orch-trail.md) for a list of possible steps.
...
3.  Click any Cloud Orchestration API **Number** to view that specific record.
    ...
    See [The Cloud Orchestration Trail](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/cloud-orch-trail.md) for field descriptions.
...
4.  To view reports about the Cloud API Trail, click the **Cloud API Dashboard** tab.
    ...
    **Note:**
    ...
    Starting with Yokohama the Cloud API dashboard will be hidden and no longer activated on new instances but will continue to be supported. The Cloud Services Catalog application provides this functionality now. The application is being prepared for future deprecation.
...
5.  Click any the data in the graphs to open the matching Cloud API Trail records.
    ...
    See [The Cloud API Trail](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/cloud-api-trail.md) for descriptions of the Cloud API Trail form fields.
