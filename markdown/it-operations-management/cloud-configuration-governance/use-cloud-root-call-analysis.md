...
4.  To view reports about the Cloud API Trail, click the **Cloud API Dashboard** tab.
    ...
    **Note:**
    ...
    Starting with Zurich the Cloud API dashboard will be hidden and no longer activated on new instances but will continue to be supported. The Cloud Services Catalog application provides this functionality now. The application is being prepared for future deprecation.
