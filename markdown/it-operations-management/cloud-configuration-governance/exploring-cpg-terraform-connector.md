...
-   **Create catalog items from the Terraform templates**
    ...
    Use the Cloud Provisioning and Governance: Terraform Connector app to create catalog items from the discovered Terraform templates and use them to provision resources in various clouds. For more information, see [Create a catalog item from the Terraform template](../task/catalog-item-terraform-template.md).
