...
9.  To add an attribute:
    ...
    3.  Fill out the rest of the fields in the row.
        ...
        See [Dictionary entry form](https://www.servicenow.com/docs/access?context=r_DictionaryEntryForm&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) for a description of all the fields.
