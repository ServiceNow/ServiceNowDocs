...
-   **Cloud Orchestration Trail**
    ...
    See [Open the Cloud Orchestration Trail](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/cloud-configuration-governance/open-cloud-orch-api-trail.md) for instructions.
...
-   **Cloud API Trail**
    ...
    See [Open the Cloud API Trail](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/cloud-configuration-governance/cloud-api-trail.md) for instructions.
...
-   **Root Cause Analysis Dashboard**
    ...
    See [Use Cloud Root Cause Analysis reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/cloud-configuration-governance/use-cloud-root-call-analysis.md) for instructions.
...
-   **Cloud Orchestrations**
    ...
    See [Open cloud orchestrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/cloud-configuration-governance/open-cloud-orchestrations.md) for instructions.
