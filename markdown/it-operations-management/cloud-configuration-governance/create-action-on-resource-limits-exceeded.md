...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/create-action-on-resource-limits-exceeded.html
release: yokohama
...
-   A workflow using the [Workflow editor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/legacy-workflow/workflow-editor.md)
...
3.  Modify the policy rules conditions.
    -   Click **New** to create a new policy record.
        ...
        For more information, see [Create a cloud policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/create-cloud-policy.md).
...
2.  In the Rules related list, modify the base system rule or create a new rule.
    ...
    -   Create a policy rule.
        ...
        For more information, see [Configure a cloud policy rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/configure-cloud-policy-rule.md).
...
<table id="choicetable_xpc_mhp_znb"><thead><tr><th align="left" id="d280019e240">

Option

</th><th align="left" id="d280019e243">

Steps

</th></tr></thead><tbody><tr><td id="d280019e249">
...
**Parent Topic:**[Create a cloud policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/create-cloud-policy.md)
