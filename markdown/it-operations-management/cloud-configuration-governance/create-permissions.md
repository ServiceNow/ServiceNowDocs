...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/create-permissions.html
release: yokohama
...
-   The [user group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/user-administration/t_CreateAGroup.md) to which you want the permission applied.
...
2.  Fill out the form fields \(see table\).
    ...
    |Permission|Select the [permission type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/cloud-permissions.md).|
...
**Parent Topic:**[Permissions management for Cloud Governance roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/cloud-permissions.md)
