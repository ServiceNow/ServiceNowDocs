...
-   The [user group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_CreateAGroup.md) to which you want the permission applied.
...
2.  Fill out the form fields \(see table\).
    ...
    |Permission|Select the [permission type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/cloud-configuration-governance/cloud-permissions.md).|
...
**Parent Topic:**[Permissions management for Cloud Governance roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/cloud-configuration-governance/cloud-permissions.md)
