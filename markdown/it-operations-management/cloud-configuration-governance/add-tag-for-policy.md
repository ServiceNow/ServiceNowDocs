...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/cloud-configuration-governance/add-tag-for-policy.html
release: xanadu
...
See [Create a custom tag for cloud resources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/cloud-tagging.md) for information about how to create and use tags in Cloud Provisioning and Governance.
