...
-   Ensure that the MID Server has Terraform Enterprise and REST capabilities. For more information, see [Configure MID Server capabilities](https://www.servicenow.com/docs/access?context=t_ConfigureCapabilities&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
