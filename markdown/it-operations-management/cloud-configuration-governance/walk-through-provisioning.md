...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/walk-through-provisioning.html
release: yokohama
...
For an example of a VM in Azure, see [Azure VM provisioning walkthrough](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/walk-through-azure-provisioning.md).
