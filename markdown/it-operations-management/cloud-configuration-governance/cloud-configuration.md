...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/cloud-configuration-governance/cloud-configuration.html
release: zurich
...
-   **Set up Cloud Provisioning and Governance**
    ...
    -   [Cloud Provisioning and Governance setup guide for AWS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/cloud-configuration-governance/cloud-mgt-aws-setup-day-1.md)
    -   [Cloud Provisioning and Governance setup guide for Azure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/cloud-configuration-governance/cloud-mgt-azure-setup-guide.md)
    -   [Cloud Provisioning and Governance setup guide for VMware](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/cloud-configuration-governance/cloud-mgt-vmware-setup-guide.md)
    .
