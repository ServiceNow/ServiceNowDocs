...
1.  Navigate to the Cloud Service Accounts \[cmdb\_ci\_cloud\_service\_account\_list\] table.
    ...
    For more information on directly navigating to a table, see [Navigate directly to a table](https://www.servicenow.com/docs/access?context=t_NavigateDirectlyToATable&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
