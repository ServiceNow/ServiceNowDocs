...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/cloud-configuration-governance/disco-datacntrs-in-srv-acct.html
release: zurich
...
1.  Navigate to the Cloud Service Accounts \[cmdb\_ci\_cloud\_service\_account\_list\] table.
    ...
    For more information on directly navigating to a table, see [Navigate directly to a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/t_NavigateDirectlyToATable.md).
...
[Logs for horizontal discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/r_DiscoveryLog.md)
