...
-   If quota limits have been exceeded, the system might either display an error message or trigger a policy-based approval workflow when you attempt to provision a stack. For more information, see [Provisioning stacks based on quota limits](quota-template-based-stacks.md).
