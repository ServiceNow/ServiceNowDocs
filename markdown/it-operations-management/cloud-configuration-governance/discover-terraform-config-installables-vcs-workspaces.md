...
-   If Cloud Provisioning and Governance: Terraform Connector discovers new Terraform templates that you want to use for cloud resource provisioning, create a catalog item from the discovered template. For more information, see [Create a catalog item from the Terraform template](catalog-item-terraform-template.md).
