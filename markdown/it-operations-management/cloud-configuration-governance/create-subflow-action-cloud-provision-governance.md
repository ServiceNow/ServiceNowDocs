...
-   Ensure that you are familiar with the concepts of [https://servicenow.com/docs/bundle/xanadu-application-development/page/build/professional-developer-guide/concept/flow-designer.html.html](https://servicenow.com/docs/bundle/xanadu-application-development/page/build/professional-developer-guide/concept/flow-designer.html.html), [Subflows](https://www.servicenow.com/docs/access?context=subflows&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US), and [Action Designer](https://www.servicenow.com/docs/access?context=actions&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
...
1.  Navigate to **All** &gt; **Flow Designer** &gt; **Actions** tab, select **New Action**.
    ...
    For more information, see [Create an action](https://www.servicenow.com/docs/access?context=create-action&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
