...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/add-resource-script-resource-block.html
release: yokohama
...
Type of script:-   Instance Script: Javascript that performs an operation on the instance \(for example, a workflow\).
-   PowerShell Script
-   Python Script
