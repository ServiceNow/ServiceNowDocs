...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/cloud-mgt-aws-setup-day-1.html
release: yokohama
...
-   **3. [Configure access to the AWS accounts using permanent AWS credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/aws-create-creds-cloud-mgt.md)**
