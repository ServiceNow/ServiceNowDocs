...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/cloud-configuration-governance/use-credentials-with-workflows.html
release: xanadu
...
You can use an expression to get the Credential alias tag. See [Create an SSH activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/orchestration/t_CreateAnSSHActivity.md) for instructions.
