...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/cloud-configuration-governance/azure-create-creds-cloud-mgt.html
release: xanadu
...
1.  [Create a Microsoft Azure service principal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown) and open the text file that you created during the procedure.
