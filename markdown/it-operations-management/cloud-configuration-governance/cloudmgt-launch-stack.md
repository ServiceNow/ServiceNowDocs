...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/cloud-configuration-governance/cloudmgt-launch-stack.html
release: xanadu
...
If a resource on a stack requires credentials when being accessed via SSH, then you must create an SSH key pair before you can launch the stack. See [Create an SSH key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/cloudmgt-create-ssh-key.md) and [Download an SSH key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/cloudmgt-download-ssh-key.md).
...
-   Red: Rejected, Error, or Canceled.
    ...
    -   If the quota limit exceeds for you or your user group, then an error message appears or the system triggers a policy-based approval workflow. For more information about the quota limits, see [Viewing resource quota limits](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-configuration-governance/resource-quota.md).
