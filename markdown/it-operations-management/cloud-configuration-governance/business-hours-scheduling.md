...
The administrator can create schedule profiles in the **Cloud Admin Portal**. See [Resource Profiles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-operations-management/cloud-configuration-governance/cloud-resource-profiles.md).
