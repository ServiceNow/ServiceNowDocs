...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/setup-cpg-terraform-connector-for-terraform-open-source.html
release: yokohama
...
2.  If you have deployed the Terraform Open Source on a Windows server, create Windows Credentials for the server in the ServiceNow AI Platform.
    ...
    5.  On the form, fill in the fields.
        ...
        For a description of the form fields, see [Cloud Services Catalog Terraform Connector Windows Credentials form reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-configuration-governance/ccg-terraform-connector-windows-credentials-form.md).
