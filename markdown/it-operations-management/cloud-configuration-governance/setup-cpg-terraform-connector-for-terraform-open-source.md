...
1.  If you have deployed the Terraform Open Source on a Linux server, create SSH Private Key Credentials for the server in the ServiceNow AI Platform.
    ...
    5.  On the form, fill in the fields.
        ...
        For a description of the form fields, see [Cloud Provisioning and Governance: Terraform Connector SSH Private Key Credentials form reference](../reference/ccg-terraform-connector-ssh-private-key-credential-form.md).
...
2.  If you have deployed the Terraform Open Source on a Windows server, create Windows Credentials for the server in the ServiceNow AI Platform.
    ...
    5.  On the form, fill in the fields.
        ...
        For a description of the form fields, see [Cloud Provisioning and Governance: Terraform Connector Windows Credentials form reference](../reference/ccg-terraform-connector-windows-credentials-form.md).
...
3.  Create a config provider for Terraform Open Source.
    ...
    3.  On the form, fill in the fields.
        ...
        For a description of the form fields, see [Cloud Provisioning and Governance: Terraform Connector Create Config Provider form reference](../reference/cpg-terraform-connector-config-provider-form.md).
