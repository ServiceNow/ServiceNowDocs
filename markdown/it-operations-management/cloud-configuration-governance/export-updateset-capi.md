...
description: Use update sets to move a cloud API from one environment to another. Update sets group a cloud API and its dependencies into a named set. You can then move them as a unit to other systems for testing or deployment.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/cloud-configuration-governance/export-updateset-capi.html
release: zurich
...
Use update sets to move a cloud API from one environment to another. Update sets group a cloud API and its dependencies into a named set. You can then move them as a unit to other systems for testing or deployment.
