...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/add-datacntr-to-cloud-acct.html
release: yokohama
...
breadcrumb: [Set up cloud accounts for VMware, Day 1 setup guide for VMware on Cloud Provisioning and Governance, Cloud Provisioning and Governance, ITOM Optimization, IT Operations Management]
---
