...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/export-updateset-blueprint.html
release: yokohama
...
2.  Export the blueprint.
    ...
    1.  Click the Export icon \(\[Omitted image "export-resource-block.png"\] Alt text: Blueprint export icon\) for the blueprint that you want to export.
        ...
        The Blueprint Exporter window has a list of all the indirect dependencies \(Policy, MID Server Script Includes, MID Server Script Files, Script Includes, and Workflows\) for the blueprint. These objects are not directly part of a blueprint, but a blueprint might depend on them to work correctly.
