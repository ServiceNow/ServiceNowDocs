...
The Azure **Subscription ID** value that you copied from the Azure Portal into the text file.
 ...
 See [Discovery for Microsoft Azure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/azure-cloud-discovery.md) to learn Management Groups subscription IDs.
