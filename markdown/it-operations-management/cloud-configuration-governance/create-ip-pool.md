...
-   Create [Infoblox credentials](https://www.servicenow.com/docs/access?context=infoblox-creds&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) and [register an Infoblox server](create-infoblox.md).
