...
For an example of a VM in AWS, see [AWS VM provisioning walkthrough](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/cloud-configuration-governance/walk-through-provisioning.md).
...
</table>        See [Store the Azure service principal credentials in the instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/cloud-configuration-governance/azure-create-creds-cloud-mgt.md) for more information on the Azure information that is used in these overrides.
