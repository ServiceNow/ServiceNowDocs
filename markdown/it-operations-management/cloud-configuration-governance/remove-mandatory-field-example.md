...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/remove-mandatory-field-example.html
release: yokohama
...
6.  Configure the condition that requires the User Group to equal Database:
    ...
    2.  On the form, fill in the fields.
        ...
        |Value|287ee6fea9fe198100ada7950d0b1b73|This value is the Sys ID of the Database user group, which is provided as part of the demo data in your instance. See Sys ID for more information.|
