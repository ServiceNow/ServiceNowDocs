...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-configuration-governance/create-or-update-terraform-based-catalog-item.html
release: yokohama
