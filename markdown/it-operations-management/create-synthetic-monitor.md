...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/create-synthetic-monitor.html
release: xanadu
topic_type: task
...
Text that is used if the API expects a message body, such as a JSON snippet.
        ...
        For more information on how to create a location, see [Create synthetic monitoring locations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/create-synthetic-monitoring-locations.md).
