...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/view-aggregat-monitor-information.html
release: xanadu
topic_type: task
...
3.  To view details about each test run by the monitor, select a monitor name.
    ...
    The monitor's detail page opens. For more information about this page, see [View a monitor's test results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/view-a-monitor-s-test-results.md).
