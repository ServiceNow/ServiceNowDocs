...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/view-aggregat-monitor-information.html
release: yokohama
topic_type: task
...
3.  To view details about each test run by the monitor, select a monitor name.
    ...
    The monitor's Overview tab opens. For more information about this page, see [View a monitor's test results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/view-a-monitor-s-test-results.md).
