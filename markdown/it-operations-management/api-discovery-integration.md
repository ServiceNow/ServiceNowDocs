...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/api-discovery-integration.html
release: yokohama
topic_type: concept
last_updated: "2026-07-24"
reading_time_minutes: 1
keywords: [synthetic monitoring, API Insights, discovery, integration]
breadcrumb: [Exploring synthetic monitoring, Synthetic monitoring, ITOM Health, IT Operations Management]
---
...
2.  Creates a synthetic monitor that references the existing API component CI. See [Create a synthetic monitor for a discovered API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/create-synthetic-monitor-for-discovered-api.md).
