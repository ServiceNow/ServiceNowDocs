...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/monitor-details-page.html
release: zurich
...
You can use the **Details** tab to create a monitor or edit an existing one. See [Create and edit a synthetic monitor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/create-synthetic-monitor.md) for more information.
