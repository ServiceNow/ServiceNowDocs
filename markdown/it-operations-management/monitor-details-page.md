...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/monitor-details-page.html
release: xanadu
...
You can use the **Details** tab to create a monitor or edit an existing one. See [Create and edit a synthetic monitor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/create-synthetic-monitor.md) for more information.

**Parent Topic:**[Synthetic monitoring reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/synthetic-monitoring-reference.md)
