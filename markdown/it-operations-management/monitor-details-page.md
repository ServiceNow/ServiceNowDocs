...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/monitor-details-page.html
release: yokohama
...
You can use the **Details** tab to create a monitor or edit an existing one. See [Create and edit a synthetic monitor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/create-synthetic-monitor.md) for more information.
