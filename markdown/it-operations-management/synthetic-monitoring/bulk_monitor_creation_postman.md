...
5.  Configure the request body to upload your monitor data file.
    ...
    3.  Select the **Select File** button, and browse to your monitor data file location and select your JSON or CSV file.
        ...
        If you are uploading a CSV file, ensure it is properly formatted with all required columns. [Convert CSV file to JSON format](../reference/convert-csv-file-to-json-format.md)
...
-   **[Convert CSV file to JSON format](../reference/convert-csv-file-to-json-format.md)**  
