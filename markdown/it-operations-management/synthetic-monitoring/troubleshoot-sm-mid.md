...
Restart the MID Server. See [Manually start, stop, and restart a MID Server](https://www.servicenow.com/docs/access?context=t_InstallMIDServerAsWinService&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
