---
title: Configuring synthetic monitoring
description: Plan and configure your implementation of synthetic monitoring.
locale: en-US
release: zurich
...
-   **[Import and create synthetic monitors in bulk using API](../task/import-and-create-synthetic-monitors-in-bulk-using-apis.md)**  
