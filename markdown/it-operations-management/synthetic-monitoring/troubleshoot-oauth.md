...
Refer to your OAuth provider's documentation when configuring OAuth. See [OAuth Inbound and Outbound authentication](https://www.servicenow.com/docs/access?context=api-inbound-and-outbound&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) for more information.
