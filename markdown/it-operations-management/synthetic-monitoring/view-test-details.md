...
3.  Select a test from the list of tests.
    ...
    The modal displays information about the test including a response body. In this example, it shows that the request was sent to a bad gateway.![A modal displays information about the test including a response body that states that the request was to a bad gateway.](../image/sys-mon-failed_monitor.png)
