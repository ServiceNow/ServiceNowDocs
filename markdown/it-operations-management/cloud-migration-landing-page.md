...
## Prepare for resource migration

Group servers, create migration assessment tasks, educate and entice stakeholders to aid a better decision for migrating to the cloud or not. With this app you can use the collected information on hardware, apps, and server configuration to evaluate the migration approaches: The migration strategies and the number of migration waves you need. Use the combined think-tank of the stakeholders to get guidance towards the best approach.
