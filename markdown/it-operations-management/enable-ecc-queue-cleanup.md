...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/enable-ecc-queue-cleanup.html
release: zurich
topic_type: task
...
On its next scheduled run, the ECC Queue auto-purge job removes and flags messages according to its [purge categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/ecc-queue-auto-purge.md).
