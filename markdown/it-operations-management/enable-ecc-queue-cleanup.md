...
On its next scheduled run, the ECC Queue auto-purge job removes and flags messages according to its [purge categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/ecc-queue-auto-purge.md).
