...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/configure-trusting-account-for-ccg.html
release: xanadu
...
-   Set up the trusted and the trusting account as described in [Set up Cloud Configuration Governance for AWS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/set-up-ccg-for-aws.md).
