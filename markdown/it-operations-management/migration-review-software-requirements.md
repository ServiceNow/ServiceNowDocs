...
breadcrumb: [Using Cloud Migration Assessment in Configurable Workspace, Cloud Migration Assessment, ITOM Cloud Accelerate, IT Operations Management]
---

# Review applications associated with assessment tasks in Configurable Workspace

Understand software requirements for resources assigned to assessment tasks. Most resources host applications. Review the list of tasks filtered to show application-related information.
...
<table id="additional-actions-buttons"><thead><tr><th>
