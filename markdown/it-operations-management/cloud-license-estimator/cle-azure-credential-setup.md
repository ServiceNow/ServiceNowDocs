...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/cloud-license-estimator/cle-azure-credential-setup.html
release: australia
...
3.  Enter the following details:
    ...
    -   **Credentials**: Select the Azure Service principle credentials configured in [Configure Azure Credentials for Cloud License Estimator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/cloud-license-estimator/cle-azure-credential-setup.md).
