...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/cloud-license-estimator/explore-cloud-license-estimator.html
release: zurich
...
The **Cloud License Estimator** estimates cloud resources eligible for licensing under ITOM and CCM licensing rules.

 It validates the  cloud  account details and estimates the resource  count  based on current licensing rules.
