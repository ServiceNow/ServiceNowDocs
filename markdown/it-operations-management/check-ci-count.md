...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/check-ci-count.html
release: yokohama
...
1.  Navigate to **ITOM License** &gt; **License Report**.
    ...
    To know more about the fields in the Licence Report window, see [License Report form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/license-report-form.md).
