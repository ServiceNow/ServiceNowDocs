...
1.  Navigate to **ITOM License** &gt; **License Report**.
    ...
    To know more about the fields in the Licence Report window, see [License Report form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/license-report-form.md).
