---
title: Plugins or applications installed with ITOM Health
description: Tables that list the plugins or applications that are installed with ITOM Health applications. When you update your application, any newly required application dependencies are installed.
locale: en-US
release: xanadu
topic_type: reference
last_updated: "2024-08-01"
reading_time_minutes: 10
breadcrumb: [Applying CSDM guidelines to ITOM Health, ITOM Health, IT Operations Management]
---

# Plugins or applications installed with ITOM Health

Tables that list the plugins or applications that are installed with ITOM Health applications. When you update your application, any newly required application dependencies are installed.
