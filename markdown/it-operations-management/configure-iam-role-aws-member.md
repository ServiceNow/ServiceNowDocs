...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/configure-iam-role-aws-member.html
release: xanadu
topic_type: task
...
2.  On the ServiceNow AI Platform, configure the trusting member's service account.
    ...
    4.  On the form, fill in the remaining fields.
        ...
        For a description of the field values, see [Create AWS service accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/create-aws-service-accounts.md).
...
-   For information on configuring accessor accounts with AWS credentials, see [Configure access using temporary credentials based on trusted AWS accounts with AWS credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/configure-iam-role-aws-account.md).
-   For information on configuring accessor accounts without AWS credentials, see [Configure access using temporary credentials based on trusted AWS accounts without AWS credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/aws-trusted-credential-less.md).
