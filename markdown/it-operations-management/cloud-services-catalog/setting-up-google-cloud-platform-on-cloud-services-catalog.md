...
for the first time, see [Day 1 setup guide for Cloud Provisioning and Governance: Google Cloud Connector](../../cloud-management-v2-setup/concept/cloud-mgt-gcp-setup-day-1.md).
