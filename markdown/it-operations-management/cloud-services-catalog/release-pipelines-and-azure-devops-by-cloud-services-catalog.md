...
Cloud Services Catalog offers the Azure DevOps release pipeline as a CI-CD tool. You can use it to build, test, and deploy applications for the entire development life cycle across different platforms and cloud providers.
