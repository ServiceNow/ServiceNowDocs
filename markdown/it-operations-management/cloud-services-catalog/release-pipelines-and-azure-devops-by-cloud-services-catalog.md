...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/cloud-services-catalog/release-pipelines-and-azure-devops-by-cloud-services-catalog.html
release: xanadu
...
Cloud Services Catalog offers the Azure DevOps release pipeline as a CI-CD tool that enables you to build, test, and deploy applications for the entire development life cycle across different platforms and cloud providers.
...
**Parent Topic:**[Integrating Azure DevOps and the Continuous Integration-Continuous Deployment pipeline](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-services-catalog/integrating-azure-devops-and-cicd-pipeline.md)
