...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/cloud-services-catalog/google-cloud-platform-big-query.html
release: xanadu
...
</table>-   **[Google Cloud Platform \(GCP\) Big Query Out Of Box permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-services-catalog/gcp-big-query-oob-permissions.md)**  
GCP Big Query Out Of Box catalog items permissions

**Parent Topic:**[Out Of Box Catalogs using Cloud Services Catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/cloud-services-catalog/out-of-the-box-catalog-items.md)
