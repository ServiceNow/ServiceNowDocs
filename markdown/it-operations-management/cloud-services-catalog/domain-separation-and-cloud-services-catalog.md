...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/cloud-services-catalog/domain-separation-and-cloud-services-catalog.html
release: zurich
...
-   **CSC Guided setup**
    ...
    CSC Guided Setup can be executed by a system administrator within the global domain or a feature admin \(sn\_cmp.cmp\_root\_admin\). It is important to note that the local domain is not the suited environment for this task.
...
For more information on how domain separation works in Cloud Provisioning and Governance, visit [Domain separation and Cloud Provisioning and Governance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/cloud-configuration-governance/domain-separation-cloud-management.md).
