...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/cloud-services-catalog/out-of-box-actions.html
release: yokohama
...
2.  Ensure that in the Catalog’s Provision variable set, the variable called 'keypath'. Set the default value to the path of the management key on the terraform VM. This key decrypts the password.
...
</table>**Parent Topic:**[Out Of Box Catalogs using Cloud Services Catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/cloud-services-catalog/out-of-the-box-catalog-items.md)
