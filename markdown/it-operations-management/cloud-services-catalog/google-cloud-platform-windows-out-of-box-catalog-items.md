...
CSC GCP Windows Cloud Firewall: Order a secure Windows virtual machine with enhanced security. Allow or deny traffic to and from your VM instances based on your specified configuration.
