...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/create-synthetic-monitors-from-incidents.html
release: yokohama
topic_type: task
...
-   At least one execution location \(\[Omitted image "recommendations-icon.png"\] self hosted MID Server\) is available and configured
