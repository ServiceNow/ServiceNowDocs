...
To learn more about using the workflow, see [Use the Analyze potential impact agentic workflow to assess a change request](../task/use-now-assist-analyze-impact-agentic-workflow.md).
...
-   [Activate the Service Mapping Candidate skill](../task/activate-sm-candidate-skill.md)
-   [Activate the Service Mapping Candidates Impact skill](../task/activate-sm-candidates-impact-skill.md)
...
-   **[Use the Analyze potential impact agentic workflow to assess a change request](../task/use-now-assist-analyze-impact-agentic-workflow.md)**  
