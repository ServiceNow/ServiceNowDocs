...
The analyze potential impact agentic workflow in Now Assist uses a single agent to evaluate the potential impact of a change request. When you select the analyze potential impact AI agent in the Now Assist panel, it initiates the workflow as follows:
