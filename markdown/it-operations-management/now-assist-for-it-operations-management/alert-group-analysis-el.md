...
3.  In the Active alerts list, select the information icon \(![Information icon.](../../agent-client-collector/image/icon-info.png)\) to the left of an alert group to display the preview panel.
