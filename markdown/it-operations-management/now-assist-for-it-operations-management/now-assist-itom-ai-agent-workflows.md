---
title: Use agentic AI in ServiceNow Otto for ITOM
...
# Use agentic AI in ServiceNow Otto for ITOM
...
Displays error analysis created by generative AI. Error analyses enable asking questions on a specific agent's error or error code.
...
-   Observability agents
 ...
 For details about observability agents, see [Configure observability agents for ServiceNow Otto](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/now-assist-for-it-operations-management/configure-integration-agents-for-now-assist.md).
...
View which certificates are about to expire and renew them by using the certificate renewal AI agent. Choose a specific certificate and renew it on the spot.
