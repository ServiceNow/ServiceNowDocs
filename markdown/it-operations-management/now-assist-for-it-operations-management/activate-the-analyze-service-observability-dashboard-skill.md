...
description: The analyze Service Observability dashboard skill uses generative AI to provide an analysis of a Service Observability dashboard. You must activate this skill before using it.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/now-assist-for-it-operations-management/activate-the-analyze-service-observability-dashboard-skill.html
release: zurich
...
The analyze Service Observability dashboard skill uses generative AI to provide an analysis of a Service Observability dashboard. You must activate this skill before using it.
