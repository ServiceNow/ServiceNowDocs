...
-   For the Avi Load Balancer VIP pattern:
    -   [Create an service instance](https://www.servicenow.com/docs/access?context=create-it-services&version=australia&pubname=australia-servicenow-platform&ft:locale=en-US).
