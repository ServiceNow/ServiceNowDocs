...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery-and-service-mapping-patterns/avi-load-balancer-discovery.html
release: xanadu
...
-   For the Avi Load Balancer Controller pattern:
    ...
    -   Configure the following credentials:
        ...
        4.  [Run a Quick Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/t_DiscoverNow.md) on the IP address of the Avi Controller Cluster.
-   For the Avi Load Balancer Controller - Session-based pattern:
    -   Create a Basic Authentication credential with an alias:
        ...
        8.  Click **Update**.
    -   Create a [serverless discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/serverless-discovery.md) schedule.
...
-   For the Avi Load Balancer VIP pattern:
    -   [Create an service instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/configuration-management-database-cmdb/create-it-services.md).
