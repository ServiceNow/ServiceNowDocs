...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery-and-service-mapping-patterns/avi-load-balancer-discovery.html
release: yokohama
...
The ServiceNow Discovery and Service Mapping applications use the Avi load balancer discovery patterns to find Avi Vantage load balancer components. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
-   For the Avi Load Balancer Controller pattern:
    ...
    -   Configure the following credentials:
        ...
        4.  [Run a Quick Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/t_DiscoverNow.md) on the IP address of the Avi Controller Cluster.
-   For the Avi Load Balancer Controller - Session-based pattern:
    -   Create a Basic Authentication credential with an alias:
        ...
        8.  Click **Update**.
    -   Create a [serverless discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/serverless-discovery.md) schedule.
...
-   For the Avi Load Balancer VIP pattern:
    -   [Create an service instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/create-it-services.md).
