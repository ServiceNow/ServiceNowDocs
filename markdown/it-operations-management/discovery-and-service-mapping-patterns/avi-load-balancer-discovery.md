...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/avi-load-balancer-discovery.html
release: australia
...
-   For the Avi Load Balancer Controller pattern:
    ...
    -   Configure the following credentials:
        ...
        4.  [Run a Quick Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/t_CreateADiscoverySchedule.md) on the IP address of the Avi Controller Cluster.
-   For the Avi Load Balancer Controller - Session-based pattern:
    -   Create a Basic Authentication credential with an alias:
        ...
        8.  Click **Update**.
    -   Create a [serverless discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/serverless-discovery.md) schedule.
