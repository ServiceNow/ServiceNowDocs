---
title: Azure Event Grid System Topic discovery with Patterns
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/azure-event-grid-pattern.html
release: australia
...
|Metric Resource Id \[metric\_resource\_id\]|The identifier used for accessing metrics related to the resource.|
|Object Id \[object\_id\]|The unique identifier of the resource within Azure.|
|Provisioning State \[provisioning\_state\]|The current status of the resource's provisioning process.|
...
|Topic Type \[topic\_type\]|The category or type of the event topic.|
...
|Azure Event Grid - System Topic \[cmdb\_azure\_event\_grid\_system\_topic\]|References|Cloud Messaging Service \[cmdb\_ci\_cloud\_messaging\_service\]|
