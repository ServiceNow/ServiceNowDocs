...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery-and-service-mapping-patterns/oracle-oid-server-pattern.html
release: zurich
...
keywords: [Oracle Internet Directory Server, application pattern, pattern-based discovery]
breadcrumb: [Available on-premise discovery patterns, Discovery patterns used by ITOM Visibility, ITOM Visibility, IT Operations Management]
---

# Oracle Internet Directory Server pattern-based discovery

Discovery and Service Mapping Patterns uses the Oracle - Internet Directory Server pattern to find Oracle Internet Directory Server instances running on Windows servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
-   **Verify read access to the application executable**
    ...
    Verify you have permission for the following command: `powershell -Command "(Get-Item '{executablePath}').VersionInfo"`.
...
Discovery populates the data in the CMDB when running the Oracle - Internet Directory Server pattern.
...
|Field|Description|
|-----|-----------|
|Name \[name\]|Name of the application in the following format: **Oracle Internet Directory Server@\{hostname\}**.|
|Product \[product\]|Product name. The value is set to **Internet Directory Server**.|
...
The Oracle - Internet Directory Server pattern creates the following relationships and references to support Oracle Internet Directory Server discovery. References link to records in other tables and don't appear in the CI Relationship \[cmdb\_rel\_ci\] table.
