---
title: Amazon Timestream for InfluxDB Database Instance pattern-based discovery
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery-and-service-mapping-patterns/aws-timestream-influxdb-db-instance.html
release: yokohama
...
|DB Instance Type \[db\_instance\_type\]|The compute and memory configuration type for the InfluxDB instance.|
|DB Storage Type \[db\_storage\_type\]|The storage class or type used for the InfluxDB instance.|
|Object Id \[object\_id\]|The Amazon Resource Name \(ARN\) uniquely identifying the InfluxDB instance.|
...
|Object ID \[object\_id\]|The ARN uniquely identifying the InfluxDB instance.|
...
|AWS Timestream for InfluxDB Database Instance \[cmdb\_aws\_timestream\_for\_influxdb\_database\_instance\]|References|Cloud DataBase \[cmdb\_ci\_cloud\_database\]|
