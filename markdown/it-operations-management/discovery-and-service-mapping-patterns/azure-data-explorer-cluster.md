---
title: Azure Data Explorer Cluster pattern-based discovery
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/azure-data-explorer-cluster.html
release: australia
...
|Resource Group \[resource\_group\]|The name of the resource group that contains the resource.|
...
|Enable Disk Encryption \[enable\_disk\_encryption\]|Specifies whether disk encryption is enabled on the resource.|
|Public Network Access \[public\_network\_access\]|Indicates if the resource is accessible over a public network.|
...
|Cluster ID \[cluster\_id\]|The unique identifier of the Azure resource.|
|Cluster Status \[cluster\_status\]|The current operational status of the Kusto cluster.|
|Install Status \[install\_status\]|Install status of the resource. Default value is Installed.|
|Operational status \[operational\_status\]|Operational status of the resource. Default value is Operational.|
|Description \[short\_description\]|Type of resource. The value is set to **microsoft.kusto/clusters**.|
...
|Azure Data Explorer Cluster \[cmdb\_azure\_data\_explorer\_clusters\_data\_explorer\_clusters\]|References|Cloud DataBase Cluster \[cmdb\_ci\_cloud\_db\_cluster\]|
