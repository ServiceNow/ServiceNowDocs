---
title: AWS DataSync Task pattern-based discovery
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery-and-service-mapping-patterns/aws-datasync-task.html
release: yokohama
...
|Field|Description|
|-----|-----------|
|Object Id \[object\_id\]|The Amazon Resource Name \(ARN\) uniquely identifying the DataSync task.|
...
|Task Mode \[task\_mode\]|The execution mode of the DataSync task. For example: one-time or scheduled.|
...
|Field|Description|
|-----|-----------|
|Object ID \[object\_id\]|The ARN uniquely identifying the DataSync task.|
|Name \[name\]|The name assigned to the AWS DataSync task.|
...
|AWS DataSync - Task \[cmdb\_aws\_datasync\_task\]|References|Cloud App Server \[cmdb\_ci\_cloud\_appserver\]|
