---
title: AWS Batch Compute Environment pattern-based discovery
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery-and-service-mapping-patterns/aws-batch-compute-environment.html
release: yokohama
...
|Field|Description|
|-----|-----------|
|Object Id \[object\_id\]|The Amazon Resource Name \(ARN\) uniquely identifying the compute environment.|
...
|ECS Cluster ARN \[ecs\_cluster\_arn\]|The ARN of the Amazon ECS cluster associated with the compute environment.|
...
|Field|Description|
|-----|-----------|
|Object ID \[object\_id\]|The ARN uniquely identifying the compute environment.|
|Name \[name\]|The name of the compute environment.|
...
|AWS Batch - Compute Environment \[cmdb\_aws\_batch\_compute\_environment\]|References|Cloud App Server \[cmdb\_ci\_cloud\_appserver\]|
