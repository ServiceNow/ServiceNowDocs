---
title: Red Hat WildFly Server pattern-based discovery
description: Discovery and Service Mapping Patterns uses the Red Hat - WildFly Server pattern to find WildFly Server instances running on Windows servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/red-hat-wildfly-server-pattern.html
release: australia
...
# Red Hat WildFly Server pattern-based discovery

Discovery and Service Mapping Patterns uses the Red Hat - WildFly Server pattern to find WildFly Server instances running on Windows servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
-   **Verify permission to run the WildFly version command**

    Verify you have permission for the following command: `"{executablePath}standalone.bat" --version`.
...
Discovery populates the data in the CMDB when running the Red Hat - WildFly Server pattern.
...
|Field|Description|
|-----|-----------|
|Name \[name\]|Name of the application in the following format: **Red Hat WildFly Server@\{hostname\}**.|
|Product \[product\]|Product name. The value is set to **WildFly**.|
...
The Red Hat - WildFly Server pattern creates the following relationships and references to support Red Hat WildFly Server discovery. References link to records in other tables and don't appear in the CI Relationship \[cmdb\_rel\_ci\] table.
