...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery-and-service-mapping-patterns/cohesity-storage-system-discovery.html
release: zurich
...
-   **Create a serverless discovery schedule**
    ...
    For more information, see [Create a serverless schedule for Cohesity storage system discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery-and-service-mapping-patterns/create-serverless-schedule-cohesity.md).
