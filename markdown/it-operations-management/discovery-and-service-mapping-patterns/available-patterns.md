...
-   **[Amazon Cognito discovery](../reference/aws_cognito-discovery-pattern.md)**  
...
-   **[Amazon DB cluster discovery with Patterns](../reference/aws-db-cluster-discovery.md)**  
...
-   **[Amazon DynamoDB discovery using Patterns](aws-dynamoDB-discovery.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Amazon ElastiCache discovery with Patterns](../reference/amazon-aws-elasticache-discovery.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Amazon Relational Database Service \(Amazon RDS\) discovery with Patterns](../reference/aws-rds-discovery.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Amazon Redshift discovery with Patterns](../reference/amazon-redshift-discovery.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Amazon Route 53 pattern-based discovery](../reference/aws-route-53-pattern.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Amazon Simple Storage Service \(Amazon S3\) discovery](aws-s3-discovery.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[AWS application ELB Service discovery](../reference/aws-application-elb-service-discovery.md)**  
...
-   **[AWS Auto Scaling groups discovery with Patterns](../reference/aws-auto-scaling-discovery.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[AWS classic ELB Service discovery](../reference/aws-classic-elb-service-discovery.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[AWS datacenter pattern-based discovery](../reference/aws-datacenter-pattern.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[AWS hardware type pattern-based discovery](../reference/aws-hardware-type-pattern.md)**  
...
-   **[AWS Keyspaces discovery](../reference/amazon-keyspaces-discovery.md)**  
...
-   **[AWS Kinesis discovery](../reference/amazon-kinesis-discovery.md)**  
...
-   **[AWS Lambda discovery with Patterns](aws-lambda-discovery.md)**  
...
-   **[AWS MemoryDB for Redis](../reference/aws-memorydb-discovery.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[AWS OpenSearch discovery](../reference/amazon-opensearch-discovery.md)**  
...
-   **[AWS Organizations pattern-based discovery](../reference/aws-organizations-pattern.md)**  
...
-   **[AWS OS image pattern-based discovery](../reference/aws-os-image-pattern.md)**  
...
-   **[Amazon Web Services \(AWS\) Resource Inventory](../reference/aws-resource-inventory.md)**  
...
-   **[AWS Serverless Database pattern-based discovery](../reference/aws-serverless-database-pattern.md)**  
...
-   **[AWS Services discovery using patterns](../reference/aws-service-discovery-pattern.md)**  
...
Discovery and Service Mapping Patterns finds AWS services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[AWS sub account pattern-based discovery](../reference/aws-sub-account-pattern.md)**  
...
-   **[AWS tag discovery](../reference/aws-discovery-pattern.md)**  
...
-   **[AWS virtual server pattern-based discovery](../reference/aws-virtual-server-pattern.md)**  
...
-   **[Google Cloud Platform \(GCP\) Cloud components discovery using Patterns](../reference/gcp-cloud-discovery-patterns.md)**  
...
-   **[Google Cloud Platform \(GCP\) AlloyDB for PostgreSQL discovery using patterns](../reference/gcp-alloydb-postgresql-patterns.md)**  
...
-   **[GCP BigQuery pattern-based discovery](../reference/gcp-bigquery-db-pattern.md)**  
...
-   **[GCP Bigtable pattern-based discovery](../reference/gcp-bigtable-db-pattern.md)**  
...
-   **[GCP Cloud Firestore pattern-based discovery](../reference/gcp-firestore-db-pattern.md)**  
...
-   **[Google Cloud Platform \(GCP\) Cloud Functions discovery using patterns](../reference/gcp-cloud-functions-patterns.md)**  
...
-   **[GCP Cloud SQL pattern-based discovery](../reference/gcp-cloud-sql-db-pattern.md)**  
...
-   **[GCP Disk Types pattern-based discovery](../reference/gcp-disk-types-pattern.md)**  
...
-   **[GCP Events pattern-based discovery](../reference/gcp-events-pattern.md)**  
...
-   **[GCP External IP Addresses pattern-based discovery](../reference/gcp-external-ip-addresses-pattern.md)**  
...
-   **[GCP Firebase Realtime Database pattern-based discovery](../reference/gcp-firebase-realtime-db-pattern.md)**  
...
-   **[GCP Load Balancer pattern-based discovery](../reference/gcp-load-balancer-pattern.md)**  
...
-   **[Google Cloud Platform \(GCP\) Memorystore discovery using patterns](../reference/gcp-memorystore-patterns.md)**  
...
-   **[GCP Networking pattern-based discovery](../reference/gcp-networking-pattern.md)**  
...
-   **[Google Cloud Platform \(GCP\) Organization discovery with Patterns](../reference/google-gcp-organization-discovery.md)**  
...
-   **[Google Cloud Platform \(GCP\) resource inventory discovery](../reference/gcp-resource-inventory-discovery.md)**  
...
-   **[GCP Spanner pattern-based discovery](../reference/gcp-spanner-db-pattern.md)**  
...
-   **[GCP SSH Keys pattern-based discovery](../reference/gcp-ssh-keys-pattern.md)**  
...
-   **[GCP Storage pattern-based discovery](../reference/gcp-storage-pattern.md)**  
...
-   **[GCP virtual server pattern-based discovery](../reference/gcp-virtual-server-pattern.md)**  
...
-   **[Microsoft Azure Cloud components discovery using patterns](../reference/azure-cloud-discovery-patterns.md)**  
...
-   **[Azure App Configuration store pattern-based discovery](../../patterns/azure-app-configuration-store.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure App Service App Service Plan pattern-based discovery](../../patterns/azure-app-service-plan.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Microsoft Azure Application Gateway discovery with Patterns](azure-application-gateway-discovery.md)**  
...
-   **[Azure Application Insight Component pattern-based discovery](../../patterns/azure-app-insight-component.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Application Insight Data Collection Rule pattern-based discovery](../../patterns/azure-app-insight-data-collect-rule.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Application Security Group pattern-based discovery](../../patterns/azure-app-security-group.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Automation Account pattern-based discovery](../../patterns/azure-automation-account.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure availability sets discovery using patterns](../reference/azure-availability-sets-patterns.md)**  
...
-   **[Azure availability zones discovery using patterns](../reference/azure-availability-zones-patterns.md)**  
...
-   **[Azure Blob Storage pattern-based discovery](../reference/azure-blob-storage-pattern.md)**  
...
-   **[Azure Classic Load Balancer pattern-based discovery](../reference/azure-classic-load-balancer-pattern.md)**  
...
-   **[Azure Compute Gallery Image Definition pattern-based discovery](../../patterns/azure-compute-gallery-img-definition.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Compute Snapshot pattern-based discovery](../../patterns/azure-compute-snapshot.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Container Registry pattern-based discovery](../../patterns/azure-container-registry.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Data Factory pattern-based discovery](../../patterns/azure-data-factory.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Data Protection Backup Vault pattern-based discovery](../../patterns/azure-data-protection-backup-vault.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Databricks Workspace pattern-based discovery](../../patterns/azure-databricks-workspace.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Datacenter discovery pattern-based discovery](../reference/azure-datacenter-discovery-pattern.md)**  
...
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Disk Encryption Set pattern-based discovery](../../patterns/azure-disk-encryption-set.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure DNS zones and record sets discovery using Patterns](../reference/azure-dns-discovery.md)**  
...
-   **[Azure Event Grid System Topic discovery with Patterns](../../patterns/azure-event-grid-pattern.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Event Hub Namespace pattern-based discovery](../../patterns/azure-event-hub-namespace.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Express Route Circuit pattern-based discovery](../reference/azure-express-route-circuit-pattern.md)**  
...
-   **[Azure File Share pattern-based discovery](../reference/azure-file-share-pattern.md)**  
...
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Microsoft Azure Functions discovery with Patterns](azure-function-discovery.md)**  
...
-   **[Azure hardware type pattern-based discovery](../reference/azure-hardware-type-pattern.md)**  
...
-   **[Azure Host pattern-based discovery](../reference/azure-host-pattern.md)**  
...
-   **[Azure Key Vault pattern-based discovery](../../patterns/azure-key-vault.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Local Network Gateway pattern-based discovery](../reference/azure-local-network-gateway-pattern.md)**  
...
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Logic App pattern-based discovery](../../patterns/azure-logic-app.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Managed Identity User Assigned Identity pattern-based discovery](../../patterns/azure-managed-id-user-assigned-id.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Network Address Translation \(NAT\) Gateway pattern-based discovery](../reference/azure-nat-gateway-pattern.md)**  
...
-   **[Azure Networks IP Group pattern-based discovery](../../patterns/azure-networks-ip-group.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure OS image pattern-based discovery](../reference/azure-os-image-pattern.md)**  
...
-   **[Azure Private Domain Name System \(DNS\) Zone pattern-based discovery](../reference/azure-private-dns-zone-pattern.md)**  
...
-   **[Azure Private Link Private Endpoint pattern-based discovery](../../patterns/azure-private-link-private-endpoint.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Microsoft Azure resource inventory discovery](../reference/azure-resource-inventory-pattern.md)**  
...
-   **[Azure Service Bus Namespace pattern-based discovery](../../patterns/azure-service-bus-namespace.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Service Bus Queue pattern-based discovery](../../patterns/azure-service-bus-queue.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Service Bus Topic pattern-based discovery](../../patterns/azure-service-bus-topic.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Service Endpoint Policy pattern-based discovery](../../patterns/azure-service-endpoint-policy.md)**  
Discovery and Service Mapping Patterns finds Azure services on your cloud environment. Discovering some of these resources may require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
-   **[Azure Subscriptions Discovery For Management Group pattern-based discovery](../reference/azure-sub-mgmt-group-pattern.md)**  
...
-   **[Azure Virtual Network Gateway Connection pattern-based discovery](../reference/azure-vng-connection-pattern.md)**  
