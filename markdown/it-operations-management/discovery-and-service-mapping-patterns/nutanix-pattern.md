...
-   **Install Nutanix end-point SSL certificates for the MID Server JRE**
    ...
    2.  Add SSL certificates for the MID Server, as described in [Add SSL certificates for the MID Server](https://www.servicenow.com/docs/access?context=add-ssl-certificates&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
...
-   **Configure basic authentication credentials**
    ...
    For more information, see [Basic authentication credentials](https://www.servicenow.com/docs/access?context=r_BasicAuthCredentialsForm&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
