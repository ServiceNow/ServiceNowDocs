...
-   **Discovered resources and relationships**
    ...
    [Resources discovered using the Azure DataBase \(LP\) pattern extension: Azure SQL Managed Instance license](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery-and-service-mapping-patterns/azure-cloud-discovery-patterns.md)

    [Relationships discovered using the Azure DataBase \(LP\) pattern extension: Azure SQL Managed Instance license](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery-and-service-mapping-patterns/azure-cloud-discovery-patterns.md)
...
-   **Discovered resources and relationships**
    ...
    [Resources discovered by the Azure - Marketplace LB \(LP\) pattern](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery-and-service-mapping-patterns/azure-cloud-discovery-patterns.md)

    [Relationships discovered using the Azure - Marketplace LB \(LP\) pattern](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery-and-service-mapping-patterns/azure-cloud-discovery-patterns.md)
