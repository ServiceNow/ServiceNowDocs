...
-   **Verify the configuration of Cloud Discovery for Microsoft Azure**
    -   Use the Cloud Discovery Workspace to set up Cloud Discovery. For more information, see [Cloud Discovery setup using Cloud Discovery Workspace](../../discovery/concept/cloud-discovery-setup-workspace.md)
    -   Enable Cloud Discovery to access your Azure environment. For more information, see [Azure Cloud Discovery](../../discovery/concept/azure-cloud-discovery.md)
