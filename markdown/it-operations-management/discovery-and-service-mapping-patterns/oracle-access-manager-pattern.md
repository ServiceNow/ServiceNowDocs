---
title: Oracle Access Manager pattern-based discovery
description: Discovery and Service Mapping Patterns uses the Oracle - Access Manager pattern to find Oracle Access Manager instances running on Windows servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/oracle-access-manager-pattern.html
release: australia
...
# Oracle Access Manager pattern-based discovery

Discovery and Service Mapping Patterns uses the Oracle - Access Manager pattern to find Oracle Access Manager instances running on Windows servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
Discovery populates the data in the CMDB when running the Oracle - Access Manager pattern.
...
|Field|Description|
|-----|-----------|
|Name \[name\]|Name of the application in the following format: **Oracle Access Manager@\{hostname\}**.|
|Product \[product\]|Product name. The value is set to **Access Manager**.|
...
The Oracle - Access Manager pattern creates the following relationships and references to support Oracle Access Manager discovery. References link to records in other tables and don't appear in the CI Relationship \[cmdb\_rel\_ci\] table.
