...
description: Discovery and Service Mapping Patterns uses the Alibaba - Storage Volume \(LP\) pattern to discover storage volumes during horizontal discovery. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/alibaba-storage-volume.html
release: australia
...
Discovery and Service Mapping Patterns uses the Alibaba - Storage Volume \(LP\) pattern to discover storage volumes during horizontal discovery. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
