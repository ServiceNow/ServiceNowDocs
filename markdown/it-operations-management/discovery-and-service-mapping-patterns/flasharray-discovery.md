...
-   **Verify the configuration of the credentials**
    ...
    Configure basic authentication credentials to classify FlashArray. For more information, see [basic authentication](https://www.servicenow.com/docs/access?context=r_BasicAuthCredentialsForm&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
