---
title: Red Hat Podman pattern-based discovery
description: Discovery and Service Mapping Patterns uses the Red Hat - Podman pattern to find Podman container engines running on UNIX servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/red-hat-podman-pattern.html
release: australia
...
keywords: [Podman, Red Hat, container engine]
breadcrumb: [Available on-premise discovery patterns, Discovery patterns used by ITOM Visibility, ITOM Visibility, IT Operations Management]
---

# Red Hat Podman pattern-based discovery

Discovery and Service Mapping Patterns uses the Red Hat - Podman pattern to find Podman container engines running on UNIX servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
-   **Verify permission to run the version command**
    ...
    Verify you have permission for the following command: `{process.executablePath} --version`.
...
Discovery populates the data in the CMDB when running the Red Hat - Podman pattern.
...
|Field|Description|
|-----|-----------|
|Name \[name\]|Name of the application in the following format: **Red Hat Podman@\{hostname\}**.|
|Product \[product\]|Product name. The value is set to **Podman**.|
...
The Red Hat - Podman pattern creates the following relationships and references to support Red Hat Podman discovery. References link to records in other tables and don't appear in the CI Relationship \[cmdb\_rel\_ci\] table.
