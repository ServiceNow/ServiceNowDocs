...
description: Improve existing patterns so that Service Mapping can find configuration item \(CI\) connections previously discovered using traffic-based discovery.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery-and-service-mapping-patterns/connection-section-traffic-based.html
release: zurich
...
6.  If there are multiple patterns used to discover this CI, select the pattern for which you want to create the step, and click **OK**.
    ...
    \[Omitted image "CreateParseStepTempStep.png"\] Alt text: Temporary Connection section in the Pattern Designer
...
8.  Search CI configuration files for data received using traffic-based discovery:
    ...
    1.  Under **Free Text**, review data automatically filled in from the Traffic Based Connections List.
        ...
        \[Omitted image "CreateParseStepSearchAssistant.png"\] Alt text: Search Assistant shows search criteria pulled directly from the Traffic Based Connections List
...
9.  Create a pattern step for parsing the configuration file containing information about the connection:
    ...
    2.  Wait for the file content to load and select the relevant entry under the file name:
        ...
        \[Omitted image "CreateParseStepSearchResults.png"\] Alt text: Search Result tab showing data found in files.
    ...
    3.  To use this data to create the pattern step, click **Create parse file step**.
        ...
        \[Omitted image "CreateParseStepPatternStep.png"\] Alt text: Automatically created step
...
10. Complete modifying the pattern as described in [Finalize a pattern](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery-and-service-mapping-patterns/t_FinalizePatternPatDef.md).
...
**Previous topic:**[Enhance patterns without modifying identification sections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery-and-service-mapping-patterns/modify-pattern-using-extensions.md)

**Next topic:**[Finalize a pattern](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery-and-service-mapping-patterns/t_FinalizePatternPatDef.md)

**Related topics**  


[Traffic-based discovery in Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/traffic-based-discovery.md)

[Enable traffic-based discovery for CI types or specific CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/t_CreateATrafficBasedDiscoveryRule.md)
