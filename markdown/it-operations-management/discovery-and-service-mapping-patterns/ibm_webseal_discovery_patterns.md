...
-   **Authentication**
    ...
    The WebSEAL authentication process includes HTTP header authentication with basic credentials [Basic authentication credentials](https://www.servicenow.com/docs/access?context=r_BasicAuthCredentialsForm&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).

    If you’re running discovery for the first time, configure Credential affinity for Discovery and Orchestration [Credential affinity for Discovery and Orchestration](https://www.servicenow.com/docs/access?context=c_CredentialAffinity&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
