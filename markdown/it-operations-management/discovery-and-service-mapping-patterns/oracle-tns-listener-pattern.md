---
title: Oracle TNS Listener pattern-based discovery
description: Discovery and Service Mapping Patterns uses the Oracle - TNS Listener pattern to find Transparent Network Substrate \(TNS\) Listener instances running on Windows servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/oracle-tns-listener-pattern.html
release: australia
...
keywords: [Oracle TNS Listener pattern-based discovery, TNS Listener, Oracle patterns, application pattern]
breadcrumb: [Available on-premise discovery patterns, Discovery patterns used by ITOM Visibility, ITOM Visibility, IT Operations Management]
---

# Oracle TNS Listener pattern-based discovery

Discovery and Service Mapping Patterns uses the Oracle - TNS Listener pattern to find Transparent Network Substrate \(TNS\) Listener instances running on Windows servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
Discovery populates the data in the CMDB when running the Oracle - TNS Listener pattern.
...
|Field|Description|
|-----|-----------|
|Name \[name\]|Name of the application in the following format: **TNS Listener@\{hostname\}**.|
|Product \[product\]|Product name. The value is set to **TNS Listener**.|
...
The Oracle - TNS Listener pattern creates the following relationships and references to support Oracle TNS Listener discovery. References link to records in other tables and don't appear in the CI Relationship \[cmdb\_rel\_ci\] table.
