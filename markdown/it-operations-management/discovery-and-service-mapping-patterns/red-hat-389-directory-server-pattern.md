---
title: Red Hat 389 Directory Server pattern-based discovery
description: Discovery and Service Mapping Patterns uses the Red Hat - Directory Server pattern to find 389 Directory Server instances running on UNIX servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/red-hat-389-directory-server-pattern.html
release: australia
...
keywords: [Red Hat 389 Directory Server, directory server discovery, application pattern]
breadcrumb: [Available on-premise discovery patterns, Discovery patterns used by ITOM Visibility, ITOM Visibility, IT Operations Management]
---

# Red Hat 389 Directory Server pattern-based discovery

Discovery and Service Mapping Patterns uses the Red Hat - Directory Server pattern to find 389 Directory Server instances running on UNIX servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
-   **Verify permission to query the RPM database**

    Verify you have permission for the following command: `rpm -qf {process.executablePath}`.
...
Discovery populates the data in the CMDB when running the Red Hat - Directory Server pattern.
...
|Field|Description|
|-----|-----------|
|Name \[name\]|Name of the application in the following format: **Red Hat 389 Directory Server @\{hostname\}**.|
|Product \[product\]|Product name. The value is set to **389 Directory Server**.|
...
The Red Hat - Directory Server pattern creates the following relationships and references to support Red Hat 389 Directory Server discovery. References link to records in other tables and don't appear in the CI Relationship \[cmdb\_rel\_ci\] table.
