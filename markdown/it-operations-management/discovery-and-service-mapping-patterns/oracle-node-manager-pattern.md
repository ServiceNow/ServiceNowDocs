---
title: Oracle Node Manager pattern-based discovery
description: Discovery and Service Mapping Patterns uses the Oracle - Node Manager pattern to find Oracle Node Manager instances running on UNIX servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/oracle-node-manager-pattern.html
release: australia
...
keywords: [Oracle Node Manager, application pattern, pattern-based discovery]
breadcrumb: [Available on-premise discovery patterns, Discovery patterns used by ITOM Visibility, ITOM Visibility, IT Operations Management]
---

# Oracle Node Manager pattern-based discovery

Discovery and Service Mapping Patterns uses the Oracle - Node Manager pattern to find Oracle Node Manager instances running on UNIX servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
Discovery populates the data in the CMDB when running the Oracle - Node Manager pattern.
...
|Field|Description|
|-----|-----------|
|Name \[name\]|Name of the application in the following format: **Oracle Node Manager@\{hostname\}**.|
|Product \[product\]|Product name. The value is set to **Node Manager**.|
...
The Oracle - Node Manager pattern creates the following relationships and references to support Oracle Node Manager discovery. References link to records in other tables and don't appear in the CI Relationship \[cmdb\_rel\_ci\] table.
