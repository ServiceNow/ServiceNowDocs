...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery-and-service-mapping-patterns/emc-data-domain-pattern.html
release: zurich
...
To learn about Data Domain components and their versions that you can discover, refer to [Detailed information on products discovered by ITOM Visibility](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/r_SupportedApplications.md)
...
-   **Verify the configuration of a Serverless Discovery schedule**
    ...
    3.  Fill in the fields in the form.
        ...
        For more information about setting the **Max run time**, **Run**, and **Time** fields, see: [Schedule a horizontal discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/t_CreateADiscoverySchedule.md)
