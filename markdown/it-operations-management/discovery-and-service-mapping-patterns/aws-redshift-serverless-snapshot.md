---
title: Amazon Redshift Serverless Snapshot pattern-based discovery
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/discovery-and-service-mapping-patterns/aws-redshift-serverless-snapshot.html
release: yokohama
...
|Name \[name\]|The user-defined name of the resource.|
|Resource type \[resource\_type\]|Type of resource. The value is set to **AWS::Redshift Serverless::Snapshot**.|
...
|AWS Redshift Serverless - Snapshot \[cmdb\_aws\_redshift\_serverless\_snapshot\]|References|Cloud Resource \[cmdb\_ci\_cmp\_resource\]|
