...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/discovery-and-service-mapping-patterns/pure-storage-discovery.html
release: xanadu
...
-   **Configure SSH credentials**
    ...
    On the ServiceNow AI Platform, configure SSH credentials for the OS user. For more information, see [SSH credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/connections-and-credentials/r_SSHCredentialsForm.md).
