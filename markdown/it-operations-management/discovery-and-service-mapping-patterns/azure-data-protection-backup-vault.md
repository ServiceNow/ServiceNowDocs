---
title: Azure Data Protection Backup Vault pattern-based discovery
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/azure-data-protection-backup-vault.html
release: australia
...
|Resource type \[resource\_type\]|Type of resource. The value is set to **microsoft.dataprotection/backupvaults**.|
...
|Azure Data Protection - Backup Vault \[cmdb\_azure\_data\_protection\_backup\_vault\]|References|Cloud Resource \[cmdb\_ci\_cmp\_resource\]|
