...
-   **Enable PowerShell on the MID Server**
    ...
    For more information, see [Set up MID Servers to use PowerShell](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery/t_SetUpAMIDServerToUsePowerShell.md).
...
-   **Verify elevated rights for IBM WebSphere Application Server commands**
    ...
    For more information, see IBM WebSphere Application Server \(on UNIX\) table in [Service Mapping commands requiring a privileged user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/r_CommandsnCredentials.md).
