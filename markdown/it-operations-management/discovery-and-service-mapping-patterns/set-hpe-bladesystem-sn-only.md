...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/discovery-and-service-mapping-patterns/set-hpe-bladesystem-sn-only.html
release: zurich
...
To delete existing CI records with the **serial\_number::UUID** serial number format, run the **Clear HPE Blade Serial Numbers** scheduled job. For more information, see [Clear UUID serial numbers from existing HPE BladeSystem CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery-and-service-mapping-patterns/clear-uuid-hpe-bladesystem-cis.md).

**Parent Topic:**[HPE BladeSystem Enclosure Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery-and-service-mapping-patterns/hpe-bladesystem-enclosure-discovery.md)

**Related topics**  


[HPE BladeSystem Enclosure Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery-and-service-mapping-patterns/hpe-bladesystem-enclosure-discovery.md)
