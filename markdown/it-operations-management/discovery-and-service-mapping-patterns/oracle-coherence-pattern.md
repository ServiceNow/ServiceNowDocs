---
title: Oracle Coherence pattern-based discovery
description: Discovery and Service Mapping Patterns uses the Oracle - Coherence pattern to find Oracle Coherence instances running on UNIX servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/discovery-and-service-mapping-patterns/oracle-coherence-pattern.html
release: australia
...
# Oracle Coherence pattern-based discovery

Discovery and Service Mapping Patterns uses the Oracle - Coherence pattern to find Oracle Coherence instances running on UNIX servers. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
...
-   **Verify read access to the version file**
    ...
    Verify you have permission for the following command: `cat {process.environmentVariables.EMHOME.value}/inventory/ContentsXML/comps.xml | grep -i version`.
...
Discovery populates the data in the CMDB when running the Oracle - Coherence pattern.
...
|Field|Description|
|-----|-----------|
|Name \[name\]|Name of the application in the following format: **Coherence@\{hostname\}**.|
|Product \[product\]|Product name. The value is set to **Coherence**.|
...
The Oracle - Coherence pattern creates the following relationships and references to support Oracle Coherence discovery. References link to records in other tables and don't appear in the CI Relationship \[cmdb\_rel\_ci\] table.
