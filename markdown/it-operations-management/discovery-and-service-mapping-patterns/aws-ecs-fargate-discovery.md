---
title: Amazon ECS resource discovery
...
-   **Create AWS cloud service accounts**
    -   In the ServiceNow AI Platform, create AWS cloud service accounts using permanent or temporary AWS credentials. For more information, see [Set up AWS service accounts](../../it-operations-management/concept/setup-aws-service-accounts.md).
