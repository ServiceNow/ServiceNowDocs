...
5.  Define the parameters for the new entry point type as described in [Create a CI class](https://www.servicenow.com/docs/access?context=t_CreateCIType&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
