...
For more information about credential types and requirements, see [Create and test your credentials](https://www.servicenow.com/docs/access?context=t_CreateCredential&version=australia&pubname=australia-platform-security&ft:locale=en-US).
...
3.  From the **Credential type** drop-down list, select a credential type.
    ...
    |---------------|-----------|
    |[Applicative Credentials](https://www.servicenow.com/docs/access?context=applicative-creds&version=australia&pubname=australia-platform-security&ft:locale=en-US)|Credentials for discovering applications running on host machines.|
    |[Basic Auth Credentials](https://www.servicenow.com/docs/access?context=r_BasicAuthCredentialsForm&version=australia&pubname=australia-platform-security&ft:locale=en-US)|Credentials that use basic authentication with a user name and password.|
    |[CIM Credentials](https://www.servicenow.com/docs/access?context=r_CIMCredentialsForm&version=australia&pubname=australia-platform-security&ft:locale=en-US)|Credentials for devices that use the Common Information Model protocol.|
    ...
    |[SNP Community Credentials \(Password Only\)](https://www.servicenow.com/docs/access?context=c_SNMPCredentials&version=australia&pubname=australia-platform-security&section=r_SNMPCommunityCredentialsForm&ft:locale=en-US)|Credentials that use an SNMP community string for network devices.|
    |[SNMPv3 Credentials](https://www.servicenow.com/docs/access?context=c_SNMPCredentials&version=australia&pubname=australia-platform-security&section=r_SNMPCredentialsForm&ft:locale=en-US)|Credentials that use the SNMPv3 protocol with authentication and privacy options.|
    |[SSH Credentials](https://www.servicenow.com/docs/access?context=r_SSHCredentialsForm&version=australia&pubname=australia-platform-security&ft:locale=en-US)|Credentials for Linux, UNIX, and other SSH-enabled devices.|
    |[SSH Private Key Credentials](https://www.servicenow.com/docs/access?context=r_SSHCredentialsForm&version=australia&pubname=australia-platform-security&ft:locale=en-US)|Credentials that use an SSH private key for authentication instead of a password.|
    |SSL Keystore Credentials|Credentials that use an SSL keystore for secure communication.|
    |[VMWare Credentials](https://www.servicenow.com/docs/access?context=r_VMwareCredentialsForm&version=australia&pubname=australia-platform-security&ft:locale=en-US)|Credentials for VMware vCenter environments.|
    |[Windows Credentials](https://www.servicenow.com/docs/access?context=r_WindowsCredentialsForm&version=australia&pubname=australia-platform-security&ft:locale=en-US)|Credentials for Windows devices that use WMI or WinRM protocols.|
