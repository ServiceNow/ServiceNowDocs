...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/setup-azure-service-accounts.html
release: zurich
topic_type: task
...
3.  Fill in the fields by the following order:
    ...
    3.  Select **Should pull events** to preform event-based discovery. For more information, see [Microsoft Azure Alert driven discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/microsoft-azure-alert-driven-discovery.md)
