...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/set-up-gcp-service-accounts.html
release: xanadu
...
-   **[Configure the Google API credentials for Cloud Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/itom-create-google-api-credentials.md)**  
Create Google API credentials to allow Cloud Discovery to access the data on your Google account securely.
-   **[Google API Credentials Form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/google-api-credentials-form.md)**  
Fill in the Google API Credentials form to configure the credentials.
-   **[Create GCP service accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/create-gcp-service-accounts.md)**  
...
-   **[GCP access and permission using policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/gcp-access-and-permission-using-policies.md)**  
...
**Parent Topic:**[Setting up a cloud service account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/setup-cloud-service-account.md)
