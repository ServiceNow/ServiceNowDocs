...
</table>To return to the procedure, see [Configure Datadog metric pull connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/configure-datadog-metric-pull-connector.md).
