...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-observability/chart-error-states.html
release: zurich
...
|Authentication failed|Service Observability can't connect to the data source. See [Connect a Service Observability data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-observability/connect-an-observability-data-source.md).|
...
**Parent Topic:**[Service Observability reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-observability/service-observability-reference.md)
