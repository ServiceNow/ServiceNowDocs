...
|Authentication failed|Service Observability can't connect to the data source. See [Connect a Service Observability data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-observability/connect-an-observability-data-source.md).|
...
**Parent Topic:**[Service Observability reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-observability/service-observability-reference.md)
