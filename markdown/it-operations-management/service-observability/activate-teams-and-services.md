...
1.  [Connect an observability data source](../task/connect-an-observability-data-source.md)
2.  [Create and manage observability data mappings](../task/create-and-manage-observability-data-mappings.md)
