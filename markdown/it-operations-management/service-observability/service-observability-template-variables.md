...
**Note:** Amazon CloudWatch uses slightly different template variables. See [Advanced query support for AWS and Azure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-observability/advanced-query-support.md) for more information.
