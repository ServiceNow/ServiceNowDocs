---
title: New Relic Overview tab for Service Observability
description: Information that is displayed on the New Relic Overview tab of the Service Details page in the SOW.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-observability/new-relic-overview-tab-for-service-observability.html
release: yokohama
...
breadcrumb: [New Relic templates, Service Observability templates, Service Observability reference, Service Observability, ITOM Health, IT Operations Management]
---

# New Relic Overview tab for Service Observability

Information that is displayed on the New Relic **Overview** tab of the Service Details page in the SOW.
...
|----------|-----------|-----------|
|Rate|Aggregate rate of transactions through the service.|New Relic|
...
The Transactions charts show metrics for specific key transactions on the service. The key transactions are determined by your Application Performance Management \(APM\) system configuration.
...
</table>**Parent Topic:**[New Relic templates for Service Observability](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-observability/new-relic-templates.md)
