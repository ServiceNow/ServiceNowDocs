...
You can add metrics that are stored in the MetricBase application to your Service Observability dashboards. These charts display with data scoped to the selected service.
