...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/review-ci-reliability-itom-mcp-server.html
release: australia
topic_type: task
...
Verify that the ITOM MCP Server Console is active and the required plugins are installed on your instance. For more information, see [Activate the ITOM MCP Server Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/activate-itom-mcp-server.md).
