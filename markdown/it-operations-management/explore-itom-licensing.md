...
The ITOM/OT SU Licensing application calculates and displays how many subscriptions for IT Operations Management \(ITOM\) applications your organization purchases and consumes. Subscriptions for the following ITOM applications are available: ServiceNow® ITOM Visibility, ServiceNow® ITOM Discovery, ServiceNow® ITOM Health, ServiceNow® Health Log Analytics, ServiceNow® ITOM Optimization, ServiceNow® ITOM Cloud Accelerate, and ServiceNow® Digital End-User Experience \(DEX\), and ServiceNow® Service Observability. You can purchase subscriptions for each ITOM application separately \(a la carte\) or together \(in a bundle\).
