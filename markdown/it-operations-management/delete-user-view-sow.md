---
title: Delete a user view in Service Operations Workspace
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/delete-user-view-sow.html
release: australia
topic_type: task
...
1.  In your Event Management instance, in the navigation pane, search for **noc\_user\_view.list**.

    The Operator Workspace Views page opens.

    \[Omitted image "workspace-nocpit-views.png"\] Alt text: Operator Workspace Views
