...
You can install the AIOps LEAP application \(sn\_itom\_leap\) if you have the admin role.The application installs related ServiceNow® Store applications and plug-ins if they are not already installed.
...
2.  Find the AIOps LEAP application \(sn\_itom\_leap\) using the filter criteria and search bar.
