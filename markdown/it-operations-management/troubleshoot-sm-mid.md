...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/troubleshoot-sm-mid.html
release: yokohama
topic_type: topic
...
Restart the MID Server. See [Manually start, stop, and restart a MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/mid-server/t_InstallMIDServerAsWinService.md).

**Parent Topic:**[Troubleshoot synthetic monitors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/troubleshoot-synthetic-monitors.md)
