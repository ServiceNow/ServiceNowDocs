...
-   Add CIs to the CMDB for the device or application that you want to add, if necessary. See [Populate the CMDB](https://www.servicenow.com/docs/access?context=c_OptionsToPopulateCMDB&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) for more information.
...
There are system records in the Manual CI Exclusions/Inclusions \[svc\_manual\_ci\_exclusions\_inclusions\] table. See [Components installed with application services](https://www.servicenow.com/docs/access?context=components-installed-app-services&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US#manual-ci-inclusion-exclusion-list) for more information.
