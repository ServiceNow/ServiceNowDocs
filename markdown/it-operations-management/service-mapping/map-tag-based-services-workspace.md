...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/service-mapping/map-tag-based-services-workspace.html
release: xanadu
...
-   Use Tag Governance to optimize tag application in your organization. See [Tag Governance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/tag-governance/exploring-tag-governance.md) for more information.
...
<table id="choicetable_mmz_qlx_1gc"><thead><tr><th align="left" id="d478130e181">

Tag category option

</th><th align="left" id="d478130e184">

Action

</th></tr></thead><tbody><tr><td id="d478130e190">
