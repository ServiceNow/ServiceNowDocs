...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/service-mapping/r\_EntryPointsforBizSvcDef.html
release: australia
...
</table>To configure entry points for subnetworks, see [Fine-tune Service Mapping with MID affinity and IP reuse](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/service-mapping/network-location-mid-affinity-td-discovery.md).
