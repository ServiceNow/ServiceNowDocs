...
</table>To configure entry points for subnetworks, see [Fine-tune Service Mapping with MID affinity and IP reuse](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/network-location-mid-affinity-td-discovery.md).
