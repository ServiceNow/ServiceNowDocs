...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-mapping/create-pattern-from-generic-application.html
release: zurich
...
Make sure that you understand what [discovery process classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/discovery-classifiers.md) is.
...
You may configure Discovery to use a different identifier. For more information, see [Discovery identifiers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/c_DiscoveryIdentifiers.md).
