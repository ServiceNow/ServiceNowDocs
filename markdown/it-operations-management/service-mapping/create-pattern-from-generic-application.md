...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-mapping/create-pattern-from-generic-application.html
release: yokohama
...
Make sure that you understand what [discovery process classification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/discovery-classifiers.md) is.
...
3.  On the map, right-click the relevant generic application CI.
    ...
    \[Omitted image "MapGenericApp.png"\] Alt text: Generic applications displayed on the map
...
Select the name of the existing icon to represent this application on maps.
    ...
    4.  To add a dependent condition, click **OR** or **AND**.
        ...
        **Note:** If the value in the first condition is not unique like Java.exe, use additional conditions to narrow down the results.
        ...
        \[Omitted image "GAprocessClassificationCondition.png"\] Alt text: Define classification criteria using the condition builder.
...
8.  Verify that Service Mapping discovered the CI as you expected.
    ...
    \[Omitted image "MapGenericAppEgResult.png"\] Alt text: Correctly discovered application.
...
You may configure Discovery to use a different identifier. For more information, see [Discovery identifiers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/c_DiscoveryIdentifiers.md).
