...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-mapping/add-cis-connection-rules-multiple.html
release: zurich
...
In addition to connection rules that add CIs to multiple services, you can [create rules for adding CIs to specific application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/add-cis-connection-rules-single.md).
