...
description: Create rules for automatically adding traffic-based connections and the CIs they lead to in discovered application services. Create rules that add CIs to multiple application services.
locale: en-US
release: xanadu
