...
In addition to connection rules that add CIs to multiple services, you can [create rules for adding CIs to specific application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/add-cis-connection-rules-single.md).
