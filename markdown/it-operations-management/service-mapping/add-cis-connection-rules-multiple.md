...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/service-mapping/add-cis-connection-rules-multiple.html
release: australia
...
In addition to connection rules that add CIs to multiple services, you can [create rules for adding CIs to specific application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/service-mapping/add-cis-connection-rules-single.md).
