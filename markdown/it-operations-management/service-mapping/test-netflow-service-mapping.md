...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/service-mapping/test-netflow-service-mapping.html
release: xanadu
...
Learn about [Traffic-based discovery in Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/service-mapping/traffic-based-discovery.md).
...
6.  Configure Service Mapping to receive data collected by the Netflow collector:
    ...
    4.  On the dfdump file page, configure parameters as follows:
        ...
        |**nfdump data path**|The path to a location on the MID Server to which you saved the nfdump data file in [5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/service-mapping/test-netflow-service-mapping.md).|
