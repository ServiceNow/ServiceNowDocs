...
6.  Configure Service Mapping to receive data collected by the Netflow collector:
    ...
    4.  On the dfdump file page, configure parameters as follows:
        ...
        |**nfdump data path**|The path to a location on the MID Server to which you saved the nfdump data file in [5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/test-netflow-service-mapping.md).|
...
If you are satisfied with the results of the test, configure Netflow-based data collection as described in [Configure data collection using Netflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/configure-netflow-service-mapping.md).
