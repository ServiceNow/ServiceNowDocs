...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/service-mapping/pattern-based-discovery.html
release: australia
...
2.  The device hosting the application is identified.
    ...
    **Note:** For the detailed description of the horizontal discovery flow, refer to [Horizontal discovery process flow with probes and sensors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/c_DiscoProcessFlows.md).
