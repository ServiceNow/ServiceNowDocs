...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-operations-management/service-mapping/traffic-based-discovery.html
release: brazil
...
-   **Specific CI level**
    ...
    See [Enable traffic-based discovery for CI types or specific CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/t_CreateATrafficBasedDiscoveryRule.md) to learn more about creating rules for CI types or specific CIs.
...
[Remove CIs not belonging to application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/remove-cis-not-belonging-business-services.md)
