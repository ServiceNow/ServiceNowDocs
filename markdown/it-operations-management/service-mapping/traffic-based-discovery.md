...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-mapping/traffic-based-discovery.html
release: zurich
...
-   **Specific CI level**
    ...
    See [Enable traffic-based discovery for CI types or specific CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/t_CreateATrafficBasedDiscoveryRule.md) to learn more about creating rules for CI types or specific CIs.
...
[Remove CIs not belonging to application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/remove-cis-not-belonging-business-services.md)

[Data collection and discovery using Netflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/data-collection-netflow-mapping.md)

[Data collection and discovery using VPC Flow Logs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/data-collection-vpc-mapping.md)
