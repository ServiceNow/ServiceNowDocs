...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-mapping/map-business-services-in-bulk.html
release: zurich
...
-   Make sure that the service instances aren't too large:
    ...
    -   [Split the service into smaller services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/add-segment-to-business-service-map.md).
...
-   **[Add CIs to application services using connection rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/add-cis-connection-rules-multiple.md)**  
