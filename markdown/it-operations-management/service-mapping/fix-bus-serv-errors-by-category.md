...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-mapping/fix-bus-serv-errors-by-category.html
release: yokohama
...
1.  Navigate to **All** &gt; **Service Mapping** &gt; **Home** and then click **Fix Your Services** in the **Fix** box.
    ...
    **Note:** To [fix the errors for a particular service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/fix-or-ignore-errors-business-service-map.md) instead, click **Manage Errors by Service**.
