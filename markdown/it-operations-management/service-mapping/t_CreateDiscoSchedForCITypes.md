...
Learn about different types of [top-down discovery schedules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/top-down-discovery-schedules.md).
...
6.  Define the rediscovery frequency by selecting the relevant option from the **Run** list.
    ...
    See [Run options for discovery schedules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/discovery-schedule-run-options.md).

7.  Click **Submit**.


-   **[Top-down discovery schedules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/top-down-discovery-schedules.md)**  
