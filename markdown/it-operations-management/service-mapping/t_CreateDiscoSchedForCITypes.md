...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-mapping/t\_CreateDiscoSchedForCITypes.html
release: yokohama
...
Learn about different types of [top-down discovery schedules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/top-down-discovery-schedules.md).
...
6.  Define the rediscovery frequency by selecting the relevant option from the **Run** list.
    ...
    See [Run options for discovery schedules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/itom-visibility/discovery-schedule-run-options.md).

7.  Click **Submit**.


-   **[Top-down discovery schedules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/top-down-discovery-schedules.md)**  
