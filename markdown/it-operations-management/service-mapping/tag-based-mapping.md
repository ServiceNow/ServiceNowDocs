...
You can create single tag-based application services using the Common Service Data Model \(CSDM\) flow as described in [populate application services using tags](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/populate-app-service-tags.md).

For information about how to create multiple tag-based services, see [Map application services using tags with classic Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/map-service-tag.md).
...
[Tag Governance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/tag-governance/landing-page-tag-governance.md)
