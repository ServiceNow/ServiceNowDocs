...
breadcrumb: [Analyze potential impact agentic workflow, AI in Service Mapping, Service Mapping, ITOM Visibility, IT Operations Management]
---
...
<table id="choicetable_rkr_bbt_3gc"><thead><tr><th align="left" id="d312626e152">

Situation

</th><th align="left" id="d312626e155">

Steps

</th></tr></thead><tbody><tr><td id="d312626e161">
...
In the panel, the Analyze potential impact agentic workflow generates an analysis of the potentially impacted relevant servers and suggested services.

The impact analysis is updated in the work notes in the change request details.

**Parent Topic:**[Analyze potential impact agentic workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/now-assist-itom-analyze-potential-impact-workflow.md)
