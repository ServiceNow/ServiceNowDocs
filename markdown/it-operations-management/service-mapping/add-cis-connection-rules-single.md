...
description: Create rules for automatically adding traffic-based connections and the CIs they lead to in discovered application services. Add CIs to specific application services using connection rules.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/service-mapping/add-cis-connection-rules-single.html
release: xanadu
...
-   [Discover applications based on fingerprints](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/discovery/discover-application-based-process.md).
...
For information about Service Mapping evaluating and applying connection rules, see [Traffic-based discovery in Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/service-mapping/traffic-based-discovery.md).

In addition to connection rules that add CIs to specific services, you can [create rules for adding CIs to multiple application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/service-mapping/add-cis-connection-rules-multiple.md).
