...
Review [Unified Map](https://www.servicenow.com/docs/access?context=cmdb-workspace-unified-map&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) to learn more about the Unified Map feature.
...
[View the attributes of a CI or a relationship](https://www.servicenow.com/docs/access?context=unified-map-show-attributes&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)

[View service instances for a CI](https://www.servicenow.com/docs/access?context=unified-map-show-app-service&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)

[View historical changes for a CI](https://www.servicenow.com/docs/access?context=unified-map-show-ci-changes&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
