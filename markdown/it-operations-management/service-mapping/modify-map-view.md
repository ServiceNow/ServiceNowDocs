...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/service-mapping/modify-map-view.html
release: xanadu
...
2.  Click the **Additional actions** menu.
    ...
    \[Omitted image "MapAdditionalActionsButton.png"\] Alt text: Click the Additional actions menu on the Map page.
...
[Create or modify map indicators](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/dependency-views/t_CreateModifyNGBSMMapIndicators.md)
