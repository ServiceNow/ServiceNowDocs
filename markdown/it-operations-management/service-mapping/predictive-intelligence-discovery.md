...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-mapping/predictive-intelligence-discovery.html
release: yokohama
...
breadcrumb: [Automated Service Suggestions, Choose the right method for discovery and mapping application services, Exploring Service Mapping, Service Mapping, ITOM Visibility, IT Operations Management]
---
...
[Add CIs to a specific application service using connection rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/add-cis-connection-rules-single.md)
