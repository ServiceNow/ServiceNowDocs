...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-mapping/t\_ConfigurePropertyDisplay.html
release: zurich
...
Get familiar with the notion of views. For more information on views, see [View Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/view-management-overview.md).
...
[View CI attributes in an application service map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/t_ViewCIDetails.md)
