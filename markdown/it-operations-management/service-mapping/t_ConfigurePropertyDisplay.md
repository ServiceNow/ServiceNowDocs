...
Get familiar with the notion of views. For more information on views, see [View Management](https://www.servicenow.com/docs/access?context=view-management-overview&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
