...
Analyze, review, and define tags as covered in [Prepare for mapping application services based on tags](prepare-map-service-tag.md).
...
2.  Make sure that the application services aren't too large: The following discovery message is displayed in a tag-based application service: **This tag-based application service reached the maximum number of CIs. For more information, refer to the product documentation.**
    ...
    -   [Modify tag definitions used for mapping](modify-tag-category-family.md) to make sure Service Mapping includes only relevant CIs in the application service.
