...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-mapping/review-service-map.html
release: yokohama
...
<table id="choicetable_zzx_gvd_ht"><thead><tr><th align="left" id="d463405e275">

Purpose

</th><th align="left" id="d463405e278">

Action

</th></tr></thead><tbody><tr><td id="d463405e284">
...
</td></tr><tr><td id="d463405e317">

**Check that the connections between CIs are correct.**

</td><td>

[View CI connection attributes in an application service map in classic Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/view-connector-properties.md).

</td></tr><tr><td id="d463405e333">
...
\[Omitted image "MapClusterAppCluster.png"\] Alt text: Expanding an application cluster

Application clusters can have a cluster within a cluster, but never more than two levels:

\[Omitted image "MapClusterDouble.png"\] Alt text: Expanding an application cluster with two levels
...
Click the plus \(+\) icon next to a CI.In an inclusion, a server hosts applications that are treated as independent objects. For example, IIS Virtual Directory can run on a Windows Service as its host.
 ...
 \[Omitted image "MapClusterInclusion.png"\] Alt text: Expanding inclusion
...
**Parent Topic:**[Review and approval of application service maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/business-service-approval.md)
