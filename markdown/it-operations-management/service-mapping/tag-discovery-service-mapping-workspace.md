...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-mapping/tag-discovery-service-mapping-workspace.html
release: zurich
...
For information about the traditional tag-based discovery process, see [Tag-based discovery in Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/tag-based-mapping.md). Tag-based discovery for the Service Mapping workspace operates differently and consists of the following stages:
