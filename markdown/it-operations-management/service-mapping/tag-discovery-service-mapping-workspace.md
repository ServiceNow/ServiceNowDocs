...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-mapping/tag-discovery-service-mapping-workspace.html
release: yokohama
...
For information about the traditional tag-based discovery process, see [Tag-based discovery in Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/tag-based-mapping.md). Tag-based discovery for the Service Mapping workspace operates differently and consists of the following stages:
