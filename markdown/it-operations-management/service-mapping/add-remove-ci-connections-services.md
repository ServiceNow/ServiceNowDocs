...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-mapping/add-remove-ci-connections-services.html
release: zurich
...
1.  View information about all application CIs in connection suggestions.
    ...
    See [Discover applications based on fingerprints](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/discover-application-based-process.md) for more information.
