...
5.  If you haven't discovered application CIs, discover a standalone CI of the application class based on fingerprints:
    ...
    4.  Select **Refresh** in the Review suggested connections window to ensure that the displayed information reflects the discovered CI classes.
...
The application service map reflects the changes you made. The connections you added and the CIs they lead to appear on the map.
