...
1.  [Add users to user groups](https://www.servicenow.com/docs/access?context=t_CreateAGroup&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
2.  [Create new roles](https://www.servicenow.com/docs/access?context=t_CreateARole&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
3.  [Assign roles to users or user groups](https://www.servicenow.com/docs/access?context=t_AssignRoleToGroup&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
