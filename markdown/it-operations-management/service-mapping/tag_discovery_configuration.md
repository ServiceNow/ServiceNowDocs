...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/service-mapping/tag\_discovery\_configuration.html
release: yokohama
...
**Note:** Starting with Service Mapping Plus version 1.16.3, take advantage of the Tag-based Service Mapping workspace to efficiently map your application services. For more information, see [Tag-based mapping in the Service Mapping Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/tag-based-mapping-dashboard.md) and [Tag-based discovery for the Service Mapping Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/tag-discovery-service-mapping-workspace.md).
...
To view preconfigured CI relationships which Service Mapping includes in application services during tag-based discovery, see [Preconfigured CI relationships in tag-based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/ci_relationships_tag_mapping.md).

To view properties installed with Service Mapping that relate to tag-based discovery, see [Properties related to tag-based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/properties_tag_mapping.md).

-   **[Include CIs based on classes in tag-based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/include_cis_tag_discovery_configuration.md)**  
...
-   **[Exclude CIs based on their installation status in tag-based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/exclude_cis_install_status_tag_mapping.md)**  
...
-   **[Exclude preconfigured CI relationships in tag-based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/exclude_ci_relationships_tag_mapping.md)**  
...
-   **[Add or edit CI relationships in tag-based discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/edit_ci_relationships_tag_mapping.md)**  
...
-   **[Recalculate previously created application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/recalculate_application_services.md)**  
...
**Parent Topic:**[Advanced Service Mapping configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/service-mapping/c_ConfigureSM.md)
