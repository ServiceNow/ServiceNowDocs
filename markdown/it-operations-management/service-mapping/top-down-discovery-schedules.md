...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/service-mapping/top-down-discovery-schedules.html
release: australia
...
-   [Schedule a horizontal discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/t_CreateADiscoverySchedule.md) — for standard horizontal discovery.
-   [Create a schedule for standard serverless Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/create-pattern-for-serverless.md) — for discovering CIs using a protocol such as REST, without using the IP address of any devices or hosts.
-   [Create a schedule for host-based serverless Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/discovery/create-pattern-for-proxy-serverless.md) — for discovering CIs that reside on an already discovered host using this host as a Proxy server.

**Parent Topic:**[Schedule a top-down discovery by Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/service-mapping/t_CreateDiscoSchedForCITypes.md)

**Related topics**  


[Schedule a top-down discovery by Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/service-mapping/t_CreateDiscoSchedForCITypes.md)
