...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/service-mapping/modify-tag-category-family.html
release: zurich
...
If you need to create a new tag category or modify an existing tag category, follow the prerequisites in [Map application services using tags with classic Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/map-service-tag.md).

Review recommendations in [Prepare for mapping application services based on tags](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/prepare-map-service-tag.md).
...
[Remap tag-based application services to reflect tag changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/service-mapping/remap-tag-based-services-tag-changes.md)
