...
-   [Views you configure for CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/t_ConfigurePropertyDisplay.md) define which connection attributes appear in the Properties pane of the map.
-   Connection lines on the map depend on the [view you select for the map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/modify-map-view.md).
...
The Traffic Based Connections List opens displaying the information in [Traffic Based Connections List table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/view-connector-properties.md).
