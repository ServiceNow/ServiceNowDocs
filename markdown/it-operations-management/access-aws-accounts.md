...
-   **Configuring access for a single account**
    ...
    -   Create an AWS service account on the ServiceNow AI Platform. For more information, see [Create AWS service accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/create-aws-service-accounts.md).
-   **Configuring access for an account that trusts an accessor account with AWS credentials**
    ...
    For more information, see [Configure temporary credential access for trusted AWS accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/configure-iam-role-aws-account.md).
...
-   **Configuring access for an account that trusts an accessor account without AWS credentials**
    ...
    For more information, see [Configure credential-less access using trusted AWS accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/aws-trusted-credential-less.md).
