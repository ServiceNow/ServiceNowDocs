...
-   Is validated. For more information, see [Validate a MID Server](https://www.servicenow.com/docs/access?context=t_ValidateAMIDServer&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)
-   Is in running state
