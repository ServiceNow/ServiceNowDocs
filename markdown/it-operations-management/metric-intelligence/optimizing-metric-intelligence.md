...
-   **[Create an anomaly test rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/anomaly-model-testing.md)**  
...
-   **[View metric to CI and resource binding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/view-metric-to-CI-binding.md)**  
...
-   **[Disable a metric for a CI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/disable-metric-per-ci.md)**  
...
-   **[Disable event collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/disable-event-collection.md)**  
...
-   **[Configure anomaly score thresholds](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/cnfgr-anomaly-score-thresholds.md)**  
...
-   **[View anomaly alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/view-metrics-anomaly-alerts.md)**  
...
-   **[View metric charts in Agent Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/view-metric-charts-workspace.md)**  
...
-   **[Configure metric charts for Agent Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/configure-metric-chart-workspace.md)**  
...
-   **[View Metric Intelligence self-health statistics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/xmlstats-oi-self-health.md)**  
...
-   **[Verify that the definitions for the Advanced Promotion Engine are active](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/verify-ape-definition-active.md)**  
Verify that the Advanced Promotion Engine definitions that come with the base system are active.
-   **[Create a definition for the Advanced Promotion Engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/create-advanced-promotion-engine.md)**  
...
-   **[View the promoted events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/view-promoted-events.md)**  
...
-   **[View the promoted anomaly alerts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/view-promoted-alerts.md)**  
...
-   **[Create metric rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/create-metric-rules.md)**  
...
-   **[Create an event rule to bind metric events to host CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/event-rule-bind-metrics-to-host.md)**  
Create event rules to explicitly allow binding of metric events to host CIs.

**Parent Topic:**[Metric Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/operational-metrics.md)
