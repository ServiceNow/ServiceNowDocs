...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/metric-intelligence/operational-intelligence-overview.html
release: zurich
...
-   **Time Series statistical model**
    ...
    -   **Weekly**
        ...
        Requires a minimum of 15 days of data in the series, as set by the [weekly\_model\_min\_days](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.
    ...
    -   **Daily**
        ...
        Requires a minimum of 3 days of data in the series, as set by the [daily\_model\_min\_days](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.
    ...
    -   **Trendy**
        ...
        Requires a minimum of 30 data points in the series, as set by the [corrupt\_data\_count\_threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.
    ...
    -   **Centered noisy**
        ...
        To retrieve alerts for metrics with this model, create metric rules for static bounds definitions. For details, see [Create metric rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/metric-intelligence/create-metric-rules.md).
...
The metric is not considered for the detected constant model.
        ...
        Requires a minimum of 400 data points in the series, calculated as 10 times the value of the [multinomial\_count\_threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.
    ...
    -   **Corrupt**
        ...
        Requires that the number of data points in the series is less than the value of the [corrupt\_data\_count\_threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting \(30 by default\).
...
-   **Non-Parametric statistical model**
    ...
    -   **Stationary Non-Parametric**
        ...
        Requires a minimum of 5000 data points in the series, as set by the [snpm\_minimum\_data\_count](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.
