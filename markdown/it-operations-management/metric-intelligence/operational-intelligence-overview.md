...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/metric-intelligence/operational-intelligence-overview.html
release: yokohama
...
-   **Time Series statistical model**
    ...
    -   **Weekly**
        ...
        Requires a minimum of 15 days of data in the series, as set by the [weekly\_model\_min\_days](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.
    ...
    -   **Daily**
        ...
        Requires a minimum of 3 days of data in the series, as set by the [daily\_model\_min\_days](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.
    ...
    -   **Trendy**
        ...
        Requires a minimum of 30 data points in the series, as set by the [corrupt\_data\_count\_threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.
    ...
    -   **Centered noisy**
        ...
        See [Specify custom upper and lower metric bounds](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/metric-intelligence/override-metric-bounds.md) for more information.
...
-   **Non-Parametric statistical model**
    ...
    -   **Stationary Non-Parametric**
        ...
        Requires a minimum of 5000 data points in the series, as set by the [snpm\_minimum\_data\_count](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.
