...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-operations-management/metric-intelligence/operational-intelligence-overview.html
release: brazil
...
After processing, the [Insights Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/view-metrics-explorer.md) shows metric statistics and charts, and the [Anomaly Map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/view-metrics-anomaly-alerts.md) shows correlated scores for CIs with the highest anomaly scores, across a timeline.
...
However, for some models, there is insufficient data to determine which values are anomalous. Anomaly detection cannot be applied without additional information \(even if anomaly detection is enabled\).
...
-   **Time Series statistical model**
    ...
    -   **Weekly**
        ...
        Requires a minimum of 15 days of data in the series, as set by the [weekly\_model\_min\_days](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.

        \[Omitted image "WeeklyDataModel.png"\] Alt text: Weekly classifier

    -   **Daily**

        Data with a pattern that repeats itself over a daily interval \(seasonal model\).

        Requires a minimum of 3 days of data in the series, as set by the [daily\_model\_min\_days](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.

        \[Omitted image "DailyDataModel.png"\] Alt text: Daily classifier

    -   **Trendy**

        Data that has a linear trend with some slope and with some noise.

        Requires a minimum of 30 data points in the series, as set by the [corrupt\_data\_count\_threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.

        \[Omitted image "TrendyDataModel.png"\] Alt text: Trendy classifier
    ...
    -   **Noisy**
        ...
        \[Omitted image "NoisyDataModel.png"\] Alt text: Noisy classifier
    ...
    -   **Positive clipped noisy**
        ...
        \[Omitted image "PositiveClippedNoisyDataModel.png"\] Alt text: Positive clipped noisy classifier
    ...
    -   **Centered noisy**
        ...
        To retrieve alerts for metrics with this model, create metric rules for static bounds definitions. For details, see [Create metric rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/create-metric-rules.md).
    ...
    -   **Skewed noisy**
        ...
        \[Omitted image "SkewedNoisyDataModel.png"\] Alt text: Skewed noisy classifier
    ...
    -   **Accumulator**
        ...
        \[Omitted image "AccumulatorDataModel.png"\] Alt text: Diagram of the Accumulator classifier.
    ...
    -   **Near Constant**
        ...
        \[Omitted image "NearConstantDataModel.png"\] Alt text: Diagram of the Near Constant classifier.
...
The metric is not considered for the detected constant model.
        ...
        Requires a minimum of 400 data points in the series, calculated as 10 times the value of the [multinomial\_count\_threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.

        \[Omitted image "MultinomialDataModel.png"\] Alt text: Multinomial classifier
    ...
    -   **Corrupt**
        ...
        Requires that the number of data points in the series is less than the value of the [corrupt\_data\_count\_threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting \(30 by default\).
...
-   **Kalman Filter statistical model**
    ...
    -   **Local level**
        ...
        \[Omitted image "KalmanFilterLocalLevelDataModel.png"\] Alt text: Diagram of the Kalman Filter Local Level classifier.
...
-   **Non-Parametric statistical model**
    ...
    -   **Stationary Non-Parametric**
        ...
        Requires a minimum of 5000 data points in the series, as set by the [snpm\_minimum\_data\_count](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/create-config-overriding-rule.md) configuration setting.

        \[Omitted image "NonParametricStationaryDataModel.png"\] Alt text: Diagram of the Non-Parametric Stationary classifier.
