...
Use the [Duplicate CI Remediator](https://www.servicenow.com/docs/access?context=de-duplication-tasks&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) to remediate the duplication.
