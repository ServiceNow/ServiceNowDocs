...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/metric-intelligence/view-metric-to-CI-binding.html
release: zurich
...
If [resource binding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/metric-intelligence/resource-binding.md) is not enabled, then no resource binding results appear.
...
Use the [Duplicate CI Remediator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/de-duplication-tasks.md) to remediate the duplication.
...
[Creating an event rule to map metrics to specific CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/metric-intelligence/event-rule-bind-metrics-to-ci.md)
