...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/metric-intelligence/view-metric-to-CI-binding.html
release: yokohama
...
If [resource binding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/metric-intelligence/resource-binding.md) is not enabled, then no resource binding results appear.
...
Use the [Duplicate CI Remediator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/de-duplication-tasks.md) to remediate the duplication.
...
[Creating an event rule to map metrics to specific CIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/metric-intelligence/event-rule-bind-metrics-to-ci.md)
