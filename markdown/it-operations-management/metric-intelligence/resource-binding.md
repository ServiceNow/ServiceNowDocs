...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-operations-management/metric-intelligence/resource-binding.html
release: australia
...
-   Ensure that the [sa.metric.use.resource.binding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-operations-management/agent-client-collector/installed-with-metrics.md) system property is set to true \(default\).
