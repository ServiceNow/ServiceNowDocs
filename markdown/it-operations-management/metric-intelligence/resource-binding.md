...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/metric-intelligence/resource-binding.html
release: yokohama
...
-   Ensure that the [sa.metric.use.resource.binding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/installed-with-metrics.md) system property is set to true \(default\).
