...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/metric-intelligence/override-metric-bounds.html
release: yokohama
...
**Min** and **Max** of the custom upper bound range Applies to the `Set ranges for upper and lower bounds` setting.
    ...
    5.  Examine the preview results and if the results are as expected, click **Finish**.
        ...
        Otherwise, go back to the previous **Apply Bounds Settings** tab, adjust settings, and then preview again. The preview results are a stripped-down version of anomaly model testing. For more details about the results, and changing chart settings, see [Anomaly model testing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/metric-intelligence/anomaly-model-test-concepts.md).
