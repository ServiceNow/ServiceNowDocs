...
1.  Configure a MID Server for Metric Intelligence.
    ...
    For details, see [MID Server and MID Server distributed cluster for Metric Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/ops-intelligence-mid-server.md).

2.  Use the [Automated Metric Intelligence setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/auto-setup.md).

3.  [Choose a source for collecting metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/metric-intelligence/metric-collection-sources.md).

4.  [Choose and configure metrics to monitor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/configure-metric-monitors.md).
...
6.  About 10 minutes after the Metric Intelligence Metrics extension has started, run the [quick start tests for Metric Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/agent-client-collector/quick-start-tests-ops-intelligence.md) to verify functionality.
