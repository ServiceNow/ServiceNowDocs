...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/metric-intelligence/anomaly-model-testing.html
release: yokohama
...
-   When you are satisfied with the anomaly test results, enable anomaly detection in the production environment, for the metrics and CIs specified in the test. See [Choose and configure metrics to monitor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/agent-client-collector/configure-metric-monitors.md) for more details.

**Parent Topic:**[Optimizing Metric Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/metric-intelligence/optimizing-metric-intelligence.md)
