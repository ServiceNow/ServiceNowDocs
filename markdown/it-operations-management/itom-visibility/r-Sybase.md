...
description: Discovery and Service Mapping uses the Sybase pattern to find SAP Sybase Adaptive Server Enterprise \(ASE\) databases and catalogs in your infrastructure. Discovering some of these resources might require updating to the latest version of the Discovery and Service Mapping Patterns application from the ServiceNow Store.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/itom-visibility/r-Sybase.html
release: yokohama
...
-   **Verify that the applications are up to date.**
    ...
    For details on the product discovered see [Detailed information on products discovered by ITOM Visibility](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/itom-visibility/r_SupportedApplications.md)
...
-   **Verify the configuration of the Applicative Credentials**
    ...
    For more information on Applicative Credentials, see [Applicative credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/applicative-creds.md)
...
-   **Verify the configuration of a Discovery schedule**
    ...
    For detailed information, see [Running discoveries in your network](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/discovery/running-discoveries.md)
