...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/itom-visibility/r-Sybase.html
release: zurich
...
-   **Verify that the applications are up to date.**
    ...
    For details on the product discovered see [Detailed information on products discovered by ITOM Visibility](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/r_SupportedApplications.md)
...
-   **Verify the configuration of the Applicative Credentials**
    ...
    For more information on Applicative Credentials, see [Applicative credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/applicative-creds.md)
...
-   **Verify the configuration of a Discovery schedule**
    ...
    For detailed information, see [Running discoveries in your network](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/running-discoveries.md)
