...
keywords: [post-quantum cryptography, PQC, quantum threat, NIST standards]
...
1.  NIST FIPS 204 \(ML-DSA\): Module-Lattice-Based Digital Signature Algorithm
2.  NIST FIPS 203 \(ML-KEM\): Module-Lattice-Based Key-Encapsulation Mechanism
3.  ISO/IEC 27001 Annex A 8.24: Information security control for the use of cryptography
