...
For detailed information on SQL Server supported versions see: [Detailed information on products discovered by ITOM Visibility](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/r_SupportedApplications.md)
...
-   **Create Windows credentials**
    ...
    After verifying that the MID Server is connected to the target Windows server, create Windows credentials on the ServiceNow AI Platform. For more information, see [Windows credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/r_WindowsCredentialsForm.md).

-   **Create applicative credentials when using SQL authentication**

    For more information, see [Applicative credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/applicative-creds.md).
...
3.  Run a CI discovery.
    ...
    For more information, see [Running discoveries in your network](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/running-discoveries.md).
...
-   **Prerequisites**
    ...
    [Verify availability group table permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/mssql-data-collected-pattern.md)

-   **Discovered resources**

    [Resources discovered by the pattern extension: Collect MSSQL HADR - Availability Group Info](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/mssql-data-collected-pattern.md)

-   **Discovered relationships**

    [Relationships discovered by the pattern extension: Collect MSSQL HADR - Availability Group Info](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/mssql-data-collected-pattern.md)
