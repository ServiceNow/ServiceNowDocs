...
|Plugin or application name|Description|
|--------------------------|-----------|
|Agent Client Collector for Visibility Content \(sn\_acc\_vis\_content\)|Provides agent-based infrastructure discovery and collects Software Asset Management \(SAM\) metrics to support Discovery and Digital End-User Experience \(DEX\) applications.|
|Discovery \(com.snc.discovery\)|Finds applications and devices on your network, and then updates the CMDB with the information it finds.|
...
[Plugins or applications installed with ITOM Cloud Accelerate](../../itom-governance/reference/plugin-app-cloud-accelerate.md)

[Plugins or applications installed with ITOM Health](plugin-app-itom-health.md)
