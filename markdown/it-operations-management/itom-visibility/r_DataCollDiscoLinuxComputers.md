...
-   **Verify the required credentials configuration**
    ...
    -   [Commands that require root privileges for Discovery, Orchestration, and Integration Hub](https://www.servicenow.com/docs/access?context=r_SSHCredentialsForm&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
    ...
    -   [MID Server privileged commands](https://www.servicenow.com/docs/access?context=c_PrivilegedCommandsForMIDServer&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
...
-   **Verify the MID Server configuration**
    ...
    -   [Test MID Server connectivity](https://www.servicenow.com/docs/access?context=t_ValidateNetworkConnectivity&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
    -   [MID Server properties](https://www.servicenow.com/docs/access?context=r_MIDServerProperties&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
