...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/itom-visibility/c\_DiscoSWAssetMgmtTableSchema.html
release: xanadu
...
Starting with the Kingston release, the Discovery populates the VMWare License Key \[samp\_vmware\_license\_key\] and VMWare License Key Usage \[samp\_vmware\_license\_key\_usage\] tables. See [Data collected for VMware vCenter Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown) for more information on where Discovery saves vCenter data.

-   **[Configure a CI to display Software Asset Management data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-operations-management/itom-visibility/configure-ci-to-display-sam-data.md)**  
