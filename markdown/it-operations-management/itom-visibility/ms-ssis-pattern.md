...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-operations-management/itom-visibility/ms-ssis-pattern.html
release: xanadu
...
-   **Verify the configuration of credentials**
    ...
    On the ServiceNow AI Platform®, verify the configuration of the Windows credentials. For more information, see [Windows credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/connections-and-credentials/r_WindowsCredentialsForm.md)
