...
-   The [CIM credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/r_CIMCredentialsForm.md) must be available for SMI-S configuration. The CIM credentials can be different than the credentials for the system hosting the CIM server.
...
-   **[Discovery of storage area networks \(SAN\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/storage-area-networks.md)**  
...
-   **[How CIM Discovery works](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/r_HowCIMDiscoveryWorks.md)**  
This is the processing flow for classifying Common Information Model \(CIM\) storage systems.
-   **[Configure SMI-S Provider for storage Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/t_ConfigDiscoForStandaloneStorage.md)**  
Use this procedure for configuring a standalone storage device with the required SMI-S Provider for Discovery.
-   **[Data collected by Discovery on storage devices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/r_DataCollDiscoStorageDevices.md)**  
