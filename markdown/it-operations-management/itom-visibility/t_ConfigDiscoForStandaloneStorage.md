...
2.  For NetApp storage devices, [install the SMI-S agent](https://www.servicenow.com/docs/access?context=r_CIMCredentialsForm&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) on the storage device host.
...
5.  On the ServiceNow instance, set up [CIM credentials](https://www.servicenow.com/docs/access?context=r_CIMCredentialsForm&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
