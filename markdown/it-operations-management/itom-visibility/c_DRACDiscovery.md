...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/itom-visibility/c\_DRACDiscovery.html
release: zurich
...
-   **Create SNMP credentials**
    ...
    SNMP credentials are required to discover DRAC devices. For more information, see [SNMP credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/c_SNMPCredentials.md).

-   **Run network discovery**

    For information on configuring and running network discovery to discover DRAC devices, see [Run network Discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/discovery/c_NetworkDiscovery.md).
