...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/itom-visibility/run-http-discovery.html
release: yokohama
...
breadcrumb: [HTTP device, Network device discovery, Data collected by ITOM Visibility, ITOM Visibility, IT Operations Management]
---
...
**Parent Topic:**[HTTP device discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/itom-visibility/http-discovery.md)
