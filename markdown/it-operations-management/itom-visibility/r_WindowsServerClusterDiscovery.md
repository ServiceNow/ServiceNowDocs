...
-   **Cluster of::Cluster**: Relationship between the cluster nodes and the cluster. [Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/service-mapping/c_ServiceMappingOverview.md) uses this relationship to map the Windows cluster and it's nodes.
...
**Parent Topic:**[Windows discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/r_DataCollDiscoWindowsComputers.md)
