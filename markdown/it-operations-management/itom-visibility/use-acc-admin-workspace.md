...
For details on the information accessible on the ACC admin workspace, see [Agent Client Collector \(ACC\) admin workspace information](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/acc-admin-workspace-information.md).
...
5.  Select the **Agent actions** button and select from actions to perform on the agent.
    ...
    For details on the available actions, see [Agent Client Collector \(ACC\) admin workspace agent actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/acc-admin-workspace-agent-actions.md).
...
-   **[Generate an Agent Client Collector installation plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/acc-onboarding-generate-plan.md)**  
...
-   **[Run diagnostics on an Agent Client Collector agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/run-acc-agent-diagnostics.md)**  
