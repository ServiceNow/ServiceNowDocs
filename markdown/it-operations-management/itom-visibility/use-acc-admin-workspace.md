...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/itom-visibility/use-acc-admin-workspace.html
release: zurich
...
4.  Select an agent in the agents list to view details of the agent.
    ...
    \[Omitted image "agent-record-page.png"\] Alt text: Agent details page \[Omitted image "agent-record-page.png"\] Alt text: Agent details page
...
-   **[Generate an Agent Client Collector installation plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/acc-onboarding-generate-plan.md)**  
...
-   **[Run diagnostics on an Agent Client Collector agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/run-acc-agent-diagnostics.md)**  
