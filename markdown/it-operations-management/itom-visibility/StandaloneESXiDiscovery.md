...
-   Make sure the Discovery \(com.snc.discovery\) plugin is installed and activated and that you have upgraded to Xanadu or later.
...
**Parent Topic:**[VMware discovery](../concept/c_DiscoverVMwareInfrastructure.md)
