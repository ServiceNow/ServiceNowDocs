...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/itom-visibility/run-acc-agent-diagnostics.html
release: yokohama
...
breadcrumb: [Use the Agent Client Collector \(ACC\) admin workspace, ITOM Visibility, IT Operations Management]
---
