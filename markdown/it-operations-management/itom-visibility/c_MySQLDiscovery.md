...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/itom-visibility/c\_MySQLDiscovery.html
release: zurich
...
-   [Applicative credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/applicative-creds.md) \(When applications require credentials in addition to the credentials the that host machine requires.\)
