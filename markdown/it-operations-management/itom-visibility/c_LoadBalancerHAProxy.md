...
-   For information about enabling probe-based discovery, see [Enable HAProxy load balancer discovery with probes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/itom-visibility/enable-haproxy-lb-discovery-probe.md).
-   For information about the HA Proxy pattern, see [HAProxy load balancer discovery with patterns](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-operations-management/discovery-and-service-mapping-patterns/haproxy-lb-discovery-pattern.md).
