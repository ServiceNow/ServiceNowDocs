...
2.  On the ServiceNow instance, [add credentials](https://www.servicenow.com/docs/access?context=t_CreateCredential&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) to the Discovery Credentials table.
