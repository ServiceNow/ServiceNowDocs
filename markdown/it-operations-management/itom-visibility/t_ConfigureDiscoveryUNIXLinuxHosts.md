...
2.  On the ServiceNow instance, [add credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/t_CreateCredential.md) to the Discovery Credentials table.
