...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-operations-management/itom-visibility/r-ActiveDirectory.html
release: yokohama
...
-   **Create Windows credentials with WMI access**
    ...
    Verify that the credentials have permission to run WMI queries on the `\\root\CIMV2` namespace. For more information, see [Windows credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/r_WindowsCredentialsForm.md).
...
**Parent Topic:**[Software discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-operations-management/itom-visibility/c_Software.md)
