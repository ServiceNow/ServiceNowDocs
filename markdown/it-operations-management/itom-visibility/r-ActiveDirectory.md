...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-operations-management/itom-visibility/r-ActiveDirectory.html
release: zurich
...
-   **Create Windows credentials with WMI access**
    ...
    Verify that the credentials have permission to run WMI queries on the `\\root\CIMV2` namespace. For more information, see [Windows credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/r_WindowsCredentialsForm.md).
