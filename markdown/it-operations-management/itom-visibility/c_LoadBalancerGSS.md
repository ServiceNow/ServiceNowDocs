...
**Warning:** You must have SNMP and [SSH credentials](https://www.servicenow.com/docs/access?context=r_SSHCredentialsForm&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) configured correctly for the GSS load balancers on your network.
