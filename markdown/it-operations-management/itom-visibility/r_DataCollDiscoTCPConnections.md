...
Controls the size of the result, including the payload.**Note:** If this is greater than the [MID Server properties](https://www.servicenow.com/docs/access?context=r_MIDServerProperties&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) mid.discovery.max\_payload\_size, a configuration error can occur.
