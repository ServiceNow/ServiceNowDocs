...
Controls the size of the result, including the payload.**Note:** If this is greater than the MID Server properties mid.discovery.max\_payload\_size, a configuration error can occur.
