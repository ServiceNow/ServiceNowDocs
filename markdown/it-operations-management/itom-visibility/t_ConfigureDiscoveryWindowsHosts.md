...
2.  For all Windows hosts including Windows 2008, [add Windows credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/r_WindowsCredentialsForm.md) to the Discovery Credentials table.
