...
description: Discovery creates configuration items \(CI\) and CI relationships for physical and logical storage components attached to application and database servers or by fibre channel switched fabric.
locale: en-US
