...
To learn about the SAP components and their versions that you can discover, refer to [Detailed information on products discovered by ITOM Visibility](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/r_SupportedApplications.md).
...
5.  Resolve the network issue and verify that the MID Server can access the URL as described in step [4](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/sap-discovery.md).
...
6.  Verify the new credentials as described in step [4](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/sap-discovery.md).
...
3.  Verify that you defined applicative credentials for the relevant CI according as described in [Map application services containing SAP applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-operations-management/itom-visibility/sap-discovery.md).
