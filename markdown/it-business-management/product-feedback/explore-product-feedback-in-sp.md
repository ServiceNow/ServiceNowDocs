...
|Generate a summary of selected text using Planning item Gen AI Docs skill.|[Generate the summary for selected or complete content with Planning item Gen AI Docs skill in Strategic Planning](../task/summarize-docs-genai-skill-pf.md)|pf\_user|
|Refine planning item description using write planning item skill.|[Refine planning items content using write planning item skill](../../now-assist-spm/task/refine-text-with-write-planning-item-skill.md)|sn\_align\_core.apw\_user|
