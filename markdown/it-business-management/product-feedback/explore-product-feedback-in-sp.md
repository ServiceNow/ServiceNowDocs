...
|Refine planning item description using write planning item skill.|[Improve efficiency and quality using refine records skill with Now Assist Context Menu](../../now-assist-spm/task/refine-text-with-write-planning-item-skill.md)|sn\_align\_core.apw\_user|
