...
-   Generate a summary of selected text in Docs using Planning item Gen AI Docs skill. For more information, see [Generate the summary for selected or complete content with Planning item Gen AI Docs skill in Strategic Planning](../task/summarize-docs-genai-skill-pf.md).
