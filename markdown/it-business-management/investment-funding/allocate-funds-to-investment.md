...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/investment-funding/allocate-funds-to-investment.html
release: xanadu
...
You can allocate funds only in the funding frequency configured in the [Investment Funding Preferences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/investment-funding/set-funding-preferences.md).
...
9.  Right-click on a column on the grid and select **View Past Funding Details** to view the funding details of your child investments for the past fiscal periods.
    ...
    For more information, see the [View past funding details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/investment-funding/view-past-funding-details.md) topic.
