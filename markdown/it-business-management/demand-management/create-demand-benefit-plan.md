...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/demand-management/create-demand-benefit-plan.html
release: xanadu
...
4.  To create a monetary benefit plan, click **New**.

    **Note:** To create a monetary benefit plan from the **Financials Summary** page, click **Manage**.

5.  On the Monetary Benefit Plan form, fill in the fields.

    For a description of the field names, see [Monetary Benefit Plan form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/monetary-benefit-plan-form.md).
...
-   **[Update a monetary benefit plan breakdown for a demand](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/update-a-monetary-benefit-plan-breakdown-for-a-demand.md)**  
