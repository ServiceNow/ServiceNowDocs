...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/demand-management/risk-value-lookup.html
release: xanadu
...
3.  On the risk value matcher form, fill in the fields.
    ...
    For a description of the field names, see [Risk value matcher form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/risk-value-matcher-form.md).

4.  Click **Submit**.


**Parent Topic:**[Add risks for a demand](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/add-risks-for-demand.md)
