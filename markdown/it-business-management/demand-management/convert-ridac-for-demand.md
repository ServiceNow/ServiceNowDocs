...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/demand-management/convert-ridac-for-demand.html
release: xanadu
...
4.  Click the **Convert to RIDAC** related link on the form.
...
7.  Change the default assignment copied from the parent record in the **Assigned to** field by clicking the lookup icon \(\[Omitted image "lookup\_icon\_2.png"\] Alt text: Lookup icon\) and selecting a different user.
