...
7.  Change the default assignment copied from the parent record in the **Assigned to** field by clicking the lookup icon \(![Lookup icon](../image/lookup_icon_2.png)\) and selecting a different user.
