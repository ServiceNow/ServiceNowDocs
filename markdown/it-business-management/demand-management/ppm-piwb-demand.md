...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/demand-management/ppm-piwb-demand.html
release: zurich
...
2.  Select the **Similar Demands** template.

3.  Click **Start**.

    The use case set up window opens displaying the name and description of the use case.
