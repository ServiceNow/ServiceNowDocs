...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/demand-management/c\_DemandWorkbenchBubbleChart.html
release: xanadu
...
-   Point to a bubble to [view a summary of the demand](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/t_ViewADemandSummary.md), including the demand name and the risk, value, and size.
-   Click a bubble to open a sizing window and [change the size of the demand](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/t_MoveAndResizeADemand.md).
-   Click and drag a bubble to increase or decrease the risk or value of the demand.
-   Right-click a bubble to view the demand, [create an artifact](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/t_CrtArtftDmdMnu.md), or [view an artifact](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/t_ViewAnArtifactCreatedFromADemand.md) that has been created from a demand.

    **Note:** You will not find the options to create an enhancement or a defect if Agile Development 2.0 is not activated.


Changes made to a demand in the bubble chart are automatically updated in the demand record.

**Parent Topic:**[Demand workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/c_DemandWorkbench.md)
