...
-   Point to a bubble to [view a summary of the demand](../task/t_ViewADemandSummary.md), including the demand name and the risk, value, and size.
-   Click a bubble to open a sizing window and [change the size of the demand](../task/t_MoveAndResizeADemand.md).
