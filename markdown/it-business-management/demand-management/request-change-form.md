...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/demand-management/request-change-form.html
release: yokohama
...
Impact on the outcome of the demand if you do not approve the requested changes.
