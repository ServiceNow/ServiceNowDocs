...
description: Train the Similar Demands solution definition included within the Predictive Intelligence for PPM capability to find related demands when creating a demand.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/demand-management/train-similarity-solution-dm.html
release: yokohama
