...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/demand-management/r\_StageFields.html
release: yokohama
...
The result of an idea depends on the initial settings in the **Category** and **Type** fields on the Demand form. The **Stage** field also appears on the Demands list. The **Stage** field is a display only field and cannot be searched or sorted.

**Important:** The **Stage** fields are no longer available starting from the New York release. Any instance provisioned in New York or later will not have a Stage field on the Idea table. However, the **Stage** fields are available if you are upgrading from an older releases to New York or later.
...
Pointing to the **Stage** field displays a pop-up window that shows the progression of the idea along with the value of the **State** field for each step in the progression.
...
\[Omitted image "IdeaStageSummary.png"\] Alt text: Idea Stage Summary pop-up window
