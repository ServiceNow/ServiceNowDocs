...
4.  On the Decision form, fill in the fields.
    ...
    For a description of the field names, see [Decision form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/demand-management/decision-form.md).
...
-   Convert a decision to an action or request change and close the decision. For more information, see [Convert one RIDAC record to another for a demand](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/demand-management/convert-ridac-for-demand.md).
