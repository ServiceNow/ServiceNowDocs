...
![Assessing demands using bubble charts from the Demand Workbench.](../image/AssessDemands.png)
...
[RIDAC \(Risk, Issue, Decision, Action, and Request Changes\) record entries for a demand](ridac-entries-for-demand.md)
