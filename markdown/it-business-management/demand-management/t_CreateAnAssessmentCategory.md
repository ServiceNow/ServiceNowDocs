...
2.  Open an assessment metric category to review it.
    ...
    |**Strategic Alignment**|[View an assessment category result](https://www.servicenow.com/docs/access?context=t_ViewACategoryResult&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) field in the assessment category result for the Strategic Alignment metric category.|Assesses how closely the demand aligns with strategic goals of the organization compared to other demands.|
