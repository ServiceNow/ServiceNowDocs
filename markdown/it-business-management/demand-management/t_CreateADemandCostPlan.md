...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/demand-management/t\_CreateADemandCostPlan.html
release: yokohama
...
5.  In the cost plan form, fill in the fields.
    ...
    For a description of the field names, see [Cost plan form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/demand-management/demand-plan-form.md).

    **Note:** When you change the planned start date of a demand, the associated cost plans and resource assignments also change. The [project property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/r_InstalledWithProjectManagement.md) **Change Resource Plan and Cost Plan Start Date with Demand or Project Start Date Change** controls the behavior for demand date change.
