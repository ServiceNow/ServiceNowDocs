...
5.  In the cost plan form, fill in the fields.
    ...
    For a description of the field names, see [Cost plan form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/demand-management/demand-plan-form.md).
