...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/demand-management/t\_CrtArtftDmdMnu.html
release: yokohama
...
A demand must have been created. For more information, see [Create a demand](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/demand-management/t_CreatingDemands.md).
...
|--------|--------------------|
|Enhancement, change, or defect|[Project Portfolio Suite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/ppm-collaboration/c_ProjectPortfolioSuite.md)|
|Agile Development entities \(story or epic\)|[Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/agile-development/agile-landing-page.md)|
...
|Enterprise Agile Planning \(EAP\) entities \(epic, feature, or capability\)|[Strategic Planning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/strategic-planning/alignment-planner-workspace-landing-page.md)|
...
3.  Verify that the values in the **Category** and **Type** fields are appropriate for the artifact you want to create.
    ...
    The options in the Type list change according to the category that you select. For more information, see [Demand form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/demand-management/demand-form.md).
...
-   **[Create an Enterprise Agile Planning \(EAP\) entity from a demand](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/demand-management/create-an-eap-entity-from-a-demand.md)**  
