...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/demand-management/allocate-budget-to-demand.html
release: xanadu
...
3.  Select the fiscal year for which you want to set the budget for the demand.
    ...
    **Tip:** You can work on allocating lean budget at fiscal period level using the Investment Budget. For more information, see [Enable lean budgeting for demands](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/config-investment-budget-demand.md).
