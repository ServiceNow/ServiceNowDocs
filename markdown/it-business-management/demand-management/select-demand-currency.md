...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/demand-management/select-demand-currency.html
release: xanadu
...
<table id="choicetable_lc1_qht_dnb"><thead><tr><th align="left" id="d59319e82">

Demand currency preference

</th><th align="left" id="d59319e85">

Currency Option

</th></tr></thead><tbody><tr><td id="d59319e91">
...
Enable the multicurrency view in the Demand and other demand-related forms. For more information, see [Enable demand currency view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/demand-management/enable-multicurrency-demand.md).
