...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/demand-management/select-demand-currency.html
release: yokohama
...
<table id="choicetable_lc1_qht_dnb"><thead><tr><th align="left" id="d141231e82">

Demand currency preference

</th><th align="left" id="d141231e85">

Currency Option

</th></tr></thead><tbody><tr><td id="d141231e91">
...
</td></tr><tr><td id="d141231e106">

**Manage demands using the same currency as the project currency**

</td><td>

Select the **Drive project currency** option to manage your demands and projects using the same currency. This currency can be your functional currency or any other currency. For example, if you want to manage your demand and project in a local currency, say GBP, then you would select this option and specify GBP as your demand currency​. The **Project Currency** field in the demand form is automatically populated with GBP as your project currency upon saving the form.

</td></tr><tr><td id="d141231e124">
...
Enable the multicurrency view in the Demand and other demand-related forms. For more information, see [Enable demand currency view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/demand-management/enable-multicurrency-demand.md).

**Parent Topic:**[Multicurrency in Demand Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/demand-management/multicurrency-demand.md)
