...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/atlassian-jira-integrations-common/components-installed-with-atlassian-jira-integration-for-agile-development.html
release: xanadu
...
Imports issues and sprints from Jira automatically at a scheduled time.This job is inactive by default.
 ...
 For more information, see [Schedule a job to auto-import issues from Jira to Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/atlassian-jira-integrations-common/schedule-jobs-to-import-issue-from-jira.md).
