...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/atlassian-jira-integrations-common/custom-table-map-configuration.html
release: xanadu
