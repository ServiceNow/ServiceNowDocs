...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/strategic-planning/team-integration-settings-form.html
release: zurich
...
-   For company-managed projects, if multiple boards exist for a single Jira project, you can map only one board to an EAP team in the Team Integration Settings form.
...
[Associate Jira projects with EAP teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/strategic-planning/create-team-integration-settings-for-jira-project-in-spw.md)
