...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/strategic-planning/set-target-for-goal-strategy.html
release: zurich
...
<table id="choicetable_whk_swd_tw"><thead><tr><th align="left" id="d143655e142">

Option

</th><th align="left" id="d143655e145">

Steps

</th></tr></thead><tbody><tr><td id="d143655e151">

**From the Goals page**

</td><td>

Next to the goal that you want to add a target for, select the row context menu icon \(\[Omitted image "action-menu-icon.png"\] Alt text: Row context menu icon.\) and select **Add target**.

</td></tr><tr><td id="d143655e169">
...
[Update the progress of the target](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/strategic-planning/update-progress-of-target-strategy.md) manually if the target isn’t enabled for target automation.
...
[Duplicate a goal or target](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/strategic-planning/duplicate-goal-target-strategy.md)
