...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/strategic-planning/target-actuals-automation-strategy.html
release: australia
...
3.  Select a target source in the **Actual value source** field, from which the value must be fetched for target automation.
    ...
    For instructions on creating targets for a goal, see [Add a target for goal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/strategic-planning/set-target-for-goal-strategy.md).
