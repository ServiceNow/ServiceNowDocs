...
<table id="choicetable_lc1_qht_dnb"><thead><tr><th align="left" id="d63227e98">

Demand currency preference

</th><th align="left" id="d63227e101">

Currency option

</th></tr></thead><tbody><tr><td id="d63227e107">
...
Enable the multicurrency view in the demand form and other demand-related forms. For more information, see [Enable the demand currency view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/strategic-planning/enable-demand-currency-view-dw.md).
