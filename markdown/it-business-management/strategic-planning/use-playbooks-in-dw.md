---
title: Use Playbooks in Next Experience for Demand Management
description: Playbooks guide a demand through each stage of its life cycle. Use the default playbook or configure a custom one to capture required information and support governance processes.
locale: en-US
...
Playbooks guide a demand through each stage of its life cycle. Use the default playbook or configure a custom one to capture required information and support governance processes.

## Before you begin

Verify that either the default or custom playbooks are activated.
...
2.  Open an existing demand or create a demand.
    ...
    For more information, see [Create a demand](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/create-demand-from-dw.md).

    The demand record opens.

3.  Use the default playbook or create or customize one.

    -   To use the default playbook:

        1.  Select **Playbooks** from the second-level navigation menu.
        ...
        3.  Complete the activities within each stage. For more information, see [Demand default playbook stages and activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/demand-default-playbook-stages.md).
        ...
        **Note:**
        ...
        -   A stage is marked as completed after all activities within it are either completed or skipped.
