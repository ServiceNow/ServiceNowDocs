...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/strategic-planning/explore-strategy-goal-strategy.html
release: zurich
...
For an example of the structure of a strategy from the strategic plan level down to targets, see [Enterprise strategy example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/strategic-planning/enterprise-goal-example-strategy.md).
...
To enable the feature, system properties must be configured. For details, see [Configure reminders for target actuals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/strategic-planning/configure-reminders-for-target-actuals-strategy.md).
