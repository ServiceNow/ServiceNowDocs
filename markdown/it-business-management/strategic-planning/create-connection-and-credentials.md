...
description: Using your Jira instance details, create a connection and credential for the child alias. This alias enables the two-way sync of work item updates between Strategic Planning Workspace and Jira.
locale: en-US
...
2.   or [Create Personal Access Token in Jira for SPW Jira Integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/strategic-planning/create-personal-access-token-pat-in-jira-server-data-center.md).
