...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/strategic-planning/create-child-alias-for-jira-spoke-alias.html
release: yokohama
...
-   For Jira Cloud: .
-   For For Jira Server/Data Center: [Create PAT for Jira Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/strategic-planning/create-personal-access-token-pat-in-jira-server-data-center.md).
