...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/scenario-planning-in-spw/define-lens-structure-in-alignment-planner-workspace.html
release: zurich
...
3.  Add an entity to the lens structure.
    ...
    2.  On the form, fill in the fields.
        ...
        For field information, see [Lens structure form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/scenario-planning-in-spw/lens-structure-form-alignment-planner-workspace.md).
...
4.  Validate your lens configuration and activate it. See [Activate a lens in Strategic Planning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/scenario-planning-in-spw/activate-lens-alignment-planner-workspace.md).
