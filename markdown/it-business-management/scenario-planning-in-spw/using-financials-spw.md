...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/scenario-planning-in-spw/using-financials-spw.html
release: zurich
...
-   Migrate budget of active demands from Classic UI to Next Experience. For more information, see [Migrate budget of active demands to Next Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/demand-management/fin-migrate-budget-demand.md).
