...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/scenario-planning-in-spw/target-form-egm.html
release: australia
...
```
 ...
 For more information on how the progress value is calculated when the weight scale is defined, see [Progress value calculation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/scenario-planning-in-spw/progress-value-calculation-egm.md).
