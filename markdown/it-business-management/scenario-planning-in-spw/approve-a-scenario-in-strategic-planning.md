---
title: Approve a scenario in Strategic Planning
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/scenario-planning-in-spw/approve-a-scenario-in-strategic-planning.html
release: yokohama
...
# Approve a scenario in Strategic Planning
...
4.  Select the **Approve scenario** button relevant to the scenario that you want to approve.
    ...
    -   Select a **Convert In-plan Demands to Projects** toggle to convert the prioritized demands to projects automatically and build a functional portfolio plan.
