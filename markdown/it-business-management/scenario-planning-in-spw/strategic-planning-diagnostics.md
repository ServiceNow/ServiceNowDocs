...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/scenario-planning-in-spw/strategic-planning-diagnostics.html
release: yokohama
...
Verifies that entities enabled for high-level planning have a Rank configuration.
 ...
 If this test fails, see [Create rank configuration for high-level planning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/scenario-planning-in-spw/create-rank-configuration-enable-high-level-planning.md) to fix failure.
