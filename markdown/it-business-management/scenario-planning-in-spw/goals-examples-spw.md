...
-   **Goal: Increase overall revenue and market share in 2024**
    ...
    **Target 1:** Expand market share by 10% in target regions
    ...
    The following is the recommended setup for defining the target using the [Target form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/scenario-planning-in-spw/target-form-egm.md) in the workspace:
