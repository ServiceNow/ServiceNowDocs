...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/scenario-planning-in-spw/associate-update-primary-goal-egm.html
release: australia
...
<table id="choicetable_ncp_ty2_fqb"><thead><tr><th align="left" id="d212927e115">

Option

</th><th align="left" id="d212927e118">

Navigation

</th></tr></thead><tbody><tr><td id="d212927e124">
...
Alternatively, you can select **Full details** and open the item's record page. Select the **Details** or **Goal/Target Relationships** tab from the record page.
    ...
    For a description of the field values, see [Planning item form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/scenario-planning-in-spw/planning-item-form.md).
