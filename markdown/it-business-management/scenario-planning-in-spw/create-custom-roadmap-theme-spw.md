...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/scenario-planning-in-spw/create-custom-roadmap-theme-spw.html
release: yokohama
...
-   Step 3: Do you want to add a secondary color
-   Step 4: Now, choose a neutral brand color
-   Step 5: Do you want to add any additional colors
-   Step 6: Next, let's add your company logo
-   Step 7: Which font would you like to use
-   Step 8: Almost done. Choose the corner shape you prefer.
...
Publish your custom theme so that you can apply it to your roadmap. For details, see [Publish a custom roadmap theme](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/scenario-planning-in-spw/publish-custom-roadmap-theme-spw.md).
