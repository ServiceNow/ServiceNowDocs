...
Prioritization page in Strategic Planning represents your backlog, showing the items of your work pipeline in List, Kanban, and Hierarchy views. For an overview of these views, see [Prioritization in Strategic Planning](backlog-management-in-alignment-planner-workspace.md).
