...
Use the **Migrate goal relationships for assigned entities** job to populate the fields, **Assigned entity type** and **Assigned entity** on the [Goal form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/goal-framework/goal-form.md) based on the existing values in the legacy fields, **Business Unit**, **Department**, **Company**, **Portfolio**, and any customized entity field.
