...
<table id="choicetable_whk_swd_tw"><thead><tr><th align="left" id="d286924e116">

Option

</th><th align="left" id="d286924e119">

Steps

</th></tr></thead><tbody><tr><td id="d286924e125">
...
[Update the progress of the target](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/scenario-planning-in-spw/update-progress-of-target-egm.md) manually if the target is not enabled for target automation.
