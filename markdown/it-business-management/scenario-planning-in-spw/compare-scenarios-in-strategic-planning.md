...
Verify that you have created one or more planning scenarios and selected planning items for execution. For more information, see [Create a scenario in Strategic Planning](create-a-scenario-in-strategic-planning.md).
...
7.  Select the **Approve Scenario** button relevant to a scenario to approve it.
    ...
    For more information about approving existing scenarios in the Strategic Planning Workspace, see [Approve a scenario in Strategic Planning](approve-a-scenario-in-strategic-planning.md).
