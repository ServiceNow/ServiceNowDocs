...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/scenario-planning-in-spw/migrate-goal-relationships-for-assigned-entities-egm.html
release: australia
...
3.  On the Scheduled Script Execution form:
    ...
    2.  In the **Run this script** field, list the entities configured in the Goal Assigned Entity Configuration \[sn\_gf\_assigned\_entity\_config\] table that you want to migrate the goal relationship data for.
        ...
        For parameters information, see [Scheduled Script Execution form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/scenario-planning-in-spw/scheduled-script-execution-form-egm.md).
