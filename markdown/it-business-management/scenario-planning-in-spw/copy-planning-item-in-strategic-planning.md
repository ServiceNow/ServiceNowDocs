---
title: Create a copy of an existing planning item in Strategic Planning
description: Create a copy of an existing planning item to add it to your portfolio plan's work backlog in Strategic Planning Workspace and ensure that the work pipeline is current. If the planning item you want to create is similar to an existing planning item, copying the existing planning item saves your time.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/scenario-planning-in-spw/copy-planning-item-in-strategic-planning.html
release: xanadu
...
# Create a copy of an existing planning item in Strategic Planning

Create a copy of an existing planning item to add it to your portfolio plan's work backlog in Strategic Planning Workspace and ensure that the work pipeline is current. If the planning item you want to create is similar to an existing planning item, copying the existing planning item saves your time.
