---
title: Goal management in Strategic Planning
...
Goal management key components:
...
-   Set targets and automate the actual value of the targets. For more information, see [Create targets for a goal in Strategic Planning](../task/set-targets-for-goal-egm.md).
    ...
    **Note:** Automating the actual value of the targets is optional. If you don't want to automate the actual value of your targets, you can still update the actual value of the targets manually.
