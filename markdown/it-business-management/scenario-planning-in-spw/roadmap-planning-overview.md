...
[Create a portfolio plan in Strategic Planning](../../alignment-planner-workspace/task/create-portfolio-plans-in-alignment-planner-workspace.md) to get started. You can view and edit your roadmap in both Timeline and Kanban views.

![Portfolio roadmap timeline view.](../images/potfolio-roadmap-timeline.png "Roadmap Timeline view")

![Portfolio roadmap kanban view.](../images/portfolio-roadmap-kanban.png "Roadmap Kanban view")
...
See [Create a free-form roadmap in Strategic Planning Workspace](../task/create-a-roadmap-in-roadmap-planning.md).
...
-   **Roadmap-level or portfolio-level milestones**
    ...
    The milestones created at the roadmap level can help with tracking launch dates or key events during that roadmap's timeline. To learn how to create roadmap milestones, see [Add milestones for a roadmap in Strategic Planning Workspace](../task/create-milestones-on-roadmap.md).
...
-   **Planning item milestones**
    ...
    To learn how to create item-level milestones on a roadmap, see [Add milestones for roadmap items in Strategic Planning Workspace](../task/create-planning-item-milestones.md).
...
To learn about creating and managing dependencies, see [Add dependencies for roadmap items in Strategic Planning Workspace](../task/create-planning-item-dependencies-in-a-roadmap.md).
...
See [Track the progress of your roadmap items in Strategic Planning Workspace](../task/track-roadmap-items-progress.md).
