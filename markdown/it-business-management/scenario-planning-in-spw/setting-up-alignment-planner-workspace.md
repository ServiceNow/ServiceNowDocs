...
11. Enable financial planning for epics and customise the Financials screen view.
    ...
    See [Configure financials for Strategic Planning](../../spw-financials/task/config-fin-spw.md).
...
When you’re configuring a task from the Guided Setup, you can launch the in-app help for additional guidance by clicking the Show Help icon \(![Show Help.](../images/help-icon.png)\).
