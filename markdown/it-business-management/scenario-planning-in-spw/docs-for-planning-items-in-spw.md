...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/scenario-planning-in-spw/docs-for-planning-items-in-spw.html
release: xanadu
...
-   Each planning item can have a separate doc to capture the information related to it.

    For example, for an Epic, you create Docs for high level business objectives or technical product requirements.

-   Each planning item can have multiple Docs associated to it and each Doc can have multiple pages to help you effectively organize key artifacts.
-   Predefined templates such as Project Brief, Product Requirements, Brainstorming Ideas, and Meeting notes are available. Create pages for your Doc using one of these templates or start with a blank page.
