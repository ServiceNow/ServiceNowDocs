...
4.  Select the Personalize icon \(![Personalize icon.](../../project-workspace/image/icon-settings.png)\) to update the view, based on your preferences.

<table id="choicetable_x5r_jqv_yxb"><thead><tr><th align="left" id="d200176e176">

Choice

</th><th align="left" id="d200176e179">

Action

</th></tr></thead><tbody><tr><td id="d200176e185">
