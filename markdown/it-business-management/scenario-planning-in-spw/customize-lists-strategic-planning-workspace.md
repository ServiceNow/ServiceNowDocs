...
For more information of configuring lists in a workspace, see [Lists](https://www.servicenow.com/docs/access?context=migration-lists&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
