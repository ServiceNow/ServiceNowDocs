...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/microsoft-azure-devops-integrations-comm/generate-default-map-config-agile-azure.html
release: yokohama
...
If the table map does not exist for a work item in your Azure DevOps process, this work item can't be imported and exported between Azure DevOps and Agile Development 2.0.
