...
The application then automatically identifies PI 1 as the program increment. It also identifies Sprint 1, Sprint 2, and so on as the corresponding SAFe sprints in the ServiceNow instance.
