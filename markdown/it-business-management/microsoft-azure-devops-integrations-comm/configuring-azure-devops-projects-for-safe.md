...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/microsoft-azure-devops-integrations-comm/configuring-azure-devops-projects-for-safe.html
release: xanadu
...
-   To create [team integration settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/microsoft-azure-devops-integrations-comm/set-up-import-export-azure-agile.md) for a project, the SAFe teams must be a part of the project's ART.
