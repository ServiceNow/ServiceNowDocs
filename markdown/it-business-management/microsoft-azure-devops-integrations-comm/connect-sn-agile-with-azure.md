...
1.  [Create a Connection &amp; Credential alias](https://www.servicenow.com/docs/access?context=connection-alias&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US)
...
2.  Use OAuth 2.0 or Basic Auth to create credentials.
    ...
    -   OAuth 2.0: See [Set up the Microsoft Azure DevOps Boards Spoke using OAuth](https://www.servicenow.com/docs/access?context=setup-azdevops-boards-oauth&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
    ...
    -   Basic Authentication: See [Basic authentication credentials](https://www.servicenow.com/docs/access?context=r_BasicAuthCredentialsForm&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
...
3.  Create [Create an HTTP\(s\) connection](https://www.servicenow.com/docs/access?context=create-https-connection&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
