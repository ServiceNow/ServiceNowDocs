...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/microsoft-azure-devops-integrations-comm/configuring-azure-devops-integration-with-safe.html
release: yokohama
...
1.  Identify the process in Azure DevOps that maps to SAFe.
    ...
    If the Process Mappings related list is empty, [discover Azure DevOps projects](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/microsoft-azure-devops-integrations-comm/discover-import-azure-projects.md) and try again.
