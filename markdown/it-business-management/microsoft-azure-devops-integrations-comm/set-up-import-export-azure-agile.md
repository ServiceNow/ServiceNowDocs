...
[Associate Azure DevOps projects with assignment groups in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/microsoft-azure-devops-integrations-comm/set-up-import-export-azure-agile.md)
...
-   Create assignment groups in Agile Development. See [Create an assignment group in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/agile-development/create-an-agile-group.md).
-   Role required: sn\_ado\_int.user
