...
description: Use the Now Assist Admin console to activate the various Now Assist applications and skills that you’re entitled to. If you have the admin role, you can configure the Now Assist for Strategic Portfolio Management \(SPM\) application to enable generative AI skills in Strategic Planning, Project Workspace, Demand Management, or Enterprise Agile Planning.
locale: en-US
release: australia
...
Use the Now Assist Admin console to activate the various Now Assist applications and skills that you’re entitled to. If you have the admin role, you can configure the Now Assist for Strategic Portfolio Management \(SPM\) application to enable generative AI skills in Strategic Planning, Project Workspace, Demand Management, or Enterprise Agile Planning.
...
Use the Now Assist Admin console to configure Now Assist for SPM. All Now Assist for SPM skills are activated by default. If a skill isn't automatically activated or you want to update its configuration, follow these steps.
...
-   Project doc generation and insights \(Project Workspace\)
-   Planning item doc generation and insights \(Strategic Planning\)
-   EAP doc generation and insights \(Enterprise Agile Planning\)
...
<table id="choicetable_vkp_mtx_mhc"><thead><tr><th align="left" id="d263968e382">

Option

</th><th align="left" id="d263968e385">

Steps

</th></tr></thead><tbody><tr><td id="d263968e391">
