...
The Project doc generation and insights skill is activated by default. For more information on how to activate the skill if it isn't automatically activated or if you want to change the skill configuration, see [Configure Now Assist Admin features](configure-now-assist-for-spm.md).
...
<table id="choicetable_oq5_fqw_1dc"><thead><tr><th align="left" id="d192897e129">

Gen AI actions

</th><th align="left" id="d192897e132">

Procedure

</th></tr></thead><tbody><tr><td id="d192897e138">
...
<table id="choicetable_nly_n5h_1dc"><thead><tr><th align="left" id="d192897e238">

Option

</th><th align="left" id="d192897e241">

Procedure

</th></tr></thead><tbody><tr><td id="d192897e247">
...
Select the copy to clipboard icon \(![Copy to clipboard icon.](../images/icon-copy-spm.png)\) to use the summary information for another purpose, such as pasting it into an email.
    ...
    Only an administrator can activate the Now Assist skills. For more information, see [Configure Now Assist Admin features](configure-now-assist-for-spm.md).
