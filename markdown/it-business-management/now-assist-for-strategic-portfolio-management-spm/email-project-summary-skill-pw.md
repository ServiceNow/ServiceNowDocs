...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/now-assist-for-strategic-portfolio-management-spm/email-project-summary-skill-pw.html
release: xanadu
...
2.  From the planning page, select the more actions icon \(\[Omitted image "more-options-icon.png"\] Alt text: More actions icon.\) and then select **Email project summary**.
...
[Email project summary](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/intelligent-experiences/enable-ai-experiences/now-assist-email-summary-skill.md)
