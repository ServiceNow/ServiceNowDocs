...
4.  Provide your project task input using one or more of these methods.
    ...
    -   Select Attach files and upload a word, pdf, excel, or powerpoint document. A preview of the attachment appears before you proceed. To use file attachments, activate the document intelligence skill. For more information, see [Activate a Now Assist in Document Intelligence skill](https://www.servicenow.com/docs/access?context=activate-now-assist-in-document-intelligence-skill&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US).
