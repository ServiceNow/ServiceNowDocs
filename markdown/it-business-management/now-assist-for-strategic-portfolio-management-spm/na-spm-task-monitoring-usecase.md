...
Autonomously generate a project insights email using AI agents. To use Monitor project tasks, make sure that the project insights generation skill is active. For more information on how to activate the skill, see [Configure Now Assist for Strategic Portfolio Management \(SPM\)](../task/configure-now-assist-for-spm.md).
...
For more information on other agentic workflow that are associated with the Platform workflow, see [Platform agentic workflows](https://www.servicenow.com/docs/access?context=platform-use-cases&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
