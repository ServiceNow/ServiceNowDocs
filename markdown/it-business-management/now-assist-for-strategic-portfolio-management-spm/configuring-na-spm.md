---
title: Configure Now Assist Admin features
...
# Configure Now Assist Admin features
...
To enable the Agile story generation skill and project insights generation skill, verify that Now assist panel is enabled. For more information, see [Activate the Now Assist panel standard chat](https://www.servicenow.com/docs/access?context=activate-now-assist-panel&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US). For Agile story generation skill, verify AI Search is activated and ready to use by navigating to **All** &gt; **AI Search** &gt; **AI Search Status**
