...
The Now Assist for SPM application is supported for the Strategic Planning Workspace, Project Workspace, and Enterprise Agile Planning.
...
For more information, see [Configure Now Assist for Strategic Portfolio Management \(SPM\)](../task/configure-now-assist-for-spm.md).
