...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/now-assist-for-strategic-portfolio-management-spm/generate-targets-for-goal.html
release: zurich
...
\[Omitted video\] Description: Generate targets for a goal in Strategic Planning Workspace using Now Assist for SPM
...
[Update the progress of the target](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/scenario-planning-in-spw/update-progress-of-target-egm.md) manually if the target isn’t enabled for target automation.
...
[Add targets for a goal in Strategic Planning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/scenario-planning-in-spw/set-targets-for-goal-egm.md)
