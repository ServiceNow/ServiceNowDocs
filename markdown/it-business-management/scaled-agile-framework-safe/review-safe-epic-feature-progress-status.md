...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/scaled-agile-framework-safe/review-safe-epic-feature-progress-status.html
release: yokohama
...
\[Omitted image "epics-progress-status.png"\] Alt text: A screenshot showing the progress status indicators of SAFe epics

\[Omitted image "safe-features-progress-status.png"\] Alt text: A screenshot showing progress status indicators for SAFe features
...
**Parent Topic:**[Work Progress Status for SAFe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/scaled-agile-framework-safe/work-progress-status-safe-overview.md)
