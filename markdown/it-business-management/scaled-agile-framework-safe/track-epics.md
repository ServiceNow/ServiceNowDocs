...
5.  Add an epic to a specific state:
    ...
    2.  On the form, fill in the fields and submit it.
        ...
        For more information on epic fields, see [Define an epic in SAFe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/scaled-agile-framework-safe/create-SAFeepic.md).
