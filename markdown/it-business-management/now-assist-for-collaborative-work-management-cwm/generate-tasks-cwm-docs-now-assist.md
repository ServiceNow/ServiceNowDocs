...
5.  Select **Create tasks in CWM**.

    Now Assist generates recommendations for tasks based on the information on your Doc page.

6.  Go through the task recommendations and choose to refine or modify any task recommendation.

7.  You can iterate on refining or modifying the tasks and when you’re satisfied with the recommendations, select **Add to Board**.

8.  Select the Space of the CWM Board to which you want to add these tasks to.

9.  Select the Board to add these tasks to.
