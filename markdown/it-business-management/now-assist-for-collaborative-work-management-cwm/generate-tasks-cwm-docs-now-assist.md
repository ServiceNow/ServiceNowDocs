...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/now-assist-for-collaborative-work-management-cwm/generate-tasks-cwm-docs-now-assist.html
release: zurich
...
5.  You can iterate on refining or modifying the tasks and when you’re satisfied with the recommendations, select **Add to Board**.
