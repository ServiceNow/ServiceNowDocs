...
-   Activate the Docs summarization in Collaborative Work Management Now Assist skill. See [Configure Now Assist for Collaborative Work Management \(CWM\)](configure-now-assist-for-collaborative-work-management.md).
