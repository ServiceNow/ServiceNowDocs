...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/ppm-collaboration/associate-goal-strategy-prj.html
release: yokohama
...
You should have an existing [project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/t_CreateAProject.md).
...
3.  In the **Business Case** tab, add or update the strategies and goals with which the project is associated.
    ...
    For more information, see the Business Case field descriptions in the [Create a project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/t_CreateAProject.md) documentation topic.
