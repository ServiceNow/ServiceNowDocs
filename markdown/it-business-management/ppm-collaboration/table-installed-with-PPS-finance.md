...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/ppm-collaboration/table-installed-with-PPS-finance.html
release: australia
...
All teamspaces, which refer to the tables that are created for the teamspaces. See [Installed with teamspaces](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/r_InstalledWithTeamspaces.md) for a list of teamspace tables.
