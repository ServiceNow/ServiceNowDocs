...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/ppm-collaboration/table-installed-with-PPS-finance.html
release: zurich
...
All teamspaces, which refer to the tables that are created for the teamspaces. See [Installed with teamspaces](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/r_InstalledWithTeamspaces.md) for a list of teamspace tables.
