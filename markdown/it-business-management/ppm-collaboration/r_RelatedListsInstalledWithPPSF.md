...
|Portfolio Target|Lists the portfolio capital and operational expense target for different fiscal years. The values are displayed from the project\_funding table. Set these values [in the Set Target stage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/portfolio-management/t_SelectFiscalPeriodAndSetTargets.md) of the portfolio workbench. You can create targets for different financial periods.|
