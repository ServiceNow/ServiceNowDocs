...
3.  From the **Assignment group** field, select a group to assign this project.
    ...
    If you don't see the group that you need, work with your admin to create it. See [Define an Agile group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/ppm-collaboration/t_SDLCPPSCreateATeam.md).
