...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/ppm-collaboration/time-sheet-dashboard.html
release: xanadu
...
**Important:** Starting with Xanadu release, **Time Sheet Dashboard** is renamed to **Analytics Time sheet** for new customers.
...
</table>**Parent Topic:**[Project Portfolio Management Platform Analytics Solutions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/ppm-collaboration/project-portfolio-content-pack.md)
