...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/collaborative-work-management/implementing-automations-in-collaborative-work-management.html
release: zurich
...
Get started with automations in CWM. See [Create automations in CWM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/collaborative-work-management/create-and-manage-automations-in-cwm.md).

-   **[Create automations in CWM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/collaborative-work-management/create-and-manage-automations-in-cwm.md)**  
Add conditions to build task automations for CWM Boards and help your team save time from manual task updates.
-   **[Manage or delete automations in CWM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/collaborative-work-management/manage-or-delete-automations-in-cwm.md)**  
