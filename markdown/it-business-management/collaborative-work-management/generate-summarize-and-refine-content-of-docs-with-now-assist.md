...
# Generate and improve Docs content with ServiceNow Otto \(CWM\)
...
<table id="choicetable_l3j_vx2_lgc"><thead><tr><th align="left" id="d303474e126">

Choice

</th><th align="left" id="d303474e129">

Steps

</th></tr></thead><tbody><tr><td id="d303474e135">
...
2.  Select the ServiceNow Otto icon \[Omitted image "cwm-icon-na-docs.png"\] Alt text:.
...
</table>    ServiceNow Otto analyzes the text and generates an output in a separate pop-up.
