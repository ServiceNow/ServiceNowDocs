---
title: Now Assist skills for Collaborative Work Management \(CWM\)
...
-   **[Generate acceptance criteria for stories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-business-management/collaborative-work-management/generate-acceptance-criteria-for-stories-in-cwm.md)**
    ...
    \[Omitted image "na-cwm-acc-criteria.png"\] Alt text: Sprint planning view in CWM showing a story detail panel with the Acceptance criteria field open and the Now Assist menu displaying the Generate acceptance criteria option.
...
-   **[CWM Doc generation and insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-business-management/collaborative-work-management/generate-summarize-and-refine-content-of-docs-with-now-assist.md)**
    ...
    -   **Refine, elaborate, or improve the existing content within the page**
        ...
        \[Omitted image "na-inline-open-text.png"\] Alt text: CWM Doc page showing the Now Assist inline context menu open over selected stakeholder text, with the prompt 'Elaborate on the scope of these teams.' entered in the text field.
...
-   **[Doc summarization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-business-management/collaborative-work-management/summarize-doc-now-assist-cwm.md)**
    ...
    \[Omitted image "cwm-na-doc-summarization.png"\] Alt text: CWM Doc page titled 'Phases and milestones' with the Now Assist panel showing an AI-generated summary of the document's key milestones.
...
An administrator can activate and manage Now Assist features and skills for the CWM workspace using the Now Assist Admin console. For more information, see [Overview tab in Now Assist Admin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/intelligent-experiences/configuring-now-assist.md).
