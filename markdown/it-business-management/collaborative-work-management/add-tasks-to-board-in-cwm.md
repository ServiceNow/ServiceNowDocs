...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/collaborative-work-management/add-tasks-to-board-in-cwm.html
release: zurich
...
-   Create additional columns for a task to add other details. See [Add custom columns for tasks in a CWM Board](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/collaborative-work-management/add-custom-columns-for-tasks-in-board.md)
-   Choose the columns to be displayed for the tasks on the Board. See [Personalize List, Gantt and Kanban display for CWM Boards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/collaborative-work-management/personalize-cwm-board-views.md).
