...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/collaborative-work-management/manage-connected-work-item-types-in-cwm.html
release: xanadu
...
5.  Update the filter conditions for a work item type by selecting **Edit** from the More actions menu \(\[Omitted image "cwm-icon-page-actions.png"\] Alt text: More actions icon.\).
    ...
    For more information, see [Update filter conditions for connected work in CWM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/collaborative-work-management/update-conditions-for-connected-work-in-cwm.md).
