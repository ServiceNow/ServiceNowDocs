...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/collaborative-work-management/connect-cwm-spw.html
release: xanadu
...
[Configure CWM Board form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/collaborative-work-management/connect-cwm-spw.md).
...
[Associate Boards with portfolio plan entities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/collaborative-work-management/connect-cwm-spw.md).
...
-   If a primary goal is added, this Board will show up in the aligned work for the selected goal in Strategic Planning workspace.
    ...
    \[Omitted image "cwm-board-aligned-work.png"\] Alt text:
