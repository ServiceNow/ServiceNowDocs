...
5.  Save the current view so the columns persist for the next session.
    ...
    For more information about saving a view, see [Update a CWM Board view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/collaborative-work-management/update-a-cwm-board-view.md).
...
[Personalize List, Gantt and Kanban display for CWM Boards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/collaborative-work-management/personalize-cwm-board-views.md)
