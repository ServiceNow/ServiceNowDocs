...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/collaborative-work-management/show-project-columns-in-cwm-list-view.html
release: australia
...
5.  Save the current view so the columns persist for the next session.
    ...
    For more information about saving a view, see [Update a CWM Board view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/collaborative-work-management/update-a-cwm-board-view.md).
