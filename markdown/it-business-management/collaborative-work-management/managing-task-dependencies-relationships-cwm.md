...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/collaborative-work-management/managing-task-dependencies-relationships-cwm.html
release: yokohama
...
-   **Related**
    ...
    \[Omitted image "cwm-relationships-kanban.png"\] Alt text: A Kanban board showing a work item card with the relationships indicator, and the right side panel open listing the related work items and their relationship types.
...
-   **[Remove a dependency from a work item in CWM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/collaborative-work-management/remove-a-dependency-from-a-work-item-cwm.md)**  
