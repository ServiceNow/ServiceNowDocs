...
-   Get notified when someone @-mentions you in a Doc.
-   Create and apply templates for documents.
...
-   Copy and paste the content such as text, images, lists, and tables from one Doc page to another.
-   Email the Docs page content to your team members and stakeholders within and outside the CWM workspace.
...
## Summarize Docs content using Now Assist for CWM
