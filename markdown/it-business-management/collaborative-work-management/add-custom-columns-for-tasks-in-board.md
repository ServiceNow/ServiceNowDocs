...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/collaborative-work-management/add-custom-columns-for-tasks-in-board.html
release: yokohama
...
**Note:** Custom columns added for a task are local to the Board that they're created in and are not applicable to other Boards and Spaces in the workspace.
