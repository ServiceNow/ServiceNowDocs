...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/financial-management/t\_AssignABucketToASegmentOrAnAccount.html
release: xanadu
...
1.  Drag a bucket to a specific account.
    ...
    Alternatively, select one or multiple buckets. Click the **Assign bucket** icon \(\[Omitted image "Bucket\_allocation\_icon.png"\] Alt text: The allocation icon\) that contains the expenses you want to assign to a single account or multiple accounts by performing the following steps:
...
2.  Drag a bucket to a segment or click the **Assign bucket** icon \(\[Omitted image "Bucket\_allocation\_icon.png"\] Alt text: The allocation icon\) to assign a bucket to a segment.
...
<table id="choicetable_lw3_zjd_yq"><tbody><tr><td id="d158912e152">
...
</td></tr><tr><td id="d158912e179">

**__Weighted__**

</td><td>

Expenses are assigned to the accounts using a weighted metric.If the metric is configured with [Total weight](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/t_CreateWeightedAllocationMetrics.md), you can’t split a bucket using that weighted metric.
...
6.  To know how the bucket amount was distributed previously to the segments or an account, click the bucket name.
    ...
    \[Omitted image "BucketAssignmentMessage.png"\] Alt text: A sample message of bucket assignment information


**Parent Topic:**[Bucket assignments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/c_BucketAssignments.md)
