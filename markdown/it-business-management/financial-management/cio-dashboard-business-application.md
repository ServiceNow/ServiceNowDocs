---
title: Financial Management CIO dashboard for Business Applications - Legacy
...
|-----------------|-------------|
|Financial Modeling Analyst: To track the total spend of business applications.|cost\_transparency\_analyst|
|Read only role for Financial Management: To view the dashboard and its reports.|sn\_itfm\_read|
...
-   **Total Expenses Fiscal Quarterly Breakdowns – Application Cost Model**
    ...
    The indicator collects fiscal quarterly cost allocation aggregated data, rolled up from the Business Application to the Business Unit of the Business Application Costing cost model.
