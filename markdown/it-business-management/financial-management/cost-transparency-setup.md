---
title: Financial Modeling - Legacy
...
Fiscal calendars, which was under IT Financial Management, has been moved to ServiceNow AI Platform area. You can access the documentation for Fiscal calendars [here](https://www.servicenow.com/docs/access?context=c_FiscalCalendar&version=australia&pubname=australia-platform-administration&ft:locale=en-US).

-   **[Financial data import - Legacy](c_FinancialManagementImport.md)**  
Financial data resides in the General Ledger Staged Data table.
-   **[Segments - Legacy](segments.md)**  
Segments define the transaction table used in cost model hierarchy.
-   **[IT shared services - Legacy](c_ITSharedService.md)**  
IT shared services are business services that are IT related but are still shared and used across your organization.
-   **[Financial Management workbench - Legacy](c_TheITFinanceWorkbench.md)**  
The Financial Management workbench provides financial administrators with a graphical interface to allocate expenses.
-   **[Cost models - Legacy](c_CostModel.md)**  
...
-   **[Allocations - Legacy](c_Allocations.md)**  
...
-   **[Allocation metrics - Legacy](c_AllocationMetrics.md)**  
