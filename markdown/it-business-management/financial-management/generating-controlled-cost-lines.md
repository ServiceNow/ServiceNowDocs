...
If you're upgrading from a previous version to the Zurich release, the following changes are made to the Controlled Cost Lines and GL Expense Lines options:
