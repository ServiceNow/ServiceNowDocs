...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/financial-management/c\_CostModel.html
release: xanadu
...
If you own an ITBM analyst license you can use the prescribed cost models that the base system provides, other than the cost models that you can create. See [prescriptive cost models for shared services and business applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/preconfigured-prescriptive-cost-models.md), and [prescriptive cost models for business services and business capabilities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/preconfigured-prescriptive-cost-models-two.md) for the following cost models:
...
-   [Business Application Costing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/financial-management-apm.md)
-   [Service Offering Costing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/financial-management-spm.md)

-   **[Create a cost model from Cost Model form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/t_CreateACostModel.md)**  
...
-   **[Choose a cost model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/t_ChooseACostModel.md)**  
You can choose one cost model that you want to use in the workbench as you pass through all the stages.
-   **[Cost model hierarchy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/c_SegmentHierarchy.md)**  
