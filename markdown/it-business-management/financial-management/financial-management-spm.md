---
title: Financial Management for licensed SPM users
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/financial-management/financial-management-spm.html
release: xanadu
...
breadcrumb: [Financial Management, Project Portfolio Management, Strategic Portfolio Management]
---
...
\[Omitted image "ServiceOfferingCostingCM.png"\] Alt text: Service Offering Costing cost model
...
See the list of [seeded IT Shared Services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/financial-management-apm.md).
...
-   **Allocate to Service Offering on Allocation Maps**
    ...
    \[Omitted image "ServiceOfferingAllocationMap.png"\] Alt text: Allocate to service offering on allocation maps
...
-   **Allocate to Service Offerings on related CIs**
    ...
    \[Omitted image "ServiceOfferingRelatedCIs.png"\] Alt text: Allocate to service offering on allocation maps
...
-   **Allocate to Service Offerings on Total Subscribers**
    ...
    \[Omitted image "ServiceOfferingTotalSubscription.png"\] Alt text: Allocate to service offerings on total subscribers
...
-   **[Configure service offering costing cost model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/customize-service-offering-costing-cost-model.md)**  
...
-   **[Allocate expenses using service offering allocation map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/financial-management/use-service-offering-allocation-maps.md)**  
