...
-   **[Configure service offering costing cost model](../task/customize-service-offering-costing-cost-model.md)**  
...
-   **[Allocate expenses using service offering allocation map](../task/use-service-offering-allocation-maps.md)**  
