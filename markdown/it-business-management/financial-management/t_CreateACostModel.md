---
title: Create a cost model from Cost Model form
...
# Create a cost model from Cost Model form
...
You can select a cost model in [The Data Definition stage](../concept/c_TheDataDefinitionStage.md) when you set up allocations. You can also [clone a cost model in the workbench](t_CreateACostModelSimple.md).
...
**Parent Topic:**[Cost models](../concept/c_CostModel.md)

**Related topics**  


[Choose a cost model](t_ChooseACostModel.md)

[Cost model hierarchy](../concept/c_SegmentHierarchy.md)
