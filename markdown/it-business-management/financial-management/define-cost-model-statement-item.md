...
Business service that uses the statement item as a configured item.You can also [define a service](https://www.servicenow.com/docs/access?context=create-or-modify-SPM2-services&version=australia&pubname=australia-it-service-management&ft:locale=en-US).
