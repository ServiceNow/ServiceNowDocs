---
title: Choose a working set - Legacy
description: A working set refers to the set of expenses that you want to use in the workbench as you pass through all the stages.
locale: en-US
release: zurich
...
[Clone a cost model in the workbench - Legacy](t_CreateACostModelSimple.md)
