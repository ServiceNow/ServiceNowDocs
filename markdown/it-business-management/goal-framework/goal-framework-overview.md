...
|-------|--------------|----------------------|
|Create strategic plans|No|Yes|
|Create strategic priorities|Yes|Yes|
|Create goals|Yes|Yes|
|Set targets|Yes|Yes|
|Set target breakdowns|No|Yes|
|Associate work with goals|Yes|Yes|
|Automate actual value of targets|No|Yes|
