...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/goal-framework/components-installed-with-goal-framework.html
release: zurich
