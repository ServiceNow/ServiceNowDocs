...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/goal-framework/create-strategic-priority.html
release: yokohama
...
<table id="choicetable_whk_swd_tw"><thead><tr><th align="left" id="d75999e64">

Option

</th><th align="left" id="d75999e67">

Steps

</th></tr></thead><tbody><tr><td id="d75999e73">

**From the Strategic Priorities related list**

</td><td>

1.  Navigate to **Strategy** &gt; **Strategic Plans**.
2.  Open the required strategic plan that you want to create a strategic priority for.
3.  In the Strategic Priorities related list, click **New**.


</td></tr><tr><td id="d75999e106">

**From the Strategic Priorities module**

</td><td>

1.  Navigate to **Strategy** &gt; **Strategic Priorities**.
2.  Click **New**.
    ...
    For field information, see [Strategic Priority form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/goal-framework/strategic-priority-form.md).
