...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/cost-management/RateType.html
release: yokohama
...
**Note:** A user can enter a rate type only if it is permitted by the users [Time sheet policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/time-card-management/time-sheet-policies.md).

**Parent Topic:**[Manage a labor rate card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/cost-management/t_ManageALaborRateCard.md)
