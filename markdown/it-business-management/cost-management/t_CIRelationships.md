...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/cost-management/t\_CIRelationships.html
release: yokohama
...
3.  View the business service map by selecting the dependency views icon \(\[Omitted image "dependency-views.png"\] Alt text: Dependency views.\).
    ...
    \[Omitted image "CostDemoRetailBsm.jpg"\] Alt text: Retail business service map.
    ...
    \[Omitted image "CostDemoServerexp.jpg"\] Alt text: Cost Demo Server Expense
    ...
    For more information on expense aggregation, see [Enable relationship aggregation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/cost-management/t_EnableRelationshipAggregation.md).
