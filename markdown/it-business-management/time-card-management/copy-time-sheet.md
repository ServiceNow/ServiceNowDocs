...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/time-card-management/copy-time-sheet.html
release: yokohama
...
breadcrumb: [Create a time card, Time cards, Time Card management, Project Portfolio Management, Strategic Portfolio Management]
---
...
You can also perform this task from the [Time Sheet Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/time-card-management/worker-portal.md).
...
**Parent Topic:**[Create a time card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/time-card-management/t_CreateATimeCard.md)
