...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/time-card-management/copy-time-sheet.html
release: xanadu
...
You can also perform this task from the [Time Sheet Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/time-card-management/worker-portal.md).
...
**Parent Topic:**[Create a time card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/time-card-management/t_CreateATimeCard.md)
