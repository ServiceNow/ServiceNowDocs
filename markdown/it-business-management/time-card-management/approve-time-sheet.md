...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/time-card-management/approve-time-sheet.html
release: xanadu
...
During out-of-office time, the user manager can [Delegate time sheet approvals to another user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/time-card-management/delegate-time-sheet-approvals.md) with the required roles as the time sheet approver. For the specified time period, the delegated user also receives all the time sheets submitted by the time card users to process.
...
-   If any time cards in the time sheet are pending approval by one of the approvers as defined by the [time sheet policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/time-card-management/create-time-sheet-policy.md), the time sheet remains in the Submitted state.

**Parent Topic:**[Time Sheets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/time-card-management/time-sheets.md)
