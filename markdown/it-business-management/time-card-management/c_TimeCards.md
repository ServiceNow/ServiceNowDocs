...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-business-management/time-card-management/c\_TimeCards.html
release: brazil
...
You can associate time cards for the project tasks and other task categories, such as meeting and training, with relevant [resource plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/resource-management/t_AssocATimeCardWithAResourcePlan.md).
...
-   **[Create a time card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/time-card-management/t_CreateATimeCard.md)**  
You can create time cards to log time against the work you have done.
-   **[Submit a time card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/time-card-management/submit-time-card.md)**  
...
-   **[Approve or reject a time card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/time-card-management/approve-time-card.md)**  
As a time card approver, you can view and approve or reject a submitted time card.
-   **[Recall a processed time card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/time-card-management/recall-approved-time-card.md)**  
