...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/time-card-management/auto-generate-time-cards.html
release: yokohama
...
3.  Configure the following parameters in the script as per the business requirements:
    ...
    **Note:**
    ...
    -   The **Allow time card reporting on** field on the [project form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/t_CreateAProject.md) determines the level that the time cards for the project tasks are created at.
