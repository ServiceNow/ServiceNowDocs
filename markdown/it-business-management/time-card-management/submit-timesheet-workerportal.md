...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/time-card-management/submit-timesheet-workerportal.html
release: zurich
...
When you submit a time sheet, time cards are verified against the assigned [time sheet policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/time-card-management/time-sheet-policies.md). If there is no time sheet policy assigned, time cards are verified against the default time sheet policy. Business rules prevent you from submitting a time sheet in case any violation is found.
