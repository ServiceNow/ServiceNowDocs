...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/time-card-management/recall-approved-time-sheet.html
release: xanadu
...
The recall option is available only if the **Allow recall** option is selected on the associated [time sheet policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/time-card-management/create-time-sheet-policy.md).

## Procedure

1.  Navigate to the approved or processed time sheet you want to recall using one of the following options.

<table id="choicetable_s4y_wb4_xgb"><thead><tr><th align="left" id="d139733e78">

Option

</th><th align="left" id="d139733e81">

Description

</th></tr></thead><tbody><tr><td id="d139733e87">
