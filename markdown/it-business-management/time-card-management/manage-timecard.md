...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/time-card-management/manage-timecard.html
release: yokohama
...
<table id="choicetable_yfs_nxg_qmb"><thead><tr><th align="left" id="d151197e82">

Action

</th><th align="left" id="d151197e85">

Steps

</th></tr></thead><tbody><tr><td id="d151197e91">
...
</td></tr><tr><td id="d151197e118">

**View notes associated with your time cards**

</td><td>

To view notes associated with the time card:-   Tap **Time card notes**.
-   Tap back icon to go back to the time sheet.


</td></tr><tr><td id="d151197e139">

**Add notes to your time cards**

</td><td>

To add notes to the time card:-   Tap **Time card notes**.
-   Tap **Add new note** to add a new note.
-   Enter the information in the text box and click **Submit**.


</td></tr><tr><td id="d151197e170">

**Delete a time card**

</td><td>

To delete a time card:-   Tap **Delete time card**.
