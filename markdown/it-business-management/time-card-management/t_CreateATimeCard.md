...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/time-card-management/t\_CreateATimeCard.html
release: zurich
...
The **Allow time card reporting on** field on the [project form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/t_CreateAProject.md) determines the level at which the time cards for the project tasks can be created.
...
-   Automatic: Use the following options to automatically generate the time cards:
    ...
    -   By updating task:
        -   **Auto create time card on task update**
            ...
            Configure time cards to be created when a user updates a task record. The **Auto create time card on task update** setting in the assigned [time sheet policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/time-card-management/create-time-sheet-policy.md) controls this behavior and is set to false by default.
        ...
        -   **Auto fill time card with time worked entries**
            ...
            In **Project Task**, **Incident**, **Problem**, and **Change** records, the [**Time worked**](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/time-card-management/c_RecordTimeWorked.md) field does not appear by default and must be configured on the form.

    -   By scheduled job: Configure time cards for the project tasks to be generated automatically for users through a [scheduled job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/time-card-management/auto-generate-time-cards.md). Only the admin can configure a scheduled job.
...
<table id="choicetable_whk_swd_tw"><thead><tr><th align="left" id="d166810e216">

Option

</th><th align="left" id="d166810e219">

Steps

</th></tr></thead><tbody><tr><td id="d166810e225">
...
2.  Click any of the following related links:
    ...
    -   **Copy from previous time sheet**: This option [copies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/time-card-management/copy-time-sheet.md) all the time cards \(for project and non-project tasks\) from a selected time sheet.
**Note:**
...
Starting date of the week of the time sheet.**Note:** The [time sheet policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/time-card-management/create-time-sheet-policy.md) **Week starts on** controls the start day of the week. A message is displayed when you try to associate a resource plan with a time card when the week on which the time card starts is outside the resource plan dates.
...
-   **[Copy time cards from a previous time sheet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/time-card-management/copy-time-sheet.md)**  
...
-   **[Auto-generate time cards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/time-card-management/auto-generate-time-cards.md)**  
