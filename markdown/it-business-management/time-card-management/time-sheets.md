...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/time-card-management/time-sheets.html
release: yokohama
...
-   **[Create a time sheet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/time-card-management/create-time-sheet.md)**  
...
-   **[Submit a time sheet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/time-card-management/submit-time-sheet.md)**  
...
-   **[Approve or reject a time sheet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/time-card-management/approve-time-sheet.md)**  
View, approve, or reject time sheet or time cards for your user, for the given week, in a single step.
-   **[Recall a processed time sheet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/time-card-management/recall-approved-time-sheet.md)**  
...
-   **[Delegate time sheet approvals to another user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/time-card-management/delegate-time-sheet-approvals.md)**  
