...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/spm-config-console-modules.html
release: australia
...
|Module|Configuration item|Description|
|------|------------------|-----------|
|Setup user roles|Users|Manage users that have access to Demand Management. For more information, see [Demand Management users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/strategic-planning/explore-demand-workspace.md).|
|Setup user roles|Groups|Manage groups that have access to Demand Management. For more information, see [Demand Management users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/strategic-planning/explore-demand-workspace.md).|
...
|Module|Configuration item|Description|
|------|------------------|-----------|
|Setup user roles|Users|Manage users that have access to project management. For more information, see [Project Management user roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/exploring-project-management.md).|
|Setup user roles|Groups|Manage groups that have access to project management. For more information, see [Project Management user roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/exploring-project-management.md).|
