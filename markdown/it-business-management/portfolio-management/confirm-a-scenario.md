...
Ensure that you have created up to four planning scenarios and selected projects and demands for execution. For more information, see [Create planning scenarios](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/portfolio-management/create-scenarios.md) and [Select demands and projects for portfolio planning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/portfolio-management/select-prj-demands.md).
...
<table id="choicetable_xfs_1fh_jlb"><thead><tr><th align="left" id="d169008e66">

Location

</th><th align="left" id="d169008e69">

Steps

</th></tr></thead><tbody><tr><td id="d169008e75">
