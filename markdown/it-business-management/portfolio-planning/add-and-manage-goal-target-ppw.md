...
3.  Select the **Goal/Target Relationships** tab.![Use the Goal/Target Relationships tab to add or edit demand tasks.](../../spw-demand/images/goal-target-demand.png)
...
6.  Select **Save**.
    ...
    **Note:**
    ...
    -   Alternatively, you can add, edit, or remove goal/target relationship records using the **Add secondary goals** playbook activity. For more information, see [Use Playbooks](use-playbooks-in-ppw.md).
