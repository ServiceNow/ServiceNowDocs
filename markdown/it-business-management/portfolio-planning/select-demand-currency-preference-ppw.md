...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/it-business-management/portfolio-planning/select-demand-currency-preference-ppw.html
release: brazil
...
breadcrumb: [Multicurrency in demands, Configure financials for demands, Configure, Next Experience for Demand Management in Portfolio Planning, Portfolio Planning, Strategic Portfolio Management]
---
...
<table id="choicetable_lc1_qht_dnb"><thead><tr><th align="left" id="d330192e96">

Demand currency preference

</th><th align="left" id="d330192e99">

Currency option

</th></tr></thead><tbody><tr><td id="d330192e105">
...
Enable the multicurrency view in the demand form and other demand-related forms. For more information, see [Enable the demand currency view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/portfolio-planning/enable-demand-currency-view-ppw.md).
