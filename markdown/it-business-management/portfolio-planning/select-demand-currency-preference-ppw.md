...
<table id="choicetable_lc1_qht_dnb"><thead><tr><th align="left" id="d302105e86">

Demand currency preference

</th><th align="left" id="d302105e89">

Currency Option

</th></tr></thead><tbody><tr><td id="d302105e95">
...
</td></tr><tr><td id="d302105e125">

**Manage demands and projects in different currencies**

</td><td>

**Flexi**: Manage your demands and projects created from the demand, using different currencies. For example, to manage demands in USD and projects in GBP, select this option and specify USD as demand currency and GBP as project currency.
...
Enable the multicurrency view in the demand form and other demand-related forms. For more information, see [Enable demand currency view](enable-demand-currency-view-ppw.md).
