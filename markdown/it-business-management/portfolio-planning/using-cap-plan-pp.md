...
![Resource criteria screen in Capacity.](../../spw-capacity-planning/images/cp-resource-criteria-screen.png)
...
![Capacity view for resource capacity.](../../spw-capacity-planning/images/cp-capacity-planning-screen.png)
...
-   Use the filter option \(![Capacity filter button.](../../spw-capacity-planning/images/cp-filter-button.png)\) to view planning items by their type, state, priority or any by any required attributes to create capacity plans.
...
![Capacity view showing Operational work in a red highlight box.](../../spw-capacity-planning/images/cp-operational-rsrc-asgnmnt.png)
