...
<table id="choicetable_qzs_rly_zbc"><thead><tr><th align="left" id="d251536e220">

For this

</th><th align="left" id="d251536e223">

Perform these steps

</th></tr></thead><tbody><tr><td id="d251536e229">
...
-   For detailed instructions on editing a dashboard using the Platform Analytics experience in Portfolio Planning, see [Edit Platform Analytics dashboards](https://www.servicenow.com/docs/access?context=edit-db-in-ac&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).

**Parent Topic:**[Create a dashboard in Portfolio Planning](create-dashboard-ppw.md)

**Related topics**  


[View a dashboard in Portfolio Planning](view-dashboard-ppw.md)

[Create a dashboard in Portfolio Planning](create-dashboard-ppw.md)

[Duplicate a dashboard in Portfolio Planning](copy-dashboard-ppw.md)

[Share a dashboard in Portfolio Planning](share-dashboard-ppw.md)

[Add a Platform Analytics dashboard to Portfolio Planning Workspace](add-platform-dashboard-to-ppw.md)
