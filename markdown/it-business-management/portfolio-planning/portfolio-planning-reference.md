...
-   **[Components installed with Portfolio Planning](../reference/installed-with-portfolio-planning.md)**  
...
-   **[Domain separation and Portfolio Planning](../reference/domain-separation-and-portfolio-planning.md)**  
...
-   **[Planning item reorder errors in Portfolio Planning](../reference/planning-item-reorder-errors-prioritization-portfolio-planning.md)**  
...
-   **[Item dependency errors in Portfolio Planning Workspace](../reference/item-dependency-errors-in-portfolio-planning-wkspc.md)**  
...
-   **[Managing Portfolio Planning with PPM](../reference/managing-integration.md)**  
Ensure that Portfolio Planning is integrated properly with Project Portfolio Management \(PPM\) following these guidelines.
-   **[Form field information for Portfolio Planning](../reference/form-field-information-for-portfolio-planning.md)**  
