...
<table id="choicetable_pfl_vwb_zsb"><thead><tr><th align="left" id="d111586e142">

Choice

</th><th align="left" id="d111586e145">

Action

</th></tr></thead><tbody><tr><td id="d111586e151">
...
2.  Use the Rearrange rows icon \(![Rearrange rows icon.](../../alignment-planner-workspace/images/icon-rearrange.png)\) to drag and drop the rows to the required position.
 ![Prioritization page multi-row reorder](../../spw-prioritization/images/backlog-v2-multi-row-reorder.gif)
    ...
    -   Sort or group the list by the required columns. See [Personalize Prioritization List view in Portfolio Planning Workspace](personalize-prioritization-page-portfolio-planning-workspace.md).
