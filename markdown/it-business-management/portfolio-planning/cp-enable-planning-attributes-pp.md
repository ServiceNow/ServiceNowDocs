...
5.  Repeat the steps 2 through 4 for the **Skill** and **Role** attributes.
    ...
    You can create custom attributes and map them to resources. For more information, see [Create or edit planning attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/project-management/configure-planning-attributes.md).
