...
Prioritization page in Portfolio Planning represents your backlog, showing the items of your work pipeline in a list and hierarchy views. See [Work prioritization in Portfolio Planning](work-prioritization-portfolio-planning.md) for an overview of these views.
...
-   **Personalize the Prioritization page view**
    ...
    Change the way that the Prioritization page is displayed so that you can view the information in the format that you need. See [Personalizing Prioritization page views in Portfolio Planning Workspace](personalizing-prioritization-page-views-in-portfolio-planning-workspace.md).
