...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/portfolio-planning/create-choice-map-ppw.html
release: xanadu
...
Ensure that you have created a field map and it contains choice fields with a list of values. For more information, see [Create a field map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/portfolio-planning/create-field-map-ppw.md).
...
6.  In the [Choice map form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/portfolio-planning/choice-map-form-ppw.md), fill in the fields.
