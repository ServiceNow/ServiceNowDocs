...
-   Planning items shown in the prioritization view = 500
-   Roadmap items shown in the roadmap view = 500
-   Item-level milestones in the roadmap view = 100
-   Items shown in all the Kanban views = 500
...
<table id="choicetable_ygd_pdb_3rb"><thead><tr><th align="left" id="d47735e137">

Field

</th><th align="left" id="d47735e140">

Description

</th></tr></thead><tbody><tr><td id="d47735e146">
