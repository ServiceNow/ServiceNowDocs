...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/portfolio-planning/add-actions-for-a-demand-ppw.html
release: zurich
...
Add actions required to resolve an issue or risk for a demand based on your analysis of the risk or issue.
...
5.  Select the **Actions** tab.
    ...
    **Note:** If the **Actions** tab isn't visible, select **More** &gt; **Actions**.

6.  Select **New**.

7.  On the Action form, fill in the fields.

    For a description of the field values, see [Action form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/portfolio-planning/create-action-form-ppw.md).
