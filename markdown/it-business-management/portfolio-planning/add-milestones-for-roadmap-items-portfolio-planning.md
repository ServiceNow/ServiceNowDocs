...
<table id="choicetable_ngc_1zz_5wb"><thead><tr><th align="left" id="d149435e123">

Roadmap type

</th><th align="left" id="d149435e126">

Navigation

</th></tr></thead><tbody><tr><td id="d149435e132">
...
-   Milestones that you created are indicated on the roadmap item bars.
    ...
    Here’s an image of a sample roadmap with the roadmap items indicating that they have milestones.![Planning item-level milestones.](../../spw-roadmap/images/roadmap-item-milestones.png)
...
-   [Customizing milestone display on roadmap in Portfolio Planning Workspace](../reference/customizing-milestone-display-roadmap-portfolio-planning.md)
...
-   [Update roadmap item milestones in Portfolio Planning Workspace](update-roadmap-item-milestones-portfolio-planning-workspace.md)
