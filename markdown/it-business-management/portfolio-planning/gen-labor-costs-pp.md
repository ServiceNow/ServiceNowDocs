...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/portfolio-planning/gen-labor-costs-pp.html
release: yokohama
...
4.  Select **Generate** on the Generate labor costs confirmation window.
    ...
    **Note:** Alternatively, you can [activate a scheduled job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/scenario-planning-in-spw/labor-cost-scheduler-job-spw.md) to automatically create baselines at the required cadence.
