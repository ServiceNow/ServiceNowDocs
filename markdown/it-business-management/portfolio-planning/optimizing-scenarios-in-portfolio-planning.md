...
|Feature|Description|
|-------|-----------|
|[Create a scenario in Portfolio Planning](../task/create-a-scenario-in-portfolio-planning.md)|Create a scenario from the current plan, or another scenario, in a simulated environment to compare the scenario with the live plan and other scenarios.|
|[Compare scenarios in Portfolio Planning](../task/compare-scenarios-in-portfolio-planning.md)|Compare scenarios and the live plan side by side to review tradeoffs and items added or removed from the plans.|
|[Approve a scenario in Portfolio Planning](../task/approve-a-scenario-in-portfolio-planning.md)|Approve the best scenario.|
|[Manage scenarios in Portfolio Planning](../task/manage-scenarios-in-portfolio-planning.md)|View list of scenarios, rename scenarios, and delete scenarios.|
