---
title: Create a scenario in Portfolio Planning
...
# Create a scenario in Portfolio Planning
...
-   [Compare scenarios in Portfolio Planning](compare-scenarios-in-portfolio-planning.md). You can directly compare scenarios from simulation mode by selecting **Compare scenarios** from the Scenario actions list.
