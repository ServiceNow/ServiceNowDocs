...
3.  On the form, fill in the fields.
    ...
    For field information, see [Highlighted Value form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/portfolio-planning/highlighted-value-form-portfolio-planning.md).
...
5.  In the Highlighted Value Conditions related list, create records to configure the color, order, and icon for each of the field values that you want to be highlighted in the workspace.
    ...
    2.  On the form, fill in the fields.
        ...
        For field, information, see [Highlighted Value Condition form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/portfolio-planning/highlighted-value-condition-form-portfolio-planning.md).
