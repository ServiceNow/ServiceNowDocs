...
<table id="choicetable_ngc_1zz_5wb"><thead><tr><th align="left" id="d37738e96">

Roadmap type

</th><th align="left" id="d37738e99">

Navigation

</th></tr></thead><tbody><tr><td id="d37738e105">
...
3.  Use the side panel to personalize how your roadmap looks like.
    ...
    2.  Group and color your roadmap items by the available attributes.
        ...
        You can work with your admin to add other attributes for the Group by, Color by, and Metrics fields. See [Customize the display preferences for Prioritization and Roadmap in Portfolio Planning Workspace](update-source-table-preferences-roadmap-portfolio-planning.md).
    ...
    5.  If your roadmap items \(such as projects, epics, or demands\) have milestones, adjust how they’re displayed using the toggles in the Milestones section.
        ...
        For more information, see [Customizing milestone display on roadmap in Portfolio Planning Workspace](../reference/customizing-milestone-display-roadmap-portfolio-planning.md).

    6.  If your roadmap items have dependencies, adjust how they’re displayed using the toggles in the Dependencies section.

        For more information, see [Customizing roadmap item dependency display in Portfolio Planning Workspace](../reference/customizing-roadmap-item-dependency-display-portfolio-planning.md).
...
-   **[Customizing roadmap item dependency display in Portfolio Planning Workspace](../reference/customizing-roadmap-item-dependency-display-portfolio-planning.md)**  
