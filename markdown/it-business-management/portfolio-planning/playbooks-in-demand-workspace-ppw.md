...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/portfolio-planning/playbooks-in-demand-workspace-ppw.html
release: zurich
...
-   Demand default playbook - The default demand playbook is a stage-gate playbook in which each stage must be finished before moving to the next one. Stages are visible only when all activities in the previous stage are completed or skipped. After completing a stage, demand managers can still return to previous stages.
    ...
    You can create a demand playbook or customize the default demand playbook. For information about creating one, see [Create and configure playbooks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/setting-up-process-automation-designer.md).
