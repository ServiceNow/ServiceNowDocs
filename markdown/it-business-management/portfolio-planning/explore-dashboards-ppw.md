...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/portfolio-planning/explore-dashboards-ppw.html
release: australia
...
The Demands dashboard in Next Experience for Demand Management help demand users and managers monitor performance, track progress, and make informed decisions related to demands.

The Demands Dashboard is created from the Platform Analytics experience and uses the dashboard components to group and display the demands data.
