...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/portfolio-planning/manage-scenarios-in-portfolio-planning.html
release: yokohama
...
# Manage scenarios in Portfolio Planning
...
<table id="choicetable_qhd_5v3_ccc"><thead><tr><th align="left" id="d234832e108">

Action

</th><th align="left" id="d234832e111">

Description

</th></tr></thead><tbody><tr><td id="d234832e117">

**Delete a scenario**

</td><td>

1.  Select the check boxes relevant to the scenarios that you want to delete.
2.  Select **Delete**.


</td></tr><tr><td id="d234832e138">

**Rename a scenario**

</td><td>

1.  Double-click the name field that has the relevant scenario name.

The field becomes editable.

2.  Edit the scenario name.
