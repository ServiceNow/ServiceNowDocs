...
4.  On the Duplicating dashboard window, fill the details.
    ...
    Duplicating the dashboard may take some time. Select **Continue in background** to keep using the application in the meantime.
...
Edit a dashboard as needed by adding sections, filters, images, lists, process mining maps, and rich text. For more information, see [Edit a dashboard in Portfolio Planning](edit-dashboard-ppw.md).
