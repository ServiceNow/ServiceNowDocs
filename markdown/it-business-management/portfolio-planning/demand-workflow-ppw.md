...
-   Demand managers or demand users can directly submit demands from Next Experience for Demand Management.
...
The demand manager or demand user reviews and adds the required details. Demand managers can create and assign demand tasks to gather more information, if necessary.The demand is moved from the draft to the submitted state once the basic demand details are added.
