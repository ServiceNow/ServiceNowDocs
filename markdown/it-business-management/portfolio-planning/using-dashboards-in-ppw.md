...
-   **[Execution Dashboard in Portfolio Planning](../../portfolio-planning/concept/execution-dashboard-ppw.md)**  
...
-   **[View a dashboard in Portfolio Planning](../task/view-dashboard-ppw.md)**  
...
-   **[Create a dashboard in Portfolio Planning](../task/create-dashboard-ppw.md)**  
...
-   **[Duplicate a dashboard in Portfolio Planning](../task/copy-dashboard-ppw.md)**  
...
-   **[Share a dashboard in Portfolio Planning](../task/share-dashboard-ppw.md)**  
...
-   **[Add a Platform Analytics dashboard to Portfolio Planning Workspace](../task/add-platform-dashboard-to-ppw.md)**  
