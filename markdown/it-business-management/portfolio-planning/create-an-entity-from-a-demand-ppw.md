...
4.  Create the entity by selecting the appropriate option from the More Actions option.![Example of Create Project in the More Actions option.](../../spw-demand/images/demand-create-entity.png)
