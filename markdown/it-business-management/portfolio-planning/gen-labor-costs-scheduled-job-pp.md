...
3.  Select **Active** and on the Scheduled Script Execution form, fill the fields.
    ...
    For a description of the field names, see [Scheduled Script Execution form to generate labor costs for projects and demands](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/portfolio-planning/gen-labor-costs-scheduled-script-form-pp.md).
