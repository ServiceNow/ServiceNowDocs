...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/portfolio-planning/create-expense-line-pp.html
release: xanadu
...
<table id="choicetable_n25_2rm_fyb"><thead><tr><th align="left" id="d211820e82">

Choice

</th><th align="left" id="d211820e85">

Description

</th></tr></thead><tbody><tr><td id="d211820e91">
...
**Note:** Use this option to record and calculate any unplanned expenses.
    ...
    For a description of the field names, see [Create expense line form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/portfolio-planning/create-exp-line-form-pp.md).
