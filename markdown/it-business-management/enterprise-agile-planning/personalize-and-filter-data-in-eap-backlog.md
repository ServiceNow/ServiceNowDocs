...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/enterprise-agile-planning/personalize-and-filter-data-in-eap-backlog.html
release: yokohama
...
4.  Apply filters to work items to narrow down the data that's displayed on the Backlog.
    ...
    4.  Select **Apply**.
        ...
        \[Omitted image "eap-backlog-add-filter.png"\] Alt text: Baclog filters in EAP.
