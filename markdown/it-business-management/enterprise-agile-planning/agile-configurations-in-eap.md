...
-   The Story records are saved in the Story \[rm\_story\] table.
    ...
    You can also create a custom work item type. See [Create a custom work item type in EAP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/enterprise-agile-planning/create-custom-work-item-type-in-eap.md).
