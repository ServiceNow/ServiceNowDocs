...
4.  Select the more icon \(![More icon.](../images/eap-more-icon.png)\) and select **Create copy**.
    ...
    ![Create copy for a work item in EAP Backlog.](../images/eap-create-copy.png)
...
From the full details page of the work item, you can refine the description with Now Assist. See [Refine planning items content using write planning item skill](../../now-assist-spm/task/refine-text-with-write-planning-item-skill.md). This feature requires activating the Write planning item skill of Now Assist for SPM. For more information, see [Configure Now Assist for Strategic Portfolio Management \(SPM\)](../../now-assist-spm/task/configure-now-assist-for-spm.md).
