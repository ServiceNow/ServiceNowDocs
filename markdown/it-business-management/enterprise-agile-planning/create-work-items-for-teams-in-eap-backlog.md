...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/enterprise-agile-planning/create-work-items-for-teams-in-eap-backlog.html
release: xanadu
...
3.  From the page header, select **New &lt;work item type&gt;**.
    ...
    \[Omitted image "eap-new-work-item-options.png"\] Alt text: New work item type options.
