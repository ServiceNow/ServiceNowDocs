...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/enterprise-agile-planning/create-or-update-scripted-extension-point-in-eap.html
release: xanadu
...
[Associate the EAP read-only role to the dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/enterprise-agile-planning/add-the-eap-read-only-role-to-the-dashboard.md).
