...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/enterprise-agile-planning/components-installed-with-enterprise-agile-planning.html
release: xanadu
...
This role is available only with the Now Assist for SPM plugin, which is activated using the SPM Pro+ license.
...
</table>**Parent Topic:**[Enterprise Agile Planning reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/enterprise-agile-planning/eap-reference.md)
