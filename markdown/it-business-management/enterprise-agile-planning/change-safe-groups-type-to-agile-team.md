...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/enterprise-agile-planning/change-safe-groups-type-to-agile-team.html
release: xanadu
...
4.  If the **Type** field is not visible, configure the form layout of the Default view to include it.
    ...
    For information on configuring the form layout, see [Show or hide fields on a form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/configure-form-layout.md).
