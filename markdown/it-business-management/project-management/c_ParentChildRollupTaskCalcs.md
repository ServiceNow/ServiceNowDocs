...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/project-management/c\_ParentChildRollupTaskCalcs.html
release: australia
...
-   **Actual cost**: By default for the project, the sum of all costs of all the expense lines, and are typically associated with a time card and a labor rate. To track costs, you can derive rates using any of the following options:
    ...
    -   Associate a [rate model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/rate-model/rate-model.md) to the project.
