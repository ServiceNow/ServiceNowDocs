...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/project-management/compare-schedule-baselines-prj.html
release: zurich
...
2.  On the Planning Console, select different baselines to view schedule variance information of project tasks.
    ...
    **Note:** Use the show or hide columns in gantt icon \(\[Omitted image "ConfigurationIcon.png"\] Alt text: Show or hide coloumns in gantt icon\) to add these columns to the Planning Console.
