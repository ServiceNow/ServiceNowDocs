...
<table id="choicetable_wgp_h4y_tfb"><thead><tr><th align="left" id="d218217e64">

Option

</th><th align="left" id="d218217e67">

Steps

</th></tr></thead><tbody><tr><td id="d218217e73">
...
2.  On the Planning Console, select different baselines to view schedule variance information of project tasks.
    ...
    **Note:** Use the show or hide columns in gantt icon \(![image.gear_icon]\) to add these columns to the Planning Console.
