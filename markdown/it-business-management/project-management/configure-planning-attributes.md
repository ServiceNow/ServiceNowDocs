...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/project-management/configure-planning-attributes.html
release: zurich
...
<table id="choicetable_bwd_pjg_cxb"><thead><tr><th align="left" id="d43525e76">

Option

</th><th align="left" id="d43525e79">

Description

</th></tr></thead><tbody><tr><td id="d43525e85">
...
For a description of the field values, see [Planning attribute form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/planning-attributes-form.md).
...
[Using the Planning attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/planning-attributes.md)
