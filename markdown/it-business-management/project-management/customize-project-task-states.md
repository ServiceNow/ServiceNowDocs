...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-management/customize-project-task-states.html
release: yokohama
...
1.  [Define](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_DefineADictionaryOverride.md) a new dictionary override for `pm_project_task` table under `[Task - State](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/view-default-project-task-states.md)` dictionary.
...
**Parent Topic:**[View default project and project task state categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/view-default-project-task-states.md)
