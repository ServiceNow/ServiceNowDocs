...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/project-management/customize-project-task-states.html
release: zurich
...
breadcrumb: [View default project and project task state categories, Create a project task from a project, Starting a project, Use, Project Management, Project Portfolio Management, Strategic Portfolio Management]
---
...
1.  [Define](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_DefineADictionaryOverride.md) a new dictionary override for `pm_project_task` table under `[Task - State](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/view-default-project-task-states.md)` dictionary.
...
**Parent Topic:**[View default project and project task state categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/view-default-project-task-states.md)
