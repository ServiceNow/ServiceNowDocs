...
1.  [Define](https://www.servicenow.com/docs/access?context=t_DefineADictionaryOverride&version=australia&pubname=australia-platform-administration&ft:locale=en-US) a new dictionary override for `pm_project_task` table under `[Task - State](view-default-project-task-states.md)` dictionary.
