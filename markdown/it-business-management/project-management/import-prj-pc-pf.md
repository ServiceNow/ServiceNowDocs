...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-management/import-prj-pc-pf.html
release: yokohama
...
Create a [project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/t_CreateAProject.md).
...
4.  In the Microsoft Project Import dialog box, select the Microsoft Project file and calculation type:
    ...
    2.  Select one of the following options to specify the method for calculating the schedule:
        ...
        For more information about the supported constraint types, see [Project import from Microsoft Project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/project-import-msp.md).
