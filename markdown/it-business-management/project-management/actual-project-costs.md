...
-   Expense lines from cost plans: You can [create expense lines from a cost plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/project-management/t_CreateAExpenseLine.md). Allows you to specify the amount and date when the expense was incurred. The actual amount incurred is included in the cost plan after the expense line is processed.
...
[View actual project costs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/project-management/t_ViewActualProjectCosts.md)
