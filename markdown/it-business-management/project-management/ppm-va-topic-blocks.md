...
To view just the reusable topic functions, access the Topics page in Virtual Agent Designer and select the **Topic Blocks** tab. For detailed information, see Reusable topic blocks.
