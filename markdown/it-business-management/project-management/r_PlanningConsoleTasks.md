...
Click the side of the column and drag it right or left.
...
Click the arrow to expand or collapse any task that has one or more subtasks.
...
Click the task, and then drag the left or right edge of the task bar.
...
Click the task, and then drag the whole task bar to a new location.
