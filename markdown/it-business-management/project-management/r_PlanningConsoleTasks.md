...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/project-management/r\_PlanningConsoleTasks.html
release: australia
...
Right-click a task and select **Add External Dependency**. Select the project and task to which the [dependency is added](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/create-external-dependency-planning-console.md).
...
Select the save icon to commit changes made in the planning console. The option is available only when [Client Side Planning Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/client-side-planning-console.md) is enabled.
...
Select the show or hide columns in gantt icon, and then select the level from the [WBS](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/c_WorkBreakdownStructure.md) **Depth** list.
...
Find the successor task in the relationship and double-click the value in the **Predecessor** column and enter a value that specifies the relationship. See [Predecessor dependencies in the planning console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/r_ProjectTaskDependencyValues.md) for examples.Alternatively, you can create a relationship between two tasks by connecting the ends of the corresponding task bars in the timeline view.
...
Select the more options icon, and then select **Create new baseline**. See [Create baseline of a project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/t_CreateAProjectBaseline.md) for more information.
...
Select the critical path icon. For more information on the critical path, see [Gantt chart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/c_GanttChart.md).
...
Select the **Planning Console** selection arrow on the banner and select **Project Workbench**. For more information, see [Using Project workbench - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/c_ProjectWorkbench.md).
...
Select the more options icon, and then select **Export Planning Console**. For more information, see [Export project data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-management/t_ExportAProjectWithTheProjectForm.md).
