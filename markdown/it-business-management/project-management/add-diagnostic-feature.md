...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-management/add-diagnostic-feature.html
release: xanadu
...
Create diagnostic scripts and add fix scripts to use with the diagnostic feature. For more information, see [Add diagnostic and fix scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-management/add-diagnostic-and-fix-script.md).
