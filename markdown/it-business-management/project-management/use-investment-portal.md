...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-management/use-investment-portal.html
release: xanadu
...
breadcrumb: [Investment Portal, Project Management, Project Portfolio Management, Strategic Portfolio Management]
---
...
Role required: it\_project\_manager or it\_project\_user

## Procedure

1.  Navigate to **All** &gt; **Project** &gt; **Investment Portal**.

2.  From the My Investment Views page, [create an investment report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-management/create-an-investment-report.md) and navigate to Investment Portal.

3.  Use the following banner icons.

<table id="choicetable_o5m_qtt_jdb"><thead><tr><th align="left" id="d102083e87">

Icon

</th><th align="left" id="d102083e90">

Description

</th></tr></thead><tbody><tr><td id="d102083e96">
...
</td></tr><tr><td id="d102083e205">

**Users/Groups \[Omitted image "share\_users.png"\] Alt text: Icon used to share board with other users and groups**

</td><td>

Share your board with default preferences and settings to other users or groups. This option is available only to the owner of the board.To share the board with other users:

1.  Click the **User** list.
2.  Click **Add members**.
To share the board with other groups:

 1.  Click the **Groups** list.
2.  Click **Add groups**.
...
Configure widgets on the investment board. You can:-   Show or hide widgets on the header.
-   Select widgets from the list to display.
 Click **Save** to save the widget configuration on the board.

</td></tr></tbody>
</table>4.  Perform the following actions in the **Overview**, **Timeline**, and **Financials** tabs.

<table id="choicetable_ich_t5v_fdb"><thead><tr><th align="left" id="d102083e304">

Option

</th><th align="left" id="d102083e307">

Description

</th></tr></thead><tbody><tr><td id="d102083e313">
...
</td></tr><tr><td id="d102083e334">

**To view details of a project**

</td><td>

Right-click the name of the project and click **View Project**. This option is available in the **Overview** tab only.

</td></tr><tr><td id="d102083e349">

**To view details of a demand**

</td><td>

Right-click the name of the demand and click **View Demand**. This option is available in the **Timeline** tab only.

</td></tr><tr><td id="d102083e364">

**To view details of a cost plan**

</td><td>

Right-click the name of the cost plan and click **View Cost Plan**. This option is available in the **Financials** tab only.

</td></tr><tr><td id="d102083e380">

**To view Planning tab on the Project Workbench**

</td><td>

Right-click the name of the project and click **View Planning Console**. This option is available in the **Timeline** tab only.

</td></tr><tr><td id="d102083e395">

**To sort records**

</td><td>

Click the name of the column header. This option is available in both the **Overview** and **Financials** tabs.

</td></tr><tr><td id="d102083e410">
...
</td></tr><tr><td id="d102083e428">

**To view details of the grid in a yearly, quarterly, and monthly format**

</td><td>

Click the**Year/Quarter/Month** option, which is available in both the **Timeline** and **Financials** tabs.

</td></tr><tr><td id="d102083e446">

**To add a column in any tab**

</td><td>

Click the **Configuration** \[Omitted image "configuration\_investment.png"\] Alt text: Icon to add a column in any tab icon. 1.  Click **Add column**.
...
**Note:** You have an option to choose between **Cost Plan** and **Demand/Project** in the **Select Column Type** field in the **Financial** tab.

    3.  In **Demand column**, specify the column to be rendered from the Demand table.
    4.  In **Project column**, specify the column to be rendered from the Project table.
    5.  In **Cost Plan**, specify the value to be rendered. This option appears only in the **Financial** tab.


</td></tr><tr><td id="d102083e528">

**To hide a column from any tab**

</td><td>

1.  Click the **Configuration** \[Omitted image "configuration\_investment.png"\] Alt text: Icon to hide a column in any tab icon.
