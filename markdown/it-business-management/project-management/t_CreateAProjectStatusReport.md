...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-management/t\_CreateAProjectStatusReport.html
release: yokohama
...
<table id="choicetable_ft2_dt1_wbb"><thead><tr><th align="left" id="d53826e88">

Option

</th><th align="left" id="d53826e91">

Steps

</th></tr></thead><tbody><tr><td id="d53826e97">
...
3.  Select the **Status Report** related link and select **New**.
    ...
    For more information, see [Status report form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/status-report-form-project-management.md).

3.  Select **Submit**.


-   **[View project status reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/project-status-report.md)**  
...
[Status report form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/status-report-form-project-management.md)
