---
title: Create baseline of a project
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/project-management/t\_CreateAProjectBaseline.html
release: zurich
...
You can create as many financial baselines as necessary and [compare them](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/compare-baselines-of-project.md) to review the financial changes that have been made to the project since the previous baseline. Any financial baseline does not capture actual cost component of the project.
...
<table id="choicetable_zvg_42n_1cb"><thead><tr><th align="left" id="d154008e121">

Option

</th><th align="left" id="d154008e124">

Steps

</th></tr></thead><tbody><tr><td id="d154008e130">
...
</td></tr><tr><td id="d154008e196">

**From a related link**

</td><td>

1.  Select the **Create Baseline** related link.
2.  In the Create Baseline pop-up, enter a suitable description.
3.  Select **Save**.


</td></tr><tr><td id="d154008e223">

**From a related list**

</td><td>

1.  Select the **Baselines** related list.
2.  Select the **Create Baseline** button.
3.  In the Create Baseline pop-up, enter a suitable name and description.
4.  Select **Save**.
...
-   **[Compare financial baselines of a project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/compare-baselines-of-project.md)**  
Compare baselines to review the variances in the financial data of a project and see what changed.
-   **[Compare schedule baselines of a project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/compare-schedule-baselines-prj.md)**  
