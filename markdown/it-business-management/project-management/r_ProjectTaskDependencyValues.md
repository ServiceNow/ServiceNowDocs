...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-management/r\_ProjectTaskDependencyValues.html
release: yokohama
...
-   `dependency_type` is one of the [types of dependencies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/c_ParentChildRollupTaskCalcs.md) that the application supports.
...
**Note:** You can also edit tasks from the Gantt chart by clicking the relationship line. See [Gantt chart options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/r_EditTasks.md) and [Modify a project task dependency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/t_ModifyProjectTaskDependencies.md) for details.
...
[Using Planning console - Legacy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/c_TheProjectPlanningConsole.md)
