...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-management/external-dependency-types.html
release: yokohama
...
The type of external dependency can be set during [adding a dependency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/create-external-dependency-planning-console.md) between two projects tasks on the planning console.
