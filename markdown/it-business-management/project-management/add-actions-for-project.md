...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-management/add-actions-for-project.html
release: yokohama
...
-   Convert an action to a request change and close the action. For more information, see [Convert one RIDAC record to another for a project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/convert-ridac-for-project.md).
