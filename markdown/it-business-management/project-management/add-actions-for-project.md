...
After analyzing the risks and issues and taking a decision on how to manage them, add an action to resolve the risk or issue.
...
-   Convert an action to a request change and close the action. For more information, see [Convert RIDAC records for a project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/project-management/convert-ridac-for-project.md).
