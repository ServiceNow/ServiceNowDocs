...
-   To apply a template on the blank project form:
    ...
    2.  Click the link next to **To create project from a template**.
...
-   To apply a template to an existing project without any project tasks or subprojects:
    ...
    1.  Navigate to **Project** &gt; **Projects** &gt; **All** and select a project.

    2.  Click the **To apply template click here** link.
