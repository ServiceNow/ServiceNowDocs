...
For more information on integrating with Slack or Microsoft Teams, see [Setting up Virtual Agent notifications](https://www.servicenow.com/docs/access?context=configuring-va-notifications&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US).
