...
7.  Create field mappings for custom columns.
    ...
    For more information, see [Create field mappings](https://www.servicenow.com/docs/access?context=c_MappingOptions&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
