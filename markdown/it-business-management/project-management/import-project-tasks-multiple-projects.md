...
4.  In the **Source of the import** field, select File, and then click**Choose File** to select the source Excel spreadsheet.
...
7.  Create field mappings for custom columns.
    ...
    For more information, see [Create field mappings](https://www.servicenow.com/docs/access?context=c_MappingOptions&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).

8.  Transform the data from the import set table to the target table.

    For more information, see [Run an import](https://www.servicenow.com/docs/access?context=t_RunImport&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
