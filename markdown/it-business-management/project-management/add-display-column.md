...
breadcrumb: [Custom columns in the planning console, Planning console, Project Management, Project Portfolio Management, Strategic Portfolio Management]
---
...
2.  Add a custom display column for planning console.
    ...
    2.  To create a display column for the selected console, click **New** in the **Planning Console Display Column** related list.
...
3.  Map the planning console display column created in step 2 to a column in a table defined in `Planning Console Table [pm_console_table]`.
    ...
    2.  To create a record of actual column in the `Planning Console Column [pm_console_column]` table, click **New** in **Planning Console Columns** related list.
