...
To navigate to the Project form, see [Define a project](../../project-management/task/t_CreateAProject.md#table_mb3_rfw_1r).
...
To navigate to the Cost Plan Breakdown form, see [Update a cost plan breakdown](../../project-management/concept/cost-plan-breakdown.md#).
