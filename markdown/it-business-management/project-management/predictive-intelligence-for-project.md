...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/project-management/predictive-intelligence-for-project.html
release: zurich
...
-   Helps you in planning your project. You can view planning details of similar projects that were created and executed in the past.
...
Similar Projects**Note:** This solution definition is available as a template on instances where the following plugins are active:
...
-   Predictive Intelligence for PPM plugin \(com.snc.ppm\_ml\)
...
View similar projects based on the **Project Name** and **Description** fields. You can see the results in the **Similar projects** section on the Project form.
...
[Train the similarity solution for Project Management to find similar projects](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/train-similarity-solution-pm.md)

[Starting a project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/t_CreateAProject.md)
