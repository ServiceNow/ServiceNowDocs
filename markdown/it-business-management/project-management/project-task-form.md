...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/project-management/project-task-form.html
release: zurich
...
|Field|Description|
|-----|-----------|
|Checklist|[Checklist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/project-management/t_CreateAProjectTaskChecklist.md) to track items that must be completed for the task.|
