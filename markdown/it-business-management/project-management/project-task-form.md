...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-management/project-task-form.html
release: yokohama
...
|Field|Description|
|-----|-----------|
|Checklist|[Checklist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/t_CreateAProjectTaskChecklist.md) to track items that must be completed for the task.|
