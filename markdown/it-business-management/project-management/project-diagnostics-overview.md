...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-management/project-diagnostics-overview.html
release: xanadu
...
-   [Create and add diagnostic features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-management/add-diagnostic-feature.md)
-   [Add diagnostic and fix scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-management/add-diagnostic-and-fix-script.md) to fix corrupt or invalid project data
-   [Create Diagnostic scans and map related scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-management/create-diagnostic-scan-map-script.md)
...
Lists the expense lines that are not associated to any cost plan. When you run the fix script, these orphan expense lines are associated to a [system-generated cost plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-management/system-generated-costplan.md) and then to the respective breakdowns of the system-generated cost plan.
