...
Lists the expense lines that are not associated to any cost plan. When you run the fix script, these orphan expense lines are associated to a [system-generated cost plan](system-generated-costplan.md) and then to the respective breakdowns of the system-generated cost plan.
