...
description: You can activate the Mobile: Project Status application from ServiceNow Store, earlier known as PPM Mobile \(com.sn\_ppm\_mobile\), if you have the admin role. Installing this application also activates related plugins if they are not already active.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-management/activate-ppm-mobile.html
release: xanadu
...
You can activate the Mobile: Project Status application from ServiceNow Store, earlier known as PPM Mobile \(com.sn\_ppm\_mobile\), if you have the admin role. Installing this application also activates related plugins if they are not already active.
