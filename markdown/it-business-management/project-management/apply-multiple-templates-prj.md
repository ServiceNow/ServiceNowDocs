...
<table id="choicetable_fl1_dqc_mlb"><thead><tr><th align="left" id="d250034e67">

Location

</th><th align="left" id="d250034e70">

Step

</th></tr></thead><tbody><tr><td id="d250034e76">
...
3.  In the Project form, based on the existing project tasks or subprojects, apply the template using any of the following options:
    -   If there are no tasks or subprojects, click the **To apply template click here** link.
    -   If there are tasks or subprojects, click the **Apply Template** related link.


</td></tr><tr><td id="d250034e123">
...
4.  In the Planning Console, click the more actions icon \(![More actions icon](../image/elipsis_icon.png)\) and select **Apply Template** option.
