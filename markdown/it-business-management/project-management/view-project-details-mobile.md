...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-management/view-project-details-mobile.html
release: yokohama
...
2.  Open a project for which you want to view the details using one of the following options.
    ...
    \[Omitted image "view-project-details.gif"\] Alt text: View project details in mobile app.
