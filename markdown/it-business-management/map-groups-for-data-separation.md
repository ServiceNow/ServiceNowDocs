...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/map-groups-for-data-separation.html
release: xanadu
topic_type: task
...
3.  On the Enity-Group Mapping form, fill in the fields.
    ...
    For a description of the field values, see [Entity Group Mapping form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/entity-group-mapping-form.md).
