...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/map-groups-for-data-separation.html
release: yokohama
topic_type: task
...
3.  On the Enity-Group Mapping form, fill in the fields.
    ...
    For a description of the field values, see [Entity Group Mapping form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/entity-group-mapping-form.md).
