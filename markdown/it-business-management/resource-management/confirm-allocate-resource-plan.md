...
**Note:** For resource plans associated to projects or demands, you can confirm and allocate these plans using the [Allocation Workbench](manage-resources-allocation-workbench.md) too.
