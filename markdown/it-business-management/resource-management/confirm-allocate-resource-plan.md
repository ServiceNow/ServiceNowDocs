...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/resource-management/confirm-allocate-resource-plan.html
release: zurich
...
Resource managers can [assign and approve the unassigned resource assignments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/resource-management/allocate-resources-rmw.md) using Resource Management Workspace.

Role required: resource\_manager

## About this task

Modify or [cancel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/resource-management/t_CancelAResourcePlan.md) a resource plan that is in the Allocated state.
