...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/resource-management/resource-termination-scheduled-job.html
release: zurich
...
# Scheduled job to handle resource effort termination
...
2.  Filter the name field to locate and open **Resource Termination Handler** record.

3.  Select **Active**.

4.  On the Scheduled Script Execution form, fill the fields.

    For a description of the field names, see [Scheduled Script Execution form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/scenario-planning-in-spw/scheduled-script-execution-form-egm.md)
