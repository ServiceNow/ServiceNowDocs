...
2.  On the Resource form, fill in the fields.
    ...
    For a description of the field names, see [Resource form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/resource-management/rsrc-form.md).
