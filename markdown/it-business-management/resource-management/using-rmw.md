...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/resource-management/using-rmw.html
release: yokohama
...
-   [Assign the unassigned](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/allocate-resources-rmw.md) tasks.
-   [Approve or unapprove](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/allocate-resources-rmw.md) the assigned tasks.
-   [Split a resource assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/split-resource-assignment-rmw.md) into two for one resource at the required date.
...
-   **[Move a resource assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/move-ra-rmw.md)**  
Move a resource assignment to a different start and end dates depending on the availability of the resource.
-   **[Reassign or unassign work using Resource Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/rmw-reassign-unassign-work.md)**  
...
-   **[Split resource assignments using Resource Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/split-resource-assignment-rmw.md)**  
Splitting a resource assignment at a specific date creates a resource assignment for the same user.
-   **[Manage resource allocations in Resource Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/manage-resource-allocations-rmw.md)**  
...
-   **[Export resource portfolio view to Excel or CSV format](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/export-rmw-card-view.md)**  
...
**Parent Topic:**[Use resource assignments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/use-resource-assignment.md)
