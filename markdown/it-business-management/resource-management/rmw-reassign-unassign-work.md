...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/resource-management/rmw-reassign-unassign-work.html
release: yokohama
...
4.  To reassign any assigned work:
    ...
    2.  Select **Reassign work**.
        ...
        **Tip:** [Group the resource board](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/using-rmw.md) by the primary attributes to drag and drop the resource assignments to another resource to completely reassign work.
