...
-   If a [rate model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/rate-model/rate-model.md) is populated on the project or demand to which the resource plan is associated, the hourly rate is derived from the rate model.
...
**Parent Topic:**[Resource Plan form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/resource-management/rsrc-plan-form.md)
