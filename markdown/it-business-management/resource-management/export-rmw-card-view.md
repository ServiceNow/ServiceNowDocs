...
description: Export your resource portfolio view in Resource Management Workspace as Microsoft Excel or CSV format to review or share the resource status with stakeholders, even if they don't have access to your instance.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/resource-management/export-rmw-card-view.html
release: yokohama
...
1.  Navigate to **Workspace** &gt; **Resource Management Workspace** and open a resource card.

2.  Select the More Actions menu \(\[Omitted image "icon-more-actions-horizontal.png"\] Alt text: Three horizontal dots icon representing More Actions option.\) and select **Export**.

3.  In the Export resource board window, select a required format from the **File type** list to export the resource portfolio.

    -   **Excel** - Exports the resource portfolio in Microsoft Excel format.
    -   **CSV** - Exports the resource portfolio in CSV format.
4.  Select the **Export** \(\[Omitted image "rmw-export-button.png"\] Alt text: Export button.\) button.
