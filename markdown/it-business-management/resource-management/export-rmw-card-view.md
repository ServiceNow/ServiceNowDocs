...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/resource-management/export-rmw-card-view.html
release: zurich
...
3.  Select the More Actions menu \(\[Omitted image "icon-more-actions-horizontal.png"\] Alt text: Three horizontal dots icon representing More Actions option.\) and select **Export**.
...
5.  Select the **Export** \(\[Omitted image "rmw-export-button.png"\] Alt text: Export button.\) button.
