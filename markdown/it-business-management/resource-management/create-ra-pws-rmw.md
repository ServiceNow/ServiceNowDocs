...
5.  From the resource assignment pane, create a resource assignment for a project or task by selecting **Add resource**.
    ...
    ![Resource-assignment-pane.](../../pw-resource-management/image/resource-assignment-pane-pw.png)
...
[Update a resource assignment from Project Workspace](../../pw-resource-management/task/update-resource-assignment-pw.md)
