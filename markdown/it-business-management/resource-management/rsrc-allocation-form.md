...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/resource-management/rsrc-allocation-form.html
release: xanadu
...
-   [Rate model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/rate-model/rate-model.md), if it is populated on the project or demand to which the resource plan is associated.
