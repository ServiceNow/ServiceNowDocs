...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/resource-management/rsrc-allocation-form.html
release: australia
...
-   [Rate model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/rate-model/rate-model.md), if it is populated on the project or demand to which the resource plan is associated.
