...
4.  Select the **Actions** icon \(![Actions icon](../../planning-and-policy/image/ellipsis-vertical-icon.png)\) on the resource plan that you want to move, and select **Move Resource Plan**.
