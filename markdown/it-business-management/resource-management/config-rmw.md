...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/resource-management/config-rmw.html
release: australia
...
2.  Find the Resource Management Workspace application using the filter criteria and search bar or use the link [https://store.servicenow.com/sn\_appstore\_store.do\#!/store/application/10504991430431101326810d0bb8f223/5.10.1](https://store.servicenow.com/sn_appstore_store.do#!/store/application/10504991430431101326810d0bb8f223/5.10.1)

    You can search for the application by its name or ID \(sn\_rm\_ws\). If you can't find an application, you may have to request it from [ServiceNow store](https://store.servicenow.com/sn_appstore_store.do#!/store/application/10504991430431101326810d0bb8f223).
...
5.  If you want to install demo data, select **Load demo data**.
    ...
    **Note:** If you don't install the demo data for a store application during installation, you can't request it later.
