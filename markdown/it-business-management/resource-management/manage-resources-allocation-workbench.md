...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/resource-management/manage-resources-allocation-workbench.html
release: xanadu
...
See the [Confirm or allocate resources from the Allocation Workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/confirm-allocate-specific-time.md) topic.
...
See the [Replace user in a resource plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/replace-user.md) topic.
...
See the [Move a resource plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/move-res-plan.md) topic.
...
See the [Shift allocations of a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/shift-allocation.md) topic.
...
See the [Request extension of an allocated resource plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/request-extension-allocated-resource-plan.md) topic.
...
-   **[Confirm or allocate resources from the Allocation Workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/confirm-allocate-specific-time.md)**  
...
-   **[Replace a user in a resource plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/replace-user.md)**  
...
-   **[Move a resource plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/move-res-plan.md)**  
Move a resource plan and its allocations to a future date for a group, role, or user resource plan.
-   **[Shift allocations of a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/shift-allocation.md)**  
