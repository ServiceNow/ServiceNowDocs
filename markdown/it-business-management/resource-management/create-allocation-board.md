...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/resource-management/create-allocation-board.html
release: yokohama
...
2.  To create a board, do the following.
    ...
    2.  In the **Create new** window, fill the fields.
        ...
        For a description of the field values, see [Create New form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/create-new-rsrc-wrkbnch-form.md).
