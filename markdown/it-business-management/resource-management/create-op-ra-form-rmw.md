...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/resource-management/create-op-ra-form-rmw.html
release: australia
...
Select the effort type to request a resource.-   Hours - to request a resource on hourly basis.
-   % Capacity - to request a certain percentage of capacity towards operational work.
...
Select the kind of operational work from the list.-   KTLO
-   Admin
-   Meeting
-   Training
-   Out of office
...
Select existing rate model to calculate planned and actual resource costs.
...
</table>**Parent Topic:**[Resource Management Workspace references](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/resource-management/rmw-references.md)
