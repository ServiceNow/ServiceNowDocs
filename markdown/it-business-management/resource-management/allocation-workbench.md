...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/resource-management/allocation-workbench.html
release: xanadu
...
The Allocation Boards page shows all your allocation boards. You can [create a personalized allocation board](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/create-allocation-board.md) through a filter definition. Selecting a board name opens the allocation workbench with a list of projects, demands, and operational work types that match the allocation board filter type.
...
Watch this video to learn about the purpose and usage of the Resource Allocation Workbench.
...
Date range selector
 ...
 \[Omitted image "DateRangeSelector.png"\] Alt text: Date range selector
...
Shows resource plans for the selected time range.
 ...
 From the Xanadu release onwards, the following enhancements are available on the board:
...
State filter
 ...
 \[Omitted image "StateFilter.png"\] Alt text: State filter
...
Week or Month view
 ...
 \[Omitted image "WeekMonthToggle.png"\] Alt text: Week and month toggle
...
Hours, FTE, or Person days view
 ...
 \[Omitted image "HoursFTESwitch.png"\] Alt text: Hours, FTE, Person days view list
...
Resource Finder
 ...
 \[Omitted image "ResourceFinderIcon.png"\] Alt text: Resource finder icon

</td><td>

Displays the resource finder section at the bottom of the workbench. Use the resource finder section to [search resources and create a resource plan for them](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/create-resource-plan-with-finder.md).

</td></tr><tr><td>

Configuration

 \[Omitted image "ConfigurationIcon.png"\] Alt text: Configuration

</td><td>

Shows or hides the selected columns on the grid.

 Selecting the **Planned Cost**, **Actual Cost**, **Conf/Alloc Cost**, or **Resource Type** columns pins them on the grid before the **Details** column group. Other columns are added in the **Details** column group in the collapsed state. To view the collapsed columns, click the expand icon \(\[Omitted image "expand-icon.png"\] Alt text: Expand icon\) on the **Details** column group.

</td></tr><tr><td>

Legend

 \[Omitted image "resource\_workbench\_legend.png"\] Alt text: Legend
...
-   Identify the resource plans created with specific members preference by viewing the **Resource plan created with specific members** icon \(\[Omitted image "specificmember\_allocation\_wb\_grid.png"\] Alt text: Icon for resource plans created with specific members\) next to the resource plans.
...
The bottom resource finder section of the allocation workbench is hidden by default. To make it visible, select the resource finder icon \(\[Omitted image "ResourceFinderIcon.png"\] Alt text: Resource finder icon\) at the top right. In the Resource finder, you can perform the following actions:
...
-   **[Create or update an allocation board](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/create-allocation-board.md)**  
...
-   **[Manage resources by using the allocation workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/manage-resources-allocation-workbench.md)**  
...
-   **[Manage operational resource plans from the allocation workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/manage-operational-rp-raw.md)**  
