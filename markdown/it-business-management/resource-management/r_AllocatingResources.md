...
![The overlapping event from the monthly view](../image/overlapping_event_monthly.png "Overlapping event from the monthly view")

![The overlapping event from the weekly view](../image/overlapping_event_weekly.png "Overlapping event from the weekly view")
