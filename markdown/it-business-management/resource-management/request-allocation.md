...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/resource-management/request-allocation.html
release: yokohama
...
4.  On the Requested Allocation form, fill in the fields.
    ...
    For a description of the field values, see [Requested Allocation form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/requested-allocation-form.md).
...
-   **Case 1: Plan duration allocation type**
    ...
    For a plan duration [allocation type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/resource-management/t_CreateResourcePlanProjectTask.md), the following requested allocation records would be created:
