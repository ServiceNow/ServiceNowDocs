...
1.  Navigate to **Workspaces** &gt; **Resource Management Workspace** and open a resource card.

2.  Create resource assignments using one of the following options.

<table id="choicetable_ibq_nxx_bcc"><thead><tr><th align="left" id="d50076e77">

Option

</th><th align="left" id="d50076e80">

Procedure

</th></tr></thead><tbody><tr><td id="d50076e86">
