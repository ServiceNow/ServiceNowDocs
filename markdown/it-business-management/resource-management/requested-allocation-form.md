...
-   [Rate model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/rate-model/rate-model.md), if it’s populated on the project or demand to which the resource plan is associated.
-   Labor rate card for user resource plans.
-   Role rate when resource is requested by [resource role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/resource-management/create-resource-role.md), if the role has a rate.
