...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/program-management/c\_ProgramWorkbench.html
release: zurich
...
-   configure the colors of the program items in Gantt chart with [Dashboard Configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/program-management/t_AccessTheProgramWorkbench.md) settings.
...
-   select the show/hide icon \(\[Omitted image "cogwheel-icon.png"\] Alt text: Show or hide columns in Gantt\) to show or hide columns.
...
-   **[Access the program workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/program-management/t_AccessTheProgramWorkbench.md)**  
When you access the program workbench, it displays a list of all the programs.

**Parent Topic:**[Program Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/program-management/c_ProgramManagement.md)
