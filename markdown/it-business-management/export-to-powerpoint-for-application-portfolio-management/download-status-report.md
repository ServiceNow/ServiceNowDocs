...
1.  To download your status report for Enterprise Architecture \(formerlyApplication Portfolio Management\), see [Export data to Microsoft PowerPoint](https://www.servicenow.com/docs/access?context=export-apm-data-ppt&version=xanadu&pubname=xanadu-application-portfolio-management&ft:locale=en-US).
...
5.  To download your status report for Portfolio Planning, see [Export the portfolio plan status or roadmap to Microsoft PowerPoint from Portfolio Planning Workspace](../../portfolio-planning/concept/export-portfolio-plan-status-to-ppt-portfolio-planning-workspace.md).
