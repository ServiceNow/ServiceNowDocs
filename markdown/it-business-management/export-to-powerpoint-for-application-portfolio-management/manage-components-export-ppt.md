...
<table id="choicetable_wws_lkm_t5b"><tbody><tr><td id="d182414e82">
...
2.  To add a custom remote table:
    1.  [Create a remote table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/create-remote-table.md).
