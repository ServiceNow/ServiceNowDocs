...
<table id="choicetable_wws_lkm_t5b"><tbody><tr><td id="d181863e82">
...
2.  To add a custom remote table:
    1.  [Create a remote table](https://www.servicenow.com/docs/access?context=create-remote-table&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
