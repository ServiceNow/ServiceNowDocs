---
title: Exploring Setup Hub \(SPM\)
description: The Setup Hub \(SPM\) consolidates setup processes for SPM applications into a single workspace, giving administrators a unified view of their configuration state.
locale: en-US
...
|User|Description|
|----|-----------|
|System administrator|Uses the Setup Hub console to configure all SPM applications and verify that the required configuration for all apps is complete.|

## Setup Hub \(SPM\) workflow
...
|-------|-------|-----|
|Find every SPM setup task from one workspace without switching between application admin pages.|[Modules in Setup Hub \(SPM\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/spm-config-console-modules.md)|System administrator|
...
-   [Access Setup Hub \(SPM\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/spm-config-console-access.md)
-   [Modules in Setup Hub \(SPM\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/spm-config-console-modules.md)
