...
1.  Open the **Ideas** application menu record and add the Idea Portal to the navigation menu.
    ...
    For information about how to add Idea Portal to the navigation menu, see [Create a module](https://www.servicenow.com/docs/access?context=test-steps-app-navigator-category&version=zurich&pubname=zurich-application-development&section=t_CreateAModule&ft:locale=en-US).
