...
If you want to allow conversion of ideas only to a demand, disable the **Create Task** button and continue using the **Accept** button or disable the **Accept** and **Defer** buttons to use other options. For more information see, [Using the form designer](https://www.servicenow.com/docs/access?context=c_FormDesign&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
To encourage your users to submit ideas through the new Idea Portal, remove navigation for old Idea application from the application menu and deactivate the Submit an Idea option from the Service Catalog. For more information see, [Enable or disable an application menu or module](https://www.servicenow.com/docs/access?context=t_EnDisableAppMenuOrMod&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
