...
description: If you are upgrading to the Yokohama release, complete the migration tasks after the upgrade to start using the new Idea Portal.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/innovation-management/migrate-legacy-to-new-ideas.html
release: yokohama
