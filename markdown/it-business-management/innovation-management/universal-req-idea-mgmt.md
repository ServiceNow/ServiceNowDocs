...
-   Universal Request plugin \(com.snc.universal\_request\). For activation information, see [Activate Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/activate-ur-plugin.md).
