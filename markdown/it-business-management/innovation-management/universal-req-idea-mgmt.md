...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/innovation-management/universal-req-idea-mgmt.html
release: yokohama
...
-   Universal Request plugin \(com.snc.universal\_request\). For activation information, see [Activate Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/employee-service-management/universal-request-for-hr-service-delivery/activate-ur-plugin.md).
...
-   **[Create an Idea from Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/innovation-management/create-idea-from-ur.md)**  
Create an idea from a universal request after initial evaluation for a new product, feature, enhancement, or change.
-   **[Idea state mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/innovation-management/idea-state-mapping.md)**  
...
-   **[Transfer an Idea to another department](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/innovation-management/transfer-idea-ur.md)**  
