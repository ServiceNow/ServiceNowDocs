...
Universal Request serves as a parent record for other records created as child records, such as INC, HRC, and custom task types. It is also used for all cross-departmental reporting. For more information about universal request, see [Exploring Universal Request](https://www.servicenow.com/docs/access?context=explore-universal-request&version=australia&pubname=australia-employee-service-management&ft:locale=en-US).
...
-   Universal Request plugin \(com.snc.universal\_request\). For activation information, see [Activate Universal Request](https://www.servicenow.com/docs/access?context=activate-ur-plugin&version=australia&pubname=australia-employee-service-management&ft:locale=en-US).
