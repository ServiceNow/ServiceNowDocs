...
4.  Review the idea details and then choose which action to perform on the idea.
    ...
    For more information, see [Evaluate ideas](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/innovation-management/evaluate-ideas-actions.md).
