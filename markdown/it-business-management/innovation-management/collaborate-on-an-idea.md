...
3.  Review the idea details and then choose which action to perform on the idea.
    ...
    For more information on actions and steps, see [Collaborate on idea](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/innovation-management/collaborate-on-idea-actions.md).
