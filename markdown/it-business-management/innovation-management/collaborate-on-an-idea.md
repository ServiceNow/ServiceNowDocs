...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/innovation-management/collaborate-on-an-idea.html
release: australia
...
You cannot comment and vote for ideas that are in the **Completed**, **Unlikely to implement**, **Duplicate**, or **Already exists** state.
...
3.  Review the idea details and then choose which action to perform on the idea.
    ...
    For more information on actions and steps, see [Collaborate on idea](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/innovation-management/collaborate-on-idea-actions.md).
