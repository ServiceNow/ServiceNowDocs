...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/test-management/c\_TestSuites.html
release: zurich
...
-   **[Create a test suite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/t_CreateATestSuite.md)**  
A test suite is made up of one or more test cases that are grouped for execution purposes.
-   **[Create a copy of an existing test suite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/t_CopyATestSuite.md)**  
Create a test suite with the details of an existing test suite.
-   **[Add a test case to a test suite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/t_AddANewTestCaseToATestSuite.md)**  
