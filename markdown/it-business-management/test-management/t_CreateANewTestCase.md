...
-   Add tests to this test case by using the Tests related list. For more information, see [Add a test to a test case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/test-management/t_AddATestToATestCase.md).
