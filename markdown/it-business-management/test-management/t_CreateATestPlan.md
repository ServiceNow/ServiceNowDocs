...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/test-management/t\_CreateATestPlan.html
release: australia
...
Projected start date for the test plan. The planned start date can be the current date or a future date. This field is automatically set to the current date. To change the planned start date, click the calendar icon \(\[Omitted image "calendar-icon.png"\] Alt text: Calendar icon.\) and select a new date.
 ...
 You may need to configure the form to add this field. For more information, see [Display test plan execution start and end dates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/test-management/t_CreateATestPlan.md).
...
-   Add new test cases to this test plan from the Test Cases related list. For more information, see [Add test case to a test plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/test-management/t_AddANewTestCaseToATestPlan.md).
