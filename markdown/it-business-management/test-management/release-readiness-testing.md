...
1.  Creating tests. See [Create a test in Test Management 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/create-test2.md)
2.  Creating test sets, and grouping similar tests into a test set. See [Create a test set in Test Management 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/create-test-set.md).
3.  Using the Test Board feature to create a test plan. See [Create a test plan using Test Board in Test Management 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/create-test-plan.md).
4.  Structuring the test plan in the Planning tab of the Test Board.
    -   Breaking down the test plan into test cycles to plan and schedule the phases of the testing effort. See [Add and modify test cycles and test execution suites in Test Management 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/use-planning-tab.md).
    -   Breaking down the test cycles into test execution sets to schedule tests, and assign users to run those tests. See [Create a test execution suite in Test Management 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/create-test-execution-suite.md).
5.  Running tests and viewing the test run results. See [Run your test assignments in Test Management 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/run-your-test-assignments.md).

-   **[Create a test in Test Management 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/create-test2.md)**  
Create a test specifying conditions or steps to determine whether a feature is working correctly.
-   **[Create a test set in Test Management 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/test-management/create-test-set.md)**  
