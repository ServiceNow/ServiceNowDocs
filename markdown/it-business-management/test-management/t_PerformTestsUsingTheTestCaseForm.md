...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/test-management/t\_PerformTestsUsingTheTestCaseForm.html
release: xanadu
...
12. After all of the tests are complete, update the test case status.
    ...
    For more information, see [Update the status of a test case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/test-management/t_UpdateTheStatusOfATestCase.md).


**Parent Topic:**[Performing tests and updating the test status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/test-management/c_Tester.md)
