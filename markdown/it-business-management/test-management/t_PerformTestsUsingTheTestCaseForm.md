...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/test-management/t\_PerformTestsUsingTheTestCaseForm.html
release: australia
...
12. After all of the tests are complete, update the test case status.
    ...
    For more information, see [Update the status of a test case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/test-management/t_UpdateTheStatusOfATestCase.md).
