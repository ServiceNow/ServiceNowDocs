...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/agile-development/steps-prior-conversion.html
release: yokohama
...
1.  Find out the sprints assigned to the team across all a release.
    ...
    **Note:** Use this step to verify whether the assignment group is updated successfully across all the sprints.
    ...
    \[Omitted image "teams-sprints.png"\] Alt text: Sprints assigned to the team across all a release.
...
2.  Find out the stories that are associated with the sprints of the team being converted.
    ...
    **Note:** Use this step to verify that the assignment group is updated successfully across all stories.
    ...
    \[Omitted image "teams-sprints1.png"\] Alt text: List of all stories belonging to sprints of the team being converted


**Parent Topic:**[Convert Agile Development 1.0 teams to Agile Development 2.0 groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/agile-development/convert-teams-groups.md)
