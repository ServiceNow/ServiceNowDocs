...
-   **[Create a release in Agile Development 2.0](../task/create-a-release.md)**  
...
-   **[Create a theme in Agile Development 2.0](../task/create-a-theme.md)**  
Create a theme in Agile Development 2.0 to group stories of different products together for an abstract goal.
-   **[Create a product in Agile Development 2.0](../task/create-a-product.md)**  
...
-   **[Assignment groups in Agile Development 2.0](manage-groups-agile-dev.md)**  
Learn the requirements to create and manage your assignment groups in Agile Development 2.0.
-   **[Create an epic in Agile Development 2.0](../task/create-an-epic.md)**  
...
-   **[Generate acceptance criteria for stories using Now Assist for Strategic Portfolio Management \(SPM\)](../task/generate-acceptance-criteria-for-stories.md)**  
...
-   **[Create a scrum task for Agile Development 2.0 stories](../task/create-a-scrum-task.md)**  
...
-   **[Create a personalized backlog in Agile Development 2.0](../../sdlc-scrum/task/create-a-backlog.md)**  
Create filters to define which stories appear in your backlog in Agile Development 2.0.
-   **[Manage your product backlog in Agile Development 2.0](../../sdlc-scrum/task/manage-maintain-backlog.md)**  
...
-   **[Plan your sprint activities in Agile Development 2.0](../../sdlc-scrum/task/plan-sprint-activities.md)**  
...
-   **[Create sprints in bulk in Agile Development 2.0](../../sdlc-scrum/task/create-agile-development-2-sprint-from-assignment-group.md)**  
Create multiple sprints at once for one or more Agile Development 2.0 assignment groups to save time.
-   **[Track progress of stories for a sprint in Agile Development 2.0](../../sdlc-scrum/task/agile-sprint-story-board.md)**  
...
-   **[Track progress of scrum tasks for a sprint in Agile Development 2.0](../../sdlc-scrum/task/agile-sprint-board.md)**  
...
-   **[Run tests for a story in Agile Development 2.0](../../sdlc-scrum/task/run-test-plan-within-agile.md)**  
...
-   **[View the test results for a story in Agile Development 2.0](../../sdlc-scrum/task/view-test-result-form.md)**  
...
-   **[Report a defect in Agile Development 2.0](../task/create-defect-report.md)**  
Track issues associated to your product or feature by reporting defects in Agile Development 2.0.
-   **[Create an enhancement request in Agile Development 2.0](../task/create-enhancement-request.md)**  
...
-   **[Set up a triage board in Agile Development 2.0](../../sdlc-scrum/task/setup-triage-board.md)**  
...
-   **[Triage items and add them to a backlog in Agile Development 2.0](../../sdlc-scrum/task/add-triage-board-items-to-backlog-agile-development-2.md)**  
