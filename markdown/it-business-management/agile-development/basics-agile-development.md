---
title: Basics of Agile Development
description: Scrum is one of the popular methodologies of Agile Development, which includes a fixed sprint schedule and regular requirements testing. These activities are performed by common roles such as product owner, scrum master, and group members. Learn about the basics of Agile Development process.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/agile-development/basics-agile-development.html
release: zurich
...
-   **Assignment group or Agile team**
    ...
    In an assignment group, a user is designated as the scrum master, who is responsible to ensure that all the scrum activities are properly performed for a release. For more information, see [Assignment groups in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/manage-groups-agile-dev.md).

-   **[Epic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/create-an-epic.md)**
...
-   **[Story](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/create-a-story.md)**
...
-   **[Scrum task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/create-a-scrum-task.md)**

    Distinct tasks that are required to complete a story. A task might require from 4 through 12 hours to complete.

-   **[Backlog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/manage-maintain-backlog.md)**
...
-   **[Personal Backlog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/create-a-backlog.md)**
...
-   **[Sprints](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/plan-sprint-activities.md)**
...
-   **Release**
    ...
    **Note:** In Agile Development 2.0, ensure that you create a product before you create themes, epics, or stories. You cannot submit these records without attaching them to a product.
...
-   **[Defects](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/defect-reports.md)**

    Defects can be used to report and track the resolution of issues that are noticed during the development of a new feature, or as feedback for existing features. Product owners then review these defects and decides on creating stories for them, which are assigned to the relevant assignment groups.

    Using the Agile Development — Unified Backlog, you can set up a triage board to maintain a centralized backlog for records of different task types, such as defects, stories, and enhancements. For more information, see [Agile Development — Unified Backlog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/unified-backlog.md).

-   **[Enhancements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/enhancement-requests.md)**
...
-   **[Sprint planning](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/plan-sprint-activities.md)**
...
-   **Sprint retrospectives**
    ...
    For details on how Agile Development 2.0 can help you manage your efforts of product development, see [Agile Development process flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/agile-development-process-flow.md).
...
For more information, see [Performance Analytics Content Pack for Agile 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/pa-content-pack-for-agile-2.0.md).
