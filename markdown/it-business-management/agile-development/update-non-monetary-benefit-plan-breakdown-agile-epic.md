...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/agile-development/update-non-monetary-benefit-plan-breakdown-agile-epic.html
release: yokohama
...
breadcrumb: [Create a non-monetary benefit plan for an epic, Create an epic in Agile Development 2.0, Use, Agile Development 2.0, Strategic Portfolio Management]
---
...
6.  In the Non-monetary Benefit Plan Breakdowns related list, click the information icon \(\[Omitted image "informationicon.png"\] Alt text: information icon.\) for a non-monetary benefit plan breakdown.
...
8.  On the Non-monetary Benefit Plan Breakdown form, view and update the enabled fields.
    ...
    |**Fiscal period**|Fiscals generated at the period level. For information on periods, see [fiscal calendars](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/time-configuration/c_FiscalCalendar.md).|
...
**Parent Topic:**[Create a non-monetary benefit plan for an epic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/agile-development/create-non-monetary-benefit-plan-agile-epic.md)
