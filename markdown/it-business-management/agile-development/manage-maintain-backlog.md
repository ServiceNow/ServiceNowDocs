...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/agile-development/manage-maintain-backlog.html
release: zurich
...
2.  From the list at the top-left corner, select the required backlog or create a backlog by using the Create Backlog icon \(\[Omitted image "createbacklog.png"\] Alt text: Create Backlog icon.\).

3.  Update the existing filter criteria of your selected backlog by using the Edit Backlog icon \(\[Omitted image "edit-icon.png"\] Alt text: Edit Backlog icon.\).

4.  Personalize columns in a list by selecting the personalize icon\[Omitted image "personalisecolumns.png"\] Alt text: Update Personalized list icon..
...
7.  Create an epic or a theme directly from the **Backlog** tab.
    ...
    1.  Select the options icon \(\[Omitted image "create-story-arrow.png"\] Alt text: options icon.\) next to the **Create Story** option.

        \[Omitted image "create-story-epic-theme-dropdown.png"\] Alt text: Drop down option to create story, epic, or theme on Agile board
...
8.  Arrange stories within a Backlog page using one of the following options.
    ...
    -   Use the keyboard. For more information, see [Arrange Agile Development 2.0 stories in Agile Board using the keyboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/arrange-stories.md)
    Rearranging stories in the backlog adjusts the ranking of stories in the global\_rank column in the Story \[rm\_story\] table. When you move a story within a backlog, its rank changes relative to the stories within the same backlog. So, the story at the top of the backlog list has a lower rank value and assumes higher priority. The story at the bottom of the backlog list has a higher rank value and assumes lower priority.
...
-   **[Arrange Agile Development 2.0 stories in Agile Board using the keyboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/arrange-stories.md)**  
...
[Agile board in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/agile-board.md)
