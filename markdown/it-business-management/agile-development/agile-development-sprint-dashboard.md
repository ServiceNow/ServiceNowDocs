...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/agile-development/agile-development-sprint-dashboard.html
release: yokohama
...
-   **Committed Points**
    ...
    **Note:** This widget is not visible by default. You can add it from Reports to your dashboard. For more information, see [Edit a responsive dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/performance-analytics/t_EditADashboard.md).
...
For more information, see [Upgrading the layout of Agile 2.0 dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/agile-development/using-solution-library-for-agile-2.0-dashboards.md).
...
Line\[Omitted image "line-icon.png"\] Alt text: Line graph
