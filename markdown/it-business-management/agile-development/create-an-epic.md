...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/agile-development/create-an-epic.html
release: xanadu
...
2.  Select **New**.
    ...
    You can also convert an existing active story into an epic. For details, see [Related links and lists for a Story in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/agile-development/agile-2-0-story-related-lists-related-links.md).
...
-   Add child epics or stories to the epic:
    ...
    -   Add stories to this epic by selecting **New** from the Stories related list. For more information, see [Create a story in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/agile-development/create-a-story.md).
...
-   **[Create a monetary benefit plan for an epic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/agile-development/create-monetary-benefit-plan-agile-epic.md)**  
...
-   **[Create a non-monetary benefit plan for an epic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/agile-development/create-non-monetary-benefit-plan-agile-epic.md)**  
...
-   **[Associate monetary and non-monetary benefit plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/agile-development/associate-benefit-plans-agile-epic.md)**  
...
-   **[Generate labor costs for epics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/agile-development/gen-labor-costs-epics.md)**  
