...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/agile-development/planning-scrum-program-overview.html
release: yokohama
...
-   **Configuration panel**
    ...
    -   **Story dependencies**
        ...
        For information on how to add story dependencies, see [Add dependencies for Agile Development 2.0 stories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/agile-development/Add-dependencies-to-stories.md).

-   **Epic Backlog pane**

    Enables you to see a list of all the epics that are based on the filter criteria in the epic backlog definition. For more information, see [Create an epic backlog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/agile-development/create-epic-backlog.md).
...
-   **Story cards**
    ...
    \[Omitted image "scrum-program-board-story-cards.png"\] Alt text: Legend for story cards.
