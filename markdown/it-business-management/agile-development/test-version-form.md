...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/agile-development/test-version-form.html
release: yokohama
...
-   **Ready**: State of the test when it is not editable. When the test has multiple versions, only one test will be in **Ready** state at any one time
...
Button used to run steps, which is displayed only when the test is in the **Ready** state. See [Run tests for a story in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/agile-development/run-test-plan-within-agile.md).
...
Option to change the order of a test step. Select the icon and drag a step to the required location.
