...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/agile-development/install-work-progress-status-for-agile-teams.html
release: xanadu
...
Install the Work Progress Status for Agile Teams \(sn\_scrum\_progress\) application from ServiceNow Store.
...
1.  Navigate to [ServiceNow® Store](https://store.servicenow.com/sn_appstore_store.do#!/store/application/7e0aa9ed8755101047d84c2c59cb0b1a).
...
If you haven't already, start the \[Scrum\] Daily Data Collection job. For more information, see [Enable daily data collection for Agile 2.0 dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/agile-development/enable-daily-data-collection.md).

**Parent Topic:**[Work Progress Status for Agile Teams](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/agile-development/work-progress-status-for-agile-teams.md)
