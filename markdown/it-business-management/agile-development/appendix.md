...
-   [Data model enhancements from Agile Development 1.0 to Agile Development 2.0](../reference/data-model-enhancements.md)
-   [Usability enhancements from Agile Development 1.0 to Agile Development 2.0](../reference/usability-enhancements.md)
-   [Functionality enhancements from Agile Development 1.0 to Agile Development 2.0](../reference/functionality-enhancements.md)
...
-   **[Review a utility customization for Agile Development 2.0](../task/utility-review-customizations.md#)**  
...
-   **[List of platform artifacts modified after upgrading to Agile Development 2.0](../reference/list-platform-artifacts.md)**  
Post migration, you can review the list of artifacts that are modified in Agile Development 2.0.

**Parent Topic:**[Migration from Agile Development 1.0 to Agile Development 2.0](migrate-agile.md)
