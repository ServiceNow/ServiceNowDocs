...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/agile-development/agile-board.html
release: zurich
...
-   Filter the stories by epic by using the Records by epic section.
    ...
    -   You can show or hide this section by selecting the configuration icon \(\[Omitted image "config-icon.png"\] Alt text: Configuration icon.\).
...
For more information on how to manage your backlog, see [Manage your product backlog in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/manage-maintain-backlog.md).
...
\[Omitted image "sprintplanningscreen.png"\] Alt text: Sprint Planning tab of Agile Board.
...
-   **Story board**
    ...
    For more information, see [Track progress of stories for a sprint in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/agile-sprint-story-board.md).
...
-   **Task board**
    ...
    For more information on tracking your scrum tasks using the board view, see [Track progress of scrum tasks for a sprint in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/agile-sprint-board.md).
...
-   **List**
    ...
    For more information on tracking a sprint's progress using the List view, see [Track sprint progress in Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/agile-development/sprint-tracking-list.md).
...
[Visual Task Boards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_VisualTaskBoards.md)
