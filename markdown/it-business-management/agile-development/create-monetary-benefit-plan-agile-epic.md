...
Non-monetary benefit that is associated to this monetary benefit plan.
    ...
    |Functional currency|Currency that is obtained from the [**glide.system.locale** property](https://www.servicenow.com/docs/access?context=currency-properties&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).|
