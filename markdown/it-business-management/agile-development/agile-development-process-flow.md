...
-   **Define products**
    ...
    See [Create a product in Agile Development 2.0](../task/create-a-product.md).
...
-   **Create epics and stories**
    ...
    See [Create an epic in Agile Development 2.0](../task/create-an-epic.md) and [Create a story in Agile Development 2.0](../task/create-a-story.md).
...
-   **Create releases**
    ...
    After you create a release in Agile Development 2.0, you can associate products, epics, and stories to it. See [Create a release in Agile Development 2.0](../task/create-a-release.md).
...
-   **Create personalized backlogs**
    ...
    See [Create a personalized backlog in Agile Development 2.0](../../sdlc-scrum/task/create-a-backlog.md)
...
-   **Create assignment groups**
    ...
    See [Create an assignment group in Agile Development 2.0](../task/create-an-agile-group.md#)
...
-   **Plan sprint activities**
    ...
    While planning your sprints, you can use the velocity reports as guidance to estimate how much work the group can complete in the next sprint. The [Agile 2.0 Team dashboard](../../../use/dashboards/application-content-packs/agile-development-team-dashboard.md) provides Velocity history report and Velocity by type report.
    ...
    For more information on how to plan your sprints, see [Plan your sprint activities in Agile Development 2.0](../../sdlc-scrum/task/plan-sprint-activities.md).
...
-   **Track sprint progress**
    ...
    You can use the [Agile 2.0 Sprint dashboard](../../../use/dashboards/application-content-packs/agile-development-sprint-dashboard.md) with reports such as burnup and burndown charts to track the progress of the team for a sprint.

    **Tip:**

    If you're running a hybrid or traditional project delivery, you can still use the Agile 2.0 Sprint dashboard to track workflow state transitions using the cumulative flow diagram. For more information about enabling dashboard access, see [Performance Analytics Content Pack for Agile 2.0](../../../use/dashboards/application-content-packs/pa-content-pack-for-agile-2.0.md).
...
-   **Track release progress**
    ...
    You can use the [Agile 2.0 Release dashboard](../../../use/dashboards/application-content-packs/agile-development-release-dashboard.md) with reports such as burnup, burndown, and cycle time charts to track the progress of the team for a release.


**Note:** All Agile 2.0 dashboards are available with [Performance Analytics Content Pack for Agile 2.0](../../../use/dashboards/application-content-packs/pa-content-pack-for-agile-2.0.md).
