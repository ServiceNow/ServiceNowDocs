...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/agile-development/review-work-progress-status-in-agile-2.0.html
release: yokohama
...
\[Omitted image "epic-progress-status.png"\] Alt text: work progress status for epics in Agile 2.0
