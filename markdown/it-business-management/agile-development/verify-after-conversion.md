...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/agile-development/verify-after-conversion.html
release: yokohama
...
2.  Verify that the team has been converted to an assignment group.
    ...
    \[Omitted image "agiledevelopment-groups.png"\] Alt text: Group type is set to Agile Team in the screen shot
...
3.  Verify that the assignment group is updated across all the sprints of the team.
    ...
    \[Omitted image "verify-sprints.png"\] Alt text: Verify that the assignment group is updated across all the sprints of the team.
...
4.  Verify that the stories associated with the sprints of team have been updated with the assignment group.
    ...
    \[Omitted image "verify-stories.png"\] Alt text: List of stories that were noted prior to converting to group
...
5.  Review the sprint burndown for the sprint that was noted prior to conversion.
    ...
    \[Omitted image "sprint-burndown.png"\] Alt text: Review the sprint burndown for the same sprint that was noted prior to conversion \[Omitted image "sprint-burndown-chart.png"\] Alt text: Burndown chart prior to conversion \[Omitted image "sprint-burndown-chartafter.png"\] Alt text: Burndown chart progress displaying the story completed after conversion
...
6.  Once the story is complete, the release burndown must also be updated correctly.
    ...
    \[Omitted image "burndownchart-release2.png"\] Alt text: Burndown is updated correctly for the current release \[Omitted image "agiledevelopment-scrumreleases.png"\] Alt text: How to navigate to a release \[Omitted image "agiledevelopment-releaseburndown.png"\] Alt text: Release burndown chart after conversion when one of the stories is completed
...
7.  For Group Velocity:
    ...
    \[Omitted image "agiledevelopment-groups.png"\] Alt text: How to navigate to groups

    \[Omitted image "agiledevelopment-groupvelocity.png"\] Alt text: Use the Group velocity related link \[Omitted image "velocitychart-agile.png"\] Alt text: View the group velocity chart
