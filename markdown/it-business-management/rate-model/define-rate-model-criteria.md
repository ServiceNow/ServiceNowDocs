...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/rate-model/define-rate-model-criteria.html
release: xanadu
product: Rate Model
...
[Create rate lines to define the hourly rates for resources.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/rate-model/create-rate-line.md)
