...
-   [Generate labor costs](../task/gen-labor-costs-prj-wrkspc.md) depending on the resource assignments for the entire scope of the planning item broken down by the financial attributes configured for your organization. For more information on the planning attributes for attribute-based mapping, see [Planning attributes](../../project-management/concept/planning-attributes.md).
