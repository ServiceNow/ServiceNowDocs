...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-workspace/financial-planning-in-pw.html
release: yokohama
...
-   Create a detailed breakdown of the planned costs [using the financials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-workspace/using-financials-prj-wrkspc.md).
-   [Add, edit, or delete cost plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-workspace/create-cost-plan-prj-wrkspc.md) from the side panel.
...
-   Get a better comprehensive solution by viewing the Forecast \(previously EAC - Estimate at Completion\), Remaining Estimates \(previously ETC - Estimate to Completion\). These show Actuals of each cost plan for the total time scope and the yearly breakdowns.
...
-   [Generate labor costs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-workspace/gen-labor-costs-prj-wrkspc.md) depending on the resource assignments for the entire scope of the planning item broken down by the financial attributes configured for your organization. For more information on the planning attributes for attribute-based mapping, see [Using the Planning attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/planning-attributes.md).
-   [Add or edit expense lines](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-workspace/create-expense-line-prj-wrkspc.md) against the cost plans from the side panel with the associated cost plan details pre-populated.
...
-   Compare the latest costs \(actual expenses for past fiscal periods and planned costs for current and future fiscal periods\) with the initial forecasted planned costs. To do so, create a financial baseline and use the compare baselines capability.
...
-   The pane gives you a tabulated view of the cost plan attributes . These include Name, Cost type, Expense type, Stat fiscal period, End fiscal period, Total planned cost, Employee type, and Role. You can customize these fields. For more information, see [Customize the left pane view for financials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/scenario-planning-in-spw/customize-fin-left-pane.md).
...
**Parent Topic:**[Exploring Project Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-workspace/exploring-project-workspace.md)
