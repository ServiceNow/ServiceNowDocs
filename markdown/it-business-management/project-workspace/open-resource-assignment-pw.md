...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/project-workspace/open-resource-assignment-pw.html
release: zurich
...
# Open a resource assignment from Project Workspace
...
5.  From the resource assignment pane, select the row context menu \(\[Omitted image "icon-row-context-menu.png"\] Alt text: Row context menu.\) of resource assignment record and then select **Open resource assignment**.

    The resource assignment record opens in the side panel, displaying all details for the selected assignment.
