...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-workspace/export-project-status-report-to-powerpoint-from-project-workspace.html
release: yokohama
...
3.  On the Export status report form, fill in the fields for an existing project.
    ...
    For field information, see [Export status report form on Project Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-workspace/export-status-report-form-project-workspace.md).
...
8.  On the Status Report form, fill in the fields.
    ...
    For field information, see [Create a project status report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/project-management/t_CreateAProjectStatusReport.md).
