---
title: Export a project status report to Microsoft PowerPoint from Project Workspace
description: Generate a status report of your project and export it as a Microsoft PowerPoint file from Project Workspace. You can use this file to present the project status to stakeholders or to collaborate with them over risks and next steps. Save time by generating a Microsoft PowerPoint file with the latest information and avoid copying information into slides.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-workspace/export-project-status-report-to-powerpoint-from-project-workspace.html
release: xanadu
...
-   Install the Export to PowerPoint for Strategic Portfolio Management application from ServiceNow store. For more information, see [Install Export to PowerPoint for Strategic Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/export-to-powerpoint-for-application-portfolio-management/install-export-to-ppt.md).
-   Create and upload a Microsoft PowerPoint template to apply to your status report. For more information on how to create and upload a template, see [Create a Microsoft PowerPoint template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/export-to-powerpoint-for-application-portfolio-management/create-ppt-template.md) and [Upload your Microsoft PowerPoint template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/export-to-powerpoint-for-application-portfolio-management/upload-ppt-template.md) respectively.
...
Create a status report or use an existing status report to download it as a Microsoft PowerPoint file.
...
1.  Open a project from the planning page of Project Workspace.
    ...
    For information on how to navigate to the planning page, see [Access the new Project Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-workspace/access-new-project-workspace.md).
...
3.  On the Export status report form, fill in the fields for an existing project.
    ...
    For field information, see [Export status report form on Project Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-workspace/export-status-report-form-project-workspace.md).

4.  Select **Export**.

5.  When prompted, select the desired location, and save the file.

6.  On the Export status report form, create a status report for a project by clicking the **Please create a status report to be able to export** link.

    \[Omitted image "export-status-report.png"\] Alt text: Export status report window on project workspace

7.  On the **Status Report** Tab, create a status report by clicking **Create New**.

8.  On the Status Report form, fill in the fields.

    For field information, see [Create a project status report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-management/t_CreateAProjectStatusReport.md).

9.  Select **Submit**.

10. Click the Export to PowerPoint icon \(\[Omitted image "export-to-powerpoint-icon.png"\] Alt text: Export to PowerPoint icon\).
