...
You can use the **Planning** tab in project workspace to displays the selected project in [project workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/project-management/c_ProjectWorkbench.md).
