...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/it-business-management/project-workspace/install-now-assist-spm-plugin.html
release: zurich
...
1.  To get started with AI, you must install at least one AI application on your instance.
...
5.  Check out the [AI Journey Checklist for more information](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/configuring-now-assist.md).

## Procedure

1.  Navigate to **All** &gt; **AI Admin Hub**.

2.  In the **Settings** tab, select **Plugins**.

    Plugins appear as cards. Review all AI plugins on the **Available for you** tab. Plugins that you have already installed appear on the **Installed** tab.
