...
3.  Create an employee profile.
    ...
    For more information, see [Activate Employee Profile](https://www.servicenow.com/docs/access?context=activate-employee-profile&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).
