...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-workspace/enable-fin-budget-pws.html
release: xanadu
...
-   For new customers accessing financials in Next Experience, this property is enabled by default.
-   Role required: admin
...
2.  Filter the Name column to locate and open **sn\_invst\_pln.enable\_budget\_allocation\_v2** property.
...
-   **[Configure budget attribute at instance-level to allocate budget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-workspace/config-budget-allocation-attribute-pws.md)**  
...
**Parent Topic:**[Configure financials for Project Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-workspace/config-fin-pws.md)
