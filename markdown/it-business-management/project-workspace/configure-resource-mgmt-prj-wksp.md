...
-   Ensure you have enabled attributes for Resource Management. For more information, see [Planning attributes](../../project-management/concept/planning-attributes.md).
