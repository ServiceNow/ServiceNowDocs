...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-workspace/configure-resource-mgmt-prj-wksp.html
release: xanadu
...
-   [Install Project Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-workspace/install-project-workspace.md).
-   Ensure you’ve activated the PPM Standard plugin \(com.snc.financial\_planning\_pmo\).
-   Ensure you have enabled attributes for Resource Management. For more information, see [Planning attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-management/planning-attributes.md).
