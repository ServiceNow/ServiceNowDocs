...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-workspace/fin-edit-monetary-benefit-plan-pws.html
release: xanadu
...
2.  Select the **Monetary Benefit Plans** related list.

3.  Select the name of a required benefit plan.

4.  In the Details tab, edit the required fields and select **Save**.
