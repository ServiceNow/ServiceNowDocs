...
-   **[Update a resource assignment from Project Workspace](../task/update-resource-assignment-pw.md)**  
...
-   **[Manage resources using resource board](../task/manage-resource-assignment-pw.md)**  
