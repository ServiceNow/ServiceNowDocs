...
|Generate a summary of selected text in Docs using Now Assist.|[Generate the summary for selected or complete content with Project doc summarization skill in Project Workspace](../task/summarize-docs-genai-skill-pw.md)|
|Generate and schedule project summary emails for your projects.|[Schedule the project summary emails with Email project summary skill](../task/email-project-summary-pw.md)|
...
|Generate and customize status reports to provide an up-to-date overview of a project's progress, including key metrics such as health, schedule, and resource usage, using either a new report or an existing template.|[Create a status report in Project Workspace](../task/create-a-status-report-in-project-workspace.md)|
