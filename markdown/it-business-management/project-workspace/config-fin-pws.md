...
3.  Enable the budget allocation for projects.
    ...
    For more information, see [Enable financial budget allocation for projects in Project Workspace](../task/enable-fin-budget-pws.md).

4.  Define the budget allocation attribute to allocate budget by cost type or expense type.

    For more information, see [Configure budget attribute at instance-level to allocate budget](../task/config-budget-allocation-attribute-pws.md).

5.  Enable the expense type attribute for resource assignments to capture relevant expenses for the work.

    For more information, see [Enable expense type on resource assignments](../task/expense-type-resource-assignments.md).
...
7.  Customize the left pane in the financials screen to match the requirements of your organization.
    ...
    For more information, see [Customize the left pane view for financials](../task/customize-fin-left-pane-prj-wrkspc.md).

8.  Customize the Create cost plan form fields to match the requirements of your organization.

    For more information, see [Customise cost plan form](../task/customise-cost-plan-form-fin-prj-wrkspc.md).

9.  Customize the default expense types to manage cost plans for your projects and demands.

    For more information, see [Change the default expense type for projects](../../portfolio-planning/task/config-expense-type-fin-pp.md).

10. Activate and define scheduled job to create financial baselines for your planning items.

    For more information, see [Activate a scheduled job to create financial baselines for your projects](../../portfolio-planning/task/baseline-schedule-job-pp.md).
...
11. Activate and define a scheduled job to generate labor costs for your projects based on the attribute-based resource assignments.
    ...
    For more information, see [Activate a scheduled job to generate labor costs for your projects](../../portfolio-planning/task/gen-labor-costs-scheduled-job-pp.md).


-   **[Enable monetary benefit plans for projects](../task/enable-benefitplans-pws-fin.md)**  
Enable the benefit plans property to create and manage benefit plans for planning items.
-   **[Enable financial budget allocation for projects in Project Workspace](../task/enable-fin-budget-pws.md)**  
...
-   **[Enable expense type on resource assignments](../task/expense-type-resource-assignments.md)**  
...
-   **[Configure a widget and associate it with project](../task/config-fin-widgets-pws.md)**  
Enable and associate a widget to view financial summary of your projects at high-level.
-   **[Customize the left pane view for financials](../task/customize-fin-left-pane-prj-wrkspc.md)**  
Customize the left pane for financials to view custom field information.
-   **[Customise cost plan form](../task/customise-cost-plan-form-fin-prj-wrkspc.md)**  
Manage the fields required on the new cost plan form as per your organization needs.
-   **[Change the default expense type for your projects](../task/config-fin-expense-type-pws.md)**  
Configure the default expense type to create or edit cost plans for your projects.
-   **[Create a custom prefix for baseline](../task/config-fin-baseline-prefix-pws.md)**  
Modify the prefix to customize the name of the baselines for your projects.
-   **[Activate a scheduled job to migrate budget of your projects](../task/fin-migrate-budget-scheduled-job-pws.md)**  
