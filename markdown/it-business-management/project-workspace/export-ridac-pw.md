...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/it-business-management/project-workspace/export-ridac-pw.html
release: australia
...
The RIDAC export allows you to export RIDAC data into an external file for backup, reporting, analysis, data sharing. Create RIDAC data or use an existing RIDAC data to download it in the required file format. You can choose to export the RIDAC data in Excel or CSV file format.
...
4.  Select the **File type** and select **Export** to export the RIDAC records of that project.
...
[Associate existing RIDAC records for a project in Project Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-workspace/associate-ridac-project-workspace.md)

[Convert one RIDAC record to another for a project in Project Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/it-business-management/project-workspace/convert-ridac-project-workspace.md)
