...
<table id="choicetable_oq5_fqw_1dc"><thead><tr><th align="left" id="d321756e104">

Gen AI actions

</th><th align="left" id="d321756e107">

Procedure

</th></tr></thead><tbody><tr><td id="d321756e113">
...
<table id="choicetable_nly_n5h_1dc"><thead><tr><th align="left" id="d321756e215">

Option

</th><th align="left" id="d321756e218">

Procedure

</th></tr></thead><tbody><tr><td id="d321756e224">
...
Select the copy to clipboard icon \(\[Omitted image "icon-copy-spm.png"\] Alt text: Copy to clipboard icon.\) to use the summary information for another purpose, such as pasting it into an email.
    ...
    Only an administrator can activate the generative AI skills. For more information, see [Configure Now Assist Admin features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/it-business-management/now-assist-for-strategic-portfolio-management-spm/configuring-na-spm.md).
