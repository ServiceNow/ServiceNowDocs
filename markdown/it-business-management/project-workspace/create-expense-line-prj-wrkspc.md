...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-workspace/create-expense-line-prj-wrkspc.html
release: yokohama
...
<table id="choicetable_n25_2rm_fyb"><thead><tr><th align="left" id="d52437e82">

Choice

</th><th align="left" id="d52437e85">

Description

</th></tr></thead><tbody><tr><td id="d52437e91">
...
**Note:** Use this option to record and calculate any unplanned expenses.
    ...
    For a description of the field names, see [Create expense line form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/it-business-management/scenario-planning-in-spw/create-exp-line-form-spw.md).
