...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-workspace/create-expense-line-prj-wrkspc.html
release: xanadu
...
<table id="choicetable_n25_2rm_fyb"><thead><tr><th align="left" id="d51265e82">

Choice

</th><th align="left" id="d51265e85">

Description

</th></tr></thead><tbody><tr><td id="d51265e91">
...
**Note:** Use this option to record and calculate any unplanned expenses.
    ...
    For a description of the field names, see [Create expense line form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/scenario-planning-in-spw/create-exp-line-form-spw.md).
