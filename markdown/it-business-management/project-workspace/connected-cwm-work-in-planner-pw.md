...
When CWM is active in your instance, CWM tasks and stories linked to your project tasks appear inline as child rows. They display under each project task on the planning page.

Project managers can see execution activity from the team without leaving Project Workspace.
