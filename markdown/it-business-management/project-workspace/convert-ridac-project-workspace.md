...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/it-business-management/project-workspace/convert-ridac-project-workspace.html
release: yokohama
...
4.  Select **Convert to RIDAC**.
    ...
    \[Omitted image "convert-to-RIDAC-list.png"\] Alt text: Convert to RIDAC in Project Workspace
