...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-workspace/associate-widget-to-project.html
release: xanadu
...
breadcrumb: [Configure a widget for project financial metrics, View forecasts and manage financial plans for a project in classic Project Workspace, Project workspace classic - Legacy, Project Portfolio Management, Strategic Portfolio Management]
---
...
You should [configure a widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-workspace/configure-widget-project-financials.md) before you can associate it with the Project \[pm\_project\] table.
...
**Parent Topic:**[Configure a widget for project financial metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-workspace/configure-widget-project-financials.md)
