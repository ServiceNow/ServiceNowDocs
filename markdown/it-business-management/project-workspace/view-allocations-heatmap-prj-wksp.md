...
5.  From the resource allocation window, view and track the assigned **Project**, **Task**, **Resource status**, **Task effort**, **Utilization**, **Remaining capacity**, and **Project Owner** of a resource.
...
6.  Send a direct message to the project owner on Microsoft Teams by selecting the **Project Owner** field.
    ...
    **Note:** The **Project Owner** can only be selected if your ServiceNow® instance is integrated with your organization's Microsoft Teams. Resource assignments on demands are visible in the allocation window both before and after they become projects.
