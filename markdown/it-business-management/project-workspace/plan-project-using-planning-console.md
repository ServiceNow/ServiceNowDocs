...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-workspace/plan-project-using-planning-console.html
release: xanadu
...
Role required: it\_project\_user or it\_project\_manager

## About this task

The **Planning** tab in project workspace displays the selected project in [planning console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-management/c_TheProjectPlanningConsole.md).
...
3.  Plan the project using planning console features such as WBS hierarchy and Gantt chart.
    ...
    You can also perform several [tasks on the planning console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/project-management/r_PlanningConsoleTasks.md) that you can perform on lists and forms, such as creating project tasks.
