...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-workspace/manage-resources-for-project.html
release: xanadu
...
2.  Click the **Resources** tab.
    ...
    -   To [create a resource plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/t_CreateResourcePlanProjectTask.md), click **New**.
    ...
    For more information on different options available on the **Actions** menu, see the [Manage resources by using the allocation workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/it-business-management/resource-management/manage-resources-allocation-workbench.md) topic.
