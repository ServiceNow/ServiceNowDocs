...
2.  Click the **Resources** tab.
    ...
    For more information on different options available on the **Actions** menu, see the [Manage resources by using the allocation workbench](../../resource-management/task/manage-resources-allocation-workbench.md) topic.
