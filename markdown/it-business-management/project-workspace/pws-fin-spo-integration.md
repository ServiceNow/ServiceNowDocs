...
2.  Place the request for an asset.
    ...
    For more details on how to request a product using Source-to-Pay Common Architecture, see Order a product with quick checkout.
