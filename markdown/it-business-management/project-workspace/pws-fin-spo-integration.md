...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/it-business-management/project-workspace/pws-fin-spo-integration.html
release: xanadu
...
2.  Place the request for an asset.
    ...
    For more details on how to request a product using Source-to-Pay Common Architecture, see [Order a product with quick checkout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/source-to-pay-operations/sourcing-and-procurement-operations/order-a-product.md).
