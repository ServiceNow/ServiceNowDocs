---
title: Combined Configurable Workspace release notes for upgrades from Yokohama to Brazil
description: Consolidated page of all release notes for Configurable Workspace from Yokohama to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-yokohama-brazil/brazil-yokohama-configurableworkspace-release-notes.html
release: brazil
...
# Combined Configurable Workspace release notes for upgrades from Yokohama to Brazil

Consolidated page of all release notes for Configurable Workspace from Yokohama to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Configurable Workspace release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Configurable Workspace to Brazil
...
Between your current release family and Brazil, new features were introduced for Configurable Workspace.
...
-   **[UI interactions for declarative actions](https://www.servicenow.com/docs/access?context=configure-da-ui-interactions&family=australia&ft:locale=en-US)**
...
Between your current release family and Brazil, some changes were made to existing Configurable Workspace features.
...
-   **[AI gradients for declarative actions](https://www.servicenow.com/docs/access?context=creating-declarative-actions&family=brazil&ft:locale=en-US)**

Customize declarative action buttons with AI gradients that visually indicate when users are interacting with AI-powered experiences.

-   **[Dynamic schema field type for forms](https://www.servicenow.com/docs/access?context=working-with-dynamic-schema&family=brazil&ft:locale=en-US)**

Configure the dynamic schema field type for forms.

-   **[Form template semantic search](https://www.servicenow.com/docs/access?context=configure-form-template-search&family=brazil&ft:locale=en-US)**

Configure AI-powered semantic search for form templates.

-   **[Color labels for highlighted values](https://www.servicenow.com/docs/access?context=use-list-highlighted-value-colors&family=brazil&ft:locale=en-US)**

Display color information alongside highlighted values in lists.

-   **[List row context menu actions](https://www.servicenow.com/docs/access?context=configure-list-row-context-menu&family=brazil&ft:locale=en-US)**

Configure context menu actions for list rows.

-   **[Group similar items](https://www.servicenow.com/docs/access?context=use-group-similar-items&family=brazil&ft:locale=en-US)**

Use AI to group similar records in a list based on their short descriptions and generate a group summary.

-   **[AI indicators for lists](https://www.servicenow.com/docs/access?context=configure-list-ai-indicators&family=brazil&ft:locale=en-US)**

Use a system property to disable AI indicators for lists.

-   **[Predicate builder component enhancements in UI Builder](https://developer.servicenow.com/dev.do#!/reference/next-experience/brazil/now-components/now-predicate-builder/uib-setup)**

Configure these enhancements to the Predicate Builder component in UI Builder:

    -   Hide the global OR operator in the predicate builder.
    -   All Core UI fields are supported in the predicate builder.

</td></tr></tbody>
</table>## Removed

Between your current release family and Brazil, some Configurable Workspace features or functionality were removed.
...
Between your current release family and Brazil, some Configurable Workspace features or functionality were deprecated.
...
Review information on how to activate Configurable Workspace.
...
If any additional requirements were introduced or changed for Configurable Workspace we have noted them here.
...
If any specific browser requirements were introduced or changed for Configurable Workspace we have noted them here.
...
Configurable Workspace doesn’t support mobile devices, Internet Explorer, or Microsoft Edge. Instead, use Microsoft Edge, Chromium or one of the other supported browsers that are listed in [Browser support](https://www.servicenow.com/docs/access?context=browser-support&family=australia&ft:locale=en-US).
...
Configurable Workspace doesn’t support mobile devices, Internet Explorer, or Microsoft Edge. Instead, use Microsoft Edge, Chromium or one of the other supported browsers that are listed in [Browser support](https://www.servicenow.com/docs/r/IDeOjpA1hzonPLWG~inEpg/R~HKN5suDllHe_wr4CWNYA).


</td></tr></tbody>
</table>## Accessibility information

Review details on accessibility information for Configurable Workspace, such as specific requirements or compliance levels.
...
-   **Accessibility information**
    -   **[Screen Summarization](https://www.servicenow.com/docs/access?context=use-screen-summarization&family=australia&ft:locale=en-US)**
...
If there are specific localization considerations for Configurable Workspace we have noted them here.
...
If there are specific highlight considerations for Configurable Workspace we have noted them here.
...
-   Implement declarative actions without assuming page ownership, and override attributes without altering the base action.
 ...
 See [Configurable Workspace UI](https://www.servicenow.com/docs/access?context=workspace-landing-page&family=australia&ft:locale=en-US) for more information.
...
-   Capture and edit record information with customizable form fields.
-   Send and receive comments, work notes, and emails.
-   View a history of updates and communications within a record.
-   Attach files and knowledge base articles to a record.
-   Organize and filter lists of records, such as cases, tasks, or incidents.

 See [Configurable Workspace UI](https://www.servicenow.com/docs/access?context=workspace-landing-page&family=brazil&ft:locale=en-US) for more information.
