---
title: Combined Talent profile release notes for upgrades from Yokohama to Brazil
description: Consolidated page of all release notes for Talent profile from Yokohama to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-yokohama-brazil/brazil-yokohama-talentprofile-release-notes.html
release: brazil
...
# Combined Talent profile release notes for upgrades from Yokohama to Brazil

Consolidated page of all release notes for Talent profile from Yokohama to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Talent profile release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Brazil.

**Tip:** If there were no updates for a release notes section in a certain family release, we included a short note for your reference. For example, if a product did not have any updates in Tokyo, the row says "No updates for this release."

## Important information for upgrading Talent profile to Brazil
...
Between your current release family and Brazil, new features were introduced for Talent profile.
...
Between your current release family and Brazil, some changes were made to existing Talent profile features.
...
Between your current release family and Brazil, some Talent profile features or functionality were removed.
...
Between your current release family and Brazil, some Talent profile features or functionality were deprecated.
...
Review information on how to activate Talent profile.
...
**Important:** Talent profile is available in the ServiceNow Store. For details, see the "Activation information" section of these release notes.
...
If any additional requirements were introduced or changed for Talent profile we have noted them here.
...
If any specific browser requirements were introduced or changed for Talent profile we have noted them here.
...
Review details on accessibility information for Talent profile, such as specific requirements or compliance levels.
...
If there are specific localization considerations for Talent profile we have noted them here.
...
If there are specific highlight considerations for Talent profile we have noted them here.
