---
title: Combined Build Agent and Autonomous Engineer release notes for upgrades from Yokohama to Brazil
description: Consolidated page of all release notes for Build Agent and Autonomous Engineer from Yokohama to Brazil.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/delta-yokohama-brazil/brazil-yokohama-buildagentandautonomousengineer-release-notes.html
release: brazil
...
# Combined Build Agent and Autonomous Engineer release notes for upgrades from Yokohama to Brazil

Consolidated page of all release notes for Build Agent and Autonomous Engineer from Yokohama to Brazil.

## How to use this page

To help you prepare for your upgrade, we have combined the cross-family Build Agent and Autonomous Engineer release notes onto one page. Read this summary of the new features, changes, and updated information for your product from Yokohama to Brazil.
...
-   **[Test suite authoring and execution](https://www.servicenow.com/docs/access?context=build-agent-testing&family=zurich&ft:locale=en-US)**
...
-   **[ATF list step support](https://www.servicenow.com/docs/access?context=build-agent-testing&family=zurich&ft:locale=en-US)**
...
-   **[Support for Box MCP server](https://www.servicenow.com/docs/access?context=accelerate-design-to-development-with-figma-mcp-server&family=zurich&ft:locale=en-US)**

Build Agent now supports integrations with Box MCP server.

-   **[Domain separation for ServiceNow Fluent](https://www.servicenow.com/docs/access?context=ba-domain-separation&family=zurich&ft:locale=en-US)**
...
The following metadata are now supported in Build Agent:
    ...
    -   UI style
-   **[Right-click to configure ServiceNow AI Platform metadata](https://www.servicenow.com/docs/access?context=access-build-agent&family=zurich&ft:locale=en-US)**

When you right-click a record or artifact and select **Configure**, the metadata editor now opens in ServiceNow Studio.

-   **[Automatic upgrades for Build Agent](https://www.servicenow.com/docs/access?context=install-build-agent&family=zurich&ft:locale=en-US)**
...
Several changes have been made to how you access Build Agent in ServiceNow Studio:
 ...
 -   **[Organized settings with tabs](https://www.servicenow.com/docs/access?context=ba-configure-settings&family=zurich&ft:locale=en-US)**
...
An updated semantic metadata search tool improves performance replaces the previous semantic search tool.
 ...
 -   **[New button prompt to add AI to an app](https://www.servicenow.com/docs/access?context=create-a-new-application-using-build-agent&family=zurich&ft:locale=en-US)**
...
-   **[Open Build Agent from ServiceNow Studio banner](https://www.servicenow.com/docs/access?context=access-build-agent&family=zurich&ft:locale=en-US)**
...
Build Agent handles checkpoints and update sets differently in the following ways:
 ...
 -   **[Generated artifact preview](https://www.servicenow.com/docs/access?context=edit-an-existing-application-using-build-agent&family=zurich&ft:locale=en-US)**
