...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/acct-lifecycle-events/account-lifecycle-product-use-case.html
release: australia
topic_type: concept
...
For more information on customer use cases and how they align to supported use cases, see [Customer Discovery Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/acct-lifecycle-events/account-lifecycle-customer-discovery-hub.md).
