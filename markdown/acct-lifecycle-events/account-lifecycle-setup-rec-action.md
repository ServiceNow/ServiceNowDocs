...
1.  Create a rule in Recommended Actions for Customer Success Management.
    ...
    For more information, see Create a rule in Recommended Actions.

2.  Create a recommendation.

    For more information, see Create a recommendation in Recommended Actions.

3.  Create a resource generator.

    For more information, see Create a resource generator in Recommended Actions.
