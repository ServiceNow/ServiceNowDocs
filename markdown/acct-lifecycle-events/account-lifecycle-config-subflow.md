...
For instructions on creating a subflow, see [Create a flow, subflow, or action in Workflow Studio](https://www.servicenow.com/docs/access?context=create-acl-flowdesigner&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US). After you have created the subflow, follow these steps to add it to the Definition Records table.
