...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/acct-lifecycle-events/account-lifecycle-use-playbook-initiate.html
release: zurich
topic_type: concept
...
This is an optional step. See [Create an engagement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-create-engage.md) for details. Select**Create** to create the engagement and move on to the next stage.
