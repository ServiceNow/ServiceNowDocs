...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/acct-lifecycle-events/account-lifecycle-create-case.html
release: xanadu
topic_type: task
...
3.  Click **New**.
    ...
    The account onboarding playbook is launched. You can configure the various activities and create the account onboarding case. See [Set up the account onboarding playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/acct-lifecycle-events/account-lifecycle-use-playbook.md) for details.
