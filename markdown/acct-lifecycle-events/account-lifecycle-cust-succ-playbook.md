...
description: Customer success agents can use playbooks to define planned and unplanned activities, and renewal processes.
locale: en-US
release: zurich
topic_type: concept
...
Customer success agents can use playbooks to define planned and unplanned activities, and renewal processes.
...
For more details on the playbook layout and components, see [Playbook layout and features](https://www.servicenow.com/docs/access?context=csm-playbook-layout&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US). The following playbooks are available:
