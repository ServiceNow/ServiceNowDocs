...
For more details on the playbook layout and components, see [Playbook layout and features](https://www.servicenow.com/docs/access?context=csm-playbook-layout&version=australia&pubname=australia-customer-service-management&ft:locale=en-US). The following playbooks are available:
