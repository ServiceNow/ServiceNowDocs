...
![Account Events Lifecycle playbook](../image/account-lifecycle-playbook.png)

The playbook visualizes a workflow in a simple, task-oriented view. The workflow for the account onboarding playbook is created using the Process Automation Designer and can be configured based on your requirements. See [Configure the account onboarding playbook using Process Automation Designer](account-lifecycle-pad.md) for details. The playbook is divided into multiple stages or lanes.
