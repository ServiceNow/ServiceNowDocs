...
breadcrumb: [Create a customer play record, Create a customer play, Manage playbooks, Customer success, Configure, Customer Success Management]
---
...
</table>5.  Select **Save** to create a new customer play.
