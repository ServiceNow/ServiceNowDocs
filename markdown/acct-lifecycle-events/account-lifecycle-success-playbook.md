---
title: Customer play playbook
description: Use the customer play playbook as the starting point to define the customer play processes in your organization. This playbook can contain one or more success case tasks with predefined activities.
locale: en-US
release: zurich
topic_type: concept
...
For more details on the playbook layout and the different cards, see [Playbook layout and features](https://www.servicenow.com/docs/access?context=csm-playbook-layout&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US). For instructions on how to create the success case playbook, see [Create a customer play](../task/account-lifecycle-create-success-case-playbook.md).
