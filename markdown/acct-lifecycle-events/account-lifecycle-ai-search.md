...
For more details on how to enable AI search and create search contexts, see [Configuring AI search in Recommended Actions](https://www.servicenow.com/docs/access?context=ra-configuring-ai-search&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
