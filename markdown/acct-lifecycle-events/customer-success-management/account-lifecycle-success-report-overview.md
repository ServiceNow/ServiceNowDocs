...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/acct-lifecycle-events/customer-success-management/account-lifecycle-success-report-overview.html
release: australia
...
The success report dashboard provides a unified view of all engagements in the hierarchy, enhances productivity, reduces friction, and empowers customer success mangers to make data driven decisions effectively. For more details, see [Success report dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/acct-lifecycle-events/customer-success-management/account-lifecycle-success-report.md).

-   **[Success report dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/acct-lifecycle-events/customer-success-management/account-lifecycle-success-report.md)**  
