...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-create-outcome.html
release: yokohama
...
**Note:** The metric values are automatically populated if:
    ...
    -   The context for the data source must be configured to point to the success outcome table. See [Define the data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-define-data-source.md).
    -   The source and the resolving context tables must be correctly configured. See [Set up the context engine mapper](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-define-context-engine-mapper.md).


</td></tr><tr><td colspan="2">

\[Omitted image "account-lifecycle-success-obj-context.png"\] Alt text: Data source context mapping
