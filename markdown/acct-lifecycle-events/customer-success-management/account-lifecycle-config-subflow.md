...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/acct-lifecycle-events/customer-success-management/account-lifecycle-config-subflow.html
release: xanadu
...
breadcrumb: [Create a success play, Configure customer success, Customer success, Account Lifecycle Events]
---
...
For instructions on creating a subflow, see [Create a flow, subflow, or action in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/integrate-applications/automation-center/create-acl-flowdesigner.md). After you have created the subflow, follow these steps to add it to the Definition Records table.
