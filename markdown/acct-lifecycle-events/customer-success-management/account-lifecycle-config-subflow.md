...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-config-subflow.html
release: yokohama
...
breadcrumb: [Create a success play, Configure customer success, Customer success, Customer Success Management]
---
...
For instructions on creating a subflow, see [Create a flow, subflow, or action in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/automation-center/create-acl-flowdesigner.md). After you have created the subflow, follow these steps to add it to the Definition Records table.
