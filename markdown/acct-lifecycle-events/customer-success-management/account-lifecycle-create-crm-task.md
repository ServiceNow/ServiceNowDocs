...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-create-crm-task.html
release: yokohama
...
3.  If you have configured the **Create CRM task** option, you can see it on the Risk and Issue page.
    ...
    See [Integrating with Microsoft Dynamics CRM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-crm-integration.md) for details on configuring this option.

    \[Omitted image "account-lifecycle-crm-create-task-1.png"\] Alt text: MS Dynamics CRM: Create CRM task
...
6.  Navigate to **Customer Success** &gt; **All Risks and Issues** and open a risk record.
    ...
    \[Omitted image "account-lifecycle-crm-create-task-2.png"\] Alt text: CRM Task work notes
