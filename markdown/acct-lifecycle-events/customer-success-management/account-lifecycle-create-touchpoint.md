...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/acct-lifecycle-events/customer-success-management/account-lifecycle-create-touchpoint.html
release: xanadu
...
breadcrumb: [Create an engagement, Configure customer success, Customer success, Account Lifecycle Events]
---
...
2.  Navigate to the **Customer Success** &gt; **All Touchpoints** and click **New**.
...
Select the engagement record to which the touchpoint is related. This is a mandatory field.
...
The channel used for communication. This can be:-   Web
-   Phone
-   Email
-   Chat
-   Social
...
The key customer contact for this touchpoint.
...
The key internal team member handling this touchpoint.
...
The category associated with this touchpoint. This can be:-   General conversation
-   Value and adoption
...
State of the touchpoint. This can be:-   New
-   In progress
-   Paused
-   Canceled
-   Closed
...
Current progress of this touchpoint. This can be:-   Not Started
-   On-Track
-   At Risk
-   Paused
-   Completed
...
Priority of this touchpoint in comparison to others. This can be:-   Critical
-   High
-   Medium
-   Low
-   Very Low
...
Date by which the touchpoint should be completed.
...
The product to which this touchpoint is related. Select the checkbox to indicate if the touchpoint is related to a specific product that has been sold.
...
Enter the subject for this touchpoint. This is a mandatory field.
...
Select the users who should be notified of any updates to the touchpoint.
...
Enter a description for this touchpoint. This is a mandatory field.
...
Any additional information that needs to be provided to the customer.
...
Date on which the touchpoint meeting is to be held.
...
Type of meeting which can be:-   Ad-hoc
-   Weekly status
-   QBR
-   Renewal
