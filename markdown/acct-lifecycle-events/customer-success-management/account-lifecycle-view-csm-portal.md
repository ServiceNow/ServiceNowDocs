...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-view-csm-portal.html
release: yokohama
...
1.  Use the name and password that you created during the registration process to log in to the Customer Service Portal.
    ...
    See [Using the Customer Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/use-the-customer-portal.md) for details.
