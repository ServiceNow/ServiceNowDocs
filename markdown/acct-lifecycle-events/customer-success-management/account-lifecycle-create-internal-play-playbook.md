...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-create-internal-play-playbook.html
release: yokohama
...
4.  In the `Assist` phase, you can perform the following activities:
    ...
    -   Related work: Click **Create task** to create an internal play task. See [Create an internal play task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-create-internal-play-task.md) for a detailed description of this form.
