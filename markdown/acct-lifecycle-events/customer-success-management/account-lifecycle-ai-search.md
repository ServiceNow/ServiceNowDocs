---
title: Using AI search with Recommended Actions
description: Use AI search with Recommended Actions to create contexts and search for relevant records.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-ai-search.html
release: yokohama
...
\[Omitted image "account-lifecycle-rec-action-search.png"\] Alt text: Recommended actions with AI search
...
For more details on how to enable AI search and create search contexts, see [Configuring AI search in Recommended Actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/ra-configuring-ai-search.md).
