...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-setup-risk-defn.html
release: yokohama
...
-   Data source and data context engine mapping must be setup for metric based risk definitions. See [Setup the data context engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-setup-metric-data.md) for details.
...
Select a category for the risk definition. The risk categories displayed here are defined in the [ALE choice record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-ale-choice.md).
