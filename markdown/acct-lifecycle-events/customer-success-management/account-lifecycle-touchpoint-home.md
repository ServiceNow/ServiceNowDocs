...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-touchpoint-home.html
release: yokohama
...
1.  Click **New** to create a new success task for this touchpoint. The Create new success task page is displayed. See [Create a success case task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-create-success-case-task.md) for details.
