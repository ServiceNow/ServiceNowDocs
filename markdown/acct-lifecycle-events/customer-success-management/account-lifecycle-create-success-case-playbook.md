...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-create-success-case-playbook.html
release: yokohama
...
3.  In the `Initiate` phase, you can perform the following activities:
    ...
    -   Enter core information: In this page, enter the details for the success case record and click **Mark Complete** to move to the next activity. See [Create a success case record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-create-success-case.md) for a detailed description of this form.
...
4.  In the `Assist` phase, you can perform the following activities:
    ...
    -   Related work: Click **Create Task** to create a success case task. See [Create a success case task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/acct-lifecycle-events/customer-success-management/account-lifecycle-create-success-case-task.md) for a detailed description of this form.
