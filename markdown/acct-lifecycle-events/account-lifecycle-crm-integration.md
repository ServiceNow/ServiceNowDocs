...
1.  Set up the Microsoft Dynamics CRM spoke. See [Microsoft Dynamics CRM Spoke](https://www.servicenow.com/docs/access?context=microsoft-dynamics-crm-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) for details.
