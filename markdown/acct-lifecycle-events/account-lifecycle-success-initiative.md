...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/acct-lifecycle-events/account-lifecycle-success-initiative.html
release: zurich
topic_type: task
...
The primary success outcome associated with this initiative.
 ...
 To create applicable success outcome, see [Create an applicable success outcome](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-create-applicable-outcome.md).
...
-   Create success play: Select this option to create a success play. See [Create a success play](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-create-success-play.md) for the details.
...
-   **[Create an applicable success outcome](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-create-applicable-outcome.md)**  
Create the applicable success outcomes to support the primary success outcome.
-   **[Close or cancel a success initiative](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-cancel-success-initiative.md)**  
