...
-   Template: Shows the template name if the roadmap was created from a template. See [Define a product adoption roadmap template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/acct-lifecycle-events/account-lifecycle-create-par-roadmap-temp.md) for details.
...
To revert the roadmap to a previous version, see [Revert a product adoption roadmap to a previous version](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/acct-lifecycle-events/account-lifecycle-revert-par-roadmap.md).
