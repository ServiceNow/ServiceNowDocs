...
4.  In the **Define the Action Plan** phase, you can perform the following activities:
    ...
    -   Related work: Select **Create task** to create an internal play task. See [Create an internal play task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/acct-lifecycle-events/account-lifecycle-create-internal-play-task.md) for a detailed description of this form.
...
-   Create internal play tasks to define tasks that should be performed when an internal play is launched. See [Create an internal play task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/acct-lifecycle-events/account-lifecycle-create-internal-play-task.md).
...
-   **[Create an internal play task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/acct-lifecycle-events/account-lifecycle-create-internal-play-task.md)**  
