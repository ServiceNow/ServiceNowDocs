...
-   sn\_acct\_lc.agent
-   One or more Playbooks roles. See [Playbooks roles](https://www.servicenow.com/docs/access?context=process-automation-designer-roles&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US) for details.
