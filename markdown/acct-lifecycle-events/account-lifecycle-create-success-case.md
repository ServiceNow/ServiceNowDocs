...
A customer play monitors external activities of unplanned actions that a provider takes to support a customer touchpoint, stakeholder request, or engagement activity. A customer play may not be associated with an objective or outcome, but can be based on the nature of the customer play and why it was created. A customer play is a form of case type with its own case tasks.
