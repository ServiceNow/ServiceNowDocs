...
-   If a customer account exists, and the account onboarding is being done in a phased manner, you can create one or more account onboarding cases from the **List** view. See [Create an account onboarding case](../task/account-lifecycle-create-case.md) for details.
