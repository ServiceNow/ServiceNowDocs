...
**Note:** Some features in the account onboarding playbook aren’t working correctly. To address this issue, you must install the Playbook Experience 26.1.2 application from the ServiceNow Store. For more details on the issues, see [KB1651378](https://support.servicenow.com/kb?id=kb_article_view&sys_kb_id=79e2c24e4763ca1077748d01426d4319).
