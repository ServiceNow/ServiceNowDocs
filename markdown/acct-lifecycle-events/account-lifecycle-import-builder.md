...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/acct-lifecycle-events/account-lifecycle-import-builder.html
release: xanadu
topic_type: task
