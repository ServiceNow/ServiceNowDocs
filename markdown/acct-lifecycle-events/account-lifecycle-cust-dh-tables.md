---
title: Customer Discovery Hub tables
description: The Customer Discovery Hub includes four tables that capture customer business context: customer business need, customer business challenge, customer business expectation, and customer use case.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/acct-lifecycle-events/account-lifecycle-cust-dh-tables.html
release: australia
...
|Table|Purpose|
|-----|-------|
|Customer business need|Captures the strategic problem a customer wants to solve. Groups related challenges, expectations, and use cases.|
|Customer business challenge|Captures a specific pain point, gap, or enhancement that surfaces a business need. Optionally associated with a business need.|
|Customer business expectation|Captures a measurable success outcome tied to a business need.|
|Customer use case|Captures how a customer plans to use a product to address a business need. Aligns to supported use cases from the product catalog.|

-   **[Customer business need](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/acct-lifecycle-events/account-lifecycle-cust-dh-tables-bn.md)**  
...
-   **[Customer business challenge](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/acct-lifecycle-events/account-lifecycle-cust-dh-tables-bc.md)**  
...
-   **[Customer business expectation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/acct-lifecycle-events/account-lifecycle-cust-dh-tables-be.md)**  
...
-   **[Customer use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/acct-lifecycle-events/account-lifecycle-cust-dh-tables-uc.md)**  
