...
-   Generated automatically by a risk definition when a threshold value is breached or a specific condition is met. See [Create a risk definition](../task/account-lifecycle-setup-risk-defn.md).
