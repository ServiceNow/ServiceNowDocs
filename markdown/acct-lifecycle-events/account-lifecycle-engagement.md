...
An engagement provides a centralized view of items associated with the engagement such as historical health trends, touchpoints, meetings, objectives, outcomes, and much more.
...
-   Create automated triggers: Can be configured to take action automatically based on the conditions of the engagement itself or related data.
...
For more details on the engagement record and its features, see [Engagement home page](account-lifecycle-view-engage.md).
