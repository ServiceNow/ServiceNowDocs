...
1.  To configure the Zoom spoke, follow the steps listed in [Set up the Zoom spoke](https://www.servicenow.com/docs/access?context=setup-zoom&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
...
Name of the webhook registry.
    ...
    For more details on configuring the webhook, see [Set up a bi-directional webhook for Zoom spoke](https://www.servicenow.com/docs/access?context=setup-webhook-zoom-spoke&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
