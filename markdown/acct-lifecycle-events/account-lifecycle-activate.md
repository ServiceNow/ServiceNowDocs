...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/acct-lifecycle-events/account-lifecycle-activate.html
release: australia
topic_type: task
...
-   To enable account onboarding, configure the onboarding playbook. See [Configure the account onboarding playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/acct-lifecycle-events/account-lifecycle-configure.md).
-   To enable customer success, create the choice and definition records. See [Getting started with Customer Success](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/acct-lifecycle-events/account-lifecycle-basic-config.md).
