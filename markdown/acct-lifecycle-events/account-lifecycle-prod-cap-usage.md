...
The Child products tab displays a list of all child products associated with the parent sold product. Click on a child product link to drill down and view the usage data for that product.

The Capabilities tab displays a list of all capabilities associated with the selected sold product. Click on the Name to drill down to the Capability usage page.
