---
title: Product adoption and capability usage
description: Product adoption and capability usage measure how effectively customers are adopting or engaging with a product.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/acct-lifecycle-events/account-lifecycle-product-adopt.html
release: zurich
topic_type: concept
...
You can configure how the product adoption and capability scores are derived and displayed on the Engagement home page and the Product Capability page. See [Configure DCE Visualizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-configure-dce-visual.md) for details.

**Related topics**  


[Product adoption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-view-engage.md)
