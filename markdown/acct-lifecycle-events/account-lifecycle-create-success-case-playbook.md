...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/account-lifecycle-create-success-case-playbook.html
release: yokohama
topic_type: task
...
4.  In the `Assist` phase, you can perform the following activities:
    ...
    -   Related work: Click **Create Task** to create a success case task. See [Create a success case task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/acct-lifecycle-events/account-lifecycle-create-success-case-task.md) for a detailed description of this form.
