...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/acct-lifecycle-events/account-lifecycle-view-success-object.html
release: yokohama
topic_type: concept
...
4.  Select the **Success blueprint** tab and click the \[Omitted image "open-link-right-outline-24.svg"\] Alt text: icon to open the page.
