...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/acct-lifecycle-events/account-lifecycle-view-success-object.html
release: zurich
topic_type: concept
last_updated: "2025-07-31"
reading_time_minutes: 1
breadcrumb: [Engagement home page, Customer success, Use, Customer Success Management]
---
...
3.  Navigate to **Customer Success** &gt; **All Engagements**, and open an engagement.
4.  Select the **Success blueprint** tab and select the \[Omitted image "open-link-right-outline-24.svg"\] Alt text: icon to open the page.
...
-   Success outcomes: The success outcomes associated with the objective. For each objective, you can see the status, value realized, and the number of days left. Value realized is the current value based on the percentage of the target achieved. Select a success outcome to view the success initiatives associated with it. Select **Edit** to drill down to the Success Outcome page.
...
**Parent Topic:**[Engagement home page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/acct-lifecycle-events/account-lifecycle-view-engage.md)
