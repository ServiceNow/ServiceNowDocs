...
-   Max
-   Min
-   Count \(This is applicable only if the Source type is **Table**\). See [Define a table data source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/acct-lifecycle-events/account-lifecycle-define-data-source-table.md) for details.
...
8.  Define color bands as necessary. See the [Set up the color banding table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/acct-lifecycle-events/account-lifecycle-setup-color-banding.md) for details. The color banding is applied to the health metric data displayed in the [Health](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/acct-lifecycle-events/account-lifecycle-view-engage.md) tab on the Engagement home page.
