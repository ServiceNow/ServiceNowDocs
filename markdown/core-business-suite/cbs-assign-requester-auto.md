...
3.  In the Configuration Summary section, navigate to **Employee Experience** &gt; **Requester role**.

4.  Select **Assign to all employees** to assign the CBS requester role to all employees.
