...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/core-business-suite/request-emp-rest.html
release: australia
topic_type: task
...
2.  In the **Help topics** widget, go to the topic card as require, and select a request form.
    ...
    -   **Finance**
    -   **Procurement**
    You can raise general, payroll, and benefits requests with the HR department on CBS. For more information, see [Raise HR requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/core-business-suite/request-emp-cbs.md).

    For more information on configuring the Help topic widget display, see [Configure instance options for Help topics widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/core-business-suite/instance-option-helpt.md).
