...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/core-business-suite/cbs-run-scheduled-jobs.html
release: yokohama
topic_type: task
...
5.  Set up an Employee Center portal with a new Core Business Suite home page setup, Advanced Portal Navigation \(APN\), employee profiles, and quick links by running the **Setup Core Business Suite for Employee Center** scheduled job.
    ...
    For information about Core Business Suite home page setup, Advanced Portal Navigation \(APN\), employee profiles, and quick links, see [Exploring employee support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/core-business-suite/exploring-emp-home.md).
