...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/core-business-suite/request-emp-cbs.html
release: xanadu
topic_type: task
...
3.  Select any of the following options, fill in the required fields, and select **Submit**.
    ...
    -   **General HR request**
        ...
        -   [HR service catalog management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/hr-service-delivery/hr-service-catalog-management.md).
        -   [Report an issue with your payslip](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/hr-service-delivery/payslips-awd.md).
