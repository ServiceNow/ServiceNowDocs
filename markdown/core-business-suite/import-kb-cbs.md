...
keywords: [import knowledge base, Core Business Suite, knowledge articles, Word documents]
...
Import articles from `.doc` or `.docx` files to quickly populate knowledge bases with existing documentation.
