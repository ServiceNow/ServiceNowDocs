...
For information on configuring the product modules in Now Assist, see [Configure in Now Assist for Setup](https://www.servicenow.com/docs/access?context=ia-config-landing&version=australia&pubname=australia-platform-administration&ft:locale=en-US).
