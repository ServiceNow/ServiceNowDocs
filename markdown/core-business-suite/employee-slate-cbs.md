...
\[Omitted image "employee-slate-cbs.png"\] Alt text: Employee Slate portal showing the conversational interface and service request options.

**Note:** Employee Slate is available Core Business Suite version 3.0.5 onwards.
...
-   [ServiceNow EmployeeWorks Web App](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/employee-service-management/employee-slate-landing-page.md)
