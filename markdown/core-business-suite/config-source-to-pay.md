...
5.  Customize existing intake forms or create new ones to collect Source‑to‑Pay requests.
...
7.  Assign roles to give groups the required access.
    ...
    4.  Select **Update**.
8.  Configure the Source‑to‑Pay email address and select **Save**.
...
10. Add or upload contacts associated with each supplier.
    ...
    2.  On the form, fill in the fields.
        ...
        |Organisation \(Supplier\)|Supplier associated with the contact.|
    ...
    5.  Select **Save**.
    **Note:** Ensure all fields are complete and accurate before uploading.
...
12. After you finish all configuration steps, select **Mark as configured**.
