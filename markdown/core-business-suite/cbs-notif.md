...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/core-business-suite/cbs-notif.html
release: zurich
topic_type: concept
...
For more information on workspace notifications, see [Getting notifications in workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/ui-notifications.md).
...
For more information on email notifications, see [Email Notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/security-management/tisc-email-notifications.md).
