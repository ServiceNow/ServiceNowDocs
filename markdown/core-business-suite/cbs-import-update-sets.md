...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/core-business-suite/cbs-import-update-sets.html
release: yokohama
...
Run the scheduled jobs to configure the Core Business Suite applications. For more information, see [Configure Core Business Suite applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/core-business-suite/cbs-run-scheduled-jobs.md).
