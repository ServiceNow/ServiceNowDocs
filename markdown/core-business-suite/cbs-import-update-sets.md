...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/core-business-suite/cbs-import-update-sets.html
release: xanadu
...
Run the scheduled jobs to configure the Core Business Suite applications. For more information, see [Configure Core Business Suite applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/core-business-suite/cbs-run-scheduled-jobs.md).
