...
By default, AI Search uses the short description, description, site, ICW device, and equipment model entity field values to display the most relevant external sources for your deviation.
