...
The Industrial Connected Workforce Mobile Experience helps operators manage work directly from their mobile devices. It brings together tasks, standards, and knowledge in one place, making it easier to keep production running smoothly and respond quickly to issues.

The Industrial Connected Workforce Mobile Experience enables operators to:

-   Create and complete guided tasks, deviations, and actions
-   Access and link knowledge articles
-   Use AI search to find standards, tasks, and articles
...
[Create an Industrial Guided Task with the Industrial Connected Workforce Mobile Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/industrial-connected-workforce/industrial-connected-workforce-mobile-experience/create-igt-icw-mobile.md)-   Request standards to create guided tasks
...
[Create an action in the Industrial Connected Workforce Mobile application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/industrial-connected-workforce/industrial-connected-workforce-mobile-experience/create-action-mobile.md)-   Automate steps of an industrial process
...
[Create a deviation in the Industrial Connected Workforce Mobile application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/industrial-connected-workforce/industrial-connected-workforce-mobile-experience/create-deviation-mobile.md)-   Report non-conformance
...
[Standards hub in the Industrial Connected Workforce Mobile Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/industrial-connected-workforce/industrial-connected-workforce-mobile-experience/standards-hub-mobile.md)Search through knowledge base articles for assistance

</td></tr></tbody>
</table>## Industrial Connected Workforce Mobile Experience benefits

<table id="table_chx_whz_pcc"><thead><tr><th>
...
-   Create actions, deviations, and breakdowns
-   View tasks assigned to you
-   View area tasks
-   View recently updated articles
-   Select or change the functional location via the pin icon \(\[Omitted image "image.pin-icon-white-background"\] Alt text: Pin icon.\)
...
-   Search for published standards and create tasks to execute them
-   Search for published knowledge articles
-   Rate, leave comments, and browse through related knowledge articles \(articles of the same category\)
...
Task list that provides a clear overview of pending tasks with a clear labeling according to their priority and status

 -   **My Tasks**

Shows active tasks assigned to or created by the user that:

    -   Have a due date that falls within their current shift
    -   Have no due date
    -   Are no more than seven days overdue
-   **Area Tasks**

Shows active tasks in the user's functional location that:
...
Shows active tasks in the user's functional location that are due within the upcoming next seven days, including today. Tasks in this list are sorted by the due date.
...
Shows inactive tasks in the user's functional location that were deactivated within the last seven days. Tasks in this list are sorted by the closed field.
 ...
 \[Omitted image "image.mobile-homepage-latest"\] Alt text: Tasks shown on the ICW Mobile Experience under My Tasks and Area Tasks on the Home page
...
</table>## Empower operators with Industrial Connected Workforce Mobile Experience
...
-   **[Standards hub in the Industrial Connected Workforce Mobile Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/industrial-connected-workforce/industrial-connected-workforce-mobile-experience/standards-hub-mobile.md)**  
...
-   **[AI Search in Industrial Connected Workforce Mobile Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown)**  
