...
9.  On the Set actions form, fill in the fields.
    ...
    For a description of the field values, see [Standard automation task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/industrial-connected-workforce/digital-factory-workspace/standard-task-automation-form.md).
