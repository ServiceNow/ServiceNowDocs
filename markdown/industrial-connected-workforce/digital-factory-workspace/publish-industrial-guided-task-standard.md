...
7.  Create an assessment template for your standard.
    ...
    The Industrial Guided Tasks uses the Smart Assessment Engine for designing the templates for standards. To learn how to create an assessment template, see Add instructions and questions to an assessment template.
