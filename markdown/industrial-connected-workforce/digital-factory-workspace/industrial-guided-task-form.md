...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/industrial-connected-workforce/digital-factory-workspace/industrial-guided-task-form.html
release: australia
...
The date by which the task is to be executed. If not set, it’s calculated based on priority. For more details, see [Due date calculation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/industrial-connected-workforce/digital-factory-workspace/due-date-calculation.md).
