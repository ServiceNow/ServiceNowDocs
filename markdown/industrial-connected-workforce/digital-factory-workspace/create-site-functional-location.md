...
2.  Create a functional location for your site.
    ...
    3.  On the Equipment Model Entity form, enter the details.
        ...
        Make sure that you select [ISA 95 Default Template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/operational-technology/equipment-model-templates.md) for the template and Site for the level.
