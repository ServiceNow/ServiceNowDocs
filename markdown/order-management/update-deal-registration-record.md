...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/update-deal-registration-record.html
release: zurich
topic_type: task
...
6.  If you are an approver, review and approve or reject the deal.
    ...
    3.  Select the three dots menu and select **Approve** or **Reject**.\[Omitted image "image.deal-approve"\] Alt text: Approve or Reject the deal
...
For detailed information about the approval workflow, approval states, and approver responsibilities, see [Deal Registration approvals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/deal-registration-approvals-overview.md).
