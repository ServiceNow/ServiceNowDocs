...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/order-mgt-in-flight-change-order.html
release: yokohama
topic_type: concept
...
To learn more about how to change or cancel an inflight order request, see [Managing inflight order changes and cancellation requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/inflight-order-change-mgt-overview.md).
