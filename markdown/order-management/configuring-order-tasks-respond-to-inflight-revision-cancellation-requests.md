...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/configuring-order-tasks-respond-to-inflight-revision-cancellation-requests.html
release: zurich
topic_type: concept
...
-   [Managing inflight order changes and cancellation requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/inflight-order-change-mgt-overview.md)
...
</table>**Parent Topic:**[Configuring inflight changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/configure-inflight-order-change-mgt.md)
