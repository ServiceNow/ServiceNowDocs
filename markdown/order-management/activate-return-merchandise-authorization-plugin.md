...
|Customer Install Base Management \[com.snc.install\_base\]|Enables you to capture the current state of the install base and establish the relationship to any downstream entities that may impact their functioning.|
...
For more information, see [Return Merchandise Authorization Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/return-merchandise-authorization-case-management-reference.md).
...
[Return Merchandise Authorization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/return-merchandise-authorization.md)
