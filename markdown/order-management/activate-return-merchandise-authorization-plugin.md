...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/activate-return-merchandise-authorization-plugin.html
release: yokohama
topic_type: task
...
For more information, see [Return Merchandise Authorization Case Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/return-merchandise-authorization-case-management-reference.md).
