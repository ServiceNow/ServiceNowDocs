...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/edit-order-mgt-tsq-spoke.html
release: zurich
topic_type: task
...
5.  In the Request adapter field, select the subflow that will communicate with the third-party system to update the customer order and click **Submit**.
    ...
    -   For more information on how to create a spoke, see [Spokes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/spokes.md). As shown in the demo subflow, ensure that the response from the third-party system passed to the Process Qualification Response block.
...
**Parent Topic:**[Service qualification requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/order-mgt-tsq-about.md)
