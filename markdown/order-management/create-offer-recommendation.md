...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/create-offer-recommendation.html
release: yokohama
topic_type: task
