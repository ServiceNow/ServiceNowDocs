...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/create-offer-recommendation.html
release: australia
topic_type: task
