...
4.  Select the invoices that you want to add to the invoice case.
    ...
    2.  On the Add invoices to case window, select the invoices for which you want to create a case and select **Add**.
        ...
        For a description of the Add invoices to case list view, see [Add invoices to case list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/add-invoices-to-case-list.md).
