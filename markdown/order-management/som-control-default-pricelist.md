...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/som-control-default-pricelist.html
release: xanadu
topic_type: task
