...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/configure-order-fulfillment.html
release: zurich
topic_type: concept
...
|Task|Description|
|----|-----------|
|Configure subflows for order fulfillment|Subflows define the task flow for fulfillment agents to fulfill customer orders. You can copy a subflow from the base system and make changes for your business needs. For more information on configuring subflows, see Building Subflows.|
...
|Configure order assignment rules to route tasks to agents, based on their skill sets|For more information on assignment rules, see [Create an assignment rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_AssignmentModuleRule.md).|

-   **[Flow actions for fulfillment subflow definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/order-mgt-flow-actions-fulfillment-subflows.md)**  
...
-   **[Integrate with Field Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/activate-fsm-csm-integration.md)**  
...
-   **[Configure customer product data management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/configure-customer-product-data-management.md)**  
