...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/create-rfq-business-portal.html
release: zurich
topic_type: task
...
3.  Review the cart contents.
    ...
    1.  Select the Cart icon \[Omitted image "icon-shopping-cart-1.png"\] Alt text:.
        ...
        |State|State of the cart. For more information, see [Request for quote \(RFQ\) states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/rfq-states.md).|
