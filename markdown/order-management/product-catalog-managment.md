...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/product-catalog-managment.html
release: australia
topic_type: concept
...
-   Browse and search product offerings by using keywords, descriptions, and industry codes​.
    ...
    Product catalog admins or managers can also [configure AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/configure-ai-search-prod-catalog.md) in the product catalog interface, enabling agents and customers to find relevant product offerings or service specifications by using semantic queries.
