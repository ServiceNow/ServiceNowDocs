...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/install-sales-cart-plugin.html
release: australia
topic_type: task
...
For more information, see [Components installed with Sales Cart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/components-installed-with-sales-cart-plugin.md).
...
A sample logo is applied to the sales cart PDF by default. To customize and add your logo, see [Add a logo to the sales cart PDF](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/add-logo-sales-cart-pdf.md).
