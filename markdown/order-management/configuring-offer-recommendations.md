...
\[Omitted image "prod-recommendations-panel.png"\] Alt text: Recommended product cards for products that agents can cross-sell to customers in the contextual side panel of the CRM Workspace.
...
For details on configuring product recommendations, see [Create a product offering recommendation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/create-offer-recommendation.md).
