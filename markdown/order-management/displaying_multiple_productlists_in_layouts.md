...
To learn how to add additional BOM types to a Save request and to configure BOM items to be written to Salesforce as configuration line items, see [CPQ admin settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/cpq-admin-settings.md).
