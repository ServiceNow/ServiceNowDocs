...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/generating\_documents\_with\_logik\_io\_configuration\_data.html
release: australia
topic_type: concept
...
CPQ does not directly interface with any document generation tools; however, CPQ configuration information can be pushed to Salesforce and used in documents from there. This can be accomplished by enabling **Push Config Data to ServiceNow CPQ Salesforce Object** in the Admin Settings if you have not done so already; this will create the Configuration Field Data and Configuration Line Items objects in Salesforce and generate records containing CPQ configuration data.
