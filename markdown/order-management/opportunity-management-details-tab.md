...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/opportunity-management-details-tab.html
release: xanadu
topic_type: task
...
1.  Select the opportunity that you’re working with from the **Opportunity List** window.

2.  Fill in all the information on the Details tab.

<table id="table_thg_mb5_c1c"><thead><tr><th>
...
</table>3.  Fill in the following fields in the **Pricing** section of the **Details** tab.
...
</table>4.  Select the customer's preferred mode of communication.

    -   Do Not Call
    -   Do Not Email
    -   Do not Share
5.  In the **System Information** section of the Details tab, fill in the required fields with information about when the opportunity was created and by whom and enter any related **Work Notes**.
