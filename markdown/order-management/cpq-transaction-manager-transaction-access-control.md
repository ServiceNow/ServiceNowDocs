...
For more information on the roles that govern quote access, see [Components Installed with Quote Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/components-installed-quote-management.md).
