...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/creating-automated-manual-fallout-records.html
release: yokohama
topic_type: concept
...
To learn more, see [Flow Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/flow-designer.md).
...
2.  From the Configurable Workspace Lists icon \(\[Omitted image "Lists.png"\] Alt text: Lists icon, click **Customer Orders**
...
8.  When you finish updating the order task, or encounter issues preventing its closure, click the options icon \(\[Omitted image "more-options.png"\] Alt text: Options icon\) next to the **Save** button and then click **Create Fallout**\).
