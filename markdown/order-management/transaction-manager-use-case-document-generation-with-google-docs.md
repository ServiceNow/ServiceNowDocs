...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/transaction-manager-use-case-document-generation-with-google-docs.html
release: australia
topic_type: concept
