...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/add-subscription-pricing-to-an-order.html
release: zurich
topic_type: task
...
See [Subscription revenue metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/som-subscription-pricing.md) for more information about how contract pricing works.
...
5.  Select the More Actions icon \[Omitted image "icon-three-dot-menu.png"\] Alt text: and select **Order details**.
...
[Order details page - Dates fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/field-descriptions-customer-orders.md)
