...
If either application is missing from your instance, install it using the Application Manager. For more information, see [Configuring AI capabilities in Sales CRM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/configuring-ai-capabilities-sales-crm.md).
...
[View opportunity scores and insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/view-opty-scores-insights.md)
