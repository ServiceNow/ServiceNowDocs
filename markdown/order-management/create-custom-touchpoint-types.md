...
Several touchpoint types are available by default. To view the available options, see [Create new CRM touchpoint form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/create-crm-touchpoint-form.md).
