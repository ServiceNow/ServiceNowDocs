...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/create-macd-orders.html
release: zurich
topic_type: task
...
9.  For disconnecting, suspending, or resuming products or services, perform the following steps.
    ...
    2.  Enter suspension start and end dates for suspend requests and select **Suspend**.
        ...
        If you do not specify a date, the suspension is effective immediately. For more information, see [Suspend and resume products and services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/order-mgt-suspend-resume-action.md).
