...
|[Product Catalog Search API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/api-reference/product-catalog-search-api.md)|The Product Catalog Search API provides endpoints to search the product catalog and retrieve products that match supplied search parameters, and also catalog items such as eligible product catalog-category hierarchies.|
