...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/sold-product-covered-form.html
release: zurich
...
For information about adding sold products or install base items that are covered, see [Add a sold product or install base item to a service contract](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/add-products-service-contract.md).
...
**Parent Topic:**[Customer Contracts and Entitlements reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/pss-reference.md)
