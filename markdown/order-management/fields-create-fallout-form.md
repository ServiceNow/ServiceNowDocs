...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/fields-create-fallout-form.html
release: australia
...
**Note:** You can also create additional fallout types, as per the requirements of your enterprise. To learn more, see [Create additional fallout types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/configure-fallout-management.md).
