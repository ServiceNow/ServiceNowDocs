...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/cpq-help-message-popups.html
release: australia
topic_type: concept
...
**Note:** To learn how to display a message that appears as the result of a message rule, see [Change how messages are displayed to the end user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/can_i_change_how_messages_are_displayed_to_the_end_user.md).
