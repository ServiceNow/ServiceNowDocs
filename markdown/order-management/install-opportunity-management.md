...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/install-opportunity-management.html
release: zurich
topic_type: task
...
The following items are installed with [Opportunity Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/opportunity-management.md):
...
2.  Find the [Opportunity Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/opportunity-management.md) application \(sn\_opty\_mgmt\) using the filter criteria and search bar.
