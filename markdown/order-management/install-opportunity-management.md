...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/install-opportunity-management.html
release: xanadu
topic_type: task
...
The following items are installed with [Opportunity Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/opportunity-management.md):
...
2.  Find the [Opportunity Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/opportunity-management.md) application \(sn\_opty\_mgmt\) using the filter criteria and search bar.
...
Load the demo data after installing [Opportunity Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/opportunity-management.md).1.  Install [Opportunity Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/opportunity-management.md).
