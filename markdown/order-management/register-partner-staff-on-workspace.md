...
1.  Navigate to the **CRM Workspace** and select the list view.
...
**Parent Topic:**[Create Channel Partner record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/create-channel-partner-record.md)
