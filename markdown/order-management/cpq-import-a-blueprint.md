...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/cpq-import-a-blueprint.html
release: zurich
topic_type: task
...
4.  In the unzipped blueprint folder, open the blueprint.yaml file for editing.
    ...
    \[Omitted image "cpq-blueprints-blueprint-yaml-file.png"\] Alt text: Select blueprintNear the end, a line reads `-id: <oldProduct2Id>`.
...
[Export a blueprint](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/cpq-export-a-blueprint.md)
