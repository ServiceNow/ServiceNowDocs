...
|[Data model for Deal Registration Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/data-model-for-deal-registration-management.md)|Add data in the deal registration tables to maintain and track partner submitted deals and the line items linked to a deal registration.|Experience \(sn\_prm\_dr.deal\_reg\_ui\)|
