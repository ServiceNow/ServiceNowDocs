...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/setting-up-project-oversight.html
release: yokohama
topic_type: concept
...
For more information on adding or changing conditions in decision tables, see [Decision Builder user interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/workflow-studio/decision-builder-user-interface.md).
