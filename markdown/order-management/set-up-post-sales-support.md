...
Create customer accounts**Note:** On the Accounts form, to view the customer contracts, remove the contract-related lists and configure the customer contracts related list.
