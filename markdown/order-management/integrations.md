---
title: Integrating ServiceNow CPQ
description: Learn how ServiceNow CPQ connects with downstream systems and UI frameworks—visualization engines \(CDS, kBridge, Threekit\), eCommerce storefronts \(Shopify, headless\), and Salesforce \(CPQ, B2B Commerce, Base Package\)—to deliver real-time, guided configuration, pricing, and ordering at scale.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/integrations.html
release: zurich
topic_type: concept
...
[Integrating ServiceNow CPQ with visualization tools](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/logik-io-integration-wtih-visualization-tools.md)

[ServiceNow CPQ integration with Salesforce B2B Commerce](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/logik_io_integration_with_salesforce_b2b_commerce.md)

[Request provisioning of an SFDC org with a ServiceNow CPQ environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/cpq-request-provisioning-of-an-sfdc-org-with-a-servicenow-cpq-environment.md)
