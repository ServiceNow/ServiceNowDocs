...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/solution-configuration-limits.html
release: australia
...
|Field types supported for mapping|Number, Text, Boolean, and Picklist only. For the full list, see [Define field mappings for a solution configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/define-field-mappings-sol-config.md) .|
