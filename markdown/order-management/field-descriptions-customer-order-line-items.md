...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/field-descriptions-customer-order-line-items.html
release: australia
...
For service order line item states, see [Service order states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/service-order-mgt-state-values.md).
