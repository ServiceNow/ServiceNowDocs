...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/opportunity-management-export-opportunities.html
release: xanadu
topic_type: task
...
Export a list of all opportunities in a specified file format, such as JSON or Excel, in Opportunity Management and provide it to a customer.
