...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/add-schedule-call-activity.html
release: zurich
topic_type: task
...
10. On the Automation tab, fill in the fields.
    ...
    For a description of the field values, see [Automation form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/sequences-automation-form-fields.md).
