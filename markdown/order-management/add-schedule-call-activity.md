...
8.  On the Add activity screen, search for and select **Customer Engagement Sequences** &gt; **Schedule call**.
    ...
    **Note:** The options available in the activity picker vary by release. For compatibility information, see [Compatibility information for Customer Engagement Sequences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/compatibility-matrix-upgrade-info.md).
...
10. On the Automation tab, fill in the fields.
    ...
    For a description of the field values, see [Automation form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/sequences-automation-form-fields.md).
...
[Start with delay input properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/build-workflows/start-with-delay-properties.md)
