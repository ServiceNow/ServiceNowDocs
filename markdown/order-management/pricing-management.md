...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/pricing-management.html
release: xanadu
topic_type: concept
...
For details on setting up and managing price list features, see [Configuring product pricing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/som-managing-product-pricing.md).

## Sales Agreement price lists

If you're using the Sales Agreement feature, a published sales agreement price list is generated automatically when a sales agent creates a sales agreement from a completed quote. The sales agreement price list reflects the final unit price for each product that is captured as part of the sales agreement. The sales agreement price list is valid for the start and end dates specified for the agreement. To learn more about sales agreements, see [Sales Agreement Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/sales-agreement-mgmt.md).

\[Omitted image "sales-agreement-price-list.png"\] Alt text: Sales Agreement Details tab and Price List Lines tab in CSM Configurable Workspace that show a sales agreement price list and price list lines respectively
...
Your pricing admins or managers create a cost book and add a cost book line to set the unit cost for each product offering. They can also copy a published cost book and its cost book lines to revise costs in the cost book \(update the copy\) or reuse a cost book without having to create a new one. For details on setting up cost books and cost book lines, see [Create and publish a cost book](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/create-cost-books.md) and [Create a cost book line](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/create-cost-book-lines.md). For information on activating the cost book and cost margin features in Quote Management, see [Install and configure Quote Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/configure-quote-management.md).
...
To learn more, see [Use extension points in Pricing Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/extension-points-som-pricing.md).
