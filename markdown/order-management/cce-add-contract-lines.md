...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/cce-add-contract-lines.html
release: australia
topic_type: task
...
6.  In the Catalog tab, add products to the new quote or order that is created.
    ...
    For more info, see [Add products to a quote](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/quote-management-catalog-tab.md).
