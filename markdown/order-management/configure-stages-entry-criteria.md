...
After approvals are configured, end users can submit approval requests using the approval interface. For user-facing tasks, see [Submit a quote for approval](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/submit-quote-for-approval-process.md) and [Review and approve a submitted quote](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/review-and-approve-quote.md).
