...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/som-create-context-variable.html
release: yokohama
topic_type: task
...
[Map the custom context variable to a transaction entity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/som-map-variable.md).
