...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/som-create-nonprod-attrib-adjustment.html
release: australia
topic_type: task
