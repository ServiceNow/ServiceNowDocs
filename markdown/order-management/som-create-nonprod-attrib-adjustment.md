...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/som-create-nonprod-attrib-adjustment.html
release: yokohama
topic_type: task
