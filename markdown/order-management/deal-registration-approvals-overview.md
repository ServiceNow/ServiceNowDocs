...
description: Enable deal agents to submit deals for approval through a configurable approval workflow built on the Advanced Approval Management for Sales framework.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/deal-registration-approvals-overview.html
release: zurich
topic_type: concept
last_updated: "2026-09-10"
reading_time_minutes: 3
breadcrumb: [Deal registration approvals and tasks, Deal Registration, Partner Relationship Management, Configure, Sales Customer Relationship Management]
---
...
Three main personas are involved in the approval workflow based on the Advanced Approval Management for Sales.
...
-   Closed \(Rejected\): An approver rejected the deal, ending the approval process. Deal can't be re-approved.\[Omitted image "image.deal-states"\] Alt text: Different states of deal registration

**Parent Topic:**[Deal registration approvals and tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/deal-registration-approvals-and-tasks-overview.md)
