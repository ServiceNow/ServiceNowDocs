...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/som-define-eligibility-rules.html
release: xanadu
topic_type: task
...
[Create the rule entity filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/som-create-rule-entity-filter.md) and define any new [custom context variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/som-create-context-variable.md) needed to define the eligibility rules.
