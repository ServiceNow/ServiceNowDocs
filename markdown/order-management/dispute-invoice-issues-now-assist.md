...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/dispute-invoice-issues-now-assist.html
release: zurich
topic_type: task
...
[Resolve invoice disputes using agentic workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/resolve-invoice-case-now-assist-agent.md)
