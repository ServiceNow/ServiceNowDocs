...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/build-needs-decision-tree.html
release: xanadu
topic_type: task
...
[Create a needs template and set the catalog relationship](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/create-publish-needs-template.md).
