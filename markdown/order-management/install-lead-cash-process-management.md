...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/install-lead-cash-process-management.html
release: xanadu
topic_type: task
...
For more information, see [Components installed with Lead-to-Cash Process Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/components-installed-lead-cash-process-management.md) and [Properties installed with Lead-to-Cash Process Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/properties-installed-lead-cash-process-management.md).
