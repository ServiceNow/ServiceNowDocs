...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/opportunity-management-emails-tab.html
release: yokohama
topic_type: task
...
4.  Fill in the fields in the Email Draft form.
    ...
    **Note:** You can create your own email templates and use the pre-filled email templates while creating a new email. To attach any files with your email, select **Attach File**.
