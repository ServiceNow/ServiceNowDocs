...
1.  In SFDC, add a custom field to the SFDC CPQ quote object with the format &lt;someName&gt;LGK. This will create a field with the API name &lt;someName&gt;LGK\_c.
    ...
    In CPQ, variable names begin with a lowercase character by default. Take care to make sure your twinned quote object in SFDC begins with a lowercase character as well.
