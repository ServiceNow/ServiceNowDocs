...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/using-customer-engagement-sequences.html
release: xanadu
topic_type: concept
...
Sales representatives view and work on sequence tasks assigned to them using the Customer Engagement Sequences application.
...
-   **[View sequence tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/view-sequence-tasks.md)**  
View sequence tasks assigned to you from the CSM Configurable Workspace.
-   **[Complete predefined customer engagement tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/execute-sequence-steps.md)**  
