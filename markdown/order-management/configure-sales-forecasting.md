...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/configure-sales-forecasting.html
release: yokohama
topic_type: concept
...
As an admin, you can activate the following plugins to enable users to access Sales Forecasting. For more information, see [Activate a plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_ActivateAPlugin.md).
