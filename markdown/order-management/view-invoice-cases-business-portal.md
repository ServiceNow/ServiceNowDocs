...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/view-invoice-cases-business-portal.html
release: australia
topic_type: task
...
4.  Select a case to view its state and other details.
    ...
    For a description of the Invoice case lines list view, see [Invoice case details on the Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/invoice-case-header-list-view.md).

    For more information about invoice states, see [Invoice case states on Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/invoice-case-states.md).
