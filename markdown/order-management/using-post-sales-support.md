...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/using-post-sales-support.html
release: australia
topic_type: concept
...
-   **[Add a sold product or install base item to a customer contract](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/add-products-service-contract.md)**  
Add the sold products or the install base items covered to customer contracts, contract lines, or entitlements.
-   **[Record the usage on the entitlement](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/record-usage-entitlement.md)**  
