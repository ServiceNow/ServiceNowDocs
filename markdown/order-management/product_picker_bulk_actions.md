...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/product\_picker\_bulk\_actions.html
release: zurich
topic_type: concept
...
\[Omitted image "cpq-product-picker-bulk-actions-new-inclusion.png"\] Alt text: Product Picker: bulk actions
...
\[Omitted image "cpq-product-picker-bulk-actions-data-1.png"\] Alt text: Product Picker: bulk actions
...
\[Omitted image "cpq-product-picker-bulk-actions-new-determination.png"\] Alt text: Product Picker: bulk actions
...
-   
\[Omitted image "cpq-product-picker-bulk-actions-condition-field.png"\] Alt text: Product Picker: bulk actions
...
\[Omitted image "cpq-product-picker-bulk-actions-data-2.png"\] Alt text: Product Picker: bulk actions
...
\[Omitted image "cpq-product-picker-bulk-actions.png"\] Alt text: Product Picker: bulk actions
...
[Product picker aggregates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/product-picker-aggregates.md)
