...
2.  Navigate to **Requests** &gt; **View submitted requests** &gt; **View quotes**.
    ...
    |State|Status of the quote. For more information, see [Request for quote \(RFQ\) states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/rfq-states.md).|
