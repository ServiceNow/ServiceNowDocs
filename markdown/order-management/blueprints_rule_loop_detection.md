...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/blueprints\_rule\_loop\_detection.html
release: zurich
topic_type: concept
...
To identify endless loops in a blueprint, use the Rule Cycle Report. See [Identify endless loops in blueprint rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/cpq-identify-endless-loops.md).

**Related topics**  


[Identify endless loops in blueprint rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/cpq-identify-endless-loops.md)
