...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/configure-proj-oversight-domain-orders.html
release: australia
topic_type: task
