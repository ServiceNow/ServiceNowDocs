...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/configure-proj-oversight-domain-orders.html
release: yokohama
topic_type: task
