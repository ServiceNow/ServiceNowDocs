...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/order-mgt-integrating-spm.html
release: australia
topic_type: concept
...
-   Supports creation of a single program at customer order level, single site projects at site level to manage site workflow across different products on that site and sub projects for top line items with the ability to reuse a single program across multiple customer orders.
-   Automates the creation of site projects for different location or product combination. Define a mapping to auto create program, site project and sub projects for customer order, site and product.
-   Synchronizes status and updates between project tasks and Order Management tasks, giving project managers real-time visibility through state changes, notes, and comments.
...
-   Supports site projects that can be across different products on a customer site and sub-projects for each product.
