...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/order-mgt-integrating-spm.html
release: xanadu
topic_type: concept
...
As an admin, review the setup tasks in [Configuring the Strategic Portfolio Management integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/configuring-spm-integration.md).
