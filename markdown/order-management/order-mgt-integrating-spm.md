...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/order-mgt-integrating-spm.html
release: zurich
topic_type: concept
...
As an admin, review the setup tasks in [Configuring the Strategic Portfolio Management integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/configuring-spm-integration.md).
