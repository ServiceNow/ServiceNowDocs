...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/order-mgt-integrating-spm.html
release: yokohama
topic_type: concept
...
As an admin, review the setup tasks in [Configuring the Strategic Portfolio Management integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/configuring-spm-integration.md).
