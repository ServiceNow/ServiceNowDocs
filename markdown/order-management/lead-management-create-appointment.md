...
You can create appointments only after creating a lead task. To create a lead task, see [Add lead tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/lead-management-use-tasks-tab.md).
...
5.  Fill in the fields in the Create New Appointment form.
    ...
    For description of the field values, see [Create new appointment form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/create-lead-appointment-form.md).

6.  Select **Save** to save the appointment and send it later or select **Send activity** to send it now.


**Parent Topic:**[Add lead tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/lead-management-use-tasks-tab.md)
