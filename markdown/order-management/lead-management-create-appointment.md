...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/lead-management-create-appointment.html
release: xanadu
topic_type: task
...
You can create appointments only after creating a lead task. To create a lead task, see [Add lead tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/lead-management-use-tasks-tab.md).
