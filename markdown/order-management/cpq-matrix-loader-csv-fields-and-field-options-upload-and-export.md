...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/cpq-matrix-loader-csv-fields-and-field-options-upload-and-export.html
release: zurich
topic_type: concept
...
4.  Click the notification center in the lower left corner.
    ...
    \[Omitted image "cpq-matrix-loader-csv-export-prepared.png"\] Alt text: CSV fields export

5.  Click **Download** to download the CSV file.

    \[Omitted image "cpq-matrix-loader-csv-export-ready.png"\] Alt text: Notifications screen
...
1.  Extract a sample CSV file for fields from the Matrix Loader.
    ...
    \[Omitted image "cpq-matrix-loader-csv-upload-fields-sample.png"\] Alt text: CSV file
...
2.  Extract a sample CSV file for field options from the Matrix Loader.
    ...
    \[Omitted image "cpq-matrix-loader-csv-export-field-options-sample.png"\] Alt text: CSV file
...
[Matrix Loader: CSV rules upload](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/matrix_loader_csv_rules_upload.md)

[Matrix Loader: CSV table upload](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/cpq-matrix-loader-csv-table-upload.md)
