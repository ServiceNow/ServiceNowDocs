...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/use-advanced-approval-mgmt-ai.html
release: australia
topic_type: concept
...
-   **[Get quote details in an MCP client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/get-quote-details-mcp.md)**  
Retrieve quote header and line-level information using natural language in a Model Context Protocol \(MCP\) client.
-   **[Get approval history and status in an MCP client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/get-approval-history-mcp.md)**  
...
-   **[Preview approval routing in an MCP client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/get-approval-preview-mcp.md)**  
...
-   **[Submit an approval request in an MCP client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/submit-approval-request-mcp.md)**  
