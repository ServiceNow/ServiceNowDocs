...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/review-order-fulfillment-orchestration-plan.html
release: zurich
topic_type: task
...
To learn more, see [Using the order orchestration UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/orchestration-plans-for-order-fulfillment.md).
...
<table id="choicetable_u3t_rjd_54b"><thead><tr><th align="left" id="d63190e133">

Task

</th><th align="left" id="d63190e136">

Description

</th></tr></thead><tbody><tr><td id="d63190e142">
...
Current state of the domain product or order task. To learn more, see:
    ...
    -   [Customer order states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/order-mgt-state-values.md)
    -   [Service order states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/service-order-mgt-state-values.md)
...
[Review and close fulfillment tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/order-mgt-customer-order-tasks.md)
...
[View an order timeline](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/view-order-timelines.md)
