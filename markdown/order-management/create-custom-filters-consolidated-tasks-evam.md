...
5.  In the **EVAM Datasource M2Ms** tab, add or remove a data source.
    ...
    -   Create and Link: Define a new data source and then link this data source to your EVAM definition. For more information, see .
...
7.  In the **EVAM View Config Bundle M2Ms** tab, add or remove a configuration bundle.
    ...
    -   Create and Link: Define a new configuration bundle and then link this bundle to your EVAM definition. For more information, see Defining an EVAM configuration bundle and Defining an EVAM view template.
...
[bundle-platcap.define-composite-dataset]
