...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/quote-view-a-quote-document.html
release: australia
topic_type: task
...
Agents can view quote documents in the PDF viewer window. The PDF viewer window has controls that enable agents to manage the PDF.
