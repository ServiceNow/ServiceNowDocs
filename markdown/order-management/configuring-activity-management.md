...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/configuring-activity-management.html
release: australia
topic_type: concept
...
1.  [Install CRM Touchpoints](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/install-crm-touchpoints.md)

    You can install the CRM Touchpoints application \(com.sn\_crm\_touchpoint\) if you have the admin role.

2.  [Create custom touchpoint types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/create-custom-touchpoint-types.md)
...
1.  [Install CRM Outlook Add-in](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/install-crm-outlook-add-in.md)

    You can install the CRM Outlook Add-in application \(com.sn\_crm\_outlook\) if you have the admin role.

2.  [Configure CRM access from Microsoft Outlook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/add-crm-outlook-add-in.md)
...
3.  [Configure email promotion rules for Activity Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/promote-crm-outlook-emails.md)
...
1.  [Install AI sales activity association](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/install-ai-sales-activity-association.md)
