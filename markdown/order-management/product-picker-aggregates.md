...
For steps to create and configure an aggregate using API calls, see [Adding a product picker aggregate using APIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown).
