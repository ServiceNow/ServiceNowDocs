...
-   If rejected: Revise the quote to address the feedback from the approver and resubmit \(for more information, see [Reject or return a quote for revision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/reject-or-return-quote-for-revision.md)\)
