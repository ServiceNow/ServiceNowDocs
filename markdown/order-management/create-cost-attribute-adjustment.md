...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/create-cost-attribute-adjustment.html
release: zurich
topic_type: task
...
7.  Test your decision table.
    ...
    For information on testing your decision table before publishing it, see [Test a decision table in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/test-decision-table-in-decision-builder.md).
