...
**Note:** To learn more about the ServiceNow - supplied API that is based on the TMF622 Product Ordering API REST Specification, see [Standardized Product Order OpenAPI](https://www.servicenow.com/docs/access?context=tmf622_product_ordering-api&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
...
**Note:** For detailed benefits on using the Service Exchange applications, see [Learn about Service Exchange](https://www.servicenow.com/docs/access?context=service-bridge-v2-benefits&version=xanadu&pubname=xanadu-service-bridge&ft:locale=en-US).
