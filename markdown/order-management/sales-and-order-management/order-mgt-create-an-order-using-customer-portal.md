...
2.  Browse the product catalog, select products, and add them to the cart.
    ...
    3.  If a product you want to order has available customizations, select **Customize** and select the product options.

    4.  Select **Add** to add products to the cart.

3.  Review the cart contents.

    1.  Select the Cart icon ![image.icon-shopping-cart-1].
