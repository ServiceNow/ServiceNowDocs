...
An opportunity in Sales and Order Management provides maximum information about a product or service based on the needs of a customer \(called a qualified lead\). A lead for a product is the minimal information that a sales agent uses to advance the conversation with a potential customer and create an opportunity.

![Sales and Order Management workflow that shows the opportunity, quote, and order creation steps.](../image/l2c-quote-workflow.png "Opportunity workflow in Sales and Order Management")
...
[Allocations](manage-allocations.md)
