...
description: Configure and manage the implementation of AI Search in the product catalog for Sales and Order Management.
locale: en-US
release: australia
...
Configure and manage the implementation of AI Search in the product catalog for Sales and Order Management.

## How AI Search works in the catalog interface

AI Search in the product catalog for Sales and Order Management transactions enables agents and customers to use semantic queries combined with keyword queries to find relevant product offerings and service specifications.
