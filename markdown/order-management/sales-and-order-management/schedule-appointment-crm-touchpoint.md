...
You can create appointments only after creating an opportunity task. For information on how to create an opportunity task from the Touchpoints module, see [Create a related task from a touchpoint](create-touchpoint-related-tasks.md). Alternatively, you can create an opportunity task from the Opportunity module in the CSM/FSM Configurable Workspace. For details, see [Add opportunity tasks](../concept/opportunity-management-tasks-tab.md).
...
5.  Select the **Opportunity Tasks** tab.

6.  Select an opportunity task.
...
9.  On the Create New Appointment form, fill in the fields.
    ...
    For a description of the field values, see [Create new appointment form](../reference/create-appointments-form.md).
