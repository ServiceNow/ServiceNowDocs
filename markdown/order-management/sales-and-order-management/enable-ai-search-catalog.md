...
description: Use the enable\_ai\_search\_in\_catalog property to enable AI Search in the product catalog interface for Sales and Order Management.
locale: en-US
release: australia
...
Use the **enable\_ai\_search\_in\_catalog** property to enable AI Search in the product catalog interface for Sales and Order Management.
