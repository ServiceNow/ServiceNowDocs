...
-   **Derived Pricing Matrix**: Define the rules for deriving the pricing of a product relative to other product offerings or pricing sources, such as transaction values from quote or order headers. To learn more, see [Configuring derived pricing](configuring-related-product-pricing.md).
