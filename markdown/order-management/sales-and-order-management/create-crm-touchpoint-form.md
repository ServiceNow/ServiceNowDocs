...
A value for this field must be set to the table name of the CRM entity linked to the touchpoint, such as Opportunity \[sn\_opty\_mgmt\_core\_opportunity\] before modifying the Associated record field.
...
Account associated with the touchpoint.
...
Contact person associated with the touchpoint.
