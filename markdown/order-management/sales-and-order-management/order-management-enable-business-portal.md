...
To set up the Business Portal and Sales and Order Management self-service enhancements, first install the Business Portal plugins, which are available in the app store.
