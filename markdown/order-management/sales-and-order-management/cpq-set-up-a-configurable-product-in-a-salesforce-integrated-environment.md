...
**Note:** If your ServiceNow CPQ SF Managed Package was installed before June 2022, see [Set up a configurable product in a Salesforce-integrated environment \(older managed package\)](cpq-set-up-a-configurable-product-in-a-salesforce-integrated-environment-older-managed-package.md).
