...
1.  In the CSM Configurable Workspace, select the **List** ![](../image/jm-order-fulfillment-manager-persona.png) view.
...
<table id="choicetable_pwy_bnv_c1c"><thead><tr><th align="left" id="d25680e103">

Option

</th><th align="left" id="d25680e106">

Description

</th></tr></thead><tbody><tr><td id="d25680e112">
