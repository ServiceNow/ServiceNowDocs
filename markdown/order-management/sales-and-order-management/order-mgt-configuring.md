---
title: Configuring Order Management
description: Learn how to configure the features and components that you need for customer and service order processing, depending on whether you are a provider or an enterprise customer.
locale: en-US
release: australia
...
-   **[Configuring Fallout Management](configure-fallout-management.md#)**  
...
-   **[Configuring inflight changes](configure-inflight-order-change-mgt.md)**  
...
-   **[Configuring compatibility rules for horizontal relationships](order-mgt-compatibility-management.md)**  
...
[Order management](explore-order-management.md)
