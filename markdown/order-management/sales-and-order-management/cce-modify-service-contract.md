...
breadcrumb: [Modify, Using Contracts and Entitlements Workflows, Customer Contracts and Entitlements, Configure, price, quote apps, Use, Sales and Order Management]
---
...
5.  On the Configurator UI, modify the existing configurations for the customer contract line.
    ...
    To learn more about the Configurator UI, see [Exploring Sales and Order Management](../../tmt-order-mgt/concept/som-exploring.md).
