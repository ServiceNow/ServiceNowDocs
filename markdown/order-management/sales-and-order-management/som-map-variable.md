...
description: Associate a custom pricing context variable to a particular transaction entity type in Sales and Order Management.
locale: en-US
release: australia
...
Associate a custom pricing context variable to a particular transaction entity type in Sales and Order Management.
...
4.  In the form, fill in the fields.
    ...
    |Field|Description|
    |-----|-----------|
    |Entity|The Sales and Order Management entity for which the variable will be used. Select the entity, for example Opportunity or Order.|
