...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/sales-and-order-management/order-enrichment.html
release: yokohama
...
breadcrumb: [Workflow scenarios, Order Management, Explore, Sales Customer Relationship Management]
---
...
\[Omitted image "order-mgt-enrichment-process.png"\] Alt text: Infographic displaying the order enrichment flow. For the image description, refer to the text that follows.
...
\[Omitted image "order-mgt-enrichment-decision-table.png"\] Alt text: Infographic displays the decision table for order enrichment process
