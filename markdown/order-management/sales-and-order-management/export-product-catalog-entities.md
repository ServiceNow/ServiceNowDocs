...
4.  In **Entity Type**, select the product catalog entity to be exported from your source instance.
    ...
    **Note:** During export, note the following:
    ...
    -   Versioned entities can be exported in any order. However, if you have many versioned entities that must be exported, the lowest version of the entity must be exported before higher versions of the entity are exported.
