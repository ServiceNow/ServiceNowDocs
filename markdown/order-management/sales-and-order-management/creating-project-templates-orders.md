...
As an admin or user with the it\_project\_manager role, you create project templates and the project template tasks in Project Portfolio Management. For more information, see [Project templates](https://www.servicenow.com/docs/access?context=c_ProjectTemplates&version=zurich&pubname=zurich-it-business-management&ft:locale=en-US) and [Create a project template](https://www.servicenow.com/docs/access?context=t_ViewAProjectTemplateForm&version=zurich&pubname=zurich-it-business-management&ft:locale=en-US). The demo data with the Order Management application includes project templates that you can copy and change as needed.
