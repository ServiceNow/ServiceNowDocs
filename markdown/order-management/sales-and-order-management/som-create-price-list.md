...
Ending date and time of the price list. Select the Calendar icon ![](../image/field-calendar.png) to choose the end date and time, then select **OK**. After the end date, the price list is no longer active.**Note:** If this is a default price list, the end date is ignored.
