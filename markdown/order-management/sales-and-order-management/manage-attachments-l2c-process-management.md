...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/sales-and-order-management/manage-attachments-l2c-process-management.html
release: yokohama
...
8.  Select the desired action.
    ...
    -   Delete
    -   Rename
    **Tip:** For bulk deletions or downloads, select the files or select **All Files** and then select the action.
