---
title: Assign user roles in Sales and Order Management applications
description: The Sales and Order Management applications use roles to control access to features and capabilities. Roles also determine access to information for data security, identify users, and define the work that users perform in your organization.
locale: en-US
release: australia
...
</table>**Parent Topic:**[Configuring Sales and Order Management applications](som-configuring.md)
