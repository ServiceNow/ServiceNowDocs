...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/sales-and-order-management/import-pricing-entities.html
release: xanadu
...
9.  In the Import Set record, open the **Import Log** tab to check for any errors and verify that the transform completed successfully.
