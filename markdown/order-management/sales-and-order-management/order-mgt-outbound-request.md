...
The outbound requests are enabled through the bi-directional integration over a REST API between Order Management for Telecommunications, Media, and Technology and the external systems. To learn more, see .
...
**Parent Topic:**[Managing service orders](../concept/managing-service-orders.md)
