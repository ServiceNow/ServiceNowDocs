...
To learn about best practices while using the `lookup` function, see [Minimizing table queries](table_queries.md).
...
[ServiceNow CPQ scripting language reference](cpq-logik-io-scripting-language-reference.md)
