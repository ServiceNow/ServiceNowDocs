...
2.  From the **Configurable Workspace Lists** tab \(![Lists tab icon to explore different tasks and services.](../image/Lists.png)\), select **Customer**, and then select **Accounts**.
...
State of the customer service case. To learn more, see [Case states](https://www.servicenow.com/docs/access?context=r_CustomerServiceCaseStates&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
