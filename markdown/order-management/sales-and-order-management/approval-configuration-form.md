...
Name of the configuration for a Sales and Order Management entity, for example Quote.
...
Sales and Order Management Entity for the approval configuration. For example, if you're creating an approval configuration for Quote Management, select the Quote \[sn\_quote\_mgmt\_core\_quote\] table.
