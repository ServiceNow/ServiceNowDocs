...
description: Use the CPQ Configurator to add configurable products to a Sales and Order Management transaction, for example an opportunity or quote.
locale: en-US
release: australia
...
breadcrumb: [CPQ Configurator, Configure, price, quote apps, Use, Sales and Order Management]
---
