...
1.  Log a Support case that describes the languages you intend to translate configuration experiences into. Request that ServiceNow CPQ Support enable these languages on all relevant ServiceNow CPQ environments in your development stack. After the new languages are enabled, continue with step 2.
