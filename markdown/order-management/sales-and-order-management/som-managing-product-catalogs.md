...
|[Control cascading quantity values in child product offerings](../task/som-activate-cascade-quantity.md)|Control how the quantities for child line items in a product offering for an opportunity, quote, or order are calculated by using the **sn\_prd\_pm.enable\_cascade\_quantity** system property.|
