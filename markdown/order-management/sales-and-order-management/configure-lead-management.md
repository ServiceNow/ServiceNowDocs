...
|[Assign user roles in Sales and Order Management applications](configure-SOM-roles.md)|Assign the user roles for Lead Management, Product Catalog Management, and Pricing Management.|Admin|
