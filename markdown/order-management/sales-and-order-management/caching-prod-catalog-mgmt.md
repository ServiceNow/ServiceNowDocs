...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/sales-and-order-management/caching-prod-catalog-mgmt.html
release: yokohama
...
For details on regenerating these caches, see [Update a cache in Product Catalog Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/sales-and-order-management/som-update-cache-catalog-mgmt.md).
