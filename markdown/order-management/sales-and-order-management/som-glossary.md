---
title: Sales and Order Management glossary
description: Learn about terms and concepts that are unique to Sales and Order Management.
locale: en-US
release: australia
...
**Parent Topic:**[Sales and Order Management reference](som-reference.md)
...
[service-bridge-consumers-landing-page]
...
For more information, see [Methods of creating orders in Sales and Order Management](order-capture-methods-som.md).
...
A user interface embedded within various Sales and Order Management applications \(Opportunity, Quote, and Order Management\) that enables agents to dynamically configure complex products or services according to customer requirements, displaying product hierarchy, option selection, and current pricing.
...
For more information, see [Order types in Sales and Order Management](som-order-types.md).
