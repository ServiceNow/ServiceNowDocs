...
description: Return Merchandise Authorization \(RMA\) application enables creating cases for install base items. It offers simplified processes, decreased turnaround time, and offers a unified workflow.
locale: en-US
release: zurich
