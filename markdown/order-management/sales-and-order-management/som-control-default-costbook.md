...
description: Set the default cost book displayed to your sales agents on the transaction header or header line for a Sales and Order Management application by using the Cost Book Defaulting Matrix.
locale: en-US
release: australia
...
Set the default cost book displayed to your sales agents on the transaction header or header line for a Sales and Order Management application by using the Cost Book Defaulting Matrix.
