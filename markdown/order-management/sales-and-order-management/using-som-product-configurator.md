...
description: The legacy product configurator in Sales and Order Management is an interface for customizing configurable product offers. The interface displays the product options available and automatically calculates product pricing as you select options.
locale: en-US
release: australia
