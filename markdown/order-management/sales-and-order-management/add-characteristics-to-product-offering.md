...
description: Add characteristic and characteristic options to an existing product offering using the Product Offering Characteristic tab in Sales and Order Management.
locale: en-US
release: australia
...
breadcrumb: [Create product characteristics and characteristic options, Defining product characteristics and characteristic options, Create product offerings, Configuring product offerings and catalogs, Lead-to-cash foundation apps, Configure, Sales and Order Management]
---

# Add characteristic and characteristic options to a product offering

Add characteristic and characteristic options to an existing product offering using the **Product Offering Characteristic** tab in Sales and Order Management.
