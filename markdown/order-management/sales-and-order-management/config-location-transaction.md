...
breadcrumb: [Configuring agent tools in Sales Customer Relationship Management, Configuring Sales Customer Relationship Management applications, Sales Customer Relationship Management]
---
...
-   **Agent experience for location-based transactions**
    ...
    -   [Update product locations at the order line level](../task/order-mgt-copy-order-line-location.md).
