...
[AI Search query language](https://www.servicenow.com/docs/access?context=query-language-ais&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
