...
-   Grant the sales process manager write access to the child entity. For more information, see [Enable the email client for a table](https://www.servicenow.com/docs/access?context=enable-email-client&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
[Email client](https://www.servicenow.com/docs/access?context=c_EnableTheEmailClient&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
