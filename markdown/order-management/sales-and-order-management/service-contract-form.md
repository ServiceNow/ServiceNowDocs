...
breadcrumb: [Customer Contracts and Entitlements reference, Configure, price, quote, Reference, Sales and Order Management]
---
...
The name of the consumer associated with the contract.**Note:** If no consumer record is found, you can create a consumer and add it to the customer contract. For more information, see [Create a consumer record](https://www.servicenow.com/docs/access?context=create-a-consumer-record&version=australia&pubname=australia-customer-service-management&ft:locale=en-US).
...
The current state of the customer contract:-   Draft
-   Active
-   Expired
-   Canceled
-   Suspended
...
A customer contract can be renewed multiple times. Renewal root refers the customer contract reference of the first or base customer contract.
