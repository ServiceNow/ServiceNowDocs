...
Use the Deal Registration Management plugin to ensure partners are recognized and rewarded for the opportunities they source and develop. Enterprises can also properly manage an upcoming deal from partners and help prevent multiple partners or internal teams from overlapping on the same customer or opportunity. To learn more about the Deal Registration Management application, see [Deal Registration](deal-registration-management.md).
...
To learn more about the Partner portal, see [Using Partner Relationship Management](using-partner-relationship-management.md). ![Home page of the Partner portal displaying a list of deal registrations, orders, and cases.](../image/partner-portal-ui.png)
