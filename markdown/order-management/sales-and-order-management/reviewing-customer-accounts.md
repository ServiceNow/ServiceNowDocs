...
**Note:** To learn how to create new customer accounts, see [Configure accounts and contacts](https://www.servicenow.com/docs/access?context=configure-csm-accounts-contacts&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US) in Customer Service Management \(CSM\).
