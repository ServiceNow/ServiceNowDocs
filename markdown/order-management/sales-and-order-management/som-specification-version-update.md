...
breadcrumb: [Specifications and product offerings, Configuring product offerings and catalogs, Lead-to-cash foundation apps, Configure, Sales and Order Management]
---
...
A set of specification versions can be updated using the batch specification utility in Sales and Order Management. The specification can also be scheduled.
