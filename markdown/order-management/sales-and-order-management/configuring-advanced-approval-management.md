...
description: Install the Advanced Approval Management application to build workflows that automate the approval process for Sales and Order Management entities such as customer quotes.
locale: en-US
release: australia
...
Install the Advanced Approval Management application to build workflows that automate the approval process for Sales and Order Management entities such as customer quotes.
