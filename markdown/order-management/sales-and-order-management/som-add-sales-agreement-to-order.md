...
description: Add a sales agreement to your order. A sales agreement is a contract to order a pre-identified set of products and services for a set price.
locale: en-US
release: yokohama
...
2.  Navigate to the Order Details tab by selecting the more icon ![](../image/som-icon-more-order-detail.png)and choosing **Order Details**.

3.  In the **Customer Order** form, find the **Sales Agreement** field and select the sales agreement you want.

    ![Image shows the order form with a sales agreement selected to add to the order.](../image/som-add-sa-to-order.png)
