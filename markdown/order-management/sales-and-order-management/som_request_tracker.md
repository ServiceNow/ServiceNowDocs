...
breadcrumb: [Sales and Service API Core, Lead-to-cash foundation apps, Configure, Sales and Order Management]
---
...
Create**Note:** For Sales and Order management requests, the user doesn't have access to the **response\_payload**, **payload**, or **requested\_flow** fields.
...
Write access for non Sales and Order management \(SOM\) requestsRead only access for Sales and Order management \(SOM\) requests

**Note:** For sales and order management requests, the user doesn't have access to the **response\_payload**, **payload**, or **requested\_flow** fields.
...
Read access to all Sales and Order Management requests
