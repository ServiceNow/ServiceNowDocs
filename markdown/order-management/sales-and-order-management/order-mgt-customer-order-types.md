...
The change order is approved, the state of product inventory is changed to Change pending.

The change order is fulfilled, the state of product inventory is changed to Active or Inactive.
