...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/sales-and-order-management/add-attachments-sales-process.html
release: yokohama
...
You can attach files only to a sales process record. To add attachments to child records, you must navigate to the respective entity's record page.
...
<table id="choicetable_rbm_fqz_bgc"><thead><tr><th align="left" id="d44789e129">

Method

</th><th align="left" id="d44789e132">

Action

</th></tr></thead><tbody><tr><td id="d44789e138">
...
2.  In the browse files pop-up window, select the file.
3.  Select **Open**.


</td></tr></tbody>
</table>7.  Select **Upload**.

8.  Attach more files by selecting the Add icon \[Omitted image "workspace-icon-add.png"\] Alt text:.


## What to do next

Download, rename, or delete attachments. For more information, see [Manage attachments for a sales process record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/sales-and-order-management/manage-attachments-l2c-process-management.md).
