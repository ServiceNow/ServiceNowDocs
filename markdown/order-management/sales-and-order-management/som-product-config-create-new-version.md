...
description: Create a version of a product offering when updates are needed to a published offering in Sales and Order Management.
locale: en-US
release: australia
...
Create a version of a product offering when updates are needed to a published offering in Sales and Order Management.
