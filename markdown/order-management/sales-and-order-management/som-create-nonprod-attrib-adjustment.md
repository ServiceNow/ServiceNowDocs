...
9.  In the decision table, set the pricing rule for the non-product attribute:
    ...
    7.  Select **Publish**.
        ...
        The adjustments are available to agents when working on Sales and Order Management transactions, such as quotes or orders and to customers using the Business Portal.
