...
-   Red: tTask is near the end of the critical percentage of allotted time.![The image shows a method of monitoring jeopardy risk level using the Order Task Characteristics Values table.](../image/jm-sla-indicator.png)
