...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/sales-and-order-management/monitoring-jeopardy-management.html
release: yokohama
...
-   Red: tTask is near the end of the critical percentage of allotted time.\[Omitted image "jm-sla-indicator.png"\] Alt text: The image shows a method of monitoring jeopardy risk level using the Order Task Characteristics Values table.

</td></tr></tbody>
</table>**Parent Topic:**[Using Order Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/sales-and-order-management/reviewing-approving-fulfilling-orders.md)
