...
As an admin, activate the plugin \(com.sn\_sales\_territory\) to enable users to access Sales Territory Management​. For more information, see [Activate a plugin](https://www.servicenow.com/docs/access?context=t_ActivateAPlugin&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
-   Provides SOM Tracker to help to run assignment rules algorithm asynchronously​.
