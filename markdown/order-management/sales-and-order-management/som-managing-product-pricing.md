...
|[Enable ramps](../task/som-create-product-offering.md)|When creating a product offering, select the **Enable ramps** option, which lets sales agents add price and quantity ramps for the offering during the quote process. For information on how ramps work, see [Price and quantity ramps](defining-products-with-ramps.md).|
