...
Starting with the May 2024 release of Sales and Order Management applications, you can use the CSM Configurable Workspace to configure product pricing.
...
|[Create a product attribute-based pricing adjustment](../task/som-create-pricing-adjustment.md)|Define pricing adjustments based on certain product characteristics.|
...
|[Control the default cost book on transaction header or header line](../task/som-control-default-costbook.md)|Set the default cost book displayed to your sales agents on the transaction header or header line for a Sales and Order Management application by using the Cost Book Defaulting Matrix.|
...
|[Create and publish a cost-based attribute adjustment](../task/create-cost-attribute-adjustment.md)|Define cost-based attribute adjustments for a cost book line or product offering.|
...
|[Map a custom context variable to a transaction entity](../task/som-map-variable.md)|Associate a custom pricing context variable to a particular transaction entity type in Sales and Order Management.|
