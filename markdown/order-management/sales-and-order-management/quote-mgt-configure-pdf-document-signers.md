...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/sales-and-order-management/quote-mgt-configure-pdf-document-signers.html
release: yokohama
...
To assign roles for internal users, see [Assign user roles in Sales Customer Relationship Management applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/sales-and-order-management/configure-SOM-roles.md).
