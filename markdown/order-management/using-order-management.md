...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/using-order-management.html
release: australia
topic_type: concept
...
1.  [Creating orders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/som-create-product-order.md)
...
2.  [Enriching orders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/order-enrichment.md)
...
3.  [Approving or rejecting orders](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/approving-rejecting-orders-som.md)

    The fulfillment manager reviews the order, order lines, and pricing details and approves or rejects the order.

4.  \[System\] [Order decomposition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/order-mgt-order-decomposition.md)
...
6.  [Order fulfillment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/reviewing-orchestration-plans-order-fulfillment.md)
...
7.  [Managing order fallouts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/fallout-management-overview.md)
...
8.  [Monitoring order jeopardy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/monitoring-jeopardy-management.md)
...
9.  [Managing post-fulfillment order changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/managing-orders.md)
...
[Order life cycle states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/order-lifecycle-states.md)

[Methods of creating orders in Sales Customer Relationship Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/order-capture-methods-som.md)

[Reviewing customer or partner accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/reviewing-customer-accounts.md)
