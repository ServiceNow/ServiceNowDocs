...
Learn about the CPQ Extension Package and the CPQ Extension for Salesforce CPQ.

CPQ offers two managed packages for Salesforce\(SFDC\) orgs: the CPQ Extension Package and the CPQ Extension for Salesforce CPQ. This article discusses what each package does and how they are different. Details on how to set up or upgrade an environment's managed packages are provided at the end of the article.

## CPQ Extension Package
