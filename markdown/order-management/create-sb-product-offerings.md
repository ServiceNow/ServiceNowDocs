...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/create-sb-product-offerings.html
release: xanadu
topic_type: task
...
When you're creating the product offering, use the **Distribution channel** field to set the channel toService Exchange.
...
<table id="choicetable_dt3_z1p_ccc"><thead><tr><th align="left" id="d31147e540">

Action

</th><th align="left" id="d31147e543">

Description

</th></tr></thead><tbody><tr><td id="d31147e549">
...
[Associate consumer criteria to a remote record producer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/associate-criteria-remote-catalog.md) for this remote catalog item.
