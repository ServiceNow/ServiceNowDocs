...
4.  Select a case for which you want to provide information.
    ...
    For a description of the field values, see [Invoice case details on the Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/invoice-case-header-list-view.md).
