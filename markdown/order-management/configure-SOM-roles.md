...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/configure-SOM-roles.html
release: xanadu
topic_type: concept
...
The roles in the following table apply to Opportunity Management. To learn more about these roles, see [Opportunity Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/opportunity-management.md).
