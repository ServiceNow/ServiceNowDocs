...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/order-management-enable-business-portal.html
release: yokohama
topic_type: task
...
Admins can enable the Business Portal \(sn\_b2b\_portal\) so customers can browse products and create orders.
...
See [Configuring the Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/order-management-configure-business-portal.md) for more information.
