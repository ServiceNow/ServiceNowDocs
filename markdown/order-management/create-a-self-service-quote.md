...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/create-a-self-service-quote.html
release: australia
topic_type: task
...
3.  On the quote form, review the following tabs and fill in the required fields:
    ...
    For field descriptions and additional information about the quote creation form, see [Quote creation via Self-Service fields for Channel Partners](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/quote-creation-fields.md).
...
[Quote creation via Self-Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/self-service-quote_generic.md)
