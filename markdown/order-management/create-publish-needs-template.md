...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/create-publish-needs-template.html
release: xanadu
topic_type: task
...
1.  Navigate to **All** &gt; **Product Catalog Management** &gt; **Needs** &gt; **Needs template**.
...
-   Published: Template has been published. After a template is published, you can update or delete it.
    ...
    The needs template is displayed in the Needs Template list.

4.  In the Needs Templates list, select the needs template record to set the catalog relationship.

    The Needs Template Relationships section opens.

    1.  Select **New**, which opens the Needs Template Relationship form.
...
5.  In the Needs Template record, select **Publish** to make it available in the product selection guide.
