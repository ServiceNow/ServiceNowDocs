...
Assign the persona to a view to define its field and event access at each stage. For more information, see [Create a transaction view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/quote-tm-configure-view.md).
