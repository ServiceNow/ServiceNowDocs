---
title: Passing array variables using Salesforce external connectionshould this be "using an external connection to Salesforce"?
description: You must use single quote strings when making a SOQL query to Salesforce.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/enrichments\_array\_variables\_using\_salesforce\_external\_connection.html
release: zurich
topic_type: concept
...
[Using external connections with OAuth support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown)

[Passing data from Salesforce to ServiceNow CPQ fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/enrichments_on_pass_data_from_salesforce_to_logik_io_fields.md)
