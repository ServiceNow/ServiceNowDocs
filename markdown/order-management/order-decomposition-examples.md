...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/order-decomposition-examples.html
release: zurich
topic_type: concept
...
To learn more about decision tables, see [Decision tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/decision-table.md):
