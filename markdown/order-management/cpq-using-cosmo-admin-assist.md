...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/cpq-using-cosmo-admin-assist.html
release: australia
topic_type: concept
...
Cosmo Admin Assist delivers conversational, AI-powered guidance to help admins quickly find answers and general guidelines. Using Retrieval-Augmented Generation \(RAG\) and ServiceNow knowledge articles, it provides context-aware, actionable support directly in the CPQ Admin interface.
...
[Cosmo SmartPredict](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/cpq-cosmo-smartpredict.md)
