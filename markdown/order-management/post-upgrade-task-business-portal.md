...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/post-upgrade-task-business-portal.html
release: yokohama
topic_type: task
...
Ensure that the Sales Cart application has been installed. For more information, see [Install Sales Cart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/install-sales-cart-plugin.md).
