...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/post-upgrade-task-business-portal.html
release: xanadu
topic_type: task
...
Ensure that the Sales Cart application has been installed. For more information, see [Install Sales Cart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/install-sales-cart-plugin.md).
