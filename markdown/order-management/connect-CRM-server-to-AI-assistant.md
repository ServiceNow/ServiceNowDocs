...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/connect-CRM-server-to-AI-assistant.html
release: australia
topic_type: task
...
-   The Advanced Approval Management AI application is installed. For details, see [Install Advanced Approval Management AI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/install-advanced-approval-management-ai.md).
