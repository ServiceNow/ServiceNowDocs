...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/configure-quote-management.html
release: xanadu
topic_type: concept
...
[Install Quote Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/installing-quote-management.md)
...
[Assign user roles in Sales and Order Management applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/configure-SOM-roles.md)
...
[Configuring product offerings and catalogs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/som-managing-product-catalogs.md)
...
[Configuring product pricing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/som-create-price-list-line.md)

</td><td>

Define the price lists, pricing strategies, and other pricing features that you want to use, unless they've been previously defined.-   Set the [price lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/som-create-price-list.md) and pricing strategies that control how pricing is applied to quotes.
-   If you're using cost books, create the [cost books](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/create-cost-books.md) that define the unit costs for product offerings.
...
[Activate location-based transactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/som-activate-location-filter.md)
