...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/som-create-pricing-adjustment.html
release: yokohama
topic_type: task
...
7.  Test your decision table.
    ...
    For more information on testing your decision table before publishing it, see [Test a decision table in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/workflow-studio/test-decision-table-in-decision-builder.md).
