...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/fallout-management-overview.html
release: australia
topic_type: concept
...
-   **[Create a manual fallout record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/create-manual-order-fallout-record.md)**  
Create a fallout record manually for an order task that has a condition or issue that prevents it from being completed.
-   **[Review a fallout record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/select-order-fallout-records-review.md)**  
Review a fallout record to make sure that the detailed information is correct and complete.
-   **[Update a fallout record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/review-update-selected-order-fallout-records.md)**  
...
-   **[Resolve order fallouts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/resolve-order-fallouts.md)**  
