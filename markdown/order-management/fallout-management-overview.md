...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/fallout-management-overview.html
release: zurich
topic_type: concept
...
-   **[Creating automated fallout records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/creating-automated-manual-fallout-records.md)**  
...
-   **[Create a manual fallout record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/create-manual-order-fallout-record.md)**  
Create a fallout record manually for an order task that has a condition or issue that prevents it from being completed.
-   **[Review a fallout record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/select-order-fallout-records-review.md)**  
Review a fallout record to make sure that the detailed information is correct and complete.
-   **[Update a fallout record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/review-update-selected-order-fallout-records.md)**  
...
-   **[Resolve order fallouts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/resolve-order-fallouts.md)**  
