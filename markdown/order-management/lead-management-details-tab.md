...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/lead-management-details-tab.html
release: yokohama
topic_type: task
...
3.  Fill in additional information on the Details tab.
    ...
    To learn more, see [Create a lead](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/create-new-lead.md).
...
Use the Product Catalog tab to add products to your lead. To learn more, see [Add products to a lead](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/lead-management-add-product.md).
