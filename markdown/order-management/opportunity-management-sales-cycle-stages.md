...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/opportunity-management-sales-cycle-stages.html
release: xanadu
topic_type: task
...
4.  Select and move one or multiple opportunity stages from Collection on the left to the Sales Cycle Stages List on the right.
