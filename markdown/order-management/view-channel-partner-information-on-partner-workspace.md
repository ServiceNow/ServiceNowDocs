...
3.  Open a channel partner record from the list.
    ...
    To learn more about the components on the channel partner record, see [Channel Partner components on workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/channel-partner-components.md).
