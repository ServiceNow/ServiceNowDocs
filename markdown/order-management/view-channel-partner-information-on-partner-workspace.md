...
1.  Navigate to the **CSM/FSM Configurable Workspace** and select the list view.
    ...
    To learn more about the CSM/FSM Configurable Workspace, see [CRM Workspace overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/csm-config-workspace-overview.md).
...
3.  Open a channel partner record from the list.
    ...
    To learn more about the components on the channel partner record, see [Channel Partner components on workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/channel-partner-components.md).
