...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/view-channel-partner-information-on-partner-workspace.html
release: australia
topic_type: task
...
3.  Open a channel partner record from the list.
    ...
    To learn more about the components on the channel partner record, see [Channel Partner components on workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/channel-partner-components.md).
