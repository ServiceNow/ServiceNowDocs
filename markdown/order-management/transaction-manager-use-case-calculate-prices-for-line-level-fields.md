---
title: ServiceNow Quote Experience use case: Calculate prices for line-level fields
description: ServiceNow Quote Experience can apply rules to line-level fields that dynamically calculate prices according to changes to the field, such as when products are added or removed.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/transaction-manager-use-case-calculate-prices-for-line-level-fields.html
release: australia
topic_type: concept
...
-   Create all the custom fields required for your use case. For the detailed steps on how to create fields, see [Quote transaction fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/quote-tm-fields.md).
...
Map the configured fields into the appropriate layout for visibility. For the detailed steps, see [Set up layouts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/layout_csv_101.md).
