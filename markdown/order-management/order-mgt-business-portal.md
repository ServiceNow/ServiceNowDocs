...
-   **[Access the Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/order-management-access-the-business-portal.md)**  
Customers can access the Business Portal from their instance to browse products and create orders.
-   **[Self-service order management using Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/self-service-order-management.md)**  
...
-   **[Managing request for quotes \(RFQs\) using Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/rfq-business-portal.md)**  
...
-   **[Order case management using Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/order-case-self-service.md)**  
...
-   **[Invoice and invoice case management using Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/invoice-case-self-service.md)**  
...
Customers can view contracts and entitlements associated with their accounts on the Business Portal.
