...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/blueprints.html
release: zurich
topic_type: concept
...
-   Document Enrichment scripts and custom external connections used by each blueprint.
