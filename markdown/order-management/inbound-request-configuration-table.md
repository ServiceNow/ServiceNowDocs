...
Script required to process the inbound request.To learn more about the configuration API, see [IBQConfigBase API - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/server-api-reference/IBQConfigBaseAPIBoth.md).
...
[IBQConfigBase API - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/server-api-reference/IBQConfigBaseAPIBoth.md)
