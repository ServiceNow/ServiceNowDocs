...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/configuring-pricing-plan.html
release: xanadu
topic_type: concept
...
|Fetch Cost|Get costs from a [cost book](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/create-cost-books.md), if your organization is using cost books in Quote Management.|
|Fetch Price List Price|Get the list price for all requested products based on the [price list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/som-create-price-list.md), unit of measurement, and data provided to the pricing API.|
...
-   [Create a configurable pricing plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/create-custom-pricing-plan.md) \(copy the default plan\).
-   [Add or change a pricing plan step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/add-pricing-step.md). In your configurable pricing plan, you can add one or more pricing steps for pricing adjustments, including any conditions for running the step. You can also change the sequence of the adjustment steps, if needed.
-   [Delete a pricing plan step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/delete-pricing-plan-step.md).
