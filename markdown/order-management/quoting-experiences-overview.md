...
For a conceptual overview of how the pricing service integrates with the Quote Experience, including pricing states and repricing, see . Administrators configure the pricing connection and repricing behavior as part of setting up the quoting experience. For more information, see [Configuring ServiceNow Quote Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/sales-crm-tm-quoting-configure.md).
...
[Configuring ServiceNow Quote Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/sales-crm-tm-quoting-configure.md)
