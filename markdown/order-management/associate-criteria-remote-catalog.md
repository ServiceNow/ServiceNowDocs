...
By default remote record producers are available to all consumers. If you have specific criteria for certain users, define the consumer criteria for Service Exchange users. For more information, see Creating entitlements in Service Exchange for Providers.
