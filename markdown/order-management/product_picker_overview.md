...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/product\_picker\_overview.html
release: zurich
topic_type: concept
...
Aggregates can be created on product pickers, similar to how set aggregates work. For information about set aggregates, see [Creating set aggregates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/creating_set_aggregates.md).
...
[Referencing a product picker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/enrichments_how_to_reference_a_product_picker.md)
