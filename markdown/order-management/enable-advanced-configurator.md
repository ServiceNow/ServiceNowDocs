...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/enable-advanced-configurator.html
release: zurich
topic_type: task
...
If you have been using the legacy product configurator for Sales Customer Relationship Management, but you want to use the CPQ Configurator instead, set the **sn\_prd\_pm.enable\_advanced\_configuration** property to true. The CPQ Configurator is installed with the ServiceNow CPQ Integration application.
