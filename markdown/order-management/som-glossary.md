...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/som-glossary.html
release: zurich
topic_type: concept
...
To learn more about channel partners, see [Partner Relationship Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/partner-relationship-management.md).
...
Sales opportunities that representatives are confident will close within the current forecast period.
...
For more information, see [Add Covered Products using Contracts and Entitlement Workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/adding-cov-prod-cceworkflows.md).
...
For more information, see [Sales Forecasting terminology](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/sales-forecasting-terminology.md).
...
For more information, see [Lead Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/lead-management.md).
...
For more information, see [Multiple configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/multiple-child-offering-configurations.md).
...
For more information, see [Opportunity Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/opportunity-management.md)
...
For more information, see [Methods of creating orders in Sales Customer Relationship Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/order-capture-methods-som.md).
...
For more information, see [Order decomposition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/order-mgt-order-decomposition.md).

## order fallout

Failures during order fulfillment due to errors or exceptions.

For more information, see [Managing order fallout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/fallout-management-overview.md).

## order fulfillment

Completing tasks to fulfill orders, guided by orchestration plans.

For more information, see [Order fulfillment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/reviewing-orchestration-plans-order-fulfillment.md).
...
For more information, see [Using Order Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/using-order-management.md).
...
For more information, see [Order life cycle states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/order-lifecycle-states.md).
...
For more information, see [Managing inflight order changes and cancellation requests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/inflight-order-change-mgt-overview.md).
...
A section in the product configurator that lists the parent and child product relationships for configurable products, helping agents navigate nested bundles.
...
Logical groupings of product offerings in a catalog, making it easier for agents to browse and navigate product offerings.
...
For more information, see [Set up sales quota](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/setup-sales-quota.md).
...
For more information, see [Order types in Sales Customer Relationship Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/som-order-types.md).
...
For more information, see [Set up PDF document signers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/quote-mgt-configure-pdf-document-signers.md).

## staggered decomposition

Breaking down customer orders in multiple iterations.

For more information, see [Staggered decomposition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/staggered-decomposition.md).
...
For more information, see [Configure volume pricing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/configure-volume-pricing.md).
