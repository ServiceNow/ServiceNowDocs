...
breadcrumb: [Events, ServiceNow Quote Experience, Configure, price, quote apps, Configure, Sales Customer Relationship Management]
---
...
Add the event to the quote layout to make it available as a button to users. For more information, see [Create a quote transaction layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/quote-tm-create-layout.md).
