...
1.  Complete the prerequisites. For more information, see [Prerequisites for setting up CPQ](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/prereq-for-cpq-config.md).
2.  Configure CPQ Configurator using the guided setup. For more information, see [Set up CPQ using guided setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/order-management/configure-cpq-using-guided-setup.md).
