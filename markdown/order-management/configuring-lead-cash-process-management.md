...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/configuring-lead-cash-process-management.html
release: australia
topic_type: concept
...
2.  [Install Lead-to-Cash Process Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/install-lead-cash-process-management.md)
...
3.  [Assign roles to Lead-to-Cash Process Management users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/assign-roles-lead-cash-process-management.md)
...
4.  [Set up business objects for sales process records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/create-business-object-group-define-entity-relationship.md)
...
5.  [Customizing the sales process dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/customizing-sales-process-dashboard.md)
...
6.  [Modifying data retention and table cleanup policy for Lead-to-Cash Process Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/modifying-table-cleanup-policy-l2c-process-management.md)

    Access and modify the default data retention and table cleanup policy to modify it to suit your needs.

7.  [Setting conditions for enabling email access in Lead-to-Cash Process Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/enabling-email-l2c-process-management.md)
