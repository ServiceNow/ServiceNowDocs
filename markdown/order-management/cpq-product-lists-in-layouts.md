...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/cpq-product-lists-in-layouts.html
release: australia
topic_type: concept
...
\[Omitted image "cpq-product-list-column-properties.png"\] Alt text: Product list column properties
...
For more information, see [Displaying multiple product lists in layouts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/order-management/displaying_multiple_productlists_in_layouts.md).
