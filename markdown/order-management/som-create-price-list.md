...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/som-create-price-list.html
release: xanadu
topic_type: task
...
[Create a price list line](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/som-create-price-list-line.md) for the price list.
