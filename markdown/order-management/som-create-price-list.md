...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/som-create-price-list.html
release: zurich
topic_type: task
...
[Create a price list line](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/som-create-price-list-line.md) for the price list.
