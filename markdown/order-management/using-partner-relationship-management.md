...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/using-partner-relationship-management.html
release: yokohama
topic_type: concept
...
Channel partners can perform the following actions through the **Support** feature.-   View and track cases.
-   Raise an inquiry and connect with the enterprise.
-   Register external staff members into a partner organization.
-   Move internal staff members within different partner organizations.

To learn more about registering a case, see [Raise an inquiry on Partner Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/raise-an-inquiry-on-partner-portal.md).

To learn more about registering staff members, see [Register a member on Partner portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/register-a-member-on-partner-portal.md).
...
Explore the knowledge base to access information that you require.
...
View a list of all the partner organizations associated with the channel partner.You can export the partner details into PDF, Excel, or CSV formats. To learn more about partner organizations, see [Channel partner table fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/channel-partner-table-fields.md).
...
[Raise an inquiry on Partner Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/raise-an-inquiry-on-partner-portal.md)

[Register a member on Partner portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/register-a-member-on-partner-portal.md)
