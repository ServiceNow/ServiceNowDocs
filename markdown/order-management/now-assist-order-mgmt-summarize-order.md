...
1.  In the CSM Configurable Workspace, select the List ![](../../../reuse/icons/product-icons/list-outline-24.svg) icon.
...
3.  In the Customer Order summary by Now Assist, select **Summarize**.
    ...
    ![](../image/na-om-summarize-order.png)
...
<table id="choicetable_z3p_sn2_3hc"><thead><tr><th align="left" id="d51129e134">

Option

</th><th align="left" id="d51129e137">

Procedure

</th></tr></thead><tbody><tr><td id="d51129e143">
