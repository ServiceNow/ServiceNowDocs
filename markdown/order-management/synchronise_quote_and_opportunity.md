...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/synchronise\_quote\_and\_opportunity.html
release: zurich
topic_type: concept
...
To learn more about establishing a sync between quote and opportunity and automatically enable sync, see [Sync a quote with an opportunity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/som-sync-quote-with-opportunity.md).
