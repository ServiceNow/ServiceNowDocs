...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/order-management/import-product-catalog-entities.html
release: xanadu
topic_type: task
...
3.  If the following message appears, select the link to change the application scope to Product Catalog Management.
    ...
    \[Omitted image "e-i-import-edit-message-screen.png"\] Alt text:
...
-   [View import job status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/order-management/view-import-job-status.md)
