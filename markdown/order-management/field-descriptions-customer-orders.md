...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/field-descriptions-customer-orders.html
release: zurich
...
**Note:** Both customer orders and service orders have an assigned ID with a prefix of ORD. To learn more about order types, see [Order types in Sales Customer Relationship Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/som-order-types.md).
...
[Add subscription pricing to an order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/add-subscription-pricing-to-an-order.md)
