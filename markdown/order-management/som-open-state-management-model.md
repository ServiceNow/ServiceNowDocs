...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/order-management/som-open-state-management-model.html
release: brazil
topic_type: concept
