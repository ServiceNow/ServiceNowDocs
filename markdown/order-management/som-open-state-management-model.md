...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/order-management/som-open-state-management-model.html
release: australia
topic_type: concept
