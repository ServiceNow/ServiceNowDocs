...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/cpq-migrating-env-to-env.html
release: zurich
topic_type: task
...
Understand ServiceNow CPQ upgrade windows, described in [ServiceNow CPQ Upgrade Schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/logik_io_upgrade_schedule.md). Schedule your migration to avoid published upgrade windows. If you have questions regarding this topic, reach out to your Customer Success Manager.
...
2.  Modify the migration package.
    ...
    2.  Open the blueprint.yaml file in a text editor.
        ...
        For a description of how this parameter affects the blueprint migration, see [The fullBlueprintMigration parameter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/cpq-fullblueprintmigration-param.md).
...
[ServiceNow CPQ Upgrade Schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/logik_io_upgrade_schedule.md)

[Migrate a blueprint to an SFDC-integrated destination](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/cpq-migrating-to-sfdc.md)
