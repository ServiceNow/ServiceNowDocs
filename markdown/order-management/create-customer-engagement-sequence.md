...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/order-management/create-customer-engagement-sequence.html
release: yokohama
topic_type: task
last_updated: "2025-07-31"
reading_time_minutes: 3
breadcrumb: [Configuring Customer Engagement Sequences, Configure, Sales Customer Relationship Management]
---
...
9.  Exit early from the sequence by selecting the **Customer Engagement Sequences** &gt; **Update Sequence Task** activity from the activity picker.
    ...
    For more information on adding an activity, see .
...
13. View the sequence in the CSM/FSM Workspace by selecting the List icon \[Omitted image "list-outline-24.svg"\] Alt text: and navigating to **Sequences** &gt; **All Sequences**.


## What to do next

View sequence tasks and execute sequence steps. See [Using Customer Engagement Sequences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/order-management/using-customer-engagement-sequences.md).
