...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/order-management/create-customer-engagement-sequence.html
release: zurich
topic_type: task
...
Check whether features you need to access are supported by reviewing the table in [Compatibility information for Customer Engagement Sequences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/compatibility-matrix-upgrade-info.md).

Your instance must be integrated with platforms such as Amazon Connect.

Delegated developer roles should be assigned to designated users. For more information, see [Grant delegated developer permissions for managing sequences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/grant-delegated-developer-permissions.md).
...
8.  Define trigger conditions that initiate a sequence.
    ...
    For more information, see [Define trigger conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/define-trigger-conditions.md).
...
11. Add decision nodes to activate the next stage in the playbook based on the outcome of the previous stage.
    ...
    For more information, see [Add decision nodes to a sequence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/add-decision-nodes-sequences.md).
...
13. Update the sequence task record by selecting the **Customer Engagement Sequences** &gt; **Update sequence task** activity from the activity picker.
    ...
    You can also use the Update sequence task activity to exit early from the sequence. For more information, see [Add the Update sequence task activity to a sequence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/add-update-sequence-task-activity.md).
...
[Assign runtime permissions while creating sequences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/configure-runtime-permission-sequence-playbooks.md).

-   **[Define trigger conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/define-trigger-conditions.md)**  
...
-   **[Add a schedule call activity to a telesales workflow sequence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/add-schedule-call-activity.md)**  
...
-   **[Add the Update sequence task activity to a sequence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/add-update-sequence-task-activity.md)**  
...
**Parent Topic:**[Using Customer Engagement Sequences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/order-management/using-customer-engagement-sequences.md)
