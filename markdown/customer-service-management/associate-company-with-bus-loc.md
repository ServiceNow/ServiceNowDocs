...
|Task|Description|
|----|-----------|
|[Add a new company](https://www.servicenow.com/docs/access?context=t_AddANewCompany&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)|Create a company record that represents vendors, manufacturers, or customers with whom you do business.|
...
Add the **Company** field to an internal or an external business location form using the form layout. For more information, see [Add fields to a form layout in Table Builder](https://www.servicenow.com/docs/access?context=add-form-fields&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US).
