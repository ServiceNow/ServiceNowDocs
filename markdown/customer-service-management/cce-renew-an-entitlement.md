...
You cannot renew an entitlement when it is in Canceled state or it does not have an end date. For more info, see [Creating, approving, and fulfilling customer \(product\) orders](https://www.servicenow.com/docs/access?context=order-mgt-fulfilling-customer-orders&version=yokohama&pubname=yokohama-order-management&ft:locale=en-US).
