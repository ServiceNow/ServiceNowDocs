...
3.  Select a table from the UX Form Headers list.
    ...
    You can also create a UX Form Header record. For more information, see [Set up a form header in CSM Configurable Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/config-csm-config-ws-form-header.md).
