...
You can activate the Customer Service plugin \(com.sn\_customerservice\) if you have the admin role. This plugin includes demo data and activates related plugins if they aren’t already active.
