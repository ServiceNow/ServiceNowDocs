...
description: You can activate the Customer Service plugin \(com.sn\_customerservice\) if you have the admin role. This plugin includes demo data and activates related plugins if they are not already active.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/t\_ActivateCustomerService.html
release: xanadu
topic_type: task
...
You can activate the Customer Service plugin \(com.sn\_customerservice\) if you have the admin role. This plugin includes demo data and activates related plugins if they are not already active.
...
The Customer Service Management plugin activates several related plugins if they are not already active. For more information, see [Plugins activated with Customer Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/plugins-activated-with-csm.md).
