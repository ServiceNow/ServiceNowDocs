...
The Customer Service Management plugin activates several related plugins if they are not already active. For more information, see [Plugins activated with Customer Service Management](../reference/plugins-activated-with-csm.md).
