...
breadcrumb: [External business location \(EBL\) as a fulfiller, Service Model Foundation cases, Service Model Foundation overview, Configure Service Model Foundation, Data models, Set up your environment, Configure, Customer Service Management]
---
