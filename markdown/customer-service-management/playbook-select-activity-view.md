...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/playbook-select-activity-view.html
release: xanadu
...
Users with the system administrator role can select the [playbook activity view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-playbook-layout.md) in the playbook component configuration in UI Builder.

## Procedure

1.  Navigate to UI Builder and open the playbook component.

2.  Click the playbook component.
