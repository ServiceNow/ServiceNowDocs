...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/map-inputs-in-decision-guidance-node.html
release: xanadu
topic_type: task
...
For more information about input mapping and exceptions related to input mapping, see [Linking inputs in decision tree nodes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/guided-decision-tree-input-mapping.md).
