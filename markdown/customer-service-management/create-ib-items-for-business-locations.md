...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/create-ib-items-for-business-locations.html
release: yokohama
topic_type: task
...
4.  On the form, fill in the fields.
    ...
    |Configuration Item|Reference to another sold product if the sold product contains child components.|
...
[Create an install base item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/create-install-base-item.md)
