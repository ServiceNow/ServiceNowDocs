...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/install-task-intelligence-cs-app.html
release: xanadu
topic_type: task
...
For more information, see [Components installed with Task Intelligence for Customer Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/case-categorization-components.md).
