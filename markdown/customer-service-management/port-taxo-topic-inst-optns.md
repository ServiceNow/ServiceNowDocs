...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/port-taxo-topic-inst-optns.html
release: australia
...
Max topic cards to display

</td><td>

Number of topic cards to appear by default on the widget.The default value is 8.
...
Option to display an icon for the taxonomy topics.By default, the card displays an icon for topic cards.
...
Name for the **View all** button. The default text is `View all`.

</td></tr><tr><td>

Browse taxonomy page
...
[Add and configure the Portal Taxonomy Topic widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/customer-self-service-and-omnichannel-engagement/add-conf-port-taxo-topic.md)
