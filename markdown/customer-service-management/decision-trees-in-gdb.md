...
As a process owner or business analyst, you can configure [decision tree](https://www.servicenow.com/docs/access?context=now-platform-glossary&version=zurich&pubname=zurich-glossary&section=gloss-decision-tree&ft:locale=en-US) by adding nodes, defining paths, and attaching guidances through Decision Tree Builder. For more information, see [Decision tree nodes](guided-decision-tree-node-types.md).
