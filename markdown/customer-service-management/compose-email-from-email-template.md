...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/compose-email-from-email-template.html
release: zurich
topic_type: task
