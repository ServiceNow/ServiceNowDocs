...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/create-install-base-characteristics.html
release: australia
topic_type: task
