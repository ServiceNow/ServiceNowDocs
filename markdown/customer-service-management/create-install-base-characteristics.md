...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/create-install-base-characteristics.html
release: yokohama
...
Create a set of configurable characteristics for an install base item on the Customer Service Management \(CSM\) application. You can then view the details about the install base item and the services that are associated with it.
