...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/configure-guidance-in-gdb.html
release: yokohama
...
Verify that the guidances you want to use exist or create them. For more information, see [Create a guidance in the Core UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/create-guidances.md).
...
[Add a next node that is a question node after a guidance node.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/configure-start-node-gdb.md)
