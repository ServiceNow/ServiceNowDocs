...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/configure-guidance-in-gdb.html
release: xanadu
topic_type: task
...
Verify that the guidances you want to use exist or create them. For more information, see [Create a guidance in the Core UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/create-guidances.md).
...
[Add a next node that is a question node after a guidance node.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/configure-start-node-gdb.md)
