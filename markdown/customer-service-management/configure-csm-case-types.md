...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/configure-csm-case-types.html
release: yokohama
topic_type: task
...
[Enable the **Create Case** UI action for case type selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/config-csm-config-ws-ui-action.md)

</td><td>

This procedure adds the **Create Case** UI action to records in the configured table. Selecting this UI action displays the [case type selector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/csm-case-type-select-modals.md).
...
-   Quick messages
-   Reports
For more information, see [Manage customer service case types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/manage-csm-case-types.md).
