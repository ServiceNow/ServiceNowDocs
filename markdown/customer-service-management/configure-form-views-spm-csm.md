...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/configure-form-views-spm-csm.html
release: yokohama
topic_type: task
...
2.  Add the sn\_customerservice\_manager role.
 If you do not see the **Edit** button enabled, see [Assign roles for Service Portfolio Management integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/assign-roles-spm-csm.md) for more details.
