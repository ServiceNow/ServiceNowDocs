...
After saving the intake record, the agent can see the [Order case record page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/csm-order-ops-order-case-record-page.md) with the case line items created either from customer orders or customer order lines.
