...
[Implement the Interaction Controls Component \(ICC\) for contact center voice call and callback integration](../task/enable-icc-for-ccaas.md)
...
[Components installed with Omnichannel Callback](https://www.servicenow.com/docs/access?context=installed-with-omnichannel-callback&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US)
