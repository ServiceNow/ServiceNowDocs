...
</table>For detailed information on the granular admin roles in Custmer Data Foundation \(CDF\) and their associated privileges, see [Platform security granular admin roles](https://www.servicenow.com/docs/access?context=platsec-granular-roles&version=australia&pubname=australia-platform-security&ft:locale=en-US).
