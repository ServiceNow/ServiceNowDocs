...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/install\_base\_hierarchy\_visualisation.html
release: yokohama
topic_type: concept
...
-   Create a case from the node.
    ...
    To learn about different case types and how to create a case from an install base node, see [Customer service case types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/customer-service-case-types.md).
