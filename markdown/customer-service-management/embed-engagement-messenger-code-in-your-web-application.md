...
<table id="choicetable_vhq_vtl_p4b"><thead><tr><th align="left" id="d72604e153">

Authentication type

</th><th align="left" id="d72604e156">

Action

</th></tr></thead><tbody><tr><td id="d72604e162">
...
9.  To modify the embed code to set the preferred language in which Engagement Messenger is displayed, do one of the following.
    ...
    **Note:** Beginning with the Xanadu release, the upgraded customers can also modify the embed code to enable language switching.
