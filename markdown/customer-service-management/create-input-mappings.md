...
For more information about input mapping in a decision node or a guidance node, see [Linking inputs in decision tree nodes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/guided-decision-tree-input-mapping.md).
