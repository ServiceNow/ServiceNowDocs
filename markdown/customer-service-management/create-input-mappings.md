...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/create-input-mappings.html
release: xanadu
...
For more information about input mapping in a decision node or a guidance node, see [Linking inputs in decision tree nodes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/guided-decision-tree-input-mapping.md).
