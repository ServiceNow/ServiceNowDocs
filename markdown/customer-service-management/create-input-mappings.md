...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/create-input-mappings.html
release: australia
topic_type: task
...
For more information about input mapping in a decision node or a guidance node, see [Linking inputs in decision tree nodes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/guided-decision-tree-input-mapping.md).
