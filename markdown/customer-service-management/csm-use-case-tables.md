...
2.  Install Base Item table \[sn\_install\_base\_item\] in CSM
    ...
    Represents the products installed or in use by an account or consumer. Install Base Items are CIs consumed by the customer and generally reference the Application Services table \[cmdb\_ci\_discovered\_service\] for SaaS products.
