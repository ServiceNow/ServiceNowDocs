...
You must have a trained default estimated time to resolve a case regression solution. For more information, see [Configure the default estimated time to resolve a case regression definition](ettr_configure.md).
