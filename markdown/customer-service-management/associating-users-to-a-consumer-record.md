...
5.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Create a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_CreateAUser.md).
...
Associate an existing user with a consumer record. For more information, see [Associate an existing user with a consumer record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/associating-users-to-a-consumer-record.md).
