...
5.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Create a user](https://www.servicenow.com/docs/access?context=t_CreateAUser&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
