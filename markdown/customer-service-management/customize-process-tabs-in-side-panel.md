...
3.  Select the desired page collection.
    ...
    A [page collection](https://www.servicenow.com/docs/access?context=page-collections&version=zurich&pubname=zurich-application-development&ft:locale=en-US) is a group of pages that you can use in multiple experiences.
...
[Customize UI Builder pages using components](https://www.servicenow.com/docs/access?context=work-components&version=zurich&pubname=zurich-application-development&ft:locale=en-US)
