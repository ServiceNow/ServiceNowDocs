...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/t\_TargetCommViewPubOnPortal.html
release: australia
topic_type: task
...
The **Publications** link on the customer service portal displays a list of current publications that is sorted by publication number.

**Note:** After a publication reaches its expiration date, it is automatically removed from the Publications list.
