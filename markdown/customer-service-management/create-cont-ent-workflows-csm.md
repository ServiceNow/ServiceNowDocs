...
-   Sales Cycle Type: In the Code field, enter **RENEW** and set the Active option to **True**. For more info, see [Create a sales cycle for an opportunity](https://www.servicenow.com/docs/access?context=opportunity-management-sales-cycle-types&version=zurich&pubname=zurich-order-management&ft:locale=en-US).
-   Opportunity Stage: In the Name field, enter **Develop** and set the Active option to **True**. For more info, see [Create opportunity stages](https://www.servicenow.com/docs/access?context=opportunity-management-opportunity-stages&version=zurich&pubname=zurich-order-management&ft:locale=en-US).
