...
For more information about the timeline features, see [CSM Configurable Workspace form ribbon and components](../../../administer/workspace/reference/csm-agent-workspace-ribbon.md#section_s4w_hms_rdb).
