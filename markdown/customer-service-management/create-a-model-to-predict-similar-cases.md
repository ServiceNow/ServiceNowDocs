...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/create-a-model-to-predict-similar-cases.html
release: yokohama
topic_type: concept
...
Find out how to [Create a custom similar case model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/create-a-custom-similar-case-model.md), [Edit a model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/edit-a-case-prediction-model.md), and [Export a model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/export-a-task-intelligence-model.md)
