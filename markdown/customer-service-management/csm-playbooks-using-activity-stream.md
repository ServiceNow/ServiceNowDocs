...
Click the More options icon \(![More options icon.](../image/contextual-side-panel-more-options.png)\) to expand and collapse posts.-   **Expand all posts**: Expands posts to view additional details.
