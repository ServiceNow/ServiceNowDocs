...
description: Create a case regarding a question or issue on your install base from the Customer Service homepage.
locale: en-US
release: yokohama
topic_type: task
...
The install base item that you have a question on or issue with.
