...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/customer-life-cycle-management-workflows.html
release: yokohama
topic_type: concept
...
Enables companies to define the products and services they market, sell, and deliver to customers.To learn more about product catalogs, see [Product Catalog Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/order-management/product-catalog-managment.md).
...
Enables customers to compose and build the workflows for various entities. To learn more about the Lead to Cash Core plugin, see [Lead to Cash](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/lead-to-cash-workflows.md).
...
To learn more about the configurations, see [Entity configuration and mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/entity-configuration-and-mapping.md).

**Related topics**  


[Modify a sold product and hierarchy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/modify-a-sold-product.md)

[Modify a sold product to create a quote](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/modify_a_sold_product_to_create_a_quote.md)

[Resume a single sold product](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/resuming_sold_products.md)

[Resume multiple sold products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/resuming_sold_products.md)

[Disconnect a single sold product](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/disconnecting_sold_products.md)

[Disconnect multiple sold products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/disconnecting_sold_products.md)

[Suspend a single sold product](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/supending_sold_products.md)

[Suspend multiple sold products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/supending_sold_products.md)
