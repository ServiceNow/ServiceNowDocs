...
The reference to the Inbound Request Configuration table.
...
Inbound request that must be processed before the current request.
...
This user can create, read, and update actions on the requests in the inbound request table.**Note:** For Sales and Order management requests, the user doesn't have access to the **requested\_flow** field.
...
This user can perform only the read operation on sales and order management requests in the inbound request table.**Note:** For Sales and Order management requests, the user doesn't have access to the **response\_payload**, **payload**, or **requested\_flow** fields.
...
This user can read all requests related to sales and order management requests.**Note:** For sales and order management requests, the user doesn't have access to the **response\_payload**, **payload**, or **requested\_flow** fields.
...
[Inbound Request Configuration table](inbound-request-configuration-table.md)
