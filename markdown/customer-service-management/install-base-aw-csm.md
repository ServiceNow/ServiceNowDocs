...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/install-base-aw-csm.html
release: xanadu
...
Ensure that the Customer Service Install Base Management plugin \(com.snc.install\_base\) is activated.

Role required: sn\_customerservice\_agent

## About this task

You can view information about the products and the services that a customer has purchased, how they are delivered, and what additional components are available with the product models.
...
7.  View the details of the install base item by opening an install base item.
    ...
    **Note:** You can also use the right navigation pane to view the install base items and related list.
