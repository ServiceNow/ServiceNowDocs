...
description: Use the auto close resolved cases feature to automatically close cases in the Resolved state if customers do not take any action.
locale: en-US
release: xanadu
topic_type: task
...
Use the auto close resolved cases feature to automatically close cases in the Resolved state if customers do not take any action.
