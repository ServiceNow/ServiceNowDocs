...
-   You also need to configure EC AI Homepage Search widget, Typeahead Search widget, and AI Search Assist widget for public access to enable AI search for unauthenticated users. For more information, see [Enable AI Search in Engagement Messenger for unauthenticated users](../task/enable-ai-guest-user.md).
...
-   In Firefox browser, AI Search results are not displayed on Engagement Messenger home page.
-   If AI Search is not enabled:
    -   Search feature will not be available for users if messenger module is created on or after version 5.6.
    -   Zing search will be used for messenger modules created before version 5.6.
