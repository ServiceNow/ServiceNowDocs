...
1.  [Install Employee Health Screening](https://www.servicenow.com/docs/access?context=install-emp-health-screening&version=yokohama&pubname=yokohama-employee-service-management&ft:locale=en-US).
