...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/customer-self-service-and-omnichannel-engagement/portal-footer-widget-social-links.html
release: zurich
...
5.  On the Menu item form, fill in the fields.
    ...
    For a description of the field values, see [Menu Item form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/menu-item-form.md).
