...
3.  Publish the following topics:
    ...
    [duplicate the topics](https://www.servicenow.com/docs/access?context=duplicate-virtual-agent-topic&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
...
6.  Test the topics.
    ...
    See [Test Virtual Agent topics](https://www.servicenow.com/docs/access?context=va-designer-testing&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US) for more information.
