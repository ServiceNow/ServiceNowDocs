...
3.  Refer to [Create or configure a service channel](https://www.servicenow.com/docs/access?context=awa-create-service-channel&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US) for detailed information regarding the Service Channel Walk-up form values and conditions.
