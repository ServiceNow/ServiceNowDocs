...
1.  Configure the instance option.
    ...
    3.  In **Heading**, enter the desired text.
        ...
        For details on filling the Heading field, see [Portal Banner widget instance options form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/banner-widget-inst-options.md).
