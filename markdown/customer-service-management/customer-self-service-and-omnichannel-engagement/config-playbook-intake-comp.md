...
breadcrumb: [Playbook intake component, Configure web components, Configure Web Embeddables, Set up self-service, Configure, Customer Service Management]
---
...
5.  Configure the Playbook intake component instance properties.
    ...
    -   For a description of the component properties related to the Playbook intake component instance, see [Component properties for the Playbook intake](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/we-playbook-intake-comp-prop.md).
