...
10. In the **Widget Option Schema** field, modify the JSON code to update the configuration of the widget that you've added.
    ...
    For more information on each JSON parameters of the Portal Quick Links widget, see [Portal Banner widget JSON parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/r-port-banner-widget-json-schema.md).
