...
Users with these roles are required to use multi-factor authentication. For more information, see [Configure user-based multi-factor criteria](https://www.servicenow.com/docs/access?context=t_RequireMultifactorAuthForAUser&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
