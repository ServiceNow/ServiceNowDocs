...
[Create an inbound REST API rate limit](https://www.servicenow.com/docs/access?context=create-REST-API-rate-limits&version=australia&pubname=australia-api-reference&ft:locale=en-US)

[Rate limit rule form for guest user access to catalog items](../reference/rate-limit-for-guest-user-access-to-catalog-items.md)
