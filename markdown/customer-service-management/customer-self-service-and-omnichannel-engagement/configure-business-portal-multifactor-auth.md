...
Enter a number in minutes that specifies how long the reset code is valid. See [Log on with multi-factor authentication](https://www.servicenow.com/docs/access?context=t_LogOnWithMultifactorAuth&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).-   Type: string
-   Default value: 10
-   Location: **Multi-factor Authentication** &gt; **Properties**
...
Users with this role is required to use multi-factor authentication. For more information, see [Configure user-based multi-factor criteria](https://www.servicenow.com/docs/access?context=t_RequireMultifactorAuthForAUser&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
