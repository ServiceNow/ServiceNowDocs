...
breadcrumb: [AI Search Assist for authenticated external users, Configure the Customer and Consumer Service Portals, Configure portals, Set up self-service, Configure, Customer Service Management]
---
...
**Parent Topic:**[AI Search Assist for authenticated external users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/customer-self-service-and-omnichannel-engagement/enable-ai-search-for-portal-auth-external.md)
