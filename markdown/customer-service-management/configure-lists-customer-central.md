...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/configure-lists-customer-central.html
release: yokohama
...
Select the name of the view that has the set of columns to display for this list. For information on how to create a view, see [Configure the list layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/list-administration/t_ConfigureTheListLayout.md).
