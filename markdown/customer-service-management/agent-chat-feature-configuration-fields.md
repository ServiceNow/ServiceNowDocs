...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/agent-chat-feature-configuration-fields.html
release: xanadu
...
Determines the chat options for managing various conversation features.For more information, see [Chat Setup configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/em-advanced-chat-setup.md).
