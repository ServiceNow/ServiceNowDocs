...
2.  Select a ribbon setting for your table.
    ...
    If a ribbon setting doesn’t exist for your table, you can create one. For more information, see [Set up a ribbon configuration in CRM Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/config-csm-config-ws-ribbon.md).
