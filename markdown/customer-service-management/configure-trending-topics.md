...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/configure-trending-topics.html
release: xanadu
...
Access the menus and use the modules to train the solution definitions to identify trending case topics. For more details, see [Trending case topics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/trending-case-topics.md).
