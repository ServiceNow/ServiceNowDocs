...
description: Use service definitions to create connections between products, services, and case types. Customers can use these definitions to quickly discover and request the services they need. Agents can use these definitions to create cases of the right type to support those service requests.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/csm-service-definitions.html
release: yokohama
topic_type: concept
...
When you create service definitions for each of the services that you offer, agents can use the defined services to create cases and cases tasks of the right type for customer issues and requests. When creating these cases and case tasks, agents can do the following:
...
In the Washington DC release, the **ID** field replaces the **Number** field.
...
|[Associate one or more products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/service-def-associate-products.md)|Services can be product-specific or general services can be created and made available for all products.|
|[Associate a case type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/service-def-associate-case-type.md)|A case type provides the processes and data that an agent needs to resolve a case for a specific type of service.|
|[Associate a playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/service-def-associate-playbook.md)|A playbook provides agents with step-by-step guidance for resolving a specific type of case.|
...
|[Associate a record producer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/service-def-config-catalog-items.md)|Record producers enable end users to request services from the Customer and Consumer Portals.|
...
|[Add a case type to the Case interceptor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/service-def-config-case-interceptor.md)|To configure this feature for use in the Core UI, add case types to the Case interceptor.|

## Agent experience

Associating a case type with a service definition automates the case type selection process for agents. From CSM Configurable Workspace, agents can quickly [create cases of the right case type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/create-case-of-specific-case-type.md) based on customer context.

When creating cases, agents can select the appropriate service for a customer based on the products that the customer owns. The Product Service Select version of the [case type selector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/csm-case-type-select-modals.md) enables agents to do the following:

-   Create cases from case and case type list views.
-   Create cases from several [types of records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/csm-case-type-select-modals.md):
