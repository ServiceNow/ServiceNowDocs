...
|[Add a case type to the Case interceptor](../task/service-def-config-case-interceptor.md)|To configure this feature for use in the Core UI, add case types to the Case interceptor.|
...
From the Customer and Consumer Service Portals, end users can view a list of services that are available for the sold products and install base items that they own.
