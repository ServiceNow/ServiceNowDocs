...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/csm-service-definitions.html
release: zurich
topic_type: concept
...
|Task|Description|
|----|-----------|
|[Create a service definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/create-csm-service-definition.md)|The service definition record stores details about a service that is provided to customers. This information includes a name for the service definition, the target table, and the service category.|
|[Associate one or more products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/service-def-associate-products.md)|Services can be product-specific or general services can be created and made available for all products.|
|[Associate a case type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/service-def-associate-case-type.md)|A case type provides the processes and data that an agent needs to resolve a case for a specific type of service.|
|[Associate a playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/service-def-associate-playbook.md)|A playbook provides agents with step-by-step guidance for resolving a specific type of case.|
...
|[Associate a record producer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/service-def-config-catalog-items.md)|Record producers enable end users to request services from the Customer and Consumer Portals.|
...
|[Add a case type to the Case interceptor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/service-def-config-case-interceptor.md)|Add case types to the Case interceptor, to configure this feature for use in the Core UI.|
