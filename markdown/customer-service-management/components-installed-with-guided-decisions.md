...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/components-installed-with-guided-decisions.html
release: yokohama
topic_type: reference
last_updated: "2025-01-30"
reading_time_minutes: 4
breadcrumb: [Install the Guided Decisions Experience application, Guided Decisions configuration, Agent tools, Organize agent workspaces, Configuring Customer Service Management, Customer Service Management]
---
