...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/migration-agent-chat.html
release: xanadu
topic_type: concept
...
Parameters that are hidden in UI Builder \(UIB\) are not configurable in UIB. These parameters are used for specific customer workflow use cases.
