...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/communities/communities-permissions.html
release: zurich
product: Communities
...
-   **[Create a forum user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/communities/add-user.md)**  
You can create forum users, which you then use to define memberships to a forum.
-   **[Create a permission](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/communities/create-permission.md)**  
Create a permission to use to define a user's access to a forum and the content in the forum.
-   **[Clone a permission](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/communities/clone-permission.md)**  
