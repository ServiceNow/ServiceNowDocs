...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/communities/communities-permissions.html
release: yokohama
product: Communities
...
-   **[Create a permission](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/communities/create-permission.md)**  
Create a permission to use to define a user's access to a forum and the content in the forum.
-   **[Clone a permission](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/communities/clone-permission.md)**  
