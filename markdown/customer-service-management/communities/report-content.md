...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/communities/report-content.html
release: zurich
product: Communities
...
2.  Click the **...** icon and then click**Report Content**.

3.  From the list, select the reason you are reporting the content from the list and add **Additional Comments**.
