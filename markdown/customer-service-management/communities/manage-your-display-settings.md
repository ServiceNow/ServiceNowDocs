...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/communities/manage-your-display-settings.html
release: yokohama
product: Communities
...
breadcrumb: [Use a community profile, Use a community, Communities, Customer Service Management]
---
...
<table id="table_ah3_pbt_xz"><thead><tr><th>
...
Visible to all users, including non-logged in users.
...
Visible to yourself and administrators. If an administrator finds inappropriate content on your profile, the administrator can change the display settings to **Only me** until the content is modified.
...
Visible to all users who access the community after logging in.
...
**Parent Topic:**[Use a community profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/communities/community-profile.md)
