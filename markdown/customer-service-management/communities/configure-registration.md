...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/communities/configure-registration.html
release: zurich
product: Communities
...
-   [Configure the required strength for passwords](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/config-pwd-strength-rqmts.md).
-   [Create an email template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_CreateAnEmailTemplate.md) and content. The email template that you can change is **communities.ext.regn.confirm**.
