...
-   [Configure the required strength for passwords](https://www.servicenow.com/docs/access?context=config-pwd-strength-rqmts&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
-   [Create an email template](https://www.servicenow.com/docs/access?context=t_CreateAnEmailTemplate&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) and content. The email template that you can change is **communities.ext.regn.confirm**.
