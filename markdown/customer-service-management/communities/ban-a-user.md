...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/communities/ban-a-user.html
release: xanadu
product: Communities
...
3.  Select the Preview icon \(\[Omitted image "preview-record.png"\] Alt text: Preview icon\) next to the user.
