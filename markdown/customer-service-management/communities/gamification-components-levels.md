...
In the community portal, users can see level range names and point totals in the [gamification user interface components](../concept/communities-gamification-UI.md).
