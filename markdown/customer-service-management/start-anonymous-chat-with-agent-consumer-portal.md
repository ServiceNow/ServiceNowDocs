...
4.  Select \[Omitted image "contact-support-icon.png"\] Alt text: Connect Support icon. and then **Call Support** to talk to a person instead of a virtual agent.
...
[Guest users experience on Consumer Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/guest-users-experience-consumer-portal.md)
