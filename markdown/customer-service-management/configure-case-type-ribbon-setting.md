...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/configure-case-type-ribbon-setting.html
release: yokohama
topic_type: task
...
To create ribbon settings, see Set up ribbons in workspace.
