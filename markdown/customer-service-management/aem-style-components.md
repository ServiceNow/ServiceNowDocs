...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/aem-style-components.html
release: xanadu
...
4.  Specify the initializeCSS function for a component in the format `<component_type>;<class_name>;<color_variable_1>;<color_variable_2>;<color_variable_n>`.
    ...
    -   color\_variable\_1, color\_variable\_2, color\_variable\_n: The color variables that you specify for the HTML elements in a component. For more information, see the [Color variable settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/aem-style-components.md) table.
