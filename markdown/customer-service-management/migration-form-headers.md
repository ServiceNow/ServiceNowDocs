...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/migration-form-headers.html
release: yokohama
topic_type: concept
...
For additional information, see [Set up a form header in Configurable Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/config-csm-config-ws-form-header.md).
