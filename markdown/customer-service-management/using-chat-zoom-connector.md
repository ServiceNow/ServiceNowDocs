...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/using-chat-zoom-connector.html
release: zurich
topic_type: concept
...
Configure the Chat Zoom Connector application for initiating Zoom meetings from customer chats. For more information, see [Configure Chat Zoom Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/config-chat-zoom-connector.md).
