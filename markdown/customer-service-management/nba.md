...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/nba.html
release: yokohama
topic_type: concept
...
For end-to-end configurations of recommended actions for specific scenarios, see [Example configurations of recommended actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/recommended-actions-use-case.md).

## Action types for Recommended Actions

With the Recommended Actions application, you can create the following types of actions for agents to take. For more information, see [Recommended Actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/configure-nba.md).
...
[Install the Recommended Actions application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/install-recommended-actions-cs-app.md)
...
[Assign roles to Recommended Actions users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/ra-csm-installed-components.md)
...
[Configuring the Recommended Actions application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/configure-recommended-actions.md)
