...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/csm-task-intel-create-language-solution.html
release: zurich
topic_type: concept
...
-   **Prerequisite**
    ...
    For more information, see [Configure language detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/case-language-detection-configure.md).
