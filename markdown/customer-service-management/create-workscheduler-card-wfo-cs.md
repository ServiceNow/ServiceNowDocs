...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/create-workscheduler-card-wfo-cs.html
release: zurich
topic_type: task
...
-   **[Create a client state parameter for Work scheduler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/work-sched-create-client-state-params-wfo-cs.md)**  
Add custom client state parameter values to add properties to the card components.
-   **[Create page scripts for Work scheduler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/work-sched-create-page-scripts-wfo-cs.md)**  
...
-   **[Define the workItem property in the Work scheduler page configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/work-sched-create-page-properties-wfo-cs.md)**  
...
-   **[Define event mappings for Work scheduler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/work-sched-event-mapping-wfo-cs.md)**  
...
-   **[Configure container components for Work scheduler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/work-sched-card-based-container-wfo-cs.md)**  
Present information in an intuitive format using the Card Base Container component.
-   **[Configure a Work scheduler card heading component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/work-sched-card-based-header-wfo-cs.md)**  
Customize the Work scheduler heading component to display the title based on your needs.
-   **[Configure a display type component for a Work scheduler card](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/work-sched-stacked-component-wfo-cs.md)**  
Add the **Label value stacked** display work item fields within the card.
-   **[Configure an avatar component for Work scheduler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/work-sched-avatar-component-wfo-cs.md)**  
Use the **Container** component to add an avatar and the user name of the work item assignee.
-   **[Associate a work scheduler card to the work configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/associate-card-config-wfo-cs.md)**  
