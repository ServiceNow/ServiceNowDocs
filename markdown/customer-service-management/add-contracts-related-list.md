...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/add-contracts-related-list.html
release: yokohama
...
breadcrumb: [Administer Customer Contracts and Entitlements, Administer Customer Service Management, Customer Service Management]
---
...
<table id="choicetable_zqd_tnc_pzb"><thead><tr><th align="left" id="d226423e65">

Add to

</th><th align="left" id="d226423e68">

Procedure

</th></tr></thead><tbody><tr><td id="d226423e74">
...
</td></tr><tr><td id="d226423e140">

**Households**

</td><td>

1.  Navigate to **All** &gt; **Customer Service** &gt; **Products** &gt; **Households**.
2.  Select the household.


</td></tr></tbody>
</table>2.  From the Additional actions menu, select **Configure** &gt; **Related Lists**.

3.  Select **Workspace** in the **View name** field.

4.  Select the **Service Contracts** from the **Available** menu and move to the **Selected** menu using the **Add** option \(forward arrow\):
