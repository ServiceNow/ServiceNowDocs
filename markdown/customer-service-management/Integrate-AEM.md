...
2.  [Configuring authentication settings for ServiceNow services and components in AEM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/aem-setup-servicenow-authentication.md).

3.  [Configuring integration settings for ServiceNow services and components in AEM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/aem-integration-setup.md).
