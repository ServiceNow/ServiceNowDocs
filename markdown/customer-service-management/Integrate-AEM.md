...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/Integrate-AEM.html
release: australia
topic_type: task
...
2.  [Configuring authentication settings for ServiceNow services and components in AEM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/aem-setup-servicenow-authentication.md).

3.  [Configuring integration settings for ServiceNow services and components in AEM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/aem-integration-setup.md).
