...
-   Integration setup:
    ...
    **Note:** Ensure that your telephony or call center system is integrated with ServiceNow if call data needs to be captured directly. Additionally, set your status as **Available** in CSM Configurable Workspace to be able to receive call requests from customers.


Any modifications to the names or labels of these fields can result in issues with summarization generation.

**Note:** You cannot modify a skill's input data source.
