...
1.  Deactivate the Propose Solution UI action for the Customer Service Management application.
    ...
    2.  Configure the list to show the Application column.
        ...
        For more information on how to configure a list, see [Configure the list layout](https://www.servicenow.com/docs/access?context=t_ConfigureTheListLayout&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
