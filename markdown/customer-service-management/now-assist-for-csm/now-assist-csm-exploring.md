...
-   **Sentiment analysis on a case**
    ...
    ![The case shows that the sentiment is positive and improving](../image/sentiment-analysis-form-view-configurable-workspace.png "Sentiment analysis on a case")
