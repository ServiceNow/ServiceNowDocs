...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/now-assist-for-csm/configure-skills-in-domain-for-now-assist-for-csm.html
release: xanadu
...
breadcrumb: [Domain separation, Configure Now Assist for Customer Service Management \(CSM\), Now Assist for Customer Service Management \(CSM\), Customer Service Management]
---
