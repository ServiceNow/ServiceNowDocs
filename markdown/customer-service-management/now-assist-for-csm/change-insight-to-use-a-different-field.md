...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/now-assist-for-csm/change-insight-to-use-a-different-field.html
release: zurich
...
3.  Select **Insight Carousel Item 1** and [duplicate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/duplicate-components.md) it.
