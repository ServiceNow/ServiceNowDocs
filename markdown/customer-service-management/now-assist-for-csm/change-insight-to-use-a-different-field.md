...
3.  Select **Insight Carousel Item 1** and [duplicate](https://www.servicenow.com/docs/access?context=duplicate-components&version=zurich&pubname=zurich-application-development&ft:locale=en-US) it.
