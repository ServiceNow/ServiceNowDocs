...
Make sure that [AI search](https://www.servicenow.com/docs/access?context=configuring-ais&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) and [Now Assist in Virtual Agent](https://www.servicenow.com/docs/access?context=turn-on-the-subflows-and-actions-skill&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US) are enabled in the instance for the conversational subflows and actions to work.
...
<table id="choicetable_tvj_cqn_xyb"><thead><tr><th align="left" id="d33311e192">

Option

</th><th align="left" id="d33311e195">

Description

</th></tr></thead><tbody><tr><td id="d33311e201">
