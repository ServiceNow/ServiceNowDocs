...
![Dashboard with multiple charts showing trends, usage counts, errors, and performance metrics for activity response generation skill](../image/skills-performance-dashboard.png "Skills performance dashboard")
...
[Analyzing Now Assist usage](https://www.servicenow.com/docs/access?context=now-assist-analytics-and-monitoring&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)

[Now Assist Analytics dashboard indicator details](https://www.servicenow.com/docs/access?context=now-assist-analytics-dashboard-indicators&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)
