...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/now-assist-for-csm/case-summarization-generation-in-now-assist.html
release: yokohama
...
9.  Select **Define access** to determine who can access this skill.
    ...
    -   If no changes are made, the default role sn\_esm\_agentautomatically appear in **Define access** and **Select display**.
