...
2.  [Configure Now Assist in Virtual Agent.](https://www.servicenow.com/docs/access?context=configure-now-assist-va&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US)
...
5.  [Configure API credentials for OpenAI](https://www.servicenow.com/docs/access?context=configure-api-credentials-for-openai&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US).
