...
-   To access the Sentiment field, refer to the information available at these KB links:
    -   [Sentiment analysis card is missing in case records in both CSM UI16 and workspace UIs upon Now Assist CSM Sentiment Analysis feature activation](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB2105461).
