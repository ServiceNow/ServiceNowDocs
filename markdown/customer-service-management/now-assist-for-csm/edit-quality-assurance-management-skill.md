...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/now-assist-for-csm/edit-quality-assurance-management-skill.html
release: zurich
...
4.  In the **All available skills** or **Active skills** section, select the **Options** icon \[Omitted image "csm-ws-dashboards-more-actions-icon.png"\] next to the Automated quality assurance skill that you want to configure.

5.  Select **Edit**.

    -   The first step in the guided setup for Automated quality assurance skill is displayed.
...
6.  Proceed to the next step when you have finished configuring the current step by selecting **Save and continue**.
