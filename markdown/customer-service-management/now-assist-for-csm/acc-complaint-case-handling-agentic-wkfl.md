---
title: Configure Accelerate Complaint Case Handling workflow
...
# Configure Accelerate Complaint Case Handling workflow
...
3.  Define the key requirements.
    ...
    For more information on defining key requirements, refer to [General guidelines for creating AI agents and agentic workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/gg-creating-aia.md).
...
6.  Select channels and status.
    ...
    -   Engage via the Now Assist panel: When users send a message to ServiceNow Otto, they can discover and use this workflow.
