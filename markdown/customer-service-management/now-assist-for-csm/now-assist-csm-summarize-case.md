...
-   **Ask AI**- An open prompt for follow-up questions in the Now Assist panel, with a drop-down for additional options.
    ...
    **Note:**
    ...
    -   When the [Provide customer 360 insights AI agent workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/now-assist-for-csm/customer-service-management-ai-agent-collection-customer-360.md) is enabled in the ServiceNow Ottopanel, the **Ask AI** button is visible. When the AI agent workflow is turned off, the **Ask AI** button is hidden.
    ...
    -   To customize Ask AI drop-down menu and quick questions, see [Customize Case Insights Ask AI button system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/now-assist-for-csm/customize-ask-ai-system-properties.md)
...
4.  After generating case insights, you can take any of the following actions:
    ...
    -   Ask follow-up questions:
        ...
        -   The Now Assist panel opens and triggers the [Provide customer 360 insights AI agent workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/now-assist-for-csm/customer-service-management-ai-agent-collection-customer-360.md), which retrieves answers based on the context of the current case.
...
[Configure Case Summarization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/now-assist-for-csm/case-summarization-generation-in-now-assist.md)
