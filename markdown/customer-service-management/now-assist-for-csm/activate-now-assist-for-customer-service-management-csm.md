...
For information about CSM Configurable Workspace, see [Set up CSM Configurable Workspace](../concept/csm-config-workspace-set-up.md). For information about Now Assist AI agents, see Install Now Assist AI Agents.
