...
4.  [Duplicate the component](https://www.servicenow.com/docs/access?context=duplicate-components&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US) from the context menu.
