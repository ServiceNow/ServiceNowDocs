...
4.  [Duplicate the component](https://www.servicenow.com/docs/access?context=duplicate-components&version=zurich&pubname=zurich-application-development&ft:locale=en-US) from the context menu.
