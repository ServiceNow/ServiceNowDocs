---
title: Add a filter
description: Add a filter to a UI Builder dashboard to enable users to refine data views based on additional fields such as consumer, product, or other custom fields.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/now-assist-for-csm/add-a-new-filter.html
release: zurich
...
Add a filter to a UI Builder dashboard to enable users to refine data views based on additional fields such as consumer, product, or other custom fields.
...
4.  [Duplicate the component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/duplicate-components.md) from the context menu.
