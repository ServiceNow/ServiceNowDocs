...
</table>3.  4.  In Core UI or CSM Configurable Workspace list view, you can sort the cases and interactions based on the sentiment scale \(Very Positive, Positive, Neutral, Negative, or Very Negative\) and the sentiment trend.

5.  Manually refresh a sentiment.
