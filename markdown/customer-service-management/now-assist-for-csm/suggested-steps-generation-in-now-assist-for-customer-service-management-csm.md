...
If suggested steps are enabled for an open case, you can generate and display these steps in a card at the top of the Recommended Actions tab in the contextual side panel.
