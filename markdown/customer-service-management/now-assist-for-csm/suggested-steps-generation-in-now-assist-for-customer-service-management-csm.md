...
If suggested steps are available for a case, ServiceNow Otto for CSM generates and displays these steps in a card at the top of the Recommended Actions tab in the contextual side panel.
