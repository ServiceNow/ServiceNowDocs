...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/enable-reflow-for-new-uib-pages.html
release: xanadu
...
7.  Select **Done**.
    ...
    For more details, see [Reflow for playbook components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/reflow-for-playbook-components.md).
