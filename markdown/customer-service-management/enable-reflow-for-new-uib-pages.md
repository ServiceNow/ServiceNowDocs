...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/enable-reflow-for-new-uib-pages.html
release: yokohama
topic_type: task
...
7.  Select **Done**.
    ...
    For more details, see [Reflow for playbook components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/workflow-studio/reflow-for-playbook-components.md).
