...
|6|Path|[Amount is not debited](configuring-paths-for-next-nodes.md#)|Path with condition: amount is not debited.|
|7|Question node|[Failure codes](../task/configure-question-node-to-ask-failure-codes.md)|Collect transaction failure codes when amount is not debited.|
