...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/csm-ppm-create-project-from-demand.html
release: zurich
topic_type: task
...
2.  Fill in the fields on the Demand form and click **Save**.
    ...
    For more information about the fields on this form, see [Create a demand](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-business-management/t_CreatingDemands.md).
