...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/ex-create-recommendation.html
release: xanadu
topic_type: task
...
7.  In the **Action** field, select the action.
    ...
    2.  In the **Document** field, select the Troubleshoot credit card transaction failure decision tree by clicking the lookup icon.
        ...
        For more information about how to create this decision tree, see [Create Troubleshoot credit card transaction failure decision tree](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/preparation-for-creating-a-decision-tree.md).
