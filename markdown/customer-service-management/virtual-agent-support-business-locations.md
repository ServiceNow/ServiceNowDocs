...
To learn more about the configuration of the pre-chat surveys, see [Define pre-chat survey configurations](https://www.servicenow.com/docs/access?context=ac-configure-pre-chat-surveys&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
