...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/virtual-agent-support-business-locations.html
release: zurich
topic_type: concept
...
To learn more about the configuration of the pre-chat surveys, see [Define pre-chat survey configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/ac-configure-pre-chat-surveys.md).
