...
Create a case for an account consumer from platform or CSM workspaces to track issues. See [Create cases for an account consumer](../task/t_CreateACaseFromCustServApp.md).
