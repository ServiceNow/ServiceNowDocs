...
-   [Learn about audiences](https://www.servicenow.com/docs/access?context=add-audiences&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US)
-   [Add an audience to your UI Builder page](https://www.servicenow.com/docs/access?context=configure-audiences&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US)
...
**Note:** These dashboards are also available from [Platform Analytics experience](https://www.servicenow.com/docs/access?context=par-workspace&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
...
-   Create and share visualization elements from the [Platform Analytics Workspace](https://www.servicenow.com/docs/access?context=par-workspace&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
...
2.  Select the info icon \(![Info icon](../image/csm-ws-dashboards-info-icon.png)\) to open the Details panel.
...
5.  To access the duplicated dashboard:
 ...
 For more information, see [Duplicate a Platform Analytics dashboard](https://www.servicenow.com/docs/access?context=duplicate-db&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
...
3.  Edit an existing element or add a new element. For more information about these tasks, see [Edit Platform Analytics dashboards](https://www.servicenow.com/docs/access?context=edit-db-in-ac&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
...
7.  Click **Confirm**.
 ...
 For more information, see [Share a Platform Analytics dashboard](https://www.servicenow.com/docs/access?context=share-db-in-ac&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
...
4.  Add new elements to the dashboard. For more information about this step, see see [Create a dashboard with the in-line editor](https://www.servicenow.com/docs/access?context=create-db-in-ac&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).

 When you create a dashboard with the in-line editor, several elements are available to help you organize and populate the information on your dashboard. For more information, see [Platform Analytics dashboard overview](https://www.servicenow.com/docs/access?context=ac-elements&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
...
2.  Select **Printer friendly**.
 ...
 For more information, see [Print a Platform Analytics dashboard](https://www.servicenow.com/docs/access?context=printer-friendly-db-ac&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
...
2.  Select **Add to bookmarks**.
 ...
 For more information, see [Bookmark a Platform Analytics dashboard](https://www.servicenow.com/docs/access?context=bookmark-dashboard-ac&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
