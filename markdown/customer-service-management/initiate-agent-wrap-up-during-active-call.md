---
title: Call Wrap-Up
description: Call wrap-up enables agents to open the wrap-up modal, select wrap-up codes, and submit summary notes during an active call. Call context is captured in real time.
locale: en-US
...
Call wrap-up enables agents to open the wrap-up modal, select wrap-up codes, and submit summary notes during an active call. Call context is captured in real time.

## Call Wrap-Up overview

\[Omitted image "open-wrap-up.png"\] Alt text:
