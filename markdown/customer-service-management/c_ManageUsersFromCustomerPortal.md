...
3.  In the Actions list, click one of the following links.

<table id="choicetable_fnc_gct_lrb"><thead><tr><th align="left" id="d187733e727">

Choice

</th><th align="left" id="d187733e730">

Description

</th></tr></thead><tbody><tr><td id="d187733e736">

**Disable login**

</td><td>

Disables the login for this contact. When the login is disabled, the contact cannot access the customer portal.This link is displayed if the login is currently enabled.

</td></tr><tr><td id="d187733e748">

**Enable login**

</td><td>

Enables the login for this contact.This link is displayed if the login is currently disabled.
