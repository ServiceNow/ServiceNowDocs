...
[Manage actions in UI Builder pages](https://www.servicenow.com/docs/access?context=work-events&version=zurich&pubname=zurich-application-development&ft:locale=en-US)

[Bind an event to a declarative action](https://www.servicenow.com/docs/access?context=bind-event-declarative-action&version=zurich&pubname=zurich-application-development&ft:locale=en-US)
