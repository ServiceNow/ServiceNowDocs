...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/add-related-party-install-base.html
release: australia
topic_type: task
...
**Note:** You can enable additional contacts by using the **Restrict Contact Access** field. For details, see [Restrict contact access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/manage-account-access-cam.md).
