...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/case-language-detection.html
release: australia
topic_type: concept
...
-   Cases can be assigned to agents based on language skills using the [assignment workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/case-assignment-workbench.md).
...
For more information, see [Create a model to detect case language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/csm-task-intel-create-language-solution.md).
...
[Configure language detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/case-language-detection-configure.md)
