...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/case-language-detection.html
release: yokohama
topic_type: concept
...
-   Cases can be routed automatically with [Advanced Work Assignment \(AWA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/awa-overview.md).
-   Cases can be assigned to agents based on language skills using the [assignment workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/case-assignment-workbench.md).
...
The language detection feature supports 20 different languages. For details, see [Languages supported by Task Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/languages-supported-by-language-detection.md).
...
When a case is created, the system calls the Detect Language action in the [Dynamic Translation spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/dynamic-translation-spoke.md) which evaluates the text and returns the detected language.
...
For more information, see [Create a model to detect case language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/csm-task-intel-create-language-solution.md).
...
**Parent Topic:**[Task Intelligence for Customer Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/csm-task-intelligence.md)

**Related topics**  


[Configure language detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/case-language-detection-configure.md)

[Task Intelligence Admin Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/csm-task-intel-admin-center.md)
