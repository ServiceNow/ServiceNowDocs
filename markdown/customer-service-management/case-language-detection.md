...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/case-language-detection.html
release: zurich
topic_type: concept
...
-   Cases can be routed automatically with [Advanced Work Assignment \(AWA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-overview.md).
-   Cases can be assigned to agents based on language skills using the [assignment workbench](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/case-assignment-workbench.md).
...
The language detection feature supports 20 different languages. For details, see [Languages supported by Task Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/languages-supported-by-language-detection.md).
...
When a case is created, the system calls the Detect Language action in the [Dynamic Translation spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/dynamic-translation-spoke.md) which evaluates the text and returns the detected language.
...
For more information, see [Create a model to detect case language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/csm-task-intel-create-language-solution.md).
...
[Configure language detection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/case-language-detection-configure.md)
