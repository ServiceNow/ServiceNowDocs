...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/customize-ra-preview-experience.html
release: yokohama
topic_type: task
...
5.  Bind the preview experience properties to your preview UI.
    ...
    Data bindings are in the **Config** tab of the configuration panel in UI Builder. For more information, see [Data resources in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/data-resources.md).
