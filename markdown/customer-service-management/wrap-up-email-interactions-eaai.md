...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/wrap-up-email-interactions-eaai.html
release: australia
topic_type: task
...
An administrator must configure internal wrap-up codes. See [Wrap up email interactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/wrap-up-email-interactions-eaai.md).
...
For more information, see Automatic wrap-up code assignment in [Using Email Interaction for Customer Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/using-email-interaction-customer-service-management.md).
