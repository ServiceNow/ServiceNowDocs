...
|[Create a guidance for linking the similar major case to the current case](../task/ra-ex-guidance-link-major-case.md)|Create a guidance for linking the similar major case to the current case by configuring guidance inputs, preview experience, and guidance action.|
