...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/create-consumer-customer-record.html
release: yokohama
...
breadcrumb: [Verify a contact, consumer, or guest user, Engaging with the customer using email interaction, Using Email Interaction for Customer Service Management, Customer communication, Using Customer Service Management, Customer Service Management]
---
