...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/ex-decision-tree-for-assgment-grp-recommendation.html
release: yokohama
...
Configure the decision table conditions, results, and values as displayed in the following table. For more information, see [Decision Tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/decision-tables/decision-table.md).
