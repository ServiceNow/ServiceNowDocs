...
description: Migrate your data from the Location table to the Account Address table.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/migrate-data-location-address-table.html
release: australia
topic_type: concept
...
**Note:** Review step 4 within the [Enable enhanced address model for accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/enable-enhanced-address-model.md) to get details on how to migrate data.
