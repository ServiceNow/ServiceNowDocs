...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/cce-cancel-service-contract.html
release: xanadu
...
You can cancel a service contract when at least one of the associated root sold product is in Active or Suspended state.
