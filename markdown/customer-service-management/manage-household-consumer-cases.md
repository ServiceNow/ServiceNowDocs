...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/manage-household-consumer-cases.html
release: yokohama
topic_type: task
...
<table id="choicetable_cyw_rnc_gmb"><tbody><tr><td id="d164177e112">
...
</table>4.  Fill in the remaining fields on the [Case form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/r_CustomerServiceCaseForm.md).
