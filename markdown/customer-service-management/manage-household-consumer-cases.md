...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/manage-household-consumer-cases.html
release: zurich
topic_type: task
...
<table id="choicetable_cyw_rnc_gmb"><tbody><tr><td id="d174321e112">
...
</table>4.  Fill in the remaining fields on the [Case form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/r_CustomerServiceCaseForm.md).
