...
-   [Monitor Document Intelligence performance](https://www.servicenow.com/docs/access?context=doc-intel-monitor-performance&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)
...
With the system administrator role, you can create [document classification use cases](https://www.servicenow.com/docs/access?context=set-up-document-classification-use-cases&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US) and define the classes or categories for the AI to detect and apply to documents. This process is useful in situations where there are multiple types of documents that must be evaluated.

Set up a document classification use case in the following steps.

1.  [Create a document classification use case.](https://www.servicenow.com/docs/access?context=set-up-document-classification-use-cases&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)

    Define the name and properties for the use case.

2.  [Create a document class.](https://www.servicenow.com/docs/access?context=create-document-classes&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)

    Define the classes or categories that the AI learns to detect and apply to documents.

3.  [Create a document task](https://www.servicenow.com/docs/access?context=upload-documents-for-extraction&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US) for document classification and upload sample documents for each class.
4.  [Train a use case.](https://www.servicenow.com/docs/access?context=train-a-use-case&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US)
