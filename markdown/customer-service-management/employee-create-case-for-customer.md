...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/employee-create-case-for-customer.html
release: australia
topic_type: concept
...
Install the [CSM Extension for Proxy Contacts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/csm-extension-for-proxy-contacts.md) to use this functionality.
