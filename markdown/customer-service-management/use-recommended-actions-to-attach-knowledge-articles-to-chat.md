...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/use-recommended-actions-to-attach-knowledge-articles-to-chat.html
release: yokohama
topic_type: task
last_updated: "2025-01-30"
reading_time_minutes: 1
breadcrumb: [Using the Recommended Actions application, Automate and optimize, Using Customer Service Management, Customer Service Management]
---
...
4.  Select the Recommended Actions icon \(\[Omitted image "nba-icon.png"\] Alt text: Recommended Actions icon.\) in the contextual side panel.
...
6.  Select **Send in chat** from the side panel to send the respective knowledge article to the customer.
    ...
    The **Send in chat**, part of Share KB in chat interactions guidance, is disabled for the inactive or concluded chats.\[Omitted image "ra-attach-kb-chat.png"\] Alt text: Agent view of the Chat window displaying the public chat, private chat of the customer along with case details, guidance card action, and success message.

    \[Omitted image "chat-customer-view.png"\] Alt text: Customer view of the active chat window.
...
7.  Following are the other secondary actions.
    ...
    |Actions|Description|
    |-------|-----------|
    |Send in private chat|Select this action if the customer is restricted to the article and to share the selected article privately to an internal agent.\[Omitted image "agent-chat-private.png"\] Alt text: Active customer chat window displaying private chat and public chat.|
...
[Share KB in chat interactions guidance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/ra-csm-guidances-share-kb-chat.md)
