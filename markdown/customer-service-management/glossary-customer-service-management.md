---
title: Glossary Customer Service Management
description: Learn about the terms and concepts that are unique to Customer Service Management.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.Glossary terms are grouped alphabetically.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/glossary-customer-service-management.html
release: zurich
...
To learn more about auto-responder notifications, see [Configure Auto-Responder notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/config-auto-responder.md).
...
To learn how to configure Advanced Work Assignment, see [Configure Advanced Work Assignment for routing email interactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/configure-advanced-work-assignment-route-email-interactions.md).
...
To learn about asset relationships, see [Create asset contact relationships](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/c_AssetContactRelationships.md).

### auto routing

Automatically directing records to the appropriate agent based on predicted values.

To learn more about auto routing, see [Using Auto-Responder for case deflections](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/auto-responder-case.md).
...
To learn more about business locations, see [Business Location 360 components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/ui-components-under-business-location-360.md).
...
To learn more about using the business portal, see [Using the Business Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/use-the-business-portal.md).
...
To learn more about communities, see [Exploring Communities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/communities/exploring-communities.md).
...
To learn more about configuring moderation filers, see [Moderate a community](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/communities/moderate-communities.md).
...
To learn more about customer central, see [Customer Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/customer-central.md).
...
To learn more about case workflows, see [Case management for Customer Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/csm-case-management.md).
...
To learn more about case types, see [Customer service case types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/customer-service-case-types.md).
...
To learn more about demand forecasting, see [Demand Forecast in Workforce Optimization for Customer Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/explore-demand-forecast-configurable-wfo-cs.md).
...
To learn more about gamification, see [Administer gamification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/communities/communities-gamification-administer.md).
...
To learn more about Install Base Management, see [Data management for Customer Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/csm-data-management.md).
...
To learn more about the attributes, see [Install base characteristics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/attributes-and-configuration-of-install-base-management.md).
...
To learn more about intelligence solutions, see [Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/intelligence-csm.md).
...
To install entitlement properties, see [Components installed with Knowledge Product Entitlements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/r_KnowProdEntitlementCompInstalled.md).
...
To learn more about omnichannel, see [Omnichannels for communicating with customers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/omnichannels-communicating-customers.md).
...
To learn more about analytics, see [Configure the Platform Analytics Solution for Self-Service Analytics for Customer Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/ssa-solution-config.md).
...
To learn more about process mining, see [Integrating with Process Mining](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/process-opt-csm.md).
...
To learn more about reverse matching, see [Reverse matching](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/t_ReverseMatching.md).
...
To learn more about service definitions for catalogs, see [Service definitions with catalog items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/csm-service-definition-catalog-items.md).
...
To learn more about service definitions, see [Service definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/csm-service-definitions.md).
...
To set up skill prediction, see [Setting up skill prediction in Workforce Optimization for Customer Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/setting-up-skill-prediction-configurable-cs.md).
...
To learn more about the customer service virtual agent conversations, see [Customer Service Virtual Agent conversations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/csm-virtual-agent-chatbot.md).
...
### variable set for Customer Service Management \(CSM\)
