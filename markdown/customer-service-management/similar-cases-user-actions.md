...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/similar-cases-user-actions.html
release: xanadu
...
-   Agent Workspace: click the More UI Actions menu and select **Link to Case**.
-   Platform: click the desired case in the search results list, then click **Link to Case**.
...
Agent Workspace: click the More UI Actions menu and select **Copy Resolution**.
...
Agent Workspace: click the **Propose Major Case** link.
...
Agent Workspace: click the More UI Actions menu and select **Link to this major issue**.
...
[Similarity solutions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/event-management/word-collection-similarity-solution.md)
