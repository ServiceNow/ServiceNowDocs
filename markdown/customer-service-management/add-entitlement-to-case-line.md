...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/add-entitlement-to-case-line.html
release: zurich
topic_type: task
...
Add one or more entitlements to a case line in CRM Workspace.
...
1.  Open a case line record in CRM Workspace.
...
4.  Select one or more entitlements from the Add entitlements pop-up window.
    ...
    The Add entitlements pop-up window displays the entitlements associated with the **Account** field on the case line record and the **Contract** field on the parent case record.
