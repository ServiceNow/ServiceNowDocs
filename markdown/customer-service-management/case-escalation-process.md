...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/case-escalation-process.html
release: yokohama
...
1.  A user with the escalation requester role requests an escalation for a case or account. As part of the request, the user provides the following information:
    ...
    -   The [escalation severity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/administer-case-account-escalation.md)
    -   The [escalation template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/administer-case-account-escalation.md)
