...
|Step|Description|
|----|-----------|
|[Integrating with IT Service Management](integrating-with-it-service-management.md)|Integrate with Incident, Problem, Change, and Request Management applications.|
...
|[Integrating with Field Service Management](csm-fsm-integration.md)|Create and view all FSM work orders and appointments as a Customer Service Management user.|
