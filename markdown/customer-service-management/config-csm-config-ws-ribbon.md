...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/config-csm-config-ws-ribbon.html
release: australia
topic_type: task
...
-   [CSM Configurable Workspace form ribbon and components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/csm-agent-workspace-ribbon.md)
-   [Display the form ribbon and form header secondary values in the Contextual side panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/config-csm-display-header-in-sidebar.md)
