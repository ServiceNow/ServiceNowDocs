...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/config-csm-config-ws-ribbon.html
release: yokohama
...
-   [CSM Configurable Workspace form ribbon and components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/csm-agent-workspace-ribbon.md)
