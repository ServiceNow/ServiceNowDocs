...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/associate-address-account.html
release: australia
topic_type: task
...
4.  Fill the details in account address form and select **Submit**.
    ...
    For more information about the table fields, see [Account Address table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/account-address-table.md).
