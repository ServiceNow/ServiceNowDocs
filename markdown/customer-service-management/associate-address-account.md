...
4.  Fill the details in account address form and select **Submit**.
    ...
    For more information about the table fields, see [Account Address table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/account-address-table.md).
