...
2.  Click the Find Agents icon \(![Find Agents icon.](../image/FindAgentsIcon.png)\) next to the **Assigned to** field to open the assignment workbench.
...
5.  Sort the agents by clicking the column header for the desired matching criteria.
