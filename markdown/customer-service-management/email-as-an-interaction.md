...
When a customer replies to an email thread linked to a closed interaction, the system automatically routes the reply to the correct open case or interaction. The system does not create a new interaction. For details, see [Email reply linking for closed interactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/email-reply-routing-closed-interactions.md).

Check your entitlements to determine whether you have access to generate AI summaries of email interactions on demand. For details, see [AI summarization of email interactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/eaai-ai-summarization-email-interactions.md).
