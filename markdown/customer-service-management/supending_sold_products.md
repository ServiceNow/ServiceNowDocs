...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/supending\_sold\_products.html
release: zurich
...
|Task|Description|
|----|-----------|
|Suspend a single sold product|[Suspend a single sold product](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/supending_sold_products.md)|
|Suspend multiple sold products|[Suspend multiple sold products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/supending_sold_products.md)|
