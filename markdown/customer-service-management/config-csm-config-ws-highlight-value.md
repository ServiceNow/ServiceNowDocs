...
[Configure a highlighted value for a form header](https://www.servicenow.com/docs/access?context=config-ws-highlight-value&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
