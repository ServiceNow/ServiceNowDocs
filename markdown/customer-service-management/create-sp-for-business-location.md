...
Staff members with the sn\_customerservice\_manager role can create sold products by choosing the right product model, whereas the staff members with the sn\_customerservice.svc\_location\_agent role can only view the list of sold products installed at any service organization.
...
Reference to another sold product if the sold product contains child components.
