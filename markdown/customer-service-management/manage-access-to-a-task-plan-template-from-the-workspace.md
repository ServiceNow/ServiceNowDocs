...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/manage-access-to-a-task-plan-template-from-the-workspace.html
release: zurich
topic_type: task
...
[Share a task plan template with other users or groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/share-task-plan-template-with-user-groups-serviceorg.md)

[Notify users when a task plan template is shared](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/notify-users-when-taskplan-template-is-shared.md)
