...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/itsm-extension-points.html
release: xanadu
...
If it is necessary to modify the APIs within the CSMChangeIntegrations extension point, users with the system administrator role can:
...
**Note:** API names used in the implementation must remain exactly the same, otherwise the extension point will not be able to identify the implementation and will result in an error.
