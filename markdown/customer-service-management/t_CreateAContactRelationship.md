...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/t\_CreateAContactRelationship.html
release: yokohama
topic_type: task
...
Starting with the Yokohama release, Customer Service Management \(CSM\) introduced the `Prevent duplicate for account-contact`business rule. By using this business rule, an administrator can assign multiple responsibilities per account for a contact.
