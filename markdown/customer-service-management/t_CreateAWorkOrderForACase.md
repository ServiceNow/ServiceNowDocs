...
3.  Fill in the fields on the Work Order form.
    ...
    For more information, see [Create a work order](https://www.servicenow.com/docs/access?context=t_CreateAWorkOrder&version=yokohama&pubname=yokohama-field-service-management&ft:locale=en-US).
...
[Manage work orders](https://www.servicenow.com/docs/access?context=c_ManageWorkOrders&version=yokohama&pubname=yokohama-field-service-management&ft:locale=en-US)
