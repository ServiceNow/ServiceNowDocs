...
3.  Fill in the fields on the Work Order form.
    ...
    For more information, see [Create a work order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/field-service-management/t_CreateAWorkOrder.md).
