...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/agent-init-messg-csm-cws.html
release: xanadu
...
4.  On the Details tab of the workspace form, fill in the details for a new interaction or modify the details.
    ...
    For more information about the form, see [CSM workspace form features](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-agent-workspace-agent-actions.md).
