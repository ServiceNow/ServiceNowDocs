...
-   Configured the Agent-Initiated Messaging Interface application. For more information, see [Agent-initiated messaging interface](https://www.servicenow.com/docs/access?context=agent-init-messg-interface&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US).
-   Configured at least one qualifying messaging channel for the agent-initiated messages. For more information, see [Determine whether messaging channels are available for agent-initiated messages](https://www.servicenow.com/docs/access?context=agent-init-messg-channel-ext-pt&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US).
