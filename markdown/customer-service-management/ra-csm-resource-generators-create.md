...
5.  In the **Generator type** field, select a generator type.
    ...
    For more information, see [Resource generator types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/ra-csm-resource-generators.md).
...
8.  On the Generator input form, fill in the fields.
    ...
    For a description of the field values, see [Resource generator inputs form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/ra-csm-resource-generator-form.md).
