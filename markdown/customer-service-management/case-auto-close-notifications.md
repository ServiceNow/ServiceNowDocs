...
This feature uses the **Auto Close Resolved Cases** Flow Designer flow. For more information, see [Automatically close customer service cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/auto-close-customer-service-case.md).
