...
When an agent proposes a solution for a customer service case, the customer has a time window in which to accept or reject the solution. If the customer does not take action within this window, the case is automatically closed.
