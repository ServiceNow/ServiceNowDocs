...
Users with the system administrator role can configure the types of records that appear in this list. The default is an interaction record. For more information about configuring the records that can be created from the Add tab, see Configure record creation from the new tab menu in Service Operations Workspace.
