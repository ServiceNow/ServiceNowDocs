...
You can use the [Advanced Work Assignment](https://www.servicenow.com/docs/access?context=awa-overview&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) \(AWA\) feature to automatically assign work items to users based on their availability and capacity.
...
1.  Create the case task service channel.
    ...
    2.  Fill in the fields on the Service Channel form.
        ...
        |Inbox order|Order in which channel items appear in the user inbox. The **Inbox Order** field is an integer [field type](https://www.servicenow.com/docs/access?context=r_FieldTypes&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US). This field can store whole numbers.|
    ...
    For more information about creating an AWA service channel, see [Create a service channel](https://www.servicenow.com/docs/access?context=awa-create-service-channel&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
2.  Configure the layout for the case task inbox card.
    ...
    For more information about configuring the card layout, see [Create or modify an inbox layout](https://www.servicenow.com/docs/access?context=awa-modify-inbox-layout&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
3.  Create a queue for the case task service channel.
    ...
    For more information about configuring a queue, see [Create a work item queue](https://www.servicenow.com/docs/access?context=awa-create-queue&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
4.  Create an assignment rule for the Case Task Assignment queue.
    ...
    For more information about creating an assignment rule, see [Configure agent assignment rules](https://www.servicenow.com/docs/access?context=awa-create-assignment-rule&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
5.  Create a group for the Case Task Assignment queue.
    ...
    For more information about creating a group, see [Create or modify groups for Advanced Work Assignment queues](https://www.servicenow.com/docs/access?context=awa-groups&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US)
...
7.  Activate the service channel.
    ...
    Once the service channel is activated, you can use it to assign work items. For more information, see [Service channels](https://www.servicenow.com/docs/access?context=awa-service-channels&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
