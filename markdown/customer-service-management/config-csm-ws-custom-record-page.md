...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/config-csm-ws-custom-record-page.html
release: zurich
topic_type: task
...
7.  Now you can customize the page variant.
    ...
    -   [Work with pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/work-pages.md)
    ...
    -   [Layouts in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/work-layouts.md)
