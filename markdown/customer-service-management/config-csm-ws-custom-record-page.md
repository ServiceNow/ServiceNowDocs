...
7.  Now you can customize the page variant.
    ...
    -   [Work with pages](https://www.servicenow.com/docs/access?context=work-pages&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)
    -   [Work with components](https://www.servicenow.com/docs/access?context=work-components&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)
    -   [Layouts in UI Builder](https://www.servicenow.com/docs/access?context=work-layouts&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)
