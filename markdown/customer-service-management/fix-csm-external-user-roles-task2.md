...
description: Review and fix roles for external users that may have intentional internal role assignments.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/fix-csm-external-user-roles-task2.html
release: xanadu
topic_type: task
...
5.  Run the scheduled job to fix the role assignments for the users with the **Ext-user-intentional** tag.
    ...
    -   For users with the snc\_internal role and one or more additional internal roles, it removes the snc\_internal role and all other internal roles, and adds snc\_external role.
