...
Stores translations for static messages in Engagement Messenger.For more information about the Message table, see [Message table](https://www.servicenow.com/docs/access?context=r_MessageTable&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).

</td></tr></tbody>
</table>**Note:** For information about Virtual Agent chat translation, see [Virtual Agent translation tables](https://www.servicenow.com/docs/access?context=va-translation-tables&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US)
