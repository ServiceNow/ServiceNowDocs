...
**Note:** This record producer is available for Customer Support portal \(CSM\). To use Now Assist Q&amp;A in Customer Service portal \(CSP\) portal, follow the steps in  to enable it for record producer **Need help with a product**.
