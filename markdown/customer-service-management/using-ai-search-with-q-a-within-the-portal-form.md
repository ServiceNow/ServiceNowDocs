...
1.  Enter Your Details:
    -   Navigate to **Request Something** &gt; **Support** &gt; **Create case for a product \(ServiceNow Otto\)**.
...
2.  Review Results:
    ...
    **Note:** Genius result configuration: The behavior of generative AI results depends on the selected genius result configuration.
    ...
    -   When configured for generative AI Q&amp;A, the system generates a direct answer based on your query and displays relevant sources below the response.
...
3.  Take Action:
    ...
    -   If no results are found or you’re not satisfied with the result, select the **Ask Otto** button, to open a contextual chat window in the generative AI in Virtual Agent for additional help.
