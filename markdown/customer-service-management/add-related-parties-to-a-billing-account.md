...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/add-related-parties-to-a-billing-account.html
release: australia
topic_type: task
...
2.  Select a billing account from the list.
    ...
    For more information on how to create a new billing account record, see [Install billing account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/install-billing-account.md).
