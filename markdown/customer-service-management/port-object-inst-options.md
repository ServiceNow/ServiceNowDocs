...
-   If this field is empty, the widget displays information based on the sys\_id parameter provided in the portal web page URL.

    ```
https://<instance-url>/<portal-id>?id=<page-id>&sys_id=<record-id>
    ```

-   If the sys\_id is provided in both the portal web page URL and the **Record** field, the widget displays information based on the**Record** field value.
...
Option to display action items related to a record.
