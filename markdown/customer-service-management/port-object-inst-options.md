...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/port-object-inst-options.html
release: zurich
...
Option to display the service definitions associated with the record under **Actions**. For details, see [Service definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/csm-service-definitions.md).
...
[Add and configure the Portal Object widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/customer-self-service-and-omnichannel-engagement/add-conf-port-object-widget.md)
