...
|Task|Description|
|----|-----------|
|[Creating a decision table for recommending assignment groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/ex-decision-tree-for-assgment-grp-recommendation.md)|Configure a decision table that takes product and problem as inputs to provide the assignment group as an output. You can use this decision table in a resource generator.|
|[Configure a resource generator for providing assignment group as an outcome](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/ex-resorce-generator-assignment-grp.md)|Configure a resource generator that you can use while configuring a field recommendation to provide the appropriate assignment group for the router issue.|
|[Create a field recommendation for recommending assignment group field value](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/ex-create-field-recommendation-assg-grp.md)|Create an action of type field recommendation for recommending a field value for the assignment group.|
