...
|[Configure a resource generator for providing assignment group as an outcome](../task/ex-resorce-generator-assignment-grp.md)|Configure a resource generator that you can use while configuring a field recommendation to provide the right assignment group for the router issue.|
