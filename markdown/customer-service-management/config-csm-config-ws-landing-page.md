...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/config-csm-config-ws-landing-page.html
release: yokohama
topic_type: task
...
You can create a variant of this page in [UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/ui-builder-overview.md), a WYSIWYG web user interface builder, and modify it as needed.
...
[Change the page layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/change-layout.md)

</td><td>

The layout governs the slots that are available on a page, how the slots are positioned, and what CSS rules apply to them. For more information about layouts and layout systems, see [Work with layouts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/work-layouts.md).

</td></tr><tr><td>

[Add components to the page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/add-components.md)
...
[Connect data resources to the components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/connect-data.md)

</td><td>

Connect data resources to dynamically expose data from tables, records, or other elements on your page. For more information, see [Work with data resources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/data-resources.md).
...
5.  Create a landing page variant.
    ...
    4.  If desired, specify the audience and display conditions for the page variant.
        ...
        The audience determines who can see the page. An audience is a collection of user roles. For more information, see [Understanding your audiences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/add-audiences.md).
...
6.  Add or modify containers and components for the landing page variant.
    ...
    -   [Add components to a page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/add-components.md): Beginning with step 4, use this task to add a component to a container and to configure the component properties and event handlers. This task also contains information about adding additional containers.
    -   [Add styling to a component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/add-styling-to-component.md): Beginning with step 3, set CSS styles for a component to change its default appearance.
    -   [Add a modal to a component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/modals-uib.md): Beginning with step 5, add a window that appears when a user clicks a component. For example, if you add a button component that deletes a record, you can add a modal that asks the user to confirm the record deletion.
