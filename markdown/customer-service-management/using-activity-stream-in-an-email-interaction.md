...
Alternatively, select the Pop out in modeless window icon \( \[Omitted image "Pop-out\_icon\_eaai.png"\] Alt text: Pop out in modeless window\) to compose email in a separate dialog. \(include icon\)

The latest email is annotated with the New Activity marker.

\[Omitted image "Email\_marker\_annotated\_eaai\_final.png"\] Alt text: Activity stream shows the latest email annotated with the New Activity marker.
...
Select the show email details icon \(\[Omitted image "Compact\_header\_eaai.png"\] Alt text: Compact header icon\) to view the email information such as subject of the email, sender, and receiver.\[Omitted image "Compact\_email\_header\_with\_details\_eei.png"\] Alt text: Cpmpact email header with details
...
Select the filter icon \(\[Omitted image "Filter\_icon\_eaai\_new.png"\] Alt text: Filter icon\) at the top of the activity stream to display the filter options: -   Post types: Select the types of posts to view, such as emails, work notes, or field changes.

\[Omitted image "Post\_types\_eaai\_new.png"\] Alt text: Post types

-   Field changes:  Select specific fields to view information in posts for only those fields.

\[Omitted image "Field\_changes\_eaaai\_new.png"\] Alt text: Field changes
...
\[Omitted image "Filtersets\_eaai\_new.png"\] Alt text: Filter sets
...
Select the search icon \(\[Omitted image "Search\_icon\_eaai\_new.png"\] Alt text: Search icon\) to search for a message.
...
Select the Sort icon \(\[Omitted image "Sort\_icon\_eaai\_new.png"\] Alt text: Sort icon\) to sort posts from newest to oldest or oldest to newest.
