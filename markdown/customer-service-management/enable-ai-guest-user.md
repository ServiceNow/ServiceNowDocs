...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/customer-service-management/enable-ai-guest-user.html
release: brazil
topic_type: task
last_updated: "2026-09-10"
reading_time_minutes: 1
breadcrumb: [Feature configuration, Set up Engagement Messenger, Configure chat, Configure omnichannel, Configure, Customer Service Management]
---
