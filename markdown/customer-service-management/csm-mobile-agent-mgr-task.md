...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/csm-mobile-agent-mgr-task.html
release: xanadu
...
</table>**Parent Topic:**[Get started with the Customer Service mobile application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/install-customer-service-mobile-app.md)
