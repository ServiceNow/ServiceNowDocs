...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/csm-config-workspace-page-templates.html
release: zurich
topic_type: concept
...
</table>For more information, see [Create a page from a template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/reuse-page-definitions.md) in the UI Builder documentation.
