...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/configure-path-for-200-failure-code.html
release: xanadu
...
\[Omitted image "ex-200-failure-code-path.png"\] Alt text:

For more information about how to configure a path, see [Determine the next node displayed in a decision tree](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/configure-path-in-gdb.md).
