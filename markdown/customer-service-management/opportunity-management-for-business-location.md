...
To create an opportunity for business location, see [Create an opportunity](https://www.servicenow.com/docs/access?context=create-new-opportunity&version=zurich&pubname=zurich-order-management&ft:locale=en-US).
