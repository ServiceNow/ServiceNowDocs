...
**Note:** If you have [customized a Work scheduler card](https://www.servicenow.com/docs/access?context=customize-workscheduler-card-wfo-itsm&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US), you can follow the steps below to add client scripts.
...
[Define the workItem property in the Work scheduler page configuration](https://www.servicenow.com/docs/access?context=work-sched-create-page-properties&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US)
...
[Define and bind client scripts to components](https://www.servicenow.com/docs/access?context=define-client-scripts&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)
