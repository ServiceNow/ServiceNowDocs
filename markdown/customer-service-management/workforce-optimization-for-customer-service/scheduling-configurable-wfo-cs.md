...
-   Track and manage the team's schedule on the team calendar by viewing the planned shifts versus the actual clock-in and clock-out times for the selected day, weekor month.
...
To delve into more information behind your key performance indicators, filters and sidebars, see [Exploring indicators with KPI Details](https://www.servicenow.com/docs/access?context=kpi-details-components&version=australia&pubname=australia-now-intelligence&ft:locale=en-US)

-   **[Create a shift plan](../task/create-shift-plan-configurable-wfo-cs.md)**  
...
-   **[Create a schedule plan](../task/create-schedule-plan-configurable-wfo-cs.md)**  
...
-   **[Publish a schedule plan for visibility into team coverage](../task/generate-preview-schedule-plan-configurable-wfo-cs.md)**  
...
-   **[Track and manage your team schedule](../task/track-manage-teams-schedule-configurable-wfo.md)**  
...
-   **[Create recurring meetings](../task/create-recurring-meeting-wfo.md)**  
...
-   **[Add events to the team calendar](../task/adding-event-calendar-configurable-wfo-cs.md)**  
Create a meeting, training, time-off request, or an ad hoc work event from the team calendar.
-   **[Swap agent shifts in Workforce Optimization for Customer Service](../task/swap-agent-shifts-configurable-wfo-cs.md)**  
Swap an agent's shift in an assignment group with another agent who can work on that shift and skip the approval process.
-   **[Enable your teams to sign up for work shifts](../task/agent-shift-signup-wfo-csm.md)**  
Empower your teams to sign up for work shifts based on their availability and preference.
-   **[Sign up for your preferred shifts](../task/sign-up-preferred-shifts-wfo-csm.md)**  
