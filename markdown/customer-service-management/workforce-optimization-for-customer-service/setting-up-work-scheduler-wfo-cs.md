...
-   **[Customize a Work Scheduler card using the Next Experience UI Builder](../task/customize-workscheduler-card-wfo-cs.md)**  
...
-   **[Set up a work configuration](../task/setup-work-scheduler-wfo-cs.md)**  
...
-   **[Create a Work scheduler card using the Next Experience UI Builder](../task/create-workscheduler-card-wfo-cs.md)**  
...
-   **[Create extension points for Work scheduler](../task/create-work-sched-ext-points-wfo-cs.md)**  
