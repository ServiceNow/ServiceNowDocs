...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/workforce-optimization-for-customer-service/track-tasks-teams-wfo-cs.html
release: xanadu
...
3.  If you don’t have any queue configurations in the Work scheduler, select the queue settings icon \(\[Omitted image "queuefilter.png"\]\) and then enable up to five work item types.
...
6.  Assign a work item to an agent.
    ...
    1.  Select a task that you want to assign to an agent.
        ...
        To add your own matching rule, see [Create a criteria for a matching rule in Work scheduler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/workforce-optimization-for-customer-service/assignment-rules-work-scheduler-wfo-cs.md).
...
7.  Update a work item from the calendar.
    ...
    The image below is a representation of the Work scheduler infographic.

    \[Omitted image "work-scheduler-ui.png"\]
