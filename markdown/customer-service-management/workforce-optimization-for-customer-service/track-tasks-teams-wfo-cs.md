...
3.  If you don’t have any queue configurations in the Work scheduler, select the queue settings icon \(![](../image/queuefilter.png)\) and then enable up to five work item types.
...
7.  Update a work item from the calendar.
    ...
    ![](../../configurable-workforce-optimization-itsm/image/work-scheduler-ui.png)
