...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/workforce-optimization-for-customer-service/assignment-rules-work-scheduler-wfo-cs.html
release: xanadu
...
breadcrumb: [Assigning work using Work Scheduler in Workforce Optimization for Customer Service, Using Workforce Optimization for Customer Service, Workforce Optimization for Customer Service, Customer Service Management]
---
...
For information on how matching criteria works, see [Matching criteria for work items in Work scheduler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/workforce-optimization-for-customer-service/work-items-assignment-matching-criteria-wfo-cs.md).
...
4.  Fill in the fields on the form.
    ...
    For information on creating a new matching criteria, see [Create assignment workbench matching criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/create-assignment-wkbench-criteria.md).

5.  Select **Submit**.


-   **[Matching criteria for work items in Work scheduler](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/workforce-optimization-for-customer-service/work-items-assignment-matching-criteria-wfo-cs.md)**  
...
**Parent Topic:**[Assigning work using Work Scheduler in Workforce Optimization for Customer Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/workforce-optimization-for-customer-service/work-scheduler-wfo-cs.md)
