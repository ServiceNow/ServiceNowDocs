...
If the [coaching opportunity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/create-coaching-opportunity.md) includes a survey, you can opt to take the survey and the assessment. When you use a survey to [assess a trainee](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/assess-trainee.md), the score for the survey is automatically calculated when you complete the survey. The assessment rating is then updated based on that score.
...
<table id="choicetable_k5z_rpq_pnb"><thead><tr><th align="left" id="d137092e635">

To

</th><th align="left" id="d137092e638">

Do this

</th></tr></thead><tbody><tr><td id="d137092e644">
...
3.  Click the **Skills** tab.
    ...
    You can view the list of all assigned skills and the skill level for each agent on your team. For more information on skills and skills levels, see [Skills Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/skills-management.md).
...
<table id="choicetable_ufk_1hx_nlb"><thead><tr><th align="left" id="d137092e1009">

To

</th><th align="left" id="d137092e1012">

Do this

</th></tr></thead><tbody><tr><td id="d137092e1018">
