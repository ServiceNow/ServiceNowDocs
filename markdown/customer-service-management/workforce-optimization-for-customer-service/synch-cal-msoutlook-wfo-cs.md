...
As a user with admin role, you can enable this feature by installing Microsoft Exchange Online Spoke. See [Set up](https://www.servicenow.com/docs/access?context=setup-ms-exch-ol&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
