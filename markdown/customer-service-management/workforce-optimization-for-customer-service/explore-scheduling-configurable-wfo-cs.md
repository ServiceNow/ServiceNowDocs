...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/workforce-optimization-for-customer-service/explore-scheduling-configurable-wfo-cs.html
release: yokohama
...
\[Omitted image "scheduling-overview.png"\] Alt text: Infographic displaying managers scheduling and forecasting agent requirements from a central location. For more information, refer to the text description that follows.

The image below provides a high-level overview of the tasks schedulers and agents can perform on the calendar.

\[Omitted image "wfo\_cs\_scheduling\_new.png"\] Alt text: Infographic displaying the Schedule page, schedulers' actions, and agents' actions. For the text description, refer to information that follows.
...
[Setting up Scheduling in Workforce Optimization for Customer Service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/workforce-optimization-for-customer-service/setup-scheduling-configurable-wfo-cs.md)
