...
The Demand Forecast application uses [MetricBase](https://www.servicenow.com/docs/access?context=metricbase&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) to forecast the demand for teams.
