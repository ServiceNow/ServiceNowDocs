...
4.  Select **Update**.
    ...
    For information on setting up a work configuration, see [Set up a work configuration](https://www.servicenow.com/docs/access?context=setup-work-scheduler&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).

    For information on creating the work scheduler card, see [Create a Work Scheduler card using UI Builder](https://www.servicenow.com/docs/access?context=create-workscheduler-card-wfo-itsm&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US).
