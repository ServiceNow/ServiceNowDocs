...
For information on how domain separation works in Coaching for Workforce Optimization for ITSM, refer to [Domain separation and Coaching](https://www.servicenow.com/docs/access?context=domain-separation-coaching&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US).
