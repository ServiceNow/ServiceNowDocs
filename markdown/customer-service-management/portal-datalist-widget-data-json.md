...
The name of the view that defines the list of columns or fields to appear on the widget.For more information on these views, see [Create and delete views](https://www.servicenow.com/docs/access?context=create-delete-view&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
