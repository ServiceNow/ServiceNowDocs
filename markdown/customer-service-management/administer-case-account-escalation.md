...
On account escalations, because the escalation corresponds to an account which typically does not support SLAs, the SLAs are associated with the escalation.-   **Escalated account response - 4 hours**: de-escalate the account within four hours.
