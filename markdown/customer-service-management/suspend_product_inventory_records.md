...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/suspend\_product\_inventory\_records.html
release: xanadu
...
After performing the **Suspend** action, a suspend order is created and the fulfilment process for the order begins. This fulfillment flow marks the order as **Complete** and updates the product inventory records.
