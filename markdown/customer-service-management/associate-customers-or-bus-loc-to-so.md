...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/associate-customers-or-bus-loc-to-so.html
release: xanadu
...
For more information about defining service organization criteria, see [Create the criteria for a service organization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/create-service-organization-criteria.md).
