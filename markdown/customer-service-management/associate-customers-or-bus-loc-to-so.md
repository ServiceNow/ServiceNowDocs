...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/associate-customers-or-bus-loc-to-so.html
release: yokohama
...
For more information about defining service organization criteria, see [Create the criteria for a service organization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/create-service-organization-criteria.md).
