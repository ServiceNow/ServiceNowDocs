...
Set up [Advanced Work Assignment](https://www.servicenow.com/docs/access?context=awa-application-landing-page&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) to automatically route tasks and interactions to the right agents.
...
For more information, see the [Manage UI Builder pages and page variants](https://www.servicenow.com/docs/access?context=work-pages&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US) topic in the [UI Builder](https://www.servicenow.com/docs/access?context=create-custom-experience&version=xanadu&pubname=xanadu-application-development&ft:locale=en-US) documentation.
