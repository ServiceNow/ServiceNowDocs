...
A theme sets the visual style of a configurable workspace experience and provides a consistent look and feel across all pages.-   [View the brand and theme setting in your workspace experience](https://www.servicenow.com/docs/access?context=workspace-view-theme-setting&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)
-   [Working with themes in Next Experience](https://www.servicenow.com/docs/access?context=next-experience-theming&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
...
Set up [Advanced Work Assignment](https://www.servicenow.com/docs/access?context=awa-application-landing-page&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) to automatically route tasks and interactions to the right agents.
...
For more information, see the [Manage UI Builder pages and page variants](https://www.servicenow.com/docs/access?context=work-pages&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US) topic in the [UI Builder](https://www.servicenow.com/docs/access?context=create-custom-experience&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US) documentation.
