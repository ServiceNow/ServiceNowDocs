...
Configure a guidance node and link the created guidance to this node to [provide actions to agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/configure-guidance-in-gdb.md).
