...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/create-guidance-action-ga.html
release: australia
topic_type: task
...
Configure a guidance node and link the created guidance to this node to [provide actions to agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/configure-guidance-in-gdb.md).
