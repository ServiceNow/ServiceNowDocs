...
To configure the time-frame for the solution definition threshold, see [Update your similarity score threshold](https://www.servicenow.com/docs/access?context=update-similarity-threshold&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
