...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/customer-service-management/csm-case-mgmt-order-ops.html
release: brazil
topic_type: concept
...
The following table provides an overview of the process for creating an order case. For detailed steps, see [Create an order case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/csm-order-ops-create-order-case.md).
...
[Case Lines and Workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/csm-case-mgmt-case-lines.md)
