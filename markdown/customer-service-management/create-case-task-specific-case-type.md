...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/create-case-task-specific-case-type.html
release: xanadu
...
In CSM Configurable Workspace, agents use the [Case type selector screen](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-case-type-select-modals.md) to make selections and create cases.
