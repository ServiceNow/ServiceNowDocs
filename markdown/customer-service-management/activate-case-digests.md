...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/activate-case-digests.html
release: yokohama
topic_type: task
...
For more information, see [Recipient lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/targeted-comm-dynamic-list.md).
