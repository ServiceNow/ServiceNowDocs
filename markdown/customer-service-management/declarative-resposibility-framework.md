...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/declarative-resposibility-framework.html
release: australia
topic_type: task
...
For more information about creating a responsibility definition, see [Create a responsibility definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/t_CreateAResponsibilityDefinition.md). The need for domain separation in configuring access records is determined by the domain of the referenced responsibility.
