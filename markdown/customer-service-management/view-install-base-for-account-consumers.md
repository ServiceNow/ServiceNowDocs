...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/view-install-base-for-account-consumers.html
release: xanadu
topic_type: task
...
Role required: sn\_acct\_consumer.consumer

## About this task

View the list of install base items information from the Customer Service Portal.

**Note:** The **Entitlements** widget and the **Contracts** widget are not visible for account consumers.

## Procedure

1.  Navigate to the Customer Service Portal.

2.  Click **Support** &gt; **Install Base**.

    The system displays a list of install base items that belong to your account.

3.  Select an install base to view its details.

    **Note:** The default view is the form view. If you switch to the list view, the **Account** and **Consumer** fields are not displayed. See [Configure the Install Base items and Sold Products lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/config-b2b2c-data-model-case-list.md) for details.
