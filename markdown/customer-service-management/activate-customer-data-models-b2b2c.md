...
description: You can activate the Customer Data Models for B2B2C plugin \(com.sn\_csm\_b2b\_consumers\) if you have the admin role. The application includes demo data and installs related ServiceNow Store applications and plugins if they are not already installed.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/activate-customer-data-models-b2b2c.html
release: xanadu
...
You can activate the Customer Data Models for B2B2C plugin \(com.sn\_csm\_b2b\_consumers\) if you have the admin role. The application includes demo data and installs related ServiceNow® Store applications and plugins if they are not already installed.
...
-   Business rules: Mandatory account or consumer
-   UI policies
    -   Table: Case
    -   Table: Interaction
    -   Table: Sold Product
