...
**Note:** If you set a context input as [mandatory](../task/ra-csm-create-context-inputs.md#entry-ci-mandatory) in the Context input form and fail to set contextual inputs on Recommended Actions component in the UIB, the recommendations will not be generated.
