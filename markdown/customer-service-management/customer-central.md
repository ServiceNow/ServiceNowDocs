...
Users with the system administrator role can add this component to a record page in [UI Builder](https://www.servicenow.com/docs/access?context=ui-builder-overview&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US) and [configure the component properties](customer-central-configuration.md).
