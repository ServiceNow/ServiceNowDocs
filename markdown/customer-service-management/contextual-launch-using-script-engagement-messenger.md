...
description: Use custom code to enable the deep linking and launch a feature in Engagement Messenger integrated with your website.
locale: en-US
release: xanadu
topic_type: task
...
Use custom code to enable the deep linking and launch a feature in Engagement Messenger integrated with your website.
...
If you are using existing code, ensure that you update the script to show `v=3.1`. For example:
...
8.  Replace the `SN_CSM_EC.loadEMFeature()` function with custom wrapper function that you created in [step 7](contextual-launch-using-script-engagement-messenger.md).
...
The feature you specified in the embed code is launched by default when Engagement Messenger is opened in the website in which it is embedded.
