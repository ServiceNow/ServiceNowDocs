...
</table>**Note:** These service-related capabilities are available only after activating the Customer Service Case Types \(sn\_csm\_case\_types\) plugin. The plugin is optional and must be enabled if you want to use these capabilities with business locations.
