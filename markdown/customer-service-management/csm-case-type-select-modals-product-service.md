...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/csm-case-type-select-modals-product-service.html
release: xanadu
topic_type: concept
...
Use the **Owned product** field to select a product.
 ...
 This field uses typeahead search. Enter the cursor in the field and begin typing to display products. Selecting a product in this field filters the available services listed in the Services section.
...
</table>Agents can select **Create Case** from the following records, which provide context about owned products and services.
