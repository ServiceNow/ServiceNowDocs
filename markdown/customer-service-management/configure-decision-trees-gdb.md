...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/configure-decision-trees-gdb.html
release: yokohama
...
Configure a start node to [add initial set of questions or instructions to a decision tree](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/configure-start-node-gdb.md) in Decision Tree Builder.
