...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/associate-customer-criteria-to-service-organization.html
release: zurich
topic_type: task
...
<table id="choicetable_tgr_32q_1cc"><thead><tr><th align="left" id="d141186e96">

Configuration type

</th><th align="left" id="d141186e99">

Description

</th></tr></thead><tbody><tr><td id="d141186e105">
...
In other words, it is a service organization relationship where a business location serves every business location within its hierarchy. For example, regional support agents.
