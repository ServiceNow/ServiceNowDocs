...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/config-data-list-widget-inst-optns.html
release: xanadu
...
11. On the instance options page, in the **Data** field, paste and update the following JSON code to configure the lists.
    ...
    For more information, see [Portal Data List widget JSON parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/portal-datalist-widget-data-json.md).
...
12. On the Instance form, fill in the fields.
    ...
    For a description of the field values, see [Portal Data List widget instance options form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/r-port-data-list-inst-options.md).
