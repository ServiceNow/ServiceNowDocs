...
description: A record page provides the base structure for how a record is displayed in CSM Configurable Workspace. This structure includes records such as cases, tasks, and interactions.
locale: en-US
