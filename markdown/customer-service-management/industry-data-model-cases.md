...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/industry-data-model-cases.html
release: xanadu
...
**Note:** Only external staff with the location agent can act as fulfillers. For more information, see [External business location \(EBL\) as a fulfiller](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/ebl-as-a-fulfiller.md).
