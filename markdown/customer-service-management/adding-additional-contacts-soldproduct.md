...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/adding-additional-contacts-soldproduct.html
release: australia
topic_type: task
...
**Note:** Additional contacts can be enabled using the **Restrict Contact Access** field. For details, see [Restrict contact access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/manage-account-access-cam.md).
