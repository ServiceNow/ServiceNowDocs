...
10. In the column, select the Edit page properties icon \(![Edit page properties icon.](../image/icon-portal-page.png)\).
...
11. Select the Edit page properties icon \(![Edit page properties icon.](../image/icon-portal-page.png)\) in the banner in Service Portal Designer.
...
17. Select the Pencil icon \(![Pencil icon](../image/icon-pencil-ac.png)\).
