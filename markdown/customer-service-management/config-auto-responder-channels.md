...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/config-auto-responder-channels.html
release: xanadu
topic_type: task
...
-   Ensure that the required channel is already set up for use. For more information, see [Configure communication channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/set-up-communication-channels.md).
