...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/create-internal-business-location.html
release: zurich
topic_type: task
...
3.  Fill in the fields on the [Internal Business Location](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/data-model-business-location-form.md) form.
...
[Create an external business location](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/create-external-business-location.md)
