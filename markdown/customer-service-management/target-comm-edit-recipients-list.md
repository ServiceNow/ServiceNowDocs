...
description: Modify targeted communication recipient lists using the Dynamically Added column in the Recipients related list.
locale: en-US
release: zurich
topic_type: task
...
Modify targeted communication recipient lists using the Dynamically Added column in the Recipients related list.
...
The **Recipients** related list includes the **Dynamically Added** column that displays either True or False, depending on how a record was added:
