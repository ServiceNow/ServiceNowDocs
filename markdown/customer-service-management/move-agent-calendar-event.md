...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/move-agent-calendar-event.html
release: australia
topic_type: task
...
<table id="choicetable_ezl_bqb_hx"><tbody><tr><td id="d247687e110">
