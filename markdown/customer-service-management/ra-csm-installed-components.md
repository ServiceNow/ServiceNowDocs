...
breadcrumb: [Install the Recommended Actions application, Recommended Actions configuration, Implement Intelligence, Configuring Customer Service Management, Customer Service Management]
---
...
<table id="table_tnv_nlr_g5b"><thead><tr><th>
