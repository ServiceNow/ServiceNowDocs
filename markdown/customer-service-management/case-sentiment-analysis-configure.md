...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/case-sentiment-analysis-configure.html
release: yokohama
topic_type: concept
...
Use the [Task Intelligence Admin Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/csm-task-intel-admin-center.md) to create and deploy a sentiment model.

</td><td>

See [Create a model to predict case sentiment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/csm-task-intel-create-sentiment-solution.md).
