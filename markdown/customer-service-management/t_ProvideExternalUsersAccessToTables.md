...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/t\_ProvideExternalUsersAccessToTables.html
release: xanadu
topic_type: task
...
1.  [Elevate to a privileged role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/servicenow-ai-platform-security/t_ElevateToAPrivilegedRole.md).

2.  [Create an ACL rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/access-control/t_CreateAnACLRule.md) with the following settings:
