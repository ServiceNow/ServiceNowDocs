...
|Sold product table \(sn\_install\_base\_sold\_product\)|household|CRM Household Entities \(com.snc.household\)|Confidential|
...
|Install base table \(sn\_install\_base\_item\)|household|CRM Household Entities \(com.snc.household\)|Confidential|
