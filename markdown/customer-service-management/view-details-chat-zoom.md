...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/view-details-chat-zoom.html
release: yokohama
topic_type: task
...
Number of the chat interaction record from which this Zoom meeting was initiated. This field is automatically set to the number of the chat interaction record.
 ...
 You may need to configure the form to add this field. For more information, see [Configure the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/configure-form-layout.md).
 ...
 **Note:** To view more details such as the meeting URL and participant details, click the preview this record icon \(\[Omitted image "preview-record.png"\] Alt text: Preview this record icon.\) for this field.
...
[Initiate Zoom meetings from chats](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/initiate-chat-zoom.md)
