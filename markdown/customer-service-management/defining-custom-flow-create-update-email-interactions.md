...
2.  Create a flow.
    ...
    7.  Select **Show additional properties**.
        ...
        To know more about additional properties, see [Create a flow in Workflow Studio](https://www.servicenow.com/docs/access?context=create-flow&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
