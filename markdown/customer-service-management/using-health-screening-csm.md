...
For more information on screening, see [Conduct a health screen for entry](https://www.servicenow.com/docs/access?context=screen-returning-employee&version=australia&pubname=australia-employee-service-management&ft:locale=en-US).
