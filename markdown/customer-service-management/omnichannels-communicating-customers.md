...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/omnichannels-communicating-customers.html
release: yokohama
topic_type: concept
...
To learn more, see [Integrating with consumer messaging apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/messg-integrate-channels.md).

**Parent Topic:**[Exploring Customer Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/exploring-csm.md)
...
An agent can also initiate a Zoom meeting from a chat to resolve issues faster. For more information, see [Chat Zoom Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/chat-zoom-connector.md).
...
Enables you to create interactions to manage email engagement with customers. Agents can review these interactions and take appropriate actions. The customer query can be resolved by an email response over the interaction, or a case can be created for further investigation.\[Omitted image "Email\_as\_an\_Interaction.png"\] Alt text: Customers can email support to get help from an agent.
...
\[Omitted image "Email\_to\_case.png"\] Alt text: Customers can email support to submit a case and get help from an agent.
...
-   **Accepting and rejecting solutions**
    ...
    **Note:** If a customer accepts a solution or closes a case from the Customer Service Portal, they’re automatically routed to the survey. They don’t receive the survey email.
    ...
    To get started with the email channel, see [Configuring the email channel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/c_CustomerServiceEmailCommunication.md).
...
\[Omitted image "phone\_image.png"\] Alt text: nfographic displaying the process when a customer calls support to get an agent to submit a case and resolve an issue.
...
To get started with the phone channel, see [Configuring the phone channel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/c_PhoneCommunication.md).
