...
For more information, see [Connect Support](https://www.servicenow.com/docs/access?context=c_ConnectSupport&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US) and [Configuring the chat channel](c_ChatFeature.md).
