---
title: View and manage Walk-up Experience appointments from the application navigator
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/csm-walkup-view-manage-appointment-nav.html
release: yokohama
topic_type: task
...
2.  Click an appointment number to view details, such as the requester name, the interaction number and description, and the appointment time.
    ...
    3.  Click **Update** to save any changes you make to the interaction form.
