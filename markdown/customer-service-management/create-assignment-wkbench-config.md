...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/create-assignment-wkbench-config.html
release: yokohama
...
<table id="choicetable_njl_kph_xx"><tbody><tr><td id="d198824e231">
...
<table id="choicetable_mth_1qh_xx"><tbody><tr><td id="d198824e270">
