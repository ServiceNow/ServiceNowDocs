...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/create-assignment-wkbench-config.html
release: xanadu
...
<table id="choicetable_njl_kph_xx"><tbody><tr><td id="d182382e231">
...
<table id="choicetable_mth_1qh_xx"><tbody><tr><td id="d182382e270">
