...
For information on displaying articles in the Featured content section, see [Add a knowledge article to featured content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/t_PinAnArticle.md).
