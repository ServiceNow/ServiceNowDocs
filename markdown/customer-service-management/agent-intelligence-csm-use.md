...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/agent-intelligence-csm-use.html
release: xanadu
topic_type: task
last_updated: "2024-08-01"
reading_time_minutes: 1
breadcrumb: [Predictive Intelligence for case management, Machine learning solutions for Customer Service Management, Implement Intelligence, Configuring Customer Service Management, Customer Service Management]
---
...
3.  Change the values in the predicted fields if needed or enter values for fields where Predictive Intelligence has skipped prediction.
