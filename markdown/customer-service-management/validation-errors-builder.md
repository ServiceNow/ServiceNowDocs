...
If there are missing values or incorrect configurations in a node or a path, errors might be displayed on validation when you save a node or path or activate a decision tree.
