...
Install base requires the Customer Service Install Base Management plugin \(com.snc.install\_base\).
...
Create a sold product to provide customers, consumers, and customer service agents with a view into the products and services that have been sold to an account or a consumer.
