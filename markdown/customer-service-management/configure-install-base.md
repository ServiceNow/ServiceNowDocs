...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/configure-install-base.html
release: yokohama
topic_type: task
...
Before setting up your install base, create your product data by creating or importing product models. For more information, see [Configure product data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/configure-csm-products.md).
