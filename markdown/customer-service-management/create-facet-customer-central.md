...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/create-facet-customer-central.html
release: xanadu
topic_type: task
...
Facets are displayed in the Customer Activity view in Agent Workspace. Dynamic facets display record details associated with the facet.

\[Omitted image "dynamic-facet.png"\] Alt text: Customer Activity tab displaying Cases facet with list of cases and with a brief description.

Static facets display a subcategorization of the facets without any record details. \[Omitted image "static-facet.png"\] Alt text: Customer Activity tab with the Interactions facet highlighted.

## Procedure

1.  Navigate to **All** &gt; **Customer Central** &gt; **Customer Activity** &gt; **Activity Contexts**.

2.  Open the contact or consumer record that you want to create facets for.

3.  On the Facets related list, select **New**.
...
Enter a Name for the facet. This is the name of the facet that appears on the Customer Activity view.
