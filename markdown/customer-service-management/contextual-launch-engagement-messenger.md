...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/contextual-launch-engagement-messenger.html
release: xanadu
topic_type: concept
...
**Note:** Beginning with the Xanadu release, in Virtual Agent and Live Agent chats, if a user is engaged in an ongoing conversation and tries to contextually open a topic then the following options are shown:
