...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/contextual-launch-engagement-messenger.html
release: yokohama
...
**Note:** Beginning with the Yokohama release, in Virtual Agent and Live Agent chats, if a user is engaged in an ongoing conversation and tries to contextually open a topic then the following options are shown:
