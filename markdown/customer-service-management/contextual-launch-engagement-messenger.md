...
**Note:** Beginning with the Zurich release, in Virtual Agent and Live Agent chats, if a user is engaged in an ongoing conversation and tries to contextually open a topic then the following options are shown:
