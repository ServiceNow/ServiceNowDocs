...
Users with the customer service agent \(sn\_customerservice\_agent\) and customer service manager \(sn\_customerservice\_manager\) roles must be manually assigned to the **TOP/MSP/Default** domain. Agents and managers cannot see case or account details until they are assigned to the **TOP** domain.
