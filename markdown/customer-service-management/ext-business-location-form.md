...
-   A list of project tasks under the customer project tab is visible only if the **Visible to Customer** is selected during project task creation.
 ...
 To learn more about project task creation, see [Create a project task from a project](https://www.servicenow.com/docs/access?context=t_CreateATaskFromAProject&version=zurich&pubname=zurich-it-business-management&ft:locale=en-US).
