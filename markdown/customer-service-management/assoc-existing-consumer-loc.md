...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/assoc-existing-consumer-loc.html
release: yokohama
topic_type: task
...
5.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Consumer Profile Location table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/consumer-profile-location-table.md).
...
[Create and associate a location to a consumer profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/creating-loc-and-assoc-to-consumer-profile.md)
