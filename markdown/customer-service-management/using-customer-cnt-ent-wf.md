...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/using-customer-cnt-ent-wf.html
release: xanadu
...
You can manage the life cycle of customer service contracts and entitlements from offer creation to contract generation using contracts and entitlements workflows. Using workflows you can perform the following functions:
...
You can suspend, resume, cancel, and renew multiple entities at once.
