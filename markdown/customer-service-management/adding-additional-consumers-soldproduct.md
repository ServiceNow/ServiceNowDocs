...
description: Add additional consumers for your business-to-consumer \(B2C\) or business-to-business-to-consumer \(B2B2C\) sold products by defining the type and responsibility of additional consumers. After you add this information, additional consumers can have the same access to the consumer associated to the sold product and the related entities.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/adding-additional-consumers-soldproduct.html
release: yokohama
...
The responsibility assigned to the additional consumer that is associated to a sold product gets access to the sold product and the related entities, which include installed products, install base items, and cases associated to sold products.
 ...
 **Note:** If the **Responsibility** field is left empty, consumers cannot access the sold product and associated case.
