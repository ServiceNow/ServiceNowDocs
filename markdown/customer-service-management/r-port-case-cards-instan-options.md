...
**Note:** If no query is provided, all case records are displayed in the widget. For more information, see [Generate an encoded query string through a filter](https://www.servicenow.com/docs/access?context=t_GenEncodQueryStringFilter&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
