...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/migrate-skills-m2m-table.html
release: zurich
topic_type: task
...
1.  [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_AddAPropertyUsingSysPropsList.md) with the following settings.

<table id="choicetable_i5b_yht_wcb"><thead><tr><th align="left" id="d199856e84">

Option

</th><th align="left" id="d199856e87">

Description

</th></tr></thead><tbody><tr><td id="d199856e93">
