...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/create-decision-paths.html
release: xanadu
topic_type: task
...
-   [Add questions or instructions to a decision input](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/create-decision-input.md)
-   [Provide actions to agents in a decision tree](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/associate-guidance-path.md)
-   [Link another decision tree to this decision tree](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/configure-linking-node.md)
