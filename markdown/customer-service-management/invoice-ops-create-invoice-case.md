...
-   [Add an invoice case line to an invoice case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/invoice-ops-add-invoice-case-line-item.md)
-   [Create a task for an invoice case line](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/invoice-ops-create-case-line-task.md)
