...
To customize this portal, navigate to **Service Portal** &gt; **Portals** and select **Consumer Portal**. For details about creating a custom interface, see [Service Portal](https://www.servicenow.com/docs/access?context=c_ServicePortal&version=australia&pubname=australia-platform-user-interface&ft:locale=en-US).
