...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/t\_CreateAnAssignmentRule.html
release: xanadu
topic_type: task
...
2.  Click the **Create assignment rule** related link.
    ...
    You can also create an assignment rule by navigating to **Routing and Assignment** &gt; **Assignment Rule** and clicking **New**.
...
**Warning:** Clearing the system cache can affect overall performance, and degrade system response times. Do not run cache flushes during business hours, and do not trigger cache flushes automatically.
...
[Define assignment rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/table-administration-and-data-management/c_DefineAssignmentRules.md)
