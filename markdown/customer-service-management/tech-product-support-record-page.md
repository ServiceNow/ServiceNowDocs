...
The audience determines who can see the page variant. The Technology product support record page variant audience does not specify any user roles so all users can see this variant.
