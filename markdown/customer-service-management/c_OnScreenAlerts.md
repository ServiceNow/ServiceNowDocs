---
title: Special handling notes overview
...
Users with the sn\_shn.admin role can configure the desired entity tables, such as the Case table, to use special handling notes. Special handling notes can also be configured to display in the following ways:

-   [In an embedded list or a related list on a record form](c_OnScreenAlerts.md#section_myw_fwg_scc).
-   [In a pop-up window that displays when a user accesses a form](c_OnScreenAlerts.md#section_why_gwg_scc).
