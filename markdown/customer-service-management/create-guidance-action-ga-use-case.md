...
You can configure the preview experience for all the action behavior types and configure the detail view for the actions that open in the subtab or contextual side panel. For more information, see [Configure guidance detail experience](configure-guidance-preview-detail-experiences-ga.md).
