...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/create-guidance-action-ga-use-case.html
release: australia
topic_type: task
