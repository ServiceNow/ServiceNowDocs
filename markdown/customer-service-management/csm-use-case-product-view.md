...
See [Applying CSDM guidelines to your product — product views](https://www.servicenow.com/docs/access?context=use-cases&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) for more information on Common Service Data Model use cases.
