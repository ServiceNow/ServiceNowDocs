...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/csm-use-case-product-view.html
release: xanadu
topic_type: concept
...
CSM provides proactive customer service, decreases cost of service, and provides end-to-end visibility to both customer service and service delivery groups. For more information, see [Integrating with Service Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-spm-integration.md).

For information on setting up the data, see [Configure foundation data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/configure-csm-foundation-data.md).
...
See [Applying the CSDM guidelines to your product](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/common-service-data-model-csdm/use-cases.md) for more information on Common Service Data Model use cases.
