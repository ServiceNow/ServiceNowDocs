...
For more information, see [Activate a plugin](https://www.servicenow.com/docs/access?context=t_ActivateAPlugin&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
[Getting started with ServiceNow Agent](https://www.servicenow.com/docs/access?context=mobile-experience&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US)
