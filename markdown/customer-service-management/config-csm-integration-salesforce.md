...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/config-csm-integration-salesforce.html
release: zurich
topic_type: task
...
1.  To configure the Salesforce spoke, follow the instructions in [Set up the Salesforce spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/setup-sf-spk.md).
