...
description: You can activate the UI Components for Customer Portals plugin \(sn\_ciwf\_ui\_cmpnt\) to enable Configurable Portal widgets. The application installs related plugins if they are not already installed.
locale: en-US
release: xanadu
topic_type: task
...
You can activate the UI Components for Customer Portals plugin \(sn\_ciwf\_ui\_cmpnt\) to enable Configurable Portal widgets. The application installs related plugins if they are not already installed.
