...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/setup-idle-state-and-directory.html
release: australia
topic_type: task
...
4.  Use the **Edit** icon to update entries.
    ...
    By default, the **Outbound call**, **Logout**, and **Phone directory** options are enabled. You can clear any options as needed. See [Configuring Transfer capabilities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/configure-transfer-capability.md).
