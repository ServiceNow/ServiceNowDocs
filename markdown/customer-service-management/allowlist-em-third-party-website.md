...
You must activate the Custom URL \(com.snc.customurl\) plugin. For more information, see [Activate custom URLs](https://www.servicenow.com/docs/access?context=activate-custom-url-plugin&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
...
[Set a custom URL as the instance URL](https://www.servicenow.com/docs/access?context=configure-custom-url&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US)

[Custom URLs association to your instance](https://www.servicenow.com/docs/access?context=custom-url&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US)

[Custom URL errors and fixes](https://www.servicenow.com/docs/access?context=custom-url-error-fix&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US)
