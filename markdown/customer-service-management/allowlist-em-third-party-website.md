...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/customer-service-management/allowlist-em-third-party-website.html
release: brazil
topic_type: task
...
You must activate the Custom URL \(com.snc.customurl\) plugin. For more information, see [Activate custom URLs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/activate-custom-url-plugin.md).
...
[Set a custom URL as the instance URL](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/configure-custom-url.md)

[Custom URLs association to your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/custom-url.md)

[Custom URL errors and fixes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/custom-url-error-fix.md)
