...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/config-csm-third-party-integration.html
release: yokohama
topic_type: task
