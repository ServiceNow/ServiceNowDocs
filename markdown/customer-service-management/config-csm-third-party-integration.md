...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/config-csm-third-party-integration.html
release: australia
topic_type: task
