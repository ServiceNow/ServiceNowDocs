...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/csm-config-ws-action-layout-groups.html
release: australia
topic_type: concept
...
-   Minimize the record to the [workspace dock](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/customer-service-management/csm-config-ws-bottom-utility-bar.md).
