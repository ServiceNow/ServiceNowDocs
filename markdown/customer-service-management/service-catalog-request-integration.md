...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/service-catalog-request-integration.html
release: yokohama
topic_type: concept
...
For more information, see [Associate a portal with a catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/service-portal/associate-portal-catalog.md).
