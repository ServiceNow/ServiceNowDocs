...
Activate the CSM with Service Portfolio Management \(SPM\) plugin to use the integration with Service Portfolio Management.

## Before you begin

Consider using guided setup to complete the Service Portfolio Management configuration. For more information, see [Integrate with Service Portfolio Management using Guided Setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/spm-csm-integration.md).
...
2.  Search for the sn\_csm\_spm plugin.
