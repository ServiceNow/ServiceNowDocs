...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/service-definitions-components.html
release: yokohama
...
This table stores the defined case types.For more information, see [Customer Service case types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/customer-service-case-types.md).
...
For more information, see [Service definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/csm-service-definitions.md).
...
This table stores the catalog items that are linked to a service definition.For more information, see [Configure catalog items for a service definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/service-def-config-catalog-items.md).
