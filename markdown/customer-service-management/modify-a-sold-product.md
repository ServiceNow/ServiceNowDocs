...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/modify-a-sold-product.html
release: xanadu
...
4.  In the Sold Products related list, select the product that you want to modify the characteristics and line items for.
    ...
    **Note:** You can do a **Modify** action on either the root or the child sold products only if the sold product is in the **Active** state. If you select two sold products at the same time, you can't do the **Modify** action.
