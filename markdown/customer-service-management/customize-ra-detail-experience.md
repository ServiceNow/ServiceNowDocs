...
5.  Bind the preview experience properties to your custom detail UI.
    ...
    Data bindings are located in the **Config** tab of the configuration panel in UI Builder. For more information, see [Data resources in UI Builder](https://www.servicenow.com/docs/access?context=data-resources&version=australia&pubname=australia-application-development&ft:locale=en-US).
...
</table>    For more information, see [Define and bind client scripts to components](https://www.servicenow.com/docs/access?context=define-client-scripts&version=australia&pubname=australia-application-development&ft:locale=en-US).
