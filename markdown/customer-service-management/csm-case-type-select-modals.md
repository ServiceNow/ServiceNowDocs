...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/csm-case-type-select-modals.html
release: xanadu
topic_type: concept
...
The selections that an agent can make is determined by the case type selector configuration. The system administrator can configure [different versions of the case type selector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-case-type-select-modals.md) by setting [properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-case-type-select-modals.md). The different versions include:

-   Multi-select \(default\)
-   single-select
-   [Product Service select](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-case-type-select-modals-product-service.md)
...
</table>Some declarative actions available with the Customer Service Case Types plugin are disabled by default. For more information, see [Configure case type and case task type declarative actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/config-case-type-declarative-action.md).
...
**Note:** If a subtype has not been configured for a case type, the subtype field is not displayed.
 ...
 For more information, see [Select a category and subtype for a case type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/manage-csm-case-types.md).
...
-   [Enable the case type single select property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/enable-case-type-single-select-prop.md)
-   [Create a configuration for case type single-select](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/create-case-type-single-selection.md)
