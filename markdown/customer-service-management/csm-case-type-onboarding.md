...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/csm-case-type-onboarding.html
release: zurich
topic_type: concept
...
The Case Playbook for Onboarding application \(com.sn\_csm\_onboarding\_caseflow\) is available from the ServiceNow® Store. For more information, see [Playbook plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/setting-up-csm-playbooks.md).
...
2.  [Configure the list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_PersonalLists.md) to show the **Name** field.

Only one PAD process per playbook can be active at a time. For more information, see [Process definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/process-definitions.md).
...
Feature that determines how the stages and activities appear in the playbook.
 ...
 The Case Playbook for Onboarding uses the [Focused activity view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/csm-playbook-layout.md), which enables agents to see
...
When an agent creates an onboarding case, the workspace opens the Create New Onboarding Case form, launches the onboarding playbook, and uses the first activity to gather customer information.
 ...
 For more information about the products and services, see [Service definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/csm-service-definitions.md).
...
Agents can create tasks as needed and view and update the case details. For more information, see [Playbook pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/customer-service-management/csm-playbook-pages.md).
