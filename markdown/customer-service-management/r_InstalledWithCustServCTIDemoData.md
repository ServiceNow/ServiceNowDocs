---
title: Components installed with Customer Service CTI Demo Data
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/r\_InstalledWithCustServCTIDemoData.html
release: australia
...
**Note:** Starting with the Yokohama release, Customer Service CTI Demo Data is being prepared for future deprecation. It will be hidden and no longer activated on new instances but will continue to be supported. ServiceNow Voice with Amazon Connect provides the latest experience for this functionality.
...
Route available user for Case Task
...
Used to dequeue a call whenever an agent becomes available.
