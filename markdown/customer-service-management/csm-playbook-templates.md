...
The playbook page templates include modular components that enable you to quickly build playbook pages in [UI Builder](https://www.servicenow.com/docs/access?context=ui-builder-overview&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
...
For more information about using multiple form controllers, see [Add forms to UI Builder pages](https://www.servicenow.com/docs/access?context=add-forms-to-ui-builder-pages&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
