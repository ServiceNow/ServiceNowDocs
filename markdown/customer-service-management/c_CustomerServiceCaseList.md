 ...
 **Note:** A [contact relationship](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/c_ContactRelationships.md) enables a contact with the customer role or customer admin role to manage the account for which the contact relationship has been established.
