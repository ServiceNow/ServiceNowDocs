...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/customer-service-management/ra-csm-contexts.html
release: brazil
topic_type: concept
...
For more information on how context inputs limit the inheritance of the parent context's rules and recommendations, see [Context Input configuration limitations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/ra-csm-dynamic-context-inputs.md).
...
[Create a context in Recommended Actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/ra-csm-contexts-create.md)
