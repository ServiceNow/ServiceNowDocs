...
A list of [blocking tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/case-action-status-blocking-tasks.md) that have been created for this case.
