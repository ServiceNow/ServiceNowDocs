...
[Triggers](https://www.servicenow.com/docs/access?context=create-trigger-definition&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US) are created in [Workflow Studio](https://www.servicenow.com/docs/access?context=workflow-studio&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
