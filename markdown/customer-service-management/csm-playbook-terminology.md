...
[Triggers](https://www.servicenow.com/docs/access?context=create-trigger-definition&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US) are created in [Workflow Studio](https://www.servicenow.com/docs/access?context=workflow-studio&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
