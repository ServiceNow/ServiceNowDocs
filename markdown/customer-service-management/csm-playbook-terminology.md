...
[Triggers](https://www.servicenow.com/docs/access?context=create-trigger-definition&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US) are created in [Workflow Studio](https://www.servicenow.com/docs/access?context=workflow-studio&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
