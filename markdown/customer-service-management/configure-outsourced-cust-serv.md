...
1.  Run all diagnostics on all records, as described in [Performance Analytics diagnostics](https://www.servicenow.com/docs/access?context=self-diagnostics&version=australia&pubname=australia-now-intelligence&ft:locale=en-US).
