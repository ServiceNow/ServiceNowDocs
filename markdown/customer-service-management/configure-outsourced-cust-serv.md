...
<table id="choicetable_nmd_nql_mlb"><thead><tr><th align="left" id="d123576e388">

Option

</th><th align="left" id="d123576e391">

Description

</th></tr></thead><tbody><tr><td id="d123576e397">
...
4.  Fill in the fields on the Outsourced Service Provider form, as appropriate.
    ...
    **Note:** A new OSP staff member record is created and the OSP is created in the **Organization** field of the external organization staff \(formerly service organization external staff\) \[sn\_csm\_service\_organization\_external\_staff\] table. Additionally, the same including Onboard Agent, ​Onboard Manager, ​Create Group​, Transfer Case, ​Register Staff​, and Register Member.
...
<table id="choicetable_ckq_svb_hlb"><thead><tr><th align="left" id="d123576e970">

Option

</th><th align="left" id="d123576e973">

Description

</th></tr></thead><tbody><tr><td id="d123576e979">
