...
After creating a service definition category, you can [associate service definitions with the category](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/service-def-category-associate-service.md). These associated service definitions are stored in the Service Definition Category Relationships related list.
