...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/case-categorization-components.html
release: xanadu
...
breadcrumb: [Install the Task Intelligence for Customer Service application, Task Intelligence for Customer Service, Machine learning solutions for Customer Service Management, Implement Intelligence, Configuring Customer Service Management, Customer Service Management]
---
...
-   **Sentiment over time**: Displays the sentiment trend prediction as an agent works to resolve the case. To be able to calculate a value for this field, there must be a minimum of two sentiment predictions.
...
For more details about skipped predictions, see [Logic for Skipped field values](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/case-categorization-components.md) below.
...
| |Empty|Yes|False|
| |Empty|Empty|True|
|Prediction unsuccessful|N/A|N/A|True|
|Prediction error|N/A|N/A|True|
...
**Note:** You can track tasks from the ML Solutions table \(ml\_solution.list​\).
...
-   Leave the property empty to enable all of the supported file extensions. This is the default setting.
...
**Note:** This property is automatically set to true when a language detection module is tested and deployed from the [Task Intelligence Admin Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-task-intel-admin-center.md).
...
Waits for several milliseconds before fetching valid attachments for Task Intelligence for Customer Service when a case is created from email.**Note:** This property is inactive by default. If you notice that attachments are being missed for cases created from email, enable this property.
...
Language detection determines the language used to create a case.
 ...
 This flow is automatically activated when a language detection module is trained and deployed from the [Task Intelligence Admin Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-task-intel-admin-center.md).
