...
Your administrator must [enable creation of articles from customer service cases](https://www.servicenow.com/docs/access?context=administer-create-article-from-case&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
