...
1.  Create the email service channel.
    ...
    The system adds the Email Interaction channel to the Service Channels list. For more information, see  Create or configure a service channel.
...
5.  Create a group for the queue.
    ...
    3.  On the Group form, fill in the fields.
        ...
        For more information about creating a group, see Create or change groups for Advanced Work Assignment queues.
...
After the service channel is activated, you can use it to assign work items. For more information, see Service channels.
