...
You can use the  [Advanced Work Assignment \(AWA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-overview.md) feature to automatically assign work items to users based on their availability and capacity.

**Note:** You can also configure external routing with third-party providers. For more information, see [Enable external routing for queues](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/enable-awa-external-routing.md).
...
1.  Create the email service channel.
    ...
    The system adds the Email Interaction channel to the Service Channels list. For more information, see  [Create or configure a service channel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-create-service-channel.md).
...
2.  Configure the layout for the email interaction inbox card.
    ...
    **Note:** The Inbox layouts are configured during the installation of the Email Interaction for CSM application.
    ...
     If you want to create Inbox layouts follow the procedure in [Create or modify an inbox layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-modify-inbox-layout.md) for **Email** service channel, available by default, or **Custom-Email** service channel.
...
5.  Create a group for the queue.
    ...
    3.  On the Group form, fill in the fields.
        ...
        For more information about creating a group, see [Create or change groups for Advanced Work Assignment queues](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-groups.md).
...
After the service channel is activated, you can use it to assign work items. For more information, see [Service channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/awa-service-channels.md).
