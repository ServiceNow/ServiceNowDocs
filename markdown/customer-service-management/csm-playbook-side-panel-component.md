...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/csm-playbook-side-panel-component.html
release: xanadu
topic_type: concept
...
The activity stream displays a list of activities occurring on a case record. For more information, see [Playbook activity stream component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-playbook-activity-stream-component.md).
...
The Related Items tab provides access the case related lists.The Case playbook: horizontal stages page incorporates related list functionality into the contextual side panel. These lists appear in an accordion format that agents can expand and collapse as needed.
...
For more information, see [Playbook related items component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-playbook-related-items-component.md).
