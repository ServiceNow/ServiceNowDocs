...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/agent-create-request-for-customer.html
release: australia
topic_type: task
...
<table id="choicetable_vjq_k4q_g3b"><thead><tr><th align="left" id="d122908e118">

Interface

</th><th align="left" id="d122908e121">

Action

</th></tr></thead><tbody><tr><td id="d122908e127">
...
1.  Click **Order Now**.
2.  Add or change the information in these fields on the Order Confirmation pop-up window: **Request for**, **Delivery information**, **Special instructions**.
3.  Click **Checkout**.
 The system creates the request and displays the request number. Click **View Details** to open the request record.

</td></tr><tr><td id="d122908e172">
