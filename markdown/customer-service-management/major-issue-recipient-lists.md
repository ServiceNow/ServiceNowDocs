...
Refresh a recipients list by clicking **Refresh Recipient List** on the Recipients List form. For major issue management, the following guidelines apply to refreshing a recipients list:
