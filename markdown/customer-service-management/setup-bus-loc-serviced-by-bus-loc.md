...
The Service Model Foundation enables business locations to request help from others and fulfil such requests. Besides supporting customers, business locations can also support other service organizations.
...
-   Setup inter-organization support for their stores by associating each store with its regional service organization.
...
-   Improve agent experience: Provide agents at a business location with visibility into the other business locations they support.
...
-   Increase operational efficiency: Define support structures for service organisations through hierarchy or relationship-based criteria.
