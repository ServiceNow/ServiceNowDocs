...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/csm-integration-service-management.html
release: xanadu
topic_type: concept
...
For more information, see [Creating incident, problem, change, and request records from Agent Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/csm-item-agent-tasks.md).
...
For more information, see [View records related to a case from the Customer and Consumer Service Portals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/view-related-records-from-portal.md).
