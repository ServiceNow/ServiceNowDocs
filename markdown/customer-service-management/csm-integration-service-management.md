...
For more information, see [Creating incident, problem, change, and request records from Agent Workspace](csm-item-agent-tasks.md#).
...
For more information, see [View records related to a case from the Customer and Consumer Service Portals](../task/view-related-records-from-portal.md).
