...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/em-callback.html
release: xanadu
...
-   For more information about how to configure Omnichannel Callback for Customer Service Management \(CSM\), see[Configuring Omnichannel Callback for Customer Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/configure-omni-callback.md)
-   For more information about how to manage a callback from an agent using Engagement Messenger, see [Working with callback requests using Engagement Messenger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/request-callback-from-em.md)
