...
Use Interaction Controls Component \(ICC\) and OpenFrame to integrate with the voice channel for contact centers. For more information, see [Integrating contact centers with Interaction Controls Component \(ICC\) for voice calls](contact-center-integration-with-icc.md).
