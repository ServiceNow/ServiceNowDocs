...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/task-plan-template-item-condition-form.html
release: australia
...
The table on which the is condition applied.When you create a condition, you select a table on which the conditions are applied. The following tables are available for selection:
