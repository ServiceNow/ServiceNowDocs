...
breadcrumb: [Creating rules for incoming emails that create and assign cases, Email to case, Configuring the email channel, Configure communication channels, Enable communication channels, Configuring Customer Service Management, Customer Service Management]
---
...
[Building flows](https://www.servicenow.com/docs/access?context=flows&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)

[Building custom actions](https://www.servicenow.com/docs/access?context=actions&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
