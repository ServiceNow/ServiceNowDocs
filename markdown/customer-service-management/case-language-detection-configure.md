...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/case-language-detection-configure.html
release: zurich
topic_type: concept
...
For more information about the languages supported by language detection, see this topic: [Languages supported by Task Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/languages-supported-by-language-detection.md).
