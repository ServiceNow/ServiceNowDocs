...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/c\_CreateAProductModel.html
release: xanadu
...
Ensure that the Model Management plugin \(com.snc.model\) is installed.
...
4.  Fill in the fields for the selected product model, as appropriate
    ...
    See [Model form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/product-catalog/r_ModelFormFields.md) for field descriptions.
