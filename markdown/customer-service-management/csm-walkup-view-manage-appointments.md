...
4.  Click an appointment number to view details, such as the requester name, the interaction number and description, and the appointment time.
    ...
    2.  Click **Accept appointment** to begin working on the interaction.
        ...
        If a significant amount of time has passed and the requester does not show up for the appointment, you can delete the appointment by clicking the More UI actions icon ![More UI actions icon.](../../../common/image/Form_MoreOptions.png) in the interaction header and choosing **Delete**.
