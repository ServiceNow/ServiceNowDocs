...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/csm-walkup-view-manage-appointments.html
release: xanadu
topic_type: task
...
4.  Click an appointment number to view details, such as the requester name, the interaction number and description, and the appointment time.
    ...
    2.  Click **Accept appointment** to begin working on the interaction.
        ...
        If a significant amount of time has passed and the requester does not show up for the appointment, you can delete the appointment by clicking the More UI actions icon \[Omitted image "Form\_MoreOptions.png"\] Alt text: More UI actions icon. in the interaction header and choosing **Delete**.

    3.  Click **Save** to save any changes you make to the appointment interaction.
