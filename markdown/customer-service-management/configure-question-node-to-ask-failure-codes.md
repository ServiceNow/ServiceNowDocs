...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/configure-question-node-to-ask-failure-codes.html
release: xanadu
...
[Configure a path](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/configure-path-for-200-failure-code.md) for each failure code the customer can receive after a failed credit card transaction.
