...
2.  Select **Review in DocIntel** to open the [Document Intelligence workspace](https://www.servicenow.com/docs/access?context=doc-intel-workspace&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US) in a separate tab and view the attachments and extracted values.
