...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/customer-service-management/configure-case-action-status-flows.html
release: australia
topic_type: task
