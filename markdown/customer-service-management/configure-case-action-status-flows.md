...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/configure-case-action-status-flows.html
release: yokohama
topic_type: task
