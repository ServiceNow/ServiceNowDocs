...
Starting with the Yokohama release, CSM Configurable Workspace has a dependency on the Customer Central plugin. For more information, see [Customer Central plugin](customer-central.md#section_jmt_bnt_ydc).
