...
Make changes to a sold product or its characteristics. When you modify a sold product's characteristics, a sold product to quote flow is triggered. This flow applies changes to the existing sold product characteristics and presents customers with a quotation based on their selected changes.
