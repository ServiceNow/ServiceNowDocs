...
[Thin compose modeless dialogs](csm-front-line-case-page-modeless-dialogs.md) enable agents to initiate a work note or email from the activity stream in a modeless dialog.
