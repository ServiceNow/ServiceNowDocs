...
Maintain an organizational structure by creating internal and external business locations. To create a business location, see [Create a business organization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/customer-service-management/create-business-location.md).
