...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/extension-points-for-workflows.html
release: zurich
topic_type: concept
...
-   If you want to execute custom Lead to Cash Core configurations. To learn more about existing Lead to Cash configurations, see [Entity configuration and mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/order-management/entity-configuration-and-mapping.md).
