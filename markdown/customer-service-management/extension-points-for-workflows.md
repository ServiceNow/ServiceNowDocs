...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/extension-points-for-workflows.html
release: xanadu
...
You can create extension points so that you can create a workflow for a sold product extension that is not already configured. You can also override extension points in order to create configurations. To learn more about the existing extensions and configurations of the Customer Life Cycle Management Workflows, see [Customer Life Cycle Management Workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/customer-life-cycle-management-workflows.md).
...
CustomerWorflowsEPsn\_l2c\_cust.flows.CustomerWorkflowEP
