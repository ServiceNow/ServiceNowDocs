...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/config-csm-config-ws-ui-action.html
release: xanadu
...
This procedure adds the **Create Case** UI action to records in the configured table. Selecting this UI action displays the Select a case type popup window.
...
3.  Select the **Create Case** action with this description:
    ...
    This Create Case UI action enables the agent to create a case on Agent Workspace by selecting the type of case from a list of available case types.
