...
The Recommended Actions for Customer Service application provides context records for the Case and Interaction tables. A [context](ra-csm-contexts.md) enables agents to see recommendations for records from a specific table when certain rules are met.
