...
For information about creating a customer account, see [Configure accounts and contacts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/configure-csm-accounts-contacts.md).
...
The parent account for this account. Use this field to create an [Account hierarchy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/c_AccountHierarchy.md).
