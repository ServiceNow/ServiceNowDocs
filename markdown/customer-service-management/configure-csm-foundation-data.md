...
A consumer is a customer in the business-to-consumer \(B2C\) business model. Import and verify existing consumer data. For more information, see [Import consumers with guided setup](import-csm-consumers.md).
