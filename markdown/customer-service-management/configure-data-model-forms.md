...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/configure-data-model-forms.html
release: xanadu
topic_type: task
...
2.  In the Service Model Foundation category, click **Get Started**.

3.  Click **Configure Forms and List**.
...
9.  Add the **Primary Household** \(Household\) field to the Consumer form for these views: Case and Workspace.
    ...
    **Note:** After the **Household** field is added to the Consumer form for both case and workspace views, observe the following behavior: the form for a new consumer does not have a **Primary Household** field.
