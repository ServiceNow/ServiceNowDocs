...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/create-user-consumer-relationship.html
release: xanadu
topic_type: task
...
3.  In the Consumer Relationships related list, click **New**.

    This related list shows the current relationships that exist for the selected consumer. When you click **New**, a new Consumer to Consumer Relationship form is displayed with the **Consumer is** field filled in.
