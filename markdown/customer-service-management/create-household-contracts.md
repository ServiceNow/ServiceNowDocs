...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/create-household-contracts.html
release: yokohama
...
5.  Fill in the remaining fields on the Contract form.
    ...
    For more information, see [Create service contracts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/create-csm-service-contracts.md).
