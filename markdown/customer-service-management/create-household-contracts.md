...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/create-household-contracts.html
release: xanadu
...
5.  Fill in the remaining fields on the Contract form.
    ...
    For more information, see [Create service contracts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/create-csm-service-contracts.md).
