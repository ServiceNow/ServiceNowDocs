...
5.  In the Catalog tab, add products to the new quote or order that is created.
    ...
    For more info, see [Add products to a quote](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/order-management/sales-and-order-management/quote-management-catalog-tab.md).
