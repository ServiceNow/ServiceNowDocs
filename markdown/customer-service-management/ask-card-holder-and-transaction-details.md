...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/ask-card-holder-and-transaction-details.html
release: xanadu
topic_type: task
...
[Add paths and configure conditions for transactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/configuring-paths-for-next-nodes.md) when the next question or guidance node is displayed in a decision tree.
