...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/ask-card-holder-and-transaction-details.html
release: yokohama
...
1.  Select **Open in Builder**.
    ...
    \[Omitted image "ex-open-in-builder.png"\] Alt text: After entering the details in Decision tree new record and submitting the form, the Open in Builder button is shown.
...
[Add paths and configure conditions for transactions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/configuring-paths-for-next-nodes.md) when the next question or guidance node is displayed in a decision tree.
