...
-   in the sys\_user table, enable the **Geolocation tracked** field for all your field service agents who would be assigned to the customer work orders.
    ...
    For more information, see [Location tracking](https://www.servicenow.com/docs/access?context=r_LocationTracking&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US).
