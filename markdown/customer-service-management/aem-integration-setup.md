...
-   Activate the Customer Service plugin \(com.sn\_customerservice\) to use the Case API endpoints for customer service cases. For more information, see [Case API](https://www.servicenow.com/docs/access?context=case-api&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
-   Configure the **glide.rest.attachment\_csm\_api.allowed\_tables** system property and include the Case \[sn\_customerservice\_case\] table to use the CSM Attachment API end points for case attachments. For more information, see [CSM Attachment API](https://www.servicenow.com/docs/access?context=attachment_csm-api&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
