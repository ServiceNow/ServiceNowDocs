...
[Set up email templates in Configurable Workspace](https://www.servicenow.com/docs/access?context=configure-email-templates&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
...
[Add an activity to a playbook](https://www.servicenow.com/docs/access?context=playbook-add-optional-activity&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
