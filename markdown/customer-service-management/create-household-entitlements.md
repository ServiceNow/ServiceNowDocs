...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/create-household-entitlements.html
release: xanadu
topic_type: task
...
5.  Fill in the remaining fields on the Entitlement form.
    ...
    For more information, see [Create entitlements for CSM entities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/c_CreateAnEntitlement.md).
