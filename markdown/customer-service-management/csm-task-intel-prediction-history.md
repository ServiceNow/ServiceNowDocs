...
**Note:** Records are created in the Predictor Result table regardless of the model prediction behavior. This includes the Testing behavior that does not add prediction values to the case.
