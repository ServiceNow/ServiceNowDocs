...
**Note:** See [Implement the Interaction Controls Component \(ICC\) for contact center integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/enable-icc-for-ccaas.md) to manage the integration dependencies before using the feature.

\[Omitted image "csm-nvc-call-transfer.png"\] Alt text: Screenshot showing the embedded voice controls in agent workspace with call transfer
