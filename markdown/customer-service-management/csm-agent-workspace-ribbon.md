...
You can also display the form ribbon in the form ribbon in the Contextual side panel. For more information, see [Display the form ribbon and form header secondary values in the Contextual side panel](../../../product/customer-service-management/task/config-csm-display-header-in-sidebar.md).
