...
You can also create a quick link and add it to the Quick Links \[sn\_ex\_sp\_quick\_link\] table. For more information, see [Create a quick link](https://www.servicenow.com/docs/access?context=create-quick-links&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).
