...
3.  Fill in the fields on the Create New pop-up window.
    ...
    For more information about these fields, see [Create an investment board](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/it-business-management/create-an-investment-report.md).
