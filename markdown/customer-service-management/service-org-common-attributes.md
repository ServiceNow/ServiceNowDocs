...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/service-org-common-attributes.html
release: yokohama
topic_type: concept
...
The following table lists the common attributes that have been identified across industries for the service organization \[sn\_customer\_service\_organization\] table.

|Field Name|Description|
|----------|-----------|
|Email|Primary email address for the service organization.|
|Identification number|ID that is used to identify the service organization.|
