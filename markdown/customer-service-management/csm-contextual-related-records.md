...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/csm-contextual-related-records.html
release: yokohama
topic_type: concept
last_updated: "2025-01-30"
reading_time_minutes: 3
breadcrumb: [Configure dynamic related records, Agent tools, Organize agent workspaces, Configuring Customer Service Management, Customer Service Management]
---
...
System administrators can also configure the related record card format. For more information, see [Configuring dynamic related records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/dynamic-related-records-configure.md).
...
For more information about these agent actions, see [Using the Related Records tab in the contextual side panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/using-dynamic-related-records.md).
...
This plugin also adds several related record definitions. For more information, see [Related record definitions included with the plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/dynamic-related-records-configure.md).
...
[Configure dynamic related records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/dynamic-related-records-configure.md)

[Using the Related Records tab in the contextual side panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/customer-service-management/using-dynamic-related-records.md)
