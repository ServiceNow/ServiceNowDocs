...
[Create customer accounts](../../customer-service-management/task/configure-csm-accounts-contacts.md#)**Note:** On the Accounts form, to view the service contracts, remove the contract-related lists and configure the Service contracts related list.
