...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/set-up-post-sales-support.html
release: xanadu
topic_type: concept
...
[Create a characteristic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/create-entitlement-template-characteristic.md)
...
[Create customer accounts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/configure-csm-accounts-contacts.md)**Note:** On the Accounts form, to view the service contracts, remove the contract-related lists and configure the Service contracts related list.
...
[Create a consumer record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/create-a-consumer-record.md)
...
[Create a sold product](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/create-sold-item.md)
...
[Create an install base item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/create-install-base-item.md)
