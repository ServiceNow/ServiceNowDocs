...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/customer-service-management/configure-user-criteria-for-a-service-definition.html
release: zurich
topic_type: task
...
4.  In the **User criteria** field, select a user criteria record.
    ...
    For more information about the fields on this form, see [User criteria form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/user-criteria-form.md).
