...
description: Search for a knowledge article in Agent Assist or or Recommended Actions - AI Search and then open the article in a sub-tab.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/customer-service-management/csm-workspace-open-knowledge.html
release: xanadu
...
3.  Perform one of the following:
    ...
    -   In the Recommended Actions - Search tab, search for the desired article and select the Search source as **Knowledge** to filter the knowledge articles.
        ...
        For more information on how to enable Recommended Actions - AI Search and disable Agent Assist, see [Enable AI search in Recommended Actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/customer-service-management/migrate-ra-agent-assist.md).
