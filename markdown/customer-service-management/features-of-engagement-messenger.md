...
-   **Search**
    ...
    **Note:**
    ...
    -   You must configure AI Search in your ServiceNow instance and then enable Typeahead Search and AI Search Assist widgets so that the unauthenticated users can use the AI search feature from Engagement Messenger.
        ...
        For more information of AI Search configuration, see [Configuring AI Search](https://www.servicenow.com/docs/access?context=configuring-ais&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
-   **Field service management**
    ...
    **Note:**
    ...
    -   Ensure that the Field Service Management - Customer Experience plugin \(com.snc.fsm\_customer\_experience\) is active in your ServiceNow instance.
...
-   **Walk-up appointments**
    ...
    **Note:** To enable walk-up feature for your customers, ensure that you activate the following plugins in your ServiceNow instance:
