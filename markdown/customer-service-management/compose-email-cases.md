...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/customer-service-management/compose-email-cases.html
release: yokohama
topic_type: task
...
3.  Click the More UI Actions \[Omitted image "agent-workspace-more-ui-actions-icon.jpg"\] Alt text: agent workspace more UI actions icon icon and select **Compose Email**.
...
4.  Compose your email and click **Send**.
    ...
    **Note:** You can also click **Save** to save the email and send it later. These drafts are available in the **Draft Emails** related list. To access the draft in the email compose tab, click the More UI Actions \[Omitted image "agent-workspace-more-ui-actions-icon.jpg"\] Alt text: agent workspace more UI actions icon icon and select **View Draft** to see the saved draft.
