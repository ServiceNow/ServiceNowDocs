...
3.  Select the More Actions \( ![CSM configurable workspace more actions icon)](../image/workspace-more-actions-icon.png) icon and select **Compose Email**.
...
4.  Compose your email and select **Send**.
    ...
    **Note:** You can also select **Save** to save the email and send it later. These drafts are available in the **Draft Emails** related list. To access the draft in the email compose tab, select the More Actions \( ![CSM configurable workspace more actions icon)](../image/workspace-more-actions-icon.png) icon and select **View Draft** to see the saved draft.
