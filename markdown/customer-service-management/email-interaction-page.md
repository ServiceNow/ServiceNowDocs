...
|State|Current state of the interaction. For more information, see [Interaction states](https://www.servicenow.com/docs/access?context=interaction-states&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).|
...
Enables agents to view the email conversations between the agent and customer. For more information, see [Using Activity stream in an email interaction](../concept/using-activity-stream-in-an-email-interaction.md).
