...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_RequestAPlugin.html
release: yokohama
topic_type: task
...
2.  From the Application Manager, select **Request Plugin** to open the **Activate Plugin** form on Now Support.
    ...
    \[Omitted image "request-plugin-appmgr.png"\] Alt text: Request Plugin button in the Application Manager.
...
**Parent Topic:**[ServiceNow plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/c_ServiceNowPlugins.md)
