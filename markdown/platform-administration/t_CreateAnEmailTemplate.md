...
If the message body for the template is to be formatted using a predefined [email layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/create-email-layout.md), select the layout.
