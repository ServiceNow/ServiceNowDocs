...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/modify-notif-channel.html
release: yokohama
topic_type: task
...
3.  In the Edit Channel form, update the fields \(see [Create notification channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/create-channel.md) for descriptions of the form fields\).
