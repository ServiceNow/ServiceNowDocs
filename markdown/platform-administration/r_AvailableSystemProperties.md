...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/r\_AvailableSystemProperties.html
release: yokohama
topic_type: reference
last_updated: "2025-01-30"
reading_time_minutes: 139
...
-   **com.snc.pa.dc.flush\_snapshot\_count**
    ...
    Maximum number of Performance Analytics [snapshots](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/glossary/now-platform-glossary.md) to store in the memory during data collection. When this number is reached, the snapshots are offloaded to the database, freeing memory.
...
-   **com.snc.pa.dc.max\_row\_count\_indicator\_source**
    ...
    Maximum number of rows that are allowed to be fetched from an [indicator source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/glossary/now-platform-glossary.md). This property only applies to jobs that do not use [Optimized data collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/optimized-data-collection.md).
...
-   **com.snc.pa.dc.hsql.max\_row\_count\_indicator\_source**
    ...
    Maximum number of rows that are allowed to be fetched from an Indicator Source. This property only applies to jobs that use [Optimized data collection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/optimized-data-collection.md).
...
-   **com.snc.pdf.whitelisted\_urls**
    ...
    Stores a list of URLs allowed to be rendered in a PDF generated by the [PDFGenerationAPI - Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/server-api-reference/PDFGenerationAPIBothAPI.md). This list is only verified if the glide.pdf.url.whitelisting.enabled property is set to true.
...
-   **glide.amb.session.logout.overlay.style**
    ...
    \[Omitted image "screen-w-overlay.png"\] Alt text: Overlay
...
-   **glide.custom.ip.authenticate.allow**
    ...
    -   Default value: none
    -   Location: [Add the property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_AddAPropertyUsingSysPropsList.md) to the System Property \[sys\_properties\] table.
    -   Instance Security Hardening Settings: [Restrict performance monitoring access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/sc-performance-monitoring-acl.md)
...
-   **glide.db.forced.chunk.threshold**
    ...
    Sets the threshold above which to forces chunk record deletions and updates. Chunking helps to prevent non-primary key deletions on huge tables from causing replication problems. Use this property to set a force chunk threshold when using the [GlideRecord – DeleteMultiple](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/server-api-reference/c_GlideRecordScopedAPI.md) and [GlideRecord – UpdateMultiple](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/server-api-reference/c_GlideRecordScopedAPI.md) methods.
...
-   **glide.history\_set.pull\_journal\_entries\_from\_journal\_table**
    ...
    -   Type: true \| false
    -   Default value: false
    -   Location: [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_AddAPropertyUsingSysPropsList.md) to the System Property \[sys\_properties\] table.
-   **glide.home.page**
...
-   **glide.home.refresh\_intervals**
    ...
    **Important:**
    ...
    Use the [Homepage deprecation help tool](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/homepage-deprecation-help-tool.md) to convert the homepages on your instance to responsive dashboards.

    For more information, see:

    -   [Dashboards in the Analytics Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/analytics-center-dashboards.md).
    -   [Working with responsive dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/c_ResponsiveDashboards.md).
-   **glide.hosts.allowlist**

    Enables control over what hosts that a Fetch action can access. This affects HTTP APIs, like [RESTMessageV2 - Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/server-api-reference/c_RESTMessageV2API.md) and Fetch [Fetch - Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/server-api-reference/FetchAPI.md). Features of `glide.hosts.allowlist`:
...
-   **glide.html.sanitize\_all\_fields**
    ...
    -   Default value: true
    -   Location: System Property \[sys\_properties\] table
    -   Instance Security Hardening Settings: [HTML sanitizer \(instance security hardening\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/sc.md-sanitizer.md)
...
-   **glide.import\_excel.use\_only\_user\_session\_date\_format**
    ...
    -   Type: true \| false
    -   Default value: true
    -   Location: [Add the property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_AddAPropertyUsingSysPropsList.md) to the System Property \[sys\_properties\] table if you want to change the value to false.
...
-   **glide.product.name**
    ...
    \[Omitted image "GlideProductName1.png"\] Alt text: Glide Product Name
...
-   **glide.security.csrf.strict.validation.mode**
    ...
    -   Default value: false
    -   Location: System Property \[sys\_properties\] table
    -   Instance Security Hardening Settings: [CSRF strict validation \(instance security hardening\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/sc-csrf-strict-validation.md)
-   **glide.security.diag\_txns\_acl**
    ...
    -   Default value: false
    -   Location: [Add the property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_AddAPropertyUsingSysPropsList.md) to the System Property \[sys\_properties\] table.
    -   Instance Security Hardening Settings: [Performance monitoring \(ACL\) \(instance security hardening\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/sc-performance-monitoring-acl.md)
...
-   **glide.security.file.mime\_type.validation**
    ...
    -   Default value: false
    -   Location: System Property \[sys\_properties\] table
    -   Instance Security Hardening Settings: [Restrict uploaded MIME types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/sc-upload-mime-type-restriction.md)
...
-   **glide.set\_x\_frame\_options**
    ...
    -   Default value: true
    -   Location: System Property \[sys\_properties\] table
    -   Instance Security Hardening Settings: [Implement the x-frame-options: SAMEORIGIN security header](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/sc-x-frame-options-sameorigin.md)
...
-   **glide.ui.attachment.force\_download\_all\_mime\_types**
    ...
    -   Default value: true for new instances, false for upgraded instances
    -   Location: System Property \[sys\_properties\] table
    -   Instance Security Hardening Settings: [Restrict Downloadable MIME types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/sc-downloadable-mime-type-denylist.md)
...
-   **glide.ui.homepage.preview**
    ...
    \[Omitted image "HomepagePreviewIcon.png"\] Alt text: Preview icon
...
-   **glide.ui.m.clear\_pasteboard\_when\_backgrounded**
    ...
    -   Type: true \| false
    -   Default value: false
    -   Location: [Add the property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_AddAPropertyUsingSysPropsList.md) to the System Property \[sys\_properties\] table. In Categories, add the mobile\_post\_auth category.
...
-   **glide.ui.polaris.experience**
    ...
    Enables the Next Experience user interface, landing page, and Unified Navigation. For more information, see [Next Experience UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/next-experience-landing-page.md).
...
-   **mid.version.override**
    ...
    Sets an override condition for the current version for all MID Servers in your environment. For more information on version control, see [MID Server version control properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_UpgradeAndTestMIDServer.md).
...
-   **sn\_global\_searchui.hide\_results\_count**
    ...
    Hides \(**true**\) or displays \(**false**\) the number of matching records for search groups and tables on the [Global search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/search-administration/global-search-polaris-ui.md) page.

    To modify this property, select **Enhanced Global Search UI** from the [application picker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_SelectAnAppFromTheAppPicker.md) before opening the System Properties table.
...
-   **sn\_query\_gen.hidden\_insights.groupby.min\_fields**
    ...
    -   Default value: 5
    -   Location: System Property \[sys\_properties\] table
    -   Learn more: [Extended analysis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/hidden-insights.md)
-   **sn\_query\_gen.segments.disable.filter**
    ...
    -   Default value: false
    -   Location: System Property \[sys\_properties\] table
    -   Learn more: [Segments in the Query Generation semantic layer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/querygen-segments.md)
...
-   **sys\_par\_insights\_enabled**
    ...
    -   More information: [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_AddAPropertyUsingSysPropsList.md)
-   **tablet.footer.text**
...
**Parent Topic:**[Basic system configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/p_CoreConfigurationOverview.md)
