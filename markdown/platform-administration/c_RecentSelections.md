...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/c\_RecentSelections.html
release: zurich
topic_type: concept
...
\[Omitted image "RecentSelectionsFiltered.png"\] Alt text: A partially-filled in reference field to the User table displaying a filtered list of users whose names begin with the letter B.
...
[Available system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/r_AvailableSystemProperties.md)
