...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/modify-cloning-schedule.html
release: yokohama
topic_type: task
last_updated: "2025-07-31"
reading_time_minutes: 1
breadcrumb: [Schedule recurring clones \(legacy\), Manage, Instance Clone, Configure core features, Administer the ServiceNow AI Platform]
---
...
This topic assumes that you have a [Schedule recurring clones \(legacy\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/schedule-cloning.md) that you want to modify.
