...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/search-administration/configure-user-mapping-settings-external-content-connector.html
release: australia
