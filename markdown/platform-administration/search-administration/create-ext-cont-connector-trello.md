---
title: Create a Trello external content connector
description: Create an external content connector to retrieve searchable content from your Trello source system.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/search-administration/create-ext-cont-connector-trello.html
release: brazil
...
4.  On the Choose source page, select the **Trello** tile, then select **Next**.
...
Unique name for this Trello external content connector.
...
API key for the Power-Up that grants the connector access to your Trello source system.If you don't have the API key, ask your Trello administrator for it.
...
API token for the Power-Up that grants the connector access to your Trello source system.If you don't have the API token, ask your Trello administrator for it.
...
Trello ID for your enterprise \(organization\).If you don't have the enterprise ID, ask your Trello administrator for it.
...
Base URL for the Trello REST API.If you don't have the base URL, ask your Trello administrator for it.
...
8.  On the Crawl settings page, modify any default crawl settings that you want to override for this connector, then select **Next**.
    ...
    If you want to skip this step for now, select **Skip** instead of **Next**. You can modify the crawl settings for this connector from the External Content Admin Home page. For details on this procedure and the available crawl settings, see [Configure crawl settings for a Trello external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/configure-crawl-settings-trello-external-content-connector.md).
...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for a Trello external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/configure-crawl-settings-trello-external-content-connector.md).
-   For details on creating crawls for your new connector, see [Create a content crawl for an external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/create-content-crawl-external-content-connector.md).
...
**Parent Topic:**[Trello external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/trello-external-content-connector.md)
