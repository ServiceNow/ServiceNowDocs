...
description: Create an external content connector to retrieve searchable content and security principals from your Fluid Topics source system.
locale: en-US
