...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/search-administration/text-search-view-formats-results.html
release: zurich
...
\[Omitted image "search-result-format-polaris-ui.png"\] Alt text: Sample search result listing in Next Experience UI showing title, field list, and description.

\[Omitted image "jakarta-search-result-formatting.png"\] Alt text: Sample search result listing in Core UI showing title, field list, and description.
...
-   **[Default display fields for global search tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/search-administration/global-search-default-tables.md)**  
...
[Create and delete views](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/create-delete-view.md)
