...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/search-administration/create-ext-cont-connector-acc.html
release: australia
...
OAuth 2.0 client secret for the OAuth 2.0 Atlassian developer application that grants Confluence API access to your Atlassian Confluence Cloud source system. If you don't have this client secret, ask your Atlassian administrator for it.
    ...
    2.  In the **Use app on** field of the pop-up window, select the site that you specified the URL for in step [5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/search-administration/create-ext-cont-connector-acc.md), then select **Accept**.
