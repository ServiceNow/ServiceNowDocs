...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/search-administration/t\_RemoveAnIndex.html
release: zurich
...
3.  If the **Text index** option field is hidden, configure the form layout to show it.
    ...
    For details on showing and hiding fields on a form, see [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/configure-form-layout.md).
