...
breadcrumb: [Text search views control format of global search results for tables, Global search finds records from multiple tables, Zing text indexing and search engine, Search administration, Configure core features, Administer]
---
