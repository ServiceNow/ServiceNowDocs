...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/search-administration/ais-admin-console-setup-field-config-indexed-source.html
release: australia
