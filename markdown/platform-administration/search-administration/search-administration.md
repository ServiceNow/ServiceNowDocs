...
-   **[Service Portal search widgets](https://www.servicenow.com/docs/access?context=search-widgets&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)**

    Service Portal includes widgets for multiple forms of search.

-   **[Now Mobile app](https://www.servicenow.com/docs/access?context=now-mobile-app&version=zurich&pubname=zurich-mobile&ft:locale=en-US)**

    The Now® Mobile app provides global search, voice search, and photo search.

-   **[Mobile Agent](https://www.servicenow.com/docs/access?context=mobile-experience&version=zurich&pubname=zurich-mobile&ft:locale=en-US)**
...
-   **[Agent assist](https://www.servicenow.com/docs/access?context=agent-assist&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)**
