...
-   The base URL for your Workday tenant that you copied in step [14.a](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/configure-learning-assignment-report-workday.md).
-   The Workday tenant name that you copied in step [14.b](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/configure-learning-assignment-report-workday.md).
-   The custom Learning assignment report owner's user name that you copied in step [14.c](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/configure-learning-assignment-report-workday.md).
-   The custom Learning assignment report's name alias that you copied in step [14.d](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/configure-learning-assignment-report-workday.md).
