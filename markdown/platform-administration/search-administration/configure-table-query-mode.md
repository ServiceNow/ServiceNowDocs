...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/search-administration/configure-table-query-mode.html
release: zurich
...
<table id="choicetable_rjr_4mz_yy"><tbody><tr><td id="d115657e103">
