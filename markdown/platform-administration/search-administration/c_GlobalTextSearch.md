...
|Core UI|Select the search icon in the banner on the upper right of the [System settings for the user interface \(UI\)](https://www.servicenow.com/docs/access?context=r_UI16BannerFrame&version=australia&pubname=australia-platform-user-interface&ft:locale=en-US) , then enter your search terms and press Enter.|
