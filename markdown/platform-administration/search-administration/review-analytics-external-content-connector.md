...
3.  In the connector editor, select the Analytics tab.
    ...
    For details on the available analytics metrics, see [Analytics for external content connectors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/analytics-external-content-connectors.md).
