...
4.  Deselect the **Crawl user content** option or the **Crawl team content** option depending on what content type you want the connector to retrieve.
...
7.  Select one of the following **Files** options:
    ...
    For details on the supported file extensions, see [Binary file extensions supported in External Content Connectors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/file-extensions-ext-cont-connector.md).
