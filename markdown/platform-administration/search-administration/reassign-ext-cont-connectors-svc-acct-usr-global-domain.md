...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/search-administration/reassign-ext-cont-connectors-svc-acct-usr-global-domain.html
release: australia
...
3.  On the User form, configure the layout to show the **Managed domain**, **Domain**, and **Domain Path** fields.
    ...
    To learn how to show or hide fields on a form, see [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/configure-form-layout.md).
