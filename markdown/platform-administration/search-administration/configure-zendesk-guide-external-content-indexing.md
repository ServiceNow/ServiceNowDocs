...
-   The OAuth 2.0 client identifier that you entered in step [6](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/configure-zendesk-guide-external-content-indexing.md).
-   The client secret that you saved in step [8](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/configure-zendesk-guide-external-content-indexing.md).
...
For details on creating and configuring a Zendesk Guide external content connector, see [Create a Zendesk Guide external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/create-ext-cont-connector-zendesk-guide.md).
