...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/search-administration/installed-with-zing.html
release: yokohama
...
|-------------|-----------|
|TS Search Stats|Compiles type-ahead suggestions each night. See [Update A Type-Ahead Suggestion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/search-administration/t_UpdateATypeAheadSuggestion.md).|
...
-   **[Zing roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/search-administration/roles-zing.md)**  
