...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/search-administration/t\_DebugZing.html
release: yokohama
...
5.  Locate the stemmed terms and compare the numbers in the list to the debug output from step [3](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/search-administration/t_DebugZing.md).
...
**Parent Topic:**[Available search options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/search-administration/c_IntroductionToSearching.md)
