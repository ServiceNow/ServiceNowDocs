...
2.  In the **Home** page's **Track AI Search activity** pane, review the dashboard reports.

3.  To view the full AI Search dashboard, select the **Go to full dashboard** link.

    For details on this dashboard's reports, see [AI Search dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/ai-search-dashboard.md).


-   **[AI Search activity reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/ais-admin-console-activity-reports.md)**  
