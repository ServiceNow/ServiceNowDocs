...
</table>If your source system contains more than 1,000 maps, topics, or unstructured documents, these default limits prevent the Fluid Topics external content connector from indexing all of your source system content. The connector must retrieve all of your maps, topics, or unstructured documents in a single request.
