...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/search-administration/add-app-search-context-polaris-ui.html
release: yokohama
...
2.  Define a globalSearchDataConfigId UX page property to map the search application configuration record to the workspace's UX application:
    ...
    3.  On the UX Page Property form, fill in the fields as follows:
        ...
        |Type|Select **string**.|
        |Value|Enter the search application configuration record sys\_id that you copied in step [1.c](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/search-administration/add-app-search-context-polaris-ui.md).|
