...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/search-administration/configure-single-table-for-indexing.html
release: zurich
...
4.  If you intend to use the table in multi-table searches or if you want to use the BM25 scoring algorithm on the table, upgrade its indexing format to V4.
    ...
    1.  If the value in **Format** isn't grayed out, select **v4**, then select **Submit** and skip to step [5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/search-administration/configure-single-table-for-indexing.md).
...
5.  Configure indexing and search attributes on the selected table.
    ...
    3.  On the Text Index Table Attribute Maps form, fill in the fields.
        ...
        |Attribute name|Search engine attribute. For a list of the attributes and valid values, see [Zing index and search attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/search-administration/index-attributes.md).|
...
6.  Configure column-level attributes.
    ...
    3.  On the Text Index Column Attribute Map form, fill in the fields.
        ...
        |Attribute name|Attribute. For a list of the attributes and valid values, see [Zing index and search attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/search-administration/index-attributes.md).|
...
8.  Add a synonym dictionary.
    ...
    3.  In **Synonym dictionary**, select the synonym dictionary to use on the specified table.
        ...
        To add a dictionary, select **New** and follow the procedure in [Create synonym dictionaries](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/search-administration/create-synonym-dictionaries.md).
...
-   Workflow
 ...
 For more information on these types, see [Field types reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/r_FieldTypes.md).
...
Text indexing excludes fields configured for Edge Encryption. For more information on configuring fields with Edge Encryption, see [Encrypt fields using encryption configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/c_ConfigureCloudEdge.md).
