...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/search-administration/enable-search-suggestions.html
release: zurich
...
breadcrumb: [Zing displays search suggestions as users enter search terms, Zing text indexing and search engine, Search administration, Configure core features, Administer]
---
...
**Parent Topic:**[Zing displays search suggestions as users enter search terms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/search-administration/search-suggestions-zing.md)
