...
description: Modify the search results of your AI Search application by creating a copy of an existing Entity View Action Mapper \(EVAM\) view and then changing the copy. This process is efficient, especially when the changes are minimal.
locale: en-US
...
Modify the search results of your AI Search application by creating a copy of an existing Entity View Action Mapper \(EVAM\) view and then changing the copy. This process is efficient, especially when the changes are minimal.
...
If the view configuration is shared and you need to change the result-card interface without impacting other shared instances, create a copy of the view configuration. You can verify if the view configuration is shared. For more information, see [Track how your EVAM view configurations are used](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/ais-admin-console-evam-viewusage.md).
