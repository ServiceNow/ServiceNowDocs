...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/localization-workspace/lw-language-asset-management.html
release: australia
...
-   Any editing or modification to the contents of existing glossaries can be done in the UI. For details see [Edit a glossary in Language Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/localization-workspace/lw-lam-edit-glossary.md).
...
-   **[Export a glossary from Language Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/localization-workspace/lw-lam-export-glossary.md)**  
