...
**Note:** From version 2.0.2, the Localization Workspace interface provides two [Guided Setups](https://www.servicenow.com/docs/access?context=guided-setup&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US) to lead admins through the process of configuration, as follows.
