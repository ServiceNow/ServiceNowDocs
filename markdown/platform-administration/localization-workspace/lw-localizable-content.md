...
-   If you have created a custom artifact, be sure to set cross-scope privileges to ensure that a content type can be selected in Localization Workspace. For more information see [Cross-scope privileges for Localization Workspace](../task/lw-cross-scope-privilege.md).
...
You can also configure your own custom artifacts. For more information, see [Dynamic artifact detection in Localization Workspace](../concept/lw-dynamic-artifact-detection.md).
