...
3.  In the list view of Glossaries, select the check box of the glossary that you want to export.

    \[Omitted image "lw-lam-export-glossary1.png"\] Alt text: The Glossaries tab of Language Asset Management is open. The check box for an example glossary is selected, and the Export Glossary button is highlighted.

    **Tip:** You can select all available glossaries using the check box in the header row at **Glossary Name**.

4.  Select **Export Glossary** to open the Export modal window.

5.  Select either CSV or Excel at the drop-down **File Type** field.

    \[Omitted image "lw-lam-export-glossary2.png"\] Alt text: The Export modal window is open. The drop-down field for File Type displays CSV in this example. The Export button is highlighted.
