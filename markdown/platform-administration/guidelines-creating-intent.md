...
For more general guidelines, see [General guidelines for creating AI agents and agentic workflows](https://www.servicenow.com/docs/access?context=gg-creating-aia&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
...
**Parent Topic:**[Email Intent to Action Agentic Workflow](../concept/email-agentic-workflow.md)
