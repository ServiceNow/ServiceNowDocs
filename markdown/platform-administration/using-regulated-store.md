...
2.  Procure an application from an isolated federal or regional instance of the ServiceNow Store.
    ...
    -   To get an application that's available at no additional cost, log in to your federal or regional instance of the ServiceNow Store and use the same process that users of the commercial ServiceNow Store do. For more information, see [Get a free application](../task/store-get-free-app.md).
