---
title: Upgrade Management summary
description: Utilize the Upgrade Management store application to access all pertinent information and tools for your upgrade.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/upgrade-management/um-overview.html
release: yokohama
...
breadcrumb: [Exploring Upgrade Management, Upgrade Management, Upgrade, Administer the ServiceNow AI Platform]
---

# Upgrade Management summary

Utilize the Upgrade Management store application to access all pertinent information and tools for your upgrade.

\[Omitted image "um-summary.png"\] Alt text: Image showing the upgrade management summary page

You can achieve the following using Upgrade Management.
...
**Note:** By default, you are on the Overview tab when you first land in Upgrade Management.
