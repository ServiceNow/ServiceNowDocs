...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/upgrade-management/um-review-history.html
release: yokohama
...
-   [Upgrade History related lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-access-rl.md): Use the related lists to resolve, track and review the skipped records in an upgrade
-   [Visual task board \(VTB\) view of skipped records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-vtb-history.md): Use the VTB view to see the resolution status of any previous upgrade with skipped records

-   **[Review skipped records using related lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-access-rl.md)**  
Use different related lists to resolve, track and review the skipped records in an upgrade.
-   **[Revert a customization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-revert-customization.md)**  
...
-   **[Resolve a skipped update and set a resolution status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-resolve-skipped-update.md)**  
Review the reason for each skipped record to resolve each skipped update after an upgrade.
-   **[Skipped Records visual task board \(VTB\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-vtb-history.md)**  
...
-   **[View import history](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-import-history.md)**  
View your import history by accessing the **My Application Import History** module.
-   **[Quick access to plugins and history records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-quick-access1.md)**  
