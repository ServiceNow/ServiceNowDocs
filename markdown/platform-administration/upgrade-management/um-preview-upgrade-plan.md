...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/upgrade-management/um-preview-upgrade-plan.html
release: yokohama
...
breadcrumb: [Prepare to upgrade with Upgrade Plan, Upgrade Plans tool in Upgrade Management, Upgrade Management tools, Using Upgrade Management, Upgrade Management, Upgrade, Administer the ServiceNow AI Platform]
---
...
**Parent Topic:**[Prepare to upgrade with Upgrade Plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-prepare-upgrade-plan.md)
