...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/upgrade-management/um-vtb-history.html
release: yokohama
...
breadcrumb: [Reviewing upgrade history, Upgrade History tool in Upgrade Management, Upgrade Management tools, Using Upgrade Management, Upgrade Management, Upgrade, Administer the ServiceNow AI Platform]
---
...
-   **[Upgrade History Task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-history-task-form.md)**  
You can update information about a skipped record task using the Upgrade History Task form.
-   **[Previous Resolutions related list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-previous-resolutions-rl.md)**  
...
-   **[Update default labels in VTB view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-label-vtb.md)**  
...
**Parent Topic:**[Reviewing upgrade history](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-review-history.md)
