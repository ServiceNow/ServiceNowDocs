...
1.  Go to the Upgrade Monitor page to ensure that the selected upgrade plan is being implemented in your upgrade.
    ...
    See Upgrade Plan background operations section in [Upgrade Plans tool in Upgrade Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/upgrade-management/um-upgrade-plans-tool.md) for more information.
...
-   **[Review skipped records with upgrade plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/upgrade-management/um-review-skipped-records-upgrade-plan.md)**  
