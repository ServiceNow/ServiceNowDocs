...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/upgrade-management/um-upgrade-monitor-explore.html
release: brazil
...
**Note:** For detailed information about the upgrade process, see [Upgrade your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/release-notes/upgrades-overview.md).
...
3.  On the upgraded non-production instance, [Process the skipped records list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/upgrade-management/um-process-skipped-records.md).
...
For details on reconciling conflicts, see [Process the skipped records list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/upgrade-management/um-process-skipped-records.md).

See [Upgrade Monitor tool in Upgrade Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/upgrade-management/um-upgrade-monitor-tool.md) for more information.
