...
breadcrumb: [Explore Upgrade Monitor in Upgrade Console, Upgrade Console summary, Exploring Upgrade Console, Upgrade Console, Upgrade, Administer the ServiceNow AI Platform]
---
