...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/upgrade-management/um-view-loaded-files-plugin.html
release: yokohama
...
breadcrumb: [Upgrade Summary Report, Monitor an upgrade to an instance, Upgrade Monitor tool in Upgrade Management, Upgrade Management tools, Using Upgrade Management, Upgrade Management, Upgrade, Administer the ServiceNow AI Platform]
---
...
4.  Click one of the plugins from the list to open the **System Upgrade Metrics** form view of that plugin.
    ...
    The Plugin Files related list of all the loaded files for that plugin is displayed. \[Omitted image "uc-plugin-form-view.png"\] Alt text: Image showing the System Upgrade Metric form with the duration message and all loaded files

    **Note:** The total plugin load duration is not the sum of the load duration of all the loaded files for that plugin.


**Parent Topic:**[Upgrade Summary Report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-management/um-complete-summary.md)
