...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/upgrade-management/um-refreshing-upgrade-plan.html
release: zurich
...
2.  Go to the upgrade plan and refresh it by selecting **Refresh**.\[Omitted image "uc-plan-refresh.png"\] Alt text: Upgrade plan screen.
