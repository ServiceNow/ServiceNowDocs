...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/email-digest-properties.html
release: yokohama
topic_type: concept
...
The following properties are available for the [email digest feature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/email-digests.md).
...
-   **Default value**: 100
-   **Location**: System Property \[sys\_properties\] table
-   **Learn more**: For details on digest intervals, see [Create or modify email digest intervals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/create-digest-intervals.md).
