...
["Indicators with business calendars" in Create an automated indicator](https://www.servicenow.com/docs/access?context=t_CreateAnAutomatedIndicator&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)
