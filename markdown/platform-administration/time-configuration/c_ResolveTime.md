...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/time-configuration/c\_ResolveTime.html
release: yokohama
...
-   **[Display resolve time as a duration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/t_DisplayResolveTimeAsADuration.md)**  
You can display the resolve time as a human-readable duration rather than an integer representing a duration in seconds.

**Parent Topic:**[Task fields for measuring work time](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/c_TaskFieldsForMeasuringWorkTime.md)
