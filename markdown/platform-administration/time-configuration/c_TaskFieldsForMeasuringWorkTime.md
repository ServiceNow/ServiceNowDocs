...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/time-configuration/c\_TaskFieldsForMeasuringWorkTime.html
release: xanadu
...
breadcrumb: [Default date and time fields, Date and Date/Time fields, Exploring time configuration, Time configuration, Configure core features, Administer the ServiceNow AI Platform]
---
...
-   **[Time worked](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/time-configuration/c_TimeWorked.md)**  
The Task \[task\] table provides a time-tracking field called **Time worked**.
-   **[Resolve time](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/time-configuration/c_ResolveTime.md)**  
...
**Parent Topic:**[Default date and time fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/time-configuration/c_DefaultDateAndTimeFields.md)
