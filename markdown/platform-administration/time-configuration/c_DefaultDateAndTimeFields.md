...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/time-configuration/c\_DefaultDateAndTimeFields.html
release: xanadu
...
-   **[Task fields for measuring work time](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/time-configuration/c_TaskFieldsForMeasuringWorkTime.md)**  
Use default task fields to measure progress and resolution for certain records.

**Parent Topic:**[Date and Date/Time fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/time-configuration/r_UseDateAndTimeFields.md)
