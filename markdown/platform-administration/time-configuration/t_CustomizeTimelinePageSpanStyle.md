...
4.  Fill in the form and click **Submit**.
    ...
    |Field|Description|
    |-----|-----------|
    |Condition|[Condition Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_ConditionBuilder.md) that filters the results that appear in the timeline.|
