...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/time-configuration/t\_CustomizeTimelinePageSpanStyle.html
release: xanadu
...
4.  Fill in the form and click **Submit**.
    ...
    |Field|Description|
    |-----|-----------|
    |Condition|[Condition Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/c_ConditionBuilder.md) that filters the results that appear in the timeline.|
