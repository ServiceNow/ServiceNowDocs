...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/time-configuration/define-business-calendar-entries.html
release: xanadu
...
**Note:** To learn how to create business calendar entry names, see [Create business calendar entry names](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/time-configuration/define-business-calendar-entries.md).
...
1.  Select \[Omitted image "SearchIcon.png"\] Alt text: Search button or
...
**Note:** If you attempt to use the \[Omitted image "SearchIcon.png"\] Alt text: Search button and see a dialog box with **Cancel** and **Leave** options, select **Cancel** and then select inside the **Calendar** field to select from a listing of recent business calendars.
