...
1.  Select ![Search button](../../search-administration/image/SearchIcon.png) or
...
**Note:** If you attempt to use the ![Search button](../../search-administration/image/SearchIcon.png) and see a dialog box with **Cancel** and **Leave** options, select **Cancel** and then select inside the **Calendar** field to select from a listing of recent business calendars.
