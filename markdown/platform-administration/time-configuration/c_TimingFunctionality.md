...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/time-configuration/c\_TimingFunctionality.html
release: zurich
...
[Time worked fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/time-configuration/c_TimingFunctionality.md)

[Time configuration SLAs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/time-configuration/c_TimingFunctionality.md)

[Metric definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/time-configuration/c_TimingFunctionality.md)
...
See [Metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/c_MetricDefinitionSupport.md) for more information.
...
Any table that extends Task can use this field. To add the field, [Personalize a form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/t_PersonalizeAForm.md).

As the record is viewed, the timer counts upward. To pause the timer, select the **Stop icon** \(\[Omitted image "TimerStop.png"\] Alt text: Stop icon\).

To resume the timer, select the **Start icon** \(\[Omitted image "TimerStart.png"\] Alt text: Start icon\).
