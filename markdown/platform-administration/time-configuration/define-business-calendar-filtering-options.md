...
To learn more about standard filtering options, see [Values for date/time fields](https://www.servicenow.com/docs/access?context=c_ValuesForDateTimeFields&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
