...
To learn more about standard filtering options, see [Values for date/time fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_ValuesForDateTimeFields.md).
