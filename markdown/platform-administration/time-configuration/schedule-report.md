...
A user with the report\_scheduler role can also create a scheduled report through a different navigation path. For more information, see [Schedule emails of reports](https://www.servicenow.com/docs/access?context=t_ScheduleAReport&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
