...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/time-configuration/business-calendars.html
release: yokohama
...
-   **Business calendar definition record**
    ...
    To learn more about creating a business calendar definition, see [Create a business calendar](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/create-business-calendar.md).
...
-   **Business calendar filter options**
    ...
    To learn more about creating filtering options for a business calendar, see [Create a business calendar](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/create-business-calendar.md).
...
-   **Calendars for package**
    ...
    To learn more about associating a business calendar with a package, see [Pair business calendars with packages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/pair-business-calendars-with-packages.md).
...
**Note:** For Strategic Portfolio Management \(SPM\) applications, you must define Fiscal Calendars using the [Generate a fiscal calendar](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/t_GenerateFiscalCalendar.md) feature.
...
-   **[Create a business calendar](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/create-business-calendar.md)**  
...
-   **[Create a business calendar group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/create-business-calendar-group.md)**  
...
-   **[Create a business calendar span using a Script includes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/create-a-business-calendar-span-using-a-script-includes.md)**  
...
-   **[Define business calendar entries](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/define-business-calendar-entries.md)**  
...
-   **[Define business calendar filtering options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/define-business-calendar-filtering-options.md)**  
...
-   **[Pair business calendars with packages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/pair-business-calendars-with-packages.md)**  
...
[Using schedules and calendars](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/r_CreateCalendarsWithSchedulePages.md)
