...
3.  Right-click the header bar and select **Save**.
    ...
    **Note:**
    ...
    -   In the Related link, select **Show Schedule** to view the schedule in the calendar using the Next Experience user interface. For more information on this framework, see [Next Experience UI](https://www.servicenow.com/docs/access?context=next-experience-landing-page&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US). To create schedule entries in the [Next Experience UI](https://www.servicenow.com/docs/access?context=next-experience-landing-page&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US), refer to [Create schedule entries in the Schedule calendar](create-events-next-experience-ui.md).
