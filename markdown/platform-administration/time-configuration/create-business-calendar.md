...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/time-configuration/create-business-calendar.html
release: xanadu
...
Parent business calendar to the current business calendar that you’re creating. To search for an existing business calendar, select \[Omitted image "SearchIcon.png"\] Alt text: Search button.
...
7.  In the Business Calendar Filter Options related list, select **New** to create filtering options for the business calendar.
    ...
    **Note:** To learn more about creating business calendar filtering options, see [Define business calendar filtering options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/time-configuration/define-business-calendar-filtering-options.md).
