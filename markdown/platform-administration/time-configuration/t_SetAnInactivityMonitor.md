...
5.  Specify any additional conditions in the **Condition** field.
    ...
    -   If you are using incident auto-close, add a Reset condition because, if you don't, auto-close won't work properly. To prevent this reset, set a **Reset Condition** on your inactivity monitor. To learn more about Incident auto-close, see [Configure incidents to close automatically](https://www.servicenow.com/docs/access?context=configure-incident-auto-close&version=australia&pubname=australia-it-service-management&ft:locale=en-US).
