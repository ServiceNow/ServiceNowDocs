...
**Note:** To use the classic schedule calendar, see [Define a schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/time-configuration/t_DefineASchedule.md).
