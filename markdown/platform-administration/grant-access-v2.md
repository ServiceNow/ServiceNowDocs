...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/grant-access-v2.html
release: yokohama
topic_type: concept
...
-   **Managing instances**
    ...
    See [Configure Manager Instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/mif-conf-manager-instance.md) for more information.
