...
-   [Translate a client script message](../task/t_TranslateAClientScriptMessage.md)
-   [Internationalize a widget](https://www.servicenow.com/docs/access?context=c_WidgetLocalization&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US) in Service Portal documentation
