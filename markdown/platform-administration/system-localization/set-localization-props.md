...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/system-localization/set-localization-props.html
release: yokohama
...
-   Default value: No
-   Learn more: [Sorting according to the session language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/system-localization/sorting-session-language.md)
...
-   Dependency: The I18N: Internationalization plugin must be active
-   Learn more: [Zing matches derived words with stemming](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/search-administration/stemming-matches-derived-words.md)
...
-   Default value: No
-   Learn more: [Debug translations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/system-localization/t_DisplayATranslationPrefix.md)
...
-   Default value: No
-   Learn more: [Currency administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/currency-administration/currency.md)
...
-   Default value: None
-   Learn more: [Locale settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/currency-administration/locales.md)
...
Option to allow setting fallback languages for the instance. Setting fallback languages creates a three-level hierarchy in which an intermediate language is used before defaulting to English when user interface text is not translated in the user's preferred language.
 ...
 -   Type: true \| false
-   Default value: true
-   Learn more: [Set a fallback language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/system-localization/set-fallback-language.md)

</td></tr></tbody>
</table>**Parent Topic:**[System Localization reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/system-localization/system-localization-reference.md)
