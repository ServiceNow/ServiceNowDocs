...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/system-localization/configuring-system-localization.html
release: brazil
...
1.  [Set the instance locale](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-localization/c_DefineLocales.md)
...
2.  [Activate a language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-localization/t_ActivateALanguage.md)
...
3.  [Set the default language for an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-localization/r_GlobalLanguage.md)

    Select a default language for an instance if it should be a language other than American English.

4.  [Set a fallback language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-localization/set-fallback-language.md)
...
5.  [Set up locations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-localization/t_LocationSetup.md)

    Configure the locations that your organization supports to help identify users, assets, incidents, and more by location.

6.  [Create regions for language selection in portals](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-localization/create-regions.md)

    Map languages to regions to organize the language selector for guest users.

7.  [Ensure that translated choices appear for applications added by plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-localization/activate-translated-choices-plugins.md)
