...
For more information about the language selector in portal headers, see [Enable a language selector in portal headers](https://www.servicenow.com/docs/access?context=configure-header-menu&version=xanadu&pubname=xanadu-platform-user-interface&section=enable-lang-selector-widget&ft:locale=en-US).
