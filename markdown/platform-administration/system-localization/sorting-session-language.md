...
This column attribute can't be set to true with locale text match. For more information see [Set case and accent sensitivity on a per-column basis](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/system-localization/sl-locale-text-match.md).
