...
3.  Provide the language information.
    ...
    -   **Fallback**: The name of another active language to use as a fallback language. For more information about fallback languages, see [Set a fallback language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-localization/set-fallback-language.md).
4.  Select **Submit**.
