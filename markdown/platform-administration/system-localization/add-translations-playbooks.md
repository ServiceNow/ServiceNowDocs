...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/system-localization/add-translations-playbooks.html
release: yokohama
...
-   To learn more about translating custom content in general, see [Translating custom content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/system-localization/translating-applications.md).

## About this task

UI Message records are used to translate the text in your playbooks to different languages at runtime, similar to the way system messages are translated on the platform. To learn more about the Message table \[sys\_ui\_message\] in general, see [Message table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/system-localization/r_MessageTable.md).
...
10. Repeat steps 1-8 to add more translations.
    ...
    \[Omitted image "image.insert-playbook-translation"\] Alt text: Adding a Spanish translation for the piece of text "Instructional"
...
\[Omitted image "image.playbook-translation-runtime"\] Alt text:
