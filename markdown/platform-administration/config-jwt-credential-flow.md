...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/config-jwt-credential-flow.html
release: xanadu
topic_type: task
...
Create a JWT signing key to assign to your JKS certificate. For more information, see [Configure a JWT signing key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/authentication/JWT-Bearer-token-support.md).
...
[Generate SHA-1 thumbprint](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/generate-sha-1-thumbprint.md)
