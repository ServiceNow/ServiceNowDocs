...
Create a JWT signing key to assign to your JKS certificate. For more information, see [Configure a JWT signing key](https://www.servicenow.com/docs/access?context=JWT-Bearer-token-support&version=australia&pubname=australia-platform-security&section=configure-JWT-signing-key&ft:locale=en-US).
