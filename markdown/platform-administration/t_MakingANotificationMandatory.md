...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_MakingANotificationMandatory.html
release: yokohama
topic_type: task
...
3.  Configure the form and add the **Mandatory** field.
    ...
    **Note:** This field does not display by default.
    ...
    3.  Select **Save**.
        ...
        For more information about configuring the form layout, see [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/configure-form-layout.md).
...
**Parent Topic:**[Subscription-based notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/c_SubscriptionBasedNotifications.md)
