...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/share-subscription-data.html
release: australia
topic_type: task
...
For more information about modifying the trust configuration for an instance, see [Basic trust configuration for data sync applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/grant-access-other-instances.md).
