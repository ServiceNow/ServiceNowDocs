...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/share-subscription-data.html
release: xanadu
topic_type: task
...
For more information about modifying the trust configuration for an instance, see [Configure data synchronization for applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/admin-center/grant-access-other-instances.md).
