...
For more information about modifying the trust configuration for an instance, see [Configure data synchronization for applications](../../core-configuration/concept/grant-access-other-instances.md).
