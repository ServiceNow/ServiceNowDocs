...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/share-subscription-data.html
release: yokohama
topic_type: task
...
For more information about modifying the trust configuration for an instance, see [Basic trust configuration for data sync applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/grant-access-other-instances.md).
...
**Parent Topic:**[Configuring Subscription Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/configuring-subscription-management-v2.md)
