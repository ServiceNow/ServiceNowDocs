...
-   Access data usage and rule details by selecting a table in the list. See [Viewing data usage by table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/data-management-table-data.md).
