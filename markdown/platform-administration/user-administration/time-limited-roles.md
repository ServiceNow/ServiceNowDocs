...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/user-administration/time-limited-roles.html
release: yokohama
...
-   For a user, you can assign only `admin`, `snc_read_only`, and \(or\) `impersonator` role as time-limited role.
...
**Parent Topic:**[Time-limited role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/user-administration/time-limited-role-overview.md)
