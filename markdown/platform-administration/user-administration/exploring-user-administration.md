...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/user-administration/exploring-user-administration.html
release: xanadu
...
1.  [Subscription Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/subscription-management-landing-page-v2.md)
    ...
    Subscriptions may include per-user subscriptions. For more information, see [Managing per-user subscriptions in Subscription Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/managing-user-subscriptions-v2.md).

2.  [Creating users, companies, and departments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/user-administration/using-user-administration.md)
...
3.  [Creating groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/user-administration/ua-creating-groups.md)
...
4.  [Managing roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/user-administration/ua-creating-roles.md)
    ...
    For a complete list of the roles included with the ServiceNow AI Platform, see [Base system roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/user-administration/r_BaseSystemRoles.md).

    Role records are stored in the Roles \[sys\_user\_role\] table.

5.  [Monitoring instance usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/platform-performance/usage-analytics-module-subscription.md)
...
6.  [Monitoring user activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/user-administration/user-admin-tools-landing.md)
...
For a complete list of the roles included with the ServiceNow platform, see [Base system roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/user-administration/r_BaseSystemRoles.md).
