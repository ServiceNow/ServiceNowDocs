...
For more information on LDAP integrations, see [Lightweight Directory Access Protocol integration](https://www.servicenow.com/docs/access?context=c_LDAPIntegration&version=australia&pubname=australia-platform-security&ft:locale=en-US).
