...
For more information on LDAP integrations, see [LDAP integration](https://www.servicenow.com/docs/access?context=c_LDAPIntegration&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
