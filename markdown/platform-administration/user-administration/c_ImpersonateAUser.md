...
Mobile impersonation is available on ServiceNow mobile apps. For information on mobile impersonations, see [Mobile impersonation](https://www.servicenow.com/docs/access?context=mobile-impersonation&version=xanadu&pubname=xanadu-mobile&ft:locale=en-US).
