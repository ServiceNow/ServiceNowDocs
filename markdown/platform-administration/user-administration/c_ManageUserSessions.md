...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/user-administration/c\_ManageUserSessions.html
release: zurich
...
[Configure a maximum active time for integration sessions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/managing-integration-sessions.md)
...
-   **glide.security.auto.resubmit.ajax**: Automatically resubmits timed-out Ajax requests when set to **true** and the [Log in to an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/t_LoggingIn.md) check box is selected or [Change the default value of the Remember me check box](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/c_ChSetRemMeChkbxCookie.md). A pop-up appears to users asking them to continue.
...
[Modify integration session timeout after inactivity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/managing-integration-sessions.md)
