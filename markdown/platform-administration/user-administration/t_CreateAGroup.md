...
3.  On the form, fill in the fields.
    ...
    Some fields appear after personalizing the form. [Personalize a form](https://www.servicenow.com/docs/access?context=t_PersonalizeAForm&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
...
Helpful information about the group.
    ...
    2.  Create a new before query business rule on the \[sys\_user\_group\] \(Group\) table with the following script:
        ...
        **Note:** For more information, see [Before Query business rules](https://www.servicenow.com/docs/access?context=bp-before-query-business-rules&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
