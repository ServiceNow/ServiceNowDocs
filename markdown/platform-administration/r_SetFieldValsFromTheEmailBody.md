...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/r\_SetFieldValsFromTheEmailBody.html
release: australia
...
See [Redirecting Emails](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/r_RedirEmailDifferentAssignGrp.md) for an example of using **setDisplayValue\(\)** in an inbound email action.
...
**Parent Topic:**[Configure inbound email actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/configure-inbound-email.md)
