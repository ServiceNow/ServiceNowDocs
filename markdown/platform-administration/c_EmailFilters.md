...
To learn more about enabling spam scoring and filtering, see [Email spam scoring and filtering \(instance security hardening\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/sc-email-spam-scoring-and-filtering.md) in Instance Security Hardening Settings.
...
-   **[Create an email filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_CreateAnEmailFilter.md)**  
...
**Parent Topic:**[Creating an email account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/using-email-admin.md)
