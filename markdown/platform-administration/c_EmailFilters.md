...
To learn more about enabling spam scoring and filtering, see [Email spam scoring and filtering \(instance security hardening\)](https://www.servicenow.com/docs/access?context=sc-email-spam-scoring-and-filtering&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) in Instance Security Hardening Settings.
