...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/c\_EmailFilters.html
release: zurich
topic_type: concept
...
To learn more about enabling spam scoring and filtering, see [Email spam scoring and filtering \(instance security hardening\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/sc-email-spam-scoring-and-filtering.md) in Instance Security Hardening Settings.
...
-   **[Create an email filter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_CreateAnEmailFilter.md)**  
...
**Parent Topic:**[Creating an email account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/using-email-admin.md)
