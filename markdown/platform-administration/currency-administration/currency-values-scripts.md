...
**Note:** To learn how to change the number of decimal places used by the system, see [Change default currency decimal places](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/currency-administration/change-currency-fraction-digits.md).
...
</table>**Parent Topic:**[Standard currency fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/currency-administration/configure-and-use-default-currency-fields.md)
