...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/currency-administration/fx-currency-conv-rate-table-date-source.html
release: brazil
...
2.  In the **Conversion Rate Table** field, select the rate table used for conversions of currency values in the FX Currency field:
    ...
    -   To use the default system rate table you defined in the **glide.currency2.system\_rate\_table** property in **System Localization** &gt; **All Properties.**, select **System Currency Conversion Rate**. This table stores daily reference rates retrieved from the European Central Bank.
        ...
        To learn more about the system rate table, see [Default currency conversions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/currency-administration/currency-conversions.md).

    -   If you have defined a custom rate table, you can select it to use in currency conversions for the FX Currency field. To learn more about how to define custom rate tables, see [Add conversion rates using a custom rate table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/currency-administration/custom-rate-table.md).
...
[Add conversion rates using a custom rate table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/currency-administration/custom-rate-table.md)
