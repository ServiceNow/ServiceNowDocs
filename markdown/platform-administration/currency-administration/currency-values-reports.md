...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/currency-administration/currency-values-reports.html
release: yokohama
...
The user determines how the report is run.
