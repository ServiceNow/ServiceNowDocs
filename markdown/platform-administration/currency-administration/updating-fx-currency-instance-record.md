...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/currency-administration/updating-fx-currency-instance-record.html
release: yokohama
...
<table id="choicetable_wfb_pcw_5jb"><thead><tr><th align="left" id="d65185e73">

Access method

</th><th align="left" id="d65185e76">

Description

</th></tr></thead><tbody><tr><td id="d65185e82">
 ...
 **Note:** To learn more about reference currencies, see [Set the reference currency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/currency-administration/fx-currency-set-reference.md).
