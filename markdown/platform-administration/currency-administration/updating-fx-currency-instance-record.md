...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/currency-administration/updating-fx-currency-instance-record.html
release: zurich
...
<table id="choicetable_wfb_pcw_5jb"><thead><tr><th align="left" id="d67150e50">

Access method

</th><th align="left" id="d67150e53">

Description

</th></tr></thead><tbody><tr><td id="d67150e59">
 ...
 **Note:** To learn more about reference currencies, see [Set the reference currency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/currency-administration/fx-currency-set-reference.md).
