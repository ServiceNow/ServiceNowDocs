---
title: Updating the Currency Instance record
description: If you have an assigned role of currency\_instance\_admin, you can review and edit the details of a currency entry in an FX Currency field. You can't edit the reference currency and value because they are calculated automatically.
locale: en-US
release: xanadu
...
If you have an assigned role of currency\_instance\_admin, you can review and edit the details of a currency entry in an FX Currency field. You can't edit the reference currency and value because they are calculated automatically.

## Before you begin

Role required: admin, currency\_instance\_admin, with ACL access to the FX Currency field.

## Procedure

1.  Access the Currency Instance record using one of the following methods.

<table id="choicetable_wfb_pcw_5jb"><thead><tr><th align="left" id="d55237e47">

Access method

</th><th align="left" id="d55237e50">

Description

</th></tr></thead><tbody><tr><td id="d55237e56">

**Direct access from an FX Currency field**

</td><td>

Click the edit icon \(![Edit icon](../images/currency-edit.png)\) that appears next to the FX Currency field in a transaction record.

</td></tr><tr><td id="d55237e71">

**From the navigator bar**

</td><td>

1.  Navigate to **System Localization** &gt; **FX Currency Configuration.**
2.  Click the Currency Instance record to edit.
