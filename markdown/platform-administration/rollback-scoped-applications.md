...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/rollback-scoped-applications.html
release: zurich
topic_type: task
...
-   The selected application must have been installed in the application repository or the application store. See [Install a ServiceNow Store application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_InstallApplications.md).
...
[Uninstall an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_UninstallApplications.md)
