...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/rollback-scoped-applications.html
release: yokohama
topic_type: task
...
-   The selected application must have been installed in the application repository or the application store. See [Install a ServiceNow Store application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_InstallApplications.md).
...
**Parent Topic:**[Rolling back and removing applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/c_RemovingApplications.md)

**Related topics**  


[Uninstall an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_UninstallApplications.md)
