...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_UsingImageFields.html
release: yokohama
topic_type: task
...
2.  Create a new field with the **Type** set to **Image**.
    ...
    For instructions, see [Add and customize a field in a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_CreatingNewFields.md).
