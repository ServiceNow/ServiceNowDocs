...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/monitoring-now-assist-usage.html
release: xanadu
topic_type: concept
...
**Note:** Now Assist usage data is refreshed daily in Subscription Management. The data reflects a 24-hour delay.
...
-   Compare the total number of Now Assist entitlements that your company has purchased to the total number of Now Assist entitlements consumed across all your instances. Monitor the remaining number of available number of Now Assist entitlements for your account.
-   Visualize Now Assist consumption over time by selecting **View details** in the Total used assists card. Monitor compliance for your account over the last 365 days or determine when Now Assist usage exceeded the total purchased count.
