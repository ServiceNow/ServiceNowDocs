...
If you notice issues with form response times, see [Improving response times on forms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/platform-performance/improving-response-time-forms.md).
...
For more information, see [Client transaction timings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/time-configuration/r_ClientTransactionTimings.md).
