...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/platform-performance/create-transaction-call-chain-register.html
release: yokohama
...
<table id="choicetable_nc2_kmn_f4b"><thead><tr><th align="left" id="d122917e54">

Type of Log

</th><th align="left" id="d122917e57">

Steps

</th></tr></thead><tbody><tr><td id="d122917e63">
...
4.  In the Slow Transactions form, click **Open Record**, then select **Record call chain of next occurrence**.
    ...
    For a description of the field values, see [Transaction call chain register form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/platform-performance/transaction-call-chain-reg-form.md).
