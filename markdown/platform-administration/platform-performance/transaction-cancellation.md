...
Selecting **Cancel** stops only the transaction associated with the window or tab where the alert appears. It doesn't cancel transactions running in your other open windows or tabs.
...
-   **[View and kill active transaction](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/platform-performance/t_ViewAndKillAnActiveTransaction.md)**  
Administrators can view active transactions and kill long-running transactions.
-   **[Canceled-transaction logging to a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/platform-performance/c_CanTranLogTbl.md)**  
