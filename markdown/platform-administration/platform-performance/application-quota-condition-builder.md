...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/platform-performance/application-quota-condition-builder.html
release: xanadu
 ...
 **Note:** Match the transaction quota **Type** to the transaction type listed in the Quota Manager [log entry for the transaction](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/platform-performance/t_EnableDebuggingInformation.md).
