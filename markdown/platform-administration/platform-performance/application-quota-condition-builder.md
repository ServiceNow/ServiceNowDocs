...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/platform-performance/application-quota-condition-builder.html
release: yokohama
 ...
 **Note:** Match the transaction quota **Type** to the transaction type listed in the Quota Manager [log entry for the transaction](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/platform-performance/t_EnableDebuggingInformation.md).
