...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/platform-performance/t\_UseASlowQueryLog.html
release: australia
...
2.  Open a query record for more details.
    ...
    For a description of the field values in the query record, see [Query record form fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/query-record-fields.md).
...
4.  To generate an index suggestion for a slow query, click **Index Suggestion**.
    ...
    For details, see [Generate an index suggestion for a slow query](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/generate-index-suggestion.md).
