...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/platform-performance/export-index-suggestion.html
release: xanadu
...
6.  To continue the index evaluation process on your non-production instance, you can [schedule the index suggestion for creation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/platform-performance/create-index-slowquery.md) and [test index performance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/platform-performance/test-index-performance.md).
