...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/platform-performance/r\_AppQuotaProperty.html
release: xanadu
...
Indicates the application quota update period in seconds. If this value is less than the glide.quota.manager.heartbeat property, the glide.quota.manager.heartbeat value is used. Type: Number
 ...
 Location: [Add to the System Properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/r_AvailableSystemProperties.md) `[sys_properties]` table
