...
1.  If [High Security Settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/c_HighSecuritySettings.md) are enabled, elevate privileges to security\_admin.
