...
1.  If [High Security Settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/c_HighSecuritySettings.md) are enabled, elevate privileges to security\_admin.
