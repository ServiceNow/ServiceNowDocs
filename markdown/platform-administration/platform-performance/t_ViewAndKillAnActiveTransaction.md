...
1.  If [High Security Settings](https://www.servicenow.com/docs/access?context=c_HighSecuritySettings&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) are enabled, elevate privileges to security\_admin.
