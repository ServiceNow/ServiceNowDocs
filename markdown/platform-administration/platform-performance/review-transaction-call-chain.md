...
2.  To view call chain detail, select the **Created** field for the desired call chain component or script.
    ...
    **Note:** You can view transaction log detail by selecting the **Transaction Log** field for the selected call chain component or script. To learn more, see [Transaction logs](https://www.servicenow.com/docs/access?context=r_TransactionLogs&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
