...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/platform-performance/resolving-slow-queries.html
release: australia
...
1.  [Use the slow query log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/t_UseASlowQueryLog.md) to identify slow queries that might benefit from improved indexing.
2.  [Generate an index suggestion for a slow query](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/generate-index-suggestion.md) using the ISE.
3.  [Review the index suggestion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/review-index-suggestions.md) and decide whether to move forward.
4.  [Export a query suggestion from a production instance to a non-production instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/export-index-suggestion.md) for evaluation before adding the index in your production instance.
5.  [Create an index from the suggestion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/create-index-slowquery.md) or schedule index creation once you're satisfied with the effects of the index suggestion.
6.  [Test index performance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/test-index-performance.md) to evaluate query speed improvement.
7.  If an index isn't needed anymore, [drop the index or schedule it to be dropped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/drop-index-slowquery.md). If an index isn't being used or isn't performing well, the ISE might display a suggestion to drop an index.

## Additional info

For more information about how the ISE generates index suggestions, see [Index suggestions for slow queries](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/index-suggestions.md).

-   **[Index suggestions for slow queries](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/index-suggestions.md)**  
...
-   **[Use a slow query log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/t_UseASlowQueryLog.md)**  
...
-   **[Generate an index suggestion for a slow query](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/generate-index-suggestion.md)**  
...
-   **[Review index suggestions for slow queries](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/review-index-suggestions.md)**  
...
-   **[Export a slow-query index suggestion to a non-production instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/export-index-suggestion.md)**  
...
-   **[Schedule a slow-query index suggestion for creation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/create-index-slowquery.md)**  
Use the Index Suggestion Engine \(ISE\) to schedule an index suggestion for creation.
-   **[Test index performance for slow queries](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/test-index-performance.md)**  
...
-   **[Drop a slow query index](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/platform-performance/drop-index-slowquery.md)**  
