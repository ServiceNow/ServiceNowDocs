...
1.  On the ServiceNow Store listing details for the app or integration, select **Request 30-day trial**.
    ...
    To contact a seller about a trial request, see [Contact a seller](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contact-seller.md).
...
You can track the trial expiration date through the **Store Applications** section of the My Store Activity page. For more information, see [Tracking your ServiceNow Store activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/tracking-store-activity.md).
