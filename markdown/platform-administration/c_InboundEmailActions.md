...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/c\_InboundEmailActions.html
release: zurich
topic_type: concept
...
\[Omitted image "inbound-action-type-old.png"\] Alt text: Flowchart showing how the system determines the type of incoming email as forward, reply, or new
...
See the [System email log and mailboxes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/r_EmailLogs.md) for examples of what you might see if a notification or inbound email action is not processed.
