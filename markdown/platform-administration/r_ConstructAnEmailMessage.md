...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/r\_ConstructAnEmailMessage.html
release: zurich
...
\[Omitted image "email-template-change-approval.png"\] Alt text: The change.itil.approve.role template specifies the HTML message content in the approval request email
...
\[Omitted image "email-template-mailto-approval.png"\] Alt text: The mailto.approval template defines the approval notification link
...
-   **[Add blank lines in an email template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/r_AddBlankLinesInAnEmailTemplate.md)**  
...
[Email layouts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/email-layouts.md)
