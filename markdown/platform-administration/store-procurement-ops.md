...
breadcrumb: [Listing details, Explore, ServiceNow Store, Administering applications, Get started, Administer the ServiceNow AI Platform]
---

# ServiceNow Store procurement options

Available procurement options on ServiceNow Store application listing details pages.

<table id="table_e2m_q5j_hgc"><thead><tr><th>
...
If an application has custom terms and conditions, review and accept them as part of procurement. Both paid applications and applications that are available at no additional cost might have custom terms and conditions.
