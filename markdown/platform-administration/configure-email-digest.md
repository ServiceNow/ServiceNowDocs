...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/configure-email-digest.html
release: zurich
topic_type: task
...
When you [create or update a notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_CreateANotification.md), use the **What Digest will contain** tab of the Notification form to configure the email digest for the notification. After you define the digest content, the digest option for the notification is available in the notification settings of your users.
...
<table id="choicetable_jb2_kxp_1fc"><thead><tr><th align="left" id="d259058e165">

Digest Type

</th><th align="left" id="d259058e168">

Description

</th></tr></thead><tbody><tr><td id="d259058e174">
