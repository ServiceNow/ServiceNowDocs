...
-   To archive Configuration Management Database \(CMDB\) CI records, use the CMDB Data Manager. See [Working with CMDB Data Manager](https://www.servicenow.com/docs/access?context=cmdb-data-management&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US).
...
-   Creates a form for the archive table using the default form view. The form excludes any [dot-walking](https://www.servicenow.com/docs/access?context=c_DotWalking&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US) fields such as **Caller ID.Email**.
