...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/maintain-mappings-renewal.html
release: xanadu
topic_type: task
...
2.  After the renewal date, map the documented tables and applications to the renewed subscription in Subscription Management.
    ...
    See [Map a custom application to a product subscription in Subscription Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/map-custom-applications-v2.md) and [Map custom tables to a product subscription in Subscription Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/allocate-custom-table-subsc-app-v2.md).
