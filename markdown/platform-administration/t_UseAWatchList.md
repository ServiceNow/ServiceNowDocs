...
1.  Navigate to a record that you want to add watchers to.
    ...
    **Note:** Not all records have watch lists. If you’re unable to see a watch list, you may need to [adjust your form view](https://www.servicenow.com/docs/access?context=view-management-overview&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US) or ask your administrator to update the form to add a watch list.
...
**Parent Topic:**[Add and customize a field in a table](../../../administer/field-administration/task/t_CreatingNewFields.md)
