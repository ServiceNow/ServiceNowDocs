...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_DefineVideoTypesForHTMLFields.html
release: yokohama
topic_type: task
...
**Note:** By default, the HTML Sanitizer removes videos from HTML fields. To allow video file types, see [Embed videos in the HTML editor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_EmbeddingVideoInHTMLFields.md)
