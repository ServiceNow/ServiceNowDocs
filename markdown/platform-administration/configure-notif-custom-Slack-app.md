...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/configure-notif-custom-Slack-app.html
release: zurich
topic_type: task
...
-   [Request Integration Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/request-ih-overview.md)
...
4.  On the JSON Configuration window, paste the JSON that you created in Step [1](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/configure-notif-custom-Slack-app.md).
...
-   Create notifications for your custom Slack app by following the steps in [Create a messaging notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/create-messaging-notification.md) and [Configure message content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/configure-message-content.md).
