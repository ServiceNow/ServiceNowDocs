...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_UpgradeSCCMIntegrationVersion.html
release: yokohama
topic_type: task
...
-   Perform a [full import](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/how-sccm-integration-works.md) to clear the cmdb\_software\_instance table, the cmdb\_sam\_sw\_install table, and other tables of old SCCM data.
...
2.  Clear the **Active** check box.
    ...
    \[Omitted image "SCCMScheduledDataImport.png"\] Alt text: Scheduled Import form
