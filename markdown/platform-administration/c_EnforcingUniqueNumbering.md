...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/c\_EnforcingUniqueNumbering.html
release: zurich
topic_type: concept
...
-   Enable a unique index on the table. For more information, see [Create a table index](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/table-administration-and-data-management/t_CreateCustomIndex.md).
