...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/schedule-execute-job-update-records.html
release: yokohama
topic_type: task
...
<table id="choicetable_vjl_krf_vtb"><thead><tr><th align="left" id="d248193e88">

Option

</th><th align="left" id="d248193e91">

Description

</th></tr></thead><tbody><tr><td id="d248193e97">
...
The records are scheduled for update or updated immediately. If you want to revert the updates to the records, see [Rollback an update job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/rollback-update-job.md).

**Parent Topic:**[Updating records safely](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/updating-records-safely.md)
