...
-   **[Inbound email actions](c_InboundEmailActions.md)**  
Define an inbound email action to script how the system responds to an inbound email.
-   **[Inbound email action processing](inbound-action-processing.md)**  
...
-   **[Criteria for matching email to inbound actions](inbound-action-type-criteria.md)**  
