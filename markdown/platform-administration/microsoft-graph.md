...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/microsoft-graph.html
release: australia
topic_type: task
...
[Create an email account for Microsoft Graph \(receive\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/create-email-account-ms-graph.md) using the OAuth profile.
