...
For additional details, see [Email API](https://www.servicenow.com/docs/access?context=email-api&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) .
