...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/grant-access-to-email-api.html
release: zurich
topic_type: task
...
For additional details, see [Email API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/email-api.md) .
