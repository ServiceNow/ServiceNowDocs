...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/read-send-emails-ms-graph.html
release: australia
topic_type: concept
...
-   **[Activate Email - Support for Email Processing by Microsoft Graph API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ms-graph-plugin.md)**  
...
-   **[Reading email using Microsoft Graph](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/read-email-using-ms-graph.md)**  
Use Microsoft Graph API to retrieve emails from Microsoft Exchange Online and save them to sys\_email table.
-   **[Sending email using Microsoft Graph](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/send-email-using-ms-graph.md)**  
