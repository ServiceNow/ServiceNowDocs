...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/t\_CreateAMobileMessageLayout.html
release: brazil
topic_type: task
...
-   `attributes`: object of the push message [attributes that you define](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_CreateAPushMessageAttribute.md).
...
[Define a push message attribute](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_CreateAPushMessageAttribute.md) to specify a default push action script or string that you can use in the push message content.
