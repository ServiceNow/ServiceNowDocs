---
title: Managing Now Assist applications through Now Assist suites
description: Starting with Zurich patch 4, the Application Manager helps ensure that Now Assist applications that you install or update remain compatible with any other Now Assist applications on your ServiceNow AI Platform instance.
locale: en-US
release: zurich
...
# Managing Now Assist applications through Now Assist suites

Starting with Zurich patch 4, the Application Manager helps ensure that Now Assist applications that you install or update remain compatible with any other Now Assist applications on your ServiceNow AI Platform instance.

## Overview of managing Now Assist applications with the Application Manager
...
For more information about how suites are used to verify compatibility between Now Assist applications on your instance, see [Now Assist suite versions in the Application Manager](now-assist-suites-app-mgr.md).
