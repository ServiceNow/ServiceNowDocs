...
3.  Review the technical details of each included application to verify that you have access to all required dependencies.
    ...
    2.  Procure any dependencies that aren't licensed from the ServiceNow Store.
        ...
        For more information, see [Getting apps and trials from the ServiceNow Store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/getting-apps-trials.md).
...
<table id="choicetable_dm4_3km_yfc"><thead><tr><th align="left" id="d291213e229">

Installation option

</th><th align="left" id="d291213e232">

Procedure

</th></tr></thead><tbody><tr><td id="d291213e238">
