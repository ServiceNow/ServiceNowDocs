...
1.  If your organization doesn't use the application that blocks installation, uninstall it through the Application Manager.
    ...
    For more information about uninstalling applications, see [Uninstall an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/application-manager/uninstall-application-app-mgr.md).


**Parent Topic:**[Application Manager reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/application-manager/app-mgr-reference.md)
