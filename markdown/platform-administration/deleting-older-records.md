---
title: Deleting older or unwanted records in Core UI
description: Delete older, expired, or unwanted records from tables automatically.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/deleting-older-records.html
release: australia
topic_type: concept
...
-   [Create a table cleanup rule in Core UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/activate-table-cleanup.md)

    Define the criteria for deleting unwanted records in a table cleanup rule.

-   [Manage table cleaner resource usage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/manage-table-cleaner-resource-usage.md)
