...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/email-bounce.html
release: zurich
topic_type: concept
...
-   **[Configure bounce email address status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/config-email-address-status.md)**  
Configure a bounced email address status according to type, class, subject, and details.
-   **[Resend all blocked emails](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/resend-all-blocked-emails.md)**  
...
[Check the status of bounced email addresses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/change-bounce-email-status.md)
