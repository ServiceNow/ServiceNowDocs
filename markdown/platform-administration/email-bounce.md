...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/email-bounce.html
release: yokohama
topic_type: concept
...
\[Omitted image "bounce-email-address-status.png"\] Alt text: Example bounce email address status codes
...
-   **[Configure bounce email address status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/config-email-address-status.md)**  
Configure a bounced email address status according to type, class, subject, and details.
-   **[Resend all blocked emails](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/resend-all-blocked-emails.md)**  
...
[Check the status of bounced email addresses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/change-bounce-email-status.md)
