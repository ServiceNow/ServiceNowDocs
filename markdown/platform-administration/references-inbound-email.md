...
-   **[Accessing email object variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/r_AccessingEmailObjsWithVars.md)**  
...
-   **[Email user matching](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/r_MatchingEmailToExistingUsers.md)**  
...
-   **[User impersonations and inbound actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/r_ImpUserRunInboundActions.md)**  
When the instance receives an email, it can take a variety of actions by impersonating the sender.
-   **[Allowing locked out users to process inbound email actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/r_AllowLockedUsersInbdEmailAct.md)**  
...
-   **[Redirecting email to the instance POP3 account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/r_RedirEmailDifferentAssignGrp.md)**  
Configure other mailboxes to forward email to the instance's POP3 account.
-   **[Inbound email action examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/r_InboundEmailActionExamples.md)**  
...
-   **[Integrate inbound events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_IntegratingInboundEvents.md)**  
This example illustrates how to create a notification from an inbound JSON request.

**Parent Topic:**[Inbound email](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/inbound-email-landing.md)
