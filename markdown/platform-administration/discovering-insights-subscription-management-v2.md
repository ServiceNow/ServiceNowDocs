...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/discovering-insights-subscription-management-v2.html
release: xanadu
topic_type: concept
...
For more information, see [Remove a group from a product subscription in Subscription Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/remove-group-from-subscription-v2.md).
