...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_HandlingFailedPushMessages.html
release: yokohama
topic_type: task
...
3.  If some push notifications continue to fail, consider increasing the value in the **glide.push.notification.ttl\_seconds** property.
    ...
    See [Push notification properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/r_PushNotificationProperties.md) for more information.
