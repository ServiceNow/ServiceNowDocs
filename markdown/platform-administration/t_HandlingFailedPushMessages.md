...
3.  If some push notifications continue to fail, consider increasing the value in the **glide.push.notification.ttl\_seconds** property.
    ...
    See [Push notification properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/r_PushNotificationProperties.md) for more information.
