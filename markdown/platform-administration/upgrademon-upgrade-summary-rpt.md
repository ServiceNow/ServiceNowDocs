...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/upgrademon-upgrade-summary-rpt.html
release: xanadu
...
\[Omitted image "upgrade-summary-02-small.png"\] Alt text: Top section of upgrade summary report
...
\[Omitted image "upgrade-summary-03-small.png"\] Alt text: Node Upgrades section of upgrade summary report
...
\[Omitted image "upgrade-summary-04-small.png"\] Alt text: Schema Changes to Clone-excluded Tables section of upgrade summary report
...
\[Omitted image "upgrade-summ-fix-scripts-small.png"\] Alt text: Top 10 Fix Scripts by Duration section of upgrade summary report
...
\[Omitted image "upgrade-summ-schema-changes-small.png"\] Alt text: Top 10 Schema Changes by Duration section of upgrade summary report

The Top 10 Schema Changes by Duration helps you understand which schema changes required the most time.

**Parent Topic:**[Monitor an upgrade to an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/monitor-upgrade-apply-upgrade.md)
