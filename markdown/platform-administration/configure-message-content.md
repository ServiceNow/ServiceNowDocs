...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/configure-message-content.html
release: yokohama
topic_type: task
...
Use the message in a notification. For more information about creating notifications, see [Create a messaging notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/create-messaging-notification.md).
