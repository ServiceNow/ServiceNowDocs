...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/dynamic-translation/dyn-translation-apis.html
release: xanadu
...
This API is available as part of Server APIs, Client APIs, and Service Portal APIs to interact with translation service providers. See [DynamicTranslation - Scoped](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/server-api-reference/DynamicTranslation.md) and [DynamicTranslation - Client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/DynamicTranslationClientAPI.md).
