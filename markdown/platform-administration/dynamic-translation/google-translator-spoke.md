...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/dynamic-translation/google-translator-spoke.html
release: xanadu
...
This spoke uses the GoogleTranslation alias record \(sn\_google\_trans.GoogleTranslation\) to authorize actions. For information about setting up the spoke, see [Set up Google Cloud Translator Service spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/dynamic-translation/setup-google-translator.md).

-   **[Set up Google Cloud Translator Service spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/dynamic-translation/setup-google-translator.md)**  
