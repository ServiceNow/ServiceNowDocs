...
6.  From the Xanadu Patch 3 release, Exclusion Framework enables you to specify which terms and patterns should not be machine translated. For information see [Exclusion Framework in Dynamic Translation](dyn-translation-exclusion-framework.md).
