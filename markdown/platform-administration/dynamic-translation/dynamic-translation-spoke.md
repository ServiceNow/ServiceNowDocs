...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/dynamic-translation/dynamic-translation-spoke.html
release: xanadu
...
In the Xanadu release, the Dynamic Translation spoke enables you to access the Dynamic Translation APIs from the Workflow Studio.
...
The following actions are built in the Xanadu release in Dynamic Translation spoke:
...
For more information about accessing the actions from the Workflow Studio, see [Access Dynamic Translation spoke actions from Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/dynamic-translation/access-dt-spoke-actions.md).
