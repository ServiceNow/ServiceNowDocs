...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_DefineFieldStyles.html
release: yokohama
topic_type: task
...
4.  To add alternative text for a style, [configure the form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/configure-form-layout.md) to add the alternative text field.
