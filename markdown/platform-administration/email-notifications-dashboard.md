...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/email-notifications-dashboard.html
release: yokohama
topic_type: concept
...
Data collection is triggered by configuring and executing jobs. For more information, see [Configure jobs for email notifications dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/configure-jobs-email-dashboard.md).
...
\[Omitted image "email-noti-insights.png"\] Alt text: Example of email notifications insights
...
-   **[Configure jobs for email notifications dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/configure-jobs-email-dashboard.md)**  
