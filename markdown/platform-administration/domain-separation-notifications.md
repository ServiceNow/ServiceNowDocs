...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/domain-separation-notifications.html
release: yokohama
topic_type: concept
...
To learn more see [Inbound email actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/c_InboundEmailActions.md).
...
Solution: Set the \[sys\_overrides\] field on the notification that belongs to the domain so it overrides the setting on global. For more information, see [Delegated administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/c_DelegatedAdministration.md).
