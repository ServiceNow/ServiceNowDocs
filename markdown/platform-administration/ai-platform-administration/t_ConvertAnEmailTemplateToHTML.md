...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-platform-administration/t\_ConvertAnEmailTemplateToHTML.html
release: yokohama
...
2.  Open the email template you want to convert.
    ...
    \[Omitted image "legacy-email-template.png"\] Alt text: Viewing template content
...
3.  Click **Switch to Rich HTML Editor**.
    ...
    \[Omitted image "Template\_converted.png"\] Alt text: Content converted to rich HTML
...
**Parent Topic:**[Email templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/c_EmailTemplates.md)
