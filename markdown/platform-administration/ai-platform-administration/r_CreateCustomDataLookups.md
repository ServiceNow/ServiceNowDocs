...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-platform-administration/r\_CreateCustomDataLookups.html
release: yokohama
...
breadcrumb: [Data lookup and record matching support, Administering fields, Field administration, Forms, fields, and lists, Configure core features, Administer the ServiceNow AI Platform]
---
...
2.  Configure the list and create new fields.
    ...
    For more information, see [Configuring lists on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/list-administration/c_ListConfiguration.md).
