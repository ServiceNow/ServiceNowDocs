---
title: Exploring the ServiceNow Store
description: Learn about the ServiceNow Store procurement workflow and how apps, products, and integrations can help your organization enhance the ServiceNow AI Platform experience.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-platform-administration/exploring-servicenow-store.html
release: yokohama
...
keywords: [servicenow store, store, app store, application store, app store user documentation, servicenow app store, servicenow store workflow]
...
\[Omitted image "mmasset0020704-producing-and-using-apps-from-store-vertical.png"\] Alt text: Infographic showing the app procurement and installation process, along with which users can complete each stage. For more details, refer to the following description.
...
-   [Tracking your ServiceNow Store activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/tracking-store-activity.md)
-   [Plugins, apps, integrations, and products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/plugins-apps-products-integrations.md)
-   [Getting apps and trials from the ServiceNow Store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/getting-apps-trials.md)
-   [Reviewing apps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/reviewing-apps.md)
-   [Getting apps as an on-premise customer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/getting-apps-on-prem.md)
-   [Using the ServiceNow Store in a regulated environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/using-regulated-store.md)
-   [ServiceNow Store reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/store-reference.md)
