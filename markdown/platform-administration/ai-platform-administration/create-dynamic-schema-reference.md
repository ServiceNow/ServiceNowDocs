...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-platform-administration/create-dynamic-schema-reference.html
release: yokohama
...
<table id="choicetable_dx5_4lv_gbc"><thead><tr><th align="left" id="d207422e87">

Reference Type

</th><th align="left" id="d207422e90">

Steps

</th></tr></thead><tbody><tr><td id="d207422e96">
...
\[Omitted image "dynamic-schema-reference-example.png"\] Alt text: Add a List field that references a dynamic attribute group.

## What to do next

[Create a dynamic attribute store field](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/create-dynamic-attribute-store-field.md)
