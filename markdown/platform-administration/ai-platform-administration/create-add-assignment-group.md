...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-platform-administration/create-add-assignment-group.html
release: yokohama
...
4.  Select **New** or **Edit** to add assignment groups.

    -   Select **New** to add assignment groups.
    ...
    -   Select **Edit** and select the groups from the collection to add to the group list.
5.  Select **Submit** or **Save**.


**Parent Topic:**[Create and update a provider notification for all users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/noti-new-update-notification.md)
