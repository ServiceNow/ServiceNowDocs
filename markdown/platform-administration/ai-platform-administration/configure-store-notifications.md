...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-platform-administration/configure-store-notifications.html
release: yokohama
...
2.  Select your name to open the user options.

3.  Select **My store activity**.

4.  Select the **Select Action** drop-down menu next to the application whose notification setting you want to change.
