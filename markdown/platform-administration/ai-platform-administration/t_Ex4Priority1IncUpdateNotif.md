...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-platform-administration/t\_Ex4Priority1IncUpdateNotif.html
release: yokohama
...
6.  Test that the email notification sends to an assignment group when its Priority 1 Incident is updated.
    ...
    1.  [Create a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/user-administration/t_CreateAUser.md) who has an email address that you can monitor, and then [create a group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/user-administration/t_CreateAGroup.md) that includes the user that you created.
...
**Parent Topic:**[Create an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/t_CreateANotification.md)
