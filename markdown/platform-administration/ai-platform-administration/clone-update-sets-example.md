...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-platform-administration/clone-update-sets-example.html
release: yokohama
...
8.  **Note:** \(Important: Don’t commit!\)

    On your source instance, retrieve the update set.
