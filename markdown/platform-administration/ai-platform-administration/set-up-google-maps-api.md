...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-platform-administration/set-up-google-maps-api.html
release: yokohama
...
\[Omitted image "MapPage.jpg"\] Alt text: Map page
