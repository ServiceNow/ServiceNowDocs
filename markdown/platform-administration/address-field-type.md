...
1.  Add the Address \(Simple\) field to a table to store and display data.
    ...
    For more information, see [Add and customize a field in a table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_CreatingNewFields.md).

2.  Configure the address suggestions API in system properties.

    For more information, see [Configure address suggestion properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/configure-address-suggestion-properties.md).
