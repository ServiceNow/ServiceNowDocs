...
![](../image/RefAutoComplete.png "Auto complete")
...
![](../image/OneAsteriskWildCardSearch.png "One asterisk wildcard search")

If two asterisks are entered, a list of available records display in the auto-complete suggestions.

![](../image/TwoAsteriskWildCardSearch.png "Two asterisk wildcard search")

**Related topics**  


[Wildcard characters allow searching for patterns and variations](../../search-administration/concept/c_Wildcards.md)
