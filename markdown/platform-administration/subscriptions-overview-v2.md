...
The usage\_admin or admin roles are required to view and edit Subscription Management.
...
-   View a summary of the Creator Plus subscriptions on the instance that you're currently accessing.
    ...
    -   Monitor the total number of Creator Plus allocations on your current instance in the **Allocated** column.
