...
-   **[General guidelines for creating and mapping an intent](../reference/guidelines-creating-intent.md)**  
...
**Parent Topic:**[Use email agentic workflow](../reference/use-agentic-ai-notifications.md)
