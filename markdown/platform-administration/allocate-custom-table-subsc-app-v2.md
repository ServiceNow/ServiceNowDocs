...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/allocate-custom-table-subsc-app-v2.html
release: australia
topic_type: task
