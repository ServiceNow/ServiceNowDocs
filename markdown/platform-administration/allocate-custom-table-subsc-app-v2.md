...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/allocate-custom-table-subsc-app-v2.html
release: yokohama
topic_type: task
