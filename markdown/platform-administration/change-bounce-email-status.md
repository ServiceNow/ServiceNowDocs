...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/change-bounce-email-status.html
release: australia
topic_type: task
...
2.  From the state of the mail address, select the state and choose the desired state to block or unblock the email address
