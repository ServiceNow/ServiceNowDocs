...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/data-management-overview.html
release: australia
topic_type: concept
...
-   Delete older or unwanted records by selecting **New cleanup rule**. See [Create a table cleanup rule in Core UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/activate-table-cleanup.md).
-   Move data that's no longer needed to an archive table by selecting **New archive rule**. See [Create an archive rule in Core UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/t_CreateAnArchiveRule.md).
