...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/deleting-records-safely.html
release: yokohama
topic_type: concept
...
1.  [Mark records for deletion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/mark-records-for-deletion.md)

    Determine which records to delete by creating a delete job.

2.  [Preview affected records for deletion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/preview-affected-records-for-deletion.md)
...
3.  [Schedule or execute a job to delete records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/schedule-execute-job-delete-records.md)

    Schedule the job to run later or execute the job immediately.

4.  [Rollback a delete job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/rollback-delete-job.md)
...
-   **[Mark records for deletion](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/mark-records-for-deletion.md)**  
...
-   **[Rollback a delete job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/rollback-delete-job.md)**  
