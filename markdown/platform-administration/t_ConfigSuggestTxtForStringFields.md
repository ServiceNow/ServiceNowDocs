...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/t\_ConfigSuggestTxtForStringFields.html
release: australia
topic_type: task
last_updated: "2026-03-12"
reading_time_minutes: 1
breadcrumb: [Suggestion field type, Reference, Field administration, Forms, fields, and lists, Configure core features, Administer the ServiceNow AI Platform]
---
...
1.  Select and hold \(or right-click\) the field label and select **Configure Choices**.

2.  Select options and the order in which you want them to appear.
...
4.  To edit existing options, select and hold \(or right-click\) the field label and select **Show Choice List.**.
