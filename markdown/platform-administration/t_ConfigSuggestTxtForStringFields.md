...
breadcrumb: [Suggestion field type, Reference, Field administration, Forms, fields, and lists, Configure core features, Administer]
---
...
![Configure choices](../image/PersonalizeChoices.png "Configure Choices List")
