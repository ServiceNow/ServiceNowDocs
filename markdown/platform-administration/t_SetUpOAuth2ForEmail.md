...
6.  Use the information you obtained from your third-party email account to fill in the fields on the form.
    ...
    See [Use a third-party OAuth provider](https://www.servicenow.com/docs/access?context=t_UseAThirdPartyOAuthProvider&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) for instructions.
