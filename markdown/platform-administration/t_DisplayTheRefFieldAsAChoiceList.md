...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_DisplayTheRefFieldAsAChoiceList.html
release: yokohama
topic_type: task
...
6.  Click **Update**.
    ...
    \[Omitted image "Referencechoice.png"\] Alt text: Reference choices
