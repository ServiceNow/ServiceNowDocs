...
<table id="choicetable_ovz_ssv_3hc"><thead><tr><th align="left" id="d317369e112">

Type

</th><th align="left" id="d317369e115">

Action

</th></tr></thead><tbody><tr><td id="d317369e121">

**Subflow Invocation**

</td><td>

Select the **Subflow** tab and select the subflow that must be triggered when the intent is matched. To create subflows see, Create a subflow in Workflow Studio

</td></tr><tr><td id="d317369e136">
