...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/create-actions-for-intent.html
release: zurich
topic_type: task
...
<table id="choicetable_ovz_ssv_3hc"><thead><tr><th align="left" id="d317305e112">

Type

</th><th align="left" id="d317305e115">

Action

</th></tr></thead><tbody><tr><td id="d317305e121">
...
6.  In **Email Template**, create or apply an existing email template for the reply action. To create an email template, see [Create an email template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_CreateAnEmailTemplate.md).
