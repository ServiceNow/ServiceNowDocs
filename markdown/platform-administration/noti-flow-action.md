...
Option to select either Flow or Action. See [Flow Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/building-applications/flow-designer.md) for more information.**Note:** You can select either Flow or Action, but not both.
