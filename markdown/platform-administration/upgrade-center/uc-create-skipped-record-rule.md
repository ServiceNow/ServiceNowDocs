...
1.  Navigate to **All** &gt; **Upgrade Center** &gt; **Administration** &gt; **Skipped Record Rules Editor**.
    ...
    **Note:** By default, a few inactive sample rules have been provided. You can change these rules to active to use any of them.
...
You can now run the skipped record rules either automatically during an upgrade or can run on demand on the skipped records. See for more information.
