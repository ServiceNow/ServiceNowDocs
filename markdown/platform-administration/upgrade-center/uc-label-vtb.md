...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/upgrade-center/uc-label-vtb.html
release: xanadu
...
Click on a skipped record in the VTB to update the task. See [Upgrade History Task form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/upgrade-center/uc-history-task-form.md) for more information.
