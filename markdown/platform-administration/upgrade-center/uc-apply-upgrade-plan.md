...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/upgrade-center/uc-apply-upgrade-plan.html
release: yokohama
...
1.  Go to the Upgrade Monitor page to ensure that the selected upgrade plan is being implemented in your upgrade.
    ...
    See Upgrade Plan background operations section in [Upgrade Plan overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-center/uc-upgrade-plan.md) for more information.
...
-   **[Review skipped records with upgrade plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-center/uc-review-skipped-records-upgrade-plan.md)**  
Review the skipped records after the completion of the upgrade.

**Parent Topic:**[Preparing your upgrade plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-center/uc-prepare-up.md)
