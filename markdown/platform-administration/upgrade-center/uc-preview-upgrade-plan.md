...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/upgrade-center/uc-preview-upgrade-plan.html
release: xanadu
...
breadcrumb: [Prepare to upgrade with Upgrade Plan, Upgrade Plan overview, Exploring Upgrade Center, Upgrade Center, Upgrade, Administer the ServiceNow AI Platform]
---
