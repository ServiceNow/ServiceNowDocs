...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/upgrade-center/uc-upgrade-preview-form1.html
release: xanadu
...
4.  Click **View preview details** on the **Previewing version** card to view the following related lists.
    ...
    See [Previewed changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/upgrade-center/uc-previewed-changes.md) for more details about the related lists.
