...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/upgrade-center/uc-resolve-skipped-update.html
release: australia
...
3.  In the Skipped Changes to Review related list, select the update record to resolve.
    ...
    See [Review skipped records using related lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/upgrade-center/uc-access-rl.md).
