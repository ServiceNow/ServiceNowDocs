...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/upgrade-center/uc-previous-resolutions-rl.html
release: xanadu
...
breadcrumb: [Skipped Records visual task board \(VTB\), Reviewing upgrade history, Upgrade Center, Upgrade, Administer the ServiceNow AI Platform]
---
