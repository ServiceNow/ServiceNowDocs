...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/upgrade-center/uc-monitor-module.html
release: xanadu
...
**Note:** For detailed information about the upgrade process, see [Upgrade your instance](https://staging-docs-servicenow.zoominsoftware.io/bundle/vancouver-release-notes/page/release-notes/upgrades/concept/upgrades-overview.html).
...
3.  On the upgraded non-production instance, [process the skipped list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/upgrade-center/uc-process-skipped-records.md).
...
-   On non-production instances, it provides information that can help you estimate how long the upgrade might take on the production instance
    ...
    **Note:** [Debug Upgrade](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/debug-upgrade.md) provides detailed debugging output for transactions containing artifacts affected by the most recent upgrade, and is designed to assist in upgrade error resolution.
...
For details on reconciling conflicts, see [Process the skipped records list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/upgrade-center/uc-process-skipped-records.md).
