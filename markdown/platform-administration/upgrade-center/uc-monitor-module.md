...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/upgrade-center/uc-monitor-module.html
release: yokohama
...
**Note:** For detailed information about the upgrade process, see [Upgrade your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/release-notes/upgrades-overview.md).
...
3.  On the upgraded non-production instance, [process the skipped list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-center/uc-process-skipped-records.md).
...
-   On non-production instances, it provides information that can help you estimate how long the upgrade might take on the production instance
    ...
    **Note:** Debug Upgrade provides detailed debugging output for transactions containing artifacts affected by the most recent upgrade, and is designed to assist in upgrade error resolution.
...
For details on reconciling conflicts, see [Process the skipped records list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upgrade-center/uc-process-skipped-records.md).
