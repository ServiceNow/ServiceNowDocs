...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/upgrade-center/uc-system-upgrades-form.html
release: xanadu
...
breadcrumb: [Process the skipped records list, Scheduling and monitoring an upgrade, Upgrade Center, Upgrade, Administer the ServiceNow AI Platform]
---
