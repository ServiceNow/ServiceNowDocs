...
breadcrumb: [Deleting older or unwanted records, Managing the growth of data on your instance, Data Management, Tables and data, Configure core features, Administer the ServiceNow AI Platform]
---
