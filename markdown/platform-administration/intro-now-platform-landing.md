...
[Explore![](../../../reuse/icons/brand-icons/bus-power.svg)Learn how the ServiceNow AI Platform works.](get-started-now-platform.md)

</td><td>

[Configure core features![](../../../reuse/icons/brand-icons/bus-sdlc.svg)Configure settings that affect global ServiceNow AI Platform behavior and behavior for ServiceNow AI Platform applications.](config-now-platform-core-features.md)

</td></tr><tr><td>

[Maintain and monitor![](../../../reuse/icons/brand-icons/ind-maintenance-repair-operations.svg)Identify health issues and settings that you need to change. Optimize ServiceNow AI Platform performance using performance monitoring and diagnostics.](maintain-monitor-now-platform.md)
...
-   [Events](https://www.servicenow.com/docs/access?context=events&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US)
