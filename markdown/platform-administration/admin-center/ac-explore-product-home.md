---
title: Explore the product home page
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/admin-center/ac-explore-product-home.html
release: xanadu
...
2.  Select one of the product families as per your requirement.
    ...
    The product home page shows up.\[Omitted image "ac-product-home-page-details.png"\] Alt text:
...
4.  Drill down to a particular application by selecting the **Explore** tab.
    ...
    **Note:** The first time the **Explore** option is loaded, it takes in all the applications displayed in the **Overview** section.
    ...
    \[Omitted image "ac-explore-files.png"\] Alt text:You can do the following in the Explore tab:
...
**Parent Topic:**[Configuration Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/admin-center/ac-configuration-hub.md)
