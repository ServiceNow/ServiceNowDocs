...
It can also help you search applications that have been grouped by SN store, taxonomy or product families. When you select a product family, it takes to the product home page. See [Explore the product home page](../task/ac-explore-product-home.md) for more information.![](../image/ac-product-home-page.png)

-   **[Explore the product home page](../task/ac-explore-product-home.md)**  
