...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/find-components.html
release: xanadu
topic_type: task
...
-   Roles required: admin or the application admin role
    ...
    **Note:** The application admin role is only required for applications that use the [Application administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/building-applications/application-administration.md) feature. For example, Vulnerability Response.
