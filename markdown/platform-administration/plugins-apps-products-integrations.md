...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/plugins-apps-products-integrations.html
release: australia
topic_type: concept
...
For more information about plugins, see [ServiceNow plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/c_ServiceNowPlugins.md).
...
After getting an app from the ServiceNow Store, install it using the Application Manager. For more information, see [Application Manager](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/application-manager/application-manager.md).
...
For more information about procuring products, see [Getting products](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/getting-products.md).
