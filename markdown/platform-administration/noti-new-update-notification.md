...
Field in the currently selected table that contains the users who receive an email notification.**Note:** The **Recipients in fields** field under Recipients enables you to choose both sys and non-sys users to whom you can send notifications.
