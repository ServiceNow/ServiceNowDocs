...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_InstallApplications.html
release: yokohama
topic_type: task
...
To install an application that you published to the ServiceNow application repository, follow the steps in [Install an application from the application repository](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/install-app-from-repo.md) instead.
...
**Parent Topic:**[Using Legacy Application Manager](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/using-legacy-application-manager.md)

**Related topics**  


[Install customizations from an application repository](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/install-customizations-from-app-repo.md)

[System-managed developer and deployment roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/delegated_deployment_user_roles.md)
