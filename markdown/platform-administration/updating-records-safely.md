...
1.  [Mark records for updating](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/mark-records-update.md)
...
2.  [Schedule or execute a job to update records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/schedule-execute-job-update-records.md)

    Schedule the job to run later or execute the job immediately.

3.  [Rollback an update job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/rollback-update-job.md)

    Use the rollback option in the update job if you need to restore the updated records to their previous state.


-   **[Mark records for updating](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/mark-records-update.md)**  
...
-   **[Rollback an update job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/rollback-update-job.md)**  
