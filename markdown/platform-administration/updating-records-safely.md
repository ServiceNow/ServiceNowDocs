...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/updating-records-safely.html
release: yokohama
topic_type: concept
...
1.  [Mark records for updating](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/mark-records-update.md)
...
2.  [Schedule or execute a job to update records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/schedule-execute-job-update-records.md)

    Schedule the job to run later or execute the job immediately.

3.  [Rollback an update job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/rollback-update-job.md)

    Use the rollback option in the update job if you need to restore the updated records to their previous state.


-   **[Mark records for updating](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/mark-records-update.md)**  
Mark records for updating according to one or more criteria by creating an update job.
-   **[Schedule or execute a job to update records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/schedule-execute-job-update-records.md)**  
Schedule a date and time to execute an update job or execute the job immediately.
-   **[Rollback an update job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/rollback-update-job.md)**  
