...
If you enter a mail script inside `${{mail_script:script name}}` and the HTML sanitizer is configured, the output of the mail script is HTML sanitized. For more information about HTML sanitizer, see HTML Sanitizer.
