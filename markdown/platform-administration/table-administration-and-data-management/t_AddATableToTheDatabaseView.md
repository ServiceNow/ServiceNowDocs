...
2.  [Configure the form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/configure-form-layout.md) and add the **Left join** field \(a check box\) to the form.
