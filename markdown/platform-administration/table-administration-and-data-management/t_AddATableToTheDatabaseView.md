...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/table-administration-and-data-management/t\_AddATableToTheDatabaseView.html
release: yokohama
...
-   Database views cannot be created on tables that participate in [table rotation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/c_TableRotation.md).
...
To see an example of using left joins to create a view, see [Example left join in creating a database view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/table-administration-and-data-management/example-left-join-db-view.md).
...
2.  [Configure the form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/configure-form-layout.md) and add the **Left join** field \(a check box\) to the form.
