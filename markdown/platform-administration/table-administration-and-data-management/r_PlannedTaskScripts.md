...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/table-administration-and-data-management/r\_PlannedTaskScripts.html
release: yokohama
...
|Planned task global events|Raises global event for every insert or update of planned task record. For more information, see [Global events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/system-events/r_GlobalEvents.md).|
...
**Parent Topic:**[Extending the Task table with Planned tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/table-administration-and-data-management/c_PlannedTask.md)
