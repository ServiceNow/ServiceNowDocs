...
-   Not all tables with a sys prefix track deletions by default. You can [Enable auditing for a system table](https://www.servicenow.com/docs/access?context=t_ConSysTablDelAud&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
...
<table id="choicetable_rxr_mx3_jdb"><tbody><tr><td id="d203972e126">
