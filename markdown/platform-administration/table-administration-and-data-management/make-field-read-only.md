...
For details on read only options, see [Configuring read-only security options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/table-administration-and-data-management/read-only-option.md).
...
<table id="choicetable_ic3_bwk_tgc"><thead><tr><th align="left" id="d124869e109">

Option

</th><th align="left" id="d124869e112">

Description

</th></tr></thead><tbody><tr><td id="d124869e118">
