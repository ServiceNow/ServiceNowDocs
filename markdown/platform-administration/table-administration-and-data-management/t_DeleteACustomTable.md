...
breadcrumb: [Deleting custom tables, Managing tables and indexes, Table administration, Tables and data, Configure core features, Administer the ServiceNow AI Platform]
---
