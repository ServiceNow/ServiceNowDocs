...
3.  Configure the following parameters in the script as per the business requirements:
    ...
    **Note:**
    ...
    -   The **Allow time card reporting on** field on the [project form](https://www.servicenow.com/docs/access?context=t_CreateAProject&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US) determines the level that the time cards for the project tasks are created at.
