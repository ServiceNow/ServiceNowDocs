...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/table-administration-and-data-management/t\_DefineARelationshipType.html
release: xanadu
...
Activate the Many to Many Task Relations plugin \(com.snc.task\_relations\) first. See [Request many to many task relations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/table-administration-and-data-management/t_RequestManyToManyTaskRelations.md).
