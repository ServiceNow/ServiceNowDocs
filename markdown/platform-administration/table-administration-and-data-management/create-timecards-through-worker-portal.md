...
breadcrumb: [Time Sheet Portal, Time Card management, Working with the Task table, Table administration, Tables and data, Configure core features, Administer the ServiceNow AI Platform]
---
...
-   Time sheet portal supports [resource assignments created using Project Workspace](https://www.servicenow.com/docs/access?context=create-resource-assignment-prj-wksp&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US). Once the time cards are approved, Project Managers can view the planned vs actual hours for an assignment in Project Workspace and Resource Management Workspace heatmap view.
...
<table id="choicetable_uks_jpt_vz"><thead><tr><th align="left" id="d318850e104">

Option

</th><th align="left" id="d318850e107">

Steps

</th></tr></thead><tbody><tr><td id="d318850e113">
...
**Note:**
    ...
    -   The **Allow time card reporting on** field on the [project form](https://www.servicenow.com/docs/access?context=t_CreateAProject&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US) determines the level at which the time cards are created for project tasks.


</td></tr><tr><td id="d318850e165">
...
<table id="choicetable_ixh_s1h_d1b"><thead><tr><th align="left" id="d318850e348">

Option

</th><th align="left" id="d318850e351">

Steps

</th></tr></thead><tbody><tr><td id="d318850e357">
