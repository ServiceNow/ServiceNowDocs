...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/table-administration-and-data-management/create-timecards-through-worker-portal.html
release: yokohama
...
<table id="choicetable_uks_jpt_vz"><thead><tr><th align="left" id="d378858e113">

Option

</th><th align="left" id="d378858e116">

Steps

</th></tr></thead><tbody><tr><td id="d378858e122">
...
**Note:**
    ...
    -   The **Allow time card reporting on** field on the [project form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-business-management/t_CreateAProject.md) determines the level at which the time cards are created for project tasks.


</td></tr><tr><td id="d378858e174">
...
<table id="choicetable_ixh_s1h_d1b"><thead><tr><th align="left" id="d378858e357">

Option

</th><th align="left" id="d378858e360">

Steps

</th></tr></thead><tbody><tr><td id="d378858e366">
...
**Parent Topic:**[Time Sheet Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/table-administration-and-data-management/worker-portal.md)
