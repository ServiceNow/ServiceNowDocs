...
Specifies the [Create a dynamic filter option](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/t_DynamicFilterOptions.md) that determines the default value if the **Use dynamic default** option is selected.
...
-   Dynamic: A [Create a dynamic filter option](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/t_DynamicFilterOptions.md) that you can use to build the qualifier.
...
Specifies the [Create a dynamic filter option](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/t_DynamicFilterOptions.md) that determines the reference qualifier when the **Dynamic** qualifier type is selected.
