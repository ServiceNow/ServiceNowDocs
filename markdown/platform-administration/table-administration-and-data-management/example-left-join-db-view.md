...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/table-administration-and-data-management/example-left-join-db-view.html
release: australia
...
4.  Add a **Left join** check box to the form by [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/configure-form-layout.md).
...
**Previous topic:**[Add a table to the database view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/table-administration-and-data-management/t_AddATableToTheDatabaseView.md)

**Next topic:**[Specify a field to return](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/table-administration-and-data-management/c_SpecifyAFieldToReturn.md)
