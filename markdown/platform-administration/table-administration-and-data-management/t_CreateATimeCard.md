...
The **Allow time card reporting on** field on the [project form](https://www.servicenow.com/docs/access?context=t_CreateAProject&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US) determines the level at which the time cards for the project tasks can be created.
...
<table id="choicetable_whk_swd_tw"><thead><tr><th align="left" id="d151974e212">

Option

</th><th align="left" id="d151974e215">

Steps

</th></tr></thead><tbody><tr><td id="d151974e221">
...
[Map a time card category with operational work types](https://www.servicenow.com/docs/access?context=map-time-card-category&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US)
