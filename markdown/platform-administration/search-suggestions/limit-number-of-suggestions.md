...
How often you run the pruning job might depend on how frequently you [generate suggestions from the Search Suggestion table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-suggestions/schedule-search-suggestion-builds.md), and how quickly the table exceeds 500,000 suggestions.
