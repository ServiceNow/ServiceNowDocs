...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/search-suggestions/view-ext-user-search-suggestions.html
release: zurich
...
-   The Domain Separation plugin isn't activated. For details on this plugin, see [Domain separation plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/domain-sep-plugin.md).
-   The Explicit Roles plugin \(com.glide.explicit\_roles\) is activated. To learn more about this plugin, see [Explicit Roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/explicit-roles.md).
