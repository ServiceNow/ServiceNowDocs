...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/search-suggestions/view-ext-user-search-suggestions.html
release: australia
...
-   The **glide.search.suggestions.allow\_guest\_user** system property is set to **true**. For details on setting a system property value, see [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/t_AddAPropertyUsingSysPropsList.md).
