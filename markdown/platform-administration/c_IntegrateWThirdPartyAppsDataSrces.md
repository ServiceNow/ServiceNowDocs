...
Information can be pulled from the platform to an external platform using an [ODBC driver](https://www.servicenow.com/docs/access?context=c_ODBCDriver&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
