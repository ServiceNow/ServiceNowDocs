---
title: Activate data archiving to object storage
description: You can activate the Data Archiving \(com.glide.db.columnar.archive\) plugin for Data Management if you have the admin role. If the application does NOT include demo data or it does NOT install related applications and plugins, delete or revise the following sentence:
locale: en-US
release: australia
topic_type: task
...
# Activate data archiving to object storage
...
2.  Find the Data Archiving plugin \(com.glide.db.columnar.archive\) plugin using the filter criteria and search bar.
