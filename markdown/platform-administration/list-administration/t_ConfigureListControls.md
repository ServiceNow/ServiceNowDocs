...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/list-administration/t\_ConfigureListControls.html
release: yokohama
...
breadcrumb: [Configuring lists, List administration, Forms, fields, and lists, Configure core features, Administer the ServiceNow AI Platform]
---
...
See [Enable a hierarchical list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/list-administration/t_EnableAHierarchicalList.md). Hierarchical list inserted into a record list. Hierarchical lists enable a user to view the contents of a record's related lists without leaving the record list form. This field is available for standard lists only.
...
**Parent Topic:**[Configuring lists on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/list-administration/c_ListConfiguration.md)
