...
**Note:** Configuring a list in this way modifies the list for all users. To make changes to a list that are visible to you only, see [Personal lists](https://www.servicenow.com/docs/access?context=c_PersonalLists&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
