...
**Note:** Configuring a list in this way modifies the list for all users. To make changes to a list that are visible to you only, see [Personal lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/platform-user-interface/configure-user-experiences/c_PersonalLists.md).
