...
breadcrumb: [Restrict filters and breadcrumbs with fixed queries, List administration, Forms, fields, and lists, Configure core features, Administer the ServiceNow AI Platform]
---
