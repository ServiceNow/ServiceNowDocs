...
5.  Select **Save**.
    ...
    **Note:**
    ...
    -   If you use [Personal lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/c_PersonalLists.md) and then configure the list view differently, the changes do not appear until you reset your personal list to column defaults.
