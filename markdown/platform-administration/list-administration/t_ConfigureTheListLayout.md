...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/list-administration/t\_ConfigureTheListLayout.html
release: zurich
...
5.  Select **Save**.
    ...
    **Note:**
    ...
    -   If you use [Personal lists](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_PersonalLists.md) and then configure the list view differently, the changes do not appear until you reset your personal list to column defaults.
