...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/configure-form-layout.html
release: yokohama
topic_type: concept
...
2.  Select the form context menu icon \(\[Omitted image "ContextMenu.png"\] Alt text: Context menu icon\), and select **Configure** &gt; **Related Lists**.
...
[Configure items on forms or in lists using a slushbucket](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/t_UseSlushbuckets.md)
...
2.  Select the form context menu icon \(\[Omitted image "ContextMenu.png"\] Alt text: Form context menu icon\) and select **Configure** &gt; **Form Layout**.
...
[Configure list control settings for the list editor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/list-administration/t_ConfigListEditorControlSettings.md)
...
<table id="choicetable_o2r_v2r_3r"><tbody><tr><td id="d320966e1188">
...
\[Omitted image "ChartOnAForm.png"\] Alt text: Chart on the Incident form
...
3.  Click the form context menu icon \(\[Omitted image "ContextMenu.png"\] Alt text: Form context menu icon\) and select **Configure** &gt; **Form Layout**.
