...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/domain-separation-data-management.html
release: yokohama
topic_type: concept
...
Data archiving supports [Domain separation for service providers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/domain-sep-landing-page.md). For example, incidents that belong to a domain keep their domain designation even after they are archived.
