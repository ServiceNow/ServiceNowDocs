...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/configure-personal-corporate-mailbox.html
release: brazil
topic_type: task
...
The email account should be created and connected. For more information, see [Create an email account](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_ConfigureAnEmailAccount.md).
...
1.  Create an email client template.
    ...
    To configure an email client template, see [Create an email client template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_CreateAnEmailClientTemplate.md).
...
2.  [Apply an email client template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_CreateAnEmailClientTemplate.md).
...
**Parent Topic:**[Personal corporate mailbox](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/personal-corporate-mailbox.md)
