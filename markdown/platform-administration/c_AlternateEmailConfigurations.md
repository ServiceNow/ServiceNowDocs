...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/c\_AlternateEmailConfigurations.html
release: xanadu
topic_type: concept
...
The following procedures assume that you [enabled basic email properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/t_ConfiguringStandardEmail.md).

-   **[Enable using your own SMTP server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/t_ConfAltEmailUsgOwnSMTP.md)**  
...
-   **[Enable using your own POP3 server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/t_ConfAltEmailConfPOP3Server.md)**  
You can use your own POP3 server to store and receive email for the instance.
-   **[Enable using your own SMTP and POP3 servers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/t_ConfAltEmailConfServers.md)**  
...
-   **[Email bounce management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/email-bounce.md)**  
...
-   **[OAuth email authentication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/c_OAuthEmailAuthentication.md)**  
OAuth enables your instance to receive and send email through a third-party email account.
-   **[System address filters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/system-address-filters.md)**  
Prevent your system from communicating with untrusted domains and email addresses.
-   **[Reading email using Microsoft Graph](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/read-email-using-ms-graph.md)**  
Use Microsoft Graph endpoints to read emails from Microsoft Exchange Online.
-   **[Send email using client credential flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/send-email-client-credential-flow.md)**  
