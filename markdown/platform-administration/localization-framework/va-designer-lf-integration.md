...
For more information about localizing the Virtual Agent topics in the Virtual Agent Designer, see [Virtual Agent Localization](https://www.servicenow.com/docs/access?context=localize-va-topic&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US).
