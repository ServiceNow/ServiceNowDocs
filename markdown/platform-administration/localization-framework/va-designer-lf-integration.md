...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/localization-framework/va-designer-lf-integration.html
release: yokohama
...
-   Monitor the overall localization health of the Virtual Agent topics from the [Localization Insights dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/localization-framework/localization-insights-dashboard.md).

For more information about localizing the Virtual Agent topics in the Virtual Agent Designer, see [Virtual Agent Localization](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/conversational-interfaces/virtual-agent/localize-va-topic.md).
