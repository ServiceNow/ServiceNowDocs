...
You can configure the **Send via Email** mode as a translation preference for one or more activated languages. For more information see, [Configure the Localization Framework preferences](../task/define-translation-preferences.md).
