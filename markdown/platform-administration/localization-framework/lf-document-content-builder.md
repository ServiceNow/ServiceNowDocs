...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/localization-framework/lf-document-content-builder.html
release: yokohama
...
The version type of the document content to be generated. For Yokohama, this value is v1.
...
**Note:** The getFinalJSON function has been deprecated in the Yokohama release and it is recommended to use the build\(\) function.
