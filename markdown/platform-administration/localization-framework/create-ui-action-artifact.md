...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/localization-framework/create-ui-action-artifact.html
release: xanadu
...
</table>    **Note:** Configure the form to see all the fields. For more information, see [Create a UI action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/t_EditingAUIAction.md).
