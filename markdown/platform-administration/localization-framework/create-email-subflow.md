...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/localization-framework/create-email-subflow.html
release: yokohama
