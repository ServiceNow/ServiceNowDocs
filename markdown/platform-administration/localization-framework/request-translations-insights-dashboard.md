...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/localization-framework/request-translations-insights-dashboard.html
release: yokohama
...
1.  Navigate to **All** &gt; **Localization Framework** &gt; **Insights Dashboard**.
    ...
    If you have created a report for your custom artifact to display in the dashboard, you can also request translations for the custom artifacts. For more information, see Create a report for custom artifact.
...
**Parent Topic:**[Monitor the Localization Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/localization-framework/monitor-localization-framework.md)
