...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/localization-framework/define-translation-preferences.html
release: brazil
...
List of all the TMS services available for machine translation. By default, the **RWS** and the **XTM** TMS are available.
 ...
 You can also choose a configured custom TMS. For more information, see [Translation Management System configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/localization-framework/tms-configuration.md).
...
-   **Send to TMS**. If the instance has been set up as a spoke in the [Localization Framework Hub and Spoke architecture](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/localization-framework/localization-framework-hub-spoke-architecture.md), this setting will submit the translation request to the hub.
-   **Send via Email**
For more information, see [Translation Modes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/localization-framework/translation-modes.md) **Note:** Ensure that you have configured the Translation Preferences for the selected auto translation mode.
