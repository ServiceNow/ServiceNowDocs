...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/localization-framework/processor-script-functions.html
release: yokohama
