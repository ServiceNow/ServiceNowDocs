...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/subscription-details-v2.html
release: yokohama
topic_type: concept
...
-   See how a subscription is measured and the type of entitlement it provides by checking the **Meter Type** field.
    ...
    For more information, see [Types of subscriptions in Subscription Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/types-subscription-v2.md).
