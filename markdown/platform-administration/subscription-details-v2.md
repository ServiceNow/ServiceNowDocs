...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/subscription-details-v2.html
release: australia
topic_type: concept
...
-   See how a subscription is measured and the type of entitlement it provides by checking the **Meter Type** field.
    ...
    For more information, see [Types of subscriptions in Subscription Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/types-subscription-v2.md).
