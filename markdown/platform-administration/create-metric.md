...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/create-metric.html
release: yokohama
topic_type: task
...
Check this box to display the metric on a timeline page. For more information, see [Timeline pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/time-configuration/c_TimelinePages.md).
