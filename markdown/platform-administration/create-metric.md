...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/create-metric.html
release: australia
topic_type: task
...
Check this box to display the metric on a timeline page. For more information, see [Timeline pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/time-configuration/c_TimelinePages.md).
