...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/platform-upgrades.html
release: xanadu
topic_type: concept
...
**Note:** For detailed information about the upgrade process, see [Upgrade your instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/release-notes/upgrades-overview.md).
...
3.  On the upgraded non-production instance, [Process the skipped records list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/upgrademon-process-skip-list.md)
...
While the upgrade is in progress the [Upgrade Progress](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/upgrademon-upgrade-progress-scrn.md) shows what the upgrade process has done, what it is doing, and what remains to be done.

When the upgrade completes, the system displays the [Upgrade Summary Report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/upgrademon-upgrade-summary-rpt.md). The Upgrade Summary Report provides information about conflicts between customizations versus the upgrade and provides a link to reconcile these conflicts. For information about understanding and resolving these conflicts, see [Resolve Conflicts form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/upgrademon-resolve-conflicts-form.md).

When you upgrade a non-production instance, the Upgrade Summary Report can help you estimate how long the same upgrade takes on a production instance. For details about the elements on this report and how to use this information, see [Upgrade Progress](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/upgrademon-upgrade-progress-scrn.md).
...
For details on reconciling conflicts, see [Process the skipped records list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/upgrademon-process-skip-list.md).
