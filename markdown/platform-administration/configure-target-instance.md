...
5.  Choose an authentication method:
    ...
    -   **OAuth \(recommended\):** Select **Setup OAuth on Target** and follow the OAuth setup workflow. See [Set up OAuth authentication for a clone target](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/setup-clone-oauth.md) for detailed steps.
...
To submit a clone request to the registered target, see [Request a clone](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_StartAClone.md).
