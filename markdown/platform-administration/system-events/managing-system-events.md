...
-   [Create an event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-events/t_CreateYourOwnEvent.md)

    Create custom system events.

-   [Move an event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-events/move_event.md)

    Accelerate the execution process by moving high priority events from the default queue to an isolated queue.

-   [Pass event parameters from a work-flow to a notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-events/t_PassEventParameters.md)
...
-   [Reprocess an event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-events/t_ReprocessAnEvent.md)
...
For more information, see [System events reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/system-events/system-events-reference.md).
