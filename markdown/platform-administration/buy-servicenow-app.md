...
3.  Select **Request license**.
    ...
    A sales agent or your account executive contacts you by email to process the purchase. If the application uses the standard terms and conditions, it's available to install from the Application Manager within 24 hours of license confirmation.
