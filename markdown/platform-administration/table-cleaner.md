...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/table-cleaner.html
release: yokohama
topic_type: concept
...
For information on using table cleaner, see [Deleting older or unwanted records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/deleting-older-records.md).
