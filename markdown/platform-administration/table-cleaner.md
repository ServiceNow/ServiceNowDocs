...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/table-cleaner.html
release: australia
topic_type: concept
...
For information on using table cleaner, see [Deleting older or unwanted records in Core UI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/deleting-older-records.md).
