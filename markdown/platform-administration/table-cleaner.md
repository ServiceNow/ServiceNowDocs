...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/table-cleaner.html
release: xanadu
topic_type: concept
...
For information on using table cleaner, see [Deleting older or unwanted records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/deleting-older-records.md).
