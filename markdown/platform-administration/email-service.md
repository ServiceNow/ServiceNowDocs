...
By default, Email Service only allows admin users to access the [Email API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/email-api.md). Administrators can [grant access to the Email API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/grant-access-to-email-api.md) by:
...
Non-admin users with the email\_api\_send role can access the Email API from the [REST API Explorer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/use-REST-API-Explorer.md).
