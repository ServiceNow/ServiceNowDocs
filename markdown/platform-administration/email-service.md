...
By default, Email Service only allows admin users to access the Email API. Administrators can [grant access to the Email API](../task/grant-access-to-email-api.md) by:
