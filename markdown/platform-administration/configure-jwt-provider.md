...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/configure-jwt-provider.html
release: yokohama
topic_type: task
...
Create a JWT signing key to assign to your Java KeyStore \(JKS\) certificate. For more information, see [Configure a JWT signing key](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/authentication/JWT-Bearer-token-support.md).
...
[Generate a SHA-1 thumbprint](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/generate-thumbprint.md)

**Parent Topic:**[Configure an OAuth profile to use certificates for authentication with Microsoft Azure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/configure-oauth-profile-using-certificates.md)
