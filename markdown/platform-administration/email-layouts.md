...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/email-layouts.html
release: yokohama
topic_type: concept
...
**Note:** To display dynamic content such as mail scripts, use email templates. For more information, see [Create an email template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_CreateAnEmailTemplate.md).
...
-   **[Create an email layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/create-email-layout.md)**  
