...
1.  From the listing details, select **View Profile** to view the partner's contact information
2.  Contact the partner and request the application using the email address listed on the profile.

</td></tr></tbody>
</table>    If your purchase request is approved, a ServiceNow or partner sales representative contacts you by email to complete purchase and procurement.

5.  Follow the emailed instructions to complete the purchase and make the application available for installation.
