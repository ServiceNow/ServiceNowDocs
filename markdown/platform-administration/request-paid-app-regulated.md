...
4.  Select **Request App**.
    ...
    If your purchase request is approved, a sales representative or your account executive contacts you by email to complete purchase and procurement.

    If you have questions about a request for a ServiceNow application, contact your account executive. If you have questions about a request for an application provided by a partner, contact the seller directly using the information provided in their seller profile. For more information, see [Contact a seller](contact-seller.md).
