---
title: Upgrade Details related list
description: Upgrade Details lists all Upgrade Details records for this upgrade.
locale: en-US
release: xanadu
topic_type: concept
...
<table id="table_aqc_zyn_1p"><thead><tr><th>
...
[Upgrade History module: Track every upgrade](c_UpgradeHistory.md)

[Resolve a skipped update and set a resolution status](../task/t_ResolveASkippedUpdate.md)
