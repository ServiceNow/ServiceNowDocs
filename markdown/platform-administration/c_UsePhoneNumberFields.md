...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/c\_UsePhoneNumberFields.html
release: xanadu
topic_type: concept
...
\[Omitted image "PhoneE164.png"\] Alt text:

-   **[Territories assigned](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/c_TerritoriesAssigned.md)**  
Territories are assigned to locations, and are not assigned directly to users.
-   **[Dependent fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/c_SpecifyDependentFields.md)**  
...
-   **[E.164 phone number field configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/r_ConfigureE.164PhoneNumberFields.md)**  
Administrators can use the phone number system properties and dictionary attributes to do certain things.
-   **[Configure a territory phone display rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/t_ConfigATerritoryPhoneDisplRule.md)**  
