...
For more information on creating inbound email flows in Workflow Studio, see [Workflow Studio flow trigger types](https://www.servicenow.com/docs/access?context=flow-triggers&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US) or follow the steps in [Create a flow with an inbound email trigger](https://www.servicenow.com/docs/access?context=create-inbound-email-flow&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US). To view or manage your inbound email flows, navigate to **Flow Designer** &gt; **Inbound Email Flows**.
