...
![Email client](../image/email-client.png)
...
For more information on using the email client in a workspace, see [Communicating via email in workspace](https://www.servicenow.com/docs/access?context=using-email&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
