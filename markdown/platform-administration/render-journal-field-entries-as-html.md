...
breadcrumb: [Journal field type, Reference, Field administration, Forms, fields, and lists, Configure core features, Administer]
---
...
[General security settings properties](https://www.servicenow.com/docs/access?context=r_GeneralSecuritySettings&version=zurich&pubname=zurich-platform-security&ft:locale=en-US)

[HTML sanitizer](https://www.servicenow.com/docs/access?context=c_HTMLSanitizer&version=zurich&pubname=zurich-platform-security&ft:locale=en-US)
