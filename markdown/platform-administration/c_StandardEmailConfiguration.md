...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/c\_StandardEmailConfiguration.html
release: zurich
topic_type: concept
...
-   **[Enable basic email](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_ConfiguringStandardEmail.md)**  
Enable basic email to use ServiceNow - provided email servers and accounts.

**Parent Topic:**[Configure email administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/configuring-email-admin.md)
