...
description: Grandfathered and exempted custom tables are treated differently than other custom tables on your instance. Please refer to your organization’s ServiceNow contract for additional information.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/grandfathered-and-exempt-tables-v2.html
release: xanadu
...
If you have a combination of custom tables and grandfathered tables in one application, the grandfathered tables must be mapped to a grandfathered table subscription and the remaining custom tables to one other subscription. Open a case with Customer Service and Support for help with mapping a grandfathered table to a grandfather table subscription.
