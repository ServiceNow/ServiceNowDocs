...
The email client uses its own [email templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/c_EmailTemplates.md) to define default values for fields. Use the following sections in the Email Client Template form to build a client template:
...
<table id="choicetable_f3x_twt_pfc"><thead><tr><th align="left" id="d40150e499">

Type

</th><th align="left" id="d40150e502">

Description

</th></tr></thead><tbody><tr><td id="d40150e508">
...
3.  Fill in the fields to compose an email.
    ...
    See [Create an email client template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_CreateAnEmailClientTemplate.md) for field details.
