...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/list-of-plugins.html
release: yokohama
...
-   For steps on activating a plugin yourself, see [Activate a plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_ActivateAPlugin.md).
-   For steps on requesting a plugin that you cannot activate yourself, see [Request a plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_RequestAPlugin.md).
-   For steps on installing a ServiceNow Store application, see [Install a ServiceNow Store application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_InstallApplications.md).

**Note:** For a list of all new and changed plugins for this release, see [Changes to plugins in the Yokohama release](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/release-notes/plugin-changes.md).
...
-   [Source-to-Pay Operations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/source-to-pay-operations/source-to-pay-operations-overview.md)
...
Includes [indexed source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/indexed-sources-ais.md) definitions for ServiceNow AI Platform tables beyond those provided in the base system:-   Catalog Task \[sc\_task\]
