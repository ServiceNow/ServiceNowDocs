...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/list-of-plugins.html
release: zurich
...
-   For steps on activating a plugin yourself, see [Activate a plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_ActivateAPlugin.md).
-   For steps on requesting a plugin that you cannot activate yourself, see [Request a plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_RequestAPlugin.md).
-   For steps on installing a ServiceNow Store application, see [Install a ServiceNow Store application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/t_InstallApplications.md).

**Note:** For a list of all new and changed plugins for this release, see [Changes to plugins in the Zurich release](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/release-notes/plugin-changes.md).
...
Includes [indexed source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/indexed-sources-ais.md) definitions for ServiceNow AI Platform tables beyond those provided in the base system:-   Catalog Task \[sc\_task\]
