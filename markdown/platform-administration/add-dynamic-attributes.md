...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/add-dynamic-attributes.html
release: yokohama
topic_type: task
