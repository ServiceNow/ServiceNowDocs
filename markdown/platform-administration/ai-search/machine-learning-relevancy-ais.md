...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/machine-learning-relevancy-ais.html
release: yokohama
product: AI Search
...
**Note:** For details on the search query parameter evaluation framework used to perform A/B testing evaluations, see [Search query parameter evaluation framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/srch-qry-parm-eval-fw-ais.md).
