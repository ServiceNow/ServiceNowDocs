...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/machine-learning-relevancy-ais.html
release: xanadu
product: AI Search
...
**Note:** For details on the search query parameter evaluation framework used to perform A/B testing evaluations, see [Search query parameter evaluation framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/srch-qry-parm-eval-fw-ais.md).
