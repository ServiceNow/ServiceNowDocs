...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/dictionary-form-ais.html
release: yokohama
product: AI Search
...
-   **fieldname**: Exclude terms found in the specified AI Search index field, such as **title** or **text**. For details on AI Search index fields, see [AI Search index fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/index-fields-list-ais.md).
