...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/enable-byom-for-semnatic-indexing.html
release: xanadu
product: AI Search
