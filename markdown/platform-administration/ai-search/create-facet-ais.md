...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/create-facet-ais.html
release: xanadu
product: AI Search
...
4.  On the Facet form, fill in the fields.
    ...
    For a description of the field values, see [Facet form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/facet-form-ais.md).
