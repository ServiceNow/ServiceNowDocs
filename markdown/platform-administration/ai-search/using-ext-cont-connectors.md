...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/using-ext-cont-connectors.html
release: xanadu
product: AI Search
...
-   **[Define a crawl schedule for an external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/define-schedule-ext-cont-connector.md)**  
...
-   **[Run a one-time full or partial document crawl for an external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/run-doc-crawl-ext-cont-connector.md)**  
...
-   **[Run a one-time user mapping crawl for an external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/run-umap-crawl-ext-cont-connector.md)**  
...
-   **[Cancel a running external content connector crawl](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/cancel-ext-cont-connector-crawl.md)**  
...
-   **[Rename an external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/rename-ext-cont-connector.md)**  
Change the name of an existing external content connector.
-   **[Deactivate, reactivate, or delete an external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/deactivate-del-ext-cont-connector.md)**  
