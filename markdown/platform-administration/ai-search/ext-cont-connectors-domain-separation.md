...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/ext-cont-connectors-domain-separation.html
release: xanadu
product: AI Search
