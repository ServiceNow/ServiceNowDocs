...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/ext-cont-connectors-domain-separation.html
release: yokohama
product: AI Search
