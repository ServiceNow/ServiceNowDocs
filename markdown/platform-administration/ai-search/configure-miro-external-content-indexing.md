...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/configure-miro-external-content-indexing.html
release: yokohama
product: AI Search
...
-   The OAuth 2.0 application client ID that you copied in step [2.a](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-miro-external-content-indexing.md)
-   The OAuth 2.0 application client secret that you copied in step [2.b](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-miro-external-content-indexing.md)
...
For details on creating and configuring a Miro external content connector, see [Create a Miro external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-ext-cont-connector-miro.md).
