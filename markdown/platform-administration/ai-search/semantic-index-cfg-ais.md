...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/semantic-index-cfg-ais.html
release: yokohama
product: AI Search
...
-   **Chunking strategy and related parameters**
    ...
    The following image shows how a two-paragraph block of sample field value text might be broken into chunks for semantic indexing. As shown, chunks can contain multiple sentences and may span paragraph breaks found in the original text.\[Omitted image "chunking-text-example.png"\] Alt text: Two paragraphs of sample text and four multi-sentence text chunks identified when the text is semantically indexed.
...
-   **[Configure semantic indexing settings for an indexed source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-semantic-indexing-ais.md)**  
...
-   **[AI Search Retrieval Augmented Generation \(RAG\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/ais-rag.md)**  
