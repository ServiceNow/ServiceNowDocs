---
title: Create a Microsoft Teams external content connector
description: Create an external content connector to retrieve searchable content and security principals from your Microsoft Teams source system.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/create-ext-cont-connector-msteams.html
release: yokohama
product: AI Search
...
4.  On the Choose source page, select the **Microsoft Teams** tile, then select **Next**.
...
Unique name for this Microsoft Teams external content connector.
...
</table>    **Note:** The **Settings for regulated markets** connection settings aren't shown for Microsoft Teams connectors that you created in versions of External Content Connectors prior to version 4.0. Starting in External Content Connectors version 4.0, these connection settings are shown when you create a new Microsoft Teams external content connector.
...
8.  On the Crawl settings page, modify any default crawl settings that you want to override for this connector, then select **Next**.
    ...
    If you want to skip this step for now, select **Skip** instead of **Next**. You can modify the crawl settings for this connector from the External Content Admin Home page. For details on this procedure and the available crawl settings, see [Configure crawl settings for a Microsoft Teams external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-crawl-settings-msteams-ext-cont-connector.md).
...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for a Microsoft Teams external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-crawl-settings-msteams-ext-cont-connector.md).
...
**Parent Topic:**[Microsoft Teams external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/microsoft-teams-external-content-connector.md)
