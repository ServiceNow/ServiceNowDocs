...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/create-key-pair-box-external-content-connector.html
release: yokohama
product: AI Search
...
3.  Convert your new private key to the encrypted PKCS\#8 format \(with AES-256-CBC and PBKDF2\):
    ...
    2.  When prompted, enter the secure password you generated in step [2](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-key-pair-box-external-content-connector.md).
...
4.  Extract the public key for your new private key in PEM-encoded X.509 certificate format:
    ...
    2.  View or edit the content of the `public_key.pem` file that you generated in step [2](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-key-pair-box-external-content-connector.md).
