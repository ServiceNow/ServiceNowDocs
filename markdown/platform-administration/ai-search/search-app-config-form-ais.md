...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/search-app-config-form-ais.html
release: yokohama
product: AI Search
