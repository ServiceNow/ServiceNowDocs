...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/ais-admin-console-evam-viewusage.html
release: zurich
product: AI Search
...
Tracking the usage of view configuration enables you to do the following tasks:
...
2.  On the **Applications** tab, select the application card that you want track the usage of.
