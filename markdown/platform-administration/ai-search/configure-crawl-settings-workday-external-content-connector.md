...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/configure-crawl-settings-workday-external-content-connector.html
release: yokohama
product: AI Search
