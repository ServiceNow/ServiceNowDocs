...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/migrate-srch-apps-ais-next-exp.html
release: xanadu
product: AI Search
