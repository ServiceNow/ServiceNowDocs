...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/migrate-srch-apps-ais-next-exp.html
release: yokohama
product: AI Search
