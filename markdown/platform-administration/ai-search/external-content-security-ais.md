...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/ai-search/external-content-security-ais.html
release: australia
product: AI Search
...
For an overview of AI Search content security, see [Content security in AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/content-security-ais.md).
...
-   For an overview of specifying access permissions on external documents, see [Defining access permissions for external documents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/defining-access-perms-ext-docs-ais.md).
-   To learn about the set of access permissions supported for external content security, see [External content access permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/defining-access-perms-ext-docs-ais.md).
-   For details on special access permissions granted by certain user roles, see [Special external content access permissions by role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/defining-access-perms-ext-docs-ais.md).
...
-   For an overview of user mappings, see [Mapping external users and groups to ServiceNow AI Platform users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/user-mappings-ais.md).
-   To learn about the set of externally defined security principal types supported in user mappings, see [External user mapping security principal types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/user-mappings-ais.md).
-   For instructions on creating a table to store your user mappings, see [Create a user mapping table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/user-mappings-ais.md).
-   For instructions on linking your user mapping tables to external content indexed sources, see [Link a user mapping table to an external content indexed source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/user-mappings-ais.md).
-   To learn about importing user mappings via the [AI Search External User Mapping API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/api-reference/ext-user-mapping-api.md), see [Importing user mappings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/user-mappings-ais.md).
...
-   **[Defining access permissions for external documents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/defining-access-perms-ext-docs-ais.md)**  
...
-   **[Mapping external users and groups to ServiceNow AI Platform users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/user-mappings-ais.md)**  
