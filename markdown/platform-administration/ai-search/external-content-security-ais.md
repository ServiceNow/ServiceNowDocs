...
-   To learn about importing user mappings via the AI Search External User Mapping API, see [Importing user mappings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/user-mappings-ais.md).
