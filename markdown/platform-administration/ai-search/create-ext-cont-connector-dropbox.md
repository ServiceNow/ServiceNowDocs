...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/create-ext-cont-connector-dropbox.html
release: zurich
product: AI Search
...
A source system administrator must have already configured your Dropbox source system to allow access by the Dropbox external content connector. For the required source system configuration steps, see [Configure Dropbox for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-dropbox-external-content-indexing.md).
