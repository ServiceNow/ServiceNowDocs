...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/copy-evam-viewconfig-ais-admin-console.html
release: yokohama
product: AI Search
