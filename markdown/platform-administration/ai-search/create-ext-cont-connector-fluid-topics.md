...
A source system administrator must have already configured your Fluid Topics source system to allow access by the Fluid Topics external content connector. For the required source system configuration steps, see [Configure Fluid Topics for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-fluid-topics-external-content-indexing.md).
