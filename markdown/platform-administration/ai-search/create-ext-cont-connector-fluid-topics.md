...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for a Fluid Topics external content connector](configure-crawl-settings-fluid-topics-external-content-connector.md).
