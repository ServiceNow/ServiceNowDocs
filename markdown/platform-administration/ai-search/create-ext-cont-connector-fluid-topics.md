---
title: Create a Fluid Topics external content connector
description: Create an external content connector to retrieve searchable content and security principalsFor connectors that don't support user permission crawls, remove this phrase element. from your Fluid Topics source system.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/create-ext-cont-connector-fluid-topics.html
release: zurich
product: AI Search
...
# Create a Fluid Topics external content connector
...
A source system administrator must have already configured your Fluid Topics source system to allow access by the Fluid Topics external content connector. For details on configuring these settings in the source system, see [Configure Fluid Topics for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-fluid-topics-external-content-indexing.md).
...
4.  On the Choose source page, select the **Fluid Topics** tile, then select **Next**.
...
Unique name for this Fluid Topics external content connector.
...
URL for your Fluid Topics tenant. This is typically `https://<organization>.fluidtopics.net`, where `<organization>` is the name of your organization.If you don't have the portal URL, ask your Fluid Topics administrator for it.
...
API key used to authenticate requests to your Fluid Topics tenant.If you don't have the API key, ask your Fluid Topics administrator for it.
...
8.  On the Crawl settings page, modify any default crawl settings that you want to override for this connector, then select **Next**.
    ...
    If you want to skip this step for now, select **Skip** instead of **Next**. You can modify the crawl settings for this connector from the External Content Admin Home page. For details on this procedure and the available crawl settings, see [Configure crawl settings for a Fluid Topics external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-crawl-settings-fluid-topics-external-content-connector.md).
...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for a Fluid Topics external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-crawl-settings-fluid-topics-external-content-connector.md).
