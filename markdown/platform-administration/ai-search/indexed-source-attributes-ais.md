...
-   **true**: Enable indexing of attachments for this table.
-   **false**: Disable indexing of attachments for this table.
...
Control indexing behavior for translated reference fields from indexed records.
