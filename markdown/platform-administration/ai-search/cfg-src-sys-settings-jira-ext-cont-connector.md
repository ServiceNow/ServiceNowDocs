...
1.  Find the instance ID for your Atlassian Jira Cloud tenant.
    ...
    1.  Navigate to `https://<tenant-name>.atlassian.net/_edge/tenant_info`, replacing `<tenant-name>` with the name of your Atlassian Jira Cloud tenant.
    ...
    2.  Record the value of the `cloudId` JSON parameter in a secure location.
        ...
        **Important:** Your AI Search administrators need this instance ID value when configuring the Atlassian Jira Cloud external content connector.
