...
-   [User criteria](https://www.servicenow.com/docs/access?context=t_CreateAUserCriteriaRecord&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) for records indexed from the Knowledge \[kb\_knowledge\] and Catalog Item \[sc\_cat\_item\] tables
