...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/debug-ext-security-perms-user-ais.html
release: xanadu
product: AI Search
...
3.  Use the [Search Preview UI for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/ai-search-preview.md) to submit the external content search query of interest.
