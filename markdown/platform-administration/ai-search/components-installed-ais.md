...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/ai-search/components-installed-ais.html
release: australia
product: AI Search
...
List of entries showing indexed record counts for indexed sources. For more information on these entries, see [Review record counts for indexed sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/record-counts-indexed-sources-ais.md).
