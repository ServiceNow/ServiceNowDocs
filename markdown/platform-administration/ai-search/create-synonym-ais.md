...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/ai-search/create-synonym-ais.html
release: australia
product: AI Search
...
4.  On the Dictionary Term form, fill in the fields.
    ...
    For a description of the field values, see [Dictionary Term form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/dictionary-term-form-ais.md).
...
**Parent Topic:**[Synonyms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/synonyms-ais.md)
