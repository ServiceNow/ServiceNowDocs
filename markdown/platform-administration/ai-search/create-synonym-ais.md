...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/create-synonym-ais.html
release: xanadu
product: AI Search
...
You must have already created a synonym dictionary. For information on creating synonym dictionaries, see [Create a synonym dictionary linked to a search profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/create-synonym-dict-ais.md).
...
4.  On the Dictionary Term form, fill in the fields.
    ...
    For a description of the field values, see [Dictionary Term form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/dictionary-term-form-ais.md).
...
**Parent Topic:**[Synonyms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/synonyms-ais.md)
