...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/install-ais-next-experience-app.html
release: zurich
product: AI Search
...
If your instance was zBooted in Zurich, the AI Search for Next Experience application is already installed. You only need to install the application if you upgraded your instance from Tokyo or a previous release.
