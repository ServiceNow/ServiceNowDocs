...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/ais-admin-console-track-activity.html
release: yokohama
product: AI Search
...
3.  To view the full AI Search dashboard, select the **Go to full dashboard** link.
    ...
    For details on this dashboard's reports, see [AI Search dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/ai-search-dashboard.md).


-   **[AI Search activity reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/ais-admin-console-activity-reports.md)**  
