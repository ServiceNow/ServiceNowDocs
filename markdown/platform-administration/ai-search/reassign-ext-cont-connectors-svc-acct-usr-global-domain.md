...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/reassign-ext-cont-connectors-svc-acct-usr-global-domain.html
release: yokohama
product: AI Search
...
3.  On the User form, configure the layout to show the **Managed domain**, **Domain**, and **Domain Path** fields.
    ...
    To learn how to show or hide fields on a form, see [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-platform-administration/configure-form-layout.md).
