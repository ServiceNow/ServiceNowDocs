...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/predefined-websources-webcrawler-ext-cont-connector.html
release: yokohama
product: AI Search
...
|Atlassian Bitbucket|`https://support.atlassian.com/bitbucket-server/`|
|Atlassian Confluence Cloud|`https://support.atlassian.com/confluence-cloud/`|
|Atlassian Jira Cloud|`https://support.atlassian.com/jira-software-cloud/`|
|Atlassian Trello|`https://support.atlassian.com/trello/`|
...
|Microsoft Office|`https://learn.microsoft.com/en-us/office/`|
...
To create a Webcrawler external content connector, see [Create a Webcrawler external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-ext-cont-connector-webcrawler.md). To configure crawl settings for a Webcrawler external content connector, see [Configure crawl settings for a Webcrawler external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-crawl-settings-webcrawler-external-content-connector.md).

**Parent Topic:**[Webcrawler external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/webcrawler-external-content-connector.md)
