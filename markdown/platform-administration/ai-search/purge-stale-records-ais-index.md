...
For more information on running background scripts, see [Scripts - Background module](https://www.servicenow.com/docs/access?context=c_ScriptsBackground&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
