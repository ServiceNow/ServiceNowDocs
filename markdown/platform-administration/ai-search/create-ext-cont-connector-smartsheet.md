---
title: Create a Smartsheet external content connector
description: Create an external content connector to retrieve searchable content and security principals from your Smartsheet source system.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/create-ext-cont-connector-smartsheet.html
release: yokohama
product: AI Search
...
# Create a Smartsheet external content connector
...
A source system administrator must have already configured your Smartsheet source system to allow access by the Smartsheet external content connector. For details on configuring these settings in the source system, see [Configure Smartsheet for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-smartsheet-external-content-indexing.md).
...
4.  On the Choose source page, select the **Smartsheet** tile, then select **Next**.
...
Unique name for this Smartsheet external content connector.
...
URL for your Smartsheet domain, such as `https://example.smartsheet.com/`. If you don't have the domain URL, ask your Smartsheet administrator for it.
...
Value of an API key configured for a Smartsheet user account with administrator privileges. If you don't have the API key value, ask your Smartsheet administrator for it.
...
8.  On the Crawl settings page, modify any default crawl settings that you want to override for this connector, then select **Next**.
    ...
    If you want to skip this step for now, select **Skip** instead of **Next**. You can modify the crawl settings for this connector from the External Content Admin Home page. For details on this procedure and the available crawl settings, see [Configure crawl settings for a Smartsheet external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-crawl-settings-smartsheet-external-content-connector.md).
...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for a Smartsheet external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-crawl-settings-smartsheet-external-content-connector.md).
...
**Parent Topic:**[Smartsheet external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/smartsheet-external-content-connector.md)
