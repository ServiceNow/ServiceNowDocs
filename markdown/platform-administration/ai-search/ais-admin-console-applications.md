...
|Show/Hide Filter panel \[Omitted image "filter-panel-icon.png"\] Alt text:|Button to open filter conditions panel. Select the clear input icon \[Omitted image "icon-clear-input.png"\] Alt text: next to any defined conditions to remove them. Select **Restore defaults** to reset default filters, or **Advanced view** to define filter conditions. For more information, see .|
