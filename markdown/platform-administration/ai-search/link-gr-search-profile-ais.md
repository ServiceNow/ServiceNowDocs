...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/link-gr-search-profile-ais.html
release: yokohama
product: AI Search
...
4.  On the Search Profile - Genius Result Mapping form, fill in the fields.
    ...
    For a description of the field values, see [Search Profile - Genius Result Mapping form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/search-prof-gr-mapping-form-ais.md).
