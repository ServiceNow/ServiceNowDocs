...
For details on activating and enabling Document Viewer, see Enable Document Viewer. To learn more about EVAM property settings for search results, see [Configure EVAM display settings for search results in AI Search applications](../task/configure-search-result-card-opts.md).
