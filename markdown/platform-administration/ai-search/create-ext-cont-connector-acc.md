...
OAuth 2.0 client secret for the OAuth 2.0 Atlassian developer application that grants Confluence API access to your Atlassian Confluence Cloud source system. If you don't have this client secret, ask your Atlassian administrator for it.
    ...
    2.  In the **Use app on** field of the pop-up window, select the site that you specified the URL for in step [create-ext-cont-connector-acc.md\#connection-settings-step](create-ext-cont-connector-acc.md#connection-settings-step), then select **Accept**.
