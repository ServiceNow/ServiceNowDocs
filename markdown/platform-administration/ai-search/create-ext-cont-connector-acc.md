...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/create-ext-cont-connector-acc.html
release: zurich
product: AI Search
...
A source system administrator must have already configured your Atlassian Confluence Cloud source system to allow access by the Atlassian Confluence Cloud external content connector. For the required source system configuration steps, see [Configure Atlassian Confluence Cloud for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/cfg-conf-cc-ext-cont-connector.md).
...
OAuth 2.0 client secret for the OAuth 2.0 Atlassian developer application that grants Confluence API access to your Atlassian Confluence Cloud source system. If you don't have this client secret, ask your Atlassian administrator for it.
    ...
    2.  In the **Use app on** field of the pop-up window, select the site that you specified the URL for in step [https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/create-ext-cont-connector-acc.md](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/create-ext-cont-connector-acc.md), then select **Accept**.
