...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/configure-user-mapping-settings-external-content-connector.html
release: yokohama
product: AI Search
