...
**Note:** If your search administrator has deactivated sort options globally or for the search application, the sort menu doesn't appear and you can only see your search results in the default relevancy order.

## Procedure

1.  On the results page for your search, access the sort menu.

    -   In Now Mobile, select **Filter**, and then select **Sort by**.
    -   In other applications, select **Most relevant**.
    The sort menu shows the list of available sort options.

2.  Select the sort option that you want to apply to your current search result set.

    As an example, to show the most recently updated search results first, select **Most recent**.

    The search results page refreshes to display your results in the preferred order.
