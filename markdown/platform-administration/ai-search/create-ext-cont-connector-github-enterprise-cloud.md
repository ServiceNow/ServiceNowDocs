...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/create-ext-cont-connector-github-enterprise-cloud.html
release: zurich
product: AI Search
