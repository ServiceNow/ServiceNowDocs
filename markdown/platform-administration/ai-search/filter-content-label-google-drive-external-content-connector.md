...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/filter-content-label-google-drive-external-content-connector.html
release: zurich
product: AI Search
...
3.  Use the list editor to add the **google\_drive\_label\_include\_filter** property to the Advanced Configuration field value.
    ...
    To learn more about the list editor, see [Use the list editor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/t_UseTheListEditor.md).
