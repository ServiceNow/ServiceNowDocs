---
title: Create a GitLab external content connector
description: Create an external content connector to retrieve searchable content and security principals from your GitLab source system.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/create-ext-cont-connector-gitlab.html
release: yokohama
product: AI Search
...
# Create a GitLab external content connector
...
A source system administrator must have already configured your GitLab source system to allow access by the GitLab external content connector. For details on configuring these settings in the source system, see [Configure GitLab for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-gitlab-external-content-indexing.md).
...
4.  On the Choose source page, select the **Gitlab** tile, then select **Next**.
...
Unique name for this GitLab external content connector.
...
GitLab.com instance URL for your source system, in this format: `https://gitlab.com`. The GitLab external content connector crawls content from your groups, projects, and repositories found in this source system.
...
Authentication token for a GitLab.com user that owns all top-level groups you want the external content connector to crawl. If you don't have the authentication token, ask your GitLab administrator for it.
...
8.  On the Crawl settings page, modify any default crawl settings that you want to override for this connector, then select **Next**.
    ...
    If you want to skip this step for now, select **Skip** instead of **Next**. You can modify the crawl settings for this connector from the External Content Admin Home page. For details on this procedure and the available crawl settings, see [Configure crawl settings for a GitLab external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-crawl-settings-gitlab-external-content-connector.md).
...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for a GitLab external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-crawl-settings-gitlab-external-content-connector.md).
