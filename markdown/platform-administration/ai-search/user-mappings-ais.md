...
3.  Import user mappings into your user mapping tables with the [AI Search External User Mapping API](https://www.servicenow.com/docs/access?context=ext-user-mapping-api&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
...
For more information on importing user mappings, see [AI Search External User Mapping API](https://www.servicenow.com/docs/access?context=ext-user-mapping-api&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
...
AI Search creates an import set for each batch of user mappings that you import via the [AI Search External User Mapping API](https://www.servicenow.com/docs/access?context=ext-user-mapping-api&version=zurich&pubname=zurich-api-reference&ft:locale=en-US). The transform histories for these import sets provide insight into the results of your user mapping import operations.
