...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/create-ext-cont-connector-hubspot.html
release: zurich
product: AI Search
...
A source system administrator must have already configured your HubSpot source system to allow access by the HubSpot external content connector. For the required source system configuration steps, see [Configure HubSpot for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-hubspot-external-content-indexing.md).
