...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/create-ext-cont-connector-hubspot.html
release: yokohama
product: AI Search
...
Client secret for the legacy public app configured in your HubSpot source system that grants the connector access to your content. If you don't have the client secret, ask your HubSpot administrator for it.
...
**Parent Topic:**[HubSpot external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/hubspot-external-content-connector.md)
