...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/configure-github-enterprise-cloud-external-content-indexing.html
release: yokohama
product: AI Search
...
-   The client ID that you copied in step [2.a](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-github-enterprise-cloud-external-content-indexing.md).
-   The PEM-format private key certificate file that you downloaded in step [2.c](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-github-enterprise-cloud-external-content-indexing.md).
-   The app installation ID that you copied in step [4.d](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-github-enterprise-cloud-external-content-indexing.md).
