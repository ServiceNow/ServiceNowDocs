...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/create-ext-cont-connector-zendesk-guide.html
release: zurich
product: AI Search
...
breadcrumb: [Zendesk Guide external content connector, Configure, External Content Connectors, ServiceNow Store applications and integrations, AI Search, Search administration, Configure core features, Administer]
---
...
A source system administrator must have already configured your Zendesk source system to allow access by the Zendesk Guide external content connector. For details on configuring these settings in the source system, see [Configure Zendesk for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-zendesk-guide-external-content-indexing.md).
...
**Parent Topic:**[Zendesk Guide external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/zendesk-guide-external-content-connector.md)
