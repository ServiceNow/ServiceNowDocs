...
Now Assist Actions Genius Results send content from your search's most relevant Catalog Item records and Virtual Agent topic records to the LLM. The LLM ranks and filters the selected records' content for display.
...
</table>-   **[Dynamic Translation for Actions Genius Results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/dynamic-translation-na-actions-gr.md)**  
