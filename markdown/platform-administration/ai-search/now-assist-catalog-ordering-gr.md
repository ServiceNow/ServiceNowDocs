...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/now-assist-catalog-ordering-gr.html
release: xanadu
product: AI Search
...
In Service Portal, Now Assist Actions Genius Results only operate on Catalog Items. In Virtual Agent, Now Assist Actions Genius Results operate on Virtual Agent topics as well as on Catalog Items. To learn more about Virtual Agent topics, see .
...
When computing Now Assist Actions Genius Result answers for a search query, AI Search applies result improvement rules normally.
...
</table>-   **[Dynamic Translation for Now Assist Actions Genius Results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/dynamic-translation-na-actions-gr.md)**  
