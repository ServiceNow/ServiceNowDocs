...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/ai-search/now-assist-catalog-ordering-gr.html
release: australia
product: AI Search
...
The following table describes the interactions between Genius Results and other search features.
...
Interaction with Genius Results
...
When computing Genius Result answers for a search query, AI Search applies result improvement rules normally. The effects depend on the result improvement rule's action, as follows:

-   **block**: Genius Results don't return blocked records as answers.
-   **boost** or **promote**: Boosted and promoted records are more likely to be returned as Genius Result answers.
...
Genius Results use a blend of semantic vector search, which doesn't support stop words, and keyword-based search. AI Search only removes stop words from keyword-based searches, so Genius Result answers may not reflect your stop words settings.
...
Genius Results use a blend of semantic vector search, which doesn't support synonyms, and keyword-based search. AI Search expands synonyms in keyword-based searches, so your synonyms are likely to improve the relevancy of Genius Result answers.
...
</table>-   **[Dynamic Translation for Actions Genius Results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/dynamic-translation-na-actions-gr.md)**  
