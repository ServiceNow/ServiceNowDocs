...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/ais-admin-console-activity-reports.html
release: xanadu
product: AI Search
...
breadcrumb: [Track AI Search activity, Using the AI Search Admin console, AI Search Admin console, ServiceNow Store applications and integrations, AI Search, Search administration, Configure core features, Administer the ServiceNow AI Platform]
---
...
**Parent Topic:**[Track AI Search activity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/ais-admin-console-track-activity.md)
