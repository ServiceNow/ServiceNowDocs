...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/ai-search/field-settings-list-ais.html
release: australia
product: AI Search
...
For more information on creating field settings, see [Create a field setting for an AI Search indexed source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/create-field-setting-ais.md).
