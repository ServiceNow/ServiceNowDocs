...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/cfg-conf-cc-ext-cont-connector.html
release: xanadu
product: AI Search
...
1.  In the Atlassian Developer console, register a new OAuth 2.0 integration for the Atlassian Confluence Cloud external content connector.
    ...
    10. Navigate to the OAuth 2.0 integration's Settings page and record the Client ID and Secret values in a secure location.
        ...
        **Important:** Your ServiceNow AI Platform admins need these Client ID and Secret values when configuring the Atlassian Confluence Cloud external content connector.
...
2.  In Atlassian Administration, create a new admin API key.
    ...
    7.  Record the value of the API key in a secure location.
        ...
        **Important:** Your ServiceNow AI Platform admins need the API key's value when configuring the Atlassian Confluence Cloud external content connector.
...
-   The OAuth 2.0 integration's Client ID and Secret values that you recorded in step [1.j](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/cfg-conf-cc-ext-cont-connector.md).
-   The API key's value that you recorded in step [2.g](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/cfg-conf-cc-ext-cont-connector.md).

Your ServiceNow AI Platform admin needs these items to configure an Atlassian Confluence Cloud external content connector to retrieve searchable content and security principals from your Atlassian Confluence Cloud instance.

For details on creating and configuring an Atlassian Confluence Cloud external content connector, see [Create an Atlassian Confluence Cloud external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/create-ext-cont-connector-acc.md).
