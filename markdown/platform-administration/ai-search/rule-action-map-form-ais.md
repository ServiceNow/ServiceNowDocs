...
Name of a field from the selected indexed source. This field appears only when you select **Boost By User Context \(dynamic\)** or **Boost By Field Match \(static\)** as the boost type.
