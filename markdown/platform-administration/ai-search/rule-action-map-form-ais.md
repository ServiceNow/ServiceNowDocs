...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/ai-search/rule-action-map-form-ais.html
release: australia
product: AI Search
...
For information on configuring boost actions in result improvement rules, see [Boost search results using a result improvement rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/boost-results-ais.md).
