...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/synonyms-ais.html
release: yokohama
product: AI Search
...
-   Its length doesn't exceed the [dictionary term-length limit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/synonyms-ais.md).
...
</table>For more details on language support in synonym dictionaries, see [Language dependence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/synonyms-ais.md).
...
-   **[Create a synonym dictionary linked to a search profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-synonym-dict-ais.md)**  
Define a new synonym dictionary and link it to a search profile.
-   **[Create synonyms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-synonym-ais.md)**  
Define terms to treat as equivalent in search queries.
-   **[Clone a synonym dictionary](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/clone-synonym-dictionary-ais.md)**  
Create a copy of an existing synonym dictionary.
-   **[Link a synonym dictionary to a search profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/link-synonym-dict-profile-ais.md)**  
Link an existing synonym dictionary to one or more search profiles.
-   **[Unlink a synonym dictionary from a search profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/unlink-synonym-dict-ais.md)**  
Remove a synonym dictionary from a search profile.
-   **[Delete a synonym dictionary](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/delete-synonym-dict-ais.md)**  
