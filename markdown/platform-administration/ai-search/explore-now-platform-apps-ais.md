...
To learn more about configuring and enabling AI Search in supported ServiceNow AI Platform applications, see [Search application configurations](defining-search-app-cfgs-ais.md) and [Enabling and configuring AI Search in ServiceNow AI Platform applications](enable-configure-apps-ais.md).
