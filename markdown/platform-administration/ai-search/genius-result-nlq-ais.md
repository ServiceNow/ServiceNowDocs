...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/genius-result-nlq-ais.html
release: xanadu
product: AI Search
...
-   Natural language queries similar to the ones made using Analytics Center. To learn more about Analytics Center table query capabilities, see [Analytics Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/analytics-center.md).
...
For more information about NLQ processing, see [Natural Language Query](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/intelligent-experiences/natural-language-query/natural-language-query.md).
...
-   If the table was found by a CMDB table query, the system displays it in the [CMDB Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/configuration-management-database-cmdb/cmdb-workspace.md).

Search administrators can customize these actions. For more information, see the [Configure navigation actions for NLQ Genius Result answer cards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/configure-nav-action-nlq-grs.md) section.
...
-   **[Display NLQ Genius Result answers in Service Portal search applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/display-nlq-gr-service-portal-apps.md)**  
...
-   **[Configure navigation actions for NLQ Genius Result answer cards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/configure-nav-action-nlq-grs.md)**  
...
-   **[System properties for NLQ Genius Results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/sys-properties-nlq-gr.md)**  
