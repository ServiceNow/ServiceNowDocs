...
-   Crawl only a specified set of teams from the source system
...
4.  Specify the connector's crawl scope by selecting one of the following **Teams to crawl** options:
