---
title: ServiceNow Otto for AI Search properties
description: System properties that you can use to modify behavior for ServiceNow Otto for AI Search Genius Results.
locale: en-US
...
Operational mode for the Q&amp;A Genius Results caches. Use this mode to control how AI Search uses the caches and the Now LLM Service when looking for Q&amp;A Genius Result answers. For details about how AI Search caches Q&amp;A Genius Result answers, see [Caching for Knowledge base articles Genius Results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/ai-search/caching-now-assist-q-a-gr.md).
...
Maximum time in seconds to wait for Knowledge base articles Genius Result answer generation results from the LLM.-   Type: integer
-   Default value: 120
-   Location: Not present in the System Property \[sys\_properties\] table by default. To override the default value, add this property by following the steps in [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_AddAPropertyUsingSysPropsList.md).
...
Case-insensitive Java regular expression pattern that defines searches eligible for Q&amp;A answer generation. As an example, the pattern `^(what|where|when|why|who|whom|which|how)\b` restricts eligibility to search queries that begin with one of the specified keywords. When this system property has a value defined, only searches in supported applications that match the specified pattern are eligible for Q&amp;A answer generation.
...
Option to remove HTML tags from knowledge article text before sending to the LLM for Knowledge base articles Genius Result answer generation. -   Type: true \| false
-   Default value: false
-   Location: Not present in the System Property \[sys\_properties\] table by default. To override the default value, add this property by following the steps in [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/t_AddAPropertyUsingSysPropsList.md).
