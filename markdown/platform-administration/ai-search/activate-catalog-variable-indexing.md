...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/platform-administration/ai-search/activate-catalog-variable-indexing.html
release: brazil
product: AI Search
...
For details on the catalog variable types that AI Search can index content from, see [Variable types supported by AI Search indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/ai-search/variable-types-ais-index.md).
