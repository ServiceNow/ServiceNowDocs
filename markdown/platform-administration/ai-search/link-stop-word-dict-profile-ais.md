...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/ai-search/link-stop-word-dict-profile-ais.html
release: australia
product: AI Search
...
4.  On the Search Profile - Dictionary Mapping form, select the stop word dictionary and search profile to link.
    ...
    For a description of the field values, see [Search Profile - Dictionary Mapping form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/search-prof-dict-mapping-form-ais.md).
...
**Parent Topic:**[Stop words](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/stop-words-ais.md)
