...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/ais-admin-console-create-indexed-source.html
release: xanadu
product: AI Search
