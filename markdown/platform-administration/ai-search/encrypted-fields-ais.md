...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/encrypted-fields-ais.html
release: yokohama
product: AI Search
...
For detailed descriptions of the encryption options available for source records, see [Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/servicenow-ai-platform-security/encryption.md).
