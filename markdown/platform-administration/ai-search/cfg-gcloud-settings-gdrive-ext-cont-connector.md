...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/cfg-gcloud-settings-gdrive-ext-cont-connector.html
release: yokohama
product: AI Search
...
1.  Enable the Google Drive and Admin SDK APIs for your selected project.
    ...
    6.  Repeat steps [1.c](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/cfg-gcloud-settings-gdrive-ext-cont-connector.md) through [1.e](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/cfg-gcloud-settings-gdrive-ext-cont-connector.md), but this time locate, select, and enable the **Admin SDK API**.
...
4.  Activate domain-wide delegation in Google Admin for your new Google Cloud service account.
    ...
    6.  In the **Client ID** field, enter the service account's OAuth 2 Client ID that you copied in step [4.a](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/cfg-gcloud-settings-gdrive-ext-cont-connector.md).
...
-   The JSON private key file for the Google Cloud service account that you downloaded in step [3.e](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/cfg-gcloud-settings-gdrive-ext-cont-connector.md).
...
For details on creating and configuring a Google Drive external content connector, see [Create a Google Drive external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-ext-cont-connector-gdrive.md).
