...
For more information on NLU vocabulary sources, see [NLU vocabulary](https://www.servicenow.com/docs/access?context=using-nlu-vocabulary&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
