...
For more information on NLU vocabulary sources, see [NLU vocabulary](https://www.servicenow.com/docs/access?context=using-nlu-vocabulary&version=xanadu&pubname=xanadu-intelligent-experiences&ft:locale=en-US).
