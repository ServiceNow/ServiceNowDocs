...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/create-genius-results-config-ais.html
release: yokohama
product: AI Search
...
4.  On the AI Search Genius Result Configuration form, fill in the fields.
    ...
    For a description of the field values, see [AI Search Genius Result Configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/genius-result-cfg-form-ais.md).
