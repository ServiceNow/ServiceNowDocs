...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/ai-search/create-genius-results-config-ais.html
release: australia
product: AI Search
...
4.  On the AI Search Genius Result Configuration form, fill in the fields.
    ...
    For a description of the field values, see [AI Search Genius Result Configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/platform-administration/ai-search/genius-result-cfg-form-ais.md).
