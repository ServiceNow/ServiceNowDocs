...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/create-genius-results-config-ais.html
release: xanadu
product: AI Search
...
4.  On the AI Search Genius Result Configuration form, fill in the fields.
    ...
    For a description of the field values, see [AI Search Genius Result Configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/genius-result-cfg-form-ais.md).
