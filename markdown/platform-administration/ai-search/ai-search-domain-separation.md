...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/ai-search-domain-separation.html
release: xanadu
product: AI Search
...
Create a **dot\_walk\_fields** field setting for the reference field, specifying the `sys_domain,sys_domain_path` domain fields as the attribute value. For full steps for this task, see [Enable automatic domain updates for a referenced table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/enable-ref-auto-domain-update-ais.md).

</td></tr></tbody>
</table>-   **[Enable automatic domain updates for a referenced table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/enable-ref-auto-domain-update-ais.md)**  
