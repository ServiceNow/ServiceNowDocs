---
title: Create an Asana external content connector
description: Create an external content connector to retrieve searchable content and security principals from your Asana source system.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/create-ext-cont-connector-asana.html
release: zurich
product: AI Search
...
breadcrumb: [Asana external content connector, Configure, External Content Connectors, ServiceNow Store applications and integrations, AI Search, Search administration, Configure core features, Administer]
---

# Create an Asana external content connector
...
A source system administrator must have already configured your Asana source system to allow access by the Asana external content connector. For details on configuring these settings in the source system, see [Configure Asana for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-asana-external-content-indexing.md).
...
4.  On the Choose source page, select the **Asana** tile, then select **Next**.
...
Unique name for this Asana external content connector.
...
Client ID for the OAuth 2.0 Asana application that grants the connector access to your Asana content. If you don't have the client ID, ask your Asana administrator for it.
...
Client secret for the OAuth 2.0 Asana application that grants the connector access to your Asana content. If you don't have the client secret, ask your Asana administrator for it.
...
8.  On the Crawl settings page, modify any default crawl settings that you want to override for this connector, then select **Next**.
    ...
    If you want to skip this step for now, select **Skip** instead of **Next**. You can modify the crawl settings for this connector from the External Content Admin Home page. For details on this procedure and the available crawl settings, see [Configure crawl settings for an Asana external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-crawl-settings-asana-external-content-connector.md).
...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for an Asana external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-crawl-settings-asana-external-content-connector.md).
