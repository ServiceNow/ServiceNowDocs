...
A source system administrator must have already configured your Asana source system to allow access by the Asana external content connector. For details on configuring these settings in the source system, see [Configure Asana for external content indexing](configure-asana-external-content-indexing.md).
...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for an Asana external content connector](configure-crawl-settings-asana-external-content-connector.md).
