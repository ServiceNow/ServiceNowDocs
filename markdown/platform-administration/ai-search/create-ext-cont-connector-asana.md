...
A source system administrator must have already configured your Asana source system to allow access by the Asana external content connector. For the required source system configuration steps, see [Configure Asana for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-asana-external-content-indexing.md).
