...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/mirror-result-improvement-rules.html
release: xanadu
product: AI Search
...
You must have [Now Assist in AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/now-assist-ais.md) installed.
...
5.  To make your mirror source changes take effect, publish your modified mirror target search profile.
    ...
    For details on publishing a search profile, see [Publish an AI Search search profile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/publish-search-profile-ais.md).
