...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/configure-crawl-settings-jira-ext-cont-connector.html
release: yokohama
product: AI Search
