...
-   [Now Assist in Virtual Agent](https://www.servicenow.com/docs/access?context=now-assist-in-va-landing&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US) is installed.
-   Enhanced chat is activated via the Now Assist panel. For details on activating enhanced chat, see [Activate Now Assist panel enhanced chat](https://www.servicenow.com/docs/access?context=now-assist-panel-enhanced-activate&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
...
To learn about Now Assist in Virtual Agent enhanced chat, see [Enhanced chat](https://www.servicenow.com/docs/access?context=nava-enhanced-chat&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US).
