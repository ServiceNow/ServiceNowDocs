...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/create-ext-cont-connector-trello.html
release: yokohama
product: AI Search
