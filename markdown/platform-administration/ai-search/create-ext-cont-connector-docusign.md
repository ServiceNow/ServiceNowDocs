...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/create-ext-cont-connector-docusign.html
release: yokohama
product: AI Search
...
A source system administrator must have already configured your Docusign source system to allow access by the Docusign external content connector. For details on configuring these settings in the source system, see [Configure Docusign for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-docusign-external-content-indexing.md).
...
Docusign authentication endpoint URL for the connector. This URL depends on which environment you want the connector to crawl:

-   For a development environment: `https://account-d.docusign.com`
-   For a production environment: `https://account.docusign.com`
 To learn more about endpoint URLs for development and production Docusign environments, see the [https://developers.docusign.com/platform/api-endpoint-base-paths/](https://developers.docusign.com/platform/api-endpoint-base-paths/) resource.
