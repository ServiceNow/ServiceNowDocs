...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/search-preview-ui-new-admin-tools.html
release: zurich
product: AI Search
...
breadcrumb: [Search Preview UI, Administer, AI Search, Search administration, Configure core features, Administer]
---
...
The Summary tool \[Omitted image "search-preview-new-icon-summary.png"\] Alt text: displays these sections:
...
The Details tool \[Omitted image "search-preview-new-icon-details.png"\] Alt text: displays these sections:
...
The Profile tool \[Omitted image "search-preview-new-icon-summary.png"\] Alt text: displays these sections:
...
**Parent Topic:**[Search Preview UI for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/search-preview-ui-new.md)
