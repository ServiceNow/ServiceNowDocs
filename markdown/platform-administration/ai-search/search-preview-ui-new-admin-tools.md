...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/search-preview-ui-new-admin-tools.html
release: xanadu
product: AI Search
...
The Data tool \[Omitted image "search-preview-new-icon-process-data.png"\] Alt text: displays summary information on the search query's triggered result improvement rules, matched NLU model intents, and processing time. These entries provide an overview of how the search query performed.
...
The Alert tool \[Omitted image "search-preview-new-icon-alerts.png"\] Alt text: displays any alert feedback messages produced while processing the search query.

## Feedback tool

The Feedback tool \[Omitted image "search-preview-new-icon-feedback.png"\] Alt text: displays any dictionary or query feedback messages or NLU model intent data produced while processing the search query.
...
The Context tool \[Omitted image "search-preview-new-icon-context.png"\] Alt text: provides fields you can use to specify user context values. Use these fields when testing user context triggers for your result improvement rules.
...
To set a role in the user context for search preview, enter the name of a role from the Role \[sys\_user\_role\] table and press Enter.
 ...
 You can set multiple roles for a single search query. Each selected role appears as a pill. To remove a role, select the Remove icon \[Omitted image "search-preview-new-icon-pill-remove.png"\] Alt text: for its pill.
...
To set an office state in the user context for search preview, enter it in this field. You can enable [session debugging for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/session-debugging-ais.md) to review values submitted for this user context field in user queries.
...
To set an operating system in the user context for search preview, enter its name in this field. You can enable [session debugging for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/session-debugging-ais.md) to review values submitted for this user context field in user queries.
...
To set a user device type in the user context for search preview, enter it in this field. You can enable [session debugging for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/session-debugging-ais.md) to review values submitted for this user context field in user queries.
...
To set an operating system version in the user context for search preview, enter it in this field. You can enable [session debugging for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/session-debugging-ais.md) to review values submitted for this user context field in user queries.
...
To set a web browser's user-agent string in the user context for search preview, enter it in this field. You can enable [session debugging for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/session-debugging-ais.md) to review values submitted for this user context field in user queries.
...
To set a browser name in the user context for search preview, enter it in this field. You can enable [session debugging for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/session-debugging-ais.md) to review values submitted for this user context field in user queries.
...
To set a device form in the user context for search preview, enter it in this field. You can enable [session debugging for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/session-debugging-ais.md) to review values submitted for this user context field in user queries.

</td></tr></tbody>
</table>## User tool

The User tool \[Omitted image "search-preview-new-icon-user.png"\] Alt text: provides fields you can use to search as a specific user or in a specific supported language. Use these fields to see how search results differ from user to user and language to language.
...
</table>**Parent Topic:**[Search Preview UI for AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/search-preview-ui-new.md)
