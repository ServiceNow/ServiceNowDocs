...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/activate-3p-embedding-model.html
release: yokohama
product: AI Search
