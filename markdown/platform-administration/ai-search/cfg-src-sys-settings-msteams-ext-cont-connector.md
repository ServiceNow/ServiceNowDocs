...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/cfg-src-sys-settings-msteams-ext-cont-connector.html
release: xanadu
product: AI Search
...
3.  Add the API permissions required by the Microsoft Teams external content connector.
    ...
    3.  For each of the following permissions, enter the permission name into the **Select permissions** search field, then locate and select the option for the permission.
        ...
        -   Sites.Read.All
            ...
            **Note:** The Microsoft Teams external content connector only uses the Sites.Read.All permission to perform automatic site discovery for crawl configuration and one-time crawls. If you plan to specify the sites to crawl manually, you don't need to select this permission. For more information on specifying sites for the connector to crawl, see [Configure crawl settings for the Microsoft Teams external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/configure-crawl-settings-msteams-ext-cont-connector.md). To learn more about one-time crawls, see [Run a one-time full or partial document crawl for an external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/run-doc-crawl-ext-cont-connector.md).
...
-   The OAuth 2.0 application's tenant ID and client ID that you recorded in step [2](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/cfg-src-sys-settings-msteams-ext-cont-connector.md).
-   The DER-encoded binary X.509 format public key certificate's SHA1 thumbprint hash that you recorded in step [5.f](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/cfg-src-sys-settings-msteams-ext-cont-connector.md).
...
For details on creating and configuring a Microsoft Teams external content connector, see [Create a Microsoft Teams external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/create-ext-cont-connector-msteams.md).

-   **[Create a public/private key pair for the Microsoft Teams external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/gen-cert-msteams-ext-cont-connector.md)**  
