...
breadcrumb: [AI Search logging and debugging, Administer, AI Search, Search administration, Configure core features, Administer]
---
...
Once enabled, session debugging remains active for the user session until you disable it. For more information on session debugging, see [Session debug](https://www.servicenow.com/docs/access?context=c_SessionDebug&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
