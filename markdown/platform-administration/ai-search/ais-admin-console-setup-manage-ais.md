...
<table id="choicetable_s2z_q1p_f2c"><thead><tr><th align="left" id="d321126e195">

Option

</th><th align="left" id="d321126e198">

Procedure

</th></tr></thead><tbody><tr><td id="d321126e204">
...
3.  Select **Link to application name**.
    ...
    4.  Populate one or more Genius Result cards with concise, actionable answers that are derived from the relevant search results by linking AI Search Genius results configurations to your search profile.
        ...
        A search profile can include multiple Genius Result configuration links. ![image.ais-admin-gr]
...
<table id="choicetable_c42_rxp_f2c"><thead><tr><th align="left" id="d321126e630">

Option

</th><th align="left" id="d321126e633">

Procedure

</th></tr></thead><tbody><tr><td id="d321126e639">
