...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/ais-admin-console-setup-manage-ais.html
release: zurich
product: AI Search
...
<table id="choicetable_s2z_q1p_f2c"><thead><tr><th align="left" id="d395445e224">

Option

</th><th align="left" id="d395445e227">

Procedure

</th></tr></thead><tbody><tr><td id="d395445e233">
...
3.  Select **Link to application name**.
    ...
    1.  Add Search sources to a search profile to make your searchable content available for your users.
        ...
        -   Link an existing AI Search search source:
            ...
            3.  Select **Link**.
        For more information, see [Search sources in AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/search-sources-ais.md).
    ...
    2.  Define the language-specific dictionaries of terms, such as equivalent terms \(synonyms\), common terms, and spell check.
        ...
        -   Link an existing AI Search term:
            ...
            3.  Select **Link**.
            For more information, see [Search profiles in AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/defining-search-profiles-ais.md).
    ...
    3.  Define the Result improvement rules to boost, block, or promote the search results for specific search queries.
        ...
        5.  Select **Update**.
        6.  In the Search Personalization section, select the **Enable** button to turn on search personalization.

            It connects Result Improvement Rules \(RIRs\) and the dictionary to the search profile to deliver personalized, context-aware search results.

        For more information, see [Result improvement rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/result-improvement-rules-ais.md).
    ...
    4.  Populate one or more Genius Result cards with concise, actionable answers that are derived from the relevant search results by linking AI Search Genius results configurations to your search profile.
        ...
        A search profile can include multiple Genius Result configuration links \(such as Now Assist Multi-Content Response, Q&amp;A, Catalog item, NLQ, and more\). \[Omitted image "ais-adminconsole-gr.png"\] Alt text: AI Search Admin console Genius Results view in the basic configuration.
        ...
        1.  On the **Genius Results Configuration** tab, enable base system genius results for your search profile from the list of genius result configuration options.
            ...
            **Note:** To enable Now Assist Multi-Content Response genius result, ensure that your workspace profile includes minimum one knowledge article, catalog, or skill.

        2.  Select **Save**.
        For more information, see [Genius Result configurations in the base system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/default-genius-result-configs-ais.md).
...
<table id="choicetable_c42_rxp_f2c"><thead><tr><th align="left" id="d395445e686">

Option

</th><th align="left" id="d395445e689">

Procedure

</th></tr></thead><tbody><tr><td id="d395445e695">
...
3.  Select **Link to application name**.
...
</table>    Each search application configuration contains the settings that determine how search results are displayed to users of the application. The search application configuration settings include Auto-complete, Search source facet buckets, Sort options, Facet filters, Result-card interface, and Review &amp; finish.
    ...
    1.  Display the intelligent suggestions in your search application's input field by adding auto-complete suggestions to the search application configuration.
        ...
        -   Create a suggestion:
            ...
            2.  On the form, fill in the fields.
                ...
                For a description of the field values, see [Suggestion Reader Group form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/sugg-reader-group-form-ais.md).
        ...
        -   Link an existing suggestion to the search application:
            ...
            3.  Select **Link**.
        For more information, see [Auto-complete suggestions in AI Search applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/auto-complete-ais.md).
    ...
    2.  Edit the display settings for search source facet buckets to help users navigate within the search application to access and manage information.
        ...
        **Note:** AI Search automatically defines the search source facet buckets for search application configurations. You can't create or delete these search source facet buckets.
    ...
    4.  Define the facets to filter your searches by using categories that are dynamically generated from the current search results \(such as filtering the search results based on the dates or keywords\).
        ...
        2.  On the form, fill in the fields.
            ...
            For a description of the field values, see [Facet form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/facet-form-ais.md).
...
2.  In the **Configuration name** field, enter the name.
            ...
            For more information, see [Create or edit an EVAM view definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/ais-admin-console-evam-configurations.md).
