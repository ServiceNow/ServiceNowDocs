...
1.  Set your current application scope context to Advanced AI Search Management Tools using [the application picker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_SelectAnAppFromTheAppPicker.md).
