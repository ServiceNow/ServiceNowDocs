...
To learn more about searching with fuzzy numeric search, see [Fuzzy numeric search in AI Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/ai-search/fuzzy-numeric-search.md).
