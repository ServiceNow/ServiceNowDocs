...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/explore-features-search-ais.html
release: zurich
product: AI Search
...
-   **Powerful query language**
    ...
    For a complete guide to supported query language syntax and operators, see [AI Search query language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/query-language-ais.md).
