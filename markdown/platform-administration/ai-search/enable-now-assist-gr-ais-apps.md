...
3.  In each search profile row, select the options for the individual Now Assist Genius Results you want to enable for the associated AI Search portal or mobile application.
    ...
    As an example, to enable Now Assist Multi-Content Response Genius Results in Service Portal, select the **Now Assist Multi-Content Response** option in the **Service Portal Default Search Profile** row.
