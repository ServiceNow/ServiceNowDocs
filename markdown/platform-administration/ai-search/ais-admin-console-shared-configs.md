...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/ais-admin-console-shared-configs.html
release: yokohama
product: AI Search
...
keywords: [AI, Search, Admin, Console, Shared, Configurations]
...
|Field|Description|
|-----|-----------|
|Refresh list \[Omitted image "refresh-list-icon.png"\] Alt text:|Button to refresh list of table entries.|
...
For further information on using these tables, see [Create an AI Search configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/ais-admin-console-create-config.md).
