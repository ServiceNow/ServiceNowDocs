...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/ais-admin-console-shared-configs.html
release: xanadu
product: AI Search
...
\[Omitted image "ais-admin-03.png"\] Alt text: AI Search Admin Console Shared Configurations Summary view with 3 callouts highlighted. For a text description, see the table that follows.
...
For further information on using these tables, see [Create an AI Search configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/ais-admin-console-create-config.md).
