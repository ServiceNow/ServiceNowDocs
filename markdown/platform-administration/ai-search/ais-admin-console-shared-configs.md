...
![AI Search Admin Console Shared Configurations Summary view with 3 callouts highlighted. For a text description, see the table that follows.](../image/ais-admin-03.png "AI Search Admin Console Shared Configurations")
...
-   Search indexes \[ais\_datasource\] table
