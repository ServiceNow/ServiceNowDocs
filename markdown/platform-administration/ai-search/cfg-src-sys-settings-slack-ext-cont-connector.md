...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/cfg-src-sys-settings-slack-ext-cont-connector.html
release: yokohama
product: AI Search
...
-   The Slack API application client ID and client secret that you recorded in step [6](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/cfg-src-sys-settings-slack-ext-cont-connector.md).
...
For details on creating and configuring a Slack external content connector, see [Create a Slack external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-ext-cont-connector-slack.md).
