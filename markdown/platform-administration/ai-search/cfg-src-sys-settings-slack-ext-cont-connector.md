...
Your search administrators need the Slack API application's client ID and secret to configure the Slack external content connector for proper connection to your Slack source system.
