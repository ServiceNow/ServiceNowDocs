...
2.  For each Knowledge article search language that you want to map to a country, create a new record in the table.
    ...
    2.  On the AI Search Country To Search Language form, fill in the fields.
        ...
        For a description of the field values, see [AI Search Country To Search Language form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/ai-search/ais-country-kb-srch-lang-form.md).
