...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/configure-box-external-content-indexing.html
release: yokohama
product: AI Search
...
-   The public key ID string that you copied in step [2.f](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-box-external-content-indexing.md).
-   The JSON-format settings file that you downloaded in step [2.g](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-box-external-content-indexing.md).
...
For details on creating and configuring a Box Cloud external content connector, see [Create a Box external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-ext-cont-connector-box.md).
