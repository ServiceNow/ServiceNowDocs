...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/grant-perms-azure-ext-cont-qna-grs.html
release: xanadu
product: AI Search
...
2.  Add an AllSites.FullControl SharePoint API delegated permission to your OAuth 2.0 application.
    ...
    1.  In the left panel, select **Manage** &gt; **API permissions**.
