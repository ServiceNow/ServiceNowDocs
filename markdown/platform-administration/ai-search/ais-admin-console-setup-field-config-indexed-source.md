...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/ais-admin-console-setup-field-config-indexed-source.html
release: yokohama
product: AI Search
