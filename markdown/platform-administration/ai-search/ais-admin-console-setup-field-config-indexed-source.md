...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/ais-admin-console-setup-field-config-indexed-source.html
release: xanadu
product: AI Search
...
To make the new field configurations take effect, perform a full table reindex for the indexed source. For more information, [Index the content from an indexed source for searchability](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/ais-admin-console-start-content-indexing.md) see

**Parent Topic:**[Managing the indexed sources from the AI Search Admin console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/ai-search/ais-managing-indexed-source.md)
