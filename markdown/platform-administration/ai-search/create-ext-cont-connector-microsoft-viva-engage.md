...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/ai-search/create-ext-cont-connector-microsoft-viva-engage.html
release: zurich
product: AI Search
