...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/ext-usr-map-idx-src-form-ais.html
release: yokohama
product: AI Search
...
For details on linking a user mapping table to an indexed source for external content, see [Mapping external users and groups to ServiceNow AI Platform users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/user-mappings-ais.md).
