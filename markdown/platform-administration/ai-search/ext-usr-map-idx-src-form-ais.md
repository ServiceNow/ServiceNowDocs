...
description: The AI Search External Search User Mapping Table Data Source Relationship form enables you to link a user mapping table to an indexed source for external content in AI Search.
locale: en-US
...
For details on linking a user mapping table to an indexed source for external content, see [Mapping external users and groups to ServiceNow AI Platform users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/ai-search/user-mappings-ais.md).
