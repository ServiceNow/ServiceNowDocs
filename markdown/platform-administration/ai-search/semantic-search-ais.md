...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/semantic-search-ais.html
release: xanadu
product: AI Search
...
By default, AI Search uses keyword search, meaning that it finds results for records that contain literal matches for the keywords \(terms\) in your search query. Starting in the Vancouver Patch 4 release, AI Search includes an alternate search mode called semantic vector search that's used in features which work with the Now LLM Service. Examples of such features include Now Assist in Virtual Agent conversations, Now Assist Q&amp;A Genius Results, and Now Assist Actions Genius Results.
