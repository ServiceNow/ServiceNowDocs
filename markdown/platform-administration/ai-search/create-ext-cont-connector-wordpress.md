...
A source system administrator must have already configured your WordPress source system to allow access by the WordPress external content connector. For the required source system configuration steps, see [Configure WordPress for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/ai-search/configure-wordpress-external-content-indexing.md).
