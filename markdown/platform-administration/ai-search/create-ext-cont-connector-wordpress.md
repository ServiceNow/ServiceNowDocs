---
title: Create a WordPress external content connector
description: Create an external content connector to retrieve searchable content and security principals from your WordPress source system.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/ai-search/create-ext-cont-connector-wordpress.html
release: yokohama
product: AI Search
...
# Create a WordPress external content connector
...
A source system administrator must have already configured your WordPress source system to allow access by the WordPress external content connector. For details on configuring these settings in the source system, see [Configure WordPress for external content indexing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-wordpress-external-content-indexing.md).
...
4.  On the Choose source page, select the **WordPress** tile, then select **Next**.
...
Unique name for this WordPress external content connector.
...
URL for your WordPress website. If you don't have the WordPress website URL, ask your WordPress administrator for it.
...
User name for the administrator user configured for your WordPress source system. If you don't have the user name for the administrator user, ask your WordPress administrator for it.
...
Application password for the administrator user configured for your WordPress source system. If you don't have the application password for the administrator user, ask your WordPress administrator for it.
...
8.  On the Crawl settings page, modify any default crawl settings that you want to override for this connector, then select **Next**.
    ...
    If you want to skip this step for now, select **Skip** instead of **Next**. You can modify the crawl settings for this connector from the External Content Admin Home page. For details on this procedure and the available crawl settings, see [Configure crawl settings for a WordPress external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-crawl-settings-wordpress-external-content-connector.md).
...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for a WordPress external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/configure-crawl-settings-wordpress-external-content-connector.md).
-   For details on creating crawls for your new connector, see [Create a content crawl for an external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-content-crawl-external-content-connector.md) and [Create a user permission crawl for an external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/create-user-mapping-crawl-external-content-connector.md).
...
**Parent Topic:**[WordPress external content connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/ai-search/wordpress-external-content-connector.md)
