---
title: Configure crawl settings for the Atlassian Confluence Cloud external content connector
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/ai-search/configure-crawl-settings-cc-ext-cont-connector.html
release: xanadu
product: AI Search
...
# Configure crawl settings for the Atlassian Confluence Cloud external content connector
...
-   Crawl only a specified set of spaces from the source system
...
4.  Specify the connector's crawl scope by selecting one of the following **Spaces to crawl** options:

    -   To crawl all spaces from the source system, select **All**, then optionally select **Exclude spaces** and use the **Add URL** field and **Add** button to enter URLs for any spaces that you want to exclude from the crawl.
    -   To crawl only a specified set of spaces from the source system, select **Specify**, then use the **Add URL** field and **Add** button to enter URLs for the spaces that you want to include in the crawl.
