...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/subscription-user-sets-v2.html
release: xanadu
topic_type: concept
...
To learn more about creating and editing groups, see [Creating groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/user-administration/ua-creating-groups.md).
