...
Using Column Level Encryption for email attachments requires you to have Column Level Encryption configured on your instance. For more information, see Column Level Encryption.
