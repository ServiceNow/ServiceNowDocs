...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_CoalesceNormalValues.html
release: yokohama
topic_type: task
...
6.  [Start](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_ApplyAliases.md) all the **Alias application** data jobs to replace the aliases with the normal value in existing records in the database.
