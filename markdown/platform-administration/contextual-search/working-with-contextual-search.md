...
-   **[Set a search context as default](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/set-a-contextual-search-as-default.md)**  
...
-   **[Set the default source for search context](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/set-source-search-context.md)**  
You can decide which source to set as the default search source.
-   **[View a searcher](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_ViewASearcher.md)**  
View the details of a searcher to know which search resources it searches and which search contexts use it.
-   **[Show the related search box in a form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/show-related-search-box-from-form.md)**  
Enable agents to search for related content without having to modify the text in the **Short description** field.
-   **[Add multiple search fields for contextual search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/add-multiple-search-fields.md)**  
...
-   **[Add additional resources to the source selector of a form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/add-addi-resource-to-source-list.md)**  
...
-   **[Edit search resource display field record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/edit-addi-resources-field.md)**  
Use the search result display fields to provide titles, descriptions, and additional details for contextual search results.
-   **[Specify fields for the Cxs\_popup view](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/def-fields-addi-resource-preview.md)**  
...
-   **[Modify or disable search actions available for contextual search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/modify-search-actions-avail-for-cxs.md)**  
...
-   **[Define contextual search for record producer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_CntxtSearchRP.md)**  
...
-   **[Define email configuration for contextual search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/define-email-configuration-for-cxs.md)**  
...
-   **[Attach a Knowledge article](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_AttachAnArticle.md)**  
...
-   **[Feedback information on contextual search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/r_QueryFeedbackInformation.md)**  
