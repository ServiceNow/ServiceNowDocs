...
-   **[Contextual search properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/contextual-search-properties.md)**  
...
-   **[Define a search context](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_DefineSearchContext.md)**  
...
-   **[Configure table for a contextual search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_DefineContextualSearchForForm.md)**  
Configure the options for the contextual search that a table performs.
-   **[Filter configuration for contextual search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/filter-configuration-for-cxs.md)**  
Define filter configurations to map fields from the form to provide a more targeted search result set.
-   **[Configure search resource context properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_ApplyConfigurationToSearch.md)**  
