...
-   **[Search resource](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_ApplyConfigurationToSearch.md)**
    ...
    **Note:**
    ...
    -   A search resource uses the [Zing search engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/features-search-administration.md) to search a table.
-   **[Searcher](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_ViewASearcher.md)**
...
-   **[Additional resources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/add-addi-resource-to-source-list.md)**
    ...
    **Note:**
    ...
    -   An additional resource performs the search based on the type of the source:
        -   Table: The [Zing search engine](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/search-administration/features-search-administration.md) to used to search a table.
        -   [Predictive Intelligence similarity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/create-similarity-solution.md): Search is based on similarity and not on the Zing search engine.
-   **[Search result display fields](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/edit-addi-resources-field.md)**
...
-   **[Search context](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_DefineSearchContext.md)**
...
-   **[Searcher text](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_DefineSearchContext.md)**
...
-   **[Search on tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/t_DefineSearchContext.md)**
...
-   **[Search actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/contextual-search/modify-search-actions-avail-for-cxs.md)**
