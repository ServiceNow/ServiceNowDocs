...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/enable-smime-for-outbound-and-inbound.html
release: yokohama
topic_type: concept
...
For encryption, you must upload the email certificate for the recipients in PEM format and the CA certificates for the issuing authority. For more information, see [Upload an email certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upload-email-certificate.md) and [Upload a CA certificate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/upload-ca-certificate.md).

For signing, you must upload the email account key pair in P12 format. For more information, see [Import an S/MIME key pair](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/import-smime-key-pair.md).
...
For signature verification, you must upload the email account key pair in P12 format. For more information, see [Import an S/MIME key pair](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/import-smime-key-pair.md).
...
For more information, see [Create an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_CreateANotification.md).
