...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/managing-user-subscriptions-v2.html
release: xanadu
topic_type: concept
...
\[Omitted image "MMASSET0020636-subscription-management-workflow-manage-subscriptions-landing.png"\] Alt text: The instance administrator allocates subscriptions by adding groups, tracks usage, and monitors end dates prior to renewal.

-   [Allocate subscriptions in Subscription Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/allocate-subscriptions-v2.md)
...
-   [Remove a group from a product subscription in Subscription Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/remove-group-from-subscription-v2.md)
...
-   [Maintain per-user subscription allocations in Subscription Management at renewal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/maintain-allocations-renewal.md)
...
When allocating per-user subscriptions, you can add groups recommended by Subscription Management based on their roles. For example:

-   If the Service Desk group has a fulfiller-type role in the ITSM application, you can add the Service Desk group to the ITSM product subscription to allocate the fulfiller subscriptions included with ITSM to all of the users in the group.
