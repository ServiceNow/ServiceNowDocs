...
![The instance administrator allocates subscriptions by adding groups, tracks usage, and monitors end dates prior to renewal.](../image/MMASSET0020636-subscription-management-workflow-manage-subscriptions-landing.png "Managing per-user subscriptions")
