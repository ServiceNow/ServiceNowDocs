...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/create-email-reader-job.html
release: yokohama
topic_type: task
