...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/platform-administration/create-email-reader-job.html
release: australia
topic_type: task
