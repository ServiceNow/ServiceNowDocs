...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/t\_ConvertADataPolicyToAUIPolicy.html
release: yokohama
topic_type: task
...
3.  Edit the fields on the UI policy record as necessary.
    ...
    For details about the fields, see [Create a UI Policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/t_CreateAUIPolicy.md).
