...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/instance-scan/hs-create-new-heath-check-timeout.html
release: xanadu
...
breadcrumb: [Implement a check timeout threshold, Timeout threshold, Instance Scan, Maintain and monitor, Administer the ServiceNow AI Platform]
---
