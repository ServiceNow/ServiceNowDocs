...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/instance-scan/hs-implement-dashboard.html
release: zurich
...
You've created some checks to execute the full scan. See [Create a check](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/instance-scan/hs-create-health-check.md) and [Execute a full scan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/instance-scan/hs-execute-full-scan.md) for more information.
