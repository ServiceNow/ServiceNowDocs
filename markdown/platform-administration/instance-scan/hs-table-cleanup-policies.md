...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/instance-scan/hs-table-cleanup-policies.html
release: xanadu
...
You can also modify these policies by entering any customized time period. See [Customize table cleanup policies](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/instance-scan/hs-customize-table-cleanup-policies.md) for more information.
