...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/instance-scan/hs-create-column-health-check.html
release: xanadu
...
breadcrumb: [Create a check, Getting started with checks, Exploring Instance Scan, Instance Scan, Maintain and monitor, Administer the ServiceNow AI Platform]
---
