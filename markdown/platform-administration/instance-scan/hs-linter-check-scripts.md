...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/instance-scan/hs-linter-check-scripts.html
release: yokohama
...
For more information, see [LinterCheckAstNode API - Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/server-api-reference/LinterCheckAstNodeAPIBoth.md).

**Parent Topic:**[Create a linter check](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/instance-scan/hc-linter-check.md)
