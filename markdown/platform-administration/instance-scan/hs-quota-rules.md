...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/platform-administration/instance-scan/hs-quota-rules.html
release: yokohama
...
To learn how to configure these thresholds, see [Implement a scan timeout threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/instance-scan/hs-full-scan-quota-rule.md) and [Implement a check timeout threshold](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/platform-administration/instance-scan/hs-health-check-quota-rule.md).
