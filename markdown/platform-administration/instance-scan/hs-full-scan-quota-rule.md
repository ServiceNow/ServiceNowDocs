...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/instance-scan/hs-full-scan-quota-rule.html
release: xanadu
...
breadcrumb: [Timeout threshold, Instance Scan, Maintain and monitor, Administer the ServiceNow AI Platform]
---
...
3.  Enter the definite execution time in the **Maximum Duration \(seconds\)** field and select **Update**.
    ...
    **Note:** The minimum allowed timeout threshold is 5 seconds. If you set the timeout to anything less than 5 seconds, the system still considers it to be 5 seconds. By default, it has been set to 10,800 seconds.
    ...
    The scan fails if the execution time exceeds the set timeout. For more information on the type of scan you want to run, see [Configuring Instance Scan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/instance-scan/hs-intro-scans.md) .
