...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/instance-scan/hs-health-check-quota-rule.html
release: xanadu
...
2.  From the System Properties list, select **glide.scan.process\_check.time\_out**.
    ...
    **Note:** If **glide.scan.process\_check.time\_out** is not present in the list, see [Create a new check timeout system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/platform-administration/instance-scan/hs-create-new-heath-check-timeout.md) for more information.
