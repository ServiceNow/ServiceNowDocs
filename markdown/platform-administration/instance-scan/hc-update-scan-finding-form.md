...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/platform-administration/instance-scan/hc-update-scan-finding-form.html
release: xanadu
...
breadcrumb: [Findings, Reviewing of scans, Configuring Instance Scan, Instance Scan, Maintain and monitor, Administer the ServiceNow AI Platform]
---
...
2.  Select the scan result you ran from the list.
...
4.  Use the information icon to open the finding you want to mute.
...
6.  Select the reason for muting the finding and then select **Mute** on the modal.

    **Note:** Selectc **Unmute** if you want to the finding too be reported in the later scans. The **Unmute** button is visible only when you have muted a finding.
