...
3.  Select one of the available types of checks.
    ...
    See [Check types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/instance-scan/hs-intro-health-check.md) for more information.
...
-   **[Create a table type check](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/instance-scan/hs-create-table-health-check.md)**  
...
-   **[Create a column type check](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/instance-scan/hs-create-column-health-check.md)**  
...
-   **[Create a script only check](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/instance-scan/hs-create-script-health-check.md)**  
...
-   **[Create a linter check](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/instance-scan/hc-linter-check.md)**  
