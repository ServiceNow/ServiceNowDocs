...
Use the Push Installation API to opt users in to receive push notifications. For more information, see [Push Installation API](https://www.servicenow.com/docs/access?context=pushinstallation-api&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
