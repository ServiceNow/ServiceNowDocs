...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/platform-administration/configure-oauth-profile-using-certificates.html
release: zurich
topic_type: task
...
[Configure a JWT provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/configure-jwt-provider.md)
...
-   **[Create an OAuth API script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/oauth-api-script.md)**  
Create and duplicate an OAuth API script for application registry.

**Parent Topic:**[Reading email using Microsoft Graph](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/platform-administration/read-email-using-ms-graph.md)
