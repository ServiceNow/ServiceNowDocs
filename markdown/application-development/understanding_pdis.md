...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/understanding\_pdis.html
release: yokohama
topic_type: concept
...
If your PDI is not on the latest release, follow the steps for [upgrading your PDI](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/upgrading_your_pdi.md) to get the latest release.
