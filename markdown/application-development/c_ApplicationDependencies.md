...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/c\_ApplicationDependencies.html
release: zurich
topic_type: concept
...
\[Omitted image "image.app-dependencies"\] Alt text: Remove dependencies from the custom app record by accessing the Dependencies related list.
