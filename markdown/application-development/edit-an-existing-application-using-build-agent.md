---
title: Edit an existing application using Build Agent default mode
...
# Edit an existing application using Build Agent default mode
...
You can convert existing apps to ServiceNow Fluent and work on them in Build Agent. For more information, see [Convert an application with the ServiceNow SDK](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-sdk/convert-application-now-sdk.md).
...
8.  Review the changes in the Change Log in a tab in ServiceNow Studio and continue iterating to refine the app.
    ...
    For more information on the change log, see [Checkpoints and conversation change log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/ba-conversational-change-log.md).
