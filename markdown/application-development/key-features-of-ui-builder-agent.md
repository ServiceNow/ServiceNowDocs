---
title: Key features of UI Builder agent
description: The UI Builder agent introduces three key features to enhance user experience.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/key-features-of-ui-builder-agent.html
release: zurich
topic_type: concept
...
The UI Builder agent introduces three key features to enhance user experience.
...
You can ask about specific features or tasks, such as `What is a data resource?`or `How can I add a component to my page?` You receive instant responses based on the latest ServiceNow documentation.
...
You can inquire about the configuration of your page. For instance, you might ask, `Is dynamic theming implemented on my page?`, or `Are any client scripts utilized on my page?`.
