...
A subscription enables you to upgrade from one family release to the next without dealing with the ServiceNow Store. For example, if you're on Tokyo and have a subscription to an app, you're automatically upgraded to Brazil as soon as it's in general release.
