...
-   Installing the Now Assist for Creator application from the ServiceNow Store \(Paid version only\)
...
-   **[Connect Build Agent to a Figma MCP server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/connect-figma-mcp-server-to-build-agent.md)**  
