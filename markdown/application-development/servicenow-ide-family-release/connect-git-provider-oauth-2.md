...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/servicenow-ide-family-release/connect-git-provider-oauth-2.html
release: yokohama
...
3.  On the form, fill in the fields.
    ...
    For additional information about fields on the form, see [Connect to a third-party OAuth provider](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/connect-3rd-party-oauth-provider.md).
