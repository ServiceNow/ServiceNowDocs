...
3.  On the form, fill in the fields.
    ...
    For additional information about fields on the form, see [Connect to a third-party OAuth provider](https://www.servicenow.com/docs/access?context=connect-3rd-party-oauth-provider&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
