...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/servicenow-ide-family-release/configure-mid-server-source-control.html
release: australia
