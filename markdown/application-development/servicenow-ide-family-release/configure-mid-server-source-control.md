...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/servicenow-ide-family-release/configure-mid-server-source-control.html
release: zurich
