...
-   To learn more about what's new in the Zurich release, see the [ServiceNow IDE release notes](https://www.servicenow.com/docs/access?context=servicenow-ide-rn&version=zurich&pubname=zurich-release-notes&ft:locale=en-US).
