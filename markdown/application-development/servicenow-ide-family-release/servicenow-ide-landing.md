...
**Note:** The ServiceNow IDE doesn't support the Global scope or global applications in the Xanadu release.
...
-   To learn more about what's new in the Xanadu release, see the [ServiceNow IDE release notes](https://www.servicenow.com/docs/access?context=servicenow-ide-rn&version=xanadu&pubname=xanadu-release-notes&ft:locale=en-US).
