...
-   **[Configure a MID Server to use source control with the ServiceNow IDE](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-ide-family-release/configure-mid-server-source-control.md)**  
Configure a MID Server to use source control with the ServiceNow IDE if your Git provider is behind a firewall.
-   **[Initialize a Git repository with the ServiceNow IDE](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-ide-family-release/initialize-git-repository-servicenow-ide.md)**  
...
-   **[Using source control in the ServiceNow IDE](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-ide-family-release/using-source-control-servicenow-ide.md)**  
