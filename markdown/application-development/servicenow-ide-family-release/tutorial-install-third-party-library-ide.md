...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-ide-family-release/tutorial-install-third-party-library-ide.html
release: xanadu
...
Complete [Tutorial part 3: Define a table in ServiceNow Fluent code](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-ide-family-release/tutorial-define-table-fluent-ide.md).
...
Continue to [Tutorial part 5: Clone the application on a different instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-ide-family-release/tutorial-clone-application-ide.md).
