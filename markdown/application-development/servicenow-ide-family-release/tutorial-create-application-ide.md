...
3.  Create an application in the workspace.
    ...
    4.  Enter a scope, such as `x_snc_hello_world`, and press Enter.
        ...
        **Important:** The scope name must be unique on the instance, begin with x\_&lt;prefix&gt;, and be 18 characters or fewer. For more information, see [Namespace identifier](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/c_NamespaceIdentifier.md).
    ...
    7.  From the Status Bar at the bottom of the ServiceNow IDE, select **Build and Install**.
        ...
        For information about the application structure, see the [Application structure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/building-applications-source-code.md) section of the Building applications in source code topic.


## What to do next

Continue to [Tutorial part 2: Initialize a repository for your application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-ide-family-release/tutorial-initialize-repository-ide.md).
