...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-ide-family-release/servicenow-ide-properties.html
release: xanadu
...
**Note:** To open the System Properties \[sys\_properties\] table, enter `sys_properties.list` in the navigation filter. To add properties to the table, see [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/r_AvailableSystemProperties.md).
...
-   Location: Add the property to the System Property \[sys\_properties\] table
-   Learn more: [ServiceNow IDE MID Server User \[sn\_glider.ide\_git\_user\]](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-ide-family-release/servicenow-ide-roles.md)
