...
-   **![](../../../reuse/icons/brand-icons/bus-learn.svg) [Learning about creating applications](getting-started-with-building-applications.md)**
    ...
    -   How [ServiceNow AI Platform](https://www.servicenow.com/docs/access?context=now-platform-landing&version=xanadu&pubname=xanadu-now-platform&ft:locale=en-US) is made up of tables and records. Learn how to convert a spreadsheet into record data.
...
-   **![](../../../reuse/icons/brand-icons/bus-application-development.svg) [Phase 2: Developing your application](developing-applications.md)**
    ...
    -   See [Build workflows](https://www.servicenow.com/docs/access?context=build-workflows&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US) to learn about creating automation with Workflow Studio or Playbooks.
...
-   **![](../../../reuse/icons/brand-icons/bus-rocketship.svg) [Phase 4: Deploying your application](deploying-applications.md)**
    ...
    -   See [Managing app development using the App Engine Management Center](../../app-engine-studio/concept/monitor-requests-using-aemc.md) to learn about the App Engine Management Center
