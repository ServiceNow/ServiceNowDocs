...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/app-engine-studio/add-workspace.html
release: australia
...
11. Edit the workspace in Workspace Builder. For more information, see [Edit a workspace in Workspace Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/workspace-builder/configure-workspace-builder.md).
