...
Role required: admin, sn\_app\_eng\_studio.user, sn\_app\_eng\_studio.admin, delegated developer permissions for "Integration" must be present to view data import and mapping options. For more information, see [Delegate developers using AES](../concept/aes-app-dev-workflow.md).
...
<table id="choicetable_ats_cqp_vvb"><tbody><tr><td id="d43777e379">
