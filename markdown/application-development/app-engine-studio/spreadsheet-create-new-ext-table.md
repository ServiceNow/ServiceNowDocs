...
<table id="choicetable_ats_cqp_vvb"><tbody><tr><td id="d47133e373">
...
</td></tr><tr><td id="d47133e487">

**Configure reference and choice field behavior**

</td><td>

Configure behavior for **Choice** and **Reference** field types.1.  Click the gear icon \(![Gear icon.](../image/gear-icon.png)\).
