...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.html
release: xanadu
...
[Build a decision table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-decision-table.md)
...
[Create a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md)

</td></tr></tbody>
</table>For more information about flows, see [Building flows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flows.md).
...
|0:41|[Add an Ask for Approval action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).|
|1:09|[Add If flow logic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).|
|1:25|[Integrate decision tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).|
|1:48|[Duplicate repeating actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).|
|2:17|[Add an Update Record action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).|
|2:38|[Add Else flow logic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).|
|2:50|[Add a Send Email action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).|
|4:14|[Add End Flow flow logic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).|
...
5.  Select **Build your flow from scratch**.
    ...
    You can also choose to build your flow with Now Assist. For more information, see [Create a flow with Now Assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/create-flow-now-assist.md).
...
8.  Add triggers to the flow.
    ...
    **Note:** A trigger specifies when to run the flow. When the trigger conditions are met, the system runs the flow using the data provided by the trigger.
    ...
    2.  In the **Trigger** field, select **Record** &gt; **Created**.
        ...
        For more information about trigger types, see [Workflow Studio flow trigger types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flow-triggers.md).
...
9.  Add actions, flow logic, and sublows to the flow.
    ...
    **Note:** You can add [actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flow-actions.md), [flow logic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flow-logic.md), and [subflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/subflows.md) to enable your flow to perform desired actions. For example, you can create an action that enables your application to send emails automatically.
    ...
    \[Omitted image "app-tutorial-create-a-flow-diagram-v4.png"\] Alt text: Diagram that
...
Continue building the flow for the employee travel request application. Proceed to the next step: [Add an Ask for Approval action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).
...
5.  Set the rules for the action.
    ...
    **Note:** Rules determine which users can approve or reject requests, and what happens after approval or rejection. For more information about the rules available for the Ask for Approval action, see [Ask for Approval action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/ask-approval-flow-designer.md).
    ...
    3.  Choose which users or groups can complete the approval actions using the **Data Pill Picker** \(\[Omitted image "data\_pill\_picker.png"\] Alt text: Pill picker icon.\), the add user icon \(\[Omitted image "app-tutorial-add-user-icon.png"\] Alt text: Add user icon\), add group icon \(\[Omitted image "app-tutorial-add-group-icon.png"\] Alt text: Add group icon\), the add manual approvers icon \(\[Omitted image "manual-users-icon.png"\] Alt text: Manual approvers icon\), or by dragging data pills from the **Data** panel into the field.
        ...
        The second Ask for Approval action, which you create in [Duplicate repeating actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md), routes the approval to the regional head.
...
Proceed to the next step: [Add If flow logic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).
...
For more information about using If flow logic, see [If flow logic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flow-logic-if.md).
...
Proceed to the next step: [Integrate decision tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).
...
For more information about Make a decision flow logic, see [Make a decision flow logic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flow-logic-make-decision.md).
...
Proceed to the next step: [Duplicate repeating actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).
...
3.  Adjust values in the action as needed.
    ...
    2.  Select the remove icon \(\[Omitted image "fb-delete-icon.png"\] Alt text: Delete form element.\) to remove any field values that you must change.

        In our tutorial, we must change the user that the Ask for Approval routes to. So we select the remove icon \( \[Omitted image "fb-delete-icon.png"\] Alt text: Delete form element.\) in the data pill that contains the manager user information.

    3.  Provide the correct field values by selecting the **Data Pill Picker** \(\[Omitted image "data\_pill\_picker.png"\] Alt text: Pill picker icon.\) or by dragging data pills from the **Data** panel into the fields.
        ...
        -   Using the **Data Pill Picker** \(\[Omitted image "data\_pill\_picker.png"\] Alt text: Pill picker icon.\), we select **Make a decision** &gt; **Decision Table Multiple Result Record** &gt; **Result elements** &gt; **Regional heads**.
...
Proceed to the next step: [Add an Update Record action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).
...
For more information about the Update Record action, see [Update Record action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/update-record-flow-designer.md).
...
4.  Select the record that you want to update by selecting the **Data Pill Picker** \(\[Omitted image "data\_pill\_picker.png"\] Alt text: Pill picker icon.\) or by dragging the data pill from the **Data** panel into the **Record** field.
...
Proceed to the next step: [Add Else flow logic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).
...
Proceed to the next step: [Add a Send Email action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).
...
For more information about the Send Email action, see [Send Email action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/send-email-flow-designer.md).
...
4.  Add the record that the email is associated with to the **Target Record** field using the Data pill picker \(\[Omitted image "data\_pill\_picker.png"\] Alt text: Pill picker icon.\), or by dragging the data pill from the **Data** panel.

    In our tutorial, we want the email to be associated with the travel request record in our trigger.

5.  Add recipients for the email in the **To** field using the Data pill picker \(\[Omitted image "data\_pill\_picker.png"\] Alt text: Pill picker icon.\), or by dragging the data pill from the **Data** panel.
...
Proceed to the next step: [Add End Flow flow logic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-create-a-flow.md).
...
For more information about End Flow flow logic, see [End Flow flow logic](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/flow-logic-end-action.md).
