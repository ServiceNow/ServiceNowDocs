...
4.  Take the appropriate actions to edit the decision.
    ...
    For more information on editing decision tables, see [Modify decision table structure in Workflow Studio](https://www.servicenow.com/docs/access?context=format-decision-table-in-decision-designer&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
