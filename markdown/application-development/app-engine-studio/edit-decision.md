...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/app-engine-studio/edit-decision.html
release: xanadu
...
4.  Take the appropriate actions to edit the decision.
    ...
    For more information on editing decision tables, see [Modify decision table structure in Workflow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/format-decision-table-in-decision-designer.md).

5.  To save your changes, select **Save**.


**Parent Topic:**[Add a decision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/add-decision.md)
