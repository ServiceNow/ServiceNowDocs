...
</table>For more information about using decision tables, see [Create decision tables in Workflow Studio](https://www.servicenow.com/docs/access?context=create-decision-table-in-decision-designer&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
