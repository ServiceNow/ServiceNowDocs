...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/app-engine-studio/publish-custom-template.html
release: xanadu
...
You must have permissions to publish a custom template. For details, see [Assign permissions to publish custom templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/assign-permissions-publish-custom-templates.md).
