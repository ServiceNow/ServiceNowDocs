...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/app-engine-studio/publish-custom-template.html
release: yokohama
...
You must have permissions to publish a custom template. For details, see [Assign permissions to publish custom templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/app-engine-studio/assign-permissions-publish-custom-templates.md).
