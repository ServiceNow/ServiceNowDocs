...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/app-engine-studio/enable-atf-properties.html
release: yokohama
...
2.  Locate the following two properties:
    ...
    \[Omitted image "p-and-d-enable-atf-properties.png"\] Alt text: Locate the system properties to enable Automated Test Framework \(ATF\) test suites.
