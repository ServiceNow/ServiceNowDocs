...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/app-engine-studio/aes-collaboration-feature-overview.html
release: australia
...
6.  Select the collaboration descriptor for the user or group that you're adding.
    ...
    For a list of collaboration permissions, see [Delegated development and collaboration permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/app-engine-studio/aes-collaboration-feature-overview.md).
