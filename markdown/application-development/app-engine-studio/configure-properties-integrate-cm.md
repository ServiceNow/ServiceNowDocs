...
3.  In the **sn\_deploy\_pipeline.change\_management.default.template** property, paste the sys\_id you have copied into the **Value** field, replacing its current contents.
