...
As of the Xanadu store 2 release, the App Engine Management Center \(AEMC\) can be used to manage app development for custom apps built in App Engine Studio, Creator Studio, and ServiceNow Studio. To learn more about managing app development using AEMC, see [Managing app development using the App Engine Management Center](../../app-engine-management-center/concept/managing-app-development-using-aemc.md).
