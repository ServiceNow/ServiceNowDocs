---
title: Customization vs. configuration with App Engine Studio
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/app-engine-studio/aes-custom-vs-config.html
release: yokohama
...
breadcrumb: [Exploring App Engine Studio, Build apps using App Engine Studio, Building low-code applications, Developing your application, Building applications]
---
...
For more information, see the [Customer Updates table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/servicenow-ai-platform-security/r_CustomerUpdatesTable.md). Note that the complexity of maintaining customizations dramatically increases as the number of customizations increases.
...
When your company needs to add new functionality to the ServiceNow platform, you can customize existing applications, such as ITSM, or create a new application using App Engine developer products, such as App Engine Studio, Creator Studio, or ServiceNow Studio. A simple guideline for which path to choose is:
...
For example, ITSM is designed to handle IT issues. To customize it to handle travel requests goes beyond the original intention of ITSM. Because IT and travel requests have different workflows, it’s better to create a travel request app using App Engine developer tools, such as App Engine Studio, Creator Studio, and ServiceNow Studio, instead of customizing ITSM.

For more information, see [Build apps using App Engine Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/app-engine-studio/aes-overview.md).
