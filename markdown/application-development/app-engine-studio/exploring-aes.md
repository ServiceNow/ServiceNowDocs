...
|Scale development while maintaining process to review and test applications before deployment.|[Managing app development using the App Engine Management Center](monitor-requests-using-aemc.md)|Administrator|
...
![App Engine Studio home page](../image/aes-landing-purple-update.png "AES landing page")
