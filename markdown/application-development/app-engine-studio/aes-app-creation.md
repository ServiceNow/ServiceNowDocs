...
![Infographic for building apps workflow.](../image/aes-build-process-asset-0020268.png "Application building process")
...
4.  [Create your app](create-application.md) or [Generate your app with Now Assist for Creator](../task/generate-apps-from-prompts.md)
...
7.  [Managing app deployments using Pipelines and Deployments](aes-review-apps-p-and-d.md)
