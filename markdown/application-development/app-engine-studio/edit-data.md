...
3.  Under the Data heading, select the Additional actions icon \(![](../image/additional-actions-icon-purple.png)\) for an existing table in your application, and then select **Edit**.

When you click on a data table or select **Edit** in the Additional actions menu \( ![](../image/additional-actions-icon-purple.png)\) to edit data for your application, Table Builder is launched. Table Builder is a tool for editing data tables that you've added to your application.
...
**Note:** To delete a table from your application, select the Additional actions icon \(![](../image/additional-actions-icon-purple.png)\) for an existing table in your application, and then select **Delete** and follow the instructions.
