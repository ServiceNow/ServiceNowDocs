...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/app-engine-studio/build-template-existing-app.html
release: australia
...
4.  On the app selection screen, select an existing application for the custom template creation, and then select **Continue**.
    ...
    **Note:** For more information, see [Supported features and metadata in custom templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/app-engine-studio/supported-features-metadata-custom-templates.md).
...
<table id="choicetable_m5y_2nz_5tb"><tbody><tr><td id="d266658e181">
...
</table>    For more information about template sharing and permissions, see [App template sharing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/app-engine-studio/app-template-sharing.md).
