...
Before you edit a process, you must add a process in Playbooks. For more information, see [Create a process definition](https://www.servicenow.com/docs/access?context=create-process-definition&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
...
Test a process to make certain it works the way you expect. For more information on testing processes, see [Test a process](https://www.servicenow.com/docs/access?context=test-process&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
