...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/app-engine-studio/supported-features-metadata-custom-templates.html
release: yokohama
...
For more information on the template creation process, see [Build a custom template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/app-engine-studio/build-custom-template.md).
