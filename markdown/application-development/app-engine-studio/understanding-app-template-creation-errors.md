...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/app-engine-studio/understanding-app-template-creation-errors.html
release: xanadu
...
You can identify which elements of your application are causing it to fail the template creation process by selecting **View all errors**, which displays the Scan Failure \[sys\_app\_scan\_failure\] table. For more information about the errors in the table and their cause, see [Template creation errors in the Scan Failure table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/understanding-app-template-creation-errors.md).

**Parent Topic:**[Build a custom template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/build-custom-template.md)
...
For more information about what types of records are allowed and skipped, see [Supported features and metadata in custom templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/supported-features-metadata-custom-templates.md).
