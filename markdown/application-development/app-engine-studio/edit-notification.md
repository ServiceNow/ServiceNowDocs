...
breadcrumb: [Add an email notification, Add logic and automation, Enhance your app, Build, App Engine Studio, Developing your application, Building applications]
---
...
4.  Edit the notification by taking the appropriate actions.
    ...
    For more information on working with notification fields, see [Add an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/app-engine-studio/add-notification.md).
...
**Parent Topic:**[Add an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/app-engine-studio/add-notification.md)
