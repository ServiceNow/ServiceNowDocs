...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/app-engine-studio/reviewing-applications-generated-by-now-assist.html
release: xanadu
...
1.  If the application is not already open, navigate to App Engine &gt; App Engine Studio and select the application tile.
    ...
    \[Omitted image "app-generation-review-home-enhanced.png"\] Alt text: App Engine Studio App Home page that displays the application's contents.

    Notice the banner prompt to review and that the line items generated by Now Assist have the following:

    -   AI indicator \[Omitted image "aes-app-gen-line-sparkle.png"\] Alt text: AI letters and sparkle icon on pink background.
    -   **Review** button
    ...
    To learn more about the AES home page, see [AES user interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/aes-ui.md).

2.  Review the generated tables.

    1.  Under the **Data** heading, select the Additional actions icon \(\[Omitted image "additional-actions-icon-purple.png"\]\) for an existing table in your application, and then select **Edit**.
    ...
    2.  Check the table data for accuracy and completeness.
        ...
        \[Omitted image "app-generation-review-table.png"\] Alt text: Data view of Table Builder that displays the generated table fields.

        For more information on editing tables in Table Builder, see [Modify application data tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/edit-data.md).

3.  Select the **App Home** tab to review the generated roles and access control lists \(ACLs\).

    1.  Under the **Security** heading, select the Additional actions icon \(\[Omitted image "additional-actions-icon-purple.png"\]\) next to a role, and then select **Edit**.
    ...
    2.  Verify that the created roles and their assigned permissions accurately represent the users of your application.
        ...
        \[Omitted image "app-generation-review-roles.png"\] Alt text: Role page with create, read, and write permissions enabled.

        For more information on configuring roles and access, see [Working with roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/add-security.md).

4.  Select the **App Home** tab to review the generated forms and record producers.

    1.  Under the **Experience** heading, select the Additional actions icon \(\[Omitted image "additional-actions-icon-purple.png"\]\) for a form or record producer in your application, and then select **Edit**.
    ...
    2.  Modify the item if necessary.
        ...
        If you want to make changes, you can fine-tune the experience by using App Engine Studio. For more information, see [Add a record producer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/add-a-record-producer.md).


## What to do next

Set up the application to perform tasks according to predefined rules or logic. You can add flows, create decision tables, build playbooks, write script includes and business rules, or configure an email notification. For more information, see [Add logic and automation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/add-automation.md).

**Parent Topic:**[Generate apps with Now Assist for Creator for use with AES](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/generate-apps-from-prompts.md)
