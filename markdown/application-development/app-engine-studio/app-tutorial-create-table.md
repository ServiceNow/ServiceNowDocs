...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/app-engine-studio/app-tutorial-create-table.html
release: xanadu
...
9.  Define the properties of your new table.
    ...
    |Make extensible|Option to enable other tables to share data from this table. For more information, see [Table extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/add-data.md).|No action needed|
...
Complete the setup of your table by proceeding to the next phase: [Configure a data table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/app-tutorial-configure-table.md)
