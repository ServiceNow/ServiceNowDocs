...
![Our tutorial application workflow starts with an employee travel request. The request is reviewed by the manager and regional head, then sent to the travel desk for booking.](../image/app-tutorial-example-workflow.png)
