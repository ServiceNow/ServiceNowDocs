...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/app-engine-studio/use-existing-table.html
release: yokohama
...
<table id="choicetable_qfr_n3p_tvb"><tbody><tr><td id="d141195e97">
...
For more information on Table Builder, see [Table Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/form-builder-glide-family-release/tb-landing-page.md).
