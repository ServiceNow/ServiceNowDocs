...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/app-engine-studio/use-existing-table.html
release: xanadu
...
<table id="choicetable_qfr_n3p_tvb"><tbody><tr><td id="d67530e97">
...
For more information on Table Builder, see [Table Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/form-builder-glide-family-release/tb-landing-page.md).
