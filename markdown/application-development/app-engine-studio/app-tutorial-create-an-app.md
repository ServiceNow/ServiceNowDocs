...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/app-engine-studio/app-tutorial-create-an-app.html
release: xanadu
