...
For information about how to set up a service for your Service Request Management application, see [Service catalog setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/p_ServiceCatalogs.md).
