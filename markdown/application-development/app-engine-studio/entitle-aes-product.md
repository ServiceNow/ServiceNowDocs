...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/app-engine-studio/entitle-aes-product.html
release: yokohama
...
5.  Verify that you have entitlement to the product and applications by selecting **Opt-in**.
    ...
    **Note:** The **Opt-in** button is not available unless you purchased an AES subscription.

6.  When the ServiceNow Store prompts you to read and accept the ServiceNow terms and conditions, select the check box and select **Accept**.
