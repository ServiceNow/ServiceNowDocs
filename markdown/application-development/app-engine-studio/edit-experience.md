...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/app-engine-studio/edit-experience.html
release: xanadu
...
Workspace Builder is a streamlined no-code tool that enables you to configure custom workspaces built in AES quickly and easily. For more information on using Workspace Builder, see [Building workspaces in AES](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/workspace-builder/using-workspace-builder.md). For more complex customizations, edit the workspace in UI Builder.
...
-   **[Preview an experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/preview-app.md)**  
See what an application experience built in App Engine Studio \(AES\) looks like to your users by previewing it in a browser.
-   **[Delete an experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/delete-experience.md)**  
