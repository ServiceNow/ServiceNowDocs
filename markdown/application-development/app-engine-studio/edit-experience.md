...
Workspace Builder is a streamlined no-code tool that enables you to configure custom workspaces built in AES quickly and easily. For more information on using Workspace Builder, see [Building workspaces in AES](using-workspace-builder.md). For more complex customizations, edit the workspace in UI Builder.
