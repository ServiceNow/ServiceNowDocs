...
Each of these products has its own guided setup. If you have already configured one or more of the products and you're prompted to configure it again, you can simply ignore that instruction. The following diagram illustrates the preferred method for implementing AES and associated applications:
