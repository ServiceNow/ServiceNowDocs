...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/app-engine-studio/aes-setup.html
release: xanadu
...
1.  On a development instance, install AES and the Pipelines and Deployments plugin. For more information, see [Installing App Engine Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/install-aes.md).
2.  Complete the AES guided setup. For more information, see [Configure App Engine Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/configure-aes.md).
3.  On your production instance:
    1.  Complete the Application Intake guided setup. For more information, see [Configure Application Intake](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/config-app-intake.md).
    2.  Complete the Pipelines and Deployments guided setup. For more information, see [Configure Pipelines and Deployments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/config-p-and-d.md).
...
9.  Install the AEMC plugin on each instance in your pipeline. For more information, see [Configure the App Engine Management Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/configure-aemc.md).
...
-   **[Configure App Engine Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/configure-aes.md)**  
App Engine Studio \(AES\) guided setup provides a sequence of tasks that help you configure AES on your ServiceNow instance.
-   **[Configure the App Engine Management Center](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/configure-aemc.md)**  
...
-   **[Configure Application Intake](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/config-app-intake.md)**  
...
-   **[Configure Pipelines and Deployments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/config-p-and-d.md)**  
...
-   **[Cloning instances with AES](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/cloning-aes-applications.md)**  
