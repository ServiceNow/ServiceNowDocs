...
-   A subset of ECMAScript features are supported in modules in accordance with the [JavaScript engine feature support](https://www.servicenow.com/docs/access?context=javascript-engine-feature-support&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
...
To access server APIs in a third-party library module, you must add the module as a trusted module with the trustedModules parameter in your application's `now.config.json` file. For more information, see [Supported now.config.json parameters](../../custom-application/concept/building-applications-source-code.md#table_upn_kqw_zbc).

For more information about available server APIs, see [Server API reference](https://www.servicenow.com/docs/access?context=api-server&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
...
For more information about script includes, see [Script includes](https://www.servicenow.com/docs/access?context=c_ScriptIncludes&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
