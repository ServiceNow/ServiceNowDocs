...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/application-administration.html
release: yokohama
topic_type: concept
...
For procedures, see [Restrict access to an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/enable-application-administration.md).
...
For procedures to enable application administration and restrict the assignment of application-specific roles, see [Restrict access to an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/enable-application-administration.md).
...
[Delegated development and deployment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/delegated-development-and-deployment/c_DelegatedDevelopment.md)
