...
For procedures, see [Restrict access to an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/enable-application-administration.md).
...
For procedures to enable application administration and restrict the assignment of application-specific roles, see [Restrict access to an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/enable-application-administration.md).
...
[Delegated development and deployment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/delegated-development-and-deployment/c_DelegatedDevelopment.md)
