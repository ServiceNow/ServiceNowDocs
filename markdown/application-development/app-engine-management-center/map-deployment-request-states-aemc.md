...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/app-engine-management-center/map-deployment-request-states-aemc.html
release: australia
