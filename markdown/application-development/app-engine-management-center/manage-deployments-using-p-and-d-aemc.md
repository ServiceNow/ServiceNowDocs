...
description: Manage deployments using Pipelines and Deployments in AEMC.
locale: en-US
release: zurich
...
-   **[Schedule app deployments in AEMC](../task/schedule-app-deployments.md)**  
...
-   **[Update a deployment request in AEMC](../task/update-deployment-request.md)**  
Change the details of a deployment request in App Engine Management Center \(AEMC\).
-   **[Cancel a scheduled deployment in AEMC](../task/cancel-a-scheduled-deployment.md)**  
...
-   **[Deployment Request form in the Pipelines and Deployments app](../reference/deployment-req-form-d-and-p.md)**  
...
**Parent Topic:**[Using AEMC](../../app-engine-management-center/concept/using-aemc.md)
