---
title: Manage custom apps using AEMC
...
The Custom apps page in AEMC shows detailed metrics and a full list of your applications. In each tile in the Custom app lifecycle status section, trending data is available for the last 90 days. You can show all apps in the Custom apps list or limit the list to only certain types of applications using the filter. Select a trend chart to filter the list to those criteria.

\[Omitted image "custom-apps-tab.png"\] Alt text: Custom app page, with high-level metrics and list of all apps.
...
\[Omitted image "custom-apps-list.png"\] Alt text: List of all custom apps.

View the app's readiness and compliance report, usage data, subscription monitoring details,deployment history, and collaborators, if any, by selecting an application name from the list.

\[Omitted image "app-details-page-bs1.png"\] Alt text: App details page showing compliance, usage, deployment history, and collaborators.
...
See how ready the app is for deployment to production instances in the **Compliance check** tab. To learn more about the app readiness and compliance report, see [App Readiness and Compliance Report](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/app-engine-management-center/app-readiness-report.md).
...
Usage data for your applications provides several benefits:
...
Subscription and licensing information for each application provides several benefits:
...
You can select a user's name in the **Assigned Users** section to see a role inheritance map. This map shows how this user inherited the role, whether from a parent role, a group assignment, or other inheritance. This information can help you take action if someone has a role you think they shouldn't, and you want to change it.
...
Deployment history information provides several benefits:
...
If you need to fix an issue or defect with an app, you can quickly see who has permissions to make changes and what those permissions are.
