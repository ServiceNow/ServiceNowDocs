...
If they aren't enabled, only the instance scan runs. For more information, see [Enable Automated Test Framework \(ATF\) properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/app-engine-management-center/enable-atf-properties.md).
