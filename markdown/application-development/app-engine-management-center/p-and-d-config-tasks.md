...
For more information, see [Configuring Instance Scan](https://www.servicenow.com/docs/access?context=hs-intro-scans&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
