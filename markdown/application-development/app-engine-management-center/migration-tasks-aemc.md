...
1.  [Install ReleaseOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/releaseops/install-releaseops.md) on each environment \(instance\) in your App Engine pipeline.
2.  Complete ReleaseOps setup by [configuring a new ReleaseOps ecosystem](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/releaseops/configure-new-releaseops-ecosystem.md) and [configuring multi-instance management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/releaseops/configure-mif.md).
