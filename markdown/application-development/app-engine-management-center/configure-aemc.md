...
3.  Select the first **Get Started** button to initiate the Application Intake Guided Setup.
    ...
    3.  [Create development environment records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/app-engine-management-center/config-pipeline-environments.md).
...
4.  Select the next **Get Started** button to initiate the Pipelines and Deployments Guided Setup.
    ...
    There are several [Pipelines and Deployments configuration tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/app-engine-management-center/p-and-d-config-tasks.md) you must complete.
