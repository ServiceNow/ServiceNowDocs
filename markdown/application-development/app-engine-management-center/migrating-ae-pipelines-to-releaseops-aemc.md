...
4.  [Map deployment request states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/app-engine-management-center/map-deployment-request-states-aemc.md) if you’re using custom deployment request states in your ReleaseOps pipeline. Base system ReleaseOps deployment request states will automatically map onto the corresponding App Engine deployment request states.
