...
2.  Locate the following property: sn\_deploy\_pipeline.change\_management.config\_ci\_creation\_subflow.
    ...
    4.  Select the More Actions menu icon \(![](../../../administer/task-table/image/MoreActionsIcon.png)\), and select **Copy subflow**.
    ...
    8.  To find the sys\_id of the subflow, select the More Actions menu icon \(![](../../../administer/task-table/image/MoreActionsIcon.png)\), and select **Executions**.
