...
For general information about guided setup, see [Using guided setup](https://www.servicenow.com/docs/access?context=guided-setup&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
...
4.  Select the next **Get Started** button to begin performing configuration tasks on your testing environment.
    ...
    5.  [Configure Instance Scan suite](https://www.servicenow.com/docs/access?context=hs-landing-page&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
    When you have completed all of the tasks in this category, the Guided Setup screen reappears.
