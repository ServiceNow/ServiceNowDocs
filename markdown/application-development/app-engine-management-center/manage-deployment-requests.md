...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/app-engine-management-center/manage-deployment-requests.html
release: australia
...
To view deployment requests in AEMC, pipelines must be configured correctly. For details, see [Configure Pipelines and Deployments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/app-engine-management-center/config-p-and-d.md).
