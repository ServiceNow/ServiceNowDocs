...
For the REST API solution, see [SG Services API](https://www.servicenow.com/docs/access?context=sg_services-api&version=australia&pubname=australia-api-reference&ft:locale=en-US).
