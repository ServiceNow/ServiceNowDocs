...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-cli/cmdb-cli-commands.html
release: xanadu
...
For the REST API solution, see [SG Services API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/rest-apis/sg_services-api.md).
