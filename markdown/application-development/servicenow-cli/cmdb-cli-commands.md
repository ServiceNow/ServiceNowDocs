...
For the REST API solution, see [SG Services API](https://www.servicenow.com/docs/access?context=sg_services-api&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
