...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/servicenow-cli/cmdb-cli-commands.html
release: zurich
...
For the REST API solution, see [SG Services API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/sg_services-api.md).
