...
App Engine ERP Rapid Deployment Packs are solution templates built for specific business processes in enterprise ERP workflows.

## App Engine ERP Rapid Deployment Packs

App Engine ERP Rapid Deployment Packs provide a prebuilt starting point that you can configure and extend to meet your business requirements without building ERP workflows from scratch.
...
-   **ServiceNow Store**
    ...
    Only customers with an App Engine Prime license can download the App Engine ERP Rapid Deployment Packs. Find App Engine Prime and App Engine ERP Rapid Deployment Packs in the [ServiceNow Store](https://store.servicenow.com/store).
