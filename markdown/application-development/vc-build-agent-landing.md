...
Build Agent is not a one-shot vibe coding tool, but enables enterprise-grade AI-assisted development.
...
**Note:** While Build Agent is part of Now Assist for Creator, it's the primary ServiceNow tool for vibe coding and AI-assisted development, and thus highlighted in its own section of this document.
