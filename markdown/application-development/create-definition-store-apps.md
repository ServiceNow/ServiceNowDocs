...
**Note:** You can only create a definition for capacity subscriptions. See [Types of subscriptions in Subscription Management](https://www.servicenow.com/docs/access?context=types-subscription-v2&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
