...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/install-ui-generation.html
release: zurich
topic_type: task
last_updated: "2025-07-31"
reading_time_minutes: 1
breadcrumb: [Configure, UI generation, Builder library, Developing your application, Building applications]
---
...
5.  Verify that Now Assist for Creator is installed:
    ...
    3.  On the UI Generation card, verify that the Experience Generation skill is active.
...
Grant the ui\_builder\_admin role to each user you want to use UI generation.

**Parent Topic:**[Configuring UI generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/configuring-ui-generation.md)
