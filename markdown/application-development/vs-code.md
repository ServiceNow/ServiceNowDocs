...
![ServiceNow application editing in Visual Studio Code](../image/vs-code-example.png)
...
-   **[Create a project in VS Code](../task/create-project.md)**  
...
-   **[Clear instance credentials in Visual Studio Code](../task/clear-credentials.md)**  
...
-   **[Reset a project in Visual Studio Code](../task/reset-project.md)**  
...
-   **[Add custom file types in Visual Studio Code](../task/vscode-add-custom-filetypes.md)**  
