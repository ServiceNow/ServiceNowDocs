...
For details on adding a new MCP connection in Workflow Data Fabric, see [Model Context Protocol connectors](https://www.servicenow.com/docs/access?context=model-context-protocol-connector&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
