...
The MCP connection must be configured before you connect to it in Build Agent. For details on adding a new MCP connection in Workflow Data Fabric, see Model Context Protocol connectors.
