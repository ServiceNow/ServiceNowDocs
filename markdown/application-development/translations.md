...
To implement a new language, activate the plugin for the new language. Then export the existing values from any of the [Translation tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/r_TranslationTables.md).
...
For more information, see [Language Internationalization Support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/c_LangInternationalizationSupport.md)

**Parent Topic:**[Create design elements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/create-design-elements.md)
