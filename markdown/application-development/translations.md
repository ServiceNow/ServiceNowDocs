...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/translations.html
release: xanadu
topic_type: concept
...
To implement a new language, activate the plugin for the new language. Then export the existing values from any of the [Translation tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/system-localization/r_TranslationTables.md).
...
For more information, see [Language Internationalization Support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/system-localization/c_LangInternationalizationSupport.md)

**Parent Topic:**[Create design elements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/create-design-elements.md)
