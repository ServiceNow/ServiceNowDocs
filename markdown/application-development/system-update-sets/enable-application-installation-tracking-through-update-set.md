...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/system-update-sets/enable-application-installation-tracking-through-update-set.html
release: australia
