...
To create an update set see [Create and select an update set as the current set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/create-select-update-set.md).

When the update set is completed, you can transfer the update set to another instance according to your test process. See [Update set transfers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/update-set-transfers.md).
...
-   **[Create and select an update set as the current set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/create-select-update-set.md)**  
Create an update set to store customization changes and select it as the current set.
-   **[Select the current update set in Unified Navigation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/select-update-set-system-settings.md)**  
...
-   **[Navigation between records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/navigation-between-records.md)**  
Navigate between a customer update record and the customized object or the application file for the object.
-   **[Compare local update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/t_CompareLocalUpdateSets.md)**  
...
-   **[Preview a remote update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/t_PreviewARemoteUpdateSet.md)**  
...
-   **[Commit an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/t_CommitAnUpdateSet.md)**  
...
-   **[Back out an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/t_BackOutUpdateSet.md)**  
You can back out changes to existing records for any committed update set.
-   **[Mark an update set complete](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/t_CompleteUpdateSets.md)**  
...
**Parent Topic:**[System update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/system-update-sets.md)
