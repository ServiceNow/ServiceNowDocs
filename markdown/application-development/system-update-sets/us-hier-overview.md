...
**Note:** For more details, see [Compare local update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/t_CompareLocalUpdateSets.md) and [View customizations and compare with current version](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/view-customer-update-records.md).
...
-   **[Reorganize a batch of update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/us-hier-reorg.md)**  
