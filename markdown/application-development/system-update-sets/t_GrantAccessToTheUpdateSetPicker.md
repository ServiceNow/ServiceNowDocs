...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/system-update-sets/t\_GrantAccessToTheUpdateSetPicker.html
release: yokohama
...
1.  [Grant the user role read access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/access-control/t_CreateAnACLRule.md) to the Update Set table \[sys\_update\_set\].

2.  Enable users to see the update set picker on the Settings panel.

    1.  [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_AddAPropertyUsingSysPropsList.md) **glide.ui.update\_set\_picker.role** to the System Properties table.
