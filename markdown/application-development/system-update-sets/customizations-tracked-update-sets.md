...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/system-update-sets/customizations-tracked-update-sets.html
release: yokohama
...
-   Using the update\_synch attribute to migrate data records between instances can cause performance issues, because it is not intended for this purpose. To migrate data, use an instance-to-instance import.
    ...
    See [Import sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/system-import-sets/c_ImportSetsKeyConcepts.md).
