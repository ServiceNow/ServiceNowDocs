...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/system-update-sets/t\_MergeUpdateSets.html
release: zurich
...
**Note:** You cannot "unmerge" update sets once they have been merged. To learn more, see [Update set batching](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/system-update-sets/us-hier-overview.md).
...
2.  Filter the list to show only the update set that you want to merge.
    ...
    \[Omitted image "image.merge-update-sets"\] Alt text: Merge update sets
