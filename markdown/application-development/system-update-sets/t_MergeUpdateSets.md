...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/system-update-sets/t\_MergeUpdateSets.html
release: yokohama
...
**Note:** You cannot "unmerge" update sets once they have been merged. To learn more, see [Update set batching](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/system-update-sets/us-hier-overview.md).
