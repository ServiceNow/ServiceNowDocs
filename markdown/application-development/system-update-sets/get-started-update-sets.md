...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/system-update-sets/get-started-update-sets.html
release: xanadu
...
To create an update set see [Create and select an update set as the current set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/system-update-sets/create-select-update-set.md).
