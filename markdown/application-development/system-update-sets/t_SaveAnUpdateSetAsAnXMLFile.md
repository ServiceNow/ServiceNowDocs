...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/system-update-sets/t\_SaveAnUpdateSetAsAnXMLFile.html
release: australia
...
6.  To commit the update set, see [Commit an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/system-update-sets/t_CommitAnUpdateSet.md).
