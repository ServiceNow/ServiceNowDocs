...
6.  To commit the update set, see [Commit an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/t_CommitAnUpdateSet.md).
