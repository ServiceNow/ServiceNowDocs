...
-   The application file record for the object: Click the **Show Application File** related link.
    ...
    ![Navigating to the application file](../image/ShowRecord.png "Navigating to the application file")
...
![Navigating to the customer update record](../image/ShowUpdate.png "Navigating to the customer update record")
