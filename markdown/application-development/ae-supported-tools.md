---
title: Supported tools for Autonomous Engineer
description: Autonomous Engineer tools support application development tasks such as semantic search, schema inspection, code search, planning, UI validation, database querying, app navigation, and script execution. Each tool extends what Autonomous Engineer can do during a build session.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/ae-supported-tools.html
release: brazil
topic_type: concept
...
# Supported tools for Autonomous Engineer
