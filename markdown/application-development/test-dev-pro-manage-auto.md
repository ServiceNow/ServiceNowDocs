...
[Automation Discovery \[Omitted image "icon-discovery.png"\] Alt text: Automation Discovery. Identify automation opportunities for your workflows on the ServiceNow platform.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/automation-discovery.md)
...
[Playbooks \[Omitted image "icon-app-journey.png"\] Alt text: Process Automation Designer. Enable process owners to author cross-enterprise workflows and create a single, unified process.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/process-automation-designer.md)
