...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/form-builder-glide-family-release/tb-landing-page.html
release: xanadu
...
[Explore \[Omitted image "icon-explore.png"\] Alt text: Explore. Learn about Table Builder concepts and features.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/form-builder-glide-family-release/exploring-fb.md)

</td><td>

[Use \[Omitted image "icon-use.png"\] Alt text: Use. Manage tables, forms, and related policies and rules using Table Builder.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/form-builder-glide-family-release/using-fb.md)

</td><td>

[Reference \[Omitted image "icon-reference.png"\] Alt text: Reference. Get details about Table Builder components like field properties and properties for policies and rules.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/form-builder-glide-family-release/fb-reference.md)
