...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/form-builder-glide-family-release/add-formula-column-table-builder.html
release: yokohama
...
3.  Enter a predefined function or a formula in the **Formula editor** modal.\[Omitted image "formula-builder-table-builder.gif"\] Alt text: Creating table using formula editor
