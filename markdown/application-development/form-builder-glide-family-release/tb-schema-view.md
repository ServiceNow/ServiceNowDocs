...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/form-builder-glide-family-release/tb-schema-view.html
release: xanadu
...
2.  Select **Schema** from the additional actions menu \(\[Omitted image "tb-data-addl-actions-menu.png"\] Alt text: Additional actions menu.\) to access Schema view.
    ...
    A visual depiction of the table and its relationships to other tables displays on the screen.

    \[Omitted image "tb-schema-view.png"\] Alt text: Schema view.
...
<table id="choicetable_a2c_l1c_wvb"><tbody><tr><td id="d206543e178">
