...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/form-builder-glide-family-release/modify-table-properties.html
release: yokohama
...
Role required: personalize\_dictionary or AES user role and delegated developer permissions. For more information, see [Delegate developers using AES](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/app-engine-studio/aes-app-dev-workflow.md).
...
**Parent Topic:**[Data in Table Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/form-builder-glide-family-release/table-builder.md)
...
<table id="choicetable_wqj_vdz_5wb"><thead><tr><th align="left" id="d171774e267">

Field

</th><th align="left" id="d171774e270">

Description

</th></tr></thead><tbody><tr><td id="d171774e276">
...
Type of information that the column contains. For example, to contain plain text in the column, select **String**.
 ...
 See [Field types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/r_FieldTypes.md).

</td></tr><tr><td id="d171774e325">
...
2.  Select a field you want to modify in the table.
    ...
    For information about basic field properties, see [Field Configuration.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/form-builder-glide-family-release/field-parameters.md)
...
4.  Make your changes to the field properties.
    ...
    For information about modifying a field's UI policies, see [Modify a UI policy in Table Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/form-builder-glide-family-release/form-builder-policies-rules.md).
