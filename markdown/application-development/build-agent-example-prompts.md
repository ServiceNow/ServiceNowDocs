...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/build-agent-example-prompts.html
release: zurich
...
For more guidelines on prompting, see [General guidelines for Build Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/build-agent-general-guidelines.md).
...
For more information on governance, see [Build Agent governance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/build-agent-governance.md).
