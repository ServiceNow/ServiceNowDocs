...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/automated-test-framework-atf/whitelist-errors-from-step-results-related-list.html
release: zurich
...
breadcrumb: [Allowed client errors, Building and running automated tests with the Automated Test Framework, Test building and execution, Automated Test Framework \(ATF\), Testing and debugging applications, Building applications]
---
...
<table id="choicetable_pd5_3d2_1db"><tbody><tr><td id="d98439e109">
...
**Parent Topic:**[Allowed client errors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/automated-test-framework-atf/whitelisted-client-errors.md)
