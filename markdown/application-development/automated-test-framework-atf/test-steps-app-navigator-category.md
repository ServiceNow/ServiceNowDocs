...
Links to the assessment-based survey you select in the **Assessment** reference field. See Create a survey module.
...
Displays the content page you select in the **Content page** reference field. See Create a content page.
...
Displays an unpopulated list view for the table you select in the **Table** field. Allows users to specify a filter without loading the list first. Use the **Filter** field to define the default filter for the list. Use the **View name** field to specify a View management.
