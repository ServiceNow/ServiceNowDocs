...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/automated-test-framework-atf/available-quick-start-tests.html
release: yokohama
...
breadcrumb: [Quick start tests, Automated Test Framework \(ATF\) tests types and testing ways, Automated Test Framework \(ATF\), Testing and debugging applications, Building applications]
---
...
</table>To learn more about Agile Development 2.0, see [Agile Development 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-business-management/agile-landing-page.md).
...
To learn more about Enterprise Architecture \(formerly Application Portfolio Management\), see [Application Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-portfolio-management/application-portfolio-management.md).
...
To learn more about Assessments and Surveys, see [Service administration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_ServiceAdministration.md).
...
To learn more about Change Management, see [Change Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/c_ITILChangeManagement.md).
...
To learn more about Cloud Provisioning and Governance, see [Cloud Provisioning and Governance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/cloud-management-v2-landing-page.md).
...
To learn more about coaching, see [Coaching](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/coaching-landing.md).
...
To learn more about Communities, see [Communities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/servicenow-communities.md).
...
To learn more about Configuration Compliance, see [Configuration Compliance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/security-management/vr-config-compliance-landing.md).
...
To learn more about Configuration Management Database, see [Configuration Management Database](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/c_ITILConfigurationManagement.md).
...
To learn more about Continual Improvement Management, see [Continual Improvement Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/cim-landing-page.md).
...
Verify creating a product case as an internal unified consumer from the CSP portal using the Customer Service and Consumer Service Portal plugins.
...
This test verifies creating a product case as an external unified consumer from the CSP portal with the Customer Service and Consumer Service Portal plugins.
...
To learn more about Customer Service Management, see [Customer Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/c_CustomerServiceManagement.md).
...
To learn more about Dashboards, see [Dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/dashboards-landing-page.md).
...
To learn more about DevOps, see [DevOps Change Velocity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/devops-landing-page-new.md).
...
-   Verify that you can update the created PI objective with the planned business value \(PBV\) and actual business value \(ABV\)
-   Verify that the percentage of business value achieved is computed as the percentage of ABV complete for committed PI objectives compared to the team PBV
...
</table>To learn more about Essential SAFe, see [Essential SAFe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-business-management/essential-overview.md).
...
To learn more about Event Management, see [Event Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/c_EM.md).
...
|Test|Description|Release version|
|----|-----------|---------------|
|\[Delegation\] Admin - Adding a delegation rule with delegator and delegate user criteria|Ensures a delegate or delegator honors the user criteria assigned to an HR task.|Yokohama|
...
Create an audit plan and associate an engagement to it. Add a cost plan and resource plan to the engagement. The costs are rolled up to the plan. Any edits to these costs in the engagement are reflected in the plan.
...
On an engagement in the validate state, perform the Enable advanced planning ui-action. An engagement project is created. When the state of an engagement associated to an audit plan with Advanced planning capabilities is changed to validate, an engagement project is created automatically.
...
Create an Auditable unit with method as "Detailed Risk Assessment" and request for Assessing the Risk Assessment by adding the Assessor. The assessor responds and marks the assessment as Complete after performing the control assessment and residual assessment. The risk assessment fields are automatically updated.
...
</table>To learn more about Audit Management, see [Audit Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/governance-risk-compliance/c_GRCAudits.md).
...
</table>To learn more about Continuous Authorization and Monitoring, see [Continuous Authorization and Monitoring](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/governance-risk-compliance/grc-cam-landing-page.md).
...
To learn more about Policy and Compliance Management, see [Policy and Compliance Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/governance-risk-compliance/r_PolicyComplianceMgmt.md).
...
To learn more about Risk Management, see [Risk Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/governance-risk-compliance/grc-risk-overview.md).
...
</table>To learn more about Hardware Asset Management, see [Hardware Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-asset-management/ham-landing-page.md).
...
To learn more about HR Service Delivery, see [HR Service Delivery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/employee-service-management/hr-service-delivery.md).
...
To learn more about Incident Management, see [Incident Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/c_IncidentManagement.md).
...
To learn more about Incident Management in Service Operations Workspace, see [Incident Management in Service Operations Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/incident-sow.md).
...
To learn more about Integration Commons for CMDB, see [Integration Commons for CMDB](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/integration-commons-for-cmdb.md).
...
</table>To learn more about Investment Funding, see [Investment Funding](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-business-management/investment-funding-overview.md).
...
</table>To learn more about Knowledge Management, see [Knowledge Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/knowledge-management.md).
...
</table>To learn more about Leader Hub, see [Leader Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/employee-service-management/td-lh-landing.md).
...
To learn more about Legal Request Management, see [Legal Request Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/employee-service-management/legal-management-overview.md).
...
To learn more about Major Incident Management, see [Major Incident Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/major-incident-management.md).
...
To learn more about On-Call Scheduling, see [On-Call Scheduling](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/c_OnCallScheduling.md).
...
</table>To learn more about Metric Intelligence, see [Metric Intelligence](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/operational-metrics.md).

## Predictive Intelligence

Predictive Intelligence quick start tests require activating the Predictive Intelligence \[com.glide.platform\_ml\] plugin. To execute critical upgrade tests on existing machine learning solutions, create a basic authorization profile named ml\_atfin the Basic Auth Configurations table \(sys\_auth\_profile\_basic.list\). To run the tests successfully, the user attached to the ml\_atf authorization profile must have the ml\_admin role.
...
</table>To learn more about Problem Management, see [Problem Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/c_ProblemManagement.md).
...
Validate the project percent complete is not 100% when at least one task is Closed Incomplete or Closed Skipped. Task percent complete must be less than 100%.
...
Validate that milestone tasks are closed when their state changes to Work in Progress. This test uses the project preference "close project milestone tasks when they change to work state".
...
Validate that the project start date changes appropriately for a project in WIP state after setting the project preference to "Enable move project for WIP projects".
...
Validate that the start date of a project task does not roll up to the project when the project planned dates differ from the task start date. This test uses the deselected project preference "Rollup project start date from tasks".
...
Validate that the aggregated cost of all resource plans rolls up to the Planned Cost, Allocated Cost, and Resource Cost fields.
...
-   If a demand is created with a start date and end date, the user resource plan has the task as demand with the specified dates.
...
Validate that actual hours in the resource plan and time card are equal when a time card category is mapped with an operational work type.
...
</table>To learn more about Project Portfolio Management, see [Project Portfolio Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-business-management/c_ProjectPortfolioSuite.md).
...
To learn more about PPM Standard, see [PPM Standard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-business-management/c_ProjectPortfolioSuiteWithFinancials.md).
...
**Note:** Reporting quick start tests do not test report access from dashboards. To test dashboards, see [Quick start tests for Dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/quick-start-tests-dashboards.md).
...
</table>To learn more about Software Asset Management, see [Software Asset Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-asset-management/c_SoftwareAssetMgmt.md).
...
</table>To learn more about Security Incident Response, see [Security Incident Response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/security-management/sir-landing-page.md).
...
To learn more about Service Level Management, see [Service Level Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/service-level-mgmt-landing-page.md).
...
</table>To learn more about Service Mapping, see [Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/c_ServiceMappingOverview.md).
...
</table>To learn more about Service Portfolio Management Premium, see [Service Portfolio Management Premium](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/SPM2-landing-page.md).
...
To learn more about Skills Management, see [Skills Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/skills-management.md).
...
To learn more about Test Management 2.0, see [Test Management 2.0](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-business-management/test-management2-landing-page.md).
...
To learn more about Vendor Management Workspace, see [Vendor Management Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/vendor-management-workspace-landing-page.md).
...
|VR: Rollup Calculator|Determine whether the rollup risk calculator can provide an overall risk score for a vulnerability group using the scores for all vulnerable items in the group.|New York|
...
To learn more about Vulnerability Response, see [Vulnerability Response](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/security-management/vuln-landing-page.md).
...
To learn more about Walk-up Experience, see [Walk-up Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-service-management/walkup-experience-landing-page.md).

**Parent Topic:**[Quick start tests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/quick-start-tests.md)
