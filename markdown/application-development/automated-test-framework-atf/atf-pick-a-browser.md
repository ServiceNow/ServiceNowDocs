...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/automated-test-framework-atf/atf-pick-a-browser.html
release: australia
...
2.  Click **Manage your test runners here** as needed to view all client test runners registered for the current user.
    ...
    See [Active manual test runners](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-active-manual-runners-module.md).
...
-   **[Cloud Runner browser](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-cloud-runner-browser.md)**  
