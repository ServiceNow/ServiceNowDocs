...
Since the ServiceNow Orlando release, customers can automate the testing and deployment of their applications via the [Continuous Integration/Continuous Delivery \(CI/CD\) API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/cicd-api.md).
...
-   **[Headless Browser setup for Linux](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/headless-browser-procedure-linux.md)**  
...
-   **[Headless Browser setup for Microsoft Windows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/headless-browser-procedure-windows.md)**  
...
-   **[Headless Browser system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-headless-browser-properties.md)**  
...
-   **[Headless Browser troubleshooting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/headless-browser-troubleshoot.md)**  
