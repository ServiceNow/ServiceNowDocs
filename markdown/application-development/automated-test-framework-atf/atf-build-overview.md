...
-   [Create a new automated test](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-create-test.md)
...
-   [View the progress of automated tests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-view-progress.md)
...
-   For tests involving form steps, you might need to [View results screenshots from an automated test](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-view-results-consolidated.md).
-   For some tests, you might need to know about [Passing data from one automated test step to another](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-passing-data.md).
-   Some steps frequently occur in the same sequence in many different tests, so you can [Add a predefined list of steps \(template\) to an automated test](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-use-template.md).

-   **[Create a new automated test](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-create-test.md)**  
Create a named automated test containing a series of steps to execute.
-   **[Copy automated test](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-copy-test.md)**  
...
-   **[Implementing breakpoints](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-breakpoints-rollback.md)**  
...
-   **[UI test steps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/ui-test-steps.md)**  
Test user interfaces by mimicking user actions and interacting with the visible components of a page.
-   **[Server test steps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/server-test-steps.md)**  
Test business logic and background processes by performing operations on the server.
-   **[Attachment test steps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/attachment-test-steps.md)**  
...
-   **[List UI actions test steps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-list-ui-actions-test-step.md)**  
Select a UI action from a list to perform different actions on a list or a related list.
-   **[Parameterized tests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/parameterized-tests.md)**  
...
-   **[Passing data from one automated test step to another](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-passing-data.md)**  
