...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/automated-test-framework-atf/atf-admin-overview.html
release: australia
...
For details about individual properties that control how the Automated Test Framework works, see [Properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-admin-properties.md).

-   **[Creating custom test step configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-custom-step-types.md)**  
...
-   **[Working with test step templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-templates.md)**  
Test step templates contain a list of steps to be added all at once to an automated test.
-   **[Testing Configurable Workspace components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-conf-ws.md)**  
...
-   **[Enable or disable executing Automated Test Framework tests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-enable-tests.md)**  
Allow or prevent tests and test suites from executing on this instance.
-   **[Modify data retention policy for ATF test results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-edit-table-cleanup.md)**  
...
-   **[Manage status and retention policies for automated test client runners](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-modify-retention-test-clients.md)**  
...
-   **[Moving automated tests from one instance to another](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-move-test.md)**  
Move automated tests from one instance to another using the normal process for update sets.
-   **[Compare results and execution times for different automated test and suite results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-compare-runs.md)**  
...
-   **[Administering REST test step configurations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-administer-rest.md)**  
Set request and response payload sizes, filter request and response headers, and create basic auth profiles.
-   **[Optimizing automatic test performance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-optimize-perf.md)**  
