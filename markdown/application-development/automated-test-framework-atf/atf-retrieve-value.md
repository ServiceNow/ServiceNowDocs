...
breadcrumb: [Passing data from one automated test step to another, Building and running automated tests with the Automated Test Framework, Test your apps with the ATF, Testing and debugging applications, Building applications]
---
