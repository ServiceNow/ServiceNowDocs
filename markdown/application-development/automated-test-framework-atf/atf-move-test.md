...
You can move automated tests, automated test suites, and related data using update sets. For more information, see [System update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/system-update-sets/system-update-sets.md).
