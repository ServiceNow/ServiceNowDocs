...
3.  To identify and resolve these script errors, open the developer tools browser console on the [Client Test Runner page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-client-test-runner-module.md).
