...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/automated-test-framework-atf/atf-config-desc-script.html
release: australia
...
For an example showing how where the description generated by this script appears, see [Description generation script example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-step-config-xmpls.md).
