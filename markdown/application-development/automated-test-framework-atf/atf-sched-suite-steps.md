...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/automated-test-framework-atf/atf-sched-suite-steps.html
release: yokohama
...
For more information about the capabilities of and requirements for scheduled test suites, see [Working with scheduled test suites](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/atf-sched-suites.md).
...
5.  Add a test suite to run by navigating to the Scheduled Suites related list, then clicking **New**.
    ...
    The system displays the [Scheduled Suite Run](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/atf-suite-sched-run-record.md) record form.

6.  On the [Scheduled Suite Run](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/atf-suite-sched-run-record.md) record form enter the appropriate data.
    ...
    2.  If the suite contains UI steps, enter any client constraints you wish to apply \(such as browser to use\).
        ...
        For more information on client constraints, see [Scheduled Suite Run](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/atf-suite-sched-run-record.md).
...
9.  If your suite includes any test steps that work with a form – or any other element on the client side, open a browser window for running the client portion of the scheduled tests.
    ...
    1.  Review [Browser recommendations and requirements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/atf-test-runners.md) for all tests and suites, as well as those that apply only to scheduled suite runs.
