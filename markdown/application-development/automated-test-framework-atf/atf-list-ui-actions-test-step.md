...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/automated-test-framework-atf/atf-list-ui-actions-test-step.html
release: yokohama
...
You can create a new UI action of the following types. See [Create a UI action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_EditingAUIAction.md) for more information.
