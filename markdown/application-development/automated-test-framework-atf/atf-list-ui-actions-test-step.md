...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/automated-test-framework-atf/atf-list-ui-actions-test-step.html
release: xanadu
...
You can create a new UI action of the following types. See [Create a UI action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/t_EditingAUIAction.md) for more information.
