...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/automated-test-framework-atf/atf-step-result-record.html
release: australia
...
-   For a Send REST Request - Inbound step, the REST request and response including the response body. The output field is truncated at 4096 characters.
    ...
    -   See [Filter REST request and response headers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-filter-rest-headers.md) for information on how to add a list of REST request and response headers to be filtered.
...
Reference to the test result associated with this step result. Click the information icon \( \[Omitted image "atf-test-results-item.png"\] Alt text: Reference field icon\) to view detailed test results information.
...
</table>**Parent Topic:**[Test results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-test-results-module.md)

**Related topics**  


[Test results record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-test-results-record.md)

[Test logs record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-test-log-record.md)
