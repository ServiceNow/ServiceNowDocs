...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/automated-test-framework-atf/atf-create-step.html
release: yokohama
...
9.  In the **Execution Order** field, enter an integer representing the order in which you want the test to execute this step.
    ...
    For more information on **Execution Order**, see [Edit automated test step order](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/atf-edit-step-order.md).

10. Fill in the fields that apply to this step.

    For instructions, see [Automated Test Framework \(ATF\) test step categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/test-step-categories.md).
