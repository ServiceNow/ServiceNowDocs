...
4.  From the left panel of the Add Test Step form, select the test step category, or select **All Steps** to view all available test steps for all test categories.
    ...
    **Note:** When selecting certain types of server tests, you can specify whether a positive or negative test result constitutes a successful test outcome. For more information, see Assert type in [Test your apps with the ATF](../concept/automated-test-framework.md).
...
10. Fill in the fields that apply to this step.
    ...
    For instructions, see [Test step categories](../reference/test-step-categories.md).
