...
1.  Navigate to related transaction record in the system transaction log.
    ...
    -   From the [Step results record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-step-result-record.md), view transactions in the Step transactions related list.
    -   From the [Test Results record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-test-results-record.md), view transactions in the Test Transactions related list.
