...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/automated-test-framework-atf/atf-run-suite.html
release: australia
...
The [test execution property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-admin-properties.md) must be enabled. You must have an admin or atf\_test\_admin role to do so.
...
3.  Click the row containing the test suite you want to run.
    ...
    The system displays the [Test Suite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-test-suite-record.md) form.
...
5.  Choose among any currently running test clients, or start a new runner.
    ...
    For more information, review [Browser recommendations for all tests and suites](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-test-runners.md).

    If the tests associated with the test suite only include [server test steps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/server-test-steps.md), the system executes the tests without displaying the Pick a Browser dialog.
