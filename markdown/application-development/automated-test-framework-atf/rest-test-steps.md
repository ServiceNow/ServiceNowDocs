...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/automated-test-framework-atf/rest-test-steps.html
release: xanadu
...
breadcrumb: [Server test steps, Building and running automated tests with the Automated Test Framework, Test your apps with the ATF, Testing and debugging applications, Building applications]
---
...
**Parent Topic:**[Server test steps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/automated-test-framework-atf/server-test-steps.md)
