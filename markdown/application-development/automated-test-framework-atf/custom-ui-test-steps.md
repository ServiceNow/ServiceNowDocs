...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/automated-test-framework-atf/custom-ui-test-steps.html
release: yokohama
...
See [Override component data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/override-component-data-type.md) for more information.
...
\[Omitted image "atf-example-custom-ui-kb-article.png"\] Alt text: Page displaying KB0011110 "ServiceNow Secure Coding guide for Instance developers"
...
\[Omitted image "atf-example-kb-test-steps-enlarged.png"\] Alt text: Screenshot displaying example test with seven test steps.
...
\[Omitted image "atf-version-order.png"\] Alt text: Image showing order for duplicate components
...
\[Omitted image "atf-default.png"\] Alt text: Image showing default value of components
...
-   **[Page Inspector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/atf-page-inspector.md)**  
...
-   **[Enable and use the page inspector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/enable-page-inspector.md)**  
...
-   **[Create a custom UI test](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/create-custom-ui-test.md)**  
Test components in custom UI pages.
-   **[Override component test actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/develop-testable-components.md)**  
...
-   **[Override component data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/override-component-data-type.md)**  
...
-   **[Select2 functionalities in ATF](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/atf-select2.md)**  
