...
The [Step execution script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-config-script.md) field determines the actions the system executes when a step with this config runs.
...
-   **[Create a custom step configuration category](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-create-custom-category.md)**  
