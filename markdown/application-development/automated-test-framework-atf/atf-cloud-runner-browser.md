...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/automated-test-framework-atf/atf-cloud-runner-browser.html
release: zurich
...
breadcrumb: [Pick a browser, UI test steps, Building and running automated tests with the Automated Test Framework, Test building and execution, Automated Test Framework \(ATF\), Testing and debugging applications, Building applications]
---
...
**Note:** See [ATF Test Generator and Cloud Runner](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/servicenow-platform/atf-tg-cr-intro.md) for more information.

**Parent Topic:**[Pick a browser](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/automated-test-framework-atf/atf-pick-a-browser.md)
