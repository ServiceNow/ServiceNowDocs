...
-   The [History \[sys\_history\_line\] table](https://www.servicenow.com/docs/access?context=c_HistorySets&version=zurich&pubname=zurich-platform-security&ft:locale=en-US)
-   The [ECC Queue table \[ecc\_queue\]](https://www.servicenow.com/docs/access?context=r_DiscoveryStatusECCQueue&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).
-   The Email [\[sys\_email\]](https://www.servicenow.com/docs/access?context=c_SystemMailboxes&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) [Email Log \[sys\_email\_log\]](https://www.servicenow.com/docs/access?context=r_EmailLogs&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) tables
-   The [Report Executions \[report\_executions\] and ReportStats \[report\_stats\]](https://www.servicenow.com/docs/access?context=report-statistics&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US) tables.
