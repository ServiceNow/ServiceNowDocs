...
-   Tests which involve impersonated users which no longer exist fail.
    ...
    **Tip:** It is recommended to create a new user to avoid data dependencies. See [Create a User](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/test-steps-server-category.md), for more information.
...
-   Tests can impersonate users with the snc\_external role, which allows testing users who do not have login access. See [Explicit Roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-security/explicit-roles.md) for requirements of the snc\_external role.
...
-   See [Step Execution Scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-config-script.md) for Run Server Side script example.
...
[Create custom step configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-create-custom-step.md)
...
[Step description generation script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/automated-test-framework-atf/atf-config-desc-script.md)
