...
-   Tests can impersonate users with the snc\_external role, which allows testing users who do not have login access. See Explicit Roles for requirements of the snc\_external role.
