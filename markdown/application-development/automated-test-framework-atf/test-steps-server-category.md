...
-   Tests can impersonate users with the snc\_external role, which allows testing users who do not have login access. See [Explicit Roles](https://www.servicenow.com/docs/access?context=explicit-roles&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) for requirements of the snc\_external role.
