...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/automated-test-framework-atf/atf-test-runners.html
release: australia
...
To work with the client test runner module, the [test execution property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-admin-properties.md) must be enabled.
...
If the test execution property is disabled when you select this module, the system displays a message and a link to the [automated test framework properties page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-admin-properties.md) where you can enable it.

## Additional debugging functionality

If you have enabled [additional debugging functionality](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-admin-properties.md), the client test runner module displays two tabs: **Execution Frame** and **Debug Info**. The **Execution Frame** displays the information normally shown by the client test runner and the **Debug Info** displays additional debugging information.
...
-   The browser must meet the criteria you specified on the [Scheduled suite run record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-suite-sched-run-record.md).
-   A client test runner meeting the criteria you specified on the [Scheduled suite run record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-suite-sched-run-record.md) must be available to run the test suite at the scheduled time. The system cannot automatically open a client test-runner session.
...
When you start a client test runner, the system registers that runner in the Active Test Runners table. You can view this table in the [Active Manual Test Runners](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-active-manual-runners-module.md) module and the [Active Scheduled Test Runners](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-active-sched-runners-module.md) module. These two modules provide views of the same table, filtered to show only manual or only scheduled test runners.
...
**Parent Topic:**[UI test steps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/ui-test-steps.md)

**Related topics**  


[Client test runner](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-client-test-runner-module.md)

[Scheduled client test runner](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-sched-test-runner-module.md)

[Allowed client errors](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/whitelisted-client-errors.md)
