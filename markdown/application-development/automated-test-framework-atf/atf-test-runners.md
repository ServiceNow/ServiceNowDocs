...
To work with the client test runner module, the [test execution property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/atf-admin-properties.md) must be enabled.
...
-   The browser must meet the criteria you specified on the [Scheduled suite run record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/atf-suite-sched-run-record.md).
