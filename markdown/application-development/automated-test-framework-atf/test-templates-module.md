...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/automated-test-framework-atf/test-templates-module.html
release: australia
...
To view or edit a test template, click the row for the template you want. For more information, see [Edit automated test steps template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-edit-template.md).
...
-   **[Automated Test Template record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/automated-test-framework-atf/atf-test-template-record.md)**  
