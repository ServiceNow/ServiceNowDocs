...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/automated-test-framework-atf/atf-sched-suites.html
release: yokohama
...
On the [Automated Test Framework Properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/atf-admin-properties.md) form, you can set options affecting the format and content of the email.
