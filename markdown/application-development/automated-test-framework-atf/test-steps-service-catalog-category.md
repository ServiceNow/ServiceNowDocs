...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/automated-test-framework-atf/test-steps-service-catalog-category.html
release: yokohama
...
Service Catalog step configurations support parametrized tests. For more information on parametrized tests, refer to [Parameterized tests](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/automated-test-framework-atf/parameterized-tests.md).
