...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/application-repository-self-hosted/what-to-expect-post-clone-for-app-customization.html
release: yokohama
