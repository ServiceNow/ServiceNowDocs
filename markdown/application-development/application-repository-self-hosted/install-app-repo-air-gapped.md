...
2.  After installing, complete the steps in [Configure the application repository on an air-gapped instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/application-repository-self-hosted/configure-app-repo-air-gapped.md).
