...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/application-repository-self-hosted/install-app-repo-air-gapped.html
release: yokohama
...
2.  After installing, complete the steps in [Configure the application repository on an air-gapped instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/application-repository-self-hosted/configure-app-repo-air-gapped.md).
