...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/application-repository-self-hosted/convert-installed-applications-to-development-mode.html
release: yokohama
