...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/application-repository-self-hosted/install-customizations-from-app-repo.html
release: australia
