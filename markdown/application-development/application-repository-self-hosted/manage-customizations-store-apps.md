...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/application-repository-self-hosted/manage-customizations-store-apps.html
release: yokohama
...
2.  Use these steps to create application-customizations from the navigation pane.
    ...
    3.  To open this application in Studio, select the stack menu, and then select **Edit in Studio**.
        ...
        \[Omitted image "app-picker-edit-in-studio.png"\] Alt text: Edit a store application in Studio in the application picker.
