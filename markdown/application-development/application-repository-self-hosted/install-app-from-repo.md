---
title: Install an application from the application repository
description: Install your application on an instance so that employees can start using the application that you developed.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/application-repository-self-hosted/install-app-from-repo.html
release: yokohama
...
-   [Publish an application to the application repository](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/application-repository-self-hosted/t_PublishAppsToTheAppRepository.md).
...
4.  Click **Install**.
    ...
    \[Omitted image "install-app-from-repo.png"\] Alt text: Install application screen
