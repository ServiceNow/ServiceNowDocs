...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/application-repository-self-hosted/preserve-applications-during-clone.html
release: yokohama
...
[bundle-cadev.t_LinkAnApplicationToSourceControl]

[bundle-cadev.t_CommitChanges]
...
[bundle-cadev.t_ApplyRemoteChanges]

[bundle-cadev.t_ImportAppFromSourceControl]

[Load customizations from a single XML file](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/system-update-sets/t_SaveAnUpdateSetAsAnXMLFile.md)
