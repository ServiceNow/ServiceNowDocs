...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/application-repository-self-hosted/publish-customizations-app-repo.html
release: yokohama
...
2.  Find the application by typing its name in the Filter Navigation box.
    ...
    \[Omitted image "filter-box.png"\] Alt text: Filter navigation box
