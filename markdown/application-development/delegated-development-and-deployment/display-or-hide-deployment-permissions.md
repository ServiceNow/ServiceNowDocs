...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/delegated-development-and-deployment/display-or-hide-deployment-permissions.html
release: yokohama
...
1.  In the Navigation filter, enter `sys_properties.list`.
    ...
    **Note:** For details on how to add and enable system properties, see [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_AddAPropertyUsingSysPropsList.md).
