...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/delegated-development-and-deployment/add-deployment-user-roles.html
release: zurich
...
breadcrumb: [Instance-specific user roles, Delegating deployment permissions, Administer, Delegated Development, Planning your application, Building applications]
---
...
1.  Navigate to **All** &gt; **User Administration** &gt; **Users** and then open a user record.
    ...
    **Note:** For details on how to assign a role to a user, refer to [Assign a user role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_AssignARoleToAUser.md).
