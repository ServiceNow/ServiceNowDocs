...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/delegated-development-and-deployment/add-deployment-user-roles.html
release: yokohama
...
breadcrumb: [Instance-specific deployment user roles, Configuring Delegated Development, Delegated Development, Planning your application, Building applications]
---
...
1.  Navigate to **All** &gt; **User Administration** &gt; **Users** and then open a user record.
    ...
    **Note:** For details on how to assign a role to a user, refer to [Assign a user role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/user-administration/t_AssignARoleToAUser.md).
