...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/t\_LinkAnApplicationToSourceControl.html
release: xanadu
...
-   Role required: admin
-   Learn more about [Managing application-customizations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/application-repository-self-hosted/manage-customizations-store-apps.md).
...
-   Learn more: [Legacy - Migrate completed update set history to Source Control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/migrate-update-set-history.md)
...
2.  Navigate to **Source Control** &gt; **Link to Source Control**.
    ...
    Studio displays the Link to Source Control dialog box.\[Omitted image "mid-server-ssh-box.png"\] Alt text: Link to Source Control dialog box
...
The credential to be used with the selected protocol. See Getting started with Credentials to learn more about creating credentials.**Note:** If you select the SSH network protocol, enter a valid credential of the SSH private key type. If you select the https protocol, enter a valid credential of the Basic Auth credentials type.
...
Be sure that the MID server user can create files to the sys\_attachment table and that the table can accept files of the “bundle” type.
 ...
 Linking or [importing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/t_ImportAppFromSourceControl.md) an application through a MID Server enables access to repositories behind a firewall. See the [Using MID Server with source control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/tips-source-control-midserver.md) and MID Server topics to learn more
...
-   **[Legacy - Using MID Server with source control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/tips-source-control-midserver.md)**  
