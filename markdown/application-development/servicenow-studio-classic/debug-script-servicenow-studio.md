...
2.  On the home page, enter `Script Debugger` in the main search.

3.  Select the **Script Debugger** module.

4.  Use the Script Debugger to debug scripts.

    Some tabs and features are role-dependent. For more information, see [Script Debugger and Session Log](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/scripts/script-debugger.md).
