...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/create-an-application-in-servicenow-studio.html
release: xanadu
...
4.  Enter the basic information for the app on the form.
    ...
    3.  Specify the **Scope**.
        ...
        For more information about working with scopes, see [Application scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/building-applications/c_ApplicationScope.md).

    4.  Select **Continue**.

5.  Define user access to the app by adding roles.

    ServiceNow Studio automatically defines default admin and user roles. You can remove the pre-defined roles or add more roles. For more information about roles, see .
