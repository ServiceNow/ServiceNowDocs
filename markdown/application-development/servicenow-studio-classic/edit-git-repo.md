...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/edit-git-repo.html
release: xanadu
...
1.  In Studio, select **Edit Repository Configuration**.
    ...
    \[Omitted image "edit-git-repo.png"\] Alt text: Edit Repository Configuration menu item

2.  Choose **https** or **ssh** Network protocol and enter the URL address of your repository.

    \[Omitted image "edit-repo-config.png"\] Alt text: Choose the http network protocol \[Omitted image "edit-repo-ssh.png"\] Alt text: Choose the ssh network protocol
