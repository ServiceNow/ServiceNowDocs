...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/publish-app-from-studio.html
release: xanadu
...
2.  The current state of the application is committed to Source Control, including any untracked or uncommitted changes.
    ...
    This occurs because when the application is published, all the untracked and uncommitted changes are also published. Therefore, the state of the application in the Git repository matches what is published. See the [Legacy - Commit changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/t_CommitChanges.md) topic for more information about the **glide.sourcecontrol.default\_commit\_mode** property.
