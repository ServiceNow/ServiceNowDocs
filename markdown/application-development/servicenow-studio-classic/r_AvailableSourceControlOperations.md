...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/r\_AvailableSourceControlOperations.html
release: xanadu
...
Allows admins to apply remote changes from the Source Control repository, to resynchronize with the instance.**Note:** This operation is only available if Delta loading is being used for the repository. See [Legacy - Delta loading](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/delta-loading.md).
...
</table>**Parent Topic:**[Legacy - Source Control integration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/c_SourceControlIntegration.md)
