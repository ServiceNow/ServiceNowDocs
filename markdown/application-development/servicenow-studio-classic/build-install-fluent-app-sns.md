...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/servicenow-studio-classic/build-install-fluent-app-sns.html
release: australia
...
Create, convert, or clone an application and add it to the Explorer. For more information, see [Create an app in source code](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/servicenow-studio-classic/create-an-app-in-source-code.md).
