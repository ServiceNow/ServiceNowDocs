...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/t\_StashLocalChanges.html
release: xanadu
...
3.  Click **Stash Local Changes**.
    ...
    \[Omitted image "stash-change-description.png"\] Alt text: Stash change dialog
