...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/servicenow-studio-classic/sn-studio-working-with-metadata.html
release: yokohama
...
\[Omitted image "sn-studio-file-nav-expanded.png"\] Alt text: Expanded Automation section of the File Categories section of the Navigator
