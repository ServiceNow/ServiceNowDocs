...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/t\_MoveAppFilesBetweenGlobalApps.html
release: xanadu
...
3.  Select the global application.
    ...
    \[Omitted image "MoveToApplication.png"\] Alt text: Move application files to a global application
