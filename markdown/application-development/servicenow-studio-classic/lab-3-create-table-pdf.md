...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/servicenow-studio-classic/lab-3-create-table-pdf.html
release: yokohama
...
13. Select **Go to PDF extractor**.
    ...
    **Note:** The PDF extractor opens with the PDF contents on the left side and the tables and fields list on the right. You must select each element from the PDF that you want to bring into the table.
    ...
    \[Omitted image "sn-studio-tutorial-pdf-extract.png"\] Alt text: The PDF extractor opens with the PDF on one side of the screen and the table on the other.
...
17. Select each check box on the PDF and select **Add** after each one.
    ...
    \[Omitted image "sn-studio-tutorial-pdf-questions.png"\] Alt text: Add each question and answer set to the table by selecting them from the PDF.
