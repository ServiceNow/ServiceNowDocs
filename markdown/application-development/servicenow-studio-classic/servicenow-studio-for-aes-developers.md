...
\[Omitted image "sn-studio-app-list-bs1.png"\] Alt text: Access the Apps list in the Navigator panel to see all your applications.

To access frequently used apps, app files, and lists quickly, bookmark them. For more information, see [Bookmark apps, files, and lists in ServiceNow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-studio-classic/qs-bookmark-apps-files.md).
...
-   [Metadata record categories in the ServiceNow Studio Navigator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-studio-classic/sn-studio-working-with-metadata.md)
...
For more information, see [Open apps and app files across scopes in ServiceNow Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-studio-classic/qs-open-apps-files-across-scopes.md).
...
\[Omitted image "sn-studio-create-app-otto.png"\] Alt text: Explore the App Gallery to find examples of completed applications.
