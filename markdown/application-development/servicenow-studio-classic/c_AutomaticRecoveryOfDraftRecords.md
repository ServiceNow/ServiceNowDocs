...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/c\_AutomaticRecoveryOfDraftRecords.html
release: xanadu
...
\[Omitted image "AutorecoveryUnsavedChanges.png"\] Alt text: The automatic recovery message reads, Previous unsaved edits to this record have been recovered. Continue to edit or clear the changes.
...
-   **[Legacy - Auto recovery properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/r_AutoRecoveryProperties.md)**  
Administrators can configure how Studio handles the recovery of draft records by navigating to **Auto Recovery** &gt; **Properties**.
-   **[Legacy - Auto recovery dictionary attribute](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/r_AutoRecoveryDictionaryAttributes.md)**  
