...
-   Users with the delegated\_developer role have access to:
    ...
    -   All apps within the scope you have access to. For more information on scopes, see [Application scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/c_ApplicationScope.md).
