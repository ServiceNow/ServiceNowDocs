...
10. Select the submit icon \(\[Omitted image "sn-studio-na-submit-icon.png"\] Alt text: submit icon\) and wait a few moments for Now Assist to generate a code snippet.
...
1.  Navigate to the We Volunteer app dashboard, and select the more options icon \(\[Omitted image "sn-studio-more-options-icon.png"\] Alt text: more options icon\).
