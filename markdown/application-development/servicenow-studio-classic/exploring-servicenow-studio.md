...
-   Build, manage, and deploy custom, base system, or global applications and global metadata records, all without switching between tools. You can also customize store apps.
-   Search for and edit any type of metadata record using the Navigator panel taxonomy.
