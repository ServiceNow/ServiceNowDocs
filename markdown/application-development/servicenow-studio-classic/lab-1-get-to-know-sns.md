...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/servicenow-studio-classic/lab-1-get-to-know-sns.html
release: yokohama
...
4.  Select the search box.
    ...
    \[Omitted image "sn-studio-reg-search.png"\] Alt text: Open the search bar to find files.
...
11. Group these file tabs by scope by selecting your user profile picture in the top right corner of the screen.
    ...
    \[Omitted image "sn-studio-user-menu.png"\] Alt text: Open the user menu
...
1.  Select the **Apps** icon \(\[Omitted image "sn-studio-apps-icon.png"\] Alt text: apps icon\).

2.  In the filter box, enter `Employee Profile`.

3.  Using the filter icon \(\[Omitted image "sn-studio-filter-icon.png"\] Alt text: filter icon\), select **Store**.

    \[Omitted image "sn-studio-lab-filter.png"\] Alt text: Use the filter to select Store
...
7.  Select the more options icon \(\[Omitted image "sn-studio-more-options-icon.png"\] Alt text: more options icon\), and toggle on the **Show parent categories** option.
...
9.  Select the collapse all icon \(\[Omitted image "sn-studio-collapse-all-icon.png"\] Alt text: collapse all\).
...
1.  Select the **File Categories** icon \(\[Omitted image "sn-studio-files-icon.png"\] Alt text: file categories icon\).
...
4.  In the filter navigator, select the back icon \(\[Omitted image "sn-studio-back-icon.png"\] Alt text: back icon\).
...
8.  In the integrated tab that opens, open the list filter and add a new condition: **Table - is - incident**.
    ...
    \[Omitted image "sn-studio-tutorial-filtering.png"\] Alt text: Traditional platform filtering is available for you in ServiceNow Studio
