...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/add-multiple-files-to-global-app.html
release: xanadu
...
3.  Enter the name of a new global application or select an existing global application.
    ...
    \[Omitted image "migrate-global-app-updates.png"\] Alt text: Migrate to global application
