...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/servicenow-studio-classic/lab-5-create-flow-with-flow-gen.html
release: yokohama
...
6.  Select **Generate flow preview**.
    ...
    **Note:** If you're prompted to keep or remove formatting in pasted content, select **Remove formatting**.
    ...
    \[Omitted image "sn-studio-tutorial-flow-preview.png"\] Alt text: Preview of a flow.
