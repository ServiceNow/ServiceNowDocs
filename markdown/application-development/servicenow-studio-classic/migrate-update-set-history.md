...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/migrate-update-set-history.html
release: xanadu
...
-   Role required: admin
-   Read the [Legacy - Link an application or application-customization to source control](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/t_LinkAnApplicationToSourceControl.md) topic
...
Regardless of which option you select, if you select **Continue**, the **Link to Source Control** operation starts, and all completed update sets and all Customer Update records are deleted. If you need to complete any additional update sets or choose not to continue, select **Cancel**. \[Omitted image "link-to-source-control-update-set.png"\] Alt text: Dialog box requesting your choices for selecting your update set history
...
\[Omitted image "link-update-set-xml-example.png"\] Alt text: Sample XML

\[Omitted image "link-update-set-property-value.png"\] Alt text: Value of the property

\[Omitted image "link-update-set-historical-commit.png"\] Alt text: The result displaying in the commit message
