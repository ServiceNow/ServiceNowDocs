...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/t\_SearchForAppFilesByNameOrType.html
release: xanadu
...
4.  Enter a search string.
    ...
    \[Omitted image "CreateNowStudioGoTo.png"\] Alt text: A pop-up window with the Go To field containing the search string Mo and the search results
