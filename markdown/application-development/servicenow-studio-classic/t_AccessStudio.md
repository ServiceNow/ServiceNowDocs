...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/t\_AccessStudio.html
release: xanadu
...
1.  Select the path available to your role.
    ...
    \[Omitted image "select-app.png"\] Alt text: The Select Application modal dialog with options to create application, import from source control or open an existing application.
