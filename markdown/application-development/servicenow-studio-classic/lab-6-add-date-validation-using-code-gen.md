...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/servicenow-studio-classic/lab-6-add-date-validation-using-code-gen.html
release: yokohama
...
11. Select the Submit icon \(\[Omitted image "sn-studio-na-submit-icon.png"\] Alt text: submit icon\) and wait a few moments for Now Assist to generate a code snippet.
