...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/t\_CommitChanges.html
release: xanadu
...
1.  Navigate to **All** &gt; **Source Control** &gt; **Commit Changes**.
    ...
    \[Omitted image "selective-commit.png"\] Alt text: Select files to commit
