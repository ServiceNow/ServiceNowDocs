...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/servicenow-studio-classic/t\_ResolveConflicts.html
release: xanadu
...
<table id="choicetable_pqx_jdv_lv"><tbody><tr><td id="d47898e136">
...
</td></tr><tr><td id="d47898e149">

**Manually merge changes**

</td><td>

Individually select which changes to apply. Go to [Step 6](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/servicenow-studio-classic/t_ResolveConflicts.md).

</td></tr></tbody>
</table>3.  If you want to apply or discard all stashed changes, select an **Action**.

<table id="choicetable_wln_1bv_lv"><tbody><tr><td id="d47898e174">
