...
breadcrumb: [Explore, App generation, AI tools and files, Use, ServiceNow Studio, Developing your application, Building applications]
---
...
App generation works best when you include specific details about your requirements. As ServiceNow Otto® makes suggestions and generates a preview, respond with additional details to refine the application.

-   **Initiation**

    ServiceNow Otto® asks for the main purpose of your application so that it can generate an initial structure. You can start with a general statement. For example, `I'd like to manage how my employees travel within my business.`

-   **Conversation**

    Describe how you want your app to work and respond to ServiceNow Otto® inquiries so that it can refine the application to match your requirements.
    ...
    You can also share only what you know and collaborate with ServiceNow Otto® to fill in the gaps. For example:

    -   `I need to collect and monitor relevant data for each employee trip. Can you suggest anything?`

        ServiceNow Otto® suggests:
    ...
    -   `That sounds good, thanks.`
        ...
        ServiceNow Otto® understands your workflow and suggests ways to implement the desired functionality:
    ...
    Throughout the conversation, ServiceNow Otto® adjusts its understanding of your application requirements based on your input.


For more information about having productive conversations with ServiceNow Otto®, see .

**Parent Topic:**[Exploring app generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-studio-classic/sns-exploring-now-assist-gen.md)
