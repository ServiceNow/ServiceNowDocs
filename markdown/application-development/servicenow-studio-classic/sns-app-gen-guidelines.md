...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/servicenow-studio-classic/sns-app-gen-guidelines.html
release: yokohama
...
breadcrumb: [Exploring Now Assist for app generation in ServiceNow Studio, Now Assist for app generation in ServiceNow Studio, Using ServiceNow Studio, Building applications with ServiceNow Studio, Developing your application, Building applications]
---
...
-   **Conversation**
    ...
    **Note:** Adding a workspace while creating or editing an application is available beginning with the Yokohama Patch 3 \(May 2025\) release.
