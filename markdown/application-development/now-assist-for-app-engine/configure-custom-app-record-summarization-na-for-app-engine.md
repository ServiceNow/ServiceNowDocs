...
9.  Define which users have access to the skill.
    ...
    2.  Follow the instructions outlined in [Configure security controls for a skill](https://www.servicenow.com/docs/access?context=nask-access-control&version=australia&pubname=australia-intelligent-experiences&ft:locale=en-US) to control who has access to the skill.
