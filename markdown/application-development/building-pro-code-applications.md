...
The ServiceNow IDE is an implementation of Visual Studio Code for the Web on the ServiceNow AI Platform. The ServiceNow SDK uses Visual Studio Code Desktop locally. For more information, see [Building applications in source code](../concept/building-applications-source-code.md).
...
-   **[Client-side scripting](../../../script/client-scripts/concept/client-side-scripting-overview.md)**
...
-   **[Now Assist for code generation](../../../script/now-assist-for-code/concept/now-assist-code-landing.md)**
...
-   **[Server-side scripting](../../../script/server-scripting/concept/c_ServerScripting.md)**
