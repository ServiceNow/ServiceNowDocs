...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/releaseops/create-runbook-task.html
release: australia
product: ReleaseOps
...
Runbook tasks enable you to pause playbook progress until a task is resolved. To learn more about runbook tasks, see [Runbook tasks in ReleaseOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/releaseops/runbook-tasks.md).
