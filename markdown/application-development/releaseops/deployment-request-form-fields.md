...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/releaseops/deployment-request-form-fields.html
release: australia
product: ReleaseOps
...
The state of the deployment request, which is changed throughout the release process. See [Deployment request states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/releaseops/deployment-request-states.md).
