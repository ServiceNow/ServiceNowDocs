---
title: Configure a new ReleaseOps ecosystem
description: Configure a new ReleaseOps ecosystem using the sample pipelines and playbooks to begin deploying changes from your development to test to production instances.
locale: en-US
release: zurich
product: ReleaseOps
...
This task enables you to configure a ReleaseOps ecosystem using the sample pipelines and playbooks. To learn about custom pipelines in ReleaseOps, see [Create a custom pipeline](create-release-ops-pipeline.md#).

## Before you begin

**Note:** Starting with version 1.2.1 of ReleaseOps, you can configure a new ecosystem using guided setup. For more information, see [Complete ReleaseOps guided setup](complete-guided-setup.md).
