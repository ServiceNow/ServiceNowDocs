...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/releaseops/instances-in-releaseops-configuration.html
release: zurich
product: ReleaseOps
...
For more information about multi-instance management, see [Cross-instance application trust configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/grant-access-v2.md). To see a complete list of managed instances, you can navigate to **All** &gt; **Multi-instance management** &gt; **Managed instances**.
