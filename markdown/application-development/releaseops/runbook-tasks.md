...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/releaseops/runbook-tasks.html
release: australia
product: ReleaseOps
...
To add runbook tasks to your deployment requests, see [Create a runbook task](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/releaseops/create-runbook-task.md).
