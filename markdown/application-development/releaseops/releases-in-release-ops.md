...
For more information about creating a release, see [Create a release](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/releaseops/create-a-release.md).
