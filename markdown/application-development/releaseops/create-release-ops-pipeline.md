...
For more information about playbooks, see [Exploring Playbook](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/process-automation-designer.md).
...
1.  Duplicate one of the ReleaseOps playbooks.
    ...
    For more information, see [Duplicate Playbooks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/duplicate-process.md).
...
3.  Add or update decisions in the playbook as needed.
    ...
    For more information, see [Decision activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/create-a-decision-activity.md).
