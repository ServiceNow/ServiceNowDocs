...
To learn more about the different components of a ReleaseOps release and the ReleaseOps deployment process, see [Exploring ReleaseOps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/releaseops/exploring-release-ops.md).
...
-   Developers can create deployment requests for scheduled and on-demand releases, which they attach their update sets to.
