...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/build-data-model.html
release: zurich
topic_type: concept
...
**Note:** Consider creating applications with help from agentic AI. For more information, see [Agentic development on the ServiceNow AI Platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/use-ai-capabilities-in-custom-apps.md).
...
**Parent Topic:**[Define and build the data model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/define-and-build-data-model.md)
