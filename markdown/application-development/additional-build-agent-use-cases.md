...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/additional-build-agent-use-cases.html
release: zurich
...
-   **Playbook authoring**
    ...
    Use Build Agent to author Playbook Designer artifacts through a conversation. As of Zurich Patch 13, you can have Build Agent do the following for playbooks that it generates:
