...
|Element|Description|
|-------|-----------|
|Year picker|Set the year for dashboard charts to display, for example, FY25. You can select multiple years.|
|Status picker|Set the journal entry task status for dashboard charts to display, for example, drafted or approved. You can select multiple statuses.|
|New Journal Entry|Select to open the **Create New Journal Task** form and create a task.|
