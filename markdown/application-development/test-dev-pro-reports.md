...
"Reporting" generally refers to showing the data inside facts tables like Incident \[incident\]. You can also create [key performance indicators \(KPIs\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/glossary/now-platform-glossary.md) to track changes in this data over time, through the Performance Analytics application.
