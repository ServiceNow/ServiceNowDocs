...
-   Create the data visualizations and the dashboards inside the Platform Analytics experience, but then place the dashboards inside UI Builder pages using the Dashboard page template. This approach lets you use the convenience and special features of the Platform Analytics experience to create dashboards, data visualizations, and filters in your own experiences/workspaces. This approach also gives you the freedom to customize the page configuration partially. For more information, see [Creating Platform Analytics pages in your own workspace](https://www.servicenow.com/docs/access?context=adding-analytics-center-to-ws&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
-   Create a [technical dashboard](https://www.servicenow.com/docs/access?context=now-platform-glossary&version=zurich&pubname=zurich-glossary&section=gloss-technical-dashboard&ft:locale=en-US) and populate it inside UI Builder. This approach is almost the same as creating your own UI Builder page from scratch, but the dashboard is available in the dashboard library, has dashboard details, and can be shared like other dashboards. For more information, see [Technical dashboards](https://www.servicenow.com/docs/access?context=technical-dashboards&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
