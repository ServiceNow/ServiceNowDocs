...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/workspace-component.html
release: yokohama
topic_type: concept
...
-   **Add a component to a Workspace record view**
    ...
    You can add custom or standard components to the component area in the Workspace record view. For more information, see [Forms](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/form-configurable-workspace.md).
