...
description: Use Build Agent to add new files or modify existing files in ServiceNow applications to assist with ongoing metadata and app development and maintenance.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/creating-or-updating-an-app-file.html
release: zurich
topic_type: concept
...
\[Omitted image "sn-studio-ba-create-update-file.png"\] Alt text: Use the Create a file and Update a file options to get started adding files to your application.
