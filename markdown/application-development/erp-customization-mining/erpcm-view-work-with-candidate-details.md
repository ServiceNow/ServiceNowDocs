...
Additional information about the candidate.
    ...
    For more information, see [Check candidate recommendations in ERP-CM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/erp-customization-mining/erpcm-work-with-recommendations.md).
...
5.  View details on which tables were relevant to the candidate and the details of their scan on the ERP system by selecting the **ERP scan results** tab.
    ...
    For a description of the field values, see [ERP-CM candidate scan results field descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/erp-customization-mining/erpcm-candidate-scan-results-descriptions.md).
...
8.  Research candidates related to the current candidate and their tables by selecting the **Similar candidates** tab.
    ...
    For a description of the field values, see [ERP-CM similar candidates field descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/erp-customization-mining/erpcm-similar-candidates-field-descriptions.md).
