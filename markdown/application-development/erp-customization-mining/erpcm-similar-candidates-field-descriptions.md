...
description: On a candidate record in ERP Customization Mining \(ERP-CM\) the Similar candidates tab displays information about similar candidates for replatforming ERP \(Enterprise Resource Planning\) apps.
locale: en-US
