...
Check box to indicates that this decision input is the [display value](https://www.servicenow.com/docs/access?context=c_DisplayValues&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) for reference fields.
...
-   List menu with -- None --
-   [Suggestion field type](https://www.servicenow.com/docs/access?context=t_AddingASuggestionField&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
