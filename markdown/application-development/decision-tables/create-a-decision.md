...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/decision-tables/create-a-decision.html
release: xanadu
...
Check box to indicates that this decision input is the [display value](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/c_DisplayValues.md) for reference fields.
...
-   List menu with -- None --
-   [Suggestion field type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/t_AddingASuggestionField.md)
