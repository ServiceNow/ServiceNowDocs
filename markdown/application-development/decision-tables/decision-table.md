...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/decision-tables/decision-table.html
release: xanadu
...
To interact with Decision Tables in script, use the [DecisionTableAPI - Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/server-api-reference/DecisionTableAPI.md).
...
-   **[Decision tables in the classic environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/decision-tables/decision-tables-classic-ui.md)**  
