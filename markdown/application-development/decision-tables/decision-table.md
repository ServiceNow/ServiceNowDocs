...
To interact with Decision Tables in script, use the [DecisionTableAPI - Scoped, Global](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/server-api-reference/DecisionTableAPI.md).
...
-   **[Decision tables in the classic environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/decision-tables/decision-tables-classic-ui.md)**  
