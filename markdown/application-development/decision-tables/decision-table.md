...
To interact with Decision Tables in script, use the [DecisionTableAPI - Scoped, Global](https://www.servicenow.com/docs/access?context=DecisionTableAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
