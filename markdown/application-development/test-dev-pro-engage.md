...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/test-dev-pro-engage.html
release: brazil
topic_type: concept
...
[Virtual Agent Designer \[Omitted image "icon-va.png"\] Alt text: Virtual Agent Designer. Create and manage virtual agent topics using the ServiceNow platform.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/conversational-interfaces/conversation-designer-virtual-agent.md)
