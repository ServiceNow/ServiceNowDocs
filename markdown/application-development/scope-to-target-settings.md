...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/scope-to-target-settings.html
release: yokohama
...
**Parent Topic:**[Set the application scope, application resource, and event access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scope-resource-access.md)
