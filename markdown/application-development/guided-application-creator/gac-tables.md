...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/guided-application-creator/gac-tables.html
release: xanadu
...
\[Omitted image "gac-good-spreadsheet.png"\] Alt text: A spreadsheet with horizontal columns and a header label for each
...
For more information on extension models, see [Table extension and classes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/table-administration-and-data-management/table-extension-and-classes.md).
