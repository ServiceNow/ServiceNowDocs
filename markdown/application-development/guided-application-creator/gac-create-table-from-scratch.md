...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/guided-application-creator/gac-create-table-from-scratch.html
release: yokohama
...
Type of field. For more information on the different field types, see [Field types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/r_FieldTypes.md).
...
Unique label for the table \(such as **Laptops** or **Thin clients**\). The label appears on list and form views for the table. See Field Labels in [Data dictionary tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/c_DataDictionaryTables.md).
...
Option to enable other tables to extend this table.
 ...
 For more information on table extension, see [Table extension and classes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/table-extension-and-classes.md).
...
7.  To add more tables to your application, follow the steps in [Designate data tables in Guided Application Creator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/guided-application-creator/gac-designate-data-table.md).
