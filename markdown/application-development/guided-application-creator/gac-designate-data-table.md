...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/guided-application-creator/gac-designate-data-table.html
release: xanadu
...
<table id="choicetable_phv_sxd_vhb"><thead><tr><th align="left" id="d41206e128">

Option

</th><th align="left" id="d41206e131">

Procedure

</th></tr></thead><tbody><tr><td id="d41206e137">
...
3.  Follow the steps for the table creation method that you selected.
    -   [Upload a spreadsheet in Guided Application Creator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/guided-application-creator/gac-upload-spreadsheet.md)
    -   [Extend a table in Guided Application Creator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/guided-application-creator/gac-extend-table.md)
