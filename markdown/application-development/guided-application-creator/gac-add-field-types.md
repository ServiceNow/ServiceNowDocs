...
For a list of field types that are available in the ServiceNow AI Platform, see [Field types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/r_FieldTypes.md).
