...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/guided-application-creator/gac-upload-spreadsheet.html
release: xanadu
...
Review the [spreadsheet guidelines](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/guided-application-creator/gac-tables.md) to ensure that your data uploads as expected.
...
11. To add more tables to your application, follow the steps in [Designate data tables in Guided Application Creator](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/guided-application-creator/gac-designate-data-table.md).
