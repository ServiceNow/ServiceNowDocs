...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/now-assist-for-creator/uib-builder-agent-concept.html
release: brazil
...
[Using UI Builder agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/now-assist-for-creator/using-ui-builder-agent.md)

[Use case: Using UI Builder Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/now-assist-for-creator/use-case-ui-builder-agent.md)
