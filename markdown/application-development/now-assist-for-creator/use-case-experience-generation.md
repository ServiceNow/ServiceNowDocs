...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/now-assist-for-creator/use-case-experience-generation.html
release: brazil
...
breadcrumb: [Use case, Use, UI generation, Use generative AI, ServiceNow Otto for Creator, Agentic development on the ServiceNow AI Platform, Building applications]
---
...
ServiceNow Otto automatically generates a fully structured multi-page experience preview, allowing developers to review the output. They can choose to save the generated experience or refine their prompt to regenerate it for further adjustments.
...
Make sure that you install UI generation and that you have the ui\_builder\_admin role. For more information, see [Install UI generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/now-assist-for-creator/install-ui-generation.md) and [Grant UI Builder admin role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/now-assist-for-creator/grant-ui-builder-admin-role.md).
...
4.  Select **Generate preview**.
    ...
    ServiceNow Otto generates and displays a preview of the experience.
...
**Parent Topic:**[UI Generation use cases](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/now-assist-for-creator/ui-generation-use-cases.md)
...
[Create an AI-generated experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/now-assist-for-creator/generate-ui.md)
