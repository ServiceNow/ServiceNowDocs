...
|-------|-------|-----|
|Simplify test failure diagnosis|[Troubleshoot test failures](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/now-assist-for-creator/atf-troubleshooting-agent-test-failure.md)|atf\_triager + now\_assist\_panel\_user|
...
-   [Use](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/now-assist-for-creator/atf-troubleshooting-agent-test-failure.md)
