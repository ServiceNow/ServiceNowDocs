...
breadcrumb: [ATF troubleshooting agent, Use agentic AI, ServiceNow Otto for Creator, Agentic development on the ServiceNow AI Platform, Building applications]
---
...
9.  Follow the automatic triaging process for the failed record.
    ...
    **Note:** See [Author, execute, and troubleshoot tests and test suites with Test Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/test-agent-use.md) if you want to execute a new application or a test.


**Parent Topic:**[ATF troubleshooting agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/now-assist-for-creator/atf-troubleshooting-agent-landing-page.md)
