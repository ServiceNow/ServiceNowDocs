...
5.  Enable the ATF troubleshooting agent skill:
    ...
    2.  Go to the **Now Assist Skills** tab and select **Creator**.![ATF troubleshooting agent is listed as Now Assist for Creator skills.](../image/atf-troubleshooting-agent.png)
