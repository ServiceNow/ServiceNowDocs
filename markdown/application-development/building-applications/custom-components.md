...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/building-applications/custom-components.html
release: xanadu
...
Alternatively, you can add a value to the `scopeName` parameter in the `now-ui.json` file. For more information, see [Change a component's application scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/building-applications/change-scope.md).
...
-   **[Set up your environment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/building-applications/set-up-environment.md)**  
...
-   **[Set up your project](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/building-applications/setup-component-project.md)**  
...
-   **[Use a proxy server with ui-component extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/building-applications/use-proxy.md)**  
...
-   **[Develop a component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/building-applications/develop-component.md)**  
Add your component code and test it using a local development server.
-   **[Develop a component for Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/building-applications/va-components.md)**  
Create a custom Virtual Agent component to gather input or display information in the Virtual Agent client interface.
-   **[Add a component to Agent Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/building-applications/workspace-component.md)**  
Use custom components to create a custom Workspace interface to fulfill the specific need of your company's agents.
-   **[Deploy a component to an instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/building-applications/deploy-to-instance.md)**  
Deploy your component to display in your instance as an application plugin.
-   **[Change a component's application scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/building-applications/change-scope.md)**  
