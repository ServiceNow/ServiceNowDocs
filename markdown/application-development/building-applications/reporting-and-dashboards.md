...
"Reporting" generally refers to showing the data inside facts tables like Incident \[incident\]. You can also create [key performance indicators \(KPIs\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/glossary/now-platform-glossary.md) to track changes in this data over time, through the Performance Analytics application.
...
-   Create the data visualizations and the dashboards inside the Platform Analytics experience, but then place the dashboards inside UI Builder pages using the Dashboard page template. This approach lets you use the convenience of the Platform Analytics experience to create dashboards, data visualizations, and filters in your own experiences/workspaces. It also gives you the freedom to customize the page configuration partially. For more information, see [Creating Platform Analytics pages in your own workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/adding-analytics-center-to-ws.md).
