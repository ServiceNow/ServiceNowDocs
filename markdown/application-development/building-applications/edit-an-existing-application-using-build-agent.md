...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/building-applications/edit-an-existing-application-using-build-agent.html
release: yokohama
...
2.  From the Application list, select the application that you want to edit.
    ...
    \[Omitted image "build-agent-edit.png"\] Alt text: Welcome to Build Agent message
...
From the Activity Bar, select the File Explorer view \(\[Omitted image "servicenow-ide-file-explorer-icon.png"\] Alt text: File Explorer\) to see the ServiceNow Fluent application code and other source code in the `src` directory, or select the Metadata Explorer view \(\[Omitted image "servicenow-ide-metadata-explorer-icon.png"\] Alt text: Metadata Explorer\) to see the application metadata on the instance.
