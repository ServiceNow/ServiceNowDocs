...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/building-applications/maintaining-applications.html
release: yokohama
...
Performance Analytics Reporting \[Omitted image "icon-par.png"\] Alt text: Performance Analytics Reporting Integrate data visualization and analytics functionality into the workspace experience.

</td><td>

Analytics Hub \[Omitted image "icon-analytics-hub.png"\] Alt text: Analytics Hub Use this exploratory view of indicators for more detailed analysis. You can see trends, predictions, breakdowns, and associated records for a specific indicator.

</td></tr><tr><td>

Analytics Center \[Omitted image "icon-analytics-center.png"\] Alt text: Analytics Center Use the Platform Analytics Workspace with a single page for all the dashboards, visualizations, analytics answers, and insights on your instance.

</td><td>

Performance Analytics Dashboards \[Omitted image "icon-per-reporting.png"\] Alt text: Performance Analytics Dashboards Continually visualize historical and real-time process health statistics in role-based dashboards that enable individual stakeholders to make informed decisions.
...
Software Asset Management \[Omitted image "bus-task-list.svg"\] Alt text: Systematically track, evaluate, and manage software licenses, compliance, and optimization.
...
Service Mapping \[Omitted image "icon-service-mapping.png"\] Alt text: Service Mapping Discover all application services in your organization and build a comprehensive map of all devices, applications, and configuration profiles used in these application services.
...
Monitor application health \[Omitted image "bus-automated-testing-framework.svg"\] Alt text: Use the Application Service Dashboard to monitor the health state of application services. Then you can reduce the number of incomplete application services by populating them and adding any missing details.
