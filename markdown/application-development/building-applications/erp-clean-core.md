...
1.  Have your administrator use the Connections and Credentials app to configure credentials to connect ERP Data Hub to the ERP system of record. For more information, see .
