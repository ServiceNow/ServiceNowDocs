...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/building-applications/erp-clean-core.html
release: yokohama
...
\[Omitted image "erpcm-landing-page-infographic.png"\] Alt text: ERP Semantic Mining diagnoses your ERP system to identify customizations and recommend next steps in replatforming the apps to the ServiceNow AI Platform.
...
1.  Requirements for installing Zero Copy Connector for ERP include the following:
    ...
    -   Spoke integration
    -   SAP configuration
    For more information, see [Requirements for installing Zero Copy Connector for ERP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/erp-integration-framework/erpc-prereqs-for-installation.md).

2.  Requirements for installing ERP-CM include the following:
    -   License and entitlement. For more information, see [Install Zero Copy Connector for ERP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/erp-integration-framework/install-erp-integration.md).
    -   ServiceNow AI Platform plugins. For more information, see [Install Zero Copy Connector for ERP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/erp-integration-framework/install-erp-integration.md).
...
1.  Install and configure Zero Copy Connector for ERP. For more information, see [Configuring Zero Copy Connector for ERP](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/erp-integration-framework/erp-integration-configuration-overview.md).
