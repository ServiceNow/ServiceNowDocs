...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/building-applications/using-ui-builder-agent.html
release: zurich
...
Install Now Assist for UI generation application. For more information, see [Install UI generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/building-applications/install-ui-generation.md).
...
2.  Create a new experience or navigate to an existing one.
    ...
    For more information about creating an experience, see [Experience generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/building-applications/generate-ui.md).
...
\[Omitted image "ui-gen-agent-learn-uib.png"\] Alt text: In the Now Assist panel, ask a question about UI Builder to get instant answers.
...
\[Omitted image "ui-gen-agent-understand-page-configpng.png"\] Alt text: In the Now Assist panel, ask a question about the page configuration to get instant answers.
...
For example: \[Omitted image "ui-gen-agent-accelerate-page-config.png"\] Alt text: In the Now Assist panel, request a page modification.
