...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/building-applications/create-a-new-application-using-build-agent.html
release: australia
...
<table id="choicetable_qzh_hj2_lgc"><thead><tr><th align="left" id="d185251e233">

Scenario

</th><th align="left" id="d185251e236">

Actions

</th></tr></thead><tbody><tr><td id="d185251e242">
...
For information on troubleshooting issues, see [Common issues and solutions in Build Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/building-applications/build-agent-troubleshooting.md).
