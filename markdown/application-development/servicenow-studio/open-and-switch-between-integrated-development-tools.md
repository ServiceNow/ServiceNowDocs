...
Access development tools and builders directly in ServiceNow Studio so you can build apps without switching between interfaces. Open any file type to launch the correct tool or builder automatically.

## How do I access tools and builders in ServiceNow Studio?
...
During app development, you can have multiple tools and builders open at the same time. For example, build a flow or playbook in Workflow Studio, then use UI Builder to build a custom web experience for your users.

To switch between tools, open the file you want to edit. ServiceNow Studio opens the file in the correct tool or builder automatically.
