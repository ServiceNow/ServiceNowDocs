...
![Hover over a tab to see the scope it's in. In this image the scope is Security Center.](../image/sn-studio-scoped-app-tab.png)
...
![Tabs that don't fit in the browser window are available in an overflow list at the top of the screen.](../image/sn-studio-overflow-tabs.png)
...
![Use your settings to group or ungroup tabs by app scope](../image/sn-studio-group-tabs.png)
