...
7.  Expand the type of script that you want to review for the code snippet.
    ...
    For a list of types of scripts, see [Available script types](https://www.servicenow.com/docs/access?context=r_17Scripts&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
