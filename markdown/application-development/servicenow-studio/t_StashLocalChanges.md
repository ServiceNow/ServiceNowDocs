...
To learn more see [Getting started with credentials](https://www.servicenow.com/docs/access?context=credentials-getting-started&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US)
