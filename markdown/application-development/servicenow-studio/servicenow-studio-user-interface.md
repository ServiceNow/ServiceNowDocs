...
-   The Navigator panel enables you to see a quick view of all your apps, files, bookmarks, recents, and tools. You can filter or sort the lists, and you can open any list in the platform view by selecting **Open list**.
    ...
    |---------------|-----------|
    |Menu \(![Menu icon](../image/sn-studio-menu-icon.png)\)|Option to expand or collapse the Navigator panel.|
    |Search \(![Search icon](../image/sn-studio-search-icon.png)\)|Option to search for any file, app, metadata, or tool in any scope on the platform.|
    |Create \(![Create an app or file](../image/sn-studio-create-icon.png)\)|Option to create a new app or file.|
    |Apps \(![Apps icon](../image/sn-studio-apps-icon.png)\)|Option to view all apps.|
    |File Categories \(![File Categories icon](../image/sn-studio-files-icon.png)\)|Option to view, sort, and filter all files and metadata.|
    |Bookmarks \(![Bookmarks icon](../image/sn-studio-bookmark-icon.png)\)|Access point for all your favorite files and apps.|
    |Recent \(![Recent icon](../image/sn-studio-recents-icon.png)\)|Access point for all your most recently accessed files.|
...
-   The Create button enables you to quickly create apps and app files.
    ...
    ![Create button enables you to quickly create apps and app files.](../image/sn-studio-create-button.png)
...
![Each app shows its scope and update set at the bottom of the canvas. If you want to change the update set, select a new one or create new.](../image/sn-studio-scope-update-set.png)
