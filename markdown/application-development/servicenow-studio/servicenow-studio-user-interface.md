...
-   The Navigator panel shows all your apps, files, bookmarks, recents, and tools. Filter or sort the lists, or select **Open list** to open any list in the platform view.

    |Icon|Navigation item|Description|
    |----|---------------|-----------|
    |![](../image/sn-studio-menu-icon.png)|Open/Hide Navigator panel|Expand or collapse the Navigator panel.|
    |![](../image/sn-studio-search-icon.png)|Search|Search for any file, app, metadata, or tool in any scope on the platform.|
    |![](../image/sn-studio-create-icon.png)|Create|Create a new app or file.|
    |![](../image/sn-studio-apps-icon.png)|Apps|View all apps.|
    |![](../image/sn-studio-files-icon.png)|File Categories|View, sort, and filter all files and metadata.|
    |![](../image/sn-studio-bookmark-icon.png)|Bookmarks|Access bookmarked files and apps.|
    |![](../image/sn-studio-recents-icon.png)|Recent|Access recently opened files.|
