...
breadcrumb: [Configure, Now Assist for app generation in ServiceNow Studio, Working with Now Assist tools and AI files, Use, ServiceNow Studio, Developing your application, Building applications]
---
...
7.  Verify that Now Assist for Creator is installed.
    ...
    For more information about setting up, configuring, and monitoring Now Assist, see [Now Assist Admin console](https://www.servicenow.com/docs/access?context=configuring-now-assist&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
...
Users that only need to edit \(not create\) applications using app generation can be granted the delegated\_developer and now\_assist\_panel\_user roles. For more information, see [Exploring Delegated Development](../../applications/concept/c_DelegatedDevelopment.md).
