...
The first step in creating an application is defining the data. This lab uses the table inheritance feature of the ServiceNow AI Platform and extend the system Task table for all requests. This allows the Marketing Services application to access base fields and capabilities of the platform, such as assigning requests to users and asking for approvals.
...
44. In the Properties side panel, expand the **Choices** section by selecting the expand icon ![](../../../script/debugging/image/console_expand.png).
...
50. Select the move choice icon ![](../../../administer/form-builder/image/fb-move-icon.png) for the Design complete field and drag the field between the **Assigned** and **Closed complete** fields.
