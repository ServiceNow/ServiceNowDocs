...
keywords: [agentic ai, app gen, app generation, now assist, application generation, app creation, application creation, servicenow studio, generative ai, agentic ai, app gen, app generation, now assist, application generation, app creation, application creation, servicenow studio, generative ai, agentic ai, app gen, app generation, now assist, application generation, app creation, application creation, servicenow studio, generative ai]
...
Users that only need to edit \(not create\) applications using app generation can be granted the delegated\_developer, now\_assist\_panel\_user, and now.assist.creator roles. For more information, see [Exploring Delegated Development](../../applications/concept/c_DelegatedDevelopment.md).
