...
You can find details on these properties in the [Skipped records that occur during application installation](https://www.servicenow.com/docs/access?context=generation-skip-records-app-installs&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) topic. With these properties, you can opt in and out of deletes and choice updates depending on whether you are using your own or a third-party application.
