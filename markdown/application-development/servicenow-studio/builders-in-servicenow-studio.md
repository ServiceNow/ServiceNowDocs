...
![Decision tables are built in the Workflow Studio builder.](../image/sn-studio-builder-decision-table.png)
...
![Some builders have a short tutorial that helps you learn the tool.](../image/sn-studio-builder-tutorial.png)
