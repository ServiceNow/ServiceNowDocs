...
![Expanded Automation section of the File Categories section of the Navigator](../image/sn-studio-file-nav-expanded.png "Metadata sections in the File Categories section of the Navigator")
