...
[Access control](https://www.servicenow.com/docs/access?context=sc-access-control&version=zurich&pubname=zurich-platform-security&ft:locale=en-US)
...
Customize system behavior. -   [Business Rules](https://www.servicenow.com/docs/access?context=c_BusinessRules&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) run when a database action occurs \(query, insert, update, or delete\).
-   The script can run:
...
[Client scripts](https://www.servicenow.com/docs/access?context=client-scripts&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[Email templates](https://www.servicenow.com/docs/access?context=c_EmailTemplates&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
...
[Inbound email actions](https://www.servicenow.com/docs/access?context=actions-inbound-email&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
...
[Map pages](https://www.servicenow.com/docs/access?context=c_MapPages&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
...
[Map transforms](https://www.servicenow.com/docs/access?context=c_CreatingNewTransformMaps&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
...
[Processors](https://www.servicenow.com/docs/access?context=c_Processors&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[Relationships](https://www.servicenow.com/docs/access?context=table-relationships&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
...
[Scheduled script executions](https://www.servicenow.com/docs/access?context=c_ScheduledJobs&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
...
[Script actions](https://www.servicenow.com/docs/access?context=r_ScriptActions&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US)
...
[Script includes](https://www.servicenow.com/docs/access?context=c_ScriptIncludes&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[Schedule items](https://www.servicenow.com/docs/access?context=t_ViewAScheduleItem&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
...
[UI macros](https://www.servicenow.com/docs/access?context=c_UIMacros&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[UI pages](https://www.servicenow.com/docs/access?context=r_UIPages&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
[UI style](https://www.servicenow.com/docs/access?context=t_DefineFieldStyles&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US)
...
[Widgets](https://www.servicenow.com/docs/access?context=c_NestedWidgets&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
