...
Code auto-complete support for scripts.For information about activation, see [Now Assist for Code](https://www.servicenow.com/docs/access?context=now-assist-code-landing&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
