...
6.  [Pull versions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/team-development/t_PullAVersion.md) from the parent instance and then [resolve any collisions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/team-development/t_ResolveACollision.md).

7.  Review the local changes list and [queue or ignore changes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/team-development/t_QueueALocalChangeForAPush.md), as appropriate.
