...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/restricted-caller-access-privilege.html
release: zurich
topic_type: concept
...
For more information, see [Requested restricted caller access \(RCA\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/requested-rca.md).
...
-   **Scope**
    ...
    All application resources in a selected source or target scope. To learn more about application scopes, see [Application scope](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/c_ApplicationScope.md).
...
For more information, see: [Activate application restricted caller access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/activate-RCA.md).

-   **[Activate application restricted caller access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/activate-RCA.md)**  
...
-   **[Define cross-scope access to an application resource](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/set-RCA-level.md)**  
Track cross-scope requests for access to an application resource and approve or deny requests.
-   **[Set the application scope, application resource, and event access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/scope-resource-access.md)**  
...
**Parent Topic:**[Application access settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/c_ApplicationAccessSettings.md)
