...
description: 
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/erp-integration-framework/gloss-entity-erp.html
release: yokohama
...
The table or Business Application Programming Interface \(BAPI\) function call that ERP Canvas uses to read or update the system of record.
