...
The farmer can use Zero Copy Connector for ERP to connect to the legacy system of record and identify the table that contains the custom field. Then they can create an ERP model in Zero Copy Connector for ERP with a remote table or an extraction table that contains the **Moisture %** field.
