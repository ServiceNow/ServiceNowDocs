---
title: ERP Data Hub clone model field descriptions
description: The Clone ERP \(Enterprise Resource Planning\) model form in ERP Data Hub enables you to clone an ERP model so you can edit the new model.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/erp-integration-framework/erp-canvas-clone-model-fields.html
release: xanadu
