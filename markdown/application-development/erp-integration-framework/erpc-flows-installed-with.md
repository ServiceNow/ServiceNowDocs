---
title: Flows that ship with ERP Canvas
description: ERP Canvas includes two ERP \(Enterprise Resource Planning\) flows that run automatically.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/erp-integration-framework/erpc-flows-installed-with.html
release: yokohama
