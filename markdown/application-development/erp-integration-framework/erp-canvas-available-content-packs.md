...
| |Target systems|Methods|
|---|--------------|-------|
|Master data models|ECC and S/4|Tables or BAPI|
|SAP Foundation models|ECC and S/4|Tables or BAPI|
|Enterprise Data Foundation process extensions|ECC and S/4|Tables or BAPI|
