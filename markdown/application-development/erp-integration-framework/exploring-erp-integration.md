...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/erp-integration-framework/exploring-erp-integration.html
release: xanadu
...
1.  Have your administrator use the Connections and Credentials app to configure credentials to connect to the ERP system of record. For more information, see [Configure the ERP Data Hub credentials and connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/erp-integration-framework/set-up-erp-integration-connection.md).
...
3.  Clone or create an ERP model that scans the specified ERP module in the system of record for available tables and fields. Note the tables and fields in the ERP model for use in extraction and remote tables, as well as for mapping parameters to read and update the system of record.For more information, see [Clone an ERP model in ERP Data Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/erp-integration-framework/erp-canvas-clone-data-model.md).
...
8.  Move the ERP systems, ERP models, tables, operations, and flows to a production environment when they're ready. For more information, see [Managing ERP development pipelines in ERP Data Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/erp-integration-framework/manage-erp-tables-pipelines.md).
9.  Use the ERP data as the data source when building apps on the ServiceNow AI Platform using:
    ...
    -   Playbooks in Workflow Studio: For more information, see [Getting started with Process Automation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/getting-started-process-automation.md).
...
[Working with ERP systems in ERP Data Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/erp-integration-framework/erp-canvas-work-with-systems.md)
...
[Standard remote tables for ERP Data Hub](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/erp-integration-framework/erpi-standard-remote-tables.md)

</td><td>

-   sn\_erp\_integration.erp\_user
-   Additional, table-specific roles are required. For more information, see [ERP Data Hub roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/erp-integration-framework/erp-canvas-roles.md).
...
</table>-   **[Identifying ERP candidates to replatform with ERP Data Hub and ERP-CM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/erp-integration-framework/erpi-and-ecm-together.md)**  
ERP Data Hub enables you to connect to your ERP \(Enterprise Resource Planning\) system of record, and to organize its data.
-   **[ERP Data Hub custom field example](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/erp-integration-framework/ecm-example-case.md)**  
...
-   **[ERP Data Hub and security](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/erp-integration-framework/erp-canvas-and-security.md)**  
