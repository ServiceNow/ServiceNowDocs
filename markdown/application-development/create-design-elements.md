...
**Note:** Consider creating applications and experiences with help from agentic AI. For more information, see [Use AI capabilities in custom applications](../../ai-capabilities/concept/use-ai-capabilities-in-custom-apps.md).
...
-   **[Virtual Agent as an application design element](virtual-agent.md)**  
