...
3.  The app's form submission workspace is already available on the non-production instance that you're using for development for you to test and customize.Additionally, you can interact with test records by selecting the record in the **Form submissions** tab, which opens the test record in a new tab within Creator Studio.
