...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/creator-studio/managing-creator-studio-deployments.html
release: xanadu
...
Find details on deploying apps in [Managing deployments using pipelines in AEMC](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/manage-deployments-using-aemc.md).

## Managing app deployment without AEMC

If you don't have AEMC installed, you can use Pipelines and Deployments and the Deployment Tasks table to publish to the Application Repository. For more information, see [Pipelines and Deployments workflow version 24.1.2](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/pipelines-deployments-workflow-vs2.md).
...
For example, you can use AEMC to monitor apps. For more information, see [Managing custom apps using AEMC](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/app-engine-studio/manage-custom-apps-using-aemc.md).
