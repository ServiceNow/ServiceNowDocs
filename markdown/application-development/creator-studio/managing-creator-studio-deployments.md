...
Find details on deploying apps in [App Engine Management Center](../../app-engine-management-center/concept/app-engine-management-center.md).
...
You can view and edit details of the deployment on the **Scheduled Deployments** tab of Pipelines and Deployments For more information, see [Managing deployments using Pipelines and Deployments](../../app-engine-studio/concept/manage-deployments-using-p-and-d-aemc.md).
