...
When you ask an admin to create an app for you, you automatically become the owner of it. For more information, see [Collaboration in Creator Studio](../reference/creator-studio-collaboration-roles.md).
