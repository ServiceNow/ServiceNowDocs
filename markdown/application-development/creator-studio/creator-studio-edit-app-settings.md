...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/creator-studio/creator-studio-edit-app-settings.html
release: australia
...
1.  Head over to the Creator Studio home page by going to **All** &gt; **App Engine** &gt; **Creator Studio**.
    ...
    You'll see a list of all your apps right there on the home page.

2.  Select the app you want to work on.

    It'll open up so you can start making changes.
