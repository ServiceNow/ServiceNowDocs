...
Hide the question from the form by leaving this option unselected.
...
Option to make the question read-only.You can use this option to associate data with the form behind the scenes by adding it to the app's Task table.
