...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/creator-studio/creator-studio-administering-activities.html
release: xanadu
...
-   **[Steps to create a custom activity in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-custom-activity-workflow.md)**  
There are multiple steps to add custom activities for use in Creator Studio automations.
-   **[Make a custom activity available for playbooks in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-add-custom-activity.md)**  
...
-   **[Reorder how activities appear in a playbook's activity picker](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-reorder-activities.md)**  
Change the order that activities appear in the activity picker in Creator Studio to present them in the order you want.
-   **[Make an activity unavailable in playbooks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-hide-activity.md)**  
