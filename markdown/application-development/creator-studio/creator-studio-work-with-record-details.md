...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/creator-studio/creator-studio-work-with-record-details.html
release: xanadu
...
4.  Select the **Form submissions** tab in the application header.
    ...
    \[Omitted image "cs-corm-sub-workspace.png"\] Alt text: Form submission workspace in Creator Studio

5.  Select the **Open record details** button.

    \[Omitted image "cs-open-record-details.png"\] Alt text: Open record details button
...
After you're done customizing how the app's records will appear, you can check out how they'll look in the Request App Workspace while remaining in Creator Studio. For more information, see [Preview how an app's records appear](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-preview-record.md).

**Parent Topic:**[Working with form submission workspaces in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-form-submissions-workspace-about.md)
