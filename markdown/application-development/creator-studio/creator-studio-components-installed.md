...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/creator-studio/creator-studio-components-installed.html
release: zurich
...
-   **com.glide.creator\_studio.template\_deny\_list**
    ...
    For more information, see [Show the AES template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/creator-studio-unhide-template.md).
...
</table>**Parent Topic:**[Installing Creator Studio from the ServiceNow Store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/creator-studio/installing-creator-studio-from-the-store.md)
