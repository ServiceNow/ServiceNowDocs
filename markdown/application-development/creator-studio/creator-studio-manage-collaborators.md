...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/creator-studio/creator-studio-manage-collaborators.html
release: xanadu
...
breadcrumb: [Collaboration in Creator Studio, Building apps with Creator Studio, Creator Studio, Building no-code applications, Developing your application, Building applications]
---
...
3.  Access the Collaborators with others modal in one of two ways:
    ...
    -   Open the app, select **Edit**, select the more actions icon in the application header, and select **Manage collaborators** from the menu that appears.
        ...
        \[Omitted image "cs-manage-collaborators.png"\] Alt text: Manage collaborators from the app's more actions menu
...
**Parent Topic:**[Collaboration in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-collaboration-roles.md)
