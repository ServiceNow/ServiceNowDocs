...
5.  Verify that ServiceNow Otto for Creator is installed:
    ...
    3.  On the Service Catalog card, verify that the catalog item generation skill is active.
        ...
        **Note:** If the Service Catalog card displays **Not started** or **Inactive** for the catalog item generation skill, you must activate it. To learn more, see [Activate an AI skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/configure-a-now-assist-skill.md).
