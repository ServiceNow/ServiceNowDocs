...
Apps aren't deployed directly from Creator Studio. Instead, your admin uses Pipelines and Deployments. Admins should check out [Managing deployments using pipelines in AEMC](../../app-engine-studio/concept/manage-deployments-using-aemc.md#).
