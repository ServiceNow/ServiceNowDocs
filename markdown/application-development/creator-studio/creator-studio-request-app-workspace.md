...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/creator-studio/creator-studio-request-app-workspace.html
release: zurich
...
The Lists view contains two tabs: **Default Lists** and **My Lists**. For more information on working with lists, check out [Using lists to find work to do](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/list-menu.md).
...
-   [Working on records in your Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/working-on-requests-in-your-workspace.md)
-   [Responding to issues in an open record in Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/finding-answers.md)
