...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/creator-studio/creator-studio-activate-automation.html
release: xanadu
...
5.  Check that you're activating the correct playbook in your app by selecting it from the **Automations** tab.
    ...
    \[Omitted image "cs-select-automation.png"\] Alt text: Select automation to activate
