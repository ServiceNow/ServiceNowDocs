...
1.  **Let's get you started.** Create your app in a few simple steps before you can start building it out. Find out more in [Create an app in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/creator-studio/create-app-creator-studio.md).
2.  **Or ask to work on someone else's app!** If you see an app that you want to work on but don't have access to, you can request to get access to it. Or, you can ask your admin to create an app for you that you can then work on. Find out how in [Ask to work on an app in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/creator-studio/creator-studio-request-join-app.md) or [Ask an admin to create an app for you in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/creator-studio/creator-studio-request-app-added.md).
3.  **Add a form to collect information.** A form is where you gather information by asking questions, but first you have to add the form to the app. See [Add a form to an app in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/creator-studio/creator-studio-add-form.md) for more information.
