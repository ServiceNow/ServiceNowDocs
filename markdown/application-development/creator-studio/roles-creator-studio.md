...
-   The user is automatically delegated as the app owner. For more information, see [Exploring Delegated Development](../../applications/concept/c_DelegatedDevelopment.md).
