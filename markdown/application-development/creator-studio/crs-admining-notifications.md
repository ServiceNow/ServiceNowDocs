...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/creator-studio/crs-admining-notifications.html
release: zurich
...
2.  Using the \[sysevent\_email\_action\] table. For more information on creating and editing notification emails on the ServiceNow AI Platform, see [Create an email notification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_CreateANotification.md).
