...
A field in Creator Studio is a column on the app's associated table. If you're using condition builder, a field is either a column on the table or a question from the form.
