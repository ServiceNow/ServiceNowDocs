...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/creator-studio/creator-studio-working-with-automations.html
release: xanadu
...
**Summary:** After reading this section, you'll understand how to use [automation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-glossary.md) to do the following things:
...
**Note:** Because playbooks are based on forms, you should finish building out your app's forms before you start working on automation.
...
Learn how to add activities in [Add activities to an app's playbook in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-add-activities-automation.md).
...
\[Omitted image "cs-playbook-diagram-view.png"\] Alt text: A playbook in Creator Studio in Diagram view
...
\[Omitted image "cs-playbook-board-view.png"\] Alt text: A playbook in Creator Studio in Board view
...
-   **[Workflow for creating automations in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-automations-workflow.md)**  
...
-   **[Add an automated playbook to an app in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-add-automation.md)**  
...
-   **[Copy an automated playbook in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-duplicate-automation.md)**  
...
-   **[Add activities to an app's playbook in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-add-activities-automation.md)**  
...
-   **[Add a decision to an app's playbook in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-add-decision-automation.md)**  
...
-   **[Add a parallel process to an app's playbook in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-decision-parallel-process-add.md)**  
Create parallel processes in Creator Studio to make things happen in your app at the same time.
-   **[Edit the trigger for a playbook in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-add-trigger-automation.md)**  
Define the trigger for a playbook in Creator Studio to specify what makes the playbook start running.
-   **[Edit a playbook in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-edit-automation.md)**  
Update a playbook to change its settings, or rearrange or remove tasks, to make it work for your app.
-   **[Activate a playbook in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-activate-automation.md)**  
...
-   **[Delete a playbook in Creator Studio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/creator-studio/creator-studio-delete-automation.md)**  
