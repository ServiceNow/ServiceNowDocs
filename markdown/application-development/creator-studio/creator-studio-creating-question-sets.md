...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/creator-studio/creator-studio-creating-question-sets.html
release: xanadu
...
See [Create a variable set and add it to an item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/servicenow-platform/service-catalog/t_CreateAVariableSet.md) to find out how to create a question set in Service Catalog.
