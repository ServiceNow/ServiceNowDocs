...
See [Create a variable set and add it to an item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/t_CreateAVariableSet.md) to find out how to create a question set in Service Catalog.
