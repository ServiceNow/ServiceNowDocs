...
See [Create a variable set and add it to an item](https://www.servicenow.com/docs/access?context=t_CreateAVariableSet&version=xanadu&pubname=xanadu-servicenow-platform&ft:locale=en-US) to find out how to create a question set in Service Catalog.
