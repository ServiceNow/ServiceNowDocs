...
For more information on the Task table, see [Working with the Task table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/c_TaskTable.md).
