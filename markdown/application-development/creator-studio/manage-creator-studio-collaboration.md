...
3.  Assign the updated descriptor to users or groups.
    ...
    4.  On the form, fill in the fields.
        ...
        -   [Assign collaboration descriptors to users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/assign-descriptor-user.md)
        -   [Assign collaboration descriptors to groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/assign-descriptor-group.md)
    5.  Select **Save**.
