...
For more information on notifications from the ServiceNow AI Platform, see [Receive notifications](https://www.servicenow.com/docs/access?context=c_ReceiveNotifications&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
