...
If you're an admin, check out [Managing deployments using Pipelines and Deployments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/app-engine-management-center/manage-deployments-using-p-and-d-aemc.md) for the scoop on deploying apps.
