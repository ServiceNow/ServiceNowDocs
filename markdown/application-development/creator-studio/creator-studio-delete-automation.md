...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/creator-studio/creator-studio-delete-automation.html
release: xanadu
...
5.  Check that you're deleting the correct playbook in your app by selecting it from the **Automations** tab.
    ...
    \[Omitted image "cs-select-automation.png"\] Alt text: Select automation to delete

6.  Select the more actions icon \(\[Omitted image "cs-more-actions-icon.png"\] Alt text:\).

7.  Select **Delete**.

    \[Omitted image "cs-delete-playbook.png"\] Alt text: Menu option to delete a playbook
