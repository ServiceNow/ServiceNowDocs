...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/creator-studio/creator-studio-preview-record.html
release: xanadu
...
6.  Preview a record by selecting it in the canvas.
    ...
    \[Omitted image "crs-select-wksp-record.png"\] Alt text: Select the record number in the list to interact with it in Creator Studio
