...
description: Build Agent enables developers to create, edit, and deploy full-stack ServiceNow applications that encompass both user interface and back-end components.
locale: en-US
release: zurich
topic_type: concept
...
keywords: [explore]
breadcrumb: [Build Agent, AI in custom applications, Developing your application, Building applications]
---
...
The Build Agent is an AI tool designed for developers within the ServiceNow Integrated Development Environment \(ServiceNow IDE\). It can be use as an autonomous AI agent capable of independently generating a complete ServiceNow® scoped application.
...
However, if you exceed the free interaction limit, wait 30 days for a free reset, or install the paid Build Agent app to continue using the services. For more information on how to install Build Agent, see [Install Build Agent](../tasks/install-build-agent.md).
