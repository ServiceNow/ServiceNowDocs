...
**Note:** To learn about application-specific administrator roles and delegated development, see [Access control rules in application administration apps](../concept/ACL-access-checks.md) and [Exploring Delegated Development](../concept/c_DelegatedDevelopment.md).
