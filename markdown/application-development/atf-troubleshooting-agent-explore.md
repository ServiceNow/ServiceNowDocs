...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/atf-troubleshooting-agent-explore.html
release: zurich
topic_type: concept
...
|-------|-------|-----|
|Simplify test failure diagnosis|[Troubleshoot test failures](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/atf-troubleshooting-agent-test-failure.md)|atf\_triager + now\_assist\_panel\_user|

## What to explore next

To learn more about configuring and using ATF troubleshooting agent, see:

-   [Install ATF troubleshooting agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/test-agent-install.md)
-   [Use](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/atf-troubleshooting-agent-test-failure.md)
