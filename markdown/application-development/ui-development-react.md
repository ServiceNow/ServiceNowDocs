...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/ui-development-react.html
release: zurich
topic_type: concept
...
-   The maximum file size of uploaded attachments is limited by the size configured with **com.glide.attachment.max\_size** system property. For more information, see [Maximum allowed attachment size \[Updated in Security Center 1.3\]](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/sc-max-allowed-attachment-size.md).
