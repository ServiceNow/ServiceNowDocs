...
1.  Navigate to the **Forms** tab in Table Builder.
    ...
    ![View list.](../image/fb-select-view-ts2.png "View list")
...
2.  You can modify the default view selected by using the View list or select another view.
    ...
    ![Additional actions menu.](../image/form-views-ts2.png "Additional actions menu")
...
3.  With the view selected, you can modify the form view in the following ways:
    ...
    -   Add fields to your form. See [Add fields to a form layout in Table Builder](add-form-fields.md).
    -   Customize the layout of your form \(sections\). For more information, see [Customize your form layout in Table Builder](customize-form-layout.md).
