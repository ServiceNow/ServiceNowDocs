...
Option for specifying whether the UI policy applies to all form views or specific views. For more information on form views, see [View management](https://www.servicenow.com/docs/access?context=view-management-overview&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
...
-   UX route
 ...
 For more information on object types, see [ACL matching requirements for objects](https://www.servicenow.com/docs/access?context=access-control-rules&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
...
For a complete list of values for client script fields, see [Client script form](../../../script/client-scripts/concept/client-scripts.md)
...
For a complete list of values for business rules, see [Create a business rule](../../../script/business-rules/concept/c_BusinessRules.md#).
