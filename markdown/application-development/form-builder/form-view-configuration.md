...
Changes to the form made in the editor are committed to the selected view.**Note:** The additional actions menu \(vertical ellipsis\) is visible only when forms are accessed throughServiceNow Studio or App Engine Studio, not throughServiceNow AI Platform.
...
See [Formatters](https://www.servicenow.com/docs/access?context=c_Formatters&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
