...
<table id="choicetable_wqj_vdz_5wb"><thead><tr><th align="left" id="d181226e267">

Field

</th><th align="left" id="d181226e270">

Description

</th></tr></thead><tbody><tr><td id="d181226e276">
...
Type of information that the column contains. For example, to contain plain text in the column, select **String**.
 ...
 See [Field types](https://www.servicenow.com/docs/access?context=r_FieldTypes&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).

</td></tr><tr><td id="d181226e325">
