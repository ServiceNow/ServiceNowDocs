...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/add-permissions.html
release: xanadu
topic_type: task
...
4.  To add or remove permissions to the descriptor, click the arrows.
    ...
    For a list of permissions, see [Collaboration permissions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/collaboration-permissions.md).
