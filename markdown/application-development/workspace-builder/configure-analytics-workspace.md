...
4.  In the navigation panel, select **Analytics**.
    ...
    ![Analytics Center in Workspace Builder canvas](../image/wb-analytics-center-purple.png)
...
For more information on working with the Analytics Center, see [Dashboards in Platform Analytics](https://www.servicenow.com/docs/access?context=analytics-center-dashboards&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
