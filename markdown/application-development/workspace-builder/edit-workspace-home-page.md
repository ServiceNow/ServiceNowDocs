...
-   [Data visualizations in Platform Analytics](https://www.servicenow.com/docs/access?context=analytics-center-data-visualizations&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US)
-   [Create a single score data visualization](https://www.servicenow.com/docs/access?context=create-dv-sing-sc-ac&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US)
...
-   [Filters in Platform Analytics](https://www.servicenow.com/docs/access?context=interactive-filters-workspace&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US)
...
-   [Simple List widget](https://www.servicenow.com/docs/access?context=simple-list-widget&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US) or [List - Simple Usage - Developer site](https://developer.servicenow.com/dev.do#!/reference/next-experience/yokohama/now-components/now-record-list-connected-snapshot/usage)
...
<table id="choicetable_r4f_dmd_wxb"><tbody><tr><td id="d208958e447">
...
<table id="choicetable_uqm_zfr_dvb"><tbody><tr><td id="d208958e595">
...
For more information, see [Edit Platform Analytics dashboards](https://www.servicenow.com/docs/access?context=edit-db-in-ac&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).
