...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/workspace-builder/edit-workspace-home-page.html
release: yokohama
...
-   [Filters in Platform Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/interactive-filters-workspace.md)
...
[Create a filter group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/create-filter-group.md)
...
[Configure a Process Mining map on a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/configure-po-map.md)
...
</table>        The [Workspace Builder components for home pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/workspace-builder/workspace-builder-components-ref.md) has details on home page elements. For more information, see [Exploring Platform Analytics dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/ac-elements.md).
...
<table id="choicetable_r4f_dmd_wxb"><tbody><tr><td id="d225498e510">
...
For example, if you're editing a data visualization, you must specify the source table. For more information on editing components, see [Add and configure components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/add-components.md).

4.  In the canvas header, select **Save**.


</td></tr><tr><td id="d225498e574">
...
<table id="choicetable_uqm_zfr_dvb"><tbody><tr><td id="d225498e659">
...
For more information, see [Edit Platform Analytics dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/edit-db-in-ac.md).
