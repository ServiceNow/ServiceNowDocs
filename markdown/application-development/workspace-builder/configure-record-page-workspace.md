...
5.  Provide fulfillers with visibility into cross-business workflows and the actionable tasks used to complete these workflows by specifying the playbook.
    ...
    For more information on playbooks, see [About Playbook Experience](https://www.servicenow.com/docs/access?context=playbook-ui&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US).
...
[SLA ribbon](https://www.servicenow.com/docs/access?context=csm-agent-workspace-ribbon&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US)
...
[Attachments](https://www.servicenow.com/docs/access?context=attachments&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
...
[Timeline ribbon component](https://www.servicenow.com/docs/access?context=csm-agent-workspace-ribbon&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US)
...
[Customer 360 ribbon component](https://www.servicenow.com/docs/access?context=csm-agent-workspace-ribbon&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US)
...
[Viewing ribbon information in the contextual side panel](https://www.servicenow.com/docs/access?context=csm-playbooks-viewing-ribbon-info&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US)
...
<table id="choicetable_f3l_vjr_dvb"><tbody><tr><td id="d227773e925">
