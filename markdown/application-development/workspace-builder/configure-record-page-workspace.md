...
4.  Create a record page.
    ...
    1.  In the Workspace Builder header, from the **Record pages** menu, select **+ Create new**.
        ...
        ![Create a new workspace from the Record pages menu.](../image/wb-create-record-page2.png)
...
You can select from two sections: Tables that are already available in your app, and all tables outside the app scope.
    ...
    4.  Select **View record page**.
        ...
        ![View record page button highlighted in the Create a record page modal.](../image/wb-create-record-page3.png)
...
7.  Provide fulfillers with visibility into cross-business workflows and the actionable tasks used to complete these workflows by specifying the playbook.
    ...
    For more information on playbooks, see [About Playbook Experience](https://www.servicenow.com/docs/access?context=playbook-ui&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
...
8.  Configure the contextual side panel for the record page, which contains the icons for the tools that appear on the right side of the page.
    ...
    **Note:** If you used a template to create the app, you can't add a contextual side panel to the record page.
    ...
    2.  In the **Context side panel settings**, select the toggle switch for each component and ribbon component that you want to appear on the record page.
        ...
        ![Components side panel with the Ribbon component toggled on.](../image/wb-create-record-page6.png)
...
[SLA ribbon](https://www.servicenow.com/docs/access?context=csm-agent-workspace-ribbon&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)
...
[Agent Assist](https://www.servicenow.com/docs/access?context=agent-assist-configurable-workspace&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)
...
[Attachments](https://www.servicenow.com/docs/access?context=attachments&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US)
...
[Timeline ribbon component](https://www.servicenow.com/docs/access?context=csm-agent-workspace-ribbon&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)
...
[Customer 360 ribbon component](https://www.servicenow.com/docs/access?context=csm-agent-workspace-ribbon&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)
...
[Viewing ribbon information in the contextual side panel](https://www.servicenow.com/docs/access?context=csm-playbooks-viewing-ribbon-info&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)
...
[Form templates](https://www.servicenow.com/docs/access?context=form-templates-configurable-workspace&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)
...
<table id="choicetable_f3l_vjr_dvb"><tbody><tr><td id="d237679e1006">
