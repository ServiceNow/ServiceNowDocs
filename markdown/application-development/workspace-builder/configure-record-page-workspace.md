...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/workspace-builder/configure-record-page-workspace.html
release: xanadu
...
4.  Create a record page.
    ...
    1.  In the Workspace Builder header, from the **Record pages** menu, select **+ Create new**.
        ...
        \[Omitted image "wb-create-record-page2.png"\] Alt text: Create a new workspace from the Record pages menu.
...
You can select from two sections: Tables that are already available in your app, and all tables outside the app scope.
    ...
    4.  Select **View record page**.
        ...
        \[Omitted image "wb-create-record-page3.png"\] Alt text: View record page button highlighted in the Create a record page modal.
...
For more information on editing forms for a record page, see [Forms in Table Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/form-builder-glide-family-release/form-view-configuration.md).
...
7.  Provide fulfillers with visibility into cross-business workflows and the actionable tasks used to complete these workflows by specifying the playbook.
    ...
    For more information on playbooks, see [About Playbook Experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/playbook-ui.md).
...
8.  Configure the contextual side panel for the record page, which contains the icons for the tools that appear on the right side of the page.
    ...
    **Note:** If you used a template to create the app, you can't add a contextual side panel to the record page.
    ...
    2.  In the **Context side panel settings**, select the toggle switch for each component and ribbon component that you want to appear on the record page.
        ...
        \[Omitted image "wb-create-record-page6.png"\] Alt text: Components side panel with the Ribbon component toggled on.
...
[SLA ribbon](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/csm-agent-workspace-ribbon.md)
...
[Agent Assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/agent-assist-configurable-workspace.md)
...
[Timeline ribbon component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/csm-agent-workspace-ribbon.md)
...
[Customer 360 ribbon component](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/csm-agent-workspace-ribbon.md)
...
[Viewing ribbon information in the contextual side panel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/csm-playbooks-viewing-ribbon-info.md)
...
[Form templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/form-templates-configurable-workspace.md)
