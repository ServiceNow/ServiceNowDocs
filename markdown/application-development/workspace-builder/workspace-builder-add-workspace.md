...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/workspace-builder/workspace-builder-add-workspace.html
release: australia
...
-   To use a custom role for your workspace, you must create one in **Security** first.
 For more information, see [Add application security](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/app-engine-studio/add-security.md).
...
8.  Edit the workspace in Workspace Builder. For more information, see [Edit a workspace in Workspace Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/workspace-builder/configure-workspace-builder.md).
...
For more information on using Workspace Builder to customize your workspace, see [Using Workspace Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/workspace-builder/using-workspace-builder.md).
