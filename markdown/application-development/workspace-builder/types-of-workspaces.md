...
description: App Engine Studio \(AES\) provides a basic workspace that includes a home page, record pages, lists, an Analytics Center, and other functions.
locale: en-US
release: xanadu
...
-   **Dashboards Overview**
    ...
    **Note:** You can create and edit dashboards in-line. For more information, see [Configure Platform Analytics dashboard details](https://www.servicenow.com/docs/access?context=config-db-in-ac&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).


For more information on Analytics Center, see [Analytics Center](https://www.servicenow.com/docs/access?context=analytics-center&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
