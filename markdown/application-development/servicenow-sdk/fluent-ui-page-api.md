...
A UI page displays as a web page and can be added to a widget for use in dashboards. For general information about UI pages, see [UI pages](https://www.servicenow.com/docs/access?context=r_UIPages&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
