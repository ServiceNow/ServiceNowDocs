...
For general information about scheduled script executions, see [Script actions](https://www.servicenow.com/docs/access?context=r_ScriptActions&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
Required. The event that triggers the script action to run. For information about creating events, see [Create an event](https://www.servicenow.com/docs/access?context=t_CreateYourOwnEvent&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
