...
For general information about Automated Test Framework tests, see [Test your apps with the ATF](../../../administer/auto-test-framework/concept/automated-test-framework.md).
...
The following test steps are supported. For information about step properties, see the [Test step categories](../../../administer/auto-test-framework/reference/test-step-categories.md) documentation.
...
[Quick start tests for Dashboards](https://www.servicenow.com/docs/access?context=quick-start-tests-dashboards&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US)
