...
-   **[Install the ServiceNow SDK in an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-sdk/install-servicenow-sdk.md)**  
Install the ServiceNow software development kit \(SDK\) in a local application using Node Package Manager \(npm\).
-   **[Upgrade the ServiceNow SDK](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-sdk/upgrade-servicenow-sdk.md)**  
Upgrade to the latest version of the ServiceNow SDK for use with instances beginning with the Washington DC release.
-   **[Install the ServiceNow Fluent Language server in Visual Studio Code](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-sdk/install-fluent-language-extension-vs-code.md)**  
...
**Parent Topic:**[ServiceNow SDK](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/servicenow-sdk/servicenow-sdk-landing.md)
