...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/servicenow-sdk/servicenow-sdk-landing.html
release: zurich
...
**Note:** The ServiceNow SDK doesn't support the Global scope or global applications with instances on the Zurich release.

## Get started

<table id="table_xd2_5d1_jbc" class="nav-card"><tbody><tr><td>

[Explore\[Omitted image "bus-explore.svg"\] Alt text:Learn about developing applications with the ServiceNow SDK.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/servicenow-sdk.md)

</td><td>

[Configure\[Omitted image "bus-sdlc.svg"\] Alt text:Install and configure the ServiceNow SDK locally.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/configuring-servicenow-sdk.md)

</td><td>

[Authenticate\[Omitted image "bus-password-reset.svg"\] Alt text:Authenticate to ServiceNow instances.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/authenticate-instance-now-sdk.md)

</td></tr><tr><td>

[Create\[Omitted image "bus-application-developer.svg"\] Alt text:Create applications in source code.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/creating-applications-servicenow-sdk.md)

</td><td>

[Develop\[Omitted image "bus-start-developing.svg"\] Alt text:Develop applications in source code.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/developing-applications-sdk.md)

</td><td>

[Reference\[Omitted image "bus-learn.svg"\] Alt text:Get details about the ServiceNow SDK CLI and ServiceNow Fluent APIs.](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/servicenow-sdk-reference.md)
...
-   To learn more about what's new in the Zurich release, see the [https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/release-notes/servicenow-sdk-rn.md](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/release-notes/servicenow-sdk-rn.md).
