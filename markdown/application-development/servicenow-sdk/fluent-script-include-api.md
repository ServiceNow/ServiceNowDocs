...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/servicenow-sdk/fluent-script-include-api.html
release: zurich
...
For general information about script includes, see [Script includes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/scripts/c_ScriptIncludes.md).
...
An option for how cross-scope access to the script include is permitted. For more information, see [Restricted caller access privilege settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/restricted-caller-access-privilege.md).Valid values:
