...
For general information about email notifications, see [Email and SMS notifications](https://www.servicenow.com/docs/access?context=c_EmailNotifications&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
For general information about creating email notifications, see [Create an email notification](https://www.servicenow.com/docs/access?context=t_CreateANotification&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
For general information about email digests, see [Email digests](https://www.servicenow.com/docs/access?context=email-digests&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
