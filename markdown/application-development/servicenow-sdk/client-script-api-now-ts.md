...
For general information about client scripts, see [Client scripts](https://www.servicenow.com/docs/access?context=client-scripts&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
...
The type of client script, which defines when it runs. For more information about the supported types, see [Client scripts](https://www.servicenow.com/docs/access?context=client-scripts&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).Valid values:
