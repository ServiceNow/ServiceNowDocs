...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/servicenow-sdk/using-typescript.html
release: australia
...
**Parent Topic:**[Create and use JavaScript modules in applications with the ServiceNow SDK](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/servicenow-sdk/create-use-javascript-modules.md)
...
5.  In the `src/server` directory, add at least one `.ts` file to contain module code.
    ...
    For information about creating modules, see [Create and use JavaScript modules in applications with the ServiceNow SDK](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/servicenow-sdk/create-use-javascript-modules.md).
