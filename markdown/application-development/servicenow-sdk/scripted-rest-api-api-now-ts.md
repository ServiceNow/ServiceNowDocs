...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/servicenow-sdk/scripted-rest-api-api-now-ts.html
release: zurich
...
For general information about scripted REST services, see [Scripted REST APIs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/api-reference/c_CustomWebServices.md).
...
The resources \[sys\_ws\_operation\] for the API. For more information, see [routes object](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/scripted-rest-api-api-now-ts.md).
...
A list of query parameters \[sys\_ws\_query\_parameter\] for the route. For more information, see [parameters and headers objects](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/scripted-rest-api-api-now-ts.md).
...
A list of headers \[sys\_ws\_header\] for the route. For more information, see [parameters and headers objects](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/scripted-rest-api-api-now-ts.md).
