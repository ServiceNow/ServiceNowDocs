...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/servicenow-sdk/fluent-import-sets-api.html
release: zurich
...
2.  Define the data source \[sys\_data\_source\] using the Record API. The data source must reference the staging table from its import\_set\_table\_name property. For more information, see [Record API - ServiceNow Fluent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/record-api-now-ts.md).
    ...
    The data source defines the connection to external systems \(files, databases, APIs\) and how to load data into import staging tables. For more information, see [Data sources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/c_DataSources.md).
...
For general information about import sets, see [Import sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/import-sets-landing-page.md).
...
For general information about creating transform maps, see [Create a transform map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/t_CreateATransformMap.md).
...
-   To map a target field name to a source field object, see [fields object](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/fluent-import-sets-api.md).
...
A list of transform scripts for additional processing. For more information, see [scripts array](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/servicenow-sdk/fluent-import-sets-api.md).
...
For general information about creating field maps, see [Create a field map](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/t_CreatingAFieldMap.md).
...
The format for transformations when the target field is a Date or Date/Time field.**Note:** To learn more about allowable date formats, see [Global date and time field format](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/r_FormatDateAndTimeFields.md).
...
The stage of the import process in which to execute the script. For more information, see [Map with transformation event scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/r_MapWithTransformationEventScripts.md).Valid values: onBefore, onAfter, onReject, onStart, onForeignInsert, onComplete, onChoiceCreate
