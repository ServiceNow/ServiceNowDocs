...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/ui-builder/controllers.html
release: australia
product: UI Builder
...
This procedure assumes that you have placed a component with a preset on the page and have configured a controller. For instructions, see [Add a controller](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/ui-builder/controllers.md).
