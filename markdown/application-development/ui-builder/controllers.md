...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/ui-builder/controllers.html
release: xanadu
product: UI Builder
...
**Note:** Creating controllers is not supported in Xanadu.
...
This procedure assumes that you have placed a component with a preset on the page and have configured a controller. For instructions, see [Add a controller](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/controllers.md).
