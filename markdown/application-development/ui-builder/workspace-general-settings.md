...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/workspace-general-settings.html
release: yokohama
product: UI Builder
...
3.  Select **View experience settings** in the upper right.
    ...
    \[Omitted image "experience-settings-toggle.png"\] Alt text: Arrow pointing to the View experience settings link on the experience view page.
