...
Change the settings of your UI Builder page at any time by selecting the More actions icon ![Three-dot more actions icon](../image/more-options-icon.png) then **View settings** in the UI Builder experience view. You can change the name, path, and parameters of your page after you create a page.
