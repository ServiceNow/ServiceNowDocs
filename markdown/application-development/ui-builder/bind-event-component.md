...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/ui-builder/bind-event-component.html
release: xanadu
product: UI Builder
...
5.  To add an event handler to your component, select the **Events** tab.
    ...
    For more information on how to add event handlers to your component, see [Manage actions in UI Builder pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/work-events.md).
