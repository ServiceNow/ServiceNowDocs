...
-   **[Create a demo experience to explore UI Builder](../task/learn-by-example-create-experience.md)**  
...
-   **[Create a blank page](../task/learn-by-example-create-blank-page.md)**  
...
-   **[Create a record page using a template](../task/learn-by-example-create-page-with-template.md)**  
...
-   **[Define an audience for your variant](../task/learn-by-example-define-audience.md)**  
...
-   **[Define conditions for your variant](../task/learn-by-example-define-conditions.md)**  
...
-   **[Customize forms within a form component](../task/learn-by-example-edit-form-component.md)**  
