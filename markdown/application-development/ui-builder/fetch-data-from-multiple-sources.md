...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/ui-builder/fetch-data-from-multiple-sources.html
release: xanadu
product: UI Builder
...
**Parent Topic:**[Multi-table data configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/multi-source-data-configuration.md)
