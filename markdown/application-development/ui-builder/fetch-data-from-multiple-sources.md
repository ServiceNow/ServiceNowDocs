...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/fetch-data-from-multiple-sources.html
release: yokohama
product: UI Builder
...
15. Select **Preview**.
    ...
    \[Omitted image "multi-table-data-source22.png"\] Alt text: Preview overlay showing heading and card base container components configured with multi-table data sources.

16. Select the **X** to close the preview overlay.


**Parent Topic:**[Multi-table data configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/multi-source-data-configuration.md)
