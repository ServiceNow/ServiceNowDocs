...
This task applies to the new layout system introduced in Xanadu. If your page is using the old layout system, see [Add styling to a component using the old layout system](add-styling-to-component.md#) for more information.
