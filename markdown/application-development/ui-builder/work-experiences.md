...
![Web browser with three pages displayed in a UI Builder experience.](../image/experience_graphic.png)
...
You can [Create an experience for UI Builder](../task/create-experience.md) from scratch or use [UI generation](../../ui-generation/concept/using-ui-generation.md) to assist you in building an experience.
