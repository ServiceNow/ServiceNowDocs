...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/flexbox-uib.html
release: yokohama
product: UI Builder
...
-   Column-reverse: Down/up
    ...
    \[Omitted image "UIB-flexbox.png"\] Alt text: Diagram showing Flexbox row and column directions.
...
**Parent Topic:**[Organize components in UI Builder pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/work-layouts.md)
...
3.  [Create a page in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/create-page.md).

4.  Select the **+ Add content** button in the UI Builder stage.

5.  Select **Flexbox** in the layouts tab.

    \[Omitted image "flexbox-select-toolbox.png"\] Alt text: Arrow pointing to the Flexbox option on the layouts tab of the toolbox.
...
8.  In the **Layout** section, you should see **Flexbox** highlighted.
    ...
    \[Omitted image "flexbox-highlighted.png"\] Alt text: Arrow pointing to the Flexbox option on the configuration panel styles tab.
...
12. Add components to your page.
    ...
    See [Add and configure components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/add-components.md) for more information.
...
3.  [Create a page in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/create-page.md) or open a page.

4.  Click the **Layout** tab and choose the two-column layout.

    \[Omitted image "UIB-layouts-flexbox-two-row.png"\] Alt text: Standard two-column-layout.

5.  Click **Edit layout code**.

    \[Omitted image "UIB-layouts-context-menu.png"\] Alt text: Edit the layout code.

6.  Expand the code editor so that you can easily view the CSS code.

    \[Omitted image "UIB-layouts-flexbox-expand.png"\] Alt text: Arrow pointing to expand the code editor button.
...
7.  Add another slot to the layout by copying the CSS code for an existing slot.
    ...
    \[Omitted image "UIB-layouts-flexbox-copy-css.png"\] Alt text: Arrow pointing to copy the CSS code for a slot.
...
8.  Below the code that you copied, place a comma and then paste the following CSS code:
    ...
    \[Omitted image "UIB-layouts-flexbox-paste-css.png"\] Alt text: Pasting the CSS code.
...
9.  Collapse the expanded view, and then click **Apply**.
    ...
    \[Omitted image "UIB-layouts-flexbox-apply.png"\] Alt text: Applying a layout change.
...
\[Omitted image "UIB-layouts-flexbox-final-layout.png"\] Alt text: New, finished custom layout.

Click **Reset to original** to reset layout changes back to the original.

\[Omitted image "UIB-layouts-reset-to-original.png"\] Alt text: Arrow pointing to reset to original option.
