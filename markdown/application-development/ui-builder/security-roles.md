...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/ui-builder/security-roles.html
release: australia
product: UI Builder
