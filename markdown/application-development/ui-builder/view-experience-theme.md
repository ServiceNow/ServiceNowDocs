---
title: View experience theme
description: View the theme applied to your experience. The theme sets the visual style of the experience and provides a consistent look and feel across all pages.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/ui-builder/view-experience-theme.html
release: xanadu
product: UI Builder
...
breadcrumb: [Manage the visual style of UI Builder experiences, Working in UI Builder, UI Builder, Builder library, Developing your application, Building applications]
---
...
3.  Select **Settings** in the UI Builder header.
    ...
    \[Omitted image "experience-settings-toggle.png"\] Alt text: Arrow pointing to the settings toggle on the experience view page.
