...
By default, the Polaris theme is applied to UI Builder experiences. For more information, see [Working with themes in Next Experience](https://www.servicenow.com/docs/access?context=next-experience-theming&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
...
If you are interested in dark theme, see [Working with the dark theme](https://www.servicenow.com/docs/access?context=tb-working-in-dark-theme&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
