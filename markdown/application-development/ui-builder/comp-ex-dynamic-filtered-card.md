...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/ui-builder/comp-ex-dynamic-filtered-card.html
release: australia
product: UI Builder
...
14. Create a client state parameter to track user selections.
    ...
    The client state parameter can be modified by components when they trigger events. For more information, see [Client state parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/ui-builder/client-state-parameters.md).
