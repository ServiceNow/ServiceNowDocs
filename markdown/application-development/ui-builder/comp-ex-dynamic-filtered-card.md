...
![UI Builder stage with numbered callouts on individual components.](../image/comp-ex-dfc-anatomy.png "Final layout preview")
...
7.  Add and configure a repeater on your page with data binding.
    ...
    4.  Keeping **Repeater 1** selected, in the configuration panel, hover over the **Data array** field and select the bind data icon ![](../image/uib-dynamic-data-binding-button.png).
        ...
        ![Configuration panel for repeater, with a cursor hovering over the bind data icon.](../image/comp-ex-dfc-bind-data.png)
