...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/add-forms-to-ui-builder-pages.html
release: yokohama
product: UI Builder
...
\[Omitted image "form-component.png"\] Alt text: Sample form component named transfer order line task on a page.
