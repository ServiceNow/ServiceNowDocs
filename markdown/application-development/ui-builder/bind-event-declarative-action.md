...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/ui-builder/bind-event-declarative-action.html
release: xanadu
product: UI Builder
...
4.  Add a component to your page that can have a declarative action, such as an action bar or related list.
    ...
    For more information, see [Add and configure components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/add-components.md).
...
9.  Choose the declarative action that you created earlier.
    ...
    To continue with the example in step [5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/bind-event-declarative-action.md), the declarative action could be something like **Complete my work**.
...
**Parent Topic:**[Bind events to add actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/bind-events.md)
