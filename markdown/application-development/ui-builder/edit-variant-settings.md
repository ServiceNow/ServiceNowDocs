...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/edit-variant-settings.html
release: yokohama
product: UI Builder
...
3.  Select **Settings** next to the page that you want to edit.
    ...
    \[Omitted image "variant-edit-settings.png"\] Alt text: Arrow pointing to settings link to edit variant settings.
...
Set the rules for when your pages are shown. For more information, see [Control the conditions for a page variant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/control-conditions-for-your-variant.md).
...
Add or remove audiences for the page variant. For more information, see [Learn about audiences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/add-audiences.md).
...
**Parent Topic:**[Create a page variant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/create-variant.md)
