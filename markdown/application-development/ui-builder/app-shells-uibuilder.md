...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/app-shells-uibuilder.html
release: yokohama
product: UI Builder
...
|---------|-----------|-------|
|Breadcrumb app shell|The breadcrumb app shell includes a header, breadcrumb style navigation, and a primary navigation bar for a workspace experience. Use the breadcrumb app shell for focused workflows and wizard flows that don't require multi-tasking.|\[Omitted image "app-shell-breadcrumb.png"\] Alt text: Experience created with breadcrumb app shell.|
|Header app shell|The header app shell includes a header and user menu for a workspace experience. Use the header app shell for experiences that require minimal navigation and few actionable items in the header.|\[Omitted image "app-shell-header.png"\] Alt text: Experience created with header app shell.|
...
|UXR Base Experience app shell|The UXR Base Experience shell creates an experience with the Next Experience banner. The UXR Base Experience shell provides base functionality support for experiences that are configured within a parent app, including experience configuration, context binding, routing, screen loading, and caching. The UXR Base Experience shell has no visual or experience-specific components. The UXR Base Experience shell can also be used for experiences that have no shell customization. For example, Identity Center directly uses UXR Base Experience Shell as its app shell.|\[Omitted image "app-shell-uxr-base-experience.png"\] Alt text: Experience created with UXR base experience shell.|
|Workspace app shell|The workspace app shell includes the headers and footers for a workspace experience. Use the workspace app shell to provide tools that users need to find, research, and resolve issues. To manage the visual style of experiences created with this app shell, see .|\[Omitted image "app-shell-workspace.png"\] Alt text: Experience created with workspace app shell.|
