...
|---------|-----------|-------|
|Breadcrumb app shell|The breadcrumb app shell includes a header, breadcrumb style navigation, and a primary navigation bar for a workspace experience. Use the breadcrumb app shell for focused workflows and wizard flows that don't require multi-tasking.|![Experience created with breadcrumb app shell.](../image/app-shell-breadcrumb.png)|
|Header app shell|The header app shell includes a header and user menu for a workspace experience. Use the header app shell for experiences that require minimal navigation and few actionable items in the header.|![Experience created with header app shell.](../image/app-shell-header.png)|
