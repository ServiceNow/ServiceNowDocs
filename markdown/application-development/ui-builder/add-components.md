...
<table id="choicetable_dzv_llh_wnb"><thead><tr><th align="left" id="d265125e196">

To add a component

</th><th align="left" id="d265125e199">

Do the following

</th></tr></thead><tbody><tr><td id="d265125e205">
...
-   Choose a component from the toolbox.
 ![Arrow pointing to the floating menu that appears after selecting the menu icon.](../image/component-add-floating.png)

</td></tr><tr><td id="d265125e260">
