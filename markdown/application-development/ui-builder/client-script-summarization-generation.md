...
# Summarize a client script using ServiceNow Otto
...
Client scripts can be long and complex. The Explain code with ServiceNow Otto panel appears on the right side of the Edit client script dialog and generates a structured explanation of the selected script on demand. You can request a new explanation if the first response does not meet your needs.
...
5.  Select **Explain this code**.
    ...
    ServiceNow Otto sends the script to the skill endpoint. When processing is complete, the panel displays two sections:
...
6.  If the generated summary does not provide sufficient clarity, select the regenerate icon to request a new response from ServiceNow Otto.
