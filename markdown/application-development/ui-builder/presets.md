...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/ui-builder/presets.html
release: xanadu
product: UI Builder
...
Presets can also include event mappings to a controller's handled events. For more information, see [Manage actions in UI Builder pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/work-events.md).
...
5.  Add a component highlighted in green to your page.
    ...
    \[Omitted image "preset-component-library.png"\] Alt text: Open the component library and drag a component highlighted in green onto your page.
...
7.  Select a different preset from the list in the configuration panel.

    You can configure a component not to use a preset by selecting **Remove**.

    1.  Select **Continue** to replace the existing preset.

    \[Omitted image "preset-select-none.gif"\] Alt text: Select a different preset or no preset from the list.
