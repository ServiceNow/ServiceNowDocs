...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/ui-builder/connect-data-components.html
release: xanadu
product: UI Builder
...
-   **[Connect data to your components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/connect-data.md)**  
Bind data exposed by local data resources to components on your UI Builder page.
-   **[Connect data to your components with formulas](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/connect-data-formulas.md)**  
