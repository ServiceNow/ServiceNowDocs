...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/client-state-parameters.html
release: yokohama
product: UI Builder
...
\[Omitted image "client-side-interactions.png"\] Alt text: Examples of client-side interactions.
...
\[Omitted image "client-side-interaction-example.png"\] Alt text: Pointer changing page content by selecting a filter.
...
-   Client state parameters
-   [Events](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/event-mapping.md)
-   [Client scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/define-client-scripts.md)
...
\[Omitted image "client-state-parameter-color.png"\] Alt text: Pages with different client state parameter color options.
...
\[Omitted image "client-state-parameter-button-color.png"\] Alt text: Client state parameters setting the color for multiple components.
...
-   **[Using client state parameters in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/create-simple-counter-component.md)**  
...
-   **[Update a component’s state using client state parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/state-parameters.md)**  
...
**Parent Topic:**[Dynamically expose data in UI Builder pages \(advanced feature\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/data-resources.md)
