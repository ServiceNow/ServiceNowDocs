...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/ui-builder/create-simple-counter-component.html
release: australia
product: UI Builder
...
**Parent Topic:**[Client state parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/ui-builder/client-state-parameters.md)
