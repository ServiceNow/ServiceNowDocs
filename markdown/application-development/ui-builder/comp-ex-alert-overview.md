...
keywords: [UI Builder, Alert, Alert message, Components, UI Builder, Alert, Alert message, Components, UI Builder, Alert, Alert message, Components]
...
![Alert appearing under the header menu, greeting the logged-in user, with a highlight over the component.](../image/comp-ex-cam-anatomy.png "Final layout preview")
...
![UI Builder editor showing a button and a series of custom scripted alerts, with highlights over the button and one alert.](../image/comp-ex-cam2-anatomy.png "Final layout preview")

1.  **Button**: Triggers the client script to display the alerts.
2.  **Alert**: Displays customized messages.
