...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/learn-by-example-create-blank-page.html
release: yokohama
product: UI Builder
...
3.  On the **First, select a template** screen, select **Create from scratch instead**.
    ...
    \[Omitted image "page-details.png"\] Alt text: Page details including page name and URL path.
