...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/ui-builder/link-component-destination.html
release: xanadu
product: UI Builder
...
**Parent Topic:**[Bind an event to a data resource](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/bind-event-data-resource.md)
