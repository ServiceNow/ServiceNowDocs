...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/application-development/ui-builder/preview-page-ui-builder.html
release: brazil
product: UI Builder
...
-   Test with different data by changing the test values and selecting **Apply**. For more information, see [Test values in a page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/ui-builder/test-value.md).
