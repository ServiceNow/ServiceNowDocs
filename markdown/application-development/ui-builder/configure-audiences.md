...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/configure-audiences.html
release: yokohama
product: UI Builder
...
3.  Select **Settings** next to the page variant that you want to edit.
    ...
    \[Omitted image "audience-settings.png"\] Alt text: Arrow pointing to variant settings link to edit page variant settings.
...
-   **[Enable the user criteria property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/enable-user-criteria-property.md)**  
