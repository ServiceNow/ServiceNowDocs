...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/ui-builder/use-case-ui-builder-agent.html
release: australia
product: UI Builder
...
3.  Open the page to edit and open the ServiceNow Otto panel from the page editor.
