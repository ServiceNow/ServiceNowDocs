...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/learn-by-example-edit-form-component.html
release: yokohama
product: UI Builder
...
You can enhance the functionality of a custom form by configuring additional features. For more information, see [Forms in Table Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/form-builder-glide-family-release/form-view-configuration.md).
