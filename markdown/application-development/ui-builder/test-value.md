...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/test-value.html
release: yokohama
product: UI Builder
...
\[Omitted image "test-value-bind-data.png"\] Alt text: Binding incident test value to a table.
