...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/workspace-utility-settings.html
release: yokohama
product: UI Builder
...
4.  Select **View experience settings** in the upper-right.
    ...
    \[Omitted image "experience-settings-navigation.png"\] Alt text: Arrow pointing to the View experience settings link on the experience view page.
...
**Parent Topic:**[Configure UI Builder workspace experiences](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/ui-builder-workspace-settings.md)
