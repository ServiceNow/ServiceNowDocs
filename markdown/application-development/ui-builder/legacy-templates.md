...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/ui-builder/legacy-templates.html
release: xanadu
product: UI Builder
...
10. Add required parameters to your page URL.
...
11. Add optional pieces of data that you want to add to the URL of your page.
...
**Parent Topic:**[Create a page in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/create-page.md)
