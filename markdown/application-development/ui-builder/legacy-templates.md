...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/ui-builder/legacy-templates.html
release: zurich
product: UI Builder
...
16. Declare conditions for when to display the page by either using the provided dropdown menus or writing an encoded query string.
    ...
    For more information on writing encoded queries, see [Encoded query strings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/c_EncodedQueryStrings.md).
