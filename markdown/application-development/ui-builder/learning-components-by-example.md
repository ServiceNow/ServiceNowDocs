...
-   **[Create dynamic filtered card displays](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/ui-builder/comp-ex-dynamic-filtered-card.md)**  
...
-   **[Create and customize alert messages in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/ui-builder/comp-ex-alert-overview.md)**  
Learn how alert messages help you communicate feedback and status updates using both default and scripted approaches.
-   **[Filter records by priority with a flyout menu](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/ui-builder/comp-ex-filter-flyout-menu.md)**  
