...
4.  From the page editor, open the ServiceNow Otto panel.
...
|-------|-----|----------|
|UI Builder Agent does not respond|The UI Builder Agent skill is disabled, or the user is outside of UI Builder.|Enable the UI Builder Agent in AI Admin Hub. The agent operates only within UI Builder and is not available in other areas of the platform.|
