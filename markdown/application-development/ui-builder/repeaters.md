...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/repeaters.html
release: yokohama
product: UI Builder
...
3.  Open the editor for the page where you want to add the repeater.
    ...
    If you haven't created a page for your experience, see [Create a page in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/create-page.md) for more information on how to create a page.
...
6.  Add the repeater component to your page.
    ...
    For information about adding components, see [Add and configure components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/add-components.md).
...
12. Configure the component you nested in the repeater.
    ...
    For example, bind the **displayValue** to the component. See [Connect data to your components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/connect-data.md) for more information.
...
13. Select **Save**.
    ...
    \[Omitted image "uib-repeaters-preview.png"\] Alt text: Heading component displayed five times, each with a different display value from the Incident table.

14. View and test your page by selecting the **Preview** button.

    A tab opens to display the page preview with repeated data.

    \[Omitted image "uib-repeaters-preview-page.png"\] Alt text: Page preview displays all data from repeated components.


**Parent Topic:**[Configure components and repeaters \(advanced feature\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/configure-comp-and-repeaters.md)
