...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/ui-builder/grant-ui-builder-admin-role.html
release: australia
product: UI Builder
...
Configure UI Builder agent. For more information, see [Configure UI Builder Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/ui-builder/configure-ui-builder-agent.md).
