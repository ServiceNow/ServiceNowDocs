...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/control-conditions-for-your-variant.html
release: yokohama
product: UI Builder
...
1.  Create a page variant.
    ...
    For more information, see [Create a page variant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/create-variant.md).
