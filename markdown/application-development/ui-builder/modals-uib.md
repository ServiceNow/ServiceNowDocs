...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/ui-builder/modals-uib.html
release: xanadu
product: UI Builder
...
-   Select a page collection from the list and click **Add**.
    ...
    See [Add and configure components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/add-components.md) for more information.
...
**Parent Topic:**[Create modals in UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/ui-builder/Modals-overview.md)
