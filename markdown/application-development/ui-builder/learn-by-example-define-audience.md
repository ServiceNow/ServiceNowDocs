...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/ui-builder/learn-by-example-define-audience.html
release: zurich
product: UI Builder
...
2.  Select the experience you created, expand the page and select **Default**.
