...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/bind-event-page.html
release: yokohama
product: UI Builder
...
5.  In the configuration panel, select the **Events** tab.
    ...
    \[Omitted image "events-tab-page.png"\] Alt text: Configuration panel with the Events tab.

6.  Add an event handler in one of the following ways.

<table id="choicetable_tqw_v1s_znb"><thead><tr><th align="left" id="d113026e182">

To add this event handler

</th><th align="left" id="d113026e185">

Do this

</th></tr></thead><tbody><tr><td id="d113026e191">
