...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/create-variant.html
release: yokohama
product: UI Builder
...
\[Omitted image "page-variant-graphic.png"\] Alt text: Graphic show one URL pointing to three different pages based on the user accessing the page.
...
9.  Declare conditions for when to display the page by either using the provided dropdown menus or writing an encoded query string.
    ...
    To learn more about declaring conditions, see [Control the conditions for a page variant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/control-conditions-for-your-variant.md). For more information on writing encoded queries, see .
...
-   **[Edit page variant settings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/edit-variant-settings.md)**  
Edit page variant settings to add additional criteria to determine when the page variant displays to users.
-   **[Control the conditions for a page variant](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/control-conditions-for-your-variant.md)**  
