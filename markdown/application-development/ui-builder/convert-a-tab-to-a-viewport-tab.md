...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/ui-builder/convert-a-tab-to-a-viewport-tab.html
release: yokohama
product: UI Builder
...
3.  Create or open a page with existing tabs, or add a **Tabs** component to your page.
    ...
    For more information on how to add a Tabs component to a page, see [Add tabbed content to UI Builder pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/tabs-components.md).
...
7.  Click **Edit content** to add a viewport-enabled tab.
    ...
    For more information on viewport components, see [Add a viewport component to your page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/work-with-viewport-components.md).
...
15. Declare conditions for when to display the page or tab by either using the provided dropdown menus or writing an encoded query string.
    ...
    For more information on writing encoded queries, see [Encoded query strings](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/c_EncodedQueryStrings.md).
...
**Parent Topic:**[Extend your UI experience with viewport components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/ui-builder/viewports-overview.md)
