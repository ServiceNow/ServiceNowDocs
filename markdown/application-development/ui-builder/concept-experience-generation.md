...
When ServiceNow Otto generates an experience, it creates the following components:

-   **Experience**

    A named web interface at a specific URL, with application scope and app shell configured automatically. The experience is tagged as generated by Otto for easy identification.
