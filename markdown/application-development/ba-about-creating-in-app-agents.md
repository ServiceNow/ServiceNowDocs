...
-   Agents:
    ...
    -   Now Assist Skill: For more information, see [Add a Now Assist skill to an AI agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/intelligent-experiences/add-skill-ai-agent.md).
