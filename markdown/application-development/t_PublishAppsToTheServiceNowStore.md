...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/application-development/t\_PublishAppsToTheServiceNowStore.html
release: australia
topic_type: task
...
5.  Fill in the fields, as appropriate \([see table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/application-development/application-repository-self-hosted/t_PublishAppsToTheAppRepository.md)\).
