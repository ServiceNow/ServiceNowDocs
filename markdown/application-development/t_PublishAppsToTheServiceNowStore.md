...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/t\_PublishAppsToTheServiceNowStore.html
release: yokohama
topic_type: task
...
5.  Fill in the fields, as appropriate \([see table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/application-repository-self-hosted/t_PublishAppsToTheAppRepository.md)\).
