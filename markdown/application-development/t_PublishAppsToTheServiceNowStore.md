...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/application-development/t\_PublishAppsToTheServiceNowStore.html
release: zurich
topic_type: task
...
5.  Fill in the fields, as appropriate \([see table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/application-development/application-repository-self-hosted/t_PublishAppsToTheAppRepository.md)\).
