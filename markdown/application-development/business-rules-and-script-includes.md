...
Use Script Includes to store JavaScript functions and classes for use by server scripts. Each Script Include defines either an object class or a function that can be reused among any server-side scripts. For more information, see [Script includes](../../../script/server-scripting/concept/c_ScriptIncludes.md#).
...
For more information, see [Classic Business rules](../../../script/business-rules/concept/c_BusinessRules.md#).
