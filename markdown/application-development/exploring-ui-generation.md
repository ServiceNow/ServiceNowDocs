...
|-------|-------|-----|
|Improve the quality of UI experiences, automate repetitive experience building tasks, and reduce time spent searching for or recalling experience structure.|[Experience generation](../task/generate-ui.md)|Developers|
|Get both a high-level summary and a detailed explanation of a client script|[Client script summarization](../task/client-script-summarization-generation.md)|Developers, administrators|
|Automatically generate a data binding and formula using natural language with correct syntax.|[Generate a data binding and formula](../task/generate-data-bindings-and-formulas.md)|Developers|
