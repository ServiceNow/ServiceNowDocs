...
For a list and description of the available scoped methods for the user object, see [GlideUser](https://www.servicenow.com/docs/access?context=GUserAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
...
For the API reference, see [GSLog\(\)](https://www.servicenow.com/docs/access?context=GSLogBoth&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
...
-   [GlideDateTime](https://www.servicenow.com/docs/access?context=p_GlideServerAPIs&version=xanadu&pubname=xanadu-api-reference&section=c_GlideDateTime&ft:locale=en-US)
...
-   [GlideDate - Scoped](https://www.servicenow.com/docs/access?context=c_GlideDateScopedAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
-   [GlideDateTime - Global](https://www.servicenow.com/docs/access?context=c_GlideDateTimeAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
-   [GlideDateTime - Scoped](https://www.servicenow.com/docs/access?context=c_GlideDateTimeScoped&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
-   [GlideTime - Scoped](https://www.servicenow.com/docs/access?context=c_GlideTimeScopedAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
