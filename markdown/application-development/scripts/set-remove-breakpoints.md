...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/scripts/set-remove-breakpoints.html
release: yokohama
product: Scripts
...
4.  Trigger the script.
    ...
    \[Omitted image "start-debugging-confirmation.png"\] Alt text: ServiceNow script debugger
