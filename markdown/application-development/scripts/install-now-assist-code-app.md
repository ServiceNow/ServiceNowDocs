...
5.  Verify that Now Assist for Creator is installed:
    ...
    3.  On the Code Assist card, verify that the code generation skill is active.
        ...
        ![Code assist card displaying the Text-to-code skill in Now Assist Admin.](../image/now-assist-code-skill.png)
...
**Parent Topic:**[Configuring code generation](../concept/configuring-now-assist-code.md)
