...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/scripts/install-now-assist-code-app.html
release: xanadu
product: Scripts
...
breadcrumb: [Configuring code generation, Now Assist for code generation, Scripting, Building pro-code applications, Developing your application, Building applications]
---
...
**Parent Topic:**[Configuring code generation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/scripts/configuring-now-assist-code.md)
