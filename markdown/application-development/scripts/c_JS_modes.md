...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/scripts/c\_JS\_modes.html
release: yokohama
product: Scripts
...
For more information about features supported by the ECMAScript 2021 \(ES12\) and ES5 Standards modes, see [JavaScript engine feature support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/scripts/javascript-engine-feature-support.md).
...
-   **[Considerations for switching JavaScript modes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/considerations-switching-javascript-mode.md)**  
...
-   **[Set the JavaScript mode for an application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/set-javascript-mode-application.md)**  
Configure which ECMAScript features can be used in an application by selecting the JavaScript mode.
-   **[Turn on ECMAScript 2021 \(ES12\) mode for a script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/set-es12-mode-scripts.md)**  
...
**Parent Topic:**[JavaScript engine on the platform](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/c_JS_engine_upgrade.md)
