...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/scripts/script-debugger.html
release: yokohama
product: Scripts
...
-   **[Script Tracer and debugging scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/script-tracer.md)**  
...
-   **[Parts of the user interface](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/parts-script-debugger-interface.md)**  
...
-   **[Script Debugger step-through and console controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/step-through-controls.md)**  
...
-   **[Evaluate expressions in runtime using Console](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/evaluate-expressions.md)**  
...
-   **[Launch the Script Debugger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/launch-script-debugger.md)**  
Developers can launch the Script Debugger from the application navigator, Studio, or from the syntax editor.
-   **[Set or remove breakpoints](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/set-remove-breakpoints.md)**  
...
-   **[Set or remove logpoints](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/set-remove-logpts.md)**  
...
-   **[Script Debugger status](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/script-debugger-status.md)**  
The Script Debugger status determines what debugging actions are available and what information it can display.
-   **[Transaction details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/transaction-details.md)**  
The Script Debugger displays transaction details for the current paused user session.
-   **[Available transaction details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/available-transaction-details.md)**  
The Script Debugger provides a standard set of transaction details for developers to debug and troubleshoot scripts.
-   **[Script Debugger multiple developer support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/multiple-developer-support.md)**  
The Script Debugger allows multiple developers to debug their own transactions without affecting each other.
-   **[Script Debugger impersonation support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/impersonation-support.md)**  
...
-   **[Script Debugger Scripts - Background support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/scripts-background-support.md)**  
...
-   **[Domain separation and Script Debugger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/application-development/scripts/domain-separation-script-debugging.md)**  
