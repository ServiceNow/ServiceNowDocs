...
You can switch between Now LLM Services and Azure OpenAI. For more information, see 
...
**Note:** Developers must be assigned the now.assist.creator role to use code generation. For more information about using code generation, see .
