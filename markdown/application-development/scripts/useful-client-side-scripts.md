...
[GlideForm - getFormElement\(\)](https://www.servicenow.com/docs/access?context=c_GlideFormAPI&version=xanadu&pubname=xanadu-api-reference&section=r_GlideFormGetFormElement&ft:locale=en-US)

[Scoped GlideSystem - eventQueue\(String name, Object instance, String parm1, String parm2, String queue\)](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=xanadu&pubname=xanadu-api-reference&section=r_ScopedGlideSystemEventQueue_String_Object_String_String_String&ft:locale=en-US)

[GlideUser - Client](https://www.servicenow.com/docs/access?context=c_GlideUserAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
