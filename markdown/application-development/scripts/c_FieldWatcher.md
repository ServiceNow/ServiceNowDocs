...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/scripts/c\_FieldWatcher.html
release: xanadu
product: Scripts
...
**Parent Topic:**[Debugging scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/scripts/script-debug-overview.md)
...
3.  View the field watcher log by clicking the debug icon.
    ...
    A new pane opens at the bottom of the screen, showing a field watcher tab. It may also show tabs for [JavaScript Logging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/scripts/c_WritingToTheDebugLog.md) and JavaScript Debugger.
...
<table id="table_psz_5n2_qp"><thead><tr><th>
