...
Access UI scripts from within client-side code using the g\_ui\_scripts global object. For more information, see [GlideUIScripts - Client](https://www.servicenow.com/docs/access?context=GUIScriptsAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
