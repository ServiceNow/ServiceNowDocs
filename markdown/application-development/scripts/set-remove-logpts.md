...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/application-development/scripts/set-remove-logpts.html
release: yokohama
product: Scripts
...
-   Set the **glide.debug.log\_point** system property to `true`. See [Available system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/r_AvailableSystemProperties.md) for more information.
