...
To learn more about server-side scripting, see [Server-side scripting](../server-scripting/concept/c_ServerScripting.md). To learn more about application scope, see [Application scope](../../build/applications/concept/c_ApplicationScope.md).
...
**Parent Topic:**[Building pro-code applications](../../build/custom-application/reference/building-pro-code-applications.md)
