...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/scripts/client-script-best-practices.html
release: xanadu
product: Scripts
...
2.  [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/configure-form-layout.md) to include the **Order** field.
