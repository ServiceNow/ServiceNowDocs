...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/scripts/r\_UIPages.html
release: xanadu
product: Scripts
...
**Parent Topic:**[Creating custom UI Pages and UI macros](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/scripts/create-custom-ui-pages.md)
...
4.  Complete the form.
    ...
    See [UI pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/scripts/r_UIPages.md) for additional information for UI field descriptions.
...
See [UI pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/scripts/r_UIPages.md) for details on high risk UI pages.
