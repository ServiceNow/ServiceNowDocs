...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/application-development/scripts/script-tracer.html
release: xanadu
product: Scripts
...
\[Omitted image "script-tracer-nav-menu.png"\] Alt text: Script Tracer in the navigation pane

</td><td>

\[Omitted image "script-tracer-tab.png"\] Alt text: Script Tracer tab
...
To learn more, see [Debugging scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/application-development/scripts/script-debug-overview.md).
