...
1.  Completeness
    1.  Required fields – These are based on the class schema defined in the platform’s [System dictionary](https://www.servicenow.com/docs/access?context=c_SystemDictionary&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) and is fixed for all domains. These cannot be changed.
