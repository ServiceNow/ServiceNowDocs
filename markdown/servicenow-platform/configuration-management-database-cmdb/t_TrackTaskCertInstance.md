...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/configuration-management-database-cmdb/t\_TrackTaskCertInstance.html
release: xanadu
...
3.  View and edit the following fields as necessary.
    ...
    |Certification Schedule|The [certification schedule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/configuration-management-database-cmdb/c_PlanningDataCertification.md) used to create the certification instance.|
