...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/configuration-management-database-cmdb/workspc-dedup-run-template.html
release: xanadu
...
6.  Select the tasks in the Available de-duplication tasks list that you want to remediate using the selected de-duplication template.

7.  Select **Add Selected** to assign the selected tasks to the current template.
