...
In the onBefore transform map script for an import set, add a call to the [CMDBTransformUtil](https://www.servicenow.com/docs/access?context=c_CMDBTransformUtilAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) API, similar to the following code sample:
...
When [importing data using Import Sets](https://www.servicenow.com/docs/access?context=c_ImportDataUsingImportSets&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US), incorporate the following steps:
