---
title: View CMDB Data Manager policies in CMDB Workspace
description: View Data Manager policies on a dashboard view, with a timeline of upcoming scheduled policies, counts, and grouped by policy status.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/configuration-management-database-cmdb/data-manager-view-policies-wrkspc.html
release: yokohama
...
View Data Manager policies on a dashboard view, with a timeline of upcoming scheduled policies, counts, and grouped by policy status.
