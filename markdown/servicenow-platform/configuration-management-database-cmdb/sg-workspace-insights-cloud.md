---
title: Cloud vs Non-cloud insights dashboard in CMDB Workspace
...
# Cloud vs Non-cloud insights dashboard in CMDB Workspace
...
-   Application Services pie chart:
    ...
    The Application Services \(Service instances\) pie chart uses the Service Configuration Item Associations \[svc\_ci\_assoc\] table and checks the cloud/non-cloud status of application service CIs in the CI classes chart. Application services in the Application Services pie chart are classified as follows:
