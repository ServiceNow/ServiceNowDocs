...
7.  Click **Next**.
    ...
    For description of the different columns in the list view, see [Dictionary entry form](https://www.servicenow.com/docs/access?context=r_DictionaryEntryForm&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US). To designate an attribute as a CI identifier for class identification, double-click the attribute's Identification Rule column and set it to **true**.
