...
If Service Mapping is deployed, see [Properties installed with Service Mapping](https://www.servicenow.com/docs/access?context=components-installed-with-service-mapping&version=australia&pubname=australia-it-operations-management&ft:locale=en-US) for additional application service properties.
