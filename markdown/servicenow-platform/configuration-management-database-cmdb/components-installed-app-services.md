...
If Service Mapping is deployed, see [Properties installed with Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/components-installed-with-service-mapping.md) for additional application service properties.
