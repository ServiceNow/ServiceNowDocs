...
For additional information related to Service Mapping, see [Pattern customization](https://www.servicenow.com/docs/access?context=c_MappingPatternsCustomization&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US) and [Enable traffic-based discovery for CI types or specific CIs](https://www.servicenow.com/docs/access?context=t_CreateATrafficBasedDiscoveryRule&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
...
6.  If Service Mapping is activated, add a discoverable outgoing connection for the manually added CI:
    ...
    3.  Configure attributes for the entry point as described in [Entry points attributes](https://www.servicenow.com/docs/access?context=r_EntryPointsforBizSvcDef&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
...
[addCI\(\)](https://www.servicenow.com/docs/access?context=BusinessServiceManagerAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
