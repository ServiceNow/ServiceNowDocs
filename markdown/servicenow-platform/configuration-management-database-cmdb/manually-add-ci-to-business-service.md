...
-   Verify that the CI type for the configuration item \(CI\) that you are planning to add, exists. If necessary, create the CI type as described in [Create CI types for Service Mapping and Discovery](https://www.servicenow.com/docs/access?context=t_CreateCITypeForSM&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).
...
For additional information related to Service Mapping, see [Pattern customization](https://www.servicenow.com/docs/access?context=c_MappingPatternsCustomization&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US) and [Enable traffic-based discovery for CI types or specific CIs](https://www.servicenow.com/docs/access?context=t_CreateATrafficBasedDiscoveryRule&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).
...
6.  If Service Mapping is activated, add a discoverable outgoing connection for the manually added CI:
    ...
    3.  Configure attributes for the entry point as described in [Entry points attributes](https://www.servicenow.com/docs/access?context=r_EntryPointsforBizSvcDef&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).
...
[addCI\(\)](https://www.servicenow.com/docs/access?context=BusinessServiceManagerAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
