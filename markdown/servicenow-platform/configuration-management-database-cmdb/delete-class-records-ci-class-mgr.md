...
**Note:** You can't delete base system tables. For information about deleting custom tables, see [Deleting custom tables](https://www.servicenow.com/docs/access?context=c_DeleteATable&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
