...
**Note:** You can't delete base system tables. For information about deleting custom tables, see [Deleting custom tables](https://www.servicenow.com/docs/access?context=c_DeleteATable&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
