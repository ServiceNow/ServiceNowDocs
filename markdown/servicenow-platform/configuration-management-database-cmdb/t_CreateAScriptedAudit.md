...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/configuration-management-database-cmdb/t\_CreateAScriptedAudit.html
release: xanadu
 ...
 **Note:** Ensure that the specified user has the [certification role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/configuration-management-database-cmdb/r_InstalledWithDataCertification.md).
