...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/configuration-management-database-cmdb/cmdb-querybldr-config-display.html
release: yokohama
...
2.  On the **CMDB Query Builder** page, select the Settings icon \(\[Omitted image "dv-map-settings.png"\] Alt text: Settings.\) and then configure the settings.
