...
For more information about mapping **Asset State** and **Substate** fields to a CI's **Status**/**Hardware Status** \(if its hardware\) field, see [Map asset state and CI hardware status](https://www.servicenow.com/docs/access?context=c_ManagingAssets&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US). And for more information about retiring assets, see [Retire assets](https://www.servicenow.com/docs/access?context=c_ManagingAssets&version=zurich&pubname=zurich-it-asset-management&ft:locale=en-US).
