...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/servicenow-platform/configuration-management-database-cmdb/t\_ViewTableDefinitions.html
release: brazil
...
3.  On the class navigation bar, expand the following items to show further details for the class.
    ...
    -   **Class Info**:
        ...
        -   **Attributes**:Shows table attributes \(columns\). Lets you edit those attributes and add new ones. For description of the different attributes in the list view, see [Dictionary entry form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/r_DictionaryEntryForm.md).

            Role required: sn\_cmdb\_admin, itil\_admin, and personalize\_dictionary for reading and writing, and sn\_cmdb\_editor and itil for read access.
        ...
        -   **Identification** and **Reconciliation**: Shows and lets you edit, create, and delete identification and [inclusion rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/configuration-management-database-cmdb/create-id-inclusion-rule.md), reconciliation and [data refresh rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/configuration-management-database-cmdb/create-datasource-staleness-rule.md) for the class.

            See [CMDB Identification and Reconciliation \(IRE\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/configuration-management-database-cmdb/c_CMDBIdentifyandReconcile.md) for more information.

            Role required: sn\_cmdb\_editor or itil for reading, and sn\_cmdb\_admin or itil\_admin \(on top\) for writing.

        -   **Dependent Relationships**: Shows and lets you edit, create, and delete hosting and containment relationships for the class. See [CMDB dependent relationship rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/configuration-management-database-cmdb/c_ServiceRulesMetadata.md) for more information.
...
[Create or modify map icons](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/dependency-views/t_CreateModifyNGBSMMapIcons.md)
