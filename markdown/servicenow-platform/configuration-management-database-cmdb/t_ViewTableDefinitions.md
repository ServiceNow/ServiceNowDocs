...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/configuration-management-database-cmdb/t\_ViewTableDefinitions.html
release: australia
...
3.  On the class navigation bar, expand the following items to show further details for the class.
    ...
    -   **Class Info**:
        ...
        -   **Identification** and **Reconciliation**: Shows and lets you edit, create, and delete identification and [inclusion rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configuration-management-database-cmdb/create-id-inclusion-rule.md), reconciliation and [data refresh rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configuration-management-database-cmdb/create-datasource-staleness-rule.md) for the class.
            ...
            See [CMDB Identification and Reconciliation \(IRE\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configuration-management-database-cmdb/c_CMDBIdentifyandReconcile.md) for more information.
