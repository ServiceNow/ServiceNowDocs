...
You can view the new CI or other CIs, using CI Form in CMDB Workspace. For more information about using the CI Form, see [Manage CI details in CI Form](../concept/ci-form-cmdb-workspace.md).
