...
2.  Configure any of the following options to show the most relevant data in your organization:
    ...
    -   [Configure datacenters for Cloud vs Non-cloud resources](../task/cmdb-workspace-config-datacenter.md)
    -   [Configure classes for Cloud vs Non-cloud resources](../task/cmdb-workspace-config-classes-cloud.md)
