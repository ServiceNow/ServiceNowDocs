...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/configuration-management-database-cmdb/cnfig-mgmt-and-cmdb.html
release: zurich
...
To extend the CMDB you can [activate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_ActivateAPlugin.md) the following plugins to access the modules for specialized configuration items.
