...
-   [Activate](https://www.servicenow.com/docs/access?context=t_ActivateAPlugin&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) the ITOM Discovery License \(com.snc.itom.discovery.license\) plugin.
...
See [Sample CMDB 360/Multisource CMDB queries](multisource-data-report-builder.md#) for more details.
