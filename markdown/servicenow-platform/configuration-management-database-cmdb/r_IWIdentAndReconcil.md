...
Incomplete items, stored using JSON format as incomplete payloads. Incomplete items are stored for the purpose of logging payloads with irrecoverable errors, and are never processed again.
 ...
 The table is configured for [table rotation](https://www.servicenow.com/docs/access?context=c_TableRotation&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US), with duration of one day and seven table rotations.
...
[Properties](properties-id-reconciliation.md)
