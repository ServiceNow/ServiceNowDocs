...
![Add CI relationship icon.](../image/FormatterAddCIRelationship.png) Add CI relationship
...
![Show dependency views icon.](../image/FormatterShowBSMView.png) Show dependency views
...
</table>Click the Settings icon \(![Settings icon.](../image/FormatterSettings.png)\) to configure additional view settings that filter the data displayed. Settings are preserved through logging out and logging back in.
...
|Icon|Description|
|----|-----------|
|![Recently closed changes icon.](../image/FormatterRelationshipClosedChange.png)|Recently closed changes|
|![Planned changes icon.](../image/FormatterRelationshipClosedChange.png)|Planned changes|
|![Currently open changes icon.](../image/FormatterRelationshipOpenChange.png)|Currently open changes|
|![Recently closed outages icon.](../image/FormatterRelationshipClosedOutage.png)|Recently closed outages|
|![Problems icon.](../image/FormatterRelationshipProblem.png)|Problems|
|![Incidents icon.](../image/FormatterRelationshipIncident.png)|Incidents|
|![Planned outages icon.](../image/FormatterRelationshipPlannedOutage.png)|Planned outages|
|![Currently open outages icon.](../image/FormatterRelationshipOpenOutage.png)|Currently open outages|
...
</table>-   **[Domain separation and the relations formatter and the CI relationship editor](domain-separation-relationship-formatter-editor.md)**  
...
[Create a formatter and add it to the form](https://www.servicenow.com/docs/access?context=t_CreateAFormatter&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
