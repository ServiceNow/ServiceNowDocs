...
![Currently active incidents.](../image/Incidents.png)
...
![Currently active problems.](../image/Problems.png)
...
![Currently active changes.](../image/Changes.png)
...
![Recently completed changes.](../image/ChangePast.png)
...
![Planned changes.](../image/ChangePlanned.png)
...
![Currently active changes.](../image/ChangePresent.png)
...
![Recently completed outages.](../image/OutagesPast.png)
...
![Planned outages.](../image/OutagesPlanned.png)
...
![Currently active outages.](../image/OutagesPresent.png)
...
![Issues with downstream CI.](../image/Issues.png)
