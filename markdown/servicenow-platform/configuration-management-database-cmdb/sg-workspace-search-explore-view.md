...
-   **AI search**
    ...
    To use this AI search, the Now Assist skill Search result classifier, must be activated. The Search result classifier skill is available starting with [Now Assist for CMDB](now-assist-landing-cmdb.md) version 3.0 store app, which must be installed.
