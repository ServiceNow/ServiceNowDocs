...
-   [Query Builder Scriptable API](https://www.servicenow.com/docs/access?context=CMDBQueryBuilderAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
-   Scheduled jobs
