...
To manage business rules, change the application scope from CMDB success advisor to Global in the [application picker](https://www.servicenow.com/docs/access?context=c_ApplicationPicker&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
...
<table id="choicetable_acr_fw5_ggc"><thead><tr><th align="left" id="d621032e505">

Action

</th><th align="left" id="d621032e508">

Description

</th></tr></thead><tbody><tr><td id="d621032e514">
