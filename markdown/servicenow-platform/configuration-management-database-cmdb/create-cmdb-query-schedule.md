...
File format to use for the query results.**Note:** [Configure the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/configure-form-layout.md) to add this field to the form.
