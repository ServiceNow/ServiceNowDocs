...
-   Switch Forwarding Rules:
    ...
    -   More information: [Network switch and router discovery](https://www.servicenow.com/docs/access?context=r_DataCollDiscoNWRouteAndSwitch&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US)
-   Switch Partitions:
...
-   Switch Ports:
    ...
    -   More information: [Layer 2 discovery](https://www.servicenow.com/docs/access?context=c_Layer2Discovery&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US)
-   Switchports:
...
-   TCP Connections:
    ...
    -   More information: [TCP connection discovery](https://www.servicenow.com/docs/access?context=r_DataCollDiscoTCPConnections&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US)
