...
description: Create a Get Records query from the CMDB 360 dashboard of your CMDB Workspace to help you explore your existing CMDB 360 data.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/configuration-management-database-cmdb/workspc-mltsrc-query-get-records.html
release: yokohama
