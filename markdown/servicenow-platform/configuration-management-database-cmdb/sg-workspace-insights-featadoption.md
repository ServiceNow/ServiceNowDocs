...
-   **CMDB application for APIs and CLI**
    ...
    Determines whether the [CMDB application for APIs and CLI](https://www.servicenow.com/docs/access?context=cmdb-cli-commands&version=zurich&pubname=zurich-application-development&ft:locale=en-US) store app is installed.
...
-   **Principal classes**
    ...
    For more information about managing the Principal Class filter in CI Class Manager, see [Update class list in the Principal Class filter](../task/update-principal-class-filter.md).
