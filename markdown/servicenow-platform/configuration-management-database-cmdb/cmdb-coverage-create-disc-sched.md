...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/configuration-management-database-cmdb/cmdb-coverage-create-disc-sched.html
release: zurich
...
4.  On the Discovery Admin Workspace, create a discovery schedule as required.
    ...
    For more information, see [Create an IP-based Discovery schedule in Discovery Admin Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/t-dawCreateNewDiscoSchedule.md).
