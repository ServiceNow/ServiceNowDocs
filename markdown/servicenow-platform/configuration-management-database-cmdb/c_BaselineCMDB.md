...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/configuration-management-database-cmdb/c\_BaselineCMDB.html
release: yokohama
...
2.  Select the baseline you want to see for this CI from the choice list.
    ...
    \[Omitted image "DetailsOfBaselineDifferences.png"\] Alt text: Baseline differences
...
4.  Update a related CI and see the changes displayed as **Basic attribute changes** in the current CI record.
    ...
    \[Omitted image "BasicAttributeChanges.png"\] Alt text: Basic attribute changes in baseline differences.
...
2.  Manually run once the **CMDB Baseline convert XML to attachment** fix script. For information about running a fix script, see [Run fix scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/application-development/t_RunFixScripts.md).
...
-   Learn more: [Baseline CMDB](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/configuration-management-database-cmdb/c_BaselineCMDB.md)
