...
1.  Open the CI form for a CI, in CMDB Workspace.
    ...
    -   On a CI form that isn't in CMDB Workspaceand in Service Graph Workspace, select **Open in CMDB Workspace**.
...
[Timeline of CI changes](https://www.servicenow.com/docs/access?context=c_HistoryTimeline&version=zurich&pubname=zurich-platform-security&ft:locale=en-US)
