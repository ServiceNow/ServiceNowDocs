...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/configuration-management-database-cmdb/get-started-cilifecyclemgmt.html
release: australia
...
2.  [Define CI actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configuration-management-database-cmdb/define-cmdb-ci-action.md).

3.  [Define compatible CI actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configuration-management-database-cmdb/dfn-cmptbl-cmdb-ci-action.md) rules.
...
4.  [Define not-allowed CI actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configuration-management-database-cmdb/non-allowed-cmdb-ci-action.md) rules.

5.  [Define not-allowed operational state transitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configuration-management-database-cmdb/not-allowed-oprtionl-trnston.md) rules.
...
7.  [Set priority for operational states](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configuration-management-database-cmdb/set-priority-operational-state.md).
