...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/configuration-management-database-cmdb/data-manager-manage-ret-def-wrkspc.html
release: xanadu
...
For information about retirement definitions used in CMDB Data Manager \(Core UI\), see [Retirement definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/configuration-management-database-cmdb/life-cycle-rules.md).
...
-   For details and definitions of independent and dependent CIs, see [CMDB classifications and class dependency](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/configuration-management-database-cmdb/c_CMDBClassifications.md).
...
3.  In the Get started area on the Data Manager overview page, select **Manage retirement definitions**.

4.  On the Data Manager settings page, review the Retirement definitions list view.
...
5.  On the Data Manager settings page, select **Add definition**.

6.  Fill out the Retirement definition form and then select **Save definition**.
...
5.  In the Delete retirement definition dialog box, select **Delete**.
