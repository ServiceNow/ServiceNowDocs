...
description: Create a Compare Attribute Values query from the CMDB 360 dashboard of your Configuration Management Database \(CMDB\) Workspace to help you find CIs with mismatched attribute values between discovery sources.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/configuration-management-database-cmdb/workspc-mltsrc-query-comp-attr-value.html
release: xanadu
