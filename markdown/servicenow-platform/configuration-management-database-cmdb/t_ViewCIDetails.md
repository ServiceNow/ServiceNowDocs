...
If Service Mapping is deployed, the way CIs appear on the map depends on the [view you select for the map](https://www.servicenow.com/docs/access?context=modify-map-view&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US). Attributes available for viewing also depend on the Service Mapping setup. For more information, see description of [components installed with Service Mapping](https://www.servicenow.com/docs/access?context=components-installed-with-service-mapping&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).
