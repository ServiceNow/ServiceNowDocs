...
-   The separate and highly robust [Discovery](https://www.servicenow.com/docs/access?context=r-discovery&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US) product.
...
-   [Discovery basics](https://www.servicenow.com/docs/access?context=c_GetStartedWithDiscovery&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US)
...
You can import data to the CMDB using Import Sets. [Import sets](https://www.servicenow.com/docs/access?context=import-sets-landing-page&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) find files of information \(in formats such as XML, Excel, or CSV\), import them, and transform them onto the required table. This process can be scheduled or performed on demand.
...
Use the [CMDB instance API](https://www.servicenow.com/docs/access?context=cmdb-instance-api&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) to populate the CMDB by creating or updating CMDB tables.
