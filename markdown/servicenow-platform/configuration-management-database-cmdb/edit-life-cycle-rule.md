---
title: Edit and activate a retirement definition \(in Core UI\)
description: Create, edit, activate, or delete a retirement definition that reflects the retirement state in your organization, for a class. Tables that are targeted in CMDB Data Manager life-cycle policies, must be associated with an active retirement definition. Target CIs in Retire policies, are set to match their associated class retirement definitions.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/configuration-management-database-cmdb/edit-life-cycle-rule.html
release: yokohama
...
# Edit and activate a retirement definition \(in Core UI\)

Create, edit, activate, or delete a retirement definition that reflects the retirement state in your organization, for a class. Tables that are targeted in CMDB Data Manager life-cycle policies, must be associated with an active retirement definition. Target CIs in Retire policies, are set to match their associated class retirement definitions.
