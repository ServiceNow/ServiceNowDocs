...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/configuration-management-database-cmdb/populate-app-service-top-down.html
release: australia
...
-   [Verify that Service Mapping is set up properly](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-operations-management/check-service-mapping-readiness-for-mapping.md).
-   Ensure you know which entry point to use for this application service and which attributes you must be able to define for this entry point. Learn about [Entry point attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-operations-management/r_EntryPointsforBizSvcDef.md) available with Service Mapping.
...
3.  Define attributes for the selected entry point as described in [Entry point attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-operations-management/r_EntryPointsforBizSvcDef.md).
...
Complete the generic procedure [Create an application service](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configuration-management-database-cmdb/create-it-services.md).
