...
-   **Recent service instance activity**
    ...
    A 7-day chart showing metrics and trend line related to [Application services](application-services.md) such as the total number of Service instances, new and updated Service instances, and the number of Service instances with outages.
