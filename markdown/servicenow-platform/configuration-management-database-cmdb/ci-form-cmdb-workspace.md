...
-   Configure the Explore CI view:
    ...
    -   Select **Configure attributes** to modify the Summary and Attributes sections on the form, in Form Builder. For example, to add sections, modify section titles or the attributes included in sections: Requires the personalize\_form user role.
        ...
        For more information about Form Builder and Table Builder, see [Forms in Table Builder](https://www.servicenow.com/docs/access?context=form-view-configuration&version=zurich&pubname=zurich-application-development&ft:locale=en-US) and [Add fields to a form layout in Table Builder](https://www.servicenow.com/docs/access?context=add-form-fields&version=zurich&pubname=zurich-application-development&ft:locale=en-US).
...
For more information about configuring attribute highlights in the ServiceNow AI Platform, see [Highlight list fields](https://www.servicenow.com/docs/access?context=highlight-list-fields-platform&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
...
-   [Tag-based discovery in Service Mapping](https://www.servicenow.com/docs/access?context=tag-based-mapping&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US)
-   [Data collected for Amazon AWS Cloud Discovery](https://www.servicenow.com/docs/access?context=cloud-disco-aws-data-collected&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US)
-   [Data collected for Microsoft Azure Cloud Discovery](https://www.servicenow.com/docs/access?context=data-collected-azure-discovery&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US)
