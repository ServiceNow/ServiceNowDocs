...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/configuration-management-database-cmdb/t\_CompareBS.html
release: zurich
...
<table id="choicetable_dnx_mtk_51b"><thead><tr><th align="left" id="d463369e184">

Option

</th><th align="left" id="d463369e187">

Action

</th></tr></thead><tbody><tr><td id="d463369e193">
...
8.  If Service Mapping is deployed, you can compare two versions of a configuration file that appears on the map as Updated:
    ...
    3.  Review actual changes.
        ...
        -   Pink — New line
        -   Gray — Deleted line
    4.  Navigate between the changes using the Next difference icon and the Previous difference icon .
...
[View the change history of application services in classic Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/configuration-management-database-cmdb/t_ViewCIChanges.md)

[Compare versions of CI configuration files](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/compare-configuration-files.md)
