...
-   [CMDBGroupAPI - Scoped](https://www.servicenow.com/docs/access?context=c_CMDBGroupAPIScoped&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
-   [CMDBTransformUtil - Global](https://www.servicenow.com/docs/access?context=c_CMDBTransformUtilAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
-   [CMDBUtil - Global](https://www.servicenow.com/docs/access?context=c_CMDBUtilAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
-   [IdentificationEngineScriptableApi](https://www.servicenow.com/docs/access?context=c_IdentEngineScriptAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
