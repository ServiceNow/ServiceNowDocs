...
[API Service Graph Connectors![](../image/icon-sgc.png)Connectors for bringing in API data correctly and quickly.](api-sgc-available.md)
...
[![](../../../reuse/icons/brand-icons/bus-workflow.svg)Service Graph Connector CentralA CMDB Workspace view for managing the full life cycle of creating, editing, monitoring, and debugging Service Graph Connector connections.](../../sgc-central/reference/sgcc-landing.md)

</td><td>

[Now Assist for Service Graph Connectors \(SGC\)![](../../../reuse/icons/brand-icons/bus-supervised-machine-learning.svg)Generative AI skills and features for resolving issues within Service Graph Connectors.](now-assist-landing-cmdb.md)
...
-   **[Populating the CMDB](c_OptionsToPopulateCMDB.md)**

    Options for populating the CMDB.

-   **[Discovery patterns](https://www.servicenow.com/docs/access?context=c_MappingPatternsCustomization&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US)**
