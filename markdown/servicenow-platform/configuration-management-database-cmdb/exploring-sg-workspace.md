...
Administrators assigned to the guided tour admin role \(guided\_tour\_admin\) can use the Guided Tour Designer to create step-by-step walkthroughs that can guide users through the Service Graph Workspace. For more information, see Guided Tours.
