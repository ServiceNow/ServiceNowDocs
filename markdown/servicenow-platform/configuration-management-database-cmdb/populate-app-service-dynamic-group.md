...
-   A CMDB group can be used to populate only a single application service. For more information about populating and using CMDB groups, see [CMDB groups](../../../Chunk1817035602.md#).
...
For more information, see [alert impact calculation](https://www.servicenow.com/docs/access?context=c_EMImpactCalculation&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
