...
For more information, see [alert impact calculation](https://www.servicenow.com/docs/access?context=c_EMImpactCalculation&version=australia&pubname=australia-it-operations-management&ft:locale=en-US).
