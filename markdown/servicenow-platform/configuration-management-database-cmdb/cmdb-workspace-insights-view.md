...
Select the tile to access the Application Services dashboard where you can monitor the adoption level and health of application services. For details about the Application Services dashboard, see [Use Application Services dashboard to monitor health](../task/app-service-dashboard.md).
