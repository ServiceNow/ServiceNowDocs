...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/configuration-management-database-cmdb/multisource-data-report-builder.html
release: xanadu
...
-   [Get Records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/configuration-management-database-cmdb/workspc-mltsrc-query-get-records.md): Queries your discovery sources for CIs that match your criteria.
...
[Enable and configure CMDB 360](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/configuration-management-database-cmdb/multisource-cmdb.md).
...
7.  Use the condition builder to specify conditions that must be met for the class, use **And** or **Or** to specify multiple conditions.

8.  Use the list collector to select one or more **Discovery source** items to query on.

9.  Set **Field to compare** to the class attributes for which to show differences.
...
10. Set **Limit results to** to limit the query results to CIs that belong to a specific application service, technical service, or a CMDB group.
...
-   Create a Multisource report for the query, that integrates the Multisource query results with the platform [Reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/reporting/reporting-landing-page.md) feature.
...
Creating a report that is based on a Multisource \(CMDB 360\) query, creates a report source which you can then manage using [Reporting](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/reporting/reporting-landing-page.md) capabilities.
...
To add a Multisource \(CMDB 360\) report to the CMDB Correctness Dashboard for example, see [Add a report to a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/reporting/add-report-to-dashboard.md).
