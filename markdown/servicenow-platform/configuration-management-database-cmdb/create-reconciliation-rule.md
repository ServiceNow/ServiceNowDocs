...
6.  Select the **Static Reconciliation Rule** tile if it appears.
    ...
    If [CMDB 360/Multisource CMDB](multisource-cmdb.md) is not enabled, you can't create a dynamic reconciliation rule and the tiles to choose the rule type do not appear.
...
-   If [CMDB 360/Multisource CMDB](multisource-cmdb.md) is enabled, you can:
...
[CMDB 360/Multisource CMDB](multisource-cmdb.md) must be enabled.
