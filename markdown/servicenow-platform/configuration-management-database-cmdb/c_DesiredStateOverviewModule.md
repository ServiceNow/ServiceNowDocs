...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/configuration-management-database-cmdb/c\_DesiredStateOverviewModule.html
release: yokohama
...
breadcrumb: [Desired State, CMDB Compliance, CMDB schema model, Exploring CMDB, Configuration Management Database \(CMDB\), Configuration Management, Extend ServiceNow AI Platform capabilities]
---
...
</table>The different levels of access are:
...
3.  Click elements within the reports to obtain more information.
    ...
    \[Omitted image "DesiredStateOverview.png"\] Alt text: Desired state overview charts.
