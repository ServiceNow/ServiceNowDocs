...
-   **Principal Class**
    ...
    For more information, see [Update class list in the Principal Class filter](../task/update-principal-class-filter.md).
...
-   **CMDB CI Class Models**
    ...
    For more information, see [CMDB CI Class Models](../concept/cmdb-ci-class-models.md).
