...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/configuration-management-database-cmdb/view-cmdb-benchmarks.html
release: yokohama
...
2.  Click the \[Omitted image "select-benchmark-bundle.png"\] Alt text: Select what to display benchmarks for. icon and select **IT Operations Management**.
...
[CMDB Health](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/configuration-management-database-cmdb/c_CMDBHealth.md)

[bundle-itsm.r_Benchmarks]

[bundle-itsm.c_BenchDashboard]
