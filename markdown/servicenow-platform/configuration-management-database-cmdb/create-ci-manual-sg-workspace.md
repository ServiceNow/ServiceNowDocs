...
Creating specialty CIs such as a service instance \(application service\), isn't supported in this Create CI experience. Typically, such CIs aren't discoverable and you must create them manually using specific wizards, such as the [Application service \(service instance\) wizard](../../service-mapping/task/create-it-services.md).
