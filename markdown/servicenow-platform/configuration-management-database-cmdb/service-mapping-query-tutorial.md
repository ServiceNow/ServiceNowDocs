---
title: Service Mapping query example — Linux servers in services
description: Use this example to build a Service Mapping query to find all Linux servers in services.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/configuration-management-database-cmdb/service-mapping-query-tutorial.html
release: yokohama
...
# Service Mapping query example — Linux servers in services
