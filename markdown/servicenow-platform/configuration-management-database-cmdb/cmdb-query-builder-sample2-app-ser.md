---
title: CMDB query example — application services with incident or change
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/configuration-management-database-cmdb/cmdb-query-builder-sample2-app-ser.html
release: yokohama
...
breadcrumb: [Example queries, CMDB Query Builder reference, CMDB Query Builder, CMDB schema model, Exploring CMDB, Configuration Management Database \(CMDB\), Configuration Management, Extend ServiceNow AI Platform capabilities]
---

# CMDB query example — application services with incident or change
