...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/c\_SurveyUsersAndGroups.html
release: yokohama
topic_type: concept
...
-   **[Create a survey user group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_CreatingSurveyUserGroups.md)**  
...
-   **[Designate a survey user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_SurveyDefinitionForm.md)**  
You can designate one survey user at a time from the Survey Definition form.
-   **[Designate or remove multiple survey users at one time](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_SurveyCategoryForm.md)**  
Use the Survey Category form to designate or remove multiple survey users at a time.
-   **[Allow recipients to retake a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_AllowRecipientsToRetakeASurvey.md)**  
