...
5.  To enable Advanced Work Assignment \(AWA\) Voice routing, check the checkbox under the **AWA Voice Routing** heading.
    ...
    1.  Complete [AWS Lambda](https://www.servicenow.com/docs/access?context=aws-lambda-spoke&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US) and OAuth credential setup.
...
6.  Set up AWA queue to route Amazon Connect phone calls.
    ...
    To setup AWA, see [Get started with Advanced Work Assignment](../../../administer/advanced-work-assignment/task/implement-awa.md)
