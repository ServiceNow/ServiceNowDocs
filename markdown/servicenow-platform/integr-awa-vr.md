...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/integr-awa-vr.html
release: zurich
topic_type: task
...
5.  To enable Advanced Work Assignment \(AWA\) Voice routing, check the checkbox under the **AWA Voice Routing** heading.
    ...
    1.  Complete [AWS Lambda](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/aws-lambda-spoke.md) and OAuth credential setup.
...
6.  Set up AWA queue to route Amazon Connect phone calls.
    ...
    To setup AWA, see [Get started with Advanced Work Assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/implement-awa.md).


## What to do next

For more information about integrating ServiceNow® Voice with Amazon Connect, see [Integrate ServiceNow Voice with Amazon Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/integrate-ccc-amazonconnect.md).
