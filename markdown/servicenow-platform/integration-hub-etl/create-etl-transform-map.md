...
When you open an ETL transform map, by default the map is not validated. You can enable this validation step by adding the system property **sn\_int\_studio.validation.enabled** to the System Properties \[sys\_properties\] table and then setting it to **true**. After validation is complete, you choose how to handle validation errors.
...
[bundle-crint.c_CreateNewDataSource]
...
6.  Click **Set Up Mapping** to configure mapping for a newly added class, or click **Edit Mapping** to edit a mapping.
    ...
    2.  Click **Add Attribute**. Then, in the Add Attribute dialog box, from the **Attribute** list, select one or more items as target attributes to map data to. You can also scroll down to the **IRE Settings** section of the list and select one of the robust import set transformer properties. Click **Save**.
...
<table id="choicetable_rvq_52s_2nb"><thead><tr><th align="left" id="d470708e1743">

Option

</th><th align="left" id="d470708e1746">

Description

</th></tr></thead><tbody><tr><td id="d470708e1752">
