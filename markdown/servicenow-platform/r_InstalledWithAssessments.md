...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/r\_InstalledWithAssessments.html
release: xanadu
...
Stores all [assessable records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_assessable-records.md).
...
Stores all [category results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_SchedulePeriods.md).
...
Stores associations between users and metric categories that they can evaluate. A user that is associated to a category is a [category user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/r_CategoryUsersAndStakeholders.md).

</td><td>

Stores associations between users and surveys. A user that is associated to a survey is a [survey user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_SurveyUsersAndGroups.md) and is automatically associated to all the survey's categories.
...
Stores all [assessment groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/r_CategoryResults.md).
...
Stores all [assessment instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_AssessmentInstances.md).

</td><td>

Stores all [survey instances](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/t_ViewSurveyInstance.md).
...
Stores all [metrics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_AssessmentMetrics.md).
...
Stores all [metric definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/t_CreateAMetricDefinition.md).

</td><td>

Stores all [answer options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/t_CreateOrModifyAnswerOptions.md) for survey questions.
...
Stores all [metric templates](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/r_MetricTemplates.md).
...
Stores all [metric types](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_AssessmentInstances.md).

</td><td>

Stores all [survey definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_SurveyDefinitions.md).
...
Stores associations between assessable records and category users. A category user that is associated to an assessable record is a [stakeholder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_MetricTypesAndAssessableRecords.md).
...
Stores all [metric template definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/r_MetricTemplates.md).
...
Users can specify metric categories as the X axis of a [decision matrix](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/r_AdministerDecisionMatrixes.md).
...
Stores all [bubble chart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/r_BubbleChartComponents.md) definitions.
...
Stores all [decision matrixes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/r_AdministerDecisionMatrixes.md).
...
Stores all [metric categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_AssessmentMetrics.md).
...
Stores all [metric results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/t_ViewAMetricResult.md).

</td><td>

Stores all [survey responses](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_SurveyResults.md).
...
Stores all [signature records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/t_CreateAnAssessmentSignature.md) for assessments and \[\[Attestations\|GRC attestations\]\].

</td><td>

Stores all signature records for[Surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/r_SurveyManagementLandingPage.md).
...
Stores all [assessment trigger conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/t_CreateTriggerAssessment.md).

</td><td>

Stores all [survey trigger conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_TriggerConditions.md).
...
-   Default value: **Yes**
 ...
 For more information about working with signatures, see [Signatures](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/t_CreateAnAssessmentSignature.md).
...
</table>For more information about customizing the appearance of a survey, see [Customize the appearance of a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/t_CustomizingAppearance.md).
...
|MigrateSurveyToAssessment|Code for [migrating legacy surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_MigrateSurveys.md) to assessment surveys.|
...
</table>**Parent Topic:**[Assessments and Surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/assessments-surveys-landing-page.md)
