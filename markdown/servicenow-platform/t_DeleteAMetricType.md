...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/t\_DeleteAMetricType.html
release: australia
topic_type: task
...
1.  Delete the records associated with the type to delete:
    ...
    -   [Assessment results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/r_AssessmentResults.md) \(metric and category results\)
    -   [Assessment instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/c_AssessmentInstances.md) \(questions and assessment instances, in that order\)
