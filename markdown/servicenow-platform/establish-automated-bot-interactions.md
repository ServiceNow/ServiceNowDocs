...
In the ServiceNow base system, a few operation handlers are available by default. For information on operation handlers, see [ServiceNow Voice reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/ccc-reference.md).
