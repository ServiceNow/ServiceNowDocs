...
**Parent Topic:**[Enrolling in the Password Reset application to reset your password](../concept/c_EnrollInPasswordReset.md)
...
[Enroll for the Password Reset program using Soft PIN](enroll-pwr-program-soft-pin.md)

[Reset your password on Windows systems](t_RsttPassDeskRst.md)
