...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/password-reset/setup-pwd-reset-ihub.html
release: australia
...
</table>3.  For third party providers, [create a credential store type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/password-reset/t_CreateACredentialStoreType.md).

    1.  Select the **Use Flow** check box.

    2.  Select the password reset subflows that you created for the provider.

    See [Password Reset application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/password-reset/password-reset-landing-page.md) for more information.

4.  [Create password reset credential store](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/password-reset/c_CredentialStores.md).

5.  [Create a password reset process](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/password-reset/t_CreateAPasswordResetProcess.md).
