...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/password-reset/win-security-properties-password-reset.html
release: xanadu
...
-   The **CheckCertificateRevocationList** registry key default setting of **true** causes the Password Reset Windows Application to validate the server certificate before every communication. See [Customize the Password Reset Windows Application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/password-reset/win-customize-password-reset.md) for details.
-   The **ServiceNowCertPublicKey** registry key contains the public key for the app. See [Customize the Password Reset Windows Application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/password-reset/win-customize-password-reset.md) for details.
