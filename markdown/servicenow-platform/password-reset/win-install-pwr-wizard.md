...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/password-reset/win-install-pwr-wizard.html
release: zurich
...
5.  Restart the computer.
    ...
    See [Use an EXE file from the command line](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/password-reset/win-install-pwr-exe.md).
