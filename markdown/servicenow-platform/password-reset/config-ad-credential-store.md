...
8.  Set up the [Microsoft AD v2 spoke](https://www.servicenow.com/docs/access?context=setup-ms-ad-v2&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
