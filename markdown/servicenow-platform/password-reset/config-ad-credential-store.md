...
To disable history policy, see [Enable history check for password reset](manage-history-check.md).
...
8.  Set up the [Microsoft AD v2 spoke](https://www.servicenow.com/docs/access?context=setup-ms-ad-v2&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US)
