...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/password-reset/configure-auto-enroll-for-pwd-reset.html
release: yokohama
...
2.  Click the verification type for the verification that your Password Reset process uses.
    ...
    The verification type for each base-system verification is identified in [Password Reset verifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/password-reset/c_PWRVerifications.md).
