...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/password-reset/win-proxy-cfg-clients-password-reset.html
release: yokohama
...
-   Configure registry keys. See [Configure registry keys on your proxy server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/password-reset/win-proxy-registry-password-reset.md).
