...
Number of questions that a user must provide answers to while enrolling for the Password Reset process.
 ...
 The value that you specify here overrides the setting of the **Number of security questions required during enrollment** property. See [Configuring Password Reset properties](t_SetPwdResetProps.md).
