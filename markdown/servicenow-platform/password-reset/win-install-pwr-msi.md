...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/password-reset/win-install-pwr-msi.html
release: xanadu
...
1.  Ensure that the user with the ServiceNow security\_admin role configures the security properties.
    ...
    For more information about security properties, see [Configure security settings for the Password Reset Windows Application](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/password-reset/win-security-properties-password-reset.md).
...
6.  After installation and depending on the setting for the `/NORESTART` argument, you might need to restart computers.
    ...
    See [Install Password Reset Windows Application using a wizard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/password-reset/win-install-pwr-wizard.md) and [Install the Password Reset Windows Application using an EXE file from the command line](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/password-reset/win-install-pwr-exe.md).
