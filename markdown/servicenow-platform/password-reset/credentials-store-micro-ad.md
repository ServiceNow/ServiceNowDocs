...
-   **[Integrate Password Reset with your Microsoft Entra ID](../task/Config-credential-store-micro-azure.md)**  
...
-   **[Configure the connection to the Microsoft Entra ID Credential Store](../task/config-azure-credential-store.md)**  
