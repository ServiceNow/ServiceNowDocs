...
-   **Homepages with a dashboard view**
    ...
    Password Reset has a new, modernized look and feel. For more information, see [Next Experience UI](https://www.servicenow.com/docs/access?context=next-experience-landing-page&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
