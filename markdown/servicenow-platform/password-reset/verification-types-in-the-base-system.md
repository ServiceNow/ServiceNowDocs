...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/password-reset/verification-types-in-the-base-system.html
release: zurich
...
Verifies user identity by presenting personal security questions that the user must answer correctly. **Note:** The Password Reset and Password Reset Windows Application support only a single verification of the Security Questions type.
 ...
 See [Add a custom question to the Security Questions verification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/password-reset/t_CreateQAVerificationQs.md).
...
See [SMS Code Verification type for Password Reset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/password-reset/c_SMSCodeTypeVerifications.md).
