...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/workflow-activities/t\_EditActivitiesPropForm.html
release: yokohama
...
4.  On the Form Design page for the Activity Properties form, add and remove activity variables.

    The activity variables appear as separate items that you can rearrange on the form.

    For more details on using the form design interface, see [Using the form designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/c_FormDesign.md).
