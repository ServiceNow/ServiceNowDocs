...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/c\_QuizDesigner.html
release: zurich
topic_type: concept
last_updated: "2025-07-31"
reading_time_minutes: 4
breadcrumb: [Use, Quizzes, Assessments and Surveys, Exploring Service Administration, Service Administration, Manage service capabilities, Extend ServiceNow AI Platform capabilities]
---
...
|Choice|List of predefined options. For more information, see the definition for **Choices** [Create quiz questions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_CreateAQuizQuestion.md). Multiple correct answers are supported.|Y|
|Date|Date field.|N|
...
|Template|Choice list of templates that provide a predefined scale of options. For details, see [Configure a template question](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_ConfigureATemplateQuestion.md). Multiple correct answers are supported.|Y|
...
-   **Configuration**: Create introductions and end notes for quizzes, and select a [signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_CreateAnAssessmentSignature.md).
...
-   **[Edit a quiz](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_EditaQuiz.md)**  
You can update a quiz after the quiz has been distributed.
-   **[Enable a quiz retake](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_EnableAQuizRetake.md)**  
...
-   **[View a quiz result](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_ViewAQuizResult.md)**  
You can view quiz results for each question and category, or view the quiz scorecard for a detailed breakdown.

**Parent Topic:**[Using Quizzes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/using-quizzes.md)

**Related topics**  


[View an assessment category result](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_ViewACategoryResult.md)

[View a quiz scorecard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_ViewAQuizScorecard.md)
