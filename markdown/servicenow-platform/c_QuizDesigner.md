...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/c\_QuizDesigner.html
release: australia
topic_type: concept
...
|Choice|List of predefined options. For more information, see the definition for **Choices** [Create quiz questions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_CreateAQuizQuestion.md). Multiple correct answers are supported.|Y|
|Date|Date field.|N|
...
|Template|Choice list of templates that provide a predefined scale of options. For details, see [Configure a template question](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_ConfigureATemplateQuestion.md). Multiple correct answers are supported.|Y|
...
-   **Configuration**: Create introductions and end notes for quizzes, and select a [signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_CreateAnAssessmentSignature.md).
...
-   **[Create a quiz](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_CreateaQuiz.md)**  
When you create a quiz, you can create one or more categories and then add questions to each category.
-   **[Edit a quiz](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_EditaQuiz.md)**  
You can update a quiz after the quiz has been distributed.
-   **[Enable a quiz retake](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_EnableAQuizRetake.md)**  
...
-   **[View a quiz result](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_ViewAQuizResult.md)**  
...
[View an assessment category result](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_ViewACategoryResult.md)

[View a quiz scorecard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_ViewAQuizScorecard.md)
