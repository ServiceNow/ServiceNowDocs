...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/product-support-for-technology/proactive-triggers.html
release: xanadu
...
You can customize the appearance of the Proactive Triggers message. For example, you can change the side bar color of the message. For more information about customization, see .
