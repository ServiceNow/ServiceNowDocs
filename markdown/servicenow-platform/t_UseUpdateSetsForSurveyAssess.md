...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/t\_UseUpdateSetsForSurveyAssess.html
release: zurich
topic_type: task
...
1.  Create an update set and use it to make changes on a development instance.
    ...
    **Note:** For more information, see [System update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/system-update-sets.md).
