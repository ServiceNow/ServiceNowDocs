...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/metricbase/train-a-model.html
release: yokohama
product: MetricBase
...
You can create a Workflow Studio trigger for this model. For more information, see [Create a model trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/metricbase/create-metricbase-model-trigger.md).
