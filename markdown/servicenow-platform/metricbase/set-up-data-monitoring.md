...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/metricbase/set-up-data-monitoring.html
release: yokohama
product: MetricBase
...
-   [Install MetricBase](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/metricbase/request-metricbase.md)
...
Use the REST or JavaScript APIs to send the data to the MetricBase database at the rate that is prescribed by the time-series definition. See [Developer resources](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/metricbase/developer-resources.md).
