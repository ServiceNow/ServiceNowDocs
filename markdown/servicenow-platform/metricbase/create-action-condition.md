...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/metricbase/create-action-condition.html
release: yokohama
product: MetricBase
...
Use Workflow Studio to [associate a flow with a trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/metricbase/assign-trigger-to-workflow.md). When configuring a flow, you can select a Condition Script you created.
