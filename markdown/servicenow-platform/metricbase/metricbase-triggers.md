...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/metricbase/metricbase-triggers.html
release: zurich
product: MetricBase
...
For more information about time-series policies, see [Create a time-series definition in MetricBase](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/metricbase/set-up-data-monitoring.md).

\[Omitted image "mb-glide-relationship.png"\] Alt text: Trigger workflow

1.  Define one or more triggers on an instance.
    -   **[Create a MetricBase band trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/metricbase/create-metricbase-band-trigger.md)**

        Triggers when a metric value falls within a range of values.

    -   **[Create a MetricBase linear predictor trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/metricbase/create-mb-linear-predictor-trigger.md)**

        Triggers when a series of values trend toward and are expected to reach a specified value.

    -   **[Create a MetricBase gap trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/metricbase/create-metricbase-gap-trigger.md)**

        Triggers when values are not received for a specified period.

    -   **[Create a MetricBase model trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/metricbase/create-metricbase-model-trigger.md)**

        Triggers when a trained model detects anomalous behavior.

2.  [Execute triggers conditionally](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/metricbase/create-action-condition.md)
...
3.  [Assign a trigger to a flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/metricbase/assign-trigger-to-workflow.md)
