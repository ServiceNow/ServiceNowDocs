...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/metricbase/create-metricbase-model-trigger.html
release: yokohama
product: MetricBase
...
Trained model this trigger uses. See [Create and train a predictive model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/metricbase/train-a-model.md).
