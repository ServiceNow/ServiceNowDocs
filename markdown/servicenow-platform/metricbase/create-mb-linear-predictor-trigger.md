...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/metricbase/create-mb-linear-predictor-trigger.html
release: australia
product: MetricBase
 ...
 **Level** is often used in Condition Scripts. See [Execute triggers conditionally](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/metricbase/create-action-condition.md).
