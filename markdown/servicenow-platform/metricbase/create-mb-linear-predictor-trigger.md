...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/metricbase/create-mb-linear-predictor-trigger.html
release: yokohama
product: MetricBase
 ...
 **Level** is often used in Condition Scripts. See [Execute triggers conditionally](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/metricbase/create-action-condition.md).
