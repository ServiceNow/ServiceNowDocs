...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/configure-custom-AO-scan.html
release: australia
topic_type: task
...
Configure Article Optimization scans for articles in the Knowledge Center. Two types of Article Optimization scans are available in the Knowledge Center. One is a script-based scan and the other is a AI-based scan. If you are subscribed to ServiceNow Otto, you can configure both the scan types. If you are not subscribed to ServiceNow Otto, you can configure only the script-based scans, and Article Optimization runs only the script-based scans.
...
To run the scan, you must add the configured scan to a job. For more information see, [Configure Article Optimization jobs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configuring-article-optimization-jobs.md)
...
[Activate the Article Optimization skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/now-assist-in-knowledge-management/activate-kc-AO-skill.md)
