...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/notify/notify-zoom-connector.html
release: yokohama
product: Notify
...
-   Ensure that the system has Zoom spoke, version 1.0.2, for ServiceNow Integration Hub plugin \(sn\_zoom\_spoke\) installed and the necessary Integration Hub license to use Zoom for meeting management.

## Plugins

-   [ServiceNow IntegrationHub Installer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/integrate-applications/integration-hub/request-ih-overview.md) \(com.glide.hub.integrations\): Suite of plugins necessary to design integration flows in the Workflow Studio application.
...
**Parent Topic:**[Exploring Notify](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/notify/exploring-notify.md)
