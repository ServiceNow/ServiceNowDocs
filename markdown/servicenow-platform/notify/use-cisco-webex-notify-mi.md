...
-   **[Create a collaborative communication task from MIM workbench](../task/create-collab-comm-cisco-webex-notify.md)**  
...
-   **[Initiate Notify Cisco Webex conference from MIM workbench](../task/initiate-cisco-webex-notify-conference.md)**  
Initiate a Webex conference from the MIM workbench to work towards the resolution of the major incident.
-   **[Add participants to a conference call](../task/add-participants-cisco-webex-notify-call.md)**  
Add a participant to a conference call to participate in the discussion to resolve the major incident.
-   **[Join a conference call](../task/join-cisco-webex-notify-call.md)**  
You can join an active conference call from an incident to discuss about the resolution of an incident.

**Parent Topic:**[Using Notify](../../notify2/concept/using-notify.md)
