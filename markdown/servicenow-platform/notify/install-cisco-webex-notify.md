...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/notify/install-cisco-webex-notify.html
release: australia
product: Notify
...
2.  Find the Notify Cisco Webex Connector application \(sn\_notify\_webex\) using the filter criteria and search bar.
...
**Parent Topic:**[Configure Notify Cisco Webex Connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/notify/setup-cisco-webex-notify.md)
