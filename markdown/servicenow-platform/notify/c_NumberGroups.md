...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/notify/c\_NumberGroups.html
release: xanadu
product: Notify
...
-   **[Create a number group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/notify/t_CreateANumberGroup.md)**  
Group Notify phone numbers and share workflows across grouped numbers.
-   **[Associate a number to a number group](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/notify/t_AssignANumberGroup.md)**  
Associate a Notify number to a number group to use inbound and outbound workflows.

**Parent Topic:**[Notify reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/notify/notify-reference-section.md)
