...
Explore
 ...
 -   [Notify Twilio Direct driver](../concept/Notify-TwilioDirectDriver.md)
...
-   [Notify connector for Microsoft Teams](https://www.servicenow.com/docs/access?context=notify-connector-ms-teams&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US)
...
-   [Install Notify connector for Microsoft Teams](https://www.servicenow.com/docs/access?context=setup-notify-ms-teams&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US)
...
-   [Using Notify for making conference calls](../concept/c_NotifyConferenceCalls.md)
-   [Using Notify with tasks](../concept/c_NotifyOnTask.md)
...
-   [Use Notify connector for Microsoft Teams](https://www.servicenow.com/docs/access?context=c-agent-ex-use-nc&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US)

</td><td>

Reference

 -   [Differences between Notify-Twilio and Notify-Twilio Direct](difference-notify-twilio-direct.md)
-   [Notify workflow activities](../../../administer/workflow-activities/concept/c_NotifyActivities.md)
-   [Components installed with Notify](installed-with-notify2.md)
