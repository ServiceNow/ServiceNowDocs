...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/notify/Notify-TwilioDirectDriver.html
release: zurich
product: Notify
...
If the instance is connected to Twilio and you upgrade to Zurich, the Twilio will not be disconnected from your instance and continues to use the Account SID and Auth key. However, if the administrator disconnects Twilio from the instance and re-connect the Twilio service, the additional record will be created to enhance the security.
...
[Configure Notify with Twilio](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/notify/t_ConfigureNotifyWithTwilio.md)
