...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/notify/t\_IALaunchAConferenceCall.html
release: xanadu
product: Notify
...
5.  Select the conference bridge and the participants for the conference call.
    ...
    Available options in the conference bridge depend on the conference providers configured. For more information, refer [Configure a provider in Notify](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/notify/configure-providers-for-provider-selectors.md).
