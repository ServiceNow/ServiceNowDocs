...
The Google Maps plugin provides additional map properties that are used to implement and control specific geolocation features. You must have a [private key](r_GeolocationGoogleKey.md) for Google Maps API for Business to take advantage of the properties listed here.
