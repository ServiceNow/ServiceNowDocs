...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/r\_InstalledWithGeolocation.html
release: australia
...
The Geolocation plugin adds a field called [Geolocation tracked](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/r_InstalledWithGeolocation.md) to the User `[sys_user]` table. This field allows the system to track individual users by their geographical coordinates.
