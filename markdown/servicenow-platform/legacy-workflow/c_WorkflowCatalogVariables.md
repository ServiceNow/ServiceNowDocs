...
2.  The list of variables that appears in the workspace has a default filter of **Cat Item != &lt;blank&gt;**. [Change the filter](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US) to **Cat Item = &lt;blank&gt;** and run the query.
