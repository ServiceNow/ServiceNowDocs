...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/legacy-workflow/r\_VldtTransitionOut.html
release: zurich
...
\[Omitted image "image.ConditionOutValid"\] Alt text:
...
\[Omitted image "image.ConditionOutInvalid"\] Alt text:
