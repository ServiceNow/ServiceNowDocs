...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/legacy-workflow/r\_VldtInptVrUpdtStDpd.html
release: xanadu
...
-   Publishable: Yes
-   Runnable: Yes
-   Related Information: [Workflow movement with update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/legacy-workflow/c_WorkflowMovementWithUpdateSets.md)
...
Follow the instructions for [Input variable removal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/legacy-workflow/c_InputVariableRemoval.md) when the validator issues this warning.
