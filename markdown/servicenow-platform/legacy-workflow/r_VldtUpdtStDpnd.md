...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/legacy-workflow/r\_VldtUpdtStDpnd.html
release: xanadu
...
For information about update sets, see [Create and select an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/application-development/system-update-sets/create-select-update-set.md).
