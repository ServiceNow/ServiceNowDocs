...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/servicenow-platform/legacy-workflow/r\_VldtUpdtStDpnd.html
release: brazil
...
For information about update sets, see [Create and select an update set](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/application-development/create-select-update-set.md).
