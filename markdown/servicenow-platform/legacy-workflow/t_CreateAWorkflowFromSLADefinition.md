...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/legacy-workflow/t\_CreateAWorkflowFromSLADefinition.html
release: yokohama
...
-   If you’re designing the workflow as part of an update set process, see [Workflow movement with update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/legacy-workflow/c_WorkflowMovementWithUpdateSets.md) before creating the workflow.
...
8.  Edit the conditions fields as necessary.
...
11. Change the advanced settings for the workflow by clicking the properties icon \(\[Omitted image "PropIcon.png"\] Alt text: Properties icon.\).
