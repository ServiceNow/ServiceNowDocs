...
This validation warns of critical errors that can prevent a workflow from running successfully, but also warns of dependencies and conflicts in update sets. See [../../workflow-validation/reference/r\_VldtUpdtStDpnd.md](../../workflow-validation/reference/r_VldtUpdtStDpnd.md) for more details.
