...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/legacy-workflow/c\_WorkflowFieldsWithDeletedRecords.html
release: zurich
...
Administrators can restore deleted records. For more information, see [Use the Deleted Records module to restore a deleted record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/t_RestoreADeletedRecordAndRef.md).
