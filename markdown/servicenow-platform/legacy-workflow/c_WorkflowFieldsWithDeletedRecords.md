...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/legacy-workflow/c\_WorkflowFieldsWithDeletedRecords.html
release: xanadu
...
Administrators can restore deleted records. For more information, see [Use the Deleted Records module to restore a deleted record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/table-administration-and-data-management/t_RestoreADeletedRecordAndRef.md).
