...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/legacy-workflow/r\_EventSpecificWorkflowActivities.html
release: xanadu
...
[Wait for WF Event](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/workflow-activities/r_WaitForWFEvent.md)

</td><td>

Listens for workflow events, as described in the [Workflow Events in the Base System](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/legacy-workflow/r_WorkflowEventsInTheBaseSystem.md) table, and only within the current context. This activity is located in the **Conditions** category of the workflow tree.
...
</table>**Parent Topic:**[Workflow events in the base system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/legacy-workflow/r_WorkflowEventsInTheBaseSystem.md)
