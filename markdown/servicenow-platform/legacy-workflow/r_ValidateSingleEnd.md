...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/legacy-workflow/r\_ValidateSingleEnd.html
release: zurich
...
\[Omitted image "image.TwoEndExampleValid"\] Alt text:
...
\[Omitted image "image.TwoEndExampleInValid"\] Alt text:
