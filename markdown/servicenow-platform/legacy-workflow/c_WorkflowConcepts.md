...
-   Create custom activities and reuse the data for other workflows.
    ...
    See [Orchestration activity designer](https://www.servicenow.com/docs/access?context=c_WorkflowActivityDesigner&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
