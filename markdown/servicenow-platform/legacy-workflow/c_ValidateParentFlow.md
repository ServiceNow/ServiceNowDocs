...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/legacy-workflow/c\_ValidateParentFlow.html
release: australia
...
-   **Publishable:** Yes
-   **Runnable:**Yes
-   **Related Information:** [Workflows used as subflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/legacy-workflow/workflows-as-subflows.md)
...
-   Changing the data types of [input variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/legacy-workflow/c_UsingVariablesInAWorkflow.md). Verify that all parent workflows cited in this validation report can pass the correct value type.
