...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/legacy-workflow/t\_CreateAWorkflowFromATable.html
release: xanadu
...
10. To change advanced settings for the workflow, click the **Properties** icon \[Omitted image "PropIcon.png"\] Alt text: Properties icon.

11. If you made changes, click **Update**.


**Parent Topic:**[Create a workflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/legacy-workflow/t_CreateAWorkflow.md)
