...
-   A basic understanding of the [Skills Management](../../../product/skills-management/reference/skills-management.md) feature is recommended.
...
-   You can use rules to identify skills and assign them to work items. For more information on defining and assigning skills for work items, see [Routing work items to agents based on skills](../../../product/skills-management/concept/skill-based-routing.md).
...
**Parent Topic:**[Work assignments](../concept/awa-assignment.md)
