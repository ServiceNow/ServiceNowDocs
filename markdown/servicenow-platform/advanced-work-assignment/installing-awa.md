...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/advanced-work-assignment/installing-awa.html
release: yokohama
...
5.  In the Essential settings section, select **Set up service channels** to [configure the service channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-create-service-channel.md) that you activated.

    1.  [Create or change an inbox layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-modify-inbox-layout.md).

    2.  [Override agent capacity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-change-agent-capacity.md), as needed.

6.  In the Essential settings section, select **Set up queues** to [create work item queues](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-create-queue.md) for your service channels.

    1.  [Set the sort order for work items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-set-work-sort-order.md) in the queue.
...
8.  In the Additional settings section, consider configuring the following parameters to improve your AWA functionality.
    ...
    4.  Select **Set up groups** to [create groups of user sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-groups.md) who share a common purpose.
...
9.  In the Advanced settings section, consider configuring the following parameters to improve your AWA functionality.
    ...
    **Note:** Advanced settings cards appear conditionally after installing their respective plugin.
    ...
    1.  Select **Set up Agent Affinity** to [create or change the Agent Affinity rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-configure-agent-affinity.md) that route work items in Advanced Work Assignment.

    2.  Select **Set up Shift-based Assignment** to [assign work items to agents based on shifts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-create-assignment-rule.md).


-   **[Advanced Work Assignment home page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-admin-console-home.md)**  
...
-   **[Get started with Advanced Work Assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/implement-awa.md)**  
To implement Advanced Work Assignment, complete these initial configuration and setup steps.
-   **[Install Conversational SMS service channel](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/install-conversational-sms.md)**  
...
-   **[Activate Agent Affinity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-activate-agent-affinity.md)**  
You can activate the Agent Affinity plugin \(com.glide.awa.agent\_affinity\) if you have the admin role.
-   **[Activate Conversational Messaging](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/activate-messaging-actions.md)**  
You can activate the Conversational Messaging plugin \(com.glide.messaging.awa\) if you have the admin role.
-   **[Service channels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-service-channels.md)**  
Provide customer support by automatically routing incoming work to agents through service channels.
-   **[Work items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-work-items.md)**  
View Advanced Work Assignment work items using the Work Items menu options.
-   **[Work assignments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-assignment.md)**  
...
-   **[Using Agent Affinity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-agent-affinity-concept.md)**  
...
-   **[Agent Inbox controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/agent-experience.md)**  
...
-   **[Advanced Work Assignment Inbox Sentiment display](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-inbox-sentiment-display.md)**  
...
-   **[Wrap up overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/wrap-up-overview.md)**  
...
-   **[Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/management.md)**  
Configure Advanced Work Assignment properties using the Management menu options.
-   **[AWA group queue priorities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-group-queue-priorities.md)**  
...
-   **[Configure messaging actions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/configure-messaging-actions.md)**  
Create or modify messaging actions that are performed when an event occurs. These actions apply only to messaging.
-   **[Enable logging for Advanced Work Assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-activate-logging.md)**  
Enable logging to monitor AWA routing and assignment.

**Parent Topic:**[Advanced Work Assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-application-landing-page.md)
