...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/advanced-work-assignment/awa-agent-affinity-concept.html
release: yokohama
...
-   **[Configure Agent Affinity rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-configure-agent-affinity.md)**  
Create or change the Agent Affinity rules that route work items in Advanced Work Assignment.
-   **[Set Agent Affinity rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-set-agent-affinity-for-queue.md)**  
Specify the Agent Affinity rules to determine the order in which work items in a queue are sorted.
-   **[Deactivate Agent Affinity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/awa-deactivate-agent-affinity.md)**  
