...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/advanced-work-assignment/awa-unassigned-task-work-items.html
release: yokohama
...
List that shows the status of the task: -   Accepted
-   Cancelled
-   Pending Accept
-   Queued
...
Reason that the task was canceled: -   Disqualified from service channel
-   Manually assigned
-   Time out
...
**Parent Topic:**[Using Advanced Work Assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/advanced-work-assignment/using-awa.md)
