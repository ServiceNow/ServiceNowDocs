...
-   Native [Chat surveys](https://www.servicenow.com/docs/access?context=ci-conversational-chat-surveys&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US)
-   Supervisor features, such as [Agent Whisper](https://www.servicenow.com/docs/access?context=ci-agent-whisper&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US), that enable managers to join ongoing public customer chats with agents or send private messages to agents.
...
If you are currently using Connect Support APIs, see [AWA Routing API](https://www.servicenow.com/docs/access?context=queue-api&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US) for information on AWA APIs.
...
5.  In [Agent Chat settings](https://www.servicenow.com/docs/access?context=ac-configure-agent-chat&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US), access the Chat Setup form to specify Agent Workspace as the fulfiller interface for live chat and enable other live chat features.

6.  Activate the [chat client on your end user Service Portal](https://www.servicenow.com/docs/access?context=ac-configure-bot-portal&version=xanadu&pubname=xanadu-conversational-interfaces&ft:locale=en-US).
