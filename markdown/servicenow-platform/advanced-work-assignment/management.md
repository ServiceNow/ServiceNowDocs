...
-   **[Configure an agent's maximum universal capacity](../task/awa-universal-capacity.md)**  
...
-   **[Create or change groups for Advanced Work Assignment queues](../task/awa-groups.md)**  
Create or manage groups that have associated Advanced Work Assignment queues.
-   **[AWA post work item subflow](../task/awa-post-work-item-subflow.md)**  
