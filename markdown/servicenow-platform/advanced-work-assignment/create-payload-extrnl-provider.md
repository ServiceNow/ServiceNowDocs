...
description: Create a payload for external third-party providers to send your work item details and events to the external queue.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/advanced-work-assignment/create-payload-extrnl-provider.html
release: xanadu
...
2.  Create a queue enabling External Routing.
    ...
    For more information about creating a queue with external routing, see [Enable external routing for queues](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/advanced-work-assignment/enable-awa-external-routing.md).
