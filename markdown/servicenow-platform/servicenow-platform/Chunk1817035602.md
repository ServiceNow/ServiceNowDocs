...
For example, a CMDB CI Lifecycle Management API can use a CMDB group scriptable API to retrieve the group's list of CIs, and then apply a CI Lifecycle Management action collectively to all the CIs. You can also use a CMDB group with the [Dynamic CI Group](product/configuration-management/task/populate-app-service-dynamic-group.md) service population method, to populate an application service.
...
-   If a CMDB group is set to CMDB Workspace, then that group appears in the [Management view](product/configuration-management/concept/cmdb-workspace-mangmnt-view.md)in the [CMDB Workspace](product/configuration-management/concept/cmdb-workspace.md).
...
-   CMDB Workspace: Custom class group which appears in the CI Overview panel in [CMDB Workspace store app](product/configuration-management/concept/cmdb-workspace.md).
