...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/api-insights/api-insights-tag-reln-cmdb-admin.html
release: xanadu
...
1.  [Define tag-based mapping rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown).
2.  [Schedule the tag-based mapping rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown).
...
Scheduled jobs automate tasks that run at a specific time or on a recurring schedule. You need the admin role to configure and run a scheduled job. For more information on configuring a scheduled job, see .
