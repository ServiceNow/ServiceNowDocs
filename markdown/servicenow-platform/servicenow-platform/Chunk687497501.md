...
1.  [Define tag-based mapping rules](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown).
2.  [Schedule the tag-based mapping rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown).
