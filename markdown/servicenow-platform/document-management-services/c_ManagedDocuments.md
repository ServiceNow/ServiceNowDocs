...
-   **[Managed Document features](../reference/r_ManagedDocumentFeatures.md)**  
...
-   **[Managed Documents plugin](../reference/r_ManagedDocumentsPlugin.md)**  
This page describes the applications and modules, database table structure, scripts, and roles.
-   **[Knowledge Document plugin](c_KnowledgeDocument.md)**  
...
-   **[Create a document](c_CreateADocument.md)**  
...
-   **[Create a new managed document record](../task/t_CreateANewManagedDocumentRecord.md)**  
Configure the properties and policies for a managed document.
-   **[Check in a document after making changes](../task/t_CheckInADocAfterChanges.md)**  
After making changes to a document, check the revised document into Managed Documents.
-   **[Check out a document to make changes](../task/t_CheckOutADocumentToMakeChanges.md)**  
...
-   **[Publish a document in Managed Documents](../task/t_PubADocInManagedDocs.md)**  
After the document is reviewed and approved, publish the document within Managed Documents.
-   **[Send a document out for review and approval](../task/t_SendDocForReviewApproval.md)**  
...
-   **[Upload a document as an attachment](../task/t_UploadADocumentAsAnAttachment.md)**  
After creating a document record, add the document to the record as an attachment.

**Parent Topic:**[Document Services](../../document-services/reference/document-services-landing-page.md)
