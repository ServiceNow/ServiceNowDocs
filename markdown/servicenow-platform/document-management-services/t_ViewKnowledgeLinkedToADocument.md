...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/document-management-services/t\_ViewKnowledgeLinkedToADocument.html
release: xanadu
...
The document is already uploaded and published. For more information, see [Upload a document](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/document-management-services/t_UploadADocument.md) and [Publish an approved revision](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/document-management-services/t_PublishAnApprovedRevision.md).
