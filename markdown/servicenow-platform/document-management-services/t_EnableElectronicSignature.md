...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/document-management-services/t\_EnableElectronicSignature.html
release: yokohama
...
You can activate the [Approval with e-signature plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/approvals/r_InstalledWApprWithEsignature.md) to require that users type in a user name and password when reviewing and approving documents.
