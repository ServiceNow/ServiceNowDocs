...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/document-management-services/sign-pdf-documents-cac-piv.html
release: xanadu
...
1.  Initiate the PDF document signing process with a custom implementation using script.
    ...
    For more information, see [Using Document Templates: Generic use case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/hr-service-delivery/doc-temp-gen.md).
