...
1.  Initiate the PDF document signing process with a custom implementation using script.
    ...
    For more information, see [Using Document Templates: Generic use case](https://www.servicenow.com/docs/access?context=doc-temp-gen&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US).
