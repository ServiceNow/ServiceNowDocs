...
-   Use [Document Templates](https://www.servicenow.com/docs/access?context=document-templates-overview&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US) to create and upload a PDF document
