...
For information about setting up the spoke, see [Set up Microsoft OneDrive spoke](https://www.servicenow.com/docs/access?context=setup-msonedrive&version=australia&pubname=australia-integrate-applications&ft:locale=en-US).
