...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/document-management-services/enable-accessibility-docx-to-pdf.html
release: australia
...
2.  Open the **com.snc.document.conversion.accessibility\_enabled** system property.

3.  In the value field, update the value to `true`.
