...
-   **[Document approval](../reference/r_ApprovalProcess.md)**  
...
-   **[Review process](c_ReviewProcess.md)**  
...
-   **[Enable electronic signature for approval](../task/t_EnableElectronicSignature.md)**  
...
-   **[Publish an approved revision](../task/t_PublishAnApprovedRevision.md)**  
Publish a document revision that has been approved.
-   **[Submit a revision for draft review](../task/t_SubmitARevisionForDraftReview.md)**  
Submit a document draft for review.
-   **[Create or request a new document](../task/t_CreateOrRequestANewDocument.md)**  
Once an administrator has set parameters for the Managed Documents application, you can create or request new documents.
-   **[Check in a document](../task/t_CheckInADocument.md)**  
Check in the document after you revise it so other users can check out the document.
-   **[Copy a document](../task/t_CopyADocument.md)**  
...
-   **[Deactivate a document](../task/t_DeactivateADocument.md)**  
...
-   **[Reopen a deactivated document](../task/t_ReopenADeactivatedDocument.md)**  
A document that has been deactivated can be reopened.
-   **[Roll back a document](../task/t_RollBackADocument.md)**  
...
-   **[Cancel a document](../task/t_CancelADocument.md)**  
Change the document state to Cancelled when no more changes will be made to the document.
-   **[Check out a document](../task/t_CheckOutADocument.md)**  
...
-   **[Create a document collection](../task/t_CreateADocumentCollection.md)**  
...
-   **[Upload a document](../task/t_UploadADocument.md)**  
