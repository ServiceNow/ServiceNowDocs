...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/document-management-services/doc-mgt-lists.html
release: yokohama
...
\[Omitted image "list-entries.png"\] Alt text: Document list entries

-   **[Group document templates in a list for creating and linking documents to a target record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/document-management-services/create-doc-list.md)**  
...
-   **[Create documents using document lists for a target table record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/document-management-services/create-documents-target-table-record.md)**  
