...
-   **[Document repository](doc-mgt-view-documents-repo.md)**  
...
-   **[Document approval and publish process](document-review-approval.md)**  
...
-   **[Digital signature for PDF documents using CAC or PIV smart cards](digital-signature.md)**  
...
-   **[Document references](doc-mgt-references.md)**  
...
-   **[Linking documents to a parent record](doc-linked-parent-rec.md)**  
...
-   **[Document Management lists](doc-mgt-lists.md)**  
...
-   **[Document attachments in an activity stream](activity-stream-for-documents.md)**  
Include documents in activity streams to include and track updates on attached documents to any record.
-   **[Redact sensitive data from documents](data-redaction-documents.md)**  
Manually mask sensitive content or data from your PDF documents. Data redaction is available in configurable workspaces.
-   **[Document Management integration with external content providers](integration-external-content-providers.md)**  
