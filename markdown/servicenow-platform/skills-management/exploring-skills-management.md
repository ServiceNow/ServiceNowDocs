...
**Important:** Using the Skills Management application, you can create skills and skill categories manually, and also assign them manually to users. Skills Foundation uses Artificial Intelligence \(AI\) to help your organization leverage skills data for talent management and employee development. When you activate the Skills Foundation plugin \(com.sn\_skills\_int\), it also activates the Skills Management plugin \(com.snc.skills\_management\). For information on Skills Foundation, see [Skills Foundation](https://www.servicenow.com/docs/access?context=skills-intelligence&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US).

Skills can contain other skills. For example, if you define network as a skill, you can add router as the skill it contains. A user assigned to a parent skill grants access to a child skill. Once a skill is assigned to a group, all members of the group inherit that skill and any others contained within it. Skills management works similar to ServiceNow platform [Create a role](https://www.servicenow.com/docs/access?context=t_CreateARole&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
-   [IT service management](https://www.servicenow.com/docs/access?context=c_AgAtAssgmtMlt&version=xanadu&pubname=xanadu-service-management-for-the-enterprise&ft:locale=en-US) - As an IT manager, reduce your time and costs while resolving incidents by assigning work items to the right agent. Assess the skill gaps that agents have in your team and [coach](https://www.servicenow.com/docs/access?context=assign-skills-assessment&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US) or train agents based on those needs. Identify and define a standard way to keep skill categories and levels consistent within your team.
-   [Customer service management](https://www.servicenow.com/docs/access?context=case-assignment-workbench&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US) - As a customer service manager, identify agent skills and automatically route tasks to agents who have the required skill to work on those tasks. Manage your team's effectiveness by understanding what type of skills your employees need to get hired or get trained to take on other roles.
-   [Field service management](https://www.servicenow.com/docs/access?context=field-service-manager-agent-skills&version=xanadu&pubname=xanadu-field-service-management&ft:locale=en-US)- As a field service or customer service manager, use rules to identify skills and skill levels that agents require to resolve work items such as cases, work order tasks, and agent interactions. Automate skill assignment to reduce a manager's work load. Automatically assign tasks to agents using Field Service dynamic scheduling.
-   [Human resources management](https://www.servicenow.com/docs/access?context=c_HRSkillsManagement&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US) - As an HR manager, identify the types of skills your organization needs and make hiring decisions based on those needs. Manage your team's effectiveness by understanding what type of skills your employees need to get hired or get trained to take on other roles.
-   [Project portfolio management](https://www.servicenow.com/docs/access?context=c_ProjectTasks&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US) - As a project and portfolio manager, standardize how you categorize skills, define skill level types, and add skill levels for your team. Set up skills for your team in a central location and make them available within your team. Prevent project reassignments by assigning projects to the team members who have the right skills to work on them.
