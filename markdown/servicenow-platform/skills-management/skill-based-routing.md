...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/skills-management/skill-based-routing.html
release: yokohama
...
-   **[Learn how Skill Determination works](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/skills-management/how-skill-determination-works.md)**  
Use Skill Determination to add skills to incoming work items so that agents with those skills can work on it.
-   **[Add a business rule for skill determination](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/skills-management/add-business-rule-skill-determination.md)**  
...
-   **[Create Skill Determination rules to assign skills to work items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/skills-management/conf-simple-skill-determination-rule.md)**  
...
-   **[Qualify and rank users based on skills and skill levels](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/skills-management/assign-work-based-on-skills.md)**  
