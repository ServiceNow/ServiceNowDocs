...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/skills-management/add-business-rule-skill-determination.html
release: yokohama
...
4.  In the **When to run** tab, set when you want the business rule to execute. For more information, see [Create a business rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/business-rules-classic/c_BusinessRules.md).
