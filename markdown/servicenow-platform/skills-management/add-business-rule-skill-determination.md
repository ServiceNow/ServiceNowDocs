...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/skills-management/add-business-rule-skill-determination.html
release: xanadu
...
4.  In the **When to run** tab, set when you want the business rule to execute. For more information, see [Create a business rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/api-reference/business-rules-classic/c_BusinessRules.md).
