...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/skills-management/create-skill-categories-seed-data.html
release: yokohama
...
The sample data provides 150 records that you can use to get started building your skill taxonomy.

## Procedure

1.  [Activate](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_ActivateAPlugin.md) the Skills Library Data for Skills Management \(com.snc.skills\_management.seed\_data\) plugin.
