...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/r\_DataTypes.html
release: australia
 ...
 **Script**: When the script runs, the system populates the **Actual value** and **Scaled value** fields on the [Metric Result](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_ViewAMetricResult.md) form with the appropriate values from the *actual\_result* and *scaled\_result* variables in the metric script.
