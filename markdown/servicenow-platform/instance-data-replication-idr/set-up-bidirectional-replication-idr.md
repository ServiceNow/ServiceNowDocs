...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/instance-data-replication-idr/set-up-bidirectional-replication-idr.html
release: australia
...
1.  Create a producer replication set.
    ...
    5.  Enable discrete mapping from a producer replication set by selecting **Discrete**.
        ...
        Discrete mapping distinguishes different consumer instances. For details, see [Set up discrete replication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/instance-data-replication-idr/set-up-discrete-replication-idr.md).
...
Choose a field to use to coalesce IDR. Only unique fields are available. See [Custom coalescing](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/instance-data-replication-idr/modifying-replication-behavior-idr.md).
