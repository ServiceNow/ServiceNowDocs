...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/instance-data-replication-idr/instance-data-replication-dashboard.html
release: yokohama
...
-   **Active Producer Replication Sets**
    ...
    |Message Queue Version|Version of the Message Queue. Either V1 \(Legacy\) or V2 \(Hermes\)|
...
The IDR License and Usage Details dashboard monitors the following:
