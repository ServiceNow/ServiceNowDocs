...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/instance-data-replication-idr/synchronization-errors.html
release: xanadu
...
Before identifying synchronization errors, complete the tasks in [check for common issues](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/instance-data-replication-idr/common-issues-idr.md).
...
1.  Determine if the consumer successfully sent the synchronize request to the producer:
    ...
    6.  Verify that you see the correct producer instance ID in the To column.
        ...
        If the producer instance ID is incorrect, [update the ID](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/instance-data-replication-idr/create-c-replication-set.md) and click **Activate**.
...
2.  Determine if the producer received the synchronize request from the consumer:
    ...
    6.  Verify that you see the correct consumer instance ID in the From column.
        ...
        If the consumer instance ID is incorrect, [update the ID](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/instance-data-replication-idr/create-c-replication-set.md).
