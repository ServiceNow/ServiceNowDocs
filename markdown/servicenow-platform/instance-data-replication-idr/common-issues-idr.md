...
[Check activation of the producer replication set](../task/create-p-replication-set.md)
...
[Check consumer subscription approval](../task/approve-consumer.md)
...
[Check the activation status of a consumer replication set](../task/create-c-replication-set.md)
...
[Delays in replicating data with Instance Data Replication](../concept/instance-data-replication-delays.md)

[Monitoring Instance Data Replication](../concept/instance-data-replication-dashboard.md)
