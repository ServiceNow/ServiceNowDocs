---
title: Transform replication data for Instance Data Replication
...
-   [Create, activate, and seed one or more consumer replication sets](create-c-replication-set.md).
...
<table id="choicetable_lbg_kqq_snb"><tbody><tr><td id="d493670e133">
...
<table id="choicetable_oh1_45q_snb"><tbody><tr><td id="d493670e178">
...
-   **[Warning and error messagesInstance Data Replication](../reference/schema-warnings-error.md)**  
