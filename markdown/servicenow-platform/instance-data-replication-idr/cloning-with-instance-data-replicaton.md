...
-   **Copy the configuration using a clone profile**
    ...
    For details on cloning, see [System clone](https://www.servicenow.com/docs/access?context=c_SystemClone&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
