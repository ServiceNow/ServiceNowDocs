...
You can copy a replication configuration from one instance to another using an update set. For details on using update sets, see [Get started with update sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/application-development/get-started-update-sets.md).
...
<table id="choicetable_ap2_cnm_3yb"><thead><tr><th align="left" id="d464882e143">

Option

</th><th align="left" id="d464882e146">

Steps

</th></tr></thead><tbody><tr><td id="d464882e152">
...
<table id="choicetable_i5p_kyv_hyb"><thead><tr><th align="left" id="d464882e472">

Type of replication

</th><th align="left" id="d464882e475">

Steps

</th></tr></thead><tbody><tr><td id="d464882e481">
