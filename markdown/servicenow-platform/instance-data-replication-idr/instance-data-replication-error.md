...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/instance-data-replication-idr/instance-data-replication-error.html
release: yokohama
...
|`Error while seeding data. Please retry seeding this table`|To recover, [reseed the table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/instance-data-replication-idr/seed-consumer-instance.md).|
...
**Parent Topic:**[Resolving data replication errors in Instance Data Replication](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/instance-data-replication-idr/common-issues-idr.md)
