...
2.  Follow the steps in [Import data from XML](https://www.servicenow.com/docs/access?context=import-xml-file&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) to import the assessment.
