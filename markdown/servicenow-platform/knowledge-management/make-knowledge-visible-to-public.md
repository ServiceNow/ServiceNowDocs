...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/knowledge-management/make-knowledge-visible-to-public.html
release: xanadu
...
5.  Manage access to the articles for the Knowledge Management Service Portal pages.
    ...
    For more information about providing access to knowledge bases, see [Managing access to knowledge bases and knowledge articles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/user-access-knowledge.md).
