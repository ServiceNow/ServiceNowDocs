...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/knowledge-management/add-human-readable-keywords-knowledge-pages.html
release: xanadu
...
If you are upgrading from a release earlier than the Xanadu release, you must enable the Human Readable URLs feature for the Knowledge Article View page. Beginning with the Xanadu release, this feature is enabled by default.
...
4.  On the Knowledge Article View form, in the **Human readable url structure** field enter the `%short_descr` variable.
    ...
    **Note:** You can also create a variable to add information from various data sources. For more information, see [Add human readable keywords to page URLs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/add-human-readable-keywords-page-urls.md).
...
**Parent Topic:**[Using human readable URLs for the Knowledge article page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/human-readable-urls-km.md)
