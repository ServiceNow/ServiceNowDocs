...
Display the effectiveness of self-service channels by using reports and dashboards based on the data generated by the Self-Service Analytics framework. This Self-Service Analytics data is used by the Self-Service Analytics dashboard for customer service. You can also use the Self-Service Analytics framework in dashboards of other applications that use the Subscriptions and Activity Feed Framework. For more information, see [Self-Service Analytics dashboard for customer service](https://www.servicenow.com/docs/access?context=ssa-cs-dashboard&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
...
[Platform Analytics Solutions for Self-Service Analytics for Customer Service](https://www.servicenow.com/docs/access?context=ssa-cs-content-pack&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)
