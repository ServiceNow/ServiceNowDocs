...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/knowledge-management/select-user-criteria-for-knowledge-block.html
release: yokohama
...
[Activate knowledge blocks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/knowledge-management/activate-knowledge-blocks.md)
...
-   To finish and publish the block, see [Create a knowledge block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/knowledge-management/create-modify-knowledge-block.md).
-   To add the block to an article, as well as preview the article by impersonating different users, see [Add knowledge blocks to a knowledge article](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/knowledge-management/add-knowledge-block-to-knowledge-article.md).
