...
**Note:** Your administrator can configure the HTML toolbar within the HTML editor. For more information, see [Customize TinyMCE attributes](https://www.servicenow.com/docs/access?context=tinymce&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
