...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/knowledge-management/retire-knowledge-block.html
release: xanadu
...
3.  Select **Retire** to retire the knowledge block.
    ...
    **Note:**
    ...
    -   Starting from the Xanadu release, you can retire the knowledge block attached to an article by setting the \(**glide.knowman.allow\_retire\_block**\) system property to true.
...
**Parent Topic:**[Create a knowledge block](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/create-modify-knowledge-block.md)
