...
-   **Assign knowledge roles to users and groups**
    ...
    Determine which [Knowledge Management roles](r_KnowledgeRoles.md#) are appropriate for each user, and then [assign those roles](https://www.servicenow.com/docs/access?context=t_AssignARoleToAUser&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) .

-   **Create custom Knowledge workflows**

    If the default [knowledge workflows](r_KnowledgeWorkflows.md) for publishing and retiring knowledge articles are not appropriate for your knowledge bases, create custom [workflows](https://www.servicenow.com/docs/access?context=c_WorkflowOverview&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US) for those knowledge bases.
