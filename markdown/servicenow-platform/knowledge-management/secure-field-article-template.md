...
1.  Create an encryption module for the article template field to be encrypted.
    ...
    See [Create a cryptographic module](https://www.servicenow.com/docs/access?context=create-cryptographic-module&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) for details.

2.  Associate the article template field with the encryption module.

    See [Encrypting fields and attachments](https://www.servicenow.com/docs/access?context=field-encryption-key-management&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) for details.
