...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/knowledge-management/diagnose-access-criteria-at-an-article-level.html
release: xanadu
...
4.  In the **Related Links** section, click **Run User Criteria Diagnostics**.
 The **User Criteria Diagnostics** landing page appears with the **Select article** field pre-populated.
    ...
    4.  Click **Diagnose**.
        ...
        -   Which user criteria provides read or read and contribute access for this user to the article and what type of [user criteria definition](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/t_SelectUCArticle.md) enables this access.
