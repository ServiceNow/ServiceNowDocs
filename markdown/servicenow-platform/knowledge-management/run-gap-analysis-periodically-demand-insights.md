...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/knowledge-management/run-gap-analysis-periodically-demand-insights.html
release: yokohama
...
2.  In the Scheduled Jobs list, select the scheduled job for your tasks in the **Name** column.
    ...
    -   For tasks other than customer service cases, incidents, and HR cases, create another scheduled job. For more information, see [Create a scheduled job](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_CreateAScheduledJob.md).
