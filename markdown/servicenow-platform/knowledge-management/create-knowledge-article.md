...
6.  To search for similar articles, enter the text in the **Related Search** field or continue with the default text in the Knowledge results section.
...
7.  To view the entire article in a pop-up window, select the link to the article title.

8.  Select **Submit** to create the article.

9.  Select **Search for Duplicates** for any redundant content in existing articles.

10. Select the link in the **For SEO suggestions on this article, click here** message, if available, to review suggestions for improving your article.
