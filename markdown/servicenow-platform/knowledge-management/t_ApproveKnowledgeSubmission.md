...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/knowledge-management/t\_ApproveKnowledgeSubmission.html
release: xanadu
...
To create a knowledge article from an incident, see [Create a knowledge article from an incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/incident-management/create-knowledge-incident.md).

To create a knowledge article from problem, see [Create a known error article](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-service-management/problem-management/create-known-error-from-problem.md).
