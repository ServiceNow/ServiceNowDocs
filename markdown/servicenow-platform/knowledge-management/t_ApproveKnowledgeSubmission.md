...
To create a knowledge article from an incident, see [Create a knowledge article from an incident](https://www.servicenow.com/docs/access?context=create-knowledge-incident&version=australia&pubname=australia-it-service-management&ft:locale=en-US).

To create a knowledge article from problem, see [Create a known error article](https://www.servicenow.com/docs/access?context=create-known-error-from-problem&version=australia&pubname=australia-it-service-management&ft:locale=en-US).
