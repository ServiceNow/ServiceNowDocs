...
To create a knowledge article from an incident, see [Create a knowledge article from an incident](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-service-management/create-knowledge-incident.md).

To create a knowledge article from problem, see [Create a known error article](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-service-management/create-known-error-from-problem.md).
