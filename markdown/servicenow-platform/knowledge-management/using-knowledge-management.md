...
-   **[Knowledge Management guide for users](product/knowledge-management/reference/get-started-knowledge-end-users.md)**  
After knowledge bases are set up, you can start searching and creating articles.
-   **[Knowledge Management Service Portal homepage features](product/knowledge-management/concept/knowledge-service-portal-pages.md)**  
...
-   **[Using search in Knowledge Management Service Portal](product/knowledge-management/concept/knowledge-service-portal-search.md)**  
...
-   **[Knowledge Management Service Portal article view page features](product/knowledge-management/concept/knowledge-service-portal-view.md)**  
...
-   **[Managing email notifications in Knowledge Management](product/knowledge-management/concept/email-notifications-km.md)**  
Reminders enable relevant users to review knowledge articles and complete tasks associated with them.
-   **[Using the homepage of Knowledge Management v3](product/knowledge-management/concept/c_KnowledgeHomepage.md)**  
...
-   **[Request a knowledge base](product/knowledge-management/task/t_RequestAKnowledgeBase.md)**  
...
-   **[Import a Word document to a knowledge base](product/knowledge-management/task/import-word-platform.md)**  
Import a Word document to create a knowledge article.
-   **[Use knowledge on mobile devices](product/knowledge-management/concept/c_UsingKnowledgeOnMobile.md#)**  
All users can access knowledge from mobile devices to search for and view knowledge articles.
-   **[Using Now Mobile for Knowledge Management](product/knowledge-management/concept/mobile-experience-for-km.md)**  
...
-   **[Manage ownership groups](product/knowledge-management/task/create-edit-ownership-group.md)**  
...
-   **[Work on a feedback task](product/knowledge-management/task/review-reassign-feedback-task.md)**  
You can change the state of a task and resolve or reassign tasks generated by article feedback.
-   **[Track the progress on a feedback task](product/knowledge-management/task/track-feedback-task-metrics.md)**  
...
-   **[Managing KCS article states](product/knowledge-management/concept/managing-kcs-article-states.md)**  
Manage the readiness of KCS articles and comply with regulated information using KCS article states.
-   **[Knowledge article creation from an incident](product/knowledge-management/concept/article-from-incident.md)**  
Enable users to quickly and easily reuse information from an incident in a knowledge article.
-   **[Knowledge content migration from v2 to v3](product/knowledge-management/task/t_KMv3MigrateKnowledgeContent.md)**  
...
-   **[Move a knowledge article](product/knowledge-management/task/t_MoveAnArticle.md)**  
