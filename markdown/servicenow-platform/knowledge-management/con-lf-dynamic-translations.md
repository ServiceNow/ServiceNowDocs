...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/knowledge-management/con-lf-dynamic-translations.html
release: yokohama
...
-   [Activate Localization Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/localization-framework/activate-lf-plugin.md).
-   [Activate a language](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/system-localization/t_ActivateALanguage.md).
-   Bulk Translation is available with the base Yokohama release. If you are upgrading from a previous release, you must configure the following settings:
...
11. Enable the creation of bulk translation localization projects.
    ...
    -   To enable manual creation, select **Enable projects**. For more information, see [Create translation projects](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/localization-framework/projects-localization-framework.md).
...
[Translate knowledge articles using Dynamic Translation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/knowledge-management/dynamic-translation-translate-articles.md)
