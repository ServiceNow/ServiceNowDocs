...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/knowledge-management/sample-ext-cont-integration.html
release: australia
...
[Import content from an external knowledge source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/knowledge-management/run-import-job-external-content-integration.md).

**Related topics**  


[Open knowledge search results in source system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/knowledge-management/open-search-results-ext-content.md)
