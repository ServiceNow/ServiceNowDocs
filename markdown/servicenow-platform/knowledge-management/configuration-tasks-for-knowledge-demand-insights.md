...
-   **[Configure Knowledge Demand Insights](product/knowledge-management/task/configure-demand-insights.md)**  
...
-   **[Configure solution definitions to find gaps in a knowledge base](product/knowledge-management/task/configure-km-solution-defintions.md)**  
...
-   **[Configure the mapping of solution definitions with task tables](product/knowledge-management/task/select-tasks-knowledge-bases.md)**  
...
-   **[Set the frequency of knowledge gap analysis](product/knowledge-management/task/run-gap-analysis-periodically-demand-insights.md)**  
Set the frequency of the scheduled job for your task to automatically run knowledge gap analysis.
-   **[Assign knowledge gap feedback tasks to content authors](product/knowledge-management/task/assign-knowledge-gaps-demand-insights.md)**  
Create assignment rules to assign knowledge gap feedback tasks to authors or groups of content creators.
-   **[Analyze knowledge gaps from a demand insights dashboard and create knowledge gap feedback tasks](product/knowledge-management/task/analyze-knowledge-gaps-demand-insights.md)**  
