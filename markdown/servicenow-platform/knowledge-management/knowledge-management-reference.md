...
-   **[Domain separation and Knowledge Management](product/knowledge-management/concept/domain-separation-knowledge.md)**  
...
-   **[Additional plugins for Knowledge Management](product/knowledge-management/reference/additional-plugins-km.md)**  
...
-   **[Components installed with Knowledge Management Core](product/knowledge-management/task/Installed-with-km-core.md)**  
...
-   **[Components installed with knowledge blocks](product/knowledge-management/reference/components-installed-with-knowledge-blocks.md)**  
Several types of components are installed with activation of the knowledge blocks plugin, including tables.
-   **[Knowledge Management roles](product/knowledge-management/reference/r_KnowledgeRoles.md#)**  
Certain roles are required to use Knowledge Management functionality.
-   **[Knowledge Management properties](product/knowledge-management/reference/r_KnowledgeProperties.md#)**  
...
-   **[Quick start tests for Knowledge Management](administer/atf-quick-start-tests/reference/quick-start-tests-knowledge.md)**  
...
-   **[Understanding access to the Knowledge knowledge base](product/knowledge-management/concept/manage-access_knowledge_kb.md)**  
User criteria are available to manage access to the Knowledge knowledge base.
-   **[Knowledge workflows](product/knowledge-management/reference/r_KnowledgeWorkflows.md)**  
...
-   **[Knowledge Management Service Portal properties](product/knowledge-management/reference/knowledge-service-portal-properties.md)**  
...
-   **[Knowledge Management v3 homepage and Knowledge Management Service Portal comparison](product/knowledge-management/reference/knowledge-service-portal-difference.md)**  
...
-   **[SEO for canonical URLs and localized versions of knowledge articles](product/knowledge-management/concept/seo-knowledge.md)**  
...
-   **[Article versioning changes](product/knowledge-management/concept/article-versioning-changes.md)**  
...
-   **[Feedback on article versions](product/knowledge-management/concept/article-versioning-feedback.md)**  
...
-   **[Knowledge article version numbers](product/knowledge-management/concept/knowledge-article-version-numbers.md)**  
Knowledge article version numbers follow a specific pattern. Increments to the version number depend on the revision type.
-   **[Knowledge article version information](product/knowledge-management/concept/knowledge-article-version-info.md)**  
Users can view version information for a knowledge article from the Knowledge view page.
-   **[Validity of a knowledge article](product/knowledge-management/concept/article-validity.md)**  
...
-   **[Knowledge article states](product/knowledge-management/concept/knowledge-article-states.md)**  
Knowledge article versions can be in one of several states as it progresses through the creation cycle.
-   **[Knowledge subscription email notification templates](product/knowledge-management/reference/subscription-email-templates.md)**  
