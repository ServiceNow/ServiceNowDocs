...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/knowledge-management/insert-toc-html-editor.html
release: xanadu
...
**Note:** Use Format select to set heading levels in the article. You can also configure the HTML toolbar using TinyMCE attributes. For more information, see [Customize TinyMCE attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/tinymce.md). \[Omitted image "km-h1.png"\] Alt text: HTML toolbar

## Procedure

1.  In the Article body section, place the cursor where you want to insert the table of contents.

2.  Click the table of contents icon \(\[Omitted image "toc.png"\] Alt text: Table of Contents icon\) on the HTML toolbar.

    If you do not see the table of contents icon on the toolbar, add it using steps available in [Customize TinyMCE attributes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/tinymce.md).

3.  Update an existing table of contents by selecting it and then clicking the update icon \(\[Omitted image "toc-update.png"\] Alt text: Update icon\) on the HTML toolbar.
