...
2.  Click the table of contents icon \(![Table of Contents icon](../image/toc.png)\) on the HTML toolbar.
    ...
    If you do not see the table of contents icon on the toolbar, add it using steps available in [Customize TinyMCE attributes](https://www.servicenow.com/docs/access?context=tinymce&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
