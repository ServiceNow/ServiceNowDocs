...
<table id="choicetable_ajx_szw_hkb"><tbody><tr><td id="d432761e158">
...
[Finding solutions by using Agent assist](https://www.servicenow.com/docs/access?context=agent-assist&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)
