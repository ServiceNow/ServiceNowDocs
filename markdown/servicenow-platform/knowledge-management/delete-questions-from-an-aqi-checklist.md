...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/knowledge-management/delete-questions-from-an-aqi-checklist.html
release: xanadu
...
-   The checklist is not attached to a knowledge base. For more information, see [Remove an AQI checklist from a knowledge base](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/remove-an-aqi-checklist-from-a-knowledgebase.md).
...
1.  Navigate to **All** &gt; **Knowledge** &gt; **Article Quality Index** &gt; **AQI checklists**.
