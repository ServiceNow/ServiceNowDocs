...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/knowledge-management/delete-questions-from-an-aqi-checklist.html
release: australia
...
-   The checklist is not attached to a knowledge base. For more information, see [Remove an AQI checklist from a knowledge base](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/knowledge-management/remove-an-aqi-checklist-from-a-knowledgebase.md).
