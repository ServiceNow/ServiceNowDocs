...
Includes the default implementation for the canonical URLs and **hreflang** tags for Service Portal pages. This script include is read-only.
 ...
 For more information, see [Enable SEO for canonical URLs and localized versions of a portal page](https://www.servicenow.com/docs/access?context=seo-sp&version=australia&pubname=australia-platform-user-interface&ft:locale=en-US).
