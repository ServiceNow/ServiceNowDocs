...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/knowledge-management/knowledge-external-content-integration.html
release: xanadu
...
-   **[Activate the External Content Integration plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/act-ext-know-content.md)**  
...
-   **[Define an external knowledge source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/define-an-external-knowledge-source.md)**  
...
-   **[Import content from an external knowledge source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/run-import-job-external-content-integration.md)**  
Run an import job manually or set up a schedule to process the integrated external content.
-   **[Open knowledge search results in source system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/open-search-results-ext-content.md)**  
...
-   **[Sample configuration for integrating external knowledge content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/sample-ext-cont-integration.md)**  
