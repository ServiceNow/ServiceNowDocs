...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/knowledge-management/t\_SelectUCArticle.html
release: zurich
...
<table id="choicetable_sqz_z3v_qjb"><thead><tr><th align="left" id="d632375e127">

Access

</th><th align="left" id="d632375e130">

Procedure

</th></tr></thead><tbody><tr><td id="d632375e136">
...
</table>    **Note:** If the **Can Read** and **Cannot Read** fields aren't visible, configure the Knowledge form to display them. For more information, see [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/configure-form-layout.md).
