...
<table id="choicetable_sqz_z3v_qjb"><thead><tr><th align="left" id="d610780e127">

Access

</th><th align="left" id="d610780e130">

Procedure

</th></tr></thead><tbody><tr><td id="d610780e136">
...
</table>    **Note:** If the **Can Read** and **Cannot Read** fields aren't visible, configure the Knowledge form to display them. For more information, see [Configuring the form layout](https://www.servicenow.com/docs/access?context=configure-form-layout&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US).
