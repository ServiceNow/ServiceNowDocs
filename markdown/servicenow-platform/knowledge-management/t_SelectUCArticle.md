...
<table id="choicetable_sqz_z3v_qjb"><thead><tr><th align="left" id="d633358e127">

Access

</th><th align="left" id="d633358e130">

Procedure

</th></tr></thead><tbody><tr><td id="d633358e136">
...
</table>    **Note:** If the **Can Read** and **Cannot Read** fields aren't visible, configure the Knowledge form to display them. For more information, see [Configuring the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-administration/configure-form-layout.md).
