...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/knowledge-management/km-service-portal-widget-instances.html
release: xanadu
...
-   [Knowledge Homepage Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-widget-options.md)

    Customize search features for the homepage.

-   [Knowledge Bases Browse](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-kb-tile-widget-options.md)

    Displays knowledge base tiles in the homepage.

-   [Knowledge Featured Articles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-homepage-widget-options.md)

    Displays a list of featured articles in the homepage.

-   [Knowledge Most Useful Articles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-homepage-widget-options.md)

    Displays a list of most useful articles in the homepage.

-   [Knowledge Most Viewed Articles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-homepage-widget-options.md)
...
-   [Knowledge Breadcrumbs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/service-portal/knowledge-breadcrumbs.md)

    Displays navigation path to the current page and a search box for users to search the knowledge base.

-   [Knowledge Search](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-widget-options.md)
-   Knowledge Facet Header

    Displays the title for the filter facets.

-   [Knowledge Field Facet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-results-filter-facets.md)

    Display search results filtered by knowledge base, knowledge category, and author.

-   [Knowledge Tags Facet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-results-filter-facets.md)

    Display search results filtered by article tags.

-   [Knowledge Resource Facet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-results-filter-facets.md)

    Display search results filtered by article resource.

-   [Knowledge Query Facet](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-results-filter-facets.md)

    Display search results filtered by article rating, number of article views, and last modified.

-   [Knowledge Result Sort](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-results-sort-options.md)
...
-   [Knowledge Result](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-results-list-options.md)
...
-   [Knowledge Article Content](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-user-action-on-article-view.md)

    Customize what information users can view and what actions they can perform in the article view page.

-   [Knowledge Article Helpful](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-knowledge-article-helpful.md)

    Enables users to mark the article as helpful.

-   [Knowledge Article Comments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-knowledge-article-comments.md)
...
-   [Related Catalog Item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/configure-related-items-widget.md)
...
-   [Knowledge Related Articles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/configure-related-articles-widget.md)
...
-   [Most Useful](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-homepage-widget-options.md)

    Displays a list of knowledge articles that users found most useful.


-   **[Activate the Knowledge Management Service Portal plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/activate-km-service-portal-plugin.md)**  
...
-   **[Configure search widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-widget-options.md)**  
...
-   **[Configure knowledge base tile widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-kb-tile-widget-options.md)**  
...
-   **[Configure the home page widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-homepage-widget-options.md)**  
...
-   **[Configure sort widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-results-sort-options.md)**  
...
-   **[Configure article list widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-article-list-widget-options.md)**  
Configure widget instance options for the article lists on the Knowledge Management Service Portal homepage.
-   **[Configure search results list widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-results-list-options.md)**  
...
-   **[Configure filter facet widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-search-results-filter-facets.md)**  
...
-   **[Configure a user action for the article view page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-user-action-on-article-view.md)**  
Configure a user action for the Knowledge Management article view page in the Knowledge Management Service Portal.
-   **[Configure article helpful widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-knowledge-article-helpful.md)**  
...
-   **[Configure article comments instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/config-knowledge-article-comments.md)**  
...
-   **[Configure related catalog item widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/configure-related-items-widget.md)**  
...
-   **[Configure knowledge related articles widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/knowledge-management/configure-related-articles-widget.md)**  
