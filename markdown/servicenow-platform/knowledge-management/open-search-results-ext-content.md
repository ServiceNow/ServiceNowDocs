...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/knowledge-management/open-search-results-ext-content.html
release: yokohama
...
Make sure the **Open search results in the original source system** import parameter for the [external knowledge source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/knowledge-management/define-an-external-knowledge-source.md) is set to **true**.
