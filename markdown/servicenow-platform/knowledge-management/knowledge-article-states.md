...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/knowledge-management/knowledge-article-states.html
release: yokohama
...
One of the following occurs:-   A more recent version of the article is published.
-   An article reaches and moves past its valid to date.

End users can read published articles as well as the outdated versions.

</td></tr></tbody>
</table>**Related topics**  


[Knowledge access controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/knowledge-management/user-access-knowledge.md)
