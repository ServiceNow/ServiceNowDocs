...
Beginning with Madrid, the Import a Word document feature is enabled by default and the Import Articles module is displayed in the application navigator.
...
6.  Click **Import**.
    ...
    ![Import word document(s) to create a knowledge base article](../image/import-word-article.png)
