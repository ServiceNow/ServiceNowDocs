...
-   The [Properties installed with Customer Service Management](https://www.servicenow.com/docs/access?context=r_PropInstallWcustServ&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US) must be enabled
