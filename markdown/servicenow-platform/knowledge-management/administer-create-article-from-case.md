...
-   The [Properties installed with Customer Service Management](https://www.servicenow.com/docs/access?context=r_PropInstallWcustServ&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US) must be enabled
