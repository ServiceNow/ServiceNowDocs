...
-   **[Create a knowledge block](product/knowledge-management/task/create-modify-knowledge-block.md)**  
...
-   **[Add knowledge blocks to a knowledge article](product/knowledge-management/task/add-knowledge-block-to-knowledge-article.md)**  
...
-   **[Preview a knowledge article with knowledge blocks](product/knowledge-management/task/preview-knowledge-article-with-knowledge-blocks.md)**  
...
-   **[Integrating a custom search or knowledge article viewer with knowledge blocks](product/knowledge-management/concept/integrating-with-custom-search-or-knowledge-article-viewer.md)**  
