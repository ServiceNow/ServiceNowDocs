...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/knowledge-management/using-knowlege-blocks.html
release: australia
...
-   **[Preview a knowledge article with knowledge blocks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/knowledge-management/preview-knowledge-article-with-knowledge-blocks.md)**  
Preview knowledge articles by user or date. For unpublished articles, impersonate different users to see how blocks display based on user criteria. For published articles, preview by user and date to see past versions.
