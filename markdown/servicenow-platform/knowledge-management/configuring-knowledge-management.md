...
-   **[Activate the Knowledge Management Advanced plugin](product/knowledge-management/task/activate-knowledge-advanced-plugin.md)**  
...
-   **[Knowledge Management setup guide for admins](product/knowledge-management/reference/setup-knowledge-admin.md)**  
...
-   **[Knowledge base setup guide for knowledge admins and managers](product/knowledge-management/reference/set-up-knowledge-admin-user.md)**  
...
-   **[Activate the sitemap configuration and definition records for the Knowledge Portal](product/knowledge-management/task/config-sitemap-generator.md)**  
Include knowledge articles in your sitemap by activating the sitemap configuration and definition records.
-   **[Activate the knowledge management internationalization plugin](product/knowledge-management/concept/c_ActKMIntPlugin.md)**  
To enable translation of knowledge articles, you must activate multiple plugins.
-   **[Activate knowledge blocks](product/knowledge-management/task/activate-knowledge-blocks.md)**  
...
-   **[Enable knowledge blocks for each knowledge base](product/knowledge-management/task/enable-knowledge-blocks-for-knowledge-base.md)**  
...
-   **[Activate Knowledge Management KCS Capabilities](product/knowledge-management/task/activate-kcs-capabilties-plugin.md)**  
...
-   **[Enable languages for a knowledge base](product/knowledge-management/task/enable-language-for-knowledge-base.md)**  
...
-   **[Configure the Knowledge Management Service Portal](product/knowledge-management/concept/knowledge-management-service-portal.md)**  
...
-   **[Create a knowledge base](product/knowledge-management/task/create-a-knowledgebase.md)**  
...
-   **[Configure knowledge bases for a portal](product/knowledge-management/task/enable-search-on-all-kb.md)**  
...
-   **[Configure knowledge subscriptions](product/knowledge-management/task/configure-subscription-properties.md)**  
...
-   **[Configuration tasks for knowledge managers](product/knowledge-management/concept/c_KnowledgeManager.md)**  
...
-   **[Configure Self-Service Analytics](product/knowledge-management/task/config-ssa.md)**  
Configure the Self-Service Analytics framework so you can use the generated metrics in a dashboard.
-   **[Managing access to knowledge bases and knowledge articles](product/knowledge-management/concept/user-access-knowledge.md)**  
...
-   **[User criteria diagnostics for Knowledge Management](product/knowledge-management/concept/diagnose-knowledge-user-criteria.md)**  
...
-   **[Integration with external knowledge sources](product/knowledge-management/concept/knowledge-external-content-integration.md)**  
...
-   **[Duplicate knowledge article numbers](product/knowledge-management/reference/knowledge-article-duplicate-numbers.md)**  
Importing knowledge articles into an instance can create articles with duplicate numbers.
-   **[Create a custom knowledge homepage](product/knowledge-management/task/t_CreateACustomKnowledgeHomepage.md)**  
...
-   **[View knowledge logs](product/knowledge-management/task/view-knowledge-logs.md)**  
Knowledge logs display information about which users have viewed knowledge articles, what they looked for, and where.
-   **[Use extension points for Knowledge Management](product/knowledge-management/task/extension-points-km-plugins.md)**  
...
-   **[Train the similarity solution for Knowledge Management to find related articles](product/knowledge-management/task/train-similarity-solution-km.md)**  
...
-   **[Enable actionable knowledge feedback](product/knowledge-management/task/configure-act-know-feedback-properties.md)**  
...
-   **[Enable creating an article from a customer service case](product/knowledge-management/concept/administer-create-article-from-case.md)**  
...
**Parent Topic:**[Knowledge Management](product/knowledge-management/concept/knowledge-management.md)
