...
-   **[Define a communication plan](../task/create-comm-plan-definition.md)**  
...
-   **[Define a recipient list for communication contact](../task/define-recipient-list-comm-contact.md)**  
...
-   **[Create a plan type](../task/define-plan-type.md)**  
...
-   **[Create a task type](../task/define-task-type.md)**  
...
-   **[Define contact responsibilities](../task/define-contact-responsibilities.md)**  
...
-   **[View communication channel configuration](../task/view-comm-channel-config.md)**  
...
-   **[Configure Slack for a communication task](../task/configure-slack-for-a-comm-task.md)**  
