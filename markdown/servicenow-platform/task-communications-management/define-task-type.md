...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/task-communications-management/define-task-type.html
release: australia
...
Role required: sn\_comm\_management.comm\_plan\_admin

## Procedure

1.  Navigate to **All** &gt; **Task Communication Management** &gt; **Administration** &gt; **Task Types**, and click **New**.
...
3.  Click **Submit**.
    ...
    A communication task type is created.
...
**Parent Topic:**[Working with Task Communications Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/task-communications-management/working-with-tcm.md)
