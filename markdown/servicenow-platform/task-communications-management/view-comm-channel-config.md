---
title: View communication channel configuration
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/task-communications-management/view-comm-channel-config.html
release: australia
...
1.  Navigate to **All** &gt; **Task Communication Management** &gt; **Administration** &gt; **Channel Configuration**.

2.  Open any communication channel record.
...
3.  On the form, view the fields.
    ...
    |Configuration script|\[Read only\] Lookup icon \(\[Omitted image "look-up-icon.png"\] Alt text: Lookup icon\) to select the script that defines the channel configuration.|
