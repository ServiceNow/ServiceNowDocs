...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/multi-instance-framework-hermes/prepare-kafka-client-environment.html
release: xanadu
...
[Create a test topic in Hermes using the Kafka client](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/multi-instance-framework-hermes/create-hermes-topic.md)
