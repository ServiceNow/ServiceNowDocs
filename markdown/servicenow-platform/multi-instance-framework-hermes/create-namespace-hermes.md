...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/multi-instance-framework-hermes/create-namespace-hermes.html
release: yokohama
...
-   Organize topics yourself by creating one or more topic records and linking them to this namespace. See [Create a topic in Hermes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/multi-instance-framework-hermes/create-topic-instance-hermes.md).
