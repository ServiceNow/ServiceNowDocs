...
-   The Hermes Messaging Service is activated. See [Hermes Messaging Service activation](../concept/hermes-messaging-service-activation.md).
...
For details on assigning KMF roles, see [Roles installed with Key Management Framework](https://www.servicenow.com/docs/access?context=kmf-roles&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US).
...
<table id="choicetable_ebz_1jn_zyb"><thead><tr><th align="left" id="d332547e124">

Option

</th><th align="left" id="d332547e127">

Description

</th></tr></thead><tbody><tr><td id="d332547e133">
...
3.  Set up security for the Hermes Messaging Service.
    ...
    If Restricted Caller Access isn't approved for the IPKI Certificate Generator, a cross scope access error appears. Contact Customer Service and Support for assistance with approving Restricted Caller Access.
...
[Hermes Messaging Service activation](../concept/hermes-messaging-service-activation.md)

[Revoke a Hermes Messaging Service certificate](revoke-certificate.md)
