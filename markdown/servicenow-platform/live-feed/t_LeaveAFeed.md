...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/live-feed/t\_LeaveAFeed.html
release: yokohama
product: Live Feed
...
3.  Click **Leave**.
    ...
    **Note:** If you leave a [feed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/live-feed/c_RecordFeeds.md) associated with a record, such as an incident, you automatically rejoin that feed if you modify the associated record again.
