...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/live-feed/t\_ParticipateInAFeed.html
release: yokohama
product: Live Feed
...
-   [View messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/live-feed/t_ViewAFeed.md) posted to the feed. Non-members can also view the messages for a public feed.
-   [View a list of feed members](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/live-feed/t_ViewAFeedMember.md).
-   Invite another user to join the feed.
-   Subscribe to feed email notifications.
-   [Leave the feed](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/live-feed/t_LeaveAFeed.md).
...
2.  Click either **Group Feeds** or **Record Feeds**, and then click **All Feeds**.
    ...
    \[Omitted image "AllFeeds.png"\] Alt text: All feeds
