...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/live-feed/c\_PostContentInLiveFeed.html
release: xanadu
product: Live Feed
...
Administrators can manage attachment file settings, such as supported file types and maximum attachment file size, by [editing system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/r_AvailableSystemProperties.md).
...
-   **[Post a Live Feed message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/live-feed/t_PostLiveFeedMessages.md)**  
You can post a message to open a new feed.
-   **[Reply to a Live Feed message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/live-feed/t_ReplyToAMessage.md)**  
...
-   **[Attach a file to a post or reply](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/live-feed/t_AttachAFileToAPostOrReply.md)**  
You can attach files to a post by dragging a file into a post or pasting an image from the clipboard.
-   **[Copy an image from the clipboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/live-feed/t_CopyAnImageFromTheClipboard.md)**  
...
-   **[Add a link to a post or reply](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/live-feed/t_AddALinkToAPostOrReply.md)**  
Add or modify a link to a Live Feed post.
-   **[Add a knowledge article link to a post or reply](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/live-feed/t_AddKnowledgeArtLinkPostRep.md)**  
Use the ID of a knowledge article to post it as a reply to a Live Feed conversation.
-   **[Add a poll to a message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/live-feed/t_AddAPollToAMessage.md)**  
...
-   **[Add mentions to a message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/live-feed/add-mentions-to-message.md)**  
An @mention is any posted update that contains @username anywhere in the body of the message.
-   **[Like a message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/live-feed/t_LikeAMessage.md)**  
