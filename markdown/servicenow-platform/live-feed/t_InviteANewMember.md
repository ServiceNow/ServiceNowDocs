...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/live-feed/t\_InviteANewMember.html
release: xanadu
product: Live Feed
...
4.  Click the **Pending members** tab.

5.  In the **Add User** field, enter the name of the user you want to invite.
