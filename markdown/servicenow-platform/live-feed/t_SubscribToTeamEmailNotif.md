...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/live-feed/t\_SubscribToTeamEmailNotif.html
release: yokohama
product: Live Feed
...
3.  Click the subscribe icon \(\[Omitted image "SubscribeIcon.png"\] Alt text: Subscribe icon\).
