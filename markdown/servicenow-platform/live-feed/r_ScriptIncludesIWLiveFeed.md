...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/live-feed/r\_ScriptIncludesIWLiveFeed.html
release: yokohama
product: Live Feed
...
|Name|Description|
|----|-----------|
|LiveMsgUtil|Provides helper functions for working with live\_message records.|
