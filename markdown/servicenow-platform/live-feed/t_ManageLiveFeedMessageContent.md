...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/live-feed/t\_ManageLiveFeedMessageContent.html
release: australia
product: Live Feed
...
1.  Navigate to **Live Feed** &gt; **Feed Administration** &gt; **Messages**.

2.  Open the message to be removed.

3.  In the **State** field, select **deleted**.
...
**Parent Topic:**[Live Feed security and table access](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/live-feed/r_LiveFeedTableAccessRules.md)
