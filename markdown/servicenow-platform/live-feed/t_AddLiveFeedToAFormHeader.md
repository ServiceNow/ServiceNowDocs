...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/live-feed/t\_AddLiveFeedToAFormHeader.html
release: xanadu
product: Live Feed
...
7.  If the **Live feed** check box does not appear on the form, [configure the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/configure-form-layout.md) to add the **Live feed** field.
