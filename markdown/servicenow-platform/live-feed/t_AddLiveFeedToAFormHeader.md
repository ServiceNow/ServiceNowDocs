...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/live-feed/t\_AddLiveFeedToAFormHeader.html
release: yokohama
product: Live Feed
...
7.  If the **Live feed** check box does not appear on the form, [configure the form layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/configure-form-layout.md) to add the **Live feed** field.
...
\[Omitted image "ShowLiveFeed.png"\] Alt text: The Live Feed button appears on the overflow menu of the form header.
