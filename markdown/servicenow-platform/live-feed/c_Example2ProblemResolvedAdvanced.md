...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/live-feed/c\_Example2ProblemResolvedAdvanced.html
release: yokohama
product: Live Feed
...
-   **Before script**:
    ...
    \[Omitted image "LiveNotificationAdvExample.png"\] Alt text: Example problem resolved message
