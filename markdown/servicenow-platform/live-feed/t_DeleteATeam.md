...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/live-feed/t\_DeleteATeam.html
release: yokohama
product: Live Feed
...
4.  Click the edit icon \(\[Omitted image "GearIcon.png"\] Alt text: The edit icon\).
