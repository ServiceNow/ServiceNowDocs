...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/live-feed/c\_Example1WorkaroundPosted.html
release: yokohama
product: Live Feed
...
-   **Before script**:
    ...
    \[Omitted image "TableNotification1.png"\] Alt text: Workaround posted example
