...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/live-feed/c\_Example3OpportunityWonNonTask.html
release: zurich
product: Live Feed
...
Create a [business rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/live-feed/t_SetUpTableNotifNonTaskTables.md) on the Opportunity \[sales\_opportunity\] table that matches the **Live Feed events** business rule on the task table.
