...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/live-feed/c\_Example3OpportunityWonNonTask.html
release: yokohama
product: Live Feed
...
Create a [business rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/live-feed/t_SetUpTableNotifNonTaskTables.md) on the Opportunity \[sales\_opportunity\] table that matches the **Live Feed events** business rule on the task table.
...
-   **Before script**:
    ...
    \[Omitted image "TableNotificationSales.png"\] Alt text: Example opportunity won message


**Parent Topic:**[Live Feed table notification examples](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/live-feed/c_LFTableNotifiExamples.md)

**Related topics**  


[Live Feed table notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/live-feed/c_SetUpLiveFeedTableNotifications.md)
