...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/live-feed/add-mentions-to-message.html
release: yokohama
product: Live Feed
...
1.  While entering a message or reply in a conversation, type `@username` anywhere in the message.
    ...
    \[Omitted image "AutoSuggest.png"\] Alt text: Auto suggest

2.  Click the user you want to add.

    That user's name is inserted into the @mention in the body of the message.

    \[Omitted image "AutoSuggestCompleted.png"\] Alt text: Auto suggest completed
