...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/live-feed/t\_AddLiveFeedToYourHomepage.html
release: australia
product: Live Feed
...
2.  Click the add content icon \(\) in top left corner of the homepage.

3.  Select Live Feed in the left panel.

4.  On the bottom of the window, click **Add here** in the appropriate layout position, then close the window.
...
**Parent Topic:**[Live Feed UI overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/live-feed/r_LiveFeedUIOverview.md)
