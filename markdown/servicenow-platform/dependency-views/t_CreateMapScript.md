...
The following dependency types are available with [Service Mapping](https://www.servicenow.com/docs/access?context=c_ServiceMappingOverview&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US):
...
[Data collection and discovery using Netflow](https://www.servicenow.com/docs/access?context=data-collection-netflow-mapping&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US)
