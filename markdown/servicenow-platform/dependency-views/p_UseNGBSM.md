...
-   **[Save or load a Dependency Views map](../task/t_SaveLoadMapView.md)**  
In the **View Map** module, use the menu icon to save and load Dependency Views maps.
-   **[Delete a saved Dependency Views map view](../task/t_DeleteSavedMapView.md)**  
...
-   **[View collapsed nodes in a Dependency Views map](../task/t_ViewCollapsedNodesInNGBSM.md)**  
Cluster and virtually grouped nodes can be displayed in a collapsed mode to avoid unnecessary clutter in large maps.

**Parent Topic:**[Dependency Views](../concept/c_BusinesssServiceManagementMaps.md)
...
[Domain separation and Dependency Views](../concept/domain-separation-dependency-views.md)

[Dependency Views map](../concept/c_NextGenBSMMaps.md)

[Dependency Views map menus and controls](../reference/r_NGBSMMenus.md)

[Cluster nodes in a Dependency Views map](../concept/c_CollapsedNodesInNGBSM.md)

[Virtual grouping of nodes in a Dependency Views map](../concept/logical-grouping.md)

[Administer Dependency Views](p_AdministerNGBSM.md)
