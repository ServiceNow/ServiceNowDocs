...
Maps provided by Service Mapping are for application services, including comprehensive maps from the perspective of application services. For more information, see [Service Mapping](https://www.servicenow.com/docs/access?context=c_ServiceMappingOverview&version=australia&pubname=australia-it-operations-management&ft:locale=en-US).
