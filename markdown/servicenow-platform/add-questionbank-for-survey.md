...
6.  In the Survey Question form, fill the fields. For information on these fields, see [Create or modify survey questions](t_CreateOrModifySurveyQuestions.md).
