...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/create-modify-templated-snippet.html
release: yokohama
topic_type: task
