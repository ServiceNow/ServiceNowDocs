...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/create-modify-templated-snippet.html
release: xanadu
topic_type: task
