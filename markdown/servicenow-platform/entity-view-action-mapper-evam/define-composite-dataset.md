...
<table id="choicetable_s23_h4l_wnb"><tbody><tr><td id="d319812e180">

**Create and Link**

</td><td>

[You can define a new data source](define-evam-datasource.md) and then link this datasource to your EVAM definition.

</td></tr><tr><td id="d319812e196">
...
<table id="choicetable_lwc_h2h_xnb"><tbody><tr><td id="d319812e236">
