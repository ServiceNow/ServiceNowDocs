...
1.  Navigate to **All** &gt; **Entity View Action Mapper \(EVAM\)** &gt; **View Definition** &gt; **View Templates**, and then click **New**.
...
A JSON template that defines the view for a mapped datasource.For example, the default search template contains the following:
