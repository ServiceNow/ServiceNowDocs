...
-   **CMDB data manager AI agent**
    ...
    The CMDB life cycle manager AI agent helps admins to promote that CMDB life-cycle policies are in place for principal classes or for specified classes. For more information, see [Working with CMDB Data Manager](cmdb-data-management.md).
...
-   **[Use Now Assist to search the CMDB for CIs](../../now-assist-cmdb/task/na-cmdb-awf-search.md)**  
