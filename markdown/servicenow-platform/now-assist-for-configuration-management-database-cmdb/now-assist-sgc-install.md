...
# Install Now Assist for Service Graph Connectors \(SGC\)

Install the Now Assist for Service Graph Connectors \(SGC\) application to enable generative AI capabilities for diagnosing Service Graph Connector issues on your instance.

## Before you begin

The Content Pack for CMDB application is automatically installed with Now Assist for SGC. While diagnosing issues with failed SGC import sets, the application accesses knowledge base articles to help generate recommendations.
