...
CI creator agentic workflow is particularly useful for adding CIs to tables accessed by Operational Technology because persons might add physical CIs while unaware of the need to manage CI data in the CMDB.
