---
title: View CI information with the ServiceNow Otto CI summarization skill
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/now-assist-for-configuration-management-database-cmdb/na-cmdb-agent-ci-summarizer.html
release: australia
...
# View CI information with the ServiceNow Otto CI summarization skill
...
2.  Select **Summarize** in the ServiceNow Otto box.

    \[Omitted image "na-cmdb-summarize-button.png"\] Alt text: Summarize button on the CI form.

    ServiceNow Otto generates and displays summary information for the CI, as in this example.
...
<table id="choicetable_md1_nyf_xyb"><thead><tr><th align="left" id="d394992e163">

Option

</th><th align="left" id="d394992e166">

Procedure

</th></tr></thead><tbody><tr><td id="d394992e172">
...
[Configure the CI summarization skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/now-assist-for-configuration-management-database-cmdb/now-assist-cmdb-config-ci-summary.md)
