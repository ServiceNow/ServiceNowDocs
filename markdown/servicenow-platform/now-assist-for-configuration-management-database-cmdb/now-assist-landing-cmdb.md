...
Use the ServiceNow® Now Assist for Configuration Management Database \(CMDB\) application to view comprehensive summaries for configuration items \(CIs\) directly on CI forms and to accelerate the process of remediating duplicate CIs.
