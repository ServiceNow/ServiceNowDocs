...
1.  While viewing a CI on the Explore CI view, select **Ask Now Assist for help**.
    ...
    The Now Assist panel opens. Enter a question about any field or section on the view. For more information, see [Working in the Now Assist panel](https://www.servicenow.com/docs/access?context=now-assist-panel-overview&version=zurich&pubname=zurich-intelligent-experiences&ft:locale=en-US).
...
<table id="choicetable_md1_nyf_xyb"><thead><tr><th align="left" id="d592370e137">

Option

</th><th align="left" id="d592370e140">

Procedure

</th></tr></thead><tbody><tr><td id="d592370e146">
...
[Manage CI details in CI Form](../../configuration-management/concept/ci-form-cmdb-workspace.md)
