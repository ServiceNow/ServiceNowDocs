...
Before you enable life-cycle sync, navigate to **CSDM** &gt; **Life Cycle Mapping**. Review the pre-populated mappings in the **Life Cycle Mappings** list view:
...
1.  [Activate the CSDM Activation \(com.snc.cmdb.csdm.activation\) plugin](https://www.servicenow.com/docs/access?context=t_ActivateAPlugin&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
