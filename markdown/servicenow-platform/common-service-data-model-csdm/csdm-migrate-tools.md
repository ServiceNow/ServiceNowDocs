...
-   **The life-cycle sync process presents the discrepancy report**
    ...
    When you start the sync process, the discrepancy report [Enabling life-cycle sync from legacy-to-asset](../../configuration-management/concept/csdm-life-cycle-standard-values.md#) helps you to isolate and remediate mapping issues or missing data issues before proceeding with migration and syncing. The report identifies issues and presents links that take you to the mappings that must be resolved before you can sync the data.
