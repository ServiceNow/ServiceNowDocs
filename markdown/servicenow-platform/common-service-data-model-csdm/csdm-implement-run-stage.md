...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/common-service-data-model-csdm/csdm-implement-run-stage.html
release: yokohama
...
\[Omitted image "run-stage.png"\] Alt text: Tables that you work on during the Run stage.
