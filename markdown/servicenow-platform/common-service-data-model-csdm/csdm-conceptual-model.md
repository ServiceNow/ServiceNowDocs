...
-   **Service Instances — Service Instance \(called application service before CSDM v5\) \[cmdb\_ci\_service\_auto\] table**
    ...
    You can monitor service instances \(called application service before CSDM v5\) on the Application Services dashboard. For more information, see [Use Application Services dashboard to monitor health](../../configuration-management/task/app-service-dashboard.md).
