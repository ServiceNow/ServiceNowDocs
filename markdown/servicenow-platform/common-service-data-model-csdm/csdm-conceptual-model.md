...
-   **Technology management service \[cmdb\_ci\_service\_technical\] table \(formerly Technical service\)**
    ...
    For more information, see [Manage Portfolio domain in the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/common-service-data-model-csdm/manage-business-services-domain.md).
...
-   **Service Instances — Service Instance \(called application service before CSDM v5\) \[cmdb\_ci\_service\_auto\] table**
    ...
    For more information about leaf nodes and structured hierarchies, see [Design &amp; Planning domain in the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/common-service-data-model-csdm/design-domain.md).
...
-   **Business services \(cmdb\_ci\_service\_business\)**
    ...
    For more information, see [Service Consumption domain in the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/common-service-data-model-csdm/sell-consume-domain.md).
...
-   **[Foundation domain in the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/common-service-data-model-csdm/foundation-domain.md)**  
...
-   **[Ideation &amp; Strategy domain in the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/common-service-data-model-csdm/ideation-strategy-domain.md)**  
...
-   **[Design &amp; Planning domain in the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/common-service-data-model-csdm/design-domain.md)**  
...
-   **[Build &amp; Integration domain in the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/common-service-data-model-csdm/build-domain.md)**  
...
-   **[Service Consumption domain in the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/common-service-data-model-csdm/sell-consume-domain.md)**  
...
-   **[Manage Portfolio domain in the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/common-service-data-model-csdm/manage-business-services-domain.md)**  
...
**Parent Topic:**[Exploring the CSDM model](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/common-service-data-model-csdm/csdm-content-frame-exploring.md)
