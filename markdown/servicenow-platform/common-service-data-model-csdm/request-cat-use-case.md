...
![CSDM tables managed by Request Catalog.](../image/csdm-tables-managed-by-req-cat-4.png "CSDM tables managed by the Service Catalog")
...
3.  Application Service table \[cmdb\_ci\_discovered\_service\]
...
![CSDM tables used by Request Catalog.](../image/csdm-tables-used-by-req-catalog-4.png "CSDM tables used by the Service Catalog")
...
**Parent Topic:**[Service Catalog product view](../concept/request-cat-use-case-product-view.md)
