...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/common-service-data-model-csdm/build-domain.html
release: xanadu
...
-   Application: An application service is a deployed instance of the SDLC application component. Examples include micro services and APIs. The build team typically builds application services on behalf of the Service Owner \(as described in [Manage Portfolio domain of the CSDM framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/common-service-data-model-csdm/manage-business-services-domain.md)\).
