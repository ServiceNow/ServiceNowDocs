...
Many assets are CIs and many CIs are assets, but that is not always the case. Assets have a life cycle with financial considerations, for example, Microsoft 365.
...
Service instance \(called application service before CSDM v5\)
