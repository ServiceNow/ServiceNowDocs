...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/common-service-data-model-csdm/csdm-auto-create-prod-model-for-ci.html
release: xanadu
...
breadcrumb: [Data Foundations dashboard, Navigate, CSDM, Configuration Management, Extend ServiceNow AI Platform capabilities]
---
...
1.  Specify the default name to use if the name / version values of a CI are insufficient to auto-generate the name for the new product model.
    ...
    2.  Navigate to each of the supported classes in turn \(Application Service, Business Service, and so on\).
...
**Parent Topic:**[CSDM Data Foundations dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/configuration-management-database-cmdb/csdm-data-foundations-dashboard.md)
