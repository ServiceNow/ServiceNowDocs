...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/common-service-data-model-csdm/csdm-datafdn-dash-walk-tab.html
release: yokohama
...
In this example, a report on the **Walk** tab indicates that there are technical service offerings that are not associated with a support group. This indicates a risk that downtimes will take longer to remedy.
