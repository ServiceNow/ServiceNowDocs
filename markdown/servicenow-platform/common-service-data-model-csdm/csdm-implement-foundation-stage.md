...
-   **Life cycle tables**
    ...
    ![Allowed life-cycle values during the Operational stage of a tangible/physical CI's life cycle](../image/csdm-op-stage-of-hw-ci.png)
    ...
    **Note:** The \[life\_cycle\_control\] table uses the type of CI \(tangible/physical, document and contract, location and so on\) to determine which *life cycle stage status* values are available for each *life cycle stage*.
    ...
    To take full advantage of the CSDM life-cycle standards, you can map legacy status data to the life-cycle value pairs. See [Enabling life-cycle sync from legacy-to-asset](../../configuration-management/concept/csdm-life-cycle-standard-values.md#).
