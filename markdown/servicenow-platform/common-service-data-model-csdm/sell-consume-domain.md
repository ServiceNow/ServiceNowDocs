...
Business consumers can use the request catalog to order business services, business service offerings, and service commitment levels. Business services are mapped to the \[cmdb\_ci\_service\_business\] table and are classified as “business services.” Catalogs are described in detail in [Service Catalog](../../service-catalog-management/concept/service-catalog.md).
