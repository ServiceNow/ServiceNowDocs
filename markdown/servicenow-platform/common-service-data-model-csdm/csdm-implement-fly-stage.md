...
-   **Information object \[cmdb\_ci\_information\_object\] table**
    ...
    **Important:** You might need to implement the Information object \[cmdb\_ci\_information\_object\] table as part of an earlier stage. Your business requirements determine the right stage for implementing the table.
