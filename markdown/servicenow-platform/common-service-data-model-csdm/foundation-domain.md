...
-   A contract is not a CI. Contracts use contract model types from the [Product Models](https://www.servicenow.com/docs/access?context=c_CreateAProductModel&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US) module. Contracts are stored in the \[ast\_contract\] table.
-   Use the Contract Management application to manage and track contracts. See [Contract Management application](https://www.servicenow.com/docs/access?context=c_ContractManagement&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
-   In the Service Level Management application, contracts group together SLAs that relate to a single vendor or customer, as well as the CIs, locations, groups, users, and child contracts that are related to the contract. For more information, see [Define a service contract](https://www.servicenow.com/docs/access?context=define-a-service-contract&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
...
For additional information, see [CMDB groups](../../../Chunk1817035602.md#).
