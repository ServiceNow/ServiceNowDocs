---
title: Migrate existing data to the CSDM framework
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/common-service-data-model-csdm/migrate.html
release: xanadu
...
-   You can continue to use customized or non-conforming CMDB tables. If you do so, however, you might not get the full benefit of your ServiceNow products.
-   Be sure to use the migration tools that are described in [CSDM migration tools](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/common-service-data-model-csdm/csdm-migrate-tools.md).
...
-   **[CSDM migration tools](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/common-service-data-model-csdm/csdm-migrate-tools.md)**  
