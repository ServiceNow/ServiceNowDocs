...
-   Be sure to use the migration tools that are described in [CSDM migration tools](../concept/csdm-migrate-tools.md).
...
-   **[CSDM migration tools](../concept/csdm-migrate-tools.md)**  
