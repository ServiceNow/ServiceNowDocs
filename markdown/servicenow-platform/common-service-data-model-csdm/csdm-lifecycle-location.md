---
title: Life cycle of location entities
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/common-service-data-model-csdm/csdm-lifecycle-location.html
release: australia
...
For definitions of the values, see [Definitions of life-cycle values for location entities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/common-service-data-model-csdm/csdm-lifecycle-df-location.md).
...
-   **[Definitions of life-cycle values for location entities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/common-service-data-model-csdm/csdm-lifecycle-df-location.md)**  
The values for the location life-cycle process reflect the locations used by your organization and are visible only in the common data locations table.
