...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/provider-configuration-ccc.html
release: yokohama
topic_type: concept
