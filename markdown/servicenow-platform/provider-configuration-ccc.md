...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/provider-configuration-ccc.html
release: xanadu
topic_type: concept
