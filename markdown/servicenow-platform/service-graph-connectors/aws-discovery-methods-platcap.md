...
-   You must provide ITOM Visibility with access permissions. For more information, see [Set up AWS service accounts](https://www.servicenow.com/docs/access?context=setup-aws-service-accounts&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US)
