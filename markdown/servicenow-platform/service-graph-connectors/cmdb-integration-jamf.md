...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-graph-connectors/cmdb-integration-jamf.html
release: yokohama
...
For more information on where data is saved when pulling data from a Jamf application, see [CMDB classes targeted in Service Graph Connector for Jamf](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-graph-connectors/cmdb-jamf-classes.md).
