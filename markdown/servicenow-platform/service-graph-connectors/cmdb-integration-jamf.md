...
For more information on where data is saved when pulling data from a Jamf application, see [CMDB classes targeted in Service Graph Connector for Jamf](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/service-graph-connectors/cmdb-jamf-classes.md).
