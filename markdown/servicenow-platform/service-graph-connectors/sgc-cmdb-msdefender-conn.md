...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-graph-connectors/sgc-cmdb-msdefender-conn.html
release: yokohama
...
With the CCF, you can access all the connections used by the Service Graph Connector for Microsoft Defender Endpoint. The connection details include the connection alias, data sources, and scheduled data imports associated with a connection. You can also test the connection.
