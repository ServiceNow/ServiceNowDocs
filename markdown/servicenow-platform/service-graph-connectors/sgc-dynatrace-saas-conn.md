...
# Accessing the connection details of the Service Graph Connector for Observability - Dynatrace SaaS

You can access the connection details of the Service Graph Connector for Observability - Dynatrace SaaS in a single view using the common connection framework \(CCF\) included within the Integration Commons for CMDB \(sn\_cmdb\_int\_util\) store app.
...
Access the details of a Dynatrace SaaS connection configured for the Service Graph Connector for Observability - Dynatrace SaaS.
