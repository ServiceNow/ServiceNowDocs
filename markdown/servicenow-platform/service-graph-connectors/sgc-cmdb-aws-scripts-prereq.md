...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-graph-connectors/sgc-cmdb-aws-scripts-prereq.html
release: xanadu
...
**Important:** Ensure that you have downloaded the scripts available within the Service Graph Connector for AWS. See [Download the AWS scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-graph-connectors/sgc-cmdb-aws-scripts-dwld.md).

Decide the following details to be used later during the execution of the AWS scripts:

-   [ServiceNow IAM role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-graph-connectors/sgc-cmdb-aws-scripts-prereq.md)
-   [ServiceNow IAM username](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-graph-connectors/sgc-cmdb-aws-scripts-prereq.md)
-   [S3 bucket for the ServiceNow IAM role](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-graph-connectors/sgc-cmdb-aws-scripts-prereq.md)

    **Note:** Define an S3 bucket only when you are using [deep discovery scripts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-graph-connectors/sgc-cmdb-aws-script-op.md).
