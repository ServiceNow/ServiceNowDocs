...
Install Service Graph Connector for Trellix version 1.0.0 from the ServiceNow Store. For ServiceNow Store installation steps, see Install a ServiceNow Store application.
