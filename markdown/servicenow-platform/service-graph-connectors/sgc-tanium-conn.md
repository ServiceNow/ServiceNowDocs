---
title: Accessing the connection details of Service Graph Connector for Tanium
description: You can access the connection details of the Service Graph Connector for Tanium in a single view using the common connection framework \(CCF\) included within the Integration Commons for CMDB \(sn\_cmdb\_int\_util\) store app.Access the details of a Tanium connection configured for the Service Graph Connector for Tanium.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-graph-connectors/sgc-tanium-conn.html
release: xanadu
...
You can access the connection details of the Service Graph Connector for Tanium in a single view using the common connection framework \(CCF\) included within the Integration Commons for CMDB \(sn\_cmdb\_int\_util\) store app.
...
Access the details of a Tanium connection configured for the Service Graph Connector for Tanium.
