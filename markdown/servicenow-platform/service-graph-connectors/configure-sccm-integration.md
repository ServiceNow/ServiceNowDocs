...
**Note:** If you’re currently using a version of the Microsoft SCCM plugin, see [Upgrade from the legacy SCCM plugin to the Service Graph Connector for Microsoft SCCM](update-2016-plugin-sccm.md).
