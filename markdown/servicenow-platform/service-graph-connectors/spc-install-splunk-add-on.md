...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-graph-connectors/spc-install-splunk-add-on.html
release: xanadu
...
9.  Adjust workloads to specify resources for search, indexing, and other workloads.
    ...
    See [Service Graph Connector for Splunk add-on](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-graph-connectors/sgc-splunk-add-on.md) for more information about target workloads and supported deployments.
