...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/service-graph-connectors/sgc-sccm-airgap-high-secure.html
release: zurich
...
6.  Copy the `GetSCCMData.ps1` and `SgSCCMHighSecureSetup.ps1` PowerShell scripts that you downloaded in step [3.c](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-graph-connectors/sgc-sccm-airgap-high-secure.md) to the Microsoft SCCM directory.
...
7.  Start a PowerShell session, and run the `SgSCCMHighSecureSetup.ps1` script to generate the JSON configuration file that is used by the `GetSCCMData.ps1` script.
    ...
    1.  At the prompt, enter the path for the Microsoft SCCM data directory that you created in step [5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-graph-connectors/sgc-sccm-airgap-high-secure.md).
...
8.  Provide write and delete permissions for the Microsoft SCCM data directory and the child directories \(created in step [5](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-graph-connectors/sgc-sccm-airgap-high-secure.md)\) to the account that will run the `GetSCCMData.ps1` script.
...
[Configure air gap solution for Microsoft SCCM in a low-secure server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-graph-connectors/sgc-sccm-airgap-low-secure.md)
