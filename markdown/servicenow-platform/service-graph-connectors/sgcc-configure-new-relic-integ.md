...
-   Install Service Graph Connector for Observability - New Relic version 1.3.0 or later from the ServiceNow Store. For ServiceNow Store installation steps, see Install a ServiceNow Store application.
