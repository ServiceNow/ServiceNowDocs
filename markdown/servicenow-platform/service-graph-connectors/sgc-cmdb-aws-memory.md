...
To access the script include, navigate to **All** &gt; **System Definitions** &gt; **Script Includes**, and then search for and select `SgAwsApplicationProperties`. For more information, see Script includes.
