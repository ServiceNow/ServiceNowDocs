...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-graph-connectors/sgc-config-new-relic-integration.html
release: yokohama
...
Select the connection alias that you created in step [4](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-graph-connectors/sgc-config-new-relic-integration.md).
...
6.  Configure the scheduled jobs to import data from the New Relic application.
    ...
    7.  Repeat steps [6.c](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-graph-connectors/sgc-config-new-relic-integration.md) to [6.f](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-graph-connectors/sgc-config-new-relic-integration.md) for each scheduled job for data import.
