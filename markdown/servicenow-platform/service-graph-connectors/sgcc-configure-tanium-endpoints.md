...
Authentication token for the Tanium API that grants access to the Tanium data \(see [Create an API token](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-graph-connectors/sgc-tanium-endpoints-create-api-token.md)\).
...
7.  Configure the import schedule.
    ...
    3.  If you configured additional sensors in step [6](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown), run the scheduled data import to view the sensor details in the import set table and complete the RTE mapping.
...
You can manage connections from the SGC Central view of the CMDB Workspace. For more information, see [Managing connections added for Service Graph Connectors in SGC Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/sgcc-managing-connection.md).
