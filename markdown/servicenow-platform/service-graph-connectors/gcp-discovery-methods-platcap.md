...
-   You must provide ITOM Visibility with access permissions. For more information, see [Set up Google Cloud Platform service accounts](https://www.servicenow.com/docs/access?context=set-up-gcp-service-accounts&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US)
