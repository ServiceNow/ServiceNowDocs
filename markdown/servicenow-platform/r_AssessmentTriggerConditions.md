...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/r\_AssessmentTriggerConditions.html
release: yokohama
...
For a description of the field values in Trigger Condition form, see [Trigger Condition form for assessments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/trigger-condition-form-for-assessment.md).
...
**Note:** This field is not available if the selected **Assessment** is a metric type used for surveys. See [Survey trigger conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_TriggerConditions.md).
