...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/view-survey-overview.html
release: yokohama
topic_type: task
...
Role required: survey\_admin, survey\_reader, or admin

## About this task

The dashboard displays your survey reports arranged in widgets. You can add new widgets to the dashboard.

## Procedure

1.  Navigate to **All** &gt; **Survey** &gt; **Overview**.

2.  Click the elements within the reports to view more information.

    For more information about working with dashboards, see [Dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/now-intelligence/dashboards-landing-page.md).
