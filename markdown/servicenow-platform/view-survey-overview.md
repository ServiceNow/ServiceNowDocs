...
2.  Click the elements within the reports to view more information.
    ...
    For more information about working with dashboards, see [Dashboards](https://www.servicenow.com/docs/access?context=dashboards-landing-page&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US).
