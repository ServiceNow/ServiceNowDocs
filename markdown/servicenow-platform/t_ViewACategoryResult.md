...
2.  Click the reference icon \(![Reference icon](../images/ReferenceIcon.png)\) next to an assessment group number to open the category result record.

    ![](../images/Rating_AssessmentCategoryResults.png)
