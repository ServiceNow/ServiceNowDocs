...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/sgcc-viewing-installed-connection.html
release: yokohama
topic_type: concept
...
-   Installed connection \(see [View an installed connection in SGC Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/sgcc-viewing-installed-connection.md).\)
-   Draft connection \(see [View a draft connection in SGC Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/sgcc-viewing-installed-connection.md).\)
