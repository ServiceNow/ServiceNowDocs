...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/sgcc-viewing-installed-connection.html
release: xanadu
topic_type: concept
...
-   Installed connection \(see [View an installed connection in SGC Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/sgcc-viewing-installed-connection.md).\)
-   Draft connection \(see [View a draft connection in SGC Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/sgcc-viewing-installed-connection.md).\)
