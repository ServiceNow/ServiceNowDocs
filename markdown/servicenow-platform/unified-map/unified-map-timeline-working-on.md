...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/unified-map/unified-map-timeline-working-on.html
release: xanadu
product: Unified Map
...
Point to the badge for the related item.
