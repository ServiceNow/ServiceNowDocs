...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/unified-map/unified-map-timeline-working-on.html
release: yokohama
product: Unified Map
