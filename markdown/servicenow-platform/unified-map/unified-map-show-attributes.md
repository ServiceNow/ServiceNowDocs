...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/unified-map/unified-map-show-attributes.html
release: xanadu
product: Unified Map
