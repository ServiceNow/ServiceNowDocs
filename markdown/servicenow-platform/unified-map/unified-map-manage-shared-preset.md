...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/unified-map/unified-map-manage-shared-preset.html
release: yokohama
product: Unified Map
...
-   An individual user can apply a shared preset and then save it as a user preset. For more information, see [Create or manage a user preset](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/unified-map/unified-map-manage-preset-filter.md).
