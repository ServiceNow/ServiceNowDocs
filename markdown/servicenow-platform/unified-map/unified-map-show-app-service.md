...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/unified-map/unified-map-show-app-service.html
release: yokohama
product: Unified Map
...
Service Mapping must be installed. For more information, see [Service Mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-operations-management/c_ServiceMappingOverview.md).
...
The information that appears on a service instance card is described in [Service Mapping data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/unified-map/um-data-from-service-mapping.md).
...
[Service Mapping data that appears on maps](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/unified-map/um-data-from-service-mapping.md)
