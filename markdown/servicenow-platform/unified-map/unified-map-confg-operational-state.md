...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/unified-map/unified-map-confg-operational-state.html
release: australia
product: Unified Map
