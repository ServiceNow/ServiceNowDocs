...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/unified-map/unified-map-cfg-max-nodes-on-maps.html
release: yokohama
product: Unified Map
...
The name of the property that you are updating: unifiedmap.map\_search.max\_nodes.
