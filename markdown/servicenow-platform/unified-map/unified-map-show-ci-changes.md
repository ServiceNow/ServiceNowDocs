...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/unified-map/unified-map-show-ci-changes.html
release: zurich
product: Unified Map
...
1.  While working in a map, select a CI on the map and then select the Changes icon \[Omitted image "icon-um-overview-panel.png"\].
    ...
    \[Omitted image "um-changes-panel.png"\] Alt text: Changes for the CI are indicated by strikeout text.
