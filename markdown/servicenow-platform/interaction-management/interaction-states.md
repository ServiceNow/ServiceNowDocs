...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/interaction-management/interaction-states.html
release: xanadu
...
-   Lists: Configure the interaction list view. You can also extend the interaction table. For more information about configuring lists, see [List configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/list-administration/c_ListConfiguration.md).
-   Forms: Configure the form view to tailor interactions for each application. For more information about configuring forms, see [Form configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/basic-form-administration.md).
...
This state indicates that the agent has completed a conversation with a customer and is wrapping up the interaction.
 ...
 For more information, see [Interaction wrap up](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/interaction-management/interaction-wrap-up-state.md).
...
</table>**Parent Topic:**[Configuring Interaction Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/interaction-management/configuring-interaction-management.md)
