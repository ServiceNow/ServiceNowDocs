...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/interaction-management/interaction-wrap-up-scheduled-job.html
release: australia
...
-   Automatically by the system, if the **Enforce wrap up duration** setting is enabled in the [interaction wrap up configuration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/interaction-management/create-interaction-wrap-up-config.md).
