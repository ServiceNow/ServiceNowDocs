...
-   Manage presence states within the ServiceNow instance. For information about the presence states of an agent, see [Agent Inbox controls](https://www.servicenow.com/docs/access?context=agent-experience&version=australia&pubname=australia-conversational-interfaces&ft:locale=en-US).
