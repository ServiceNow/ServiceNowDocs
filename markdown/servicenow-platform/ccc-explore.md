...
-   Manage presence states within the ServiceNow instance. For information about the presence states of an agent, see [Agent Inbox controls](../../../administer/advanced-work-assignment/concept/agent-experience.md).
-   Access and use your softphone directly from within the ServiceNow interface using the OpenFrame integration. For information about OpenFrame, see [OpenFrame overview](https://www.servicenow.com/docs/access?context=c_OpenFrameOverview&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
