...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/connect/add-users-to-support-chat.html
release: xanadu
product: Connect
...
<table id="choicetable_qdq_dmf_ct"><tbody><tr><td id="d465069e93">
