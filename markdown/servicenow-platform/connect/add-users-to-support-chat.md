...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/connect/add-users-to-support-chat.html
release: zurich
product: Connect
...
<table id="choicetable_qdq_dmf_ct"><tbody><tr><td id="d478561e90">
