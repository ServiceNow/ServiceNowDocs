...
<table id="choicetable_rtc_4wl_wt"><tbody><tr><td id="d87569e124">
...
5.  Initiate a Zoom meeting to help resolve customer issues faster.
    ...
    For more information, see [Initiate Zoom meetings from chats](https://www.servicenow.com/docs/access?context=initiate-chat-zoom&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
