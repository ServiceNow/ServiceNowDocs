---
title: Monitor incoming Connect Support conversations
...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/connect/t\_MonitorIncomingConnectSupport.html
release: zurich
product: Connect
...
**Note:** The support tab is visible only if you are an agent for one or more queues.
...
<table id="choicetable_rtc_4wl_wt"><tbody><tr><td id="d99278e124">
...
</table>4.  Respond to the user and help resolve the issue.
...
5.  Initiate a Zoom meeting to help resolve customer issues faster.
    ...
    For more information, see [Initiate Zoom meetings from chats](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/initiate-chat-zoom.md).
