...
<table id="choicetable_rtc_4wl_wt"><tbody><tr><td id="d92826e124">
...
5.  Initiate a Zoom meeting to help resolve customer issues faster.
    ...
    For more information, see [Initiate Zoom meetings from chats](https://www.servicenow.com/docs/access?context=initiate-chat-zoom&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
