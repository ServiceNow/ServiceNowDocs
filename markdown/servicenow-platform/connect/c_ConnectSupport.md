...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/connect/c\_ConnectSupport.html
release: xanadu
product: Connect
...
Connect Support builds on the messaging platform provided with Connect. For general information about the Connect interface, setup, and administration, see [Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/connect/c_Connect.md). When Connect Support is enabled, users designated as support agents can access the support tab of the Connect sidebar.
...
-   Users can share links, files, and records using drag-and-drop.

Core UI is required to use Connect Support.

**Note:** Connect Support does not replace legacy chat but offers some of the same functionality. Do not use the features concurrently.
