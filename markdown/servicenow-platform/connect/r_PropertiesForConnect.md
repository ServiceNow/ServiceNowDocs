...
-   Learn more: [User presence](https://www.servicenow.com/docs/access?context=c_UserPresence&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)
