...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/connect/t\_AdministerConnectActions.html
release: yokohama
product: Connect
...
For information about the response object, see the [ConnectActionResponse](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/api-reference/server-api-reference/c_ConnectActionResponseAPI.md) API reference documentation.**Note:** You can only create a Connect action that is based on a task table.
