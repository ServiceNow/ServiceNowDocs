...
[Upload the audio file](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/t_UploadAnAudioFile.md) you want to use as the notification sound.
