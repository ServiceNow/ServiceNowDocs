...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/connect/c\_ConnectSupportMetrics.html
release: xanadu
product: Connect
...
</table>**Note:** For more information about these plugins, including which other plugins they activate, see [Additional plugins for Connect Support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/connect/t_ActivateConnectSupport.md).

**Related topics**  


[Performance Analytics concepts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/performance-analytics/c_PerformanceAnalytics.md)
