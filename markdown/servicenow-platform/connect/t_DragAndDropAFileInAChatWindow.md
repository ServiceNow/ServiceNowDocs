...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/connect/t\_DragAndDropAFileInAChatWindow.html
release: xanadu
product: Connect
...
1.  Drag an item in a Connect mini window.
    ...
    Connect accepts the same file extensions as the platform. For more information, see [Add and manage attachments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/t_AddingAnAttachment.md).
