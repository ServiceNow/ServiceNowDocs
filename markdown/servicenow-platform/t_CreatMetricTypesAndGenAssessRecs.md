...
[Attestations - Legacy](https://www.servicenow.com/docs/access?context=c_Attestations&version=xanadu&pubname=xanadu-governance-risk-compliance&ft:locale=en-US).
...
Condition builder that defines specific records to assess from the selected table. If you do not specify any conditions, the system creates assessable records for all records on the selected table. Click the refresh icon to update the adjacent record count.![Metric type condition match](../images/MetricTypeConditionMatch.png)
...
![Filter field](../images/FilterMenu.png)

-   On scorecards for this type, the Averages view displays ratings by vendor type.

![Vendor scorecard filter field](../images/VendorScorecardFilterField.png)
