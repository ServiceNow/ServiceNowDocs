...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/now-assist-in-knowledge-management/exploring-now-assist-KM.html
release: yokohama
...
## Now Assist multi-language support

Agents and authors can use Now Assist multi-language support to generate articles in from incidents, cases and other task types that are documented in languages other than English by using a language selector. For more information see [Generate a Knowledge article using multi-language support](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/now-assist-in-knowledge-management/Now-Assist-generate-article-using-multilanguage-support.md).

## Now Assist context menu

Agents and authors can use Now Assist context menu, a content recommendation skill, to elaborate or shorten content within a Knowledge article. For more information see [Edit an article using the Now Assist context menu](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/now-assist-in-knowledge-management/Now-Assist-generate-article-using-context-menu.md).

## Now Assist identify and review duplicate articles

Knowledge managers and admins can review duplicate Knowledge articles using the Now Assist identify and review duplicate articles feature. For more information see [Identify and review duplicate Knowledge articles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/now-assist-in-knowledge-management/Now-Assist-identify-and-review-duplicate-articles.md).
...
[Generate a Knowledge article from the classic environment with Now Assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/now-assist-in-knowledge-management/Now-Assist-generate-article-coreui.md)
