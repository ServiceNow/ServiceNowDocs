...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/now-assist-in-knowledge-management/Now-Assist-generate-article-using-context-menu.html
release: xanadu
...
3.  Select the Now Assist icon \[Omitted image "Now-Assist-icon.png"\] Alt text: Now Assist icon. and select either **Elaborate** or **Shorten** from the context menu.
