...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/now-assist-in-knowledge-management/Now-assist-configure-custom-prompts-for-templates.html
release: yokohama
...
In the form configuration of the article record, admin must check for the availability of **Knowledge Gen AI Message** and **Knowledge Now Assist Modal**. If they aren’t present, admin must add them from the **Available** to the **Selected** list.

Role required: sn\_skill\_builder.admin, sn\_nowassist\_admin.nsa\_admin

## About this task

To create custom prompts for OOB and custom knowledge article templates, clone the existing KB generation skill, from the Now Assist skill Kit \(NASK\). For more information, see [Now Assist Skill Kit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/now-assist-skill-kit/now-assist-skill-kit-landing.md) Configuration of the skill happens in three steps:
...
5.  In the **Clone skill** window, fill the required fields and select **Clone**.
    ...
    \[Omitted image "Clone\_skill.png"\] Alt text: Enter the name of the skill and provider details.

6.  On the success message window, select **Open Cloned Skill**.

    \[Omitted image "Cloned\_success.png"\] Alt text: Select Open cloned skill

7.  On the cloned skill page, navigate to the **Prompts** menu and select the **Add** icon.

    \[Omitted image "Add\_prompt.png"\] Alt text: Select Add from Prompts menu
...
9.  To develop a prompt, see [Guidelines for creating prompts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/now-assist-in-knowledge-management/guidelines-for-creating-prompts.md).

10. Save the prompt.

11. Evaluate the prompt.

    For more, see [Evaluate a prompt](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/intelligent-experiences/now-assist-skill-kit/evaluate-prompt.md)

12. Select the **Settings** icon to open the **Configurations** settings panel.\[Omitted image "Config\_settings.png"\] Alt text: Select configuration settings
...
-   **[Guidelines for creating prompts](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/now-assist-in-knowledge-management/guidelines-for-creating-prompts.md)**  
