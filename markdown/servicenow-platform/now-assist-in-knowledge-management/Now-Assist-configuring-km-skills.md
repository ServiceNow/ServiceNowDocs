...
-   For ServiceNow Store installation steps, see [Install a ServiceNow Store application](https://www.servicenow.com/docs/access?context=t_InstallApplications&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
...
-   **[Configure skill for Now Assist context menu](Now-Assist-configuring-context-menu-skill.md)**  
...
[Skill inputs and triggers for Now Assist for Customer Service Management \(CSM\)](https://www.servicenow.com/docs/access?context=now-assist-csm-skill-inputs&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)

[Skill inputs and triggers for Now Assist for IT Service Management \(ITSM\)](https://www.servicenow.com/docs/access?context=now-assist-itsm-skills&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US)

[Skill inputs and triggers for Now Assist for HR Service Delivery \(HRSD\)](https://www.servicenow.com/docs/access?context=now-assist-hrsd-skill-inputs&version=xanadu&pubname=xanadu-employee-service-management&ft:locale=en-US)

[Skill inputs for Now Assist for Field Service Management \(FSM\)](https://www.servicenow.com/docs/access?context=now-assist-fsm-skill-inputs&version=xanadu&pubname=xanadu-field-service-management&ft:locale=en-US)
