...
[Skill inputs and triggers for Now Assist for IT Service Management \(ITSM\)](https://www.servicenow.com/docs/access?context=now-assist-itsm-skills&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US)

[Skill inputs and triggers for Now Assist for HRSD](https://www.servicenow.com/docs/access?context=now-assist-hrsd-skill-inputs&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US)

[Skill inputs for Now Assist for Field Service Management \(FSM\)](https://www.servicenow.com/docs/access?context=now-assist-fsm-skill-inputs&version=zurich&pubname=zurich-field-service-management&ft:locale=en-US)
