...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/email-notification-for-surveys.html
release: zurich
topic_type: concept
...
Triggered surveys are sent when a defined trigger condition is met. The OOB event is fired and placed in the event queue. This event automatically invokes the base system **Survey Invitation** notification, which sends an email to the assigned user. You don't need to create event, as the survey invitation notification is preconfigured for this purpose.
