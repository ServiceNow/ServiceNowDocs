...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/install-ccc-apps.html
release: zurich
topic_type: task
...
For information about the components installed with this application, see [Components installed with ServiceNow Voice Core](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/instld-with-cloud-call-center.md).
...
For information about the components installed with this application, see [Components installed with Amazon Connect Integration with ServiceNow Voice](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/instld-with-amazn-cnct-integ.md).
