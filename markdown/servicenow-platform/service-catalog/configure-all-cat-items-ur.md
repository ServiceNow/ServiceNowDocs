...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/configure-all-cat-items-ur.html
release: xanadu
...
For information about service configurations, see [Service Configuration form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/employee-service-management/universal-request-for-hr-service-delivery/ur-service-config-form.md).
...
**Parent Topic:**[Service Catalog configuration for Universal Request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/ur-catalog-config.md)
