...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/config-auto-populate-value-for-question-cat-builder.html
release: xanadu
...
breadcrumb: [Create a question for a catalog item in Catalog Builder, Creating or editing catalog item template, Service Catalog, Manage service capabilities, Extend ServiceNow AI Platform capabilities]
---
...
7.  On the **Auto-populate** tab, do the following:
    ...
    3.  From the list, select **Manager**.
        ...
        **Note:** To search any value, enter what you're looking for, for example, `manager` or dot-walk to get the required value.
        ...
        For more information about dot-walking, see [Dot-walking to data in related tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/configure-user-experiences/c_DotWalking.md).

8.  Select **Insert question**.


**Parent Topic:**[Create a question for a catalog item in Catalog Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/create-question-cat-builder.md)
