...
For information about the SC Order Guide widget, see [SC Order Guide widget](https://www.servicenow.com/docs/access?context=sc-order-guide-widget&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
