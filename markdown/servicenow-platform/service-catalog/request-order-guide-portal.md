...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-catalog/request-order-guide-portal.html
release: yokohama
...
For information about the SC Order Guide widget, see [SC Order Guide widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/sc-order-guide-widget.md).
