...
[SC Shopping Cart widget](https://www.servicenow.com/docs/access?context=sc-shopping-cart&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
