...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/service-catalog/t\_ManageCatalogPortalPages.html
release: australia
...
7.  [Manage sites](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/t_ManageCatalogSites.md) if you are using a CMS system.
...
To define a new catalog item for the catalog, click **New** and [enter the details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/t_DefineACatalogItem.md) for the item.
...
A catalog portal page provides a [homepage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/c_ManagingTheHomepageForACatalog.md) for a specific catalog. You can use portal pages to create different catalog views for different user groups. Each portal page accesses the same catalog content and presents that content in different ways.
