...
You can enable read access to the catalogs by applying the rule **read ACL** on Catalog \(sc\_catalog\) table. See [Access Control Rules](https://www.servicenow.com/docs/access?context=access-control-rules&version=australia&pubname=australia-platform-security&ft:locale=en-US) for more information.
...
The application scope for this catalog. For information on the application scope, see [Application scope](https://www.servicenow.com/docs/access?context=c_ApplicationScope&version=australia&pubname=australia-application-development&ft:locale=en-US) .
...
To add a module in the navigator for the new catalog, see [Create a module](https://www.servicenow.com/docs/access?context=test-steps-app-navigator-category&version=australia&pubname=australia-application-development&section=t_CreateAModule&ft:locale=en-US).
