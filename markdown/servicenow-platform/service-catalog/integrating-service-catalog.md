...
-   **[Service Catalog in Employee Center portal](service-catalog-in-ec.md)**  
Employees can submit requests for service and product offerings using catalog items from the Employee Center portal.
-   **[Service Catalog in Service Portal](catalog-on-portal.md)**  
...
-   **[Service Catalog in mobile](catalog-experience-mobile.md)**  
You can use a mobile and track request and approval flows of Service Catalog.
-   **[Service Catalog configuration for Universal Request](ur-catalog-config.md)**  
