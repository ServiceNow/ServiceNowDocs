...
For information about the SC Catalog Item widget, see [SC Catalog Item widget](https://www.servicenow.com/docs/access?context=sc-catalog-item-widget&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)
...
<table id="choicetable_sly_jsd_5bb"><tbody><tr><td id="d564699e133">

**Add attachments**

</td><td>

To add attachments to the catalog item, click the add attachments icon \(![Icon to add attachment](../image/IconAddAttachmnt.png)\).You can browse and choose the files, drag the files, or copy and paste them in the Add attachments window.

</td></tr><tr><td id="d564699e150">
