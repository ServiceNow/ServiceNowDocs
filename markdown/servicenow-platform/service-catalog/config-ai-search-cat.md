...
-   Service Portal Default Search Application. For information about AI Search in Service Portal, see [AI Search in Service Portal](https://www.servicenow.com/docs/access?context=ai-search&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
-   NowMobile App Search Configurations. For information about AI Search in Now Mobile, see [AI Search in mobile](https://www.servicenow.com/docs/access?context=text-search-advanced-now&version=zurich&pubname=zurich-employee-service-management&ft:locale=en-US).
