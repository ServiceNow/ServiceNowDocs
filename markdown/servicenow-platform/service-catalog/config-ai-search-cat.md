...
-   Service Portal Default Search Application. For information about AI Search in Service Portal, see [AI Search in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-user-interface/ai-search.md).
-   NowMobile App Search Configurations. For information about AI Search in Now Mobile, see [AI Search in mobile](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/employee-service-management/text-search-advanced-now.md).
