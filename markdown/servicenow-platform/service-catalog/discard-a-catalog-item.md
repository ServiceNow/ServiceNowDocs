---
title: Discard a catalog item
description: Discard a catalog item that’s in the Draft state in Catalog Builder.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/discard-a-catalog-item.html
release: xanadu
...
breadcrumb: [Edit a catalog item in Catalog Builder, Creating or editing catalog item template, Service Catalog, Manage service capabilities, Extend ServiceNow AI Platform capabilities]
---
...
3.  Select the catalog item that you want to discard.

    **Note:** You can discard only those catalog items that are in the **Draft** state. After you select any draft item, the **Discard draft** button becomes active.
...
**Parent Topic:**[Edit a catalog item in Catalog Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/edit-cat-item-cat-builder.md)
