...
-   **[Debug actions on catalog item variables](../task/debug-actions-on-catalog-item-variables.md)**  
...
-   **[Debug UI customizations for a Service Catalog page](../task/debug-ui-customization-catalog-page.md)**  
...
-   **[Debug performance diagnostics of a catalog item](../task/debug-perf-diagnostics.md)**  
...
-   **[Debug a Service Catalog variable](../task/debug-a-service-catalog-variable.md)**  
