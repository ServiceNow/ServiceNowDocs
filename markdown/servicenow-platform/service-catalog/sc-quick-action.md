...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/service-catalog/sc-quick-action.html
release: zurich
...
For more information about function types, see [Configure a smart button](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/mobile/sg-studio-config-smart-button.md).
