...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-catalog/c\_ServiceCatalogAccessControls.html
release: yokohama
...
You can [create user criteria records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/t_CreateAUserCriteriaRecord.md) that define conditions for user information and then apply these criteria records to catalog items and categories. In this way you can control access to these items and categories.
...
-   **[Create a user criteria record in Service Catalog](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/t_CreateAUserCriteriaRecord.md)**  
Create a user criteria record to define conditions that are evaluated against user records.
-   **[Apply user criteria to items and categories](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/t_AppUserCritItemsCat.md)**  
...
-   **[Extend user criteria](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/t_ExtendUserCriteria.md)**  
...
-   **[User criteria migration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/c_MigrtSvcCatUserCriteria.md)**  
Service catalog user criteria records provide access control for service catalog items and categories.

**Parent Topic:**[Service Catalog security](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/p_ServiceCatalogSecurity.md)

**Related topics**  


[Debug user criteria of a catalog item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/debug-user-criteria-cat-item.md)
