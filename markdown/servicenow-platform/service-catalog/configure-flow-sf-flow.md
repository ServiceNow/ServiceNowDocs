...
1.  Create a Workflow Studio flow \(With the trigger type as Service Catalog\).
    ...
    For information about creating a flow with Service Catalog trigger type, see [Create a flow with a Service Catalog trigger](https://www.servicenow.com/docs/access?context=create-sc-flow&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
