...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-catalog/configure-flow-sf-flow.html
release: yokohama
...
1.  Create a Workflow Studio flow \(With the trigger type as Service Catalog\).
    ...
    For information about creating a flow with Service Catalog trigger type, see [Create a flow with a Service Catalog trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/build-workflows/workflow-studio/create-sc-flow.md).
