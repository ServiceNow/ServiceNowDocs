...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/configure-flow-sf-flow.html
release: xanadu
...
1.  Create a Workflow Studio flow \(With the trigger type as Service Catalog\).
    ...
    For information about creating a flow with Service Catalog trigger type, see [Create a flow with a Service Catalog trigger](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/create-sc-flow.md).
