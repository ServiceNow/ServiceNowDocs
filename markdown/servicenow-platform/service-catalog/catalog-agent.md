...
For the conditions that determine whether a catalog item is conversational in the LLM topic block, see [Topic blocks to request catalog items through conversational experience](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-catalog/request-topic-blocks-va-llm.md).
