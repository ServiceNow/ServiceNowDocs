...
-   When you set the default value for the **IP Address** variable, or specify its value in the g\_form.getValue\(\) and g\_form.setValue\(\) functions, the delimiter is \(.\).
