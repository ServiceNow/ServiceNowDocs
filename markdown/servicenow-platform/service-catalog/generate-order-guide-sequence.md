...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/generate-order-guide-sequence.html
release: xanadu
...
breadcrumb: [Create an order guide, Order guides, Types of catalog items, Exploring Service Catalog, Service Catalog, Manage service capabilities, Extend ServiceNow AI Platform capabilities]
---
...
**Parent Topic:**[Create an order guide](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/t_CreateAnOrderGuide.md)

**Related topics**  


[Process Automation Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/build-workflows/workflow-studio/process-automation-designer.md)
