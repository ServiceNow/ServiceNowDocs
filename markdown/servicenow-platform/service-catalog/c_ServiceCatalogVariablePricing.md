...
For information on the pricing models, see [Price fields](https://www.servicenow.com/docs/access?context=price-fields&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) .
