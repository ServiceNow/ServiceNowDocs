...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/service-catalog-screens.html
release: xanadu
...
3.  You can add/remove components, columns, buttons, and rename labels.
    ...
    For more information, see [Configure cart layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/t_ConfigureCartLayout.md).
...
3.  You can add/remove components, columns, buttons, and rename title and button labels.
    ...
    See [Configure cart layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/t_ConfigureCartLayout.md).
