...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/r\_UpgradToMultpleServiceCats.html
release: xanadu
...
The following tables are provided with [multiple service catalogs](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/c_MultipleServiceCatalogs.md):
...
**Parent Topic:**[Service catalog setup](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/p_ServiceCatalogs.md)

## Catalog site records

Catalog site records appear in the **Sites** related list on the Catalog form.

The Catalog Site \[sc\_catalog\_site\] table associates catalogs with [CMS web sites](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-user-interface/content-management-system/t_CreateANewSite.md).

Several [service catalog system properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/r_ServiceCatalogProperties.md) are used to specify values for different sites used by different catalogs.
