...
The Catalog Site \[sc\_catalog\_site\] table associates catalogs with [CMS web sites](https://www.servicenow.com/docs/access?context=t_CreateANewSite&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US).
