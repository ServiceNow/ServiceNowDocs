...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/c\_UsingTheServiceCatalog.html
release: xanadu
...
-   **[Service Catalog home page](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/c_ViewNavSvrCat.md)**  
The home page for a service catalog lists the goods and services available to order from that catalog.
-   **[Service Catalog request screens](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/c_RequestingAServiceCatalogItem.md)**  
To place a request from a service catalog, navigate to the catalog home page and select the item to order.
-   **[Clone a request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/t_UsingBulkRequests.md)**  
You can clone a request for up to 10 users on the notification list.
-   **[View catalog item audit history](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/t_ViewingAuditHistory.md)**  
...
-   **[Saving catalog items to a wish list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/catalog-items-wishlist.md)**  
