...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/service-catalog/create-ui-policies-in-catalog-builder.html
release: australia
...
3.  Navigate to the UI Policy tab.

4.  Select **Add new behavior**.

5.  Define dynamic behavior for your catalog item using conditions, actions, or scripts.

    For more information about the fields and their description, see [UI policy form in Catalog Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/ui-policy-form-in-catalog-builder.md).
