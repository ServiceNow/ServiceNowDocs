...
For information about accessing data in a multi-row variable set \(MRVS\) when a dialog box is open, see [g\_service\_catalog - Client](https://www.servicenow.com/docs/access?context=g_service_catalogClientAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
