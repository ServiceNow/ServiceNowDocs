...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/service-catalog/set-up-cat-builder.html
release: australia
...
3.  Create or duplicate catalog item templates.
    ...
    For information on creating a template, see [Creating or editing catalog item template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/create-cat-item-template-cat-builder.md).
...
-   **[Configure a step-based service fulfillment flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/configure-flow-sf-flow.md)**  
Define service fulfillment steps while creating a catalog item in Catalog Builder.
-   **[Create a service fulfillment step type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/create-sf-step-type.md)**  
