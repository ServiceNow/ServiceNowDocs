...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-catalog/map-items-cat-item.html
release: yokohama
...
4.  To specify a related catalog item, perform these steps.
    ...
    **Note:** In Service Portal, use the instance options to configure the number of articles and items shown in the **Related Articles** and **Related Items** section. See [Configure related catalog item widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/knowledge-management/configure-related-items-widget.md) or [Configure knowledge related articles widget instance options](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/knowledge-management/configure-related-articles-widget.md).


**Parent Topic:**[Service Catalog items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/c_IntroductionToCatalogItems.md)

**Related topics**  


[Map related articles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/knowledge-management/map-related-articles.md)
