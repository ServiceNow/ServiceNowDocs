...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/service-catalog/t\_CreateAUserCriteriaRecord.html
release: australia
...
A [script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/t_ContrlAccessByCDGUOrLoc.md) to define any additional criteria, and return **true** or **false**. This field is available only if **Advanced** is selected. **Note:**
