...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/service-catalog/c\_ManagingTheHomepageForACatalog.html
release: zurich
...
-   **[Configure search and navigation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-catalog/c_ConfigSrchNavUseProps.md)**  
You can use service catalog properties to configure search and navigation within the service catalog homepage.
-   **[Configure preview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-catalog/t_ConfigureMoreInformationDisplays.md)**  
...
-   **[Create a renderer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-catalog/t_CreatingOrModifyingRenderers.md)**  
...
-   **[Customize a catalog homepage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-catalog/t_CustomizingTheHomepageForACatalog.md)**  
Customize a catalog homepage to provide end users with access to catalogs from one homepage.
-   **[Customize the multi-catalog homepage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-catalog/t_CustomizeTheMultiCatalogHomepage.md)**  
Customize the multi-catalog homepage to provide end users with access to multiple catalogs from one homepage.
-   **[Show item details in sections or pop-ups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/service-catalog/t_ShowItemDetlsCollapsSect.md)**  
