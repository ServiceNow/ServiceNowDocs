...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/service-catalog/request-fulfillment.html
release: australia
...
-   **[Service catalog workflows](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/c_ServiceCatalogWorkflowDefinition.md)**  
...
-   **[Execution Plans](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/c_ExecutionPlans.md)**  
An execution plan describes how a catalog item is procured, configured, and installed.
-   **[Service Catalog checkout models](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/c_EnableATwoStepCheckout.md)**  
...
-   **[Create a catalog request from another flow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/create-request-from-other-flow.md)**  
...
-   **[Configure a parent mapping for a request](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/configure-mapping-for-request.md)**  
You can configure a mapping that specifies the association between the parent record and the request record.
-   **[State closure in the request fulfillment execution plan](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/state-closure-request.md)**  
...
-   **[View request notifications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/view-request-notification.md)**  
