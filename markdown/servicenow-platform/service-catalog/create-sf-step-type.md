...
<table id="choicetable_lxs_24x_jpb"><thead><tr><th align="left" id="d321757e67">

Option

</th><th align="left" id="d321757e70">

Description

</th></tr></thead><tbody><tr><td id="d321757e76">
...
3.  Create a subflow to perform a sequence of actions by copying the Template: Service Fulfillment Steps subflow and then defining your subflow. For information about subflows, see [Subflows](https://www.servicenow.com/docs/access?context=subflows&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
...
</table>    For information about subflow field types, see [Field types](https://www.servicenow.com/docs/access?context=r_FieldTypes&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
