...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/enable-shopping-cart-wishlist-ec.html
release: xanadu
...
Enable the wish list feature for catalog. For information about enabling the wish list, see [Saving catalog items to a wish list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/catalog-items-wishlist.md).
