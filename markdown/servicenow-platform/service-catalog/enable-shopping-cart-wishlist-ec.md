...
Enable the wish list feature for catalog. For information about enabling the wish list, see [Saving catalog items to a wish list](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/service-catalog/catalog-items-wishlist.md).
