...
**Note:** Variables with several possible choices defined, such as [multiple choice](../reference/r_VariableTypes.md) variables, are considered a single entity in layouts. All choices are displayed as a single, contiguous unit.
...
For additional layout options, you can also add [container variables](../reference/r_VariableTypes.md) to a variable set.
