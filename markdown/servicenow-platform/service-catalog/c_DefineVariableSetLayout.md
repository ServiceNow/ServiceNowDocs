...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/c\_DefineVariableSetLayout.html
release: xanadu
...
**Note:** Variables with several possible choices defined, such as [Multiple choice](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/multiple-choice.md) variables, are considered a single entity in layouts. All choices are displayed as a single, contiguous unit.
...
</table>**Parent Topic:**[Service catalog variable sets](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/c_ServiceCatalogVariableSets.md)
