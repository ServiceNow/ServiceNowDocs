...
**Note:** Variables with several possible choices defined, such as [Multiple choice](../reference/multiple-choice.md) variables, are considered a single entity in layouts. All choices are displayed as a single, contiguous unit.
