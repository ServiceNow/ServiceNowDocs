...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-catalog/define-question-choice-var.html
release: yokohama
...
3.  Enter the question choice details in **Question Choice** form and click **Submit** to save the record.
    ...
    -   **Price** and **Recurring price**: variables can affect the item [price](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/c_ServiceCatalogVariablePricing.md) and recurring price \(if used\).
...
**Parent Topic:**[Create a service catalog variable](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/t_CreateAVariableForACatalogItem.md)
