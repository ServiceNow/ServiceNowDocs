...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/service-catalog/c\_IntroductionToCatalogItems.html
release: xanadu
...
-   **[Specify related items and articles for a catalog item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/map-items-cat-item.md)**  
...
-   **[Add an ordered item link to an item](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/t_AddOrderedItemLinks.md)**  
Use ordered item links to provide a link on the ordered item screen that provides more information about an item.
-   **[Create a Service Catalog client script](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/t_CreateACatalogClientScript.md)**  
You can create client scripts to customize the catalog.
-   **[Translation of Service Catalog items](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/translate-catalog-items.md)**  
You can translate Service Catalog items into multiple languages using the ServiceNow® Localization Framework.
-   **[Monitoring aggregated catalog item data](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/service-catalog/monitor-aggregated-catalog-item-data.md)**  
