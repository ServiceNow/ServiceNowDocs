...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/service-catalog/service-catalog-variable-editor.html
release: australia
...
By default, this editor is applicable for the Incident and Change tables. For other tables, you can [configure this editor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/configure-default-variable-editor.md).
...
-   **Service Catalog variable editors in the core UI**
    ...
    The GlideForm [setVariablesReadOnly\(\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/service-catalog-variable-editor.md) method is supported for ServiceNow AI Platform and Agent Workspace forms to make the variable editor read-only. This method is intended for requested item, target record, and catalog tasks.
...
-   **[Configure the default variable editor for a task-extended table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/service-catalog/configure-default-variable-editor.md)**  
