...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-catalog/request-cat-use-case.html
release: yokohama
...
\[Omitted image "csdm-tables-managed-by-req-cat-4.png"\] Alt text: CSDM tables managed by Request Catalog.
...
\[Omitted image "csdm-tables-managed-by-req-cat-4.png"\] Alt text: CSDM tables used by Request Catalog.
...
**Parent Topic:**[Service Catalog and CSDM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/request-cat-use-case-product-view.md)
