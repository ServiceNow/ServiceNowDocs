...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-catalog/t\_CreatingRecordProducersFromTables.html
release: yokohama
...
5.  To use container variables, select **\|- container start -\|** and **\|- container end -\|**.
    ...
    \[Omitted image "CreateRecordProducersFromTables.png"\] Alt text:
