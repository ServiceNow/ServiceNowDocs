...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/service-catalog/monitor-aggregated-catalog-item-data.html
release: zurich
...
The Catalog item translation coverage graph is displayed only if you have enabled the Localization framework. For more information, see [Localization Framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-administration/localization-framework-landing.md).
...
[Dashboards overview](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/now-intelligence/dashboards-overview.md)
