...
-   **glide\_list**
    ...
    ![Screenshot for the glide_list attribute when collapsed](../image/VarGlideListCollapsed.png "Collapsed glide_list")

    ![Screenshot for the glide_list attribute when expanded](../image/VarGlideListExpanded.png "Expanded glide_list")
...
-   **is\_searchable\_choice**
    ...
    **Note:**
    ...
    ![Screenshot for the is_searchable_choice attribute](../image/VA_SearchableChoice.png "is_searchable_choice")
...
-   **no\_filter**
    ...
    ![Screenshot for the no_filter attribute](../image/VarNoFilter.png "no_filter")
