...
[Create a request from an incident](https://www.servicenow.com/docs/access?context=create-request-from-incident&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US)
