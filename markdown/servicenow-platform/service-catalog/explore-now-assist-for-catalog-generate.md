...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-catalog/explore-now-assist-for-catalog-generate.html
release: yokohama
...
The application uses the Catalog item generation skill to create catalog items.

**Note:** You must be assigned the catalog\_builder\_editor role to create the items using Now Assist.
...
-   Tailored catalog items: Provide specific details, and Now Assist tailors catalog items to your needs. It's customizable, so you can verify every item fits the specifications you need.
...
[Create catalog items using Now Assist](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/service-catalog/create-catalog-item-using-now-assist.md)
