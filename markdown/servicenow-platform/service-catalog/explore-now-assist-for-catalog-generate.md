...
The application uses the Catalog item generation skill to create catalog items. For more information about the skill, see [Catalog item generation](now-assist-catalog-item-generation.md).
