...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/service-catalog/access-categories-portal.html
release: yokohama
...
3.  In the **Catalogs** section, select the required catalog from the list.
    ...
    For information on how you can configure a catalog, see [Configure a catalog in Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/associate-portal-catalog.md).
...
[SC Categories widget](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/sc-categories-widget.md)
