...
3.  In the **Catalogs** section, select the required catalog from the list.
    ...
    For information on how you can configure a catalog, see [Configure a catalog in Service Portal](https://www.servicenow.com/docs/access?context=associate-portal-catalog&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US).
...
[SC Categories widget](https://www.servicenow.com/docs/access?context=sc-categories-widget&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
