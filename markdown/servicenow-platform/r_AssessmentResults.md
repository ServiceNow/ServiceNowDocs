...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/r\_AssessmentResults.html
release: yokohama
...
The system calculates [metric results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_ViewAMetricResult.md) first, normalizes the scores, and then calculates [category results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_ViewAMetricResult.md). Each metric and category result record stores data from one assessment group, for a particular category and source record evaluated. Specifically:
...
-   The user does not answer the question and the [data type](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/r_DataTypes.md) is not Checkbox.
...
**Parent Topic:**[View a metric result](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_ViewAMetricResult.md)
