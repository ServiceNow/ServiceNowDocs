...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/t\_ViewAnAssessmentInstance.html
release: yokohama
topic_type: task
...
Verification provided by the recipient when a signature is required. This value is either the recipient's full name from the User \[sys\_user\] table or **checked**, indicating that the recipient acknowledged reading the assertion by selecting a check box.
    ...
    For more information, see [Take an assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_TakeAnAssessment.md).
...
**Parent Topic:**[Scheduled assessments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_ScheduledAssessments.md)
