...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/t\_ViewAnAssessmentInstance.html
release: zurich
topic_type: task
...
Verification provided by the recipient when a signature is required. This value is either the recipient's full name from the User \[sys\_user\] table or **checked**, indicating that the recipient acknowledged reading the assertion by selecting a check box.
    ...
    For more information, see [Take an assessment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_TakeAnAssessment.md).
