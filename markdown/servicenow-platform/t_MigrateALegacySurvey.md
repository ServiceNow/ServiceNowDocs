...
To avoid timing out for very large surveys, you can disable the transaction quota. See [Transaction quotas](https://www.servicenow.com/docs/access?context=c_TransactionQuotas&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
