...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/ai-platform-capabilities/install-voice-hr.html
release: xanadu
...
-   Ensure that Amazon Connect Integration with ServiceNow Voice \(sn\_cti\_amzn\_cct\) is installed. For more information, see [Install ServiceNow Voice applications](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/ai-platform-capabilities/install-ccc-apps.md).
...
For more information, see [Components installed with ServiceNow Voice for HR Agent Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/ai-platform-capabilities/instld-with-hr-agent.md).
...
Follow these steps to [Integrate ServiceNow Voice with Amazon Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/ai-platform-capabilities/integrate-ccc-amazonconnect.md).
