...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/ai-platform-capabilities/ccc-csm-config-pin.html
release: xanadu
