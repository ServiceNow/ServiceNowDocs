...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/ai-platform-capabilities/t\_CompleteaQuiz.html
release: yokohama
...
You must answer every required question, indicated by a red star, before you can submit the quiz. If you start to take a quiz but cannot complete it, save your responses and return to it later. When you have answered all the questions and are satisfied with the responses, submit the quiz.

By default, you cannot modify your answers to a quiz after submission. However, if the administrator has configured this quiz to allow retakes, the quiz remains in your queue after you finish it and the card shows a Modify Quiz button. You can retake the quiz as many times as you like before the due date.
...
2.  Click **Take Quiz** on a quiz card to open the questionnaire.
    ...
    If there is more than one quiz category, you can click the collapse or expand icon to hide or show the questions in the category.
...
4.  Click **Save** at any time to save your responses without submitting them.
...
8.  If prompted, enter your user name and password to verify your signature.
...
9.  If the system displays an error message indicating that a question has an invalid response or must still be answered, correct the error and resubmit the quiz.

10. Edit your answers and resubmit a quiz that permits retakes by clicking **Modify Quiz**.

    You can modify your responses to the quiz until its due date.


**Parent Topic:**[Using Quizzes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/ai-platform-capabilities/using-quizzes.md)
