...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/ai-platform-capabilities/add-interaction-related-records.html
release: yokohama
...
2.  Open any IMS record.

    If there are no records, create a dummy record.

3.  Click **Additional actions** &gt; **Configure** &gt; **Related lists**.

4.  Select the **HR Workspace** view.

5.  Locate the **Interaction Related Record -&gt; Interaction** option and add it to the **Selected** list.

    \[Omitted image "voice-related-list.png"\] Alt text: Select the HR Workspace view and the Interaction Related Record - Interaction option

6.  Click **Save**.


**Parent Topic:**[Integrating ServiceNow Voice for HR](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/ai-platform-capabilities/integrate-voice-hr-agent.md)
