...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/ai-platform-capabilities/survey-design-config-form.html
release: yokohama
