...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/ai-platform-capabilities/t\_view-bubble-chart-assessments.html
release: yokohama
...
1.  Navigate to **All** &gt; **Assessments** &gt; **Admin** &gt; **Bubble Charts**.

2.  Click a **Name** to open the bubble chart record.

3.  Under **Related Links**, click **View Bubble Chart**.

    **Note:** Demand managers and vendor managers can view bubble charts through the Demand Management and Vendor Performance applications. See [Project Portfolio Suite](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-business-management/ppm-collaboration/c_ProjectPortfolioSuite.md) for more information.


-   **[Bubble charts for assessments](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/ai-platform-capabilities/c_bubble-chart-assessments.md)**  
A bubble chart is a dynamically updated graph that plots assessment results for multiple assessable records.
-   **[Create a bubble chart](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/ai-platform-capabilities/r_CreateBubbleCharts.md)**  
...
-   **[Bubble chart components](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/ai-platform-capabilities/r_BubbleChartComponents.md)**  
...
-   **[Assessable record score summaries](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/ai-platform-capabilities/r_AssessableRecordScoreSummaries.md)**  
Point to a bubble to display a score summary for the assessable record the bubble represents.

**Parent Topic:**[View a metric result](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/ai-platform-capabilities/t_ViewAMetricResult.md)
