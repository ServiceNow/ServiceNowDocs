...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/ai-platform-capabilities/set-up-rtt.html
release: xanadu
...
If you have already deployed ServiceNow Voice and are upgrading, go through all of the steps for [Setting up ServiceNow Voice](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/ai-platform-capabilities/ccc-setup.md), and the steps in this procedure, before completing the setup on Amazon Connect.

## Procedure

1.  Add the system property `sn_cti_csm_cnt.enable_ims_update` and set it to **true**.

    For more information on adding a new system property, see [Add a system property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-administration/r_AvailableSystemProperties.md).
...
**Parent Topic:**[Configure Real Time Transcription for ServiceNow Voice Customer Service Management](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/ai-platform-capabilities/configure-rtt-sn-voice.md)
