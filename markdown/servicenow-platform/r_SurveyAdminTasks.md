...
To set up surveys in [Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/c_ServicePortal.md), you must first install Service Portal and then [Create and edit a page using the Service Portal Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/platform-user-interface/t_ConfigureAPage.md) on the page. The base system includes the Survey widget.

-   **[View survey reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/view-survey-overview.md)**  
...
-   **[View a survey instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/t_ViewSurveyInstance.md)**  
...
-   **[Survey users and groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/c_SurveyUsersAndGroups.md)**  
Survey users and survey user groups help survey administrators control who can take a survey.
-   **[Copy a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/copy-survey.md)**  
Create a copy of a survey with at least one category to reduce the effort of creating another survey with similar data.
-   **[Publish a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/t_PublishASurvey.md)**  
You must publish a survey to enable people to receive and complete survey instances.
-   **[Customize the appearance of a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/t_CustomizingAppearance.md)**  
...
-   **[Survey definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/c_SurveyDefinitions.md)**  
A survey definition is the root record upon which a survey is built.
-   **[Create a survey designer template question](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/t_CreateASurveyDesignerTemplateQ.md)**  
You can create a question that uses choice lists from a template.
-   **[Survey questions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/c_SurveyQuestion.md)**  
...
-   **[Survey distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/c_SurveyDistribution.md)**  
There are several ways for survey administrators to distribute surveys to users.
-   **[Outlook Actionable Messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/outlook-actionable-messages.md)**  
Outlook actionable messages plugin enables users to respond to the survey from within the Microsoft Outlook application.
-   **[Sentiment analysis for surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/sentiment-analysis.md)**  
...
-   **[Surveys in ITSM Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/survey-virtual-agent.md)**  
