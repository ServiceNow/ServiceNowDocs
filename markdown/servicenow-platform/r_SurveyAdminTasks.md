...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/r\_SurveyAdminTasks.html
release: yokohama
...
To set up surveys in [Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/c_ServicePortal.md), you must first install Service Portal and then [Create and edit a page using the Service Portal Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-user-interface/t_ConfigureAPage.md) on the page. The base system includes the Survey widget.

-   **[View survey reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/view-survey-overview.md)**  
Use the Survey Overview dashboard to view various survey reports, such as Surveys by Metric Type and State.
-   **[Survey designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_SurveyDesigner.md)**  
...
-   **[View a survey instance](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_ViewSurveyInstance.md)**  
...
-   **[Survey users and groups](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_SurveyUsersAndGroups.md)**  
Survey users and survey user groups help survey administrators control who can take a survey.
-   **[Copy a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/copy-survey.md)**  
Create a copy of a survey with at least one category to reduce the effort of creating another survey with similar data.
-   **[Publish a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_PublishASurvey.md)**  
You must publish a survey to enable people to receive and complete survey instances.
-   **[Customize the appearance of a survey](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_CustomizingAppearance.md)**  
...
-   **[Survey definitions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_SurveyDefinitions.md)**  
A survey definition is the root record upon which a survey is built.
-   **[Create a survey designer template question](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_CreateASurveyDesignerTemplateQ.md)**  
You can create a question that uses choice lists from a template.
-   **[Survey questions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_SurveyQuestion.md)**  
Survey questions appear on survey questionnaires for the associated survey definition.
-   **[Survey trigger conditions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_TriggerConditions.md)**  
Trigger conditions specify when to send a particular survey and the persons to send it to.
-   **[Survey distribution](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_SurveyDistribution.md)**  
There are several ways for survey administrators to distribute surveys to users.
-   **[Outlook Actionable Messages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/outlook-actionable-messages.md)**  
Outlook actionable messages plugin enables users to respond to the survey from within the Microsoft Outlook application.
-   **[Sentiment analysis for surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/sentiment-analysis.md)**  
...
-   **[Surveys in Service Portal and the Now Mobile app](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_SurveyServicePortal.md)**  
...
-   **[Surveys in ITSM Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/survey-virtual-agent.md)**  
...
-   **[Legacy survey migration](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_MigrateSurveys.md)**  
...
**Parent Topic:**[Using surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/using-surveys.md)
