...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/sentiment-analysis.html
release: australia
topic_type: concept
...
-   **[Configure a sentiment connector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/configure-sentiment-connector.md)**  
Specify the service URL and other configuration information for third party APIs that are used for sentiment analysis.
-   **[Sentiment analysis property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/sentiment-analysis-properties.md)**  
You can use the sentiment analysis property to customize the **Sentiment Analysis** module.
-   **[Sentiment analysis results](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/sentiment-analysis-results.md)**  
