...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/orchestration/t\_CreateOrchROICorrTaskRule.html
release: xanadu
...
Before starting this procedure, make sure you have created [labor rate cards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/orchestration/t_CreateOrchROILaborRateCard.md) and the appropriate [automation entry records](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/orchestration/t_CreateOrchROIAutoEntryRecord.md) for the automated tasks you want to evaluate.
