...
<table id="choicetable_lh4_h3j_4y"><tbody><tr><td id="d500679e333">
...
</table>10. Click **Continue** to open the [Conditions](https://www.servicenow.com/docs/access?context=conditions&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US) form to create exit condition rules for your activity and then click **Save**.
