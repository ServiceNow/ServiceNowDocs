...
3.  Add the [general properties](https://www.servicenow.com/docs/access?context=General-Flds-Templates&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).

    This information is standard for each custom activity, include a name, description, and other related information.

4.  Create the template [Create input variables](https://www.servicenow.com/docs/access?context=CreateInputVariables&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) for the template.
...
<table id="choicetable_lh4_h3j_4y"><tbody><tr><td id="d559031e333">
...
</table>10. Click **Continue** to open the [Conditions](https://www.servicenow.com/docs/access?context=conditions&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US) form to create exit condition rules for your activity and then click **Save**.
