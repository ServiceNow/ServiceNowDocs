...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/orchestration/t\_CreateAProbeActivity.html
release: yokohama
...
For descriptions of the command fields, see [Configure the Probe execution command](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/orchestration/t_CreateAProbeActivity.md).
...
2.  Complete the fields shown in the table.
    ...
    |Field|Description|
    |-----|-----------|
    |Input|Input variable builder. [Create input variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/orchestration/CreateInputVariables.md) to map to available fields.|
