...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/orchestration/t\_CreateAJMSActivity.html
release: yokohama
...
1.  Create or verify your [JMS credential](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/r_JMSCredentialsForm.md) .
...
2.  Create or verify your [JMS connection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/orchestration/t_CreateAJMSActivity.md) .
...
<table id="choicetable_yqs_2c4_5y"><tbody><tr><td id="d158348e456">
...
<table id="choicetable_gqc_pd4_5y"><tbody><tr><td id="d158348e537">
...
7.  Click **New**, select **JMS Credentials**, and provide the user name and password the MID should use to communicate with the JMS provider.
    ...
    For more information, see [JMS credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/r_JMSCredentialsForm.md) [JMS credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/r_JMSCredentialsForm.md).
