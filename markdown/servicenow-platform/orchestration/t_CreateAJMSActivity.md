...
1.  Create or verify your [JMS credential](https://www.servicenow.com/docs/access?context=r_JMSCredentialsForm&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) .
...
<table id="choicetable_py3_zmj_4y"><tbody><tr><td id="d147899e161">
...
<table id="choicetable_yqs_2c4_5y"><tbody><tr><td id="d147899e456">
...
<table id="choicetable_gqc_pd4_5y"><tbody><tr><td id="d147899e537">
...
7.  Click **New**, select **JMS Credentials**, and provide the user name and password the MID should use to communicate with the JMS provider.
    ...
    For more information, see [JMS credentials](https://www.servicenow.com/docs/access?context=r_JMSCredentialsForm&version=zurich&pubname=zurich-platform-security&ft:locale=en-US) [JMS credentials](https://www.servicenow.com/docs/access?context=r_JMSCredentialsForm&version=zurich&pubname=zurich-platform-security&ft:locale=en-US).
