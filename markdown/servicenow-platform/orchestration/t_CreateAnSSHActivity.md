...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/orchestration/t\_CreateAnSSHActivity.html
release: xanadu
...
For instructions on using the activity template process flow, see [create custom activities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/orchestration/create-custom-activities.md).
...
2.  After setting up [general properties](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/orchestration/General-Flds-Templates.md) and [creating input variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/orchestration/CreateInputVariables.md), configure the SSH Execution Command.

<table id="choicetable_j2l_k2s_d1b"><tbody><tr><td id="d74388e117">

**[Map the input variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/orchestration/CreateInputVariables.md)**

</td><td>

Use the variables you created to configure the command that Orchestration executes.

</td></tr><tr><td id="d74388e133">
...
</td></tr><tr><td id="d74388e191">

**Must Sudo**

</td><td>

If checked, enables the use of [sudo](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/connections-and-credentials/r_SSHCredentialsForm.md) to run commands.

</td></tr></tbody>
</table>    **Note:** You can map parameter values in a test payload to variables in the **Outputs** tab automatically. See [automap output variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/orchestration/automap-output-variable-inputs.md).
...
-   Use [auto-mapping](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/orchestration/automap-output-variable-inputs.md) to generate outputs and parsing rules
...
For descriptions of the command fields, see [Configure the SSH execution command](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/orchestration/t_CreateAnSSHActivity.md).
...
Capability values used to select the MID Server. For more information, see [MID Server capabilities](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown). If there are additional capabilities that are assigned by value, use this example to customize the MID Server selection:```
...
Input variable builder. [Create input variables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/orchestration/CreateInputVariables.md) to map to available fields.
...
Check box to allow the use of [SSH credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/connections-and-credentials/r_SSHCredentialsForm.md) to run commands.
