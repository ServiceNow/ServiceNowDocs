...
Provides the labor rate cards Orchestration ROI uses to determine the savings for each automated task. See [Cost Management](https://www.servicenow.com/docs/access?context=r_CostManagement&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US) for more information.
