...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/orchestration/t\_RetrieveSCCMDataClientSWDist.html
release: australia
...
-   [Configure a user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/orchestration/t-config-SCCM-deployment-manager.md) with the Application Deployment Manager role on the SCCM server.
...
**Parent Topic:**[Configuring SCCM](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/orchestration/configuring-sccm.md)
...
Users run the **Discover SCCM** workflow from an [SCCM Server Instance record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/orchestration/t_RetrieveSCCMDataClientSWDist.md) to populate the following ServiceNow tables:
...
</table>**Note:** For details about the custom activities used in this workflow to extract data from an SCCM server, see [Orchestration SCCM activity pack](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/orchestration/c_SCCMActivityPack.md).
