...
[SOAP message](https://www.servicenow.com/docs/access?context=c_SOAPMessage&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) to use for this activity. Users must have the web\_service\_admin role to configure this field.
...
SOAP message [SOAP message functions](https://www.servicenow.com/docs/access?context=c_SOAPMessageFunctions&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) to use for this activity. Users must have the web\_service\_admin role to configure this field.
