...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/servicenow-platform/orchestration/automap-output-variable-inputs.html
release: australia
...
<table id="choicetable_wkc_2t4_sz"><tbody><tr><td id="d457068e110">
