...
<table id="choicetable_zmw_zbr_vz"><tbody><tr><td id="d473745e117">
...
</td></tr><tr><td id="d473745e422">

**Required MID Server capabilities**

</td><td>

MID Server with the appropriate [MID Server capabilities](../../../product/mid-server/reference/r_MIDServerCapabilities.md) for connecting to the source and target servers.
...
[Credential aliases for Orchestration activities](https://www.servicenow.com/docs/access?context=c_AssignCredsOrchActivities&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) used to run the command on the source host.
...
Specific [Credential aliases for Orchestration activities](https://www.servicenow.com/docs/access?context=c_AssignCredsOrchActivities&version=xanadu&pubname=xanadu-platform-security&ft:locale=en-US) this activity must use to run SFTP commands on the source host.
...
MID Server with the appropriate [MID Server capabilities](../../../product/mid-server/reference/r_MIDServerCapabilities.md) for connecting to the source and target servers. By default, the system selects an SSH MID Server.
