...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/question-property-form.html
release: yokohama
...
\[Read-only\] Data type selected for this question. See the table in [Controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_QuizDesigner.md) for possible data types.
...
Check box for requiring users to answer the question. Users cannot submit quizzes until they answer all mandatory questions, which are denoted by a red Introduction\_to\_Fields\#Field\_Status\_Indicator" --&gt; field status indicator. This field is available when the question does not have a dependency and the question [Controls](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_QuizDesigner.md) is not **Boolean** with a check box option.
...
</table>**Parent Topic:**[Quizzes reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/quizzes-reference.md)

**Related topics**  


[Create quiz questions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_CreateAQuizQuestion.md)
