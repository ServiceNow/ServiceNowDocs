...
2.  Open an assessment metric category to review it.
    ...
    |--------------------------|-----------|-----------|
    |**Size**|**T-Shirt size** field on the [Demand](https://www.servicenow.com/docs/access?context=t_CreatingDemands&version=xanadu&pubname=xanadu-it-business-management&ft:locale=en-US) form.|Assesses demand size relative to the size of other demands.|
