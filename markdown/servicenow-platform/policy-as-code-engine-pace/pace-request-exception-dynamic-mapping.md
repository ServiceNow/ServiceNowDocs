...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/policy-as-code-engine-pace/pace-request-exception-dynamic-mapping.html
release: xanadu
...
breadcrumb: [Map PaCE policies using Dynamic Mapping, PaCE mapping, Manage PaCE policies, Administer PaCE policies, Policy as Code Engine \(PaCE\), Extend ServiceNow AI Platform capabilities]
---
...
You need to have the Governance, Risk, and Compliance \(GRC\) application installed to have the Request Exception button to show up on the mappings list. If you don't have the GRC application, see the  topic.

Role required: sn\_pace.admin, sn\_pace.mapping\_admin, or sn\_pace.execution\_reader
