...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/policy-as-code-engine-pace/pace-data-collector-structure.html
release: xanadu
...
Refer to the [Data type descriptions](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/policy-as-code-engine-pace/pace-data-type-descriptions.md) topic to see a list of the supported data types for the inputs and outputs.
