...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/policy-as-code-engine-pace/pace-add-nest-policies.html
release: xanadu
...
**Note:** You must create a policy before adding it to another policy. For more information, see [Create a PaCE policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/policy-as-code-engine-pace/pace-create-policy.md).
