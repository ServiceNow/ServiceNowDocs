...
To debug the script, select the Debugger script icon ![Debugger icon](../image/pace-debug-icon.jpg). For more information, see [Script Debugger API](https://www.servicenow.com/docs/access?context=scriptdebugger-api&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
