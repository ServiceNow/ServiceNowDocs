...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/policy-as-code-engine-pace/pace-test-data-collector.html
release: yokohama
...
Make sure you created a data collector in the policy. For more information, see [Create a data collector for a policy version](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/policy-as-code-engine-pace/pace-create-data-collector.md).
...
5.  In the contextual sidebar, select the Test playground icon \[Omitted image "pace-test-playground-icon.jpg"\] Alt text: Test playground icon..
    ...
    \[Omitted image "pace-data-collector-test-pg.jpg"\] Alt text: Test data collector test playground.
