...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/approvals/t\_CreateANewCustomSummarizer.html
release: yokohama
product: Approvals
...
5.  [Create a formatter and add it to a form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/t_CreateAFormatter.md) and add it to the appropriate form.

    To learn more about activity formatters, see [Activity formatter](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/ai-platform-administration/c_ActivityFormatter.md).


**Parent Topic:**[Summarizers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/approvals/c_Summarizers.md)
