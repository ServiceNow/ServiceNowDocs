...
-   Properties: see [E-signature SAML properties](https://www.servicenow.com/docs/access?context=c_AddingSupportForESignature&version=australia&pubname=australia-platform-security&ft:locale=en-US)
