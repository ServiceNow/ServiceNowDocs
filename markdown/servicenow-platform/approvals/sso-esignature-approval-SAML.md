...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/approvals/sso-esignature-approval-SAML.html
release: xanadu
product: Approvals
...
1.  Activate or upgrade to SAML 2.0 with the [Activate Multi-Provider SSO plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/platform-security/authentication/t_ActivateMultipleProviderSSO.md).

2.  Activate the [Approval with E-Signature plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/approvals/activate-approval-esignature.md).
...
<table id="choicetable_b2l_vpw_lz"><tbody><tr><td id="d318729e104">
...
**Parent Topic:**[Approval with e-signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/approvals/approval-with-e-signature.md)
