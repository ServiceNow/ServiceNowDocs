...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/approvals/sso-esignature-approval-SAML.html
release: yokohama
product: Approvals
...
1.  Activate or upgrade to SAML 2.0 with the [Activate Multi-Provider SSO plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-security/authentication/t_ActivateMultipleProviderSSO.md).

2.  Activate the [Approval with E-Signature plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/approvals/activate-approval-esignature.md).
...
<table id="choicetable_b2l_vpw_lz"><tbody><tr><td id="d334899e104">
...
**Parent Topic:**[Approval with e-signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/approvals/approval-with-e-signature.md)
