...
-   **Calling and routing**
    -   Make outbound calls via click to call or via auto-connecting the Omnichannel Callback feature.
        ...
        For more information, see [Configure Conversational IVR with Amazon Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/configure-va-ivr.md).
...
[Conversational IVR with Amazon Connect](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/conversational-interfaces/va-ivr-voice.md)
