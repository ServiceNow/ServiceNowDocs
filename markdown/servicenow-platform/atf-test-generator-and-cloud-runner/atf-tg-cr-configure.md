...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/atf-test-generator-and-cloud-runner/atf-tg-cr-configure.html
release: yokohama
...
3.  Click **Submit**.
    ...
    **Note:** You can see the number of entitled concurrent cloud runner browsers.
