...
breadcrumb: [Generating the tests, ATF Test Generator and Cloud Runner, Extend ServiceNow AI Platform capabilities]
---

# Tests generation for flow and flow logic

Use the ATF Test Generator and Cloud Runner store application to auto-generate tests that drive a ServiceNow flow for the available trigger types.
