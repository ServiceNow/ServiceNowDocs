...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/atf-test-generator-and-cloud-runner/atf-tg-cr-log-boq-form.html
release: xanadu
...
-   Successful test run\[Omitted image "atf-tg-cr-successful-run-boq.png"\] Alt text: Image showing successful test run
    ...
    **Note:** Select See generated tests related link to view the automated tests. The list of generated tests shows up and is not editable. You can also view the state and the reasons of failure of the tests on the list. The See generated tests related link is visible for all the log entries in the BOQ form examples. \[Omitted image "atf-tg-cr-generated-tests.png"\] Alt text: Generated tests screenshot.
...
**Parent Topic:**[ATF Test Generator and Cloud Runner reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/atf-test-generator-and-cloud-runner/atf-tg-cr-ref.md)
