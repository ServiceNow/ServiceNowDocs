...
-   Successful test run![Image showing successful test run](../image/atf-tg-cr-successful-run-boq.png)
    ...
    **Note:** Select See generated tests related link to view the automated tests. The list of generated tests shows up and is not editable. You can also view the state and the reasons of failure of the tests on the list. The See generated tests related link is visible for all the log entries in the BOQ form examples. ![Generated tests screenshot.](../image/atf-tg-cr-generated-tests.png)
