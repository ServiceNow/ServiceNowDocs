 ...
 **Note:** An administrator may need to add more [Define an option for a choice list](https://www.servicenow.com/docs/access?context=t_ViewChoiceListDefinitions&version=xanadu&pubname=xanadu-platform-administration&section=t_DefineAnOptionForAChoiceList&ft:locale=en-US) of plugins to the field.
