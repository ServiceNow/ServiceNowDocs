 ...
 **Note:** An administrator may need to add more [Define an option for a choice list](https://www.servicenow.com/docs/access?context=t_ViewChoiceListDefinitions&version=zurich&pubname=zurich-platform-administration&section=t_DefineAnOptionForAChoiceList&ft:locale=en-US) of plugins to the field.
...
**Note:** Script can now only be edited by Assessment Admins. Survey Creators no longer have the ability to edit the script.
 ...
 For more information about using this field, see [Script methods](../../../product/compliance/reference/r_ScriptMethods.md).
