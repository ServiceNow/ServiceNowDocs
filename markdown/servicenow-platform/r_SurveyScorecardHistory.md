...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/r\_SurveyScorecardHistory.html
release: zurich
topic_type: reference
last_updated: "2025-07-31"
reading_time_minutes: 2
breadcrumb: [View a survey scorecard, Survey responses and results, Use, Surveys, Assessments and Surveys, Exploring Service Administration, Service Administration, Manage service capabilities, Extend ServiceNow AI Platform capabilities]
---
...
To calculate the current ratings, the system averages the ratings from the trailing twelve month \(TTM\) period. The **Diff** column shows the discrepancy between the current ratings and the previous calendar year's ratings.

\[Omitted image "SurveyScorecardHistory3yr.png"\] Alt text: Survey scorecard history - 3 years
...
**Parent Topic:**[View a survey scorecard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/t_ViewAScorecard.md)
