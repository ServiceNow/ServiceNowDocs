...
The length of time to complete assigned survey instances, starting from the time the survey instance is generated. The assessment duration sets the Due date for each survey instance. The default duration is 14 days. [Configure the form](https://www.servicenow.com/docs/access?context=configure-form-layout&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US) to view this field.
...
-   You must opt in to Benchmarks to view the dashboard. See [Enable Benchmarks](https://www.servicenow.com/docs/access?context=t_EnableBench&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US)
...
[Event scheduling](https://www.servicenow.com/docs/access?context=c_ScheduleEvents&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US)
