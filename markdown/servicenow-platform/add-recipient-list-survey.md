...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/add-recipient-list-survey.html
release: yokohama
topic_type: task
...
Recipients lists should be pre-defined in the Recipients Lists submodule. For more information on defining recipients lists, see [Define a recipients list for surveys](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/define-recipient-list.md).
...
<table id="choicetable_jnl_df2_5fb"><thead><tr><th align="left" id="d481995e84">

Option

</th><th align="left" id="d481995e87">

Description

</th></tr></thead><tbody><tr><td id="d481995e93">
