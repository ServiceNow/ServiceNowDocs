...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/t\_ConfigureAScoredQuestion.html
release: xanadu
topic_type: task
...
A question must have a correct answer specified to be scored. Only results for scored questions are displayed in the [quiz scorecard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/c_QuizScorecards.md).
...
6.  Select the **Correct answer** for the question.
    ...
    **Note:** Multiple correct answers are supported for a few data types. See [Data types for quizzes](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/r_AvailableDataTypes.md).
...
**Parent Topic:**[Edit a quiz](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/t_EditaQuiz.md)
