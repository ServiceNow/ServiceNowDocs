...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/t\_ViewSurveyInstance.html
release: yokohama
topic_type: task
...
2.  Open a survey instance from the required sub-module.
    ...
    By default, you can view the following fields in the [Survey Instance form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/survey-instance-form.md) for all sub-modules other than **Completed**.
