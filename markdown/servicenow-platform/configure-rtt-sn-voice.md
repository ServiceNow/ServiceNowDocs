...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/configure-rtt-sn-voice.html
release: xanadu
topic_type: task
...
If you have already deployed Voice for CSM and are upgrading, go through all of the steps for [Setting up ServiceNow Voice](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/ccc-setup.md), and [Set up Real-Time Transcription for ServiceNow Voice](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/set-up-rtt.md) before completing the setup on Amazon Connect.
...
-   **[Set up Real-Time Transcription for ServiceNow Voice](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/set-up-rtt.md)**  
