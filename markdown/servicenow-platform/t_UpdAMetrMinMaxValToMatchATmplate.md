...
2.  Configure the [Configure the list layout](https://www.servicenow.com/docs/access?context=t_ConfigureTheListLayout&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) to show the **Min** and **Max** columns.
