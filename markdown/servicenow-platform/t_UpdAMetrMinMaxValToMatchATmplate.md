...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/t\_UpdAMetrMinMaxValToMatchATmplate.html
release: yokohama
topic_type: task
...
2.  Configure the [Configure the list layout](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_ConfigureTheListLayout.md) to show the **Min** and **Max** columns.
...
**Parent Topic:**[Create a metric template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_CreateAMetricTemplate.md)
