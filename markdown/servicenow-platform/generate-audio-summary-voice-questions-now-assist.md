...
Configure the Voice Assist for docs skill. For more information, see .
...
4.  Select the **Ask Otto** drop-down button \[Omitted image "image.icon-ask-otto-dropdown"\] Alt text: Ask otto dropdown button icon
...
6.  For Audio Summary feature:
    ...
    3.  Select \[Omitted image "image.icon-toggle"\] Alt text: toggle button icon to view auto-generated transcript of the audio summary.
7.  For Voice Q&amp;A feature:
    ...
    7.  To generate live captions, select \[Omitted image "image.icon-livecaption"\] Alt text: live caption icon
