...
description: If you have the admin role, you can activate the Remote Tables plugin \(com.glide.script.vtable\). This plugin includes demo data and activates related plugins if they are not already active.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/remote-tables/activate-remote-tables-plugin.html
release: xanadu
