...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/remote-tables/define-flow.html
release: yokohama
...
breadcrumb: [Create a flow definition for a remote table, Remote tables, Manage instance data sources, Extend ServiceNow AI Platform capabilities]
---
...
**Parent Topic:**[Create a flow definition for a remote table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/remote-tables/create-remote-table-flow.md)
