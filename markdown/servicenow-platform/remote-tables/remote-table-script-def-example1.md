...
**Note:** To learn more about use of RESTMessageV2 and how to define a direct message, see [RESTMessageV2 - Scoped, Global](https://www.servicenow.com/docs/access?context=c_RESTMessageV2API&version=zurich&pubname=zurich-api-reference&ft:locale=en-US) and [Direct RESTMessageV2 example](https://www.servicenow.com/docs/access?context=r_DirectRESTMessageV2Example&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).
...
[TransformerDefinition API - Scoped, Global](https://www.servicenow.com/docs/access?context=TransformerDefinitionAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)

[TransformerRuleList API - Scoped, Global](https://www.servicenow.com/docs/access?context=TransformerRuleListAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)

[TransformerScripted API - Scoped, Global](https://www.servicenow.com/docs/access?context=TransformerScriptedAPI&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
