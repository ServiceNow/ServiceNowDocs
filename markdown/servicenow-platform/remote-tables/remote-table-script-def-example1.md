...
**Note:** To learn more about use of RESTMessageV2 and how to define a direct message, see [RESTMessageV2 - Scoped, Global](https://www.servicenow.com/docs/access?context=c_RESTMessageV2API&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US) and [Direct RESTMessageV2 example](https://www.servicenow.com/docs/access?context=r_DirectRESTMessageV2Example&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US).
...
[TransformerDefinition API - Scoped, Global](https://www.servicenow.com/docs/access?context=TransformerDefinitionAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)

[TransformerRuleList API - Scoped, Global](https://www.servicenow.com/docs/access?context=TransformerRuleListAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)

[TransformerScripted API - Scoped, Global](https://www.servicenow.com/docs/access?context=TransformerScriptedAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US)
