...
-   You want to retrieve customer details that are stored in an external Customer Relationship Management \(CRM\) application for viewing in Customer Service Management functions such as Agent Workspace.
    ...
    **Note:** To learn more about data retrieval for Customer Service Management, see [Third-party data integration for CSM](https://www.servicenow.com/docs/access?context=csm-third-party-data-integration&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
