...
5.  Update the connector.
    ...
    For more information, see [Application Manager](https://www.servicenow.com/docs/access?context=application-manager&version=xanadu&pubname=xanadu-platform-administration&ft:locale=en-US).
