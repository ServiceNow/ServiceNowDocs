...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/api-insights/api-insights-viewing-installed-connection.html
release: australia
...
-   Installed connection \(see [View an installed connection within API Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/api-insights/api-insights-viewing-installed-connection.md).\)
-   Draft connection \(see [View a draft connection within API Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/api-insights/api-insights-viewing-installed-connection.md).\)
