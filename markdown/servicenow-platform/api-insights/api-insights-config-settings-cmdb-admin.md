...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/api-insights/api-insights-config-settings-cmdb-admin.html
release: yokohama
...
<table id="choicetable_mvn_tgd_ncc"><tbody><tr><td id="d79869e104">
...
<table id="choicetable_ots_vkd_ncc"><thead><tr><th align="left" id="d79869e198">

Option

</th><th align="left" id="d79869e201">

Description

</th></tr></thead><tbody><tr><td id="d79869e207">
...
Assigns the API to a support group responsible for resolving incidents, maintaining stability, and troubleshooting issues.
    ...
    **Note:** Workflows are created by your administrator using the Workflow Studio. See [Configuring flows for API actions in API Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/api-insights/api-insights-workflow.md).
