...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/api-insights/api-insights-config-settings-cmdb-admin.html
release: xanadu
...
<table id="choicetable_mvn_tgd_ncc"><tbody><tr><td id="d73132e104">
...
<table id="choicetable_ots_vkd_ncc"><thead><tr><th align="left" id="d73132e198">

Option

</th><th align="left" id="d73132e201">

Description

</th></tr></thead><tbody><tr><td id="d73132e207">
...
Assigns the API to a support group responsible for resolving incidents, maintaining stability, and troubleshooting issues.
    ...
    **Note:** Workflows are created by your administrator using the Workflow Studio. See [Configuring flows for API actions in API Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/api-insights/api-insights-workflow.md).
