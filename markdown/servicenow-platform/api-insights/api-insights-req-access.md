...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/api-insights/api-insights-req-access.html
release: australia
...
Alternatively, you can request access to an API managed by your team. See [Manage your team's API data in API Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/api-insights/api-insights-team-api.md),
