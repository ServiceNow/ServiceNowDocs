...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/api-insights/api-insights-resolve-gaps.html
release: xanadu
...
**Important:** When creating relationships for a large number of APIs, you can automate creating relationships based on tags on API. For more information, see [Automating creating tag-based relationship mapping within API Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown).
