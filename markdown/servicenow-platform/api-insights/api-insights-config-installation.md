...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/api-insights/api-insights-config-installation.html
release: xanadu
...
1.  [Install API Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/api-insights/api-insights-install.md).

    Install the API Insights application \(sn\_api\_insights\_ws\).

2.  [Assign roles for API Insights users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/api-insights/api-insights-assign-roles.md)
