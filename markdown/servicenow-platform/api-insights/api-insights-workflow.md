...
To learn about creating flows, see [Getting started with flows](https://www.servicenow.com/docs/access?context=getting-started-flow&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US).
