...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/api-insights/api-insights-team-api.html
release: australia
...
3.  From the **Name** column, select an API to view more details of the API.
    ...
    See [Viewing API details in API Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/api-insights/api-insights-api-details-page.md).
