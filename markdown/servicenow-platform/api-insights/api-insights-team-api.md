...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/api-insights/api-insights-team-api.html
release: yokohama
...
3.  From the **Name** column, select an API to view more details of the API.
    ...
    See [Viewing API details in API Insights](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/api-insights/api-insights-api-details-page.md).
