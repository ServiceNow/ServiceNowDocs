...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/define-recipient-list.html
release: yokohama
topic_type: task
...
3.  On the Recipients List form, fill in the fields:
    ...
    For a description of the field values, see [Recipients List form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/recipients-list-form.md).
