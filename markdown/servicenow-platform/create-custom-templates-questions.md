...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/create-custom-templates-questions.html
release: yokohama
topic_type: task
...
3.  On the Custom Metric form, fill in the fields.
    ...
    For a description of the field values, see [Custom Metric form](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/custom-metric-form-fields.md).
