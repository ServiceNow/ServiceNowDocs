...
List of predefined options. For more information, see the definition of the **Choices** field in [Create a question in the survey designer](../task/t_CreateQuestSurveyDesigr.md).
