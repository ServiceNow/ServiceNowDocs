...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/c\_SurveyDesignerElements.html
release: australia
topic_type: concept
...
Choice list of templates that provide a predefined scale of options. For details, see [Quiz scorecards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/c_QuizScorecards.md).
...
-   **Configuration**: Create introductions and end notes for surveys and select a [signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/t_CreateAnAssessmentSignature.md).
