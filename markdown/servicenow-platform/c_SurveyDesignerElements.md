...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/c\_SurveyDesignerElements.html
release: yokohama
topic_type: concept
...
Choice list of templates that provide a predefined scale of options. For details, see [Quiz scorecards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/c_QuizScorecards.md).
...
-   **Configuration**: Create introductions and end notes for surveys and select a [signature](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/t_CreateAnAssessmentSignature.md).
