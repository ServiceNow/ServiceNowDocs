...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/create-article-using-sharepoint.html
release: australia
topic_type: task
