...
-   To enable Advanced Work Assignment \(AWA\) Voice Routing, check the checkbox under the **AWA Voice Routing** heading. Complete the steps specified in the setup guide:
    ...
    -   Complete [AWS Lambda](https://www.servicenow.com/docs/access?context=aws-lambda-spoke&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US) and Oauth credential setup.
...
-   Amazon Connect \(Phone\) is a placeholder phone channel for Amazon Connect integration. For queues that you implement in your Amazon Connect instance, you can use this channel to create corresponding Advanced Work Assignment queues. For an example implementation, see [Associate Amazon Connect queues for ITSM to a ServiceNow instance](https://www.servicenow.com/docs/access?context=setup-cloudcallcenter-itsm-configurable-workspace&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US) or [Associate Amazon Connect queues for CSM to a ServiceNow instance](https://www.servicenow.com/docs/access?context=setup-amazonconnect-configurable-csm&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
