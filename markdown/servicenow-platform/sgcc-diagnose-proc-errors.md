...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/sgcc-diagnose-proc-errors.html
release: xanadu
topic_type: task
...
Verify that the Service Graph Connector diagnosis skill is enabled. For more information, see .
