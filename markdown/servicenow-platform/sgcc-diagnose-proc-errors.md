...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/sgcc-diagnose-proc-errors.html
release: yokohama
topic_type: task
...
Verify that the Service Graph Connector diagnosis skill is enabled. For more information, see [Configure the Service Graph Connector diagnosis skill](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown).
