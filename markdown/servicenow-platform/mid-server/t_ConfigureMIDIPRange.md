...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/mid-server/t\_ConfigureMIDIPRange.html
release: xanadu
product: MID Server
...
The MID Servers that can use this IP address range.
    ...
    **Important:** IP ranges assigned manually prior to using auto-assignment in the [Discovery Quick Start](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/discovery/discovery-quick-start.md) are affected as follows:
...
**Parent Topic:**[MID Server selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/mid-server/c_MIDServerSelector.md)
