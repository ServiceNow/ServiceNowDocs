...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/mid-server/r\_MIDServerProperties.html
release: zurich
product: MID Server
...
-   **mid.discovery.max\_payload\_size**
    ...
    For probes, this applies only to those probes where the Used by Discovery field is true. For patterns, this applies to the [Horizontal Pattern probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/r-HorizontalPatternProbe.md).
