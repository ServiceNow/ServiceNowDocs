...
-   **glide.http.proxy\_username**
    ...
    Set the proxy server username. If the proxy server is authenticating using user name and password, enter a value for this property.

    -   Type: string
    -   Default value: none
-   **glide.http.proxy\_password**

    Set the proxy server password. If the proxy server is authenticating using user name and password, enter a value for this property.
...
-   **mid.aws.sts.assume\_role.disable\_credential\_caching**
    ...
    Set this property to **true** to prevent the caching of temporary credentials for Cloud Discovery. For more information, see [Access setup for AWS service accounts](https://www.servicenow.com/docs/access?context=access-aws-accounts&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US) [Access setup for AWS service accounts](https://www.servicenow.com/docs/access?context=access-aws-accounts&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).

    -   Type: true \| false
    -   Default: false
-   **mid.aws.sts.assume\_role.credential\_ttl\_minutes**

    Set the number of minutes you want to cache temporary credentials for Cloud Discovery. For more information, see [Access setup for AWS service accounts](https://www.servicenow.com/docs/access?context=access-aws-accounts&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US) [Access setup for AWS service accounts](https://www.servicenow.com/docs/access?context=access-aws-accounts&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
...
-   **mid.discovery.max\_payload\_size**
    ...
    For probes, this applies only to those probes where the Used by Discovery field is true. For patterns, this applies to the [Horizontal Pattern probe](https://www.servicenow.com/docs/access?context=r-HorizontalPatternProbe&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
