...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/mid-server/trigger-mid-server-upgrade.html
release: zurich
product: MID Server
