...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/mid-server/override\_mid\_server\_selector.html
release: yokohama
product: MID Server
...
Before attempting to create an override filter, be sure you understand the criteria the platform uses to select MID Servers. See [MID Server selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/mid-server/c_MIDServerSelector.md) for details.
