...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/mid-server/t\_UpgradeTheMIDServerManually.html
release: xanadu
product: MID Server
...
For the upgrade to run, MID servers must be in the **Up** state and [validated](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/mid-server/t_ValidateAMIDServer.md), or in the **Upgrade failed** state. The MID Server automatically runs the [pre-upgrade test](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/mid-server/mid-server-pre-upgrade-check.md) before upgrading. Any errors encountered during this test must be resolved for the upgrade to proceed.

## About this task

The MID Server is upgraded to the version specified by build stamp on the instance, or by the [upgrade property](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/mid-server/mid-server-version-selection.md) that you specify.
...
**Parent Topic:**[MID Server upgrades](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/mid-server/c_UpgradeAndTestMIDServer.md)
