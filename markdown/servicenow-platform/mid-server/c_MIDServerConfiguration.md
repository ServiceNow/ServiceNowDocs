...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/mid-server/c\_MIDServerConfiguration.html
release: australia
product: MID Server
...
-   **[MID Server selection](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/c_MIDServerSelector.md)**
...
-   **[MID Server IP range auto-assignment](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/mid-servers-auto-assignment.md)**

    Configure the system to automatically assign a qualified MID Server to a subnet by that subnet's IP address range.

-   **[Map an IP address to a DNS name](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/t_MapIPAddressToDNSName.md)**

    Map host server DNS names to IP addresses if your MID Server manages resources within defined IP ranges.

-   **[Configure MID Server as WinRM trusted host](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/enable-winRM-MID-servers.md)**
...
-   **[File permission enforcement for Windows MID Servers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/mid-non-admin-permission.md)**
...
-   **[Create a MID Server cluster](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/t_ConfigureAMIDServerCluster.md)**

    Create a MID Server cluster for load balancing and fail-over protection.

-   **[Set thread use](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/t_SetMIDServerThreadUse.md)**
...
-   **[MID Server domain separation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/c_MIDServerDomainSeparation.md)**

    Set up your MID Servers in different domains to restrict the records and credentials that a MID Server can access.

-   **[Synchronize a JAR file to MID Servers](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/t_SynchronizeAJARFiletoMIDServers.md)**
...
[Install and uninstall Nmap on a MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/install-nmap-on-mid-server.md)
...
-   **[vCenter event collector](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/c_VCenterEventProcessorExtension.md)**
...
-   **[SNMP trap collector extension](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/c_SNMPTrapCollectorExtension.md)**
