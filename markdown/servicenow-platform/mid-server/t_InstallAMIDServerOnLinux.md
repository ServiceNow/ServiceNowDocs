...
Verify that the host computer satisfies the [MID Server system requirements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/mid-server/r_MIDServerSystemRequirements.md).
...
5.  The **installer.sh** script takes the following inputs.
    ...
    -   **MID-Server Username**
        ...
        Enter the user name of [the MID Server user that you already created](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/mid-server/t_SetupMIDServerRole.md). The MID Server user must have the mid\_server role.
