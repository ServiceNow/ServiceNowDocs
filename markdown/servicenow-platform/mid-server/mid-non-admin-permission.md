...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/mid-server/mid-non-admin-permission.html
release: yokohama
product: MID Server
