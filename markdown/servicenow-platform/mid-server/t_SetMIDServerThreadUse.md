...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/mid-server/t\_SetMIDServerThreadUse.html
release: xanadu
product: MID Server
...
Follow the steps below to change the `config.XML` file. Alternatively, use the `threads.max` connection parameter. See [MID Server Connection parameters](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/servicenow-platform/mid-server/mid-server-parameters.md) for more details.
