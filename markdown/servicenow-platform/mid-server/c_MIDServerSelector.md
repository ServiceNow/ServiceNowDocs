...
For Agent Client Collector, refer to [Automatic MID Server selection](https://www.servicenow.com/docs/access?context=acc-auto-mid-selection&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
...
The IP configured in the event connector instances, such as [Configure event collection from HPOM](https://www.servicenow.com/docs/access?context=t_EMConfigureHPOMConnector&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US), must fall within the IP range configured on the MID Server.
...
Choose one or more MID Servers on the connector instance event collection, such as [Configure event collection from HPOM](https://www.servicenow.com/docs/access?context=t_EMConfigureHPOMConnector&version=xanadu&pubname=xanadu-it-operations-management&ft:locale=en-US).
