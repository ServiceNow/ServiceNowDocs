...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/mid-server/c\_MIDServerDomainSeparation.html
release: australia
product: MID Server
...
1.  [Configure a MID Server user](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/t_SetupMIDServerRole.md) within a specified domain with the proper **mid\_server** role.

2.  Specify this user within the MID Server **config.xml** file.

    When you set the [MID Server user credentials](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/mid-server-install-prereqs.md) in the `config.xml` file, make sure they are in the proper domain.
