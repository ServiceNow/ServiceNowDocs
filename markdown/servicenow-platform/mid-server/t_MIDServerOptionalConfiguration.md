...
-   For a complete list of minimum MID Server requirements, see [MID Server system requirements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/mid-server/r_MIDServerSystemRequirements.md).
-   You can use MID Server profiles to set the JVM memory size from your instance without accessing the host server or editing configuration files manually. For more information, see [Set the MID Server JVM memory size](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/mid-server/t_MIDServerOptionalConfiguration.md). This method is supported for Zurich and later releases.

## Procedure

1.  Open the `\ServiceNow\<MID Server name>\agent\conf\wrapper-override.conf` file in a text editor.

    For more information about this file, see [Installing Multiple MID Servers on a Single System](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/servicenow-platform/mid-server/t_InstallMultplMIDSvrOnASingleSys.md).
