...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/mid-server/t\_MIDServerOptionalConfiguration.html
release: australia
product: MID Server
...
**Note:** For a complete list of minimum MID Server requirements, see [MID Server system requirements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/r_MIDServerSystemRequirements.md).

## Procedure

1.  Open the `\ServiceNow\<MID Server name>\agent\conf\wrapper-override.conf` file in a text editor.

    For more information about this file, see [Installing Multiple MID Servers on a Single System](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/servicenow-platform/mid-server/t_InstallMultplMIDSvrOnASingleSys.md).
