...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/mid-server/containerized-mid-deployment.html
release: australia
product: MID Server
