...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/mid-server/containerized-mid-deployment.html
release: yokohama
product: MID Server
