...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/mid-server/c\_MIDServerConnectionPrerequisites.html
release: yokohama
product: MID Server
...
**Parent Topic:**[Configuring MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/mid-server/configure-mid-server.md)
...
</table>Make sure that the host machine meets the requirements specified in the [MID Server system requirements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/mid-server/r_MIDServerSystemRequirements.md).
...
After the network is prepared, proceed to [Installing the MID Server](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/servicenow-platform/mid-server/mid-server-installation.md).
