...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/mid-server/c\_UpgradeAndTestMIDServer.html
release: zurich
product: MID Server
...
-   **MID Server operating system compatibility**
    ...
    Upgrading Windows or Linux MID Servers with 32-bit operating systems is not supported. For supported operating systems and other host requirements, see [MID Server system requirements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/mid-server/r_MIDServerSystemRequirements.md).
...
-   **Upgrading**
    ...
    The MID Server status is changed to Upgrading while the upgrade is running. The Upgrading state is similar to the [**Paused**](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/mid-server/t_PauseTheMIDServer.md) state. This is avoids potential miscommunication between the new version of the instance and the previous version of the MID Server during upgrade. While in the Upgrading state, you cannot resume or restart the MID Server. However, you can perform the same actions that you can when the MID Server is in the Paused state.
...
-   **[MID Server pre-upgrade check](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/mid-server/mid-server-pre-upgrade-check.md)**  
...
-   **[Pinning a MID Server to a specific version](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/mid-server/mid-server-version-selection.md)**  
...
-   **[Trigger MID Server upgrade](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/servicenow-platform/mid-server/trigger-mid-server-upgrade.md)**  
