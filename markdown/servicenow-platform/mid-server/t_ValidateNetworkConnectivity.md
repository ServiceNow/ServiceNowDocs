...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/servicenow-platform/mid-server/t\_ValidateNetworkConnectivity.html
release: xanadu
product: MID Server
