...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/mid-server/t\_ValidateNetworkConnectivity.html
release: yokohama
product: MID Server
