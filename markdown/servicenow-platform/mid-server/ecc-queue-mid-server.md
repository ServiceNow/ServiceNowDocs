...
The name of the probe the MID server ran. If you are using a pattern for discovery, the [Horizontal Pattern probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/discovery/r-HorizontalPatternProbe.md) [Horizontal Pattern probe](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/it-operations-management/discovery/r-HorizontalPatternProbe.md) appears.
