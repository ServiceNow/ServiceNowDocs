...
The name of the probe the MID server ran. If you are using a pattern for discovery, the [Horizontal Pattern probe](https://www.servicenow.com/docs/access?context=r-HorizontalPatternProbe&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US) [Horizontal Pattern probe](https://www.servicenow.com/docs/access?context=r-HorizontalPatternProbe&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US) appears.
