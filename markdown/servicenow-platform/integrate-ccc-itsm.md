...
Integrate Voice with Workforce Optimization for ITSM to visualize call metrics from Amazon Connect. The Voice uses [Advanced Work Assignment](https://www.servicenow.com/docs/access?context=awa-overview&version=zurich&pubname=zurich-conversational-interfaces&ft:locale=en-US) to display the call metrics and active calls along with all other Channel metrics in the Manager Workspace.
