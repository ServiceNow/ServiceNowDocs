...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/servicenow-platform/ccc-csm-config-pin.html
release: australia
topic_type: concept
