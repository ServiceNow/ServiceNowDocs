...
Discovered by the Next Generation Fortinet Network Firewall - REST pattern. See [Fortinet firewall and FortiGate VDOM REST-based discovery](https://www.servicenow.com/docs/access?context=fortinet-fw-vdoms-rest-discovery&version=zurich&pubname=zurich-it-operations-management&ft:locale=en-US).
