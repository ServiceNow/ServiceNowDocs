...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/cmdb-ci-class-models/cmdb-ci-class-models-avi-lb.html
release: zurich
...
Discovery uses the [Avi Vantage load balancer discovery](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/it-operations-management/avi-load-balancer-discovery.md) pattern to find Avi load balancer resources.
