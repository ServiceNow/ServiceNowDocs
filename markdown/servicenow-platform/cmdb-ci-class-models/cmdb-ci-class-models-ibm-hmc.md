...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/servicenow-platform/cmdb-ci-class-models/cmdb-ci-class-models-ibm-hmc.html
release: yokohama
...
\[Omitted image "IBM-HMC-CI-Class-Model.png"\] Alt text: IBM HMC extension classes integrated with the CMDB class hierarchy.
