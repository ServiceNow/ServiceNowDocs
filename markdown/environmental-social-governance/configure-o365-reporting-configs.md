...
-   **Report**: Select this option if you want to import data from a predefined report or chart. For more information on how to create a report, see Create a report with Analytics Q&amp;A.
-   **Data visualization**: Select this option if you want to import data from a data visualization in the Performance Analytics library. For more information, see Overview of data visualization types.
