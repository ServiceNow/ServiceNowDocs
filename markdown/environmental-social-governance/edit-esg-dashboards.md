...
<table id="choicetable_gv3_q3r_g5"><thead><tr><th align="left" id="d20292e109">

Action

</th><th align="left" id="d20292e112">

Steps

</th></tr></thead><tbody><tr><td id="d20292e118">
...
3.  Edit the details of the dashboard and then select **Exit editing mode**.
 For more information, see [Edit ESG Management dashboard details](edit-esg-dashboard-details.md).

</td></tr><tr><td id="d20292e192">
