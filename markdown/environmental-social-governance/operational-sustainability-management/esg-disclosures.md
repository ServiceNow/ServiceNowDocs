...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/environmental-social-governance/operational-sustainability-management/esg-disclosures.html
release: xanadu
...
In a narrative disclosure, multiple collaborators can contribute to create the disclosure. You can also define templates for each type of disclosure report. Refer to [Types of disclosure reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/types-of-disclosure-reports.md) to understand each report type. Each disclosure can be approved by one or more approvers.
...
-   **[Types of disclosure reports](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/types-of-disclosure-reports.md)**  
...
-   **[Approval workflow of a disclosure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/approval-workflow-of-a-disclosure.md)**  
...
-   **[Create a disclosure template](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/create-a-disclosure-template.md)**  
...
-   **[Create a narrative disclosure on remote storage](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/create-disclosure.md)**  
...
-   **[Create a narrative disclosure on local system](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/create-a-disclosure-on-local.md)**  
...
-   **[Add disclosure documents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/add-disclosure-related-docs.md)**  
...
-   **[Add metrics to a disclosure](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/add-related-metric-to-a-disclosure.md)**  
Add any metrics to the disclosure that would help to contribute to the disclosure data.
-   **[Create a authority document using ESG Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/create-a-authority-document-using-esg-workspace.md)**  
...
-   **[Create a citation using ESG Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/create-a-citation-using-esg-workspace.md)**  
