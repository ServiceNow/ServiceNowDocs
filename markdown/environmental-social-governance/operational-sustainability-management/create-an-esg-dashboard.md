...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/environmental-social-governance/operational-sustainability-management/create-an-esg-dashboard.html
release: yokohama
...
2.  Select the Analytics dashboard icon.
...
7.  Select the View dashboard details icon \[Omitted image "details-icon.png"\] Alt text: to view all the details of the dashboard.
    ...
    You can also edit the details as required. For more information, see [Edit Operational Sustainability Management dashboard details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/environmental-social-governance/operational-sustainability-management/edit-esg-dashboard-details.md)
...
-   [Edit Operational Sustainability Management dashboard details](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/environmental-social-governance/operational-sustainability-management/edit-esg-dashboard-details.md)
-   [Edit Operational Sustainability Management dashboard elements](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/environmental-social-governance/operational-sustainability-management/edit-esg-dashboard-elements.md)

**Parent Topic:**[Monitoring assessment data using Operational Sustainability Management \(formerly ESG\) dashboards](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/environmental-social-governance/operational-sustainability-management/monitor-data-using-esg-dashboards.md)
