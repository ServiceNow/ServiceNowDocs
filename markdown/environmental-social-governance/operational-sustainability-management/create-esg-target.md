---
title: Create an ESG target
description: Create an environmental, social, and social \(ESG\) target to help track the progress towards your ESG goal.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/environmental-social-governance/operational-sustainability-management/create-esg-target.html
release: xanadu
...
1.  Navigate to **All** &gt; **Environmental, Social, and Governance** &gt; **ESG Workspace** &gt; **Lists** &gt; **Program Setup** &gt; **Targets**.
...
-   **[Add a source for a target](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/add-a-source-for-a-target.md)**  
