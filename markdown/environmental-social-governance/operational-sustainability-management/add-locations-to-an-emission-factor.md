...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/environmental-social-governance/operational-sustainability-management/add-locations-to-an-emission-factor.html
release: xanadu
...
breadcrumb: [Create an emission factor, Set up the emission factor library, Configuring ESG Management, Environmental, Social, and Governance Management]
---
...
**Parent Topic:**[Create an emission factor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/create-an-emission-factor.md)
