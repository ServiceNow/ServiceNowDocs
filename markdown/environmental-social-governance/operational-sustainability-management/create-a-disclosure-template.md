...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/environmental-social-governance/operational-sustainability-management/create-a-disclosure-template.html
release: xanadu
...
1.  Navigate to **All** &gt; **Environmental, Social, and Governance** &gt; **Administration** &gt; **Disclosure Templates**.
...
Document to add.**Note:** The file extension must be .docx.

</td></tr></tbody>
</table>4.  Select **Click to add...**.

5.  Select **Choose file**.

    1.  Select a file of your choice from your local system.
