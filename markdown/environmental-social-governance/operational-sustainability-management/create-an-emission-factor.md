...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/environmental-social-governance/operational-sustainability-management/create-an-emission-factor.html
release: xanadu
...
-   **[Add locations to an emission factor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/add-locations-to-an-emission-factor.md)**  
...
-   **[Recalculate emission factor](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/recalculate-emission-factor.md)**  
When an emission factor value is updated, you can initiate the recalculation of the calculated metric definitions to which the emission factor is associated to. This ensures that metrics data remains consistent and accurate, reflecting the latest changes.

**Parent Topic:**[Set up the emission factor library](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/environmental-social-governance/operational-sustainability-management/set-up-the-emission-factor-library.md)
