...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/environmental-social-governance/operational-sustainability-management/configure-project-form.html
release: yokohama
...
The same procedure can be performed on the Demand and Program forms as well. For more information, see [Goal framework](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/it-business-management/goal-framework/goal-framework.md).
