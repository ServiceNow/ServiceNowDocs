...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/environmental-social-governance/operational-sustainability-management/share-an-esg-dashboard.html
release: yokohama
...
# Share an Operational Sustainability Management dashboard
...
2.  Select the Analytics dashboard icon and then select the dashboard you want to share.
...
<table id="choicetable_yxb_j15_q5b"><tbody><tr><td id="d22773e118">
