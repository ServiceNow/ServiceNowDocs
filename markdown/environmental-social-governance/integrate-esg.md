...
For more information on the roles and tables that are installed with the ESG Management, see [Components installed with Operational Sustainability Management \(formerly ESG Management\)](../reference/components-installed-with-esg.md).
...
-   **[Integrating ESG Management \(formerly ESG\) with Advanced risk assessment](esg-risk-management.md)**  
...
-   **[Integrating ESG Management \(formerly ESG\) with Watershed](integrate-esg-with-watershed.md)**  
...
-   **[Integrating ESG Management \(formerly ESG\) with Urjanet](integrating-esg-management-with-urjanet.md)**  
...
-   **[Integrating ESG Management \(formerly ESG\) with SAP Concur](integrate-esg-with-concur.md)**  
