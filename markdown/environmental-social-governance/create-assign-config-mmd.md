...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/environmental-social-governance/create-assign-config-mmd.html
release: yokohama
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    For information about the fields, refer to [Assignment Configuration New Record](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/governance-risk-compliance/grc-common-functions/assignment-configuration-new-record.md).
