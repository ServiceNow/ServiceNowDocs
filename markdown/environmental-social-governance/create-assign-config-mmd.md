...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/environmental-social-governance/create-assign-config-mmd.html
release: xanadu
topic_type: task
