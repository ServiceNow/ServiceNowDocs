...
description: Import and insert data such as ESG data points and reports into a Microsoft Word disclosure report document from a ServiceNow instance. You can only import and insert the data that is configured in your reporting configurations.
locale: en-US
release: xanadu
topic_type: task
...
4.  To insert an ESG data point from a table into the document, move the cursor at the point where you want to insert data.

    1.  Select the **Data** tab on the right side pane.

    2.  The **Business domain** field is set to **ESG**.
