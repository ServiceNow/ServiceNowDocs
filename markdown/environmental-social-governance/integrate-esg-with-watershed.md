...
To use the features of Watershed, you must activate the Watershed Integration for ESG plugin and [configure the metric integrations.](../../metrics/task/configure-metric-integrations.md)
...
-   **[Modify the Watershed Integration for ESG](../../metrics/task/configure-metric-integrations.md)**  
