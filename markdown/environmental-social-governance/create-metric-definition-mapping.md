...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/environmental-social-governance/create-metric-definition-mapping.html
release: xanadu
topic_type: task
...
1.  Navigate to **All** &gt; **Environmental, Social, and Governance** &gt; **Urjanet** &gt; **Metric Definition Mapping**.
