...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/environmental-social-governance/update-an-entity.html
release: yokohama
topic_type: task
...
3.  On the form, update the fields as necessary.
    ...
    |Details tab|Information on the entity. For more information on the **Details** tab, see [Create an entity](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/environmental-social-governance/create-entity.md) for more information.|
...
**Parent Topic:**[Manage entities in Operational Sustainability Management \(formerly ESG Management\)](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/environmental-social-governance/entities-in-esg.md)
