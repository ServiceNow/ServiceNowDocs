...
After you create a [material topic](create-material-topics.md), you must also create goals to track your progress toward the material topic. After you create a goal, you can do the following:
...
For more information, see [Goal framework](https://www.servicenow.com/docs/access?context=goal-framework&version=zurich&pubname=zurich-it-business-management&ft:locale=en-US)
...
[Goals overview in the Operational Sustainability Workspace](../reference/goals-overview-page.md)
