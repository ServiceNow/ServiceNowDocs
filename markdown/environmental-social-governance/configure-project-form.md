...
The same procedure can be performed on the Demand and Program forms as well. For more information, see [Goal framework](https://www.servicenow.com/docs/access?context=goal-framework&version=zurich&pubname=zurich-it-business-management&ft:locale=en-US).
