...
You can associate an entity type, create metrics, and add citations to the metric definition. See [Update metric definition](update-automated-metric-definition.md) for more information.
