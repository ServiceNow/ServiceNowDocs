...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/environmental-social-governance/create-an-adhoc-metric-data-task.html
release: australia
topic_type: task
...
For information about features that are not supported for ad hoc metric data tasks, see [Ad hoc metric data task limitations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/environmental-social-governance/ad-hoc-metric-data-task-limitations.md).

-   **[Ad hoc metric data task limitations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/environmental-social-governance/ad-hoc-metric-data-task-limitations.md)**  
