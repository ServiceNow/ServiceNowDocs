...
A user with the sn\_esg.program\_manager role, can download and install the ESG Management application. For details, see [Install Operational Sustainability Management \(formerly ESG Management\)](install-esg.md).
