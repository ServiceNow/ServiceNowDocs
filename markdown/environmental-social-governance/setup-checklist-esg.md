---
title: Setup checklist for the ESG Management \(formerly ESG Management\) application
...
# Setup checklist for the ESG Management \(formerly ESG Management\) application
...
A user with the sn\_esg.program\_manager role, can download and install the ESG Management application. For details, see [Install ESG Management \(formerly ESG Management\)](install-esg.md).
...
Optionally, users of the [Install ESG Management \(formerly ESG Management\)](install-esg.md) application can integrate with other applications such as Project Portfolio Management and Integrated Risk Management. These integrations provide more features and capabilities. For more information, see [Integrating ESG Management \(formerly ESG\) with other applications](../concept/integrate-esg.md)

</td></tr></tbody>
</table>**Parent Topic:**[ESG Management \(formerly ESG Management\) implementation](../concept/esg-implementation.md)
