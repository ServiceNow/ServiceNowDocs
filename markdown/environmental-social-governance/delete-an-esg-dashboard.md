...
2.  Select the Analytics dashboard icon ![](../images/esg-dashboard-icon.png) and then select the dashboard that you want to delete.

3.  From the More actions menu ![](../images/more-menu.png), select**Delete**.
