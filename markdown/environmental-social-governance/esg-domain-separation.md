...
For more information on these tables, see [Components installed with ESG Management](../reference/components-installed-with-esg.md).
...
**Parent Topic:**[ESG Management reference](reference-data-esg.md)
