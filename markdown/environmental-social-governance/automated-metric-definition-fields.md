...
**Note:** This field appears only when the Metric approval property is set to **Simple**. For more information see, [Components installed with ESG Management](../../esg-management-reporting/reference/components-installed-with-esg.md).
