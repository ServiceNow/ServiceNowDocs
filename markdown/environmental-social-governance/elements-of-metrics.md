...
A metrics manager has the authority to determine whether a metric data task needs approval. If approval is necessary, you can choose between two methods: Simple Approval or Advanced Approval by using the **Metric approval** property. For more information about this property, see [Components installed with ESG Management](../../esg-management-reporting/reference/components-installed-with-esg.md).
