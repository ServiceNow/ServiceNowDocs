...
The following video shows the Hardware assets tab.The Hardware asset tab on the Sustainable IT dashboard.
...
For more information on DEX, see [Digital End-User Experience](https://www.servicenow.com/docs/access?context=dex-landing&version=xanadu&pubname=xanadu-it-service-management&ft:locale=en-US).
