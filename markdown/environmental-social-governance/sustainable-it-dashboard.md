...
For more information on DEX, see [Digital End-User Experience](https://www.servicenow.com/docs/access?context=dex-landing&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US).
