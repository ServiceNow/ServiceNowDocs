...
To understand how you can extract details from the utility bills, refer to [Extract data from utility invoices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/environmental-social-governance/extract-data-from-utility-invoices.md).
