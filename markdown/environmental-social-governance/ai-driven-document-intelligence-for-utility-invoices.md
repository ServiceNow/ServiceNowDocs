...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/environmental-social-governance/ai-driven-document-intelligence-for-utility-invoices.html
release: zurich
topic_type: concept
...
To understand how you can extract details from the utility bills, refer to [Extract data from utility invoices](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/environmental-social-governance/extract-data-from-utility-invoices.md).
