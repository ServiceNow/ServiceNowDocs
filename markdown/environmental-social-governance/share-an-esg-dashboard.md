...
2.  Select the Analytics dashboard icon ![](../images/esg-dashboard-icon.png) and then select the dashboard you want to share.
...
<table id="choicetable_yxb_j15_q5b"><tbody><tr><td id="d21349e123">
