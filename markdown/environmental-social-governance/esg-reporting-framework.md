...
Starting with the Xanadu release, Sustainability Accounting Standards Board \(SASB\) Global Reporting Initiative \(GRI\) content accelerator are deprecated. It will be hidden and no longer activated on new instances but will continue to be supported. The [ESG content accelerator](esg-content-accelerator.md) application provides the latest experience for this functionality.
