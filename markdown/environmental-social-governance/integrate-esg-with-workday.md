---
title: Integrating ESG Management with Workday
description: The Workday ESG integration plugin enables users to import HR data that is required for ESG reporting from Workday into the ESG Management application.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/environmental-social-governance/integrate-esg-with-workday.html
release: xanadu
topic_type: concept
