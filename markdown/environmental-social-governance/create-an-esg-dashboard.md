...
2.  Select the Analytics dashboard icon ![](../images/dashboard-icon.png).

3.  Select the More actions menu icon ![](../images/more-menu.png) and select**Create new**.

4.  Select the **In-line editor** tile and give the dashboard a name and a description.

    The Technical editor option opens a page in UI Builder that is treated as a dashboard, with a list of available components. For more information, see [UI Builder](https://www.servicenow.com/docs/access?context=ui-builder-overview&version=zurich&pubname=zurich-application-development&ft:locale=en-US) and [Create a technical dashboard in UI Builder](https://www.servicenow.com/docs/access?context=create-tech-db-in-ac&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US).

5.  Select **Create new dashboard**.

6.  Select **Add new element** to add content to the dashboard.

    See [Exploring Platform Analytics dashboards](https://www.servicenow.com/docs/access?context=ac-elements&version=zurich&pubname=zurich-now-intelligence&ft:locale=en-US) for information about what you can add to a dashboard.
...
7.  Select the View dashboard details icon ![](../images/details-icon.png) to view all the details of the dashboard.

    You can also edit the details as required. For more information, see [Edit ESG Management dashboard details](edit-esg-dashboard-details.md)
...
-   [Edit ESG Management dashboard details](edit-esg-dashboard-details.md)
-   [Edit ESG Management dashboard elements](edit-esg-dashboard-elements.md)
