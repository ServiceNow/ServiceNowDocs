...
2.  Select the Analytics dashboard icon ![](../images/esg-dashboard-icon.png).
...
6.  Select **Add new element** to add content to the dashboard.
    ...
    See [Platform Analytics dashboard overview](https://www.servicenow.com/docs/access?context=ac-elements&version=xanadu&pubname=xanadu-now-intelligence&ft:locale=en-US) for information about what you can add to a dashboard.
