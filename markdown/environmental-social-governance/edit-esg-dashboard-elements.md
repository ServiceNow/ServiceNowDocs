...
You can edit the details of dashboards created in the in-line editor and in the technical editor in the ESG Workspace. When you edit the content of dashboards created in the technical editor, you’re redirected to UI Builder.

## Procedure

1.  Navigate to **All** &gt; **Environmental, Social, and Governance** &gt; **ESG Workspace** &gt; **Analytics dashboard**.

2.  Select the Analytics dashboard icon \[Omitted image "esg-dashboard-icon.png"\] Alt text: and then select the dashboard you want to edit.

3.  Perform any of the following actions.

<table id="choicetable_gv3_q3r_g5"><thead><tr><th align="left" id="d22369e79">

Action

</th><th align="left" id="d22369e82">

Steps

</th></tr></thead><tbody><tr><td id="d22369e88">
...
3.  Create the visualization as described in [Data visualizations in Platform Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/analytics-center-data-visualizations.md).
...
4.  Configure the element and choose **Save**. For more information about configuring an element, see one of the following:
    -   [Edit a data visualization in an inline dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/editing-dv-in-line-db.md)
    -   [Edit a Platform Analytics filter on a dashboard](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/edit-filters-configurable-workspaces.md)
...
Filters let users filter data for all report widgets on a dashboard that follow them. You can add filters to both the entire dashboard and to individual dashboard tabs.
 ...
 For more information, see [Filters in Platform Analytics](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/now-intelligence/interactive-filters-workspace.md).

</td></tr><tr><td id="d22369e346">
