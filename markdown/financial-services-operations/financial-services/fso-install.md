---
title: Activate the Analytics and Reporting Solution for Financial Services Operations
description: Activate the content pack ServiceNow Store application for the Platform Analytics.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/financial-services-operations/financial-services/fso-install.html
release: yokohama
...
# Activate the Analytics and Reporting Solution for Financial Services Operations
...
2.  Browse for Performance Analytics Content Pack for FSO and verify that you have the necessary valid entitlements.
...
3.  Search for `Performance Analytics Content Pack for FSO`.
