...
-   Claim Adjuster Task \[sn\_ins\_gen\_claim\_adj\_task\]
    ...
    For detailed instructions and field descriptions, see [Create an SLA definition](https://www.servicenow.com/docs/access?context=t_CreateAnSLADefinition&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US).
