...
[Create script definitions for a remote table](https://www.servicenow.com/docs/access?context=create-remote-table-script&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)

[Create a form action](https://www.servicenow.com/docs/access?context=create-a-new-form-action&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)

[Create a UXF client action for forms](https://www.servicenow.com/docs/access?context=create-a-new-uxf-client-action-for-forms&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
