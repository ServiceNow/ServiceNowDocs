...
[Create script definitions for a remote table](https://www.servicenow.com/docs/access?context=create-remote-table-script&version=zurich&pubname=zurich-servicenow-platform&ft:locale=en-US)

[Create a form action button](https://www.servicenow.com/docs/access?context=create-a-new-form-action&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
