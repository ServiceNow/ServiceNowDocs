...
-   **Typed query**: The CSR types a question directly into the ServiceNow Otto panel at any point during the call.
...
3.  In the Interaction page, select **Ask Otto**.
    ...
    **Note:** By default, **Ask Otto** is available when:
    ...
    The ServiceNow Otto panel displays. The Insurance CSR support AI agent starts processing information from the call transcript and the customer's insurance data. It displays information relevant to the customer's request and presents follow-up options as selectable pills.
...
4.  Get a response from the agent using one of the following methods:
    ...
    -   Type a question directly into the ServiceNow Otto panel and press Enter to submit it.
