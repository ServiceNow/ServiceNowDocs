...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/financial-services-operations/configure-assignment-rules-fso-applications.html
release: yokohama
topic_type: task
...
3.  On the form, fill in the fields.
    ...
    For information about the Assignment Rule form fields, see [Create an assignment rule](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/table-administration-and-data-management/t_AssignmentModuleRule.md).
