...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/financial-services-operations/fso-combine-csm-industry-roles.html
release: yokohama
topic_type: concept
...
For more information, see [Industry data model roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/csm-data-model-roles.md) and [Contributor user roles](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/csm-contributor-user-roles.md).
