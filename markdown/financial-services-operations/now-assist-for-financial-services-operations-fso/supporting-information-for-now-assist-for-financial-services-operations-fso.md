...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/financial-services-operations/now-assist-for-financial-services-operations-fso/supporting-information-for-now-assist-for-financial-services-operations-fso.html
release: yokohama
...
breadcrumb: [ServiceNow Otto for FSO reference, ServiceNow Otto for Financial Services Operations \(FSO\)]
---
...
ServiceNow Otto for FSO is supported starting with the Xanadu release.

## Supported user interfaces

The ServiceNow Otto for FSO application includes the skills that are listed in the following table.
...
Activate the ServiceNow Otto for FSO store app \(sn\_fso\_gen\_ai\) to use the skills included in the application.
...
4.  ServiceNow Otto for FSO \(sn\_fso\_gen\_ai\)

**Note:** Form Data Collector is activated as part of ServiceNow Otto for FSO.

**Parent Topic:**[ServiceNow Otto for Financial Services Operations \(FSO\) reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/financial-services-operations/now-assist-for-financial-services-operations-fso/now-assist-for-fso-reference.md)
