---
title: Review a customer interaction with Disputes intake via Virtual Agent
description: Retrieve a chat interaction between a customer and Disputes intake via Virtual Agent to review a transcript of the conversation and confirm responses.
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/financial-services-operations/now-assist-for-financial-services-operations-fso/review-interaction-with-dispute-intake-virtual-agent.html
release: yokohama
...
\[Omitted image "disputes-va-transcript.png"\] Alt text: The interaction transcript shows the conversation history between Virtual Agent and the customer.

**Parent Topic:**[Submit a dispute case with Disputes intake via Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/financial-services-operations/now-assist-for-financial-services-operations-fso/submit-dispute-case-disputes-intake-via-virtual-agent.md)
