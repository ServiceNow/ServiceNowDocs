...
2.  In the chat window, select **Show all my options**.
    ...
    ![Select Show all my options when the chat window appears.](../image/disputes-va-show-options.png)
...
**Parent Topic:**[Using generative AI](../../fso-common/concept/using-now-assist-for-financial-services-operations-fso.md)
