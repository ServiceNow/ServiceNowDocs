...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/financial-services-operations/now-assist-for-financial-services-operations-fso/dispute-communication-ai.html
release: zurich
...
8.  The dispute agent reviews the content of the email and can choose to modify it before sending the mail.
    ...
    For information about dispute communication agent in ACH disputes, see and [Dispute communication initiation](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/zurich/financial-services-operations/dispute-management/fso-ach-dispute-communication.md).
