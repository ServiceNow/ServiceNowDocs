...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/financial-services-operations/financial-services-card-operations/increase-credit-limit.html
release: xanadu
...
breadcrumb: [Increasing the credit limit of a card, Managing credit card service requests, Financial Services Card Operations, Banking applications, Financial Services Operations \(FSO\)]
---
...
[Retrieve a credit assessment and evaluate the risks for a customer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/financial-services-card-operations/retrieve-credit-assessment-evaluate-risk.md).
...
If the associated case is for a temporary increase in the credit limit, work on the new case to [revert the credit limit](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/financial-services-card-operations/reset-credit-limit.md) to the original limit on the end date.
