...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/financial-services-operations/activate-visa-spoke.html
release: zurich
topic_type: task
...
2.  To customize the connection configuration, access the connection settings in **Flow Designer** &gt; **Connections** and select **Visa**.
    ...
    For more information on how to update the connection configuration, see [Visa Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/integrate-applications/visa-spoke.md).
