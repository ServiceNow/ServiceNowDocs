...
2.  To customize the connection configuration, access the connection settings in **Flow Designer** &gt; **Connections** and select **Visa**.
    ...
    For more information on how to update the connection configuration, see [Visa Spoke](https://www.servicenow.com/docs/access?context=visa-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
