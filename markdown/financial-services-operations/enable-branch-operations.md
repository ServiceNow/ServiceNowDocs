...
For more information about analytics and reporting for Financial Services Operations, see [Implementing Platform Analytics solutions](../../../use/application-content-packs/concept/fso-content-pack.md) and [KPI Details](https://www.servicenow.com/docs/access?context=kpi-details&version=australia&pubname=australia-now-intelligence&ft:locale=en-US).
