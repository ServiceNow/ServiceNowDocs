...
2.  To customize the connection configuration, access the connection settings in **Flow Designer** &gt; **Connections** and select **Mastercard**.
    ...
    For more information on how to update the connection configuration, see [Mastercard Spoke](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/integrate-applications/mastercard-spoke.md).
