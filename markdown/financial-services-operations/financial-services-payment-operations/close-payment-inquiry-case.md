...
For more information, see [Accept or reject a case solution from the Consumer Service Portal](https://www.servicenow.com/docs/access?context=resolve-cases-consumer-portal&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
