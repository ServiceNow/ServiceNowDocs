...
-   [View a case from the Consumer Service Portal](https://www.servicenow.com/docs/access?context=view-cases-consumer-portal&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)
-   [Accept or reject a case solution from the Consumer Service Portal](https://www.servicenow.com/docs/access?context=resolve-cases-consumer-portal&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US)
...
<table id="choicetable_lgv_1db_hmb"><thead><tr><th align="left" id="d104010e106">

Option

</th><th align="left" id="d104010e109">

Steps

</th></tr></thead><tbody><tr><td id="d104010e115">
