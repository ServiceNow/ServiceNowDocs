...
-   If there's a Customer or Consumer Service Portal available for customers, the new claim case appears on the portal.
    ...
    For more information, see [View a case from the Consumer Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/view-cases-consumer-portal.md).
