...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/financial-services-operations/financial-services-payment-operations/create-claim-case-inquiry-case.html
release: xanadu
...
-   If there's a Customer or Consumer Service Portal available for customers, the new claim case appears on the portal.
    ...
    For more information, see [View a case from the Consumer Service Portal](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/view-cases-consumer-portal.md).
...
You can close the associated inquiry case as the request is now tracked via the claim case. For more information, see [Close a payment inquiry case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/financial-services-payment-operations/close-payment-inquiry-case.md).

**Parent Topic:**[Investigate a payment inquiry case](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/financial-services-payment-operations/investigate-payment-inquiry-case.md)
