...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/financial-services-operations/customer-central-fso.html
release: zurich
topic_type: concept
...
To use Customer Central in FSO applications, activate the Customer Central plugin. For more information, see [Activate Customer Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/activate-customer-central.md).
...
For more information, see [Configure Customer Central](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/customer-service-management/configure-customer-central.md).
