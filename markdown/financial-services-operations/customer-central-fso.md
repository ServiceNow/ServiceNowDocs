...
To use Customer Central in FSO applications, activate the Customer Central plugin. For more information, see [Activate Customer Central](https://www.servicenow.com/docs/access?context=activate-customer-central&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
...
For more information, see [Configure Customer Central](https://www.servicenow.com/docs/access?context=configure-customer-central&version=zurich&pubname=zurich-customer-service-management&ft:locale=en-US).
