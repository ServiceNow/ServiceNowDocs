...
For a list of all of the FSO roles and descriptions, see [User roles and FSO Business rules](../../../../product/fso-common/reference/fso-core-roles.md)Components installed with Financial Services Operations Core.

## Test driving ServiceNow® REST APIs

The ServiceNow platform provides the [REST API Explorer](https://www.servicenow.com/docs/access?context=use-REST-API-Explorer&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US), which allows you to access the available REST APIs within your instance. Use this tool to interact with the various FSO tables within your instance before trying to implement the endpoint calls within your application.
