...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/financial-services-operations/document-processor-workflows.html
release: zurich
topic_type: concept
...
These workflows are built using [Flow Designer](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/build-workflows/flow-designer-home-landing-page.md). The application admin can review and customize these predefined flows that are based on the business needs of an organization.
