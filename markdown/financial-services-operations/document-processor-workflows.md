...
These workflows are built using [Flow Designer](https://www.servicenow.com/docs/access?context=flow-designer-home-landing-page&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US). The application admin can review and customize these predefined flows that are based on the business needs of an organization.
