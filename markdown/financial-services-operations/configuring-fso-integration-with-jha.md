...
2.  To customize the connection configuration, access the connection settings in **Flow Designer** &gt; **Connections** and select **JHA**.
    ...
    For more information on how to update the connection configuration, see [Set up Jack Henry jXchange Spoke](https://www.servicenow.com/docs/access?context=jha-spk-setup&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
