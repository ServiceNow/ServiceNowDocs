...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/financial-services-operations/financial-services-deposit-operations/installed-with-business-deposit-ops.html
release: yokohama
...
breadcrumb: [Financial Services Deposit Operations reference, Deposit Operations, Using banking applications, Financial Services Operations \(FSO\)]
---
...
|CSM Contributor User|Enables middle office teams to create cases for customer requests. For more information, see [CSM Contributor User](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/config-contributor-user.md) [Configure Contributor Users](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/customer-service-management/config-contributor-user.md).|
...
</table>**Parent Topic:**[Financial Services Deposit Operations reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/financial-services-operations/financial-services-deposit-operations/fso-deposit-ops-reference.md)
