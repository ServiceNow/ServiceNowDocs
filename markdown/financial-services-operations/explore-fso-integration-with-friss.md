...
|Spoke Layer|Layer that contains the FRISS spoke actions that use REST APIs to interact with FRISS. For more information on the FRISS spoke actions, see[FRISS Spoke](https://www.servicenow.com/docs/access?context=friss-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).|
