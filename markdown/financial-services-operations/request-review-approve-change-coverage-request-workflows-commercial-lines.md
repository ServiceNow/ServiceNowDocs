...
![Workflow showing how a policy change coverage request is resolved using the Commercial Lines Servicing application. For the text description, refer to the workflow steps that follow.](../image/change-coverage-workflow.jpg "Change coverage workflow example")
