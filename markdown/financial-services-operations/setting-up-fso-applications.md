...
1.  [Planning to import your financial data](../task/import-financial-accounts-products-institutions.md)
...
2.  \(Optional\) [Enabling branch operation features](enable-branch-operations.md)
...
3.  [Setting up roles and personas](fso-user-management.md)
...
4.  [Setting up script includes](https://www.servicenow.com/docs/access?context=c_ScriptIncludes&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US)

    Create script includes to store JavaScript that runs on the server.

5.  [Setting up Data models](../reference/data-models.md)

    Create structured and flexible data models to represent the need across various industries.

6.  [Creating an ACL](https://www.servicenow.com/docs/access?context=t_CreateNewACL&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US)

    Create an access control rule \(ACL\) to prevent the Needs review field from being modified after it has been set.

7.  [Setting up form views](https://www.servicenow.com/docs/access?context=form-configurable-workspace&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)

    Form views refer to the user interfaces or screens that allow users to input, edit, and view data related to tables.

8.  [Configuring service definitions](../task/configure-service-definitions.md)
...
9.  [Creating a UI action](https://www.servicenow.com/docs/access?context=t_CreateNewUIAction&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US)

    Create UI actions.

10. [Setting up CSM Configurable Workspace](../task/configure-csm-workspace-fso-apps.md)
...
11. [Setting up decision tables](https://www.servicenow.com/docs/access?context=decision-table&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)

    Create decision tables.

12. [Setting up approval engine](https://www.servicenow.com/docs/access?context=t_SetupAnApprovalEngine&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)

    Set up insurance claim core as per the business requirements.

13. [Configuring assignment rules](../task/configure-assignment-rules-fso-applications.md)
...
14. [Configuring flows](../task/configure-flow-designer-flows-fso-apps.md)
