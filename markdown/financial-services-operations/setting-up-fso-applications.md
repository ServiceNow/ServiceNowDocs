...
4.  [Setting up script includes](https://www.servicenow.com/docs/access?context=c_ScriptIncludes&version=zurich&pubname=zurich-api-reference&ft:locale=en-US)
...
6.  [Creating an ACL](https://www.servicenow.com/docs/access?context=t_CreateNewACL&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US)

    Create an access control rule \(ACL\) to prevent the Needs review field from being modified after it has been set.

7.  [Setting up form views](https://www.servicenow.com/docs/access?context=form-configurable-workspace&version=zurich&pubname=zurich-platform-user-interface&ft:locale=en-US)
...
9.  [Creating a UI action](https://www.servicenow.com/docs/access?context=t_CreateNewUIAction&version=zurich&pubname=zurich-it-service-management&ft:locale=en-US)
...
11. [Setting up decision tables](https://www.servicenow.com/docs/access?context=decision-table&version=zurich&pubname=zurich-application-development&ft:locale=en-US)

    Create decision tables.

12. [Setting up approval engine](https://www.servicenow.com/docs/access?context=t_SetupAnApprovalEngine&version=zurich&pubname=zurich-build-workflows&ft:locale=en-US)
