...
-   For information about the ServiceNow Otto installation process, see [Install Now Assist plugins](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/install-now-assist-feature-plugins.md).
...
4.  In the Turn on skill window, define the roles permitted to use this skill.
    ...
    ACLs are implemented to identify the users permitted to access the skill. See [Implement access control in AI agents](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/intelligent-experiences/aia-security-implementation.md) for more information.
