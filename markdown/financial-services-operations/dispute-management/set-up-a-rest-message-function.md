...
2.  Open the Visa Resolve Online or Mastercom record.
    ...
    Create a new REST Message record if you don't see one for your Third-Party System. For more information, see [Create a REST message](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/api-reference/web-services/t_ConfiguringARESTMessage.md).
