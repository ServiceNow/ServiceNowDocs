...
-   [Set up Visa Spoke](https://www.servicenow.com/docs/access?context=set-up-visa-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US)
...
-   [Set up Verifi Spoke](https://www.servicenow.com/docs/access?context=set-up-verifi-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US)

    Use Verifi Spoke to integrate with the Verifi CDRN API suite and perform API calls to perform early dispute resolution.

-   [Set up Mastercard spoke](https://www.servicenow.com/docs/access?context=set-up-mastercard-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US)
...
-   [Set up Ethoca spoke](https://www.servicenow.com/docs/access?context=set-up-ethoca-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US)
