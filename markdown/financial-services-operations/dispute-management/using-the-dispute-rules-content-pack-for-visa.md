...
In the  Dispute Rules Content Pack for Visa, the following actions take place:

-   The dispute agent completes the intake of questionnaires based on dispute category
-   Decision tables are evaluated to determine the dispute reason code and chargeback eligibility
