...
breadcrumb: [Resolving disputes with Visa, Processing, Use, Dispute Management, Banking applications, Financial Services Operations \(FSO\)]
---

# About pre-arbitration and arbitration
...
**Note:** In the playbook, the term “case filing” is used to refer to submitting an arbitration case to Visa.
