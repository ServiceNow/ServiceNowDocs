...
<table id="table_t5z_gz3_tcc"><thead><tr><th>
...
Store information about the claim case. This table extends the Claim Base \[sn\_bom\_claim\_case\] table.
...
Stores information about a claim task. This table extends the Financial Task \[sn\_bom\_task\] table.
...
Stores information about an adjuster task for a claim. This table extends the Financial Task \[sn\_bom\_task\] table.
...
Defines the configuration for the claim incidents that can be created. Use this table to define the following:-   Name and short description of the claim incident
...
Stores information about a personal travel policy issued to a policy holder. Extends Insurance Policy \[sn\_bom\_ins\_policy\].
