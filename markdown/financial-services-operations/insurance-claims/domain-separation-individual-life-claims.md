...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/financial-services-operations/insurance-claims/domain-separation-individual-life-claims.html
release: xanadu
...
breadcrumb: [Individual Life Claims reference, Individual Life Claims, Claims applications, Insurance applications, Financial Services Operations \(FSO\)]
---
...
All [FSO integrations](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/financial-services/fso-overview.md) applications are built on top of and use many Customer Service Management \(CSM\) tables. The key reference tables are the customer tables such as Consumer, Account, and Contact, and these tables are domain-separated.
