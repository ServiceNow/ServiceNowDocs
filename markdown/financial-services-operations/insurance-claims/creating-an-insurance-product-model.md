...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/financial-services-operations/insurance-claims/creating-an-insurance-product-model.html
release: xanadu
...
breadcrumb: [Insurance product models, Setting up the policy data for Insurance claims, Setting up Insurance claims, Insurance claims, Claims applications, Insurance applications, Financial Services Operations \(FSO\)]
---
...
<table id="choicetable_hsn_gnv_2dc"><tbody><tr><td id="d37781e75">
...
9.  On the form, fill in the fields.
    ...
    |Specification|Coverage Specification. For more information, see [Coverage specification](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/insurance-claims/coverage-specification.md).|
