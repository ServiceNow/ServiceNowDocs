...
**Note:** For more information, see [Configure the fraud score ranges with UI Builder](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/brazil/markdown/financial-services-operations/insurance-claims/configure-ranges-for-scores.md).
