...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/financial-services-operations/insurance-claims/grant-insurance-claims-roles-access-to-the-insurance-policy-table.html
release: australia
...
Create an instance of the insurance policy by creating a policy record. For more information, see [Create an insurance policy](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/australia/financial-services-operations/insurance-claims/create-an-insurance-policy-for-a-consumer.md).
