...
-   Generic claim: in this approach, the application provides a default robust framework which can be leveraged to build an end-to-end claim process with a few configuration steps.
