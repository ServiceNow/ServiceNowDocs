...
For more information, see [Expanded Model and Asset Classes Store application](https://www.servicenow.com/docs/access?context=enterprise-model-asset-classes-app&version=yokohama&pubname=yokohama-it-asset-management&ft:locale=en-US).
