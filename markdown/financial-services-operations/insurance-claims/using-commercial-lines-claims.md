...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/financial-services-operations/insurance-claims/using-commercial-lines-claims.html
release: xanadu
...
Configures Workspace per the business requirements. For more information, see [Configure CSM Configurable Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/financial-services/configure-csm-workspace-fso-apps.md).
...
For more information, see [Insurance Claims Core tables](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/financial-services/insurance-claims-core-tables.md).
