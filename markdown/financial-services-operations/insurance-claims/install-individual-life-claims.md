...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/financial-services-operations/insurance-claims/install-individual-life-claims.html
release: yokohama
...
The following items are installed with Individual Life Claims:
...
2.  Find the Individual Life Claims application \(sn\_ins\_claim\_indl\) using the filter criteria and search bar.
