...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/financial-services-operations/insurance-claims/manage-an-insurance-claims-flow-case.html
release: australia
...
**Important:** To access the Claim workspace, and Summary adjuster workspace related tabs, you must activate the CSM default record page. By default, the page is set to inactive. To determine the default page for displaying records in CSM Configurable Workspace, see [CRM Workspace record pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/customer-service-management/csm-config-workspace-record-pages.md) .
...
<table id="choicetable_kfd_jfb_vcc"><thead><tr><th align="left" id="d90490e93">

Option

</th><th align="left" id="d90490e96">

Steps

</th></tr></thead><tbody><tr><td id="d90490e102">
...
<table id="choicetable_ozd_rgb_vcc"><thead><tr><th align="left" id="d90490e156">

Claim task

</th><th align="left" id="d90490e159">

Claim workspace actions

</th></tr></thead><tbody><tr><td id="d90490e165">
