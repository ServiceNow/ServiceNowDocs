...
breadcrumb: [Coverage specification, Setting up the policy data for Insurance claims, Setting up Insurance claims, Insurance claims, Claims applications, Insurance applications, Financial Services Operations \(FSO\)]
---
...
Ensure you have created a coverage specification, coverage types, and coverage type options. For more information, see [Create a coverage specification](creating-a-coverage-specification.md).
