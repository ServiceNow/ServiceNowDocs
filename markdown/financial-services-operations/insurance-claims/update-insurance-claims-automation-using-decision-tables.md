...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/financial-services-operations/insurance-claims/update-insurance-claims-automation-using-decision-tables.html
release: yokohama
...
breadcrumb: [Automating Insurance claims processes by using decision tables, Setting up Insurance claims, Insurance claims, Claims applications, Using insurance applications, Financial Services Operations \(FSO\)]
---
