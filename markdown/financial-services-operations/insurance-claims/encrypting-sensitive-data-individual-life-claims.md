...
Fields in Individual Life Claims can be encrypted by using Field Encryption. For more information, see [Field Encryption](https://www.servicenow.com/docs/access?context=field-encryption&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
