...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/financial-services-operations/insurance-claims/encrypting-sensitive-data-individual-life-claims.html
release: zurich
...
Fields in Individual Life Claims can be encrypted by using Field Encryption. For more information, see [Field Encryption](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/zurich/markdown/platform-security/field-encryption.md).
