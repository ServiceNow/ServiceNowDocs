...
<table id="choicetable_oxg_nxp_4bc"><thead><tr><th align="left" id="d44507e124">

Task

</th><th align="left" id="d44507e127">

Description

</th></tr></thead><tbody><tr><td id="d44507e133">
...
For more information, see [Script includes](https://www.servicenow.com/docs/access?context=c_ScriptIncludes&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).

</td></tr><tr><td id="d44507e246">
...
For more information, see [Defining UI actions](https://www.servicenow.com/docs/access?context=c_UIActions&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) and [FSO Core Banking tables](../../fso-common/reference/fso-core-banking-tables.md).

</td></tr><tr><td id="d44507e349">
...
For more information, see [Configure CSM Configurable Workspace](../../fso-common/task/configure-csm-workspace-fso-apps.md) and [UI Builder](https://www.servicenow.com/docs/access?context=ui-builder-overview&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).

</td></tr><tr><td id="d44507e398">
...
For more information, see [Decision Tables](https://www.servicenow.com/docs/access?context=decision-table&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).

</td></tr><tr><td id="d44507e418">
