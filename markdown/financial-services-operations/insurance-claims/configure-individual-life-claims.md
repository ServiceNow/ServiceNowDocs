...
<table id="choicetable_oxg_nxp_4bc"><thead><tr><th align="left" id="d48724e128">

Task

</th><th align="left" id="d48724e131">

Description

</th></tr></thead><tbody><tr><td id="d48724e137">
...
For more information, see [Script includes](https://www.servicenow.com/docs/access?context=c_ScriptIncludes&version=zurich&pubname=zurich-api-reference&ft:locale=en-US).

</td></tr><tr><td id="d48724e250">
...
For more information, see [Defining UI actions](https://www.servicenow.com/docs/access?context=c_UIActions&version=zurich&pubname=zurich-platform-administration&ft:locale=en-US) and [FSO Core Banking tables](../../fso-common/reference/fso-core-banking-tables.md).

</td></tr><tr><td id="d48724e353">
...
For more information, see [Configure CSM Configurable Workspace](../../fso-common/task/configure-csm-workspace-fso-apps.md) and [UI Builder](https://www.servicenow.com/docs/access?context=ui-builder-overview&version=zurich&pubname=zurich-application-development&ft:locale=en-US).

</td></tr><tr><td id="d48724e402">
...
For more information, see [Decision Tables](https://www.servicenow.com/docs/access?context=decision-table&version=zurich&pubname=zurich-application-development&ft:locale=en-US).

</td></tr><tr><td id="d48724e422">
