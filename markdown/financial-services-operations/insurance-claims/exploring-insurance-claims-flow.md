...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/financial-services-operations/insurance-claims/exploring-insurance-claims-flow.html
release: xanadu
...
|Support for single and multiple adjusters|[Work on Insurance claims adjuster tasks](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/insurance-claims/manage-an-insurance-claims-flow-case.md)|Claims adjusters or claims managers|
...
-   [Setting up Insurance claims](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/insurance-claims/setting-up-insurance-claims-flow.md)
-   [Using Insurance claims](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/insurance-claims/using-insurance-claims-flow.md)
-   [Insurance claims reference](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/xanadu/financial-services-operations/insurance-claims/insurance-claims-flow-reference.md)
