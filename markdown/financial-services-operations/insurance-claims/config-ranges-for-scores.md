...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/xanadu/financial-services-operations/insurance-claims/config-ranges-for-scores.html
release: xanadu
...
breadcrumb: [Generate and view a claim's fraud score, Managing Commercial Lines Claims, Commercial Lines Claims, Claims applications, Insurance applications, Financial Services Operations \(FSO\)]
---
...
[CSM Configurable Workspace record pages](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/xanadu/markdown/customer-service-management/csm-config-workspace-record-pages.md)
