...
|Plugin|Description|
|------|-----------|
|Case Management Core \[com.sn\_customerservice\]|Enables the extension of tables from the Customer Service Management application into the Financial Services Operations applications.|
