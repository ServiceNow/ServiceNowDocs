...
For more information on setting up the integration to invoke Visa APIs for the Visa card dispute processs, see [Set up Visa Spoke](https://www.servicenow.com/docs/access?context=set-up-visa-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US).
...
[Visa Spoke](https://www.servicenow.com/docs/access?context=visa-spoke&version=zurich&pubname=zurich-integrate-applications&ft:locale=en-US)
