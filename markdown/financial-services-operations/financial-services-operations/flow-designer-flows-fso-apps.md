...
By using [Workflow Studio](https://www.servicenow.com/docs/access?context=workflow-studio&version=xanadu&pubname=xanadu-build-workflows&ft:locale=en-US), you can review and configure these predefined flows for your own business needs.

The following table lists the predefined flows that are available with Financial Services Operations applications.

<table id="table_d11_l32_jmb"><thead><tr><th>
...
-   Claim work notes - updates for payment
-   Claim work notes - updates for reserve
...
-   Claim adjuster task closed
-   Gen Claim Work Notes - Copy on Settlement
-   Generate Policy Snapshot for Claim Case
...
-   Beneficiary Claim Non-Receipt – Inquiry task
-   Claim Flow – External Refund
-   Claim Follow-up
-   Update Inquiry case via Reply
-   Update Debit Approval via Reply
...
-   Create Deposit Service Case
-   Deposit Instructions List
-   Deposit Operation Business – PB Activity
-   Update Deposit Case

These flows are available as subflows.
...
-   Create Deposit Service Case
-   Deposit Operation Personal – PB Activity
-   Document List Automation Plan
-   Update Deposit Case
...
-   Loan Deferment
-   Loan Forgiveness
-   Loan Missed Installment Repayment
-   Loan Restructure
-   Loan Write Off
-   Partial Prepayment
...
-   Treasury service case form
-   Treasury Service List Automation Plan
...
Claim work notes - updates for SIU task

</td></tr></tbody>
</table>**Parent Topic:**[Configure flows](../task/configure-flow-designer-flows-fso-apps.md)
