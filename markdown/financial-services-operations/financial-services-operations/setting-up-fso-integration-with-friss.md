...
1.  Request an Integration Hub subscription. To learn how, see [Request Integration Hub](https://www.servicenow.com/docs/access?context=request-ih-overview&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
...
3.  Set up the FRISS spoke. To learn how, see [Set up the FRISS spoke](https://www.servicenow.com/docs/access?context=set-up-the-friss-spoke&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
