...
-   **[Case Types in FSO](fso-int_guide-case-types-in-fso.md)**  
Learn about case types, how they’re structured, and how they’re used in Financial Services Operations \(FSO\).
-   **[Extending FSO Case Types](fso-int_guide-extending-fso-case-types.md)**  
...
-   **[Creating FSO Case Types](fso-int_guide-creating-new-fso-case-types.md)**  
...
-   **[Service Definitions in FSO](fso-int_guide-service-definitions-in-fso.md)**  
...
**Parent Topic:**[Financial Services Operations developer guide](fso-int_guide-overview.md)
