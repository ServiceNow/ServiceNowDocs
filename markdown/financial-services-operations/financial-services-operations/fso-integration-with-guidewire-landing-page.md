...
[Explore ![](../../../reuse/icons/brand-icons/bus-explore.svg) Learn about the benefits that are provided by integrating Financial Services Operations with Guidewire.](exploring-fso-integration-with-guidewire.md)
...
[Configure ![](../../fso-common/image/icon-install-new.png)Plan your configuration.](../task/configure-fso-integration-with-guidewire.md)
...
-   **[Setting up the Financial Services Operations Integration with Guidewire](../task/setting-up-fso-integration-with-guidewire.md)**  
...
-   **[Configure the Financial Services Operations Integration with Guidewire](../task/configure-fso-integration-with-guidewire.md)**  
...
**Parent Topic:**[Integration with third-party applications](../../fso-common/concept/fso-embedded-spokes-overview.md)
