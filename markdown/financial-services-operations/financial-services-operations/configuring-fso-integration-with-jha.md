---
title: Configure the Financial Services Operations Integration with Jack Henry jXchange
...
# Configure the Financial Services Operations Integration with Jack Henry jXchange
...
2.  To customize the connection configuration, access the connection settings in **Flow Designer** &gt; **Connections** and select **JHA**.
    ...
    For more information on how to update the connection configuration, see [Set up Jack Henry jXchange Spoke](https://www.servicenow.com/docs/access?context=jha-spk-setup&version=xanadu&pubname=xanadu-integrate-applications&ft:locale=en-US).
