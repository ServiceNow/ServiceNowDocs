...
For more information, see [Industry data model roles](https://www.servicenow.com/docs/access?context=csm-data-model-roles&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US) and [Contributor user roles](https://www.servicenow.com/docs/access?context=csm-contributor-user-roles&version=xanadu&pubname=xanadu-customer-service-management&ft:locale=en-US).
