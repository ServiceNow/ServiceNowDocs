...
Option to enable request for exemption from submittal of this document list item.
...
Option to enable to request for deferral of this document list item for submittal at a future date.
...
Option to require text or data to be automatically extracted from the document list item definition using optical character recognition. For more information, see [Financial Services Operations Integration with Document Intelligence](../concept/integration-with-document-intelligence.md).
