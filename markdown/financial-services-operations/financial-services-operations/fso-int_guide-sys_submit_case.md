...
1.  In the bank application, define the information necessary to create the loan case record, and then call the [POST /now/table/\{table\_Name\}](https://www.servicenow.com/docs/access?context=c_TableAPI&version=xanadu&pubname=xanadu-api-reference&ft:locale=en-US) REST endpoint on your ServiceNow instance.
