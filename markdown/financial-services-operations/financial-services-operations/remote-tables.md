...
[Create a form action](https://www.servicenow.com/docs/access?context=create-a-new-form-action&version=xanadu&pubname=xanadu-platform-user-interface&ft:locale=en-US)
