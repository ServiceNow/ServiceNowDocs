...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/yokohama/financial-services-operations/setting-up-a-remote-table-integration.html
release: yokohama
topic_type: concept
...
The remote tables plugin must be enabled for the ServiceNow instance to support remote tables. For more information, see [Activate the remote tables plugin](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/servicenow-platform/activate-remote-tables-plugin.md).
...
Create a UI action to populate remote data from the interaction into the case, or the respective objects in your workflow.For more information, see [Create a UI action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/platform-administration/t_EditingAUIAction.md).
...
For more information on the FSO Look Up Client action, see [FSO Look Up Client action](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/yokohama/markdown/yokohama/financial-services-operations/fso-look-up-client-action.md).
