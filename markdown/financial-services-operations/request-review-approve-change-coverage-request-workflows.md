...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/australia/financial-services-operations/request-review-approve-change-coverage-request-workflows.html
release: australia
topic_type: concept
...
\[Omitted image "change-coverage-workflow.png"\] Alt text: Workflow showing how a policy change coverage request is resolved using the Personal Lines Servicing application. For the text description, refer to the workflow steps that follow.
