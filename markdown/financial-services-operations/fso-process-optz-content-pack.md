...
For information about enabling the FSO Process Mining Content Pack, see [Content pack for Financial Services Operations](https://www.servicenow.com/docs/access?context=integration-fso-process-opt&version=australia&pubname=australia-now-intelligence&ft:locale=en-US).
...
You can also configure a new process project that is based on a pre-built project. For more information, see [Create a project or template using Project Builder](https://www.servicenow.com/docs/access?context=define-workflow-model&version=australia&pubname=australia-now-intelligence&ft:locale=en-US).
