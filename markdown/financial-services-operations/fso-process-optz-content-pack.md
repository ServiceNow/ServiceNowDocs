...
For information about enabling the FSO Process Mining Content Pack, see [Activate Process Mining content packs](https://www.servicenow.com/docs/access?context=po-content-pack&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
...
You can also configure a new process project that is based on a pre-built project. For more information, see [Create a project or template using Project Builder](https://www.servicenow.com/docs/access?context=define-workflow-model&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
...
**Parent Topic:**[Analytics and reporting solutions](../../../use/application-content-packs/concept/fso-content-pack.md)
